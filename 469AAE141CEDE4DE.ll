; ModuleID = '/usr/local/google/home/aeubanks/repos/test-suite/MultiSource/Benchmarks/TSVC/ControlFlow-dbl/tsc.c'
source_filename = "/usr/local/google/home/aeubanks/repos/test-suite/MultiSource/Benchmarks/TSVC/ControlFlow-dbl/tsc.c"
...
entry:
  %call = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.1) #16
...
if.else:                                          ; preds = %entry
  %call17 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.2) #16
...
if.else25:                                        ; preds = %if.else
  %call26 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.3) #16
...
if.else31:                                        ; preds = %if.else25
  %call32 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.4) #16
...
if.else37:                                        ; preds = %if.else31
  %call38 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.5) #16
...
if.else43:                                        ; preds = %if.else37
  %call44 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.6) #16
...
if.else51:                                        ; preds = %if.else43
  %call52 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.7) #16
...
if.else56:                                        ; preds = %if.else51
  %call57 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.8) #16
...
if.else62:                                        ; preds = %if.else56
  %call63 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.9) #16
...
if.else68:                                        ; preds = %if.else62
  %call69 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.10) #16
...
if.else74:                                        ; preds = %if.else68
  %call75 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.11) #16
...
if.else80:                                        ; preds = %if.else74
  %call81 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.12) #16
...
if.else89:                                        ; preds = %if.else80
  %call90 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.13) #16
...
if.else98:                                        ; preds = %if.else89
  %call99 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.14) #16
...
if.else106:                                       ; preds = %if.else98
  %call107 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.15) #16
...
if.else113:                                       ; preds = %if.else106
  %call114 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.16) #16
...
if.else122:                                       ; preds = %if.else113
  %call123 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.17) #16
...
if.else130:                                       ; preds = %if.else122
  %call131 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.18) #16
...
if.else136:                                       ; preds = %if.else130
  %call137 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.19) #16
...
if.else143:                                       ; preds = %if.else136
  %call144 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.20) #16
...
if.else149:                                       ; preds = %if.else143
  %call150 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.21) #16
...
if.else155:                                       ; preds = %if.else149
  %call156 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.22) #16
...
if.else164:                                       ; preds = %if.else155
  %call165 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.23) #16
...
if.else174:                                       ; preds = %if.else164
  %call175 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.24) #16
...
if.else181:                                       ; preds = %if.else174
  %call182 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.25) #16
...
if.else187:                                       ; preds = %if.else181
  %call188 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.26) #16
...
if.else193:                                       ; preds = %if.else187
  %call194 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.27) #16
...
if.else199:                                       ; preds = %if.else193
  %call200 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.28) #16
...
if.else205:                                       ; preds = %if.else199
  %call206 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.29) #16
...
if.else211:                                       ; preds = %if.else205
  %call212 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.30) #16
...
if.else218:                                       ; preds = %if.else211
  %call219 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.31) #16
...
if.else227:                                       ; preds = %if.else218
  %call228 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.32) #16
...
if.else235:                                       ; preds = %if.else227
  %call236 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.33) #16
...
if.else243:                                       ; preds = %if.else235
  %call244 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.34) #16
...
if.else250:                                       ; preds = %if.else243
  %call251 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.35) #16
...
if.else256:                                       ; preds = %if.else250
  %call257 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.36) #16
...
if.else262:                                       ; preds = %if.else256
  %call263 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.37) #16
...
if.else269:                                       ; preds = %if.else262
  %call270 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.38) #16
...
if.else276:                                       ; preds = %if.else269
  %call277 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.39) #16
...
if.else285:                                       ; preds = %if.else276
  %call286 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.40) #16
...
if.else293:                                       ; preds = %if.else285
  %call294 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.41) #16
...
if.else301:                                       ; preds = %if.else293
  %call302 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.42) #16
...
if.else310:                                       ; preds = %if.else301
  %call311 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.43) #16
...
if.else318:                                       ; preds = %if.else310
  %call319 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.44) #16
...
if.else327:                                       ; preds = %if.else318
  %call328 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.45) #16
...
if.else334:                                       ; preds = %if.else327
  %call335 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.46) #16
...
if.else342:                                       ; preds = %if.else334
  %call343 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.47) #16
...
if.else348:                                       ; preds = %if.else342
  %call349 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.48) #16
...
if.else354:                                       ; preds = %if.else348
  %call355 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.49) #16
...
if.else361:                                       ; preds = %if.else354
  %call362 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.50) #16
...
if.else368:                                       ; preds = %if.else361
  %call369 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.51) #16
...
if.else378:                                       ; preds = %if.else368
  %call379 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.52) #16
...
if.else386:                                       ; preds = %if.else378
  %call387 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.53) #16
...
if.else393:                                       ; preds = %if.else386
  %call394 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.54) #16
...
if.else402:                                       ; preds = %if.else393
  %call403 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.55) #16
...
if.else411:                                       ; preds = %if.else402
  %call412 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.56) #16
...
if.else420:                                       ; preds = %if.else411
  %call421 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.57) #16
...
if.else427:                                       ; preds = %if.else420
  %call428 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.58) #16
...
if.else435:                                       ; preds = %if.else427
  %call436 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.59) #16
...
if.else446:                                       ; preds = %if.else435
  %call447 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.60) #16
...
if.else457:                                       ; preds = %if.else446
  %call458 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.61) #16
...
if.else468:                                       ; preds = %if.else457
  %call469 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.62) #16
...
if.else477:                                       ; preds = %if.else468
  %call478 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.63) #16
...
if.else484:                                       ; preds = %if.else477
  %call485 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.64) #16
...
if.else491:                                       ; preds = %if.else484
  %call492 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.65) #16
...
if.else498:                                       ; preds = %if.else491
  %call499 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.66) #16
...
if.else504:                                       ; preds = %if.else498
  %call505 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.67) #16
...
if.else510:                                       ; preds = %if.else504
  %call511 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.68) #16
...
if.else515:                                       ; preds = %if.else510
  %call516 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.69) #16
...
if.else522:                                       ; preds = %if.else515
  %call523 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.70) #16
...
if.else527:                                       ; preds = %if.else522
  %call528 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.71) #16
...
if.else532:                                       ; preds = %if.else527
  %call533 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.72) #16
...
if.else537:                                       ; preds = %if.else532
  %call538 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.73) #16
...
if.else542:                                       ; preds = %if.else537
  %call543 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.74) #16
...
if.else548:                                       ; preds = %if.else542
  %call549 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.75) #16
...
if.else553:                                       ; preds = %if.else548
  %call554 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.76) #16
...
if.else558:                                       ; preds = %if.else553
  %call559 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.77) #16
...
if.else563:                                       ; preds = %if.else558
  %call564 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.78) #16
  %tobool565.not = icmp eq i32 %call564, 0
  br i1 %tobool565.not, label %if.end1093, label %if.else567

if.else567:                                       ; preds = %if.else563
  %call568 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.79) #16
...
if.else573:                                       ; preds = %if.else567
  %call574 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.80) #16
...
if.else582:                                       ; preds = %if.else573
  %call583 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.81) #16
...
if.else587:                                       ; preds = %if.else582
  %call588 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.82) #16
...
if.else592:                                       ; preds = %if.else587
  %call593 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.83) #16
...
if.else598:                                       ; preds = %if.else592
  %call599 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.84) #16
...
if.else604:                                       ; preds = %if.else598
  %call605 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.85) #16
...
if.else610:                                       ; preds = %if.else604
  %call611 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.86) #16
...
if.else617:                                       ; preds = %if.else610
  %call618 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.87) #16
...
if.else626:                                       ; preds = %if.else617
  %call627 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.88) #16
...
if.else632:                                       ; preds = %if.else626
  %call633 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.89) #16
...
if.else637:                                       ; preds = %if.else632
  %call638 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.90) #16
...
if.else643:                                       ; preds = %if.else637
  %call644 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.91) #16
...
if.else649:                                       ; preds = %if.else643
  %call650 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.92) #16
...
if.else655:                                       ; preds = %if.else649
  %call656 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.93) #16
...
if.else661:                                       ; preds = %if.else655
  %call662 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.94) #16
...
if.else667:                                       ; preds = %if.else661
  %call668 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.95) #16
...
if.else673:                                       ; preds = %if.else667
  %call674 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.96) #16
...
if.else680:                                       ; preds = %if.else673
  %call681 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.97) #16
...
if.else687:                                       ; preds = %if.else680
  %call688 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.98) #16
...
if.else696:                                       ; preds = %if.else687
  %call697 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.99) #16
...
if.else703:                                       ; preds = %if.else696
  %call704 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.100) #16
...
if.else711:                                       ; preds = %if.else703
  %call712 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.101) #16
...
if.else717:                                       ; preds = %if.else711
  %call718 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.102) #16
...
if.else723:                                       ; preds = %if.else717
  %call724 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.103) #16
...
if.else729:                                       ; preds = %if.else723
  %call730 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.104) #16
...
if.else735:                                       ; preds = %if.else729
  %call736 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.105) #16
...
if.else741:                                       ; preds = %if.else735
  %call742 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.106) #16
...
if.else747:                                       ; preds = %if.else741
  %call748 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.107) #16
...
if.else758:                                       ; preds = %if.else747
  %call759 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.108) #16
...
if.else767:                                       ; preds = %if.else758
  %call768 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.109) #16
...
if.else774:                                       ; preds = %if.else767
  %call775 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.110) #16
...
if.else780:                                       ; preds = %if.else774
  %call781 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.111) #16
...
if.else787:                                       ; preds = %if.else780
  %call788 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.112) #16
...
if.else793:                                       ; preds = %if.else787
  %call794 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.113) #16
...
if.else802:                                       ; preds = %if.else793
  %call803 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.114) #16
...
if.else810:                                       ; preds = %if.else802
  %call811 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.115) #16
...
if.else817:                                       ; preds = %if.else810
  %call818 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.116) #16
...
if.else825:                                       ; preds = %if.else817
  %call826 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.117) #16
...
if.else831:                                       ; preds = %if.else825
  %call832 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.118) #16
...
if.else838:                                       ; preds = %if.else831
  %call839 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.119) #16
...
if.else846:                                       ; preds = %if.else838
  %call847 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.120) #16
...
if.else852:                                       ; preds = %if.else846
  %call853 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.121) #16
...
if.else858:                                       ; preds = %if.else852
  %call859 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.122) #16
...
if.else866:                                       ; preds = %if.else858
  %call867 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.123) #16
...
if.else873:                                       ; preds = %if.else866
  %call874 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(4) @.str.124) #16
...
if.else879:                                       ; preds = %if.else873
  %call880 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.125) #16
...
if.else885:                                       ; preds = %if.else879
  %call886 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.126) #16
...
if.else891:                                       ; preds = %if.else885
  %call892 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.127) #16
...
if.else897:                                       ; preds = %if.else891
  %call898 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.128) #16
...
if.else903:                                       ; preds = %if.else897
  %call904 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.129) #16
...
if.else909:                                       ; preds = %if.else903
  %call910 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.130) #16
...
if.else916:                                       ; preds = %if.else909
  %call917 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.131) #16
...
if.else922:                                       ; preds = %if.else916
  %call923 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.132) #16
...
if.else930:                                       ; preds = %if.else922
  %call931 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.133) #16
...
if.else937:                                       ; preds = %if.else930
  %call938 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.134) #16
...
if.else942:                                       ; preds = %if.else937
  %call943 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.135) #16
...
if.else948:                                       ; preds = %if.else942
  %call949 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.136) #16
...
entry:
  %call = tail call i32 @init(ptr noundef nonnull @.str.23)
...
for.cond1.preheader:                              ; preds = %entry, %for.cond.cleanup3
  %nl.042 = phi i32 [ %inc24, %for.cond.cleanup3 ], [ 0, %entry ]
  br label %for.body4

for.cond.cleanup:                                 ; preds = %for.cond.cleanup3, %entry
  %call27 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.137, double noundef 0.000000e+00)
  br label %for.body.i

for.body.i:                                       ; preds = %for.body.i, %for.cond.cleanup
  %indvars.iv.i = phi i64 [ 0, %for.cond.cleanup ], [ %indvars.iv.next.i.1, %for.body.i ]
  %sumc.0194.i = phi double [ 0.000000e+00, %for.cond.cleanup ], [ %add6.i.1, %for.body.i ]
  %suma.0192.i = phi double [ 0.000000e+00, %for.cond.cleanup ], [ %add.i.1, %for.body.i ]
  %arrayidx.i = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv.i
  %1 = load double, ptr %arrayidx.i, align 16, !tbaa !5
  %add.i = fadd double %suma.0192.i, %1
  %arrayidx5.i = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 %indvars.iv.i
  %2 = load double, ptr %arrayidx5.i, align 16, !tbaa !5
  %add6.i = fadd double %sumc.0194.i, %2
  ...
  %add.i.1 = fadd double %add.i, %3
  %arrayidx5.i.1 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 %indvars.iv.next.i
  %4 = load double, ptr %arrayidx5.i.1, align 8, !tbaa !5
  %add6.i.1 = fadd double %add6.i, %4
  %indvars.iv.next.i.1 = add nuw nsw i64 %indvars.iv.i, 2
  %exitcond.not.i.1 = icmp eq i64 %indvars.iv.next.i.1, 32000
  br i1 %exitcond.not.i.1, label %for.cond18.preheader.i.preheader, label %for.body.i

for.cond18.preheader.i.preheader:                 ; preds = %for.body.i
  %5 = load i32, ptr @digits, align 4, !tbaa !17
  %add99.i = fadd double %add.i.1, %add6.i.1
  %call100.i = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %5, double noundef %add99.i)
  ret i32 0
...
for.body4:                                        ; preds = %for.cond1.preheader, %for.inc
  ...
  %7 = load double, ptr %arrayidx, align 8, !tbaa !5
  %cmp5 = fcmp olt double %7, 0.000000e+00
  %arrayidx17 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 %indvars.iv
  %8 = load double, ptr %arrayidx17, align 8, !tbaa !5
  br i1 %cmp5, label %L20, label %if.end

if.end:                                           ; preds = %for.body4
  %arrayidx7 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 %indvars.iv
  %9 = load double, ptr %arrayidx7, align 8, !tbaa !5
  %arrayidx11 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 11, i64 %indvars.iv
  %10 = load double, ptr %arrayidx11, align 8, !tbaa !5
  %11 = tail call double @llvm.fmuladd.f64(double %8, double %10, double %9)
  %arrayidx13 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv
  store double %11, ptr %arrayidx13, align 8, !tbaa !5
  %.pre = add nuw nsw i64 %indvars.iv, 1
  br label %for.inc

L20:                                              ; preds = %for.body4
  %arrayidx15 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv
  %12 = load double, ptr %arrayidx15, align 8, !tbaa !5
  %13 = tail call double @llvm.fmuladd.f64(double %8, double %8, double %12)
  %14 = add nuw nsw i64 %indvars.iv, 1
  %arrayidx21 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 %14
  store double %13, ptr %arrayidx21, align 8, !tbaa !5
  br label %for.inc

for.inc:                                          ; preds = %if.end, %L20
  %indvars.iv.next.pre-phi = phi i64 [ %.pre, %if.end ], [ %14, %L20 ]
...
entry:
  ...
  br i1 %cmp39, label %for.cond1.preheader, label %for.cond.cleanup

for.cond1.preheader:                              ; preds = %entry, %for.cond.cleanup3
  %nl.040 = phi i32 [ %inc24, %for.cond.cleanup3 ], [ 0, %entry ]
  br label %for.body4

for.cond.cleanup:                                 ; preds = %for.cond.cleanup3, %entry
  %call26 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.138, double noundef 0.000000e+00)
  br label %for.body.i
...
for.cond.cleanup3:                                ; preds = %for.inc
  %call22 = tail call i32 @dummy(ptr noundef nonnull @global_data, ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 11, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 20, i64 0, i64 0), double noundef 0.000000e+00) #17
  %inc24 = add nuw nsw i32 %nl.040, 1
  %6 = load i32, ptr @ntimes, align 4, !tbaa !17
  %cmp = icmp slt i32 %inc24, %6
  br i1 %cmp, label %for.cond1.preheader, label %for.cond.cleanup
...
if.end:                                           ; preds = %for.body4
  ...
  %8 = load double, ptr %arrayidx9, align 8, !tbaa !5
  %arrayidx11 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 11, i64 %indvars.iv
  %9 = load double, ptr %arrayidx11, align 8, !tbaa !5
  %10 = tail call double @llvm.fmuladd.f64(double %8, double %9, double %7)
  %arrayidx13 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv
  store double %10, ptr %arrayidx13, align 8, !tbaa !5
  br label %for.inc

L20:                                              ; preds = %for.body4
  %arrayidx15 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv
  %11 = load double, ptr %arrayidx15, align 8, !tbaa !5
  %arrayidx17 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 %indvars.iv
  %12 = load double, ptr %arrayidx17, align 8, !tbaa !5
  %13 = tail call double @llvm.fmuladd.f64(double %12, double %12, double %11)
  %arrayidx21 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %indvars.iv
  store double %13, ptr %arrayidx21, align 8, !tbaa !5
  br label %for.inc
...
; Function Attrs: nounwind uwtable
define dso_local i32 @s162(i32 noundef %k) local_unnamed_addr #7 {
entry:
  %call = tail call i32 @init(ptr noundef nonnull @.str.24)
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
  %cmp25 = icmp sgt i32 %0, 0
  br i1 %cmp25, label %for.body.lr.ph, label %for.cond.cleanup

for.body.lr.ph:                                   ; preds = %entry
  %cmp1 = icmp sgt i32 %k, 0
  br i1 %cmp1, label %for.body.us.preheader, label %for.body

for.body.us.preheader:                            ; preds = %for.body.lr.ph
  %1 = zext i32 %k to i64
  %.neg = mul nsw i64 %1, -8
  %diff.check = icmp ult i64 %.neg, 32
  %conflict.rdx32 = or i1 %diff.check, or (i1 icmp ult (i64 sub (i64 ptrtoint (ptr @global_data to i64), i64 add (i64 ptrtoint (ptr @global_data to i64), i64 256032)), i64 32), i1 icmp ult (i64 sub (i64 ptrtoint (ptr @global_data to i64), i64 add (i64 ptrtoint (ptr @global_data to i64), i64 512064)), i64 32))
  br label %vector.memcheck

vector.memcheck:                                  ; preds = %if.end.loopexit.us, %for.body.us.preheader
  %nl.026.us = phi i32 [ %inc14.us, %if.end.loopexit.us ], [ 0, %for.body.us.preheader ]
  br i1 %conflict.rdx32, label %for.body5.us.prol, label %vector.body

vector.body:                                      ; preds = %vector.memcheck, %vector.body
  %index = phi i64 [ %index.next, %vector.body ], [ 0, %vector.memcheck ]
  %2 = add nuw nsw i64 %index, %1
  %3 = getelementptr inbounds double, ptr @global_data, i64 %2
  %wide.load = load <2 x double>, ptr %3, align 8, !tbaa !5
  %4 = getelementptr inbounds double, ptr %3, i64 2
  %wide.load33 = load <2 x double>, ptr %4, align 8, !tbaa !5
  %5 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %index
  %wide.load34 = load <2 x double>, ptr %5, align 32, !tbaa !5
  %6 = getelementptr inbounds double, ptr %5, i64 2
  %wide.load35 = load <2 x double>, ptr %6, align 16, !tbaa !5
  %7 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 %index
  %wide.load36 = load <2 x double>, ptr %7, align 32, !tbaa !5
  %8 = getelementptr inbounds double, ptr %7, i64 2
  %wide.load37 = load <2 x double>, ptr %8, align 16, !tbaa !5
  %9 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %wide.load34, <2 x double> %wide.load36, <2 x double> %wide.load)
  %10 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %wide.load35, <2 x double> %wide.load37, <2 x double> %wide.load33)
  %11 = getelementptr inbounds double, ptr @global_data, i64 %index
  ...
  %13 = icmp eq i64 %index.next, 31996
  br i1 %13, label %for.body5.us.prol, label %vector.body, !llvm.loop !367

for.body5.us.prol:                                ; preds = %vector.body, %vector.memcheck
  %indvars.iv.ph = phi i64 [ 0, %vector.memcheck ], [ 31996, %vector.body ]
  %14 = add nuw nsw i64 %indvars.iv.ph, %1
  %arrayidx.us.prol = getelementptr inbounds double, ptr @global_data, i64 %14
  %15 = load double, ptr %arrayidx.us.prol, align 8, !tbaa !5
  %arrayidx7.us.prol = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %indvars.iv.ph
  %16 = load double, ptr %arrayidx7.us.prol, align 32, !tbaa !5
  %arrayidx9.us.prol = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 %indvars.iv.ph
  %17 = load double, ptr %arrayidx9.us.prol, align 32, !tbaa !5
  %18 = tail call double @llvm.fmuladd.f64(double %16, double %17, double %15)
  %arrayidx11.us.prol = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv.ph
  store double %18, ptr %arrayidx11.us.prol, align 32, !tbaa !5
  %indvars.iv.next.prol = or i64 %indvars.iv.ph, 1
  br label %for.body5.us

for.body5.us:                                     ; preds = %for.body5.us, %for.body5.us.prol
  %indvars.iv = phi i64 [ %indvars.iv.next.prol, %for.body5.us.prol ], [ %indvars.iv.next.1, %for.body5.us ]
  %19 = add nuw nsw i64 %indvars.iv, %1
  %arrayidx.us = getelementptr inbounds double, ptr @global_data, i64 %19
  %20 = load double, ptr %arrayidx.us, align 8, !tbaa !5
  %arrayidx7.us = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %indvars.iv
  %21 = load double, ptr %arrayidx7.us, align 8, !tbaa !5
  %arrayidx9.us = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 %indvars.iv
  %22 = load double, ptr %arrayidx9.us, align 8, !tbaa !5
  %23 = tail call double @llvm.fmuladd.f64(double %21, double %22, double %20)
  %arrayidx11.us = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv
  store double %23, ptr %arrayidx11.us, align 8, !tbaa !5
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %24 = add nuw nsw i64 %indvars.iv.next, %1
  %arrayidx.us.1 = getelementptr inbounds double, ptr @global_data, i64 %24
  %25 = load double, ptr %arrayidx.us.1, align 8, !tbaa !5
  %arrayidx7.us.1 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %indvars.iv.next
  %26 = load double, ptr %arrayidx7.us.1, align 8, !tbaa !5
  %arrayidx9.us.1 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 %indvars.iv.next
  %27 = load double, ptr %arrayidx9.us.1, align 8, !tbaa !5
  %28 = tail call double @llvm.fmuladd.f64(double %26, double %27, double %25)
  %arrayidx11.us.1 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv.next
  store double %28, ptr %arrayidx11.us.1, align 8, !tbaa !5
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %exitcond.not.1 = icmp eq i64 %indvars.iv.next.1, 31999
  br i1 %exitcond.not.1, label %if.end.loopexit.us, label %for.body5.us, !llvm.loop !368

if.end.loopexit.us:                               ; preds = %for.body5.us
  %call12.us = tail call i32 @dummy(ptr noundef nonnull @global_data, ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 11, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 20, i64 0, i64 0), double noundef 0.000000e+00) #17
  %inc14.us = add nuw nsw i32 %nl.026.us, 1
  %29 = load i32, ptr @ntimes, align 4, !tbaa !17
  %cmp.us = icmp slt i32 %inc14.us, %29
  br i1 %cmp.us, label %vector.memcheck, label %for.cond.cleanup

for.cond.cleanup:                                 ; preds = %for.body, %if.end.loopexit.us, %entry
  %call16 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.139, double noundef 0.000000e+00)
  br label %for.body.i
...
for.body.i:                                       ; preds = %for.body.i, %for.cond.cleanup
  ...
  %add.i = fadd double %suma.0192.i, %30
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1
  %arrayidx.i.1 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv.next.i
  %31 = load double, ptr %arrayidx.i.1, align 8, !tbaa !5
  %add.i.1 = fadd double %add.i, %31
  %indvars.iv.next.i.1 = add nuw nsw i64 %indvars.iv.i, 2
  %arrayidx.i.2 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv.next.i.1
  %32 = load double, ptr %arrayidx.i.2, align 8, !tbaa !5
  ...
  %33 = load double, ptr %arrayidx.i.3, align 8, !tbaa !5
  ...
  %34 = load double, ptr %arrayidx.i.4, align 8, !tbaa !5
...
for.cond18.preheader.i.preheader:                 ; preds = %for.body.i
  %35 = load i32, ptr @digits, align 4, !tbaa !17
  %call.i = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %35, double noundef %add.i.4)
  ret i32 0

for.body:                                         ; preds = %for.body.lr.ph, %for.body
  %nl.026 = phi i32 [ %inc14, %for.body ], [ 0, %for.body.lr.ph ]
  %call12 = tail call i32 @dummy(ptr noundef nonnull @global_data, ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 11, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 20, i64 0, i64 0), double noundef 0.000000e+00) #17
  %inc14 = add nuw nsw i32 %nl.026, 1
  %36 = load i32, ptr @ntimes, align 4, !tbaa !17
  %cmp = icmp slt i32 %inc14, %36
...
entry:
  %call = tail call i32 @init(ptr noundef nonnull @.str.53)
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
  %cmp26 = icmp sgt i32 %0, 0
  br i1 %cmp26, label %for.cond1.preheader, label %for.cond.cleanup

for.cond1.preheader:                              ; preds = %entry, %for.cond.cleanup3
  %nl.027 = phi i32 [ %inc15, %for.cond.cleanup3 ], [ 0, %entry ]
  br label %for.body4

for.cond.cleanup:                                 ; preds = %for.cond.cleanup3, %entry
  %call17 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.140, double noundef 0.000000e+00)
  br label %for.body.i
...
for.cond.cleanup3:                                ; preds = %for.inc
  ...
  %inc15 = add nuw nsw i32 %nl.027, 1
  %7 = load i32, ptr @ntimes, align 4, !tbaa !17
  %mul = shl nsw i32 %7, 2
  %cmp = icmp slt i32 %inc15, %mul
  br i1 %cmp, label %for.cond1.preheader, label %for.cond.cleanup
...
if.then:                                          ; preds = %for.body4
  %arrayidx9 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 %indvars.iv
  %9 = load double, ptr %arrayidx9, align 8, !tbaa !5
  %arrayidx12 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv
  %10 = load double, ptr %arrayidx12, align 8, !tbaa !5
  %11 = tail call double @llvm.fmuladd.f64(double %8, double %9, double %10)
  store double %11, ptr %arrayidx12, align 8, !tbaa !5
  br label %for.inc
...
; Function Attrs: nounwind uwtable
define dso_local i32 @s272(double noundef %t) local_unnamed_addr #7 {
entry:
  %call = tail call i32 @init(ptr noundef nonnull @.str.54)
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
  %cmp33 = icmp sgt i32 %0, 0
  br i1 %cmp33, label %for.cond1.preheader, label %for.cond.cleanup

for.cond1.preheader:                              ; preds = %entry, %for.cond.cleanup3
  %nl.034 = phi i32 [ %inc20, %for.cond.cleanup3 ], [ 0, %entry ]
  br label %for.body4

for.cond.cleanup:                                 ; preds = %for.cond.cleanup3, %entry
  %call22 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.141, double noundef 0.000000e+00)
  br label %for.body.i

for.body.i:                                       ; preds = %for.body.i, %for.cond.cleanup
  %indvars.iv.i = phi i64 [ 0, %for.cond.cleanup ], [ %indvars.iv.next.i.1, %for.body.i ]
  %sumb.0193.i = phi double [ 0.000000e+00, %for.cond.cleanup ], [ %add3.i.1, %for.body.i ]
  %suma.0192.i = phi double [ 0.000000e+00, %for.cond.cleanup ], [ %add.i.1, %for.body.i ]
  %arrayidx.i = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv.i
  %1 = load double, ptr %arrayidx.i, align 16, !tbaa !5
  %add.i = fadd double %suma.0192.i, %1
  %arrayidx2.i = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %indvars.iv.i
  %2 = load double, ptr %arrayidx2.i, align 16, !tbaa !5
  %add3.i = fadd double %sumb.0193.i, %2
  %indvars.iv.next.i = or i64 %indvars.iv.i, 1
  %arrayidx.i.1 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv.next.i
  %3 = load double, ptr %arrayidx.i.1, align 8, !tbaa !5
  %add.i.1 = fadd double %add.i, %3
  %arrayidx2.i.1 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %indvars.iv.next.i
  %4 = load double, ptr %arrayidx2.i.1, align 8, !tbaa !5
  %add3.i.1 = fadd double %add3.i, %4
  %indvars.iv.next.i.1 = add nuw nsw i64 %indvars.iv.i, 2
  %exitcond.not.i.1 = icmp eq i64 %indvars.iv.next.i.1, 32000
  br i1 %exitcond.not.i.1, label %for.cond18.preheader.i.preheader, label %for.body.i
...
for.cond18.preheader.i.preheader:                 ; preds = %for.body.i
  %5 = load i32, ptr @digits, align 4, !tbaa !17
  %add89.i = fadd double %add.i.1, %add3.i.1
  %call90.i = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %5, double noundef %add89.i)
  ret i32 0

for.cond.cleanup3:                                ; preds = %for.inc
  %call18 = tail call i32 @dummy(ptr noundef nonnull @global_data, ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 11, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 20, i64 0, i64 0), double noundef 0.000000e+00) #17
  %inc20 = add nuw nsw i32 %nl.034, 1
  %6 = load i32, ptr @ntimes, align 4, !tbaa !17
  %cmp = icmp slt i32 %inc20, %6
  br i1 %cmp, label %for.cond1.preheader, label %for.cond.cleanup

for.body4:                                        ; preds = %for.cond1.preheader, %for.inc
  %indvars.iv = phi i64 [ 0, %for.cond1.preheader ], [ %indvars.iv.next, %for.inc ]
  %arrayidx = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 11, i64 %indvars.iv
  %7 = load double, ptr %arrayidx, align 8, !tbaa !5
  %cmp5 = fcmp ult double %7, %t
  br i1 %cmp5, label %for.inc, label %if.then

if.then:                                          ; preds = %for.body4
  %arrayidx7 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 %indvars.iv
  %8 = load double, ptr %arrayidx7, align 8, !tbaa !5
  %arrayidx9 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 %indvars.iv
  %9 = load double, ptr %arrayidx9, align 8, !tbaa !5
  %arrayidx11 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv
  %10 = load double, ptr %arrayidx11, align 8, !tbaa !5
  %11 = tail call double @llvm.fmuladd.f64(double %8, double %9, double %10)
  store double %11, ptr %arrayidx11, align 8, !tbaa !5
  %arrayidx17 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %indvars.iv
  %12 = load double, ptr %arrayidx17, align 8, !tbaa !5
  %13 = tail call double @llvm.fmuladd.f64(double %8, double %8, double %12)
  store double %13, ptr %arrayidx17, align 8, !tbaa !5
  br label %for.inc
...
entry:
  %call = tail call i32 @init(ptr noundef nonnull @.str.55)
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
  %cmp42 = icmp sgt i32 %0, 0
  br i1 %cmp42, label %vector.ph, label %for.cond.cleanup

vector.ph:                                        ; preds = %entry, %for.cond.cleanup3
  %nl.043 = phi i32 [ %inc26, %for.cond.cleanup3 ], [ 0, %entry ]
  br label %vector.body

vector.body:                                      ; preds = %pred.store.continue48, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %pred.store.continue48 ]
  %1 = or i64 %index, 1
  %2 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 %index
  %wide.load = load <2 x double>, ptr %2, align 16, !tbaa !5
  %3 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 11, i64 %index
  %wide.load45 = load <2 x double>, ptr %3, align 16, !tbaa !5
  %4 = getelementptr inbounds double, ptr @global_data, i64 %index
  %wide.load46 = load <2 x double>, ptr %4, align 16, !tbaa !5
  %5 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %wide.load, <2 x double> %wide.load45, <2 x double> %wide.load46)
  ...
  %8 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %1
  %9 = load <2 x double>, ptr %7, align 16, !tbaa !5
  %10 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %wide.load, <2 x double> %wide.load45, <2 x double> %9)
  %11 = extractelement <2 x i1> %6, i64 0
  br i1 %11, label %pred.store.if, label %pred.store.continue

pred.store.if:                                    ; preds = %vector.body
  %12 = extractelement <2 x double> %10, i64 0
  store double %12, ptr %7, align 16, !tbaa !5
  br label %pred.store.continue

pred.store.continue:                              ; preds = %pred.store.if, %vector.body
  %13 = extractelement <2 x i1> %6, i64 1
...
pred.store.if47:                                  ; preds = %pred.store.continue
  ...
  store double %14, ptr %8, align 8, !tbaa !5
  br label %pred.store.continue48

pred.store.continue48:                            ; preds = %pred.store.if47, %pred.store.continue
  %15 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 %index
  %wide.load49 = load <2 x double>, ptr %15, align 16, !tbaa !5
  %16 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %5, <2 x double> %wide.load, <2 x double> %wide.load49)
  store <2 x double> %16, ptr %15, align 16, !tbaa !5
  %index.next = add nuw i64 %index, 2
  %17 = icmp eq i64 %index.next, 32000
  br i1 %17, label %for.cond.cleanup3, label %vector.body, !llvm.loop !369

for.cond.cleanup:                                 ; preds = %for.cond.cleanup3, %entry
  %call28 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.142, double noundef 0.000000e+00)
  br label %for.body.i
...
for.body.i:                                       ; preds = %for.body.i, %for.cond.cleanup
  ...
  %suma.0192.i = phi double [ 0.000000e+00, %for.cond.cleanup ], [ %add.i.1, %for.body.i ]
  %arrayidx.i = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv.i
  %18 = load double, ptr %arrayidx.i, align 16, !tbaa !5
  %add.i = fadd double %suma.0192.i, %18
  %arrayidx2.i = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %indvars.iv.i
  %19 = load double, ptr %arrayidx2.i, align 16, !tbaa !5
  %add3.i = fadd double %sumb.0193.i, %19
  %arrayidx5.i = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 %indvars.iv.i
  %20 = load double, ptr %arrayidx5.i, align 16, !tbaa !5
  %add6.i = fadd double %sumc.0194.i, %20
  %indvars.iv.next.i = or i64 %indvars.iv.i, 1
  %arrayidx.i.1 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv.next.i
  %21 = load double, ptr %arrayidx.i.1, align 8, !tbaa !5
  %add.i.1 = fadd double %add.i, %21
  %arrayidx2.i.1 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %indvars.iv.next.i
  %22 = load double, ptr %arrayidx2.i.1, align 8, !tbaa !5
  %add3.i.1 = fadd double %add3.i, %22
  %arrayidx5.i.1 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 %indvars.iv.next.i
  %23 = load double, ptr %arrayidx5.i.1, align 8, !tbaa !5
  %add6.i.1 = fadd double %add6.i, %23
  %indvars.iv.next.i.1 = add nuw nsw i64 %indvars.iv.i, 2
  %exitcond.not.i.1 = icmp eq i64 %indvars.iv.next.i.1, 32000
  br i1 %exitcond.not.i.1, label %for.cond18.preheader.i.preheader, label %for.body.i
...
for.cond18.preheader.i.preheader:                 ; preds = %for.body.i
  %24 = load i32, ptr @digits, align 4, !tbaa !17
  %add104.i = fadd double %add.i.1, %add3.i.1
  %add105.i = fadd double %add104.i, %add6.i.1
  %call106.i = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %24, double noundef %add105.i)
  ret i32 0

for.cond.cleanup3:                                ; preds = %pred.store.continue48
  %call24 = tail call i32 @dummy(ptr noundef nonnull @global_data, ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 11, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 20, i64 0, i64 0), double noundef 0.000000e+00) #17
  %inc26 = add nuw nsw i32 %nl.043, 1
  %25 = load i32, ptr @ntimes, align 4, !tbaa !17
  %cmp = icmp slt i32 %inc26, %25
...
entry:
  %call = tail call i32 @init(ptr noundef nonnull @.str.56)
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
  %cmp45 = icmp sgt i32 %0, 0
  br i1 %cmp45, label %for.cond1.preheader, label %for.cond.cleanup

for.cond1.preheader:                              ; preds = %entry, %for.cond.cleanup3
  %nl.046 = phi i32 [ %inc28, %for.cond.cleanup3 ], [ 0, %entry ]
  br label %for.body4

for.cond.cleanup:                                 ; preds = %for.cond.cleanup3, %entry
  %call30 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.143, double noundef 0.000000e+00)
  br label %for.body.i
...
for.cond.cleanup3:                                ; preds = %for.inc
  %call26 = tail call i32 @dummy(ptr noundef nonnull @global_data, ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 11, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 20, i64 0, i64 0), double noundef 0.000000e+00) #17
  %inc28 = add nuw nsw i32 %nl.046, 1
  %6 = load i32, ptr @ntimes, align 4, !tbaa !17
  %cmp = icmp slt i32 %inc28, %6
  br i1 %cmp, label %for.cond1.preheader, label %for.cond.cleanup
...
for.body4:                                        ; preds = %for.cond1.preheader, %for.inc
  ...
  %arrayidx = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 %indvars.iv
  %7 = load double, ptr %arrayidx, align 8, !tbaa !5
  %arrayidx6 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 11, i64 %indvars.iv
  %8 = load double, ptr %arrayidx6, align 8, !tbaa !5
  %arrayidx8 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 %indvars.iv
  %9 = load double, ptr %arrayidx8, align 8, !tbaa !5
  %10 = tail call double @llvm.fmuladd.f64(double %8, double %9, double %7)
  %arrayidx10 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv
  store double %10, ptr %arrayidx10, align 8, !tbaa !5
...
if.then:                                          ; preds = %for.body4
  ...
  store double %add, ptr %arrayidx17, align 8, !tbaa !5
  br label %for.inc

if.else:                                          ; preds = %for.body4
  %mul = fmul double %8, %9
  store double %mul, ptr %arrayidx10, align 8, !tbaa !5
  br label %for.inc
...
entry:
  %call = tail call i32 @init(ptr noundef nonnull @.str.57)
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
  %cmp53 = icmp sgt i32 %0, 255
  br i1 %cmp53, label %for.cond1.preheader, label %for.cond.cleanup

for.cond1.preheader:                              ; preds = %entry, %for.cond.cleanup3
  %nl.054 = phi i32 [ %inc32, %for.cond.cleanup3 ], [ 0, %entry ]
  br label %for.body4

for.cond.cleanup:                                 ; preds = %for.cond.cleanup3, %entry
  %call36 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.144, double noundef 0.000000e+00)
...
for.cond.cleanup3:                                ; preds = %for.inc27
  %call30 = tail call i32 @dummy(ptr noundef nonnull @global_data, ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 11, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 20, i64 0, i64 0), double noundef 0.000000e+00) #17
  %inc32 = add nuw nsw i32 %nl.054, 1
  %6 = load i32, ptr @ntimes, align 4, !tbaa !17
  %div = sdiv i32 %6, 256
  %mul = mul nsw i32 %div, 10
  %cmp = icmp slt i32 %inc32, %mul
  br i1 %cmp, label %for.cond1.preheader, label %for.cond.cleanup

for.body4:                                        ; preds = %for.cond1.preheader, %for.inc27
  %indvars.iv57 = phi i64 [ 0, %for.cond1.preheader ], [ %indvars.iv.next58, %for.inc27 ]
  %arrayidx = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), i64 0, i64 %indvars.iv57
  %7 = load double, ptr %arrayidx, align 8, !tbaa !5
  %cmp5 = fcmp ogt double %7, 0.000000e+00
  br i1 %cmp5, label %for.body9, label %for.inc27

for.body9:                                        ; preds = %for.body4, %for.body9.1
  %8 = phi double [ %14, %for.body9.1 ], [ %7, %for.body4 ]
  %indvars.iv = phi i64 [ %indvars.iv.next.1, %for.body9.1 ], [ 1, %for.body4 ]
  %arrayidx17 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), i64 %indvars.iv, i64 %indvars.iv57
  %9 = load double, ptr %arrayidx17, align 8, !tbaa !5
  %arrayidx21 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 20, i64 0, i64 0), i64 %indvars.iv, i64 %indvars.iv57
  %10 = load double, ptr %arrayidx21, align 8, !tbaa !5
  %11 = tail call double @llvm.fmuladd.f64(double %9, double %10, double %8)
  %arrayidx26 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), i64 %indvars.iv, i64 %indvars.iv57
  store double %11, ptr %arrayidx26, align 8, !tbaa !5
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, 256
  br i1 %exitcond.not, label %for.inc27, label %for.body9.1

for.body9.1:                                      ; preds = %for.body9
  %arrayidx17.1 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), i64 %indvars.iv.next, i64 %indvars.iv57
  %12 = load double, ptr %arrayidx17.1, align 8, !tbaa !5
  %arrayidx21.1 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 20, i64 0, i64 0), i64 %indvars.iv.next, i64 %indvars.iv57
  %13 = load double, ptr %arrayidx21.1, align 8, !tbaa !5
  %14 = tail call double @llvm.fmuladd.f64(double %12, double %13, double %11)
  %arrayidx26.1 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), i64 %indvars.iv.next, i64 %indvars.iv57
  store double %14, ptr %arrayidx26.1, align 8, !tbaa !5
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  br label %for.body9

for.inc27:                                        ; preds = %for.body9, %for.body4
  %indvars.iv.next58 = add nuw nsw i64 %indvars.iv57, 1
  %exitcond60.not = icmp eq i64 %indvars.iv.next58, 256
  br i1 %exitcond60.not, label %for.cond.cleanup3, label %for.body4
}
...
entry:
  %call = tail call i32 @init(ptr noundef nonnull @.str.57)
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
  %cmp61 = icmp sgt i32 %0, 255
  br i1 %cmp61, label %for.cond1.preheader, label %for.cond.cleanup

for.cond1.preheader:                              ; preds = %entry, %for.cond.cleanup3
  %nl.062 = phi i32 [ %inc38, %for.cond.cleanup3 ], [ 0, %entry ]
  br label %for.cond5.preheader

for.cond.cleanup:                                 ; preds = %for.cond.cleanup3, %entry
  %call41 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.145, double noundef 0.000000e+00)
  br label %for.cond18.preheader.i
...
for.cond5.preheader:                              ; preds = %for.cond1.preheader, %for.cond.cleanup7
  %indvars.iv64 = phi i64 [ 0, %for.cond1.preheader ], [ %indvars.iv.next65, %for.cond.cleanup7 ]
  br label %for.body8

for.cond.cleanup3:                                ; preds = %for.cond.cleanup7
  %call36 = tail call i32 @dummy(ptr noundef nonnull @global_data, ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 11, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 20, i64 0, i64 0), double noundef 0.000000e+00) #17
  %inc38 = add nuw nsw i32 %nl.062, 1
  %6 = load i32, ptr @ntimes, align 4, !tbaa !17
  %div = sdiv i32 %6, 256
  %mul = mul nsw i32 %div, 100
  %cmp = icmp slt i32 %inc38, %mul
  br i1 %cmp, label %for.cond1.preheader, label %for.cond.cleanup

for.cond.cleanup7:                                ; preds = %for.body8
  %arrayidx25 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %indvars.iv64
  %7 = load double, ptr %arrayidx25, align 8, !tbaa !5
  %arrayidx27 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 %indvars.iv64
  %8 = load double, ptr %arrayidx27, align 8, !tbaa !5
  %arrayidx29 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 %indvars.iv64
  %9 = load double, ptr %arrayidx29, align 8, !tbaa !5
  %10 = tail call double @llvm.fmuladd.f64(double %8, double %9, double %7)
  %arrayidx32 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv64
  store double %10, ptr %arrayidx32, align 8, !tbaa !5
...
for.body8:                                        ; preds = %for.body8, %for.cond5.preheader
  ...
  %arrayidx10 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), i64 %indvars.iv, i64 %indvars.iv64
  %11 = load double, ptr %arrayidx10, align 8, !tbaa !5
  %arrayidx14 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), i64 %indvars.iv, i64 %indvars.iv64
  %12 = load double, ptr %arrayidx14, align 8, !tbaa !5
  %arrayidx18 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 20, i64 0, i64 0), i64 %indvars.iv, i64 %indvars.iv64
  %13 = load double, ptr %arrayidx18, align 8, !tbaa !5
  %14 = tail call double @llvm.fmuladd.f64(double %12, double %13, double %11)
  store double %14, ptr %arrayidx10, align 8, !tbaa !5
  %indvars.iv.next = or i64 %indvars.iv, 1
  %arrayidx10.1 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), i64 %indvars.iv.next, i64 %indvars.iv64
  %15 = load double, ptr %arrayidx10.1, align 8, !tbaa !5
  %arrayidx14.1 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), i64 %indvars.iv.next, i64 %indvars.iv64
  %16 = load double, ptr %arrayidx14.1, align 8, !tbaa !5
  %arrayidx18.1 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 20, i64 0, i64 0), i64 %indvars.iv.next, i64 %indvars.iv64
  %17 = load double, ptr %arrayidx18.1, align 8, !tbaa !5
  %18 = tail call double @llvm.fmuladd.f64(double %16, double %17, double %15)
  store double %18, ptr %arrayidx10.1, align 8, !tbaa !5
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
...
entry:
  %call = tail call i32 @init(ptr noundef nonnull @.str.58)
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
  %cmp34 = icmp sgt i32 %0, 0
  br i1 %cmp34, label %for.cond1.preheader, label %for.cond.cleanup

for.cond1.preheader:                              ; preds = %entry, %for.cond.cleanup3
  %nl.035 = phi i32 [ %inc20, %for.cond.cleanup3 ], [ 0, %entry ]
  br label %for.body4

for.cond.cleanup:                                 ; preds = %for.cond.cleanup3, %entry
  %call22 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.146, double noundef 0.000000e+00)
  br label %for.body.i
...
for.cond.cleanup3:                                ; preds = %for.body4
  %call18 = tail call i32 @dummy(ptr noundef nonnull @global_data, ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 11, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 20, i64 0, i64 0), double noundef 0.000000e+00) #17
  %inc20 = add nuw nsw i32 %nl.035, 1
  %7 = load i32, ptr @ntimes, align 4, !tbaa !17
  %mul = shl nsw i32 %7, 2
  %cmp = icmp slt i32 %inc20, %mul
  br i1 %cmp, label %for.cond1.preheader, label %for.cond.cleanup

for.body4:                                        ; preds = %for.cond1.preheader, %for.body4
  %indvars.iv = phi i64 [ 0, %for.cond1.preheader ], [ %indvars.iv.next, %for.body4 ]
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %cmp5 = icmp ult i64 %indvars.iv, 15999
  %arrayidx = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %indvars.iv
  %8 = load double, ptr %arrayidx, align 8, !tbaa !5
  %arrayidx10 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv
  %9 = load double, ptr %arrayidx10, align 8, !tbaa !5
  %arrayidx7 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 %indvars.iv
  %arrayidx14 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 %indvars.iv
  %arrayidx7.sink = select i1 %cmp5, ptr %arrayidx7, ptr %arrayidx14
  %10 = load double, ptr %arrayidx7.sink, align 8, !tbaa !5
  %11 = tail call double @llvm.fmuladd.f64(double %8, double %10, double %9)
  store double %11, ptr %arrayidx10, align 8, !tbaa !5
  %exitcond.not = icmp eq i64 %indvars.iv.next, 32000
  br i1 %exitcond.not, label %for.cond.cleanup3, label %for.body4
}
...
entry:
  %call = tail call i32 @init(ptr noundef nonnull @.str.59)
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
  %cmp42 = icmp sgt i32 %0, 0
  br i1 %cmp42, label %for.cond1.preheader, label %for.cond.cleanup

for.cond1.preheader:                              ; preds = %entry, %for.cond.cleanup3
  %nl.043 = phi i32 [ %inc27, %for.cond.cleanup3 ], [ 0, %entry ]
  br label %for.body4

for.cond.cleanup:                                 ; preds = %for.cond.cleanup3, %entry
  %call29 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.147, double noundef 0.000000e+00)
  br label %for.body.i
...
for.cond.cleanup3:                                ; preds = %for.inc
  %call25 = tail call i32 @dummy(ptr noundef nonnull @global_data, ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 11, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 20, i64 0, i64 0), double noundef 0.000000e+00) #17
  %inc27 = add nuw nsw i32 %nl.043, 1
  %6 = load i32, ptr @ntimes, align 4, !tbaa !17
...
for.body4:                                        ; preds = %for.cond1.preheader, %for.inc
  ...
  %arrayidx = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv
  %7 = load double, ptr %arrayidx, align 8, !tbaa !5
  %cmp5 = fcmp ult double %7, 0.000000e+00
  br i1 %cmp5, label %if.end, label %for.body4.for.inc_crit_edge
...
if.end:                                           ; preds = %for.body4
  %arrayidx7 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %indvars.iv
  %8 = load double, ptr %arrayidx7, align 8, !tbaa !5
  %cmp8 = fcmp ult double %8, 0.000000e+00
  %arrayidx12 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 %indvars.iv
  %9 = load double, ptr %arrayidx12, align 8, !tbaa !5
  %arrayidx14 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 %indvars.iv
  %10 = load double, ptr %arrayidx14, align 8, !tbaa !5
  br i1 %cmp8, label %if.end10, label %L30

if.end10:                                         ; preds = %if.end
  %11 = tail call double @llvm.fmuladd.f64(double %9, double %10, double %7)
  store double %11, ptr %arrayidx, align 8, !tbaa !5
  br label %L30

L30:                                              ; preds = %if.end, %if.end10
  %arrayidx22 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 11, i64 %indvars.iv
  %12 = load double, ptr %arrayidx22, align 8, !tbaa !5
  %13 = tail call double @llvm.fmuladd.f64(double %10, double %12, double %9)
  %14 = add nuw nsw i64 %indvars.iv, 1
  %arrayidx24 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %14
  store double %13, ptr %arrayidx24, align 8, !tbaa !5
  br label %for.inc

for.inc:                                          ; preds = %for.body4.for.inc_crit_edge, %L30
  %indvars.iv.next.pre-phi = phi i64 [ %.pre47, %for.body4.for.inc_crit_edge ], [ %14, %L30 ]
  %exitcond.not = icmp eq i64 %indvars.iv.next.pre-phi, 31999
  br i1 %exitcond.not, label %for.cond.cleanup3, label %for.body4
}
...
entry:
  %call = tail call i32 @init(ptr noundef nonnull @.str.60)
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
  %cmp52 = icmp sgt i32 %0, 0
  br i1 %cmp52, label %for.cond1.preheader, label %for.cond.cleanup

for.cond1.preheader:                              ; preds = %entry, %for.cond.cleanup3
  %nl.053 = phi i32 [ %inc33, %for.cond.cleanup3 ], [ 0, %entry ]
  br label %for.body4

for.cond.cleanup:                                 ; preds = %for.cond.cleanup3, %entry
  %call35 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.148, double noundef 0.000000e+00)
  br label %for.body.i
...
for.body.i:                                       ; preds = %for.body.i, %for.cond.cleanup
  ...
  %add3.i = fadd double %sumb.0193.i, %2
  %arrayidx5.i = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 %indvars.iv.i
  %3 = load double, ptr %arrayidx5.i, align 16, !tbaa !5
  %add6.i = fadd double %sumc.0194.i, %3
  %indvars.iv.next.i = or i64 %indvars.iv.i, 1
  %arrayidx.i.1 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv.next.i
  %4 = load double, ptr %arrayidx.i.1, align 8, !tbaa !5
  %add.i.1 = fadd double %add.i, %4
  %arrayidx2.i.1 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %indvars.iv.next.i
  %5 = load double, ptr %arrayidx2.i.1, align 8, !tbaa !5
  %add3.i.1 = fadd double %add3.i, %5
  %arrayidx5.i.1 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 %indvars.iv.next.i
  %6 = load double, ptr %arrayidx5.i.1, align 8, !tbaa !5
  %add6.i.1 = fadd double %add6.i, %6
  %indvars.iv.next.i.1 = add nuw nsw i64 %indvars.iv.i, 2
  %exitcond.not.i.1 = icmp eq i64 %indvars.iv.next.i.1, 32000
  br i1 %exitcond.not.i.1, label %for.cond18.preheader.i.preheader, label %for.body.i

for.cond18.preheader.i.preheader:                 ; preds = %for.body.i
  %7 = load i32, ptr @digits, align 4, !tbaa !17
  %add104.i = fadd double %add.i.1, %add3.i.1
  %add105.i = fadd double %add104.i, %add6.i.1
  %call106.i = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %7, double noundef %add105.i)
  ret i32 0

for.cond.cleanup3:                                ; preds = %L30
  ...
  %inc33 = add nuw nsw i32 %nl.053, 1
  %8 = load i32, ptr @ntimes, align 4, !tbaa !17
  %cmp = icmp slt i32 %inc33, %8
  br i1 %cmp, label %for.cond1.preheader, label %for.cond.cleanup

for.body4:                                        ; preds = %for.cond1.preheader, %L30
  %indvars.iv = phi i64 [ 0, %for.cond1.preheader ], [ %indvars.iv.next, %L30 ]
  %arrayidx = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv
  %9 = load double, ptr %arrayidx, align 8, !tbaa !5
  %cmp5 = fcmp ogt double %9, 0.000000e+00
  %arrayidx18 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 %indvars.iv
  %10 = load double, ptr %arrayidx18, align 8, !tbaa !5
  %arrayidx20 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 11, i64 %indvars.iv
  %11 = load double, ptr %arrayidx20, align 8, !tbaa !5
  br i1 %cmp5, label %L20, label %if.end

if.end:                                           ; preds = %for.body4
  %arrayidx7 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %indvars.iv
  %12 = load double, ptr %arrayidx7, align 8, !tbaa !5
  %fneg = fneg double %12
  %13 = tail call double @llvm.fmuladd.f64(double %10, double %11, double %fneg)
  store double %13, ptr %arrayidx7, align 8, !tbaa !5
  %arrayidx26.phi.trans.insert = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 %indvars.iv
  %.pre55 = load double, ptr %arrayidx26.phi.trans.insert, align 8, !tbaa !5
  br label %L30

L20:                                              ; preds = %for.body4
  %arrayidx15 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 %indvars.iv
  %14 = load double, ptr %arrayidx15, align 8, !tbaa !5
  %fneg16 = fneg double %14
  %15 = tail call double @llvm.fmuladd.f64(double %10, double %11, double %fneg16)
  store double %15, ptr %arrayidx15, align 8, !tbaa !5
  %arrayidx24.phi.trans.insert = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %indvars.iv
  %.pre = load double, ptr %arrayidx24.phi.trans.insert, align 8, !tbaa !5
  br label %L30

L30:                                              ; preds = %L20, %if.end
  %16 = phi double [ %15, %L20 ], [ %.pre55, %if.end ]
  %17 = phi double [ %.pre, %L20 ], [ %13, %if.end ]
  %18 = tail call double @llvm.fmuladd.f64(double %16, double %10, double %17)
  store double %18, ptr %arrayidx, align 8, !tbaa !5
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, 32000
  br i1 %exitcond.not, label %for.cond.cleanup3, label %for.body4
}
...
entry:
  %call = tail call i32 @init(ptr noundef nonnull @.str.61)
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
  %cmp72 = icmp sgt i32 %0, 1
  br i1 %cmp72, label %for.cond1.preheader, label %for.cond.cleanup

for.cond1.preheader:                              ; preds = %entry, %for.cond.cleanup3
  %nl.073 = phi i32 [ %inc46, %for.cond.cleanup3 ], [ 0, %entry ]
  br label %for.body4

for.cond.cleanup:                                 ; preds = %for.cond.cleanup3, %entry
  %call49 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.149, double noundef 0.000000e+00)
  br label %for.body.i
...
for.cond.cleanup3:                                ; preds = %L30
  %call44 = tail call i32 @dummy(ptr noundef nonnull @global_data, ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 11, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 20, i64 0, i64 0), double noundef 0.000000e+00) #17
  %inc46 = add nuw nsw i32 %nl.073, 1
  %8 = load i32, ptr @ntimes, align 4, !tbaa !17
  %div = sdiv i32 %8, 2
  %cmp = icmp slt i32 %inc46, %div
  br i1 %cmp, label %for.cond1.preheader, label %for.cond.cleanup
...
if.end:                                           ; preds = %for.body4
  %arrayidx7 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %indvars.iv
  %10 = load double, ptr %arrayidx7, align 8, !tbaa !5
  %fneg = fneg double %10
  %arrayidx9 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 %indvars.iv
  %11 = load double, ptr %arrayidx9, align 8, !tbaa !5
  %12 = tail call double @llvm.fmuladd.f64(double %11, double %11, double %fneg)
  store double %12, ptr %arrayidx7, align 8, !tbaa !5
  %cmp18 = fcmp ugt double %12, %9
  br i1 %cmp18, label %if.end20, label %if.end.L30_crit_edge

if.end.L30_crit_edge:                             ; preds = %if.end
  %arrayidx39.phi.trans.insert = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 %indvars.iv
  %.pre75 = load double, ptr %arrayidx39.phi.trans.insert, align 8, !tbaa !5
  br label %L30

if.end20:                                         ; preds = %if.end
  %arrayidx24 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 11, i64 %indvars.iv
  %13 = load double, ptr %arrayidx24, align 8, !tbaa !5
  %arrayidx26 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 %indvars.iv
  %14 = load double, ptr %arrayidx26, align 8, !tbaa !5
  %15 = tail call double @llvm.fmuladd.f64(double %11, double %13, double %14)
  store double %15, ptr %arrayidx26, align 8, !tbaa !5
  br label %L30

L20:                                              ; preds = %for.body4
  %arrayidx28 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 %indvars.iv
  %16 = load double, ptr %arrayidx28, align 8, !tbaa !5
  %fneg29 = fneg double %16
  %arrayidx31 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 11, i64 %indvars.iv
  %17 = load double, ptr %arrayidx31, align 8, !tbaa !5
  %18 = tail call double @llvm.fmuladd.f64(double %17, double %17, double %fneg29)
  store double %18, ptr %arrayidx28, align 8, !tbaa !5
  %arrayidx37.phi.trans.insert = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %indvars.iv
  %.pre = load double, ptr %arrayidx37.phi.trans.insert, align 8, !tbaa !5
  %arrayidx41.phi.trans.insert = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 %indvars.iv
  %.pre76 = load double, ptr %arrayidx41.phi.trans.insert, align 8, !tbaa !5
  br label %L30

L30:                                              ; preds = %if.end.L30_crit_edge, %L20, %if.end20
  %19 = phi double [ %11, %if.end.L30_crit_edge ], [ %.pre76, %L20 ], [ %11, %if.end20 ]
  %20 = phi double [ %.pre75, %if.end.L30_crit_edge ], [ %18, %L20 ], [ %15, %if.end20 ]
  %21 = phi double [ %12, %if.end.L30_crit_edge ], [ %.pre, %L20 ], [ %12, %if.end20 ]
  %22 = tail call double @llvm.fmuladd.f64(double %20, double %19, double %21)
  store double %22, ptr %arrayidx, align 8, !tbaa !5
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, 32000
  br i1 %exitcond.not, label %for.cond.cleanup3, label %for.body4
}
...
for.cond1.preheader:                              ; preds = %entry, %for.cond.cleanup3
  %nl.034 = phi i32 [ %inc21, %for.cond.cleanup3 ], [ 0, %entry ]
  br label %for.body4

for.cond.cleanup:                                 ; preds = %for.cond.cleanup3, %entry
  %call23 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.150, double noundef 0.000000e+00)
  br label %for.body.i
...
for.cond.cleanup3:                                ; preds = %for.inc
  ...
  %inc21 = add nuw nsw i32 %nl.034, 1
  %8 = load i32, ptr @ntimes, align 4, !tbaa !17
  %cmp = icmp slt i32 %inc21, %8
  br i1 %cmp, label %for.cond1.preheader, label %for.cond.cleanup
...
for.body4:                                        ; preds = %for.cond1.preheader, %for.inc
  ...
  %arrayidx = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv
  %9 = load double, ptr %arrayidx, align 8, !tbaa !5
  %cmp5 = fcmp olt double %9, 0.000000e+00
  br i1 %cmp5, label %if.then, label %for.inc

if.then:                                          ; preds = %for.body4
  %arrayidx7 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %indvars.iv
  %10 = load double, ptr %arrayidx7, align 8, !tbaa !5
  %cmp10 = fcmp ogt double %10, %9
  br i1 %cmp10, label %if.then11, label %for.inc

if.then11:                                        ; preds = %if.then
  %arrayidx13 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 %indvars.iv
  %11 = load double, ptr %arrayidx13, align 8, !tbaa !5
  %arrayidx15 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 11, i64 %indvars.iv
  %12 = load double, ptr %arrayidx15, align 8, !tbaa !5
  %arrayidx17 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 %indvars.iv
  %13 = load double, ptr %arrayidx17, align 8, !tbaa !5
  %14 = tail call double @llvm.fmuladd.f64(double %11, double %12, double %13)
  store double %14, ptr %arrayidx17, align 8, !tbaa !5
  br label %for.inc
...
; Function Attrs: nounwind uwtable
define dso_local i32 @s2710(double noundef %x) local_unnamed_addr #7 {
entry:
  %call = tail call i32 @init(ptr noundef nonnull @.str.62)
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
  %cmp76 = icmp sgt i32 %0, 1
  br i1 %cmp76, label %for.cond1.preheader.lr.ph, label %for.cond.cleanup

for.cond1.preheader.lr.ph:                        ; preds = %entry
  %cmp28 = fcmp ogt double %x, 0.000000e+00
  br i1 %cmp28, label %for.cond1.preheader.us, label %for.cond1.preheader

for.cond1.preheader.us:                           ; preds = %for.cond1.preheader.lr.ph, %for.cond.cleanup3.split.us.us
  %nl.077.us = phi i32 [ %inc48.us, %for.cond.cleanup3.split.us.us ], [ 0, %for.cond1.preheader.lr.ph ]
  br label %for.body4.us.us

for.body4.us.us:                                  ; preds = %for.inc.us.us, %for.cond1.preheader.us
  %indvars.iv80 = phi i64 [ %indvars.iv.next81, %for.inc.us.us ], [ 0, %for.cond1.preheader.us ]
  %arrayidx.us.us = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv80
  %1 = load double, ptr %arrayidx.us.us, align 8, !tbaa !5
  %arrayidx6.us.us = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %indvars.iv80
  %2 = load double, ptr %arrayidx6.us.us, align 8, !tbaa !5
  %cmp7.us.us = fcmp ogt double %1, %2
  br i1 %cmp7.us.us, label %if.then.us.us, label %if.else.us.us

if.else.us.us:                                    ; preds = %for.body4.us.us
  %arrayidx23.us.us = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 11, i64 %indvars.iv80
  %3 = load double, ptr %arrayidx23.us.us, align 8, !tbaa !5
  %4 = tail call double @llvm.fmuladd.f64(double %3, double %3, double %1)
  store double %4, ptr %arrayidx6.us.us, align 8, !tbaa !5
  %arrayidx33.us.us = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 %indvars.iv80
  %5 = load double, ptr %arrayidx33.us.us, align 8, !tbaa !5
  %6 = tail call double @llvm.fmuladd.f64(double %5, double %5, double %1)
  %arrayidx37.us.us = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 %indvars.iv80
  store double %6, ptr %arrayidx37.us.us, align 8, !tbaa !5
  br label %for.inc.us.us

if.then.us.us:                                    ; preds = %for.body4.us.us
  %arrayidx11.us.us = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 %indvars.iv80
  %7 = load double, ptr %arrayidx11.us.us, align 8, !tbaa !5
  %8 = tail call double @llvm.fmuladd.f64(double %2, double %7, double %1)
  store double %8, ptr %arrayidx.us.us, align 8, !tbaa !5
  %arrayidx19.us.us = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 %indvars.iv80
  %9 = load double, ptr %arrayidx19.us.us, align 8, !tbaa !5
  %10 = tail call double @llvm.fmuladd.f64(double %7, double %7, double %9)
  store double %10, ptr %arrayidx19.us.us, align 8, !tbaa !5
  br label %for.inc.us.us

for.inc.us.us:                                    ; preds = %if.then.us.us, %if.else.us.us
  %indvars.iv.next81 = add nuw nsw i64 %indvars.iv80, 1
  %exitcond83.not = icmp eq i64 %indvars.iv.next81, 32000
  br i1 %exitcond83.not, label %for.cond.cleanup3.split.us.us, label %for.body4.us.us

for.cond.cleanup3.split.us.us:                    ; preds = %for.inc.us.us
  %call46.us = tail call i32 @dummy(ptr noundef nonnull @global_data, ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 11, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 20, i64 0, i64 0), double noundef 0.000000e+00) #17
  %inc48.us = add nuw nsw i32 %nl.077.us, 1
  %11 = load i32, ptr @ntimes, align 4, !tbaa !17
  %div.us = sdiv i32 %11, 2
  %cmp.us = icmp slt i32 %inc48.us, %div.us
  br i1 %cmp.us, label %for.cond1.preheader.us, label %for.cond.cleanup

for.cond1.preheader:                              ; preds = %for.cond1.preheader.lr.ph, %for.cond.cleanup3.split
  %nl.077 = phi i32 [ %inc48, %for.cond.cleanup3.split ], [ 0, %for.cond1.preheader.lr.ph ]
  br label %for.body4

for.cond.cleanup:                                 ; preds = %for.cond.cleanup3.split, %for.cond.cleanup3.split.us.us, %entry
  %call51 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.151, double noundef 0.000000e+00)
  br label %for.body.i
...
for.body.i:                                       ; preds = %for.body.i, %for.cond.cleanup
  ...
  %suma.0192.i = phi double [ 0.000000e+00, %for.cond.cleanup ], [ %add.i.1, %for.body.i ]
  %arrayidx.i = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv.i
  %12 = load double, ptr %arrayidx.i, align 16, !tbaa !5
  %add.i = fadd double %suma.0192.i, %12
  %arrayidx2.i = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %indvars.iv.i
  %13 = load double, ptr %arrayidx2.i, align 16, !tbaa !5
  %add3.i = fadd double %sumb.0193.i, %13
  %arrayidx5.i = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 %indvars.iv.i
  %14 = load double, ptr %arrayidx5.i, align 16, !tbaa !5
  %add6.i = fadd double %sumc.0194.i, %14
  %indvars.iv.next.i = or i64 %indvars.iv.i, 1
  %arrayidx.i.1 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv.next.i
  %15 = load double, ptr %arrayidx.i.1, align 8, !tbaa !5
  %add.i.1 = fadd double %add.i, %15
  %arrayidx2.i.1 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %indvars.iv.next.i
  %16 = load double, ptr %arrayidx2.i.1, align 8, !tbaa !5
  %add3.i.1 = fadd double %add3.i, %16
  %arrayidx5.i.1 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 %indvars.iv.next.i
  %17 = load double, ptr %arrayidx5.i.1, align 8, !tbaa !5
  %add6.i.1 = fadd double %add6.i, %17
  %indvars.iv.next.i.1 = add nuw nsw i64 %indvars.iv.i, 2
  %exitcond.not.i.1 = icmp eq i64 %indvars.iv.next.i.1, 32000
  br i1 %exitcond.not.i.1, label %for.cond18.preheader.i.preheader, label %for.body.i
...
for.cond18.preheader.i.preheader:                 ; preds = %for.body.i
  ...
  %add104.i = fadd double %add.i.1, %add3.i.1
  %add105.i = fadd double %add104.i, %add6.i.1
  %call106.i = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %18, double noundef %add105.i)
  ret i32 0

for.cond.cleanup3.split:                          ; preds = %for.inc
  %call46 = tail call i32 @dummy(ptr noundef nonnull @global_data, ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 11, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 20, i64 0, i64 0), double noundef 0.000000e+00) #17
  %inc48 = add nuw nsw i32 %nl.077, 1
  %19 = load i32, ptr @ntimes, align 4, !tbaa !17
  %div = sdiv i32 %19, 2
  %cmp = icmp slt i32 %inc48, %div
  br i1 %cmp, label %for.cond1.preheader, label %for.cond.cleanup

for.body4:                                        ; preds = %for.cond1.preheader, %for.inc
  %indvars.iv = phi i64 [ 0, %for.cond1.preheader ], [ %indvars.iv.next, %for.inc ]
  %arrayidx = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv
  %20 = load double, ptr %arrayidx, align 8, !tbaa !5
  %arrayidx6 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %indvars.iv
  %21 = load double, ptr %arrayidx6, align 8, !tbaa !5
  %cmp7 = fcmp ogt double %20, %21
  %arrayidx19 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 %indvars.iv
  br i1 %cmp7, label %if.then, label %if.else

if.then:                                          ; preds = %for.body4
  %arrayidx11 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 %indvars.iv
  %22 = load double, ptr %arrayidx11, align 8, !tbaa !5
  %23 = tail call double @llvm.fmuladd.f64(double %21, double %22, double %20)
  store double %23, ptr %arrayidx, align 8, !tbaa !5
  %24 = load double, ptr %arrayidx19, align 8, !tbaa !5
  %25 = tail call double @llvm.fmuladd.f64(double %22, double %22, double %24)
  br label %for.inc

if.else:                                          ; preds = %for.body4
  %arrayidx23 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 11, i64 %indvars.iv
  %26 = load double, ptr %arrayidx23, align 8, !tbaa !5
  %27 = tail call double @llvm.fmuladd.f64(double %26, double %26, double %20)
  store double %27, ptr %arrayidx6, align 8, !tbaa !5
  %28 = load double, ptr %arrayidx19, align 8, !tbaa !5
  %29 = tail call double @llvm.fmuladd.f64(double %26, double %26, double %28)
  br label %for.inc

for.inc:                                          ; preds = %if.then, %if.else
  %.sink = phi double [ %25, %if.then ], [ %29, %if.else ]
  store double %.sink, ptr %arrayidx19, align 8, !tbaa !5
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, 32000
  br i1 %exitcond.not, label %for.cond.cleanup3.split, label %for.body4
}

; Function Attrs: nounwind uwtable
define dso_local i32 @s2711() local_unnamed_addr #7 {
entry:
  %call = tail call i32 @init(ptr noundef nonnull @.str.63)
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
  %cmp26 = icmp sgt i32 %0, 0
  br i1 %cmp26, label %for.cond1.preheader, label %for.cond.cleanup
...
for.cond.cleanup:                                 ; preds = %for.cond.cleanup3, %entry
  %call17 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.152, double noundef 0.000000e+00)
  br label %for.body.i
...
entry:
  %call = tail call i32 @init(ptr noundef nonnull @.str.64)
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
  %cmp30 = icmp sgt i32 %0, 0
  br i1 %cmp30, label %vector.ph, label %for.cond.cleanup

vector.ph:                                        ; preds = %entry, %for.cond.cleanup3
  %nl.031 = phi i32 [ %inc17, %for.cond.cleanup3 ], [ 0, %entry ]
  br label %vector.body

vector.body:                                      ; preds = %pred.store.continue43, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %pred.store.continue43 ]
  %1 = or i64 %index, 2
  %2 = getelementptr inbounds double, ptr @global_data, i64 %index
  %wide.load = load <2 x double>, ptr %2, align 32, !tbaa !5
  %3 = getelementptr inbounds double, ptr %2, i64 2
  %wide.load33 = load <2 x double>, ptr %3, align 16, !tbaa !5
  %4 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %index
  %wide.load34 = load <2 x double>, ptr %4, align 32, !tbaa !5
  %5 = getelementptr inbounds double, ptr %4, i64 2
  %wide.load35 = load <2 x double>, ptr %5, align 16, !tbaa !5
  %6 = fcmp ogt <2 x double> %wide.load, %wide.load34
  %7 = fcmp ogt <2 x double> %wide.load33, %wide.load35
  %8 = getelementptr %struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 %index
  %wide.load36 = load <2 x double>, ptr %8, align 32, !tbaa !5
  %9 = getelementptr double, ptr %8, i64 2
  %wide.load37 = load <2 x double>, ptr %9, align 16, !tbaa !5
  %10 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %wide.load34, <2 x double> %wide.load36, <2 x double> %wide.load)
  %11 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %wide.load35, <2 x double> %wide.load37, <2 x double> %wide.load33)
  %12 = extractelement <2 x i1> %6, i64 0
  br i1 %12, label %pred.store.if, label %pred.store.continue

pred.store.if:                                    ; preds = %vector.body
  %13 = getelementptr inbounds double, ptr @global_data, i64 %index
  %14 = extractelement <2 x double> %10, i64 0
  store double %14, ptr %13, align 32, !tbaa !5
  br label %pred.store.continue

pred.store.continue:                              ; preds = %pred.store.if, %vector.body
  %15 = extractelement <2 x i1> %6, i64 1
  br i1 %15, label %pred.store.if38, label %pred.store.continue39

pred.store.if38:                                  ; preds = %pred.store.continue
  %16 = or i64 %index, 1
  %17 = getelementptr inbounds double, ptr @global_data, i64 %16
...
pred.store.continue39:                            ; preds = %pred.store.if38, %pred.store.continue
  %19 = extractelement <2 x i1> %7, i64 0
  br i1 %19, label %pred.store.if40, label %pred.store.continue41

pred.store.if40:                                  ; preds = %pred.store.continue39
  %20 = getelementptr inbounds double, ptr @global_data, i64 %1
  %21 = extractelement <2 x double> %11, i64 0
  store double %21, ptr %20, align 16, !tbaa !5
  br label %pred.store.continue41

pred.store.continue41:                            ; preds = %pred.store.if40, %pred.store.continue39
  %22 = extractelement <2 x i1> %7, i64 1
  br i1 %22, label %pred.store.if42, label %pred.store.continue43
...
pred.store.if42:                                  ; preds = %pred.store.continue41
  ...
  store double %25, ptr %24, align 8, !tbaa !5
  br label %pred.store.continue43

pred.store.continue43:                            ; preds = %pred.store.if42, %pred.store.continue41
  %index.next = add nuw i64 %index, 4
  %26 = icmp eq i64 %index.next, 32000
  br i1 %26, label %for.cond.cleanup3, label %vector.body, !llvm.loop !370

for.cond.cleanup:                                 ; preds = %for.cond.cleanup3, %entry
  %call19 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.153, double noundef 0.000000e+00)
  br label %for.body.i
...
for.body.i:                                       ; preds = %for.body.i, %for.cond.cleanup
  ...
  %suma.0192.i = phi double [ 0.000000e+00, %for.cond.cleanup ], [ %add.i.4, %for.body.i ]
  %arrayidx.i = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv.i
  %27 = load double, ptr %arrayidx.i, align 8, !tbaa !5
  %add.i = fadd double %suma.0192.i, %27
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1
  %arrayidx.i.1 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv.next.i
  %28 = load double, ptr %arrayidx.i.1, align 8, !tbaa !5
  %add.i.1 = fadd double %add.i, %28
  %indvars.iv.next.i.1 = add nuw nsw i64 %indvars.iv.i, 2
  %arrayidx.i.2 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv.next.i.1
  %29 = load double, ptr %arrayidx.i.2, align 8, !tbaa !5
  %add.i.2 = fadd double %add.i.1, %29
  %indvars.iv.next.i.2 = add nuw nsw i64 %indvars.iv.i, 3
  %arrayidx.i.3 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv.next.i.2
  %30 = load double, ptr %arrayidx.i.3, align 8, !tbaa !5
  %add.i.3 = fadd double %add.i.2, %30
  %indvars.iv.next.i.3 = add nuw nsw i64 %indvars.iv.i, 4
  %arrayidx.i.4 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv.next.i.3
  %31 = load double, ptr %arrayidx.i.4, align 8, !tbaa !5
  %add.i.4 = fadd double %add.i.3, %31
  %indvars.iv.next.i.4 = add nuw nsw i64 %indvars.iv.i, 5
  %exitcond.not.i.4 = icmp eq i64 %indvars.iv.next.i.4, 32000
  br i1 %exitcond.not.i.4, label %for.cond18.preheader.i.preheader, label %for.body.i

for.cond18.preheader.i.preheader:                 ; preds = %for.body.i
  %32 = load i32, ptr @digits, align 4, !tbaa !17
  %call.i = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %32, double noundef %add.i.4)
  ret i32 0

for.cond.cleanup3:                                ; preds = %pred.store.continue43
  %call15 = tail call i32 @dummy(ptr noundef nonnull @global_data, ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 11, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 20, i64 0, i64 0), double noundef 0.000000e+00) #17
  %inc17 = add nuw nsw i32 %nl.031, 1
  %33 = load i32, ptr @ntimes, align 4, !tbaa !17
  %mul = shl nsw i32 %33, 2
  %cmp = icmp slt i32 %inc17, %mul
  br i1 %cmp, label %vector.ph, label %for.cond.cleanup
}
...
entry:
  %call = tail call i32 @init(ptr noundef nonnull @.str.107)
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
  %cmp49 = icmp sgt i32 %0, 0
  br i1 %cmp49, label %for.cond1.preheader, label %for.cond.cleanup

for.cond1.preheader:                              ; preds = %entry, %for.cond.cleanup3
  %nl.050 = phi i32 [ %inc32, %for.cond.cleanup3 ], [ 0, %entry ]
  br label %for.body4

for.cond.cleanup:                                 ; preds = %for.cond.cleanup3, %entry
  %call34 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.154, double noundef 0.000000e+00)
  br label %for.body.i
...
for.cond.cleanup3:                                ; preds = %for.inc
  %call30 = tail call i32 @dummy(ptr noundef nonnull @global_data, ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 11, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 20, i64 0, i64 0), double noundef 0.000000e+00) #17
  %inc32 = add nuw nsw i32 %nl.050, 1
  %7 = load i32, ptr @ntimes, align 4, !tbaa !17
...
for.body4:                                        ; preds = %for.cond1.preheader, %for.inc
  %indvars.iv = phi i64 [ 0, %for.cond1.preheader ], [ %indvars.iv.next, %for.inc ]
  %arrayidx = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 %indvars.iv
  %8 = load double, ptr %arrayidx, align 8, !tbaa !5
...
if.then:                                          ; preds = %for.body4
  ...
  %arrayidx11 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv
  %11 = load double, ptr %arrayidx11, align 8, !tbaa !5
  %12 = tail call double @llvm.fmuladd.f64(double %9, double %10, double %11)
  store double %12, ptr %arrayidx11, align 8, !tbaa !5
  br label %for.inc

if.else:                                          ; preds = %for.body4
  %cmp14 = fcmp oeq double %8, 0.000000e+00
  %arrayidx21 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv
  %13 = load double, ptr %arrayidx21, align 8, !tbaa !5
  br i1 %cmp14, label %if.then15, label %if.else22

if.then15:                                        ; preds = %if.else
  %arrayidx17 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %indvars.iv
  %14 = load double, ptr %arrayidx17, align 8, !tbaa !5
  %15 = tail call double @llvm.fmuladd.f64(double %14, double %14, double %13)
  store double %15, ptr %arrayidx21, align 8, !tbaa !5
  br label %for.inc

if.else22:                                        ; preds = %if.else
  %arrayidx24 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 %indvars.iv
  %16 = load double, ptr %arrayidx24, align 8, !tbaa !5
  %17 = tail call double @llvm.fmuladd.f64(double %16, double %16, double %13)
  store double %17, ptr %arrayidx21, align 8, !tbaa !5
  br label %for.inc

for.inc:                                          ; preds = %if.then, %if.else22, %if.then15
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, 32000
  br i1 %exitcond.not, label %for.cond.cleanup3, label %for.body4
}
...
entry:
  %call = tail call i32 @init(ptr noundef nonnull @.str.108)
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
  %cmp55 = icmp sgt i32 %0, 1
  br i1 %cmp55, label %for.cond1.preheader, label %for.cond.cleanup

for.cond1.preheader:                              ; preds = %entry, %for.cond.cleanup3
  %nl.056 = phi i32 [ %inc34, %for.cond.cleanup3 ], [ 0, %entry ]
  br label %for.body4

for.cond.cleanup:                                 ; preds = %for.cond.cleanup3, %entry
  %call37 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.155, double noundef 0.000000e+00)
  br label %for.body.i
...
for.cond.cleanup3:                                ; preds = %for.inc
  %call32 = tail call i32 @dummy(ptr noundef nonnull @global_data, ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 11, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 20, i64 0, i64 0), double noundef 0.000000e+00) #17
  %inc34 = add nuw nsw i32 %nl.056, 1
  %7 = load i32, ptr @ntimes, align 4, !tbaa !17
  %div = sdiv i32 %7, 2
  %cmp = icmp slt i32 %inc34, %div
  br i1 %cmp, label %for.cond1.preheader, label %for.cond.cleanup

for.body4:                                        ; preds = %for.cond1.preheader, %for.inc
  %indvars.iv = phi i64 [ 0, %for.cond1.preheader ], [ %indvars.iv.next, %for.inc ]
  %arrayidx = getelementptr inbounds [32000 x i32], ptr @indx, i64 0, i64 %indvars.iv
  %8 = load i32, ptr %arrayidx, align 4, !tbaa !17
  switch i32 %8, label %L15 [
    i32 4, label %L40
    i32 2, label %L20
    i32 3, label %L30
  ]
...
L15:                                              ; preds = %for.body4
  %arrayidx9 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %indvars.iv
  %9 = load double, ptr %arrayidx9, align 8, !tbaa !5
  %arrayidx13 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv
  %10 = load double, ptr %arrayidx13, align 8, !tbaa !5
...
L20:                                              ; preds = %for.body4
  %arrayidx15 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 %indvars.iv
  %12 = load double, ptr %arrayidx15, align 8, !tbaa !5
  %arrayidx19 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv
  %13 = load double, ptr %arrayidx19, align 8, !tbaa !5
  %14 = tail call double @llvm.fmuladd.f64(double %12, double %12, double %13)
  store double %14, ptr %arrayidx19, align 8, !tbaa !5
  br label %for.inc

L30:                                              ; preds = %for.body4
  %arrayidx21 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 %indvars.iv
  %15 = load double, ptr %arrayidx21, align 8, !tbaa !5
  %arrayidx25 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv
  %16 = load double, ptr %arrayidx25, align 8, !tbaa !5
  %17 = tail call double @llvm.fmuladd.f64(double %15, double %15, double %16)
  store double %17, ptr %arrayidx25, align 8, !tbaa !5
  br label %for.inc

L40:                                              ; preds = %for.body4
  %arrayidx27 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 11, i64 %indvars.iv
  %18 = load double, ptr %arrayidx27, align 8, !tbaa !5
  %arrayidx31 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv
  %19 = load double, ptr %arrayidx31, align 8, !tbaa !5
  %20 = tail call double @llvm.fmuladd.f64(double %18, double %18, double %19)
  store double %20, ptr %arrayidx31, align 8, !tbaa !5
  br label %for.inc
...
entry:
  %call = tail call i32 @init(ptr noundef nonnull @.str.109)
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
  %cmp36 = icmp sgt i32 %0, 0
  br i1 %cmp36, label %vector.ph, label %for.cond.cleanup

vector.ph:                                        ; preds = %entry, %for.cond.cleanup3
  %nl.037 = phi i32 [ %inc22, %for.cond.cleanup3 ], [ 0, %entry ]
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ]
  %1 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 %index
  %wide.load = load <2 x double>, ptr %1, align 32, !tbaa !5
  %2 = getelementptr inbounds double, ptr %1, i64 2
  %wide.load42 = load <2 x double>, ptr %2, align 16, !tbaa !5
  %3 = fcmp ugt <2 x double> %wide.load, zeroinitializer
  %4 = fcmp ugt <2 x double> %wide.load42, zeroinitializer
  %5 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %index
  %wide.load43 = load <2 x double>, ptr %5, align 32, !tbaa !5
  %6 = getelementptr inbounds double, ptr %5, i64 2
  %wide.load44 = load <2 x double>, ptr %6, align 16, !tbaa !5
  %7 = getelementptr %struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 %index
  %wide.load45 = load <2 x double>, ptr %7, align 32, !tbaa !5
  %8 = getelementptr double, ptr %7, i64 2
  %wide.load46 = load <2 x double>, ptr %8, align 16, !tbaa !5
  %predphi = select <2 x i1> %3, <2 x double> %wide.load43, <2 x double> %wide.load45
  %predphi47 = select <2 x i1> %4, <2 x double> %wide.load44, <2 x double> %wide.load46
  %9 = getelementptr inbounds double, ptr @global_data, i64 %index
  %wide.load48 = load <2 x double>, ptr %9, align 32, !tbaa !5
  %10 = getelementptr inbounds double, ptr %9, i64 2
  %wide.load49 = load <2 x double>, ptr %10, align 16, !tbaa !5
  %11 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %wide.load43, <2 x double> %predphi, <2 x double> %wide.load48)
  %12 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %wide.load44, <2 x double> %predphi47, <2 x double> %wide.load49)
  store <2 x double> %11, ptr %9, align 32, !tbaa !5
  store <2 x double> %12, ptr %10, align 16, !tbaa !5
  %index.next = add nuw i64 %index, 4
  %13 = icmp eq i64 %index.next, 32000
  br i1 %13, label %for.cond.cleanup3, label %vector.body, !llvm.loop !371

for.cond.cleanup:                                 ; preds = %for.cond.cleanup3, %entry
  %call24 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.156, double noundef 0.000000e+00)
  br label %for.body.i
...
for.cond.cleanup3:                                ; preds = %vector.body
  %call20 = tail call i32 @dummy(ptr noundef nonnull @global_data, ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 11, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 20, i64 0, i64 0), double noundef 0.000000e+00) #17
  %inc22 = add nuw nsw i32 %nl.037, 1
  %20 = load i32, ptr @ntimes, align 4, !tbaa !17
  %mul = shl nsw i32 %20, 1
  %cmp = icmp slt i32 %inc22, %mul
  br i1 %cmp, label %vector.ph, label %for.cond.cleanup
}
...
entry:
  %call = tail call i32 @init(ptr noundef nonnull @.str.114)
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
  %cmp24 = icmp sgt i32 %0, 0
  br i1 %cmp24, label %for.cond1.preheader, label %for.cond.cleanup

for.cond1.preheader:                              ; preds = %entry, %for.cond.cleanup3
  %nl.025 = phi i32 [ %inc14, %for.cond.cleanup3 ], [ 0, %entry ]
  br label %for.body4

for.cond.cleanup:                                 ; preds = %for.cond.cleanup3, %entry
  %call16 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.157, double noundef 0.000000e+00)
  br label %for.body.i
...
for.cond.cleanup3:                                ; preds = %if.end
  %call12 = tail call i32 @dummy(ptr noundef nonnull @global_data, ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 11, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 20, i64 0, i64 0), double noundef 0.000000e+00) #17
  %inc14 = add nuw nsw i32 %nl.025, 1
  %7 = load i32, ptr @ntimes, align 4, !tbaa !17
...
entry:
  %call = tail call i32 @init(ptr noundef nonnull @.str.115)
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
  %cmp32 = icmp sgt i32 %0, 0
  br i1 %cmp32, label %for.cond1.preheader, label %for.cond.cleanup

for.cond1.preheader:                              ; preds = %entry, %cleanup
  %nl.033 = phi i32 [ %inc16, %cleanup ], [ 0, %entry ]
  br label %for.body4

for.cond.cleanup:                                 ; preds = %cleanup, %entry
  %call19 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.158, double noundef 0.000000e+00)
  br label %for.body.i
...
for.body4:                                        ; preds = %for.body4, %for.cond1.preheader
  ...
  %arrayidx = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %indvars.iv
  %7 = load double, ptr %arrayidx, align 8, !tbaa !5
  %arrayidx6 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 %indvars.iv
  %8 = load double, ptr %arrayidx6, align 8, !tbaa !5
  ...
  store double %10, ptr %arrayidx8, align 8, !tbaa !5
  %cmp13 = fcmp ule double %8, %7
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %cmp2 = icmp ult i64 %indvars.iv, 31999
  %or.cond = select i1 %cmp13, i1 %cmp2, i1 false
  br i1 %or.cond, label %for.body4, label %cleanup

cleanup:                                          ; preds = %for.body4
  %call14 = tail call i32 @dummy(ptr noundef nonnull @global_data, ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 11, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 20, i64 0, i64 0), double noundef 0.000000e+00) #17
...
define dso_local i32 @min(i32 noundef %a, i32 noundef %b) local_unnamed_addr #11 {
entry:
...
entry:
  %call = tail call i32 @posix_memalign(ptr noundef nonnull @xx, i64 noundef 32, i64 noundef 256000) #17
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %ip) #17
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %s1) #17
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %s2) #17
  %call = call i32 @posix_memalign(ptr noundef nonnull %ip, i64 noundef 32, i64 noundef 256000) #17
  %cmp = icmp sgt i32 %argc, 1
  br i1 %cmp, label %if.end, label %if.end.thread

if.end.thread:                                    ; preds = %entry
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
  %call235 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.160, i32 noundef %0)
  br label %if.end7

if.end:                                           ; preds = %entry
  %arrayidx = getelementptr inbounds ptr, ptr %argv, i64 1
  %1 = load ptr, ptr %arrayidx, align 8, !tbaa !381
  %call.i = call i64 @strtol(ptr nocapture noundef nonnull %1, ptr noundef null, i32 noundef 10) #17
  %conv.i = trunc i64 %call.i to i32
  store i32 %conv.i, ptr @ntimes, align 4, !tbaa !17
  %call2 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.160, i32 noundef %conv.i)
...
if.then4:                                         ; preds = %if.end
  ...
  %call.i33 = call i64 @strtol(ptr nocapture noundef nonnull %2, ptr noundef null, i32 noundef 10) #17
  %conv.i34 = trunc i64 %call.i33 to i32
  store i32 %conv.i34, ptr @digits, align 4, !tbaa !17
  br label %if.end7
...
if.end7:                                          ; preds = %if.end.thread, %if.then4, %if.end
  ...
  %call11 = call i32 @s162(i32 noundef 1)
  %call12 = call i32 @s271()
  %4 = load double, ptr %s1, align 8, !tbaa !5
  %call13 = call i32 @s272(double noundef %4)
  ...
  %call23 = call i32 @s2710(double noundef %4)
  ...
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %s2) #17
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %s1) #17
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %ip) #17
  ret i32 0
}
