...
if.then93:                                        ; preds = %for.body57
  ...
  %shr.i955 = zext i1 %25 to i32
  %shr1.i956 = ashr i32 %sub69, 31
  %or.i957 = or i32 %shr1.i956, %shr.i955
  %26 = trunc i32 %or.i957 to i16
  %conv97 = sub i16 %a345.01087, %26
  %mul98 = mul nsw i32 %or.i957, %sub69
...
if.end105:                                        ; preds = %if.then93
  ...
  %shr.i958 = zext i1 %27 to i32
  %shr1.i959 = ashr i32 %sub67, 31
  %or.i960 = or i32 %shr1.i959, %shr.i958
  %28 = trunc i32 %or.i960 to i16
  %conv109 = sub i16 %a244.01086, %28
  %mul110 = mul nsw i32 %or.i960, %sub67
...
if.end117:                                        ; preds = %if.end105
  ...
  %shr.i961 = zext i1 %29 to i32
  %shr1.i962 = ashr i32 %sub65, 31
  %or.i963 = or i32 %shr1.i962, %shr.i961
  %30 = trunc i32 %or.i963 to i16
  %conv121 = sub i16 %a143.01085, %30
  %mul122 = mul nsw i32 %or.i963, %sub65
...
if.end129:                                        ; preds = %if.end117
  ...
  %shr.i964 = zext i1 %31 to i32
  %shr1.i965 = ashr i32 %sub63, 31
  %or.i966 = or i32 %shr1.i965, %shr.i964
  %32 = trunc i32 %or.i966 to i16
...
if.then136:                                       ; preds = %if.else
  ...
  %shr.i967 = zext i1 %33 to i32
  %shr1.i968 = ashr i32 %sub69, 31
  %or.i969 = or i32 %shr1.i968, %shr.i967
  %34 = trunc i32 %or.i969 to i16
  %conv141 = add i16 %a345.01087, %34
  %35 = mul i32 %sub69, %or.i969
  %mul142 = sub i32 0, %35
...
if.end149:                                        ; preds = %if.then136
  ...
  %shr.i970 = zext i1 %36 to i32
  %shr1.i971 = ashr i32 %sub67, 31
  %or.i972 = or i32 %shr1.i971, %shr.i970
  %37 = trunc i32 %or.i972 to i16
  %conv154 = add i16 %a244.01086, %37
  %38 = mul i32 %sub67, %or.i972
  %mul155 = sub i32 0, %38
...
if.end162:                                        ; preds = %if.end149
  ...
  %shr.i973 = zext i1 %39 to i32
  %shr1.i974 = ashr i32 %sub65, 31
  %or.i975 = or i32 %shr1.i974, %shr.i973
  %40 = trunc i32 %or.i975 to i16
  %conv167 = add i16 %a143.01085, %40
  %41 = mul i32 %sub65, %or.i975
  %mul168 = sub i32 0, %41
...
if.end175:                                        ; preds = %if.end162
  ...
  %shr.i976 = zext i1 %42 to i32
  %shr1.i977 = ashr i32 %sub63, 31
  %or.i978 = or i32 %shr1.i977, %shr.i976
  %43 = trunc i32 %or.i978 to i16
...
for.body204:                                      ; preds = %for.body204.preheader, %for.inc452
  ...
  %shr.i979 = zext i1 %63 to i32
  %shr1.i980 = ashr i32 %62, 31
  %or.i981 = or i32 %shr1.i980, %shr.i979
  ...
  %cmp260 = icmp sgt i32 %or.i981, 0
  br i1 %cmp260, label %if.then262, label %if.else351

if.then262:                                       ; preds = %for.body204
  %64 = icmp sgt i32 %sub224, 0
  %shr.i982 = zext i1 %64 to i32
  %shr1.i983 = ashr i32 %sub224, 31
  %or.i984 = or i32 %shr1.i983, %shr.i982
  %65 = trunc i32 %or.i984 to i16
  %conv266 = sub i16 %a7.01071, %65
  %mul267 = mul nsw i32 %or.i984, %sub224
...
if.end274:                                        ; preds = %if.then262
  ...
  %shr.i985 = zext i1 %66 to i32
  %shr1.i986 = ashr i32 %sub223, 31
  %or.i987 = or i32 %shr1.i986, %shr.i985
  %67 = trunc i32 %or.i987 to i16
  %conv278 = sub i16 %a6.01070, %67
  %mul279 = mul nsw i32 %or.i987, %sub223
...
if.end286:                                        ; preds = %if.end274
  ...
  %shr.i988 = zext i1 %68 to i32
  %shr1.i989 = ashr i32 %sub221, 31
  %or.i990 = or i32 %shr1.i989, %shr.i988
  %69 = trunc i32 %or.i990 to i16
  %conv290 = sub i16 %a5.01069, %69
  %mul291 = mul nsw i32 %or.i990, %sub221
...
if.end298:                                        ; preds = %if.end286
  ...
  %shr.i991 = zext i1 %70 to i32
  %shr1.i992 = ashr i32 %sub219, 31
  %or.i993 = or i32 %shr1.i992, %shr.i991
  %71 = trunc i32 %or.i993 to i16
  %conv302 = sub i16 %a4.01068, %71
  %mul303 = mul nsw i32 %or.i993, %sub219
...
if.end310:                                        ; preds = %if.end298
  ...
  %shr.i994 = zext i1 %72 to i32
  %shr1.i995 = ashr i32 %sub217, 31
  %or.i996 = or i32 %shr1.i995, %shr.i994
  %73 = trunc i32 %or.i996 to i16
  %conv314 = sub i16 %a3.01072, %73
  %mul315 = mul nsw i32 %or.i996, %sub217
...
if.end322:                                        ; preds = %if.end310
  ...
  %shr.i997 = zext i1 %74 to i32
  %shr1.i998 = ashr i32 %sub215, 31
  %or.i999 = or i32 %shr1.i998, %shr.i997
  %75 = trunc i32 %or.i999 to i16
  %conv326 = sub i16 %a2.01073, %75
  %mul327 = mul nsw i32 %or.i999, %sub215
...
if.end334:                                        ; preds = %if.end322
  ...
  %shr.i1000 = zext i1 %76 to i32
  %shr1.i1001 = ashr i32 %sub213, 31
  %or.i1002 = or i32 %shr1.i1001, %shr.i1000
  %77 = trunc i32 %or.i1002 to i16
  %conv338 = sub i16 %a1.01074, %77
  %mul339 = mul nsw i32 %or.i1002, %sub213
...
if.end346:                                        ; preds = %if.end334
  ...
  %shr.i1003 = zext i1 %78 to i32
  %shr1.i1004 = ashr i32 %sub211, 31
  %or.i1005 = or i32 %shr1.i1004, %shr.i1003
  %79 = trunc i32 %or.i1005 to i16
  %conv350 = sub i16 %a0.01075, %79
  br label %for.inc452

if.else351:                                       ; preds = %for.body204
  %cmp352 = icmp slt i32 %or.i981, 0
  br i1 %cmp352, label %if.then354, label %for.inc452

if.then354:                                       ; preds = %if.else351
  %80 = icmp sgt i32 %sub224, 0
  %shr.i1006 = zext i1 %80 to i32
  %shr1.i1007 = ashr i32 %sub224, 31
  %or.i1008 = or i32 %shr1.i1007, %shr.i1006
  %81 = trunc i32 %or.i1008 to i16
  %conv359 = add i16 %a7.01071, %81
  %82 = mul i32 %sub224, %or.i1008
  %mul360 = sub i32 0, %82
...
if.end367:                                        ; preds = %if.then354
  ...
  %shr.i1009 = zext i1 %83 to i32
  %shr1.i1010 = ashr i32 %sub223, 31
  %or.i1011 = or i32 %shr1.i1010, %shr.i1009
  %84 = trunc i32 %or.i1011 to i16
  %conv372 = add i16 %a6.01070, %84
  %85 = mul i32 %sub223, %or.i1011
  %mul373 = sub i32 0, %85
...
if.end380:                                        ; preds = %if.end367
  ...
  %shr.i1012 = zext i1 %86 to i32
  %shr1.i1013 = ashr i32 %sub221, 31
  %or.i1014 = or i32 %shr1.i1013, %shr.i1012
  %87 = trunc i32 %or.i1014 to i16
  %conv385 = add i16 %a5.01069, %87
  %88 = mul i32 %sub221, %or.i1014
  %mul386 = sub i32 0, %88
...
if.end393:                                        ; preds = %if.end380
  ...
  %shr.i1015 = zext i1 %89 to i32
  %shr1.i1016 = ashr i32 %sub219, 31
  %or.i1017 = or i32 %shr1.i1016, %shr.i1015
  %90 = trunc i32 %or.i1017 to i16
  %conv398 = add i16 %a4.01068, %90
  %91 = mul i32 %sub219, %or.i1017
  %mul399 = sub i32 0, %91
...
if.end406:                                        ; preds = %if.end393
  ...
  %shr.i1018 = zext i1 %92 to i32
  %shr1.i1019 = ashr i32 %sub217, 31
  %or.i1020 = or i32 %shr1.i1019, %shr.i1018
  %93 = trunc i32 %or.i1020 to i16
  %conv411 = add i16 %a3.01072, %93
  %94 = mul i32 %sub217, %or.i1020
  %mul412 = sub i32 0, %94
...
if.end419:                                        ; preds = %if.end406
  ...
  %shr.i1021 = zext i1 %95 to i32
  %shr1.i1022 = ashr i32 %sub215, 31
  %or.i1023 = or i32 %shr1.i1022, %shr.i1021
  %96 = trunc i32 %or.i1023 to i16
  %conv424 = add i16 %a2.01073, %96
  %97 = mul i32 %sub215, %or.i1023
  %mul425 = sub i32 0, %97
...
if.end432:                                        ; preds = %if.end419
  ...
  %shr.i1024 = zext i1 %98 to i32
  %shr1.i1025 = ashr i32 %sub213, 31
  %or.i1026 = or i32 %shr1.i1025, %shr.i1024
  %99 = trunc i32 %or.i1026 to i16
  %conv437 = add i16 %a1.01074, %99
  %100 = mul i32 %sub213, %or.i1026
...
if.end445:                                        ; preds = %if.end432
  ...
  %shr.i1027 = zext i1 %101 to i32
  %shr1.i1028 = ashr i32 %sub211, 31
  %or.i1029 = or i32 %shr1.i1028, %shr.i1027
  %102 = trunc i32 %or.i1029 to i16
...
for.end489:                                       ; preds = %for.body477, %middle.block, %for.body467
  ...
  %shr.i1030 = zext i1 %125 to i32
  %shr1.i1031 = ashr i32 %124, 31
  %or.i1032 = or i32 %shr1.i1031, %shr.i1030
  ...
  %cmp501 = icmp sgt i32 %or.i1032, 0
...
for.body508:                                      ; preds = %for.cond505
  ...
  %shr.i1033 = zext i1 %128 to i32
  %shr1.i1034 = ashr i32 %sub512, 31
  %or.i1035 = or i32 %shr1.i1034, %shr.i1033
...
if.else530:                                       ; preds = %for.end489
  %cmp531 = icmp slt i32 %or.i1032, 0
...
for.body538:                                      ; preds = %for.cond535
  ...
  %shr.i1036 = zext i1 %135 to i32
  %shr1.i1037 = ashr i32 %sub542, 31
  %or.i1038 = or i32 %shr1.i1037, %shr.i1036
