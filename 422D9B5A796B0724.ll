...
entry:
  ...
  %bf.lshr = lshr i32 %y.sroa.0.0.copyload, 17
...
entry:
  ...
  %add = add i32 %bf.lshr, %x
  %bf.value = and i32 %add, 32767
  %bf.shl = shl nuw i32 %bf.value, 17
  %bf.clear = and i32 %bf.load, 131071
  %bf.set = or i32 %bf.shl, %bf.clear
  store i32 %bf.set, ptr @sA, align 4
  ret i32 %bf.value
}
...
if.end89:
  ...
  %add.i192 = add nuw nsw i32 %rem.i190, %rem.i186
  %bf.shl.i = shl nuw nsw i32 %add.i192, 17
  %bf.set.i = or i32 %bf.shl.i, %bf.clear
  store i32 %bf.set.i, ptr @sA, align 4
  ret void
}
...
entry:
  ...
  %bf.clear = and i32 %bf.load, 131071
  %bf.set = or i32 %bf.shl, %bf.clear
  store i32 %bf.set, ptr @sB, align 4
  ret i32 %bf.value
}
...
if.end78:
  ...
  %add.i168 = add nuw nsw i32 %rem.i166, %rem.i162
  %bf.shl.i = shl nuw nsw i32 %add.i168, 17
  %bf.set.i = or i32 %bf.shl.i, %bf.clear
  store i32 %bf.set.i, ptr @sB, align 4
  ret void
}
...
entry:
  ...
  %bf.lshr = lshr i32 %y.sroa.5.0.copyload, 17
  %add = add i32 %bf.lshr, %x
  %bf.value = and i32 %add, 32767
  ret i32 %bf.value
}
...
entry:
  ...
  %bf.lshr = lshr i32 %y.sroa.3.0.copyload, 17
  %add = add i32 %bf.lshr, %x
  %0 = trunc i32 %add to i16
  %rem.lhs.trunc = and i16 %0, 32767
...
define dso_local void @testC() local_unnamed_addr #5 {
if.end82:
  %myrnd.s.promoted = load i32, ptr @myrnd.s, align 4, !tbaa !5
  %mul.i = mul i32 %myrnd.s.promoted, 1103515245
  %add.i = add i32 %mul.i, 12345
  ...
  %rem.i180 = and i32 %div1.i179, 2047
  %bf.shl87 = shl nuw nsw i32 %rem.i176, 17
  %bf.set89 = or i32 %bf.shl87, %bf.clear
  %add2.i = shl nuw nsw i32 %rem.i180, 17
  ...
  %add118 = add nuw nsw i32 %rem.i180, %rem.i176
...
entry:
  ...
  %bf.lshr = lshr i32 %y.sroa.0.0.copyload, 25
  %add = add i32 %bf.lshr, %x
  %0 = trunc i32 %add to i8
  %rem.lhs.trunc = and i8 %0, 127
...
entry:
  ...
  %bf.lshr = lshr i32 %bf.load, 25
  %add = add i32 %bf.lshr, %x
  %bf.value = and i32 %add, 127
  %bf.shl = shl nuw i32 %bf.value, 25
  %bf.clear = and i32 %bf.load, 33554431
  %bf.set = or i32 %bf.shl, %bf.clear
  store i32 %bf.set, ptr @sG, align 8
  ret i32 %bf.value
}

; Function Attrs: nounwind uwtable
define dso_local void @testG() local_unnamed_addr #5 {
lor.lhs.false34:
  %myrnd.s.promoted = load i32, ptr @myrnd.s, align 4, !tbaa !5
  %mul.i = mul i32 %myrnd.s.promoted, 1103515245
  %add.i = add i32 %mul.i, 12345
  ...
  %bf.set8 = or i32 %bf.value, %bf.clear
...
if.then:                                          ; preds = %lor.lhs.false34
  tail call void @abort() #8
  unreachable

if.end117:                                        ; preds = %lor.lhs.false34
  %4 = mul i32 %add.i149, -2139243339
  %add.i163 = add i32 %4, -1492899873
  %div1.i164 = lshr i32 %add.i163, 16
  %mul.i166 = mul i32 %add.i163, 1103515245
  %add.i167 = add i32 %mul.i166, 12345
  store i32 %add.i167, ptr @myrnd.s, align 4, !tbaa !5
  %div1.i168 = lshr i32 %add.i167, 16
  %add.i171 = add nuw nsw i32 %div1.i168, %div1.i164
  %bf.value.i = shl i32 %add.i171, 25
  %bf.set.i = or i32 %bf.value.i, %bf.clear
  store i32 %bf.set.i, ptr @sG, align 8
  ret void
}
...
entry:
  ...
  %bf.lshr = lshr i32 %y.sroa.0.0.copyload, 23
  %add = add i32 %bf.lshr, %x
  %0 = trunc i32 %add to i16
  %rem.lhs.trunc = and i16 %0, 511
  %rem11 = urem i16 %rem.lhs.trunc, 15
  %rem.zext = zext i16 %rem11 to i32
  ret i32 %rem.zext
}
...
entry:
  ...
  %bf.lshr = lshr i32 %bf.load, 23
  %add = add i32 %bf.lshr, %x
  %bf.value = and i32 %add, 511
  %bf.shl = shl nuw i32 %bf.value, 23
  %bf.clear = and i32 %bf.load, 8388607
  %bf.set = or i32 %bf.shl, %bf.clear
  store i32 %bf.set, ptr @sH, align 8
  ret i32 %bf.value
}

; Function Attrs: nounwind uwtable
define dso_local void @testH() local_unnamed_addr #5 {
lor.lhs.false34:
  %myrnd.s.promoted = load i32, ptr @myrnd.s, align 4, !tbaa !5
  %mul.i = mul i32 %myrnd.s.promoted, 1103515245
  %add.i = add i32 %mul.i, 12345
...
if.end117:                                        ; preds = %lor.lhs.false34
  ...
  %div1.i168 = lshr i32 %add.i167, 16
  %add.i171 = add nuw nsw i32 %div1.i168, %div1.i164
  %bf.value.i = shl i32 %add.i171, 23
  %bf.set.i = or i32 %bf.value.i, %bf.clear
  store i32 %bf.set.i, ptr @sH, align 8
  ret void
}
...
entry:
  ...
  %bf.lshr = lshr i16 %y.sroa.0.0.copyload, 7
  %0 = trunc i32 %x to i16
  %conv1 = add i16 %bf.lshr, %0
  %bf.value = and i16 %conv1, 511
...
entry:
  ...
  %conv1 = add i16 %bf.lshr, %0
  %bf.value = and i16 %conv1, 511
  %bf.shl = shl nuw i16 %bf.value, 7
  %bf.clear = and i16 %bf.load, 127
  %bf.set = or i16 %bf.shl, %bf.clear
  store i16 %bf.set, ptr @sI, align 8
  %conv.i = zext i16 %bf.value to i32
  ret i32 %conv.i
}

; Function Attrs: nounwind uwtable
define dso_local void @testI() local_unnamed_addr #5 {
lor.lhs.false42:
  %myrnd.s.promoted = load i32, ptr @myrnd.s, align 4, !tbaa !5
  %mul.i = mul i32 %myrnd.s.promoted, 1103515245
  %add.i = add i32 %mul.i, 12345
  ...
  %bf.set10 = or i16 %bf.value, %bf.clear
...
if.end:                                           ; preds = %lor.lhs.false42
  ...
  %5 = trunc i32 %div1.i177 to i16
  %conv1.i = add i16 %5, %conv47
  %bf.value.i = and i16 %conv1.i, 511
  %6 = urem i16 %bf.value.i, 15
  %add87 = add nuw nsw i32 %div1.i177, %div1.i173
  %7 = trunc i32 %add87 to i16
  %rem.lhs.trunc = and i16 %7, 511
  %rem192 = urem i16 %rem.lhs.trunc, 15
  %cmp90.not = icmp eq i16 %rem192, %6
...
if.end93:                                         ; preds = %if.end
  %mul.i180 = mul i32 %add.i176, 1103515245
  ...
  %div1.i186 = lshr i32 %add.i185, 16
  %conv96 = trunc i32 %div1.i182 to i16
  %8 = trunc i32 %div1.i186 to i16
  %conv1.i189 = add i16 %8, %conv96
  %bf.value.i190 = and i16 %conv1.i189, 511
  %bf.shl.i = shl nuw i16 %bf.value.i190, 7
  %bf.set.i = or i16 %bf.shl.i, %bf.clear
  store i16 %bf.set.i, ptr @sI, align 8
  %conv.i.i = zext i16 %bf.value.i190 to i32
...
; Function Attrs: nounwind uwtable
define dso_local void @testJ() local_unnamed_addr #5 {
if.end:
  %myrnd.s.promoted = load i32, ptr @myrnd.s, align 4, !tbaa !5
  %mul.i = mul i32 %myrnd.s.promoted, 1103515245
  %add.i = add i32 %mul.i, 12345
...
if.end121:
  ...
  %bf.set.i = or i32 %bf.value.i179, %bf.clear
...
; Function Attrs: nounwind uwtable
define dso_local void @testN() local_unnamed_addr #5 {
if.end:
  %myrnd.s.promoted = load i32, ptr @myrnd.s, align 4, !tbaa !5
  %mul.i = mul i32 %myrnd.s.promoted, 1103515245
  %add.i = add i32 %mul.i, 12345
...
; Function Attrs: nounwind uwtable
define dso_local void @testQ() local_unnamed_addr #5 {
entry:
  %myrnd.s.promoted = load i32, ptr @myrnd.s, align 4, !tbaa !5
  %mul.i = mul i32 %myrnd.s.promoted, 1103515245
  %add.i = add i32 %mul.i, 12345
  ...
  %bf.set9 = or i32 %rem.i145, %bf.clear
  ...
  br i1 %cmp35.not, label %if.end77, label %if.then
...
if.end77:                                         ; preds = %entry
  ...
  %bf.set.i = or i32 %add.i169, %bf.clear
...
; Function Attrs: nounwind uwtable
define dso_local void @testR() local_unnamed_addr #5 {
entry:
  %myrnd.s.promoted = load i32, ptr @myrnd.s, align 4, !tbaa !5
  %mul.i = mul i32 %myrnd.s.promoted, 1103515245
  %add.i = add i32 %mul.i, 12345
...
; Function Attrs: nounwind uwtable
define dso_local void @testS() local_unnamed_addr #5 {
lor.lhs.false42:
  %myrnd.s.promoted = load i32, ptr @myrnd.s, align 4, !tbaa !5
  %mul.i = mul i32 %myrnd.s.promoted, 1103515245
  %add.i = add i32 %mul.i, 12345
  ...
  %bf.set11 = or i16 %bf.value, %bf.clear
...
if.end92:                                         ; preds = %lor.lhs.false42
  %3 = mul i32 %add.i166, -2139243339
  %add.i179 = add i32 %3, -1492899873
  ...
  %4 = trunc i32 %div1.i184 to i16
  %conv1.i186 = add i16 %4, %conv95
  %bf.value.i187 = and i16 %conv1.i186, 1
  %bf.set.i = or i16 %bf.value.i187, %bf.clear
...
; Function Attrs: nounwind uwtable
define dso_local void @testT() local_unnamed_addr #5 {
if.end96:
  %myrnd.s.promoted = load i32, ptr @myrnd.s, align 4, !tbaa !5
  %mul.i = mul i32 %myrnd.s.promoted, 1103515245
  %add.i = add i32 %mul.i, 12345
...
; Function Attrs: nounwind uwtable
define dso_local void @testU() local_unnamed_addr #5 {
lor.lhs.false43:
  %myrnd.s.promoted = load i32, ptr @myrnd.s, align 4, !tbaa !5
  %mul.i = mul i32 %myrnd.s.promoted, 1103515245
  %add.i = add i32 %mul.i, 12345
  ...
  %bf.set11 = or i16 %bf.shl, %bf.clear
...
if.then:                                          ; preds = %lor.lhs.false43
  tail call void @abort() #8
  unreachable

if.end94:                                         ; preds = %lor.lhs.false43
  %5 = mul i32 %add.i168, -2139243339
  %add.i181 = add i32 %5, -1492899873
  %div1.i182 = lshr i32 %add.i181, 16
  %mul.i184 = mul i32 %add.i181, 1103515245
  %add.i185 = add i32 %mul.i184, 12345
  store i32 %add.i185, ptr @myrnd.s, align 4, !tbaa !5
  ...
  %6 = trunc i32 %div1.i186 to i16
  %bf.value99189 = add i16 %6, %conv97
...
; Function Attrs: nounwind uwtable
define dso_local void @testV() local_unnamed_addr #5 {
if.end98:
  %myrnd.s.promoted = load i32, ptr @myrnd.s, align 4, !tbaa !5
  %mul.i = mul i32 %myrnd.s.promoted, 1103515245
  %add.i = add i32 %mul.i, 12345
...
if.end81:
  ...
  %bf.set.i = or i32 %add.i172, %bf.clear
...
if.end77:
  ...
  %bf.set.i = or i32 %add.i167, %bf.clear
...
; Function Attrs: nounwind uwtable
define dso_local void @testZ() local_unnamed_addr #5 {
if.end82:
  %myrnd.s.promoted = load i32, ptr @myrnd.s, align 4, !tbaa !5
  %mul.i = mul i32 %myrnd.s.promoted, 1103515245
  %add.i = add i32 %mul.i, 12345
  ...
  %1 = mul i32 %add.i.31, -341751747
  %add.i168 = add i32 %1, 229283573
  %div1.i169 = lshr i32 %add.i168, 16
  %rem.i170 = and i32 %div1.i169, 2047
  %mul.i171 = mul i32 %add.i168, 1103515245
  %add.i172 = add i32 %mul.i171, 12345
  store i32 %add.i172, ptr @myrnd.s, align 4, !tbaa !5
  %div1.i173 = lshr i32 %add.i172, 16
  %rem.i174 = and i32 %div1.i173, 2047
  %bf.shl87 = shl nuw nsw i32 %rem.i170, 20
  %bf.set89 = or i32 %bf.shl87, %bf.clear
  %add2.i = shl nuw nsw i32 %rem.i174, 20
  ...
  %add118 = add nuw nsw i32 %rem.i174, %rem.i170
  %cmp120.not = icmp eq i32 %add118, %bf.lshr.i.i
  br i1 %cmp120.not, label %if.end123, label %if.then122
