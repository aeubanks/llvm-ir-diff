...
"for op_maxps_123.s0.x.x":                        ; preds = %"for op_maxps_123.s0.x.x.1", %"for op_maxps_123.s0.x.x.preheader"
  ...
  %9 = shufflevector <6 x float> %a60, <6 x float> undef, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 poison, i32 poison>
  %10 = shufflevector <6 x float> %b69, <6 x float> undef, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 poison, i32 poison>
...
"for op_maxps_123.s0.x.x.1":                      ; preds = %"for op_maxps_123.s0.x.x"
  ...
  %26 = shufflevector <6 x float> %a60.1, <6 x float> undef, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 poison, i32 poison>
  %27 = shufflevector <6 x float> %b69.1, <6 x float> undef, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 poison, i32 poison>
