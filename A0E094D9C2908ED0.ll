...
237:                                              ; preds = %187, %218, %229, %196, %207
  %238 = and i64 %191, 1073741824
  %239 = icmp eq i64 %238, 0
  br i1 %239, label %240, label %187

240:                                              ; preds = %140, %118, %115, %173, %176, %184, %226, %229, %204, %207, %237, %3
  %241 = phi i32 [ 1, %3 ], [ 1, %226 ], [ 1, %229 ], [ 1, %204 ], [ 1, %207 ], [ 0, %237 ], [ 1, %173 ], [ 1, %176 ], [ 0, %184 ], [ 1, %115 ], [ 1, %118 ], [ 0, %140 ]
