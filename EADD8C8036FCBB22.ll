...
while.body.i:                                     ; preds = %entry, %if.end.i
  ...
  %call.i.i = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %call3.val.i, ptr noundef nonnull dereferenceable(1) %ClName) #18
  %cmp.i18.not.not.i = icmp eq i32 %call.i.i, 0
  br i1 %cmp.i18.not.not.i, label %while.body.i6, label %if.end.i
...
while.cond.i:                                     ; preds = %while.body.i6
  %add.i.i4 = add nuw nsw i32 %ScanId.017.i, 1
  %Scan.0.i = load ptr, ptr %Scan.018.i, align 8
  %cmp.i.not.i5 = icmp eq ptr %Scan.0.i, null
  br i1 %cmp.i.not.i5, label %cleanup, label %while.body.i6, !llvm.loop !14

while.body.i6:                                    ; preds = %while.body.i, %while.cond.i
...
if.then.i.i105:                                   ; preds = %land.rhs
  ...
  %call.i.i.i104 = tail call ptr @getenv(ptr noundef nonnull @.str.31) #19
...
if.then5.i.i:                                     ; preds = %lor.lhs.false2.i.i, %if.end.i.i106, %if.end.thread.i.i
  %optstring.addr.0838.i.i = phi ptr [ %optstring.addr.0.i.i.i, %if.end.thread.i.i ], [ %ShortDecl.2.i, %lor.lhs.false2.i.i ], [ %ShortDecl.2.i, %if.end.i.i106 ]
  %opts_Ind.promoted836.i.i = phi i32 [ 1, %if.end.thread.i.i ], [ %11, %lor.lhs.false2.i.i ], [ %11, %if.end.i.i106 ]
  %14 = load i32, ptr @opts_LastNonOpt, align 4
  %cmp6.i.i = icmp sgt i32 %14, %opts_Ind.promoted836.i.i
  br i1 %cmp6.i.i, label %if.then8.i.i, label %if.end9.i.i

if.then8.i.i:                                     ; preds = %if.then5.i.i
  store i32 %opts_Ind.promoted836.i.i, ptr @opts_LastNonOpt, align 4
  br label %if.end9.i.i

if.end9.i.i:                                      ; preds = %if.then8.i.i, %if.then5.i.i
  %15 = phi i32 [ %opts_Ind.promoted836.i.i, %if.then8.i.i ], [ %14, %if.then5.i.i ]
  %16 = load i32, ptr @opts_FirstNonOpt, align 4
  %cmp10.i.i = icmp sgt i32 %16, %opts_Ind.promoted836.i.i
  br i1 %cmp10.i.i, label %if.then12.i.i, label %if.end13.i.i

if.then12.i.i:                                    ; preds = %if.end9.i.i
  store i32 %opts_Ind.promoted836.i.i, ptr @opts_FirstNonOpt, align 4
  br label %if.end13.i.i

if.end13.i.i:                                     ; preds = %if.then12.i.i, %if.end9.i.i
  %17 = phi i32 [ %opts_Ind.promoted836.i.i, %if.then12.i.i ], [ %16, %if.end9.i.i ]
...
if.then16.i.i:                                    ; preds = %if.end13.i.i
  ...
  %cmp19.not.i.i = icmp eq i32 %opts_Ind.promoted836.i.i, %15
...
if.then21.i.i:                                    ; preds = %if.then16.i.i
  %cmp91.i.i.i = icmp sgt i32 %opts_Ind.promoted836.i.i, %15
...
while.body.i.i.i:                                 ; preds = %if.end.i.i.i, %while.body.preheader.i.i.i
  ...
  %top.093.i.i.i = phi i32 [ %top.1.i.i.i, %if.end.i.i.i ], [ %opts_Ind.promoted836.i.i, %while.body.preheader.i.i.i ]
...
opts_Exchange.exit.i.i:                           ; preds = %if.end.i.i.i, %if.then21.i.i
  %sub42.i.i.i = sub i32 %opts_Ind.promoted836.i.i, %15
...
if.end26.sink.split.i.i:                          ; preds = %if.else.i.i, %opts_Exchange.exit.i.i
  %opts_Ind.promoted836.sink.i.i = phi i32 [ %add43.i.i.i, %opts_Exchange.exit.i.i ], [ %opts_Ind.promoted836.i.i, %if.else.i.i ]
  store i32 %opts_Ind.promoted836.sink.i.i, ptr @opts_FirstNonOpt, align 4
  br label %if.end26.i.i

if.end26.i.i:                                     ; preds = %if.end26.sink.split.i.i, %if.else.i.i
  %78 = phi i32 [ %17, %if.else.i.i ], [ %opts_Ind.promoted836.sink.i.i, %if.end26.sink.split.i.i ]
  %cmp27801.i.i = icmp slt i32 %opts_Ind.promoted836.i.i, %argc
  br i1 %cmp27801.i.i, label %land.rhs.preheader.i.i, label %while.end.i.i

land.rhs.preheader.i.i:                           ; preds = %if.end26.i.i
  %79 = sext i32 %opts_Ind.promoted836.i.i to i64
...
while.end.i.i:                                    ; preds = %while.body.i.i107, %while.end.i.loopexit.split.loop.exit.i, %if.end26.i.i
  %83 = phi i32 [ %opts_Ind.promoted836.i.i, %if.end26.i.i ], [ %indvars18.le.i, %while.end.i.loopexit.split.loop.exit.i ], [ %argc, %while.body.i.i107 ]
...
if.end39.i.i:                                     ; preds = %while.end.i.i, %if.end13.i.i
  ...
  %86 = phi i32 [ %83, %while.end.i.i ], [ %opts_Ind.promoted836.i.i, %if.end13.i.i ]
...
if.then54.i.i:                                    ; preds = %if.then47.i.i
  ...
  %cmp192.i712.i.i = icmp slt i32 %85, %84
  %88 = and i1 %cmp192.i712.i.i, %cmp91.i711.i.i
  br i1 %88, label %while.body.preheader.i713.i.i, label %opts_Exchange.exit750.i.i

while.body.preheader.i713.i.i:                    ; preds = %if.then54.i.i
  %89 = sext i32 %84 to i64
  %90 = shl nsw i64 %89, 3
  %scevgep429 = getelementptr i8, ptr %argv, i64 %90
  %scevgep430 = getelementptr i8, ptr %argv, i64 %90
  br label %while.body.i719.i.i

while.body.i719.i.i:                              ; preds = %if.end.i747.i.i, %while.body.preheader.i713.i.i
  %bottom.094.i714.i.i = phi i32 [ %bottom.1.i744.i.i, %if.end.i747.i.i ], [ %85, %while.body.preheader.i713.i.i ]
  %top.093.i715.i.i = phi i32 [ %top.1.i743.i.i, %if.end.i747.i.i ], [ %inc48.i.i, %while.body.preheader.i713.i.i ]
  %sub.i716.i.i = sub nsw i32 %top.093.i715.i.i, %84
  %sub2.i717.i.i = sub nsw i32 %84, %bottom.094.i714.i.i
  %cmp3.i718.i.i = icmp sgt i32 %sub.i716.i.i, %sub2.i717.i.i
  br i1 %cmp3.i718.i.i, label %for.cond.preheader.i726.i.i, label %for.cond23.preheader.i721.i.i

for.cond23.preheader.i721.i.i:                    ; preds = %while.body.i719.i.i
  %cmp2487.i720.i.i = icmp sgt i32 %sub.i716.i.i, 0
  br i1 %cmp2487.i720.i.i, label %for.body25.preheader.i723.i.i, label %for.end40.i742.i.i

for.body25.preheader.i723.i.i:                    ; preds = %for.cond23.preheader.i721.i.i
  %91 = sext i32 %bottom.094.i714.i.i to i64
  %wide.trip.count.i722.i.i = zext i32 %sub.i716.i.i to i64
  %min.iters.check437 = icmp ult i32 %sub.i716.i.i, 8
  br i1 %min.iters.check437, label %for.body25.i740.i.i.preheader, label %vector.memcheck426

vector.memcheck426:                               ; preds = %for.body25.preheader.i723.i.i
  %92 = shl nsw i64 %91, 3
  %scevgep427 = getelementptr i8, ptr %argv, i64 %92
  %93 = shl nuw nsw i64 %wide.trip.count.i722.i.i, 3
  ...
  br i1 %found.conflict434, label %for.body25.i740.i.i.preheader, label %vector.ph438

vector.ph438:                                     ; preds = %vector.memcheck426
  %n.vec440 = and i64 %wide.trip.count.i722.i.i, 4294967292
...
middle.block435:                                  ; preds = %vector.body443
  %cmp.n442 = icmp eq i64 %n.vec440, %wide.trip.count.i722.i.i
  br i1 %cmp.n442, label %for.end40.i742.i.i, label %for.body25.i740.i.i.preheader

for.body25.i740.i.i.preheader:                    ; preds = %vector.memcheck426, %for.body25.preheader.i723.i.i, %middle.block435
  %indvars.iv.i735.i.i.ph = phi i64 [ 0, %vector.memcheck426 ], [ 0, %for.body25.preheader.i723.i.i ], [ %n.vec440, %middle.block435 ]
  %102 = xor i64 %indvars.iv.i735.i.i.ph, -1
  %xtraiter486 = and i64 %wide.trip.count.i722.i.i, 1
  %lcmp.mod487.not = icmp eq i64 %xtraiter486, 0
  br i1 %lcmp.mod487.not, label %for.body25.i740.i.i.prol.loopexit, label %for.body25.i740.i.i.prol

for.body25.i740.i.i.prol:                         ; preds = %for.body25.i740.i.i.preheader
  %103 = add nsw i64 %indvars.iv.i735.i.i.ph, %91
  %arrayidx28.i736.i.i.prol = getelementptr inbounds ptr, ptr %argv, i64 %103
  %104 = load ptr, ptr %arrayidx28.i736.i.i.prol, align 8
  %105 = add nsw i64 %indvars.iv.i735.i.i.ph, %89
  %arrayidx31.i737.i.i.prol = getelementptr inbounds ptr, ptr %argv, i64 %105
  %106 = load ptr, ptr %arrayidx31.i737.i.i.prol, align 8
  store ptr %106, ptr %arrayidx28.i736.i.i.prol, align 8
  store ptr %104, ptr %arrayidx31.i737.i.i.prol, align 8
  %indvars.iv.next.i738.i.i.prol = or i64 %indvars.iv.i735.i.i.ph, 1
  br label %for.body25.i740.i.i.prol.loopexit

for.body25.i740.i.i.prol.loopexit:                ; preds = %for.body25.i740.i.i.prol, %for.body25.i740.i.i.preheader
  %indvars.iv.i735.i.i.unr = phi i64 [ %indvars.iv.i735.i.i.ph, %for.body25.i740.i.i.preheader ], [ %indvars.iv.next.i738.i.i.prol, %for.body25.i740.i.i.prol ]
  %107 = sub nsw i64 0, %wide.trip.count.i722.i.i
  %108 = icmp eq i64 %102, %107
  br i1 %108, label %for.end40.i742.i.i, label %for.body25.i740.i.i

for.cond.preheader.i726.i.i:                      ; preds = %while.body.i719.i.i
  %cmp589.i724.i.i = icmp sgt i32 %sub2.i717.i.i, 0
  %sub7.i725.i.i = sub i32 %top.093.i715.i.i, %sub2.i717.i.i
  br i1 %cmp589.i724.i.i, label %for.body.lr.ph.i728.i.i, label %if.end.i747.i.i

for.body.lr.ph.i728.i.i:                          ; preds = %for.cond.preheader.i726.i.i
  %109 = sext i32 %bottom.094.i714.i.i to i64
  %110 = sext i32 %sub7.i725.i.i to i64
  %wide.trip.count103.i727.i.i = zext i32 %sub2.i717.i.i to i64
  %min.iters.check413 = icmp ult i32 %sub2.i717.i.i, 10
  br i1 %min.iters.check413, label %for.body.i734.i.i.preheader, label %vector.memcheck403

vector.memcheck403:                               ; preds = %for.body.lr.ph.i728.i.i
  %111 = shl nsw i64 %109, 3
  %scevgep404 = getelementptr i8, ptr %argv, i64 %111
  %112 = shl nuw nsw i64 %wide.trip.count103.i727.i.i, 3
  ...
  br i1 %found.conflict410, label %for.body.i734.i.i.preheader, label %vector.ph414

vector.ph414:                                     ; preds = %vector.memcheck403
  %n.vec416 = and i64 %wide.trip.count103.i727.i.i, 4294967292
...
middle.block411:                                  ; preds = %vector.body419
  %cmp.n418 = icmp eq i64 %n.vec416, %wide.trip.count103.i727.i.i
  br i1 %cmp.n418, label %if.end.i747.i.i, label %for.body.i734.i.i.preheader

for.body.i734.i.i.preheader:                      ; preds = %vector.memcheck403, %for.body.lr.ph.i728.i.i, %middle.block411
  %indvars.iv98.i729.i.i.ph = phi i64 [ 0, %vector.memcheck403 ], [ 0, %for.body.lr.ph.i728.i.i ], [ %n.vec416, %middle.block411 ]
  %123 = xor i64 %indvars.iv98.i729.i.i.ph, -1
  %xtraiter488 = and i64 %wide.trip.count103.i727.i.i, 1
  %lcmp.mod489.not = icmp eq i64 %xtraiter488, 0
  br i1 %lcmp.mod489.not, label %for.body.i734.i.i.prol.loopexit, label %for.body.i734.i.i.prol

for.body.i734.i.i.prol:                           ; preds = %for.body.i734.i.i.preheader
  %124 = add nsw i64 %indvars.iv98.i729.i.i.ph, %109
  %arrayidx.i730.i.i.prol = getelementptr inbounds ptr, ptr %argv, i64 %124
  %125 = load ptr, ptr %arrayidx.i730.i.i.prol, align 8
  %126 = add nsw i64 %indvars.iv98.i729.i.i.ph, %110
  %arrayidx10.i731.i.i.prol = getelementptr inbounds ptr, ptr %argv, i64 %126
  %127 = load ptr, ptr %arrayidx10.i731.i.i.prol, align 8
  store ptr %127, ptr %arrayidx.i730.i.i.prol, align 8
  store ptr %125, ptr %arrayidx10.i731.i.i.prol, align 8
  %indvars.iv.next99.i732.i.i.prol = or i64 %indvars.iv98.i729.i.i.ph, 1
  br label %for.body.i734.i.i.prol.loopexit

for.body.i734.i.i.prol.loopexit:                  ; preds = %for.body.i734.i.i.prol, %for.body.i734.i.i.preheader
  %indvars.iv98.i729.i.i.unr = phi i64 [ %indvars.iv98.i729.i.i.ph, %for.body.i734.i.i.preheader ], [ %indvars.iv.next99.i732.i.i.prol, %for.body.i734.i.i.prol ]
  %128 = sub nsw i64 0, %wide.trip.count103.i727.i.i
  %129 = icmp eq i64 %123, %128
  br i1 %129, label %if.end.i747.i.i, label %for.body.i734.i.i

for.body.i734.i.i:                                ; preds = %for.body.i734.i.i.prol.loopexit, %for.body.i734.i.i
  %indvars.iv98.i729.i.i = phi i64 [ %indvars.iv.next99.i732.i.i.1, %for.body.i734.i.i ], [ %indvars.iv98.i729.i.i.unr, %for.body.i734.i.i.prol.loopexit ]
  %130 = add nsw i64 %indvars.iv98.i729.i.i, %109
  %arrayidx.i730.i.i = getelementptr inbounds ptr, ptr %argv, i64 %130
  %131 = load ptr, ptr %arrayidx.i730.i.i, align 8
  %132 = add nsw i64 %indvars.iv98.i729.i.i, %110
  %arrayidx10.i731.i.i = getelementptr inbounds ptr, ptr %argv, i64 %132
  %133 = load ptr, ptr %arrayidx10.i731.i.i, align 8
  store ptr %133, ptr %arrayidx.i730.i.i, align 8
  store ptr %131, ptr %arrayidx10.i731.i.i, align 8
  %indvars.iv.next99.i732.i.i = add nuw nsw i64 %indvars.iv98.i729.i.i, 1
  %134 = add nsw i64 %indvars.iv.next99.i732.i.i, %109
  %arrayidx.i730.i.i.1 = getelementptr inbounds ptr, ptr %argv, i64 %134
  %135 = load ptr, ptr %arrayidx.i730.i.i.1, align 8
  %136 = add nsw i64 %indvars.iv.next99.i732.i.i, %110
  %arrayidx10.i731.i.i.1 = getelementptr inbounds ptr, ptr %argv, i64 %136
  %137 = load ptr, ptr %arrayidx10.i731.i.i.1, align 8
  store ptr %137, ptr %arrayidx.i730.i.i.1, align 8
  store ptr %135, ptr %arrayidx10.i731.i.i.1, align 8
  %indvars.iv.next99.i732.i.i.1 = add nuw nsw i64 %indvars.iv98.i729.i.i, 2
  %exitcond104.not.i733.i.i.1 = icmp eq i64 %indvars.iv.next99.i732.i.i.1, %wide.trip.count103.i727.i.i
  br i1 %exitcond104.not.i733.i.i.1, label %if.end.i747.i.i, label %for.body.i734.i.i, !llvm.loop !49

for.body25.i740.i.i:                              ; preds = %for.body25.i740.i.i.prol.loopexit, %for.body25.i740.i.i
  %indvars.iv.i735.i.i = phi i64 [ %indvars.iv.next.i738.i.i.1, %for.body25.i740.i.i ], [ %indvars.iv.i735.i.i.unr, %for.body25.i740.i.i.prol.loopexit ]
  %138 = add nsw i64 %indvars.iv.i735.i.i, %91
  %arrayidx28.i736.i.i = getelementptr inbounds ptr, ptr %argv, i64 %138
  %139 = load ptr, ptr %arrayidx28.i736.i.i, align 8
  %140 = add nsw i64 %indvars.iv.i735.i.i, %89
  %arrayidx31.i737.i.i = getelementptr inbounds ptr, ptr %argv, i64 %140
  %141 = load ptr, ptr %arrayidx31.i737.i.i, align 8
  store ptr %141, ptr %arrayidx28.i736.i.i, align 8
  store ptr %139, ptr %arrayidx31.i737.i.i, align 8
  %indvars.iv.next.i738.i.i = add nuw nsw i64 %indvars.iv.i735.i.i, 1
  %142 = add nsw i64 %indvars.iv.next.i738.i.i, %91
  %arrayidx28.i736.i.i.1 = getelementptr inbounds ptr, ptr %argv, i64 %142
  %143 = load ptr, ptr %arrayidx28.i736.i.i.1, align 8
  %144 = add nsw i64 %indvars.iv.next.i738.i.i, %89
  %arrayidx31.i737.i.i.1 = getelementptr inbounds ptr, ptr %argv, i64 %144
  %145 = load ptr, ptr %arrayidx31.i737.i.i.1, align 8
  store ptr %145, ptr %arrayidx28.i736.i.i.1, align 8
  store ptr %143, ptr %arrayidx31.i737.i.i.1, align 8
  %indvars.iv.next.i738.i.i.1 = add nuw nsw i64 %indvars.iv.i735.i.i, 2
  %exitcond.not.i739.i.i.1 = icmp eq i64 %indvars.iv.next.i738.i.i.1, %wide.trip.count.i722.i.i
  br i1 %exitcond.not.i739.i.i.1, label %for.end40.i742.i.i, label %for.body25.i740.i.i, !llvm.loop !50

for.end40.i742.i.i:                               ; preds = %for.body25.i740.i.i.prol.loopexit, %for.body25.i740.i.i, %middle.block435, %for.cond23.preheader.i721.i.i
  %add41.i741.i.i = add nsw i32 %sub.i716.i.i, %bottom.094.i714.i.i
  br label %if.end.i747.i.i

if.end.i747.i.i:                                  ; preds = %for.body.i734.i.i.prol.loopexit, %for.body.i734.i.i, %middle.block411, %for.end40.i742.i.i, %for.cond.preheader.i726.i.i
  %top.1.i743.i.i = phi i32 [ %top.093.i715.i.i, %for.end40.i742.i.i ], [ %sub7.i725.i.i, %for.cond.preheader.i726.i.i ], [ %sub7.i725.i.i, %middle.block411 ], [ %sub7.i725.i.i, %for.body.i734.i.i ], [ %sub7.i725.i.i, %for.body.i734.i.i.prol.loopexit ]
  %bottom.1.i744.i.i = phi i32 [ %add41.i741.i.i, %for.end40.i742.i.i ], [ %bottom.094.i714.i.i, %for.cond.preheader.i726.i.i ], [ %bottom.094.i714.i.i, %middle.block411 ], [ %bottom.094.i714.i.i, %for.body.i734.i.i ], [ %bottom.094.i714.i.i, %for.body.i734.i.i.prol.loopexit ]
  %cmp.i745.i.i = icmp sgt i32 %top.1.i743.i.i, %84
  %cmp1.i746.i.i = icmp sgt i32 %84, %bottom.1.i744.i.i
  %146 = select i1 %cmp.i745.i.i, i1 %cmp1.i746.i.i, i1 false
  br i1 %146, label %while.body.i719.i.i, label %opts_Exchange.exit750.i.i, !llvm.loop !35

opts_Exchange.exit750.i.i:                        ; preds = %if.end.i747.i.i, %if.then54.i.i
  %sub42.i748.i.i = sub i32 %85, %84
  %add43.i749.i.i = add i32 %sub42.i748.i.i, %inc48.i.i
...
if.end60.sink.split.i.i:                          ; preds = %if.else55.i.i, %opts_Exchange.exit750.i.i
  %inc48.sink.i.i = phi i32 [ %add43.i749.i.i, %opts_Exchange.exit750.i.i ], [ %inc48.i.i, %if.else55.i.i ]
...
if.end105.i.i:                                    ; preds = %if.end91.i.i, %lor.lhs.false2.i.i
  %optstring.addr.0837.i.i = phi ptr [ %optstring.addr.0838.i.i, %if.end91.i.i ], [ %ShortDecl.2.i, %lor.lhs.false2.i.i ]
...
lor.lhs.false123.i.i:                             ; preds = %land.lhs.true117.i.i
  %call128.i.i = tail call ptr @strchr(ptr noundef nonnull dereferenceable(1) %optstring.addr.0837.i.i, i32 noundef %conv112.i.i) #18
...
for.end.i.i:                                      ; preds = %for.cond.i.i, %for.cond.i.i
  ...
  %tobool140.not804.not.i.i = icmp eq ptr %158, null
  br i1 %tobool140.not804.not.i.i, label %lor.lhs.false263.i.i, label %for.body141.lr.ph.i.i
...
for.body141.i.i:                                  ; preds = %for.inc164.i.i, %for.body141.lr.ph.i.i
  ...
  %option_index.0809.i.i = phi i32 [ 0, %for.body141.lr.ph.i.i ], [ %inc166.i.i, %for.inc164.i.i ]
  %indfound.0808.i.i = phi i32 [ -1, %for.body141.lr.ph.i.i ], [ %indfound.1.i.i, %for.inc164.i.i ]
  %ambig.0807.i.i = phi i32 [ 0, %for.body141.lr.ph.i.i ], [ %ambig.1.i.i, %for.inc164.i.i ]
  %pfound.0806.i.i = phi ptr [ null, %for.body141.lr.ph.i.i ], [ %pfound.1.i.i, %for.inc164.i.i ]
  %p.0805.i.i = phi ptr [ %call.i.i, %for.body141.lr.ph.i.i ], [ %incdec.ptr165.i.i, %for.inc164.i.i ]
...
if.else156.i.i:                                   ; preds = %if.then145.i.i
  %cmp157.i.i = icmp eq ptr %pfound.0806.i.i, null
  %p.0.pfound.0.i.i = select i1 %cmp157.i.i, ptr %p.0805.i.i, ptr %pfound.0806.i.i
  %ambig.0..i.i = select i1 %cmp157.i.i, i32 %ambig.0807.i.i, i32 1
  %option_index.0.indfound.0.i.i = select i1 %cmp157.i.i, i32 %option_index.0809.i.i, i32 %indfound.0808.i.i
  br label %for.inc164.i.i

for.inc164.i.i:                                   ; preds = %if.else156.i.i, %for.body141.i.i
  %pfound.1.i.i = phi ptr [ %pfound.0806.i.i, %for.body141.i.i ], [ %p.0.pfound.0.i.i, %if.else156.i.i ]
  %ambig.1.i.i = phi i32 [ %ambig.0807.i.i, %for.body141.i.i ], [ %ambig.0..i.i, %if.else156.i.i ]
  %indfound.1.i.i = phi i32 [ %indfound.0808.i.i, %for.body141.i.i ], [ %option_index.0.indfound.0.i.i, %if.else156.i.i ]
  %incdec.ptr165.i.i = getelementptr inbounds %struct.OPTION, ptr %p.0805.i.i, i64 1
  %inc166.i.i = add nuw nsw i32 %option_index.0809.i.i, 1
...
if.then185.i.i:                                   ; preds = %if.then145.i.i, %if.end182.i.i
  %pfound.2764770.i.i = phi ptr [ %pfound.1.i.i, %if.end182.i.i ], [ %p.0805.i.i, %if.then145.i.i ]
  %indfound.2765769.i.i = phi i32 [ %indfound.1.i.i, %if.end182.i.i ], [ %option_index.0809.i.i, %if.then145.i.i ]
...
lor.lhs.false270.i.i:                             ; preds = %lor.lhs.false263.i.i
  ...
  %call272.i.i = tail call ptr @strchr(ptr noundef nonnull dereferenceable(1) %optstring.addr.0837.i.i, i32 noundef %conv271.i.i) #18
...
if.end304.i.i:                                    ; preds = %lor.lhs.false270.i.i, %lor.lhs.false123.i.i, %if.end105.i.i
  ...
  %call307.i.i = tail call ptr @strchr(ptr noundef nonnull dereferenceable(1) %optstring.addr.0837.i.i, i32 noundef %conv306.i.i) #18
...
if.end335.i.i:                                    ; preds = %if.end313.i.i
  ...
  %or.cond868.i.i = select i1 %cmp338.i.i, i1 %cmp343.i.i, i1 false
  br i1 %or.cond868.i.i, label %if.then345.i.i, label %if.end514.i.i
...
for.end395.i.i:                                   ; preds = %for.cond383.i.i, %for.cond383.i.i
  ...
  %tobool398.not814.not.i.i = icmp eq ptr %214, null
  br i1 %tobool398.not814.not.i.i, label %if.end506.i.i, label %for.body399.lr.ph.i.i
...
for.body399.i.i:                                  ; preds = %for.inc425.i.i, %for.body399.lr.ph.i.i
  ...
  %option_index352.0819.i.i = phi i32 [ 0, %for.body399.lr.ph.i.i ], [ %inc427.i.i, %for.inc425.i.i ]
  %indfound351.0818.i.i = phi i32 [ 0, %for.body399.lr.ph.i.i ], [ %indfound351.1.i.i, %for.inc425.i.i ]
  %ambig350.0817.i.i = phi i32 [ 0, %for.body399.lr.ph.i.i ], [ %ambig350.1.i.i, %for.inc425.i.i ]
  %pfound348.0816.i.i = phi ptr [ null, %for.body399.lr.ph.i.i ], [ %pfound348.1.i.i, %for.inc425.i.i ]
  %p347.0815.i.i = phi ptr [ %call.i.i, %for.body399.lr.ph.i.i ], [ %incdec.ptr426.i.i, %for.inc425.i.i ]
...
if.else417.i.i:                                   ; preds = %if.then406.i.i
  %cmp418.i.i = icmp eq ptr %pfound348.0816.i.i, null
  %p347.0.pfound348.0.i.i = select i1 %cmp418.i.i, ptr %p347.0815.i.i, ptr %pfound348.0816.i.i
  %ambig350.0..i.i = select i1 %cmp418.i.i, i32 %ambig350.0817.i.i, i32 1
  %option_index352.0.indfound351.0.i.i = select i1 %cmp418.i.i, i32 %option_index352.0819.i.i, i32 %indfound351.0818.i.i
  br label %for.inc425.i.i

for.inc425.i.i:                                   ; preds = %if.else417.i.i, %for.body399.i.i
  %pfound348.1.i.i = phi ptr [ %pfound348.0816.i.i, %for.body399.i.i ], [ %p347.0.pfound348.0.i.i, %if.else417.i.i ]
  %ambig350.1.i.i = phi i32 [ %ambig350.0817.i.i, %for.body399.i.i ], [ %ambig350.0..i.i, %if.else417.i.i ]
  %indfound351.1.i.i = phi i32 [ %indfound351.0818.i.i, %for.body399.i.i ], [ %option_index352.0.indfound351.0.i.i, %if.else417.i.i ]
  %incdec.ptr426.i.i = getelementptr inbounds %struct.OPTION, ptr %p347.0815.i.i, i64 1
  %inc427.i.i = add nuw nsw i32 %option_index352.0819.i.i, 1
...
if.then434.i.i:                                   ; preds = %for.end428.i.i
  ...
  tail call void (ptr, ...) @misc_UserErrorReport(ptr noundef nonnull @.str.29, ptr noundef %218, ptr noundef %220) #19
  tail call fastcc void @misc_Error()
  unreachable
...
if.then446.i.i:                                   ; preds = %if.then406.i.i, %if.end443.i.i
  %pfound348.2778784.i.i = phi ptr [ %pfound348.1.i.i, %if.end443.i.i ], [ %p347.0815.i.i, %if.then406.i.i ]
  %indfound351.2779783.i.i = phi i32 [ %indfound351.1.i.i, %if.end443.i.i ], [ %option_index352.0819.i.i, %if.then406.i.i ]
...
if.then455.i.i:                                   ; preds = %if.then448.i.i
  ...
  %224 = load ptr, ptr %pfound348.2778784.i.i, align 8
  tail call void (ptr, ...) @misc_UserErrorReport(ptr noundef nonnull @.str.30, ptr noundef %223, ptr noundef %224) #19
  tail call fastcc void @misc_Error()
  unreachable
...
if.then476.i.i:                                   ; preds = %if.then467.i.i
  ...
  tail call void (ptr, ...) @misc_UserErrorReport(ptr noundef nonnull @.str.22, ptr noundef %227, ptr noundef %229) #19
  tail call fastcc void @misc_Error()
  unreachable

if.end492.sink.split.i.i:                         ; preds = %if.then470.i.i, %if.then451.i.i
  %.sink869.i.i = phi ptr [ %225, %if.then470.i.i ], [ %add.ptr452.i.i, %if.then451.i.i ]
  store ptr %.sink869.i.i, ptr @opts_Arg, align 8
  br label %if.end492.i.i

if.end492.i.i:                                    ; preds = %if.end492.sink.split.i.i, %if.else463.i.i
  %230 = phi ptr [ %.sink869.i.i, %if.end492.sink.split.i.i ], [ %212, %if.else463.i.i ]
...
if.then543.i.i:                                   ; preds = %if.else538.i.i
  ...
  tail call void (ptr, ...) @misc_UserErrorReport(ptr noundef nonnull @.str.28, ptr noundef %235, i32 noundef %conv306.i.i) #19
  tail call fastcc void @misc_Error()
  unreachable
...
if.then5:                                         ; preds = %if.then256.i.i, %if.then501.i.i, %opts_GetOptLongOnly.exit
  ...
  br i1 %cmp.i.not.i109248, label %opts_DeclGetById.exit, label %while.body.i112

while.body.i112:                                  ; preds = %if.then5, %if.end.i
  %Scan.020.i250 = phi ptr [ %Scan.020.i, %if.end.i ], [ %Scan.020.i247, %if.then5 ]
  %Id.021.i249 = phi i32 [ %add.i.i113, %if.end.i ], [ 0, %if.then5 ]
  %239 = getelementptr i8, ptr %Scan.020.i250, i64 8
  %Scan.0.val.i110 = load ptr, ptr %239, align 8
  %call3.val.i = load ptr, ptr %Scan.0.val.i110, align 8
  %call.i.i111 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %call3.val.i, ptr noundef nonnull dereferenceable(1) %238) #18
  %cmp.i18.not.not.i = icmp eq i32 %call.i.i111, 0
  br i1 %cmp.i18.not.not.i, label %opts_Id.exit, label %if.end.i

if.end.i:                                         ; preds = %while.body.i112
  ...
  br i1 %cmp.i.not.i109, label %opts_Id.exit, label %while.body.i112, !llvm.loop !5

opts_Id.exit:                                     ; preds = %while.body.i112, %if.end.i
  %Id.2.i = phi i32 [ %Id.021.i249, %while.body.i112 ], [ -1, %if.end.i ]
  br i1 %cmp.i.not.i109248, label %opts_DeclGetById.exit, label %while.body.i117
...
while.body.i117:                                  ; preds = %opts_Id.exit, %while.cond.i
  %Scan.018.i = phi ptr [ %Scan.0.i115, %while.cond.i ], [ %Scan.020.i247, %opts_Id.exit ]
  %ScanId.017.i = phi i32 [ %add.i.i114, %while.cond.i ], [ 0, %opts_Id.exit ]
...
if.then.i119:                                     ; preds = %while.body.i117
  %240 = getelementptr i8, ptr %Scan.018.i, i64 8
  %Scan.0.val.i118 = load ptr, ptr %240, align 8
...
opts_DeclGetById.exit:                            ; preds = %while.cond.i, %if.then5, %opts_Id.exit, %if.then.i119
  ...
  %241 = load ptr, ptr @opts_Arg, align 8
  %cmp8 = icmp eq ptr %241, null
  br i1 %cmp8, label %if.then9, label %if.else15

if.then9:                                         ; preds = %opts_DeclGetById.exit
  %242 = getelementptr i8, ptr %retval.0.i, i64 8
  %call7.val = load i32, ptr %242, align 8
  %cmp.i.not = icmp eq i32 %call7.val, 1
  br i1 %cmp.i.not, label %if.then12, label %if.end

if.then12:                                        ; preds = %if.then9
  %243 = load ptr, ptr @stdout, align 8
  %call13 = tail call i32 @fflush(ptr noundef %243)
  tail call void (ptr, ...) @misc_UserErrorReport(ptr noundef nonnull @.str.5, ptr noundef %238) #19
  %244 = load ptr, ptr @stderr, align 8
  %call.i120 = tail call i32 @fflush(ptr noundef %244)
  %245 = load ptr, ptr @stdout, align 8
  %call1.i121 = tail call i32 @fflush(ptr noundef %245)
  %246 = load ptr, ptr @stderr, align 8
  %call2.i = tail call i32 @fflush(ptr noundef %246)
  tail call void @exit(i32 noundef 1) #21
  unreachable
...
if.else15:                                        ; preds = %opts_DeclGetById.exit
  %call16 = tail call fastcc i32 @opts_AddParamCheck(i32 noundef %Id.2.i310, ptr noundef nonnull %241), !range !55
  br label %if.end68

if.else21:                                        ; preds = %if.end506.i.i, %if.end87.i.i, %opts_GetOptLongOnly.exit
  %247 = phi ptr [ %237, %opts_GetOptLongOnly.exit ], [ %212, %if.end506.i.i ], [ %87, %if.end87.i.i ]
  ...
  br i1 %cmp.i.not.i3.i.not, label %if.then25, label %while.body.i.i124

while.body.i.i124:                                ; preds = %if.else21, %if.end.i.i126
  %Scan.020.i5.i = phi ptr [ %Scan.020.i.i, %if.end.i.i126 ], [ %Scan.020.i2.i, %if.else21 ]
  %Id.021.i4.i = phi i32 [ %add.i.i.i, %if.end.i.i126 ], [ 0, %if.else21 ]
  %248 = getelementptr i8, ptr %Scan.020.i5.i, i64 8
  %Scan.0.val.i.i122 = load ptr, ptr %248, align 8
  ...
  %cmp.i18.not.not.i.i = icmp eq i32 %call.i.i.i123, 0
  br i1 %cmp.i18.not.not.i.i, label %opts_ShortOptId.exit, label %if.end.i.i126

if.end.i.i126:                                    ; preds = %while.body.i.i124
  %add.i.i.i = add nuw nsw i32 %Id.021.i4.i, 1
  %Scan.020.i.i = load ptr, ptr %Scan.020.i5.i, align 8
  %cmp.i.not.i.i125 = icmp eq ptr %Scan.020.i.i, null
  br i1 %cmp.i.not.i.i125, label %if.then25, label %while.body.i.i124, !llvm.loop !5

opts_ShortOptId.exit:                             ; preds = %while.body.i.i124
  call void @llvm.lifetime.end.p0(i64 2, ptr nonnull %Str.i) #19
  %cmp.i12.not.i138252 = icmp eq i32 %Id.021.i4.i, 0
  br i1 %cmp.i12.not.i138252, label %if.then.i141, label %while.cond.i135.preheader

while.cond.i135.preheader:                        ; preds = %opts_ShortOptId.exit
  %xtraiter483 = and i32 %Id.021.i4.i, 7
  %249 = icmp ult i32 %Id.021.i4.i, 8
  br i1 %249, label %if.then.i141.loopexit.unr-lcssa, label %while.cond.i135.preheader.new

while.cond.i135.preheader.new:                    ; preds = %while.cond.i135.preheader
  %unroll_iter = and i32 %Id.021.i4.i, 2147483640
  br label %while.cond.i135

if.then25:                                        ; preds = %if.else21, %if.end.i.i126
  call void @llvm.lifetime.end.p0(i64 2, ptr nonnull %Str.i) #19
  %250 = load ptr, ptr @stdout, align 8
  %call26 = tail call i32 @fflush(ptr noundef %250)
  %251 = load ptr, ptr @stderr, align 8
  %call27 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %251, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, i32 noundef 928) #20
  ...
  %253 = tail call i64 @fwrite(ptr nonnull @.str.3, i64 132, i64 1, ptr %252) #20
  %254 = load ptr, ptr @stderr, align 8
  %255 = tail call i64 @fwrite(ptr nonnull @.str.13, i64 2, i64 1, ptr %254) #20
  %256 = load ptr, ptr @stderr, align 8
  %call1.i128 = tail call i32 @fflush(ptr noundef %256)
  %257 = load ptr, ptr @stdout, align 8
  %call2.i129 = tail call i32 @fflush(ptr noundef %257)
  %258 = load ptr, ptr @stderr, align 8
  %call3.i = tail call i32 @fflush(ptr noundef %258)
  tail call void @abort() #21
  unreachable

while.cond.i135:                                  ; preds = %while.cond.i135, %while.cond.i135.preheader.new
  %Scan.018.i136253 = phi ptr [ %Scan.020.i2.i, %while.cond.i135.preheader.new ], [ %Scan.0.i133.7, %while.cond.i135 ]
  %niter = phi i32 [ 0, %while.cond.i135.preheader.new ], [ %niter.next.7, %while.cond.i135 ]
  %Scan.0.i133 = load ptr, ptr %Scan.018.i136253, align 8, !nonnull !9
  %Scan.0.i133.1 = load ptr, ptr %Scan.0.i133, align 8, !nonnull !9
  %Scan.0.i133.2 = load ptr, ptr %Scan.0.i133.1, align 8, !nonnull !9
  %Scan.0.i133.3 = load ptr, ptr %Scan.0.i133.2, align 8, !nonnull !9
  %Scan.0.i133.4 = load ptr, ptr %Scan.0.i133.3, align 8, !nonnull !9
  %Scan.0.i133.5 = load ptr, ptr %Scan.0.i133.4, align 8, !nonnull !9
  %Scan.0.i133.6 = load ptr, ptr %Scan.0.i133.5, align 8, !nonnull !9
  %Scan.0.i133.7 = load ptr, ptr %Scan.0.i133.6, align 8, !nonnull !9
  %niter.next.7 = add i32 %niter, 8
  %niter.ncmp.7 = icmp eq i32 %niter.next.7, %unroll_iter
  br i1 %niter.ncmp.7, label %if.then.i141.loopexit.unr-lcssa, label %while.cond.i135

if.then.i141.loopexit.unr-lcssa:                  ; preds = %while.cond.i135, %while.cond.i135.preheader
  %Scan.0.i133.lcssa.ph = phi ptr [ undef, %while.cond.i135.preheader ], [ %Scan.0.i133.7, %while.cond.i135 ]
  %Scan.018.i136253.unr = phi ptr [ %Scan.020.i2.i, %while.cond.i135.preheader ], [ %Scan.0.i133.7, %while.cond.i135 ]
  %lcmp.mod484.not = icmp eq i32 %xtraiter483, 0
  br i1 %lcmp.mod484.not, label %if.then.i141, label %while.cond.i135.epil

while.cond.i135.epil:                             ; preds = %if.then.i141.loopexit.unr-lcssa, %while.cond.i135.epil
  %Scan.018.i136253.epil = phi ptr [ %Scan.0.i133.epil, %while.cond.i135.epil ], [ %Scan.018.i136253.unr, %if.then.i141.loopexit.unr-lcssa ]
  %epil.iter = phi i32 [ %epil.iter.next, %while.cond.i135.epil ], [ 0, %if.then.i141.loopexit.unr-lcssa ]
  %Scan.0.i133.epil = load ptr, ptr %Scan.018.i136253.epil, align 8, !nonnull !9
  %epil.iter.next = add i32 %epil.iter, 1
  %epil.iter.cmp.not = icmp eq i32 %epil.iter.next, %xtraiter483
  br i1 %epil.iter.cmp.not, label %if.then.i141, label %while.cond.i135.epil, !llvm.loop !56

if.then.i141:                                     ; preds = %if.then.i141.loopexit.unr-lcssa, %while.cond.i135.epil, %opts_ShortOptId.exit
  %Scan.018.i136.lcssa = phi ptr [ %Scan.020.i2.i, %opts_ShortOptId.exit ], [ %Scan.0.i133.lcssa.ph, %if.then.i141.loopexit.unr-lcssa ], [ %Scan.0.i133.epil, %while.cond.i135.epil ]
  %259 = getelementptr i8, ptr %Scan.018.i136.lcssa, i64 8
  %Scan.0.val.i140 = load ptr, ptr %259, align 8
  %260 = getelementptr i8, ptr %Scan.0.val.i140, i64 8
  %call30.val = load i32, ptr %260, align 8
...
if.then35:                                        ; preds = %if.then33
  ...
  %call.i146 = tail call i32 @fflush(ptr noundef %262)
  %263 = load ptr, ptr @stdout, align 8
  %call1.i147 = tail call i32 @fflush(ptr noundef %263)
  %264 = load ptr, ptr @stderr, align 8
  %call2.i148 = tail call i32 @fflush(ptr noundef %264)
  tail call void @exit(i32 noundef 1) #21
  unreachable

if.else37:                                        ; preds = %if.then33
  %call.i150 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %247, ptr noundef nonnull dereferenceable(3) @.str.9) #18
...
if.then40:                                        ; preds = %if.else37
  ...
  %call41 = tail call i32 @fflush(ptr noundef %265)
  ...
  %call.i153 = tail call i32 @fflush(ptr noundef %266)
  %267 = load ptr, ptr @stdout, align 8
  %call1.i154 = tail call i32 @fflush(ptr noundef %267)
  %268 = load ptr, ptr @stderr, align 8
  %call2.i155 = tail call i32 @fflush(ptr noundef %268)
  tail call void @exit(i32 noundef 1) #21
  unreachable

if.else42:                                        ; preds = %if.else37
  %call43 = tail call fastcc i32 @opts_AddParamCheck(i32 noundef %Id.021.i4.i, ptr noundef nonnull %247), !range !55
  br label %if.end68

if.then49:                                        ; preds = %if.then.i141
  %tobool50.not = icmp eq ptr %247, null
  br i1 %tobool50.not, label %if.else59, label %if.then51

if.then51:                                        ; preds = %if.then49
  %call.i159 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %247, ptr noundef nonnull dereferenceable(3) @.str.9) #18
...
if.else56:                                        ; preds = %if.then51
  %call57 = tail call fastcc i32 @opts_AddParamCheck(i32 noundef %Id.021.i4.i, ptr noundef nonnull %247), !range !55
  br label %if.end68
...
for.cond.i:                                       ; preds = %for.cond.i, %while.end
  ...
  %269 = load ptr, ptr %arrayidx.i163, align 8
  %cmp.not.i164 = icmp eq ptr %269, null
  %indvars.iv.next.i165 = add nuw i64 %indvars.iv.i162, 1
  br i1 %cmp.not.i164, label %for.end.i, label %for.cond.i, !llvm.loop !58

for.end.i:                                        ; preds = %for.cond.i
  %270 = trunc i64 %indvars.iv.i162 to i32
  %add.i = shl i32 %270, 5
  %mul.i = add i32 %add.i, 32
  %cmp.i.i.i166 = icmp ult i32 %mul.i, 1024
  br i1 %cmp.i.i.i166, label %if.else25.i.i, label %if.then.i.i168

if.then.i.i168:                                   ; preds = %for.end.i
  %271 = load i32, ptr @memory_ALIGN, align 4
  %rem2.i.i.i.i = urem i32 %mul.i, %271
  %tobool3.not.i.i.i.i = icmp eq i32 %rem2.i.i.i.i, 0
  %sub6.i.i.i.i = sub i32 %271, %rem2.i.i.i.i
  %add7.i.i.i.i = select i1 %tobool3.not.i.i.i.i, i32 0, i32 %sub6.i.i.i.i
  %RealSize.1.i.i.i.i = add i32 %add7.i.i.i.i, %mul.i
  %272 = load i32, ptr @memory_OFFSET, align 4
  %idx.ext.i.i167 = zext i32 %272 to i64
  %idx.neg.i.i = sub nsw i64 0, %idx.ext.i.i167
  ...
  %273 = load ptr, ptr %add.ptr1.i.i, align 8
  %cmp2.not.i.i = icmp eq ptr %273, null
  %next6.i.i = getelementptr inbounds i8, ptr %add.ptr.i.i, i64 -8
  %274 = load ptr, ptr %next6.i.i, align 8
  %next5.i.i = getelementptr inbounds %struct.MEMORY_BIGBLOCKHEADERHELP, ptr %273, i64 0, i32 1
  %memory_BIGBLOCKS.sink.i.i = select i1 %cmp2.not.i.i, ptr @memory_BIGBLOCKS, ptr %next5.i.i
  store ptr %274, ptr %memory_BIGBLOCKS.sink.i.i, align 8
  %275 = load ptr, ptr %next6.i.i, align 8
  %cmp8.not.i.i = icmp eq ptr %275, null
  br i1 %cmp8.not.i.i, label %if.end13.i.i171, label %if.then9.i.i

if.then9.i.i:                                     ; preds = %if.then.i.i168
  %276 = load ptr, ptr %add.ptr1.i.i, align 8
  store ptr %276, ptr %275, align 8
  br label %if.end13.i.i171

if.end13.i.i171:                                  ; preds = %if.then9.i.i, %if.then.i.i168
  %277 = load i32, ptr @memory_MARKSIZE, align 4
  %add.i.i169 = add i32 %RealSize.1.i.i.i.i, %277
  %conv.i.i170 = zext i32 %add.i.i169 to i64
  %add14.i.i = add nuw nsw i64 %conv.i.i170, 16
  %278 = load i64, ptr @memory_FREEDBYTES, align 8
  %add15.i.i = add i64 %add14.i.i, %278
  store i64 %add15.i.i, ptr @memory_FREEDBYTES, align 8
  %279 = load i64, ptr @memory_MAXMEM, align 8
  %cmp16.i.i = icmp sgt i64 %279, -1
  br i1 %cmp16.i.i, label %if.then18.i.i, label %if.end23.i.i

if.then18.i.i:                                    ; preds = %if.end13.i.i171
  %add22.i.i = add nuw i64 %279, %add14.i.i
  store i64 %add22.i.i, ptr @memory_MAXMEM, align 8
  br label %if.end23.i.i

if.end23.i.i:                                     ; preds = %if.then18.i.i, %if.end13.i.i171
...
if.else25.i.i:                                    ; preds = %for.end.i
  ...
  %280 = load ptr, ptr %arrayidx.i.i172, align 8
  %total_size.i.i = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %280, i64 0, i32 4
  %281 = load i32, ptr %total_size.i.i, align 8
  %conv26.i.i = sext i32 %281 to i64
  %282 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i = add i64 %282, %conv26.i.i
  store i64 %add27.i.i, ptr @memory_FREEDBYTES, align 8
  %283 = load ptr, ptr %280, align 8
  store ptr %283, ptr %call.i.i, align 8
  %284 = load ptr, ptr %arrayidx.i.i172, align 8
  store ptr %call.i.i, ptr %284, align 8
  br label %cleanup
