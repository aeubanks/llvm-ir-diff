; ModuleID = '/usr/local/google/home/aeubanks/repos/test-suite/Bitcode/simd_ops/x86_tests/test_op_vpcmpgtw_369.bc'
...
@str.11 = private constant [16 x i8] c"op_vpcmpgtw_369\00", align 32
...
define i32 @__test_op(ptr noalias nocapture readnone %in_f32.buffer, ptr noalias nocapture readnone %in_f64.buffer, ptr noalias nocapture readnone %in_i8.buffer, ptr noalias nocapture readnone %in_u8.buffer, ptr noalias nocapture readnone %in_i16.buffer, ptr noalias nocapture readonly %in_u16.buffer, ptr noalias nocapture readnone %in_i32.buffer, ptr noalias nocapture readnone %in_u32.buffer, ptr noalias nocapture readnone %in_i64.buffer, ptr noalias nocapture readnone %in_u64.buffer, ptr noalias nocapture readonly %op_vpcmpgtw_369.buffer) local_unnamed_addr #0 {
"produce op_vpcmpgtw_369":
  %buf_extent168 = getelementptr inbounds %struct.buffer_t, ptr %op_vpcmpgtw_369.buffer, i64 0, i32 2, i64 1
  %op_vpcmpgtw_369.extent.1 = load i32, ptr %buf_extent168, align 4
  %buf_min176 = getelementptr inbounds %struct.buffer_t, ptr %op_vpcmpgtw_369.buffer, i64 0, i32 4, i64 1
  %op_vpcmpgtw_369.min.1 = load i32, ptr %buf_min176, align 4
  %0 = add nsw i32 %op_vpcmpgtw_369.min.1, %op_vpcmpgtw_369.extent.1
  %1 = icmp sgt i32 %op_vpcmpgtw_369.extent.1, 0
  br i1 %1, label %"for op_vpcmpgtw_369.s0.y.preheader", label %destructor_block, !prof !4

"for op_vpcmpgtw_369.s0.y.preheader":             ; preds = %"produce op_vpcmpgtw_369"
  ...
  %buf_min175 = getelementptr inbounds %struct.buffer_t, ptr %op_vpcmpgtw_369.buffer, i64 0, i32 4, i64 0
  %op_vpcmpgtw_369.min.0 = load i32, ptr %buf_min175, align 4
  %2 = sext i32 %op_vpcmpgtw_369.min.0 to i64
  %buf_stride172 = getelementptr inbounds %struct.buffer_t, ptr %op_vpcmpgtw_369.buffer, i64 0, i32 3, i64 1
  %op_vpcmpgtw_369.stride.1 = load i32, ptr %buf_stride172, align 4
  %3 = sext i32 %op_vpcmpgtw_369.stride.1 to i64
  %buf_host163 = getelementptr inbounds %struct.buffer_t, ptr %op_vpcmpgtw_369.buffer, i64 0, i32 1
  %op_vpcmpgtw_369.host = load ptr, ptr %buf_host163, align 8
  %4 = shl nsw i64 %2, 3
  %5 = sub nsw i64 96, %4
  %scevgep = getelementptr i8, ptr %op_vpcmpgtw_369.host, i64 %5
  %6 = shl nsw i64 %3, 3
  ...
  %9 = icmp ugt <16 x i16> %7, %8
  %10 = select <16 x i1> %9, <16 x i16> <i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1>, <16 x i16> <i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2>
  %11 = uitofp <16 x i16> %10 to <16 x double>
  ...
  %16 = load <16 x i16>, ptr %sunkaddr211.1, align 32, !tbaa !5
  %17 = icmp ugt <16 x i16> %8, %16
  %18 = select <16 x i1> %17, <16 x i16> <i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1>, <16 x i16> <i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2>
  %19 = uitofp <16 x i16> %18 to <16 x double>
  ...
  %24 = load <16 x i16>, ptr %sunkaddr207.2, align 32, !tbaa !5
  %sunkaddr210.2 = add i64 %sunkaddr, 96
  %sunkaddr211.2 = inttoptr i64 %sunkaddr210.2 to ptr
  %25 = load <16 x i16>, ptr %sunkaddr211.2, align 32, !tbaa !5
  %26 = icmp ugt <16 x i16> %24, %25
  %27 = select <16 x i1> %26, <16 x i16> <i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1>, <16 x i16> <i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2>
  %28 = uitofp <16 x i16> %27 to <16 x double>
  ...
  %33 = load <16 x i16>, ptr %sunkaddr207.3, align 32, !tbaa !5
  %sunkaddr210.3 = add i64 %sunkaddr, 128
  %sunkaddr211.3 = inttoptr i64 %sunkaddr210.3 to ptr
  %34 = load <16 x i16>, ptr %sunkaddr211.3, align 32, !tbaa !5
  %35 = icmp ugt <16 x i16> %33, %34
  %36 = select <16 x i1> %35, <16 x i16> <i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1>, <16 x i16> <i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2>
  %37 = uitofp <16 x i16> %36 to <16 x double>
  ...
  %42 = load <16 x i16>, ptr %sunkaddr207.4, align 32, !tbaa !5
  %sunkaddr210.4 = add i64 %sunkaddr, 160
  %sunkaddr211.4 = inttoptr i64 %sunkaddr210.4 to ptr
  %43 = load <16 x i16>, ptr %sunkaddr211.4, align 32, !tbaa !5
  %44 = icmp ugt <16 x i16> %42, %43
  %45 = select <16 x i1> %44, <16 x i16> <i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1>, <16 x i16> <i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2>
  ...
  %51 = load <16 x i16>, ptr %sunkaddr207.5, align 32, !tbaa !5
  %sunkaddr210.5 = add i64 %sunkaddr, 192
  %sunkaddr211.5 = inttoptr i64 %sunkaddr210.5 to ptr
  %52 = load <16 x i16>, ptr %sunkaddr211.5, align 32, !tbaa !5
  %53 = icmp ugt <16 x i16> %51, %52
  %54 = select <16 x i1> %53, <16 x i16> <i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1>, <16 x i16> <i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2>
  ...
  %60 = load <16 x i16>, ptr %sunkaddr207.6, align 32, !tbaa !5
  %sunkaddr210.6 = add i64 %sunkaddr, 224
  %sunkaddr211.6 = inttoptr i64 %sunkaddr210.6 to ptr
  %61 = load <16 x i16>, ptr %sunkaddr211.6, align 32, !tbaa !5
  %62 = icmp ugt <16 x i16> %60, %61
  %63 = select <16 x i1> %62, <16 x i16> <i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1>, <16 x i16> <i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2>
  %64 = uitofp <16 x i16> %63 to <16 x double>
  ...
  %69 = load <16 x i16>, ptr %sunkaddr207.7, align 32, !tbaa !5
  %sunkaddr210.7 = add i64 %sunkaddr, 256
  %sunkaddr211.7 = inttoptr i64 %sunkaddr210.7 to ptr
  %70 = load <16 x i16>, ptr %sunkaddr211.7, align 32, !tbaa !5
  %71 = icmp ugt <16 x i16> %69, %70
  %72 = select <16 x i1> %71, <16 x i16> <i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1>, <16 x i16> <i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2>
  ...
  %78 = load <16 x i16>, ptr %sunkaddr207.8, align 32, !tbaa !5
  %sunkaddr210.8 = add i64 %sunkaddr, 288
  %sunkaddr211.8 = inttoptr i64 %sunkaddr210.8 to ptr
  %79 = load <16 x i16>, ptr %sunkaddr211.8, align 32, !tbaa !5
  %80 = icmp ugt <16 x i16> %78, %79
  %81 = select <16 x i1> %80, <16 x i16> <i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1>, <16 x i16> <i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2>
  %82 = uitofp <16 x i16> %81 to <16 x double>
  ...
  br label %"for op_vpcmpgtw_369.s0.x.x.preheader"

"for op_vpcmpgtw_369.s0.x.x.preheader":           ; preds = %"for op_vpcmpgtw_369.s0.x.x.preheader", %"for op_vpcmpgtw_369.s0.y.preheader"
  %lsr.iv180 = phi ptr [ %scevgep, %"for op_vpcmpgtw_369.s0.y.preheader" ], [ %scevgep182, %"for op_vpcmpgtw_369.s0.x.x.preheader" ]
  %op_vpcmpgtw_369.s0.y = phi i32 [ %op_vpcmpgtw_369.min.1, %"for op_vpcmpgtw_369.s0.y.preheader" ], [ %150, %"for op_vpcmpgtw_369.s0.x.x.preheader" ]
  ...
  %87 = load <16 x i16>, ptr %sunkaddr207.9, align 32, !tbaa !5
  %88 = load <16 x i16>, ptr %sunkaddr211.9, align 32, !tbaa !5
  %89 = icmp ugt <16 x i16> %87, %88
  %90 = select <16 x i1> %89, <16 x i16> <i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1>, <16 x i16> <i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2>
  %91 = uitofp <16 x i16> %90 to <16 x double>
  ...
  %96 = load <16 x i16>, ptr %sunkaddr207.10, align 32, !tbaa !5
  %97 = load <16 x i16>, ptr %sunkaddr211.10, align 32, !tbaa !5
  %98 = icmp ugt <16 x i16> %96, %97
  %99 = select <16 x i1> %98, <16 x i16> <i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1>, <16 x i16> <i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2>
  %100 = uitofp <16 x i16> %99 to <16 x double>
  ...
  %105 = load <16 x i16>, ptr %sunkaddr207.11, align 32, !tbaa !5
  %106 = load <16 x i16>, ptr %sunkaddr211.11, align 32, !tbaa !5
  %107 = icmp ugt <16 x i16> %105, %106
  %108 = select <16 x i1> %107, <16 x i16> <i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1>, <16 x i16> <i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2>
  %109 = uitofp <16 x i16> %108 to <16 x double>
  ...
  %114 = load <16 x i16>, ptr %sunkaddr207.12, align 32, !tbaa !5
  %115 = load <16 x i16>, ptr %sunkaddr211.12, align 32, !tbaa !5
  %116 = icmp ugt <16 x i16> %114, %115
  %117 = select <16 x i1> %116, <16 x i16> <i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1>, <16 x i16> <i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2>
  %118 = uitofp <16 x i16> %117 to <16 x double>
  ...
  %123 = load <16 x i16>, ptr %sunkaddr207.13, align 32, !tbaa !5
  %124 = load <16 x i16>, ptr %sunkaddr211.13, align 32, !tbaa !5
  %125 = icmp ugt <16 x i16> %123, %124
  %126 = select <16 x i1> %125, <16 x i16> <i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1>, <16 x i16> <i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2>
  %127 = uitofp <16 x i16> %126 to <16 x double>
  ...
  %132 = load <16 x i16>, ptr %sunkaddr207.14, align 32, !tbaa !5
  %133 = load <16 x i16>, ptr %sunkaddr211.14, align 32, !tbaa !5
  %134 = icmp ugt <16 x i16> %132, %133
  %135 = select <16 x i1> %134, <16 x i16> <i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1>, <16 x i16> <i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2>
  %136 = uitofp <16 x i16> %135 to <16 x double>
  ...
  %141 = load <16 x i16>, ptr %sunkaddr207.15, align 32, !tbaa !5
  %142 = load <16 x i16>, ptr %sunkaddr211.15, align 32, !tbaa !5
  %143 = icmp ugt <16 x i16> %141, %142
  %144 = select <16 x i1> %143, <16 x i16> <i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1>, <16 x i16> <i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2, i16 2>
  ...
  %150 = add nsw i32 %op_vpcmpgtw_369.s0.y, 1
  %scevgep182 = getelementptr i1, ptr %lsr.iv180, i64 %6
  %.not2 = icmp eq i32 %150, %0
  br i1 %.not2, label %destructor_block, label %"for op_vpcmpgtw_369.s0.x.x.preheader"

destructor_block:                                 ; preds = %"for op_vpcmpgtw_369.s0.x.x.preheader", %"produce op_vpcmpgtw_369"
  ret i32 0
}

; Function Attrs: nofree norecurse nosync nounwind memory(readwrite, inaccessiblemem: none)
define i32 @test_op(ptr noalias nocapture readnone %in_f32.buffer, ptr noalias nocapture readnone %in_f64.buffer, ptr noalias nocapture readnone %in_i8.buffer, ptr noalias nocapture readnone %in_u8.buffer, ptr noalias nocapture readnone %in_i16.buffer, ptr noalias nocapture readonly %in_u16.buffer, ptr noalias nocapture readnone %in_i32.buffer, ptr noalias nocapture readnone %in_u32.buffer, ptr noalias nocapture readnone %in_i64.buffer, ptr noalias nocapture readnone %in_u64.buffer, ptr noalias nocapture readonly %op_vpcmpgtw_369.buffer) local_unnamed_addr #1 {
destructor_block:
  %"__test_op_result$23" = tail call i32 @__test_op(ptr poison, ptr poison, ptr poison, ptr poison, ptr poison, ptr %in_u16.buffer, ptr poison, ptr poison, ptr poison, ptr poison, ptr %op_vpcmpgtw_369.buffer) #3
  ret i32 0
}
