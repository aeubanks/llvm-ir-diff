...
define dso_local i32 @NALUtoRBSP(ptr nocapture noundef %nalu) local_unnamed_addr #0 {
entry:
  ...
  %1 = load i32, ptr %len, align 4, !tbaa !11
  %call = tail call i32 @EBSPtoRBSP(ptr noundef %0, i32 noundef %1, i32 noundef 1) #2
  store i32 %call, ptr %len, align 4, !tbaa !11
  ret i32 %call
}
