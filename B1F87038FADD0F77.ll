...
entry:
  ...
  tail call fastcc void @fn1(ptr noundef %0)
  ret i32 0
}
...
define internal fastcc void @fn1(ptr nocapture noundef writeonly %p1) unnamed_addr #2 {
entry:
  %.pr = load i32, ptr @p, align 4, !tbaa !11
  %tobool.not1 = icmp eq i32 %.pr, 0
  br i1 %tobool.not1, label %for.end, label %for.body

for.body:                                         ; preds = %entry, %for.body
  store i32 1, ptr %p1, align 4, !tbaa !11
  %0 = load i32, ptr @p, align 4, !tbaa !11
  %inc = add nsw i32 %0, 1
  store i32 %inc, ptr @p, align 4, !tbaa !11
