...
define dso_local ptr @get_pauth(i32 noundef %type) local_unnamed_addr #0 {
entry:
  %0 = load ptr, ptr @get_pauth.no_auth, align 8, !tbaa !5
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i32, ptr @pfs_enable, align 4, !tbaa !9
  store i32 0, ptr @pfs_enable, align 4, !tbaa !9
  %call1 = tail call i32 @getuid() #5
  %call2 = tail call ptr @getpwuid(i32 noundef %call1) #5
  store i32 %1, ptr @pfs_enable, align 4, !tbaa !9
...
if.else:                                          ; preds = %if.then
  %2 = load ptr, ptr %call2, align 8, !tbaa !11
  %call9 = tail call ptr @strcpy(ptr noundef nonnull dereferenceable(1) getelementptr inbounds (%struct.pfs_auth_info, ptr @get_pauth.no_auth_st, i64 0, i32 1), ptr noundef nonnull dereferenceable(1) %2)
  br label %if.end10

if.end10:                                         ; preds = %if.then4, %if.else, %entry
  %3 = load ptr, ptr @get_pauth.no_auth, align 8, !tbaa !5
  ret ptr %3
}
