...
define dso_local noundef zeroext i1 @_ZN19btPrimitiveTriangle25overlap_test_conservativeERKS_(ptr nocapture noundef nonnull readonly align 4 dereferenceable(72) %0, ptr nocapture noundef nonnull readonly align 4 dereferenceable(72) %1) local_unnamed_addr #3 align 2 {
  ...
  %30 = fsub float %29, %17
  %31 = fsub float %30, %7
  %32 = load <4 x float>, ptr %1, align 4
...
65:                                               ; preds = %2
  ...
  %88 = fsub float %87, %75
  %89 = fsub float %88, %7
  %90 = load <4 x float>, ptr %0, align 4
  %91 = shufflevector <4 x float> %90, <4 x float> poison, <2 x i32> <i32 0, i32 undef>
  %92 = load <4 x float>, ptr %68, align 4
  %93 = shufflevector <4 x float> %92, <4 x float> poison, <2 x i32> <i32 0, i32 undef>
  %94 = load <4 x float>, ptr %71, align 4
  %95 = shufflevector <4 x float> %94, <4 x float> poison, <2 x i32> <i32 0, i32 undef>
  %96 = load float, ptr %76, align 4, !tbaa !14
  %97 = load float, ptr %77, align 4, !tbaa !14
  %98 = insertelement <2 x float> poison, float %70, i64 0
  %99 = shufflevector <2 x float> %98, <2 x float> poison, <2 x i32> zeroinitializer
  %100 = insertelement <2 x float> %93, float %97, i64 1
  %101 = fmul <2 x float> %99, %100
  %102 = insertelement <2 x float> %91, float %96, i64 1
  %103 = insertelement <2 x float> poison, float %67, i64 0
  %104 = shufflevector <2 x float> %103, <2 x float> poison, <2 x i32> zeroinitializer
  %105 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %102, <2 x float> %104, <2 x float> %101)
  %106 = load float, ptr %78, align 4, !tbaa !14
  %107 = insertelement <2 x float> %95, float %106, i64 1
  ...
  %110 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %107, <2 x float> %109, <2 x float> %105)
  ...
  %116 = shufflevector <2 x i1> %115, <2 x i1> poison, <2 x i32> <i32 1, i32 undef>
  %117 = or <2 x i1> %115, %116
...
define dso_local noundef zeroext i1 @_ZN17btTriangleShapeEx25overlap_test_conservativeERKS_(ptr noundef nonnull align 8 dereferenceable(112) %0, ptr noundef nonnull align 8 dereferenceable(112) %1) local_unnamed_addr #4 align 2 {
  ...
  %25 = getelementptr inbounds %class.btTriangleShape, ptr %1, i64 0, i32 1, i64 1
  %26 = getelementptr inbounds %class.btTriangleShape, ptr %1, i64 0, i32 1, i64 2
  %27 = getelementptr inbounds %class.btTriangleShape, ptr %1, i64 0, i32 1, i64 0, i32 0, i64 1
  %28 = getelementptr inbounds %class.btTriangleShape, ptr %1, i64 0, i32 1, i64 0, i32 0, i64 2
  %29 = load float, ptr %21, align 8, !tbaa !14
  %30 = load float, ptr %22, align 4, !tbaa !14
  %31 = load float, ptr %23, align 8, !tbaa !14
  %32 = getelementptr inbounds %class.btTriangleShape, ptr %1, i64 0, i32 1, i64 1, i32 0, i64 1
  %33 = getelementptr inbounds %class.btTriangleShape, ptr %1, i64 0, i32 1, i64 1, i32 0, i64 2
  ...
  %43 = fneg float %37
  %44 = fneg float %39
  %45 = load float, ptr %26, align 8, !tbaa !14
  %46 = fsub float %29, %36
  %47 = fsub float %30, %38
  %48 = fsub float %31, %40
  %49 = fmul float %47, %42
  %50 = tail call float @llvm.fmuladd.f32(float %39, float %48, float %49)
  %51 = fmul float %48, %43
  %52 = tail call float @llvm.fmuladd.f32(float %41, float %46, float %51)
  %53 = fmul float %46, %44
  %54 = tail call float @llvm.fmuladd.f32(float %37, float %47, float %53)
  %55 = fmul float %52, %52
  ...
  %83 = fsub float %82, %11
  %84 = load float, ptr %25, align 8, !tbaa !14
  %85 = load float, ptr %24, align 8, !tbaa !14
  %86 = load float, ptr %27, align 4, !tbaa !14
  %87 = load float, ptr %28, align 8, !tbaa !14
  ...
  %91 = fmul <2 x float> %90, %67
  %92 = insertelement <2 x float> poison, float %85, i64 0
  %93 = insertelement <2 x float> %92, float %84, i64 1
  %94 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %93, <2 x float> %72, <2 x float> %91)
  %95 = load float, ptr %33, align 8, !tbaa !14
  %96 = insertelement <2 x float> poison, float %87, i64 0
  %97 = insertelement <2 x float> %96, float %95, i64 1
  %98 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %97, <2 x float> %78, <2 x float> %94)
  ...
  %105 = shufflevector <2 x i1> %104, <2 x i1> poison, <2 x i32> <i32 1, i32 undef>
  %106 = and <2 x i1> %104, %105
...
110:                                              ; preds = %2
  %111 = fsub float %84, %85
  %112 = fsub float %63, %86
  %113 = fsub float %45, %85
  %114 = fsub float %88, %86
  %115 = fneg float %114
  %116 = fmul float %113, %115
  %117 = tail call float @llvm.fmuladd.f32(float %111, float %112, float %116)
  %118 = fsub float %74, %87
  %119 = fsub float %95, %87
  %120 = fneg float %119
  ...
  %135 = insertelement <2 x float> %134, float %86, i64 1
  %136 = insertelement <2 x float> poison, float %133, i64 0
  %137 = shufflevector <2 x float> %136, <2 x float> poison, <2 x i32> zeroinitializer
  %138 = fmul <2 x float> %135, %137
  %139 = insertelement <2 x float> poison, float %29, i64 0
  %140 = insertelement <2 x float> %139, float %85, i64 1
  ...
  %144 = insertelement <2 x float> poison, float %31, i64 0
  %145 = insertelement <2 x float> %144, float %87, i64 1
  ...
  %153 = insertelement <2 x float> poison, float %38, i64 0
  %154 = insertelement <2 x float> %153, float %19, i64 1
  %155 = fmul <2 x float> %154, %137
  %156 = insertelement <2 x float> poison, float %36, i64 0
  %157 = insertelement <2 x float> %156, float %18, i64 1
  %158 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %157, <2 x float> %142, <2 x float> %155)
  %159 = insertelement <2 x float> poison, float %40, i64 0
  %160 = insertelement <2 x float> %159, float %20, i64 1
  ...
  %165 = fcmp ogt <2 x float> %164, zeroinitializer
  %166 = shufflevector <2 x i1> %165, <2 x i1> poison, <2 x i32> <i32 1, i32 undef>
  %167 = and <2 x i1> %165, %166
  %168 = extractelement <2 x i1> %167, i64 0
  %169 = fcmp ogt float %152, 0.000000e+00
  %170 = and i1 %169, %168
  %171 = xor i1 %170, true
  br label %172

172:                                              ; preds = %110, %2
  %173 = phi i1 [ false, %2 ], [ %171, %110 ]
  ret i1 %173
}
