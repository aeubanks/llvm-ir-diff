...
for.body.lr.ph.i:                                 ; preds = %if.end
  %arrayidx7.i.i.i = getelementptr inbounds %struct.GIM_TRIANGLE_CONTACT, ptr %contacts1, i64 0, i32 2, i32 0, i32 0, i64 1
  ...
  %2 = load float, ptr %m_separating_normal, align 4, !tbaa !14
  %3 = load float, ptr %arrayidx7.i.i.i, align 4, !tbaa !14
  %4 = load float, ptr %arrayidx12.i.i.i, align 4, !tbaa !14
  %5 = load float, ptr %arrayidx.i.i, align 4, !tbaa !14
  br label %for.body.i.outer

for.body.i.outer:                                 ; preds = %if.end18.i.thread, %for.body.lr.ph.i
  %.sink.i110.ph = phi i32 [ 1, %if.end18.i.thread ], [ 0, %for.body.lr.ph.i ]
  %add.i107.ph = phi float [ %add.i, %if.end18.i.thread ], [ -1.000000e+03, %for.body.lr.ph.i ]
  %indvars.iv.i.ph = phi i64 [ %indvars.iv.next.i124, %if.end18.i.thread ], [ 0, %for.body.lr.ph.i ]
  br label %for.body.i

for.cond20.preheader.i:                           ; preds = %if.end18.i
  store float %add.i107.ph, ptr %contacts1, align 4, !tbaa !13
  store i32 %.sink.i111, ptr %m_point_count.i, align 4, !tbaa !5
...
for.body23.preheader.i:                           ; preds = %for.cond20.preheader.i.thread, %for.cond20.preheader.i
  %.sink.i111126135 = phi i32 [ 1, %for.cond20.preheader.i.thread ], [ %.sink.i111, %for.cond20.preheader.i ]
  %add.i108127134 = phi float [ %add.i, %for.cond20.preheader.i.thread ], [ %add.i107.ph, %for.cond20.preheader.i ]
  %inc45.i128133 = phi i32 [ 1, %for.cond20.preheader.i.thread ], [ %inc45.i, %for.cond20.preheader.i ]
  %wide.trip.count56.i = zext i32 %inc45.i128133 to i64
  %xtraiter = and i64 %wide.trip.count56.i, 1
  %6 = icmp eq i32 %inc45.i128133, 1
  br i1 %6, label %_ZN20GIM_TRIANGLE_CONTACT12merge_pointsERK9btVector4fPK9btVector3i.exit.loopexit.unr-lcssa, label %for.body23.preheader.i.new
...
if.then12.i:                                      ; preds = %if.else.i
  ...
  store i32 %12, ptr %arrayidx15.i, align 4, !tbaa !15
  %inc.i = add nsw i32 %inc4648.i, 1
  br label %if.end18.i

if.end18.i:                                       ; preds = %if.then12.i, %if.else.i, %for.body.i
  %.sink.i111 = phi i32 [ %.sink.i110, %if.else.i ], [ %.sink.i110, %for.body.i ], [ %inc.i, %if.then12.i ]
...
if.end18.i.thread:                                ; preds = %if.then.i
  ...
  store i32 %13, ptr %point_indices.i, align 16, !tbaa !15
  %indvars.iv.next.i124 = add nuw nsw i64 %indvars.iv.i, 1
  %exitcond.not.i125 = icmp eq i64 %indvars.iv.next.i124, %wide.trip.count.i
  br i1 %exitcond.not.i125, label %for.cond20.preheader.i.thread, label %for.body.i.outer
...
for.body23.i:                                     ; preds = %for.body23.i, %for.body23.preheader.i.new
  ...
  %14 = load i32, ptr %arrayidx25.i, align 8, !tbaa !15
  %idxprom26.i = sext i32 %14 to i64
  ...
  %15 = load i32, ptr %arrayidx25.i.1, align 4, !tbaa !15
  %idxprom26.i.1 = sext i32 %15 to i64
...
for.body23.i.epil:                                ; preds = %_ZN20GIM_TRIANGLE_CONTACT12merge_pointsERK9btVector4fPK9btVector3i.exit.loopexit.unr-lcssa
  ...
  %16 = load i32, ptr %arrayidx25.i.epil, align 4, !tbaa !15
  %idxprom26.i.epil = sext i32 %16 to i64
...
_ZN20GIM_TRIANGLE_CONTACT12merge_pointsERK9btVector4fPK9btVector3i.exit: ; preds = %for.body23.i.epil, %_ZN20GIM_TRIANGLE_CONTACT12merge_pointsERK9btVector4fPK9btVector3i.exit.loopexit.unr-lcssa, %for.cond20.preheader.i
  %17 = phi float [ %add.i107.ph, %for.cond20.preheader.i ], [ %add.i108127134, %_ZN20GIM_TRIANGLE_CONTACT12merge_pointsERK9btVector4fPK9btVector3i.exit.loopexit.unr-lcssa ], [ %add.i108127134, %for.body23.i.epil ]
  %18 = phi i32 [ %.sink.i111, %for.cond20.preheader.i ], [ %.sink.i111126135, %_ZN20GIM_TRIANGLE_CONTACT12merge_pointsERK9btVector4fPK9btVector3i.exit.loopexit.unr-lcssa ], [ %.sink.i111126135, %for.body23.i.epil ]
  call void @llvm.lifetime.end.p0(i64 64, ptr nonnull %point_indices.i) #9
...
if.end7:                                          ; preds = %_ZN20GIM_TRIANGLE_CONTACT12merge_pointsERK9btVector4fPK9btVector3i.exit
  %19 = load <2 x float>, ptr %m_separating_normal, align 4, !tbaa !14
  %20 = fneg <2 x float> %19
  store <2 x float> %20, ptr %m_separating_normal, align 4, !tbaa !14
  %arrayidx6.i = getelementptr inbounds %struct.GIM_TRIANGLE_CONTACT, ptr %contacts1, i64 0, i32 2, i32 0, i32 0, i64 2
  %21 = load float, ptr %arrayidx6.i, align 4, !tbaa !14
  %mul7.i = fneg float %21
  store float %mul7.i, ptr %arrayidx6.i, align 4, !tbaa !14
...
for.body.lr.ph.i46:                               ; preds = %if.end16
  ...
  %22 = load float, ptr %m_separating_normal11, align 4, !tbaa !14
  %23 = load float, ptr %arrayidx7.i.i.i42, align 4, !tbaa !14
  %24 = load float, ptr %arrayidx12.i.i.i43, align 4, !tbaa !14
  %25 = load float, ptr %arrayidx.i.i44, align 4, !tbaa !14
  br label %for.body.i60.outer

for.body.i60.outer:                               ; preds = %if.end18.i77.thread, %for.body.lr.ph.i46
  %.sink.i71115.ph = phi i32 [ 1, %if.end18.i77.thread ], [ 0, %for.body.lr.ph.i46 ]
  %add.i58112.ph = phi float [ %add.i58, %if.end18.i77.thread ], [ -1.000000e+03, %for.body.lr.ph.i46 ]
  %indvars.iv.i51.ph = phi i64 [ %indvars.iv.next.i75140, %if.end18.i77.thread ], [ 0, %for.body.lr.ph.i46 ]
  br label %for.body.i60

for.cond20.preheader.i48:                         ; preds = %if.end18.i77
  store float %add.i58112.ph, ptr %contacts2, align 4, !tbaa !13
  store i32 %.sink.i71116, ptr %m_point_count.i40, align 4, !tbaa !5
...
for.body23.preheader.i50:                         ; preds = %for.cond20.preheader.i48.thread, %for.cond20.preheader.i48
  %.sink.i71116142151 = phi i32 [ 1, %for.cond20.preheader.i48.thread ], [ %.sink.i71116, %for.cond20.preheader.i48 ]
  %add.i58113143150 = phi float [ %add.i58, %for.cond20.preheader.i48.thread ], [ %add.i58112.ph, %for.cond20.preheader.i48 ]
  %inc45.i74144149 = phi i32 [ 1, %for.cond20.preheader.i48.thread ], [ %inc45.i74, %for.cond20.preheader.i48 ]
  %wide.trip.count56.i49 = zext i32 %inc45.i74144149 to i64
  %xtraiter172 = and i64 %wide.trip.count56.i49, 1
  %26 = icmp eq i32 %inc45.i74144149, 1
...
for.body23.preheader.i50.new:                     ; preds = %for.body23.preheader.i50
  %unroll_iter174 = and i64 %wide.trip.count56.i49, 4294967294
  br label %for.body23.i85

for.body.i60:                                     ; preds = %for.body.i60.outer, %if.end18.i77
  %.sink.i71115 = phi i32 [ %.sink.i71116, %if.end18.i77 ], [ %.sink.i71115.ph, %for.body.i60.outer ]
  %indvars.iv.i51 = phi i64 [ %indvars.iv.next.i75, %if.end18.i77 ], [ %indvars.iv.i51.ph, %for.body.i60.outer ]
  %inc4648.i52 = phi i32 [ %inc45.i74, %if.end18.i77 ], [ %.sink.i71115.ph, %for.body.i60.outer ]
  ...
  %mul8.i.i.i55 = fmul float %28, %23
  %29 = call float @llvm.fmuladd.f32(float %27, float %22, float %mul8.i.i.i55)
...
if.then.i62:                                      ; preds = %for.body.i60
  %cmp4.i61 = fcmp ogt float %add.i58, %add.i58112.ph
...
if.else.i66:                                      ; preds = %if.then.i62
  ...
  %cmp11.i65 = fcmp ult float %add9.i64, %add.i58112.ph
...
if.end18.i77:                                     ; preds = %if.then12.i70, %if.else.i66, %for.body.i60
  %.sink.i71116 = phi i32 [ %.sink.i71115, %if.else.i66 ], [ %.sink.i71115, %for.body.i60 ], [ %inc.i69, %if.then12.i70 ]
...
if.end18.i77.thread:                              ; preds = %if.then.i62
  ...
  %indvars.iv.next.i75140 = add nuw nsw i64 %indvars.iv.i51, 1
  %exitcond.not.i76141 = icmp eq i64 %indvars.iv.next.i75140, %wide.trip.count.i45
  br i1 %exitcond.not.i76141, label %for.cond20.preheader.i48.thread, label %for.body.i60.outer
...
for.body23.i85:                                   ; preds = %for.body23.i85, %for.body23.preheader.i50.new
  ...
  %niter175 = phi i64 [ 0, %for.body23.preheader.i50.new ], [ %niter175.next.1, %for.body23.i85 ]
  ...
  br i1 %niter175.ncmp.1, label %_ZN20GIM_TRIANGLE_CONTACT12merge_pointsERK9btVector4fPK9btVector3i.exit86.loopexit.unr-lcssa, label %for.body23.i85
...
_ZN20GIM_TRIANGLE_CONTACT12merge_pointsERK9btVector4fPK9btVector3i.exit86.loopexit.unr-lcssa: ; preds = %for.body23.i85, %for.body23.preheader.i50
  ...
  br i1 %lcmp.mod173.not, label %_ZN20GIM_TRIANGLE_CONTACT12merge_pointsERK9btVector4fPK9btVector3i.exit86, label %for.body23.i85.epil
...
_ZN20GIM_TRIANGLE_CONTACT12merge_pointsERK9btVector4fPK9btVector3i.exit86: ; preds = %for.body23.i85.epil, %_ZN20GIM_TRIANGLE_CONTACT12merge_pointsERK9btVector4fPK9btVector3i.exit86.loopexit.unr-lcssa, %for.cond20.preheader.i48
  %37 = phi float [ %add.i58112.ph, %for.cond20.preheader.i48 ], [ %add.i58113143150, %_ZN20GIM_TRIANGLE_CONTACT12merge_pointsERK9btVector4fPK9btVector3i.exit86.loopexit.unr-lcssa ], [ %add.i58113143150, %for.body23.i85.epil ]
  %38 = phi i32 [ %.sink.i71116, %for.cond20.preheader.i48 ], [ %.sink.i71116142151, %_ZN20GIM_TRIANGLE_CONTACT12merge_pointsERK9btVector4fPK9btVector3i.exit86.loopexit.unr-lcssa ], [ %.sink.i71116142151, %for.body23.i85.epil ]
  call void @llvm.lifetime.end.p0(i64 64, ptr nonnull %point_indices.i39) #9
...
while.body.preheader.i:                           ; preds = %if.end22
  ...
  store i32 %38, ptr %m_point_count4.i, align 4, !tbaa !5
  ...
  %scevgep119 = getelementptr i8, ptr %contacts, i64 %45
  %scevgep120 = getelementptr i8, ptr %contacts2, i64 %45
  %46 = zext i32 %38 to i64
  %47 = shl nuw nsw i64 %46, 4
  call void @llvm.memcpy.p0.p0.i64(ptr align 4 %scevgep119, ptr align 4 %scevgep120, i64 %47, i1 false)
  br label %cleanup

while.body.preheader.i96:                         ; preds = %if.end22
  store float %17, ptr %contacts, align 4, !tbaa !13
  ...
  store i32 %18, ptr %m_point_count4.i, align 4, !tbaa !5
  ...
  %scevgep = getelementptr i8, ptr %contacts, i64 %54
  %scevgep118 = getelementptr i8, ptr %contacts1, i64 %54
  %55 = zext i32 %18 to i64
  %56 = shl nuw nsw i64 %55, 4
  call void @llvm.memcpy.p0.p0.i64(ptr align 4 %scevgep, ptr align 4 %scevgep118, i64 %56, i1 false)
  br label %cleanup

cleanup:                                          ; preds = %_ZN20GIM_TRIANGLE_CONTACT12merge_pointsERK9btVector4fPK9btVector3i.exit86.thread, %while.body.preheader.i96, %while.body.preheader.i, %_ZN20GIM_TRIANGLE_CONTACT12merge_pointsERK9btVector4fPK9btVector3i.exit86, %if.end7
  %retval.0 = phi i1 [ false, %if.end7 ], [ false, %_ZN20GIM_TRIANGLE_CONTACT12merge_pointsERK9btVector4fPK9btVector3i.exit86 ], [ true, %while.body.preheader.i ], [ true, %while.body.preheader.i96 ], [ false, %_ZN20GIM_TRIANGLE_CONTACT12merge_pointsERK9btVector4fPK9btVector3i.exit86.thread ]
