...
entry:
  ...
  %11 = load <4 x float>, ptr %other, align 4
  ...
  %17 = load float, ptr %arrayidx5, align 4, !tbaa !14
  %18 = load float, ptr %arrayidx5.i.i58, align 4, !tbaa !14
  %19 = insertelement <2 x float> poison, float %3, i64 0
  %20 = shufflevector <2 x float> %19, <2 x float> poison, <2 x i32> zeroinitializer
  %21 = insertelement <2 x float> %14, float %18, i64 1
  %22 = fmul <2 x float> %20, %21
  %23 = insertelement <2 x float> %12, float %17, i64 1
  ...
  %27 = load float, ptr %arrayidx10.i.i61, align 4, !tbaa !14
  %28 = insertelement <2 x float> %16, float %27, i64 1
...
if.end:                                           ; preds = %entry
  ...
  %40 = load float, ptr %m_plane16, align 4, !tbaa !14
  ...
  %41 = load float, ptr %arrayidx7.i.i73, align 4, !tbaa !14
  ...
  %44 = load float, ptr %arrayidx28, align 4, !tbaa !14
  %arrayidx5.i.i86 = getelementptr inbounds [3 x %class.btVector3], ptr %this, i64 0, i64 2, i32 0, i64 1
  %45 = load float, ptr %arrayidx5.i.i86, align 4, !tbaa !14
  %mul8.i.i88 = fmul float %41, %45
  %46 = tail call float @llvm.fmuladd.f32(float %44, float %40, float %mul8.i.i88)
  %arrayidx10.i.i89 = getelementptr inbounds [3 x %class.btVector3], ptr %this, i64 0, i64 2, i32 0, i64 2
  %47 = load float, ptr %arrayidx10.i.i89, align 4, !tbaa !14
  %48 = tail call float @llvm.fmuladd.f32(float %47, float %42, float %46)
  %sub.i92 = fsub float %48, %43
  %sub30 = fsub float %sub.i92, %add
  %49 = load <4 x float>, ptr %this, align 4
  %50 = shufflevector <4 x float> %49, <4 x float> poison, <2 x i32> <i32 0, i32 poison>
  %51 = load <4 x float>, ptr %arrayidx5.i.i72, align 4
  %52 = shufflevector <4 x float> %51, <4 x float> poison, <2 x i32> <i32 0, i32 poison>
  %53 = load <4 x float>, ptr %arrayidx10.i.i75, align 4
  %54 = shufflevector <4 x float> %53, <4 x float> poison, <2 x i32> <i32 0, i32 poison>
  %55 = load float, ptr %arrayidx23, align 4, !tbaa !14
  %56 = load float, ptr %arrayidx5.i.i79, align 4, !tbaa !14
  %57 = insertelement <2 x float> poison, float %41, i64 0
  %58 = shufflevector <2 x float> %57, <2 x float> poison, <2 x i32> zeroinitializer
  %59 = insertelement <2 x float> %52, float %56, i64 1
  %60 = fmul <2 x float> %58, %59
  %61 = insertelement <2 x float> %50, float %55, i64 1
  ...
  %65 = load float, ptr %arrayidx10.i.i82, align 4, !tbaa !14
  %66 = insertelement <2 x float> %54, float %65, i64 1
  ...
  %70 = insertelement <2 x float> poison, float %43, i64 0
...
if.then.i70:                                      ; preds = %for.body
  ...
  %fneg.i46 = fneg float %olddist.089
  %sub.i47 = fsub float %sub.i42, %olddist.089
  %div.i48 = fdiv float %fneg.i46, %sub.i47
  %idxprom.i49 = sext i32 %clipped_count.187 to i64
  ...
  %inc.i69 = add nsw i32 %clipped_count.187, 1
  br label %if.end.i71

if.end.i71:                                       ; preds = %if.then.i70, %for.body
  %clipped_count.4 = phi i32 [ %clipped_count.187, %for.body ], [ %inc.i69, %if.then.i70 ]
...
entry:
  ...
  %14 = load float, ptr %arrayidx6.i65, align 8, !tbaa !14
  %sub.i24.i = fsub float %5, %8
  %sub8.i27.i = fsub float %6, %9
  %sub14.i30.i = fsub float %7, %10
  %neg.i.i = fmul float %sub8.i27.i, %11
  %15 = tail call float @llvm.fmuladd.f32(float %sub8.i.i, float %sub14.i30.i, float %neg.i.i)
  %neg19.i.i = fmul float %sub14.i30.i, %12
  %16 = tail call float @llvm.fmuladd.f32(float %sub14.i.i, float %sub.i24.i, float %neg19.i.i)
  %neg30.i.i = fmul float %sub.i24.i, %13
  %17 = tail call float @llvm.fmuladd.f32(float %sub.i.i, float %sub8.i27.i, float %neg30.i.i)
  %mul8.i.i.i.i.i = fmul float %16, %16
  %18 = tail call float @llvm.fmuladd.f32(float %15, float %15, float %mul8.i.i.i.i.i)
  %19 = tail call float @llvm.fmuladd.f32(float %17, float %17, float %18)
  %sqrt.i.i.i = tail call float @llvm.sqrt.f32(float %19)
  %div.i.i.i = fdiv float 1.000000e+00, %sqrt.i.i.i
  %mul.i.i.i.i = fmul float %15, %div.i.i.i
  ...
  %38 = load float, ptr %arrayidx.i57, align 8, !tbaa !14
  %39 = load float, ptr %m_vertices1.i56, align 8, !tbaa !14
  %40 = load float, ptr %arrayidx5.i.i84, align 4, !tbaa !14
  %41 = load float, ptr %arrayidx10.i.i, align 8, !tbaa !14
  ...
  %45 = fmul <2 x float> %44, %24
  %46 = insertelement <2 x float> poison, float %39, i64 0
  %47 = insertelement <2 x float> %46, float %38, i64 1
  %48 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %47, <2 x float> %29, <2 x float> %45)
  %49 = load float, ptr %arrayidx10.i.i91, align 8, !tbaa !14
  %50 = insertelement <2 x float> poison, float %41, i64 0
  %51 = insertelement <2 x float> %50, float %49, i64 1
  %52 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %51, <2 x float> %35, <2 x float> %48)
...
if.end:                                           ; preds = %entry
  %sub.i.i58 = fsub float %38, %39
  %sub8.i27.i68 = fsub float %20, %40
  %sub.i24.i66 = fsub float %14, %39
  %sub8.i.i61 = fsub float %42, %40
  ...
  %sub14.i30.i70 = fsub float %31, %41
  %sub14.i.i64 = fsub float %49, %41
  ...
  %68 = insertelement <2 x float> poison, float %6, i64 0
  %69 = insertelement <2 x float> %68, float %40, i64 1
  %70 = insertelement <2 x float> poison, float %mul4.i.i.i.i78, i64 0
  %71 = shufflevector <2 x float> %70, <2 x float> poison, <2 x i32> zeroinitializer
  %72 = fmul <2 x float> %69, %71
  %73 = insertelement <2 x float> poison, float %5, i64 0
  %74 = insertelement <2 x float> %73, float %39, i64 1
  ...
  %78 = insertelement <2 x float> poison, float %7, i64 0
  %79 = insertelement <2 x float> %78, float %41, i64 1
  ...
  %85 = insertelement <2 x float> %84, float %3, i64 1
  %86 = fmul <2 x float> %85, %71
  %87 = insertelement <2 x float> poison, float %8, i64 0
  ...
  %90 = insertelement <2 x float> poison, float %10, i64 0
  %91 = insertelement <2 x float> %90, float %4, i64 1
