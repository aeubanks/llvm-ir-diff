...
entry:
  ...
  %cmp217.not = icmp ne i16 %bf.clear, 0
  %osucc239 = getelementptr inbounds %struct.LIST, ptr %hd, i64 0, i32 1
  %cmp265 = icmp eq i16 %bf.clear, 0
  ...
  %. = select i1 %cmp217.not, i16 16, i16 8
  br label %RESUME
...
sw.bb49:                                          ; preds = %for.end42
  %tobool.i.not = icmp eq i32 %prnt_flush.0, 0
  br i1 %tobool.i.not, label %ParentFlush.exit, label %if.then.i
...
for.cond.i:                                       ; preds = %for.cond.i, %if.then.i
  %prnt.0.i.in = phi ptr [ %9, %if.then.i ], [ %prnt.0.i, %for.cond.i ]
  %prnt.0.i = load ptr, ptr %prnt.0.i.in, align 8, !tbaa !5
...
sw.bb55:                                          ; preds = %for.end42
  %tobool.i5687.not = icmp eq i32 %prnt_flush.0, 0
  br i1 %tobool.i5687.not, label %ParentFlush.exit5699, label %if.then.i5690

if.then.i5690:                                    ; preds = %sw.bb55
  %osucc.i5689 = getelementptr inbounds [2 x %struct.LIST], ptr %dest_index.1, i64 0, i64 1, i32 1
  %13 = load ptr, ptr %osucc.i5689, align 8, !tbaa !5
  br label %for.cond.i5695

for.cond.i5695:                                   ; preds = %for.cond.i5695, %if.then.i5690
  %prnt.0.i5691.in = phi ptr [ %13, %if.then.i5690 ], [ %prnt.0.i5691, %for.cond.i5695 ]
  %prnt.0.i5691 = load ptr, ptr %prnt.0.i5691.in, align 8, !tbaa !5
  %ou1.i5692 = getelementptr inbounds %struct.word_type, ptr %prnt.0.i5691, i64 0, i32 1
  %14 = load i8, ptr %ou1.i5692, align 8, !tbaa !5
  %cmp.i5694 = icmp eq i8 %14, 0
  br i1 %cmp.i5694, label %for.cond.i5695, label %for.end.i5697, !llvm.loop !12

for.end.i5697:                                    ; preds = %for.cond.i5695
  call void @FlushGalley(ptr noundef nonnull %prnt.0.i5691)
  br label %ParentFlush.exit5699

ParentFlush.exit5699:                             ; preds = %sw.bb55, %for.end.i5697
  %15 = load ptr, ptr %inners, align 8, !tbaa !8
  %cmp56 = icmp eq ptr %15, null
  br i1 %cmp56, label %cleanup5156, label %if.then58

if.then58:                                        ; preds = %ParentFlush.exit5699
...
if.then100:                                       ; preds = %for.end93
  ...
  %.pre6232 = load ptr, ptr %oux174, align 8, !tbaa !5
  br label %if.end105

if.end105:                                        ; preds = %if.then100, %for.end93
  %24 = phi ptr [ %.pre6232, %if.then100 ], [ %20, %for.end93 ]
...
for.end159:                                       ; preds = %for.cond148
  ...
  %spec.select5738 = select i1 %tobool165.not, i32 1, i32 %prnt_flush.0
...
if.end184:                                        ; preds = %lor.end, %for.end159
  %prnt_flush.4 = phi i32 [ %spec.select5738, %for.end159 ], [ %lor.ext, %lor.end ]
...
if.then195:                                       ; preds = %sw.bb190
  %tobool.i5700.not = icmp eq i32 %prnt_flush.0, 0
  br i1 %tobool.i5700.not, label %cleanup5156, label %if.then.i5703

if.then.i5703:                                    ; preds = %if.then195
  %osucc.i5702 = getelementptr inbounds [2 x %struct.LIST], ptr %dest_index.0, i64 0, i64 1, i32 1
  %41 = load ptr, ptr %osucc.i5702, align 8, !tbaa !5
  br label %for.cond.i5708

for.cond.i5708:                                   ; preds = %for.cond.i5708, %if.then.i5703
  %prnt.0.i5704.in = phi ptr [ %41, %if.then.i5703 ], [ %prnt.0.i5704, %for.cond.i5708 ]
  %prnt.0.i5704 = load ptr, ptr %prnt.0.i5704.in, align 8, !tbaa !5
  %ou1.i5705 = getelementptr inbounds %struct.word_type, ptr %prnt.0.i5704, i64 0, i32 1
  %42 = load i8, ptr %ou1.i5705, align 8, !tbaa !5
  %cmp.i5707 = icmp eq i8 %42, 0
  br i1 %cmp.i5707, label %for.cond.i5708, label %for.end.i5710, !llvm.loop !12

for.end.i5710:                                    ; preds = %for.cond.i5708
  call void @FlushGalley(ptr noundef nonnull %prnt.0.i5704)
  br label %cleanup5156

sw.default197:                                    ; preds = %for.cond
  %conv14.le = zext i8 %4 to i32
  %43 = load ptr, ptr @no_fpos, align 8, !tbaa !8
  %call201 = call ptr @Image(i32 noundef %conv14.le) #6
...
if.end216:                                        ; preds = %if.then211, %sw.epilog203
  %bf.load221.in.in = phi i32 [ %bf.set215, %if.then211 ], [ %bf.load206, %sw.epilog203 ]
  %bf.load221.in = lshr i32 %bf.load221.in.in, 16
  %bf.load221 = trunc i32 %bf.load221.in to i16
  %46 = and i16 %., %bf.load221
  %47 = icmp eq i16 %46, 0
  store ptr null, ptr %inners, align 8, !tbaa !8
  %link.05983 = load ptr, ptr %osucc239, align 8, !tbaa !5
  %cmp241.not5984 = icmp eq ptr %link.05983, %hd
  br i1 %cmp241.not5984, label %if.end1762, label %for.cond247.preheader.lr.ph
...
for.cond247.preheader.lr.ph:                      ; preds = %if.end216
  ...
  %cond1084.in = select i1 %cmp265, ptr %osucc1066, ptr %arrayidx1069
...
for.cond247.preheader:                            ; preds = %for.cond247.preheader.lr.ph, %for.inc1753
  %link.06005 = phi ptr [ %link.05983, %for.cond247.preheader.lr.ph ], [ %link.0, %for.inc1753 ]
  %dest_encl.16003 = phi ptr [ null, %for.cond247.preheader.lr.ph ], [ %dest_encl.5, %for.inc1753 ]
  %need_adjust.16002 = phi i32 [ 0, %for.cond247.preheader.lr.ph ], [ %need_adjust.3, %for.inc1753 ]
  %dest_back.16000 = phi i32 [ %dest_back.0, %for.cond247.preheader.lr.ph ], [ %dest_back.4, %for.inc1753 ]
  %dest_fwd.15998 = phi i32 [ %dest_fwd.0, %for.cond247.preheader.lr.ph ], [ %dest_fwd.4, %for.inc1753 ]
  %frame_size.15996 = phi i32 [ %frame_size.0, %for.cond247.preheader.lr.ph ], [ %frame_size.4, %for.inc1753 ]
  %perp_fwd.15994 = phi i32 [ %perp_fwd.0, %for.cond247.preheader.lr.ph ], [ %perp_fwd.4, %for.inc1753 ]
  %perp_back.15992 = phi i32 [ %perp_back.0, %for.cond247.preheader.lr.ph ], [ %perp_back.4, %for.inc1753 ]
  %stop_link.05991 = phi ptr [ null, %for.cond247.preheader.lr.ph ], [ %stop_link.2, %for.inc1753 ]
  %stop_back.15990 = phi i32 [ %stop_back.0, %for.cond247.preheader.lr.ph ], [ %stop_back.3, %for.inc1753 ]
  %headers_seen.05989 = phi i32 [ 0, %for.cond247.preheader.lr.ph ], [ %headers_seen.1, %for.inc1753 ]
  %stop_fwd.15988 = phi i32 [ %stop_fwd.0, %for.cond247.preheader.lr.ph ], [ %stop_fwd.3, %for.inc1753 ]
  %prnt_flush.55987 = phi i32 [ %prnt_flush.0, %for.cond247.preheader.lr.ph ], [ %prnt_flush.6, %for.inc1753 ]
  %stop_perp_fwd.15986 = phi i32 [ %stop_perp_fwd.0, %for.cond247.preheader.lr.ph ], [ %stop_perp_fwd.3, %for.inc1753 ]
  %stop_perp_back.15985 = phi i32 [ %stop_perp_back.0, %for.cond247.preheader.lr.ph ], [ %stop_perp_back.3, %for.inc1753 ]
  br label %for.cond247

for.cond247:                                      ; preds = %for.cond247.preheader, %for.cond247
  %link.0.pn = phi ptr [ %storemerge, %for.cond247 ], [ %link.06005, %for.cond247.preheader ]
...
if.then264:                                       ; preds = %for.cond247
  ...
  %cond.in = select i1 %cmp265, ptr %osucc269, ptr %storemerge
  %cond = load ptr, ptr %cond.in, align 8, !tbaa !5
  br label %for.cond276

for.cond276:                                      ; preds = %for.cond276, %if.then264
  %cond.pn = phi ptr [ %cond, %if.then264 ], [ %storemerge5737, %for.cond276 ]
  %storemerge5737.in = getelementptr inbounds [2 x %struct.LIST], ptr %cond.pn, i64 0, i64 1
  %storemerge5737 = load ptr, ptr %storemerge5737.in, align 8, !tbaa !5
  %ou1277 = getelementptr inbounds %struct.word_type, ptr %storemerge5737, i64 0, i32 1
...
if.end288:                                        ; preds = %for.cond247, %for.cond276
  ...
  %storemerge6051 = phi ptr [ %storemerge5737, %for.cond276 ], [ %storemerge, %for.cond247 ]
  store ptr %storemerge6051, ptr %y, align 8, !tbaa !8
...
sw.bb292:                                         ; preds = %if.end288
  ...
  %ou2297 = getelementptr inbounds %struct.word_type, ptr %storemerge6051, i64 0, i32 2
  ...
  store ptr %storemerge6051, ptr %prec_gap, align 8, !tbaa !8
  br i1 %47, label %if.then302, label %if.end314

if.then302:                                       ; preds = %sw.bb292
  %cmp303.not = icmp eq ptr %dest_encl.16003, null
  br i1 %cmp303.not, label %if.end314, label %land.lhs.true305

land.lhs.true305:                                 ; preds = %if.then302
  %ogap = getelementptr inbounds %struct.gapobj_type, ptr %storemerge6051, i64 0, i32 3
...
if.end314:                                        ; preds = %sw.bb292, %if.then302, %land.lhs.true305, %if.then311
  %stop_perp_back.2 = phi i32 [ %stop_perp_back.15985, %land.lhs.true305 ], [ %perp_back.15992, %if.then311 ], [ %stop_perp_back.15985, %if.then302 ], [ %stop_perp_back.15985, %sw.bb292 ]
  %stop_perp_fwd.2 = phi i32 [ %stop_perp_fwd.15986, %land.lhs.true305 ], [ %perp_fwd.15994, %if.then311 ], [ %stop_perp_fwd.15986, %if.then302 ], [ %stop_perp_fwd.15986, %sw.bb292 ]
  %stop_fwd.2 = phi i32 [ %stop_fwd.15988, %land.lhs.true305 ], [ %dest_fwd.15998, %if.then311 ], [ %stop_fwd.15988, %if.then302 ], [ %stop_fwd.15988, %sw.bb292 ]
  %stop_back.2 = phi i32 [ %stop_back.15990, %land.lhs.true305 ], [ %dest_back.16000, %if.then311 ], [ %stop_back.15990, %if.then302 ], [ %stop_back.15990, %sw.bb292 ]
  %stop_link.1 = phi ptr [ %stop_link.05991, %land.lhs.true305 ], [ %link.06005, %if.then311 ], [ %stop_link.05991, %if.then302 ], [ %link.06005, %sw.bb292 ]
  %ogap315 = getelementptr inbounds %struct.gapobj_type, ptr %storemerge6051, i64 0, i32 3
...
sw.bb328:                                         ; preds = %if.end288, %if.end288, %if.end288, %if.end288, %if.end288, %if.end288, %if.end288, %if.end288, %if.end288, %if.end288, %if.end288, %if.end288
  ...
  %ou2333 = getelementptr inbounds %struct.word_type, ptr %storemerge6051, i64 0, i32 2
...
if.end364:                                        ; preds = %if.then353, %if.else355
  ...
  %arrayidx368 = getelementptr inbounds [2 x %struct.LIST], ptr %58, i64 0, i64 1
  %osucc369 = getelementptr inbounds [2 x %struct.LIST], ptr %58, i64 0, i64 1, i32 1
  store ptr %58, ptr %osucc369, align 8, !tbaa !5
  store ptr %58, ptr %arrayidx368, align 8, !tbaa !5
...
if.end402:                                        ; preds = %if.then391, %if.else393
  ...
  %arrayidx406 = getelementptr inbounds [2 x %struct.LIST], ptr %63, i64 0, i64 1
  %osucc407 = getelementptr inbounds [2 x %struct.LIST], ptr %63, i64 0, i64 1, i32 1
  store ptr %63, ptr %osucc407, align 8, !tbaa !5
  store ptr %63, ptr %arrayidx406, align 8, !tbaa !5
...
cond.end448:                                      ; preds = %if.end402, %cond.false424
  %73 = phi ptr [ %63, %if.end402 ], [ %.pre6264, %cond.false424 ]
  ...
  %or.cond5750 = select i1 %cmp450, i1 true, i1 %cmp454
  br i1 %or.cond5750, label %for.inc1753, label %cond.false457
...
sw.bb484:                                         ; preds = %if.end288
  %osucc487 = getelementptr inbounds %struct.LIST, ptr %storemerge6051, i64 0, i32 1
  %78 = load ptr, ptr %osucc487, align 8, !tbaa !5
  br label %for.cond491

for.cond491:                                      ; preds = %for.cond491, %sw.bb484
  %.pn5736 = phi ptr [ %78, %sw.bb484 ], [ %tmp.0, %for.cond491 ]
  %tmp.0.in = getelementptr inbounds [2 x %struct.LIST], ptr %.pn5736, i64 0, i64 1
...
if.then511:                                       ; preds = %for.end502
  %82 = load ptr, ptr %link.06005, align 8, !tbaa !5
...
cond.false524:                                    ; preds = %if.then511
  %arrayidx519 = getelementptr inbounds [2 x %struct.LIST], ptr %83, i64 0, i64 1
  store ptr %84, ptr @zz_res, align 8, !tbaa !8
  %85 = load ptr, ptr %arrayidx519, align 8, !tbaa !5
  %arrayidx532 = getelementptr inbounds [2 x %struct.LIST], ptr %84, i64 0, i64 1
  store ptr %85, ptr %arrayidx532, align 8, !tbaa !5
  %86 = load ptr, ptr %arrayidx519, align 8, !tbaa !5
  ...
  store ptr %83, ptr %arrayidx519, align 8, !tbaa !5
...
cond.false554:                                    ; preds = %cond.end546
  ...
  %.pre6245 = load ptr, ptr @xx_link, align 8, !tbaa !8
  br label %cond.end576

cond.end576:                                      ; preds = %cond.end546, %cond.false554
  %92 = phi ptr [ %83, %cond.end546 ], [ %.pre6245, %cond.false554 ]
  ...
  %cond599.in.in = select i1 %switch5751, ptr %orec_size, ptr %arrayidx596
...
sw.bb643:                                         ; preds = %if.end641
  ...
  %osucc6465979 = getelementptr inbounds [2 x %struct.LIST], ptr %tmp.1, i64 0, i64 1, i32 1
  %101 = load ptr, ptr %osucc6465979, align 8, !tbaa !5
  %cmp647.not5980 = icmp eq ptr %101, %tmp.1
  br i1 %cmp647.not5980, label %while.cond742.preheader, label %while.body

while.cond742.preheader:                          ; preds = %cond.end710, %sw.bb643
  %102 = phi ptr [ %tmp.1, %sw.bb643 ], [ %118, %cond.end710 ]
  %osucc7455981 = getelementptr inbounds %struct.LIST, ptr %102, i64 0, i32 1
  %103 = load ptr, ptr %osucc7455981, align 8, !tbaa !5
  %cmp746.not5982 = icmp eq ptr %103, %102
  br i1 %cmp746.not5982, label %while.end842, label %while.body748
...
cond.false658:                                    ; preds = %while.body
  %arrayidx653 = getelementptr inbounds [2 x %struct.LIST], ptr %104, i64 0, i64 1
  store ptr %105, ptr @zz_res, align 8, !tbaa !8
  %106 = load ptr, ptr %arrayidx653, align 8, !tbaa !5
  %arrayidx666 = getelementptr inbounds [2 x %struct.LIST], ptr %105, i64 0, i64 1
  store ptr %106, ptr %arrayidx666, align 8, !tbaa !5
  %107 = load ptr, ptr %arrayidx653, align 8, !tbaa !5
  ...
  store ptr %104, ptr %arrayidx653, align 8, !tbaa !5
...
cond.false688:                                    ; preds = %cond.end680
  ...
  %.pre6242 = load ptr, ptr @xx_link, align 8, !tbaa !8
  br label %cond.end710

cond.end710:                                      ; preds = %cond.end680, %cond.false688
  %113 = phi ptr [ %104, %cond.end680 ], [ %.pre6242, %cond.false688 ]
  ...
  %.off5752 = add i8 %114, -11
  %switch5753 = icmp ult i8 %.off5752, 2
  ...
  %cond734.in.in = select i1 %switch5753, ptr %orec_size725, ptr %arrayidx731
...
cond.false758:                                    ; preds = %while.body748
  %arrayidx753 = getelementptr inbounds [2 x %struct.LIST], ptr %120, i64 0, i64 1
  ...
  %123 = load ptr, ptr %arrayidx753, align 8, !tbaa !5
  ...
  store ptr %120, ptr %arrayidx753, align 8, !tbaa !5
...
cond.false788:                                    ; preds = %cond.end780
  ...
  %.pre6243 = load ptr, ptr @xx_link, align 8, !tbaa !8
  br label %cond.end810

cond.end810:                                      ; preds = %cond.end780, %cond.false788
  %129 = phi ptr [ %120, %cond.end780 ], [ %.pre6243, %cond.false788 ]
  ...
  %.off5754 = add i8 %130, -11
  %switch5755 = icmp ult i8 %.off5754, 2
  ...
  %cond834.in.in = select i1 %switch5755, ptr %orec_size825, ptr %arrayidx831
...
while.end842:                                     ; preds = %cond.end810, %while.cond742.preheader
  %.lcssa5850 = phi ptr [ %102, %while.cond742.preheader ], [ %134, %cond.end810 ]
  store ptr %.lcssa5850, ptr @zz_hold, align 8, !tbaa !8
  %ou1843 = getelementptr inbounds %struct.word_type, ptr %.lcssa5850, i64 0, i32 1
  %136 = load i8, ptr %ou1843, align 8, !tbaa !5
  %.off5756 = add i8 %136, -11
  %switch5757 = icmp ult i8 %.off5756, 2
  %orec_size856 = getelementptr inbounds %struct.word_type, ptr %.lcssa5850, i64 0, i32 1, i32 0, i32 1
  %idxprom861 = zext i8 %136 to i64
  %arrayidx862 = getelementptr inbounds [0 x i8], ptr @zz_lengths, i64 0, i64 %idxprom861
  %cond865.in.in = select i1 %switch5757, ptr %orec_size856, ptr %arrayidx862
  ...
  store ptr %137, ptr %.lcssa5850, align 8, !tbaa !5
  ...
  %140 = load ptr, ptr %link.06005, align 8, !tbaa !5
...
cond.false885:                                    ; preds = %while.end842
  %arrayidx880 = getelementptr inbounds [2 x %struct.LIST], ptr %141, i64 0, i64 1
  store ptr %142, ptr @zz_res, align 8, !tbaa !8
  %143 = load ptr, ptr %arrayidx880, align 8, !tbaa !5
  %arrayidx893 = getelementptr inbounds [2 x %struct.LIST], ptr %142, i64 0, i64 1
  store ptr %143, ptr %arrayidx893, align 8, !tbaa !5
  %144 = load ptr, ptr %arrayidx880, align 8, !tbaa !5
  ...
  store ptr %141, ptr %arrayidx880, align 8, !tbaa !5
...
cond.false915:                                    ; preds = %cond.end907
  ...
  %.pre6244 = load ptr, ptr @xx_link, align 8, !tbaa !8
  br label %cond.end937

cond.end937:                                      ; preds = %cond.end907, %cond.false915
  %150 = phi ptr [ %141, %cond.end907 ], [ %.pre6244, %cond.false915 ]
  ...
  %.off5758 = add i8 %151, -11
  %switch5759 = icmp ult i8 %.off5758, 2
  ...
  %cond961.in.in = select i1 %switch5759, ptr %orec_size952, ptr %arrayidx958
...
sw.bb988:                                         ; preds = %if.end288, %if.end288, %if.end288, %if.end288, %if.end288, %if.end288, %if.end288, %if.end288, %if.end288, %if.end288, %if.end288, %if.end288, %if.end288, %if.end288, %if.end288, %if.end288, %if.end288, %if.end288, %if.end288, %if.end288, %if.end288, %if.end288, %if.end288, %if.end288, %if.end288, %if.end288, %if.end288, %if.end288, %if.end288, %if.end288, %if.end288, %if.end288, %if.end288, %if.end288, %if.end288, %if.end288, %if.end288, %if.end288, %if.end288, %if.end288, %if.end288, %if.end288
  ...
  %ou2993 = getelementptr inbounds %struct.word_type, ptr %storemerge6051, i64 0, i32 2
  ...
  br i1 %cmp217.not, label %for.cond1005.preheader, label %if.end1055

for.cond1005.preheader:                           ; preds = %sw.bb988
  %zlink.0.in5975 = getelementptr inbounds %struct.LIST, ptr %link.06005, i64 0, i32 1
  %zlink.05976 = load ptr, ptr %zlink.0.in5975, align 8, !tbaa !5
  %cmp1006.not5977 = icmp eq ptr %zlink.05976, %hd
  br i1 %cmp1006.not5977, label %for.end1046, label %for.cond1012.preheader

for.cond1012.preheader:                           ; preds = %for.cond1005.preheader, %for.inc1042
  %zlink.05978 = phi ptr [ %zlink.0, %for.inc1042 ], [ %zlink.05976, %for.cond1005.preheader ]
  br label %for.cond1012

for.cond1012:                                     ; preds = %for.cond1012.preheader, %for.cond1012
  %zlink.0.pn = phi ptr [ %z.0, %for.cond1012 ], [ %zlink.05978, %for.cond1012.preheader ]
...
for.inc1042:                                      ; preds = %for.cond1012, %if.then1035, %sw.bb1028
  %zlink.1 = phi ptr [ %zlink.05978, %sw.bb1028 ], [ %160, %if.then1035 ], [ %zlink.05978, %for.cond1012 ]
...
if.then1052:                                      ; preds = %for.end1046
  %call1053 = call i32 @VerticalHyphenate(ptr noundef %storemerge6051) #6
  br label %if.end1055
...
if.then1057:                                      ; preds = %if.end1055
  %cmp1058 = icmp eq ptr %dest_encl.16003, null
...
for.end1107:                                      ; preds = %for.cond1096
  %cmp1114 = icmp eq i8 %163, 19
  %or.cond5739 = and i1 %cmp217.not, %cmp1114
  %cmp1123 = icmp eq i8 %163, 17
  %or.cond5740 = and i1 %cmp265, %cmp1123
  %or.cond5760 = or i1 %or.cond5739, %or.cond5740
  br i1 %or.cond5760, label %if.end1127, label %if.then1125
...
if.then1125:                                      ; preds = %for.end1107
  ...
  %.pre6235 = load ptr, ptr %osucc1066, align 8, !tbaa !5
  br label %if.end1127

if.end1127:                                       ; preds = %for.end1107, %if.then1125
  %165 = phi ptr [ %162, %for.end1107 ], [ %.pre6235, %if.then1125 ]
...
lor.lhs.false1133:                                ; preds = %if.end1127
  ...
  %169 = add i8 %168, -2
  %or.cond5741 = icmp ult i8 %169, 7
  br i1 %or.cond5741, label %if.end1147, label %if.then1145
...
lor.lhs.false1155:                                ; preds = %if.end1152
  ...
  %176 = add i8 %175, -2
  %or.cond5742 = icmp ult i8 %176, 7
  br i1 %or.cond5742, label %if.end1169, label %if.then1167
...
if.end1199:                                       ; preds = %if.end1169, %if.then1057
  %perp_back.2 = phi i32 [ %180, %if.end1169 ], [ %perp_back.15992, %if.then1057 ]
  %perp_fwd.2 = phi i32 [ %181, %if.end1169 ], [ %perp_fwd.15994, %if.then1057 ]
  %frame_size.2 = phi i32 [ %cond1198, %if.end1169 ], [ %frame_size.15996, %if.then1057 ]
  %dest_fwd.2 = phi i32 [ %179, %if.end1169 ], [ %dest_fwd.15998, %if.then1057 ]
  %dest_back.2 = phi i32 [ %178, %if.end1169 ], [ %dest_back.16000, %if.then1057 ]
  %dest_encl.3 = phi ptr [ %dest_encl.2, %if.end1169 ], [ %dest_encl.16003, %if.then1057 ]
  ...
  %187 = add i8 %186, -2
  %or.cond5743 = icmp ult i8 %187, 7
  br i1 %or.cond5743, label %if.end1675, label %if.then1211
...
land.lhs.true1249:                                ; preds = %if.then1211
  ...
  %or.cond5744 = select i1 %cmp1252, i1 true, i1 %cmp1256.not
  br i1 %or.cond5744, label %if.then1274, label %land.lhs.true1258
...
land.lhs.true1258:                                ; preds = %land.lhs.true1249, %lor.lhs.false1254
  ...
  %or.cond5746 = select i1 %cmp1261.not, i1 true, i1 %cmp1265.not
  br i1 %or.cond5746, label %if.then1274, label %lor.lhs.false1267
...
if.then1274:                                      ; preds = %land.lhs.true1258, %lor.lhs.false1254, %land.lhs.true1249
  %.pr = load ptr, ptr %oopt_components1268, align 8, !tbaa !5
  %cmp1276.not = icmp eq ptr %.pr, null
...
if.end1347:                                       ; preds = %if.then1336, %if.else1338
  ...
  %arrayidx1351 = getelementptr inbounds [2 x %struct.LIST], ptr %212, i64 0, i64 1
  %osucc1352 = getelementptr inbounds [2 x %struct.LIST], ptr %212, i64 0, i64 1, i32 1
  store ptr %212, ptr %osucc1352, align 8, !tbaa !5
  store ptr %212, ptr %arrayidx1351, align 8, !tbaa !5
...
cond.end1393:                                     ; preds = %if.end1347
  ...
  %.pre6236 = load ptr, ptr @xx_link, align 8, !tbaa !8
  store ptr %.pre6236, ptr @zz_res, align 8, !tbaa !8
  store ptr %205, ptr @zz_hold, align 8, !tbaa !8
  %cmp1399 = icmp eq ptr %.pre6236, null
  br i1 %cmp1399, label %cond.end1426, label %cond.false1402

cond.false1402:                                   ; preds = %cond.end1393.thread, %cond.end1393
  %222 = phi ptr [ %212, %cond.end1393.thread ], [ %.pre6236, %cond.end1393 ]
...
for.cond1446:                                     ; preds = %land.lhs.true1430, %for.cond1446
  %.pn5729 = phi ptr [ %z1279.0, %for.cond1446 ], [ %227, %land.lhs.true1430 ]
  %z1279.0.in = getelementptr inbounds [2 x %struct.LIST], ptr %.pn5729, i64 0, i64 1
...
cond.false1473:                                   ; preds = %for.end1457
  %arrayidx1468 = getelementptr inbounds [2 x %struct.LIST], ptr %231, i64 0, i64 1
  store ptr %232, ptr @zz_res, align 8, !tbaa !8
  %233 = load ptr, ptr %arrayidx1468, align 8, !tbaa !5
  %arrayidx1481 = getelementptr inbounds [2 x %struct.LIST], ptr %232, i64 0, i64 1
  store ptr %233, ptr %arrayidx1481, align 8, !tbaa !5
  %234 = load ptr, ptr %arrayidx1468, align 8, !tbaa !5
  ...
  store ptr %231, ptr %arrayidx1468, align 8, !tbaa !5
...
cond.false1503:                                   ; preds = %cond.end1495
  ...
  %.pre6237 = load ptr, ptr @xx_link, align 8, !tbaa !8
  br label %cond.end1525

cond.end1525:                                     ; preds = %cond.end1495, %cond.false1503
  %240 = phi ptr [ %231, %cond.end1495 ], [ %.pre6237, %cond.false1503 ]
  ...
  %.off5761 = add i8 %241, -11
  %switch5762 = icmp ult i8 %.off5761, 2
  ...
  %cond1549.in.in = select i1 %switch5762, ptr %orec_size1540, ptr %arrayidx1546
...
if.end1639:                                       ; preds = %if.else1606, %if.then1577
  %.sink6566 = phi i32 [ %251, %if.else1606 ], [ %add1588, %if.then1577 ]
  %pb.0 = phi i32 [ %.perp_back.2, %if.else1606 ], [ 0, %if.then1577 ]
  %cond1638 = call i32 @llvm.smax.i32(i32 %perp_fwd.2, i32 %.sink6566)
...
land.lhs.true1643:                                ; preds = %if.end1639
  ...
  %or.cond5748 = select i1 %cmp1646.not, i1 true, i1 %cmp1650.not
  br i1 %or.cond5748, label %if.then1652, label %if.end1667
...
if.end1660:                                       ; preds = %if.then1656, %if.then1652
  br i1 %cmp217.not, label %if.then1663, label %REJECT
...
if.end1675:                                       ; preds = %if.end1199, %if.then1671, %if.end1667, %if.end1055
  %perp_back.3 = phi i32 [ %pb.0, %if.then1671 ], [ %pb.0, %if.end1667 ], [ %perp_back.15992, %if.end1055 ], [ %perp_back.2, %if.end1199 ]
  %perp_fwd.3 = phi i32 [ %cond1638, %if.then1671 ], [ %cond1638, %if.end1667 ], [ %perp_fwd.15994, %if.end1055 ], [ %perp_fwd.2, %if.end1199 ]
  %frame_size.3 = phi i32 [ %frame_size.2, %if.then1671 ], [ %frame_size.2, %if.end1667 ], [ %frame_size.15996, %if.end1055 ], [ %frame_size.2, %if.end1199 ]
  %dest_fwd.3 = phi i32 [ %add1241, %if.then1671 ], [ %add1241, %if.end1667 ], [ %dest_fwd.15998, %if.end1055 ], [ %dest_fwd.2, %if.end1199 ]
  %dest_back.3 = phi i32 [ %dest_back.2, %if.then1671 ], [ %dest_back.2, %if.end1667 ], [ %dest_back.16000, %if.end1055 ], [ %dest_back.2, %if.end1199 ]
  %need_adjust.2 = phi i32 [ 1, %if.then1671 ], [ 1, %if.end1667 ], [ %need_adjust.16002, %if.end1055 ], [ %need_adjust.16002, %if.end1199 ]
  %dest_encl.4 = phi ptr [ %dest_encl.3, %if.then1671 ], [ %dest_encl.3, %if.end1667 ], [ %dest_encl.16003, %if.end1055 ], [ %dest_encl.3, %if.end1199 ]
  %tobool1676.not = icmp eq i32 %prnt_flush.55987, 0
...
if.then1689:                                      ; preds = %lor.end1685
  %osucc1692 = getelementptr inbounds %struct.LIST, ptr %link.06005, i64 0, i32 1
...
if.end1724.if.then1735_crit_edge:                 ; preds = %if.end1724
  %osucc1692.le = getelementptr inbounds %struct.LIST, ptr %link.06005, i64 0, i32 1
  %.pre6238 = load ptr, ptr %osucc1692.le, align 8, !tbaa !5
  br label %if.then1735

if.then1735:                                      ; preds = %if.then1689, %if.end1724.if.then1735_crit_edge
  %265 = phi ptr [ %.pre6238, %if.end1724.if.then1735_crit_edge ], [ %260, %if.then1689 ]
...
for.inc1753:                                      ; preds = %if.end1724, %if.end288, %if.end288, %if.end288, %if.end288, %cond.end448, %sw.bb328, %sw.default1746, %if.then321, %if.end314, %cond.false457, %if.then612, %cond.end576, %cond.end937, %if.then974, %if.end641, %lor.end1685
  %stop_perp_back.3 = phi i32 [ %stop_perp_back.15985, %sw.default1746 ], [ %stop_perp_back.15985, %lor.end1685 ], [ %stop_perp_back.15985, %if.then612 ], [ %stop_perp_back.15985, %cond.end576 ], [ %stop_perp_back.15985, %if.end641 ], [ %stop_perp_back.15985, %if.then974 ], [ %stop_perp_back.15985, %cond.end937 ], [ %stop_perp_back.15985, %cond.false457 ], [ %stop_perp_back.15985, %sw.bb328 ], [ %stop_perp_back.2, %if.end314 ], [ %stop_perp_back.2, %if.then321 ], [ %stop_perp_back.15985, %cond.end448 ], [ %stop_perp_back.15985, %if.end288 ], [ %stop_perp_back.15985, %if.end288 ], [ %stop_perp_back.15985, %if.end288 ], [ %stop_perp_back.15985, %if.end288 ], [ %stop_perp_back.15985, %if.end1724 ]
  %stop_perp_fwd.3 = phi i32 [ %stop_perp_fwd.15986, %sw.default1746 ], [ %stop_perp_fwd.15986, %lor.end1685 ], [ %stop_perp_fwd.15986, %if.then612 ], [ %stop_perp_fwd.15986, %cond.end576 ], [ %stop_perp_fwd.15986, %if.end641 ], [ %stop_perp_fwd.15986, %if.then974 ], [ %stop_perp_fwd.15986, %cond.end937 ], [ %stop_perp_fwd.15986, %cond.false457 ], [ %stop_perp_fwd.15986, %sw.bb328 ], [ %stop_perp_fwd.2, %if.end314 ], [ %stop_perp_fwd.2, %if.then321 ], [ %stop_perp_fwd.15986, %cond.end448 ], [ %stop_perp_fwd.15986, %if.end288 ], [ %stop_perp_fwd.15986, %if.end288 ], [ %stop_perp_fwd.15986, %if.end288 ], [ %stop_perp_fwd.15986, %if.end288 ], [ %stop_perp_fwd.15986, %if.end1724 ]
  %prnt_flush.6 = phi i32 [ %prnt_flush.55987, %sw.default1746 ], [ %lor.ext1686, %lor.end1685 ], [ %prnt_flush.55987, %if.then612 ], [ %prnt_flush.55987, %cond.end576 ], [ %prnt_flush.55987, %if.end641 ], [ %prnt_flush.55987, %if.then974 ], [ %prnt_flush.55987, %cond.end937 ], [ %prnt_flush.55987, %cond.false457 ], [ %prnt_flush.55987, %sw.bb328 ], [ %prnt_flush.55987, %if.end314 ], [ %prnt_flush.55987, %if.then321 ], [ %prnt_flush.55987, %cond.end448 ], [ %prnt_flush.55987, %if.end288 ], [ %prnt_flush.55987, %if.end288 ], [ %prnt_flush.55987, %if.end288 ], [ %prnt_flush.55987, %if.end288 ], [ %lor.ext1686, %if.end1724 ]
  %stop_fwd.3 = phi i32 [ %stop_fwd.15988, %sw.default1746 ], [ %stop_fwd.15988, %lor.end1685 ], [ %stop_fwd.15988, %if.then612 ], [ %stop_fwd.15988, %cond.end576 ], [ %stop_fwd.15988, %if.end641 ], [ %stop_fwd.15988, %if.then974 ], [ %stop_fwd.15988, %cond.end937 ], [ %stop_fwd.15988, %cond.false457 ], [ %stop_fwd.15988, %sw.bb328 ], [ %stop_fwd.2, %if.end314 ], [ %stop_fwd.2, %if.then321 ], [ %stop_fwd.15988, %cond.end448 ], [ %stop_fwd.15988, %if.end288 ], [ %stop_fwd.15988, %if.end288 ], [ %stop_fwd.15988, %if.end288 ], [ %stop_fwd.15988, %if.end288 ], [ %stop_fwd.15988, %if.end1724 ]
  %headers_seen.1 = phi i32 [ %headers_seen.05989, %sw.default1746 ], [ %headers_seen.05989, %lor.end1685 ], [ %headers_seen.05989, %if.then612 ], [ %headers_seen.05989, %cond.end576 ], [ %headers_seen.05989, %if.end641 ], [ %headers_seen.05989, %if.then974 ], [ %headers_seen.05989, %cond.end937 ], [ %headers_seen.05989, %cond.false457 ], [ %headers_seen.05989, %sw.bb328 ], [ %headers_seen.05989, %if.end314 ], [ %headers_seen.05989, %if.then321 ], [ %headers_seen.05989, %cond.end448 ], [ 1, %if.end288 ], [ 1, %if.end288 ], [ 1, %if.end288 ], [ 1, %if.end288 ], [ %headers_seen.05989, %if.end1724 ]
  %stop_back.3 = phi i32 [ %stop_back.15990, %sw.default1746 ], [ %stop_back.15990, %lor.end1685 ], [ %stop_back.15990, %if.then612 ], [ %stop_back.15990, %cond.end576 ], [ %stop_back.15990, %if.end641 ], [ %stop_back.15990, %if.then974 ], [ %stop_back.15990, %cond.end937 ], [ %stop_back.15990, %cond.false457 ], [ %stop_back.15990, %sw.bb328 ], [ %stop_back.2, %if.end314 ], [ %stop_back.2, %if.then321 ], [ %stop_back.15990, %cond.end448 ], [ %stop_back.15990, %if.end288 ], [ %stop_back.15990, %if.end288 ], [ %stop_back.15990, %if.end288 ], [ %stop_back.15990, %if.end288 ], [ %stop_back.15990, %if.end1724 ]
  %stop_link.2 = phi ptr [ %stop_link.05991, %sw.default1746 ], [ %stop_link.05991, %lor.end1685 ], [ %stop_link.05991, %if.then612 ], [ %stop_link.05991, %cond.end576 ], [ %stop_link.05991, %if.end641 ], [ %stop_link.05991, %if.then974 ], [ %stop_link.05991, %cond.end937 ], [ %stop_link.05991, %cond.false457 ], [ %stop_link.05991, %sw.bb328 ], [ %stop_link.1, %if.end314 ], [ %stop_link.1, %if.then321 ], [ %stop_link.05991, %cond.end448 ], [ %stop_link.05991, %if.end288 ], [ %stop_link.05991, %if.end288 ], [ %stop_link.05991, %if.end288 ], [ %stop_link.05991, %if.end288 ], [ %stop_link.05991, %if.end1724 ]
  %perp_back.4 = phi i32 [ %perp_back.15992, %sw.default1746 ], [ %perp_back.3, %lor.end1685 ], [ %perp_back.15992, %if.then612 ], [ %perp_back.15992, %cond.end576 ], [ %perp_back.15992, %if.end641 ], [ %perp_back.15992, %if.then974 ], [ %perp_back.15992, %cond.end937 ], [ %perp_back.15992, %cond.false457 ], [ %perp_back.15992, %sw.bb328 ], [ %perp_back.15992, %if.end314 ], [ %perp_back.15992, %if.then321 ], [ %perp_back.15992, %cond.end448 ], [ %perp_back.15992, %if.end288 ], [ %perp_back.15992, %if.end288 ], [ %perp_back.15992, %if.end288 ], [ %perp_back.15992, %if.end288 ], [ %perp_back.3, %if.end1724 ]
  %perp_fwd.4 = phi i32 [ %perp_fwd.15994, %sw.default1746 ], [ %perp_fwd.3, %lor.end1685 ], [ %perp_fwd.15994, %if.then612 ], [ %perp_fwd.15994, %cond.end576 ], [ %perp_fwd.15994, %if.end641 ], [ %perp_fwd.15994, %if.then974 ], [ %perp_fwd.15994, %cond.end937 ], [ %perp_fwd.15994, %cond.false457 ], [ %perp_fwd.15994, %sw.bb328 ], [ %perp_fwd.15994, %if.end314 ], [ %perp_fwd.15994, %if.then321 ], [ %perp_fwd.15994, %cond.end448 ], [ %perp_fwd.15994, %if.end288 ], [ %perp_fwd.15994, %if.end288 ], [ %perp_fwd.15994, %if.end288 ], [ %perp_fwd.15994, %if.end288 ], [ %perp_fwd.3, %if.end1724 ]
  %frame_size.4 = phi i32 [ %frame_size.15996, %sw.default1746 ], [ %frame_size.3, %lor.end1685 ], [ %frame_size.15996, %if.then612 ], [ %frame_size.15996, %cond.end576 ], [ %frame_size.15996, %if.end641 ], [ %frame_size.15996, %if.then974 ], [ %frame_size.15996, %cond.end937 ], [ %frame_size.15996, %cond.false457 ], [ %frame_size.15996, %sw.bb328 ], [ %frame_size.15996, %if.end314 ], [ %frame_size.15996, %if.then321 ], [ %frame_size.15996, %cond.end448 ], [ %frame_size.15996, %if.end288 ], [ %frame_size.15996, %if.end288 ], [ %frame_size.15996, %if.end288 ], [ %frame_size.15996, %if.end288 ], [ %frame_size.3, %if.end1724 ]
  %dest_fwd.4 = phi i32 [ %dest_fwd.15998, %sw.default1746 ], [ %dest_fwd.3, %lor.end1685 ], [ %dest_fwd.15998, %if.then612 ], [ %dest_fwd.15998, %cond.end576 ], [ %dest_fwd.15998, %if.end641 ], [ %dest_fwd.15998, %if.then974 ], [ %dest_fwd.15998, %cond.end937 ], [ %dest_fwd.15998, %cond.false457 ], [ %dest_fwd.15998, %sw.bb328 ], [ %dest_fwd.15998, %if.end314 ], [ %dest_fwd.15998, %if.then321 ], [ %dest_fwd.15998, %cond.end448 ], [ %dest_fwd.15998, %if.end288 ], [ %dest_fwd.15998, %if.end288 ], [ %dest_fwd.15998, %if.end288 ], [ %dest_fwd.15998, %if.end288 ], [ %dest_fwd.3, %if.end1724 ]
  %dest_back.4 = phi i32 [ %dest_back.16000, %sw.default1746 ], [ %dest_back.3, %lor.end1685 ], [ %dest_back.16000, %if.then612 ], [ %dest_back.16000, %cond.end576 ], [ %dest_back.16000, %if.end641 ], [ %dest_back.16000, %if.then974 ], [ %dest_back.16000, %cond.end937 ], [ %dest_back.16000, %cond.false457 ], [ %dest_back.16000, %sw.bb328 ], [ %dest_back.16000, %if.end314 ], [ %dest_back.16000, %if.then321 ], [ %dest_back.16000, %cond.end448 ], [ %dest_back.16000, %if.end288 ], [ %dest_back.16000, %if.end288 ], [ %dest_back.16000, %if.end288 ], [ %dest_back.16000, %if.end288 ], [ %dest_back.3, %if.end1724 ]
  %need_adjust.3 = phi i32 [ %need_adjust.16002, %sw.default1746 ], [ %need_adjust.2, %lor.end1685 ], [ %need_adjust.16002, %if.then612 ], [ %need_adjust.16002, %cond.end576 ], [ %need_adjust.16002, %if.end641 ], [ %need_adjust.16002, %if.then974 ], [ %need_adjust.16002, %cond.end937 ], [ %need_adjust.16002, %cond.false457 ], [ %need_adjust.16002, %sw.bb328 ], [ %need_adjust.16002, %if.end314 ], [ %need_adjust.16002, %if.then321 ], [ %need_adjust.16002, %cond.end448 ], [ %need_adjust.16002, %if.end288 ], [ %need_adjust.16002, %if.end288 ], [ %need_adjust.16002, %if.end288 ], [ %need_adjust.16002, %if.end288 ], [ %need_adjust.2, %if.end1724 ]
  %dest_encl.5 = phi ptr [ %dest_encl.16003, %sw.default1746 ], [ %dest_encl.4, %lor.end1685 ], [ %dest_encl.16003, %if.then612 ], [ %dest_encl.16003, %cond.end576 ], [ %dest_encl.16003, %if.end641 ], [ %dest_encl.16003, %if.then974 ], [ %dest_encl.16003, %cond.end937 ], [ %dest_encl.16003, %cond.false457 ], [ %dest_encl.16003, %sw.bb328 ], [ %dest_encl.16003, %if.end314 ], [ %dest_encl.16003, %if.then321 ], [ %dest_encl.16003, %cond.end448 ], [ %dest_encl.16003, %if.end288 ], [ %dest_encl.16003, %if.end288 ], [ %dest_encl.16003, %if.end288 ], [ %dest_encl.16003, %if.end288 ], [ %dest_encl.4, %if.end1724 ]
  %link.1 = phi ptr [ %link.06005, %sw.default1746 ], [ %link.06005, %lor.end1685 ], [ %82, %if.then612 ], [ %82, %cond.end576 ], [ %link.06005, %if.end641 ], [ %140, %if.then974 ], [ %140, %cond.end937 ], [ %link.06005, %cond.false457 ], [ %link.06005, %sw.bb328 ], [ %link.06005, %if.end314 ], [ %link.06005, %if.then321 ], [ %link.06005, %cond.end448 ], [ %link.06005, %if.end288 ], [ %link.06005, %if.end288 ], [ %link.06005, %if.end288 ], [ %link.06005, %if.end288 ], [ %link.06005, %if.end1724 ]
...
for.end1757:                                      ; preds = %for.inc1753
  %.pre6265 = load ptr, ptr %inners, align 8, !tbaa !8
  %cmp1758.not = icmp eq ptr %.pre6265, null
  br i1 %cmp1758.not, label %if.end1762, label %if.then1760

if.then1760:                                      ; preds = %for.end1757
  %call1761 = call i32 @DisposeObject(ptr noundef nonnull %.pre6265) #6
  br label %if.end1762

if.end1762:                                       ; preds = %if.end216, %if.then1760, %for.end1757
  %dest_encl.1.lcssa6283 = phi ptr [ %dest_encl.5, %if.then1760 ], [ %dest_encl.5, %for.end1757 ], [ null, %if.end216 ]
  %need_adjust.1.lcssa6282 = phi i32 [ %need_adjust.3, %if.then1760 ], [ %need_adjust.3, %for.end1757 ], [ 0, %if.end216 ]
  %dest_back.1.lcssa6281 = phi i32 [ %dest_back.4, %if.then1760 ], [ %dest_back.4, %for.end1757 ], [ %dest_back.0, %if.end216 ]
  %dest_fwd.1.lcssa6280 = phi i32 [ %dest_fwd.4, %if.then1760 ], [ %dest_fwd.4, %for.end1757 ], [ %dest_fwd.0, %if.end216 ]
  %perp_fwd.1.lcssa6279 = phi i32 [ %perp_fwd.4, %if.then1760 ], [ %perp_fwd.4, %for.end1757 ], [ %perp_fwd.0, %if.end216 ]
  %perp_back.1.lcssa6278 = phi i32 [ %perp_back.4, %if.then1760 ], [ %perp_back.4, %for.end1757 ], [ %perp_back.0, %if.end216 ]
  %prnt_flush.5.lcssa6277 = phi i32 [ %prnt_flush.6, %if.then1760 ], [ %prnt_flush.6, %for.end1757 ], [ %prnt_flush.0, %if.end216 ]
...
if.then1768:                                      ; preds = %if.end1762
  ...
  %tobool1769.not = icmp eq i32 %need_adjust.1.lcssa6282, 0
  br i1 %tobool1769.not, label %if.end1773, label %if.then1770

if.then1770:                                      ; preds = %if.then1768
  call void @AdjustSize(ptr noundef %dest_encl.1.lcssa6283, i32 noundef %dest_back.1.lcssa6281, i32 noundef %dest_fwd.1.lcssa6280, i32 noundef %bf.cast) #6
  call void @AdjustSize(ptr noundef %dest_encl.1.lcssa6283, i32 noundef %perp_back.1.lcssa6278, i32 noundef %perp_fwd.1.lcssa6279, i32 noundef %sub) #6
  br label %if.end1773
...
if.end1858:                                       ; preds = %if.then1847, %if.else1849
  ...
  %arrayidx1862 = getelementptr inbounds [2 x %struct.LIST], ptr %285, i64 0, i64 1
  %osucc1863 = getelementptr inbounds [2 x %struct.LIST], ptr %285, i64 0, i64 1, i32 1
  store ptr %285, ptr %osucc1863, align 8, !tbaa !5
  store ptr %285, ptr %arrayidx1862, align 8, !tbaa !5
...
cond.end1905:                                     ; preds = %if.end1858
  ...
  store ptr %.pre6266, ptr @zz_res, align 8, !tbaa !8
  store ptr %274, ptr @zz_hold, align 8, !tbaa !8
  %cmp1911 = icmp eq ptr %.pre6266, null
  br i1 %cmp1911, label %if.end1940, label %cond.false1914

cond.false1914:                                   ; preds = %cond.end1905.thread, %cond.end1905
  %295 = phi ptr [ %285, %cond.end1905.thread ], [ %.pre6266, %cond.end1905 ]
...
if.end1940:                                       ; preds = %cond.false1914, %cond.end1905, %if.end1773
  call void @DetachGalley(ptr noundef nonnull %hd) #6
  call void @KillGalley(ptr noundef nonnull %hd, i32 noundef 1) #6
  call fastcc void @ParentFlush(i32 noundef %prnt_flush.5.lcssa6277, ptr noundef %dest_index.2, i32 noundef 1)
  br label %cleanup5156

REJECT:                                           ; preds = %if.else1565, %if.then1562, %cond.end1525, %if.end1660, %if.then1663, %if.then1274, %sw.bb978, %if.then981
  %perp_back.5 = phi i32 [ %perp_back.2, %if.then1274 ], [ %perp_back.2, %if.then1663 ], [ %perp_back.2, %if.end1660 ], [ %perp_back.15992, %if.then981 ], [ %perp_back.15992, %sw.bb978 ], [ %perp_back.2, %cond.end1525 ], [ %perp_back.2, %if.then1562 ], [ %perp_back.2, %if.else1565 ]
  %perp_fwd.5 = phi i32 [ %perp_fwd.2, %if.then1274 ], [ %perp_fwd.2, %if.then1663 ], [ %perp_fwd.2, %if.end1660 ], [ %perp_fwd.15994, %if.then981 ], [ %perp_fwd.15994, %sw.bb978 ], [ %perp_fwd.2, %cond.end1525 ], [ %perp_fwd.2, %if.then1562 ], [ %perp_fwd.2, %if.else1565 ]
  %frame_size.5 = phi i32 [ %frame_size.2, %if.then1274 ], [ %frame_size.2, %if.then1663 ], [ %frame_size.2, %if.end1660 ], [ %frame_size.15996, %if.then981 ], [ %frame_size.15996, %sw.bb978 ], [ %frame_size.2, %cond.end1525 ], [ %frame_size.2, %if.then1562 ], [ %frame_size.2, %if.else1565 ]
  %dest_fwd.5 = phi i32 [ %dest_fwd.2, %if.then1274 ], [ %dest_fwd.2, %if.then1663 ], [ %dest_fwd.2, %if.end1660 ], [ %dest_fwd.15998, %if.then981 ], [ %dest_fwd.15998, %sw.bb978 ], [ %dest_fwd.2, %cond.end1525 ], [ %dest_fwd.2, %if.then1562 ], [ %dest_fwd.2, %if.else1565 ]
  %dest_back.5 = phi i32 [ %dest_back.2, %if.then1274 ], [ %dest_back.2, %if.then1663 ], [ %dest_back.2, %if.end1660 ], [ %dest_back.16000, %if.then981 ], [ %dest_back.16000, %sw.bb978 ], [ %dest_back.2, %cond.end1525 ], [ %dest_back.2, %if.then1562 ], [ %dest_back.2, %if.else1565 ]
  %dest_encl.6 = phi ptr [ %dest_encl.3, %if.then1274 ], [ %dest_encl.3, %if.then1663 ], [ %dest_encl.3, %if.end1660 ], [ %dest_encl.16003, %if.then981 ], [ %dest_encl.16003, %sw.bb978 ], [ %dest_encl.3, %cond.end1525 ], [ %dest_encl.3, %if.then1562 ], [ %dest_encl.3, %if.else1565 ]
...
if.end1951:                                       ; preds = %if.then1949, %if.end1946
  %cmp1952.not = icmp eq ptr %stop_link.05991, null
  br i1 %cmp1952.not, label %if.end1959, label %if.then1954

if.then1954:                                      ; preds = %if.end1951
  call void @Promote(ptr noundef nonnull %hd, ptr noundef nonnull %stop_link.05991, ptr noundef %dest_index.2, i32 noundef 1) #6
  %tobool1955.not = icmp eq i32 %need_adjust.16002, 0
  br i1 %tobool1955.not, label %if.end1959, label %if.then1956

if.then1956:                                      ; preds = %if.then1954
  call void @AdjustSize(ptr noundef %dest_encl.6, i32 noundef %stop_back.15990, i32 noundef %stop_fwd.15988, i32 noundef %bf.cast) #6
  call void @AdjustSize(ptr noundef %dest_encl.6, i32 noundef %stop_perp_back.15985, i32 noundef %stop_perp_fwd.15986, i32 noundef %sub) #6
  br label %if.end1959

if.end1959:                                       ; preds = %if.then1954, %if.then1956, %if.end1951
  %tobool1962 = icmp ne i32 %headers_seen.05989, 0
...
for.cond1966.preheader:                           ; preds = %if.end1959
  ...
  %cmp1970.not6025 = icmp eq ptr %303, %link.06005
  br i1 %cmp1970.not6025, label %if.end2048, label %for.cond1979.preheader

for.cond1979.preheader:                           ; preds = %for.cond1966.preheader, %if.end2046
  %304 = phi ptr [ %310, %if.end2046 ], [ %303, %for.cond1966.preheader ]
  %zlink1965.06026 = phi ptr [ %zlink1965.1, %if.end2046 ], [ %hd, %for.cond1966.preheader ]
  br label %for.cond1979

for.cond1979:                                     ; preds = %for.cond1979.preheader, %for.cond1979
  %.pn5728 = phi ptr [ %z1964.0, %for.cond1979 ], [ %304, %for.cond1979.preheader ]
  %z1964.0.in = getelementptr inbounds [2 x %struct.LIST], ptr %.pn5728, i64 0, i64 1
...
if.then1996:                                      ; preds = %for.cond1979
  ...
  %cond2008.in = select i1 %cmp265, ptr %osucc2002, ptr %z1964.0
...
if.end2024:                                       ; preds = %for.cond1979, %for.cond2012
  ...
  %308 = and i8 %307, -4
  %or.cond5749 = icmp eq i8 %308, 20
  br i1 %or.cond5749, label %if.then2036, label %if.end2046
...
if.end2069:                                       ; preds = %if.then2067, %if.end2061
  ...
  %link.2.in6028 = getelementptr inbounds %struct.LIST, ptr %316, i64 0, i32 1
  %link.26029 = load ptr, ptr %link.2.in6028, align 8, !tbaa !5
  %cmp2076.not6030 = icmp eq ptr %link.26029, %316
  br i1 %cmp2076.not6030, label %if.end2221, label %for.cond2082.preheader.lr.ph
...
for.cond2082.preheader:                           ; preds = %for.cond2082.preheader.lr.ph, %cond.end2209
  %link.26032 = phi ptr [ %link.26029, %for.cond2082.preheader.lr.ph ], [ %link.2, %cond.end2209 ]
  %headers_count.06031 = phi i32 [ 0, %for.cond2082.preheader.lr.ph ], [ %inc, %cond.end2209 ]
  br label %for.cond2082

for.cond2082:                                     ; preds = %for.cond2082.preheader, %for.cond2082
  %link.2.pn = phi ptr [ %storemerge5726, %for.cond2082 ], [ %link.26032, %for.cond2082.preheader ]
  %storemerge5726.in = getelementptr inbounds [2 x %struct.LIST], ptr %link.2.pn, i64 0, i64 1
  %storemerge5726 = load ptr, ptr %storemerge5726.in, align 8, !tbaa !5
  %ou12083 = getelementptr inbounds %struct.word_type, ptr %storemerge5726, i64 0, i32 1
...
if.then2105:                                      ; preds = %for.cond2082, %for.cond2082
  store ptr %storemerge5726, ptr %y, align 8, !tbaa !8
...
if.end2130:                                       ; preds = %if.then2119, %if.else2121
  ...
  %arrayidx2134 = getelementptr inbounds [2 x %struct.LIST], ptr %323, i64 0, i64 1
  %osucc2135 = getelementptr inbounds [2 x %struct.LIST], ptr %323, i64 0, i64 1, i32 1
  store ptr %323, ptr %osucc2135, align 8, !tbaa !5
  store ptr %323, ptr %arrayidx2134, align 8, !tbaa !5
...
cond.false2152:                                   ; preds = %if.end2130
  ...
  %.pre6239 = load ptr, ptr @xx_link, align 8, !tbaa !8
  br label %cond.end2176

cond.end2176:                                     ; preds = %if.end2130, %cond.false2152
  %332 = phi ptr [ %323, %if.end2130 ], [ %.pre6239, %cond.false2152 ]
  ...
  %or.cond5763 = select i1 %cmp2178, i1 true, i1 %cmp2182
  br i1 %or.cond5763, label %cond.end2209, label %cond.false2185
...
cond.end2209:                                     ; preds = %cond.end2176, %cond.false2185
  %inc = add nuw nsw i32 %headers_count.06031, 1
  %link.2.in = getelementptr inbounds %struct.LIST, ptr %link.26032, i64 0, i32 1
...
if.end2229:                                       ; preds = %if.then2227, %if.end2221
  %tobool2230.not = icmp eq i32 %prnt_flush.55987, 0
...
lor.end2239:                                      ; preds = %lor.rhs2231, %if.end2229
  ...
  %osucc22446034 = getelementptr inbounds [2 x %struct.LIST], ptr %dest_index.2, i64 0, i64 1, i32 1
  %343 = load ptr, ptr %osucc22446034, align 8, !tbaa !5
  %cmp2245.not6035 = icmp eq ptr %343, %dest_index.2
  br i1 %cmp2245.not6035, label %while.cond2342.preheader, label %while.body2247

while.cond2342.preheader:                         ; preds = %cond.end2309, %lor.end2239
  %344 = phi ptr [ %dest_index.2, %lor.end2239 ], [ %360, %cond.end2309 ]
  %osucc23456036 = getelementptr inbounds %struct.LIST, ptr %344, i64 0, i32 1
  %345 = load ptr, ptr %osucc23456036, align 8, !tbaa !5
  %cmp2346.not6037 = icmp eq ptr %345, %344
  br i1 %cmp2346.not6037, label %while.end2442, label %while.body2348
...
cond.false2257:                                   ; preds = %while.body2247
  %arrayidx2252 = getelementptr inbounds [2 x %struct.LIST], ptr %346, i64 0, i64 1
  store ptr %347, ptr @zz_res, align 8, !tbaa !8
  %348 = load ptr, ptr %arrayidx2252, align 8, !tbaa !5
  %arrayidx2265 = getelementptr inbounds [2 x %struct.LIST], ptr %347, i64 0, i64 1
  store ptr %348, ptr %arrayidx2265, align 8, !tbaa !5
  %349 = load ptr, ptr %arrayidx2252, align 8, !tbaa !5
  ...
  store ptr %346, ptr %arrayidx2252, align 8, !tbaa !5
...
cond.false2287:                                   ; preds = %cond.end2279
  ...
  %.pre6240 = load ptr, ptr @xx_link, align 8, !tbaa !8
  br label %cond.end2309

cond.end2309:                                     ; preds = %cond.end2279, %cond.false2287
  %355 = phi ptr [ %346, %cond.end2279 ], [ %.pre6240, %cond.false2287 ]
  ...
  %.off5764 = add i8 %356, -11
  %switch5765 = icmp ult i8 %.off5764, 2
  ...
  %cond2333.in.in = select i1 %switch5765, ptr %orec_size2324, ptr %arrayidx2330
...
cond.false2358:                                   ; preds = %while.body2348
  %arrayidx2353 = getelementptr inbounds [2 x %struct.LIST], ptr %362, i64 0, i64 1
  store ptr %363, ptr @zz_res, align 8, !tbaa !8
  %364 = load ptr, ptr %arrayidx2353, align 8, !tbaa !5
  %arrayidx2366 = getelementptr inbounds [2 x %struct.LIST], ptr %363, i64 0, i64 1
  store ptr %364, ptr %arrayidx2366, align 8, !tbaa !5
  %365 = load ptr, ptr %arrayidx2353, align 8, !tbaa !5
  ...
  store ptr %362, ptr %arrayidx2353, align 8, !tbaa !5
...
cond.false2388:                                   ; preds = %cond.end2380
  ...
  %.pre6241 = load ptr, ptr @xx_link, align 8, !tbaa !8
  br label %cond.end2410

cond.end2410:                                     ; preds = %cond.end2380, %cond.false2388
  %371 = phi ptr [ %362, %cond.end2380 ], [ %.pre6241, %cond.false2388 ]
  ...
  %.off5766 = add i8 %372, -11
  %switch5767 = icmp ult i8 %.off5766, 2
  ...
  %cond2434.in.in = select i1 %switch5767, ptr %orec_size2425, ptr %arrayidx2431
...
while.end2442:                                    ; preds = %cond.end2410, %while.cond2342.preheader
  %.lcssa5959 = phi ptr [ %344, %while.cond2342.preheader ], [ %376, %cond.end2410 ]
  store ptr %.lcssa5959, ptr @zz_hold, align 8, !tbaa !8
  %ou12443 = getelementptr inbounds %struct.word_type, ptr %.lcssa5959, i64 0, i32 1
  %378 = load i8, ptr %ou12443, align 8, !tbaa !5
  %.off5768 = add i8 %378, -11
  %switch5769 = icmp ult i8 %.off5768, 2
  %orec_size2456 = getelementptr inbounds %struct.word_type, ptr %.lcssa5959, i64 0, i32 1, i32 0, i32 1
  %idxprom2461 = zext i8 %378 to i64
  %arrayidx2462 = getelementptr inbounds [0 x i8], ptr @zz_lengths, i64 0, i64 %idxprom2461
  %cond2465.in.in = select i1 %switch5769, ptr %orec_size2456, ptr %arrayidx2462
  ...
  store ptr %379, ptr %.lcssa5959, align 8, !tbaa !5
...
SUSPEND:                                          ; preds = %if.end641, %if.end288, %if.end288, %sw.bb61, %sw.bb1027
  %stop_perp_back.4 = phi i32 [ %stop_perp_back.15985, %sw.bb1027 ], [ %stop_perp_back.0, %sw.bb61 ], [ %stop_perp_back.15985, %if.end288 ], [ %stop_perp_back.15985, %if.end288 ], [ %stop_perp_back.15985, %if.end641 ]
  %stop_perp_fwd.4 = phi i32 [ %stop_perp_fwd.15986, %sw.bb1027 ], [ %stop_perp_fwd.0, %sw.bb61 ], [ %stop_perp_fwd.15986, %if.end288 ], [ %stop_perp_fwd.15986, %if.end288 ], [ %stop_perp_fwd.15986, %if.end641 ]
  %prnt_flush.7 = phi i32 [ %prnt_flush.55987, %sw.bb1027 ], [ %prnt_flush.0, %sw.bb61 ], [ %prnt_flush.55987, %if.end288 ], [ %prnt_flush.55987, %if.end288 ], [ %prnt_flush.55987, %if.end641 ]
  %stop_fwd.4 = phi i32 [ %stop_fwd.15988, %sw.bb1027 ], [ %stop_fwd.0, %sw.bb61 ], [ %stop_fwd.15988, %if.end288 ], [ %stop_fwd.15988, %if.end288 ], [ %stop_fwd.15988, %if.end641 ]
  %stop_back.4 = phi i32 [ %stop_back.15990, %sw.bb1027 ], [ %stop_back.0, %sw.bb61 ], [ %stop_back.15990, %if.end288 ], [ %stop_back.15990, %if.end288 ], [ %stop_back.15990, %if.end641 ]
  %stop_link.3 = phi ptr [ %stop_link.05991, %sw.bb1027 ], [ null, %sw.bb61 ], [ %stop_link.05991, %if.end288 ], [ %stop_link.05991, %if.end288 ], [ %stop_link.05991, %if.end641 ]
  %perp_back.6 = phi i32 [ %perp_back.15992, %sw.bb1027 ], [ %perp_back.0, %sw.bb61 ], [ %perp_back.15992, %if.end288 ], [ %perp_back.15992, %if.end288 ], [ %perp_back.15992, %if.end641 ]
  %perp_fwd.6 = phi i32 [ %perp_fwd.15994, %sw.bb1027 ], [ %perp_fwd.0, %sw.bb61 ], [ %perp_fwd.15994, %if.end288 ], [ %perp_fwd.15994, %if.end288 ], [ %perp_fwd.15994, %if.end641 ]
  %frame_size.6 = phi i32 [ %frame_size.15996, %sw.bb1027 ], [ %frame_size.0, %sw.bb61 ], [ %frame_size.15996, %if.end288 ], [ %frame_size.15996, %if.end288 ], [ %frame_size.15996, %if.end641 ]
  %dest_fwd.6 = phi i32 [ %dest_fwd.15998, %sw.bb1027 ], [ %dest_fwd.0, %sw.bb61 ], [ %dest_fwd.15998, %if.end288 ], [ %dest_fwd.15998, %if.end288 ], [ %dest_fwd.15998, %if.end641 ]
  %dest_back.6 = phi i32 [ %dest_back.16000, %sw.bb1027 ], [ %dest_back.0, %sw.bb61 ], [ %dest_back.16000, %if.end288 ], [ %dest_back.16000, %if.end288 ], [ %dest_back.16000, %if.end641 ]
  %need_adjust.4 = phi i32 [ %need_adjust.16002, %sw.bb1027 ], [ %need_adjust.0, %sw.bb61 ], [ %need_adjust.16002, %if.end288 ], [ %need_adjust.16002, %if.end288 ], [ %need_adjust.16002, %if.end641 ]
  %dest_encl.7 = phi ptr [ %dest_encl.16003, %sw.bb1027 ], [ %dest_encl.0, %sw.bb61 ], [ %dest_encl.16003, %if.end288 ], [ %dest_encl.16003, %if.end288 ], [ %dest_encl.16003, %if.end641 ]
...
for.cond2504:                                     ; preds = %for.cond2504, %if.then2496
  %.pn5733 = phi ptr [ %387, %if.then2496 ], [ %eg.0, %for.cond2504 ]
  %eg.0.in = getelementptr inbounds [2 x %struct.LIST], ptr %.pn5733, i64 0, i64 1
...
if.else2546:                                      ; preds = %if.end2532
  ...
  %idxprom2552 = zext i8 %396 to i64
  %arrayidx2553 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %idxprom2552
  store ptr %399, ptr %arrayidx2553, align 8, !tbaa !8
  br label %if.end2555
...
if.else2584:                                      ; preds = %if.end2555
  ...
  %idxprom2590 = zext i8 %401 to i64
  %arrayidx2591 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %idxprom2590
  store ptr %404, ptr %arrayidx2591, align 8, !tbaa !8
  br label %if.end2593
...
cond.end2724:                                     ; preds = %if.then2667, %if.else2669
  ...
  %arrayidx2682 = getelementptr inbounds [2 x %struct.LIST], ptr %413, i64 0, i64 1
  %osucc2683 = getelementptr inbounds [2 x %struct.LIST], ptr %413, i64 0, i64 1, i32 1
  store ptr %413, ptr %osucc2683, align 8, !tbaa !5
  store ptr %413, ptr %arrayidx2682, align 8, !tbaa !5
...
if.else2772:                                      ; preds = %cond.end2757
  ...
  %idxprom2778 = zext i8 %426 to i64
  %arrayidx2779 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %idxprom2778
  store ptr %429, ptr %arrayidx2779, align 8, !tbaa !8
  br label %cond.end2827
...
cond.end2827:                                     ; preds = %if.then2770, %if.else2772
  ...
  %arrayidx2785 = getelementptr inbounds [2 x %struct.LIST], ptr %430, i64 0, i64 1
  %osucc2786 = getelementptr inbounds [2 x %struct.LIST], ptr %430, i64 0, i64 1, i32 1
  store ptr %430, ptr %osucc2786, align 8, !tbaa !5
  store ptr %430, ptr %arrayidx2785, align 8, !tbaa !5
  ...
  %or.cond5771 = select i1 %cmp2517, i1 true, i1 %cmp2833
  br i1 %or.cond5771, label %cond.end2860, label %cond.false2836
...
if.else2888:                                      ; preds = %cond.end2872
  ...
  %idxprom2894 = zext i8 %445 to i64
  %arrayidx2895 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %idxprom2894
  store ptr %448, ptr %arrayidx2895, align 8, !tbaa !8
  br label %if.end2897
...
if.end2897:                                       ; preds = %if.then2886, %if.else2888
  ...
  %arrayidx2901 = getelementptr inbounds [2 x %struct.LIST], ptr %449, i64 0, i64 1
  %osucc2902 = getelementptr inbounds [2 x %struct.LIST], ptr %449, i64 0, i64 1, i32 1
  store ptr %449, ptr %osucc2902, align 8, !tbaa !5
  store ptr %449, ptr %arrayidx2901, align 8, !tbaa !5
...
cond.end2946:                                     ; preds = %if.end2897
  ...
  %.pre6258 = load ptr, ptr @xx_link, align 8, !tbaa !8
  store ptr %.pre6258, ptr @zz_res, align 8, !tbaa !8
  store ptr %400, ptr @zz_hold, align 8, !tbaa !8
  %cmp2952 = icmp eq ptr %.pre6258, null
  br i1 %cmp2952, label %cond.end2979, label %cond.false2955

cond.false2955:                                   ; preds = %cond.end2946.thread, %cond.end2946
  %460 = phi ptr [ %449, %cond.end2946.thread ], [ %.pre6258, %cond.end2946 ]
...
for.cond2987:                                     ; preds = %for.cond2987, %cond.end2979
  %.pn5734 = phi ptr [ %464, %cond.end2979 ], [ %tag.0, %for.cond2987 ]
  %tag.0.in = getelementptr inbounds [2 x %struct.LIST], ptr %.pn5734, i64 0, i64 1
...
for.cond3005:                                     ; preds = %for.cond3005, %for.end2998
  %.pn5735 = phi ptr [ %466, %for.end2998 ], [ %seq.0, %for.cond3005 ]
  %seq.0.in = getelementptr inbounds [2 x %struct.LIST], ptr %.pn5735, i64 0, i64 1
...
do.body:                                          ; preds = %do.body.preheader, %land.rhs3394
  ...
  %or.cond5831 = select i1 %tobool3022.not, i1 true, i1 %tobool3024.not
  br i1 %or.cond5831, label %if.else3817, label %land.lhs.true3025
...
if.end3103:                                       ; preds = %if.then3092, %if.else3094
  ...
  %arrayidx3122 = getelementptr inbounds [2 x %struct.LIST], ptr %487, i64 0, i64 1
  ...
  %.pre6260 = load ptr, ptr %arrayidx3122, align 8, !tbaa !5
...
cond.false3127:                                   ; preds = %if.end3103
  ...
  store ptr %.pre6260, ptr %arrayidx3135, align 8, !tbaa !5
  %489 = load ptr, ptr %arrayidx3122, align 8, !tbaa !5
  ...
  store ptr %487, ptr %arrayidx3122, align 8, !tbaa !5
  %.pre6259 = load ptr, ptr %arrayidx3107, align 8, !tbaa !5
  br label %cond.end3182

cond.end3182:                                     ; preds = %if.end3103, %cond.false3127
  %490 = phi ptr [ %487, %cond.false3127 ], [ %.pre6260, %if.end3103 ]
  %491 = phi ptr [ %.pre6259, %cond.false3127 ], [ %486, %if.end3103 ]
...
if.end3206:                                       ; preds = %if.then3195, %if.else3197
  ...
  %arrayidx3210 = getelementptr inbounds [2 x %struct.LIST], ptr %497, i64 0, i64 1
  %osucc3211 = getelementptr inbounds [2 x %struct.LIST], ptr %497, i64 0, i64 1, i32 1
  store ptr %497, ptr %osucc3211, align 8, !tbaa !5
  store ptr %497, ptr %arrayidx3210, align 8, !tbaa !5
...
cond.false3261:                                   ; preds = %if.end3206
...
if.end3287:                                       ; preds = %cond.false3261, %if.end3206, %if.else3073
  %hd2.1 = phi ptr [ %hd2.0, %if.else3073 ], [ %486, %if.end3206 ], [ %486, %cond.false3261 ]
...
cond.end3356:                                     ; preds = %if.then3299, %if.else3301
  ...
  %arrayidx3314 = getelementptr inbounds [2 x %struct.LIST], ptr %514, i64 0, i64 1
  %osucc3315 = getelementptr inbounds [2 x %struct.LIST], ptr %514, i64 0, i64 1, i32 1
  store ptr %514, ptr %osucc3315, align 8, !tbaa !5
  store ptr %514, ptr %arrayidx3314, align 8, !tbaa !5
  ...
  %or.cond5775 = select i1 %cmp3049, i1 true, i1 %cmp3362
  br i1 %or.cond5775, label %land.rhs3394, label %cond.false3365
...
cond.false3444:                                   ; preds = %cond.end3436
  ...
  %.pre6261 = load ptr, ptr @xx_link, align 8, !tbaa !8
  br label %cond.end3466

cond.end3466:                                     ; preds = %cond.end3436, %cond.false3444
  %536 = phi ptr [ %527, %cond.end3436 ], [ %.pre6261, %cond.false3444 ]
  ...
  %.off5776 = add i8 %537, -11
  %switch5777 = icmp ult i8 %.off5776, 2
  ...
  %cond3490.in.in = select i1 %switch5777, ptr %orec_size3481, ptr %arrayidx3487
...
cond.end3567:                                     ; preds = %cond.end3537, %cond.false3545
  %552 = phi ptr [ %543, %cond.end3537 ], [ %.pre6262, %cond.false3545 ]
  ...
  %.off5778 = add i8 %553, -11
  %switch5779 = icmp ult i8 %.off5778, 2
  ...
  %cond3591.in.in = select i1 %switch5779, ptr %orec_size3582, ptr %arrayidx3588
...
if.else3624:                                      ; preds = %if.end3606
  ...
  %idxprom3630 = zext i8 %561 to i64
  %arrayidx3631 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %idxprom3630
  store ptr %564, ptr %arrayidx3631, align 8, !tbaa !8
  br label %if.end3633

if.end3633:                                       ; preds = %if.then3622, %if.else3624
  ...
  %arrayidx3637 = getelementptr inbounds [2 x %struct.LIST], ptr %565, i64 0, i64 1
  %osucc3638 = getelementptr inbounds [2 x %struct.LIST], ptr %565, i64 0, i64 1, i32 1
  store ptr %565, ptr %osucc3638, align 8, !tbaa !5
  store ptr %565, ptr %arrayidx3637, align 8, !tbaa !5
  ...
  %or.cond5780 = select i1 %cmp3681, i1 true, i1 %cmp3685
  br i1 %or.cond5780, label %cond.end3712, label %cond.false3688

cond.false3688:                                   ; preds = %if.end3633
...
cond.end3712:                                     ; preds = %if.end3633, %cond.false3688
...
if.end3736:                                       ; preds = %if.then3725, %if.else3727
  ...
  %arrayidx3740 = getelementptr inbounds [2 x %struct.LIST], ptr %582, i64 0, i64 1
  %osucc3741 = getelementptr inbounds [2 x %struct.LIST], ptr %582, i64 0, i64 1, i32 1
  store ptr %582, ptr %osucc3741, align 8, !tbaa !5
  store ptr %582, ptr %arrayidx3740, align 8, !tbaa !5
  ...
  %or.cond5781 = select i1 %cmp3784, i1 true, i1 %cmp3788
  br i1 %or.cond5781, label %if.end3960, label %cond.false3791

cond.false3791:                                   ; preds = %if.end3736
...
cond.end3879:                                     ; preds = %cond.end3849, %cond.false3857
  %604 = phi ptr [ %595, %cond.end3849 ], [ %.pre6263, %cond.false3857 ]
  ...
  %.off5782 = add i8 %605, -11
  %switch5783 = icmp ult i8 %.off5782, 2
  ...
  %cond3903.in.in = select i1 %switch5783, ptr %orec_size3894, ptr %arrayidx3900
...
if.then3926:                                      ; preds = %if.end3918
  ...
  %.off5784 = add i8 %613, -11
  %switch5785 = icmp ult i8 %.off5784, 2
  ...
  %cond3950.in.in = select i1 %switch5785, ptr %orec_size3941, ptr %arrayidx3947
...
if.end3960:                                       ; preds = %if.end3736, %if.end3918, %if.then3926, %cond.false3791
  %hd2.25827 = phi ptr [ %hd2.2.ph, %if.end3736 ], [ %hd2.0, %if.end3918 ], [ %hd2.0, %if.then3926 ], [ %hd2.2.ph, %cond.false3791 ]
  %ou13961 = getelementptr inbounds %struct.word_type, ptr %hd2.25827, i64 0, i32 1
...
if.then3966:                                      ; preds = %if.end3960
  %call3967 = call ptr @ConvertGalleyList(ptr noundef nonnull %hd2.25827) #6
  br label %if.end3968

if.end3968:                                       ; preds = %if.then3966, %if.end3960
  %hd2.3 = phi ptr [ %call3967, %if.then3966 ], [ %hd2.25827, %if.end3960 ]
...
if.then3995:                                      ; preds = %land.lhs.true3986
  ...
  %cmp4005.not6039 = icmp eq ptr %call4003, null
  br i1 %cmp4005.not6039, label %for.end4598, label %for.body4007

for.body4007:                                     ; preds = %if.then3995, %for.inc4594
  %sym.06040 = phi ptr [ %call4597, %for.inc4594 ], [ %call4003, %if.then3995 ]
  ...
  %call4010 = call ptr @GallTargEval(ptr noundef nonnull %sym.06040, ptr noundef nonnull %ou14009) #6
...
cond.end4120:                                     ; preds = %if.end4071
  ...
  %.pre6246 = load ptr, ptr @xx_link, align 8, !tbaa !8
  store ptr %.pre6246, ptr @zz_res, align 8, !tbaa !8
  store ptr %627, ptr @zz_hold, align 8, !tbaa !8
  %cmp4126 = icmp eq ptr %.pre6246, null
  br i1 %cmp4126, label %cond.end4153, label %cond.false4129

cond.false4129:                                   ; preds = %cond.end4120.thread, %cond.end4120
  %643 = phi ptr [ %632, %cond.end4120.thread ], [ %.pre6246, %cond.end4120 ]
...
for.cond4161:                                     ; preds = %for.cond4161, %cond.end4153
  %.pn5732 = phi ptr [ %647, %cond.end4153 ], [ %tag3996.0, %for.cond4161 ]
  %tag3996.0.in = getelementptr inbounds [2 x %struct.LIST], ptr %.pn5732, i64 0, i64 1
...
if.end4186:                                       ; preds = %for.cond4161, %for.cond4161, %if.then4184
  ...
  %call4190 = call i32 @DbRetrieve(ptr noundef %650, i32 noundef 1, ptr noundef nonnull %sym.06040, ptr noundef nonnull %ostring4187, ptr noundef nonnull %newseq4000, ptr noundef nonnull %tfnum, ptr noundef nonnull %tfpos, ptr noundef nonnull %tlnum, ptr noundef nonnull %tcont) #6
...
if.else4210:                                      ; preds = %if.then4196
  ...
  %idxprom4216 = zext i8 %652 to i64
  %arrayidx4217 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %idxprom4216
  store ptr %655, ptr %arrayidx4217, align 8, !tbaa !8
  br label %if.end4219
...
if.end4258:                                       ; preds = %if.then4247, %if.else4249
  ...
  store ptr %sym.06040, ptr %oeg_symbol4276, align 8, !tbaa !5
...
cond.end4349:                                     ; preds = %if.then4292, %if.else4294
  ...
  %.pre6247 = load ptr, ptr @xx_link, align 8, !tbaa !8
  store ptr %.pre6247, ptr @zz_res, align 8, !tbaa !8
  store ptr %call4280, ptr @zz_hold, align 8, !tbaa !8
  %cmp4351 = icmp eq ptr %call4280, null
  %cmp4355 = icmp eq ptr %.pre6247, null
  %or.cond5793 = select i1 %cmp4351, i1 true, i1 %cmp4355
  br i1 %or.cond5793, label %cond.end4382, label %cond.false4358

cond.false4358:                                   ; preds = %cond.end4349
  %arrayidx4360 = getelementptr inbounds [2 x %struct.LIST], ptr %call4280, i64 0, i64 1
  %680 = load ptr, ptr %arrayidx4360, align 8, !tbaa !5
  store ptr %680, ptr @zz_tmp, align 8, !tbaa !8
  %arrayidx4363 = getelementptr inbounds [2 x %struct.LIST], ptr %.pre6247, i64 0, i64 1
  %681 = load ptr, ptr %arrayidx4363, align 8, !tbaa !5
  store ptr %681, ptr %arrayidx4360, align 8, !tbaa !5
  %682 = load ptr, ptr %arrayidx4363, align 8, !tbaa !5
  %osucc4373 = getelementptr inbounds [2 x %struct.LIST], ptr %682, i64 0, i64 1, i32 1
  store ptr %call4280, ptr %osucc4373, align 8, !tbaa !5
  store ptr %680, ptr %arrayidx4363, align 8, !tbaa !5
  %osucc4379 = getelementptr inbounds [2 x %struct.LIST], ptr %680, i64 0, i64 1, i32 1
  store ptr %.pre6247, ptr %osucc4379, align 8, !tbaa !5
  br label %cond.end4382

cond.end4382:                                     ; preds = %cond.end4349, %cond.false4358
  %683 = load ptr, ptr @no_fpos, align 8, !tbaa !8
  %call4385 = call ptr @MakeWord(i32 noundef 11, ptr noundef nonnull %newseq4000, ptr noundef %683) #6
  %684 = load i8, ptr @zz_lengths, align 1, !tbaa !5
  %conv4386 = zext i8 %684 to i32
  store i32 %conv4386, ptr @zz_size, align 4, !tbaa !16
  %conv4387 = zext i8 %684 to i64
  %arrayidx4394 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %conv4387
  %685 = load ptr, ptr %arrayidx4394, align 8, !tbaa !8
  %cmp4395 = icmp eq ptr %685, null
  br i1 %cmp4395, label %if.then4397, label %if.else4399

if.then4397:                                      ; preds = %cond.end4382
  %686 = load ptr, ptr @no_fpos, align 8, !tbaa !8
  %call4398 = call ptr @GetMemory(i32 noundef %conv4386, ptr noundef %686) #6
...
if.else4399:                                      ; preds = %cond.end4382
  ...
  %idxprom4405 = zext i8 %684 to i64
  %arrayidx4406 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %idxprom4405
  store ptr %687, ptr %arrayidx4406, align 8, !tbaa !8
  br label %cond.end4454

cond.end4454:                                     ; preds = %if.then4397, %if.else4399
  %688 = phi ptr [ %call4398, %if.then4397 ], [ %685, %if.else4399 ]
  %ou14409 = getelementptr inbounds %struct.word_type, ptr %688, i64 0, i32 1
  store i8 0, ptr %ou14409, align 8, !tbaa !5
  %osucc4413 = getelementptr inbounds [2 x %struct.LIST], ptr %688, i64 0, i64 1, i32 1
  store ptr %688, ptr %osucc4413, align 8, !tbaa !5
  %arrayidx4415 = getelementptr inbounds [2 x %struct.LIST], ptr %688, i64 0, i64 1
  store ptr %688, ptr %arrayidx4415, align 8, !tbaa !5
  %osucc4419 = getelementptr inbounds %struct.LIST, ptr %688, i64 0, i32 1
  store ptr %688, ptr %osucc4419, align 8, !tbaa !5
  store ptr %688, ptr %688, align 8, !tbaa !5
  store ptr %688, ptr @xx_link, align 8, !tbaa !8
  store ptr %688, ptr @zz_res, align 8, !tbaa !8
  store ptr %661, ptr @zz_hold, align 8, !tbaa !8
  %689 = load ptr, ptr %661, align 8, !tbaa !5
  store ptr %689, ptr @zz_tmp, align 8, !tbaa !8
  %690 = load ptr, ptr %688, align 8, !tbaa !5
  store ptr %690, ptr %661, align 8, !tbaa !5
  %691 = load ptr, ptr @zz_hold, align 8, !tbaa !8
  %692 = load ptr, ptr @zz_res, align 8, !tbaa !8
  %693 = load ptr, ptr %692, align 8, !tbaa !5
  %osucc4445 = getelementptr inbounds %struct.LIST, ptr %693, i64 0, i32 1
  store ptr %691, ptr %osucc4445, align 8, !tbaa !5
  %694 = load ptr, ptr @zz_tmp, align 8, !tbaa !8
  store ptr %694, ptr %692, align 8, !tbaa !5
  %695 = load ptr, ptr @zz_res, align 8, !tbaa !8
  %696 = load ptr, ptr @zz_tmp, align 8, !tbaa !8
  %osucc4451 = getelementptr inbounds %struct.LIST, ptr %696, i64 0, i32 1
  store ptr %695, ptr %osucc4451, align 8, !tbaa !5
  %.pre6248 = load ptr, ptr @xx_link, align 8, !tbaa !8
  store ptr %.pre6248, ptr @zz_res, align 8, !tbaa !8
  store ptr %call4385, ptr @zz_hold, align 8, !tbaa !8
  %cmp4456 = icmp eq ptr %call4385, null
  %cmp4460 = icmp eq ptr %.pre6248, null
  %or.cond5797 = select i1 %cmp4456, i1 true, i1 %cmp4460
  br i1 %or.cond5797, label %cond.end4487, label %cond.false4463

cond.false4463:                                   ; preds = %cond.end4454
  %arrayidx4465 = getelementptr inbounds [2 x %struct.LIST], ptr %call4385, i64 0, i64 1
  %697 = load ptr, ptr %arrayidx4465, align 8, !tbaa !5
  store ptr %697, ptr @zz_tmp, align 8, !tbaa !8
  %arrayidx4468 = getelementptr inbounds [2 x %struct.LIST], ptr %.pre6248, i64 0, i64 1
  %698 = load ptr, ptr %arrayidx4468, align 8, !tbaa !5
  store ptr %698, ptr %arrayidx4465, align 8, !tbaa !5
  %699 = load ptr, ptr %arrayidx4468, align 8, !tbaa !5
  %osucc4478 = getelementptr inbounds [2 x %struct.LIST], ptr %699, i64 0, i64 1, i32 1
  store ptr %call4385, ptr %osucc4478, align 8, !tbaa !5
  store ptr %697, ptr %arrayidx4468, align 8, !tbaa !5
  %osucc4484 = getelementptr inbounds [2 x %struct.LIST], ptr %697, i64 0, i64 1, i32 1
  store ptr %.pre6248, ptr %osucc4484, align 8, !tbaa !5
  br label %cond.end4487

cond.end4487:                                     ; preds = %cond.end4454, %cond.false4463
  %700 = load i8, ptr @zz_lengths, align 1, !tbaa !5
  %conv4489 = zext i8 %700 to i32
  store i32 %conv4489, ptr @zz_size, align 4, !tbaa !16
  %conv4490 = zext i8 %700 to i64
  %arrayidx4497 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %conv4490
  %701 = load ptr, ptr %arrayidx4497, align 8, !tbaa !8
  %cmp4498 = icmp eq ptr %701, null
  br i1 %cmp4498, label %if.then4500, label %if.else4502

if.then4500:                                      ; preds = %cond.end4487
  %702 = load ptr, ptr @no_fpos, align 8, !tbaa !8
  %call4501 = call ptr @GetMemory(i32 noundef %conv4489, ptr noundef %702) #6
  br label %if.end4511

if.else4502:                                      ; preds = %cond.end4487
  store ptr %701, ptr @zz_hold, align 8, !tbaa !8
  %703 = load ptr, ptr %701, align 8, !tbaa !5
  %idxprom4508 = zext i8 %700 to i64
  %arrayidx4509 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %idxprom4508
  store ptr %703, ptr %arrayidx4509, align 8, !tbaa !8
  br label %if.end4511

if.end4511:                                       ; preds = %if.then4500, %if.else4502
  %704 = phi ptr [ %call4501, %if.then4500 ], [ %701, %if.else4502 ]
  %ou14512 = getelementptr inbounds %struct.word_type, ptr %704, i64 0, i32 1
  store i8 0, ptr %ou14512, align 8, !tbaa !5
  %osucc4516 = getelementptr inbounds [2 x %struct.LIST], ptr %704, i64 0, i64 1, i32 1
  store ptr %704, ptr %osucc4516, align 8, !tbaa !5
  %arrayidx4518 = getelementptr inbounds [2 x %struct.LIST], ptr %704, i64 0, i64 1
  store ptr %704, ptr %arrayidx4518, align 8, !tbaa !5
  %osucc4522 = getelementptr inbounds %struct.LIST, ptr %704, i64 0, i32 1
  store ptr %704, ptr %osucc4522, align 8, !tbaa !5
  store ptr %704, ptr %704, align 8, !tbaa !5
  store ptr %704, ptr @xx_link, align 8, !tbaa !8
  store ptr %704, ptr @zz_res, align 8, !tbaa !8
  %705 = load ptr, ptr %oready_galls, align 8, !tbaa !5
  store ptr %705, ptr @zz_hold, align 8, !tbaa !8
  %cmp4527 = icmp eq ptr %705, null
...
cond.end4558:                                     ; preds = %if.end4511
  ...
  store ptr %706, ptr @zz_tmp, align 8, !tbaa !8
  %707 = load ptr, ptr %704, align 8, !tbaa !5
  store ptr %707, ptr %705, align 8, !tbaa !5
  %708 = load ptr, ptr @zz_hold, align 8, !tbaa !8
  %709 = load ptr, ptr @zz_res, align 8, !tbaa !8
  %710 = load ptr, ptr %709, align 8, !tbaa !5
  %osucc4549 = getelementptr inbounds %struct.LIST, ptr %710, i64 0, i32 1
  store ptr %708, ptr %osucc4549, align 8, !tbaa !5
  ...
  %osucc4555 = getelementptr inbounds %struct.LIST, ptr %713, i64 0, i32 1
  store ptr %712, ptr %osucc4555, align 8, !tbaa !5
  %.pre6249 = load ptr, ptr @xx_link, align 8, !tbaa !8
  store ptr %.pre6249, ptr @zz_res, align 8, !tbaa !8
  store ptr %661, ptr @zz_hold, align 8, !tbaa !8
  %cmp4564 = icmp eq ptr %.pre6249, null
  br i1 %cmp4564, label %for.inc4594, label %cond.false4567

cond.false4567:                                   ; preds = %cond.end4558.thread, %cond.end4558
  %714 = phi ptr [ %704, %cond.end4558.thread ], [ %.pre6249, %cond.end4558 ]
  %715 = load ptr, ptr %arrayidx4262, align 8, !tbaa !5
  store ptr %715, ptr @zz_tmp, align 8, !tbaa !8
  %arrayidx4572 = getelementptr inbounds [2 x %struct.LIST], ptr %714, i64 0, i64 1
  %716 = load ptr, ptr %arrayidx4572, align 8, !tbaa !5
  store ptr %716, ptr %arrayidx4262, align 8, !tbaa !5
  %717 = load ptr, ptr %arrayidx4572, align 8, !tbaa !5
  %osucc4582 = getelementptr inbounds [2 x %struct.LIST], ptr %717, i64 0, i64 1, i32 1
  store ptr %661, ptr %osucc4582, align 8, !tbaa !5
  store ptr %715, ptr %arrayidx4572, align 8, !tbaa !5
  %osucc4588 = getelementptr inbounds [2 x %struct.LIST], ptr %715, i64 0, i64 1, i32 1
  store ptr %714, ptr %osucc4588, align 8, !tbaa !5
  br label %for.inc4594

for.inc4594:                                      ; preds = %cond.end4558, %if.end4186, %cond.false4567
  %718 = load ptr, ptr %y, align 8, !tbaa !8
  %oactual4595 = getelementptr inbounds %struct.closure_type, ptr %718, i64 0, i32 5
  %719 = load ptr, ptr %oactual4595, align 8, !tbaa !5
  %oactual4596 = getelementptr inbounds %struct.closure_type, ptr %719, i64 0, i32 5
  %720 = load ptr, ptr %oactual4596, align 8, !tbaa !5
  %call4597 = call ptr @NextExternTarget(ptr noundef %720, ptr noundef nonnull %cnt) #6
...
for.end4598:                                      ; preds = %for.inc4594, %if.then3995
  %721 = load ptr, ptr %y, align 8, !tbaa !8
  %otrigger_ext4600 = getelementptr inbounds i8, ptr %721, i64 42
  ...
  %722 = load ptr, ptr %oready_galls, align 8, !tbaa !5
  %cmp4605.not = icmp eq ptr %722, null
...
for.end4598.if.end4625_crit_edge:                 ; preds = %for.end4598
  %ou14626.phi.trans.insert = getelementptr inbounds %struct.word_type, ptr %721, i64 0, i32 1
  %.pre6250 = load i8, ptr %ou14626.phi.trans.insert, align 8, !tbaa !5
  br label %if.end4625

if.end4625:                                       ; preds = %for.end4598.if.end4625_crit_edge, %if.end2485
  %723 = phi i8 [ %.pre6250, %for.end4598.if.end4625_crit_edge ], [ %384, %if.end2485 ]
  %724 = phi ptr [ %721, %for.end4598.if.end4625_crit_edge ], [ %383, %if.end2485 ]
  switch i8 %723, label %if.end4625.if.end5150_crit_edge [
    i8 121, label %land.lhs.true4631
    i8 122, label %land.lhs.true4877
  ]

if.end4625.if.end5150_crit_edge:                  ; preds = %if.end4625
  %oblocked5152.phi.trans.insert = getelementptr inbounds i8, ptr %724, i64 42
  %bf.load5153.pre = load i16, ptr %oblocked5152.phi.trans.insert, align 2
  br label %if.end5150

land.lhs.true4631:                                ; preds = %land.lhs.true3986, %if.end4625
  %725 = phi ptr [ %724, %if.end4625 ], [ %383, %land.lhs.true3986 ]
  %onon_blocking4633 = getelementptr inbounds i8, ptr %725, i64 42
...
if.then4638:                                      ; preds = %land.lhs.true4631
  store ptr %725, ptr @xx_hold, align 8, !tbaa !8
  %osucc46426046 = getelementptr inbounds [2 x %struct.LIST], ptr %725, i64 0, i64 1, i32 1
  %726 = load ptr, ptr %osucc46426046, align 8, !tbaa !5
  %cmp4643.not6047 = icmp eq ptr %726, %725
  br i1 %cmp4643.not6047, label %while.cond4740.preheader, label %while.body4645

while.cond4740.preheader:                         ; preds = %cond.end4707, %if.then4638
  %727 = phi ptr [ %725, %if.then4638 ], [ %743, %cond.end4707 ]
  %osucc47436048 = getelementptr inbounds %struct.LIST, ptr %727, i64 0, i32 1
  %728 = load ptr, ptr %osucc47436048, align 8, !tbaa !5
  %cmp4744.not6049 = icmp eq ptr %728, %727
  br i1 %cmp4744.not6049, label %while.end4840, label %while.body4746

while.body4645:                                   ; preds = %if.then4638, %cond.end4707
  %729 = phi ptr [ %744, %cond.end4707 ], [ %726, %if.then4638 ]
  store ptr %729, ptr @xx_link, align 8, !tbaa !8
  %osucc4651 = getelementptr inbounds [2 x %struct.LIST], ptr %729, i64 0, i64 1, i32 1
  %730 = load ptr, ptr %osucc4651, align 8, !tbaa !5
  %cmp4652 = icmp eq ptr %730, %729
...
cond.false4655:                                   ; preds = %while.body4645
  ...
  %arrayidx4660 = getelementptr inbounds [2 x %struct.LIST], ptr %729, i64 0, i64 1
  %731 = load ptr, ptr %arrayidx4660, align 8, !tbaa !5
  %arrayidx4663 = getelementptr inbounds [2 x %struct.LIST], ptr %730, i64 0, i64 1
  store ptr %731, ptr %arrayidx4663, align 8, !tbaa !5
  %732 = load ptr, ptr %arrayidx4660, align 8, !tbaa !5
  %osucc4670 = getelementptr inbounds [2 x %struct.LIST], ptr %732, i64 0, i64 1, i32 1
  store ptr %730, ptr %osucc4670, align 8, !tbaa !5
  store ptr %729, ptr %osucc4651, align 8, !tbaa !5
  store ptr %729, ptr %arrayidx4660, align 8, !tbaa !5
  br label %cond.end4677

cond.end4677:                                     ; preds = %while.body4645, %cond.false4655
  store ptr %729, ptr @zz_hold, align 8, !tbaa !8
  %osucc4681 = getelementptr inbounds %struct.LIST, ptr %729, i64 0, i32 1
  %733 = load ptr, ptr %osucc4681, align 8, !tbaa !5
  %cmp4682 = icmp eq ptr %733, %729
  br i1 %cmp4682, label %cond.end4707, label %cond.false4685

cond.false4685:                                   ; preds = %cond.end4677
  store ptr %733, ptr @zz_res, align 8, !tbaa !8
  %734 = load ptr, ptr %729, align 8, !tbaa !5
  store ptr %734, ptr %733, align 8, !tbaa !5
  %735 = load ptr, ptr @zz_res, align 8, !tbaa !8
  %736 = load ptr, ptr @zz_hold, align 8, !tbaa !8
  %737 = load ptr, ptr %736, align 8, !tbaa !5
  %osucc4700 = getelementptr inbounds %struct.LIST, ptr %737, i64 0, i32 1
  store ptr %735, ptr %osucc4700, align 8, !tbaa !5
  %osucc4703 = getelementptr inbounds %struct.LIST, ptr %736, i64 0, i32 1
  store ptr %736, ptr %osucc4703, align 8, !tbaa !5
  store ptr %736, ptr %736, align 8, !tbaa !5
  %.pre6254 = load ptr, ptr @xx_link, align 8, !tbaa !8
  br label %cond.end4707

cond.end4707:                                     ; preds = %cond.end4677, %cond.false4685
  %738 = phi ptr [ %729, %cond.end4677 ], [ %.pre6254, %cond.false4685 ]
  store ptr %738, ptr @zz_hold, align 8, !tbaa !8
  %ou14709 = getelementptr inbounds %struct.word_type, ptr %738, i64 0, i32 1
  %739 = load i8, ptr %ou14709, align 8, !tbaa !5
  %.off5802 = add i8 %739, -11
  %switch5803 = icmp ult i8 %.off5802, 2
  %orec_size4722 = getelementptr inbounds %struct.word_type, ptr %738, i64 0, i32 1, i32 0, i32 1
  %idxprom4727 = zext i8 %739 to i64
  %arrayidx4728 = getelementptr inbounds [0 x i8], ptr @zz_lengths, i64 0, i64 %idxprom4727
  %cond4731.in.in = select i1 %switch5803, ptr %orec_size4722, ptr %arrayidx4728
  ...
  %740 = load ptr, ptr %arrayidx4733, align 8, !tbaa !8
  store ptr %740, ptr %738, align 8, !tbaa !5
  %741 = load ptr, ptr @zz_hold, align 8, !tbaa !8
  %742 = load i32, ptr @zz_size, align 4, !tbaa !16
  %idxprom4737 = sext i32 %742 to i64
  %arrayidx4738 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %idxprom4737
  store ptr %741, ptr %arrayidx4738, align 8, !tbaa !8
  %743 = load ptr, ptr @xx_hold, align 8, !tbaa !8
  %osucc4642 = getelementptr inbounds [2 x %struct.LIST], ptr %743, i64 0, i64 1, i32 1
  %744 = load ptr, ptr %osucc4642, align 8, !tbaa !5
  %cmp4643.not = icmp eq ptr %744, %743
...
while.body4746:                                   ; preds = %while.cond4740.preheader, %cond.end4808
  %745 = phi ptr [ %760, %cond.end4808 ], [ %728, %while.cond4740.preheader ]
  store ptr %745, ptr @xx_link, align 8, !tbaa !8
  %osucc4752 = getelementptr inbounds [2 x %struct.LIST], ptr %745, i64 0, i64 1, i32 1
  %746 = load ptr, ptr %osucc4752, align 8, !tbaa !5
  %cmp4753 = icmp eq ptr %746, %745
...
cond.false4756:                                   ; preds = %while.body4746
  ...
  %arrayidx4761 = getelementptr inbounds [2 x %struct.LIST], ptr %745, i64 0, i64 1
  %747 = load ptr, ptr %arrayidx4761, align 8, !tbaa !5
  %arrayidx4764 = getelementptr inbounds [2 x %struct.LIST], ptr %746, i64 0, i64 1
  store ptr %747, ptr %arrayidx4764, align 8, !tbaa !5
  %748 = load ptr, ptr %arrayidx4761, align 8, !tbaa !5
  %osucc4771 = getelementptr inbounds [2 x %struct.LIST], ptr %748, i64 0, i64 1, i32 1
  store ptr %746, ptr %osucc4771, align 8, !tbaa !5
  store ptr %745, ptr %osucc4752, align 8, !tbaa !5
  store ptr %745, ptr %arrayidx4761, align 8, !tbaa !5
  br label %cond.end4778

cond.end4778:                                     ; preds = %while.body4746, %cond.false4756
  store ptr %745, ptr @zz_hold, align 8, !tbaa !8
  %osucc4782 = getelementptr inbounds %struct.LIST, ptr %745, i64 0, i32 1
  %749 = load ptr, ptr %osucc4782, align 8, !tbaa !5
  %cmp4783 = icmp eq ptr %749, %745
...
cond.false4786:                                   ; preds = %cond.end4778
  ...
  %osucc4801 = getelementptr inbounds %struct.LIST, ptr %753, i64 0, i32 1
  store ptr %751, ptr %osucc4801, align 8, !tbaa !5
  %osucc4804 = getelementptr inbounds %struct.LIST, ptr %752, i64 0, i32 1
  store ptr %752, ptr %osucc4804, align 8, !tbaa !5
  store ptr %752, ptr %752, align 8, !tbaa !5
  %.pre6255 = load ptr, ptr @xx_link, align 8, !tbaa !8
  br label %cond.end4808

cond.end4808:                                     ; preds = %cond.end4778, %cond.false4786
  %754 = phi ptr [ %745, %cond.end4778 ], [ %.pre6255, %cond.false4786 ]
  store ptr %754, ptr @zz_hold, align 8, !tbaa !8
  %ou14810 = getelementptr inbounds %struct.word_type, ptr %754, i64 0, i32 1
  %755 = load i8, ptr %ou14810, align 8, !tbaa !5
  %.off5804 = add i8 %755, -11
  %switch5805 = icmp ult i8 %.off5804, 2
  %orec_size4823 = getelementptr inbounds %struct.word_type, ptr %754, i64 0, i32 1, i32 0, i32 1
  %idxprom4828 = zext i8 %755 to i64
  %arrayidx4829 = getelementptr inbounds [0 x i8], ptr @zz_lengths, i64 0, i64 %idxprom4828
  %cond4832.in.in = select i1 %switch5805, ptr %orec_size4823, ptr %arrayidx4829
  ...
  %756 = load ptr, ptr %arrayidx4834, align 8, !tbaa !8
  store ptr %756, ptr %754, align 8, !tbaa !5
  %757 = load ptr, ptr @zz_hold, align 8, !tbaa !8
  %758 = load i32, ptr @zz_size, align 4, !tbaa !16
  %idxprom4838 = sext i32 %758 to i64
  %arrayidx4839 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %idxprom4838
  store ptr %757, ptr %arrayidx4839, align 8, !tbaa !8
  %759 = load ptr, ptr @xx_hold, align 8, !tbaa !8
  %osucc4743 = getelementptr inbounds %struct.LIST, ptr %759, i64 0, i32 1
  %760 = load ptr, ptr %osucc4743, align 8, !tbaa !5
  %cmp4744.not = icmp eq ptr %760, %759
...
while.end4840:                                    ; preds = %cond.end4808, %while.cond4740.preheader
  %.lcssa5963 = phi ptr [ %727, %while.cond4740.preheader ], [ %759, %cond.end4808 ]
  store ptr %.lcssa5963, ptr @zz_hold, align 8, !tbaa !8
  %ou14841 = getelementptr inbounds %struct.word_type, ptr %.lcssa5963, i64 0, i32 1
  %761 = load i8, ptr %ou14841, align 8, !tbaa !5
  %.off5806 = add i8 %761, -11
  %switch5807 = icmp ult i8 %.off5806, 2
  %orec_size4854 = getelementptr inbounds %struct.word_type, ptr %.lcssa5963, i64 0, i32 1, i32 0, i32 1
  %idxprom4859 = zext i8 %761 to i64
  %arrayidx4860 = getelementptr inbounds [0 x i8], ptr @zz_lengths, i64 0, i64 %idxprom4859
  %cond4863.in.in = select i1 %switch5807, ptr %orec_size4854, ptr %arrayidx4860
  ...
  %762 = load ptr, ptr %arrayidx4865, align 8, !tbaa !8
  store ptr %762, ptr %.lcssa5963, align 8, !tbaa !5
  %763 = load ptr, ptr @zz_hold, align 8, !tbaa !8
  %764 = load i32, ptr @zz_size, align 4, !tbaa !16
  %idxprom4869 = sext i32 %764 to i64
  %arrayidx4870 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %idxprom4869
  store ptr %763, ptr %arrayidx4870, align 8, !tbaa !8
  br label %RESUME.backedge

land.lhs.true4877:                                ; preds = %if.end4625
  %onon_blocking4879 = getelementptr inbounds i8, ptr %724, i64 42
...
if.then4884:                                      ; preds = %land.lhs.true4877
  %osucc4887 = getelementptr inbounds %struct.LIST, ptr %724, i64 0, i32 1
  %765 = load ptr, ptr %osucc4887, align 8, !tbaa !5
  %cmp4888 = icmp eq ptr %765, %724
  br i1 %cmp4888, label %if.then4890, label %for.cond5130

if.then4890:                                      ; preds = %if.then4884
  store ptr %724, ptr @xx_hold, align 8, !tbaa !8
  %osucc48946041 = getelementptr inbounds [2 x %struct.LIST], ptr %724, i64 0, i64 1, i32 1
  %766 = load ptr, ptr %osucc48946041, align 8, !tbaa !5
  %cmp4895.not6042 = icmp eq ptr %766, %724
  br i1 %cmp4895.not6042, label %while.end5092, label %while.body4897

while.cond4992.preheader:                         ; preds = %cond.end4959
  %osucc49956043.phi.trans.insert = getelementptr inbounds %struct.LIST, ptr %781, i64 0, i32 1
  %.pre6252 = load ptr, ptr %osucc49956043.phi.trans.insert, align 8, !tbaa !5
  %cmp4996.not6044 = icmp eq ptr %.pre6252, %781
  br i1 %cmp4996.not6044, label %while.end5092, label %while.body4998

while.body4897:                                   ; preds = %if.then4890, %cond.end4959
  %767 = phi ptr [ %782, %cond.end4959 ], [ %766, %if.then4890 ]
  store ptr %767, ptr @xx_link, align 8, !tbaa !8
  %osucc4903 = getelementptr inbounds [2 x %struct.LIST], ptr %767, i64 0, i64 1, i32 1
  %768 = load ptr, ptr %osucc4903, align 8, !tbaa !5
  %cmp4904 = icmp eq ptr %768, %767
...
cond.false4907:                                   ; preds = %while.body4897
  ...
  %arrayidx4912 = getelementptr inbounds [2 x %struct.LIST], ptr %767, i64 0, i64 1
  %769 = load ptr, ptr %arrayidx4912, align 8, !tbaa !5
  %arrayidx4915 = getelementptr inbounds [2 x %struct.LIST], ptr %768, i64 0, i64 1
  store ptr %769, ptr %arrayidx4915, align 8, !tbaa !5
  %770 = load ptr, ptr %arrayidx4912, align 8, !tbaa !5
  %osucc4922 = getelementptr inbounds [2 x %struct.LIST], ptr %770, i64 0, i64 1, i32 1
  store ptr %768, ptr %osucc4922, align 8, !tbaa !5
  store ptr %767, ptr %osucc4903, align 8, !tbaa !5
  store ptr %767, ptr %arrayidx4912, align 8, !tbaa !5
  br label %cond.end4929

cond.end4929:                                     ; preds = %while.body4897, %cond.false4907
  store ptr %767, ptr @zz_hold, align 8, !tbaa !8
  %osucc4933 = getelementptr inbounds %struct.LIST, ptr %767, i64 0, i32 1
  %771 = load ptr, ptr %osucc4933, align 8, !tbaa !5
  %cmp4934 = icmp eq ptr %771, %767
...
cond.false4937:                                   ; preds = %cond.end4929
  ...
  %osucc4952 = getelementptr inbounds %struct.LIST, ptr %775, i64 0, i32 1
  store ptr %773, ptr %osucc4952, align 8, !tbaa !5
  %osucc4955 = getelementptr inbounds %struct.LIST, ptr %774, i64 0, i32 1
  store ptr %774, ptr %osucc4955, align 8, !tbaa !5
  store ptr %774, ptr %774, align 8, !tbaa !5
  %.pre6251 = load ptr, ptr @xx_link, align 8, !tbaa !8
  br label %cond.end4959

cond.end4959:                                     ; preds = %cond.end4929, %cond.false4937
  %776 = phi ptr [ %767, %cond.end4929 ], [ %.pre6251, %cond.false4937 ]
  store ptr %776, ptr @zz_hold, align 8, !tbaa !8
  %ou14961 = getelementptr inbounds %struct.word_type, ptr %776, i64 0, i32 1
  %777 = load i8, ptr %ou14961, align 8, !tbaa !5
  %.off5808 = add i8 %777, -11
  %switch5809 = icmp ult i8 %.off5808, 2
  %orec_size4974 = getelementptr inbounds %struct.word_type, ptr %776, i64 0, i32 1, i32 0, i32 1
  %idxprom4979 = zext i8 %777 to i64
  %arrayidx4980 = getelementptr inbounds [0 x i8], ptr @zz_lengths, i64 0, i64 %idxprom4979
  %cond4983.in.in = select i1 %switch5809, ptr %orec_size4974, ptr %arrayidx4980
  ...
  %778 = load ptr, ptr %arrayidx4985, align 8, !tbaa !8
  store ptr %778, ptr %776, align 8, !tbaa !5
  %779 = load ptr, ptr @zz_hold, align 8, !tbaa !8
  %780 = load i32, ptr @zz_size, align 4, !tbaa !16
  %idxprom4989 = sext i32 %780 to i64
  %arrayidx4990 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %idxprom4989
  store ptr %779, ptr %arrayidx4990, align 8, !tbaa !8
  %781 = load ptr, ptr @xx_hold, align 8, !tbaa !8
  %osucc4894 = getelementptr inbounds [2 x %struct.LIST], ptr %781, i64 0, i64 1, i32 1
  %782 = load ptr, ptr %osucc4894, align 8, !tbaa !5
  %cmp4895.not = icmp eq ptr %782, %781
...
while.body4998:                                   ; preds = %while.cond4992.preheader, %cond.end5060
  %783 = phi ptr [ %798, %cond.end5060 ], [ %.pre6252, %while.cond4992.preheader ]
  store ptr %783, ptr @xx_link, align 8, !tbaa !8
  %osucc5004 = getelementptr inbounds [2 x %struct.LIST], ptr %783, i64 0, i64 1, i32 1
  %784 = load ptr, ptr %osucc5004, align 8, !tbaa !5
  %cmp5005 = icmp eq ptr %784, %783
...
cond.false5008:                                   ; preds = %while.body4998
  ...
  %arrayidx5013 = getelementptr inbounds [2 x %struct.LIST], ptr %783, i64 0, i64 1
  %785 = load ptr, ptr %arrayidx5013, align 8, !tbaa !5
  %arrayidx5016 = getelementptr inbounds [2 x %struct.LIST], ptr %784, i64 0, i64 1
  store ptr %785, ptr %arrayidx5016, align 8, !tbaa !5
  %786 = load ptr, ptr %arrayidx5013, align 8, !tbaa !5
  %osucc5023 = getelementptr inbounds [2 x %struct.LIST], ptr %786, i64 0, i64 1, i32 1
  store ptr %784, ptr %osucc5023, align 8, !tbaa !5
  store ptr %783, ptr %osucc5004, align 8, !tbaa !5
  store ptr %783, ptr %arrayidx5013, align 8, !tbaa !5
  br label %cond.end5030

cond.end5030:                                     ; preds = %while.body4998, %cond.false5008
  store ptr %783, ptr @zz_hold, align 8, !tbaa !8
  %osucc5034 = getelementptr inbounds %struct.LIST, ptr %783, i64 0, i32 1
  %787 = load ptr, ptr %osucc5034, align 8, !tbaa !5
  %cmp5035 = icmp eq ptr %787, %783
  br i1 %cmp5035, label %cond.end5060, label %cond.false5038

cond.false5038:                                   ; preds = %cond.end5030
  store ptr %787, ptr @zz_res, align 8, !tbaa !8
  %788 = load ptr, ptr %783, align 8, !tbaa !5
  store ptr %788, ptr %787, align 8, !tbaa !5
  %789 = load ptr, ptr @zz_res, align 8, !tbaa !8
  %790 = load ptr, ptr @zz_hold, align 8, !tbaa !8
  %791 = load ptr, ptr %790, align 8, !tbaa !5
  %osucc5053 = getelementptr inbounds %struct.LIST, ptr %791, i64 0, i32 1
  store ptr %789, ptr %osucc5053, align 8, !tbaa !5
  %osucc5056 = getelementptr inbounds %struct.LIST, ptr %790, i64 0, i32 1
  store ptr %790, ptr %osucc5056, align 8, !tbaa !5
  store ptr %790, ptr %790, align 8, !tbaa !5
  %.pre6253 = load ptr, ptr @xx_link, align 8, !tbaa !8
  br label %cond.end5060

cond.end5060:                                     ; preds = %cond.end5030, %cond.false5038
  %792 = phi ptr [ %783, %cond.end5030 ], [ %.pre6253, %cond.false5038 ]
  store ptr %792, ptr @zz_hold, align 8, !tbaa !8
  %ou15062 = getelementptr inbounds %struct.word_type, ptr %792, i64 0, i32 1
  %793 = load i8, ptr %ou15062, align 8, !tbaa !5
  %.off5810 = add i8 %793, -11
  %switch5811 = icmp ult i8 %.off5810, 2
  %orec_size5075 = getelementptr inbounds %struct.word_type, ptr %792, i64 0, i32 1, i32 0, i32 1
  %idxprom5080 = zext i8 %793 to i64
  %arrayidx5081 = getelementptr inbounds [0 x i8], ptr @zz_lengths, i64 0, i64 %idxprom5080
  %cond5084.in.in = select i1 %switch5811, ptr %orec_size5075, ptr %arrayidx5081
  ...
  %794 = load ptr, ptr %arrayidx5086, align 8, !tbaa !8
  store ptr %794, ptr %792, align 8, !tbaa !5
  %795 = load ptr, ptr @zz_hold, align 8, !tbaa !8
  %796 = load i32, ptr @zz_size, align 4, !tbaa !16
  %idxprom5090 = sext i32 %796 to i64
  %arrayidx5091 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %idxprom5090
  store ptr %795, ptr %arrayidx5091, align 8, !tbaa !8
  %797 = load ptr, ptr @xx_hold, align 8, !tbaa !8
  %osucc4995 = getelementptr inbounds %struct.LIST, ptr %797, i64 0, i32 1
  %798 = load ptr, ptr %osucc4995, align 8, !tbaa !5
  %cmp4996.not = icmp eq ptr %798, %797
...
while.end5092:                                    ; preds = %cond.end5060, %if.then4890, %while.cond4992.preheader
  %.lcssa5962 = phi ptr [ %.pre6252, %while.cond4992.preheader ], [ %724, %if.then4890 ], [ %797, %cond.end5060 ]
  store ptr %.lcssa5962, ptr @zz_hold, align 8, !tbaa !8
  %ou15093 = getelementptr inbounds %struct.word_type, ptr %.lcssa5962, i64 0, i32 1
  %799 = load i8, ptr %ou15093, align 8, !tbaa !5
  %.off5812 = add i8 %799, -11
  %switch5813 = icmp ult i8 %.off5812, 2
  %orec_size5106 = getelementptr inbounds %struct.word_type, ptr %.lcssa5962, i64 0, i32 1, i32 0, i32 1
  %idxprom5111 = zext i8 %799 to i64
  %arrayidx5112 = getelementptr inbounds [0 x i8], ptr @zz_lengths, i64 0, i64 %idxprom5111
  %cond5115.in.in = select i1 %switch5813, ptr %orec_size5106, ptr %arrayidx5112
  ...
  %800 = load ptr, ptr %arrayidx5117, align 8, !tbaa !8
  store ptr %800, ptr %.lcssa5962, align 8, !tbaa !5
  %801 = load ptr, ptr @zz_hold, align 8, !tbaa !8
  %802 = load i32, ptr @zz_size, align 4, !tbaa !16
  %idxprom5121 = sext i32 %802 to i64
  %arrayidx5122 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %idxprom5121
  store ptr %801, ptr %arrayidx5122, align 8, !tbaa !8
  br label %RESUME.backedge
...
RESUME.backedge:                                  ; preds = %while.end5092, %if.end5147, %if.end184, %if.then187, %if.then64, %while.end2442, %if.end3968, %while.end4840, %for.end4598, %cleanup
  %stop_perp_back.0.be = phi i32 [ %stop_perp_back.4, %if.end3968 ], [ %stop_perp_back.4, %for.end4598 ], [ %stop_perp_back.4, %while.end4840 ], [ %stop_perp_back.15985, %cleanup ], [ %stop_perp_back.15985, %while.end2442 ], [ %stop_perp_back.0, %if.then64 ], [ %stop_perp_back.0, %if.then187 ], [ %stop_perp_back.0, %if.end184 ], [ %stop_perp_back.4, %if.end5147 ], [ %stop_perp_back.4, %while.end5092 ]
  %stop_perp_fwd.0.be = phi i32 [ %stop_perp_fwd.4, %if.end3968 ], [ %stop_perp_fwd.4, %for.end4598 ], [ %stop_perp_fwd.4, %while.end4840 ], [ %stop_perp_fwd.15986, %cleanup ], [ %stop_perp_fwd.15986, %while.end2442 ], [ %stop_perp_fwd.0, %if.then64 ], [ %stop_perp_fwd.0, %if.then187 ], [ %stop_perp_fwd.0, %if.end184 ], [ %stop_perp_fwd.4, %if.end5147 ], [ %stop_perp_fwd.4, %while.end5092 ]
  ...
  %stop_fwd.0.be = phi i32 [ %stop_fwd.4, %if.end3968 ], [ %stop_fwd.4, %for.end4598 ], [ %stop_fwd.4, %while.end4840 ], [ %stop_fwd.15988, %cleanup ], [ %stop_fwd.15988, %while.end2442 ], [ %stop_fwd.0, %if.then64 ], [ %stop_fwd.0, %if.then187 ], [ %stop_fwd.0, %if.end184 ], [ %stop_fwd.4, %if.end5147 ], [ %stop_fwd.4, %while.end5092 ]
  %stop_back.0.be = phi i32 [ %stop_back.4, %if.end3968 ], [ %stop_back.4, %for.end4598 ], [ %stop_back.4, %while.end4840 ], [ %stop_back.15990, %cleanup ], [ %stop_back.15990, %while.end2442 ], [ %stop_back.0, %if.then64 ], [ %stop_back.0, %if.then187 ], [ %stop_back.0, %if.end184 ], [ %stop_back.4, %if.end5147 ], [ %stop_back.4, %while.end5092 ]
  ...
  %need_adjust.0.be = phi i32 [ %need_adjust.4, %if.end3968 ], [ %need_adjust.4, %for.end4598 ], [ %need_adjust.4, %while.end4840 ], [ %need_adjust.2, %cleanup ], [ %need_adjust.16002, %while.end2442 ], [ %need_adjust.0, %if.then64 ], [ %need_adjust.0, %if.then187 ], [ %need_adjust.0, %if.end184 ], [ %need_adjust.4, %if.end5147 ], [ %need_adjust.4, %while.end5092 ]
...
for.cond5130:                                     ; preds = %if.then4884, %for.cond5130
  %.pn5731 = phi ptr [ %z.1, %for.cond5130 ], [ %765, %if.then4884 ]
  %z.1.in = getelementptr inbounds [2 x %struct.LIST], ptr %.pn5731, i64 0, i64 1
  %z.1 = load ptr, ptr %z.1.in, align 8, !tbaa !5
  %ou15131 = getelementptr inbounds %struct.word_type, ptr %z.1, i64 0, i32 1
  %803 = load i8, ptr %ou15131, align 8, !tbaa !5
  %cmp5134 = icmp eq i8 %803, 0
...
for.end5141:                                      ; preds = %for.cond5130
  ...
  %804 = load ptr, ptr %oopt_components5142, align 8, !tbaa !5
  %cmp5143.not = icmp eq ptr %804, null
  br i1 %cmp5143.not, label %if.end5147, label %if.then5145

if.then5145:                                      ; preds = %for.end5141
  %oactual5146 = getelementptr inbounds %struct.closure_type, ptr %724, i64 0, i32 5
  %805 = load ptr, ptr %oactual5146, align 8, !tbaa !5
  call void @GazumpOptimize(ptr noundef nonnull %z.1, ptr noundef %805) #6
  br label %if.end5147
...
if.end5150:                                       ; preds = %land.lhs.true4631, %land.lhs.true4877, %if.end4625.if.end5150_crit_edge
  %806 = phi ptr [ %724, %if.end4625.if.end5150_crit_edge ], [ %724, %land.lhs.true4877 ], [ %725, %land.lhs.true4631 ]
  ...
  %oblocked5152 = getelementptr inbounds i8, ptr %806, i64 42
  %bf.set5155 = or i16 %bf.load5153, 32
  store i16 %bf.set5155, ptr %oblocked5152, align 2
  %tobool.i5713.not = icmp eq i32 %prnt_flush.7, 0
  br i1 %tobool.i5713.not, label %cleanup5156, label %if.then.i5716

if.then.i5716:                                    ; preds = %if.end5150
  %osucc.i5715 = getelementptr inbounds [2 x %struct.LIST], ptr %dest_index.3, i64 0, i64 1, i32 1
  %807 = load ptr, ptr %osucc.i5715, align 8, !tbaa !5
  br label %for.cond.i5721

for.cond.i5721:                                   ; preds = %for.cond.i5721, %if.then.i5716
  %prnt.0.i5717.in = phi ptr [ %807, %if.then.i5716 ], [ %prnt.0.i5717, %for.cond.i5721 ]
  %prnt.0.i5717 = load ptr, ptr %prnt.0.i5717.in, align 8, !tbaa !5
  %ou1.i5718 = getelementptr inbounds %struct.word_type, ptr %prnt.0.i5717, i64 0, i32 1
  %808 = load i8, ptr %ou1.i5718, align 8, !tbaa !5
  %cmp.i5720 = icmp eq i8 %808, 0
  br i1 %cmp.i5720, label %for.cond.i5721, label %for.end.i5723, !llvm.loop !12

for.end.i5723:                                    ; preds = %for.cond.i5721
  call void @FlushGalley(ptr noundef nonnull %prnt.0.i5717)
  br label %cleanup5156

cleanup5156:                                      ; preds = %for.cond, %for.end.i5723, %if.end5150, %for.end.i5710, %if.then195, %if.then126, %if.else127, %ParentFlush.exit5699, %if.then58, %ParentFlush.exit, %if.then52, %sw.bb43, %if.then46, %if.end1940
...
cond.false:                                       ; preds = %while.body
  ...
  %6 = load ptr, ptr %arrayidx18, align 8, !tbaa !5
...
cond.false116:                                    ; preds = %while.body106
  %arrayidx111 = getelementptr inbounds [2 x %struct.LIST], ptr %20, i64 0, i64 1
  store ptr %21, ptr @zz_res, align 8, !tbaa !8
  %22 = load ptr, ptr %arrayidx111, align 8, !tbaa !5
  %arrayidx124 = getelementptr inbounds [2 x %struct.LIST], ptr %21, i64 0, i64 1
  store ptr %22, ptr %arrayidx124, align 8, !tbaa !5
  %23 = load ptr, ptr %arrayidx111, align 8, !tbaa !5
  ...
  store ptr %20, ptr %arrayidx111, align 8, !tbaa !5
...
cond.false249:                                    ; preds = %while.body239
  %arrayidx244 = getelementptr inbounds [2 x %struct.LIST], ptr %43, i64 0, i64 1
  store ptr %44, ptr @zz_res, align 8, !tbaa !8
  %45 = load ptr, ptr %arrayidx244, align 8, !tbaa !5
  %arrayidx257 = getelementptr inbounds [2 x %struct.LIST], ptr %44, i64 0, i64 1
  store ptr %45, ptr %arrayidx257, align 8, !tbaa !5
  %46 = load ptr, ptr %arrayidx244, align 8, !tbaa !5
  ...
  store ptr %43, ptr %arrayidx244, align 8, !tbaa !5
...
cond.false350:                                    ; preds = %while.body340
  %arrayidx345 = getelementptr inbounds [2 x %struct.LIST], ptr %59, i64 0, i64 1
  store ptr %60, ptr @zz_res, align 8, !tbaa !8
  %61 = load ptr, ptr %arrayidx345, align 8, !tbaa !5
  %arrayidx358 = getelementptr inbounds [2 x %struct.LIST], ptr %60, i64 0, i64 1
  store ptr %61, ptr %arrayidx358, align 8, !tbaa !5
  %62 = load ptr, ptr %arrayidx345, align 8, !tbaa !5
  ...
  store ptr %59, ptr %arrayidx345, align 8, !tbaa !5
