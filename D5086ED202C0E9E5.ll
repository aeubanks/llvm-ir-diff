...
entry:
  %__dnew.i.i.i46 = alloca i64, align 8
...
if.end.i:                                         ; preds = %if.end4
  %call.i.i38 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %1) #15
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %__dnew.i.i) #15
  store i64 %call.i.i38, ptr %__dnew.i.i, align 8, !tbaa !13
  %cmp.i.i = icmp ugt i64 %call.i.i38, 15
  br i1 %cmp.i.i, label %if.then.i.i, label %if.end.i.i

if.then.i.i:                                      ; preds = %if.end.i
  %call2.i9.i39 = invoke noundef ptr @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE9_M_createERmm(ptr noundef nonnull align 8 dereferenceable(32) %probname, ptr noundef nonnull align 8 dereferenceable(8) %__dnew.i.i, i64 noundef 0)
          to label %call2.i9.i.noexc unwind label %lpad

call2.i9.i.noexc:                                 ; preds = %if.then.i.i
  store ptr %call2.i9.i39, ptr %probname, align 8, !tbaa !15
  %3 = load i64, ptr %__dnew.i.i, align 8, !tbaa !13
  store i64 %3, ptr %2, align 8, !tbaa !17
  br label %if.end.i.i

if.end.i.i:                                       ; preds = %call2.i9.i.noexc, %if.end.i
  %4 = phi ptr [ %call2.i9.i39, %call2.i9.i.noexc ], [ %2, %if.end.i ]
  switch i64 %call.i.i38, label %if.end.i.i.i.i.i [
...
if.end.i.i.i.i.i:                                 ; preds = %if.end.i.i
  call void @llvm.memcpy.p0.p0.i64(ptr align 1 %4, ptr nonnull align 1 %1, i64 %call.i.i38, i1 false)
  br label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC2IS3_EEPKcRKS3_.exit
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC2IS3_EEPKcRKS3_.exit: ; preds = %if.end.i.i, %if.then.i.i.i.i, %if.end.i.i.i.i.i
  ...
  %cmp.i.i40 = icmp ult i64 %8, %conv7
  br i1 %cmp.i.i40, label %if.then.i.i41, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE8_M_checkEmPKc.exit.i

if.then.i.i41:                                    ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC2IS3_EEPKcRKS3_.exit
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE8_M_checkEmPKc.exit.i: ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC2IS3_EEPKcRKS3_.exit
  ...
  %__off.sub.i.i.i = call i64 @llvm.umin.i64(i64 %sub.i.i.i, i64 4)
  switch i64 %__off.sub.i.i.i, label %if.end.i.i.i.i.i.i [
    i64 1, label %if.then.i.i.i.i.i
    i64 0, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6substrEmm.exit
  ]

if.then.i.i.i.i.i:                                ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE8_M_checkEmPKc.exit.i
  %11 = load i8, ptr %add.ptr.i.i, align 1, !tbaa !17
  store i8 %11, ptr %9, align 8, !tbaa !17
  br label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6substrEmm.exit

if.end.i.i.i.i.i.i:                               ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE8_M_checkEmPKc.exit.i
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 8 %9, ptr align 1 %add.ptr.i.i, i64 %__off.sub.i.i.i, i1 false)
  br label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6substrEmm.exit

_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6substrEmm.exit: ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE8_M_checkEmPKc.exit.i, %if.then.i.i.i.i.i, %if.end.i.i.i.i.i.i
  %_M_string_length.i.i.i.i.i = getelementptr inbounds %"class.std::__cxx11::basic_string", ptr %ref.tmp6, i64 0, i32 1
  store i64 %__off.sub.i.i.i, ptr %_M_string_length.i.i.i.i.i, align 8, !tbaa !18, !alias.scope !19
  %arrayidx.i.i.i.i = getelementptr inbounds i8, ptr %9, i64 %__off.sub.i.i.i
  store i8 0, ptr %arrayidx.i.i.i.i, align 1, !tbaa !17
  %call.i43 = call noundef i32 @_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE7compareEPKc(ptr noundef nonnull align 8 dereferenceable(32) %ref.tmp6, ptr noundef nonnull @.str.1) #15
...
if.then.i.i45:                                    ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6substrEmm.exit
  call void @_ZdlPv(ptr noundef %12) #17
  br label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit

_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit: ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6substrEmm.exit, %if.then.i.i45
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %ref.tmp6) #15
  br i1 %cmp.i44, label %if.then13, label %if.end21
...
if.then13:                                        ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit
  ...
  %__off.sub.i.i.i48 = call i64 @llvm.umin.i64(i64 %13, i64 %conv7)
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %__dnew.i.i.i46) #15, !noalias !22
  store i64 %__off.sub.i.i.i48, ptr %__dnew.i.i.i46, align 8, !tbaa !13, !noalias !22
  %cmp.i15.i.i = icmp ugt i64 %__off.sub.i.i.i48, 15
  br i1 %cmp.i15.i.i, label %if.then.i16.i.i, label %if.end.i.i.i

if.then.i16.i.i:                                  ; preds = %if.then13
  %call2.i17.i.i54 = invoke noundef ptr @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE9_M_createERmm(ptr noundef nonnull align 8 dereferenceable(32) %ref.tmp14, ptr noundef nonnull align 8 dereferenceable(8) %__dnew.i.i.i46, i64 noundef 0)
          to label %call2.i17.i.i.noexc unwind label %lpad17

call2.i17.i.i.noexc:                              ; preds = %if.then.i16.i.i
  store ptr %call2.i17.i.i54, ptr %ref.tmp14, align 8, !tbaa !15, !alias.scope !22
  %16 = load i64, ptr %__dnew.i.i.i46, align 8, !tbaa !13, !noalias !22
  store i64 %16, ptr %14, align 8, !tbaa !17, !alias.scope !22
  br label %if.end.i.i.i

if.end.i.i.i:                                     ; preds = %call2.i17.i.i.noexc, %if.then13
  %17 = phi ptr [ %call2.i17.i.i54, %call2.i17.i.i.noexc ], [ %14, %if.then13 ]
  switch i64 %__off.sub.i.i.i48, label %if.end.i.i.i.i.i.i51 [
    i64 1, label %if.then.i.i.i.i.i50
    i64 0, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6substrEmm.exit55
  ]

if.then.i.i.i.i.i50:                              ; preds = %if.end.i.i.i
...
if.end.i.i.i.i.i.i51:                             ; preds = %if.end.i.i.i
  call void @llvm.memcpy.p0.p0.i64(ptr align 1 %17, ptr align 1 %15, i64 %__off.sub.i.i.i48, i1 false)
  br label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6substrEmm.exit55

_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6substrEmm.exit55: ; preds = %if.end.i.i.i, %if.then.i.i.i.i.i50, %if.end.i.i.i.i.i.i51
  %19 = load i64, ptr %__dnew.i.i.i46, align 8, !tbaa !13, !noalias !22
  %_M_string_length.i.i.i.i.i52 = getelementptr inbounds %"class.std::__cxx11::basic_string", ptr %ref.tmp14, i64 0, i32 1
  store i64 %19, ptr %_M_string_length.i.i.i.i.i52, align 8, !tbaa !18, !alias.scope !22
  %20 = load ptr, ptr %ref.tmp14, align 8, !tbaa !15, !alias.scope !22
  %arrayidx.i.i.i.i53 = getelementptr inbounds i8, ptr %20, i64 %19
  store i8 0, ptr %arrayidx.i.i.i.i53, align 1, !tbaa !17
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %__dnew.i.i.i46) #15, !noalias !22
  %21 = load ptr, ptr %ref.tmp14, align 8, !tbaa !15
  %cmp.i56.i = icmp eq ptr %21, %14
  br i1 %cmp.i56.i, label %if.then15.i, label %if.else.i

if.then15.i:                                      ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6substrEmm.exit55
  %22 = load i64, ptr %_M_string_length.i.i.i.i.i52, align 8, !tbaa !18
...
if.then19.i:                                      ; preds = %if.then15.i
  ...
  br i1 %cond.i, label %if.then.i.i56, label %if.end.i.i.i57

if.then.i.i56:                                    ; preds = %if.then19.i
  %24 = load i8, ptr %14, align 8, !tbaa !17
  store i8 %24, ptr %23, align 1, !tbaa !17
  br label %if.end24.i

if.end.i.i.i57:                                   ; preds = %if.then19.i
  call void @llvm.memcpy.p0.p0.i64(ptr align 1 %23, ptr nonnull align 8 %14, i64 %22, i1 false)
  br label %if.end24.i

if.end24.i:                                       ; preds = %if.end.i.i.i57, %if.then.i.i56, %if.then15.i
  %25 = load i64, ptr %_M_string_length.i.i.i.i.i52, align 8, !tbaa !18
...
if.else.i:                                        ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6substrEmm.exit55
  %27 = load ptr, ptr %probname, align 8, !tbaa !15
  %cmp.i60.i = icmp eq ptr %27, %2
  %28 = load i64, ptr %2, align 8
  store ptr %21, ptr %probname, align 8, !tbaa !15
  %29 = load <2 x i64>, ptr %_M_string_length.i.i.i.i.i52, align 8, !tbaa !17
  store <2 x i64> %29, ptr %_M_string_length.i.i.i.i, align 8, !tbaa !17
  %tobool35.not63.i = icmp eq ptr %27, null
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSEOS4_.exit: ; preds = %if.end24.i, %if.then36.i, %if.else37.i
  %30 = phi ptr [ %27, %if.then36.i ], [ %14, %if.else37.i ], [ %.pre.i, %if.end24.i ]
  store i64 0, ptr %_M_string_length.i.i.i.i.i52, align 8, !tbaa !18
  store i8 0, ptr %30, align 1, !tbaa !17
  %31 = load ptr, ptr %ref.tmp14, align 8, !tbaa !15
  %cmp.i.i.i59 = icmp eq ptr %31, %14
  br i1 %cmp.i.i.i59, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit61, label %if.then.i.i60

if.then.i.i60:                                    ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSEOS4_.exit
  call void @_ZdlPv(ptr noundef %31) #17
  br label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit61

_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit61: ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSEOS4_.exit, %if.then.i.i60
...
if.end21:                                         ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit61, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit
...
invoke.cont26:                                    ; preds = %invoke.cont25
  ...
  %35 = load ptr, ptr %probname, align 8, !tbaa !15
  %cmp.i.i.i62 = icmp eq ptr %35, %2
  br i1 %cmp.i.i.i62, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit64, label %if.then.i.i63

if.then.i.i63:                                    ; preds = %invoke.cont26
  call void @_ZdlPv(ptr noundef %35) #17
  br label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit64

_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit64: ; preds = %invoke.cont26, %if.then.i.i63
...
ehcleanup28:                                      ; preds = %lpad24, %lpad22
  %.pn = phi { ptr, i32 } [ %37, %lpad24 ], [ %36, %lpad22 ]
  call void @llvm.lifetime.end.p0(i64 192, ptr nonnull %drv) #15
  br label %ehcleanup29

ehcleanup29:                                      ; preds = %ehcleanup28, %lpad17, %lpad8
  %.pn.pn = phi { ptr, i32 } [ %.pn, %ehcleanup28 ], [ %34, %lpad17 ], [ %33, %lpad8 ]
  %38 = load ptr, ptr %probname, align 8, !tbaa !15
  %cmp.i.i.i65 = icmp eq ptr %38, %2
  br i1 %cmp.i.i.i65, label %ehcleanup31, label %if.then.i.i66

if.then.i.i66:                                    ; preds = %ehcleanup29
  call void @_ZdlPv(ptr noundef %38) #17
  br label %ehcleanup31

ehcleanup31:                                      ; preds = %if.then.i.i66, %ehcleanup29, %lpad
  %.pn.pn.pn = phi { ptr, i32 } [ %32, %lpad ], [ %.pn.pn, %ehcleanup29 ], [ %.pn.pn, %if.then.i.i66 ]
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %probname) #15
  call void @_ZN9InputFileD1Ev(ptr noundef nonnull align 8 dereferenceable(48) %inp) #15
  call void @llvm.lifetime.end.p0(i64 48, ptr nonnull %inp) #15
