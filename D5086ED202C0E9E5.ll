...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC2IS3_EEPKcRKS3_.exit: ; preds = %if.end.i.i, %if.then.i.i.i.i, %if.end.i.i.i.i.i
  ...
  br i1 %cmp.i.i40, label %if.then.i.i41, label %invoke.cont4.i.i
...
invoke.cont4.i.i:                                 ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC2IS3_EEPKcRKS3_.exit
  ...
  %cond.i.i.i = call i64 @llvm.umin.i64(i64 %sub.i.i.i, i64 4)
...
if.end.i.i.i.i.i.i:                               ; preds = %invoke.cont4.i.i
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 8 %9, ptr align 1 %add.ptr.i.i, i64 %cond.i.i.i, i1 false)
  br label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6substrEmm.exit

_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6substrEmm.exit: ; preds = %invoke.cont4.i.i, %if.then.i.i.i.i.i, %if.end.i.i.i.i.i.i
  %_M_string_length.i.i.i.i.i = getelementptr inbounds %"class.std::__cxx11::basic_string", ptr %ref.tmp6, i64 0, i32 1
  store i64 %cond.i.i.i, ptr %_M_string_length.i.i.i.i.i, align 8, !tbaa !18, !alias.scope !19
  %arrayidx.i.i.i.i = getelementptr inbounds i8, ptr %9, i64 %cond.i.i.i
...
if.then13:                                        ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit
  ...
  %13 = load i64, ptr %_M_string_length.i.i.i.i, align 8, !noalias !22
  ...
  %cond.i.i.i48 = call i64 @llvm.umin.i64(i64 %13, i64 %conv7)
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %__dnew.i.i.i46) #15, !noalias !22
  store i64 %cond.i.i.i48, ptr %__dnew.i.i.i46, align 8, !tbaa !13, !noalias !22
  %cmp.i15.i.i = icmp ugt i64 %cond.i.i.i48, 15
...
if.end.i.i.i:                                     ; preds = %call2.i17.i.i.noexc, %if.then13
  ...
  switch i64 %cond.i.i.i48, label %if.end.i.i.i.i.i.i51 [
...
if.end.i.i.i.i.i.i51:                             ; preds = %if.end.i.i.i
  call void @llvm.memcpy.p0.p0.i64(ptr align 1 %17, ptr align 1 %15, i64 %cond.i.i.i48, i1 false)
  br label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6substrEmm.exit55
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6substrEmm.exit55: ; preds = %if.end.i.i.i, %if.then.i.i.i.i.i50, %if.end.i.i.i.i.i.i51
  ...
  %21 = load ptr, ptr %probname, align 8
  %22 = load ptr, ptr %ref.tmp14, align 8, !tbaa !15
...
if.then15.i:                                      ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6substrEmm.exit55
  %23 = load i64, ptr %_M_string_length.i.i.i.i.i52, align 8, !tbaa !18
  switch i64 %23, label %if.end.i.i.i57 [
    i64 0, label %if.end24.i
    i64 1, label %if.then.i.i56
  ]

if.then.i.i56:                                    ; preds = %if.then15.i
  %24 = load i8, ptr %14, align 8, !tbaa !17
  store i8 %24, ptr %21, align 1, !tbaa !17
  br label %if.end24.i

if.end.i.i.i57:                                   ; preds = %if.then15.i
  call void @llvm.memcpy.p0.p0.i64(ptr align 1 %21, ptr nonnull align 8 %14, i64 %23, i1 false)
  br label %if.end24.i
...
invoke.cont28.i:                                  ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6substrEmm.exit55
  %cmp.i60.i = icmp eq ptr %21, %2
  %27 = load i64, ptr %2, align 8
  store ptr %22, ptr %probname, align 8, !tbaa !15
  %28 = load <2 x i64>, ptr %_M_string_length.i.i.i.i.i52, align 8, !tbaa !17
  store <2 x i64> %28, ptr %_M_string_length.i.i.i.i, align 8, !tbaa !17
  %tobool35.not63.i = icmp eq ptr %21, null
  %tobool35.not.i = or i1 %cmp.i60.i, %tobool35.not63.i
  br i1 %tobool35.not.i, label %if.else37.i, label %if.then36.i

if.then36.i:                                      ; preds = %invoke.cont28.i
  store ptr %21, ptr %ref.tmp14, align 8, !tbaa !15
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSEOS4_.exit: ; preds = %if.end24.i, %if.then36.i, %if.else37.i
  %29 = phi ptr [ %21, %if.then36.i ], [ %14, %if.else37.i ], [ %.pre.i, %if.end24.i ]
  store i64 0, ptr %_M_string_length.i.i.i.i.i52, align 8, !tbaa !18
  store i8 0, ptr %29, align 1, !tbaa !17
  %30 = load ptr, ptr %ref.tmp14, align 8, !tbaa !15
  %cmp.i.i.i59 = icmp eq ptr %30, %14
...
invoke.cont26:                                    ; preds = %invoke.cont25
  ...
  %34 = load ptr, ptr %probname, align 8, !tbaa !15
  %cmp.i.i.i62 = icmp eq ptr %34, %2
...
ehcleanup29:                                      ; preds = %ehcleanup28, %lpad17, %lpad8
  %.pn.pn = phi { ptr, i32 } [ %.pn, %ehcleanup28 ], [ %33, %lpad17 ], [ %32, %lpad8 ]
  %37 = load ptr, ptr %probname, align 8, !tbaa !15
  %cmp.i.i.i65 = icmp eq ptr %37, %2
...
ehcleanup31:                                      ; preds = %if.then.i.i66, %ehcleanup29, %lpad
  %.pn.pn.pn = phi { ptr, i32 } [ %31, %lpad ], [ %.pn.pn, %ehcleanup29 ], [ %.pn.pn, %if.then.i.i66 ]
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %probname) #15
  call void @_ZN9InputFileD1Ev(ptr noundef nonnull align 8 dereferenceable(48) %inp) #15
  call void @llvm.lifetime.end.p0(i64 48, ptr nonnull %inp) #15
