...
"for result$1.s0.i":                              ; preds = %"for result$1.s0.i.preheader", %"end for result$1.s0.n1"
  ...
  %"fwd_fft0_S1_R8_n0$1.0.value.x4" = shufflevector <4 x float> %1029, <4 x float> undef, <4 x i32> <i32 3, i32 2, i32 1, i32 0>
  ...
  %1037 = fmul <4 x float> %"fwd_fft0_S1_R8_n0$1.1.value.s.x4", <float 5.000000e-01, float 5.000000e-01, float 5.000000e-01, float 5.000000e-01>
  store <4 x float> %1037, ptr %491, align 4, !tbaa !531
  %"fwd_fft0_S1_R8_n0$1.0.value.x490" = shufflevector <4 x float> %1036, <4 x float> undef, <4 x i32> <i32 3, i32 2, i32 1, i32 0>
  %1038 = fsub <4 x float> zeroinitializer, %1037
  %"fwd_fft0_S1_R8_n0$1.1.value.x491" = shufflevector <4 x float> %1038, <4 x float> poison, <4 x i32> <i32 3, i32 2, i32 1, i32 0>
  store <4 x float> %"fwd_fft0_S1_R8_n0$1.0.value.x490", ptr %267, align 16, !tbaa !47
  store <4 x float> %"fwd_fft0_S1_R8_n0$1.1.value.x491", ptr %388, align 16, !tbaa !491
...
"assert failed94":                                ; preds = %"assert succeeded93"
  %1049 = tail call i32 @halide_error_explicit_bounds_too_small(ptr null, ptr nonnull @str.13, ptr nonnull @str.12, i32 0, i32 7, i32 %84, i32 %b16) #2
  br label %destructor_block
...
"for result$1.s0.n1":                             ; preds = %"for result$1.s0.n1.preheader", %"end for result$1.s0.n0.n0107"
  %indvars.iv243 = phi i64 [ %765, %"for result$1.s0.n1.preheader" ], [ %indvars.iv.next244, %"end for result$1.s0.n0.n0107" ]
  br i1 %760, label %"for result$1.s0.n0.n0.preheader", label %"end for result$1.s0.n0.n0", !prof !26
...
"for result$1.s0.n0.n0.preheader":                ; preds = %"for result$1.s0.n1"
  ...
  br i1 %773, label %"end for result$1.s0.n0.n0.loopexit.unr-lcssa", label %"for result$1.s0.n0.n0"
...
"end for result$1.s0.n0.n0":                      ; preds = %"for result$1.s0.n0.n0.epil", %"end for result$1.s0.n0.n0.loopexit.unr-lcssa", %"for result$1.s0.n1"
  br i1 %763, label %"for result$1.s0.n0.n0106.preheader", label %"end for result$1.s0.n0.n0107", !prof !26
...
!443 = !{!444, !444, i64 0}
!444 = !{!"fwd_X8$2.0.width1.base3", !445, i64 0}
!445 = !{!"fwd_X8$2.0.width2.base2", !446, i64 0}
!446 = !{!"fwd_X8$2.0.width4.base0", !447, i64 0}
!447 = !{!"fwd_X8$2.0.width8.base0", !448, i64 0}
!448 = !{!"fwd_X8$2.0.width16.base0", !354, i64 0}
!449 = !{!450, !450, i64 0}
!450 = !{!"fwd_X8$2.0.width1.base1", !451, i64 0}
!451 = !{!"fwd_X8$2.0.width2.base0", !446, i64 0}
!452 = !{!453, !453, i64 0}
!453 = !{!"fwd_X8$2.0.width1.base2", !445, i64 0}
!454 = !{!455, !455, i64 0}
!455 = !{!"fwd_X8$2.0.width1.base0", !451, i64 0}
!456 = !{!457, !457, i64 0}
!457 = !{!"fwd_X8$2.0.width1.base7", !458, i64 0}
!458 = !{!"fwd_X8$2.0.width2.base6", !459, i64 0}
!459 = !{!"fwd_X8$2.0.width4.base4", !447, i64 0}
!460 = !{!461, !461, i64 0}
!461 = !{!"fwd_X8$2.0.width1.base5", !462, i64 0}
!462 = !{!"fwd_X8$2.0.width2.base4", !459, i64 0}
!463 = !{!464, !464, i64 0}
!464 = !{!"fwd_X8$2.0.width1.base6", !458, i64 0}
!465 = !{!466, !466, i64 0}
!466 = !{!"fwd_X8$2.0.width1.base4", !462, i64 0}
!467 = !{!468, !468, i64 0}
!468 = !{!"fwd_X8$2.0.width1.base8", !469, i64 0}
!469 = !{!"fwd_X8$2.0.width2.base8", !470, i64 0}
!470 = !{!"fwd_X8$2.0.width4.base8", !471, i64 0}
!471 = !{!"fwd_X8$2.0.width8.base8", !448, i64 0}
!472 = !{!473, !473, i64 0}
!473 = !{!"fwd_X8$2.0.width1.base9", !469, i64 0}
!474 = !{!475, !475, i64 0}
!475 = !{!"fwd_X8$2.0.width1.base10", !476, i64 0}
!476 = !{!"fwd_X8$2.0.width2.base10", !470, i64 0}
!477 = !{!478, !478, i64 0}
!478 = !{!"fwd_X8$2.0.width1.base11", !476, i64 0}
!479 = !{!201, !201, i64 0}
!480 = !{!481, !481, i64 0}
!481 = !{!"fwd_X8$2.0.width1.base12", !482, i64 0}
!482 = !{!"fwd_X8$2.0.width2.base12", !483, i64 0}
!483 = !{!"fwd_X8$2.0.width4.base12", !471, i64 0}
!484 = !{!485, !485, i64 0}
!485 = !{!"fwd_X8$2.0.width1.base13", !482, i64 0}
!486 = !{!487, !487, i64 0}
!487 = !{!"fwd_X8$2.0.width1.base14", !488, i64 0}
!488 = !{!"fwd_X8$2.0.width2.base14", !483, i64 0}
!489 = !{!490, !490, i64 0}
!490 = !{!"fwd_X8$2.0.width1.base15", !488, i64 0}
!491 = !{!164, !164, i64 0}
!492 = !{!73, !73, i64 0}
!493 = !{!494, !494, i64 0}
!494 = !{!"fwd_X8$2.1.width2.base8", !394, i64 0}
!495 = !{!496, !496, i64 0}
!496 = !{!"kernel_fft1_S1_R8_n1$1.1.width2.base8", !138, i64 0}
!497 = !{!498, !498, i64 0}
!498 = !{!"fwd_X8$2.1.width2.base10", !394, i64 0}
!499 = !{!500, !500, i64 0}
!500 = !{!"kernel_fft1_S1_R8_n1$1.1.width2.base10", !138, i64 0}
!501 = !{!502, !502, i64 0}
!502 = !{!"fwd_X8$2.1.width2.base6", !391, i64 0}
!503 = !{!504, !504, i64 0}
!504 = !{!"kernel_fft1_S1_R8_n1$1.1.width2.base6", !136, i64 0}
!505 = !{!506, !506, i64 0}
!506 = !{!"fwd_X8$2.1.width2.base4", !391, i64 0}
!507 = !{!508, !508, i64 0}
!508 = !{!"kernel_fft1_S1_R8_n1$1.1.width2.base4", !136, i64 0}
!509 = !{!510, !510, i64 0}
!510 = !{!"fwd_X8$2.1.width2.base12", !387, i64 0}
!511 = !{!512, !512, i64 0}
!512 = !{!"kernel_fft1_S1_R8_n1$1.1.width2.base12", !141, i64 0}
!513 = !{!514, !514, i64 0}
!514 = !{!"fwd_X8$2.1.width2.base14", !387, i64 0}
!515 = !{!516, !516, i64 0}
!516 = !{!"kernel_fft1_S1_R8_n1$1.1.width2.base14", !141, i64 0}
!517 = !{!518, !518, i64 0}
!518 = !{!"fwd_X8$2.1.width2.base2", !396, i64 0}
!519 = !{!520, !520, i64 0}
!520 = !{!"kernel_fft1_S1_R8_n1$1.1.width2.base2", !125, i64 0}
!521 = !{!522, !522, i64 0}
!522 = !{!"fwd_X8$2.1.width2.base0", !396, i64 0}
!523 = !{!524, !524, i64 0}
!524 = !{!"kernel_fft1_S1_R8_n1$1.1.width2.base0", !125, i64 0}
!525 = !{!526, !526, i64 0}
!526 = !{!"k$1.width1.base32", !527, i64 0}
!527 = !{!"k$1.width2.base32", !43, i64 0}
!528 = !{!529, !529, i64 0}
!529 = !{!"kernel_X8$2.0.width1.base32", !530, i64 0}
!530 = !{!"kernel_X8$2.0.width2.base32", !102, i64 0}
!531 = !{!165, !165, i64 0}
!532 = !{!44, !44, i64 0}
!533 = !{!34, !34, i64 0}
!534 = !{!103, !103, i64 0}
!535 = !{!204, !204, i64 0}
!536 = !{!537, !537, i64 0}
!537 = !{!"k$1.width1.base33", !527, i64 0}
!538 = !{!539, !539, i64 0}
...
!580 = !{!581, !581, i64 0}
!581 = !{!"kernel_X8$2.0.width1.base33", !530, i64 0}
!582 = !{!583, !583, i64 0}
