...
entry:
  %zip1685 = ptrtoint ptr %zip to i64
  ...
  %scevgep1505 = getelementptr i8, ptr %zip, i64 236
  %scevgep1507 = getelementptr i8, ptr %zip, i64 348
  %scevgep1509 = getelementptr i8, ptr %zip, i64 372
  %arrayidx.3 = getelementptr inbounds [4 x i8], ptr %lens_buf, i64 0, i64 3
  %4 = add i64 %zip1685, 2972
  %5 = add i64 %zip1685, 2972
  br label %do.body5
...
do.body5:                                         ; preds = %do.cond599, %entry
  ...
  %cmp1322 = icmp slt i32 %bits_left.0, 1
  br i1 %cmp1322, label %while.body, label %do.end14

while.body:                                       ; preds = %do.body5, %if.end12
  %i_end.11326 = phi ptr [ %i_end.2, %if.end12 ], [ %i_end.0, %do.body5 ]
  %i_ptr.11325 = phi ptr [ %incdec.ptr, %if.end12 ], [ %i_ptr.0, %do.body5 ]
  %bits_left.11324 = phi i32 [ %add, %if.end12 ], [ %bits_left.0, %do.body5 ]
  %bit_buffer.11323 = phi i32 [ %or, %if.end12 ], [ %bit_buffer.0, %do.body5 ]
  %cmp8.not = icmp ult ptr %i_ptr.11325, %i_end.11326
...
if.end12:                                         ; preds = %if.end14.i, %while.body
  %i_ptr.2 = phi ptr [ %13, %if.end14.i ], [ %i_ptr.11325, %while.body ]
  %i_end.2 = phi ptr [ %arrayidx18.i, %if.end14.i ], [ %i_end.11326, %while.body ]
  %incdec.ptr = getelementptr inbounds i8, ptr %i_ptr.2, i64 1
  %14 = load i8, ptr %i_ptr.2, align 1, !tbaa !28
  %conv = zext i8 %14 to i32
  %shl = shl nuw nsw i32 %conv, %bits_left.11324
  %or = or i32 %shl, %bit_buffer.11323
  %add = add nsw i32 %bits_left.11324, 8
  %cmp = icmp slt i32 %bits_left.11324, -7
...
do.end14:                                         ; preds = %if.end12, %do.body5
  ...
  %cmp201330 = icmp ult i32 %bits_left.1.lcssa, 3
  br i1 %cmp201330, label %while.body22, label %do.end41

while.body22:                                     ; preds = %do.end14, %if.end33
  %i_end.31334 = phi ptr [ %i_end.4, %if.end33 ], [ %i_end.1.lcssa, %do.end14 ]
  %i_ptr.31333 = phi ptr [ %incdec.ptr34, %if.end33 ], [ %i_ptr.1.lcssa, %do.end14 ]
  %bits_left.21332 = phi i32 [ %add38, %if.end33 ], [ %sub, %do.end14 ]
  %bit_buffer.21331 = phi i32 [ %or37, %if.end33 ], [ %shr, %do.end14 ]
  %cmp23.not = icmp ult ptr %i_ptr.31333, %i_end.31334
...
if.end33:                                         ; preds = %if.end14.i937, %while.body22
  %i_ptr.4 = phi ptr [ %22, %if.end14.i937 ], [ %i_ptr.31333, %while.body22 ]
  %i_end.4 = phi ptr [ %arrayidx18.i935, %if.end14.i937 ], [ %i_end.31334, %while.body22 ]
  %incdec.ptr34 = getelementptr inbounds i8, ptr %i_ptr.4, i64 1
  %23 = load i8, ptr %i_ptr.4, align 1, !tbaa !28
  %conv35 = zext i8 %23 to i32
  %shl36 = shl nuw nsw i32 %conv35, %bits_left.21332
  %or37 = or i32 %shl36, %bit_buffer.21331
  %add38 = add nuw nsw i32 %bits_left.21332, 8
  %cmp20 = icmp slt i32 %bits_left.21332, -6
...
if.then49:                                        ; preds = %do.end41
  ...
  %cmp531349.not = icmp eq i32 %sub52, 0
  br i1 %cmp531349.not, label %while.body70.preheader, label %for.body.preheader
...
while.body70:                                     ; preds = %while.body70.preheader, %if.end81
  ...
  %i_end.51359 = phi ptr [ %i_end.3.lcssa, %while.body70.preheader ], [ %i_end.6, %if.end81 ]
  %i_ptr.51358 = phi ptr [ %i_ptr.3.lcssa, %while.body70.preheader ], [ %incdec.ptr82, %if.end81 ]
  %cmp71.not = icmp ult ptr %i_ptr.51358, %i_end.51359
...
if.end81:                                         ; preds = %if.end14.i971, %while.body70
  %i_ptr.6 = phi ptr [ %31, %if.end14.i971 ], [ %i_ptr.51358, %while.body70 ]
  %i_end.6 = phi ptr [ %arrayidx18.i969, %if.end14.i971 ], [ %i_end.51359, %while.body70 ]
...
while.end86:                                      ; preds = %for.body.3, %while.end86.loopexit
  %bit_buffer.3.lcssa1521 = phi i32 [ %bit_buffer.3.lcssa.ph, %while.end86.loopexit ], [ 0, %for.body.3 ]
...
while.cond104.preheader:                          ; preds = %while.end86
  %cmp105.not1362 = icmp eq i32 %or92, 0
  br i1 %cmp105.not1362, label %cleanup, label %while.body107

while.body107:                                    ; preds = %while.cond104.preheader, %if.end151
  %i_end.71365 = phi ptr [ %i_end.8, %if.end151 ], [ %i_end.5.lcssa, %while.cond104.preheader ]
  %i_ptr.71364 = phi ptr [ %add.ptr, %if.end151 ], [ %i_ptr.5.lcssa, %while.cond104.preheader ]
  %length.01363 = phi i32 [ %sub141, %if.end151 ], [ %or92, %while.cond104.preheader ]
  %cmp108.not = icmp ult ptr %i_ptr.71364, %i_end.71365
...
if.end118:                                        ; preds = %if.end14.i1005, %while.body107
  %i_ptr.8 = phi ptr [ %44, %if.end14.i1005 ], [ %i_ptr.71364, %while.body107 ]
  %i_end.8 = phi ptr [ %arrayidx18.i1003, %if.end14.i1005 ], [ %i_end.71365, %while.body107 ]
  ...
  %spec.select = tail call i32 @llvm.umin.i32(i32 %length.01363, i32 %conv119)
  ...
  %sub141 = sub i32 %length.01363, %this_run.1
...
for.cond197.preheader:                            ; preds = %do.end41
  ...
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(112) %scevgep1505, i8 9, i64 112, i1 false), !tbaa !28
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(24) %scevgep1507, i8 7, i64 24, i1 false), !tbaa !28
  store i64 578721382704613384, ptr %scevgep1509, align 1
...
do.body207:                                       ; preds = %do.end41
  ...
  %cmp862.i = icmp slt i32 %bits_left.2.lcssa, 7
...
while.cond286.preheader.i:                        ; preds = %sw.epilog.i
  ...
  %min.iters.check1712 = icmp ult i32 %run.0.i, 32
  br i1 %min.iters.check1712, label %while.body288.i.preheader, label %vector.scevcheck

vector.scevcheck:                                 ; preds = %while.cond286.preheader.i
  %134 = add nsw i32 %run.0.i, -1
  %135 = xor i32 %i.2947.i, -1
  %136 = icmp ugt i32 %134, %135
  br i1 %136, label %while.body288.i.preheader, label %vector.ph1713

vector.ph1713:                                    ; preds = %vector.scevcheck
  %n.vec1715 = and i32 %run.0.i, -32
  %ind.end1716 = and i32 %run.0.i, 31
  %ind.end1718 = add i32 %i.2947.i, %n.vec1715
  %broadcast.splatinsert = insertelement <16 x i8> poison, i8 %conv289.i, i64 0
  %broadcast.splat = shufflevector <16 x i8> %broadcast.splatinsert, <16 x i8> poison, <16 x i32> zeroinitializer
  %broadcast.splatinsert1723 = insertelement <16 x i8> poison, i8 %conv289.i, i64 0
  %broadcast.splat1724 = shufflevector <16 x i8> %broadcast.splatinsert1723, <16 x i8> poison, <16 x i32> zeroinitializer
  ...
  store <16 x i8> %broadcast.splat1724, ptr %139, align 1, !tbaa !28
  %140 = icmp eq i32 %n.vec1715, 32
  br i1 %140, label %middle.block1711, label %vector.body1721.1, !llvm.loop !54

vector.body1721.1:                                ; preds = %vector.ph1713
  ...
  store <16 x i8> %broadcast.splat1724, ptr %143, align 1, !tbaa !28
  %144 = icmp eq i32 %n.vec1715, 64
  br i1 %144, label %middle.block1711, label %vector.body1721.2, !llvm.loop !54

vector.body1721.2:                                ; preds = %vector.body1721.1
  ...
  store <16 x i8> %broadcast.splat1724, ptr %147, align 1, !tbaa !28
  %148 = icmp eq i32 %n.vec1715, 96
  br i1 %148, label %middle.block1711, label %vector.body1721.3, !llvm.loop !54

vector.body1721.3:                                ; preds = %vector.body1721.2
  ...
  store <16 x i8> %broadcast.splat1724, ptr %151, align 1, !tbaa !28
  br label %middle.block1711

middle.block1711:                                 ; preds = %vector.body1721.3, %vector.body1721.2, %vector.body1721.1, %vector.ph1713
  %cmp.n1720 = icmp eq i32 %run.0.i, %n.vec1715
  br i1 %cmp.n1720, label %for.inc296.i, label %while.body288.i.preheader

while.body288.i.preheader:                        ; preds = %vector.scevcheck, %while.cond286.preheader.i, %middle.block1711
  %run.1941.i.ph = phi i32 [ %run.0.i, %vector.scevcheck ], [ %run.0.i, %while.cond286.preheader.i ], [ %ind.end1716, %middle.block1711 ]
  %i.3940.i.ph = phi i32 [ %i.2947.i, %vector.scevcheck ], [ %i.2947.i, %while.cond286.preheader.i ], [ %ind.end1718, %middle.block1711 ]
  %152 = add nsw i32 %run.1941.i.ph, -1
  %xtraiter1838 = and i32 %run.1941.i.ph, 3
  %lcmp.mod1839.not = icmp eq i32 %xtraiter1838, 0
  br i1 %lcmp.mod1839.not, label %while.body288.i.prol.loopexit, label %while.body288.i.prol
...
while.body288.i.prol:                             ; preds = %while.body288.i.preheader, %while.body288.i.prol
  ...
  %prol.iter1840 = phi i32 [ %prol.iter1840.next, %while.body288.i.prol ], [ 0, %while.body288.i.preheader ]
  ...
  br i1 %prol.iter1840.cmp.not, label %while.body288.i.prol.loopexit, label %while.body288.i.prol, !llvm.loop !57
...
for.inc296.i:                                     ; preds = %while.body288.i.prol.loopexit, %while.body288.i, %middle.block1711, %if.then181.i
  %inc297.pre-phi.i = phi i32 [ %.pre.i, %if.then181.i ], [ %ind.end1718, %middle.block1711 ], [ %inc290.i.lcssa.unr, %while.body288.i.prol.loopexit ], [ %inc290.i.3, %while.body288.i ]
  %bit_buffer.11.i = phi i32 [ %shr174.i, %if.then181.i ], [ %bit_buffer.10.i, %middle.block1711 ], [ %bit_buffer.10.i, %while.body288.i ], [ %bit_buffer.10.i, %while.body288.i.prol.loopexit ]
  %bits_left.11.i = phi i32 [ %sub178.i, %if.then181.i ], [ %bits_left.10.i, %middle.block1711 ], [ %bits_left.10.i, %while.body288.i ], [ %bits_left.10.i, %while.body288.i.prol.loopexit ]
  %i_ptr.19.i = phi ptr [ %i_ptr.10.lcssa.i, %if.then181.i ], [ %i_ptr.18.i, %middle.block1711 ], [ %i_ptr.18.i, %while.body288.i ], [ %i_ptr.18.i, %while.body288.i.prol.loopexit ]
  %i_end.19.i = phi ptr [ %i_end.10.lcssa.i, %if.then181.i ], [ %i_end.18.i, %middle.block1711 ], [ %i_end.18.i, %while.body288.i ], [ %i_end.18.i, %while.body288.i.prol.loopexit ]
  %last_code.1.i = phi i32 [ %conv170.i, %if.then181.i ], [ %last_code.0946.i, %middle.block1711 ], [ %last_code.0946.i, %while.body288.i ], [ %last_code.0946.i, %while.body288.i.prol.loopexit ]
...
while.cond241:                                    ; preds = %while.cond241.outer, %while.cond513.preheader
  ...
  %cmp2461368 = icmp slt i32 %bits_left.5, 16
  br i1 %cmp2461368, label %while.body248, label %do.end267

while.body248:                                    ; preds = %while.cond241, %if.end259
  %i_end.121372 = phi ptr [ %i_end.13, %if.end259 ], [ %i_end.11, %while.cond241 ]
  %i_ptr.121371 = phi ptr [ %incdec.ptr260, %if.end259 ], [ %i_ptr.11, %while.cond241 ]
  %bits_left.61370 = phi i32 [ %add264, %if.end259 ], [ %bits_left.5, %while.cond241 ]
  %bit_buffer.61369 = phi i32 [ %or263, %if.end259 ], [ %bit_buffer.5, %while.cond241 ]
  %cmp249.not = icmp ult ptr %i_ptr.121371, %i_end.121372
...
if.end259:                                        ; preds = %if.end14.i1043, %while.body248
  %i_ptr.13 = phi ptr [ %170, %if.end14.i1043 ], [ %i_ptr.121371, %while.body248 ]
  %i_end.13 = phi ptr [ %arrayidx18.i1041, %if.end14.i1043 ], [ %i_end.121372, %while.body248 ]
  ...
  %shl262 = shl nuw nsw i32 %conv261, %bits_left.61370
  %or263 = or i32 %shl262, %bit_buffer.61369
  %add264 = add nsw i32 %bits_left.61370, 8
  %cmp246 = icmp slt i32 %bits_left.61370, 8
...
while.cond340.preheader:                          ; preds = %if.else332
  ...
  %cmp3441377 = icmp slt i32 %sub308, %conv343
  br i1 %cmp3441377, label %while.body346, label %do.end365

while.body346:                                    ; preds = %while.cond340.preheader, %if.end357
  %i_end.141381 = phi ptr [ %i_end.15, %if.end357 ], [ %i_end.12.lcssa, %while.cond340.preheader ]
  %i_ptr.141380 = phi ptr [ %incdec.ptr358, %if.end357 ], [ %i_ptr.12.lcssa, %while.cond340.preheader ]
  %bits_left.71379 = phi i32 [ %add362, %if.end357 ], [ %sub308, %while.cond340.preheader ]
  %bit_buffer.71378 = phi i32 [ %or361, %if.end357 ], [ %shr307, %while.cond340.preheader ]
  %cmp347.not = icmp ult ptr %i_ptr.141380, %i_end.141381
...
if.end357:                                        ; preds = %if.end14.i1077, %while.body346
  %i_ptr.15 = phi ptr [ %201, %if.end14.i1077 ], [ %i_ptr.141380, %while.body346 ]
  %i_end.15 = phi ptr [ %arrayidx18.i1075, %if.end14.i1077 ], [ %i_end.141381, %while.body346 ]
  ...
  %shl360 = shl i32 %conv359, %bits_left.71379
  %or361 = or i32 %shl360, %bit_buffer.71378
  %add362 = add nsw i32 %bits_left.71379, 8
...
do.end365:                                        ; preds = %if.end357, %while.cond340.preheader
  ...
  %cmp3891389 = icmp slt i32 %sub379, 16
  br i1 %cmp3891389, label %while.body391, label %do.end410

while.body391:                                    ; preds = %do.end365, %if.end402
  %i_end.161393 = phi ptr [ %i_end.17, %if.end402 ], [ %i_end.14.lcssa, %do.end365 ]
  %i_ptr.161392 = phi ptr [ %incdec.ptr403, %if.end402 ], [ %i_ptr.14.lcssa, %do.end365 ]
  %bits_left.81391 = phi i32 [ %add407, %if.end402 ], [ %sub379, %do.end365 ]
  %bit_buffer.81390 = phi i32 [ %or406, %if.end402 ], [ %shr375, %do.end365 ]
  %cmp392.not = icmp ult ptr %i_ptr.161392, %i_end.161393
...
if.end402:                                        ; preds = %if.end14.i1111, %while.body391
  %i_ptr.17 = phi ptr [ %212, %if.end14.i1111 ], [ %i_ptr.161392, %while.body391 ]
  %i_end.17 = phi ptr [ %arrayidx18.i1109, %if.end14.i1111 ], [ %i_end.161393, %while.body391 ]
  ...
  %shl405 = shl nuw nsw i32 %conv404, %bits_left.81391
  %or406 = or i32 %shl405, %bit_buffer.81390
  %add407 = add nsw i32 %bits_left.81391, 8
  %cmp389 = icmp slt i32 %bits_left.81391, 8
...
while.cond460.preheader:                          ; preds = %if.end444
  ...
  %cmp4641398 = icmp slt i32 %sub451, %conv463
  br i1 %cmp4641398, label %while.body466, label %do.end485

while.body466:                                    ; preds = %while.cond460.preheader, %if.end477
  %i_end.181402 = phi ptr [ %i_end.19, %if.end477 ], [ %i_end.16.lcssa, %while.cond460.preheader ]
  %i_ptr.181401 = phi ptr [ %incdec.ptr478, %if.end477 ], [ %i_ptr.16.lcssa, %while.cond460.preheader ]
  %bits_left.91400 = phi i32 [ %add482, %if.end477 ], [ %sub451, %while.cond460.preheader ]
  %bit_buffer.91399 = phi i32 [ %or481, %if.end477 ], [ %shr450, %while.cond460.preheader ]
  %cmp467.not = icmp ult ptr %i_ptr.181401, %i_end.181402
...
if.end477:                                        ; preds = %if.end14.i1145, %while.body466
  %i_ptr.19 = phi ptr [ %260, %if.end14.i1145 ], [ %i_ptr.181401, %while.body466 ]
  %i_end.19 = phi ptr [ %arrayidx18.i1143, %if.end14.i1145 ], [ %i_end.181402, %while.body466 ]
  ...
  %shl480 = shl i32 %conv479, %bits_left.91400
  %or481 = or i32 %shl480, %bit_buffer.91399
  %add482 = add nsw i32 %bits_left.91400, 8
...
do.body536.preheader:                             ; preds = %do.end485
  %idxprom488.le1972 = zext i8 %252 to i64
  %arrayidx489.le = getelementptr inbounds [17 x i16], ptr @mszip_bit_mask_tab, i64 0, i64 %idxprom488.le1972
  %262 = load i16, ptr %arrayidx489.le, align 2, !tbaa !49
  %conv490.le = zext i16 %262 to i32
  %and491.le1964 = and i32 %bit_buffer.9.lcssa, %conv490.le
  %arrayidx503.le1962 = getelementptr inbounds [30 x i16], ptr @mszip_dist_offsets, i64 0, i64 %idxprom447
  %263 = load i16, ptr %arrayidx503.le1962, align 2, !tbaa !49
  %conv504.le1959 = zext i16 %263 to i32
  %add505.le = add nuw nsw i32 %and491.le1964, %conv504.le1959
  %cmp506.le1954 = icmp ult i32 %window_posn158.0.ph, %add505.le
  %cond.le = select i1 %cmp506.le1954, i32 32768, i32 0
  %add508.le = sub i32 %window_posn158.0.ph, %add505.le
  %sub509.le1946 = add i32 %add508.le, %cond.le
  br label %do.body536

while.cond513.preheader:                          ; preds = %do.end485
  %tobool514.not1415 = icmp eq i32 %add385, 0
  br i1 %tobool514.not1415, label %while.cond241, label %while.body515.preheader

while.body515.preheader:                          ; preds = %while.cond513.preheader
  %idxprom488.le = zext i8 %252 to i64
  %arrayidx489.le1970 = getelementptr inbounds [17 x i16], ptr @mszip_bit_mask_tab, i64 0, i64 %idxprom488.le
  %264 = load i16, ptr %arrayidx489.le1970, align 2, !tbaa !49
  %conv490.le1967 = zext i16 %264 to i32
  %and491.le = and i32 %bit_buffer.9.lcssa, %conv490.le1967
  ...
  %add505.le1956 = add nuw nsw i32 %and491.le, %conv504.le
  %cmp506.le = icmp ult i32 %window_posn158.0.ph, %add505.le1956
  %cond.le1951 = select i1 %cmp506.le, i32 32768, i32 0
  %add508.le1949 = sub i32 %window_posn158.0.ph, %add505.le1956
  %sub509.le = add i32 %add508.le1949, %cond.le1951
  br label %while.body515

while.body515:                                    ; preds = %while.body515.preheader, %if.end533
  %dec1418.in = phi i32 [ %dec1418, %if.end533 ], [ %add385, %while.body515.preheader ]
  %match_posn.01417 = phi i32 [ %and524, %if.end533 ], [ %sub509.le, %while.body515.preheader ]
  %window_posn158.11416 = phi i32 [ %window_posn158.2, %if.end533 ], [ %window_posn158.0.ph, %while.body515.preheader ]
  %dec1418 = add nsw i32 %dec1418.in, -1
  %inc517 = add i32 %match_posn.01417, 1
  %idxprom518 = zext i32 %match_posn.01417 to i64
  ...
  %inc521 = add i32 %window_posn158.11416, 1
  %idxprom522 = zext i32 %window_posn158.11416 to i64
...
if.end533:                                        ; preds = %if.then527, %while.body515
  ...
  %tobool514.not = icmp eq i32 %dec1418, 0
...
do.body536:                                       ; preds = %do.body536.preheader, %if.end573
  ...
  %match_posn.1 = phi i32 [ %spec.store.select, %if.end573 ], [ %sub509.le1946, %do.body536.preheader ]
  ...
  %tobool560.not1410 = icmp eq i32 %this_run.3, 0
  br i1 %tobool560.not1410, label %while.end564, label %iter.check
...
vector.main.loop.iter.check:                      ; preds = %vector.memcheck
  %min.iters.check1686 = icmp ult i32 %this_run.3, 32
  br i1 %min.iters.check1686, label %vec.epilog.ph, label %vector.ph
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %next.gep1688 = getelementptr i8, ptr %arrayidx555, i64 %index
  %wide.load = load <16 x i8>, ptr %next.gep1688, align 1, !tbaa !28
  %272 = getelementptr i8, ptr %next.gep1688, i64 16
  %wide.load1690 = load <16 x i8>, ptr %272, align 1, !tbaa !28
  store <16 x i8> %wide.load, ptr %next.gep, align 1, !tbaa !28
  %273 = getelementptr i8, ptr %next.gep, i64 16
  store <16 x i8> %wide.load1690, ptr %273, align 1, !tbaa !28
...
vec.epilog.iter.check:                            ; preds = %middle.block
  %.cast1702 = trunc i64 %n.vec to i32
  %ind.end1703 = sub i32 %this_run.3, %.cast1702
  %ind.end1699 = getelementptr i8, ptr %arrayidx555, i64 %n.vec
  %ind.end1696 = getelementptr i8, ptr %arrayidx551, i64 %n.vec
...
vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  ...
  %n.vec1694 = and i64 %268, 4294967288
  %ind.end1695 = getelementptr i8, ptr %arrayidx551, i64 %n.vec1694
  %ind.end1698 = getelementptr i8, ptr %arrayidx555, i64 %n.vec1694
  %.cast = trunc i64 %n.vec1694 to i32
  %ind.end1701 = sub i32 %this_run.3, %.cast
  br label %vec.epilog.vector.body

vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  %index1706 = phi i64 [ %vec.epilog.resume.val, %vec.epilog.ph ], [ %index.next1710, %vec.epilog.vector.body ]
  %next.gep1707 = getelementptr i8, ptr %arrayidx551, i64 %index1706
  %next.gep1708 = getelementptr i8, ptr %arrayidx555, i64 %index1706
  %wide.load1709 = load <8 x i8>, ptr %next.gep1708, align 1, !tbaa !28
  store <8 x i8> %wide.load1709, ptr %next.gep1707, align 1, !tbaa !28
  %index.next1710 = add nuw i64 %index1706, 8
  %275 = icmp eq i64 %index.next1710, %n.vec1694
  br i1 %275, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !68

vec.epilog.middle.block:                          ; preds = %vec.epilog.vector.body
  %cmp.n1705 = icmp eq i64 %n.vec1694, %268
  br i1 %cmp.n1705, label %while.end564, label %while.body561.preheader

while.body561.preheader:                          ; preds = %vector.memcheck, %iter.check, %vec.epilog.iter.check, %vec.epilog.middle.block
  %rundest.01413.ph = phi ptr [ %arrayidx551, %iter.check ], [ %arrayidx551, %vector.memcheck ], [ %ind.end1696, %vec.epilog.iter.check ], [ %ind.end1695, %vec.epilog.middle.block ]
  %runsrc.01412.ph = phi ptr [ %arrayidx555, %iter.check ], [ %arrayidx555, %vector.memcheck ], [ %ind.end1699, %vec.epilog.iter.check ], [ %ind.end1698, %vec.epilog.middle.block ]
  %this_run.41411.ph = phi i32 [ %this_run.3, %iter.check ], [ %this_run.3, %vector.memcheck ], [ %ind.end1703, %vec.epilog.iter.check ], [ %ind.end1701, %vec.epilog.middle.block ]
  %276 = add i32 %this_run.41411.ph, -1
  %xtraiter1841 = and i32 %this_run.41411.ph, 7
  %lcmp.mod1842.not = icmp eq i32 %xtraiter1841, 0
  br i1 %lcmp.mod1842.not, label %while.body561.prol.loopexit, label %while.body561.prol

while.body561.prol:                               ; preds = %while.body561.preheader, %while.body561.prol
  %rundest.01413.prol = phi ptr [ %incdec.ptr563.prol, %while.body561.prol ], [ %rundest.01413.ph, %while.body561.preheader ]
  %runsrc.01412.prol = phi ptr [ %incdec.ptr562.prol, %while.body561.prol ], [ %runsrc.01412.ph, %while.body561.preheader ]
  %this_run.41411.prol = phi i32 [ %dec559.prol, %while.body561.prol ], [ %this_run.41411.ph, %while.body561.preheader ]
  %prol.iter1843 = phi i32 [ %prol.iter1843.next, %while.body561.prol ], [ 0, %while.body561.preheader ]
  %dec559.prol = add i32 %this_run.41411.prol, -1
  %incdec.ptr562.prol = getelementptr inbounds i8, ptr %runsrc.01412.prol, i64 1
  %277 = load i8, ptr %runsrc.01412.prol, align 1, !tbaa !28
  %incdec.ptr563.prol = getelementptr inbounds i8, ptr %rundest.01413.prol, i64 1
  store i8 %277, ptr %rundest.01413.prol, align 1, !tbaa !28
  %prol.iter1843.next = add i32 %prol.iter1843, 1
  %prol.iter1843.cmp.not = icmp eq i32 %prol.iter1843.next, %xtraiter1841
  br i1 %prol.iter1843.cmp.not, label %while.body561.prol.loopexit, label %while.body561.prol, !llvm.loop !69

while.body561.prol.loopexit:                      ; preds = %while.body561.prol, %while.body561.preheader
  %rundest.01413.unr = phi ptr [ %rundest.01413.ph, %while.body561.preheader ], [ %incdec.ptr563.prol, %while.body561.prol ]
  %runsrc.01412.unr = phi ptr [ %runsrc.01412.ph, %while.body561.preheader ], [ %incdec.ptr562.prol, %while.body561.prol ]
  %this_run.41411.unr = phi i32 [ %this_run.41411.ph, %while.body561.preheader ], [ %dec559.prol, %while.body561.prol ]
...
while.body561:                                    ; preds = %while.body561.prol.loopexit, %while.body561
  %rundest.01413 = phi ptr [ %incdec.ptr563.7, %while.body561 ], [ %rundest.01413.unr, %while.body561.prol.loopexit ]
  %runsrc.01412 = phi ptr [ %incdec.ptr562.7, %while.body561 ], [ %runsrc.01412.unr, %while.body561.prol.loopexit ]
  %this_run.41411 = phi i32 [ %dec559.7, %while.body561 ], [ %this_run.41411.unr, %while.body561.prol.loopexit ]
  %incdec.ptr562 = getelementptr inbounds i8, ptr %runsrc.01412, i64 1
  %279 = load i8, ptr %runsrc.01412, align 1, !tbaa !28
  %incdec.ptr563 = getelementptr inbounds i8, ptr %rundest.01413, i64 1
  store i8 %279, ptr %rundest.01413, align 1, !tbaa !28
  %incdec.ptr562.1 = getelementptr inbounds i8, ptr %runsrc.01412, i64 2
  %280 = load i8, ptr %incdec.ptr562, align 1, !tbaa !28
  %incdec.ptr563.1 = getelementptr inbounds i8, ptr %rundest.01413, i64 2
  store i8 %280, ptr %incdec.ptr563, align 1, !tbaa !28
  %incdec.ptr562.2 = getelementptr inbounds i8, ptr %runsrc.01412, i64 3
  %281 = load i8, ptr %incdec.ptr562.1, align 1, !tbaa !28
  %incdec.ptr563.2 = getelementptr inbounds i8, ptr %rundest.01413, i64 3
  store i8 %281, ptr %incdec.ptr563.1, align 1, !tbaa !28
  %incdec.ptr562.3 = getelementptr inbounds i8, ptr %runsrc.01412, i64 4
  %282 = load i8, ptr %incdec.ptr562.2, align 1, !tbaa !28
  %incdec.ptr563.3 = getelementptr inbounds i8, ptr %rundest.01413, i64 4
  store i8 %282, ptr %incdec.ptr563.2, align 1, !tbaa !28
  %incdec.ptr562.4 = getelementptr inbounds i8, ptr %runsrc.01412, i64 5
  %283 = load i8, ptr %incdec.ptr562.3, align 1, !tbaa !28
  %incdec.ptr563.4 = getelementptr inbounds i8, ptr %rundest.01413, i64 5
  store i8 %283, ptr %incdec.ptr563.3, align 1, !tbaa !28
  %incdec.ptr562.5 = getelementptr inbounds i8, ptr %runsrc.01412, i64 6
  %284 = load i8, ptr %incdec.ptr562.4, align 1, !tbaa !28
  %incdec.ptr563.5 = getelementptr inbounds i8, ptr %rundest.01413, i64 6
  store i8 %284, ptr %incdec.ptr563.4, align 1, !tbaa !28
  %incdec.ptr562.6 = getelementptr inbounds i8, ptr %runsrc.01412, i64 7
  %285 = load i8, ptr %incdec.ptr562.5, align 1, !tbaa !28
  %incdec.ptr563.6 = getelementptr inbounds i8, ptr %rundest.01413, i64 7
  store i8 %285, ptr %incdec.ptr563.5, align 1, !tbaa !28
  %dec559.7 = add i32 %this_run.41411, -8
  %incdec.ptr562.7 = getelementptr inbounds i8, ptr %runsrc.01412, i64 8
  %286 = load i8, ptr %incdec.ptr562.6, align 1, !tbaa !28
  %incdec.ptr563.7 = getelementptr inbounds i8, ptr %rundest.01413, i64 8
...
do.cond599:                                       ; preds = %cleanup591, %cleanup
  %bit_buffer.12 = phi i32 [ %bit_buffer.3.lcssa1521, %cleanup ], [ %shr307, %cleanup591 ]
...
if.then85:                                        ; preds = %for.body72
  %arrayidx80 = getelementptr inbounds %struct.qtm_modelsym, ptr %37, i64 %indvars.iv200
  %arrayidx75 = getelementptr inbounds %struct.qtm_modelsym, ptr %37, i64 %indvars.iv204
  %40 = load i32, ptr %arrayidx75, align 2
  %41 = load i32, ptr %arrayidx80, align 2
