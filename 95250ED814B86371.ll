...
define dso_local i32 @func1(ptr nocapture noundef readonly %p) local_unnamed_addr #2 {
entry:
  %0 = load i32, ptr %p, align 4, !tbaa !12
  ret i32 %0
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none) uwtable
define dso_local i32 @foo(ptr nocapture noundef readnone %s) local_unnamed_addr #3 {
entry:
  ret i32 undef
}
