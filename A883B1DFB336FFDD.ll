...
define dso_local i32 @main() local_unnamed_addr #0 {
  %1 = load i16, ptr @s, align 2, !tbaa !5
  %2 = tail call fastcc i64 @foo(i16 noundef zeroext %1), !range !9
  %3 = icmp ne i64 %2, -1
  %4 = zext i1 %3 to i32
  ret i32 %4
}
...
define internal fastcc i64 @foo(i16 noundef zeroext %0) unnamed_addr #1 {
  %2 = sext i16 %0 to i64
  ret i64 %2
}
