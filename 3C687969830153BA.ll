...
entry:
  ...
  %0 = load x86_fp80, ptr @dnan, align 16, !tbaa !5
  %cmp = fcmp ord x86_fp80 %0, 0xK00000000000000000000
...
if.end:                                           ; preds = %entry
  ...
  %cmp1 = fcmp une x86_fp80 %0, %1
  br i1 %cmp1, label %if.then2, label %if.else

if.then2:                                         ; preds = %if.end
  store x86_fp80 0xK3FFF8000000000000000, ptr @x, align 16, !tbaa !5
  %cmp4 = fcmp olt x86_fp80 %0, 0xK3FFF8000000000000000
...
if.end6:                                          ; preds = %if.then2
  %cmp7 = fcmp ogt x86_fp80 %0, 0xK3FFF8000000000000000
...
if.end9:                                          ; preds = %if.end6
  %cmp10 = fcmp ugt x86_fp80 %0, 0xK3FFF8000000000000000
...
if.end12:                                         ; preds = %if.end9
  %cmp13 = fcmp ult x86_fp80 %0, 0xK3FFF8000000000000000
...
if.end15:                                         ; preds = %if.end12
  %cmp16 = fcmp oeq x86_fp80 %0, 0xK3FFF8000000000000000
