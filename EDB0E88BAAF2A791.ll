...
define dso_local void @get_materials(ptr noalias nocapture writeonly sret(%struct.Materials) align 8 %agg.result, ptr nocapture noundef readonly byval(%struct.Input) align 8 %input) local_unnamed_addr #0 {
entry:
  %input5.sroa.3.0.input.sroa_idx = getelementptr inbounds i8, ptr %input, i64 4
  %input5.sroa.3.0.copyload = load i32, ptr %input5.sroa.3.0.input.sroa_idx, align 4
  %call.i = tail call noalias dereferenceable_or_null(48) ptr @malloc(i64 noundef 48) #7
  %cmp.i = icmp eq i32 %input5.sroa.3.0.copyload, 68
  %..i = select i1 %cmp.i, i32 34, i32 321
  store i32 %..i, ptr %call.i, align 4, !tbaa !5
  %arrayidx2.i = getelementptr inbounds i32, ptr %call.i, i64 1
  store <4 x i32> <i32 5, i32 4, i32 4, i32 27>, ptr %arrayidx2.i, align 4, !tbaa !5
  %arrayidx6.i = getelementptr inbounds i32, ptr %call.i, i64 5
  store <4 x i32> <i32 21, i32 21, i32 21, i32 21>, ptr %arrayidx6.i, align 4, !tbaa !5
  %arrayidx10.i = getelementptr inbounds i32, ptr %call.i, i64 9
  store i32 21, ptr %arrayidx10.i, align 4, !tbaa !5
  %arrayidx11.i = getelementptr inbounds i32, ptr %call.i, i64 10
  store i32 9, ptr %arrayidx11.i, align 4, !tbaa !5
  %arrayidx12.i = getelementptr inbounds i32, ptr %call.i, i64 11
  store i32 9, ptr %arrayidx12.i, align 4, !tbaa !5
  store ptr %call.i, ptr %agg.result, align 8, !tbaa !9
  %call2 = tail call ptr @load_mats(ptr noundef nonnull byval(%struct.Input) align 8 %input, ptr noundef nonnull %call.i)
  %mats = getelementptr inbounds %struct.Materials, ptr %agg.result, i64 0, i32 1
  store ptr %call2, ptr %mats, align 8, !tbaa !12
  %call4 = tail call ptr @load_concs(ptr noundef nonnull %call.i)
  %concs = getelementptr inbounds %struct.Materials, ptr %agg.result, i64 0, i32 2
  store ptr %call4, ptr %concs, align 8, !tbaa !13
  ret void
}

; Function Attrs: mustprogress nofree nounwind willreturn memory(write, argmem: read, inaccessiblemem: readwrite) uwtable
define dso_local noalias ptr @load_num_nucs(ptr nocapture noundef readonly byval(%struct.Input) align 8 %input) local_unnamed_addr #1 {
entry:
  ...
  %0 = load i32, ptr %n_nuclides, align 4, !tbaa !14
...
define dso_local noalias ptr @load_mats(ptr nocapture noundef readonly byval(%struct.Input) align 8 %input, ptr nocapture noundef readonly %num_nucs) local_unnamed_addr #2 {
entry:
  %mats0_Lrg = alloca [321 x i32], align 16
  %call = tail call noalias dereferenceable_or_null(96) ptr @malloc(i64 noundef 96) #7
  ...
  %call1.1 = tail call noalias ptr @malloc(i64 noundef %mul.1) #7
  %arrayidx3.1 = getelementptr inbounds ptr, ptr %call, i64 1
  store ptr %call1.1, ptr %arrayidx3.1, align 8, !tbaa !16
  ...
  %call1.2 = tail call noalias ptr @malloc(i64 noundef %mul.2) #7
  %arrayidx3.2 = getelementptr inbounds ptr, ptr %call, i64 2
  store ptr %call1.2, ptr %arrayidx3.2, align 8, !tbaa !16
  ...
  %call1.3 = tail call noalias ptr @malloc(i64 noundef %mul.3) #7
  %arrayidx3.3 = getelementptr inbounds ptr, ptr %call, i64 3
  store ptr %call1.3, ptr %arrayidx3.3, align 8, !tbaa !16
  ...
  %call1.4 = tail call noalias ptr @malloc(i64 noundef %mul.4) #7
  %arrayidx3.4 = getelementptr inbounds ptr, ptr %call, i64 4
  store ptr %call1.4, ptr %arrayidx3.4, align 8, !tbaa !16
  ...
  %call1.5 = tail call noalias ptr @malloc(i64 noundef %mul.5) #7
  %arrayidx3.5 = getelementptr inbounds ptr, ptr %call, i64 5
  store ptr %call1.5, ptr %arrayidx3.5, align 8, !tbaa !16
  ...
  %call1.6 = tail call noalias ptr @malloc(i64 noundef %mul.6) #7
  %arrayidx3.6 = getelementptr inbounds ptr, ptr %call, i64 6
  store ptr %call1.6, ptr %arrayidx3.6, align 8, !tbaa !16
  ...
  %call1.7 = tail call noalias ptr @malloc(i64 noundef %mul.7) #7
  %arrayidx3.7 = getelementptr inbounds ptr, ptr %call, i64 7
  store ptr %call1.7, ptr %arrayidx3.7, align 8, !tbaa !16
  ...
  %call1.8 = tail call noalias ptr @malloc(i64 noundef %mul.8) #7
  %arrayidx3.8 = getelementptr inbounds ptr, ptr %call, i64 8
  store ptr %call1.8, ptr %arrayidx3.8, align 8, !tbaa !16
  ...
  %call1.9 = tail call noalias ptr @malloc(i64 noundef %mul.9) #7
  %arrayidx3.9 = getelementptr inbounds ptr, ptr %call, i64 9
  store ptr %call1.9, ptr %arrayidx3.9, align 8, !tbaa !16
  ...
  %call1.10 = tail call noalias ptr @malloc(i64 noundef %mul.10) #7
  %arrayidx3.10 = getelementptr inbounds ptr, ptr %call, i64 10
  store ptr %call1.10, ptr %arrayidx3.10, align 8, !tbaa !16
  ...
  %call1.11 = tail call noalias ptr @malloc(i64 noundef %mul.11) #7
  %arrayidx3.11 = getelementptr inbounds ptr, ptr %call, i64 11
  store ptr %call1.11, ptr %arrayidx3.11, align 8, !tbaa !16
  ...
  %n_nuclides = getelementptr inbounds %struct.Input, ptr %input, i64 0, i32 1
  %12 = load i32, ptr %n_nuclides, align 4, !tbaa !14
  %cmp16 = icmp eq i32 %12, 68
...
; Function Attrs: nounwind uwtable
define dso_local noalias ptr @load_concs(ptr nocapture noundef readonly %num_nucs) local_unnamed_addr #0 {
entry:
  %call = tail call noalias dereferenceable_or_null(96) ptr @malloc(i64 noundef 96) #7
  %0 = load i32, ptr %num_nucs, align 4, !tbaa !5
  %conv = sext i32 %0 to i64
...
for.body16.1:                                     ; preds = %for.cond.cleanup15, %for.body16.1
  ...
  %call17.1 = tail call i32 @glibc_compat_rand() #8
  ...
  store double %div.1, ptr %arrayidx22.1, align 8, !tbaa !17
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv.1, 1
  %13 = load i32, ptr %arrayidx.1, align 4, !tbaa !5
  %14 = sext i32 %13 to i64
  %cmp13.1 = icmp slt i64 %indvars.iv.next.1, %14
  br i1 %cmp13.1, label %for.body16.1, label %for.cond.cleanup15.1
...
for.body16.2:                                     ; preds = %for.cond.cleanup15.1, %for.body16.2
  ...
  %call17.2 = tail call i32 @glibc_compat_rand() #8
  ...
  store double %div.2, ptr %arrayidx22.2, align 8, !tbaa !17
  %indvars.iv.next.2 = add nuw nsw i64 %indvars.iv.2, 1
  %16 = load i32, ptr %arrayidx.2, align 4, !tbaa !5
  %17 = sext i32 %16 to i64
  %cmp13.2 = icmp slt i64 %indvars.iv.next.2, %17
  br i1 %cmp13.2, label %for.body16.2, label %for.cond.cleanup15.2
...
for.body16.3:                                     ; preds = %for.cond.cleanup15.2, %for.body16.3
  ...
  %call17.3 = tail call i32 @glibc_compat_rand() #8
  ...
  store double %div.3, ptr %arrayidx22.3, align 8, !tbaa !17
  %indvars.iv.next.3 = add nuw nsw i64 %indvars.iv.3, 1
  %19 = load i32, ptr %arrayidx.3, align 4, !tbaa !5
  %20 = sext i32 %19 to i64
  %cmp13.3 = icmp slt i64 %indvars.iv.next.3, %20
  br i1 %cmp13.3, label %for.body16.3, label %for.cond.cleanup15.3
...
for.body16.4:                                     ; preds = %for.cond.cleanup15.3, %for.body16.4
  ...
  %call17.4 = tail call i32 @glibc_compat_rand() #8
  ...
  store double %div.4, ptr %arrayidx22.4, align 8, !tbaa !17
  %indvars.iv.next.4 = add nuw nsw i64 %indvars.iv.4, 1
  %22 = load i32, ptr %arrayidx.4, align 4, !tbaa !5
  %23 = sext i32 %22 to i64
  %cmp13.4 = icmp slt i64 %indvars.iv.next.4, %23
  br i1 %cmp13.4, label %for.body16.4, label %for.cond.cleanup15.4
...
for.body16.5:                                     ; preds = %for.cond.cleanup15.4, %for.body16.5
  ...
  %call17.5 = tail call i32 @glibc_compat_rand() #8
  ...
  store double %div.5, ptr %arrayidx22.5, align 8, !tbaa !17
  %indvars.iv.next.5 = add nuw nsw i64 %indvars.iv.5, 1
  %25 = load i32, ptr %arrayidx.5, align 4, !tbaa !5
  %26 = sext i32 %25 to i64
  %cmp13.5 = icmp slt i64 %indvars.iv.next.5, %26
  br i1 %cmp13.5, label %for.body16.5, label %for.cond.cleanup15.5
...
for.body16.6:                                     ; preds = %for.cond.cleanup15.5, %for.body16.6
  ...
  %call17.6 = tail call i32 @glibc_compat_rand() #8
  ...
  store double %div.6, ptr %arrayidx22.6, align 8, !tbaa !17
  %indvars.iv.next.6 = add nuw nsw i64 %indvars.iv.6, 1
  %28 = load i32, ptr %arrayidx.6, align 4, !tbaa !5
  %29 = sext i32 %28 to i64
  %cmp13.6 = icmp slt i64 %indvars.iv.next.6, %29
  br i1 %cmp13.6, label %for.body16.6, label %for.cond.cleanup15.6
...
for.body16.7:                                     ; preds = %for.cond.cleanup15.6, %for.body16.7
  ...
  %call17.7 = tail call i32 @glibc_compat_rand() #8
  ...
  store double %div.7, ptr %arrayidx22.7, align 8, !tbaa !17
  %indvars.iv.next.7 = add nuw nsw i64 %indvars.iv.7, 1
  %31 = load i32, ptr %arrayidx.7, align 4, !tbaa !5
  %32 = sext i32 %31 to i64
  %cmp13.7 = icmp slt i64 %indvars.iv.next.7, %32
  br i1 %cmp13.7, label %for.body16.7, label %for.cond.cleanup15.7
...
for.body16.8:                                     ; preds = %for.cond.cleanup15.7, %for.body16.8
  ...
  %call17.8 = tail call i32 @glibc_compat_rand() #8
  ...
  store double %div.8, ptr %arrayidx22.8, align 8, !tbaa !17
  ...
  br i1 %cmp13.8, label %for.body16.8, label %for.cond.cleanup15.8
...
for.body16.9:                                     ; preds = %for.cond.cleanup15.8, %for.body16.9
  ...
  %call17.9 = tail call i32 @glibc_compat_rand() #8
  ...
  store double %div.9, ptr %arrayidx22.9, align 8, !tbaa !17
  ...
  br i1 %cmp13.9, label %for.body16.9, label %for.cond.cleanup15.9
...
for.body16.10:                                    ; preds = %for.cond.cleanup15.9, %for.body16.10
  ...
  %call17.10 = tail call i32 @glibc_compat_rand() #8
  ...
  store double %div.10, ptr %arrayidx22.10, align 8, !tbaa !17
  ...
  br i1 %cmp13.10, label %for.body16.10, label %for.cond.cleanup15.10
...
for.body16.11:                                    ; preds = %for.cond.cleanup15.10, %for.body16.11
  ...
  %call17.11 = tail call i32 @glibc_compat_rand() #8
  ...
  store double %div.11, ptr %arrayidx22.11, align 8, !tbaa !17
  ...
  br i1 %cmp13.11, label %for.body16.11, label %for.cond.cleanup15.11
...
for.body16:                                       ; preds = %entry, %for.body16
  ...
  %call17 = tail call i32 @glibc_compat_rand() #8
  ...
  store double %div, ptr %arrayidx22, align 8, !tbaa !17
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %45 = load i32, ptr %num_nucs, align 4, !tbaa !5
  %46 = sext i32 %45 to i64
  %cmp13 = icmp slt i64 %indvars.iv.next, %46
  br i1 %cmp13, label %for.body16, label %for.cond.cleanup15.loopexit
}
...
; Function Attrs: nounwind uwtable
define dso_local i32 @pick_mat(ptr noundef %seed) local_unnamed_addr #0 {
for.cond.cleanup14:
  %call = tail call double @rn(ptr noundef %seed) #8
