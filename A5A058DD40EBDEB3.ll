...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none) uwtable
define dso_local i32 @ShrTest3(i32 noundef %0) local_unnamed_addr #0 {
  %2 = ashr i32 %0, 31
  ret i32 %2
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none) uwtable
define dso_local i32 @ShrTest4(i32 noundef %0) local_unnamed_addr #0 {
  %2 = lshr i32 %0, 31
  ret i32 %2
}
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none) uwtable
define dso_local i32 @ShrTest7(i32 noundef returned %0) local_unnamed_addr #0 {
  ret i32 %0
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none) uwtable
define dso_local i32 @ShrTest8(i32 noundef %0) local_unnamed_addr #0 {
  ret i32 -1
}
