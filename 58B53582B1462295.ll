...
define dso_local zeroext i16 @test1(i16 noundef zeroext %0) local_unnamed_addr #0 {
  %2 = icmp eq i16 %0, 0
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none) uwtable
define dso_local i64 @test2(i64 noundef %0) local_unnamed_addr #0 {
  %2 = icmp eq i64 %0, 0
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none) uwtable
define dso_local i32 @test3(i16 noundef zeroext %0) local_unnamed_addr #0 {
  %2 = icmp ne i16 %0, 0
  %3 = zext i1 %2 to i32
  ret i32 %3
}
