...
land.lhs.true1.i217.i:                            ; preds = %land.lhs.true.i214.i
  ...
  br i1 %cmp.i11.i216.i, label %clause_IsEmptyClause.exit222.i, label %if.end48.i

clause_IsEmptyClause.exit222.i:                   ; preds = %land.lhs.true1.i217.i
...
if.end48.i:                                       ; preds = %clause_IsEmptyClause.exit222.i, %land.lhs.true1.i217.i, %land.lhs.true.i214.i, %if.end44.i
...
land.lhs.true61.i:                                ; preds = %if.end58.i
  %arrayidx.i226.i = getelementptr inbounds i32, ptr %Search.val.i, i64 90
  %29 = load i32, ptr %arrayidx.i226.i, align 4
...
if.then64.i:                                      ; preds = %land.lhs.true61.i
  ...
  %arrayidx.i227.i = getelementptr inbounds i32, ptr %Search.val.i, i64 9
  %33 = load i32, ptr %arrayidx.i227.i, align 4
  ...
  %tobool.not.i228.i = icmp eq ptr %34, null
  br i1 %tobool.not.i228.i, label %red_ExchangeClauses.exit232.i, label %red_ExchangeClauses.exit232.thread.i

red_ExchangeClauses.exit232.thread.i:             ; preds = %if.then64.i
  %35 = load ptr, ptr %Redundant, align 8
  %call.i.i229.i = tail call ptr @memory_Malloc(i32 noundef 16) #11
  %car.i.i230.i = getelementptr inbounds %struct.LIST_HELP, ptr %call.i.i229.i, i64 0, i32 1
  store ptr %31, ptr %car.i.i230.i, align 8
  store ptr %35, ptr %call.i.i229.i, align 8
  store ptr %call.i.i229.i, ptr %Redundant, align 8
  store ptr %34, ptr %Clause.addr, align 8
  store ptr null, ptr %Copy.i, align 8
  br label %land.lhs.true.i236.i

red_ExchangeClauses.exit232.i:                    ; preds = %if.then64.i
  %cmp.not.i233.i = icmp eq ptr %31, null
  br i1 %cmp.not.i233.i, label %if.end73.i, label %land.lhs.true.i236.i

land.lhs.true.i236.i:                             ; preds = %red_ExchangeClauses.exit232.i, %red_ExchangeClauses.exit232.thread.i
  %36 = phi ptr [ %34, %red_ExchangeClauses.exit232.thread.i ], [ %31, %red_ExchangeClauses.exit232.i ]
  %37 = getelementptr i8, ptr %36, i64 68
  %C.val.i234.i = load i32, ptr %37, align 4
  %cmp.i.i235.i = icmp eq i32 %C.val.i234.i, 0
  br i1 %cmp.i.i235.i, label %land.lhs.true1.i239.i, label %if.end73.i

land.lhs.true1.i239.i:                            ; preds = %land.lhs.true.i236.i
  %38 = getelementptr i8, ptr %36, i64 72
  %C.val9.i237.i = load i32, ptr %38, align 8
  %cmp.i11.i238.i = icmp eq i32 %C.val9.i237.i, 0
  br i1 %cmp.i11.i238.i, label %land.rhs.i242.i, label %if.end73.i

land.rhs.i242.i:                                  ; preds = %land.lhs.true1.i239.i
  %39 = getelementptr i8, ptr %36, i64 64
  %C.val10.i240.i = load i32, ptr %39, align 8
  %cmp.i13.i241.not.i = icmp eq i32 %C.val10.i240.i, 0
  br i1 %cmp.i13.i241.not.i, label %red_StaticReductions.exit.thread, label %if.end73.i

if.end73.i:                                       ; preds = %land.rhs.i242.i, %land.lhs.true1.i239.i, %land.lhs.true.i236.i, %red_ExchangeClauses.exit232.i, %land.lhs.true61.i, %if.end58.i
  %arrayidx.i245.i = getelementptr inbounds i32, ptr %Search.val.i, i64 83
  %40 = load i32, ptr %arrayidx.i245.i, align 4
...
if.then76.i:                                      ; preds = %if.end73.i
  ...
  %tobool.not.i246.i = icmp eq ptr %43, null
  br i1 %tobool.not.i246.i, label %red_ExchangeClauses.exit250.i, label %red_ExchangeClauses.exit250.thread.i

red_ExchangeClauses.exit250.thread.i:             ; preds = %if.then76.i
  %44 = load ptr, ptr %Redundant, align 8
  %call.i.i247.i = tail call ptr @memory_Malloc(i32 noundef 16) #11
  %car.i.i248.i = getelementptr inbounds %struct.LIST_HELP, ptr %call.i.i247.i, i64 0, i32 1
  store ptr %41, ptr %car.i.i248.i, align 8
  store ptr %44, ptr %call.i.i247.i, align 8
  store ptr %call.i.i247.i, ptr %Redundant, align 8
  store ptr %43, ptr %Clause.addr, align 8
  store ptr null, ptr %Copy.i, align 8
  br label %land.lhs.true.i254.i

red_ExchangeClauses.exit250.i:                    ; preds = %if.then76.i
  %cmp.not.i251.i = icmp eq ptr %41, null
  br i1 %cmp.not.i251.i, label %if.end83.i, label %land.lhs.true.i254.i

land.lhs.true.i254.i:                             ; preds = %red_ExchangeClauses.exit250.i, %red_ExchangeClauses.exit250.thread.i
  %45 = phi ptr [ %43, %red_ExchangeClauses.exit250.thread.i ], [ %41, %red_ExchangeClauses.exit250.i ]
  %46 = getelementptr i8, ptr %45, i64 68
  %C.val.i252.i = load i32, ptr %46, align 4
  %cmp.i.i253.i = icmp eq i32 %C.val.i252.i, 0
  br i1 %cmp.i.i253.i, label %land.lhs.true1.i257.i, label %if.end83.i

land.lhs.true1.i257.i:                            ; preds = %land.lhs.true.i254.i
  %47 = getelementptr i8, ptr %45, i64 72
  %C.val9.i255.i = load i32, ptr %47, align 8
  %cmp.i11.i256.i = icmp eq i32 %C.val9.i255.i, 0
  br i1 %cmp.i11.i256.i, label %land.rhs.i260.i, label %if.end83.i

land.rhs.i260.i:                                  ; preds = %land.lhs.true1.i257.i
  %48 = getelementptr i8, ptr %45, i64 64
  %C.val10.i258.i = load i32, ptr %48, align 8
  %cmp.i13.i259.not.i = icmp eq i32 %C.val10.i258.i, 0
  br i1 %cmp.i13.i259.not.i, label %red_StaticReductions.exit.thread, label %if.end83.i

if.end83.i:                                       ; preds = %land.rhs.i260.i, %land.lhs.true1.i257.i, %land.lhs.true.i254.i, %red_ExchangeClauses.exit250.i, %if.end73.i
  %arrayidx.i263.i = getelementptr inbounds i32, ptr %Search.val.i, i64 86
  %49 = load i32, ptr %arrayidx.i263.i, align 4
...
if.then86.i:                                      ; preds = %if.end83.i
  ...
  %tobool.not.i264.i = icmp eq ptr %52, null
  br i1 %tobool.not.i264.i, label %red_ExchangeClauses.exit268.i, label %red_ExchangeClauses.exit268.thread.i

red_ExchangeClauses.exit268.thread.i:             ; preds = %if.then86.i
  %53 = load ptr, ptr %Redundant, align 8
  %call.i.i265.i = tail call ptr @memory_Malloc(i32 noundef 16) #11
  %car.i.i266.i = getelementptr inbounds %struct.LIST_HELP, ptr %call.i.i265.i, i64 0, i32 1
  store ptr %50, ptr %car.i.i266.i, align 8
  store ptr %53, ptr %call.i.i265.i, align 8
  store ptr %call.i.i265.i, ptr %Redundant, align 8
  store ptr %52, ptr %Clause.addr, align 8
  br label %land.lhs.true.i272.i

red_ExchangeClauses.exit268.i:                    ; preds = %if.then86.i
  %cmp.not.i269.i = icmp eq ptr %50, null
  br i1 %cmp.not.i269.i, label %if.end93.i, label %land.lhs.true.i272.i

land.lhs.true.i272.i:                             ; preds = %red_ExchangeClauses.exit268.i, %red_ExchangeClauses.exit268.thread.i
  %54 = phi ptr [ %52, %red_ExchangeClauses.exit268.thread.i ], [ %50, %red_ExchangeClauses.exit268.i ]
  %55 = getelementptr i8, ptr %54, i64 68
  %C.val.i270.i = load i32, ptr %55, align 4
  %cmp.i.i271.i = icmp eq i32 %C.val.i270.i, 0
  br i1 %cmp.i.i271.i, label %land.lhs.true1.i275.i, label %if.end93.i

land.lhs.true1.i275.i:                            ; preds = %land.lhs.true.i272.i
  %56 = getelementptr i8, ptr %54, i64 72
  %C.val9.i273.i = load i32, ptr %56, align 8
  %cmp.i11.i274.i = icmp eq i32 %C.val9.i273.i, 0
  br i1 %cmp.i11.i274.i, label %land.rhs.i278.i, label %if.end93.i

land.rhs.i278.i:                                  ; preds = %land.lhs.true1.i275.i
  %57 = getelementptr i8, ptr %54, i64 64
  %C.val10.i276.i = load i32, ptr %57, align 8
  %cmp.i13.i277.not296.i = icmp eq i32 %C.val10.i276.i, 0
  %brmerge.i = or i1 %cmp.i.i, %cmp.i13.i277.not296.i
  br i1 %brmerge.i, label %red_StaticReductions.exit.thread, label %land.lhs.true96.i

if.end93.i:                                       ; preds = %land.lhs.true1.i275.i, %land.lhs.true.i272.i, %red_ExchangeClauses.exit268.i, %if.end83.i
  br i1 %cmp.i.i, label %red_StaticReductions.exit.thread, label %land.lhs.true96.i

land.lhs.true96.i:                                ; preds = %if.end93.i, %land.rhs.i278.i
  %arrayidx.i283.i = getelementptr inbounds i32, ptr %Search.val.i, i64 89
  %58 = load i32, ptr %arrayidx.i283.i, align 4
...
red_StaticReductions.exit.thread:                 ; preds = %if.end93.i, %land.lhs.true96.i, %land.rhs.i278.i, %land.rhs.i260.i, %land.rhs.i242.i, %clause_IsEmptyClause.exit222.i, %clause_IsEmptyClause.exit.i
...
red_StaticReductions.exit.thread68.sink.split:    ; preds = %if.then51.i, %if.then21.i
  ...
  %call.i.i.sink73 = phi ptr [ %call.i.i, %if.then21.i ], [ %call.i, %if.then51.i ]
  ...
  %call.val.i.i = load i32, ptr %call.i.i.sink73, align 8
  %61 = getelementptr i8, ptr %call.i.i.sink73, i64 12
...
red_StaticReductions.exit.thread68:               ; preds = %red_StaticReductions.exit.thread68.sink.split, %red_ForwardSubsumption.exit, %red_ExchangeClauses.exit210.i, %red_ForwardSubsumption.exit.i, %entry
  %RedClause.2.ph = phi ptr [ null, %entry ], [ %call.i.i, %red_ForwardSubsumption.exit.i ], [ null, %red_ExchangeClauses.exit210.i ], [ %call.i, %red_ForwardSubsumption.exit ], [ %call.i.i.sink73, %red_StaticReductions.exit.thread68.sink.split ]
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %Copy.i) #11
...
if.then:                                          ; preds = %red_StaticReductions.exit.thread68, %red_StaticReductions.exit
  %65 = phi ptr [ %.pre, %red_StaticReductions.exit.thread68 ], [ %63, %red_StaticReductions.exit ]
  %RedClause.271 = phi ptr [ %RedClause.2.ph, %red_StaticReductions.exit.thread68 ], [ null, %red_StaticReductions.exit ]
  %66 = load ptr, ptr %Redundant, align 8
  %cmp.i.not28.i = icmp eq ptr %66, null
...
for.body.i:                                       ; preds = %for.inc.i, %for.body.lr.ph.i
  %Scan.029.i = phi ptr [ %66, %for.body.lr.ph.i ], [ %Scan.0.val24.i, %for.inc.i ]
...
while.body.i:                                     ; preds = %for.inc.i, %while.body.i
  %Current.06.i = phi ptr [ %L.addr.0.val.i, %while.body.i ], [ %66, %for.inc.i ]
...
land.lhs.true:                                    ; preds = %list_Delete.exit
  ...
  %Search.val26 = load i32, ptr %80, align 4
  %cmp.i = icmp ugt i32 %.val25, %.val24
  %cmp1.i = icmp ugt i32 %.val25, %Search.val26
  %81 = or i1 %cmp.i, %cmp1.i
  br i1 %81, label %if.then8, label %if.else

if.then8:                                         ; preds = %land.lhs.true
  tail call void @split_KeepClauseAtLevel(ptr noundef nonnull %Search, ptr noundef nonnull %65, i32 noundef %.val25) #11
  br label %if.end17
...
if.else:                                          ; preds = %land.lhs.true, %list_Delete.exit
  ...
  %tobool12.not = icmp eq i32 %82, 0
  br i1 %tobool12.not, label %if.else14, label %if.then13

if.then13:                                        ; preds = %if.else
  tail call void @prfs_InsertDocProofClause(ptr noundef nonnull %Search, ptr noundef %65) #11
  br label %if.end17

if.else14:                                        ; preds = %if.else
  tail call void @clause_Delete(ptr noundef %65) #11
  br label %if.end17

if.else16:                                        ; preds = %red_StaticReductions.exit.thread, %red_StaticReductions.exit
  %83 = load ptr, ptr %Redundant, align 8
  %cmp.i.not28.i30 = icmp eq ptr %83, null
  %.pre72 = load ptr, ptr %Clause.addr, align 8
  br i1 %cmp.i.not28.i30, label %if.end17, label %for.body.lr.ph.i31

for.body.lr.ph.i31:                               ; preds = %if.else16
  %84 = getelementptr i8, ptr %.pre72, i64 12
  %85 = getelementptr i8, ptr %Search, i64 132
  br label %for.body.i39

for.body.i39:                                     ; preds = %for.inc.i49, %for.body.lr.ph.i31
  %Scan.029.i32 = phi ptr [ %83, %for.body.lr.ph.i31 ], [ %Scan.0.val24.i47, %for.inc.i49 ]
  %86 = getelementptr i8, ptr %Scan.029.i32, i64 8
  %Scan.0.val.i33 = load ptr, ptr %86, align 8
  %RedClause.val25.i34 = load i32, ptr %84, align 4
  %87 = getelementptr i8, ptr %Scan.0.val.i33, i64 12
  %call1.val.i35 = load i32, ptr %87, align 4
  %Search.val26.i36 = load i32, ptr %85, align 4
  %cmp.i27.i37 = icmp ugt i32 %RedClause.val25.i34, %call1.val.i35
  %cmp1.i.i38 = icmp ugt i32 %RedClause.val25.i34, %Search.val26.i36
  %88 = or i1 %cmp.i27.i37, %cmp1.i.i38
  br i1 %88, label %if.then.i40, label %if.else.i44
...
if.else.i44:                                      ; preds = %for.body.i39
  ...
  %89 = load i32, ptr %arrayidx.i.i42, align 4
  %tobool10.not.i43 = icmp eq i32 %89, 0
...
while.body.i58:                                   ; preds = %for.inc.i49, %while.body.i58
  %Current.06.i52 = phi ptr [ %L.addr.0.val.i53, %while.body.i58 ], [ %83, %for.inc.i49 ]
  ...
  %total_size.i.i.i54 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %90, i64 0, i32 4
  %91 = load i32, ptr %total_size.i.i.i54, align 8
  %conv26.i.i.i55 = sext i32 %91 to i64
  %92 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i56 = add i64 %92, %conv26.i.i.i55
  store i64 %add27.i.i.i56, ptr @memory_FREEDBYTES, align 8
  %93 = load ptr, ptr %90, align 8
  store ptr %93, ptr %Current.06.i52, align 8
  %94 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i52, ptr %94, align 8
...
if.end17:                                         ; preds = %while.body.i58, %if.else16, %if.then8, %if.else14, %if.then13
  %95 = phi ptr [ null, %if.then13 ], [ null, %if.else14 ], [ null, %if.then8 ], [ %.pre72, %if.else16 ], [ %.pre72, %while.body.i58 ]
...
land.lhs.true:                                    ; preds = %list_Delete.exit
  ...
  %17 = getelementptr i8, ptr %Search, i64 132
  %Search.val26 = load i32, ptr %17, align 4
  %cmp.i = icmp ugt i32 %.val25, %.val24
  %cmp1.i = icmp ugt i32 %.val25, %Search.val26
  %18 = or i1 %cmp.i, %cmp1.i
  br i1 %18, label %if.then8, label %if.else
...
if.else:                                          ; preds = %land.lhs.true, %list_Delete.exit
  %19 = getelementptr i8, ptr %Search, i64 112
  %Search.val = load ptr, ptr %19, align 8
  %arrayidx.i = getelementptr inbounds i32, ptr %Search.val, i64 9
...
for.body.lr.ph.i29:                               ; preds = %if.else16
  %21 = getelementptr i8, ptr %.pre, i64 12
  %22 = getelementptr i8, ptr %Search, i64 132
  %23 = getelementptr i8, ptr %Search, i64 112
...
for.body.i37:                                     ; preds = %for.inc.i47, %for.body.lr.ph.i29
  ...
  %24 = getelementptr i8, ptr %Scan.029.i30, i64 8
  %Scan.0.val.i31 = load ptr, ptr %24, align 8
  %RedClause.val25.i32 = load i32, ptr %21, align 4
  %25 = getelementptr i8, ptr %Scan.0.val.i31, i64 12
  %call1.val.i33 = load i32, ptr %25, align 4
  %Search.val26.i34 = load i32, ptr %22, align 4
  %cmp.i27.i35 = icmp ugt i32 %RedClause.val25.i32, %call1.val.i33
  %cmp1.i.i36 = icmp ugt i32 %RedClause.val25.i32, %Search.val26.i34
  %26 = or i1 %cmp.i27.i35, %cmp1.i.i36
  br i1 %26, label %if.then.i38, label %if.else.i42
...
while.body.i56:                                   ; preds = %for.inc.i47, %while.body.i56
  ...
  %total_size.i.i.i52 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %28, i64 0, i32 4
  %29 = load i32, ptr %total_size.i.i.i52, align 8
  %conv26.i.i.i53 = sext i32 %29 to i64
  %30 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i54 = add i64 %30, %conv26.i.i.i53
  store i64 %add27.i.i.i54, ptr @memory_FREEDBYTES, align 8
  %31 = load ptr, ptr %28, align 8
  store ptr %31, ptr %Current.06.i50, align 8
  %32 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i50, ptr %32, align 8
...
if.end17:                                         ; preds = %while.body.i56, %if.else16, %if.then8, %if.else14, %if.then13
  %33 = phi ptr [ null, %if.then13 ], [ null, %if.else14 ], [ null, %if.then8 ], [ %.pre, %if.else16 ], [ %.pre, %while.body.i56 ]
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %Redundant) #11
...
red_ForwardSubsumption.exit:                      ; preds = %if.then30
  store ptr %call.i, ptr %Subsumer, align 8
  br i1 %tobool2.i, label %cleanup, label %if.end36
...
red_ForwardSubsumption.exit392:                   ; preds = %if.then39
  store ptr %call.i383, ptr %Subsumer, align 8
  br i1 %tobool2.i386, label %cleanup, label %if.end46
...
while.body.lr.ph:                                 ; preds = %if.end46
  ...
  %arrayidx.i.i414 = getelementptr inbounds i32, ptr %Search.val, i64 12
  %cmp82.not = icmp eq ptr %UsIndex.0, null
  br label %while.body

while.body:                                       ; preds = %while.body.lr.ph, %if.end138
  %tobool96604 = phi i1 [ true, %while.body.lr.ph ], [ false, %if.end138 ]
...
land.lhs.true1.i406:                              ; preds = %land.lhs.true.i403
  ...
  br i1 %cmp.i11.i405, label %clause_IsEmptyClause.exit411, label %if.end73

clause_IsEmptyClause.exit411:                     ; preds = %land.lhs.true1.i406
  %39 = getelementptr i8, ptr %36, i64 64
...
if.end73:                                         ; preds = %if.end69, %land.lhs.true.i403, %land.lhs.true1.i406, %clause_IsEmptyClause.exit411
...
if.then76:                                        ; preds = %if.end73
  ...
  %call.i413 = tail call fastcc ptr @red_ForwardSubsumer(ptr noundef %41, ptr noundef nonnull %WoIndex.0)
  %42 = load i32, ptr %arrayidx.i.i414, align 4
  %tobool.i415 = icmp ne i32 %42, 0
  %tobool2.i416 = icmp ne ptr %call.i413, null
  %or.cond.i417 = select i1 %tobool.i415, i1 %tobool2.i416, i1 false
  br i1 %or.cond.i417, label %red_ForwardSubsumption.exit422.thread, label %red_ForwardSubsumption.exit422

red_ForwardSubsumption.exit422.thread:            ; preds = %if.then76
  %43 = load ptr, ptr @stdout, align 8
  %44 = tail call i64 @fwrite(ptr nonnull @.str.25, i64 15, i64 1, ptr %43)
  tail call void @clause_Print(ptr noundef %41) #11
  %call.val.i418 = load i32, ptr %call.i413, align 8
  %45 = getelementptr i8, ptr %call.i413, i64 12
  %call.val12.i419 = load i32, ptr %45, align 4
  %call6.i420 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.26, i32 noundef %call.val.i418, i32 noundef %call.val12.i419)
  store ptr %call.i413, ptr %Subsumer, align 8
  br label %cleanup

red_ForwardSubsumption.exit422:                   ; preds = %if.then76
  store ptr %call.i413, ptr %Subsumer, align 8
  br i1 %tobool2.i416, label %cleanup, label %if.end81

if.end81:                                         ; preds = %red_ForwardSubsumption.exit422
  br i1 %cmp82.not, label %if.end138, label %if.then84

if.then84:                                        ; preds = %if.end81
  %46 = load ptr, ptr %Clause, align 8
  %call.i423 = tail call fastcc ptr @red_ForwardSubsumer(ptr noundef %46, ptr noundef nonnull %UsIndex.0)
  %47 = load i32, ptr %arrayidx.i.i414, align 4
  %tobool.i425 = icmp ne i32 %47, 0
  %tobool2.i426 = icmp ne ptr %call.i423, null
  %or.cond.i427 = select i1 %tobool.i425, i1 %tobool2.i426, i1 false
  br i1 %or.cond.i427, label %red_ForwardSubsumption.exit432.thread, label %red_ForwardSubsumption.exit432

red_ForwardSubsumption.exit432.thread:            ; preds = %if.then84
  %48 = load ptr, ptr @stdout, align 8
  %49 = tail call i64 @fwrite(ptr nonnull @.str.25, i64 15, i64 1, ptr %48)
  tail call void @clause_Print(ptr noundef %46) #11
  %call.val.i428 = load i32, ptr %call.i423, align 8
  %50 = getelementptr i8, ptr %call.i423, i64 12
  %call.val12.i429 = load i32, ptr %50, align 4
  %call6.i430 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.26, i32 noundef %call.val.i428, i32 noundef %call.val12.i429)
  store ptr %call.i423, ptr %Subsumer, align 8
  br label %cleanup

red_ForwardSubsumption.exit432:                   ; preds = %if.then84
  store ptr %call.i423, ptr %Subsumer, align 8
  br i1 %tobool2.i426, label %cleanup, label %land.lhs.true99
...
land.lhs.true95:                                  ; preds = %if.end92
  %or.cond = or i1 %tobool96604, %tobool98
  br i1 %or.cond, label %land.lhs.true99, label %while.end

land.lhs.true99:                                  ; preds = %red_ForwardSubsumption.exit432, %land.lhs.true95
  %Rewritten.1574578 = phi i32 [ %Rewritten.1, %land.lhs.true95 ], [ 1, %red_ForwardSubsumption.exit432 ]
...
if.then111:                                       ; preds = %land.lhs.true107, %land.lhs.true101
  ...
  %tobool.not.i433 = icmp eq ptr %53, null
  br i1 %tobool.not.i433, label %red_ExchangeClauses.exit437, label %if.then.i436

if.then.i436:                                     ; preds = %if.then111
  %54 = load ptr, ptr %Clause, align 8
  %55 = load ptr, ptr %Result, align 8
  %call.i.i434 = tail call ptr @memory_Malloc(i32 noundef 16) #11
  %car.i.i435 = getelementptr inbounds %struct.LIST_HELP, ptr %call.i.i434, i64 0, i32 1
  store ptr %54, ptr %car.i.i435, align 8
  store ptr %55, ptr %call.i.i434, align 8
  store ptr %call.i.i434, ptr %Result, align 8
  store ptr %53, ptr %Clause, align 8
  store ptr null, ptr %Copy, align 8
  br label %red_ExchangeClauses.exit437

red_ExchangeClauses.exit437:                      ; preds = %if.then111, %if.then.i436
...
if.end115:                                        ; preds = %red_ExchangeClauses.exit437
  %56 = load ptr, ptr %Clause, align 8
  %cmp.not.i438 = icmp eq ptr %56, null
  br i1 %cmp.not.i438, label %if.end119, label %land.lhs.true.i441

land.lhs.true.i441:                               ; preds = %if.end115
  %57 = getelementptr i8, ptr %56, i64 68
  %C.val.i439 = load i32, ptr %57, align 4
  %cmp.i.i440 = icmp eq i32 %C.val.i439, 0
  br i1 %cmp.i.i440, label %land.lhs.true1.i444, label %if.end119

land.lhs.true1.i444:                              ; preds = %land.lhs.true.i441
  %58 = getelementptr i8, ptr %56, i64 72
  %C.val9.i442 = load i32, ptr %58, align 8
  %cmp.i11.i443 = icmp eq i32 %C.val9.i442, 0
  br i1 %cmp.i11.i443, label %clause_IsEmptyClause.exit449, label %if.end119

clause_IsEmptyClause.exit449:                     ; preds = %land.lhs.true1.i444
  %59 = getelementptr i8, ptr %56, i64 64
  %C.val10.i445 = load i32, ptr %59, align 8
  %cmp.i13.i446.not = icmp eq i32 %C.val10.i445, 0
  br i1 %cmp.i13.i446.not, label %cleanup, label %if.end119

if.end119:                                        ; preds = %if.end115, %land.lhs.true.i441, %land.lhs.true1.i444, %clause_IsEmptyClause.exit449
...
if.then125:                                       ; preds = %if.then122
  ...
  %call.i451 = tail call fastcc ptr @red_ForwardSubsumer(ptr noundef %61, ptr noundef nonnull %WoIndex.0)
  %62 = load i32, ptr %arrayidx.i.i414, align 4
  %tobool.i453 = icmp ne i32 %62, 0
  %tobool2.i454 = icmp ne ptr %call.i451, null
  %or.cond.i455 = select i1 %tobool.i453, i1 %tobool2.i454, i1 false
  br i1 %or.cond.i455, label %if.end127.thread582, label %if.end127

if.end127.thread582:                              ; preds = %if.then125
  ...
  %call.val.i456 = load i32, ptr %call.i451, align 8
  %65 = getelementptr i8, ptr %call.i451, i64 12
  %call.val12.i457 = load i32, ptr %65, align 4
  %call6.i458 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.26, i32 noundef %call.val.i456, i32 noundef %call.val12.i457)
  store ptr %call.i451, ptr %Subsumer, align 8
  br label %cleanup

if.end127:                                        ; preds = %if.then125
  store ptr %call.i451, ptr %Subsumer, align 8
  %cmp128.not = icmp eq ptr %call.i451, null
  br i1 %cmp128.not, label %if.end131, label %cleanup

if.end131:                                        ; preds = %if.then122, %if.end127
  %66 = load ptr, ptr %Clause, align 8
  %call.i461 = tail call fastcc ptr @red_ForwardSubsumer(ptr noundef %66, ptr noundef nonnull %UsIndex.0)
  %67 = load i32, ptr %arrayidx.i.i414, align 4
  %tobool.i463 = icmp ne i32 %67, 0
  %tobool2.i464 = icmp ne ptr %call.i461, null
  %or.cond.i465 = select i1 %tobool.i463, i1 %tobool2.i464, i1 false
  br i1 %or.cond.i465, label %red_ForwardSubsumption.exit470.thread, label %red_ForwardSubsumption.exit470

red_ForwardSubsumption.exit470.thread:            ; preds = %if.end131
  ...
  %call.val.i466 = load i32, ptr %call.i461, align 8
  %70 = getelementptr i8, ptr %call.i461, i64 12
  %call.val12.i467 = load i32, ptr %70, align 4
  %call6.i468 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.26, i32 noundef %call.val.i466, i32 noundef %call.val12.i467)
  store ptr %call.i461, ptr %Subsumer, align 8
  br label %cleanup

red_ForwardSubsumption.exit470:                   ; preds = %if.end131
  store ptr %call.i461, ptr %Subsumer, align 8
  br i1 %tobool2.i464, label %cleanup, label %if.end138

if.end138:                                        ; preds = %if.end81, %if.end119, %red_ForwardSubsumption.exit470, %land.lhs.true107, %lor.lhs.false105, %if.end92
  %Rewritten.2 = phi i32 [ 1, %red_ForwardSubsumption.exit470 ], [ 1, %if.end119 ], [ %Rewritten.1574578, %land.lhs.true107 ], [ %Rewritten.1574578, %lor.lhs.false105 ], [ %Rewritten.1, %if.end92 ], [ 1, %if.end81 ]
...
while.end:                                        ; preds = %land.lhs.true95, %if.end138, %if.end46
  %arrayidx.i471 = getelementptr inbounds i32, ptr %Search.val, i64 90
...
if.then141:                                       ; preds = %while.end
  ...
  %arrayidx.i472 = getelementptr inbounds i32, ptr %Search.val, i64 9
  %75 = load i32, ptr %arrayidx.i472, align 4
  ...
  %tobool.not.i473 = icmp eq ptr %76, null
  %.pr584 = load ptr, ptr %Clause, align 8
  br i1 %tobool.not.i473, label %red_ExchangeClauses.exit477, label %red_ExchangeClauses.exit477.thread

red_ExchangeClauses.exit477.thread:               ; preds = %if.then141
  %77 = load ptr, ptr %Result, align 8
  %call.i.i474 = tail call ptr @memory_Malloc(i32 noundef 16) #11
  %car.i.i475 = getelementptr inbounds %struct.LIST_HELP, ptr %call.i.i474, i64 0, i32 1
  store ptr %.pr584, ptr %car.i.i475, align 8
  store ptr %77, ptr %call.i.i474, align 8
  store ptr %call.i.i474, ptr %Result, align 8
  store ptr %76, ptr %Clause, align 8
  store ptr null, ptr %Copy, align 8
  br label %land.lhs.true.i481

red_ExchangeClauses.exit477:                      ; preds = %if.then141
  %cmp.not.i478 = icmp eq ptr %.pr584, null
  br i1 %cmp.not.i478, label %if.end150, label %land.lhs.true.i481

land.lhs.true.i481:                               ; preds = %red_ExchangeClauses.exit477.thread, %red_ExchangeClauses.exit477
  %78 = phi ptr [ %76, %red_ExchangeClauses.exit477.thread ], [ %.pr584, %red_ExchangeClauses.exit477 ]
  %79 = getelementptr i8, ptr %78, i64 68
  %C.val.i479 = load i32, ptr %79, align 4
  %cmp.i.i480 = icmp eq i32 %C.val.i479, 0
  br i1 %cmp.i.i480, label %land.lhs.true1.i484, label %if.end150

land.lhs.true1.i484:                              ; preds = %land.lhs.true.i481
  %80 = getelementptr i8, ptr %78, i64 72
  %C.val9.i482 = load i32, ptr %80, align 8
  %cmp.i11.i483 = icmp eq i32 %C.val9.i482, 0
  br i1 %cmp.i11.i483, label %clause_IsEmptyClause.exit489, label %if.end150

clause_IsEmptyClause.exit489:                     ; preds = %land.lhs.true1.i484
  %81 = getelementptr i8, ptr %78, i64 64
  %C.val10.i485 = load i32, ptr %81, align 8
  %cmp.i13.i486.not = icmp eq i32 %C.val10.i485, 0
  br i1 %cmp.i13.i486.not, label %cleanup, label %if.end150

if.end150:                                        ; preds = %red_ExchangeClauses.exit477, %land.lhs.true.i481, %land.lhs.true1.i484, %clause_IsEmptyClause.exit489, %while.end
  %arrayidx.i490 = getelementptr inbounds i32, ptr %Search.val, i64 83
  %82 = load i32, ptr %arrayidx.i490, align 4
...
if.end158:                                        ; preds = %if.then155, %if.then153
  ...
  %tobool.not.i491 = icmp eq ptr %85, null
  %.pr588 = load ptr, ptr %Clause, align 8
  br i1 %tobool.not.i491, label %red_ExchangeClauses.exit495, label %red_ExchangeClauses.exit495.thread

red_ExchangeClauses.exit495.thread:               ; preds = %if.end158
  %86 = load ptr, ptr %Result, align 8
  %call.i.i492 = tail call ptr @memory_Malloc(i32 noundef 16) #11
  %car.i.i493 = getelementptr inbounds %struct.LIST_HELP, ptr %call.i.i492, i64 0, i32 1
  store ptr %.pr588, ptr %car.i.i493, align 8
  store ptr %86, ptr %call.i.i492, align 8
  store ptr %call.i.i492, ptr %Result, align 8
  store ptr %85, ptr %Clause, align 8
  store ptr null, ptr %Copy, align 8
  br label %land.lhs.true.i499

red_ExchangeClauses.exit495:                      ; preds = %if.end158
  %cmp.not.i496 = icmp eq ptr %.pr588, null
  br i1 %cmp.not.i496, label %if.end162, label %land.lhs.true.i499

land.lhs.true.i499:                               ; preds = %red_ExchangeClauses.exit495.thread, %red_ExchangeClauses.exit495
  %87 = phi ptr [ %85, %red_ExchangeClauses.exit495.thread ], [ %.pr588, %red_ExchangeClauses.exit495 ]
  %88 = getelementptr i8, ptr %87, i64 68
  %C.val.i497 = load i32, ptr %88, align 4
  %cmp.i.i498 = icmp eq i32 %C.val.i497, 0
  br i1 %cmp.i.i498, label %land.lhs.true1.i502, label %if.end162

land.lhs.true1.i502:                              ; preds = %land.lhs.true.i499
  %89 = getelementptr i8, ptr %87, i64 72
  %C.val9.i500 = load i32, ptr %89, align 8
  %cmp.i11.i501 = icmp eq i32 %C.val9.i500, 0
  br i1 %cmp.i11.i501, label %clause_IsEmptyClause.exit507, label %if.end162

clause_IsEmptyClause.exit507:                     ; preds = %land.lhs.true1.i502
  %90 = getelementptr i8, ptr %87, i64 64
  %C.val10.i503 = load i32, ptr %90, align 8
  %cmp.i13.i504.not = icmp eq i32 %C.val10.i503, 0
  br i1 %cmp.i13.i504.not, label %cleanup, label %if.end162

if.end162:                                        ; preds = %red_ExchangeClauses.exit495, %land.lhs.true.i499, %land.lhs.true1.i502, %clause_IsEmptyClause.exit507
  %91 = phi ptr [ %87, %clause_IsEmptyClause.exit507 ], [ null, %red_ExchangeClauses.exit495 ], [ %87, %land.lhs.true.i499 ], [ %87, %land.lhs.true1.i502 ]
  %tobool163.not = icmp eq ptr %UsIndex.0, null
  br i1 %tobool163.not, label %red_ExchangeClauses.exit512, label %if.end167
...
if.end167:                                        ; preds = %if.end162
  ...
  %tobool.not.i508 = icmp eq ptr %.pre, null
  br i1 %tobool.not.i508, label %red_ExchangeClauses.exit512, label %red_ExchangeClauses.exit512.thread

red_ExchangeClauses.exit512.thread:               ; preds = %if.end167
  %93 = load ptr, ptr %Clause, align 8
  %94 = load ptr, ptr %Result, align 8
  %call.i.i509 = tail call ptr @memory_Malloc(i32 noundef 16) #11
  %car.i.i510 = getelementptr inbounds %struct.LIST_HELP, ptr %call.i.i509, i64 0, i32 1
  store ptr %93, ptr %car.i.i510, align 8
  store ptr %94, ptr %call.i.i509, align 8
  store ptr %call.i.i509, ptr %Result, align 8
  store ptr %.pre, ptr %Clause, align 8
  store ptr null, ptr %Copy, align 8
  br label %land.lhs.true.i516

red_ExchangeClauses.exit512:                      ; preds = %if.end162, %if.end167
  %.pr592 = load ptr, ptr %Clause, align 8
  %cmp.not.i513 = icmp eq ptr %.pr592, null
  br i1 %cmp.not.i513, label %if.end172, label %land.lhs.true.i516

land.lhs.true.i516:                               ; preds = %red_ExchangeClauses.exit512.thread, %red_ExchangeClauses.exit512
  %95 = phi ptr [ %.pre, %red_ExchangeClauses.exit512.thread ], [ %.pr592, %red_ExchangeClauses.exit512 ]
  %96 = getelementptr i8, ptr %95, i64 68
  %C.val.i514 = load i32, ptr %96, align 4
  %cmp.i.i515 = icmp eq i32 %C.val.i514, 0
  br i1 %cmp.i.i515, label %land.lhs.true1.i519, label %if.end172

land.lhs.true1.i519:                              ; preds = %land.lhs.true.i516
  %97 = getelementptr i8, ptr %95, i64 72
  %C.val9.i517 = load i32, ptr %97, align 8
  %cmp.i11.i518 = icmp eq i32 %C.val9.i517, 0
  br i1 %cmp.i11.i518, label %land.rhs.i522, label %if.end172

land.rhs.i522:                                    ; preds = %land.lhs.true1.i519
  %98 = getelementptr i8, ptr %95, i64 64
  %C.val10.i520 = load i32, ptr %98, align 8
  %cmp.i13.i521.not = icmp eq i32 %C.val10.i520, 0
  br i1 %cmp.i13.i521.not, label %cleanup, label %if.end172

if.end172:                                        ; preds = %land.lhs.true1.i519, %land.lhs.true.i516, %red_ExchangeClauses.exit512, %land.rhs.i522, %if.end150
  %arrayidx.i525 = getelementptr inbounds i32, ptr %Search.val, i64 86
  %99 = load i32, ptr %arrayidx.i525, align 4
...
if.end180:                                        ; preds = %if.then177, %if.then175
  ...
  %tobool.not.i526 = icmp eq ptr %102, null
  %.pr594 = load ptr, ptr %Clause, align 8
  br i1 %tobool.not.i526, label %red_ExchangeClauses.exit530, label %red_ExchangeClauses.exit530.thread

red_ExchangeClauses.exit530.thread:               ; preds = %if.end180
  %103 = load ptr, ptr %Result, align 8
  %call.i.i527 = tail call ptr @memory_Malloc(i32 noundef 16) #11
  %car.i.i528 = getelementptr inbounds %struct.LIST_HELP, ptr %call.i.i527, i64 0, i32 1
  store ptr %.pr594, ptr %car.i.i528, align 8
  store ptr %103, ptr %call.i.i527, align 8
  store ptr %call.i.i527, ptr %Result, align 8
  store ptr %102, ptr %Clause, align 8
  store ptr null, ptr %Copy, align 8
  br label %land.lhs.true.i534

red_ExchangeClauses.exit530:                      ; preds = %if.end180
  %cmp.not.i531 = icmp eq ptr %.pr594, null
  br i1 %cmp.not.i531, label %if.end184, label %land.lhs.true.i534

land.lhs.true.i534:                               ; preds = %red_ExchangeClauses.exit530.thread, %red_ExchangeClauses.exit530
  %104 = phi ptr [ %102, %red_ExchangeClauses.exit530.thread ], [ %.pr594, %red_ExchangeClauses.exit530 ]
  %105 = getelementptr i8, ptr %104, i64 68
  %C.val.i532 = load i32, ptr %105, align 4
  %cmp.i.i533 = icmp eq i32 %C.val.i532, 0
  br i1 %cmp.i.i533, label %land.lhs.true1.i537, label %if.end184

land.lhs.true1.i537:                              ; preds = %land.lhs.true.i534
  %106 = getelementptr i8, ptr %104, i64 72
  %C.val9.i535 = load i32, ptr %106, align 8
  %cmp.i11.i536 = icmp eq i32 %C.val9.i535, 0
  br i1 %cmp.i11.i536, label %land.rhs.i540, label %if.end184

land.rhs.i540:                                    ; preds = %land.lhs.true1.i537
  %107 = getelementptr i8, ptr %104, i64 64
  %C.val10.i538 = load i32, ptr %107, align 8
  %cmp.i13.i539.not = icmp eq i32 %C.val10.i538, 0
  br i1 %cmp.i13.i539.not, label %cleanup, label %if.end184

if.end184:                                        ; preds = %land.lhs.true1.i537, %land.lhs.true.i534, %red_ExchangeClauses.exit530, %land.rhs.i540
  %108 = phi ptr [ %104, %land.lhs.true1.i537 ], [ %104, %land.lhs.true.i534 ], [ null, %red_ExchangeClauses.exit530 ], [ %104, %land.rhs.i540 ]
  %tobool185.not = icmp eq ptr %UsIndex.0, null
  br i1 %tobool185.not, label %red_ExchangeClauses.exit547, label %if.end189
...
if.end189:                                        ; preds = %if.end184
  ...
  %.pre610 = load ptr, ptr %Copy, align 8
  %tobool.not.i543 = icmp eq ptr %.pre610, null
  br i1 %tobool.not.i543, label %red_ExchangeClauses.exit547, label %red_ExchangeClauses.exit547.thread

red_ExchangeClauses.exit547.thread:               ; preds = %if.end189
  %110 = load ptr, ptr %Clause, align 8
  %111 = load ptr, ptr %Result, align 8
  %call.i.i544 = tail call ptr @memory_Malloc(i32 noundef 16) #11
  %car.i.i545 = getelementptr inbounds %struct.LIST_HELP, ptr %call.i.i544, i64 0, i32 1
  store ptr %110, ptr %car.i.i545, align 8
  store ptr %111, ptr %call.i.i544, align 8
  store ptr %call.i.i544, ptr %Result, align 8
  store ptr %.pre610, ptr %Clause, align 8
  br label %land.lhs.true.i551

red_ExchangeClauses.exit547:                      ; preds = %if.end184, %if.end189
  %.pr596 = load ptr, ptr %Clause, align 8
  %cmp.not.i548 = icmp eq ptr %.pr596, null
  br i1 %cmp.not.i548, label %if.end194, label %land.lhs.true.i551

land.lhs.true.i551:                               ; preds = %red_ExchangeClauses.exit547.thread, %red_ExchangeClauses.exit547
  %112 = phi ptr [ %.pre610, %red_ExchangeClauses.exit547.thread ], [ %.pr596, %red_ExchangeClauses.exit547 ]
  %113 = getelementptr i8, ptr %112, i64 68
  %C.val.i549 = load i32, ptr %113, align 4
  %cmp.i.i550 = icmp eq i32 %C.val.i549, 0
  br i1 %cmp.i.i550, label %land.lhs.true1.i554, label %if.end194

land.lhs.true1.i554:                              ; preds = %land.lhs.true.i551
  %114 = getelementptr i8, ptr %112, i64 72
  %C.val9.i552 = load i32, ptr %114, align 8
  %cmp.i11.i553 = icmp eq i32 %C.val9.i552, 0
  br i1 %cmp.i11.i553, label %land.rhs.i557, label %if.end194

land.rhs.i557:                                    ; preds = %land.lhs.true1.i554
  %115 = getelementptr i8, ptr %112, i64 64
  %C.val10.i555 = load i32, ptr %115, align 8
  %cmp.i13.i556.not = icmp eq i32 %C.val10.i555, 0
  br i1 %cmp.i13.i556.not, label %cleanup, label %if.end194

if.end194:                                        ; preds = %land.lhs.true1.i554, %land.lhs.true.i551, %red_ExchangeClauses.exit547, %land.rhs.i557, %if.end172
  %arrayidx.i560 = getelementptr inbounds i32, ptr %Search.val, i64 89
  %116 = load i32, ptr %arrayidx.i560, align 4
...
cleanup:                                          ; preds = %red_ForwardSubsumption.exit470, %if.end127, %clause_IsEmptyClause.exit449, %red_ExchangeClauses.exit437, %red_ForwardSubsumption.exit432, %red_ForwardSubsumption.exit422, %clause_IsEmptyClause.exit411, %red_ExchangeClauses.exit399, %red_ForwardSubsumption.exit470.thread, %if.end127.thread582, %red_ForwardSubsumption.exit432.thread, %red_ForwardSubsumption.exit422.thread, %red_ForwardSubsumption.exit392.thread, %red_ForwardSubsumption.exit.thread, %if.end194, %if.then197, %land.rhs.i557, %land.rhs.i540, %land.rhs.i522, %clause_IsEmptyClause.exit507, %clause_IsEmptyClause.exit489, %red_ForwardSubsumption.exit392, %red_ForwardSubsumption.exit, %clause_IsEmptyClause.exit, %if.end8
  %retval.0 = phi i32 [ 1, %if.end8 ], [ 0, %clause_IsEmptyClause.exit ], [ 1, %red_ForwardSubsumption.exit ], [ 1, %red_ForwardSubsumption.exit392 ], [ 0, %clause_IsEmptyClause.exit489 ], [ 0, %clause_IsEmptyClause.exit507 ], [ 0, %land.rhs.i522 ], [ 0, %land.rhs.i540 ], [ 0, %land.rhs.i557 ], [ %call199, %if.then197 ], [ 0, %if.end194 ], [ 1, %red_ForwardSubsumption.exit.thread ], [ 1, %red_ForwardSubsumption.exit392.thread ], [ 1, %red_ForwardSubsumption.exit422.thread ], [ 1, %red_ForwardSubsumption.exit432.thread ], [ 1, %if.end127.thread582 ], [ 1, %red_ForwardSubsumption.exit470.thread ], [ 1, %red_ForwardSubsumption.exit470 ], [ 1, %if.end127 ], [ 0, %clause_IsEmptyClause.exit449 ], [ 1, %red_ExchangeClauses.exit437 ], [ 1, %red_ForwardSubsumption.exit432 ], [ 1, %red_ForwardSubsumption.exit422 ], [ 0, %clause_IsEmptyClause.exit411 ], [ 1, %red_ExchangeClauses.exit399 ]
...
if.end:                                           ; preds = %entry.if.end_crit_edge, %land.lhs.true.i, %land.lhs.true1.i, %clause_IsEmptyClause.exit
  ...
  %sub.i = add i32 %RedCl.val239, -1
  %sub.i242 = add i32 %sub.i, %RedCl.val227
  %add.i = add i32 %RedCl.val227, %RedCl.val239
...
while.body.lr.ph:                                 ; preds = %clause_GetLiteralAtom.exit
  ...
  %cmp34.not = icmp slt i32 %i.0.lcssa, %RedCl.val239
...
while.body74.lr.ph:                               ; preds = %if.then64
  ...
  %cmp93.not = icmp slt i32 %i.0.lcssa, %RedCl.val239
  %cmp95.not = icmp sgt i32 %i.0.lcssa, %sub.i242
  %or.cond1 = or i1 %cmp93.not, %cmp95.not
...
land.lhs.true87:                                  ; preds = %clause_LiteralGetIndex.exit290
  br i1 %cmp88.not, label %lor.lhs.false92, label %while.cond.i.i297
...
if.else:                                          ; preds = %for.body
  ...
  %cmp.i46.not = icmp eq i32 %and.i, 0
  %7 = load i32, ptr %arrayidx.i, align 4
  %tobool18.not = icmp eq i32 %7, 0
  br i1 %cmp.i46.not, label %if.else16, label %if.then11
...
if.then:                                          ; preds = %entry
  ...
  br i1 %cmp.i.i, label %if.then.i257, label %clause_LiteralAtom.exit

clause_LiteralAtom.exit:                          ; preds = %if.then
  %8 = load i32, ptr @fol_EQUALITY, align 4
  %cmp.i.not = icmp eq i32 %8, %L.val7.val.i
  br i1 %cmp.i.not, label %cleanup, label %clause_LiteralAtom.exit259
...
clause_LiteralAtom.exit259:                       ; preds = %clause_LiteralAtom.exit, %if.then.i257
  ...
  %ShIndex.val375 = load ptr, ptr %ShIndex, align 8
  %call13 = tail call ptr @st_ExistInstance(ptr noundef %11, ptr noundef %ShIndex.val375, ptr noundef %retval.0.i258) #11
  %RedClause.val249 = load i32, ptr %RedClause, align 8
  %tobool16.not394 = icmp eq ptr %call13, null
  br i1 %tobool16.not394, label %cleanup, label %while.body

while.cond28.preheader:                           ; preds = %for.end
  %cmp.i263.not406 = icmp eq ptr %LitList.1.lcssa, null
  br i1 %cmp.i263.not406, label %cleanup, label %while.body32.lr.ph
...
while.body:                                       ; preds = %clause_LiteralAtom.exit259, %for.end
  %LitList.0396 = phi ptr [ %LitList.1.lcssa, %for.end ], [ null, %clause_LiteralAtom.exit259 ]
  %CandTerm.0395 = phi ptr [ %call27, %for.end ], [ %call13, %clause_LiteralAtom.exit259 ]
  %call17 = tail call ptr @sharing_NAtomDataList(ptr noundef nonnull %CandTerm.0395) #11
  %cmp.i260.not390 = icmp eq ptr %call17, null
  br i1 %cmp.i260.not390, label %for.end, label %for.body.preheader

for.body.preheader:                               ; preds = %while.body
  %.pre413 = load i32, ptr @fol_NOT, align 4
  br label %for.body

for.body:                                         ; preds = %for.body.preheader, %for.inc
  %13 = phi i32 [ %16, %for.inc ], [ %.pre413, %for.body.preheader ]
  %LitList.1392 = phi ptr [ %LitList.2, %for.inc ], [ %LitList.0396, %for.body.preheader ]
  %Iter.0391 = phi ptr [ %Iter.0.val245, %for.inc ], [ %call17, %for.body.preheader ]
  %14 = getelementptr i8, ptr %Iter.0391, i64 8
...
lor.rhs.i.thread:                                 ; preds = %for.body
  %cmp.i11.i418 = icmp eq i32 %13, %L2.val10.val.i
  br i1 %cmp.i11.i418, label %if.then23, label %for.inc

if.then23:                                        ; preds = %lor.rhs.i.thread, %land.lhs.true.i
  %call.i = tail call ptr @memory_Malloc(i32 noundef 16) #11
  %car.i = getelementptr inbounds %struct.LIST_HELP, ptr %call.i, i64 0, i32 1
  store ptr %Iter.0.val237, ptr %car.i, align 8
  store ptr %LitList.1392, ptr %call.i, align 8
...
for.inc:                                          ; preds = %land.lhs.true.i, %lor.rhs.i.thread, %if.then23
  ...
  %LitList.2 = phi ptr [ %call.i, %if.then23 ], [ %LitList.1392, %lor.rhs.i.thread ], [ %LitList.1392, %land.lhs.true.i ]
  %Iter.0.val245 = load ptr, ptr %Iter.0391, align 8
  %cmp.i260.not = icmp eq ptr %Iter.0.val245, null
  br i1 %cmp.i260.not, label %for.end, label %for.body, !llvm.loop !20

for.end:                                          ; preds = %for.inc, %while.body
  %LitList.1.lcssa = phi ptr [ %LitList.0396, %while.body ], [ %LitList.2, %for.inc ]
...
while.body32:                                     ; preds = %while.body32.lr.ph, %if.end84
  %Blocked.0408 = phi ptr [ null, %while.body32.lr.ph ], [ %call.i265, %if.end84 ]
  %LitList.3407 = phi ptr [ %LitList.1.lcssa, %while.body32.lr.ph ], [ %LitList.3.val242, %if.end84 ]
  %17 = getelementptr i8, ptr %LitList.3407, i64 8
  ...
  store ptr %Blocked.0408, ptr %call.i265, align 8
...
if.end44:                                         ; preds = %if.then39, %while.body32
  %Scan.0398 = load ptr, ptr %LitList.3407, align 8
  %cmp.i268.not399 = icmp eq ptr %Scan.0398, null
  br i1 %cmp.i268.not399, label %for.end59, label %for.body50

for.body50:                                       ; preds = %if.end44, %for.inc57
  %Scan.0402 = phi ptr [ %Scan.0, %for.inc57 ], [ %Scan.0398, %if.end44 ]
  %Scan.0.in401 = phi ptr [ %Scan.1, %for.inc57 ], [ %LitList.3407, %if.end44 ]
  %PIndL.0400 = phi ptr [ %PIndL.1, %for.inc57 ], [ %call.i.i, %if.end44 ]
  %22 = getelementptr i8, ptr %Scan.0402, i64 8
...
if.then54:                                        ; preds = %for.body50
  %Scan.0.val243 = load ptr, ptr %Scan.0402, align 8
  store ptr %Scan.0.val243, ptr %Scan.0.in401, align 8
  store ptr %PIndL.0400, ptr %Scan.0402, align 8
  br label %for.inc57

for.inc57:                                        ; preds = %for.body50, %if.then54
  %PIndL.1 = phi ptr [ %Scan.0402, %if.then54 ], [ %PIndL.0400, %for.body50 ]
  %Scan.1 = phi ptr [ %Scan.0.in401, %if.then54 ], [ %Scan.0402, %for.body50 ]
...
for.end59.loopexit:                               ; preds = %for.inc57
  %LitList.3.val242.pre = load ptr, ptr %LitList.3407, align 8
  br label %for.end59
...
for.end59:                                        ; preds = %for.end59.loopexit, %if.end44
  ...
  store ptr %27, ptr %LitList.3407, align 8
  %28 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %LitList.3407, ptr %28, align 8
...
clause_RemoveFlag.exit:                           ; preds = %for.end59, %if.then.i270
  ...
  %cmp.i271.not404 = icmp eq ptr %PIndL.0.lcssa, null
  br i1 %cmp.i271.not404, label %for.end71.thread, label %for.body66

for.body66:                                       ; preds = %clause_RemoveFlag.exit, %clause_LiteralGetIndex.exit
  %Scan.2405 = phi ptr [ %Scan.2.val241, %clause_LiteralGetIndex.exit ], [ %PIndL.0.lcssa, %clause_RemoveFlag.exit ]
  %30 = getelementptr i8, ptr %Scan.2405, i64 8
...
clause_LiteralGetIndex.exit:                      ; preds = %while.cond.i
  %sext368 = shl i64 %indvars.iv.i, 32
  %conv = ashr exact i64 %sext368, 32
  %34 = inttoptr i64 %conv to ptr
  store ptr %34, ptr %30, align 8
  %Scan.2.val241 = load ptr, ptr %Scan.2405, align 8
...
if.else79:                                        ; preds = %for.end71
  br i1 %cmp.i271.not404, label %if.end80, label %while.body.i
...
if.else88:                                        ; preds = %entry
  %cmp98386 = icmp sgt i32 %add3.i, 0
  br i1 %cmp98386, label %for.body100.lr.ph, label %cleanup
...
for.body100.lr.ph:                                ; preds = %if.else88
  ...
  %arrayidx.i356 = getelementptr inbounds i32, ptr %Flags, i64 20
...
if.then.i291:                                     ; preds = %for.body100
  ...
  %call1.val.i289 = load ptr, ptr %50, align 8
  %51 = getelementptr i8, ptr %call1.val.i289, i64 8
  %call1.val.val.i290 = load ptr, ptr %51, align 8
...
clause_LiteralAtom.exit293:                       ; preds = %for.body100, %if.then.i291
  ...
  %cmp.i294 = icmp eq i32 %52, %call102.val
...
land.lhs.true.i298:                               ; preds = %for.body.i
  ...
  %cmp.i.i33.i = icmp eq i32 %62, %ActLit.val32.val.i
...
lor.rhs.i.thread.i:                               ; preds = %land.lhs.true.i298
  %cmp.i11.i55.i = icmp eq i32 %62, %L2.val10.val.i.i
...
red_GetBackMRResLits.exit:                        ; preds = %for.end.i
  %cmp.i304.not383 = icmp eq ptr %PClLits.1.lcssa.i, null
  br i1 %cmp.i304.not383, label %for.inc147, label %for.body111.lr.ph
...
for.body111:                                      ; preds = %for.body111.lr.ph, %if.end141
  %Blocked.3385 = phi ptr [ %Blocked.2388, %for.body111.lr.ph ], [ %Blocked.4, %if.end141 ]
  %LitScan.0384 = phi ptr [ %PClLits.1.lcssa.i, %for.body111.lr.ph ], [ %LitScan.0.val240, %if.end141 ]
  %69 = getelementptr i8, ptr %LitScan.0384, i64 8
  ...
  %call.val.i307 = load ptr, ptr %71, align 8
...
while.cond.i312:                                  ; preds = %while.cond.i312, %for.body111
  ...
  %72 = load ptr, ptr %arrayidx.i.i309, align 8
  %cmp.not.i310 = icmp eq ptr %72, %LitScan.0.val
...
if.else123:                                       ; preds = %if.end.i, %clause_LiteralGetIndex.exit313
  ...
  store ptr %Blocked.3385, ptr %call.i319, align 8
  br label %if.end125

if.end125:                                        ; preds = %if.then118, %if.then121, %if.else123
  %Blocked.4 = phi ptr [ %Blocked.3385, %if.then118 ], [ %Blocked.3385, %if.then121 ], [ %call.i319, %if.else123 ]
  %flags.i321 = getelementptr inbounds %struct.CLAUSE_HELP, ptr %call115, i64 0, i32 8
  %77 = load i32, ptr %flags.i321, align 8
  %and.i322 = and i32 %77, 1
...
clause_RemoveFlag.exit327:                        ; preds = %if.end125, %if.then.i325
  %78 = phi i32 [ %77, %if.end125 ], [ %sub.i324, %if.then.i325 ]
  %Partner.val20.i = load i32, ptr %43, align 8
  %and.i.i = and i32 %Partner.val20.i, 8
  %cmp.i.not.i328 = icmp eq i32 %and.i.i, 0
  br i1 %cmp.i.not.i328, label %if.end.i331, label %if.then.i329

if.then.i329:                                     ; preds = %clause_RemoveFlag.exit327
  %or.i.i = or i32 %78, 8
  store i32 %or.i.i, ptr %flags.i321, align 8
  br label %if.end.i331

if.end.i331:                                      ; preds = %if.then.i329, %clause_RemoveFlag.exit327
  %Partner.val19.i = load i32, ptr %44, align 4
  %cmp.i330 = icmp eq i32 %Partner.val19.i, 0
  br i1 %cmp.i330, label %clause_UpdateSplitDataFromPartner.exit, label %if.end3.i

if.end3.i:                                        ; preds = %if.end.i331
  %79 = getelementptr i8, ptr %call115, i64 12
  %Result.val17.i = load i32, ptr %79, align 4
  %Partner.val19.Result.val17.i = tail call i32 @llvm.umax.i32(i32 %Partner.val19.i, i32 %Result.val17.i)
  store i32 %Partner.val19.Result.val17.i, ptr %79, align 4
  %splitfield_length.i.i = getelementptr inbounds %struct.CLAUSE_HELP, ptr %call115, i64 0, i32 5
  %80 = load i32, ptr %splitfield_length.i.i, align 8
  %81 = load i32, ptr %splitfield_length1.i.i, align 8
  %cmp.i21.i = icmp ult i32 %80, %81
  br i1 %cmp.i21.i, label %if.then.i.i.i, label %if.end.i.i

if.then.i.i.i:                                    ; preds = %if.end3.i
  %mul.i.i.i = shl i32 %81, 3
  %call.i.i.i = tail call ptr @memory_Malloc(i32 noundef %mul.i.i.i) #11
  %82 = load i32, ptr %splitfield_length.i.i, align 8
  %cmp349.not.i.i.i = icmp eq i32 %82, 0
...
for.cond8.preheader.i.i.i:                        ; preds = %for.body.i.i.i, %if.then.i.i.i
  %.lcssa.i.i.i = phi i32 [ 0, %if.then.i.i.i ], [ %92, %for.body.i.i.i ]
  %cmp951.i.i.i = icmp ult i32 %.lcssa.i.i.i, %81
...
for.body11.preheader.i.i.i:                       ; preds = %for.cond8.preheader.i.i.i
  %83 = zext i32 %.lcssa.i.i.i to i64
  %84 = shl nuw nsw i64 %83, 3
  %scevgep.i.i.i = getelementptr i8, ptr %call.i.i.i, i64 %84
  %85 = xor i32 %.lcssa.i.i.i, -1
  %86 = add i32 %81, %85
  %87 = zext i32 %86 to i64
  %88 = shl nuw nsw i64 %87, 3
  %89 = add nuw nsw i64 %88, 8
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(1) %scevgep.i.i.i, i8 0, i64 %89, i1 false)
  br label %for.end16.i.i.i

for.body.i.i.i:                                   ; preds = %for.body.i.i.i, %for.body.lr.ph.i.i.i
  %indvars.iv.i.i.i = phi i64 [ 0, %for.body.lr.ph.i.i.i ], [ %indvars.iv.next.i.i.i, %for.body.i.i.i ]
  %90 = load ptr, ptr %splitfield.i.i.i, align 8
  %arrayidx.i.i.i332 = getelementptr inbounds i64, ptr %90, i64 %indvars.iv.i.i.i
  %91 = load i64, ptr %arrayidx.i.i.i332, align 8
  %arrayidx6.i.i.i = getelementptr inbounds i64, ptr %call.i.i.i, i64 %indvars.iv.i.i.i
  store i64 %91, ptr %arrayidx6.i.i.i, align 8
  %indvars.iv.next.i.i.i = add nuw nsw i64 %indvars.iv.i.i.i, 1
  %92 = load i32, ptr %splitfield_length.i.i, align 8
  %93 = zext i32 %92 to i64
  %cmp3.i.i.i = icmp ult i64 %indvars.iv.next.i.i.i, %93
...
for.end16.i.i.i:                                  ; preds = %for.body11.preheader.i.i.i, %for.cond8.preheader.i.i.i
  ...
  %94 = load ptr, ptr %splitfield17.i.i.i, align 8
  %cmp18.not.i.i.i = icmp eq ptr %94, null
  br i1 %cmp18.not.i.i.i, label %if.end.i.i.i, label %if.then20.i.i.i

if.then20.i.i.i:                                  ; preds = %for.end16.i.i.i
  %95 = load i32, ptr %splitfield_length.i.i, align 8
...
if.then.i.i.i.i:                                  ; preds = %if.then20.i.i.i
  ...
  %sub6.i.i.i.i.i.i = add i32 %45, %mul24.i.i.i
  %add7.i.i.i.i.i.i = sub i32 %sub6.i.i.i.i.i.i, %rem2.i.i.i.i.i.i
  %RealSize.1.i.i.i.i.i.i = select i1 %tobool3.not.i.i.i.i.i.i, i32 %mul24.i.i.i, i32 %add7.i.i.i.i.i.i
  %96 = load i32, ptr @memory_OFFSET, align 4
  %idx.ext.i.i.i.i = zext i32 %96 to i64
  %idx.neg.i.i.i.i = sub nsw i64 0, %idx.ext.i.i.i.i
  %add.ptr.i.i.i.i = getelementptr inbounds i8, ptr %94, i64 %idx.neg.i.i.i.i
  %add.ptr1.i.i.i.i = getelementptr inbounds i8, ptr %add.ptr.i.i.i.i, i64 -16
  %97 = load ptr, ptr %add.ptr1.i.i.i.i, align 8
  %cmp2.not.i.i.i.i = icmp eq ptr %97, null
  %next6.i.i.i.i = getelementptr inbounds i8, ptr %add.ptr.i.i.i.i, i64 -8
  %98 = load ptr, ptr %next6.i.i.i.i, align 8
  %next5.i.i.i.i = getelementptr inbounds %struct.MEMORY_BIGBLOCKHEADERHELP, ptr %97, i64 0, i32 1
  %memory_BIGBLOCKS.sink.i.i.i.i = select i1 %cmp2.not.i.i.i.i, ptr @memory_BIGBLOCKS, ptr %next5.i.i.i.i
  store ptr %98, ptr %memory_BIGBLOCKS.sink.i.i.i.i, align 8
  %99 = load ptr, ptr %next6.i.i.i.i, align 8
  %cmp8.not.i.i.i.i = icmp eq ptr %99, null
  br i1 %cmp8.not.i.i.i.i, label %if.end13.i.i.i.i, label %if.then9.i.i.i.i

if.then9.i.i.i.i:                                 ; preds = %if.then.i.i.i.i
  %100 = load ptr, ptr %add.ptr1.i.i.i.i, align 8
  store ptr %100, ptr %99, align 8
  br label %if.end13.i.i.i.i

if.end13.i.i.i.i:                                 ; preds = %if.then9.i.i.i.i, %if.then.i.i.i.i
  %101 = load i32, ptr @memory_MARKSIZE, align 4
  %add.i.i.i.i = add i32 %101, %RealSize.1.i.i.i.i.i.i
...
if.end23.i.i.i.i:                                 ; preds = %if.then18.i.i.i.i, %if.end13.i.i.i.i
  %add.ptr24.i.i.i.i = getelementptr inbounds i8, ptr %94, i64 -16
...
if.else25.i.i.i.i:                                ; preds = %if.then20.i.i.i
  ...
  %104 = load ptr, ptr %arrayidx.i.i.i.i, align 8
  %total_size.i.i.i.i = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %104, i64 0, i32 4
  %105 = load i32, ptr %total_size.i.i.i.i, align 8
  %conv26.i.i.i.i = sext i32 %105 to i64
  %106 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i.i = add i64 %106, %conv26.i.i.i.i
...
if.end.i.i.i:                                     ; preds = %if.else25.i.i.i.i, %if.end23.i.i.i.i, %for.end16.i.i.i
  store ptr %call.i.i.i, ptr %splitfield17.i.i.i, align 8
  store i32 %81, ptr %splitfield_length.i.i, align 8
  %.pre.i.i = load i32, ptr %splitfield_length1.i.i, align 8
  br label %if.end.i.i

if.end.i.i:                                       ; preds = %if.end.i.i.i, %if.end3.i
  %109 = phi i32 [ %.pre.i.i, %if.end.i.i.i ], [ %81, %if.end3.i ]
  %cmp421.not.i.i = icmp eq i32 %109, 0
...
for.body.i.i:                                     ; preds = %for.body.i.i, %for.body.lr.ph.i.i
  ...
  %110 = load ptr, ptr %splitfield.i.i, align 8
  %arrayidx.i.i334 = getelementptr inbounds i64, ptr %110, i64 %indvars.iv.i.i333
  %111 = load i64, ptr %arrayidx.i.i334, align 8
  %112 = load ptr, ptr %splitfield5.i.i, align 8
  %arrayidx7.i.i = getelementptr inbounds i64, ptr %112, i64 %indvars.iv.i.i333
  %113 = load i64, ptr %arrayidx7.i.i, align 8
  %or.i22.i = or i64 %113, %111
  store i64 %or.i22.i, ptr %arrayidx.i.i334, align 8
  %indvars.iv.next.i.i335 = add nuw nsw i64 %indvars.iv.i.i333, 1
  %114 = load i32, ptr %splitfield_length1.i.i, align 8
  %115 = zext i32 %114 to i64
  %cmp4.i.i = icmp ult i64 %indvars.iv.next.i.i335, %115
...
if.then127:                                       ; preds = %clause_UpdateSplitDataFromPartner.exit
  ...
  %116 = inttoptr i64 %conv128 to ptr
  %call.i.i336 = tail call ptr @memory_Malloc(i32 noundef 16) #11
  %car.i.i337 = getelementptr inbounds %struct.LIST_HELP, ptr %call.i.i336, i64 0, i32 1
  store ptr %116, ptr %car.i.i337, align 8
  store ptr null, ptr %call.i.i336, align 8
  %call.i.i338 = tail call ptr @memory_Malloc(i32 noundef 16) #11
  %car.i.i339 = getelementptr inbounds %struct.LIST_HELP, ptr %call.i.i338, i64 0, i32 1
  store ptr %46, ptr %car.i.i339, align 8
  store ptr null, ptr %call.i.i338, align 8
  %call.i.i340 = tail call ptr @memory_Malloc(i32 noundef 16) #11
  %car.i.i341 = getelementptr inbounds %struct.LIST_HELP, ptr %call.i.i340, i64 0, i32 1
  store ptr %67, ptr %car.i.i341, align 8
  store ptr null, ptr %call.i.i340, align 8
  br label %for.body.i346

for.body.i346:                                    ; preds = %if.then127, %for.body.i346
  %Help.042.i = phi ptr [ %call.i.i343, %for.body.i346 ], [ null, %if.then127 ]
  %Scan.041.i = phi ptr [ %Scan.0.val.i, %for.body.i346 ], [ %call.i.i336, %if.then127 ]
  %Clause.val20.i = load i32, ptr %call115, align 8
  %conv.i342 = sext i32 %Clause.val20.i to i64
  %117 = inttoptr i64 %conv.i342 to ptr
  %call.i.i343 = tail call ptr @memory_Malloc(i32 noundef 16) #11
  %car.i.i344 = getelementptr inbounds %struct.LIST_HELP, ptr %call.i.i343, i64 0, i32 1
  store ptr %117, ptr %car.i.i344, align 8
  store ptr %Help.042.i, ptr %call.i.i343, align 8
  %Scan.0.val.i = load ptr, ptr %Scan.041.i, align 8
  %cmp.i.not.i345 = icmp eq ptr %Scan.0.val.i, null
  br i1 %cmp.i.not.i345, label %for.end.i348, label %for.body.i346, !llvm.loop !29

for.end.i348:                                     ; preds = %for.body.i346
  %118 = getelementptr i8, ptr %call115, i64 32
  %Clause.val.i347 = load ptr, ptr %118, align 8
  %cmp.i.not5.i.i = icmp eq ptr %Clause.val.i347, null
  br i1 %cmp.i.not5.i.i, label %list_Delete.exit.i, label %while.body.i.i

while.body.i.i:                                   ; preds = %for.end.i348, %while.body.i.i
  %Current.06.i.i = phi ptr [ %L.addr.0.val.i.i, %while.body.i.i ], [ %Clause.val.i347, %for.end.i348 ]
  ...
  %total_size.i.i.i.i349 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %119, i64 0, i32 4
  %120 = load i32, ptr %total_size.i.i.i.i349, align 8
  %conv26.i.i.i.i350 = sext i32 %120 to i64
  %121 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i.i351 = add i64 %121, %conv26.i.i.i.i350
  store i64 %add27.i.i.i.i351, ptr @memory_FREEDBYTES, align 8
  %122 = load ptr, ptr %119, align 8
  store ptr %122, ptr %Current.06.i.i, align 8
  %123 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i.i, ptr %123, align 8
...
list_Delete.exit.i:                               ; preds = %while.body.i.i, %for.end.i348
  %124 = getelementptr i8, ptr %call115, i64 40
  %Clause.val19.i = load ptr, ptr %124, align 8
...
while.body.i28.i:                                 ; preds = %list_Delete.exit.i, %while.body.i28.i
  ...
  %total_size.i.i.i24.i = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %125, i64 0, i32 4
  %126 = load i32, ptr %total_size.i.i.i24.i, align 8
  %conv26.i.i.i25.i = sext i32 %126 to i64
  %127 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i26.i = add i64 %127, %conv26.i.i.i25.i
  store i64 %add27.i.i.i26.i, ptr @memory_FREEDBYTES, align 8
  %128 = load ptr, ptr %125, align 8
  store ptr %128, ptr %Current.06.i22.i, align 8
  %129 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i22.i, ptr %129, align 8
...
for.cond.i.i:                                     ; preds = %for.cond.i.i.preheader, %for.cond.i.i
  %List1.addr.0.i.i = phi ptr [ %List1.addr.0.val17.i.i, %for.cond.i.i ], [ %call.i.i343, %for.cond.i.i.preheader ]
...
for.end.i.i:                                      ; preds = %for.cond.i.i
  store ptr %call.i.i338, ptr %List1.addr.0.i.i, align 8
  store ptr %call.i.i343, ptr %118, align 8
  br label %for.cond.i36.i

for.cond.i36.i:                                   ; preds = %for.end.i.i, %for.cond.i36.i
  %List1.addr.0.i33.i = phi ptr [ %List1.addr.0.val17.i34.i, %for.cond.i36.i ], [ %call.i.i336, %for.end.i.i ]
...
for.end.i37.i:                                    ; preds = %for.cond.i36.i
  store ptr %call.i.i340, ptr %List1.addr.0.i33.i, align 8
  store ptr %call.i.i336, ptr %124, align 8
  %130 = load i32, ptr @clause_CLAUSECOUNTER, align 4
  %inc.i.i355 = add nsw i32 %130, 1
  store i32 %inc.i.i355, ptr @clause_CLAUSECOUNTER, align 4
  store i32 %130, ptr %call115, align 8
  %origin.i.i = getelementptr inbounds %struct.CLAUSE_HELP, ptr %call115, i64 0, i32 14
  store i32 23, ptr %origin.i.i, align 4
  br label %if.end134

if.end134:                                        ; preds = %for.end.i37.i, %clause_UpdateSplitDataFromPartner.exit
  %131 = load i32, ptr %arrayidx.i356, align 4
  %tobool136.not = icmp eq i32 %131, 0
  br i1 %tobool136.not, label %if.end141, label %if.then137

if.then137:                                       ; preds = %if.end134
  %132 = load ptr, ptr @stdout, align 8
  %133 = tail call i64 @fwrite(ptr nonnull @.str.42, i64 33, i64 1, ptr %132)
...
if.end141:                                        ; preds = %if.then137, %if.end134
  ...
  %call.i357 = tail call ptr @memory_Malloc(i32 noundef 16) #11
  %car.i358 = getelementptr inbounds %struct.LIST_HELP, ptr %call.i357, i64 0, i32 1
  store ptr %call115, ptr %car.i358, align 8
  store ptr %134, ptr %call.i357, align 8
  store ptr %call.i357, ptr %Result, align 8
  %LitScan.0.val240 = load ptr, ptr %LitScan.0384, align 8
  %cmp.i304.not = icmp eq ptr %LitScan.0.val240, null
  br i1 %cmp.i304.not, label %for.end145, label %for.body111, !llvm.loop !30

for.end145:                                       ; preds = %if.end141
  br i1 %cmp.i304.not383, label %for.inc147, label %while.body.i366

while.body.i366:                                  ; preds = %for.end145, %while.body.i366
  %Current.06.i360 = phi ptr [ %L.addr.0.val.i361, %while.body.i366 ], [ %PClLits.1.lcssa.i, %for.end145 ]
  %L.addr.0.val.i361 = load ptr, ptr %Current.06.i360, align 8
  %135 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i362 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %135, i64 0, i32 4
  %136 = load i32, ptr %total_size.i.i.i362, align 8
  %conv26.i.i.i363 = sext i32 %136 to i64
  %137 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i364 = add i64 %137, %conv26.i.i.i363
  store i64 %add27.i.i.i364, ptr @memory_FREEDBYTES, align 8
  %138 = load ptr, ptr %135, align 8
  store ptr %138, ptr %Current.06.i360, align 8
  %139 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i360, ptr %139, align 8
  %cmp.i.not.i365 = icmp eq ptr %L.addr.0.val.i361, null
  br i1 %cmp.i.not.i365, label %for.inc147, label %while.body.i366, !llvm.loop !8

for.inc147:                                       ; preds = %while.body.i366, %clause_LiteralAtom.exit.i, %red_GetBackMRResLits.exit, %for.end145, %clause_LiteralAtom.exit293
  %Blocked.5 = phi ptr [ %Blocked.2388, %clause_LiteralAtom.exit293 ], [ %Blocked.4, %for.end145 ], [ %Blocked.2388, %red_GetBackMRResLits.exit ], [ %Blocked.2388, %clause_LiteralAtom.exit.i ], [ %Blocked.4, %while.body.i366 ]
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
...
for.body.i:                                       ; preds = %if.then.i, %if.end.i
  ...
  %18 = getelementptr i8, ptr %LitList.05.i, i64 8
...
if.end7.i.i:                                      ; preds = %if.then3.i.i, %if.end.i68.i
  ...
  %and.i.i22 = and i32 %Partner.val20.i, 8
  %cmp.i.not.i23 = icmp eq i32 %and.i.i22, 0
  br i1 %cmp.i.not.i23, label %if.end.i26, label %if.then.i25
...
if.end3.i:                                        ; preds = %if.end.i26
  %57 = getelementptr i8, ptr %call30.i, i64 12
  %Result.val17.i = load i32, ptr %57, align 4
  %Partner.val19.Result.val17.i = tail call i32 @llvm.umax.i32(i32 %Partner.val19.i, i32 %Result.val17.i)
  store i32 %Partner.val19.Result.val17.i, ptr %57, align 4
  %splitfield_length.i.i = getelementptr inbounds %struct.CLAUSE_HELP, ptr %call30.i, i64 0, i32 5
  %58 = load i32, ptr %splitfield_length.i.i, align 8
  %59 = load i32, ptr %splitfield_length1.i.i, align 8
  %cmp.i21.i = icmp ult i32 %58, %59
  br i1 %cmp.i21.i, label %if.then.i.i.i, label %if.end.i.i33

if.then.i.i.i:                                    ; preds = %if.end3.i
  %mul.i.i.i = shl i32 %59, 3
  %call.i.i.i = tail call ptr @memory_Malloc(i32 noundef %mul.i.i.i) #11
  %60 = load i32, ptr %splitfield_length.i.i, align 8
  %cmp349.not.i.i.i = icmp eq i32 %60, 0
  br i1 %cmp349.not.i.i.i, label %for.cond8.preheader.i.i.i, label %for.body.lr.ph.i.i.i
...
for.cond8.preheader.i.i.i:                        ; preds = %for.body.i.i.i, %if.then.i.i.i
  %.lcssa.i.i.i = phi i32 [ 0, %if.then.i.i.i ], [ %70, %for.body.i.i.i ]
  %cmp951.i.i.i = icmp ult i32 %.lcssa.i.i.i, %59
  br i1 %cmp951.i.i.i, label %for.body11.preheader.i.i.i, label %for.end16.i.i.i

for.body11.preheader.i.i.i:                       ; preds = %for.cond8.preheader.i.i.i
  %61 = zext i32 %.lcssa.i.i.i to i64
  %62 = shl nuw nsw i64 %61, 3
  %scevgep.i.i.i = getelementptr i8, ptr %call.i.i.i, i64 %62
  %63 = xor i32 %.lcssa.i.i.i, -1
  %64 = add i32 %59, %63
  %65 = zext i32 %64 to i64
  %66 = shl nuw nsw i64 %65, 3
  %67 = add nuw nsw i64 %66, 8
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(1) %scevgep.i.i.i, i8 0, i64 %67, i1 false)
  br label %for.end16.i.i.i

for.body.i.i.i:                                   ; preds = %for.body.i.i.i, %for.body.lr.ph.i.i.i
  %indvars.iv.i.i.i = phi i64 [ 0, %for.body.lr.ph.i.i.i ], [ %indvars.iv.next.i.i.i, %for.body.i.i.i ]
  %68 = load ptr, ptr %splitfield.i.i.i, align 8
  %arrayidx.i.i.i27 = getelementptr inbounds i64, ptr %68, i64 %indvars.iv.i.i.i
  %69 = load i64, ptr %arrayidx.i.i.i27, align 8
  %arrayidx6.i.i.i = getelementptr inbounds i64, ptr %call.i.i.i, i64 %indvars.iv.i.i.i
  store i64 %69, ptr %arrayidx6.i.i.i, align 8
  %indvars.iv.next.i.i.i = add nuw nsw i64 %indvars.iv.i.i.i, 1
  %70 = load i32, ptr %splitfield_length.i.i, align 8
  %71 = zext i32 %70 to i64
  %cmp3.i.i.i = icmp ult i64 %indvars.iv.next.i.i.i, %71
  br i1 %cmp3.i.i.i, label %for.body.i.i.i, label %for.cond8.preheader.i.i.i, !llvm.loop !27

for.end16.i.i.i:                                  ; preds = %for.body11.preheader.i.i.i, %for.cond8.preheader.i.i.i
  %splitfield17.i.i.i = getelementptr inbounds %struct.CLAUSE_HELP, ptr %call30.i, i64 0, i32 4
  %72 = load ptr, ptr %splitfield17.i.i.i, align 8
  %cmp18.not.i.i.i = icmp eq ptr %72, null
  br i1 %cmp18.not.i.i.i, label %if.end.i.i.i, label %if.then20.i.i.i

if.then20.i.i.i:                                  ; preds = %for.end16.i.i.i
  %73 = load i32, ptr %splitfield_length.i.i, align 8
  %mul24.i.i.i = shl i32 %73, 3
  %cmp.i.i.i.i.i = icmp ult i32 %mul24.i.i.i, 1024
  br i1 %cmp.i.i.i.i.i, label %if.else25.i.i.i.i, label %if.then.i.i.i.i
...
if.then.i.i.i.i:                                  ; preds = %if.then20.i.i.i
  ...
  %tobool3.not.i.i.i.i.i.i = icmp eq i32 %rem2.i.i.i.i.i.i, 0
  %sub6.i.i.i.i.i.i = add i32 %7, %mul24.i.i.i
  %add7.i.i.i.i.i.i = sub i32 %sub6.i.i.i.i.i.i, %rem2.i.i.i.i.i.i
  %RealSize.1.i.i.i.i.i.i = select i1 %tobool3.not.i.i.i.i.i.i, i32 %mul24.i.i.i, i32 %add7.i.i.i.i.i.i
  %74 = load i32, ptr @memory_OFFSET, align 4
  %idx.ext.i.i.i.i = zext i32 %74 to i64
  %idx.neg.i.i.i.i = sub nsw i64 0, %idx.ext.i.i.i.i
  %add.ptr.i.i.i.i = getelementptr inbounds i8, ptr %72, i64 %idx.neg.i.i.i.i
  %add.ptr1.i.i.i.i = getelementptr inbounds i8, ptr %add.ptr.i.i.i.i, i64 -16
  %75 = load ptr, ptr %add.ptr1.i.i.i.i, align 8
  %cmp2.not.i.i.i.i = icmp eq ptr %75, null
  %next6.i.i.i.i = getelementptr inbounds i8, ptr %add.ptr.i.i.i.i, i64 -8
  %76 = load ptr, ptr %next6.i.i.i.i, align 8
  %next5.i.i.i.i = getelementptr inbounds %struct.MEMORY_BIGBLOCKHEADERHELP, ptr %75, i64 0, i32 1
  %memory_BIGBLOCKS.sink.i.i.i.i = select i1 %cmp2.not.i.i.i.i, ptr @memory_BIGBLOCKS, ptr %next5.i.i.i.i
  store ptr %76, ptr %memory_BIGBLOCKS.sink.i.i.i.i, align 8
  %77 = load ptr, ptr %next6.i.i.i.i, align 8
  %cmp8.not.i.i.i.i = icmp eq ptr %77, null
  br i1 %cmp8.not.i.i.i.i, label %if.end13.i.i.i.i, label %if.then9.i.i.i.i

if.then9.i.i.i.i:                                 ; preds = %if.then.i.i.i.i
  %78 = load ptr, ptr %add.ptr1.i.i.i.i, align 8
  store ptr %78, ptr %77, align 8
  br label %if.end13.i.i.i.i

if.end13.i.i.i.i:                                 ; preds = %if.then9.i.i.i.i, %if.then.i.i.i.i
  %79 = load i32, ptr @memory_MARKSIZE, align 4
  %add.i.i.i.i = add i32 %79, %RealSize.1.i.i.i.i.i.i
  ...
  %add15.i.i.i.i = add i64 %add14.i.i.i.i, %80
  store i64 %add15.i.i.i.i, ptr @memory_FREEDBYTES, align 8
  %81 = load i64, ptr @memory_MAXMEM, align 8
  %cmp16.i.i.i.i = icmp sgt i64 %81, -1
  br i1 %cmp16.i.i.i.i, label %if.then18.i.i.i.i, label %if.end23.i.i.i.i

if.then18.i.i.i.i:                                ; preds = %if.end13.i.i.i.i
  %add22.i.i.i.i = add nuw i64 %81, %add14.i.i.i.i
  store i64 %add22.i.i.i.i, ptr @memory_MAXMEM, align 8
  br label %if.end23.i.i.i.i

if.end23.i.i.i.i:                                 ; preds = %if.then18.i.i.i.i, %if.end13.i.i.i.i
  %add.ptr24.i.i.i.i = getelementptr inbounds i8, ptr %72, i64 -16
  tail call void @free(ptr noundef nonnull %add.ptr24.i.i.i.i) #11
  br label %if.end.i.i.i
...
if.else25.i.i.i.i:                                ; preds = %if.then20.i.i.i
  ...
  %82 = load ptr, ptr %arrayidx.i.i.i.i29, align 8
  %total_size.i.i.i.i30 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %82, i64 0, i32 4
  %83 = load i32, ptr %total_size.i.i.i.i30, align 8
  %conv26.i.i.i.i31 = sext i32 %83 to i64
  %84 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i.i32 = add i64 %84, %conv26.i.i.i.i31
  store i64 %add27.i.i.i.i32, ptr @memory_FREEDBYTES, align 8
  %85 = load ptr, ptr %82, align 8
  store ptr %85, ptr %72, align 8
  %86 = load ptr, ptr %arrayidx.i.i.i.i29, align 8
  store ptr %72, ptr %86, align 8
  br label %if.end.i.i.i

if.end.i.i.i:                                     ; preds = %if.else25.i.i.i.i, %if.end23.i.i.i.i, %for.end16.i.i.i
  store ptr %call.i.i.i, ptr %splitfield17.i.i.i, align 8
  store i32 %59, ptr %splitfield_length.i.i, align 8
  %.pre.i.i = load i32, ptr %splitfield_length1.i.i, align 8
  br label %if.end.i.i33

if.end.i.i33:                                     ; preds = %if.end.i.i.i, %if.end3.i
  %87 = phi i32 [ %.pre.i.i, %if.end.i.i.i ], [ %59, %if.end3.i ]
  %cmp421.not.i.i = icmp eq i32 %87, 0
  br i1 %cmp421.not.i.i, label %clause_UpdateSplitDataFromPartner.exit, label %for.body.lr.ph.i.i
...
for.body.i.i:                                     ; preds = %for.body.i.i, %for.body.lr.ph.i.i
  ...
  %88 = load ptr, ptr %splitfield.i.i, align 8
  %arrayidx.i.i = getelementptr inbounds i64, ptr %88, i64 %indvars.iv.i.i34
  %89 = load i64, ptr %arrayidx.i.i, align 8
  %90 = load ptr, ptr %splitfield5.i.i, align 8
  %arrayidx7.i.i = getelementptr inbounds i64, ptr %90, i64 %indvars.iv.i.i34
  %91 = load i64, ptr %arrayidx7.i.i, align 8
  %or.i22.i = or i64 %91, %89
  store i64 %or.i22.i, ptr %arrayidx.i.i, align 8
  %indvars.iv.next.i.i35 = add nuw nsw i64 %indvars.iv.i.i34, 1
  %92 = load i32, ptr %splitfield_length1.i.i, align 8
  %93 = zext i32 %92 to i64
  %cmp4.i.i = icmp ult i64 %indvars.iv.next.i.i35, %93
  br i1 %cmp4.i.i, label %for.body.i.i, label %clause_UpdateSplitDataFromPartner.exit, !llvm.loop !28

clause_UpdateSplitDataFromPartner.exit:           ; preds = %for.body.i.i, %if.end.i26, %if.end.i.i33
  %94 = load i32, ptr %arrayidx.i36.i.i, align 4
  %tobool17.not.i.i = icmp eq i32 %94, 0
...
red_ApplyRewriting.exit.i:                        ; preds = %if.then18.i.i, %clause_UpdateSplitDataFromPartner.exit
  ...
  store ptr %95, ptr %call.i69.i, align 8
...
if.end.i:                                         ; preds = %while.body.i.i, %red_ApplyRewriting.exit.i, %land.lhs.true25.critedge.i, %land.lhs.true19.i, %clause_LiteralGetIndex.exit.i
  ...
  %total_size.i.i.i.i = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %96, i64 0, i32 4
  %97 = load i32, ptr %total_size.i.i.i.i, align 8
  %conv26.i.i.i.i = sext i32 %97 to i64
  %98 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i.i = add i64 %98, %conv26.i.i.i.i
  store i64 %add27.i.i.i.i, ptr @memory_FREEDBYTES, align 8
  %99 = load ptr, ptr %96, align 8
  store ptr %99, ptr %LitList.05.i, align 8
  %100 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %LitList.05.i, ptr %100, align 8
...
if.end.i21:                                       ; preds = %red_LiteralRewriting.exit
  %cmp.i18.i = icmp eq ptr %Blocked.040, null
...
for.inc:                                          ; preds = %if.then, %for.end.i, %if.end.i21, %red_LiteralRewriting.exit, %for.body
  %Blocked.1 = phi ptr [ %Blocked.040, %for.body ], [ %Blocked.3.i, %for.end.i ], [ %Blocked.040, %red_LiteralRewriting.exit ], [ %Blocked.3.i, %if.end.i21 ], [ %Blocked.040, %if.then ]
...
for.body.lr.ph:                                   ; preds = %entry
  ...
  %9 = getelementptr i8, ptr %RuleClause, i64 48
  %10 = getelementptr i8, ptr %RuleClause, i64 12
  %splitfield_length1.i.i79 = getelementptr inbounds %struct.CLAUSE_HELP, ptr %RuleClause, i64 0, i32 5
  %11 = load i32, ptr @memory_ALIGN, align 4
  %splitfield5.i.i142 = getelementptr inbounds %struct.CLAUSE_HELP, ptr %RuleClause, i64 0, i32 4
  %12 = sext i32 %Clause.val6.i.i to i64
  %13 = sext i32 %Clause.val.i.i to i64
  %14 = add nsw i64 %12, %13
  %15 = sext i32 %sub.i to i64
  br label %for.body

for.body:                                         ; preds = %for.body.lr.ph, %for.inc
  %indvars.iv = phi i64 [ %14, %for.body.lr.ph ], [ %indvars.iv.next, %for.inc ]
  ...
  %call5.val = load i32, ptr %17, align 8
  %tobool7.not = icmp eq i32 %call5.val, 0
  br i1 %tobool7.not, label %for.inc, label %land.lhs.true

land.lhs.true:                                    ; preds = %for.body
  %call5.val33 = load i32, ptr %16, align 8
  %18 = and i32 %call5.val33, 2
...
land.lhs.true10:                                  ; preds = %land.lhs.true
  ...
  %Equation.val.i = load ptr, ptr %19, align 8
  %20 = getelementptr i8, ptr %Equation.val.i, i64 16
  %call.val.i = load ptr, ptr %20, align 8
  %21 = getelementptr i8, ptr %call.val.i, i64 8
  %call.val.val.i = load ptr, ptr %21, align 8
  %22 = getelementptr i8, ptr %16, i64 16
  %L.val.i.i = load ptr, ptr %22, align 8
  %23 = getelementptr i8, ptr %L.val.i.i, i64 56
...
for.body.lr.ph.i:                                 ; preds = %clause_LiteralGetIndex.exit.i
  ...
  %26 = add i32 %add.i.i.i, %Clause.val7.i.i.i
  %wide.trip.count.i = zext i32 %26 to i64
  br label %for.body.i

for.body.i:                                       ; preds = %for.inc.i, %for.body.lr.ph.i
  %indvars.iv.i = phi i64 [ 0, %for.body.lr.ph.i ], [ %indvars.iv.next.i, %for.inc.i ]
  %cmp5.not.i = icmp eq i64 %indvars.iv.i, %25
...
if.then.i:                                        ; preds = %for.body.i
  ...
  %call6.val.i = load ptr, ptr %28, align 8
...
if.then.i.i:                                      ; preds = %if.then.i
  %30 = getelementptr i8, ptr %call6.val.i, i64 16
...
clause_LiteralAtom.exit.i:                        ; preds = %if.then.i.i, %if.then.i
  ...
  %cmp.i.i = icmp eq i32 %32, %call7.val45.i
...
if.then9.i:                                       ; preds = %clause_LiteralAtom.exit.i
  ...
  %call7.val.i = load ptr, ptr %33, align 8
  %34 = getelementptr i8, ptr %call7.val.i, i64 8
  %call7.val.val.i = load ptr, ptr %34, align 8
...
lor.lhs.false.i:                                  ; preds = %if.then9.i
  ...
  %call6.val46.i = load i32, ptr %35, align 8
  %tobool14.not.i = icmp eq i32 %call6.val46.i, 0
  br i1 %tobool14.not.i, label %land.lhs.true.i, label %for.inc.i

land.lhs.true.i:                                  ; preds = %lor.lhs.false.i
  %call7.val47.i = load ptr, ptr %33, align 8
  %call7.val47.val.i = load ptr, ptr %call7.val47.i, align 8
  %36 = getelementptr i8, ptr %call7.val47.val.i, i64 8
  %call7.val47.val.val.i = load ptr, ptr %36, align 8
...
for.inc.i:                                        ; preds = %if.else.i, %land.lhs.true.i, %lor.lhs.false.i, %for.body.i
  ...
  br i1 %exitcond.not.i, label %if.then.critedge.loopexit, label %for.body.i, !llvm.loop !35

if.then.critedge.loopexit:                        ; preds = %for.inc.i
  %37 = getelementptr i8, ptr %16, i64 24
  %Lit.val.i.pre = load ptr, ptr %37, align 8
...
if.then.critedge:                                 ; preds = %clause_LiteralGetIndex.exit.i, %if.then.critedge.loopexit
  ...
  %call10.i = tail call ptr @st_GetInstance(ptr noundef %38, ptr noundef %ShIndex.0.val.i, ptr noundef %call6.val.val.i) #11
  %cmp.i.not177.i = icmp eq ptr %call10.i, null
  br i1 %cmp.i.not177.i, label %for.end, label %for.body.lr.ph.i36

for.body.lr.ph.i36:                               ; preds = %if.then.critedge
  %arrayidx.i.i35 = getelementptr inbounds i32, ptr %Search.val.i, i64 9
  %39 = inttoptr i64 %indvars.iv to ptr
...
for.body.i38:                                     ; preds = %for.inc83.i, %for.body.lr.ph.i36
  %Inst.0179.i = phi ptr [ %call10.i, %for.body.lr.ph.i36 ], [ %L.val.i168.i, %for.inc83.i ]
  %Blocked.0178.i = phi ptr [ null, %for.body.lr.ph.i36 ], [ %Blocked.3.i, %for.inc83.i ]
  %41 = getelementptr i8, ptr %Inst.0179.i, i64 8
  %Inst.0.val.i = load ptr, ptr %41, align 8
...
if.then19.i:                                      ; preds = %symbol_IsPredicate.exit.i, %land.lhs.true.i39
  ...
  %cmp.i143.not174.i = icmp eq ptr %call20.i, null
  br i1 %cmp.i143.not174.i, label %for.inc83.i, label %for.body25.i

for.body25.i:                                     ; preds = %if.then19.i, %if.end80.i
  %Blocked.1176.i = phi ptr [ %Blocked.2.i, %if.end80.i ], [ %Blocked.0178.i, %if.then19.i ]
  %LitList.0175.i = phi ptr [ %L.val.i167.i, %if.end80.i ], [ %call20.i, %if.then19.i ]
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %HelpClause.i) #11
  %42 = getelementptr i8, ptr %LitList.0175.i, i64 8
  %LitList.0.val.i = load ptr, ptr %42, align 8
  %43 = getelementptr i8, ptr %LitList.0.val.i, i64 16
  %L.val.i.i40 = load ptr, ptr %43, align 8
  %44 = getelementptr i8, ptr %L.val.i.i40, i64 56
  %call.val.i.i41 = load ptr, ptr %44, align 8
...
while.cond.i.i46:                                 ; preds = %while.cond.i.i46, %for.body25.i
  ...
  %45 = load ptr, ptr %arrayidx.i.i.i43, align 8
  %cmp.not.i.i44 = icmp eq ptr %45, %LitList.0.val.i
...
clause_LiteralGetIndex.exit.i47:                  ; preds = %while.cond.i.i46
  %46 = trunc i64 %indvars.iv.i.i42 to i32
...
land.lhs.true31.i:                                ; preds = %clause_LiteralGetIndex.exit.i47
  %47 = getelementptr i8, ptr %L.val.i.i40, i64 64
  %call28.val.i = load i32, ptr %47, align 8
  %cmp33.not.i = icmp sgt i32 %call28.val.i, %46
  br i1 %cmp33.not.i, label %if.end80.i, label %land.lhs.true34.i

land.lhs.true34.i:                                ; preds = %land.lhs.true31.i
  %cmp.i.not6.i.i = icmp eq ptr %Blocked.1176.i, null
...
while.body.i.i:                                   ; preds = %land.lhs.true34.i, %if.end.i.i
  %List.addr.07.i.i = phi ptr [ %List.addr.0.val5.i.i, %if.end.i.i ], [ %Blocked.1176.i, %land.lhs.true34.i ]
  %48 = getelementptr i8, ptr %List.addr.07.i.i, i64 8
  %List.addr.0.val.i.i = load ptr, ptr %48, align 8
...
land.lhs.true37.critedge.i:                       ; preds = %if.end.i.i, %land.lhs.true34.i
  %call38.i = call fastcc i32 @red_CRwTautologyCheck(ptr noundef %Search, ptr noundef nonnull %L.val.i.i40, i32 noundef %46, ptr noundef nonnull %Inst.0.val.i, ptr noundef nonnull %RuleClause, i32 noundef %40, i32 noundef %Mode, ptr noundef nonnull %HelpClause.i), !range !5
  %tobool39.not.i = icmp eq i32 %call38.i, 0
...
if.then40.i:                                      ; preds = %land.lhs.true37.critedge.i
  ...
  store ptr %Blocked.1176.i, ptr %call.i.i, align 8
...
clause_RemoveFlag.exit.i:                         ; preds = %if.then.i.i49, %if.then40.i
  ...
  store i32 %50, ptr %arrayidx.i.i148.i, align 4
  store i32 0, ptr @cont_BINDINGS, align 4
  %52 = load ptr, ptr @cont_LEFTCONTEXT, align 8
  %call44.i = tail call i32 @unify_MatchBindings(ptr noundef %52, ptr noundef %call6.val.val.i, ptr noundef nonnull %Inst.0.val.i) #11
  ...
  %54 = load ptr, ptr %arrayidx.i.i150.i, align 8
  %55 = getelementptr i8, ptr %54, i64 24
  %call.val.i151.i = load ptr, ptr %55, align 8
  %56 = getelementptr i8, ptr %call.val.i151.i, i64 16
  %call49.val.i = load ptr, ptr %56, align 8
  %call49.val.val.i = load ptr, ptr %call49.val.i, align 8
  %57 = getelementptr i8, ptr %call49.val.val.i, i64 8
  %call49.val.val.val.i = load ptr, ptr %57, align 8
  %call51.i = tail call ptr @term_Copy(ptr noundef %call49.val.val.val.i) #11
  %call52.i = tail call ptr @cont_ApplyBindingsModuloMatching(ptr noundef %53, ptr noundef %call51.i, i32 noundef 1) #11
...
while.body.i153.i.prol:                           ; preds = %while.body.i153.i.preheader
  ...
  %call.val.i.i.i.i.prol = load ptr, ptr %59, align 8
  store ptr %call.val.i.i.i.i.prol, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i.i.prol = getelementptr inbounds %struct.binding, ptr %58, i64 0, i32 1
  ...
  %link.i.i.i.i.i.prol = getelementptr inbounds %struct.binding, ptr %60, i64 0, i32 4
...
while.body.i153.i.prol.loopexit:                  ; preds = %while.body.i153.i.prol, %while.body.i153.i.preheader
  ...
  %61 = icmp eq i32 %.pr.i.i, 1
  br i1 %61, label %while.end.i.i, label %while.body.i153.i

while.body.i153.i:                                ; preds = %while.body.i153.i.prol.loopexit, %while.body.i153.i
  %62 = phi i32 [ %dec.i.i.i.i.1, %while.body.i153.i ], [ %.unr, %while.body.i153.i.prol.loopexit ]
  %63 = load ptr, ptr @cont_LASTBINDING, align 8
  store ptr %63, ptr @cont_CURRENTBINDING, align 8
  %64 = getelementptr i8, ptr %63, i64 24
  %call.val.i.i.i.i = load ptr, ptr %64, align 8
  store ptr %call.val.i.i.i.i, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i.i = getelementptr inbounds %struct.binding, ptr %63, i64 0, i32 1
  ...
  %link.i.i.i.i.i = getelementptr inbounds %struct.binding, ptr %65, i64 0, i32 4
  ...
  %call.val.i.i.i.i.1 = load ptr, ptr %67, align 8
  store ptr %call.val.i.i.i.i.1, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i.i.1 = getelementptr inbounds %struct.binding, ptr %66, i64 0, i32 1
  ...
  %link.i.i.i.i.i.1 = getelementptr inbounds %struct.binding, ptr %68, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i.i.1, align 8
  %dec.i.i.i.i.1 = add nsw i32 %62, -2
...
while.end.i.i:                                    ; preds = %while.body.i153.i.prol.loopexit, %while.body.i153.i, %clause_RemoveFlag.exit.i
  %69 = load i32, ptr @cont_STACKPOINTER, align 4
  %cmp.i.i154.i = icmp eq i32 %69, 0
...
if.then.i157.i:                                   ; preds = %while.end.i.i
  ...
  %70 = load i32, ptr %arrayidx.i.i156.i, align 4
...
cont_BackTrack.exit.i:                            ; preds = %if.then.i157.i, %while.end.i.i
  %71 = getelementptr i8, ptr %call42.i, i64 56
  %call42.val.i = load ptr, ptr %71, align 8
  ...
  %72 = load ptr, ptr %arrayidx.i.i160.i, align 8
  %73 = getelementptr i8, ptr %72, i64 24
  %call.val.i161.i = load ptr, ptr %73, align 8
  %L.val7.val.i.i.i = load i32, ptr %call.val.i161.i, align 8
  %74 = load i32, ptr @fol_NOT, align 4
  %cmp.i.i.i.i = icmp eq i32 %74, %L.val7.val.i.i.i
  br i1 %cmp.i.i.i.i, label %if.then.i.i.i, label %clause_GetLiteralAtom.exit.i

if.then.i.i.i:                                    ; preds = %cont_BackTrack.exit.i
  %75 = getelementptr i8, ptr %call.val.i161.i, i64 16
  %call1.val.i.i.i = load ptr, ptr %75, align 8
  %76 = getelementptr i8, ptr %call1.val.i.i.i, i64 8
  %call1.val.val.i.i.i = load ptr, ptr %76, align 8
...
clause_GetLiteralAtom.exit.i:                     ; preds = %if.then.i.i.i, %cont_BackTrack.exit.i
  ...
  %77 = load i32, ptr %arrayidx.i.i35, align 4
  %tobool57.not.i = icmp eq i32 %77, 0
...
if.then60.i:                                      ; preds = %if.then58.i
  %78 = getelementptr i8, ptr %.pre.i, i64 32
  %.val.i = load ptr, ptr %78, align 8
  %79 = getelementptr i8, ptr %.pre.i, i64 40
  %.val137.i = load ptr, ptr %79, align 8
...
if.end67.i:                                       ; preds = %if.then60.i, %if.then58.i
  ...
  %80 = getelementptr i8, ptr %call42.i, i64 32
  %Clause.val.i.i50 = load ptr, ptr %80, align 8
...
list_Delete.exit.i.i:                             ; preds = %while.body.i.i.i, %if.end67.i
  %86 = getelementptr i8, ptr %call42.i, i64 40
  %Clause.val14.i.i = load ptr, ptr %86, align 8
...
while.body.i23.i.i:                               ; preds = %list_Delete.exit.i.i, %while.body.i23.i.i
  ...
  %total_size.i.i.i19.i.i = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %87, i64 0, i32 4
  %88 = load i32, ptr %total_size.i.i.i19.i.i, align 8
  %conv26.i.i.i20.i.i = sext i32 %88 to i64
  %89 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i21.i.i = add i64 %89, %conv26.i.i.i20.i.i
  store i64 %add27.i.i.i21.i.i, ptr @memory_FREEDBYTES, align 8
  %90 = load ptr, ptr %87, align 8
  store ptr %90, ptr %Current.06.i17.i.i, align 8
  %91 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i17.i.i, ptr %91, align 8
...
red_DocumentContextualRewriting.exit.i:           ; preds = %while.body.i23.i.i, %list_Delete.exit.i.i
  store ptr %PClauses.0.i, ptr %80, align 8
  store ptr %PLits.0.i, ptr %86, align 8
  %Clause.val15.i.i = load i32, ptr %call42.i, align 8
  %conv.i.i162.i = sext i32 %Clause.val15.i.i to i64
  %92 = inttoptr i64 %conv.i.i162.i to ptr
  ...
  store ptr %93, ptr %car.i.i29.i.i, align 8
  store ptr %94, ptr %call.i.i28.i.i, align 8
  store ptr %call.i.i28.i.i, ptr %86, align 8
  %RuleClause.val.i.i = load i32, ptr %RuleClause, align 8
  %conv.i30.i.i = sext i32 %RuleClause.val.i.i to i64
  %95 = inttoptr i64 %conv.i30.i.i to ptr
  ...
  store ptr %95, ptr %car.i.i33.i.i, align 8
  store ptr %96, ptr %call.i.i32.i.i, align 8
  store ptr %call.i.i32.i.i, ptr %80, align 8
  ...
  store ptr %39, ptr %car.i.i37.i.i, align 8
  store ptr %97, ptr %call.i.i36.i.i, align 8
  store ptr %call.i.i36.i.i, ptr %86, align 8
  %98 = load i32, ptr @clause_CLAUSECOUNTER, align 4
  %inc.i.i.i.i = add nsw i32 %98, 1
  store i32 %inc.i.i.i.i, ptr @clause_CLAUSECOUNTER, align 4
  store i32 %98, ptr %call42.i, align 8
...
if.end68.i:                                       ; preds = %red_DocumentContextualRewriting.exit.i, %clause_GetLiteralAtom.exit.i
  %Partner.val20.i67 = load i32, ptr %9, align 8
  %and.i.i68 = and i32 %Partner.val20.i67, 8
  %cmp.i.not.i69 = icmp eq i32 %and.i.i68, 0
  br i1 %cmp.i.not.i69, label %if.end.i75, label %if.then.i72

if.then.i72:                                      ; preds = %if.end68.i
  %99 = load i32, ptr %flags.i.i, align 8
  %or.i.i71 = or i32 %99, 8
  store i32 %or.i.i71, ptr %flags.i.i, align 8
  br label %if.end.i75

if.end.i75:                                       ; preds = %if.then.i72, %if.end68.i
  %Partner.val19.i73 = load i32, ptr %10, align 4
  %cmp.i74 = icmp eq i32 %Partner.val19.i73, 0
  br i1 %cmp.i74, label %clause_UpdateSplitDataFromPartner.exit151, label %if.end3.i81

if.end3.i81:                                      ; preds = %if.end.i75
  %100 = getelementptr i8, ptr %call42.i, i64 12
  %Result.val17.i76 = load i32, ptr %100, align 4
  %Partner.val19.Result.val17.i77 = tail call i32 @llvm.umax.i32(i32 %Partner.val19.i73, i32 %Result.val17.i76)
  store i32 %Partner.val19.Result.val17.i77, ptr %100, align 4
  %splitfield_length.i.i78 = getelementptr inbounds %struct.CLAUSE_HELP, ptr %call42.i, i64 0, i32 5
  %101 = load i32, ptr %splitfield_length.i.i78, align 8
  %102 = load i32, ptr %splitfield_length1.i.i79, align 8
  %cmp.i21.i80 = icmp ult i32 %101, %102
  br i1 %cmp.i21.i80, label %if.then.i.i.i85, label %if.end.i.i140

if.then.i.i.i85:                                  ; preds = %if.end3.i81
  %mul.i.i.i82 = shl i32 %102, 3
  %call.i.i.i83 = tail call ptr @memory_Malloc(i32 noundef %mul.i.i.i82) #11
  %103 = load i32, ptr %splitfield_length.i.i78, align 8
  %cmp349.not.i.i.i84 = icmp eq i32 %103, 0
  br i1 %cmp349.not.i.i.i84, label %for.cond8.preheader.i.i.i90, label %for.body.lr.ph.i.i.i87

for.body.lr.ph.i.i.i87:                           ; preds = %if.then.i.i.i85
  %splitfield.i.i.i86 = getelementptr inbounds %struct.CLAUSE_HELP, ptr %call42.i, i64 0, i32 4
  br label %for.body.i.i.i98

for.cond8.preheader.i.i.i90:                      ; preds = %for.body.i.i.i98, %if.then.i.i.i85
  %.lcssa.i.i.i88 = phi i32 [ 0, %if.then.i.i.i85 ], [ %113, %for.body.i.i.i98 ]
  %cmp951.i.i.i89 = icmp ult i32 %.lcssa.i.i.i88, %102
  br i1 %cmp951.i.i.i89, label %for.body11.preheader.i.i.i92, label %for.end16.i.i.i101

for.body11.preheader.i.i.i92:                     ; preds = %for.cond8.preheader.i.i.i90
  %104 = zext i32 %.lcssa.i.i.i88 to i64
  %105 = shl nuw nsw i64 %104, 3
  %scevgep.i.i.i91 = getelementptr i8, ptr %call.i.i.i83, i64 %105
  %106 = xor i32 %.lcssa.i.i.i88, -1
  %107 = add i32 %102, %106
  %108 = zext i32 %107 to i64
  %109 = shl nuw nsw i64 %108, 3
  %110 = add nuw nsw i64 %109, 8
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(1) %scevgep.i.i.i91, i8 0, i64 %110, i1 false)
  br label %for.end16.i.i.i101

for.body.i.i.i98:                                 ; preds = %for.body.i.i.i98, %for.body.lr.ph.i.i.i87
  %indvars.iv.i.i.i93 = phi i64 [ 0, %for.body.lr.ph.i.i.i87 ], [ %indvars.iv.next.i.i.i96, %for.body.i.i.i98 ]
  %111 = load ptr, ptr %splitfield.i.i.i86, align 8
  %arrayidx.i.i.i94 = getelementptr inbounds i64, ptr %111, i64 %indvars.iv.i.i.i93
  %112 = load i64, ptr %arrayidx.i.i.i94, align 8
  %arrayidx6.i.i.i95 = getelementptr inbounds i64, ptr %call.i.i.i83, i64 %indvars.iv.i.i.i93
  store i64 %112, ptr %arrayidx6.i.i.i95, align 8
  %indvars.iv.next.i.i.i96 = add nuw nsw i64 %indvars.iv.i.i.i93, 1
  %113 = load i32, ptr %splitfield_length.i.i78, align 8
  %114 = zext i32 %113 to i64
  %cmp3.i.i.i97 = icmp ult i64 %indvars.iv.next.i.i.i96, %114
  br i1 %cmp3.i.i.i97, label %for.body.i.i.i98, label %for.cond8.preheader.i.i.i90, !llvm.loop !27

for.end16.i.i.i101:                               ; preds = %for.body11.preheader.i.i.i92, %for.cond8.preheader.i.i.i90
  %splitfield17.i.i.i99 = getelementptr inbounds %struct.CLAUSE_HELP, ptr %call42.i, i64 0, i32 4
  %115 = load ptr, ptr %splitfield17.i.i.i99, align 8
  %cmp18.not.i.i.i100 = icmp eq ptr %115, null
  br i1 %cmp18.not.i.i.i100, label %if.end.i.i.i138, label %if.then20.i.i.i104

if.then20.i.i.i104:                               ; preds = %for.end16.i.i.i101
  %116 = load i32, ptr %splitfield_length.i.i78, align 8
  %mul24.i.i.i102 = shl i32 %116, 3
  %cmp.i.i.i.i.i103 = icmp ult i32 %mul24.i.i.i102, 1024
  br i1 %cmp.i.i.i.i.i103, label %if.else25.i.i.i.i136, label %if.then.i.i.i.i119

if.then.i.i.i.i119:                               ; preds = %if.then20.i.i.i104
  %rem2.i.i.i.i.i.i105 = urem i32 %mul24.i.i.i102, %11
  %tobool3.not.i.i.i.i.i.i106 = icmp eq i32 %rem2.i.i.i.i.i.i105, 0
  %sub6.i.i.i.i.i.i107 = add i32 %11, %mul24.i.i.i102
  %add7.i.i.i.i.i.i108 = sub i32 %sub6.i.i.i.i.i.i107, %rem2.i.i.i.i.i.i105
  %RealSize.1.i.i.i.i.i.i109 = select i1 %tobool3.not.i.i.i.i.i.i106, i32 %mul24.i.i.i102, i32 %add7.i.i.i.i.i.i108
  %117 = load i32, ptr @memory_OFFSET, align 4
  %idx.ext.i.i.i.i110 = zext i32 %117 to i64
  %idx.neg.i.i.i.i111 = sub nsw i64 0, %idx.ext.i.i.i.i110
  %add.ptr.i.i.i.i112 = getelementptr inbounds i8, ptr %115, i64 %idx.neg.i.i.i.i111
  %add.ptr1.i.i.i.i113 = getelementptr inbounds i8, ptr %add.ptr.i.i.i.i112, i64 -16
  %118 = load ptr, ptr %add.ptr1.i.i.i.i113, align 8
  %cmp2.not.i.i.i.i114 = icmp eq ptr %118, null
  %next6.i.i.i.i115 = getelementptr inbounds i8, ptr %add.ptr.i.i.i.i112, i64 -8
  %119 = load ptr, ptr %next6.i.i.i.i115, align 8
  %next5.i.i.i.i116 = getelementptr inbounds %struct.MEMORY_BIGBLOCKHEADERHELP, ptr %118, i64 0, i32 1
  %memory_BIGBLOCKS.sink.i.i.i.i117 = select i1 %cmp2.not.i.i.i.i114, ptr @memory_BIGBLOCKS, ptr %next5.i.i.i.i116
  store ptr %119, ptr %memory_BIGBLOCKS.sink.i.i.i.i117, align 8
  %120 = load ptr, ptr %next6.i.i.i.i115, align 8
  %cmp8.not.i.i.i.i118 = icmp eq ptr %120, null
  br i1 %cmp8.not.i.i.i.i118, label %if.end13.i.i.i.i126, label %if.then9.i.i.i.i120

if.then9.i.i.i.i120:                              ; preds = %if.then.i.i.i.i119
  %121 = load ptr, ptr %add.ptr1.i.i.i.i113, align 8
  store ptr %121, ptr %120, align 8
  br label %if.end13.i.i.i.i126

if.end13.i.i.i.i126:                              ; preds = %if.then9.i.i.i.i120, %if.then.i.i.i.i119
  %122 = load i32, ptr @memory_MARKSIZE, align 4
  %add.i.i.i.i121 = add i32 %122, %RealSize.1.i.i.i.i.i.i109
  %conv.i.i.i.i122 = zext i32 %add.i.i.i.i121 to i64
  %add14.i.i.i.i123 = add nuw nsw i64 %conv.i.i.i.i122, 16
  %123 = load i64, ptr @memory_FREEDBYTES, align 8
  %add15.i.i.i.i124 = add i64 %add14.i.i.i.i123, %123
  store i64 %add15.i.i.i.i124, ptr @memory_FREEDBYTES, align 8
  %124 = load i64, ptr @memory_MAXMEM, align 8
  %cmp16.i.i.i.i125 = icmp sgt i64 %124, -1
  br i1 %cmp16.i.i.i.i125, label %if.then18.i.i.i.i128, label %if.end23.i.i.i.i130

if.then18.i.i.i.i128:                             ; preds = %if.end13.i.i.i.i126
  %add22.i.i.i.i127 = add nuw i64 %124, %add14.i.i.i.i123
  store i64 %add22.i.i.i.i127, ptr @memory_MAXMEM, align 8
  br label %if.end23.i.i.i.i130

if.end23.i.i.i.i130:                              ; preds = %if.then18.i.i.i.i128, %if.end13.i.i.i.i126
  %add.ptr24.i.i.i.i129 = getelementptr inbounds i8, ptr %115, i64 -16
  tail call void @free(ptr noundef nonnull %add.ptr24.i.i.i.i129) #11
  br label %if.end.i.i.i138

if.else25.i.i.i.i136:                             ; preds = %if.then20.i.i.i104
  %idxprom.i.i.i.i131 = zext i32 %mul24.i.i.i102 to i64
  %arrayidx.i.i.i.i132 = getelementptr inbounds [0 x ptr], ptr @memory_ARRAY, i64 0, i64 %idxprom.i.i.i.i131
  %125 = load ptr, ptr %arrayidx.i.i.i.i132, align 8
  %total_size.i.i.i.i133 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %125, i64 0, i32 4
  %126 = load i32, ptr %total_size.i.i.i.i133, align 8
  %conv26.i.i.i.i134 = sext i32 %126 to i64
  %127 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i.i135 = add i64 %127, %conv26.i.i.i.i134
  store i64 %add27.i.i.i.i135, ptr @memory_FREEDBYTES, align 8
  %128 = load ptr, ptr %125, align 8
  store ptr %128, ptr %115, align 8
  %129 = load ptr, ptr %arrayidx.i.i.i.i132, align 8
  store ptr %115, ptr %129, align 8
  br label %if.end.i.i.i138

if.end.i.i.i138:                                  ; preds = %if.else25.i.i.i.i136, %if.end23.i.i.i.i130, %for.end16.i.i.i101
  store ptr %call.i.i.i83, ptr %splitfield17.i.i.i99, align 8
  store i32 %102, ptr %splitfield_length.i.i78, align 8
  %.pre.i.i137 = load i32, ptr %splitfield_length1.i.i79, align 8
  br label %if.end.i.i140

if.end.i.i140:                                    ; preds = %if.end.i.i.i138, %if.end3.i81
  %130 = phi i32 [ %.pre.i.i137, %if.end.i.i.i138 ], [ %102, %if.end3.i81 ]
  %cmp421.not.i.i139 = icmp eq i32 %130, 0
  br i1 %cmp421.not.i.i139, label %clause_UpdateSplitDataFromPartner.exit151, label %for.body.lr.ph.i.i143

for.body.lr.ph.i.i143:                            ; preds = %if.end.i.i140
  %splitfield.i.i141 = getelementptr inbounds %struct.CLAUSE_HELP, ptr %call42.i, i64 0, i32 4
  br label %for.body.i.i150

for.body.i.i150:                                  ; preds = %for.body.i.i150, %for.body.lr.ph.i.i143
  %indvars.iv.i.i144 = phi i64 [ 0, %for.body.lr.ph.i.i143 ], [ %indvars.iv.next.i.i148, %for.body.i.i150 ]
  %131 = load ptr, ptr %splitfield.i.i141, align 8
  %arrayidx.i.i145 = getelementptr inbounds i64, ptr %131, i64 %indvars.iv.i.i144
  %132 = load i64, ptr %arrayidx.i.i145, align 8
  %133 = load ptr, ptr %splitfield5.i.i142, align 8
  %arrayidx7.i.i146 = getelementptr inbounds i64, ptr %133, i64 %indvars.iv.i.i144
  %134 = load i64, ptr %arrayidx7.i.i146, align 8
  %or.i22.i147 = or i64 %134, %132
  store i64 %or.i22.i147, ptr %arrayidx.i.i145, align 8
  %indvars.iv.next.i.i148 = add nuw nsw i64 %indvars.iv.i.i144, 1
  %135 = load i32, ptr %splitfield_length1.i.i79, align 8
  %136 = zext i32 %135 to i64
  %cmp4.i.i149 = icmp ult i64 %indvars.iv.next.i.i148, %136
  br i1 %cmp4.i.i149, label %for.body.i.i150, label %clause_UpdateSplitDataFromPartner.exit151, !llvm.loop !28

clause_UpdateSplitDataFromPartner.exit151:        ; preds = %for.body.i.i150, %if.end.i75, %if.end.i.i140
  %cmp69.not.i = icmp eq ptr %.pre.i, null
  br i1 %cmp69.not.i, label %if.end71.i, label %if.then70.i

if.then70.i:                                      ; preds = %clause_UpdateSplitDataFromPartner.exit151
  %137 = getelementptr i8, ptr %.pre.i, i64 48
  %Partner.val20.i = load i32, ptr %137, align 8
  %and.i.i53 = and i32 %Partner.val20.i, 8
  %cmp.i.not.i54 = icmp eq i32 %and.i.i53, 0
  br i1 %cmp.i.not.i54, label %if.end.i57, label %if.then.i56

if.then.i56:                                      ; preds = %if.then70.i
  %138 = load i32, ptr %flags.i.i, align 8
  %or.i.i = or i32 %138, 8
  store i32 %or.i.i, ptr %flags.i.i, align 8
  br label %if.end.i57

if.end.i57:                                       ; preds = %if.then.i56, %if.then70.i
  %139 = getelementptr i8, ptr %.pre.i, i64 12
  %Partner.val19.i = load i32, ptr %139, align 4
  %cmp.i = icmp eq i32 %Partner.val19.i, 0
  br i1 %cmp.i, label %clause_UpdateSplitDataFromPartner.exit, label %if.end3.i

if.end3.i:                                        ; preds = %if.end.i57
  %140 = getelementptr i8, ptr %call42.i, i64 12
  %Result.val17.i = load i32, ptr %140, align 4
  %Partner.val19.Result.val17.i = tail call i32 @llvm.umax.i32(i32 %Partner.val19.i, i32 %Result.val17.i)
  store i32 %Partner.val19.Result.val17.i, ptr %140, align 4
  %splitfield_length.i.i = getelementptr inbounds %struct.CLAUSE_HELP, ptr %call42.i, i64 0, i32 5
  %141 = load i32, ptr %splitfield_length.i.i, align 8
  %splitfield_length1.i.i = getelementptr inbounds %struct.CLAUSE_HELP, ptr %.pre.i, i64 0, i32 5
  %142 = load i32, ptr %splitfield_length1.i.i, align 8
  %cmp.i21.i = icmp ult i32 %141, %142
  br i1 %cmp.i21.i, label %if.then.i.i.i58, label %if.end.i.i63

if.then.i.i.i58:                                  ; preds = %if.end3.i
  %mul.i.i.i = shl i32 %142, 3
  %call.i.i.i = tail call ptr @memory_Malloc(i32 noundef %mul.i.i.i) #11
  %143 = load i32, ptr %splitfield_length.i.i, align 8
  %cmp349.not.i.i.i = icmp eq i32 %143, 0
  br i1 %cmp349.not.i.i.i, label %for.cond8.preheader.i.i.i, label %for.body.lr.ph.i.i.i

for.body.lr.ph.i.i.i:                             ; preds = %if.then.i.i.i58
  %splitfield.i.i.i = getelementptr inbounds %struct.CLAUSE_HELP, ptr %call42.i, i64 0, i32 4
  br label %for.body.i.i.i

for.cond8.preheader.i.i.i:                        ; preds = %for.body.i.i.i, %if.then.i.i.i58
  %.lcssa.i.i.i = phi i32 [ 0, %if.then.i.i.i58 ], [ %153, %for.body.i.i.i ]
  %cmp951.i.i.i = icmp ult i32 %.lcssa.i.i.i, %142
  br i1 %cmp951.i.i.i, label %for.body11.preheader.i.i.i, label %for.end16.i.i.i

for.body11.preheader.i.i.i:                       ; preds = %for.cond8.preheader.i.i.i
  %144 = zext i32 %.lcssa.i.i.i to i64
  %145 = shl nuw nsw i64 %144, 3
  %scevgep.i.i.i = getelementptr i8, ptr %call.i.i.i, i64 %145
  %146 = xor i32 %.lcssa.i.i.i, -1
  %147 = add i32 %142, %146
  %148 = zext i32 %147 to i64
  %149 = shl nuw nsw i64 %148, 3
  %150 = add nuw nsw i64 %149, 8
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(1) %scevgep.i.i.i, i8 0, i64 %150, i1 false)
  br label %for.end16.i.i.i

for.body.i.i.i:                                   ; preds = %for.body.i.i.i, %for.body.lr.ph.i.i.i
  %indvars.iv.i.i.i = phi i64 [ 0, %for.body.lr.ph.i.i.i ], [ %indvars.iv.next.i.i.i, %for.body.i.i.i ]
  %151 = load ptr, ptr %splitfield.i.i.i, align 8
  %arrayidx.i.i.i59 = getelementptr inbounds i64, ptr %151, i64 %indvars.iv.i.i.i
  %152 = load i64, ptr %arrayidx.i.i.i59, align 8
  %arrayidx6.i.i.i = getelementptr inbounds i64, ptr %call.i.i.i, i64 %indvars.iv.i.i.i
  store i64 %152, ptr %arrayidx6.i.i.i, align 8
  %indvars.iv.next.i.i.i = add nuw nsw i64 %indvars.iv.i.i.i, 1
  %153 = load i32, ptr %splitfield_length.i.i, align 8
  %154 = zext i32 %153 to i64
  %cmp3.i.i.i = icmp ult i64 %indvars.iv.next.i.i.i, %154
  br i1 %cmp3.i.i.i, label %for.body.i.i.i, label %for.cond8.preheader.i.i.i, !llvm.loop !27

for.end16.i.i.i:                                  ; preds = %for.body11.preheader.i.i.i, %for.cond8.preheader.i.i.i
  %splitfield17.i.i.i = getelementptr inbounds %struct.CLAUSE_HELP, ptr %call42.i, i64 0, i32 4
  %155 = load ptr, ptr %splitfield17.i.i.i, align 8
  %cmp18.not.i.i.i = icmp eq ptr %155, null
  br i1 %cmp18.not.i.i.i, label %if.end.i.i.i, label %if.then20.i.i.i

if.then20.i.i.i:                                  ; preds = %for.end16.i.i.i
  %156 = load i32, ptr %splitfield_length.i.i, align 8
  %mul24.i.i.i = shl i32 %156, 3
  %cmp.i.i.i.i.i = icmp ult i32 %mul24.i.i.i, 1024
  br i1 %cmp.i.i.i.i.i, label %if.else25.i.i.i.i, label %if.then.i.i.i.i

if.then.i.i.i.i:                                  ; preds = %if.then20.i.i.i
  %rem2.i.i.i.i.i.i = urem i32 %mul24.i.i.i, %11
  %tobool3.not.i.i.i.i.i.i = icmp eq i32 %rem2.i.i.i.i.i.i, 0
  %sub6.i.i.i.i.i.i = add i32 %11, %mul24.i.i.i
  %add7.i.i.i.i.i.i = sub i32 %sub6.i.i.i.i.i.i, %rem2.i.i.i.i.i.i
  %RealSize.1.i.i.i.i.i.i = select i1 %tobool3.not.i.i.i.i.i.i, i32 %mul24.i.i.i, i32 %add7.i.i.i.i.i.i
  %157 = load i32, ptr @memory_OFFSET, align 4
  %idx.ext.i.i.i.i = zext i32 %157 to i64
  %idx.neg.i.i.i.i = sub nsw i64 0, %idx.ext.i.i.i.i
  %add.ptr.i.i.i.i = getelementptr inbounds i8, ptr %155, i64 %idx.neg.i.i.i.i
  %add.ptr1.i.i.i.i = getelementptr inbounds i8, ptr %add.ptr.i.i.i.i, i64 -16
  %158 = load ptr, ptr %add.ptr1.i.i.i.i, align 8
  %cmp2.not.i.i.i.i = icmp eq ptr %158, null
  %next6.i.i.i.i = getelementptr inbounds i8, ptr %add.ptr.i.i.i.i, i64 -8
  %159 = load ptr, ptr %next6.i.i.i.i, align 8
  %next5.i.i.i.i = getelementptr inbounds %struct.MEMORY_BIGBLOCKHEADERHELP, ptr %158, i64 0, i32 1
  %memory_BIGBLOCKS.sink.i.i.i.i = select i1 %cmp2.not.i.i.i.i, ptr @memory_BIGBLOCKS, ptr %next5.i.i.i.i
  store ptr %159, ptr %memory_BIGBLOCKS.sink.i.i.i.i, align 8
  %160 = load ptr, ptr %next6.i.i.i.i, align 8
  %cmp8.not.i.i.i.i = icmp eq ptr %160, null
  br i1 %cmp8.not.i.i.i.i, label %if.end13.i.i.i.i, label %if.then9.i.i.i.i

if.then9.i.i.i.i:                                 ; preds = %if.then.i.i.i.i
  %161 = load ptr, ptr %add.ptr1.i.i.i.i, align 8
  store ptr %161, ptr %160, align 8
  br label %if.end13.i.i.i.i

if.end13.i.i.i.i:                                 ; preds = %if.then9.i.i.i.i, %if.then.i.i.i.i
  %162 = load i32, ptr @memory_MARKSIZE, align 4
  %add.i.i.i.i = add i32 %162, %RealSize.1.i.i.i.i.i.i
  %conv.i.i.i.i = zext i32 %add.i.i.i.i to i64
  %add14.i.i.i.i = add nuw nsw i64 %conv.i.i.i.i, 16
  %163 = load i64, ptr @memory_FREEDBYTES, align 8
  %add15.i.i.i.i = add i64 %add14.i.i.i.i, %163
  store i64 %add15.i.i.i.i, ptr @memory_FREEDBYTES, align 8
  %164 = load i64, ptr @memory_MAXMEM, align 8
  %cmp16.i.i.i.i = icmp sgt i64 %164, -1
  br i1 %cmp16.i.i.i.i, label %if.then18.i.i.i.i, label %if.end23.i.i.i.i

if.then18.i.i.i.i:                                ; preds = %if.end13.i.i.i.i
  %add22.i.i.i.i = add nuw i64 %164, %add14.i.i.i.i
  store i64 %add22.i.i.i.i, ptr @memory_MAXMEM, align 8
  br label %if.end23.i.i.i.i

if.end23.i.i.i.i:                                 ; preds = %if.then18.i.i.i.i, %if.end13.i.i.i.i
  %add.ptr24.i.i.i.i = getelementptr inbounds i8, ptr %155, i64 -16
  tail call void @free(ptr noundef nonnull %add.ptr24.i.i.i.i) #11
  br label %if.end.i.i.i
...
if.else25.i.i.i.i:                                ; preds = %if.then20.i.i.i
  ...
  %total_size.i.i.i.i60 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %165, i64 0, i32 4
  %166 = load i32, ptr %total_size.i.i.i.i60, align 8
  %conv26.i.i.i.i61 = sext i32 %166 to i64
  %167 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i.i62 = add i64 %167, %conv26.i.i.i.i61
  store i64 %add27.i.i.i.i62, ptr @memory_FREEDBYTES, align 8
...
if.end.i.i.i:                                     ; preds = %if.else25.i.i.i.i, %if.end23.i.i.i.i, %for.end16.i.i.i
  store ptr %call.i.i.i, ptr %splitfield17.i.i.i, align 8
  store i32 %142, ptr %splitfield_length.i.i, align 8
  %.pre.i.i = load i32, ptr %splitfield_length1.i.i, align 8
  br label %if.end.i.i63

if.end.i.i63:                                     ; preds = %if.end.i.i.i, %if.end3.i
  %170 = phi i32 [ %.pre.i.i, %if.end.i.i.i ], [ %142, %if.end3.i ]
  %cmp421.not.i.i = icmp eq i32 %170, 0
  br i1 %cmp421.not.i.i, label %clause_UpdateSplitDataFromPartner.exit, label %for.body.lr.ph.i.i

for.body.lr.ph.i.i:                               ; preds = %if.end.i.i63
...
for.body.i.i:                                     ; preds = %for.body.i.i, %for.body.lr.ph.i.i
  %indvars.iv.i.i64 = phi i64 [ 0, %for.body.lr.ph.i.i ], [ %indvars.iv.next.i.i66, %for.body.i.i ]
  %171 = load ptr, ptr %splitfield.i.i, align 8
  %arrayidx.i.i65 = getelementptr inbounds i64, ptr %171, i64 %indvars.iv.i.i64
  %172 = load i64, ptr %arrayidx.i.i65, align 8
  %173 = load ptr, ptr %splitfield5.i.i, align 8
  %arrayidx7.i.i = getelementptr inbounds i64, ptr %173, i64 %indvars.iv.i.i64
  %174 = load i64, ptr %arrayidx7.i.i, align 8
  %or.i22.i = or i64 %174, %172
  store i64 %or.i22.i, ptr %arrayidx.i.i65, align 8
  %indvars.iv.next.i.i66 = add nuw nsw i64 %indvars.iv.i.i64, 1
  %175 = load i32, ptr %splitfield_length1.i.i, align 8
  %176 = zext i32 %175 to i64
  %cmp4.i.i = icmp ult i64 %indvars.iv.next.i.i66, %176
  br i1 %cmp4.i.i, label %for.body.i.i, label %clause_UpdateSplitDataFromPartner.exit, !llvm.loop !28

clause_UpdateSplitDataFromPartner.exit:           ; preds = %for.body.i.i, %if.end.i57, %if.end.i.i63
  tail call void @clause_Delete(ptr noundef nonnull %.pre.i) #11
  br label %if.end71.i

if.end71.i:                                       ; preds = %clause_UpdateSplitDataFromPartner.exit, %clause_UpdateSplitDataFromPartner.exit151
  ...
  %177 = load i32, ptr %arrayidx.i164.i, align 4
  %tobool73.not.i = icmp eq i32 %177, 0
  br i1 %tobool73.not.i, label %if.end78.i, label %if.then74.i

if.then74.i:                                      ; preds = %if.end71.i
  %178 = load ptr, ptr @stdout, align 8
  %179 = tail call i64 @fwrite(ptr nonnull @.str.45, i64 17, i64 1, ptr %178)
  tail call void @clause_Print(ptr noundef nonnull %L.val.i.i40) #11
  %RuleClause.val.i = load i32, ptr %RuleClause, align 8
  %call77.i = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.43, i32 noundef %RuleClause.val.i, i32 noundef %40)
...
if.end78.i:                                       ; preds = %if.then74.i, %if.end71.i
  ...
  store ptr %180, ptr %call.i165.i, align 8
...
if.end80.i:                                       ; preds = %while.body.i.i, %if.end78.i, %land.lhs.true37.critedge.i, %land.lhs.true31.i, %clause_LiteralGetIndex.exit.i47
  %Blocked.2.i = phi ptr [ %call.i.i, %if.end78.i ], [ %Blocked.1176.i, %land.lhs.true37.critedge.i ], [ %Blocked.1176.i, %land.lhs.true31.i ], [ %Blocked.1176.i, %clause_LiteralGetIndex.exit.i47 ], [ %Blocked.1176.i, %while.body.i.i ]
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %HelpClause.i) #11
  %L.val.i167.i = load ptr, ptr %LitList.0175.i, align 8
  %181 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i.i = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %181, i64 0, i32 4
  %182 = load i32, ptr %total_size.i.i.i.i, align 8
  %conv26.i.i.i.i = sext i32 %182 to i64
  %183 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i.i = add i64 %183, %conv26.i.i.i.i
  store i64 %add27.i.i.i.i, ptr @memory_FREEDBYTES, align 8
  %184 = load ptr, ptr %181, align 8
  store ptr %184, ptr %LitList.0175.i, align 8
  %185 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %LitList.0175.i, ptr %185, align 8
...
for.inc83.i:                                      ; preds = %if.end80.i, %if.then19.i, %symbol_IsPredicate.exit.i, %for.body.i38
  %Blocked.3.i = phi ptr [ %Blocked.0178.i, %for.body.i38 ], [ %Blocked.0178.i, %symbol_IsPredicate.exit.i ], [ %Blocked.0178.i, %if.then19.i ], [ %Blocked.2.i, %if.end80.i ]
  %L.val.i168.i = load ptr, ptr %Inst.0179.i, align 8
  %186 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i169.i = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %186, i64 0, i32 4
  %187 = load i32, ptr %total_size.i.i.i169.i, align 8
  %conv26.i.i.i170.i = sext i32 %187 to i64
  %188 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i171.i = add i64 %188, %conv26.i.i.i170.i
  store i64 %add27.i.i.i171.i, ptr @memory_FREEDBYTES, align 8
  %189 = load ptr, ptr %186, align 8
  store ptr %189, ptr %Inst.0179.i, align 8
  %190 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Inst.0179.i, ptr %190, align 8
  %cmp.i.not.i = icmp eq ptr %L.val.i168.i, null
  br i1 %cmp.i.not.i, label %for.end, label %for.body.i38, !llvm.loop !38

for.inc:                                          ; preds = %if.else.i, %land.lhs.true.i, %if.then9.i, %for.body, %land.lhs.true
  %indvars.iv.next = add nsw i64 %indvars.iv, 1
  %cmp = icmp slt i64 %indvars.iv, %15
...
for.body:                                         ; preds = %if.else, %for.body
  ...
  br i1 %cmp.i124.not, label %if.end64, label %for.body, !llvm.loop !40
...
for.body67:                                       ; preds = %for.cond60.preheader, %if.end84
  %Scan.1273 = phi ptr [ %Scan.1.val187, %if.end84 ], [ %call49, %for.cond60.preheader ]
  %ApproxWOList.1268 = phi ptr [ %ApproxWOList.5256, %if.end84 ], [ %call.i203, %for.cond60.preheader ]
  %ApproxUsableList.1267 = phi ptr [ %ApproxUsableList.5254, %if.end84 ], [ %call47, %for.cond60.preheader ]
...
for.inc20.i.i.i:                                  ; preds = %for.end.i.i.i, %clause_GetLiteralAtom.exit.i.i.i
  ...
  br i1 %exitcond.not.i.i.i, label %if.else.i215, label %for.body.i.i.i, !llvm.loop !45
...
for.inc.i.i:                                      ; preds = %while.body.i.i36.i, %if.then20.critedge.i.i, %clause_LiteralGetIndex.exit.i.i, %for.body.i.i
  ...
  br i1 %cmp.i.not.i.i, label %for.end.i.i, label %for.body.i.i, !llvm.loop !46
...
for.body28.i.i:                                   ; preds = %for.cond24.preheader.i.i, %if.end39.i.i
  %ApproxUsableList.2 = phi ptr [ %call44.i.i.ApproxUsableList.2, %if.end39.i.i ], [ %ApproxUsableList.1267, %for.cond24.preheader.i.i ]
  %ApproxWOList.2 = phi ptr [ %ApproxWOList.2.call44.i.i, %if.end39.i.i ], [ %ApproxWOList.1268, %for.cond24.preheader.i.i ]
...
if.end39.i.i:                                     ; preds = %if.then35.i.i, %land.lhs.true32.i.i, %for.body28.i.i
  ...
  %cmp.i86.not.i.i = icmp eq i32 %and.i.i.i, 0
  %.sroa.speculated = select i1 %cmp.i86.not.i.i, ptr %ApproxUsableList.2, ptr %ApproxWOList.2
  %call44.i.i = call ptr @list_PointerDeleteOneElement(ptr noundef %.sroa.speculated, ptr noundef nonnull %Scan.1.val.i.i) #11
  %call44.i.i.ApproxUsableList.2 = select i1 %cmp.i86.not.i.i, ptr %call44.i.i, ptr %ApproxUsableList.2
  %ApproxWOList.2.call44.i.i = select i1 %cmp.i86.not.i.i, ptr %ApproxWOList.2, ptr %call44.i.i
  ...
  br i1 %cmp.i83.not.i.i, label %while.body.i89.i.i, label %for.body28.i.i, !llvm.loop !48
...
red_CDBackSubsumption.exit.i:                     ; preds = %while.body.i89.i.i, %for.cond24.preheader.i.i, %clause_GetLiteralAtom.exit.i.i, %land.rhs.i.i.i
  %ApproxUsableList.4 = phi ptr [ %ApproxUsableList.1267, %clause_GetLiteralAtom.exit.i.i ], [ %ApproxUsableList.1267, %for.cond24.preheader.i.i ], [ %ApproxUsableList.1267, %land.rhs.i.i.i ], [ %call44.i.i.ApproxUsableList.2, %while.body.i89.i.i ]
  %ApproxWOList.4 = phi ptr [ %ApproxWOList.1268, %clause_GetLiteralAtom.exit.i.i ], [ %ApproxWOList.1268, %for.cond24.preheader.i.i ], [ %ApproxWOList.1268, %land.rhs.i.i.i ], [ %ApproxWOList.2.call44.i.i, %while.body.i89.i.i ]
...
if.else72:                                        ; preds = %red_CDBackSubsumption.exit.i, %clause_IsEmptyClause.exit.i
  %ApproxUsableList.5 = phi ptr [ %call.i.i216, %red_CDBackSubsumption.exit.i ], [ %ApproxUsableList.1267, %clause_IsEmptyClause.exit.i ]
  %ApproxWOList.5 = phi ptr [ %ApproxWOList.4, %red_CDBackSubsumption.exit.i ], [ %ApproxWOList.1268, %clause_IsEmptyClause.exit.i ]
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %Copy.i) #11
...
if.end84:                                         ; preds = %if.end78, %land.lhs.true.i, %land.lhs.true1.i, %clause_IsEmptyClause.exit, %if.then81, %if.then71
  %ApproxWOList.5256 = phi ptr [ %ApproxWOList.1268, %if.then71 ], [ %ApproxWOList.5, %if.then81 ], [ %ApproxWOList.5, %clause_IsEmptyClause.exit ], [ %ApproxWOList.5, %land.lhs.true1.i ], [ %ApproxWOList.5, %land.lhs.true.i ], [ %ApproxWOList.5, %if.end78 ]
  %ApproxUsableList.5254 = phi ptr [ %ApproxUsableList.1267, %if.then71 ], [ %ApproxUsableList.5, %if.then81 ], [ %ApproxUsableList.5, %clause_IsEmptyClause.exit ], [ %ApproxUsableList.5, %land.lhs.true1.i ], [ %ApproxUsableList.5, %land.lhs.true.i ], [ %ApproxUsableList.5, %if.end78 ]
  store ptr null, ptr %31, align 8
  %Scan.1.val187 = load ptr, ptr %Scan.1273, align 8
  %cmp.i210 = icmp ne ptr %Scan.1.val187, null
  %86 = load ptr, ptr %EmptyClauses, align 8
  %cmp.i212 = icmp eq ptr %86, null
  %or.cond250 = select i1 %cmp.i210, i1 %cmp.i212, i1 false
  br i1 %or.cond250, label %for.body67, label %for.end87, !llvm.loop !49

for.end87:                                        ; preds = %if.end84
  %cmp.i225 = icmp eq ptr %86, null
  br i1 %cmp.i225, label %while.body.i235, label %if.then90
...
while.body.i235:                                  ; preds = %for.end87, %while.body.i235
  %Current.06.i229 = phi ptr [ %L.addr.0.val.i230, %while.body.i235 ], [ %call49, %for.end87 ]
  %L.addr.0.val.i230 = load ptr, ptr %Current.06.i229, align 8
  %90 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i231 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %90, i64 0, i32 4
  %91 = load i32, ptr %total_size.i.i.i231, align 8
  %conv26.i.i.i232 = sext i32 %91 to i64
  %92 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i233 = add i64 %92, %conv26.i.i.i232
  store i64 %add27.i.i.i233, ptr @memory_FREEDBYTES, align 8
  %93 = load ptr, ptr %90, align 8
  store ptr %93, ptr %Current.06.i229, align 8
  %94 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i229, ptr %94, align 8
...
if.end101thread-pre-split.sink.split.sink.split:  ; preds = %if.then55, %if.then93
  ...
  %.sink297 = load ptr, ptr %EmptyClauses, align 8
  %95 = getelementptr i8, ptr %.sink297, i64 8
...
if.end101thread-pre-split:                        ; preds = %while.body.i235, %if.end101thread-pre-split.sink.split
  %ApproxUsableList.6.ph = phi ptr [ %ApproxUsableList.6.ph.ph, %if.end101thread-pre-split.sink.split ], [ %ApproxUsableList.5254, %while.body.i235 ]
  %ApproxWOList.6.ph = phi ptr [ %ApproxWOList.6.ph.ph, %if.end101thread-pre-split.sink.split ], [ %ApproxWOList.5256, %while.body.i235 ]
...
while.end:                                        ; preds = %if.end101
  %cmp.i237 = icmp eq ptr %96, null
  br i1 %cmp.i237, label %if.else111, label %if.then104
...
if.else111:                                       ; preds = %while.end
  ...
  %98 = load i32, ptr %arrayidx.i240, align 4
...
entry:
  ...
  %cmp.i113 = icmp eq ptr %call4, null
  br i1 %cmp.i113, label %list_Delete.exit, label %while.body.lr.ph
...
for.cond36.preheader:                             ; preds = %if.end35
  %cmp.i89.not120 = icmp eq ptr %ClauseList.addr.1, null
  br i1 %cmp.i89.not120, label %for.end44, label %for.body40

while.body:                                       ; preds = %while.body.lr.ph, %if.end35
  %Derived.0118 = phi i32 [ %2, %while.body.lr.ph ], [ %Derived.2, %if.end35 ]
  %ClauseList.addr.0117 = phi ptr [ %call4, %while.body.lr.ph ], [ %ClauseList.addr.1, %if.end35 ]
  %car.i = getelementptr inbounds %struct.LIST_HELP, ptr %ClauseList.addr.0117, i64 0, i32 1
  %4 = load ptr, ptr %car.i, align 8
  %5 = load ptr, ptr %ClauseList.addr.0117, align 8
  ...
  store ptr %9, ptr %ClauseList.addr.0117, align 8
  %10 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %ClauseList.addr.0117, ptr %10, align 8
...
if.else:                                          ; preds = %land.lhs.true.i, %land.lhs.true1.i, %clause_IsEmptyClause.exit
  ...
  %cmp.not = icmp eq i32 %Derived.0118, 0
...
if.end25:                                         ; preds = %if.else
  ...
  %spec.select = call i32 @llvm.usub.sat.i32(i32 %Derived.0118, i32 %call19)
...
for.end.thread:                                   ; preds = %list_Nconc.exit
  %cmp.i.i79128 = icmp eq ptr %5, null
  br i1 %cmp.i.i79128, label %list_Delete.exit, label %if.end35
...
if.end35:                                         ; preds = %for.end, %for.end.thread, %for.end.i86, %if.then13, %while.body
  ...
  %Derived.2 = phi i32 [ %Derived.0118, %if.then13 ], [ %Derived.0118, %while.body ], [ %Derived.1106, %for.end.i86 ], [ %Derived.1106, %for.end ], [ %Derived.1106, %for.end.thread ]
  %cmp.i = icmp eq ptr %ClauseList.addr.1, null
  %15 = load ptr, ptr %EmptyClauses, align 8
  %cmp.i74 = icmp ne ptr %15, null
  %or.cond.not = select i1 %cmp.i, i1 true, i1 %cmp.i74
...
for.body40:                                       ; preds = %for.cond36.preheader, %for.body40
  %Scan.1121 = phi ptr [ %Scan.1.val72, %for.body40 ], [ %ClauseList.addr.1, %for.cond36.preheader ]
  %16 = getelementptr i8, ptr %Scan.1121, i64 8
  %Scan.1.val = load ptr, ptr %16, align 8
  call void @prfs_InsertUsableClause(ptr noundef %Search, ptr noundef %Scan.1.val) #11
  %Scan.1.val72 = load ptr, ptr %Scan.1121, align 8
...
for.end44:                                        ; preds = %for.body40, %for.cond36.preheader
  %ClauseList.addr.0.lcssa126 = phi ptr [ null, %for.cond36.preheader ], [ %ClauseList.addr.1, %for.body40 ]
  br i1 %cmp.i, label %list_Delete.exit, label %while.body.i

while.body.i:                                     ; preds = %for.end44, %while.body.i
  %Current.06.i = phi ptr [ %L.addr.0.val.i, %while.body.i ], [ %ClauseList.addr.0.lcssa126, %for.end44 ]
  %L.addr.0.val.i = load ptr, ptr %Current.06.i, align 8
...
entry:
  ...
  %cmp.i71 = icmp eq ptr %call5, null
  %2 = load ptr, ptr %EmptyClauses, align 8
  %cmp.i5473 = icmp ne ptr %2, null
  %or.cond74.not = select i1 %cmp.i71, i1 true, i1 %cmp.i5473
  br i1 %or.cond74.not, label %while.end, label %land.rhs.lr.ph
...
land.rhs:                                         ; preds = %land.rhs.lr.ph, %if.end27
  %ClauseList.addr.075 = phi ptr [ %call5, %land.rhs.lr.ph ], [ %ClauseList.addr.1, %if.end27 ]
...
while.body:                                       ; preds = %land.rhs, %lor.rhs
  %car.i = getelementptr inbounds %struct.LIST_HELP, ptr %ClauseList.addr.075, i64 0, i32 1
  %4 = load ptr, ptr %car.i, align 8
  %5 = load ptr, ptr %ClauseList.addr.075, align 8
  %6 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %6, i64 0, i32 4
  %7 = load i32, ptr %total_size.i.i.i, align 8
  %conv26.i.i.i = sext i32 %7 to i64
  ...
  store i64 %add27.i.i.i, ptr @memory_FREEDBYTES, align 8
  %9 = load ptr, ptr %6, align 8
  store ptr %9, ptr %ClauseList.addr.075, align 8
  %10 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %ClauseList.addr.075, ptr %10, align 8
...
if.end27:                                         ; preds = %if.then20, %if.else, %red_SpecialInputReductions.exit
  ...
  %cmp.i54 = icmp ne ptr %45, null
  %or.cond.not = select i1 %cmp.i, i1 true, i1 %cmp.i54
...
while.end:                                        ; preds = %if.end27, %entry
  ...
  %cmp.i.lcssa = phi i1 [ %cmp.i71, %entry ], [ %cmp.i, %if.end27 ]
  %cmp.i59.not80 = icmp eq ptr %ClauseList.addr.0.lcssa, null
  br i1 %cmp.i59.not80, label %for.end, label %for.body.preheader

for.body.preheader:                               ; preds = %lor.rhs, %while.end
  %cmp.i.lcssa87 = phi i1 [ %cmp.i.lcssa, %while.end ], [ false, %lor.rhs ]
  %ClauseList.addr.0.lcssa85 = phi ptr [ %ClauseList.addr.0.lcssa, %while.end ], [ %ClauseList.addr.075, %lor.rhs ]
  br label %for.body

for.body:                                         ; preds = %for.body.preheader, %for.body
  %Scan.081 = phi ptr [ %Scan.0.val53, %for.body ], [ %ClauseList.addr.0.lcssa85, %for.body.preheader ]
  %46 = getelementptr i8, ptr %Scan.081, i64 8
  %Scan.0.val = load ptr, ptr %46, align 8
  call void @prfs_InsertUsableClause(ptr noundef %Search, ptr noundef %Scan.0.val) #11
  %Scan.0.val53 = load ptr, ptr %Scan.081, align 8
...
for.end:                                          ; preds = %for.body, %while.end
  %cmp.i.lcssa88 = phi i1 [ %cmp.i.lcssa, %while.end ], [ %cmp.i.lcssa87, %for.body ]
  %ClauseList.addr.0.lcssa86 = phi ptr [ null, %while.end ], [ %ClauseList.addr.0.lcssa85, %for.body ]
  br i1 %cmp.i.lcssa88, label %list_Delete.exit, label %while.body.i

while.body.i:                                     ; preds = %for.end, %while.body.i
  %Current.06.i = phi ptr [ %L.addr.0.val.i, %while.body.i ], [ %ClauseList.addr.0.lcssa86, %for.end ]
  %L.addr.0.val.i = load ptr, ptr %Current.06.i, align 8
  %47 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
...
while.body:                                       ; preds = %land.rhs, %lor.rhs
  ...
  %and.i = and i32 %call13.val, 8
  %cmp.i114.not = icmp eq i32 %and.i, 0
  br i1 %cmp.i114.not, label %if.end, label %if.then
...
while.end:                                        ; preds = %lor.rhs, %if.end, %entry
  ...
  %derivedclauses.i = getelementptr inbounds %struct.PROOFSEARCH_HELP, ptr %Search, i64 0, i32 20
  %7 = load i32, ptr %derivedclauses.i, align 8
  %add.i = add nsw i32 %7, %call21
  store i32 %add.i, ptr %derivedclauses.i, align 8
...
while.body46:                                     ; preds = %land.rhs34, %lor.rhs38
  %15 = getelementptr i8, ptr %Scan.1163, i64 8
  %Scan.1.val = load ptr, ptr %15, align 8
  %16 = getelementptr i8, ptr %Scan.1.val, i64 48
  %call47.val = load i32, ptr %16, align 8
  %and.i122 = and i32 %call47.val, 8
  %cmp.i123.not = icmp eq i32 %and.i122, 0
  br i1 %cmp.i123.not, label %if.end59, label %land.lhs.true50

land.lhs.true50:                                  ; preds = %while.body46
  %17 = getelementptr i8, ptr %Scan.1.val, i64 76
  %call47.val110 = load i32, ptr %17, align 4
  %cmp.i125 = icmp eq i32 %call47.val110, 16
  br i1 %cmp.i125, label %if.then53, label %if.end59

if.then53:                                        ; preds = %land.lhs.true50
  %Search.val106 = load ptr, ptr %13, align 8
...
while.end61:                                      ; preds = %lor.rhs38, %if.end59, %while.cond28.preheader
  ...
  %18 = load i32, ptr %derivedclauses.i, align 8
  %add.i138 = add nsw i32 %18, %call62
...
while.body.i146:                                  ; preds = %while.end61, %while.body.i146
  ...
  %total_size.i.i.i142 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %19, i64 0, i32 4
  %20 = load i32, ptr %total_size.i.i.i142, align 8
  %conv26.i.i.i143 = sext i32 %20 to i64
  %21 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i144 = add i64 %21, %conv26.i.i.i143
  store i64 %add27.i.i.i144, ptr @memory_FREEDBYTES, align 8
  %22 = load ptr, ptr %19, align 8
  store ptr %22, ptr %Current.06.i140, align 8
  %23 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i140, ptr %23, align 8
...
clause_GetLiteralAtom.exit:                       ; preds = %for.body, %if.then.i.i
  ...
  %call8 = tail call ptr @st_ExistGen(ptr noundef %14, ptr noundef %ShIndex.val193, ptr noundef %retval.0.i.i) #11
...
for.body15.us.us.us:                              ; preds = %for.body15.lr.ph.split.us.us.split.us, %for.inc.us.us.us
  %LitScan.03.us.us.us = phi ptr [ %LitScan.0.val189.us.us.us, %for.inc.us.us.us ], [ %call11.us, %for.body15.lr.ph.split.us.us.split.us ]
  %17 = getelementptr i8, ptr %LitScan.03.us.us.us, i64 8
...
clause_LiteralIsFromConstraint.exit.us.us.us:     ; preds = %while.cond.i.i.us.us.us
  ...
  %cmp.not.not.i.us.us.us = icmp sgt i32 %call1.val.i.us.us.us, %22
  %cmp4.i.us.us.us = icmp sgt i32 %22, -1
  %narrow.i.us.us.us = and i1 %cmp4.i.us.us.us, %cmp.not.not.i.us.us.us
  br i1 %narrow.i.us.us.us, label %land.lhs.true38.us.us.us, label %for.inc.us.us.us
...
for.inc.us.us.us:                                 ; preds = %clause_LiteralIsFromConstraint.exit.us.us.us, %land.lhs.true38.us.us.us, %land.lhs.true.us.us.us, %for.body15.us.us.us
  %LitScan.0.val189.us.us.us = load ptr, ptr %LitScan.03.us.us.us, align 8
  %cmp.i.not.us.us.us = icmp eq ptr %LitScan.0.val189.us.us.us, null
...
for.body15.us.us:                                 ; preds = %for.body15.lr.ph.us, %for.inc.us.us
  ...
  %24 = getelementptr i8, ptr %LitScan.03.us.us, i64 8
...
land.lhs.true22.us.us:                            ; preds = %land.lhs.true.us.us
  br i1 %cmp23.not.fr, label %while.cond.i.i205.us.us.preheader, label %while.cond.i.i.us.us
...
clause_LiteralIsFromConstraint.exit.us.us:        ; preds = %while.cond.i.i.us.us
  ...
  %cmp.not.not.i.us.us = icmp sgt i32 %call1.val.i.us.us, %29
  %cmp4.i.us.us = icmp sgt i32 %29, -1
  %narrow.i.us.us = and i1 %cmp4.i.us.us, %cmp.not.not.i.us.us
  br i1 %narrow.i.us.us, label %land.lhs.true38.us.us, label %while.cond.i.i205.us.us.preheader

while.cond.i.i205.us.us.preheader:                ; preds = %clause_LiteralIsFromConstraint.exit.us.us, %land.lhs.true22.us.us
  br label %while.cond.i.i205.us.us

while.cond.i.i205.us.us:                          ; preds = %while.cond.i.i205.us.us.preheader, %while.cond.i.i205.us.us
  %indvars.iv.i.i201.us.us = phi i64 [ %indvars.iv.next.i.i204.us.us, %while.cond.i.i205.us.us ], [ 0, %while.cond.i.i205.us.us.preheader ]
  %arrayidx.i.i.i202.us.us = getelementptr inbounds ptr, ptr %call17.val.us.us, i64 %indvars.iv.i.i201.us.us
  %31 = load ptr, ptr %arrayidx.i.i.i202.us.us, align 8
  %cmp.not.i.i203.us.us = icmp eq ptr %31, %LitScan.0.val.us.us
...
clause_LiteralIsFromAntecedent.exit.us.us:        ; preds = %while.cond.i.i205.us.us
  %32 = trunc i64 %indvars.iv.i.i201.us.us to i32
  %33 = getelementptr i8, ptr %call16.val.us.us, i64 64
  %call1.val.i206.us.us = load i32, ptr %33, align 8
  ...
  %cmp.not.i.us.us = icmp sge i32 %sub.i.i.us.us, %32
  %cmp4.i207.us.us = icmp sle i32 %call1.val.i206.us.us, %32
...
for.body15:                                       ; preds = %if.then, %for.inc
  ...
  %35 = getelementptr i8, ptr %LitScan.03, i64 8
...
clause_LiteralIsFromConstraint.exit:              ; preds = %while.cond.i.i
  ...
  %cmp.not.not.i = icmp sgt i32 %call1.val.i, %40
  %cmp4.i = icmp sgt i32 %40, -1
  %narrow.i = and i1 %cmp4.i, %cmp.not.not.i
...
lor.lhs.false:                                    ; preds = %clause_LiteralIsFromConstraint.exit, %land.lhs.true22
  br i1 %or.cond.fr, label %while.cond.i.i216.preheader, label %while.cond.i.i205
...
while.cond.i.i205:                                ; preds = %lor.lhs.false, %while.cond.i.i205
  ...
  %42 = load ptr, ptr %arrayidx.i.i.i202, align 8
  %cmp.not.i.i203 = icmp eq ptr %42, %LitScan.0.val
...
while.cond.i.i216:                                ; preds = %while.cond.i.i216.preheader, %while.cond.i.i216
  ...
  %46 = load ptr, ptr %arrayidx.i.i.i213, align 8
  %cmp.not.i.i214 = icmp eq ptr %46, %LitScan.0.val
...
clause_LiteralIsFromSuccedent.exit:               ; preds = %while.cond.i.i216
  %47 = trunc i64 %indvars.iv.i.i212 to i32
  ...
  %cmp.not.i219 = icmp sge i32 %sub.i.i218, %47
  %cmp4.i220 = icmp sle i32 %add.i.i.i217, %47
...
while.end:                                        ; preds = %if.end44, %if.end44.us, %clause_GetLiteralAtom.exit
  ...
  %cmp.i223 = icmp eq i32 %51, %call5.val
...
if.then52:                                        ; preds = %land.lhs.true48
  ...
  %call5.val195 = load ptr, ptr %54, align 8
  ...
  %tobool61.not12 = icmp eq ptr %call59, null
  br i1 %tobool61.not12, label %while.end108, label %while.body62.lr.ph
...
while.body62.lr.ph:                               ; preds = %if.then52
  ...
  %or.cond1 = or i1 %cmp85.not, %cmp87.not
...
while.body62:                                     ; preds = %while.body62.lr.ph, %if.end106
  %AtomGen.113 = phi ptr [ %call59, %while.body62.lr.ph ], [ %call107, %if.end106 ]
  %AtomGen.1.val = load i32, ptr %AtomGen.113, align 8
  %cmp.i.i225 = icmp sgt i32 %AtomGen.1.val, 0
  br i1 %cmp.i.i225, label %if.end106, label %if.then65

if.then65:                                        ; preds = %while.body62
  %call66 = tail call ptr @sharing_NAtomDataList(ptr noundef nonnull %AtomGen.113) #11
  %cmp.i227.not8 = icmp eq ptr %call66, null
  br i1 %cmp.i227.not8, label %if.end106, label %for.body71.lr.ph
...
for.body71.us:                                    ; preds = %for.body71.lr.ph, %for.inc103.us
  %LitScan.19.us = phi ptr [ %LitScan.1.val188.us, %for.inc103.us ], [ %call66, %for.body71.lr.ph ]
  %58 = getelementptr i8, ptr %LitScan.19.us, i64 8
...
land.lhs.true79.us:                               ; preds = %land.lhs.true75.us
  br i1 %cmp80.not, label %lor.lhs.false84.us, label %while.cond.i.i235.us
...
while.cond.i.i235.us:                             ; preds = %land.lhs.true79.us, %while.cond.i.i235.us
  ...
  %62 = load ptr, ptr %arrayidx.i.i.i232.us, align 8
  %cmp.not.i.i233.us = icmp eq ptr %62, %LitScan.1.val.us
...
clause_LiteralIsFromConstraint.exit241.us:        ; preds = %while.cond.i.i235.us
  %63 = trunc i64 %indvars.iv.i.i231.us to i32
  %64 = getelementptr i8, ptr %call72.val.us, i64 64
  %call1.val.i236.us = load i32, ptr %64, align 8
  %cmp.not.not.i237.us = icmp sgt i32 %call1.val.i236.us, %63
  %cmp4.i238.us = icmp sgt i32 %63, -1
...
while.cond.i.i248.us:                             ; preds = %lor.lhs.false84.us, %while.cond.i.i248.us
  ...
  %65 = load ptr, ptr %arrayidx.i.i.i245.us, align 8
  %cmp.not.i.i246.us = icmp eq ptr %65, %LitScan.1.val.us
...
clause_LiteralIsFromAntecedent.exit257.us:        ; preds = %while.cond.i.i248.us
  %66 = trunc i64 %indvars.iv.i.i244.us to i32
  %67 = getelementptr i8, ptr %call72.val.us, i64 64
  %call1.val.i249.us = load i32, ptr %67, align 8
  %68 = getelementptr i8, ptr %call72.val.us, i64 68
  %call1.val8.i250.us = load i32, ptr %68, align 4
  %add.i.i.i251.us = add i32 %call1.val.i249.us, -1
  %sub.i.i252.us = add i32 %add.i.i.i251.us, %call1.val8.i250.us
  %cmp.not.i253.us = icmp sge i32 %sub.i.i252.us, %66
  %cmp4.i254.us = icmp sle i32 %call1.val.i249.us, %66
...
for.inc103.us:                                    ; preds = %lor.lhs.false84.us, %clause_LiteralIsFromAntecedent.exit257.us, %land.lhs.true96.us, %land.lhs.true75.us, %for.body71.us
  %LitScan.1.val188.us = load ptr, ptr %LitScan.19.us, align 8
  %cmp.i227.not.us = icmp eq ptr %LitScan.1.val188.us, null
  br i1 %cmp.i227.not.us, label %if.end106, label %for.body71.us, !llvm.loop !64

for.body71:                                       ; preds = %for.body71.lr.ph, %for.inc103
  %LitScan.19 = phi ptr [ %LitScan.1.val188, %for.inc103 ], [ %call66, %for.body71.lr.ph ]
  %69 = getelementptr i8, ptr %LitScan.19, i64 8
...
land.lhs.true79:                                  ; preds = %land.lhs.true75
  br i1 %cmp80.not, label %lor.lhs.false84, label %while.cond.i.i235
...
while.cond.i.i235:                                ; preds = %land.lhs.true79, %while.cond.i.i235
  ...
  %73 = load ptr, ptr %arrayidx.i.i.i232, align 8
  %cmp.not.i.i233 = icmp eq ptr %73, %LitScan.1.val
...
clause_LiteralIsFromConstraint.exit241:           ; preds = %while.cond.i.i235
  %74 = trunc i64 %indvars.iv.i.i231 to i32
  %75 = getelementptr i8, ptr %call72.val, i64 64
  %call1.val.i236 = load i32, ptr %75, align 8
  %cmp.not.not.i237 = icmp sgt i32 %call1.val.i236, %74
  %cmp4.i238 = icmp sgt i32 %74, -1
...
while.cond.i.i248:                                ; preds = %lor.lhs.false84, %while.cond.i.i248
  ...
  %76 = load ptr, ptr %arrayidx.i.i.i245, align 8
  %cmp.not.i.i246 = icmp eq ptr %76, %LitScan.1.val
...
clause_LiteralIsFromAntecedent.exit257:           ; preds = %while.cond.i.i248
  %77 = trunc i64 %indvars.iv.i.i244 to i32
  %78 = getelementptr i8, ptr %call72.val, i64 64
  %call1.val.i249 = load i32, ptr %78, align 8
  %79 = getelementptr i8, ptr %call72.val, i64 68
  %call1.val8.i250 = load i32, ptr %79, align 4
  %add.i.i.i251 = add i32 %call1.val.i249, -1
  %sub.i.i252 = add i32 %add.i.i.i251, %call1.val8.i250
  %cmp.not.i253 = icmp sge i32 %sub.i.i252, %77
  %cmp4.i254 = icmp sle i32 %call1.val.i249, %77
...
while.cond.i.i264:                                ; preds = %while.cond.i.i264.preheader, %while.cond.i.i264
  ...
  %80 = load ptr, ptr %arrayidx.i.i.i261, align 8
  %cmp.not.i.i262 = icmp eq ptr %80, %LitScan.1.val
...
clause_LiteralIsFromSuccedent.exit275:            ; preds = %while.cond.i.i264
  %81 = trunc i64 %indvars.iv.i.i260 to i32
  %82 = getelementptr i8, ptr %call72.val, i64 64
  %Clause.val6.i.i.i265 = load i32, ptr %82, align 8
  %83 = getelementptr i8, ptr %call72.val, i64 68
  %Clause.val.i.i.i266 = load i32, ptr %83, align 4
  %84 = getelementptr i8, ptr %call72.val, i64 72
  %Clause.val7.i.i.i267 = load i32, ptr %84, align 8
  ...
  %cmp.not.i271 = icmp sge i32 %sub.i.i270, %81
  %cmp4.i272 = icmp sle i32 %add.i.i.i268, %81
...
if.then100:                                       ; preds = %land.lhs.true96, %land.lhs.true96.us
  %.us-phi11 = phi ptr [ %call72.val.us, %land.lhs.true96.us ], [ %call72.val, %land.lhs.true96 ]
  tail call void @st_CancelExistRetrieval() #11
  %85 = getelementptr i8, ptr %call56, i64 16
  %call56.val194 = load ptr, ptr %85, align 8
...
for.inc103:                                       ; preds = %for.body71, %land.lhs.true75, %clause_LiteralIsFromSuccedent.exit275, %land.lhs.true96
  %LitScan.1.val188 = load ptr, ptr %LitScan.19, align 8
  %cmp.i227.not = icmp eq ptr %LitScan.1.val188, null
  br i1 %cmp.i227.not, label %if.end106, label %for.body71, !llvm.loop !64
...
while.body.i283:                                  ; preds = %while.end108, %while.body.i283
  ...
  %total_size.i.i.i279 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %97, i64 0, i32 4
  %98 = load i32, ptr %total_size.i.i.i279, align 8
  %conv26.i.i.i280 = sext i32 %98 to i64
  %99 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i281 = add i64 %99, %conv26.i.i.i280
  store i64 %add27.i.i.i281, ptr @memory_FREEDBYTES, align 8
  %100 = load ptr, ptr %97, align 8
  store ptr %100, ptr %Current.06.i277, align 8
  %101 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i277, ptr %101, align 8
...
list_Delete.exit284:                              ; preds = %while.body.i283, %while.end108
  ...
  %total_size.i.i285 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %102, i64 0, i32 4
  %103 = load i32, ptr %total_size.i.i285, align 8
  %conv26.i.i286 = sext i32 %103 to i64
  %104 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i287 = add i64 %104, %conv26.i.i286
...
cleanup:                                          ; preds = %for.inc111, %entry, %list_Delete.exit, %if.then42
  %retval.0 = phi ptr [ %.us-phi, %if.then42 ], [ %.us-phi11, %list_Delete.exit ], [ null, %entry ], [ null, %for.inc111 ]
  ret ptr %retval.0
}
...
for.body.lr.ph.i:                                 ; preds = %land.lhs.true
  ...
  br i1 %cmp179.i, label %for.body.us.preheader.i, label %for.body.preheader.i
...
for.body.us.i:                                    ; preds = %for.inc29.us.i, %for.body.us.preheader.i
  %indvars.iv23.i = phi i64 [ %10, %for.body.us.preheader.i ], [ %indvars.iv.next24.i, %for.inc29.us.i ]
  %Clause.val81.us.i = load ptr, ptr %6, align 8
  %arrayidx.i.us.i = getelementptr inbounds ptr, ptr %Clause.val81.us.i, i64 %indvars.iv23.i
  ...
  %cmp.i.i.us.i = icmp eq i32 %14, %L.val7.val.i.us.i
...
clause_LiteralAtom.exit.us.i:                     ; preds = %if.then.i.us.i, %for.body.us.i
  ...
  br i1 %cmp.i.us.i, label %land.lhs.true.us.i, label %for.body22.us.i.preheader
...
for.inc29.us.i:                                   ; preds = %clause_LiteralAtom.exit95.us.i
  %indvars.iv.next24.i = add nsw i64 %indvars.iv23.i, 1
  %cmp.us.i = icmp slt i64 %indvars.iv.next24.i, %11
  %22 = select i1 %cmp.us.i, i1 %tobool26.not.us.i, i1 false
  br i1 %22, label %for.body.us.i, label %for.end31.i, !llvm.loop !67

for.body22.us.i:                                  ; preds = %for.body22.us.i.preheader, %clause_LiteralAtom.exit95.us.i
  %indvars.iv20.i = phi i64 [ %indvars.iv.next21.i, %clause_LiteralAtom.exit95.us.i ], [ 0, %for.body22.us.i.preheader ]
  %Clause.val79.us.i = load ptr, ptr %6, align 8
  %arrayidx.i88.us.i = getelementptr inbounds ptr, ptr %Clause.val79.us.i, i64 %indvars.iv20.i
  %23 = load ptr, ptr %arrayidx.i88.us.i, align 8
  %24 = getelementptr i8, ptr %23, i64 24
  %call23.val.us.i = load ptr, ptr %24, align 8
  %L.val7.val.i89.us.i = load i32, ptr %call23.val.us.i, align 8
  %25 = load i32, ptr @fol_NOT, align 4
  %cmp.i.i90.us.i = icmp eq i32 %25, %L.val7.val.i89.us.i
  br i1 %cmp.i.i90.us.i, label %if.then.i93.us.i, label %clause_LiteralAtom.exit95.us.i

if.then.i93.us.i:                                 ; preds = %for.body22.us.i
  %26 = getelementptr i8, ptr %call23.val.us.i, i64 16
  %call1.val.i91.us.i = load ptr, ptr %26, align 8
  %27 = getelementptr i8, ptr %call1.val.i91.us.i, i64 8
  %call1.val.val.i92.us.i = load ptr, ptr %27, align 8
  br label %clause_LiteralAtom.exit95.us.i

clause_LiteralAtom.exit95.us.i:                   ; preds = %if.then.i93.us.i, %for.body22.us.i
  %retval.0.i94.us.i = phi ptr [ %call1.val.val.i92.us.i, %if.then.i93.us.i ], [ %call23.val.us.i, %for.body22.us.i ]
  %call25.us.i = tail call i32 @term_Equal(ptr noundef nonnull %retval.0.i.us.i, ptr noundef %retval.0.i94.us.i) #11
  %tobool26.not.us.i = icmp eq i32 %call25.us.i, 0
  %indvars.iv.next21.i = add nuw nsw i64 %indvars.iv20.i, 1
  %cmp17.us.i = icmp ult i64 %indvars.iv20.i, %9
...
for.body.i:                                       ; preds = %if.end.i, %for.body.preheader.i
  %29 = phi i32 [ %.pre26.i, %for.body.preheader.i ], [ %39, %if.end.i ]
  %indvars.iv.i = phi i64 [ %7, %for.body.preheader.i ], [ %indvars.iv.next.i, %if.end.i ]
  %Clause.val81.i = load ptr, ptr %6, align 8
  %arrayidx.i.i = getelementptr inbounds ptr, ptr %Clause.val81.i, i64 %indvars.iv.i
...
clause_LiteralAtom.exit.i:                        ; preds = %if.then.i.i, %for.body.i
  ...
  %cmp.i.i = icmp eq i32 %34, %call4.val82.i
...
land.lhs.true10.i:                                ; preds = %land.lhs.true.i
  ...
  %38 = getelementptr i8, ptr %call4.val83.val.i, i64 8
  %call4.val83.val.val.i = load ptr, ptr %38, align 8
...
for.cond.preheader:                               ; preds = %entry
  %cmp4378 = icmp slt i32 %Clause.val6.i, %add3.i
  br i1 %cmp4378, label %for.body.lr.ph, label %cleanup

for.body.lr.ph:                                   ; preds = %for.cond.preheader
  %tobool67.not = icmp eq i32 %3, 0
  %4 = getelementptr i8, ptr %RedClause, i64 12
  %arrayidx.i265 = getelementptr inbounds i32, ptr %Flags, i64 13
...
if.then:                                          ; preds = %entry
  ...
  %cmp.i.i.i.i = icmp eq i32 %12, %L.val7.val.i.i.i
  br i1 %cmp.i.i.i.i, label %if.then.i.i.i, label %clause_GetLiteralAtom.exit.i
...
while.cond.loopexit.i:                            ; preds = %if.end144.i
  %tobool14.not.i = icmp eq i32 %Rewritten.2.lcssa464.i, 0
...
while.body.i:                                     ; preds = %while.cond.loopexit.i, %if.end13.i
  %RedAtom.0379.i = phi ptr [ %retval.0.i.i.i, %if.end13.i ], [ %RedAtom.2.lcssa465.i, %while.cond.loopexit.i ]
  %Copy.0378.i = phi ptr [ %RedClause, %if.end13.i ], [ %Copy.2.lcssa463.i, %while.cond.loopexit.i ]
  %Result.0377.i = phi i32 [ 0, %if.end13.i ], [ %Result.2.lcssa462.i, %while.cond.loopexit.i ]
  %Renamed.0376.i = phi i32 [ 0, %if.end13.i ], [ %Renamed.2.lcssa461.i, %while.cond.loopexit.i ]
  %22 = getelementptr i8, ptr %RedAtom.0379.i, i64 16
  ...
  %cmp.i266.not365.i = icmp eq i32 %23, %.pre.i
  br i1 %cmp.i266.not365.i, label %while.end146.i, label %while.body20.i

while.body20.i:                                   ; preds = %while.body.i, %if.end144.i
  %24 = phi i32 [ %129, %if.end144.i ], [ %23, %while.body.i ]
  %RedAtom.1370.i = phi ptr [ %RedAtom.2.lcssa465.i, %if.end144.i ], [ %RedAtom.0379.i, %while.body.i ]
  %Rewritten.1369.i = phi i32 [ %Rewritten.2.lcssa464.i, %if.end144.i ], [ 0, %while.body.i ]
  %Copy.1368.i = phi ptr [ %Copy.2.lcssa463.i, %if.end144.i ], [ %Copy.0378.i, %while.body.i ]
  %Result.1367.i = phi i32 [ %Result.2.lcssa462.i, %if.end144.i ], [ %Result.0377.i, %while.body.i ]
  %Renamed.1366.i = phi i32 [ %Renamed.2.lcssa461.i, %if.end144.i ], [ %Renamed.0376.i, %while.body.i ]
  ...
  %tobool26352.i = icmp ne ptr %call24.i, null
  %tobool27.not353.i = icmp eq i32 %Rewritten.1369.i, 0
  %27 = select i1 %tobool26352.i, i1 %tobool27.not353.i, i1 false
  br i1 %27, label %while.body29.i, label %while.end.i

while.body29.i:                                   ; preds = %while.body20.i, %if.then139.i
  %TermS.0355.i = phi ptr [ %call140.i, %if.then139.i ], [ %call24.i, %while.body20.i ]
  %Renamed.2354.i = phi i32 [ %Renamed.3.lcssa425.i, %if.then139.i ], [ %Renamed.1366.i, %while.body20.i ]
  %28 = getelementptr i8, ptr %TermS.0355.i, i64 8
  %EqScan.0339.i = load ptr, ptr %28, align 8
  %cmp.i269340.not.i = icmp eq ptr %EqScan.0339.i, null
  br i1 %cmp.i269340.not.i, label %if.then139.i, label %for.body.i

for.body.i:                                       ; preds = %while.body29.i, %for.inc135.i
  %EqScan.0345.i = phi ptr [ %EqScan.0.i, %for.inc135.i ], [ %EqScan.0339.i, %while.body29.i ]
  %Renamed.3341.i = phi i32 [ %Renamed.7.i, %for.inc135.i ], [ %Renamed.2354.i, %while.body29.i ]
  %29 = getelementptr i8, ptr %EqScan.0345.i, i64 8
  ...
  %cmp.i271.i = icmp eq i32 %30, %call37.val254.i
...
if.then40.i:                                      ; preds = %for.body.i
  ...
  %cmp42.i = icmp eq ptr %TermS.0355.i, %call37.val253.val.i
...
if.end46.i:                                       ; preds = %if.then43.i, %if.then40.i
  ...
  %cmp.i273328.not.i = icmp eq ptr %call47.i, null
  br i1 %cmp.i273328.not.i, label %for.inc135.i, label %for.body55.i.preheader

for.body55.i.preheader:                           ; preds = %if.end46.i
  %.pre390 = load i32, ptr @fol_NOT, align 4
  br label %for.body55.i

for.body55.i:                                     ; preds = %for.body55.i.preheader, %for.inc.i
  %34 = phi i32 [ %127, %for.inc.i ], [ %.pre390, %for.body55.i.preheader ]
  %LitScan.0332.i = phi ptr [ %LitScan.0.val257.i, %for.inc.i ], [ %call47.i, %for.body55.i.preheader ]
  %Renamed.4329.i = phi i32 [ %Renamed.6.i, %for.inc.i ], [ %Renamed.3341.i, %for.body55.i.preheader ]
  %35 = getelementptr i8, ptr %LitScan.0332.i, i64 8
...
if.then62.i:                                      ; preds = %land.lhs.true.i
  ...
  %tobool64.not.not.i = icmp eq i32 %call56.val255.i, 0
  br i1 %tobool64.not.not.i, label %if.then73.i, label %land.end68.thread.i

land.end68.thread.i:                              ; preds = %if.then62.i
  %call37.val.i = load ptr, ptr %31, align 8
  %42 = getelementptr i8, ptr %call37.val.i, i64 8
  %call37.val.val.i = load ptr, ptr %42, align 8
  %cmp67.i = icmp eq ptr %TermS.0355.i, %call37.val.val.i
  %land.ext306.i = zext i1 %cmp67.i to i32
  br label %if.end79.i
...
if.then73.i:                                      ; preds = %if.then62.i
  ...
  %call75.i = tail call ptr @term_Rename(ptr noundef %RedAtom.1370.i) #11
  %44 = load ptr, ptr @cont_LEFTCONTEXT, align 8
  %call78.i = tail call i32 @ord_ContGreater(ptr noundef %44, ptr noundef nonnull %TermS.0355.i, ptr noundef %44, ptr noundef %Right.0.i, ptr noundef %Flags, ptr noundef %Precedence) #11
  %.pre = load i32, ptr @fol_NOT, align 4
  br label %if.end79.i

if.end79.i:                                       ; preds = %if.then73.i, %land.end68.thread.i
  %45 = phi i32 [ %.pre, %if.then73.i ], [ %34, %land.end68.thread.i ]
  %Renamed.5.i = phi i32 [ 1, %if.then73.i ], [ %Renamed.4329.i, %land.end68.thread.i ]
  %Oriented.0.i = phi i32 [ %call78.i, %if.then73.i ], [ %land.ext306.i, %land.end68.thread.i ]
...
if.then81.i:                                      ; preds = %if.end79.i
  %cmp82.i = icmp eq ptr %Copy.1368.i, %RedClause
...
lor.lhs.false85.i:                                ; preds = %land.lhs.true83.i
  ...
  %47 = or i1 %cmp1.i.i, %cmp.i275.i
  br i1 %47, label %if.then90.i, label %if.end94.thread.i

if.then90.i:                                      ; preds = %lor.lhs.false85.i, %land.lhs.true83.i
  %call91.i = tail call ptr @clause_Copy(ptr noundef %RedClause) #11
  %48 = getelementptr i8, ptr %call91.i, i64 56
  %call91.val.i = load ptr, ptr %48, align 8
  %49 = load ptr, ptr %call91.val.i, align 8
  %50 = getelementptr i8, ptr %49, i64 24
  %call.val.i276.i = load ptr, ptr %50, align 8
  %L.val7.val.i.i277.i = load i32, ptr %call.val.i276.i, align 8
  %51 = load i32, ptr @fol_NOT, align 4
  %cmp.i.i.i278.i = icmp eq i32 %51, %L.val7.val.i.i277.i
  br i1 %cmp.i.i.i278.i, label %if.then.i.i281.i, label %if.end94.i

if.then.i.i281.i:                                 ; preds = %if.then90.i
  %52 = getelementptr i8, ptr %call.val.i276.i, i64 16
  %call1.val.i.i279.i = load ptr, ptr %52, align 8
  %53 = getelementptr i8, ptr %call1.val.i.i279.i, i64 8
  %call1.val.val.i.i280.i = load ptr, ptr %53, align 8
  br label %if.end94.i

if.end94.i:                                       ; preds = %if.then.i.i281.i, %if.then90.i, %if.then81.i
  %Copy.5.i = phi ptr [ %Copy.1368.i, %if.then81.i ], [ %call91.i, %if.then90.i ], [ %call91.i, %if.then.i.i281.i ]
  %RedAtom.5.i = phi ptr [ %RedAtom.1370.i, %if.then81.i ], [ %call.val.i276.i, %if.then90.i ], [ %call1.val.val.i.i280.i, %if.then.i.i281.i ]
  %tobool95.not.i = icmp eq i32 %Result.1367.i, 0
  br i1 %tobool95.not.i, label %if.then96.i, label %if.end103.thread.i

if.end94.thread.i:                                ; preds = %lor.lhs.false85.i
  %tobool95.not315.i = icmp eq i32 %Result.1367.i, 0
  br i1 %tobool95.not315.i, label %if.then96.i, label %if.end114.i

if.then96.i:                                      ; preds = %if.end94.thread.i, %if.end94.i
  %RedAtom.5323.i = phi ptr [ %RedAtom.1370.i, %if.end94.thread.i ], [ %RedAtom.5.i, %if.end94.i ]
  %Copy.5316.i = phi ptr [ %RedClause, %if.end94.thread.i ], [ %Copy.5.i, %if.end94.i ]
  %54 = load i32, ptr %arrayidx.i284.i, align 4
  %tobool98.not.i = icmp eq i32 %54, 0
  br i1 %tobool98.not.i, label %if.end103.i, label %if.then99.i

if.then99.i:                                      ; preds = %if.then96.i
  %55 = load ptr, ptr @stdout, align 8
  %56 = tail call i64 @fwrite(ptr nonnull @.str.27, i64 13, i64 1, ptr %55)
  tail call void @clause_Print(ptr noundef %Copy.5316.i) #11
  %57 = load ptr, ptr @stdout, align 8
  %58 = tail call i64 @fwrite(ptr nonnull @.str.28, i64 6, i64 1, ptr %57)
...
if.then107.i:                                     ; preds = %if.end103.i
  %59 = getelementptr i8, ptr %Copy.5316.i, i64 32
  %Clause.val.i285.i = load ptr, ptr %59, align 8
...
while.body.i.i.i:                                 ; preds = %if.then107.i, %while.body.i.i.i
  ...
  %total_size.i.i.i.i.i = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %60, i64 0, i32 4
  %61 = load i32, ptr %total_size.i.i.i.i.i, align 8
  %conv26.i.i.i.i.i = sext i32 %61 to i64
  %62 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i.i.i = add i64 %62, %conv26.i.i.i.i.i
  store i64 %add27.i.i.i.i.i, ptr @memory_FREEDBYTES, align 8
  %63 = load ptr, ptr %60, align 8
  store ptr %63, ptr %Current.06.i.i.i, align 8
  %64 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i.i.i, ptr %64, align 8
  %cmp.i.not.i.i.i = icmp eq ptr %L.addr.0.val.i.i.i, null
  br i1 %cmp.i.not.i.i.i, label %list_Delete.exit.i.i, label %while.body.i.i.i, !llvm.loop !8

list_Delete.exit.i.i:                             ; preds = %while.body.i.i.i, %if.then107.i
  %65 = getelementptr i8, ptr %Copy.5316.i, i64 40
  %Clause.val15.i.i = load ptr, ptr %65, align 8
...
while.body.i24.i.i:                               ; preds = %list_Delete.exit.i.i, %while.body.i24.i.i
  ...
  %total_size.i.i.i20.i.i = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %66, i64 0, i32 4
  %67 = load i32, ptr %total_size.i.i.i20.i.i, align 8
  %conv26.i.i.i21.i.i = sext i32 %67 to i64
  %68 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i22.i.i = add i64 %68, %conv26.i.i.i21.i.i
  store i64 %add27.i.i.i22.i.i, ptr @memory_FREEDBYTES, align 8
  %69 = load ptr, ptr %66, align 8
  store ptr %69, ptr %Current.06.i18.i.i, align 8
  %70 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i18.i.i, ptr %70, align 8
...
red_DocumentRewriting.exit.i:                     ; preds = %while.body.i24.i.i, %list_Delete.exit.i.i
  %Clause.val16.i.i = load i32, ptr %Copy.5316.i, align 8
  %conv.i286.i = sext i32 %Clause.val16.i.i to i64
  %71 = inttoptr i64 %conv.i286.i to ptr
  %call.i.i.i.i = tail call ptr @memory_Malloc(i32 noundef 16) #11
  %car.i.i.i.i = getelementptr inbounds %struct.LIST_HELP, ptr %call.i.i.i.i, i64 0, i32 1
  store ptr %71, ptr %car.i.i.i.i, align 8
  store ptr null, ptr %call.i.i.i.i, align 8
  store ptr %call.i.i.i.i, ptr %59, align 8
  ...
  store ptr %call.i.i26.i.i, ptr %65, align 8
  %72 = load i32, ptr @clause_CLAUSECOUNTER, align 4
  %inc.i.i.i.i = add nsw i32 %72, 1
  store i32 %inc.i.i.i.i, ptr @clause_CLAUSECOUNTER, align 4
  store i32 %72, ptr %Copy.5316.i, align 8
  %origin.i.i.i = getelementptr inbounds %struct.CLAUSE_HELP, ptr %Copy.5316.i, i64 0, i32 14
  ...
  %73 = inttoptr i64 %conv.i.i.i to ptr
  ...
  store ptr %73, ptr %car.i.i30.i.i, align 8
  store ptr %74, ptr %call.i.i29.i.i, align 8
  store ptr %call.i.i29.i.i, ptr %59, align 8
  ...
  store ptr %75, ptr %call.i.i33.i.i, align 8
  store ptr %call.i.i33.i.i, ptr %65, align 8
  br label %if.end114.i

if.else110.i:                                     ; preds = %if.end103.thread.i
  %76 = getelementptr i8, ptr %Copy.5.i, i64 32
  %Clause.val.i287.i = load ptr, ptr %76, align 8
  %call.val.i288.i = load ptr, ptr %Clause.val.i287.i, align 8
  %77 = getelementptr i8, ptr %call.val.i288.i, i64 8
  %call1.val.i.i = load ptr, ptr %77, align 8
  %78 = ptrtoint ptr %call1.val.i.i to i64
  %sext.i.i = shl i64 %78, 32
  %conv.i.i289.i = ashr exact i64 %sext.i.i, 32
  %79 = inttoptr i64 %conv.i.i289.i to ptr
  ...
  store ptr %79, ptr %car.i.i.i291.i, align 8
  store ptr %Clause.val.i287.i, ptr %call.i.i.i290.i, align 8
  store ptr %call.i.i.i290.i, ptr %76, align 8
  ...
  store ptr %80, ptr %call.i.i9.i.i, align 8
  ...
  %81 = inttoptr i64 %conv.i11.i.i to ptr
  ...
  store ptr %81, ptr %car.i.i14.i.i, align 8
  store ptr %82, ptr %call.i.i13.i.i, align 8
  store ptr %call.i.i13.i.i, ptr %76, align 8
  %83 = load ptr, ptr %parentLits.i.i.i, align 8
  ...
  store ptr %83, ptr %call.i.i17.i.i, align 8
...
if.end114.i:                                      ; preds = %if.else110.i, %red_DocumentRewriting.exit.i, %if.end103.thread.i, %if.end103.i, %if.end94.thread.i
  %RedAtom.5321.i = phi ptr [ %RedAtom.5.i, %if.end103.thread.i ], [ %RedAtom.5323.i, %red_DocumentRewriting.exit.i ], [ %RedAtom.5.i, %if.else110.i ], [ %RedAtom.5323.i, %if.end103.i ], [ %RedAtom.1370.i, %if.end94.thread.i ]
  %Copy.5319.i = phi ptr [ %Copy.5.i, %if.end103.thread.i ], [ %Copy.5316.i, %red_DocumentRewriting.exit.i ], [ %Copy.5.i, %if.else110.i ], [ %Copy.5316.i, %if.end103.i ], [ %RedClause, %if.end94.thread.i ]
  %84 = load ptr, ptr @cont_LEFTCONTEXT, align 8
  %call116.i = tail call ptr @term_Copy(ptr noundef %Right.0.i) #11
  %call117.i = tail call ptr @cont_ApplyBindingsModuloMatching(ptr noundef %84, ptr noundef %call116.i, i32 noundef 1) #11
  %85 = load ptr, ptr @cont_RIGHTCONTEXT, align 8
  %call119.i = tail call i32 @cont_BindingsAreRenamingModuloMatching(ptr noundef %85) #11
...
if.end122.i:                                      ; preds = %if.then121.i, %if.end114.i
  %call123.i = tail call i32 @term_ReplaceSubtermBy(ptr noundef %RedAtom.5321.i, ptr noundef %25, ptr noundef %call117.i) #11
  %86 = getelementptr i8, ptr %call56.val261.i, i64 48
  %Partner.val20.i.i = load i32, ptr %86, align 8
  %and.i.i.i = and i32 %Partner.val20.i.i, 8
  %cmp.i.not.i.i = icmp eq i32 %and.i.i.i, 0
  br i1 %cmp.i.not.i.i, label %if.end.i.i, label %if.then.i.i

if.then.i.i:                                      ; preds = %if.end122.i
  %flags.i.i.i = getelementptr inbounds %struct.CLAUSE_HELP, ptr %Copy.5319.i, i64 0, i32 8
...
if.end.i.i:                                       ; preds = %if.then.i.i, %if.end122.i
  ...
  %cmp.i293.i = icmp eq i32 %Partner.val19.i.i, 0
  br i1 %cmp.i293.i, label %clause_UpdateSplitDataFromPartner.exit.i, label %if.end3.i.i

if.end3.i.i:                                      ; preds = %if.end.i.i
  %89 = getelementptr i8, ptr %Copy.5319.i, i64 12
  %Result.val17.i.i = load i32, ptr %89, align 4
  %Partner.val19.Result.val17.i.i = tail call i32 @llvm.umax.i32(i32 %Partner.val19.i.i, i32 %Result.val17.i.i)
  store i32 %Partner.val19.Result.val17.i.i, ptr %89, align 4
  %splitfield_length.i.i.i = getelementptr inbounds %struct.CLAUSE_HELP, ptr %Copy.5319.i, i64 0, i32 5
...
if.then.i.i.i.i:                                  ; preds = %if.end3.i.i
  ...
  %call.i.i.i294.i = tail call ptr @memory_Malloc(i32 noundef %mul.i.i.i.i) #11
...
for.body.lr.ph.i.i.i.i:                           ; preds = %if.then.i.i.i.i
  %splitfield.i.i.i.i = getelementptr inbounds %struct.CLAUSE_HELP, ptr %Copy.5319.i, i64 0, i32 4
...
for.body11.preheader.i.i.i.i:                     ; preds = %for.cond8.preheader.i.i.i.i
  ...
  %scevgep.i.i.i.i = getelementptr i8, ptr %call.i.i.i294.i, i64 %94
...
for.body.i.i.i.i:                                 ; preds = %for.body.i.i.i.i, %for.body.lr.ph.i.i.i.i
  ...
  %arrayidx6.i.i.i.i = getelementptr inbounds i64, ptr %call.i.i.i294.i, i64 %indvars.iv.i.i.i.i
...
for.end16.i.i.i.i:                                ; preds = %for.body11.preheader.i.i.i.i, %for.cond8.preheader.i.i.i.i
  %splitfield17.i.i.i.i = getelementptr inbounds %struct.CLAUSE_HELP, ptr %Copy.5319.i, i64 0, i32 4
  %104 = load ptr, ptr %splitfield17.i.i.i.i, align 8
  %cmp18.not.i.i.i.i = icmp eq ptr %104, null
  br i1 %cmp18.not.i.i.i.i, label %if.end.i.i.i.i, label %if.then20.i.i.i.i
...
if.then.i.i.i.i.i:                                ; preds = %if.then20.i.i.i.i
  ...
  %sub6.i.i.i.i.i.i.i = add i32 %mul24.i.i.i.i, %21
  %add7.i.i.i.i.i.i.i = sub i32 %sub6.i.i.i.i.i.i.i, %rem2.i.i.i.i.i.i.i
  %RealSize.1.i.i.i.i.i.i.i = select i1 %tobool3.not.i.i.i.i.i.i.i, i32 %mul24.i.i.i.i, i32 %add7.i.i.i.i.i.i.i
...
if.end13.i.i.i.i.i:                               ; preds = %if.then9.i.i.i.i.i, %if.then.i.i.i.i.i
  ...
  %add.i.i.i.i.i = add i32 %111, %RealSize.1.i.i.i.i.i.i.i
...
if.else25.i.i.i.i.i:                              ; preds = %if.then20.i.i.i.i
  ...
  %total_size.i.i.i.i295.i = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %114, i64 0, i32 4
  %115 = load i32, ptr %total_size.i.i.i.i295.i, align 8
  %conv26.i.i.i.i296.i = sext i32 %115 to i64
  %116 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i.i297.i = add i64 %116, %conv26.i.i.i.i296.i
  store i64 %add27.i.i.i.i297.i, ptr @memory_FREEDBYTES, align 8
...
if.end.i.i.i.i:                                   ; preds = %if.else25.i.i.i.i.i, %if.end23.i.i.i.i.i, %for.end16.i.i.i.i
  store ptr %call.i.i.i294.i, ptr %splitfield17.i.i.i.i, align 8
  store i32 %91, ptr %splitfield_length.i.i.i, align 8
  %.pre.i.i.i = load i32, ptr %splitfield_length1.i.i.i, align 8
  br label %if.end.i.i.i

if.end.i.i.i:                                     ; preds = %if.end.i.i.i.i, %if.end3.i.i
  %119 = phi i32 [ %.pre.i.i.i, %if.end.i.i.i.i ], [ %91, %if.end3.i.i ]
...
for.body.lr.ph.i.i.i:                             ; preds = %if.end.i.i.i
  %splitfield.i.i.i = getelementptr inbounds %struct.CLAUSE_HELP, ptr %Copy.5319.i, i64 0, i32 4
...
while.end.thread.i:                               ; preds = %if.then126.i, %clause_UpdateSplitDataFromPartner.exit.i
  %call.i.i = tail call i32 @clause_ComputeWeight(ptr noundef %Copy.5319.i, ptr noundef nonnull %Flags) #11
  %weight.i.i = getelementptr inbounds %struct.CLAUSE_HELP, ptr %Copy.5319.i, i64 0, i32 1
...
for.inc.i:                                        ; preds = %if.end79.i, %land.lhs.true.i, %for.body55.i
  ...
  %Renamed.6.i = phi i32 [ %Renamed.5.i, %if.end79.i ], [ %Renamed.4329.i, %land.lhs.true.i ], [ %Renamed.4329.i, %for.body55.i ]
  %LitScan.0.val257.i = load ptr, ptr %LitScan.0332.i, align 8
...
for.inc135.i:                                     ; preds = %for.inc.i, %if.end46.i, %for.body.i
  %Renamed.7.i = phi i32 [ %Renamed.3341.i, %for.body.i ], [ %Renamed.3341.i, %if.end46.i ], [ %Renamed.6.i, %for.inc.i ]
  %EqScan.0.i = load ptr, ptr %EqScan.0345.i, align 8
...
if.then139.i:                                     ; preds = %for.inc135.i, %while.body29.i
  %Renamed.3.lcssa425.i = phi i32 [ %Renamed.2354.i, %while.body29.i ], [ %Renamed.7.i, %for.inc135.i ]
...
while.end.i:                                      ; preds = %while.body20.i
  tail call void @st_CancelExistRetrieval() #11
  br i1 %tobool27.not353.i, label %if.then143.i, label %if.end144.i

if.then143.i:                                     ; preds = %while.end.i.thread, %while.end.i
  %Renamed.2.lcssa.i304 = phi i32 [ %Renamed.3.lcssa425.i, %while.end.i.thread ], [ %Renamed.1366.i, %while.end.i ]
  %128 = load i32, ptr @term_STAMP, align 4
  %stamp.i299.i = getelementptr inbounds %struct.term, ptr %25, i64 0, i32 3
  store i32 %128, ptr %stamp.i299.i, align 8
  br label %if.end144.i

if.end144.i:                                      ; preds = %if.then143.i, %while.end.i, %while.end.thread.i
  %RedAtom.2.lcssa465.i = phi ptr [ %RedAtom.5321.i, %while.end.thread.i ], [ %RedAtom.1370.i, %if.then143.i ], [ %RedAtom.1370.i, %while.end.i ]
  %Rewritten.2.lcssa464.i = phi i32 [ 1, %while.end.thread.i ], [ 0, %if.then143.i ], [ %Rewritten.1369.i, %while.end.i ]
  %Copy.2.lcssa463.i = phi ptr [ %Copy.5319.i, %while.end.thread.i ], [ %Copy.1368.i, %if.then143.i ], [ %Copy.1368.i, %while.end.i ]
  %Result.2.lcssa462.i = phi i32 [ 1, %while.end.thread.i ], [ %Result.1367.i, %if.then143.i ], [ %Result.1367.i, %while.end.i ]
  %Renamed.2.lcssa461.i = phi i32 [ %Renamed.5.i, %while.end.thread.i ], [ %Renamed.2.lcssa.i304, %if.then143.i ], [ %Renamed.1366.i, %while.end.i ]
...
while.end146.i:                                   ; preds = %while.body.i, %while.cond.loopexit.i
  %Copy.1.lcssa390.i = phi ptr [ %Copy.2.lcssa463.i, %while.cond.loopexit.i ], [ %Copy.0378.i, %while.body.i ]
  %Result.1.lcssa389.i = phi i32 [ %Result.2.lcssa462.i, %while.cond.loopexit.i ], [ %Result.0377.i, %while.body.i ]
  %Renamed.1.lcssa388.i = phi i32 [ %Renamed.2.lcssa461.i, %while.cond.loopexit.i ], [ %Renamed.0376.i, %while.body.i ]
  %tobool147.not.i = icmp eq i32 %Result.1.lcssa389.i, 0
  br i1 %tobool147.not.i, label %if.else160.i, label %if.then148.i

if.then148.i:                                     ; preds = %while.end146.i
  tail call void @clause_OrientEqualities(ptr noundef %Copy.1.lcssa390.i, ptr noundef %Flags, ptr noundef %Precedence) #11
  tail call void @clause_Normalize(ptr noundef %Copy.1.lcssa390.i) #11
  tail call void @clause_SetMaxLitFlags(ptr noundef %Copy.1.lcssa390.i, ptr noundef %Flags, ptr noundef %Precedence) #11
  %call.i.i.i300.i = tail call i32 @clause_ComputeWeight(ptr noundef %Copy.1.lcssa390.i, ptr noundef %Flags) #11
  %weight.i.i.i.i = getelementptr inbounds %struct.CLAUSE_HELP, ptr %Copy.1.lcssa390.i, i64 0, i32 1
  store i32 %call.i.i.i300.i, ptr %weight.i.i.i.i, align 4
  tail call void @clause_UpdateMaxVar(ptr noundef %Copy.1.lcssa390.i) #11
  %cmp149.not.i = icmp eq ptr %Copy.1.lcssa390.i, %RedClause
...
if.then150.i:                                     ; preds = %if.then148.i
  ...
  %call.i.i.i301.i = tail call i32 @clause_ComputeWeight(ptr noundef %RedClause, ptr noundef %Flags) #11
  %weight.i.i.i302.i = getelementptr inbounds %struct.CLAUSE_HELP, ptr %RedClause, i64 0, i32 1
  store i32 %call.i.i.i301.i, ptr %weight.i.i.i302.i, align 4
...
if.then154.i:                                     ; preds = %if.end151.i
  ...
  tail call void @clause_Print(ptr noundef nonnull %Copy.1.lcssa390.i) #11
...
if.then158.i:                                     ; preds = %if.end156.i
  store ptr %Copy.1.lcssa390.i, ptr %Changed, align 8
  br label %cleanup

if.else160.i:                                     ; preds = %while.end146.i
  %tobool161.not.i = icmp eq i32 %Renamed.1.lcssa388.i, 0
...
if.then162.i:                                     ; preds = %if.else160.i
  ...
  tail call void @clause_Normalize(ptr noundef %Copy.1.lcssa390.i) #11
  tail call void @clause_SetMaxLitFlags(ptr noundef %Copy.1.lcssa390.i, ptr noundef %Flags, ptr noundef %Precedence) #11
  %call.i.i.i304.i = tail call i32 @clause_ComputeWeight(ptr noundef %Copy.1.lcssa390.i, ptr noundef %Flags) #11
  %weight.i.i.i305.i = getelementptr inbounds %struct.CLAUSE_HELP, ptr %Copy.1.lcssa390.i, i64 0, i32 1
  store i32 %call.i.i.i304.i, ptr %weight.i.i.i305.i, align 4
  tail call void @clause_UpdateMaxVar(ptr noundef %Copy.1.lcssa390.i) #11
  br label %cleanup

for.body:                                         ; preds = %for.body.lr.ph, %for.inc116
  %indvars.iv = phi i64 [ %6, %for.body.lr.ph ], [ %indvars.iv.next, %for.inc116 ]
  %Copy.0380 = phi ptr [ %RedClause, %for.body.lr.ph ], [ %Copy.10, %for.inc116 ]
  %Result.0379 = phi i32 [ 0, %for.body.lr.ph ], [ %Result.9, %for.inc116 ]
  %133 = getelementptr i8, ptr %Copy.0380, i64 56
  ...
  %cmp.i.i.i = icmp eq i32 %136, %L.val7.val.i.i
  br i1 %cmp.i.i.i, label %if.then.i.i228, label %clause_GetLiteralAtom.exit
...
while.body:                                       ; preds = %while.body.preheader, %while.cond
  %Result.1 = phi i32 [ %Result.3.lcssa, %while.cond ], [ %Result.0379, %while.body.preheader ]
  %Copy.1 = phi ptr [ %Copy.3.lcssa, %while.cond ], [ %Copy.0380, %while.body.preheader ]
  ...
  %cmp.i.i.i234 = icmp eq i32 %145, %L.val7.val.i.i233
  br i1 %cmp.i.i.i234, label %if.then.i.i237, label %clause_GetLiteralAtom.exit239
...
clause_GetLiteralAtom.exit239:                    ; preds = %while.body, %if.then.i.i237
  ...
  %cmp.i240.not370 = icmp eq i32 %150, %148
  br i1 %cmp.i240.not370, label %for.inc116, label %while.body16, !llvm.loop !76

while.body16:                                     ; preds = %clause_GetLiteralAtom.exit239, %while.end
  %151 = phi i32 [ %252, %while.end ], [ %150, %clause_GetLiteralAtom.exit239 ]
  %RedAtom.0374 = phi ptr [ %RedAtom.1.lcssa, %while.end ], [ %retval.0.i.i238, %clause_GetLiteralAtom.exit239 ]
  %Rewritten.0373 = phi i32 [ %Rewritten.1.lcssa, %while.end ], [ 0, %clause_GetLiteralAtom.exit239 ]
  %Copy.2372 = phi ptr [ %Copy.3.lcssa, %while.end ], [ %Copy.1, %clause_GetLiteralAtom.exit239 ]
  %Result.2371 = phi i32 [ %Result.3.lcssa, %while.end ], [ %Result.1, %clause_GetLiteralAtom.exit239 ]
  %dec.i = add i32 %151, -1
  ...
  %tobool22360 = icmp ne ptr %call20, null
  %tobool23.not361 = icmp eq i32 %Rewritten.0373, 0
  %154 = select i1 %tobool22360, i1 %tobool23.not361, i1 false
  br i1 %154, label %while.body25, label %while.end

while.body25:                                     ; preds = %while.body16, %if.end112
  %TermS.0362 = phi ptr [ %call111, %if.end112 ], [ %call20, %while.body16 ]
  %TermS.0.val = load i32, ptr %TermS.0362, align 8
  %cmp.i.i243 = icmp sgt i32 %TermS.0.val, 0
  br i1 %cmp.i.i243, label %if.end112, label %if.then28

if.then28:                                        ; preds = %while.body25
  %155 = getelementptr i8, ptr %TermS.0362, i64 8
  %EqScan.0350 = load ptr, ptr %155, align 8
  %cmp.i244351.not = icmp eq ptr %EqScan.0350, null
  br i1 %cmp.i244351.not, label %if.end112, label %for.body37

for.body37:                                       ; preds = %if.then28, %for.inc105
  %EqScan.0355 = phi ptr [ %EqScan.0, %for.inc105 ], [ %EqScan.0350, %if.then28 ]
  %156 = getelementptr i8, ptr %EqScan.0355, i64 8
  ...
  %cmp.i246 = icmp eq i32 %157, %call38.val216
  br i1 %cmp.i246, label %land.lhs.true, label %for.inc105
...
land.lhs.true:                                    ; preds = %for.body37
  ...
  %cmp42 = icmp eq ptr %call38.val.val, %TermS.0362
...
if.then43:                                        ; preds = %land.lhs.true
  ...
  %cmp.i248340.not = icmp eq ptr %call44, null
  br i1 %cmp.i248340.not, label %for.inc105, label %for.body52

for.body52:                                       ; preds = %if.then43, %for.inc
  %LitScan.0343 = phi ptr [ %LitScan.0.val218, %for.inc ], [ %call44, %if.then43 ]
  %160 = getelementptr i8, ptr %LitScan.0343, i64 8
  ...
  %call.val.i250 = load ptr, ptr %162, align 8
  br label %while.cond.i

while.cond.i:                                     ; preds = %while.cond.i, %for.body52
  %indvars.iv.i = phi i64 [ %indvars.iv.next.i, %while.cond.i ], [ 0, %for.body52 ]
  %arrayidx.i.i251 = getelementptr inbounds ptr, ptr %call.val.i250, i64 %indvars.iv.i
  %163 = load ptr, ptr %arrayidx.i.i251, align 8
...
clause_LiteralGetIndex.exit:                      ; preds = %while.cond.i
  ...
  %cmp.i.i253.not = icmp eq i32 %166, %call53.val224.val
  br i1 %cmp.i.i253.not, label %for.inc, label %land.lhs.true58
...
land.lhs.true61:                                  ; preds = %land.lhs.true58
  %call62 = tail call i32 @subs_SubsumesBasic(ptr noundef %call53.val220, ptr noundef %Copy.2372, i32 noundef %164, i32 noundef %141) #11
  %tobool63.not = icmp eq i32 %call62, 0
  br i1 %tobool63.not, label %for.inc, label %if.then64

if.then64:                                        ; preds = %land.lhs.true61
  %168 = getelementptr i8, ptr %EqScan.0.val, i64 16
  %cmp65 = icmp eq ptr %Copy.2372, %RedClause
...
lor.lhs.false:                                    ; preds = %land.lhs.true66
  ...
  %cmp.i254 = icmp ugt i32 %call54.val222, %RedClause.val221
  %cmp1.i = icmp ugt i32 %call54.val222, %Level
  %170 = or i1 %cmp1.i, %cmp.i254
  br i1 %170, label %if.then72, label %if.end75.thread
...
if.then72:                                        ; preds = %lor.lhs.false, %land.lhs.true66
  ...
  %arrayidx.i.i256 = getelementptr inbounds ptr, ptr %call73.val, i64 %indvars.iv
  %172 = load ptr, ptr %arrayidx.i.i256, align 8
  %173 = getelementptr i8, ptr %172, i64 24
  %call.val.i257 = load ptr, ptr %173, align 8
  %L.val7.val.i.i258 = load i32, ptr %call.val.i257, align 8
  %174 = load i32, ptr @fol_NOT, align 4
  %cmp.i.i.i259 = icmp eq i32 %174, %L.val7.val.i.i258
  br i1 %cmp.i.i.i259, label %if.then.i.i262, label %if.end75

if.then.i.i262:                                   ; preds = %if.then72
  %175 = getelementptr i8, ptr %call.val.i257, i64 16
  %call1.val.i.i260 = load ptr, ptr %175, align 8
  %176 = getelementptr i8, ptr %call1.val.i.i260, i64 8
  %call1.val.val.i.i261 = load ptr, ptr %176, align 8
  br label %if.end75

if.end75:                                         ; preds = %if.then.i.i262, %if.then72, %if.then64
  %Copy.6 = phi ptr [ %Copy.2372, %if.then64 ], [ %call73, %if.then72 ], [ %call73, %if.then.i.i262 ]
  %RedAtom.4 = phi ptr [ %RedAtom.0374, %if.then64 ], [ %call.val.i257, %if.then72 ], [ %call1.val.val.i.i261, %if.then.i.i262 ]
  %tobool76.not = icmp eq i32 %Result.2371, 0
  br i1 %tobool76.not, label %if.then77, label %if.end84.thread

if.end75.thread:                                  ; preds = %lor.lhs.false
  %tobool76.not322 = icmp eq i32 %Result.2371, 0
  br i1 %tobool76.not322, label %if.then77, label %if.end90

if.then77:                                        ; preds = %if.end75.thread, %if.end75
  %RedAtom.4330 = phi ptr [ %RedAtom.0374, %if.end75.thread ], [ %RedAtom.4, %if.end75 ]
  %Copy.6326 = phi ptr [ %RedClause, %if.end75.thread ], [ %Copy.6, %if.end75 ]
  %177 = load i32, ptr %arrayidx.i265, align 4
...
if.then80:                                        ; preds = %if.then77
  ...
  tail call void @clause_Print(ptr noundef %Copy.6326) #11
...
if.then88:                                        ; preds = %if.end84
  %182 = getelementptr i8, ptr %Copy.6326, i64 32
  %Clause.val.i266 = load ptr, ptr %182, align 8
  %cmp.i.not5.i.i = icmp eq ptr %Clause.val.i266, null
  br i1 %cmp.i.not5.i.i, label %list_Delete.exit.i, label %while.body.i.i

while.body.i.i:                                   ; preds = %if.then88, %while.body.i.i
  %Current.06.i.i = phi ptr [ %L.addr.0.val.i.i, %while.body.i.i ], [ %Clause.val.i266, %if.then88 ]
  %L.addr.0.val.i.i = load ptr, ptr %Current.06.i.i, align 8
  ...
  %cmp.i.not.i.i267 = icmp eq ptr %L.addr.0.val.i.i, null
  br i1 %cmp.i.not.i.i267, label %list_Delete.exit.i, label %while.body.i.i, !llvm.loop !8

list_Delete.exit.i:                               ; preds = %while.body.i.i, %if.then88
  %188 = getelementptr i8, ptr %Copy.6326, i64 40
...
red_DocumentRewriting.exit:                       ; preds = %while.body.i24.i, %list_Delete.exit.i
  %Clause.val16.i = load i32, ptr %Copy.6326, align 8
  %conv.i268 = sext i32 %Clause.val16.i to i64
  %194 = inttoptr i64 %conv.i268 to ptr
  %call.i.i.i = tail call ptr @memory_Malloc(i32 noundef 16) #11
  %car.i.i.i = getelementptr inbounds %struct.LIST_HELP, ptr %call.i.i.i, i64 0, i32 1
  ...
  store i32 %195, ptr %Copy.6326, align 8
  %origin.i.i = getelementptr inbounds %struct.CLAUSE_HELP, ptr %Copy.6326, i64 0, i32 14
  store i32 21, ptr %origin.i.i, align 4
  %Rule.val.i = load i32, ptr %call53.val220, align 8
  %conv.i.i269 = sext i32 %Rule.val.i to i64
  %196 = inttoptr i64 %conv.i.i269 to ptr
...
if.else:                                          ; preds = %if.end84.thread
  ...
  %Clause.val.i270 = load ptr, ptr %200, align 8
  %call.val.i271 = load ptr, ptr %Clause.val.i270, align 8
  %201 = getelementptr i8, ptr %call.val.i271, i64 8
  %call1.val.i272 = load ptr, ptr %201, align 8
  %202 = ptrtoint ptr %call1.val.i272 to i64
  %sext.i = shl i64 %202, 32
  %conv.i.i273 = ashr exact i64 %sext.i, 32
  %203 = inttoptr i64 %conv.i.i273 to ptr
  %call.i.i.i274 = tail call ptr @memory_Malloc(i32 noundef 16) #11
  %car.i.i.i275 = getelementptr inbounds %struct.LIST_HELP, ptr %call.i.i.i274, i64 0, i32 1
  store ptr %203, ptr %car.i.i.i275, align 8
  store ptr %Clause.val.i270, ptr %call.i.i.i274, align 8
  store ptr %call.i.i.i274, ptr %200, align 8
  ...
  %Rule.val.i276 = load i32, ptr %call53.val220, align 8
  %conv.i11.i = sext i32 %Rule.val.i276 to i64
  ...
  %conv.i15.i = ashr exact i64 %sext300, 32
...
if.end90:                                         ; preds = %if.end75.thread, %if.end84.thread, %red_DocumentRewriting.exit, %if.else, %if.end84
  %RedAtom.4328 = phi ptr [ %RedAtom.4, %if.end84.thread ], [ %RedAtom.4330, %red_DocumentRewriting.exit ], [ %RedAtom.4, %if.else ], [ %RedAtom.4330, %if.end84 ], [ %RedAtom.0374, %if.end75.thread ]
  %Copy.6324 = phi ptr [ %Copy.6, %if.end84.thread ], [ %Copy.6326, %red_DocumentRewriting.exit ], [ %Copy.6, %if.else ], [ %Copy.6326, %if.end84 ], [ %RedClause, %if.end75.thread ]
  ...
  %call95 = tail call i32 @term_ReplaceSubtermBy(ptr noundef %RedAtom.4328, ptr noundef %152, ptr noundef %call94) #11
  %211 = getelementptr i8, ptr %call53.val220, i64 48
  %Partner.val20.i = load i32, ptr %211, align 8
  %and.i.i = and i32 %Partner.val20.i, 8
  %cmp.i.not.i = icmp eq i32 %and.i.i, 0
  br i1 %cmp.i.not.i, label %if.end.i278, label %if.then.i

if.then.i:                                        ; preds = %if.end90
  %flags.i.i = getelementptr inbounds %struct.CLAUSE_HELP, ptr %Copy.6324, i64 0, i32 8
  %212 = load i32, ptr %flags.i.i, align 8
  %or.i.i = or i32 %212, 8
  store i32 %or.i.i, ptr %flags.i.i, align 8
  br label %if.end.i278

if.end.i278:                                      ; preds = %if.then.i, %if.end90
...
if.end3.i:                                        ; preds = %if.end.i278
  %214 = getelementptr i8, ptr %Copy.6324, i64 12
  %Result.val17.i = load i32, ptr %214, align 4
  %Partner.val19.Result.val17.i = tail call i32 @llvm.umax.i32(i32 %Partner.val19.i, i32 %Result.val17.i)
  store i32 %Partner.val19.Result.val17.i, ptr %214, align 4
  %splitfield_length.i.i = getelementptr inbounds %struct.CLAUSE_HELP, ptr %Copy.6324, i64 0, i32 5
  ...
  br i1 %cmp.i21.i, label %if.then.i.i.i280, label %if.end.i.i293

if.then.i.i.i280:                                 ; preds = %if.end3.i
  %mul.i.i.i = shl i32 %216, 3
  %call.i.i.i279 = tail call ptr @memory_Malloc(i32 noundef %mul.i.i.i) #11
...
for.body.lr.ph.i.i.i282:                          ; preds = %if.then.i.i.i280
  %splitfield.i.i.i281 = getelementptr inbounds %struct.CLAUSE_HELP, ptr %Copy.6324, i64 0, i32 4
  br label %for.body.i.i.i286

for.cond8.preheader.i.i.i:                        ; preds = %for.body.i.i.i286, %if.then.i.i.i280
  %.lcssa.i.i.i = phi i32 [ 0, %if.then.i.i.i280 ], [ %227, %for.body.i.i.i286 ]
...
for.body11.preheader.i.i.i:                       ; preds = %for.cond8.preheader.i.i.i
  ...
  %scevgep.i.i.i = getelementptr i8, ptr %call.i.i.i279, i64 %219
...
for.body.i.i.i286:                                ; preds = %for.body.i.i.i286, %for.body.lr.ph.i.i.i282
  %indvars.iv.i.i.i283 = phi i64 [ 0, %for.body.lr.ph.i.i.i282 ], [ %indvars.iv.next.i.i.i285, %for.body.i.i.i286 ]
  %225 = load ptr, ptr %splitfield.i.i.i281, align 8
  %arrayidx.i.i.i284 = getelementptr inbounds i64, ptr %225, i64 %indvars.iv.i.i.i283
  %226 = load i64, ptr %arrayidx.i.i.i284, align 8
  %arrayidx6.i.i.i = getelementptr inbounds i64, ptr %call.i.i.i279, i64 %indvars.iv.i.i.i283
  store i64 %226, ptr %arrayidx6.i.i.i, align 8
  %indvars.iv.next.i.i.i285 = add nuw nsw i64 %indvars.iv.i.i.i283, 1
  %227 = load i32, ptr %splitfield_length.i.i, align 8
  %228 = zext i32 %227 to i64
  %cmp3.i.i.i = icmp ult i64 %indvars.iv.next.i.i.i285, %228
  br i1 %cmp3.i.i.i, label %for.body.i.i.i286, label %for.cond8.preheader.i.i.i, !llvm.loop !27

for.end16.i.i.i:                                  ; preds = %for.body11.preheader.i.i.i, %for.cond8.preheader.i.i.i
  %splitfield17.i.i.i = getelementptr inbounds %struct.CLAUSE_HELP, ptr %Copy.6324, i64 0, i32 4
  %229 = load ptr, ptr %splitfield17.i.i.i, align 8
  %cmp18.not.i.i.i = icmp eq ptr %229, null
  br i1 %cmp18.not.i.i.i, label %if.end.i.i.i292, label %if.then20.i.i.i

if.then20.i.i.i:                                  ; preds = %for.end16.i.i.i
  %230 = load i32, ptr %splitfield_length.i.i, align 8
  %mul24.i.i.i = shl i32 %230, 3
  %cmp.i.i.i.i.i = icmp ult i32 %mul24.i.i.i, 1024
  br i1 %cmp.i.i.i.i.i, label %if.else25.i.i.i.i, label %if.then.i.i.i.i287

if.then.i.i.i.i287:                               ; preds = %if.then20.i.i.i
  %rem2.i.i.i.i.i.i = urem i32 %mul24.i.i.i, %5
  %tobool3.not.i.i.i.i.i.i = icmp eq i32 %rem2.i.i.i.i.i.i, 0
  %sub6.i.i.i.i.i.i = add i32 %5, %mul24.i.i.i
  %add7.i.i.i.i.i.i = sub i32 %sub6.i.i.i.i.i.i, %rem2.i.i.i.i.i.i
  %RealSize.1.i.i.i.i.i.i = select i1 %tobool3.not.i.i.i.i.i.i, i32 %mul24.i.i.i, i32 %add7.i.i.i.i.i.i
...
if.then9.i.i.i.i:                                 ; preds = %if.then.i.i.i.i287
  %235 = load ptr, ptr %add.ptr1.i.i.i.i, align 8
  store ptr %235, ptr %234, align 8
  br label %if.end13.i.i.i.i

if.end13.i.i.i.i:                                 ; preds = %if.then9.i.i.i.i, %if.then.i.i.i.i287
  %236 = load i32, ptr @memory_MARKSIZE, align 4
  %add.i.i.i.i = add i32 %236, %RealSize.1.i.i.i.i.i.i
  %conv.i.i.i.i = zext i32 %add.i.i.i.i to i64
  %add14.i.i.i.i = add nuw nsw i64 %conv.i.i.i.i, 16
...
if.end23.i.i.i.i:                                 ; preds = %if.then18.i.i.i.i, %if.end13.i.i.i.i
  ...
  tail call void @free(ptr noundef nonnull %add.ptr24.i.i.i.i) #11
  br label %if.end.i.i.i292

if.else25.i.i.i.i:                                ; preds = %if.then20.i.i.i
  %idxprom.i.i.i.i = zext i32 %mul24.i.i.i to i64
  %arrayidx.i.i.i.i288 = getelementptr inbounds [0 x ptr], ptr @memory_ARRAY, i64 0, i64 %idxprom.i.i.i.i
  %239 = load ptr, ptr %arrayidx.i.i.i.i288, align 8
  %total_size.i.i.i.i289 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %239, i64 0, i32 4
  %240 = load i32, ptr %total_size.i.i.i.i289, align 8
  %conv26.i.i.i.i290 = sext i32 %240 to i64
  %241 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i.i291 = add i64 %241, %conv26.i.i.i.i290
  store i64 %add27.i.i.i.i291, ptr @memory_FREEDBYTES, align 8
  %242 = load ptr, ptr %239, align 8
  store ptr %242, ptr %229, align 8
  %243 = load ptr, ptr %arrayidx.i.i.i.i288, align 8
  store ptr %229, ptr %243, align 8
  br label %if.end.i.i.i292

if.end.i.i.i292:                                  ; preds = %if.else25.i.i.i.i, %if.end23.i.i.i.i, %for.end16.i.i.i
  store ptr %call.i.i.i279, ptr %splitfield17.i.i.i, align 8
  store i32 %216, ptr %splitfield_length.i.i, align 8
  %.pre.i.i = load i32, ptr %splitfield_length1.i.i, align 8
  br label %if.end.i.i293

if.end.i.i293:                                    ; preds = %if.end.i.i.i292, %if.end3.i
  %244 = phi i32 [ %.pre.i.i, %if.end.i.i.i292 ], [ %216, %if.end3.i ]
  %cmp421.not.i.i = icmp eq i32 %244, 0
  br i1 %cmp421.not.i.i, label %clause_UpdateSplitDataFromPartner.exit, label %for.body.lr.ph.i.i

for.body.lr.ph.i.i:                               ; preds = %if.end.i.i293
  %splitfield.i.i = getelementptr inbounds %struct.CLAUSE_HELP, ptr %Copy.6324, i64 0, i32 4
...
for.body.i.i:                                     ; preds = %for.body.i.i, %for.body.lr.ph.i.i
  ...
  %arrayidx.i.i294 = getelementptr inbounds i64, ptr %245, i64 %indvars.iv.i.i
  %246 = load i64, ptr %arrayidx.i.i294, align 8
  ...
  store i64 %or.i22.i, ptr %arrayidx.i.i294, align 8
...
clause_UpdateSplitDataFromPartner.exit:           ; preds = %for.body.i.i, %if.end.i278, %if.end.i.i293
  tail call void @term_Delete(ptr noundef %call94) #11
  store i32 %148, ptr @stack_POINTER, align 4
  %251 = load i32, ptr %arrayidx.i265, align 4
...
for.inc:                                          ; preds = %clause_LiteralGetIndex.exit, %land.lhs.true58, %land.lhs.true61
  %LitScan.0.val218 = load ptr, ptr %LitScan.0343, align 8
  %cmp.i248.not = icmp eq ptr %LitScan.0.val218, null
  br i1 %cmp.i248.not, label %for.inc105, label %for.body52, !llvm.loop !77

for.inc105:                                       ; preds = %for.inc, %if.then43, %for.body37, %land.lhs.true
  %EqScan.0 = load ptr, ptr %EqScan.0355, align 8
  %cmp.i244.not = icmp eq ptr %EqScan.0, null
  br i1 %cmp.i244.not, label %if.end112, label %for.body37, !llvm.loop !78

if.end112.thread:                                 ; preds = %if.then98, %clause_UpdateSplitDataFromPartner.exit
  %call.i = tail call i32 @clause_ComputeWeight(ptr noundef %Copy.6324, ptr noundef nonnull %Flags) #11
  %weight.i = getelementptr inbounds %struct.CLAUSE_HELP, ptr %Copy.6324, i64 0, i32 1
...
while.end:                                        ; preds = %if.end112, %if.end112.thread, %while.body16
  %Result.3.lcssa = phi i32 [ %Result.2371, %while.body16 ], [ 1, %if.end112.thread ], [ %Result.2371, %if.end112 ]
  %Copy.3.lcssa = phi ptr [ %Copy.2372, %while.body16 ], [ %Copy.6324, %if.end112.thread ], [ %Copy.2372, %if.end112 ]
  %Rewritten.1.lcssa = phi i32 [ %Rewritten.0373, %while.body16 ], [ 1, %if.end112.thread ], [ 0, %if.end112 ]
  %RedAtom.1.lcssa = phi ptr [ %RedAtom.0374, %while.body16 ], [ %RedAtom.4328, %if.end112.thread ], [ %RedAtom.0374, %if.end112 ]
  tail call void @st_CancelExistRetrieval() #11
...
for.inc116:                                       ; preds = %while.cond, %clause_GetLiteralAtom.exit239, %clause_GetLiteralAtom.exit
  %Result.9 = phi i32 [ %Result.0379, %clause_GetLiteralAtom.exit ], [ %Result.1, %clause_GetLiteralAtom.exit239 ], [ %Result.3.lcssa, %while.cond ]
  %Copy.10 = phi ptr [ %Copy.0380, %clause_GetLiteralAtom.exit ], [ %Copy.1, %clause_GetLiteralAtom.exit239 ], [ %Copy.3.lcssa, %while.cond ]
  %indvars.iv.next = add nsw i64 %indvars.iv, 1
...
if.then119:                                       ; preds = %for.end117
  ...
  %call.i.i.i296 = tail call i32 @clause_ComputeWeight(ptr noundef %Copy.10, ptr noundef %Flags) #11
  %weight.i.i.i = getelementptr inbounds %struct.CLAUSE_HELP, ptr %Copy.10, i64 0, i32 1
  store i32 %call.i.i.i296, ptr %weight.i.i.i, align 4
  tail call void @clause_UpdateMaxVar(ptr noundef %Copy.10) #11
  %arrayidx.i297 = getelementptr inbounds i32, ptr %Flags, i64 13
  %253 = load i32, ptr %arrayidx.i297, align 4
...
if.then126:                                       ; preds = %if.end124
  ...
  %call.i.i.i298 = tail call i32 @clause_ComputeWeight(ptr noundef %RedClause, ptr noundef nonnull %Flags) #11
  %weight.i.i.i299 = getelementptr inbounds %struct.CLAUSE_HELP, ptr %RedClause, i64 0, i32 1
  store i32 %call.i.i.i298, ptr %weight.i.i.i299, align 4
  tail call void @clause_UpdateMaxVar(ptr noundef %RedClause) #11
...
cleanup:                                          ; preds = %for.cond.preheader, %for.end117, %if.then126, %if.end124, %if.then162.i, %if.else160.i, %if.then158.i, %if.end156.i, %lor.lhs.false.i, %clause_GetLiteralAtom.exit.i
  %retval.0 = phi i32 [ 0, %lor.lhs.false.i ], [ 0, %clause_GetLiteralAtom.exit.i ], [ 0, %if.else160.i ], [ 0, %if.then162.i ], [ %Result.1.lcssa389.i, %if.end156.i ], [ %Result.1.lcssa389.i, %if.then158.i ], [ %Result.9, %if.end124 ], [ %Result.9, %if.then126 ], [ 0, %for.end117 ], [ 0, %for.cond.preheader ]
  ret i32 %retval.0
}
...
entry:
  ...
  %sub.i = add i32 %add3.i.i, %Clause.val7.i.i
  %cmp.not503 = icmp sgt i32 %Clause.val6.i.i, %sub.i
  br i1 %cmp.not503, label %if.end159, label %for.body.lr.ph
...
for.body.lr.ph:                                   ; preds = %entry
  ...
  %11 = add i32 %Clause.val.i.i, %Clause.val7.i.i
  %12 = add i32 %11, %Clause.val6.i.i
  br label %for.body

for.body:                                         ; preds = %for.body.lr.ph, %for.inc147
  %indvars.iv = phi i64 [ %10, %for.body.lr.ph ], [ %indvars.iv.next, %for.inc147 ]
  %Result.0505 = phi i32 [ 0, %for.body.lr.ph ], [ %Result.9, %for.inc147 ]
  %Copy.0504 = phi ptr [ %RedClause, %for.body.lr.ph ], [ %Copy.10, %for.inc147 ]
  %13 = getelementptr i8, ptr %Copy.0504, i64 56
  %Copy.0.val = load ptr, ptr %13, align 8
  ...
  %cmp.i.i.i = icmp eq i32 %16, %L.val7.val.i.i
  br i1 %cmp.i.i.i, label %if.then.i.i, label %clause_GetLiteralAtom.exit

if.then.i.i:                                      ; preds = %for.body
  %17 = getelementptr i8, ptr %call.val.i, i64 16
  %call1.val.i.i = load ptr, ptr %17, align 8
  %18 = getelementptr i8, ptr %call1.val.i.i, i64 8
  %call1.val.val.i.i = load ptr, ptr %18, align 8
  br label %clause_GetLiteralAtom.exit
...
clause_GetLiteralAtom.exit:                       ; preds = %for.body, %if.then.i.i
  %retval.0.i.i = phi ptr [ %call1.val.val.i.i, %if.then.i.i ], [ %call.val.i, %for.body ]
  %19 = getelementptr i8, ptr %retval.0.i.i, i64 16
  %call8.val = load ptr, ptr %19, align 8
...
while.cond.preheader:                             ; preds = %clause_GetLiteralAtom.exit
  %20 = inttoptr i64 %indvars.iv to ptr
...
while.body:                                       ; preds = %while.cond.preheader, %while.cond.loopexit
  %Result.1502 = phi i32 [ %Result.0505, %while.cond.preheader ], [ %Result.3.lcssa, %while.cond.loopexit ]
  %Copy.1501 = phi ptr [ %Copy.0504, %while.cond.preheader ], [ %Copy.3.lcssa, %while.cond.loopexit ]
  %22 = getelementptr i8, ptr %Copy.1501, i64 56
  %Copy.1.val = load ptr, ptr %22, align 8
  %arrayidx.i.i264 = getelementptr inbounds ptr, ptr %Copy.1.val, i64 %indvars.iv
  %23 = load ptr, ptr %arrayidx.i.i264, align 8
  %24 = getelementptr i8, ptr %23, i64 24
  %call.val.i265 = load ptr, ptr %24, align 8
  %L.val7.val.i.i266 = load i32, ptr %call.val.i265, align 8
  %25 = load i32, ptr @fol_NOT, align 4
  %cmp.i.i.i267 = icmp eq i32 %25, %L.val7.val.i.i266
  br i1 %cmp.i.i.i267, label %if.then.i.i270, label %clause_GetLiteralAtom.exit272

if.then.i.i270:                                   ; preds = %while.body
  %26 = getelementptr i8, ptr %call.val.i265, i64 16
  %call1.val.i.i268 = load ptr, ptr %26, align 8
  %27 = getelementptr i8, ptr %call1.val.i.i268, i64 8
  %call1.val.val.i.i269 = load ptr, ptr %27, align 8
...
clause_GetLiteralAtom.exit272:                    ; preds = %while.body, %if.then.i.i270
  ...
  %29 = getelementptr i8, ptr %retval.0.i.i271, i64 16
  %call14.val = load ptr, ptr %29, align 8
  tail call void @sharing_PushListReverseOnStack(ptr noundef %call14.val) #11
  %30 = load i32, ptr @stack_POINTER, align 4
  %cmp.i273.not493 = icmp eq i32 %30, %28
  br i1 %cmp.i273.not493, label %for.inc147, label %while.body20

while.body20:                                     ; preds = %clause_GetLiteralAtom.exit272, %list_Delete.exit
  %31 = phi i32 [ %235, %list_Delete.exit ], [ %30, %clause_GetLiteralAtom.exit272 ]
  %RedAtom.0497 = phi ptr [ %RedAtom.1.lcssa, %list_Delete.exit ], [ %retval.0.i.i271, %clause_GetLiteralAtom.exit272 ]
  %Rewritten.1496 = phi i32 [ %Rewritten.2.lcssa, %list_Delete.exit ], [ 0, %clause_GetLiteralAtom.exit272 ]
  %Result.2495 = phi i32 [ %Result.3.lcssa, %list_Delete.exit ], [ %Result.1502, %clause_GetLiteralAtom.exit272 ]
  %Copy.2494 = phi ptr [ %Copy.3.lcssa, %list_Delete.exit ], [ %Copy.1501, %clause_GetLiteralAtom.exit272 ]
  %dec.i = add i32 %31, -1
  store i32 %dec.i, ptr @stack_POINTER, align 4
  %idxprom.i = zext i32 %dec.i to i64
  %arrayidx.i275 = getelementptr inbounds [10000 x ptr], ptr @stack_STACK, i64 0, i64 %idxprom.i
  %32 = load ptr, ptr %arrayidx.i275, align 8
  %33 = load ptr, ptr @cont_LEFTCONTEXT, align 8
  %ShIndex.0.val = load ptr, ptr %ShIndex.0, align 8
  %call24 = tail call ptr @st_GetGen(ptr noundef %33, ptr noundef %ShIndex.0.val, ptr noundef %32) #11
  %cmp.i276481 = icmp ne ptr %call24, null
  %tobool28.not482 = icmp eq i32 %Rewritten.1496, 0
  %34 = select i1 %cmp.i276481, i1 %tobool28.not482, i1 false
  br i1 %34, label %for.body30, label %for.end144

for.body30:                                       ; preds = %while.body20, %for.inc142
  %RedAtom.1486 = phi ptr [ %RedAtom.7, %for.inc142 ], [ %RedAtom.0497, %while.body20 ]
  %Result.3485 = phi i32 [ %Result.8, %for.inc142 ], [ %Result.2495, %while.body20 ]
  %Gen.0484 = phi ptr [ %L.val.i429, %for.inc142 ], [ %call24, %while.body20 ]
  %Copy.3483 = phi ptr [ %Copy.9, %for.inc142 ], [ %Copy.2494, %while.body20 ]
  %35 = getelementptr i8, ptr %Gen.0484, i64 8
  %Gen.0.val = load ptr, ptr %35, align 8
...
if.then34:                                        ; preds = %for.body30
  %36 = getelementptr i8, ptr %Gen.0.val, i64 8
  %EqScan.0471 = load ptr, ptr %36, align 8
  %cmp.i278472.not = icmp eq ptr %EqScan.0471, null
  br i1 %cmp.i278472.not, label %for.inc142, label %for.body43

for.body43:                                       ; preds = %if.then34, %for.inc138
  %EqScan.0476 = phi ptr [ %EqScan.0, %for.inc138 ], [ %EqScan.0471, %if.then34 ]
  %RedAtom.2475 = phi ptr [ %RedAtom.6, %for.inc138 ], [ %RedAtom.1486, %if.then34 ]
  %Result.4474 = phi i32 [ %Result.7, %for.inc138 ], [ %Result.3485, %if.then34 ]
  %Copy.4473 = phi ptr [ %Copy.8, %for.inc138 ], [ %Copy.3483, %if.then34 ]
  %37 = getelementptr i8, ptr %EqScan.0476, i64 8
  %EqScan.0.val = load ptr, ptr %37, align 8
  %call44.val250 = load i32, ptr %EqScan.0.val, align 8
  %38 = load i32, ptr @fol_EQUALITY, align 4
  %cmp.i280 = icmp eq i32 %38, %call44.val250
  br i1 %cmp.i280, label %land.lhs.true, label %for.inc138

land.lhs.true:                                    ; preds = %for.body43
  %39 = getelementptr i8, ptr %EqScan.0.val, i64 16
  %call44.val = load ptr, ptr %39, align 8
  %40 = getelementptr i8, ptr %call44.val, i64 8
  %call44.val.val = load ptr, ptr %40, align 8
...
if.then49:                                        ; preds = %land.lhs.true
  ...
  %cmp.i282462.not = icmp eq ptr %call50, null
  br i1 %cmp.i282462.not, label %for.end, label %for.body58

for.body58:                                       ; preds = %if.then49, %for.inc
  %LitScan.0463 = phi ptr [ %LitScan.0.val252, %for.inc ], [ %call50, %if.then49 ]
  %41 = getelementptr i8, ptr %LitScan.0463, i64 8
  %LitScan.0.val = load ptr, ptr %41, align 8
  %42 = getelementptr i8, ptr %LitScan.0.val, i64 16
  %call59.val255 = load ptr, ptr %42, align 8
  %43 = getelementptr i8, ptr %call59.val255, i64 56
  %call.val.i284 = load ptr, ptr %43, align 8
  br label %while.cond.i
...
while.cond.i:                                     ; preds = %while.cond.i, %for.body58
  ...
  %44 = load ptr, ptr %arrayidx.i.i285, align 8
  %cmp.not.i = icmp eq ptr %44, %LitScan.0.val
  %indvars.iv.next.i = add nuw i64 %indvars.iv.i, 1
  br i1 %cmp.not.i, label %clause_LiteralGetIndex.exit, label %while.cond.i, !llvm.loop !12
...
clause_LiteralGetIndex.exit:                      ; preds = %while.cond.i
  ...
  %46 = getelementptr i8, ptr %LitScan.0.val, i64 24
  %call59.val261 = load ptr, ptr %46, align 8
  %call59.val261.val = load i32, ptr %call59.val261, align 8
  %47 = load i32, ptr @fol_NOT, align 4
  %cmp.i.i286.not = icmp eq i32 %47, %call59.val261.val
...
land.lhs.true64:                                  ; preds = %clause_LiteralGetIndex.exit
  ...
  %48 = and i32 %call59.val262, 2
  %tobool66.not = icmp eq i32 %48, 0
  br i1 %tobool66.not, label %for.inc, label %land.lhs.true67

land.lhs.true67:                                  ; preds = %land.lhs.true64
  %49 = getelementptr i8, ptr %LitScan.0.val, i64 8
  %call59.val = load i32, ptr %49, align 8
  %tobool69.not = icmp eq i32 %call59.val, 0
  br i1 %tobool69.not, label %for.inc, label %land.lhs.true70

land.lhs.true70:                                  ; preds = %land.lhs.true67
  %50 = getelementptr i8, ptr %call59.val261, i64 16
  %call.val.i287 = load ptr, ptr %50, align 8
  %51 = getelementptr i8, ptr %call.val.i287, i64 8
  %call.val.val.i = load ptr, ptr %51, align 8
  br label %while.cond.i.i
...
while.cond.i.i:                                   ; preds = %while.cond.i.i, %land.lhs.true70
  ...
  %cmp.not.i.i = icmp eq ptr %52, %LitScan.0.val
  %indvars.iv.next.i.i = add nuw i64 %indvars.iv.i.i, 1
  br i1 %cmp.not.i.i, label %clause_LiteralGetIndex.exit.i, label %while.cond.i.i, !llvm.loop !12

clause_LiteralGetIndex.exit.i:                    ; preds = %while.cond.i.i
  %53 = getelementptr i8, ptr %call59.val255, i64 64
  %Clause.val6.i.i.i = load i32, ptr %53, align 8
  %54 = getelementptr i8, ptr %call59.val255, i64 68
  %Clause.val.i.i.i = load i32, ptr %54, align 4
  %55 = getelementptr i8, ptr %call59.val255, i64 72
  %Clause.val7.i.i.i = load i32, ptr %55, align 8
  %add.i.i.i = add i32 %Clause.val.i.i.i, %Clause.val6.i.i.i
  %add3.i.i.i = add i32 %add.i.i.i, -1
  %sub.i.i = add i32 %add3.i.i.i, %Clause.val7.i.i.i
  %cmp.not48.i = icmp slt i32 %sub.i.i, 0
...
for.body.lr.ph.i:                                 ; preds = %clause_LiteralGetIndex.exit.i
  ...
  %57 = add i32 %add.i.i.i, %Clause.val7.i.i.i
  %wide.trip.count.i = zext i32 %57 to i64
  br label %for.body.i

for.body.i:                                       ; preds = %for.inc.i, %for.body.lr.ph.i
  %indvars.iv.i288 = phi i64 [ 0, %for.body.lr.ph.i ], [ %indvars.iv.next.i297, %for.inc.i ]
  %cmp5.not.i = icmp eq i64 %indvars.iv.i288, %56
  br i1 %cmp5.not.i, label %for.inc.i, label %if.then.i

if.then.i:                                        ; preds = %for.body.i
  %Clause.val.i = load ptr, ptr %43, align 8
  %arrayidx.i.i289 = getelementptr inbounds ptr, ptr %Clause.val.i, i64 %indvars.iv.i288
  %58 = load ptr, ptr %arrayidx.i.i289, align 8
  %59 = getelementptr i8, ptr %58, i64 24
  %call6.val.i = load ptr, ptr %59, align 8
  %L.val7.val.i.i290 = load i32, ptr %call6.val.i, align 8
  %60 = load i32, ptr @fol_NOT, align 4
  %cmp.i.i.i291 = icmp eq i32 %60, %L.val7.val.i.i290
  br i1 %cmp.i.i.i291, label %if.then.i.i294, label %clause_LiteralAtom.exit.i

if.then.i.i294:                                   ; preds = %if.then.i
  %61 = getelementptr i8, ptr %call6.val.i, i64 16
  %call1.val.i.i292 = load ptr, ptr %61, align 8
  %62 = getelementptr i8, ptr %call1.val.i.i292, i64 8
  %call1.val.val.i.i293 = load ptr, ptr %62, align 8
...
clause_LiteralAtom.exit.i:                        ; preds = %if.then.i.i294, %if.then.i
  ...
  %cmp.i.i296 = icmp eq i32 %63, %call7.val45.i
  br i1 %cmp.i.i296, label %if.then9.i, label %if.else.i

if.then9.i:                                       ; preds = %clause_LiteralAtom.exit.i
  %64 = getelementptr i8, ptr %retval.0.i.i295, i64 16
  %call7.val.i = load ptr, ptr %64, align 8
  %65 = getelementptr i8, ptr %call7.val.i, i64 8
  %call7.val.val.i = load ptr, ptr %65, align 8
...
lor.lhs.false.i:                                  ; preds = %if.then9.i
  ...
  %call6.val46.i = load i32, ptr %66, align 8
  %tobool14.not.i = icmp eq i32 %call6.val46.i, 0
  br i1 %tobool14.not.i, label %land.lhs.true.i, label %for.inc.i

land.lhs.true.i:                                  ; preds = %lor.lhs.false.i
  %call7.val47.i = load ptr, ptr %64, align 8
  %call7.val47.val.i = load ptr, ptr %call7.val47.i, align 8
  %67 = getelementptr i8, ptr %call7.val47.val.i, i64 8
  %call7.val47.val.val.i = load ptr, ptr %67, align 8
...
for.inc.i:                                        ; preds = %if.else.i, %land.lhs.true.i, %lor.lhs.false.i, %for.body.i
  ...
  br i1 %exitcond.not.i, label %land.lhs.true73.critedge, label %for.body.i, !llvm.loop !35

land.lhs.true73.critedge:                         ; preds = %for.inc.i, %clause_LiteralGetIndex.exit.i
  %call74 = call fastcc i32 @red_CRwTautologyCheck(ptr noundef %Search, ptr noundef %Copy.4473, i32 noundef %21, ptr noundef %32, ptr noundef %call59.val255, i32 noundef %45, i32 noundef %Mode, ptr noundef nonnull %HelpClause), !range !5
  %tobool75.not = icmp eq i32 %call74, 0
  br i1 %tobool75.not, label %for.inc, label %if.then76

if.then76:                                        ; preds = %land.lhs.true73.critedge
  %cmp77 = icmp eq ptr %Copy.4473, %RedClause
...
lor.lhs.false:                                    ; preds = %land.lhs.true78
  ...
  %69 = or i1 %cmp1.i, %cmp.i298
  br i1 %69, label %if.then89, label %lor.lhs.false84

lor.lhs.false84:                                  ; preds = %lor.lhs.false
  %70 = load ptr, ptr %HelpClause, align 8
  %71 = getelementptr i8, ptr %70, i64 12
  %.val257 = load i32, ptr %71, align 4
  %cmp.i300 = icmp ugt i32 %.val257, %RedClause.val258
  %cmp1.i301 = icmp ugt i32 %.val257, %Level
  %72 = or i1 %cmp.i300, %cmp1.i301
  br i1 %72, label %if.then89, label %if.end92

if.then89:                                        ; preds = %lor.lhs.false84, %lor.lhs.false, %land.lhs.true78
  %call90 = tail call ptr @clause_Copy(ptr noundef %RedClause) #11
  %73 = getelementptr i8, ptr %call90, i64 56
  %call90.val = load ptr, ptr %73, align 8
  %arrayidx.i.i304 = getelementptr inbounds ptr, ptr %call90.val, i64 %indvars.iv
  %74 = load ptr, ptr %arrayidx.i.i304, align 8
  %75 = getelementptr i8, ptr %74, i64 24
  %call.val.i305 = load ptr, ptr %75, align 8
  %L.val7.val.i.i306 = load i32, ptr %call.val.i305, align 8
  %76 = load i32, ptr @fol_NOT, align 4
  %cmp.i.i.i307 = icmp eq i32 %76, %L.val7.val.i.i306
  br i1 %cmp.i.i.i307, label %if.then.i.i310, label %if.end92

if.then.i.i310:                                   ; preds = %if.then89
  %77 = getelementptr i8, ptr %call.val.i305, i64 16
  %call1.val.i.i308 = load ptr, ptr %77, align 8
  %78 = getelementptr i8, ptr %call1.val.i.i308, i64 8
  %call1.val.val.i.i309 = load ptr, ptr %78, align 8
  br label %if.end92

if.end92:                                         ; preds = %if.then.i.i310, %if.then89, %lor.lhs.false84, %if.then76
  %Copy.6 = phi ptr [ %RedClause, %lor.lhs.false84 ], [ %Copy.4473, %if.then76 ], [ %call90, %if.then89 ], [ %call90, %if.then.i.i310 ]
  %RedAtom.4 = phi ptr [ %RedAtom.2475, %lor.lhs.false84 ], [ %RedAtom.2475, %if.then76 ], [ %call.val.i305, %if.then89 ], [ %call1.val.val.i.i309, %if.then.i.i310 ]
  %tobool93.not = icmp eq i32 %Result.4474, 0
  br i1 %tobool93.not, label %land.lhs.true94, label %if.end100

land.lhs.true94:                                  ; preds = %if.end92
  %79 = load i32, ptr %arrayidx.i314, align 4
  %tobool96.not = icmp eq i32 %79, 0
  br i1 %tobool96.not, label %if.end100, label %if.then97

if.then97:                                        ; preds = %land.lhs.true94
  %80 = load ptr, ptr @stdout, align 8
  %81 = tail call i64 @fwrite(ptr nonnull @.str.31, i64 17, i64 1, ptr %80)
  tail call void @clause_Print(ptr noundef %Copy.6) #11
  %82 = load ptr, ptr @stdout, align 8
  %83 = tail call i64 @fwrite(ptr nonnull @.str.28, i64 6, i64 1, ptr %82)
  br label %if.end100
...
if.then102:                                       ; preds = %if.end100
  %84 = load ptr, ptr %HelpClause, align 8
...
if.end112:                                        ; preds = %if.then102
  ...
  %.val254 = load ptr, ptr %86, align 8
...
list_Nconc.exit.i.thread:                         ; preds = %if.end112.thread
  ...
  %Clause.val15.i317449 = load ptr, ptr %87, align 8
  %call.val.i318450 = load ptr, ptr %Clause.val15.i317449, align 8
  %88 = getelementptr i8, ptr %call.val.i318450, i64 8
  %call.val.val.i319451 = load ptr, ptr %88, align 8
  %89 = getelementptr i8, ptr %Copy.6, i64 40
  %Clause.val16.i458 = load ptr, ptr %89, align 8
...
if.then114:                                       ; preds = %if.end112.thread, %if.end112
  ...
  %90 = getelementptr i8, ptr %Copy.6, i64 32
  %Clause.val.i315 = load ptr, ptr %90, align 8
...
list_Delete.exit.i:                               ; preds = %while.body.i.i, %if.then114
  %96 = getelementptr i8, ptr %Copy.6, i64 40
  %Clause.val14.i = load ptr, ptr %96, align 8
...
while.body.i23.i:                                 ; preds = %list_Delete.exit.i, %while.body.i23.i
  ...
  %97 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i19.i = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %97, i64 0, i32 4
  %98 = load i32, ptr %total_size.i.i.i19.i, align 8
  %conv26.i.i.i20.i = sext i32 %98 to i64
  %99 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i21.i = add i64 %99, %conv26.i.i.i20.i
  store i64 %add27.i.i.i21.i, ptr @memory_FREEDBYTES, align 8
  %100 = load ptr, ptr %97, align 8
  store ptr %100, ptr %Current.06.i17.i, align 8
  %101 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i17.i, ptr %101, align 8
...
red_DocumentContextualRewriting.exit:             ; preds = %while.body.i23.i, %list_Delete.exit.i
  store ptr %PClauses.0443, ptr %90, align 8
  store ptr %PLits.0445, ptr %96, align 8
  %Clause.val15.i = load i32, ptr %Copy.6, align 8
  %conv.i.i316 = sext i32 %Clause.val15.i to i64
  %102 = inttoptr i64 %conv.i.i316 to ptr
  %call.i.i.i = tail call ptr @memory_Malloc(i32 noundef 16) #11
  %car.i.i.i = getelementptr inbounds %struct.LIST_HELP, ptr %call.i.i.i, i64 0, i32 1
  ...
  store ptr %20, ptr %car.i.i29.i, align 8
  store ptr %103, ptr %call.i.i28.i, align 8
  store ptr %call.i.i28.i, ptr %96, align 8
  %RuleClause.val.i = load i32, ptr %call59.val255, align 8
  %conv.i30.i = sext i32 %RuleClause.val.i to i64
  %104 = inttoptr i64 %conv.i30.i to ptr
  %105 = load ptr, ptr %90, align 8
  %call.i.i32.i = tail call ptr @memory_Malloc(i32 noundef 16) #11
  %car.i.i33.i = getelementptr inbounds %struct.LIST_HELP, ptr %call.i.i32.i, i64 0, i32 1
  store ptr %104, ptr %car.i.i33.i, align 8
  store ptr %105, ptr %call.i.i32.i, align 8
  store ptr %call.i.i32.i, ptr %90, align 8
  %sext = shl i64 %indvars.iv.i, 32
  %conv.i34.i = ashr exact i64 %sext, 32
  %106 = inttoptr i64 %conv.i34.i to ptr
  ...
  store ptr %106, ptr %car.i.i37.i, align 8
  store ptr %107, ptr %call.i.i36.i, align 8
  store ptr %call.i.i36.i, ptr %96, align 8
  %108 = load i32, ptr @clause_CLAUSECOUNTER, align 4
  %inc.i.i.i = add nsw i32 %108, 1
  store i32 %inc.i.i.i, ptr @clause_CLAUSECOUNTER, align 4
  store i32 %108, ptr %Copy.6, align 8
...
if.else115:                                       ; preds = %if.end112
  %109 = getelementptr i8, ptr %Copy.6, i64 32
  %Clause.val15.i317 = load ptr, ptr %109, align 8
  %call.val.i318 = load ptr, ptr %Clause.val15.i317, align 8
  %110 = getelementptr i8, ptr %call.val.i318, i64 8
  %call.val.val.i319 = load ptr, ptr %110, align 8
...
list_Nconc.exit.i:                                ; preds = %for.end.i.i, %if.else115
  ...
  store ptr %retval.0.i.i321, ptr %109, align 8
  %111 = getelementptr i8, ptr %Copy.6, i64 40
  %Clause.val16.i = load ptr, ptr %111, align 8
...
red_DocumentFurtherCRw.exit:                      ; preds = %list_Nconc.exit.i.thread, %list_Nconc.exit.i, %if.end.i19.i, %for.end.i24.i
  %112 = phi ptr [ %111, %for.end.i24.i ], [ %111, %list_Nconc.exit.i ], [ %111, %if.end.i19.i ], [ %89, %list_Nconc.exit.i.thread ]
  %113 = phi ptr [ %109, %for.end.i24.i ], [ %109, %list_Nconc.exit.i ], [ %109, %if.end.i19.i ], [ %87, %list_Nconc.exit.i.thread ]
  ...
  %114 = phi ptr [ %.pre.i, %for.end.i24.i ], [ %retval.0.i.i321, %list_Nconc.exit.i ], [ %retval.0.i.i321, %if.end.i19.i ], [ %Clause.val15.i317449, %list_Nconc.exit.i.thread ]
  ...
  %115 = ptrtoint ptr %call.val.val.i319454460 to i64
  store ptr %retval.0.i25.i, ptr %112, align 8
  %sext.i = shl i64 %115, 32
  %conv.i.i322 = ashr exact i64 %sext.i, 32
  %116 = inttoptr i64 %conv.i.i322 to ptr
  ...
  store ptr %116, ptr %car.i.i.i324, align 8
  store ptr %114, ptr %call.i.i.i323, align 8
  store ptr %call.i.i.i323, ptr %113, align 8
  ...
  store ptr %20, ptr %car.i.i31.i, align 8
  store ptr %117, ptr %call.i.i30.i, align 8
  store ptr %call.i.i30.i, ptr %112, align 8
  %RuleClause.val.i325 = load i32, ptr %call59.val255, align 8
  %conv.i32.i = sext i32 %RuleClause.val.i325 to i64
  %118 = inttoptr i64 %conv.i32.i to ptr
  ...
  store ptr %118, ptr %car.i.i35.i, align 8
  store ptr %119, ptr %call.i.i34.i, align 8
  store ptr %call.i.i34.i, ptr %113, align 8
  %sext440 = shl i64 %indvars.iv.i, 32
  %conv.i36.i = ashr exact i64 %sext440, 32
  %120 = inttoptr i64 %conv.i36.i to ptr
  ...
  store ptr %120, ptr %car.i.i39.i, align 8
  store ptr %121, ptr %call.i.i38.i, align 8
  store ptr %call.i.i38.i, ptr %112, align 8
  br label %if.end117

if.end117:                                        ; preds = %red_DocumentContextualRewriting.exit, %red_DocumentFurtherCRw.exit, %if.end100
  %122 = load i32, ptr @cont_BINDINGS, align 4
  %123 = load i32, ptr @cont_STACKPOINTER, align 4
  %inc.i.i = add nsw i32 %123, 1
  store i32 %inc.i.i, ptr @cont_STACKPOINTER, align 4
  %idxprom.i.i326 = sext i32 %123 to i64
  %arrayidx.i.i327 = getelementptr inbounds [1000 x i32], ptr @cont_STACK, i64 0, i64 %idxprom.i.i326
  store i32 %122, ptr %arrayidx.i.i327, align 4
  store i32 0, ptr @cont_BINDINGS, align 4
  %124 = load ptr, ptr @cont_LEFTCONTEXT, align 8
  %call119 = tail call i32 @unify_MatchBindings(ptr noundef %124, ptr noundef nonnull %Gen.0.val, ptr noundef %32) #11
  %125 = load ptr, ptr @cont_LEFTCONTEXT, align 8
  %call44.val253 = load ptr, ptr %39, align 8
  %call44.val253.val = load ptr, ptr %call44.val253, align 8
  %126 = getelementptr i8, ptr %call44.val253.val, i64 8
  %call44.val253.val.val = load ptr, ptr %126, align 8
  %call122 = tail call ptr @term_Copy(ptr noundef %call44.val253.val.val) #11
  %call123 = tail call ptr @cont_ApplyBindingsModuloMatching(ptr noundef %125, ptr noundef %call122, i32 noundef 1) #11
...
while.body.i.prol:                                ; preds = %while.body.i.preheader
  ...
  %call.val.i.i.i.prol = load ptr, ptr %128, align 8
  store ptr %call.val.i.i.i.prol, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i.prol = getelementptr inbounds %struct.binding, ptr %127, i64 0, i32 1
  ...
  %link.i.i.i.i.prol = getelementptr inbounds %struct.binding, ptr %129, i64 0, i32 4
...
while.body.i.prol.loopexit:                       ; preds = %while.body.i.prol, %while.body.i.preheader
  ...
  %130 = icmp eq i32 %.pr.i, 1
  br i1 %130, label %while.end.i, label %while.body.i

while.body.i:                                     ; preds = %while.body.i.prol.loopexit, %while.body.i
  %131 = phi i32 [ %dec.i.i.i.1, %while.body.i ], [ %.unr, %while.body.i.prol.loopexit ]
  %132 = load ptr, ptr @cont_LASTBINDING, align 8
  store ptr %132, ptr @cont_CURRENTBINDING, align 8
  %133 = getelementptr i8, ptr %132, i64 24
  %call.val.i.i.i = load ptr, ptr %133, align 8
  store ptr %call.val.i.i.i, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i = getelementptr inbounds %struct.binding, ptr %132, i64 0, i32 1
  ...
  %link.i.i.i.i = getelementptr inbounds %struct.binding, ptr %134, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i, align 8
  %dec.i.i.i = add nsw i32 %131, -1
  store i32 %dec.i.i.i, ptr @cont_BINDINGS, align 4
  %135 = load ptr, ptr @cont_LASTBINDING, align 8
  store ptr %135, ptr @cont_CURRENTBINDING, align 8
  %136 = getelementptr i8, ptr %135, i64 24
  %call.val.i.i.i.1 = load ptr, ptr %136, align 8
  store ptr %call.val.i.i.i.1, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i.1 = getelementptr inbounds %struct.binding, ptr %135, i64 0, i32 1
  ...
  %link.i.i.i.i.1 = getelementptr inbounds %struct.binding, ptr %137, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i.1, align 8
  %dec.i.i.i.1 = add nsw i32 %131, -2
...
while.end.i:                                      ; preds = %while.body.i.prol.loopexit, %while.body.i, %if.end117
  %138 = load i32, ptr @cont_STACKPOINTER, align 4
  %cmp.i.i329 = icmp eq i32 %138, 0
  br i1 %cmp.i.i329, label %cont_BackTrack.exit, label %if.then.i332

if.then.i332:                                     ; preds = %while.end.i
  %dec.i.i = add nsw i32 %138, -1
  ...
  %139 = load i32, ptr %arrayidx.i.i331, align 4
  store i32 %139, ptr @cont_BINDINGS, align 4
  br label %cont_BackTrack.exit

cont_BackTrack.exit:                              ; preds = %while.end.i, %if.then.i332
  %call125 = tail call i32 @term_ReplaceSubtermBy(ptr noundef %RedAtom.4, ptr noundef %32, ptr noundef %call123) #11
  %140 = getelementptr i8, ptr %call59.val255, i64 48
  %Partner.val20.i = load i32, ptr %140, align 8
  %and.i.i = and i32 %Partner.val20.i, 8
  %cmp.i.not.i = icmp eq i32 %and.i.i, 0
  br i1 %cmp.i.not.i, label %if.end.i, label %if.then.i333

if.then.i333:                                     ; preds = %cont_BackTrack.exit
  %flags.i.i = getelementptr inbounds %struct.CLAUSE_HELP, ptr %Copy.6, i64 0, i32 8
  %141 = load i32, ptr %flags.i.i, align 8
  %or.i.i = or i32 %141, 8
  store i32 %or.i.i, ptr %flags.i.i, align 8
  br label %if.end.i

if.end.i:                                         ; preds = %if.then.i333, %cont_BackTrack.exit
  %142 = getelementptr i8, ptr %call59.val255, i64 12
  %Partner.val19.i = load i32, ptr %142, align 4
  %cmp.i334 = icmp eq i32 %Partner.val19.i, 0
  br i1 %cmp.i334, label %clause_UpdateSplitDataFromPartner.exit, label %if.end3.i

if.end3.i:                                        ; preds = %if.end.i
  %143 = getelementptr i8, ptr %Copy.6, i64 12
  %Result.val17.i = load i32, ptr %143, align 4
  %Partner.val19.Result.val17.i = tail call i32 @llvm.umax.i32(i32 %Partner.val19.i, i32 %Result.val17.i)
  store i32 %Partner.val19.Result.val17.i, ptr %143, align 4
  ...
  %145 = load i32, ptr %splitfield_length1.i.i, align 8
  %cmp.i21.i = icmp ult i32 %144, %145
  br i1 %cmp.i21.i, label %if.then.i.i.i, label %if.end.i.i

if.then.i.i.i:                                    ; preds = %if.end3.i
  %mul.i.i.i = shl i32 %145, 3
  %call.i.i.i335 = tail call ptr @memory_Malloc(i32 noundef %mul.i.i.i) #11
  %146 = load i32, ptr %splitfield_length.i.i, align 8
  %cmp349.not.i.i.i = icmp eq i32 %146, 0
  br i1 %cmp349.not.i.i.i, label %for.cond8.preheader.i.i.i, label %for.body.lr.ph.i.i.i
...
for.cond8.preheader.i.i.i:                        ; preds = %for.body.i.i.i, %if.then.i.i.i
  %.lcssa.i.i.i = phi i32 [ 0, %if.then.i.i.i ], [ %156, %for.body.i.i.i ]
  %cmp951.i.i.i = icmp ult i32 %.lcssa.i.i.i, %145
  br i1 %cmp951.i.i.i, label %for.body11.preheader.i.i.i, label %for.end16.i.i.i

for.body11.preheader.i.i.i:                       ; preds = %for.cond8.preheader.i.i.i
  %147 = zext i32 %.lcssa.i.i.i to i64
  %148 = shl nuw nsw i64 %147, 3
  %scevgep.i.i.i = getelementptr i8, ptr %call.i.i.i335, i64 %148
  %149 = xor i32 %.lcssa.i.i.i, -1
  %150 = add i32 %145, %149
  %151 = zext i32 %150 to i64
  %152 = shl nuw nsw i64 %151, 3
  %153 = add nuw nsw i64 %152, 8
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(1) %scevgep.i.i.i, i8 0, i64 %153, i1 false)
  br label %for.end16.i.i.i

for.body.i.i.i:                                   ; preds = %for.body.i.i.i, %for.body.lr.ph.i.i.i
  %indvars.iv.i.i.i = phi i64 [ 0, %for.body.lr.ph.i.i.i ], [ %indvars.iv.next.i.i.i, %for.body.i.i.i ]
  %154 = load ptr, ptr %splitfield.i.i.i, align 8
  %arrayidx.i.i.i336 = getelementptr inbounds i64, ptr %154, i64 %indvars.iv.i.i.i
  %155 = load i64, ptr %arrayidx.i.i.i336, align 8
  %arrayidx6.i.i.i = getelementptr inbounds i64, ptr %call.i.i.i335, i64 %indvars.iv.i.i.i
  store i64 %155, ptr %arrayidx6.i.i.i, align 8
  %indvars.iv.next.i.i.i = add nuw nsw i64 %indvars.iv.i.i.i, 1
  %156 = load i32, ptr %splitfield_length.i.i, align 8
  %157 = zext i32 %156 to i64
  %cmp3.i.i.i = icmp ult i64 %indvars.iv.next.i.i.i, %157
  br i1 %cmp3.i.i.i, label %for.body.i.i.i, label %for.cond8.preheader.i.i.i, !llvm.loop !27

for.end16.i.i.i:                                  ; preds = %for.body11.preheader.i.i.i, %for.cond8.preheader.i.i.i
  %splitfield17.i.i.i = getelementptr inbounds %struct.CLAUSE_HELP, ptr %Copy.6, i64 0, i32 4
  %158 = load ptr, ptr %splitfield17.i.i.i, align 8
  %cmp18.not.i.i.i = icmp eq ptr %158, null
  br i1 %cmp18.not.i.i.i, label %if.end.i.i.i, label %if.then20.i.i.i

if.then20.i.i.i:                                  ; preds = %for.end16.i.i.i
  %159 = load i32, ptr %splitfield_length.i.i, align 8
  %mul24.i.i.i = shl i32 %159, 3
  %cmp.i.i.i.i.i = icmp ult i32 %mul24.i.i.i, 1024
  br i1 %cmp.i.i.i.i.i, label %if.else25.i.i.i.i, label %if.then.i.i.i.i

if.then.i.i.i.i:                                  ; preds = %if.then20.i.i.i
  %rem2.i.i.i.i.i.i = urem i32 %mul24.i.i.i, %9
  %tobool3.not.i.i.i.i.i.i = icmp eq i32 %rem2.i.i.i.i.i.i, 0
  %sub6.i.i.i.i.i.i = add i32 %9, %mul24.i.i.i
  %add7.i.i.i.i.i.i = sub i32 %sub6.i.i.i.i.i.i, %rem2.i.i.i.i.i.i
  %RealSize.1.i.i.i.i.i.i = select i1 %tobool3.not.i.i.i.i.i.i, i32 %mul24.i.i.i, i32 %add7.i.i.i.i.i.i
  %160 = load i32, ptr @memory_OFFSET, align 4
  %idx.ext.i.i.i.i = zext i32 %160 to i64
  %idx.neg.i.i.i.i = sub nsw i64 0, %idx.ext.i.i.i.i
  %add.ptr.i.i.i.i = getelementptr inbounds i8, ptr %158, i64 %idx.neg.i.i.i.i
  %add.ptr1.i.i.i.i = getelementptr inbounds i8, ptr %add.ptr.i.i.i.i, i64 -16
  %161 = load ptr, ptr %add.ptr1.i.i.i.i, align 8
  %cmp2.not.i.i.i.i = icmp eq ptr %161, null
  %next6.i.i.i.i = getelementptr inbounds i8, ptr %add.ptr.i.i.i.i, i64 -8
  %162 = load ptr, ptr %next6.i.i.i.i, align 8
  %next5.i.i.i.i = getelementptr inbounds %struct.MEMORY_BIGBLOCKHEADERHELP, ptr %161, i64 0, i32 1
  %memory_BIGBLOCKS.sink.i.i.i.i = select i1 %cmp2.not.i.i.i.i, ptr @memory_BIGBLOCKS, ptr %next5.i.i.i.i
  store ptr %162, ptr %memory_BIGBLOCKS.sink.i.i.i.i, align 8
  %163 = load ptr, ptr %next6.i.i.i.i, align 8
  %cmp8.not.i.i.i.i = icmp eq ptr %163, null
  br i1 %cmp8.not.i.i.i.i, label %if.end13.i.i.i.i, label %if.then9.i.i.i.i

if.then9.i.i.i.i:                                 ; preds = %if.then.i.i.i.i
  %164 = load ptr, ptr %add.ptr1.i.i.i.i, align 8
  store ptr %164, ptr %163, align 8
  br label %if.end13.i.i.i.i

if.end13.i.i.i.i:                                 ; preds = %if.then9.i.i.i.i, %if.then.i.i.i.i
  %165 = load i32, ptr @memory_MARKSIZE, align 4
  %add.i.i.i.i = add i32 %165, %RealSize.1.i.i.i.i.i.i
  %conv.i.i.i.i = zext i32 %add.i.i.i.i to i64
  %add14.i.i.i.i = add nuw nsw i64 %conv.i.i.i.i, 16
  %166 = load i64, ptr @memory_FREEDBYTES, align 8
  %add15.i.i.i.i = add i64 %add14.i.i.i.i, %166
  store i64 %add15.i.i.i.i, ptr @memory_FREEDBYTES, align 8
  %167 = load i64, ptr @memory_MAXMEM, align 8
  %cmp16.i.i.i.i = icmp sgt i64 %167, -1
  br i1 %cmp16.i.i.i.i, label %if.then18.i.i.i.i, label %if.end23.i.i.i.i

if.then18.i.i.i.i:                                ; preds = %if.end13.i.i.i.i
  %add22.i.i.i.i = add nuw i64 %167, %add14.i.i.i.i
  store i64 %add22.i.i.i.i, ptr @memory_MAXMEM, align 8
  br label %if.end23.i.i.i.i

if.end23.i.i.i.i:                                 ; preds = %if.then18.i.i.i.i, %if.end13.i.i.i.i
  %add.ptr24.i.i.i.i = getelementptr inbounds i8, ptr %158, i64 -16
  tail call void @free(ptr noundef nonnull %add.ptr24.i.i.i.i) #11
  br label %if.end.i.i.i
...
if.else25.i.i.i.i:                                ; preds = %if.then20.i.i.i
  %idxprom.i.i.i.i = zext i32 %mul24.i.i.i to i64
  %arrayidx.i.i.i.i = getelementptr inbounds [0 x ptr], ptr @memory_ARRAY, i64 0, i64 %idxprom.i.i.i.i
  %168 = load ptr, ptr %arrayidx.i.i.i.i, align 8
  %total_size.i.i.i.i337 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %168, i64 0, i32 4
  %169 = load i32, ptr %total_size.i.i.i.i337, align 8
  %conv26.i.i.i.i338 = sext i32 %169 to i64
  %170 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i.i339 = add i64 %170, %conv26.i.i.i.i338
...
if.end.i.i.i:                                     ; preds = %if.else25.i.i.i.i, %if.end23.i.i.i.i, %for.end16.i.i.i
  ...
  store i32 %145, ptr %splitfield_length.i.i, align 8
  %.pre.i.i = load i32, ptr %splitfield_length1.i.i, align 8
  br label %if.end.i.i

if.end.i.i:                                       ; preds = %if.end.i.i.i, %if.end3.i
  %173 = phi i32 [ %.pre.i.i, %if.end.i.i.i ], [ %145, %if.end3.i ]
  %cmp421.not.i.i = icmp eq i32 %173, 0
  br i1 %cmp421.not.i.i, label %clause_UpdateSplitDataFromPartner.exit, label %for.body.lr.ph.i.i
...
for.body.i.i:                                     ; preds = %for.body.i.i, %for.body.lr.ph.i.i
  ...
  %174 = load ptr, ptr %splitfield.i.i, align 8
  %arrayidx.i.i341 = getelementptr inbounds i64, ptr %174, i64 %indvars.iv.i.i340
  %175 = load i64, ptr %arrayidx.i.i341, align 8
  %176 = load ptr, ptr %splitfield5.i.i, align 8
  %arrayidx7.i.i = getelementptr inbounds i64, ptr %176, i64 %indvars.iv.i.i340
  %177 = load i64, ptr %arrayidx7.i.i, align 8
  %or.i22.i = or i64 %177, %175
  store i64 %or.i22.i, ptr %arrayidx.i.i341, align 8
  %indvars.iv.next.i.i342 = add nuw nsw i64 %indvars.iv.i.i340, 1
  %178 = load i32, ptr %splitfield_length1.i.i, align 8
  %179 = zext i32 %178 to i64
  %cmp4.i.i = icmp ult i64 %indvars.iv.next.i.i342, %179
  br i1 %cmp4.i.i, label %for.body.i.i, label %clause_UpdateSplitDataFromPartner.exit, !llvm.loop !28

clause_UpdateSplitDataFromPartner.exit:           ; preds = %for.body.i.i, %if.end.i, %if.end.i.i
  %180 = load ptr, ptr %HelpClause, align 8
  %cmp126.not = icmp eq ptr %180, null
  br i1 %cmp126.not, label %if.end128, label %if.then127

if.then127:                                       ; preds = %clause_UpdateSplitDataFromPartner.exit
  %181 = getelementptr i8, ptr %180, i64 48
  %Partner.val20.i343 = load i32, ptr %181, align 8
  %and.i.i344 = and i32 %Partner.val20.i343, 8
  %cmp.i.not.i345 = icmp eq i32 %and.i.i344, 0
  br i1 %cmp.i.not.i345, label %if.end.i351, label %if.then.i348

if.then.i348:                                     ; preds = %if.then127
  %flags.i.i346 = getelementptr inbounds %struct.CLAUSE_HELP, ptr %Copy.6, i64 0, i32 8
  %182 = load i32, ptr %flags.i.i346, align 8
  %or.i.i347 = or i32 %182, 8
  store i32 %or.i.i347, ptr %flags.i.i346, align 8
  br label %if.end.i351

if.end.i351:                                      ; preds = %if.then.i348, %if.then127
  %183 = getelementptr i8, ptr %180, i64 12
  %Partner.val19.i349 = load i32, ptr %183, align 4
  %cmp.i350 = icmp eq i32 %Partner.val19.i349, 0
  br i1 %cmp.i350, label %clause_UpdateSplitDataFromPartner.exit427, label %if.end3.i357

if.end3.i357:                                     ; preds = %if.end.i351
  %184 = getelementptr i8, ptr %Copy.6, i64 12
  %Result.val17.i352 = load i32, ptr %184, align 4
  %Partner.val19.Result.val17.i353 = tail call i32 @llvm.umax.i32(i32 %Partner.val19.i349, i32 %Result.val17.i352)
  store i32 %Partner.val19.Result.val17.i353, ptr %184, align 4
  %splitfield_length.i.i354 = getelementptr inbounds %struct.CLAUSE_HELP, ptr %Copy.6, i64 0, i32 5
  %185 = load i32, ptr %splitfield_length.i.i354, align 8
  %splitfield_length1.i.i355 = getelementptr inbounds %struct.CLAUSE_HELP, ptr %180, i64 0, i32 5
  %186 = load i32, ptr %splitfield_length1.i.i355, align 8
  %cmp.i21.i356 = icmp ult i32 %185, %186
  br i1 %cmp.i21.i356, label %if.then.i.i.i361, label %if.end.i.i416

if.then.i.i.i361:                                 ; preds = %if.end3.i357
  %mul.i.i.i358 = shl i32 %186, 3
  %call.i.i.i359 = tail call ptr @memory_Malloc(i32 noundef %mul.i.i.i358) #11
  %187 = load i32, ptr %splitfield_length.i.i354, align 8
  %cmp349.not.i.i.i360 = icmp eq i32 %187, 0
  br i1 %cmp349.not.i.i.i360, label %for.cond8.preheader.i.i.i366, label %for.body.lr.ph.i.i.i363

for.body.lr.ph.i.i.i363:                          ; preds = %if.then.i.i.i361
  %splitfield.i.i.i362 = getelementptr inbounds %struct.CLAUSE_HELP, ptr %Copy.6, i64 0, i32 4
  br label %for.body.i.i.i374

for.cond8.preheader.i.i.i366:                     ; preds = %for.body.i.i.i374, %if.then.i.i.i361
  %.lcssa.i.i.i364 = phi i32 [ 0, %if.then.i.i.i361 ], [ %197, %for.body.i.i.i374 ]
  %cmp951.i.i.i365 = icmp ult i32 %.lcssa.i.i.i364, %186
  br i1 %cmp951.i.i.i365, label %for.body11.preheader.i.i.i368, label %for.end16.i.i.i377

for.body11.preheader.i.i.i368:                    ; preds = %for.cond8.preheader.i.i.i366
  %188 = zext i32 %.lcssa.i.i.i364 to i64
  %189 = shl nuw nsw i64 %188, 3
  %scevgep.i.i.i367 = getelementptr i8, ptr %call.i.i.i359, i64 %189
  %190 = xor i32 %.lcssa.i.i.i364, -1
  %191 = add i32 %186, %190
  %192 = zext i32 %191 to i64
  %193 = shl nuw nsw i64 %192, 3
  %194 = add nuw nsw i64 %193, 8
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(1) %scevgep.i.i.i367, i8 0, i64 %194, i1 false)
  br label %for.end16.i.i.i377

for.body.i.i.i374:                                ; preds = %for.body.i.i.i374, %for.body.lr.ph.i.i.i363
  %indvars.iv.i.i.i369 = phi i64 [ 0, %for.body.lr.ph.i.i.i363 ], [ %indvars.iv.next.i.i.i372, %for.body.i.i.i374 ]
  %195 = load ptr, ptr %splitfield.i.i.i362, align 8
  %arrayidx.i.i.i370 = getelementptr inbounds i64, ptr %195, i64 %indvars.iv.i.i.i369
  %196 = load i64, ptr %arrayidx.i.i.i370, align 8
  %arrayidx6.i.i.i371 = getelementptr inbounds i64, ptr %call.i.i.i359, i64 %indvars.iv.i.i.i369
  store i64 %196, ptr %arrayidx6.i.i.i371, align 8
  %indvars.iv.next.i.i.i372 = add nuw nsw i64 %indvars.iv.i.i.i369, 1
  %197 = load i32, ptr %splitfield_length.i.i354, align 8
  %198 = zext i32 %197 to i64
  %cmp3.i.i.i373 = icmp ult i64 %indvars.iv.next.i.i.i372, %198
  br i1 %cmp3.i.i.i373, label %for.body.i.i.i374, label %for.cond8.preheader.i.i.i366, !llvm.loop !27

for.end16.i.i.i377:                               ; preds = %for.body11.preheader.i.i.i368, %for.cond8.preheader.i.i.i366
  %splitfield17.i.i.i375 = getelementptr inbounds %struct.CLAUSE_HELP, ptr %Copy.6, i64 0, i32 4
  %199 = load ptr, ptr %splitfield17.i.i.i375, align 8
  %cmp18.not.i.i.i376 = icmp eq ptr %199, null
  br i1 %cmp18.not.i.i.i376, label %if.end.i.i.i414, label %if.then20.i.i.i380

if.then20.i.i.i380:                               ; preds = %for.end16.i.i.i377
  %200 = load i32, ptr %splitfield_length.i.i354, align 8
  %mul24.i.i.i378 = shl i32 %200, 3
  %cmp.i.i.i.i.i379 = icmp ult i32 %mul24.i.i.i378, 1024
  br i1 %cmp.i.i.i.i.i379, label %if.else25.i.i.i.i412, label %if.then.i.i.i.i395

if.then.i.i.i.i395:                               ; preds = %if.then20.i.i.i380
  %rem2.i.i.i.i.i.i381 = urem i32 %mul24.i.i.i378, %9
  %tobool3.not.i.i.i.i.i.i382 = icmp eq i32 %rem2.i.i.i.i.i.i381, 0
  %sub6.i.i.i.i.i.i383 = add i32 %9, %mul24.i.i.i378
  %add7.i.i.i.i.i.i384 = sub i32 %sub6.i.i.i.i.i.i383, %rem2.i.i.i.i.i.i381
  %RealSize.1.i.i.i.i.i.i385 = select i1 %tobool3.not.i.i.i.i.i.i382, i32 %mul24.i.i.i378, i32 %add7.i.i.i.i.i.i384
  %201 = load i32, ptr @memory_OFFSET, align 4
  %idx.ext.i.i.i.i386 = zext i32 %201 to i64
  %idx.neg.i.i.i.i387 = sub nsw i64 0, %idx.ext.i.i.i.i386
  %add.ptr.i.i.i.i388 = getelementptr inbounds i8, ptr %199, i64 %idx.neg.i.i.i.i387
  %add.ptr1.i.i.i.i389 = getelementptr inbounds i8, ptr %add.ptr.i.i.i.i388, i64 -16
  %202 = load ptr, ptr %add.ptr1.i.i.i.i389, align 8
  %cmp2.not.i.i.i.i390 = icmp eq ptr %202, null
  %next6.i.i.i.i391 = getelementptr inbounds i8, ptr %add.ptr.i.i.i.i388, i64 -8
  %203 = load ptr, ptr %next6.i.i.i.i391, align 8
  %next5.i.i.i.i392 = getelementptr inbounds %struct.MEMORY_BIGBLOCKHEADERHELP, ptr %202, i64 0, i32 1
  %memory_BIGBLOCKS.sink.i.i.i.i393 = select i1 %cmp2.not.i.i.i.i390, ptr @memory_BIGBLOCKS, ptr %next5.i.i.i.i392
  store ptr %203, ptr %memory_BIGBLOCKS.sink.i.i.i.i393, align 8
  %204 = load ptr, ptr %next6.i.i.i.i391, align 8
  %cmp8.not.i.i.i.i394 = icmp eq ptr %204, null
  br i1 %cmp8.not.i.i.i.i394, label %if.end13.i.i.i.i402, label %if.then9.i.i.i.i396

if.then9.i.i.i.i396:                              ; preds = %if.then.i.i.i.i395
  %205 = load ptr, ptr %add.ptr1.i.i.i.i389, align 8
  store ptr %205, ptr %204, align 8
  br label %if.end13.i.i.i.i402

if.end13.i.i.i.i402:                              ; preds = %if.then9.i.i.i.i396, %if.then.i.i.i.i395
  %206 = load i32, ptr @memory_MARKSIZE, align 4
  %add.i.i.i.i397 = add i32 %206, %RealSize.1.i.i.i.i.i.i385
  %conv.i.i.i.i398 = zext i32 %add.i.i.i.i397 to i64
  %add14.i.i.i.i399 = add nuw nsw i64 %conv.i.i.i.i398, 16
  %207 = load i64, ptr @memory_FREEDBYTES, align 8
  %add15.i.i.i.i400 = add i64 %add14.i.i.i.i399, %207
  store i64 %add15.i.i.i.i400, ptr @memory_FREEDBYTES, align 8
  %208 = load i64, ptr @memory_MAXMEM, align 8
  %cmp16.i.i.i.i401 = icmp sgt i64 %208, -1
  br i1 %cmp16.i.i.i.i401, label %if.then18.i.i.i.i404, label %if.end23.i.i.i.i406

if.then18.i.i.i.i404:                             ; preds = %if.end13.i.i.i.i402
  %add22.i.i.i.i403 = add nuw i64 %208, %add14.i.i.i.i399
  store i64 %add22.i.i.i.i403, ptr @memory_MAXMEM, align 8
  br label %if.end23.i.i.i.i406

if.end23.i.i.i.i406:                              ; preds = %if.then18.i.i.i.i404, %if.end13.i.i.i.i402
  %add.ptr24.i.i.i.i405 = getelementptr inbounds i8, ptr %199, i64 -16
  tail call void @free(ptr noundef nonnull %add.ptr24.i.i.i.i405) #11
  br label %if.end.i.i.i414

if.else25.i.i.i.i412:                             ; preds = %if.then20.i.i.i380
  %idxprom.i.i.i.i407 = zext i32 %mul24.i.i.i378 to i64
  %arrayidx.i.i.i.i408 = getelementptr inbounds [0 x ptr], ptr @memory_ARRAY, i64 0, i64 %idxprom.i.i.i.i407
  %209 = load ptr, ptr %arrayidx.i.i.i.i408, align 8
  %total_size.i.i.i.i409 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %209, i64 0, i32 4
  %210 = load i32, ptr %total_size.i.i.i.i409, align 8
  %conv26.i.i.i.i410 = sext i32 %210 to i64
  %211 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i.i411 = add i64 %211, %conv26.i.i.i.i410
  store i64 %add27.i.i.i.i411, ptr @memory_FREEDBYTES, align 8
  %212 = load ptr, ptr %209, align 8
  store ptr %212, ptr %199, align 8
  %213 = load ptr, ptr %arrayidx.i.i.i.i408, align 8
  store ptr %199, ptr %213, align 8
  br label %if.end.i.i.i414

if.end.i.i.i414:                                  ; preds = %if.else25.i.i.i.i412, %if.end23.i.i.i.i406, %for.end16.i.i.i377
  store ptr %call.i.i.i359, ptr %splitfield17.i.i.i375, align 8
  store i32 %186, ptr %splitfield_length.i.i354, align 8
  %.pre.i.i413 = load i32, ptr %splitfield_length1.i.i355, align 8
  br label %if.end.i.i416

if.end.i.i416:                                    ; preds = %if.end.i.i.i414, %if.end3.i357
  %214 = phi i32 [ %.pre.i.i413, %if.end.i.i.i414 ], [ %186, %if.end3.i357 ]
  %cmp421.not.i.i415 = icmp eq i32 %214, 0
  br i1 %cmp421.not.i.i415, label %clause_UpdateSplitDataFromPartner.exit427, label %for.body.lr.ph.i.i419

for.body.lr.ph.i.i419:                            ; preds = %if.end.i.i416
  %splitfield.i.i417 = getelementptr inbounds %struct.CLAUSE_HELP, ptr %Copy.6, i64 0, i32 4
  %splitfield5.i.i418 = getelementptr inbounds %struct.CLAUSE_HELP, ptr %180, i64 0, i32 4
  br label %for.body.i.i426

for.body.i.i426:                                  ; preds = %for.body.i.i426, %for.body.lr.ph.i.i419
  %indvars.iv.i.i420 = phi i64 [ 0, %for.body.lr.ph.i.i419 ], [ %indvars.iv.next.i.i424, %for.body.i.i426 ]
  %215 = load ptr, ptr %splitfield.i.i417, align 8
  %arrayidx.i.i421 = getelementptr inbounds i64, ptr %215, i64 %indvars.iv.i.i420
  %216 = load i64, ptr %arrayidx.i.i421, align 8
  %217 = load ptr, ptr %splitfield5.i.i418, align 8
  %arrayidx7.i.i422 = getelementptr inbounds i64, ptr %217, i64 %indvars.iv.i.i420
  %218 = load i64, ptr %arrayidx7.i.i422, align 8
  %or.i22.i423 = or i64 %218, %216
  store i64 %or.i22.i423, ptr %arrayidx.i.i421, align 8
  %indvars.iv.next.i.i424 = add nuw nsw i64 %indvars.iv.i.i420, 1
  %219 = load i32, ptr %splitfield_length1.i.i355, align 8
  %220 = zext i32 %219 to i64
  %cmp4.i.i425 = icmp ult i64 %indvars.iv.next.i.i424, %220
  br i1 %cmp4.i.i425, label %for.body.i.i426, label %clause_UpdateSplitDataFromPartner.exit427, !llvm.loop !28

clause_UpdateSplitDataFromPartner.exit427:        ; preds = %for.body.i.i426, %if.end.i351, %if.end.i.i416
  %221 = load ptr, ptr %HelpClause, align 8
  tail call void @clause_Delete(ptr noundef %221) #11
  br label %if.end128

if.end128:                                        ; preds = %clause_UpdateSplitDataFromPartner.exit427, %clause_UpdateSplitDataFromPartner.exit
  tail call void @term_Delete(ptr noundef %call123) #11
  store i32 %28, ptr @stack_POINTER, align 4
  %222 = load i32, ptr %arrayidx.i314, align 4
...
if.then131:                                       ; preds = %if.end128
  ...
  %call133 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.29, i32 noundef %call60.val, i32 noundef %45)
...
for.inc:                                          ; preds = %if.else.i, %land.lhs.true.i, %if.then9.i, %clause_LiteralGetIndex.exit, %land.lhs.true64, %land.lhs.true67, %land.lhs.true73.critedge
  %LitScan.0.val252 = load ptr, ptr %LitScan.0463, align 8
...
for.end:                                          ; preds = %for.inc, %for.inc.thread, %if.then49
  %Copy.5.lcssa = phi ptr [ %Copy.4473, %if.then49 ], [ %Copy.6, %for.inc.thread ], [ %Copy.4473, %for.inc ]
  %Result.5.lcssa = phi i32 [ %Result.4474, %if.then49 ], [ 1, %for.inc.thread ], [ %Result.4474, %for.inc ]
  %Rewritten.4.lcssa = phi i32 [ 0, %if.then49 ], [ 1, %for.inc.thread ], [ 0, %for.inc ]
  %RedAtom.3.lcssa = phi ptr [ %RedAtom.2475, %if.then49 ], [ %RedAtom.4, %for.inc.thread ], [ %RedAtom.2475, %for.inc ]
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %HelpClause) #11
  br label %for.inc138

for.inc138:                                       ; preds = %for.body43, %land.lhs.true, %for.end
  %Copy.8 = phi ptr [ %Copy.5.lcssa, %for.end ], [ %Copy.4473, %land.lhs.true ], [ %Copy.4473, %for.body43 ]
  %Result.7 = phi i32 [ %Result.5.lcssa, %for.end ], [ %Result.4474, %land.lhs.true ], [ %Result.4474, %for.body43 ]
  %Rewritten.6 = phi i32 [ %Rewritten.4.lcssa, %for.end ], [ 0, %land.lhs.true ], [ 0, %for.body43 ]
  %RedAtom.6 = phi ptr [ %RedAtom.3.lcssa, %for.end ], [ %RedAtom.2475, %land.lhs.true ], [ %RedAtom.2475, %for.body43 ]
  %EqScan.0 = load ptr, ptr %EqScan.0476, align 8
  %cmp.i278 = icmp ne ptr %EqScan.0, null
  %tobool40.not = icmp eq i32 %Rewritten.6, 0
  %223 = and i1 %cmp.i278, %tobool40.not
  br i1 %223, label %for.body43, label %for.inc142, !llvm.loop !84

for.inc142:                                       ; preds = %for.inc138, %if.then34, %for.body30
  %Copy.9 = phi ptr [ %Copy.3483, %for.body30 ], [ %Copy.3483, %if.then34 ], [ %Copy.8, %for.inc138 ]
  %Result.8 = phi i32 [ %Result.3485, %for.body30 ], [ %Result.3485, %if.then34 ], [ %Result.7, %for.inc138 ]
  %Rewritten.7 = phi i32 [ 0, %for.body30 ], [ 0, %if.then34 ], [ %Rewritten.6, %for.inc138 ]
  %RedAtom.7 = phi ptr [ %RedAtom.1486, %for.body30 ], [ %RedAtom.1486, %if.then34 ], [ %RedAtom.6, %for.inc138 ]
  %L.val.i429 = load ptr, ptr %Gen.0484, align 8
  ...
  store ptr %227, ptr %Gen.0484, align 8
  %228 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Gen.0484, ptr %228, align 8
  %cmp.i276 = icmp ne ptr %L.val.i429, null
  %tobool28.not = icmp eq i32 %Rewritten.7, 0
  %229 = and i1 %cmp.i276, %tobool28.not
  br i1 %229, label %for.body30, label %for.end144, !llvm.loop !85

for.end144:                                       ; preds = %for.inc142, %while.body20
  %Copy.3.lcssa = phi ptr [ %Copy.2494, %while.body20 ], [ %Copy.9, %for.inc142 ]
  %Gen.0.lcssa = phi ptr [ %call24, %while.body20 ], [ %L.val.i429, %for.inc142 ]
  %Result.3.lcssa = phi i32 [ %Result.2495, %while.body20 ], [ %Result.8, %for.inc142 ]
  %Rewritten.2.lcssa = phi i32 [ %Rewritten.1496, %while.body20 ], [ %Rewritten.7, %for.inc142 ]
  %RedAtom.1.lcssa = phi ptr [ %RedAtom.0497, %while.body20 ], [ %RedAtom.7, %for.inc142 ]
  %cmp.i276.lcssa = phi i1 [ %cmp.i276481, %while.body20 ], [ %cmp.i276, %for.inc142 ]
  br i1 %cmp.i276.lcssa, label %while.body.i434, label %list_Delete.exit

while.body.i434:                                  ; preds = %for.end144, %while.body.i434
  %Current.06.i = phi ptr [ %L.addr.0.val.i, %while.body.i434 ], [ %Gen.0.lcssa, %for.end144 ]
  %L.addr.0.val.i = load ptr, ptr %Current.06.i, align 8
  %230 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i430 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %230, i64 0, i32 4
  %231 = load i32, ptr %total_size.i.i.i430, align 8
  %conv26.i.i.i431 = sext i32 %231 to i64
  %232 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i432 = add i64 %232, %conv26.i.i.i431
  ...
  %cmp.i.not.i433 = icmp eq ptr %L.addr.0.val.i, null
  br i1 %cmp.i.not.i433, label %list_Delete.exit, label %while.body.i434, !llvm.loop !8

list_Delete.exit:                                 ; preds = %while.body.i434, %for.end144
  %235 = load i32, ptr @stack_POINTER, align 4
  %cmp.i273.not = icmp eq i32 %235, %28
...
for.inc147:                                       ; preds = %while.cond.loopexit, %clause_GetLiteralAtom.exit272, %clause_GetLiteralAtom.exit
  %Copy.10 = phi ptr [ %Copy.0504, %clause_GetLiteralAtom.exit ], [ %Copy.1501, %clause_GetLiteralAtom.exit272 ], [ %Copy.3.lcssa, %while.cond.loopexit ]
  %Result.9 = phi i32 [ %Result.0505, %clause_GetLiteralAtom.exit ], [ %Result.1502, %clause_GetLiteralAtom.exit272 ], [ %Result.3.lcssa, %while.cond.loopexit ]
  %indvars.iv.next = add nsw i64 %indvars.iv, 1
  %lftr.wideiv = trunc i64 %indvars.iv.next to i32
...
if.then150:                                       ; preds = %for.end148
  ...
  %call.i.i.i436 = tail call i32 @clause_ComputeWeight(ptr noundef %Copy.10, ptr noundef %Search.val) #11
  %weight.i.i.i = getelementptr inbounds %struct.CLAUSE_HELP, ptr %Copy.10, i64 0, i32 1
  store i32 %call.i.i.i436, ptr %weight.i.i.i, align 4
  tail call void @clause_UpdateMaxVar(ptr noundef %Copy.10) #11
  %arrayidx.i437 = getelementptr inbounds i32, ptr %Search.val, i64 14
  %236 = load i32, ptr %arrayidx.i437, align 4
...
if.then157:                                       ; preds = %if.end155
  ...
  %call.i.i.i438 = tail call i32 @clause_ComputeWeight(ptr noundef %RedClause, ptr noundef nonnull %Search.val) #11
  %weight.i.i.i439 = getelementptr inbounds %struct.CLAUSE_HELP, ptr %RedClause, i64 0, i32 1
  store i32 %call.i.i.i438, ptr %weight.i.i.i439, align 4
  tail call void @clause_UpdateMaxVar(ptr noundef %RedClause) #11
  store ptr %Copy.10, ptr %Changed, align 8
  br label %if.end159

if.end159:                                        ; preds = %entry, %if.end155, %if.then157, %for.end148
  %Result.0.lcssa532 = phi i32 [ %Result.9, %if.end155 ], [ %Result.9, %if.then157 ], [ 0, %for.end148 ], [ 0, %entry ]
  ret i32 %Result.0.lcssa532
}
...
while.body:                                       ; preds = %while.body.lr.ph, %if.end55
  ...
  %cmp.i.i = icmp eq i32 %6, %L.val7.val.i
  br i1 %cmp.i.i, label %if.then.i, label %clause_LiteralAtom.exit
...
lor.lhs.false:                                    ; preds = %land.lhs.true31
  ...
  %21 = icmp ugt i32 %call33.val, %invariant.umin
  br i1 %21, label %if.then37, label %if.end39
...
if.end39:                                         ; preds = %if.then37, %lor.lhs.false, %for.body
  ...
  %22 = getelementptr i8, ptr %Scan.0186, i64 8
  %Scan.0.val141 = load ptr, ptr %22, align 8
  %23 = getelementptr i8, ptr %Scan.0.val141, i64 48
  %Partner.val20.i = load i32, ptr %23, align 8
  %and.i.i = and i32 %Partner.val20.i, 8
  %cmp.i.not.i = icmp eq i32 %and.i.i, 0
  br i1 %cmp.i.not.i, label %if.end.i155, label %if.then.i153
...
if.end3.i:                                        ; preds = %if.end.i155
  ...
  %Partner.val19.Result.val17.i = tail call i32 @llvm.umax.i32(i32 %Partner.val19.i, i32 %Result.val17.i)
  store i32 %Partner.val19.Result.val17.i, ptr %26, align 4
...
if.then.i.i.i.i:                                  ; preds = %if.then20.i.i.i
  ...
  %tobool3.not.i.i.i.i.i.i = icmp eq i32 %rem2.i.i.i.i.i.i, 0
  %sub6.i.i.i.i.i.i = add i32 %2, %mul24.i.i.i
  %add7.i.i.i.i.i.i = sub i32 %sub6.i.i.i.i.i.i, %rem2.i.i.i.i.i.i
  %RealSize.1.i.i.i.i.i.i = select i1 %tobool3.not.i.i.i.i.i.i, i32 %mul24.i.i.i, i32 %add7.i.i.i.i.i.i
...
if.end13.i.i.i.i:                                 ; preds = %if.then9.i.i.i.i, %if.then.i.i.i.i
  ...
  %add.i.i.i.i = add i32 %48, %RealSize.1.i.i.i.i.i.i
  %conv.i.i.i.i = zext i32 %add.i.i.i.i to i64
  %add14.i.i.i.i = add nuw nsw i64 %conv.i.i.i.i, 16
  %49 = load i64, ptr @memory_FREEDBYTES, align 8
...
if.end.i.i:                                       ; preds = %if.end.i.i.i, %if.end3.i
  %56 = phi i32 [ %.pre.i.i, %if.end.i.i.i ], [ %28, %if.end3.i ]
...
if.end.i159:                                      ; preds = %if.end52
  %cmp.i18.i158 = icmp eq ptr %Clauses.0189, null
  br i1 %cmp.i18.i158, label %list_Nconc.exit166, label %for.cond.i163
...
while.body.i:                                     ; preds = %if.else, %while.body.i
  ...
  %cmp.i.not.i167 = icmp eq ptr %L.addr.0.val.i, null
...
for.body12.i:                                     ; preds = %for.body12.i, %for.body12.preheader.i
  ...
  %83 = getelementptr i8, ptr %Scan.175.i, i64 8
...
red_DocumentSortSimplification.exit:              ; preds = %list_Nconc.exit.thread98.i, %if.end.i63.thread.i, %list_Nconc.exit.i, %for.end.i68.i
  ...
  store ptr %retval.0.i69.i, ptr %70, align 8
...
while.body.i180:                                  ; preds = %if.else61, %while.body.i180
  %Current.06.i174 = phi ptr [ %L.addr.0.val.i175, %while.body.i180 ], [ %Clauses.1, %if.else61 ]
  %L.addr.0.val.i175 = load ptr, ptr %Current.06.i174, align 8
  ...
  %cmp.i.not.i179 = icmp eq ptr %L.addr.0.val.i175, null
...
entry:
  ...
  %arrayidx.i = getelementptr inbounds i32, ptr %Flags, i64 9
  %3 = load i32, ptr %arrayidx.i, align 4
  %cmp216 = icmp sgt i32 %add3.i, 0
  br i1 %cmp216, label %while.body.lr.ph, label %cleanup
...
while.body:                                       ; preds = %while.body.lr.ph, %if.end45
  %PLits.0223 = phi ptr [ null, %while.body.lr.ph ], [ %PLits.1, %if.end45 ]
  %ReducedLits.0222 = phi ptr [ null, %while.body.lr.ph ], [ %ReducedLits.1, %if.end45 ]
  %ReducedBy.0221 = phi ptr [ null, %while.body.lr.ph ], [ %ReducedBy.1, %if.end45 ]
  %length.0220 = phi i32 [ %add3.i, %while.body.lr.ph ], [ %length.1, %if.end45 ]
  %j.0219 = phi i32 [ 0, %while.body.lr.ph ], [ %j.1, %if.end45 ]
  %i.0218 = phi i32 [ 0, %while.body.lr.ph ], [ %i.1, %if.end45 ]
  %Copy.0217 = phi ptr [ %Clause, %while.body.lr.ph ], [ %Copy.2, %if.end45 ]
  %5 = getelementptr i8, ptr %Copy.0217, i64 56
  %Copy.0.val = load ptr, ptr %5, align 8
  %idxprom.i = sext i32 %i.0218 to i64
...
clause_LiteralAtom.exit:                          ; preds = %while.body
  ...
  %cmp.i = icmp eq i32 %11, %call7.val.pre
  %or.cond = and i1 %cmp.i.i, %cmp.i
...
if.then16.i:                                      ; preds = %lor.rhs.i.thread.i, %land.lhs.true.i.i
  ...
  br i1 %cmp.i169, label %red_GetMRResLit.exit.thread211, label %lor.lhs.false.i

red_GetMRResLit.exit.thread211:                   ; preds = %if.then16.i
  tail call void @st_CancelExistRetrieval() #11
  br label %if.then14
...
if.end24.i:                                       ; preds = %clause_LiteralGetIndex.exit57.i, %lor.rhs.i.thread.i, %land.lhs.true.i.i
  ...
  br i1 %cmp.i.not.i, label %if.end26.i, label %while.body12.i, !llvm.loop !92
...
if.then14:                                        ; preds = %red_GetMRResLit.exit.thread211, %red_GetMRResLit.exit
  %30 = getelementptr i8, ptr %LitScan.0.val.i, i64 16
  %cmp.i173 = icmp eq ptr %PLits.0223, null
...
if.then19:                                        ; preds = %land.lhs.true
  ...
  tail call void @clause_Print(ptr noundef %Copy.0217) #11
  br label %if.end
...
if.end:                                           ; preds = %if.then19, %land.lhs.true, %if.then14
  ...
  store ptr %ReducedBy.0221, ptr %call.i, align 8
...
clause_LiteralGetIndex.exit:                      ; preds = %while.cond.i
  ...
  store ptr %PLits.0223, ptr %call.i176, align 8
  %add = add nsw i32 %j.0219, %i.0218
  ...
  store ptr %ReducedLits.0222, ptr %call.i178, align 8
  %cmp29 = icmp eq ptr %Copy.0217, %Clause
...
if.end40:                                         ; preds = %if.then38, %lor.lhs.false33, %clause_LiteralGetIndex.exit
  %Copy.1 = phi ptr [ %call39, %if.then38 ], [ %Clause, %lor.lhs.false33 ], [ %Copy.0217, %clause_LiteralGetIndex.exit ]
  tail call fastcc void @clause_UpdateSplitDataFromPartner(ptr noundef %Copy.1, ptr noundef nonnull %call11.val)
  tail call void @clause_DeleteLiteral(ptr noundef %Copy.1, i32 noundef %i.0218, ptr noundef %Flags, ptr noundef %Precedence) #11
  %dec = add nsw i32 %length.0220, -1
  %inc = add nsw i32 %j.0219, 1
  br label %if.end45

if.else:                                          ; preds = %if.end26.i, %clause_LiteralAtom.exit.i, %red_GetMRResLit.exit
  %inc41 = add nsw i32 %i.0218, 1
  br label %if.end45

if.else43:                                        ; preds = %clause_LiteralAtom.exit
  %inc44 = add nsw i32 %i.0218, 1
  br label %if.end45

if.end45:                                         ; preds = %if.end40, %if.else, %if.else43
  %Copy.2 = phi ptr [ %Copy.1, %if.end40 ], [ %Copy.0217, %if.else ], [ %Copy.0217, %if.else43 ]
  %i.1 = phi i32 [ %i.0218, %if.end40 ], [ %inc41, %if.else ], [ %inc44, %if.else43 ]
  %j.1 = phi i32 [ %inc, %if.end40 ], [ %j.0219, %if.else ], [ %j.0219, %if.else43 ]
  %length.1 = phi i32 [ %dec, %if.end40 ], [ %length.0220, %if.else ], [ %length.0220, %if.else43 ]
  %ReducedBy.1 = phi ptr [ %call.i, %if.end40 ], [ %ReducedBy.0221, %if.else ], [ %ReducedBy.0221, %if.else43 ]
  %ReducedLits.1 = phi ptr [ %call.i178, %if.end40 ], [ %ReducedLits.0222, %if.else ], [ %ReducedLits.0222, %if.else43 ]
  %PLits.1 = phi ptr [ %call.i176, %if.end40 ], [ %PLits.0223, %if.else ], [ %PLits.0223, %if.else43 ]
...
if.then56:                                        ; preds = %if.then50
  ...
  %cmp.i184.not227 = icmp eq ptr %call51, null
  br i1 %cmp.i184.not227, label %for.end, label %for.body

for.body:                                         ; preds = %if.then56, %for.body
  %Scan2.0229 = phi ptr [ %Scan2.0.val161, %for.body ], [ %call52, %if.then56 ]
  %Scan1.0228 = phi ptr [ %Scan1.0.val162, %for.body ], [ %call51, %if.then56 ]
  %44 = getelementptr i8, ptr %Scan1.0228, i64 8
  %Scan1.0.val = load ptr, ptr %44, align 8
  %45 = ptrtoint ptr %Scan1.0.val to i64
  %46 = trunc i64 %45 to i32
  %47 = getelementptr i8, ptr %Scan2.0229, i64 8
  ...
  %Scan1.0.val162 = load ptr, ptr %Scan1.0228, align 8
  %Scan2.0.val161 = load ptr, ptr %Scan2.0229, align 8
...
for.body76:                                       ; preds = %for.body76.preheader, %for.body76
  %Scan2.1232 = phi ptr [ %Scan2.1.val159, %for.body76 ], [ %ReducedLits.1, %for.body76.preheader ]
  %Scan1.1231 = phi ptr [ %Scan1.1.val160, %for.body76 ], [ %ReducedBy.1, %for.body76.preheader ]
  %55 = getelementptr i8, ptr %Scan1.1231, i64 8
  %Scan1.1.val = load ptr, ptr %55, align 8
  %56 = ptrtoint ptr %Scan1.1.val to i64
  %57 = trunc i64 %56 to i32
  %58 = getelementptr i8, ptr %Scan2.1232, i64 8
  ...
  %Scan1.1.val160 = load ptr, ptr %Scan1.1231, align 8
  %Scan2.1.val159 = load ptr, ptr %Scan2.1232, align 8
...
clause_LiteralAtom.exit:                          ; preds = %if.then, %if.then.i
  ...
  %tobool276.not = icmp eq ptr %call8, null
  br i1 %tobool276.not, label %land.lhs.true34, label %while.body

while.body:                                       ; preds = %clause_LiteralAtom.exit, %if.end31
  %CandTerm.0277 = phi ptr [ %call30, %if.end31 ], [ %call8, %clause_LiteralAtom.exit ]
  %CandTerm.0.val = load i32, ptr %CandTerm.0277, align 8
  %cmp.i.i191 = icmp sgt i32 %CandTerm.0.val, 0
  br i1 %cmp.i.i191, label %if.end31, label %if.then12

if.then12:                                        ; preds = %while.body
  %call13 = tail call ptr @sharing_NAtomDataList(ptr noundef nonnull %CandTerm.0277) #11
  %cmp.i.not274 = icmp eq ptr %call13, null
  br i1 %cmp.i.not274, label %if.end31, label %while.body17.preheader

while.body17.preheader:                           ; preds = %if.then12
  %.pre287 = load i32, ptr @fol_NOT, align 4
  %call3.val190 = load ptr, ptr %8, align 8
  %call3.val190.val = load i32, ptr %call3.val190, align 8
  %cmp.i.i192 = icmp eq i32 %.pre287, %call3.val190.val
  br label %while.body17

while.body17:                                     ; preds = %while.body17.preheader, %if.end
  %Scan.0275 = phi ptr [ %Scan.0.val184, %if.end ], [ %call13, %while.body17.preheader ]
  %12 = getelementptr i8, ptr %Scan.0275, i64 8
...
land.lhs.true.i:                                  ; preds = %while.body17
  %cmp.i.i.not.i = icmp eq i32 %L2.val10.val.i, %.pre287
  br i1 %cmp.i.i.not.i, label %if.end, label %land.lhs.true

lor.rhs.i.thread:                                 ; preds = %while.body17
  %cmp.i11.i291 = icmp eq i32 %.pre287, %L2.val10.val.i
  br i1 %cmp.i11.i291, label %land.lhs.true, label %if.end
...
if.end:                                           ; preds = %land.lhs.true.i, %land.lhs.true, %lor.rhs.i.thread
  %Scan.0.val184 = load ptr, ptr %Scan.0275, align 8
...
clause_LiteralAtom.exit204.thread:                ; preds = %land.lhs.true34
  %22 = load i32, ptr @fol_EQUALITY, align 4
  %cmp.i205258 = icmp eq i32 %22, %L.val7.val.i198
  br i1 %cmp.i205258, label %clause_LiteralAtom.exit213, label %cleanup
...
clause_LiteralAtom.exit213:                       ; preds = %clause_LiteralAtom.exit204, %clause_LiteralAtom.exit204.thread
  ...
  %tobool51283.not = icmp eq ptr %call47, null
  br i1 %tobool51283.not, label %while.end81, label %while.body53

while.body53:                                     ; preds = %clause_LiteralAtom.exit213, %if.end80
  %CandTerm.2284 = phi ptr [ %call79, %if.end80 ], [ %call47, %clause_LiteralAtom.exit213 ]
  %CandTerm.2.val = load i32, ptr %CandTerm.2284, align 8
  %cmp.i.i214 = icmp sgt i32 %CandTerm.2.val, 0
  br i1 %cmp.i.i214, label %if.end80, label %if.then56

if.then56:                                        ; preds = %while.body53
  %call57 = tail call ptr @sharing_NAtomDataList(ptr noundef nonnull %CandTerm.2284) #11
  %cmp.i216.not280 = icmp eq ptr %call57, null
  br i1 %cmp.i216.not280, label %if.end80, label %while.body62.preheader

while.body62.preheader:                           ; preds = %if.then56
  %.pre289 = load i32, ptr @fol_NOT, align 4
  %call3.val189 = load ptr, ptr %8, align 8
  %call3.val189.val = load i32, ptr %call3.val189, align 8
  %cmp.i.i218 = icmp eq i32 %.pre289, %call3.val189.val
  br label %while.body62

while.body62:                                     ; preds = %while.body62.preheader, %if.end74
  %Scan.2281 = phi ptr [ %Scan.2.val183, %if.end74 ], [ %call57, %while.body62.preheader ]
  %27 = getelementptr i8, ptr %Scan.2281, i64 8
...
land.lhs.true.i222:                               ; preds = %while.body62
  %cmp.i.i.not.i221 = icmp eq i32 %L2.val10.val.i220, %.pre289
  br i1 %cmp.i.i.not.i221, label %if.end74, label %land.lhs.true66

lor.rhs.i225.thread:                              ; preds = %while.body62
  %cmp.i11.i224307 = icmp eq i32 %.pre289, %L2.val10.val.i220
  br i1 %cmp.i11.i224307, label %land.lhs.true66, label %if.end74
...
if.end74:                                         ; preds = %land.lhs.true.i222, %land.lhs.true66, %lor.rhs.i225.thread
  %Scan.2.val183 = load ptr, ptr %Scan.2281, align 8
  %cmp.i216.not = icmp eq ptr %Scan.2.val183, null
  br i1 %cmp.i216.not, label %if.end80, label %while.body62, !llvm.loop !99
...
if.end83:                                         ; preds = %while.body.i, %while.end81
  ...
  %cmp.i235.not = icmp eq ptr %PLit.4.lcssa, null
  br i1 %cmp.i235.not, label %cleanup, label %if.then86

if.then86:                                        ; preds = %if.end31.thread, %if.end83
  %PLit.8273 = phi ptr [ %PLit.4.lcssa, %if.end83 ], [ %Scan.0.val, %if.end31.thread ]
  %arrayidx.i237 = getelementptr inbounds i32, ptr %Flags, i64 21
  %44 = load i32, ptr %arrayidx.i237, align 4
...
if.end91:                                         ; preds = %if.then89, %if.then86
  %47 = getelementptr i8, ptr %PLit.8273, i64 16
...
lor.lhs.false:                                    ; preds = %if.end91
  ...
  %cmp.i238 = icmp ugt i32 %call92.val188, %Clause.val187
  %cmp1.i = icmp ugt i32 %call92.val188, %Level
  %50 = or i1 %cmp1.i, %cmp.i238
...
if.then105:                                       ; preds = %if.end102
  ...
  %call.i.i240 = tail call ptr @memory_Malloc(i32 noundef 16) #11
  %car.i.i241 = getelementptr inbounds %struct.LIST_HELP, ptr %call.i.i240, i64 0, i32 1
  store ptr %51, ptr %car.i.i241, align 8
  store ptr null, ptr %call.i.i240, align 8
  %call.i.i242 = tail call ptr @memory_Malloc(i32 noundef 16) #11
  %52 = getelementptr i8, ptr %Copy.0, i64 32
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %call.i.i242, i8 0, i64 16, i1 false)
  %Clause.val.i244 = load ptr, ptr %52, align 8
  %cmp.i.not5.i.i = icmp eq ptr %Clause.val.i244, null
  br i1 %cmp.i.not5.i.i, label %list_Delete.exit.i, label %while.body.i.i

while.body.i.i:                                   ; preds = %if.then105, %while.body.i.i
  %Current.06.i.i = phi ptr [ %L.addr.0.val.i.i, %while.body.i.i ], [ %Clause.val.i244, %if.then105 ]
  %L.addr.0.val.i.i = load ptr, ptr %Current.06.i.i, align 8
...
list_Delete.exit23.i:                             ; preds = %while.body.i22.i, %list_Delete.exit.i
  ...
  %conv.i245 = sext i32 %Clause.val14.i to i64
  %64 = inttoptr i64 %conv.i245 to ptr
  %call.i.i.i = tail call ptr @memory_Malloc(i32 noundef 16) #11
  %car.i.i.i = getelementptr inbounds %struct.LIST_HELP, ptr %call.i.i.i, i64 0, i32 1
  store ptr %64, ptr %car.i.i.i, align 8
  store ptr %call.i.i240, ptr %call.i.i.i, align 8
...
for.end.i31.i:                                    ; preds = %for.cond.i30.i
  store ptr %call.i.i242, ptr %List1.addr.0.i27.i, align 8
...
if.end114:                                        ; preds = %for.end.i31.i, %if.end102
  %66 = load i32, ptr %arrayidx.i237, align 4
...
for.cond47.loopexit:                              ; preds = %for.inc82, %for.inc82.thread, %clause_LiteralAtom.exit284.for.cond47.loopexit_crit_edge
  ...
  br i1 %exitcond369.not, label %for.end87.loopexit, label %for.body50, !llvm.loop !103
...
while.body.i328:                                  ; preds = %while.body.i328.prol.loopexit, %while.body.i328
  ...
  br i1 %cmp.i327.1, label %while.body.i328, label %while.end.i, !llvm.loop !36
...
if.end:                                           ; preds = %if.then, %entry
  %2 = getelementptr i8, ptr %Partner, i64 12
  %Partner.val19 = load i32, ptr %2, align 4
  %cmp = icmp eq i32 %Partner.val19, 0
  br i1 %cmp, label %return, label %if.end3

if.end3:                                          ; preds = %if.end
  %3 = getelementptr i8, ptr %Result, i64 12
  %Result.val17 = load i32, ptr %3, align 4
  %Partner.val19.Result.val17 = tail call i32 @llvm.umax.i32(i32 %Partner.val19, i32 %Result.val17)
  store i32 %Partner.val19.Result.val17, ptr %3, align 4
  ...
  %5 = load i32, ptr %splitfield_length1.i, align 8
  %cmp.i21 = icmp ult i32 %4, %5
...
if.then.i.i:                                      ; preds = %if.end3
  ...
  %6 = load i32, ptr %splitfield_length.i, align 8
  %cmp349.not.i.i = icmp eq i32 %6, 0
...
for.cond8.preheader.i.i:                          ; preds = %for.body.i.i, %if.then.i.i
  %.lcssa.i.i = phi i32 [ 0, %if.then.i.i ], [ %16, %for.body.i.i ]
  %cmp951.i.i = icmp ult i32 %.lcssa.i.i, %5
...
for.body11.preheader.i.i:                         ; preds = %for.cond8.preheader.i.i
  %7 = zext i32 %.lcssa.i.i to i64
  %8 = shl nuw nsw i64 %7, 3
  %scevgep.i.i = getelementptr i8, ptr %call.i.i, i64 %8
  %9 = xor i32 %.lcssa.i.i, -1
  %10 = add i32 %5, %9
  %11 = zext i32 %10 to i64
  %12 = shl nuw nsw i64 %11, 3
  %13 = add nuw nsw i64 %12, 8
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(1) %scevgep.i.i, i8 0, i64 %13, i1 false)
  br label %for.end16.i.i

for.body.i.i:                                     ; preds = %for.body.i.i, %for.body.lr.ph.i.i
  %indvars.iv.i.i = phi i64 [ 0, %for.body.lr.ph.i.i ], [ %indvars.iv.next.i.i, %for.body.i.i ]
  %14 = load ptr, ptr %splitfield.i.i, align 8
  %arrayidx.i.i = getelementptr inbounds i64, ptr %14, i64 %indvars.iv.i.i
  %15 = load i64, ptr %arrayidx.i.i, align 8
  %arrayidx6.i.i = getelementptr inbounds i64, ptr %call.i.i, i64 %indvars.iv.i.i
  store i64 %15, ptr %arrayidx6.i.i, align 8
  %indvars.iv.next.i.i = add nuw nsw i64 %indvars.iv.i.i, 1
  %16 = load i32, ptr %splitfield_length.i, align 8
  %17 = zext i32 %16 to i64
  %cmp3.i.i = icmp ult i64 %indvars.iv.next.i.i, %17
...
for.end16.i.i:                                    ; preds = %for.body11.preheader.i.i, %for.cond8.preheader.i.i
  ...
  %18 = load ptr, ptr %splitfield17.i.i, align 8
...
if.then20.i.i:                                    ; preds = %for.end16.i.i
  %19 = load i32, ptr %splitfield_length.i, align 8
  %mul24.i.i = shl i32 %19, 3
...
if.then.i.i.i:                                    ; preds = %if.then20.i.i
  ...
  %rem2.i.i.i.i.i = urem i32 %mul24.i.i, %20
  %tobool3.not.i.i.i.i.i = icmp eq i32 %rem2.i.i.i.i.i, 0
  %sub6.i.i.i.i.i = add i32 %20, %mul24.i.i
...
if.end23.i.i.i:                                   ; preds = %if.then18.i.i.i, %if.end13.i.i.i
  %add.ptr24.i.i.i = getelementptr inbounds i8, ptr %18, i64 -16
...
if.end.i.i:                                       ; preds = %if.else25.i.i.i, %if.end23.i.i.i, %for.end16.i.i
  ...
  store i32 %5, ptr %splitfield_length.i, align 8
  %.pre.i = load i32, ptr %splitfield_length1.i, align 8
  br label %if.end.i

if.end.i:                                         ; preds = %if.end.i.i, %if.end3
  %34 = phi i32 [ %.pre.i, %if.end.i.i ], [ %5, %if.end3 ]
  %cmp421.not.i = icmp eq i32 %34, 0
...
for.body.i:                                       ; preds = %for.body.i, %for.body.lr.ph.i
  ...
  %35 = load ptr, ptr %splitfield.i, align 8
  %arrayidx.i = getelementptr inbounds i64, ptr %35, i64 %indvars.iv.i
  %36 = load i64, ptr %arrayidx.i, align 8
  %37 = load ptr, ptr %splitfield5.i, align 8
  %arrayidx7.i = getelementptr inbounds i64, ptr %37, i64 %indvars.iv.i
  %38 = load i64, ptr %arrayidx7.i, align 8
  %or.i22 = or i64 %38, %36
  store i64 %or.i22, ptr %arrayidx.i, align 8
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1
  %39 = load i32, ptr %splitfield_length1.i, align 8
  %40 = zext i32 %39 to i64
  %cmp4.i = icmp ult i64 %indvars.iv.next.i, %40
...
entry:
  ...
  %0 = getelementptr i8, ptr %Search, i64 112
  %Search.val = load ptr, ptr %0, align 8
  %Search.val436 = ptrtoint ptr %Search.val to i64
  %1 = getelementptr i8, ptr %Search, i64 104
...
if.end28:                                         ; preds = %land.lhs.true19, %clause_LiteralIsEquality.exit, %clause_GetLiteralAtom.exit176
  ...
  %add3.i.i = add i32 %add.i.i, -1
  %sub.i = add i32 %add3.i.i, %Clause.val7.i.i
  %cmp31.not355 = icmp slt i32 %sub.i, 0
  br i1 %cmp31.not355, label %for.end, label %for.body.preheader
...
while.body.i212.preheader:                        ; preds = %for.end
  %xtraiter453 = and i32 %.pr.i205, 1
  %lcmp.mod454.not = icmp eq i32 %xtraiter453, 0
  br i1 %lcmp.mod454.not, label %while.body.i212.prol.loopexit, label %while.body.i212.prol
...
while.body.i212.prol.loopexit:                    ; preds = %while.body.i212.prol, %while.body.i212.preheader
  %.unr455 = phi i32 [ %.pr.i205, %while.body.i212.preheader ], [ %dec.i.i.i210.prol, %while.body.i212.prol ]
...
while.body.i212:                                  ; preds = %while.body.i212.prol.loopexit, %while.body.i212
  %72 = phi i32 [ %dec.i.i.i210.1, %while.body.i212 ], [ %.unr455, %while.body.i212.prol.loopexit ]
...
cont_BackTrack.exit219:                           ; preds = %while.end.i214, %if.then.i218
  ...
  %call.i435 = ptrtoint ptr %call.i to i64
  ...
  %84 = sub i64 %call.i435, %Search.val436
...
flag_TransferAllFlags.exit:                       ; preds = %for.body.i, %vector.body
  ...
  %cmp45357 = icmp sgt i32 %sub.i226, -1
  br i1 %cmp45357, label %for.body46.lr.ph, label %for.end68
...
for.body46:                                       ; preds = %for.body46.lr.ph, %for.inc66
  %indvars.iv368 = phi i64 [ 0, %for.body46.lr.ph ], [ %indvars.iv.next369, %for.inc66 ]
  %cmp47.not = icmp eq i64 %indvars.iv368, %139
...
if.then48:                                        ; preds = %for.body46
  ...
  %arrayidx.i334 = getelementptr inbounds ptr, ptr %RuleClause.val.i, i64 %indvars.iv368
...
clause_LiteralAtom.exit:                          ; preds = %if.then48, %if.then.i331
  ...
  %cmp.i228.not.not = icmp slt i64 %indvars.iv368, %147
...
if.end.i:                                         ; preds = %if.then15.i
  ...
  br i1 %cmp19.i.not, label %red_CRwLitTautologyCheck.exit.thread377, label %red_CRwLitTautologyCheck.exit.thread

red_CRwLitTautologyCheck.exit.thread377:          ; preds = %if.end.i
...
if.then24.i:                                      ; preds = %if.end22.i
  ...
  %cmp26.i.not.not = icmp slt i64 %indvars.iv368, %161
...
while.body.i.i.preheader:                         ; preds = %for.end.i274
  %xtraiter456 = and i32 %.pr.i.i, 1
  %lcmp.mod457.not = icmp eq i32 %xtraiter456, 0
  br i1 %lcmp.mod457.not, label %while.body.i.i.prol.loopexit, label %while.body.i.i.prol
...
while.body.i.i.prol.loopexit:                     ; preds = %while.body.i.i.prol, %while.body.i.i.preheader
  %.unr458 = phi i32 [ %.pr.i.i, %while.body.i.i.preheader ], [ %dec.i.i.i.i.prol, %while.body.i.i.prol ]
...
while.body.i.i:                                   ; preds = %while.body.i.i.prol.loopexit, %while.body.i.i
  %222 = phi i32 [ %dec.i.i.i.i.1, %while.body.i.i ], [ %.unr458, %while.body.i.i.prol.loopexit ]
  ...
  br i1 %cmp.i145.i.1, label %while.body.i.i, label %while.end.i.i, !llvm.loop !36
...
list_Delete.exit.i.loopexit:                      ; preds = %while.body.i150.i
  %.pre371.pre = load ptr, ptr %aux.i, align 8
  br label %list_Delete.exit.i

list_Delete.exit.i:                               ; preds = %list_Delete.exit.i.loopexit, %if.then65.i
  %.pre371 = phi ptr [ %.pre371.pre, %list_Delete.exit.i.loopexit ], [ %172, %if.then65.i ]
...
red_PropagateDefinitions.exit:                    ; preds = %list_Delete.exit286, %for.end63.i, %list_Delete.exit.i
  %237 = phi ptr [ %172, %list_Delete.exit286 ], [ %172, %for.end63.i ], [ %.pre371, %list_Delete.exit.i ]
  store ptr null, ptr %NewClause.i, align 8
...
if.end56.i:                                       ; preds = %if.then55.i, %if.then53.i
  ...
  %.pre427 = load ptr, ptr %RedundantList.i, align 8
  br i1 %tobool57.i.not, label %red_CRwLitTautologyCheck.exit.thread380, label %if.then58.i

if.then58.i:                                      ; preds = %if.end56.i
  %243 = getelementptr i8, ptr %238, i64 32
  %Reduced.val.i391 = load ptr, ptr %243, align 8
  store ptr null, ptr %243, align 8
  %cmp.i.not65.i = icmp eq ptr %.pre427, null
  br i1 %cmp.i.not65.i, label %for.end.i396, label %for.body.i393

for.body.i393:                                    ; preds = %if.then58.i, %list_Append.exit.i
  %Parents.067.i = phi ptr [ %retval.0.i.i394, %list_Append.exit.i ], [ %Reduced.val.i391, %if.then58.i ]
  %Scan.066.i = phi ptr [ %Scan.0.val57.i, %list_Append.exit.i ], [ %.pre427, %if.then58.i ]
  ...
  %cmp.i.i.i392 = icmp eq ptr %call3.val.i, null
  br i1 %cmp.i.i.i392, label %list_Append.exit.i, label %if.end.i.i

if.end.i.i:                                       ; preds = %for.body.i393
...
list_Append.exit.i:                               ; preds = %for.end.i.i, %if.end.i.i, %for.body.i393
  %retval.0.i.i394 = phi ptr [ %call4.i.i, %for.end.i.i ], [ %Parents.067.i, %for.body.i393 ], [ %call4.i.i, %if.end.i.i ]
  %Scan.0.val57.i = load ptr, ptr %Scan.066.i, align 8
  %cmp.i.not.i395 = icmp eq ptr %Scan.0.val57.i, null
  br i1 %cmp.i.not.i395, label %for.end.i396, label %for.body.i393, !llvm.loop !112

for.end.i396:                                     ; preds = %list_Append.exit.i, %if.then58.i
  %Parents.0.lcssa.i = phi ptr [ %Reduced.val.i391, %if.then58.i ], [ %retval.0.i.i394, %list_Append.exit.i ]
  br i1 %cmp54.i.not, label %if.end.i401, label %if.then.i399

if.then.i399:                                     ; preds = %for.end.i396
  ...
  store ptr %246, ptr %car.i.i398, align 8
  store ptr %Parents.0.lcssa.i, ptr %call.i.i397, align 8
  br label %if.end.i401

if.end.i401:                                      ; preds = %if.then.i399, %for.end.i396
  %Parents.1.i = phi ptr [ %call.i.i397, %if.then.i399 ], [ %Parents.0.lcssa.i, %for.end.i396 ]
  %conv9.i400 = sext i32 %.val.i to i64
  %247 = inttoptr i64 %conv9.i400 to ptr
...
for.body15.i:                                     ; preds = %if.end.i401, %for.body15.i
  %Parents.270.i = phi ptr [ %call19.i, %for.body15.i ], [ %call10.i, %if.end.i401 ]
  %Scan.169.i = phi ptr [ %Scan.1.val56.i, %for.body15.i ], [ %.pre427, %if.end.i401 ]
...
for.end22.i:                                      ; preds = %for.body15.i, %if.end.i401
  %Parents.2.lcssa.i = phi ptr [ %call10.i, %if.end.i401 ], [ %call19.i, %for.body15.i ]
  %call23.i402 = tail call ptr @list_PointerDeleteDuplicates(ptr noundef %Parents.2.lcssa.i) #11
  store ptr %call23.i402, ptr %243, align 8
  %call24.i403 = tail call ptr @list_Copy(ptr noundef %call23.i402) #11
  %cmp.i62.not72.i404 = icmp eq ptr %call24.i403, null
  br i1 %cmp.i62.not72.i404, label %for.end32.i412, label %for.body29.i409

for.body29.i409:                                  ; preds = %for.end22.i, %for.body29.i409
  %Scan.273.i405 = phi ptr [ %Scan.2.val.i407, %for.body29.i409 ], [ %call24.i403, %for.end22.i ]
  %car.i64.i406 = getelementptr inbounds %struct.LIST_HELP, ptr %Scan.273.i405, i64 0, i32 1
  store ptr null, ptr %car.i64.i406, align 8
  %Scan.2.val.i407 = load ptr, ptr %Scan.273.i405, align 8
  %cmp.i62.not.i408 = icmp eq ptr %Scan.2.val.i407, null
  br i1 %cmp.i62.not.i408, label %for.end32.i412, label %for.body29.i409, !llvm.loop !108

for.end32.i412:                                   ; preds = %for.body29.i409, %for.end22.i
  %250 = getelementptr i8, ptr %238, i64 40
  %Reduced.val58.i410 = load ptr, ptr %250, align 8
  %cmp.i.not5.i.i411 = icmp eq ptr %Reduced.val58.i410, null
  br i1 %cmp.i.not5.i.i411, label %red_CRwCalculateAdditionalParents.exit, label %while.body.i.i419

while.body.i.i419:                                ; preds = %for.end32.i412, %while.body.i.i419
  %Current.06.i.i413 = phi ptr [ %L.addr.0.val.i.i414, %while.body.i.i419 ], [ %Reduced.val58.i410, %for.end32.i412 ]
  %L.addr.0.val.i.i414 = load ptr, ptr %Current.06.i.i413, align 8
  %251 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i.i415 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %251, i64 0, i32 4
  %252 = load i32, ptr %total_size.i.i.i.i415, align 8
  %conv26.i.i.i.i416 = sext i32 %252 to i64
  %253 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i.i417 = add i64 %253, %conv26.i.i.i.i416
  store i64 %add27.i.i.i.i417, ptr @memory_FREEDBYTES, align 8
  %254 = load ptr, ptr %251, align 8
  store ptr %254, ptr %Current.06.i.i413, align 8
  %255 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i.i413, ptr %255, align 8
  %cmp.i.not.i.i418 = icmp eq ptr %L.addr.0.val.i.i414, null
  br i1 %cmp.i.not.i.i418, label %red_CRwCalculateAdditionalParents.exit, label %while.body.i.i419, !llvm.loop !8

red_CRwCalculateAdditionalParents.exit:           ; preds = %while.body.i.i419, %for.end32.i412
  store ptr %call24.i403, ptr %250, align 8
  br label %red_CRwLitTautologyCheck.exit.thread380

red_CRwLitTautologyCheck.exit.thread380:          ; preds = %if.end56.i, %red_CRwCalculateAdditionalParents.exit
  tail call void @clause_DeleteClauseList(ptr noundef %.pre427) #11
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %RedundantList.i) #11
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %NewClause.i) #11
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %aux.i) #11
  br label %if.else
...
if.else:                                          ; preds = %red_CRwLitTautologyCheck.exit.thread380, %red_CRwLitTautologyCheck.exit.thread377, %red_CRwLitTautologyCheck.exit.thread
  %retval.0.i351 = phi ptr [ %.pre, %red_CRwLitTautologyCheck.exit.thread ], [ %call11.i, %red_CRwLitTautologyCheck.exit.thread377 ], [ %238, %red_CRwLitTautologyCheck.exit.thread380 ]
  tail call fastcc void @clause_UpdateSplitDataFromPartner(ptr noundef %call2, ptr noundef nonnull %retval.0.i351)
...
if.then54:                                        ; preds = %if.else
  %258 = getelementptr i8, ptr %retval.0.i351, i64 32
...
list_Nconc.exit:                                  ; preds = %if.then54, %if.end.i232, %for.end.i
  ...
  %259 = getelementptr i8, ptr %retval.0.i351, i64 40
...
if.end63:                                         ; preds = %list_Nconc.exit244, %if.else
  tail call void @clause_Delete(ptr noundef nonnull %retval.0.i351) #11
  br label %for.inc66

for.inc66:                                        ; preds = %for.body46, %if.end63
  %indvars.iv.next369 = add nuw nsw i64 %indvars.iv368, 1
  %exitcond.not428 = icmp eq i64 %indvars.iv368, %140
  br i1 %exitcond.not428, label %for.end68, label %for.body46, !llvm.loop !114
...
flag_TransferAllFlags.exit255:                    ; preds = %for.body.i253, %vector.body444
