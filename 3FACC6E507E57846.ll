...
while.cond.preheader:                             ; preds = %if.end
  %cmp6392 = icmp sgt i32 %0, 0
  br i1 %cmp6392, label %while.body.lr.ph, label %cleanup170
...
while.body:                                       ; preds = %while.body.lr.ph, %cleanup152
  %pos.0396 = phi i32 [ 0, %while.body.lr.ph ], [ %pos.6, %cleanup152 ]
  %4 = load ptr, ptr %s, align 8, !tbaa !27
  %idxprom8 = sext i32 %pos.0396 to i64
  ...
  %spec.select = add nsw i32 %pos.0396, %inc
...
_ZN11CStringBaseIwED2Ev.exit264:                  ; preds = %invoke.cont29, %delete.notnull.i263
  ...
  %.pre401 = load i32, ptr %this, align 8, !tbaa !5
  br label %cleanup

cleanup:                                          ; preds = %_Z11MyStringLenIwEiPKT_.exit, %_ZN11CStringBaseIwED2Ev.exit264
  %37 = phi i32 [ %.pre401, %_ZN11CStringBaseIwED2Ev.exit264 ], [ %7, %_Z11MyStringLenIwEiPKT_.exit ]
...
for.body117:                                      ; preds = %for.body117.preheader, %for.inc133
  %indvars.iv398 = phi i64 [ %78, %for.body117.preheader ], [ %indvars.iv.next399, %for.inc133 ]
  %i.0388 = phi i32 [ %61, %for.body117.preheader ], [ %inc134, %for.inc133 ]
  %79 = load ptr, ptr %s, align 8, !tbaa !27
  %arrayidx122 = getelementptr inbounds i32, ptr %79, i64 %indvars.iv398
...
call.i.i.i.noexc:                                 ; preds = %if.end.i.i.i319
  %call.i.i.i321443 = ptrtoint ptr %call.i.i.i321 to i64
...
for.body.lr.ph.i.i.i:                             ; preds = %for.cond.preheader.i.i.i
  ...
  %90 = sub i64 %call.i.i.i321443, %89
  %diff.check = icmp ult i64 %90, 32
  %or.cond445 = select i1 %min.iters.check, i1 true, i1 %diff.check
  br i1 %or.cond445, label %for.body.i.i.i.preheader, label %vector.ph
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load444 = load <4 x i32>, ptr %92, align 4, !tbaa !28
  ...
  store <4 x i32> %wide.load444, ptr %94, align 4, !tbaa !28
...
for.inc133:                                       ; preds = %if.end9.i.i.i, %if.end.i.i317, %if.end126
  ...
  %cmp115 = icmp slt i64 %indvars.iv.next399, %3
...
cleanup136.loopexit:                              ; preds = %for.body117, %for.inc133
  %pos.4.lcssa.ph.ph.in = phi i64 [ %indvars.iv398, %for.body117 ], [ %indvars.iv.next399, %for.inc133 ]
  %pos.4.lcssa.ph.ph = trunc i64 %pos.4.lcssa.ph.ph.in to i32
  br label %cleanup136

cleanup136:                                       ; preds = %cleanup136.loopexit, %if.end110
  %pos.4.lcssa = phi i32 [ %add112, %if.end110 ], [ %pos.4.lcssa.ph.ph, %cleanup136.loopexit ]
...
for.cond.preheader.i.i:                           ; preds = %if.then
  %cmp42.i.i = icmp sgt i32 %.pre, 0
  br i1 %cmp42.i.i, label %for.cond2.preheader.lr.ph.i.i, label %cleanup
...
land.rhs.us.i.i:                                  ; preds = %for.inc.us.i.i, %for.cond2.preheader.us.i.i
  ...
  %12 = add nuw nsw i64 %indvars.iv.i.i35, %indvars.iv57.i.i
...
for.inc19.us.i.i:                                 ; preds = %for.body7.us.i.i, %land.rhs.us.i.i
  ...
  %15 = icmp eq i64 %indvars.iv.next58.i.i, %11
...
invoke.cont:                                      ; preds = %for.inc.us.i.i
  %16 = and i64 %indvars.iv57.i.i, 4294967295
