...
while.end158.i:                                   ; preds = %while.body155.i, %while.end158.i.loopexit.split.loop.exit, %for.end138.i
  %cnt106.2.lcssa.i = phi i32 [ %cnt106.0.lcssa.i, %for.end138.i ], [ %cnt106.2352.i, %while.end158.i.loopexit.split.loop.exit ], [ %115, %while.body155.i ]
  ...
  %invariant.umin360.i = call i32 @llvm.umin.i32(i32 %sub160.i, i32 %pos108.1.lcssa.fr.i)
...
for.body167.lr.ph.i:                              ; preds = %while.end158.i
  ...
  %min.iters.check76 = icmp ult i32 %invariant.umin360.i, 12
...
for.body167.i.preheader:                          ; preds = %vector.scevcheck73, %for.body167.lr.ph.i, %middle.block74
  ...
  %cntDna107.0361.i.ph = phi i32 [ 0, %vector.scevcheck73 ], [ 0, %for.body167.lr.ph.i ], [ %139, %middle.block74 ]
