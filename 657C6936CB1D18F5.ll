...
while.end158.i:                                   ; preds = %while.body155.i, %land.rhs144.i, %for.end138.i
  %cnt106.2.lcssa.i = phi i32 [ %cnt106.0.lcssa.i, %for.end138.i ], [ %cnt106.2351.i, %land.rhs144.i ], [ %115, %while.body155.i ]
...
for.body167.i.preheader:                          ; preds = %vector.scevcheck63, %for.body167.lr.ph.i, %middle.block64
  ...
  %cntDna107.0360.i.ph = phi i32 [ 0, %vector.scevcheck63 ], [ 0, %for.body167.lr.ph.i ], [ %137, %middle.block64 ]
