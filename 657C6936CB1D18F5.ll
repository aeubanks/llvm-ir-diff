...
sw.bb14:                                          ; preds = %while.cond
  ...
  %call.i341 = tail call i64 @strtol(ptr nocapture noundef nonnull %4, ptr noundef null, i32 noundef 10) #18
  %conv.i342 = trunc i64 %call.i341 to i32
  %cmp16 = icmp slt i32 %conv.i342, 0
...
if.end18:                                         ; preds = %sw.bb14
  store i32 %conv.i342, ptr getelementptr inbounds (%struct._options_t, ptr @options, i64 0, i32 4), align 8, !tbaa !20
...
sw.bb19:                                          ; preds = %while.cond
  ...
  %call.i343 = tail call i64 @strtol(ptr nocapture noundef nonnull %5, ptr noundef null, i32 noundef 10) #18
  %conv.i344 = trunc i64 %call.i343 to i32
  %cmp22 = icmp slt i32 %conv.i344, 0
...
if.end24:                                         ; preds = %sw.bb19
  store i32 %conv.i344, ptr getelementptr inbounds (%struct._options_t, ptr @options, i64 0, i32 17), align 4, !tbaa !18
  br label %while.cond.backedge

sw.bb25:                                          ; preds = %while.cond
  %6 = load ptr, ptr @optarg, align 8, !tbaa !5
  %call.i345 = tail call i64 @strtol(ptr nocapture noundef nonnull %6, ptr noundef null, i32 noundef 10) #18
  %conv.i346 = trunc i64 %call.i345 to i32
  store i32 %conv.i346, ptr getelementptr inbounds (%struct._options_t, ptr @options, i64 0, i32 5), align 4, !tbaa !21
  %7 = add i32 %conv.i346, -11
...
sw.bb32:                                          ; preds = %while.cond
  ...
  %call.i347 = tail call i64 @strtol(ptr nocapture noundef nonnull %8, ptr noundef null, i32 noundef 10) #18
  %conv.i348 = trunc i64 %call.i347 to i32
  store i32 %conv.i348, ptr getelementptr inbounds (%struct._options_t, ptr @options, i64 0, i32 16), align 8, !tbaa !17
  %cmp34 = icmp ugt i32 %conv.i348, 100
...
sw.bb37:                                          ; preds = %while.cond
  ...
  %call.i349 = tail call i64 @strtol(ptr nocapture noundef nonnull %9, ptr noundef null, i32 noundef 10) #18
  %conv.i350 = trunc i64 %call.i349 to i32
  store i32 %conv.i350, ptr getelementptr inbounds (%struct._options_t, ptr @options, i64 0, i32 6), align 8, !tbaa !22
  br label %while.cond.backedge

sw.bb39:                                          ; preds = %while.cond
  %10 = load ptr, ptr @optarg, align 8, !tbaa !5
  %call.i351 = tail call i64 @strtol(ptr nocapture noundef nonnull %10, ptr noundef null, i32 noundef 10) #18
  %conv.i352 = trunc i64 %call.i351 to i32
  store i32 %conv.i352, ptr getelementptr inbounds (%struct._options_t, ptr @options, i64 0, i32 7), align 4, !tbaa !23
  br label %while.cond.backedge

sw.bb41:                                          ; preds = %while.cond
  %11 = load ptr, ptr @optarg, align 8, !tbaa !5
  %call.i353 = tail call i64 @strtol(ptr nocapture noundef nonnull %11, ptr noundef null, i32 noundef 10) #18
  %conv.i354 = trunc i64 %call.i353 to i32
  %cmp44 = icmp slt i32 %conv.i354, 0
...
if.end46:                                         ; preds = %sw.bb41
  store i32 %conv.i354, ptr getelementptr inbounds (%struct._options_t, ptr @options, i64 0, i32 8), align 8, !tbaa !24
  br label %while.cond.backedge
...
sw.bb86:                                          ; preds = %while.cond
  ...
  %call.i355 = tail call i64 @strtol(ptr nocapture noundef nonnull %14, ptr noundef null, i32 noundef 10) #18
  %conv.i356 = trunc i64 %call.i355 to i32
  %cmp89 = icmp slt i32 %conv.i356, 0
...
if.end92:                                         ; preds = %sw.bb86
  store i32 %conv.i356, ptr getelementptr inbounds (%struct._options_t, ptr @options, i64 0, i32 9), align 4, !tbaa !28
  br label %while.cond.backedge

sw.bb93:                                          ; preds = %while.cond
  %15 = load ptr, ptr @optarg, align 8, !tbaa !5
  %call.i357 = tail call i64 @strtol(ptr nocapture noundef nonnull %15, ptr noundef null, i32 noundef 10) #18
  %conv.i358 = trunc i64 %call.i357 to i32
  store i32 %conv.i358, ptr getelementptr inbounds (%struct._options_t, ptr @options, i64 0, i32 15), align 4, !tbaa !29
  br label %while.cond.backedge

sw.bb95:                                          ; preds = %while.cond
  %16 = load ptr, ptr @optarg, align 8, !tbaa !5
  %call.i359 = tail call i64 @strtol(ptr nocapture noundef nonnull %16, ptr noundef null, i32 noundef 10) #18
  %conv.i360 = trunc i64 %call.i359 to i32
  store i32 %conv.i360, ptr getelementptr inbounds (%struct._options_t, ptr @options, i64 0, i32 10), align 8, !tbaa !30
  br label %while.cond.backedge

sw.bb97:                                          ; preds = %while.cond
  %17 = load ptr, ptr @optarg, align 8, !tbaa !5
  %call.i361 = tail call i64 @strtol(ptr nocapture noundef nonnull %17, ptr noundef null, i32 noundef 10) #18
  %conv.i362 = trunc i64 %call.i361 to i32
  store i32 %conv.i362, ptr getelementptr inbounds (%struct._options_t, ptr @options, i64 0, i32 11), align 4, !tbaa !31
  %or.cond281 = icmp ugt i32 %conv.i362, 2
...
sw.bb106:                                         ; preds = %while.cond
  ...
  %call.i363 = tail call i64 @strtol(ptr nocapture noundef nonnull %18, ptr noundef null, i32 noundef 10) #18
  %conv.i364 = trunc i64 %call.i363 to i32
  store i32 %conv.i364, ptr getelementptr inbounds (%struct._options_t, ptr @options, i64 0, i32 12), align 8, !tbaa !14
  br label %while.cond.backedge

sw.bb108:                                         ; preds = %while.cond
  %19 = load ptr, ptr @optarg, align 8, !tbaa !5
  %call.i365 = tail call i64 @strtol(ptr nocapture noundef nonnull %19, ptr noundef null, i32 noundef 10) #18
  %conv.i366 = trunc i64 %call.i365 to i32
  store i32 %conv.i366, ptr getelementptr inbounds (%struct._options_t, ptr @options, i64 0, i32 13), align 4, !tbaa !15
  %20 = add i32 %conv.i366, -16
...
sw.bb117:                                         ; preds = %while.cond
  ...
  %call.i367 = tail call i64 @strtol(ptr nocapture noundef nonnull %21, ptr noundef null, i32 noundef 10) #18
  %conv.i368 = trunc i64 %call.i367 to i32
  store i32 %conv.i368, ptr getelementptr inbounds (%struct._options_t, ptr @options, i64 0, i32 14), align 8, !tbaa !16
  %cmp119 = icmp slt i32 %conv.i368, 1
...
if.end150:                                        ; preds = %if.end138
  ...
  %conv.i369 = zext i32 %54 to i64
  %mul.i = shl nuw nsw i64 %conv.i369, 3
  %call.i370 = call ptr @xmalloc(i64 noundef %mul.i) #18
  store ptr %call.i370, ptr getelementptr inbounds (%struct._options_t, ptr @options, i64 0, i32 1), align 8, !tbaa !38
...
sw.bb162:                                         ; preds = %while.body156, %sw.bb161
  %seq2.val340 = load i32, ptr %79, align 4, !tbaa !37
  %cmp1.not.i = icmp eq i32 %seq2.val340, 0
  br i1 %cmp1.not.i, label %sw.epilog164, label %while.body.preheader.i

while.body.preheader.i:                           ; preds = %sw.bb162
  %seq2.val339 = load ptr, ptr %80, align 8, !tbaa !36
  %idx.ext.i = zext i32 %seq2.val340 to i64
  %add.ptr.i = getelementptr inbounds i8, ptr %seq2.val339, i64 %idx.ext.i
  br label %while.body.i

while.body.i:                                     ; preds = %while.body.i, %while.body.preheader.i
  %s.03.i = phi ptr [ %incdec.ptr5.i, %while.body.i ], [ %seq2.val339, %while.body.preheader.i ]
  ...
  %idxprom.i371 = zext i8 %83 to i64
  %arrayidx.i372 = getelementptr inbounds [256 x i8], ptr @dna_complement, i64 0, i64 %idxprom.i371
  %84 = load i8, ptr %arrayidx.i372, align 1, !tbaa !25
  ...
  %cmp.i373 = icmp ult ptr %incdec.ptr5.i, %incdec.ptr.i
  br i1 %cmp.i373, label %while.body.i, label %sw.epilog164, !llvm.loop !40
...
for.body187:                                      ; preds = %for.body187, %for.body187.lr.ph.new
  ...
  %max_nmatches.2410 = phi i32 [ %max_nmatches.0.lcssa, %for.body187.lr.ph.new ], [ %spec.select389.3, %for.body187 ]
  ...
  %spec.select389 = call i32 @llvm.umax.i32(i32 %104, i32 %max_nmatches.2410)
  ...
  %spec.select389.1 = call i32 @llvm.umax.i32(i32 %106, i32 %spec.select389)
  ...
  %spec.select389.2 = call i32 @llvm.umax.i32(i32 %108, i32 %spec.select389.1)
  ...
  %spec.select389.3 = call i32 @llvm.umax.i32(i32 %110, i32 %spec.select389.2)
...
for.end202.loopexit.unr-lcssa:                    ; preds = %for.body187, %for.body187.lr.ph
  %spec.select389.lcssa.ph = phi i32 [ undef, %for.body187.lr.ph ], [ %spec.select389.3, %for.body187 ]
  %indvars.iv428.unr = phi i64 [ 0, %for.body187.lr.ph ], [ %indvars.iv.next429.3, %for.body187 ]
  %max_nmatches.2410.unr = phi i32 [ %max_nmatches.0.lcssa, %for.body187.lr.ph ], [ %spec.select389.3, %for.body187 ]
...
for.body187.epil:                                 ; preds = %for.end202.loopexit.unr-lcssa, %for.body187.epil
  ...
  %max_nmatches.2410.epil = phi i32 [ %spec.select389.epil, %for.body187.epil ], [ %max_nmatches.2410.unr, %for.end202.loopexit.unr-lcssa ]
  ...
  %spec.select389.epil = call i32 @llvm.umax.i32(i32 %112, i32 %max_nmatches.2410.epil)
...
for.end202:                                       ; preds = %for.end202.loopexit.unr-lcssa, %for.body187.epil, %for.cond183.preheader
  %max_nmatches.2.lcssa = phi i32 [ %max_nmatches.0.lcssa, %for.cond183.preheader ], [ %spec.select389.lcssa.ph, %for.end202.loopexit.unr-lcssa ], [ %spec.select389.epil, %for.body187.epil ]
...
if.then259:                                       ; preds = %for.end254
  %seq2.val338 = load i32, ptr %79, align 4, !tbaa !37
  %cmp1.not.i374 = icmp eq i32 %seq2.val338, 0
  br i1 %cmp1.not.i374, label %if.end260, label %while.body.preheader.i377

while.body.preheader.i377:                        ; preds = %if.then259
  %seq2.val = load ptr, ptr %80, align 8, !tbaa !36
  %idx.ext.i375 = zext i32 %seq2.val338 to i64
  %add.ptr.i376 = getelementptr inbounds i8, ptr %seq2.val, i64 %idx.ext.i375
  br label %while.body.i387

while.body.i387:                                  ; preds = %while.body.i387, %while.body.preheader.i377
  %s.03.i378 = phi ptr [ %incdec.ptr5.i385, %while.body.i387 ], [ %seq2.val, %while.body.preheader.i377 ]
  %t.02.i379 = phi ptr [ %incdec.ptr.i380, %while.body.i387 ], [ %add.ptr.i376, %while.body.preheader.i377 ]
  %incdec.ptr.i380 = getelementptr inbounds i8, ptr %t.02.i379, i64 -1
  %135 = load i8, ptr %incdec.ptr.i380, align 1, !tbaa !25
  %idxprom.i381 = zext i8 %135 to i64
  %arrayidx.i382 = getelementptr inbounds [256 x i8], ptr @dna_complement, i64 0, i64 %idxprom.i381
  %136 = load i8, ptr %arrayidx.i382, align 1, !tbaa !25
  %137 = load i8, ptr %s.03.i378, align 1, !tbaa !25
  %idxprom3.i383 = zext i8 %137 to i64
  %arrayidx4.i384 = getelementptr inbounds [256 x i8], ptr @dna_complement, i64 0, i64 %idxprom3.i383
  %138 = load i8, ptr %arrayidx4.i384, align 1, !tbaa !25
  store i8 %138, ptr %incdec.ptr.i380, align 1, !tbaa !25
  %incdec.ptr5.i385 = getelementptr inbounds i8, ptr %s.03.i378, i64 1
  store i8 %136, ptr %s.03.i378, align 1, !tbaa !25
  %cmp.i386 = icmp ult ptr %incdec.ptr5.i385, %incdec.ptr.i380
  br i1 %cmp.i386, label %while.body.i387, label %if.end260, !llvm.loop !40

if.end260:                                        ; preds = %while.body.i387, %if.then259, %for.end254
...
entry:
  ...
  %cond261 = icmp eq i32 %0, 0
  br i1 %cond261, label %cleanup, label %land.rhs.lr.ph

land.rhs.lr.ph:                                   ; preds = %entry
  %1 = load ptr, ptr %rb, align 8, !tbaa !65
  %fd = getelementptr inbounds %struct._seq_t, ptr %sp, i64 0, i32 4
  %2 = load i8, ptr %1, align 1, !tbaa !25
  %cmp2.not293 = icmp eq i8 %2, 62
  br i1 %cmp2.not293, label %if.end, label %while.body
...
while.body:                                       ; preds = %land.rhs.lr.ph, %land.rhs
  ...
  br i1 %cond, label %cleanup, label %land.rhs, !llvm.loop !66

if.end:                                           ; preds = %land.rhs, %land.rhs.lr.ph
  %.lcssa291 = phi i32 [ %0, %land.rhs.lr.ph ], [ %5, %land.rhs ]
  %buf.0262.lcssa = phi ptr [ %1, %land.rhs.lr.ph ], [ %call, %land.rhs ]
  %add11 = add i32 %.lcssa291, 25
  %maxHead = getelementptr inbounds %struct._seq_t, ptr %sp, i64 0, i32 6
...
if.end.if.end24_crit_edge:                        ; preds = %if.end
  ...
  %.pre281 = load ptr, ptr %header27.phi.trans.insert, align 8, !tbaa !33
  br label %if.end24
...
if.end24:                                         ; preds = %if.end.if.end24_crit_edge, %if.then14
  %8 = phi ptr [ %call22, %if.then14 ], [ %.pre281, %if.end.if.end24_crit_edge ]
  %9 = phi i32 [ %.pre, %if.then14 ], [ %.lcssa291, %if.end.if.end24_crit_edge ]
  %header27 = getelementptr inbounds %struct._seq_t, ptr %sp, i64 0, i32 1
  %add30 = add i32 %9, 1
  %conv31 = zext i32 %add30 to i64
  tail call void @llvm.memcpy.p0.p0.i64(ptr align 1 %8, ptr nonnull align 1 %buf.0262.lcssa, i64 %conv31, i1 false)
  %len = getelementptr inbounds %struct._seq_t, ptr %sp, i64 0, i32 5
  store i32 0, ptr %len, align 4, !tbaa !37
  ...
  %cmp39.not266 = icmp eq i32 %11, 0
  br i1 %cmp39.not266, label %if.end125, label %land.rhs41.lr.ph
...
land.rhs41:                                       ; preds = %land.rhs41.lr.ph, %while.end113
  ...
  %buf.1267 = phi ptr [ %call35, %land.rhs41.lr.ph ], [ %call116, %while.end113 ]
  %13 = load i8, ptr %buf.1267, align 1, !tbaa !25
  %cmp44.not = icmp eq i8 %13, 62
  br i1 %cmp44.not, label %while.end117, label %while.body47
...
if.then55:                                        ; preds = %while.body47
  ...
  %.pre282 = load i8, ptr %buf.1267, align 1, !tbaa !25
  br label %if.end78

if.end78:                                         ; preds = %if.then55, %while.body47
  %17 = phi i8 [ %.pre282, %if.then55 ], [ %13, %while.body47 ]
  %cmp81.not264 = icmp eq i8 %17, 0
  br i1 %cmp81.not264, label %while.end113, label %while.body83.lr.ph
...
while.body83:                                     ; preds = %while.body83.lr.ph, %if.end112
  ...
  %buf.1267.pn = phi ptr [ %buf.1267, %while.body83.lr.ph ], [ %incdec.ptr265, %if.end112 ]
  %incdec.ptr265 = getelementptr inbounds i8, ptr %buf.1267.pn, i64 1
...
if.end112:                                        ; preds = %if.end112.sink.split, %if.else
  %25 = load i8, ptr %incdec.ptr265, align 1, !tbaa !25
...
while.end117:                                     ; preds = %land.rhs41
  %tobool118.not = icmp eq i32 %warnMultiSeq, 0
  br i1 %tobool118.not, label %if.end125, label %if.then123

if.then123:                                       ; preds = %while.end117
  %28 = load ptr, ptr @stderr, align 8, !tbaa !5
  %29 = tail call i64 @fwrite(ptr nonnull @.str.34, i64 238, i64 1, ptr %28) #19
  br label %if.end125

if.end125:                                        ; preds = %while.end113, %if.end24, %while.end117, %if.then123
...
if.end125.if.end152_crit_edge:                    ; preds = %if.end125
  %.pre284 = tail call ptr @__ctype_b_loc() #22
  br label %if.end152
...
if.then133:                                       ; preds = %if.end125
  ...
  %idxprom137269 = sext i8 %34 to i64
  %arrayidx138270 = getelementptr inbounds i16, ptr %33, i64 %idxprom137269
  %35 = load i16, ptr %arrayidx138270, align 2, !tbaa !67
  %36 = and i16 %35, 2048
  %tobool141.not271 = icmp eq i16 %36, 0
  br i1 %tobool141.not271, label %while.cond146.preheader, label %while.body142
...
while.cond146.preheader:                          ; preds = %while.body142, %if.then133
  ...
  %tobool147.not275 = icmp eq i8 %37, 0
  br i1 %tobool147.not275, label %if.end152, label %while.body148

while.body142:                                    ; preds = %if.then133, %while.body142
  %s.0273 = phi ptr [ %add.ptr143, %while.body142 ], [ %add.ptr, %if.then133 ]
  %headerLen.0272 = phi i32 [ %sub144, %while.body142 ], [ %sub, %if.then133 ]
  %add.ptr143 = getelementptr inbounds i8, ptr %s.0273, i64 1
  %sub144 = add i32 %headerLen.0272, -1
...
while.body148:                                    ; preds = %while.cond146.preheader, %while.body148
  ...
  %s.1277 = phi ptr [ %incdec.ptr149, %while.body148 ], [ %s.0.lcssa, %while.cond146.preheader ]
  %buf.3276 = phi ptr [ %incdec.ptr150, %while.body148 ], [ %call131, %while.cond146.preheader ]
  %incdec.ptr149 = getelementptr inbounds i8, ptr %s.1277, i64 1
  %incdec.ptr150 = getelementptr inbounds i8, ptr %buf.3276, i64 1
  store i8 %41, ptr %buf.3276, align 1, !tbaa !25
...
if.end152.loopexit:                               ; preds = %while.body148
  %.pre283 = load ptr, ptr %header27, align 8, !tbaa !33
  br label %if.end152

if.end152:                                        ; preds = %if.end125.if.end152_crit_edge, %if.end152.loopexit, %while.cond146.preheader
  %call157.pre-phi = phi ptr [ %.pre284, %if.end125.if.end152_crit_edge ], [ %call135, %if.end152.loopexit ], [ %call135, %while.cond146.preheader ]
  %43 = phi ptr [ %32, %if.end125.if.end152_crit_edge ], [ %.pre283, %if.end152.loopexit ], [ %32, %while.cond146.preheader ]
...
for.end.i:                                        ; preds = %for.body.9.i, %for.body.8.i, %for.body.7.i, %for.body.6.i, %for.body.5.i, %for.body.4.i, %for.body.3.i, %for.body.2.i, %for.body.1.i, %for.body.i, %if.then.i
  ...
  %add12334.i = add i32 %pos.0.lcssa.i, %16
  %cmp14335.i = icmp ult i32 %add12334.i, %17
  br i1 %cmp14335.i, label %land.rhs16.lr.ph.i, label %while.end.i
...
land.rhs16.i:                                     ; preds = %while.body.i, %land.rhs16.lr.ph.i
  %add12338.i = phi i32 [ %add12334.i, %land.rhs16.lr.ph.i ], [ %add12.i, %while.body.i ]
  %cnt.2337.i = phi i32 [ %cnt.0.lcssa.i, %land.rhs16.lr.ph.i ], [ %add27.i, %while.body.i ]
  %pos.1336.i = phi i32 [ %pos.0.lcssa.i, %land.rhs16.lr.ph.i ], [ %add26.i, %while.body.i ]
  %idxprom20.i = zext i32 %add12338.i to i64
...
while.body.i:                                     ; preds = %land.rhs16.i
  %add26.i = add i32 %pos.1336.i, 1
  %add27.i = add i32 %cnt.2337.i, 1
...
while.end.i:                                      ; preds = %while.body.i, %land.rhs16.i, %for.end.i
  %pos.1.lcssa.i = phi i32 [ %pos.0.lcssa.i, %for.end.i ], [ %pos.1336.i, %land.rhs16.i ], [ %41, %while.body.i ]
  %cnt.2.lcssa.i = phi i32 [ %cnt.0.lcssa.i, %for.end.i ], [ %cnt.2337.i, %land.rhs16.i ], [ %add27.i, %while.body.i ]
...
while.end.for.end49_crit_edge.i:                  ; preds = %while.end.i
  ...
  %.pre389.i = load ptr, ptr %seq57.phi.trans.insert.i, align 8, !tbaa !36
...
for.body36.lr.ph.i:                               ; preds = %while.end.i
  ...
  %wide.trip.count372.i = zext i32 %invariant.umin.i to i64
...
vector.scevcheck:                                 ; preds = %for.body36.lr.ph.i
  %46 = add nsw i64 %wide.trip.count372.i, -1
...
vector.ph:                                        ; preds = %vector.scevcheck
  %n.vec = and i64 %wide.trip.count372.i, 4294967288
...
middle.block:                                     ; preds = %vector.body
  ...
  %cmp.n = icmp eq i64 %n.vec, %wide.trip.count372.i
...
for.body36.i.preheader:                           ; preds = %vector.scevcheck, %for.body36.lr.ph.i, %middle.block
  ...
  %cntDna.0345.i.ph = phi i32 [ 0, %vector.scevcheck ], [ 0, %for.body36.lr.ph.i ], [ %64, %middle.block ]
  %65 = xor i64 %indvars.iv.i.ph, -1
  %66 = add nsw i64 %65, %wide.trip.count372.i
  %xtraiter = and i64 %wide.trip.count372.i, 3
  %lcmp.mod.not = icmp eq i64 %xtraiter, 0
...
for.body36.i.prol:                                ; preds = %for.body36.i.preheader, %for.body36.i.prol
  ...
  %cntDna.0345.i.prol = phi i32 [ %spec.select322.i.prol, %for.body36.i.prol ], [ %cntDna.0345.i.ph, %for.body36.i.preheader ]
  ...
  %spec.select322.i.prol = add i32 %cntDna.0345.i.prol, %add45.i.prol
...
for.body36.i.prol.loopexit:                       ; preds = %for.body36.i.prol, %for.body36.i.preheader
  ...
  %cntDna.0345.i.unr = phi i32 [ %cntDna.0345.i.ph, %for.body36.i.preheader ], [ %spec.select322.i.prol, %for.body36.i.prol ]
...
for.body36.i:                                     ; preds = %for.body36.i.prol.loopexit, %for.body36.i
  ...
  %cntDna.0345.i = phi i32 [ %spec.select322.i.3, %for.body36.i ], [ %cntDna.0345.i.unr, %for.body36.i.prol.loopexit ]
  ...
  %spec.select322.i = add i32 %cntDna.0345.i, %add45.i
  ...
  %exitcond373.not.i.3 = icmp eq i64 %indvars.iv.next.i.3, %wide.trip.count372.i
  br i1 %exitcond373.not.i.3, label %for.end49.i, label %for.body36.i, !llvm.loop !84

for.end49.i:                                      ; preds = %for.body36.i.prol.loopexit, %for.body36.i, %middle.block, %while.end.for.end49_crit_edge.i
  %81 = phi ptr [ %.pre389.i, %while.end.for.end49_crit_edge.i ], [ %44, %middle.block ], [ %44, %for.body36.i ], [ %44, %for.body36.i.prol.loopexit ]
  ...
  %narrow.i = tail call i32 @llvm.umin.i32(i32 %85, i32 50)
  %spec.select323.i = zext i32 %narrow.i to i64
  %idx.neg.i = sub nsw i64 0, %spec.select323.i
  %86 = load ptr, ptr %seq57.i, align 8, !tbaa !36
  %idx.ext72.i = zext i32 %85 to i64
  %add.ptr73.i = getelementptr inbounds i8, ptr %86, i64 %idx.ext72.i
...
if.then90.i:                                      ; preds = %if.end87.i, %for.end49.i
  ...
  %87 = load i32, ptr %to150.i, align 4, !tbaa !79
  %88 = add i64 %spec.select323.i, %sub.ptr.rhs.cast.i
  %89 = sub i64 %sub.ptr.lhs.cast.i, %88
  %90 = load i32, ptr getelementptr inbounds (%struct._options_t, ptr @options, i64 0, i32 15), align 4, !tbaa !29
  %91 = trunc i64 %89 to i32
  %92 = add i32 %87, 1
  %93 = add i32 %92, %90
  %conv100.i = add i32 %93, %91
...
if.end103.i:                                      ; preds = %if.end102.i, %sw.bb11
  ...
  %94 = load i32, ptr %polyT_cut.i, align 4, !tbaa !85
  %tobool104.not.i = icmp eq i32 %94, 0
...
if.then105.i:                                     ; preds = %if.end103.i
  ...
  %95 = load ptr, ptr %eCol12, align 8, !tbaa !25
  %96 = load ptr, ptr %95, align 8, !tbaa !5
  %from2.i = getelementptr inbounds %struct._exon_t, ptr %96, i64 0, i32 1
  %97 = load i32, ptr %from2.i, align 4, !tbaa !86
  ...
  %98 = add nuw nsw i32 %umin.i, 1
  %exitcond378.not.i = icmp eq i32 %sub119.i, 0
  br i1 %exitcond378.not.i, label %for.end138.i, label %for.body123.i

for.body123.i:                                    ; preds = %if.then105.i
  %99 = load ptr, ptr %seq124.i, align 8, !tbaa !36
  %sub127.i = add i32 %97, -2
  %idxprom128.i = zext i32 %sub127.i to i64
  %arrayidx129.i = getelementptr inbounds i8, ptr %99, i64 %idxprom128.i
  %100 = load i8, ptr %arrayidx129.i, align 1, !tbaa !25
  %cmp131.i = icmp eq i8 %100, 84
  %add134.i = zext i1 %cmp131.i to i32
  %exitcond378.1.not.i = icmp eq i32 %sub119.i, 1
  br i1 %exitcond378.1.not.i, label %for.end138.i, label %for.body123.1.i

for.body123.1.i:                                  ; preds = %for.body123.i
  %sub127.1.i = add i32 %97, -3
  %idxprom128.1.i = zext i32 %sub127.1.i to i64
  %arrayidx129.1.i = getelementptr inbounds i8, ptr %99, i64 %idxprom128.1.i
  %101 = load i8, ptr %arrayidx129.1.i, align 1, !tbaa !25
  %cmp131.1.i = icmp eq i8 %101, 84
  %add134.1.i = zext i1 %cmp131.1.i to i32
  %spec.select324.1.i = add nuw nsw i32 %add134.1.i, %add134.i
  %exitcond378.2.not.i = icmp eq i32 %sub119.i, 2
  br i1 %exitcond378.2.not.i, label %for.end138.i, label %for.body123.2.i

for.body123.2.i:                                  ; preds = %for.body123.1.i
  %sub127.2.i = add i32 %97, -4
  %idxprom128.2.i = zext i32 %sub127.2.i to i64
  %arrayidx129.2.i = getelementptr inbounds i8, ptr %99, i64 %idxprom128.2.i
  %102 = load i8, ptr %arrayidx129.2.i, align 1, !tbaa !25
  %cmp131.2.i = icmp eq i8 %102, 84
  %add134.2.i = zext i1 %cmp131.2.i to i32
  %spec.select324.2.i = add nuw nsw i32 %spec.select324.1.i, %add134.2.i
  %exitcond378.3.not.i = icmp eq i32 %sub119.i, 3
  br i1 %exitcond378.3.not.i, label %for.end138.i, label %for.body123.3.i

for.body123.3.i:                                  ; preds = %for.body123.2.i
  %sub127.3.i = add i32 %97, -5
  %idxprom128.3.i = zext i32 %sub127.3.i to i64
  %arrayidx129.3.i = getelementptr inbounds i8, ptr %99, i64 %idxprom128.3.i
  %103 = load i8, ptr %arrayidx129.3.i, align 1, !tbaa !25
  %cmp131.3.i = icmp eq i8 %103, 84
  %add134.3.i = zext i1 %cmp131.3.i to i32
  %spec.select324.3.i = add nuw nsw i32 %spec.select324.2.i, %add134.3.i
  %exitcond378.4.not.i = icmp eq i32 %sub119.i, 4
  br i1 %exitcond378.4.not.i, label %for.end138.i, label %for.body123.4.i

for.body123.4.i:                                  ; preds = %for.body123.3.i
  %sub127.4.i = add i32 %97, -6
  %idxprom128.4.i = zext i32 %sub127.4.i to i64
  %arrayidx129.4.i = getelementptr inbounds i8, ptr %99, i64 %idxprom128.4.i
  %104 = load i8, ptr %arrayidx129.4.i, align 1, !tbaa !25
  %cmp131.4.i = icmp eq i8 %104, 84
  %add134.4.i = zext i1 %cmp131.4.i to i32
  %spec.select324.4.i = add nuw nsw i32 %spec.select324.3.i, %add134.4.i
  %exitcond378.5.not.i = icmp eq i32 %sub119.i, 5
  br i1 %exitcond378.5.not.i, label %for.end138.i, label %for.body123.5.i

for.body123.5.i:                                  ; preds = %for.body123.4.i
  %sub127.5.i = add i32 %97, -7
  %idxprom128.5.i = zext i32 %sub127.5.i to i64
  %arrayidx129.5.i = getelementptr inbounds i8, ptr %99, i64 %idxprom128.5.i
  %105 = load i8, ptr %arrayidx129.5.i, align 1, !tbaa !25
  %cmp131.5.i = icmp eq i8 %105, 84
  %add134.5.i = zext i1 %cmp131.5.i to i32
  %spec.select324.5.i = add nuw nsw i32 %spec.select324.4.i, %add134.5.i
  %exitcond378.6.not.i = icmp eq i32 %sub119.i, 6
  br i1 %exitcond378.6.not.i, label %for.end138.i, label %for.body123.6.i

for.body123.6.i:                                  ; preds = %for.body123.5.i
  %sub127.6.i = add i32 %97, -8
  %idxprom128.6.i = zext i32 %sub127.6.i to i64
  %arrayidx129.6.i = getelementptr inbounds i8, ptr %99, i64 %idxprom128.6.i
  %106 = load i8, ptr %arrayidx129.6.i, align 1, !tbaa !25
  %cmp131.6.i = icmp eq i8 %106, 84
  %add134.6.i = zext i1 %cmp131.6.i to i32
  %spec.select324.6.i = add nuw nsw i32 %spec.select324.5.i, %add134.6.i
  %exitcond378.7.not.i = icmp eq i32 %sub119.i, 7
  br i1 %exitcond378.7.not.i, label %for.end138.i, label %for.body123.7.i

for.body123.7.i:                                  ; preds = %for.body123.6.i
  %sub127.7.i = add i32 %97, -9
  %idxprom128.7.i = zext i32 %sub127.7.i to i64
  %arrayidx129.7.i = getelementptr inbounds i8, ptr %99, i64 %idxprom128.7.i
  %107 = load i8, ptr %arrayidx129.7.i, align 1, !tbaa !25
  %cmp131.7.i = icmp eq i8 %107, 84
  %add134.7.i = zext i1 %cmp131.7.i to i32
  %spec.select324.7.i = add nuw nsw i32 %spec.select324.6.i, %add134.7.i
  %exitcond378.8.not.i = icmp eq i32 %sub119.i, 8
  br i1 %exitcond378.8.not.i, label %for.end138.i, label %for.body123.8.i

for.body123.8.i:                                  ; preds = %for.body123.7.i
  %sub127.8.i = add i32 %97, -10
  %idxprom128.8.i = zext i32 %sub127.8.i to i64
  %arrayidx129.8.i = getelementptr inbounds i8, ptr %99, i64 %idxprom128.8.i
  %108 = load i8, ptr %arrayidx129.8.i, align 1, !tbaa !25
  %cmp131.8.i = icmp eq i8 %108, 84
  %add134.8.i = zext i1 %cmp131.8.i to i32
  %spec.select324.8.i = add nuw nsw i32 %spec.select324.7.i, %add134.8.i
  %exitcond378.9.not.i = icmp eq i32 %sub119.i, 9
  br i1 %exitcond378.9.not.i, label %for.end138.i, label %for.body123.9.i

for.body123.9.i:                                  ; preds = %for.body123.8.i
  %sub127.9.i = add i32 %97, -11
  %idxprom128.9.i = zext i32 %sub127.9.i to i64
  %arrayidx129.9.i = getelementptr inbounds i8, ptr %99, i64 %idxprom128.9.i
  %109 = load i8, ptr %arrayidx129.9.i, align 1, !tbaa !25
  %cmp131.9.i = icmp eq i8 %109, 84
...
for.end138.i:                                     ; preds = %for.body123.9.i, %for.body123.8.i, %for.body123.7.i, %for.body123.6.i, %for.body123.5.i, %for.body123.4.i, %for.body123.3.i, %for.body123.2.i, %for.body123.1.i, %for.body123.i, %if.then105.i
  ...
  %pos108.0.lcssa.i = phi i32 [ %umin.i, %if.then105.i ], [ %umin.i, %for.body123.i ], [ %umin.i, %for.body123.1.i ], [ %umin.i, %for.body123.2.i ], [ %umin.i, %for.body123.3.i ], [ %umin.i, %for.body123.4.i ], [ %umin.i, %for.body123.5.i ], [ %umin.i, %for.body123.6.i ], [ %umin.i, %for.body123.7.i ], [ %umin.i, %for.body123.8.i ], [ %98, %for.body123.9.i ]
  %cmp142350.i = icmp ugt i32 %sub119.i, %pos108.0.lcssa.i
  br i1 %cmp142350.i, label %land.rhs144.lr.ph.i, label %while.end158.i

land.rhs144.lr.ph.i:                              ; preds = %for.end138.i
  %110 = load ptr, ptr %seq124.i, align 8, !tbaa !36
  %111 = zext i32 %pos108.0.lcssa.i to i64
  %112 = add i32 %cnt106.0.lcssa.i, %97
  %113 = xor i32 %pos108.0.lcssa.i, -1
  %114 = add i32 %112, %113
  %reass.sub366.i = add i32 %97, -2
  br label %land.rhs144.i

land.rhs144.i:                                    ; preds = %while.body155.i, %land.rhs144.lr.ph.i
  %indvars.iv380.i = phi i64 [ %111, %land.rhs144.lr.ph.i ], [ %indvars.iv.next381.i, %while.body155.i ]
  %cnt106.2351.i = phi i32 [ %cnt106.0.lcssa.i, %land.rhs144.lr.ph.i ], [ %add157.i, %while.body155.i ]
  %115 = trunc i64 %indvars.iv380.i to i32
  %sub148.i = sub i32 %reass.sub366.i, %115
  %idxprom149.i = zext i32 %sub148.i to i64
  %arrayidx150.i = getelementptr inbounds i8, ptr %110, i64 %idxprom149.i
  %116 = load i8, ptr %arrayidx150.i, align 1, !tbaa !25
  %cmp152.i = icmp eq i8 %116, 84
...
while.body155.i:                                  ; preds = %land.rhs144.i
  ...
  %add157.i = add i32 %cnt106.2351.i, 1
  %lftr.wideiv.i = trunc i64 %indvars.iv.next381.i to i32
  %exitcond383.not.i = icmp eq i32 %sub119.i, %lftr.wideiv.i
  br i1 %exitcond383.not.i, label %while.end158.i, label %land.rhs144.i, !llvm.loop !87

while.end158.i:                                   ; preds = %while.body155.i, %land.rhs144.i, %for.end138.i
  %cnt106.2.lcssa.i = phi i32 [ %cnt106.0.lcssa.i, %for.end138.i ], [ %cnt106.2351.i, %land.rhs144.i ], [ %114, %while.body155.i ]
  %pos108.1.lcssa.i = phi i32 [ %pos108.0.lcssa.i, %for.end138.i ], [ %115, %land.rhs144.i ], [ %sub119.i, %while.body155.i ]
  %117 = load i32, ptr %96, align 4, !tbaa !88
  %sub160.i = add i32 %117, -1
  %invariant.umin359.i = call i32 @llvm.umin.i32(i32 %pos108.1.lcssa.i, i32 %sub160.i)
  %.not365.i = icmp eq i32 %invariant.umin359.i, 0
  %seq194.phi.trans.insert.i = getelementptr inbounds %struct._seq_t, ptr %seq1, i64 0, i32 2
  %.pre390.i = load ptr, ptr %seq194.phi.trans.insert.i, align 8, !tbaa !36
  br i1 %.not365.i, label %for.end182.i, label %for.body167.lr.ph.i

for.body167.lr.ph.i:                              ; preds = %while.end158.i
  %wide.trip.count387.i = zext i32 %invariant.umin359.i to i64
  %reass.sub.i = add i32 %117, -2
  %min.iters.check66 = icmp ult i32 %invariant.umin359.i, 12
...
vector.scevcheck63:                               ; preds = %for.body167.lr.ph.i
  %118 = add nsw i64 %wide.trip.count387.i, -1
  %119 = trunc i64 %118 to i32
  %120 = icmp ult i32 %reass.sub.i, %119
  %121 = icmp ugt i64 %118, 4294967295
  %122 = or i1 %120, %121
  br i1 %122, label %for.body167.i.preheader, label %vector.ph67

vector.ph67:                                      ; preds = %vector.scevcheck63
  %n.vec69 = and i64 %wide.trip.count387.i, 4294967288
...
vector.body72:                                    ; preds = %vector.body72, %vector.ph67
  ...
  %vec.phi73 = phi <4 x i32> [ zeroinitializer, %vector.ph67 ], [ %133, %vector.body72 ]
  %vec.phi74 = phi <4 x i32> [ zeroinitializer, %vector.ph67 ], [ %134, %vector.body72 ]
  %123 = trunc i64 %offset.idx75 to i32
  %124 = sub i32 %reass.sub.i, %123
  %125 = zext i32 %124 to i64
  %126 = getelementptr inbounds i8, ptr %.pre390.i, i64 %125
  %127 = getelementptr inbounds i8, ptr %126, i64 -3
  %wide.load76 = load <4 x i8>, ptr %127, align 1, !tbaa !25
  %reverse = shufflevector <4 x i8> %wide.load76, <4 x i8> poison, <4 x i32> <i32 3, i32 2, i32 1, i32 0>
  %128 = getelementptr inbounds i8, ptr %126, i64 -7
  %wide.load77 = load <4 x i8>, ptr %128, align 1, !tbaa !25
  %reverse78 = shufflevector <4 x i8> %wide.load77, <4 x i8> poison, <4 x i32> <i32 3, i32 2, i32 1, i32 0>
  %129 = icmp eq <4 x i8> %reverse, <i8 84, i8 84, i8 84, i8 84>
  %130 = icmp eq <4 x i8> %reverse78, <i8 84, i8 84, i8 84, i8 84>
  %131 = zext <4 x i1> %129 to <4 x i32>
  %132 = zext <4 x i1> %130 to <4 x i32>
  %133 = add <4 x i32> %vec.phi73, %131
  %134 = add <4 x i32> %vec.phi74, %132
  %index.next79 = add nuw i64 %offset.idx75, 8
  %135 = icmp eq i64 %index.next79, %n.vec69
  br i1 %135, label %middle.block64, label %vector.body72, !llvm.loop !89

middle.block64:                                   ; preds = %vector.body72
  %bin.rdx80 = add <4 x i32> %134, %133
  %136 = call i32 @llvm.vector.reduce.add.v4i32(<4 x i32> %bin.rdx80)
  %cmp.n71 = icmp eq i64 %n.vec69, %wide.trip.count387.i
...
for.body167.i.preheader:                          ; preds = %vector.scevcheck63, %for.body167.lr.ph.i, %middle.block64
  %indvars.iv384.i.ph = phi i64 [ 0, %vector.scevcheck63 ], [ 0, %for.body167.lr.ph.i ], [ %n.vec69, %middle.block64 ]
  %cntDna107.0360.i.ph = phi i32 [ 0, %vector.scevcheck63 ], [ 0, %for.body167.lr.ph.i ], [ %136, %middle.block64 ]
  %137 = xor i64 %indvars.iv384.i.ph, -1
  %138 = add nsw i64 %137, %wide.trip.count387.i
  %xtraiter85 = and i64 %wide.trip.count387.i, 3
...
for.body167.i.prol:                               ; preds = %for.body167.i.preheader, %for.body167.i.prol
  %indvars.iv384.i.prol = phi i64 [ %indvars.iv.next385.i.prol, %for.body167.i.prol ], [ %indvars.iv384.i.ph, %for.body167.i.preheader ]
  %cntDna107.0360.i.prol = phi i32 [ %spec.select325.i.prol, %for.body167.i.prol ], [ %cntDna107.0360.i.ph, %for.body167.i.preheader ]
  %prol.iter87 = phi i64 [ %prol.iter87.next, %for.body167.i.prol ], [ 0, %for.body167.i.preheader ]
  %139 = trunc i64 %indvars.iv384.i.prol to i32
  %sub171.i.prol = sub i32 %reass.sub.i, %139
  %idxprom172.i.prol = zext i32 %sub171.i.prol to i64
  %arrayidx173.i.prol = getelementptr inbounds i8, ptr %.pre390.i, i64 %idxprom172.i.prol
  %140 = load i8, ptr %arrayidx173.i.prol, align 1, !tbaa !25
  %cmp175.i.prol = icmp eq i8 %140, 84
  %add178.i.prol = zext i1 %cmp175.i.prol to i32
  %spec.select325.i.prol = add i32 %cntDna107.0360.i.prol, %add178.i.prol
  %indvars.iv.next385.i.prol = add nuw nsw i64 %indvars.iv384.i.prol, 1
...
for.body167.i.prol.loopexit:                      ; preds = %for.body167.i.prol, %for.body167.i.preheader
  ...
  %indvars.iv384.i.unr = phi i64 [ %indvars.iv384.i.ph, %for.body167.i.preheader ], [ %indvars.iv.next385.i.prol, %for.body167.i.prol ]
  %cntDna107.0360.i.unr = phi i32 [ %cntDna107.0360.i.ph, %for.body167.i.preheader ], [ %spec.select325.i.prol, %for.body167.i.prol ]
  %141 = icmp ult i64 %138, 3
  br i1 %141, label %for.end182.i, label %for.body167.i

for.body167.i:                                    ; preds = %for.body167.i.prol.loopexit, %for.body167.i
  %indvars.iv384.i = phi i64 [ %indvars.iv.next385.i.3, %for.body167.i ], [ %indvars.iv384.i.unr, %for.body167.i.prol.loopexit ]
  %cntDna107.0360.i = phi i32 [ %spec.select325.i.3, %for.body167.i ], [ %cntDna107.0360.i.unr, %for.body167.i.prol.loopexit ]
  %142 = trunc i64 %indvars.iv384.i to i32
  %sub171.i = sub i32 %reass.sub.i, %142
  %idxprom172.i = zext i32 %sub171.i to i64
  %arrayidx173.i = getelementptr inbounds i8, ptr %.pre390.i, i64 %idxprom172.i
  %143 = load i8, ptr %arrayidx173.i, align 1, !tbaa !25
  %cmp175.i = icmp eq i8 %143, 84
  %add178.i = zext i1 %cmp175.i to i32
  %spec.select325.i = add i32 %cntDna107.0360.i, %add178.i
  %144 = trunc i64 %indvars.iv384.i to i32
  %.neg = xor i32 %144, -1
  %sub171.i.1 = add i32 %reass.sub.i, %.neg
  %idxprom172.i.1 = zext i32 %sub171.i.1 to i64
  %arrayidx173.i.1 = getelementptr inbounds i8, ptr %.pre390.i, i64 %idxprom172.i.1
  %145 = load i8, ptr %arrayidx173.i.1, align 1, !tbaa !25
  %cmp175.i.1 = icmp eq i8 %145, 84
  %add178.i.1 = zext i1 %cmp175.i.1 to i32
  %spec.select325.i.1 = add i32 %spec.select325.i, %add178.i.1
  %146 = trunc i64 %indvars.iv384.i to i32
  %147 = add i32 %146, 2
  %sub171.i.2 = sub i32 %reass.sub.i, %147
  %idxprom172.i.2 = zext i32 %sub171.i.2 to i64
  %arrayidx173.i.2 = getelementptr inbounds i8, ptr %.pre390.i, i64 %idxprom172.i.2
  %148 = load i8, ptr %arrayidx173.i.2, align 1, !tbaa !25
  %cmp175.i.2 = icmp eq i8 %148, 84
  %add178.i.2 = zext i1 %cmp175.i.2 to i32
  %spec.select325.i.2 = add i32 %spec.select325.i.1, %add178.i.2
  %149 = trunc i64 %indvars.iv384.i to i32
  %150 = add i32 %149, 3
  %sub171.i.3 = sub i32 %reass.sub.i, %150
  %idxprom172.i.3 = zext i32 %sub171.i.3 to i64
  %arrayidx173.i.3 = getelementptr inbounds i8, ptr %.pre390.i, i64 %idxprom172.i.3
  %151 = load i8, ptr %arrayidx173.i.3, align 1, !tbaa !25
  %cmp175.i.3 = icmp eq i8 %151, 84
  %add178.i.3 = zext i1 %cmp175.i.3 to i32
  %spec.select325.i.3 = add i32 %spec.select325.i.2, %add178.i.3
  %indvars.iv.next385.i.3 = add nuw nsw i64 %indvars.iv384.i, 4
  %exitcond388.not.i.3 = icmp eq i64 %indvars.iv.next385.i.3, %wide.trip.count387.i
  br i1 %exitcond388.not.i.3, label %for.end182.i, label %for.body167.i, !llvm.loop !91

for.end182.i:                                     ; preds = %for.body167.i.prol.loopexit, %for.body167.i, %middle.block64, %while.end158.i
  %cntDna107.0.lcssa.i = phi i32 [ 0, %while.end158.i ], [ %136, %middle.block64 ], [ %spec.select325.i.lcssa.unr, %for.body167.i.prol.loopexit ], [ %spec.select325.i.3, %for.body167.i ]
  %152 = load i32, ptr getelementptr inbounds (%struct._options_t, ptr @options, i64 0, i32 15), align 4, !tbaa !29
  %add185.i = add i32 %152, %sub160.i
  %153 = load ptr, ptr %seq124.i, align 8, !tbaa !36
  %sub189.i = sub i32 %sub119.i, %pos108.1.lcssa.i
  %idx.ext190.i = zext i32 %sub189.i to i64
  %add.ptr191.i = getelementptr inbounds i8, ptr %153, i64 %idx.ext190.i
  %sub197.i = sub i32 %sub160.i, %invariant.umin359.i
  %idx.ext198.i = zext i32 %sub197.i to i64
  %add.ptr199.i = getelementptr inbounds i8, ptr %.pre390.i, i64 %idx.ext198.i
  %call203.i = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.28, i32 noundef %pos108.1.lcssa.i, i32 noundef %cnt106.2.lcssa.i, i32 noundef %cntDna107.0.lcssa.i, i32 noundef %add185.i, i32 noundef %pos108.1.lcssa.i, ptr noundef %add.ptr191.i, i32 noundef %sub119.i, i32 noundef %pos108.1.lcssa.i, i32 noundef %invariant.umin359.i, ptr noundef %add.ptr199.i, i32 noundef %add185.i)
  %154 = load ptr, ptr %seq194.phi.trans.insert.i, align 8, !tbaa !36
  %155 = load i32, ptr %96, align 4, !tbaa !88
  %idx.ext207.i = zext i32 %155 to i64
  %add.ptr208.i = getelementptr inbounds i8, ptr %154, i64 %idx.ext207.i
...
if.then222.i:                                     ; preds = %if.end219.i, %for.end182.i
  ...
  %156 = load i32, ptr %96, align 4, !tbaa !88
  %157 = load i32, ptr getelementptr inbounds (%struct._options_t, ptr @options, i64 0, i32 15), align 4, !tbaa !29
  %158 = trunc i64 %sub.ptr.sub226.i to i32
  %159 = add i32 %156, 5
  %160 = add i32 %159, %157
  %conv233.i = add i32 %160, %158
...
print_polyA_info.exit:                            ; preds = %if.end103.i, %if.end235.i
  ...
  %161 = load ptr, ptr %seq16, align 8, !tbaa !36
  %seq17 = getelementptr inbounds %struct._seq_t, ptr %seq2, i64 0, i32 2
  %162 = load ptr, ptr %seq17, align 8, !tbaa !36
  call fastcc void @print_align_lat(ptr noundef %161, ptr noundef %162, ptr noundef %res)
  br label %sw.epilog
...
if.end19:                                         ; preds = %sw.epilog, %entry
  ...
  %163 = load i32, ptr %nb, align 8, !tbaa !92
  %cmp2158.not = icmp eq i32 %163, 0
...
for.body:                                         ; preds = %if.end19, %for.body
  ...
  %164 = load ptr, ptr %eCol20, align 8, !tbaa !25
  %arrayidx = getelementptr inbounds ptr, ptr %164, i64 %indvars.iv
  %165 = load ptr, ptr %arrayidx, align 8, !tbaa !5
  call void @free(ptr noundef %165) #18
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %166 = load i32, ptr %nb, align 8, !tbaa !92
  %167 = zext i32 %166 to i64
  %cmp21 = icmp ult i64 %indvars.iv.next, %167
  br i1 %cmp21, label %for.body, label %for.end, !llvm.loop !93

for.end:                                          ; preds = %for.body, %if.end19
  %168 = load ptr, ptr %eCol20, align 8, !tbaa !25
  call void @free(ptr noundef %168) #18
  %169 = load ptr, ptr %res, align 8, !tbaa !94
  %tobool25.not = icmp eq ptr %169, null
  br i1 %tobool25.not, label %if.end28, label %if.then26

if.then26:                                        ; preds = %for.end
  call void @free_align(ptr noundef nonnull %169) #18
  br label %if.end28
