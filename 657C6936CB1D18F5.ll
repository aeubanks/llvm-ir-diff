...
while.end.i:                                      ; preds = %while.body.i, %land.rhs16.i, %for.end.i
  ...
  %pos.1.lcssa.fr.i = freeze i32 %pos.1.lcssa.i
  %len29.i = getelementptr inbounds %struct._seq_t, ptr %seq1, i64 0, i32 5
  %43 = load i32, ptr %len29.i, align 4, !tbaa !37
  %invariant.umin.i = tail call i32 @llvm.umin.i32(i32 %43, i32 %pos.1.lcssa.fr.i)
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %vec.phi71 = phi <4 x i32> [ zeroinitializer, %vector.ph ], [ %62, %vector.body ]
  ...
  %wide.load72 = load <4 x i8>, ptr %56, align 1, !tbaa !25
  %57 = icmp eq <4 x i8> %wide.load, <i8 65, i8 65, i8 65, i8 65>
  %58 = icmp eq <4 x i8> %wide.load72, <i8 65, i8 65, i8 65, i8 65>
  %59 = zext <4 x i1> %57 to <4 x i32>
  %60 = zext <4 x i1> %58 to <4 x i32>
  %61 = add <4 x i32> %vec.phi, %59
  %62 = add <4 x i32> %vec.phi71, %60
...
for.end49.i:                                      ; preds = %for.body36.i.prol.loopexit, %for.body36.i, %middle.block, %while.end.for.end49_crit_edge.i
  ...
  %call.i = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.24, i32 noundef %pos.1.lcssa.fr.i, i32 noundef %cnt.2.lcssa.i, i32 noundef %cntDna.0.lcssa.i, i32 noundef %add52.i, i32 noundef %pos.1.lcssa.fr.i, ptr noundef %add.ptr.i, i32 noundef %add56.i, i32 noundef %pos.1.lcssa.fr.i, i32 noundef %invariant.umin.i, ptr noundef %add.ptr60.i, i32 noundef %add52.i)
  %85 = load i32, ptr %to150.i, align 4, !tbaa !79
  %86 = zext i32 %85 to i64
  %spec.select323365.i = tail call i32 @llvm.umin.i32(i32 %85, i32 50)
  %spec.select323.i = zext i32 %spec.select323365.i to i64
...
for.end138.i:                                     ; preds = %for.body123.9.i, %for.body123.8.i, %for.body123.7.i, %for.body123.6.i, %for.body123.5.i, %for.body123.4.i, %for.body123.3.i, %for.body123.2.i, %for.body123.1.i, %for.body123.i, %if.then105.i
  ...
  %cmp142350.i = icmp ult i32 %pos108.0.lcssa.i, %sub119.i
...
while.end158.i.loopexit.split.loop.exit:          ; preds = %land.rhs144.i
  %118 = trunc i64 %indvars.iv381.i to i32
  br label %while.end158.i

while.end158.i:                                   ; preds = %while.body155.i, %while.end158.i.loopexit.split.loop.exit, %for.end138.i
  %cnt106.2.lcssa.i = phi i32 [ %cnt106.0.lcssa.i, %for.end138.i ], [ %cnt106.2351.i, %while.end158.i.loopexit.split.loop.exit ], [ %115, %while.body155.i ]
  %pos108.1.lcssa.i = phi i32 [ %pos108.0.lcssa.i, %for.end138.i ], [ %118, %while.end158.i.loopexit.split.loop.exit ], [ %sub119.i, %while.body155.i ]
  %pos108.1.lcssa.fr.i = freeze i32 %pos108.1.lcssa.i
  %119 = load i32, ptr %97, align 4, !tbaa !88
  %sub160.i = add i32 %119, -1
  %invariant.umin359.i = call i32 @llvm.umin.i32(i32 %sub160.i, i32 %pos108.1.lcssa.fr.i)
  %.not366.i = icmp eq i32 %invariant.umin359.i, 0
...
for.body167.lr.ph.i:                              ; preds = %while.end158.i
  %wide.trip.count388.i = zext i32 %invariant.umin359.i to i64
  %reass.sub.i = add i32 %119, -2
  %min.iters.check76 = icmp ult i32 %invariant.umin359.i, 12
...
vector.scevcheck73:                               ; preds = %for.body167.lr.ph.i
  %120 = add nsw i64 %wide.trip.count388.i, -1
  %121 = trunc i64 %120 to i32
  %122 = icmp ult i32 %reass.sub.i, %121
  %123 = icmp ugt i64 %120, 4294967295
  %124 = or i1 %122, %123
  br i1 %124, label %for.body167.i.preheader, label %vector.ph77

vector.ph77:                                      ; preds = %vector.scevcheck73
  %n.vec79 = and i64 %wide.trip.count388.i, 4294967288
...
vector.body82:                                    ; preds = %vector.body82, %vector.ph77
  ...
  %vec.phi83 = phi <4 x i32> [ zeroinitializer, %vector.ph77 ], [ %136, %vector.body82 ]
  %vec.phi84 = phi <4 x i32> [ zeroinitializer, %vector.ph77 ], [ %137, %vector.body82 ]
  %125 = trunc i64 %offset.idx85 to i32
  %126 = sub i32 %reass.sub.i, %125
  %127 = zext i32 %126 to i64
  %128 = getelementptr inbounds i8, ptr %.pre391.i, i64 %127
  %129 = getelementptr inbounds i8, ptr %128, i64 -3
  %wide.load86 = load <4 x i8>, ptr %129, align 1, !tbaa !25
  ...
  %wide.load87 = load <4 x i8>, ptr %131, align 1, !tbaa !25
  %reverse88 = shufflevector <4 x i8> %wide.load87, <4 x i8> poison, <4 x i32> <i32 3, i32 2, i32 1, i32 0>
  %132 = icmp eq <4 x i8> %reverse, <i8 84, i8 84, i8 84, i8 84>
  %133 = icmp eq <4 x i8> %reverse88, <i8 84, i8 84, i8 84, i8 84>
  %134 = zext <4 x i1> %132 to <4 x i32>
  %135 = zext <4 x i1> %133 to <4 x i32>
  %136 = add <4 x i32> %vec.phi83, %134
  %137 = add <4 x i32> %vec.phi84, %135
  %index.next89 = add nuw i64 %offset.idx85, 8
  %138 = icmp eq i64 %index.next89, %n.vec79
  br i1 %138, label %middle.block74, label %vector.body82, !llvm.loop !89

middle.block74:                                   ; preds = %vector.body82
  %bin.rdx90 = add <4 x i32> %137, %136
  %139 = call i32 @llvm.vector.reduce.add.v4i32(<4 x i32> %bin.rdx90)
  %cmp.n81 = icmp eq i64 %n.vec79, %wide.trip.count388.i
...
for.body167.i.preheader:                          ; preds = %vector.scevcheck73, %for.body167.lr.ph.i, %middle.block74
  %indvars.iv385.i.ph = phi i64 [ 0, %vector.scevcheck73 ], [ 0, %for.body167.lr.ph.i ], [ %n.vec79, %middle.block74 ]
  %cntDna107.0360.i.ph = phi i32 [ 0, %vector.scevcheck73 ], [ 0, %for.body167.lr.ph.i ], [ %139, %middle.block74 ]
  %140 = xor i64 %indvars.iv385.i.ph, -1
  %141 = add nsw i64 %140, %wide.trip.count388.i
  %xtraiter97 = and i64 %wide.trip.count388.i, 3
...
for.body167.i.prol:                               ; preds = %for.body167.i.preheader, %for.body167.i.prol
  ...
  %142 = trunc i64 %indvars.iv385.i.prol to i32
  %sub171.i.prol = sub i32 %reass.sub.i, %142
  ...
  %143 = load i8, ptr %arrayidx173.i.prol, align 1, !tbaa !25
  %cmp175.i.prol = icmp eq i8 %143, 84
  ...
  br i1 %prol.iter99.cmp.not, label %for.body167.i.prol.loopexit, label %for.body167.i.prol, !llvm.loop !90
...
for.body167.i.prol.loopexit:                      ; preds = %for.body167.i.prol, %for.body167.i.preheader
  ...
  %144 = icmp ult i64 %141, 3
  br i1 %144, label %for.end182.i, label %for.body167.i
...
for.end182.i:                                     ; preds = %for.body167.i.prol.loopexit, %for.body167.i, %middle.block74, %while.end158.i
  %cntDna107.0.lcssa.i = phi i32 [ 0, %while.end158.i ], [ %139, %middle.block74 ], [ %spec.select325.i.lcssa.unr, %for.body167.i.prol.loopexit ], [ %spec.select325.i.3, %for.body167.i ]
  %155 = load i32, ptr getelementptr inbounds (%struct._options_t, ptr @options, i64 0, i32 15), align 4, !tbaa !29
  %add185.i = add i32 %155, %sub160.i
  %156 = load ptr, ptr %seq124.i, align 8, !tbaa !36
  %sub189.i = sub i32 %sub119.i, %pos108.1.lcssa.fr.i
  %idx.ext190.i = zext i32 %sub189.i to i64
  %add.ptr191.i = getelementptr inbounds i8, ptr %156, i64 %idx.ext190.i
  ...
  %call203.i = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.28, i32 noundef %pos108.1.lcssa.fr.i, i32 noundef %cnt106.2.lcssa.i, i32 noundef %cntDna107.0.lcssa.i, i32 noundef %add185.i, i32 noundef %pos108.1.lcssa.fr.i, ptr noundef %add.ptr191.i, i32 noundef %sub119.i, i32 noundef %pos108.1.lcssa.fr.i, i32 noundef %invariant.umin359.i, ptr noundef %add.ptr199.i, i32 noundef %add185.i)
  %157 = load ptr, ptr %seq194.phi.trans.insert.i, align 8, !tbaa !36
  %158 = load i32, ptr %97, align 4, !tbaa !88
  %idx.ext207.i = zext i32 %158 to i64
  %add.ptr208.i = getelementptr inbounds i8, ptr %157, i64 %idx.ext207.i
...
if.then222.i:                                     ; preds = %if.end219.i, %for.end182.i
  ...
  %159 = load i32, ptr %97, align 4, !tbaa !88
  %160 = load i32, ptr getelementptr inbounds (%struct._options_t, ptr @options, i64 0, i32 15), align 4, !tbaa !29
  %161 = trunc i64 %sub.ptr.sub226.i to i32
  %162 = add i32 %159, 5
  %163 = add i32 %162, %160
  %conv233.i = add i32 %163, %161
...
print_polyA_info.exit:                            ; preds = %if.end103.i, %if.end235.i
  ...
  %164 = load ptr, ptr %seq16, align 8, !tbaa !36
  %seq17 = getelementptr inbounds %struct._seq_t, ptr %seq2, i64 0, i32 2
  %165 = load ptr, ptr %seq17, align 8, !tbaa !36
  call fastcc void @print_align_lat(ptr noundef %164, ptr noundef %165, ptr noundef %res)
  br label %sw.epilog
...
for.body:                                         ; preds = %if.end19, %for.body
  ...
  %167 = load ptr, ptr %eCol20, align 8, !tbaa !25
  %arrayidx = getelementptr inbounds ptr, ptr %167, i64 %indvars.iv
  %168 = load ptr, ptr %arrayidx, align 8, !tbaa !5
  call void @free(ptr noundef %168) #18
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %169 = load i32, ptr %nb, align 8, !tbaa !92
  %170 = zext i32 %169 to i64
  %cmp21 = icmp ult i64 %indvars.iv.next, %170
  br i1 %cmp21, label %for.body, label %for.end, !llvm.loop !93

for.end:                                          ; preds = %for.body, %if.end19
  %171 = load ptr, ptr %eCol20, align 8, !tbaa !25
  call void @free(ptr noundef %171) #18
  %172 = load ptr, ptr %res, align 8, !tbaa !94
  %tobool25.not = icmp eq ptr %172, null
  br i1 %tobool25.not, label %if.end28, label %if.then26

if.then26:                                        ; preds = %for.end
  call void @free_align(ptr noundef nonnull %172) #18
  br label %if.end28
...
while.cond.preheader:                             ; preds = %entry
  %invariant.gep37 = getelementptr i8, ptr %seq1, i64 -2
  %invariant.gep40 = getelementptr i8, ptr %seq2, i64 -2
...
while.body:                                       ; preds = %while.cond.preheader, %while.body
  %aligns.043 = phi ptr [ %0, %while.cond.preheader ], [ %1, %while.body ]
  %1 = load ptr, ptr %aligns.043, align 8, !tbaa !95
  %len2 = getelementptr inbounds %struct._edit_script_list, ptr %aligns.043, i64 0, i32 5
  ...
  %script = getelementptr inbounds %struct._edit_script_list, ptr %aligns.043, i64 0, i32 1
  ...
  %offset1 = getelementptr inbounds %struct._edit_script_list, ptr %aligns.043, i64 0, i32 2
  %5 = load i32, ptr %offset1, align 8, !tbaa !99
  %idx.ext = zext i32 %5 to i64
  %gep38 = getelementptr i8, ptr %invariant.gep37, i64 %idx.ext
  %offset2 = getelementptr inbounds %struct._edit_script_list, ptr %aligns.043, i64 0, i32 3
  %6 = load i32, ptr %offset2, align 4, !tbaa !100
  %idx.ext8 = zext i32 %6 to i64
  %gep41 = getelementptr i8, ptr %invariant.gep40, i64 %idx.ext8
  %len1 = getelementptr inbounds %struct._edit_script_list, ptr %aligns.043, i64 0, i32 4
  %7 = load i32, ptr %len1, align 8, !tbaa !101
  %8 = load i32, ptr %len2, align 4, !tbaa !97
  %9 = load i32, ptr %direction, align 8, !tbaa !74
  tail call void @IDISPLAY(ptr noundef nonnull %gep38, ptr noundef nonnull %gep41, i32 noundef %7, i32 noundef %8, ptr noundef nonnull %incdec.ptr, i32 noundef %5, i32 noundef %6, ptr noundef nonnull %eCol, i32 noundef %9) #18
  tail call void @free(ptr noundef %call) #18
  tail call void @free(ptr noundef nonnull %aligns.043) #18
