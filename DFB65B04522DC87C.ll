...
367:                                              ; preds = %86, %208, %241, %270, %266, %237, %216, %214, %212, %204, %82, %64, %365
  %368 = phi { ptr, i32 } [ %366, %365 ], [ %65, %64 ], [ %83, %82 ], [ %205, %204 ], [ %213, %212 ], [ %215, %214 ], [ %217, %216 ], [ %238, %237 ], [ %267, %266 ], [ %267, %270 ], [ %238, %241 ], [ %205, %208 ], [ %83, %86 ]
...
375:                                              ; preds = %34, %371, %367, %30
  %376 = phi { ptr, i32 } [ %31, %30 ], [ %368, %367 ], [ %368, %371 ], [ %31, %34 ]
  call void @llvm.lifetime.end.p0(i64 24, ptr nonnull %4) #12
