...
entry:
  %0 = load i32, ptr getelementptr inbounds ([3 x i32], ptr @arr, i64 0, i64 1), align 4, !tbaa !5
  ...
  %2 = load i32, ptr getelementptr inbounds ([3 x i32], ptr @arr, i64 0, i64 2), align 4
