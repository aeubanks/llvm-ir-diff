...
invoke.cont149:                                   ; preds = %call1.i.noexc1827
  ...
  %cmp1582489 = icmp sgt i32 %75, 0
  br i1 %cmp1582489, label %for.body, label %if.end218

for.cond175.preheader:                            ; preds = %for.inc
  %cmp1762493 = icmp sgt i32 %88, 0
  br i1 %cmp1762493, label %for.body178, label %if.end218
...
for.cond198.preheader:                            ; preds = %for.inc193
  %cmp1992497 = icmp sgt i32 %95, 0
  br i1 %cmp1992497, label %for.body201, label %if.end218

for.body178:                                      ; preds = %for.cond175.preheader, %for.inc193
  %indvars.iv2566 = phi i64 [ %indvars.iv.next2567, %for.inc193 ], [ 0, %for.cond175.preheader ]
  ...
  %gep2492 = getelementptr i8, ptr %invariant.gep, i64 %vbase.offset.i1090
  store i64 12, ptr %gep2492, align 8, !tbaa !58
  %y = getelementptr inbounds %struct.double2, ptr %gpx.sroa.0.0, i64 %indvars.iv2566, i32 1
...
for.inc193:                                       ; preds = %call1.i.noexc1879
  ...
  %cmp176 = icmp slt i64 %indvars.iv.next2567, %96
...
for.body201:                                      ; preds = %for.cond198.preheader, %for.inc214
  %p197.02498 = phi i32 [ %inc215, %for.inc214 ], [ 0, %for.cond198.preheader ]
  ...
  %gep2496 = getelementptr i8, ptr %invariant.gep, i64 %vbase.offset.i1100
  store i64 12, ptr %gep2496, align 8, !tbaa !58
...
for.inc214:                                       ; preds = %call1.i.noexc1905
  %inc215 = add nuw nsw i32 %p197.02498, 1
...
invoke.cont233:                                   ; preds = %if.then.i1119.invoke.cont233_crit_edge, %invoke.cont.i.i, %if.then5.i, %if.else.i
  %conv234.pre-phi = phi i64 [ %.pre2648, %if.then.i1119.invoke.cont233_crit_edge ], [ %conv231, %invoke.cont.i.i ], [ %conv231, %if.then5.i ], [ %conv231, %if.else.i ]
  %penquads = getelementptr inbounds %class.ExportGold, ptr %this, i64 0, i32 6
...
if.then.i1129.invoke.cont235_crit_edge:           ; preds = %if.then.i1129
  %.pre2647 = load i32, ptr @_ZN8Parallel5numpeE, align 4, !tbaa !23
  %.pre2649 = sext i32 %.pre2647 to i64
...
invoke.cont235:                                   ; preds = %if.then.i1129.invoke.cont235_crit_edge, %invoke.cont.i.i1135, %if.then5.i1134, %if.else.i1131
  %conv236.pre-phi = phi i64 [ %.pre2649, %if.then.i1129.invoke.cont235_crit_edge ], [ %conv234.pre-phi, %invoke.cont.i.i1135 ], [ %conv234.pre-phi, %if.then5.i1134 ], [ %conv234.pre-phi, %if.else.i1131 ]
  %penothers = getelementptr inbounds %class.ExportGold, ptr %this, i64 0, i32 7
...
for.body.i.preheader:                             ; preds = %invoke.cont247
  ...
  br i1 %min.iters.check, label %for.body.i.preheader2791, label %vector.ph
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %vec.phi2679 = phi <4 x i32> [ zeroinitializer, %vector.ph ], [ %138, %vector.body ]
  %135 = shl i64 %index, 2
  ...
  %wide.load2681 = load <4 x i32>, ptr %136, align 4, !tbaa !23
  %137 = add <4 x i32> %wide.load, %vec.phi
  %138 = add <4 x i32> %wide.load2681, %vec.phi2679
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %_ZSt10accumulateIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEEiET0_T_S8_S7_.exit, label %for.body.i.preheader2791

for.body.i.preheader2791:                         ; preds = %for.body.i.preheader, %middle.block
...
for.body.i:                                       ; preds = %for.body.i.preheader2791, %for.body.i
  %__init.addr.09.i = phi i32 [ %add.i1155, %for.body.i ], [ %__init.addr.09.i.ph, %for.body.i.preheader2791 ]
  %__first.sroa.0.08.i = phi ptr [ %incdec.ptr.i.i1156, %for.body.i ], [ %__first.sroa.0.08.i.ph, %for.body.i.preheader2791 ]
...
for.body.i1164.preheader:                         ; preds = %_ZSt10accumulateIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEEiET0_T_S8_S7_.exit
  ...
  %min.iters.check2684 = icmp ult i64 %147, 28
  br i1 %min.iters.check2684, label %for.body.i1164.preheader2788, label %vector.ph2685

vector.ph2685:                                    ; preds = %for.body.i1164.preheader
  %n.vec2687 = and i64 %149, -8
  %150 = shl i64 %n.vec2687, 2
  %ind.end2688 = getelementptr i8, ptr %142, i64 %150
  br label %vector.body2691

vector.body2691:                                  ; preds = %vector.body2691, %vector.ph2685
  %index2692 = phi i64 [ 0, %vector.ph2685 ], [ %index.next2699, %vector.body2691 ]
  %vec.phi2693 = phi <4 x i32> [ zeroinitializer, %vector.ph2685 ], [ %153, %vector.body2691 ]
  %vec.phi2694 = phi <4 x i32> [ zeroinitializer, %vector.ph2685 ], [ %154, %vector.body2691 ]
  %151 = shl i64 %index2692, 2
  %next.gep2695 = getelementptr i8, ptr %142, i64 %151
  %wide.load2697 = load <4 x i32>, ptr %next.gep2695, align 4, !tbaa !23
  %152 = getelementptr i32, ptr %next.gep2695, i64 4
  %wide.load2698 = load <4 x i32>, ptr %152, align 4, !tbaa !23
  %153 = add <4 x i32> %wide.load2697, %vec.phi2693
  %154 = add <4 x i32> %wide.load2698, %vec.phi2694
  %index.next2699 = add nuw i64 %index2692, 8
  %155 = icmp eq i64 %index.next2699, %n.vec2687
  br i1 %155, label %middle.block2682, label %vector.body2691, !llvm.loop !76

middle.block2682:                                 ; preds = %vector.body2691
  %bin.rdx2700 = add <4 x i32> %154, %153
  %156 = call i32 @llvm.vector.reduce.add.v4i32(<4 x i32> %bin.rdx2700)
  %cmp.n2690 = icmp eq i64 %149, %n.vec2687
  br i1 %cmp.n2690, label %_ZSt10accumulateIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEEiET0_T_S8_S7_.exit1166, label %for.body.i1164.preheader2788

for.body.i1164.preheader2788:                     ; preds = %for.body.i1164.preheader, %middle.block2682
  %__init.addr.09.i1159.ph = phi i32 [ 0, %for.body.i1164.preheader ], [ %156, %middle.block2682 ]
  %__first.sroa.0.08.i1160.ph = phi ptr [ %142, %for.body.i1164.preheader ], [ %ind.end2688, %middle.block2682 ]
  br label %for.body.i1164

for.body.i1164:                                   ; preds = %for.body.i1164.preheader2788, %for.body.i1164
  %__init.addr.09.i1159 = phi i32 [ %add.i1161, %for.body.i1164 ], [ %__init.addr.09.i1159.ph, %for.body.i1164.preheader2788 ]
  %__first.sroa.0.08.i1160 = phi ptr [ %incdec.ptr.i.i1162, %for.body.i1164 ], [ %__first.sroa.0.08.i1160.ph, %for.body.i1164.preheader2788 ]
...
_ZSt10accumulateIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEEiET0_T_S8_S7_.exit1166: ; preds = %for.body.i1164, %middle.block2682, %_ZSt10accumulateIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEEiET0_T_S8_S7_.exit
  %__init.addr.0.lcssa.i1165 = phi i32 [ 0, %_ZSt10accumulateIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEEiET0_T_S8_S7_.exit ], [ %156, %middle.block2682 ], [ %add.i1161, %for.body.i1164 ]
...
for.body.i1174.preheader:                         ; preds = %_ZSt10accumulateIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEEiET0_T_S8_S7_.exit1166
  ...
  %min.iters.check2704 = icmp ult i64 %163, 28
  br i1 %min.iters.check2704, label %for.body.i1174.preheader2785, label %vector.ph2705

vector.ph2705:                                    ; preds = %for.body.i1174.preheader
  %n.vec2707 = and i64 %165, -8
  %166 = shl i64 %n.vec2707, 2
  %ind.end2708 = getelementptr i8, ptr %158, i64 %166
  br label %vector.body2711

vector.body2711:                                  ; preds = %vector.body2711, %vector.ph2705
  %index2712 = phi i64 [ 0, %vector.ph2705 ], [ %index.next2719, %vector.body2711 ]
  %vec.phi2713 = phi <4 x i32> [ zeroinitializer, %vector.ph2705 ], [ %169, %vector.body2711 ]
  %vec.phi2714 = phi <4 x i32> [ zeroinitializer, %vector.ph2705 ], [ %170, %vector.body2711 ]
  %167 = shl i64 %index2712, 2
  %next.gep2715 = getelementptr i8, ptr %158, i64 %167
  %wide.load2717 = load <4 x i32>, ptr %next.gep2715, align 4, !tbaa !23
  %168 = getelementptr i32, ptr %next.gep2715, i64 4
  %wide.load2718 = load <4 x i32>, ptr %168, align 4, !tbaa !23
  %169 = add <4 x i32> %wide.load2717, %vec.phi2713
  %170 = add <4 x i32> %wide.load2718, %vec.phi2714
  %index.next2719 = add nuw i64 %index2712, 8
  %171 = icmp eq i64 %index.next2719, %n.vec2707
  br i1 %171, label %middle.block2702, label %vector.body2711, !llvm.loop !79

middle.block2702:                                 ; preds = %vector.body2711
  %bin.rdx2720 = add <4 x i32> %170, %169
  %172 = call i32 @llvm.vector.reduce.add.v4i32(<4 x i32> %bin.rdx2720)
  %cmp.n2710 = icmp eq i64 %165, %n.vec2707
  br i1 %cmp.n2710, label %_ZSt10accumulateIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEEiET0_T_S8_S7_.exit1176, label %for.body.i1174.preheader2785

for.body.i1174.preheader2785:                     ; preds = %for.body.i1174.preheader, %middle.block2702
  %__init.addr.09.i1169.ph = phi i32 [ 0, %for.body.i1174.preheader ], [ %172, %middle.block2702 ]
  %__first.sroa.0.08.i1170.ph = phi ptr [ %158, %for.body.i1174.preheader ], [ %ind.end2708, %middle.block2702 ]
  br label %for.body.i1174

for.body.i1174:                                   ; preds = %for.body.i1174.preheader2785, %for.body.i1174
  %__init.addr.09.i1169 = phi i32 [ %add.i1171, %for.body.i1174 ], [ %__init.addr.09.i1169.ph, %for.body.i1174.preheader2785 ]
  %__first.sroa.0.08.i1170 = phi ptr [ %incdec.ptr.i.i1172, %for.body.i1174 ], [ %__first.sroa.0.08.i1170.ph, %for.body.i1174.preheader2785 ]
...
_ZSt10accumulateIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEEiET0_T_S8_S7_.exit1176: ; preds = %for.body.i1174, %middle.block2702, %_ZSt10accumulateIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEEiET0_T_S8_S7_.exit1166
  %__init.addr.0.lcssa.i1175 = phi i32 [ 0, %_ZSt10accumulateIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEEiET0_T_S8_S7_.exit1166 ], [ %172, %middle.block2702 ], [ %add.i1171, %for.body.i1174 ]
...
invoke.cont292:                                   ; preds = %if.end.i.i.i.i.i.i.i1188, %call5.i.i.i.i4.i.i.noexc1192, %_ZNSt6vectorIiSaIiEE17_S_check_init_lenEmRKS0_.exit.i1180
  ...
  %__first.addr.0.i.i.i.i.i11892751 = ptrtoint ptr %__first.addr.0.i.i.i.i.i1189 to i64
  %pesizes.sroa.0.02722 = ptrtoint ptr %pesizes.sroa.0.0 to i64
...
invoke.cont313:                                   ; preds = %_ZNSt6vectorIiSaIiEE17_S_check_init_lenEmRKS0_.exit.i1216, %call5.i.i.i.i4.i.i.noexc1246
  %gtris.sroa.0.02392 = phi ptr [ %call5.i.i.i.i4.i.i1229, %call5.i.i.i.i4.i.i.noexc1246 ], [ null, %_ZNSt6vectorIiSaIiEE17_S_check_init_lenEmRKS0_.exit.i1216 ]
  ...
  invoke void @_ZN8Parallel7gathervIiEEvPKT_iPS1_PKi(ptr noundef %180, i32 noundef %conv224, ptr noundef %gtris.sroa.0.02392, ptr noundef %126)
...
for.cond325.preheader:                            ; preds = %invoke.cont322
  ...
  %cmp3262499 = icmp sgt i32 %182, 0
  br i1 %cmp3262499, label %for.body328.lr.ph, label %if.end338
...
for.body328.lr.ph:                                ; preds = %for.cond325.preheader
  ...
  %min.iters.check2725 = icmp ult i32 %182, 8
  %184 = ptrtoint ptr %183 to i64
  %185 = sub i64 %pesizes.sroa.0.02722, %184
  %diff.check = icmp ult i64 %185, 32
  %or.cond2773 = select i1 %min.iters.check2725, i1 true, i1 %diff.check
  br i1 %or.cond2773, label %for.body328.preheader, label %vector.ph2726

vector.ph2726:                                    ; preds = %for.body328.lr.ph
  %n.vec2728 = and i64 %wide.trip.count, 4294967288
  br label %vector.body2731

vector.body2731:                                  ; preds = %vector.body2731, %vector.ph2726
  %index2732 = phi i64 [ 0, %vector.ph2726 ], [ %index.next2735, %vector.body2731 ]
  %186 = getelementptr inbounds i32, ptr %183, i64 %index2732
  %wide.load2733 = load <4 x i32>, ptr %186, align 4, !tbaa !23
  %187 = getelementptr inbounds i32, ptr %186, i64 4
  %wide.load2734 = load <4 x i32>, ptr %187, align 4, !tbaa !23
  %188 = mul nsw <4 x i32> %wide.load2733, <i32 3, i32 3, i32 3, i32 3>
  %189 = mul nsw <4 x i32> %wide.load2734, <i32 3, i32 3, i32 3, i32 3>
  %190 = getelementptr inbounds i32, ptr %pesizes.sroa.0.0, i64 %index2732
  ...
  %index.next2735 = add nuw i64 %index2732, 8
  %192 = icmp eq i64 %index.next2735, %n.vec2728
  br i1 %192, label %middle.block2723, label %vector.body2731, !llvm.loop !82

middle.block2723:                                 ; preds = %vector.body2731
  %cmp.n2730 = icmp eq i64 %n.vec2728, %wide.trip.count
  br i1 %cmp.n2730, label %if.end338, label %for.body328.preheader

for.body328.preheader:                            ; preds = %for.body328.lr.ph, %middle.block2723
  %indvars.iv2569.ph = phi i64 [ 0, %for.body328.lr.ph ], [ %n.vec2728, %middle.block2723 ]
  %193 = xor i64 %indvars.iv2569.ph, -1
...
for.body328.prol:                                 ; preds = %for.body328.preheader, %for.body328.prol
  %indvars.iv2569.prol = phi i64 [ %indvars.iv.next2570.prol, %for.body328.prol ], [ %indvars.iv2569.ph, %for.body328.preheader ]
  %prol.iter = phi i64 [ %prol.iter.next, %for.body328.prol ], [ 0, %for.body328.preheader ]
  %add.ptr.i1249.prol = getelementptr inbounds i32, ptr %183, i64 %indvars.iv2569.prol
  %195 = load i32, ptr %add.ptr.i1249.prol, align 4, !tbaa !23
  %mul332.prol = mul nsw i32 %195, 3
  %add.ptr.i1250.prol = getelementptr inbounds i32, ptr %pesizes.sroa.0.0, i64 %indvars.iv2569.prol
  store i32 %mul332.prol, ptr %add.ptr.i1250.prol, align 4, !tbaa !23
  %indvars.iv.next2570.prol = add nuw nsw i64 %indvars.iv2569.prol, 1
...
for.body328.prol.loopexit:                        ; preds = %for.body328.prol, %for.body328.preheader
  %indvars.iv2569.unr = phi i64 [ %indvars.iv2569.ph, %for.body328.preheader ], [ %indvars.iv.next2570.prol, %for.body328.prol ]
...
for.body328:                                      ; preds = %for.body328.prol.loopexit, %for.body328
  %indvars.iv2569 = phi i64 [ %indvars.iv.next2570.3, %for.body328 ], [ %indvars.iv2569.unr, %for.body328.prol.loopexit ]
  %add.ptr.i1249 = getelementptr inbounds i32, ptr %183, i64 %indvars.iv2569
  %202 = load i32, ptr %add.ptr.i1249, align 4, !tbaa !23
  %mul332 = mul nsw i32 %202, 3
  %add.ptr.i1250 = getelementptr inbounds i32, ptr %pesizes.sroa.0.0, i64 %indvars.iv2569
  store i32 %mul332, ptr %add.ptr.i1250, align 4, !tbaa !23
  %indvars.iv.next2570 = add nuw nsw i64 %indvars.iv2569, 1
  %add.ptr.i1249.1 = getelementptr inbounds i32, ptr %183, i64 %indvars.iv.next2570
  %203 = load i32, ptr %add.ptr.i1249.1, align 4, !tbaa !23
  %mul332.1 = mul nsw i32 %203, 3
  %add.ptr.i1250.1 = getelementptr inbounds i32, ptr %pesizes.sroa.0.0, i64 %indvars.iv.next2570
  store i32 %mul332.1, ptr %add.ptr.i1250.1, align 4, !tbaa !23
  %indvars.iv.next2570.1 = add nuw nsw i64 %indvars.iv2569, 2
  %add.ptr.i1249.2 = getelementptr inbounds i32, ptr %183, i64 %indvars.iv.next2570.1
  %204 = load i32, ptr %add.ptr.i1249.2, align 4, !tbaa !23
  %mul332.2 = mul nsw i32 %204, 3
  %add.ptr.i1250.2 = getelementptr inbounds i32, ptr %pesizes.sroa.0.0, i64 %indvars.iv.next2570.1
  store i32 %mul332.2, ptr %add.ptr.i1250.2, align 4, !tbaa !23
  %indvars.iv.next2570.2 = add nuw nsw i64 %indvars.iv2569, 3
  %add.ptr.i1249.3 = getelementptr inbounds i32, ptr %183, i64 %indvars.iv.next2570.2
  %205 = load i32, ptr %add.ptr.i1249.3, align 4, !tbaa !23
  %mul332.3 = mul nsw i32 %205, 3
  %add.ptr.i1250.3 = getelementptr inbounds i32, ptr %pesizes.sroa.0.0, i64 %indvars.iv.next2570.2
  store i32 %mul332.3, ptr %add.ptr.i1250.3, align 4, !tbaa !23
  %indvars.iv.next2570.3 = add nuw nsw i64 %indvars.iv2569, 4
  %exitcond.not.3 = icmp eq i64 %indvars.iv.next2570.3, %wide.trip.count
  br i1 %exitcond.not.3, label %if.end338, label %for.body328, !llvm.loop !85

if.end338:                                        ; preds = %for.body328.prol.loopexit, %for.body328, %middle.block2723, %for.cond325.preheader, %invoke.cont322
  %cmp3402502 = icmp sgt i32 %conv224, 0
  br i1 %cmp3402502, label %for.body342.lr.ph, label %for.cond.cleanup341
...
for.body342.lr.ph:                                ; preds = %if.end338
  ...
  %wide.trip.count2582 = and i64 %107, 4294967295
...
for.body342:                                      ; preds = %for.body342.lr.ph, %for.body342
  %indvars.iv2578 = phi i64 [ 0, %for.body342.lr.ph ], [ %indvars.iv.next2579, %for.body342 ]
  %add.ptr.i1251 = getelementptr inbounds i32, ptr %206, i64 %indvars.iv2578
  ...
  %211 = mul nuw nsw i64 %indvars.iv2578, 3
  ...
  %exitcond2583.not = icmp eq i64 %indvars.iv.next2579, %wide.trip.count2582
  br i1 %exitcond2583.not, label %for.cond.cleanup341, label %for.body342, !llvm.loop !86
...
for.cond391.preheader:                            ; preds = %call1.i.noexc1957
  %invariant.gep2504 = getelementptr inbounds %"class.std::ios_base", ptr %ofs, i64 0, i32 2
  %231 = load i32, ptr %gntris, align 8, !tbaa !75
  %cmp3932506 = icmp sgt i32 %231, 0
  br i1 %cmp3932506, label %for.body395, label %if.end452

for.cond416.preheader:                            ; preds = %for.inc411
  %invariant.gep2511 = getelementptr inbounds %"class.std::basic_ios", ptr %ofs, i64 0, i32 5
  %cmp4182513 = icmp sgt i32 %237, 0
  br i1 %cmp4182513, label %for.cond422.preheader, label %if.end452

for.body395:                                      ; preds = %for.cond391.preheader, %for.inc411
  %indvars.iv2584 = phi i64 [ %indvars.iv.next2585, %for.inc411 ], [ 0, %for.cond391.preheader ]
  ...
  %gep2505 = getelementptr i8, ptr %invariant.gep2504, i64 %vbase.offset.i1270
  store i64 10, ptr %gep2505, align 8, !tbaa !58
  %add.ptr.i1273 = getelementptr inbounds i32, ptr %gtris.sroa.0.02392, i64 %indvars.iv2584
...
for.inc411:                                       ; preds = %call1.i.noexc1983
  ...
  %cmp393 = icmp slt i64 %indvars.iv.next2585, %238
...
for.cond422.preheader:                            ; preds = %for.cond416.preheader, %for.inc448
  %indvars.iv2592 = phi i64 [ %indvars.iv.next2593, %for.inc448 ], [ 0, %for.cond416.preheader ]
  %239 = mul nuw nsw i64 %indvars.iv2592, 3
  ...
  %gep2509 = getelementptr i8, ptr %invariant.gep2504, i64 %vbase.offset.i1280
  store i64 10, ptr %gep2509, align 8, !tbaa !58
...
for.inc441:                                       ; preds = %for.cond422.preheader
  ...
  %gep2509.1 = getelementptr i8, ptr %invariant.gep2504, i64 %vbase.offset.i1280.1
  store i64 10, ptr %gep2509.1, align 8, !tbaa !58
...
for.inc441.1:                                     ; preds = %for.inc441
  ...
  %gep2509.2 = getelementptr i8, ptr %invariant.gep2504, i64 %vbase.offset.i1280.2
  store i64 10, ptr %gep2509.2, align 8, !tbaa !58
...
for.inc441.2:                                     ; preds = %for.inc441.1
  ...
  %gep2512 = getelementptr i8, ptr %invariant.gep2511, i64 %vbase.offset.i1989
  %248 = load ptr, ptr %gep2512, align 8, !tbaa !36
...
for.inc448:                                       ; preds = %call1.i.noexc2009
  ...
  %cmp418 = icmp slt i64 %indvars.iv.next2593, %251
...
if.then.i.i.i.i.i1328:                            ; preds = %call5.i.i.i.i4.i.i.noexc1316, %if.end.i.i.i.i.i.i.i1312
  %mul4682395 = shl nsw i32 %253, 2
  %conv4692396 = sext i32 %mul4682395 to i64
  %mul.i.i.i.i.i.i1324 = shl nuw nsw i64 %conv4692396, 2
...
invoke.cont472:                                   ; preds = %_ZNSt6vectorIiSaIiEE17_S_check_init_lenEmRKS0_.exit.i1304, %call5.i.i.i.i4.i.i.noexc1333
  %gquads.sroa.0.02399 = phi ptr [ %call5.i.i.i.i4.i.i1317, %call5.i.i.i.i4.i.i.noexc1333 ], [ null, %_ZNSt6vectorIiSaIiEE17_S_check_init_lenEmRKS0_.exit.i1304 ]
  ...
  invoke void @_ZN8Parallel7gathervIiEEvPKT_iPS1_PKi(ptr noundef %256, i32 noundef %conv226, ptr noundef %gquads.sroa.0.02399, ptr noundef %257)
...
for.cond485.preheader:                            ; preds = %invoke.cont481
  ...
  %cmp4862515 = icmp sgt i32 %259, 0
  br i1 %cmp4862515, label %for.body488.lr.ph, label %if.end498

for.body488.lr.ph:                                ; preds = %for.cond485.preheader
  %260 = load ptr, ptr %penquads242, align 8, !tbaa !15
  %wide.trip.count2599 = zext i32 %259 to i64
  %min.iters.check2740 = icmp ult i32 %259, 8
  %261 = ptrtoint ptr %260 to i64
  %262 = sub i64 %pesizes.sroa.0.02722, %261
  %diff.check2737 = icmp ult i64 %262, 32
  %or.cond2775 = select i1 %min.iters.check2740, i1 true, i1 %diff.check2737
  br i1 %or.cond2775, label %for.body488.preheader, label %vector.ph2741

vector.ph2741:                                    ; preds = %for.body488.lr.ph
  %n.vec2743 = and i64 %wide.trip.count2599, 4294967288
  br label %vector.body2746

vector.body2746:                                  ; preds = %vector.body2746, %vector.ph2741
  %index2747 = phi i64 [ 0, %vector.ph2741 ], [ %index.next2750, %vector.body2746 ]
  %263 = getelementptr inbounds i32, ptr %260, i64 %index2747
  %wide.load2748 = load <4 x i32>, ptr %263, align 4, !tbaa !23
  %264 = getelementptr inbounds i32, ptr %263, i64 4
  %wide.load2749 = load <4 x i32>, ptr %264, align 4, !tbaa !23
  %265 = shl nsw <4 x i32> %wide.load2748, <i32 2, i32 2, i32 2, i32 2>
  %266 = shl nsw <4 x i32> %wide.load2749, <i32 2, i32 2, i32 2, i32 2>
  %267 = getelementptr inbounds i32, ptr %pesizes.sroa.0.0, i64 %index2747
  ...
  %index.next2750 = add nuw i64 %index2747, 8
  %269 = icmp eq i64 %index.next2750, %n.vec2743
  br i1 %269, label %middle.block2738, label %vector.body2746, !llvm.loop !89

middle.block2738:                                 ; preds = %vector.body2746
  %cmp.n2745 = icmp eq i64 %n.vec2743, %wide.trip.count2599
  br i1 %cmp.n2745, label %if.end498, label %for.body488.preheader

for.body488.preheader:                            ; preds = %for.body488.lr.ph, %middle.block2738
  %indvars.iv2596.ph = phi i64 [ 0, %for.body488.lr.ph ], [ %n.vec2743, %middle.block2738 ]
  %270 = xor i64 %indvars.iv2596.ph, -1
  %271 = add nsw i64 %270, %wide.trip.count2599
  %xtraiter2796 = and i64 %wide.trip.count2599, 3
  %lcmp.mod2797.not = icmp eq i64 %xtraiter2796, 0
  br i1 %lcmp.mod2797.not, label %for.body488.prol.loopexit, label %for.body488.prol

for.body488.prol:                                 ; preds = %for.body488.preheader, %for.body488.prol
  %indvars.iv2596.prol = phi i64 [ %indvars.iv.next2597.prol, %for.body488.prol ], [ %indvars.iv2596.ph, %for.body488.preheader ]
  %prol.iter2798 = phi i64 [ %prol.iter2798.next, %for.body488.prol ], [ 0, %for.body488.preheader ]
  %add.ptr.i1336.prol = getelementptr inbounds i32, ptr %260, i64 %indvars.iv2596.prol
  %272 = load i32, ptr %add.ptr.i1336.prol, align 4, !tbaa !23
  %mul492.prol = shl nsw i32 %272, 2
  %add.ptr.i1337.prol = getelementptr inbounds i32, ptr %pesizes.sroa.0.0, i64 %indvars.iv2596.prol
  store i32 %mul492.prol, ptr %add.ptr.i1337.prol, align 4, !tbaa !23
  %indvars.iv.next2597.prol = add nuw nsw i64 %indvars.iv2596.prol, 1
  %prol.iter2798.next = add i64 %prol.iter2798, 1
  %prol.iter2798.cmp.not = icmp eq i64 %prol.iter2798.next, %xtraiter2796
  br i1 %prol.iter2798.cmp.not, label %for.body488.prol.loopexit, label %for.body488.prol, !llvm.loop !90

for.body488.prol.loopexit:                        ; preds = %for.body488.prol, %for.body488.preheader
  %indvars.iv2596.unr = phi i64 [ %indvars.iv2596.ph, %for.body488.preheader ], [ %indvars.iv.next2597.prol, %for.body488.prol ]
...
for.body488:                                      ; preds = %for.body488.prol.loopexit, %for.body488
  %indvars.iv2596 = phi i64 [ %indvars.iv.next2597.3, %for.body488 ], [ %indvars.iv2596.unr, %for.body488.prol.loopexit ]
  %add.ptr.i1336 = getelementptr inbounds i32, ptr %260, i64 %indvars.iv2596
  %278 = load i32, ptr %add.ptr.i1336, align 4, !tbaa !23
  %mul492 = shl nsw i32 %278, 2
  %add.ptr.i1337 = getelementptr inbounds i32, ptr %pesizes.sroa.0.0, i64 %indvars.iv2596
  store i32 %mul492, ptr %add.ptr.i1337, align 4, !tbaa !23
  %indvars.iv.next2597 = add nuw nsw i64 %indvars.iv2596, 1
  %add.ptr.i1336.1 = getelementptr inbounds i32, ptr %260, i64 %indvars.iv.next2597
  %279 = load i32, ptr %add.ptr.i1336.1, align 4, !tbaa !23
  %mul492.1 = shl nsw i32 %279, 2
  %add.ptr.i1337.1 = getelementptr inbounds i32, ptr %pesizes.sroa.0.0, i64 %indvars.iv.next2597
  store i32 %mul492.1, ptr %add.ptr.i1337.1, align 4, !tbaa !23
  %indvars.iv.next2597.1 = add nuw nsw i64 %indvars.iv2596, 2
  %add.ptr.i1336.2 = getelementptr inbounds i32, ptr %260, i64 %indvars.iv.next2597.1
  %280 = load i32, ptr %add.ptr.i1336.2, align 4, !tbaa !23
  %mul492.2 = shl nsw i32 %280, 2
  %add.ptr.i1337.2 = getelementptr inbounds i32, ptr %pesizes.sroa.0.0, i64 %indvars.iv.next2597.1
  store i32 %mul492.2, ptr %add.ptr.i1337.2, align 4, !tbaa !23
  %indvars.iv.next2597.2 = add nuw nsw i64 %indvars.iv2596, 3
  %add.ptr.i1336.3 = getelementptr inbounds i32, ptr %260, i64 %indvars.iv.next2597.2
  %281 = load i32, ptr %add.ptr.i1336.3, align 4, !tbaa !23
  %mul492.3 = shl nsw i32 %281, 2
  %add.ptr.i1337.3 = getelementptr inbounds i32, ptr %pesizes.sroa.0.0, i64 %indvars.iv.next2597.2
  store i32 %mul492.3, ptr %add.ptr.i1337.3, align 4, !tbaa !23
  %indvars.iv.next2597.3 = add nuw nsw i64 %indvars.iv2596, 4
  %exitcond2600.not.3 = icmp eq i64 %indvars.iv.next2597.3, %wide.trip.count2599
  br i1 %exitcond2600.not.3, label %if.end498, label %for.body488, !llvm.loop !91

if.end498:                                        ; preds = %for.body488.prol.loopexit, %for.body488, %middle.block2738, %for.cond485.preheader, %invoke.cont481
  %cmp5002518 = icmp sgt i32 %conv226, 0
  br i1 %cmp5002518, label %for.body502.lr.ph, label %for.cond.cleanup501
...
for.body502.lr.ph:                                ; preds = %if.end498
  ...
  %wide.trip.count2611 = and i64 %110, 4294967295
...
for.body502:                                      ; preds = %for.body502.lr.ph, %for.body502
  %indvars.iv2607 = phi i64 [ 0, %for.body502.lr.ph ], [ %indvars.iv.next2608, %for.body502 ]
  %add.ptr.i1338 = getelementptr inbounds i32, ptr %282, i64 %indvars.iv2607
  ...
  %287 = shl nsw i64 %indvars.iv2607, 2
  ...
  %exitcond2612.not = icmp eq i64 %indvars.iv.next2608, %wide.trip.count2611
  br i1 %exitcond2612.not, label %for.cond.cleanup501, label %for.body502, !llvm.loop !92
...
for.cond557.preheader:                            ; preds = %call1.i.noexc2061
  %invariant.gep2520 = getelementptr inbounds %"class.std::ios_base", ptr %ofs, i64 0, i32 2
  %310 = load i32, ptr %gnquads, align 4, !tbaa !78
  %cmp5592522 = icmp sgt i32 %310, 0
  br i1 %cmp5592522, label %for.body561, label %if.end618

for.cond582.preheader:                            ; preds = %for.inc577
  %invariant.gep2527 = getelementptr inbounds %"class.std::basic_ios", ptr %ofs, i64 0, i32 5
  %cmp5842529 = icmp sgt i32 %316, 0
  br i1 %cmp5842529, label %for.cond588.preheader, label %if.end618

for.body561:                                      ; preds = %for.cond557.preheader, %for.inc577
  %indvars.iv2613 = phi i64 [ %indvars.iv.next2614, %for.inc577 ], [ 0, %for.cond557.preheader ]
  ...
  %gep2521 = getelementptr i8, ptr %invariant.gep2520, i64 %vbase.offset.i1357
  store i64 10, ptr %gep2521, align 8, !tbaa !58
  %add.ptr.i1360 = getelementptr inbounds i32, ptr %gquads.sroa.0.02399, i64 %indvars.iv2613
...
for.inc577:                                       ; preds = %call1.i.noexc2087
  ...
  %cmp559 = icmp slt i64 %indvars.iv.next2614, %317
...
for.cond588.preheader:                            ; preds = %for.cond582.preheader, %for.inc614
  %indvars.iv2621 = phi i64 [ %indvars.iv.next2622, %for.inc614 ], [ 0, %for.cond582.preheader ]
  %318 = shl nsw i64 %indvars.iv2621, 2
  ...
  %gep2525 = getelementptr i8, ptr %invariant.gep2520, i64 %vbase.offset.i1367
  store i64 10, ptr %gep2525, align 8, !tbaa !58
...
for.inc607:                                       ; preds = %for.cond588.preheader
  ...
  %gep2525.1 = getelementptr i8, ptr %invariant.gep2520, i64 %vbase.offset.i1367.1
  store i64 10, ptr %gep2525.1, align 8, !tbaa !58
  %323 = or i64 %318, 1
...
for.inc607.1:                                     ; preds = %for.inc607
  ...
  %gep2525.2 = getelementptr i8, ptr %invariant.gep2520, i64 %vbase.offset.i1367.2
  store i64 10, ptr %gep2525.2, align 8, !tbaa !58
  %325 = or i64 %318, 2
...
for.inc607.2:                                     ; preds = %for.inc607.1
  ...
  %gep2525.3 = getelementptr i8, ptr %invariant.gep2520, i64 %vbase.offset.i1367.3
  store i64 10, ptr %gep2525.3, align 8, !tbaa !58
  %327 = or i64 %318, 3
...
for.inc607.3:                                     ; preds = %for.inc607.2
  ...
  %gep2528 = getelementptr i8, ptr %invariant.gep2527, i64 %vbase.offset.i2093
  %329 = load ptr, ptr %gep2528, align 8, !tbaa !36
...
for.inc614:                                       ; preds = %call1.i.noexc2113
  ...
  %cmp584 = icmp slt i64 %indvars.iv.next2622, %332
...
invoke.cont636:                                   ; preds = %_ZNSt6vectorIiSaIiEE17_S_check_init_lenEmRKS0_.exit.i1392, %if.end.i.i.i.i.i.i.i1418, %call5.i.i.i.i4.i.i.noexc1422
  %gothers.sroa.0.02404 = phi ptr [ %call5.i.i.i.i4.i.i1405, %call5.i.i.i.i4.i.i.noexc1422 ], [ %call5.i.i.i.i4.i.i1405, %if.end.i.i.i.i.i.i.i1418 ], [ null, %_ZNSt6vectorIiSaIiEE17_S_check_init_lenEmRKS0_.exit.i1392 ]
  ...
  invoke void @_ZN8Parallel7gathervIiEEvPKT_iPS1_PKi(ptr noundef %337, i32 noundef %conv228, ptr noundef %gothers.sroa.0.02404, ptr noundef %338)
          to label %for.cond646.preheader unwind label %lpad644

for.cond646.preheader:                            ; preds = %invoke.cont636
  %cmp6472538 = icmp sgt i32 %conv228, 0
  br i1 %cmp6472538, label %for.body649.lr.ph, label %for.cond.cleanup648

for.body649.lr.ph:                                ; preds = %for.cond646.preheader
  %mapzs655 = getelementptr inbounds %class.ExportGold, ptr %this, i64 0, i32 4
  %wide.trip.count2632 = and i64 %113, 4294967295
...
for.body649:                                      ; preds = %for.body649.lr.ph, %for.cond.cleanup667
  %indvars.iv2629 = phi i64 [ 0, %for.body649.lr.ph ], [ %indvars.iv.next2630, %for.cond.cleanup667 ]
  %otherp.sroa.14.02541 = phi ptr [ null, %for.body649.lr.ph ], [ %otherp.sroa.14.1.lcssa, %for.cond.cleanup667 ]
  %otherp.sroa.10.02540 = phi ptr [ null, %for.body649.lr.ph ], [ %otherp.sroa.10.1.lcssa, %for.cond.cleanup667 ]
  %otherp.sroa.0.02539 = phi ptr [ null, %for.body649.lr.ph ], [ %otherp.sroa.0.2.lcssa, %for.cond.cleanup667 ]
  %344 = load ptr, ptr %others, align 8, !tbaa !15
  %add.ptr.i1425 = getelementptr inbounds i32, ptr %344, i64 %indvars.iv2629
  ...
  %add.ptr.i1427 = getelementptr inbounds i32, ptr %othernump.sroa.0.0, i64 %indvars.iv2629
  store i32 %348, ptr %add.ptr.i1427, align 4, !tbaa !23
  %349 = load i32, ptr %arrayidx659, align 4, !tbaa !23
  %cmp6662531 = icmp sgt i32 %349, 0
  br i1 %cmp6662531, label %for.body668.preheader, label %for.cond.cleanup667
...
for.cond.cleanup667:                              ; preds = %invoke.cont675, %for.body649
  %otherp.sroa.0.2.lcssa = phi ptr [ %otherp.sroa.0.02539, %for.body649 ], [ %otherp.sroa.0.3, %invoke.cont675 ]
  %otherp.sroa.10.1.lcssa = phi ptr [ %otherp.sroa.10.02540, %for.body649 ], [ %otherp.sroa.10.2, %invoke.cont675 ]
  %otherp.sroa.14.1.lcssa = phi ptr [ %otherp.sroa.14.02541, %for.body649 ], [ %otherp.sroa.14.2, %invoke.cont675 ]
  %indvars.iv.next2630 = add nuw nsw i64 %indvars.iv2629, 1
  %exitcond2633.not = icmp eq i64 %indvars.iv.next2630, %wide.trip.count2632
  br i1 %exitcond2633.not, label %for.cond.cleanup648, label %for.body649, !llvm.loop !95

for.body668:                                      ; preds = %for.body668.preheader, %invoke.cont675
  %indvars.iv2625 = phi i64 [ 0, %for.body668.preheader ], [ %indvars.iv.next2626, %invoke.cont675 ]
  %otherp.sroa.14.12534 = phi ptr [ %otherp.sroa.14.02541, %for.body668.preheader ], [ %otherp.sroa.14.2, %invoke.cont675 ]
  %otherp.sroa.10.12533 = phi ptr [ %otherp.sroa.10.02540, %for.body668.preheader ], [ %otherp.sroa.10.2, %invoke.cont675 ]
  %otherp.sroa.0.22532 = phi ptr [ %otherp.sroa.0.02539, %for.body668.preheader ], [ %otherp.sroa.0.3, %invoke.cont675 ]
  %351 = add nsw i64 %indvars.iv2625, %350
  ...
  %cmp.not.i.i = icmp eq ptr %otherp.sroa.10.12533, %otherp.sroa.14.12534
  br i1 %cmp.not.i.i, label %if.else.i.i, label %if.then.i.i1430

if.then.i.i1430:                                  ; preds = %for.body668
  store i32 %add673, ptr %otherp.sroa.10.12533, align 4, !tbaa !23
  br label %invoke.cont675

if.else.i.i:                                      ; preds = %for.body668
  %sub.ptr.lhs.cast.i.i.i.i.i = ptrtoint ptr %otherp.sroa.14.12534 to i64
  %sub.ptr.rhs.cast.i.i.i.i.i = ptrtoint ptr %otherp.sroa.0.22532 to i64
...
if.then.i.i.i33.i.i.i:                            ; preds = %_ZNSt12_Vector_baseIiSaIiEE11_M_allocateEm.exit.i.i.i
  call void @llvm.memmove.p0.p0.i64(ptr nonnull align 4 %cond.i31.i.i.i, ptr align 4 %otherp.sroa.0.22532, i64 %sub.ptr.sub.i.i.i.i.i, i1 false)
...
_ZNSt6vectorIiSaIiEE11_S_relocateEPiS2_S2_RS0_.exit.i.i.i: ; preds = %if.then.i.i.i33.i.i.i, %_ZNSt12_Vector_baseIiSaIiEE11_M_allocateEm.exit.i.i.i
  %tobool.not.i.i.i.i = icmp eq ptr %otherp.sroa.0.22532, null
...
if.then.i42.i.i.i:                                ; preds = %_ZNSt6vectorIiSaIiEE11_S_relocateEPiS2_S2_RS0_.exit.i.i.i
  call void @_ZdlPv(ptr noundef nonnull %otherp.sroa.0.22532) #17
...
invoke.cont675:                                   ; preds = %_ZNSt6vectorIiSaIiEE17_M_realloc_insertIJiEEEvN9__gnu_cxx17__normal_iteratorIPiS1_EEDpOT_.exit.i.i, %if.then.i.i1430
  %otherp.sroa.0.3 = phi ptr [ %cond.i31.i.i.i, %_ZNSt6vectorIiSaIiEE17_M_realloc_insertIJiEEEvN9__gnu_cxx17__normal_iteratorIPiS1_EEDpOT_.exit.i.i ], [ %otherp.sroa.0.22532, %if.then.i.i1430 ]
  %add.ptr.i.i.i1434.pn = phi ptr [ %add.ptr.i.i.i1434, %_ZNSt6vectorIiSaIiEE17_M_realloc_insertIJiEEEvN9__gnu_cxx17__normal_iteratorIPiS1_EEDpOT_.exit.i.i ], [ %otherp.sroa.10.12533, %if.then.i.i1430 ]
  %otherp.sroa.14.2 = phi ptr [ %add.ptr19.i.i.i, %_ZNSt6vectorIiSaIiEE17_M_realloc_insertIJiEEEvN9__gnu_cxx17__normal_iteratorIPiS1_EEDpOT_.exit.i.i ], [ %otherp.sroa.14.12534, %if.then.i.i1430 ]
  ...
  %cmp666 = icmp slt i64 %indvars.iv.next2626, %355
...
for.body.i1449.preheader:                         ; preds = %invoke.cont696
  %357 = add i64 %__first.addr.0.i.i.i.i.i11892751, -4
  %358 = sub i64 %357, %pesizes.sroa.0.02722
  %359 = lshr i64 %358, 2
  %360 = add nuw nsw i64 %359, 1
  %min.iters.check2754 = icmp ult i64 %358, 28
  br i1 %min.iters.check2754, label %for.body.i1449.preheader2777, label %vector.ph2755

vector.ph2755:                                    ; preds = %for.body.i1449.preheader
  %n.vec2757 = and i64 %360, -8
  %361 = shl i64 %n.vec2757, 2
  %ind.end2758 = getelementptr i8, ptr %pesizes.sroa.0.0, i64 %361
  br label %vector.body2761

vector.body2761:                                  ; preds = %vector.body2761, %vector.ph2755
  %index2762 = phi i64 [ 0, %vector.ph2755 ], [ %index.next2769, %vector.body2761 ]
  %vec.phi2763 = phi <4 x i32> [ zeroinitializer, %vector.ph2755 ], [ %364, %vector.body2761 ]
  %vec.phi2764 = phi <4 x i32> [ zeroinitializer, %vector.ph2755 ], [ %365, %vector.body2761 ]
  %362 = shl i64 %index2762, 2
  %next.gep2765 = getelementptr i8, ptr %pesizes.sroa.0.0, i64 %362
  %wide.load2767 = load <4 x i32>, ptr %next.gep2765, align 4, !tbaa !23
  %363 = getelementptr i32, ptr %next.gep2765, i64 4
  %wide.load2768 = load <4 x i32>, ptr %363, align 4, !tbaa !23
  %364 = add <4 x i32> %wide.load2767, %vec.phi2763
  %365 = add <4 x i32> %wide.load2768, %vec.phi2764
  %index.next2769 = add nuw i64 %index2762, 8
  %366 = icmp eq i64 %index.next2769, %n.vec2757
  br i1 %366, label %middle.block2752, label %vector.body2761, !llvm.loop !97

middle.block2752:                                 ; preds = %vector.body2761
  %bin.rdx2770 = add <4 x i32> %365, %364
  %367 = call i32 @llvm.vector.reduce.add.v4i32(<4 x i32> %bin.rdx2770)
  %cmp.n2760 = icmp eq i64 %360, %n.vec2757
  br i1 %cmp.n2760, label %_ZSt10accumulateIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEEiET0_T_S8_S7_.exit1451, label %for.body.i1449.preheader2777

for.body.i1449.preheader2777:                     ; preds = %for.body.i1449.preheader, %middle.block2752
  %__init.addr.09.i1444.ph = phi i32 [ 0, %for.body.i1449.preheader ], [ %367, %middle.block2752 ]
  %__first.sroa.0.08.i1445.ph = phi ptr [ %pesizes.sroa.0.0, %for.body.i1449.preheader ], [ %ind.end2758, %middle.block2752 ]
  br label %for.body.i1449

for.body.i1449:                                   ; preds = %for.body.i1449.preheader2777, %for.body.i1449
  %__init.addr.09.i1444 = phi i32 [ %add.i1446, %for.body.i1449 ], [ %__init.addr.09.i1444.ph, %for.body.i1449.preheader2777 ]
  %__first.sroa.0.08.i1445 = phi ptr [ %incdec.ptr.i.i1447, %for.body.i1449 ], [ %__first.sroa.0.08.i1445.ph, %for.body.i1449.preheader2777 ]
...
_ZSt10accumulateIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEEiET0_T_S8_S7_.exit1451: ; preds = %for.body.i1449, %middle.block2752
  %add.i1446.lcssa = phi i32 [ %367, %middle.block2752 ], [ %add.i1446, %for.body.i1449 ]
...
for.cond741.preheader:                            ; preds = %call1.i.noexc2165
  %invariant.gep2545 = getelementptr inbounds %"class.std::ios_base", ptr %ofs, i64 0, i32 2
  %381 = load i32, ptr %gnothers, align 8, !tbaa !81
  %cmp7432547 = icmp sgt i32 %381, 0
  br i1 %cmp7432547, label %for.body745, label %if.end831thread-pre-split

for.cond766.preheader:                            ; preds = %for.inc761
  %cmp7682551 = icmp sgt i32 %390, 0
  br i1 %cmp7682551, label %for.body770, label %if.end831thread-pre-split
...
for.body745:                                      ; preds = %for.cond741.preheader, %for.inc761
  %indvars.iv2634 = phi i64 [ %indvars.iv.next2635, %for.inc761 ], [ 0, %for.cond741.preheader ]
  ...
  %gep2546 = getelementptr i8, ptr %invariant.gep2545, i64 %vbase.offset.i1486
  store i64 10, ptr %gep2546, align 8, !tbaa !58
  %add.ptr.i1489 = getelementptr inbounds i32, ptr %gothers.sroa.0.02404, i64 %indvars.iv2634
...
for.inc761:                                       ; preds = %call1.i.noexc2191
  ...
  %cmp743 = icmp slt i64 %indvars.iv.next2635, %391
...
for.cond790.preheader:                            ; preds = %for.inc785
  %invariant.gep2558 = getelementptr inbounds %"class.std::basic_ios", ptr %ofs, i64 0, i32 5
  %cmp7922560 = icmp sgt i32 %397, 0
  br i1 %cmp7922560, label %for.cond796.preheader, label %if.end831thread-pre-split

for.body770:                                      ; preds = %for.cond766.preheader, %for.inc785
  %indvars.iv2637 = phi i64 [ %indvars.iv.next2638, %for.inc785 ], [ 0, %for.cond766.preheader ]
  ...
  %gep2550 = getelementptr i8, ptr %invariant.gep2545, i64 %vbase.offset.i1494
  store i64 10, ptr %gep2550, align 8, !tbaa !58
  %add.ptr.i1497 = getelementptr inbounds i32, ptr %gothernump.sroa.0.0, i64 %indvars.iv2637
...
for.inc785:                                       ; preds = %call1.i.noexc2217
  ...
  %cmp768 = icmp slt i64 %indvars.iv.next2638, %398
...
lpad772.loopexit:                                 ; preds = %for.body770, %if.end.i.i.i2210, %.noexc2215, %_ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc.exit.i2213, %call1.i.noexc2217
  %lpad.loopexit2447 = landingpad { ptr, i32 }
          cleanup
  br label %ehcleanup836

lpad772.loopexit.split-lp:                        ; preds = %if.then.i.i.i2201
  %lpad.loopexit.split-lp2448 = landingpad { ptr, i32 }
          cleanup
  br label %ehcleanup836

for.cond796.preheader:                            ; preds = %for.cond790.preheader, %invoke.cont821
  %indvars.iv2644 = phi i64 [ %indvars.iv.next2645, %invoke.cont821 ], [ 0, %for.cond790.preheader ]
  %gp.02561 = phi i32 [ %add825, %invoke.cont821 ], [ 0, %for.cond790.preheader ]
  %add.ptr.i1500 = getelementptr inbounds i32, ptr %gothernump.sroa.0.0, i64 %indvars.iv2644
  %399 = load i32, ptr %add.ptr.i1500, align 4, !tbaa !23
  %cmp7992555 = icmp sgt i32 %399, 0
  br i1 %cmp7992555, label %for.body801.preheader, label %for.cond.cleanup800

for.body801.preheader:                            ; preds = %for.cond796.preheader
  %400 = sext i32 %gp.02561 to i64
...
for.cond.cleanup800:                              ; preds = %for.inc816, %for.cond796.preheader
  ...
  %gep2559 = getelementptr i8, ptr %invariant.gep2558, i64 %vbase.offset.i2223
  %401 = load ptr, ptr %gep2559, align 8, !tbaa !36
...
for.body801:                                      ; preds = %for.body801.preheader, %for.inc816
  %indvars.iv2640 = phi i64 [ 0, %for.body801.preheader ], [ %indvars.iv.next2641, %for.inc816 ]
  ...
  %gep2554 = getelementptr i8, ptr %invariant.gep2545, i64 %vbase.offset.i1505
  store i64 10, ptr %gep2554, align 8, !tbaa !58
  %405 = add nsw i64 %indvars.iv2640, %400
...
for.inc816:                                       ; preds = %for.body801
  ...
  %cmp799 = icmp slt i64 %indvars.iv.next2641, %408
...
if.end831thread-pre-split:                        ; preds = %invoke.cont821, %for.cond741.preheader, %for.cond766.preheader, %for.cond790.preheader
  %.pr2413 = load i32, ptr @_ZN8Parallel4mypeE, align 4, !tbaa !23
  br label %if.end831

if.end831:                                        ; preds = %if.end831thread-pre-split, %invoke.cont718
  %413 = phi i32 [ %.pr2413, %if.end831thread-pre-split ], [ %370, %invoke.cont718 ]
...
_ZNSt6vectorIiSaIiEED2Ev.exit1525:                ; preds = %_ZNSt6vectorIiSaIiEED2Ev.exit, %if.then.i.i.i1524
  %tobool.not.i.i.i1526 = icmp eq ptr %gothers.sroa.0.02404, null
...
if.then.i.i.i1527:                                ; preds = %_ZNSt6vectorIiSaIiEED2Ev.exit1525
  call void @_ZdlPv(ptr noundef nonnull %gothers.sroa.0.02404) #17
...
_ZNSt6vectorIiSaIiEED2Ev.exit1537:                ; preds = %_ZNSt6vectorIiSaIiEED2Ev.exit1534, %if.then.i.i.i1536
  %tobool.not.i.i.i1538 = icmp eq ptr %gquads.sroa.0.02399, null
...
if.then.i.i.i1539:                                ; preds = %_ZNSt6vectorIiSaIiEED2Ev.exit1537
  call void @_ZdlPv(ptr noundef nonnull %gquads.sroa.0.02399) #17
...
_ZNSt6vectorIiSaIiEED2Ev.exit1546:                ; preds = %_ZNSt6vectorIiSaIiEED2Ev.exit1543, %if.then.i.i.i1545
  %tobool.not.i.i.i1547 = icmp eq ptr %gtris.sroa.0.02392, null
...
if.then.i.i.i1548:                                ; preds = %_ZNSt6vectorIiSaIiEED2Ev.exit1546
  call void @_ZdlPv(ptr noundef nonnull %gtris.sroa.0.02392) #17
...
ehcleanup836:                                     ; preds = %lpad820.loopexit, %lpad820.loopexit.split-lp, %lpad772.loopexit, %lpad772.loopexit.split-lp, %lpad747.loopexit, %lpad747.loopexit.split-lp, %lpad717
  %.pn2345 = phi { ptr, i32 } [ %384, %lpad717 ], [ %lpad.loopexit2450, %lpad747.loopexit ], [ %lpad.loopexit.split-lp2451, %lpad747.loopexit.split-lp ], [ %lpad.loopexit2447, %lpad772.loopexit ], [ %lpad.loopexit.split-lp2448, %lpad772.loopexit.split-lp ], [ %lpad.loopexit, %lpad820.loopexit ], [ %lpad.loopexit.split-lp, %lpad820.loopexit.split-lp ]
...
if.then.i.i.i1565:                                ; preds = %ehcleanup836.thread, %ehcleanup836
  %.pn23452416 = phi { ptr, i32 } [ %409, %ehcleanup836.thread ], [ %.pn2345, %ehcleanup836 ]
  call void @_ZdlPv(ptr noundef nonnull %gotherp.sroa.0.0) #17
  br label %ehcleanup840

ehcleanup840:                                     ; preds = %lpad674.loopexit, %lpad674.loopexit.split-lp, %lpad695, %if.then.i.i.i1565, %ehcleanup836, %lpad710, %lpad644
  %otherp.sroa.0.4 = phi ptr [ %otherp.sroa.0.1, %lpad644 ], [ %otherp.sroa.0.0.lcssa, %lpad710 ], [ %otherp.sroa.0.0.lcssa, %ehcleanup836 ], [ %otherp.sroa.0.0.lcssa, %if.then.i.i.i1565 ], [ %otherp.sroa.0.0.lcssa, %lpad695 ], [ %otherp.sroa.0.22532, %lpad674.loopexit ], [ %otherp.sroa.0.22532, %lpad674.loopexit.split-lp ]
  %.pn2346 = phi { ptr, i32 } [ %343, %lpad644 ], [ %383, %lpad710 ], [ %.pn2345, %ehcleanup836 ], [ %.pn23452416, %if.then.i.i.i1565 ], [ %382, %lpad695 ], [ %lpad.loopexit2453, %lpad674.loopexit ], [ %lpad.loopexit.split-lp2454, %lpad674.loopexit.split-lp ]
...
ehcleanup841:                                     ; preds = %if.then.i.i.i1568, %ehcleanup840
  %tobool.not.i.i.i1570 = icmp eq ptr %gothers.sroa.0.02404, null
...
if.then.i.i.i1571:                                ; preds = %ehcleanup841.thread, %ehcleanup841
  %.pn23472423 = phi { ptr, i32 } [ %342, %ehcleanup841.thread ], [ %.pn2346, %ehcleanup841 ]
  %otherp.sroa.0.52422 = phi ptr [ null, %ehcleanup841.thread ], [ %otherp.sroa.0.4, %ehcleanup841 ]
  %gothers.sroa.0.024022421 = phi ptr [ %call5.i.i.i.i4.i.i1405, %ehcleanup841.thread ], [ %gothers.sroa.0.02404, %ehcleanup841 ]
  call void @_ZdlPv(ptr noundef nonnull %gothers.sroa.0.024022421) #17
  br label %ehcleanup843

ehcleanup843:                                     ; preds = %if.then.i.i.i1571, %ehcleanup841
  %otherp.sroa.0.6 = phi ptr [ %otherp.sroa.0.4, %ehcleanup841 ], [ %otherp.sroa.0.52422, %if.then.i.i.i1571 ]
  %.pn2348 = phi { ptr, i32 } [ %.pn2346, %ehcleanup841 ], [ %.pn23472423, %if.then.i.i.i1571 ]
...
_ZNSt6vectorIiSaIiEED2Ev.exit1575:                ; preds = %ehcleanup843.thread, %ehcleanup843, %if.then.i.i.i1574
  %.pn23482427 = phi { ptr, i32 } [ %341, %ehcleanup843.thread ], [ %.pn2348, %ehcleanup843 ], [ %.pn2348, %if.then.i.i.i1574 ]
...
ehcleanup848:                                     ; preds = %lpad563.loopexit, %lpad563.loopexit.split-lp, %lpad621, %_ZNSt6vectorIiSaIiEED2Ev.exit1575, %if.then.i.i.i1577, %lpad480
  %.pn2358 = phi { ptr, i32 } [ %277, %lpad480 ], [ %340, %lpad621 ], [ %.pn23482427, %_ZNSt6vectorIiSaIiEED2Ev.exit1575 ], [ %.pn23482427, %if.then.i.i.i1577 ], [ %lpad.loopexit2459, %lpad563.loopexit ], [ %lpad.loopexit.split-lp2460, %lpad563.loopexit.split-lp ]
...
if.then.i.i.i1580:                                ; preds = %lpad611.loopexit.split-lp, %lpad611.loopexit, %ehcleanup848.thread, %ehcleanup848
  %.pn23582430 = phi { ptr, i32 } [ %330, %ehcleanup848.thread ], [ %.pn2358, %ehcleanup848 ], [ %lpad.loopexit.split-lp2457, %lpad611.loopexit.split-lp ], [ %lpad.loopexit2456, %lpad611.loopexit ]
  call void @_ZdlPv(ptr noundef nonnull %gquadp.sroa.0.0) #17
  br label %ehcleanup849

ehcleanup849:                                     ; preds = %if.then.i.i.i1580, %ehcleanup848
  %.pn2358.pn = phi { ptr, i32 } [ %.pn2358, %ehcleanup848 ], [ %.pn23582430, %if.then.i.i.i1580 ]
  %tobool.not.i.i.i1582 = icmp eq ptr %gquads.sroa.0.02399, null
...
if.then.i.i.i1583:                                ; preds = %ehcleanup849.thread, %ehcleanup849
  %.pn2358.pn2435 = phi { ptr, i32 } [ %276, %ehcleanup849.thread ], [ %.pn2358.pn, %ehcleanup849 ]
  %gquads.sroa.0.023972434 = phi ptr [ %call5.i.i.i.i4.i.i1317, %ehcleanup849.thread ], [ %gquads.sroa.0.02399, %ehcleanup849 ]
  call void @_ZdlPv(ptr noundef nonnull %gquads.sroa.0.023972434) #17
  br label %ehcleanup851

ehcleanup851:                                     ; preds = %if.then.i.i.i1583, %ehcleanup849, %lpad463
  %.pn2358.pn.pn = phi { ptr, i32 } [ %275, %lpad463 ], [ %.pn2358.pn, %ehcleanup849 ], [ %.pn2358.pn2435, %if.then.i.i.i1583 ]
...
ehcleanup854:                                     ; preds = %lpad397.loopexit, %lpad397.loopexit.split-lp, %lpad456, %ehcleanup851, %if.then.i.i.i1586, %lpad321
  %.pn2365 = phi { ptr, i32 } [ %201, %lpad321 ], [ %274, %lpad456 ], [ %.pn2358.pn.pn, %ehcleanup851 ], [ %.pn2358.pn.pn, %if.then.i.i.i1586 ], [ %lpad.loopexit2465, %lpad397.loopexit ], [ %lpad.loopexit.split-lp2466, %lpad397.loopexit.split-lp ]
...
if.then.i.i.i1589:                                ; preds = %lpad445.loopexit.split-lp, %lpad445.loopexit, %ehcleanup854.thread, %ehcleanup854
  %.pn23652438 = phi { ptr, i32 } [ %249, %ehcleanup854.thread ], [ %.pn2365, %ehcleanup854 ], [ %lpad.loopexit.split-lp2463, %lpad445.loopexit.split-lp ], [ %lpad.loopexit2462, %lpad445.loopexit ]
  call void @_ZdlPv(ptr noundef nonnull %gtrip.sroa.0.0) #17
  br label %ehcleanup855

ehcleanup855:                                     ; preds = %if.then.i.i.i1589, %ehcleanup854
  %.pn2365.pn = phi { ptr, i32 } [ %.pn2365, %ehcleanup854 ], [ %.pn23652438, %if.then.i.i.i1589 ]
  %tobool.not.i.i.i1591 = icmp eq ptr %gtris.sroa.0.02392, null
...
if.then.i.i.i1592:                                ; preds = %ehcleanup855.thread, %ehcleanup855
  %.pn2365.pn2443 = phi { ptr, i32 } [ %200, %ehcleanup855.thread ], [ %.pn2365.pn, %ehcleanup855 ]
  %gtris.sroa.0.023902442 = phi ptr [ %call5.i.i.i.i4.i.i1229, %ehcleanup855.thread ], [ %gtris.sroa.0.02392, %ehcleanup855 ]
  call void @_ZdlPv(ptr noundef nonnull %gtris.sroa.0.023902442) #17
  br label %ehcleanup857

ehcleanup857:                                     ; preds = %if.then.i.i.i1592, %ehcleanup855, %lpad304
  %.pn2365.pn.pn = phi { ptr, i32 } [ %199, %lpad304 ], [ %.pn2365.pn, %ehcleanup855 ], [ %.pn2365.pn2443, %if.then.i.i.i1592 ]
...
ehcleanup867:                                     ; preds = %lpad203.loopexit, %lpad203.loopexit.split-lp, %lpad232, %if.then.i.i.i1598, %ehcleanup859, %lpad291, %lpad132
  %.pn2366 = phi { ptr, i32 } [ %82, %lpad132 ], [ %122, %lpad232 ], [ %197, %lpad291 ], [ %.pn2365.pn.pn.pn, %ehcleanup859 ], [ %.pn2365.pn.pn.pn, %if.then.i.i.i1598 ], [ %lpad.loopexit2468, %lpad203.loopexit ], [ %lpad.loopexit.split-lp2469, %lpad203.loopexit.split-lp ]
...
if.then.i.i.i1601:                                ; preds = %lpad180.loopexit, %lpad180.loopexit.split-lp, %lpad160.loopexit, %lpad160.loopexit.split-lp, %ehcleanup867
  %.pn23662446 = phi { ptr, i32 } [ %.pn2366, %ehcleanup867 ], [ %lpad.loopexit2474, %lpad160.loopexit ], [ %lpad.loopexit.split-lp2475, %lpad160.loopexit.split-lp ], [ %lpad.loopexit2471, %lpad180.loopexit ], [ %lpad.loopexit.split-lp2472, %lpad180.loopexit.split-lp ]
  call void @_ZdlPv(ptr noundef nonnull %gpx.sroa.0.0) #17
  br label %ehcleanup869

ehcleanup869:                                     ; preds = %lpad126, %ehcleanup867, %if.then.i.i.i1601, %lpad117
  %.pn2366.pn.pn = phi { ptr, i32 } [ %80, %lpad117 ], [ %81, %lpad126 ], [ %.pn2366, %ehcleanup867 ], [ %.pn23662446, %if.then.i.i.i1601 ]
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %offset) #18
