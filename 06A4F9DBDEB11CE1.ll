...
while.body:                                       ; preds = %while.cond.preheader, %if.end54
  ...
  %shr = lshr i16 %4, 8
  store i16 %shr, ptr @cfc, align 2, !tbaa !8
  %5 = and i16 %4, 255
  store i16 %5, ptr @cfd, align 2, !tbaa !8
  %6 = load i16, ptr @c, align 2, !tbaa !8
  %conv27 = trunc i16 %6 to i8
  %7 = load <16 x i8>, ptr @cle, align 16, !tbaa !5
  %8 = insertelement <16 x i8> poison, i8 %conv27, i64 0
  %9 = shufflevector <16 x i8> %8, <16 x i8> poison, <16 x i32> zeroinitializer
  %10 = xor <16 x i8> %7, %9
  store <16 x i8> %10, ptr @cle, align 16, !tbaa !5
  %11 = load <16 x i8>, ptr getelementptr inbounds ([32 x i8], ptr @cle, i64 0, i64 16), align 16, !tbaa !5
  %12 = xor <16 x i8> %11, %9
  store <16 x i8> %12, ptr getelementptr inbounds ([32 x i8], ptr @cle, i64 0, i64 16), align 16, !tbaa !5
  store i16 32, ptr @compte, align 2, !tbaa !8
  %13 = xor i16 %5, %6
  %xor38 = xor i16 %13, %shr
  store i16 %xor38, ptr @c, align 2, !tbaa !8
  %shr41 = ashr i16 %xor38, 4
  store i16 %shr41, ptr @d, align 2, !tbaa !8
  %14 = and i16 %xor38, 15
  store i16 %14, ptr @e, align 2, !tbaa !8
