...
sw.bb:                                            ; preds = %while.body383
  store i32 1, ptr %mode_fixed471, align 8, !tbaa !38
  %36 = load i8, ptr %nextArg.0., align 1, !tbaa !14
...
if.else419:                                       ; preds = %sw.bb
  ...
  %call420 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %37, ptr noundef nonnull @.str.149, ptr noundef %0, ptr noundef nonnull %nextArg.0.) #14
  br label %if.then566
...
if.else523:                                       ; preds = %sw.bb481
  ...
  %call524 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %40, ptr noundef nonnull @.str.150, ptr noundef %0, ptr noundef nonnull %nextArg.0.) #14
  br label %if.then566
...
sw.bb536:                                         ; preds = %while.body383
  ...
  %call537 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %41, ptr noundef nonnull @.str.151, ptr noundef %0, ptr noundef %nextArg.0.) #14
  br label %if.end573
...
if.else555:                                       ; preds = %sw.bb538
  ...
  %call556 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %43, ptr noundef nonnull @.str.152, ptr noundef %0, ptr noundef nonnull %nextArg.0.) #14
  br label %if.then566
