...
define dso_local i32 @podd(ptr noundef %0) local_unnamed_addr #0 {
  %2 = icmp ne ptr %0, null
  tail call void @llvm.assume(i1 %2)
  %3 = load i16, ptr %0, align 2, !tbaa !5
  %4 = getelementptr inbounds %struct.precisionType, ptr %0, i64 0, i32 4
  %5 = load i16, ptr %4, align 2, !tbaa !5
  %6 = icmp eq i16 %3, 0
  br i1 %6, label %7, label %9

7:                                                ; preds = %1
  %8 = tail call i32 (ptr, ...) @pfree(ptr noundef nonnull %0) #3
  br label %9
