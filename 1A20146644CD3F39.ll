...
if.end:                                           ; preds = %if.then, %entry
  ...
  %or.cond856 = select i1 %cmp8, i1 true, i1 %cmp10
  br i1 %or.cond856, label %if.then12, label %if.end84
...
if.then17:                                        ; preds = %if.then12
  ...
  %.pre989 = load i32, ptr @partA__align.orlgth1, align 4, !tbaa !11
  %.pre990 = load i32, ptr @partA__align.orlgth2, align 4, !tbaa !11
  br label %if.end18

if.end18:                                         ; preds = %if.then17, %if.then12
  %24 = phi i32 [ %.pre990, %if.then17 ], [ %7, %if.then12 ]
  %25 = phi i32 [ %.pre989, %if.then17 ], [ %4, %if.then12 ]
...
if.end84:                                         ; preds = %if.end, %if.end18
  ...
  %cmp85862 = icmp sgt i32 %icyc, 0
  br i1 %cmp85862, label %for.body.lr.ph, label %for.cond90.preheader
...
for.body.lr.ph:                                   ; preds = %if.end84
  ...
  %or.cond1258 = select i1 %min.iters.check, i1 true, i1 %diff.check
  br i1 %or.cond1258, label %for.body.preheader, label %vector.ph
...
for.cond90.preheader:                             ; preds = %for.body.prol.loopexit, %for.body, %middle.block, %if.end84
  %cmp91864 = icmp sgt i32 %jcyc, 0
  br i1 %cmp91864, label %for.body93.lr.ph, label %for.end101
...
for.body93.lr.ph:                                 ; preds = %for.cond90.preheader
  ...
  %wide.trip.count922 = zext i32 %jcyc to i64
  %min.iters.check1012 = icmp ult i32 %jcyc, 8
  br i1 %min.iters.check1012, label %for.body93.preheader, label %vector.memcheck1008

vector.memcheck1008:                              ; preds = %for.body93.lr.ph
  %46 = ptrtoint ptr %44 to i64
  %47 = ptrtoint ptr %43 to i64
  %48 = shl nsw i64 %45, 3
  %49 = add i64 %48, %47
  %50 = sub i64 %46, %49
  %diff.check1009 = icmp ult i64 %50, 32
  br i1 %diff.check1009, label %for.body93.preheader, label %vector.ph1013

vector.ph1013:                                    ; preds = %vector.memcheck1008
  %n.vec1015 = and i64 %wide.trip.count922, 4294967292
  br label %vector.body1018

vector.body1018:                                  ; preds = %vector.body1018, %vector.ph1013
  %index1019 = phi i64 [ 0, %vector.ph1013 ], [ %index.next1022, %vector.body1018 ]
  %51 = add nsw i64 %index1019, %45
  %52 = getelementptr inbounds ptr, ptr %43, i64 %51
  %wide.load1020 = load <2 x ptr>, ptr %52, align 8, !tbaa !5
  %53 = getelementptr inbounds ptr, ptr %52, i64 2
  %wide.load1021 = load <2 x ptr>, ptr %53, align 8, !tbaa !5
  %54 = getelementptr inbounds ptr, ptr %44, i64 %index1019
  store <2 x ptr> %wide.load1020, ptr %54, align 8, !tbaa !5
  %55 = getelementptr inbounds ptr, ptr %54, i64 2
  store <2 x ptr> %wide.load1021, ptr %55, align 8, !tbaa !5
  %index.next1022 = add nuw i64 %index1019, 4
  %56 = icmp eq i64 %index.next1022, %n.vec1015
  br i1 %56, label %middle.block1010, label %vector.body1018, !llvm.loop !56

middle.block1010:                                 ; preds = %vector.body1018
  %cmp.n1017 = icmp eq i64 %n.vec1015, %wide.trip.count922
  br i1 %cmp.n1017, label %for.end101, label %for.body93.preheader

for.body93.preheader:                             ; preds = %vector.memcheck1008, %for.body93.lr.ph, %middle.block1010
  %indvars.iv918.ph = phi i64 [ 0, %vector.memcheck1008 ], [ 0, %for.body93.lr.ph ], [ %n.vec1015, %middle.block1010 ]
  %57 = xor i64 %indvars.iv918.ph, -1
  %58 = add nsw i64 %57, %wide.trip.count922
  %xtraiter1261 = and i64 %wide.trip.count922, 3
  %lcmp.mod1262.not = icmp eq i64 %xtraiter1261, 0
  br i1 %lcmp.mod1262.not, label %for.body93.prol.loopexit, label %for.body93.prol

for.body93.prol:                                  ; preds = %for.body93.preheader, %for.body93.prol
  %indvars.iv918.prol = phi i64 [ %indvars.iv.next919.prol, %for.body93.prol ], [ %indvars.iv918.ph, %for.body93.preheader ]
  %prol.iter1263 = phi i64 [ %prol.iter1263.next, %for.body93.prol ], [ 0, %for.body93.preheader ]
  %59 = add nsw i64 %indvars.iv918.prol, %45
  %arrayidx96.prol = getelementptr inbounds ptr, ptr %43, i64 %59
  %60 = load ptr, ptr %arrayidx96.prol, align 8, !tbaa !5
  %arrayidx98.prol = getelementptr inbounds ptr, ptr %44, i64 %indvars.iv918.prol
  store ptr %60, ptr %arrayidx98.prol, align 8, !tbaa !5
  %indvars.iv.next919.prol = add nuw nsw i64 %indvars.iv918.prol, 1
  %prol.iter1263.next = add i64 %prol.iter1263, 1
  %prol.iter1263.cmp.not = icmp eq i64 %prol.iter1263.next, %xtraiter1261
  br i1 %prol.iter1263.cmp.not, label %for.body93.prol.loopexit, label %for.body93.prol, !llvm.loop !57

for.body93.prol.loopexit:                         ; preds = %for.body93.prol, %for.body93.preheader
  %indvars.iv918.unr = phi i64 [ %indvars.iv918.ph, %for.body93.preheader ], [ %indvars.iv.next919.prol, %for.body93.prol ]
...
for.body93:                                       ; preds = %for.body93.prol.loopexit, %for.body93
  %indvars.iv918 = phi i64 [ %indvars.iv.next919.3, %for.body93 ], [ %indvars.iv918.unr, %for.body93.prol.loopexit ]
  %66 = add nsw i64 %indvars.iv918, %45
  %arrayidx96 = getelementptr inbounds ptr, ptr %43, i64 %66
  %67 = load ptr, ptr %arrayidx96, align 8, !tbaa !5
  %arrayidx98 = getelementptr inbounds ptr, ptr %44, i64 %indvars.iv918
  store ptr %67, ptr %arrayidx98, align 8, !tbaa !5
  %indvars.iv.next919 = add nuw nsw i64 %indvars.iv918, 1
  %68 = add nsw i64 %indvars.iv.next919, %45
  %arrayidx96.1 = getelementptr inbounds ptr, ptr %43, i64 %68
  %69 = load ptr, ptr %arrayidx96.1, align 8, !tbaa !5
  %arrayidx98.1 = getelementptr inbounds ptr, ptr %44, i64 %indvars.iv.next919
  store ptr %69, ptr %arrayidx98.1, align 8, !tbaa !5
  %indvars.iv.next919.1 = add nuw nsw i64 %indvars.iv918, 2
  %70 = add nsw i64 %indvars.iv.next919.1, %45
  %arrayidx96.2 = getelementptr inbounds ptr, ptr %43, i64 %70
  %71 = load ptr, ptr %arrayidx96.2, align 8, !tbaa !5
  %arrayidx98.2 = getelementptr inbounds ptr, ptr %44, i64 %indvars.iv.next919.1
  store ptr %71, ptr %arrayidx98.2, align 8, !tbaa !5
  %indvars.iv.next919.2 = add nuw nsw i64 %indvars.iv918, 3
  %72 = add nsw i64 %indvars.iv.next919.2, %45
  %arrayidx96.3 = getelementptr inbounds ptr, ptr %43, i64 %72
  %73 = load ptr, ptr %arrayidx96.3, align 8, !tbaa !5
  %arrayidx98.3 = getelementptr inbounds ptr, ptr %44, i64 %indvars.iv.next919.2
  store ptr %73, ptr %arrayidx98.3, align 8, !tbaa !5
  %indvars.iv.next919.3 = add nuw nsw i64 %indvars.iv918, 4
  %exitcond923.not.3 = icmp eq i64 %indvars.iv.next919.3, %wide.trip.count922
  br i1 %exitcond923.not.3, label %for.end101, label %for.body93, !llvm.loop !59

for.end101:                                       ; preds = %for.body93.prol.loopexit, %for.body93, %middle.block1010, %for.cond90.preheader
  %74 = load i32, ptr @commonAlloc1, align 4
  %cmp102 = icmp sgt i32 %28, %74
  %.pre991 = load i32, ptr @commonAlloc2, align 4
  %cmp105 = icmp sgt i32 %27, %.pre991
  %or.cond1004 = select i1 %cmp102, i1 true, i1 %cmp105
  br i1 %or.cond1004, label %if.then107, label %lor.lhs.false104.if.end129_crit_edge

lor.lhs.false104.if.end129_crit_edge:             ; preds = %for.end101
  %.pre996 = load ptr, ptr @commonIP, align 8, !tbaa !5
  br label %if.end129

if.then107:                                       ; preds = %for.end101
  %tobool = icmp ne i32 %74, 0
  %tobool111 = icmp ne i32 %.pre991, 0
...
if.then112:                                       ; preds = %if.then107
  ...
  %.pre992 = load i32, ptr @partA__align.orlgth1, align 4
  %.pre993 = load i32, ptr @commonAlloc1, align 4
  %.pre994 = load i32, ptr @partA__align.orlgth2, align 4
  %.pre995 = load i32, ptr @commonAlloc2, align 4
  br label %if.end113

if.end113:                                        ; preds = %if.then112, %if.then107
  %76 = phi i32 [ %.pre995, %if.then112 ], [ %.pre991, %if.then107 ]
  %77 = phi i32 [ %.pre994, %if.then112 ], [ %27, %if.then107 ]
  %78 = phi i32 [ %.pre993, %if.then112 ], [ %74, %if.then107 ]
  %79 = phi i32 [ %.pre992, %if.then112 ], [ %28, %if.then107 ]
...
if.end129:                                        ; preds = %lor.lhs.false104.if.end129_crit_edge, %if.end113
  %80 = phi ptr [ %.pre996, %lor.lhs.false104.if.end129_crit_edge ], [ %call128, %if.end113 ]
...
if.end132:                                        ; preds = %if.else, %if.then131
  %cmp134866 = icmp sgt i32 %conv4, 0
  br i1 %cmp134866, label %for.body136.lr.ph, label %for.cond160.preheader
...
for.body136.lr.ph:                                ; preds = %if.end132
  ...
  %wide.trip.count927 = and i64 %call3, 4294967295
  %min.iters.check1027 = icmp ult i64 %wide.trip.count927, 4
  br i1 %min.iters.check1027, label %for.body136.preheader, label %vector.memcheck1023

vector.memcheck1023:                              ; preds = %for.body136.lr.ph
  %92 = shl nuw nsw i64 %wide.trip.count927, 2
  %scevgep = getelementptr i8, ptr %90, i64 %92
  %scevgep1024 = getelementptr i8, ptr %91, i64 %92
  %bound0 = icmp ult ptr %90, %scevgep1024
  %bound1 = icmp ult ptr %91, %scevgep
  %found.conflict = and i1 %bound0, %bound1
  br i1 %found.conflict, label %for.body136.preheader, label %vector.ph1028

vector.ph1028:                                    ; preds = %vector.memcheck1023
  %n.mod.vf1029 = and i64 %call3, 3
  %n.vec1030 = sub nsw i64 %wide.trip.count927, %n.mod.vf1029
...
vector.body1033:                                  ; preds = %vector.body1033, %vector.ph1028
  %index1034 = phi i64 [ 0, %vector.ph1028 ], [ %index.next1037, %vector.body1033 ]
  %93 = getelementptr inbounds float, ptr %90, i64 %index1034
  %wide.load1035 = load <4 x float>, ptr %93, align 4, !tbaa !9, !alias.scope !60, !noalias !63
  %94 = fpext <4 x float> %wide.load1035 to <4 x double>
  ...
  %99 = getelementptr inbounds float, ptr %91, i64 %index1034
  %wide.load1036 = load <4 x float>, ptr %99, align 4, !tbaa !9, !alias.scope !63
  %100 = fpext <4 x float> %wide.load1036 to <4 x double>
  ...
  %index.next1037 = add nuw i64 %index1034, 4
  %105 = icmp eq i64 %index.next1037, %n.vec1030
  br i1 %105, label %middle.block1025, label %vector.body1033, !llvm.loop !65

middle.block1025:                                 ; preds = %vector.body1033
  %cmp.n1032 = icmp eq i64 %n.mod.vf1029, 0
  br i1 %cmp.n1032, label %for.cond160.preheader, label %for.body136.preheader

for.body136.preheader:                            ; preds = %vector.memcheck1023, %for.body136.lr.ph, %middle.block1025
  %indvars.iv924.ph = phi i64 [ 0, %vector.memcheck1023 ], [ 0, %for.body136.lr.ph ], [ %n.vec1030, %middle.block1025 ]
  br label %for.body136

for.cond160.preheader:                            ; preds = %for.body136, %middle.block1025, %if.end132
  %cmp161868 = icmp sgt i32 %conv7, 0
  br i1 %cmp161868, label %for.body163.lr.ph, label %for.end186
...
for.body163.lr.ph:                                ; preds = %for.cond160.preheader
  ...
  %wide.trip.count932 = and i64 %call6, 4294967295
  %min.iters.check1046 = icmp ult i64 %wide.trip.count932, 4
  br i1 %min.iters.check1046, label %for.body163.preheader, label %vector.memcheck1038

vector.memcheck1038:                              ; preds = %for.body163.lr.ph
  %108 = shl nuw nsw i64 %wide.trip.count932, 2
  %scevgep1039 = getelementptr i8, ptr %106, i64 %108
  %scevgep1040 = getelementptr i8, ptr %107, i64 %108
  %bound01041 = icmp ult ptr %106, %scevgep1040
  %bound11042 = icmp ult ptr %107, %scevgep1039
  %found.conflict1043 = and i1 %bound01041, %bound11042
  br i1 %found.conflict1043, label %for.body163.preheader, label %vector.ph1047

vector.ph1047:                                    ; preds = %vector.memcheck1038
  %n.mod.vf1048 = and i64 %call6, 3
  %n.vec1049 = sub nsw i64 %wide.trip.count932, %n.mod.vf1048
  %broadcast.splatinsert1055 = insertelement <4 x double> poison, double %conv169, i64 0
...
vector.body1052:                                  ; preds = %vector.body1052, %vector.ph1047
  %index1053 = phi i64 [ 0, %vector.ph1047 ], [ %index.next1058, %vector.body1052 ]
  %109 = getelementptr inbounds float, ptr %106, i64 %index1053
  %wide.load1054 = load <4 x float>, ptr %109, align 4, !tbaa !9, !alias.scope !66, !noalias !69
  %110 = fpext <4 x float> %wide.load1054 to <4 x double>
  ...
  %113 = fmul <4 x double> %112, %broadcast.splat1056
  %114 = fptrunc <4 x double> %113 to <4 x float>
  store <4 x float> %114, ptr %109, align 4, !tbaa !9, !alias.scope !66, !noalias !69
  %115 = getelementptr inbounds float, ptr %107, i64 %index1053
  %wide.load1057 = load <4 x float>, ptr %115, align 4, !tbaa !9, !alias.scope !69
  %116 = fpext <4 x float> %wide.load1057 to <4 x double>
  ...
  %119 = fmul <4 x double> %118, %broadcast.splat1056
  %120 = fptrunc <4 x double> %119 to <4 x float>
  store <4 x float> %120, ptr %115, align 4, !tbaa !9, !alias.scope !69
  %index.next1058 = add nuw i64 %index1053, 4
  %121 = icmp eq i64 %index.next1058, %n.vec1049
  br i1 %121, label %middle.block1044, label %vector.body1052, !llvm.loop !71

middle.block1044:                                 ; preds = %vector.body1052
  %cmp.n1051 = icmp eq i64 %n.mod.vf1048, 0
  br i1 %cmp.n1051, label %for.end186, label %for.body163.preheader

for.body163.preheader:                            ; preds = %vector.memcheck1038, %for.body163.lr.ph, %middle.block1044
  %indvars.iv929.ph = phi i64 [ 0, %vector.memcheck1038 ], [ 0, %for.body163.lr.ph ], [ %n.vec1049, %middle.block1044 ]
  br label %for.body163

for.body136:                                      ; preds = %for.body136.preheader, %for.body136
  %indvars.iv924 = phi i64 [ %indvars.iv.next925, %for.body136 ], [ %indvars.iv924.ph, %for.body136.preheader ]
  %arrayidx138 = getelementptr inbounds float, ptr %90, i64 %indvars.iv924
  ...
  %arrayidx148 = getelementptr inbounds float, ptr %91, i64 %indvars.iv924
  ...
  br i1 %exitcond928.not, label %for.cond160.preheader, label %for.body136, !llvm.loop !72

for.body163:                                      ; preds = %for.body163.preheader, %for.body163
  %indvars.iv929 = phi i64 [ %indvars.iv.next930, %for.body163 ], [ %indvars.iv929.ph, %for.body163.preheader ]
  %arrayidx165 = getelementptr inbounds float, ptr %106, i64 %indvars.iv929
  ...
  %arrayidx175 = getelementptr inbounds float, ptr %107, i64 %indvars.iv929
  ...
  br i1 %exitcond933.not, label %for.end186, label %for.body163, !llvm.loop !73

for.end186:                                       ; preds = %for.body163, %middle.block1044, %for.cond160.preheader
...
if.then188:                                       ; preds = %for.end186
  ...
  br i1 %cmp134866, label %for.body.lr.ph.i, label %if.end191
...
if.end191.loopexit.unr-lcssa:                     ; preds = %for.body.i, %for.body.lr.ph.i
  ...
  br i1 %lcmp.mod1265.not, label %if.end191, label %for.body.i.epil
...
if.end191:                                        ; preds = %for.body.i.epil, %if.end191.loopexit.unr-lcssa, %if.then188
  ...
  br i1 %cmp161868, label %for.body.lr.ph.i691, label %if.end196
...
for.body.lr.ph.i691.new:                          ; preds = %for.body.lr.ph.i691
  %unroll_iter1268 = sub nsw i64 %wide.trip.count.i690, %xtraiter1266
...
for.body.i701:                                    ; preds = %for.body.i701, %for.body.lr.ph.i691.new
  ...
  %niter1269 = phi i64 [ 0, %for.body.lr.ph.i691.new ], [ %niter1269.next.1, %for.body.i701 ]
  ...
  %niter1269.next.1 = add i64 %niter1269, 2
  %niter1269.ncmp.1 = icmp eq i64 %niter1269.next.1, %unroll_iter1268
  br i1 %niter1269.ncmp.1, label %if.end196.loopexit.unr-lcssa, label %for.body.i701, !llvm.loop !75
...
if.end196.loopexit.unr-lcssa:                     ; preds = %for.body.i701, %for.body.lr.ph.i691
  ...
  br i1 %lcmp.mod1267.not, label %if.end196, label %for.body.i701.epil
...
for.cond233.preheader:                            ; preds = %if.end196
  %cmp235.not870 = icmp slt i32 %conv7, 1
  br i1 %cmp235.not870, label %for.cond248.preheader, label %for.body237.lr.ph

for.body237.lr.ph:                                ; preds = %for.cond233.preheader
  %171 = load i32, ptr @offset, align 4, !tbaa !11
  %172 = add i64 %call6, 1
  %wide.trip.count937 = and i64 %172, 4294967295
  %173 = add nsw i64 %wide.trip.count937, -1
  %min.iters.check1061 = icmp ult i64 %173, 4
  br i1 %min.iters.check1061, label %for.body237.preheader, label %vector.ph1062

vector.ph1062:                                    ; preds = %for.body237.lr.ph
  %n.vec1064 = and i64 %173, -4
  %ind.end = or i64 %n.vec1064, 1
  %broadcast.splatinsert1069 = insertelement <4 x i32> poison, i32 %171, i64 0
...
vector.body1067:                                  ; preds = %vector.body1067, %vector.ph1062
  %index1068 = phi i64 [ 0, %vector.ph1062 ], [ %index.next1072, %vector.body1067 ]
  %vec.ind = phi <4 x i32> [ <i32 1, i32 2, i32 3, i32 4>, %vector.ph1062 ], [ %vec.ind.next, %vector.body1067 ]
  %offset.idx = or i64 %index1068, 1
  %174 = mul nsw <4 x i32> %broadcast.splat1070, %vec.ind
  ...
  %wide.load1071 = load <4 x float>, ptr %177, align 4, !tbaa !9
  %178 = fpext <4 x float> %wide.load1071 to <4 x double>
  %179 = fsub <4 x double> %178, %176
  %180 = fptrunc <4 x double> %179 to <4 x float>
  store <4 x float> %180, ptr %177, align 4, !tbaa !9
  %index.next1072 = add nuw i64 %index1068, 4
  %vec.ind.next = add <4 x i32> %vec.ind, <i32 4, i32 4, i32 4, i32 4>
  %181 = icmp eq i64 %index.next1072, %n.vec1064
  br i1 %181, label %middle.block1059, label %vector.body1067, !llvm.loop !76

middle.block1059:                                 ; preds = %vector.body1067
  %cmp.n1066 = icmp eq i64 %173, %n.vec1064
  br i1 %cmp.n1066, label %for.cond248.preheader, label %for.body237.preheader

for.body237.preheader:                            ; preds = %for.body237.lr.ph, %middle.block1059
  %indvars.iv934.ph = phi i64 [ 1, %for.body237.lr.ph ], [ %ind.end, %middle.block1059 ]
  br label %for.body237

for.cond200.preheader:                            ; preds = %if.end196
  %cmp202.not874 = icmp slt i32 %conv4, 1
  br i1 %cmp202.not874, label %for.cond216.preheader, label %for.body204.lr.ph
...
for.body204.lr.ph:                                ; preds = %for.cond200.preheader
  ...
  %185 = add i64 %call3, 1
  %wide.trip.count948 = and i64 %185, 4294967295
  %186 = add nsw i64 %wide.trip.count948, -1
  %min.iters.check1104 = icmp ult i64 %186, 12
  br i1 %min.iters.check1104, label %for.body204.preheader, label %vector.memcheck1091

vector.memcheck1091:                              ; preds = %for.body204.lr.ph
  %scevgep1092 = getelementptr i8, ptr %184, i64 4
  %187 = shl nuw nsw i64 %wide.trip.count948, 2
  %scevgep1093 = getelementptr i8, ptr %184, i64 %187
  %188 = add nsw i64 %187, -4
  %scevgep1095 = getelementptr i8, ptr %183, i64 %188
  %bound01096 = icmp ult ptr %184, %182
  %bound11097 = icmp ult ptr %182, %scevgep1093
  %found.conflict1098 = and i1 %bound01096, %bound11097
  %bound01099 = icmp ult ptr %scevgep1092, %scevgep1095
  %bound11100 = icmp ult ptr %183, %scevgep1093
  %found.conflict1101 = and i1 %bound01099, %bound11100
  %conflict.rdx = or i1 %found.conflict1098, %found.conflict1101
  br i1 %conflict.rdx, label %for.body204.preheader, label %vector.ph1105

vector.ph1105:                                    ; preds = %vector.memcheck1091
  %n.vec1107 = and i64 %186, -8
  %ind.end1108 = or i64 %n.vec1107, 1
  %189 = load float, ptr %182, align 4, !tbaa !9, !alias.scope !77
  %broadcast.splatinsert1118 = insertelement <4 x float> poison, float %189, i64 0
...
vector.body1111:                                  ; preds = %vector.body1111, %vector.ph1105
  %index1112 = phi i64 [ 0, %vector.ph1105 ], [ %index.next1122, %vector.body1111 ]
  %offset.idx1113 = or i64 %index1112, 1
  %190 = getelementptr inbounds float, ptr %183, i64 %index1112
  %wide.load1114 = load <4 x float>, ptr %190, align 4, !tbaa !9, !alias.scope !80
  %191 = getelementptr inbounds float, ptr %190, i64 4
  %wide.load1115 = load <4 x float>, ptr %191, align 4, !tbaa !9, !alias.scope !80
  %192 = fadd <4 x float> %broadcast.splat1119, %wide.load1114
  %193 = fadd <4 x float> %broadcast.splat1119, %wide.load1115
  %194 = getelementptr inbounds float, ptr %184, i64 %offset.idx1113
  %wide.load1120 = load <4 x float>, ptr %194, align 4, !tbaa !9, !alias.scope !82, !noalias !84
  %195 = getelementptr inbounds float, ptr %194, i64 4
  %wide.load1121 = load <4 x float>, ptr %195, align 4, !tbaa !9, !alias.scope !82, !noalias !84
  %196 = fadd <4 x float> %192, %wide.load1120
  %197 = fadd <4 x float> %193, %wide.load1121
  ...
  %index.next1122 = add nuw i64 %index1112, 8
  %198 = icmp eq i64 %index.next1122, %n.vec1107
  br i1 %198, label %middle.block1102, label %vector.body1111, !llvm.loop !85

middle.block1102:                                 ; preds = %vector.body1111
  %cmp.n1110 = icmp eq i64 %186, %n.vec1107
  br i1 %cmp.n1110, label %for.cond216.preheader, label %for.body204.preheader

for.body204.preheader:                            ; preds = %vector.memcheck1091, %for.body204.lr.ph, %middle.block1102
  %indvars.iv944.ph = phi i64 [ 1, %vector.memcheck1091 ], [ 1, %for.body204.lr.ph ], [ %ind.end1108, %middle.block1102 ]
  %.neg1392 = add nsw i64 %indvars.iv944.ph, 1
  %xtraiter1270 = and i64 %call3, 1
  %lcmp.mod1271.not = icmp eq i64 %xtraiter1270, 0
  br i1 %lcmp.mod1271.not, label %for.body204.prol.loopexit, label %for.body204.prol

for.body204.prol:                                 ; preds = %for.body204.preheader
  %199 = load float, ptr %182, align 4, !tbaa !9
  %200 = add nsw i64 %indvars.iv944.ph, -1
  ...
  %arrayidx211.prol = getelementptr inbounds float, ptr %184, i64 %indvars.iv944.ph
  ...
  %indvars.iv.next945.prol = add nuw nsw i64 %indvars.iv944.ph, 1
  br label %for.body204.prol.loopexit

for.body204.prol.loopexit:                        ; preds = %for.body204.prol, %for.body204.preheader
  %indvars.iv944.unr = phi i64 [ %indvars.iv944.ph, %for.body204.preheader ], [ %indvars.iv.next945.prol, %for.body204.prol ]
  %203 = icmp eq i64 %wide.trip.count948, %.neg1392
  br i1 %203, label %for.cond216.preheader, label %for.body204

for.cond216.preheader:                            ; preds = %for.body204.prol.loopexit, %for.body204, %middle.block1102, %for.cond200.preheader
  %cmp218.not876 = icmp slt i32 %conv7, 1
  br i1 %cmp218.not876, label %for.end281, label %for.body220.lr.ph
...
for.body220.lr.ph:                                ; preds = %for.cond216.preheader
  ...
  %206 = add i64 %call6, 1
  %wide.trip.count954 = and i64 %206, 4294967295
  %207 = add nsw i64 %wide.trip.count954, -1
  %min.iters.check1137 = icmp ult i64 %207, 12
  br i1 %min.iters.check1137, label %for.body220.preheader, label %vector.memcheck1123

vector.memcheck1123:                              ; preds = %for.body220.lr.ph
  %scevgep1124 = getelementptr i8, ptr %126, i64 4
  %208 = shl nuw nsw i64 %wide.trip.count954, 2
  %scevgep1125 = getelementptr i8, ptr %126, i64 %208
  %209 = add nsw i64 %208, -4
  %scevgep1127 = getelementptr i8, ptr %205, i64 %209
  %bound01128 = icmp ult ptr %126, %204
  %bound11129 = icmp ult ptr %204, %scevgep1125
  %found.conflict1130 = and i1 %bound01128, %bound11129
  %bound01131 = icmp ult ptr %scevgep1124, %scevgep1127
  %bound11132 = icmp ult ptr %205, %scevgep1125
  %found.conflict1133 = and i1 %bound01131, %bound11132
  %conflict.rdx1134 = or i1 %found.conflict1130, %found.conflict1133
  br i1 %conflict.rdx1134, label %for.body220.preheader, label %vector.ph1138

vector.ph1138:                                    ; preds = %vector.memcheck1123
  %n.vec1140 = and i64 %207, -8
  %ind.end1141 = or i64 %n.vec1140, 1
  %210 = load float, ptr %204, align 4, !tbaa !9, !alias.scope !86
  %broadcast.splatinsert1151 = insertelement <4 x float> poison, float %210, i64 0
  %broadcast.splat1152 = shufflevector <4 x float> %broadcast.splatinsert1151, <4 x float> poison, <4 x i32> zeroinitializer
  br label %vector.body1144

vector.body1144:                                  ; preds = %vector.body1144, %vector.ph1138
  %index1145 = phi i64 [ 0, %vector.ph1138 ], [ %index.next1155, %vector.body1144 ]
  %offset.idx1146 = or i64 %index1145, 1
  %211 = getelementptr inbounds float, ptr %205, i64 %index1145
  %wide.load1147 = load <4 x float>, ptr %211, align 4, !tbaa !9, !alias.scope !89
  %212 = getelementptr inbounds float, ptr %211, i64 4
  %wide.load1148 = load <4 x float>, ptr %212, align 4, !tbaa !9, !alias.scope !89
  %213 = fadd <4 x float> %broadcast.splat1152, %wide.load1147
  %214 = fadd <4 x float> %broadcast.splat1152, %wide.load1148
  %215 = getelementptr inbounds float, ptr %126, i64 %offset.idx1146
  %wide.load1153 = load <4 x float>, ptr %215, align 4, !tbaa !9, !alias.scope !91, !noalias !93
  %216 = getelementptr inbounds float, ptr %215, i64 4
  %wide.load1154 = load <4 x float>, ptr %216, align 4, !tbaa !9, !alias.scope !91, !noalias !93
  %217 = fadd <4 x float> %wide.load1153, %213
  %218 = fadd <4 x float> %wide.load1154, %214
  ...
  %index.next1155 = add nuw i64 %index1145, 8
  %219 = icmp eq i64 %index.next1155, %n.vec1140
  br i1 %219, label %middle.block1135, label %vector.body1144, !llvm.loop !94

middle.block1135:                                 ; preds = %vector.body1144
  %cmp.n1143 = icmp eq i64 %207, %n.vec1140
  br i1 %cmp.n1143, label %if.end264, label %for.body220.preheader

for.body220.preheader:                            ; preds = %vector.memcheck1123, %for.body220.lr.ph, %middle.block1135
  %indvars.iv950.ph = phi i64 [ 1, %vector.memcheck1123 ], [ 1, %for.body220.lr.ph ], [ %ind.end1141, %middle.block1135 ]
  %.neg1393 = add nsw i64 %indvars.iv950.ph, 1
  %xtraiter1273 = and i64 %call6, 1
  %lcmp.mod1274.not = icmp eq i64 %xtraiter1273, 0
  br i1 %lcmp.mod1274.not, label %for.body220.prol.loopexit, label %for.body220.prol

for.body220.prol:                                 ; preds = %for.body220.preheader
  %220 = load float, ptr %204, align 4, !tbaa !9
  %221 = add nsw i64 %indvars.iv950.ph, -1
  ...
  %arrayidx227.prol = getelementptr inbounds float, ptr %126, i64 %indvars.iv950.ph
  ...
  %indvars.iv.next951.prol = add nuw nsw i64 %indvars.iv950.ph, 1
  br label %for.body220.prol.loopexit

for.body220.prol.loopexit:                        ; preds = %for.body220.prol, %for.body220.preheader
  %indvars.iv950.unr = phi i64 [ %indvars.iv950.ph, %for.body220.preheader ], [ %indvars.iv.next951.prol, %for.body220.prol ]
  %224 = icmp eq i64 %wide.trip.count954, %.neg1393
  br i1 %224, label %if.end264, label %for.body220

for.body204:                                      ; preds = %for.body204.prol.loopexit, %for.body204
  %indvars.iv944 = phi i64 [ %indvars.iv.next945.1, %for.body204 ], [ %indvars.iv944.unr, %for.body204.prol.loopexit ]
  %225 = load float, ptr %182, align 4, !tbaa !9
  %226 = add nsw i64 %indvars.iv944, -1
  ...
  %arrayidx211 = getelementptr inbounds float, ptr %184, i64 %indvars.iv944
  ...
  %arrayidx208.1 = getelementptr inbounds float, ptr %183, i64 %indvars.iv944
  %230 = load float, ptr %arrayidx208.1, align 4, !tbaa !9
  %add209.1 = fadd float %229, %230
  %arrayidx211.1 = getelementptr inbounds float, ptr %184, i64 %indvars.iv.next945
  ...
  %indvars.iv.next945.1 = add nuw nsw i64 %indvars.iv944, 2
  %exitcond949.not.1 = icmp eq i64 %indvars.iv.next945.1, %wide.trip.count948
  br i1 %exitcond949.not.1, label %for.cond216.preheader, label %for.body204, !llvm.loop !95

for.body220:                                      ; preds = %for.body220.prol.loopexit, %for.body220
  %indvars.iv950 = phi i64 [ %indvars.iv.next951.1, %for.body220 ], [ %indvars.iv950.unr, %for.body220.prol.loopexit ]
  %232 = load float, ptr %204, align 4, !tbaa !9
  %233 = add nsw i64 %indvars.iv950, -1
  ...
  %arrayidx227 = getelementptr inbounds float, ptr %126, i64 %indvars.iv950
  ...
  %arrayidx224.1 = getelementptr inbounds float, ptr %205, i64 %indvars.iv950
  %237 = load float, ptr %arrayidx224.1, align 4, !tbaa !9
  %add225.1 = fadd float %236, %237
  %arrayidx227.1 = getelementptr inbounds float, ptr %126, i64 %indvars.iv.next951
  ...
  %indvars.iv.next951.1 = add nuw nsw i64 %indvars.iv950, 2
  %exitcond955.not.1 = icmp eq i64 %indvars.iv.next951.1, %wide.trip.count954
  br i1 %exitcond955.not.1, label %if.end264, label %for.body220, !llvm.loop !96

for.cond248.preheader:                            ; preds = %for.body237, %middle.block1059, %for.cond233.preheader
  %cmp250.not872 = icmp slt i32 %conv4, 1
  br i1 %cmp250.not872, label %if.end264, label %for.body252.lr.ph
...
for.body252.lr.ph:                                ; preds = %for.cond248.preheader
  ...
  %241 = add i64 %call3, 1
  %wide.trip.count942 = and i64 %241, 4294967295
  %242 = add nsw i64 %wide.trip.count942, -1
  %min.iters.check1075 = icmp ult i64 %242, 4
  br i1 %min.iters.check1075, label %for.body252.preheader, label %vector.ph1076

vector.ph1076:                                    ; preds = %for.body252.lr.ph
  %n.vec1078 = and i64 %242, -4
  %ind.end1079 = or i64 %n.vec1078, 1
  %broadcast.splatinsert1087 = insertelement <4 x i32> poison, i32 %239, i64 0
...
vector.body1082:                                  ; preds = %vector.body1082, %vector.ph1076
  %index1083 = phi i64 [ 0, %vector.ph1076 ], [ %index.next1090, %vector.body1082 ]
  %vec.ind1084 = phi <4 x i32> [ <i32 1, i32 2, i32 3, i32 4>, %vector.ph1076 ], [ %vec.ind.next1085, %vector.body1082 ]
  %offset.idx1086 = or i64 %index1083, 1
  %243 = mul nsw <4 x i32> %broadcast.splat1088, %vec.ind1084
  ...
  %246 = getelementptr inbounds float, ptr %240, i64 %offset.idx1086
  %wide.load1089 = load <4 x float>, ptr %246, align 4, !tbaa !9
  %247 = fpext <4 x float> %wide.load1089 to <4 x double>
  %248 = fsub <4 x double> %247, %245
  %249 = fptrunc <4 x double> %248 to <4 x float>
  store <4 x float> %249, ptr %246, align 4, !tbaa !9
  %index.next1090 = add nuw i64 %index1083, 4
  %vec.ind.next1085 = add <4 x i32> %vec.ind1084, <i32 4, i32 4, i32 4, i32 4>
  %250 = icmp eq i64 %index.next1090, %n.vec1078
  br i1 %250, label %middle.block1073, label %vector.body1082, !llvm.loop !97

middle.block1073:                                 ; preds = %vector.body1082
  %cmp.n1081 = icmp eq i64 %242, %n.vec1078
  br i1 %cmp.n1081, label %if.end264, label %for.body252.preheader

for.body252.preheader:                            ; preds = %for.body252.lr.ph, %middle.block1073
  %indvars.iv939.ph = phi i64 [ 1, %for.body252.lr.ph ], [ %ind.end1079, %middle.block1073 ]
  br label %for.body252

for.body237:                                      ; preds = %for.body237.preheader, %for.body237
  %indvars.iv934 = phi i64 [ %indvars.iv.next935, %for.body237 ], [ %indvars.iv934.ph, %for.body237.preheader ]
  %251 = trunc i64 %indvars.iv934 to i32
  %mul238 = mul nsw i32 %171, %251
  %conv239 = sitofp i32 %mul238 to double
  %div = fmul double %conv239, 5.000000e-01
  %arrayidx241 = getelementptr inbounds float, ptr %126, i64 %indvars.iv934
  ...
  br i1 %exitcond938.not, label %for.cond248.preheader, label %for.body237, !llvm.loop !98

for.body252:                                      ; preds = %for.body252.preheader, %for.body252
  %indvars.iv939 = phi i64 [ %indvars.iv.next940, %for.body252 ], [ %indvars.iv939.ph, %for.body252.preheader ]
  %253 = trunc i64 %indvars.iv939 to i32
  %mul253 = mul nsw i32 %239, %253
  %conv254 = sitofp i32 %mul253 to double
  %div255 = fmul double %conv254, 5.000000e-01
  %arrayidx257 = getelementptr inbounds float, ptr %240, i64 %indvars.iv939
  ...
  br i1 %exitcond943.not, label %if.end264, label %for.body252, !llvm.loop !99

if.end264:                                        ; preds = %for.body252, %for.body220.prol.loopexit, %for.body220, %middle.block1073, %middle.block1135, %for.cond248.preheader
  %cmp267.not878 = icmp slt i32 %conv7, 1
  br i1 %cmp267.not878, label %for.end281, label %for.body269.lr.ph
...
for.body269.lr.ph:                                ; preds = %if.end264
  ...
  %258 = add i64 %call6, 1
  %wide.trip.count960 = and i64 %258, 4294967295
  %259 = add nsw i64 %wide.trip.count960, -1
  %min.iters.check1170 = icmp ult i64 %259, 12
  br i1 %min.iters.check1170, label %for.body269.preheader, label %vector.memcheck1156

vector.memcheck1156:                              ; preds = %for.body269.lr.ph
  %scevgep1157 = getelementptr i8, ptr %256, i64 4
  %260 = shl nuw nsw i64 %wide.trip.count960, 2
  %scevgep1158 = getelementptr i8, ptr %256, i64 %260
  %261 = add nsw i64 %260, -4
  %scevgep1159 = getelementptr i8, ptr %126, i64 %261
  %scevgep1160 = getelementptr i8, ptr %255, i64 8
  %bound01161 = icmp ult ptr %scevgep1157, %scevgep1159
  %bound11162 = icmp ult ptr %126, %scevgep1158
  %found.conflict1163 = and i1 %bound01161, %bound11162
  %bound01164 = icmp ult ptr %scevgep1157, %scevgep1160
  %bound11165 = icmp ult ptr %arrayidx273, %scevgep1158
  %found.conflict1166 = and i1 %bound01164, %bound11165
  %conflict.rdx1167 = or i1 %found.conflict1163, %found.conflict1166
  br i1 %conflict.rdx1167, label %for.body269.preheader, label %vector.ph1171

vector.ph1171:                                    ; preds = %vector.memcheck1156
  %n.vec1173 = and i64 %259, -8
  %ind.end1174 = or i64 %n.vec1173, 1
  %262 = load float, ptr %arrayidx273, align 4, !tbaa !9, !alias.scope !100
  %broadcast.splatinsert1184 = insertelement <4 x float> poison, float %262, i64 0
  %broadcast.splat1185 = shufflevector <4 x float> %broadcast.splatinsert1184, <4 x float> poison, <4 x i32> zeroinitializer
  br label %vector.body1177

vector.body1177:                                  ; preds = %vector.body1177, %vector.ph1171
  %index1178 = phi i64 [ 0, %vector.ph1171 ], [ %index.next1186, %vector.body1177 ]
  %offset.idx1179 = or i64 %index1178, 1
  %263 = getelementptr inbounds float, ptr %126, i64 %index1178
  %wide.load1180 = load <4 x float>, ptr %263, align 4, !tbaa !9, !alias.scope !103
  %264 = getelementptr inbounds float, ptr %263, i64 4
  %wide.load1181 = load <4 x float>, ptr %264, align 4, !tbaa !9, !alias.scope !103
  %265 = fadd <4 x float> %wide.load1180, %broadcast.splat1185
  %266 = fadd <4 x float> %wide.load1181, %broadcast.splat1185
  %267 = getelementptr inbounds float, ptr %256, i64 %offset.idx1179
  ...
  %269 = getelementptr inbounds i32, ptr %257, i64 %offset.idx1179
  ...
  %index.next1186 = add nuw i64 %index1178, 8
  %271 = icmp eq i64 %index.next1186, %n.vec1173
  br i1 %271, label %middle.block1168, label %vector.body1177, !llvm.loop !108

middle.block1168:                                 ; preds = %vector.body1177
  %cmp.n1176 = icmp eq i64 %259, %n.vec1173
  br i1 %cmp.n1176, label %for.end281.loopexit, label %for.body269.preheader

for.body269.preheader:                            ; preds = %vector.memcheck1156, %for.body269.lr.ph, %middle.block1168
  %indvars.iv956.ph = phi i64 [ 1, %vector.memcheck1156 ], [ 1, %for.body269.lr.ph ], [ %ind.end1174, %middle.block1168 ]
  %.neg = add nsw i64 %indvars.iv956.ph, 1
  %xtraiter1276 = and i64 %call6, 1
  %lcmp.mod1277.not = icmp eq i64 %xtraiter1276, 0
  br i1 %lcmp.mod1277.not, label %for.body269.prol.loopexit, label %for.body269.prol

for.body269.prol:                                 ; preds = %for.body269.preheader
  %272 = add nsw i64 %indvars.iv956.ph, -1
  ...
  %arrayidx276.prol = getelementptr inbounds float, ptr %256, i64 %indvars.iv956.ph
  store float %add274.prol, ptr %arrayidx276.prol, align 4, !tbaa !9
  %arrayidx278.prol = getelementptr inbounds i32, ptr %257, i64 %indvars.iv956.ph
  store i32 0, ptr %arrayidx278.prol, align 4, !tbaa !11
  %indvars.iv.next957.prol = add nuw nsw i64 %indvars.iv956.ph, 1
  br label %for.body269.prol.loopexit

for.body269.prol.loopexit:                        ; preds = %for.body269.prol, %for.body269.preheader
  %indvars.iv956.unr = phi i64 [ %indvars.iv956.ph, %for.body269.preheader ], [ %indvars.iv.next957.prol, %for.body269.prol ]
  %275 = icmp eq i64 %wide.trip.count960, %.neg
  br i1 %275, label %for.end281.loopexit, label %for.body269

for.body269:                                      ; preds = %for.body269.prol.loopexit, %for.body269
  %indvars.iv956 = phi i64 [ %indvars.iv.next957.1, %for.body269 ], [ %indvars.iv956.unr, %for.body269.prol.loopexit ]
  %276 = add nsw i64 %indvars.iv956, -1
  ...
  %arrayidx276 = getelementptr inbounds float, ptr %256, i64 %indvars.iv956
  store float %add274, ptr %arrayidx276, align 4, !tbaa !9
  %arrayidx278 = getelementptr inbounds i32, ptr %257, i64 %indvars.iv956
  store i32 0, ptr %arrayidx278, align 4, !tbaa !11
  %indvars.iv.next957 = add nuw nsw i64 %indvars.iv956, 1
  %arrayidx272.1 = getelementptr inbounds float, ptr %126, i64 %indvars.iv956
  %279 = load float, ptr %arrayidx272.1, align 4, !tbaa !9
  %280 = load float, ptr %arrayidx273, align 4, !tbaa !9
  %add274.1 = fadd float %279, %280
  %arrayidx276.1 = getelementptr inbounds float, ptr %256, i64 %indvars.iv.next957
  store float %add274.1, ptr %arrayidx276.1, align 4, !tbaa !9
  %arrayidx278.1 = getelementptr inbounds i32, ptr %257, i64 %indvars.iv.next957
  store i32 0, ptr %arrayidx278.1, align 4, !tbaa !11
  %indvars.iv.next957.1 = add nuw nsw i64 %indvars.iv956, 2
  %exitcond961.not.1 = icmp eq i64 %indvars.iv.next957.1, %wide.trip.count960
  br i1 %exitcond961.not.1, label %for.end281.loopexit, label %for.body269, !llvm.loop !109

for.end281.loopexit:                              ; preds = %for.body269.prol.loopexit, %for.body269, %middle.block1168
  %.pre997 = load i32, ptr @outgap, align 4, !tbaa !11
  br label %for.end281

for.end281:                                       ; preds = %for.cond216.preheader, %for.end281.loopexit, %if.end264
  %cmp267.not8781001 = phi i1 [ %cmp267.not878, %for.end281.loopexit ], [ true, %if.end264 ], [ true, %for.cond216.preheader ]
  %281 = phi i32 [ %.pre997, %for.end281.loopexit ], [ %170, %if.end264 ], [ %170, %for.cond216.preheader ]
  ...
  %cmp293900 = icmp sgt i32 %lasti.0, 1
  br i1 %cmp293900, label %for.body295.lr.ph, label %for.end369

for.body295.lr.ph:                                ; preds = %for.end281
  %or.cond859 = and i1 %tobool187.not, %cmp161868
  %wide.trip.count.i705 = and i64 %call6, 4294967295
  %wide.trip.count967 = zext i32 %lasti.0 to i64
  %.pre998 = load ptr, ptr @partA__align.initverticalw, align 8, !tbaa !5
  %xtraiter1279 = and i64 %call6, 1
  %284 = icmp eq i64 %wide.trip.count.i705, 1
  %unroll_iter1281 = sub nsw i64 %wide.trip.count.i705, %xtraiter1279
  %lcmp.mod1280.not = icmp eq i64 %xtraiter1279, 0
  br label %for.body295

for.body295:                                      ; preds = %for.body295.lr.ph, %for.end361
  %285 = phi ptr [ %.pre998, %for.body295.lr.ph ], [ %305, %for.end361 ]
  %indvars.iv963 = phi i64 [ 1, %for.body295.lr.ph ], [ %indvars.iv.next964, %for.end361 ]
  %wm.0903 = phi float [ 0.000000e+00, %for.body295.lr.ph ], [ %wm.1.lcssa, %for.end361 ]
  %currentw.0902 = phi ptr [ %126, %for.body295.lr.ph ], [ %previousw.0901, %for.end361 ]
  %previousw.0901 = phi ptr [ %127, %for.body295.lr.ph ], [ %currentw.0902, %for.end361 ]
  %286 = add nsw i64 %indvars.iv963, -1
  %arrayidx298 = getelementptr inbounds float, ptr %285, i64 %286
  %287 = load float, ptr %arrayidx298, align 4, !tbaa !9
  store float %287, ptr %currentw.0902, align 4, !tbaa !9
  ...
  %292 = trunc i64 %indvars.iv963 to i32
  tail call fastcc void @match_calc(ptr noundef %previousw.0901, ptr noundef %288, ptr noundef %289, i32 noundef %292, i32 noundef %conv7, ptr noundef %290, ptr noundef %291, i32 noundef 0)
  br i1 %or.cond859, label %for.body.lr.ph.i706, label %if.end305

for.body.lr.ph.i706:                              ; preds = %for.body295
  %arrayidx303 = getelementptr inbounds i32, ptr %gapmap1, i64 %indvars.iv963
...
for.body.i716:                                    ; preds = %for.body.lr.ph.i706, %for.body.i716
  ...
  %niter1282 = phi i64 [ %niter1282.next.1, %for.body.i716 ], [ 0, %for.body.lr.ph.i706 ]
  ...
  %arrayidx6.i712 = getelementptr inbounds float, ptr %previousw.0901, i64 %indvars.iv.i707
  ...
  %arrayidx6.i712.1 = getelementptr inbounds float, ptr %previousw.0901, i64 %indvars.iv.next.i714
  ...
  %niter1282.next.1 = add i64 %niter1282, 2
  %niter1282.ncmp.1 = icmp eq i64 %niter1282.next.1, %unroll_iter1281
  br i1 %niter1282.ncmp.1, label %if.end305.loopexit.unr-lcssa, label %for.body.i716, !llvm.loop !75
...
if.end305.loopexit.unr-lcssa:                     ; preds = %for.body.i716, %for.body.lr.ph.i706
  ...
  br i1 %lcmp.mod1280.not, label %if.end305, label %for.body.i716.epil
...
for.body.i716.epil:                               ; preds = %if.end305.loopexit.unr-lcssa
  ...
  %arrayidx6.i712.epil = getelementptr inbounds float, ptr %previousw.0901, i64 %indvars.iv.i707.unr
...
if.end305:                                        ; preds = %for.body.i716.epil, %if.end305.loopexit.unr-lcssa, %for.body295
  ...
  %arrayidx307 = getelementptr inbounds float, ptr %305, i64 %indvars.iv963
  %306 = load float, ptr %arrayidx307, align 4, !tbaa !9
  store float %306, ptr %previousw.0901, align 4, !tbaa !9
  ...
  %arrayidx322 = getelementptr inbounds float, ptr %309, i64 %indvars.iv963
  %310 = load float, ptr %arrayidx322, align 4, !tbaa !9
  br i1 %cmp267.not8781001, label %for.end361, label %for.body326.preheader

for.body326.preheader:                            ; preds = %if.end305
  %311 = load float, ptr %currentw.0902, align 4, !tbaa !9
  ...
  %arrayidx313 = getelementptr inbounds ptr, ptr %317, i64 %indvars.iv963
...
for.body326:                                      ; preds = %for.body326.preheader, %if.end351
  %ijppt.0899.pn = phi ptr [ %ijppt.0899, %if.end351 ], [ %318, %for.body326.preheader ]
  %mjpt.0898.pn = phi ptr [ %mjpt.0898, %if.end351 ], [ %316, %for.body326.preheader ]
  %mpjpt.0897.pn = phi ptr [ %mpjpt.0897, %if.end351 ], [ %315, %for.body326.preheader ]
  %curpt.0896.pn = phi ptr [ %curpt.0896, %if.end351 ], [ %previousw.0901, %for.body326.preheader ]
  %ogcp2pt.0895.pn = phi ptr [ %ogcp2pt.0895, %if.end351 ], [ %312, %for.body326.preheader ]
  %j.4894 = phi i32 [ %inc360, %if.end351 ], [ 1, %for.body326.preheader ]
  %fgcp2pt.0893 = phi ptr [ %incdec.ptr357, %if.end351 ], [ %314, %for.body326.preheader ]
  %prept.0892 = phi ptr [ %incdec.ptr354, %if.end351 ], [ %currentw.0902, %for.body326.preheader ]
  %add334881891 = phi float [ %add334880, %if.end351 ], [ %add311, %for.body326.preheader ]
  %sub338883890 = phi i32 [ %sub338882, %if.end351 ], [ 0, %for.body326.preheader ]
  %ogcp2pt.0895 = getelementptr inbounds float, ptr %ogcp2pt.0895.pn, i64 1
  %curpt.0896 = getelementptr inbounds float, ptr %curpt.0896.pn, i64 1
  %mpjpt.0897 = getelementptr inbounds i32, ptr %mpjpt.0897.pn, i64 1
  %mjpt.0898 = getelementptr inbounds float, ptr %mjpt.0898.pn, i64 1
  %ijppt.0899 = getelementptr inbounds i32, ptr %ijppt.0899.pn, i64 1
  %320 = load float, ptr %prept.0892, align 4, !tbaa !9
  store i32 0, ptr %ijppt.0899, align 4, !tbaa !11
  %321 = load float, ptr %fgcp2pt.0893, align 4, !tbaa !9
  %add327 = fadd float %add334881891, %321
  %cmp328 = fcmp ogt float %add327, %320
  br i1 %cmp328, label %if.then330, label %if.end333

if.then330:                                       ; preds = %for.body326
  %sub331.neg = sub i32 %sub338883890, %j.4894
  store i32 %sub331.neg, ptr %ijppt.0899, align 4, !tbaa !11
  br label %if.end333

if.end333:                                        ; preds = %if.then330, %for.body326
  %wm.2 = phi float [ %add327, %if.then330 ], [ %320, %for.body326 ]
  %322 = load float, ptr %ogcp2pt.0895, align 4, !tbaa !9
  %add334 = fadd float %320, %322
  %cmp335 = fcmp ult float %add334, %add334881891
  %sub338 = add nsw i32 %j.4894, -1
  %sub338882 = select i1 %cmp335, i32 %sub338883890, i32 %sub338
  %add334880 = select i1 %cmp335, float %add334881891, float %add334
  %323 = load float, ptr %mjpt.0898, align 4, !tbaa !9
...
if.then343:                                       ; preds = %if.end333
  %324 = load i32, ptr %mpjpt.0897, align 4, !tbaa !11
  %sub344 = sub nsw i32 %292, %324
  store i32 %sub344, ptr %ijppt.0899, align 4, !tbaa !11
  br label %if.end345
...
if.then349:                                       ; preds = %if.end345
  store float %add346, ptr %mjpt.0898, align 4, !tbaa !9
  store i32 %319, ptr %mpjpt.0897, align 4, !tbaa !11
  br label %if.end351

if.end351:                                        ; preds = %if.then349, %if.end345
  %325 = load float, ptr %curpt.0896, align 4, !tbaa !9
  %add352 = fadd float %wm.3, %325
  store float %add352, ptr %curpt.0896, align 4, !tbaa !9
  %incdec.ptr354 = getelementptr inbounds float, ptr %prept.0892, i64 1
  %incdec.ptr357 = getelementptr inbounds float, ptr %fgcp2pt.0893, i64 1
  %inc360 = add nuw i32 %j.4894, 1
  %exitcond962.not = icmp eq i32 %j.4894, %conv7
  br i1 %exitcond962.not, label %for.end361, label %for.body326, !llvm.loop !110

for.end361:                                       ; preds = %if.end351, %if.end305
  %wm.1.lcssa = phi float [ %wm.0903, %if.end305 ], [ %wm.3, %if.end351 ]
  %arrayidx364 = getelementptr inbounds float, ptr %previousw.0901, i64 %idxprom283
  %326 = load float, ptr %arrayidx364, align 4, !tbaa !9
  %327 = load ptr, ptr @partA__align.lastverticalw, align 8, !tbaa !5
  %arrayidx366 = getelementptr inbounds float, ptr %327, i64 %indvars.iv963
  ...
  br i1 %exitcond968.not, label %for.end369.loopexit, label %for.body295, !llvm.loop !111

for.end369.loopexit:                              ; preds = %for.end361
  %.pre999 = load i32, ptr @outgap, align 4, !tbaa !11
  br label %for.end369

for.end369:                                       ; preds = %for.end369.loopexit, %for.end281
  %328 = phi ptr [ %283, %for.end281 ], [ %327, %for.end369.loopexit ]
  %329 = phi i32 [ %281, %for.end281 ], [ %.pre999, %for.end369.loopexit ]
  %currentw.0.lcssa = phi ptr [ %126, %for.end281 ], [ %previousw.0901, %for.end369.loopexit ]
...
for.cond372.preheader:                            ; preds = %for.end369
  br i1 %cmp267.not8781001, label %for.cond389.preheader, label %for.body376.lr.ph

for.body376.lr.ph:                                ; preds = %for.cond372.preheader
  %330 = load i32, ptr @offset, align 4, !tbaa !11
  %331 = add i64 %call6, 1
  %wide.trip.count972 = and i64 %331, 4294967295
  %332 = add nsw i64 %wide.trip.count972, -1
  %min.iters.check1189 = icmp ult i64 %332, 4
  br i1 %min.iters.check1189, label %for.body376.preheader, label %vector.ph1190

vector.ph1190:                                    ; preds = %for.body376.lr.ph
  %n.vec1192 = and i64 %332, -4
  %ind.end1193 = or i64 %n.vec1192, 1
  %broadcast.splatinsert1201 = insertelement <4 x i32> poison, i32 %conv7, i64 0
  %broadcast.splat1202 = shufflevector <4 x i32> %broadcast.splatinsert1201, <4 x i32> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1203 = insertelement <4 x i32> poison, i32 %330, i64 0
...
vector.body1196:                                  ; preds = %vector.body1196, %vector.ph1190
  %index1197 = phi i64 [ 0, %vector.ph1190 ], [ %index.next1206, %vector.body1196 ]
  %vec.ind1198 = phi <4 x i32> [ <i32 1, i32 2, i32 3, i32 4>, %vector.ph1190 ], [ %vec.ind.next1199, %vector.body1196 ]
  %offset.idx1200 = or i64 %index1197, 1
  %333 = sub nsw <4 x i32> %broadcast.splat1202, %vec.ind1198
  %334 = mul nsw <4 x i32> %broadcast.splat1204, %333
  ...
  %337 = getelementptr inbounds float, ptr %currentw.0.lcssa, i64 %offset.idx1200
  %wide.load1205 = load <4 x float>, ptr %337, align 4, !tbaa !9
  %338 = fpext <4 x float> %wide.load1205 to <4 x double>
  %339 = fsub <4 x double> %338, %336
  %340 = fptrunc <4 x double> %339 to <4 x float>
  store <4 x float> %340, ptr %337, align 4, !tbaa !9
  %index.next1206 = add nuw i64 %index1197, 4
  %vec.ind.next1199 = add <4 x i32> %vec.ind1198, <i32 4, i32 4, i32 4, i32 4>
  %341 = icmp eq i64 %index.next1206, %n.vec1192
  br i1 %341, label %middle.block1187, label %vector.body1196, !llvm.loop !112

middle.block1187:                                 ; preds = %vector.body1196
  %cmp.n1195 = icmp eq i64 %332, %n.vec1192
  br i1 %cmp.n1195, label %for.cond389.preheader, label %for.body376.preheader

for.body376.preheader:                            ; preds = %for.body376.lr.ph, %middle.block1187
  %indvars.iv969.ph = phi i64 [ 1, %for.body376.lr.ph ], [ %ind.end1193, %middle.block1187 ]
  br label %for.body376

for.cond389.preheader:                            ; preds = %for.body376, %middle.block1187, %for.cond372.preheader
  %cmp391.not909 = icmp slt i32 %conv4, 1
  br i1 %cmp391.not909, label %if.end407, label %for.body393.lr.ph
...
for.body393.lr.ph:                                ; preds = %for.cond389.preheader
  ...
  %343 = add i64 %call3, 1
  %wide.trip.count977 = and i64 %343, 4294967295
  %344 = add nsw i64 %wide.trip.count977, -1
  %min.iters.check1209 = icmp ult i64 %344, 4
  br i1 %min.iters.check1209, label %for.body393.preheader, label %vector.ph1210

vector.ph1210:                                    ; preds = %for.body393.lr.ph
  %n.vec1212 = and i64 %344, -4
  %ind.end1213 = or i64 %n.vec1212, 1
  %broadcast.splatinsert1221 = insertelement <4 x double> poison, double %conv395, i64 0
  %broadcast.splat1222 = shufflevector <4 x double> %broadcast.splatinsert1221, <4 x double> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1224 = insertelement <4 x double> poison, double %neg, i64 0
...
vector.body1216:                                  ; preds = %vector.body1216, %vector.ph1210
  %index1217 = phi i64 [ 0, %vector.ph1210 ], [ %index.next1226, %vector.body1216 ]
  %vec.ind1218 = phi <4 x i32> [ <i32 1, i32 2, i32 3, i32 4>, %vector.ph1210 ], [ %vec.ind.next1219, %vector.body1216 ]
  %offset.idx1220 = or i64 %index1217, 1
  %345 = sitofp <4 x i32> %vec.ind1218 to <4 x double>
  %346 = fmul <4 x double> %345, <double 5.000000e-01, double 5.000000e-01, double 5.000000e-01, double 5.000000e-01>
  %347 = fsub <4 x double> %broadcast.splat1222, %346
  %348 = getelementptr inbounds float, ptr %328, i64 %offset.idx1220
  %wide.load1223 = load <4 x float>, ptr %348, align 4, !tbaa !9
  %349 = fpext <4 x float> %wide.load1223 to <4 x double>
  %350 = tail call <4 x double> @llvm.fmuladd.v4f64(<4 x double> %broadcast.splat1225, <4 x double> %347, <4 x double> %349)
  %351 = fptrunc <4 x double> %350 to <4 x float>
  store <4 x float> %351, ptr %348, align 4, !tbaa !9
  %index.next1226 = add nuw i64 %index1217, 4
  %vec.ind.next1219 = add <4 x i32> %vec.ind1218, <i32 4, i32 4, i32 4, i32 4>
  %352 = icmp eq i64 %index.next1226, %n.vec1212
  br i1 %352, label %middle.block1207, label %vector.body1216, !llvm.loop !113

middle.block1207:                                 ; preds = %vector.body1216
  %cmp.n1215 = icmp eq i64 %344, %n.vec1212
  br i1 %cmp.n1215, label %if.end407, label %for.body393.preheader

for.body393.preheader:                            ; preds = %for.body393.lr.ph, %middle.block1207
  %indvars.iv974.ph = phi i64 [ 1, %for.body393.lr.ph ], [ %ind.end1213, %middle.block1207 ]
  br label %for.body393

for.body376:                                      ; preds = %for.body376.preheader, %for.body376
  %indvars.iv969 = phi i64 [ %indvars.iv.next970, %for.body376 ], [ %indvars.iv969.ph, %for.body376.preheader ]
  %353 = trunc i64 %indvars.iv969 to i32
  ...
  %arrayidx382 = getelementptr inbounds float, ptr %currentw.0.lcssa, i64 %indvars.iv969
  ...
  br i1 %exitcond973.not, label %for.cond389.preheader, label %for.body376, !llvm.loop !114

for.body393:                                      ; preds = %for.body393.preheader, %for.body393
  %indvars.iv974 = phi i64 [ %indvars.iv.next975, %for.body393 ], [ %indvars.iv974.ph, %for.body393.preheader ]
  %355 = trunc i64 %indvars.iv974 to i32
  %conv396 = sitofp i32 %355 to double
  %div397 = fmul double %conv396, 5.000000e-01
  %sub398 = fsub double %conv395, %div397
  %arrayidx401 = getelementptr inbounds float, ptr %328, i64 %indvars.iv974
  ...
  br i1 %exitcond978.not, label %if.end407, label %for.body393, !llvm.loop !115

if.end407:                                        ; preds = %for.body393, %middle.block1207, %for.cond389.preheader, %for.end369
...
for.body.lr.ph.i719.new:                          ; preds = %for.body.lr.ph.i719
  %unroll_iter1340 = sub nsw i64 %wide.trip.count.i718, %xtraiter1336
...
for.cond19.preheader.i.loopexit.unr-lcssa:        ; preds = %for.inc.i.1, %for.body.lr.ph.i719
  ...
  br i1 %lcmp.mod1338.not, label %for.cond19.preheader.i, label %for.body.i721.epil
...
for.body22.lr.ph.i:                               ; preds = %for.cond19.preheader.i
  ...
  %xtraiter1342 = and i64 %call2.i, 1
...
for.body22.lr.ph.i.new:                           ; preds = %for.body22.lr.ph.i
  %unroll_iter1345 = sub nsw i64 %wide.trip.count52.i, %xtraiter1342
...
for.body.i721:                                    ; preds = %for.inc.i.1, %for.body.lr.ph.i719.new
  ...
  %niter1341 = phi i64 [ 0, %for.body.lr.ph.i719.new ], [ %niter1341.next.1, %for.inc.i.1 ]
...
for.inc.i.1:                                      ; preds = %if.then11.i.1, %for.inc.i
  ...
  %niter1341.next.1 = add i64 %niter1341, 2
  %niter1341.ncmp.1 = icmp eq i64 %niter1341.next.1, %unroll_iter1340
  br i1 %niter1341.ncmp.1, label %for.cond19.preheader.i.loopexit.unr-lcssa, label %for.body.i721, !llvm.loop !116
...
for.body22.i:                                     ; preds = %for.inc38.i.1, %for.body22.lr.ph.i.new
  ...
  %niter1346 = phi i64 [ 0, %for.body22.lr.ph.i.new ], [ %niter1346.next.1, %for.inc38.i.1 ]
...
for.inc38.i.1:                                    ; preds = %if.then27.i.1, %for.inc38.i
  ...
  br i1 %niter1346.ncmp.1, label %if.end41.i.loopexit.unr-lcssa, label %for.body22.i, !llvm.loop !117
...
if.end41.i.loopexit.unr-lcssa:                    ; preds = %for.inc38.i.1, %for.body22.lr.ph.i
  ...
  br i1 %lcmp.mod1344.not, label %if.end41.i, label %for.body22.i.epil
...
for.body45.preheader.i.new:                       ; preds = %for.body45.preheader.i
  %unroll_iter1350 = sub nsw i64 %wide.trip.count57.i, %xtraiter1347
...
for.cond53.preheader.i.loopexit.unr-lcssa:        ; preds = %for.body45.i, %for.body45.preheader.i
  ...
  br i1 %lcmp.mod1349.not, label %for.cond53.preheader.i, label %for.body45.i.epil
...
for.body45.i.epil:                                ; preds = %for.cond53.preheader.i.loopexit.unr-lcssa, %for.body45.i.epil
  ...
  %epil.iter1348 = phi i64 [ %epil.iter1348.next, %for.body45.i.epil ], [ 0, %for.cond53.preheader.i.loopexit.unr-lcssa ]
  ...
  %epil.iter1348.next = add i64 %epil.iter1348, 1
  %epil.iter1348.cmp.not = icmp eq i64 %epil.iter1348.next, %xtraiter1347
  br i1 %epil.iter1348.cmp.not, label %for.cond53.preheader.i, label %for.body45.i.epil, !llvm.loop !118
...
for.body57.lr.ph.i:                               ; preds = %for.cond53.preheader.i
  ...
  %min.iters.check1243 = icmp ult i64 %wide.trip.count63.i, 8
  br i1 %min.iters.check1243, label %for.body57.i.preheader, label %vector.ph1244

vector.ph1244:                                    ; preds = %for.body57.lr.ph.i
  %n.mod.vf1245 = and i64 %390, 7
  %n.vec1246 = sub nsw i64 %wide.trip.count63.i, %n.mod.vf1245
  br label %vector.body1249

vector.body1249:                                  ; preds = %vector.body1249, %vector.ph1244
  %index1250 = phi i64 [ 0, %vector.ph1244 ], [ %index.next1255, %vector.body1249 ]
  %vec.ind1251 = phi <4 x i32> [ <i32 0, i32 1, i32 2, i32 3>, %vector.ph1244 ], [ %vec.ind.next1254, %vector.body1249 ]
  %391 = xor <4 x i32> %vec.ind1251, <i32 -1, i32 -1, i32 -1, i32 -1>
  %392 = sub <4 x i32> <i32 -5, i32 -5, i32 -5, i32 -5>, %vec.ind1251
  %393 = getelementptr inbounds i32, ptr %389, i64 %index1250
  ...
  %index.next1255 = add nuw i64 %index1250, 8
  %vec.ind.next1254 = add <4 x i32> %vec.ind1251, <i32 8, i32 8, i32 8, i32 8>
  %395 = icmp eq i64 %index.next1255, %n.vec1246
  br i1 %395, label %middle.block1241, label %vector.body1249, !llvm.loop !119

middle.block1241:                                 ; preds = %vector.body1249
  %cmp.n1248 = icmp eq i64 %n.mod.vf1245, 0
  br i1 %cmp.n1248, label %for.cond66.preheader.i, label %for.body57.i.preheader

for.body57.i.preheader:                           ; preds = %for.body57.lr.ph.i, %middle.block1241
  %indvars.iv59.i.ph = phi i64 [ 0, %for.body57.lr.ph.i ], [ %n.vec1246, %middle.block1241 ]
...
for.body45.i:                                     ; preds = %for.body45.i, %for.body45.preheader.i.new
  ...
  %niter1351 = phi i64 [ 0, %for.body45.preheader.i.new ], [ %niter1351.next.7, %for.body45.i ]
  ...
  %niter1351.next.7 = add i64 %niter1351, 8
  %niter1351.ncmp.7 = icmp eq i64 %niter1351.next.7, %unroll_iter1350
  br i1 %niter1351.ncmp.7, label %for.cond53.preheader.i.loopexit.unr-lcssa, label %for.body45.i, !llvm.loop !120

for.cond66.preheader.i:                           ; preds = %for.body57.i, %middle.block1241, %for.cond53.preheader.i
  br i1 %cmp85862, label %for.body69.lr.ph.i, label %for.cond78.preheader.i
...
for.body69.lr.ph.i:                               ; preds = %for.cond66.preheader.i
  ...
  %xtraiter1352 = and i64 %wide.trip.count68.i, 3
...
for.body69.lr.ph.i.new:                           ; preds = %for.body69.lr.ph.i
  %unroll_iter1355 = and i64 %wide.trip.count68.i, 4294967292
...
for.cond78.preheader.i.loopexit.unr-lcssa:        ; preds = %for.body69.i, %for.body69.lr.ph.i
  ...
  br i1 %lcmp.mod1354.not, label %for.cond78.preheader.i, label %for.body69.i.epil
...
for.body69.i.epil:                                ; preds = %for.cond78.preheader.i.loopexit.unr-lcssa, %for.body69.i.epil
  ...
  %epil.iter1353 = phi i64 [ %epil.iter1353.next, %for.body69.i.epil ], [ 0, %for.cond78.preheader.i.loopexit.unr-lcssa ]
  ...
  br i1 %epil.iter1353.cmp.not, label %for.cond78.preheader.i, label %for.body69.i.epil, !llvm.loop !122

for.cond78.preheader.i:                           ; preds = %for.cond78.preheader.i.loopexit.unr-lcssa, %for.body69.i.epil, %for.cond66.preheader.i
  br i1 %cmp91864, label %for.body81.lr.ph.i, label %for.end91.i
...
for.body81.lr.ph.i:                               ; preds = %for.cond78.preheader.i
  ...
  %xtraiter1357 = and i64 %wide.trip.count73.i, 3
...
for.body81.lr.ph.i.new:                           ; preds = %for.body81.lr.ph.i
  %unroll_iter1360 = and i64 %wide.trip.count73.i, 4294967292
...
for.body69.i:                                     ; preds = %for.body69.i, %for.body69.lr.ph.i.new
  ...
  %niter1356 = phi i64 [ 0, %for.body69.lr.ph.i.new ], [ %niter1356.next.3, %for.body69.i ]
  ...
  br i1 %niter1356.ncmp.3, label %for.cond78.preheader.i.loopexit.unr-lcssa, label %for.body69.i, !llvm.loop !123
...
for.body81.i:                                     ; preds = %for.body81.i, %for.body81.lr.ph.i.new
  ...
  %niter1361 = phi i64 [ 0, %for.body81.lr.ph.i.new ], [ %niter1361.next.3, %for.body81.i ]
  ...
  br i1 %niter1361.ncmp.3, label %for.end91.i.loopexit.unr-lcssa, label %for.body81.i, !llvm.loop !124
...
for.end91.i.loopexit.unr-lcssa:                   ; preds = %for.body81.i, %for.body81.lr.ph.i
  ...
  br i1 %lcmp.mod1359.not, label %for.end91.i, label %for.body81.i.epil
...
for.body81.i.epil:                                ; preds = %for.end91.i.loopexit.unr-lcssa, %for.body81.i.epil
  ...
  %epil.iter1358 = phi i64 [ %epil.iter1358.next, %for.body81.i.epil ], [ 0, %for.end91.i.loopexit.unr-lcssa ]
  ...
  br i1 %epil.iter1358.cmp.not, label %for.end91.i, label %for.body81.i.epil, !llvm.loop !125
...
for.body96.lr.ph.i:                               ; preds = %for.end91.i
  ...
  %xtraiter1362 = and i64 %wide.trip.count78.i, 1
  %427 = icmp eq i64 %425, 0
  %unroll_iter1365 = and i64 %wide.trip.count78.i, 4294967294
  %lcmp.mod1364.not = icmp eq i64 %xtraiter1362, 0
  %xtraiter1367 = and i64 %wide.trip.count83.i, 3
  %428 = icmp ult i32 %jcyc, 4
  %unroll_iter1370 = and i64 %wide.trip.count83.i, 4294967292
  %lcmp.mod1369.not = icmp eq i64 %xtraiter1367, 0
  %xtraiter1372 = and i64 %wide.trip.count78.i, 3
  %429 = icmp ult i32 %icyc, 4
  %unroll_iter1375 = and i64 %wide.trip.count78.i, 4294967292
  %lcmp.mod1374.not = icmp eq i64 %xtraiter1372, 0
  %xtraiter1377 = and i64 %wide.trip.count83.i, 1
  %430 = icmp eq i64 %426, 0
  %unroll_iter1380 = and i64 %wide.trip.count83.i, 4294967294
  %lcmp.mod1379.not = icmp eq i64 %xtraiter1377, 0
  %xtraiter1382 = and i64 %wide.trip.count78.i, 1
  %431 = icmp eq i64 %425, 0
  %unroll_iter1385 = and i64 %wide.trip.count78.i, 4294967294
  %lcmp.mod1384.not = icmp eq i64 %xtraiter1382, 0
  %xtraiter1387 = and i64 %wide.trip.count83.i, 1
  %432 = icmp eq i64 %426, 0
  %unroll_iter1390 = and i64 %wide.trip.count83.i, 4294967294
  %lcmp.mod1389.not = icmp eq i64 %xtraiter1387, 0
...
for.cond130.preheader.i:                          ; preds = %for.end153.i, %for.cond130.preheader.preheader.i
  ...
  br i1 %cmp85862, label %for.body133.lr.ph.i, label %for.cond144.preheader.i
...
for.cond144.preheader.i.loopexit.unr-lcssa:       ; preds = %for.body133.i, %for.body133.lr.ph.i
  ...
  br i1 %lcmp.mod1364.not, label %for.cond144.preheader.i, label %for.body133.i.epil
...
for.cond144.preheader.i:                          ; preds = %for.body133.i.epil, %for.cond144.preheader.i.loopexit.unr-lcssa, %for.cond130.preheader.i
  br i1 %cmp91864, label %for.body147.i.preheader, label %for.end153.i
...
for.body133.i:                                    ; preds = %for.body133.lr.ph.i, %for.body133.i
  ...
  %niter1366 = phi i64 [ %niter1366.next.1, %for.body133.i ], [ 0, %for.body133.lr.ph.i ]
  ...
  %niter1366.next.1 = add i64 %niter1366, 2
  %niter1366.ncmp.1 = icmp eq i64 %niter1366.next.1, %unroll_iter1365
  br i1 %niter1366.ncmp.1, label %for.cond144.preheader.i.loopexit.unr-lcssa, label %for.body133.i, !llvm.loop !126
...
for.body147.i:                                    ; preds = %for.body147.i.preheader, %for.body147.i
  ...
  %niter1371 = phi i64 [ %niter1371.next.3, %for.body147.i ], [ 0, %for.body147.i.preheader ]
  ...
  br i1 %niter1371.ncmp.3, label %for.end153.i.loopexit.unr-lcssa, label %for.body147.i, !llvm.loop !127
...
for.end153.i.loopexit.unr-lcssa:                  ; preds = %for.body147.i, %for.body147.i.preheader
  ...
  br i1 %lcmp.mod1369.not, label %for.end153.i, label %for.body147.i.epil
...
for.body147.i.epil:                               ; preds = %for.end153.i.loopexit.unr-lcssa, %for.body147.i.epil
  ...
  %epil.iter1368 = phi i64 [ %epil.iter1368.next, %for.body147.i.epil ], [ 0, %for.end153.i.loopexit.unr-lcssa ]
  ...
  br i1 %epil.iter1368.cmp.not, label %for.end153.i, label %for.body147.i.epil, !llvm.loop !128
...
for.cond160.preheader.i:                          ; preds = %for.end185.i, %for.cond160.preheader.preheader.i
  ...
  br i1 %cmp85862, label %for.body163.i.preheader, label %for.cond171.preheader.i
...
for.cond171.preheader.i.loopexit.unr-lcssa:       ; preds = %for.body163.i, %for.body163.i.preheader
  ...
  br i1 %lcmp.mod1374.not, label %for.cond171.preheader.i, label %for.body163.i.epil
...
for.body163.i.epil:                               ; preds = %for.cond171.preheader.i.loopexit.unr-lcssa, %for.body163.i.epil
  ...
  %epil.iter1373 = phi i64 [ %epil.iter1373.next, %for.body163.i.epil ], [ 0, %for.cond171.preheader.i.loopexit.unr-lcssa ]
  ...
  br i1 %epil.iter1373.cmp.not, label %for.cond171.preheader.i, label %for.body163.i.epil, !llvm.loop !130

for.cond171.preheader.i:                          ; preds = %for.cond171.preheader.i.loopexit.unr-lcssa, %for.body163.i.epil, %for.cond160.preheader.i
  br i1 %cmp91864, label %for.body174.lr.ph.i, label %for.end185.i
...
for.body163.i:                                    ; preds = %for.body163.i.preheader, %for.body163.i
  ...
  %niter1376 = phi i64 [ %niter1376.next.3, %for.body163.i ], [ 0, %for.body163.i.preheader ]
  ...
  %niter1376.next.3 = add i64 %niter1376, 4
  %niter1376.ncmp.3 = icmp eq i64 %niter1376.next.3, %unroll_iter1375
  br i1 %niter1376.ncmp.3, label %for.cond171.preheader.i.loopexit.unr-lcssa, label %for.body163.i, !llvm.loop !131
...
for.body174.i:                                    ; preds = %for.body174.lr.ph.i, %for.body174.i
  ...
  %niter1381 = phi i64 [ %niter1381.next.1, %for.body174.i ], [ 0, %for.body174.lr.ph.i ]
  ...
  %niter1381.next.1 = add i64 %niter1381, 2
  %niter1381.ncmp.1 = icmp eq i64 %niter1381.next.1, %unroll_iter1380
  br i1 %niter1381.ncmp.1, label %for.end185.i.loopexit.unr-lcssa, label %for.body174.i, !llvm.loop !132
...
for.end185.i.loopexit.unr-lcssa:                  ; preds = %for.body174.i, %for.body174.lr.ph.i
  ...
  br i1 %lcmp.mod1379.not, label %for.end185.i, label %for.body174.i.epil
...
for.cond208.preheader.i:                          ; preds = %if.end201.i
  br i1 %cmp85862, label %for.body211.lr.ph.i, label %for.cond222.preheader.i
...
for.cond222.preheader.i.loopexit.unr-lcssa:       ; preds = %for.body211.i, %for.body211.lr.ph.i
  ...
  br i1 %lcmp.mod1384.not, label %for.cond222.preheader.i, label %for.body211.i.epil
...
for.cond222.preheader.i:                          ; preds = %for.body211.i.epil, %for.cond222.preheader.i.loopexit.unr-lcssa, %for.cond208.preheader.i
  br i1 %cmp91864, label %for.body225.lr.ph.i, label %for.end235.i
...
for.body211.i:                                    ; preds = %for.body211.lr.ph.i, %for.body211.i
  ...
  %niter1386 = phi i64 [ %niter1386.next.1, %for.body211.i ], [ 0, %for.body211.lr.ph.i ]
  ...
  %niter1386.next.1 = add i64 %niter1386, 2
  %niter1386.ncmp.1 = icmp eq i64 %niter1386.next.1, %unroll_iter1385
  br i1 %niter1386.ncmp.1, label %for.cond222.preheader.i.loopexit.unr-lcssa, label %for.body211.i, !llvm.loop !134
...
for.body225.i:                                    ; preds = %for.body225.lr.ph.i, %for.body225.i
  ...
  %niter1391 = phi i64 [ %niter1391.next.1, %for.body225.i ], [ 0, %for.body225.lr.ph.i ]
  ...
  %niter1391.next.1 = add i64 %niter1391, 2
  %niter1391.ncmp.1 = icmp eq i64 %niter1391.next.1, %unroll_iter1390
  br i1 %niter1391.ncmp.1, label %for.end235.i.loopexit.unr-lcssa, label %for.body225.i, !llvm.loop !135
...
for.end235.i.loopexit.unr-lcssa:                  ; preds = %for.body225.i, %for.body225.lr.ph.i
  ...
  br i1 %lcmp.mod1389.not, label %for.end235.i, label %for.body225.i.epil
...
for.body.lr.ph.i736.new:                          ; preds = %for.body.lr.ph.i736
  %unroll_iter1286 = sub nsw i64 %wide.trip.count.i735, %xtraiter1283
...
for.cond19.preheader.i738.loopexit.unr-lcssa:     ; preds = %for.inc.i755.1, %for.body.lr.ph.i736
  ...
  %lcmp.mod1284.not = icmp eq i64 %xtraiter1283, 0
  br i1 %lcmp.mod1284.not, label %for.cond19.preheader.i738, label %for.body.i748.epil
...
for.body22.lr.ph.i744:                            ; preds = %for.cond19.preheader.i738
  ...
  %xtraiter1288 = and i64 %call2.i, 1
...
for.body22.lr.ph.i744.new:                        ; preds = %for.body22.lr.ph.i744
  %unroll_iter1290 = sub nsw i64 %wide.trip.count51.i, %xtraiter1288
...
for.body.i748:                                    ; preds = %for.inc.i755.1, %for.body.lr.ph.i736.new
  ...
  %niter1287 = phi i64 [ 0, %for.body.lr.ph.i736.new ], [ %niter1287.next.1, %for.inc.i755.1 ]
...
for.inc.i755.1:                                   ; preds = %if.then11.i751.1, %for.inc.i755
  ...
  br i1 %niter1287.ncmp.1, label %for.cond19.preheader.i738.loopexit.unr-lcssa, label %for.body.i748, !llvm.loop !137
...
for.body22.i758:                                  ; preds = %for.inc38.i763.1, %for.body22.lr.ph.i744.new
  ...
  %niter1291 = phi i64 [ 0, %for.body22.lr.ph.i744.new ], [ %niter1291.next.1, %for.inc38.i763.1 ]
...
for.inc38.i763.1:                                 ; preds = %if.then27.i761.1, %for.inc38.i763
  ...
  %niter1291.next.1 = add i64 %niter1291, 2
  %niter1291.ncmp.1 = icmp eq i64 %niter1291.next.1, %unroll_iter1290
  br i1 %niter1291.ncmp.1, label %if.end41.i764.loopexit.unr-lcssa, label %for.body22.i758, !llvm.loop !138
...
if.end41.i764.loopexit.unr-lcssa:                 ; preds = %for.inc38.i763.1, %for.body22.lr.ph.i744
  ...
  br i1 %lcmp.mod1289.not, label %if.end41.i764, label %for.body22.i758.epil
...
for.body45.preheader.i765.new:                    ; preds = %for.body45.preheader.i765
  %unroll_iter1294 = sub nsw i64 %wide.trip.count56.i, %xtraiter1292
...
for.cond53.preheader.i766.loopexit.unr-lcssa:     ; preds = %for.body45.i769, %for.body45.preheader.i765
  ...
  br i1 %lcmp.mod1293.not, label %for.cond53.preheader.i766, label %for.body45.i769.epil
...
for.body45.i769.epil:                             ; preds = %for.cond53.preheader.i766.loopexit.unr-lcssa, %for.body45.i769.epil
  ...
  %epil.iter.next = add i64 %epil.iter, 1
  %epil.iter.cmp.not = icmp eq i64 %epil.iter.next, %xtraiter1292
...
for.body57.lr.ph.i767:                            ; preds = %for.cond53.preheader.i766
  ...
  %min.iters.check1229 = icmp ult i64 %wide.trip.count62.i, 8
  br i1 %min.iters.check1229, label %for.body57.i777.preheader, label %vector.ph1230

vector.ph1230:                                    ; preds = %for.body57.lr.ph.i767
  %n.mod.vf1231 = and i64 %525, 7
  %n.vec1232 = sub nsw i64 %wide.trip.count62.i, %n.mod.vf1231
  br label %vector.body1235

vector.body1235:                                  ; preds = %vector.body1235, %vector.ph1230
  %index1236 = phi i64 [ 0, %vector.ph1230 ], [ %index.next1240, %vector.body1235 ]
  %vec.ind1237 = phi <4 x i32> [ <i32 0, i32 1, i32 2, i32 3>, %vector.ph1230 ], [ %vec.ind.next1239, %vector.body1235 ]
  %526 = xor <4 x i32> %vec.ind1237, <i32 -1, i32 -1, i32 -1, i32 -1>
  %527 = sub <4 x i32> <i32 -5, i32 -5, i32 -5, i32 -5>, %vec.ind1237
  %528 = getelementptr inbounds i32, ptr %524, i64 %index1236
  ...
  %index.next1240 = add nuw i64 %index1236, 8
  %vec.ind.next1239 = add <4 x i32> %vec.ind1237, <i32 8, i32 8, i32 8, i32 8>
  %530 = icmp eq i64 %index.next1240, %n.vec1232
  br i1 %530, label %middle.block1227, label %vector.body1235, !llvm.loop !140

middle.block1227:                                 ; preds = %vector.body1235
  %cmp.n1234 = icmp eq i64 %n.mod.vf1231, 0
  br i1 %cmp.n1234, label %for.cond66.preheader.i770, label %for.body57.i777.preheader

for.body57.i777.preheader:                        ; preds = %for.body57.lr.ph.i767, %middle.block1227
  %indvars.iv58.i.ph = phi i64 [ 0, %for.body57.lr.ph.i767 ], [ %n.vec1232, %middle.block1227 ]
...
for.body45.i769:                                  ; preds = %for.body45.i769, %for.body45.preheader.i765.new
  ...
  %niter1295 = phi i64 [ 0, %for.body45.preheader.i765.new ], [ %niter1295.next.7, %for.body45.i769 ]
  ...
  %niter1295.next.7 = add i64 %niter1295, 8
  %niter1295.ncmp.7 = icmp eq i64 %niter1295.next.7, %unroll_iter1294
  br i1 %niter1295.ncmp.7, label %for.cond53.preheader.i766.loopexit.unr-lcssa, label %for.body45.i769, !llvm.loop !141

for.cond66.preheader.i770:                        ; preds = %for.body57.i777, %middle.block1227, %for.cond53.preheader.i766
  br i1 %cmp85862, label %for.body69.lr.ph.i774, label %for.cond78.preheader.i778
...
for.body69.lr.ph.i774:                            ; preds = %for.cond66.preheader.i770
  ...
  %xtraiter1296 = and i64 %wide.trip.count67.i, 3
...
for.body69.lr.ph.i774.new:                        ; preds = %for.body69.lr.ph.i774
  %unroll_iter1299 = and i64 %wide.trip.count67.i, 4294967292
...
for.cond78.preheader.i778.loopexit.unr-lcssa:     ; preds = %for.body69.i785, %for.body69.lr.ph.i774
  ...
  %lcmp.mod1298.not = icmp eq i64 %xtraiter1296, 0
  br i1 %lcmp.mod1298.not, label %for.cond78.preheader.i778, label %for.body69.i785.epil
...
for.body69.i785.epil:                             ; preds = %for.cond78.preheader.i778.loopexit.unr-lcssa, %for.body69.i785.epil
  ...
  %epil.iter1297 = phi i64 [ %epil.iter1297.next, %for.body69.i785.epil ], [ 0, %for.cond78.preheader.i778.loopexit.unr-lcssa ]
  ...
  %epil.iter1297.next = add i64 %epil.iter1297, 1
  %epil.iter1297.cmp.not = icmp eq i64 %epil.iter1297.next, %xtraiter1296
  br i1 %epil.iter1297.cmp.not, label %for.cond78.preheader.i778, label %for.body69.i785.epil, !llvm.loop !143
...
for.cond78.preheader.i778:                        ; preds = %for.cond78.preheader.i778.loopexit.unr-lcssa, %for.body69.i785.epil, %for.cond66.preheader.i770
  br i1 %cmp91864, label %for.body81.lr.ph.i782, label %for.end91.i789
...
for.body81.lr.ph.i782:                            ; preds = %for.cond78.preheader.i778
  ...
  %xtraiter1301 = and i64 %wide.trip.count72.i, 3
...
for.body81.lr.ph.i782.new:                        ; preds = %for.body81.lr.ph.i782
  %unroll_iter1304 = and i64 %wide.trip.count72.i, 4294967292
...
for.body69.i785:                                  ; preds = %for.body69.i785, %for.body69.lr.ph.i774.new
  ...
  %niter1300 = phi i64 [ 0, %for.body69.lr.ph.i774.new ], [ %niter1300.next.3, %for.body69.i785 ]
  ...
  %niter1300.next.3 = add i64 %niter1300, 4
  %niter1300.ncmp.3 = icmp eq i64 %niter1300.next.3, %unroll_iter1299
  br i1 %niter1300.ncmp.3, label %for.cond78.preheader.i778.loopexit.unr-lcssa, label %for.body69.i785, !llvm.loop !144
...
for.body81.i788:                                  ; preds = %for.body81.i788, %for.body81.lr.ph.i782.new
  ...
  %niter1305 = phi i64 [ 0, %for.body81.lr.ph.i782.new ], [ %niter1305.next.3, %for.body81.i788 ]
  ...
  %niter1305.next.3 = add i64 %niter1305, 4
  %niter1305.ncmp.3 = icmp eq i64 %niter1305.next.3, %unroll_iter1304
  br i1 %niter1305.ncmp.3, label %for.end91.i789.loopexit.unr-lcssa, label %for.body81.i788, !llvm.loop !145
...
for.end91.i789.loopexit.unr-lcssa:                ; preds = %for.body81.i788, %for.body81.lr.ph.i782
  ...
  %lcmp.mod1303.not = icmp eq i64 %xtraiter1301, 0
  br i1 %lcmp.mod1303.not, label %for.end91.i789, label %for.body81.i788.epil
...
for.body81.i788.epil:                             ; preds = %for.end91.i789.loopexit.unr-lcssa, %for.body81.i788.epil
  ...
  %epil.iter1302 = phi i64 [ %epil.iter1302.next, %for.body81.i788.epil ], [ 0, %for.end91.i789.loopexit.unr-lcssa ]
  ...
  %epil.iter1302.next = add i64 %epil.iter1302, 1
  %epil.iter1302.cmp.not = icmp eq i64 %epil.iter1302.next, %xtraiter1301
  br i1 %epil.iter1302.cmp.not, label %for.end91.i789, label %for.body81.i788.epil, !llvm.loop !146
...
for.body96.lr.ph.i790:                            ; preds = %for.end91.i789
  ...
  %xtraiter1306 = and i64 %wide.trip.count77.i, 1
  %561 = icmp eq i64 %559, 0
  %unroll_iter1309 = and i64 %wide.trip.count77.i, 4294967294
  %lcmp.mod1308.not = icmp eq i64 %xtraiter1306, 0
  %xtraiter1311 = and i64 %wide.trip.count82.i, 3
  %562 = icmp ult i32 %jcyc, 4
  %unroll_iter1314 = and i64 %wide.trip.count82.i, 4294967292
  %lcmp.mod1313.not = icmp eq i64 %xtraiter1311, 0
  %xtraiter1316 = and i64 %wide.trip.count77.i, 3
  %563 = icmp ult i32 %icyc, 4
  %unroll_iter1319 = and i64 %wide.trip.count77.i, 4294967292
  %lcmp.mod1318.not = icmp eq i64 %xtraiter1316, 0
  %xtraiter1321 = and i64 %wide.trip.count82.i, 1
  %564 = icmp eq i64 %560, 0
  %unroll_iter1324 = and i64 %wide.trip.count82.i, 4294967294
  %lcmp.mod1323.not = icmp eq i64 %xtraiter1321, 0
  %xtraiter1326 = and i64 %wide.trip.count77.i, 1
  %565 = icmp eq i64 %559, 0
  %unroll_iter1329 = and i64 %wide.trip.count77.i, 4294967294
  %lcmp.mod1328.not = icmp eq i64 %xtraiter1326, 0
  %xtraiter1331 = and i64 %wide.trip.count82.i, 1
  %566 = icmp eq i64 %560, 0
  %unroll_iter1334 = and i64 %wide.trip.count82.i, 4294967294
  %lcmp.mod1333.not = icmp eq i64 %xtraiter1331, 0
...
for.cond130.preheader.i810:                       ; preds = %for.end153.i822, %for.cond130.preheader.preheader.i809
  ...
  br i1 %cmp85862, label %for.body133.lr.ph.i811, label %for.cond144.preheader.i812
...
for.cond144.preheader.i812.loopexit.unr-lcssa:    ; preds = %for.body133.i817, %for.body133.lr.ph.i811
  ...
  br i1 %lcmp.mod1308.not, label %for.cond144.preheader.i812, label %for.body133.i817.epil
...
for.cond144.preheader.i812:                       ; preds = %for.body133.i817.epil, %for.cond144.preheader.i812.loopexit.unr-lcssa, %for.cond130.preheader.i810
  br i1 %cmp91864, label %for.body147.i820.preheader, label %for.end153.i822
...
for.body133.i817:                                 ; preds = %for.body133.lr.ph.i811, %for.body133.i817
  ...
  %niter1310 = phi i64 [ %niter1310.next.1, %for.body133.i817 ], [ 0, %for.body133.lr.ph.i811 ]
  ...
  %niter1310.next.1 = add i64 %niter1310, 2
  %niter1310.ncmp.1 = icmp eq i64 %niter1310.next.1, %unroll_iter1309
  br i1 %niter1310.ncmp.1, label %for.cond144.preheader.i812.loopexit.unr-lcssa, label %for.body133.i817, !llvm.loop !147
...
for.body147.i820:                                 ; preds = %for.body147.i820.preheader, %for.body147.i820
  ...
  %niter1315 = phi i64 [ %niter1315.next.3, %for.body147.i820 ], [ 0, %for.body147.i820.preheader ]
  ...
  %niter1315.next.3 = add i64 %niter1315, 4
  %niter1315.ncmp.3 = icmp eq i64 %niter1315.next.3, %unroll_iter1314
  br i1 %niter1315.ncmp.3, label %for.end153.i822.loopexit.unr-lcssa, label %for.body147.i820, !llvm.loop !148
...
for.end153.i822.loopexit.unr-lcssa:               ; preds = %for.body147.i820, %for.body147.i820.preheader
  ...
  br i1 %lcmp.mod1313.not, label %for.end153.i822, label %for.body147.i820.epil
...
for.body147.i820.epil:                            ; preds = %for.end153.i822.loopexit.unr-lcssa, %for.body147.i820.epil
  ...
  %epil.iter1312 = phi i64 [ %epil.iter1312.next, %for.body147.i820.epil ], [ 0, %for.end153.i822.loopexit.unr-lcssa ]
  ...
  %epil.iter1312.next = add i64 %epil.iter1312, 1
  %epil.iter1312.cmp.not = icmp eq i64 %epil.iter1312.next, %xtraiter1311
  br i1 %epil.iter1312.cmp.not, label %for.end153.i822, label %for.body147.i820.epil, !llvm.loop !149
...
for.cond160.preheader.i827:                       ; preds = %for.end185.i840, %for.cond160.preheader.preheader.i826
  ...
  br i1 %cmp85862, label %for.body163.i832.preheader, label %for.cond171.preheader.i828
...
for.cond171.preheader.i828.loopexit.unr-lcssa:    ; preds = %for.body163.i832, %for.body163.i832.preheader
  ...
  br i1 %lcmp.mod1318.not, label %for.cond171.preheader.i828, label %for.body163.i832.epil
...
for.body163.i832.epil:                            ; preds = %for.cond171.preheader.i828.loopexit.unr-lcssa, %for.body163.i832.epil
  ...
  %epil.iter1317 = phi i64 [ %epil.iter1317.next, %for.body163.i832.epil ], [ 0, %for.cond171.preheader.i828.loopexit.unr-lcssa ]
  ...
  %epil.iter1317.next = add i64 %epil.iter1317, 1
  %epil.iter1317.cmp.not = icmp eq i64 %epil.iter1317.next, %xtraiter1316
  br i1 %epil.iter1317.cmp.not, label %for.cond171.preheader.i828, label %for.body163.i832.epil, !llvm.loop !151
...
for.cond171.preheader.i828:                       ; preds = %for.cond171.preheader.i828.loopexit.unr-lcssa, %for.body163.i832.epil, %for.cond160.preheader.i827
  br i1 %cmp91864, label %for.body174.lr.ph.i829, label %for.end185.i840
...
for.body163.i832:                                 ; preds = %for.body163.i832.preheader, %for.body163.i832
  ...
  %niter1320 = phi i64 [ %niter1320.next.3, %for.body163.i832 ], [ 0, %for.body163.i832.preheader ]
  ...
  %niter1320.next.3 = add i64 %niter1320, 4
  %niter1320.ncmp.3 = icmp eq i64 %niter1320.next.3, %unroll_iter1319
  br i1 %niter1320.ncmp.3, label %for.cond171.preheader.i828.loopexit.unr-lcssa, label %for.body163.i832, !llvm.loop !152
...
for.body174.i837:                                 ; preds = %for.body174.lr.ph.i829, %for.body174.i837
  ...
  %niter1325 = phi i64 [ %niter1325.next.1, %for.body174.i837 ], [ 0, %for.body174.lr.ph.i829 ]
  ...
  %niter1325.next.1 = add i64 %niter1325, 2
  %niter1325.ncmp.1 = icmp eq i64 %niter1325.next.1, %unroll_iter1324
  br i1 %niter1325.ncmp.1, label %for.end185.i840.loopexit.unr-lcssa, label %for.body174.i837, !llvm.loop !153
...
for.end185.i840.loopexit.unr-lcssa:               ; preds = %for.body174.i837, %for.body174.lr.ph.i829
  ...
  br i1 %lcmp.mod1323.not, label %for.end185.i840, label %for.body174.i837.epil
...
for.cond194.preheader.i:                          ; preds = %while.end187.i843
  br i1 %cmp85862, label %for.body197.lr.ph.i, label %for.cond208.preheader.i844
...
for.cond208.preheader.i844.loopexit.unr-lcssa:    ; preds = %for.body197.i, %for.body197.lr.ph.i
  ...
  br i1 %lcmp.mod1328.not, label %for.cond208.preheader.i844, label %for.body197.i.epil
...
for.cond208.preheader.i844:                       ; preds = %for.body197.i.epil, %for.cond208.preheader.i844.loopexit.unr-lcssa, %for.cond194.preheader.i
  br i1 %cmp91864, label %for.body211.lr.ph.i846, label %for.end221.i
...
for.body197.i:                                    ; preds = %for.body197.lr.ph.i, %for.body197.i
  ...
  %niter1330 = phi i64 [ %niter1330.next.1, %for.body197.i ], [ 0, %for.body197.lr.ph.i ]
  ...
  %niter1330.next.1 = add i64 %niter1330, 2
  %niter1330.ncmp.1 = icmp eq i64 %niter1330.next.1, %unroll_iter1329
  br i1 %niter1330.ncmp.1, label %for.cond208.preheader.i844.loopexit.unr-lcssa, label %for.body197.i, !llvm.loop !155
...
for.body211.i851:                                 ; preds = %for.body211.lr.ph.i846, %for.body211.i851
  ...
  %niter1335 = phi i64 [ %niter1335.next.1, %for.body211.i851 ], [ 0, %for.body211.lr.ph.i846 ]
  ...
  %niter1335.next.1 = add i64 %niter1335, 2
  %niter1335.ncmp.1 = icmp eq i64 %niter1335.next.1, %unroll_iter1334
  br i1 %niter1335.ncmp.1, label %for.end221.i.loopexit.unr-lcssa, label %for.body211.i851, !llvm.loop !156
...
for.end221.i.loopexit.unr-lcssa:                  ; preds = %for.body211.i851, %for.body211.lr.ph.i846
  ...
  br i1 %lcmp.mod1333.not, label %for.end221.i, label %for.body211.i851.epil
...
if.end423:                                        ; preds = %if.end412, %if.then421
  br i1 %cmp85862, label %for.body427.lr.ph, label %for.cond436.preheader

for.body427.lr.ph:                                ; preds = %if.end423
  %629 = load ptr, ptr @partA__align.mseq1, align 8, !tbaa !5
  %wide.trip.count982 = zext i32 %icyc to i64
  br label %for.body427

for.cond436.preheader:                            ; preds = %for.body427, %if.end423
  br i1 %cmp91864, label %for.body439.lr.ph, label %for.end447

for.body439.lr.ph:                                ; preds = %for.cond436.preheader
  %630 = load ptr, ptr @partA__align.mseq2, align 8, !tbaa !5
  %wide.trip.count987 = zext i32 %jcyc to i64
  br label %for.body439

for.body427:                                      ; preds = %for.body427.lr.ph, %for.body427
  %indvars.iv979 = phi i64 [ 0, %for.body427.lr.ph ], [ %indvars.iv.next980, %for.body427 ]
  %arrayidx429 = getelementptr inbounds ptr, ptr %seq1, i64 %indvars.iv979
  %631 = load ptr, ptr %arrayidx429, align 8, !tbaa !5
  %arrayidx431 = getelementptr inbounds ptr, ptr %629, i64 %indvars.iv979
  ...
  br i1 %exitcond983.not, label %for.cond436.preheader, label %for.body427, !llvm.loop !158

for.body439:                                      ; preds = %for.body439.lr.ph, %for.body439
  %indvars.iv984 = phi i64 [ 0, %for.body439.lr.ph ], [ %indvars.iv.next985, %for.body439 ]
  %arrayidx441 = getelementptr inbounds ptr, ptr %seq2, i64 %indvars.iv984
  %633 = load ptr, ptr %arrayidx441, align 8, !tbaa !5
  %arrayidx443 = getelementptr inbounds ptr, ptr %630, i64 %indvars.iv984
  ...
  br i1 %exitcond988.not, label %for.end447, label %for.body439, !llvm.loop !159
