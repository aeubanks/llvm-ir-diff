...
for.cond6.preheader:                              ; preds = %for.body, %for.cond.cleanup8
  %cmp3321 = phi i1 [ %4, %for.cond.cleanup8 ], [ true, %for.body ]
  %y.0320 = phi i32 [ %add49, %for.cond.cleanup8 ], [ 1, %for.body ]
  %no.0319 = phi i32 [ %no.2, %for.cond.cleanup8 ], [ 0, %for.body ]
  %cmp16 = icmp ult i32 %y.0320, 5
  %sub18 = add nuw nsw i32 %y.0320, 4
  %cmp22 = icmp ult i32 %y.0320, 6
  %sub24 = add nsw i32 %y.0320, -5
  %sub34 = add nsw i32 %y.0320, -1
  %1 = add nsw i32 %y.0320, -2
  %2 = icmp ult i32 %1, 9
  %cmp6.i = icmp ugt i32 %y.0320, 5
  %sub8.i = add nuw nsw i32 %y.0320, 3
  %cmp12.i = icmp ult i32 %y.0320, 7
  ...
  %sub14.i107 = add nsw i32 %y.0320, -6
  %3 = add nsw i32 %y.0320, -4
  %mul.i152 = mul nuw nsw i32 %y.0320, 9
  %cmp20.i154 = icmp ugt i32 %y.0320, 1
  %spec.select.v.i155 = select i1 %cmp20.i154, i32 -14, i32 -10
  %add.i153 = add nsw i32 %spec.select.v.i155, %mul.i152
  %cmp24.i157 = icmp ugt i32 %y.0320, 2
  %cmp28.i160 = icmp ugt i32 %y.0320, 3
  %cmp32.i163 = icmp ugt i32 %y.0320, 4
  %sub34.i164 = sext i1 %cmp32.i163 to i32
  %not.cmp12.i166 = xor i1 %cmp22, true
  %sub38.i167 = sext i1 %not.cmp12.i166 to i32
  %no.3.i165 = add nsw i32 %sub38.i167, %sub34.i164
  %cmp40.i169 = icmp ugt i32 %y.0320, 6
  %cmp44.i172 = icmp ugt i32 %y.0320, 7
  %cmp48.i175 = icmp ugt i32 %y.0320, 8
  %add49 = add nuw nsw i32 %y.0320, 1
  %4 = icmp ult i32 %y.0320, 9
  %sub8.i225 = add nuw nsw i32 %y.0320, 5
...
for.cond.cleanup8:                                ; preds = %if.end57
  %exitcond335.not = icmp eq i32 %add49, 10
  br i1 %exitcond335.not, label %for.cond.cleanup4, label %for.cond6.preheader, !llvm.loop !15

if.then:                                          ; preds = %for.cond6.preheader, %if.end57
  %x.0317 = phi i32 [ 1, %for.cond6.preheader ], [ %inc59.pre-phi, %if.end57 ]
  %no.1316 = phi i32 [ %no.0319, %for.cond6.preheader ], [ %no.2, %if.end57 ]
  %cmp19 = icmp ule i32 %x.0317, %sub18
  %or.cond = select i1 %not.cmp12.i248, i1 true, i1 %cmp19
  %cmp25.not = icmp sgt i32 %x.0317, %sub24
  %or.cond304 = select i1 %cmp22, i1 true, i1 %cmp25.not
  %tobool.not = select i1 %or.cond304, i1 %or.cond, i1 false
  br i1 %tobool.not, label %if.then30, label %if.then.if.end57_crit_edge

if.then.if.end57_crit_edge:                       ; preds = %if.then
  %.pre = add nuw nsw i32 %x.0317, 1
  br label %if.end57

if.then30:                                        ; preds = %if.then
  %5 = load ptr, ptr @clone_lookups, align 8, !tbaa !5
  %idxprom31 = sext i32 %no.1316 to i64
  %arrayidx32 = getelementptr inbounds %class.BitBoard64, ptr %5, i64 %idxprom31
  %sub33 = add nsw i32 %x.0317, -1
  %6 = add nsw i32 %x.0317, -2
  %or.cond.i = icmp ult i32 %6, 9
  %or.cond54.i = and i1 %2, %or.cond.i
  br i1 %or.cond54.i, label %if.then.i, label %_Z16getHexxagonIndexii.exit

if.then.i:                                        ; preds = %if.then30
  %cmp9.i = icmp uge i32 %sub8.i, %sub33
  %or.cond81.i.not332 = or i1 %cmp6.i, %cmp9.i
  %or.cond82.i = select i1 %cmp12.i, i1 true, i1 %cmp25.not
  %or.cond322 = select i1 %or.cond81.i.not332, i1 %or.cond82.i, i1 false
  br i1 %or.cond322, label %if.end18.i, label %_Z16getHexxagonIndexii.exit.thread
...
if.end18.i:                                       ; preds = %if.then.i
  ...
  br label %_Z16getHexxagonIndexii.exit.thread

_Z16getHexxagonIndexii.exit.thread:               ; preds = %if.then.i, %if.end18.i
  %retval.0.i.ph = phi i32 [ -1, %if.then.i ], [ %no.6.i, %if.end18.i ]
  call void @_ZN10BitBoard646setBitEi(ptr noundef nonnull align 4 dereferenceable(8) %arrayidx32, i32 noundef %retval.0.i.ph)
  %7 = load ptr, ptr @clone_lookups, align 8, !tbaa !5
  %arrayidx37306 = getelementptr inbounds %class.BitBoard64, ptr %7, i64 %idxprom31
  br label %if.then.i105

_Z16getHexxagonIndexii.exit:                      ; preds = %if.then30
  call void @_ZN10BitBoard646setBitEi(ptr noundef nonnull align 4 dereferenceable(8) %arrayidx32, i32 noundef -1)
  %8 = load ptr, ptr @clone_lookups, align 8, !tbaa !5
  %arrayidx37 = getelementptr inbounds %class.BitBoard64, ptr %8, i64 %idxprom31
  br i1 %2, label %if.then.i105, label %_Z16getHexxagonIndexii.exit139

if.then.i105:                                     ; preds = %_Z16getHexxagonIndexii.exit.thread, %_Z16getHexxagonIndexii.exit
  %arrayidx37308 = phi ptr [ %arrayidx37306, %_Z16getHexxagonIndexii.exit.thread ], [ %arrayidx37, %_Z16getHexxagonIndexii.exit ]
  %cmp9.i103 = icmp uge i32 %sub8.i, %x.0317
  %or.cond81.i104.not331 = or i1 %cmp6.i, %cmp9.i103
  %cmp15.not.i108 = icmp slt i32 %sub14.i107, %x.0317
  %or.cond82.i109 = select i1 %cmp12.i, i1 true, i1 %cmp15.not.i108
  %or.cond323 = select i1 %or.cond81.i104.not331, i1 %or.cond82.i109, i1 false
  br i1 %or.cond323, label %if.end18.i137, label %_Z16getHexxagonIndexii.exit139

if.end18.i137:                                    ; preds = %if.then.i105
  %spec.select.i115 = add i32 %add.i, %x.0317
...
_Z16getHexxagonIndexii.exit139:                   ; preds = %_Z16getHexxagonIndexii.exit, %if.then.i105, %if.end18.i137
  %arrayidx37307 = phi ptr [ %arrayidx37308, %if.end18.i137 ], [ %arrayidx37308, %if.then.i105 ], [ %arrayidx37, %_Z16getHexxagonIndexii.exit ]
  %retval.0.i138 = phi i32 [ %no.6.i133, %if.end18.i137 ], [ -1, %if.then.i105 ], [ -1, %_Z16getHexxagonIndexii.exit ]
  call void @_ZN10BitBoard646setBitEi(ptr noundef nonnull align 4 dereferenceable(8) %arrayidx37307, i32 noundef %retval.0.i138)
  %9 = load ptr, ptr @clone_lookups, align 8, !tbaa !5
  %arrayidx41 = getelementptr inbounds %class.BitBoard64, ptr %9, i64 %idxprom31
  %or.cond54.i141 = and i1 %cmp3321, %or.cond.i
  %cmp9.i144 = icmp ult i32 %sub18, %sub33
  %or.cond81.i145 = and i1 %cmp16, %cmp9.i144
  %or.cond81.i145.not = xor i1 %or.cond81.i145, true
  %or.cond313.not = select i1 %or.cond54.i141, i1 %or.cond81.i145.not, i1 false
  %cmp15.not.i149 = icmp slt i32 %3, %x.0317
  %or.cond82.i150 = select i1 %cmp22, i1 true, i1 %cmp15.not.i149
  %or.cond324 = select i1 %or.cond313.not, i1 %or.cond82.i150, i1 false
  br i1 %or.cond324, label %if.end18.i178, label %_Z16getHexxagonIndexii.exit180
...
_Z16getHexxagonIndexii.exit180:                   ; preds = %_Z16getHexxagonIndexii.exit139, %if.end18.i178
  ...
  %10 = load ptr, ptr @clone_lookups, align 8, !tbaa !5
  %arrayidx45 = getelementptr inbounds %class.BitBoard64, ptr %10, i64 %idxprom31
  %add = add nuw nsw i32 %x.0317, 1
  %or.cond.i181 = icmp ult i32 %x.0317, 9
  %or.cond54.i182 = and i1 %cmp3321, %or.cond.i181
  %cmp9.i185 = icmp ule i32 %sub18, %x.0317
  %or.cond81.i186 = and i1 %cmp16, %cmp9.i185
  %or.cond81.i186.not = xor i1 %or.cond81.i186, true
  %or.cond314.not = select i1 %or.cond54.i182, i1 %or.cond81.i186.not, i1 false
  %cmp15.not.i190 = icmp sle i32 %sub24, %x.0317
  %or.cond82.i191 = select i1 %cmp22, i1 true, i1 %cmp15.not.i190
  %or.cond325 = select i1 %or.cond314.not, i1 %or.cond82.i191, i1 false
  br i1 %or.cond325, label %if.end18.i219, label %_Z16getHexxagonIndexii.exit221
...
_Z16getHexxagonIndexii.exit221:                   ; preds = %_Z16getHexxagonIndexii.exit180, %if.end18.i219
  ...
  %arrayidx48 = getelementptr inbounds %class.BitBoard64, ptr %11, i64 %idxprom31
  br i1 %4, label %if.then.i228, label %_Z16getHexxagonIndexii.exit262.thread

_Z16getHexxagonIndexii.exit262.thread:            ; preds = %_Z16getHexxagonIndexii.exit221
  call void @_ZN10BitBoard646setBitEi(ptr noundef nonnull align 4 dereferenceable(8) %arrayidx48, i32 noundef -1)
  %12 = load ptr, ptr @clone_lookups, align 8, !tbaa !5
  br label %_Z16getHexxagonIndexii.exit303

if.then.i228:                                     ; preds = %_Z16getHexxagonIndexii.exit221
  %cmp9.i226 = icmp uge i32 %sub8.i225, %x.0317
  %or.cond81.i227.not329 = or i1 %cmp28.i160, %cmp9.i226
  %or.cond82.i232 = select i1 %cmp16, i1 true, i1 %cmp15.not.i149
  %or.cond326 = select i1 %or.cond81.i227.not329, i1 %or.cond82.i232, i1 false
  br i1 %or.cond326, label %if.end18.i260, label %_Z16getHexxagonIndexii.exit262

if.end18.i260:                                    ; preds = %if.then.i228
  %no.1.i241 = add i32 %add.i235, %x.0317
  ...
  %no.5.i253 = select i1 %cmp6.i, i32 %sub42.i252, i32 %no.4.i250
...
_Z16getHexxagonIndexii.exit262:                   ; preds = %if.then.i228, %if.end18.i260
  %retval.0.i261 = phi i32 [ %no.7.i259, %if.end18.i260 ], [ -1, %if.then.i228 ]
  call void @_ZN10BitBoard646setBitEi(ptr noundef nonnull align 4 dereferenceable(8) %arrayidx48, i32 noundef %retval.0.i261)
  %13 = load ptr, ptr @clone_lookups, align 8, !tbaa !5
  %cmp9.i267 = icmp ugt i32 %sub8.i225, %x.0317
  %or.cond81.i268.not330 = or i1 %cmp28.i160, %cmp9.i267
  %or.cond327.not = select i1 %or.cond.i181, i1 %or.cond81.i268.not330, i1 false
  %cmp15.not.i272 = icmp sle i32 %3, %x.0317
  %or.cond82.i273 = select i1 %cmp16, i1 true, i1 %cmp15.not.i272
  %or.cond328 = select i1 %or.cond327.not, i1 %or.cond82.i273, i1 false
  br i1 %or.cond328, label %if.end18.i301, label %_Z16getHexxagonIndexii.exit303
...
if.end18.i301:                                    ; preds = %_Z16getHexxagonIndexii.exit262
  ...
  %no.5.i294 = select i1 %cmp6.i, i32 %sub42.i293, i32 %no.4.i291
...
_Z16getHexxagonIndexii.exit303:                   ; preds = %_Z16getHexxagonIndexii.exit262.thread, %_Z16getHexxagonIndexii.exit262, %if.end18.i301
  %.pn = phi ptr [ %13, %if.end18.i301 ], [ %13, %_Z16getHexxagonIndexii.exit262 ], [ %12, %_Z16getHexxagonIndexii.exit262.thread ]
  %retval.0.i302 = phi i32 [ %no.7.i300, %if.end18.i301 ], [ -1, %_Z16getHexxagonIndexii.exit262 ], [ -1, %_Z16getHexxagonIndexii.exit262.thread ]
  %arrayidx52312 = getelementptr inbounds %class.BitBoard64, ptr %.pn, i64 %idxprom31
  call void @_ZN10BitBoard646setBitEi(ptr noundef nonnull align 4 dereferenceable(8) %arrayidx52312, i32 noundef %retval.0.i302)
  %inc56 = add nsw i32 %no.1316, 1
  br label %if.end57
...
if.end57:                                         ; preds = %if.then.if.end57_crit_edge, %_Z16getHexxagonIndexii.exit303
  ...
  %no.2 = phi i32 [ %no.1316, %if.then.if.end57_crit_edge ], [ %inc56, %_Z16getHexxagonIndexii.exit303 ]
  %exitcond334.not = icmp eq i32 %inc59.pre-phi, 10
  br i1 %exitcond334.not, label %for.cond.cleanup8, label %if.then, !llvm.loop !16
}
...
for.cond6.preheader:                              ; preds = %for.body, %for.cond.cleanup8
  %cmp3615 = phi i1 [ %6, %for.cond.cleanup8 ], [ true, %for.body ]
  %y.0614 = phi i32 [ %add65, %for.cond.cleanup8 ], [ 1, %for.body ]
  %no.0613 = phi i32 [ %no.2, %for.cond.cleanup8 ], [ 0, %for.body ]
  %cmp16 = icmp ult i32 %y.0614, 5
  %sub18 = add nuw nsw i32 %y.0614, 4
  %cmp22 = icmp ult i32 %y.0614, 6
  %sub24 = add nsw i32 %y.0614, -5
  %sub34 = add nsw i32 %y.0614, -2
  %1 = add nsw i32 %y.0614, -3
  %2 = icmp ult i32 %1, 9
  %cmp6.i = icmp ugt i32 %sub34, 4
  %sub8.i = add nuw nsw i32 %y.0614, 2
  ...
  %3 = add nsw i32 %y.0614, -6
  %sub14.i196 = add nsw i32 %y.0614, -7
  %sub48 = add nsw i32 %y.0614, -1
  %4 = icmp ult i32 %sub34, 9
  %cmp6.i231 = icmp ugt i32 %y.0614, 5
  %sub8.i232 = add nuw nsw i32 %y.0614, 3
  %cmp12.i236 = icmp ult i32 %y.0614, 7
  %5 = add nsw i32 %y.0614, -4
  ...
  %mul.i323 = mul nuw nsw i32 %y.0614, 9
  %cmp20.i325 = icmp ugt i32 %y.0614, 1
  %spec.select.v.i326 = select i1 %cmp20.i325, i32 -14, i32 -10
  %add.i324 = add nsw i32 %spec.select.v.i326, %mul.i323
  %cmp24.i328 = icmp ugt i32 %y.0614, 2
  %cmp28.i331 = icmp ugt i32 %y.0614, 3
  %cmp32.i334 = icmp ugt i32 %y.0614, 4
  %sub34.i335 = sext i1 %cmp32.i334 to i32
  %not.cmp12.i337 = xor i1 %cmp22, true
  %sub38.i338 = sext i1 %not.cmp12.i337 to i32
  %no.3.i336 = add nsw i32 %sub38.i338, %sub34.i335
  %cmp40.i340 = icmp ugt i32 %y.0614, 6
  %cmp44.i343 = icmp ugt i32 %y.0614, 7
  %cmp48.i346 = icmp ugt i32 %y.0614, 8
  %add65 = add nuw nsw i32 %y.0614, 1
  %6 = icmp ult i32 %y.0614, 9
  %sub8.i396 = add nuw nsw i32 %y.0614, 5
  ...
  %7 = icmp ult i32 %y.0614, 8
  %sub8.i478 = add nuw nsw i32 %y.0614, 6
  %cmp12.i482 = icmp ult i32 %y.0614, 4
  ...
  %cmp6.i559 = icmp ult i32 %y.0614, 3
  br label %if.then
...
for.cond.cleanup8:                                ; preds = %if.end87
  %exitcond644.not = icmp eq i32 %add65, 10
  br i1 %exitcond644.not, label %for.cond.cleanup4, label %for.cond6.preheader, !llvm.loop !18

if.then:                                          ; preds = %for.cond6.preheader, %if.end87
  %x.0612 = phi i32 [ 1, %for.cond6.preheader ], [ %inc89.pre-phi, %if.end87 ]
  %no.1611 = phi i32 [ %no.0613, %for.cond6.preheader ], [ %no.2, %if.end87 ]
  %cmp19 = icmp ule i32 %x.0612, %sub18
  %or.cond = select i1 %not.cmp12.i419, i1 true, i1 %cmp19
  %cmp25.not = icmp sgt i32 %x.0612, %sub24
  %or.cond598 = select i1 %cmp22, i1 true, i1 %cmp25.not
  %tobool.not = select i1 %or.cond598, i1 %or.cond, i1 false
  br i1 %tobool.not, label %if.then30, label %if.then.if.end87_crit_edge

if.then.if.end87_crit_edge:                       ; preds = %if.then
  %.pre = add nuw nsw i32 %x.0612, 1
  br label %if.end87

if.then30:                                        ; preds = %if.then
  %8 = load ptr, ptr @jump_lookups, align 8, !tbaa !5
  %idxprom31 = sext i32 %no.1611 to i64
  %arrayidx32 = getelementptr inbounds %class.BitBoard64, ptr %8, i64 %idxprom31
  %sub33 = add nsw i32 %x.0612, -2
  %9 = add nsw i32 %x.0612, -3
  %or.cond.i = icmp ult i32 %9, 9
  %or.cond54.i = and i1 %2, %or.cond.i
  %cmp9.i = icmp uge i32 %sub8.i, %sub33
  %or.cond81.i.not633 = or i1 %cmp6.i, %cmp9.i
  %or.cond616.not = select i1 %or.cond54.i, i1 %or.cond81.i.not633, i1 false
  %or.cond82.i = select i1 %cmp12.i, i1 true, i1 %cmp25.not
  %or.cond617 = select i1 %or.cond616.not, i1 %or.cond82.i, i1 false
  br i1 %or.cond617, label %if.end18.i, label %_Z16getHexxagonIndexii.exit
...
_Z16getHexxagonIndexii.exit:                      ; preds = %if.then30, %if.end18.i
  ...
  %sub38 = add nsw i32 %x.0612, -1
  %or.cond.i147 = icmp ult i32 %sub33, 9
  %or.cond54.i148 = and i1 %2, %or.cond.i147
  br i1 %or.cond54.i148, label %if.then.i153, label %_Z16getHexxagonIndexii.exit187

if.then.i153:                                     ; preds = %_Z16getHexxagonIndexii.exit
  %cmp9.i151 = icmp uge i32 %sub8.i, %sub38
  %or.cond81.i152.not641 = or i1 %cmp6.i, %cmp9.i151
  %cmp15.not.i156 = icmp slt i32 %3, %x.0612
  %or.cond82.i157 = select i1 %cmp12.i, i1 true, i1 %cmp15.not.i156
  %or.cond618 = select i1 %or.cond81.i152.not641, i1 %or.cond82.i157, i1 false
  br i1 %or.cond618, label %if.end18.i185, label %_Z16getHexxagonIndexii.exit187.thread

if.end18.i185:                                    ; preds = %if.then.i153
  ...
  br label %_Z16getHexxagonIndexii.exit187.thread

_Z16getHexxagonIndexii.exit187.thread:            ; preds = %if.then.i153, %if.end18.i185
  %retval.0.i186.ph = phi i32 [ -1, %if.then.i153 ], [ %no.7.i184, %if.end18.i185 ]
  call void @_ZN10BitBoard646setBitEi(ptr noundef nonnull align 4 dereferenceable(8) %arrayidx37, i32 noundef %retval.0.i186.ph)
  %11 = load ptr, ptr @jump_lookups, align 8, !tbaa !5
  %arrayidx42600 = getelementptr inbounds %class.BitBoard64, ptr %11, i64 %idxprom31
  br label %if.then.i194

_Z16getHexxagonIndexii.exit187:                   ; preds = %_Z16getHexxagonIndexii.exit
  call void @_ZN10BitBoard646setBitEi(ptr noundef nonnull align 4 dereferenceable(8) %arrayidx37, i32 noundef -1)
  %12 = load ptr, ptr @jump_lookups, align 8, !tbaa !5
  %arrayidx42 = getelementptr inbounds %class.BitBoard64, ptr %12, i64 %idxprom31
  br i1 %2, label %if.then.i194, label %_Z16getHexxagonIndexii.exit228

if.then.i194:                                     ; preds = %_Z16getHexxagonIndexii.exit187.thread, %_Z16getHexxagonIndexii.exit187
  %arrayidx42602 = phi ptr [ %arrayidx42600, %_Z16getHexxagonIndexii.exit187.thread ], [ %arrayidx42, %_Z16getHexxagonIndexii.exit187 ]
  %cmp9.i192 = icmp uge i32 %sub8.i, %x.0612
  %or.cond81.i193.not640 = or i1 %cmp6.i, %cmp9.i192
  %cmp15.not.i197 = icmp slt i32 %sub14.i196, %x.0612
  %or.cond82.i198 = select i1 %cmp12.i, i1 true, i1 %cmp15.not.i197
  %or.cond619 = select i1 %or.cond81.i193.not640, i1 %or.cond82.i198, i1 false
  br i1 %or.cond619, label %if.end18.i226, label %_Z16getHexxagonIndexii.exit228

if.end18.i226:                                    ; preds = %if.then.i194
  %spec.select.i204 = add i32 %add.i, %x.0612
...
_Z16getHexxagonIndexii.exit228:                   ; preds = %_Z16getHexxagonIndexii.exit187, %if.then.i194, %if.end18.i226
  %arrayidx42601 = phi ptr [ %arrayidx42602, %if.end18.i226 ], [ %arrayidx42602, %if.then.i194 ], [ %arrayidx42, %_Z16getHexxagonIndexii.exit187 ]
  %retval.0.i227 = phi i32 [ %no.7.i225, %if.end18.i226 ], [ -1, %if.then.i194 ], [ -1, %_Z16getHexxagonIndexii.exit187 ]
  call void @_ZN10BitBoard646setBitEi(ptr noundef nonnull align 4 dereferenceable(8) %arrayidx42601, i32 noundef %retval.0.i227)
  %13 = load ptr, ptr @jump_lookups, align 8, !tbaa !5
  %arrayidx46 = getelementptr inbounds %class.BitBoard64, ptr %13, i64 %idxprom31
  %or.cond54.i230 = and i1 %4, %or.cond.i
  %cmp9.i233 = icmp uge i32 %sub8.i232, %sub33
  %or.cond81.i234.not634 = or i1 %cmp6.i231, %cmp9.i233
  %or.cond620.not = select i1 %or.cond54.i230, i1 %or.cond81.i234.not634, i1 false
  %cmp15.not.i238 = icmp slt i32 %5, %x.0612
  %or.cond82.i239 = select i1 %cmp12.i236, i1 true, i1 %cmp15.not.i238
  %or.cond621 = select i1 %or.cond620.not, i1 %or.cond82.i239, i1 false
  br i1 %or.cond621, label %if.end18.i267, label %_Z16getHexxagonIndexii.exit269
...
_Z16getHexxagonIndexii.exit269:                   ; preds = %_Z16getHexxagonIndexii.exit228, %if.end18.i267
  ...
  %arrayidx51 = getelementptr inbounds %class.BitBoard64, ptr %14, i64 %idxprom31
  %add = add nuw nsw i32 %x.0612, 1
  %or.cond.i270 = icmp ult i32 %x.0612, 9
  %or.cond54.i271 = and i1 %4, %or.cond.i270
  %cmp9.i274 = icmp ugt i32 %sub8.i232, %x.0612
  %or.cond81.i275.not635 = or i1 %cmp6.i231, %cmp9.i274
  %or.cond622.not = select i1 %or.cond54.i271, i1 %or.cond81.i275.not635, i1 false
  %cmp15.not.i279 = icmp sle i32 %3, %x.0612
  %or.cond82.i280 = select i1 %cmp12.i236, i1 true, i1 %cmp15.not.i279
  %or.cond623 = select i1 %or.cond622.not, i1 %or.cond82.i280, i1 false
  br i1 %or.cond623, label %if.end18.i308, label %_Z16getHexxagonIndexii.exit310
...
_Z16getHexxagonIndexii.exit310:                   ; preds = %_Z16getHexxagonIndexii.exit269, %if.end18.i308
  ...
  %arrayidx55 = getelementptr inbounds %class.BitBoard64, ptr %15, i64 %idxprom31
  %or.cond54.i312 = and i1 %cmp3615, %or.cond.i
  %cmp9.i315 = icmp ult i32 %sub18, %sub33
  %or.cond81.i316 = and i1 %cmp16, %cmp9.i315
  %or.cond81.i316.not = xor i1 %or.cond81.i316, true
  %or.cond607.not = select i1 %or.cond54.i312, i1 %or.cond81.i316.not, i1 false
  %cmp15.not.i320 = icmp slt i32 %1, %x.0612
  %or.cond82.i321 = select i1 %cmp22, i1 true, i1 %cmp15.not.i320
  %or.cond624 = select i1 %or.cond607.not, i1 %or.cond82.i321, i1 false
  br i1 %or.cond624, label %if.end18.i349, label %_Z16getHexxagonIndexii.exit351
...
_Z16getHexxagonIndexii.exit351:                   ; preds = %_Z16getHexxagonIndexii.exit310, %if.end18.i349
  ...
  %arrayidx59 = getelementptr inbounds %class.BitBoard64, ptr %16, i64 %idxprom31
  %add60 = add nuw nsw i32 %x.0612, 2
  %or.cond.i352 = icmp ult i32 %x.0612, 8
  %or.cond54.i353 = and i1 %cmp3615, %or.cond.i352
  %cmp9.i356 = icmp ult i32 %sub18, %add60
  %or.cond81.i357 = and i1 %cmp16, %cmp9.i356
  %or.cond81.i357.not = xor i1 %or.cond81.i357, true
  %or.cond608.not = select i1 %or.cond54.i353, i1 %or.cond81.i357.not, i1 false
  %cmp15.not.i361 = icmp slt i32 %sub24, %add60
  %or.cond82.i362 = select i1 %cmp22, i1 true, i1 %cmp15.not.i361
  %or.cond625 = select i1 %or.cond608.not, i1 %or.cond82.i362, i1 false
  br i1 %or.cond625, label %if.end18.i390, label %_Z16getHexxagonIndexii.exit392
...
_Z16getHexxagonIndexii.exit392:                   ; preds = %_Z16getHexxagonIndexii.exit351, %if.end18.i390
  ...
  %arrayidx63 = getelementptr inbounds %class.BitBoard64, ptr %17, i64 %idxprom31
  %or.cond54.i394 = and i1 %6, %or.cond.i147
  br i1 %or.cond54.i394, label %if.then.i399, label %_Z16getHexxagonIndexii.exit433

if.then.i399:                                     ; preds = %_Z16getHexxagonIndexii.exit392
  %cmp9.i397 = icmp uge i32 %sub8.i396, %sub38
  %or.cond81.i398.not639 = or i1 %cmp28.i331, %cmp9.i397
  %or.cond82.i403 = select i1 %cmp16, i1 true, i1 %cmp15.not.i320
  %or.cond609 = and i1 %or.cond82.i403, %or.cond81.i398.not639
  br i1 %or.cond609, label %if.end18.i431, label %_Z16getHexxagonIndexii.exit433

if.end18.i431:                                    ; preds = %if.then.i399
  ...
  %no.5.i424 = select i1 %cmp6.i231, i32 %sub42.i423, i32 %no.4.i421
...
_Z16getHexxagonIndexii.exit433:                   ; preds = %_Z16getHexxagonIndexii.exit392, %if.then.i399, %if.end18.i431
  %retval.0.i432 = phi i32 [ %no.7.i430, %if.end18.i431 ], [ -1, %if.then.i399 ], [ -1, %_Z16getHexxagonIndexii.exit392 ]
  ...
  %arrayidx68 = getelementptr inbounds %class.BitBoard64, ptr %18, i64 %idxprom31
  %or.cond54.i435 = and i1 %6, %or.cond.i352
  %cmp9.i438 = icmp uge i32 %sub8.i396, %add60
  %or.cond81.i439.not636 = or i1 %cmp28.i331, %cmp9.i438
  %or.cond626.not = select i1 %or.cond54.i435, i1 %or.cond81.i439.not636, i1 false
  %cmp15.not.i443 = icmp slt i32 %5, %add60
  %or.cond82.i444 = select i1 %cmp16, i1 true, i1 %cmp15.not.i443
  %or.cond627 = select i1 %or.cond626.not, i1 %or.cond82.i444, i1 false
  br i1 %or.cond627, label %if.end18.i472, label %_Z16getHexxagonIndexii.exit474

if.end18.i472:                                    ; preds = %_Z16getHexxagonIndexii.exit433
  %no.2.i456.v = select i1 %cmp24.i328, i32 %x.0612, i32 %add60
  %no.2.i456 = add i32 %add.i406, %no.2.i456.v
  %no.4.i462 = add i32 %no.3.i418, %no.2.i456
  %sub42.i464 = add nsw i32 %no.4.i462, -2
  %no.5.i465 = select i1 %cmp6.i231, i32 %sub42.i464, i32 %no.4.i462
...
_Z16getHexxagonIndexii.exit474:                   ; preds = %_Z16getHexxagonIndexii.exit433, %if.end18.i472
  ...
  %arrayidx73 = getelementptr inbounds %class.BitBoard64, ptr %19, i64 %idxprom31
  br i1 %7, label %if.then.i481, label %_Z16getHexxagonIndexii.exit515.thread

_Z16getHexxagonIndexii.exit515.thread:            ; preds = %_Z16getHexxagonIndexii.exit474
  call void @_ZN10BitBoard646setBitEi(ptr noundef nonnull align 4 dereferenceable(8) %arrayidx73, i32 noundef -1)
  %20 = load ptr, ptr @jump_lookups, align 8, !tbaa !5
  br label %_Z16getHexxagonIndexii.exit556

if.then.i481:                                     ; preds = %_Z16getHexxagonIndexii.exit474
  %cmp9.i479 = icmp uge i32 %sub8.i478, %x.0612
  %or.cond81.i480.not637 = or i1 %cmp24.i328, %cmp9.i479
  %or.cond82.i485 = select i1 %cmp12.i482, i1 true, i1 %cmp15.not.i320
  %or.cond628 = select i1 %or.cond81.i480.not637, i1 %or.cond82.i485, i1 false
  br i1 %or.cond628, label %if.end18.i513, label %_Z16getHexxagonIndexii.exit515

if.end18.i513:                                    ; preds = %if.then.i481
  %no.4.i503 = add i32 %no.3.i500, %x.0612
  %sub42.i505 = add nsw i32 %no.4.i503, -2
  %no.5.i506 = select i1 %cmp32.i334, i32 %sub42.i505, i32 %no.4.i503
  %sub46.i508 = add nsw i32 %no.5.i506, -3
  %no.6.i509 = select i1 %cmp6.i231, i32 %sub46.i508, i32 %no.5.i506
...
_Z16getHexxagonIndexii.exit515:                   ; preds = %if.then.i481, %if.end18.i513
  %retval.0.i514 = phi i32 [ %no.7.i512, %if.end18.i513 ], [ -1, %if.then.i481 ]
  call void @_ZN10BitBoard646setBitEi(ptr noundef nonnull align 4 dereferenceable(8) %arrayidx73, i32 noundef %retval.0.i514)
  %21 = load ptr, ptr @jump_lookups, align 8, !tbaa !5
  %cmp9.i520 = icmp ugt i32 %sub8.i478, %x.0612
  %or.cond81.i521.not638 = or i1 %cmp24.i328, %cmp9.i520
  %or.cond629.not = select i1 %or.cond.i270, i1 %or.cond81.i521.not638, i1 false
  %cmp15.not.i525 = icmp sle i32 %1, %x.0612
  %or.cond82.i526 = select i1 %cmp12.i482, i1 true, i1 %cmp15.not.i525
  %or.cond630 = select i1 %or.cond629.not, i1 %or.cond82.i526, i1 false
  br i1 %or.cond630, label %if.end18.i554, label %_Z16getHexxagonIndexii.exit556

if.end18.i554:                                    ; preds = %_Z16getHexxagonIndexii.exit515
  %no.4.i544 = add i32 %no.3.i500, %add
  %sub42.i546 = add nsw i32 %no.4.i544, -2
  %no.5.i547 = select i1 %cmp32.i334, i32 %sub42.i546, i32 %no.4.i544
  %sub46.i549 = add nsw i32 %no.5.i547, -3
  %no.6.i550 = select i1 %cmp6.i231, i32 %sub46.i549, i32 %no.5.i547
  %sub50.i552 = add nsw i32 %no.6.i550, -4
  %no.7.i553 = select i1 %cmp40.i340, i32 %sub50.i552, i32 %no.6.i550
  br label %_Z16getHexxagonIndexii.exit556

_Z16getHexxagonIndexii.exit556:                   ; preds = %_Z16getHexxagonIndexii.exit515.thread, %_Z16getHexxagonIndexii.exit515, %if.end18.i554
  %.pn = phi ptr [ %21, %if.end18.i554 ], [ %21, %_Z16getHexxagonIndexii.exit515 ], [ %20, %_Z16getHexxagonIndexii.exit515.thread ]
  %retval.0.i555 = phi i32 [ %no.7.i553, %if.end18.i554 ], [ -1, %_Z16getHexxagonIndexii.exit515 ], [ -1, %_Z16getHexxagonIndexii.exit515.thread ]
  %arrayidx77606 = getelementptr inbounds %class.BitBoard64, ptr %.pn, i64 %idxprom31
  call void @_ZN10BitBoard646setBitEi(ptr noundef nonnull align 4 dereferenceable(8) %arrayidx77606, i32 noundef %retval.0.i555)
  %22 = load ptr, ptr @jump_lookups, align 8, !tbaa !5
  %arrayidx82 = getelementptr inbounds %class.BitBoard64, ptr %22, i64 %idxprom31
  %23 = or i32 %x.0612, %y.0614
  %or.cond54.i558 = icmp ugt i32 %23, 7
  %cmp9.i561 = icmp ult i32 %sub8.i478, %add60
  %or.cond81.i562 = and i1 %cmp6.i559, %cmp9.i561
  %or.cond631 = select i1 %or.cond54.i558, i1 true, i1 %or.cond81.i562
  %or.cond631.not = xor i1 %or.cond631, true
  %cmp15.not.i566 = icmp slt i32 %1, %add60
  %or.cond82.i567 = select i1 %cmp12.i482, i1 true, i1 %cmp15.not.i566
  %or.cond632 = select i1 %or.cond631.not, i1 %or.cond82.i567, i1 false
  br i1 %or.cond632, label %if.end18.i595, label %_Z16getHexxagonIndexii.exit597

if.end18.i595:                                    ; preds = %_Z16getHexxagonIndexii.exit556
  %no.5.i588.v = select i1 %cmp32.i334, i32 %x.0612, i32 %add60
  %no.5.i588 = add i32 %no.3.i500, %no.5.i588.v
  %sub46.i590 = add nsw i32 %no.5.i588, -3
  %no.6.i591 = select i1 %cmp6.i231, i32 %sub46.i590, i32 %no.5.i588
...
if.end87:                                         ; preds = %if.then.if.end87_crit_edge, %_Z16getHexxagonIndexii.exit597
  ...
  %no.2 = phi i32 [ %no.1611, %if.then.if.end87_crit_edge ], [ %inc86, %_Z16getHexxagonIndexii.exit597 ]
  %exitcond643.not = icmp eq i32 %inc89.pre-phi, 10
  br i1 %exitcond643.not, label %for.cond.cleanup8, label %if.then, !llvm.loop !19
}
...
for.cond.cleanup17:                               ; preds = %if.end37
  ...
  %exitcond353.not = icmp eq i32 %inc43, 10
  br i1 %exitcond353.not, label %for.cond.cleanup, label %for.body, !llvm.loop !31

if.then.i:                                        ; preds = %if.end14, %if.end37
  %x.0344 = phi i32 [ 1, %if.end14 ], [ %inc39, %if.end37 ]
  %cmp9.i = icmp uge i32 %sub8.i, %x.0344
  %or.cond81.i.not354 = or i1 %cmp7, %cmp9.i
  %cmp15.not.i = icmp slt i32 %sub14.i, %x.0344
  %or.cond82.i = select i1 %cmp12.i, i1 true, i1 %cmp15.not.i
  %or.cond = select i1 %or.cond81.i.not354, i1 %or.cond82.i, i1 false
  br i1 %or.cond, label %_Z16getHexxagonIndexii.exit, label %if.then21

_Z16getHexxagonIndexii.exit:                      ; preds = %if.then.i
...
if.then21:                                        ; preds = %if.then.i, %_Z16getHexxagonIndexii.exit
...
if.end37:                                         ; preds = %if.else34, %if.else31, %if.then29, %if.then21
  ...
  %exitcond352.not = icmp eq i32 %inc39, 10
  br i1 %exitcond352.not, label %for.cond.cleanup17, label %if.then.i, !llvm.loop !32
...
if.then.i171:                                     ; preds = %for.body.i168
  ...
  %spec.select359 = add nsw i32 %bad.030.i164, %inc5.i174
  br label %for.inc.i180

for.inc.i180:                                     ; preds = %if.then.i171, %for.body.i168
  %bad.1.i177 = phi i32 [ %bad.030.i164, %for.body.i168 ], [ %spec.select359, %if.then.i171 ]
...
if.then.i192:                                     ; preds = %for.body.i189
  ...
  %spec.select360 = add nsw i32 %bad.030.i185, %inc5.i195
  br label %for.inc.i201

for.inc.i201:                                     ; preds = %if.then.i192, %for.body.i189
  %bad.1.i198 = phi i32 [ %bad.030.i185, %for.body.i189 ], [ %spec.select360, %if.then.i192 ]
...
if.then.i213:                                     ; preds = %for.body.i210
  ...
  %spec.select361 = add nsw i32 %good.029.i207, %inc.i214
  br label %for.inc.i222

for.inc.i222:                                     ; preds = %if.then.i213, %for.body.i210
  %good.1.i218 = phi i32 [ %good.029.i207, %for.body.i210 ], [ %spec.select361, %if.then.i213 ]
...
if.then.i237:                                     ; preds = %for.body.i234
  ...
  %spec.select362 = add nsw i32 %good.029.i231, %inc.i238
  br label %for.inc.i246

for.inc.i246:                                     ; preds = %if.then.i237, %for.body.i234
  %good.1.i242 = phi i32 [ %good.029.i231, %for.body.i234 ], [ %spec.select362, %if.then.i237 ]
...
if.then.i258:                                     ; preds = %for.body.i255
  ...
  %spec.select363 = add nsw i32 %bad.030.i251, %inc5.i261
  br label %for.inc.i267

for.inc.i267:                                     ; preds = %if.then.i258, %for.body.i255
  %bad.1.i264 = phi i32 [ %bad.030.i251, %for.body.i255 ], [ %spec.select363, %if.then.i258 ]
...
if.then.i282:                                     ; preds = %for.body.i279
  ...
  %spec.select364 = add nsw i32 %bad.030.i275, %inc5.i285
  br label %for.inc.i291

for.inc.i291:                                     ; preds = %if.then.i282, %for.body.i279
  %bad.1.i288 = phi i32 [ %bad.030.i275, %for.body.i279 ], [ %spec.select364, %if.then.i282 ]
...
if.then.i303:                                     ; preds = %for.body.i300
  ...
  %spec.select365 = add nsw i32 %good.029.i297, %inc.i304
  br label %for.inc.i312

for.inc.i312:                                     ; preds = %if.then.i303, %for.body.i300
  %good.1.i308 = phi i32 [ %good.029.i297, %for.body.i300 ], [ %spec.select365, %if.then.i303 ]
