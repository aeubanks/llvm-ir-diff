...
for.end.i.i:                                      ; preds = %for.end.i.loopexit.i, %sw.bb23.i
  ...
  br i1 %cmp369.i.i, label %for.body5.lr.ph.i.i, label %FmoGenerateMapUnitToSliceGroupMap.exit
...
for.body5.i.i:                                    ; preds = %for.cond2.loopexit.i.i, %for.body5.lr.ph.i.i
  %indvars.iv.i = phi i64 [ %indvars.iv.next.i, %for.cond2.loopexit.i.i ], [ %33, %for.body5.lr.ph.i.i ]
...
define dso_local i32 @FmoGetNextMBNr(i32 noundef %CurrentMbNr) local_unnamed_addr #7 {
entry:
  %0 = load ptr, ptr @MBAmap, align 8, !tbaa !19
...
land.rhs:                                         ; preds = %while.cond
  ...
  %6 = load i8, ptr %arrayidx, align 1, !tbaa !23
...
while.end:                                        ; preds = %while.cond, %while.end.split.loop.exit11
  %inc.lcssa = phi i32 [ %7, %while.end.split.loop.exit11 ], [ %smax, %while.cond ]
  %cmp4.not = icmp slt i32 %inc.lcssa, %3
  %inc. = select i1 %cmp4.not, i32 %inc.lcssa, i32 -1
  ret i32 %inc.
}
...
entry:
  ...
  %4 = sext i32 %3 to i64
  %5 = add nsw i32 %mb, 1
  %smax.i = tail call i32 @llvm.smax.i32(i32 %3, i32 %5)
...
land.rhs.i:                                       ; preds = %while.cond.i
  ...
  %6 = load i8, ptr %arrayidx.i4, align 1, !tbaa !23
...
FmoGetNextMBNr.exit:                              ; preds = %while.cond.i, %while.end.split.loop.exit11.i
  %inc.lcssa.i = phi i32 [ %7, %while.end.split.loop.exit11.i ], [ %smax.i, %while.cond.i ]
  %cmp4.not.i = icmp slt i32 %inc.lcssa.i, %3
  %inc..i = select i1 %cmp4.not.i, i32 %inc.lcssa.i, i32 -1
