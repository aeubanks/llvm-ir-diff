...
define dso_local ptr @phalf(ptr noundef %0) local_unnamed_addr #0 {
  %2 = load ptr, ptr @ptwo, align 8, !tbaa !5
  %3 = tail call ptr @pdivmod(ptr noundef %0, ptr noundef %2, ptr noundef nonnull inttoptr (i64 -1 to ptr), ptr noundef null) #2
  ret ptr %3
}
