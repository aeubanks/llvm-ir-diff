...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load92 = load <4 x float>, ptr %14, align 4, !tbaa !28
  store <4 x float> %wide.load, ptr %12, align 4, !tbaa !28
  %15 = getelementptr inbounds float, ptr %12, i64 4
  store <4 x float> %wide.load92, ptr %15, align 4, !tbaa !28
...
for.body.i.i.i64.prol:                            ; preds = %for.body.i.i.i64.preheader, %for.body.i.i.i64.prol
  ...
  %19 = load float, ptr %arrayidx3.i.i.i61.prol, align 4, !tbaa !28
  store float %19, ptr %arrayidx.i.i.i60.prol, align 4, !tbaa !28
  ...
  br i1 %prol.iter.cmp.not, label %for.body.i.i.i64.prol.loopexit, label %for.body.i.i.i64.prol, !llvm.loop !33
...
for.body.i.i.i64:                                 ; preds = %for.body.i.i.i64.prol.loopexit, %for.body.i.i.i64
  ...
  %21 = load float, ptr %arrayidx3.i.i.i61, align 4, !tbaa !28
  store float %21, ptr %arrayidx.i.i.i60, align 4, !tbaa !28
  ...
  %22 = load float, ptr %arrayidx3.i.i.i61.1, align 4, !tbaa !28
  store float %22, ptr %arrayidx.i.i.i60.1, align 4, !tbaa !28
  ...
  %23 = load float, ptr %arrayidx3.i.i.i61.2, align 4, !tbaa !28
  store float %23, ptr %arrayidx.i.i.i60.2, align 4, !tbaa !28
  ...
  %24 = load float, ptr %arrayidx3.i.i.i61.3, align 4, !tbaa !28
  store float %24, ptr %arrayidx.i.i.i60.3, align 4, !tbaa !28
  ...
  br i1 %exitcond.not.i.i.i63.3, label %if.then.i11.i.i, label %for.body.i.i.i64, !llvm.loop !35
...
if.then.i11.i.i:                                  ; preds = %for.body.i.i.i64.prol.loopexit, %for.body.i.i.i64, %middle.block, %_ZNK20btAlignedObjectArrayIfE4copyEiiPf.exit.i.i
  %25 = load i8, ptr %m_ownsMemory.i.i35, align 8, !tbaa !18, !range !36, !noundef !37
...
for.body.epil:                                    ; preds = %for.cond.cleanup.loopexit.unr-lcssa
  ...
  store float %33, ptr %arrayidx.i84.epil, align 4, !tbaa !28
...
for.body:                                         ; preds = %for.body, %for.body.preheader.new
  ...
  store float %38, ptr %arrayidx.i84, align 4, !tbaa !28
  ...
  store float %41, ptr %arrayidx.i84.1, align 4, !tbaa !28
...
_ZN20btAlignedObjectArrayIfED2Ev.exit:            ; preds = %if.then3.i.i.i, %entry
  ...
  %3 = load i8, ptr %m_ownsMemory.i.i.i10, align 8
...
_ZN20btAlignedObjectArrayIfED2Ev.exit.i:          ; preds = %if.then3.i.i.i.i, %entry
  ...
  %3 = load i8, ptr %m_ownsMemory.i.i.i10.i, align 8
