...
55:                                               ; preds = %17, %36
  ...
  %73 = tail call float @llvm.fmuladd.f32(float %64, float %64, float %72)
  %74 = tail call float @llvm.sqrt.f32(float %73)
  %75 = fadd float %9, %11
  %76 = fmul float %75, 5.000000e-01
  %77 = fadd <2 x float> %6, %7
  %78 = fmul float %74, %56
  %79 = fmul float %74, %57
  %80 = fmul <2 x float> %77, <float 5.000000e-01, float 5.000000e-01>
  ...
  %86 = tail call float @llvm.fmuladd.f32(float %14, float %76, float %85)
  %87 = fsub float %86, %62
  %88 = fmul float %14, %87
  %89 = fsub float %76, %88
