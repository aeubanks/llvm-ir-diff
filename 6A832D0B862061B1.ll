; ModuleID = '/usr/local/google/home/aeubanks/repos/test-suite/MultiSource/Benchmarks/VersaBench/dbms/getDeleteCommand.c'
source_filename = "/usr/local/google/home/aeubanks/repos/test-suite/MultiSource/Benchmarks/VersaBench/dbms/getDeleteCommand.c"
...
define dso_local i64 @getDeleteCommand(ptr noundef %file, ptr nocapture noundef writeonly %searchKey, ptr nocapture noundef %searchNonKey) local_unnamed_addr #0 {
entry:
...
if.then14:                                        ; preds = %if.then
  ...
  call void @errorMessage(ptr noundef nonnull @getDeleteCommand.name, i8 noundef signext 1) #4
  br label %cleanup115
