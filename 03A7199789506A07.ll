...
for.cond:                                         ; preds = %cleanup16
  ...
  %spec.select35 = sub i64 %totalSize.041, %conv10
  %cmp.not = icmp eq i64 %spec.select35, 0
  br i1 %cmp.not, label %cleanup19, label %for.body, !llvm.loop !35

for.body:                                         ; preds = %for.body.lr.ph, %for.cond
  %indvars.iv = phi i64 [ 0, %for.body.lr.ph ], [ %indvars.iv.next, %for.cond ]
  %totalSize.041 = phi i64 [ %0, %for.body.lr.ph ], [ %spec.select35, %for.cond ]
...
if.end.i.i:                                       ; preds = %if.then
  ...
  br i1 %cmp2.i.i, label %return.sink.split.i.i, label %return.sink.split.i.i.thread

return.sink.split.i.i.thread:                     ; preds = %if.end.i.i
  store i32 %add.i.i, ptr %_count.i.i, align 8, !tbaa !21
  %5 = load ptr, ptr %_sync.i.i, align 8, !tbaa !19
...
return.sink.split.i.i:                            ; preds = %if.end.i.i
  %6 = load ptr, ptr %_sync.i.i, align 8, !tbaa !19
  %call.i10.i.i = tail call i32 @pthread_mutex_unlock(ptr noundef nonnull %6) #9
  br label %return

if.end8:                                          ; preds = %return.sink.split.i.i.thread, %if.then
  store i8 0, ptr %LockMode, align 8, !tbaa !36
  br label %return

return:                                           ; preds = %return.sink.split.i.i, %entry, %if.end8
  %retval.1 = phi i32 [ 1, %return.sink.split.i.i ], [ 0, %if.end8 ], [ 0, %entry ]
  ret i32 %retval.1
}
