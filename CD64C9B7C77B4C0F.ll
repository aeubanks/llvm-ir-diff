...
define dso_local i32 @foo() local_unnamed_addr #0 {
  %1 = load i32, ptr getelementptr inbounds (%struct.type, ptr @t, i64 0, i32 1), align 8
  %2 = lshr i32 %1, 16
  %3 = and i32 %2, 511
  ret i32 %3
}
...
define dso_local i32 @main() local_unnamed_addr #1 {
  ...
  %3 = or i32 %2, 524288
  store i32 %3, ptr getelementptr inbounds (%struct.type, ptr @t, i64 0, i32 1), align 8
  ret i32 0
}
