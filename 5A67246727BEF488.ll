...
do.end:                                           ; preds = %do.cond
  ...
  %cmp53242.not = icmp eq i32 %add51, 0
  br i1 %cmp53242.not, label %cleanup87, label %for.body.lr.ph
...
for.body:                                         ; preds = %for.body.lr.ph, %for.cond52
  %pos.0243 = phi i32 [ 0, %for.body.lr.ph ], [ %inc77, %for.cond52 ]
  %8 = zext i32 %pos.0243 to i64
  br label %for.cond54
...
if.end63:                                         ; preds = %for.end
  %arrayidx55.le = getelementptr inbounds i8, ptr %call.i174, i64 %indvars.iv
