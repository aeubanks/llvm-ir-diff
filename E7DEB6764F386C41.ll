...
if.end:                                           ; preds = %if.then, %entry
  ...
  %or.cond1182 = select i1 %tobool2.not, i1 %cmp.not.i, i1 false
  br i1 %or.cond1182, label %if.end.i, label %cleanup355
...
if.then14.i:                                      ; preds = %ReadMatchDistances.exit
  ...
  %.pre1136 = load i32, ptr %additionalOffset.i, align 4, !tbaa !97
...
RangeEnc_EncodeBit.exit:                          ; preds = %ReadMatchDistances.exit, %if.then14.i
  ...
  %25 = phi i32 [ %inc29.i, %ReadMatchDistances.exit ], [ %.pre1136, %if.then14.i ]
...
for.cond.preheader:                               ; preds = %if.end35
  ...
  %pbMask1043 = getelementptr inbounds %struct.CLzmaEnc, ptr %p, i64 0, i32 28
...
land.rhs.us.1.i:                                  ; preds = %for.inc.us.1.i, %land.rhs.us.preheader.1.i
  ...
  br i1 %cmp34.us.1.i, label %for.inc.us.1.i, label %for.end.us.1.split.loop.exit568.i
...
for.end.us.1.split.loop.exit568.i:                ; preds = %land.rhs.us.1.i
  %74 = trunc i64 %indvars.iv.1.i to i32
  br label %for.end.us.1.i

for.end.us.1.i:                                   ; preds = %for.inc.us.1.i, %for.end.us.1.split.loop.exit568.i
  %len.0.lcssa.us.1.i = phi i32 [ %74, %for.end.us.1.split.loop.exit568.i ], [ %spec.store.select.i549, %for.inc.us.1.i ]
...
land.rhs.us.2.i:                                  ; preds = %for.inc.us.2.i, %land.rhs.us.preheader.2.i
  ...
  br i1 %cmp34.us.2.i, label %for.inc.us.2.i, label %for.end.us.2.split.loop.exit570.i
...
for.end.us.2.split.loop.exit570.i:                ; preds = %land.rhs.us.2.i
  %82 = trunc i64 %indvars.iv.2.i to i32
  br label %for.end.us.2.i

for.end.us.2.i:                                   ; preds = %for.inc.us.2.i, %for.end.us.2.split.loop.exit570.i
  %len.0.lcssa.us.2.i = phi i32 [ %82, %for.end.us.2.split.loop.exit570.i ], [ %spec.store.select.i549, %for.inc.us.2.i ]
...
land.rhs.us.3.i:                                  ; preds = %for.inc.us.3.i, %land.rhs.us.preheader.3.i
  ...
  br i1 %cmp34.us.3.i, label %for.inc.us.3.i, label %for.end.us.3.split.loop.exit572.i
...
for.end.us.3.split.loop.exit572.i:                ; preds = %land.rhs.us.3.i
  %90 = trunc i64 %indvars.iv.3.i to i32
  br label %for.end.us.3.i

for.end.us.3.i:                                   ; preds = %for.inc.us.3.i, %for.end.us.3.split.loop.exit572.i
  %len.0.lcssa.us.3.i = phi i32 [ %90, %for.end.us.3.split.loop.exit572.i ], [ %spec.store.select.i549, %for.inc.us.3.i ]
...
land.rhs68.i:                                     ; preds = %if.end82.i, %land.rhs68.preheader.i
  %indvars.iv519.i = phi i64 [ %112, %land.rhs68.preheader.i ], [ %indvars.iv.next520.i, %if.end82.i ]
  %mainDist.0476.i = phi i32 [ %mainDist.0472.i, %land.rhs68.preheader.i ], [ %115, %if.end82.i ]
  %mainLen.1475.i = phi i32 [ %mainLen.0.i, %land.rhs68.preheader.i ], [ %113, %if.end82.i ]
  %sub69.i = add nsw i64 %indvars.iv519.i, 4294967292
...
while.body.i:                                     ; preds = %land.rhs68.i
  ...
  %114 = add nsw i64 %indvars.iv519.i, -3
  ...
  br i1 %cmp79.i, label %if.end82.i, label %while.end.i

if.end82.i:                                       ; preds = %while.body.i
  %indvars.iv.next520.i = add nsw i64 %indvars.iv519.i, -2
  %indvars.i = trunc i64 %indvars.iv.next520.i to i32
  %cmp66.i = icmp ugt i32 %indvars.i, 2
  br i1 %cmp66.i, label %land.rhs68.i, label %while.end.i, !llvm.loop !147

while.end.i:                                      ; preds = %if.end82.i, %while.body.i, %land.rhs68.i, %if.then62.i
  %mainLen.1.lcssa.i = phi i32 [ %mainLen.0.i, %if.then62.i ], [ %mainLen.1475.i, %land.rhs68.i ], [ %mainLen.1475.i, %while.body.i ], [ %113, %if.end82.i ]
  %mainDist.0.lcssa.i = phi i32 [ %mainDist.0472.i, %if.then62.i ], [ %mainDist.0476.i, %land.rhs68.i ], [ %mainDist.0476.i, %while.body.i ], [ %115, %if.end82.i ]
...
ReadMatchDistances.exit421.thread.i:              ; preds = %if.end126.i
  ...
  %inc29.i420447.i = add i32 %120, 1
  store i32 %inc29.i420447.i, ptr %additionalOffset.i542, align 4, !tbaa !97
...
lor.lhs.false144.i:                               ; preds = %if.then133.i
  ...
  %or.cond433.not503.i = select i1 %cmp147.i, i1 %cmp151.i, i1 false
  %cmp156.i = icmp ugt i32 %lenRes.1.i418.i, %add146.i
  %or.cond434.i = or i1 %cmp156.i, %or.cond433.not503.i
  br i1 %or.cond434.i, label %if.end47, label %cleanup172.i
...
cleanup172.i:                                     ; preds = %lor.lhs.false144.i
  ...
  %or.cond435.i = select i1 %or.cond253.i, i1 %cmp168.i, i1 false
  br i1 %or.cond435.i, label %if.end47, label %if.end175.i
...
land.rhs213.us.preheader.i:                       ; preds = %lor.lhs.false200.us.i
  %wide.trip.count533.i = zext i32 %sub209.i to i64
  br label %land.rhs213.us.i

land.rhs213.us.i:                                 ; preds = %for.inc224.us.i, %land.rhs213.us.preheader.i
  %indvars.iv529.i = phi i64 [ 2, %land.rhs213.us.preheader.i ], [ %indvars.iv.next530.i, %for.inc224.us.i ]
  %arrayidx215.us.i = getelementptr inbounds i8, ptr %add.ptr180.i, i64 %indvars.iv529.i
  %140 = load i8, ptr %arrayidx215.us.i, align 1, !tbaa !24
  %arrayidx218.us.i = getelementptr inbounds i8, ptr %add.ptr193.us.i, i64 %indvars.iv529.i
  %141 = load i8, ptr %arrayidx218.us.i, align 1, !tbaa !24
  %cmp220.us.i = icmp eq i8 %140, %141
  br i1 %cmp220.us.i, label %for.inc224.us.i, label %for.end226.us.i

for.end226.us.i:                                  ; preds = %land.rhs213.us.i
  %142 = trunc i64 %indvars.iv529.i to i32
  %cmp227.not.us.i = icmp ugt i32 %sub209.i, %142
  br i1 %cmp227.not.us.i, label %for.inc236.us.i, label %if.end47

for.inc236.us.i:                                  ; preds = %for.end226.us.i, %lor.lhs.false200.us.i, %for.body184.us.preheader.i
  %143 = load i32, ptr %arrayidx.1.i, align 4, !tbaa !22
  %add190.us.1.i = add i32 %143, 1
  ...
  %144 = load i8, ptr %add.ptr193.us.1.i, align 1, !tbaa !24
  %cmp198.not.us.1.i = icmp eq i8 %135, %144
...
lor.lhs.false200.us.1.i:                          ; preds = %for.inc236.us.i
  %145 = load i8, ptr %call179.i, align 1, !tbaa !24
  %arrayidx203.us.1.i = getelementptr inbounds i8, ptr %add.ptr193.us.1.i, i64 1
  %146 = load i8, ptr %arrayidx203.us.1.i, align 1, !tbaa !24
  %cmp205.not.us.1.i = icmp eq i8 %145, %146
...
land.rhs213.us.preheader.1.i:                     ; preds = %lor.lhs.false200.us.1.i
  %wide.trip.count533.1.i = zext i32 %sub209.i to i64
  br label %land.rhs213.us.1.i

land.rhs213.us.1.i:                               ; preds = %for.inc224.us.1.i, %land.rhs213.us.preheader.1.i
  %indvars.iv529.1.i = phi i64 [ 2, %land.rhs213.us.preheader.1.i ], [ %indvars.iv.next530.1.i, %for.inc224.us.1.i ]
  %arrayidx215.us.1.i = getelementptr inbounds i8, ptr %add.ptr180.i, i64 %indvars.iv529.1.i
  %147 = load i8, ptr %arrayidx215.us.1.i, align 1, !tbaa !24
  %arrayidx218.us.1.i = getelementptr inbounds i8, ptr %add.ptr193.us.1.i, i64 %indvars.iv529.1.i
  %148 = load i8, ptr %arrayidx218.us.1.i, align 1, !tbaa !24
  %cmp220.us.1.i = icmp eq i8 %147, %148
  br i1 %cmp220.us.1.i, label %for.inc224.us.1.i, label %for.end226.us.1.i

for.inc224.us.1.i:                                ; preds = %land.rhs213.us.1.i
  %indvars.iv.next530.1.i = add nuw nsw i64 %indvars.iv529.1.i, 1
  %exitcond534.1.not.i = icmp eq i64 %indvars.iv.next530.1.i, %wide.trip.count533.1.i
  br i1 %exitcond534.1.not.i, label %if.end47, label %land.rhs213.us.1.i, !llvm.loop !148

for.end226.us.1.i:                                ; preds = %land.rhs213.us.1.i
  %149 = trunc i64 %indvars.iv529.1.i to i32
  %cmp227.not.us.1.i = icmp ugt i32 %sub209.i, %149
  br i1 %cmp227.not.us.1.i, label %for.inc236.us.1.i, label %if.end47

for.inc236.us.1.i:                                ; preds = %for.end226.us.1.i, %lor.lhs.false200.us.1.i, %for.inc236.us.i
  %150 = load i32, ptr %arrayidx.2.i, align 4, !tbaa !22
  ...
  %cmp198.not.us.2.i = icmp eq i8 %135, %151
...
land.rhs213.us.preheader.2.i:                     ; preds = %lor.lhs.false200.us.2.i
  %wide.trip.count533.2.i = zext i32 %sub209.i to i64
  br label %land.rhs213.us.2.i

land.rhs213.us.2.i:                               ; preds = %for.inc224.us.2.i, %land.rhs213.us.preheader.2.i
  %indvars.iv529.2.i = phi i64 [ 2, %land.rhs213.us.preheader.2.i ], [ %indvars.iv.next530.2.i, %for.inc224.us.2.i ]
  %arrayidx215.us.2.i = getelementptr inbounds i8, ptr %add.ptr180.i, i64 %indvars.iv529.2.i
  %154 = load i8, ptr %arrayidx215.us.2.i, align 1, !tbaa !24
  %arrayidx218.us.2.i = getelementptr inbounds i8, ptr %add.ptr193.us.2.i, i64 %indvars.iv529.2.i
  %155 = load i8, ptr %arrayidx218.us.2.i, align 1, !tbaa !24
  %cmp220.us.2.i = icmp eq i8 %154, %155
  br i1 %cmp220.us.2.i, label %for.inc224.us.2.i, label %for.end226.us.2.i

for.inc224.us.2.i:                                ; preds = %land.rhs213.us.2.i
  %indvars.iv.next530.2.i = add nuw nsw i64 %indvars.iv529.2.i, 1
  %exitcond534.2.not.i = icmp eq i64 %indvars.iv.next530.2.i, %wide.trip.count533.2.i
  br i1 %exitcond534.2.not.i, label %if.end47, label %land.rhs213.us.2.i, !llvm.loop !148

for.end226.us.2.i:                                ; preds = %land.rhs213.us.2.i
  %156 = trunc i64 %indvars.iv529.2.i to i32
  %cmp227.not.us.2.i = icmp ugt i32 %sub209.i, %156
  br i1 %cmp227.not.us.2.i, label %for.inc236.us.2.i, label %if.end47

for.inc236.us.2.i:                                ; preds = %for.end226.us.2.i, %lor.lhs.false200.us.2.i, %for.inc236.us.1.i
  %157 = load i32, ptr %arrayidx.3.i, align 4, !tbaa !22
  %add190.us.3.i = add i32 %157, 1
  ...
  %158 = load i8, ptr %add.ptr193.us.3.i, align 1, !tbaa !24
  %cmp198.not.us.3.i = icmp eq i8 %135, %158
  br i1 %cmp198.not.us.3.i, label %lor.lhs.false200.us.3.i, label %for.end238.i

lor.lhs.false200.us.3.i:                          ; preds = %for.inc236.us.2.i
  %159 = load i8, ptr %call179.i, align 1, !tbaa !24
  %arrayidx203.us.3.i = getelementptr inbounds i8, ptr %add.ptr193.us.3.i, i64 1
  %160 = load i8, ptr %arrayidx203.us.3.i, align 1, !tbaa !24
  %cmp205.not.us.3.i = icmp eq i8 %159, %160
...
land.rhs213.us.preheader.3.i:                     ; preds = %lor.lhs.false200.us.3.i
  %wide.trip.count533.3.i = zext i32 %sub209.i to i64
  br label %land.rhs213.us.3.i

land.rhs213.us.3.i:                               ; preds = %for.inc224.us.3.i, %land.rhs213.us.preheader.3.i
  %indvars.iv529.3.i = phi i64 [ 2, %land.rhs213.us.preheader.3.i ], [ %indvars.iv.next530.3.i, %for.inc224.us.3.i ]
  %arrayidx215.us.3.i = getelementptr inbounds i8, ptr %add.ptr180.i, i64 %indvars.iv529.3.i
  %161 = load i8, ptr %arrayidx215.us.3.i, align 1, !tbaa !24
  %arrayidx218.us.3.i = getelementptr inbounds i8, ptr %add.ptr193.us.3.i, i64 %indvars.iv529.3.i
  %162 = load i8, ptr %arrayidx218.us.3.i, align 1, !tbaa !24
  %cmp220.us.3.i = icmp eq i8 %161, %162
  br i1 %cmp220.us.3.i, label %for.inc224.us.3.i, label %for.end226.us.3.i

for.inc224.us.3.i:                                ; preds = %land.rhs213.us.3.i
  %indvars.iv.next530.3.i = add nuw nsw i64 %indvars.iv529.3.i, 1
  %exitcond534.3.not.i = icmp eq i64 %indvars.iv.next530.3.i, %wide.trip.count533.3.i
  br i1 %exitcond534.3.not.i, label %if.end47, label %land.rhs213.us.3.i, !llvm.loop !148

for.end226.us.3.i:                                ; preds = %land.rhs213.us.3.i
  %163 = trunc i64 %indvars.iv529.3.i to i32
  %cmp227.not.us.3.i = icmp ugt i32 %sub209.i, %163
  br i1 %cmp227.not.us.3.i, label %for.end238.i, label %if.end47

for.inc224.us.i:                                  ; preds = %land.rhs213.us.i
  %indvars.iv.next530.i = add nuw nsw i64 %indvars.iv529.i, 1
  %exitcond534.not.i = icmp eq i64 %indvars.iv.next530.i, %wide.trip.count533.i
  br i1 %exitcond534.not.i, label %if.end47, label %land.rhs213.us.i, !llvm.loop !148
...
lor.lhs.false200.i:                               ; preds = %for.body184.preheader.i
  ...
  %165 = load i8, ptr %arrayidx203.i, align 1, !tbaa !24
  %cmp205.not.i = icmp eq i8 %164, %165
  br i1 %cmp205.not.i, label %if.end47, label %for.inc236.i

for.inc236.i:                                     ; preds = %lor.lhs.false200.i, %for.body184.preheader.i
  %166 = load i32, ptr %arrayidx.1.i, align 4, !tbaa !22
  %add190.1.i = add i32 %166, 1
  ...
  %167 = load i8, ptr %add.ptr193.1.i, align 1, !tbaa !24
  %cmp198.not.1.i = icmp eq i8 %135, %167
...
lor.lhs.false200.1.i:                             ; preds = %for.inc236.i
  ...
  %169 = load i8, ptr %arrayidx203.1.i, align 1, !tbaa !24
  %cmp205.not.1.i = icmp eq i8 %168, %169
  br i1 %cmp205.not.1.i, label %if.end47, label %for.inc236.1.i

for.inc236.1.i:                                   ; preds = %lor.lhs.false200.1.i, %for.inc236.i
  %170 = load i32, ptr %arrayidx.2.i, align 4, !tbaa !22
  %add190.2.i = add i32 %170, 1
  ...
  %171 = load i8, ptr %add.ptr193.2.i, align 1, !tbaa !24
  %cmp198.not.2.i = icmp eq i8 %135, %171
...
lor.lhs.false200.2.i:                             ; preds = %for.inc236.1.i
  ...
  %173 = load i8, ptr %arrayidx203.2.i, align 1, !tbaa !24
  %cmp205.not.2.i = icmp eq i8 %172, %173
  br i1 %cmp205.not.2.i, label %if.end47, label %for.inc236.2.i

for.inc236.2.i:                                   ; preds = %lor.lhs.false200.2.i, %for.inc236.1.i
  %174 = load i32, ptr %arrayidx.3.i, align 4, !tbaa !22
  %add190.3.i = add i32 %174, 1
  ...
  %175 = load i8, ptr %add.ptr193.3.i, align 1, !tbaa !24
  %cmp198.not.3.i = icmp eq i8 %135, %175
  br i1 %cmp198.not.3.i, label %lor.lhs.false200.3.i, label %for.end238.i

lor.lhs.false200.3.i:                             ; preds = %for.inc236.2.i
  %176 = load i8, ptr %call179.i, align 1, !tbaa !24
  %arrayidx203.3.i = getelementptr inbounds i8, ptr %add.ptr193.3.i, i64 1
  %177 = load i8, ptr %arrayidx203.3.i, align 1, !tbaa !24
  %cmp205.not.3.i = icmp eq i8 %176, %177
  br i1 %cmp205.not.3.i, label %if.end47, label %for.end238.i

for.end238.i:                                     ; preds = %lor.lhs.false200.3.i, %for.inc236.2.i, %for.end226.us.3.i, %lor.lhs.false200.us.3.i, %for.inc236.us.2.i
...
cleanup241.sink.split.i:                          ; preds = %for.cond25.preheader.i, %for.cond25.preheader.1.i, %for.cond25.preheader.2.i, %for.cond25.preheader.3.i, %for.end238.i, %if.then.i378.i, %if.then53.i, %if.then39.i
  ...
  %sub545.sink575.i = phi i32 [ %sub118.i, %if.then.i378.i ], [ %sub240.i, %for.end238.i ], [ %sub58.i, %if.then53.i ], [ %sub.i559, %if.then39.i ], [ 1, %for.cond25.preheader.3.i ], [ 1, %for.cond25.preheader.2.i ], [ 1, %for.cond25.preheader.1.i ], [ 1, %for.cond25.preheader.i ]
  ...
  %178 = load i32, ptr %additionalOffset.i542, align 4, !tbaa !97
  %add.i363.i = add i32 %178, %sub545.sink575.i
  store i32 %add.i363.i, ptr %additionalOffset.i542, align 4, !tbaa !97
  %179 = load ptr, ptr %Skip.i.i, align 8, !tbaa !149
  %180 = load ptr, ptr %matchFinderObj38, align 8, !tbaa !121
  tail call void %179(ptr noundef %180, i32 noundef %sub545.sink575.i) #16
  br label %if.end47
...
if.else:                                          ; preds = %for.cond
  ...
  %181 = load i32, ptr %optimumEndIndex.i, align 8, !tbaa !95
  %182 = load i32, ptr %optimumCurrentIndex.i, align 4, !tbaa !96
  %cmp.not.i561 = icmp eq i32 %181, %182
  br i1 %cmp.not.i561, label %if.end.i566, label %if.then.i564

if.then.i564:                                     ; preds = %if.else
  %idxprom.i562 = zext i32 %182 to i64
  %posPrev.i = getelementptr inbounds %struct.CLzmaEnc, ptr %p, i64 0, i32 11, i64 %idxprom.i562, i32 6
  %183 = load i32, ptr %posPrev.i, align 4, !tbaa !150
  %sub.i563 = sub i32 %183, %182
  %backPrev.i = getelementptr inbounds %struct.CLzmaEnc, ptr %p, i64 0, i32 11, i64 %idxprom.i562, i32 7
  %184 = load i32, ptr %backPrev.i, align 4, !tbaa !152
  store i32 %183, ptr %optimumCurrentIndex.i, align 4, !tbaa !96
...
if.end.i566:                                      ; preds = %if.else
  ...
  %185 = load i32, ptr %additionalOffset.i542, align 4, !tbaa !97
  %cmp8.i = icmp eq i32 %185, 0
  br i1 %cmp8.i, label %if.then9.i, label %if.else.i609

if.then9.i:                                       ; preds = %if.end.i566
  %186 = load ptr, ptr %GetNumAvailableBytes37, align 8, !tbaa !126
  %187 = load ptr, ptr %matchFinderObj38, align 8, !tbaa !121
  %call.i.i569 = tail call i32 %186(ptr noundef %187) #16
  store i32 %call.i.i569, ptr %numAvail.i.i, align 8, !tbaa !139
  %188 = load ptr, ptr %GetMatches.i.i, align 8, !tbaa !140
  %189 = load ptr, ptr %matchFinderObj38, align 8, !tbaa !121
  %call3.i.i573 = tail call i32 %188(ptr noundef %189, ptr noundef nonnull %matches.i.i) #16
...
if.then.i.i580:                                   ; preds = %if.then9.i
  ...
  %190 = load i32, ptr %arrayidx.i.i577, align 4, !tbaa !22
  %191 = load i32, ptr %numFastBytes.i.i, align 8, !tbaa !66
  %cmp5.i.i579 = icmp eq i32 %190, %191
  br i1 %cmp5.i.i579, label %if.then6.i.i593, label %ReadMatchDistances.exit.i607

if.then6.i.i593:                                  ; preds = %if.then.i.i580
  %192 = load ptr, ptr %GetPointerToCurrentPos.i.i, align 8, !tbaa !127
  %193 = load ptr, ptr %matchFinderObj38, align 8, !tbaa !121
  %call9.i.i582 = tail call ptr %192(ptr noundef %193) #16
  ...
  %194 = load i32, ptr %arrayidx13.i.i586, align 4, !tbaa !22
  %add.i.i587 = add i32 %194, 1
  %195 = load i32, ptr %numAvail.i.i, align 8, !tbaa !139
  %spec.store.select.i.i588 = tail call i32 @llvm.umin.i32(i32 %195, i32 273)
  ...
  %cmp1952.i.i592 = icmp ult i32 %190, %spec.store.select.i.i588
...
land.rhs.i.i599:                                  ; preds = %for.inc.i.i603, %land.rhs.preheader.i.i594
  %indvars.iv.i.i595 = phi i64 [ %196, %land.rhs.preheader.i.i594 ], [ %indvars.iv.next.i.i600, %for.inc.i.i603 ]
  %arrayidx21.i.i596 = getelementptr inbounds i8, ptr %add.ptr.i.i583, i64 %indvars.iv.i.i595
  %197 = load i8, ptr %arrayidx21.i.i596, align 1, !tbaa !24
  %arrayidx23.i.i597 = getelementptr inbounds i8, ptr %add.ptr18.i.i591, i64 %indvars.iv.i.i595
  %198 = load i8, ptr %arrayidx23.i.i597, align 1, !tbaa !24
  %cmp25.i.i598 = icmp eq i8 %197, %198
...
if.end28.loopexit.split.loop.exit.i.i604:         ; preds = %land.rhs.i.i599
  %199 = trunc i64 %indvars.iv.i.i595 to i32
...
ReadMatchDistances.exit.i607:                     ; preds = %for.inc.i.i603, %if.end28.loopexit.split.loop.exit.i.i604, %if.then6.i.i593, %if.then.i.i580, %if.then9.i
  %lenRes.1.i.i605 = phi i32 [ %190, %if.then.i.i580 ], [ 0, %if.then9.i ], [ %190, %if.then6.i.i593 ], [ %199, %if.end28.loopexit.split.loop.exit.i.i604 ], [ %spec.store.select.i.i588, %for.inc.i.i603 ]
  %200 = load i32, ptr %additionalOffset.i542, align 4, !tbaa !97
  %inc29.i.i606 = add i32 %200, 1
  store i32 %inc29.i.i606, ptr %additionalOffset.i542, align 4, !tbaa !97
  br label %if.end11.i

if.else.i609:                                     ; preds = %if.end.i566
  %201 = load i32, ptr %longestMatchLength.i, align 8, !tbaa !144
  %202 = load i32, ptr %numPairs1.i, align 4, !tbaa !145
  br label %if.end11.i

if.end11.i:                                       ; preds = %if.else.i609, %ReadMatchDistances.exit.i607
  %numPairs.0.i610 = phi i32 [ %call3.i.i573, %ReadMatchDistances.exit.i607 ], [ %202, %if.else.i609 ]
  %mainLen.0.i611 = phi i32 [ %lenRes.1.i.i605, %ReadMatchDistances.exit.i607 ], [ %201, %if.else.i609 ]
  %203 = load i32, ptr %numAvail.i.i, align 8, !tbaa !139
  %cmp13.i = icmp ult i32 %203, 2
  br i1 %cmp13.i, label %GetOptimum.exit, label %if.end15.i

if.end15.i:                                       ; preds = %if.end11.i
  %spec.store.select.i613 = tail call i32 @llvm.umin.i32(i32 %203, i32 273)
  %204 = load ptr, ptr %GetPointerToCurrentPos.i.i, align 8, !tbaa !127
  %205 = load ptr, ptr %matchFinderObj38, align 8, !tbaa !121
  %call19.i = tail call ptr %204(ptr noundef %205) #16
  %add.ptr.i616 = getelementptr inbounds i8, ptr %call19.i, i64 -1
  %206 = load i8, ptr %add.ptr.i616, align 1, !tbaa !24
  ...
  %207 = load i32, ptr %arrayidx.us.i, align 4, !tbaa !22
  %add.i617 = add i32 %207, 1
  ...
  %208 = load i8, ptr %add.ptr28.i, align 1, !tbaa !24
  %cmp32.not.i = icmp eq i8 %206, %208
  br i1 %cmp32.not.i, label %lor.lhs.false.i620, label %cleanup.i

lor.lhs.false.i620:                               ; preds = %if.end15.i
  %209 = load i8, ptr %call19.i, align 1, !tbaa !24
  %arrayidx36.i = getelementptr inbounds i8, ptr %add.ptr28.i, i64 1
  %210 = load i8, ptr %arrayidx36.i, align 1, !tbaa !24
  %cmp38.not.i = icmp ne i8 %209, %210
...
land.rhs.i624:                                    ; preds = %for.inc.i627, %land.rhs.preheader.i622
  ...
  %211 = load i8, ptr %arrayidx48.i, align 1, !tbaa !24
  %arrayidx51.i = getelementptr inbounds i8, ptr %add.ptr28.i, i64 %indvars.iv.i623
  %212 = load i8, ptr %arrayidx51.i, align 1, !tbaa !24
  %cmp53.i = icmp eq i8 %211, %212
...
cleanup.loopexit.split.loop.exit.i:               ; preds = %land.rhs.i624
  %213 = trunc i64 %indvars.iv.i623 to i32
  br label %cleanup.i

cleanup.i:                                        ; preds = %for.inc.i627, %cleanup.loopexit.split.loop.exit.i, %lor.lhs.false.i620, %if.end15.i
  %214 = phi i32 [ %.mux.i, %lor.lhs.false.i620 ], [ 0, %if.end15.i ], [ %213, %cleanup.loopexit.split.loop.exit.i ], [ %spec.store.select.i613, %for.inc.i627 ]
  store i32 %214, ptr %repLens.i, align 16, !tbaa !22
  %215 = load i32, ptr %arrayidx.1.i, align 4, !tbaa !22
  %add.1.i628 = add i32 %215, 1
  ...
  %216 = load i8, ptr %add.ptr28.1.i, align 1, !tbaa !24
  %cmp32.not.1.i = icmp eq i8 %206, %216
  br i1 %cmp32.not.1.i, label %lor.lhs.false.1.i631, label %if.then40.1.i

lor.lhs.false.1.i631:                             ; preds = %cleanup.i
  %217 = load i8, ptr %call19.i, align 1, !tbaa !24
  %arrayidx36.1.i = getelementptr inbounds i8, ptr %add.ptr28.1.i, i64 1
  %218 = load i8, ptr %arrayidx36.1.i, align 1, !tbaa !24
  %cmp38.not.1.i = icmp eq i8 %217, %218
...
land.rhs.1.i:                                     ; preds = %for.inc.1.i, %land.rhs.preheader.1.i
  ...
  %219 = load i8, ptr %arrayidx48.1.i, align 1, !tbaa !24
  %arrayidx51.1.i = getelementptr inbounds i8, ptr %add.ptr28.1.i, i64 %indvars.iv.1.i633
  %220 = load i8, ptr %arrayidx51.1.i, align 1, !tbaa !24
  %cmp53.1.i = icmp eq i8 %219, %220
...
for.end.1.loopexit.split.loop.exit2546.i:         ; preds = %land.rhs.1.i
  %221 = trunc i64 %indvars.iv.1.i633 to i32
  br label %for.end.1.i

for.end.1.i:                                      ; preds = %for.inc.1.i, %for.end.1.loopexit.split.loop.exit2546.i, %for.cond44.preheader.1.i
  %lenTest.0.lcssa.1.i = phi i32 [ 2, %for.cond44.preheader.1.i ], [ %221, %for.end.1.loopexit.split.loop.exit2546.i ], [ %spec.store.select.i613, %for.inc.1.i ]
  store i32 %lenTest.0.lcssa.1.i, ptr %arrayidx42.1.i, align 4, !tbaa !22
  %cmp60.1.i = icmp ugt i32 %lenTest.0.lcssa.1.i, %214
  %spec.select.1.i = zext i1 %cmp60.1.i to i32
  br label %cleanup.1.i

cleanup.1.i:                                      ; preds = %for.end.1.i, %if.then40.1.i
  %222 = phi i32 [ 0, %if.then40.1.i ], [ %lenTest.0.lcssa.1.i, %for.end.1.i ]
  %repMaxIndex.2.1.i = phi i32 [ 0, %if.then40.1.i ], [ %spec.select.1.i, %for.end.1.i ]
  %223 = load i32, ptr %arrayidx.2.i, align 4, !tbaa !22
  %add.2.i636 = add i32 %223, 1
  ...
  %224 = load i8, ptr %add.ptr28.2.i, align 1, !tbaa !24
  %cmp32.not.2.i = icmp eq i8 %206, %224
  br i1 %cmp32.not.2.i, label %lor.lhs.false.2.i639, label %if.then40.2.i

lor.lhs.false.2.i639:                             ; preds = %cleanup.1.i
  %225 = load i8, ptr %call19.i, align 1, !tbaa !24
  %arrayidx36.2.i = getelementptr inbounds i8, ptr %add.ptr28.2.i, i64 1
  %226 = load i8, ptr %arrayidx36.2.i, align 1, !tbaa !24
  %cmp38.not.2.i = icmp eq i8 %225, %226
...
land.rhs.2.i:                                     ; preds = %for.inc.2.i, %land.rhs.preheader.2.i
  ...
  %227 = load i8, ptr %arrayidx48.2.i, align 1, !tbaa !24
  %arrayidx51.2.i = getelementptr inbounds i8, ptr %add.ptr28.2.i, i64 %indvars.iv.2.i641
  %228 = load i8, ptr %arrayidx51.2.i, align 1, !tbaa !24
  %cmp53.2.i = icmp eq i8 %227, %228
...
for.end.2.loopexit.split.loop.exit2548.i:         ; preds = %land.rhs.2.i
  %229 = trunc i64 %indvars.iv.2.i641 to i32
  br label %for.end.2.i

for.end.2.i:                                      ; preds = %for.inc.2.i, %for.end.2.loopexit.split.loop.exit2548.i, %for.cond44.preheader.2.i
  %lenTest.0.lcssa.2.i = phi i32 [ 2, %for.cond44.preheader.2.i ], [ %229, %for.end.2.loopexit.split.loop.exit2548.i ], [ %spec.store.select.i613, %for.inc.2.i ]
  ...
  %230 = load i32, ptr %arrayidx59.2.i, align 4, !tbaa !22
  %cmp60.2.i = icmp ugt i32 %lenTest.0.lcssa.2.i, %230
  %spec.select.2.i = select i1 %cmp60.2.i, i32 2, i32 %repMaxIndex.2.1.i
  br label %cleanup.2.i

cleanup.2.i:                                      ; preds = %for.end.2.i, %if.then40.2.i
  %231 = phi i32 [ 0, %if.then40.2.i ], [ %lenTest.0.lcssa.2.i, %for.end.2.i ]
  %repMaxIndex.2.2.i = phi i32 [ %repMaxIndex.2.1.i, %if.then40.2.i ], [ %spec.select.2.i, %for.end.2.i ]
  %232 = load i32, ptr %arrayidx.3.i, align 4, !tbaa !22
  %add.3.i644 = add i32 %232, 1
  ...
  %233 = load i8, ptr %add.ptr28.3.i, align 1, !tbaa !24
  %cmp32.not.3.i = icmp eq i8 %206, %233
  br i1 %cmp32.not.3.i, label %lor.lhs.false.3.i647, label %if.then40.3.i

lor.lhs.false.3.i647:                             ; preds = %cleanup.2.i
  %234 = load i8, ptr %call19.i, align 1, !tbaa !24
  %arrayidx36.3.i = getelementptr inbounds i8, ptr %add.ptr28.3.i, i64 1
  %235 = load i8, ptr %arrayidx36.3.i, align 1, !tbaa !24
  %cmp38.not.3.i = icmp eq i8 %234, %235
...
land.rhs.3.i:                                     ; preds = %for.inc.3.i, %land.rhs.preheader.3.i
  ...
  %236 = load i8, ptr %arrayidx48.3.i, align 1, !tbaa !24
  %arrayidx51.3.i = getelementptr inbounds i8, ptr %add.ptr28.3.i, i64 %indvars.iv.3.i649
  %237 = load i8, ptr %arrayidx51.3.i, align 1, !tbaa !24
  %cmp53.3.i = icmp eq i8 %236, %237
...
for.end.3.loopexit.split.loop.exit2550.i:         ; preds = %land.rhs.3.i
  %238 = trunc i64 %indvars.iv.3.i649 to i32
  br label %for.end.3.i

for.end.3.i:                                      ; preds = %for.inc.3.i, %for.end.3.loopexit.split.loop.exit2550.i, %for.cond44.preheader.3.i
  %lenTest.0.lcssa.3.i = phi i32 [ 2, %for.cond44.preheader.3.i ], [ %238, %for.end.3.loopexit.split.loop.exit2550.i ], [ %spec.store.select.i613, %for.inc.3.i ]
  ...
  %239 = load i32, ptr %arrayidx59.3.i, align 4, !tbaa !22
  %cmp60.3.i = icmp ugt i32 %lenTest.0.lcssa.3.i, %239
  %spec.select.3.i = select i1 %cmp60.3.i, i32 3, i32 %repMaxIndex.2.2.i
  br label %cleanup.3.i

cleanup.3.i:                                      ; preds = %for.end.3.i, %if.then40.3.i
  %240 = phi i32 [ 0, %if.then40.3.i ], [ %lenTest.0.lcssa.3.i, %for.end.3.i ]
  ...
  %241 = load i32, ptr %arrayidx69.i, align 4, !tbaa !22
  %242 = load i32, ptr %numFastBytes.i.i, align 8, !tbaa !66
  %cmp70.not.i = icmp ult i32 %241, %242
  br i1 %cmp70.not.i, label %if.end78.i, label %if.then72.i

if.then72.i:                                      ; preds = %cleanup.3.i
  %sub76.i = add i32 %241, -1
...
if.then.i1989.i:                                  ; preds = %if.then72.i
  ...
  %add.i1987.i = add i32 %243, %sub76.i
  ...
  tail call void %244(ptr noundef %245, i32 noundef %sub76.i) #16
  br label %GetOptimum.exit

if.end78.i:                                       ; preds = %cleanup.3.i
  %cmp81.not.i = icmp ult i32 %mainLen.0.i611, %242
...
if.then83.i:                                      ; preds = %if.end78.i
  ...
  %246 = load i32, ptr %arrayidx86.i, align 4, !tbaa !22
  %add87.i = add i32 %246, 4
...
if.then.i1995.i:                                  ; preds = %if.then83.i
  %247 = load i32, ptr %additionalOffset.i542, align 4, !tbaa !97
  %add.i1992.i = add i32 %247, %sub88.i
  store i32 %add.i1992.i, ptr %additionalOffset.i542, align 4, !tbaa !97
  %248 = load ptr, ptr %Skip.i.i, align 8, !tbaa !149
  %249 = load ptr, ptr %matchFinderObj38, align 8, !tbaa !121
  tail call void %248(ptr noundef %249, i32 noundef %sub88.i) #16
  br label %GetOptimum.exit

if.end89.i:                                       ; preds = %if.end78.i
  %250 = load i32, ptr %reps.i, align 16, !tbaa !22
  %add91.i = add i32 %250, 1
  ...
  %251 = load i8, ptr %add.ptr94.i, align 1, !tbaa !24
  %cmp95.i = icmp ult i32 %mainLen.0.i611, 2
  %cmp99.not.i = icmp ne i8 %206, %251
  %or.cond.not2420.i = select i1 %cmp95.i, i1 %cmp99.not.i, i1 false
  %cmp104.i = icmp ult i32 %241, 2
...
if.end107.i:                                      ; preds = %if.end89.i
  %252 = load i32, ptr %state.i, align 8, !tbaa !33
  store i32 %252, ptr %state110.i, align 4, !tbaa !154
  %253 = load i32, ptr %pbMask1043, align 4, !tbaa !98
  %and.i = and i32 %253, %nowPos32.2
  %254 = load ptr, ptr %litProbs.i, align 8, !tbaa !52
  %255 = load i32, ptr %lpMask.i, align 8, !tbaa !99
  %and111.i = and i32 %255, %nowPos32.2
  %256 = load i32, ptr %lc.i, align 4, !tbaa !67
  %shl.i654 = shl i32 %and111.i, %256
  %add.ptr112.i = getelementptr inbounds i8, ptr %call19.i, i64 -2
  %257 = load i8, ptr %add.ptr112.i, align 1, !tbaa !24
  %conv113.i = zext i8 %257 to i32
  %sub115.i = sub i32 8, %256
  ...
  %add.ptr118.i = getelementptr inbounds i16, ptr %254, i64 %idx.ext117.i
  %idxprom120.i = zext i32 %252 to i64
  ...
  %258 = load i16, ptr %arrayidx123.i, align 2, !tbaa !31
  %259 = lshr i16 %258, 4
  %idxprom126.i = zext i16 %259 to i64
  %arrayidx127.i = getelementptr inbounds %struct.CLzmaEnc, ptr %p, i64 0, i32 13, i64 %idxprom126.i
  %260 = load i32, ptr %arrayidx127.i, align 4, !tbaa !22
  %cmp129.i = icmp ult i32 %252, 7
  %conv136.i = zext i8 %206 to i32
  br i1 %cmp129.i, label %cond.false.i, label %cond.true.i

cond.true.i:                                      ; preds = %if.end107.i
  %conv132.i = zext i8 %251 to i32
...
do.body.i.i:                                      ; preds = %do.body.i.i, %cond.true.i
  ...
  %261 = load i16, ptr %arrayidx.i1999.i, align 2, !tbaa !31
  %conv.i.i659 = zext i16 %261 to i64
  ...
  %262 = load i32, ptr %arrayidx7.i.i, align 4, !tbaa !22
  %add8.i.i = add i32 %262, %price.0.i.i
  %shl9.i.i = shl nuw nsw i32 %symbol.addr.0.i.i, 1
  %263 = xor i32 %shl.i.i657, %shl9.i.i
  %not.i.i = xor i32 %263, -1
...
do.body.i2013.i:                                  ; preds = %do.body.i2013.i, %cond.false.i
  ...
  %264 = load i16, ptr %arrayidx.i2005.i, align 2, !tbaa !31
  %conv.i2006.i = zext i16 %264 to i64
  ...
  %265 = load i32, ptr %arrayidx5.i.i, align 4, !tbaa !22
  %add.i2010.i = add i32 %265, %price.0.i2002.i
...
if.end193.i:                                      ; preds = %if.then182.i, %if.then173.i, %cond.end.i
  %278 = phi i32 [ -1, %if.then173.i ], [ 0, %if.then182.i ], [ -1, %cond.end.i ]
  %.mainLen.0.i = tail call i32 @llvm.umax.i32(i32 %mainLen.0.i611, i32 %241)
...
if.end210.i:                                      ; preds = %if.end193.i
  ...
  %279 = add i32 %.mainLen.0.i, 3
  %280 = add i32 %.mainLen.0.i, -2
  %xtraiter = and i32 %279, 3
  %lcmp.mod.not = icmp eq i32 %xtraiter, 0
...
do.body.i662.prol.loopexit:                       ; preds = %do.body.i662.prol, %if.end210.i
  ...
  br i1 %281, label %for.body236.preheader.i, label %do.body.i662
...
GetPureRepPrice.exit.i:                           ; preds = %for.body236.preheader.i
  ...
  %282 = load i16, ptr %arrayidx7.i2024.i, align 2, !tbaa !31
  %283 = lshr i16 %282, 4
  %284 = xor i16 %283, 127
  %idxprom10.i2025.i = zext i16 %284 to i64
  %arrayidx11.i2026.i = getelementptr inbounds %struct.CLzmaEnc, ptr %p, i64 0, i32 13, i64 %idxprom10.i2025.i
  %285 = load i32, ptr %arrayidx11.i2026.i, align 4, !tbaa !22
  %arrayidx.i2020.i = getelementptr inbounds %struct.CLzmaEnc, ptr %p, i64 0, i32 32, i64 %idxprom120.i
  %286 = load i16, ptr %arrayidx.i2020.i, align 2, !tbaa !31
  %287 = lshr i16 %286, 4
  %idxprom1.i2021.i = zext i16 %287 to i64
  %arrayidx2.i2022.i = getelementptr inbounds %struct.CLzmaEnc, ptr %p, i64 0, i32 13, i64 %idxprom1.i2021.i
  %288 = load i32, ptr %arrayidx2.i2022.i, align 4, !tbaa !22
  %add31.i.i = add i32 %285, %add168.i
  %add246.i = add i32 %add31.i.i, %288
  %289 = zext i32 %214 to i64
  br label %do.body247.i

do.body247.i:                                     ; preds = %if.end266.i, %GetPureRepPrice.exit.i
  %indvars.iv = phi i64 [ %indvars.iv.next, %if.end266.i ], [ %289, %GetPureRepPrice.exit.i ]
  ...
  %290 = load i32, ptr %arrayidx252.i, align 4, !tbaa !22
  %add253.i = add i32 %add246.i, %290
  %arrayidx257.i = getelementptr inbounds %struct.CLzmaEnc, ptr %p, i64 0, i32 11, i64 %indvars.iv
  %291 = load i32, ptr %arrayidx257.i, align 4, !tbaa !157
  %cmp259.i = icmp ult i32 %add253.i, %291
...
if.end266.i:                                      ; preds = %if.then261.i, %do.body247.i
  ...
  %292 = and i64 %indvars.iv.next, 4294967294
  %cmp269.i.not = icmp eq i64 %292, 0
...
GetPureRepPrice.exit.1.i:                         ; preds = %cleanup272.i
  ...
  %293 = load i16, ptr %arrayidx.i2020.1.i, align 2, !tbaa !31
  %294 = lshr i16 %293, 4
  %295 = xor i16 %294, 127
  %idxprom19.i.1.i = zext i16 %295 to i64
  %arrayidx20.i.1.i = getelementptr inbounds %struct.CLzmaEnc, ptr %p, i64 0, i32 13, i64 %idxprom19.i.1.i
  %296 = load i32, ptr %arrayidx20.i.1.i, align 4, !tbaa !22
  %arrayidx26.i.1.i = getelementptr inbounds %struct.CLzmaEnc, ptr %p, i64 0, i32 33, i64 %idxprom120.i
  %297 = load i16, ptr %arrayidx26.i.1.i, align 2, !tbaa !31
  %298 = lshr i16 %297, 4
  %idxprom29.i.1.i = zext i16 %298 to i64
  %arrayidx30.i.1.i = getelementptr inbounds %struct.CLzmaEnc, ptr %p, i64 0, i32 13, i64 %idxprom29.i.1.i
  %299 = load i32, ptr %arrayidx30.i.1.i, align 4, !tbaa !22
  %add31.i.1.i = add i32 %296, %add168.i
  %add246.1.i = add i32 %add31.i.1.i, %299
  %300 = zext i32 %222 to i64
  br label %do.body247.1.i

do.body247.1.i:                                   ; preds = %if.end266.1.i, %GetPureRepPrice.exit.1.i
  %indvars.iv1111 = phi i64 [ %indvars.iv.next1112, %if.end266.1.i ], [ %300, %GetPureRepPrice.exit.1.i ]
  %sub250.1.i = add i64 %indvars.iv1111, 4294967294
  ...
  %301 = load i32, ptr %arrayidx252.1.i, align 4, !tbaa !22
  %add253.1.i = add i32 %add246.1.i, %301
  %arrayidx257.1.i = getelementptr inbounds %struct.CLzmaEnc, ptr %p, i64 0, i32 11, i64 %indvars.iv1111
  %302 = load i32, ptr %arrayidx257.1.i, align 4, !tbaa !157
  %cmp259.1.i = icmp ult i32 %add253.1.i, %302
...
if.then261.1.i:                                   ; preds = %do.body247.1.i
  ...
  %posPrev263.1.i = getelementptr inbounds %struct.CLzmaEnc, ptr %p, i64 0, i32 11, i64 %indvars.iv1111, i32 6
  store i32 0, ptr %posPrev263.1.i, align 4, !tbaa !150
  %backPrev264.1.i = getelementptr inbounds %struct.CLzmaEnc, ptr %p, i64 0, i32 11, i64 %indvars.iv1111, i32 7
  store i32 1, ptr %backPrev264.1.i, align 4, !tbaa !152
  %prev1IsChar265.1.i = getelementptr inbounds %struct.CLzmaEnc, ptr %p, i64 0, i32 11, i64 %indvars.iv1111, i32 2
...
if.end266.1.i:                                    ; preds = %if.then261.1.i, %do.body247.1.i
  ...
  %303 = and i64 %indvars.iv.next1112, 4294967294
  %cmp269.1.i.not = icmp eq i64 %303, 0
...
GetPureRepPrice.exit.2.i:                         ; preds = %cleanup272.1.i
  ...
  %304 = load i16, ptr %arrayidx45.i.2.i, align 2, !tbaa !31
  %305 = lshr i16 %304, 4
  %idxprom50.i.2.i = zext i16 %305 to i64
  %arrayidx51.i.2.i = getelementptr inbounds %struct.CLzmaEnc, ptr %p, i64 0, i32 13, i64 %idxprom50.i.2.i
  %306 = load i32, ptr %arrayidx51.i.2.i, align 4, !tbaa !22
  %arrayidx26.i.2.i = getelementptr inbounds %struct.CLzmaEnc, ptr %p, i64 0, i32 33, i64 %idxprom120.i
  %307 = load i16, ptr %arrayidx26.i.2.i, align 2, !tbaa !31
  %308 = lshr i16 %307, 4
  %309 = xor i16 %308, 127
  %idxprom40.i.2.i = zext i16 %309 to i64
  %arrayidx41.i.2.i = getelementptr inbounds %struct.CLzmaEnc, ptr %p, i64 0, i32 13, i64 %idxprom40.i.2.i
  %310 = load i32, ptr %arrayidx41.i.2.i, align 4, !tbaa !22
  %arrayidx.i2020.2.i = getelementptr inbounds %struct.CLzmaEnc, ptr %p, i64 0, i32 32, i64 %idxprom120.i
  %311 = load i16, ptr %arrayidx.i2020.2.i, align 2, !tbaa !31
  %312 = lshr i16 %311, 4
  %313 = xor i16 %312, 127
  %idxprom19.i.2.i = zext i16 %313 to i64
  %arrayidx20.i.2.i = getelementptr inbounds %struct.CLzmaEnc, ptr %p, i64 0, i32 13, i64 %idxprom19.i.2.i
  %314 = load i32, ptr %arrayidx20.i.2.i, align 4, !tbaa !22
  %add42.i.2.i = add i32 %306, %add168.i
  %add31.i.2.i = add i32 %add42.i.2.i, %310
  %add246.2.i = add i32 %add31.i.2.i, %314
  %315 = zext i32 %231 to i64
  br label %do.body247.2.i

do.body247.2.i:                                   ; preds = %if.end266.2.i, %GetPureRepPrice.exit.2.i
  %indvars.iv1115 = phi i64 [ %indvars.iv.next1116, %if.end266.2.i ], [ %315, %GetPureRepPrice.exit.2.i ]
  %sub250.2.i = add i64 %indvars.iv1115, 4294967294
  ...
  %316 = load i32, ptr %arrayidx252.2.i, align 4, !tbaa !22
  %add253.2.i = add i32 %add246.2.i, %316
  %arrayidx257.2.i = getelementptr inbounds %struct.CLzmaEnc, ptr %p, i64 0, i32 11, i64 %indvars.iv1115
  %317 = load i32, ptr %arrayidx257.2.i, align 4, !tbaa !157
  %cmp259.2.i = icmp ult i32 %add253.2.i, %317
...
if.then261.2.i:                                   ; preds = %do.body247.2.i
  ...
  %posPrev263.2.i = getelementptr inbounds %struct.CLzmaEnc, ptr %p, i64 0, i32 11, i64 %indvars.iv1115, i32 6
  store i32 0, ptr %posPrev263.2.i, align 4, !tbaa !150
  %backPrev264.2.i = getelementptr inbounds %struct.CLzmaEnc, ptr %p, i64 0, i32 11, i64 %indvars.iv1115, i32 7
  store i32 2, ptr %backPrev264.2.i, align 4, !tbaa !152
  %prev1IsChar265.2.i = getelementptr inbounds %struct.CLzmaEnc, ptr %p, i64 0, i32 11, i64 %indvars.iv1115, i32 2
...
if.end266.2.i:                                    ; preds = %if.then261.2.i, %do.body247.2.i
  ...
  %318 = and i64 %indvars.iv.next1116, 4294967294
  %cmp269.2.i.not = icmp eq i64 %318, 0
...
GetPureRepPrice.exit.3.i:                         ; preds = %cleanup272.2.i
  ...
  %319 = load i16, ptr %arrayidx45.i.3.i, align 2, !tbaa !31
  %320 = lshr i16 %319, 4
  %321 = xor i16 %320, 127
  %idxprom50.i.3.i = zext i16 %321 to i64
  %arrayidx51.i.3.i = getelementptr inbounds %struct.CLzmaEnc, ptr %p, i64 0, i32 13, i64 %idxprom50.i.3.i
  %322 = load i32, ptr %arrayidx51.i.3.i, align 4, !tbaa !22
  %arrayidx26.i.3.i = getelementptr inbounds %struct.CLzmaEnc, ptr %p, i64 0, i32 33, i64 %idxprom120.i
  %323 = load i16, ptr %arrayidx26.i.3.i, align 2, !tbaa !31
  %324 = lshr i16 %323, 4
  %325 = xor i16 %324, 127
  %idxprom40.i.3.i = zext i16 %325 to i64
  %arrayidx41.i.3.i = getelementptr inbounds %struct.CLzmaEnc, ptr %p, i64 0, i32 13, i64 %idxprom40.i.3.i
  %326 = load i32, ptr %arrayidx41.i.3.i, align 4, !tbaa !22
  %arrayidx.i2020.3.i = getelementptr inbounds %struct.CLzmaEnc, ptr %p, i64 0, i32 32, i64 %idxprom120.i
  %327 = load i16, ptr %arrayidx.i2020.3.i, align 2, !tbaa !31
  %328 = lshr i16 %327, 4
  %329 = xor i16 %328, 127
  %idxprom19.i.3.i = zext i16 %329 to i64
  %arrayidx20.i.3.i = getelementptr inbounds %struct.CLzmaEnc, ptr %p, i64 0, i32 13, i64 %idxprom19.i.3.i
  %330 = load i32, ptr %arrayidx20.i.3.i, align 4, !tbaa !22
  %add42.i.3.i = add i32 %322, %add168.i
  %add31.i.3.i = add i32 %add42.i.3.i, %326
  %add246.3.i = add i32 %add31.i.3.i, %330
  %331 = zext i32 %240 to i64
  br label %do.body247.3.i

do.body247.3.i:                                   ; preds = %if.end266.3.i, %GetPureRepPrice.exit.3.i
  %indvars.iv1119 = phi i64 [ %indvars.iv.next1120, %if.end266.3.i ], [ %331, %GetPureRepPrice.exit.3.i ]
  %sub250.3.i = add i64 %indvars.iv1119, 4294967294
  ...
  %332 = load i32, ptr %arrayidx252.3.i, align 4, !tbaa !22
  %add253.3.i = add i32 %add246.3.i, %332
  %arrayidx257.3.i = getelementptr inbounds %struct.CLzmaEnc, ptr %p, i64 0, i32 11, i64 %indvars.iv1119
  %333 = load i32, ptr %arrayidx257.3.i, align 4, !tbaa !157
  %cmp259.3.i = icmp ult i32 %add253.3.i, %333
...
if.then261.3.i:                                   ; preds = %do.body247.3.i
  ...
  %posPrev263.3.i = getelementptr inbounds %struct.CLzmaEnc, ptr %p, i64 0, i32 11, i64 %indvars.iv1119, i32 6
  store i32 0, ptr %posPrev263.3.i, align 4, !tbaa !150
  %backPrev264.3.i = getelementptr inbounds %struct.CLzmaEnc, ptr %p, i64 0, i32 11, i64 %indvars.iv1119, i32 7
  store i32 3, ptr %backPrev264.3.i, align 4, !tbaa !152
  %prev1IsChar265.3.i = getelementptr inbounds %struct.CLzmaEnc, ptr %p, i64 0, i32 11, i64 %indvars.iv1119, i32 2
...
if.end266.3.i:                                    ; preds = %if.then261.3.i, %do.body247.3.i
  ...
  %334 = and i64 %indvars.iv.next1120, 4294967294
  %cmp269.3.i.not = icmp eq i64 %334, 0
...
cleanup272.3.i:                                   ; preds = %if.end266.3.i, %cleanup272.2.i
  %idxprom286.i = zext i16 %269 to i64
  %arrayidx287.i = getelementptr inbounds %struct.CLzmaEnc, ptr %p, i64 0, i32 13, i64 %idxprom286.i
  %335 = load i32, ptr %arrayidx287.i, align 4, !tbaa !22
  %add288.i = add i32 %335, %267
  %add294.i = add i32 %214, 1
  %cond297.i = select i1 %cmp240.i, i32 2, i32 %add294.i
  %cmp298.not.i = icmp ugt i32 %cond297.i, %mainLen.0.i611
  br i1 %cmp298.not.i, label %if.end390.i, label %while.cond.i

while.cond.i:                                     ; preds = %cleanup272.3.i, %while.cond.i
  %offs.0.i = phi i32 [ %add305.i, %while.cond.i ], [ 0, %cleanup272.3.i ]
  %idxprom301.i = zext i32 %offs.0.i to i64
  %arrayidx302.i = getelementptr inbounds i32, ptr %matches.i.i, i64 %idxprom301.i
  %336 = load i32, ptr %arrayidx302.i, align 4, !tbaa !22
  %cmp303.i = icmp ugt i32 %cond297.i, %336
  %add305.i = add i32 %offs.0.i, 2
  br i1 %cmp303.i, label %while.cond.i, label %for.cond306.i, !llvm.loop !163

for.cond306.i:                                    ; preds = %while.cond.i, %for.inc387.i
  %offs.1.i = phi i32 [ %offs.2.i, %for.inc387.i ], [ %offs.0.i, %while.cond.i ]
  %len.1.i = phi i32 [ %inc388.i, %for.inc387.i ], [ %cond297.i, %while.cond.i ]
  ...
  %337 = load i32, ptr %arrayidx310.i, align 4, !tbaa !22
  ...
  %338 = load i32, ptr %arrayidx317.i, align 4, !tbaa !22
  %add318.i = add i32 %add288.i, %338
  %cmp319.i = icmp ult i32 %len.1.i, 5
  %cond325.i = select i1 %cmp319.i, i32 %sub315.i, i32 3
  %cmp326.i = icmp ult i32 %337, 128
...
if.else334.i:                                     ; preds = %for.cond306.i
  ...
  %340 = load i8, ptr %arrayidx343.i, align 1, !tbaa !24
  %conv344.i = zext i8 %340 to i32
  %mul345.i = shl nuw nsw i32 %add340.i, 1
  %add346.i = add nuw nsw i32 %mul345.i, %conv344.i
  %and347.i = and i32 %337, 15
  ...
  %341 = load i32, ptr %arrayidx349.i, align 4, !tbaa !22
  ...
  %342 = load i32, ptr %arrayidx353.i, align 4, !tbaa !22
  %add354.i = add i32 %342, %341
  br label %if.end356.i

if.end356.i:                                      ; preds = %if.else334.i, %if.then328.i
  %.pn2293.i = phi i32 [ %339, %if.then328.i ], [ %add354.i, %if.else334.i ]
  ...
  %343 = load i32, ptr %arrayidx359.i, align 4, !tbaa !157
  %cmp361.i = icmp ult i32 %curAndLenPrice311.0.i, %343
...
if.end369.i:                                      ; preds = %if.then363.i, %if.end356.i
  ...
  %344 = load i32, ptr %arrayidx371.i, align 4, !tbaa !22
  %cmp372.i = icmp eq i32 %len.1.i, %344
...
do.body.i2030.i:                                  ; preds = %if.end45.i.i, %if.then404.i
  %backMem.0.i.i = phi i32 [ %346, %if.then404.i ], [ %351, %if.end45.i.i ]
  %posMem.0.i.i = phi i32 [ %345, %if.then404.i ], [ %350, %if.end45.i.i ]
  ...
  %347 = load i32, ptr %prev1IsChar.i.i, align 4, !tbaa !158
  %tobool.not.i.i = icmp eq i32 %347, 0
...
if.then.i2032.i:                                  ; preds = %do.body.i2030.i
  ...
  %348 = load i32, ptr %prev2.i.i, align 4, !tbaa !164
  %tobool22.not.i.i = icmp eq i32 %348, 0
...
if.then23.i2033.i:                                ; preds = %if.then.i2032.i
  ...
  %349 = load <2 x i32>, ptr %posPrev2.i.i, align 4, !tbaa !22
  store <2 x i32> %349, ptr %posPrev36.i.i, align 4, !tbaa !22
  br label %if.end45.i.i

if.end45.i.i:                                     ; preds = %if.then23.i2033.i, %if.then.i2032.i, %do.body.if.end45_crit_edge.i.i
  %350 = phi i32 [ %.pre110.i.i, %do.body.if.end45_crit_edge.i.i ], [ %sub.i2031.i, %if.then.i2032.i ], [ %sub.i2031.i, %if.then23.i2033.i ]
  %351 = phi i32 [ %.pre.i.i, %do.body.if.end45_crit_edge.i.i ], [ -1, %if.then.i2032.i ], [ -1, %if.then23.i2033.i ]
...
Backward.exit.i:                                  ; preds = %if.end45.i.i
  %352 = load i32, ptr %backPrev65.i2111.i, align 4, !tbaa !152
  %353 = load i32, ptr %posPrev68.i2112.i, align 4, !tbaa !150
  store i32 %353, ptr %optimumCurrentIndex.i, align 4, !tbaa !96
  br label %GetOptimum.exit

if.end406.i:                                      ; preds = %if.end390.i, %cleanup1356.i
  %indvars.iv1123 = phi i32 [ %indvars.iv.next1124, %cleanup1356.i ], [ 4094, %if.end390.i ]
  %354 = phi i32 [ %401, %cleanup1356.i ], [ %250, %if.end390.i ]
  ...
  %355 = load ptr, ptr %GetNumAvailableBytes37, align 8, !tbaa !126
  %356 = load ptr, ptr %matchFinderObj38, align 8, !tbaa !121
  %call.i2037.i = tail call i32 %355(ptr noundef %356) #16
  store i32 %call.i2037.i, ptr %numAvail.i.i, align 8, !tbaa !139
  %357 = load ptr, ptr %GetMatches.i.i, align 8, !tbaa !140
  %358 = load ptr, ptr %matchFinderObj38, align 8, !tbaa !121
  %call3.i2041.i = tail call i32 %357(ptr noundef %358, ptr noundef nonnull %matches.i.i) #16
...
if.then.i2048.i:                                  ; preds = %if.end406.i
  ...
  %359 = load i32, ptr %arrayidx.i2045.i, align 4, !tbaa !22
  %360 = load i32, ptr %numFastBytes.i.i, align 8, !tbaa !66
  %cmp5.i2047.i = icmp eq i32 %359, %360
  br i1 %cmp5.i2047.i, label %if.then6.i2061.i, label %ReadMatchDistances.exit2076.i

if.then6.i2061.i:                                 ; preds = %if.then.i2048.i
  %361 = load ptr, ptr %GetPointerToCurrentPos.i.i, align 8, !tbaa !127
  %362 = load ptr, ptr %matchFinderObj38, align 8, !tbaa !121
  %call9.i2050.i = tail call ptr %361(ptr noundef %362) #16
  ...
  %363 = load i32, ptr %arrayidx13.i2054.i, align 4, !tbaa !22
  %add.i2055.i = add i32 %363, 1
  %364 = load i32, ptr %numAvail.i.i, align 8, !tbaa !139
  %spec.store.select.i2056.i = tail call i32 @llvm.umin.i32(i32 %364, i32 273)
  ...
  %cmp1952.i2060.i = icmp ult i32 %359, %spec.store.select.i2056.i
...
land.rhs.i2067.i:                                 ; preds = %for.inc.i2071.i, %land.rhs.preheader.i2062.i
  %indvars.iv.i2063.i = phi i64 [ %365, %land.rhs.preheader.i2062.i ], [ %indvars.iv.next.i2068.i, %for.inc.i2071.i ]
  %arrayidx21.i2064.i = getelementptr inbounds i8, ptr %add.ptr.i2051.i, i64 %indvars.iv.i2063.i
  %366 = load i8, ptr %arrayidx21.i2064.i, align 1, !tbaa !24
  %arrayidx23.i2065.i = getelementptr inbounds i8, ptr %add.ptr18.i2059.i, i64 %indvars.iv.i2063.i
  %367 = load i8, ptr %arrayidx23.i2065.i, align 1, !tbaa !24
  %cmp25.i2066.i = icmp eq i8 %366, %367
...
if.end28.loopexit.split.loop.exit.i2072.i:        ; preds = %land.rhs.i2067.i
  %368 = trunc i64 %indvars.iv.i2063.i to i32
...
ReadMatchDistances.exit2076.i:                    ; preds = %for.inc.i2071.i, %if.end28.loopexit.split.loop.exit.i2072.i, %if.then6.i2061.i, %if.then.i2048.i, %if.end406.i
  %lenRes.1.i2073.i = phi i32 [ %359, %if.then.i2048.i ], [ 0, %if.end406.i ], [ %359, %if.then6.i2061.i ], [ %368, %if.end28.loopexit.split.loop.exit.i2072.i ], [ %spec.store.select.i2056.i, %for.inc.i2071.i ]
  %369 = load i32, ptr %additionalOffset.i542, align 4, !tbaa !97
  %inc29.i2075.i = add i32 %369, 1
  store i32 %inc29.i2075.i, ptr %additionalOffset.i542, align 4, !tbaa !97
  %370 = load i32, ptr %numFastBytes.i.i, align 8, !tbaa !66
  %cmp409.not.i = icmp ult i32 %lenRes.1.i2073.i, %370
...
do.body.i2089.i:                                  ; preds = %if.end45.i2110.i, %if.then411.i
  %backMem.0.i2081.i = phi i32 [ %372, %if.then411.i ], [ %377, %if.end45.i2110.i ]
  %posMem.0.i2082.i = phi i32 [ %371, %if.then411.i ], [ %376, %if.end45.i2110.i ]
  ...
  %373 = load i32, ptr %prev1IsChar.i2085.i, align 4, !tbaa !158
  %tobool.not.i2086.i = icmp eq i32 %373, 0
...
if.then.i2099.i:                                  ; preds = %do.body.i2089.i
  ...
  %374 = load i32, ptr %prev2.i2097.i, align 4, !tbaa !164
  %tobool22.not.i2098.i = icmp eq i32 %374, 0
...
if.then23.i2106.i:                                ; preds = %if.then.i2099.i
  ...
  %375 = load <2 x i32>, ptr %posPrev2.i2102.i, align 4, !tbaa !22
  store <2 x i32> %375, ptr %posPrev36.i2103.i, align 4, !tbaa !22
  br label %if.end45.i2110.i

if.end45.i2110.i:                                 ; preds = %if.then23.i2106.i, %if.then.i2099.i, %do.body.if.end45_crit_edge.i2093.i
  %376 = phi i32 [ %.pre110.i2092.i, %do.body.if.end45_crit_edge.i2093.i ], [ %sub.i2095.i, %if.then.i2099.i ], [ %sub.i2095.i, %if.then23.i2106.i ]
  %377 = phi i32 [ %.pre.i2090.i, %do.body.if.end45_crit_edge.i2093.i ], [ -1, %if.then.i2099.i ], [ -1, %if.then23.i2106.i ]
...
Backward.exit2114.i:                              ; preds = %if.end45.i2110.i
  %378 = load i32, ptr %backPrev65.i2111.i, align 4, !tbaa !152
  %379 = load i32, ptr %posPrev68.i2112.i, align 4, !tbaa !150
  store i32 %379, ptr %optimumCurrentIndex.i, align 4, !tbaa !96
  br label %GetOptimum.exit
...
if.then425.i:                                     ; preds = %if.then422.i
  ...
  %383 = load i32, ptr %posPrev2.i, align 4, !tbaa !166
  %idxprom427.i = zext i32 %383 to i64
  %state429.i = getelementptr inbounds %struct.CLzmaEnc, ptr %p, i64 0, i32 11, i64 %idxprom427.i, i32 1
  %384 = load i32, ptr %state429.i, align 4, !tbaa !154
  %backPrev2.i = getelementptr inbounds %struct.CLzmaEnc, ptr %p, i64 0, i32 11, i64 %idxprom418.i, i32 5
  %385 = load i32, ptr %backPrev2.i, align 4, !tbaa !167
  %cmp430.i = icmp ult i32 %385, 4
  %idxprom433.i = zext i32 %384 to i64
...
if.end452.i:                                      ; preds = %if.end415.i
  %idxprom449.i = zext i32 %380 to i64
  ...
  %cmp454.i = icmp eq i32 %380, %cur.02412.i
...
if.then456.i:                                     ; preds = %if.end452.thread.thread.i, %if.end452.i, %if.then425.i
  ...
  %386 = load i32, ptr %backPrev457.i, align 4, !tbaa !152
  %cmp458.i = icmp eq i32 %386, 0
...
if.then460.i:                                     ; preds = %if.then456.i
  ...
  %387 = load i32, ptr %arrayidx462.i, align 4, !tbaa !22
...
if.else463.i:                                     ; preds = %if.then456.i
  ...
  %388 = load i32, ptr %arrayidx465.i, align 4, !tbaa !22
  br label %if.end544.i
...
if.else478.i:                                     ; preds = %if.end452.thread.thread.i, %if.end452.i
  ...
  %389 = load i32, ptr %backPrev479.i, align 4, !tbaa !152
  %cmp480.i = icmp ult i32 %389, 4
...
if.then495.i:                                     ; preds = %if.end489.i, %if.end489.thread.i
  ...
  %pos.02324.i = phi i32 [ %389, %if.end489.thread.i ], [ %385, %if.end489.i ]
  ...
  %390 = load i32, ptr %arrayidx499.i, align 4, !tbaa !22
  store i32 %390, ptr %reps.i, align 16, !tbaa !22
  %cmp502.not2370.i = icmp eq i32 %pos.02324.i, 0
  %.pre1154 = mul nuw nsw i64 %idxprom4912326.i, 48
...
for.cond514.preheader.i:                          ; preds = %if.then495.i
  %scevgep2454.i = getelementptr i8, ptr %scevgep2435.i, i64 %.pre1154
  %391 = shl nuw nsw i64 %idxprom498.i, 2
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 4 %arrayidx549.i, ptr align 4 %scevgep2454.i, i64 %391, i1 false), !tbaa !22
  %392 = add nuw nsw i32 %pos.02324.i, 1
...
for.body517.preheader.i:                          ; preds = %if.then495.i, %for.cond514.preheader.i
  %i496.0.lcssa2533.i = phi i32 [ %392, %for.cond514.preheader.i ], [ 1, %if.then495.i ]
  %393 = zext i32 %i496.0.lcssa2533.i to i64
  %394 = shl nuw nsw i64 %393, 2
  %scevgep2461.i = getelementptr i8, ptr %reps.i, i64 %394
  %395 = add nuw nsw i64 %394, %.pre1154
  %scevgep2463.i = getelementptr i8, ptr %scevgep2435.i, i64 %395
  %396 = sub nuw nsw i32 2, %pos.02324.i
  %397 = zext i32 %396 to i64
  %398 = shl nuw nsw i64 %397, 2
  %399 = add nuw nsw i64 %398, 4
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(1) %scevgep2461.i, ptr noundef nonnull align 4 dereferenceable(1) %scevgep2463.i, i64 %399, i1 false), !tbaa !22
...
if.else526.i:                                     ; preds = %if.end489.i, %if.end489.thread2327.i
  ...
  %pos.02334.i = phi i32 [ %389, %if.end489.thread2327.i ], [ %385, %if.end489.i ]
  %sub528.i = add i32 %pos.02334.i, -4
  store i32 %sub528.i, ptr %reps.i, align 16, !tbaa !22
  %400 = mul nuw nsw i64 %idxprom4912336.i, 48
  %scevgep2448.i = getelementptr i8, ptr %scevgep2435.i, i64 %400
...
if.end544.i:                                      ; preds = %if.else526.i, %for.body517.preheader.i, %for.cond514.preheader.i, %if.else463.i, %if.then460.i
  %401 = phi i32 [ %354, %if.then460.i ], [ %354, %if.else463.i ], [ %390, %for.cond514.preheader.i ], [ %.pre.i, %for.body517.preheader.i ], [ %sub528.i, %if.else526.i ]
  %state394.3.i = phi i32 [ %387, %if.then460.i ], [ %388, %if.else463.i ], [ %state394.22325.i, %for.cond514.preheader.i ], [ %state394.22325.i, %for.body517.preheader.i ], [ %state394.22335.i, %if.else526.i ]
  ...
  store i32 %401, ptr %backs547.i, align 4, !tbaa !22
  %arrayidx551.i = getelementptr inbounds %struct.CLzmaEnc, ptr %p, i64 0, i32 11, i64 %idxprom418.i, i32 8, i64 1
  %402 = load <2 x i32>, ptr %arrayidx549.i, align 4, !tbaa !22
  store <2 x i32> %402, ptr %arrayidx551.i, align 4, !tbaa !22
  %403 = load i32, ptr %arrayidx555.i, align 4, !tbaa !22
  %arrayidx557.i = getelementptr inbounds %struct.CLzmaEnc, ptr %p, i64 0, i32 11, i64 %idxprom418.i, i32 8, i64 3
  store i32 %403, ptr %arrayidx557.i, align 4, !tbaa !22
  %404 = load i32, ptr %arrayidx419.i, align 4, !tbaa !157
  %405 = load ptr, ptr %GetPointerToCurrentPos.i.i, align 8, !tbaa !127
  %406 = load ptr, ptr %matchFinderObj38, align 8, !tbaa !121
  %call562.i = tail call ptr %405(ptr noundef %406) #16
  %add.ptr563.i = getelementptr inbounds i8, ptr %call562.i, i64 -1
  %407 = load i8, ptr %add.ptr563.i, align 1, !tbaa !24
  %add565.i = add i32 %401, 1
  ...
  %408 = load i8, ptr %add.ptr568.i, align 1, !tbaa !24
  %409 = load i32, ptr %pbMask1043, align 4, !tbaa !98
  %and570.i = and i32 %409, %inc416.i
  ...
  %410 = load i16, ptr %arrayidx576.i, align 2, !tbaa !31
  %411 = lshr i16 %410, 4
  %idxprom579.i = zext i16 %411 to i64
  %arrayidx580.i = getelementptr inbounds %struct.CLzmaEnc, ptr %p, i64 0, i32 13, i64 %idxprom579.i
  %412 = load i32, ptr %arrayidx580.i, align 4, !tbaa !22
  %add581.i = add i32 %412, %404
  %413 = load ptr, ptr %litProbs.i, align 8, !tbaa !52
  %414 = load i32, ptr %lpMask.i, align 8, !tbaa !99
  %and585.i = and i32 %414, %inc416.i
  %415 = load i32, ptr %lc.i, align 4, !tbaa !67
  %shl587.i = shl i32 %and585.i, %415
  %add.ptr588.i = getelementptr inbounds i8, ptr %call562.i, i64 -2
  %416 = load i8, ptr %add.ptr588.i, align 1, !tbaa !24
  %conv589.i = zext i8 %416 to i32
  %sub591.i = sub i32 8, %415
...
do.body.i2139.i:                                  ; preds = %do.body.i2139.i, %cond.true599.i
  ...
  %417 = load i16, ptr %arrayidx.i2126.i, align 2, !tbaa !31
  %conv.i2127.i = zext i16 %417 to i64
  ...
  %418 = load i32, ptr %arrayidx7.i2133.i, align 4, !tbaa !22
  %add8.i2134.i = add i32 %418, %price.0.i2118.i
  %shl9.i2135.i = shl nuw nsw i32 %symbol.addr.0.i2117.i, 1
  %419 = xor i32 %shl.i2120.i, %shl9.i2135.i
  %not.i2136.i = xor i32 %419, -1
...
do.body.i2157.i:                                  ; preds = %do.body.i2157.i, %cond.false605.i
  ...
  %420 = load i16, ptr %arrayidx.i2146.i, align 2, !tbaa !31
  %conv.i2147.i = zext i16 %420 to i64
  ...
  %421 = load i32, ptr %arrayidx5.i2153.i, align 4, !tbaa !22
  %add.i2154.i = add i32 %421, %price.0.i2143.i
...
cond.end610.i:                                    ; preds = %do.body.i2139.i, %do.body.i2157.i
  ...
  %422 = load i32, ptr %arrayidx616.i, align 4, !tbaa !157
  %cmp618.i = icmp ult i32 %add612.i, %422
...
if.end625.i:                                      ; preds = %if.then620.i, %cond.end610.i
  %423 = phi i32 [ %add612.i, %if.then620.i ], [ %422, %cond.end610.i ]
  %nextIsChar.0.i = phi i32 [ 1, %if.then620.i ], [ 0, %cond.end610.i ]
  %424 = xor i16 %411, 127
  %idxprom635.i = zext i16 %424 to i64
  %arrayidx636.i = getelementptr inbounds %struct.CLzmaEnc, ptr %p, i64 0, i32 13, i64 %idxprom635.i
  %425 = load i32, ptr %arrayidx636.i, align 4, !tbaa !22
  %add637.i = add i32 %425, %404
  %arrayidx641.i = getelementptr inbounds %struct.CLzmaEnc, ptr %p, i64 0, i32 31, i64 %idxprom573.i
  %426 = load i16, ptr %arrayidx641.i, align 2, !tbaa !31
  %427 = lshr i16 %426, 4
  %428 = xor i16 %427, 127
  %idxprom645.i = zext i16 %428 to i64
  %arrayidx646.i = getelementptr inbounds %struct.CLzmaEnc, ptr %p, i64 0, i32 13, i64 %idxprom645.i
  %429 = load i32, ptr %arrayidx646.i, align 4, !tbaa !22
  %add647.i = add i32 %429, %add637.i
  %cmp650.i = icmp eq i8 %408, %407
...
land.lhs.true652.i:                               ; preds = %if.end625.i
  ...
  %430 = load i32, ptr %posPrev653.i, align 4, !tbaa !150
  %cmp654.i = icmp ult i32 %430, %inc4012418.i
...
land.lhs.true656.i:                               ; preds = %land.lhs.true652.i
  ...
  %431 = load i32, ptr %backPrev657.i, align 4, !tbaa !152
  %cmp658.i = icmp eq i32 %431, 0
...
if.then660.i:                                     ; preds = %land.lhs.true656.i, %land.lhs.true652.i
  ...
  %432 = load i16, ptr %arrayidx.i2160.i, align 2, !tbaa !31
  %433 = lshr i16 %432, 4
  %idxprom1.i2161.i = zext i16 %433 to i64
  %arrayidx2.i2162.i = getelementptr inbounds %struct.CLzmaEnc, ptr %p, i64 0, i32 13, i64 %idxprom1.i2161.i
  %434 = load i32, ptr %arrayidx2.i2162.i, align 4, !tbaa !22
  %arrayidx7.i2164.i = getelementptr inbounds %struct.CLzmaEnc, ptr %p, i64 0, i32 35, i64 %idxprom573.i, i64 %idxprom575.i
  %435 = load i16, ptr %arrayidx7.i2164.i, align 2, !tbaa !31
  %436 = lshr i16 %435, 4
  %idxprom10.i2165.i = zext i16 %436 to i64
  %arrayidx11.i2166.i = getelementptr inbounds %struct.CLzmaEnc, ptr %p, i64 0, i32 13, i64 %idxprom10.i2165.i
  %437 = load i32, ptr %arrayidx11.i2166.i, align 4, !tbaa !22
  %add.i2167.i = add i32 %434, %add647.i
  %add663.i = add i32 %add.i2167.i, %437
  %cmp665.not.i = icmp ugt i32 %add663.i, %423
...
if.end673.i:                                      ; preds = %if.then667.i, %if.then660.i, %land.lhs.true656.i, %if.end625.i
  ...
  %438 = load i32, ptr %numAvail.i.i, align 8, !tbaa !139
  %sub675.i = sub i32 4094, %cur.02412.i
  %spec.select2295.i = tail call i32 @llvm.umin.i32(i32 %sub675.i, i32 %438)
...
if.end683.i:                                      ; preds = %if.end673.i
  %439 = load i32, ptr %numFastBytes.i.i, align 8, !tbaa !66
  %.spec.select2295.i = tail call i32 @llvm.umin.i32(i32 %spec.select2295.i, i32 %439)
...
land.rhs715.preheader.i:                          ; preds = %if.then698.i
  %440 = tail call i32 @llvm.umin.i32(i32 %438, i32 %indvars.iv1123)
  %441 = tail call i32 @llvm.umin.i32(i32 %440, i32 %add707.i)
  %umin1125 = zext i32 %441 to i64
...
land.rhs715.i:                                    ; preds = %for.inc726.i, %land.rhs715.preheader.i
  ...
  %442 = load i8, ptr %arrayidx717.i, align 1, !tbaa !24
  %arrayidx720.i = getelementptr inbounds i8, ptr %add.ptr568.i, i64 %indvars.iv2467.i
  %443 = load i8, ptr %arrayidx720.i, align 1, !tbaa !24
  %cmp722.i = icmp eq i8 %442, %443
...
for.inc726.i:                                     ; preds = %land.rhs715.i
  ...
  %exitcond.not = icmp eq i64 %indvars.iv.next2468.i, %umin1125
  br i1 %exitcond.not, label %for.end728.i, label %land.rhs715.i, !llvm.loop !168

for.end728.i:                                     ; preds = %for.inc726.i, %land.rhs715.i
  %temp699.0.lcssa.ph.in.i = phi i64 [ %indvars.iv2467.i, %land.rhs715.i ], [ %umin1125, %for.inc726.i ]
...
if.then732.i:                                     ; preds = %for.end728.i
  ...
  %444 = load i32, ptr %arrayidx734.i, align 4, !tbaa !22
  %add735.i = add i32 %position.addr.02417.i, 2
  %and737.i = and i32 %409, %add735.i
  %idxprom740.i = zext i32 %444 to i64
...
while.body767.preheader.i:                        ; preds = %if.then732.i
  %453 = zext i32 %lenEnd.02416.i to i64
  %454 = add i32 %inc4012418.i, %temp699.0.lcssa.ph.i
  %wide.trip.count2474.i = zext i32 %454 to i64
  %455 = sub nsw i64 %wide.trip.count2474.i, %453
  %456 = xor i64 %453, -1
  %457 = add nsw i64 %456, %wide.trip.count2474.i
  %xtraiter1242 = and i64 %455, 3
  %lcmp.mod1243.not = icmp eq i64 %xtraiter1242, 0
  br i1 %lcmp.mod1243.not, label %while.body767.i.prol.loopexit, label %while.body767.i.prol

while.body767.i.prol:                             ; preds = %while.body767.preheader.i, %while.body767.i.prol
  %indvars.iv2470.i.prol = phi i64 [ %indvars.iv.next2471.i.prol, %while.body767.i.prol ], [ %453, %while.body767.preheader.i ]
  %prol.iter1244 = phi i64 [ %prol.iter1244.next, %while.body767.i.prol ], [ 0, %while.body767.preheader.i ]
  ...
  %prol.iter1244.next = add i64 %prol.iter1244, 1
  %prol.iter1244.cmp.not = icmp eq i64 %prol.iter1244.next, %xtraiter1242
  br i1 %prol.iter1244.cmp.not, label %while.body767.i.prol.loopexit, label %while.body767.i.prol, !llvm.loop !169

while.body767.i.prol.loopexit:                    ; preds = %while.body767.i.prol, %while.body767.preheader.i
  %indvars.iv2470.i.unr = phi i64 [ %453, %while.body767.preheader.i ], [ %indvars.iv.next2471.i.prol, %while.body767.i.prol ]
  %458 = icmp ult i64 %457, 3
  br i1 %458, label %while.end773.i, label %while.body767.i
...
while.end773.i:                                   ; preds = %while.body767.i.prol.loopexit, %while.body767.i, %if.then732.i
  %lenEnd.1.lcssa.i = phi i32 [ %lenEnd.02416.i, %if.then732.i ], [ %454, %while.body767.i ], [ %454, %while.body767.i.prol.loopexit ]
  ...
  %459 = load i32, ptr %arrayidx2.i2171.i, align 4, !tbaa !22
  %arrayidx.i.i.i = getelementptr inbounds %struct.CLzmaEnc, ptr %p, i64 0, i32 32, i64 %idxprom740.i
  %460 = load i16, ptr %arrayidx.i.i.i, align 2, !tbaa !31
  %461 = lshr i16 %460, 4
  %idxprom1.i.i.i = zext i16 %461 to i64
  %arrayidx2.i.i.i = getelementptr inbounds %struct.CLzmaEnc, ptr %p, i64 0, i32 13, i64 %idxprom1.i.i.i
  %462 = load i32, ptr %arrayidx2.i.i.i, align 4, !tbaa !22
  %arrayidx7.i.i.i = getelementptr inbounds %struct.CLzmaEnc, ptr %p, i64 0, i32 35, i64 %idxprom740.i, i64 %idxprom742.i
  %463 = load i16, ptr %arrayidx7.i.i.i, align 2, !tbaa !31
  %464 = lshr i16 %463, 4
  %465 = xor i16 %464, 127
  %idxprom10.i.i.i = zext i16 %465 to i64
  %arrayidx11.i.i.i = getelementptr inbounds %struct.CLzmaEnc, ptr %p, i64 0, i32 13, i64 %idxprom10.i.i.i
  %466 = load i32, ptr %arrayidx11.i.i.i, align 4, !tbaa !22
  %add31.i.i.i = add i32 %448, %add612.i
  %add.i2172.i = add i32 %add31.i.i.i, %452
  %add749.i = add i32 %add.i2172.i, %459
  %add759.i = add i32 %add749.i, %462
  %add775.i = add i32 %add759.i, %466
  ...
  %467 = load i32, ptr %arrayidx778.i, align 4, !tbaa !157
  %cmp780.i = icmp ult i32 %add775.i, %467
...
if.end791.i:                                      ; preds = %if.then782.i, %while.end773.i, %for.end728.i, %if.then698.i, %if.end683.i
  ...
  %468 = tail call i32 @llvm.umin.i32(i32 %438, i32 %439)
  %469 = tail call i32 @llvm.umin.i32(i32 %468, i32 %indvars.iv1123)
  %umin1127 = zext i32 %469 to i64
  %470 = tail call i32 @llvm.umin.i32(i32 %438, i32 %indvars.iv1123)
...
for.body795.i:                                    ; preds = %cleanup1033.i, %if.end791.i
  ...
  %471 = load i32, ptr %arrayidx800.i, align 4, !tbaa !22
  %add801.i = add i32 %471, 1
  ...
  %472 = load i8, ptr %add.ptr563.i, align 1, !tbaa !24
  %473 = load i8, ptr %add.ptr804.i, align 1, !tbaa !24
  %cmp809.not.i = icmp eq i8 %472, %473
  br i1 %cmp809.not.i, label %lor.lhs.false811.i, label %cleanup1033.i

lor.lhs.false811.i:                               ; preds = %for.body795.i
  %474 = load i8, ptr %call562.i, align 1, !tbaa !24
  %arrayidx814.i = getelementptr inbounds i8, ptr %add.ptr804.i, i64 1
  %475 = load i8, ptr %arrayidx814.i, align 1, !tbaa !24
  %cmp816.not.i = icmp eq i8 %474, %475
...
land.rhs823.i:                                    ; preds = %for.cond820.preheader.i, %for.inc834.i
  ...
  %476 = load i8, ptr %arrayidx825.i, align 1, !tbaa !24
  %arrayidx828.i = getelementptr inbounds i8, ptr %add.ptr804.i, i64 %indvars.iv2476.i
  %477 = load i8, ptr %arrayidx828.i, align 1, !tbaa !24
  %cmp830.i = icmp eq i8 %476, %477
...
for.inc834.i:                                     ; preds = %land.rhs823.i
  ...
  %exitcond1128.not = icmp eq i64 %indvars.iv.next2477.i, %umin1127
  br i1 %exitcond1128.not, label %for.end836.loopexit.i, label %land.rhs823.i, !llvm.loop !171

for.end836.loopexit.i:                            ; preds = %for.inc834.i, %land.rhs823.i
  %lenTest796.0.lcssa.ph.in.i = phi i64 [ %indvars.iv2476.i, %land.rhs823.i ], [ %umin1127, %for.inc834.i ]
...
while.body841.preheader.i:                        ; preds = %for.end836.i
  %478 = zext i32 %lenEnd.42400.i to i64
  %wide.trip.count2484.i = zext i32 %add838.i to i64
  %479 = sub nsw i64 %wide.trip.count2484.i, %478
  %480 = xor i64 %478, -1
  %481 = add nsw i64 %480, %wide.trip.count2484.i
  %xtraiter1245 = and i64 %479, 3
  %lcmp.mod1246.not = icmp eq i64 %xtraiter1245, 0
  br i1 %lcmp.mod1246.not, label %while.body841.i.prol.loopexit, label %while.body841.i.prol

while.body841.i.prol:                             ; preds = %while.body841.preheader.i, %while.body841.i.prol
  %indvars.iv2480.i.prol = phi i64 [ %indvars.iv.next2481.i.prol, %while.body841.i.prol ], [ %478, %while.body841.preheader.i ]
  %prol.iter1247 = phi i64 [ %prol.iter1247.next, %while.body841.i.prol ], [ 0, %while.body841.preheader.i ]
  ...
  %prol.iter1247.next = add i64 %prol.iter1247, 1
  %prol.iter1247.cmp.not = icmp eq i64 %prol.iter1247.next, %xtraiter1245
  br i1 %prol.iter1247.cmp.not, label %while.body841.i.prol.loopexit, label %while.body841.i.prol, !llvm.loop !172

while.body841.i.prol.loopexit:                    ; preds = %while.body841.i.prol, %while.body841.preheader.i
  %indvars.iv2480.i.unr = phi i64 [ %478, %while.body841.preheader.i ], [ %indvars.iv.next2481.i.prol, %while.body841.i.prol ]
  %482 = icmp ult i64 %481, 3
  br i1 %482, label %while.end847.i, label %while.body841.i
...
if.else32.i2202.i:                                ; preds = %if.else.i2187.i
  ...
  %499 = load i32, ptr %arrayidx51.i2201.i, align 4, !tbaa !22
  br label %GetPureRepPrice.exit2206.i

GetPureRepPrice.exit2206.i:                       ; preds = %if.else32.i2202.i, %if.then23.i2190.i, %if.then.i2182.i
  %.sink76.i2203.i = phi i32 [ %491, %if.then23.i2190.i ], [ %499, %if.else32.i2202.i ], [ %485, %if.then.i2182.i ]
  %.sink.i2204.i = phi i32 [ %494, %if.then23.i2190.i ], [ %add42.i2193.i, %if.else32.i2202.i ], [ %489, %if.then.i2182.i ]
  %add31.i2205.i = add i32 %.sink76.i2203.i, %add647.i
  %add849.i = add i32 %add31.i2205.i, %.sink.i2204.i
  %500 = zext i32 %lenTest796.0.lcssa.i to i64
  %501 = trunc i64 %indvars.iv2500.i to i32
  br label %do.body850.i

do.body850.i:                                     ; preds = %if.end873.i, %GetPureRepPrice.exit2206.i
  %indvars.iv2486.i = phi i64 [ %indvars.iv.next2487.i, %if.end873.i ], [ %500, %GetPureRepPrice.exit2206.i ]
  ...
  %502 = load i32, ptr %arrayidx858.i, align 4, !tbaa !22
  %add859.i = add i32 %502, %add849.i
  ...
  %503 = load i32, ptr %arrayidx864.i, align 4, !tbaa !157
  %cmp866.i = icmp ult i32 %add859.i, %503
...
if.then868.i:                                     ; preds = %do.body850.i
  ...
  store i32 %501, ptr %backPrev871.i, align 4, !tbaa !152
...
if.end873.i:                                      ; preds = %if.then868.i, %do.body850.i
  ...
  %504 = and i64 %indvars.iv.next2487.i, 4294967294
  %cmp876.not.i = icmp eq i64 %504, 0
...
land.rhs897.preheader.i:                          ; preds = %do.end878.i
  %505 = zext i32 %add882.i to i64
  %506 = tail call i32 @llvm.umin.i32(i32 %470, i32 %add888.i)
  %umin1130 = zext i32 %506 to i64
  br label %land.rhs897.i

land.rhs897.i:                                    ; preds = %for.inc908.i, %land.rhs897.preheader.i
  %indvars.iv2490.i = phi i64 [ %505, %land.rhs897.preheader.i ], [ %indvars.iv.next2491.i, %for.inc908.i ]
  %arrayidx899.i = getelementptr inbounds i8, ptr %add.ptr563.i, i64 %indvars.iv2490.i
  %507 = load i8, ptr %arrayidx899.i, align 1, !tbaa !24
  %arrayidx902.i = getelementptr inbounds i8, ptr %add.ptr804.i, i64 %indvars.iv2490.i
  %508 = load i8, ptr %arrayidx902.i, align 1, !tbaa !24
  %cmp904.i = icmp eq i8 %507, %508
...
for.inc908.i:                                     ; preds = %land.rhs897.i
  ...
  %exitcond1131.not = icmp eq i64 %indvars.iv.next2491.i, %umin1130
  br i1 %exitcond1131.not, label %for.end910.loopexit.i, label %land.rhs897.i, !llvm.loop !175

for.end910.loopexit.i:                            ; preds = %for.inc908.i, %land.rhs897.i
  %lenTest2884.0.lcssa.ph.in.i = phi i64 [ %indvars.iv2490.i, %land.rhs897.i ], [ %umin1130, %for.inc908.i ]
...
if.then915.i:                                     ; preds = %for.end910.i
  %509 = load i32, ptr %arrayidx918.i, align 4, !tbaa !22
  %add920.i = add i32 %lenTest796.0.lcssa.i, %inc416.i
  %and922.i = and i32 %add920.i, %409
  ...
  %510 = load i32, ptr %arrayidx929.i, align 4, !tbaa !22
  %idxprom933.i = zext i32 %509 to i64
  ...
  %511 = load i16, ptr %arrayidx936.i, align 2, !tbaa !31
  %512 = lshr i16 %511, 4
  %idxprom939.i = zext i16 %512 to i64
  %arrayidx940.i = getelementptr inbounds %struct.CLzmaEnc, ptr %p, i64 0, i32 13, i64 %idxprom939.i
  %513 = load i32, ptr %arrayidx940.i, align 4, !tbaa !22
  %and945.i = and i32 %add920.i, %414
  %shl947.i = shl i32 %and945.i, %415
  ...
  %514 = load i8, ptr %arrayidx950.i, align 1, !tbaa !24
  %conv951.i = zext i8 %514 to i32
  ...
  %add.ptr958.i = getelementptr inbounds i16, ptr %413, i64 %idx.ext957.i
  %arrayidx960.i = getelementptr inbounds i8, ptr %add.ptr563.i, i64 %500
  %515 = load i8, ptr %arrayidx960.i, align 1, !tbaa !24
  %conv961.i = zext i8 %515 to i32
  %arrayidx963.i = getelementptr inbounds i8, ptr %add.ptr804.i, i64 %500
  %516 = load i8, ptr %arrayidx963.i, align 1, !tbaa !24
  %conv964.i = zext i8 %516 to i32
...
do.body.i2231.i:                                  ; preds = %do.body.i2231.i, %if.then915.i
  ...
  %517 = load i16, ptr %arrayidx.i2218.i, align 2, !tbaa !31
  %conv.i2219.i = zext i16 %517 to i64
  ...
  %518 = load i32, ptr %arrayidx7.i2225.i, align 4, !tbaa !22
  %add8.i2226.i = add i32 %518, %price.0.i2210.i
  %shl9.i2227.i = shl nuw nsw i32 %symbol.addr.0.i2209.i, 1
  %519 = xor i32 %shl.i2212.i, %shl9.i2227.i
  %not.i2228.i = xor i32 %519, -1
...
LitEnc_GetPriceMatched.exit2232.i:                ; preds = %do.body.i2231.i
  ...
  %520 = load i32, ptr %arrayidx970.i, align 4, !tbaa !22
  %add972.i = add i32 %add920.i, 1
  %and974.i = and i32 %add972.i, %409
  %idxprom977.i = zext i32 %520 to i64
...
while.body1006.preheader.i:                       ; preds = %LitEnc_GetPriceMatched.exit2232.i
  %529 = zext i32 %lenEnd.5.lcssa.i to i64
  %530 = add i32 %lenTest2884.0.lcssa.i, %inc4012418.i
  %wide.trip.count2498.i = zext i32 %530 to i64
  %531 = sub nsw i64 %wide.trip.count2498.i, %529
  %532 = xor i64 %529, -1
  %533 = add nsw i64 %532, %wide.trip.count2498.i
  %xtraiter1248 = and i64 %531, 3
  %lcmp.mod1249.not = icmp eq i64 %xtraiter1248, 0
  br i1 %lcmp.mod1249.not, label %while.body1006.i.prol.loopexit, label %while.body1006.i.prol

while.body1006.i.prol:                            ; preds = %while.body1006.preheader.i, %while.body1006.i.prol
  %indvars.iv2494.i.prol = phi i64 [ %indvars.iv.next2495.i.prol, %while.body1006.i.prol ], [ %529, %while.body1006.preheader.i ]
  %prol.iter1250 = phi i64 [ %prol.iter1250.next, %while.body1006.i.prol ], [ 0, %while.body1006.preheader.i ]
  ...
  %prol.iter1250.next = add i64 %prol.iter1250, 1
  %prol.iter1250.cmp.not = icmp eq i64 %prol.iter1250.next, %xtraiter1248
  br i1 %prol.iter1250.cmp.not, label %while.body1006.i.prol.loopexit, label %while.body1006.i.prol, !llvm.loop !176

while.body1006.i.prol.loopexit:                   ; preds = %while.body1006.i.prol, %while.body1006.preheader.i
  %indvars.iv2494.i.unr = phi i64 [ %529, %while.body1006.preheader.i ], [ %indvars.iv.next2495.i.prol, %while.body1006.i.prol ]
  %534 = icmp ult i64 %533, 3
  br i1 %534, label %while.end1012.i, label %while.body1006.i
...
while.end1012.i:                                  ; preds = %while.body1006.i.prol.loopexit, %while.body1006.i, %LitEnc_GetPriceMatched.exit2232.i
  %lenEnd.6.lcssa.i = phi i32 [ %lenEnd.5.lcssa.i, %LitEnc_GetPriceMatched.exit2232.i ], [ %530, %while.body1006.i ], [ %530, %while.body1006.i.prol.loopexit ]
  ...
  %535 = load i32, ptr %arrayidx2.i2236.i, align 4, !tbaa !22
  %arrayidx.i.i2238.i = getelementptr inbounds %struct.CLzmaEnc, ptr %p, i64 0, i32 32, i64 %idxprom977.i
  %536 = load i16, ptr %arrayidx.i.i2238.i, align 2, !tbaa !31
  %537 = lshr i16 %536, 4
  %idxprom1.i.i2239.i = zext i16 %537 to i64
  %arrayidx2.i.i2240.i = getelementptr inbounds %struct.CLzmaEnc, ptr %p, i64 0, i32 13, i64 %idxprom1.i.i2239.i
  %538 = load i32, ptr %arrayidx2.i.i2240.i, align 4, !tbaa !22
  %arrayidx7.i.i2241.i = getelementptr inbounds %struct.CLzmaEnc, ptr %p, i64 0, i32 35, i64 %idxprom977.i, i64 %idxprom979.i
  %539 = load i16, ptr %arrayidx7.i.i2241.i, align 2, !tbaa !31
  %540 = lshr i16 %539, 4
  %541 = xor i16 %540, 127
  %idxprom10.i.i2242.i = zext i16 %541 to i64
  %arrayidx11.i.i2243.i = getelementptr inbounds %struct.CLzmaEnc, ptr %p, i64 0, i32 13, i64 %idxprom10.i.i2242.i
  %542 = load i32, ptr %arrayidx11.i.i2243.i, align 4, !tbaa !22
  %add31.i.i2244.i = add i32 %510, %add849.i
  %add.i2245.i = add i32 %add31.i.i2244.i, %513
  %add930.i = add i32 %add.i2245.i, %add8.i2226.i
  %add941.i = add i32 %add930.i, %524
  %add968.i = add i32 %add941.i, %528
  %add986.i = add i32 %add968.i, %535
  %add996.i = add i32 %add986.i, %538
  %add1014.i = add i32 %add996.i, %542
  ...
  %543 = load i32, ptr %arrayidx1017.i, align 4, !tbaa !157
  %cmp1019.i = icmp ult i32 %add1014.i, %543
...
if.then1021.i:                                    ; preds = %while.end1012.i
  ...
  store i32 %501, ptr %backPrev21030.i, align 4, !tbaa !167
...
for.cond1045.i:                                   ; preds = %for.end1041.i, %for.cond1045.i
  ...
  %544 = load i32, ptr %arrayidx1047.i, align 4, !tbaa !22
  %cmp1048.i = icmp ugt i32 %.spec.select2295.i, %544
...
if.then1060.i:                                    ; preds = %if.end1057.i
  %idxprom1068.i = zext i16 %427 to i64
  %arrayidx1069.i = getelementptr inbounds %struct.CLzmaEnc, ptr %p, i64 0, i32 13, i64 %idxprom1068.i
  %545 = load i32, ptr %arrayidx1069.i, align 4, !tbaa !22
  %add1070.i = add i32 %545, %add637.i
...
while.body1077.preheader.i:                       ; preds = %if.then1060.i
  %546 = zext i32 %lenEnd.8.i to i64
  %umin1132 = tail call i32 @llvm.umin.i32(i32 %lenRes.1.i2073.i, i32 %438)
  %umin1133 = tail call i32 @llvm.umin.i32(i32 %umin1132, i32 %439)
  %umin1134 = tail call i32 @llvm.umin.i32(i32 %umin1133, i32 %indvars.iv1123)
  %547 = add i32 %umin1134, %inc4012418.i
  %548 = zext i32 %547 to i64
  %549 = sub nsw i64 %548, %546
  %550 = xor i64 %546, -1
  %551 = add nsw i64 %550, %548
  %xtraiter1251 = and i64 %549, 3
  %lcmp.mod1252.not = icmp eq i64 %xtraiter1251, 0
  br i1 %lcmp.mod1252.not, label %while.body1077.i.prol.loopexit, label %while.body1077.i.prol

while.body1077.i.prol:                            ; preds = %while.body1077.preheader.i, %while.body1077.i.prol
  %indvars.iv2506.i.prol = phi i64 [ %indvars.iv.next2507.i.prol, %while.body1077.i.prol ], [ %546, %while.body1077.preheader.i ]
  %prol.iter1253 = phi i64 [ %prol.iter1253.next, %while.body1077.i.prol ], [ 0, %while.body1077.preheader.i ]
  ...
  br i1 %prol.iter1253.cmp.not, label %while.body1077.i.prol.loopexit, label %while.body1077.i.prol, !llvm.loop !180

while.body1077.i.prol.loopexit:                   ; preds = %while.body1077.i.prol, %while.body1077.preheader.i
  %indvars.iv2506.i.unr = phi i64 [ %546, %while.body1077.preheader.i ], [ %indvars.iv.next2507.i.prol, %while.body1077.i.prol ]
  %552 = icmp ult i64 %551, 3
  br i1 %552, label %while.cond1084.preheader.i, label %while.body1077.i

while.cond1084.preheader.i:                       ; preds = %while.body1077.i.prol.loopexit, %while.body1077.i, %if.then1060.i
  %lenEnd.9.lcssa.i = phi i32 [ %lenEnd.8.i, %if.then1060.i ], [ %547, %while.body1077.i ], [ %547, %while.body1077.i.prol.loopexit ]
...
while.body1077.i:                                 ; preds = %while.body1077.i.prol.loopexit, %while.body1077.i
  ...
  %exitcond1135.not.3 = icmp eq i64 %indvars.iv.next2507.i.3, %548
  br i1 %exitcond1135.not.3, label %while.cond1084.preheader.i, label %while.body1077.i, !llvm.loop !181
...
while.cond1084.i:                                 ; preds = %while.cond1084.i, %while.cond1084.preheader.i
  ...
  %553 = load i32, ptr %arrayidx1086.i, align 4, !tbaa !22
  %cmp1087.i = icmp ugt i32 %startLen.2.i, %553
...
while.end1091.i:                                  ; preds = %while.cond1084.i
  ...
  %554 = load i32, ptr %arrayidx1094.i, align 4, !tbaa !22
  %notsub.i = add i32 %554, -524288
  %isneg.inv.i = icmp slt i32 %notsub.i, 0
  %add1100.i = select i1 %isneg.inv.i, i32 6, i32 18
  %shr1102.i = lshr i32 %554, %add1100.i
  ...
  %555 = load i8, ptr %arrayidx1104.i, align 1, !tbaa !24
  %conv1105.i = zext i8 %555 to i32
  ...
  %556 = load i32, ptr %numFastBytes.i.i, align 8, !tbaa !66
...
for.cond1108.i.outer.outer:                       ; preds = %while.end1091.i, %if.then1325.i
  ...
  %curBack.0.i.ph.ph = phi i32 [ %554, %while.end1091.i ], [ %604, %if.then1325.i ]
...
for.cond1108.i.outer:                             ; preds = %for.cond1108.i.outer.outer, %if.end1319.i
  ...
  %curBack.0.i.ph = phi i32 [ %604, %if.end1319.i ], [ %curBack.0.i.ph.ph, %for.cond1108.i.outer.outer ]
...
for.cond1108.i:                                   ; preds = %for.cond1108.i.outer, %if.end1162.for.inc1352_crit_edge.i
  ...
  %557 = load i32, ptr %arrayidx1116.i, align 4, !tbaa !22
  %add1117.i = add i32 %add1070.i, %557
...
if.then1129.i:                                    ; preds = %for.cond1108.i
  ...
  %558 = load i32, ptr %arrayidx1134.i, align 4, !tbaa !22
...
if.else1136.i:                                    ; preds = %for.cond1108.i
  ...
  %559 = load i32, ptr %arrayidx1141.i, align 4, !tbaa !22
  %560 = load i32, ptr %arrayidx1145.i, align 4, !tbaa !22
  %add1146.i = add i32 %560, %559
  br label %if.end1148.i

if.end1148.i:                                     ; preds = %if.else1136.i, %if.then1129.i
  %.pn.i = phi i32 [ %558, %if.then1129.i ], [ %add1146.i, %if.else1136.i ]
  ...
  %561 = load i32, ptr %arrayidx1152.i, align 4, !tbaa !157
  %cmp1154.i = icmp ult i32 %curAndLenPrice1109.0.i, %561
...
if.end1162.i:                                     ; preds = %if.then1156.i, %if.end1148.i
  %562 = load i32, ptr %arrayidx1164.i, align 4, !tbaa !22
  %cmp1165.i = icmp eq i32 %lenTest1072.0.i, %562
...
if.then1167.i:                                    ; preds = %if.end1162.i
  %563 = zext i32 %indvars.iv2510.i to i64
  ...
  %add1177.i = add i32 %556, %add1174.i
...
land.rhs1186.preheader.i:                         ; preds = %if.then1167.i
  %564 = zext i32 %spec.select2299.i to i64
  br label %land.rhs1186.i

land.rhs1186.i:                                   ; preds = %for.inc1197.i, %land.rhs1186.preheader.i
  %indvars.iv2512.i = phi i64 [ %563, %land.rhs1186.preheader.i ], [ %indvars.iv.next2513.i, %for.inc1197.i ]
  %arrayidx1188.i = getelementptr inbounds i8, ptr %add.ptr563.i, i64 %indvars.iv2512.i
  %565 = load i8, ptr %arrayidx1188.i, align 1, !tbaa !24
  %arrayidx1191.i = getelementptr inbounds i8, ptr %add.ptr1172.i, i64 %indvars.iv2512.i
  %566 = load i8, ptr %arrayidx1191.i, align 1, !tbaa !24
  %cmp1193.i = icmp eq i8 %565, %566
...
for.inc1197.i:                                    ; preds = %land.rhs1186.i
  ...
  %cmp1184.i = icmp ult i64 %indvars.iv.next2513.i, %564
...
if.then1204.i:                                    ; preds = %for.end1199.i
  %567 = load i32, ptr %arrayidx1207.i, align 4, !tbaa !22
  %add1209.i = add i32 %lenTest1072.0.i, %inc416.i
  %568 = load i32, ptr %pbMask1043, align 4, !tbaa !98
  %and1211.i = and i32 %568, %add1209.i
  %idxprom1215.i = zext i32 %567 to i64
  ...
  %569 = load i16, ptr %arrayidx1218.i, align 2, !tbaa !31
  %570 = lshr i16 %569, 4
  %idxprom1221.i = zext i16 %570 to i64
  %arrayidx1222.i = getelementptr inbounds %struct.CLzmaEnc, ptr %p, i64 0, i32 13, i64 %idxprom1221.i
  %571 = load i32, ptr %arrayidx1222.i, align 4, !tbaa !22
  %572 = load i32, ptr %lpMask.i, align 8, !tbaa !99
  %and1227.i = and i32 %572, %add1209.i
  %573 = load i32, ptr %lc.i, align 4, !tbaa !67
  %shl1229.i = shl i32 %and1227.i, %573
  ...
  %574 = load i8, ptr %arrayidx1232.i, align 1, !tbaa !24
  %conv1233.i = zext i8 %574 to i32
  %sub1235.i = sub i32 8, %573
  ...
  %add.ptr1240.i = getelementptr inbounds i16, ptr %413, i64 %idx.ext1239.i
  %idxprom1241.i = zext i32 %lenTest1072.0.i to i64
  %arrayidx1242.i = getelementptr inbounds i8, ptr %add.ptr563.i, i64 %idxprom1241.i
  %575 = load i8, ptr %arrayidx1242.i, align 1, !tbaa !24
  %conv1243.i = zext i8 %575 to i32
  %arrayidx1245.i = getelementptr inbounds i8, ptr %add.ptr1172.i, i64 %idxprom1241.i
  %576 = load i8, ptr %arrayidx1245.i, align 1, !tbaa !24
  %conv1246.i = zext i8 %576 to i32
...
do.body.i2270.i:                                  ; preds = %do.body.i2270.i, %if.then1204.i
  ...
  %577 = load i16, ptr %arrayidx.i2257.i, align 2, !tbaa !31
  %conv.i2258.i = zext i16 %577 to i64
  ...
  %578 = load i32, ptr %arrayidx7.i2264.i, align 4, !tbaa !22
  %add8.i2265.i = add i32 %578, %price.0.i2249.i
  %shl9.i2266.i = shl nuw nsw i32 %symbol.addr.0.i2248.i, 1
  %579 = xor i32 %shl.i2251.i, %shl9.i2266.i
  %not.i2267.i = xor i32 %579, -1
...
LitEnc_GetPriceMatched.exit2271.i:                ; preds = %do.body.i2270.i
  ...
  %580 = load i32, ptr %arrayidx1252.i, align 4, !tbaa !22
  %add1253.i = add i32 %and1211.i, 1
  %and1255.i = and i32 %add1253.i, %568
  %idxprom1258.i = zext i32 %580 to i64
...
while.body1287.preheader.i:                       ; preds = %LitEnc_GetPriceMatched.exit2271.i
  %589 = zext i32 %lenEnd.10.i.ph to i64
  %590 = add i32 %lenTest21173.0.lcssa.i, %inc4012418.i
  %wide.trip.count2520.i = zext i32 %590 to i64
  %591 = sub nsw i64 %wide.trip.count2520.i, %589
  %592 = xor i64 %589, -1
  %593 = add nsw i64 %592, %wide.trip.count2520.i
  %xtraiter1254 = and i64 %591, 3
  %lcmp.mod1255.not = icmp eq i64 %xtraiter1254, 0
  br i1 %lcmp.mod1255.not, label %while.body1287.i.prol.loopexit, label %while.body1287.i.prol

while.body1287.i.prol:                            ; preds = %while.body1287.preheader.i, %while.body1287.i.prol
  %indvars.iv2516.i.prol = phi i64 [ %indvars.iv.next2517.i.prol, %while.body1287.i.prol ], [ %589, %while.body1287.preheader.i ]
  %prol.iter1256 = phi i64 [ %prol.iter1256.next, %while.body1287.i.prol ], [ 0, %while.body1287.preheader.i ]
  ...
  %prol.iter1256.next = add i64 %prol.iter1256, 1
  %prol.iter1256.cmp.not = icmp eq i64 %prol.iter1256.next, %xtraiter1254
  br i1 %prol.iter1256.cmp.not, label %while.body1287.i.prol.loopexit, label %while.body1287.i.prol, !llvm.loop !184

while.body1287.i.prol.loopexit:                   ; preds = %while.body1287.i.prol, %while.body1287.preheader.i
  %indvars.iv2516.i.unr = phi i64 [ %589, %while.body1287.preheader.i ], [ %indvars.iv.next2517.i.prol, %while.body1287.i.prol ]
  %594 = icmp ult i64 %593, 3
  br i1 %594, label %while.end1293.i, label %while.body1287.i
...
while.end1293.i:                                  ; preds = %while.body1287.i.prol.loopexit, %while.body1287.i, %LitEnc_GetPriceMatched.exit2271.i
  %lenEnd.11.lcssa.i = phi i32 [ %lenEnd.10.i.ph, %LitEnc_GetPriceMatched.exit2271.i ], [ %590, %while.body1287.i ], [ %590, %while.body1287.i.prol.loopexit ]
  ...
  %595 = load i32, ptr %arrayidx2.i2275.i, align 4, !tbaa !22
  %arrayidx.i.i2277.i = getelementptr inbounds %struct.CLzmaEnc, ptr %p, i64 0, i32 32, i64 %idxprom1258.i
  %596 = load i16, ptr %arrayidx.i.i2277.i, align 2, !tbaa !31
  %597 = lshr i16 %596, 4
  %idxprom1.i.i2278.i = zext i16 %597 to i64
  %arrayidx2.i.i2279.i = getelementptr inbounds %struct.CLzmaEnc, ptr %p, i64 0, i32 13, i64 %idxprom1.i.i2278.i
  %598 = load i32, ptr %arrayidx2.i.i2279.i, align 4, !tbaa !22
  %arrayidx7.i.i2280.i = getelementptr inbounds %struct.CLzmaEnc, ptr %p, i64 0, i32 35, i64 %idxprom1258.i, i64 %idxprom1260.i
  %599 = load i16, ptr %arrayidx7.i.i2280.i, align 2, !tbaa !31
  %600 = lshr i16 %599, 4
  %601 = xor i16 %600, 127
  %idxprom10.i.i2281.i = zext i16 %601 to i64
  %arrayidx11.i.i2282.i = getelementptr inbounds %struct.CLzmaEnc, ptr %p, i64 0, i32 13, i64 %idxprom10.i.i2281.i
  %602 = load i32, ptr %arrayidx11.i.i2282.i, align 4, !tbaa !22
  %add31.i.i2283.i = add i32 %571, %curAndLenPrice1109.0.i
  %add.i2284.i = add i32 %add31.i.i2283.i, %add8.i2265.i
  %add1223.i = add i32 %add.i2284.i, %584
  %add1250.i = add i32 %add1223.i, %588
  %add1267.i = add i32 %add1250.i, %595
  %add1277.i = add i32 %add1267.i, %598
  %add1295.i = add i32 %add1277.i, %602
  ...
  %603 = load i32, ptr %arrayidx1298.i, align 4, !tbaa !157
  %cmp1300.i = icmp ult i32 %add1295.i, %603
...
if.then1325.i:                                    ; preds = %if.end1319.i
  ...
  %605 = load i8, ptr %arrayidx1335.i, align 1, !tbaa !24
  %conv1336.i = zext i8 %605 to i32
...
cleanup1356.i:                                    ; preds = %if.end1314.i, %if.end1057.i, %if.end673.i
  ...
  %indvars.iv.next1124 = add i32 %indvars.iv1123, -1
...
GetOptimum.exit:                                  ; preds = %if.end193.i, %if.end89.i, %if.end11.i, %if.then.i564, %if.then72.i, %if.then.i1989.i, %if.then83.i, %if.then.i1995.i, %Backward.exit.i, %Backward.exit2114.i
  %pos.2 = phi i32 [ %352, %Backward.exit.i ], [ %378, %Backward.exit2114.i ], [ %add87.i, %if.then83.i ], [ %add87.i, %if.then.i1995.i ], [ %repMaxIndex.2.3.i, %if.then72.i ], [ %repMaxIndex.2.3.i, %if.then.i1989.i ], [ %184, %if.then.i564 ], [ -1, %if.end11.i ], [ -1, %if.end89.i ], [ %278, %if.end193.i ]
  %retval.2.i = phi i32 [ %353, %Backward.exit.i ], [ %379, %Backward.exit2114.i ], [ 1, %if.then83.i ], [ %mainLen.0.i611, %if.then.i1995.i ], [ 1, %if.then72.i ], [ %241, %if.then.i1989.i ], [ %sub.i563, %if.then.i564 ], [ 1, %if.end11.i ], [ 1, %if.end89.i ], [ 1, %if.end193.i ]
...
if.end47.thread:                                  ; preds = %for.end238.i, %if.then39.i
  ...
  %cmp481045 = phi i1 [ true, %if.then39.i ], [ false, %for.end238.i ]
  %len.0.ph = phi i32 [ 1, %if.then39.i ], [ 2, %for.end238.i ]
  %606 = load i32, ptr %pbMask1043, align 4, !tbaa !98
  %and1044 = and i32 %606, %nowPos32.2
  br label %if.else93

if.end47:                                         ; preds = %for.inc224.us.i, %for.inc224.us.1.i, %for.inc224.us.2.i, %for.inc224.us.3.i, %cleanup241.sink.split.i, %lor.lhs.false200.3.i, %lor.lhs.false200.2.i, %lor.lhs.false200.1.i, %lor.lhs.false200.i, %for.end226.us.3.i, %for.end226.us.2.i, %for.end226.us.1.i, %for.end226.us.i, %cleanup172.i, %lor.lhs.false144.i, %if.then133.i, %if.end119.i, %if.then53.i, %if.end.i548, %GetOptimum.exit
  %pos.3 = phi i32 [ %pos.2, %GetOptimum.exit ], [ -1, %if.end.i548 ], [ %pos.0, %cleanup241.sink.split.i ], [ -1, %if.end119.i ], [ -1, %for.end226.us.3.i ], [ -1, %for.end226.us.2.i ], [ -1, %for.end226.us.1.i ], [ -1, %for.end226.us.i ], [ -1, %lor.lhs.false200.i ], [ -1, %lor.lhs.false200.1.i ], [ -1, %lor.lhs.false200.2.i ], [ -1, %lor.lhs.false200.3.i ], [ -1, %if.then133.i ], [ -1, %lor.lhs.false144.i ], [ -1, %cleanup172.i ], [ %add57.i, %if.then53.i ], [ -1, %for.inc224.us.3.i ], [ -1, %for.inc224.us.2.i ], [ -1, %for.inc224.us.1.i ], [ -1, %for.inc224.us.i ]
  %len.0 = phi i32 [ %retval.2.i, %GetOptimum.exit ], [ 1, %if.end.i548 ], [ %retval.6.ph.i, %cleanup241.sink.split.i ], [ 1, %if.end119.i ], [ 1, %for.end226.us.3.i ], [ 1, %for.end226.us.2.i ], [ 1, %for.end226.us.1.i ], [ 1, %for.end226.us.i ], [ 1, %lor.lhs.false200.i ], [ 1, %lor.lhs.false200.1.i ], [ 1, %lor.lhs.false200.2.i ], [ 1, %lor.lhs.false200.3.i ], [ 1, %if.then133.i ], [ 1, %lor.lhs.false144.i ], [ 1, %cleanup172.i ], [ 1, %if.then53.i ], [ 1, %for.inc224.us.3.i ], [ 1, %for.inc224.us.2.i ], [ 1, %for.inc224.us.1.i ], [ 1, %for.inc224.us.i ]
  %607 = load i32, ptr %pbMask1043, align 4, !tbaa !98
  %and = and i32 %607, %nowPos32.2
...
if.then52:                                        ; preds = %if.end47
  %608 = load i32, ptr %state.i, align 8, !tbaa !33
  %idxprom57 = zext i32 %608 to i64
  ...
  %609 = load i16, ptr %arrayidx60, align 2, !tbaa !31
  %conv.i663 = zext i16 %609 to i32
  %610 = load i32, ptr %rc94, align 8, !tbaa !86
  %shr.i664 = lshr i32 %610, 11
  ...
  %611 = trunc i32 %shr3.i667 to i16
  %conv10.i670 = add i16 %609, %611
...
RangeEnc_EncodeBit.exit675:                       ; preds = %if.then52, %if.then14.i674
  %612 = load ptr, ptr %GetPointerToCurrentPos.i.i, align 8, !tbaa !127
  %613 = load ptr, ptr %matchFinderObj38, align 8, !tbaa !121
  %call63 = tail call ptr %612(ptr noundef %613) #16
  %614 = load i32, ptr %additionalOffset.i542, align 4, !tbaa !97
  %idx.ext = zext i32 %614 to i64
  %idx.neg = sub nsw i64 0, %idx.ext
  %add.ptr = getelementptr inbounds i8, ptr %call63, i64 %idx.neg
  %615 = load i8, ptr %add.ptr, align 1, !tbaa !24
  %616 = load ptr, ptr %litProbs.i, align 8, !tbaa !52
  %617 = load i32, ptr %lpMask.i, align 8, !tbaa !99
  %and66 = and i32 %617, %nowPos32.2
  %618 = load i32, ptr %lc.i, align 4, !tbaa !67
  %shl = shl i32 %and66, %618
  %add.ptr67 = getelementptr inbounds i8, ptr %add.ptr, i64 -1
  %619 = load i8, ptr %add.ptr67, align 1, !tbaa !24
  %conv68 = zext i8 %619 to i32
  %sub70 = sub i32 8, %618
  %shr = lshr i32 %conv68, %sub70
  %add = add i32 %shr, %shl
  %mul = mul i32 %add, 768
  %idx.ext71 = zext i32 %mul to i64
  %add.ptr72 = getelementptr inbounds i16, ptr %616, i64 %idx.ext71
  %620 = load i32, ptr %state.i, align 8, !tbaa !33
  %cmp74 = icmp ult i32 %620, 7
  %conv78 = zext i8 %615 to i32
...
do.body.i686:                                     ; preds = %RangeEnc_EncodeBit.exit.i706, %if.then76
  ...
  %621 = load i16, ptr %add.ptr.i681, align 2, !tbaa !31
  %conv.i.i682 = zext i16 %621 to i32
  %622 = load i32, ptr %rc94, align 8, !tbaa !86
  %shr.i.i683 = lshr i32 %622, 11
  %mul.i.i684 = mul i32 %shr.i.i683, %conv.i.i682
  %623 = and i32 %symbol.addr.0.i678, 128
  %cmp.i.i685 = icmp eq i32 %623, 0
...
if.else.i.i696:                                   ; preds = %do.body.i686
  ...
  %add5.i.i692 = add i64 %624, %conv4.i.i691
  store i64 %add5.i.i692, ptr %low.i, align 8, !tbaa !85
  %sub7.i.i693 = sub i32 %622, %mul.i.i684
...
if.else79:                                        ; preds = %RangeEnc_EncodeBit.exit675
  %625 = load i32, ptr %arrayidx.us.i, align 8, !tbaa !22
  %idx.ext83 = zext i32 %625 to i64
  ...
  %626 = load i8, ptr %add.ptr86, align 1, !tbaa !24
  %conv87 = zext i8 %626 to i32
...
do.body.i722:                                     ; preds = %RangeEnc_EncodeBit.exit.i741, %if.else79
  ...
  %627 = load i16, ptr %add.ptr.i717, align 2, !tbaa !31
  %conv.i.i718 = zext i16 %627 to i32
  %628 = load i32, ptr %rc94, align 8, !tbaa !86
  %shr.i.i719 = lshr i32 %628, 11
  %mul.i.i720 = mul i32 %shr.i.i719, %conv.i.i718
  %629 = and i32 %symbol.addr.0.i710, 128
  %cmp.i.i721 = icmp eq i32 %629, 0
...
if.else.i.i732:                                   ; preds = %do.body.i722
  ...
  %add5.i.i728 = add i64 %630, %conv4.i.i727
  store i64 %add5.i.i728, ptr %low.i, align 8, !tbaa !85
  %sub7.i.i729 = sub i32 %628, %mul.i.i720
...
if.end88:                                         ; preds = %RangeEnc_EncodeBit.exit.i741, %RangeEnc_EncodeBit.exit.i706
  ...
  %idxprom90 = zext i32 %632 to i64
  %arrayidx91 = getelementptr inbounds [12 x i32], ptr @kLiteralNextStates, i64 0, i64 %idxprom90
  %633 = load i32, ptr %arrayidx91, align 4, !tbaa !22
  store i32 %633, ptr %state.i, align 8, !tbaa !33
  br label %if.end279

if.else93:                                        ; preds = %if.end47.thread, %if.end47
  %cmp481052 = phi i1 [ %cmp481045, %if.end47.thread ], [ %cmp48, %if.end47 ]
  %and1051 = phi i32 [ %and1044, %if.end47.thread ], [ %and, %if.end47 ]
  %len.01050 = phi i32 [ %len.0.ph, %if.end47.thread ], [ %len.0, %if.end47 ]
  %pos.31048 = phi i32 [ %pos.3.ph, %if.end47.thread ], [ %pos.3, %if.end47 ]
  %634 = load i32, ptr %state.i, align 8, !tbaa !33
  %idxprom97 = zext i32 %634 to i64
  %idxprom99 = zext i32 %and1051 to i64
  %arrayidx100 = getelementptr inbounds %struct.CLzmaEnc, ptr %p, i64 0, i32 30, i64 %idxprom97, i64 %idxprom99
  %635 = load i16, ptr %arrayidx100, align 2, !tbaa !31
  %conv.i742 = zext i16 %635 to i32
  %636 = load i32, ptr %rc94, align 8, !tbaa !86
  %shr.i743 = lshr i32 %636, 11
  %mul.i744 = mul i32 %shr.i743, %conv.i742
  %conv4.i = zext i32 %mul.i744 to i64
  %637 = load i64, ptr %low.i, align 8, !tbaa !85
  %add5.i = add i64 %637, %conv4.i
  store i64 %add5.i, ptr %low.i, align 8, !tbaa !85
  %sub7.i = sub i32 %636, %mul.i744
  %shr8.i = lshr i16 %635, 5
  %sub9.i = sub i16 %635, %shr8.i
...
if.then103:                                       ; preds = %RangeEnc_EncodeBit.exit751
  ...
  %add5.i757 = add i64 %641, %conv4.i755
  store i64 %add5.i757, ptr %low.i, align 8, !tbaa !85
  %sub7.i758 = sub i32 %640, %mul.i754
  %shr8.i759 = lshr i16 %639, 5
  %sub9.i760 = sub i16 %639, %shr8.i759
...
RangeEnc_EncodeBit.exit767:                       ; preds = %if.then103, %if.then14.i766
  %cmp108 = icmp eq i32 %pos.31048, 0
  br i1 %cmp108, label %if.then110, label %if.else123

if.then110:                                       ; preds = %RangeEnc_EncodeBit.exit767
  %642 = load i32, ptr %state.i, align 8, !tbaa !33
  %idxprom113 = zext i32 %642 to i64
  %arrayidx114 = getelementptr inbounds %struct.CLzmaEnc, ptr %p, i64 0, i32 32, i64 %idxprom113
  %643 = load i16, ptr %arrayidx114, align 2, !tbaa !31
  %conv.i768 = zext i16 %643 to i32
  %644 = load i32, ptr %rc94, align 8, !tbaa !86
  %shr.i769 = lshr i32 %644, 11
  ...
  %645 = trunc i32 %shr3.i772 to i16
  %conv10.i775 = add i16 %643, %645
...
if.then14.i779:                                   ; preds = %if.then110
  ...
  tail call fastcc void @RangeEnc_ShiftLow(ptr noundef nonnull %rc94)
  %.pre1148 = load i32, ptr %state.i, align 8, !tbaa !33
  %.pre1149 = load i32, ptr %rc94, align 8, !tbaa !86
...
RangeEnc_EncodeBit.exit780:                       ; preds = %if.then110, %if.then14.i779
  %idxprom117.pre-phi = phi i64 [ %idxprom113, %if.then110 ], [ %.pre1153, %if.then14.i779 ]
  %646 = phi i32 [ %mul.i770, %if.then110 ], [ %.pre1149, %if.then14.i779 ]
  %arrayidx120 = getelementptr inbounds %struct.CLzmaEnc, ptr %p, i64 0, i32 35, i64 %idxprom117.pre-phi, i64 %idxprom99
  %647 = load i16, ptr %arrayidx120, align 2, !tbaa !31
  %conv.i781 = zext i16 %647 to i32
  %shr.i782 = lshr i32 %646, 11
  %mul.i783 = mul i32 %shr.i782, %conv.i781
  br i1 %cmp481052, label %if.then.i787, label %if.else.i794
...
if.else.i794:                                     ; preds = %RangeEnc_EncodeBit.exit780
  ...
  %648 = load i64, ptr %low.i, align 8, !tbaa !85
  %add5.i790 = add i64 %648, %conv4.i788
  store i64 %add5.i790, ptr %low.i, align 8, !tbaa !85
  %sub7.i791 = sub i32 %646, %mul.i783
...
if.else123:                                       ; preds = %RangeEnc_EncodeBit.exit767
  %idxprom125 = zext i32 %pos.31048 to i64
  %arrayidx126 = getelementptr inbounds %struct.CLzmaEnc, ptr %p, i64 0, i32 17, i64 %idxprom125
  %649 = load i32, ptr %arrayidx126, align 4, !tbaa !22
  %650 = load i32, ptr %state.i, align 8, !tbaa !33
  %idxprom130 = zext i32 %650 to i64
  %arrayidx131 = getelementptr inbounds %struct.CLzmaEnc, ptr %p, i64 0, i32 32, i64 %idxprom130
  %651 = load i16, ptr %arrayidx131, align 2, !tbaa !31
  %conv.i801 = zext i16 %651 to i32
  %652 = load i32, ptr %rc94, align 8, !tbaa !86
  %shr.i802 = lshr i32 %652, 11
  %mul.i803 = mul i32 %shr.i802, %conv.i801
  %conv4.i804 = zext i32 %mul.i803 to i64
  %653 = load i64, ptr %low.i, align 8, !tbaa !85
  %add5.i806 = add i64 %653, %conv4.i804
  store i64 %add5.i806, ptr %low.i, align 8, !tbaa !85
  %sub7.i807 = sub i32 %652, %mul.i803
  %shr8.i808 = lshr i16 %651, 5
  %sub9.i809 = sub i16 %651, %shr8.i808
...
RangeEnc_EncodeBit.exit818:                       ; preds = %if.else123, %if.then14.i817
  %cmp132 = icmp eq i32 %pos.31048, 1
  %654 = load i32, ptr %state.i, align 8, !tbaa !33
  %idxprom137 = zext i32 %654 to i64
  %arrayidx138 = getelementptr inbounds %struct.CLzmaEnc, ptr %p, i64 0, i32 33, i64 %idxprom137
  %655 = load i16, ptr %arrayidx138, align 2, !tbaa !31
  %conv.i819 = zext i16 %655 to i32
  %656 = load i32, ptr %rc94, align 8, !tbaa !86
  %shr.i820 = lshr i32 %656, 11
...
if.then134:                                       ; preds = %RangeEnc_EncodeBit.exit818
  ...
  %657 = trunc i32 %shr3.i823 to i16
  %conv10.i828 = add i16 %655, %657
...
if.else139:                                       ; preds = %RangeEnc_EncodeBit.exit818
  ...
  %658 = load i64, ptr %low.i, align 8, !tbaa !85
  %add5.i839 = add i64 %658, %conv4.i837
  store i64 %add5.i839, ptr %low.i, align 8, !tbaa !85
  %sub7.i840 = sub i32 %656, %mul.i821
  %shr8.i841 = lshr i16 %655, 5
  %sub9.i842 = sub i16 %655, %shr8.i841
...
if.then14.i850:                                   ; preds = %if.else139
  ...
  tail call fastcc void @RangeEnc_ShiftLow(ptr noundef nonnull %rc94)
  %.pre1146 = load i32, ptr %state.i, align 8, !tbaa !33
  %.pre1147 = load i32, ptr %rc94, align 8, !tbaa !86
...
RangeEnc_EncodeBit.exit851:                       ; preds = %if.else139, %if.then14.i850
  %idxprom147.pre-phi = phi i64 [ %idxprom137, %if.else139 ], [ %.pre1152, %if.then14.i850 ]
  %659 = phi i32 [ %sub7.i840, %if.else139 ], [ %.pre1147, %if.then14.i850 ]
  %arrayidx148 = getelementptr inbounds %struct.CLzmaEnc, ptr %p, i64 0, i32 34, i64 %idxprom147.pre-phi
  %660 = load i16, ptr %arrayidx148, align 2, !tbaa !31
  %conv.i852 = zext i16 %660 to i32
  %shr.i853 = lshr i32 %659, 11
  %mul.i854 = mul i32 %shr.i853, %conv.i852
  %cmp.i855 = icmp eq i32 %pos.31048, 2
...
if.else.i866:                                     ; preds = %RangeEnc_EncodeBit.exit851
  ...
  %661 = load i64, ptr %low.i, align 8, !tbaa !85
  %add5.i862 = add i64 %661, %conv4.i860
  store i64 %add5.i862, ptr %low.i, align 8, !tbaa !85
  %sub7.i863 = sub i32 %659, %mul.i854
...
RangeEnc_EncodeBit.exit874:                       ; preds = %if.end.i871, %if.then14.i873
  %cmp150 = icmp eq i32 %pos.31048, 3
  br i1 %cmp150, label %if.then152, label %if.end157

if.then152:                                       ; preds = %RangeEnc_EncodeBit.exit874
  %662 = load i32, ptr %arrayidx.2.i, align 8, !tbaa !22
  store i32 %662, ptr %arrayidx.3.i, align 4, !tbaa !22
  br label %if.end157

if.end157:                                        ; preds = %if.then152, %RangeEnc_EncodeBit.exit874
  %663 = load i32, ptr %arrayidx.1.i, align 4, !tbaa !22
  store i32 %663, ptr %arrayidx.2.i, align 8, !tbaa !22
  br label %if.end162

if.end162:                                        ; preds = %if.then14.i832, %if.then134, %if.end157
  %664 = load i32, ptr %arrayidx.us.i, align 8, !tbaa !22
  store i32 %664, ptr %arrayidx.1.i, align 4, !tbaa !22
  store i32 %649, ptr %arrayidx.us.i, align 8, !tbaa !22
  br label %if.end169

if.end169:                                        ; preds = %if.then14.i799, %if.end.i797, %if.end162
  br i1 %cmp481052, label %if.then172, label %if.else177

if.then172:                                       ; preds = %if.end169
  %665 = load i32, ptr %state.i, align 8, !tbaa !33
  %idxprom174 = zext i32 %665 to i64
  %arrayidx175 = getelementptr inbounds [12 x i32], ptr @kShortRepNextStates, i64 0, i64 %idxprom174
  %666 = load i32, ptr %arrayidx175, align 4, !tbaa !22
  store i32 %666, ptr %state.i, align 8, !tbaa !33
  br label %if.end279

if.else177:                                       ; preds = %if.end169
  %sub179 = add i32 %len.01050, -2
  %667 = load i32, ptr %fastMode, align 8, !tbaa !70
  %tobool181.not = icmp eq i32 %667, 0
  %lnot.ext = zext i1 %tobool181.not to i32
  tail call fastcc void @LenEnc_Encode2(ptr noundef nonnull %repLenEnc, ptr noundef nonnull %rc94, i32 noundef %sub179, i32 noundef %and1051, i32 noundef %lnot.ext, ptr noundef nonnull %ProbPrices.i)
  %668 = load i32, ptr %state.i, align 8, !tbaa !33
  %idxprom183 = zext i32 %668 to i64
  %arrayidx184 = getelementptr inbounds [12 x i32], ptr @kRepNextStates, i64 0, i64 %idxprom183
  %669 = load i32, ptr %arrayidx184, align 4, !tbaa !22
  store i32 %669, ptr %state.i, align 8, !tbaa !33
  br label %if.end279
...
if.else187:                                       ; preds = %RangeEnc_EncodeBit.exit751
  ...
  %670 = trunc i32 %shr3.i879 to i16
  %conv10.i884 = add i16 %639, %670
...
RangeEnc_EncodeBit.exit889:                       ; preds = %if.else187, %if.then14.i888
  %idxprom194.pre-phi = phi i64 [ %idxprom106, %if.else187 ], [ %.pre1151, %if.then14.i888 ]
  %arrayidx195 = getelementptr inbounds [12 x i32], ptr @kMatchNextStates, i64 0, i64 %idxprom194.pre-phi
  %671 = load i32, ptr %arrayidx195, align 4, !tbaa !22
  store i32 %671, ptr %state.i, align 8, !tbaa !33
  %sub198 = add i32 %len.01050, -2
  %672 = load i32, ptr %fastMode, align 8, !tbaa !70
  %tobool200.not = icmp eq i32 %672, 0
  %lnot.ext202 = zext i1 %tobool200.not to i32
  tail call fastcc void @LenEnc_Encode2(ptr noundef nonnull %lenEnc, ptr noundef nonnull %rc94, i32 noundef %sub198, i32 noundef %and1051, i32 noundef %lnot.ext202, ptr noundef nonnull %ProbPrices.i)
  %sub205 = add i32 %pos.31048, -4
...
if.then208:                                       ; preds = %RangeEnc_EncodeBit.exit889
  ...
  %673 = load i8, ptr %arrayidx210, align 1, !tbaa !24
  %conv211 = zext i8 %673 to i32
  br label %if.end225

if.else212:                                       ; preds = %RangeEnc_EncodeBit.exit889
  %notsub = add i32 %pos.31048, -524292
  ...
  %674 = load i8, ptr %arrayidx221, align 1, !tbaa !24
  %conv222 = zext i8 %674 to i32
...
if.end225:                                        ; preds = %if.else212, %if.then208
  ...
  %cmp227 = icmp ult i32 %len.01050, 5
  ...
  %675 = load i16, ptr %add.ptr.i895, align 2, !tbaa !31
  %conv.i.i896 = zext i16 %675 to i32
  %676 = load i32, ptr %rc94, align 8, !tbaa !86
  %shr.i.i897 = lshr i32 %676, 11
...
if.else.i.i909:                                   ; preds = %if.end225
  ...
  %add5.i.i905 = add i64 %677, %conv4.i.i904
  store i64 %add5.i.i905, ptr %low.i, align 8, !tbaa !85
  %sub7.i.i906 = sub i32 %676, %mul.i.i898
...
RangeEnc_EncodeBit.exit.i920:                     ; preds = %if.then14.i.i916, %if.end.i.i914
  %678 = phi i32 [ %.pre1138, %if.then14.i.i916 ], [ %sub7.sink.i.i910, %if.end.i.i914 ]
  ...
  %679 = load i16, ptr %add.ptr.i895.1, align 2, !tbaa !31
  %conv.i.i896.1 = zext i16 %679 to i32
  %shr.i.i897.1 = lshr i32 %678, 11
...
if.else.i.i909.1:                                 ; preds = %RangeEnc_EncodeBit.exit.i920
  ...
  %add5.i.i905.1 = add i64 %680, %conv4.i.i904.1
  store i64 %add5.i.i905.1, ptr %low.i, align 8, !tbaa !85
  %sub7.i.i906.1 = sub i32 %678, %mul.i.i898.1
...
if.then14.i.i916.1:                               ; preds = %if.end.i.i914.1
  ...
  tail call fastcc void @RangeEnc_ShiftLow(ptr noundef nonnull %rc94)
  %.pre1139 = load i32, ptr %rc94, align 8, !tbaa !86
  br label %RangeEnc_EncodeBit.exit.i920.1

RangeEnc_EncodeBit.exit.i920.1:                   ; preds = %if.then14.i.i916.1, %if.end.i.i914.1
  %681 = phi i32 [ %.pre1139, %if.then14.i.i916.1 ], [ %sub7.sink.i.i910.1, %if.end.i.i914.1 ]
  ...
  %682 = load i16, ptr %add.ptr.i895.2, align 2, !tbaa !31
  %conv.i.i896.2 = zext i16 %682 to i32
  %shr.i.i897.2 = lshr i32 %681, 11
...
if.else.i.i909.2:                                 ; preds = %RangeEnc_EncodeBit.exit.i920.1
  ...
  %add5.i.i905.2 = add i64 %683, %conv4.i.i904.2
  store i64 %add5.i.i905.2, ptr %low.i, align 8, !tbaa !85
  %sub7.i.i906.2 = sub i32 %681, %mul.i.i898.2
...
RangeEnc_EncodeBit.exit.i920.2:                   ; preds = %if.then14.i.i916.2, %if.end.i.i914.2
  %684 = phi i32 [ %.pre1140, %if.then14.i.i916.2 ], [ %sub7.sink.i.i910.2, %if.end.i.i914.2 ]
  ...
  %685 = load i16, ptr %add.ptr.i895.3, align 2, !tbaa !31
  %conv.i.i896.3 = zext i16 %685 to i32
  %shr.i.i897.3 = lshr i32 %684, 11
...
if.else.i.i909.3:                                 ; preds = %RangeEnc_EncodeBit.exit.i920.2
  ...
  %add5.i.i905.3 = add i64 %686, %conv4.i.i904.3
  store i64 %add5.i.i905.3, ptr %low.i, align 8, !tbaa !85
  %sub7.i.i906.3 = sub i32 %684, %mul.i.i898.3
...
if.then14.i.i916.3:                               ; preds = %if.end.i.i914.3
  ...
  tail call fastcc void @RangeEnc_ShiftLow(ptr noundef nonnull %rc94)
  %.pre1141 = load i32, ptr %rc94, align 8, !tbaa !86
  br label %RangeEnc_EncodeBit.exit.i920.3

RangeEnc_EncodeBit.exit.i920.3:                   ; preds = %if.then14.i.i916.3, %if.end.i.i914.3
  %687 = phi i32 [ %.pre1141, %if.then14.i.i916.3 ], [ %sub7.sink.i.i910.3, %if.end.i.i914.3 ]
  ...
  %688 = load i16, ptr %add.ptr.i895.4, align 2, !tbaa !31
  %conv.i.i896.4 = zext i16 %688 to i32
  %shr.i.i897.4 = lshr i32 %687, 11
...
if.else.i.i909.4:                                 ; preds = %RangeEnc_EncodeBit.exit.i920.3
  ...
  %add5.i.i905.4 = add i64 %689, %conv4.i.i904.4
  store i64 %add5.i.i905.4, ptr %low.i, align 8, !tbaa !85
  %sub7.i.i906.4 = sub i32 %687, %mul.i.i898.4
...
RangeEnc_EncodeBit.exit.i920.4:                   ; preds = %if.then14.i.i916.4, %if.end.i.i914.4
  %690 = phi i32 [ %.pre1142, %if.then14.i.i916.4 ], [ %sub7.sink.i.i910.4, %if.end.i.i914.4 ]
  ...
  %691 = load i16, ptr %add.ptr.i895.5, align 2, !tbaa !31
  %conv.i.i896.5 = zext i16 %691 to i32
  %shr.i.i897.5 = lshr i32 %690, 11
...
if.else.i.i909.5:                                 ; preds = %RangeEnc_EncodeBit.exit.i920.4
  ...
  %692 = load i64, ptr %low.i, align 8, !tbaa !85
  %add5.i.i905.5 = add i64 %692, %conv4.i.i904.5
  store i64 %add5.i.i905.5, ptr %low.i, align 8, !tbaa !85
  %sub7.i.i906.5 = sub i32 %690, %mul.i.i898.5
...
if.then236:                                       ; preds = %RangeEnc_EncodeBit.exit.i920.5
  ...
  br i1 %cmp242, label %if.then244, label %if.else253
...
for.body.i930:                                    ; preds = %if.then244, %RangeEnc_EncodeBit.exit.i952
  %symbol.addr.08.i = phi i32 [ %shr.i950, %RangeEnc_EncodeBit.exit.i952 ], [ %sub241, %if.then244 ]
  %i.07.i = phi i32 [ %inc.i, %RangeEnc_EncodeBit.exit.i952 ], [ 0, %if.then244 ]
  %m.06.i = phi i32 [ %or.i949, %RangeEnc_EncodeBit.exit.i952 ], [ 1, %if.then244 ]
  ...
  %693 = load i16, ptr %add.ptr.i925, align 2, !tbaa !31
  %conv.i.i926 = zext i16 %693 to i32
  %694 = load i32, ptr %rc94, align 8, !tbaa !86
  %shr.i.i927 = lshr i32 %694, 11
...
if.else.i.i940:                                   ; preds = %for.body.i930
  ...
  %695 = load i64, ptr %low.i, align 8, !tbaa !85
  %add5.i.i936 = add i64 %695, %conv4.i.i935
  store i64 %add5.i.i936, ptr %low.i, align 8, !tbaa !85
  %sub7.i.i937 = sub i32 %694, %mul.i.i928
...
RangeEnc_EncodeDirectBits.exit:                   ; preds = %do.cond.i
  ...
  %701 = load i16, ptr %add.ptr.i970, align 2, !tbaa !31
  %conv.i.i971 = zext i16 %701 to i32
  %702 = load i32, ptr %rc94, align 8, !tbaa !86
  %shr.i.i972 = lshr i32 %702, 11
...
if.else.i.i985:                                   ; preds = %RangeEnc_EncodeDirectBits.exit
  ...
  %add5.i.i981 = add i64 %703, %conv4.i.i980
  store i64 %add5.i.i981, ptr %low.i, align 8, !tbaa !85
  %sub7.i.i982 = sub i32 %702, %mul.i.i973
...
if.then14.i.i992:                                 ; preds = %if.end.i.i990
  ...
  tail call fastcc void @RangeEnc_ShiftLow(ptr noundef nonnull %rc94)
  %.pre1143 = load i32, ptr %rc94, align 8, !tbaa !86
  br label %RangeEnc_EncodeBit.exit.i998

RangeEnc_EncodeBit.exit.i998:                     ; preds = %if.then14.i.i992, %if.end.i.i990
  %704 = phi i32 [ %.pre1143, %if.then14.i.i992 ], [ %sub7.sink.i.i986, %if.end.i.i990 ]
  ...
  %705 = load i16, ptr %add.ptr.i970.1, align 2, !tbaa !31
  %conv.i.i971.1 = zext i16 %705 to i32
  %shr.i.i972.1 = lshr i32 %704, 11
...
if.else.i.i985.1:                                 ; preds = %RangeEnc_EncodeBit.exit.i998
  ...
  %add5.i.i981.1 = add i64 %706, %conv4.i.i980.1
  store i64 %add5.i.i981.1, ptr %low.i, align 8, !tbaa !85
  %sub7.i.i982.1 = sub i32 %704, %mul.i.i973.1
...
if.then14.i.i992.1:                               ; preds = %if.end.i.i990.1
  ...
  tail call fastcc void @RangeEnc_ShiftLow(ptr noundef nonnull %rc94)
  %.pre1144 = load i32, ptr %rc94, align 8, !tbaa !86
  br label %RangeEnc_EncodeBit.exit.i998.1

RangeEnc_EncodeBit.exit.i998.1:                   ; preds = %if.then14.i.i992.1, %if.end.i.i990.1
  %707 = phi i32 [ %.pre1144, %if.then14.i.i992.1 ], [ %sub7.sink.i.i986.1, %if.end.i.i990.1 ]
  ...
  %708 = load i16, ptr %add.ptr.i970.2, align 2, !tbaa !31
  %conv.i.i971.2 = zext i16 %708 to i32
  %shr.i.i972.2 = lshr i32 %707, 11
...
if.else.i.i985.2:                                 ; preds = %RangeEnc_EncodeBit.exit.i998.1
  ...
  %add5.i.i981.2 = add i64 %709, %conv4.i.i980.2
  store i64 %add5.i.i981.2, ptr %low.i, align 8, !tbaa !85
  %sub7.i.i982.2 = sub i32 %707, %mul.i.i973.2
...
if.then14.i.i992.2:                               ; preds = %if.end.i.i990.2
  ...
  tail call fastcc void @RangeEnc_ShiftLow(ptr noundef nonnull %rc94)
  %.pre1145 = load i32, ptr %rc94, align 8, !tbaa !86
  br label %RangeEnc_EncodeBit.exit.i998.2

RangeEnc_EncodeBit.exit.i998.2:                   ; preds = %if.then14.i.i992.2, %if.end.i.i990.2
  %710 = phi i32 [ %.pre1145, %if.then14.i.i992.2 ], [ %sub7.sink.i.i986.2, %if.end.i.i990.2 ]
  ...
  %711 = load i16, ptr %add.ptr.i970.3, align 2, !tbaa !31
  %conv.i.i971.3 = zext i16 %711 to i32
  %shr.i.i972.3 = lshr i32 %710, 11
  %mul.i.i973.3 = mul i32 %shr.i.i972.3, %conv.i.i971.3
  %712 = and i32 %sub241, 8
  %cmp.i.i974.3 = icmp eq i32 %712, 0
...
if.else.i.i985.3:                                 ; preds = %RangeEnc_EncodeBit.exit.i998.2
  ...
  %713 = load i64, ptr %low.i, align 8, !tbaa !85
  %add5.i.i981.3 = add i64 %713, %conv4.i.i980.3
  store i64 %add5.i.i981.3, ptr %low.i, align 8, !tbaa !85
  %sub7.i.i982.3 = sub i32 %710, %mul.i.i973.3
...
if.end262:                                        ; preds = %RangeEnc_EncodeBit.exit.i952, %RangeEnc_EncodeBit.exit.i998.3, %RangeEnc_EncodeBit.exit.i920.5
  %715 = load i32, ptr %arrayidx.2.i, align 8, !tbaa !22
  store i32 %715, ptr %arrayidx.3.i, align 4, !tbaa !22
  %716 = load <2 x i32>, ptr %arrayidx.us.i, align 8, !tbaa !22
  store <2 x i32> %716, ptr %arrayidx.1.i, align 4, !tbaa !22
  store i32 %sub205, ptr %arrayidx.us.i, align 8, !tbaa !22
  %717 = load i32, ptr %matchPriceCount, align 8, !tbaa !113
  %inc277 = add i32 %717, 1
  store i32 %inc277, ptr %matchPriceCount, align 8, !tbaa !113
  br label %if.end279

if.end279:                                        ; preds = %if.end262, %if.else177, %if.then172, %if.end88
  %len.01049 = phi i32 [ %len.01050, %if.end262 ], [ %len.01050, %if.else177 ], [ %len.01050, %if.then172 ], [ 1, %if.end88 ]
  %718 = load i32, ptr %additionalOffset.i542, align 4, !tbaa !97
  %sub281 = sub i32 %718, %len.01049
  store i32 %sub281, ptr %additionalOffset.i542, align 4, !tbaa !97
  %add282 = add i32 %len.01049, %nowPos32.2
  %cmp284 = icmp eq i32 %718, %len.01049
  br i1 %cmp284, label %if.then286, label %cleanup344

if.then286:                                       ; preds = %if.end279
  %719 = load i32, ptr %fastMode, align 8, !tbaa !70
  %tobool288.not = icmp eq i32 %719, 0
  br i1 %tobool288.not, label %if.then289, label %if.end300

if.then289:                                       ; preds = %if.then286
  %720 = load i32, ptr %matchPriceCount, align 8, !tbaa !113
  %cmp291 = icmp ugt i32 %720, 127
...
if.end294:                                        ; preds = %if.then293, %if.then289
  %721 = load i32, ptr %alignPriceCount, align 4, !tbaa !102
  %cmp296 = icmp ugt i32 %721, 15
...
for.body.i1011:                                   ; preds = %for.body.i1011, %if.then298
  %indvars.iv.i1003 = phi i64 [ 0, %if.then298 ], [ %indvars.iv.next.i1009, %for.body.i1011 ]
  %722 = trunc i64 %indvars.iv.i1003 to i32
  %and.i.i1004 = and i32 %722, 1
  %shr.i.i1005 = lshr i32 %722, 1
  %723 = icmp eq i32 %and.i.i1004, 0
  %and1.i.i = select i1 %723, i64 0, i64 2032
  %xor.i.i1006 = xor i64 %and1.i.i, %conv.i.i1002
  %shr2.i.i = lshr i64 %xor.i.i1006, 4
  %arrayidx4.i.i = getelementptr inbounds i32, ptr %ProbPrices.i, i64 %shr2.i.i
  %724 = load i32, ptr %arrayidx4.i.i, align 4, !tbaa !22
  %or.i.i1007 = or i32 %and.i.i1004, 2
  %and.i.1.i = and i32 %shr.i.i1005, 1
  %shr.i.1.i = lshr i32 %722, 2
  %idxprom.i.1.i = zext i32 %or.i.i1007 to i64
  %arrayidx.i.1.i = getelementptr inbounds i16, ptr %posAlignEncoder, i64 %idxprom.i.1.i
  %725 = load i16, ptr %arrayidx.i.1.i, align 2, !tbaa !31
  %conv.i.1.i = zext i16 %725 to i64
  %726 = icmp eq i32 %and.i.1.i, 0
  %and1.i.1.i = select i1 %726, i64 0, i64 2032
  %xor.i.1.i = xor i64 %and1.i.1.i, %conv.i.1.i
  %shr2.i.1.i = lshr i64 %xor.i.1.i, 4
  %arrayidx4.i.1.i = getelementptr inbounds i32, ptr %ProbPrices.i, i64 %shr2.i.1.i
  %727 = load i32, ptr %arrayidx4.i.1.i, align 4, !tbaa !22
  %add.i.1.i = add i32 %727, %724
  %shl.i.1.i = shl nuw nsw i32 %or.i.i1007, 1
  %or.i.1.i = or i32 %shl.i.1.i, %and.i.1.i
  %and.i.2.i = and i32 %shr.i.1.i, 1
  %idxprom.i.2.i = zext i32 %or.i.1.i to i64
  %arrayidx.i.2.i = getelementptr inbounds i16, ptr %posAlignEncoder, i64 %idxprom.i.2.i
  %728 = load i16, ptr %arrayidx.i.2.i, align 2, !tbaa !31
  %conv.i.2.i = zext i16 %728 to i64
  %729 = icmp eq i32 %and.i.2.i, 0
  %and1.i.2.i = select i1 %729, i64 0, i64 2032
  %xor.i.2.i = xor i64 %and1.i.2.i, %conv.i.2.i
  %shr2.i.2.i = lshr i64 %xor.i.2.i, 4
  %arrayidx4.i.2.i = getelementptr inbounds i32, ptr %ProbPrices.i, i64 %shr2.i.2.i
  %730 = load i32, ptr %arrayidx4.i.2.i, align 4, !tbaa !22
  %add.i.2.i = add i32 %add.i.1.i, %730
  %shl.i.2.i = shl nuw nsw i32 %or.i.1.i, 1
  %or.i.2.i = or i32 %shl.i.2.i, %and.i.2.i
  %idxprom.i.3.i = zext i32 %or.i.2.i to i64
  %arrayidx.i.3.i = getelementptr inbounds i16, ptr %posAlignEncoder, i64 %idxprom.i.3.i
  %731 = load i16, ptr %arrayidx.i.3.i, align 2, !tbaa !31
  %conv.i.3.i = zext i16 %731 to i64
  %732 = and i32 %722, 8
  %733 = icmp eq i32 %732, 0
  %and1.i.3.i = select i1 %733, i64 0, i64 2032
  %xor.i.3.i = xor i64 %and1.i.3.i, %conv.i.3.i
  %shr2.i.3.i = lshr i64 %xor.i.3.i, 4
  %arrayidx4.i.3.i = getelementptr inbounds i32, ptr %ProbPrices.i, i64 %shr2.i.3.i
  %734 = load i32, ptr %arrayidx4.i.3.i, align 4, !tbaa !22
  %add.i.3.i = add i32 %add.i.2.i, %734
  %arrayidx.i1008 = getelementptr inbounds %struct.CLzmaEnc, ptr %p, i64 0, i32 21, i64 %indvars.iv.i1003
  store i32 %add.i.3.i, ptr %arrayidx.i1008, align 4, !tbaa !22
  %indvars.iv.next.i1009 = add nuw nsw i64 %indvars.iv.i1003, 1
  %exitcond.not.i1010 = icmp eq i64 %indvars.iv.next.i1009, 16
  br i1 %exitcond.not.i1010, label %FillAlignPrices.exit, label %for.body.i1011, !llvm.loop !101

FillAlignPrices.exit:                             ; preds = %for.body.i1011
  store i32 0, ptr %alignPriceCount, align 4, !tbaa !102
  br label %if.end300

if.end300:                                        ; preds = %if.end294, %FillAlignPrices.exit, %if.then286
  %735 = load ptr, ptr %GetNumAvailableBytes37, align 8, !tbaa !126
  %736 = load ptr, ptr %matchFinderObj38, align 8, !tbaa !121
  %call304 = tail call i32 %735(ptr noundef %736) #16
...
lor.lhs.false:                                    ; preds = %if.then311
  %737 = load i64, ptr %processed317, align 8, !tbaa !189
  %738 = load ptr, ptr %buf, align 8, !tbaa !190
  %739 = load ptr, ptr %bufBase, align 8, !tbaa !191
  %sub.ptr.lhs.cast = ptrtoint ptr %738 to i64
  %sub.ptr.rhs.cast = ptrtoint ptr %739 to i64
  %740 = load i64, ptr %cacheSize, align 8, !tbaa !192
  %sub.ptr.sub = add i64 %737, 8192
  %add320 = add i64 %sub.ptr.sub, %sub.ptr.lhs.cast
  %add322 = sub i64 %add320, %sub.ptr.rhs.cast
  %add323 = add i64 %add322, %740
...
if.then332:                                       ; preds = %if.else329
  ...
  %add336 = add i64 %741, %conv334
  store i64 %add336, ptr %nowPos64, align 8, !tbaa !122
  %742 = load i32, ptr %result.i, align 4, !tbaa !117
  %cmp.not.i1013 = icmp eq i32 %742, 0
  br i1 %cmp.not.i1013, label %if.end.i1016, label %cleanup340.thread

if.end.i1016:                                     ; preds = %if.then332
  %743 = load i32, ptr %res.i, align 8, !tbaa !137
  %cmp2.not.i1015 = icmp eq i32 %743, 0
  br i1 %cmp2.not.i1015, label %if.end5.i1019, label %if.end5.thread.i1022

if.end5.i1019:                                    ; preds = %if.end.i1016
  %744 = load i32, ptr %result6.i, align 8, !tbaa !138
  %cmp7.not.i1018 = icmp eq i32 %744, 0
  br i1 %cmp7.not.i1018, label %cleanup340.thread, label %if.end10.thread.i1023

if.end5.thread.i1022:                             ; preds = %if.end.i1016
  store i32 9, ptr %result.i, align 4, !tbaa !117
  %745 = load i32, ptr %result6.i, align 8, !tbaa !138
  %cmp7.not28.i1021 = icmp eq i32 %745, 0
  br i1 %cmp7.not28.i1021, label %if.then13.i1025, label %if.end10.thread.i1023

if.end10.thread.i1023:                            ; preds = %if.end5.thread.i1022, %if.end5.i1019
  store i32 8, ptr %result.i, align 4, !tbaa !117
  br label %if.then13.i1025

if.then13.i1025:                                  ; preds = %if.end10.thread.i1023, %if.end5.thread.i1022
  %746 = phi i32 [ 8, %if.end10.thread.i1023 ], [ 9, %if.end5.thread.i1022 ]
  store i32 1, ptr %finished, align 4, !tbaa !116
  br label %cleanup340.thread

cleanup340.thread:                                ; preds = %if.end300, %lor.lhs.false, %if.then311, %if.then332, %if.end5.i1019, %if.then13.i1025
  %cleanup.dest.slot.2.ph = phi i32 [ 1, %if.then13.i1025 ], [ 1, %if.end5.i1019 ], [ 1, %if.then332 ], [ 2, %if.then311 ], [ 2, %lor.lhs.false ], [ 2, %if.end300 ]
  %retval.4.ph = phi i32 [ %746, %if.then13.i1025 ], [ 0, %if.end5.i1019 ], [ %742, %if.then332 ], [ %retval.3, %if.then311 ], [ %retval.3, %lor.lhs.false ], [ %retval.3, %if.end300 ]
  br label %cleanup344
...
if.end349:                                        ; preds = %cleanup344, %if.end35
  ...
  %747 = load i64, ptr %nowPos64, align 8, !tbaa !122
  %add353 = add i64 %747, %conv351
