...
invoke.cont9.thread:                              ; preds = %invoke.cont
  ...
  %_M_prev.i.i.i.i.i42106 = getelementptr inbounds %"struct.std::__detail::_List_node_base", ptr %li3, i64 0, i32 1
  store ptr %li3, ptr %_M_prev.i.i.i.i.i42106, align 8, !tbaa !5
  store ptr %li3, ptr %li3, align 8, !tbaa !10
  %_M_size.i.i.i.i.i43107 = getelementptr inbounds %"struct.std::__detail::_List_node_header", ptr %li3, i64 0, i32 1
  store i64 0, ptr %_M_size.i.i.i.i.i43107, align 8, !tbaa !11
...
invoke.cont9:                                     ; preds = %call5.i.i.i.i.i.i.i.noexc.i35
  ...
  %tobool.not97 = icmp eq i64 %add.i.i.i.i.i34, 0
  br i1 %tobool.not97, label %while.end21, label %while.body

while.body:                                       ; preds = %invoke.cont9, %_ZNSt7__cxx114listImSaImEE9push_backERKm.exit
  %dec98.in = phi i64 [ %dec98, %_ZNSt7__cxx114listImSaImEE9push_backERKm.exit ], [ %add.i.i.i.i.i34, %invoke.cont9 ]
...
_ZNSt7__cxx114listImSaImEE9push_backERKm.exit:    ; preds = %while.body
  ...
  %tobool.not = icmp eq i64 %dec98, 0
...
while.end:                                        ; preds = %_ZNSt7__cxx114listImSaImEE9push_backERKm.exit
  %.pre104 = load i64, ptr %_M_size.i.i.i.i.i43, align 8, !tbaa !15
  %tobool17.not100 = icmp eq i64 %.pre104, 0
  br i1 %tobool17.not100, label %while.end21, label %while.body18

while.body18:                                     ; preds = %while.end, %_ZNSt7__cxx114listImSaImEE9push_backERKm.exit60
  %dec16101.in = phi i64 [ %dec16101, %_ZNSt7__cxx114listImSaImEE9push_backERKm.exit60 ], [ %.pre104, %while.end ]
...
_ZNSt7__cxx114listImSaImEE9push_backERKm.exit60:  ; preds = %while.body18
  %dec16101 = add i64 %dec16101.in, -1
  ...
  %tobool17.not = icmp eq i64 %dec16101, 0
...
while.end21:                                      ; preds = %_ZNSt7__cxx114listImSaImEE9push_backERKm.exit60, %invoke.cont9.thread, %invoke.cont9, %while.end
  %_M_size.i.i.i.i.i3191109116 = phi ptr [ %_M_size.i.i.i.i.i31, %while.end ], [ %_M_size.i.i.i.i.i3190, %invoke.cont9.thread ], [ %_M_size.i.i.i.i.i31, %invoke.cont9 ], [ %_M_size.i.i.i.i.i31, %_ZNSt7__cxx114listImSaImEE9push_backERKm.exit60 ]
...
land.lhs.true:                                    ; preds = %while.end21
  ...
  %29 = load i64, ptr %_M_size.i.i.i.i.i3191109116, align 8, !tbaa !15
...
while.cond.i:                                     ; preds = %land.lhs.true, %land.rhs.i
  ...
  br i1 %or.cond.i, label %_ZSteqImSaImEEbRKNSt7__cxx114listIT_T0_EES7_.exit, label %land.rhs.i
...
_ZSteqImSaImEEbRKNSt7__cxx114listIT_T0_EES7_.exit: ; preds = %while.cond.i, %land.rhs.i
  %cmp.i.not.i64.lcssa = phi i1 [ %cmp.i.not.i64, %while.cond.i ], [ false, %land.rhs.i ]
  %cmp.i25.not.i.lcssa = phi i1 [ %cmp.i25.not.i, %while.cond.i ], [ false, %land.rhs.i ]
  %spec.select.i = select i1 %cmp.i.not.i64.lcssa, i1 %cmp.i25.not.i.lcssa, i1 false
  %cond.fr = freeze i1 %spec.select.i
  %spec.select = select i1 %cond.fr, i64 %28, i64 0
  br label %cond.end
