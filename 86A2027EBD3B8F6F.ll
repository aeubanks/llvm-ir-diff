...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %59 = add nsw <4 x i32> %54, %58
  %60 = sub nsw <4 x i32> %59, %44
...
for.body120:                                      ; preds = %for.body120.preheader, %for.body120
  ...
  %sub169 = sub nsw i32 %cond156, %cond140
...
for.body183:                                      ; preds = %for.body183.preheader, %for.body183
  ...
  %sub232 = sub nsw i32 %cond219, %cond203
...
vector.body376:                                   ; preds = %vector.body376, %vector.ph370
  ...
  %97 = add nsw <4 x i32> %92, %96
  %98 = sub nsw <4 x i32> %97, %90
...
for.body120:                                      ; preds = %for.body120.preheader, %for.body120
  ...
  %126 = add nsw <2 x i32> %121, %125
  %127 = shufflevector <2 x i32> %126, <2 x i32> poison, <2 x i32> <i32 1, i32 poison>
