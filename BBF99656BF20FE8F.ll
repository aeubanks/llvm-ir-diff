; ModuleID = '/usr/local/google/home/aeubanks/repos/test-suite/Bitcode/simd_ops/x86_tests/test_op_pmaxub_83.bc'
...
@str.11 = private constant [13 x i8] c"op_pmaxub_83\00", align 32
...
define i32 @__test_op(ptr noalias nocapture readnone %in_f32.buffer, ptr noalias nocapture readnone %in_f64.buffer, ptr noalias nocapture readnone %in_i8.buffer, ptr noalias nocapture readonly %in_u8.buffer, ptr noalias nocapture readnone %in_i16.buffer, ptr noalias nocapture readnone %in_u16.buffer, ptr noalias nocapture readnone %in_i32.buffer, ptr noalias nocapture readnone %in_u32.buffer, ptr noalias nocapture readnone %in_i64.buffer, ptr noalias nocapture readnone %in_u64.buffer, ptr noalias nocapture readonly %op_pmaxub_83.buffer) local_unnamed_addr #0 {
"produce op_pmaxub_83":
  %buf_extent168 = getelementptr inbounds %struct.buffer_t, ptr %op_pmaxub_83.buffer, i64 0, i32 2, i64 1
  %op_pmaxub_83.extent.1 = load i32, ptr %buf_extent168, align 4
  %buf_min176 = getelementptr inbounds %struct.buffer_t, ptr %op_pmaxub_83.buffer, i64 0, i32 4, i64 1
  %op_pmaxub_83.min.1 = load i32, ptr %buf_min176, align 4
  %0 = add nsw i32 %op_pmaxub_83.min.1, %op_pmaxub_83.extent.1
  %1 = icmp sgt i32 %op_pmaxub_83.extent.1, 0
  br i1 %1, label %"for op_pmaxub_83.s0.y.preheader", label %destructor_block, !prof !4

"for op_pmaxub_83.s0.y.preheader":                ; preds = %"produce op_pmaxub_83"
  %buf_host44 = getelementptr inbounds %struct.buffer_t, ptr %in_u8.buffer, i64 0, i32 1
  %in_u8.host = load ptr, ptr %buf_host44, align 8
  %buf_min175 = getelementptr inbounds %struct.buffer_t, ptr %op_pmaxub_83.buffer, i64 0, i32 4, i64 0
  %op_pmaxub_83.min.0 = load i32, ptr %buf_min175, align 4
  %2 = sext i32 %op_pmaxub_83.min.0 to i64
  %buf_stride172 = getelementptr inbounds %struct.buffer_t, ptr %op_pmaxub_83.buffer, i64 0, i32 3, i64 1
  %op_pmaxub_83.stride.1 = load i32, ptr %buf_stride172, align 4
  %3 = sext i32 %op_pmaxub_83.stride.1 to i64
  %buf_host163 = getelementptr inbounds %struct.buffer_t, ptr %op_pmaxub_83.buffer, i64 0, i32 1
  %op_pmaxub_83.host = load ptr, ptr %buf_host163, align 8
  %4 = shl nsw i64 %2, 3
  %5 = sub nsw i64 96, %4
  %scevgep = getelementptr i8, ptr %op_pmaxub_83.host, i64 %5
  %6 = shl nsw i64 %3, 3
  %sunkaddr = ptrtoint ptr %in_u8.host to i64
  %a22 = load <16 x i8>, ptr %in_u8.host, align 16, !tbaa !5
  %sunkaddr210 = add i64 %sunkaddr, 16
  %sunkaddr211 = inttoptr i64 %sunkaddr210 to ptr
  %b29 = load <16 x i8>, ptr %sunkaddr211, align 16, !tbaa !5
  %7 = tail call <16 x i8> @llvm.umax.v16i8(<16 x i8> %a22, <16 x i8> %b29)
  %8 = uitofp <16 x i8> %7 to <16 x double>
  ...
  %b29.1 = load <16 x i8>, ptr %sunkaddr211.1, align 16, !tbaa !5
  %13 = tail call <16 x i8> @llvm.umax.v16i8(<16 x i8> %b29, <16 x i8> %b29.1)
  %14 = uitofp <16 x i8> %13 to <16 x double>
  ...
  %a22.2 = load <16 x i8>, ptr %sunkaddr207.2, align 16, !tbaa !5
  %sunkaddr210.2 = add i64 %sunkaddr, 48
  %sunkaddr211.2 = inttoptr i64 %sunkaddr210.2 to ptr
  %b29.2 = load <16 x i8>, ptr %sunkaddr211.2, align 16, !tbaa !5
  %19 = tail call <16 x i8> @llvm.umax.v16i8(<16 x i8> %a22.2, <16 x i8> %b29.2)
  ...
  %a22.3 = load <16 x i8>, ptr %sunkaddr207.3, align 16, !tbaa !5
  %sunkaddr210.3 = add i64 %sunkaddr, 64
  %sunkaddr211.3 = inttoptr i64 %sunkaddr210.3 to ptr
  %b29.3 = load <16 x i8>, ptr %sunkaddr211.3, align 16, !tbaa !5
  %25 = tail call <16 x i8> @llvm.umax.v16i8(<16 x i8> %a22.3, <16 x i8> %b29.3)
  ...
  %a22.4 = load <16 x i8>, ptr %sunkaddr207.4, align 16, !tbaa !5
  %sunkaddr210.4 = add i64 %sunkaddr, 80
  %sunkaddr211.4 = inttoptr i64 %sunkaddr210.4 to ptr
  %b29.4 = load <16 x i8>, ptr %sunkaddr211.4, align 16, !tbaa !5
  %31 = tail call <16 x i8> @llvm.umax.v16i8(<16 x i8> %a22.4, <16 x i8> %b29.4)
  %32 = uitofp <16 x i8> %31 to <16 x double>
  ...
  %a22.5 = load <16 x i8>, ptr %sunkaddr207.5, align 16, !tbaa !5
  %sunkaddr210.5 = add i64 %sunkaddr, 96
  %sunkaddr211.5 = inttoptr i64 %sunkaddr210.5 to ptr
  %b29.5 = load <16 x i8>, ptr %sunkaddr211.5, align 16, !tbaa !5
  %37 = tail call <16 x i8> @llvm.umax.v16i8(<16 x i8> %a22.5, <16 x i8> %b29.5)
  ...
  %a22.6 = load <16 x i8>, ptr %sunkaddr207.6, align 16, !tbaa !5
  %sunkaddr210.6 = add i64 %sunkaddr, 112
  %sunkaddr211.6 = inttoptr i64 %sunkaddr210.6 to ptr
  %b29.6 = load <16 x i8>, ptr %sunkaddr211.6, align 16, !tbaa !5
  %43 = tail call <16 x i8> @llvm.umax.v16i8(<16 x i8> %a22.6, <16 x i8> %b29.6)
  ...
  %a22.7 = load <16 x i8>, ptr %sunkaddr207.7, align 16, !tbaa !5
  %sunkaddr210.7 = add i64 %sunkaddr, 128
  %sunkaddr211.7 = inttoptr i64 %sunkaddr210.7 to ptr
  %b29.7 = load <16 x i8>, ptr %sunkaddr211.7, align 16, !tbaa !5
  %49 = tail call <16 x i8> @llvm.umax.v16i8(<16 x i8> %a22.7, <16 x i8> %b29.7)
  ...
  %a22.8 = load <16 x i8>, ptr %sunkaddr207.8, align 16, !tbaa !5
  %sunkaddr210.8 = add i64 %sunkaddr, 144
  %sunkaddr211.8 = inttoptr i64 %sunkaddr210.8 to ptr
  %b29.8 = load <16 x i8>, ptr %sunkaddr211.8, align 16, !tbaa !5
  %55 = tail call <16 x i8> @llvm.umax.v16i8(<16 x i8> %a22.8, <16 x i8> %b29.8)
  ...
  br label %"for op_pmaxub_83.s0.x.x.preheader"

"for op_pmaxub_83.s0.x.x.preheader":              ; preds = %"for op_pmaxub_83.s0.x.x.preheader", %"for op_pmaxub_83.s0.y.preheader"
  %lsr.iv180 = phi ptr [ %scevgep, %"for op_pmaxub_83.s0.y.preheader" ], [ %scevgep182, %"for op_pmaxub_83.s0.x.x.preheader" ]
  %op_pmaxub_83.s0.y = phi i32 [ %op_pmaxub_83.min.1, %"for op_pmaxub_83.s0.y.preheader" ], [ %103, %"for op_pmaxub_83.s0.x.x.preheader" ]
  ...
  %a22.9 = load <16 x i8>, ptr %sunkaddr207.9, align 16, !tbaa !5
  %b29.9 = load <16 x i8>, ptr %sunkaddr211.9, align 16, !tbaa !5
  %61 = tail call <16 x i8> @llvm.umax.v16i8(<16 x i8> %a22.9, <16 x i8> %b29.9)
  %62 = uitofp <16 x i8> %61 to <16 x double>
  ...
  %a22.10 = load <16 x i8>, ptr %sunkaddr207.10, align 16, !tbaa !5
  %b29.10 = load <16 x i8>, ptr %sunkaddr211.10, align 16, !tbaa !5
  %67 = tail call <16 x i8> @llvm.umax.v16i8(<16 x i8> %a22.10, <16 x i8> %b29.10)
  %68 = uitofp <16 x i8> %67 to <16 x double>
  ...
  %a22.11 = load <16 x i8>, ptr %sunkaddr207.11, align 16, !tbaa !5
  %b29.11 = load <16 x i8>, ptr %sunkaddr211.11, align 16, !tbaa !5
  %73 = tail call <16 x i8> @llvm.umax.v16i8(<16 x i8> %a22.11, <16 x i8> %b29.11)
  ...
  %a22.12 = load <16 x i8>, ptr %sunkaddr207.12, align 16, !tbaa !5
  %b29.12 = load <16 x i8>, ptr %sunkaddr211.12, align 16, !tbaa !5
  %79 = tail call <16 x i8> @llvm.umax.v16i8(<16 x i8> %a22.12, <16 x i8> %b29.12)
  %80 = uitofp <16 x i8> %79 to <16 x double>
  ...
  %a22.13 = load <16 x i8>, ptr %sunkaddr207.13, align 16, !tbaa !5
  %b29.13 = load <16 x i8>, ptr %sunkaddr211.13, align 16, !tbaa !5
  %85 = tail call <16 x i8> @llvm.umax.v16i8(<16 x i8> %a22.13, <16 x i8> %b29.13)
  ...
  %a22.14 = load <16 x i8>, ptr %sunkaddr207.14, align 16, !tbaa !5
  %b29.14 = load <16 x i8>, ptr %sunkaddr211.14, align 16, !tbaa !5
  %91 = tail call <16 x i8> @llvm.umax.v16i8(<16 x i8> %a22.14, <16 x i8> %b29.14)
  ...
  %a22.15 = load <16 x i8>, ptr %sunkaddr207.15, align 16, !tbaa !5
  %b29.15 = load <16 x i8>, ptr %sunkaddr211.15, align 16, !tbaa !5
  %97 = tail call <16 x i8> @llvm.umax.v16i8(<16 x i8> %a22.15, <16 x i8> %b29.15)
  ...
  %103 = add nsw i32 %op_pmaxub_83.s0.y, 1
  %scevgep182 = getelementptr i1, ptr %lsr.iv180, i64 %6
  %.not2 = icmp eq i32 %103, %0
  br i1 %.not2, label %destructor_block, label %"for op_pmaxub_83.s0.x.x.preheader"

destructor_block:                                 ; preds = %"for op_pmaxub_83.s0.x.x.preheader", %"produce op_pmaxub_83"
  ret i32 0
}

; Function Attrs: nofree nosync nounwind memory(readwrite, inaccessiblemem: none)
define i32 @test_op(ptr noalias nocapture readnone %in_f32.buffer, ptr noalias nocapture readnone %in_f64.buffer, ptr noalias nocapture readnone %in_i8.buffer, ptr noalias nocapture readonly %in_u8.buffer, ptr noalias nocapture readnone %in_i16.buffer, ptr noalias nocapture readnone %in_u16.buffer, ptr noalias nocapture readnone %in_i32.buffer, ptr noalias nocapture readnone %in_u32.buffer, ptr noalias nocapture readnone %in_i64.buffer, ptr noalias nocapture readnone %in_u64.buffer, ptr noalias nocapture readonly %op_pmaxub_83.buffer) local_unnamed_addr #1 {
destructor_block:
  %"__test_op_result$5" = tail call i32 @__test_op(ptr poison, ptr poison, ptr poison, ptr %in_u8.buffer, ptr poison, ptr poison, ptr poison, ptr poison, ptr poison, ptr poison, ptr %op_pmaxub_83.buffer) #4
  ret i32 0
}
