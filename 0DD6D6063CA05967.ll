...
while.cond.preheader.i:                           ; preds = %land.lhs.true
  ...
  br i1 %cmp.i3237.i, label %while.end.i, label %land.rhs.i.preheader
...
land.rhs.i.preheader:                             ; preds = %while.cond.preheader.i
  ...
  br i1 %cmp.i34.not.i19, label %while.end.i, label %while.body.i
...
while.body.i:                                     ; preds = %land.rhs.i.preheader, %land.rhs.i
  ...
  br i1 %cmp.i32.i, label %while.end.i, label %land.rhs.i, !llvm.loop !16
...
while.end.i:                                      ; preds = %land.rhs.i, %while.body.i, %land.rhs.i.preheader, %while.cond.preheader.i
  ...
  %Prev.0.lcssa.i = phi ptr [ %L, %while.cond.preheader.i ], [ %L, %land.rhs.i.preheader ], [ %SingleStep.038.i20, %while.body.i ], [ %SingleStep.038.i20, %land.rhs.i ]
...
if.end:                                           ; preds = %entry, %land.lhs.true, %while.end.i16, %if.end.i, %while.end.i
  %Result.0 = phi ptr [ %ResultStart.0.i, %while.end.i16 ], [ %call5, %while.end.i ], [ %call4, %if.end.i ], [ %L, %land.lhs.true ], [ null, %entry ]
  ret ptr %Result.0
}
...
entry:
  %cmp.i12 = icmp eq ptr %List, null
  br i1 %cmp.i12, label %return, label %land.rhs
...
while.body:                                       ; preds = %land.rhs
  ...
  %cmp.i = icmp eq ptr %List.addr.0.val8, null
  br i1 %cmp.i, label %return, label %land.rhs, !llvm.loop !19
...
entry:
  %cmp.i53 = icmp eq ptr %List, null
  br i1 %cmp.i53, label %cleanup, label %land.rhs
...
while.body:                                       ; preds = %land.rhs
  ...
  %cmp.i = icmp eq ptr %Scan1.055, null
  br i1 %cmp.i, label %cleanup, label %land.rhs, !llvm.loop !22
...
cleanup:                                          ; preds = %while.body, %if.end20, %entry, %while.cond9.preheader
  %List.addr.052 = phi ptr [ %List.addr.054, %while.cond9.preheader ], [ null, %entry ], [ %List.addr.054, %if.end20 ], [ null, %while.body ]
  ret ptr %List.addr.052
}

; Function Attrs: nounwind uwtable
define dso_local ptr @list_DeleteElementIf(ptr noundef %List, ptr nocapture noundef readonly %Test) local_unnamed_addr #0 {
entry:
  %cmp.i52 = icmp eq ptr %List, null
  br i1 %cmp.i52, label %cleanup, label %land.rhs
...
while.body:                                       ; preds = %land.rhs
  ...
  %cmp.i = icmp eq ptr %Scan1.054, null
  br i1 %cmp.i, label %cleanup, label %land.rhs, !llvm.loop !24
...
cleanup:                                          ; preds = %while.body, %if.end20, %entry, %while.cond9.preheader
  %List.addr.051 = phi ptr [ %List.addr.053, %while.cond9.preheader ], [ null, %entry ], [ %List.addr.053, %if.end20 ], [ null, %while.body ]
  ret ptr %List.addr.051
}
...
entry:
  %cmp.i59 = icmp eq ptr %List, null
  br i1 %cmp.i59, label %cleanup, label %land.rhs
...
while.body:                                       ; preds = %land.rhs
  ...
  %cmp.i = icmp eq ptr %Scan1.061, null
  br i1 %cmp.i, label %cleanup, label %land.rhs, !llvm.loop !26
...
cleanup:                                          ; preds = %while.body, %if.end22, %entry, %while.cond10.preheader
  %List.addr.058 = phi ptr [ %List.addr.060, %while.cond10.preheader ], [ null, %entry ], [ %List.addr.060, %if.end22 ], [ null, %while.body ]
  ret ptr %List.addr.058
}
...
entry:
  %cmp.i60 = icmp eq ptr %List, null
  br i1 %cmp.i60, label %cleanup, label %land.rhs
...
while.body:                                       ; preds = %land.rhs
  ...
  %cmp.i = icmp eq ptr %Scan1.062, null
  br i1 %cmp.i, label %cleanup, label %land.rhs, !llvm.loop !28
...
cleanup:                                          ; preds = %while.body, %if.end22, %entry, %while.cond10.preheader
  %List.addr.059 = phi ptr [ %List.addr.061, %while.cond10.preheader ], [ null, %entry ], [ %List.addr.061, %if.end22 ], [ null, %while.body ]
  ret ptr %List.addr.059
}
...
entry:
  %cmp.i49 = icmp eq ptr %List, null
  br i1 %cmp.i49, label %cleanup, label %land.rhs
...
while.body:                                       ; preds = %land.rhs
  ...
  %cmp.i = icmp eq ptr %List.addr.0.val38, null
  br i1 %cmp.i, label %cleanup, label %land.rhs, !llvm.loop !31
...
cleanup:                                          ; preds = %while.body, %if.end17, %entry, %while.cond7.preheader
  %List.addr.048 = phi ptr [ %List.addr.050, %while.cond7.preheader ], [ null, %entry ], [ %List.addr.050, %if.end17 ], [ null, %while.body ]
  ret ptr %List.addr.048
}
...
entry:
  %cmp.i56 = icmp eq ptr %List, null
  br i1 %cmp.i56, label %cleanup, label %land.rhs
...
while.body:                                       ; preds = %land.rhs
  ...
  %cmp.i = icmp eq ptr %List.addr.0.val45, null
  br i1 %cmp.i, label %cleanup, label %land.rhs, !llvm.loop !33
...
cleanup:                                          ; preds = %while.body, %if.end19, %entry, %while.cond8.preheader
  %List.addr.055 = phi ptr [ %List.addr.057, %while.cond8.preheader ], [ null, %entry ], [ %List.addr.057, %if.end19 ], [ null, %while.body ]
  ret ptr %List.addr.055
}
...
while.body.preheader:                             ; preds = %entry
  ...
  %cmp.i53.i31 = icmp eq ptr %Scan.0.val1129, null
  br i1 %cmp.i53.i31, label %list_DeleteElement.exit.thread, label %land.rhs.i.preheader
...
while.body.i:                                     ; preds = %land.rhs.i
  ...
  %cmp.i.i = icmp eq ptr %Scan1.055.i, null
  br i1 %cmp.i.i, label %list_DeleteElement.exit.thread, label %land.rhs.i, !llvm.loop !22
...
list_DeleteElement.exit:                          ; preds = %if.end20.i, %while.cond9.preheader.i
  ...
  %cmp.i53.i = icmp eq ptr %Scan.0.val11, null
  br i1 %cmp.i53.i, label %list_DeleteElement.exit.thread, label %land.rhs.i.preheader, !llvm.loop !41
...
while.body.preheader:                             ; preds = %entry
  %Scan.0.val1129 = load ptr, ptr %List, align 8
  %cmp.i60.i31 = icmp eq ptr %Scan.0.val1129, null
  br i1 %cmp.i60.i31, label %list_DeleteElementFree.exit.thread, label %land.rhs.i.preheader
...
while.body.i:                                     ; preds = %land.rhs.i
  ...
  %cmp.i.i = icmp eq ptr %Scan1.062.i, null
  br i1 %cmp.i.i, label %list_DeleteElementFree.exit.thread, label %land.rhs.i, !llvm.loop !28
...
list_DeleteElementFree.exit:                      ; preds = %if.end22.i, %while.cond10.preheader.i
  ...
  %cmp.i60.i = icmp eq ptr %Scan.0.val11, null
  br i1 %cmp.i60.i, label %list_DeleteElementFree.exit.thread, label %land.rhs.i.preheader, !llvm.loop !42
...
while.body.preheader:                             ; preds = %entry
  ...
  %cmp.i49.i32 = icmp eq ptr %Scan.0.val1130, null
  br i1 %cmp.i49.i32, label %list_PointerDeleteElement.exit.thread, label %land.rhs.i.preheader
...
while.body.i:                                     ; preds = %land.rhs.i
  ...
  %cmp.i.i = icmp eq ptr %List.addr.0.val38.i, null
  br i1 %cmp.i.i, label %list_PointerDeleteElement.exit.thread, label %land.rhs.i, !llvm.loop !31
...
list_PointerDeleteElement.exit:                   ; preds = %if.end17.i, %while.cond7.preheader.i
  ...
  %cmp.i49.i = icmp eq ptr %Scan.0.val11, null
  br i1 %cmp.i49.i, label %list_PointerDeleteElement.exit.thread, label %land.rhs.i.preheader, !llvm.loop !43
...
while.body.i.preheader:                           ; preds = %if.end.i, %list_Nconc.exit
  ...
  %cmp.i49.i.i8 = icmp eq ptr %Scan.0.val11.i6, null
  br i1 %cmp.i49.i.i8, label %list_PointerDeleteElement.exit.thread.i, label %land.rhs.i.i.preheader
...
while.body.i.i:                                   ; preds = %land.rhs.i.i
  ...
  %cmp.i.i.i = icmp eq ptr %List.addr.0.val38.i.i, null
  br i1 %cmp.i.i.i, label %list_PointerDeleteElement.exit.thread.i, label %land.rhs.i.i, !llvm.loop !31
...
list_PointerDeleteElement.exit.i:                 ; preds = %if.end17.i.i, %while.cond7.preheader.i.i
  ...
  %cmp.i49.i.i = icmp eq ptr %Scan.0.val11.i, null
  br i1 %cmp.i49.i.i, label %list_PointerDeleteElement.exit.thread.i, label %land.rhs.i.i.preheader
...
while.body.i.preheader:                           ; preds = %if.end.i, %list_Nconc.exit
  %retval.0.i17 = phi ptr [ %retval.0.i, %list_Nconc.exit ], [ %List1, %if.end.i ]
  %Scan.0.val11.i6 = load ptr, ptr %retval.0.i17, align 8
  %cmp.i53.i.i8 = icmp eq ptr %Scan.0.val11.i6, null
  br i1 %cmp.i53.i.i8, label %list_DeleteElement.exit.thread.i, label %land.rhs.i.i.preheader
...
while.body.i.i:                                   ; preds = %land.rhs.i.i
  ...
  %cmp.i.i.i = icmp eq ptr %Scan1.055.i.i, null
  br i1 %cmp.i.i.i, label %list_DeleteElement.exit.thread.i, label %land.rhs.i.i, !llvm.loop !22
...
list_DeleteElement.exit.i:                        ; preds = %if.end20.i.i, %while.cond9.preheader.i.i
  ...
  %cmp.i53.i.i = icmp eq ptr %Scan.0.val11.i, null
  br i1 %cmp.i53.i.i, label %list_DeleteElement.exit.thread.i, label %land.rhs.i.i.preheader
...
entry:
  %cmp.i68 = icmp eq ptr %List1, null
  br i1 %cmp.i68, label %cleanup, label %land.rhs.lr.ph
...
land.rhs.us:                                      ; preds = %land.rhs.lr.ph, %land.rhs.us
  ...
  %cmp.i.us = icmp eq ptr %List1.addr.0.val45.us, null
  br i1 %cmp.i.us, label %cleanup, label %land.rhs.us, !llvm.loop !48
...
while.body.critedge.loopexit:                     ; preds = %if.end.i
  ...
  %cmp.i = icmp eq ptr %List1.addr.0.val45, null
  br i1 %cmp.i, label %cleanup, label %land.rhs, !llvm.loop !48

while.cond8.preheader:                            ; preds = %while.body.i
  %Scan2.071 = load ptr, ptr %List1.addr.069, align 8
  %cmp.i48.not72 = icmp eq ptr %Scan2.071, null
  br i1 %cmp.i48.not72, label %cleanup, label %while.body12

while.body12:                                     ; preds = %while.cond8.preheader, %if.end21
  %Scan2.074 = phi ptr [ %Scan2.0, %if.end21 ], [ %Scan2.071, %while.cond8.preheader ]
  %Scan1.073 = phi ptr [ %Scan1.1, %if.end21 ], [ %List1.addr.069, %while.cond8.preheader ]
  %12 = getelementptr i8, ptr %Scan2.074, i64 8
...
if.then16:                                        ; preds = %while.body.i55
  %Scan1.0.val42 = load ptr, ptr %Scan1.073, align 8
  br label %if.end21

if.else:                                          ; preds = %if.end.i58
  %Scan2.0.val41 = load ptr, ptr %Scan2.074, align 8
  store ptr %Scan2.0.val41, ptr %Scan1.073, align 8
  %14 = load ptr, ptr getelementptr ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  ...
  %17 = load ptr, ptr %14, align 8
  store ptr %17, ptr %Scan2.074, align 8
  %18 = load ptr, ptr getelementptr ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Scan2.074, ptr %18, align 8
  br label %if.end21

if.end21:                                         ; preds = %if.else, %if.then16
  %Scan1.1 = phi ptr [ %Scan1.0.val42, %if.then16 ], [ %Scan1.073, %if.else ]
  %Scan2.1.in = phi ptr [ %Scan2.074, %if.then16 ], [ %Scan1.073, %if.else ]
...
cleanup:                                          ; preds = %while.body.critedge.loopexit, %if.end21, %land.rhs.us, %entry, %while.cond8.preheader
  %List1.addr.067 = phi ptr [ %List1.addr.069, %while.cond8.preheader ], [ null, %entry ], [ null, %land.rhs.us ], [ %List1.addr.069, %if.end21 ], [ null, %while.body.critedge.loopexit ]
  ret ptr %List1.addr.067
}

; Function Attrs: nofree norecurse nosync nounwind memory(readwrite, inaccessiblemem: none) uwtable
define dso_local ptr @list_NPointerIntersect(ptr noundef %List1, ptr noundef readonly %List2) local_unnamed_addr #2 {
entry:
  %cmp.i67 = icmp eq ptr %List1, null
  br i1 %cmp.i67, label %cleanup, label %land.rhs.lr.ph
...
land.rhs.us:                                      ; preds = %land.rhs.lr.ph, %land.rhs.us
  ...
  %cmp.i.us = icmp eq ptr %List1.addr.0.val44.us, null
  br i1 %cmp.i.us, label %cleanup, label %land.rhs.us, !llvm.loop !51
...
while.body.critedge.loopexit:                     ; preds = %if.end.i
  ...
  %cmp.i = icmp eq ptr %List1.addr.0.val44, null
  br i1 %cmp.i, label %cleanup, label %land.rhs, !llvm.loop !51

while.cond8.preheader:                            ; preds = %while.body.i
  %Scan2.070 = load ptr, ptr %List1.addr.068, align 8
...
while.body12:                                     ; preds = %while.cond8.preheader, %if.end21
  ...
  %Scan1.072 = phi ptr [ %Scan1.1, %if.end21 ], [ %List1.addr.068, %while.cond8.preheader ]
...
if.then16:                                        ; preds = %while.body.i54
  %Scan1.0.val41 = load ptr, ptr %Scan1.072, align 8
  br label %if.end21

if.else:                                          ; preds = %if.end.i57
  %Scan2.0.val40 = load ptr, ptr %Scan2.073, align 8
  store ptr %Scan2.0.val40, ptr %Scan1.072, align 8
  %14 = load ptr, ptr getelementptr ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
...
if.end21:                                         ; preds = %if.else, %if.then16
  %Scan1.1 = phi ptr [ %Scan1.0.val41, %if.then16 ], [ %Scan1.072, %if.else ]
...
cleanup:                                          ; preds = %while.body.critedge.loopexit, %if.end21, %land.rhs.us, %entry, %while.cond8.preheader
  %List1.addr.066 = phi ptr [ %List1.addr.068, %while.cond8.preheader ], [ null, %entry ], [ null, %land.rhs.us ], [ %List1.addr.068, %if.end21 ], [ null, %while.body.critedge.loopexit ]
...
for.body:                                         ; preds = %for.cond.preheader, %list_PointerDeleteElement.exit
  ...
  %List1.addr.017 = phi ptr [ %List.addr.048.i, %list_PointerDeleteElement.exit ], [ %List1, %for.cond.preheader ]
  %0 = getelementptr i8, ptr %Scan.018, i64 8
  %Scan.0.val = load ptr, ptr %0, align 8
  %cmp.i49.i = icmp eq ptr %List1.addr.017, null
  br i1 %cmp.i49.i, label %list_PointerDeleteElement.exit, label %land.rhs.i
...
while.body.i:                                     ; preds = %land.rhs.i
  ...
  %cmp.i.i = icmp eq ptr %List.addr.0.val38.i, null
  br i1 %cmp.i.i, label %list_PointerDeleteElement.exit, label %land.rhs.i, !llvm.loop !31
...
list_PointerDeleteElement.exit:                   ; preds = %while.body.i, %if.end17.i, %for.body, %while.cond7.preheader.i
  %List.addr.048.i = phi ptr [ %List.addr.050.i, %while.cond7.preheader.i ], [ null, %for.body ], [ %List.addr.050.i, %if.end17.i ], [ null, %while.body.i ]
...
if.end:                                           ; preds = %list_PointerDeleteElement.exit, %for.cond.preheader, %entry
  %List1.addr.1 = phi ptr [ null, %entry ], [ %List1, %for.cond.preheader ], [ %List.addr.048.i, %list_PointerDeleteElement.exit ]
...
for.body:                                         ; preds = %for.cond.preheader, %list_DeleteElement.exit
  ...
  %List1.addr.016 = phi ptr [ %List.addr.052.i, %list_DeleteElement.exit ], [ %List1, %for.cond.preheader ]
  %0 = getelementptr i8, ptr %Scan.017, i64 8
  %Scan.0.val = load ptr, ptr %0, align 8
  %cmp.i53.i = icmp eq ptr %List1.addr.016, null
  br i1 %cmp.i53.i, label %list_DeleteElement.exit, label %land.rhs.i
...
while.body.i:                                     ; preds = %land.rhs.i
  ...
  %cmp.i.i = icmp eq ptr %Scan1.055.i, null
  br i1 %cmp.i.i, label %list_DeleteElement.exit, label %land.rhs.i, !llvm.loop !22
...
list_DeleteElement.exit:                          ; preds = %while.body.i, %if.end20.i, %for.body, %while.cond9.preheader.i
  %List.addr.052.i = phi ptr [ %List.addr.054.i, %while.cond9.preheader.i ], [ null, %for.body ], [ %List.addr.054.i, %if.end20.i ], [ null, %while.body.i ]
...
if.end:                                           ; preds = %list_DeleteElement.exit, %for.cond.preheader, %entry
  %List1.addr.1 = phi ptr [ null, %entry ], [ %List1, %for.cond.preheader ], [ %List.addr.052.i, %list_DeleteElement.exit ]
  ret ptr %List1.addr.1
}
...
list_MultisetDistribution.exit38:                 ; preds = %if.end.i36, %list_MultisetDistribution.exit
  ...
  %cmp.i52.i = icmp eq ptr %call.i, null
  %cmp.i3653.i = icmp eq ptr %call.i39, null
  %spec.select54.i = or i1 %cmp.i52.i, %cmp.i3653.i
  br i1 %spec.select54.i, label %if.then9.i, label %while.body.i

while.body.i:                                     ; preds = %list_MultisetDistribution.exit38, %if.end.i40
  %scan2.056.i = phi ptr [ %scan2.0.val34.i, %if.end.i40 ], [ %call.i39, %list_MultisetDistribution.exit38 ]
  %scan.055.i = phi ptr [ %scan.0.val35.i, %if.end.i40 ], [ %call.i, %list_MultisetDistribution.exit38 ]
  %10 = getelementptr i8, ptr %scan.055.i, i64 8
  %scan.0.val.i = load ptr, ptr %10, align 8
  %11 = getelementptr i8, ptr %scan2.056.i, i64 8
...
if.end.i40:                                       ; preds = %while.body.i
  %scan.0.val35.i = load ptr, ptr %scan.055.i, align 8
  %scan2.0.val34.i = load ptr, ptr %scan2.056.i, align 8
...
if.then9.i:                                       ; preds = %if.end.i40, %list_MultisetDistribution.exit38
  ...
  %cmp.i.lcssa.i = phi i1 [ %cmp.i52.i, %list_MultisetDistribution.exit38 ], [ %cmp.i.i, %if.end.i40 ]
  %cmp.i41.i = icmp ne ptr %scan2.0.lcssa.i, null
  %or.cond.not58.i = select i1 %cmp.i.lcssa.i, i1 %cmp.i41.i, i1 false
  %.mux.i = sext i1 %or.cond.not58.i to i32
  br i1 %cmp.i.lcssa.i, label %list_CompareDistributions.exit, label %land.lhs.true17.i

land.lhs.true17.i:                                ; preds = %if.then9.i
  %cmp.i45.i = icmp eq ptr %scan2.0.lcssa.i, null
  %spec.select47.i = zext i1 %cmp.i45.i to i32
  br label %list_CompareDistributions.exit

list_CompareDistributions.exit:                   ; preds = %while.body.i, %if.then9.i, %land.lhs.true17.i
  %result.2.i = phi i32 [ %.mux.i, %if.then9.i ], [ %spec.select47.i, %land.lhs.true17.i ], [ %retval.0.i.i, %while.body.i ]
  br i1 %cmp.i52.i, label %list_DeleteDistribution.exit, label %while.body.i.i.i
...
list_DeleteDistribution.exit:                     ; preds = %while.body.i.i.i, %list_CompareDistributions.exit
  br i1 %cmp.i3653.i, label %list_DeleteDistribution.exit53, label %while.body.i.i.i52

while.body.i.i.i52:                               ; preds = %list_DeleteDistribution.exit, %while.body.i.i.i52
  %List.addr.08.i.i.i42 = phi ptr [ %List.addr.0.val6.i.i.i43, %while.body.i.i.i52 ], [ %call.i39, %list_DeleteDistribution.exit ]
  %List.addr.0.val6.i.i.i43 = load ptr, ptr %List.addr.08.i.i.i42, align 8
  %27 = getelementptr i8, ptr %List.addr.08.i.i.i42, i64 8
  %List.addr.0.val.i.i.i44 = load ptr, ptr %27, align 8
  %28 = load ptr, ptr getelementptr ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i1.i.i45 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %28, i64 0, i32 4
  %29 = load i32, ptr %total_size.i.i.i1.i.i45, align 8
  %conv26.i.i.i2.i.i46 = sext i32 %29 to i64
  %30 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i3.i.i47 = add i64 %30, %conv26.i.i.i2.i.i46
  store i64 %add27.i.i.i3.i.i47, ptr @memory_FREEDBYTES, align 8
  %31 = load ptr, ptr %28, align 8
  store ptr %31, ptr %List.addr.0.val.i.i.i44, align 8
  %32 = load ptr, ptr getelementptr ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %List.addr.0.val.i.i.i44, ptr %32, align 8
  %33 = load ptr, ptr getelementptr ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i.i.i48 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %33, i64 0, i32 4
  %34 = load i32, ptr %total_size.i.i.i.i.i48, align 8
  %conv26.i.i.i.i.i49 = sext i32 %34 to i64
  %35 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i.i.i50 = add i64 %35, %conv26.i.i.i.i.i49
  store i64 %add27.i.i.i.i.i50, ptr @memory_FREEDBYTES, align 8
  %36 = load ptr, ptr %33, align 8
  store ptr %36, ptr %List.addr.08.i.i.i42, align 8
  %37 = load ptr, ptr getelementptr ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %List.addr.08.i.i.i42, ptr %37, align 8
  %cmp.i.not.i.i.i51 = icmp eq ptr %List.addr.0.val6.i.i.i43, null
  br i1 %cmp.i.not.i.i.i51, label %list_DeleteDistribution.exit53, label %while.body.i.i.i52, !llvm.loop !20

list_DeleteDistribution.exit53:                   ; preds = %while.body.i.i.i52, %list_DeleteDistribution.exit
  ret i32 %result.2.i
}
