...
40:                                               ; preds = %37, %32
  ...
  %43 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %42)
  br label %148
...
55:                                               ; preds = %52, %47
  ...
  %58 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, double noundef %57)
  br label %148
...
70:                                               ; preds = %67, %62
  ...
  %73 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i64 noundef %72)
  br label %148
...
102:                                              ; preds = %99, %94
  ...
  %108 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.5, i32 noundef %104, i32 noundef %107)
  br label %148
...
131:                                              ; preds = %125, %115
  ...
  %134 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.6, i32 noundef %132, double noundef %133)
  br label %148
...
135:                                              ; preds = %9
  ...
  %147 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.7, i32 noundef %138, double noundef %140, i32 noundef %146, i32 noundef %144)
  br label %148
...
define dso_local i32 @main() local_unnamed_addr #0 {
  ...
  call void (ptr, ...) @test(ptr noundef nonnull @.str.13, i64 %6, i32 19, double 2.000000e+01, ptr noundef nonnull byval(%struct.LargeS_struct) align 8 %2)
