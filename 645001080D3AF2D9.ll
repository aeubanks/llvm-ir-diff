...
define dso_local void @ygraph() local_unnamed_addr #0 {
  ...
  store ptr %8, ptr @yNodules, align 8, !tbaa !9
  %9 = icmp slt i32 %4, -1
...
22:                                               ; preds = %10, %0
  %23 = load ptr, ptr @Hlist, align 8, !tbaa !9
  ...
  %33 = load ptr, ptr @hChanBeginRoot, align 8, !tbaa !9
...
63:                                               ; preds = %59, %22
  %64 = load ptr, ptr @Hend, align 8, !tbaa !9
  ...
  %74 = load ptr, ptr @hChanEndRoot, align 8, !tbaa !9
...
91:                                               ; preds = %87
  %92 = load ptr, ptr @yNodules, align 8, !tbaa !9
  ...
  %99 = load ptr, ptr @yNodules, align 8, !tbaa !9
...
119:                                              ; preds = %114, %63
  %120 = load ptr, ptr @hFixedList, align 8, !tbaa !9
...
131:                                              ; preds = %126, %231
  ...
  %140 = load ptr, ptr @yNodules, align 8, !tbaa !9
...
155:                                              ; preds = %146
  %156 = load ptr, ptr @hChanEndRoot, align 8, !tbaa !9
...
169:                                              ; preds = %161
  %170 = load ptr, ptr @yNodules, align 8, !tbaa !9
  ...
  %174 = load ptr, ptr @yNodules, align 8, !tbaa !9
...
188:                                              ; preds = %146
  %189 = load ptr, ptr @hChanBeginRoot, align 8, !tbaa !9
...
202:                                              ; preds = %194
  %203 = load ptr, ptr @yNodules, align 8, !tbaa !9
  ...
  %207 = load ptr, ptr @yNodules, align 8, !tbaa !9
...
237:                                              ; preds = %128, %384
  ...
  %239 = load ptr, ptr @yNodules, align 8, !tbaa !9
...
249:                                              ; preds = %243, %300
  ...
  %262 = load ptr, ptr @hChanEndRoot, align 8, !tbaa !9
...
278:                                              ; preds = %274
  tail call void @tdelete(ptr noundef nonnull @hChanEndRoot, i32 noundef %257, i32 noundef %269) #5
...
310:                                              ; preds = %306
  %311 = load ptr, ptr @yNodules, align 8, !tbaa !9
  br label %312
...
323:                                              ; preds = %317, %374
  ...
  %336 = load ptr, ptr @hChanBeginRoot, align 8, !tbaa !9
...
352:                                              ; preds = %348
  tail call void @tdelete(ptr noundef nonnull @hChanBeginRoot, i32 noundef %331, i32 noundef %343) #5
...
389:                                              ; preds = %384, %128
  ...
  %390 = load ptr, ptr @hFixedList, align 8, !tbaa !9
...
394:                                              ; preds = %392, %394
  ...
  %396 = load i32, ptr @numYnodes, align 4, !tbaa !5
  %397 = add nsw i32 %396, 1
  store i32 %397, ptr @numYnodes, align 4, !tbaa !5
...
404:                                              ; preds = %394
  %405 = load i32, ptr @numYnodes, align 4, !tbaa !5
  br label %406
...
406:                                              ; preds = %404, %389
  ...
  store ptr %411, ptr @yNodeArray, align 8, !tbaa !9
...
424:                                              ; preds = %421, %424
  ...
  %427 = load ptr, ptr @yNodeArray, align 8, !tbaa !9
...
455:                                              ; preds = %432, %517
  ...
  %458 = load ptr, ptr @yNodules, align 8, !tbaa !9
...
466:                                              ; preds = %462, %511
  ...
  %470 = load ptr, ptr @yNodules, align 8, !tbaa !9
...
474:                                              ; preds = %466
  ...
  %479 = load ptr, ptr @yNodeArray, align 8, !tbaa !9
...
482:                                              ; preds = %474, %482
  ...
  %493 = load ptr, ptr @yNodeArray, align 8, !tbaa !9
...
522:                                              ; preds = %452, %590
  ...
  %525 = load ptr, ptr @yNodules, align 8, !tbaa !9
...
529:                                              ; preds = %522
  %530 = load ptr, ptr @yNodeArray, align 8, !tbaa !9
  br label %531
...
531:                                              ; preds = %529, %584
  ...
  %556 = load ptr, ptr @yNodeArray, align 8, !tbaa !9
...
595:                                              ; preds = %590, %452
  %596 = load ptr, ptr @hChanBeginRoot, align 8, !tbaa !9
  %597 = icmp eq ptr %596, null
  br i1 %597, label %601, label %598

598:                                              ; preds = %595, %598
  call void @tpop(ptr noundef nonnull @hChanBeginRoot, ptr noundef nonnull %3, ptr noundef nonnull %1, ptr noundef nonnull %2) #5
  %599 = load ptr, ptr %3, align 8, !tbaa !9
  %600 = icmp eq ptr %599, null
  br i1 %600, label %601, label %598

601:                                              ; preds = %598, %595
  %602 = load ptr, ptr @hChanEndRoot, align 8, !tbaa !9
  %603 = icmp eq ptr %602, null
  br i1 %603, label %607, label %604

604:                                              ; preds = %601, %604
  call void @tpop(ptr noundef nonnull @hChanEndRoot, ptr noundef nonnull %3, ptr noundef nonnull %1, ptr noundef nonnull %2) #5
