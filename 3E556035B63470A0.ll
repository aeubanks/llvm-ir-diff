...
55:                                               ; preds = %13, %30, %38, %47
  %56 = phi i32 [ %54, %47 ], [ 0, %38 ], [ 0, %30 ], [ 0, %13 ]
...
107:                                              ; preds = %77, %81, %89, %98
  %108 = phi i32 [ %106, %98 ], [ 0, %89 ], [ 0, %81 ], [ 0, %77 ]
...
169:                                              ; preds = %132, %145, %153, %162
  %170 = phi i32 [ %168, %162 ], [ 0, %153 ], [ 0, %145 ], [ 0, %132 ]
...
226:                                              ; preds = %194, %200, %208, %217
  %227 = phi i32 [ %201, %217 ], [ %201, %208 ], [ %201, %200 ], [ 0, %194 ]
  %228 = phi i32 [ %225, %217 ], [ 0, %208 ], [ 0, %200 ], [ 0, %194 ]
...
261:                                              ; preds = %251, %239, %231, %226, %119, %111, %107
  %262 = phi i32 [ 0, %119 ], [ 0, %111 ], [ 0, %107 ], [ 0, %239 ], [ 0, %231 ], [ 0, %226 ], [ %260, %251 ]
  %263 = phi i32 [ %21, %119 ], [ %21, %111 ], [ %21, %107 ], [ %137, %239 ], [ %137, %231 ], [ %137, %226 ], [ %253, %251 ]
  %264 = phi i32 [ %78, %119 ], [ %78, %111 ], [ %78, %107 ], [ %227, %239 ], [ %227, %231 ], [ %227, %226 ], [ %254, %251 ]
  %265 = phi i32 [ %16, %119 ], [ %16, %111 ], [ %16, %107 ], [ %133, %239 ], [ %133, %231 ], [ %133, %226 ], [ %255, %251 ]
  %266 = phi i32 [ %56, %119 ], [ %56, %111 ], [ %56, %107 ], [ %170, %239 ], [ %170, %231 ], [ %170, %226 ], [ %256, %251 ]
