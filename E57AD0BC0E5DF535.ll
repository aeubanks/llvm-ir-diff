...
define dso_local i32 @main() local_unnamed_addr #0 {
  ...
  tail call void asm sideeffect "", "=*imr,0,~{dirflag},~{fpsr},~{flags}"(ptr nonnull elementtype(i32) @x, i32 %1) #2, !srcloc !9
...
7:                                                ; preds = %5
  ...
  tail call void asm sideeffect "", "imr,~{dirflag},~{fpsr},~{flags}"(i32 %8) #2, !srcloc !10
