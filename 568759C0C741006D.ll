...
invoke.cont100:                                   ; preds = %cond.end
  ...
  br i1 %or.cond427, label %if.end106, label %delete.notnull.i373
...
_ZN8app_node9set_rightEP8exp_nodes.exit416:       ; preds = %if.then252, %if.end5.i411
  %90 = phi ptr [ %call259, %if.then252 ], [ %.pre, %if.end5.i411 ]
