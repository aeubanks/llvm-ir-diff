...
define dso_local void @countlib(i32 noundef %0, i32 noundef %1, i32 noundef %2) local_unnamed_addr #0 {
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(361) @ml, i8 1, i64 361, i1 false), !tbaa !5
  tail call void @count(i32 noundef %0, i32 noundef %1, i32 noundef %2) #3
  ret void
}
