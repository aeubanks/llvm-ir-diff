...
for.body:                                         ; preds = %if.else, %list_Nconc.exit
  ...
  %Scan.034 = phi ptr [ %Scan.0.val26, %list_Nconc.exit ], [ %Term.val28, %if.else ]
...
list_Nconc.exit:                                  ; preds = %for.body, %if.end.i, %for.end.i
  ...
  %Scan.0.val26 = load ptr, ptr %Scan.034, align 8
...
if.then4:                                         ; preds = %if.then
  ...
  %Scan1.0105 = load ptr, ptr %4, align 8
  %cmp.i84.not106 = icmp eq ptr %Scan1.0105, null
  br i1 %cmp.i84.not106, label %for.end, label %for.body

for.body:                                         ; preds = %if.then4, %list_Nconc.exit
  %Scan1.0108 = phi ptr [ %Scan1.0, %list_Nconc.exit ], [ %Scan1.0105, %if.then4 ]
  %OldVars.0107 = phi ptr [ %retval.0.i, %list_Nconc.exit ], [ null, %if.then4 ]
  %5 = getelementptr i8, ptr %Scan1.0108, i64 8
  ...
  store ptr null, ptr %call.i.i, align 8
  %cmp.i.i86 = icmp eq ptr %OldVars.0107, null
  br i1 %cmp.i.i86, label %list_Nconc.exit, label %for.cond.i

for.cond.i:                                       ; preds = %for.body, %for.cond.i
  %List1.addr.0.i = phi ptr [ %List1.addr.0.val17.i, %for.cond.i ], [ %OldVars.0107, %for.body ]
  %List1.addr.0.val17.i = load ptr, ptr %List1.addr.0.i, align 8
  %cmp.i20.not.i = icmp eq ptr %List1.addr.0.val17.i, null
  br i1 %cmp.i20.not.i, label %for.end.i, label %for.cond.i, !llvm.loop !7
...
list_Nconc.exit:                                  ; preds = %for.body, %for.end.i
  %retval.0.i = phi ptr [ %OldVars.0107, %for.end.i ], [ %call.i.i, %for.body ]
  ...
  %Scan1.0 = load ptr, ptr %Scan1.0108, align 8
...
for.end:                                          ; preds = %for.end.loopexit, %if.then4
  ...
  %Scan1.1109 = load ptr, ptr %13, align 8
  %cmp.i87.not110 = icmp eq ptr %Scan1.1109, null
  br i1 %cmp.i87.not110, label %for.end33, label %for.body23

for.body23:                                       ; preds = %for.end, %for.body23
  %Scan1.1112 = phi ptr [ %Scan1.1, %for.body23 ], [ %Scan1.1109, %for.end ]
  %Scan2.0111 = phi ptr [ %Scan2.0.val76, %for.body23 ], [ %OldVars.0.lcssa, %for.end ]
  %14 = getelementptr i8, ptr %Scan1.1112, i64 8
  ...
  %19 = getelementptr i8, ptr %Scan2.0111, i64 8
  ...
  %Scan2.0.val76 = load ptr, ptr %Scan2.0111, align 8
  %Scan1.1 = load ptr, ptr %Scan1.1112, align 8
...
for.body39:                                       ; preds = %if.then, %for.body39
  %Scan1.2104 = phi ptr [ %Scan1.2.val75, %for.body39 ], [ %Formula.val81, %if.then ]
  %26 = getelementptr i8, ptr %Scan1.2104, i64 8
  %Scan1.2.val = load ptr, ptr %26, align 8
  tail call fastcc void @fol_NormalizeVarsIntern(ptr noundef %Scan1.2.val)
  %Scan1.2.val75 = load ptr, ptr %Scan1.2104, align 8
  %cmp.i96.not = icmp eq ptr %Scan1.2.val75, null
...
if.then8:                                         ; preds = %if.then
  ...
  %Scan.0191 = load ptr, ptr %10, align 8
  %cmp.i124.not192 = icmp eq ptr %Scan.0191, null
  br i1 %cmp.i124.not192, label %for.end, label %for.body

for.body:                                         ; preds = %if.then8, %for.inc
  %Scan.0193 = phi ptr [ %Scan.0, %for.inc ], [ %Scan.0191, %if.then8 ]
  %11 = getelementptr i8, ptr %Scan.0193, i64 8
...
for.inc:                                          ; preds = %for.body, %if.then16
  %Scan.0 = load ptr, ptr %Scan.0193, align 8
...
for.body32:                                       ; preds = %if.else, %for.inc41
  %Scan.1190 = phi ptr [ %Scan.1.val107, %for.inc41 ], [ %Term.addr.0.val113, %if.else ]
  %16 = getelementptr i8, ptr %Scan.1190, i64 8
...
for.inc41:                                        ; preds = %for.body32, %if.then37
  %Scan.1.val107 = load ptr, ptr %Scan.1190, align 8
...
while.body:                                       ; preds = %land.rhs
  ...
  br i1 %cmp.i165.not, label %do.end, label %land.rhs, !llvm.loop !20
...
while.body:                                       ; preds = %land.rhs
  ...
  br i1 %cmp.i47.not, label %do.end, label %land.rhs, !llvm.loop !21
...
do.cond:                                          ; preds = %if.then13, %if.else
  ...
  br i1 %cmp.i77.not, label %do.end, label %do.body, !llvm.loop !28
...
do.cond41:                                        ; preds = %if.then36, %if.else38
  ...
  br i1 %cmp.i96.not, label %list_Delete.exit, label %do.body24, !llvm.loop !29
...
while.body.i:                                     ; preds = %land.rhs.i
  ...
  br i1 %cmp.i62.not.i, label %fol_InstancesIntern.exit, label %land.rhs.i, !llvm.loop !37
...
while.body.i:                                     ; preds = %land.rhs.i
  ...
  br i1 %cmp.i104.not.i, label %fol_GeneralizationsIntern.exit, label %land.rhs.i, !llvm.loop !38
...
for.inc:                                          ; preds = %cleanup
  ...
  br i1 %cmp.i38.not, label %cleanup22, label %for.body, !llvm.loop !44
...
if.end.lr.ph.i:                                   ; preds = %if.then
  ...
  %Subterm.val.i85 = load ptr, ptr %8, align 8
  %cmp1.i86 = icmp eq ptr %Subterm.val.i85, %Term
  br i1 %cmp1.i86, label %cleanup, label %if.end3.i

if.end3.i:                                        ; preds = %if.end.lr.ph.i, %if.then25.i
  %Subterm.val.i89 = phi ptr [ %Subterm.val.i, %if.then25.i ], [ %Subterm.val.i85, %if.end.lr.ph.i ]
  %Subterm.tr58.i88 = phi ptr [ %Subterm.val.i89, %if.then25.i ], [ %Subterm, %if.end.lr.ph.i ]
  %SubtermPolar.tr59.i87 = phi i32 [ %retval.0.i.i, %if.then25.i ], [ -1, %if.end.lr.ph.i ]
  %call.val.i = load i32, ptr %Subterm.val.i89, align 8
  %cmp.i.i = icmp eq ptr %Subterm.val.i89, %Subterm.tr58.i88
...
land.lhs.true.i.i:                                ; preds = %lor.lhs.false7.i.i
  %9 = getelementptr i8, ptr %Subterm.val.i89, i64 16
  ...
  %cmp11.i.i = icmp eq ptr %SuperTerm.val39.val.val.i.i, %Subterm.tr58.i88
...
land.lhs.true15.i.i:                              ; preds = %lor.lhs.false12.i.i
  %11 = getelementptr i8, ptr %Subterm.val.i89, i64 16
  ...
  %cmp17.i.i = icmp eq ptr %SuperTerm.val38.val.i.i, %Subterm.tr58.i88
...
if.end19.i.i:                                     ; preds = %land.lhs.true15.i.i, %lor.lhs.false12.i.i
  ...
  %sub.i.i = sub nsw i32 0, %SubtermPolar.tr59.i87
...
fol_PolarCheckCount.exit.i:                       ; preds = %if.end19.i.i, %land.lhs.true15.i.i, %land.lhs.true.i.i, %lor.lhs.false4.i.i, %if.end.i.i, %if.end3.i
  %retval.0.i.i = phi i32 [ %SubtermPolar.tr59.i87, %if.end3.i ], [ %SubtermPolar.tr59.i87, %land.lhs.true15.i.i ], [ %SubtermPolar.tr59.i87, %land.lhs.true.i.i ], [ %SubtermPolar.tr59.i87, %lor.lhs.false4.i.i ], [ %SubtermPolar.tr59.i87, %if.end.i.i ], [ %spec.select.i.i, %if.end19.i.i ]
...
if.then25.i:                                      ; preds = %lor.lhs.false10.i, %lor.lhs.false.i, %fol_PolarCheckCount.exit.i
  %13 = getelementptr i8, ptr %Subterm.val.i89, i64 8
...
land.lhs.true5:                                   ; preds = %entry
  ...
  br i1 %cmp.i21, label %if.then8, label %cleanup
...
if.end.lr.ph.i24:                                 ; preds = %if.then8
  ...
  %Subterm.val.i2779 = load ptr, ptr %22, align 8
  %cmp1.i2880 = icmp eq ptr %Subterm.val.i2779, %Term
  br i1 %cmp1.i2880, label %cleanup, label %if.end3.i32

if.end3.i32:                                      ; preds = %if.end.lr.ph.i24, %if.then25.i75
  %Subterm.val.i2783 = phi ptr [ %Subterm.val.i27, %if.then25.i75 ], [ %Subterm.val.i2779, %if.end.lr.ph.i24 ]
  %Subterm.tr58.i2682 = phi ptr [ %Subterm.val.i2783, %if.then25.i75 ], [ %Subterm, %if.end.lr.ph.i24 ]
  %SubtermPolar.tr59.i2581 = phi i32 [ %retval.0.i.i58, %if.then25.i75 ], [ 1, %if.end.lr.ph.i24 ]
  %call.val.i30 = load i32, ptr %Subterm.val.i2783, align 8
  %cmp.i.i31 = icmp eq ptr %Subterm.val.i2783, %Subterm.tr58.i2682
...
lor.lhs.false4.i.i40:                             ; preds = %if.end.i.i36
  %cmp.i.i.i.i37 = icmp eq i32 %17, %call.val.i30
  %cmp.i4.i.i.i38 = icmp eq i32 %Term.val, %call.val.i30
  %narrow.i.i.i39 = or i1 %cmp.i.i.i.i37, %cmp.i4.i.i.i38
...
land.lhs.true.i.i47:                              ; preds = %lor.lhs.false7.i.i42
  ...
  %cmp11.i.i46 = icmp eq ptr %SuperTerm.val39.val.val.i.i45, %Subterm.tr58.i2682
...
land.lhs.true15.i.i53:                            ; preds = %lor.lhs.false12.i.i49
  ...
  %cmp17.i.i52 = icmp eq ptr %SuperTerm.val38.val.i.i51, %Subterm.tr58.i2682
...
if.end19.i.i57:                                   ; preds = %land.lhs.true15.i.i53, %lor.lhs.false12.i.i49
  %cmp.i46.i.i54 = icmp eq i32 %call.val.i30, %20
  %sub.i.i55 = sub nsw i32 0, %SubtermPolar.tr59.i2581
...
fol_PolarCheckCount.exit.i60:                     ; preds = %if.end19.i.i57, %land.lhs.true15.i.i53, %land.lhs.true.i.i47, %lor.lhs.false4.i.i40, %if.end.i.i36, %if.end3.i32
  %retval.0.i.i58 = phi i32 [ %SubtermPolar.tr59.i2581, %if.end3.i32 ], [ %SubtermPolar.tr59.i2581, %land.lhs.true15.i.i53 ], [ %SubtermPolar.tr59.i2581, %land.lhs.true.i.i47 ], [ %SubtermPolar.tr59.i2581, %lor.lhs.false4.i.i40 ], [ %SubtermPolar.tr59.i2581, %if.end.i.i36 ], [ %spec.select.i.i56, %if.end19.i.i57 ]
  %cmp.i48.i59 = icmp eq i32 %call.val.i30, %21
...
if.then25.i75:                                    ; preds = %lor.lhs.false10.i74, %lor.lhs.false.i64, %fol_PolarCheckCount.exit.i60
  %27 = getelementptr i8, ptr %Subterm.val.i2783, i64 8
...
cleanup:                                          ; preds = %if.then25.i75, %lor.lhs.false10.i74, %if.then25.i, %lor.lhs.false10.i, %if.end.lr.ph.i24, %if.end.lr.ph.i, %land.lhs.true, %land.lhs.true5, %entry, %if.then8, %if.then
  %retval.0 = phi i32 [ 1, %if.then ], [ 1, %if.then8 ], [ 0, %entry ], [ 0, %land.lhs.true5 ], [ 0, %land.lhs.true ], [ 1, %if.end.lr.ph.i ], [ 1, %if.end.lr.ph.i24 ], [ 1, %if.then25.i ], [ 0, %lor.lhs.false10.i ], [ 1, %if.then25.i75 ], [ 0, %lor.lhs.false10.i74 ]
  ret i32 %retval.0
}
...
if.end20:                                         ; preds = %if.end14, %if.then17
  ...
  %7 = load i32, ptr @fol_ALL, align 4
  %cmp.i = icmp eq i32 %call3.val126, %7
  %8 = load i32, ptr @fol_OR, align 4
  %cmp.i139 = icmp eq i32 %call.val, %8
  ...
  %cmp.i141 = icmp eq i32 %Predicat.0.val125, %9
  %or.cond179 = select i1 %or.cond, i1 %cmp.i141, i1 false
  br i1 %or.cond179, label %land.lhs.true33, label %if.end50
...
land.lhs.true33:                                  ; preds = %if.end20
  ...
  %16 = and i32 %15, 768
  %or.cond176.not = icmp eq i32 %16, 768
...
if.end50:                                         ; preds = %if.end20, %land.lhs.true43, %land.lhs.true33
  ...
  %23 = and i32 %22, 768
  %or.cond177.not = icmp eq i32 %23, 768
...
if.end77:                                         ; preds = %if.then69
  ...
  %cmp.i170 = icmp eq i32 %call.val, %27
...
if.else86:                                        ; preds = %if.end64
  ...
  %cmp.i173 = icmp eq i32 %call.val, %29
...
if.then7:                                         ; preds = %if.then
  ...
  %cmp.i127 = icmp ne i32 %and.i.i, 3
  %tobool.not.i.inv = icmp sgt i32 %ActFormula.0.val, -1
  %narrow.not = select i1 %tobool.not.i.inv, i1 true, i1 %cmp.i127
  br i1 %narrow.not, label %land.lhs.true, label %if.else
...
if.else:                                          ; preds = %land.lhs.true15, %land.lhs.true12, %symbol_IsJunctor.exit134, %if.then7
...
if.end66:                                         ; preds = %if.else45, %if.else58, %if.then55, %if.then42
  ...
  %cmp.i177.not214 = icmp eq i32 %stack_POINTER.promoted, %0
  br i1 %cmp.i177.not214, label %cleanup, label %land.rhs

land.rhs:                                         ; preds = %if.end66, %while.body
  %dec.i184213215 = phi i32 [ %dec.i184, %while.body ], [ %stack_POINTER.promoted, %if.end66 ]
  %sub.i179 = add i32 %dec.i184213215, -1
...
while.body:                                       ; preds = %land.rhs
  %dec.i184 = add i32 %dec.i184213215, -2
  store i32 %dec.i184, ptr @stack_POINTER, align 4
  %cmp.i177.not = icmp eq i32 %dec.i184, %0
  br i1 %cmp.i177.not, label %cleanup, label %land.rhs, !llvm.loop !70

do.cond:                                          ; preds = %land.rhs
  %21 = getelementptr i8, ptr %20, i64 8
  %call77.val = load ptr, ptr %21, align 8
  %sub.i190 = add i32 %dec.i184213215, -2
...
if.then7:                                         ; preds = %if.then
  ...
  %cmp.i140 = icmp ne i32 %and.i.i, 3
  %tobool.not.i.inv = icmp sgt i32 %ActTerm.0.val, -1
  %narrow.not = select i1 %tobool.not.i.inv, i1 true, i1 %cmp.i140
  br i1 %narrow.not, label %land.lhs.true, label %if.else
...
if.else:                                          ; preds = %symbol_ContextIsMapped.exit, %land.lhs.true15, %land.lhs.true12, %symbol_IsJunctor.exit147, %if.then7
...
if.end74:                                         ; preds = %if.else50, %if.else66, %if.then60, %if.then47
  %stack_POINTER.promoted = load i32, ptr @stack_POINTER, align 4
  %cmp.i193.not231 = icmp eq i32 %stack_POINTER.promoted, %0
  br i1 %cmp.i193.not231, label %cleanup, label %land.rhs

land.rhs:                                         ; preds = %if.end74, %while.body
  %dec.i200230232 = phi i32 [ %dec.i200, %while.body ], [ %stack_POINTER.promoted, %if.end74 ]
  %sub.i195 = add i32 %dec.i200230232, -1
...
while.body:                                       ; preds = %land.rhs
  %dec.i200 = add i32 %dec.i200230232, -2
  store i32 %dec.i200, ptr @stack_POINTER, align 4
  %cmp.i193.not = icmp eq i32 %dec.i200, %0
  br i1 %cmp.i193.not, label %cleanup, label %land.rhs, !llvm.loop !72

do.cond:                                          ; preds = %land.rhs
  %25 = getelementptr i8, ptr %24, i64 8
  %call85.val = load ptr, ptr %25, align 8
  %sub.i206 = add i32 %dec.i200230232, -2
