...
_Z11MyStringLenIcEiPKT_.exit.i:                   ; preds = %for.cond.i.i12
  ...
  %call.i.i1625 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %conv.i.i15) #23
          to label %call.i.i16.noexc unwind label %lpad1
...
while.cond.i.i23:                                 ; preds = %call.i.i16.noexc, %while.cond.i.i23
  ...
  br i1 %cmp.not.i10.i22, label %_ZN11CStringBaseIcEC2EPKc.exit, label %while.cond.i.i23, !llvm.loop !23

_ZN11CStringBaseIcEC2EPKc.exit:                   ; preds = %while.cond.i.i23
...
ehcleanup:                                        ; preds = %lpad1, %_ZN11CStringBaseIwED2Ev.exit30
  %.pn = phi { ptr, i32 } [ %15, %lpad1 ], [ %13, %_ZN11CStringBaseIwED2Ev.exit30 ]
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %astr) #22
  resume { ptr, i32 } %.pn
}
...
invoke.cont:                                      ; preds = %for.cond.i
  ...
  %or.cond241 = select i1 %cmp, i1 %cmp3, i1 false
  br i1 %or.cond241, label %if.then, label %if.end14
...
if.end14:                                         ; preds = %if.end7.i, %if.then4.i, %if.end, %invoke.cont
  ...
  %.fr297 = freeze i32 %10
  %add.i.i103 = add nsw i32 %.fr297, 1
...
if.end.i.i.thread:                                ; preds = %if.end.i.i, %_ZN11CStringBaseIwEC2EPKw.exit
  %13 = phi i32 [ 0, %_ZN11CStringBaseIwEC2EPKw.exit ], [ %.fr297, %if.end.i.i ]
  %add.i.i103279284 = phi i32 [ 1, %_ZN11CStringBaseIwEC2EPKw.exit ], [ %add.i.i103, %if.end.i.i ]
...
_ZN11CStringBaseIwE11SetCapacityEi.exit.i108:     ; preds = %call.i.i107.noexc, %if.end14
  %add.i.i103280 = phi i32 [ 0, %if.end14 ], [ %add.i.i103279284, %call.i.i107.noexc ]
...
if.end25:                                         ; preds = %_ZN11CStringBaseIcED2Ev.exit.i
  %.pre276 = tail call ptr @__errno_location() #26
  %.pr285 = load i32, ptr %.pre276, align 4, !tbaa !29
  %cmp28 = icmp eq i32 %.pr285, 17
...
if.end9.i.i174:                                   ; preds = %delete.notnull.i.i171, %call.i.i167.noexc
  ...
  store i32 %add.i.i103280, ptr %_capacity.i, align 4, !tbaa !15
...
while.cond51:                                     ; preds = %_ZN11CStringBaseIwEaSERKS0_.exit183, %_ZN11CStringBaseIwED2Ev.exit216
  ...
  %48 = load i32, ptr %_length.i, align 8, !tbaa !17
...
_ZN11CStringBaseIcED2Ev.exit.i210:                ; preds = %delete.notnull.i.i209, %.noexc212
  ...
  %.pre275 = load ptr, ptr %ref.tmp63, align 8, !tbaa !11
  br label %invoke.cont69

invoke.cont69:                                    ; preds = %_ZN11CStringBaseIcED2Ev.exit.i210, %if.then.i204
  %59 = phi ptr [ %.pre275, %_ZN11CStringBaseIcED2Ev.exit.i210 ], [ %56, %if.then.i204 ]
...
delete.notnull.i227:                              ; preds = %land.lhs.true7, %cleanup79
  %retval.1254 = phi i1 [ %retval.0, %cleanup79 ], [ true, %land.lhs.true7 ]
...
_ZN11CStringBaseIwED2Ev.exit228:                  ; preds = %cleanup79, %delete.notnull.i227
  %retval.1255 = phi i1 [ %retval.0, %cleanup79 ], [ %retval.1254, %delete.notnull.i227 ]
...
lor.lhs.false.i:                                  ; preds = %.noexc65
  ...
  br i1 %tobool1.not.i, label %delete.notnull.i154.thread, label %if.end.i349

if.end.i349:                                      ; preds = %lor.lhs.false.i
...
invoke.cont7:                                     ; preds = %.noexc65
  %call.i.i346354 = tail call ptr @__errno_location() #26
  store i32 2, ptr %call.i.i346354, align 4, !tbaa !29
  br label %cleanup
...
cleanup:                                          ; preds = %delete.notnull.i154, %_ZN11CStringBaseIwED2Ev.exit184, %invoke.cont6, %invoke.cont7, %delete.notnull.i154.thread
  %call383 = phi i1 [ true, %invoke.cont7 ], [ true, %delete.notnull.i154.thread ], [ %call, %delete.notnull.i154 ], [ %call, %_ZN11CStringBaseIwED2Ev.exit184 ], [ false, %invoke.cont6 ]
...
_ZN8NWindows5NFile5NFind12CEnumeratorWD2Ev.exit:  ; preds = %_ZN11CStringBaseIcED2Ev.exit.i.i, %delete.notnull.i3.i.i
  ...
  br i1 %call383, label %cleanup23, label %cleanup.cont
