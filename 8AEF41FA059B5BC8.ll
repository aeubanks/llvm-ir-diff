; ModuleID = '/usr/local/google/home/aeubanks/repos/test-suite/SingleSource/Regression/C/gcc-c-torture/execute/pr34768-1.c'
source_filename = "/usr/local/google/home/aeubanks/repos/test-suite/SingleSource/Regression/C/gcc-c-torture/execute/pr34768-1.c"
...
define dso_local i32 @test(i32 noundef %c) local_unnamed_addr #2 {
entry:
  %0 = load i32, ptr @x, align 4, !tbaa !5
  %tobool.not = icmp eq i32 %c, 0
  %cond = select i1 %tobool.not, ptr @bar, ptr @foo
  tail call void %cond() #5, !callees !9
...
entry:
  ...
  %call = tail call i32 @test(i32 noundef 1)
