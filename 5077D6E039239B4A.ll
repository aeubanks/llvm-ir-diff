...
while.cond4.while.end19_crit_edge.us:             ; preds = %if.end.us
  ...
  %spec.select47.idx.us = zext i1 %cmp20.us to i64
  %spec.select47.us = getelementptr i32, ptr %cword.056.us, i64 %spec.select47.idx.us
...
while.cond4.while.end19_crit_edge.us.i.split:     ; preds = %if.end.us.i
  ...
  %spec.select47.idx.us.i = zext i1 %cmp20.us.i to i64
  %spec.select47.us.i = getelementptr i32, ptr %cword.056.us.i, i64 %spec.select47.idx.us.i
