...
for.body5.i.i:                                    ; preds = %clause_RemoveFlag.exit84.i.i, %for.inc38.i.i
  ...
  %and.i85.i.i = and i32 %.val74.i.i, 64
  %cmp.i.not.i.i = icmp eq i32 %and.i85.i.i, 0
  br i1 %cmp.i.not.i.i, label %if.then.i.i, label %for.inc38.i.i
...
if.then.i.i:                                      ; preds = %for.body5.i.i
  ...
  %Parents.0119.i.i = load ptr, ptr %10, align 8
...
while.body.i.preheader.i.i:                       ; preds = %if.then.i.i, %if.end30.i.i
  %PLits.0126.in.i.i = phi ptr [ %PLits.0126.i.i, %if.end30.i.i ], [ %11, %if.then.i.i ]
  ...
  %12 = getelementptr i8, ptr %Parents.0125.i.i, i64 8
  %Parents.0.val73.i.i = load ptr, ptr %12, align 8
  %13 = ptrtoint ptr %Parents.0.val73.i.i to i64
  %14 = trunc i64 %13 to i32
  %15 = getelementptr i8, ptr %PLits.0126.i.i, i64 8
  %PLits.0.val72.i.i = load ptr, ptr %15, align 8
  %16 = ptrtoint ptr %PLits.0.val72.i.i to i64
...
while.body.i.i.i:                                 ; preds = %if.end6.i.i.i, %while.body.i.preheader.i.i
  ...
  %.val.i.i.i = load i32, ptr %18, align 8
  %cmp1.i.i.i = icmp sgt i32 %.val.i.i.i, %14
  br i1 %cmp1.i.i.i, label %if.end6.i.i.i, label %if.else.i.i.i

if.else.i.i.i:                                    ; preds = %while.body.i.i.i
  %cmp2.not.i.i.i = icmp eq i32 %.val.i.i.i, %14
...
if.then21.i.i:                                    ; preds = %if.end6.i.i.i
  ...
  %or.i92.i.i = or i32 %19, 128
  store i32 %or.i92.i.i, ptr %9, align 8
  br label %if.end30.i.i

if.else.i.i:                                      ; preds = %if.else.i.i.i
  %20 = getelementptr i8, ptr %18, i64 48
  %.val.i.i = load i32, ptr %20, align 8
  %and.i93.i.i = and i32 %.val.i.i, 128
  %cmp.i94.not.i.i = icmp eq i32 %and.i93.i.i, 0
  br i1 %cmp.i94.not.i.i, label %if.end.i.i, label %if.then26.i.i

if.then26.i.i:                                    ; preds = %if.else.i.i
  %add.ptr.i.i.i.le = getelementptr inbounds i8, ptr %call3.i, i64 %mul.i.i.i
  %21 = load i32, ptr %9, align 8
  %or.i97.i.i = or i32 %21, 128
...
if.end.i.i:                                       ; preds = %if.then26.i.i, %if.else.i.i
  %22 = phi ptr [ %.pre141.i.i, %if.then26.i.i ], [ %18, %if.else.i.i ]
  ...
  store ptr %22, ptr %car.i99.i.i, align 8
  store ptr %NewParents.0124.i.i, ptr %call.i98.i.i, align 8
  %sext113.i.i = shl i64 %16, 32
  %conv28.i.i = ashr exact i64 %sext113.i.i, 32
  %23 = inttoptr i64 %conv28.i.i to ptr
  ...
  store ptr %23, ptr %car.i101.i.i, align 8
...
while.end.i.i:                                    ; preds = %if.end30.i.i
  %.val75.pre.i.i = load ptr, ptr %10, align 8
...
while.body.i102.i.i:                              ; preds = %while.end.i.i, %while.body.i102.i.i
  ...
  %total_size.i.i.i.i.i = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %24, i64 0, i32 4
  %25 = load i32, ptr %total_size.i.i.i.i.i, align 8
  %conv26.i.i.i.i.i = sext i32 %25 to i64
  %26 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i.i.i = add i64 %26, %conv26.i.i.i.i.i
  store i64 %add27.i.i.i.i.i, ptr @memory_FREEDBYTES, align 8
  %27 = load ptr, ptr %24, align 8
  store ptr %27, ptr %Current.06.i.i.i, align 8
  %28 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i.i.i, ptr %28, align 8
...
list_Delete.exit.i.i:                             ; preds = %while.body.i102.i.i, %while.end.i.i, %if.then.i.i
  ...
  %.val77.i.i = load ptr, ptr %11, align 8
...
while.body.i110.i.i:                              ; preds = %list_Delete.exit.i.i, %while.body.i110.i.i
  ...
  %total_size.i.i.i106.i.i = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %29, i64 0, i32 4
  %30 = load i32, ptr %total_size.i.i.i106.i.i, align 8
  %conv26.i.i.i107.i.i = sext i32 %30 to i64
  %31 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i108.i.i = add i64 %31, %conv26.i.i.i107.i.i
  store i64 %add27.i.i.i108.i.i, ptr @memory_FREEDBYTES, align 8
  %32 = load ptr, ptr %29, align 8
  store ptr %32, ptr %Current.06.i104.i.i, align 8
  %33 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i104.i.i, ptr %33, align 8
...
list_Delete.exit111.i.i:                          ; preds = %while.body.i110.i.i, %list_Delete.exit.i.i
  ...
  store ptr %call35.i.i, ptr %10, align 8
  store ptr %call36.i.i, ptr %11, align 8
...
if.then.i28.i:                                    ; preds = %pcheck_ForceParentNumbersToPointersInVector.exit.i
  %34 = load i32, ptr @memory_ALIGN, align 4
  %rem2.i.i.i.i = urem i32 %mul.i, %34
  %tobool3.not.i.i.i.i = icmp eq i32 %rem2.i.i.i.i, 0
  %sub6.i.i.i.i = add i32 %34, %mul.i
  ...
  %35 = load i32, ptr @memory_OFFSET, align 4
...
if.else25.i.i:                                    ; preds = %pcheck_ForceParentNumbersToPointersInVector.exit.i
  ...
  %43 = load ptr, ptr %arrayidx.i30.i, align 8
  %total_size.i.i = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %43, i64 0, i32 4
  %44 = load i32, ptr %total_size.i.i, align 8
  %conv26.i.i = sext i32 %44 to i64
  %45 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i = add i64 %45, %conv26.i.i
  store i64 %add27.i.i, ptr @memory_FREEDBYTES, align 8
  %46 = load ptr, ptr %43, align 8
  store ptr %46, ptr %call3.i, align 8
  %47 = load ptr, ptr %arrayidx.i30.i, align 8
  store ptr %call3.i, ptr %47, align 8
  br label %pcheck_ConvertParentsInList.exit
...
for.body:                                         ; preds = %clause_RemoveFlag.exit.i, %for.inc15
  ...
  %and.i = and i32 %call1.val, 64
  %cmp.i31.not = icmp eq i32 %and.i, 0
  br i1 %cmp.i31.not, label %if.then, label %for.inc15

if.then:                                          ; preds = %for.body
  %4 = getelementptr i8, ptr %ScanClauses.0.val30, i64 32
  %ScanParents.035 = load ptr, ptr %4, align 8
...
for.body10:                                       ; preds = %if.then, %for.body10
  ...
  %5 = getelementptr i8, ptr %ScanParents.037, i64 8
  %ScanParents.0.val28 = load ptr, ptr %5, align 8
...
entry:
  ...
  %cmp.i.not146 = icmp eq ptr %ProofRest, null
  br i1 %cmp.i.not146, label %while.end28, label %while.body.lr.ph
...
while.body:                                       ; preds = %while.body.lr.ph, %clause_RemoveFlag.exit
  %ProofRest.addr.0148 = phi ptr [ %ProofRest, %while.body.lr.ph ], [ %ProofRest.addr.0.val, %clause_RemoveFlag.exit ]
  %Clauses.0147 = phi ptr [ null, %while.body.lr.ph ], [ %call.i87, %clause_RemoveFlag.exit ]
  %1 = getelementptr i8, ptr %ProofRest.addr.0148, i64 8
  ...
  %cmp.i66.not141 = icmp eq ptr %call2.val63.val.val, null
  br i1 %cmp.i66.not141, label %while.end, label %while.body18

while.body18:                                     ; preds = %while.body, %pcheck_LabelToNumber.exit
  %ParentLits.0144 = phi ptr [ %call.i71, %pcheck_LabelToNumber.exit ], [ null, %while.body ]
  %ParentIds.0143 = phi ptr [ %call.i69, %pcheck_LabelToNumber.exit ], [ null, %while.body ]
  %ParentLabels.0142 = phi ptr [ %ParentLabels.0.val, %pcheck_LabelToNumber.exit ], [ %call2.val63.val.val, %while.body ]
  %11 = getelementptr i8, ptr %ParentLabels.0142, i64 8
...
pcheck_LabelToNumber.exit:                        ; preds = %while.body18
  ...
  store ptr %ParentIds.0143, ptr %call.i69, align 8
  ...
  store ptr %ParentLits.0144, ptr %call.i71, align 8
  %ParentLabels.0.val = load ptr, ptr %ParentLabels.0142, align 8
...
clause_ClearSplitField.exit:                      ; preds = %clause_ClearSplitField.exit.loopexit, %if.then
  ...
  br i1 %cmp.not.i74, label %clause_ClearSplitField.exit.clause_SetSplitFieldBit.exit_crit_edge, label %if.then.i.i

clause_ClearSplitField.exit.clause_SetSplitFieldBit.exit_crit_edge: ; preds = %clause_ClearSplitField.exit
  %splitfield.i76.phi.trans.insert = getelementptr inbounds %struct.CLAUSE_HELP, ptr %call10, i64 0, i32 4
  %.pre157 = load ptr, ptr %splitfield.i76.phi.trans.insert, align 8
...
clause_SetSplitFieldBit.exit:                     ; preds = %clause_ClearSplitField.exit.clause_SetSplitFieldBit.exit_crit_edge, %if.end.i.i
  %57 = phi ptr [ %.pre157, %clause_ClearSplitField.exit.clause_SetSplitFieldBit.exit_crit_edge ], [ %call.i.i75, %if.end.i.i ]
...
if.then2.i:                                       ; preds = %if.then.i82
  %mul.i = shl i32 %18, 3
  %cmp.i.i.i = icmp ult i32 %mul.i, 1024
  br i1 %cmp.i.i.i, label %if.else25.i.i, label %if.then.i.i83

if.then.i.i83:                                    ; preds = %if.then2.i
...
if.then9.i.i:                                     ; preds = %if.then.i.i83
  %64 = load ptr, ptr %add.ptr1.i.i, align 8
  store ptr %64, ptr %63, align 8
  br label %if.end13.i.i

if.end13.i.i:                                     ; preds = %if.then9.i.i, %if.then.i.i83
...
if.else25.i.i:                                    ; preds = %if.then2.i
  %idxprom.i.i = zext i32 %mul.i to i64
  %arrayidx.i.i84 = getelementptr inbounds [0 x ptr], ptr @memory_ARRAY, i64 0, i64 %idxprom.i.i
  %68 = load ptr, ptr %arrayidx.i.i84, align 8
  ...
  %72 = load ptr, ptr %arrayidx.i.i84, align 8
...
if.end:                                           ; preds = %if.else.i, %if.else, %clause_SetSplitFieldBit.exit
  ...
  br i1 %tobool.not.i85, label %clause_RemoveFlag.exit, label %if.then.i86
...
clause_RemoveFlag.exit:                           ; preds = %if.end, %if.then.i86
  %call.i87 = call ptr @memory_Malloc(i32 noundef 16) #16
  %car.i88 = getelementptr inbounds %struct.LIST_HELP, ptr %call.i87, i64 0, i32 1
  store ptr %call10, ptr %car.i88, align 8
  store ptr %Clauses.0147, ptr %call.i87, align 8
  %ProofRest.addr.0.val = load ptr, ptr %ProofRest.addr.0148, align 8
...
while.end28:                                      ; preds = %clause_RemoveFlag.exit, %entry
  %Clauses.0.lcssa = phi ptr [ null, %entry ], [ %call.i87, %clause_RemoveFlag.exit ]
...
if.end.i:                                         ; preds = %while.end28
  ...
  %mul.i89 = shl i32 %call2.i, 3
  %call4.i = call ptr @memory_Malloc(i32 noundef %mul.i89) #16
  br label %for.body.i91

for.body.i91:                                     ; preds = %for.body.i91, %if.end.i
  %indvars.iv.i = phi i64 [ 0, %if.end.i ], [ %indvars.iv.next.i, %for.body.i91 ]
  %ScanClauses.039.i = phi ptr [ %call29, %if.end.i ], [ %ScanClauses.0.val.i, %for.body.i91 ]
  ...
  br i1 %cmp.i29.not.i, label %for.end.i, label %for.body.i91, !llvm.loop !22

for.end.i:                                        ; preds = %for.body.i91
  %conv.i92 = sext i32 %call2.i to i64
  call void @qsort(ptr noundef nonnull %call4.i, i64 noundef %conv.i92, i64 noundef 8, ptr noundef nonnull @pcheck_CompareClauseNumber) #16
  %cmp51.i.i = icmp sgt i32 %call2.i, 0
  br i1 %cmp51.i.i, label %for.body.lr.ph.i.i93, label %pcheck_ParentNumbersToPointersInVector.exit.i

for.body.lr.ph.i.i93:                             ; preds = %for.end.i
  %conv6.i.i = zext i32 %call2.i to i64
  br label %for.body.i.i97

for.body.i.i97:                                   ; preds = %list_Delete.exit.i.i, %for.body.lr.ph.i.i93
  %indvars.iv.i.i94 = phi i64 [ 0, %for.body.lr.ph.i.i93 ], [ %indvars.iv.next.i.i102, %list_Delete.exit.i.i ]
  %arrayidx.i.i95 = getelementptr inbounds ptr, ptr %call4.i, i64 %indvars.iv.i.i94
  %75 = load ptr, ptr %arrayidx.i.i95, align 8
  %76 = getelementptr i8, ptr %75, i64 32
  %.val.i.i = load ptr, ptr %76, align 8
  %call1.i.i96 = call ptr @list_Copy(ptr noundef %.val.i.i) #16
  %cmp.i.not46.i.i = icmp eq ptr %call1.i.i96, null
  br i1 %cmp.i.not46.i.i, label %for.end.i.i, label %for.body4.i.i

for.body4.i.i:                                    ; preds = %for.body.i.i97, %if.then.i.i101
  %ScanParents.047.i.i = phi ptr [ %ScanParents.0.val.i.i, %if.then.i.i101 ], [ %call1.i.i96, %for.body.i.i97 ]
...
while.body.i.i.i:                                 ; preds = %if.end6.i.i.i, %for.body4.i.i
  ...
  %add.i.i.i98 = add i64 %__u.019.i.i.i, %__l.020.i.i.i
  %div17.i.i.i = lshr i64 %add.i.i.i98, 1
  %mul.i.i.i = shl i64 %div17.i.i.i, 3
  %add.ptr.i.i.i99 = getelementptr inbounds i8, ptr %call4.i, i64 %mul.i.i.i
  %80 = load ptr, ptr %add.ptr.i.i.i99, align 8
  %.val.i.i.i = load i32, ptr %80, align 8
  %cmp1.i.i.i = icmp sgt i32 %.val.i.i.i, %79
  br i1 %cmp1.i.i.i, label %if.end6.i.i.i, label %if.else.i.i.i

if.else.i.i.i:                                    ; preds = %while.body.i.i.i
  %cmp2.not.i.i.i100 = icmp eq i32 %.val.i.i.i, %79
  br i1 %cmp2.not.i.i.i100, label %if.then.i.i101, label %if.then3.i.i.i
...
if.then.i.i101:                                   ; preds = %if.else.i.i.i
...
if.else.i.i:                                      ; preds = %if.end6.i.i.i
  ...
  %82 = load ptr, ptr %arrayidx.i.i95, align 8
...
for.end.i.i:                                      ; preds = %if.then.i.i101, %for.body.i.i97
  %86 = load ptr, ptr %arrayidx.i.i95, align 8
  %parentCls.i.i.i = getelementptr inbounds %struct.CLAUSE_HELP, ptr %86, i64 0, i32 6
  store ptr %call1.i.i96, ptr %parentCls.i.i.i, align 8
...
list_Delete.exit.i.i:                             ; preds = %while.body.i38.i.i, %for.end.i.i
  %indvars.iv.next.i.i102 = add nuw nsw i64 %indvars.iv.i.i94, 1
  %exitcond.not.i.i = icmp eq i64 %indvars.iv.next.i.i102, %conv6.i.i
  br i1 %exitcond.not.i.i, label %pcheck_ParentNumbersToPointersInVector.exit.i, label %for.body.i.i97, !llvm.loop !24

pcheck_ParentNumbersToPointersInVector.exit.i:    ; preds = %list_Delete.exit.i.i, %for.end.i
  %cmp.i.i.i103 = icmp ult i32 %mul.i89, 1024
  br i1 %cmp.i.i.i103, label %if.else25.i.i132, label %if.then.i31.i

if.then.i31.i:                                    ; preds = %pcheck_ParentNumbersToPointersInVector.exit.i
  %92 = load i32, ptr @memory_ALIGN, align 4
  %rem2.i.i.i.i104 = urem i32 %mul.i89, %92
  %tobool3.not.i.i.i.i105 = icmp eq i32 %rem2.i.i.i.i104, 0
  %sub6.i.i.i.i106 = add i32 %92, %mul.i89
  %add7.i.i.i.i107 = sub i32 %sub6.i.i.i.i106, %rem2.i.i.i.i104
  %RealSize.1.i.i.i.i108 = select i1 %tobool3.not.i.i.i.i105, i32 %mul.i89, i32 %add7.i.i.i.i107
  %93 = load i32, ptr @memory_OFFSET, align 4
  %idx.ext.i.i109 = zext i32 %93 to i64
  %idx.neg.i.i110 = sub nsw i64 0, %idx.ext.i.i109
  %add.ptr.i.i111 = getelementptr inbounds i8, ptr %call4.i, i64 %idx.neg.i.i110
  %add.ptr1.i.i112 = getelementptr inbounds i8, ptr %add.ptr.i.i111, i64 -16
  %94 = load ptr, ptr %add.ptr1.i.i112, align 8
  %cmp2.not.i.i113 = icmp eq ptr %94, null
  %next6.i.i114 = getelementptr inbounds i8, ptr %add.ptr.i.i111, i64 -8
  %95 = load ptr, ptr %next6.i.i114, align 8
  %next5.i.i115 = getelementptr inbounds %struct.MEMORY_BIGBLOCKHEADERHELP, ptr %94, i64 0, i32 1
  %memory_BIGBLOCKS.sink.i.i116 = select i1 %cmp2.not.i.i113, ptr @memory_BIGBLOCKS, ptr %next5.i.i115
  store ptr %95, ptr %memory_BIGBLOCKS.sink.i.i116, align 8
  %96 = load ptr, ptr %next6.i.i114, align 8
  %cmp8.not.i.i117 = icmp eq ptr %96, null
  br i1 %cmp8.not.i.i117, label %if.end13.i.i123, label %if.then9.i.i118

if.then9.i.i118:                                  ; preds = %if.then.i31.i
  %97 = load ptr, ptr %add.ptr1.i.i112, align 8
  store ptr %97, ptr %96, align 8
  br label %if.end13.i.i123

if.end13.i.i123:                                  ; preds = %if.then9.i.i118, %if.then.i31.i
  %98 = load i32, ptr @memory_MARKSIZE, align 4
  %add.i.i119 = add i32 %98, %RealSize.1.i.i.i.i108
  %conv.i32.i = zext i32 %add.i.i119 to i64
  %add14.i.i120 = add nuw nsw i64 %conv.i32.i, 16
  %99 = load i64, ptr @memory_FREEDBYTES, align 8
  %add15.i.i121 = add i64 %add14.i.i120, %99
  store i64 %add15.i.i121, ptr @memory_FREEDBYTES, align 8
  %100 = load i64, ptr @memory_MAXMEM, align 8
  %cmp16.i.i122 = icmp sgt i64 %100, -1
  br i1 %cmp16.i.i122, label %if.then18.i.i125, label %if.end23.i.i127

if.then18.i.i125:                                 ; preds = %if.end13.i.i123
  %add22.i.i124 = add nuw i64 %100, %add14.i.i120
  store i64 %add22.i.i124, ptr @memory_MAXMEM, align 8
  br label %if.end23.i.i127

if.end23.i.i127:                                  ; preds = %if.then18.i.i125, %if.end13.i.i123
  %add.ptr24.i.i126 = getelementptr inbounds i8, ptr %call4.i, i64 -16
  call void @free(ptr noundef nonnull %add.ptr24.i.i126) #16
  br label %pcheck_ParentNumbersToParents.exit

if.else25.i.i132:                                 ; preds = %pcheck_ParentNumbersToPointersInVector.exit.i
  %idxprom.i.i128 = zext i32 %mul.i89 to i64
  %arrayidx.i33.i = getelementptr inbounds [0 x ptr], ptr @memory_ARRAY, i64 0, i64 %idxprom.i.i128
  %101 = load ptr, ptr %arrayidx.i33.i, align 8
  %total_size.i.i129 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %101, i64 0, i32 4
  %102 = load i32, ptr %total_size.i.i129, align 8
  %conv26.i.i130 = sext i32 %102 to i64
  %103 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i131 = add i64 %103, %conv26.i.i130
  store i64 %add27.i.i131, ptr @memory_FREEDBYTES, align 8
...
pcheck_ParentNumbersToParents.exit:               ; preds = %while.end28, %if.end23.i.i127, %if.else25.i.i132
  ret ptr %call29
}
...
for.body:                                         ; preds = %entry, %for.inc
  ...
  %and.i = and i32 %call1.val, 64
  %cmp.i12.not = icmp eq i32 %and.i, 0
  br i1 %cmp.i12.not, label %if.then, label %for.inc

if.then:                                          ; preds = %for.body
  %2 = getelementptr i8, ptr %Clauses.addr.0.val10, i64 32
...
for.body:                                         ; preds = %for.cond.preheader, %for.inc
  ...
  %and.i = and i32 %call4.val, 64
  %cmp.i34.not = icmp eq i32 %and.i, 0
  br i1 %cmp.i34.not, label %land.lhs.true, label %for.inc

land.lhs.true:                                    ; preds = %for.body
  %2 = getelementptr i8, ptr %Scan.0.val29, i64 76
  %call7.val = load i32, ptr %2, align 4
  %cmp.i36 = icmp eq i32 %call7.val, 15
  br i1 %cmp.i36, label %if.then10, label %for.inc

if.then10:                                        ; preds = %land.lhs.true
  %3 = load ptr, ptr %Splits, align 8
...
for.end:                                          ; preds = %for.inc, %for.cond.preheader
  %4 = getelementptr i8, ptr %T.tr42, i64 32
  %T.val30 = load ptr, ptr %4, align 8
  tail call fastcc void @pcheck_CollectUnmarkedSplits(ptr noundef %T.val30, ptr noundef %Splits)
  %5 = getelementptr i8, ptr %T.tr42, i64 40
  %T.val31 = load ptr, ptr %5, align 8
...
entry:
  %cmp.i79 = icmp eq ptr %T, null
  br i1 %cmp.i79, label %cleanup, label %if.end

if.end:                                           ; preds = %entry, %for.end
  %T.tr80 = phi ptr [ %T.val56, %for.end ], [ %T, %entry ]
  %0 = getelementptr i8, ptr %T.tr80, i64 40
...
tab_IsLeaf.exit:                                  ; preds = %if.end
  %1 = getelementptr i8, ptr %T.tr80, i64 32
...
for.body.i.i:                                     ; preds = %for.body.i.i, %if.then28.i
  %call31.val.i = phi ptr [ %call.i.i92.i, %for.body.i.i ], [ null, %if.then28.i ]
...
pcheck_ClauseListToTermList.exit.i:               ; preds = %for.body.i.i
  %cmp.i94.i = icmp eq ptr %call31.val.i, null
  br i1 %cmp.i94.i, label %if.then35.i, label %if.else.i

if.then35.i:                                      ; preds = %pcheck_ClauseListToTermList.exit.i
  %21 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i113.i = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %21, i64 0, i32 4
  %22 = load i32, ptr %total_size.i.i.i113.i, align 8
  %conv26.i.i.i114.i = sext i32 %22 to i64
  %23 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i115.i = add i64 %23, %conv26.i.i.i114.i
...
if.end39.i:                                       ; preds = %if.else.i, %if.then35.i
  %Tmp.0.i = phi ptr [ %call38.i, %if.else.i ], [ %call3.i91.i, %if.then35.i ]
...
if.end4:                                          ; preds = %if.end39.i, %if.end.i, %if.then3, %tab_IsLeaf.exit
  %Scan.076 = load ptr, ptr %T.tr80, align 8
  %cmp.i60.not77 = icmp eq ptr %Scan.076, null
  br i1 %cmp.i60.not77, label %for.end, label %for.body

for.body:                                         ; preds = %if.end4, %for.inc
  %Scan.078 = phi ptr [ %Scan.0, %for.inc ], [ %Scan.076, %if.end4 ]
  %30 = getelementptr i8, ptr %Scan.078, i64 8
...
for.end:                                          ; preds = %for.inc, %if.end4
  ...
  %39 = getelementptr i8, ptr %T.tr80, i64 32
...
if.end19:                                         ; preds = %while.body.i, %if.else
  ...
  %cmp.i.not11.i.i = icmp eq ptr %call.i.i33, null
  br i1 %cmp.i.not11.i.i, label %pcheck_UnivClosure.exit, label %for.body.i.i
