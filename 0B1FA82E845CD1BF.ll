...
if.end186:                                        ; preds = %cleanup.cont182
  ...
  %or.cond875 = select i1 %tobool188.not, i1 %cmp194825, i1 false
  br i1 %or.cond875, label %for.body195, label %if.end225
...
_ZN11CStringBaseIwE10GrowLengthEi.exit.i.i:       ; preds = %if.end9.i.i.i.i, %_ZN11CStringBaseIwEC2ERKS0_.exit.i.i
  %ref.tmp89.sroa.0.1.i = phi ptr [ %call.i.i.i352.i, %if.end9.i.i.i.i ], [ %call.i.i.i291.i, %_ZN11CStringBaseIwEC2ERKS0_.exit.i.i ]
...
while.cond.i.i349.i:                              ; preds = %while.cond.i.i349.i, %_ZN11CStringBaseIwE10GrowLengthEi.exit.i.i
  %src.addr.0.i.i345.i = phi ptr [ %187, %_ZN11CStringBaseIwE10GrowLengthEi.exit.i.i ], [ %incdec.ptr.i.i347.i, %while.cond.i.i349.i ]
  ...
  %188 = load i32, ptr %src.addr.0.i.i345.i, align 4, !tbaa !25
  %incdec.ptr1.i.i348.i = getelementptr inbounds i32, ptr %dest.addr.0.i.i346.i, i64 1
  store i32 %188, ptr %dest.addr.0.i.i346.i, align 4, !tbaa !25
...
_ZN11CStringBaseIwEpLERKS0_.exit.i:               ; preds = %while.cond.i.i349.i
  %189 = load i32, ptr %_length.i.i650, align 8, !tbaa !60
  %add.i.i652 = add nsw i32 %189, 32
  store i32 0, ptr %_length.i.i293.i, align 8, !tbaa !60
  %190 = load ptr, ptr %errorMessage, align 8, !tbaa !24
  store i32 0, ptr %190, align 4, !tbaa !25
  %add.i.i295.i = add nsw i32 %189, 33
  %191 = load i32, ptr %_capacity.i.i296.i, align 4, !tbaa !27
  %cmp.i.i297.i = icmp eq i32 %add.i.i295.i, %191
...
if.end.i.i299.i:                                  ; preds = %_ZN11CStringBaseIwEpLERKS0_.exit.i
  ...
  %193 = icmp slt i32 %189, -33
  %194 = shl nuw nsw i64 %conv.i.i298.i, 2
  %195 = select i1 %193, i64 -1, i64 %194
  %call.i.i310.i = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %195) #15
          to label %call.i.i.noexc309.i unwind label %delete.notnull.i318.i

call.i.i.noexc309.i:                              ; preds = %if.end.i.i299.i
  %cmp3.i.i.i = icmp sgt i32 %191, 0
...
if.end9.i.i301.i:                                 ; preds = %delete.notnull.i.i300.i, %call.i.i.noexc309.i
  %idxprom13.i.i.i = phi i64 [ %196, %delete.notnull.i.i300.i ], [ 0, %call.i.i.noexc309.i ]
...
while.cond.i.i308.i.preheader:                    ; preds = %if.end9.i.i301.i, %_ZN11CStringBaseIwEpLERKS0_.exit.i
  %dest.addr.0.i.i304.i.ph = phi ptr [ %190, %_ZN11CStringBaseIwEpLERKS0_.exit.i ], [ %call.i.i310.i, %if.end9.i.i301.i ]
  br label %while.cond.i.i308.i

while.cond.i.i308.i:                              ; preds = %while.cond.i.i308.i.preheader, %while.cond.i.i308.i
  %src.addr.0.i.i303.i = phi ptr [ %incdec.ptr.i.i305.i, %while.cond.i.i308.i ], [ %ref.tmp89.sroa.0.1.i, %while.cond.i.i308.i.preheader ]
  ...
  %197 = load i32, ptr %src.addr.0.i.i303.i, align 4, !tbaa !25
  %incdec.ptr1.i.i306.i = getelementptr inbounds i32, ptr %dest.addr.0.i.i304.i, i64 1
  store i32 %197, ptr %dest.addr.0.i.i304.i, align 4, !tbaa !25
  %cmp.not.i.i307.i = icmp eq i32 %197, 0
...
delete.notnull.i321.i:                            ; preds = %delete.notnull.i318.i, %lpad93.i, %delete.notnull.i.i.i
  %.pn357.i = phi { ptr, i32 } [ %199, %lpad93.i ], [ %192, %delete.notnull.i.i.i ], [ %200, %delete.notnull.i318.i ]
  call void @_ZdaPv(ptr noundef nonnull %call.i.i281.i) #17
  br label %ehcleanup174.i
...
cleanup.cont121.i:                                ; preds = %invoke.cont114.i
  ...
  %209 = zext i8 %narrow.i to i32
  %210 = load i8, ptr %options, align 8, !tbaa !14, !range !22, !noundef !23
  %tobool130.not.i = icmp eq i8 %210, 0
...
if.then131.i:                                     ; preds = %cleanup.cont121.i
  ...
  %211 = load ptr, ptr %vfn133.i, align 8
  %call136.i = invoke noundef i32 %211(ptr noundef nonnull align 8 dereferenceable(8) %138, ptr noundef null, i32 noundef -1, i32 noundef %209, ptr noundef nonnull %call27)
...
invoke.cont135.i:                                 ; preds = %if.then131.i
  ...
  %212 = load ptr, ptr %vfn140.i, align 8
  %call143.i = invoke noundef i32 %212(ptr noundef nonnull align 8 dereferenceable(8) %138, i32 noundef 44, ptr noundef nonnull %prop.i)
...
if.then145.i:                                     ; preds = %invoke.cont142.i
  %213 = load i16, ptr %prop.i, align 8
  switch i16 %213, label %if.end154.i [
...
invoke.cont157.i:                                 ; preds = %cleanup.cont121.i
  %220 = load ptr, ptr %_items.i.i639, align 8, !tbaa !32
  %221 = load i32, ptr %_size.i.i640, align 4, !tbaa !35
  %vtable160.i = load ptr, ptr %138, align 8, !tbaa !12
  %vfn161.i = getelementptr inbounds ptr, ptr %vtable160.i, i64 9
  %222 = load ptr, ptr %vfn161.i, align 8
  %call163.i = invoke noundef i32 %222(ptr noundef nonnull align 8 dereferenceable(8) %138, ptr noundef %220, i32 noundef %221, i32 noundef %209, ptr noundef nonnull %call27)
...
if.end164.i:                                      ; preds = %invoke.cont157.i, %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit326.i
  ...
  %223 = load ptr, ptr %vfn166.i, align 8
  %call168.i = invoke noundef i32 %223(ptr noundef nonnull align 8 dereferenceable(8) %extractCallback, i32 noundef %result.0.i)
...
cleanup173.i:                                     ; preds = %if.end164.i, %invoke.cont114.i, %_ZN11CStringBaseIwED2Ev.exit316.i
  ...
  %224 = load ptr, ptr %outDir.i, align 8, !tbaa !24
  %isnull.i328.i = icmp eq ptr %224, null
...
ehcleanup174.i:                                   ; preds = %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit.i, %lpad134.i, %lpad113.i, %delete.notnull.i321.i, %lpad91.i, %lpad74.i, %ehcleanup73.i
  %.pn360.pn.i = phi { ptr, i32 } [ %205, %lpad113.i ], [ %175, %lpad74.i ], [ %.pn.pn.i, %ehcleanup73.i ], [ %214, %lpad134.i ], [ %215, %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit.i ], [ %198, %lpad91.i ], [ %.pn357.i, %delete.notnull.i321.i ]
  %227 = load ptr, ptr %outDir.i, align 8, !tbaa !24
  %isnull.i332.i = icmp eq ptr %227, null
...
cleanup.cont342:                                  ; preds = %_ZL17DecompressArchiveRK4CArcyRKN9NWildcard11CCensorNodeERK15CExtractOptionsP18IExtractCallbackUIP23CArchiveExtractCallbackR11CStringBaseIwERy.exit
  %228 = load i8, ptr %options, align 8, !tbaa !14, !range !22, !noundef !23
  %tobool345.not = icmp eq i8 %228, 0
  %229 = load i64, ptr %fi54, align 8
  %230 = load i64, ptr %VolumesSize.i, align 8
  %add349 = add i64 %230, %229
  %packProcessed.4 = select i1 %tobool345.not, i64 %add349, i64 %packProcessed.3
  %231 = load ptr, ptr %LocalProgressSpec, align 8, !tbaa !82
  %InSize = getelementptr inbounds %class.CLocalProgress, ptr %231, i64 0, i32 8
  %232 = load i64, ptr %InSize, align 8, !tbaa !83
  %add351 = add i64 %232, %packProcessed.4
  store i64 %add351, ptr %InSize, align 8, !tbaa !83
  %233 = load i64, ptr %UnpackSize, align 8, !tbaa !86
  %OutSize = getelementptr inbounds %class.CLocalProgress, ptr %231, i64 0, i32 9
  store i64 %233, ptr %OutSize, align 8, !tbaa !87
  %234 = load i32, ptr %_length.i.i293.i, align 8, !tbaa !60
  %cmp.i656 = icmp ne i32 %234, 0
...
cleanup362:                                       ; preds = %invoke.cont301, %cleanup.cont342, %_ZL17DecompressArchiveRK4CArcyRKN9NWildcard11CCensorNodeERK15CExtractOptionsP18IExtractCallbackUIP23CArchiveExtractCallbackR11CStringBaseIwERy.exit, %invoke.cont269, %invoke.cont252
  ...
  %235 = load ptr, ptr %password, align 8, !tbaa !24
  %isnull.i657 = icmp eq ptr %235, null
...
cleanup378:                                       ; preds = %invoke.cont81, %cleanup368
  ...
  %236 = load ptr, ptr %Name.i541, align 8, !tbaa !24
  %isnull.i.i661 = icmp eq ptr %236, null
...
for.inc386:                                       ; preds = %_ZN8NWindows5NFile5NFind10CFileInfoWD2Ev.exit664, %_ZN8NWindows5NFile5NFind10CFileInfoWD2Ev.exit664
  ...
  %237 = sext i32 %numArcs.6 to i64
  %cmp48 = icmp slt i64 %indvars.iv.next858, %237
...
ehcleanup363:                                     ; preds = %ehcleanup182.i, %lpad296, %lpad268, %lpad251
  ...
  %238 = load ptr, ptr %password, align 8, !tbaa !24
  %isnull.i665 = icmp eq ptr %238, null
...
ehcleanup379:                                     ; preds = %lpad61.loopexit, %lpad61.loopexit.split-lp, %ehcleanup373, %lpad76
  ...
  %239 = load ptr, ptr %Name.i541, align 8, !tbaa !24
  %isnull.i.i669 = icmp eq ptr %239, null
...
for.end388:                                       ; preds = %for.inc386, %if.end46
  ...
  %240 = load <2 x i64>, ptr %NumFolders.i, align 8, !tbaa !36
  store <2 x i64> %240, ptr %NumFolders389, align 8, !tbaa !36
  %UnpackSize391 = getelementptr inbounds %class.CArchiveExtractCallback, ptr %call27, i64 0, i32 44
  %241 = load i64, ptr %UnpackSize391, align 8, !tbaa !86
  %UnpackSize392 = getelementptr inbounds %struct.CDecompressStat, ptr %stat, i64 0, i32 1
  store i64 %241, ptr %UnpackSize392, align 8, !tbaa !89
  %CrcSum = getelementptr inbounds %class.CArchiveExtractCallback, ptr %call27, i64 0, i32 45
  %242 = load i32, ptr %CrcSum, align 8, !tbaa !91
  %CrcSum393 = getelementptr inbounds %struct.CDecompressStat, ptr %stat, i64 0, i32 5
  store i32 %242, ptr %CrcSum393, align 8, !tbaa !92
  %243 = load i32, ptr %_size.i, align 4, !tbaa !35
  %conv = sext i32 %243 to i64
  ...
  %244 = load ptr, ptr %LocalProgressSpec396, align 8, !tbaa !82
  %InSize397 = getelementptr inbounds %class.CLocalProgress, ptr %244, i64 0, i32 8
  %245 = load i64, ptr %InSize397, align 8, !tbaa !83
  %PackSize = getelementptr inbounds %struct.CDecompressStat, ptr %stat, i64 0, i32 2
  store i64 %245, ptr %PackSize, align 8, !tbaa !94
...
if.then.i677:                                     ; preds = %_ZN8NWindows5NFile5NFind10CFileInfoWD2Ev.exit664, %for.end388, %invoke.cont40
  ...
  %246 = load ptr, ptr %vfn.i676, align 8
  %call.i = invoke noundef i32 %246(ptr noundef nonnull align 8 dereferenceable(8) %call27)
...
if.then.i683:                                     ; preds = %lpad39, %ehcleanup381
  ...
  %249 = load ptr, ptr %vfn.i681, align 8
  %call.i682 = invoke noundef i32 %249(ptr noundef nonnull align 8 dereferenceable(8) %call27)
...
while.body:                                       ; preds = %if.end4, %_ZN11CStringBaseIwE6InsertEiRKS0_.exit
  ...
  br i1 %cmp.i.i, label %_ZNK11CStringBaseIwE4FindERKS0_i.exit, label %for.cond.preheader.i

for.cond.preheader.i:                             ; preds = %while.body
  %cmp42.i = icmp sgt i32 %6, %pos.044
  br i1 %cmp42.i, label %for.cond2.preheader.lr.ph.i, label %return
...
for.cond2.preheader.us.i:                         ; preds = %for.inc19.us.i, %for.cond2.preheader.us.preheader.i
  %indvars.iv57.i = phi i64 [ %11, %for.cond2.preheader.us.preheader.i ], [ %indvars.iv.next58.i, %for.inc19.us.i ]
...
land.rhs.us.i:                                    ; preds = %for.inc.us.i, %for.cond2.preheader.us.i
  ...
  %12 = add nsw i64 %indvars.iv.i, %indvars.iv57.i
...
for.inc19.us.i:                                   ; preds = %land.rhs.us.i, %for.body7.us.i
  ...
  %lftr.wideiv.i = trunc i64 %indvars.iv.next58.i to i32
  %exitcond60.not.i = icmp eq i32 %6, %lftr.wideiv.i
  br i1 %exitcond60.not.i, label %return, label %for.cond2.preheader.us.i, !llvm.loop !105
...
for.end.us.thread.i:                              ; preds = %for.inc.us.i
  %15 = trunc i64 %indvars.iv57.i to i32
...
if.then4.i:                                       ; preds = %if.end10
  ...
  %reass.sub.i = add i32 %6, 1
  %add.i.i = sub i32 %reass.sub.i, %add5.i
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load59 = load <4 x i32>, ptr %30, align 4, !tbaa !25
  ...
  store <4 x i32> %wide.load59, ptr %33, align 4, !tbaa !25
...
return:                                           ; preds = %_ZNK11CStringBaseIwE4FindERKS0_i.exit, %_ZN11CStringBaseIwE6InsertEiRKS0_.exit, %for.cond.preheader.i, %for.cond2.preheader.lr.ph.i, %for.inc19.us.i, %if.end4, %if.end, %entry
  %retval.0 = phi i32 [ 0, %entry ], [ 0, %if.end ], [ 0, %if.end4 ], [ %number.043, %for.inc19.us.i ], [ %number.043, %_ZNK11CStringBaseIwE4FindERKS0_i.exit ], [ %inc, %_ZN11CStringBaseIwE6InsertEiRKS0_.exit ], [ %number.043, %for.cond.preheader.i ], [ %number.043, %for.cond2.preheader.lr.ph.i ]
  ret i32 %retval.0
}
...
entry:
  ...
  %_length = getelementptr inbounds %class.CStringBase, ptr %this, i64 0, i32 1
  %0 = load i32, ptr %_length, align 8, !tbaa !60
