; ModuleID = '/usr/local/google/home/aeubanks/repos/test-suite/MultiSource/Benchmarks/TSVC/NodeSplitting-dbl/tsc.c'
source_filename = "/usr/local/google/home/aeubanks/repos/test-suite/MultiSource/Benchmarks/TSVC/NodeSplitting-dbl/tsc.c"
...
define dso_local i32 @s241() local_unnamed_addr #7 {
  %1 = tail call i32 @init(ptr noundef nonnull @.str.40)
...
37:                                               ; preds = %4, %37
  %38 = phi i64 [ 0, %4 ], [ %48, %37 ]
  %39 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %38
  %40 = load double, ptr %39, align 8, !tbaa !5
  %41 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 %38
  %42 = load double, ptr %41, align 8, !tbaa !5
  %43 = fmul double %40, %42
  %44 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 %38
  ...
  store double %52, ptr %39, align 8, !tbaa !5
  %53 = icmp eq i64 %48, 31999
  br i1 %53, label %31, label %37
}
...
; Function Attrs: nounwind uwtable
define dso_local i32 @s242(double noundef %0, double noundef %1) local_unnamed_addr #7 {
  %3 = tail call i32 @init(ptr noundef nonnull @.str.41)
...
6:                                                ; preds = %2, %38
  %7 = phi i32 [ %40, %38 ], [ 0, %2 ]
  %8 = load double, ptr @global_data, align 32, !tbaa !5
  br label %44

9:                                                ; preds = %38, %2
  %10 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.138, double noundef 0.000000e+00)
  br label %11
...
38:                                               ; preds = %44
  ...
  br i1 %43, label %6, label %9

44:                                               ; preds = %6, %44
  %45 = phi double [ %8, %6 ], [ %57, %44 ]
  %46 = phi i64 [ 1, %6 ], [ %59, %44 ]
  %47 = fadd double %45, %0
  %48 = fadd double %47, %1
  %49 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %46
  %50 = load double, ptr %49, align 8, !tbaa !5
  %51 = fadd double %50, %48
  %52 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 %46
  %53 = load double, ptr %52, align 8, !tbaa !5
  %54 = fadd double %53, %51
  %55 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 %46
  %56 = load double, ptr %55, align 8, !tbaa !5
  %57 = fadd double %56, %54
  %58 = getelementptr inbounds double, ptr @global_data, i64 %46
  store double %57, ptr %58, align 8, !tbaa !5
  %59 = add nuw nsw i64 %46, 1
  %60 = icmp eq i64 %59, 32000
  br i1 %60, label %38, label %44
}

; Function Attrs: nounwind uwtable
define dso_local i32 @s243() local_unnamed_addr #7 {
  %1 = tail call i32 @init(ptr noundef nonnull @.str.42)
  %2 = load i32, ptr @ntimes, align 4, !tbaa !17
  %3 = icmp sgt i32 %2, 0
...
6:                                                ; preds = %6, %4
  ...
  %12 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 %7
  %13 = load <2 x double>, ptr %12, align 16, !tbaa !5
  %14 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %11, <2 x double> %13, <2 x double> %9)
  %15 = getelementptr inbounds double, ptr @global_data, i64 %7
  %16 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 11, i64 %7
  %17 = load <2 x double>, ptr %16, align 16, !tbaa !5
  %18 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %13, <2 x double> %17, <2 x double> %14)
  ...
  %22 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %21, <2 x double> %13, <2 x double> %18)
  store <2 x double> %22, ptr %15, align 16, !tbaa !5
  %23 = add nuw i64 %7, 2
  %24 = icmp eq i64 %23, 31998
  br i1 %24, label %50, label %6, !llvm.loop !367

25:                                               ; preds = %50, %0
  %26 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.139, double noundef 0.000000e+00)
  br label %27
...
50:                                               ; preds = %6
  %51 = load double, ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 31998), align 16, !tbaa !5
  %52 = load double, ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 31998), align 16, !tbaa !5
  %53 = load double, ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 31998), align 16, !tbaa !5
  %54 = tail call double @llvm.fmuladd.f64(double %52, double %53, double %51)
  %55 = load double, ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 11, i64 31998), align 16, !tbaa !5
  %56 = tail call double @llvm.fmuladd.f64(double %53, double %55, double %54)
  store double %56, ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 31998), align 16, !tbaa !5
  %57 = load double, ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 0, i64 31999), align 8, !tbaa !5
  %58 = tail call double @llvm.fmuladd.f64(double %57, double %53, double %56)
  store double %58, ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 0, i64 31998), align 16, !tbaa !5
...
define dso_local i32 @s244() local_unnamed_addr #7 {
  %1 = tail call i32 @init(ptr noundef nonnull @.str.43)
  %2 = load i32, ptr @ntimes, align 4, !tbaa !17
  %3 = icmp sgt i32 %2, 0
  br i1 %3, label %4, label %6
...
36:                                               ; preds = %4, %36
  %37 = phi i64 [ 0, %4 ], [ %44, %36 ]
  %38 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %37
  %39 = load double, ptr %38, align 8, !tbaa !5
  %40 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 %37
  %41 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 %37
  %42 = load double, ptr %41, align 8, !tbaa !5
  %43 = getelementptr inbounds double, ptr @global_data, i64 %37
  %44 = add nuw nsw i64 %37, 1
  %45 = getelementptr inbounds double, ptr @global_data, i64 %44
  %46 = load double, ptr %40, align 8, !tbaa !5
  %47 = fadd double %39, %46
  store double %47, ptr %38, align 8, !tbaa !5
  %48 = load double, ptr %45, align 8, !tbaa !5
  ...
  %54 = insertelement <2 x double> %53, double %47, i64 1
  %55 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %50, <2 x double> %52, <2 x double> %54)
  store <2 x double> %55, ptr %43, align 8, !tbaa !5
  %56 = icmp eq i64 %44, 31999
...
36:                                               ; preds = %4, %36
  ...
  %50 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 %37
  store double %49, ptr %50, align 8, !tbaa !5
  %51 = icmp eq i64 %46, 31999
  br i1 %51, label %31, label %36
}
...
6:                                                ; preds = %6, %4
  ...
  %13 = or i64 %7, 1
  %14 = getelementptr inbounds double, ptr @global_data, i64 %13
  store <2 x double> %12, ptr %14, align 8, !tbaa !5
  %15 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 %7
  %16 = load <2 x double>, ptr %15, align 16, !tbaa !5
  %17 = fadd <2 x double> %9, %16
  %18 = getelementptr inbounds double, ptr @global_data, i64 %7
  store <2 x double> %17, ptr %18, align 16, !tbaa !5
  %19 = add nuw i64 %7, 2
  %20 = icmp eq i64 %19, 31998
  br i1 %20, label %46, label %6, !llvm.loop !368

21:                                               ; preds = %46, %0
  %22 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.142, double noundef 0.000000e+00)
  br label %23

23:                                               ; preds = %23, %21
  %24 = phi i64 [ 0, %21 ], [ %40, %23 ]
  %25 = phi double [ 0.000000e+00, %21 ], [ %39, %23 ]
  %26 = phi double [ 0.000000e+00, %21 ], [ %36, %23 ]
  %27 = getelementptr inbounds double, ptr @global_data, i64 %24
  %28 = load double, ptr %27, align 16, !tbaa !5
  %29 = fadd double %26, %28
  %30 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %24
  ...
  %35 = load double, ptr %34, align 8, !tbaa !5
  %36 = fadd double %29, %35
  %37 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %33
...
42:                                               ; preds = %23
  ...
  %45 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %43, double noundef %44)
  ret i32 0

46:                                               ; preds = %6
  %47 = load double, ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 31998), align 16, !tbaa !5
  %48 = load double, ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 11, i64 31998), align 16, !tbaa !5
  %49 = load double, ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 31998), align 16, !tbaa !5
  %50 = insertelement <2 x double> poison, double %47, i64 0
  %51 = shufflevector <2 x double> %50, <2 x double> poison, <2 x i32> zeroinitializer
  %52 = insertelement <2 x double> poison, double %49, i64 0
  %53 = insertelement <2 x double> %52, double %48, i64 1
  %54 = fadd <2 x double> %51, %53
  store <2 x double> %54, ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 0, i64 31998), align 16, !tbaa !5
...
23:                                               ; preds = %8, %18, %11
  ...
  %26 = call i32 @s241()
  %27 = load double, ptr %4, align 8, !tbaa !5
  %28 = load double, ptr %5, align 8, !tbaa !5
  %29 = call i32 @s242(double noundef %27, double noundef %28)
  %30 = call i32 @s243()
  %31 = call i32 @s244()
  %32 = call i32 @s1244()
  %33 = call i32 @s2244()
