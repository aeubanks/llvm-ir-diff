...
for.body4:                                        ; preds = %for.cond1.preheader, %for.body4
  ...
  %mul10 = fmul double %mul7, %9
  %arrayidx12 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv
  store double %mul10, ptr %arrayidx12, align 8, !tbaa !5
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %arrayidx16 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv.next
  %10 = load double, ptr %arrayidx16, align 8, !tbaa !5
  %mul17 = fmul double %mul10, %10
  %mul20 = fmul double %9, %mul17
  store double %mul20, ptr %arrayidx, align 8, !tbaa !5
...
; Function Attrs: nounwind uwtable
define dso_local i32 @s242(double noundef %s1, double noundef %s2) local_unnamed_addr #7 {
entry:
  %call = tail call i32 @init(ptr noundef nonnull @.str.41)
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
  %cmp33 = icmp sgt i32 %0, 4
  br i1 %cmp33, label %for.cond1.preheader, label %for.cond.cleanup

for.cond1.preheader:                              ; preds = %entry, %for.cond.cleanup3
  %nl.034 = phi i32 [ %inc19, %for.cond.cleanup3 ], [ 0, %entry ]
...
for.cond.cleanup3:                                ; preds = %for.body4
  ...
  %inc19 = add nuw nsw i32 %nl.034, 1
  %7 = load i32, ptr @ntimes, align 4, !tbaa !17
  %div = sdiv i32 %7, 5
  %cmp = icmp slt i32 %inc19, %div
  br i1 %cmp, label %for.cond1.preheader, label %for.cond.cleanup

for.body4:                                        ; preds = %for.cond1.preheader, %for.body4
  %8 = phi double [ %.pre, %for.cond1.preheader ], [ %add14, %for.body4 ]
  %indvars.iv = phi i64 [ 1, %for.cond1.preheader ], [ %indvars.iv.next, %for.body4 ]
  %add = fadd double %8, %s1
  %add5 = fadd double %add, %s2
  ...
  %add14 = fadd double %11, %add11
  %arrayidx16 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv
  store double %add14, ptr %arrayidx16, align 8, !tbaa !5
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, 32000
  br i1 %exitcond.not, label %for.cond.cleanup3, label %for.body4
}
...
entry:
  %call = tail call i32 @init(ptr noundef nonnull @.str.42)
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
  %cmp47 = icmp sgt i32 %0, 0
  br i1 %cmp47, label %vector.ph, label %for.cond.cleanup

vector.ph:                                        ; preds = %entry, %for.body4
  %nl.048 = phi i32 [ %inc29, %for.body4 ], [ 0, %entry ]
  br label %vector.body
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %3 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 %index
  %wide.load51 = load <2 x double>, ptr %3, align 16, !tbaa !5
  %4 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %wide.load50, <2 x double> %wide.load51, <2 x double> %wide.load)
  ...
  %7 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %wide.load51, <2 x double> %wide.load52, <2 x double> %4)
  ...
  %10 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %wide.load53, <2 x double> %wide.load51, <2 x double> %7)
  store <2 x double> %10, ptr %5, align 16, !tbaa !5
  %index.next = add nuw i64 %index, 2
  %11 = icmp eq i64 %index.next, 31998
  br i1 %11, label %for.body4, label %vector.body, !llvm.loop !367
...
for.body.i:                                       ; preds = %for.body.i, %for.cond.cleanup
  ...
  %indvars.iv.next.i = or i64 %indvars.iv.i, 1
  %arrayidx.i.1 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv.next.i
  %14 = load double, ptr %arrayidx.i.1, align 8, !tbaa !5
  %add.i.1 = fadd double %add.i, %14
  %arrayidx2.i.1 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %indvars.iv.next.i
  %15 = load double, ptr %arrayidx2.i.1, align 8, !tbaa !5
  %add3.i.1 = fadd double %add3.i, %15
  %indvars.iv.next.i.1 = add nuw nsw i64 %indvars.iv.i, 2
  %exitcond.not.i.1 = icmp eq i64 %indvars.iv.next.i.1, 32000
  br i1 %exitcond.not.i.1, label %for.cond18.preheader.i.preheader, label %for.body.i
...
for.cond18.preheader.i.preheader:                 ; preds = %for.body.i
  %16 = load i32, ptr @digits, align 4, !tbaa !17
  %add89.i = fadd double %add.i.1, %add3.i.1
  %call90.i = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %16, double noundef %add89.i)
  ret i32 0

for.body4:                                        ; preds = %vector.body
  %17 = load double, ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 31998), align 16, !tbaa !5
  %18 = load double, ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 31998), align 16, !tbaa !5
  %19 = load double, ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 31998), align 16, !tbaa !5
  %20 = tail call double @llvm.fmuladd.f64(double %18, double %19, double %17)
  %21 = load double, ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 11, i64 31998), align 16, !tbaa !5
  %22 = tail call double @llvm.fmuladd.f64(double %19, double %21, double %20)
  store double %22, ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 31998), align 16, !tbaa !5
  %23 = load double, ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 0, i64 31999), align 8, !tbaa !5
  %24 = tail call double @llvm.fmuladd.f64(double %23, double %19, double %22)
  store double %24, ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 0, i64 31998), align 16, !tbaa !5
  ...
  %inc29 = add nuw nsw i32 %nl.048, 1
  %25 = load i32, ptr @ntimes, align 4, !tbaa !17
  %cmp = icmp slt i32 %inc29, %25
...
entry:
  %call = tail call i32 @init(ptr noundef nonnull @.str.43)
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
  %cmp46 = icmp sgt i32 %0, 0
  br i1 %cmp46, label %for.cond1.preheader, label %for.cond.cleanup

for.cond1.preheader:                              ; preds = %entry, %for.cond.cleanup3
  %nl.047 = phi i32 [ %inc29, %for.cond.cleanup3 ], [ 0, %entry ]
  br label %for.body4

for.cond.cleanup:                                 ; preds = %for.cond.cleanup3, %entry
  %call31 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.140, double noundef 0.000000e+00)
  br label %for.body.i
...
for.cond.cleanup3:                                ; preds = %for.body4
  %call27 = tail call i32 @dummy(ptr noundef nonnull @global_data, ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 11, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 20, i64 0, i64 0), double noundef 0.000000e+00) #16
  %inc29 = add nuw nsw i32 %nl.047, 1
  %6 = load i32, ptr @ntimes, align 4, !tbaa !17
...
for.body4:                                        ; preds = %for.cond1.preheader, %for.body4
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %arrayidx21 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv.next
  ...
  %16 = insertelement <2 x double> %15, double %add, i64 1
  %17 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %12, <2 x double> %14, <2 x double> %16)
  store <2 x double> %17, ptr %arrayidx10, align 8, !tbaa !5
  %exitcond.not = icmp eq i64 %indvars.iv.next, 31999
  br i1 %exitcond.not, label %for.cond.cleanup3, label %for.body4
}
...
for.cond1.preheader:                              ; preds = %entry, %for.cond.cleanup3
  %nl.044 = phi i32 [ %inc27, %for.cond.cleanup3 ], [ 0, %entry ]
  br label %for.body4

for.cond.cleanup:                                 ; preds = %for.cond.cleanup3, %entry
  %call29 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.141, double noundef 0.000000e+00)
  br label %for.body.i
...
for.cond.cleanup3:                                ; preds = %for.body4
  ...
  %inc27 = add nuw nsw i32 %nl.044, 1
  %6 = load i32, ptr @ntimes, align 4, !tbaa !17
...
for.body4:                                        ; preds = %for.cond1.preheader, %for.body4
  ...
  %arrayidx16 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv
  store double %add, ptr %arrayidx16, align 8, !tbaa !5
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %arrayidx21 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv.next
  %11 = load double, ptr %arrayidx21, align 8, !tbaa !5
  %add22 = fadd double %11, %add
  %arrayidx24 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 %indvars.iv
...
entry:
  ...
  br i1 %cmp31, label %vector.ph, label %for.cond.cleanup

vector.ph:                                        ; preds = %entry, %for.body4
  %nl.032 = phi i32 [ %inc19, %for.body4 ], [ 0, %entry ]
  br label %vector.body
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load34 = load <2 x double>, ptr %2, align 16, !tbaa !5
  %3 = fadd <2 x double> %wide.load, %wide.load34
  %4 = or i64 %index, 1
  %5 = getelementptr inbounds double, ptr @global_data, i64 %4
  store <2 x double> %3, ptr %5, align 8, !tbaa !5
  %6 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 %index
  %wide.load35 = load <2 x double>, ptr %6, align 16, !tbaa !5
  %7 = fadd <2 x double> %wide.load, %wide.load35
  %8 = getelementptr inbounds double, ptr @global_data, i64 %index
  store <2 x double> %7, ptr %8, align 16, !tbaa !5
  %index.next = add nuw i64 %index, 2
  %9 = icmp eq i64 %index.next, 31998
  br i1 %9, label %for.body4, label %vector.body, !llvm.loop !368

for.cond.cleanup:                                 ; preds = %for.body4, %entry
  %call21 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.142, double noundef 0.000000e+00)
  br label %for.body.i
...
for.body4:                                        ; preds = %vector.body
  %15 = load double, ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 31998), align 16, !tbaa !5
  %16 = load double, ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 11, i64 31998), align 16, !tbaa !5
  %17 = load double, ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 31998), align 16, !tbaa !5
  ...
  store <2 x double> %22, ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 0, i64 31998), align 16, !tbaa !5
  %call17 = tail call i32 @dummy(ptr noundef nonnull @global_data, ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 11, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 20, i64 0, i64 0), double noundef 0.000000e+00) #16
  %inc19 = add nuw nsw i32 %nl.032, 1
  %23 = load i32, ptr @ntimes, align 4, !tbaa !17
  %cmp = icmp slt i32 %inc19, %23
  br i1 %cmp, label %vector.ph, label %for.cond.cleanup
}
...
if.end.thread:                                    ; preds = %entry
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
  %call219 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.144, i32 noundef %0)
  br label %if.end7
...
if.then4:                                         ; preds = %if.end
  ...
  %call.i17 = call i64 @strtol(ptr nocapture noundef nonnull %2, ptr noundef null, i32 noundef 10) #16
  %conv.i18 = trunc i64 %call.i17 to i32
  store i32 %conv.i18, ptr @digits, align 4, !tbaa !17
  br label %if.end7
...
if.end7:                                          ; preds = %if.end.thread, %if.then4, %if.end
  ...
  %5 = load double, ptr %s2, align 8, !tbaa !5
  %call10 = call i32 @s242(double noundef %4, double noundef %5)
