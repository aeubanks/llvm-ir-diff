...
define dso_local i32 @main(i32 noundef %0, ptr noundef %1) local_unnamed_addr #0 {
  ...
  call void @llvm.lifetime.start.p0(i64 16384, ptr nonnull %3) #6
  call void @llvm.lifetime.start.p0(i64 4608, ptr nonnull %4) #6
  call void @llvm.lifetime.start.p0(i64 280, ptr nonnull %5) #6
  call void @lame_init(ptr noundef nonnull %5) #6
  %6 = icmp eq i32 %0, 1
  br i1 %6, label %7, label %9

7:                                                ; preds = %2
  %8 = load ptr, ptr %1, align 8, !tbaa !5
  call void @lame_usage(ptr noundef nonnull %5, ptr noundef %8) #6
  br label %9

9:                                                ; preds = %7, %2
  call void @lame_parse_args(ptr noundef nonnull %5, i32 noundef %0, ptr noundef %1) #6
...
13:                                               ; preds = %9
  ...
  %16 = call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %15, ptr noundef nonnull dereferenceable(2) @.str) #7
  %17 = icmp eq i32 %16, 0
...
20:                                               ; preds = %13
  %21 = call noalias ptr @fopen(ptr noundef %15, ptr noundef nonnull @.str.1)
...
23:                                               ; preds = %20
  ...
  %26 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %24, ptr noundef nonnull @.str.2, ptr noundef %25) #8
  call void @exit(i32 noundef 1) #9
  unreachable

27:                                               ; preds = %18, %20, %9
  %28 = phi ptr [ undef, %9 ], [ %21, %20 ], [ %19, %18 ]
  call void @lame_init_infile(ptr noundef nonnull %5) #6
  call void @lame_init_params(ptr noundef nonnull %5) #6
  call void @lame_print_config(ptr noundef nonnull %5) #6
  %29 = getelementptr inbounds [2 x [1152 x i16]], ptr %4, i64 0, i64 1
  br label %30

30:                                               ; preds = %44, %27
  %31 = call i32 @lame_readframe(ptr noundef nonnull %5, ptr noundef nonnull %4) #6
  %32 = call i32 @lame_encode_buffer(ptr noundef nonnull %5, ptr noundef nonnull %4, ptr noundef nonnull %29, i32 noundef %31, ptr noundef nonnull %3, i32 noundef 16384) #6
  %33 = icmp eq i32 %32, -1
  br i1 %33, label %34, label %37

34:                                               ; preds = %30
  %35 = load ptr, ptr @stderr, align 8, !tbaa !5
  %36 = call i64 @fwrite(ptr nonnull @.str.3, i64 33, i64 1, ptr %35) #8
  call void @exit(i32 noundef 1) #9
  unreachable

37:                                               ; preds = %30
  %38 = sext i32 %32 to i64
  %39 = call i64 @fwrite(ptr noundef nonnull %3, i64 noundef 1, i64 noundef %38, ptr noundef %28)
  %40 = icmp eq i64 %39, %38
  br i1 %40, label %44, label %41

41:                                               ; preds = %37
  %42 = load ptr, ptr @stderr, align 8, !tbaa !5
  %43 = call i64 @fwrite(ptr nonnull @.str.4, i64 24, i64 1, ptr %42) #8
  call void @exit(i32 noundef 1) #9
  unreachable
...
46:                                               ; preds = %44
  %47 = call i32 @lame_encode_finish(ptr noundef nonnull %5, ptr noundef nonnull %3, i32 noundef 16384) #6
  %48 = sext i32 %47 to i64
  %49 = call i64 @fwrite(ptr noundef nonnull %3, i64 noundef 1, i64 noundef %48, ptr noundef %28)
  %50 = call i32 @fclose(ptr noundef %28)
  call void @lame_close_infile(ptr noundef nonnull %5) #6
  call void @lame_mp3_tags(ptr noundef nonnull %5) #6
  call void @llvm.lifetime.end.p0(i64 280, ptr nonnull %5) #6
  call void @llvm.lifetime.end.p0(i64 4608, ptr nonnull %4) #6
  call void @llvm.lifetime.end.p0(i64 16384, ptr nonnull %3) #6
  ret i32 0
}
