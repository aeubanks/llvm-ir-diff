...
define dso_local noalias ptr @AllocPPS() local_unnamed_addr #0 {
  %1 = tail call noalias dereferenceable_or_null(240) ptr @calloc(i64 noundef 240, i64 noundef 1) #6
...
define dso_local noalias ptr @AllocSPS() local_unnamed_addr #0 {
  %1 = tail call noalias dereferenceable_or_null(2132) ptr @calloc(i64 noundef 2132, i64 noundef 1) #6
  %2 = icmp eq ptr %1, null
  br i1 %2, label %3, label %4
...
define dso_local void @FreePPS(ptr nocapture noundef %0) local_unnamed_addr #3 {
  %2 = getelementptr inbounds %struct.pic_parameter_set_rbsp_t, ptr %0, i64 0, i32 16
