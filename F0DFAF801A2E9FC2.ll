...
"produce f5":                                     ; preds = %"assert succeeded77"
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 32 dereferenceable(64) %"inv_X4$7.031", ptr noundef nonnull align 4 dereferenceable(64) %scevgep364, i64 64, i1 false)
  %scevgep363.1 = getelementptr inbounds i8, ptr %"inv_X4$7.031", i64 64
  %278 = add i64 %276, %277
  ...
  %scevgep363.2 = getelementptr inbounds i8, ptr %"inv_X4$7.031", i64 128
  ...
  %scevgep363.3 = getelementptr inbounds i8, ptr %"inv_X4$7.031", i64 192
  ...
  %scevgep363.4 = getelementptr inbounds i8, ptr %"inv_X4$7.031", i64 256
  ...
  %scevgep363.5 = getelementptr inbounds i8, ptr %"inv_X4$7.031", i64 320
  ...
  %scevgep363.6 = getelementptr inbounds i8, ptr %"inv_X4$7.031", i64 384
  ...
  %scevgep363.7 = getelementptr inbounds i8, ptr %"inv_X4$7.031", i64 448
  ...
  %scevgep363.8 = getelementptr inbounds i8, ptr %"inv_X4$7.031", i64 512
  ...
  %scevgep363.9 = getelementptr inbounds i8, ptr %"inv_X4$7.031", i64 576
  ...
  %scevgep363.10 = getelementptr inbounds i8, ptr %"inv_X4$7.031", i64 640
  ...
  %scevgep363.11 = getelementptr inbounds i8, ptr %"inv_X4$7.031", i64 704
  ...
  %scevgep363.12 = getelementptr inbounds i8, ptr %"inv_X4$7.031", i64 768
  ...
  %scevgep363.13 = getelementptr inbounds i8, ptr %"inv_X4$7.031", i64 832
  ...
  %scevgep363.14 = getelementptr inbounds i8, ptr %"inv_X4$7.031", i64 896
  ...
  %scevgep363.15 = getelementptr inbounds i8, ptr %"inv_X4$7.031", i64 960
...
"for kernel_fft1_S4_R4_n1$1.s1.n0.g":             ; preds = %"for kernel_fft1_S4_R4_n1$1.s1.n0.g.preheader", %"end for kernel_fft1_S4_R4_n1$1.s1.r13639$y"
  %.not50 = phi i1 [ true, %"end for kernel_fft1_S4_R4_n1$1.s1.r13639$y" ], [ false, %"for kernel_fft1_S4_R4_n1$1.s1.n0.g.preheader" ]
...
"for kernel_fft1_S4_R4_n1$1.s1.r13639$y":         ; preds = %"for kernel_fft1_S4_R4_n1$1.s1.n0.g", %"for kernel_fft1_S4_R4_n1$1.s1.r13639$y"
  %indvars.iv372 = phi i64 [ 0, %"for kernel_fft1_S4_R4_n1$1.s1.n0.g" ], [ %indvars.iv.next373, %"for kernel_fft1_S4_R4_n1$1.s1.r13639$y" ]
  ...
  %579 = getelementptr inbounds float, ptr %f4.037, i64 %indvars.iv372
  ...
  %586 = getelementptr inbounds float, ptr %f4.136, i64 %indvars.iv372
  ...
  br i1 %.not49, label %"end for kernel_fft1_S4_R4_n1$1.s1.r13639$y", label %"for kernel_fft1_S4_R4_n1$1.s1.r13639$y"
...
"for result$1.s0.i.preheader":                    ; preds = %"produce result$1"
  ...
  %a25 = lshr i32 %64, 3
  %.not324 = icmp ult i32 %64, 8
  %680 = add nsw i32 %64, 7
  %681 = ashr i32 %680, 3
  %682 = icmp slt i32 %a25, %681
  %683 = sext i32 %62 to i64
  %684 = sext i32 %68 to i64
  %685 = sext i32 %74 to i64
  %686 = add nsw i64 %220, %683
  %687 = add nsw i64 %686, -8
  %688 = add nsw i64 %220, -8
  %689 = zext i32 %a25 to i64
  %690 = getelementptr inbounds float, ptr %"inv_exchange_S1_R4_n1$1.019", i64 8
  %691 = getelementptr inbounds float, ptr %"inv_exchange_S1_R4_n1$1.118", i64 8
  %692 = getelementptr inbounds float, ptr %"inv_exchange_S1_R4_n1$1.019", i64 16
  %693 = getelementptr inbounds float, ptr %"inv_exchange_S1_R4_n1$1.118", i64 16
  %694 = getelementptr inbounds float, ptr %"inv_exchange_S1_R4_n1$1.019", i64 24
  %695 = getelementptr inbounds float, ptr %"inv_exchange_S1_R4_n1$1.118", i64 24
  %696 = getelementptr inbounds float, ptr %"inv_exchange_S1_R4_n1$1.019", i64 32
  %697 = getelementptr inbounds float, ptr %"inv_exchange_S1_R4_n1$1.118", i64 32
  %698 = getelementptr inbounds float, ptr %"inv_exchange_S1_R4_n1$1.019", i64 40
  %699 = getelementptr inbounds float, ptr %"inv_exchange_S1_R4_n1$1.118", i64 40
  %700 = getelementptr inbounds float, ptr %"inv_exchange_S1_R4_n1$1.019", i64 48
  %701 = getelementptr inbounds float, ptr %"inv_exchange_S1_R4_n1$1.118", i64 48
  %702 = getelementptr inbounds float, ptr %"inv_exchange_S1_R4_n1$1.019", i64 56
  %703 = getelementptr inbounds float, ptr %"inv_exchange_S1_R4_n1$1.118", i64 56
  %704 = getelementptr inbounds float, ptr %"inv_exchange_S1_R4_n1$1.019", i64 64
  %705 = getelementptr inbounds float, ptr %"inv_exchange_S1_R4_n1$1.118", i64 64
  %706 = getelementptr inbounds float, ptr %"inv_exchange_S1_R4_n1$1.019", i64 72
  %707 = getelementptr inbounds float, ptr %"inv_exchange_S1_R4_n1$1.118", i64 72
  %708 = getelementptr inbounds float, ptr %"inv_exchange_S1_R4_n1$1.019", i64 80
  %709 = getelementptr inbounds float, ptr %"inv_exchange_S1_R4_n1$1.118", i64 80
  %710 = getelementptr inbounds float, ptr %"inv_exchange_S1_R4_n1$1.019", i64 88
  %711 = getelementptr inbounds float, ptr %"inv_exchange_S1_R4_n1$1.118", i64 88
  %712 = getelementptr inbounds float, ptr %"inv_exchange_S1_R4_n1$1.019", i64 96
  %713 = getelementptr inbounds float, ptr %"inv_exchange_S1_R4_n1$1.118", i64 96
  %714 = getelementptr inbounds float, ptr %"inv_exchange_S1_R4_n1$1.019", i64 104
  %715 = getelementptr inbounds float, ptr %"inv_exchange_S1_R4_n1$1.118", i64 104
  %716 = getelementptr inbounds float, ptr %"inv_exchange_S1_R4_n1$1.019", i64 112
  %717 = getelementptr inbounds float, ptr %"inv_exchange_S1_R4_n1$1.118", i64 112
  %718 = getelementptr inbounds float, ptr %"inv_exchange_S1_R4_n1$1.019", i64 120
  %719 = getelementptr inbounds float, ptr %"inv_exchange_S1_R4_n1$1.118", i64 120
  %720 = getelementptr inbounds float, ptr %"inv_exchange_S1_R4_n1$1.019", i64 8
  %721 = getelementptr inbounds float, ptr %"inv_exchange_S1_R4_n1$1.118", i64 8
  %722 = getelementptr inbounds float, ptr %"inv_exchange_S1_R4_n1$1.019", i64 16
  %723 = getelementptr inbounds float, ptr %"inv_exchange_S1_R4_n1$1.118", i64 16
  %724 = getelementptr inbounds float, ptr %"inv_exchange_S1_R4_n1$1.019", i64 24
  %725 = getelementptr inbounds float, ptr %"inv_exchange_S1_R4_n1$1.118", i64 24
  %726 = getelementptr inbounds float, ptr %"inv_exchange_S1_R4_n1$1.019", i64 32
  %727 = getelementptr inbounds float, ptr %"inv_exchange_S1_R4_n1$1.118", i64 32
  %728 = getelementptr inbounds float, ptr %"inv_exchange_S1_R4_n1$1.019", i64 40
  %729 = getelementptr inbounds float, ptr %"inv_exchange_S1_R4_n1$1.118", i64 40
  %730 = getelementptr inbounds float, ptr %"inv_exchange_S1_R4_n1$1.019", i64 48
  %731 = getelementptr inbounds float, ptr %"inv_exchange_S1_R4_n1$1.118", i64 48
  %732 = getelementptr inbounds float, ptr %"inv_exchange_S1_R4_n1$1.019", i64 56
  %733 = getelementptr inbounds float, ptr %"inv_exchange_S1_R4_n1$1.118", i64 56
  %734 = getelementptr inbounds float, ptr %"inv_exchange_S1_R4_n1$1.019", i64 64
  %735 = getelementptr inbounds float, ptr %"inv_exchange_S1_R4_n1$1.118", i64 64
  %736 = getelementptr inbounds float, ptr %"inv_exchange_S1_R4_n1$1.019", i64 72
  %737 = getelementptr inbounds float, ptr %"inv_exchange_S1_R4_n1$1.118", i64 72
  %738 = getelementptr inbounds float, ptr %"inv_exchange_S1_R4_n1$1.019", i64 80
  %739 = getelementptr inbounds float, ptr %"inv_exchange_S1_R4_n1$1.118", i64 80
  %740 = getelementptr inbounds float, ptr %"inv_exchange_S1_R4_n1$1.019", i64 88
  %741 = getelementptr inbounds float, ptr %"inv_exchange_S1_R4_n1$1.118", i64 88
  %742 = getelementptr inbounds float, ptr %"inv_exchange_S1_R4_n1$1.019", i64 96
  %743 = getelementptr inbounds float, ptr %"inv_exchange_S1_R4_n1$1.118", i64 96
  %744 = getelementptr inbounds float, ptr %"inv_exchange_S1_R4_n1$1.019", i64 104
  %745 = getelementptr inbounds float, ptr %"inv_exchange_S1_R4_n1$1.118", i64 104
  %746 = getelementptr inbounds float, ptr %"inv_exchange_S1_R4_n1$1.019", i64 112
  %747 = getelementptr inbounds float, ptr %"inv_exchange_S1_R4_n1$1.118", i64 112
  %748 = getelementptr inbounds float, ptr %"inv_exchange_S1_R4_n1$1.019", i64 120
  %749 = getelementptr inbounds float, ptr %"inv_exchange_S1_R4_n1$1.118", i64 120
  %xtraiter = and i64 %689, 1
  %750 = icmp eq i32 %a25, 1
  %unroll_iter = and i64 %689, 536870910
  %lcmp.mod.not = icmp eq i64 %xtraiter, 0
  br label %"for result$1.s0.i"

"for result$1.s0.i":                              ; preds = %"for result$1.s0.i.preheader", %"end for result$1.s0.n1"
  %indvars.iv401 = phi i64 [ %685, %"for result$1.s0.i.preheader" ], [ %indvars.iv.next402, %"end for result$1.s0.n1" ]
  %751 = trunc i64 %indvars.iv401 to i32
  %reass.add73 = sub i32 %751, %26
  %reass.mul74 = mul i32 %reass.add73, %30
  %752 = sub i32 %reass.mul74, %14
  %753 = load <4 x float>, ptr %f3.039, align 32
  %754 = load <4 x float>, ptr %f3.138, align 32
  %755 = load <4 x float>, ptr %261, align 16, !tbaa !84
  %756 = shufflevector <4 x float> %753, <4 x float> %755, <4 x i32> <i32 0, i32 2, i32 4, i32 6>
  %757 = load <4 x float>, ptr %262, align 16, !tbaa !86
  %758 = shufflevector <4 x float> %754, <4 x float> %757, <4 x i32> <i32 0, i32 2, i32 4, i32 6>
  %759 = extractelement <4 x float> %753, i64 3
  %760 = insertelement <4 x float> %753, float %759, i64 1
  %761 = extractelement <4 x float> %755, i64 2
  %762 = insertelement <4 x float> %760, float %761, i64 2
  %763 = load float, ptr %265, align 4, !tbaa !144
  %764 = insertelement <4 x float> %762, float %763, i64 3
  %765 = extractelement <4 x float> %754, i64 3
  %766 = insertelement <4 x float> %754, float %765, i64 1
  %767 = extractelement <4 x float> %757, i64 2
  %768 = insertelement <4 x float> %766, float %767, i64 2
  %769 = load float, ptr %266, align 4, !tbaa !145
  %770 = insertelement <4 x float> %768, float %769, i64 3
...
"for fwd_fft0_S4_R4_n0$1.s1.n1":                  ; preds = %"for result$1.s0.i", %"for fwd_fft0_S4_R4_n0$1.s1.n1"
  %indvars.iv375 = phi i64 [ 0, %"for result$1.s0.i" ], [ %indvars.iv.next376, %"for fwd_fft0_S4_R4_n0$1.s1.n1" ]
  %771 = trunc i64 %indvars.iv375 to i32
  %reass.add75 = sub i32 %771, %20
  %reass.mul76 = mul i32 %reass.add75, %24
  %t1933 = add i32 %752, %reass.mul76
  %772 = sext i32 %t1933 to i64
  %773 = getelementptr inbounds float, ptr %5, i64 %772
  %774 = load <4 x float>, ptr %773, align 4, !tbaa !146
  %775 = add nsw i64 %772, 8
  %776 = getelementptr inbounds float, ptr %5, i64 %775
  %777 = load <4 x float>, ptr %776, align 4, !tbaa !146
  %778 = fadd <4 x float> %774, %777
  %779 = add nsw i64 %772, 4
  %780 = getelementptr inbounds float, ptr %5, i64 %779
  %781 = load <4 x float>, ptr %780, align 4, !tbaa !146
  %782 = add nsw i64 %772, 12
  %783 = getelementptr inbounds float, ptr %5, i64 %782
  %784 = load <4 x float>, ptr %783, align 4, !tbaa !146
  %785 = fadd <4 x float> %781, %784
  %786 = fadd <4 x float> %778, %785
  %787 = fsub <4 x float> %778, %785
  %788 = fsub <4 x float> %774, %777
  %789 = fsub <4 x float> %784, %781
  %790 = fadd <4 x float> %788, zeroinitializer
  %791 = fadd <4 x float> %789, zeroinitializer
  %792 = fsub <4 x float> zeroinitializer, %789
  %793 = shufflevector <4 x float> %786, <4 x float> %787, <8 x i32> <i32 0, i32 4, i32 1, i32 5, i32 2, i32 6, i32 3, i32 7>
  %794 = shufflevector <4 x float> %790, <4 x float> %788, <8 x i32> <i32 0, i32 4, i32 1, i32 5, i32 2, i32 6, i32 3, i32 7>
  %795 = shufflevector <8 x float> %793, <8 x float> %794, <16 x i32> <i32 0, i32 8, i32 1, i32 9, i32 2, i32 10, i32 3, i32 11, i32 4, i32 12, i32 5, i32 13, i32 6, i32 14, i32 7, i32 15>
  %796 = shufflevector <16 x float> %795, <16 x float> undef, <8 x i32> <i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %797 = shufflevector <4 x float> %791, <4 x float> %792, <8 x i32> <i32 0, i32 4, i32 1, i32 5, i32 2, i32 6, i32 3, i32 7>
  ...
  %799 = shufflevector <16 x float> %798, <16 x float> undef, <8 x i32> <i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %"v_inv_fft0_S4_R4_n0$1.029.sroa.0.0.vec.extract425" = shufflevector <16 x float> %795, <16 x float> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %"v_inv_fft0_S4_R4_n0$1.128.sroa.0.0.vec.extract437" = shufflevector <16 x float> %798, <16 x float> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %"v_inv_fft0_S4_R4_n0$1.029.sroa.0.16.vec.extract428" = shufflevector <16 x float> %795, <16 x float> undef, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
  %800 = fmul <4 x float> %"v_inv_fft0_S4_R4_n0$1.029.sroa.0.16.vec.extract428", %753
  %"v_inv_fft0_S4_R4_n0$1.128.sroa.0.16.vec.extract440" = shufflevector <16 x float> %798, <16 x float> undef, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
  %801 = fmul <4 x float> %"v_inv_fft0_S4_R4_n0$1.128.sroa.0.16.vec.extract440", %754
  %802 = fsub <4 x float> %800, %801
  %803 = fmul <4 x float> %"v_inv_fft0_S4_R4_n0$1.029.sroa.0.16.vec.extract428", %754
  %804 = fmul <4 x float> %753, %"v_inv_fft0_S4_R4_n0$1.128.sroa.0.16.vec.extract440"
  %805 = fadd <4 x float> %804, %803
  %"v_inv_fft0_S4_R4_n0$1.029.sroa.8.32.vec.extract431" = shufflevector <8 x float> %796, <8 x float> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %806 = fmul <4 x float> %"v_inv_fft0_S4_R4_n0$1.029.sroa.8.32.vec.extract431", %756
  %"v_inv_fft0_S4_R4_n0$1.128.sroa.8.32.vec.extract443" = shufflevector <8 x float> %799, <8 x float> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %807 = fmul <4 x float> %"v_inv_fft0_S4_R4_n0$1.128.sroa.8.32.vec.extract443", %758
  %808 = fsub <4 x float> %806, %807
  %809 = fmul <4 x float> %"v_inv_fft0_S4_R4_n0$1.029.sroa.8.32.vec.extract431", %758
  %810 = fmul <4 x float> %"v_inv_fft0_S4_R4_n0$1.128.sroa.8.32.vec.extract443", %756
  %811 = fadd <4 x float> %810, %809
  %"v_inv_fft0_S4_R4_n0$1.029.sroa.8.48.vec.extract434" = shufflevector <8 x float> %796, <8 x float> poison, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
  %812 = fmul <4 x float> %"v_inv_fft0_S4_R4_n0$1.029.sroa.8.48.vec.extract434", %764
  %"v_inv_fft0_S4_R4_n0$1.128.sroa.8.48.vec.extract446" = shufflevector <8 x float> %799, <8 x float> poison, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
  %813 = fmul <4 x float> %"v_inv_fft0_S4_R4_n0$1.128.sroa.8.48.vec.extract446", %770
  %814 = fsub <4 x float> %812, %813
  %815 = fmul <4 x float> %"v_inv_fft0_S4_R4_n0$1.029.sroa.8.48.vec.extract434", %770
  %816 = fmul <4 x float> %"v_inv_fft0_S4_R4_n0$1.128.sroa.8.48.vec.extract446", %764
  %817 = fadd <4 x float> %816, %815
  %818 = fadd <4 x float> %"v_inv_fft0_S4_R4_n0$1.029.sroa.0.0.vec.extract425", %808
  %819 = fadd <4 x float> %"v_inv_fft0_S4_R4_n0$1.128.sroa.0.0.vec.extract437", %811
  %820 = fadd <4 x float> %802, %814
  %821 = fadd <4 x float> %805, %817
  %822 = fadd <4 x float> %818, %820
  %823 = fadd <4 x float> %819, %821
  %824 = fsub <4 x float> %818, %820
  %825 = fsub <4 x float> %819, %821
  %826 = fsub <4 x float> %"v_inv_fft0_S4_R4_n0$1.029.sroa.0.0.vec.extract425", %808
  %827 = fsub <4 x float> %"v_inv_fft0_S4_R4_n0$1.128.sroa.0.0.vec.extract437", %811
  %828 = fsub <4 x float> %805, %817
  %829 = fsub <4 x float> %814, %802
  %830 = fadd <4 x float> %826, %828
  %831 = fadd <4 x float> %827, %829
  %832 = fsub <4 x float> %826, %828
  %833 = fsub <4 x float> %827, %829
  %834 = mul nuw nsw i64 %indvars.iv375, 24
  %835 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$1.033", i64 %834
  store <4 x float> %822, ptr %835, align 32, !tbaa !134
  %836 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$1.132", i64 %834
  store <4 x float> %823, ptr %836, align 32, !tbaa !136
  %837 = or i64 %834, 4
  %838 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$1.033", i64 %837
  store <4 x float> %830, ptr %838, align 16, !tbaa !134
  %839 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$1.132", i64 %837
  store <4 x float> %831, ptr %839, align 16, !tbaa !136
  %840 = add nuw nsw i64 %834, 8
  %841 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$1.033", i64 %840
  store <4 x float> %824, ptr %841, align 32, !tbaa !134
  %842 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$1.132", i64 %840
  store <4 x float> %825, ptr %842, align 32, !tbaa !136
  %843 = add nuw nsw i64 %834, 12
  %844 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$1.033", i64 %843
  store <4 x float> %832, ptr %844, align 16, !tbaa !134
  %845 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$1.132", i64 %843
  store <4 x float> %833, ptr %845, align 16, !tbaa !136
  %indvars.iv.next376 = add nuw nsw i64 %indvars.iv375, 1
  %.not51 = icmp eq i64 %indvars.iv.next376, 16
...
"for fwd_fft1_S4_R4_n1$1.s1.n0.g":                ; preds = %"for fwd_fft0_S4_R4_n0$1.s1.n1", %"end for fwd_fft1_S4_R4_n1$1.s1.r13593$y"
  %.not54 = phi i1 [ true, %"end for fwd_fft1_S4_R4_n1$1.s1.r13593$y" ], [ false, %"for fwd_fft0_S4_R4_n0$1.s1.n1" ]
  %"fwd_fft1_S4_R4_n1$1.s1.n0.g" = phi i64 [ 8, %"end for fwd_fft1_S4_R4_n1$1.s1.r13593$y" ], [ 0, %"for fwd_fft0_S4_R4_n0$1.s1.n1" ]
  %846 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$1.033", i64 %"fwd_fft1_S4_R4_n1$1.s1.n0.g"
  %847 = load <8 x float>, ptr %846, align 32, !tbaa !134
  %848 = or i64 %"fwd_fft1_S4_R4_n1$1.s1.n0.g", 192
  %849 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$1.033", i64 %848
  %850 = load <8 x float>, ptr %849, align 32, !tbaa !134
  %851 = fadd <8 x float> %847, %850
  %852 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$1.132", i64 %"fwd_fft1_S4_R4_n1$1.s1.n0.g"
  %853 = load <8 x float>, ptr %852, align 32, !tbaa !136
  %854 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$1.132", i64 %848
  %855 = load <8 x float>, ptr %854, align 32, !tbaa !136
  %856 = fadd <8 x float> %853, %855
  %857 = or i64 %"fwd_fft1_S4_R4_n1$1.s1.n0.g", 96
  %858 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$1.033", i64 %857
  %859 = load <8 x float>, ptr %858, align 32, !tbaa !134
  %860 = or i64 %"fwd_fft1_S4_R4_n1$1.s1.n0.g", 288
  %861 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$1.033", i64 %860
  %862 = load <8 x float>, ptr %861, align 32, !tbaa !134
  %863 = fadd <8 x float> %859, %862
  %864 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$1.132", i64 %857
  %865 = load <8 x float>, ptr %864, align 32, !tbaa !136
  %866 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$1.132", i64 %860
  %867 = load <8 x float>, ptr %866, align 32, !tbaa !136
  %868 = fadd <8 x float> %865, %867
  %869 = fadd <8 x float> %851, %863
  %870 = fadd <8 x float> %856, %868
  %871 = fsub <8 x float> %851, %863
  %872 = fsub <8 x float> %856, %868
  %873 = fsub <8 x float> %847, %850
  %874 = fsub <8 x float> %853, %855
  %875 = fsub <8 x float> %865, %867
  %876 = fsub <8 x float> %862, %859
  %877 = fadd <8 x float> %873, %875
  %878 = fadd <8 x float> %874, %876
  %879 = fsub <8 x float> %873, %875
  %880 = fsub <8 x float> %874, %876
  store <8 x float> %869, ptr %"inv_exchange_S1_R4_n1$1.019", align 32, !tbaa !148
  store <8 x float> %870, ptr %"inv_exchange_S1_R4_n1$1.118", align 32, !tbaa !150
  store <8 x float> %877, ptr %690, align 32, !tbaa !148
  store <8 x float> %878, ptr %691, align 32, !tbaa !150
  store <8 x float> %871, ptr %692, align 32, !tbaa !148
  store <8 x float> %872, ptr %693, align 32, !tbaa !150
  store <8 x float> %879, ptr %694, align 32, !tbaa !148
  store <8 x float> %880, ptr %695, align 32, !tbaa !150
  %881 = add nuw nsw i64 %"fwd_fft1_S4_R4_n1$1.s1.n0.g", 24
  %882 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$1.033", i64 %881
  %883 = load <8 x float>, ptr %882, align 32, !tbaa !134
  %884 = add nuw nsw i64 %"fwd_fft1_S4_R4_n1$1.s1.n0.g", 216
  %885 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$1.033", i64 %884
  %886 = load <8 x float>, ptr %885, align 32, !tbaa !134
  %887 = fadd <8 x float> %883, %886
  %888 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$1.132", i64 %881
  %889 = load <8 x float>, ptr %888, align 32, !tbaa !136
  %890 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$1.132", i64 %884
  %891 = load <8 x float>, ptr %890, align 32, !tbaa !136
  %892 = fadd <8 x float> %889, %891
  %893 = add nuw nsw i64 %"fwd_fft1_S4_R4_n1$1.s1.n0.g", 120
  %894 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$1.033", i64 %893
  %895 = load <8 x float>, ptr %894, align 32, !tbaa !134
  %896 = add nuw nsw i64 %"fwd_fft1_S4_R4_n1$1.s1.n0.g", 312
  %897 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$1.033", i64 %896
  %898 = load <8 x float>, ptr %897, align 32, !tbaa !134
  %899 = fadd <8 x float> %895, %898
  %900 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$1.132", i64 %893
  %901 = load <8 x float>, ptr %900, align 32, !tbaa !136
  %902 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$1.132", i64 %896
  %903 = load <8 x float>, ptr %902, align 32, !tbaa !136
  %904 = fadd <8 x float> %901, %903
  %905 = fadd <8 x float> %887, %899
  %906 = fadd <8 x float> %892, %904
  %907 = fsub <8 x float> %887, %899
  %908 = fsub <8 x float> %892, %904
  %909 = fsub <8 x float> %883, %886
  %910 = fsub <8 x float> %889, %891
  %911 = fsub <8 x float> %901, %903
  %912 = fsub <8 x float> %898, %895
  %913 = fadd <8 x float> %909, %911
  %914 = fadd <8 x float> %910, %912
  %915 = fsub <8 x float> %909, %911
  %916 = fsub <8 x float> %910, %912
  store <8 x float> %905, ptr %696, align 32, !tbaa !148
  store <8 x float> %906, ptr %697, align 32, !tbaa !150
  store <8 x float> %913, ptr %698, align 32, !tbaa !148
  store <8 x float> %914, ptr %699, align 32, !tbaa !150
  store <8 x float> %907, ptr %700, align 32, !tbaa !148
  store <8 x float> %908, ptr %701, align 32, !tbaa !150
  store <8 x float> %915, ptr %702, align 32, !tbaa !148
  store <8 x float> %916, ptr %703, align 32, !tbaa !150
  %917 = or i64 %"fwd_fft1_S4_R4_n1$1.s1.n0.g", 48
  %918 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$1.033", i64 %917
  %919 = load <8 x float>, ptr %918, align 32, !tbaa !134
  %920 = or i64 %"fwd_fft1_S4_R4_n1$1.s1.n0.g", 240
  %921 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$1.033", i64 %920
  %922 = load <8 x float>, ptr %921, align 32, !tbaa !134
  %923 = fadd <8 x float> %919, %922
  %924 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$1.132", i64 %917
  %925 = load <8 x float>, ptr %924, align 32, !tbaa !136
  %926 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$1.132", i64 %920
  %927 = load <8 x float>, ptr %926, align 32, !tbaa !136
  %928 = fadd <8 x float> %925, %927
  %929 = or i64 %"fwd_fft1_S4_R4_n1$1.s1.n0.g", 144
  %930 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$1.033", i64 %929
  %931 = load <8 x float>, ptr %930, align 32, !tbaa !134
  %932 = or i64 %"fwd_fft1_S4_R4_n1$1.s1.n0.g", 336
  %933 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$1.033", i64 %932
  %934 = load <8 x float>, ptr %933, align 32, !tbaa !134
  %935 = fadd <8 x float> %931, %934
  %936 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$1.132", i64 %929
  %937 = load <8 x float>, ptr %936, align 32, !tbaa !136
  %938 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$1.132", i64 %932
  %939 = load <8 x float>, ptr %938, align 32, !tbaa !136
  %940 = fadd <8 x float> %937, %939
  %941 = fadd <8 x float> %923, %935
  %942 = fadd <8 x float> %928, %940
  %943 = fsub <8 x float> %923, %935
  %944 = fsub <8 x float> %928, %940
  %945 = fsub <8 x float> %919, %922
  %946 = fsub <8 x float> %925, %927
  %947 = fsub <8 x float> %937, %939
  %948 = fsub <8 x float> %934, %931
  %949 = fadd <8 x float> %945, %947
  %950 = fadd <8 x float> %946, %948
  %951 = fsub <8 x float> %945, %947
  %952 = fsub <8 x float> %946, %948
  store <8 x float> %941, ptr %704, align 32, !tbaa !148
  store <8 x float> %942, ptr %705, align 32, !tbaa !150
  store <8 x float> %949, ptr %706, align 32, !tbaa !148
  store <8 x float> %950, ptr %707, align 32, !tbaa !150
  store <8 x float> %943, ptr %708, align 32, !tbaa !148
  store <8 x float> %944, ptr %709, align 32, !tbaa !150
  store <8 x float> %951, ptr %710, align 32, !tbaa !148
  store <8 x float> %952, ptr %711, align 32, !tbaa !150
  %953 = add nuw nsw i64 %"fwd_fft1_S4_R4_n1$1.s1.n0.g", 72
  %954 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$1.033", i64 %953
  %955 = load <8 x float>, ptr %954, align 32, !tbaa !134
  %956 = add nuw nsw i64 %"fwd_fft1_S4_R4_n1$1.s1.n0.g", 264
  %957 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$1.033", i64 %956
  %958 = load <8 x float>, ptr %957, align 32, !tbaa !134
  %959 = fadd <8 x float> %955, %958
  %960 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$1.132", i64 %953
  %961 = load <8 x float>, ptr %960, align 32, !tbaa !136
  %962 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$1.132", i64 %956
  %963 = load <8 x float>, ptr %962, align 32, !tbaa !136
  %964 = fadd <8 x float> %961, %963
  %965 = add nuw nsw i64 %"fwd_fft1_S4_R4_n1$1.s1.n0.g", 168
  %966 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$1.033", i64 %965
  %967 = load <8 x float>, ptr %966, align 32, !tbaa !134
  %968 = add nuw nsw i64 %"fwd_fft1_S4_R4_n1$1.s1.n0.g", 360
  %969 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$1.033", i64 %968
  %970 = load <8 x float>, ptr %969, align 32, !tbaa !134
  %971 = fadd <8 x float> %967, %970
  %972 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$1.132", i64 %965
  %973 = load <8 x float>, ptr %972, align 32, !tbaa !136
  %974 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$1.132", i64 %968
  %975 = load <8 x float>, ptr %974, align 32, !tbaa !136
  %976 = fadd <8 x float> %973, %975
  %977 = fadd <8 x float> %959, %971
  %978 = fadd <8 x float> %964, %976
  %979 = fsub <8 x float> %959, %971
  %980 = fsub <8 x float> %964, %976
  %981 = fsub <8 x float> %955, %958
  %982 = fsub <8 x float> %961, %963
  %983 = fsub <8 x float> %973, %975
  %984 = fsub <8 x float> %970, %967
  %985 = fadd <8 x float> %981, %983
  %986 = fadd <8 x float> %982, %984
  %987 = fsub <8 x float> %981, %983
  %988 = fsub <8 x float> %982, %984
  store <8 x float> %977, ptr %712, align 32, !tbaa !148
  store <8 x float> %978, ptr %713, align 32, !tbaa !150
  store <8 x float> %985, ptr %714, align 32, !tbaa !148
  store <8 x float> %986, ptr %715, align 32, !tbaa !150
  store <8 x float> %979, ptr %716, align 32, !tbaa !148
  store <8 x float> %980, ptr %717, align 32, !tbaa !150
  store <8 x float> %987, ptr %718, align 32, !tbaa !148
  store <8 x float> %988, ptr %719, align 32, !tbaa !150
...
"for fwd_fft1_S4_R4_n1$1.s1.r13593$y":            ; preds = %"for fwd_fft1_S4_R4_n1$1.s1.n0.g", %"for fwd_fft1_S4_R4_n1$1.s1.r13593$y"
  %indvars.iv382 = phi i64 [ 0, %"for fwd_fft1_S4_R4_n1$1.s1.n0.g" ], [ %indvars.iv.next383, %"for fwd_fft1_S4_R4_n1$1.s1.r13593$y" ]
  %989 = shl nuw nsw i64 %indvars.iv382, 3
  %990 = getelementptr inbounds float, ptr %"inv_exchange_S1_R4_n1$1.019", i64 %989
  %991 = load <8 x float>, ptr %990, align 32, !tbaa !148
  %992 = getelementptr inbounds float, ptr %"inv_exchange_S1_R4_n1$1.118", i64 %989
  %993 = load <8 x float>, ptr %992, align 32, !tbaa !150
  %994 = add nuw nsw i64 %989, 32
  %995 = getelementptr inbounds float, ptr %"inv_exchange_S1_R4_n1$1.019", i64 %994
  %996 = load <8 x float>, ptr %995, align 32, !tbaa !148
  %997 = getelementptr inbounds float, ptr %f3.039, i64 %indvars.iv382
  %998 = load float, ptr %997, align 4, !tbaa !152
  %999 = insertelement <8 x float> undef, float %998, i64 0
  %1000 = shufflevector <8 x float> %999, <8 x float> undef, <8 x i32> zeroinitializer
  %1001 = fmul <8 x float> %996, %1000
  %1002 = getelementptr inbounds float, ptr %"inv_exchange_S1_R4_n1$1.118", i64 %994
  %1003 = load <8 x float>, ptr %1002, align 32, !tbaa !150
  %1004 = getelementptr inbounds float, ptr %f3.138, i64 %indvars.iv382
  ...
  %1009 = fsub <8 x float> %1001, %1008
  %1010 = fmul <8 x float> %996, %1007
  %1011 = fmul <8 x float> %1003, %1000
  %1012 = fadd <8 x float> %1011, %1010
  %1013 = add nuw nsw i64 %989, 64
  %1014 = getelementptr inbounds float, ptr %"inv_exchange_S1_R4_n1$1.019", i64 %1013
  %1015 = load <8 x float>, ptr %1014, align 32, !tbaa !148
  %1016 = shl nuw nsw i64 %indvars.iv382, 1
  %1017 = getelementptr inbounds float, ptr %f3.039, i64 %1016
  %1018 = load float, ptr %1017, align 8, !tbaa !152
  ...
  %1022 = getelementptr inbounds float, ptr %"inv_exchange_S1_R4_n1$1.118", i64 %1013
  %1023 = load <8 x float>, ptr %1022, align 32, !tbaa !150
  %1024 = getelementptr inbounds float, ptr %f3.138, i64 %1016
  %1025 = load float, ptr %1024, align 8, !tbaa !153
  %1026 = insertelement <8 x float> undef, float %1025, i64 0
  %1027 = shufflevector <8 x float> %1026, <8 x float> undef, <8 x i32> zeroinitializer
  %1028 = fmul <8 x float> %1023, %1027
  %1029 = fsub <8 x float> %1021, %1028
  %1030 = fmul <8 x float> %1015, %1027
  %1031 = fmul <8 x float> %1023, %1020
  %1032 = fadd <8 x float> %1031, %1030
  %1033 = add nuw nsw i64 %989, 96
  %1034 = getelementptr inbounds float, ptr %"inv_exchange_S1_R4_n1$1.019", i64 %1033
  %1035 = load <8 x float>, ptr %1034, align 32, !tbaa !148
  %1036 = mul nuw nsw i64 %indvars.iv382, 3
  %1037 = getelementptr inbounds float, ptr %f3.039, i64 %1036
  %1038 = load float, ptr %1037, align 4, !tbaa !152
  ...
  %1041 = fmul <8 x float> %1035, %1040
  %1042 = getelementptr inbounds float, ptr %"inv_exchange_S1_R4_n1$1.118", i64 %1033
  %1043 = load <8 x float>, ptr %1042, align 32, !tbaa !150
  %1044 = getelementptr inbounds float, ptr %f3.138, i64 %1036
  %1045 = load float, ptr %1044, align 4, !tbaa !153
  ...
  %1050 = fmul <8 x float> %1035, %1047
  %1051 = fmul <8 x float> %1043, %1040
  %1052 = fadd <8 x float> %1051, %1050
  %1053 = fadd <8 x float> %991, %1029
  %1054 = fadd <8 x float> %993, %1032
  %1055 = fadd <8 x float> %1009, %1049
  %1056 = fadd <8 x float> %1012, %1052
  %1057 = fadd <8 x float> %1053, %1055
  %1058 = fadd <8 x float> %1054, %1056
  %1059 = fsub <8 x float> %1053, %1055
  %1060 = fsub <8 x float> %1054, %1056
  %1061 = fsub <8 x float> %991, %1029
  %1062 = fsub <8 x float> %993, %1032
  %1063 = fsub <8 x float> %1012, %1052
  %1064 = fsub <8 x float> %1049, %1009
  %1065 = fadd <8 x float> %1061, %1063
  %1066 = fadd <8 x float> %1062, %1064
  %1067 = fsub <8 x float> %1061, %1063
  %1068 = fsub <8 x float> %1062, %1064
  %1069 = shl nuw nsw i64 %indvars.iv382, 4
  %1070 = or i64 %1069, %"fwd_fft1_S4_R4_n1$1.s1.n0.g"
  %1071 = getelementptr inbounds float, ptr %"inv_X4$7.031", i64 %1070
  store <8 x float> %1057, ptr %1071, align 32, !tbaa !132
  %1072 = getelementptr inbounds float, ptr %"inv_X4$7.130", i64 %1070
  store <8 x float> %1058, ptr %1072, align 32, !tbaa !130
  %1073 = add nuw nsw i64 %1070, 64
  %1074 = getelementptr inbounds float, ptr %"inv_X4$7.031", i64 %1073
  store <8 x float> %1065, ptr %1074, align 32, !tbaa !132
  %1075 = getelementptr inbounds float, ptr %"inv_X4$7.130", i64 %1073
  store <8 x float> %1066, ptr %1075, align 32, !tbaa !130
  %1076 = add nuw nsw i64 %1070, 128
  %1077 = getelementptr inbounds float, ptr %"inv_X4$7.031", i64 %1076
  store <8 x float> %1059, ptr %1077, align 32, !tbaa !132
  %1078 = getelementptr inbounds float, ptr %"inv_X4$7.130", i64 %1076
  store <8 x float> %1060, ptr %1078, align 32, !tbaa !130
  %1079 = add nuw nsw i64 %1070, 192
  %1080 = getelementptr inbounds float, ptr %"inv_X4$7.031", i64 %1079
  store <8 x float> %1067, ptr %1080, align 32, !tbaa !132
  %1081 = getelementptr inbounds float, ptr %"inv_X4$7.130", i64 %1079
  store <8 x float> %1068, ptr %1081, align 32, !tbaa !130
  %indvars.iv.next383 = add nuw nsw i64 %indvars.iv382, 1
  %.not53 = icmp eq i64 %indvars.iv.next383, 4
  br i1 %.not53, label %"end for fwd_fft1_S4_R4_n1$1.s1.r13593$y", label %"for fwd_fft1_S4_R4_n1$1.s1.r13593$y"
...
"assert failed80":                                ; preds = %"consume fwd_fft1_S4_R4_n1$1"
  %1082 = tail call i32 @halide_error_explicit_bounds_too_small(ptr null, ptr nonnull @str.11, ptr nonnull @str.12, i32 0, i32 15, i32 %84, i32 %b15) #2
  br label %destructor_block
...
"assert failed82":                                ; preds = %"assert succeeded81"
  %1083 = tail call i32 @llvm.smin.i32(i32 %68, i32 0)
  %a18 = add nsw i32 %676, -1
  %1084 = tail call i32 @halide_error_explicit_bounds_too_small(ptr null, ptr nonnull @str.13, ptr nonnull @str.12, i32 0, i32 15, i32 %1083, i32 %a18) #2
  br label %destructor_block

"assert succeeded83":                             ; preds = %"assert succeeded81"
  br i1 %678, label %"assert failed84", label %"for inv_fft0_S4_R4_n0$1.s1.n1.preheader", !prof !5

"for inv_fft0_S4_R4_n0$1.s1.n1.preheader":        ; preds = %"assert succeeded83"
  %1085 = load <4 x float>, ptr %f5.041, align 32
  %1086 = load <4 x float>, ptr %f5.140, align 32
  %1087 = load <4 x float>, ptr %255, align 16, !tbaa !50
  %1088 = shufflevector <4 x float> %1085, <4 x float> %1087, <4 x i32> <i32 0, i32 2, i32 4, i32 6>
  %1089 = load <4 x float>, ptr %256, align 16, !tbaa !52
  %1090 = shufflevector <4 x float> %1086, <4 x float> %1089, <4 x i32> <i32 0, i32 2, i32 4, i32 6>
  %1091 = extractelement <4 x float> %1085, i64 3
  %1092 = insertelement <4 x float> %1085, float %1091, i64 1
  %1093 = extractelement <4 x float> %1087, i64 2
  %1094 = insertelement <4 x float> %1092, float %1093, i64 2
  %1095 = load float, ptr %259, align 4, !tbaa !154
  %1096 = insertelement <4 x float> %1094, float %1095, i64 3
  %1097 = extractelement <4 x float> %1086, i64 3
  %1098 = insertelement <4 x float> %1086, float %1097, i64 1
  %1099 = extractelement <4 x float> %1089, i64 2
  %1100 = insertelement <4 x float> %1098, float %1099, i64 2
  %1101 = load float, ptr %260, align 4, !tbaa !155
  %1102 = insertelement <4 x float> %1100, float %1101, i64 3
...
"for inv_fft0_S4_R4_n0$1.s1.n1":                  ; preds = %"for inv_fft0_S4_R4_n0$1.s1.n1.preheader", %"for inv_fft0_S4_R4_n0$1.s1.n1"
  ...
  %1104 = shl nuw nsw i64 %indvars.iv385, 4
  %1105 = getelementptr inbounds float, ptr %"inv_X4$7.031", i64 %1104
  %1106 = load <4 x float>, ptr %1105, align 32, !tbaa !132
  %1107 = getelementptr inbounds float, ptr %"kernel_fft1_S4_R4_n1$1.035", i64 %1104
  %1108 = load <4 x float>, ptr %1107, align 32, !tbaa !140
  %1109 = fmul <4 x float> %1106, %1108
  %1110 = getelementptr inbounds float, ptr %"inv_X4$7.130", i64 %1104
  %1111 = load <4 x float>, ptr %1110, align 32, !tbaa !130
  %1112 = getelementptr inbounds float, ptr %"kernel_fft1_S4_R4_n1$1.134", i64 %1104
  %1113 = load <4 x float>, ptr %1112, align 32, !tbaa !142
  %1114 = fmul <4 x float> %1111, %1113
  %1115 = fsub <4 x float> %1109, %1114
  %1116 = or i64 %1104, 8
  %1117 = getelementptr inbounds float, ptr %"inv_X4$7.031", i64 %1116
  %1118 = load <4 x float>, ptr %1117, align 32, !tbaa !132
  %1119 = getelementptr inbounds float, ptr %"kernel_fft1_S4_R4_n1$1.035", i64 %1116
  %1120 = load <4 x float>, ptr %1119, align 32, !tbaa !140
  %1121 = fmul <4 x float> %1118, %1120
  %1122 = getelementptr inbounds float, ptr %"inv_X4$7.130", i64 %1116
  %1123 = load <4 x float>, ptr %1122, align 32, !tbaa !130
  %1124 = getelementptr inbounds float, ptr %"kernel_fft1_S4_R4_n1$1.134", i64 %1116
  ...
  %1136 = or i64 %1104, 4
  %1137 = getelementptr inbounds float, ptr %"inv_X4$7.031", i64 %1136
  %1138 = load <4 x float>, ptr %1137, align 16, !tbaa !132
  %1139 = getelementptr inbounds float, ptr %"kernel_fft1_S4_R4_n1$1.035", i64 %1136
  %1140 = load <4 x float>, ptr %1139, align 16, !tbaa !140
  %1141 = fmul <4 x float> %1138, %1140
  %1142 = getelementptr inbounds float, ptr %"inv_X4$7.130", i64 %1136
  %1143 = load <4 x float>, ptr %1142, align 16, !tbaa !130
  %1144 = getelementptr inbounds float, ptr %"kernel_fft1_S4_R4_n1$1.134", i64 %1136
  %1145 = load <4 x float>, ptr %1144, align 16, !tbaa !142
  %1146 = fmul <4 x float> %1143, %1145
  %1147 = fsub <4 x float> %1141, %1146
  %1148 = or i64 %1104, 12
  %1149 = getelementptr inbounds float, ptr %"inv_X4$7.031", i64 %1148
  %1150 = load <4 x float>, ptr %1149, align 16, !tbaa !132
  %1151 = getelementptr inbounds float, ptr %"kernel_fft1_S4_R4_n1$1.035", i64 %1148
  %1152 = load <4 x float>, ptr %1151, align 16, !tbaa !140
  %1153 = fmul <4 x float> %1150, %1152
  %1154 = getelementptr inbounds float, ptr %"inv_X4$7.130", i64 %1148
  %1155 = load <4 x float>, ptr %1154, align 16, !tbaa !130
  %1156 = getelementptr inbounds float, ptr %"kernel_fft1_S4_R4_n1$1.134", i64 %1148
  ...
  %"inv_exchange_S1_R4_n0$1.026.sroa.0.0.vec.extract" = shufflevector <16 x float> %1184, <16 x float> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %"inv_exchange_S1_R4_n0$1.127.sroa.0.0.vec.extract" = shufflevector <16 x float> %1188, <16 x float> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %"inv_exchange_S1_R4_n0$1.026.sroa.0.16.vec.extract" = shufflevector <16 x float> %1184, <16 x float> undef, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
  %1190 = fmul <4 x float> %"inv_exchange_S1_R4_n0$1.026.sroa.0.16.vec.extract", %1085
  %"inv_exchange_S1_R4_n0$1.127.sroa.0.16.vec.extract" = shufflevector <16 x float> %1188, <16 x float> undef, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
  %1191 = fmul <4 x float> %"inv_exchange_S1_R4_n0$1.127.sroa.0.16.vec.extract", %1086
  %1192 = fsub <4 x float> %1190, %1191
  %1193 = fmul <4 x float> %"inv_exchange_S1_R4_n0$1.026.sroa.0.16.vec.extract", %1086
  %1194 = fmul <4 x float> %1085, %"inv_exchange_S1_R4_n0$1.127.sroa.0.16.vec.extract"
  %1195 = fadd <4 x float> %1194, %1193
  %"inv_exchange_S1_R4_n0$1.026.sroa.7.32.vec.extract" = shufflevector <8 x float> %1185, <8 x float> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %1196 = fmul <4 x float> %"inv_exchange_S1_R4_n0$1.026.sroa.7.32.vec.extract", %1088
  %"inv_exchange_S1_R4_n0$1.127.sroa.7.32.vec.extract" = shufflevector <8 x float> %1189, <8 x float> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %1197 = fmul <4 x float> %"inv_exchange_S1_R4_n0$1.127.sroa.7.32.vec.extract", %1090
  %1198 = fsub <4 x float> %1196, %1197
  %1199 = fmul <4 x float> %"inv_exchange_S1_R4_n0$1.026.sroa.7.32.vec.extract", %1090
  %1200 = fmul <4 x float> %"inv_exchange_S1_R4_n0$1.127.sroa.7.32.vec.extract", %1088
  %1201 = fadd <4 x float> %1200, %1199
  %"inv_exchange_S1_R4_n0$1.026.sroa.7.48.vec.extract" = shufflevector <8 x float> %1185, <8 x float> poison, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
  %1202 = fmul <4 x float> %"inv_exchange_S1_R4_n0$1.026.sroa.7.48.vec.extract", %1096
  %"inv_exchange_S1_R4_n0$1.127.sroa.7.48.vec.extract" = shufflevector <8 x float> %1189, <8 x float> poison, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
  %1203 = fmul <4 x float> %"inv_exchange_S1_R4_n0$1.127.sroa.7.48.vec.extract", %1102
  %1204 = fsub <4 x float> %1202, %1203
  %1205 = fmul <4 x float> %"inv_exchange_S1_R4_n0$1.026.sroa.7.48.vec.extract", %1102
  %1206 = fmul <4 x float> %"inv_exchange_S1_R4_n0$1.127.sroa.7.48.vec.extract", %1096
  %1207 = fadd <4 x float> %1206, %1205
  %1208 = fadd <4 x float> %"inv_exchange_S1_R4_n0$1.026.sroa.0.0.vec.extract", %1198
  %1209 = fadd <4 x float> %"inv_exchange_S1_R4_n0$1.127.sroa.0.0.vec.extract", %1201
  ...
  %1216 = fsub <4 x float> %"inv_exchange_S1_R4_n0$1.026.sroa.0.0.vec.extract", %1198
  %1217 = fsub <4 x float> %"inv_exchange_S1_R4_n0$1.127.sroa.0.0.vec.extract", %1201
  ...
  %1224 = mul nuw nsw i64 %indvars.iv385, 24
  %1225 = getelementptr inbounds float, ptr %"inv_fft0_S4_R4_n0$1.017", i64 %1224
  store <4 x float> %1212, ptr %1225, align 32, !tbaa !156
  %1226 = getelementptr inbounds float, ptr %"inv_fft0_S4_R4_n0$1.116", i64 %1224
  store <4 x float> %1213, ptr %1226, align 32, !tbaa !158
  %1227 = or i64 %1224, 4
  %1228 = getelementptr inbounds float, ptr %"inv_fft0_S4_R4_n0$1.017", i64 %1227
  store <4 x float> %1220, ptr %1228, align 16, !tbaa !156
  %1229 = getelementptr inbounds float, ptr %"inv_fft0_S4_R4_n0$1.116", i64 %1227
  store <4 x float> %1221, ptr %1229, align 16, !tbaa !158
  %1230 = add nuw nsw i64 %1224, 8
  %1231 = getelementptr inbounds float, ptr %"inv_fft0_S4_R4_n0$1.017", i64 %1230
  store <4 x float> %1214, ptr %1231, align 32, !tbaa !156
  %1232 = getelementptr inbounds float, ptr %"inv_fft0_S4_R4_n0$1.116", i64 %1230
  store <4 x float> %1215, ptr %1232, align 32, !tbaa !158
  %1233 = add nuw nsw i64 %1224, 12
  %1234 = getelementptr inbounds float, ptr %"inv_fft0_S4_R4_n0$1.017", i64 %1233
  store <4 x float> %1222, ptr %1234, align 16, !tbaa !156
  %1235 = getelementptr inbounds float, ptr %"inv_fft0_S4_R4_n0$1.116", i64 %1233
  store <4 x float> %1223, ptr %1235, align 16, !tbaa !158
...
"for inv_fft1_S4_R4_n1$1.s1.n0.g":                ; preds = %"for inv_fft0_S4_R4_n0$1.s1.n1", %"end for inv_fft1_S4_R4_n1$1.s1.r13686$y"
  %.not58 = phi i1 [ true, %"end for inv_fft1_S4_R4_n1$1.s1.r13686$y" ], [ false, %"for inv_fft0_S4_R4_n0$1.s1.n1" ]
  %"inv_fft1_S4_R4_n1$1.s1.n0.g" = phi i64 [ 8, %"end for inv_fft1_S4_R4_n1$1.s1.r13686$y" ], [ 0, %"for inv_fft0_S4_R4_n0$1.s1.n1" ]
  %1236 = getelementptr inbounds float, ptr %"inv_fft0_S4_R4_n0$1.017", i64 %"inv_fft1_S4_R4_n1$1.s1.n0.g"
  %1237 = load <8 x float>, ptr %1236, align 32, !tbaa !156
  %1238 = or i64 %"inv_fft1_S4_R4_n1$1.s1.n0.g", 192
  %1239 = getelementptr inbounds float, ptr %"inv_fft0_S4_R4_n0$1.017", i64 %1238
  %1240 = load <8 x float>, ptr %1239, align 32, !tbaa !156
  %1241 = fadd <8 x float> %1237, %1240
  %1242 = getelementptr inbounds float, ptr %"inv_fft0_S4_R4_n0$1.116", i64 %"inv_fft1_S4_R4_n1$1.s1.n0.g"
  %1243 = load <8 x float>, ptr %1242, align 32, !tbaa !158
  %1244 = getelementptr inbounds float, ptr %"inv_fft0_S4_R4_n0$1.116", i64 %1238
  %1245 = load <8 x float>, ptr %1244, align 32, !tbaa !158
  %1246 = fadd <8 x float> %1243, %1245
  %1247 = or i64 %"inv_fft1_S4_R4_n1$1.s1.n0.g", 96
  %1248 = getelementptr inbounds float, ptr %"inv_fft0_S4_R4_n0$1.017", i64 %1247
  %1249 = load <8 x float>, ptr %1248, align 32, !tbaa !156
  %1250 = or i64 %"inv_fft1_S4_R4_n1$1.s1.n0.g", 288
  %1251 = getelementptr inbounds float, ptr %"inv_fft0_S4_R4_n0$1.017", i64 %1250
  %1252 = load <8 x float>, ptr %1251, align 32, !tbaa !156
  %1253 = fadd <8 x float> %1249, %1252
  %1254 = getelementptr inbounds float, ptr %"inv_fft0_S4_R4_n0$1.116", i64 %1247
  %1255 = load <8 x float>, ptr %1254, align 32, !tbaa !158
  %1256 = getelementptr inbounds float, ptr %"inv_fft0_S4_R4_n0$1.116", i64 %1250
  %1257 = load <8 x float>, ptr %1256, align 32, !tbaa !158
  %1258 = fadd <8 x float> %1255, %1257
  %1259 = fadd <8 x float> %1241, %1253
  %1260 = fadd <8 x float> %1258, %1246
  ...
  %1267 = fadd <8 x float> %1265, %1263
  %1268 = fadd <8 x float> %1266, %1264
  %1269 = fsub <8 x float> %1263, %1265
  %1270 = fsub <8 x float> %1264, %1266
  store <8 x float> %1259, ptr %"inv_exchange_S1_R4_n1$1.019", align 32, !tbaa !148
  store <8 x float> %1260, ptr %"inv_exchange_S1_R4_n1$1.118", align 32, !tbaa !150
  store <8 x float> %1267, ptr %720, align 32, !tbaa !148
  store <8 x float> %1268, ptr %721, align 32, !tbaa !150
  store <8 x float> %1261, ptr %722, align 32, !tbaa !148
  store <8 x float> %1262, ptr %723, align 32, !tbaa !150
  store <8 x float> %1269, ptr %724, align 32, !tbaa !148
  store <8 x float> %1270, ptr %725, align 32, !tbaa !150
  %1271 = add nuw nsw i64 %"inv_fft1_S4_R4_n1$1.s1.n0.g", 24
  %1272 = getelementptr inbounds float, ptr %"inv_fft0_S4_R4_n0$1.017", i64 %1271
  %1273 = load <8 x float>, ptr %1272, align 32, !tbaa !156
  %1274 = add nuw nsw i64 %"inv_fft1_S4_R4_n1$1.s1.n0.g", 216
  %1275 = getelementptr inbounds float, ptr %"inv_fft0_S4_R4_n0$1.017", i64 %1274
  %1276 = load <8 x float>, ptr %1275, align 32, !tbaa !156
  %1277 = fadd <8 x float> %1273, %1276
  %1278 = getelementptr inbounds float, ptr %"inv_fft0_S4_R4_n0$1.116", i64 %1271
  %1279 = load <8 x float>, ptr %1278, align 32, !tbaa !158
  %1280 = getelementptr inbounds float, ptr %"inv_fft0_S4_R4_n0$1.116", i64 %1274
  %1281 = load <8 x float>, ptr %1280, align 32, !tbaa !158
  %1282 = fadd <8 x float> %1279, %1281
  %1283 = add nuw nsw i64 %"inv_fft1_S4_R4_n1$1.s1.n0.g", 120
  %1284 = getelementptr inbounds float, ptr %"inv_fft0_S4_R4_n0$1.017", i64 %1283
  %1285 = load <8 x float>, ptr %1284, align 32, !tbaa !156
  %1286 = add nuw nsw i64 %"inv_fft1_S4_R4_n1$1.s1.n0.g", 312
  %1287 = getelementptr inbounds float, ptr %"inv_fft0_S4_R4_n0$1.017", i64 %1286
  %1288 = load <8 x float>, ptr %1287, align 32, !tbaa !156
  %1289 = fadd <8 x float> %1285, %1288
  %1290 = getelementptr inbounds float, ptr %"inv_fft0_S4_R4_n0$1.116", i64 %1283
  %1291 = load <8 x float>, ptr %1290, align 32, !tbaa !158
  %1292 = getelementptr inbounds float, ptr %"inv_fft0_S4_R4_n0$1.116", i64 %1286
  %1293 = load <8 x float>, ptr %1292, align 32, !tbaa !158
  %1294 = fadd <8 x float> %1291, %1293
  %1295 = fadd <8 x float> %1277, %1289
  %1296 = fadd <8 x float> %1294, %1282
  ...
  %1303 = fadd <8 x float> %1301, %1299
  %1304 = fadd <8 x float> %1302, %1300
  %1305 = fsub <8 x float> %1299, %1301
  %1306 = fsub <8 x float> %1300, %1302
  store <8 x float> %1295, ptr %726, align 32, !tbaa !148
  store <8 x float> %1296, ptr %727, align 32, !tbaa !150
  store <8 x float> %1303, ptr %728, align 32, !tbaa !148
  store <8 x float> %1304, ptr %729, align 32, !tbaa !150
  store <8 x float> %1297, ptr %730, align 32, !tbaa !148
  store <8 x float> %1298, ptr %731, align 32, !tbaa !150
  store <8 x float> %1305, ptr %732, align 32, !tbaa !148
  store <8 x float> %1306, ptr %733, align 32, !tbaa !150
  %1307 = or i64 %"inv_fft1_S4_R4_n1$1.s1.n0.g", 48
  %1308 = getelementptr inbounds float, ptr %"inv_fft0_S4_R4_n0$1.017", i64 %1307
  %1309 = load <8 x float>, ptr %1308, align 32, !tbaa !156
  %1310 = or i64 %"inv_fft1_S4_R4_n1$1.s1.n0.g", 240
  %1311 = getelementptr inbounds float, ptr %"inv_fft0_S4_R4_n0$1.017", i64 %1310
  %1312 = load <8 x float>, ptr %1311, align 32, !tbaa !156
  %1313 = fadd <8 x float> %1309, %1312
  %1314 = getelementptr inbounds float, ptr %"inv_fft0_S4_R4_n0$1.116", i64 %1307
  %1315 = load <8 x float>, ptr %1314, align 32, !tbaa !158
  %1316 = getelementptr inbounds float, ptr %"inv_fft0_S4_R4_n0$1.116", i64 %1310
  %1317 = load <8 x float>, ptr %1316, align 32, !tbaa !158
  %1318 = fadd <8 x float> %1315, %1317
  %1319 = or i64 %"inv_fft1_S4_R4_n1$1.s1.n0.g", 144
  %1320 = getelementptr inbounds float, ptr %"inv_fft0_S4_R4_n0$1.017", i64 %1319
  %1321 = load <8 x float>, ptr %1320, align 32, !tbaa !156
  %1322 = or i64 %"inv_fft1_S4_R4_n1$1.s1.n0.g", 336
  %1323 = getelementptr inbounds float, ptr %"inv_fft0_S4_R4_n0$1.017", i64 %1322
  %1324 = load <8 x float>, ptr %1323, align 32, !tbaa !156
  %1325 = fadd <8 x float> %1321, %1324
  %1326 = getelementptr inbounds float, ptr %"inv_fft0_S4_R4_n0$1.116", i64 %1319
  %1327 = load <8 x float>, ptr %1326, align 32, !tbaa !158
  %1328 = getelementptr inbounds float, ptr %"inv_fft0_S4_R4_n0$1.116", i64 %1322
  %1329 = load <8 x float>, ptr %1328, align 32, !tbaa !158
  %1330 = fadd <8 x float> %1327, %1329
  %1331 = fadd <8 x float> %1313, %1325
  %1332 = fadd <8 x float> %1330, %1318
  ...
  store <8 x float> %1331, ptr %734, align 32, !tbaa !148
  store <8 x float> %1332, ptr %735, align 32, !tbaa !150
  store <8 x float> %1339, ptr %736, align 32, !tbaa !148
  store <8 x float> %1340, ptr %737, align 32, !tbaa !150
  store <8 x float> %1333, ptr %738, align 32, !tbaa !148
  store <8 x float> %1334, ptr %739, align 32, !tbaa !150
  store <8 x float> %1341, ptr %740, align 32, !tbaa !148
  store <8 x float> %1342, ptr %741, align 32, !tbaa !150
  %1343 = add nuw nsw i64 %"inv_fft1_S4_R4_n1$1.s1.n0.g", 72
  %1344 = getelementptr inbounds float, ptr %"inv_fft0_S4_R4_n0$1.017", i64 %1343
  %1345 = load <8 x float>, ptr %1344, align 32, !tbaa !156
  %1346 = add nuw nsw i64 %"inv_fft1_S4_R4_n1$1.s1.n0.g", 264
  %1347 = getelementptr inbounds float, ptr %"inv_fft0_S4_R4_n0$1.017", i64 %1346
  %1348 = load <8 x float>, ptr %1347, align 32, !tbaa !156
  %1349 = fadd <8 x float> %1345, %1348
  %1350 = getelementptr inbounds float, ptr %"inv_fft0_S4_R4_n0$1.116", i64 %1343
  %1351 = load <8 x float>, ptr %1350, align 32, !tbaa !158
  %1352 = getelementptr inbounds float, ptr %"inv_fft0_S4_R4_n0$1.116", i64 %1346
  %1353 = load <8 x float>, ptr %1352, align 32, !tbaa !158
  %1354 = fadd <8 x float> %1351, %1353
  %1355 = add nuw nsw i64 %"inv_fft1_S4_R4_n1$1.s1.n0.g", 168
  %1356 = getelementptr inbounds float, ptr %"inv_fft0_S4_R4_n0$1.017", i64 %1355
  %1357 = load <8 x float>, ptr %1356, align 32, !tbaa !156
  %1358 = add nuw nsw i64 %"inv_fft1_S4_R4_n1$1.s1.n0.g", 360
  %1359 = getelementptr inbounds float, ptr %"inv_fft0_S4_R4_n0$1.017", i64 %1358
  %1360 = load <8 x float>, ptr %1359, align 32, !tbaa !156
  %1361 = fadd <8 x float> %1357, %1360
  %1362 = getelementptr inbounds float, ptr %"inv_fft0_S4_R4_n0$1.116", i64 %1355
  %1363 = load <8 x float>, ptr %1362, align 32, !tbaa !158
  %1364 = getelementptr inbounds float, ptr %"inv_fft0_S4_R4_n0$1.116", i64 %1358
  %1365 = load <8 x float>, ptr %1364, align 32, !tbaa !158
  %1366 = fadd <8 x float> %1363, %1365
  %1367 = fadd <8 x float> %1349, %1361
  %1368 = fadd <8 x float> %1366, %1354
  ...
  %1375 = fadd <8 x float> %1373, %1371
  %1376 = fadd <8 x float> %1374, %1372
  %1377 = fsub <8 x float> %1371, %1373
  %1378 = fsub <8 x float> %1372, %1374
  store <8 x float> %1367, ptr %742, align 32, !tbaa !148
  store <8 x float> %1368, ptr %743, align 32, !tbaa !150
  store <8 x float> %1375, ptr %744, align 32, !tbaa !148
  store <8 x float> %1376, ptr %745, align 32, !tbaa !150
  store <8 x float> %1369, ptr %746, align 32, !tbaa !148
  store <8 x float> %1370, ptr %747, align 32, !tbaa !150
  store <8 x float> %1377, ptr %748, align 32, !tbaa !148
  store <8 x float> %1378, ptr %749, align 32, !tbaa !150
...
"for inv_fft1_S4_R4_n1$1.s1.r13686$y":            ; preds = %"for inv_fft1_S4_R4_n1$1.s1.n0.g", %"for inv_fft1_S4_R4_n1$1.s1.r13686$y"
  %indvars.iv392 = phi i64 [ 0, %"for inv_fft1_S4_R4_n1$1.s1.n0.g" ], [ %indvars.iv.next393, %"for inv_fft1_S4_R4_n1$1.s1.r13686$y" ]
  %1379 = shl nuw nsw i64 %indvars.iv392, 3
  %1380 = getelementptr inbounds float, ptr %"inv_exchange_S1_R4_n1$1.019", i64 %1379
  %1381 = load <8 x float>, ptr %1380, align 32, !tbaa !148
  %1382 = getelementptr inbounds float, ptr %"inv_exchange_S1_R4_n1$1.118", i64 %1379
  %1383 = load <8 x float>, ptr %1382, align 32, !tbaa !150
  %1384 = add nuw nsw i64 %1379, 32
  %1385 = getelementptr inbounds float, ptr %"inv_exchange_S1_R4_n1$1.019", i64 %1384
  %1386 = load <8 x float>, ptr %1385, align 32, !tbaa !148
  %1387 = getelementptr inbounds float, ptr %f5.041, i64 %indvars.iv392
  %1388 = load float, ptr %1387, align 4, !tbaa !160
  ...
  %1392 = getelementptr inbounds float, ptr %"inv_exchange_S1_R4_n1$1.118", i64 %1384
  %1393 = load <8 x float>, ptr %1392, align 32, !tbaa !150
  %1394 = getelementptr inbounds float, ptr %f5.140, i64 %indvars.iv392
  %1395 = load float, ptr %1394, align 4, !tbaa !161
  ...
  %1404 = getelementptr inbounds float, ptr %"inv_exchange_S1_R4_n1$1.019", i64 %1403
  %1405 = load <8 x float>, ptr %1404, align 32, !tbaa !148
  %1406 = shl nuw nsw i64 %indvars.iv392, 1
  %1407 = getelementptr inbounds float, ptr %f5.041, i64 %1406
  %1408 = load float, ptr %1407, align 8, !tbaa !160
  ...
  %1412 = getelementptr inbounds float, ptr %"inv_exchange_S1_R4_n1$1.118", i64 %1403
  %1413 = load <8 x float>, ptr %1412, align 32, !tbaa !150
  %1414 = getelementptr inbounds float, ptr %f5.140, i64 %1406
  %1415 = load float, ptr %1414, align 8, !tbaa !161
  ...
  %1424 = getelementptr inbounds float, ptr %"inv_exchange_S1_R4_n1$1.019", i64 %1423
  %1425 = load <8 x float>, ptr %1424, align 32, !tbaa !148
  %1426 = mul nuw nsw i64 %indvars.iv392, 3
  %1427 = getelementptr inbounds float, ptr %f5.041, i64 %1426
  %1428 = load float, ptr %1427, align 4, !tbaa !160
  ...
  %1432 = getelementptr inbounds float, ptr %"inv_exchange_S1_R4_n1$1.118", i64 %1423
  %1433 = load <8 x float>, ptr %1432, align 32, !tbaa !150
  %1434 = getelementptr inbounds float, ptr %f5.140, i64 %1426
  %1435 = load float, ptr %1434, align 4, !tbaa !161
  ...
  %1455 = fadd <8 x float> %1453, %1451
  %1456 = fadd <8 x float> %1454, %1452
  %1457 = fsub <8 x float> %1451, %1453
  %1458 = fsub <8 x float> %1452, %1454
  %1459 = shl nuw nsw i64 %indvars.iv392, 4
  %1460 = or i64 %1459, %"inv_fft1_S4_R4_n1$1.s1.n0.g"
  %1461 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$1.033", i64 %1460
  store <8 x float> %1447, ptr %1461, align 32, !tbaa !134
  %1462 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$1.132", i64 %1460
  store <8 x float> %1448, ptr %1462, align 32, !tbaa !136
  %1463 = add nuw nsw i64 %1460, 64
  %1464 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$1.033", i64 %1463
  store <8 x float> %1455, ptr %1464, align 32, !tbaa !134
  %1465 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$1.132", i64 %1463
  store <8 x float> %1456, ptr %1465, align 32, !tbaa !136
  %1466 = add nuw nsw i64 %1460, 128
  %1467 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$1.033", i64 %1466
  store <8 x float> %1449, ptr %1467, align 32, !tbaa !134
  %1468 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$1.132", i64 %1466
  store <8 x float> %1450, ptr %1468, align 32, !tbaa !136
  %1469 = add nuw nsw i64 %1460, 192
  %1470 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$1.033", i64 %1469
  store <8 x float> %1457, ptr %1470, align 32, !tbaa !134
  %1471 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$1.132", i64 %1469
  store <8 x float> %1458, ptr %1471, align 32, !tbaa !136
  %indvars.iv.next393 = add nuw nsw i64 %indvars.iv392, 1
  %.not57 = icmp eq i64 %indvars.iv.next393, 4
  br i1 %.not57, label %"end for inv_fft1_S4_R4_n1$1.s1.r13686$y", label %"for inv_fft1_S4_R4_n1$1.s1.r13686$y"
...
"consume inv_fft1_S4_R4_n1$1":                    ; preds = %"end for inv_fft1_S4_R4_n1$1.s1.r13686$y"
  store <8 x float> %1453, ptr %664, align 32, !tbaa !162
  store <8 x float> %1454, ptr %665, align 32, !tbaa !171
  store <8 x float> %1451, ptr %"inv_X4$7.031", align 32, !tbaa !180
  store <8 x float> %1452, ptr %"inv_X4$7.130", align 32, !tbaa !182
  store <8 x float> %1447, ptr %scevgep363.1, align 32, !tbaa !184
  store <8 x float> %1448, ptr %666, align 32, !tbaa !187
  store <8 x float> %1449, ptr %scevgep363.2, align 32, !tbaa !190
  store <8 x float> %1450, ptr %669, align 32, !tbaa !194
  store <8 x float> %1455, ptr %667, align 32, !tbaa !198
  store <8 x float> %1456, ptr %668, align 32, !tbaa !200
  store <8 x float> %1457, ptr %670, align 32, !tbaa !202
  store <8 x float> %1458, ptr %671, align 32, !tbaa !204
  br i1 %679, label %"for result$1.s0.n1.preheader", label %"end for result$1.s0.n1", !prof !26

"for result$1.s0.n1.preheader":                   ; preds = %"consume inv_fft1_S4_R4_n1$1"
  %reass.add82 = sub nsw i64 %indvars.iv401, %685
  %reass.mul83 = mul i64 %reass.add82, %248
  %1472 = sub i64 %reass.mul83, %683
  %1473 = add i64 %688, %reass.mul83
  br label %"for result$1.s0.n1"

"for result$1.s0.n1":                             ; preds = %"for result$1.s0.n1.preheader", %"end for result$1.s0.n0.n091"
  %indvars.iv398 = phi i64 [ %684, %"for result$1.s0.n1.preheader" ], [ %indvars.iv.next399, %"end for result$1.s0.n0.n091" ]
  br i1 %.not324, label %"end for result$1.s0.n0.n0", label %"for result$1.s0.n0.n0.preheader", !prof !5

"for result$1.s0.n0.n0.preheader":                ; preds = %"for result$1.s0.n1"
  %1474 = shl nsw i64 %indvars.iv398, 4
  %reass.add84 = sub nsw i64 %indvars.iv398, %684
  %reass.mul85 = mul i64 %reass.add84, %241
  %1475 = add i64 %1472, %reass.mul85
  br i1 %750, label %"end for result$1.s0.n0.n0.loopexit.unr-lcssa", label %"for result$1.s0.n0.n0"
...
"end for result$1.s0.n1":                         ; preds = %"end for result$1.s0.n0.n091", %"consume inv_fft1_S4_R4_n1$1"
  ...
  %1476 = trunc i64 %indvars.iv.next402 to i32
  %.not59 = icmp eq i32 %173, %1476
...
"for result$1.s0.n0.n0":                          ; preds = %"for result$1.s0.n0.n0.preheader", %"for result$1.s0.n0.n0"
  ...
  %1477 = shl nuw nsw i64 %indvars.iv395, 3
  %1478 = add nsw i64 %1477, %683
  %1479 = add nsw i64 %1478, %1474
  %1480 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$1.033", i64 %1479
  ...
  store <8 x float> %1482, ptr %1484, align 4, !tbaa !206
  %indvars.iv.next396 = shl i64 %indvars.iv395, 3
  %1485 = or i64 %indvars.iv.next396, 8
  %1486 = add nsw i64 %1485, %683
  %1487 = add nsw i64 %1486, %1474
  %1488 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$1.033", i64 %1487
  ...
  store <8 x float> %1490, ptr %1492, align 4, !tbaa !206
...
"for result$1.s0.n0.n0.epil":                     ; preds = %"end for result$1.s0.n0.n0.loopexit.unr-lcssa"
  %1493 = shl nuw nsw i64 %indvars.iv395.unr, 3
  %1494 = add nsw i64 %1493, %683
  %1495 = add nsw i64 %1494, %1474
  %1496 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$1.033", i64 %1495
  ...
  store <8 x float> %1498, ptr %1500, align 4, !tbaa !206
...
"end for result$1.s0.n0.n0":                      ; preds = %"for result$1.s0.n0.n0.epil", %"end for result$1.s0.n0.n0.loopexit.unr-lcssa", %"for result$1.s0.n1"
  br i1 %682, label %"for result$1.s0.n0.n090.preheader", label %"end for result$1.s0.n0.n091", !prof !26

"for result$1.s0.n0.n090.preheader":              ; preds = %"end for result$1.s0.n0.n0"
  %1501 = shl nsw i64 %indvars.iv398, 4
  %1502 = add nsw i64 %687, %1501
  %1503 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$1.033", i64 %1502
  ...
  %reass.add93 = sub nsw i64 %indvars.iv398, %684
  %reass.mul94 = mul i64 %reass.add93, %241
  %1506 = add i64 %1473, %reass.mul94
  %1507 = getelementptr inbounds float, ptr %53, i64 %1506
  store <8 x float> %1505, ptr %1507, align 4, !tbaa !206
...
"end for result$1.s0.n0.n091":                    ; preds = %"for result$1.s0.n0.n090.preheader", %"end for result$1.s0.n0.n0"
  ...
  %1508 = trunc i64 %indvars.iv.next399 to i32
  %.not60 = icmp eq i32 %676, %1508
