...
entry:
  ...
  %j = getelementptr inbounds %struct.B, ptr %d, i64 0, i32 1
  store i32 0, ptr %j, align 4, !tbaa !5
  store i32 0, ptr %d, align 4, !tbaa !10
  %0 = load i64, ptr @di, align 8, !tbaa !11
  %memptr.offset = getelementptr inbounds i8, ptr %d, i64 %0
  store i32 4, ptr %memptr.offset, align 4, !tbaa !12
  %1 = load i64, ptr @dj, align 8, !tbaa !11
  %memptr.offset1 = getelementptr inbounds i8, ptr %d, i64 %1
  store i32 7, ptr %memptr.offset1, align 4, !tbaa !12
  %2 = load i32, ptr %d, align 4, !tbaa !10
  %3 = load i32, ptr %j, align 4, !tbaa !5
  %call = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %2, i32 noundef %3)
