...
entry:
  ...
  %cmp.i.not30 = icmp eq ptr %0, %unknown
  br i1 %cmp.i.not30, label %while.end14, label %while.body.lr.ph
...
_ZNSt6vectorIiSaIiEE9push_backERKi.exit:          ; preds = %if.then.i, %_ZNSt6vectorIiSaIiEE17_M_realloc_insertIJRKiEEEvN9__gnu_cxx17__normal_iteratorIPiS1_EEDpOT_.exit.i
  ...
  %cmp.i.not = icmp eq ptr %11, %unknown
  br i1 %cmp.i.not, label %while.end14, label %while.body, !llvm.loop !24
...
while.body:                                       ; preds = %while.body.lr.ph, %_ZNSt7__cxx1110_List_baseIiSaIiEED2Ev.exit
  %dec53.in = phi i64 [ %cond756, %while.body.lr.ph ], [ %dec53, %_ZNSt7__cxx1110_List_baseIiSaIiEED2Ev.exit ]
  %dec53 = add nsw i64 %dec53.in, -1
...
for.cond.cleanup:                                 ; preds = %_ZNSt7__cxx114listIiSaIiEE9push_backERKi.exit
...
for.body:                                         ; preds = %while.body, %_ZNSt7__cxx114listIiSaIiEE9push_backERKi.exit
  %i.050 = phi i32 [ 2, %while.body ], [ %inc, %_ZNSt7__cxx114listIiSaIiEE9push_backERKi.exit ]
  %call5.i.i.i.i.i.i25 = invoke noalias noundef nonnull dereferenceable(24) ptr @_Znwm(i64 noundef 24) #16
          to label %_ZNSt7__cxx114listIiSaIiEE9push_backERKi.exit unwind label %lpad

_ZNSt7__cxx114listIiSaIiEE9push_backERKi.exit:    ; preds = %for.body
  %_M_storage.i.i.i.i = getelementptr inbounds %"struct.std::_List_node", ptr %call5.i.i.i.i.i.i25, i64 0, i32 1
  store i32 %i.050, ptr %_M_storage.i.i.i.i, align 4, !tbaa !10
  call void @_ZNSt8__detail15_List_node_base7_M_hookEPS0_(ptr noundef nonnull align 8 dereferenceable(16) %call5.i.i.i.i.i.i25, ptr noundef nonnull %integers) #13
...
_ZNSt7__cxx1110_List_baseIiSaIiEED2Ev.exit:       ; preds = %while.body.i.i, %invoke.cont10
  ...
  %tobool.not = icmp eq i64 %dec53, 0
...
ehcleanup:                                        ; preds = %lpad9, %lpad
  ...
  %cmp.not9.i.i26 = icmp eq ptr %8, %integers
  br i1 %cmp.not9.i.i26, label %_ZNSt7__cxx1110_List_baseIiSaIiEED2Ev.exit30, label %while.body.i.i29

while.body.i.i29:                                 ; preds = %ehcleanup, %while.body.i.i29
  %__cur.010.i.i27 = phi ptr [ %9, %while.body.i.i29 ], [ %8, %ehcleanup ]
  %9 = load ptr, ptr %__cur.010.i.i27, align 8, !tbaa !5
  call void @_ZdlPv(ptr noundef %__cur.010.i.i27) #14
  %cmp.not.i.i28 = icmp eq ptr %9, %integers
  br i1 %cmp.not.i.i28, label %_ZNSt7__cxx1110_List_baseIiSaIiEED2Ev.exit30, label %while.body.i.i29, !llvm.loop !28

_ZNSt7__cxx1110_List_baseIiSaIiEED2Ev.exit30:     ; preds = %while.body.i.i29, %ehcleanup
  call void @llvm.lifetime.end.p0(i64 24, ptr nonnull %integers) #13
  br label %ehcleanup20

while.end:                                        ; preds = %_ZNSt7__cxx1110_List_baseIiSaIiEED2Ev.exit, %cond.end6
  %call1.i31 = invoke noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, ptr noundef nonnull @.str, i64 noundef 7)
...
invoke.cont13:                                    ; preds = %while.end
  ...
  %call.i3233 = invoke noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo9_M_insertImEERSoT_(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i64 noundef %sub.ptr.div.i)
          to label %invoke.cont16 unwind label %lpad12

invoke.cont16:                                    ; preds = %invoke.cont13
  %vtable.i = load ptr, ptr %call.i3233, align 8, !tbaa !30
  %vbase.offset.ptr.i = getelementptr i8, ptr %vtable.i, i64 -24
  %vbase.offset.i = load i64, ptr %vbase.offset.ptr.i, align 8
  %add.ptr.i = getelementptr inbounds i8, ptr %call.i3233, i64 %vbase.offset.i
  ...
  br i1 %tobool.not.i.i.i39, label %if.then.i.i.i40, label %_ZSt13__check_facetISt5ctypeIcEERKT_PS3_.exit.i.i
...
.noexc42:                                         ; preds = %if.end.i.i.i
  %vtable.i.i.i = load ptr, ptr %12, align 8, !tbaa !30
  %vfn.i.i.i = getelementptr inbounds ptr, ptr %vtable.i.i.i, i64 6
  %15 = load ptr, ptr %vfn.i.i.i, align 8
  %call.i.i.i43 = invoke noundef signext i8 %15(ptr noundef nonnull align 8 dereferenceable(570) %12, i8 noundef signext 10)
...
_ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc.exit.i: ; preds = %.noexc42, %if.then.i4.i.i
  %retval.0.i.i.i = phi i8 [ %14, %if.then.i4.i.i ], [ %call.i.i.i43, %.noexc42 ]
  %call1.i44 = invoke noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call.i3233, i8 noundef signext %retval.0.i.i.i)
...
lpad12:                                           ; preds = %call1.i.noexc, %_ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc.exit.i, %.noexc42, %if.end.i.i.i, %if.then.i.i.i40, %invoke.cont13, %while.end
  %16 = landingpad { ptr, i32 }
          cleanup
  br label %ehcleanup20

ehcleanup20:                                      ; preds = %lpad12, %_ZNSt7__cxx1110_List_baseIiSaIiEED2Ev.exit30
  %.pn.pn = phi { ptr, i32 } [ %.pn, %_ZNSt7__cxx1110_List_baseIiSaIiEED2Ev.exit30 ], [ %16, %lpad12 ]
...
if.then.i.i.i37:                                  ; preds = %ehcleanup20
  call void @_ZdlPv(ptr noundef nonnull %17) #14
  br label %_ZNSt6vectorIiSaIiEED2Ev.exit38

_ZNSt6vectorIiSaIiEED2Ev.exit38:                  ; preds = %ehcleanup20, %if.then.i.i.i37
  call void @llvm.lifetime.end.p0(i64 24, ptr nonnull %primes) #13
