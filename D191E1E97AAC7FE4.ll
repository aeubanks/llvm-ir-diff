...
if.end:                                           ; preds = %entry
  %call = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %real_url) #17
  %call1 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %display_url) #17
  ...
  %call9 = tail call ptr @cli_malloc(i64 noundef %add8) #18
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %mdata) #18
  %tobool10.not = icmp eq ptr %call9, null
  br i1 %tobool10.not, label %cleanup115, label %if.end12

if.end12:                                         ; preds = %if.end
  %call13 = tail call ptr @strncpy(ptr noundef nonnull %call9, ptr noundef %real_url, i64 noundef %call) #18
...
if.end28.thread:                                  ; preds = %if.end12
  tail call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str, ptr noundef nonnull %call9) #18
  br label %if.then30

if.then20:                                        ; preds = %if.end12
  %add.ptr21 = getelementptr inbounds i8, ptr %arrayidx, i64 1
  %call22 = tail call ptr @strncpy(ptr noundef nonnull %add.ptr21, ptr noundef %display_url, i64 noundef %call1) #18
...
if.then30:                                        ; preds = %if.end28.thread, %if.end28
  %call31 = call i32 @cli_ac_initdata(ptr noundef nonnull %mdata, i32 noundef 0, i8 noundef zeroext 8) #18
...
for.body:                                         ; preds = %for.body.lr.ph, %for.inc
  ...
  %call38 = call i32 @cli_ac_scanbuff(ptr noundef nonnull %call9, i32 noundef %conv36, ptr noundef %info, ptr noundef %arrayidx37, ptr noundef nonnull %mdata, i8 noundef zeroext 0, i32 noundef 0, i32 noundef 0, i32 noundef -1, ptr noundef null) #18
  call void @cli_ac_freedata(ptr noundef nonnull %mdata) #18
  %tobool39.not = icmp eq i32 %call38, 0
  br i1 %tobool39.not, label %for.inc, label %if.then40

if.then40:                                        ; preds = %for.body
  %3 = load ptr, ptr %info, align 8, !tbaa !16
  %call41 = call ptr @strchr(ptr noundef nonnull dereferenceable(1) %3, i32 noundef 58) #17
...
cond.true43:                                      ; preds = %if.then40
  ...
  %call45 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %add.ptr44) #17
  br label %cond.end47
...
if.then84:                                        ; preds = %land.lhs.true73, %land.lhs.true73, %land.lhs.true67
  ...
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.1, ptr noundef nonnull %call9, ptr noundef %4) #18
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.2, ptr noundef %real_url) #18
...
if.then88:                                        ; preds = %if.then84
  ...
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.3, ptr noundef %real_url) #18
...
cleanup:                                          ; preds = %lor.lhs.false70, %cond.end47, %land.lhs.true73
  ...
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.4, ptr noundef nonnull %call9, ptr noundef %6, i32 noundef %conv94) #18
  br label %for.inc
...
if.end29.i:                                       ; preds = %sw.bb23.i
  %call.i = call i32 @cli_regexec(ptr noundef nonnull %20, ptr noundef nonnull %c.addr.0.i, i64 noundef 0, ptr noundef null, i32 noundef 0) #18
...
sw.default.i:                                     ; preds = %for.cond.i
  call void (ptr, ...) @cli_errmsg(ptr noundef nonnull @.str.38, i32 noundef %10) #18
...
cleanup115.sink.split:                            ; preds = %lor.lhs.false136.i, %lor.lhs.false.i, %if.then75.i, %while.body88.i, %while.body130.i, %if.then84, %if.then88, %cleanup.i, %if.then100
  ...
  call void @free(ptr noundef %call9) #18
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull %.str.5.sink) #18
  br label %cleanup115
...
cleanup115:                                       ; preds = %cleanup115.sink.split, %if.then30, %if.end
  ...
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %mdata) #18
  br label %return
...
if.then:                                          ; preds = %entry
  %call = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %buffer) #17
...
if.end:                                           ; preds = %entry
  ...
  tail call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.15, i64 noundef %pos, i64 noundef %1, i64 noundef %2, ptr noundef %0, ptr noundef %buffer) #18
...
land.rhs.lr.ph:                                   ; preds = %if.end
  %call11 = tail call ptr @__ctype_b_loc() #20
...
while.end40:                                      ; preds = %while.cond33
  ...
  tail call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.16, ptr noundef nonnull %arrayidx34.le) #18
...
entry:
  ...
  %call.i.i = tail call ptr @cli_malloc(i64 noundef 32) #18
...
if.end:                                           ; preds = %entry
  ...
  %call.i.i42 = tail call ptr @cli_malloc(i64 noundef 32) #18
...
if.end8:                                          ; preds = %if.end
  ...
  %call.i = tail call ptr @cli_malloc(i64 noundef 8192) #18
...
if.end14:                                         ; preds = %if.end8
  ...
  %call.i53 = tail call ptr @cli_malloc(i64 noundef 8192) #18
...
if.end10:                                         ; preds = %if.then5, %if.end2
  %call11292 = call ptr @fgets(ptr noundef nonnull %buffer, i32 noundef 8192, ptr noundef nonnull %fd)
  %tobool12.not293 = icmp eq ptr %call11292, null
  br i1 %tobool12.not293, label %while.end, label %while.body.lr.ph
...
while.body:                                       ; preds = %while.body.lr.ph, %cleanup121
  %line.0294 = phi i32 [ 0, %while.body.lr.ph ], [ %line.1, %cleanup121 ]
  %call14 = call i32 @cli_chomp(ptr noundef nonnull %buffer) #18
...
if.end18:                                         ; preds = %while.body
  %call.i = call ptr @strrchr(ptr noundef nonnull dereferenceable(1) %buffer, i32 noundef 58) #17
...
if.end.i:                                         ; preds = %if.end18
  ...
  %call1.i = call ptr @strchr(ptr noundef nonnull dereferenceable(1) %incdec.ptr.i, i32 noundef 45) #17
...
for.body.lr.ph.i:                                 ; preds = %if.else.i
  %call6.i = tail call ptr @__ctype_b_loc() #20
...
for.cond12.preheader.i:                           ; preds = %for.cond.i, %if.else.i
  %call13.i = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %incdec.ptr4.i) #17
...
for.body16.lr.ph.i:                               ; preds = %for.cond12.preheader.i
  %call17.i = tail call ptr @__ctype_b_loc() #20
...
for.end29.i:                                      ; preds = %for.cond12.i, %for.cond12.preheader.i
  ...
  %call.i.i = call i64 @strtol(ptr nocapture noundef nonnull %incdec.ptr.i, ptr noundef null, i32 noundef 10) #18
...
if.else37.i:                                      ; preds = %for.end29.i
  %call.i79.i = call i64 @strtol(ptr nocapture noundef nonnull %incdec.ptr4.i, ptr noundef null, i32 noundef 10) #18
...
if.end40.i:                                       ; preds = %if.else37.i, %for.end29.i
  ...
  %call41.i = call i32 @cl_retflevel() #18
...
if.then45.i:                                      ; preds = %if.end40.i
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.17, ptr noundef nonnull %buffer, i32 noundef %conv.i.i) #18
  br label %cleanup121, !llvm.loop !51

if.end47.i:                                       ; preds = %if.end40.i
  %call48.i = call i32 @cl_retflevel() #18
...
if.end23:                                         ; preds = %for.body.i, %for.body16.i, %if.end18, %if.end.i, %if.end53.i
  %inc = add nsw i32 %line.0294, 1
  %call25 = call ptr @strchr(ptr noundef nonnull dereferenceable(1) %buffer, i32 noundef 58) #17
  %tobool26.not = icmp eq ptr %call25, null
  br i1 %tobool26.not, label %if.then27, label %if.end28

if.then27:                                        ; preds = %if.end23
  call void (ptr, ...) @cli_errmsg(ptr noundef nonnull @.str.10, i32 noundef %inc) #18
...
if.then31:                                        ; preds = %if.end28
  %call32 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %incdec.ptr) #17
  %cmp33 = icmp ult i64 %call32, 8192
  br i1 %cmp33, label %lor.lhs.false, label %cleanup

cleanup:                                          ; preds = %if.then31
  call void (ptr, ...) @cli_errmsg(ptr noundef nonnull @.str.11, i32 noundef %inc) #18
  call void @regex_list_done(ptr noundef %matcher)
  store i32 -1, ptr %list_inited, align 8, !tbaa !5
  br label %cleanup133
...
if.then53:                                        ; preds = %lor.lhs.false, %if.end37
  ...
  call void @llvm.lifetime.start.p0(i64 24, ptr nonnull %token.i.i) #18
  %call.i.i195 = call ptr @cli_malloc(i64 noundef 80) #18
...
if.end12.i.i:                                     ; preds = %if.then3.i.i
  switch i8 %18, label %do.cond.i.i [
    i8 5, label %if.then21.i.i
    i8 2, label %if.then21.i.i
    i8 3, label %if.then45.i.i
  ]
...
if.then34.i.i:                                    ; preds = %if.else.i.i
  ...
  %call35.i.i = call ptr @cli_realloc2(ptr noundef nonnull %altpositions.0.i.i, i64 noundef %mul.i.i) #18
  %tobool36.not.i.i = icmp eq ptr %call35.i.i, null
  br i1 %tobool36.not.i.i, label %find_regex_start.exit.i, label %do.cond.i.i

if.then45.i.i:                                    ; preds = %if.end12.i.i
  %dec.i.i = add i64 %altpositions_cnt.0.i.i, -1
  br label %do.cond.i.i
...
do.cond.i.i:                                      ; preds = %if.then50.i.i, %if.else48.i.i, %if.then45.i.i, %if.then34.i.i, %if.else.i.i, %if.then28.i.i, %if.end12.i.i, %if.end12.thread.i.i
  %last.1.i.i = phi ptr [ %pat.addr.0.i.i, %if.then28.i.i ], [ %pat.addr.0.i.i, %if.then34.i.i ], [ %pat.addr.0.i.i, %if.else.i.i ], [ %pat.addr.0.i.i, %if.then45.i.i ], [ %22, %if.then50.i.i ], [ %last.0.i.i, %if.else48.i.i ], [ %pat.addr.0.i.i, %if.end12.i.i ], [ %pat.addr.0.i.i, %if.end12.thread.i.i ]
  %altpositions.1.i.i = phi ptr [ %altpositions.0.i.i, %if.then28.i.i ], [ %call35.i.i, %if.then34.i.i ], [ %altpositions.0.i.i, %if.else.i.i ], [ %altpositions.0.i.i, %if.then45.i.i ], [ %altpositions.0.i.i, %if.then50.i.i ], [ %altpositions.0.i.i, %if.else48.i.i ], [ %altpositions.0.i.i, %if.end12.i.i ], [ %altpositions.0.i.i, %if.end12.thread.i.i ]
  %altpositions_capacity.1.i.i = phi i64 [ %altpositions_capacity.0.i.i, %if.then28.i.i ], [ %add.i.i, %if.then34.i.i ], [ %altpositions_capacity.0.i.i, %if.else.i.i ], [ %altpositions_capacity.0.i.i, %if.then45.i.i ], [ %altpositions_capacity.0.i.i, %if.then50.i.i ], [ %altpositions_capacity.0.i.i, %if.else48.i.i ], [ %altpositions_capacity.0.i.i, %if.end12.i.i ], [ %altpositions_capacity.0.i.i, %if.end12.thread.i.i ]
  %altpositions_cnt.1.i.i = phi i64 [ %altpositions_cnt.0.i.i, %if.then28.i.i ], [ %altpositions_capacity.0.i.i, %if.then34.i.i ], [ %inc.i.i, %if.else.i.i ], [ %dec.i.i, %if.then45.i.i ], [ %altpositions_cnt.0.i.i, %if.then50.i.i ], [ 0, %if.else48.i.i ], [ %altpositions_cnt.0.i.i, %if.end12.i.i ], [ %altpositions_cnt.0.i.i, %if.end12.thread.i.i ]
...
do.end.i.i:                                       ; preds = %do.cond.i.i
  call void @free(ptr noundef %altpositions.1.i.i) #18
...
find_regex_start.exit.i:                          ; preds = %if.then34.i.i, %do.end.i.i, %if.then53
  ...
  call void @llvm.lifetime.end.p0(i64 24, ptr nonnull %token.i.i) #18
  call void @llvm.lifetime.start.p0(i64 24, ptr nonnull %token.i) #18
...
if.then.i.i:                                      ; preds = %find_regex_start.exit.i
  ...
  %call.i190.i = call ptr @cli_realloc2(ptr noundef %28, i64 noundef 32768) #18
...
stack_push.exit.i:                                ; preds = %if.end6.i.i, %if.then.i.i
  %op400.i = getelementptr inbounds %struct.tree_node, ptr %cond.i, i64 0, i32 2
  %31 = load i32, ptr %op400.i, align 4, !tbaa !20
  %cmp.not401.i = icmp eq i32 %31, 4
  br i1 %cmp.not401.i, label %add_pattern.exit, label %for.body.i198

for.body.i198:                                    ; preds = %stack_push.exit.i, %sw.epilog.i
  %pat.addr.0403.i = phi ptr [ %call4.i, %sw.epilog.i ], [ %incdec.ptr, %stack_push.exit.i ]
  %node.0402.i = phi ptr [ %node.4.i, %sw.epilog.i ], [ %cond.i, %stack_push.exit.i ]
  %cmp3.i = icmp ult ptr %pat.addr.0403.i, %retval.0.i.i
  br i1 %cmp3.i, label %if.end9.i, label %if.else.i199

if.else.i199:                                     ; preds = %for.body.i198
  %32 = load i8, ptr %pat.addr.0403.i, align 1, !tbaa !13
  %tobool5.not.i = icmp eq i8 %32, 0
  br i1 %tobool5.not.i, label %sw.bb70.i, label %if.then6.i

if.then6.i:                                       ; preds = %if.else.i199
  store ptr %pat.addr.0403.i, ptr %token.i, align 8, !tbaa !13
  br label %sw.bb70.i

if.end9.i:                                        ; preds = %for.body.i198
  %call4.i = call fastcc ptr @getNextToken(ptr noundef %pat.addr.0403.i, ptr noundef nonnull %token.i)
...
sw.bb.i:                                          ; preds = %if.end9.i
  ...
  %op.i.i.i = getelementptr inbounds %struct.tree_node, ptr %node.0402.i, i64 0, i32 2
  %34 = load i32, ptr %op.i.i.i, align 4, !tbaa !20
  %cmp.i.i.i = icmp eq i32 %34, 2
  %u.i.i.i = getelementptr inbounds %struct.tree_node, ptr %node.0402.i, i64 0, i32 5
...
tree_node_get_children.exit.i.i:                  ; preds = %cond.true.i.i.i, %sw.bb.i
  ...
  %alternatives.i.i = getelementptr inbounds %struct.tree_node, ptr %node.0402.i, i64 0, i32 3
...
land.lhs.true2.i.i.i:                             ; preds = %tree_node_get_children.exit.i.i.i
  ...
  %spec.select.i.i200.i = select i1 %tobool3.not.i.i.i, ptr %node.0402.i, ptr %43
...
tree_get_next.exit.i.i:                           ; preds = %if.else8.i.i.i, %if.else.i.i.i, %land.lhs.true2.i.i.i
  %retval.0.i.i.i = phi ptr [ %45, %if.else8.i.i.i ], [ %node.0402.i, %if.else.i.i.i ], [ %spec.select.i.i200.i, %land.lhs.true2.i.i.i ]
  ...
  %call2.i.i = call ptr @cli_realloc2(ptr noundef %35, i64 noundef %mul.i.i.i) #18
  store ptr %call2.i.i, ptr %u.i.i.i, align 8, !tbaa !13
  %tobool.not.i203.i = icmp ne ptr %call2.i.i, null
  call void @llvm.assume(i1 %tobool.not.i203.i)
  %46 = load i32, ptr %op.i.i.i, align 4, !tbaa !20
  ...
  %call.i.i.i = call ptr @cli_malloc(i64 noundef 32) #18
  %cond58.i.i = icmp eq ptr %call.i.i.i, null
  br i1 %cond58.i.i, label %if.end14.i.i, label %if.then.i.i.i

if.then.i.i.i:                                    ; preds = %tree_get_next.exit.i.i
  %cmp7.i207.i = icmp eq ptr %retval.0.i.i.i, %node.0402.i
...
if.end14.i.i:                                     ; preds = %if.then.i.i.i, %tree_get_next.exit.i.i
...
if.then.i225.i:                                   ; preds = %sw.bb19.i
  ...
  %call.i223.i = call ptr @cli_realloc2(ptr noundef %51, i64 noundef %mul.i222.i) #18
...
if.then.i242.i:                                   ; preds = %stack_push.exit232.i
  ...
  %call.i240.i = call ptr @cli_realloc2(ptr noundef %56, i64 noundef %mul.i239.i) #18
...
if.end6.i247.i:                                   ; preds = %if.then.if.end6_crit_edge.i244.i, %entry.if.end6_crit_edge.i237.i
  ...
  store ptr %node.0402.i, ptr %arrayidx.i246.i, align 8, !tbaa !16
  br label %sw.epilog.i

sw.bb24.i:                                        ; preds = %if.end9.i
  %call.i250.i = call ptr @cli_malloc(i64 noundef 32) #18
...
tree_node_alloc.exit.i:                           ; preds = %if.then.i253.i, %sw.bb24.i
  ...
  call fastcc void @tree_node_insert_nonbin(ptr noundef nonnull %node.0402.i, ptr noundef %call.i250.i)
  %59 = load i64, ptr %cnt.i186.i, align 8, !tbaa !45
  %tobool.not.i256399.i = icmp eq i64 %59, 0
  br i1 %tobool.not.i256399.i, label %while.end.i, label %stack_pop.exit.i
...
for.body.preheader.i.i:                           ; preds = %if.then1.i.i
  ...
  %xtraiter418 = and i64 %conv.i273.i, 3
  %69 = icmp ult i8 %66, 4
...
if.end47.i.i:                                     ; preds = %if.then27.i.i, %if.else23.i.i
  %call49.i.i = call ptr @cli_realloc2(ptr noundef %64, i64 noundef 16) #18
...
tree_node_insert_nonbin.exit.i.loopexit.unr-lcssa: ; preds = %for.body.i.i, %for.body.preheader.i.i
  ...
  br i1 %lcmp.mod419.not, label %tree_node_insert_nonbin.exit.i, label %for.body.i.i.epil
...
for.body.i.i.epil:                                ; preds = %tree_node_insert_nonbin.exit.i.loopexit.unr-lcssa, %for.body.i.i.epil
  ...
  %epil.iter.cmp.not = icmp eq i64 %epil.iter.next, %xtraiter418
...
if.then.i291.i:                                   ; preds = %sw.bb32.i
  ...
  %call.i289.i = call ptr @cli_realloc2(ptr noundef %88, i64 noundef %mul.i288.i) #18
...
if.end6.i296.i:                                   ; preds = %if.then.if.end6_crit_edge.i293.i, %entry.if.end6_crit_edge.i286.i
  ...
  store ptr %node.0402.i, ptr %arrayidx.i295.i, align 8, !tbaa !16
...
if.then.i315.i:                                   ; preds = %stack_pop.exit305.i
  ...
  %call.i313.i = call ptr @cli_realloc2(ptr noundef %96, i64 noundef %mul.i312.i) #18
...
sw.bb39.i:                                        ; preds = %if.end9.i
  %op.i.i323.i = getelementptr inbounds %struct.tree_node, ptr %node.0402.i, i64 0, i32 2
  %99 = load i32, ptr %op.i.i323.i, align 4, !tbaa !20
  %cmp.i.i324.i = icmp eq i32 %99, 2
  %u.i.i325.i = getelementptr inbounds %struct.tree_node, ptr %node.0402.i, i64 0, i32 5
...
tree_node_get_children.exit.i333.i:               ; preds = %cond.true.i.i329.i, %sw.bb39.i
  ...
  %alternatives.i331.i = getelementptr inbounds %struct.tree_node, ptr %node.0402.i, i64 0, i32 3
  ...
  br i1 %or.cond.i332.i, label %land.lhs.true2.i.i, label %if.else.i335.i
...
land.lhs.true2.i.i:                               ; preds = %tree_node_get_children.exit.i333.i
  ...
  %spec.select.i.i = select i1 %tobool3.not.i.i, ptr %node.0402.i, ptr %103
  br label %tree_get_next.exit.i

if.else.i335.i:                                   ; preds = %tree_node_get_children.exit.i333.i
  %cmp.i334.i = icmp slt i8 %102, 2
  br i1 %cmp.i334.i, label %tree_get_next.exit.i, label %if.else8.i.i

if.else8.i.i:                                     ; preds = %if.else.i335.i
  %104 = load ptr, ptr %cond6.i.i330.i, align 8, !tbaa !16
  %105 = load ptr, ptr %104, align 8, !tbaa !31
  br label %tree_get_next.exit.i

tree_get_next.exit.i:                             ; preds = %if.else8.i.i, %if.else.i335.i, %land.lhs.true2.i.i
  %retval.0.i336.i = phi ptr [ %105, %if.else8.i.i ], [ %node.0402.i, %if.else.i335.i ], [ %spec.select.i.i, %land.lhs.true2.i.i ]
  %call.i338.i = call ptr @cli_malloc(i64 noundef 32) #18
  %tobool.not.i339.i = icmp eq ptr %call.i338.i, null
  br i1 %tobool.not.i339.i, label %tree_node_alloc.exit345.i, label %if.then.i343.i

if.then.i343.i:                                   ; preds = %tree_get_next.exit.i
  %alternatives.i340.i = getelementptr inbounds %struct.tree_node, ptr %call.i338.i, i64 0, i32 3
  store i8 0, ptr %alternatives.i340.i, align 8, !tbaa !28
  store ptr %retval.0.i336.i, ptr %call.i338.i, align 8, !tbaa !31
  %listend2.i341.i = getelementptr inbounds %struct.tree_node, ptr %call.i338.i, i64 0, i32 4
  store i8 1, ptr %listend2.i341.i, align 1, !tbaa !30
  %u.i342.i = getelementptr inbounds %struct.tree_node, ptr %call.i338.i, i64 0, i32 5
  store ptr null, ptr %u.i342.i, align 8, !tbaa !13
  br label %tree_node_alloc.exit345.i

tree_node_alloc.exit345.i:                        ; preds = %if.then.i343.i, %tree_get_next.exit.i
  ...
  %tobool.not.i346.i = icmp eq i32 %bcmp.i.i, 0
  br i1 %tobool.not.i346.i, label %if.else59.i, label %for.inc.i.i

for.inc.i.i:                                      ; preds = %tree_node_alloc.exit345.i
...
if.then47.i:                                      ; preds = %for.inc.10.i.i
  %op48.i = getelementptr inbounds %struct.tree_node, ptr %call.i338.i, i64 0, i32 2
  store i32 2, ptr %op48.i, align 4, !tbaa !20
  %call49.i = call ptr @cli_malloc(i64 noundef 16) #18
  %u50.i = getelementptr inbounds %struct.tree_node, ptr %call.i338.i, i64 0, i32 5
...
if.end54.i:                                       ; preds = %if.then47.i
  ...
  call fastcc void @tree_node_insert_nonbin(ptr noundef nonnull %node.0402.i, ptr noundef nonnull %call.i338.i)
  br label %sw.epilog.i

if.else59.i:                                      ; preds = %for.inc.10.i.i, %for.inc.9.i.i, %for.inc.8.i.i, %for.inc.7.i.i, %for.inc.6.i.i, %for.inc.5.i.i, %for.inc.4.i.i, %for.inc.3.i.i, %for.inc.2.i.i, %for.inc.1.i.i, %for.inc.i.i, %tree_node_alloc.exit345.i
  %retval.0.i348.ph.i = phi i8 [ 10, %for.inc.9.i.i ], [ 9, %for.inc.8.i.i ], [ 8, %for.inc.7.i.i ], [ 7, %for.inc.6.i.i ], [ 6, %for.inc.5.i.i ], [ 5, %for.inc.4.i.i ], [ 4, %for.inc.3.i.i ], [ 3, %for.inc.2.i.i ], [ 2, %for.inc.1.i.i ], [ 1, %for.inc.i.i ], [ 0, %tree_node_alloc.exit345.i ], [ 11, %for.inc.10.i.i ]
  %op60.i = getelementptr inbounds %struct.tree_node, ptr %call.i338.i, i64 0, i32 2
  store i32 1, ptr %op60.i, align 4, !tbaa !20
  %c61.i = getelementptr inbounds %struct.tree_node, ptr %call.i338.i, i64 0, i32 1
  store i8 %retval.0.i348.ph.i, ptr %c61.i, align 8, !tbaa !24
  call fastcc void @tree_node_insert_nonbin(ptr noundef nonnull %node.0402.i, ptr noundef %call.i338.i)
  br label %sw.epilog.i

sw.bb64.i:                                        ; preds = %if.end9.i
  %op.i.i350.i = getelementptr inbounds %struct.tree_node, ptr %node.0402.i, i64 0, i32 2
  %108 = load i32, ptr %op.i.i350.i, align 4, !tbaa !20
  %cmp.i.i351.i = icmp eq i32 %108, 2
  %u.i.i352.i = getelementptr inbounds %struct.tree_node, ptr %node.0402.i, i64 0, i32 5
  %109 = load ptr, ptr %u.i.i352.i, align 8, !tbaa !13
  br i1 %cmp.i.i351.i, label %cond.true.i.i356.i, label %tree_node_get_children.exit.i362.i

cond.true.i.i356.i:                               ; preds = %sw.bb64.i
  %arrayidx.i.i353.i = getelementptr inbounds ptr, ptr %109, i64 1
  %110 = load ptr, ptr %arrayidx.i.i353.i, align 8, !tbaa !16
  %tobool.not.i.i354.i = icmp eq ptr %110, null
  %spec.select.i.i355.i = select i1 %tobool.not.i.i354.i, ptr null, ptr %arrayidx.i.i353.i
  br label %tree_node_get_children.exit.i362.i

tree_node_get_children.exit.i362.i:               ; preds = %cond.true.i.i356.i, %sw.bb64.i
  %cond6.i.i357.i = phi ptr [ %spec.select.i.i355.i, %cond.true.i.i356.i ], [ %109, %sw.bb64.i ]
  %alternatives.i358.i = getelementptr inbounds %struct.tree_node, ptr %node.0402.i, i64 0, i32 3
  %111 = load i8, ptr %alternatives.i358.i, align 8, !tbaa !28
  %tobool.i359.i = icmp eq i8 %111, 0
  %tobool1.i360.i = icmp ne ptr %cond6.i.i357.i, null
  %or.cond.i361.i = select i1 %tobool.i359.i, i1 %tobool1.i360.i, i1 false
  br i1 %or.cond.i361.i, label %land.lhs.true2.i365.i, label %if.else.i367.i

land.lhs.true2.i365.i:                            ; preds = %tree_node_get_children.exit.i362.i
  %112 = load ptr, ptr %cond6.i.i357.i, align 8, !tbaa !16
  %tobool3.not.i363.i = icmp eq ptr %112, null
  %spec.select.i364.i = select i1 %tobool3.not.i363.i, ptr %node.0402.i, ptr %112
  br label %tree_get_next.exit371.i

if.else.i367.i:                                   ; preds = %tree_node_get_children.exit.i362.i
  %cmp.i366.i = icmp slt i8 %111, 2
  br i1 %cmp.i366.i, label %tree_get_next.exit371.i, label %if.else8.i368.i

if.else8.i368.i:                                  ; preds = %if.else.i367.i
  %113 = load ptr, ptr %cond6.i.i357.i, align 8, !tbaa !16
  %114 = load ptr, ptr %113, align 8, !tbaa !31
  br label %tree_get_next.exit371.i

tree_get_next.exit371.i:                          ; preds = %if.else8.i368.i, %if.else.i367.i, %land.lhs.true2.i365.i
  %retval.0.i369.i = phi ptr [ %114, %if.else8.i368.i ], [ %node.0402.i, %if.else.i367.i ], [ %spec.select.i364.i, %land.lhs.true2.i365.i ]
  %call.i372.i = call ptr @cli_malloc(i64 noundef 32) #18
  %tobool.not.i373.i = icmp eq ptr %call.i372.i, null
  br i1 %tobool.not.i373.i, label %tree_node_alloc.exit379.i, label %if.then.i377.i

if.then.i377.i:                                   ; preds = %tree_get_next.exit371.i
  %alternatives.i374.i = getelementptr inbounds %struct.tree_node, ptr %call.i372.i, i64 0, i32 3
  store i8 0, ptr %alternatives.i374.i, align 8, !tbaa !28
  store ptr %retval.0.i369.i, ptr %call.i372.i, align 8, !tbaa !31
  %listend2.i375.i = getelementptr inbounds %struct.tree_node, ptr %call.i372.i, i64 0, i32 4
  store i8 1, ptr %listend2.i375.i, align 1, !tbaa !30
  %u.i376.i = getelementptr inbounds %struct.tree_node, ptr %call.i372.i, i64 0, i32 5
  store ptr null, ptr %u.i376.i, align 8, !tbaa !13
  br label %tree_node_alloc.exit379.i

tree_node_alloc.exit379.i:                        ; preds = %if.then.i377.i, %tree_get_next.exit371.i
  %op68.i = getelementptr inbounds %struct.tree_node, ptr %call.i372.i, i64 0, i32 2
  store i32 3, ptr %op68.i, align 4, !tbaa !20
  call fastcc void @tree_node_insert_nonbin(ptr noundef nonnull %node.0402.i, ptr noundef %call.i372.i)
  br label %sw.epilog.i
...
sw.bb70.i:                                        ; preds = %if.end9.i, %if.end9.i, %if.then6.i, %if.else.i199
  ...
  %op.le.i = getelementptr inbounds %struct.tree_node, ptr %node.0402.i, i64 0, i32 2
  %call71.i = call ptr @cli_malloc(i64 noundef 16) #18
...
if.end74.i:                                       ; preds = %sw.bb70.i
  %call75.i = call ptr @cli_strdup(ptr noundef nonnull %add.ptr) #18
...
if.then81.i:                                      ; preds = %if.end74.i
  %call83.i = call ptr @cli_malloc(i64 noundef 32) #18
...
if.end86.i:                                       ; preds = %if.then81.i
  ...
  %call90.i201 = call i32 @cli_regcomp(ptr noundef nonnull %call83.i, ptr noundef %116, i32 noundef 1) #18
...
if.end94.i:                                       ; preds = %if.end86.i
  %call95.i = call ptr @cli_malloc(i64 noundef 32) #18
...
cleanup102.i:                                     ; preds = %if.end94.i
  ...
  store ptr %node.0402.i, ptr %call95.i, align 8, !tbaa !31
  ...
  call fastcc void @tree_node_insert_nonbin(ptr noundef nonnull %node.0402.i, ptr noundef nonnull %call95.i)
...
if.else106.i:                                     ; preds = %if.end74.i
  ...
  %alternatives108.i = getelementptr inbounds %struct.tree_node, ptr %node.0402.i, i64 0, i32 3
  store i8 0, ptr %alternatives108.i, align 8, !tbaa !28
  %u109.i = getelementptr inbounds %struct.tree_node, ptr %node.0402.i, i64 0, i32 5
  store ptr %call71.i, ptr %u109.i, align 8, !tbaa !13
  store i32 4, ptr %op.le.i, align 4, !tbaa !20
  br label %add_pattern.exit

sw.epilog.i:                                      ; preds = %while.body.i.i, %tree_node_alloc.exit379.i, %if.else59.i, %if.end54.i, %if.end6.i320.i, %if.then.i315.i, %cond.true.i279.i, %while.end.i, %if.end6.i247.i, %if.then.i242.i, %if.end28.i.i, %if.end9.i
  %node.4.i = phi ptr [ %node.0402.i, %if.end9.i ], [ %call.i372.i, %tree_node_alloc.exit379.i ], [ %call.i.i.i, %if.end28.i.i ], [ %node.0402.i, %if.then.i242.i ], [ %node.0402.i, %if.end6.i247.i ], [ %call.i250.i, %while.end.i ], [ %call.i250.i, %cond.true.i279.i ], [ %cond.i304.i, %if.then.i315.i ], [ %cond.i304.i, %if.end6.i320.i ], [ %call.i338.i, %if.else59.i ], [ %call.i338.i, %if.end54.i ], [ %39, %while.body.i.i ]
...
add_pattern.exit:                                 ; preds = %sw.epilog.i, %stack_push.exit.i, %cleanup102.i, %if.else106.i
  call void @llvm.lifetime.end.p0(i64 24, ptr nonnull %token.i) #18
  br label %cleanup121
...
if.else64:                                        ; preds = %if.end37, %lor.lhs.false
  %or.cond229.v = phi i8 [ 72, %if.end37 ], [ 77, %lor.lhs.false ]
  %119 = phi i8 [ %14, %if.end37 ], [ %15, %lor.lhs.false ]
  %or.cond229 = icmp eq i8 %119, %or.cond229.v
...
if.then80:                                        ; preds = %if.then78
  ...
  %call84 = call ptr @cli_realloc(ptr noundef %121, i64 noundef %mul) #18
...
if.end90:                                         ; preds = %if.then80
  ...
  %call94 = call i32 @cli_ac_init(ptr noundef nonnull %arrayidx93, i8 noundef zeroext %124, i8 noundef zeroext %125) #18
...
if.end107:                                        ; preds = %cleanup99, %if.else102
  ...
  %call.i202 = call ptr @cli_calloc(i64 noundef 1, i64 noundef 96) #18
...
if.end.i207:                                      ; preds = %if.end107
  %call1.i204 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %incdec.ptr) #17
...
if.end9.i209:                                     ; preds = %if.then6.i208, %if.end.i207
  ...
  %call10.i = call ptr @cli_malloc(i64 noundef %mul.i) #18
...
if.then110.thread251:                             ; preds = %if.end9.i209
  call void @free(ptr noundef nonnull %call.i202) #18
...
for.body.i212.preheader:                          ; preds = %for.cond.preheader.i
  ...
  br i1 %min.iters.check, label %for.body.i212.preheader386, label %vector.memcheck

vector.memcheck:                                  ; preds = %for.body.i212.preheader
  %128 = shl i64 %call1.i204, 1
  %scevgep = getelementptr i8, ptr %call10.i, i64 %128
  %scevgep383 = getelementptr i8, ptr %call25, i64 1
  %scevgep384 = getelementptr i8, ptr %scevgep383, i64 %call1.i204
  %bound0 = icmp ult ptr %call10.i, %scevgep384
  %bound1 = icmp ult ptr %incdec.ptr, %scevgep
  %found.conflict = and i1 %bound0, %bound1
  br i1 %found.conflict, label %for.body.i212.preheader386, label %vector.ph
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load385 = load <8 x i8>, ptr %130, align 1, !tbaa !13, !alias.scope !73
  %131 = sext <8 x i8> %wide.load to <8 x i16>
  %132 = sext <8 x i8> %wide.load385 to <8 x i16>
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %for.end.i, label %for.body.i212.preheader386

for.body.i212.preheader386:                       ; preds = %vector.memcheck, %for.body.i212.preheader, %middle.block
...
for.body.i212.prol:                               ; preds = %for.body.i212.preheader386, %for.body.i212.prol
  %i.060.i.prol = phi i64 [ %inc.i210.prol, %for.body.i212.prol ], [ %i.060.i.ph, %for.body.i212.preheader386 ]
  %prol.iter = phi i64 [ %prol.iter.next, %for.body.i212.prol ], [ 0, %for.body.i212.preheader386 ]
...
for.body.i212.prol.loopexit:                      ; preds = %for.body.i212.prol, %for.body.i212.preheader386
  %i.060.i.unr = phi i64 [ %i.060.i.ph, %for.body.i212.preheader386 ], [ %inc.i210.prol, %for.body.i212.prol ]
...
for.end.i:                                        ; preds = %for.body.i212.prol.loopexit, %for.body.i212, %middle.block, %for.cond.preheader.i
  %call21.i = call ptr @cli_strdup(ptr noundef nonnull %add.ptr) #18
  ...
  %call22.i = call i32 @cli_ac_addpatt(ptr noundef nonnull %root.2, ptr noundef nonnull %call.i202) #18
...
cleanup121:                                       ; preds = %add_pattern.exit, %for.end.i, %if.then45.i, %if.end47.i, %while.body
  %line.1 = phi i32 [ %line.0294, %while.body ], [ %line.0294, %if.end47.i ], [ %line.0294, %if.then45.i ], [ %inc, %for.end.i ], [ %inc, %add_pattern.exit ]
...
if.then3.i:                                       ; preds = %if.end.i216
  ...
  %call.i218 = call i32 @cli_ac_buildtrie(ptr noundef nonnull %arrayidx.i217) #18
...
regex_list_cleanup.exit:                          ; preds = %stack_destroy.exit.i, %if.then.i8.i
  ...
  %call.i.i228 = call ptr @cli_malloc(i64 noundef 8192) #18
  ...
  %call.i13.i = call ptr @cli_malloc(i64 noundef 8192) #18
...
stack_destroy.exit9:                              ; preds = %stack_destroy.exit, %if.then.i8
  ...
  %call.i13 = tail call ptr @cli_malloc(i64 noundef 8192) #18
...
regex_list_cleanup.exit:                          ; preds = %stack_destroy.exit.i, %if.then.i8.i
  ...
  %call.i.i = tail call ptr @cli_malloc(i64 noundef 8192) #18
  store ptr %call.i.i, ptr %node_stack.i, align 8, !tbaa !47
  %cnt.i11.i = getelementptr inbounds %struct.regex_matcher, ptr %matcher, i64 0, i32 8, i32 2
  store i64 0, ptr %cnt.i11.i, align 8, !tbaa !45
  %capacity.i12.i = getelementptr inbounds %struct.regex_matcher, ptr %matcher, i64 0, i32 8, i32 1
  store i64 1024, ptr %capacity.i12.i, align 8, !tbaa !46
  %call.i13.i = tail call ptr @cli_malloc(i64 noundef 8192) #18
...
for.body:                                         ; preds = %for.cond.preheader, %for.body
  ...
  tail call void @cli_ac_free(ptr noundef %arrayidx) #18
...
if.then:                                          ; preds = %sw.bb
  call void @llvm.lifetime.start.p0(i64 3, ptr nonnull %fmt) #18
  ...
  call void @llvm.lifetime.start.p0(i64 1, ptr nonnull %c) #18
  %arrayidx5 = getelementptr inbounds [3 x i8], ptr %fmt, i64 0, i64 1
  store i8 %1, ptr %arrayidx5, align 1, !tbaa !13
  %call6 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef nonnull dereferenceable(1) %c, i64 noundef 1, ptr noundef nonnull %fmt) #18
...
if.end:                                           ; preds = %if.else, %if.then8
  call void @llvm.lifetime.end.p0(i64 1, ptr nonnull %c) #18
  call void @llvm.lifetime.end.p0(i64 3, ptr nonnull %fmt) #18
  br label %if.end12
...
sw.bb17:                                          ; preds = %entry
  ...
  %call19 = tail call ptr @cli_malloc(i64 noundef 32) #18
...
if.then89:                                        ; preds = %land.lhs.true84
  ...
  %call91 = tail call ptr @strstr(ptr noundef nonnull dereferenceable(1) %add.ptr, ptr noundef nonnull dereferenceable(1) @.str.21) #17
...
if.end95:                                         ; preds = %if.then89
  ...
  %call103 = tail call i32 @strncmp(ptr noundef nonnull %add.ptr, ptr noundef nonnull @.str.24, i64 noundef %conv102) #17
  %tobool104.not = icmp eq i32 %call103, 0
  br i1 %tobool104.not, label %for.end110, label %for.inc108

for.inc108:                                       ; preds = %if.end95
  %call103.1 = tail call i32 @strncmp(ptr noundef nonnull %add.ptr, ptr noundef nonnull @.str.25, i64 noundef %conv102) #17
...
for.inc108.1:                                     ; preds = %for.inc108
  %call103.2 = tail call i32 @strncmp(ptr noundef nonnull %add.ptr, ptr noundef nonnull @.str.26, i64 noundef %conv102) #17
...
for.inc108.2:                                     ; preds = %for.inc108.1
  %call103.3 = tail call i32 @strncmp(ptr noundef nonnull %add.ptr, ptr noundef nonnull @.str.27, i64 noundef %conv102) #17
...
for.inc108.3:                                     ; preds = %for.inc108.2
  %call103.4 = tail call i32 @strncmp(ptr noundef nonnull %add.ptr, ptr noundef nonnull @.str.28, i64 noundef %conv102) #17
...
for.inc108.4:                                     ; preds = %for.inc108.3
  %call103.5 = tail call i32 @strncmp(ptr noundef nonnull %add.ptr, ptr noundef nonnull @.str.29, i64 noundef %conv102) #17
...
for.inc108.5:                                     ; preds = %for.inc108.4
  %call103.6 = tail call i32 @strncmp(ptr noundef nonnull %add.ptr, ptr noundef nonnull @.str.30, i64 noundef %conv102) #17
...
for.inc108.6:                                     ; preds = %for.inc108.5
  %call103.7 = tail call i32 @strncmp(ptr noundef nonnull %add.ptr, ptr noundef nonnull @.str.31, i64 noundef %conv102) #17
...
for.inc108.7:                                     ; preds = %for.inc108.6
  %call103.8 = tail call i32 @strncmp(ptr noundef nonnull %add.ptr, ptr noundef nonnull @.str.32, i64 noundef %conv102) #17
...
for.inc108.8:                                     ; preds = %for.inc108.7
  %call103.9 = tail call i32 @strncmp(ptr noundef nonnull %add.ptr, ptr noundef nonnull @.str.33, i64 noundef %conv102) #17
...
for.inc108.9:                                     ; preds = %for.inc108.8
  %call103.10 = tail call i32 @strncmp(ptr noundef nonnull %add.ptr, ptr noundef nonnull @.str.34, i64 noundef %conv102) #17
...
for.inc108.10:                                    ; preds = %for.inc108.9
  %call103.11 = tail call i32 @strncmp(ptr noundef nonnull %add.ptr, ptr noundef nonnull @.str.35, i64 noundef %conv102) #17
...
cleanup163.sink.split:                            ; preds = %for.inc108.10, %if.then89, %land.lhs.true56, %land.lhs.true51, %if.then46
  ...
  tail call void (ptr, ...) @cli_warnmsg(ptr noundef nonnull %.str.22.sink) #18
  br label %cleanup163
...
if.end47:                                         ; preds = %if.then27, %if.else23
  %call49 = tail call ptr @cli_realloc2(ptr noundef %1, i64 noundef 16) #18
...
if.end:                                           ; preds = %if.then2, %land.lhs.true, %if.then
  ...
  br i1 %cmp7.not.i, label %for.end.i, label %for.body.lr.ph.i
...
for.body.i:                                       ; preds = %for.cond.i, %for.body.lr.ph.i
  ...
  %arrayidx.i125 = getelementptr inbounds ptr, ptr %7, i64 %i.08.i
...
if.then.i.i:                                      ; preds = %for.end.i
  ...
  %mul.i.i = shl i64 %add.i.i, 3
  %call.i.i = tail call ptr @cli_realloc2(ptr noundef %10, i64 noundef %mul.i.i) #18
...
stack_push_once.exit:                             ; preds = %for.body.i, %if.then.i.i, %if.end6.i.i
  ...
  %cmp7.not.i127 = icmp eq i64 %13, 0
  br i1 %cmp7.not.i127, label %for.end.i138, label %for.body.lr.ph.i128
...
for.cond.i131:                                    ; preds = %for.body.i135
  %inc.i129 = add nuw i64 %i.08.i132, 1
  %exitcond.not.i130 = icmp eq i64 %inc.i129, %13
  br i1 %exitcond.not.i130, label %for.end.i138, label %for.body.i135, !llvm.loop !92

for.body.i135:                                    ; preds = %for.cond.i131, %for.body.lr.ph.i128
  %i.08.i132 = phi i64 [ 0, %for.body.lr.ph.i128 ], [ %inc.i129, %for.cond.i131 ]
  %arrayidx.i133 = getelementptr inbounds ptr, ptr %14, i64 %i.08.i132
...
if.then.i.i145:                                   ; preds = %for.end.i138
  ...
  %call.i.i143 = tail call ptr @cli_realloc2(ptr noundef %17, i64 noundef %mul.i.i142) #18
...
if.then7:                                         ; preds = %stack_push_once.exit151
  tail call void @cli_regfree(ptr noundef nonnull %20) #18
...
if.end17:                                         ; preds = %entry, %tree_node_get_children.exit.thread, %if.end11, %if.then13
  %cond6.i211 = phi ptr [ %spec.select.i, %tree_node_get_children.exit.thread ], [ %1, %if.end11 ], [ %1, %if.then13 ], [ %1, %entry ]
  %alternatives = getelementptr inbounds %struct.tree_node, ptr %node, i64 0, i32 3
...
if.then19:                                        ; preds = %if.end17
  %24 = load ptr, ptr %cond6.i211, align 8, !tbaa !16
...
cond.end:                                         ; preds = %if.then19, %cond.false
  ...
  %cmp25205 = icmp sgt i8 %23, 0
  br i1 %cmp25205, label %for.body, label %for.end

for.body:                                         ; preds = %cond.end, %for.body
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.body ], [ 0, %cond.end ]
  %arrayidx27 = getelementptr inbounds ptr, ptr %cond6.i211, i64 %indvars.iv
...
if.else:                                          ; preds = %if.end17
  %tobool34.not = icmp eq ptr %cond6.i211, null
  br i1 %tobool34.not, label %if.end42, label %if.then35

if.then35:                                        ; preds = %if.else
  %30 = load ptr, ptr %cond6.i211, align 8, !tbaa !16
...
if.then57:                                        ; preds = %if.end54
  ...
  %cmp7.not.i153 = icmp eq i64 %35, 0
  br i1 %cmp7.not.i153, label %for.end.i164, label %for.body.lr.ph.i154
...
for.cond.i157:                                    ; preds = %for.body.i161
  %inc.i155 = add nuw i64 %i.08.i158, 1
  %exitcond.not.i156 = icmp eq i64 %inc.i155, %35
  br i1 %exitcond.not.i156, label %for.end.i164, label %for.body.i161, !llvm.loop !92

for.body.i161:                                    ; preds = %for.cond.i157, %for.body.lr.ph.i154
  %i.08.i158 = phi i64 [ 0, %for.body.lr.ph.i154 ], [ %inc.i155, %for.cond.i157 ]
  %arrayidx.i159 = getelementptr inbounds ptr, ptr %36, i64 %i.08.i158
...
if.then.i.i171:                                   ; preds = %for.end.i164
  ...
  %call.i.i169 = tail call ptr @cli_realloc2(ptr noundef %39, i64 noundef %mul.i.i168) #18
...
if.end73:                                         ; preds = %if.then68, %land.lhs.true64, %if.end60
  ...
  %cmp7.not.i179 = icmp eq i64 %46, 0
  br i1 %cmp7.not.i179, label %for.end.i190, label %for.body.lr.ph.i180
...
for.cond.i183:                                    ; preds = %for.body.i187
  %inc.i181 = add nuw i64 %i.08.i184, 1
  %exitcond.not.i182 = icmp eq i64 %inc.i181, %46
  br i1 %exitcond.not.i182, label %for.end.i190, label %for.body.i187, !llvm.loop !92

for.body.i187:                                    ; preds = %for.cond.i183, %for.body.lr.ph.i180
  %i.08.i184 = phi i64 [ 0, %for.body.lr.ph.i180 ], [ %inc.i181, %for.cond.i183 ]
  %arrayidx.i185 = getelementptr inbounds ptr, ptr %47, i64 %i.08.i184
...
if.then.i.i197:                                   ; preds = %for.end.i190
  ...
  %call.i.i195 = tail call ptr @cli_realloc2(ptr noundef %50, i64 noundef %mul.i.i194) #18
