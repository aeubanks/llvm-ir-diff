...
define dso_local void @foo(ptr nocapture noundef readonly %p1, ptr nocapture readnone %p2) local_unnamed_addr #0 {
entry:
  %0 = load i16, ptr %p1, align 2, !tbaa !5
  %cmp = icmp ult i16 %0, 4096
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 2, ptr nonnull %x) #5
  store i16 -5, ptr %x, align 2, !tbaa !5
  call void @foo(ptr noundef nonnull %x, ptr nonnull poison)
  unreachable
}
