...
if.then:                                          ; preds = %entry
  ...
  %div6158 = lshr i32 256, %conv.i
  br label %if.end47

if.then12:                                        ; preds = %entry
  %arrayidx13 = getelementptr inbounds ptr, ptr %argv, i64 1
  %1 = load ptr, ptr %arrayidx13, align 8, !tbaa !5
  %call.i159 = tail call i64 @strtol(ptr nocapture noundef nonnull %1, ptr noundef null, i32 noundef 10) #9
  ...
  %call.i161 = tail call i64 @strtol(ptr nocapture noundef nonnull %2, ptr noundef null, i32 noundef 10) #9
  ...
  %call.i163 = tail call i64 @strtol(ptr nocapture noundef nonnull %3, ptr noundef null, i32 noundef 10) #9
  ...
  %call.i165 = tail call i64 @strtol(ptr nocapture noundef nonnull %4, ptr noundef null, i32 noundef 10) #9
...
if.then23:                                        ; preds = %entry
  ...
  %call.i167 = tail call i64 @strtol(ptr nocapture noundef nonnull %5, ptr noundef null, i32 noundef 10) #9
  ...
  %call.i169 = tail call i64 @strtol(ptr nocapture noundef nonnull %6, ptr noundef null, i32 noundef 10) #9
  ...
  %call.i171 = tail call i64 @strtol(ptr nocapture noundef nonnull %7, ptr noundef null, i32 noundef 10) #9
  ...
  %call.i173 = tail call i64 @strtol(ptr nocapture noundef nonnull %8, ptr noundef null, i32 noundef 10) #9
  ...
  %call.i175 = tail call i64 @strtol(ptr nocapture noundef nonnull %9, ptr noundef null, i32 noundef 10) #9
  ...
  %call.i177 = tail call i64 @strtol(ptr nocapture noundef nonnull %10, ptr noundef null, i32 noundef 10) #9
  ...
  %call.i179 = tail call i64 @strtol(ptr nocapture noundef nonnull %11, ptr noundef null, i32 noundef 10) #9
  %conv.i180 = trunc i64 %call.i179 to i32
  br label %if.end47

if.then42:                                        ; preds = %entry
  %puts157 = tail call i32 @puts(ptr nonnull dereferenceable(1) @str.8)
  tail call void @exit(i32 noundef 0) #10
  unreachable

if.end47:                                         ; preds = %entry, %if.then12, %if.then23, %if.then
  %ranks_in_k.0 = phi i32 [ 1, %if.then ], [ 1, %if.then12 ], [ %conv.i180, %if.then23 ], [ %argc, %entry ]
  %ranks_in_j.0 = phi i32 [ 1, %if.then ], [ 1, %if.then12 ], [ %conv.i178, %if.then23 ], [ %argc, %entry ]
  %ranks_in_i.0 = phi i32 [ 1, %if.then ], [ 1, %if.then12 ], [ %conv.i176, %if.then23 ], [ %argc, %entry ]
  %subdomains_per_rank_in_k.0 = phi i32 [ %div6158, %if.then ], [ %conv.i166, %if.then12 ], [ %conv.i174, %if.then23 ], [ 4, %entry ]
  %subdomains_per_rank_in_j.0 = phi i32 [ %div6158, %if.then ], [ %conv.i164, %if.then12 ], [ %conv.i172, %if.then23 ], [ 4, %entry ]
  %subdomains_per_rank_in_i.0 = phi i32 [ %div6158, %if.then ], [ %conv.i162, %if.then12 ], [ %conv.i170, %if.then23 ], [ 4, %entry ]
  %log2_subdomain_dim.0 = phi i32 [ %conv.i, %if.then ], [ %conv.i160, %if.then12 ], [ %conv.i168, %if.then23 ], [ 6, %entry ]
