...
cond.end.i:                                       ; preds = %cond.false.i, %if.then426.i
  %116 = phi ptr [ %108, %if.then426.i ], [ %.pre2250.i, %cond.false.i ]
...
cond.false544.i:                                  ; preds = %for.end534.i
  ...
  %.pre2251.i = load ptr, ptr @xx_link, align 8, !tbaa !10
  br label %cond.end566.i

cond.end566.i:                                    ; preds = %cond.false544.i, %for.end534.i
  %133 = phi ptr [ %127, %for.end534.i ], [ %.pre2251.i, %cond.false544.i ]
...
if.end962.i:                                      ; preds = %if.then959.i, %if.then956.i
  %197 = phi i32 [ %.pre2252.i, %if.then959.i ], [ %196, %if.then956.i ]
...
if.end1494.i:                                     ; preds = %if.then1485.i, %if.end1479.i
  ...
  %237 = phi i16 [ %conv1486.i, %if.then1485.i ], [ %.pre2253.i, %if.end1479.i ]
...
if.then1511.i:                                    ; preds = %for.inc1506.i, %for.end1508.i
  ...
  %cmp1512.i = icmp eq i32 %ks_top.0.ph2173.i, %240
...
land.rhs1530.i:                                   ; preds = %for.body1538.i, %land.rhs1530.preheader.i
  %indvars.iv2244.i = phi i64 [ %241, %land.rhs1530.preheader.i ], [ %indvars.iv.next2245.i, %for.body1538.i ]
...
for.body1538.i:                                   ; preds = %land.rhs1530.i
  ...
  %cmp1528.not.not.i = icmp sgt i64 %indvars.iv.next2245.i, %242
...
land.lhs.true1555.i:                              ; preds = %land.rhs1530.i
  %245 = trunc i64 %indvars.iv2244.i to i32
...
if.end1568.loopexit.i:                            ; preds = %for.body1538.i
  %246 = trunc i64 %indvars.iv.next2245.i to i32
  br label %if.end1568.i
...
if.end45.i.i:                                     ; preds = %if.then41.i.i, %if.end34.i.i
  ...
  %cmp50201.i.i = icmp sgt i32 %254, 0
...
for.body52.i.i:                                   ; preds = %if.end104.i.i, %for.body52.i.preheader.i
  %indvars.iv2247.i = phi i64 [ %255, %for.body52.i.preheader.i ], [ %indvars.iv.next2248.i, %if.end104.i.i ]
...
if.end63.i.i:                                     ; preds = %if.then59.i.i, %for.body52.i.i
  %256 = ashr exact i64 %i.1203.i.i, 32
  br label %for.cond64.i.i

for.cond64.i.i:                                   ; preds = %for.cond64.i.i, %if.end63.i.i
  %indvars.iv214.in.i.i = phi i64 [ %256, %if.end63.i.i ], [ %indvars.iv214.i.i, %for.cond64.i.i ]
...
for.end125.i.loopexit.i:                          ; preds = %if.end104.i.i
  %261 = trunc i64 %indvars.iv.next2248.i to i32
...
if.then142.i.i:                                   ; preds = %if.then142.i.loopexit.i, %lor.lhs.false.i.i, %if.then1656.i
  %262 = phi i32 [ %inc1637.i, %if.then1656.i ], [ %inc.i2199.i, %lor.lhs.false.i.i ], [ %inc.i.i, %if.then142.i.loopexit.i ]
