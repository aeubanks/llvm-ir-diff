...
entry:
  %top = alloca [2 x i32], align 8
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %top) #3
  store i64 -37582978188412294, ptr %top, align 8
  %call = call i32 @Predictor(i32 noundef -8684677, ptr noundef nonnull %top)
  %cmp = icmp ne i32 %call, -8684677
  %. = zext i1 %cmp to i32
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %top) #3
  ret i32 %.
}
