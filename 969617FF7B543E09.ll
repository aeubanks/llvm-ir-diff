...
for.body514.preheader:                            ; preds = %for.body238
  ...
  %.pre1614 = load i32, ptr %arrayidx532.phi.trans.insert, align 16, !tbaa !5
  %arrayidx571.phi.trans.insert = getelementptr inbounds [80 x i32], ptr %W, i64 0, i64 38
  %.pre1615 = load i32, ptr %arrayidx571.phi.trans.insert, align 8, !tbaa !5
  %arrayidx585.phi.trans.insert = getelementptr inbounds [80 x i32], ptr %W, i64 0, i64 25
  %.pre1616 = load i32, ptr %arrayidx585.phi.trans.insert, align 4, !tbaa !5
  %arrayidx629.phi.trans.insert = getelementptr inbounds [80 x i32], ptr %W, i64 0, i64 39
  %.pre1617 = load i32, ptr %arrayidx629.phi.trans.insert, align 4, !tbaa !5
  %arrayidx696.phi.trans.insert = getelementptr inbounds [80 x i32], ptr %W, i64 0, i64 29
  %.pre1618 = load i32, ptr %arrayidx696.phi.trans.insert, align 4, !tbaa !5
...
for.body801.preheader:                            ; preds = %for.body514
  ...
  %.pre1619 = load i32, ptr %arrayidx806.phi.trans.insert, align 4, !tbaa !5
  %arrayidx817.phi.trans.insert = getelementptr inbounds [80 x i32], ptr %W, i64 0, i64 44
  %.pre1620 = load i32, ptr %arrayidx817.phi.trans.insert, align 16, !tbaa !5
  %arrayidx854.phi.trans.insert = getelementptr inbounds [80 x i32], ptr %W, i64 0, i64 58
  %.pre1621 = load i32, ptr %arrayidx854.phi.trans.insert, align 8, !tbaa !5
  %arrayidx868.phi.trans.insert = getelementptr inbounds [80 x i32], ptr %W, i64 0, i64 45
  %.pre1622 = load i32, ptr %arrayidx868.phi.trans.insert, align 4, !tbaa !5
  %arrayidx910.phi.trans.insert = getelementptr inbounds [80 x i32], ptr %W, i64 0, i64 59
  %.pre1623 = load i32, ptr %arrayidx910.phi.trans.insert, align 4, !tbaa !5
  %arrayidx919.phi.trans.insert = getelementptr inbounds [80 x i32], ptr %W, i64 0, i64 48
  %.pre1624 = load i32, ptr %arrayidx919.phi.trans.insert, align 16, !tbaa !5
  %arrayidx975.phi.trans.insert = getelementptr inbounds [80 x i32], ptr %W, i64 0, i64 49
  %.pre1625 = load i32, ptr %arrayidx975.phi.trans.insert, align 4, !tbaa !5
  br label %for.body801

for.body514:                                      ; preds = %for.body514.preheader, %for.body514
  %76 = phi i32 [ %.pre1618, %for.body514.preheader ], [ %95, %for.body514 ]
  %77 = phi i32 [ %.pre1617, %for.body514.preheader ], [ %or782, %for.body514 ]
  %78 = phi i32 [ %.pre1616, %for.body514.preheader ], [ %107, %for.body514 ]
  %79 = phi i32 [ %.pre1615, %for.body514.preheader ], [ %or724, %for.body514 ]
  %80 = phi i32 [ %.pre1614, %for.body514.preheader ], [ %76, %for.body514 ]
  %81 = phi i32 [ %.pre, %for.body514.preheader ], [ %or666, %for.body514 ]
  %indvars.iv1558 = phi i64 [ 40, %for.body514.preheader ], [ %indvars.iv.next1559, %for.body514 ]
  ...
  %82 = add nsw i64 %indvars.iv1558, -8
  %arrayidx524 = getelementptr inbounds [80 x i32], ptr %W, i64 0, i64 %82
  %83 = load i32, ptr %arrayidx524, align 4, !tbaa !5
  %xor525 = xor i32 %83, %81
  %84 = add nsw i64 %indvars.iv1558, -14
  %arrayidx528 = getelementptr inbounds [80 x i32], ptr %W, i64 0, i64 %84
  %85 = load i32, ptr %arrayidx528, align 4, !tbaa !5
  %86 = xor i32 %xor525, %80
  %xor533 = xor i32 %86, %85
  %or551 = tail call i32 @llvm.fshl.i32(i32 %xor533, i32 %xor533, i32 1)
  %arrayidx553 = getelementptr inbounds [80 x i32], ptr %W, i64 0, i64 %indvars.iv1558
  ...
  %87 = add nuw nsw i64 %indvars.iv1558, 1
  %88 = add nsw i64 %indvars.iv1558, -7
  %arrayidx575 = getelementptr inbounds [80 x i32], ptr %W, i64 0, i64 %88
  %89 = load i32, ptr %arrayidx575, align 4, !tbaa !5
  %xor576 = xor i32 %89, %79
  %90 = add nsw i64 %indvars.iv1558, -13
  %arrayidx580 = getelementptr inbounds [80 x i32], ptr %W, i64 0, i64 %90
  %91 = load i32, ptr %arrayidx580, align 4, !tbaa !5
  %92 = xor i32 %xor576, %78
  %xor586 = xor i32 %92, %91
  %or608 = tail call i32 @llvm.fshl.i32(i32 %xor586, i32 %xor586, i32 1)
  %arrayidx611 = getelementptr inbounds [80 x i32], ptr %W, i64 0, i64 %87
  ...
  %93 = add nuw nsw i64 %indvars.iv1558, 2
  %94 = add nsw i64 %indvars.iv1558, -6
  %arrayidx633 = getelementptr inbounds [80 x i32], ptr %W, i64 0, i64 %94
  %95 = load i32, ptr %arrayidx633, align 4, !tbaa !5
  %xor634 = xor i32 %95, %77
  %96 = add nsw i64 %indvars.iv1558, -12
  %arrayidx638 = getelementptr inbounds [80 x i32], ptr %W, i64 0, i64 %96
  %97 = load i32, ptr %arrayidx638, align 4, !tbaa !5
  %xor639 = xor i32 %xor634, %97
  %xor644 = xor i32 %xor639, %85
  %or666 = tail call i32 @llvm.fshl.i32(i32 %xor644, i32 %xor644, i32 1)
  %arrayidx669 = getelementptr inbounds [80 x i32], ptr %W, i64 0, i64 %93
  ...
  %98 = add nuw nsw i64 %indvars.iv1558, 3
  %99 = add nsw i64 %indvars.iv1558, -5
  %arrayidx691 = getelementptr inbounds [80 x i32], ptr %W, i64 0, i64 %99
  %100 = load i32, ptr %arrayidx691, align 4, !tbaa !5
  %101 = xor i32 %100, %76
  %102 = xor i32 %101, %91
  %xor702 = xor i32 %102, %or551
  %or724 = tail call i32 @llvm.fshl.i32(i32 %xor702, i32 %xor702, i32 1)
  %arrayidx727 = getelementptr inbounds [80 x i32], ptr %W, i64 0, i64 %98
  ...
  %103 = add nuw nsw i64 %indvars.iv1558, 4
  %104 = add nsw i64 %indvars.iv1558, -4
  %arrayidx749 = getelementptr inbounds [80 x i32], ptr %W, i64 0, i64 %104
  %105 = load i32, ptr %arrayidx749, align 4, !tbaa !5
  %xor750 = xor i32 %105, %or608
  %106 = add nsw i64 %indvars.iv1558, -10
  %arrayidx754 = getelementptr inbounds [80 x i32], ptr %W, i64 0, i64 %106
  %107 = load i32, ptr %arrayidx754, align 4, !tbaa !5
  %xor755 = xor i32 %xor750, %107
  %xor760 = xor i32 %xor755, %97
  %or782 = tail call i32 @llvm.fshl.i32(i32 %xor760, i32 %xor760, i32 1)
  %arrayidx785 = getelementptr inbounds [80 x i32], ptr %W, i64 0, i64 %103
  ...
  %add787 = add i32 %add786, %or741
  %add791 = add i32 %add787, %or782
  %add792 = add i32 %add791, %or790
  %or795 = tail call i32 @llvm.fshl.i32(i32 %add676, i32 %add676, i32 30)
  %indvars.iv.next1559 = add nuw nsw i64 %indvars.iv1558, 5
  %cmp513 = icmp ult i64 %indvars.iv1558, 55
...
for.body801:                                      ; preds = %for.body801.preheader, %for.body801
  %108 = phi i32 [ %.pre1625, %for.body801.preheader ], [ %129, %for.body801 ]
  %109 = phi i32 [ %.pre1624, %for.body801.preheader ], [ %122, %for.body801 ]
  %110 = phi i32 [ %.pre1623, %for.body801.preheader ], [ %or1059, %for.body801 ]
  %111 = phi i32 [ %.pre1622, %for.body801.preheader ], [ %141, %for.body801 ]
  %112 = phi i32 [ %.pre1621, %for.body801.preheader ], [ %or1003, %for.body801 ]
  %113 = phi i32 [ %.pre1620, %for.body801.preheader ], [ %108, %for.body801 ]
  %114 = phi i32 [ %.pre1619, %for.body801.preheader ], [ %or947, %for.body801 ]
  %indvars.iv1584 = phi i64 [ 60, %for.body801.preheader ], [ %indvars.iv.next1585, %for.body801 ]
  ...
  %115 = add nsw i64 %indvars.iv1584, -8
  %arrayidx809 = getelementptr inbounds [80 x i32], ptr %W, i64 0, i64 %115
  %116 = load i32, ptr %arrayidx809, align 4, !tbaa !5
  %xor810 = xor i32 %116, %114
  %117 = add nsw i64 %indvars.iv1584, -14
  %arrayidx813 = getelementptr inbounds [80 x i32], ptr %W, i64 0, i64 %117
  %118 = load i32, ptr %arrayidx813, align 4, !tbaa !5
  %119 = xor i32 %xor810, %113
  %xor818 = xor i32 %119, %118
  %or836 = tail call i32 @llvm.fshl.i32(i32 %xor818, i32 %xor818, i32 1)
  %arrayidx838 = getelementptr inbounds [80 x i32], ptr %W, i64 0, i64 %indvars.iv1584
  ...
  %120 = add nuw nsw i64 %indvars.iv1584, 1
  %121 = add nsw i64 %indvars.iv1584, -7
  %arrayidx858 = getelementptr inbounds [80 x i32], ptr %W, i64 0, i64 %121
  %122 = load i32, ptr %arrayidx858, align 4, !tbaa !5
  %123 = add nsw i64 %indvars.iv1584, -13
  %arrayidx863 = getelementptr inbounds [80 x i32], ptr %W, i64 0, i64 %123
  %124 = load i32, ptr %arrayidx863, align 4, !tbaa !5
  %125 = xor i32 %112, %111
  %126 = xor i32 %125, %122
  %xor869 = xor i32 %126, %124
  %or891 = tail call i32 @llvm.fshl.i32(i32 %xor869, i32 %xor869, i32 1)
  %arrayidx894 = getelementptr inbounds [80 x i32], ptr %W, i64 0, i64 %120
  ...
  %127 = add nuw nsw i64 %indvars.iv1584, 2
  %128 = add nsw i64 %indvars.iv1584, -6
  %arrayidx914 = getelementptr inbounds [80 x i32], ptr %W, i64 0, i64 %128
  %129 = load i32, ptr %arrayidx914, align 4, !tbaa !5
  %130 = add nsw i64 %indvars.iv1584, -12
  %arrayidx919 = getelementptr inbounds [80 x i32], ptr %W, i64 0, i64 %130
  %131 = xor i32 %110, %109
  %xor920 = xor i32 %131, %129
  %xor925 = xor i32 %xor920, %118
  %or947 = tail call i32 @llvm.fshl.i32(i32 %xor925, i32 %xor925, i32 1)
  %arrayidx950 = getelementptr inbounds [80 x i32], ptr %W, i64 0, i64 %127
  ...
  %132 = add nuw nsw i64 %indvars.iv1584, 3
  %133 = add nsw i64 %indvars.iv1584, -5
  %arrayidx970 = getelementptr inbounds [80 x i32], ptr %W, i64 0, i64 %133
  %134 = load i32, ptr %arrayidx970, align 4, !tbaa !5
  %135 = xor i32 %134, %108
  %136 = xor i32 %135, %124
  %xor981 = xor i32 %136, %or836
  %or1003 = tail call i32 @llvm.fshl.i32(i32 %xor981, i32 %xor981, i32 1)
  %arrayidx1006 = getelementptr inbounds [80 x i32], ptr %W, i64 0, i64 %132
  ...
  %137 = add nuw nsw i64 %indvars.iv1584, 4
  %138 = add nsw i64 %indvars.iv1584, -4
  %arrayidx1026 = getelementptr inbounds [80 x i32], ptr %W, i64 0, i64 %138
  %139 = load i32, ptr %arrayidx1026, align 4, !tbaa !5
  %140 = add nsw i64 %indvars.iv1584, -10
  %arrayidx1031 = getelementptr inbounds [80 x i32], ptr %W, i64 0, i64 %140
  %141 = load i32, ptr %arrayidx1031, align 4, !tbaa !5
  %142 = load i32, ptr %arrayidx919, align 4, !tbaa !5
  %143 = xor i32 %139, %142
  %144 = xor i32 %143, %or891
  %xor1037 = xor i32 %144, %141
  %or1059 = tail call i32 @llvm.fshl.i32(i32 %xor1037, i32 %xor1037, i32 1)
  %arrayidx1062 = getelementptr inbounds [80 x i32], ptr %W, i64 0, i64 %137
  ...
  %indvars.iv.next1585 = add nuw nsw i64 %indvars.iv1584, 5
  %cmp800 = icmp ult i64 %indvars.iv1584, 75
