...
_ZN20btAlignedObjectArrayIP17btTypedConstraintED2Ev.exit: ; preds = %if.then3.i.i.i, %entry
  ...
  store i32 0, ptr %m_size.i4.i.i, align 4, !tbaa !31
...
if.end:                                           ; preds = %if.else, %if.then
  ...
  %or.cond291 = select i1 %tobool22.not, i1 %tobool2.not, i1 false
...
if.else32:                                        ; preds = %if.end
  ...
  %327 = load <2 x float>, ptr %arrayidx5.i251, align 8, !tbaa !5
  %328 = load <2 x float>, ptr %arrayidx7.i252, align 8, !tbaa !5
...
if.end39:                                         ; preds = %if.else32, %if.then26
  ...
  %336 = shufflevector <2 x float> %retval.sroa.0.0.vec.insert.i257, <2 x float> %335, <2 x i32> <i32 0, i32 2>
  ...
  %343 = tail call float @llvm.fmuladd.f32(float %339, float %sub.i250.sink, float %mul8.i)
  ...
  %346 = load float, ptr %arrayidx7.i278.1, align 8, !tbaa !5
  %347 = load float, ptr %arrayidx12.i280.1, align 8, !tbaa !5
  %348 = shufflevector <2 x float> %335, <2 x float> poison, <2 x i32> zeroinitializer
  %349 = insertelement <2 x float> poison, float %316, i64 0
  %350 = insertelement <2 x float> %349, float %346, i64 1
  %351 = fmul <2 x float> %348, %350
  %352 = insertelement <2 x float> poison, float %sub.i250.sink, i64 0
  ...
  %359 = load float, ptr %arrayidx7.i278.2, align 4, !tbaa !5
  %360 = load float, ptr %arrayidx12.i280.2, align 4, !tbaa !5
  %mul8.i288.2 = fmul float %342, %359
  %361 = tail call float @llvm.fmuladd.f32(float %sub.i250.sink, float %338, float %mul8.i288.2)
...
if.then66:                                        ; preds = %if.then
  ...
  %187 = load float, ptr %arrayidx.i, align 8, !tbaa !5
  %188 = load float, ptr %arrayidx10.i, align 4, !tbaa !5
  %189 = load float, ptr %arrayidx5.i406, align 4, !tbaa !5
  %190 = fneg float %189
  %191 = load float, ptr %m_relPosA, align 4, !tbaa !5
  %192 = fneg float %191
  %neg19.i524 = fmul float %188, %192
  %193 = fneg float %187
  ...
  %198 = fneg float %197
  %neg19.i536 = fmul float %188, %198
  %199 = fneg float %194
  %200 = load float, ptr %m_inverseMass.i, align 8, !tbaa !56
  %mul8.i548 = fmul float %188, %200
  ...
  %206 = tail call float @llvm.fmuladd.f32(float %187, float %188, float %neg.i523)
  ...
  %210 = tail call float @llvm.fmuladd.f32(float %194, float %188, float %neg.i535)
...
entry:
  ...
  %.fca.0.insert = insertvalue { <2 x float>, <2 x float> } poison, <2 x float> %50, 0
  %.fca.1.insert = insertvalue { <2 x float>, <2 x float> } %.fca.0.insert, <2 x float> %51, 1
