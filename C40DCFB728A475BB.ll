...
"for k.s0.n1.preheader":                          ; preds = %"assert succeeded77"
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 32 dereferenceable(32) %fwd_fft1_S1_R8_n1.020, ptr noundef nonnull align 4 dereferenceable(32) %scevgep192, i64 32, i1 false)
  %scevgep191.1 = getelementptr inbounds i8, ptr %fwd_fft1_S1_R8_n1.020, i64 32
  %261 = add i64 %259, %260
  ...
  %scevgep191.2 = getelementptr inbounds i8, ptr %fwd_fft1_S1_R8_n1.020, i64 64
  ...
  %scevgep191.3 = getelementptr inbounds i8, ptr %fwd_fft1_S1_R8_n1.020, i64 96
  ...
  %scevgep191.4 = getelementptr inbounds i8, ptr %fwd_fft1_S1_R8_n1.020, i64 128
  ...
  %scevgep191.5 = getelementptr inbounds i8, ptr %fwd_fft1_S1_R8_n1.020, i64 160
  ...
  %scevgep191.6 = getelementptr inbounds i8, ptr %fwd_fft1_S1_R8_n1.020, i64 192
  ...
  %scevgep191.7 = getelementptr inbounds i8, ptr %fwd_fft1_S1_R8_n1.020, i64 224
  ...
  %wide.vec280 = load <32 x float>, ptr %fwd_fft1_S1_R8_n1.119, align 32, !tbaa !27
  ...
  store <32 x float> %interleaved.vec289, ptr %inv_fft1_S1_R8_n1.121, align 32, !tbaa !34
...
"for result.s0.i.preheader":                      ; preds = %"for k.s0.n1.preheader"
  ...
  %invariant.gep336 = getelementptr float, ptr %inv_fft0_S1_R8_n0.115, i64 -7
...
"for result.s0.i":                                ; preds = %"for result.s0.i.preheader", %"end for result.s0.n1"
  %indvars.iv208 = phi i64 [ %569, %"for result.s0.i.preheader" ], [ %indvars.iv.next209, %"end for result.s0.n1" ]
...
"for fwd_fft0_S1_R8_n0.s1.n1":                    ; preds = %"for result.s0.i", %"for fwd_fft0_S1_R8_n0.s1.n1"
  %indvars.iv196 = phi i64 [ 0, %"for result.s0.i" ], [ %indvars.iv.next197, %"for fwd_fft0_S1_R8_n0.s1.n1" ]
  %577 = trunc i64 %indvars.iv196 to i32
  %reass.add49 = sub i32 %577, %20
  %reass.mul50 = mul i32 %reass.add49, %24
  %t956 = add i32 %576, %reass.mul50
  ...
  %599 = getelementptr inbounds float, ptr %inv_fft1_S1_R8_n1.121, i64 %598
  %600 = getelementptr inbounds float, ptr %inv_fft1_S1_R8_n1.022, i64 %598
  store float 0.000000e+00, ptr %600, align 32, !tbaa !32
  %601 = or i64 %598, 1
  %602 = getelementptr inbounds float, ptr %inv_fft1_S1_R8_n1.022, i64 %601
  %603 = or i64 %598, 2
  %604 = getelementptr inbounds float, ptr %inv_fft1_S1_R8_n1.022, i64 %603
  ...
  %632 = or i64 %598, 4
  %633 = getelementptr inbounds float, ptr %inv_fft1_S1_R8_n1.121, i64 %632
  %634 = getelementptr inbounds float, ptr %inv_fft1_S1_R8_n1.022, i64 %632
  store float 0.000000e+00, ptr %634, align 16, !tbaa !32
  %635 = or i64 %598, 5
  %636 = getelementptr inbounds float, ptr %inv_fft1_S1_R8_n1.022, i64 %635
  store float %627, ptr %636, align 4, !tbaa !32
  %637 = or i64 %598, 6
  %638 = getelementptr inbounds float, ptr %inv_fft1_S1_R8_n1.022, i64 %637
...
vector.body295:                                   ; preds = %"assert succeeded83", %vector.body295
  ...
  %801 = fmul <4 x float> %strided.vec308, %strided.vec317
  %802 = fadd <4 x float> %801, %800
  %803 = fmul <4 x float> %strided.vec303, %strided.vec330
  %804 = fmul <4 x float> %strided.vec312, %strided.vec321
  ...
  %816 = fmul <4 x float> %strided.vec310, %strided.vec319
  %817 = fadd <4 x float> %816, %815
  %818 = fmul <4 x float> %strided.vec305, %strided.vec332
  %819 = fmul <4 x float> %strided.vec314, %strided.vec323
  ...
  br i1 %873, label %"produce inv_X8$1", label %vector.body295, !llvm.loop !308
...
"produce inv_X8$1":                               ; preds = %vector.body295
  %875 = load <8 x float>, ptr %inv_fft0_S1_R8_n0.016, align 32, !tbaa !142
  %876 = load <8 x float>, ptr %459, align 32, !tbaa !104
  %877 = fadd <8 x float> %875, %876
  %878 = load <8 x float>, ptr %inv_fft0_S1_R8_n0.115, align 32, !tbaa !144
  ...
  store <8 x float> %932, ptr %inv_fft1_S1_R8_n1.022, align 32, !tbaa !36
  store <8 x float> %933, ptr %inv_fft1_S1_R8_n1.121, align 32, !tbaa !49
...
"for result.s0.n1":                               ; preds = %"for result.s0.n1.preheader", %"end for result.s0.n0.n091"
  %indvars.iv205 = phi i64 [ %568, %"for result.s0.n1.preheader" ], [ %indvars.iv.next206, %"end for result.s0.n0.n091" ]
...
"for result.s0.n0.n0":                            ; preds = %"for result.s0.n0.n0.preheader", %"for result.s0.n0.n0"
  %indvars.iv202 = phi i64 [ %indvars.iv.next203.1, %"for result.s0.n0.n0" ], [ 0, %"for result.s0.n0.n0.preheader" ]
  ...
  %956 = getelementptr inbounds float, ptr %inv_fft1_S1_R8_n1.022, i64 %955
  ...
  %964 = getelementptr inbounds float, ptr %inv_fft1_S1_R8_n1.022, i64 %963
...
"end for result.s0.n0.n0.loopexit.unr-lcssa":     ; preds = %"for result.s0.n0.n0", %"for result.s0.n0.n0.preheader"
  %indvars.iv202.unr = phi i64 [ 0, %"for result.s0.n0.n0.preheader" ], [ %indvars.iv.next203.1, %"for result.s0.n0.n0" ]
...
"for result.s0.n0.n0.epil":                       ; preds = %"end for result.s0.n0.n0.loopexit.unr-lcssa"
  ...
  %972 = getelementptr inbounds float, ptr %inv_fft1_S1_R8_n1.022, i64 %971
...
"for result.s0.n0.n090.preheader":                ; preds = %"end for result.s0.n0.n0"
  ...
  %979 = getelementptr inbounds float, ptr %inv_fft1_S1_R8_n1.022, i64 %978
