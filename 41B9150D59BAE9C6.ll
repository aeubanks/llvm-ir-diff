...
if.end:                                           ; preds = %entry
  ...
  %cmp1.not58 = icmp eq ptr %1, null
  br i1 %cmp1.not58, label %for.end, label %for.body

for.body:                                         ; preds = %if.end, %for.body
  %prow.059 = phi ptr [ %2, %for.body ], [ %1, %if.end ]
  %flag = getelementptr inbounds %struct.sm_row_struct, ptr %prow.059, i64 0, i32 2
  store i32 0, ptr %flag, align 8, !tbaa !19
  %next_row = getelementptr inbounds %struct.sm_row_struct, ptr %prow.059, i64 0, i32 5
  %2 = load ptr, ptr %next_row, align 8, !tbaa !27
...
for.end:                                          ; preds = %for.body, %if.end
  ...
  %pcol.060 = load ptr, ptr %first_col, align 8, !tbaa !14
  %cmp3.not61 = icmp eq ptr %pcol.060, null
  br i1 %cmp3.not61, label %for.end7, label %for.body4

for.body4:                                        ; preds = %for.end, %for.body4
  %pcol.062 = phi ptr [ %pcol.0, %for.body4 ], [ %pcol.060, %for.end ]
  %flag5 = getelementptr inbounds %struct.sm_col_struct, ptr %pcol.062, i64 0, i32 2
  store i32 0, ptr %flag5, align 8, !tbaa !5
  %next_col = getelementptr inbounds %struct.sm_col_struct, ptr %pcol.062, i64 0, i32 5
...
for.end7:                                         ; preds = %for.body4, %for.end
  ...
  %3 = load i32, ptr %flag.i, align 8, !tbaa !19
...
for.body.i:                                       ; preds = %for.inc.i, %for.body.lr.ph.i
  ...
  %4 = load i32, ptr %col_num.i, align 4, !tbaa !22
  %cmp4.i = icmp sgt i32 %4, -1
  tail call void @llvm.assume(i1 %cmp4.i)
  %5 = load i32, ptr %cols_size.i, align 8, !tbaa !23
  %cmp6.i = icmp slt i32 %4, %5
  tail call void @llvm.assume(i1 %cmp6.i)
  %6 = load ptr, ptr %cols.i, align 8, !tbaa !24
  ...
  %flag8.i = getelementptr inbounds %struct.sm_col_struct, ptr %7, i64 0, i32 2
  %8 = load i32, ptr %flag8.i, align 8, !tbaa !5
  %tobool9.not.i = icmp eq i32 %8, 0
  br i1 %tobool9.not.i, label %if.then10.i, label %for.inc.i

if.then10.i:                                      ; preds = %for.body.i
  %call.i = call i32 @visit_col(ptr noundef nonnull %A, ptr noundef nonnull %7, ptr noundef nonnull %rows_visited, ptr noundef nonnull %cols_visited), !range !25
...
if.else:                                          ; preds = %for.inc.i, %for.end7, %if.end.i
  ...
  %prow.163 = load ptr, ptr %first_row, align 8, !tbaa !14
  %cmp14.not64 = icmp eq ptr %prow.163, null
  br i1 %cmp14.not64, label %cleanup, label %for.body15

for.body15:                                       ; preds = %if.else, %for.inc21
  %prow.165 = phi ptr [ %prow.1, %for.inc21 ], [ %prow.163, %if.else ]
  %flag16 = getelementptr inbounds %struct.sm_row_struct, ptr %prow.165, i64 0, i32 2
  %9 = load i32, ptr %flag16, align 8, !tbaa !19
  %tobool17.not = icmp eq i32 %9, 0
  %10 = getelementptr i8, ptr %prow.165, i64 16
  %prow.1.val = load ptr, ptr %10, align 8, !tbaa !28
  %cmp.not1.i48 = icmp eq ptr %prow.1.val, null
  br i1 %tobool17.not, label %if.else19, label %if.then18

if.then18:                                        ; preds = %for.body15
  %11 = load ptr, ptr %L, align 8, !tbaa !14
  br i1 %cmp.not1.i48, label %for.inc21, label %for.body.i47

for.body.i47:                                     ; preds = %if.then18, %for.body.i47
  %p.02.i = phi ptr [ %14, %for.body.i47 ], [ %prow.1.val, %if.then18 ]
  %12 = load i32, ptr %p.02.i, align 8, !tbaa !15
  %col_num.i44 = getelementptr inbounds %struct.sm_element_struct, ptr %p.02.i, i64 0, i32 1
  %13 = load i32, ptr %col_num.i44, align 4, !tbaa !22
  %call.i45 = tail call ptr (ptr, i32, i32, ...) @sm_insert(ptr noundef %11, i32 noundef %12, i32 noundef %13) #5
  %next_col.i46 = getelementptr inbounds %struct.sm_element_struct, ptr %p.02.i, i64 0, i32 4
  %14 = load ptr, ptr %next_col.i46, align 8, !tbaa !29
  %cmp.not.i = icmp eq ptr %14, null
  br i1 %cmp.not.i, label %for.inc21, label %for.body.i47

if.else19:                                        ; preds = %for.body15
  %15 = load ptr, ptr %R, align 8, !tbaa !14
  br i1 %cmp.not1.i48, label %for.inc21, label %for.body.i54

for.body.i54:                                     ; preds = %if.else19, %for.body.i54
  %p.02.i49 = phi ptr [ %18, %for.body.i54 ], [ %prow.1.val, %if.else19 ]
  %16 = load i32, ptr %p.02.i49, align 8, !tbaa !15
  %col_num.i50 = getelementptr inbounds %struct.sm_element_struct, ptr %p.02.i49, i64 0, i32 1
  %17 = load i32, ptr %col_num.i50, align 4, !tbaa !22
  %call.i51 = tail call ptr (ptr, i32, i32, ...) @sm_insert(ptr noundef %15, i32 noundef %16, i32 noundef %17) #5
  %next_col.i52 = getelementptr inbounds %struct.sm_element_struct, ptr %p.02.i49, i64 0, i32 4
  %18 = load ptr, ptr %next_col.i52, align 8, !tbaa !29
  %cmp.not.i53 = icmp eq ptr %18, null
  br i1 %cmp.not.i53, label %for.inc21, label %for.body.i54

for.inc21:                                        ; preds = %for.body.i47, %for.body.i54, %if.else19, %if.then18
  %next_row22 = getelementptr inbounds %struct.sm_row_struct, ptr %prow.165, i64 0, i32 5
