; ModuleID = '/usr/local/google/home/aeubanks/repos/test-suite/Bitcode/simd_ops/x86_tests/test_op_vpackusdw_401.bc'
...
@str.11 = private constant [17 x i8] c"op_vpackusdw_401\00", align 32
...
define i32 @__test_op(ptr noalias nocapture readnone %in_f32.buffer, ptr noalias nocapture readnone %in_f64.buffer, ptr noalias nocapture readnone %in_i8.buffer, ptr noalias nocapture readnone %in_u8.buffer, ptr noalias nocapture readnone %in_i16.buffer, ptr noalias nocapture readnone %in_u16.buffer, ptr noalias nocapture readonly %in_i32.buffer, ptr noalias nocapture readnone %in_u32.buffer, ptr noalias nocapture readnone %in_i64.buffer, ptr noalias nocapture readnone %in_u64.buffer, ptr noalias nocapture readonly %op_vpackusdw_401.buffer) local_unnamed_addr #1 {
"produce op_vpackusdw_401":
  %buf_extent168 = getelementptr inbounds %struct.buffer_t, ptr %op_vpackusdw_401.buffer, i64 0, i32 2, i64 1
  %op_vpackusdw_401.extent.1 = load i32, ptr %buf_extent168, align 4
  %buf_min176 = getelementptr inbounds %struct.buffer_t, ptr %op_vpackusdw_401.buffer, i64 0, i32 4, i64 1
  %op_vpackusdw_401.min.1 = load i32, ptr %buf_min176, align 4
  %0 = add nsw i32 %op_vpackusdw_401.min.1, %op_vpackusdw_401.extent.1
  %1 = icmp sgt i32 %op_vpackusdw_401.extent.1, 0
  br i1 %1, label %"for op_vpackusdw_401.s0.y.preheader", label %destructor_block, !prof !4

"for op_vpackusdw_401.s0.y.preheader":            ; preds = %"produce op_vpackusdw_401"
  ...
  %buf_min175 = getelementptr inbounds %struct.buffer_t, ptr %op_vpackusdw_401.buffer, i64 0, i32 4, i64 0
  %op_vpackusdw_401.min.0 = load i32, ptr %buf_min175, align 4
  %2 = sext i32 %op_vpackusdw_401.min.0 to i64
  %buf_stride172 = getelementptr inbounds %struct.buffer_t, ptr %op_vpackusdw_401.buffer, i64 0, i32 3, i64 1
  %op_vpackusdw_401.stride.1 = load i32, ptr %buf_stride172, align 4
  %3 = sext i32 %op_vpackusdw_401.stride.1 to i64
  %buf_host163 = getelementptr inbounds %struct.buffer_t, ptr %op_vpackusdw_401.buffer, i64 0, i32 1
  %op_vpackusdw_401.host = load ptr, ptr %buf_host163, align 8
  %4 = shl nsw i64 %2, 3
  %5 = sub nsw i64 96, %4
  %scevgep = getelementptr i8, ptr %op_vpackusdw_401.host, i64 %5
  %6 = shl nsw i64 %3, 3
  ...
  %11 = tail call <8 x i16> @llvm.x86.sse41.packusdw(<4 x i32> %9, <4 x i32> %10) #4
  ...
  %14 = tail call <8 x i16> @llvm.x86.sse41.packusdw(<4 x i32> %12, <4 x i32> %13) #4
  ...
  %25 = tail call <8 x i16> @llvm.x86.sse41.packusdw(<4 x i32> %23, <4 x i32> %24) #4
  ...
  %28 = tail call <8 x i16> @llvm.x86.sse41.packusdw(<4 x i32> %26, <4 x i32> %27) #4
  ...
  %30 = uitofp <16 x i16> %29 to <16 x double>
  ...
  %39 = tail call <8 x i16> @llvm.x86.sse41.packusdw(<4 x i32> %37, <4 x i32> %38) #4
  ...
  %42 = tail call <8 x i16> @llvm.x86.sse41.packusdw(<4 x i32> %40, <4 x i32> %41) #4
  ...
  %53 = tail call <8 x i16> @llvm.x86.sse41.packusdw(<4 x i32> %51, <4 x i32> %52) #4
  ...
  %56 = tail call <8 x i16> @llvm.x86.sse41.packusdw(<4 x i32> %54, <4 x i32> %55) #4
  ...
  %58 = uitofp <16 x i16> %57 to <16 x double>
  ...
  %67 = tail call <8 x i16> @llvm.x86.sse41.packusdw(<4 x i32> %65, <4 x i32> %66) #4
  ...
  %70 = tail call <8 x i16> @llvm.x86.sse41.packusdw(<4 x i32> %68, <4 x i32> %69) #4
  ...
  %72 = uitofp <16 x i16> %71 to <16 x double>
  ...
  %81 = tail call <8 x i16> @llvm.x86.sse41.packusdw(<4 x i32> %79, <4 x i32> %80) #4
  ...
  %84 = tail call <8 x i16> @llvm.x86.sse41.packusdw(<4 x i32> %82, <4 x i32> %83) #4
  ...
  %95 = tail call <8 x i16> @llvm.x86.sse41.packusdw(<4 x i32> %93, <4 x i32> %94) #4
  ...
  %98 = tail call <8 x i16> @llvm.x86.sse41.packusdw(<4 x i32> %96, <4 x i32> %97) #4
  ...
  %109 = tail call <8 x i16> @llvm.x86.sse41.packusdw(<4 x i32> %107, <4 x i32> %108) #4
  ...
  %112 = tail call <8 x i16> @llvm.x86.sse41.packusdw(<4 x i32> %110, <4 x i32> %111) #4
  ...
  %114 = uitofp <16 x i16> %113 to <16 x double>
  ...
  %123 = tail call <8 x i16> @llvm.x86.sse41.packusdw(<4 x i32> %121, <4 x i32> %122) #4
  ...
  %126 = tail call <8 x i16> @llvm.x86.sse41.packusdw(<4 x i32> %124, <4 x i32> %125) #4
  ...
  %128 = uitofp <16 x i16> %127 to <16 x double>
  ...
  br label %"for op_vpackusdw_401.s0.x.x.preheader"

"for op_vpackusdw_401.s0.x.x.preheader":          ; preds = %"for op_vpackusdw_401.s0.x.x.preheader", %"for op_vpackusdw_401.s0.y.preheader"
  %lsr.iv180 = phi ptr [ %scevgep, %"for op_vpackusdw_401.s0.y.preheader" ], [ %scevgep182, %"for op_vpackusdw_401.s0.x.x.preheader" ]
  %op_vpackusdw_401.s0.y = phi i32 [ %op_vpackusdw_401.min.1, %"for op_vpackusdw_401.s0.y.preheader" ], [ %231, %"for op_vpackusdw_401.s0.x.x.preheader" ]
  ...
  %137 = tail call <8 x i16> @llvm.x86.sse41.packusdw(<4 x i32> %135, <4 x i32> %136) #4
  ...
  %140 = tail call <8 x i16> @llvm.x86.sse41.packusdw(<4 x i32> %138, <4 x i32> %139) #4
  ...
  %142 = uitofp <16 x i16> %141 to <16 x double>
  ...
  %151 = tail call <8 x i16> @llvm.x86.sse41.packusdw(<4 x i32> %149, <4 x i32> %150) #4
  ...
  %154 = tail call <8 x i16> @llvm.x86.sse41.packusdw(<4 x i32> %152, <4 x i32> %153) #4
  ...
  %165 = tail call <8 x i16> @llvm.x86.sse41.packusdw(<4 x i32> %163, <4 x i32> %164) #4
  ...
  %168 = tail call <8 x i16> @llvm.x86.sse41.packusdw(<4 x i32> %166, <4 x i32> %167) #4
  ...
  %179 = tail call <8 x i16> @llvm.x86.sse41.packusdw(<4 x i32> %177, <4 x i32> %178) #4
  ...
  %182 = tail call <8 x i16> @llvm.x86.sse41.packusdw(<4 x i32> %180, <4 x i32> %181) #4
  ...
  %184 = uitofp <16 x i16> %183 to <16 x double>
  ...
  %193 = tail call <8 x i16> @llvm.x86.sse41.packusdw(<4 x i32> %191, <4 x i32> %192) #4
  ...
  %196 = tail call <8 x i16> @llvm.x86.sse41.packusdw(<4 x i32> %194, <4 x i32> %195) #4
  ...
  %198 = uitofp <16 x i16> %197 to <16 x double>
  ...
  %207 = tail call <8 x i16> @llvm.x86.sse41.packusdw(<4 x i32> %205, <4 x i32> %206) #4
  ...
  %210 = tail call <8 x i16> @llvm.x86.sse41.packusdw(<4 x i32> %208, <4 x i32> %209) #4
  ...
  %212 = uitofp <16 x i16> %211 to <16 x double>
  ...
  %221 = tail call <8 x i16> @llvm.x86.sse41.packusdw(<4 x i32> %219, <4 x i32> %220) #4
  ...
  %224 = tail call <8 x i16> @llvm.x86.sse41.packusdw(<4 x i32> %222, <4 x i32> %223) #4
  ...
  %226 = uitofp <16 x i16> %225 to <16 x double>
  ...
  %231 = add nsw i32 %op_vpackusdw_401.s0.y, 1
  %scevgep182 = getelementptr i1, ptr %lsr.iv180, i64 %6
  %.not2 = icmp eq i32 %231, %0
  br i1 %.not2, label %destructor_block, label %"for op_vpackusdw_401.s0.x.x.preheader"

destructor_block:                                 ; preds = %"for op_vpackusdw_401.s0.x.x.preheader", %"produce op_vpackusdw_401"
  ret i32 0
}

; Function Attrs: nofree nosync nounwind memory(readwrite, inaccessiblemem: none)
define i32 @test_op(ptr noalias nocapture readnone %in_f32.buffer, ptr noalias nocapture readnone %in_f64.buffer, ptr noalias nocapture readnone %in_i8.buffer, ptr noalias nocapture readnone %in_u8.buffer, ptr noalias nocapture readnone %in_i16.buffer, ptr noalias nocapture readnone %in_u16.buffer, ptr noalias nocapture readonly %in_i32.buffer, ptr noalias nocapture readnone %in_u32.buffer, ptr noalias nocapture readnone %in_i64.buffer, ptr noalias nocapture readnone %in_u64.buffer, ptr noalias nocapture readonly %op_vpackusdw_401.buffer) local_unnamed_addr #2 {
destructor_block:
  %"__test_op_result$25" = tail call i32 @__test_op(ptr poison, ptr poison, ptr poison, ptr poison, ptr poison, ptr poison, ptr %in_i32.buffer, ptr poison, ptr poison, ptr poison, ptr %op_vpackusdw_401.buffer) #4
  ret i32 0
}
