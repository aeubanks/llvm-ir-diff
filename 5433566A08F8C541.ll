...
if.end65:                                         ; preds = %if.then64, %if.end61
  ...
  %arrayidx108.11451 = getelementptr inbounds [3 x i32], ptr %lambda_mf, i64 0, i64 1
...
for.body69:                                       ; preds = %if.end65, %for.inc365
  %indvars.iv1377 = phi i64 [ 1, %if.end65 ], [ %indvars.iv.next1378, %for.inc365 ]
  %RDCost16.11346 = phi double [ 0x7FEFFFFFFFFFFFFF, %if.end65 ], [ %RDCost16.3, %for.inc365 ]
  %mode16.11345 = phi i16 [ 0, %if.end65 ], [ %mode16.3, %for.inc365 ]
  %mode.01343 = phi i32 [ 1, %if.end65 ], [ %inc366, %for.inc365 ]
  %min_cost.01342 = phi i32 [ 2147483647, %if.end65 ], [ %min_cost.1, %for.inc365 ]
  store i16 0, ptr @bi_pred_me, align 2, !tbaa !22
  %25 = load ptr, ptr @img, align 8, !tbaa !9
  %arrayidx71 = getelementptr inbounds %struct.ImageParameters, ptr %25, i64 0, i32 83, i64 %indvars.iv1377
  store i16 0, ptr %arrayidx71, align 2, !tbaa !22
  %arrayidx74 = getelementptr inbounds %struct.RD_PARAMS, ptr %enc_mb, i64 0, i32 3, i64 %indvars.iv1377
...
if.then79:                                        ; preds = %for.body69
  store i32 0, ptr %cost, align 4, !tbaa !5
  %cmp81 = icmp eq i64 %indvars.iv1377, 1
  %cmp210 = icmp ugt i64 %indvars.iv1377, 1
  %28 = trunc i64 %indvars.iv1377 to i32
...
for.cond87.preheader:                             ; preds = %if.then79, %for.inc222
  ...
  %cmp841367 = phi i1 [ false, %if.then79 ], [ true, %for.inc222 ]
...
cond.end105:                                      ; preds = %for.cond87.preheader
  ...
  %.pre1407 = load ptr, ptr @input, align 8, !tbaa !9
  %CtxAdptLagrangeMult91.1.phi.trans.insert = getelementptr inbounds %struct.InputParameters, ptr %.pre1407, i64 0, i32 114
  %.pre1408 = load i32, ptr %CtxAdptLagrangeMult91.1.phi.trans.insert, align 4, !tbaa !29
  store i32 %conv104, ptr %lambda_mf, align 4, !tbaa !5
  %cmp92.1 = icmp eq i32 %.pre1408, 0
...
cond.end105.1.thread:                             ; preds = %cond.end105, %cond.end105.thread
  ...
  store i32 %34, ptr %arrayidx108.11451, align 4, !tbaa !5
...
cond.end105.1:                                    ; preds = %cond.end105
  ...
  %.pre1409 = load ptr, ptr @input, align 8, !tbaa !9
  %CtxAdptLagrangeMult91.2.phi.trans.insert = getelementptr inbounds %struct.InputParameters, ptr %.pre1409, i64 0, i32 114
  %.pre1410 = load i32, ptr %CtxAdptLagrangeMult91.2.phi.trans.insert, align 4, !tbaa !29
  store i32 %conv104.1, ptr %arrayidx108.1, align 4, !tbaa !5
  %cmp92.2 = icmp eq i32 %.pre1410, 0
...
if.end143:                                        ; preds = %if.else140, %if.then137
  ...
  %.pre1411 = load i8, ptr %best_pdir, align 1, !tbaa !31
  br label %if.end148
...
if.end148:                                        ; preds = %if.else146, %if.end143
  %45 = phi i8 [ 0, %if.else146 ], [ %.pre1411, %if.end143 ]
...
for.inc222:                                       ; preds = %if.end209, %if.then215
  %cmp84.not = or i1 %cmp81, %cmp841367
...
if.then227:                                       ; preds = %for.end224
  switch i32 %.fr, label %for.body234 [
...
if.end351:                                        ; preds = %if.end349, %for.end224
  %mode16.2 = phi i16 [ %86, %if.end349 ], [ %mode16.11345, %for.end224 ]
  %RDCost16.2 = phi double [ %85, %if.end349 ], [ %RDCost16.11346, %for.end224 ]
  %87 = load i16, ptr %inter_skip, align 2, !tbaa !22
  %tobool352.not = icmp eq i16 %87, 0
  br i1 %tobool352.not, label %land.lhs.true353, label %for.inc365

land.lhs.true353:                                 ; preds = %if.end351
  %88 = load i32, ptr %cost, align 4, !tbaa !5
  %cmp354 = icmp slt i32 %88, %min_cost.01342
  br i1 %cmp354, label %if.then356, label %for.inc365

if.then356:                                       ; preds = %land.lhs.true353
  %conv357 = trunc i32 %mode.01343 to i16
...
for.inc365:                                       ; preds = %for.body69, %if.then356, %if.then361, %land.lhs.true353, %if.end351
  %min_cost.1 = phi i32 [ %min_cost.01342, %for.body69 ], [ %min_cost.01342, %if.end351 ], [ %88, %if.then361 ], [ %88, %if.then356 ], [ %min_cost.01342, %land.lhs.true353 ]
  %mode16.3 = phi i16 [ %mode16.11345, %for.body69 ], [ %mode16.2, %if.end351 ], [ %mode16.2, %if.then361 ], [ %mode16.2, %if.then356 ], [ %mode16.2, %land.lhs.true353 ]
  %RDCost16.3 = phi double [ %RDCost16.11346, %for.body69 ], [ %RDCost16.2, %if.end351 ], [ %RDCost16.2, %if.then361 ], [ %RDCost16.2, %if.then356 ], [ %RDCost16.2, %land.lhs.true353 ]
  %indvars.iv.next1378 = add nuw nsw i64 %indvars.iv1377, 1
  %inc366 = add nuw nsw i32 %mode.01343, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next1378, 4
...
if.end403:                                        ; preds = %if.then374
  ...
  %.pre1412 = load ptr, ptr @input, align 8, !tbaa !9
  %Transform8x8Mode404.phi.trans.insert = getelementptr inbounds %struct.InputParameters, ptr %.pre1412, i64 0, i32 153
  %.pre1413 = load i32, ptr %Transform8x8Mode404.phi.trans.insert, align 4, !tbaa !45
  %cmp405.not = icmp eq i32 %.pre1413, 2
...
if.end450:                                        ; preds = %if.then443, %if.then447
  ...
  %.pre1414 = load ptr, ptr @input, align 8, !tbaa !9
  br i1 %tobool52, label %land.end454.thread, label %land.end454

land.end454:                                      ; preds = %if.end450
  %SelectiveIntraEnable = getelementptr inbounds %struct.InputParameters, ptr %.pre1414, i64 0, i32 191
  %156 = load i32, ptr %SelectiveIntraEnable, align 4, !tbaa !51
  %.fr1368 = freeze i32 %156
  %tobool453 = icmp ne i32 %.fr1368, 0
  %spec.select1336 = select i1 %tobool453, i32 5, i32 9
...
land.end454.thread:                               ; preds = %if.end450, %land.end454
  ...
  %158 = phi i32 [ %spec.select1336, %land.end454 ], [ 9, %if.end450 ]
  %BiPredMotionEstimation456 = getelementptr inbounds %struct.InputParameters, ptr %.pre1414, i64 0, i32 46
...
if.end477:                                        ; preds = %if.end461, %if.then467, %if.then469
  ...
  %cmp483.not1354 = icmp sgt i32 %conv478, %conv482
  %.pre1421 = load ptr, ptr @img, align 8, !tbaa !9
  br i1 %cmp483.not1354, label %for.end757, label %for.body485.preheader
...
for.body485:                                      ; preds = %for.body485.preheader, %for.inc754
  %.pre1417 = phi ptr [ %.pre14171443, %for.inc754 ], [ %.pre1421, %for.body485.preheader ]
  %164 = phi ptr [ %274, %for.inc754 ], [ %.pre1421, %for.body485.preheader ]
  %storemerge1355 = phi i32 [ %inc756, %for.inc754 ], [ %conv478, %for.body485.preheader ]
...
land.lhs.true492:                                 ; preds = %land.lhs.true489, %lor.lhs.false
  ...
  %cmp493 = icmp ne i32 %168, 1
  %cmp497.not = icmp eq i32 %storemerge1355, 0
  %or.cond1325 = or i1 %cmp497.not, %cmp493
  br i1 %or.cond1325, label %lor.lhs.false499, label %for.inc754

lor.lhs.false499:                                 ; preds = %land.lhs.true492, %lor.lhs.false
  %cmp501 = icmp ne i32 %storemerge1355, 2
...
lor.lhs.false505:                                 ; preds = %lor.lhs.false499
  %cmp507 = icmp ne i32 %storemerge1355, 1
...
lor.lhs.false511:                                 ; preds = %lor.lhs.false505
  %cmp513 = icmp eq i32 %storemerge1355, 3
...
for.body526.preheader:                            ; preds = %land.lhs.true515, %lor.lhs.false511, %for.body485
  br label %for.body526

for.body526:                                      ; preds = %for.body526.preheader, %for.inc751
  %.pre14171446 = phi ptr [ %.pre14171444, %for.inc751 ], [ %.pre1417, %for.body526.preheader ]
  %172 = phi ptr [ %272, %for.inc751 ], [ %.pre1417, %for.body526.preheader ]
  %173 = phi ptr [ %273, %for.inc751 ], [ %.pre1417, %for.body526.preheader ]
  %index.91353 = phi i32 [ %inc752, %for.inc751 ], [ 0, %for.body526.preheader ]
  %ctr16x16.31352 = phi i32 [ %ctr16x16.6, %for.inc751 ], [ 0, %for.body526.preheader ]
  %idxprom527 = sext i32 %index.91353 to i64
...
if.end545.if.end580_crit_edge:                    ; preds = %if.end545
  %.pre1418 = load ptr, ptr @input, align 8, !tbaa !9
  br label %if.end580

if.then551:                                       ; preds = %if.end545
  %conv552 = trunc i32 %ctr16x16.31352 to i8
  ...
  %cmp559 = icmp eq i32 %ctr16x16.31352, 2
...
if.end573:                                        ; preds = %land.lhs.true561, %if.then551
  %ctr16x16.4 = phi i32 [ %ctr16x16.31352, %if.then551 ], [ %spec.select, %land.lhs.true561 ]
  %cmp574 = icmp slt i32 %ctr16x16.4, 2
  %dec577 = sext i1 %cmp574 to i32
  %spec.select1327 = add nsw i32 %index.91353, %dec577
  %inc579 = add nsw i32 %ctr16x16.4, 1
  br label %if.end580

if.end580:                                        ; preds = %if.end545.if.end580_crit_edge, %if.end573
  %179 = phi ptr [ %176, %if.end573 ], [ %.pre1418, %if.end545.if.end580_crit_edge ]
  %ctr16x16.5 = phi i32 [ %inc579, %if.end573 ], [ %ctr16x16.31352, %if.end545.if.end580_crit_edge ]
  %index.11 = phi i32 [ %spec.select1327, %if.end573 ], [ %index.91353, %if.end545.if.end580_crit_edge ]
...
for.body624.11491:                                ; preds = %for.cond618
  %arrayidx641.11487 = getelementptr inbounds i32, ptr %193, i64 1
  %200 = load i32, ptr %arrayidx641.11487, align 4, !tbaa !5
  %arrayidx658.11488 = getelementptr inbounds i32, ptr %196, i64 1
  %201 = load i32, ptr %arrayidx658.11488, align 4, !tbaa !5
  %add659.11489 = add i32 %200, -128
  %202 = add i32 %add659.11489, %201
  %or.cond1057.11490 = icmp ult i32 %202, -256
...
for.body624.21501:                                ; preds = %for.cond618.11495
  %arrayidx641.21497 = getelementptr inbounds i32, ptr %193, i64 2
  %203 = load i32, ptr %arrayidx641.21497, align 4, !tbaa !5
  %arrayidx658.21498 = getelementptr inbounds i32, ptr %196, i64 2
  %204 = load i32, ptr %arrayidx658.21498, align 4, !tbaa !5
  %add659.21499 = add i32 %203, -128
  %205 = add i32 %add659.21499, %204
  %or.cond1057.21500 = icmp ult i32 %205, -256
...
if.then716:                                       ; preds = %if.end711
  ...
  %.pre1416 = load ptr, ptr @img, align 8, !tbaa !9
  %.pre1419 = load ptr, ptr @input, align 8, !tbaa !9
  br label %if.end717

if.end717:                                        ; preds = %if.then716, %if.end711
  %.pre14171445 = phi ptr [ %.pre1416, %if.then716 ], [ %.pre14171446, %if.end711 ]
  %266 = phi ptr [ %.pre1416, %if.then716 ], [ %172, %if.end711 ]
  %267 = phi ptr [ %.pre1419, %if.then716 ], [ %179, %if.end711 ]
  %268 = phi ptr [ %.pre1416, %if.then716 ], [ %173, %if.end711 ]
...
for.inc751.sink.split:                            ; preds = %land.lhs.true726, %land.lhs.true686
  ...
  %.pre14171444.ph = phi ptr [ %.pre14171446, %land.lhs.true686 ], [ %.pre14171445, %land.lhs.true726 ]
  %.ph = phi ptr [ %172, %land.lhs.true686 ], [ %266, %land.lhs.true726 ]
  %.ph1472 = phi ptr [ %173, %land.lhs.true686 ], [ %266, %land.lhs.true726 ]
...
for.inc751:                                       ; preds = %for.inc751.sink.split, %if.then680, %land.lhs.true686, %if.end717, %land.lhs.true726, %land.lhs.true591, %if.then532
  %.pre14171444 = phi ptr [ %.pre14171446, %if.then532 ], [ %.pre14171446, %land.lhs.true591 ], [ %.pre14171445, %land.lhs.true726 ], [ %.pre14171445, %if.end717 ], [ %.pre14171446, %land.lhs.true686 ], [ %.pre14171446, %if.then680 ], [ %.pre14171444.ph, %for.inc751.sink.split ]
  ...
  %273 = phi ptr [ %173, %if.then532 ], [ %173, %land.lhs.true591 ], [ %266, %land.lhs.true726 ], [ %268, %if.end717 ], [ %173, %land.lhs.true686 ], [ %173, %if.then680 ], [ %.ph1472, %for.inc751.sink.split ]
  %ctr16x16.6 = phi i32 [ %ctr16x16.31352, %if.then532 ], [ %ctr16x16.5, %land.lhs.true591 ], [ 2, %land.lhs.true726 ], [ %ctr16x16.5, %if.end717 ], [ 2, %land.lhs.true686 ], [ %ctr16x16.5, %if.then680 ], [ 2, %for.inc751.sink.split ]
  %index.12 = phi i32 [ %index.91353, %if.then532 ], [ %index.11, %land.lhs.true591 ], [ %index.11, %land.lhs.true726 ], [ %index.11, %if.end717 ], [ %index.11, %land.lhs.true686 ], [ %index.11, %if.then680 ], [ %index.11, %for.inc751.sink.split ]
...
for.inc754.loopexit:                              ; preds = %for.inc751
  %.pre1420 = load i32, ptr %c_ipred_mode, align 8, !tbaa !26
  br label %for.inc754

for.inc754:                                       ; preds = %for.inc754.loopexit, %land.lhs.true492, %land.lhs.true515, %lor.lhs.false499, %lor.lhs.false505
  %.pre14171443 = phi ptr [ %.pre1417, %land.lhs.true515 ], [ %.pre1417, %lor.lhs.false505 ], [ %.pre1417, %lor.lhs.false499 ], [ %.pre1417, %land.lhs.true492 ], [ %.pre14171444, %for.inc754.loopexit ]
  %274 = phi ptr [ %164, %land.lhs.true515 ], [ %164, %lor.lhs.false505 ], [ %164, %lor.lhs.false499 ], [ %164, %land.lhs.true492 ], [ %272, %for.inc754.loopexit ]
  %275 = phi i32 [ 3, %land.lhs.true515 ], [ 1, %lor.lhs.false505 ], [ 2, %lor.lhs.false499 ], [ %storemerge1355, %land.lhs.true492 ], [ %.pre1420, %for.inc754.loopexit ]
...
for.end757:                                       ; preds = %for.inc754, %if.end477
  %276 = phi ptr [ %.pre1421, %if.end477 ], [ %274, %for.inc754 ]
...
if.end784:                                        ; preds = %if.then769, %if.then773, %if.then776
  ...
  %cmp790.not1358 = icmp sgt i32 %conv785, %conv789
  br i1 %cmp790.not1358, label %if.end887, label %for.body792.preheader
...
for.body792.preheader:                            ; preds = %if.end784
  ...
  %292 = load i32, ptr getelementptr inbounds ([9 x i32], ptr @mb_mode_table, i64 0, i64 5), align 4
  %cmp844.us = icmp sgt i32 %292, 9
  %cmp863.us = icmp ne i32 %292, 0
  %cmp868.us = icmp ne i32 %292, 1
  %or.cond1072.not.us = select i1 %cmp, i1 true, i1 %cmp868.us
  %or.cond1329.us = and i1 %cmp863.us, %or.cond1072.not.us
  %idxprom874.us = sext i32 %292 to i64
  %arrayidx875.us = getelementptr inbounds %struct.RD_PARAMS, ptr %enc_mb, i64 0, i32 3, i64 %idxprom874.us
  %293 = load i32, ptr getelementptr inbounds ([9 x i32], ptr @mb_mode_table, i64 0, i64 6), align 8
  %cmp844.us.1 = icmp sgt i32 %293, 9
  %cmp863.us.1 = icmp ne i32 %293, 0
  %cmp868.us.1 = icmp ne i32 %293, 1
  %or.cond1072.not.us.1 = select i1 %cmp, i1 true, i1 %cmp868.us.1
  %or.cond1329.us.1 = and i1 %cmp863.us.1, %or.cond1072.not.us.1
  %idxprom874.us.1 = sext i32 %293 to i64
  %arrayidx875.us.1 = getelementptr inbounds %struct.RD_PARAMS, ptr %enc_mb, i64 0, i32 3, i64 %idxprom874.us.1
  %294 = load i32, ptr getelementptr inbounds ([9 x i32], ptr @mb_mode_table, i64 0, i64 7), align 4
  %cmp844.us.2 = icmp sgt i32 %294, 9
  %cmp863.us.2 = icmp ne i32 %294, 0
  %cmp868.us.2 = icmp ne i32 %294, 1
  %or.cond1072.not.us.2 = select i1 %cmp, i1 true, i1 %cmp868.us.2
  %or.cond1329.us.2 = and i1 %cmp863.us.2, %or.cond1072.not.us.2
  %idxprom874.us.2 = sext i32 %294 to i64
  %arrayidx875.us.2 = getelementptr inbounds %struct.RD_PARAMS, ptr %enc_mb, i64 0, i32 3, i64 %idxprom874.us.2
  %295 = load i32, ptr getelementptr inbounds ([9 x i32], ptr @mb_mode_table, i64 0, i64 8), align 16
  %cmp844.us.3 = icmp sgt i32 %295, 9
  %cmp863.us.3 = icmp ne i32 %295, 0
  %cmp868.us.3 = icmp ne i32 %295, 1
  %or.cond1072.not.us.3 = select i1 %cmp, i1 true, i1 %cmp868.us.3
  %or.cond1329.us.3 = and i1 %cmp863.us.3, %or.cond1072.not.us.3
  %idxprom874.us.3 = sext i32 %295 to i64
  %arrayidx875.us.3 = getelementptr inbounds %struct.RD_PARAMS, ptr %enc_mb, i64 0, i32 3, i64 %idxprom874.us.3
  br label %for.body792

for.body792:                                      ; preds = %for.body792.preheader, %for.inc882
  %storemerge13211359 = phi i32 [ %inc884, %for.inc882 ], [ %conv785, %for.body792.preheader ]
  %296 = load ptr, ptr @img, align 8, !tbaa !9
  %yuv_format793 = getelementptr inbounds %struct.ImageParameters, ptr %296, i64 0, i32 160
  %297 = load i32, ptr %yuv_format793, align 8, !tbaa !52
  %cmp794.not = icmp eq i32 %297, 0
...
lor.lhs.false798:                                 ; preds = %land.lhs.true796
  %IntraDisableInterOnly799 = getelementptr inbounds %struct.InputParameters, ptr %298, i64 0, i32 84
  %299 = load i32, ptr %IntraDisableInterOnly799, align 8, !tbaa !54
  %tobool800.not = icmp eq i32 %299, 0
...
land.lhs.true801:                                 ; preds = %land.lhs.true796, %lor.lhs.false798
  %ChromaIntraDisable802 = getelementptr inbounds %struct.InputParameters, ptr %298, i64 0, i32 90
  %300 = load i32, ptr %ChromaIntraDisable802, align 8, !tbaa !55
  %cmp803 = icmp ne i32 %300, 1
  %cmp807.not = icmp eq i32 %storemerge13211359, 0
  %or.cond1328 = or i1 %cmp807.not, %cmp803
  br i1 %or.cond1328, label %lor.lhs.false809, label %for.inc882

lor.lhs.false809:                                 ; preds = %land.lhs.true801, %lor.lhs.false798
  %cmp811 = icmp ne i32 %storemerge13211359, 2
  %301 = load i32, ptr %mb_available_up, align 4
  %tobool814 = icmp ne i32 %301, 0
...
lor.lhs.false815:                                 ; preds = %lor.lhs.false809
  %cmp817 = icmp ne i32 %storemerge13211359, 1
  %302 = load i32, ptr %mb_available_left, align 4
  %tobool820 = icmp ne i32 %302, 0
...
lor.lhs.false821:                                 ; preds = %lor.lhs.false815
  %cmp823 = icmp eq i32 %storemerge13211359, 3
...
land.lhs.true825:                                 ; preds = %lor.lhs.false821
  ...
  %303 = load i32, ptr %mb_available_up_left, align 4
  %tobool830 = icmp ne i32 %303, 0
  %or.cond1067 = select i1 %or.cond1066, i1 %tobool830, i1 false
  br i1 %or.cond1067, label %if.end832, label %for.inc882

if.end832:                                        ; preds = %land.lhs.true825, %lor.lhs.false821, %for.body792
  %304 = load ptr, ptr @input, align 8, !tbaa !9
  %SkipIntraInInterSlices839.us = getelementptr inbounds %struct.InputParameters, ptr %304, i64 0, i32 67
  %305 = load i32, ptr %SkipIntraInInterSlices839.us, align 8, !tbaa !56
  %tobool840.us = icmp eq i32 %305, 0
  %or.cond1068.us = or i1 %tobool52, %tobool840.us
  %or.cond1068.not.us = xor i1 %or.cond1068.us, true
  %306 = load i16, ptr @best_mode, align 2
  %cmp848.us = icmp slt i16 %306, 4
  br i1 %cmp3, label %for.body836.us.preheader, label %for.body836.preheader

for.body836.preheader:                            ; preds = %if.end832
  %or.cond1069 = select i1 %or.cond1068.not.us, i1 %cmp844, i1 false
  %or.cond1070 = select i1 %or.cond1069, i1 %cmp848.us, i1 false
  br i1 %or.cond1070, label %land.lhs.true850, label %if.end855

for.body836.us.preheader:                         ; preds = %if.end832
  %or.cond1069.us = select i1 %or.cond1068.not.us, i1 %cmp844.us, i1 false
  %or.cond1070.us = select i1 %or.cond1069.us, i1 %cmp848.us, i1 false
  br i1 %or.cond1070.us, label %land.lhs.true850.us, label %if.end855.us

land.lhs.true850.us:                              ; preds = %for.body836.us.preheader
  %307 = load i32, ptr %cbp, align 4, !tbaa !35
  %cmp852.us = icmp ne i32 %307, 0
  %brmerge = select i1 %cmp794.not, i1 true, i1 %or.cond1329.us
  %or.cond1477 = select i1 %cmp852.us, i1 %brmerge, i1 false
  br i1 %or.cond1477, label %if.end872.us, label %for.inc879.us

if.end855.us:                                     ; preds = %for.body836.us.preheader
  %brmerge.old = select i1 %cmp794.not, i1 true, i1 %or.cond1329.us
  br i1 %brmerge.old, label %if.end872.us, label %for.inc879.us

if.end872.us:                                     ; preds = %land.lhs.true850.us, %if.end855.us
  %308 = load i16, ptr %arrayidx875.us, align 2, !tbaa !22
  %tobool876.not.us = icmp eq i16 %308, 0
  br i1 %tobool876.not.us, label %for.inc879.us, label %if.then877.us

if.then877.us:                                    ; preds = %if.end872.us
  call void @compute_mode_RD_cost(i32 noundef %292, ptr noundef nonnull %arrayidx, ptr noundef nonnull byval(%struct.RD_PARAMS) align 8 %enc_mb, ptr noundef nonnull %min_rdcost, ptr noundef nonnull %min_rate, i32 noundef 0, i16 noundef signext %conv5, ptr noundef nonnull %inter_skip) #6
  %.pre1432 = load ptr, ptr @input, align 8, !tbaa !9
  %SkipIntraInInterSlices839.us.1.phi.trans.insert = getelementptr inbounds %struct.InputParameters, ptr %.pre1432, i64 0, i32 67
  %.pre1433 = load i32, ptr %SkipIntraInInterSlices839.us.1.phi.trans.insert, align 8, !tbaa !56
  %.pre1434 = load i16, ptr @best_mode, align 2
  br label %for.inc879.us

for.inc879.us:                                    ; preds = %if.end855.us, %if.then877.us, %if.end872.us, %land.lhs.true850.us
  %309 = phi i16 [ %.pre1434, %if.then877.us ], [ %306, %if.end872.us ], [ %306, %land.lhs.true850.us ], [ %306, %if.end855.us ]
  %310 = phi i32 [ %.pre1433, %if.then877.us ], [ %305, %if.end872.us ], [ %305, %land.lhs.true850.us ], [ %305, %if.end855.us ]
  %tobool840.us.1 = icmp eq i32 %310, 0
  %or.cond1068.us.1 = or i1 %tobool52, %tobool840.us.1
  %or.cond1068.not.us.1 = xor i1 %or.cond1068.us.1, true
  %or.cond1069.us.1 = select i1 %or.cond1068.not.us.1, i1 %cmp844.us.1, i1 false
  %cmp848.us.1 = icmp slt i16 %309, 4
  %or.cond1070.us.1 = select i1 %or.cond1069.us.1, i1 %cmp848.us.1, i1 false
  br i1 %or.cond1070.us.1, label %land.lhs.true850.us.1, label %if.end855.us.1

land.lhs.true850.us.1:                            ; preds = %for.inc879.us
  %311 = load i32, ptr %cbp, align 4, !tbaa !35
  %cmp852.us.1 = icmp eq i32 %311, 0
  br i1 %cmp852.us.1, label %for.inc879.us.1, label %if.end855.us.1

if.end855.us.1:                                   ; preds = %land.lhs.true850.us.1, %for.inc879.us
  %312 = load ptr, ptr @img, align 8, !tbaa !9
  %yuv_format856.us.1 = getelementptr inbounds %struct.ImageParameters, ptr %312, i64 0, i32 160
  %313 = load i32, ptr %yuv_format856.us.1, align 8, !tbaa !52
  %cmp857.not.us.1 = icmp eq i32 %313, 0
  %brmerge1473 = select i1 %cmp857.not.us.1, i1 true, i1 %or.cond1329.us.1
  br i1 %brmerge1473, label %if.end872.us.1, label %for.inc879.us.1

if.end872.us.1:                                   ; preds = %if.end855.us.1
  %314 = load i16, ptr %arrayidx875.us.1, align 2, !tbaa !22
  %tobool876.not.us.1 = icmp eq i16 %314, 0
  br i1 %tobool876.not.us.1, label %for.inc879.us.1, label %if.then877.us.1

if.then877.us.1:                                  ; preds = %if.end872.us.1
  call void @compute_mode_RD_cost(i32 noundef %293, ptr noundef nonnull %arrayidx, ptr noundef nonnull byval(%struct.RD_PARAMS) align 8 %enc_mb, ptr noundef nonnull %min_rdcost, ptr noundef nonnull %min_rate, i32 noundef 0, i16 noundef signext %conv5, ptr noundef nonnull %inter_skip) #6
  %.pre1435 = load ptr, ptr @input, align 8, !tbaa !9
  %SkipIntraInInterSlices839.us.2.phi.trans.insert = getelementptr inbounds %struct.InputParameters, ptr %.pre1435, i64 0, i32 67
  %.pre1436 = load i32, ptr %SkipIntraInInterSlices839.us.2.phi.trans.insert, align 8, !tbaa !56
  %.pre1437 = load i16, ptr @best_mode, align 2
  br label %for.inc879.us.1

for.inc879.us.1:                                  ; preds = %if.end855.us.1, %if.then877.us.1, %if.end872.us.1, %land.lhs.true850.us.1
  %315 = phi i16 [ %.pre1437, %if.then877.us.1 ], [ %309, %if.end872.us.1 ], [ %309, %land.lhs.true850.us.1 ], [ %309, %if.end855.us.1 ]
  %316 = phi i32 [ %.pre1436, %if.then877.us.1 ], [ %310, %if.end872.us.1 ], [ %310, %land.lhs.true850.us.1 ], [ %310, %if.end855.us.1 ]
  %tobool840.us.2 = icmp eq i32 %316, 0
  %or.cond1068.us.2 = or i1 %tobool52, %tobool840.us.2
  %or.cond1068.not.us.2 = xor i1 %or.cond1068.us.2, true
  %or.cond1069.us.2 = select i1 %or.cond1068.not.us.2, i1 %cmp844.us.2, i1 false
  %cmp848.us.2 = icmp slt i16 %315, 4
  %or.cond1070.us.2 = select i1 %or.cond1069.us.2, i1 %cmp848.us.2, i1 false
  br i1 %or.cond1070.us.2, label %land.lhs.true850.us.2, label %if.end855.us.2

land.lhs.true850.us.2:                            ; preds = %for.inc879.us.1
  %317 = load i32, ptr %cbp, align 4, !tbaa !35
  %cmp852.us.2 = icmp eq i32 %317, 0
  br i1 %cmp852.us.2, label %for.inc879.us.2, label %if.end855.us.2

if.end855.us.2:                                   ; preds = %land.lhs.true850.us.2, %for.inc879.us.1
  %318 = load ptr, ptr @img, align 8, !tbaa !9
  %yuv_format856.us.2 = getelementptr inbounds %struct.ImageParameters, ptr %318, i64 0, i32 160
  %319 = load i32, ptr %yuv_format856.us.2, align 8, !tbaa !52
  %cmp857.not.us.2 = icmp eq i32 %319, 0
  %brmerge1474 = select i1 %cmp857.not.us.2, i1 true, i1 %or.cond1329.us.2
  br i1 %brmerge1474, label %if.end872.us.2, label %for.inc879.us.2

if.end872.us.2:                                   ; preds = %if.end855.us.2
  %320 = load i16, ptr %arrayidx875.us.2, align 2, !tbaa !22
  %tobool876.not.us.2 = icmp eq i16 %320, 0
  br i1 %tobool876.not.us.2, label %for.inc879.us.2, label %if.then877.us.2

if.then877.us.2:                                  ; preds = %if.end872.us.2
  call void @compute_mode_RD_cost(i32 noundef %294, ptr noundef nonnull %arrayidx, ptr noundef nonnull byval(%struct.RD_PARAMS) align 8 %enc_mb, ptr noundef nonnull %min_rdcost, ptr noundef nonnull %min_rate, i32 noundef 0, i16 noundef signext %conv5, ptr noundef nonnull %inter_skip) #6
  %.pre1438 = load ptr, ptr @input, align 8, !tbaa !9
  %SkipIntraInInterSlices839.us.3.phi.trans.insert = getelementptr inbounds %struct.InputParameters, ptr %.pre1438, i64 0, i32 67
  %.pre1439 = load i32, ptr %SkipIntraInInterSlices839.us.3.phi.trans.insert, align 8, !tbaa !56
  %.pre1440 = load i16, ptr @best_mode, align 2
  br label %for.inc879.us.2

for.inc879.us.2:                                  ; preds = %if.end855.us.2, %if.then877.us.2, %if.end872.us.2, %land.lhs.true850.us.2
  %321 = phi i16 [ %.pre1440, %if.then877.us.2 ], [ %315, %if.end872.us.2 ], [ %315, %land.lhs.true850.us.2 ], [ %315, %if.end855.us.2 ]
  %322 = phi i32 [ %.pre1439, %if.then877.us.2 ], [ %316, %if.end872.us.2 ], [ %316, %land.lhs.true850.us.2 ], [ %316, %if.end855.us.2 ]
  %tobool840.us.3 = icmp eq i32 %322, 0
  %or.cond1068.us.3 = or i1 %tobool52, %tobool840.us.3
  %or.cond1068.not.us.3 = xor i1 %or.cond1068.us.3, true
  %or.cond1069.us.3 = select i1 %or.cond1068.not.us.3, i1 %cmp844.us.3, i1 false
  %cmp848.us.3 = icmp slt i16 %321, 4
  %or.cond1070.us.3 = select i1 %or.cond1069.us.3, i1 %cmp848.us.3, i1 false
  br i1 %or.cond1070.us.3, label %land.lhs.true850.us.3, label %if.end855.us.3

land.lhs.true850.us.3:                            ; preds = %for.inc879.us.2
  %323 = load i32, ptr %cbp, align 4, !tbaa !35
  %cmp852.us.3 = icmp eq i32 %323, 0
  br i1 %cmp852.us.3, label %for.inc882, label %if.end855.us.3

if.end855.us.3:                                   ; preds = %land.lhs.true850.us.3, %for.inc879.us.2
  %324 = load ptr, ptr @img, align 8, !tbaa !9
  %yuv_format856.us.3 = getelementptr inbounds %struct.ImageParameters, ptr %324, i64 0, i32 160
  %325 = load i32, ptr %yuv_format856.us.3, align 8, !tbaa !52
  %cmp857.not.us.3 = icmp eq i32 %325, 0
  %brmerge1475 = select i1 %cmp857.not.us.3, i1 true, i1 %or.cond1329.us.3
  br i1 %brmerge1475, label %if.end872.us.3, label %for.inc882

if.end872.us.3:                                   ; preds = %if.end855.us.3
  %326 = load i16, ptr %arrayidx875.us.3, align 2, !tbaa !22
  %tobool876.not.us.3 = icmp eq i16 %326, 0
  br i1 %tobool876.not.us.3, label %for.inc882, label %if.then877.us.3

if.then877.us.3:                                  ; preds = %if.end872.us.3
  call void @compute_mode_RD_cost(i32 noundef %295, ptr noundef nonnull %arrayidx, ptr noundef nonnull byval(%struct.RD_PARAMS) align 8 %enc_mb, ptr noundef nonnull %min_rdcost, ptr noundef nonnull %min_rate, i32 noundef 0, i16 noundef signext %conv5, ptr noundef nonnull %inter_skip) #6
  br label %for.inc882

land.lhs.true850:                                 ; preds = %for.body836.preheader
  %327 = load i32, ptr %cbp, align 4, !tbaa !35
  %cmp852 = icmp eq i32 %327, 0
  br i1 %cmp852, label %for.inc879, label %if.end872

if.end855:                                        ; preds = %for.body836.preheader
  %328 = or i1 %cmp794.not, %cmp
  %or.cond1366 = select i1 %328, i1 true, i1 %cmp868
  br i1 %or.cond1366, label %if.end872, label %for.inc879

if.end872:                                        ; preds = %land.lhs.true850, %if.end855
  %329 = load i16, ptr %arrayidx875, align 2, !tbaa !22
  %tobool876.not = icmp eq i16 %329, 0
...
if.then877:                                       ; preds = %if.end872
  ...
  %SkipIntraInInterSlices839.1.phi.trans.insert = getelementptr inbounds %struct.InputParameters, ptr %.pre1423, i64 0, i32 67
  %.pre1424 = load i32, ptr %SkipIntraInInterSlices839.1.phi.trans.insert, align 8, !tbaa !56
  %.pre1425 = load i16, ptr @best_mode, align 2
  br label %for.inc879

for.inc879:                                       ; preds = %if.end855, %if.end872, %if.then877, %land.lhs.true850
  %330 = phi i16 [ %306, %if.end855 ], [ %306, %if.end872 ], [ %.pre1425, %if.then877 ], [ %306, %land.lhs.true850 ]
  %331 = phi i32 [ %305, %if.end855 ], [ %305, %if.end872 ], [ %.pre1424, %if.then877 ], [ %305, %land.lhs.true850 ]
  %tobool840.1 = icmp eq i32 %331, 0
...
land.lhs.true850.1:                               ; preds = %for.inc879
  %332 = load i32, ptr %cbp, align 4, !tbaa !35
  %cmp852.1 = icmp eq i32 %332, 0
  br i1 %cmp852.1, label %for.inc879.1, label %if.end872.1

if.end855.1:                                      ; preds = %for.inc879
  %333 = load ptr, ptr @img, align 8, !tbaa !9
  %yuv_format856.1 = getelementptr inbounds %struct.ImageParameters, ptr %333, i64 0, i32 160
  %334 = load i32, ptr %yuv_format856.1, align 8, !tbaa !52
  %cmp857.not.1 = icmp eq i32 %334, 0
  %335 = or i1 %cmp857.not.1, %cmp
  %or.cond1366.1 = select i1 %335, i1 true, i1 %cmp868.1
  br i1 %or.cond1366.1, label %if.end872.1, label %for.inc879.1

if.end872.1:                                      ; preds = %land.lhs.true850.1, %if.end855.1
  %336 = load i16, ptr %arrayidx875.1, align 2, !tbaa !22
  %tobool876.not.1 = icmp eq i16 %336, 0
...
if.then877.1:                                     ; preds = %if.end872.1
  ...
  %SkipIntraInInterSlices839.2.phi.trans.insert = getelementptr inbounds %struct.InputParameters, ptr %.pre1426, i64 0, i32 67
  %.pre1427 = load i32, ptr %SkipIntraInInterSlices839.2.phi.trans.insert, align 8, !tbaa !56
  %.pre1428 = load i16, ptr @best_mode, align 2
  br label %for.inc879.1

for.inc879.1:                                     ; preds = %if.then877.1, %if.end872.1, %if.end855.1, %land.lhs.true850.1
  %337 = phi i16 [ %.pre1428, %if.then877.1 ], [ %330, %if.end872.1 ], [ %330, %if.end855.1 ], [ %330, %land.lhs.true850.1 ]
  %338 = phi i32 [ %.pre1427, %if.then877.1 ], [ %331, %if.end872.1 ], [ %331, %if.end855.1 ], [ %331, %land.lhs.true850.1 ]
  %tobool840.2 = icmp eq i32 %338, 0
...
land.lhs.true850.2:                               ; preds = %for.inc879.1
  %339 = load i32, ptr %cbp, align 4, !tbaa !35
  %cmp852.2 = icmp eq i32 %339, 0
  br i1 %cmp852.2, label %for.inc879.2, label %if.end872.2

if.end855.2:                                      ; preds = %for.inc879.1
  %340 = load ptr, ptr @img, align 8, !tbaa !9
  %yuv_format856.2 = getelementptr inbounds %struct.ImageParameters, ptr %340, i64 0, i32 160
  %341 = load i32, ptr %yuv_format856.2, align 8, !tbaa !52
  %cmp857.not.2 = icmp eq i32 %341, 0
  %342 = or i1 %cmp857.not.2, %cmp
  %or.cond1366.2 = select i1 %342, i1 true, i1 %cmp868.2
  br i1 %or.cond1366.2, label %if.end872.2, label %for.inc879.2

if.end872.2:                                      ; preds = %land.lhs.true850.2, %if.end855.2
  %343 = load i16, ptr %arrayidx875.2, align 2, !tbaa !22
  %tobool876.not.2 = icmp eq i16 %343, 0
...
if.then877.2:                                     ; preds = %if.end872.2
  ...
  %SkipIntraInInterSlices839.3.phi.trans.insert = getelementptr inbounds %struct.InputParameters, ptr %.pre1429, i64 0, i32 67
  %.pre1430 = load i32, ptr %SkipIntraInInterSlices839.3.phi.trans.insert, align 8, !tbaa !56
  %.pre1431 = load i16, ptr @best_mode, align 2
  br label %for.inc879.2

for.inc879.2:                                     ; preds = %if.then877.2, %if.end872.2, %if.end855.2, %land.lhs.true850.2
  %344 = phi i16 [ %.pre1431, %if.then877.2 ], [ %337, %if.end872.2 ], [ %337, %if.end855.2 ], [ %337, %land.lhs.true850.2 ]
  %345 = phi i32 [ %.pre1430, %if.then877.2 ], [ %338, %if.end872.2 ], [ %338, %if.end855.2 ], [ %338, %land.lhs.true850.2 ]
  %tobool840.3 = icmp eq i32 %345, 0
...
land.lhs.true850.3:                               ; preds = %for.inc879.2
  %346 = load i32, ptr %cbp, align 4, !tbaa !35
  %cmp852.3 = icmp eq i32 %346, 0
  br i1 %cmp852.3, label %for.inc882, label %if.end872.3

if.end855.3:                                      ; preds = %for.inc879.2
  %347 = load ptr, ptr @img, align 8, !tbaa !9
  %yuv_format856.3 = getelementptr inbounds %struct.ImageParameters, ptr %347, i64 0, i32 160
  %348 = load i32, ptr %yuv_format856.3, align 8, !tbaa !52
  %cmp857.not.3 = icmp eq i32 %348, 0
  %349 = or i1 %cmp857.not.3, %cmp
  %or.cond1366.3 = select i1 %349, i1 true, i1 %cmp868.3
  br i1 %or.cond1366.3, label %if.end872.3, label %for.inc882

if.end872.3:                                      ; preds = %land.lhs.true850.3, %if.end855.3
  %350 = load i16, ptr %arrayidx875.3, align 2, !tbaa !22
  %tobool876.not.3 = icmp eq i16 %350, 0
  br i1 %tobool876.not.3, label %for.inc882, label %if.then877.3
...
for.inc882:                                       ; preds = %if.end855.us.3, %land.lhs.true850.3, %if.end855.3, %if.end872.3, %if.then877.3, %land.lhs.true850.us.3, %if.end872.us.3, %if.then877.us.3, %land.lhs.true801, %land.lhs.true825, %lor.lhs.false809, %lor.lhs.false815
  %351 = load i32, ptr %c_ipred_mode, align 8, !tbaa !26
  %inc884 = add nsw i32 %351, 1
  store i32 %inc884, ptr %c_ipred_mode, align 8, !tbaa !26
  %cmp790.not.not = icmp slt i32 %351, %conv789
...
if.then891:                                       ; preds = %if.end441, %if.end887
  %352 = load i32, ptr %mb_type, align 8, !tbaa !68
  %353 = add i32 %352, -9
  %switch.and.le = and i32 %353, -6
  %switch.selectcmp.le = icmp eq i32 %switch.and.le, 0
  %lor.ext907.le = zext i1 %switch.selectcmp.le to i32
  %354 = load i32, ptr @cbp, align 4, !tbaa !5
  %cmp912 = icmp ne i32 %354, 0
  %355 = load i16, ptr @best_mode, align 2
  %cmp916 = icmp eq i16 %355, 10
  %or.cond1073 = select i1 %cmp912, i1 true, i1 %cmp916
  %cmp920 = icmp ne i16 %355, 14
...
if.else923:                                       ; preds = %if.then891
  %cmp924 = icmp eq i32 %354, 0
  br i1 %cmp924, label %land.lhs.true926, label %lor.lhs.false929

land.lhs.true926:                                 ; preds = %if.else923
  %356 = load ptr, ptr @input, align 8, !tbaa !9
  %RCEnable927 = getelementptr inbounds %struct.InputParameters, ptr %356, i64 0, i32 157
  %357 = load i32, ptr %RCEnable927, align 4, !tbaa !48
  %tobool928 = icmp eq i32 %357, 0
  %cmp931 = icmp eq i16 %355, 14
...
if.then933:                                       ; preds = %lor.lhs.false929, %land.lhs.true926
  ...
  %358 = load i32, ptr %prev_qp, align 8, !tbaa !70
  %qp = getelementptr inbounds %struct.macroblock, ptr %6, i64 %idxprom, i32 2
  store i32 %358, ptr %qp, align 8, !tbaa !71
  call void @set_chroma_qp(ptr noundef nonnull %arrayidx) #6
  %359 = load i32, ptr %qp, align 8, !tbaa !71
  %360 = load ptr, ptr @img, align 8, !tbaa !9
  %qp935 = getelementptr inbounds %struct.ImageParameters, ptr %360, i64 0, i32 9
  store i32 %359, ptr %qp935, align 4, !tbaa !72
...
if.end938:                                        ; preds = %if.end938.sink.split, %lor.lhs.false929, %land.lhs.true926
  ...
  %361 = load ptr, ptr @input, align 8, !tbaa !9
  %RCEnable939 = getelementptr inbounds %struct.InputParameters, ptr %361, i64 0, i32 157
  %362 = load i32, ptr %RCEnable939, align 4, !tbaa !48
  %tobool940.not = icmp eq i32 %362, 0
  br i1 %tobool940.not, label %if.end942, label %if.then941

if.then941:                                       ; preds = %if.end938
  %363 = load i16, ptr @best_mode, align 2, !tbaa !22
  call void @update_rc(ptr noundef nonnull %arrayidx, i16 noundef signext %363) #6
  br label %if.end942

if.end942:                                        ; preds = %if.then941, %if.end938
  %364 = load double, ptr %min_rdcost, align 8, !tbaa !23
  %365 = load ptr, ptr @rdopt, align 8, !tbaa !9
  store double %364, ptr %365, align 8, !tbaa !74
  %366 = load ptr, ptr @img, align 8, !tbaa !9
  %MbaffFrameFlag = getelementptr inbounds %struct.ImageParameters, ptr %366, i64 0, i32 100
  %367 = load i32, ptr %MbaffFrameFlag, align 4, !tbaa !76
  %tobool944.not = icmp eq i32 %367, 0
  br i1 %tobool944.not, label %if.end977, label %land.lhs.true945

land.lhs.true945:                                 ; preds = %if.end942
  %current_mb_nr946 = getelementptr inbounds %struct.ImageParameters, ptr %366, i64 0, i32 3
  %368 = load i32, ptr %current_mb_nr946, align 4, !tbaa !20
  %369 = and i32 %368, 1
  %tobool947.not = icmp eq i32 %369, 0
  br i1 %tobool947.not, label %if.end977, label %land.lhs.true948

land.lhs.true948:                                 ; preds = %land.lhs.true945
  %370 = load i32, ptr %mb_type, align 8, !tbaa !68
  %tobool950.not = icmp eq i32 %370, 0
...
cond.true955:                                     ; preds = %cond.false952
  %371 = load i32, ptr %cbp, align 4, !tbaa !35
  %tobool957.not = icmp eq i32 %371, 0
...
land.lhs.true959:                                 ; preds = %cond.true955
  ...
  %372 = load i32, ptr %mb_type960, align 8, !tbaa !68
  %tobool961.not = icmp eq i32 %372, 0
  br i1 %tobool961.not, label %cond.true966, label %if.end977

land.lhs.true959.thread:                          ; preds = %cond.false952
  %mb_type9601334 = getelementptr inbounds %struct.macroblock, ptr %cond, i64 0, i32 8
  %373 = load i32, ptr %mb_type9601334, align 8, !tbaa !68
  %tobool961.not1335 = icmp eq i32 %373, 0
  br i1 %tobool961.not1335, label %land.lhs.true970, label %if.end977

cond.true966:                                     ; preds = %land.lhs.true959
  %cbp967 = getelementptr inbounds %struct.macroblock, ptr %cond, i64 0, i32 12
  %374 = load i32, ptr %cbp967, align 4, !tbaa !35
  %tobool968.not = icmp eq i32 %374, 0
...
land.lhs.true970:                                 ; preds = %land.lhs.true959.thread, %cond.true966
  ...
  %375 = load i16, ptr %curr_mb_field, align 2, !tbaa !77
  %conv972 = sext i16 %375 to i32
  %cmp973 = icmp eq i32 %call971, %conv972
  br i1 %cmp973, label %if.end977, label %if.then975

if.then975:                                       ; preds = %land.lhs.true970
  %376 = load ptr, ptr @rdopt, align 8, !tbaa !9
  store double 1.000000e+30, ptr %376, align 8, !tbaa !74
  br label %if.end977
...
if.end977:                                        ; preds = %land.lhs.true959.thread, %land.lhs.true959, %land.lhs.true948, %if.then975, %land.lhs.true970, %cond.true966, %cond.true955, %land.lhs.true945, %if.end942
  ...
  %RestrictRef = getelementptr inbounds %struct.InputParameters, ptr %377, i64 0, i32 128
  %378 = load i32, ptr %RestrictRef, align 4, !tbaa !79
  %tobool978.not = icmp eq i32 %378, 0
...
if.end981:                                        ; preds = %if.then979, %if.end977
  %379 = phi ptr [ %.pre1441, %if.then979 ], [ %377, %if.end977 ]
  %SearchMode982 = getelementptr inbounds %struct.InputParameters, ptr %379, i64 0, i32 169
  %380 = load i32, ptr %SearchMode982, align 4, !tbaa !24
  switch i32 %380, label %if.end1002 [
    i32 1, label %if.then985
    i32 2, label %if.then995
  ]

if.then985:                                       ; preds = %if.end981
  %381 = load i16, ptr @best_mode, align 2, !tbaa !22
  %conv986 = sext i16 %381 to i32
  %382 = load i16, ptr %list_offset, align 2, !tbaa !22
  %idxprom989 = sext i16 %382 to i64
  %arrayidx990 = getelementptr inbounds [6 x i32], ptr @listXsize, i64 0, i64 %idxprom989
  %383 = load i32, ptr %arrayidx990, align 4, !tbaa !5
  call void @UMHEX_skip_intrabk_SAD(i32 noundef %conv986, i32 noundef %383) #6
  br label %if.end1002

if.then995:                                       ; preds = %if.end981
  %384 = load i16, ptr @best_mode, align 2, !tbaa !22
  %conv996 = sext i16 %384 to i32
  %385 = load i16, ptr %list_offset, align 2, !tbaa !22
  %idxprom999 = sext i16 %385 to i64
  %arrayidx1000 = getelementptr inbounds [6 x i32], ptr @listXsize, i64 0, i64 %idxprom999
  %386 = load i32, ptr %arrayidx1000, align 4, !tbaa !5
  call void @smpUMHEX_skip_intrabk_SAD(i32 noundef %conv996, i32 noundef %386) #6
  br label %if.end1002

if.end1002:                                       ; preds = %if.end981, %if.then995, %if.then985
  %387 = load ptr, ptr @input, align 8, !tbaa !9
  %UseConstrainedIntraPred = getelementptr inbounds %struct.InputParameters, ptr %387, i64 0, i32 23
  %388 = load i32, ptr %UseConstrainedIntraPred, align 8, !tbaa !80
  %tobool1003.not = icmp eq i32 %388, 0
...
land.lhs.true1004:                                ; preds = %if.end1002
  ...
  %type1005 = getelementptr inbounds %struct.ImageParameters, ptr %389, i64 0, i32 5
  %390 = load i32, ptr %type1005, align 4, !tbaa !11
  %switch1330 = icmp ult i32 %390, 2
  br i1 %switch1330, label %if.then1012, label %if.end1033

if.then1012:                                      ; preds = %land.lhs.true1004
  %391 = load i32, ptr %mb_type, align 8, !tbaa !68
  switch i32 %391, label %lor.rhs1024 [
...
lor.rhs1024:                                      ; preds = %if.then1012
  %cmp1026 = icmp eq i32 %391, 14
  %392 = zext i1 %cmp1026 to i32
  br label %lor.end1028

lor.end1028:                                      ; preds = %if.then1012, %if.then1012, %if.then1012, %lor.rhs1024
  %lor.ext1029 = phi i32 [ 1, %if.then1012 ], [ %392, %lor.rhs1024 ], [ 1, %if.then1012 ], [ 1, %if.then1012 ]
  %intra_block = getelementptr inbounds %struct.ImageParameters, ptr %389, i64 0, i32 63
  %393 = load ptr, ptr %intra_block, align 8, !tbaa !81
  %current_mb_nr1030 = getelementptr inbounds %struct.ImageParameters, ptr %389, i64 0, i32 3
  %394 = load i32, ptr %current_mb_nr1030, align 4, !tbaa !20
  %idxprom1031 = sext i32 %394 to i64
  %arrayidx1032 = getelementptr inbounds i32, ptr %393, i64 %idxprom1031
