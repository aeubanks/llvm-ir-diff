...
define internal noundef nonnull ptr @_ZL9CreateArcv() #1 personality ptr @__gxx_personality_v0 {
  %1 = tail call noalias noundef nonnull dereferenceable(256) ptr @_Znwm(i64 noundef 256) #5
  invoke void @_ZN8NArchive4NZip8CHandlerC1Ev(ptr noundef nonnull align 8 dereferenceable(256) %1)
