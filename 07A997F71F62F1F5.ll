...
"for op_blendvpd_277.s0.x.x":                     ; preds = %"for op_blendvpd_277.s0.x.x", %"for op_blendvpd_277.s0.x.x.preheader"
  ...
  %6 = shufflevector <3 x double> %t211, <3 x double> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 poison>
  ...
  %11 = shufflevector <3 x double> %10, <3 x double> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 poison>
  ...
  %20 = shufflevector <3 x double> %t211.1, <3 x double> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 poison>
  ...
  %25 = shufflevector <3 x double> %24, <3 x double> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 poison>
