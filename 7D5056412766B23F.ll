...
define dso_local i32 @g723_24_encoder(i32 noundef %0, i32 noundef %1, ptr noundef %2) local_unnamed_addr #0 {
...
8:                                                ; preds = %3, %6, %4
  ...
  %24 = tail call i32 (i32, i32, ptr, i32, ...) @quantize(i32 noundef %21, i32 noundef %23, ptr noundef nonnull @qtab_723_24, i32 noundef 3) #2
  ...
  %31 = getelementptr inbounds [8 x i16], ptr @_dqlntab, i64 0, i64 %30
  ...
  %45 = getelementptr inbounds [8 x i16], ptr @_witab, i64 0, i64 %30
  %46 = load i16, ptr %45, align 2, !tbaa !5
  %47 = sext i16 %46 to i32
  %48 = getelementptr inbounds [8 x i16], ptr @_fitab, i64 0, i64 %30
  %49 = load i16, ptr %48, align 2, !tbaa !5
  %50 = sext i16 %49 to i32
  %51 = shl i32 %44, 16
  %52 = ashr exact i32 %51, 16
  tail call void (i32, i32, i32, i32, i32, i32, i32, ptr, ...) @update(i32 noundef 3, i32 noundef %23, i32 noundef %47, i32 noundef %50, i32 noundef %36, i32 noundef %43, i32 noundef %52, ptr noundef %2) #2
  br label %53
...
; Function Attrs: nounwind uwtable
define dso_local i32 @g723_24_decoder(i32 noundef %0, i32 noundef %1, ptr noundef %2) local_unnamed_addr #0 {
  %4 = and i32 %0, 7
  ...
  %15 = getelementptr inbounds [8 x i16], ptr @_dqlntab, i64 0, i64 %14
  ...
  %30 = add nsw i32 %7, %26
  %31 = getelementptr inbounds [8 x i16], ptr @_witab, i64 0, i64 %14
  %32 = load i16, ptr %31, align 2, !tbaa !5
  %33 = sext i16 %32 to i32
  %34 = getelementptr inbounds [8 x i16], ptr @_fitab, i64 0, i64 %14
  %35 = load i16, ptr %34, align 2, !tbaa !5
  %36 = sext i16 %35 to i32
  %37 = shl i32 %30, 16
  %38 = ashr exact i32 %37, 16
  tail call void (i32, i32, i32, i32, i32, i32, i32, ptr, ...) @update(i32 noundef 3, i32 noundef %19, i32 noundef %33, i32 noundef %36, i32 noundef %22, i32 noundef %29, i32 noundef %38, ptr noundef %2) #2
...
39:                                               ; preds = %3
  %40 = tail call i32 (i32, i32, i32, i32, i32, ptr, ...) @tandem_adjust_alaw(i32 noundef %29, i32 noundef %11, i32 noundef %19, i32 noundef %4, i32 noundef 4, ptr noundef nonnull @qtab_723_24) #2
  br label %45

41:                                               ; preds = %3
  %42 = tail call i32 (i32, i32, i32, i32, i32, ptr, ...) @tandem_adjust_ulaw(i32 noundef %29, i32 noundef %11, i32 noundef %19, i32 noundef %4, i32 noundef 4, ptr noundef nonnull @qtab_723_24) #2
  br label %45
