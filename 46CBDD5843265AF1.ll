...
for.cond38.preheader:                             ; preds = %invoke.cont11
  ...
  %scevgep428 = getelementptr i8, ptr %this, i64 32780
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(257) %scevgep428, i8 0, i64 257, i1 false), !tbaa !23
  %scevgep430 = getelementptr i8, ptr %this, i64 33037
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(24576) %scevgep, i8 0, i64 24576, i1 false)
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(7935) %scevgep430, i8 1, i64 7935, i1 false), !tbaa !23
  ...
  %scevgep440 = getelementptr i8, ptr %this, i64 41229
...
for.cond38:                                       ; preds = %for.cond38.backedge, %for.cond38.preheader
  %prevPos.0 = phi i64 [ 0, %for.cond38.preheader ], [ %prevPos.3467, %for.cond38.backedge ]
  %numBits.0 = phi i32 [ 9, %for.cond38.preheader ], [ %numBits.3468, %for.cond38.backedge ]
  %head.0 = phi i32 [ 257, %for.cond38.preheader ], [ %head.6469, %for.cond38.backedge ]
  %needPrev.0 = phi i8 [ 0, %for.cond38.preheader ], [ %needPrev.4470, %for.cond38.backedge ]
  %lastSymbol.0 = phi i32 [ 0, %for.cond38.preheader ], [ %lastSymbol.1471, %for.cond38.backedge ]
...
if.end70:                                         ; preds = %if.then66, %if.then64
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(7935) %scevgep440, i8 0, i64 7935, i1 false), !tbaa !23
  br label %for.body81

for.body81:                                       ; preds = %for.inc94.2, %if.end70
  %indvars.iv445 = phi i64 [ 257, %if.end70 ], [ %indvars.iv.next446.2, %for.inc94.2 ]
  %arrayidx84 = getelementptr inbounds %"class.NCompress::NShrink::CDecoder", ptr %this, i64 0, i32 5, i64 %indvars.iv445
...
if.then86:                                        ; preds = %for.body81
  %arrayidx90 = getelementptr inbounds %"class.NCompress::NShrink::CDecoder", ptr %this, i64 0, i32 2, i64 %indvars.iv445
...
for.inc94:                                        ; preds = %for.body81, %if.then86
  ...
  %arrayidx84.1 = getelementptr inbounds %"class.NCompress::NShrink::CDecoder", ptr %this, i64 0, i32 5, i64 %indvars.iv.next446
...
if.then86.1:                                      ; preds = %for.inc94
  %arrayidx90.1 = getelementptr inbounds %"class.NCompress::NShrink::CDecoder", ptr %this, i64 0, i32 2, i64 %indvars.iv.next446
...
for.inc94.1:                                      ; preds = %if.then86.1, %for.inc94
  ...
  %arrayidx84.2 = getelementptr inbounds %"class.NCompress::NShrink::CDecoder", ptr %this, i64 0, i32 5, i64 %indvars.iv.next446.1
...
if.then86.2:                                      ; preds = %for.inc94.1
  %arrayidx90.2 = getelementptr inbounds %"class.NCompress::NShrink::CDecoder", ptr %this, i64 0, i32 2, i64 %indvars.iv.next446.1
...
for.inc94.2:                                      ; preds = %if.then86.2, %for.inc94.1
  %indvars.iv.next446.2 = add nuw nsw i64 %indvars.iv445, 3
  %exitcond449.not.2 = icmp eq i64 %indvars.iv.next446.2, 8192
  br i1 %exitcond449.not.2, label %vector.body, label %for.body81, !llvm.loop !34

vector.body:                                      ; preds = %for.inc94.2, %pred.store.continue543
  %index = phi i64 [ %index.next, %pred.store.continue543 ], [ 0, %for.inc94.2 ]
  ...
  %wide.load481 = load <16 x i8>, ptr %61, align 1, !tbaa !23
  %62 = icmp eq <16 x i8> %wide.load, zeroinitializer
  %63 = icmp eq <16 x i8> %wide.load481, zeroinitializer
...
pred.store.continue:                              ; preds = %pred.store.if, %vector.body
  ...
  br i1 %66, label %pred.store.if482, label %pred.store.continue483

pred.store.if482:                                 ; preds = %pred.store.continue
...
pred.store.continue483:                           ; preds = %pred.store.if482, %pred.store.continue
  %69 = extractelement <16 x i1> %62, i64 2
  br i1 %69, label %pred.store.if484, label %pred.store.continue485
...
pred.store.continue485:                           ; preds = %pred.store.if484, %pred.store.continue483
  ...
  br i1 %72, label %pred.store.if486, label %pred.store.continue487
...
pred.store.continue487:                           ; preds = %pred.store.if486, %pred.store.continue485
  ...
  br i1 %75, label %pred.store.if488, label %pred.store.continue489
...
pred.store.continue489:                           ; preds = %pred.store.if488, %pred.store.continue487
  ...
  br i1 %78, label %pred.store.if490, label %pred.store.continue491
...
pred.store.continue491:                           ; preds = %pred.store.if490, %pred.store.continue489
  ...
  br i1 %81, label %pred.store.if492, label %pred.store.continue493
...
pred.store.continue493:                           ; preds = %pred.store.if492, %pred.store.continue491
  ...
  br i1 %84, label %pred.store.if494, label %pred.store.continue495
...
pred.store.continue495:                           ; preds = %pred.store.if494, %pred.store.continue493
  ...
  br i1 %87, label %pred.store.if496, label %pred.store.continue497
...
pred.store.continue497:                           ; preds = %pred.store.if496, %pred.store.continue495
  ...
  br i1 %90, label %pred.store.if498, label %pred.store.continue499
...
pred.store.continue499:                           ; preds = %pred.store.if498, %pred.store.continue497
  ...
  br i1 %93, label %pred.store.if500, label %pred.store.continue501
...
pred.store.continue501:                           ; preds = %pred.store.if500, %pred.store.continue499
  ...
  br i1 %96, label %pred.store.if502, label %pred.store.continue503
...
pred.store.continue503:                           ; preds = %pred.store.if502, %pred.store.continue501
  ...
  br i1 %99, label %pred.store.if504, label %pred.store.continue505
...
pred.store.continue505:                           ; preds = %pred.store.if504, %pred.store.continue503
  ...
  br i1 %102, label %pred.store.if506, label %pred.store.continue507
...
pred.store.continue507:                           ; preds = %pred.store.if506, %pred.store.continue505
  ...
  br i1 %105, label %pred.store.if508, label %pred.store.continue509
...
pred.store.continue509:                           ; preds = %pred.store.if508, %pred.store.continue507
  ...
  br i1 %108, label %pred.store.if510, label %pred.store.continue511
...
pred.store.continue511:                           ; preds = %pred.store.if510, %pred.store.continue509
  ...
  br i1 %111, label %pred.store.if512, label %pred.store.continue513
...
pred.store.continue513:                           ; preds = %pred.store.if512, %pred.store.continue511
  ...
  br i1 %113, label %pred.store.if514, label %pred.store.continue515
...
pred.store.continue515:                           ; preds = %pred.store.if514, %pred.store.continue513
  ...
  br i1 %116, label %pred.store.if516, label %pred.store.continue517
...
pred.store.continue517:                           ; preds = %pred.store.if516, %pred.store.continue515
  ...
  br i1 %119, label %pred.store.if518, label %pred.store.continue519
...
pred.store.continue519:                           ; preds = %pred.store.if518, %pred.store.continue517
  ...
  br i1 %122, label %pred.store.if520, label %pred.store.continue521
...
pred.store.continue521:                           ; preds = %pred.store.if520, %pred.store.continue519
  ...
  br i1 %125, label %pred.store.if522, label %pred.store.continue523
...
pred.store.continue523:                           ; preds = %pred.store.if522, %pred.store.continue521
  ...
  br i1 %128, label %pred.store.if524, label %pred.store.continue525
...
pred.store.continue525:                           ; preds = %pred.store.if524, %pred.store.continue523
  ...
  br i1 %131, label %pred.store.if526, label %pred.store.continue527
...
pred.store.continue527:                           ; preds = %pred.store.if526, %pred.store.continue525
  ...
  br i1 %134, label %pred.store.if528, label %pred.store.continue529
...
pred.store.continue529:                           ; preds = %pred.store.if528, %pred.store.continue527
  ...
  br i1 %137, label %pred.store.if530, label %pred.store.continue531
...
pred.store.continue531:                           ; preds = %pred.store.if530, %pred.store.continue529
  ...
  br i1 %140, label %pred.store.if532, label %pred.store.continue533
...
pred.store.continue533:                           ; preds = %pred.store.if532, %pred.store.continue531
  ...
  br i1 %143, label %pred.store.if534, label %pred.store.continue535
...
pred.store.continue535:                           ; preds = %pred.store.if534, %pred.store.continue533
  ...
  br i1 %146, label %pred.store.if536, label %pred.store.continue537
...
pred.store.continue537:                           ; preds = %pred.store.if536, %pred.store.continue535
  ...
  br i1 %149, label %pred.store.if538, label %pred.store.continue539
...
pred.store.continue539:                           ; preds = %pred.store.if538, %pred.store.continue537
  ...
  br i1 %152, label %pred.store.if540, label %pred.store.continue541
...
pred.store.continue541:                           ; preds = %pred.store.if540, %pred.store.continue539
  ...
  br i1 %155, label %pred.store.if542, label %pred.store.continue543
...
vec.epilog.vector.body:                           ; preds = %pred.store.continue543
  %wide.load547 = load <8 x i8>, ptr %3, align 1, !tbaa !23
  %159 = icmp eq <8 x i8> %wide.load547, zeroinitializer
  %160 = extractelement <8 x i1> %159, i64 0
  br i1 %160, label %pred.store.if548, label %pred.store.continue549

pred.store.if548:                                 ; preds = %vec.epilog.vector.body
  store i8 1, ptr %4, align 1, !tbaa !23
  br label %pred.store.continue549

pred.store.continue549:                           ; preds = %pred.store.if548, %vec.epilog.vector.body
  %161 = extractelement <8 x i1> %159, i64 1
  br i1 %161, label %pred.store.if550, label %pred.store.continue551
...
pred.store.continue551:                           ; preds = %pred.store.if550, %pred.store.continue549
  ...
  br i1 %162, label %pred.store.if552, label %pred.store.continue553
...
pred.store.continue553:                           ; preds = %pred.store.if552, %pred.store.continue551
  ...
  br i1 %163, label %pred.store.if554, label %pred.store.continue555
...
pred.store.continue555:                           ; preds = %pred.store.if554, %pred.store.continue553
  ...
  br i1 %164, label %pred.store.if556, label %pred.store.continue557
...
pred.store.continue557:                           ; preds = %pred.store.if556, %pred.store.continue555
  ...
  br i1 %165, label %pred.store.if558, label %pred.store.continue559
...
pred.store.continue559:                           ; preds = %pred.store.if558, %pred.store.continue557
  ...
  br i1 %166, label %pred.store.if560, label %pred.store.continue561
...
pred.store.continue561:                           ; preds = %pred.store.if560, %pred.store.continue559
  ...
  br i1 %167, label %pred.store.if562, label %pred.store.continue563
...
pred.store.continue563:                           ; preds = %pred.store.if562, %pred.store.continue561
  %wide.load547.1 = load <8 x i8>, ptr %12, align 1, !tbaa !23
  %168 = icmp eq <8 x i8> %wide.load547.1, zeroinitializer
  %169 = extractelement <8 x i1> %168, i64 0
  br i1 %169, label %pred.store.if548.1, label %pred.store.continue549.1

pred.store.if548.1:                               ; preds = %pred.store.continue563
  store i8 1, ptr %13, align 1, !tbaa !23
  br label %pred.store.continue549.1

pred.store.continue549.1:                         ; preds = %pred.store.if548.1, %pred.store.continue563
  %170 = extractelement <8 x i1> %168, i64 1
  br i1 %170, label %pred.store.if550.1, label %pred.store.continue551.1

pred.store.if550.1:                               ; preds = %pred.store.continue549.1
  store i8 1, ptr %14, align 2, !tbaa !23
  br label %pred.store.continue551.1

pred.store.continue551.1:                         ; preds = %pred.store.if550.1, %pred.store.continue549.1
  %171 = extractelement <8 x i1> %168, i64 2
  br i1 %171, label %pred.store.if552.1, label %pred.store.continue553.1

pred.store.if552.1:                               ; preds = %pred.store.continue551.1
  store i8 1, ptr %15, align 1, !tbaa !23
  br label %pred.store.continue553.1

pred.store.continue553.1:                         ; preds = %pred.store.if552.1, %pred.store.continue551.1
  %172 = extractelement <8 x i1> %168, i64 3
  br i1 %172, label %pred.store.if554.1, label %pred.store.continue555.1

pred.store.if554.1:                               ; preds = %pred.store.continue553.1
  store i8 1, ptr %16, align 8, !tbaa !23
  br label %pred.store.continue555.1

pred.store.continue555.1:                         ; preds = %pred.store.if554.1, %pred.store.continue553.1
  %173 = extractelement <8 x i1> %168, i64 4
  br i1 %173, label %pred.store.if556.1, label %pred.store.continue557.1
...
pred.store.continue557.1:                         ; preds = %pred.store.if556.1, %pred.store.continue555.1
  ...
  br i1 %174, label %pred.store.if558.1, label %pred.store.continue559.1
...
pred.store.continue559.1:                         ; preds = %pred.store.if558.1, %pred.store.continue557.1
  ...
  br i1 %175, label %pred.store.if560.1, label %pred.store.continue561.1
...
pred.store.continue561.1:                         ; preds = %pred.store.if560.1, %pred.store.continue559.1
  ...
  br i1 %176, label %pred.store.if562.1, label %pred.store.continue563.1
...
pred.store.continue563.1:                         ; preds = %pred.store.if562.1, %pred.store.continue561.1
  %wide.load547.2 = load <8 x i8>, ptr %21, align 1, !tbaa !23
  %177 = icmp eq <8 x i8> %wide.load547.2, zeroinitializer
  %178 = extractelement <8 x i1> %177, i64 0
  br i1 %178, label %pred.store.if548.2, label %pred.store.continue549.2

pred.store.if548.2:                               ; preds = %pred.store.continue563.1
  store i8 1, ptr %22, align 1, !tbaa !23
  br label %pred.store.continue549.2

pred.store.continue549.2:                         ; preds = %pred.store.if548.2, %pred.store.continue563.1
  %179 = extractelement <8 x i1> %177, i64 1
  br i1 %179, label %pred.store.if550.2, label %pred.store.continue551.2

pred.store.if550.2:                               ; preds = %pred.store.continue549.2
  store i8 1, ptr %23, align 2, !tbaa !23
  br label %pred.store.continue551.2

pred.store.continue551.2:                         ; preds = %pred.store.if550.2, %pred.store.continue549.2
  %180 = extractelement <8 x i1> %177, i64 2
  br i1 %180, label %pred.store.if552.2, label %pred.store.continue553.2

pred.store.if552.2:                               ; preds = %pred.store.continue551.2
  store i8 1, ptr %24, align 1, !tbaa !23
  br label %pred.store.continue553.2

pred.store.continue553.2:                         ; preds = %pred.store.if552.2, %pred.store.continue551.2
  %181 = extractelement <8 x i1> %177, i64 3
  br i1 %181, label %pred.store.if554.2, label %pred.store.continue555.2

pred.store.if554.2:                               ; preds = %pred.store.continue553.2
  store i8 1, ptr %25, align 8, !tbaa !23
  br label %pred.store.continue555.2

pred.store.continue555.2:                         ; preds = %pred.store.if554.2, %pred.store.continue553.2
  %182 = extractelement <8 x i1> %177, i64 4
  br i1 %182, label %pred.store.if556.2, label %pred.store.continue557.2
...
pred.store.continue557.2:                         ; preds = %pred.store.if556.2, %pred.store.continue555.2
  ...
  br i1 %183, label %pred.store.if558.2, label %pred.store.continue559.2
...
pred.store.continue559.2:                         ; preds = %pred.store.if558.2, %pred.store.continue557.2
  ...
  br i1 %184, label %pred.store.if560.2, label %pred.store.continue561.2
...
pred.store.continue561.2:                         ; preds = %pred.store.if560.2, %pred.store.continue559.2
  ...
  br i1 %185, label %pred.store.if562.2, label %for.body99

pred.store.if562.2:                               ; preds = %pred.store.continue561.2
  store i8 1, ptr %29, align 4, !tbaa !23
  br label %for.body99

for.body99:                                       ; preds = %pred.store.continue561.2, %pred.store.if562.2
...
land.rhs:                                         ; preds = %while.body.4, %for.inc109.6
  %indvars.iv455 = phi i64 [ 257, %for.inc109.6 ], [ %indvars.iv.next456.4, %while.body.4 ]
  %arrayidx115 = getelementptr inbounds %"class.NCompress::NShrink::CDecoder", ptr %this, i64 0, i32 5, i64 %indvars.iv455
...
while.body:                                       ; preds = %land.rhs
  ...
  %arrayidx115.1 = getelementptr inbounds %"class.NCompress::NShrink::CDecoder", ptr %this, i64 0, i32 5, i64 %indvars.iv.next456
...
while.body.1:                                     ; preds = %while.body
  ...
  %arrayidx115.2 = getelementptr inbounds %"class.NCompress::NShrink::CDecoder", ptr %this, i64 0, i32 5, i64 %indvars.iv.next456.1
...
while.body.2:                                     ; preds = %while.body.1
  %indvars.iv.next456.2 = add nuw nsw i64 %indvars.iv455, 3
  %arrayidx115.3 = getelementptr inbounds %"class.NCompress::NShrink::CDecoder", ptr %this, i64 0, i32 5, i64 %indvars.iv.next456.2
...
while.body.3:                                     ; preds = %while.body.2
  ...
  %arrayidx115.4 = getelementptr inbounds %"class.NCompress::NShrink::CDecoder", ptr %this, i64 0, i32 5, i64 %indvars.iv.next456.3
...
while.body.4:                                     ; preds = %while.body.3
  %indvars.iv.next456.4 = add nuw nsw i64 %indvars.iv455, 5
  %exitcond459.not.4 = icmp eq i64 %indvars.iv.next456.4, 8192
  br i1 %exitcond459.not.4, label %for.cond38.backedge, label %land.rhs, !llvm.loop !38

if.then119:                                       ; preds = %while.body.3, %while.body.2, %while.body.1, %while.body, %land.rhs
  %indvars.iv455.lcssa = phi i64 [ %indvars.iv455, %land.rhs ], [ %indvars.iv.next456, %while.body ], [ %indvars.iv.next456.1, %while.body.1 ], [ %indvars.iv.next456.2, %while.body.2 ], [ %indvars.iv.next456.3, %while.body.3 ]
  %198 = trunc i64 %indvars.iv455.lcssa to i32
  %idxprom121 = and i64 %indvars.iv455.lcssa, 4294967295
  %arrayidx122 = getelementptr inbounds %"class.NCompress::NShrink::CDecoder", ptr %this, i64 0, i32 5, i64 %idxprom121
  store i8 0, ptr %arrayidx122, align 1, !tbaa !23
  %conv = trunc i32 %lastSymbol.0 to i16
  %arrayidx125 = getelementptr inbounds %"class.NCompress::NShrink::CDecoder", ptr %this, i64 0, i32 2, i64 %idxprom121
...
while.cond179.preheader:                          ; preds = %_ZN10COutBuffer9WriteByteEh.exit
  %cmp180416 = icmp ult i32 %head.0, 8192
  br i1 %cmp180416, label %land.rhs181.preheader, label %if.end202
...
while.body172:                                    ; preds = %while.body172.preheader, %_ZN10COutBuffer9WriteByteEh.exit
  %indvars.iv433 = phi i64 [ %204, %while.body172.preheader ], [ %indvars.iv.next434, %_ZN10COutBuffer9WriteByteEh.exit ]
  %indvars.iv.next434 = add nsw i64 %indvars.iv433, -1
  %idxprom174 = and i64 %indvars.iv.next434, 4294967295
...
_ZN10COutBuffer9WriteByteEh.exit:                 ; preds = %if.then.i, %while.body172
  %211 = trunc i64 %indvars.iv433 to i32
...
land.rhs181:                                      ; preds = %land.rhs181.preheader, %while.body188
  %indvars.iv436 = phi i64 [ %205, %land.rhs181.preheader ], [ %indvars.iv.next437, %while.body188 ]
  %arrayidx184 = getelementptr inbounds %"class.NCompress::NShrink::CDecoder", ptr %this, i64 0, i32 5, i64 %indvars.iv436
...
while.body188:                                    ; preds = %land.rhs181
  ...
  %exitcond.not = icmp eq i64 %indvars.iv.next437, 8192
  br i1 %exitcond.not, label %if.end202, label %land.rhs181, !llvm.loop !41

if.then192:                                       ; preds = %land.rhs181
  %214 = trunc i64 %indvars.iv436 to i32
  %idxprom194 = and i64 %indvars.iv436, 4294967295
  %arrayidx195 = getelementptr inbounds %"class.NCompress::NShrink::CDecoder", ptr %this, i64 0, i32 5, i64 %idxprom194
  store i8 0, ptr %arrayidx195, align 1, !tbaa !23
  %conv196 = trunc i32 %and.i to i16
  %arrayidx199 = getelementptr inbounds %"class.NCompress::NShrink::CDecoder", ptr %this, i64 0, i32 2, i64 %idxprom194
...
invoke.cont214:                                   ; preds = %if.then209
  ...
  br i1 %cmp216.not, label %cleanup230, label %cleanup230.thread473

cleanup230.thread473:                             ; preds = %invoke.cont214
...
for.cond38.backedge:                              ; preds = %while.body.4, %if.then58, %if.then119, %cleanup230
  %lastSymbol.1471 = phi i32 [ %and.i, %cleanup230 ], [ %lastSymbol.0, %if.then119 ], [ %lastSymbol.0, %if.then58 ], [ %lastSymbol.0, %while.body.4 ]
  %needPrev.4470 = phi i8 [ %needPrev.3, %cleanup230 ], [ 1, %if.then119 ], [ %needPrev.0, %if.then58 ], [ %needPrev.0, %while.body.4 ]
  %head.6469 = phi i32 [ %head.5, %cleanup230 ], [ %inc126, %if.then119 ], [ %head.0, %if.then58 ], [ 8192, %while.body.4 ]
  %numBits.3468 = phi i32 [ %numBits.0, %cleanup230 ], [ %numBits.0, %if.then119 ], [ %spec.select, %if.then58 ], [ %numBits.0, %while.body.4 ]
  %prevPos.3467 = phi i64 [ %prevPos.1, %cleanup230 ], [ %prevPos.0, %if.then119 ], [ %prevPos.0, %if.then58 ], [ %prevPos.0, %while.body.4 ]
...
cleanup250:                                       ; preds = %_ZN5NBitl12CBaseDecoderI9CInBufferE8ReadBitsEj.exit366, %if.end45, %cleanup230.thread473, %for.end234, %invoke.cont7, %invoke.cont4
  %retval.7 = phi i32 [ -2147024882, %invoke.cont4 ], [ -2147024882, %invoke.cont7 ], [ %call237, %for.end234 ], [ %call215, %cleanup230.thread473 ], [ 1, %if.end45 ], [ 1, %_ZN5NBitl12CBaseDecoderI9CInBufferE8ReadBitsEj.exit366 ]
