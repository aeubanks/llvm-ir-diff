...
vector.body:                                      ; preds = %for.inc94.2, %pred.store.continue547
  %index = phi i64 [ %index.next, %pred.store.continue547 ], [ 0, %for.inc94.2 ]
  ...
  %wide.load485 = load <16 x i8>, ptr %61, align 1, !tbaa !23
  %62 = icmp eq <16 x i8> %wide.load, zeroinitializer
  %63 = icmp eq <16 x i8> %wide.load485, zeroinitializer
...
pred.store.continue:                              ; preds = %pred.store.if, %vector.body
  ...
  br i1 %66, label %pred.store.if486, label %pred.store.continue487

pred.store.if486:                                 ; preds = %pred.store.continue
...
pred.store.continue487:                           ; preds = %pred.store.if486, %pred.store.continue
  %69 = extractelement <16 x i1> %62, i64 2
  br i1 %69, label %pred.store.if488, label %pred.store.continue489
...
pred.store.continue489:                           ; preds = %pred.store.if488, %pred.store.continue487
  ...
  br i1 %72, label %pred.store.if490, label %pred.store.continue491
...
pred.store.continue491:                           ; preds = %pred.store.if490, %pred.store.continue489
  ...
  br i1 %75, label %pred.store.if492, label %pred.store.continue493
...
pred.store.continue493:                           ; preds = %pred.store.if492, %pred.store.continue491
  ...
  br i1 %78, label %pred.store.if494, label %pred.store.continue495
...
pred.store.continue495:                           ; preds = %pred.store.if494, %pred.store.continue493
  ...
  br i1 %81, label %pred.store.if496, label %pred.store.continue497
...
pred.store.continue497:                           ; preds = %pred.store.if496, %pred.store.continue495
  ...
  br i1 %84, label %pred.store.if498, label %pred.store.continue499
...
pred.store.continue499:                           ; preds = %pred.store.if498, %pred.store.continue497
  ...
  br i1 %87, label %pred.store.if500, label %pred.store.continue501
...
pred.store.continue501:                           ; preds = %pred.store.if500, %pred.store.continue499
  ...
  br i1 %90, label %pred.store.if502, label %pred.store.continue503
...
pred.store.continue503:                           ; preds = %pred.store.if502, %pred.store.continue501
  ...
  br i1 %93, label %pred.store.if504, label %pred.store.continue505
...
pred.store.continue505:                           ; preds = %pred.store.if504, %pred.store.continue503
  ...
  br i1 %96, label %pred.store.if506, label %pred.store.continue507
...
pred.store.continue507:                           ; preds = %pred.store.if506, %pred.store.continue505
  ...
  br i1 %99, label %pred.store.if508, label %pred.store.continue509
...
pred.store.continue509:                           ; preds = %pred.store.if508, %pred.store.continue507
  ...
  br i1 %102, label %pred.store.if510, label %pred.store.continue511
...
pred.store.continue511:                           ; preds = %pred.store.if510, %pred.store.continue509
  ...
  br i1 %105, label %pred.store.if512, label %pred.store.continue513
...
pred.store.continue513:                           ; preds = %pred.store.if512, %pred.store.continue511
  ...
  br i1 %108, label %pred.store.if514, label %pred.store.continue515
...
pred.store.continue515:                           ; preds = %pred.store.if514, %pred.store.continue513
  ...
  br i1 %111, label %pred.store.if516, label %pred.store.continue517
...
pred.store.continue517:                           ; preds = %pred.store.if516, %pred.store.continue515
  ...
  br i1 %113, label %pred.store.if518, label %pred.store.continue519
...
pred.store.continue519:                           ; preds = %pred.store.if518, %pred.store.continue517
  ...
  br i1 %116, label %pred.store.if520, label %pred.store.continue521
...
pred.store.continue521:                           ; preds = %pred.store.if520, %pred.store.continue519
  ...
  br i1 %119, label %pred.store.if522, label %pred.store.continue523
...
pred.store.continue523:                           ; preds = %pred.store.if522, %pred.store.continue521
  ...
  br i1 %122, label %pred.store.if524, label %pred.store.continue525
...
pred.store.continue525:                           ; preds = %pred.store.if524, %pred.store.continue523
  ...
  br i1 %125, label %pred.store.if526, label %pred.store.continue527
...
pred.store.continue527:                           ; preds = %pred.store.if526, %pred.store.continue525
  ...
  br i1 %128, label %pred.store.if528, label %pred.store.continue529
...
pred.store.continue529:                           ; preds = %pred.store.if528, %pred.store.continue527
  ...
  br i1 %131, label %pred.store.if530, label %pred.store.continue531
...
pred.store.continue531:                           ; preds = %pred.store.if530, %pred.store.continue529
  ...
  br i1 %134, label %pred.store.if532, label %pred.store.continue533
...
pred.store.continue533:                           ; preds = %pred.store.if532, %pred.store.continue531
  ...
  br i1 %137, label %pred.store.if534, label %pred.store.continue535
...
pred.store.continue535:                           ; preds = %pred.store.if534, %pred.store.continue533
  ...
  br i1 %140, label %pred.store.if536, label %pred.store.continue537
...
pred.store.continue537:                           ; preds = %pred.store.if536, %pred.store.continue535
  ...
  br i1 %143, label %pred.store.if538, label %pred.store.continue539
...
pred.store.continue539:                           ; preds = %pred.store.if538, %pred.store.continue537
  ...
  br i1 %146, label %pred.store.if540, label %pred.store.continue541
...
pred.store.continue541:                           ; preds = %pred.store.if540, %pred.store.continue539
  ...
  br i1 %149, label %pred.store.if542, label %pred.store.continue543
...
pred.store.continue543:                           ; preds = %pred.store.if542, %pred.store.continue541
  ...
  br i1 %152, label %pred.store.if544, label %pred.store.continue545
...
pred.store.continue545:                           ; preds = %pred.store.if544, %pred.store.continue543
  ...
  br i1 %155, label %pred.store.if546, label %pred.store.continue547
...
vec.epilog.vector.body:                           ; preds = %pred.store.continue547
  %wide.load551 = load <8 x i8>, ptr %3, align 1, !tbaa !23
  %159 = icmp eq <8 x i8> %wide.load551, zeroinitializer
  %160 = extractelement <8 x i1> %159, i64 0
  br i1 %160, label %pred.store.if552, label %pred.store.continue553

pred.store.if552:                                 ; preds = %vec.epilog.vector.body
  store i8 1, ptr %4, align 1, !tbaa !23
  br label %pred.store.continue553

pred.store.continue553:                           ; preds = %pred.store.if552, %vec.epilog.vector.body
  %161 = extractelement <8 x i1> %159, i64 1
  br i1 %161, label %pred.store.if554, label %pred.store.continue555
...
pred.store.continue555:                           ; preds = %pred.store.if554, %pred.store.continue553
  ...
  br i1 %162, label %pred.store.if556, label %pred.store.continue557
...
pred.store.continue557:                           ; preds = %pred.store.if556, %pred.store.continue555
  ...
  br i1 %163, label %pred.store.if558, label %pred.store.continue559
...
pred.store.continue559:                           ; preds = %pred.store.if558, %pred.store.continue557
  ...
  br i1 %164, label %pred.store.if560, label %pred.store.continue561
...
pred.store.continue561:                           ; preds = %pred.store.if560, %pred.store.continue559
  ...
  br i1 %165, label %pred.store.if562, label %pred.store.continue563
...
pred.store.continue563:                           ; preds = %pred.store.if562, %pred.store.continue561
  ...
  br i1 %166, label %pred.store.if564, label %pred.store.continue565
...
pred.store.continue565:                           ; preds = %pred.store.if564, %pred.store.continue563
  ...
  br i1 %167, label %pred.store.if566, label %pred.store.continue567
...
pred.store.continue567:                           ; preds = %pred.store.if566, %pred.store.continue565
  %wide.load551.1 = load <8 x i8>, ptr %12, align 1, !tbaa !23
  %168 = icmp eq <8 x i8> %wide.load551.1, zeroinitializer
  %169 = extractelement <8 x i1> %168, i64 0
  br i1 %169, label %pred.store.if552.1, label %pred.store.continue553.1

pred.store.if552.1:                               ; preds = %pred.store.continue567
  store i8 1, ptr %13, align 1, !tbaa !23
  br label %pred.store.continue553.1

pred.store.continue553.1:                         ; preds = %pred.store.if552.1, %pred.store.continue567
  %170 = extractelement <8 x i1> %168, i64 1
  br i1 %170, label %pred.store.if554.1, label %pred.store.continue555.1
...
pred.store.continue555.1:                         ; preds = %pred.store.if554.1, %pred.store.continue553.1
  ...
  br i1 %171, label %pred.store.if556.1, label %pred.store.continue557.1
...
pred.store.continue557.1:                         ; preds = %pred.store.if556.1, %pred.store.continue555.1
  ...
  br i1 %172, label %pred.store.if558.1, label %pred.store.continue559.1
...
pred.store.continue559.1:                         ; preds = %pred.store.if558.1, %pred.store.continue557.1
  ...
  br i1 %173, label %pred.store.if560.1, label %pred.store.continue561.1
...
pred.store.continue561.1:                         ; preds = %pred.store.if560.1, %pred.store.continue559.1
  ...
  br i1 %174, label %pred.store.if562.1, label %pred.store.continue563.1
...
pred.store.continue563.1:                         ; preds = %pred.store.if562.1, %pred.store.continue561.1
  ...
  br i1 %175, label %pred.store.if564.1, label %pred.store.continue565.1
...
pred.store.continue565.1:                         ; preds = %pred.store.if564.1, %pred.store.continue563.1
  ...
  br i1 %176, label %pred.store.if566.1, label %pred.store.continue567.1
...
pred.store.continue567.1:                         ; preds = %pred.store.if566.1, %pred.store.continue565.1
  %wide.load551.2 = load <8 x i8>, ptr %21, align 1, !tbaa !23
  %177 = icmp eq <8 x i8> %wide.load551.2, zeroinitializer
  %178 = extractelement <8 x i1> %177, i64 0
  br i1 %178, label %pred.store.if552.2, label %pred.store.continue553.2

pred.store.if552.2:                               ; preds = %pred.store.continue567.1
  store i8 1, ptr %22, align 1, !tbaa !23
  br label %pred.store.continue553.2

pred.store.continue553.2:                         ; preds = %pred.store.if552.2, %pred.store.continue567.1
  %179 = extractelement <8 x i1> %177, i64 1
  br i1 %179, label %pred.store.if554.2, label %pred.store.continue555.2
...
pred.store.continue555.2:                         ; preds = %pred.store.if554.2, %pred.store.continue553.2
  ...
  br i1 %180, label %pred.store.if556.2, label %pred.store.continue557.2
...
pred.store.continue557.2:                         ; preds = %pred.store.if556.2, %pred.store.continue555.2
  ...
  br i1 %181, label %pred.store.if558.2, label %pred.store.continue559.2
...
pred.store.continue559.2:                         ; preds = %pred.store.if558.2, %pred.store.continue557.2
  ...
  br i1 %182, label %pred.store.if560.2, label %pred.store.continue561.2
...
pred.store.continue561.2:                         ; preds = %pred.store.if560.2, %pred.store.continue559.2
  ...
  br i1 %183, label %pred.store.if562.2, label %pred.store.continue563.2
...
pred.store.continue563.2:                         ; preds = %pred.store.if562.2, %pred.store.continue561.2
  ...
  br i1 %184, label %pred.store.if564.2, label %pred.store.continue565.2
...
pred.store.continue565.2:                         ; preds = %pred.store.if564.2, %pred.store.continue563.2
  ...
  br i1 %185, label %pred.store.if566.2, label %for.body99

pred.store.if566.2:                               ; preds = %pred.store.continue565.2
  store i8 1, ptr %29, align 4, !tbaa !23
  br label %for.body99

for.body99:                                       ; preds = %pred.store.continue565.2, %pred.store.if566.2
...
if.then119:                                       ; preds = %while.body.3, %while.body.2, %while.body.1, %while.body, %land.rhs
  ...
  %idxprom114.le = and i64 %indvars.iv459.lcssa, 4294967295
...
while.end149:                                     ; preds = %while.cond132.while.end149_crit_edge, %while.cond132.preheader
  ...
  %corectionIndex.0.lcssa = phi i32 [ %spec.select385, %while.cond132.while.end149_crit_edge ], [ -1, %while.cond132.preheader ]
...
while.cond179.preheader:                          ; preds = %_ZN10COutBuffer9WriteByteEh.exit
  %cmp180418 = icmp ult i32 %head.0, 8192
  br i1 %cmp180418, label %land.rhs181.preheader, label %if.end202
...
if.then192:                                       ; preds = %land.rhs181
  ...
  %idxprom183.le = and i64 %indvars.iv440, 4294967295
