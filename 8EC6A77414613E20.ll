...
if.end:                                           ; preds = %entry
  ...
  br i1 %cmp.i, label %check_unit.exit, label %if.else.i

if.else.i:                                        ; preds = %if.end
  %cmp1.i = fcmp ogt double %gray, 1.000000e+00
  br i1 %cmp1.i, label %check_unit.exit, label %if.else3.i
...
check_unit.exit:                                  ; preds = %if.end, %if.else.i, %if.else3.i
...
cleanup:                                          ; preds = %entry, %check_unit.exit
  %retval.0 = phi i32 [ 0, %check_unit.exit ], [ -21, %entry ]
  ret i32 %retval.0
}
...
if.end:                                           ; preds = %entry
  ...
  br i1 %cmp.i.i, label %check_unit.exit.i, label %if.else.i.i

if.else.i.i:                                      ; preds = %if.end
  %cmp1.i.i = fcmp ogt double %h, 1.000000e+00
  br i1 %cmp1.i.i, label %check_unit.exit.i, label %if.else3.i.i
...
check_unit.exit.i:                                ; preds = %if.else3.i.i, %if.else.i.i, %if.end
  %.sink.i.i = phi i16 [ %2, %if.else3.i.i ], [ 0, %if.end ], [ -1, %if.else.i.i ]
  %cmp.i17.i = fcmp olt double %s, 0.000000e+00
  br i1 %cmp.i17.i, label %check_unit.exit23.i, label %if.else.i19.i

if.else.i19.i:                                    ; preds = %check_unit.exit.i
  %cmp1.i18.i = fcmp ogt double %s, 1.000000e+00
  br i1 %cmp1.i18.i, label %check_unit.exit23.i, label %if.else3.i21.i
...
if.else3.i21.i:                                   ; preds = %if.else.i19.i
  ...
  br label %check_unit.exit23.i

check_unit.exit23.i:                              ; preds = %if.else3.i21.i, %if.else.i19.i, %check_unit.exit.i
  %.sink.i22.i = phi i16 [ %4, %if.else3.i21.i ], [ 0, %check_unit.exit.i ], [ -1, %if.else.i19.i ]
  %cmp.i24.i = fcmp olt double %b, 0.000000e+00
  br i1 %cmp.i24.i, label %tri_param.exit, label %if.else.i26.i

if.else.i26.i:                                    ; preds = %check_unit.exit23.i
  %cmp1.i25.i = fcmp ogt double %b, 1.000000e+00
  br i1 %cmp1.i25.i, label %tri_param.exit, label %if.else3.i28.i
...
tri_param.exit:                                   ; preds = %check_unit.exit23.i, %if.else.i26.i, %if.else3.i28.i
  %.sink.i29.i = phi i16 [ %6, %if.else3.i28.i ], [ 0, %check_unit.exit23.i ], [ -1, %if.else.i26.i ]
  %color = getelementptr inbounds %struct.gs_state_s, ptr %pgs, i64 0, i32 13
...
cleanup:                                          ; preds = %entry, %tri_param.exit
  %retval.0 = phi i32 [ 0, %tri_param.exit ], [ -21, %entry ]
  ret i32 %retval.0
}
...
check_unit.exit:                                  ; preds = %entry, %if.else.i, %if.else3.i
  %.sink.i = phi i16 [ %1, %if.else3.i ], [ 0, %entry ], [ -1, %if.else.i ]
  %cmp.i17 = fcmp olt double %p2, 0.000000e+00
  br i1 %cmp.i17, label %check_unit.exit23, label %if.else.i19

if.else.i19:                                      ; preds = %check_unit.exit
  %cmp1.i18 = fcmp ogt double %p2, 1.000000e+00
  br i1 %cmp1.i18, label %check_unit.exit23, label %if.else3.i21

if.else3.i21:                                     ; preds = %if.else.i19
  %conv.i20 = fptrunc double %p2 to float
  %2 = fmul float %conv.i20, 6.553500e+04
  %3 = fptoui float %2 to i16
  br label %check_unit.exit23

check_unit.exit23:                                ; preds = %check_unit.exit, %if.else.i19, %if.else3.i21
  %.sink.i22 = phi i16 [ %3, %if.else3.i21 ], [ 0, %check_unit.exit ], [ -1, %if.else.i19 ]
  %cmp.i24 = fcmp olt double %p3, 0.000000e+00
  br i1 %cmp.i24, label %check_unit.exit30, label %if.else.i26

if.else.i26:                                      ; preds = %check_unit.exit23
  %cmp1.i25 = fcmp ogt double %p3, 1.000000e+00
  br i1 %cmp1.i25, label %check_unit.exit30, label %if.else3.i28
...
if.else3.i28:                                     ; preds = %if.else.i26
  ...
  br label %check_unit.exit30

check_unit.exit30:                                ; preds = %check_unit.exit23, %if.else.i26, %if.else3.i28
  %.sink.i29 = phi i16 [ %5, %if.else3.i28 ], [ 0, %check_unit.exit23 ], [ -1, %if.else.i26 ]
...
while.cond.preheader:                             ; preds = %entry
  %call126 = call i32 @gs_screen_currentpoint(ptr noundef nonnull %senum, ptr noundef nonnull %pt), !range !29
  %cmp227 = icmp eq i32 %call126, 0
  br i1 %cmp227, label %while.body.lr.ph, label %while.end
...
gs_screen_next.exit:                              ; preds = %if.end.i, %if.then11.i
  ...
  br i1 %cmp2, label %while.body, label %while.end, !llvm.loop !40

while.end:                                        ; preds = %gs_screen_next.exit, %while.cond.preheader
  %call1.lcssa = phi i32 [ %call126, %while.cond.preheader ], [ %call1, %gs_screen_next.exit ]
...
if.end14:                                         ; preds = %while.end
  ...
  store ptr %proc, ptr %ht_proc, align 8, !tbaa !42
  br label %cleanup
...
if.end46:                                         ; preds = %if.end41
  ...
  store <2 x i32> %5, ptr %width, align 8, !tbaa !43
  ...
  store ptr %pgs, ptr %pgs54, align 8, !tbaa !44
  ...
  store float %conv57, ptr %mat, align 8, !tbaa !45
  %yy = getelementptr inbounds %struct.gs_matrix_s, ptr %mat, i64 0, i32 6
  store float %conv60, ptr %yy, align 8, !tbaa !46
  ...
  store float %conv63, ptr %tx, align 8, !tbaa !47
  ...
  store float %conv66, ptr %ty, align 8, !tbaa !48
...
entry:
  ...
  %1 = load i32, ptr %height, align 4, !tbaa !49
...
for.body.i:                                       ; preds = %for.body.i, %for.body.preheader.i.new
  ...
  store i16 %conv.i, ptr %arrayidx.i, align 2, !tbaa !50
  ...
  store i16 %conv.i.1, ptr %arrayidx.i.1, align 2, !tbaa !50
  ...
  store i16 %conv.i.2, ptr %arrayidx.i.2, align 2, !tbaa !50
  ...
  store i16 %conv.i.3, ptr %arrayidx.i.3, align 2, !tbaa !50
  ...
  store i16 %conv.i.4, ptr %arrayidx.i.4, align 2, !tbaa !50
  ...
  store i16 %conv.i.5, ptr %arrayidx.i.5, align 2, !tbaa !50
  ...
  store i16 %conv.i.6, ptr %arrayidx.i.6, align 2, !tbaa !50
  ...
  store i16 %conv.i.7, ptr %arrayidx.i.7, align 2, !tbaa !50
  %indvars.iv.next.i.7 = add nuw nsw i64 %indvars.iv.i, 8
  %niter.next.7 = add i64 %niter, 8
  %niter.ncmp.7 = icmp eq i64 %niter.next.7, %unroll_iter
  br i1 %niter.ncmp.7, label %for.end.i.loopexit.unr-lcssa, label %for.body.i, !llvm.loop !51
...
for.body.i.epil:                                  ; preds = %for.end.i.loopexit.unr-lcssa, %for.body.i.epil
  ...
  store i16 %conv.i.epil, ptr %arrayidx.i.epil, align 2, !tbaa !50
  %indvars.iv.next.i.epil = add nuw nsw i64 %indvars.iv.i.epil, 1
  %epil.iter.next = add i64 %epil.iter, 1
  %epil.iter.cmp.not = icmp eq i64 %epil.iter.next, %xtraiter
  br i1 %epil.iter.cmp.not, label %for.end.i, label %for.body.i.epil, !llvm.loop !52
...
for.end.i:                                        ; preds = %for.end.i.loopexit.unr-lcssa, %for.body.i.epil, %if.then
  ...
  %7 = load i32, ptr %height, align 4, !tbaa !49
...
if.end.i:                                         ; preds = %for.end.i
  ...
  %8 = load ptr, ptr %pgs.i, align 8, !tbaa !44
  %halftone.i = getelementptr inbounds %struct.gs_state_s, ptr %8, i64 0, i32 11
  %9 = load ptr, ptr %halftone.i, align 8, !tbaa !54
...
cleanup:                                          ; preds = %if.end.i, %for.end.i, %if.end, %if.end46
  %retval.0 = phi i32 [ 0, %if.end46 ], [ %call3, %if.end ], [ 1, %if.end.i ], [ %call.i, %for.end.i ]
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %pt) #12
  ret i32 %retval.0
}
...
entry:
  ...
  %0 = load ptr, ptr %halftone, align 8, !tbaa !54
  %1 = load float, ptr %0, align 8, !tbaa !60
  store float %1, ptr %pfreq, align 4, !tbaa !22
  %angle = getelementptr inbounds %struct.halftone_s, ptr %0, i64 0, i32 1
  %2 = load float, ptr %angle, align 4, !tbaa !61
  store float %2, ptr %pangle, align 4, !tbaa !22
  %ht_proc = getelementptr inbounds %struct.gs_state_s, ptr %pgs, i64 0, i32 12
  %3 = load ptr, ptr %ht_proc, align 8, !tbaa !42
  store ptr %3, ptr %pproc, align 8, !tbaa !62
  ret i32 0
}
...
entry:
  ...
  %height = getelementptr inbounds %struct.gs_screen_enum_s, ptr %penum, i64 0, i32 4
  %2 = load i32, ptr %height, align 4, !tbaa !49
  %mul = mul nsw i32 %2, %1
...
for.body:                                         ; preds = %for.body, %for.body.preheader.new
  ...
  store i16 %conv, ptr %arrayidx, align 2, !tbaa !50
  ...
  store i16 %conv.1, ptr %arrayidx.1, align 2, !tbaa !50
  ...
  store i16 %conv.2, ptr %arrayidx.2, align 2, !tbaa !50
  ...
  store i16 %conv.3, ptr %arrayidx.3, align 2, !tbaa !50
  ...
  store i16 %conv.4, ptr %arrayidx.4, align 2, !tbaa !50
  ...
  store i16 %conv.5, ptr %arrayidx.5, align 2, !tbaa !50
  ...
  store i16 %conv.6, ptr %arrayidx.6, align 2, !tbaa !50
  ...
  store i16 %conv.7, ptr %arrayidx.7, align 2, !tbaa !50
  %indvars.iv.next.7 = add nuw nsw i64 %indvars.iv, 8
  %niter.next.7 = add i64 %niter, 8
  %niter.ncmp.7 = icmp eq i64 %niter.next.7, %unroll_iter
  br i1 %niter.ncmp.7, label %for.end.loopexit.unr-lcssa, label %for.body, !llvm.loop !51
...
for.body.epil:                                    ; preds = %for.end.loopexit.unr-lcssa, %for.body.epil
  ...
  store i16 %conv.epil, ptr %arrayidx.epil, align 2, !tbaa !50
...
for.end:                                          ; preds = %for.end.loopexit.unr-lcssa, %for.body.epil, %entry
  ...
  %6 = load i32, ptr %height, align 4, !tbaa !49
...
if.end:                                           ; preds = %for.end
  ...
  %7 = load ptr, ptr %pgs, align 8, !tbaa !44
  %halftone = getelementptr inbounds %struct.gs_state_s, ptr %7, i64 0, i32 11
  %8 = load ptr, ptr %halftone, align 8, !tbaa !54
