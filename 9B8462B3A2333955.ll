...
lor.lhs.false43:                                  ; preds = %lor.lhs.false
  ...
  %4 = and i1 %cmp47, %cmp55
  %5 = and i1 %4, %cmp38
  %or.cond204 = and i1 %5, %cmp27
...
lor.rhs72:                                        ; preds = %lor.lhs.false57
  ...
  %8 = and i1 %cmp76, %cmp80
  %or.cond206 = and i1 %8, %cmp58
  br i1 %or.cond206, label %land.rhs82, label %if.end135

land.rhs82:                                       ; preds = %lor.rhs72
  %add83 = fadd double %tot_noise, %over_noise
  %add84 = fadd double %add83, %over_noise
...
if.then96:                                        ; preds = %if.end
  ...
  %9 = and i1 %cmp11, %cmp100
  %narrow = or i1 %cmp97, %9
  br label %if.end135
...
lor.rhs121:                                       ; preds = %lor.rhs115
  ...
  %10 = and i1 %cmp125, %cmp122
  br label %if.end135

if.end135:                                        ; preds = %lor.rhs115, %lor.lhs.false57, %if.then, %if.end, %lor.lhs.false43, %lor.lhs.false, %lor.rhs72, %land.rhs82, %if.then26, %if.end23.thread, %if.then96, %if.then112, %lor.rhs121
  %better.6.shrunk = phi i1 [ true, %if.then112 ], [ %not.cmp116, %lor.rhs115 ], [ %10, %lor.rhs121 ], [ %narrow, %if.then96 ], [ %1, %if.end23.thread ], [ true, %lor.lhs.false43 ], [ true, %lor.lhs.false ], [ %cmp87, %land.rhs82 ], [ false, %lor.rhs72 ], [ true, %if.then26 ], [ %better.2.v, %if.end ], [ %narrow224, %if.then ], [ true, %lor.lhs.false57 ]
