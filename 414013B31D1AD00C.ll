...
define dso_local void @f(ptr nocapture noundef writeonly %s) local_unnamed_addr #0 {
entry:
  %scevgep = getelementptr i8, ptr %s, i64 8
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(192) %scevgep, i8 0, i64 192, i1 false), !tbaa !5
  ret void
}
