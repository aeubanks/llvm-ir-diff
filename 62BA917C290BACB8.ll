...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 1000, ptr nonnull %filename) #7
  ...
  tail call void @compress(i32 noundef %argc, ptr noundef %argv) #7
  tail call void @compress(i32 noundef %argc, ptr noundef %argv) #7
  tail call void @compress(i32 noundef %argc, ptr noundef %argv) #7
  tail call void @compress(i32 noundef %argc, ptr noundef %argv) #7
  %arrayidx = getelementptr inbounds ptr, ptr %argv, i64 1
  %2 = load ptr, ptr %arrayidx, align 8, !tbaa !5
  %call2 = call ptr @strcpy(ptr noundef nonnull dereferenceable(1) %filename, ptr noundef nonnull dereferenceable(1) %2) #7
  %strlen = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %filename)
  %endptr = getelementptr inbounds i8, ptr %filename, i64 %strlen
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(7) %endptr, ptr noundef nonnull align 1 dereferenceable(7) @.str.4, i64 7, i1 false)
  store ptr %filename, ptr %arrayidx, align 8, !tbaa !5
  call void @uncompress(i32 noundef %argc, ptr noundef %argv) #7
  %call8 = call i32 @remove(ptr noundef nonnull %filename) #7
  call void @llvm.lifetime.end.p0(i64 1000, ptr nonnull %filename) #7
  ret i32 0
}
