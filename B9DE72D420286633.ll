...
entry.if.end_crit_edge:                           ; preds = %entry
  ...
  %.pre249 = load i32, ptr %arrayidx4.i90.phi.trans.insert, align 4, !tbaa !9
  br label %if.end

if.then:                                          ; preds = %entry
  %sext242 = add i64 %sext, -8589934592
  %idxprom1.i.i = ashr exact i64 %sext242, 32
...
if.end:                                           ; preds = %entry.if.end_crit_edge, %if.then
  %11 = phi i32 [ %.pre249, %entry.if.end_crit_edge ], [ %add.i, %if.then ]
  ...
  %sext243 = add i64 %sext, 4294967296
  %idxprom5.i.i68 = ashr exact i64 %sext243, 32
...
if.then20:                                        ; preds = %if.end
  %sext241 = add i64 %sext, 8589934592
  %idxprom5.i.i96 = ashr exact i64 %sext241, 32
...
if.then25:                                        ; preds = %if.end22
  ...
  %idxprom1.i.i122 = ashr i64 %sext240, 32
...
if.then32:                                        ; preds = %if.end27
  %sext237 = add i64 %move.coerce0, 4294967296
  %idxprom1.i.i150 = ashr i64 %sext237, 32
  ...
  %sext238 = add i64 %move.coerce0, 12884901888
  %idxprom5.i.i153 = ashr i64 %sext238, 32
  ...
  %sext239 = add i64 %move.coerce0, 8589934592
  %idxprom9.i.i156 = ashr i64 %sext239, 32
...
for.body49.prol:                                  ; preds = %for.body49.preheader
  ...
  %sub.prol = add nuw nsw i64 %4, 4294967295
  %idxprom52.prol = and i64 %sub.prol, 4294967295
...
for.body49:                                       ; preds = %for.body49.prol.loopexit, %for.body49
  ...
  %sub = add nuw i64 %indvars.iv114, 4294967295
  %idxprom52 = and i64 %sub, 4294967295
  ...
  %sub.1 = add i64 %indvars.iv114, 4294967294
  %idxprom52.1 = and i64 %sub.1, 4294967295
...
if.then:                                          ; preds = %entry
  ...
  %idxprom1.i225 = ashr exact i64 %sext345, 32
...
if.end:                                           ; preds = %if.then, %entry
  ...
  %sext338 = add i64 %sext, -4294967296
  %idxprom1.i242 = ashr exact i64 %sext338, 32
  ...
  %sext344 = add i64 %sext, 4294967296
  %idxprom5.i244 = ashr exact i64 %sext344, 32
...
if.then59:                                        ; preds = %if.end
  %sext343 = add i64 %sext, 8589934592
  %idxprom5.i268 = ashr exact i64 %sext343, 32
...
if.then73:                                        ; preds = %if.end70
  ...
  %idxprom1.i290 = ashr i64 %sext342, 32
...
if.then89:                                        ; preds = %if.end84
  %sext339 = add i64 %move.coerce0, 4294967296
  %idxprom1.i314 = ashr i64 %sext339, 32
  ...
  %sext340 = add i64 %move.coerce0, 12884901888
  %idxprom5.i317 = ashr i64 %sext340, 32
  ...
  %sext341 = add i64 %move.coerce0, 8589934592
  %idxprom9.i320 = ashr i64 %sext341, 32
