...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 144, ptr nonnull %ru.i) #21
  %call.i = call i32 @getrusage(i32 noundef 0, ptr noundef nonnull %ru.i) #21
  call void @llvm.lifetime.end.p0(i64 144, ptr nonnull %ru.i) #21
  call void @llvm.lifetime.start.p0(i64 256, ptr nonnull %name.i.i) #21
  %call.i.i = call i32 @getpid() #21
  %call1.i.i = call i32 (ptr, ptr, ...) @sprintf(ptr noundef nonnull dereferenceable(1) %name.i.i, ptr noundef nonnull dereferenceable(1) @.str.50, i32 noundef %call.i.i) #21
...
if.end.i.i:                                       ; preds = %entry
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %value.i.i) #21
  ...
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %value.i.i) #21
  br label %_ZL7memUsedv.exit

_ZL7memUsedv.exit:                                ; preds = %entry, %if.end.i.i
  call void @llvm.lifetime.end.p0(i64 256, ptr nonnull %name.i.i) #21
  ...
  %call3 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %1, ptr noundef nonnull @.str, i64 noundef %2) #22
  ...
  %call6 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %5, ptr noundef nonnull @.str.5, i64 noundef %6) #22
  ...
  %call12 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %9, ptr noundef nonnull @.str.6, i64 noundef %10, double noundef %conv11) #22
  ...
  %call15 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %14, ptr noundef nonnull @.str.7, i64 noundef %15) #22
  ...
  %call24 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %18, ptr noundef nonnull @.str.8, i64 noundef %19, double noundef %div23) #22
...
entry:
  ...
  %call1 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %1, ptr noundef nonnull @.str.9, ptr noundef %2) #22
  %3 = load ptr, ptr @stderr, align 8, !tbaa !5
  %call2 = tail call i32 @fflush(ptr noundef %3)
  %4 = load ptr, ptr @stdout, align 8, !tbaa !5
  %call3 = tail call i32 @fflush(ptr noundef %4)
  %5 = load ptr, ptr @stderr, align 8, !tbaa !5
  %6 = tail call i64 @fwrite(ptr nonnull @.str.10, i64 10, i64 1, ptr %5) #22
  %7 = load ptr, ptr @stderr, align 8, !tbaa !5
  %call5 = tail call i32 @fflush(ptr noundef %7)
  %8 = load ptr, ptr @stdout, align 8, !tbaa !5
  %call6 = tail call i32 @fflush(ptr noundef %8)
  %9 = load ptr, ptr @stderr, align 8, !tbaa !5
  %10 = tail call i64 @fwrite(ptr nonnull @.str.11, i64 36, i64 1, ptr %9) #22
  ...
  %14 = tail call i64 @fwrite(ptr nonnull @.str.12, i64 35, i64 1, ptr %13) #22
  ...
  %18 = tail call i64 @fwrite(ptr nonnull @.str.13, i64 35, i64 1, ptr %17) #22
  ...
  %21 = load ptr, ptr @stderr, align 8, !tbaa !5
  %22 = tail call i64 @fwrite(ptr nonnull @.str.14, i64 27, i64 1, ptr %21) #22
...
entry:
  %call = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %prefix) #23
  %sext = shl i64 %call, 32
  %conv1 = ashr exact i64 %sext, 32
  %call2 = tail call i32 @strncmp(ptr noundef %str, ptr noundef %prefix, i64 noundef %conv1) #23
  %cmp = icmp eq i32 %call2, 0
  br i1 %cmp, label %if.then, label %cleanup

if.then:                                          ; preds = %entry
  %add.ptr = getelementptr inbounds i8, ptr %str, i64 %conv1
  %call3 = tail call noalias ptr @strdup(ptr noundef %add.ptr) #21
  br label %cleanup
...
entry:
  %tmp.i = alloca %class.vec.0, align 8
  ...
  call void @llvm.lifetime.start.p0(i64 536, ptr nonnull %S) #21
...
for.body:                                         ; preds = %for.body.lr.ph, %for.inc
  ...
  %j.0412 = phi i32 [ 0, %for.body.lr.ph ], [ %j.1, %for.inc ]
  %arrayidx = getelementptr inbounds ptr, ptr %argv, i64 %indvars.iv
  %0 = load ptr, ptr %arrayidx, align 8, !tbaa !5
  %call2.i = call i32 @strncmp(ptr noundef nonnull dereferenceable(1) %0, ptr noundef nonnull dereferenceable(16) @.str.16, i64 noundef 15) #23
...
_Z9hasPrefixPKcS0_.exit:                          ; preds = %for.body
  ...
  %call3.i = call noalias ptr @strdup(ptr noundef nonnull %add.ptr.i) #21
  %tobool.not = icmp eq ptr %call3.i, null
  br i1 %tobool.not, label %if.else21, label %if.then

if.then:                                          ; preds = %_Z9hasPrefixPKcS0_.exit
  %call1 = call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %call3.i, ptr noundef nonnull dereferenceable(5) @.str.17) #23
...
if.else:                                          ; preds = %if.then
  %call4 = call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %call3.i, ptr noundef nonnull dereferenceable(6) @.str.18) #23
...
if.else8:                                         ; preds = %if.else
  %call9 = call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %call3.i, ptr noundef nonnull dereferenceable(4) @.str.19) #23
...
if.else13:                                        ; preds = %if.else8
  ...
  %call16 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %2, ptr noundef nonnull @.str.20, ptr noundef nonnull %call3.i) #22
  %3 = load ptr, ptr @stderr, align 8, !tbaa !5
...
if.else21:                                        ; preds = %for.body, %_Z9hasPrefixPKcS0_.exit
  %call2.i345 = call i32 @strncmp(ptr noundef nonnull dereferenceable(1) %0, ptr noundef nonnull dereferenceable(11) @.str.21, i64 noundef 10) #23
  %cmp.i346 = icmp eq i32 %call2.i345, 0
  br i1 %cmp.i346, label %_Z9hasPrefixPKcS0_.exit351, label %if.else41

_Z9hasPrefixPKcS0_.exit351:                       ; preds = %if.else21
  %add.ptr.i347 = getelementptr inbounds i8, ptr %0, i64 10
  %call3.i348 = call noalias ptr @strdup(ptr noundef nonnull %add.ptr.i347) #21
  %tobool25.not = icmp eq ptr %call3.i348, null
  br i1 %tobool25.not, label %if.else41, label %if.then26

if.then26:                                        ; preds = %_Z9hasPrefixPKcS0_.exit351
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %rnd) #21
  %call27 = call i32 (ptr, ptr, ...) @__isoc99_sscanf(ptr noundef nonnull %call3.i348, ptr noundef nonnull @.str.22, ptr noundef nonnull %rnd) #21
...
if.then32:                                        ; preds = %if.then26
  ...
  %call37 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %6, ptr noundef nonnull @.str.23, ptr noundef nonnull %call3.i348) #22
  %7 = load ptr, ptr @stderr, align 8, !tbaa !5
...
if.end40:                                         ; preds = %if.then26
  ...
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %rnd) #21
  br label %for.inc

if.else41:                                        ; preds = %if.else21, %_Z9hasPrefixPKcS0_.exit351
  %call2.i355 = call i32 @strncmp(ptr noundef nonnull dereferenceable(1) %0, ptr noundef nonnull dereferenceable(8) @.str.24, i64 noundef 7) #23
  %cmp.i356 = icmp eq i32 %call2.i355, 0
  br i1 %cmp.i356, label %_Z9hasPrefixPKcS0_.exit361, label %if.else62

_Z9hasPrefixPKcS0_.exit361:                       ; preds = %if.else41
  %add.ptr.i357 = getelementptr inbounds i8, ptr %0, i64 7
  %call3.i358 = call noalias ptr @strdup(ptr noundef nonnull %add.ptr.i357) #21
  %tobool45.not = icmp eq ptr %call3.i358, null
  br i1 %tobool45.not, label %if.else62, label %if.then46

if.then46:                                        ; preds = %_Z9hasPrefixPKcS0_.exit361
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %decay) #21
  %call47 = call i32 (ptr, ptr, ...) @__isoc99_sscanf(ptr noundef nonnull %call3.i358, ptr noundef nonnull @.str.22, ptr noundef nonnull %decay) #21
...
if.then53:                                        ; preds = %if.then46
  ...
  %call58 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %10, ptr noundef nonnull @.str.25, ptr noundef nonnull %call3.i358) #22
  %11 = load ptr, ptr @stderr, align 8, !tbaa !5
...
if.end61:                                         ; preds = %if.then46
  ...
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %decay) #21
  br label %for.inc

if.else62:                                        ; preds = %if.else41, %_Z9hasPrefixPKcS0_.exit361
  %call2.i365 = call i32 @strncmp(ptr noundef nonnull dereferenceable(1) %0, ptr noundef nonnull dereferenceable(12) @.str.26, i64 noundef 11) #23
  %cmp.i366 = icmp eq i32 %call2.i365, 0
  br i1 %cmp.i366, label %_Z9hasPrefixPKcS0_.exit371, label %if.else84

_Z9hasPrefixPKcS0_.exit371:                       ; preds = %if.else62
  %add.ptr.i367 = getelementptr inbounds i8, ptr %0, i64 11
  %call3.i368 = call noalias ptr @strdup(ptr noundef nonnull %add.ptr.i367) #21
  %tobool66.not = icmp eq ptr %call3.i368, null
  br i1 %tobool66.not, label %if.else84, label %if.then67

if.then67:                                        ; preds = %_Z9hasPrefixPKcS0_.exit371
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %end) #21
  %call69 = call i64 @strtol(ptr noundef nonnull %call3.i368, ptr noundef nonnull %end, i32 noundef 10) #21
  %conv = trunc i64 %call69 to i32
  %12 = load ptr, ptr %end, align 8, !tbaa !5
  %cmp70 = icmp eq ptr %12, %call3.i368
...
if.then74:                                        ; preds = %lor.lhs.false71, %if.then67
  ...
  %15 = load ptr, ptr @stderr, align 8, !tbaa !5
  %call79 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %15, ptr noundef nonnull @.str.27, ptr noundef nonnull %call3.i368) #22
  %16 = load ptr, ptr @stderr, align 8, !tbaa !5
...
if.end82:                                         ; preds = %lor.lhs.false71
  ...
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %end) #21
  br label %for.inc

if.else84:                                        ; preds = %if.else62, %_Z9hasPrefixPKcS0_.exit371
  %call87 = call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %0, ptr noundef nonnull dereferenceable(3) @.str.28) #23
  %cmp88 = icmp eq i32 %call87, 0
  br i1 %cmp88, label %if.then99, label %lor.lhs.false89

lor.lhs.false89:                                  ; preds = %if.else84
  %call92 = call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %0, ptr noundef nonnull dereferenceable(6) @.str.29) #23
  %cmp93 = icmp eq i32 %call92, 0
  br i1 %cmp93, label %if.then99, label %lor.lhs.false94

lor.lhs.false94:                                  ; preds = %lor.lhs.false89
  %call97 = call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %0, ptr noundef nonnull dereferenceable(7) @.str.30) #23
...
if.then106:                                       ; preds = %if.else101
  ...
  %call112 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %18, ptr noundef nonnull @.str.32, ptr noundef %19) #22
...
if.else115:                                       ; preds = %if.else101
  %inc = add nsw i32 %j.0412, 1
  %idxprom118 = sext i32 %j.0412 to i64
...
for.inc:                                          ; preds = %if.then6, %if.then11, %if.then3, %if.end61, %if.else115, %if.end82, %if.end40
  %j.1 = phi i32 [ %j.0412, %if.then3 ], [ %j.0412, %if.then6 ], [ %j.0412, %if.then11 ], [ %j.0412, %if.end40 ], [ %j.0412, %if.end61 ], [ %j.0412, %if.end82 ], [ %inc, %if.else115 ]
...
for.end:                                          ; preds = %for.inc, %entry
  ...
  %23 = call i64 @fwrite(ptr nonnull @.str.33, i64 25, i64 1, ptr %22) #22
  %24 = load ptr, ptr @stderr, align 8, !tbaa !5
  %call132 = call i32 @fflush(ptr noundef %24)
  call void @llvm.lifetime.start.p0(i64 2, ptr nonnull %oldcw) #21
  call void @llvm.lifetime.start.p0(i64 2, ptr nonnull %newcw) #21
  call void asm sideeffect "fnstcw $0", "=*m,~{dirflag},~{fpsr},~{flags}"(ptr nonnull elementtype(i16) %oldcw) #21, !srcloc !37
  %25 = load i16, ptr %oldcw, align 2, !tbaa !38
  %26 = and i16 %25, -769
  %27 = or i16 %26, 512
  store i16 %27, ptr %newcw, align 2, !tbaa !38
  call void asm sideeffect "fldcw $0", "*m,~{dirflag},~{fpsr},~{flags}"(ptr nonnull elementtype(i16) %newcw) #21, !srcloc !40
  call void @llvm.lifetime.start.p0(i64 144, ptr nonnull %ru.i) #21
  %call.i372 = call i32 @getrusage(i32 noundef 0, ptr noundef nonnull %ru.i) #21
  call void @llvm.lifetime.end.p0(i64 144, ptr nonnull %ru.i) #21
...
if.then139:                                       ; preds = %for.end
  ...
  %30 = call i64 @fwrite(ptr nonnull @.str.34, i64 62, i64 1, ptr %29) #22
...
cond.end160:                                      ; preds = %if.then153, %cond.false158
  ...
  %call163 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %35, ptr noundef nonnull @.str.36, ptr noundef %cond161) #22
...
if.end166:                                        ; preds = %cond.end
  %39 = call i64 @fwrite(ptr nonnull @.str.38, i64 80, i64 1, ptr %35) #22
  ...
  %43 = call i64 @fwrite(ptr nonnull @.str.39, i64 80, i64 1, ptr %42) #22
  %44 = load ptr, ptr @stderr, align 8, !tbaa !5
  %call178 = call i32 @fflush(ptr noundef %44)
  %call.i373374 = invoke noalias noundef nonnull dereferenceable(1048592) ptr @_Znwm(i64 noundef 1048592) #25
          to label %call.i373.noexc unwind label %lpad149

call.i373.noexc:                                  ; preds = %if.end166
  store ptr %cond, ptr %call.i373374, align 8, !tbaa !41
  %pos.i.i = getelementptr inbounds %class.StreamBuffer, ptr %call.i373374, i64 0, i32 2
  store i64 0, ptr %pos.i.i, align 8
  %call.i.i.i = call i32 @fileno(ptr noundef nonnull %cond) #21
  %buf.i.i.i = getelementptr inbounds %class.StreamBuffer, ptr %call.i373374, i64 0, i32 1
  %call3.i.i3.i = invoke i64 @read(i32 noundef %call.i.i.i, ptr noundef nonnull %buf.i.i.i, i64 noundef 1048576)
          to label %_ZN12StreamBufferC2EP8_IO_FILE.exit.i unwind label %lpad.i

_ZN12StreamBufferC2EP8_IO_FILE.exit.i:            ; preds = %call.i373.noexc
  %size.i.i = getelementptr inbounds %class.StreamBuffer, ptr %call.i373374, i64 0, i32 3
  %conv.i.i.i = trunc i64 %call3.i.i3.i to i32
  store i32 %conv.i.i.i, ptr %size.i.i, align 4, !tbaa !43
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %lits.i.i) #21
...
for.cond.i.i:                                     ; preds = %if.end51.i.i, %_ZN12StreamBufferC2EP8_IO_FILE.exit.i
  %45 = phi i32 [ %.pre.i, %if.end51.i.i ], [ %conv.i.i.i, %_ZN12StreamBufferC2EP8_IO_FILE.exit.i ]
...
_ZN12StreamBufferdeEv.exit.i.i.i:                 ; preds = %for.cond.i.i, %_ZN12StreamBufferppEv.exit.i.i.i
  ...
  %arrayidx.i.i.i.i = getelementptr inbounds %class.StreamBuffer, ptr %call.i373374, i64 0, i32 1, i64 %idxprom.i.i.i.i
...
if.then.i.i.i.i.i:                                ; preds = %while.body.i.i.i
  ...
  %50 = load ptr, ptr %call.i373374, align 8, !tbaa !41
  %call.i.i.i.i.i = call i32 @fileno(ptr noundef %50) #21
  %call3.i.i.i66.i.i = invoke i64 @read(i32 noundef %call.i.i.i.i.i, ptr noundef nonnull %buf.i.i.i, i64 noundef 1048576)
...
call3.i.i.i.noexc.i.i:                            ; preds = %if.then.i.i.i.i.i
  %conv.i.i.i.i.i = trunc i64 %call3.i.i.i66.i.i to i32
...
_ZN12StreamBufferdeEv.exit.i.i:                   ; preds = %invoke.cont.i.i
  ...
  %arrayidx.i.i.i = getelementptr inbounds %class.StreamBuffer, ptr %call.i373374, i64 0, i32 1, i64 %idxprom.i.i.i
  ...
  switch i8 %55, label %if.else45.i.i [
    ...
    i8 99, label %_ZN12StreamBufferdeEv.exit.i128.i.i
  ]

lpad.loopexit.i.i:                                ; preds = %while.body.i140.i.i
...
lpad.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.i.i: ; preds = %invoke.cont46.i.i, %_ZN3vecI3LitE5clearEb.exit.i.i.i, %if.then.i.i.i133.i.i, %if.then.i.i.4.i.i.i, %if.then.i.i.3.i.i.i, %if.then.i.i.2.i.i.i, %if.then.i.i.1.i.i.i, %if.then.i.i.i88.i.i
  %lpad.loopexit.split-lp172.i.i = landingpad { ptr, i32 }
          cleanup
  br label %ehcleanup52.i.i

for.inc.i.i.i:                                    ; preds = %_ZN12StreamBufferdeEv.exit.i.i
  %inc.i.i83.i.i = add nsw i32 %54, 1
  store i32 %inc.i.i83.i.i, ptr %pos.i.i, align 8, !tbaa !44
  %cmp.not.i.i.i84.i.i = icmp slt i32 %inc.i.i83.i.i, %53
  br i1 %cmp.not.i.i.i84.i.i, label %_ZN12StreamBufferppEv.exit.i89.i.i, label %if.then.i.i.i88.i.i

if.then.i.i.i88.i.i:                              ; preds = %for.inc.i.i.i
  store i32 0, ptr %pos.i.i, align 8, !tbaa !44
  %56 = load ptr, ptr %call.i373374, align 8, !tbaa !41
  %call.i.i.i85.i.i = call i32 @fileno(ptr noundef %56) #21
  %call3.i.i.i91.i.i = invoke i64 @read(i32 noundef %call.i.i.i85.i.i, ptr noundef nonnull %buf.i.i.i, i64 noundef 1048576)
          to label %call3.i.i.i.noexc90.i.i unwind label %lpad.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.i.i

call3.i.i.i.noexc90.i.i:                          ; preds = %if.then.i.i.i88.i.i
  %conv.i.i.i86.i.i = trunc i64 %call3.i.i.i91.i.i to i32
  store i32 %conv.i.i.i86.i.i, ptr %size.i.i, align 4, !tbaa !43
  %.pre.i87.i.i = load i32, ptr %pos.i.i, align 8, !tbaa !44
  br label %_ZN12StreamBufferppEv.exit.i89.i.i

_ZN12StreamBufferppEv.exit.i89.i.i:               ; preds = %call3.i.i.i.noexc90.i.i, %for.inc.i.i.i
  %57 = phi i32 [ %53, %for.inc.i.i.i ], [ %conv.i.i.i86.i.i, %call3.i.i.i.noexc90.i.i ]
  %58 = phi i32 [ %inc.i.i83.i.i, %for.inc.i.i.i ], [ %.pre.i87.i.i, %call3.i.i.i.noexc90.i.i ]
  %cmp.not.i.1.i.i.i = icmp slt i32 %58, %57
  br i1 %cmp.not.i.1.i.i.i, label %_ZN12StreamBufferdeEv.exit.1.i.i.i, label %if.else27.i.i

_ZN12StreamBufferdeEv.exit.1.i.i.i:               ; preds = %_ZN12StreamBufferppEv.exit.i89.i.i
  %idxprom.i.1.i.i.i = sext i32 %58 to i64
  %arrayidx.i.1.i.i.i = getelementptr inbounds %class.StreamBuffer, ptr %call.i373374, i64 0, i32 1, i64 %idxprom.i.1.i.i.i
...
if.then.i.i.1.i.i.i:                              ; preds = %for.inc.1.i.i.i
  store i32 0, ptr %pos.i.i, align 8, !tbaa !44
  %61 = load ptr, ptr %call.i373374, align 8, !tbaa !41
  %call.i.i.1.i.i.i = call i32 @fileno(ptr noundef %61) #21
  %call3.i.i.1.i92.i.i = invoke i64 @read(i32 noundef %call.i.i.1.i.i.i, ptr noundef nonnull %buf.i.i.i, i64 noundef 1048576)
...
call3.i.i.1.i.noexc.i.i:                          ; preds = %if.then.i.i.1.i.i.i
  %conv.i.i.1.i.i.i = trunc i64 %call3.i.i.1.i92.i.i to i32
...
_ZN12StreamBufferppEv.exit.1.i.i.i:               ; preds = %call3.i.i.1.i.noexc.i.i, %for.inc.1.i.i.i
  ...
  %63 = phi i32 [ %.pre4.i.i.i, %call3.i.i.1.i.noexc.i.i ], [ %inc.i.1.i.i.i, %for.inc.1.i.i.i ]
...
_ZN12StreamBufferdeEv.exit.2.i.i.i:               ; preds = %_ZN12StreamBufferppEv.exit.1.i.i.i
  ...
  %arrayidx.i.2.i.i.i = getelementptr inbounds %class.StreamBuffer, ptr %call.i373374, i64 0, i32 1, i64 %idxprom.i.2.i.i.i
...
if.then.i.i.2.i.i.i:                              ; preds = %for.inc.2.i.i.i
  store i32 0, ptr %pos.i.i, align 8, !tbaa !44
  %66 = load ptr, ptr %call.i373374, align 8, !tbaa !41
  %call.i.i.2.i.i.i = call i32 @fileno(ptr noundef %66) #21
  %call3.i.i.2.i93.i.i = invoke i64 @read(i32 noundef %call.i.i.2.i.i.i, ptr noundef nonnull %buf.i.i.i, i64 noundef 1048576)
...
call3.i.i.2.i.noexc.i.i:                          ; preds = %if.then.i.i.2.i.i.i
  %conv.i.i.2.i.i.i = trunc i64 %call3.i.i.2.i93.i.i to i32
...
_ZN12StreamBufferppEv.exit.2.i.i.i:               ; preds = %call3.i.i.2.i.noexc.i.i, %for.inc.2.i.i.i
  ...
  %68 = phi i32 [ %.pre5.i.i.i, %call3.i.i.2.i.noexc.i.i ], [ %inc.i.2.i.i.i, %for.inc.2.i.i.i ]
...
_ZN12StreamBufferdeEv.exit.3.i.i.i:               ; preds = %_ZN12StreamBufferppEv.exit.2.i.i.i
  ...
  %arrayidx.i.3.i.i.i = getelementptr inbounds %class.StreamBuffer, ptr %call.i373374, i64 0, i32 1, i64 %idxprom.i.3.i.i.i
...
if.then.i.i.3.i.i.i:                              ; preds = %for.inc.3.i.i.i
  store i32 0, ptr %pos.i.i, align 8, !tbaa !44
  %71 = load ptr, ptr %call.i373374, align 8, !tbaa !41
  %call.i.i.3.i.i.i = call i32 @fileno(ptr noundef %71) #21
  %call3.i.i.3.i94.i.i = invoke i64 @read(i32 noundef %call.i.i.3.i.i.i, ptr noundef nonnull %buf.i.i.i, i64 noundef 1048576)
...
call3.i.i.3.i.noexc.i.i:                          ; preds = %if.then.i.i.3.i.i.i
  %conv.i.i.3.i.i.i = trunc i64 %call3.i.i.3.i94.i.i to i32
  store i32 %conv.i.i.3.i.i.i, ptr %size.i.i, align 4, !tbaa !43
  %.pre6.i.i.i = load i32, ptr %pos.i.i, align 8, !tbaa !44
...
_ZN12StreamBufferppEv.exit.3.i.i.i:               ; preds = %call3.i.i.3.i.noexc.i.i, %for.inc.3.i.i.i
  ...
  %73 = phi i32 [ %.pre6.i.i.i, %call3.i.i.3.i.noexc.i.i ], [ %inc.i.3.i.i.i, %for.inc.3.i.i.i ]
...
_ZN12StreamBufferdeEv.exit.4.i.i.i:               ; preds = %_ZN12StreamBufferppEv.exit.3.i.i.i
  ...
  %arrayidx.i.4.i.i.i = getelementptr inbounds %class.StreamBuffer, ptr %call.i373374, i64 0, i32 1, i64 %idxprom.i.4.i.i.i
...
if.then.i.i.4.i.i.i:                              ; preds = %for.inc.4.i.i.i
  store i32 0, ptr %pos.i.i, align 8, !tbaa !44
  %76 = load ptr, ptr %call.i373374, align 8, !tbaa !41
  %call.i.i.4.i.i.i = call i32 @fileno(ptr noundef %76) #21
  %call3.i.i.4.i95.i.i = invoke i64 @read(i32 noundef %call.i.i.4.i.i.i, ptr noundef nonnull %buf.i.i.i, i64 noundef 1048576)
...
call3.i.i.4.i.noexc.i.i:                          ; preds = %if.then.i.i.4.i.i.i
  %conv.i.i.4.i.i.i = trunc i64 %call3.i.i.4.i95.i.i to i32
...
if.then8.i.i:                                     ; preds = %call3.i.i.4.i.noexc.i.i, %for.inc.4.i.i.i
  %call11.i.i = invoke fastcc noundef i32 @_ZL8parseIntI12StreamBufferEiRT_(ptr noundef nonnull align 8 dereferenceable(1048592) %call.i373374)
          to label %invoke.cont10.i.i unwind label %lpad9.i.i

invoke.cont10.i.i:                                ; preds = %if.then8.i.i
  %call14.i.i = invoke fastcc noundef i32 @_ZL8parseIntI12StreamBufferEiRT_(ptr noundef nonnull align 8 dereferenceable(1048592) %call.i373374)
...
invoke.cont13.i.i:                                ; preds = %invoke.cont10.i.i
  ...
  %call18.i.i = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %78, ptr noundef nonnull @.str.53, i32 noundef %call11.i.i) #22
  ...
  %call24.i.i = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %81, ptr noundef nonnull @.str.54, i32 noundef %call14.i.i) #22
...
if.else27.i.i:                                    ; preds = %_ZN12StreamBufferdeEv.exit.4.i.i.i, %_ZN12StreamBufferppEv.exit.3.i.i.i, %_ZN12StreamBufferdeEv.exit.3.i.i.i, %_ZN12StreamBufferppEv.exit.2.i.i.i, %_ZN12StreamBufferdeEv.exit.2.i.i.i, %_ZN12StreamBufferppEv.exit.1.i.i.i, %_ZN12StreamBufferdeEv.exit.1.i.i.i, %_ZN12StreamBufferppEv.exit.i89.i.i
  ...
  %cmp.not.i98.i.i = icmp slt i32 %87, %88
  br i1 %cmp.not.i98.i.i, label %cond.false.i102.i.i, label %_ZN12StreamBufferdeEv.exit104.i.i

cond.false.i102.i.i:                              ; preds = %if.else27.i.i
  %idxprom.i99.i.i = sext i32 %87 to i64
  %arrayidx.i100.i.i = getelementptr inbounds %class.StreamBuffer, ptr %call.i373374, i64 0, i32 1, i64 %idxprom.i99.i.i
  %89 = load i8, ptr %arrayidx.i100.i.i, align 1, !tbaa !34
  %conv.i101.i.i = sext i8 %89 to i32
  br label %_ZN12StreamBufferdeEv.exit104.i.i

_ZN12StreamBufferdeEv.exit104.i.i:                ; preds = %cond.false.i102.i.i, %if.else27.i.i
  %cond.i103.i.i = phi i32 [ %conv.i101.i.i, %cond.false.i102.i.i ], [ -1, %if.else27.i.i ]
  %call33.i.i = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %86, ptr noundef nonnull @.str.55, i32 noundef %cond.i103.i.i) #22
  %90 = load ptr, ptr @stderr, align 8, !tbaa !5
  %call35.i.i = call i32 @fflush(ptr noundef %90)
  call void @exit(i32 noundef 3) #24
  unreachable

_ZN12StreamBufferdeEv.exit.i128.i.i:              ; preds = %_ZN12StreamBufferdeEv.exit.i.i, %_ZN12StreamBufferppEv.exit39.i.i.i
  ...
  %idxprom.i.i126.i.i = sext i32 %92 to i64
  %arrayidx.i.i127.i.i = getelementptr inbounds %class.StreamBuffer, ptr %call.i373374, i64 0, i32 1, i64 %idxprom.i.i126.i.i
  %93 = load i8, ptr %arrayidx.i.i127.i.i, align 1, !tbaa !34
...
if.then5.i.i.i:                                   ; preds = %_ZN12StreamBufferdeEv.exit.i128.i.i
  %inc.i.i129.i.i = add nsw i32 %92, 1
  store i32 %inc.i.i129.i.i, ptr %pos.i.i, align 8, !tbaa !44
  %cmp.not.i.i.i130.i.i = icmp slt i32 %inc.i.i129.i.i, %91
  br i1 %cmp.not.i.i.i130.i.i, label %if.end51.i.i, label %if.then.i.i.i133.i.i

if.then.i.i.i133.i.i:                             ; preds = %if.then5.i.i.i
  store i32 0, ptr %pos.i.i, align 8, !tbaa !44
  %94 = load ptr, ptr %call.i373374, align 8, !tbaa !41
  %call.i.i.i131.i.i = call i32 @fileno(ptr noundef %94) #21
  %call3.i.i.i137.i.i = invoke i64 @read(i32 noundef %call.i.i.i131.i.i, ptr noundef nonnull %buf.i.i.i, i64 noundef 1048576)
          to label %call3.i.i.i.noexc136.i.i unwind label %lpad.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.i.i

call3.i.i.i.noexc136.i.i:                         ; preds = %if.then.i.i.i133.i.i
  %conv.i.i.i132.i.i = trunc i64 %call3.i.i.i137.i.i to i32
  store i32 %conv.i.i.i132.i.i, ptr %size.i.i, align 4, !tbaa !43
  br label %if.end51.i.i

if.end6.i.i.i:                                    ; preds = %_ZN12StreamBufferdeEv.exit.i128.i.i
...
if.then.i.i38.i.i.i:                              ; preds = %if.end6.i.i.i
  store i32 0, ptr %pos.i.i, align 8, !tbaa !44
  %95 = load ptr, ptr %call.i373374, align 8, !tbaa !41
  %call.i.i34.i.i.i = call i32 @fileno(ptr noundef %95) #21
  %call3.i.i36.i138.i.i = invoke i64 @read(i32 noundef %call.i.i34.i.i.i, ptr noundef nonnull %buf.i.i.i, i64 noundef 1048576)
...
call3.i.i36.i.noexc.i.i:                          ; preds = %if.then.i.i38.i.i.i
  %conv.i.i37.i.i.i = trunc i64 %call3.i.i36.i138.i.i to i32
  store i32 %conv.i.i37.i.i.i, ptr %size.i.i, align 4, !tbaa !43
  %.pre.i134.i.i = load i32, ptr %pos.i.i, align 8, !tbaa !44
...
_ZN12StreamBufferppEv.exit39.i.i.i:               ; preds = %call3.i.i36.i.noexc.i.i, %if.end6.i.i.i
  ...
  %97 = phi i32 [ %inc.i31.i.i.i, %if.end6.i.i.i ], [ %.pre.i134.i.i, %call3.i.i36.i.noexc.i.i ]
  %cmp.not.i.i135.i.i = icmp slt i32 %97, %96
  br i1 %cmp.not.i.i135.i.i, label %_ZN12StreamBufferdeEv.exit.i128.i.i, label %if.end51.i.i, !llvm.loop !46

if.else45.i.i:                                    ; preds = %_ZN12StreamBufferdeEv.exit.i.i
  %98 = load ptr, ptr %lits.i.i, align 8, !tbaa !47
  %cmp.not.i.i139.i.i = icmp eq ptr %98, null
  br i1 %cmp.not.i.i139.i.i, label %_ZN3vecI3LitE5clearEb.exit.i.i.i, label %for.cond.preheader.i.i.i.i
...
_ZN3vecI3LitE5clearEb.exit.i.i.i:                 ; preds = %for.cond.preheader.i.i.i.i, %if.else45.i.i
  %call18.i145.i.i = invoke fastcc noundef i32 @_ZL8parseIntI12StreamBufferEiRT_(ptr noundef nonnull align 8 dereferenceable(1048592) %call.i373374)
...
call18.i.noexc.i.i:                               ; preds = %_ZN3vecI3LitE5clearEb.exit.i.i.i
  %cmp19.i.i.i = icmp eq i32 %call18.i145.i.i, 0
  br i1 %cmp19.i.i.i, label %invoke.cont46.i.i, label %if.end.i.i.i

if.end.i.i.i:                                     ; preds = %call18.i.noexc.i.i, %call.i.noexc.i.i
  %call20.i.i.i = phi i32 [ %call.i147.i.i, %call.i.noexc.i.i ], [ %call18.i145.i.i, %call18.i.noexc.i.i ]
  ...
  br i1 %cmp3.not.not17.i.i.i, label %while.body.i140.i.i, label %while.end.i.i.i

while.body.i140.i.i:                              ; preds = %if.end.i.i.i, %call4.i.noexc.i.i
  %call4.i146.i.i = invoke noundef i32 @_ZN6Solver6newVarEbb(ptr noundef nonnull align 8 dereferenceable(536) %S, i1 noundef zeroext true, i1 noundef zeroext true)
          to label %call4.i.noexc.i.i unwind label %lpad.loopexit.i.i

call4.i.noexc.i.i:                                ; preds = %while.body.i140.i.i
  %100 = load i32, ptr %sz.i.i.i.i.i, align 8, !tbaa !49
  %cmp3.not.not.i.i.i = icmp sgt i32 %call1.i.i.i, %100
  br i1 %cmp3.not.not.i.i.i, label %while.body.i140.i.i, label %while.end.i.i.i, !llvm.loop !50
...
if.then.i.i.i.i:                                  ; preds = %while.end.i.i.i
  ...
  %call6.i.i.i.i = call ptr @realloc(ptr noundef %103, i64 noundef %mul5.i.i.i.i) #26
...
_ZN3vecI3LitE4pushERKS0_.exit.i.i.i:              ; preds = %if.then.i.i.i.i, %entry.if.end_crit_edge.i.i.i.i
  ...
  %inc.i.i141.i.i = add nsw i32 %104, 1
  store i32 %inc.i.i141.i.i, ptr %sz.le.i.i.i.i, align 8, !tbaa !48
  %idxprom.i.i142.i.i = sext i32 %104 to i64
  %arrayidx.i.i143.i.i = getelementptr inbounds %class.Lit, ptr %105, i64 %idxprom.i.i142.i.i
  store i32 %ref.tmp.sroa.0.0.i.i.i, ptr %arrayidx.i.i143.i.i, align 4, !tbaa !52
  %call.i147.i.i = invoke fastcc noundef i32 @_ZL8parseIntI12StreamBufferEiRT_(ptr noundef nonnull align 8 dereferenceable(1048592) %call.i373374)
...
call.i.noexc.i.i:                                 ; preds = %_ZN3vecI3LitE4pushERKS0_.exit.i.i.i
  %cmp.i144.i.i = icmp eq i32 %call.i147.i.i, 0
  br i1 %cmp.i144.i.i, label %invoke.cont46.i.i, label %if.end.i.i.i, !llvm.loop !53
...
if.end51.i.i:                                     ; preds = %_ZN12StreamBufferppEv.exit39.i.i.i, %_ZN12StreamBufferdeEv.exit.i128.i.i, %_ZN12StreamBufferdeEv.exit.i128.i.i, %invoke.cont46.i.i, %call3.i.i.i.noexc136.i.i, %if.then5.i.i.i, %invoke.cont13.i.i
...
for.end.i.i:                                      ; preds = %_ZN12StreamBufferdeEv.exit.i.i, %invoke.cont.i.i
  ...
  %cmp.not.i.i148.i.i = icmp eq ptr %106, null
  br i1 %cmp.not.i.i148.i.i, label %_ZL12parse_DIMACSP8_IO_FILER6Solver.exit, label %for.cond.preheader.i.i151.i.i

for.cond.preheader.i.i151.i.i:                    ; preds = %for.end.i.i
  store i32 0, ptr %sz.le.i.i.i.i, align 8, !tbaa !48
  call void @free(ptr noundef nonnull %106) #21
  br label %_ZL12parse_DIMACSP8_IO_FILER6Solver.exit
...
ehcleanup52.i.i:                                  ; preds = %lpad12.i.i, %lpad9.i.i, %lpad.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.i.i, %lpad.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.i.i, %lpad.loopexit.split-lp.loopexit.split-lp.loopexit.i.i, %lpad.loopexit.split-lp.loopexit.i.i, %lpad.loopexit.i.i
  %.pn.pn.i.i = phi { ptr, i32 } [ %84, %lpad12.i.i ], [ %83, %lpad9.i.i ], [ %lpad.loopexit163.i.i, %lpad.loopexit.i.i ], [ %lpad.loopexit165.i.i, %lpad.loopexit.split-lp.loopexit.i.i ], [ %lpad.loopexit168.i.i, %lpad.loopexit.split-lp.loopexit.split-lp.loopexit.i.i ], [ %lpad.loopexit171.i.i, %lpad.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.i.i ], [ %lpad.loopexit.split-lp172.i.i, %lpad.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.i.i ]
  %107 = load ptr, ptr %lits.i.i, align 8, !tbaa !47
  %cmp.not.i.i153.i.i = icmp eq ptr %107, null
  br i1 %cmp.not.i.i153.i.i, label %_ZN3vecI3LitED2Ev.exit158.i.i, label %for.cond.preheader.i.i156.i.i

for.cond.preheader.i.i156.i.i:                    ; preds = %ehcleanup52.i.i
  store i32 0, ptr %sz.le.i.i.i.i, align 8, !tbaa !48
  call void @free(ptr noundef nonnull %107) #21
  br label %_ZN3vecI3LitED2Ev.exit158.i.i

_ZN3vecI3LitED2Ev.exit158.i.i:                    ; preds = %for.cond.preheader.i.i156.i.i, %ehcleanup52.i.i
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %lits.i.i) #21
  br label %ehcleanup270

lpad.i:                                           ; preds = %call.i373.noexc
  %108 = landingpad { ptr, i32 }
          cleanup
  call void @_ZdlPv(ptr noundef nonnull %call.i373374) #27
  br label %ehcleanup270

_ZL12parse_DIMACSP8_IO_FILER6Solver.exit:         ; preds = %for.end.i.i, %for.cond.preheader.i.i151.i.i
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %lits.i.i) #21
  call void @_ZdlPv(ptr noundef nonnull %call.i373374) #27
...
cond.true183:                                     ; preds = %_ZL12parse_DIMACSP8_IO_FILER6Solver.exit
...
cond.end189:                                      ; preds = %_ZL12parse_DIMACSP8_IO_FILER6Solver.exit, %cond.true183
  %cond190 = phi ptr [ %call187, %cond.true183 ], [ null, %_ZL12parse_DIMACSP8_IO_FILER6Solver.exit ]
...
if.then193:                                       ; preds = %invoke.cont191
  ...
  %112 = call i64 @fwrite(ptr nonnull @.str.41, i64 27, i64 1, ptr %111) #22
...
if.end209:                                        ; preds = %invoke.cont191
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %tmp.i) #21
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %tmp.i, i8 0, i64 16, i1 false)
  %call.i375 = invoke noundef zeroext i1 @_ZN6Solver5solveERK3vecI3LitE(ptr noundef nonnull align 8 dereferenceable(536) %S, ptr noundef nonnull align 8 dereferenceable(16) %tmp.i)
          to label %invoke.cont.i unwind label %lpad.i377

invoke.cont.i:                                    ; preds = %if.end209
  %116 = load ptr, ptr %tmp.i, align 8, !tbaa !47
  %cmp.not.i.i.i376 = icmp eq ptr %116, null
  br i1 %cmp.not.i.i.i376, label %_ZN6Solver5solveEv.exit, label %for.cond.preheader.i.i.i

for.cond.preheader.i.i.i:                         ; preds = %invoke.cont.i
  %sz.le.i.i.i = getelementptr inbounds %class.vec.0, ptr %tmp.i, i64 0, i32 1
  store i32 0, ptr %sz.le.i.i.i, align 8, !tbaa !48
  call void @free(ptr noundef nonnull %116) #21
  br label %_ZN6Solver5solveEv.exit

lpad.i377:                                        ; preds = %if.end209
  %117 = landingpad { ptr, i32 }
          cleanup
  %118 = load ptr, ptr %tmp.i, align 8, !tbaa !47
  %cmp.not.i.i3.i = icmp eq ptr %118, null
  br i1 %cmp.not.i.i3.i, label %_ZN3vecI3LitED2Ev.exit7.i, label %for.cond.preheader.i.i6.i

for.cond.preheader.i.i6.i:                        ; preds = %lpad.i377
  %sz.le.i.i4.i = getelementptr inbounds %class.vec.0, ptr %tmp.i, i64 0, i32 1
  store i32 0, ptr %sz.le.i.i4.i, align 8, !tbaa !48
  call void @free(ptr noundef nonnull %118) #21
  br label %_ZN3vecI3LitED2Ev.exit7.i

_ZN3vecI3LitED2Ev.exit7.i:                        ; preds = %for.cond.preheader.i.i6.i, %lpad.i377
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %tmp.i) #21
  br label %ehcleanup270

_ZN6Solver5solveEv.exit:                          ; preds = %invoke.cont.i, %for.cond.preheader.i.i.i
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %tmp.i) #21
...
invoke.cont213:                                   ; preds = %_ZN6Solver5solveEv.exit
  %119 = load ptr, ptr @stdout, align 8, !tbaa !5
  %call215 = call i32 @fflush(ptr noundef %119)
  %120 = load ptr, ptr @stderr, align 8, !tbaa !5
  %fputc = call i32 @fputc(i32 10, ptr %120)
  %121 = load ptr, ptr @stderr, align 8, !tbaa !5
  %call219 = call i32 @fflush(ptr noundef %121)
  %cond221 = select i1 %call.i375, ptr @.str.44, ptr @.str.43
...
if.then225:                                       ; preds = %invoke.cont213
  br i1 %call.i375, label %if.then227, label %if.end263

if.then227:                                       ; preds = %if.then225
  %122 = call i64 @fwrite(ptr nonnull @.str.45, i64 4, i64 1, ptr nonnull %cond190)
  %123 = load i32, ptr %sz.i.i.i.i.i, align 8, !tbaa !49
  %cmp235414 = icmp sgt i32 %123, 0
  br i1 %cmp235414, label %for.body236, label %if.end263

lpad210:                                          ; preds = %_ZN6Solver5solveEv.exit
  %124 = landingpad { ptr, i32 }
          cleanup
  br label %ehcleanup270

for.body236:                                      ; preds = %if.then227, %for.inc255
  %125 = phi i32 [ %130, %for.inc255 ], [ %123, %if.then227 ]
  %indvars.iv429 = phi i64 [ %indvars.iv.next430.pre-phi, %for.inc255 ], [ 0, %if.then227 ]
  %126 = load ptr, ptr %S, align 8, !tbaa !55
  %arrayidx.i = getelementptr inbounds %class.lbool, ptr %126, i64 %indvars.iv429
  %127 = load i8, ptr %arrayidx.i, align 1, !tbaa !56
  %cmp.i379.not = icmp eq i8 %127, 0
  br i1 %cmp.i379.not, label %for.body236.for.inc255_crit_edge, label %if.then241

for.body236.for.inc255_crit_edge:                 ; preds = %for.body236
  %.pre433 = add nuw nsw i64 %indvars.iv429, 1
  br label %for.inc255

if.then241:                                       ; preds = %for.body236
  %cmp242 = icmp eq i64 %indvars.iv429, 0
  %cond243 = select i1 %cmp242, ptr @.str.47, ptr @.str.48
  %cmp.i382 = icmp eq i8 %127, 1
  %cond251 = select i1 %cmp.i382, ptr @.str.47, ptr @.str.31
  %128 = add nuw nsw i64 %indvars.iv429, 1
  %129 = trunc i64 %128 to i32
  %call253 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef nonnull %cond190, ptr noundef nonnull @.str.46, ptr noundef nonnull %cond243, ptr noundef nonnull %cond251, i32 noundef %129)
  %.pre = load i32, ptr %sz.i.i.i.i.i, align 8, !tbaa !49
  br label %for.inc255

for.inc255:                                       ; preds = %for.body236.for.inc255_crit_edge, %if.then241
  %indvars.iv.next430.pre-phi = phi i64 [ %.pre433, %for.body236.for.inc255_crit_edge ], [ %128, %if.then241 ]
  %130 = phi i32 [ %125, %for.body236.for.inc255_crit_edge ], [ %.pre, %if.then241 ]
  %131 = sext i32 %130 to i64
  %cmp235 = icmp slt i64 %indvars.iv.next430.pre-phi, %131
...
if.end263:                                        ; preds = %for.inc255, %if.then225, %if.then227
  ...
  %132 = call i64 @fwrite(ptr nonnull %.str.42.sink, i64 %.sink, i64 1, ptr nonnull %cond190)
  %call265 = call i32 @fclose(ptr noundef nonnull %cond190)
  br label %if.end266

if.end266:                                        ; preds = %if.end263, %invoke.cont213
  %cond268 = select i1 %call.i375, i32 10, i32 20
  call void @exit(i32 noundef %cond268) #24
  unreachable

ehcleanup270:                                     ; preds = %lpad185, %lpad210, %_ZN3vecI3LitED2Ev.exit7.i, %_ZN3vecI3LitED2Ev.exit158.i.i, %lpad.i, %lpad149
  %eh.lpad-body378.pn.pn = phi { ptr, i32 } [ %38, %lpad149 ], [ %.pn.pn.i.i, %_ZN3vecI3LitED2Ev.exit158.i.i ], [ %108, %lpad.i ], [ %115, %lpad185 ], [ %124, %lpad210 ], [ %117, %_ZN3vecI3LitED2Ev.exit7.i ]
  call void @llvm.lifetime.end.p0(i64 2, ptr nonnull %newcw) #21
  call void @llvm.lifetime.end.p0(i64 2, ptr nonnull %oldcw) #21
  call void @_ZN6SolverD1Ev(ptr noundef nonnull align 8 dereferenceable(536) %S) #21
  call void @llvm.lifetime.end.p0(i64 536, ptr nonnull %S) #21
  resume { ptr, i32 } %eh.lpad-body378.pn.pn
}
...
define internal fastcc noundef i32 @_ZL8parseIntI12StreamBufferEiRT_(ptr nocapture noundef nonnull align 8 dereferenceable(1048592) %in) unnamed_addr #15 {
entry:
...
if.then.i.i.i:                                    ; preds = %while.body.i
  ...
  %call.i.i.i = tail call i32 @fileno(ptr noundef %5) #21
...
if.end4.sink.split:                               ; preds = %if.then3, %if.then
  %cond.i121.ph = phi i1 [ true, %if.then ], [ false, %if.then3 ]
  store i32 0, ptr %pos.i.i, align 8, !tbaa !44
  %11 = load ptr, ptr %in, align 8, !tbaa !41
  %call.i.i = tail call i32 @fileno(ptr noundef %11) #21
  ...
  %conv.i.i53.sink = trunc i64 %call3.i.i to i32
  store i32 %conv.i.i53.sink, ptr %size.i.i, align 4, !tbaa !43
  br label %if.end4
...
if.end4:                                          ; preds = %if.end4.sink.split, %_ZN12StreamBufferdeEv.exit, %_ZL14skipWhitespaceI12StreamBufferEvRT_.exit, %if.then3, %if.then
  %12 = phi i32 [ %8, %if.then3 ], [ %8, %if.then ], [ %8, %_ZL14skipWhitespaceI12StreamBufferEvRT_.exit ], [ %8, %_ZN12StreamBufferdeEv.exit ], [ %conv.i.i53.sink, %if.end4.sink.split ]
  %cond.i121 = phi i1 [ false, %if.then3 ], [ true, %if.then ], [ false, %_ZL14skipWhitespaceI12StreamBufferEvRT_.exit ], [ false, %_ZN12StreamBufferdeEv.exit ], [ %cond.i121.ph, %if.end4.sink.split ]
  %13 = load i32, ptr %pos.i.i, align 8, !tbaa !44
  %cmp.not.i58 = icmp slt i32 %13, %12
  br i1 %cmp.not.i58, label %cond.false.i62, label %if.then9

cond.false.i62:                                   ; preds = %if.end4
  ...
  br i1 %or.cond, label %if.then9, label %_ZN12StreamBufferdeEv.exit91.lr.ph

_ZN12StreamBufferdeEv.exit91.lr.ph:               ; preds = %cond.false.i62
  %buf.i.i115 = getelementptr inbounds %class.StreamBuffer, ptr %in, i64 0, i32 1
  br label %_ZN12StreamBufferdeEv.exit91

if.then9:                                         ; preds = %if.end4, %cond.false.i62
  %16 = load ptr, ptr @stdout, align 8, !tbaa !5
...
_ZN12StreamBufferdeEv.exit82:                     ; preds = %if.then9, %cond.false.i80
  ...
  %call12 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %17, ptr noundef nonnull @.str.55, i32 noundef %cond.i81) #22
  %21 = load ptr, ptr @stderr, align 8, !tbaa !5
...
_ZN12StreamBufferdeEv.exit91:                     ; preds = %_ZN12StreamBufferdeEv.exit91.lr.ph, %_ZN12StreamBufferppEv.exit119
  ...
  %val.0128 = phi i32 [ 0, %_ZN12StreamBufferdeEv.exit91.lr.ph ], [ %add, %_ZN12StreamBufferppEv.exit119 ]
  ...
  %25 = add i8 %24, -48
  %or.cond131 = icmp ult i8 %25, 10
  br i1 %or.cond131, label %_ZN12StreamBufferdeEv.exit109, label %while.end

_ZN12StreamBufferdeEv.exit109:                    ; preds = %_ZN12StreamBufferdeEv.exit91
  %mul = mul nsw i32 %val.0128, 10
...
if.then.i.i118:                                   ; preds = %_ZN12StreamBufferdeEv.exit109
  ...
  %call.i.i114 = tail call i32 @fileno(ptr noundef %26) #21
...
while.end:                                        ; preds = %_ZN12StreamBufferdeEv.exit91, %_ZN12StreamBufferppEv.exit119
  %val.0.lcssa.ph = phi i32 [ %val.0128, %_ZN12StreamBufferdeEv.exit91 ], [ %add, %_ZN12StreamBufferppEv.exit119 ]
  %sub20 = sub nsw i32 0, %val.0.lcssa.ph
  %cond = select i1 %cond.i121, i32 %sub20, i32 %val.0.lcssa.ph
  ret i32 %cond
}
