...
if.end.i.i:                                       ; preds = %call.i.i32.i.noexc
  ...
  %call.i35.i = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %14) #13
          to label %invoke.cont.i unwind label %_ZN11CStringBaseIwED2Ev.exit.i, !noalias !38
...
ehcleanup:                                        ; preds = %delete.notnull.i202, %lpad13, %lpad11, %_ZN11CStringBaseIwED2Ev.exit.i
  %.pn430 = phi { ptr, i32 } [ %44, %lpad11 ], [ %33, %_ZN11CStringBaseIwED2Ev.exit.i ], [ %45, %lpad13 ], [ %45, %delete.notnull.i202 ]
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %ref.tmp) #11
...
if.end.i.i305:                                    ; preds = %call.i.i32.i.noexc321
  ...
  %call.i35.i304 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %53) #13
          to label %invoke.cont.i307 unwind label %_ZN11CStringBaseIwED2Ev.exit.i313, !noalias !47
...
_ZN11CStringBaseIwED2Ev.exit.i313:                ; preds = %if.end.i.i305
...
ehcleanup42:                                      ; preds = %delete.notnull.i220, %lpad38, %lpad36, %_ZN11CStringBaseIwED2Ev.exit.i313
  %.pn428 = phi { ptr, i32 } [ %86, %lpad36 ], [ %72, %_ZN11CStringBaseIwED2Ev.exit.i313 ], [ %87, %lpad38 ], [ %87, %delete.notnull.i220 ]
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %ref.tmp35) #11
...
if.end.i.i335:                                    ; preds = %call.i.i32.i.noexc351
  ...
  %call.i35.i334 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %95) #13
          to label %invoke.cont.i337 unwind label %_ZN11CStringBaseIwED2Ev.exit.i343, !noalias !53
...
_ZN11CStringBaseIwED2Ev.exit.i343:                ; preds = %if.end.i.i335
...
ehcleanup73:                                      ; preds = %delete.notnull.i240, %lpad69, %lpad67, %_ZN11CStringBaseIwED2Ev.exit.i343
  %.pn426 = phi { ptr, i32 } [ %128, %lpad67 ], [ %114, %_ZN11CStringBaseIwED2Ev.exit.i343 ], [ %129, %lpad69 ], [ %129, %delete.notnull.i240 ]
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %ref.tmp66) #11
...
if.end.i.i365:                                    ; preds = %call.i.i32.i.noexc381
  ...
  %call.i35.i364 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %137) #13
          to label %invoke.cont.i367 unwind label %_ZN11CStringBaseIwED2Ev.exit.i373, !noalias !59
...
_ZN11CStringBaseIwED2Ev.exit.i373:                ; preds = %if.end.i.i365
...
ehcleanup104:                                     ; preds = %delete.notnull.i260, %lpad100, %lpad98, %_ZN11CStringBaseIwED2Ev.exit.i373
  %.pn424 = phi { ptr, i32 } [ %170, %lpad98 ], [ %156, %_ZN11CStringBaseIwED2Ev.exit.i373 ], [ %171, %lpad100 ], [ %171, %delete.notnull.i260 ]
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %ref.tmp97) #11
...
if.end.i.i395:                                    ; preds = %call.i.i32.i.noexc411
  ...
  %call.i35.i394 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %179) #13
          to label %invoke.cont.i397 unwind label %_ZN11CStringBaseIwED2Ev.exit.i403, !noalias !65
...
_ZN11CStringBaseIwED2Ev.exit.i403:                ; preds = %if.end.i.i395
...
ehcleanup135:                                     ; preds = %delete.notnull.i280, %lpad131, %lpad129, %_ZN11CStringBaseIwED2Ev.exit.i403
  %.pn422 = phi { ptr, i32 } [ %212, %lpad129 ], [ %198, %_ZN11CStringBaseIwED2Ev.exit.i403 ], [ %213, %lpad131 ], [ %213, %delete.notnull.i280 ]
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %ref.tmp128) #11
