...
ehcleanup:                                        ; preds = %if.then.i.i211, %lpad19, %lpad15
  %.pn270 = phi { ptr, i32 } [ %20, %lpad15 ], [ %21, %lpad19 ], [ %21, %if.then.i.i211 ]
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %big_o) #20
...
if.end43:                                         ; preds = %if.else37.invoke, %if.then29, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit209
  ...
  %or.cond275 = select i1 %tobool45.not, i1 %tobool47.not, i1 false
  br i1 %or.cond275, label %if.then48, label %if.end50
...
if.end50:                                         ; preds = %if.then48, %if.end43
  ...
  %cmp.i214.not279 = icmp eq ptr %40, %add.ptr.i.i
  br i1 %cmp.i214.not279, label %for.cond.cleanup, label %for.body.lr.ph
...
for.body.lr.ph:                                   ; preds = %if.end50
  ...
  %_M_string_length.i61.i235 = getelementptr inbounds %"class.std::__cxx11::basic_string", ptr %ref.tmp77, i64 0, i32 1
...
for.cond.cleanup:                                 ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit249, %if.end50
...
for.body:                                         ; preds = %for.body.lr.ph, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit249
  %__begin1.sroa.0.0280 = phi ptr [ %40, %for.body.lr.ph ], [ %call.i, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit249 ]
  %_M_storage.i.i = getelementptr inbounds %"struct.std::_Rb_tree_node", ptr %__begin1.sroa.0.0280, i64 0, i32 1
  %_M_string_length.i = getelementptr inbounds %"struct.std::_Rb_tree_node", ptr %__begin1.sroa.0.0280, i64 0, i32 1, i32 0, i64 8
  ...
  %or.cond276 = select i1 %cmp65, i1 %cmp68, i1 false
  %second = getelementptr inbounds %"struct.std::_Rb_tree_node", ptr %__begin1.sroa.0.0280, i64 0, i32 1, i32 0, i64 32
  br i1 %or.cond276, label %if.then69, label %if.else76
...
if.then19.i:                                      ; preds = %if.then15.i
  ...
  br i1 %cond.i, label %if.then.i.i218, label %if.end.i.i.i

if.then.i.i218:                                   ; preds = %if.then19.i
...
if.else.i:                                        ; preds = %invoke.cont73
  ...
  %57 = load <2 x i64>, ptr %_M_string_length.i61.i, align 8, !tbaa !59
  store <2 x i64> %57, ptr %_M_string_length.i.i.i, align 8, !tbaa !59
...
if.then36.i:                                      ; preds = %if.else.i
  ...
  store i64 %56, ptr %43, align 8, !tbaa !59
  br label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSEOS4_.exit
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSEOS4_.exit: ; preds = %if.end24.i, %if.then36.i, %if.else37.i
  %58 = phi ptr [ %55, %if.then36.i ], [ %43, %if.else37.i ], [ %.pre.i, %if.end24.i ]
  store i64 0, ptr %_M_string_length.i61.i, align 8, !tbaa !34
  store i8 0, ptr %58, align 1, !tbaa !59
  %59 = load ptr, ptr %ref.tmp70, align 8, !tbaa !31
  %cmp.i.i.i219 = icmp eq ptr %59, %43
...
if.else76:                                        ; preds = %for.body
  ...
  %61 = load double, ptr %second, align 8, !tbaa !60
  %oneK = getelementptr inbounds %"struct.std::_Rb_tree_node", ptr %__begin1.sroa.0.0280, i64 0, i32 1, i32 0, i64 44
  %62 = load i32, ptr %oneK, align 4, !tbaa !65
  %conv = uitofp i32 %62 to double
  invoke void @_ZN9benchmark19HumanReadableNumberB5cxx11Edd(ptr nonnull sret(%"class.std::__cxx11::basic_string") align 8 %ref.tmp77, double noundef %61, double noundef %conv)
          to label %invoke.cont82 unwind label %lpad81

invoke.cont82:                                    ; preds = %if.else76
  %63 = load ptr, ptr %ref.tmp77, align 8, !tbaa !31
  %cmp.i56.i222 = icmp eq ptr %63, %42
  br i1 %cmp.i56.i222, label %if.then15.i223, label %if.else.i239

if.then15.i223:                                   ; preds = %invoke.cont82
  %64 = load i64, ptr %_M_string_length.i61.i235, align 8, !tbaa !34
  %tobool18.not.i225 = icmp eq i64 %64, 0
  br i1 %tobool18.not.i225, label %if.end24.i233, label %if.then19.i227

if.then19.i227:                                   ; preds = %if.then15.i223
  %65 = load ptr, ptr %s, align 8, !tbaa !31
  %cond.i226 = icmp eq i64 %64, 1
  br i1 %cond.i226, label %if.then.i.i228, label %if.end.i.i.i229

if.then.i.i228:                                   ; preds = %if.then19.i227
  %66 = load i8, ptr %42, align 8, !tbaa !59
  store i8 %66, ptr %65, align 1, !tbaa !59
  br label %if.end24.i233

if.end.i.i.i229:                                  ; preds = %if.then19.i227
  call void @llvm.memcpy.p0.p0.i64(ptr align 1 %65, ptr nonnull align 8 %42, i64 %64, i1 false)
  br label %if.end24.i233

if.end24.i233:                                    ; preds = %if.end.i.i.i229, %if.then.i.i228, %if.then15.i223
  %67 = load i64, ptr %_M_string_length.i61.i235, align 8, !tbaa !34
  store i64 %67, ptr %_M_string_length.i.i.i, align 8, !tbaa !34
  %68 = load ptr, ptr %s, align 8, !tbaa !31
  %arrayidx.i.i231 = getelementptr inbounds i8, ptr %68, i64 %67
  store i8 0, ptr %arrayidx.i.i231, align 1, !tbaa !59
  %.pre.i232 = load ptr, ptr %ref.tmp77, align 8, !tbaa !31
  br label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSEOS4_.exit243

if.else.i239:                                     ; preds = %invoke.cont82
  %69 = load ptr, ptr %s, align 8, !tbaa !31
  %cmp.i60.i234 = icmp eq ptr %69, %41
  %70 = load i64, ptr %41, align 8
  store ptr %63, ptr %s, align 8, !tbaa !31
  %71 = load <2 x i64>, ptr %_M_string_length.i61.i235, align 8, !tbaa !59
  store <2 x i64> %71, ptr %_M_string_length.i.i.i, align 8, !tbaa !59
  %tobool35.not63.i237 = icmp eq ptr %69, null
  %tobool35.not.i238 = or i1 %cmp.i60.i234, %tobool35.not63.i237
  br i1 %tobool35.not.i238, label %if.else37.i241, label %if.then36.i240

if.then36.i240:                                   ; preds = %if.else.i239
  store ptr %69, ptr %ref.tmp77, align 8, !tbaa !31
  store i64 %70, ptr %42, align 8, !tbaa !59
  br label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSEOS4_.exit243

if.else37.i241:                                   ; preds = %if.else.i239
  store ptr %42, ptr %ref.tmp77, align 8, !tbaa !31
  br label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSEOS4_.exit243

_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSEOS4_.exit243: ; preds = %if.end24.i233, %if.then36.i240, %if.else37.i241
  %72 = phi ptr [ %69, %if.then36.i240 ], [ %42, %if.else37.i241 ], [ %.pre.i232, %if.end24.i233 ]
  store i64 0, ptr %_M_string_length.i61.i235, align 8, !tbaa !34
  store i8 0, ptr %72, align 1, !tbaa !59
  %73 = load ptr, ptr %ref.tmp77, align 8, !tbaa !31
  %cmp.i.i.i244 = icmp eq ptr %73, %42
  br i1 %cmp.i.i.i244, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit246, label %if.then.i.i245

if.then.i.i245:                                   ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSEOS4_.exit243
  call void @_ZdlPv(ptr noundef %73) #22
  br label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit246

_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit246: ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSEOS4_.exit243, %if.then.i.i245
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %ref.tmp77) #20
  %flags = getelementptr inbounds %"struct.std::_Rb_tree_node", ptr %__begin1.sroa.0.0280, i64 0, i32 1, i32 0, i64 40
  %74 = load i32, ptr %flags, align 8, !tbaa !66
  %and86 = and i32 %74, 1
  %tobool87.not = icmp eq i32 %and86, 0
  br i1 %tobool87.not, label %if.end95, label %if.then88

if.then88:                                        ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit246
  %tobool92.not = icmp sgt i32 %74, -1
...
if.end95:                                         ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit246, %if.then88, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit221
  %unit.0 = phi ptr [ @.str.13, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit221 ], [ %cond93, %if.then88 ], [ @.str.16, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit246 ]
  %76 = load i32, ptr %output_options_, align 8, !tbaa !30
  %and97 = and i32 %76, 2
...
if.then99:                                        ; preds = %if.end95
  ...
  %77 = load ptr, ptr %s, align 8, !tbaa !31
  invoke void (ptr, i32, ptr, ...) %cond(ptr noundef nonnull align 8 dereferenceable(8) %0, i32 noundef 0, ptr noundef nonnull @.str.20, i64 noundef %sub, ptr noundef %77, ptr noundef nonnull %unit.0)
...
if.else104:                                       ; preds = %if.end95
  %79 = load ptr, ptr %_M_storage.i.i, align 8, !tbaa !31
  %80 = load ptr, ptr %s, align 8, !tbaa !31
  invoke void (ptr, i32, ptr, ...) %cond(ptr noundef nonnull align 8 dereferenceable(8) %0, i32 noundef 0, ptr noundef nonnull @.str.21, ptr noundef %79, ptr noundef %80, ptr noundef nonnull %unit.0)
          to label %if.end109 unwind label %lpad102, !callees !50

if.end109:                                        ; preds = %if.else104, %if.then99
  %81 = load ptr, ptr %s, align 8, !tbaa !31
  %cmp.i.i.i247 = icmp eq ptr %81, %41
  br i1 %cmp.i.i.i247, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit249, label %if.then.i.i248

if.then.i.i248:                                   ; preds = %if.end109
  call void @_ZdlPv(ptr noundef %81) #22
  br label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit249

_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit249: ; preds = %if.end109, %if.then.i.i248
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %s) #20
  %call.i = call noundef ptr @_ZSt18_Rb_tree_incrementPKSt18_Rb_tree_node_base(ptr noundef nonnull %__begin1.sroa.0.0280) #23
...
ehcleanup110:                                     ; preds = %lpad102, %lpad81, %lpad72
  %.pn = phi { ptr, i32 } [ %78, %lpad102 ], [ %60, %lpad72 ], [ %75, %lpad81 ]
  %82 = load ptr, ptr %s, align 8, !tbaa !31
  %cmp.i.i.i250 = icmp eq ptr %82, %41
  br i1 %cmp.i.i.i250, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit252, label %if.then.i.i251

if.then.i.i251:                                   ; preds = %ehcleanup110
  call void @_ZdlPv(ptr noundef %82) #22
  br label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit252

_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit252: ; preds = %ehcleanup110, %if.then.i.i251
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %s) #20
  br label %ehcleanup126
...
if.then120:                                       ; preds = %for.cond.cleanup
  ...
  %83 = load ptr, ptr %report_label, align 8, !tbaa !31
  invoke void (ptr, i32, ptr, ...) %cond(ptr noundef nonnull align 8 dereferenceable(8) %0, i32 noundef 0, ptr noundef nonnull @.str.22, ptr noundef %83)
...
invoke.cont125:                                   ; preds = %if.end124
  %84 = load ptr, ptr %cpu_time_str, align 8, !tbaa !31
  %85 = getelementptr inbounds %"class.std::__cxx11::basic_string", ptr %cpu_time_str, i64 0, i32 2
...
if.then.i.i254:                                   ; preds = %invoke.cont125
  call void @_ZdlPv(ptr noundef %84) #22
  br label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit255

_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit255: ; preds = %invoke.cont125, %if.then.i.i254
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %cpu_time_str) #20
  %86 = load ptr, ptr %real_time_str, align 8, !tbaa !31
  %87 = getelementptr inbounds %"class.std::__cxx11::basic_string", ptr %real_time_str, i64 0, i32 2
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit258: ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit255, %if.then.i.i257
...
ehcleanup126:                                     ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit252, %lpad30, %lpad25, %ehcleanup
  %.pn.pn = phi { ptr, i32 } [ %.pn, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit252 ], [ %25, %lpad25 ], [ %.pn270, %ehcleanup ], [ %32, %lpad30 ]
  %88 = load ptr, ptr %cpu_time_str, align 8, !tbaa !31
  %89 = getelementptr inbounds %"class.std::__cxx11::basic_string", ptr %cpu_time_str, i64 0, i32 2
  %cmp.i.i.i259 = icmp eq ptr %88, %89
  br i1 %cmp.i.i.i259, label %ehcleanup127, label %if.then.i.i260

if.then.i.i260:                                   ; preds = %ehcleanup126
  call void @_ZdlPv(ptr noundef %88) #22
  br label %ehcleanup127

ehcleanup127:                                     ; preds = %if.then.i.i260, %ehcleanup126, %lpad10
  %.pn.pn.pn = phi { ptr, i32 } [ %19, %lpad10 ], [ %.pn.pn, %ehcleanup126 ], [ %.pn.pn, %if.then.i.i260 ]
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %cpu_time_str) #20
  %90 = load ptr, ptr %real_time_str, align 8, !tbaa !31
  %91 = getelementptr inbounds %"class.std::__cxx11::basic_string", ptr %real_time_str, i64 0, i32 2
  %cmp.i.i.i262 = icmp eq ptr %90, %91
  br i1 %cmp.i.i.i262, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit264, label %if.then.i.i263

if.then.i.i263:                                   ; preds = %ehcleanup127
  call void @_ZdlPv(ptr noundef %90) #22
  br label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit264

_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit264: ; preds = %ehcleanup127, %if.then.i.i263
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %real_time_str) #20
  br label %ehcleanup132

ehcleanup132:                                     ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit264, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit198
  %.pn.pn.pn.pn = phi { ptr, i32 } [ %.pn.pn.pn, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit264 ], [ %11, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit198 ]
