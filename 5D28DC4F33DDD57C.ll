...
entry:
  ...
  %and = and i32 %1, 8
  store i32 %and, ptr %0, align 4, !tbaa !9
  ...
  %spec.store.select = select i1 %or.cond, i8 %3, i8 0
  store i8 %spec.store.select, ptr @b, align 1
...
entry:
  ...
  store ptr %temp_1, ptr @a, align 8, !tbaa !5
  store i32 8, ptr %temp_1, align 4, !tbaa !9
  store ptr @b, ptr @p, align 8, !tbaa !5
