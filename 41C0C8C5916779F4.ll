...
define dso_local i32 @f(i32 %x, i32 %y, i32 %z, i32 %a, i32 %u.coerce) local_unnamed_addr #0 {
entry:
  %0 = trunc i32 %u.coerce to i16
  %cmp = icmp slt i16 %0, 1
  %conv1 = zext i1 %cmp to i32
  %conv2 = and i32 %u.coerce, 65535
...
entry:
  %call = tail call i32 @f(i32 poison, i32 poison, i32 poison, i32 poison, i32 65535), !range !5
  %cmp.not = icmp eq i32 %call, 65536
