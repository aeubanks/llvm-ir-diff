; ModuleID = '/usr/local/google/home/aeubanks/repos/test-suite/Bitcode/simd_ops/x86_tests/test_op_paddb_42.bc'
...
@str.11 = private constant [12 x i8] c"op_paddb_42\00", align 32
...
define i32 @__test_op(ptr noalias nocapture readnone %in_f32.buffer, ptr noalias nocapture readnone %in_f64.buffer, ptr noalias nocapture readnone %in_i8.buffer, ptr noalias nocapture readonly %in_u8.buffer, ptr noalias nocapture readnone %in_i16.buffer, ptr noalias nocapture readnone %in_u16.buffer, ptr noalias nocapture readnone %in_i32.buffer, ptr noalias nocapture readnone %in_u32.buffer, ptr noalias nocapture readnone %in_i64.buffer, ptr noalias nocapture readnone %in_u64.buffer, ptr noalias nocapture readonly %op_paddb_42.buffer) local_unnamed_addr #0 {
"produce op_paddb_42":
  %buf_extent168 = getelementptr inbounds %struct.buffer_t, ptr %op_paddb_42.buffer, i64 0, i32 2, i64 1
  %op_paddb_42.extent.1 = load i32, ptr %buf_extent168, align 4
  %buf_min176 = getelementptr inbounds %struct.buffer_t, ptr %op_paddb_42.buffer, i64 0, i32 4, i64 1
  %op_paddb_42.min.1 = load i32, ptr %buf_min176, align 4
  %0 = add nsw i32 %op_paddb_42.min.1, %op_paddb_42.extent.1
  %1 = icmp sgt i32 %op_paddb_42.extent.1, 0
  br i1 %1, label %"for op_paddb_42.s0.y.preheader", label %destructor_block, !prof !4

"for op_paddb_42.s0.y.preheader":                 ; preds = %"produce op_paddb_42"
  %buf_host44 = getelementptr inbounds %struct.buffer_t, ptr %in_u8.buffer, i64 0, i32 1
  %in_u8.host = load ptr, ptr %buf_host44, align 8
  %buf_min175 = getelementptr inbounds %struct.buffer_t, ptr %op_paddb_42.buffer, i64 0, i32 4, i64 0
  %op_paddb_42.min.0 = load i32, ptr %buf_min175, align 4
  %2 = sext i32 %op_paddb_42.min.0 to i64
  %buf_stride172 = getelementptr inbounds %struct.buffer_t, ptr %op_paddb_42.buffer, i64 0, i32 3, i64 1
  %op_paddb_42.stride.1 = load i32, ptr %buf_stride172, align 4
  %3 = sext i32 %op_paddb_42.stride.1 to i64
  %buf_host163 = getelementptr inbounds %struct.buffer_t, ptr %op_paddb_42.buffer, i64 0, i32 1
  %op_paddb_42.host = load ptr, ptr %buf_host163, align 8
  %4 = shl nsw i64 %2, 3
  %5 = sub nsw i64 96, %4
  %scevgep = getelementptr i8, ptr %op_paddb_42.host, i64 %5
  %6 = shl nsw i64 %3, 3
  %sunkaddr = ptrtoint ptr %in_u8.host to i64
  %sunkaddr207 = add i64 %sunkaddr, 16
  %sunkaddr208 = inttoptr i64 %sunkaddr207 to ptr
  %7 = load <16 x i8>, ptr %sunkaddr208, align 16, !tbaa !5
  %8 = load <16 x i8>, ptr %in_u8.host, align 16, !tbaa !5
  %9 = add <16 x i8> %8, %7
  ...
  %sunkaddr207.1 = add i64 %sunkaddr, 32
  %sunkaddr208.1 = inttoptr i64 %sunkaddr207.1 to ptr
  %15 = load <16 x i8>, ptr %sunkaddr208.1, align 16, !tbaa !5
  %16 = add <16 x i8> %7, %15
  ...
  %sunkaddr207.3 = add i64 %sunkaddr, 64
  %sunkaddr208.3 = inttoptr i64 %sunkaddr207.3 to ptr
  %30 = load <16 x i8>, ptr %sunkaddr208.3, align 16, !tbaa !5
  ...
  %sunkaddr207.5 = add i64 %sunkaddr, 96
  %sunkaddr208.5 = inttoptr i64 %sunkaddr207.5 to ptr
  %46 = load <16 x i8>, ptr %sunkaddr208.5, align 16, !tbaa !5
  ...
  %sunkaddr207.6 = add i64 %sunkaddr, 112
  %sunkaddr208.6 = inttoptr i64 %sunkaddr207.6 to ptr
  %54 = load <16 x i8>, ptr %sunkaddr208.6, align 16, !tbaa !5
  ...
  %sunkaddr207.9 = add i64 %sunkaddr, 160
  ...
  %sunkaddr207.10 = add i64 %sunkaddr, 176
  ...
  %sunkaddr207.11 = add i64 %sunkaddr, 192
  ...
  %sunkaddr207.12 = add i64 %sunkaddr, 208
  ...
  %sunkaddr207.13 = add i64 %sunkaddr, 224
  ...
  %sunkaddr207.14 = add i64 %sunkaddr, 240
  ...
  %sunkaddr207.15 = add i64 %sunkaddr, 256
  %sunkaddr208.15 = inttoptr i64 %sunkaddr207.15 to ptr
  %sunkaddr211.15 = inttoptr i64 %sunkaddr206.15 to ptr
  br label %"for op_paddb_42.s0.x.x.preheader"

"for op_paddb_42.s0.x.x.preheader":               ; preds = %"for op_paddb_42.s0.x.x.preheader", %"for op_paddb_42.s0.y.preheader"
  %lsr.iv180 = phi ptr [ %scevgep, %"for op_paddb_42.s0.y.preheader" ], [ %scevgep182, %"for op_paddb_42.s0.x.x.preheader" ]
  %op_paddb_42.s0.y = phi i32 [ %op_paddb_42.min.1, %"for op_paddb_42.s0.y.preheader" ], [ %134, %"for op_paddb_42.s0.x.x.preheader" ]
  ...
  %78 = load <16 x i8>, ptr %sunkaddr208.9, align 16, !tbaa !5
  %79 = load <16 x i8>, ptr %sunkaddr211.9, align 16, !tbaa !5
  %80 = add <16 x i8> %79, %78
  ...
  %86 = load <16 x i8>, ptr %sunkaddr208.10, align 16, !tbaa !5
  %87 = load <16 x i8>, ptr %sunkaddr211.10, align 16, !tbaa !5
  %88 = add <16 x i8> %87, %86
  ...
  %94 = load <16 x i8>, ptr %sunkaddr208.11, align 16, !tbaa !5
  %95 = load <16 x i8>, ptr %sunkaddr211.11, align 16, !tbaa !5
  %96 = add <16 x i8> %95, %94
  ...
  %102 = load <16 x i8>, ptr %sunkaddr208.12, align 16, !tbaa !5
  %103 = load <16 x i8>, ptr %sunkaddr211.12, align 16, !tbaa !5
  %104 = add <16 x i8> %103, %102
  ...
  %110 = load <16 x i8>, ptr %sunkaddr208.13, align 16, !tbaa !5
  %111 = load <16 x i8>, ptr %sunkaddr211.13, align 16, !tbaa !5
  %112 = add <16 x i8> %111, %110
  ...
  %118 = load <16 x i8>, ptr %sunkaddr208.14, align 16, !tbaa !5
  %119 = load <16 x i8>, ptr %sunkaddr211.14, align 16, !tbaa !5
  %120 = add <16 x i8> %119, %118
  ...
  %126 = load <16 x i8>, ptr %sunkaddr208.15, align 16, !tbaa !5
  %127 = load <16 x i8>, ptr %sunkaddr211.15, align 16, !tbaa !5
  %128 = add <16 x i8> %127, %126
  ...
  %134 = add nsw i32 %op_paddb_42.s0.y, 1
  %scevgep182 = getelementptr i1, ptr %lsr.iv180, i64 %6
  %.not2 = icmp eq i32 %134, %0
  br i1 %.not2, label %destructor_block, label %"for op_paddb_42.s0.x.x.preheader"

destructor_block:                                 ; preds = %"for op_paddb_42.s0.x.x.preheader", %"produce op_paddb_42"
  ret i32 0
}

; Function Attrs: nofree norecurse nosync nounwind memory(readwrite, inaccessiblemem: none)
define i32 @test_op(ptr noalias nocapture readnone %in_f32.buffer, ptr noalias nocapture readnone %in_f64.buffer, ptr noalias nocapture readnone %in_i8.buffer, ptr noalias nocapture readonly %in_u8.buffer, ptr noalias nocapture readnone %in_i16.buffer, ptr noalias nocapture readnone %in_u16.buffer, ptr noalias nocapture readnone %in_i32.buffer, ptr noalias nocapture readnone %in_u32.buffer, ptr noalias nocapture readnone %in_i64.buffer, ptr noalias nocapture readnone %in_u64.buffer, ptr noalias nocapture readonly %op_paddb_42.buffer) local_unnamed_addr #1 {
destructor_block:
  %"__test_op_result$2" = tail call i32 @__test_op(ptr poison, ptr poison, ptr poison, ptr %in_u8.buffer, ptr poison, ptr poison, ptr poison, ptr poison, ptr poison, ptr poison, ptr %op_paddb_42.buffer) #3
  ret i32 0
}
