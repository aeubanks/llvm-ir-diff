...
if.end43:                                         ; preds = %if.end33
  ...
  %cmp47.not = icmp eq i32 %or46, 1073742115
...
if.end60:                                         ; preds = %if.end50
  ...
  %cmp64.not = icmp eq i64 %or63, -9223372036835687065
...
if.end77:                                         ; preds = %if.end67
  ...
  %cmp81.not = icmp eq i64 %or80, 5124095577148911
...
if.end94:                                         ; preds = %if.end84
  ...
  %cmp98.not = icmp eq i64 %or97, 1311768467750121216
...
if.end153:                                        ; preds = %if.end143
  ...
  %cmp157.not = icmp eq i32 %or156, 74560
...
if.end170:                                        ; preds = %if.end160
  ...
  %cmp174.not = icmp eq i64 %or173, 4886718336
