...
"for op_pmulhuw_39.s0.x.x":                       ; preds = %"for op_pmulhuw_39.s0.x.x", %"for op_pmulhuw_39.s0.x.x.preheader"
  ...
  %19 = shufflevector <4 x i16> %18, <4 x i16> undef, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 undef, i32 undef, i32 undef, i32 undef>
  ...
  %25 = shufflevector <4 x i16> %24, <4 x i16> undef, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 undef, i32 undef, i32 undef, i32 undef>
  ...
  %31 = shufflevector <4 x i16> %30, <4 x i16> undef, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 undef, i32 undef, i32 undef, i32 undef>
  ...
  %37 = shufflevector <4 x i16> %36, <4 x i16> undef, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 undef, i32 undef, i32 undef, i32 undef>
  ...
  %43 = shufflevector <4 x i16> %42, <4 x i16> undef, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 undef, i32 undef, i32 undef, i32 undef>
  ...
  %49 = shufflevector <4 x i16> %48, <4 x i16> undef, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 undef, i32 undef, i32 undef, i32 undef>
