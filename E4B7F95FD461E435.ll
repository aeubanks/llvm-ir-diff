; ModuleID = '/usr/local/google/home/aeubanks/repos/test-suite/Bitcode/simd_ops/x86_scalar_tests/scalar_test_op_paddsb_50.bc'
...
@str.11 = private constant [20 x i8] c"scalar_op_paddsb_50\00", align 32
...
define i32 @__scalar_test_op(ptr noalias nocapture readnone %in_f32.buffer, ptr noalias nocapture readnone %in_f64.buffer, ptr noalias nocapture readonly %in_i8.buffer, ptr noalias nocapture readnone %in_u8.buffer, ptr noalias nocapture readnone %in_i16.buffer, ptr noalias nocapture readnone %in_u16.buffer, ptr noalias nocapture readnone %in_i32.buffer, ptr noalias nocapture readnone %in_u32.buffer, ptr noalias nocapture readnone %in_i64.buffer, ptr noalias nocapture readnone %in_u64.buffer, ptr noalias nocapture readonly %scalar_op_paddsb_50.buffer) local_unnamed_addr #0 {
"produce scalar_op_paddsb_50":
  %buf_host27 = getelementptr inbounds %struct.buffer_t, ptr %in_i8.buffer, i64 0, i32 1
  %in_i8.host = load ptr, ptr %buf_host27, align 8
  %buf_extent168 = getelementptr inbounds %struct.buffer_t, ptr %scalar_op_paddsb_50.buffer, i64 0, i32 2, i64 1
  %scalar_op_paddsb_50.extent.1 = load i32, ptr %buf_extent168, align 4
  %buf_min176 = getelementptr inbounds %struct.buffer_t, ptr %scalar_op_paddsb_50.buffer, i64 0, i32 4, i64 1
  %scalar_op_paddsb_50.min.1 = load i32, ptr %buf_min176, align 4
  %0 = add nsw i32 %scalar_op_paddsb_50.min.1, %scalar_op_paddsb_50.extent.1
  %1 = icmp sgt i32 %scalar_op_paddsb_50.extent.1, 0
  br i1 %1, label %"for scalar_op_paddsb_50.s0.y.preheader", label %destructor_block, !prof !4

"for scalar_op_paddsb_50.s0.y.preheader":         ; preds = %"produce scalar_op_paddsb_50"
  %buf_min175 = getelementptr inbounds %struct.buffer_t, ptr %scalar_op_paddsb_50.buffer, i64 0, i32 4, i64 0
  %scalar_op_paddsb_50.min.0 = load i32, ptr %buf_min175, align 4
  %2 = sext i32 %scalar_op_paddsb_50.min.0 to i64
  %buf_stride172 = getelementptr inbounds %struct.buffer_t, ptr %scalar_op_paddsb_50.buffer, i64 0, i32 3, i64 1
  %scalar_op_paddsb_50.stride.1 = load i32, ptr %buf_stride172, align 4
  %3 = sext i32 %scalar_op_paddsb_50.stride.1 to i64
  %buf_host163 = getelementptr inbounds %struct.buffer_t, ptr %scalar_op_paddsb_50.buffer, i64 0, i32 1
  %scalar_op_paddsb_50.host = load ptr, ptr %buf_host163, align 8
  %4 = mul nsw i64 %2, -8
  %scevgep = getelementptr i8, ptr %scalar_op_paddsb_50.host, i64 %4
  %5 = shl nsw i64 %3, 3
  br label %vector.ph

vector.ph:                                        ; preds = %"for scalar_op_paddsb_50.s0.y.preheader", %"end for scalar_op_paddsb_50.s0.x"
  %lsr.iv180 = phi ptr [ %scevgep, %"for scalar_op_paddsb_50.s0.y.preheader" ], [ %scevgep182, %"end for scalar_op_paddsb_50.s0.x" ]
  %scalar_op_paddsb_50.s0.y = phi i32 [ %scalar_op_paddsb_50.min.1, %"for scalar_op_paddsb_50.s0.y.preheader" ], [ %47, %"end for scalar_op_paddsb_50.s0.x" ]
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  br i1 %46, label %"end for scalar_op_paddsb_50.s0.x", label %vector.body, !llvm.loop !10

"end for scalar_op_paddsb_50.s0.x":               ; preds = %vector.body
  %47 = add nsw i32 %scalar_op_paddsb_50.s0.y, 1
  %scevgep182 = getelementptr i1, ptr %lsr.iv180, i64 %5
  %.not2 = icmp eq i32 %47, %0
  br i1 %.not2, label %destructor_block, label %vector.ph

destructor_block:                                 ; preds = %"end for scalar_op_paddsb_50.s0.x", %"produce scalar_op_paddsb_50"
  ret i32 0
}

; Function Attrs: nofree nosync nounwind memory(readwrite, inaccessiblemem: none)
define i32 @scalar_test_op(ptr noalias nocapture readnone %in_f32.buffer, ptr noalias nocapture readnone %in_f64.buffer, ptr noalias nocapture readonly %in_i8.buffer, ptr noalias nocapture readnone %in_u8.buffer, ptr noalias nocapture readnone %in_i16.buffer, ptr noalias nocapture readnone %in_u16.buffer, ptr noalias nocapture readnone %in_i32.buffer, ptr noalias nocapture readnone %in_u32.buffer, ptr noalias nocapture readnone %in_i64.buffer, ptr noalias nocapture readnone %in_u64.buffer, ptr noalias nocapture readonly %scalar_op_paddsb_50.buffer) local_unnamed_addr #1 {
destructor_block:
  %"__scalar_test_op_result$3" = tail call i32 @__scalar_test_op(ptr poison, ptr poison, ptr %in_i8.buffer, ptr poison, ptr poison, ptr poison, ptr poison, ptr poison, ptr poison, ptr poison, ptr %scalar_op_paddsb_50.buffer) #4
  ret i32 0
}
