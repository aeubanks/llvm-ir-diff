...
lor.lhs.false.10:                                 ; preds = %lor.lhs.false.9
  %call.10 = call fastcc i16 @next(ptr noundef nonnull %s), !range !11
...
lor.lhs.false.11:                                 ; preds = %lor.lhs.false.10
  %call.11 = call fastcc i16 @next(ptr noundef nonnull %s), !range !11
...
lor.lhs.false.12:                                 ; preds = %lor.lhs.false.11
  %call.12 = call fastcc i16 @next(ptr noundef nonnull %s), !range !11
...
lor.lhs.false.13:                                 ; preds = %lor.lhs.false.12
  %call.13 = call fastcc i16 @next(ptr noundef nonnull %s), !range !11
...
lor.lhs.false.14:                                 ; preds = %lor.lhs.false.13
  %call.14 = call fastcc i16 @next(ptr noundef nonnull %s), !range !11
...
lor.lhs.false.15:                                 ; preds = %lor.lhs.false.14
  %call.15 = call fastcc i16 @next(ptr noundef nonnull %s), !range !11
...
entry:
  ...
  br i1 %cmp.not10, label %cleanup, label %if.then

if.then:                                          ; preds = %entry
  %flag.promoted = load i1, ptr @flag, align 4
  br i1 %flag.promoted, label %if.then1, label %if.end

if.then1:                                         ; preds = %if.then
  store i1 false, ptr @flag, align 4
  tail call fastcc void @fetch(ptr noundef nonnull %p)
  %2 = load i32, ptr %p, align 4, !tbaa !5
  %3 = load i32, ptr %length, align 4, !tbaa !10
...
cleanup:                                          ; preds = %entry, %if.then1, %if.end
  %retval.sroa.0.0 = phi i16 [ -1, %if.end ], [ 0, %if.then1 ], [ 0, %entry ]
