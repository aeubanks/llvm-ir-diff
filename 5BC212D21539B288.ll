...
for.cond.loopexit:                                ; preds = %if.end66.i.us.2, %for.body, %for.cond14.for.inc30_crit_edge.split.us.us.us.2
  %.us-phi222 = phi i32 [ %bitsWritten.0223, %for.cond14.for.inc30_crit_edge.split.us.us.us.2 ], [ %bitsWritten.0223, %for.body ], [ %add28.us.2, %if.end66.i.us.2 ]
...
for.body16.us214:                                 ; preds = %for.cond14.preheader.us.preheader, %if.end66.i.us
  %indvars.iv235 = phi i64 [ %5, %for.cond14.preheader.us.preheader ], [ %indvars.iv.next236, %if.end66.i.us ]
  %bitsWritten.2209.us = phi i32 [ %bitsWritten.0223, %for.cond14.preheader.us.preheader ], [ %add28.us, %if.end66.i.us ]
  %arrayidx20.us = getelementptr inbounds [192 x [3 x i32]], ptr %ix, i64 0, i64 %indvars.iv235, i64 0
...
if.end66.i.us:                                    ; preds = %if.end66.sink.split.i.us, %if.end33.i.us, %if.end58.i.us
  %30 = phi i32 [ %.pre255, %if.end66.sink.split.i.us ], [ %27, %if.end33.i.us ], [ 0, %if.end58.i.us ]
  %31 = phi i32 [ %.pre254, %if.end66.sink.split.i.us ], [ %conv.i.us, %if.end33.i.us ], [ %18, %if.end58.i.us ]
  %32 = phi i32 [ %.pre253, %if.end66.sink.split.i.us ], [ %26, %if.end33.i.us ], [ 0, %if.end58.i.us ]
  ...
  %call26.us216 = tail call ptr @BF_addEntry(ptr noundef %34, i32 noundef %31, i32 noundef %33) #9
  store ptr %call26.us216, ptr %pph, align 8, !tbaa !5
  %call27.us217 = tail call ptr @BF_addEntry(ptr noundef %call26.us216, i32 noundef %30, i32 noundef %32) #9
  ...
  br i1 %cmp15.us219, label %for.body16.us214, label %for.body16.us214.1, !llvm.loop !92

for.body16.us214.1:                               ; preds = %if.end66.i.us, %if.end66.i.us.1
  %indvars.iv235.1 = phi i64 [ %indvars.iv.next236.1, %if.end66.i.us.1 ], [ %5, %if.end66.i.us ]
  %bitsWritten.2209.us.1 = phi i32 [ %add28.us.1, %if.end66.i.us.1 ], [ %add28.us, %if.end66.i.us ]
  %arrayidx20.us.1 = getelementptr inbounds [192 x [3 x i32]], ptr %ix, i64 0, i64 %indvars.iv235.1, i64 1
  %35 = load i32, ptr %arrayidx20.us.1, align 4, !tbaa !9
  %36 = add nsw i64 %indvars.iv235.1, 1
  ...
  %spec.select128.i.us.1 = zext i1 %cmp.i.i.us.1 to i32
...
if.else.i.us.1:                                   ; preds = %for.body16.us214.1
...
if.then54.i.us.1:                                 ; preds = %if.else.i.us.1
  ...
  %or56.i.us.1 = or i32 %shl55.i.us.1, %spec.select128.i.us.1
...
if.then3.i.us.1:                                  ; preds = %for.body16.us214.1
  %44 = load i32, ptr %arrayidx.i, align 8, !tbaa !90
  %cmp4.i.us.1 = icmp ugt i32 %spec.select.i.us.1, 14
  %spec.select129.i.us.1 = select i1 %cmp4.i.us.1, i32 15, i32 %spec.select.i.us.1
  ...
  %mul.i.us.1 = shl nuw nsw i32 %spec.select129.i.us.1, 4
...
if.end20.i.us.1:                                  ; preds = %if.then3.i.us.1
  %cmp21.not.i.us.1 = icmp eq i32 %spec.select129.i.us.1, 0
...
if.then23.i.us.1:                                 ; preds = %if.end20.thread.i.us.1, %if.end20.i.us.1
  ...
  %or24.i.us.1 = or i32 %shl.i.us.1, %spec.select128.i.us.1
...
if.end66.sink.split.i.us.1:                       ; preds = %if.end33.thread.i.us.1, %if.end33.i.us.1, %if.end58.i.us.1
  ...
  %.pre253.1 = load i32, ptr %xbits, align 4, !tbaa !9
  %.pre254.1 = load i32, ptr %code, align 4, !tbaa !9
  %.pre255.1 = load i32, ptr %ext, align 4, !tbaa !9
  br label %if.end66.i.us.1

if.end66.i.us.1:                                  ; preds = %if.end66.sink.split.i.us.1, %if.end33.i.us.1, %if.end58.i.us.1
  %55 = phi i32 [ %.pre255.1, %if.end66.sink.split.i.us.1 ], [ %52, %if.end33.i.us.1 ], [ 0, %if.end58.i.us.1 ]
  %56 = phi i32 [ %.pre254.1, %if.end66.sink.split.i.us.1 ], [ %conv.i.us.1, %if.end33.i.us.1 ], [ %43, %if.end58.i.us.1 ]
  %57 = phi i32 [ %.pre253.1, %if.end66.sink.split.i.us.1 ], [ %51, %if.end33.i.us.1 ], [ 0, %if.end58.i.us.1 ]
  ...
  %call26.us216.1 = tail call ptr @BF_addEntry(ptr noundef %59, i32 noundef %56, i32 noundef %58) #9
  store ptr %call26.us216.1, ptr %pph, align 8, !tbaa !5
  %call27.us217.1 = tail call ptr @BF_addEntry(ptr noundef %call26.us216.1, i32 noundef %55, i32 noundef %57) #9
  store ptr %call27.us217.1, ptr %pph, align 8, !tbaa !5
  %add28.us.1 = add nsw i32 %add67.i.us.1, %bitsWritten.2209.us.1
  %indvars.iv.next236.1 = add nsw i64 %indvars.iv235.1, 2
  %cmp15.us219.1 = icmp slt i64 %indvars.iv.next236.1, %6
  br i1 %cmp15.us219.1, label %for.body16.us214.1, label %for.body16.us214.2, !llvm.loop !92

for.body16.us214.2:                               ; preds = %if.end66.i.us.1, %if.end66.i.us.2
  %indvars.iv235.2 = phi i64 [ %indvars.iv.next236.2, %if.end66.i.us.2 ], [ %5, %if.end66.i.us.1 ]
  %bitsWritten.2209.us.2 = phi i32 [ %add28.us.2, %if.end66.i.us.2 ], [ %add28.us.1, %if.end66.i.us.1 ]
  %arrayidx20.us.2 = getelementptr inbounds [192 x [3 x i32]], ptr %ix, i64 0, i64 %indvars.iv235.2, i64 2
  %60 = load i32, ptr %arrayidx20.us.2, align 4, !tbaa !9
  %61 = add nsw i64 %indvars.iv235.2, 1
  ...
  %spec.select128.i.us.2 = zext i1 %cmp.i.i.us.2 to i32
...
if.else.i.us.2:                                   ; preds = %for.body16.us214.2
...
if.then54.i.us.2:                                 ; preds = %if.else.i.us.2
  ...
  %or56.i.us.2 = or i32 %shl55.i.us.2, %spec.select128.i.us.2
...
if.then3.i.us.2:                                  ; preds = %for.body16.us214.2
  %69 = load i32, ptr %arrayidx.i, align 8, !tbaa !90
  %cmp4.i.us.2 = icmp ugt i32 %spec.select.i.us.2, 14
  %spec.select129.i.us.2 = select i1 %cmp4.i.us.2, i32 15, i32 %spec.select.i.us.2
  ...
  %mul.i.us.2 = shl nuw nsw i32 %spec.select129.i.us.2, 4
...
if.end20.i.us.2:                                  ; preds = %if.then3.i.us.2
  %cmp21.not.i.us.2 = icmp eq i32 %spec.select129.i.us.2, 0
...
if.then23.i.us.2:                                 ; preds = %if.end20.thread.i.us.2, %if.end20.i.us.2
  ...
  %or24.i.us.2 = or i32 %shl.i.us.2, %spec.select128.i.us.2
...
if.end66.sink.split.i.us.2:                       ; preds = %if.end33.thread.i.us.2, %if.end33.i.us.2, %if.end58.i.us.2
  ...
  %.pre253.2 = load i32, ptr %xbits, align 4, !tbaa !9
  %.pre254.2 = load i32, ptr %code, align 4, !tbaa !9
  %.pre255.2 = load i32, ptr %ext, align 4, !tbaa !9
  br label %if.end66.i.us.2

if.end66.i.us.2:                                  ; preds = %if.end66.sink.split.i.us.2, %if.end33.i.us.2, %if.end58.i.us.2
  %80 = phi i32 [ %.pre255.2, %if.end66.sink.split.i.us.2 ], [ %77, %if.end33.i.us.2 ], [ 0, %if.end58.i.us.2 ]
  %81 = phi i32 [ %.pre254.2, %if.end66.sink.split.i.us.2 ], [ %conv.i.us.2, %if.end33.i.us.2 ], [ %68, %if.end58.i.us.2 ]
  %82 = phi i32 [ %.pre253.2, %if.end66.sink.split.i.us.2 ], [ %76, %if.end33.i.us.2 ], [ 0, %if.end58.i.us.2 ]
  ...
  %call26.us216.2 = tail call ptr @BF_addEntry(ptr noundef %84, i32 noundef %81, i32 noundef %83) #9
  store ptr %call26.us216.2, ptr %pph, align 8, !tbaa !5
  %call27.us217.2 = tail call ptr @BF_addEntry(ptr noundef %call26.us216.2, i32 noundef %80, i32 noundef %82) #9
  store ptr %call27.us217.2, ptr %pph, align 8, !tbaa !5
  %add28.us.2 = add nsw i32 %add67.i.us.2, %bitsWritten.2209.us.2
  %indvars.iv.next236.2 = add nsw i64 %indvars.iv235.2, 2
  %cmp15.us219.2 = icmp slt i64 %indvars.iv.next236.2, %6
  br i1 %cmp15.us219.2, label %for.body16.us214.2, label %for.cond.loopexit, !llvm.loop !92
...
for.body87:                                       ; preds = %for.body87.lr.ph, %for.body87
  %103 = phi ptr [ %.pre257, %for.body87.lr.ph ], [ %call29.i, %for.body87 ]
  %indvars.iv247 = phi i64 [ %101, %for.body87.lr.ph ], [ %indvars.iv.next248, %for.body87 ]
  ...
  %spec.select.i194 = tail call i32 @llvm.abs.i32(i32 %104, i1 true)
  %cmp.i46.i = icmp slt i32 %106, 1
  %w.addr.0.i = tail call i32 @llvm.abs.i32(i32 %106, i1 true)
  %retval.0.i49.i = zext i1 %cmp.i46.i to i32
  %cmp.i51.i = icmp slt i32 %108, 1
  %x.addr.0.i = tail call i32 @llvm.abs.i32(i32 %108, i1 true)
  %retval.0.i54.i = zext i1 %cmp.i51.i to i32
  %cmp.i56.i = icmp slt i32 %110, 1
  %y.addr.0.i195 = tail call i32 @llvm.abs.i32(i32 %110, i1 true)
  ...
  %112 = load ptr, ptr %table.i198, align 8, !tbaa !85
  %idxprom.i199 = zext i32 %add7.i to i64
  %arrayidx.i200 = getelementptr inbounds i64, ptr %112, i64 %idxprom.i199
  %113 = load i64, ptr %arrayidx.i200, align 8, !tbaa !87
  %hlen.i201 = getelementptr inbounds [34 x %struct.huffcodetab], ptr @ht, i64 0, i64 %idxprom100, i32 3
  %114 = load ptr, ptr %hlen.i201, align 8, !tbaa !88
  %arrayidx9.i = getelementptr inbounds i8, ptr %114, i64 %idxprom.i199
  %115 = load i8, ptr %arrayidx9.i, align 1, !tbaa !89
  %conv.i202 = zext i8 %115 to i32
  %conv10.i = trunc i64 %113 to i32
  %call11.i = tail call ptr @BF_addEntry(ptr noundef %103, i32 noundef %conv10.i, i32 noundef %conv.i202) #9
  ...
  %cmp86 = icmp slt i64 %indvars.iv.next248, %102
...
while.body:                                       ; preds = %while.body.preheader, %while.body
  %122 = phi ptr [ %call113, %while.body ], [ %.pre258, %while.body.preheader ]
