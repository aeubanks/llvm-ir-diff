...
entry:
  ...
  %tobool.not30 = icmp eq i32 %.pr, 0
  br i1 %tobool.not30, label %for.cond18, label %for.cond1.preheader.lr.ph
...
for.cond1.preheader.lr.ph:                        ; preds = %entry
  ...
  br i1 %tobool9.not, label %for.cond.for.cond18_crit_edge, label %for.cond1.preheader.lr.ph.split

for.cond1.preheader.lr.ph.split:                  ; preds = %for.cond1.preheader.lr.ph
  %tobool.not = icmp eq i8 %1, 0
  br i1 %tobool.not, label %for.cond.for.cond18_crit_edge, label %for.cond1.preheader, !llvm.loop !10

for.cond1.preheader:                              ; preds = %for.cond1.preheader.lr.ph.split, %for.cond1.preheader
  br label %for.cond1.preheader

for.cond.for.cond18_crit_edge:                    ; preds = %for.cond1.preheader.lr.ph, %for.cond1.preheader.lr.ph.split
  %.us-phi32 = phi i32 [ 5, %for.cond1.preheader.lr.ph.split ], [ 33, %for.cond1.preheader.lr.ph ]
  store i32 %.us-phi32, ptr @g, align 4, !tbaa !5
  br label %for.cond18

for.cond18:                                       ; preds = %for.cond.for.cond18_crit_edge, %entry
