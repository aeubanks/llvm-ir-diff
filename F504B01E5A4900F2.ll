...
entry:
  ...
  %0 = add nsw i32 %add.i.i, -1048576
  %tobool.not.i = icmp ult i32 %0, 3145729
  %sub.i = sub nsw i32 %center_y, %size
  %mul1.i64.i = mul nsw i32 %sub.i, %sub.i
  %add.i65.i = add nuw i32 %mul1.i64.i, %mul.i.i
  %1 = add i32 %add.i65.i, -1048576
  %tobool4.not.i = icmp ult i32 %1, 3145729
...
land.lhs.true5.i:                                 ; preds = %entry
  ...
  %2 = add i32 %add.i72.i, %mul1.i64.i
  %tobool9.not.i = icmp ult i32 %2, 3145729
  %3 = add i32 %add.i72.i, %mul1.i.i
  %tobool14.not.i = icmp ult i32 %3, 3145729
...
CheckIntersect.exit:                              ; preds = %entry, %land.lhs.true5.i
  %cmp.i87.i = icmp ugt i32 %add.i.i, 4194304
  %cmp2.i88.i = icmp ult i32 %add.i.i, 1048576
  %..i89.i = sext i1 %cmp2.i88.i to i32
  %retval.0.i90.i = select i1 %cmp.i87.i, i32 1, i32 %..i89.i
  %cmp.i94.i = icmp ugt i32 %add.i65.i, 4194304
  %cmp2.i95.i = icmp ult i32 %add.i65.i, 1048576
  %4 = select i1 %cmp2.i95.i, i32 3, i32 4
  ...
  %add21.i = select i1 %cmp.i94.i, i32 5, i32 %4
  %add25.i = add nsw i32 %add21.i, %retval.0.i90.i
  %add29.i = add nsw i32 %add25.i, %retval.0.i104.i
  %5 = add nsw i32 %add29.i, %retval.0.i111.i
  %switch.and.i = and i32 %5, -9
