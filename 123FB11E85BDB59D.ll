...
while.body:                                       ; preds = %while.body.lr.ph, %if.end47
  ...
  %or.cond78 = and i1 %or.cond, %tobool6.not
...
lor.rhs.i.i.i:                                    ; preds = %if.end5.i.i.i
  ...
  %or.cond.i78.i = or i1 %cmp11.i.not.i.i, %tobool5.not.i.i
...
while.body12.i.i:                                 ; preds = %if.end25.i.i, %if.end7.i.i
  ...
  %66 = load i32, ptr %tt15.i.i, align 8, !tbaa !33
...
lor.rhs.i65.i.i:                                  ; preds = %if.end5.i63.i.i
  ...
  %or.cond85.i.i = or i1 %cmp11.i64.not.i.i, %tobool21.not.i.i
