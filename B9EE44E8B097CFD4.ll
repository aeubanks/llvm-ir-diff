...
define dso_local i32 @alaw_input(ptr nocapture noundef writeonly %0) local_unnamed_addr #0 {
  br label %2
...
7:                                                ; preds = %2
  ...
  br i1 %14, label %20, label %2, !llvm.loop !11

15:                                               ; preds = %2
  %16 = trunc i64 %3 to i32
  %17 = load ptr, ptr @in, align 8, !tbaa !5
  %18 = tail call i32 @ferror(ptr noundef %17) #3
  %19 = icmp eq i32 %18, 0
...
; Function Attrs: nofree nounwind uwtable
define dso_local i32 @alaw_output(ptr nocapture noundef readonly %0) local_unnamed_addr #0 {
  br label %2
...
2:                                                ; preds = %1, %14
  ...
  %10 = zext i8 %9 to i32
  %11 = load ptr, ptr @out, align 8, !tbaa !5
