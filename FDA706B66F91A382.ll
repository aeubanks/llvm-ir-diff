...
call.i.i.noexc:                                   ; preds = %if.end.i.i
  %call.i.i200348 = ptrtoint ptr %call.i.i200 to i64
...
iter.check:                                       ; preds = %for.cond.preheader.i.i
  ...
  %30 = sub i64 %call.i.i200348, %29
  %diff.check = icmp ult i64 %30, 32
  %or.cond357 = select i1 %min.iters.check, i1 true, i1 %diff.check
  br i1 %or.cond357, label %for.body.i.i.preheader, label %vector.main.loop.iter.check

vector.main.loop.iter.check:                      ; preds = %iter.check
  %min.iters.check349 = icmp ult i32 %27, 32
  br i1 %min.iters.check349, label %vec.epilog.ph, label %vector.ph
...
vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  ...
  %n.vec352 = and i64 %wide.trip.count.i.i, 4294967288
  br label %vec.epilog.vector.body

vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  %index354 = phi i64 [ %vec.epilog.resume.val, %vec.epilog.ph ], [ %index.next356, %vec.epilog.vector.body ]
  %36 = getelementptr inbounds i8, ptr %28, i64 %index354
  %wide.load355 = load <8 x i8>, ptr %36, align 1, !tbaa !49
  %37 = getelementptr inbounds i8, ptr %call.i.i200, i64 %index354
  store <8 x i8> %wide.load355, ptr %37, align 1, !tbaa !49
  %index.next356 = add nuw i64 %index354, 8
  %38 = icmp eq i64 %index.next356, %n.vec352
  br i1 %38, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !59

vec.epilog.middle.block:                          ; preds = %vec.epilog.vector.body
  %cmp.n353 = icmp eq i64 %n.vec352, %wide.trip.count.i.i
  br i1 %cmp.n353, label %delete.notnull.i.i, label %for.body.i.i.preheader

for.body.i.i.preheader:                           ; preds = %iter.check, %vec.epilog.iter.check, %vec.epilog.middle.block
  %indvars.iv.i6.i.ph = phi i64 [ 0, %iter.check ], [ %n.vec, %vec.epilog.iter.check ], [ %n.vec352, %vec.epilog.middle.block ]
...
entry:
  ...
  %cmp58 = icmp ult i32 %0, %index
  %1 = load i8, ptr %_latestIsRead, align 4, !range !39
  %tobool.not59 = icmp eq i8 %1, 0
  %or.cond60 = select i1 %cmp58, i1 true, i1 %tobool.not59
  br i1 %or.cond60, label %while.body.lr.ph, label %return
...
while.body:                                       ; preds = %while.body.lr.ph, %if.end38
  %2 = phi i8 [ %1, %while.body.lr.ph ], [ %44, %if.end38 ]
...
if.then:                                          ; preds = %while.body
  ...
  %3 = load i64, ptr %Size.i, align 8, !tbaa !54
  %add.i = add i64 %3, 511
  %and.i = and i64 %add.i, -512
  store i64 %and.i, ptr %packSize, align 8, !tbaa !41
  %4 = load ptr, ptr %copyCoderSpec, align 8, !tbaa !84
  %5 = load ptr, ptr %_seqStream, align 8, !tbaa !78
  %vtable = load ptr, ptr %4, align 8, !tbaa !47
  %vfn = getelementptr inbounds ptr, ptr %vtable, i64 5
  %6 = load ptr, ptr %vfn, align 8
  %call5 = call noundef i32 %6(ptr noundef nonnull align 8 dereferenceable(40) %4, ptr noundef %5, ptr noundef null, ptr noundef nonnull %packSize, ptr noundef nonnull %packSize, ptr noundef null)
  %cmp6.not = icmp eq i32 %call5, 0
  br i1 %cmp6.not, label %cleanup.cont, label %cleanup17.thread

cleanup.cont:                                     ; preds = %if.then
  %7 = load ptr, ptr %copyCoderSpec, align 8, !tbaa !84
  %TotalSize = getelementptr inbounds %"class.NCompress::CCopyCoder", ptr %7, i64 0, i32 4
  %8 = load i64, ptr %TotalSize, align 8, !tbaa !85
  %9 = load i64, ptr %_phySize, align 8, !tbaa !44
  %add = add i64 %9, %8
  store i64 %add, ptr %_phySize, align 8, !tbaa !44
  %10 = load i64, ptr %packSize, align 8, !tbaa !41
  %cmp11.not = icmp eq i64 %8, %10
  br i1 %cmp11.not, label %cleanup17, label %if.then12

if.then12:                                        ; preds = %cleanup.cont
  %_length.i.i = getelementptr inbounds %"class.NArchive::NTar::CHandler", ptr %this, i64 0, i32 15, i32 1
  store i32 0, ptr %_length.i.i, align 8, !tbaa !42
  %11 = load ptr, ptr %_errorMessage.i, align 8, !tbaa !43
  store i8 0, ptr %11, align 1, !tbaa !49
  %_capacity.i.i = getelementptr inbounds %"class.NArchive::NTar::CHandler", ptr %this, i64 0, i32 15, i32 2
  %12 = load i32, ptr %_capacity.i.i, align 4, !tbaa !50
  %cmp.i.i = icmp eq i32 %12, 26
  br i1 %cmp.i.i, label %_Z11MyStringLenIcEiPKT_.exit._ZN11CStringBaseIcE11SetCapacityEi.exit_crit_edge.i, label %if.end.i.i
...
if.end.i.i:                                       ; preds = %if.then12
  ...
  %cmp3.i.i = icmp sgt i32 %12, 0
  br i1 %cmp3.i.i, label %for.cond.preheader.i.i, label %if.end9.i.i

for.cond.preheader.i.i:                           ; preds = %if.end.i.i
  %13 = load i32, ptr %_length.i.i, align 8, !tbaa !42
  %cmp522.i.i = icmp sgt i32 %13, 0
  %14 = load ptr, ptr %_errorMessage.i, align 8, !tbaa !43
  br i1 %cmp522.i.i, label %iter.check, label %for.cond.cleanup.i.i
...
iter.check:                                       ; preds = %for.cond.preheader.i.i
  ...
  %16 = sub i64 %call.i.i67, %15
  %diff.check = icmp ult i64 %16, 32
  %or.cond77 = select i1 %min.iters.check, i1 true, i1 %diff.check
  br i1 %or.cond77, label %for.body.i.i.preheader, label %vector.main.loop.iter.check

vector.main.loop.iter.check:                      ; preds = %iter.check
  %min.iters.check68 = icmp ult i32 %13, 32
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %17 = getelementptr inbounds i8, ptr %14, i64 %index69
  %wide.load = load <16 x i8>, ptr %17, align 1, !tbaa !49
  %18 = getelementptr inbounds i8, ptr %17, i64 16
  %wide.load70 = load <16 x i8>, ptr %18, align 1, !tbaa !49
  %19 = getelementptr inbounds i8, ptr %call.i.i, i64 %index69
  store <16 x i8> %wide.load, ptr %19, align 1, !tbaa !49
  %20 = getelementptr inbounds i8, ptr %19, i64 16
  store <16 x i8> %wide.load70, ptr %20, align 1, !tbaa !49
  %index.next = add nuw i64 %index69, 32
  %21 = icmp eq i64 %index.next, %n.vec
  br i1 %21, label %middle.block, label %vector.body, !llvm.loop !89
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %22 = getelementptr inbounds i8, ptr %14, i64 %index74
  %wide.load75 = load <8 x i8>, ptr %22, align 1, !tbaa !49
  %23 = getelementptr inbounds i8, ptr %call.i.i, i64 %index74
  store <8 x i8> %wide.load75, ptr %23, align 1, !tbaa !49
  %index.next76 = add nuw i64 %index74, 8
  %24 = icmp eq i64 %index.next76, %n.vec72
  br i1 %24, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !90
...
for.body.i.i.preheader:                           ; preds = %iter.check, %vec.epilog.iter.check, %vec.epilog.middle.block
  ...
  %25 = xor i64 %indvars.iv.i6.i.ph, -1
...
for.body.i.i.prol:                                ; preds = %for.body.i.i.preheader, %for.body.i.i.prol
  %indvars.iv.i6.i.prol = phi i64 [ %indvars.iv.next.i8.i.prol, %for.body.i.i.prol ], [ %indvars.iv.i6.i.ph, %for.body.i.i.preheader ]
  %prol.iter = phi i64 [ %prol.iter.next, %for.body.i.i.prol ], [ 0, %for.body.i.i.preheader ]
  %arrayidx.i7.i.prol = getelementptr inbounds i8, ptr %14, i64 %indvars.iv.i6.i.prol
  %27 = load i8, ptr %arrayidx.i7.i.prol, align 1, !tbaa !49
  %arrayidx7.i.i.prol = getelementptr inbounds i8, ptr %call.i.i, i64 %indvars.iv.i6.i.prol
  store i8 %27, ptr %arrayidx7.i.i.prol, align 1, !tbaa !49
  %indvars.iv.next.i8.i.prol = add nuw nsw i64 %indvars.iv.i6.i.prol, 1
  %prol.iter.next = add i64 %prol.iter, 1
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
...
for.body.i.i.prol.loopexit:                       ; preds = %for.body.i.i.prol, %for.body.i.i.preheader
  ...
  br i1 %28, label %delete.notnull.i.i, label %for.body.i.i
...
for.body.i.i:                                     ; preds = %for.body.i.i.prol.loopexit, %for.body.i.i
  %indvars.iv.i6.i = phi i64 [ %indvars.iv.next.i8.i.3, %for.body.i.i ], [ %indvars.iv.i6.i.unr, %for.body.i.i.prol.loopexit ]
  %arrayidx.i7.i = getelementptr inbounds i8, ptr %14, i64 %indvars.iv.i6.i
  %29 = load i8, ptr %arrayidx.i7.i, align 1, !tbaa !49
  %arrayidx7.i.i = getelementptr inbounds i8, ptr %call.i.i, i64 %indvars.iv.i6.i
  store i8 %29, ptr %arrayidx7.i.i, align 1, !tbaa !49
  %indvars.iv.next.i8.i = add nuw nsw i64 %indvars.iv.i6.i, 1
  %arrayidx.i7.i.1 = getelementptr inbounds i8, ptr %14, i64 %indvars.iv.next.i8.i
  %30 = load i8, ptr %arrayidx.i7.i.1, align 1, !tbaa !49
  %arrayidx7.i.i.1 = getelementptr inbounds i8, ptr %call.i.i, i64 %indvars.iv.next.i8.i
  store i8 %30, ptr %arrayidx7.i.i.1, align 1, !tbaa !49
  %indvars.iv.next.i8.i.1 = add nuw nsw i64 %indvars.iv.i6.i, 2
  %arrayidx.i7.i.2 = getelementptr inbounds i8, ptr %14, i64 %indvars.iv.next.i8.i.1
  %31 = load i8, ptr %arrayidx.i7.i.2, align 1, !tbaa !49
  %arrayidx7.i.i.2 = getelementptr inbounds i8, ptr %call.i.i, i64 %indvars.iv.next.i8.i.1
  store i8 %31, ptr %arrayidx7.i.i.2, align 1, !tbaa !49
  %indvars.iv.next.i8.i.2 = add nuw nsw i64 %indvars.iv.i6.i, 3
  %arrayidx.i7.i.3 = getelementptr inbounds i8, ptr %14, i64 %indvars.iv.next.i8.i.2
  %32 = load i8, ptr %arrayidx.i7.i.3, align 1, !tbaa !49
  %arrayidx7.i.i.3 = getelementptr inbounds i8, ptr %call.i.i, i64 %indvars.iv.next.i8.i.2
  store i8 %32, ptr %arrayidx7.i.i.3, align 1, !tbaa !49
  %indvars.iv.next.i8.i.3 = add nuw nsw i64 %indvars.iv.i6.i, 4
  %exitcond.not.i.i.3 = icmp eq i64 %indvars.iv.next.i8.i.3, %wide.trip.count.i.i
...
if.end9.i.i:                                      ; preds = %delete.notnull.i.i, %for.cond.cleanup.i.i, %if.end.i.i
  ...
  %33 = load i32, ptr %_length.i.i, align 8, !tbaa !42
  %idxprom13.i.i = sext i32 %33 to i64
...
_ZN11CStringBaseIcE11SetCapacityEi.exit.i:        ; preds = %if.end9.i.i, %_Z11MyStringLenIcEiPKT_.exit._ZN11CStringBaseIcE11SetCapacityEi.exit_crit_edge.i
  %34 = phi ptr [ %.pre.i, %_Z11MyStringLenIcEiPKT_.exit._ZN11CStringBaseIcE11SetCapacityEi.exit_crit_edge.i ], [ %call.i.i, %if.end9.i.i ]
  %incdec.ptr1.i.i.15 = getelementptr inbounds i8, ptr %34, i64 16
  store <16 x i8> <i8 85, i8 110, i8 101, i8 120, i8 112, i8 101, i8 99, i8 116, i8 101, i8 100, i8 32, i8 101, i8 110, i8 100, i8 32, i8 111>, ptr %34, align 1, !tbaa !49
  %incdec.ptr1.i.i.23 = getelementptr inbounds i8, ptr %34, i64 24
  store <8 x i8> <i8 102, i8 32, i8 97, i8 114, i8 99, i8 104, i8 105, i8 118>, ptr %incdec.ptr1.i.i.15, align 1, !tbaa !49
  %incdec.ptr1.i.i.24 = getelementptr inbounds i8, ptr %34, i64 25
  store i8 101, ptr %incdec.ptr1.i.i.23, align 1, !tbaa !49
  store i8 0, ptr %incdec.ptr1.i.i.24, align 1, !tbaa !49
  store i32 25, ptr %_length.i.i, align 8, !tbaa !42
...
cleanup17:                                        ; preds = %cleanup.cont
  store i8 0, ptr %_latestIsRead, align 4, !tbaa !80
  %35 = load i32, ptr %_curIndex, align 8, !tbaa !79
  %inc = add i32 %35, 1
...
if.else:                                          ; preds = %while.body
  call void @llvm.lifetime.start.p0(i64 1, ptr nonnull %filled) #19
  %36 = load ptr, ptr %_seqStream, align 8, !tbaa !78
  %37 = load i64, ptr %_phySize, align 8, !tbaa !44
  store i64 %37, ptr %HeaderPos.i, align 8, !tbaa !45
  %call.i = call noundef i32 @_ZN8NArchive4NTar8ReadItemEP19ISequentialInStreamRbRNS0_7CItemExER11CStringBaseIcE(ptr noundef %36, ptr noundef nonnull align 1 dereferenceable(1) %filled, ptr noundef nonnull align 8 dereferenceable(124) %_latestItem23, ptr noundef nonnull align 8 dereferenceable(16) %_errorMessage.i)
...
cleanup.cont30:                                   ; preds = %if.else
  %38 = load i32, ptr %HeaderSize.i, align 8, !tbaa !46
  %conv.i = zext i32 %38 to i64
  %39 = load <2 x i64>, ptr %_phySize, align 8, !tbaa !41
  %40 = insertelement <2 x i64> poison, i64 %conv.i, i64 0
  %41 = shufflevector <2 x i64> %40, <2 x i64> poison, <2 x i32> zeroinitializer
  %42 = add <2 x i64> %39, %41
  store <2 x i64> %42, ptr %_phySize, align 8, !tbaa !41
  %43 = load i8, ptr %filled, align 1, !tbaa !51, !range !39, !noundef !40
...
if.end38:                                         ; preds = %cleanup35, %cleanup17
  %44 = phi i8 [ 1, %cleanup35 ], [ 0, %cleanup17 ]
  %45 = phi i32 [ %.pre, %cleanup35 ], [ %inc, %cleanup17 ]
  %cmp = icmp ult i32 %45, %index
  %or.cond = or i1 %cmp, %tobool3.not
  br i1 %or.cond, label %while.body, label %return, !llvm.loop !93
...
for.body.preheader:                               ; preds = %for.body.lr.ph
  ...
  br i1 %5, label %for.end.loopexit576.unr-lcssa, label %for.body.preheader.new
...
invoke.cont37:                                    ; preds = %invoke.cont34
  ...
  %call.i411 = invoke noundef i32 %41(ptr noundef nonnull align 8 dereferenceable(8) %call35)
...
invoke.cont43:                                    ; preds = %invoke.cont41
  ...
  %call.i414 = invoke noundef i32 %43(ptr noundef nonnull align 8 dereferenceable(8) %call44)
...
if.then.i.i:                                      ; preds = %invoke.cont48
  ...
  %call.i.i416 = invoke noundef i32 %44(ptr noundef nonnull align 8 dereferenceable(8) %spec.select)
...
if.then2.i.i:                                     ; preds = %if.end.i.i
  ...
  %call6.i.i417 = invoke noundef i32 %46(ptr noundef nonnull align 8 dereferenceable(8) %45)
...
invoke.cont52:                                    ; preds = %_ZN26CLimitedSequentialInStream9SetStreamEP19ISequentialInStream.exit
  ...
  %call.i421 = invoke noundef i32 %48(ptr noundef nonnull align 8 dereferenceable(8) %call53)
...
for.cond58.preheader:                             ; preds = %invoke.cont52
  ...
  %49 = or i1 %cmp, %cmp59539
  br i1 %49, label %for.body61.lr.ph, label %if.then.i485
...
cond.end77:                                       ; preds = %cleanup.cont, %cond.false74
  %cond78 = phi i32 [ %60, %cond.false74 ], [ %i.1542, %cleanup.cont ]
...
invoke.cont99:                                    ; preds = %cond.end77
  %62 = load ptr, ptr %_items.i.i422, align 8, !tbaa !52
  %idxprom.i.i423 = sext i32 %cond78 to i64
  %arrayidx.i.i424 = getelementptr inbounds ptr, ptr %62, i64 %idxprom.i.i423
  %63 = load ptr, ptr %arrayidx.i.i424, align 8, !tbaa !15
  br label %if.end101

if.end101:                                        ; preds = %invoke.cont82, %invoke.cont99
  %item.2 = phi ptr [ %63, %invoke.cont99 ], [ %_latestItem, %invoke.cont82 ]
...
cleanup.cont115:                                  ; preds = %invoke.cont108
  ...
  %66 = load i8, ptr %LinkFlag.i.i425, align 8, !tbaa !94
  %cmp.i.i426 = icmp eq i8 %66, 50
  %Size.i.i427 = getelementptr inbounds %"struct.NArchive::NTar::CItem", ptr %item.2, i64 0, i32 1
  %67 = load i64, ptr %Size.i.i427, align 8
  %cmp2.i.i428 = icmp eq i64 %67, 0
  %68 = select i1 %cmp.i.i426, i1 %cmp2.i.i428, i1 false
  %_length.i.i429 = getelementptr inbounds %"struct.NArchive::NTar::CItem", ptr %item.2, i64 0, i32 8, i32 1
  %69 = load i32, ptr %_length.i.i429, align 8
  %conv.i430 = sext i32 %69 to i64
  %cond.i431 = select i1 %68, i64 %conv.i430, i64 %67
  %add119 = add i64 %cond.i431, %totalSize.1543
  %add.i = add i64 %67, 511
  %and.i = and i64 %add.i, -512
  %add122 = add i64 %and.i, %totalPackSize.0541
  %conv.i432 = sext i8 %66 to i32
...
if.end160:                                        ; preds = %if.end150
  ...
  %call166 = invoke noundef i32 %77(ptr noundef nonnull align 8 dereferenceable(8) %extractCallback, i32 noundef %cond71.mux)
...
cleanup.cont172:                                  ; preds = %invoke.cont165
  ...
  %cmp.not.i.i435 = icmp eq ptr %79, null
  br i1 %cmp.not.i.i435, label %if.end.i.i440, label %if.then.i.i438

if.then.i.i438:                                   ; preds = %cleanup.cont172
  %vtable.i.i436 = load ptr, ptr %79, align 8, !tbaa !47
  %vfn.i.i437 = getelementptr inbounds ptr, ptr %vtable.i.i436, i64 1
  %80 = load ptr, ptr %vfn.i.i437, align 8
  %call.i.i445 = invoke noundef i32 %80(ptr noundef nonnull align 8 dereferenceable(8) %79)
          to label %if.end.i.i440 unwind label %lpad153

if.end.i.i440:                                    ; preds = %if.then.i.i438, %cleanup.cont172
  %81 = load ptr, ptr %_stream.i418, align 8, !tbaa !98
  %tobool.not.i.i439 = icmp eq ptr %81, null
...
if.then2.i.i443:                                  ; preds = %if.end.i.i440
  %vtable4.i.i441 = load ptr, ptr %81, align 8, !tbaa !47
  %vfn5.i.i442 = getelementptr inbounds ptr, ptr %vtable4.i.i441, i64 2
  %82 = load ptr, ptr %vfn5.i.i442, align 8
  %call6.i.i447 = invoke noundef i32 %82(ptr noundef nonnull align 8 dereferenceable(8) %81)
...
_ZN27CLimitedSequentialOutStream9SetStreamEP20ISequentialOutStream.exit: ; preds = %if.then2.i.i443, %if.end.i.i440
  store ptr %79, ptr %_stream.i418, align 8, !tbaa !98
...
if.then.i:                                        ; preds = %_ZN27CLimitedSequentialOutStream9SetStreamEP20ISequentialOutStream.exit
  %vtable.i448 = load ptr, ptr %83, align 8, !tbaa !47
  %vfn.i449 = getelementptr inbounds ptr, ptr %vtable.i448, i64 2
  %84 = load ptr, ptr %vfn.i449, align 8
  %call.i451 = invoke noundef i32 %84(ptr noundef nonnull align 8 dereferenceable(8) %83)
...
invoke.cont176:                                   ; preds = %call.i.noexc450, %_ZN27CLimitedSequentialOutStream9SetStreamEP20ISequentialOutStream.exit
  ...
  %85 = load i8, ptr %LinkFlag.i.i425, align 8, !tbaa !94
  %cmp.i454 = icmp eq i8 %85, 50
  %86 = load i64, ptr %Size.i.i427, align 8
  %cmp2.i = icmp eq i64 %86, 0
  %87 = select i1 %cmp.i454, i1 %cmp2.i, i1 false
...
if.then185:                                       ; preds = %invoke.cont176
  ...
  %89 = load i32, ptr %_length.i.i429, align 8, !tbaa !42
...
if.then203:                                       ; preds = %if.else201
  ...
  %conv.i456 = zext i32 %93 to i64
  %add.i457 = add i64 %92, %conv.i456
  ...
  %call214 = invoke noundef i32 %94(ptr noundef nonnull align 8 dereferenceable(8) %91, i64 noundef %add.i457, i32 noundef 0, ptr noundef null)
...
if.end249:                                        ; preds = %if.then247, %if.end245
  %101 = load ptr, ptr %_stream.i418, align 8, !tbaa !98
  %tobool.not.i.i463 = icmp eq ptr %101, null
  br i1 %tobool.not.i.i463, label %invoke.cont250, label %if.then.i.i466

if.then.i.i466:                                   ; preds = %if.end249
  %vtable.i.i464 = load ptr, ptr %101, align 8, !tbaa !47
  %vfn.i.i465 = getelementptr inbounds ptr, ptr %vtable.i.i464, i64 2
  %102 = load ptr, ptr %vfn.i.i465, align 8
  %call.i.i468 = invoke noundef i32 %102(ptr noundef nonnull align 8 dereferenceable(8) %101)
...
invoke.cont250:                                   ; preds = %call.i.i.noexc467, %if.end249
  %103 = load i64, ptr %_size.i452, align 8, !tbaa !106
...
if.then.i473:                                     ; preds = %cleanup270
  ...
  %106 = load ptr, ptr %vfn.i472, align 8
...
for.inc282:                                       ; preds = %_ZN9CMyComPtrI20ISequentialOutStreamED2Ev.exit.thread, %_ZN9CMyComPtrI20ISequentialOutStreamED2Ev.exit, %_ZN9CMyComPtrI20ISequentialOutStreamED2Ev.exit
  ...
  %109 = or i1 %cmp, %cmp59
  br i1 %109, label %for.body61, label %if.then.i485, !llvm.loop !116

ehcleanup271:                                     ; preds = %lpad116, %lpad129, %lpad141, %lpad252, %lpad226, %lpad206, %lpad187, %lpad164, %lpad153, %lpad103, %lpad81
  %.pn527.pn = phi { ptr, i32 } [ %65, %lpad103 ], [ %61, %lpad81 ], [ %74, %lpad141 ], [ %72, %lpad129 ], [ %71, %lpad116 ], [ %105, %lpad252 ], [ %76, %lpad153 ], [ %90, %lpad187 ], [ %99, %lpad226 ], [ %95, %lpad206 ], [ %78, %lpad164 ]
...
if.then.i478:                                     ; preds = %ehcleanup271
  %vtable.i475 = load ptr, ptr %110, align 8, !tbaa !47
  %vfn.i476 = getelementptr inbounds ptr, ptr %vtable.i475, i64 2
  %111 = load ptr, ptr %vfn.i476, align 8
  %call.i477 = invoke noundef i32 %111(ptr noundef nonnull align 8 dereferenceable(8) %110)
...
if.then.i485:                                     ; preds = %_ZN9CMyComPtrI20ISequentialOutStreamED2Ev.exit, %for.inc282, %if.then.i485.loopexit, %for.cond58.preheader
  ...
  %114 = load ptr, ptr %vfn.i483, align 8
  %call.i484 = invoke noundef i32 %114(ptr noundef nonnull align 8 dereferenceable(8) %call53)
...
if.then.i492:                                     ; preds = %if.then.i485
  ...
  %117 = load ptr, ptr %vfn.i490, align 8
  %call.i491 = invoke noundef i32 %117(ptr noundef nonnull align 8 dereferenceable(8) %call44)
...
if.then.i498:                                     ; preds = %if.then.i492
  ...
  %120 = load ptr, ptr %vfn.i496, align 8
  %call.i497 = invoke noundef i32 %120(ptr noundef nonnull align 8 dereferenceable(8) %call35)
...
if.then.i504:                                     ; preds = %lpad62, %_ZN9CMyComPtrI20ISequentialOutStreamED2Ev.exit480
  %.pn527.pn.pn = phi { ptr, i32 } [ %.pn527.pn, %_ZN9CMyComPtrI20ISequentialOutStreamED2Ev.exit480 ], [ %59, %lpad62 ]
  %vtable.i501 = load ptr, ptr %call53, align 8, !tbaa !47
  %vfn.i502 = getelementptr inbounds ptr, ptr %vtable.i501, i64 2
  %123 = load ptr, ptr %vfn.i502, align 8
  %call.i503 = invoke noundef i32 %123(ptr noundef nonnull align 8 dereferenceable(8) %call53)
...
if.then.i511:                                     ; preds = %lpad49, %lpad56, %if.then.i504, %lpad51
  %.pn = phi { ptr, i32 } [ %56, %lpad49 ], [ %57, %lpad51 ], [ %58, %lpad56 ], [ %.pn527.pn.pn, %if.then.i504 ]
  %vtable.i508 = load ptr, ptr %call44, align 8, !tbaa !47
  %vfn.i509 = getelementptr inbounds ptr, ptr %vtable.i508, i64 2
  %126 = load ptr, ptr %vfn.i509, align 8
  %call.i510 = invoke noundef i32 %126(ptr noundef nonnull align 8 dereferenceable(8) %call44)
...
if.then.i518:                                     ; preds = %lpad40, %lpad47, %if.then.i511, %lpad42
  %.pn545 = phi { ptr, i32 } [ %53, %lpad40 ], [ %54, %lpad42 ], [ %55, %lpad47 ], [ %.pn, %if.then.i511 ]
  %vtable.i515 = load ptr, ptr %call35, align 8, !tbaa !47
  %vfn.i516 = getelementptr inbounds ptr, ptr %vtable.i515, i64 2
  %129 = load ptr, ptr %vfn.i516, align 8
  %call.i517 = invoke noundef i32 %129(ptr noundef nonnull align 8 dereferenceable(8) %call35)
...
ehcleanup306:                                     ; preds = %lpad33, %lpad36, %if.then.i518, %lpad38, %lpad26
  %.pn546 = phi { ptr, i32 } [ %28, %lpad26 ], [ %51, %lpad36 ], [ %50, %lpad33 ], [ %52, %lpad38 ], [ %.pn545, %if.then.i518 ]
