; ModuleID = '/usr/local/google/home/aeubanks/repos/test-suite/Bitcode/Regression/fft/modules/FftConvolve8x8xRHalide_x86_64_linux_avx_avx2_c_plus_plus_name_mangling_fma_no_runtime_sse41.bc'
...
@str.15 = private constant [92 x i8] c"FftConvolve8x8xRHalide_x86_64_linux_avx_avx2_c_plus_plus_name_mangling_fma_no_runtime_sse41\00", align 32
@_Z100FftConvolve8x8xRHalide_x86_64_linux_avx_avx2_c_plus_plus_name_mangling_fma_no_runtime_sse41_metadatav_storage = private constant %struct.halide_filter_metadata_t { i32 0, i32 3, ptr @0, ptr @str.14, ptr @str.15 }
...
define i32 @_Z91FftConvolve8x8xRHalide_x86_64_linux_avx_avx2_c_plus_plus_name_mangling_fma_no_runtime_sse41P15halide_buffer_tS0_S0_(ptr noalias %input.buffer, ptr noalias %kernel.buffer, ptr noalias %result.buffer) local_unnamed_addr #1 {
entry:
  ...
  %inv_zipped.121.sroa.0 = alloca [8 x float], align 32
...
"for k.s0.n1.preheader":                          ; preds = %"assert succeeded77"
  ...
  store <4 x float> %433, ptr %inv_zipped.121.sroa.0, align 32, !tbaa !153
  %434 = fadd <4 x float> %411, %411
  %inv_zipped.121.sroa.0.16.sroa_idx641 = getelementptr inbounds i8, ptr %inv_zipped.121.sroa.0, i64 16
  store <4 x float> %434, ptr %inv_zipped.121.sroa.0.16.sroa_idx641, align 16, !tbaa !153
  ...
  %inv_fft1_S1_R8_n1.120.sroa.14.32.vecblend = shufflevector <4 x float> %436, <4 x float> poison, <32 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  ...
  %inv_fft1_S1_R8_n1.120.sroa.14.48.vec.expand = shufflevector <4 x float> %438, <4 x float> poison, <32 x i32> <i32 poison, i32 poison, i32 poison, i32 poison, i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %inv_fft1_S1_R8_n1.120.sroa.14.48.vecblend = shufflevector <32 x float> %inv_fft1_S1_R8_n1.120.sroa.14.32.vecblend, <32 x float> %inv_fft1_S1_R8_n1.120.sroa.14.48.vec.expand, <32 x i32> <i32 0, i32 1, i32 2, i32 3, i32 36, i32 37, i32 38, i32 39, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  ...
  %inv_fft1_S1_R8_n1.120.sroa.14.64.vec.expand = shufflevector <4 x float> %440, <4 x float> poison, <32 x i32> <i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %inv_fft1_S1_R8_n1.120.sroa.14.64.vecblend = shufflevector <32 x float> %inv_fft1_S1_R8_n1.120.sroa.14.48.vecblend, <32 x float> %inv_fft1_S1_R8_n1.120.sroa.14.64.vec.expand, <32 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 40, i32 41, i32 42, i32 43, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  ...
  %inv_fft1_S1_R8_n1.120.sroa.14.80.vec.expand = shufflevector <4 x float> %442, <4 x float> poison, <32 x i32> <i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %inv_fft1_S1_R8_n1.120.sroa.14.80.vecblend = shufflevector <32 x float> %inv_fft1_S1_R8_n1.120.sroa.14.64.vecblend, <32 x float> %inv_fft1_S1_R8_n1.120.sroa.14.80.vec.expand, <32 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 44, i32 45, i32 46, i32 47, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  ...
  %inv_zipped.121.sroa.0.4.sroa_idx632 = getelementptr inbounds i8, ptr %inv_zipped.121.sroa.0, i64 4
  %inv_zipped.121.sroa.0.4.inv_zipped.121.sroa.0.4. = load float, ptr %inv_zipped.121.sroa.0.4.sroa_idx632, align 4, !tbaa !173
  %inv_zipped.121.sroa.0.20.sroa_idx646 = getelementptr inbounds i8, ptr %inv_zipped.121.sroa.0, i64 20
  %inv_zipped.121.sroa.0.20.inv_zipped.121.sroa.0.20. = load float, ptr %inv_zipped.121.sroa.0.20.sroa_idx646, align 4, !tbaa !185
  %479 = fadd float %inv_zipped.121.sroa.0.4.inv_zipped.121.sroa.0.4., %inv_zipped.121.sroa.0.20.inv_zipped.121.sroa.0.20.
  %480 = extractelement <4 x float> %447, i64 1
  %481 = extractelement <4 x float> %449, i64 1
  %482 = fadd float %480, %481
  %inv_zipped.121.sroa.0.12.sroa_idx638 = getelementptr inbounds i8, ptr %inv_zipped.121.sroa.0, i64 12
  %inv_zipped.121.sroa.0.12.inv_zipped.121.sroa.0.12. = load float, ptr %inv_zipped.121.sroa.0.12.sroa_idx638, align 4, !tbaa !189
  %inv_zipped.121.sroa.0.28.sroa_idx649 = getelementptr inbounds i8, ptr %inv_zipped.121.sroa.0, i64 28
  %inv_zipped.121.sroa.0.28.inv_zipped.121.sroa.0.28. = load float, ptr %inv_zipped.121.sroa.0.28.sroa_idx649, align 4, !tbaa !192
  %483 = fadd float %inv_zipped.121.sroa.0.12.inv_zipped.121.sroa.0.12., %inv_zipped.121.sroa.0.28.inv_zipped.121.sroa.0.28.
  ...
  %492 = fsub float %inv_zipped.121.sroa.0.4.inv_zipped.121.sroa.0.4., %inv_zipped.121.sroa.0.20.inv_zipped.121.sroa.0.20.
  ...
  %496 = fsub float %inv_zipped.121.sroa.0.28.inv_zipped.121.sroa.0.28., %inv_zipped.121.sroa.0.12.inv_zipped.121.sroa.0.12.
  ...
  store float %508, ptr %"inv_X8$1.017", align 32, !tbaa !212
  %509 = fsub float %496, %493
  %510 = fadd float %509, %505
  %511 = fmul float %510, 0x3FE6A09E60000000
  store float %511, ptr %"inv_X8$1.116", align 32, !tbaa !214
  ...
  store float %524, ptr %kernel_fft0_S1_R8_n0.023, align 32, !tbaa !249
  ...
  store <2 x float> %539, ptr %kernel_fft0_S1_R8_n0.122, align 32, !tbaa !274
  ...
  %strided.vec487 = shufflevector <32 x float> %inv_zipped.121.sroa.25.128.vecblend, <32 x float> poison, <4 x i32> <i32 1, i32 9, i32 17, i32 25>
  %strided.vec488 = shufflevector <32 x float> %inv_zipped.121.sroa.25.128.vecblend, <32 x float> poison, <4 x i32> <i32 2, i32 10, i32 18, i32 26>
  %strided.vec489 = shufflevector <32 x float> %inv_zipped.121.sroa.25.128.vecblend, <32 x float> poison, <4 x i32> <i32 3, i32 11, i32 19, i32 27>
  %strided.vec490 = shufflevector <32 x float> %inv_zipped.121.sroa.25.144.vecblend, <32 x float> poison, <4 x i32> <i32 4, i32 12, i32 20, i32 28>
  %strided.vec491 = shufflevector <32 x float> %inv_zipped.121.sroa.25.144.vecblend, <32 x float> poison, <4 x i32> <i32 5, i32 13, i32 21, i32 29>
  %strided.vec492 = shufflevector <32 x float> %inv_zipped.121.sroa.25.144.vecblend, <32 x float> poison, <4 x i32> <i32 6, i32 14, i32 22, i32 30>
  %strided.vec493 = shufflevector <32 x float> %inv_zipped.121.sroa.25.144.vecblend, <32 x float> poison, <4 x i32> <i32 7, i32 15, i32 23, i32 31>
  %566 = fadd <4 x float> %strided.vec, %strided.vec490
  %strided.vec495 = shufflevector <32 x float> %inv_fft1_S1_R8_n1.120.sroa.14.128.vecblend, <32 x float> poison, <4 x i32> <i32 0, i32 8, i32 16, i32 24>
  %strided.vec496 = shufflevector <32 x float> %inv_fft1_S1_R8_n1.120.sroa.14.128.vecblend, <32 x float> poison, <4 x i32> <i32 1, i32 9, i32 17, i32 25>
  %strided.vec497 = shufflevector <32 x float> %inv_fft1_S1_R8_n1.120.sroa.14.128.vecblend, <32 x float> poison, <4 x i32> <i32 2, i32 10, i32 18, i32 26>
  %strided.vec498 = shufflevector <32 x float> %inv_fft1_S1_R8_n1.120.sroa.14.128.vecblend, <32 x float> poison, <4 x i32> <i32 3, i32 11, i32 19, i32 27>
  %strided.vec499 = shufflevector <32 x float> %inv_fft1_S1_R8_n1.120.sroa.14.144.vecblend, <32 x float> poison, <4 x i32> <i32 4, i32 12, i32 20, i32 28>
  %strided.vec500 = shufflevector <32 x float> %inv_fft1_S1_R8_n1.120.sroa.14.144.vecblend, <32 x float> poison, <4 x i32> <i32 5, i32 13, i32 21, i32 29>
  %strided.vec501 = shufflevector <32 x float> %inv_fft1_S1_R8_n1.120.sroa.14.144.vecblend, <32 x float> poison, <4 x i32> <i32 6, i32 14, i32 22, i32 30>
  %strided.vec502 = shufflevector <32 x float> %inv_fft1_S1_R8_n1.120.sroa.14.144.vecblend, <32 x float> poison, <4 x i32> <i32 7, i32 15, i32 23, i32 31>
  ...
  %653 = load float, ptr %kernel_fft0_S1_R8_n0.122, align 32, !tbaa !322
  ...
  store float 0.000000e+00, ptr %kernel_fft0_S1_R8_n0.122, align 32, !tbaa !322
...
"for result.s0.i.preheader":                      ; preds = %"for k.s0.n1.preheader"
  ...
  %t2280 = add nsw i32 %677, %678
  %679 = sext i32 %t2280 to i64
  %680 = shl nsw i64 %221, 2
  %681 = sub nsw i64 %680, %679
  %682 = getelementptr inbounds float, ptr %inv_unzipped14, i64 32
  %683 = getelementptr inbounds float, ptr %inv_fft0_S1_R8_n0.013, i64 32
  %684 = shl nsw i64 %221, 1
  %685 = sub nsw i64 %684, %679
  %686 = mul nsw i64 %221, 6
  %687 = sub nsw i64 %686, %679
  %688 = getelementptr inbounds float, ptr %inv_unzipped14, i64 40
  %689 = getelementptr inbounds float, ptr %inv_fft0_S1_R8_n0.013, i64 40
  %690 = getelementptr inbounds float, ptr %inv_unzipped14, i64 28
  %691 = getelementptr inbounds float, ptr %inv_fft0_S1_R8_n0.013, i64 28
  %692 = getelementptr inbounds float, ptr %inv_unzipped14, i64 20
  %693 = getelementptr inbounds float, ptr %inv_fft0_S1_R8_n0.013, i64 20
  %694 = getelementptr inbounds float, ptr %inv_unzipped14, i64 36
  %695 = getelementptr inbounds float, ptr %inv_fft0_S1_R8_n0.013, i64 36
  %696 = getelementptr inbounds float, ptr %inv_unzipped14, i64 44
  %697 = getelementptr inbounds float, ptr %inv_fft0_S1_R8_n0.013, i64 44
  %698 = getelementptr inbounds float, ptr %inv_unzipped14, i64 24
  %699 = getelementptr inbounds float, ptr %inv_fft0_S1_R8_n0.013, i64 24
  %700 = getelementptr inbounds float, ptr %inv_unzipped14, i64 16
  %701 = getelementptr inbounds float, ptr %inv_fft0_S1_R8_n0.013, i64 16
  %702 = sub nsw i64 %221, %679
  %703 = mul nsw i64 %221, 5
  %704 = sub nsw i64 %703, %679
  %705 = getelementptr inbounds float, ptr %inv_unzipped14, i64 48
  %706 = getelementptr inbounds float, ptr %inv_fft0_S1_R8_n0.013, i64 48
  %707 = mul nsw i64 %221, 3
  %708 = sub nsw i64 %707, %679
  %709 = mul nsw i64 %221, 7
  %710 = sub nsw i64 %709, %679
  %711 = getelementptr inbounds float, ptr %inv_unzipped14, i64 56
  %712 = getelementptr inbounds float, ptr %inv_fft0_S1_R8_n0.013, i64 56
  %713 = getelementptr inbounds float, ptr %inv_unzipped14, i64 12
  %714 = getelementptr inbounds float, ptr %inv_fft0_S1_R8_n0.013, i64 12
  %715 = getelementptr inbounds float, ptr %inv_unzipped14, i64 4
  %716 = getelementptr inbounds float, ptr %inv_fft0_S1_R8_n0.013, i64 4
  %717 = getelementptr inbounds float, ptr %inv_unzipped14, i64 52
  %718 = getelementptr inbounds float, ptr %inv_fft0_S1_R8_n0.013, i64 52
  %719 = getelementptr inbounds float, ptr %inv_unzipped14, i64 60
  %720 = getelementptr inbounds float, ptr %inv_fft0_S1_R8_n0.013, i64 60
  %721 = getelementptr inbounds float, ptr %inv_unzipped14, i64 8
  %722 = getelementptr inbounds float, ptr %inv_fft0_S1_R8_n0.013, i64 8
  %723 = getelementptr inbounds float, ptr %inv_unzipped14, i64 10
  %724 = getelementptr inbounds float, ptr %inv_unzipped14, i64 7
  %725 = getelementptr inbounds float, ptr %inv_unzipped14, i64 5
  %726 = getelementptr inbounds float, ptr %inv_unzipped14, i64 9
  %727 = getelementptr inbounds float, ptr %inv_unzipped14, i64 11
  %728 = getelementptr inbounds float, ptr %inv_unzipped14, i64 6
  %729 = getelementptr inbounds float, ptr %inv_unzipped14, i64 14
  %730 = getelementptr inbounds float, ptr %inv_unzipped14, i64 3
  %731 = getelementptr inbounds float, ptr %inv_unzipped14, i64 1
  %732 = getelementptr inbounds float, ptr %inv_unzipped14, i64 13
  %733 = getelementptr inbounds float, ptr %inv_unzipped14, i64 15
  %734 = getelementptr inbounds float, ptr %inv_unzipped14, i64 2
  %735 = getelementptr inbounds float, ptr %inv_fft0_S1_R8_n0.013, i64 10
  %736 = getelementptr inbounds float, ptr %inv_fft0_S1_R8_n0.118, i64 10
  %737 = getelementptr inbounds float, ptr %inv_fft0_S1_R8_n0.013, i64 6
  %738 = getelementptr inbounds float, ptr %inv_fft0_S1_R8_n0.118, i64 6
  %739 = getelementptr inbounds float, ptr %inv_fft0_S1_R8_n0.013, i64 14
  %740 = getelementptr inbounds float, ptr %inv_fft0_S1_R8_n0.118, i64 14
  %741 = getelementptr inbounds float, ptr %inv_fft0_S1_R8_n0.013, i64 2
  %742 = getelementptr inbounds float, ptr %inv_fft0_S1_R8_n0.118, i64 2
  %743 = getelementptr inbounds float, ptr %"inv_X8$1.116", i64 33
  ...
  %750 = and i1 %749, %748
  %751 = getelementptr inbounds float, ptr %kernel_fft0_S1_R8_n0.122, i64 34
  %752 = getelementptr inbounds float, ptr %kernel_fft0_S1_R8_n0.023, i64 34
  %753 = getelementptr inbounds float, ptr %kernel_fft0_S1_R8_n0.122, i64 38
  %754 = getelementptr inbounds float, ptr %kernel_fft0_S1_R8_n0.023, i64 38
  %755 = getelementptr inbounds float, ptr %kernel_fft0_S1_R8_n0.122, i64 37
  %756 = getelementptr inbounds float, ptr %"inv_X8$1.116", i64 37
  %757 = getelementptr inbounds float, ptr %kernel_fft0_S1_R8_n0.023, i64 37
  %758 = getelementptr inbounds float, ptr %kernel_fft0_S1_R8_n0.122, i64 35
  %759 = getelementptr inbounds float, ptr %"inv_X8$1.116", i64 35
  %760 = getelementptr inbounds float, ptr %kernel_fft0_S1_R8_n0.023, i64 35
  %761 = getelementptr inbounds float, ptr %kernel_fft0_S1_R8_n0.122, i64 39
  %762 = getelementptr inbounds float, ptr %"inv_X8$1.116", i64 39
  %763 = getelementptr inbounds float, ptr %kernel_fft0_S1_R8_n0.023, i64 39
  %764 = icmp sgt i32 %70, 0
  %a11 = ashr i32 %64, 3
  %765 = icmp sgt i32 %64, 7
  %766 = add nsw i32 %64, 7
  %767 = ashr i32 %766, 3
  %768 = icmp slt i32 %a11, %767
  ...
  %775 = zext i32 %a11 to i64
  %inv_zipped.121.sroa.0.16.sroa_idx642 = getelementptr inbounds i8, ptr %inv_zipped.121.sroa.0, i64 16
  %776 = getelementptr inbounds float, ptr %"inv_X8$1.017", i64 8
  %777 = getelementptr inbounds float, ptr %"inv_X8$1.116", i64 8
  %inv_zipped.121.sroa.0.28.sroa_idx650 = getelementptr inbounds i8, ptr %inv_zipped.121.sroa.0, i64 28
  %inv_zipped.121.sroa.0.12.sroa_idx637 = getelementptr inbounds i8, ptr %inv_zipped.121.sroa.0, i64 12
  %inv_zipped.121.sroa.0.8.sroa_idx635 = getelementptr inbounds i8, ptr %inv_zipped.121.sroa.0, i64 8
  %inv_zipped.121.sroa.0.12.sroa_idx639 = getelementptr inbounds i8, ptr %inv_zipped.121.sroa.0, i64 12
  %inv_zipped.121.sroa.0.4.sroa_idx633 = getelementptr inbounds i8, ptr %inv_zipped.121.sroa.0, i64 4
  %inv_zipped.121.sroa.0.16.sroa_idx644 = getelementptr inbounds i8, ptr %inv_zipped.121.sroa.0, i64 16
  %inv_zipped.121.sroa.0.28.sroa_idx651 = getelementptr inbounds i8, ptr %inv_zipped.121.sroa.0, i64 28
  %inv_zipped.121.sroa.0.20.sroa_idx647 = getelementptr inbounds i8, ptr %inv_zipped.121.sroa.0, i64 20
  %inv_zipped.121.sroa.0.24.sroa_idx648 = getelementptr inbounds i8, ptr %inv_zipped.121.sroa.0, i64 24
  %inv_zipped.121.sroa.0.16.sroa_idx645 = getelementptr inbounds i8, ptr %inv_zipped.121.sroa.0, i64 16
  %inv_zipped.121.sroa.0.12.sroa_idx640 = getelementptr inbounds i8, ptr %inv_zipped.121.sroa.0, i64 12
  %inv_zipped.121.sroa.0.4.sroa_idx634 = getelementptr inbounds i8, ptr %inv_zipped.121.sroa.0, i64 4
  %inv_zipped.121.sroa.0.8.sroa_idx636 = getelementptr inbounds i8, ptr %inv_zipped.121.sroa.0, i64 8
  %inv_zipped.121.sroa.0.16.sroa_idx643 = getelementptr inbounds i8, ptr %inv_zipped.121.sroa.0, i64 16
  %xtraiter = and i64 %775, 1
  %778 = icmp eq i32 %a11, 1
...
"for result.s0.i":                                ; preds = %"for result.s0.i.preheader", %"end for result.s0.n1"
  %inv_fft1_S1_R8_n1.120.sroa.14.0 = phi <32 x float> [ %inv_fft1_S1_R8_n1.120.sroa.14.144.vecblend, %"for result.s0.i.preheader" ], [ %inv_fft1_S1_R8_n1.120.sroa.14.112.vecblend674, %"end for result.s0.n1" ]
  %indvars.iv246 = phi i64 [ %771, %"for result.s0.i.preheader" ], [ %indvars.iv.next247, %"end for result.s0.n1" ]
  ...
  store <4 x float> %868, ptr %inv_fft0_S1_R8_n0.013, align 32, !tbaa !395
  ...
  store <4 x float> %869, ptr %inv_fft0_S1_R8_n0.118, align 32, !tbaa !124
  ...
  store <4 x float> %886, ptr %inv_zipped.121.sroa.0, align 32, !tbaa !153
  %887 = fadd <4 x float> %870, %870
  %888 = fsub <4 x float> %869, %869
  store <4 x float> %888, ptr %inv_zipped.121.sroa.0.16.sroa_idx642, align 16, !tbaa !153
  %889 = fadd <4 x float> %871, %883
  %inv_zipped.015.sroa.29.32.vec.expand700 = shufflevector <4 x float> %889, <4 x float> poison, <32 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  ...
  %inv_zipped.015.sroa.29.48.vec.expand714 = shufflevector <4 x float> %891, <4 x float> poison, <32 x i32> <i32 poison, i32 poison, i32 poison, i32 poison, i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %inv_zipped.015.sroa.29.48.vecblend715 = shufflevector <32 x float> %inv_zipped.015.sroa.29.32.vec.expand700, <32 x float> %inv_zipped.015.sroa.29.48.vec.expand714, <32 x i32> <i32 0, i32 1, i32 2, i32 3, i32 36, i32 37, i32 38, i32 39, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %892 = fsub <4 x float> %883, %871
  %inv_zipped.121.sroa.25.48.vec.expand593 = shufflevector <4 x float> %892, <4 x float> poison, <32 x i32> <i32 poison, i32 poison, i32 poison, i32 poison, i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  ...
  %inv_zipped.015.sroa.29.64.vec.expand731 = shufflevector <4 x float> %893, <4 x float> poison, <32 x i32> <i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %inv_zipped.015.sroa.29.64.vecblend732 = shufflevector <32 x float> %inv_zipped.015.sroa.29.48.vecblend715, <32 x float> %inv_zipped.015.sroa.29.64.vec.expand731, <32 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 40, i32 41, i32 42, i32 43, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %894 = fsub <4 x float> %874, %882
  %inv_zipped.121.sroa.25.64.vec.expand606 = shufflevector <4 x float> %894, <4 x float> poison, <32 x i32> <i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  ...
  %inv_zipped.015.sroa.29.80.vec.expand734 = shufflevector <4 x float> %895, <4 x float> poison, <32 x i32> <i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %inv_zipped.015.sroa.29.80.vecblend735 = shufflevector <32 x float> %inv_zipped.015.sroa.29.64.vecblend732, <32 x float> %inv_zipped.015.sroa.29.80.vec.expand734, <32 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 44, i32 45, i32 46, i32 47, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %896 = fsub <4 x float> %881, %873
  %inv_zipped.121.sroa.25.80.vec.expand609 = shufflevector <4 x float> %896, <4 x float> poison, <32 x i32> <i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  ...
  %inv_zipped.015.sroa.29.96.vec.expand740 = shufflevector <4 x float> %897, <4 x float> poison, <32 x i32> <i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %inv_zipped.015.sroa.29.96.vecblend741 = shufflevector <32 x float> %inv_zipped.015.sroa.29.80.vecblend735, <32 x float> %inv_zipped.015.sroa.29.96.vec.expand740, <32 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 48, i32 49, i32 50, i32 51, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %898 = fsub <4 x float> %876, %880
  %inv_zipped.121.sroa.25.96.vec.expand615 = shufflevector <4 x float> %898, <4 x float> poison, <32 x i32> <i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  ...
  %inv_zipped.015.sroa.29.128.vec.expand752 = shufflevector <4 x float> %901, <4 x float> poison, <32 x i32> <i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison>
  %inv_zipped.015.sroa.29.128.vecblend753 = shufflevector <32 x float> %inv_zipped.015.sroa.29.112.vecblend747, <32 x float> %inv_zipped.015.sroa.29.128.vec.expand752, <32 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 56, i32 57, i32 58, i32 59, i32 poison, i32 poison, i32 poison, i32 poison>
  %902 = fsub <4 x float> %878, %878
  %inv_zipped.121.sroa.25.128.vec.expand627 = shufflevector <4 x float> %902, <4 x float> poison, <32 x i32> <i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison>
  %inv_zipped.121.sroa.25.128.vecblend628 = shufflevector <32 x float> %inv_zipped.121.sroa.25.112.vecblend622, <32 x float> %inv_zipped.121.sroa.25.128.vec.expand627, <32 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 56, i32 57, i32 58, i32 59, i32 poison, i32 poison, i32 poison, i32 poison>
  %903 = fadd <4 x float> %878, %878
  %inv_zipped.015.sroa.29.144.vec.expand755 = shufflevector <4 x float> %903, <4 x float> poison, <32 x i32> <i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 0, i32 1, i32 2, i32 3>
  %inv_zipped.015.sroa.29.144.vecblend756 = shufflevector <32 x float> %inv_zipped.015.sroa.29.128.vecblend753, <32 x float> %inv_zipped.015.sroa.29.144.vec.expand755, <32 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 60, i32 61, i32 62, i32 63>
  %904 = fsub <4 x float> %877, %877
  %inv_zipped.121.sroa.25.144.vec.expand630 = shufflevector <4 x float> %904, <4 x float> poison, <32 x i32> <i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 0, i32 1, i32 2, i32 3>
  %inv_zipped.121.sroa.25.144.vecblend631 = shufflevector <32 x float> %inv_zipped.121.sroa.25.128.vecblend628, <32 x float> %inv_zipped.121.sroa.25.144.vec.expand630, <32 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 60, i32 61, i32 62, i32 63>
  ...
  %inv_zipped.015.sroa.0.12.vec.extract = extractelement <4 x float> %885, i64 3
  %inv_zipped.015.sroa.14.28.vec.extract = extractelement <4 x float> %887, i64 3
  %934 = fadd float %inv_zipped.015.sroa.0.12.vec.extract, %inv_zipped.015.sroa.14.28.vec.extract
  ...
  %944 = fsub float %inv_zipped.015.sroa.14.28.vec.extract, %inv_zipped.015.sroa.0.12.vec.extract
  ...
  store float %955, ptr %inv_unzipped14, align 32, !tbaa !463
  ...
  store float %962, ptr %"inv_X8$1.017", align 32, !tbaa !212
  ...
  store float %989, ptr %"inv_X8$1.116", align 32, !tbaa !214
  ...
  %strided.vec513 = shufflevector <32 x float> %inv_zipped.015.sroa.29.128.vecblend753, <32 x float> poison, <4 x i32> <i32 0, i32 8, i32 16, i32 24>
  %strided.vec514 = shufflevector <32 x float> %inv_zipped.015.sroa.29.128.vecblend753, <32 x float> poison, <4 x i32> <i32 1, i32 9, i32 17, i32 25>
  %strided.vec515 = shufflevector <32 x float> %inv_zipped.015.sroa.29.128.vecblend753, <32 x float> poison, <4 x i32> <i32 2, i32 10, i32 18, i32 26>
  %strided.vec516 = shufflevector <32 x float> %inv_zipped.015.sroa.29.128.vecblend753, <32 x float> poison, <4 x i32> <i32 3, i32 11, i32 19, i32 27>
  %strided.vec517 = shufflevector <32 x float> %inv_zipped.015.sroa.29.144.vecblend756, <32 x float> poison, <4 x i32> <i32 4, i32 12, i32 20, i32 28>
  %strided.vec518 = shufflevector <32 x float> %inv_zipped.015.sroa.29.144.vecblend756, <32 x float> poison, <4 x i32> <i32 5, i32 13, i32 21, i32 29>
  %strided.vec519 = shufflevector <32 x float> %inv_zipped.015.sroa.29.144.vecblend756, <32 x float> poison, <4 x i32> <i32 6, i32 14, i32 22, i32 30>
  %strided.vec520 = shufflevector <32 x float> %inv_zipped.015.sroa.29.144.vecblend756, <32 x float> poison, <4 x i32> <i32 7, i32 15, i32 23, i32 31>
  %1015 = fadd <4 x float> %strided.vec513, %strided.vec517
  %strided.vec522 = shufflevector <32 x float> %inv_zipped.121.sroa.25.128.vecblend628, <32 x float> poison, <4 x i32> <i32 0, i32 8, i32 16, i32 24>
  %strided.vec523 = shufflevector <32 x float> %inv_zipped.121.sroa.25.128.vecblend628, <32 x float> poison, <4 x i32> <i32 1, i32 9, i32 17, i32 25>
  %strided.vec524 = shufflevector <32 x float> %inv_zipped.121.sroa.25.128.vecblend628, <32 x float> poison, <4 x i32> <i32 2, i32 10, i32 18, i32 26>
  %strided.vec525 = shufflevector <32 x float> %inv_zipped.121.sroa.25.128.vecblend628, <32 x float> poison, <4 x i32> <i32 3, i32 11, i32 19, i32 27>
  %strided.vec526 = shufflevector <32 x float> %inv_zipped.121.sroa.25.144.vecblend631, <32 x float> poison, <4 x i32> <i32 4, i32 12, i32 20, i32 28>
  %strided.vec527 = shufflevector <32 x float> %inv_zipped.121.sroa.25.144.vecblend631, <32 x float> poison, <4 x i32> <i32 5, i32 13, i32 21, i32 29>
  %strided.vec528 = shufflevector <32 x float> %inv_zipped.121.sroa.25.144.vecblend631, <32 x float> poison, <4 x i32> <i32 6, i32 14, i32 22, i32 30>
  %strided.vec529 = shufflevector <32 x float> %inv_zipped.121.sroa.25.144.vecblend631, <32 x float> poison, <4 x i32> <i32 7, i32 15, i32 23, i32 31>
  ...
  store <2 x float> %1114, ptr %inv_fft0_S1_R8_n0.013, align 32, !tbaa !523
  %1115 = shufflevector <4 x float> %1055, <4 x float> %1038, <2 x i32> <i32 3, i32 7>
  store <2 x float> %1115, ptr %inv_fft0_S1_R8_n0.118, align 32, !tbaa !525
  %1116 = load float, ptr %"inv_X8$1.116", align 32, !tbaa !214
  ...
  %fwd_fft0_S1_R8_n0.0.value.x4 = shufflevector <4 x float> %1121, <4 x float> undef, <4 x i32> <i32 3, i32 2, i32 1, i32 0>
  %1127 = fsub <4 x float> zeroinitializer, %1126
  %fwd_fft0_S1_R8_n0.1.value.x4 = shufflevector <4 x float> %1127, <4 x float> poison, <4 x i32> <i32 3, i32 2, i32 1, i32 0>
  ...
  store float 0.000000e+00, ptr %"inv_X8$1.116", align 32, !tbaa !214
  %fwd_fft0_S1_R8_n0.0.value.s.x4 = fadd <4 x float> %1124, %1123
  %fwd_fft0_S1_R8_n0.1.value.s.x4 = fsub <4 x float> %1117, %1119
  %1128 = fmul <4 x float> %fwd_fft0_S1_R8_n0.0.value.s.x4, <float 5.000000e-01, float 5.000000e-01, float 5.000000e-01, float 5.000000e-01>
  store <4 x float> %1128, ptr %260, align 4, !tbaa !492
  %1129 = fmul <4 x float> %fwd_fft0_S1_R8_n0.1.value.s.x4, <float 5.000000e-01, float 5.000000e-01, float 5.000000e-01, float 5.000000e-01>
  store <4 x float> %1129, ptr %491, align 4, !tbaa !491
  %fwd_fft0_S1_R8_n0.0.value.x490 = shufflevector <4 x float> %1128, <4 x float> undef, <4 x i32> <i32 3, i32 2, i32 1, i32 0>
  %1130 = fsub <4 x float> zeroinitializer, %1129
  %fwd_fft0_S1_R8_n0.1.value.x491 = shufflevector <4 x float> %1130, <4 x float> poison, <4 x i32> <i32 3, i32 2, i32 1, i32 0>
  store <4 x float> %fwd_fft0_S1_R8_n0.0.value.x490, ptr %267, align 16, !tbaa !47
  store <4 x float> %fwd_fft0_S1_R8_n0.1.value.x491, ptr %388, align 16, !tbaa !475
...
"assert succeeded93":                             ; preds = %"for result.s0.i"
  br i1 %750, label %"produce inv_X8", label %"assert failed94", !prof !26

"assert failed94":                                ; preds = %"assert succeeded93"
  %1141 = tail call i32 @halide_error_explicit_bounds_too_small(ptr null, ptr nonnull @str.13, ptr nonnull @str.12, i32 0, i32 7, i32 %84, i32 %b2) #2
  br label %destructor_block

"produce inv_X8":                                 ; preds = %"assert succeeded93"
  %1142 = load <2 x float>, ptr %"inv_X8$1.017", align 32, !tbaa !535
  ...
  %1351 = load <2 x float>, ptr %kernel_fft0_S1_R8_n0.023, align 32, !tbaa !591
  %1352 = fmul <2 x float> %1142, %1351
  %1353 = extractelement <2 x float> %1352, i64 0
  %1354 = load <2 x float>, ptr %kernel_fft0_S1_R8_n0.122, align 32, !tbaa !274
  ...
  store float %1430, ptr %inv_zipped.121.sroa.0.28.sroa_idx650, align 4, !tbaa !192
  ...
  %inv_zipped.015.sroa.14.16.vec.insert = insertelement <4 x float> %1440, float %1420, i64 3
  ...
  store <4 x float> %1454, ptr %inv_zipped.121.sroa.0.12.sroa_idx637, align 4, !tbaa !600
  ...
  store float %1462, ptr %inv_zipped.121.sroa.0.8.sroa_idx635, align 8, !tbaa !601
  ...
  store <2 x float> %1476, ptr %inv_zipped.121.sroa.0, align 32, !tbaa !603
  %inv_zipped.121.sroa.0.12.inv_zipped.121.sroa.0.12.571 = load float, ptr %inv_zipped.121.sroa.0.12.sroa_idx639, align 4, !tbaa !189
  %inv_zipped.015.sroa.0.4.vec.extract = extractelement <2 x float> %1465, i64 1
  %inv_zipped.121.sroa.0.4.inv_zipped.121.sroa.0.4.566 = load float, ptr %inv_zipped.121.sroa.0.4.sroa_idx633, align 4, !tbaa !173
  %1477 = shufflevector <2 x float> %1464, <2 x float> poison, <4 x i32> <i32 0, i32 poison, i32 poison, i32 poison>
  %1478 = insertelement <4 x float> %1477, float %inv_zipped.015.sroa.0.4.vec.extract, i64 1
  ...
  %1481 = fadd <4 x float> %inv_zipped.015.sroa.14.16.vec.insert, %1480
  %1482 = shufflevector <4 x float> %1481, <4 x float> poison, <4 x i32> <i32 3, i32 2, i32 1, i32 0>
  %inv_zipped.121.sroa.0.16.inv_zipped.121.sroa.0.16. = load <4 x float>, ptr %inv_zipped.121.sroa.0.16.sroa_idx644, align 16, !tbaa !604
  %1483 = shufflevector <2 x float> %1474, <2 x float> poison, <4 x i32> <i32 0, i32 poison, i32 poison, i32 poison>
  %1484 = insertelement <4 x float> %1483, float %inv_zipped.121.sroa.0.4.inv_zipped.121.sroa.0.4.566, i64 1
  %1485 = insertelement <4 x float> %1484, float %1462, i64 2
  %1486 = insertelement <4 x float> %1485, float %inv_zipped.121.sroa.0.12.inv_zipped.121.sroa.0.12.571, i64 3
  %1487 = fadd <4 x float> %inv_zipped.121.sroa.0.16.inv_zipped.121.sroa.0.16., %1486
  %1488 = shufflevector <4 x float> %1487, <4 x float> poison, <4 x i32> <i32 3, i32 2, i32 1, i32 0>
  %1489 = fsub <4 x float> %inv_zipped.015.sroa.14.16.vec.insert, %1480
  %1490 = shufflevector <4 x float> %1489, <4 x float> poison, <4 x i32> <i32 3, i32 2, i32 1, i32 0>
  %1491 = fsub <4 x float> %inv_zipped.121.sroa.0.16.inv_zipped.121.sroa.0.16., %1486
  %1492 = shufflevector <4 x float> %1491, <4 x float> poison, <4 x i32> <i32 3, i32 2, i32 1, i32 0>
  store <4 x float> %1482, ptr %inv_fft0_S1_R8_n0.013, align 32, !tbaa !395
  store <4 x float> %1488, ptr %inv_fft0_S1_R8_n0.118, align 32, !tbaa !124
...
"for inv_fft0_S1_R8_n0.s1.n1":                    ; preds = %"produce inv_X8", %"for inv_fft0_S1_R8_n0.s1.n1"
  ...
  %1494 = getelementptr inbounds float, ptr %"inv_X8$1.017", i64 %1493
  %1495 = load float, ptr %1494, align 32, !tbaa !30
  %1496 = getelementptr inbounds float, ptr %kernel_fft0_S1_R8_n0.023, i64 %1493
  %1497 = load float, ptr %1496, align 32, !tbaa !320
  %1498 = fmul float %1495, %1497
  %1499 = getelementptr inbounds float, ptr %"inv_X8$1.116", i64 %1493
  %1500 = load float, ptr %1499, align 32, !tbaa !494
  %1501 = getelementptr inbounds float, ptr %kernel_fft0_S1_R8_n0.122, i64 %1493
  %1502 = load float, ptr %1501, align 32, !tbaa !321
  %1503 = fmul float %1500, %1502
  %1504 = fsub float %1498, %1503
  %1505 = or i64 %1493, 4
  %1506 = getelementptr inbounds float, ptr %"inv_X8$1.017", i64 %1505
  %1507 = load float, ptr %1506, align 16, !tbaa !30
  %1508 = getelementptr inbounds float, ptr %kernel_fft0_S1_R8_n0.023, i64 %1505
  %1509 = load float, ptr %1508, align 16, !tbaa !320
  %1510 = fmul float %1507, %1509
  %1511 = getelementptr inbounds float, ptr %"inv_X8$1.116", i64 %1505
  %1512 = load float, ptr %1511, align 16, !tbaa !494
  %1513 = getelementptr inbounds float, ptr %kernel_fft0_S1_R8_n0.122, i64 %1505
  ...
  %1525 = or i64 %1493, 2
  %1526 = getelementptr inbounds float, ptr %"inv_X8$1.017", i64 %1525
  %1527 = load float, ptr %1526, align 8, !tbaa !30
  %1528 = getelementptr inbounds float, ptr %kernel_fft0_S1_R8_n0.023, i64 %1525
  %1529 = load float, ptr %1528, align 8, !tbaa !320
  %1530 = fmul float %1527, %1529
  %1531 = getelementptr inbounds float, ptr %"inv_X8$1.116", i64 %1525
  %1532 = load float, ptr %1531, align 8, !tbaa !494
  %1533 = getelementptr inbounds float, ptr %kernel_fft0_S1_R8_n0.122, i64 %1525
  %1534 = load float, ptr %1533, align 8, !tbaa !321
  %1535 = fmul float %1532, %1534
  %1536 = fsub float %1530, %1535
  %1537 = or i64 %1493, 6
  %1538 = getelementptr inbounds float, ptr %"inv_X8$1.017", i64 %1537
  %1539 = load float, ptr %1538, align 8, !tbaa !30
  %1540 = getelementptr inbounds float, ptr %kernel_fft0_S1_R8_n0.023, i64 %1537
  %1541 = load float, ptr %1540, align 8, !tbaa !320
  %1542 = fmul float %1539, %1541
  %1543 = getelementptr inbounds float, ptr %"inv_X8$1.116", i64 %1537
  %1544 = load float, ptr %1543, align 8, !tbaa !494
  %1545 = getelementptr inbounds float, ptr %kernel_fft0_S1_R8_n0.122, i64 %1537
  ...
  %1571 = or i64 %1493, 1
  %1572 = getelementptr inbounds float, ptr %"inv_X8$1.017", i64 %1571
  %1573 = load float, ptr %1572, align 4, !tbaa !30
  %1574 = getelementptr inbounds float, ptr %kernel_fft0_S1_R8_n0.023, i64 %1571
  %1575 = load float, ptr %1574, align 4, !tbaa !320
  %1576 = fmul float %1573, %1575
  %1577 = getelementptr inbounds float, ptr %"inv_X8$1.116", i64 %1571
  %1578 = load float, ptr %1577, align 4, !tbaa !494
  %1579 = getelementptr inbounds float, ptr %kernel_fft0_S1_R8_n0.122, i64 %1571
  %1580 = load float, ptr %1579, align 4, !tbaa !321
  %1581 = fmul float %1578, %1580
  %1582 = fsub float %1576, %1581
  %1583 = or i64 %1493, 5
  %1584 = getelementptr inbounds float, ptr %"inv_X8$1.017", i64 %1583
  %1585 = load float, ptr %1584, align 4, !tbaa !30
  %1586 = getelementptr inbounds float, ptr %kernel_fft0_S1_R8_n0.023, i64 %1583
  %1587 = load float, ptr %1586, align 4, !tbaa !320
  %1588 = fmul float %1585, %1587
  %1589 = getelementptr inbounds float, ptr %"inv_X8$1.116", i64 %1583
  %1590 = load float, ptr %1589, align 4, !tbaa !494
  %1591 = getelementptr inbounds float, ptr %kernel_fft0_S1_R8_n0.122, i64 %1583
  ...
  %1603 = or i64 %1493, 3
  %1604 = getelementptr inbounds float, ptr %"inv_X8$1.017", i64 %1603
  %1605 = load float, ptr %1604, align 4, !tbaa !30
  %1606 = getelementptr inbounds float, ptr %kernel_fft0_S1_R8_n0.023, i64 %1603
  %1607 = load float, ptr %1606, align 4, !tbaa !320
  %1608 = fmul float %1605, %1607
  %1609 = getelementptr inbounds float, ptr %"inv_X8$1.116", i64 %1603
  %1610 = load float, ptr %1609, align 4, !tbaa !494
  %1611 = getelementptr inbounds float, ptr %kernel_fft0_S1_R8_n0.122, i64 %1603
  %1612 = load float, ptr %1611, align 4, !tbaa !321
  %1613 = fmul float %1610, %1612
  %1614 = fsub float %1608, %1613
  %1615 = or i64 %1493, 7
  %1616 = getelementptr inbounds float, ptr %"inv_X8$1.017", i64 %1615
  %1617 = load float, ptr %1616, align 4, !tbaa !30
  %1618 = getelementptr inbounds float, ptr %kernel_fft0_S1_R8_n0.023, i64 %1615
  %1619 = load float, ptr %1618, align 4, !tbaa !320
  %1620 = fmul float %1617, %1619
  %1621 = getelementptr inbounds float, ptr %"inv_X8$1.116", i64 %1615
  %1622 = load float, ptr %1621, align 4, !tbaa !494
  %1623 = getelementptr inbounds float, ptr %kernel_fft0_S1_R8_n0.122, i64 %1615
  ...
  %1674 = getelementptr inbounds float, ptr %inv_fft0_S1_R8_n0.013, i64 %1493
  store float %1658, ptr %1674, align 32, !tbaa !605
  %1675 = getelementptr inbounds float, ptr %inv_fft0_S1_R8_n0.118, i64 %1493
  store float %1659, ptr %1675, align 32, !tbaa !606
  %1676 = getelementptr inbounds float, ptr %inv_fft0_S1_R8_n0.013, i64 %1571
  store float %1660, ptr %1676, align 4, !tbaa !605
  %1677 = getelementptr inbounds float, ptr %inv_fft0_S1_R8_n0.118, i64 %1571
  store float %1661, ptr %1677, align 4, !tbaa !606
  %1678 = getelementptr inbounds float, ptr %inv_fft0_S1_R8_n0.013, i64 %1525
  store float %1662, ptr %1678, align 8, !tbaa !605
  %1679 = getelementptr inbounds float, ptr %inv_fft0_S1_R8_n0.118, i64 %1525
  store float %1663, ptr %1679, align 8, !tbaa !606
  %1680 = getelementptr inbounds float, ptr %inv_fft0_S1_R8_n0.013, i64 %1603
  store float %1664, ptr %1680, align 4, !tbaa !605
  %1681 = getelementptr inbounds float, ptr %inv_fft0_S1_R8_n0.118, i64 %1603
  store float %1665, ptr %1681, align 4, !tbaa !606
  %1682 = getelementptr inbounds float, ptr %inv_fft0_S1_R8_n0.013, i64 %1505
  store float %1666, ptr %1682, align 16, !tbaa !605
  %1683 = getelementptr inbounds float, ptr %inv_fft0_S1_R8_n0.118, i64 %1505
  store float %1667, ptr %1683, align 16, !tbaa !606
  %1684 = getelementptr inbounds float, ptr %inv_fft0_S1_R8_n0.013, i64 %1583
  store float %1668, ptr %1684, align 4, !tbaa !605
  %1685 = getelementptr inbounds float, ptr %inv_fft0_S1_R8_n0.118, i64 %1583
  store float %1669, ptr %1685, align 4, !tbaa !606
  %1686 = getelementptr inbounds float, ptr %inv_fft0_S1_R8_n0.013, i64 %1537
  store float %1670, ptr %1686, align 8, !tbaa !605
  %1687 = getelementptr inbounds float, ptr %inv_fft0_S1_R8_n0.118, i64 %1537
  store float %1671, ptr %1687, align 8, !tbaa !606
  %1688 = getelementptr inbounds float, ptr %inv_fft0_S1_R8_n0.013, i64 %1615
  store float %1672, ptr %1688, align 4, !tbaa !605
  %1689 = getelementptr inbounds float, ptr %inv_fft0_S1_R8_n0.118, i64 %1615
...
"produce inv_zipped":                             ; preds = %"for inv_fft0_S1_R8_n0.s1.n1"
  store float %1558, ptr %inv_zipped.121.sroa.0.28.sroa_idx651, align 4, !tbaa !192
  store float %1560, ptr %inv_zipped.121.sroa.0.20.sroa_idx647, align 4, !tbaa !185
  store float %1568, ptr %inv_zipped.121.sroa.0.24.sroa_idx648, align 8, !tbaa !607
  store float %1570, ptr %inv_zipped.121.sroa.0.16.sroa_idx645, align 16, !tbaa !609
  store float %1636, ptr %inv_zipped.121.sroa.0.12.sroa_idx640, align 4, !tbaa !189
  store float %1638, ptr %inv_zipped.121.sroa.0.4.sroa_idx634, align 4, !tbaa !173
  store float %1650, ptr %inv_zipped.121.sroa.0.8.sroa_idx636, align 8, !tbaa !601
  store float %1657, ptr %inv_zipped.121.sroa.0, align 32, !tbaa !611
  %1690 = load <4 x float>, ptr %inv_fft0_S1_R8_n0.013, align 32, !tbaa !395
  %1691 = load <4 x float>, ptr %716, align 16, !tbaa !390
  store <4 x float> %1691, ptr %inv_zipped.121.sroa.0, align 32, !tbaa !613
  %1692 = load <4 x float>, ptr %inv_fft0_S1_R8_n0.118, align 32, !tbaa !124
  ...
  store <4 x float> %1699, ptr %inv_zipped.121.sroa.0.16.sroa_idx643, align 16, !tbaa !153
  ...
  store <4 x float> %1755, ptr %"inv_X8$1.017", align 32, !tbaa !32
  ...
  store <4 x float> %1758, ptr %"inv_X8$1.116", align 32, !tbaa !616
  ...
  %inv_fft1_S1_R8_n1.120.sroa.14.32.vec.expand656 = shufflevector <4 x float> %1764, <4 x float> poison, <32 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %inv_fft1_S1_R8_n1.120.sroa.14.32.vecblend657 = shufflevector <32 x float> %inv_fft1_S1_R8_n1.120.sroa.14.32.vec.expand656, <32 x float> %inv_fft1_S1_R8_n1.120.sroa.14.0, <32 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 56, i32 57, i32 58, i32 59, i32 60, i32 61, i32 62, i32 63>
  %inv_fft1_S1_R8_n1.120.sroa.14.48.vec.expand660 = shufflevector <4 x float> %1766, <4 x float> poison, <32 x i32> <i32 poison, i32 poison, i32 poison, i32 poison, i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %inv_fft1_S1_R8_n1.120.sroa.14.48.vecblend661 = shufflevector <32 x float> %inv_fft1_S1_R8_n1.120.sroa.14.32.vecblend657, <32 x float> %inv_fft1_S1_R8_n1.120.sroa.14.48.vec.expand660, <32 x i32> <i32 0, i32 1, i32 2, i32 3, i32 36, i32 37, i32 38, i32 39, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31>
  %inv_fft1_S1_R8_n1.120.sroa.14.64.vec.expand664 = shufflevector <4 x float> %1768, <4 x float> poison, <32 x i32> <i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %inv_fft1_S1_R8_n1.120.sroa.14.64.vecblend665 = shufflevector <32 x float> %inv_fft1_S1_R8_n1.120.sroa.14.48.vecblend661, <32 x float> %inv_fft1_S1_R8_n1.120.sroa.14.64.vec.expand664, <32 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 40, i32 41, i32 42, i32 43, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31>
  %inv_fft1_S1_R8_n1.120.sroa.14.80.vec.expand667 = shufflevector <4 x float> %1770, <4 x float> poison, <32 x i32> <i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %inv_fft1_S1_R8_n1.120.sroa.14.80.vecblend668 = shufflevector <32 x float> %inv_fft1_S1_R8_n1.120.sroa.14.64.vecblend665, <32 x float> %inv_fft1_S1_R8_n1.120.sroa.14.80.vec.expand667, <32 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 44, i32 45, i32 46, i32 47, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31>
  %inv_fft1_S1_R8_n1.120.sroa.14.96.vec.expand670 = shufflevector <4 x float> %1772, <4 x float> poison, <32 x i32> <i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %inv_fft1_S1_R8_n1.120.sroa.14.96.vecblend671 = shufflevector <32 x float> %inv_fft1_S1_R8_n1.120.sroa.14.80.vecblend668, <32 x float> %inv_fft1_S1_R8_n1.120.sroa.14.96.vec.expand670, <32 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 48, i32 49, i32 50, i32 51, i32 poison, i32 poison, i32 poison, i32 poison, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31>
  %inv_fft1_S1_R8_n1.120.sroa.14.112.vec.expand673 = shufflevector <4 x float> %1774, <4 x float> poison, <32 x i32> <i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %inv_fft1_S1_R8_n1.120.sroa.14.112.vecblend674 = shufflevector <32 x float> %inv_fft1_S1_R8_n1.120.sroa.14.96.vecblend671, <32 x float> %inv_fft1_S1_R8_n1.120.sroa.14.112.vec.expand673, <32 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 52, i32 53, i32 54, i32 55, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31>
  store <4 x float> %1759, ptr %inv_unzipped14, align 32, !tbaa !617
  ...
  br i1 %764, label %"for result.s0.n1.preheader", label %"end for result.s0.n1", !prof !26
...
"for result.s0.n1":                               ; preds = %"for result.s0.n1.preheader", %"end for result.s0.n0.n0107"
  %indvars.iv243 = phi i64 [ %770, %"for result.s0.n1.preheader" ], [ %indvars.iv.next244, %"end for result.s0.n0.n0107" ]
  br i1 %765, label %"for result.s0.n0.n0.preheader", label %"end for result.s0.n0.n0", !prof !26
...
"for result.s0.n0.n0.preheader":                  ; preds = %"for result.s0.n1"
  ...
  br i1 %778, label %"end for result.s0.n0.n0.loopexit.unr-lcssa", label %"for result.s0.n0.n0"
...
"for result.s0.n0.n0":                            ; preds = %"for result.s0.n0.n0.preheader", %"for result.s0.n0.n0"
  ...
  %1783 = getelementptr inbounds float, ptr %inv_unzipped14, i64 %1782
  ...
  %1791 = getelementptr inbounds float, ptr %inv_unzipped14, i64 %1790
...
"for result.s0.n0.n0.epil":                       ; preds = %"end for result.s0.n0.n0.loopexit.unr-lcssa"
  ...
  %1799 = getelementptr inbounds float, ptr %inv_unzipped14, i64 %1798
...
"end for result.s0.n0.n0":                        ; preds = %"for result.s0.n0.n0.epil", %"end for result.s0.n0.n0.loopexit.unr-lcssa", %"for result.s0.n1"
  br i1 %768, label %"for result.s0.n0.n0106.preheader", label %"end for result.s0.n0.n0107", !prof !26

"for result.s0.n0.n0106.preheader":               ; preds = %"end for result.s0.n0.n0"
  %1804 = shl nsw i64 %indvars.iv243, 3
  %1805 = add nsw i64 %773, %1804
  %1806 = getelementptr inbounds float, ptr %inv_unzipped14, i64 %1805
...
; Function Attrs: nounwind
define i32 @_Z96FftConvolve8x8xRHalide_x86_64_linux_avx_avx2_c_plus_plus_name_mangling_fma_no_runtime_sse41_argvPPv(ptr nocapture readonly %0) local_unnamed_addr #2 {
entry:
  ...
  %6 = tail call i32 @_Z91FftConvolve8x8xRHalide_x86_64_linux_avx_avx2_c_plus_plus_name_mangling_fma_no_runtime_sse41P15halide_buffer_tS0_S0_(ptr %1, ptr %3, ptr %5) #6
  ret i32 %6
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none)
define nonnull ptr @_Z100FftConvolve8x8xRHalide_x86_64_linux_avx_avx2_c_plus_plus_name_mangling_fma_no_runtime_sse41_metadatav() local_unnamed_addr #3 {
entry:
  ret ptr @_Z100FftConvolve8x8xRHalide_x86_64_linux_avx_avx2_c_plus_plus_name_mangling_fma_no_runtime_sse41_metadatav_storage
}

; Function Attrs: nounwind
define i32 @_Z91FftConvolve8x8xRHalide_x86_64_linux_avx_avx2_c_plus_plus_name_mangling_fma_no_runtime_sse41P8buffer_tS0_S0_(ptr %input, ptr %kernel, ptr %result) local_unnamed_addr #1 {
entry:
  %0 = alloca %struct.halide_buffer_t, align 8
  %t2319 = alloca [12 x i32], align 4
  %1 = alloca %struct.halide_buffer_t, align 8
  %t2315 = alloca [8 x i32], align 4
  %2 = alloca %struct.halide_buffer_t, align 8
  %t2311 = alloca [12 x i32], align 4
  %3 = getelementptr inbounds %struct.halide_buffer_t, ptr %2, i64 0, i32 2
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(48) %t2311, i8 0, i64 48, i1 false)
  ...
  store ptr %t2311, ptr %8, align 8, !tbaa !18
  %9 = getelementptr inbounds %struct.halide_buffer_t, ptr %2, i64 0, i32 3
  store i64 0, ptr %9, align 8, !tbaa !25
  %10 = getelementptr inbounds %struct.halide_buffer_t, ptr %1, i64 0, i32 2
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(32) %t2315, i8 0, i64 32, i1 false)
  ...
  store ptr %t2315, ptr %15, align 8, !tbaa !18
  %16 = getelementptr inbounds %struct.halide_buffer_t, ptr %1, i64 0, i32 3
  store i64 0, ptr %16, align 8, !tbaa !25
  %17 = getelementptr inbounds %struct.halide_buffer_t, ptr %0, i64 0, i32 2
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(48) %t2319, i8 0, i64 48, i1 false)
  ...
  store ptr %t2319, ptr %22, align 8, !tbaa !18
  %23 = getelementptr inbounds %struct.halide_buffer_t, ptr %0, i64 0, i32 3
  store i64 0, ptr %23, align 8, !tbaa !25
  %t2314 = call i32 @halide_upgrade_buffer_t(ptr null, ptr nonnull @str.3, ptr %input, ptr nonnull %2) #2
  %24 = icmp eq i32 %t2314, 0
  br i1 %24, label %"assert succeeded", label %destructor_block, !prof !26

"assert succeeded":                               ; preds = %entry
  %t2318 = call i32 @halide_upgrade_buffer_t(ptr null, ptr nonnull @str.2, ptr %kernel, ptr nonnull %1) #2
  %25 = icmp eq i32 %t2318, 0
  br i1 %25, label %"assert succeeded2", label %destructor_block, !prof !26

destructor_block:                                 ; preds = %false_bb19, %true_bb18, %false_bb12, %true_bb11, %false_bb, %true_bb, %"assert succeeded4", %"assert succeeded2", %"assert succeeded", %entry
  %26 = phi i32 [ %t2314, %entry ], [ %t2318, %"assert succeeded" ], [ %t2322, %"assert succeeded2" ], [ %t2323, %"assert succeeded4" ], [ %t2312, %true_bb ], [ %t2313, %false_bb ], [ %t2316, %true_bb11 ], [ %t2317, %false_bb12 ], [ %t2320, %true_bb18 ], [ %t2321, %false_bb19 ]
  ret i32 %26

"assert succeeded2":                              ; preds = %"assert succeeded"
  %t2322 = call i32 @halide_upgrade_buffer_t(ptr null, ptr nonnull @str, ptr %result, ptr nonnull %0) #2
  %27 = icmp eq i32 %t2322, 0
  br i1 %27, label %"assert succeeded4", label %destructor_block, !prof !26

"assert succeeded4":                              ; preds = %"assert succeeded2"
  %t2323 = call i32 @_Z91FftConvolve8x8xRHalide_x86_64_linux_avx_avx2_c_plus_plus_name_mangling_fma_no_runtime_sse41P15halide_buffer_tS0_S0_(ptr nonnull %2, ptr nonnull %1, ptr nonnull %0) #2
  %28 = icmp eq i32 %t2323, 0
...
true_bb:                                          ; preds = %"assert succeeded6"
  %t2312 = call i32 @halide_downgrade_buffer_t(ptr null, ptr nonnull @str.3, ptr nonnull %2, ptr %input) #2
  %34 = icmp eq i32 %t2312, 0
  br i1 %34, label %after_bb, label %destructor_block, !prof !26

false_bb:                                         ; preds = %"assert succeeded6"
  %t2313 = call i32 @halide_downgrade_buffer_t_device_fields(ptr null, ptr nonnull @str.3, ptr nonnull %2, ptr %input) #2
  %35 = icmp eq i32 %t2313, 0
...
true_bb11:                                        ; preds = %after_bb
  %t2316 = call i32 @halide_downgrade_buffer_t(ptr null, ptr nonnull @str.2, ptr nonnull %1, ptr %kernel) #2
  %41 = icmp eq i32 %t2316, 0
  br i1 %41, label %after_bb13, label %destructor_block, !prof !26

false_bb12:                                       ; preds = %after_bb
  %t2317 = call i32 @halide_downgrade_buffer_t_device_fields(ptr null, ptr nonnull @str.2, ptr nonnull %1, ptr %kernel) #2
  %42 = icmp eq i32 %t2317, 0
...
true_bb18:                                        ; preds = %after_bb13
  %t2320 = call i32 @halide_downgrade_buffer_t(ptr null, ptr nonnull @str, ptr nonnull %0, ptr %result) #2
  br label %destructor_block

false_bb19:                                       ; preds = %after_bb13
  %t2321 = call i32 @halide_downgrade_buffer_t_device_fields(ptr null, ptr nonnull @str, ptr nonnull %0, ptr %result) #2
  br label %destructor_block
}
...
!443 = !{!444, !444, i64 0}
!444 = !{!"fwd_X8.0.width1.base7", !445, i64 0}
!445 = !{!"fwd_X8.0.width2.base6", !446, i64 0}
!446 = !{!"fwd_X8.0.width4.base4", !447, i64 0}
!447 = !{!"fwd_X8.0.width8.base0", !448, i64 0}
!448 = !{!"fwd_X8.0.width16.base0", !354, i64 0}
!449 = !{!450, !450, i64 0}
!450 = !{!"fwd_X8.0.width1.base5", !451, i64 0}
!451 = !{!"fwd_X8.0.width2.base4", !446, i64 0}
!452 = !{!453, !453, i64 0}
!453 = !{!"fwd_X8.0.width1.base6", !445, i64 0}
!454 = !{!455, !455, i64 0}
!455 = !{!"fwd_X8.0.width1.base4", !451, i64 0}
!456 = !{!457, !457, i64 0}
!457 = !{!"fwd_X8.0.width1.base1", !458, i64 0}
!458 = !{!"fwd_X8.0.width2.base0", !459, i64 0}
!459 = !{!"fwd_X8.0.width4.base0", !447, i64 0}
!460 = !{!461, !461, i64 0}
!461 = !{!"fwd_X8.0.width1.base2", !462, i64 0}
!462 = !{!"fwd_X8.0.width2.base2", !459, i64 0}
!463 = !{!464, !464, i64 0}
!464 = !{!"fwd_X8.0.width1.base0", !458, i64 0}
!465 = !{!466, !466, i64 0}
!466 = !{!"fwd_X8.0.width1.base15", !467, i64 0}
!467 = !{!"fwd_X8.0.width2.base14", !468, i64 0}
!468 = !{!"fwd_X8.0.width4.base12", !469, i64 0}
!469 = !{!"fwd_X8.0.width8.base8", !448, i64 0}
!470 = !{!471, !471, i64 0}
!471 = !{!"fwd_X8.0.width1.base13", !472, i64 0}
!472 = !{!"fwd_X8.0.width2.base12", !468, i64 0}
!473 = !{!474, !474, i64 0}
!474 = !{!"fwd_X8.0.width1.base14", !467, i64 0}
!475 = !{!164, !164, i64 0}
!476 = !{!477, !477, i64 0}
!477 = !{!"fwd_X8.0.width1.base3", !462, i64 0}
!478 = !{!479, !479, i64 0}
!479 = !{!"fwd_X8.0.width1.base8", !480, i64 0}
!480 = !{!"fwd_X8.0.width2.base8", !481, i64 0}
!481 = !{!"fwd_X8.0.width4.base8", !469, i64 0}
!482 = !{!483, !483, i64 0}
!483 = !{!"fwd_X8.0.width1.base9", !480, i64 0}
!484 = !{!485, !485, i64 0}
!485 = !{!"fwd_X8.0.width1.base10", !486, i64 0}
!486 = !{!"fwd_X8.0.width2.base10", !481, i64 0}
!487 = !{!488, !488, i64 0}
!488 = !{!"fwd_X8.0.width1.base11", !486, i64 0}
!489 = !{!490, !490, i64 0}
!490 = !{!"fwd_X8.0.width1.base12", !472, i64 0}
!491 = !{!165, !165, i64 0}
!492 = !{!34, !34, i64 0}
!493 = !{!157, !157, i64 0}
!494 = !{!73, !73, i64 0}
!495 = !{!496, !496, i64 0}
!496 = !{!"fwd_X8.1.width2.base8", !394, i64 0}
!497 = !{!498, !498, i64 0}
!498 = !{!"kernel_fft1_S1_R8_n1.1.width2.base8", !138, i64 0}
!499 = !{!500, !500, i64 0}
!500 = !{!"fwd_X8.1.width2.base10", !394, i64 0}
!501 = !{!502, !502, i64 0}
!502 = !{!"kernel_fft1_S1_R8_n1.1.width2.base10", !138, i64 0}
!503 = !{!504, !504, i64 0}
!504 = !{!"fwd_X8.1.width2.base6", !391, i64 0}
!505 = !{!506, !506, i64 0}
!506 = !{!"kernel_fft1_S1_R8_n1.1.width2.base6", !136, i64 0}
!507 = !{!508, !508, i64 0}
!508 = !{!"fwd_X8.1.width2.base4", !391, i64 0}
!509 = !{!510, !510, i64 0}
!510 = !{!"kernel_fft1_S1_R8_n1.1.width2.base4", !136, i64 0}
!511 = !{!512, !512, i64 0}
!512 = !{!"fwd_X8.1.width2.base12", !387, i64 0}
!513 = !{!514, !514, i64 0}
!514 = !{!"kernel_fft1_S1_R8_n1.1.width2.base12", !141, i64 0}
!515 = !{!516, !516, i64 0}
!516 = !{!"fwd_X8.1.width2.base14", !387, i64 0}
!517 = !{!518, !518, i64 0}
!518 = !{!"kernel_fft1_S1_R8_n1.1.width2.base14", !141, i64 0}
!519 = !{!520, !520, i64 0}
!520 = !{!"fwd_X8.1.width2.base2", !396, i64 0}
!521 = !{!522, !522, i64 0}
!522 = !{!"kernel_fft1_S1_R8_n1.1.width2.base2", !125, i64 0}
!523 = !{!524, !524, i64 0}
!524 = !{!"fwd_X8.1.width2.base0", !396, i64 0}
!525 = !{!526, !526, i64 0}
!526 = !{!"kernel_fft1_S1_R8_n1.1.width2.base0", !125, i64 0}
!527 = !{!528, !528, i64 0}
!528 = !{!"k.width1.base32", !529, i64 0}
!529 = !{!"k.width2.base32", !43, i64 0}
!530 = !{!531, !531, i64 0}
!531 = !{!"kernel_X8.0.width1.base32", !532, i64 0}
!532 = !{!"kernel_X8.0.width2.base32", !102, i64 0}
!533 = !{!44, !44, i64 0}
!534 = !{!103, !103, i64 0}
!535 = !{!204, !204, i64 0}
!536 = !{!537, !537, i64 0}
!537 = !{!"k.width1.base33", !529, i64 0}
!538 = !{!539, !539, i64 0}
...
!580 = !{!581, !581, i64 0}
!581 = !{!"kernel_X8.0.width1.base33", !532, i64 0}
!582 = !{!583, !583, i64 0}
