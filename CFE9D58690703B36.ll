...
lor.lhs.false:                                    ; preds = %entry
  ...
  %1 = load i32, ptr %_size.i214, align 4, !tbaa !5
...
for.cond138.preheader:                            ; preds = %sw.bb
  ...
  %cmp143803 = icmp sgt i32 %67, 0
  br i1 %cmp143803, label %for.body145, label %for.cond.cleanup144
...
for.body145:                                      ; preds = %for.cond138.preheader, %for.inc151
  %indvars.iv826 = phi i64 [ %indvars.iv.next827, %for.inc151 ], [ 0, %for.cond138.preheader ]
  %77 = load ptr, ptr %_inByteBack.i, align 8, !tbaa !44
  %78 = load ptr, ptr %_items.i.i618, align 8, !tbaa !15
  %arrayidx.i.i613 = getelementptr inbounds ptr, ptr %78, i64 %indvars.iv826
...
for.inc151:                                       ; preds = %for.body145
  ...
  %cmp143 = icmp slt i64 %indvars.iv.next827, %81
...
for.body175:                                      ; preds = %for.body175.lr.ph, %if.end188
  %i74.1802 = phi i32 [ 0, %for.body175.lr.ph ], [ %inc191, %if.end188 ]
  %idxprom.i.i619 = sext i32 %i74.1802 to i64
...
if.end188:                                        ; preds = %_ZN8NArchive3N7z10CInArchive10ReadUInt32Ev.exit, %for.body175
  %inc191 = add nuw i32 %i74.1802, 1
  %exitcond825.not = icmp eq i32 %inc191, %conv.i.i
  br i1 %exitcond825.not, label %for.end192, label %for.body175, !llvm.loop !159
...
for.cond204.preheader:                            ; preds = %sw.bb201
  ...
  %cmp207798.not = icmp eq i32 %102, 0
  br i1 %cmp207798.not, label %for.end217, label %for.body208.lr.ph

for.body208.lr.ph:                                ; preds = %for.cond204.preheader
  %103 = load ptr, ptr %_items.i647, align 8, !tbaa !15
  %104 = add i32 %102, 2147483647
  %or.cond873 = icmp ult i32 %104, -2147483641
  br i1 %or.cond873, label %for.body208.preheader, label %vector.ph
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %vec.phi852 = phi <4 x i32> [ zeroinitializer, %vector.ph ], [ %112, %vector.body ]
  %106 = sext i32 %index to i64
  %107 = getelementptr inbounds i8, ptr %103, i64 %106
  %wide.load = load <4 x i8>, ptr %107, align 1, !tbaa !16
  %108 = getelementptr inbounds i8, ptr %107, i64 4
  %wide.load853 = load <4 x i8>, ptr %108, align 1, !tbaa !16
  %109 = zext <4 x i8> %wide.load to <4 x i32>
  %110 = zext <4 x i8> %wide.load853 to <4 x i32>
  %111 = add <4 x i32> %vec.phi, %109
  %112 = add <4 x i32> %vec.phi852, %110
...
for.body208.preheader:                            ; preds = %for.body208.lr.ph, %middle.block
  %numEmptyStreams.1800.ph = phi i32 [ %numEmptyStreams.0, %for.body208.lr.ph ], [ %114, %middle.block ]
  %i74.2799.ph = phi i32 [ 0, %for.body208.lr.ph ], [ %n.vec, %middle.block ]
  %115 = xor i32 %i74.2799.ph, -1
  %116 = add i32 %102, %115
...
for.body208.prol:                                 ; preds = %for.body208.preheader, %for.body208.prol
  %numEmptyStreams.1800.prol = phi i32 [ %spec.select.prol, %for.body208.prol ], [ %numEmptyStreams.1800.ph, %for.body208.preheader ]
  %i74.2799.prol = phi i32 [ %inc216.prol, %for.body208.prol ], [ %i74.2799.ph, %for.body208.preheader ]
  %prol.iter = phi i32 [ %prol.iter.next, %for.body208.prol ], [ 0, %for.body208.preheader ]
  %idxprom.i648.prol = sext i32 %i74.2799.prol to i64
  ...
  %spec.select.prol = add i32 %numEmptyStreams.1800.prol, %inc213.prol
  %inc216.prol = add nuw i32 %i74.2799.prol, 1
  %prol.iter.next = add i32 %prol.iter, 1
  %prol.iter.cmp.not = icmp eq i32 %prol.iter.next, %xtraiter
...
for.body208.prol.loopexit:                        ; preds = %for.body208.prol, %for.body208.preheader
  ...
  %numEmptyStreams.1800.unr = phi i32 [ %numEmptyStreams.1800.ph, %for.body208.preheader ], [ %spec.select.prol, %for.body208.prol ]
  %i74.2799.unr = phi i32 [ %i74.2799.ph, %for.body208.preheader ], [ %inc216.prol, %for.body208.prol ]
...
for.body208:                                      ; preds = %for.body208.prol.loopexit, %for.body208
  %numEmptyStreams.1800 = phi i32 [ %spec.select.3, %for.body208 ], [ %numEmptyStreams.1800.unr, %for.body208.prol.loopexit ]
  %i74.2799 = phi i32 [ %inc216.3, %for.body208 ], [ %i74.2799.unr, %for.body208.prol.loopexit ]
  %idxprom.i648 = sext i32 %i74.2799 to i64
  ...
  %spec.select = add i32 %numEmptyStreams.1800, %inc213
  %inc216 = add nuw i32 %i74.2799, 1
  ...
  %inc216.1 = add nuw i32 %i74.2799, 2
  ...
  %inc216.2 = add nuw i32 %i74.2799, 3
  ...
  %inc216.3 = add nuw i32 %i74.2799, 4
  %exitcond824.not.3 = icmp eq i32 %inc216.3, %102
  br i1 %exitcond824.not.3, label %for.end217, label %for.body208, !llvm.loop !162
...
for.cond233:                                      ; preds = %_ZN8NArchive3N7z10CInArchive8ReadByteEv.exit
  ...
  %exitcond823.not = icmp eq i64 %inc246, %call.i604605
  br i1 %exitcond823.not, label %if.end262, label %for.body236, !llvm.loop !163

for.body236:                                      ; preds = %for.body236.lr.ph, %for.cond233
  %inc.i.i685797 = phi i64 [ %64, %for.body236.lr.ph ], [ %inc.i.i685, %for.cond233 ]
  %j.0796 = phi i64 [ 0, %for.body236.lr.ph ], [ %inc246, %for.cond233 ]
  %cmp.not.i.i = icmp ult i64 %inc.i.i685797, %66
...
_ZN8NArchive3N7z10CInArchive8ReadByteEv.exit:     ; preds = %for.body236
  %129 = load ptr, ptr %63, align 8, !tbaa !49
  %inc.i.i685 = add nuw i64 %inc.i.i685797, 1
  store i64 %inc.i.i685, ptr %_pos, align 8, !tbaa !52
  %arrayidx.i.i686 = getelementptr inbounds i8, ptr %129, i64 %inc.i.i685797
  %130 = load i8, ptr %arrayidx.i.i686, align 1, !tbaa !55
  %cmp241.not = icmp eq i8 %130, 0
...
_ZN13CRecordVectorIyE3AddEy.exit697:              ; preds = %if.then254
  %132 = load ptr, ptr %_items.i559, align 8, !tbaa !15
  %133 = load i32, ptr %_size.i560, align 4, !tbaa !5
  %idxprom.i693 = sext i32 %133 to i64
  %arrayidx.i694 = getelementptr inbounds i64, ptr %132, i64 %idxprom.i693
  store i64 %call.i600601, ptr %arrayidx.i694, align 8, !tbaa !57
  %inc.i695 = add nsw i32 %133, 1
...
if.else260:                                       ; preds = %invoke.cont128, %if.else132
  ...
  %134 = load i64, ptr %_size.i.i699, align 8, !tbaa !51
  %sub.i.i = sub i64 %134, %64
...
if.end262:                                        ; preds = %for.cond233, %for.cond233.preheader, %_ZN8NArchive3N7z10CInArchive8SkipDataEy.exit, %_ZN13CRecordVectorIyE3AddEy.exit697
  ...
  %135 = load i8, ptr %ArchiveInfo89, align 8, !tbaa !164
  %cmp265.not = icmp ne i8 %135, 0
  %136 = load i8, ptr %Minor, align 1
  %cmp269 = icmp ugt i8 %136, 2
  %137 = select i1 %cmp265.not, i1 true, i1 %cmp269
  br i1 %137, label %land.lhs.true272, label %cleanup285

land.lhs.true272:                                 ; preds = %if.end262
  %138 = load ptr, ptr %_inByteBack.i, align 8, !tbaa !44
  %_pos274 = getelementptr inbounds %"class.NArchive::N7z::CInByte2", ptr %138, i64 0, i32 2
  %139 = load i64, ptr %_pos274, align 8, !tbaa !52
  %sub = sub i64 %139, %64
...
for.cond290.preheader:                            ; preds = %invoke.cont122, %cleanup285
  %numEmptyStreams.4833 = phi i32 [ %numEmptyStreams.3767, %cleanup285 ], [ %numEmptyStreams.0, %invoke.cont122 ]
  %cmp291805.not = icmp eq i32 %numEmptyStreams.4833, 0
  br i1 %cmp291805.not, label %for.cond303.preheader, label %for.body292.lr.ph

for.body292.lr.ph:                                ; preds = %for.cond290.preheader
  %141 = load ptr, ptr %_items.i.i666, align 8, !tbaa !15
  %142 = add i32 %numEmptyStreams.4833, 2147483647
  %or.cond875 = icmp ult i32 %142, -2147483641
  br i1 %or.cond875, label %for.body292.preheader, label %vector.ph858

vector.ph858:                                     ; preds = %for.body292.lr.ph
  %n.vec860 = and i32 %numEmptyStreams.4833, -8
  br label %vector.body863

vector.body863:                                   ; preds = %vector.body863, %vector.ph858
  %index864 = phi i32 [ 0, %vector.ph858 ], [ %index.next869, %vector.body863 ]
  %vec.phi865 = phi <4 x i32> [ zeroinitializer, %vector.ph858 ], [ %148, %vector.body863 ]
  %vec.phi866 = phi <4 x i32> [ zeroinitializer, %vector.ph858 ], [ %149, %vector.body863 ]
  %143 = sext i32 %index864 to i64
  %144 = getelementptr inbounds i8, ptr %141, i64 %143
  %wide.load867 = load <4 x i8>, ptr %144, align 1, !tbaa !16
  %145 = getelementptr inbounds i8, ptr %144, i64 4
  %wide.load868 = load <4 x i8>, ptr %145, align 1, !tbaa !16
  %146 = zext <4 x i8> %wide.load867 to <4 x i32>
  %147 = zext <4 x i8> %wide.load868 to <4 x i32>
  %148 = add <4 x i32> %vec.phi865, %146
  %149 = add <4 x i32> %vec.phi866, %147
  %index.next869 = add nuw i32 %index864, 8
  %150 = icmp eq i32 %index.next869, %n.vec860
  br i1 %150, label %middle.block855, label %vector.body863, !llvm.loop !165

middle.block855:                                  ; preds = %vector.body863
  %bin.rdx870 = add <4 x i32> %149, %148
  %151 = call i32 @llvm.vector.reduce.add.v4i32(<4 x i32> %bin.rdx870)
  %cmp.n862 = icmp eq i32 %numEmptyStreams.4833, %n.vec860
  br i1 %cmp.n862, label %for.cond303.preheader, label %for.body292.preheader

for.body292.preheader:                            ; preds = %for.body292.lr.ph, %middle.block855
  %numAntiItems.0807.ph = phi i32 [ 0, %for.body292.lr.ph ], [ %151, %middle.block855 ]
  %i74.3806.ph = phi i32 [ 0, %for.body292.lr.ph ], [ %n.vec860, %middle.block855 ]
  %152 = xor i32 %i74.3806.ph, -1
  %153 = add i32 %numEmptyStreams.4833, %152
  %xtraiter888 = and i32 %numEmptyStreams.4833, 3
  %lcmp.mod889.not = icmp eq i32 %xtraiter888, 0
  br i1 %lcmp.mod889.not, label %for.body292.prol.loopexit, label %for.body292.prol

for.body292.prol:                                 ; preds = %for.body292.preheader, %for.body292.prol
  %numAntiItems.0807.prol = phi i32 [ %spec.select762.prol, %for.body292.prol ], [ %numAntiItems.0807.ph, %for.body292.preheader ]
  %i74.3806.prol = phi i32 [ %inc301.prol, %for.body292.prol ], [ %i74.3806.ph, %for.body292.preheader ]
  %prol.iter890 = phi i32 [ %prol.iter890.next, %for.body292.prol ], [ 0, %for.body292.preheader ]
  %idxprom.i710.prol = sext i32 %i74.3806.prol to i64
  %arrayidx.i711.prol = getelementptr inbounds i8, ptr %141, i64 %idxprom.i710.prol
  %154 = load i8, ptr %arrayidx.i711.prol, align 1, !tbaa !16, !range !23, !noundef !24
  %inc298.prol = zext i8 %154 to i32
  %spec.select762.prol = add i32 %numAntiItems.0807.prol, %inc298.prol
  %inc301.prol = add nuw i32 %i74.3806.prol, 1
  %prol.iter890.next = add i32 %prol.iter890, 1
  %prol.iter890.cmp.not = icmp eq i32 %prol.iter890.next, %xtraiter888
  br i1 %prol.iter890.cmp.not, label %for.body292.prol.loopexit, label %for.body292.prol, !llvm.loop !166
...
for.body292.prol.loopexit:                        ; preds = %for.body292.prol, %for.body292.preheader
  ...
  %numAntiItems.0807.unr = phi i32 [ %numAntiItems.0807.ph, %for.body292.preheader ], [ %spec.select762.prol, %for.body292.prol ]
  %i74.3806.unr = phi i32 [ %i74.3806.ph, %for.body292.preheader ], [ %inc301.prol, %for.body292.prol ]
  %155 = icmp ult i32 %153, 3
  br i1 %155, label %for.cond303.preheader, label %for.body292

for.cond303.preheader:                            ; preds = %for.body292.prol.loopexit, %for.body292, %middle.block855, %for.cond290.preheader
  %numAntiItems.0.lcssa = phi i32 [ 0, %for.cond290.preheader ], [ %151, %middle.block855 ], [ %spec.select762.lcssa.unr, %for.body292.prol.loopexit ], [ %spec.select762.3, %for.body292 ]
...
for.body292:                                      ; preds = %for.body292.prol.loopexit, %for.body292
  %numAntiItems.0807 = phi i32 [ %spec.select762.3, %for.body292 ], [ %numAntiItems.0807.unr, %for.body292.prol.loopexit ]
  %i74.3806 = phi i32 [ %inc301.3, %for.body292 ], [ %i74.3806.unr, %for.body292.prol.loopexit ]
  %idxprom.i710 = sext i32 %i74.3806 to i64
  %arrayidx.i711 = getelementptr inbounds i8, ptr %141, i64 %idxprom.i710
  %156 = load i8, ptr %arrayidx.i711, align 1, !tbaa !16, !range !23, !noundef !24
  %inc298 = zext i8 %156 to i32
  %spec.select762 = add i32 %numAntiItems.0807, %inc298
  %inc301 = add nuw i32 %i74.3806, 1
  %idxprom.i710.1 = sext i32 %inc301 to i64
  %arrayidx.i711.1 = getelementptr inbounds i8, ptr %141, i64 %idxprom.i710.1
  %157 = load i8, ptr %arrayidx.i711.1, align 1, !tbaa !16, !range !23, !noundef !24
  %inc298.1 = zext i8 %157 to i32
  %spec.select762.1 = add i32 %spec.select762, %inc298.1
  %inc301.1 = add nuw i32 %i74.3806, 2
  %idxprom.i710.2 = sext i32 %inc301.1 to i64
  %arrayidx.i711.2 = getelementptr inbounds i8, ptr %141, i64 %idxprom.i710.2
  %158 = load i8, ptr %arrayidx.i711.2, align 1, !tbaa !16, !range !23, !noundef !24
  %inc298.2 = zext i8 %158 to i32
  %spec.select762.2 = add i32 %spec.select762.1, %inc298.2
  %inc301.2 = add nuw i32 %i74.3806, 3
  %idxprom.i710.3 = sext i32 %inc301.2 to i64
  %arrayidx.i711.3 = getelementptr inbounds i8, ptr %141, i64 %idxprom.i710.3
  %159 = load i8, ptr %arrayidx.i711.3, align 1, !tbaa !16, !range !23, !noundef !24
  %inc298.3 = zext i8 %159 to i32
  %spec.select762.3 = add i32 %spec.select762.2, %inc298.3
  %inc301.3 = add nuw i32 %i74.3806, 4
  %exitcond829.not.3 = icmp eq i32 %inc301.3, %numEmptyStreams.4833
  br i1 %exitcond829.not.3, label %for.cond303.preheader, label %for.body292, !llvm.loop !167

for.body305:                                      ; preds = %for.body305.lr.ph, %if.end348
  %sizeIndex.0812 = phi i32 [ 0, %for.body305.lr.ph ], [ %sizeIndex.1, %if.end348 ]
  %emptyFileIndex.0811 = phi i32 [ 0, %for.body305.lr.ph ], [ %emptyFileIndex.1, %if.end348 ]
  %i74.4810 = phi i32 [ 0, %for.body305.lr.ph ], [ %inc352, %if.end348 ]
  %160 = load ptr, ptr %_items.i.i618, align 8, !tbaa !15
  %idxprom.i.i713 = sext i32 %i74.4810 to i64
  %arrayidx.i.i714 = getelementptr inbounds ptr, ptr %160, i64 %idxprom.i.i713
  %161 = load ptr, ptr %arrayidx.i.i714, align 8, !tbaa !29
  %162 = load ptr, ptr %_items.i647, align 8, !tbaa !15
  %arrayidx.i717 = getelementptr inbounds i8, ptr %162, i64 %idxprom.i.i713
  %163 = load i8, ptr %arrayidx.i717, align 1, !tbaa !16, !range !23, !noundef !24
  %tobool314.not = icmp eq i8 %163, 0
  %HasStream = getelementptr inbounds %"struct.NArchive::N7z::CFileItem", ptr %161, i64 0, i32 4
  %frombool315 = xor i8 %163, 1
...
if.then318:                                       ; preds = %for.body305
  %IsDir = getelementptr inbounds %"struct.NArchive::N7z::CFileItem", ptr %161, i64 0, i32 5
  store i8 0, ptr %IsDir, align 1, !tbaa !169
  %164 = load ptr, ptr %_items.i718, align 8, !tbaa !15
  %idxprom.i719 = sext i32 %sizeIndex.0812 to i64
  %arrayidx.i720 = getelementptr inbounds i64, ptr %164, i64 %idxprom.i719
  %165 = load i64, ptr %arrayidx.i720, align 8, !tbaa !57
  %166 = load ptr, ptr %_items.i721, align 8, !tbaa !15
  %arrayidx.i723 = getelementptr inbounds i32, ptr %166, i64 %idxprom.i719
  %167 = load i32, ptr %arrayidx.i723, align 4, !tbaa !26
  %Crc = getelementptr inbounds %"struct.NArchive::N7z::CFileItem", ptr %161, i64 0, i32 2
  store i32 %167, ptr %Crc, align 4, !tbaa !170
  %168 = load ptr, ptr %_items.i724, align 8, !tbaa !15
  %arrayidx.i726 = getelementptr inbounds i8, ptr %168, i64 %idxprom.i719
  %169 = load i8, ptr %arrayidx.i726, align 1, !tbaa !16, !range !23, !noundef !24
  %inc327 = add i32 %sizeIndex.0812, 1
  br label %if.end342
...
if.else328:                                       ; preds = %for.body305
  %171 = load ptr, ptr %_items.i.i651, align 8, !tbaa !15
  %idxprom.i728 = sext i32 %emptyFileIndex.0811 to i64
  %arrayidx.i729 = getelementptr inbounds i8, ptr %171, i64 %idxprom.i728
  %172 = load i8, ptr %arrayidx.i729, align 1, !tbaa !16, !range !23, !noundef !24
  %IsDir333 = getelementptr inbounds %"struct.NArchive::N7z::CFileItem", ptr %161, i64 0, i32 5
  %frombool334 = xor i8 %172, 1
  store i8 %frombool334, ptr %IsDir333, align 1, !tbaa !169
  %173 = load ptr, ptr %_items.i.i666, align 8, !tbaa !15
  %arrayidx.i732 = getelementptr inbounds i8, ptr %173, i64 %idxprom.i728
  %174 = load i8, ptr %arrayidx.i732, align 1, !tbaa !16, !range !23, !noundef !24
  %inc339 = add i32 %emptyFileIndex.0811, 1
  br label %if.end342

if.end342:                                        ; preds = %if.else328, %if.then318
  %.sink831 = phi i64 [ %165, %if.then318 ], [ 0, %if.else328 ]
  %.sink = phi i8 [ %169, %if.then318 ], [ 0, %if.else328 ]
  %emptyFileIndex.1 = phi i32 [ %emptyFileIndex.0811, %if.then318 ], [ %inc339, %if.else328 ]
  %sizeIndex.1 = phi i32 [ %inc327, %if.then318 ], [ %sizeIndex.0812, %if.else328 ]
  %isAnti.0 = phi i8 [ 0, %if.then318 ], [ %174, %if.else328 ]
  store i64 %.sink831, ptr %161, align 8
  %175 = getelementptr inbounds %"struct.NArchive::N7z::CFileItem", ptr %161, i64 0, i32 6
  store i8 %.sink, ptr %175, align 2
...
_ZN13CRecordVectorIbE3AddEb.exit740:              ; preds = %if.then344
  %176 = load ptr, ptr %_items.i734, align 8, !tbaa !15
  %177 = load i32, ptr %_size.i735, align 4, !tbaa !5
  %idxprom.i736 = sext i32 %177 to i64
  %arrayidx.i737 = getelementptr inbounds i8, ptr %176, i64 %idxprom.i736
  store i8 %isAnti.0, ptr %arrayidx.i737, align 1, !tbaa !16
  %inc.i738 = add nsw i32 %177, 1
  store i32 %inc.i738, ptr %_size.i735, align 4, !tbaa !5
  br label %if.end348

if.end348:                                        ; preds = %_ZN13CRecordVectorIbE3AddEb.exit740, %if.end342
  %inc352 = add nuw i32 %i74.4810, 1
  %exitcond830.not = icmp eq i32 %inc352, %conv.i.i
  br i1 %exitcond830.not, label %for.end353, label %for.body305, !llvm.loop !171
...
cleanup.cont:                                     ; preds = %if.then29
  ...
  br i1 %cmp41.not, label %cleanup.cont46, label %cleanup127.thread369

cleanup.cont46:                                   ; preds = %cleanup.cont
  %11 = load i64, ptr %cur2, align 8, !tbaa !57
  %12 = load i64, ptr %cur, align 8, !tbaa !57
  %sub = sub i64 %11, %12
  %spec.select381 = call i64 @llvm.umin.i64(i64 %sub, i64 500)
  %13 = load ptr, ptr %this, align 8, !tbaa !81
  %sub55 = sub nsw i64 0, %spec.select381
  ...
  br i1 %cmp60.not, label %cleanup.cont65, label %cleanup127.thread369

cleanup.cont65:                                   ; preds = %cleanup.cont46
  %15 = load ptr, ptr %this, align 8, !tbaa !81
  %call71 = call noundef i32 @_Z16ReadStream_FALSEP19ISequentialInStreamPvm(ptr noundef %15, ptr noundef nonnull %buf, i64 noundef %spec.select381)
  %cmp72.not = icmp eq i32 %call71, 0
  br i1 %cmp72.not, label %cleanup.cont77, label %cleanup127.thread369

cleanup.cont77:                                   ; preds = %cleanup.cont65
  %cmp79379.not = icmp ult i64 %spec.select381, 2
  br i1 %cmp79379.not, label %cleanup127.thread369, label %for.body.preheader

for.body.preheader:                               ; preds = %cleanup.cont77
  %sub78 = add nuw nsw i64 %spec.select381, 4294967294
...
for.inc:                                          ; preds = %land.lhs.true83, %for.body, %land.lhs.true92
  %indvars.iv.next = add nsw i64 %indvars.iv, -1
  %cmp79 = icmp sgt i64 %indvars.iv, 0
  br i1 %cmp79, label %for.body, label %cleanup127.thread369, !llvm.loop !178

if.end102:                                        ; preds = %land.lhs.true83, %land.lhs.true92
  %sub103 = sub i64 %spec.select381, %indvars.iv
  ...
  br i1 %cmp117.not, label %cleanup127, label %cleanup127.thread369

cleanup127.thread369:                             ; preds = %for.inc, %cleanup.cont77, %cleanup.cont, %cleanup.cont65, %cleanup.cont46, %if.end102
...
cleanup.cont173:                                  ; preds = %invoke.cont166
  ...
  %call183 = invoke i32 @CrcCalc(ptr noundef nonnull %call.i339, i64 noundef %nextHeaderSize.4)
          to label %invoke.cont182 unwind label %ehcleanup255.thread391
...
if.then185:                                       ; preds = %invoke.cont182
  invoke fastcc void @_ZN8NArchive3N7zL14ThrowIncorrectEv()
          to label %if.end187.unreachable unwind label %ehcleanup255.thread391
...
ehcleanup255.thread391:                           ; preds = %if.then185, %cleanup.cont173
  %lpad.thr_comm = landingpad { ptr, i32 }
          cleanup
  br label %delete.notnull.i355

delete.notnull.i355:                              ; preds = %lpad161, %ehcleanup251, %ehcleanup255.thread391
  %.pn.pn.pn388 = phi { ptr, i32 } [ %lpad.thr_comm, %ehcleanup255.thread391 ], [ %30, %lpad161 ], [ %.pn.pn, %ehcleanup251 ]
  call void @_ZdaPv(ptr noundef nonnull %call.i339) #19
  call void @llvm.lifetime.end.p0(i64 24, ptr nonnull %buffer2) #16
  resume { ptr, i32 } %.pn.pn.pn388

cleanup258:                                       ; preds = %cleanup127.thread369, %cleanup127.thread, %if.end140, %if.end134, %if.end146, %_ZN7CBufferIhED2Ev.exit
  %retval.16 = phi i32 [ %retval.15, %_ZN7CBufferIhED2Ev.exit ], [ %call152, %if.end146 ], [ 0, %if.end134 ], [ 1, %if.end140 ], [ %call31, %cleanup127.thread ], [ %retval.7.ph, %cleanup127.thread369 ]
  ret i32 %retval.16
}
