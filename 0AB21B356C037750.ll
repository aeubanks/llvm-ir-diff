; ModuleID = '/usr/local/google/home/aeubanks/repos/test-suite/SingleSource/Regression/C/gcc-c-torture/execute/pr57344-4.c'
source_filename = "/usr/local/google/home/aeubanks/repos/test-suite/SingleSource/Regression/C/gcc-c-torture/execute/pr57344-4.c"
...
3:                                                ; preds = %0, %3
  %4 = load i120, ptr getelementptr inbounds ([2 x %struct.S], ptr @s, i64 0, i64 1), align 16
  %5 = shl i120 %4, 7
  %6 = ashr i120 %5, 66
  %7 = trunc i120 %6 to i64
...
!5 = !{i64 295}
!6 = !{i64 0, i64 8, !7, i64 7, i64 8, !7, i64 15, i64 1, !11}
!7 = !{!8, !8, i64 0}
!8 = !{!"long long", !9, i64 0}
