...
define dso_local i64 @getComplex(i64 noundef returned %0) local_unnamed_addr #0 {
  %2 = load i32, ptr @getComplex.count, align 4, !tbaa !5
  %3 = add nsw i32 %2, 1
  store i32 %3, ptr @getComplex.count, align 4, !tbaa !5
  %4 = icmp eq i32 %2, 0
...
define dso_local i64 @doo() local_unnamed_addr #0 {
  %1 = load i32, ptr @getComplex.count, align 4, !tbaa !5
  %2 = add nsw i32 %1, 1
  store i32 %2, ptr @getComplex.count, align 4, !tbaa !5
  %3 = icmp eq i32 %1, 0
