; ModuleID = '/usr/local/google/home/aeubanks/repos/test-suite/Bitcode/simd_ops/x86_tests/test_op_vpaddb_349.bc'
...
@str.11 = private constant [14 x i8] c"op_vpaddb_349\00", align 32
...
define i32 @__test_op(ptr noalias nocapture readnone %in_f32.buffer, ptr noalias nocapture readnone %in_f64.buffer, ptr noalias nocapture readnone %in_i8.buffer, ptr noalias nocapture readonly %in_u8.buffer, ptr noalias nocapture readnone %in_i16.buffer, ptr noalias nocapture readnone %in_u16.buffer, ptr noalias nocapture readnone %in_i32.buffer, ptr noalias nocapture readnone %in_u32.buffer, ptr noalias nocapture readnone %in_i64.buffer, ptr noalias nocapture readnone %in_u64.buffer, ptr noalias nocapture readonly %op_vpaddb_349.buffer) local_unnamed_addr #0 {
"produce op_vpaddb_349":
  %buf_extent168 = getelementptr inbounds %struct.buffer_t, ptr %op_vpaddb_349.buffer, i64 0, i32 2, i64 1
  %op_vpaddb_349.extent.1 = load i32, ptr %buf_extent168, align 4
  %buf_min176 = getelementptr inbounds %struct.buffer_t, ptr %op_vpaddb_349.buffer, i64 0, i32 4, i64 1
  %op_vpaddb_349.min.1 = load i32, ptr %buf_min176, align 4
  %0 = add nsw i32 %op_vpaddb_349.min.1, %op_vpaddb_349.extent.1
  %1 = icmp sgt i32 %op_vpaddb_349.extent.1, 0
  br i1 %1, label %"for op_vpaddb_349.s0.y.preheader", label %destructor_block, !prof !4

"for op_vpaddb_349.s0.y.preheader":               ; preds = %"produce op_vpaddb_349"
  %buf_host44 = getelementptr inbounds %struct.buffer_t, ptr %in_u8.buffer, i64 0, i32 1
  %in_u8.host = load ptr, ptr %buf_host44, align 8
  %buf_min175 = getelementptr inbounds %struct.buffer_t, ptr %op_vpaddb_349.buffer, i64 0, i32 4, i64 0
  %op_vpaddb_349.min.0 = load i32, ptr %buf_min175, align 4
  %2 = sext i32 %op_vpaddb_349.min.0 to i64
  %buf_stride172 = getelementptr inbounds %struct.buffer_t, ptr %op_vpaddb_349.buffer, i64 0, i32 3, i64 1
  %op_vpaddb_349.stride.1 = load i32, ptr %buf_stride172, align 4
  %3 = sext i32 %op_vpaddb_349.stride.1 to i64
  %buf_host163 = getelementptr inbounds %struct.buffer_t, ptr %op_vpaddb_349.buffer, i64 0, i32 1
  %op_vpaddb_349.host = load ptr, ptr %buf_host163, align 8
  %4 = shl nsw i64 %2, 3
  %5 = sub nsw i64 224, %4
  %scevgep = getelementptr i8, ptr %op_vpaddb_349.host, i64 %5
  %6 = shl nsw i64 %3, 3
  %sunkaddr = ptrtoint ptr %in_u8.host to i64
  %sunkaddr212 = add i64 %sunkaddr, 16
  %sunkaddr213 = inttoptr i64 %sunkaddr212 to ptr
  %7 = load <32 x i8>, ptr %sunkaddr213, align 16, !tbaa !5
  %8 = load <32 x i8>, ptr %in_u8.host, align 32, !tbaa !5
  %9 = add <32 x i8> %8, %7
  ...
  %sunkaddr212.1 = add i64 %sunkaddr, 48
  %sunkaddr213.1 = inttoptr i64 %sunkaddr212.1 to ptr
  %19 = load <32 x i8>, ptr %sunkaddr213.1, align 16, !tbaa !5
  %sunkaddr216.1 = inttoptr i64 %sunkaddr211.1 to ptr
  %20 = load <32 x i8>, ptr %sunkaddr216.1, align 32, !tbaa !5
  %21 = add <32 x i8> %20, %19
  ...
  %sunkaddr212.2 = add i64 %sunkaddr, 80
  %sunkaddr213.2 = inttoptr i64 %sunkaddr212.2 to ptr
  %31 = load <32 x i8>, ptr %sunkaddr213.2, align 16, !tbaa !5
  %sunkaddr216.2 = inttoptr i64 %sunkaddr211.2 to ptr
  %32 = load <32 x i8>, ptr %sunkaddr216.2, align 32, !tbaa !5
  %33 = add <32 x i8> %32, %31
  ...
  %sunkaddr212.3 = add i64 %sunkaddr, 112
  %sunkaddr213.3 = inttoptr i64 %sunkaddr212.3 to ptr
  %43 = load <32 x i8>, ptr %sunkaddr213.3, align 16, !tbaa !5
  %sunkaddr216.3 = inttoptr i64 %sunkaddr211.3 to ptr
  %44 = load <32 x i8>, ptr %sunkaddr216.3, align 32, !tbaa !5
  %45 = add <32 x i8> %44, %43
  ...
  %sunkaddr212.4 = add i64 %sunkaddr, 144
  %sunkaddr213.4 = inttoptr i64 %sunkaddr212.4 to ptr
  %55 = load <32 x i8>, ptr %sunkaddr213.4, align 16, !tbaa !5
  %sunkaddr216.4 = inttoptr i64 %sunkaddr211.4 to ptr
  %56 = load <32 x i8>, ptr %sunkaddr216.4, align 32, !tbaa !5
  %57 = add <32 x i8> %56, %55
  ...
  %sunkaddr212.5 = add i64 %sunkaddr, 176
  %sunkaddr213.5 = inttoptr i64 %sunkaddr212.5 to ptr
  %sunkaddr216.5 = inttoptr i64 %sunkaddr211.5 to ptr
  %sunkaddr211.6 = add i64 %sunkaddr, 192
  %sunkaddr212.6 = add i64 %sunkaddr, 208
  %sunkaddr213.6 = inttoptr i64 %sunkaddr212.6 to ptr
  %sunkaddr216.6 = inttoptr i64 %sunkaddr211.6 to ptr
  %sunkaddr211.7 = add i64 %sunkaddr, 224
  %sunkaddr212.7 = add i64 %sunkaddr, 240
  %sunkaddr213.7 = inttoptr i64 %sunkaddr212.7 to ptr
  %sunkaddr216.7 = inttoptr i64 %sunkaddr211.7 to ptr
  br label %"for op_vpaddb_349.s0.x.x.preheader"

"for op_vpaddb_349.s0.x.x.preheader":             ; preds = %"for op_vpaddb_349.s0.x.x.preheader", %"for op_vpaddb_349.s0.y.preheader"
  %lsr.iv180 = phi ptr [ %scevgep, %"for op_vpaddb_349.s0.y.preheader" ], [ %scevgep182, %"for op_vpaddb_349.s0.x.x.preheader" ]
  %op_vpaddb_349.s0.y = phi i32 [ %op_vpaddb_349.min.1, %"for op_vpaddb_349.s0.y.preheader" ], [ %103, %"for op_vpaddb_349.s0.x.x.preheader" ]
  ...
  %67 = load <32 x i8>, ptr %sunkaddr213.5, align 16, !tbaa !5
  %68 = load <32 x i8>, ptr %sunkaddr216.5, align 32, !tbaa !5
  %69 = add <32 x i8> %68, %67
  ...
  %79 = load <32 x i8>, ptr %sunkaddr213.6, align 16, !tbaa !5
  %80 = load <32 x i8>, ptr %sunkaddr216.6, align 32, !tbaa !5
  %81 = add <32 x i8> %80, %79
  ...
  %91 = load <32 x i8>, ptr %sunkaddr213.7, align 16, !tbaa !5
  %92 = load <32 x i8>, ptr %sunkaddr216.7, align 32, !tbaa !5
  %93 = add <32 x i8> %92, %91
  ...
  %103 = add nsw i32 %op_vpaddb_349.s0.y, 1
  %scevgep182 = getelementptr i1, ptr %lsr.iv180, i64 %6
  %.not2 = icmp eq i32 %103, %0
  br i1 %.not2, label %destructor_block, label %"for op_vpaddb_349.s0.x.x.preheader"

destructor_block:                                 ; preds = %"for op_vpaddb_349.s0.x.x.preheader", %"produce op_vpaddb_349"
  ret i32 0
}

; Function Attrs: nofree norecurse nosync nounwind memory(readwrite, inaccessiblemem: none)
define i32 @test_op(ptr noalias nocapture readnone %in_f32.buffer, ptr noalias nocapture readnone %in_f64.buffer, ptr noalias nocapture readnone %in_i8.buffer, ptr noalias nocapture readonly %in_u8.buffer, ptr noalias nocapture readnone %in_i16.buffer, ptr noalias nocapture readnone %in_u16.buffer, ptr noalias nocapture readnone %in_i32.buffer, ptr noalias nocapture readnone %in_u32.buffer, ptr noalias nocapture readnone %in_i64.buffer, ptr noalias nocapture readnone %in_u64.buffer, ptr noalias nocapture readonly %op_vpaddb_349.buffer) local_unnamed_addr #1 {
destructor_block:
  %"__test_op_result$21" = tail call i32 @__test_op(ptr poison, ptr poison, ptr poison, ptr %in_u8.buffer, ptr poison, ptr poison, ptr poison, ptr poison, ptr poison, ptr poison, ptr %op_vpaddb_349.buffer) #3
  ret i32 0
}
