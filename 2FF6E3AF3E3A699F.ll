; ModuleID = '/usr/local/google/home/aeubanks/repos/test-suite/Bitcode/simd_ops/x86_tests/test_op_vrcpps_324.bc'
...
@str.11 = private constant [14 x i8] c"op_vrcpps_324\00", align 32
...
define i32 @__test_op(ptr noalias nocapture readonly %in_f32.buffer, ptr noalias nocapture readnone %in_f64.buffer, ptr noalias nocapture readnone %in_i8.buffer, ptr noalias nocapture readnone %in_u8.buffer, ptr noalias nocapture readnone %in_i16.buffer, ptr noalias nocapture readnone %in_u16.buffer, ptr noalias nocapture readnone %in_i32.buffer, ptr noalias nocapture readnone %in_u32.buffer, ptr noalias nocapture readnone %in_i64.buffer, ptr noalias nocapture readnone %in_u64.buffer, ptr noalias nocapture readonly %op_vrcpps_324.buffer) local_unnamed_addr #1 {
"produce op_vrcpps_324":
  %buf_extent168 = getelementptr inbounds %struct.buffer_t, ptr %op_vrcpps_324.buffer, i64 0, i32 2, i64 1
  %op_vrcpps_324.extent.1 = load i32, ptr %buf_extent168, align 4
  %buf_min176 = getelementptr inbounds %struct.buffer_t, ptr %op_vrcpps_324.buffer, i64 0, i32 4, i64 1
  %op_vrcpps_324.min.1 = load i32, ptr %buf_min176, align 4
  %0 = add nsw i32 %op_vrcpps_324.min.1, %op_vrcpps_324.extent.1
  %1 = icmp sgt i32 %op_vrcpps_324.extent.1, 0
  br i1 %1, label %"for op_vrcpps_324.s0.y.preheader", label %destructor_block, !prof !4

"for op_vrcpps_324.s0.y.preheader":               ; preds = %"produce op_vrcpps_324"
  %buf_host = getelementptr inbounds %struct.buffer_t, ptr %in_f32.buffer, i64 0, i32 1
  %in_f32.host = load ptr, ptr %buf_host, align 8
  %buf_min175 = getelementptr inbounds %struct.buffer_t, ptr %op_vrcpps_324.buffer, i64 0, i32 4, i64 0
  %op_vrcpps_324.min.0 = load i32, ptr %buf_min175, align 4
  %2 = sext i32 %op_vrcpps_324.min.0 to i64
  %buf_stride172 = getelementptr inbounds %struct.buffer_t, ptr %op_vrcpps_324.buffer, i64 0, i32 3, i64 1
  %op_vrcpps_324.stride.1 = load i32, ptr %buf_stride172, align 4
  %3 = sext i32 %op_vrcpps_324.stride.1 to i64
  %buf_host163 = getelementptr inbounds %struct.buffer_t, ptr %op_vrcpps_324.buffer, i64 0, i32 1
  %op_vrcpps_324.host = load ptr, ptr %buf_host163, align 8
  %4 = shl nsw i64 %2, 3
  %5 = sub nsw i64 32, %4
  %scevgep = getelementptr i8, ptr %op_vrcpps_324.host, i64 %5
  %6 = shl nsw i64 %3, 3
  %7 = load <8 x float>, ptr %in_f32.host, align 32, !tbaa !5
  %approx.i = tail call <8 x float> @llvm.x86.avx.rcp.ps.256(<8 x float> %7) #4
  ...
  %approx.i.1 = tail call <8 x float> @llvm.x86.avx.rcp.ps.256(<8 x float> %11) #4
  ...
  %approx.i.2 = tail call <8 x float> @llvm.x86.avx.rcp.ps.256(<8 x float> %15) #4
  ...
  %approx.i.3 = tail call <8 x float> @llvm.x86.avx.rcp.ps.256(<8 x float> %19) #4
  ...
  %approx.i.4 = tail call <8 x float> @llvm.x86.avx.rcp.ps.256(<8 x float> %23) #4
  ...
  %approx.i.5 = tail call <8 x float> @llvm.x86.avx.rcp.ps.256(<8 x float> %27) #4
  ...
  %approx.i.6 = tail call <8 x float> @llvm.x86.avx.rcp.ps.256(<8 x float> %31) #4
  ...
  %approx.i.7 = tail call <8 x float> @llvm.x86.avx.rcp.ps.256(<8 x float> %35) #4
  ...
  %approx.i.8 = tail call <8 x float> @llvm.x86.avx.rcp.ps.256(<8 x float> %39) #4
  ...
  %approx.i.9 = tail call <8 x float> @llvm.x86.avx.rcp.ps.256(<8 x float> %43) #4
  ...
  %approx.i.10 = tail call <8 x float> @llvm.x86.avx.rcp.ps.256(<8 x float> %47) #4
  ...
  %approx.i.11 = tail call <8 x float> @llvm.x86.avx.rcp.ps.256(<8 x float> %51) #4
  ...
  %approx.i.12 = tail call <8 x float> @llvm.x86.avx.rcp.ps.256(<8 x float> %55) #4
  ...
  %approx.i.13 = tail call <8 x float> @llvm.x86.avx.rcp.ps.256(<8 x float> %59) #4
  ...
  %approx.i.14 = tail call <8 x float> @llvm.x86.avx.rcp.ps.256(<8 x float> %63) #4
  ...
  %approx.i.15 = tail call <8 x float> @llvm.x86.avx.rcp.ps.256(<8 x float> %67) #4
  ...
  %approx.i.16 = tail call <8 x float> @llvm.x86.avx.rcp.ps.256(<8 x float> %71) #4
  ...
  %approx.i.17 = tail call <8 x float> @llvm.x86.avx.rcp.ps.256(<8 x float> %75) #4
  ...
  br label %"for op_vrcpps_324.s0.x.x.preheader"

"for op_vrcpps_324.s0.x.x.preheader":             ; preds = %"for op_vrcpps_324.s0.x.x.preheader", %"for op_vrcpps_324.s0.y.preheader"
  %lsr.iv180 = phi ptr [ %scevgep, %"for op_vrcpps_324.s0.y.preheader" ], [ %scevgep182, %"for op_vrcpps_324.s0.x.x.preheader" ]
  %op_vrcpps_324.s0.y = phi i32 [ %op_vrcpps_324.min.1, %"for op_vrcpps_324.s0.y.preheader" ], [ %135, %"for op_vrcpps_324.s0.x.x.preheader" ]
  ...
  %approx.i.18 = tail call <8 x float> @llvm.x86.avx.rcp.ps.256(<8 x float> %79) #4
  ...
  %approx.i.19 = tail call <8 x float> @llvm.x86.avx.rcp.ps.256(<8 x float> %83) #4
  ...
  %approx.i.20 = tail call <8 x float> @llvm.x86.avx.rcp.ps.256(<8 x float> %87) #4
  ...
  %approx.i.21 = tail call <8 x float> @llvm.x86.avx.rcp.ps.256(<8 x float> %91) #4
  ...
  %approx.i.22 = tail call <8 x float> @llvm.x86.avx.rcp.ps.256(<8 x float> %95) #4
  ...
  %approx.i.23 = tail call <8 x float> @llvm.x86.avx.rcp.ps.256(<8 x float> %99) #4
  ...
  %approx.i.24 = tail call <8 x float> @llvm.x86.avx.rcp.ps.256(<8 x float> %103) #4
  ...
  %approx.i.25 = tail call <8 x float> @llvm.x86.avx.rcp.ps.256(<8 x float> %107) #4
  ...
  %approx.i.26 = tail call <8 x float> @llvm.x86.avx.rcp.ps.256(<8 x float> %111) #4
  ...
  %approx.i.27 = tail call <8 x float> @llvm.x86.avx.rcp.ps.256(<8 x float> %115) #4
  ...
  %approx.i.28 = tail call <8 x float> @llvm.x86.avx.rcp.ps.256(<8 x float> %119) #4
  ...
  %approx.i.29 = tail call <8 x float> @llvm.x86.avx.rcp.ps.256(<8 x float> %123) #4
  ...
  %approx.i.30 = tail call <8 x float> @llvm.x86.avx.rcp.ps.256(<8 x float> %127) #4
  ...
  %approx.i.31 = tail call <8 x float> @llvm.x86.avx.rcp.ps.256(<8 x float> %131) #4
  ...
  %135 = add nsw i32 %op_vrcpps_324.s0.y, 1
  %scevgep182 = getelementptr i1, ptr %lsr.iv180, i64 %6
  %.not2 = icmp eq i32 %135, %0
  br i1 %.not2, label %destructor_block, label %"for op_vrcpps_324.s0.x.x.preheader"

destructor_block:                                 ; preds = %"for op_vrcpps_324.s0.x.x.preheader", %"produce op_vrcpps_324"
  ret i32 0
}

; Function Attrs: nofree nosync nounwind memory(readwrite, inaccessiblemem: none)
define i32 @test_op(ptr noalias nocapture readonly %in_f32.buffer, ptr noalias nocapture readnone %in_f64.buffer, ptr noalias nocapture readnone %in_i8.buffer, ptr noalias nocapture readnone %in_u8.buffer, ptr noalias nocapture readnone %in_i16.buffer, ptr noalias nocapture readnone %in_u16.buffer, ptr noalias nocapture readnone %in_i32.buffer, ptr noalias nocapture readnone %in_u32.buffer, ptr noalias nocapture readnone %in_i64.buffer, ptr noalias nocapture readnone %in_u64.buffer, ptr noalias nocapture readonly %op_vrcpps_324.buffer) local_unnamed_addr #2 {
destructor_block:
  %"__test_op_result$20" = tail call i32 @__test_op(ptr %in_f32.buffer, ptr poison, ptr poison, ptr poison, ptr poison, ptr poison, ptr poison, ptr poison, ptr poison, ptr poison, ptr %op_vrcpps_324.buffer) #4
  ret i32 0
}
