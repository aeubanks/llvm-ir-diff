...
define dso_local i64 @foo(ptr noundef %p) local_unnamed_addr #0 {
entry:
  %0 = load i16, ptr %p, align 2, !tbaa !5
  %conv = sext i16 %0 to i64
  %add.ptr = getelementptr inbounds i16, ptr %p, i64 1
...
entry:
  ...
  store i16 -256, ptr %a, align 2, !tbaa !5
  %add.ptr.i = getelementptr inbounds i16, ptr %a, i64 1
  store ptr %add.ptr.i, ptr @q, align 8, !tbaa !9
