...
if.then:                                          ; preds = %while.body, %lor.lhs.false.i.i, %_ZNSt8_Rb_treeISt4pairIPKcS2_ES0_IKS3_iESt10_Select1stIS5_ESt4lessIS3_ESaIS5_EE14_M_lower_boundEPSt13_Rb_tree_nodeIS5_EPSt18_Rb_tree_node_baseRS4_.exit.i.i, %land.rhs.i.i.i.i
...
land.rhs.i.i98:                                   ; preds = %lor.rhs.i.i94
  ...
  br i1 %cmp6.i.i97, label %if.then18, label %if.else44.thread
...
if.else44.thread:                                 ; preds = %land.rhs.i.i98
  %brmerge.not268 = icmp eq ptr %16, %17
  br i1 %brmerge.not268, label %land.rhs.i.i171, label %cleanup80

land.rhs.i.i171:                                  ; preds = %if.else44.thread
  %second.i.i168 = getelementptr inbounds %"struct.std::_Rb_tree_node", ptr %__position.coerce, i64 0, i32 1, i32 0, i64 8
  %32 = load ptr, ptr %second.i.i168, align 8, !tbaa !38
  %second5.i.i169 = getelementptr inbounds %"struct.std::pair", ptr %__k, i64 0, i32 1
  %33 = load ptr, ptr %second5.i.i169, align 8, !tbaa !38
  %cmp6.i.i170 = icmp ult ptr %32, %33
...
if.then50:                                        ; preds = %lor.rhs.i.i94, %land.rhs.i.i171
  ...
  %34 = load ptr, ptr %_M_right.i173, align 8, !tbaa !39
  %cmp53 = icmp eq ptr %34, %__position.coerce
...
if.else57:                                        ; preds = %if.then50
  ...
  %35 = load ptr, ptr %_M_storage.i.i.i177, align 8, !tbaa !36
  %cmp.i.i178 = icmp ult ptr %16, %35
  br i1 %cmp.i.i178, label %if.then64, label %lor.rhs.i.i180

lor.rhs.i.i180:                                   ; preds = %if.else57
  %cmp4.i.i179 = icmp ult ptr %35, %16
...
land.rhs.i.i184:                                  ; preds = %lor.rhs.i.i180
  ...
  %36 = load ptr, ptr %second.i.i181, align 8, !tbaa !38
  %second5.i.i182 = getelementptr inbounds %"struct.std::_Rb_tree_node", ptr %call.i176, i64 0, i32 1, i32 0, i64 8
  %37 = load ptr, ptr %second5.i.i182, align 8, !tbaa !38
  %cmp6.i.i183 = icmp ult ptr %36, %37
...
if.then64:                                        ; preds = %if.else57, %land.rhs.i.i184
  ...
  %38 = load ptr, ptr %_M_right.i186, align 8, !tbaa !52
...
while.body.lr.ph.i194:                            ; preds = %if.else74
  ...
  %39 = load ptr, ptr %second.i.i.i193, align 8
...
while.body.i198:                                  ; preds = %while.body.i198.backedge, %while.body.lr.ph.i194
  ...
  %40 = load ptr, ptr %_M_storage.i.i.i196, align 8, !tbaa !36
  %cmp.i.i.i197 = icmp ult ptr %16, %40
  br i1 %cmp.i.i.i197, label %while.cond.i212.thread, label %lor.rhs.i.i.i200

lor.rhs.i.i.i200:                                 ; preds = %while.body.i198
  %cmp4.i.i.i199 = icmp ult ptr %40, %16
...
_ZNKSt4lessISt4pairIPKcS2_EEclERKS3_S6_.exit.i207: ; preds = %lor.rhs.i.i.i200
  ...
  %41 = load ptr, ptr %second5.i.i.i203, align 8, !tbaa !38
  %cmp6.i.i.i204 = icmp ult ptr %39, %41
...
while.cond.i212:                                  ; preds = %lor.rhs.i.i.i200, %_ZNKSt4lessISt4pairIPKcS2_EEclERKS3_S6_.exit.i207
  %42 = getelementptr inbounds %"struct.std::_Rb_tree_node_base", ptr %__x.065.i195, i64 0, i32 3
  %__x.0.i210 = load ptr, ptr %42, align 8, !tbaa !39
...
if.then.i217:                                     ; preds = %while.cond.i212.thread, %if.else74
  ...
  %43 = load ptr, ptr %_M_left.i26.i215, align 8, !tbaa !25
  %cmp.i.i216 = icmp eq ptr %__y.0.lcssa70.i214, %43
...
if.end12.i224:                                    ; preds = %while.cond.i212, %if.else.i219
  %44 = phi ptr [ %.pre, %if.else.i219 ], [ %40, %while.cond.i212 ]
  ...
  %cmp.i.i27.i223 = icmp ult ptr %44, %16
...
lor.rhs.i.i29.i226:                               ; preds = %if.end12.i224
  %cmp4.i.i28.i225 = icmp ult ptr %16, %44
...
_ZNKSt4lessISt4pairIPKcS2_EEclERKS3_S6_.exit34.i231: ; preds = %lor.rhs.i.i29.i226
  ...
  %45 = load ptr, ptr %second.i.i30.i227, align 8, !tbaa !38
  %second5.i.i31.i228 = getelementptr inbounds %"struct.std::pair", ptr %__k, i64 0, i32 1
  %46 = load ptr, ptr %second5.i.i31.i228, align 8, !tbaa !38
  %cmp6.i.i32.i229 = icmp ult ptr %45, %46
...
cleanup80:                                        ; preds = %if.else44.thread, %land.rhs.i.i171, %land.lhs.true, %if.then50, %if.then64, %if.then.i217, %lor.rhs.i.i29.i226, %_ZNKSt4lessISt4pairIPKcS2_EEclERKS3_S6_.exit34.i231, %_ZNKSt4lessISt4pairIPKcS2_EEclERKS3_S6_.exit34.thread.thread.i232, %if.then18, %if.then32, %if.then.i143, %lor.rhs.i.i29.i152, %_ZNKSt4lessISt4pairIPKcS2_EEclERKS3_S6_.exit34.i157, %_ZNKSt4lessISt4pairIPKcS2_EEclERKS3_S6_.exit34.thread.thread.i158, %_ZNKSt4lessISt4pairIPKcS2_EEclERKS3_S6_.exit34.thread.thread.i, %_ZNKSt4lessISt4pairIPKcS2_EEclERKS3_S6_.exit34.i, %lor.rhs.i.i29.i, %if.then.i, %land.rhs.i.i
  %retval.sroa.0.2 = phi ptr [ null, %land.rhs.i.i ], [ null, %if.then.i ], [ null, %_ZNKSt4lessISt4pairIPKcS2_EEclERKS3_S6_.exit34.thread.thread.i ], [ %__j.sroa.0.0.i, %lor.rhs.i.i29.i ], [ %__j.sroa.0.0.i, %_ZNKSt4lessISt4pairIPKcS2_EEclERKS3_S6_.exit34.i ], [ %__position.coerce, %if.then18 ], [ %.__position.coerce, %if.then32 ], [ null, %if.then.i143 ], [ null, %_ZNKSt4lessISt4pairIPKcS2_EEclERKS3_S6_.exit34.thread.thread.i158 ], [ %__j.sroa.0.0.i147, %lor.rhs.i.i29.i152 ], [ %__j.sroa.0.0.i147, %_ZNKSt4lessISt4pairIPKcS2_EEclERKS3_S6_.exit34.i157 ], [ null, %if.then50 ], [ %.call.i176, %if.then64 ], [ null, %if.then.i217 ], [ null, %_ZNKSt4lessISt4pairIPKcS2_EEclERKS3_S6_.exit34.thread.thread.i232 ], [ %__j.sroa.0.0.i221, %lor.rhs.i.i29.i226 ], [ %__j.sroa.0.0.i221, %_ZNKSt4lessISt4pairIPKcS2_EEclERKS3_S6_.exit34.i231 ], [ null, %land.lhs.true ], [ %__position.coerce, %land.rhs.i.i171 ], [ %__position.coerce, %if.else44.thread ]
  %retval.sroa.12.2 = phi ptr [ %1, %land.rhs.i.i ], [ %__y.0.lcssa70.i, %if.then.i ], [ %__y.0.lcssa69.i, %_ZNKSt4lessISt4pairIPKcS2_EEclERKS3_S6_.exit34.thread.thread.i ], [ null, %lor.rhs.i.i29.i ], [ null, %_ZNKSt4lessISt4pairIPKcS2_EEclERKS3_S6_.exit34.i ], [ %__position.coerce, %if.then18 ], [ %call.i.__position.coerce, %if.then32 ], [ %20, %if.then.i143 ], [ %__y.0.lcssa69.i146, %_ZNKSt4lessISt4pairIPKcS2_EEclERKS3_S6_.exit34.thread.thread.i158 ], [ null, %lor.rhs.i.i29.i152 ], [ null, %_ZNKSt4lessISt4pairIPKcS2_EEclERKS3_S6_.exit34.i157 ], [ %__position.coerce, %if.then50 ], [ %__position.coerce.call.i176, %if.then64 ], [ %__y.0.lcssa70.i214, %if.then.i217 ], [ %__y.0.lcssa69.i220, %_ZNKSt4lessISt4pairIPKcS2_EEclERKS3_S6_.exit34.thread.thread.i232 ], [ null, %lor.rhs.i.i29.i226 ], [ null, %_ZNKSt4lessISt4pairIPKcS2_EEclERKS3_S6_.exit34.i231 ], [ %1, %land.lhs.true ], [ null, %land.rhs.i.i171 ], [ null, %if.else44.thread ]
