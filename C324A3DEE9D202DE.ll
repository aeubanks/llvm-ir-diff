...
define dso_local i64 @test1(ptr noundef %0, i64 noundef %1) local_unnamed_addr #0 {
  %3 = add i64 %1, 1
  %4 = getelementptr inbounds i8, ptr @.str, i64 %1
  %5 = tail call ptr @strcpy(ptr noundef nonnull dereferenceable(1) %0, ptr noundef nonnull dereferenceable(1) %4)
  ret i64 %3
}
...
; Function Attrs: nounwind uwtable
define dso_local void @test2(ptr nocapture noundef writeonly %0) local_unnamed_addr #2 {
...
define dso_local i32 @main() local_unnamed_addr #4 {
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(3) %1, ptr noundef nonnull align 1 dereferenceable(3) getelementptr inbounds ([10 x i8], ptr @.str, i64 0, i64 7), i64 3, i1 false)
