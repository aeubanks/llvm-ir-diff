...
16:                                               ; preds = %10
  ...
  %19 = tail call i64 @strtol(ptr nocapture noundef nonnull %18, ptr noundef null, i32 noundef 10) #3
  %20 = shl i64 %19, 32
...
69:                                               ; preds = %22
  %70 = getelementptr inbounds ptr, ptr %1, i64 3
  %71 = load ptr, ptr %70, align 8, !tbaa !5
  %72 = tail call double @strtod(ptr nocapture noundef nonnull %71, ptr noundef null) #3
...
77:                                               ; preds = %74
  ...
  %80 = tail call double @strtod(ptr nocapture noundef nonnull %79, ptr noundef null) #3
  br label %81
