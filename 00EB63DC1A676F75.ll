...
if.end.i.i451:                                    ; preds = %if.end.i
  ...
  %call.i.i455 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %conv.i.i) #11
          to label %delete.notnull.i.i unwind label %lpad67

delete.notnull.i.i:                               ; preds = %if.end.i.i451
...
_ZN11CStringBaseIcE11SetCapacityEi.exit.i:        ; preds = %if.end.i, %delete.notnull.i.i
  %47 = phi ptr [ %call.i.i455, %delete.notnull.i.i ], [ %call.i.i.i448, %if.end.i ]
...
invoke.cont261:                                   ; preds = %if.end249
  ...
  %retval.13.call262 = select i1 %cmp263.not, i32 %retval.1.call50, i32 %call262
...
cleanup287:                                       ; preds = %if.end273
  ...
  %add286 = select i1 %cmp279.not, i64 %size.0, i64 0
  %spec.select639 = add i64 %complexity.2687, %add286
...
if.end293:                                        ; preds = %cleanup287, %_ZN9CMyComPtrI19ISequentialInStreamED2Ev.exit
  %complexity.5 = phi i64 [ %complexity.3, %_ZN9CMyComPtrI19ISequentialInStreamED2Ev.exit ], [ %spec.select639, %cleanup287 ]
  %retval.17 = phi i32 [ %retval.9, %_ZN9CMyComPtrI19ISequentialInStreamED2Ev.exit ], [ %retval.13.call262, %cleanup287 ]
  br label %cleanup294
...
cleanup294:                                       ; preds = %cleanup.cont268, %invoke.cont237, %invoke.cont261, %invoke.cont207, %invoke.cont222, %if.then93, %_ZN9CMyComPtrI19ISequentialInStreamED2Ev.exit, %cleanup287, %if.end293
  ...
  %complexity.6 = phi i64 [ %complexity.3, %_ZN9CMyComPtrI19ISequentialInStreamED2Ev.exit ], [ %spec.select639, %cleanup287 ], [ %complexity.5, %if.end293 ], [ %complexity.2687, %if.then93 ], [ %complexity.2687, %invoke.cont222 ], [ %complexity.2687, %invoke.cont207 ], [ %complexity.2687, %invoke.cont261 ], [ %complexity.2687, %invoke.cont237 ], [ %complexity.2687, %cleanup.cont268 ]
