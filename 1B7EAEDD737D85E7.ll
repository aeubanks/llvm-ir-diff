...
for.cond45.preheader:                             ; preds = %while.cond
  ...
  %cond660703 = icmp eq ptr %1, null
  %.pre760.pre = load ptr, ptr @optarg, align 8, !tbaa !9
  br i1 %cond660703, label %if.then70, label %for.body50

for.cond19.preheader:                             ; preds = %while.cond
  %2 = load ptr, ptr @pla_types, align 8, !tbaa !13
  %cond659707 = icmp eq ptr %2, null
  %.pre761.pre = load ptr, ptr @optarg, align 8, !tbaa !9
  br i1 %cond659707, label %if.then40, label %for.body23

for.cond.preheader:                               ; preds = %while.cond
  %3 = load ptr, ptr @option_table, align 16, !tbaa !15
  %cond658711 = icmp eq ptr %3, null
  %.pre762.pre = load ptr, ptr @optarg, align 8, !tbaa !9
  br i1 %cond658711, label %if.then14, label %for.body

for.body:                                         ; preds = %for.cond.preheader, %for.inc
  %indvars.iv754 = phi i64 [ %indvars.iv.next755, %for.inc ], [ 0, %for.cond.preheader ]
  %4 = phi ptr [ %6, %for.inc ], [ %3, %for.cond.preheader ]
  %call8 = call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %.pre762.pre, ptr noundef nonnull dereferenceable(1) %4) #15
  %cmp9 = icmp eq i32 %call8, 0
  br i1 %cmp9, label %if.then, label %for.inc

if.then:                                          ; preds = %for.body
  %5 = trunc i64 %indvars.iv754 to i32
  store i32 %5, ptr %option, align 4, !tbaa !5
  br label %while.cond.backedge

for.inc:                                          ; preds = %for.body
  %indvars.iv.next755 = add nuw i64 %indvars.iv754, 1
  %arrayidx = getelementptr inbounds [44 x %struct.anon], ptr @option_table, i64 0, i64 %indvars.iv.next755
  %6 = load ptr, ptr %arrayidx, align 8, !tbaa !15
  %cond658 = icmp eq ptr %6, null
  br i1 %cond658, label %if.then14, label %for.body

if.then14:                                        ; preds = %for.cond.preheader, %for.inc
  %7 = load ptr, ptr @stderr, align 8, !tbaa !9
  %8 = load ptr, ptr %argv, align 8, !tbaa !9
  %call16 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %7, ptr noundef nonnull @.str.63, ptr noundef %8, ptr noundef %.pre762.pre) #16
  call void @exit(i32 noundef 1) #17
  unreachable

for.cond19:                                       ; preds = %for.body23
  %indvars.iv.next752 = add nuw i64 %indvars.iv751, 1
  %arrayidx21 = getelementptr inbounds [0 x %struct.pla_types_struct], ptr @pla_types, i64 0, i64 %indvars.iv.next752
  %9 = load ptr, ptr %arrayidx21, align 8, !tbaa !13
  %cond659 = icmp eq ptr %9, null
  br i1 %cond659, label %if.then40, label %for.body23

for.body23:                                       ; preds = %for.cond19.preheader, %for.cond19
  %indvars.iv751 = phi i64 [ %indvars.iv.next752, %for.cond19 ], [ 0, %for.cond19.preheader ]
  %10 = phi ptr [ %9, %for.cond19 ], [ %2, %for.cond19.preheader ]
  %add.ptr = getelementptr inbounds i8, ptr %10, i64 1
  %call27 = call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %.pre761.pre, ptr noundef nonnull dereferenceable(1) %add.ptr) #15
  %cmp28 = icmp eq i32 %call27, 0
  br i1 %cmp28, label %if.then29, label %for.cond19

if.then29:                                        ; preds = %for.body23
  %value = getelementptr inbounds [0 x %struct.pla_types_struct], ptr @pla_types, i64 0, i64 %indvars.iv751, i32 1
...
if.then40:                                        ; preds = %for.cond19.preheader, %for.cond19
  ...
  %call42 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %12, ptr noundef nonnull @.str.64, ptr noundef %13, ptr noundef %.pre761.pre) #16
  call void @exit(i32 noundef 1) #17
  unreachable

for.cond45:                                       ; preds = %for.body50
  %indvars.iv.next749 = add nuw i64 %indvars.iv748, 1
  %arrayidx47 = getelementptr inbounds [12 x %struct.anon.1], ptr @esp_opt_table, i64 0, i64 %indvars.iv.next749
  %14 = load ptr, ptr %arrayidx47, align 8, !tbaa !11
  %cond660 = icmp eq ptr %14, null
  br i1 %cond660, label %if.then70, label %for.body50

for.body50:                                       ; preds = %for.cond45.preheader, %for.cond45
  %indvars.iv748 = phi i64 [ %indvars.iv.next749, %for.cond45 ], [ 0, %for.cond45.preheader ]
  %15 = phi ptr [ %14, %for.cond45 ], [ %1, %for.cond45.preheader ]
  %call54 = call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %.pre760.pre, ptr noundef nonnull dereferenceable(1) %15) #15
  %cmp55 = icmp eq i32 %call54, 0
  br i1 %cmp55, label %if.then56, label %for.cond45

if.then56:                                        ; preds = %for.body50
  %value59 = getelementptr inbounds [12 x %struct.anon.1], ptr @esp_opt_table, i64 0, i64 %indvars.iv748, i32 2
  %16 = load i32, ptr %value59, align 8, !tbaa !18
  %variable = getelementptr inbounds [12 x %struct.anon.1], ptr @esp_opt_table, i64 0, i64 %indvars.iv748, i32 1
...
if.then70:                                        ; preds = %for.cond45.preheader, %for.cond45
  ...
  %call72 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %18, ptr noundef nonnull @.str.65, ptr noundef %19, ptr noundef %.pre760.pre) #16
  call void @exit(i32 noundef 1) #17
  unreachable
...
sw.bb75:                                          ; preds = %while.cond
  ...
  %cond661699 = icmp eq ptr %21, null
  %.pre.pre = load ptr, ptr @optarg, align 8, !tbaa !9
  br i1 %cond661699, label %if.then99, label %for.body81
...
for.cond76:                                       ; preds = %for.body81
  ...
  %cond661 = icmp eq ptr %22, null
  br i1 %cond661, label %if.then99, label %for.body81
...
for.body81:                                       ; preds = %sw.bb75, %for.cond76
  ...
  %call85 = call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %.pre.pre, ptr noundef nonnull dereferenceable(1) %23) #15
  %cmp86 = icmp eq i32 %call85, 0
  br i1 %cmp86, label %if.then87, label %for.cond76
...
while.cond.backedge:                              ; preds = %if.then87, %if.then56, %if.then29, %if.then, %sw.bb108, %sw.bb106, %sw.bb105, %sw.bb104, %sw.bb103, %sw.bb74
  %strategy.0.be = phi i32 [ %strategy.0, %sw.bb108 ], [ %conv.i, %sw.bb106 ], [ %strategy.0, %sw.bb105 ], [ %strategy.0, %sw.bb104 ], [ %strategy.0, %sw.bb103 ], [ %strategy.0, %if.then87 ], [ %strategy.0, %sw.bb74 ], [ %strategy.0, %if.then56 ], [ %strategy.0, %if.then29 ], [ %strategy.0, %if.then ]
  br label %while.cond

if.then99:                                        ; preds = %sw.bb75, %for.cond76
  %26 = load ptr, ptr @stderr, align 8, !tbaa !9
  %27 = load ptr, ptr %argv, align 8, !tbaa !9
  %call101 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %26, ptr noundef nonnull @.str.66, ptr noundef %27, ptr noundef %.pre.pre) #16
  call void @exit(i32 noundef 1) #17
  unreachable
...
if.then117:                                       ; preds = %while.end
  ...
  %cmp120713 = icmp sgt i32 %0, 1
  br i1 %cmp120713, label %for.body121.preheader, label %for.end128
...
for.body121:                                      ; preds = %for.body121.preheader, %for.body121
  %indvars.iv757 = phi i64 [ 1, %for.body121.preheader ], [ %indvars.iv.next758, %for.body121 ]
  %arrayidx123 = getelementptr inbounds ptr, ptr %argv, i64 %indvars.iv757
...
if.then136:                                       ; preds = %sw.bb134
  ...
  %.pre764 = load i32, ptr @optind, align 4, !tbaa !5
  br label %if.end137

if.end137:                                        ; preds = %if.then136, %sw.bb134
  %39 = phi i32 [ %.pre764, %if.then136 ], [ %38, %sw.bb134 ]
...
if.then145:                                       ; preds = %sw.bb142
  call void (ptr, ...) @fatal(ptr noundef nonnull @.str.74) #14
  %.pre763 = load i32, ptr @optind, align 4, !tbaa !5
  %.pre773 = add nsw i32 %.pre763, 1
  br label %if.end146

if.end146:                                        ; preds = %if.then145, %sw.bb142
  %inc147.pre-phi = phi i32 [ %.pre773, %if.then145 ], [ %add143, %sw.bb142 ]
  %43 = phi i32 [ %.pre763, %if.then145 ], [ %42, %sw.bb142 ]
...
for.cond434.preheader:                            ; preds = %if.end163
  ...
  %cmp435715 = icmp sgt i32 %51, 0
  br i1 %cmp435715, label %for.body436, label %sw.epilog530
...
sw.bb255:                                         ; preds = %if.end163
  ...
  %cmp261719 = icmp sgt i32 %mul, 0
  br i1 %cmp261719, label %for.body262, label %for.end271

for.body262:                                      ; preds = %sw.bb255, %for.body262
  %p.0720 = phi ptr [ %add.ptr270, %for.body262 ], [ %111, %sw.bb255 ]
  %114 = load i32, ptr %p.0720, align 4, !tbaa !5
  %or264 = and i32 %114, -17409
  %and = or i32 %or264, 1024
  store i32 %and, ptr %p.0720, align 4, !tbaa !5
  %115 = load i32, ptr %110, align 8, !tbaa !36
  %idx.ext269 = sext i32 %115 to i64
  %add.ptr270 = getelementptr inbounds i32, ptr %p.0720, i64 %idx.ext269
...
if.end340:                                        ; preds = %if.then339, %lor.lhs.false335
  ...
  %.pre765 = load ptr, ptr getelementptr inbounds (%struct.cube_struct, ptr @cube, i64 0, i32 5), align 8, !tbaa !32
  %.pre766 = load i32, ptr getelementptr inbounds (%struct.cube_struct, ptr @cube, i64 0, i32 18), align 4, !tbaa !37
  %idxprom347.phi.trans.insert = sext i32 %.pre766 to i64
  %arrayidx348.phi.trans.insert = getelementptr inbounds i32, ptr %.pre765, i64 %idxprom347.phi.trans.insert
  %.pre767 = load i32, ptr %arrayidx348.phi.trans.insert, align 4, !tbaa !5
  %cmp345.not = icmp slt i32 %163, %.pre767
  %or.cond792 = select i1 %cmp341, i1 %cmp345.not, i1 false
  br i1 %or.cond792, label %if.end350, label %if.then346

if.then346:                                       ; preds = %if.end340
  %sub349 = add nsw i32 %.pre767, -1
...
sw.bb396:                                         ; preds = %if.end163
  ...
  %or.cond654 = select i1 %cmp397, i1 %cmp399.not, i1 false
  br i1 %or.cond654, label %if.end401, label %if.then400
...
if.end401:                                        ; preds = %sw.bb396, %if.then400
  ...
  %or.cond655 = select i1 %cmp402, i1 %cmp404.not, i1 false
  br i1 %or.cond655, label %if.end407, label %if.then405
...
sw.bb412:                                         ; preds = %if.end163
  ...
  %or.cond656 = select i1 %cmp413, i1 %cmp415.not, i1 false
  br i1 %or.cond656, label %if.end417, label %if.then416
...
if.end417:                                        ; preds = %sw.bb412, %if.then416
  ...
  %or.cond657 = select i1 %cmp418, i1 %cmp420.not, i1 false
  br i1 %or.cond657, label %if.end423, label %if.then421
...
if.then532:                                       ; preds = %sw.epilog530
  ...
  %.pre768 = load i32, ptr @trace, align 4
  %281 = icmp ne i32 %.pre768, 0
  br label %if.end534
...
if.end534:                                        ; preds = %sw.bb206, %sw.bb316, %if.then532, %sw.epilog530
  ...
  %error.0664 = phi i32 [ %error.0.ph, %if.then532 ], [ %error.0.ph, %sw.epilog530 ], [ 0, %sw.bb316 ], [ 0, %sw.bb206 ]
...
if.end551:                                        ; preds = %if.then547, %if.end545
  %tobool552.not = icmp eq i32 %error.0664, 0
