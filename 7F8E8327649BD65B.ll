...
entry:
  ...
  store volatile double 3.200000e+01, ptr %a, align 8, !tbaa !5
  %a.0.a.0.a.0.a.0. = load volatile double, ptr %a, align 8, !tbaa !5
  %call = tail call double @pow(double noundef %a.0.a.0.a.0.a.0., double noundef 0x3FD5555555555555) #4
  %add = fadd double %call, 1.000000e-01
  %cmp = fcmp ogt double %add, 0x400965FE974A3401
  %sub = fadd double %call, -1.000000e-01
  %cmp1 = fcmp olt double %sub, 0x400965FE974A3401
