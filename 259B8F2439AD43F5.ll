...
define dso_local void @bar(ptr noundef %x) local_unnamed_addr #0 {
entry:
  %x.addr = alloca ptr, align 8
  store ptr %x, ptr %x.addr, align 8, !tbaa !5
  call void asm sideeffect "", "=*m,~{dirflag},~{fpsr},~{flags}"(ptr nonnull elementtype(ptr) %x.addr) #4, !srcloc !9
  ret void
}
...
entry:
  ...
  %0 = load i64, ptr @v, align 8, !tbaa !10
