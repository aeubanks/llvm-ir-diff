...
for.body.us.us:                                   ; preds = %for.body.us.us.preheader, %for.cond49.for.inc86.loopexit_crit_edge.us.us
  ...
  %4 = mul nsw i64 %indvars.iv165, %idx.ext2
  %add.ptr.us.us = getelementptr inbounds i8, ptr %fld0, i64 %4
  %5 = icmp eq i64 %indvars.iv165, 0
  %idx.ext2.pn.us.us = select i1 %5, i64 %idx.ext2, i64 %idx.neg
  %cond.us.us = getelementptr inbounds i8, ptr %add.ptr.us.us, i64 %idx.ext2.pn.us.us
  %6 = icmp eq i64 %indvars.iv165, %sext169
  %idx.neg9.pn.us.us = select i1 %6, i64 %idx.neg, i64 %idx.ext2
  %cond15.us.us = getelementptr inbounds i8, ptr %add.ptr.us.us, i64 %idx.neg9.pn.us.us
  %add.ptr28.us.us = getelementptr inbounds i8, ptr %fld1, i64 %4
  ...
  %cond48.us.us.idx = select i1 %cmp40.not.us.us, i64 %3, i64 0
...
for.body52.us.us:                                 ; preds = %for.body.us.us, %for.body52.us.us
  ...
  %7 = load i8, ptr %arrayidx54.us.us, align 1, !tbaa !13
  %conv55.us.us = zext i8 %7 to i32
  %arrayidx57.us.us = getelementptr inbounds i8, ptr %cond15.us.us, i64 %indvars.iv160
  %8 = load i8, ptr %arrayidx57.us.us, align 1, !tbaa !13
  %conv58.us.us = zext i8 %8 to i32
  ...
  %9 = load i8, ptr %arrayidx62.us.us, align 1, !tbaa !13
  %conv63.us.us = zext i8 %9 to i32
  %mul64.us.us = shl nuw nsw i32 %conv63.us.us, 1
  %arrayidx67.us.us = getelementptr inbounds i8, ptr %cond38.us.us, i64 %indvars.iv160
  %10 = load i8, ptr %arrayidx67.us.us, align 1, !tbaa !13
  %conv68.us.us = zext i8 %10 to i32
  %arrayidx71.us.us = getelementptr inbounds i8, ptr %cond48.us.us, i64 %indvars.iv160
  %11 = load i8, ptr %arrayidx71.us.us, align 1, !tbaa !13
  %conv72.us.us = zext i8 %11 to i32
  %.neg.us.us = add nuw nsw i32 %mul60.us.us, %mul64.us.us
  %12 = add nuw nsw i32 %conv68.us.us, %conv72.us.us
  %sub73.us.us = sub nsw i32 %.neg.us.us, %12
  %13 = load ptr, ptr @Clip, align 8, !tbaa !9
  ...
  %arrayidx80.us.us = getelementptr inbounds i8, ptr %13, i64 %idxprom79.us.us
  %14 = load i8, ptr %arrayidx80.us.us, align 1, !tbaa !13
  %arrayidx82.us.us = getelementptr inbounds i8, ptr %add.ptr.us.us, i64 %indvars.iv160
  store i8 %14, ptr %arrayidx82.us.us, align 1, !tbaa !13
...
for.body.us138.preheader:                         ; preds = %for.body.lr.ph.split
  %15 = sext i32 %j0 to i64
  %16 = sext i32 %ly to i64
...
iter.check:                                       ; preds = %for.body.us138.preheader, %for.cond16.for.inc86.loopexit131_crit_edge.us
  %indvars.iv155 = phi i64 [ %15, %for.body.us138.preheader ], [ %indvars.iv.next156, %for.cond16.for.inc86.loopexit131_crit_edge.us ]
  %18 = mul nsw i64 %indvars.iv155, %idx.ext2
  %add.ptr.us142 = getelementptr inbounds i8, ptr %fld0, i64 %18
  %19 = icmp eq i64 %indvars.iv155, 0
  %idx.ext2.pn.us144 = select i1 %19, i64 %idx.ext2, i64 %idx.neg
  %cond.us145 = getelementptr inbounds i8, ptr %add.ptr.us142, i64 %idx.ext2.pn.us144
  %20 = icmp eq i64 %indvars.iv155, %sext158
  %idx.neg9.pn.us147 = select i1 %20, i64 %idx.neg, i64 %idx.ext2
...
vector.memcheck:                                  ; preds = %iter.check
  %21 = add nsw i64 %idx.ext2.pn.us144, 31
  %diff.check = icmp ult i64 %21, 32
  %22 = add nsw i64 %idx.neg9.pn.us147, 31
  %diff.check174 = icmp ult i64 %22, 32
...
vector.body:                                      ; preds = %vector.main.loop.iter.check, %vector.body
  ...
  %23 = getelementptr inbounds i8, ptr %cond.us145, i64 %index
  %wide.load = load <16 x i8>, ptr %23, align 1, !tbaa !13
  %24 = getelementptr inbounds i8, ptr %23, i64 16
  %wide.load176 = load <16 x i8>, ptr %24, align 1, !tbaa !13
  %25 = zext <16 x i8> %wide.load to <16 x i16>
  %26 = zext <16 x i8> %wide.load176 to <16 x i16>
  %27 = getelementptr inbounds i8, ptr %cond15.us148, i64 %index
  %wide.load177 = load <16 x i8>, ptr %27, align 1, !tbaa !13
  %28 = getelementptr inbounds i8, ptr %27, i64 16
  %wide.load178 = load <16 x i8>, ptr %28, align 1, !tbaa !13
  %29 = zext <16 x i8> %wide.load177 to <16 x i16>
  %30 = zext <16 x i8> %wide.load178 to <16 x i16>
  ...
  %32 = add nuw nsw <16 x i16> %26, <i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1>
  %33 = add nuw nsw <16 x i16> %31, %29
  %34 = add nuw nsw <16 x i16> %32, %30
  %35 = lshr <16 x i16> %33, <i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1>
  %36 = lshr <16 x i16> %34, <i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1>
  %37 = trunc <16 x i16> %35 to <16 x i8>
  %38 = trunc <16 x i16> %36 to <16 x i8>
  %39 = getelementptr inbounds i8, ptr %add.ptr.us142, i64 %index
  store <16 x i8> %37, ptr %39, align 1, !tbaa !13
  %40 = getelementptr inbounds i8, ptr %39, i64 16
  store <16 x i8> %38, ptr %40, align 1, !tbaa !13
  %index.next = add nuw i64 %index, 32
  %41 = icmp eq i64 %index.next, %n.vec
  br i1 %41, label %middle.block, label %vector.body, !llvm.loop !79
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %42 = getelementptr inbounds i8, ptr %cond.us145, i64 %index182
  %wide.load183 = load <8 x i8>, ptr %42, align 1, !tbaa !13
  %43 = zext <8 x i8> %wide.load183 to <8 x i16>
  %44 = getelementptr inbounds i8, ptr %cond15.us148, i64 %index182
  %wide.load184 = load <8 x i8>, ptr %44, align 1, !tbaa !13
  %45 = zext <8 x i8> %wide.load184 to <8 x i16>
  %46 = add nuw nsw <8 x i16> %43, <i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1>
  %47 = add nuw nsw <8 x i16> %46, %45
  %48 = lshr <8 x i16> %47, <i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1>
  %49 = trunc <8 x i16> %48 to <8 x i8>
  %50 = getelementptr inbounds i8, ptr %add.ptr.us142, i64 %index182
  store <8 x i8> %49, ptr %50, align 1, !tbaa !13
  %index.next185 = add nuw i64 %index182, 8
  %51 = icmp eq i64 %index.next185, %n.vec180
  br i1 %51, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !80
...
for.body18.us.prol:                               ; preds = %for.body18.us.preheader
  ...
  %53 = load i8, ptr %arrayidx.us.prol, align 1, !tbaa !13
  %conv.us.prol = zext i8 %53 to i16
  %arrayidx20.us.prol = getelementptr inbounds i8, ptr %cond15.us148, i64 %indvars.iv.ph
  %54 = load i8, ptr %arrayidx20.us.prol, align 1, !tbaa !13
  %conv21.us.prol = zext i8 %54 to i16
...
for.body18.us.prol.loopexit:                      ; preds = %for.body18.us.prol, %for.body18.us.preheader
  ...
  br i1 %55, label %for.cond16.for.inc86.loopexit131_crit_edge.us, label %for.body18.us
...
for.body18.us:                                    ; preds = %for.body18.us.prol.loopexit, %for.body18.us
  ...
  %56 = load i8, ptr %arrayidx.us, align 1, !tbaa !13
  %conv.us = zext i8 %56 to i16
  %arrayidx20.us = getelementptr inbounds i8, ptr %cond15.us148, i64 %indvars.iv
  %57 = load i8, ptr %arrayidx20.us, align 1, !tbaa !13
  %conv21.us = zext i8 %57 to i16
  ...
  %58 = load i8, ptr %arrayidx.us.1, align 1, !tbaa !13
  %conv.us.1 = zext i8 %58 to i16
  %arrayidx20.us.1 = getelementptr inbounds i8, ptr %cond15.us148, i64 %indvars.iv.next
  %59 = load i8, ptr %arrayidx20.us.1, align 1, !tbaa !13
  %conv21.us.1 = zext i8 %59 to i16
...
for.cond16.for.inc86.loopexit131_crit_edge.us:    ; preds = %for.body18.us.prol.loopexit, %for.body18.us, %vec.epilog.middle.block, %middle.block
  ...
  %cmp.us150 = icmp slt i64 %indvars.iv.next156, %16
