...
define dso_local i32 @bla(ptr nocapture noundef writeonly %xa, ptr nocapture noundef %xb) local_unnamed_addr #0 {
entry:
  store i32 1, ptr @global, align 4, !tbaa !5
  %sub = getelementptr inbounds %struct.test2, ptr %xb, i64 0, i32 1
