...
entry:
  %0 = load i64, ptr @ull1, align 8, !tbaa !5
  %cmp.not = icmp eq i64 %0, 0
  %conv3 = select i1 %cmp.not, i64 2595916315, i64 2595916314
  store i64 %conv3, ptr @ll, align 8, !tbaa !5
  %add = add nsw i64 %conv3, -2129105131
  %xor = xor i64 %add, -8165993929295883380
  %sub4 = add nsw i64 %xor, 8165993929712309607
  %shl = shl i64 2067854353, %sub4
  %conv5 = trunc i64 %shl to i32
  %1 = load i64, ptr @ull2, align 8, !tbaa !5
  %2 = trunc i64 %1 to i32
  %3 = or i32 %2, -8651009
  %sh_prom = add nsw i32 %3, 5
  %shr = lshr i32 %conv5, %sh_prom
...
entry:
  %call = tail call i64 @foo(), !range !9
  store i64 %call, ptr @ull3, align 8, !tbaa !5
  %cmp.not = icmp eq i64 %call, 3998784
