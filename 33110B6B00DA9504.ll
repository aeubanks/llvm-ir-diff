...
if.then26.i:                                      ; preds = %if.then23.i
  ...
  %.pre254.i = sub nsw i32 0, %call3.val180.pre.i
  br label %if.end37.i

if.end37.i:                                       ; preds = %if.then26.i, %if.then23.i
  %sub.i.i216.pre-phi.i = phi i32 [ %.pre254.i, %if.then26.i ], [ %sub.i.i.i.i, %if.then23.i ]
...
if.else40.i:                                      ; preds = %if.else.i
  ...
  br i1 %cmp.i221.i, label %if.end84.i, label %while.body56.i

while.body56.i:                                   ; preds = %if.else40.i, %if.end75.i
  %HelpList.0243.i = phi ptr [ %HelpList.0.val.i, %if.end75.i ], [ %call42.val.i, %if.else40.i ]
  %17 = getelementptr i8, ptr %HelpList.0243.i, i64 8
...
land.rhs66.i:                                     ; preds = %while.body72.i, %if.then60.i
  %DuplHelpArgList.0239.in.i = phi ptr [ %18, %if.then60.i ], [ %DuplHelpArgList.0239.i, %while.body72.i ]
  %OrigHelpArgList.0238.i = phi ptr [ %T.val4.i.i, %if.then60.i ], [ %OrigHelpArgList.0.val.i, %while.body72.i ]
  %DuplHelpArgList.0239.i = load ptr, ptr %DuplHelpArgList.0239.in.i, align 8
  %19 = getelementptr i8, ptr %OrigHelpArgList.0238.i, i64 8
  ...
  %21 = getelementptr i8, ptr %DuplHelpArgList.0239.i, i64 8
...
while.body72.i:                                   ; preds = %land.rhs66.i
  %OrigHelpArgList.0.val.i = load ptr, ptr %OrigHelpArgList.0238.i, align 8
  %cmp.i225.i = icmp eq ptr %OrigHelpArgList.0.val.i, null
  br i1 %cmp.i225.i, label %if.end104.i, label %land.rhs66.i, !llvm.loop !15

if.end75.i:                                       ; preds = %land.rhs66.i, %while.body56.i
  %HelpList.0.val.i = load ptr, ptr %HelpList.0243.i, align 8
  %cmp.i223.not.not.i = icmp eq ptr %HelpList.0.val.i, null
  br i1 %cmp.i223.not.not.i, label %if.end84.i, label %while.body56.i, !llvm.loop !16

if.end84.i:                                       ; preds = %if.end75.i, %if.else40.i
  %call82.i = tail call ptr @term_Create(i32 noundef %call3.val174.i, ptr noundef null) #10
...
for.body.lr.ph.i:                                 ; preds = %if.end84.i
  %22 = getelementptr i8, ptr %call82.i, i64 16
  br label %for.body.i

for.body.i:                                       ; preds = %for.body.i, %for.body.lr.ph.i
  %HelpList.1248.i = phi ptr [ %HelpList.1246.i, %for.body.lr.ph.i ], [ %HelpList.1.i, %for.body.i ]
  %23 = getelementptr i8, ptr %HelpList.1248.i, i64 8
  ...
  store ptr %call82.i, ptr %car.i230.i, align 8
...
for.end.i:                                        ; preds = %for.body.i, %if.end84.i
  %26 = getelementptr i8, ptr %call82.i, i64 16
  ...
  tail call void @st_EntryCreate(ptr noundef %SharedIndex.val.i, ptr noundef %call82.i, ptr noundef %call82.i, ptr noundef %27) #10
  br label %if.end104.i

if.end104.i:                                      ; preds = %while.body72.i, %for.end.i, %if.end37.i, %if.then8.i, %if.then.i
  %.sink.i = phi ptr [ %13, %if.end37.i ], [ %.pre.i, %if.then8.i ], [ %6, %if.then.i ], [ %call82.i, %for.end.i ], [ %HelpList.0.val188.i, %while.body72.i ]
...
land.rhs37:                                       ; preds = %while.cond34
  ...
  br i1 %cmp.i87, label %while.cond34, label %while.end, !llvm.loop !27

while.end:                                        ; preds = %land.rhs37
  br label %land.rhs25, !llvm.loop !28
...
while.end44:                                      ; preds = %do.cond15, %while.cond34
  ...
  br i1 %cmp, label %do.body.preheader, label %if.end54, !llvm.loop !29
...
for.inc:                                          ; preds = %for.end.i, %if.end.i, %if.then6, %for.body
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, 3001
  br i1 %exitcond.not, label %for.body13, label %for.body, !llvm.loop !30
...
for.inc20:                                        ; preds = %for.end.i45, %if.end.i40, %if.then16, %for.body13
  ...
  br i1 %exitcond56.not, label %for.end22, label %for.body13, !llvm.loop !31
...
for.inc:                                          ; preds = %for.body, %if.then7
  ...
  %cmp.i.not = icmp eq ptr %SuperList.0, null
  br i1 %cmp.i.not, label %if.end9, label %for.body, !llvm.loop !32
...
for.inc16:                                        ; preds = %for.body9, %if.then12
  ...
  br i1 %exitcond41.not, label %for.end18, label %for.body9, !llvm.loop !40
...
while.body:                                       ; preds = %if.then5, %while.body
  ...
  br i1 %cmp.i23.not, label %if.end12, label %while.body, !llvm.loop !41
...
if.end:                                           ; preds = %if.then, %while.body
  ...
  br i1 %cmp.i.not, label %while.end, label %while.body, !llvm.loop !42
