...
for.cond.preheader:                               ; preds = %if.end
  %cmp6239.not = icmp eq i32 %conv, 0
  br i1 %cmp6239.not, label %cleanup, label %for.body

for.body:                                         ; preds = %for.cond.preheader, %if.end99
  %i.0241 = phi i32 [ %add100, %if.end99 ], [ 0, %for.cond.preheader ]
  %ptr.0240 = phi ptr [ %incdec.ptr, %if.end99 ], [ %call3, %for.cond.preheader ]
  %idxprom = zext i32 %i.0241 to i64
  %arrayidx = getelementptr inbounds i8, ptr %hex, i64 %idxprom
  %0 = load i8, ptr %arrayidx, align 1, !tbaa !5
  %cmp9 = icmp eq i8 %0, 63
  %add11 = or i32 %i.0241, 1
...
if.else:                                          ; preds = %for.body
  br i1 %cmp15, label %if.then26, label %if.else40
...
if.end3.i:                                        ; preds = %if.end.i
  ...
  br i1 %or.cond21.i, label %cli_hex2int.exit.thread213, label %if.end20.i

cli_hex2int.exit.thread213:                       ; preds = %if.end3.i
...
cli_hex2int.exit:                                 ; preds = %if.end.i
  %sub.i = add nsw i32 %conv29, -48
  %cmp31 = icmp ugt i8 %0, 47
  br i1 %cmp31, label %if.then33, label %if.else35

if.then33:                                        ; preds = %cli_hex2int.exit.thread213, %cli_hex2int.exit
  %retval.0.i216 = phi i32 [ %sub19.i, %cli_hex2int.exit.thread213 ], [ %sub.i, %cli_hex2int.exit ]
  %retval.0.i.tr = trunc i32 %retval.0.i216 to i16
...
if.else40:                                        ; preds = %if.else
  ...
  %cond = icmp eq i8 %0, 40
  br i1 %cond, label %if.end99, label %if.else71

if.then46:                                        ; preds = %land.lhs.true
  %conv23207220 = sext i8 %1 to i32
...
if.end.i148:                                      ; preds = %if.then46
  ...
  %idxprom.i145 = zext i32 %conv23207220 to i64
...
if.end3.i156:                                     ; preds = %if.end.i148
  ...
  br i1 %or.cond21.i155, label %cli_hex2int.exit161.thread223, label %if.end20.i159

cli_hex2int.exit161.thread223:                    ; preds = %if.end3.i156
...
cli_hex2int.exit161:                              ; preds = %if.end.i148
  %sub.i149 = add nsw i32 %conv23207220, -48
  %cmp52 = icmp ugt i8 %1, 47
  br i1 %cmp52, label %if.then54, label %if.else56

if.then54:                                        ; preds = %cli_hex2int.exit161.thread223, %cli_hex2int.exit161
  %retval.0.i160226 = phi i32 [ %sub19.i157, %cli_hex2int.exit161.thread223 ], [ %sub.i149, %cli_hex2int.exit161 ]
  %11 = trunc i32 %retval.0.i160226 to i16
...
if.end.i167:                                      ; preds = %if.else71
  ...
  %idxprom.i164 = zext i32 %conv43 to i64
...
if.end3.i175:                                     ; preds = %if.end.i167
  ...
  br i1 %or.cond21.i174, label %cli_hex2int.exit180.thread229, label %if.end20.i178

cli_hex2int.exit180.thread229:                    ; preds = %if.end3.i175
...
cli_hex2int.exit180:                              ; preds = %if.end.i167
  %sub.i168 = add nsw i32 %conv43, -48
  %cmp76 = icmp ugt i8 %0, 47
  br i1 %cmp76, label %if.then78, label %if.else94

if.then78:                                        ; preds = %cli_hex2int.exit180.thread229, %cli_hex2int.exit180
  %retval.0.i179232 = phi i32 [ %sub19.i176, %cli_hex2int.exit180.thread229 ], [ %sub.i168, %cli_hex2int.exit180 ]
...
if.end3.i194:                                     ; preds = %if.end.i186
  ...
  br i1 %or.cond21.i193, label %cli_hex2int.exit199.thread235, label %if.end20.i197

cli_hex2int.exit199.thread235:                    ; preds = %if.end3.i194
...
if.then87:                                        ; preds = %cli_hex2int.exit199.thread235, %cli_hex2int.exit199
  %retval.0.i198238 = phi i32 [ %sub19.i195, %cli_hex2int.exit199.thread235 ], [ %sub.i187, %cli_hex2int.exit199 ]
  %conv88 = shl nuw nsw i32 %retval.0.i179232, 4
  %add90 = add nuw nsw i32 %retval.0.i198238, %conv88
...
if.end99:                                         ; preds = %if.else40, %land.lhs.true, %if.then33, %if.then87, %if.then54
  ...
  %incdec.ptr = getelementptr inbounds i16, ptr %ptr.0240, i64 1
  store i16 %val.0, ptr %ptr.0240, align 2, !tbaa !10
  %add100 = add i32 %i.0241, 2
