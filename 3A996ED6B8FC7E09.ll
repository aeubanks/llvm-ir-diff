...
_ZN15CLockedInStream4InitEP9IInStream.exit:       ; preds = %if.then2.i.i, %if.end.i.i
  ...
  %cmp1212 = icmp sgt i32 %8, 0
  br i1 %cmp1212, label %for.body.lr.ph, label %for.cond.cleanup
...
for.body:                                         ; preds = %for.body.lr.ph, %_ZN9CMyComPtrI19ISequentialInStreamED2Ev.exit698
  ...
  %startPos.addr.01214 = phi i64 [ %startPos, %for.body.lr.ph ], [ %add, %_ZN9CMyComPtrI19ISequentialInStreamED2Ev.exit698 ]
...
invoke.cont17:                                    ; preds = %invoke.cont13
  ...
  %call.i665 = invoke noundef i32 %10(ptr noundef nonnull align 8 dereferenceable(8) %call18)
          to label %if.then.i.i672 unwind label %lpad22

if.then.i.i672:                                   ; preds = %invoke.cont17
...
if.end.i.i674:                                    ; preds = %if.then.i.i672
...
lpad24:                                           ; preds = %invoke.cont.i, %_ZN26CLimitedSequentialInStream9SetStreamEP19ISequentialInStream.exit, %if.then2.i.i677, %if.then.i.i672
...
for.cond78.preheader:                             ; preds = %invoke.cont72
  %cmp791215 = icmp sgt i32 %11, 0
  br i1 %cmp791215, label %for.body80.lr.ph, label %for.end163
...
for.cond78:                                       ; preds = %_ZN9CMyComPtrI14ICompressCoderED2Ev.exit
  ...
  %exitcond.not = icmp eq i64 %indvars.iv.next1288, %wide.trip.count
  br i1 %exitcond.not, label %for.end163, label %for.body80, !llvm.loop !73

for.body80:                                       ; preds = %for.body80.lr.ph, %for.cond78
  %indvars.iv1287 = phi i64 [ 0, %for.body80.lr.ph ], [ %indvars.iv.next1288, %for.cond78 ]
  %retval.11217 = phi i32 [ 0, %for.body80.lr.ph ], [ %retval.41148, %for.cond78 ]
  %122 = load ptr, ptr %_items.i.i760, align 8, !tbaa !47
  %arrayidx.i.i762 = getelementptr inbounds ptr, ptr %122, i64 %indvars.iv1287
...
lpad102.body.thread1098:                          ; preds = %invoke.cont.i809, %if.end141, %if.then117, %if.then135
  %decoderUnknown.sroa.0.0.ph = phi ptr [ %137, %if.then135 ], [ %129, %if.then117 ], [ %decoderUnknown.sroa.0.2, %if.end141 ], [ %decoderUnknown.sroa.0.2, %invoke.cont.i809 ]
  %lpad.thr_comm = landingpad { ptr, i32 }
          cleanup
  br label %if.then.i770

lpad102.body:                                     ; preds = %if.then.i776, %if.then.i788
  %lpad.thr_comm.split-lp = landingpad { ptr, i32 }
          cleanup
  br label %ehcleanup150

if.then.i770:                                     ; preds = %lpad102.body.thread1098, %lpad102.body.thread
  %eh.lpad-body8131097 = phi { ptr, i32 } [ %143, %lpad102.body.thread ], [ %lpad.thr_comm, %lpad102.body.thread1098 ]
  %decoderUnknown.sroa.0.11096 = phi ptr [ %decoderUnknown.sroa.0.2, %lpad102.body.thread ], [ %decoderUnknown.sroa.0.0.ph, %lpad102.body.thread1098 ]
...
if.then.i776:                                     ; preds = %if.then105
  ...
  %call.i775781 = invoke noundef i32 %133(ptr noundef nonnull align 8 dereferenceable(8) %129)
          to label %invoke.cont113 unwind label %lpad102.body
...
if.then117:                                       ; preds = %invoke.cont113
  ...
  invoke void @_ZN11NCoderMixer14CCoderMixer2MT8AddCoderEP14ICompressCoder(ptr noundef nonnull align 8 dereferenceable(224) %135, ptr noundef %136)
          to label %if.end141 unwind label %lpad102.body.thread1098
...
if.then.i788:                                     ; preds = %if.else123
  ...
  %call.i787794 = invoke noundef i32 %138(ptr noundef nonnull align 8 dereferenceable(8) %137)
          to label %invoke.cont131 unwind label %lpad102.body
...
if.end141:                                        ; preds = %invoke.cont131, %if.then135, %invoke.cont113, %if.then117
  ...
  %call.i798811 = invoke noalias noundef nonnull dereferenceable(8) ptr @_Znwm(i64 noundef 8) #16
          to label %call.i798.noexc unwind label %lpad102.body.thread1098

call.i798.noexc:                                  ; preds = %if.end141
...
invoke.cont.i809:                                 ; preds = %call.i798.noexc
  invoke void @_ZN17CBaseRecordVector18ReserveOnePositionEv(ptr noundef nonnull align 8 dereferenceable(32) %_decoders)
          to label %if.then.i818 unwind label %lpad102.body.thread1098

lpad102.body.thread:                              ; preds = %call.i798.noexc
  %143 = landingpad { ptr, i32 }
          cleanup
  call void @_ZdlPv(ptr noundef nonnull %call.i798811) #17
  br label %if.then.i770

if.then.i818:                                     ; preds = %invoke.cont.i809
...
terminate.lpad.i820:                              ; preds = %if.then.i818
...
cleanup149:                                       ; preds = %if.then105, %if.then.i818, %invoke.cont91
  %cleanup.dest.slot.3.ph = phi i32 [ 1, %if.then105 ], [ 0, %if.then.i818 ], [ 1, %invoke.cont91 ]
  %retval.4.ph = phi i32 [ -2147467263, %if.then105 ], [ %retval.11217, %if.then.i818 ], [ %call92, %invoke.cont91 ]
  %.pr1143 = load ptr, ptr %decoder2, align 8, !tbaa !14
  %tobool.not.i822 = icmp eq ptr %.pr1143, null
  br i1 %tobool.not.i822, label %_ZN9CMyComPtrI15ICompressCoder2ED2Ev.exit, label %if.then.i826

if.then.i826:                                     ; preds = %cleanup149
  %vtable.i823 = load ptr, ptr %.pr1143, align 8, !tbaa !12
  %vfn.i824 = getelementptr inbounds ptr, ptr %vtable.i823, i64 2
  %149 = load ptr, ptr %vfn.i824, align 8
  %call.i825 = invoke noundef i32 %149(ptr noundef nonnull align 8 dereferenceable(8) %.pr1143)
...
_ZN9CMyComPtrI15ICompressCoder2ED2Ev.exit:        ; preds = %if.else123, %cleanup149, %if.then.i826
  %retval.41148 = phi i32 [ %retval.4.ph, %cleanup149 ], [ %retval.4.ph, %if.then.i826 ], [ -2147467263, %if.else123 ]
  %cleanup.dest.slot.31147 = phi i32 [ %cleanup.dest.slot.3.ph, %cleanup149 ], [ %cleanup.dest.slot.3.ph, %if.then.i826 ], [ 1, %if.else123 ]
...
_ZN9CMyComPtrI14ICompressCoderED2Ev.exit:         ; preds = %_ZN9CMyComPtrI15ICompressCoder2ED2Ev.exit, %if.then.i833
  ...
  %cond574 = icmp eq i32 %cleanup.dest.slot.31147, 0
  br i1 %cond574, label %for.cond78, label %cleanup543

ehcleanup150:                                     ; preds = %lpad102.body, %if.then.i770, %lpad90
  %eh.lpad-body813.pn = phi { ptr, i32 } [ %125, %lpad90 ], [ %lpad.thr_comm.split-lp, %lpad102.body ], [ %eh.lpad-body8131097, %if.then.i770 ]
...
for.end163:                                       ; preds = %for.cond78, %for.cond78.preheader
  %retval.1.lcssa = phi i32 [ 0, %for.cond78.preheader ], [ %retval.41148, %for.cond78 ]
...
for.cond179.preheader:                            ; preds = %if.end172
  %cmp1801228 = icmp sgt i32 %11, 0
  br i1 %cmp1801228, label %for.body181.lr.ph, label %for.end479
...
for.body181.lr.ph:                                ; preds = %for.cond179.preheader
  ...
  %wide.trip.count1306 = zext i32 %11 to i64
  br label %for.body181

for.cond179:                                      ; preds = %cleanup471
  %exitcond1307.not = icmp eq i64 %indvars.iv.next1302, %wide.trip.count1306
  br i1 %exitcond1307.not, label %for.end479, label %for.body181, !llvm.loop !79

for.body181:                                      ; preds = %for.body181.lr.ph, %for.cond179
  %indvars.iv1301 = phi i64 [ 0, %for.body181.lr.ph ], [ %indvars.iv.next1302, %for.cond179 ]
  %retval.71239 = phi i32 [ %retval.6, %for.body181.lr.ph ], [ %retval.25, %for.cond179 ]
  %packStreamIndex.01236 = phi i32 [ 0, %for.body181.lr.ph ], [ %packStreamIndex.11181, %for.cond179 ]
  %unpackStreamIndex.01235 = phi i32 [ 0, %for.body181.lr.ph ], [ %unpackStreamIndex.1.lcssa, %for.cond179 ]
  %172 = load ptr, ptr %_items.i.i858, align 8, !tbaa !47
  %arrayidx.i.i860 = getelementptr inbounds ptr, ptr %172, i64 %indvars.iv1301
  %173 = load ptr, ptr %arrayidx.i.i860, align 8, !tbaa !48
  %174 = load ptr, ptr %_items.i.i861, align 8, !tbaa !47
  %arrayidx.i.i863 = getelementptr inbounds ptr, ptr %174, i64 %indvars.iv1301
...
cleanup233:                                       ; preds = %invoke.cont217, %cleanup226.thread
  ...
  %retval.11.ph = phi i32 [ %retval.71239, %invoke.cont217 ], [ %retval.9.ph, %cleanup226.thread ]
...
cleanup.cont237:                                  ; preds = %_ZN9CMyComPtrI30ICompressSetDecoderProperties2ED2Ev.exit.thread, %_ZN9CMyComPtrI30ICompressSetDecoderProperties2ED2Ev.exit
  %retval.1111151118 = phi i32 [ %retval.71239, %_ZN9CMyComPtrI30ICompressSetDecoderProperties2ED2Ev.exit.thread ], [ %retval.11.ph, %_ZN9CMyComPtrI30ICompressSetDecoderProperties2ED2Ev.exit ]
...
cleanup268:                                       ; preds = %invoke.cont258, %if.end267
  ...
  %retval.14 = phi i32 [ %call259, %invoke.cont258 ], [ %retval.1111151118, %if.end267 ]
...
if.end274:                                        ; preds = %_ZN9CMyComPtrI19ICompressSetCoderMtED2Ev.exit, %cleanup.cont237
  %retval.15 = phi i32 [ %retval.14, %_ZN9CMyComPtrI19ICompressSetCoderMtED2Ev.exit ], [ %retval.1111151118, %cleanup.cont237 ]
...
for.cond.i.i:                                     ; preds = %for.cond.i.i, %cleanup.cont304
  %indvars.iv1295 = phi i32 [ %indvars.iv.next1296, %for.cond.i.i ], [ 0, %cleanup.cont304 ]
  ...
  %indvars.iv.next1296 = add i32 %indvars.iv1295, 1
...
invoke.cont316:                                   ; preds = %if.then3.i
  %cmp3221218 = icmp sgt i32 %214, 0
  br i1 %cmp3221218, label %for.body324.preheader, label %for.cond.cleanup323

for.body324.preheader:                            ; preds = %invoke.cont316
  %wide.trip.count1297 = zext i32 %indvars.iv1295 to i64
  %min.iters.check = icmp ult i32 %indvars.iv1295, 8
  br i1 %min.iters.check, label %for.body324.preheader1406, label %vector.ph

vector.ph:                                        ; preds = %for.body324.preheader
  %n.vec = and i64 %wide.trip.count1297, 4294967288
  %invariant.gep = getelementptr i8, ptr %call.i916918, i64 -1
  %invariant.gep1475 = getelementptr i8, ptr %call.i916918, i64 -1
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %interleaved.vec1401 = shufflevector <4 x i8> %223, <4 x i8> %229, <8 x i32> <i32 0, i32 4, i32 1, i32 5, i32 2, i32 6, i32 3, i32 7>
  store <8 x i8> %interleaved.vec1401, ptr %gep1476, align 1, !tbaa !94
  %index.next = add nuw i64 %index, 8
  %232 = icmp eq i64 %index.next, %n.vec
  br i1 %232, label %middle.block, label %vector.body, !llvm.loop !95

middle.block:                                     ; preds = %vector.body
  %cmp.n = icmp eq i64 %n.vec, %wide.trip.count1297
  br i1 %cmp.n, label %for.cond.cleanup323, label %for.body324.preheader1406

for.body324.preheader1406:                        ; preds = %for.body324.preheader, %middle.block
  %indvars.iv1290.ph = phi i64 [ 0, %for.body324.preheader ], [ %n.vec, %middle.block ]
  br label %for.body324

for.cond.cleanup323:                              ; preds = %for.body324, %middle.block, %invoke.cont311, %invoke.cont316
  %buffer.sroa.9.11314 = phi ptr [ %call.i916918, %invoke.cont316 ], [ null, %invoke.cont311 ], [ %call.i916918, %middle.block ], [ %call.i916918, %for.body324 ]
  ...
  %call358 = invoke noundef i32 %234(ptr noundef nonnull align 8 dereferenceable(8) %233, ptr noundef %buffer.sroa.9.11314, i32 noundef %mul)
...
for.body324:                                      ; preds = %for.body324.preheader1406, %for.body324
  %indvars.iv1290 = phi i64 [ %indvars.iv.next1291, %for.body324 ], [ %indvars.iv1290.ph, %for.body324.preheader1406 ]
  %arrayidx329 = getelementptr inbounds i32, ptr %218, i64 %indvars.iv1290
  %237 = load i32, ptr %arrayidx329, align 4, !tbaa !90
  %conv330 = trunc i32 %237 to i8
  %238 = shl nuw nsw i64 %indvars.iv1290, 1
  ...
  %exitcond1298.not = icmp eq i64 %indvars.iv.next1291, %wide.trip.count1297
  br i1 %exitcond1298.not, label %for.cond.cleanup323, label %for.body324, !llvm.loop !98
...
ehcleanup367:                                     ; preds = %lpad350, %lpad312
  %buffer.sroa.9.3 = phi ptr [ %buffer.sroa.9.11314, %lpad350 ], [ null, %lpad312 ]
...
cleanup383:                                       ; preds = %_ZN10CMyComBSTRD2Ev.exit, %if.end382
  ...
  %.pr1315 = load ptr, ptr %cryptoSetPassword, align 8, !tbaa !86
  %tobool.not.i944 = icmp eq ptr %.pr1315, null
...
if.then.i948:                                     ; preds = %if.then285, %cleanup383
  %retval.201321 = phi i32 [ %retval.20.ph, %cleanup383 ], [ -2147467259, %if.then285 ]
  %cond5611319 = phi i1 [ %cond561.ph, %cleanup383 ], [ false, %if.then285 ]
  %248 = phi ptr [ %.pr1315, %cleanup383 ], [ %208, %if.then285 ]
...
_ZN9CMyComPtrI18ICryptoSetPasswordED2Ev.exit:     ; preds = %cleanup383, %if.then.i948
  %retval.201322 = phi i32 [ %retval.20.ph, %cleanup383 ], [ %retval.201321, %if.then.i948 ]
  %cond5611320 = phi i1 [ %cond561.ph, %cleanup383 ], [ %cond5611319, %if.then.i948 ]
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %cryptoSetPassword) #14
  br i1 %cond5611320, label %cleanup.cont387, label %cleanup543
...
for.cond398.preheader:                            ; preds = %invoke.cont395
  %cmp3991220.not = icmp eq i32 %253, 0
  br i1 %cmp3991220.not, label %for.cond410.preheader, label %for.body400.preheader

for.body400.preheader:                            ; preds = %for.cond398.preheader
  %254 = add i32 %unpackStreamIndex.01235, %253
  br label %for.body400

for.cond410.preheader:                            ; preds = %_ZN13CRecordVectorIPKyE3AddES1_.exit, %for.cond398.preheader
  %unpackStreamIndex.1.lcssa = phi i32 [ %unpackStreamIndex.01235, %for.cond398.preheader ], [ %254, %_ZN13CRecordVectorIPKyE3AddES1_.exit ]
  %cmp4111224.not = icmp eq i32 %252, 0
  br i1 %cmp4111224.not, label %for.end448, label %for.body412.preheader

for.body412.preheader:                            ; preds = %for.cond410.preheader
  %255 = add i32 %packStreamIndex.01236, %252
  br label %for.body412

for.body400:                                      ; preds = %for.body400.preheader, %_ZN13CRecordVectorIPKyE3AddES1_.exit
  %unpackStreamIndex.11221 = phi i32 [ %inc408, %_ZN13CRecordVectorIPKyE3AddES1_.exit ], [ %unpackStreamIndex.01235, %for.body400.preheader ]
...
_ZN13CRecordVectorIPKyE3AddES1_.exit:             ; preds = %for.body400
  %idxprom.i = sext i32 %unpackStreamIndex.11221 to i64
  ...
  %inc408 = add i32 %unpackStreamIndex.11221, 1
  %exitcond1299.not = icmp eq i32 %inc408, %254
  br i1 %exitcond1299.not, label %for.cond410.preheader, label %for.body400, !llvm.loop !99
...
for.body412:                                      ; preds = %for.body412.preheader, %for.inc445
  %j397.11226 = phi i32 [ %inc446, %for.inc445 ], [ 0, %for.body412.preheader ]
  %packStreamIndex.11225 = phi i32 [ %inc447, %for.inc445 ], [ %packStreamIndex.01236, %for.body412.preheader ]
...
for.body.i973:                                    ; preds = %for.inc.i, %for.body.lr.ph.i970
  ...
  %cmp4.i = icmp eq i32 %266, %packStreamIndex.11225
...
for.body.i997:                                    ; preds = %for.inc.i1000, %for.body.lr.ph.i993
  ...
  %cmp4.i996 = icmp eq i32 %273, %packStreamIndex.11225
...
for.inc445:                                       ; preds = %cleanup436, %_ZN13CRecordVectorIPKyE3AddES1_.exit988
  ...
  %inc446 = add nuw i32 %j397.11226, 1
  %inc447 = add i32 %packStreamIndex.11225, 1
  %exitcond1300.not = icmp eq i32 %inc446, %252
  br i1 %exitcond1300.not, label %for.end448, label %for.body412, !llvm.loop !102

for.end448:                                       ; preds = %for.inc445, %for.cond410.preheader
  %packStreamIndex.1.lcssa = phi i32 [ %packStreamIndex.01236, %for.cond410.preheader ], [ %255, %for.inc445 ]
  ...
  %282 = trunc i64 %indvars.iv1301 to i32
...
cleanup471:                                       ; preds = %if.else425, %_ZNK8NArchive3N7z7CFolder24FindPackStreamArrayIndexEj.exit, %for.inc.i1000, %for.end448
  %packStreamIndex.11181 = phi i32 [ %packStreamIndex.1.lcssa, %for.end448 ], [ %packStreamIndex.11225, %for.inc.i1000 ], [ %packStreamIndex.11225, %_ZNK8NArchive3N7z7CFolder24FindPackStreamArrayIndexEj.exit ], [ %packStreamIndex.11225, %if.else425 ]
  ...
  %retval.25 = phi i32 [ %retval.201322, %for.end448 ], [ -2147467259, %for.inc.i1000 ], [ -2147467259, %_ZNK8NArchive3N7z7CFolder24FindPackStreamArrayIndexEj.exit ], [ -2147467259, %if.else425 ]
...
ehcleanup460:                                     ; preds = %lpad401.loopexit, %lpad401.loopexit.split-lp, %lpad426, %lpad413, %lpad394
  %.pn1077.pn = phi { ptr, i32 } [ %263, %lpad394 ], [ %270, %lpad413 ], [ %275, %lpad426 ], [ %lpad.loopexit1150, %lpad401.loopexit ], [ %lpad.loopexit.split-lp1151, %lpad401.loopexit.split-lp ]
  call void @_ZN17CBaseRecordVectorD2Ev(ptr noundef nonnull align 8 dereferenceable(32) %unpackSizesPointers) #14
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %unpackSizesPointers) #14
  call void @_ZN17CBaseRecordVectorD2Ev(ptr noundef nonnull align 8 dereferenceable(32) %packSizesPointers) #14
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %packSizesPointers) #14
...
for.inc.i1022:                                    ; preds = %for.body.i1019
  ...
  %exitcond1308.not = icmp eq i32 %inc.i1020, %283
  br i1 %exitcond1308.not, label %for.end.i1023, label %for.body.i1019, !llvm.loop !105
...
for.cond499.preheader:                            ; preds = %if.end492
  ...
  %cmp5021240 = icmp sgt i32 %293, 0
  br i1 %cmp5021240, label %for.body503.lr.ph, label %for.end512
...
for.body503:                                      ; preds = %for.body503.lr.ph, %_ZN13CRecordVectorIP19ISequentialInStreamE3AddES1_.exit
  %indvars.iv1309 = phi i64 [ 0, %for.body503.lr.ph ], [ %indvars.iv.next1310, %_ZN13CRecordVectorIP19ISequentialInStreamE3AddES1_.exit ]
  %294 = load ptr, ptr %_items.i.i1029, align 8, !tbaa !47
  %arrayidx.i.i1031 = getelementptr inbounds ptr, ptr %294, i64 %indvars.iv1309
...
_ZN13CRecordVectorIP19ISequentialInStreamE3AddES1_.exit: ; preds = %for.body503
  ...
  %cmp502 = icmp slt i64 %indvars.iv.next1310, %300
...
cleanup543:                                       ; preds = %_ZN9CMyComPtrI14ICompressCoderED2Ev.exit, %_ZN9CMyComPtrI30ICompressSetDecoderProperties2ED2Ev.exit, %_ZN9CMyComPtrI19ICompressSetCoderMtED2Ev.exit, %_ZN9CMyComPtrI18ICryptoSetPasswordED2Ev.exit, %cleanup471, %invoke.cont72, %if.end489, %invoke.cont523
  %retval.29 = phi i32 [ %call524, %invoke.cont523 ], [ 0, %if.end489 ], [ %call73, %invoke.cont72 ], [ %retval.201322, %_ZN9CMyComPtrI18ICryptoSetPasswordED2Ev.exit ], [ %retval.14, %_ZN9CMyComPtrI19ICompressSetCoderMtED2Ev.exit ], [ %retval.11.ph, %_ZN9CMyComPtrI30ICompressSetDecoderProperties2ED2Ev.exit ], [ %retval.25, %cleanup471 ], [ %retval.41148, %_ZN9CMyComPtrI14ICompressCoderED2Ev.exit ]
...
ehcleanup546:                                     ; preds = %lpad480, %ehcleanup528, %lpad53.loopexit, %lpad53.loopexit.split-lp, %lpad43.loopexit, %lpad43.loopexit.split-lp.loopexit.split-lp.loopexit, %lpad43.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp, %lpad43.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit, %lpad43.loopexit.split-lp.loopexit, %_ZN9CMyComPtrI14ICompressCoderED2Ev.exit851, %lpad71, %_ZN9CMyComPtrI30ICompressSetDecoderProperties2ED2Ev.exit884, %_ZN9CMyComPtrI19ICompressSetCoderMtED2Ev.exit899, %_ZN9CMyComPtrI18ICryptoSetPasswordED2Ev.exit966, %ehcleanup460, %lpad177
  %lpad.phi1161.pn = phi { ptr, i32 } [ %eh.lpad-body813.pn, %_ZN9CMyComPtrI14ICompressCoderED2Ev.exit851 ], [ %121, %lpad71 ], [ %180, %lpad177 ], [ %.pn1077.pn, %ehcleanup460 ], [ %.pn1081.pn.pn.pn, %_ZN9CMyComPtrI18ICryptoSetPasswordED2Ev.exit966 ], [ %.pn1086, %_ZN9CMyComPtrI19ICompressSetCoderMtED2Ev.exit899 ], [ %.pn1074, %_ZN9CMyComPtrI30ICompressSetDecoderProperties2ED2Ev.exit884 ], [ %lpad.loopexit1159, %lpad43.loopexit ], [ %lpad.loopexit1162, %lpad43.loopexit.split-lp.loopexit ], [ %lpad.loopexit1165, %lpad43.loopexit.split-lp.loopexit.split-lp.loopexit ], [ %lpad.loopexit1168, %lpad43.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit ], [ %lpad.loopexit.split-lp1169, %lpad43.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp ], [ %lpad.loopexit1153, %lpad53.loopexit ], [ %lpad.loopexit.split-lp1154, %lpad53.loopexit.split-lp ], [ %.pn, %ehcleanup528 ], [ %291, %lpad480 ]
...
ehcleanup552:                                     ; preds = %lpad7, %if.then.i710, %lpad12, %ehcleanup546, %lpad2
  %lpad.phi1161.pn.pn = phi { ptr, i32 } [ %lpad.phi1161.pn, %ehcleanup546 ], [ %12, %lpad2 ], [ %32, %lpad7 ], [ %33, %lpad12 ], [ %eh.lpad-body689.pn.pn, %if.then.i710 ]
...
ehcleanup554:                                     ; preds = %if.then.i.i, %lpad.i, %ehcleanup552
  %lpad.phi1161.pn.pn.pn = phi { ptr, i32 } [ %lpad.phi1161.pn.pn, %ehcleanup552 ], [ %0, %lpad.i ], [ %0, %if.then.i.i ]
  call void @llvm.lifetime.end.p0(i64 48, ptr nonnull %lockedInStream) #14
  ...
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %inStreams) #14
  resume { ptr, i32 } %lpad.phi1161.pn.pn.pn
