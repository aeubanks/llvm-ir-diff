...
while.cond.preheader:                             ; preds = %if.end
  ...
  %cond33 = icmp eq i8 %1, 0
  br i1 %cond33, label %if.else, label %land.rhs.lr.ph
...
while.body:                                       ; preds = %land.rhs
  ...
  %cond = icmp eq i8 %6, 0
  br i1 %cond, label %if.else, label %land.rhs, !llvm.loop !31
...
if.end26.i.i:                                     ; preds = %if.end13.i.i
  tail call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.97, i32 noundef %conv44.i) #18
  br label %hex.exit.i
...
if.end26.i143.i:                                  ; preds = %if.end13.i140.i
  tail call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.97, i32 noundef %conv54.i) #18
  br label %hex.exit145.i
...
while.body:                                       ; preds = %while.body.lr.ph, %cleanup119
  %char0 = phi i8 [ %0, %while.body.lr.ph ], [ %14, %cleanup119 ]
  %string.0215 = phi ptr [ %s, %while.body.lr.ph ], [ %string.7, %cleanup119 ]
  %1 = load ptr, ptr %call, align 8, !tbaa !15
  %idxprom = sext i8 %char0 to i64
  %arrayidx = getelementptr inbounds i16, ptr %1, i64 %idxprom
  %2 = load i16, ptr %arrayidx, align 2, !tbaa !21
  %3 = and i16 %2, 8192
  %tobool2.not = icmp ne i16 %3, 0
  %cmp = icmp eq i8 %char0, 59
...
while.cond16:                                     ; preds = %while.cond16.preheader, %while.cond16
  ...
  %4 = load i8, ptr %string.1, align 1, !tbaa !20
  %idxprom19 = sext i8 %4 to i64
  %arrayidx20 = getelementptr inbounds i16, ptr %1, i64 %idxprom19
  %5 = load i16, ptr %arrayidx20, align 2, !tbaa !21
  %6 = and i16 %5, 8192
  %tobool23.not = icmp eq i16 %6, 0
  %cmp25.not = icmp eq i8 %4, 0
  %or.cond190 = or i1 %cmp25.not, %tobool23.not
  br i1 %or.cond190, label %while.end, label %while.cond16, !llvm.loop !44

while.end:                                        ; preds = %while.cond16
  %incdec.ptr29 = getelementptr inbounds i8, ptr %data.0.pn, i64 2
  %cmp31 = icmp eq i8 %char0, 0
  br i1 %cmp31, label %cleanup119, label %if.end34, !llvm.loop !43

if.end34:                                         ; preds = %while.end
  %cmp36 = icmp eq i8 %4, 34
...
while.cond88.preheader:                           ; preds = %if.else82
  %7 = load i8, ptr %incdec.ptr29, align 1, !tbaa !20
  %cmp90.not210 = icmp eq i8 %7, 0
...
land.rhs92:                                       ; preds = %while.cond88.preheader, %while.body101
  %8 = phi i8 [ %11, %while.body101 ], [ %7, %while.cond88.preheader ]
  %string.4211 = phi ptr [ %incdec.ptr102, %while.body101 ], [ %incdec.ptr29, %while.cond88.preheader ]
  %idxprom95 = sext i8 %8 to i64
  %arrayidx96 = getelementptr inbounds i16, ptr %1, i64 %idxprom95
  %9 = load i16, ptr %arrayidx96, align 2, !tbaa !21
  %10 = and i16 %9, 8192
  %tobool99.not = icmp eq i16 %10, 0
...
while.body101:                                    ; preds = %land.rhs92
  ...
  %11 = load i8, ptr %incdec.ptr102, align 1, !tbaa !20
  %cmp90.not = icmp eq i8 %11, 0
...
while.end103:                                     ; preds = %land.rhs92, %while.body101, %while.cond88.preheader
  ...
  %12 = ptrtoint ptr %string.4.lcssa to i64
  %13 = ptrtoint ptr %string.0215 to i64
  %sub = sub i64 %12, %13
...
cleanup119:                                       ; preds = %while.end103, %if.end115.thread231, %if.then59, %if.then117, %while.end, %if.then
  %string.7 = phi ptr [ %incdec.ptr, %if.then ], [ %incdec.ptr29, %while.end ], [ %string.6230, %if.then117 ], [ %string.2, %if.then59 ], [ %string.2, %if.end115.thread231 ], [ %string.4.lcssa, %while.end103 ]
  %14 = load i8, ptr %string.7, align 1
...
if.end:                                           ; preds = %if.then, %while.end
  ...
  %call5160 = tail call ptr @cli_strtok(ptr noundef nonnull %enctype.addr.1, i32 noundef 0, ptr noundef nonnull @.str.28) #18
  %cmp6.not161 = icmp eq ptr %call5160, null
  br i1 %cmp6.not161, label %while.end98, label %for.cond.preheader.lr.ph
...
for.cond.preheader:                               ; preds = %for.cond.preheader.lr.ph, %if.end97
  %call5163 = phi ptr [ %call5160, %for.cond.preheader.lr.ph ], [ %call5, %if.end97 ]
  %inc162 = phi i32 [ 1, %for.cond.preheader.lr.ph ], [ %inc, %if.end97 ]
  br label %for.body

for.body:                                         ; preds = %for.cond.preheader, %for.inc85
  %4 = phi ptr [ @.str.58, %for.cond.preheader ], [ %17, %for.inc85 ]
  %e.0157 = phi ptr [ @encoding_map, %for.cond.preheader ], [ %incdec.ptr86, %for.inc85 ]
  %highestSimil.0156 = phi i32 [ 0, %for.cond.preheader ], [ %highestSimil.2, %for.inc85 ]
  %closest.0155 = phi ptr [ null, %for.cond.preheader ], [ %closest.2, %for.inc85 ]
  %5 = load ptr, ptr %call10, align 8, !tbaa !15
  %6 = load i8, ptr %call5163, align 1, !tbaa !20
...
if.end37:                                         ; preds = %if.end31
  %call39 = tail call fastcc i32 @simil(ptr noundef nonnull %call5163, ptr noundef nonnull %4)
...
for.cond43.preheader:                             ; preds = %if.end37
  ...
  %cmp44158 = icmp sgt i32 %10, 0
  %11 = load ptr, ptr %encodingTypes, align 8, !tbaa !19
  br i1 %cmp44158, label %for.body46.lr.ph, label %if.end59

for.body46.lr.ph:                                 ; preds = %for.cond43.preheader
  %type49 = getelementptr inbounds %struct.encoding_map, ptr %e.0157, i64 0, i32 1
...
if.then58:                                        ; preds = %for.body46
  tail call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.30, ptr noundef nonnull %call5163) #18
  br label %if.end97
...
if.end67:                                         ; preds = %if.end59
  ...
  %type69 = getelementptr inbounds %struct.encoding_map, ptr %e.0157, i64 0, i32 1
  ...
  tail call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.31, i32 noundef %16, ptr noundef nonnull %call5163) #18
  br label %if.end97

if.else:                                          ; preds = %if.end37
  %cmp77 = icmp sgt i32 %call39, %highestSimil.0156
  %spec.select = select i1 %cmp77, ptr %4, ptr %closest.0155
  %spec.select139 = tail call i32 @llvm.smax.i32(i32 %call39, i32 %highestSimil.0156)
  br label %for.inc85

for.inc85:                                        ; preds = %if.else, %for.body, %if.end31
  %closest.2 = phi ptr [ %spec.select, %if.else ], [ %closest.0155, %for.body ], [ %closest.0155, %if.end31 ]
  %highestSimil.2 = phi i32 [ %spec.select139, %if.else ], [ %highestSimil.0156, %for.body ], [ %highestSimil.0156, %if.end31 ]
  %incdec.ptr86 = getelementptr inbounds %struct.encoding_map, ptr %e.0157, i64 1
...
if.then91:                                        ; preds = %for.inc85
  %cmp92 = icmp sgt i32 %highestSimil.2, 49
  br i1 %cmp92, label %if.then94, label %if.else95

if.then94:                                        ; preds = %if.then91
  tail call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.32, ptr noundef nonnull %call5163, ptr noundef %closest.2, i32 noundef %highestSimil.2) #18
  tail call void @messageSetEncoding(ptr noundef %m, ptr noundef %closest.2)
  br label %if.end97

if.else95:                                        ; preds = %if.then91
  tail call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.33, ptr noundef nonnull %call5163) #18
...
if.end97:                                         ; preds = %if.then58, %if.end67, %if.end59, %if.then94, %if.else95
  tail call void @free(ptr noundef %call5163) #18
  %inc = add nuw nsw i32 %inc162, 1
  %call5 = tail call ptr @cli_strtok(ptr noundef nonnull %enctype.addr.1, i32 noundef %inc162, ptr noundef nonnull @.str.28) #18
...
if.end31.i:                                       ; preds = %if.then26.i
  ...
  %cmp3287.i = icmp ugt i64 %call22.i, 1
  br i1 %cmp3287.i, label %for.body.i, label %cleanup103.i

for.body.i:                                       ; preds = %if.end31.i, %for.inc.i
  %bytenumber.090.i = phi i32 [ %bytenumber.2.ph.i, %for.inc.i ], [ 0, %if.end31.i ]
  %newlen.089.i = phi i64 [ %newlen.2.ph.i, %for.inc.i ], [ 0, %if.end31.i ]
  %l.088.i = phi i64 [ %inc102.i, %for.inc.i ], [ 1, %if.end31.i ]
  %arrayidx34.i = getelementptr inbounds i8, ptr %call27.i, i64 %l.088.i
...
if.end63.i:                                       ; preds = %lor.lhs.false55.i
  switch i32 %bytenumber.090.i, label %for.inc.i [
    i32 0, label %sw.bb.i
...
sw.bb.i:                                          ; preds = %if.end63.i
  %shl.i = shl i8 %10, 2
  %arrayidx68.i = getelementptr inbounds i8, ptr %call18.i, i64 %newlen.089.i
...
sw.bb69.i:                                        ; preds = %if.end63.i
  ...
  %inc.i = add i64 %newlen.089.i, 1
  %arrayidx72.i = getelementptr inbounds i8, ptr %call18.i, i64 %newlen.089.i
...
sw.bb80.i:                                        ; preds = %if.end63.i
  ...
  %inc84.i = add i64 %newlen.089.i, 1
  %arrayidx85.i = getelementptr inbounds i8, ptr %call18.i, i64 %newlen.089.i
...
sw.bb94.i:                                        ; preds = %if.end63.i
  ...
  %inc97.i = add i64 %newlen.089.i, 1
  %arrayidx98.i = getelementptr inbounds i8, ptr %call18.i, i64 %newlen.089.i
...
for.inc.i:                                        ; preds = %sw.bb94.i, %sw.bb80.i, %sw.bb69.i, %sw.bb.i, %if.end63.i, %for.body.i, %for.body.i
  %newlen.2.ph.i = phi i64 [ %newlen.089.i, %sw.bb.i ], [ %inc.i, %sw.bb69.i ], [ %inc84.i, %sw.bb80.i ], [ %inc97.i, %sw.bb94.i ], [ %newlen.089.i, %if.end63.i ], [ %newlen.089.i, %for.body.i ], [ %newlen.089.i, %for.body.i ]
  %bytenumber.2.ph.i = phi i32 [ 1, %sw.bb.i ], [ 2, %sw.bb69.i ], [ 3, %sw.bb80.i ], [ 0, %sw.bb94.i ], [ %bytenumber.090.i, %if.end63.i ], [ %bytenumber.090.i, %for.body.i ], [ %bytenumber.090.i, %for.body.i ]
  %inc102.i = add nuw i64 %l.088.i, 1
...
cleanup103.i:                                     ; preds = %for.inc.i, %for.body.i, %if.then60.i, %if.end31.i
  %newlen.083.i = phi i64 [ %newlen.089.i, %if.then60.i ], [ 0, %if.end31.i ], [ %newlen.2.ph.i, %for.inc.i ], [ %newlen.089.i, %for.body.i ]
  tail call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.75, i64 noundef %newlen.083.i) #18
...
if.end106.i:                                      ; preds = %if.else.i, %cleanup103.i
  %newlen.5.i = phi i64 [ %newlen.083.i, %cleanup103.i ], [ %call22.i, %if.else.i ]
...
for.cond114.preheader.i:                          ; preds = %if.then108.i
  %cmp11593.not.i = icmp eq i64 %newlen.5.i, 0
  br i1 %cmp11593.not.i, label %cleanup152.i, label %for.body117.lr.ph.i
...
for.body117.i:                                    ; preds = %if.end146.i, %for.body117.lr.ph.i
  %l.194.i = phi i64 [ 0, %for.body117.lr.ph.i ], [ %inc148.i, %if.end146.i ]
  call void @llvm.lifetime.start.p0(i64 1, ptr nonnull %c118.i) #18
  %arrayidx119.i = getelementptr inbounds i8, ptr %call18.i, i64 %l.194.i
...
if.else136.i:                                     ; preds = %if.then128.i
  ...
  %cmp14091.not.i = icmp eq i8 %16, 1
  br i1 %cmp14091.not.i, label %if.end146.i, label %while.body142.preheader.i
...
while.body142.i:                                  ; preds = %while.body142.i, %while.body142.preheader.i
  %count.092.i = phi i32 [ %dec.i, %while.body142.i ], [ %conv131.i, %while.body142.preheader.i ]
  %dec.i = add nsw i32 %count.092.i, -1
  %call143.i = call i32 @blobAddData(ptr noundef nonnull %call109.i, ptr noundef nonnull %c118.i, i64 noundef 1) #18
  %cmp140.i = icmp ugt i32 %count.092.i, 2
...
if.end146.i:                                      ; preds = %while.body142.i, %if.else136.i, %if.then134.i, %land.lhs.true123.i, %for.body117.i
  %l.2.i = phi i64 [ %l.194.i, %land.lhs.true123.i ], [ %l.194.i, %for.body117.i ], [ %add129.i, %if.then134.i ], [ %add129.i, %if.else136.i ], [ %add129.i, %while.body142.i ]
...
if.end343.i:                                      ; preds = %if.then341.i, %land.lhs.true338.i
  ...
  %cmp34699.i = icmp sgt i32 %35, 0
  br i1 %cmp34699.i, label %for.body348.lr.ph.i, label %messageExport.119.exit
...
for.body348.i:                                    ; preds = %for.inc541.i, %for.body348.lr.ph.i
  ...
  %ret.0104.i = phi ptr [ %call1.i, %for.body348.lr.ph.i ], [ %ret.2129.i, %for.inc541.i ]
...
if.end363.i:                                      ; preds = %if.then354.i
  call void @fileblobDestroy(ptr noundef %ret.0104.i) #18
...
land.lhs.true369.i:                               ; preds = %if.end363.i, %if.end363.thread.i
  %ret.2127.i = phi ptr [ %ret.0104.i, %if.end363.thread.i ], [ %call355.i, %if.end363.i ]
...
land.lhs.true389.i:                               ; preds = %if.then379.i
  ...
  call void @fileblobSetFilename(ptr noundef %ret.2127.i, ptr noundef %dir, ptr noundef nonnull %spec.select556.i) #18
...
if.end398.critedge.i:                             ; preds = %if.then379.i, %if.then372.i
  call void @fileblobSetFilename(ptr noundef %ret.2127.i, ptr noundef %dir, ptr noundef nonnull @.str.87) #18
  br label %if.end427.thread.i
...
if.else400.i:                                     ; preds = %land.lhs.true369.i, %if.end363.i
  %ret.2128.i = phi ptr [ %ret.2127.i, %land.lhs.true369.i ], [ %call355.i, %if.end363.i ]
...
messageGetFilename.exit.i:                        ; preds = %if.end407.i
  ...
  br i1 %cmp409.i, label %if.end427.thread44.i, label %if.else412.i

if.else412.i:                                     ; preds = %messageGetFilename.exit.i, %if.end407.i
  %retval.0.i33.i = phi ptr [ %call1.i.i, %messageGetFilename.exit.i ], [ %call.i.i, %if.end407.i ]
...
if.end427.thread44.i:                             ; preds = %messageGetFilename.exit.i
  ...
  call void @fileblobSetFilename(ptr noundef %ret.2128.i, ptr noundef %dir, ptr noundef nonnull @.str.87) #18
  %44 = load ptr, ptr %body_first.i.i, align 8, !tbaa !18
  br label %if.end430.i

if.then429.i:                                     ; preds = %if.then415.i, %if.else412.i
  %45 = load i8, ptr %retval.0.i33.i, align 1, !tbaa !20
  %tobool421.not.i = icmp eq i8 %45, 0
  %spec.select557.i = select i1 %tobool421.not.i, ptr @.str.87, ptr %retval.0.i33.i
  call void @fileblobSetFilename(ptr noundef %ret.2128.i, ptr noundef %dir, ptr noundef nonnull %spec.select557.i) #18
  %46 = load ptr, ptr %body_first.i.i, align 8, !tbaa !18
  call void @free(ptr noundef nonnull %retval.0.i33.i) #18
  br label %if.end430.i

if.end430.i:                                      ; preds = %if.then429.i, %if.end427.thread44.i, %if.end427.thread.i
  %ret.2129.i = phi ptr [ %ret.2127.i, %if.end427.thread.i ], [ %ret.2128.i, %if.then429.i ], [ %ret.2128.i, %if.end427.thread44.i ]
  %t_line.143.i = phi ptr [ %42, %if.end427.thread.i ], [ %46, %if.then429.i ], [ %44, %if.end427.thread44.i ]
  %enctype.142.i = phi i32 [ 6, %if.end427.thread.i ], [ %enctype.0.i, %if.then429.i ], [ %enctype.0.i, %if.end427.thread44.i ]
  %enctype.142.fr.i = freeze i32 %enctype.142.i
  %cmp431.i = icmp eq ptr %t_line.143.i, null
...
if.then433.i:                                     ; preds = %if.end430.i
  ...
  call void @fileblobDestroy(ptr noundef %ret.2129.i) #18
  br label %messageExport.119.exit

if.end434.i:                                      ; preds = %if.end430.i
  switch i32 %enctype.142.fr.i, label %do.body.i [
...
do.body.us.i:                                     ; preds = %if.end434.i, %do.cond.us.i
  ...
  %t_line.2.us.i = phi ptr [ %56, %do.cond.us.i ], [ %t_line.143.i, %if.end434.i ]
...
if.then488.us.i:                                  ; preds = %decodeLine.exit
  ...
  call void @fileblobAddData(ptr noundef %ret.2129.i, ptr noundef %data448.0.us.i, i64 noundef %sub.ptr.sub.us.i) #18, !callees !78
...
if.end444.i:                                      ; preds = %if.then437.i
  %call445.i = call ptr @textToFileblob(ptr noundef nonnull %t_line.143.i, ptr noundef %ret.2129.i, i32 noundef 0) #18
  br label %for.inc541.i

do.body.i:                                        ; preds = %if.end434.i, %do.cond.i
  %size.0.i = phi i64 [ %size.1.i, %do.cond.i ], [ 0, %if.end434.i ]
  %t_line.2.i = phi ptr [ %63, %do.cond.i ], [ %t_line.143.i, %if.end434.i ]
  call void @llvm.lifetime.start.p0(i64 1024, ptr nonnull %smallbuf.i) #18
...
if.end476.i:                                      ; preds = %if.then473.i, %cond.end469.i, %do.body.i
  ...
  %call477.i = call ptr @decodeLine(ptr noundef %m, i32 noundef %enctype.142.fr.i, ptr noundef %call450.i, ptr noundef %data448.0.i, i64 noundef %datasize.0.i)
...
if.then488.i:                                     ; preds = %if.end485.i
  ...
  call void @fileblobAddData(ptr noundef %ret.2129.i, ptr noundef %data448.0.i, i64 noundef %sub.ptr.sub.i) #18, !callees !78
...
cleanup511.i:                                     ; preds = %if.end457.us.i, %if.then483.i, %if.then480.i
  %size.075.i = phi i64 [ %size.0.i, %if.then480.i ], [ %size.0.i, %if.then483.i ], [ %size.0.us.i, %if.end457.us.i ]
  call void @llvm.lifetime.end.p0(i64 1024, ptr nonnull %smallbuf.i) #18
  br label %do.end.i
...
do.end.i:                                         ; preds = %do.cond.us.i, %do.cond.i, %cleanup511.i
  %size.260.i = phi i64 [ %size.075.i, %cleanup511.i ], [ %size.1.i, %do.cond.i ], [ %size.2.ph.us.i, %do.cond.us.i ]
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.95, i64 noundef %size.260.i, i32 noundef %enctype.142.fr.i) #18
...
if.then529.i:                                     ; preds = %base64Flush.exit.i
  ...
  call void @fileblobAddData(ptr noundef %ret.2129.i, ptr noundef nonnull %data524.i, i64 noundef %sub.ptr.sub534.i) #18, !callees !78
...
cleanup537.i:                                     ; preds = %if.then437.i
  %call443.i = call ptr @textToFileblob(ptr noundef nonnull %t_line.143.i, ptr noundef %ret.2129.i, i32 noundef %destroy) #18
  br label %messageExport.119.exit
...
messageExport.119.exit:                           ; preds = %for.inc541.i, %entry, %if.end.i, %if.then16.i, %if.then20.i, %cleanup103.thread.i, %cleanup152.thread.i, %if.then159.i, %if.then165.i, %if.then173.i, %if.then287.i, %if.then332.i, %if.end343.i, %cleanup360.thread.i, %if.then433.i, %cleanup537.i
  %retval.10.i = phi ptr [ %call334.i, %if.then332.i ], [ null, %entry ], [ null, %if.end.i ], [ %ret.2129.i, %cleanup537.i ], [ null, %cleanup152.thread.i ], [ null, %cleanup103.thread.i ], [ %call1.i, %if.then287.i ], [ null, %if.then173.i ], [ null, %if.then165.i ], [ null, %if.then159.i ], [ null, %if.then20.i ], [ null, %if.then16.i ], [ %ret.0104.i, %cleanup360.thread.i ], [ null, %if.then433.i ], [ %call1.i, %if.end343.i ], [ %ret.2129.i, %for.inc541.i ]
...
if.end343.i:                                      ; preds = %if.end328.i, %if.end302.i, %if.end274.i
  ...
  %cmp34699.i = icmp sgt i32 %32, 0
  br i1 %cmp34699.i, label %for.body348.lr.ph.i, label %messageExport.118.exit
...
if.end363.i:                                      ; preds = %if.then354.i
  call void @blobDestroy(ptr noundef %ret.0104.i) #18
...
land.lhs.true389.i:                               ; preds = %if.then379.i
  ...
  %spec.select556.i = select i1 %tobool391.not.i, ptr @.str.87, ptr %call381.i
  call void @blobSetFilename(ptr noundef %ret.2127.i, ptr noundef null, ptr noundef nonnull %spec.select556.i) #18
  call void @free(ptr noundef nonnull %call381.i) #18
  br label %if.end427.thread.i

if.end398.critedge.i:                             ; preds = %if.then379.i, %if.then372.i
  call void @blobSetFilename(ptr noundef %ret.2127.i, ptr noundef null, ptr noundef nonnull @.str.87) #18
  br label %if.end427.thread.i
...
if.end427.thread44.i:                             ; preds = %messageGetFilename.exit.i
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.93) #18
  call void @messageAddArgument(ptr noundef nonnull %m, ptr noundef nonnull @.str.86)
  call void @blobSetFilename(ptr noundef %ret.2128.i, ptr noundef null, ptr noundef nonnull @.str.87) #18
  %41 = load ptr, ptr %body_first.i.i, align 8, !tbaa !18
  br label %if.end430.i

if.then429.i:                                     ; preds = %if.then415.i, %if.else412.i
  %42 = load i8, ptr %retval.0.i33.i, align 1, !tbaa !20
  %tobool421.not.i = icmp eq i8 %42, 0
  %spec.select557.i = select i1 %tobool421.not.i, ptr @.str.87, ptr %retval.0.i33.i
  call void @blobSetFilename(ptr noundef %ret.2128.i, ptr noundef null, ptr noundef nonnull %spec.select557.i) #18
...
if.end430.i:                                      ; preds = %if.then429.i, %if.end427.thread44.i, %if.end427.thread.i
  %ret.2129.i = phi ptr [ %ret.2127.i, %if.end427.thread.i ], [ %ret.2128.i, %if.then429.i ], [ %ret.2128.i, %if.end427.thread44.i ]
  %t_line.143.i = phi ptr [ %39, %if.end427.thread.i ], [ %43, %if.then429.i ], [ %41, %if.end427.thread44.i ]
  %enctype.142.i = phi i32 [ 6, %if.end427.thread.i ], [ %enctype.0.i, %if.then429.i ], [ %enctype.0.i, %if.end427.thread44.i ]
  %enctype.142.fr.i = freeze i32 %enctype.142.i
  %cmp431.i = icmp eq ptr %t_line.143.i, null
  br i1 %cmp431.i, label %if.then433.i, label %if.end434.i
...
if.then433.i:                                     ; preds = %if.end430.i
  call void (ptr, ...) @cli_warnmsg(ptr noundef nonnull @.str.94) #18
  call void @blobDestroy(ptr noundef %ret.2129.i) #18
  br label %messageExport.118.exit
...
do.body.us.i:                                     ; preds = %if.end434.i, %do.cond.us.i
  %size.0.us.i = phi i64 [ %size.2.ph.us.i, %do.cond.us.i ], [ 0, %if.end434.i ]
  %t_line.2.us.i = phi ptr [ %53, %do.cond.us.i ], [ %t_line.143.i, %if.end434.i ]
  call void @llvm.lifetime.start.p0(i64 1024, ptr nonnull %smallbuf.i) #18
...
if.then488.us.i:                                  ; preds = %decodeLine.exit
  ...
  %sub.ptr.rhs.cast.us.i = ptrtoint ptr %data448.0.us.i to i64
  %sub.ptr.sub.us.i = sub i64 %sub.ptr.lhs.cast.us.i, %sub.ptr.rhs.cast.us.i
  call void @blobAddData(ptr noundef %ret.2129.i, ptr noundef %data448.0.us.i, i64 noundef %sub.ptr.sub.us.i) #18, !callees !82
  %add492.us.i = add i64 %sub.ptr.sub.us.i, %size.0.us.i
  br label %if.end493.us.i
...
if.end444.i:                                      ; preds = %if.then437.i
  %call445.i = call ptr @textToBlob(ptr noundef nonnull %t_line.143.i, ptr noundef %ret.2129.i, i32 noundef 0) #18
  br label %for.inc541.i

do.body.i:                                        ; preds = %if.end434.i, %do.cond.i
  %size.0.i = phi i64 [ %size.1.i, %do.cond.i ], [ 0, %if.end434.i ]
  %t_line.2.i = phi ptr [ %60, %do.cond.i ], [ %t_line.143.i, %if.end434.i ]
  call void @llvm.lifetime.start.p0(i64 1024, ptr nonnull %smallbuf.i) #18
...
if.then488.i:                                     ; preds = %if.end485.i
  ...
  %sub.ptr.rhs.cast.i = ptrtoint ptr %data448.0.i to i64
  %sub.ptr.sub.i = sub i64 %sub.ptr.lhs.cast.i, %sub.ptr.rhs.cast.i
  call void @blobAddData(ptr noundef %ret.2129.i, ptr noundef %data448.0.i, i64 noundef %sub.ptr.sub.i) #18, !callees !82
  %add492.i = add i64 %sub.ptr.sub.i, %size.0.i
  br label %if.end493.i
...
if.then529.i:                                     ; preds = %base64Flush.exit.i
  %sub.ptr.lhs.cast532.i = ptrtoint ptr %call.i5.i to i64
  %sub.ptr.sub534.i = sub i64 %sub.ptr.lhs.cast532.i, %sub.ptr.rhs.cast533.i
  call void @blobAddData(ptr noundef %ret.2129.i, ptr noundef nonnull %data524.i, i64 noundef %sub.ptr.sub534.i) #18, !callees !82
  br label %if.end535.i
...
cleanup537.i:                                     ; preds = %if.then437.i
  %call443.i = call ptr @textToBlob(ptr noundef nonnull %t_line.143.i, ptr noundef %ret.2129.i, i32 noundef %destroy) #18
  br label %messageExport.118.exit
...
for.cond27.preheader:                             ; preds = %entry
  %cmp29318 = icmp sgt i32 %0, 0
  br i1 %cmp29318, label %for.body30.lr.ph, label %cleanup191
...
if.then:                                          ; preds = %entry
  ...
  %t_line.0324 = load ptr, ptr %body_first.i, align 8, !tbaa !15
  %tobool.not325 = icmp eq ptr %t_line.0324, null
  br i1 %tobool.not325, label %cleanup191, label %for.body

for.body:                                         ; preds = %if.then, %for.inc
  %t_line.0328 = phi ptr [ %t_line.0, %for.inc ], [ %t_line.0324, %if.then ]
  %first.0327 = phi ptr [ %first.1, %for.inc ], [ null, %if.then ]
  %last.0326 = phi ptr [ %call3, %for.inc ], [ null, %if.then ]
  %cmp1 = icmp eq ptr %first.0327, null
  %call3 = tail call ptr @cli_malloc(i64 noundef 16) #18
  br i1 %cmp1, label %if.end, label %if.else

if.else:                                          ; preds = %for.body
  %t_next = getelementptr inbounds %struct.text, ptr %last.0326, i64 0, i32 1
  store ptr %call3, ptr %t_next, align 8, !tbaa !59
  br label %if.end

if.end:                                           ; preds = %for.body, %if.else
  %first.1 = phi ptr [ %first.0327, %if.else ], [ %call3, %for.body ]
  %cmp6 = icmp eq ptr %call3, null
...
if.end11:                                         ; preds = %if.end
  %1 = load ptr, ptr %t_line.0328, align 8, !tbaa !61
...
for.inc:                                          ; preds = %if.end11, %if.then14
  ...
  %t_next21 = getelementptr inbounds %struct.text, ptr %t_line.0328, i64 0, i32 1
...
for.body30:                                       ; preds = %for.body30.lr.ph, %for.inc185
  ...
  %first.2320 = phi ptr [ null, %for.body30.lr.ph ], [ %first.12, %for.inc185 ]
  %last.2319 = phi ptr [ null, %for.body30.lr.ph ], [ %last.12, %for.inc185 ]
...
for.body34:                                       ; preds = %sw.bb, %for.inc59
  ...
  %first.3303 = phi ptr [ %first.4, %for.inc59 ], [ %first.2320, %sw.bb ]
  %last.3302 = phi ptr [ %call37, %for.inc59 ], [ %last.2319, %sw.bb ]
...
sw.bb62:                                          ; preds = %for.body30
  ...
  %tobool63.not = icmp eq ptr %first.2320, null
  br i1 %tobool63.not, label %cleanup191, label %if.then64

if.then64:                                        ; preds = %sw.bb62
  %t_next65 = getelementptr inbounds %struct.text, ptr %last.2319, i64 0, i32 1
  store ptr null, ptr %t_next65, align 8, !tbaa !59
  call void @textDestroy(ptr noundef nonnull %first.2320) #18
  br label %cleanup191
...
if.then70:                                        ; preds = %sw.bb67
  %tobool71.not = icmp eq ptr %first.2320, null
  br i1 %tobool71.not, label %cleanup191, label %if.then72

if.then72:                                        ; preds = %if.then70
  %t_next73 = getelementptr inbounds %struct.text, ptr %last.2319, i64 0, i32 1
...
for.body85.lr.ph:                                 ; preds = %if.end81
  ...
  br i1 %cmp88, label %for.body85.us, label %for.body85

for.body85.us:                                    ; preds = %for.body85.lr.ph, %for.inc148.us
  %t_line.2310.us = phi ptr [ %t_line.2.us, %for.inc148.us ], [ %t_line.2306, %for.body85.lr.ph ]
  %first.5309.us = phi ptr [ %first.7.us, %for.inc148.us ], [ %first.2320, %for.body85.lr.ph ]
  %last.5308.us = phi ptr [ %last.7.us, %for.inc148.us ], [ %last.2319, %for.body85.lr.ph ]
  call void @llvm.lifetime.start.p0(i64 1024, ptr nonnull %data) #18
  %8 = load ptr, ptr %t_line.2310.us, align 8, !tbaa !61
  %call87.us = call ptr @lineGetData(ptr noundef %8) #18
  %cmp90.us = icmp eq ptr %call87.us, null
  br i1 %cmp90.us, label %for.inc148.us, label %if.end93.us

if.end93.us:                                      ; preds = %for.body85.us
  %call94.us = call ptr @decodeLine(ptr noundef %m, i32 noundef 2, ptr noundef nonnull %call87.us, ptr noundef nonnull %data, i64 noundef 1024)
  %cmp95.us = icmp eq ptr %call94.us, null
  br i1 %cmp95.us, label %cleanup.thread, label %if.end97.us

if.end97.us:                                      ; preds = %if.end93.us
  %cmp98.us = icmp eq ptr %first.5309.us, null
  %call100.us = call ptr @cli_malloc(i64 noundef 16) #18
  br i1 %cmp98.us, label %if.end105.us, label %if.else101.us

if.else101.us:                                    ; preds = %if.end97.us
  %t_next103.us = getelementptr inbounds %struct.text, ptr %last.5308.us, i64 0, i32 1
  store ptr %call100.us, ptr %t_next103.us, align 8, !tbaa !59
  br label %if.end105.us

if.end105.us:                                     ; preds = %if.end97.us, %if.else101.us
  %first.6.us = phi ptr [ %first.5309.us, %if.else101.us ], [ %call100.us, %if.end97.us ]
  %cmp106.us = icmp eq ptr %call100.us, null
  br i1 %cmp106.us, label %cleanup.thread, label %if.end108.us

if.end108.us:                                     ; preds = %if.end105.us
  %9 = load i8, ptr %data, align 16
  switch i8 %9, label %if.else118.us [
    i8 10, label %if.end135.us
    i8 0, label %if.end135.us
  ]

if.else118.us:                                    ; preds = %if.end108.us
  %call122.us = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %call87.us) #20
  %call123.us = call i32 @strncmp(ptr noundef nonnull %data, ptr noundef nonnull %call87.us, i64 noundef %call122.us) #20
  %cmp124.us = icmp eq i32 %call123.us, 0
  br i1 %cmp124.us, label %if.then126.us, label %if.else130.us

if.then126.us:                                    ; preds = %if.else118.us
  %10 = load ptr, ptr %t_line.2310.us, align 8, !tbaa !61
  %call128.us = call ptr @lineLink(ptr noundef %10) #18
  br label %if.end135.us

if.else130.us:                                    ; preds = %if.else118.us
  %call132.us = call ptr @lineCreate(ptr noundef nonnull %data) #18
  br label %if.end135.us

if.end135.us:                                     ; preds = %if.end108.us, %if.end108.us, %if.else130.us, %if.then126.us
  %call132.us.sink = phi ptr [ %call132.us, %if.else130.us ], [ %call128.us, %if.then126.us ], [ null, %if.end108.us ], [ null, %if.end108.us ]
  store ptr %call132.us.sink, ptr %call100.us, align 8, !tbaa !61
  %call141.us = call ptr @strchr(ptr noundef nonnull dereferenceable(1) %call87.us, i32 noundef 61) #20
  %tobool142.not.us = icmp eq ptr %call141.us, null
  br i1 %tobool142.not.us, label %for.inc148.us, label %cleanup.thread

for.inc148.us:                                    ; preds = %for.body85.us, %if.end135.us
  %last.7.us = phi ptr [ %last.5308.us, %for.body85.us ], [ %call100.us, %if.end135.us ]
  %first.7.us = phi ptr [ %first.5309.us, %for.body85.us ], [ %first.6.us, %if.end135.us ]
  call void @llvm.lifetime.end.p0(i64 1024, ptr nonnull %data) #18
  %t_next149.us = getelementptr inbounds %struct.text, ptr %t_line.2310.us, i64 0, i32 1
  %t_line.2.us = load ptr, ptr %t_next149.us, align 8, !tbaa !15
  %tobool84.not.us = icmp eq ptr %t_line.2.us, null
  br i1 %tobool84.not.us, label %for.end150, label %for.body85.us, !llvm.loop !85

for.body85:                                       ; preds = %for.body85.lr.ph, %if.end135
  %t_line.2310 = phi ptr [ %t_line.2, %if.end135 ], [ %t_line.2306, %for.body85.lr.ph ]
  %first.5309 = phi ptr [ %first.6, %if.end135 ], [ %first.2320, %for.body85.lr.ph ]
  %last.5308 = phi ptr [ %call100, %if.end135 ], [ %last.2319, %for.body85.lr.ph ]
  call void @llvm.lifetime.start.p0(i64 1024, ptr nonnull %data) #18
  %11 = load ptr, ptr %t_line.2310, align 8, !tbaa !61
  %call87 = call ptr @lineGetData(ptr noundef %11) #18
...
if.end108:                                        ; preds = %if.end105
  %12 = load i8, ptr %data, align 16
  switch i8 %12, label %if.else118 [
    i8 10, label %if.end135
    i8 0, label %if.end135
  ]

if.else118:                                       ; preds = %if.end108
  %tobool119.not = icmp eq ptr %call87, null
  br i1 %tobool119.not, label %if.else130, label %land.lhs.true120
...
if.then126:                                       ; preds = %land.lhs.true120
  %13 = load ptr, ptr %t_line.2310, align 8, !tbaa !61
  %call128 = call ptr @lineLink(ptr noundef %13) #18
  br label %if.end135
...
cleanup.thread:                                   ; preds = %if.end105, %for.body85, %if.end93.us, %if.end105.us, %if.end135.us
  %.us-phi = phi ptr [ %call100.us, %if.end135.us ], [ null, %if.end105.us ], [ %last.5308.us, %if.end93.us ], [ null, %if.end105 ], [ %last.5308, %for.body85 ]
  %.us-phi315 = phi ptr [ %first.6.us, %if.end135.us ], [ %first.6.us, %if.end105.us ], [ %first.5309.us, %if.end93.us ], [ %first.6, %if.end105 ], [ %first.5309, %for.body85 ]
  call void @llvm.lifetime.end.p0(i64 1024, ptr nonnull %data) #18
  br label %for.end150

for.end150:                                       ; preds = %if.end135, %for.inc148.us, %if.end81, %cleanup.thread
  %last.8 = phi ptr [ %.us-phi, %cleanup.thread ], [ %last.2319, %if.end81 ], [ %last.7.us, %for.inc148.us ], [ %call100, %if.end135 ]
  %first.8 = phi ptr [ %.us-phi315, %cleanup.thread ], [ %first.2320, %if.end81 ], [ %first.7.us, %for.inc148.us ], [ %first.6, %if.end135 ]
  %14 = load i32, ptr %base64chars, align 4, !tbaa !72
...
if.then152:                                       ; preds = %for.end150
  ...
  %15 = load i8, ptr %data153, align 4
  %tobool161 = icmp ne i8 %15, 0
...
for.inc185:                                       ; preds = %for.inc59, %sw.bb, %if.end179, %for.end150
  %last.12 = phi ptr [ %last.10, %if.end179 ], [ %last.8, %for.end150 ], [ %last.2319, %sw.bb ], [ %call37, %for.inc59 ]
  %first.12 = phi ptr [ %first.10, %if.end179 ], [ %first.8, %for.end150 ], [ %first.2320, %sw.bb ], [ %first.4, %for.inc59 ]
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %16 = load i32, ptr %numberOfEncTypes, align 8, !tbaa !51
...
while.cond.preheader:                             ; preds = %sw.bb2
  %tobool5.not313 = icmp eq i64 %buflen, 0
  br i1 %tobool5.not313, label %if.then49, label %land.rhs
...
land.rhs:                                         ; preds = %while.cond.preheader, %if.end46
  %line.addr.0316 = phi ptr [ %incdec.ptr47, %if.end46 ], [ %line, %while.cond.preheader ]
  %buf.addr.1315 = phi ptr [ %buf.addr.3, %if.end46 ], [ %buf, %while.cond.preheader ]
  %buflen.addr.0314 = phi i64 [ %dec, %if.end46 ], [ %buflen, %while.cond.preheader ]
  %0 = load i8, ptr %line.addr.0316, align 1, !tbaa !20
...
if.then10:                                        ; preds = %land.rhs
  %incdec.ptr11 = getelementptr inbounds i8, ptr %line.addr.0316, i64 1
...
if.end26.i:                                       ; preds = %if.end13.i
  tail call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.97, i32 noundef %conv12) #18
  br label %hex.exit
...
hex.exit:                                         ; preds = %if.then.i, %if.then9.i, %if.then21.i, %if.end26.i
  ...
  %incdec.ptr21 = getelementptr inbounds i8, ptr %line.addr.0316, i64 2
...
if.then29:                                        ; preds = %hex.exit, %hex.exit
  %incdec.ptr30 = getelementptr inbounds i8, ptr %buf.addr.1315, i64 1
  store i8 %retval.0.i, ptr %buf.addr.1315, align 1, !tbaa !20
  br label %if.then49
...
if.end26.i265:                                    ; preds = %if.end13.i262
  tail call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.97, i32 noundef %conv22) #18
  br label %hex.exit267
...
if.end46:                                         ; preds = %land.rhs, %if.end31, %hex.exit267
  %storemerge319 = phi i8 [ %add, %hex.exit267 ], [ 61, %if.end31 ], [ %0, %land.rhs ]
  %line.addr.3 = phi ptr [ %incdec.ptr21, %hex.exit267 ], [ %line.addr.0316, %if.end31 ], [ %line.addr.0316, %land.rhs ]
  %buf.addr.3 = getelementptr inbounds i8, ptr %buf.addr.1315, i64 1
  store i8 %storemerge319, ptr %buf.addr.1315, align 1, !tbaa !20
  %incdec.ptr47 = getelementptr inbounds i8, ptr %line.addr.3, i64 1
  %dec = add i64 %buflen.addr.0314, -1
...
if.then49:                                        ; preds = %land.rhs, %if.end46, %if.then29, %while.cond.preheader
  %buf.addr.4 = phi ptr [ %incdec.ptr30, %if.then29 ], [ %buf, %while.cond.preheader ], [ %buf.addr.3, %if.end46 ], [ %buf.addr.1315, %land.rhs ]
...
if.end100:                                        ; preds = %if.end95
  ...
  %.old = and i8 %50, 63
  %cmp107.old = icmp eq i8 %.old, 32
  %or.cond318 = or i1 %cmp.not.i, %cmp107.old
  br i1 %or.cond318, label %sw.epilog, label %if.end110
...
if.end121:                                        ; preds = %if.end110
  ...
  %or.cond286 = or i1 %cmp123, %cmp126
  br i1 %or.cond286, label %if.then128, label %if.else129
...
if.then156:                                       ; preds = %while.cond150
  ...
  %54 = load i8, ptr %incdec.ptr157, align 1, !tbaa !20
  %cmp159 = icmp eq i8 %54, 0
...
if.end175:                                        ; preds = %if.else168, %if.end162
  %storemerge = phi i8 [ %56, %if.else168 ], [ %55, %if.end162 ]
...
sw.epilog:                                        ; preds = %if.then10, %if.then10, %while.cond150, %if.then156, %if.end100, %if.end144, %sw.bb136, %lor.lhs.false139, %if.end110, %if.end95, %sw.bb87, %lor.lhs.false90, %decode.116.exit, %if.then85, %if.else63, %sw.bb52, %if.then49, %if.end135, %if.then3
  %buf.addr.8 = phi ptr [ %incdec.ptr, %if.then3 ], [ %incdec.ptr50, %if.then49 ], [ %buf, %sw.bb52 ], [ %retval.1.i, %if.then85 ], [ %retval.1.i, %decode.116.exit ], [ %buf, %if.else63 ], [ %buf, %sw.bb87 ], [ %buf, %lor.lhs.false90 ], [ %buf, %if.end95 ], [ %buf, %if.end110 ], [ %buf.addr.5, %if.end135 ], [ %buf, %sw.bb136 ], [ %buf, %lor.lhs.false139 ], [ %buf, %if.end144 ], [ %buf, %if.end100 ], [ %buf.addr.6, %if.then156 ], [ %buf.addr.6, %while.cond150 ], [ %buf.addr.1315, %if.then10 ], [ %buf.addr.1315, %if.then10 ]
