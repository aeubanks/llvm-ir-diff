...
if.end68.peel:
  ...
  %11 = shl nsw i64 %idxprom, 2
  %12 = load <2 x i32>, ptr %base_index2, align 4, !tbaa !22
  store <2 x i32> %12, ptr %cindex, align 8, !tbaa !22
  %13 = load i32, ptr %arrayidx49, align 4, !tbaa !22
  store i32 %13, ptr %arrayidx44, align 8, !tbaa !22
  %14 = load <2 x i32>, ptr %base_stride3, align 4, !tbaa !22
  store <2 x i32> %14, ptr %stride, align 8, !tbaa !22
  %15 = load i32, ptr %arrayidx66, align 4, !tbaa !22
  store i32 %15, ptr %arrayidx60, align 8, !tbaa !22
  ...
  %16 = load i32, ptr %arrayidx8, align 4, !tbaa !22
  %cmp78.peel = icmp eq i32 %16, %.pre1288
...
if.end68:                                         ; preds = %if.end84, %if.end84.peel
  ...
  %17 = load ptr, ptr %arrayidx103.sink, align 8, !tbaa !24
  %arrayidx116 = getelementptr inbounds ptr, ptr %call31, i64 %indvars.iv.next.sink1309
  %call117 = call i32 @hypre_StructCoarsen(ptr noundef %17, ptr noundef nonnull %cindex, ptr noundef nonnull %stride, i32 noundef 1, ptr noundef nonnull %arrayidx116) #5
  ...
  %18 = load i32, ptr %arrayidx8, align 4, !tbaa !22
  %cmp78 = icmp eq i32 %18, %.pre1290
...
for.end:                                          ; preds = %if.end68, %if.end68.peel
  ...
  %scevgep = getelementptr i8, ptr %cindex, i64 %11
  %19 = trunc i64 %l.0.lcssa.wide to i32
  %add118 = add nuw nsw i32 %19, 1
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %20 = shl nuw nsw i64 %index, 1
  %21 = shl i64 %index, 1
  %22 = or i64 %20, 1
  %23 = or i64 %21, 5
  %gep = getelementptr [6 x i32], ptr %invariant.gep, i64 0, i64 %22
  %gep1312 = getelementptr [6 x i32], ptr %invariant.gep1311, i64 0, i64 %23
  ...
  br i1 %24, label %middle.block, label %vector.body, !llvm.loop !30
...
for.body:                                         ; preds = %for.body.preheader1310, %for.body
  ...
  %25 = shl nuw nsw i64 %indvars.iv1263, 1
  %arrayidx164 = getelementptr inbounds [6 x i32], ptr %x_num_ghost, i64 0, i64 %25
  store i32 1, ptr %arrayidx164, align 8, !tbaa !22
  %26 = or i64 %25, 1
  %arrayidx168 = getelementptr inbounds [6 x i32], ptr %x_num_ghost, i64 0, i64 %26
...
for.end171:                                       ; preds = %for.body, %middle.block, %for.end
  %27 = load ptr, ptr %call31, align 8, !tbaa !24
  %call173 = call ptr @hypre_StructVectorCreate(i32 noundef %0, ptr noundef %27) #5
  ...
  %call179 = call i32 @hypre_StructVectorInitializeShell(ptr noundef %28) #5
  %29 = load ptr, ptr %call148, align 8, !tbaa !24
  %data_size181 = getelementptr inbounds %struct.hypre_StructVector_struct, ptr %29, i64 0, i32 5
  %30 = load i32, ptr %data_size181, align 4, !tbaa !35
  %31 = load ptr, ptr %call31, align 8, !tbaa !24
  %call184 = call ptr @hypre_StructVectorCreate(i32 noundef %0, ptr noundef %31) #5
  ...
  %call191 = call i32 @hypre_StructVectorInitializeShell(ptr noundef %32) #5
  %33 = load ptr, ptr %call152, align 8, !tbaa !24
  %data_size193 = getelementptr inbounds %struct.hypre_StructVector_struct, ptr %33, i64 0, i32 5
  %34 = load i32, ptr %data_size193, align 4, !tbaa !35
  %add194 = add nsw i32 %34, %30
  %cmp1971252.not = icmp eq i32 %19, 0
...
for.body199:                                      ; preds = %for.body199.lr.ph, %for.body199
  ...
  %35 = load ptr, ptr %arrayidx201, align 8, !tbaa !24
  ...
  %36 = load ptr, ptr %arrayidx204, align 8, !tbaa !24
  %call205 = call ptr @hypre_SMGCreateInterpOp(ptr noundef %35, ptr noundef %36, i32 noundef %sub) #5
  ...
  %37 = load ptr, ptr %arrayidx207, align 8, !tbaa !24
  %data_size213 = getelementptr inbounds %struct.hypre_StructMatrix_struct, ptr %37, i64 0, i32 8
  %38 = load i32, ptr %data_size213, align 4, !tbaa !37
  %add214 = add nsw i32 %38, %data_size.01253
  %39 = getelementptr inbounds ptr, ptr %call136, i64 %indvars.iv1268
  store ptr %37, ptr %39, align 8
  %40 = load ptr, ptr %arrayidx201, align 8, !tbaa !24
  %41 = load ptr, ptr %arrayidx207, align 8, !tbaa !24
  %arrayidx234 = getelementptr inbounds ptr, ptr %call31, i64 %indvars.iv.next1269
  %42 = load ptr, ptr %arrayidx234, align 8, !tbaa !24
  %call235 = call ptr @hypre_SMGCreateRAPOp(ptr noundef nonnull %37, ptr noundef %40, ptr noundef %41, ptr noundef %42) #5
  ...
  %43 = load ptr, ptr %arrayidx238, align 8, !tbaa !24
  %data_size246 = getelementptr inbounds %struct.hypre_StructMatrix_struct, ptr %43, i64 0, i32 8
  %44 = load i32, ptr %data_size246, align 4, !tbaa !37
  %add247 = add nsw i32 %add214, %44
  %45 = load ptr, ptr %arrayidx234, align 8, !tbaa !24
  %call251 = call ptr @hypre_StructVectorCreate(i32 noundef %0, ptr noundef %45) #5
  ...
  %call263 = call i32 @hypre_StructVectorInitializeShell(ptr noundef %46) #5
  %47 = load ptr, ptr %arrayidx254, align 8, !tbaa !24
  %data_size267 = getelementptr inbounds %struct.hypre_StructVector_struct, ptr %47, i64 0, i32 5
  %48 = load i32, ptr %data_size267, align 4, !tbaa !35
  %add268 = add nsw i32 %add247, %48
  %49 = load ptr, ptr %arrayidx234, align 8, !tbaa !24
  %call272 = call ptr @hypre_StructVectorCreate(i32 noundef %0, ptr noundef %49) #5
  ...
  %call284 = call i32 @hypre_StructVectorInitializeShell(ptr noundef %50) #5
  %51 = load ptr, ptr %arrayidx275, align 8, !tbaa !24
  %data_size288 = getelementptr inbounds %struct.hypre_StructVector_struct, ptr %51, i64 0, i32 5
  %52 = load i32, ptr %data_size288, align 4, !tbaa !35
  %add289 = add nsw i32 %add268, %52
  %53 = load ptr, ptr %arrayidx234, align 8, !tbaa !24
  %call293 = call ptr @hypre_StructVectorCreate(i32 noundef %0, ptr noundef %53) #5
  ...
  %54 = load ptr, ptr %arrayidx296, align 8, !tbaa !24
  %call306 = call i32 @hypre_StructVectorInitializeShell(ptr noundef %54) #5
  %55 = load ptr, ptr %arrayidx234, align 8, !tbaa !24
  %call310 = call ptr @hypre_StructVectorCreate(i32 noundef %0, ptr noundef %55) #5
  ...
  %56 = load ptr, ptr %arrayidx313, align 8, !tbaa !24
  %call323 = call i32 @hypre_StructVectorInitializeShell(ptr noundef %56) #5
...
for.end326:                                       ; preds = %for.body199, %for.end171
  ...
  %call330 = call i32 @hypre_StructVectorInitializeData(ptr noundef %57, ptr noundef %call327) #5
  %58 = load ptr, ptr %call148, align 8, !tbaa !24
  %call332 = call i32 @hypre_StructVectorAssemble(ptr noundef %58) #5
  %59 = load ptr, ptr %call148, align 8, !tbaa !24
  %data_size334 = getelementptr inbounds %struct.hypre_StructVector_struct, ptr %59, i64 0, i32 5
  %60 = load i32, ptr %data_size334, align 4, !tbaa !35
  ...
  %call336 = call i32 @hypre_StructVectorInitializeData(ptr noundef %61, ptr noundef %add.ptr) #5
  %62 = load ptr, ptr %call152, align 8, !tbaa !24
  %call338 = call i32 @hypre_StructVectorAssemble(ptr noundef %62) #5
...
for.body347.preheader:                            ; preds = %for.end326
  ...
  %data_size340 = getelementptr inbounds %struct.hypre_StructVector_struct, ptr %63, i64 0, i32 5
  %64 = load i32, ptr %data_size340, align 4, !tbaa !35
  %idx.ext341 = sext i32 %64 to i64
...
for.body347:                                      ; preds = %for.body347.preheader, %for.body347
  ...
  %call350 = call i32 @hypre_StructMatrixInitializeData(ptr noundef %65, ptr noundef %data.01256) #5
  %66 = load ptr, ptr %arrayidx349, align 8, !tbaa !24
  %data_size353 = getelementptr inbounds %struct.hypre_StructMatrix_struct, ptr %66, i64 0, i32 8
  %67 = load i32, ptr %data_size353, align 4, !tbaa !37
  %idx.ext354 = sext i32 %67 to i64
  ...
  %call359 = call i32 @hypre_StructMatrixInitializeData(ptr noundef %68, ptr noundef %add.ptr355) #5
  %69 = load ptr, ptr %arrayidx358, align 8, !tbaa !24
  %data_size363 = getelementptr inbounds %struct.hypre_StructMatrix_struct, ptr %69, i64 0, i32 8
  %70 = load i32, ptr %data_size363, align 4, !tbaa !37
  %idx.ext364 = sext i32 %70 to i64
  ...
  %call369 = call i32 @hypre_StructVectorInitializeData(ptr noundef %71, ptr noundef %add.ptr365) #5
  %72 = load ptr, ptr %arrayidx368, align 8, !tbaa !24
  %call373 = call i32 @hypre_StructVectorAssemble(ptr noundef %72) #5
  %73 = load ptr, ptr %arrayidx368, align 8, !tbaa !24
  %data_size377 = getelementptr inbounds %struct.hypre_StructVector_struct, ptr %73, i64 0, i32 5
  %74 = load i32, ptr %data_size377, align 4, !tbaa !35
  %idx.ext378 = sext i32 %74 to i64
  ...
  %call383 = call i32 @hypre_StructVectorInitializeData(ptr noundef %75, ptr noundef %add.ptr379) #5
  %76 = load ptr, ptr %arrayidx382, align 8, !tbaa !24
  %call387 = call i32 @hypre_StructVectorAssemble(ptr noundef %76) #5
  %77 = load ptr, ptr %arrayidx382, align 8, !tbaa !24
  %data_size391 = getelementptr inbounds %struct.hypre_StructVector_struct, ptr %77, i64 0, i32 5
  %78 = load i32, ptr %data_size391, align 4, !tbaa !35
  %idx.ext392 = sext i32 %78 to i64
  ...
  %79 = load ptr, ptr %arrayidx396, align 8, !tbaa !24
  %80 = load ptr, ptr %call148, align 8, !tbaa !24
  %data398 = getelementptr inbounds %struct.hypre_StructVector_struct, ptr %80, i64 0, i32 3
  %81 = load ptr, ptr %data398, align 8, !tbaa !40
  %call399 = call i32 @hypre_StructVectorInitializeData(ptr noundef %79, ptr noundef %81) #5
  %82 = load ptr, ptr %arrayidx396, align 8, !tbaa !24
  %call403 = call i32 @hypre_StructVectorAssemble(ptr noundef %82) #5
  %arrayidx406 = getelementptr inbounds ptr, ptr %call152, i64 %indvars.iv.next1274
  %83 = load ptr, ptr %arrayidx406, align 8, !tbaa !24
  %84 = load ptr, ptr %call152, align 8, !tbaa !24
  %data408 = getelementptr inbounds %struct.hypre_StructVector_struct, ptr %84, i64 0, i32 3
  %85 = load ptr, ptr %data408, align 8, !tbaa !40
  %call409 = call i32 @hypre_StructVectorInitializeData(ptr noundef %83, ptr noundef %85) #5
  %86 = load ptr, ptr %arrayidx406, align 8, !tbaa !24
  %call413 = call i32 @hypre_StructVectorAssemble(ptr noundef %86) #5
...
for.end416:                                       ; preds = %for.body347, %for.end326
  ...
  %87 = load ptr, ptr %call140, align 8, !tbaa !24
  %data443 = getelementptr inbounds %struct.hypre_StructVector_struct, ptr %87, i64 0, i32 3
  %88 = load ptr, ptr %data443, align 8, !tbaa !40
  %data_alloced = getelementptr inbounds %struct.hypre_StructVector_struct, ptr %87, i64 0, i32 4
  %89 = load i32, ptr %data_alloced, align 8, !tbaa !51
  %90 = load ptr, ptr %call144, align 8, !tbaa !24
  %data446 = getelementptr inbounds %struct.hypre_StructVector_struct, ptr %90, i64 0, i32 3
  %91 = load ptr, ptr %data446, align 8, !tbaa !40
  %data_alloced448 = getelementptr inbounds %struct.hypre_StructVector_struct, ptr %90, i64 0, i32 4
  %92 = load i32, ptr %data_alloced448, align 8, !tbaa !51
  %93 = load ptr, ptr %call148, align 8, !tbaa !24
  %data451 = getelementptr inbounds %struct.hypre_StructVector_struct, ptr %93, i64 0, i32 3
  %94 = load ptr, ptr %data451, align 8, !tbaa !40
  %call452 = call i32 @hypre_StructVectorInitializeData(ptr noundef %87, ptr noundef %94) #5
  %95 = load ptr, ptr %call144, align 8, !tbaa !24
  %96 = load ptr, ptr %call152, align 8, !tbaa !24
  %data455 = getelementptr inbounds %struct.hypre_StructVector_struct, ptr %96, i64 0, i32 3
  %97 = load ptr, ptr %data455, align 8, !tbaa !40
  %call456 = call i32 @hypre_StructVectorInitializeData(ptr noundef %95, ptr noundef %97) #5
  %98 = load ptr, ptr %call140, align 8, !tbaa !24
  %call458 = call i32 @hypre_StructVectorAssemble(ptr noundef %98) #5
  %99 = load ptr, ptr %call144, align 8, !tbaa !24
  %call460 = call i32 @hypre_StructVectorAssemble(ptr noundef %99) #5
...
if.else534:                                       ; preds = %for.body465
  %100 = load i32, ptr %base_index2, align 4, !tbaa !22
  store i32 %100, ptr %bindex, align 8, !tbaa !22
  %101 = load i32, ptr %arrayidx47, align 4, !tbaa !22
  store i32 %101, ptr %arrayidx470, align 4, !tbaa !22
  %102 = load i32, ptr %arrayidx49, align 4, !tbaa !22
  store i32 %102, ptr %arrayidx471, align 8, !tbaa !22
  %103 = load i32, ptr %base_stride3, align 4, !tbaa !22
  store i32 %103, ptr %bstride, align 8, !tbaa !22
  %104 = load i32, ptr %arrayidx64, align 4, !tbaa !22
  store i32 %104, ptr %arrayidx484, align 4, !tbaa !22
  %105 = load i32, ptr %arrayidx66, align 4, !tbaa !22
  br label %if.end541

if.end541:                                        ; preds = %if.else534, %if.then530
  %storemerge1296 = phi i32 [ 0, %if.then530 ], [ %100, %if.else534 ]
  %storemerge1295 = phi i32 [ 0, %if.then530 ], [ %101, %if.else534 ]
  %storemerge1294 = phi i32 [ 0, %if.then530 ], [ %102, %if.else534 ]
  %storemerge1292 = phi i32 [ 1, %if.then530 ], [ %103, %if.else534 ]
  %storemerge1291 = phi i32 [ 1, %if.then530 ], [ %104, %if.else534 ]
  %storemerge = phi i32 [ 1, %if.then530 ], [ %105, %if.else534 ]
  ...
  %106 = load i32, ptr %arrayidx70, align 4, !tbaa !22
  %mul544 = shl nsw i32 %106, 1
  ...
  %107 = load ptr, ptr %arrayidx547, align 8, !tbaa !24
  %108 = load i32, ptr %memory_use, align 4, !tbaa !52
  %call555 = call i32 @hypre_SMGRelaxSetMemoryUse(ptr noundef %107, i32 noundef %108) #5
  %109 = load ptr, ptr %arrayidx547, align 8, !tbaa !24
  %call558 = call i32 @hypre_SMGRelaxSetTol(ptr noundef %109, double noundef 0.000000e+00) #5
  %110 = load ptr, ptr %arrayidx547, align 8, !tbaa !24
  %call561 = call i32 @hypre_SMGRelaxSetNumSpaces(ptr noundef %110, i32 noundef 2) #5
  %111 = load ptr, ptr %arrayidx547, align 8, !tbaa !24
  %112 = load i32, ptr %scevgep, align 4, !tbaa !22
  %113 = load i32, ptr %arrayidx70, align 4, !tbaa !22
  %call568 = call i32 @hypre_SMGRelaxSetSpace(ptr noundef %111, i32 noundef 0, i32 noundef %112, i32 noundef %113) #5
  %114 = load ptr, ptr %arrayidx547, align 8, !tbaa !24
  %115 = load i32, ptr %arrayidx526, align 4, !tbaa !22
  %116 = load i32, ptr %arrayidx70, align 4, !tbaa !22
  %call575 = call i32 @hypre_SMGRelaxSetSpace(ptr noundef %114, i32 noundef 1, i32 noundef %115, i32 noundef %116) #5
  %117 = load ptr, ptr %arrayidx547, align 8, !tbaa !24
  %arrayidx579 = getelementptr inbounds ptr, ptr %call148, i64 %indvars.iv1278
  %118 = load ptr, ptr %arrayidx579, align 8, !tbaa !24
  %call580 = call i32 @hypre_SMGRelaxSetTempVec(ptr noundef %117, ptr noundef %118) #5
  %119 = load ptr, ptr %arrayidx547, align 8, !tbaa !24
  %call583 = call i32 @hypre_SMGRelaxSetNumPreRelax(ptr noundef %119, i32 noundef %1) #5
  %120 = load ptr, ptr %arrayidx547, align 8, !tbaa !24
  %call586 = call i32 @hypre_SMGRelaxSetNumPostRelax(ptr noundef %120, i32 noundef %2) #5
  %121 = load ptr, ptr %arrayidx547, align 8, !tbaa !24
  %arrayidx590 = getelementptr inbounds ptr, ptr %call126, i64 %indvars.iv1278
  %122 = load ptr, ptr %arrayidx590, align 8, !tbaa !24
  %arrayidx592 = getelementptr inbounds ptr, ptr %call140, i64 %indvars.iv1278
  %123 = load ptr, ptr %arrayidx592, align 8, !tbaa !24
  %arrayidx594 = getelementptr inbounds ptr, ptr %call144, i64 %indvars.iv1278
  %124 = load ptr, ptr %arrayidx594, align 8, !tbaa !24
  %call595 = call i32 @hypre_SMGRelaxSetup(ptr noundef %121, ptr noundef %122, ptr noundef %123, ptr noundef %124) #5
  %125 = load ptr, ptr %arrayidx547, align 8, !tbaa !24
  %126 = load ptr, ptr %arrayidx590, align 8, !tbaa !24
  %127 = load ptr, ptr %arrayidx592, align 8, !tbaa !24
  %128 = load ptr, ptr %arrayidx594, align 8, !tbaa !24
  %arrayidx605 = getelementptr inbounds ptr, ptr %call131, i64 %indvars.iv1278
  %129 = load ptr, ptr %arrayidx605, align 8, !tbaa !24
  %call609 = call i32 @hypre_SMGSetupInterpOp(ptr noundef %125, ptr noundef %126, ptr noundef %127, ptr noundef %128, ptr noundef %129, i32 noundef %sub, ptr noundef nonnull %cindex, ptr noundef nonnull %findex, ptr noundef nonnull %stride) #5
  %130 = load ptr, ptr %arrayidx547, align 8, !tbaa !24
  %call612 = call i32 @hypre_SMGRelaxSetNumPreSpaces(ptr noundef %130, i32 noundef 0) #5
  %131 = load ptr, ptr %arrayidx547, align 8, !tbaa !24
  %call615 = call i32 @hypre_SMGRelaxSetNumRegSpaces(ptr noundef %131, i32 noundef 2) #5
  %132 = load ptr, ptr %arrayidx547, align 8, !tbaa !24
  %133 = load ptr, ptr %arrayidx590, align 8, !tbaa !24
  %134 = load ptr, ptr %arrayidx592, align 8, !tbaa !24
  %135 = load ptr, ptr %arrayidx594, align 8, !tbaa !24
  %call624 = call i32 @hypre_SMGRelaxSetup(ptr noundef %132, ptr noundef %133, ptr noundef %134, ptr noundef %135) #5
  ...
  %136 = load ptr, ptr %arrayidx627, align 8, !tbaa !24
  %137 = load ptr, ptr %arrayidx590, align 8, !tbaa !24
  %138 = load ptr, ptr %arrayidx594, align 8, !tbaa !24
  %139 = load ptr, ptr %arrayidx592, align 8, !tbaa !24
  %arrayidx642 = getelementptr inbounds ptr, ptr %call152, i64 %indvars.iv1278
  %140 = load ptr, ptr %arrayidx642, align 8, !tbaa !24
  %call643 = call i32 @hypre_SMGResidualSetup(ptr noundef %136, ptr noundef %137, ptr noundef %138, ptr noundef %139, ptr noundef %140) #5
  ...
  %141 = load ptr, ptr %arrayidx605, align 8, !tbaa !24
  ...
  %142 = load ptr, ptr %arrayidx653, align 8, !tbaa !24
  %143 = load ptr, ptr %arrayidx642, align 8, !tbaa !24
  %call659 = call i32 @hypre_SemiInterpSetup(ptr noundef %call644, ptr noundef %141, i32 noundef 1, ptr noundef %142, ptr noundef %143, ptr noundef nonnull %cindex, ptr noundef nonnull %findex, ptr noundef nonnull %stride) #5
  ...
  %144 = load ptr, ptr %arrayidx666, align 8, !tbaa !24
  %145 = load ptr, ptr %arrayidx642, align 8, !tbaa !24
  %arrayidx671 = getelementptr inbounds ptr, ptr %call140, i64 %indvars.iv.next1279
  %146 = load ptr, ptr %arrayidx671, align 8, !tbaa !24
  %call675 = call i32 @hypre_SemiRestrictSetup(ptr noundef %call660, ptr noundef %144, i32 noundef 0, ptr noundef %145, ptr noundef %146, ptr noundef nonnull %cindex, ptr noundef nonnull %findex, ptr noundef nonnull %stride) #5
  %147 = load ptr, ptr %arrayidx666, align 8, !tbaa !24
  %148 = load ptr, ptr %arrayidx590, align 8, !tbaa !24
  %149 = load ptr, ptr %arrayidx605, align 8, !tbaa !24
  %arrayidx684 = getelementptr inbounds ptr, ptr %call126, i64 %indvars.iv.next1279
  %150 = load ptr, ptr %arrayidx684, align 8, !tbaa !24
  %call687 = call i32 @hypre_SMGSetupRAPOp(ptr noundef %147, ptr noundef %148, ptr noundef %149, ptr noundef %150, ptr noundef nonnull %cindex, ptr noundef nonnull %stride) #5
...
if.else711:                                       ; preds = %for.end416
  %151 = load <2 x i32>, ptr %base_index2, align 4, !tbaa !22
  %152 = load i32, ptr %arrayidx49, align 4, !tbaa !22
  %153 = load <2 x i32>, ptr %base_stride3, align 4, !tbaa !22
  %154 = load i32, ptr %arrayidx66, align 4, !tbaa !22
  br label %if.end718

if.end718:                                        ; preds = %if.end541, %if.else711
  %l.3.lcssa1303 = phi i64 [ 0, %if.else711 ], [ %l.0.lcssa.wide, %if.end541 ]
  %.sink1285 = phi i32 [ %152, %if.else711 ], [ 0, %if.end541 ]
  %.sink = phi i32 [ %154, %if.else711 ], [ 1, %if.end541 ]
  %155 = phi <2 x i32> [ %151, %if.else711 ], [ zeroinitializer, %if.end541 ]
  %156 = phi <2 x i32> [ %153, %if.else711 ], [ <i32 1, i32 1>, %if.end541 ]
  store <2 x i32> %155, ptr %bindex, align 8
  %157 = getelementptr inbounds [3 x i32], ptr %bindex, i64 0, i64 2
  store i32 %.sink1285, ptr %157, align 8
  store <2 x i32> %156, ptr %bstride, align 8
  %158 = getelementptr inbounds [3 x i32], ptr %bstride, i64 0, i64 2
  ...
  %call729 = call i32 @hypre_SMGRelaxSetTol(ptr noundef %159, double noundef 0.000000e+00) #5
  %160 = load ptr, ptr %arrayidx721, align 8, !tbaa !24
  %call732 = call i32 @hypre_SMGRelaxSetMaxIter(ptr noundef %160, i32 noundef 1) #5
  %161 = load ptr, ptr %arrayidx721, align 8, !tbaa !24
  %arrayidx736 = getelementptr inbounds ptr, ptr %call148, i64 %idxprom720
  %162 = load ptr, ptr %arrayidx736, align 8, !tbaa !24
  %call737 = call i32 @hypre_SMGRelaxSetTempVec(ptr noundef %161, ptr noundef %162) #5
  %163 = load ptr, ptr %arrayidx721, align 8, !tbaa !24
  %call740 = call i32 @hypre_SMGRelaxSetNumPreRelax(ptr noundef %163, i32 noundef %1) #5
  %164 = load ptr, ptr %arrayidx721, align 8, !tbaa !24
  %call743 = call i32 @hypre_SMGRelaxSetNumPostRelax(ptr noundef %164, i32 noundef %2) #5
  %165 = load ptr, ptr %arrayidx721, align 8, !tbaa !24
  %arrayidx747 = getelementptr inbounds ptr, ptr %call126, i64 %idxprom720
  %166 = load ptr, ptr %arrayidx747, align 8, !tbaa !24
  %arrayidx749 = getelementptr inbounds ptr, ptr %call140, i64 %idxprom720
  %167 = load ptr, ptr %arrayidx749, align 8, !tbaa !24
  %arrayidx751 = getelementptr inbounds ptr, ptr %call144, i64 %idxprom720
  %168 = load ptr, ptr %arrayidx751, align 8, !tbaa !24
  %call752 = call i32 @hypre_SMGRelaxSetup(ptr noundef %165, ptr noundef %166, ptr noundef %167, ptr noundef %168) #5
...
if.then755:                                       ; preds = %if.end718
  ...
  %169 = load ptr, ptr %arrayidx758, align 8, !tbaa !24
  %170 = load ptr, ptr %arrayidx747, align 8, !tbaa !24
  %171 = load ptr, ptr %arrayidx751, align 8, !tbaa !24
  %172 = load ptr, ptr %arrayidx749, align 8, !tbaa !24
  %arrayidx773 = getelementptr inbounds ptr, ptr %call152, i64 %idxprom720
  %173 = load ptr, ptr %arrayidx773, align 8, !tbaa !24
  %call774 = call i32 @hypre_SMGResidualSetup(ptr noundef %169, ptr noundef %170, ptr noundef %171, ptr noundef %172, ptr noundef %173) #5
  br label %if.end775

if.end775:                                        ; preds = %if.then755, %if.end718
  %174 = load ptr, ptr %call140, align 8, !tbaa !24
  %call777 = call i32 @hypre_StructVectorInitializeData(ptr noundef %174, ptr noundef %88) #5
  %175 = load ptr, ptr %call140, align 8, !tbaa !24
  %data_alloced779 = getelementptr inbounds %struct.hypre_StructVector_struct, ptr %175, i64 0, i32 4
  store i32 %89, ptr %data_alloced779, align 8, !tbaa !51
  %176 = load ptr, ptr %call144, align 8, !tbaa !24
  %call781 = call i32 @hypre_StructVectorInitializeData(ptr noundef %176, ptr noundef %91) #5
  %177 = load ptr, ptr %call144, align 8, !tbaa !24
  %data_alloced783 = getelementptr inbounds %struct.hypre_StructVector_struct, ptr %177, i64 0, i32 4
  store i32 %92, ptr %data_alloced783, align 8, !tbaa !51
  %178 = load ptr, ptr %call140, align 8, !tbaa !24
  %call785 = call i32 @hypre_StructVectorAssemble(ptr noundef %178) #5
  %179 = load ptr, ptr %call144, align 8, !tbaa !24
  %call787 = call i32 @hypre_StructVectorAssemble(ptr noundef %179) #5
  ...
  %180 = load i32, ptr %logging, align 8, !tbaa !58
  %cmp792 = icmp sgt i32 %180, 0
...
if.then794:                                       ; preds = %if.end775
  ...
  %181 = load i32, ptr %max_iter795, align 8, !tbaa !59
  %mul797 = shl i32 %181, 3
