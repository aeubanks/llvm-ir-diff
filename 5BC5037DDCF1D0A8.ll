...
entry:
  %cmp2 = icmp sgt i32 %numflags, 0
  br i1 %cmp2, label %while.body, label %while.end

while.body:                                       ; preds = %entry, %entdump.exit
  %numflags.addr.04 = phi i32 [ %dec, %entdump.exit ], [ %numflags, %entry ]
  %flagp.addr.03 = phi ptr [ %incdec.ptr, %entdump.exit ], [ %flagp, %entry ]
  %dec = add nsw i32 %numflags.addr.04, -1
  %incdec.ptr = getelementptr inbounds %struct.flagent, ptr %flagp.addr.03, i64 1
  %flagflags.i = getelementptr inbounds %struct.flagent, ptr %flagp.addr.03, i64 0, i32 6
  %0 = load i16, ptr %flagflags.i, align 8, !tbaa !11
  %1 = and i16 %0, 1
  %tobool.not.i = icmp eq i16 %1, 0
  %cond1.i = select i1 %tobool.not.i, ptr @.str.7, ptr @.str.6
  %flagbit.i = getelementptr inbounds %struct.flagent, ptr %flagp.addr.03, i64 0, i32 2
  ...
  %numconds.i = getelementptr inbounds %struct.flagent, ptr %flagp.addr.03, i64 0, i32 5
...
for.body.lr.ph.i:                                 ; preds = %while.body
  %conds.i = getelementptr inbounds %struct.flagent, ptr %flagp.addr.03, i64 0, i32 7
  br label %for.body.i
...
for.body.i.i:                                     ; preds = %for.body.i.i, %for.body.i
  %indvars.iv.i.i = phi i64 [ 128, %for.body.i ], [ %indvars.iv.next.i.i.1, %for.body.i.i ]
  %numnz.079.i.i = phi i32 [ 0, %for.body.i ], [ %spec.select30.i.i.1, %for.body.i.i ]
  %firstnz.078.i.i = phi i32 [ 0, %for.body.i ], [ %spec.select.i.i.1, %for.body.i.i ]
  %indvars.iv.next.i.i = add nsw i64 %indvars.iv.i.i, -1
  %arrayidx.i.i = getelementptr inbounds i8, ptr %conds.i, i64 %indvars.iv.next.i.i
  ...
  %spec.select.i.i = select i1 %tobool.not.i.i, i32 %5, i32 %firstnz.078.i.i
  %inc.i.i = zext i1 %tobool.not.i.i to i32
  %spec.select30.i.i = add nuw nsw i32 %numnz.079.i.i, %inc.i.i
  %indvars.iv.next.i.i.1 = add nsw i64 %indvars.iv.i.i, -2
  %arrayidx.i.i.1 = getelementptr inbounds i8, ptr %conds.i, i64 %indvars.iv.next.i.i.1
  ...
  %7 = trunc i64 %indvars.iv.next.i.i.1 to i32
  %spec.select.i.i.1 = select i1 %tobool.not.i.i.1, i32 %7, i32 %spec.select.i.i
  %inc.i.i.1 = zext i1 %tobool.not.i.i.1 to i32
  %spec.select30.i.i.1 = add nuw nsw i32 %spec.select30.i.i, %inc.i.i.1
  %cmp.i.i.1.not = icmp eq i64 %indvars.iv.next.i.i, 1
  br i1 %cmp.i.i.1.not, label %for.end.i.i, label %for.body.i.i, !llvm.loop !17

for.end.i.i:                                      ; preds = %for.body.i.i
  switch i32 %spec.select30.i.i.1, label %if.else8.i.i [
...
if.else8.i.i:                                     ; preds = %for.end.i.i
  %cmp9.i.i = icmp ugt i32 %spec.select30.i.i.1, 64
...
for.body.i36.i.i:                                 ; preds = %for.inc27.i75.i.i, %if.else14.i.i
  %cnum.059.i31.i.i = phi i32 [ 0, %if.else14.i.i ], [ %inc29.i73.i.i, %for.inc27.i75.i.i ]
  %setp.addr.058.i32.i.i = phi ptr [ %conds.i, %if.else14.i.i ], [ %incdec.ptr28.i72.i.i, %for.inc27.i75.i.i ]
  %15 = load i8, ptr %setp.addr.058.i32.i.i, align 1, !tbaa !16
  %16 = xor i8 %15, -1
  %17 = sext i8 %16 to i32
  %and.i34.i.i = and i32 %shl.i, %17
  %cmp1.i35.i.i = icmp eq i32 %and.i34.i.i, 0
  br i1 %cmp1.i35.i.i, label %for.body6.preheader.i39.i.i, label %for.inc27.i75.i.i

for.body6.preheader.i39.i.i:                      ; preds = %for.body.i36.i.i
  %scevgep.i37.i.i = getelementptr i8, ptr %setp.addr.058.i32.i.i, i64 1
  %18 = sub i32 127, %cnum.059.i31.i.i
  %19 = zext i32 %18 to i64
  %scevgep60.i38.i.i = getelementptr i8, ptr %scevgep.i37.i.i, i64 %19
  br label %for.body6.i45.i.i

for.body6.i45.i.i:                                ; preds = %for.inc.i49.i.i, %for.body6.preheader.i39.i.i
  %cnum.152.i40.i.i = phi i32 [ %inc.i47.i.i, %for.inc.i49.i.i ], [ %cnum.059.i31.i.i, %for.body6.preheader.i39.i.i ]
  %setp.addr.151.i41.i.i = phi ptr [ %incdec.ptr.i46.i.i, %for.inc.i49.i.i ], [ %setp.addr.058.i32.i.i, %for.body6.preheader.i39.i.i ]
  %20 = load i8, ptr %setp.addr.151.i41.i.i, align 1, !tbaa !16
  %21 = xor i8 %20, -1
  %22 = sext i8 %21 to i32
  %and9.i43.i.i = and i32 %shl.i, %22
  %tobool.not.i44.i.i = icmp eq i32 %and9.i43.i.i, 0
  br i1 %tobool.not.i44.i.i, label %for.inc.i49.i.i, label %for.end.i54.i.i

for.inc.i49.i.i:                                  ; preds = %for.body6.i45.i.i
  %incdec.ptr.i46.i.i = getelementptr inbounds i8, ptr %setp.addr.151.i41.i.i, i64 1
  %inc.i47.i.i = add i32 %cnum.152.i40.i.i, 1
  %exitcond.not.i48.i.i = icmp eq i32 %inc.i47.i.i, 128
  br i1 %exitcond.not.i48.i.i, label %for.end.i54.i.i, label %for.body6.i45.i.i, !llvm.loop !19

for.end.i54.i.i:                                  ; preds = %for.inc.i49.i.i, %for.body6.i45.i.i
  %setp.addr.1.lcssa.ph.i50.i.i = phi ptr [ %scevgep60.i38.i.i, %for.inc.i49.i.i ], [ %setp.addr.151.i41.i.i, %for.body6.i45.i.i ]
  %cnum.1.lcssa.ph.i51.i.i = phi i32 [ 128, %for.inc.i49.i.i ], [ %cnum.152.i40.i.i, %for.body6.i45.i.i ]
  %add.i52.i.i = add nsw i32 %cnum.059.i31.i.i, 1
  %cmp11.i53.i.i = icmp eq i32 %cnum.1.lcssa.ph.i51.i.i, %add.i52.i.i
  br i1 %cmp11.i53.i.i, label %if.then13.i56.i.i, label %if.else.i59.i.i

if.then13.i56.i.i:                                ; preds = %for.end.i54.i.i
  %23 = load ptr, ptr @stdout, align 8, !tbaa !9
  %call.i55.i.i = tail call i32 @putc(i32 noundef %cnum.059.i31.i.i, ptr noundef %23)
  br label %for.inc27.i75.i.i

if.else.i59.i.i:                                  ; preds = %for.end.i54.i.i
  %add14.i57.i.i = add nsw i32 %cnum.059.i31.i.i, 3
  %cmp15.not.i58.i.i = icmp sgt i32 %cnum.1.lcssa.ph.i51.i.i, %add14.i57.i.i
  br i1 %cmp15.not.i58.i.i, label %if.else22.i69.i.i, label %while.cond.preheader.i61.i.i

while.cond.preheader.i61.i.i:                     ; preds = %if.else.i59.i.i
  %cmp1856.i60.i.i = icmp slt i32 %cnum.059.i31.i.i, %cnum.1.lcssa.ph.i51.i.i
  br i1 %cmp1856.i60.i.i, label %while.body.i66.i.i, label %for.inc27.i75.i.i

while.body.i66.i.i:                               ; preds = %while.cond.preheader.i61.i.i, %while.body.i66.i.i
  %rangestart.057.i62.i.i = phi i32 [ %inc21.i64.i.i, %while.body.i66.i.i ], [ %cnum.059.i31.i.i, %while.cond.preheader.i61.i.i ]
  %24 = load ptr, ptr @stdout, align 8, !tbaa !9
  %call20.i63.i.i = tail call i32 @putc(i32 noundef %rangestart.057.i62.i.i, ptr noundef %24)
  %inc21.i64.i.i = add i32 %rangestart.057.i62.i.i, 1
  %exitcond61.not.i65.i.i = icmp eq i32 %inc21.i64.i.i, %cnum.1.lcssa.ph.i51.i.i
  br i1 %exitcond61.not.i65.i.i, label %for.inc27.i75.i.i, label %while.body.i66.i.i, !llvm.loop !20

if.else22.i69.i.i:                                ; preds = %if.else.i59.i.i
  %sub.i67.i.i = add nsw i32 %cnum.1.lcssa.ph.i51.i.i, -1
  %call23.i68.i.i = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.13, i32 noundef %cnum.059.i31.i.i, i32 noundef %sub.i67.i.i)
  br label %for.inc27.i75.i.i

for.inc27.i75.i.i:                                ; preds = %while.body.i66.i.i, %if.else22.i69.i.i, %while.cond.preheader.i61.i.i, %if.then13.i56.i.i, %for.body.i36.i.i
  %setp.addr.2.i70.i.i = phi ptr [ %setp.addr.1.lcssa.ph.i50.i.i, %if.then13.i56.i.i ], [ %setp.addr.1.lcssa.ph.i50.i.i, %if.else22.i69.i.i ], [ %setp.addr.058.i32.i.i, %for.body.i36.i.i ], [ %setp.addr.1.lcssa.ph.i50.i.i, %while.cond.preheader.i61.i.i ], [ %setp.addr.1.lcssa.ph.i50.i.i, %while.body.i66.i.i ]
  %cnum.2.i71.i.i = phi i32 [ %cnum.1.lcssa.ph.i51.i.i, %if.then13.i56.i.i ], [ %cnum.1.lcssa.ph.i51.i.i, %if.else22.i69.i.i ], [ %cnum.059.i31.i.i, %for.body.i36.i.i ], [ %cnum.1.lcssa.ph.i51.i.i, %while.cond.preheader.i61.i.i ], [ %cnum.1.lcssa.ph.i51.i.i, %while.body.i66.i.i ]
  %incdec.ptr28.i72.i.i = getelementptr inbounds i8, ptr %setp.addr.2.i70.i.i, i64 1
  %inc29.i73.i.i = add nsw i32 %cnum.2.i71.i.i, 1
  %cmp.i74.i.i = icmp slt i32 %cnum.2.i71.i.i, 127
  br i1 %cmp.i74.i.i, label %for.body.i36.i.i, label %setdump.exit.i, !llvm.loop !21

setdump.exit.i:                                   ; preds = %for.inc27.i75.i.i, %for.inc27.i.i.i, %if.then6.i.i, %for.end.i.i
  %.sink.i.i = phi i32 [ 46, %if.then6.i.i ], [ %spec.select.i.i.1, %for.end.i.i ], [ 93, %for.inc27.i.i.i ], [ 93, %for.inc27.i75.i.i ]
...
if.end14.i:                                       ; preds = %for.inc.i, %if.then12.i
  ...
  %stripl.i = getelementptr inbounds %struct.flagent, ptr %flagp.addr.03, i64 0, i32 3
...
if.then18.i:                                      ; preds = %if.end14.i
  %31 = load ptr, ptr %flagp.addr.03, align 8, !tbaa !24
...
if.end21.i:                                       ; preds = %if.then18.i, %if.end14.i
  %affl.i = getelementptr inbounds %struct.flagent, ptr %flagp.addr.03, i64 0, i32 4
...
cond.true.i:                                      ; preds = %if.end21.i
  %affix.i = getelementptr inbounds %struct.flagent, ptr %flagp.addr.03, i64 0, i32 1
...
entdump.exit:                                     ; preds = %if.end21.i, %cond.true.i
  ...
  %cmp = icmp sgt i32 %numflags.addr.04, 1
