...
if.end80:                                         ; preds = %if.end75, %_ZN13CObjectVectorIN8NArchive4NCab11CDatabaseExEE6InsertEiRKS2_.exit
  %res.2305 = phi i32 [ 0, %_ZN13CObjectVectorIN8NArchive4NCab11CDatabaseExEE6InsertEiRKS2_.exit ], [ 1, %if.end75 ]
...
if.end125:                                        ; preds = %invoke.cont115, %invoke.cont100
  %prevChecked.4314.ph = phi i8 [ %prevChecked.2, %invoke.cont100 ], [ %prevChecked.4.ph, %invoke.cont115 ]
...
if.end149:                                        ; preds = %invoke.cont142
  %46 = and i8 %prevChecked.4314.ph, 1
  %tobool150.not = icmp eq i8 %46, 0
  %47 = shl nuw nsw i8 %46, 2
  %. = zext i8 %47 to i32
  %.prevChecked.4 = select i1 %tobool150.not, i8 1, i8 %prevChecked.4314.ph
  br label %cleanup154
...
cleanup154:                                       ; preds = %if.then148, %invoke.cont142, %if.end149, %invoke.cont127
  ...
  %prevChecked.6 = phi i8 [ %prevChecked.4314.ph, %invoke.cont127 ], [ %prevChecked.4314.ph, %if.then148 ], [ %prevChecked.4314.ph, %invoke.cont142 ], [ %.prevChecked.4, %if.end149 ]
...
cleanup161:                                       ; preds = %cleanup157, %invoke.cont115, %cleanup161.loopexit, %invoke.cont23, %if.end75, %if.else69, %invoke.cont88
  %res.2307 = phi i32 [ %res.2305, %invoke.cont88 ], [ 1, %if.else69 ], [ 1, %if.end75 ], [ %call24, %invoke.cont23 ], [ %res.2305, %cleanup161.loopexit ], [ %res.2305, %invoke.cont115 ], [ %res.2305, %cleanup157 ]
...
if.then180:                                       ; preds = %invoke.cont14.thread, %invoke.cont14, %catch, %while.end, %invoke.cont172
  %res.3.ph = phi i32 [ 1, %invoke.cont172 ], [ %res.2307, %while.end ], [ 1, %catch ], [ 1, %invoke.cont14 ], [ 1, %invoke.cont14.thread ]
...
_ZN8NArchive4NCab10CInArchiveD2Ev.exit:           ; preds = %invoke.cont.i.i, %if.then.i.i.i
  ...
  %spec.select302 = select i1 %switch, i32 0, i32 %retval.13
  br label %return
...
return:                                           ; preds = %_ZN8NArchive4NCab10CInArchiveD2Ev.exit, %catch206
  %retval.14 = phi i32 [ -2147024882, %catch206 ], [ %spec.select302, %_ZN8NArchive4NCab10CInArchiveD2Ev.exit ]
  ret i32 %retval.14
...
cond.end258:                                      ; preds = %for.body252, %cond.false255
  ...
  %110 = load ptr, ptr %_items.i.i, align 8, !tbaa !22
  %111 = load i32, ptr %arrayidx.i1025, align 4, !tbaa !49
  %idxprom.i.i1027 = sext i32 %111 to i64
  %arrayidx.i.i1028 = getelementptr inbounds ptr, ptr %110, i64 %idxprom.i.i1027
...
call.i.i.i6.noexc:                                ; preds = %_ZN8NArchive4NCab13COtherArchiveC2Ev.exit
  ...
  %call.i.i45.i8 = invoke noalias noundef nonnull dereferenceable(4) ptr @_Znam(i64 noundef 4) #19
          to label %_ZN8NArchive4NCab13COtherArchiveC2Ev.exit12 unwind label %_ZN11CStringBaseIcED2Ev.exit.i10

_ZN11CStringBaseIcED2Ev.exit.i10:                 ; preds = %call.i.i.i6.noexc
...
lpad.body:                                        ; preds = %_ZN11CStringBaseIcED2Ev.exit.i10, %lpad
  %eh.lpad-body = phi { ptr, i32 } [ %2, %lpad ], [ %1, %_ZN11CStringBaseIcED2Ev.exit.i10 ]
