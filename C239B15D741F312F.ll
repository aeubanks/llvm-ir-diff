...
define dso_local i32 @f(ptr nocapture noundef readonly %0) local_unnamed_addr #0 {
  %2 = tail call i32 (ptr, ptr, ...) %0(ptr noundef nonnull @buf, ptr noundef nonnull @.str, double noundef 5.000000e+00) #4
  ret i32 undef
}

; Function Attrs: noreturn nounwind uwtable
define dso_local i32 @main() local_unnamed_addr #1 {
  %1 = tail call i32 (ptr, ptr, ...) @sprintf(ptr noundef nonnull dereferenceable(1) @buf, ptr noundef nonnull dereferenceable(1) @.str, double noundef 5.000000e+00) #4
  %2 = load i8, ptr @buf, align 1, !tbaa !5
  %3 = icmp ne i8 %2, 53
  %4 = load i8, ptr getelementptr inbounds ([2 x i8], ptr @buf, i64 0, i64 1), align 1
  %5 = icmp ne i8 %4, 0
