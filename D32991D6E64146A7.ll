...
define dso_local signext i8 @test(i32 noundef %0) local_unnamed_addr #0 {
  %2 = alloca [16 x i8], align 16
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %2) #5
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(11) %2, ptr noundef nonnull align 16 dereferenceable(11) @.str, i64 11, i1 false)
  %3 = sext i32 %0 to i64
...
define dso_local i32 @main() local_unnamed_addr #2 {
  %1 = tail call signext i8 @test(i32 noundef 2)
  %2 = icmp eq i8 %1, 49
