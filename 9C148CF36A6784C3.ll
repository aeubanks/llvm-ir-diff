...
for.body:                                         ; preds = %for.body.lr.ph, %for.inc165
  %flent.010 = phi ptr [ %ind.0.val, %for.body.lr.ph ], [ %incdec.ptr166, %for.inc165 ]
  %entcount.09 = phi i32 [ %ind.8.val, %for.body.lr.ph ], [ %dec, %for.inc165 ]
  %flagflags = getelementptr inbounds %struct.flagent, ptr %flent.010, i64 0, i32 6
...
land.lhs.true19:                                  ; preds = %if.end15
  %cmp22 = icmp eq i16 %2, 0
  br i1 %cmp22, label %land.lhs.true28, label %lor.lhs.false

lor.lhs.false:                                    ; preds = %land.lhs.true19
  %affix = getelementptr inbounds %struct.flagent, ptr %flent.010, i64 0, i32 1
  %3 = load ptr, ptr %affix, align 8, !tbaa !19
  %conv25 = sext i16 %2 to i64
  %call = call i32 @strncmp(ptr noundef %3, ptr noundef %ucword, i64 noundef %conv25) #7
...
land.lhs.true28:                                  ; preds = %lor.lhs.false, %land.lhs.true19
  %stripl = getelementptr inbounds %struct.flagent, ptr %flent.010, i64 0, i32 3
  %4 = load i16, ptr %stripl, align 2, !tbaa !20
  %conv29 = sext i16 %4 to i32
  %add = add nsw i32 %sub, %conv29
  %numconds = getelementptr inbounds %struct.flagent, ptr %flent.010, i64 0, i32 5
  %5 = load i16, ptr %numconds, align 2, !tbaa !21
...
if.then35:                                        ; preds = %if.then33
  %6 = load ptr, ptr %flent.010, align 8, !tbaa !22
  %call36 = call ptr @strcpy(ptr noundef nonnull dereferenceable(1) %tword, ptr noundef nonnull dereferenceable(1) %6) #6
  br label %if.end37

if.end37:                                         ; preds = %if.then35, %if.then33
  %idx.ext = sext i16 %4 to i64
  %add.ptr = getelementptr inbounds i8, ptr %tword, i64 %idx.ext
  %idx.ext43 = sext i16 %2 to i64
  ...
  %cmp502 = icmp sgt i16 %5, 0
  br i1 %cmp502, label %for.body52, label %for.end

for.body52:                                       ; preds = %if.end37, %for.inc
  %cond.04 = phi i32 [ %inc, %for.inc ], [ 0, %if.end37 ]
  %cp.03 = phi ptr [ %incdec.ptr, %for.inc ], [ %tword, %if.end37 ]
  %7 = load i8, ptr %cp.03, align 1, !tbaa !5
  %idxprom = zext i8 %7 to i64
  %arrayidx = getelementptr inbounds %struct.flagent, ptr %flent.010, i64 0, i32 7, i64 %idxprom
  %8 = load i8, ptr %arrayidx, align 1, !tbaa !5
  %conv53 = sext i8 %8 to i32
  %shl = shl nuw i32 1, %cond.04
  %and54 = and i32 %shl, %conv53
  %cmp55 = icmp eq i32 %and54, 0
  br i1 %cmp55, label %for.end, label %for.inc

for.inc:                                          ; preds = %for.body52
  %incdec.ptr = getelementptr inbounds i8, ptr %cp.03, i64 1
  %inc = add nuw nsw i32 %cond.04, 1
  %exitcond.not = icmp eq i32 %inc, %conv30
  br i1 %exitcond.not, label %if.then63, label %for.body52, !llvm.loop !23

for.end:                                          ; preds = %for.body52, %if.end37
  %cond.0.lcssa = phi i32 [ 0, %if.end37 ], [ %cond.04, %for.body52 ]
  %cmp61.not = icmp slt i32 %cond.0.lcssa, %conv30
  br i1 %cmp61.not, label %for.inc165, label %if.then63

if.then63:                                        ; preds = %for.inc, %for.end
  %9 = load i32, ptr @cflag, align 4, !tbaa !13
  %tobool67.not = icmp eq i32 %9, 0
  br i1 %tobool67.not, label %if.else, label %if.then68

if.then68:                                        ; preds = %if.then63
  %flagbit = getelementptr inbounds %struct.flagent, ptr %flent.010, i64 0, i32 2
  %10 = load i16, ptr %flagbit, align 8, !tbaa !24
  %conv70 = sext i16 %10 to i32
...
if.then82:                                        ; preds = %if.then77
  %11 = load i16, ptr %affl, align 4, !tbaa !18
  %tobool85.not = icmp eq i16 %11, 0
  br i1 %tobool85.not, label %if.end94, label %if.then86

if.then86:                                        ; preds = %if.then82
  %affix87 = getelementptr inbounds %struct.flagent, ptr %flent.010, i64 0, i32 1
  %12 = load ptr, ptr %affix87, align 8, !tbaa !19
  %call88 = call ptr @strcpy(ptr noundef nonnull dereferenceable(1) %tword2, ptr noundef nonnull dereferenceable(1) %12) #6
  %idx.ext91 = sext i16 %11 to i64
...
if.end94:                                         ; preds = %if.then86, %if.then82
  ...
  %13 = load i16, ptr %stripl, align 2, !tbaa !20
...
if.then103:                                       ; preds = %if.end94
  ...
  %14 = load ptr, ptr %flent.010, align 8, !tbaa !22
  %call106 = call ptr @strcpy(ptr noundef nonnull dereferenceable(1) %incdec.ptr104, ptr noundef nonnull dereferenceable(1) %14) #6
  br label %if.end107

if.end107:                                        ; preds = %if.then103, %if.end94
  %cp.2 = phi ptr [ %incdec.ptr104, %if.then103 ], [ %add.ptr100, %if.end94 ]
  %conv110 = sext i16 %13 to i32
  %sub.ptr.lhs.cast112 = ptrtoint ptr %cp.2 to i64
  %15 = add i64 %sub.ptr.lhs.cast.pre-phi, %idx.ext99
  %sub118 = sub i64 %sub.ptr.lhs.cast112, %15
  %conv119 = trunc i64 %sub118 to i32
  %call120 = call i32 @ins_root_cap(ptr noundef nonnull %tword2, ptr noundef %word, i32 noundef %conv110, i32 noundef %conv96, i32 noundef 0, i32 noundef %conv119, ptr noundef nonnull %call124, ptr noundef nonnull %flent.010, ptr noundef null) #6
  br label %if.end155
...
land.lhs.true127:                                 ; preds = %if.else122
  ...
  %16 = load i64, ptr %mask, align 8, !tbaa !25
  %flagbit129 = getelementptr inbounds %struct.flagent, ptr %flent.010, i64 0, i32 2
  %17 = load i16, ptr %flagbit129, align 8, !tbaa !24
  %conv130 = sext i16 %17 to i64
  %sh_prom = and i64 %conv130, 4294967295
  %shl131 = shl nuw i64 1, %sh_prom
  %and132 = and i64 %shl131, %16
  %tobool133.not = icmp eq i64 %and132, 0
  br i1 %tobool133.not, label %if.end155, label %if.then134

if.then134:                                       ; preds = %land.lhs.true127
  %18 = load i32, ptr @numhits, align 4, !tbaa !13
  %cmp135 = icmp slt i32 %18, 10
  br i1 %cmp135, label %if.then137, label %if.end145

if.then137:                                       ; preds = %if.then134
  %idxprom138 = sext i32 %18 to i64
  ...
  store ptr %flent.010, ptr %prefix, align 8, !tbaa !29
...
if.end155:                                        ; preds = %if.end107, %if.then77, %if.end145, %if.end151, %land.lhs.true127, %if.else122, %if.then68
  %19 = load i16, ptr %flagflags, align 8, !tbaa !14
  %20 = and i16 %19, 1
  %tobool159.not = icmp eq i16 %20, 0
  br i1 %tobool159.not, label %for.inc165, label %if.then160

if.then160:                                       ; preds = %if.end155
  call fastcc void @chk_suf(ptr noundef %word, ptr noundef nonnull %tword, i32 noundef %add, i32 noundef %or, ptr noundef nonnull %flent.010, i32 noundef %ignoreflagbits, i32 noundef %allhits)
  br label %for.inc165

for.inc165:                                       ; preds = %for.body, %if.end15, %lor.lhs.false, %land.lhs.true28, %if.end155, %if.then160, %for.end, %land.lhs.true8
  %incdec.ptr166 = getelementptr inbounds %struct.flagent, ptr %flent.010, i64 1
  %dec = add nsw i32 %entcount.09, -1
  %cmp = icmp sgt i32 %entcount.09, 1
...
entry:
  ...
  %cmp18 = icmp sgt i32 %ind.8.val, 0
  br i1 %cmp18, label %for.body.lr.ph, label %cleanup
...
for.body.lr.ph:                                   ; preds = %entry
  ...
  %sub.ptr.rhs.cast5 = ptrtoint ptr %tword2 to i64
  %tobool222.not = icmp eq i32 %allhits, 0
  br label %for.body

for.body:                                         ; preds = %for.body.lr.ph, %for.inc
  %flent.020 = phi ptr [ %ind.0.val, %for.body.lr.ph ], [ %incdec.ptr234, %for.inc ]
  %entcount.019 = phi i32 [ %ind.8.val, %for.body.lr.ph ], [ %dec235, %for.inc ]
  %flagflags5.phi.trans.insert = getelementptr inbounds %struct.flagent, ptr %flent.020, i64 0, i32 6
  %.pre = load i16, ptr %flagflags5.phi.trans.insert, align 8, !tbaa !14
  %0 = and i16 %.pre, 1
  %cmp3 = icmp eq i16 %0, 0
  %or.cond24 = select i1 %cmp1.not, i1 %cmp3, i1 false
  br i1 %or.cond24, label %for.inc, label %if.end

if.end:                                           ; preds = %for.body
  %conv623 = zext i16 %.pre to i32
  %and7 = and i32 %conv623, 2
...
land.lhs.true29:                                  ; preds = %if.end25
  %cmp32 = icmp eq i16 %2, 0
  br i1 %cmp32, label %land.lhs.true37, label %lor.lhs.false

lor.lhs.false:                                    ; preds = %land.lhs.true29
  %affix = getelementptr inbounds %struct.flagent, ptr %flent.020, i64 0, i32 1
  %3 = load ptr, ptr %affix, align 8, !tbaa !19
  %idx.ext = zext i32 %sub to i64
  %add.ptr = getelementptr inbounds i8, ptr %ucword, i64 %idx.ext
  %call34 = call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %3, ptr noundef nonnull dereferenceable(1) %add.ptr) #7
  %cmp35 = icmp eq i32 %call34, 0
  br i1 %cmp35, label %land.lhs.true37, label %for.inc

land.lhs.true37:                                  ; preds = %lor.lhs.false, %land.lhs.true29
  %stripl = getelementptr inbounds %struct.flagent, ptr %flent.020, i64 0, i32 3
  %4 = load i16, ptr %stripl, align 2, !tbaa !20
  %conv38 = sext i16 %4 to i32
  %add = add nsw i32 %sub, %conv38
  %numconds = getelementptr inbounds %struct.flagent, ptr %flent.020, i64 0, i32 5
  %5 = load i16, ptr %numconds, align 2, !tbaa !21
...
if.then49:                                        ; preds = %if.then42
  %6 = load ptr, ptr %flent.020, align 8, !tbaa !22
  %call50 = call ptr @strcpy(ptr noundef nonnull dereferenceable(1) %add.ptr47, ptr noundef nonnull dereferenceable(1) %6) #6
...
for.body63:                                       ; preds = %for.cond60
  ...
  %idxprom = zext i8 %7 to i64
  %arrayidx = getelementptr inbounds %struct.flagent, ptr %flent.020, i64 0, i32 7, i64 %idxprom
  %8 = load i8, ptr %arrayidx, align 1, !tbaa !5
...
if.then77:                                        ; preds = %if.then74
  %10 = load i16, ptr %flagbit, align 8, !tbaa !24
  %conv79 = sext i16 %10 to i32
  %add80 = add nsw i32 %conv79, 65
  %11 = load i16, ptr %stripl81, align 2, !tbaa !20
  %conv82 = sext i16 %11 to i32
  %12 = load i16, ptr %affl83, align 4, !tbaa !18
  %conv84 = sext i16 %12 to i32
  %flagbit85 = getelementptr inbounds %struct.flagent, ptr %flent.020, i64 0, i32 2
  %13 = load i16, ptr %flagbit85, align 8, !tbaa !24
  %conv86 = sext i16 %13 to i32
...
if.else90:                                        ; preds = %if.then74
  %flagbit92 = getelementptr inbounds %struct.flagent, ptr %flent.020, i64 0, i32 2
  %14 = load i16, ptr %flagbit92, align 8, !tbaa !24
  %conv93 = sext i16 %14 to i32
...
land.lhs.true109:                                 ; preds = %if.then105
  %15 = load i16, ptr %affl83, align 4, !tbaa !18
  %cmp112.not = icmp eq i16 %15, 0
  br i1 %cmp112.not, label %land.lhs.true131, label %if.then114

if.then114:                                       ; preds = %land.lhs.true109
  %16 = load ptr, ptr %affix115, align 8, !tbaa !19
  %call116 = call ptr @strcpy(ptr noundef nonnull dereferenceable(1) %tword2, ptr noundef nonnull dereferenceable(1) %16) #6
  %idx.ext119 = sext i16 %15 to i64
  ...
  %.pre22 = ptrtoint ptr %incdec.ptr121 to i64
...
land.lhs.true131:                                 ; preds = %if.then114, %land.lhs.true109
  %sub.ptr.lhs.cast4.pre-phi = phi i64 [ %.pre22, %if.then114 ], [ %sub.ptr.rhs.cast5, %land.lhs.true109 ]
  %cp.2.ph = phi ptr [ %incdec.ptr121, %if.then114 ], [ %tword2, %land.lhs.true109 ]
  %sub.ptr.sub6 = sub i64 %sub.ptr.lhs.cast4.pre-phi, %sub.ptr.rhs.cast5
  %conv1247 = trunc i64 %sub.ptr.sub6 to i32
  %call1268 = call ptr @strcpy(ptr noundef nonnull dereferenceable(1) %cp.2.ph, ptr noundef nonnull dereferenceable(1) %tword) #6
  %idx.ext1279 = sext i32 %tlen.0 to i64
  %add.ptr12810 = getelementptr inbounds i8, ptr %cp.2.ph, i64 %idx.ext1279
  %17 = load i16, ptr %stripl81, align 2, !tbaa !20
  %cmp134.not = icmp eq i16 %17, 0
  br i1 %cmp134.not, label %if.end144, label %if.then136

if.then136:                                       ; preds = %land.lhs.true131
  %incdec.ptr137 = getelementptr inbounds i8, ptr %add.ptr12810, i64 1
  store i8 45, ptr %add.ptr12810, align 1, !tbaa !5
  %18 = load ptr, ptr %pfxent, align 8, !tbaa !22
  %call139 = call ptr @strcpy(ptr noundef nonnull dereferenceable(1) %incdec.ptr137, ptr noundef nonnull dereferenceable(1) %18) #6
  %idx.ext142 = sext i16 %17 to i64
...
if.end144:                                        ; preds = %if.end122, %if.then136, %land.lhs.true131
  %idx.ext12716 = phi i64 [ %idx.ext1279, %if.then136 ], [ %idx.ext1279, %land.lhs.true131 ], [ %idx.ext127, %if.end122 ]
  %conv12414 = phi i32 [ %conv1247, %if.then136 ], [ %conv1247, %land.lhs.true131 ], [ 0, %if.end122 ]
  %sub.ptr.lhs.cast12 = phi i64 [ %sub.ptr.lhs.cast4.pre-phi, %if.then136 ], [ %sub.ptr.lhs.cast4.pre-phi, %land.lhs.true131 ], [ %sub.ptr.rhs.cast5, %if.end122 ]
  %cp.3 = phi ptr [ %add.ptr143, %if.then136 ], [ %add.ptr12810, %land.lhs.true131 ], [ %add.ptr128, %if.end122 ]
  %19 = load i16, ptr %stripl, align 2, !tbaa !20
...
if.then147:                                       ; preds = %if.end144
  ...
  %20 = load ptr, ptr %flent.020, align 8, !tbaa !22
  %call150 = call ptr @strcpy(ptr noundef nonnull dereferenceable(1) %incdec.ptr148, ptr noundef nonnull dereferenceable(1) %20) #6
  %21 = load i16, ptr %stripl, align 2, !tbaa !20
  %idx.ext153 = sext i16 %21 to i64
...
if.end155:                                        ; preds = %if.then147, %if.end144
  ...
  %22 = load i16, ptr %affl, align 4, !tbaa !18
  %tobool157.not = icmp eq i16 %22, 0
...
if.then158:                                       ; preds = %if.end155
  ...
  %affix160 = getelementptr inbounds %struct.flagent, ptr %flent.020, i64 0, i32 1
  %23 = load ptr, ptr %affix160, align 8, !tbaa !19
  %call161 = call ptr @strcpy(ptr noundef nonnull dereferenceable(1) %incdec.ptr159, ptr noundef nonnull dereferenceable(1) %23) #6
  %24 = load i16, ptr %affl, align 4, !tbaa !18
  %idx.ext164 = sext i16 %24 to i64
...
cond.true:                                        ; preds = %if.end166
  %25 = load i16, ptr %stripl81, align 2, !tbaa !20
  %conv171 = sext i16 %25 to i32
  br label %cond.end

cond.end:                                         ; preds = %if.end166, %cond.true
  %cond172 = phi i32 [ %conv171, %cond.true ], [ 0, %if.end166 ]
  %26 = load i16, ptr %stripl, align 2, !tbaa !20
  %conv174 = sext i16 %26 to i32
  %sub.ptr.lhs.cast176 = ptrtoint ptr %cp.5 to i64
  %27 = add i64 %sub.ptr.lhs.cast12, %idx.ext12716
  %sub182 = sub i64 %sub.ptr.lhs.cast176, %27
  %conv183 = trunc i64 %sub182 to i32
  %call184 = call i32 @ins_root_cap(ptr noundef nonnull %tword2, ptr noundef %word, i32 noundef %cond172, i32 noundef %conv12414, i32 noundef %conv174, i32 noundef %conv183, ptr noundef nonnull %call188, ptr noundef %pfxent, ptr noundef nonnull %flent.020) #6
  br label %for.inc
...
land.lhs.true191:                                 ; preds = %if.else186
  ...
  %28 = load i64, ptr %mask, align 8, !tbaa !25
  %flagbit193 = getelementptr inbounds %struct.flagent, ptr %flent.020, i64 0, i32 2
  %29 = load i16, ptr %flagbit193, align 8, !tbaa !24
  %conv194 = sext i16 %29 to i64
  %sh_prom = and i64 %conv194, 4294967295
  %shl195 = shl nuw i64 1, %sh_prom
  %and196 = and i64 %shl195, %28
...
lor.lhs.false202:                                 ; preds = %land.lhs.true198
  %30 = load i16, ptr %flagbit, align 8, !tbaa !24
  %conv206 = sext i16 %30 to i64
  %sh_prom207 = and i64 %conv206, 4294967295
  %shl208 = shl nuw i64 1, %sh_prom207
  %and209 = and i64 %shl208, %28
...
if.then214:                                       ; preds = %if.then211
  ...
  store ptr %flent.020, ptr %suffix, align 8, !tbaa !30
...
for.inc:                                          ; preds = %for.body63, %for.body, %if.end, %if.end25, %lor.lhs.false, %land.lhs.true37, %if.else90, %if.then77, %if.else186, %land.lhs.true191, %lor.lhs.false202, %if.end227, %if.end221, %if.then100, %cond.end, %land.lhs.true18
  %incdec.ptr234 = getelementptr inbounds %struct.flagent, ptr %flent.020, i64 1
  %dec235 = add nsw i32 %entcount.019, -1
  %cmp = icmp sgt i32 %entcount.019, 1
