...
entry:
  %cmp.i.not29 = icmp eq ptr %Sort, null
  br i1 %cmp.i.not29, label %cleanup, label %for.cond2.preheader

for.cond2.preheader:                              ; preds = %entry, %for.inc12
  %Scan1.030 = phi ptr [ %Scan1.0.val, %for.inc12 ], [ %Sort, %entry ]
  %0 = getelementptr i8, ptr %Scan1.030, i64 8
  br label %for.cond2

for.cond2:                                        ; preds = %for.cond2.preheader, %for.body6
  %Scan2.0.in = phi ptr [ %Scan2.0, %for.body6 ], [ %Scan1.030, %for.cond2.preheader ]
  %Scan2.0 = load ptr, ptr %Scan2.0.in, align 8
  %cmp.i24.not = icmp eq ptr %Scan2.0, null
  br i1 %cmp.i24.not, label %for.inc12, label %for.body6
...
for.body6:                                        ; preds = %for.cond2
  ...
  br i1 %cmp.i26, label %cleanup, label %for.cond2, !llvm.loop !11

for.inc12:                                        ; preds = %for.cond2
  %Scan1.0.val = load ptr, ptr %Scan1.030, align 8
  %cmp.i.not = icmp eq ptr %Scan1.0.val, null
  br i1 %cmp.i.not, label %cleanup, label %for.cond2.preheader, !llvm.loop !12

cleanup:                                          ; preds = %for.inc12, %for.body6, %entry
  %retval.0 = phi i32 [ 1, %entry ], [ 0, %for.body6 ], [ 1, %for.inc12 ]
  ret i32 %retval.0
}
...
for.body.i:                                       ; preds = %if.end, %for.body.i
  ...
  br i1 %exitcond.not.i.4, label %sort_TheoryIncrementMark.exit, label %for.body.i, !llvm.loop !13
...
for.body:                                         ; preds = %sort_TheoryIncrementMark.exit, %for.body
  ...
  br i1 %cmp.i30.not, label %for.cond5.preheader, label %for.body, !llvm.loop !14
...
for.inc15:                                        ; preds = %for.body9
  ...
  br i1 %cmp.i32.not, label %cleanup, label %for.body9, !llvm.loop !15
...
for.body11.i:                                     ; preds = %for.end.i, %for.body11.i
  ...
  br i1 %cmp.i63.not.i, label %for.end16.i, label %for.body11.i, !llvm.loop !17
...
for.body22.i:                                     ; preds = %for.end16.i, %for.body22.i
  ...
  br i1 %cmp.i66.not.i, label %for.end27.i, label %for.body22.i, !llvm.loop !18
...
for.body33.i:                                     ; preds = %for.end27.i, %for.body33.i
  ...
  br i1 %cmp.i69.not.i, label %sort_ConditionPrint.exit, label %for.body33.i, !llvm.loop !19
...
for.inc:                                          ; preds = %for.body, %land.lhs.true
  ...
  br i1 %cmp.i.not, label %cleanup, label %for.body, !llvm.loop !20
...
for.inc.i:                                        ; preds = %for.body.i
  ...
  br i1 %cmp.i.not.i, label %for.end.i, label %for.body.i, !llvm.loop !22
...
for.inc27.i:                                      ; preds = %for.body19.i
  ...
  br i1 %cmp.i111.not.i, label %for.end29.i, label %for.body19.i, !llvm.loop !23
...
for.inc44.i:                                      ; preds = %for.body36.i
  ...
  br i1 %cmp.i116.not.i, label %for.end46.i, label %for.body36.i, !llvm.loop !24
...
for.inc61.i:                                      ; preds = %for.body53.i
  ...
  br i1 %cmp.i121.not.i, label %sort_LinkPrint.exit, label %for.body53.i, !llvm.loop !25
...
for.body17:                                       ; preds = %for.end, %for.body17
  ...
  br i1 %cmp.i36.not, label %cleanup, label %for.body17, !llvm.loop !27
...
for.body.i:                                       ; preds = %for.body, %for.body.i
  ...
  %cmp.i.not.i = icmp eq ptr %Scan.0.i, null
  br i1 %cmp.i.not.i, label %for.end.i, label %for.body.i, !llvm.loop !28
...
list_Delete.exit118:                              ; preds = %while.body.i117
  ...
  br i1 %cmp.i89.not, label %for.end27, label %for.body10, !llvm.loop !30
...
for.inc38:                                        ; preds = %for.body32, %sort_NodeDelete.exit
  ...
  br i1 %cmp31, label %for.body32, label %for.end39, !llvm.loop !31
...
for.inc.i:                                        ; preds = %if.else.i, %clause_GetLiteralAtom.exit138.i
  ...
  br i1 %cmp.not.not.i, label %for.body.i, label %for.cond23.preheader.i, !llvm.loop !32
...
for.body26.i:                                     ; preds = %for.body26.i, %for.body26.lr.ph.i
  ...
  br i1 %cmp25.not.not.i, label %for.body26.i, label %for.end32.i, !llvm.loop !33
...
for.inc45.i:                                      ; preds = %if.then40.i, %for.body37.i
  ...
  br i1 %cmp36.not.not.i, label %for.body37.i, label %for.end47.i, !llvm.loop !34
...
while.body.i:                                     ; preds = %for.end47.i, %while.body.i
  ...
  br i1 %cmp.i164.not.i, label %sort_TheoryLinkCreate.exit, label %while.body.i, !llvm.loop !35
...
for.inc32:                                        ; preds = %while.body.i107, %for.body13
  ...
  br i1 %cmp.i78.not, label %for.end34.loopexit, label %for.body13, !llvm.loop !37
...
for.body10:                                       ; preds = %for.end, %for.body10
  ...
  br i1 %cmp.i102.not, label %for.end15, label %for.body10, !llvm.loop !39
...
for.body21:                                       ; preds = %for.end15, %for.body21
  ...
  br i1 %cmp.i104.not, label %for.end26, label %for.body21, !llvm.loop !40
...
for.body35:                                       ; preds = %for.end26, %for.body35
  ...
  br i1 %cmp.i106.not, label %for.cond41.preheader, label %for.body35, !llvm.loop !41
...
for.body45:                                       ; preds = %for.cond41.preheader, %for.body45
  ...
  br i1 %cmp.i108.not, label %for.cond51.preheader, label %for.body45, !llvm.loop !42
...
for.body55:                                       ; preds = %for.cond51.preheader, %for.body55
  ...
  br i1 %cmp.i110.not, label %for.end59, label %for.body55, !llvm.loop !43
...
for.body:                                         ; preds = %entry, %for.body
  ...
  br i1 %cmp.i.not, label %for.cond11.preheader, label %for.body, !llvm.loop !44
...
for.body15:                                       ; preds = %for.cond11.preheader, %for.body15
  ...
  br i1 %cmp.i187.not, label %for.cond21.preheader, label %for.body15, !llvm.loop !45
...
for.body25:                                       ; preds = %for.cond21.preheader, %for.body25
  ...
  br i1 %cmp.i189.not, label %for.end30, label %for.body25, !llvm.loop !46
...
for.body38:                                       ; preds = %for.end30, %for.body38
  ...
  br i1 %cmp.i191.not, label %for.cond43.preheader, label %for.body38, !llvm.loop !47
...
for.body47:                                       ; preds = %for.cond43.preheader, %for.body47
  ...
  br i1 %cmp.i193.not, label %for.cond52.preheader, label %for.body47, !llvm.loop !48
...
for.body56:                                       ; preds = %for.cond52.preheader, %for.body56
  ...
  br i1 %cmp.i195.not, label %for.end60, label %for.body56, !llvm.loop !49
...
for.body67:                                       ; preds = %for.end60, %for.body67
  ...
  br i1 %cmp.i197.not, label %for.end71, label %for.body67, !llvm.loop !50
...
for.body77:                                       ; preds = %for.end71, %for.body77
  ...
  br i1 %cmp.i199.not, label %for.end81, label %for.body77, !llvm.loop !51
...
for.body87:                                       ; preds = %for.end81, %for.body87
  ...
  br i1 %cmp.i201.not, label %for.end91, label %for.body87, !llvm.loop !52
...
for.cond.i:                                       ; preds = %for.end91, %for.cond.i
  ...
  br i1 %cmp.i20.not.i, label %for.end.i, label %for.cond.i, !llvm.loop !53
...
for.cond.i209:                                    ; preds = %list_Nconc.exit, %for.cond.i209
  ...
  br i1 %cmp.i20.not.i208, label %for.end.i210, label %for.cond.i209, !llvm.loop !53
...
for.cond.i219:                                    ; preds = %list_Nconc.exit212, %for.cond.i219
  ...
  br i1 %cmp.i20.not.i218, label %for.end.i220, label %for.cond.i219, !llvm.loop !53
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %cmp.i.not = icmp eq ptr %Lits.0.val, null
  br i1 %cmp.i.not, label %for.cond11.preheader, label %for.body, !llvm.loop !54
...
for.body15:                                       ; preds = %for.cond11.preheader, %for.body15
  ...
  br i1 %cmp.i188.not, label %for.cond21.preheader, label %for.body15, !llvm.loop !55
...
for.body25:                                       ; preds = %for.cond21.preheader, %for.body25
  ...
  br i1 %cmp.i190.not, label %for.end30, label %for.body25, !llvm.loop !56
...
for.body38:                                       ; preds = %for.end30, %for.body38
  ...
  br i1 %cmp.i192.not, label %for.cond43.preheader, label %for.body38, !llvm.loop !57
...
for.body47:                                       ; preds = %for.cond43.preheader, %for.body47
  ...
  br i1 %cmp.i194.not, label %for.cond52.preheader, label %for.body47, !llvm.loop !58
...
for.body56:                                       ; preds = %for.cond52.preheader, %for.body56
  ...
  br i1 %cmp.i196.not, label %for.end60, label %for.body56, !llvm.loop !59
...
for.body67:                                       ; preds = %for.end60, %for.body67
  ...
  br i1 %cmp.i198.not, label %for.end71, label %for.body67, !llvm.loop !60
...
for.body77:                                       ; preds = %for.end71, %for.body77
  ...
  br i1 %cmp.i200.not, label %for.end81, label %for.body77, !llvm.loop !61
...
for.body87:                                       ; preds = %for.end81, %for.body87
  ...
  br i1 %cmp.i202.not, label %for.end91, label %for.body87, !llvm.loop !62
...
for.cond.i210:                                    ; preds = %list_Nconc.exit, %for.cond.i210
  ...
  br i1 %cmp.i20.not.i209, label %for.end.i211, label %for.cond.i210, !llvm.loop !53
...
for.cond.i220:                                    ; preds = %list_Nconc.exit213, %for.cond.i220
  ...
  br i1 %cmp.i20.not.i219, label %for.end.i221, label %for.cond.i220, !llvm.loop !53
...
for.cond.i230:                                    ; preds = %if.end.i226, %for.cond.i230
  ...
  br i1 %cmp.i20.not.i229, label %for.end.i231, label %for.cond.i230, !llvm.loop !53
...
for.body29:                                       ; preds = %if.else, %for.body29
  ...
  br i1 %cmp.i221.not, label %for.cond33.preheader, label %for.body29, !llvm.loop !63
...
for.body37:                                       ; preds = %for.cond33.preheader, %for.body37
  ...
  br i1 %cmp.i223.not, label %for.cond43.preheader, label %for.body37, !llvm.loop !64
...
for.body47:                                       ; preds = %for.cond43.preheader, %for.body47
  ...
  br i1 %cmp.i225.not, label %for.end52, label %for.body47, !llvm.loop !65
...
for.body60:                                       ; preds = %for.end52, %for.body60
  ...
  br i1 %cmp.i227.not, label %for.cond65.preheader, label %for.body60, !llvm.loop !66
...
for.body69:                                       ; preds = %for.cond65.preheader, %for.body69
  ...
  br i1 %cmp.i229.not, label %for.cond74.preheader, label %for.body69, !llvm.loop !67
...
for.body78:                                       ; preds = %for.cond74.preheader, %for.body78
  ...
  br i1 %cmp.i231.not, label %for.end82, label %for.body78, !llvm.loop !68
...
for.body88:                                       ; preds = %for.end82, %for.body88
  ...
  br i1 %cmp.i233.not, label %for.cond93.preheader, label %for.body88, !llvm.loop !69
...
for.body97:                                       ; preds = %for.cond93.preheader, %for.body97
  ...
  br i1 %cmp.i235.not, label %for.cond102.preheader, label %for.body97, !llvm.loop !70
...
for.body106:                                      ; preds = %for.cond102.preheader, %for.body106
  ...
  br i1 %cmp.i237.not, label %for.end110, label %for.body106, !llvm.loop !71
...
for.cond.i246:                                    ; preds = %list_Nconc.exit, %for.cond.i246
  ...
  br i1 %cmp.i20.not.i245, label %for.end.i247, label %for.cond.i246, !llvm.loop !53
...
for.cond.i256:                                    ; preds = %list_Nconc.exit249, %for.cond.i256
  ...
  br i1 %cmp.i20.not.i255, label %for.end.i257, label %for.cond.i256, !llvm.loop !53
...
for.inc121:                                       ; preds = %if.then, %list_Nconc.exit259
  ...
  br i1 %cmp.i.not, label %for.end123, label %for.body, !llvm.loop !72
...
for.body34:                                       ; preds = %if.then23, %for.body34
  ...
  br i1 %cmp.i232.not, label %for.cond38.preheader, label %for.body34, !llvm.loop !73
...
for.body42:                                       ; preds = %for.cond38.preheader, %for.body42
  ...
  br i1 %cmp.i234.not, label %for.cond48.preheader, label %for.body42, !llvm.loop !74
...
for.body52:                                       ; preds = %for.cond48.preheader, %for.body52
  ...
  br i1 %cmp.i236.not, label %for.end57, label %for.body52, !llvm.loop !75
...
for.body65:                                       ; preds = %for.end57, %for.body65
  ...
  br i1 %cmp.i238.not, label %for.cond70.preheader, label %for.body65, !llvm.loop !76
...
for.body74:                                       ; preds = %for.cond70.preheader, %for.body74
  ...
  br i1 %cmp.i240.not, label %for.cond79.preheader, label %for.body74, !llvm.loop !77
...
for.body83:                                       ; preds = %for.cond79.preheader, %for.body83
  ...
  br i1 %cmp.i242.not, label %for.cond88.preheader, label %for.body83, !llvm.loop !78
...
for.body92:                                       ; preds = %for.cond88.preheader, %for.body92
  ...
  br i1 %cmp.i244.not, label %for.cond97.preheader, label %for.body92, !llvm.loop !79
...
for.body101:                                      ; preds = %for.cond97.preheader, %for.body101
  ...
  br i1 %cmp.i246.not, label %for.cond106.preheader, label %for.body101, !llvm.loop !80
...
for.body110:                                      ; preds = %for.cond106.preheader, %for.body110
  ...
  br i1 %cmp.i248.not, label %for.end114, label %for.body110, !llvm.loop !81
...
for.cond.i257:                                    ; preds = %list_Nconc.exit, %for.cond.i257
  ...
  br i1 %cmp.i20.not.i256, label %for.end.i258, label %for.cond.i257, !llvm.loop !53
...
for.cond.i267:                                    ; preds = %if.end.i263, %for.cond.i267
  ...
  br i1 %cmp.i20.not.i266, label %for.end.i268, label %for.cond.i267, !llvm.loop !53
...
for.cond.i277:                                    ; preds = %if.end.i273, %for.cond.i277
  ...
  br i1 %cmp.i20.not.i276, label %for.end.i278, label %for.cond.i277, !llvm.loop !53
...
list_Nconc.exit280:                               ; preds = %if.end118, %if.end.i273, %for.end.i278
  ...
  br i1 %cmp.i227.not, label %for.end124, label %for.body, !llvm.loop !82
...
for.body:                                         ; preds = %sort_TheoryIncrementMark.exit, %for.body
  ...
  br i1 %cmp.i124.not, label %for.cond5.preheader, label %for.body, !llvm.loop !83
...
for.body9:                                        ; preds = %for.cond5.preheader, %for.body9
  ...
  br i1 %cmp.i125.not, label %for.cond24.preheader, label %for.body9, !llvm.loop !84
...
for.inc43:                                        ; preds = %land.lhs.true, %land.lhs.true.i, %for.body28, %sort_LinkNoResidues.exit, %if.then
  ...
  br i1 %cmp.i127.not, label %for.end45, label %for.body28, !llvm.loop !85
...
for.cond.i.i:                                     ; preds = %if.end.i.i, %for.cond.i.i
  ...
  br i1 %cmp.i20.not.i.i, label %for.end.i.i, label %for.cond.i.i, !llvm.loop !53
...
while.cond.loopexit.i:                            ; preds = %for.inc41.i, %while.body.i
  ...
  br i1 %cmp.i.not.i, label %sort_EvalSubsortNoResidues.exit, label %while.body.i, !llvm.loop !86
...
for.cond.i.i152:                                  ; preds = %if.end.i.i148, %for.cond.i.i152
  ...
  br i1 %cmp.i20.not.i.i151, label %for.end.i.i153, label %for.cond.i.i152, !llvm.loop !53
...
for.inc.i:                                        ; preds = %for.end.i.i153, %if.end.i.i148, %if.then27.i, %for.body22.i
  ...
  br i1 %cmp.i76.not.i, label %for.end.i, label %for.body22.i, !llvm.loop !87
...
for.inc41.i:                                      ; preds = %for.end.i, %if.then.i, %land.lhs.true.i146, %sort_LinkNoResidues.exit.i, %land.lhs.true.i.i, %for.body.i144
  ...
  br i1 %cmp.i72.not.i, label %while.cond.loopexit.i, label %for.body.i144, !llvm.loop !88
...
for.cond.i:                                       ; preds = %if.end.i, %for.cond.i
  ...
  %List1.addr.0.val17.i = load ptr, ptr %List1.addr.0.i, align 8
  %cmp.i20.not.i = icmp eq ptr %List1.addr.0.val17.i, null
  br i1 %cmp.i20.not.i, label %for.end.i168, label %for.cond.i, !llvm.loop !53
...
for.inc70:                                        ; preds = %for.end.i168, %if.end.i, %if.then62, %if.else
  ...
  br i1 %cmp.i156.not, label %for.end72, label %for.body54, !llvm.loop !89
...
for.body:                                         ; preds = %sort_TheoryIncrementMark.exit, %for.body
  ...
  br i1 %cmp.i47.not, label %for.cond5.preheader, label %for.body, !llvm.loop !90
...
for.body9:                                        ; preds = %for.cond5.preheader, %for.body9
  ...
  br i1 %cmp.i48.not, label %for.end13, label %for.body9, !llvm.loop !91
...
while.cond.loopexit.i:                            ; preds = %for.inc.i, %while.body.i
  ...
  %cmp.i.not.i = icmp eq ptr %Nodes.addr.1.lcssa.i, null
  br i1 %cmp.i.not.i, label %sort_EvalSubsortSpecial.exit, label %while.body.i, !llvm.loop !92
...
for.inc.i:                                        ; preds = %if.then11.i, %if.then.i, %for.body.i51
  ...
  br i1 %cmp.i23.not.i, label %while.cond.loopexit.i, label %for.body.i51, !llvm.loop !93
...
for.inc23:                                        ; preds = %for.body19
  ...
  br i1 %cmp.i52.not, label %cleanup, label %for.body19, !llvm.loop !94
...
for.body:                                         ; preds = %sort_TheoryIncrementMark.exit, %for.body
  ...
  br i1 %cmp.i51.not, label %for.cond5.preheader, label %for.body, !llvm.loop !95
...
for.body9:                                        ; preds = %for.cond5.preheader, %for.body9
  ...
  br i1 %cmp.i52.not, label %for.end13, label %for.body9, !llvm.loop !96
...
for.inc.i:                                        ; preds = %if.then11.i, %if.then.i, %for.body.i55
  ...
  %Scan.0.i = load ptr, ptr %Scan.033.i, align 8
  %cmp.i23.not.i = icmp eq ptr %Scan.0.i, null
  br i1 %cmp.i23.not.i, label %while.cond.loopexit.i, label %for.body.i55, !llvm.loop !93
...
for.inc23:                                        ; preds = %for.body19
  ...
  br i1 %cmp.i56.not, label %for.end25, label %for.body19, !llvm.loop !97
...
for.inc.us.i:                                     ; preds = %if.then10.us.i, %for.body.us.i
  ...
  br i1 %cmp.i30.not.us.i, label %while.cond.loopexit.us.i, label %for.body.us.i, !llvm.loop !98
...
while.cond.loopexit.us.i:                         ; preds = %for.inc.us.i, %while.body.us.i
  ...
  br i1 %cmp.i.not.us.i, label %cleanup, label %while.body.us.i, !llvm.loop !99
...
while.cond.loopexit.i64:                          ; preds = %for.inc.i77, %if.end.loopexit.i
  ...
  br i1 %cmp.i.not.i63, label %cleanup, label %while.body.i69, !llvm.loop !99
...
if.end.i.i:                                       ; preds = %while.body.i.i
  ...
  br i1 %cmp.i.not.i.i, label %if.end.loopexit.i, label %while.body.i.i, !llvm.loop !100
...
for.inc.i77:                                      ; preds = %if.then10.i, %for.body.i72
  ...
  br i1 %cmp.i30.not.i, label %while.cond.loopexit.i64, label %for.body.i72, !llvm.loop !98
...
for.body:                                         ; preds = %sort_TheoryIncrementMark.exit, %for.body
  ...
  br i1 %cmp.i211.not, label %for.cond6.preheader, label %for.body, !llvm.loop !101
...
for.body10:                                       ; preds = %for.cond6.preheader, %for.body10
  ...
  br i1 %cmp.i212.not, label %for.end22, label %for.body10, !llvm.loop !102
...
while.cond.loopexit.i:                            ; preds = %for.inc41.i, %while.body.i
  %Nodes.addr.1.lcssa.i = phi ptr [ %Nodes.addr.0.val.i, %while.body.i ], [ %Nodes.addr.2.i, %for.inc41.i ]
  %cmp.i.not.i = icmp eq ptr %Nodes.addr.1.lcssa.i, null
  br i1 %cmp.i.not.i, label %sort_EvalSubsort.exit, label %while.body.i, !llvm.loop !103
...
for.inc.i:                                        ; preds = %if.then29.i, %for.body24.i
  ...
  br i1 %cmp.i75.not.i, label %for.end.i, label %for.body24.i, !llvm.loop !104
...
for.inc41.i:                                      ; preds = %for.end.i, %if.then.i, %for.body.i217
  ...
  br i1 %cmp.i71.not.i, label %while.cond.loopexit.i, label %for.body.i217, !llvm.loop !105
...
for.inc33:                                        ; preds = %for.body28
  ...
  br i1 %cmp.i220.not, label %while.body.preheader, label %for.body28, !llvm.loop !106
...
while.body:                                       ; preds = %while.body.preheader, %if.end123
  ...
  %cmp.i.not9.i = icmp eq ptr %Visited.0297, null
...
while.body.us.i:                                  ; preds = %while.body.lr.ph.i235, %if.end.us.i
  %List.addr.010.us.i = phi ptr [ %List.addr.0.val.us.i, %if.end.us.i ], [ %Visited.0297, %while.body.lr.ph.i235 ]
...
for.body.i.i.us.i:                                ; preds = %if.end.i.us.i, %for.body.i.i.us.i
  ...
  br i1 %exitcond.not.i.i.us.i.4, label %sort_TheoryIncrementMark.exit.i.us.i, label %for.body.i.i.us.i, !llvm.loop !13
...
for.body.i.us.i:                                  ; preds = %sort_TheoryIncrementMark.exit.i.us.i, %for.body.i.us.i
  ...
  br i1 %cmp.i30.not.i.us.i, label %if.end123, label %for.body.i.us.i, !llvm.loop !14
...
if.end.us.i:                                      ; preds = %while.body.us.i
  ...
  br i1 %cmp.i.not.us.i, label %if.then53.critedge, label %while.body.us.i, !llvm.loop !107

while.body.i237:                                  ; preds = %while.body.lr.ph.i235, %if.end.i
  %List.addr.010.i = phi ptr [ %List.addr.0.val.i, %if.end.i ], [ %Visited.0297, %while.body.lr.ph.i235 ]
...
for.body.i.i.i:                                   ; preds = %if.end.i.i, %for.body.i.i.i
  ...
  br i1 %exitcond.not.i.i.i.4, label %sort_TheoryIncrementMark.exit.i.i, label %for.body.i.i.i, !llvm.loop !13
...
for.body.i.i:                                     ; preds = %sort_TheoryIncrementMark.exit.i.i, %for.body.i.i
  ...
  br i1 %cmp.i30.not.i.i, label %for.cond5.preheader.i.loopexit.i, label %for.body.i.i, !llvm.loop !14
...
for.inc15.i.i:                                    ; preds = %for.body9.i.i
  ...
  br i1 %cmp.i32.not.i.i, label %if.end123, label %for.body9.i.i, !llvm.loop !15
...
if.end.i:                                         ; preds = %for.body9.i.i, %while.body.i237
  ...
  br i1 %cmp.i.not.i238, label %if.then53.critedge, label %while.body.i237, !llvm.loop !107
...
if.then53.critedge:                               ; preds = %if.end.i, %if.end.us.i, %while.body
  ...
  %Scan.3278 = load ptr, ptr %38, align 8
  %cmp.i241279 = icmp eq ptr %Scan.3278, null
  br i1 %cmp.i241279, label %if.then78, label %land.rhs

land.rhs:                                         ; preds = %if.then53.critedge, %for.inc72
  %Scan.3282 = phi ptr [ %Scan.3, %for.inc72 ], [ %Scan.3278, %if.then53.critedge ]
...
for.body63:                                       ; preds = %land.rhs
  %60 = getelementptr i8, ptr %Scan.3282, i64 8
...
for.inc72:                                        ; preds = %if.else, %for.body63
  ...
  %Scan.3 = load ptr, ptr %Scan.3282, align 8
  %cmp.i241 = icmp eq ptr %Scan.3, null
  br i1 %cmp.i241, label %for.end74, label %land.rhs, !llvm.loop !108
...
if.then78:                                        ; preds = %if.then53.critedge, %if.then76
  %call.i.i243 = tail call ptr @list_Copy(ptr noundef %Scan.3278) #12
...
if.end81:                                         ; preds = %if.then78, %if.then76
  %Scan.4289 = phi ptr [ %Scan.4289.pre, %if.then78 ], [ %Scan.3278, %if.then76 ]
...
for.cond83.loopexit:                              ; preds = %for.inc116, %for.body87
  ...
  br i1 %cmp.i247.not, label %if.end122, label %for.body87thread-pre-split, !llvm.loop !109
...
sort_Intersect.exit:                              ; preds = %if.then102, %if.end.i.i257, %for.end.i.i
  ...
  store ptr %Search.2286, ptr %call.i262, align 8
  br label %for.inc116

for.inc116:                                       ; preds = %for.body94, %land.lhs.true, %sort_Intersect.exit
  %Search.3 = phi ptr [ %Search.2286, %land.lhs.true ], [ %call.i262, %sort_Intersect.exit ], [ %Search.2286, %for.body94 ]
  %Scan2.0 = load ptr, ptr %Scan2.0287, align 8
  %cmp.i249.not = icmp eq ptr %Scan2.0, null
  br i1 %cmp.i249.not, label %for.cond83.loopexit, label %for.body94, !llvm.loop !111
...
if.end123:                                        ; preds = %for.body.i.us.i, %for.inc15.i.i, %sort_TheoryIncrementMark.exit.i.us.i, %if.end122
  ...
  br i1 %cmp.i232.not, label %while.end, label %while.body, !llvm.loop !112
...
for.cond.i.i.i.i:                                 ; preds = %if.then11.i.i, %for.cond.i.i.i.i
  ...
  br i1 %cmp.i20.not.i.i.i.i, label %for.end.i.i.i.i, label %for.cond.i.i.i.i, !llvm.loop !53
...
for.inc.i.i:                                      ; preds = %for.end.i.i.i.i, %if.then11.i.i, %land.lhs.true.i.i, %clause_LiteralAtom.exit.i.i, %for.body.i.i
  ...
  br i1 %cmp.not.not.i.i, label %for.body.i.i, label %sort_ComputeSortInternNoResidues.exit, !llvm.loop !113
...
while.body.i.i.i:                                 ; preds = %while.body.i.i.i.prol.loopexit, %while.body.i.i.i
  ...
  br i1 %cmp.i.i61.i.1, label %while.body.i.i.i, label %while.end.i.i.i, !llvm.loop !114
...
for.cond.i.i.i.i.i:                               ; preds = %if.then11.i.i.i, %for.cond.i.i.i.i.i
  ...
  br i1 %cmp.i20.not.i.i.i.i.i, label %for.end.i.i.i.i.i, label %for.cond.i.i.i.i.i, !llvm.loop !53
...
for.inc.i.i.i:                                    ; preds = %for.end.i.i.i.i.i, %if.then11.i.i.i, %land.lhs.true.i.i.i, %clause_LiteralAtom.exit.i.i.i, %for.body.i.i.i
  ...
  br i1 %cmp.not.not.i.i.i, label %for.body.i.i.i, label %sort_VarSort.exit.i.i, !llvm.loop !113
...
for.cond.i.i.i:                                   ; preds = %if.end.i.i.i, %for.cond.i.i.i
  ...
  br i1 %cmp.i20.not.i.i.i, label %for.end.i.i.i, label %for.cond.i.i.i, !llvm.loop !53
...
for.cond.i63.i.i:                                 ; preds = %if.end.i59.i.i, %for.cond.i63.i.i
  ...
  br i1 %cmp.i20.not.i62.i.i, label %for.end.i64.i.i, label %for.cond.i63.i.i, !llvm.loop !53
...
sort_DeleteOne.exit89.i.i:                        ; preds = %while.body.i.i87.i.i, %list_Delete.exit.i.i.i
  ...
  br i1 %cmp.i49.not.i.i, label %for.end.i.i, label %for.body.i65.i, !llvm.loop !115
...
for.cond.i96.i.i:                                 ; preds = %if.end.i92.i.i, %for.cond.i96.i.i
  ...
  br i1 %cmp.i20.not.i95.i.i, label %for.end.i97.i.i, label %for.cond.i96.i.i, !llvm.loop !53
...
for.cond.i.i82.i:                                 ; preds = %if.then27.critedge.i, %for.cond.i.i82.i
  ...
  br i1 %cmp.i20.not.i.i81.i, label %for.end.i.i83.i, label %for.cond.i.i82.i, !llvm.loop !53
...
if.end31.i:                                       ; preds = %for.body.i71.i, %sort_Intersect.exit.i, %sort_MatchNoResidues.exit.i, %if.then13.i, %for.body.i
  ...
  br i1 %cmp.i.not.i, label %while.body.i.i, label %for.body.i, !llvm.loop !116
...
if.end:                                           ; preds = %sort_ComputeSortInternNoResidues.exit, %while.body
  ...
  br i1 %cmp.i.not, label %while.end, label %while.body, !llvm.loop !117
...
for.inc:                                          ; preds = %for.body17, %clause_LiteralAtom.exit
  ...
  br i1 %exitcond.not, label %for.end, label %for.body17, !llvm.loop !118
...
for.inc38:                                        ; preds = %for.body, %land.lhs.true, %list_Delete.exit97
  ...
  br i1 %cmp, label %for.body, label %for.end40, !llvm.loop !119
...
for.body.us:                                      ; preds = %for.body.lr.ph, %for.body.us
  ...
  %cmp.i.not.us = icmp eq ptr %Scan1.0.val.us, null
  br i1 %cmp.i.not.us, label %for.end27, label %for.body.us, !llvm.loop !120
...
for.inc:                                          ; preds = %for.body12, %if.then
  ...
  br i1 %cmp.i44.not, label %for.cond8.for.inc25_crit_edge, label %for.body12, !llvm.loop !121
...
for.cond8.for.inc25_crit_edge:                    ; preds = %for.inc, %for.body
  ...
  %cmp.i.not = icmp eq ptr %Scan1.0.val, null
  br i1 %cmp.i.not, label %for.end27, label %for.body, !llvm.loop !120
...
if.end.i.us:                                      ; preds = %while.body.i.us
  ...
  br i1 %cmp.i.not.i.us, label %land.lhs.true12.critedge.us, label %while.body.i.us, !llvm.loop !100
...
for.inc.us:                                       ; preds = %while.body.i.us, %land.lhs.true12.critedge.us, %for.body6.us
  ...
  br i1 %cmp.i46.us.not, label %for.cond2.for.inc22_crit_edge.us, label %for.body6.us, !llvm.loop !122
...
for.cond2.for.inc22_crit_edge.us:                 ; preds = %for.inc.us, %for.inc.us.thread
  ...
  br i1 %cmp.i.not.us, label %for.end24, label %for.cond2.preheader.us, !llvm.loop !123
...
for.inc.i:                                        ; preds = %if.then5.i, %land.lhs.true.i, %symbol_IsPredicate.exit.i, %if.then.i, %for.body.i
  ...
  br i1 %cmp.i, label %for.body.i, label %sort_TheoryCreate.exit, !llvm.loop !21
...
for.inc.i.i:                                      ; preds = %clause_LiteralAtom.exit.i.i, %for.body20.i.i
  ...
  br i1 %exitcond.not.i.i, label %for.end.i.i, label %for.body20.i.i, !llvm.loop !124
...
for.inc42.i.i:                                    ; preds = %list_Delete.exit105.i.i, %for.body.i.i
  ...
  br i1 %cmp.i11.i, label %for.body.i.i, label %sort_ApproxHornClauses.exit.i, !llvm.loop !125
...
for.cond.i.i:                                     ; preds = %if.end.i.i, %for.cond.i.i
  ...
  %List1.addr.0.val17.i.i = load ptr, ptr %List1.addr.0.i.i, align 8
  %cmp.i20.not.i.i = icmp eq ptr %List1.addr.0.val17.i.i, null
  br i1 %cmp.i20.not.i.i, label %for.end.i13.i, label %for.cond.i.i, !llvm.loop !53
...
list_Nconc.exit.i:                                ; preds = %for.end.i13.i, %if.end.i.i, %sort_ApproxHornClauses.exit.i, %if.then.i.i, %land.lhs.true.i.i, %while.body.i
  ...
  br i1 %cmp.i.not.i38, label %sort_ApproxClauses.exit, label %while.body.i, !llvm.loop !126
...
for.body:                                         ; preds = %sort_ApproxClauses.exit, %for.body
  ...
  br i1 %cmp.i39.not, label %for.end, label %for.body, !llvm.loop !127
...
clause_LiteralAtom.exit.i:                        ; preds = %if.then.i.i49, %for.body.i48
  ...
  br i1 %exitcond.not.i, label %for.end.i, label %for.body.i48, !llvm.loop !128
...
for.end.i:                                        ; preds = %clause_LiteralAtom.exit.i, %while.body.i43
  ...
  br i1 %cmp.i.not.i53, label %while.cond11.preheader.i, label %while.body.i43, !llvm.loop !129
...
while.body15.i:                                   ; preds = %while.body15.i, %while.body15.lr.ph.i
  ...
  br i1 %cmp.i63.not.i, label %while.end19.i, label %while.body15.i, !llvm.loop !130
...
sort_DeleteOne.exit.i:                            ; preds = %while.body.i.i76.i, %if.end.i
  ...
  br i1 %cmp.i66.not.i, label %while.body.i.i, label %while.body25.i, !llvm.loop !131
...
for.inc:                                          ; preds = %for.body, %list_Delete.exit182
  ...
  br i1 %cmp.i169.not, label %for.body21, label %for.body, !llvm.loop !132
...
for.inc69:                                        ; preds = %for.body29, %sort_PairDelete.exit258
  ...
  br i1 %130, label %for.body29, label %for.inc71, !llvm.loop !133
...
for.inc71:                                        ; preds = %for.inc69, %for.body21
  ...
  br i1 %131, label %for.body21, label %for.end73, !llvm.loop !134
