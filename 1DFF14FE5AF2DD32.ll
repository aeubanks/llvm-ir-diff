...
while.body.preheader:                             ; preds = %if.then9
  ...
  br i1 %min.iters.check, label %while.body.preheader71, label %vector.scevcheck
...
vector.scevcheck:                                 ; preds = %while.body.preheader
  ...
  %16 = or i1 %11, %15
  br i1 %16, label %while.body.preheader71, label %vector.memcheck
...
vector.memcheck:                                  ; preds = %vector.scevcheck
  ...
  br i1 %diff.check, label %while.body.preheader71, label %vector.ph
...
vector.ph:                                        ; preds = %vector.memcheck
  ...
  %invariant.gep = getelementptr i8, ptr %add.ptr, i64 -16
  %invariant.gep72 = getelementptr i8, ptr %add.ptr11, i64 -16
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <16 x i8>, ptr %gep, align 1, !tbaa !48
  %gep73 = getelementptr i8, ptr %invariant.gep72, i64 %22
  store <16 x i8> %wide.load, ptr %gep73, align 1, !tbaa !48
  %index.next = add nuw i64 %index, 16
  %24 = icmp eq i64 %index.next, %n.vec
  br i1 %24, label %middle.block, label %vector.body, !llvm.loop !49

middle.block:                                     ; preds = %vector.body
  %cmp.n = icmp eq i64 %4, %n.vec
  br i1 %cmp.n, label %while.end, label %while.body.preheader71

while.body.preheader71:                           ; preds = %vector.memcheck, %vector.scevcheck, %while.body.preheader, %middle.block
...
while.body:                                       ; preds = %while.body.preheader71, %while.body
  %to.057 = phi ptr [ %incdec.ptr14, %while.body ], [ %to.057.ph, %while.body.preheader71 ]
  %from.056 = phi ptr [ %incdec.ptr, %while.body ], [ %from.056.ph, %while.body.preheader71 ]
  %incdec.ptr = getelementptr inbounds i8, ptr %from.056, i64 -1
  %25 = load i8, ptr %incdec.ptr, align 1, !tbaa !48
  %incdec.ptr14 = getelementptr inbounds i8, ptr %to.057, i64 -1
  store i8 %25, ptr %incdec.ptr14, align 1, !tbaa !48
