; ModuleID = '/usr/local/google/home/aeubanks/repos/test-suite/Bitcode/simd_ops/x86_tests/test_op_vpminsw_375.bc'
...
@str.11 = private constant [15 x i8] c"op_vpminsw_375\00", align 32
...
define i32 @__test_op(ptr noalias nocapture readnone %in_f32.buffer, ptr noalias nocapture readnone %in_f64.buffer, ptr noalias nocapture readnone %in_i8.buffer, ptr noalias nocapture readnone %in_u8.buffer, ptr noalias nocapture readonly %in_i16.buffer, ptr noalias nocapture readnone %in_u16.buffer, ptr noalias nocapture readnone %in_i32.buffer, ptr noalias nocapture readnone %in_u32.buffer, ptr noalias nocapture readnone %in_i64.buffer, ptr noalias nocapture readnone %in_u64.buffer, ptr noalias nocapture readonly %op_vpminsw_375.buffer) local_unnamed_addr #0 {
"produce op_vpminsw_375":
  %buf_extent168 = getelementptr inbounds %struct.buffer_t, ptr %op_vpminsw_375.buffer, i64 0, i32 2, i64 1
  %op_vpminsw_375.extent.1 = load i32, ptr %buf_extent168, align 4
  %buf_min176 = getelementptr inbounds %struct.buffer_t, ptr %op_vpminsw_375.buffer, i64 0, i32 4, i64 1
  %op_vpminsw_375.min.1 = load i32, ptr %buf_min176, align 4
  %0 = add nsw i32 %op_vpminsw_375.min.1, %op_vpminsw_375.extent.1
  %1 = icmp sgt i32 %op_vpminsw_375.extent.1, 0
  br i1 %1, label %"for op_vpminsw_375.s0.y.preheader", label %destructor_block, !prof !4

"for op_vpminsw_375.s0.y.preheader":              ; preds = %"produce op_vpminsw_375"
  ...
  %buf_min175 = getelementptr inbounds %struct.buffer_t, ptr %op_vpminsw_375.buffer, i64 0, i32 4, i64 0
  %op_vpminsw_375.min.0 = load i32, ptr %buf_min175, align 4
  %2 = sext i32 %op_vpminsw_375.min.0 to i64
  %buf_stride172 = getelementptr inbounds %struct.buffer_t, ptr %op_vpminsw_375.buffer, i64 0, i32 3, i64 1
  %op_vpminsw_375.stride.1 = load i32, ptr %buf_stride172, align 4
  %3 = sext i32 %op_vpminsw_375.stride.1 to i64
  %buf_host163 = getelementptr inbounds %struct.buffer_t, ptr %op_vpminsw_375.buffer, i64 0, i32 1
  %op_vpminsw_375.host = load ptr, ptr %buf_host163, align 8
  %4 = shl nsw i64 %2, 3
  %5 = sub nsw i64 96, %4
  %scevgep = getelementptr i8, ptr %op_vpminsw_375.host, i64 %5
  %6 = shl nsw i64 %3, 3
  %sunkaddr = ptrtoint ptr %in_i16.host to i64
  %a148 = load <16 x i16>, ptr %in_i16.host, align 32, !tbaa !5
  ...
  %7 = tail call <16 x i16> @llvm.smin.v16i16(<16 x i16> %b173, <16 x i16> %a148)
  ...
  %13 = tail call <16 x i16> @llvm.smin.v16i16(<16 x i16> %b173.1, <16 x i16> %b173)
  ...
  %a148.2 = load <16 x i16>, ptr %sunkaddr207.2, align 32, !tbaa !5
  ...
  %19 = tail call <16 x i16> @llvm.smin.v16i16(<16 x i16> %b173.2, <16 x i16> %a148.2)
  ...
  %a148.3 = load <16 x i16>, ptr %sunkaddr207.3, align 32, !tbaa !5
  ...
  %25 = tail call <16 x i16> @llvm.smin.v16i16(<16 x i16> %b173.3, <16 x i16> %a148.3)
  ...
  %a148.4 = load <16 x i16>, ptr %sunkaddr207.4, align 32, !tbaa !5
  ...
  %31 = tail call <16 x i16> @llvm.smin.v16i16(<16 x i16> %b173.4, <16 x i16> %a148.4)
  ...
  %a148.5 = load <16 x i16>, ptr %sunkaddr207.5, align 32, !tbaa !5
  ...
  %37 = tail call <16 x i16> @llvm.smin.v16i16(<16 x i16> %b173.5, <16 x i16> %a148.5)
  ...
  %a148.6 = load <16 x i16>, ptr %sunkaddr207.6, align 32, !tbaa !5
  ...
  %43 = tail call <16 x i16> @llvm.smin.v16i16(<16 x i16> %b173.6, <16 x i16> %a148.6)
  ...
  %a148.7 = load <16 x i16>, ptr %sunkaddr207.7, align 32, !tbaa !5
  ...
  %49 = tail call <16 x i16> @llvm.smin.v16i16(<16 x i16> %b173.7, <16 x i16> %a148.7)
  ...
  %a148.8 = load <16 x i16>, ptr %sunkaddr207.8, align 32, !tbaa !5
  ...
  %55 = tail call <16 x i16> @llvm.smin.v16i16(<16 x i16> %b173.8, <16 x i16> %a148.8)
  ...
  br label %"for op_vpminsw_375.s0.x.x.preheader"

"for op_vpminsw_375.s0.x.x.preheader":            ; preds = %"for op_vpminsw_375.s0.x.x.preheader", %"for op_vpminsw_375.s0.y.preheader"
  %lsr.iv180 = phi ptr [ %scevgep, %"for op_vpminsw_375.s0.y.preheader" ], [ %scevgep182, %"for op_vpminsw_375.s0.x.x.preheader" ]
  %op_vpminsw_375.s0.y = phi i32 [ %op_vpminsw_375.min.1, %"for op_vpminsw_375.s0.y.preheader" ], [ %103, %"for op_vpminsw_375.s0.x.x.preheader" ]
  ...
  %a148.9 = load <16 x i16>, ptr %sunkaddr207.9, align 32, !tbaa !5
  %b173.9 = load <16 x i16>, ptr %sunkaddr211.9, align 32, !tbaa !5
  %61 = tail call <16 x i16> @llvm.smin.v16i16(<16 x i16> %b173.9, <16 x i16> %a148.9)
  ...
  %a148.10 = load <16 x i16>, ptr %sunkaddr207.10, align 32, !tbaa !5
  %b173.10 = load <16 x i16>, ptr %sunkaddr211.10, align 32, !tbaa !5
  %67 = tail call <16 x i16> @llvm.smin.v16i16(<16 x i16> %b173.10, <16 x i16> %a148.10)
  ...
  %a148.11 = load <16 x i16>, ptr %sunkaddr207.11, align 32, !tbaa !5
  %b173.11 = load <16 x i16>, ptr %sunkaddr211.11, align 32, !tbaa !5
  %73 = tail call <16 x i16> @llvm.smin.v16i16(<16 x i16> %b173.11, <16 x i16> %a148.11)
  ...
  %a148.12 = load <16 x i16>, ptr %sunkaddr207.12, align 32, !tbaa !5
  %b173.12 = load <16 x i16>, ptr %sunkaddr211.12, align 32, !tbaa !5
  %79 = tail call <16 x i16> @llvm.smin.v16i16(<16 x i16> %b173.12, <16 x i16> %a148.12)
  ...
  %a148.13 = load <16 x i16>, ptr %sunkaddr207.13, align 32, !tbaa !5
  %b173.13 = load <16 x i16>, ptr %sunkaddr211.13, align 32, !tbaa !5
  %85 = tail call <16 x i16> @llvm.smin.v16i16(<16 x i16> %b173.13, <16 x i16> %a148.13)
  ...
  %a148.14 = load <16 x i16>, ptr %sunkaddr207.14, align 32, !tbaa !5
  %b173.14 = load <16 x i16>, ptr %sunkaddr211.14, align 32, !tbaa !5
  %91 = tail call <16 x i16> @llvm.smin.v16i16(<16 x i16> %b173.14, <16 x i16> %a148.14)
  ...
  %a148.15 = load <16 x i16>, ptr %sunkaddr207.15, align 32, !tbaa !5
  %b173.15 = load <16 x i16>, ptr %sunkaddr211.15, align 32, !tbaa !5
  %97 = tail call <16 x i16> @llvm.smin.v16i16(<16 x i16> %b173.15, <16 x i16> %a148.15)
  ...
  %103 = add nsw i32 %op_vpminsw_375.s0.y, 1
  %scevgep182 = getelementptr i1, ptr %lsr.iv180, i64 %6
  %.not2 = icmp eq i32 %103, %0
  br i1 %.not2, label %destructor_block, label %"for op_vpminsw_375.s0.x.x.preheader"

destructor_block:                                 ; preds = %"for op_vpminsw_375.s0.x.x.preheader", %"produce op_vpminsw_375"
  ret i32 0
}

; Function Attrs: nofree nosync nounwind memory(readwrite, inaccessiblemem: none)
define i32 @test_op(ptr noalias nocapture readnone %in_f32.buffer, ptr noalias nocapture readnone %in_f64.buffer, ptr noalias nocapture readnone %in_i8.buffer, ptr noalias nocapture readnone %in_u8.buffer, ptr noalias nocapture readonly %in_i16.buffer, ptr noalias nocapture readnone %in_u16.buffer, ptr noalias nocapture readnone %in_i32.buffer, ptr noalias nocapture readnone %in_u32.buffer, ptr noalias nocapture readnone %in_i64.buffer, ptr noalias nocapture readnone %in_u64.buffer, ptr noalias nocapture readonly %op_vpminsw_375.buffer) local_unnamed_addr #1 {
destructor_block:
  %"__test_op_result$23" = tail call i32 @__test_op(ptr poison, ptr poison, ptr poison, ptr poison, ptr %in_i16.buffer, ptr poison, ptr poison, ptr poison, ptr poison, ptr poison, ptr %op_vpminsw_375.buffer) #4
  ret i32 0
}
