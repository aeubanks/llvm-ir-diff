...
invoke.cont2:                                     ; preds = %if.end
  br i1 %call3, label %if.end5, label %cleanup101
...
if.end5:                                          ; preds = %invoke.cont2
  %3 = load i64, ptr %length, align 8, !tbaa !18
  %cmp = icmp ugt i64 %3, 2147483648
  br i1 %cmp, label %cleanup101, label %if.end7
...
if.end.i.i:                                       ; preds = %_ZN11CStringBaseIcEC2Ev.exit
  ...
  %call.i.i117 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %conv.i.i) #11
          to label %delete.notnull.i.i unwind label %ehcleanup96.thread
...
delete.notnull.i.i:                               ; preds = %if.end.i.i
  ...
  %5 = load i32, ptr %_length.i.i, align 8, !tbaa !20
  ...
  %.pre = load i64, ptr %length, align 8, !tbaa !18
  %.pre229 = trunc i64 %.pre to i32
  br label %_ZN11CStringBaseIcE9GetBufferEi.exit

_ZN11CStringBaseIcE9GetBufferEi.exit:             ; preds = %_ZN11CStringBaseIcEC2Ev.exit, %delete.notnull.i.i
  %conv13.pre-phi = phi i32 [ %conv, %_ZN11CStringBaseIcEC2Ev.exit ], [ %.pre229, %delete.notnull.i.i ]
  %6 = phi ptr [ %call.i.i115, %_ZN11CStringBaseIcEC2Ev.exit ], [ %call.i.i117, %delete.notnull.i.i ]
...
if.end18:                                         ; preds = %invoke.cont15
  %10 = load i64, ptr %length, align 8, !tbaa !18
...
_ZN11CStringBaseIcE13ReleaseBufferEv.exit:        ; preds = %for.cond.i.i
  ...
  store i32 %13, ptr %_length.i.i121, align 8, !tbaa !20
...
_ZN11CStringBaseIwEC2Ev.exit149:                  ; preds = %if.end49
  ...
  %cmp55225 = icmp sgt i32 %35, 0
  br i1 %cmp55225, label %for.body.lr.ph, label %for.cond.cleanup
...
call.i.i.i.noexc:                                 ; preds = %if.end.i.i.i167
  %call.i.i.i168233 = ptrtoint ptr %call.i.i.i168 to i64
...
for.body.lr.ph.i.i.i:                             ; preds = %for.cond.preheader.i.i.i
  ...
  %60 = sub i64 %call.i.i.i168233, %40
  %diff.check = icmp ult i64 %60, 32
  %or.cond235 = select i1 %min.iters.check, i1 true, i1 %diff.check
  br i1 %or.cond235, label %for.body.i.i.i.preheader, label %vector.ph
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load234 = load <4 x i32>, ptr %62, align 4, !tbaa !25
  ...
  store <4 x i32> %wide.load234, ptr %64, align 4, !tbaa !25
...
ehcleanup96:                                      ; preds = %lpad14, %ehcleanup92
  ...
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %processed) #10
  %.pre228 = load ptr, ptr %s, align 8, !tbaa !13
  %isnull.i212 = icmp eq ptr %.pre228, null
  br i1 %isnull.i212, label %ehcleanup100, label %delete.notnull.i213

delete.notnull.i213:                              ; preds = %ehcleanup96.thread, %ehcleanup96
  %eh.lpad-body.pn.pn.pn.pn.pn.pn232 = phi { ptr, i32 } [ %8, %ehcleanup96.thread ], [ %eh.lpad-body.pn.pn.pn.pn.pn, %ehcleanup96 ]
  %97 = phi ptr [ %call.i.i115, %ehcleanup96.thread ], [ %.pre228, %ehcleanup96 ]
  call void @_ZdaPv(ptr noundef nonnull %97) #12
  br label %ehcleanup100

ehcleanup100:                                     ; preds = %delete.notnull.i213, %ehcleanup96, %lpad8
  %eh.lpad-body.pn.pn.pn.pn.pn.pn.pn = phi { ptr, i32 } [ %7, %lpad8 ], [ %eh.lpad-body.pn.pn.pn.pn.pn, %ehcleanup96 ], [ %eh.lpad-body.pn.pn.pn.pn.pn.pn232, %delete.notnull.i213 ]
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %s) #10
  br label %ehcleanup102

cleanup101:                                       ; preds = %if.end5, %invoke.cont2, %_ZN11CStringBaseIcED2Ev.exit
  %retval.2 = phi i1 [ %retval.1, %_ZN11CStringBaseIcED2Ev.exit ], [ false, %invoke.cont2 ], [ false, %if.end5 ]
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %length) #10
  br label %cleanup103

ehcleanup102:                                     ; preds = %ehcleanup100, %lpad1
  %eh.lpad-body.pn.pn.pn.pn.pn.pn.pn.pn = phi { ptr, i32 } [ %eh.lpad-body.pn.pn.pn.pn.pn.pn.pn, %ehcleanup100 ], [ %2, %lpad1 ]
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %length) #10
  br label %ehcleanup104
...
vector.memcheck:                                  ; preds = %for.body.lr.ph.i
  ...
  %ref.tmp.sroa.0.036 = ptrtoint ptr %ref.tmp.sroa.0.0 to i64
  %8 = add nuw i64 %7, 4
  %9 = sub i64 %ref.tmp.sroa.0.036, %8
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load37 = load <4 x i32>, ptr %12, align 4, !tbaa !25, !noalias !50
  ...
  store <4 x i32> %wide.load37, ptr %14, align 4, !tbaa !25, !noalias !50
  %index.next = add nuw i64 %index, 8
...
common.resume:                                    ; preds = %_ZN11CStringBaseIwED2Ev.exit32, %lpad.i
  %ref.tmp.sroa.0.1.sink = phi ptr [ %ref.tmp.sroa.0.1, %_ZN11CStringBaseIwED2Ev.exit32 ], [ %call.i.i32.i, %lpad.i ]
  %common.resume.op = phi { ptr, i32 } [ %35, %_ZN11CStringBaseIwED2Ev.exit32 ], [ %21, %lpad.i ]
