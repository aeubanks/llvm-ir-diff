...
if.end7:                                          ; preds = %invoke.cont2
  ...
  %call.i.i115 = invoke noalias noundef nonnull dereferenceable(4) ptr @_Znam(i64 noundef 4) #11
          to label %_ZN11CStringBaseIcEC2Ev.exit unwind label %lpad8

_ZN11CStringBaseIcEC2Ev.exit:                     ; preds = %if.end7
  %_capacity.i = getelementptr inbounds %class.CStringBase, ptr %s, i64 0, i32 2
  store ptr %call.i.i115, ptr %s, align 8, !tbaa !13
  store i8 0, ptr %call.i.i115, align 1, !tbaa !14
  store i32 4, ptr %_capacity.i, align 4, !tbaa !15
  %conv = trunc i64 %2 to i32
  %cmp.not.i = icmp slt i32 %conv, 3
  br i1 %cmp.not.i, label %_ZN11CStringBaseIcE9GetBufferEi.exit, label %if.end.i.i

if.end.i.i:                                       ; preds = %_ZN11CStringBaseIcEC2Ev.exit
  %add.i.i = add nuw nsw i32 %conv, 2
  %conv.i.i = zext i32 %add.i.i to i64
  %call.i.i117 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %conv.i.i) #11
...
if.end9.i.i:                                      ; preds = %if.end.i.i
  ...
  call void @_ZdaPv(ptr noundef nonnull %call.i.i115) #12
  store ptr %call.i.i117, ptr %s, align 8, !tbaa !13
  %5 = load i32, ptr %_length.i.i, align 8, !tbaa !18
  %idxprom13.i.i = sext i32 %5 to i64
  %arrayidx14.i.i = getelementptr inbounds i8, ptr %call.i.i117, i64 %idxprom13.i.i
  ...
  %.pre230 = trunc i64 %.pre to i32
  br label %_ZN11CStringBaseIcE9GetBufferEi.exit

_ZN11CStringBaseIcE9GetBufferEi.exit:             ; preds = %_ZN11CStringBaseIcEC2Ev.exit, %if.end9.i.i
  %conv13.pre-phi = phi i32 [ %conv, %_ZN11CStringBaseIcEC2Ev.exit ], [ %.pre230, %if.end9.i.i ]
  %6 = phi ptr [ %call.i.i115, %_ZN11CStringBaseIcEC2Ev.exit ], [ %call.i.i117, %if.end9.i.i ]
...
invoke.cont15:                                    ; preds = %_ZN11CStringBaseIcE9GetBufferEi.exit
...
ehcleanup96.thread:                               ; preds = %if.end.i.i
  %8 = landingpad { ptr, i32 }
          cleanup
  br label %delete.notnull.i213

lpad14:                                           ; preds = %_ZN11CStringBaseIcE13ReleaseBufferEv.exit, %_ZN11CStringBaseIcE9GetBufferEi.exit
...
for.cond.i.i:                                     ; preds = %for.cond.i.i, %if.end18
  %indvars.iv.i.i118 = phi i64 [ %indvars.iv.next.i.i120, %for.cond.i.i ], [ 0, %if.end18 ]
  %arrayidx.i.i119 = getelementptr inbounds i8, ptr %11, i64 %indvars.iv.i.i118
  %12 = load i8, ptr %arrayidx.i.i119, align 1, !tbaa !14
  %cmp.not.i.i = icmp eq i8 %12, 0
  %indvars.iv.next.i.i120 = add nuw i64 %indvars.iv.i.i118, 1
  br i1 %cmp.not.i.i, label %_ZN11CStringBaseIcE13ReleaseBufferEv.exit, label %for.cond.i.i, !llvm.loop !21

_ZN11CStringBaseIcE13ReleaseBufferEv.exit:        ; preds = %for.cond.i.i
  %13 = trunc i64 %indvars.iv.i.i118 to i32
  %sext.i = shl i64 %indvars.iv.i.i118, 32
  ...
  %_length.i.i121 = getelementptr inbounds %class.CStringBase, ptr %s, i64 0, i32 1
  store i32 %13, ptr %_length.i.i121, align 8, !tbaa !18
...
invoke.cont21:                                    ; preds = %_ZN11CStringBaseIcE13ReleaseBufferEv.exit
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %u) #10
  %14 = getelementptr inbounds i8, ptr %u, i64 8
  store i64 0, ptr %14, align 8
  %call.i.i124 = invoke noalias noundef nonnull dereferenceable(16) ptr @_Znam(i64 noundef 16) #11
          to label %_ZN11CStringBaseIwEC2Ev.exit unwind label %lpad23

_ZN11CStringBaseIwEC2Ev.exit:                     ; preds = %invoke.cont21
  %_capacity.i122 = getelementptr inbounds %class.CStringBase.0, ptr %u, i64 0, i32 2
  store ptr %call.i.i124, ptr %u, align 8, !tbaa !23
  store i32 0, ptr %call.i.i124, align 4, !tbaa !25
  store i32 4, ptr %_capacity.i122, align 4, !tbaa !27
  %cmp25 = icmp eq i32 %codePage, 65001
  br i1 %cmp25, label %if.then26, label %if.else

if.then26:                                        ; preds = %_ZN11CStringBaseIwEC2Ev.exit
...
invoke.cont33:                                    ; preds = %if.else
  %_length.i.i125 = getelementptr inbounds %class.CStringBase.0, ptr %u, i64 0, i32 1
  store i32 0, ptr %_length.i.i125, align 8, !tbaa !28
  ...
  %add.i.i126 = add nsw i32 %18, 1
  %19 = load i32, ptr %_capacity.i122, align 4, !tbaa !27
  %cmp.i.i127 = icmp eq i32 %add.i.i126, %19
  br i1 %cmp.i.i127, label %_ZN11CStringBaseIwE11SetCapacityEi.exit.i, label %if.end.i.i130

if.end.i.i130:                                    ; preds = %invoke.cont33
  %conv.i.i128 = zext i32 %add.i.i126 to i64
  %20 = icmp slt i32 %18, -1
  %21 = shl nuw nsw i64 %conv.i.i128, 2
  %22 = select i1 %20, i64 -1, i64 %21
  %call.i.i137 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %22) #11
          to label %call.i.i.noexc136 unwind label %lpad34

call.i.i.noexc136:                                ; preds = %if.end.i.i130
  %cmp3.i.i129 = icmp sgt i32 %19, 0
  br i1 %cmp3.i.i129, label %delete.notnull.i.i131, label %if.end9.i.i134

delete.notnull.i.i131:                            ; preds = %call.i.i.noexc136
  call void @_ZdaPv(ptr noundef nonnull %17) #12
  %.pre.i = load i32, ptr %_length.i.i125, align 8, !tbaa !28
  %23 = sext i32 %.pre.i to i64
  br label %if.end9.i.i134

if.end9.i.i134:                                   ; preds = %delete.notnull.i.i131, %call.i.i.noexc136
  %idxprom13.i.i132 = phi i64 [ %23, %delete.notnull.i.i131 ], [ 0, %call.i.i.noexc136 ]
  store ptr %call.i.i137, ptr %u, align 8, !tbaa !23
  %arrayidx14.i.i133 = getelementptr inbounds i32, ptr %call.i.i137, i64 %idxprom13.i.i132
  store i32 0, ptr %arrayidx14.i.i133, align 4, !tbaa !25
  store i32 %add.i.i126, ptr %_capacity.i122, align 4, !tbaa !27
  br label %_ZN11CStringBaseIwE11SetCapacityEi.exit.i

_ZN11CStringBaseIwE11SetCapacityEi.exit.i:        ; preds = %if.end9.i.i134, %invoke.cont33
  %24 = phi ptr [ %17, %invoke.cont33 ], [ %call.i.i137, %if.end9.i.i134 ]
...
while.cond.i.i:                                   ; preds = %while.cond.i.i, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i
  ...
  %cmp.not.i.i135 = icmp eq i32 %26, 0
  br i1 %cmp.not.i.i135, label %_ZN11CStringBaseIwEaSERKS0_.exit, label %while.cond.i.i, !llvm.loop !29

_ZN11CStringBaseIwEaSERKS0_.exit:                 ; preds = %while.cond.i.i
  %27 = load i32, ptr %_length.i, align 8, !tbaa !28
  store i32 %27, ptr %_length.i.i125, align 8, !tbaa !28
...
lpad34:                                           ; preds = %if.end.i.i130
  %29 = landingpad { ptr, i32 }
          cleanup
  %30 = load ptr, ptr %ref.tmp, align 8, !tbaa !23
  %isnull.i138 = icmp eq ptr %30, null
  br i1 %isnull.i138, label %ehcleanup, label %delete.notnull.i139

delete.notnull.i139:                              ; preds = %lpad34
  call void @_ZdaPv(ptr noundef nonnull %30) #12
  br label %ehcleanup

ehcleanup:                                        ; preds = %delete.notnull.i139, %lpad34, %lpad32
  %.pn = phi { ptr, i32 } [ %28, %lpad32 ], [ %29, %lpad34 ], [ %29, %delete.notnull.i139 ]
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %ref.tmp) #10
  br label %ehcleanup90

if.end37:                                         ; preds = %invoke.cont28, %_ZN11CStringBaseIwED2Ev.exit
  %_length.i141 = getelementptr inbounds %class.CStringBase.0, ptr %u, i64 0, i32 1
  %31 = load i32, ptr %_length.i141, align 8, !tbaa !28
...
if.then40:                                        ; preds = %if.end37
  ...
  %or.cond225 = and i1 %cmp3.i, %cmp44
  br i1 %or.cond225, label %if.then4.i, label %if.end49

if.then4.i:                                       ; preds = %if.then40
  %add.ptr4.i.i = getelementptr inbounds i32, ptr %32, i64 1
  %conv.i.i145 = zext i32 %31 to i64
  %mul.i.i = shl nuw nsw i64 %conv.i.i145, 2
  call void @llvm.memmove.p0.p0.i64(ptr nonnull align 4 %32, ptr nonnull align 4 %add.ptr4.i.i, i64 %mul.i.i, i1 false)
  %34 = load i32, ptr %_length.i141, align 8, !tbaa !28
  %sub7.i = add nsw i32 %34, -1
  store i32 %sub7.i, ptr %_length.i141, align 8, !tbaa !28
  br label %if.end49
...
if.end49:                                         ; preds = %if.then4.i, %if.then40, %if.end37
  ...
  %call.i.i148 = invoke noalias noundef nonnull dereferenceable(16) ptr @_Znam(i64 noundef 16) #11
          to label %_ZN11CStringBaseIwEC2Ev.exit149 unwind label %lpad50

_ZN11CStringBaseIwEC2Ev.exit149:                  ; preds = %if.end49
  %_capacity.i146 = getelementptr inbounds %class.CStringBase.0, ptr %t, i64 0, i32 2
  store ptr %call.i.i148, ptr %t, align 8, !tbaa !23
  store i32 0, ptr %call.i.i148, align 4, !tbaa !25
  store i32 4, ptr %_capacity.i146, align 4, !tbaa !27
  %cmp55226 = icmp sgt i32 %35, 0
  br i1 %cmp55226, label %for.body.lr.ph, label %for.cond.cleanup

for.body.lr.ph:                                   ; preds = %_ZN11CStringBaseIwEC2Ev.exit149
  %_length.i151 = getelementptr inbounds %class.CStringBase.0, ptr %t, i64 0, i32 1
...
for.cond.cleanup:                                 ; preds = %if.end76, %_ZN11CStringBaseIwEC2Ev.exit149
...
for.body:                                         ; preds = %for.body.lr.ph, %if.end76
  %38 = phi ptr [ %call.i.i148, %for.body.lr.ph ], [ %77, %if.end76 ]
...
invoke.cont65:                                    ; preds = %invoke.cont64
  %43 = load i32, ptr %_length.i151, align 8, !tbaa !28
  %cmp.i152 = icmp eq i32 %43, 0
  br i1 %cmp.i152, label %if.end71, label %if.then68

if.then68:                                        ; preds = %invoke.cont65
  %call.i157 = invoke noalias noundef nonnull dereferenceable(16) ptr @_Znwm(i64 noundef 16) #11
          to label %call.i.noexc unwind label %lpad56

call.i.noexc:                                     ; preds = %if.then68
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %call.i157, i8 0, i64 16, i1 false)
...
call.i.i.noexc.i:                                 ; preds = %if.end.i.i.i
  %_capacity.i.i153 = getelementptr inbounds %class.CStringBase.0, ptr %call.i157, i64 0, i32 2
  store ptr %call.i.i4.i, ptr %call.i157, align 8, !tbaa !23
  store i32 0, ptr %call.i.i4.i, align 4, !tbaa !25
  store i32 %add.i.i.i, ptr %_capacity.i.i153, align 4, !tbaa !27
...
_ZN11CStringBaseIwEC2ERKS0_.exit.i:               ; preds = %while.cond.i.i.i
  %_length.i.i154 = getelementptr inbounds %class.CStringBase.0, ptr %call.i157, i64 0, i32 1
  store i32 %43, ptr %_length.i.i154, align 8, !tbaa !28
...
lpad.i:                                           ; preds = %if.end.i.i.i
  %50 = landingpad { ptr, i32 }
          cleanup
  call void @_ZdlPv(ptr noundef nonnull %call.i157) #12
...
_ZN13CObjectVectorI11CStringBaseIwEE3AddERKS1_.exit: ; preds = %_ZN11CStringBaseIwEC2ERKS0_.exit.i
  ...
  %idxprom.i.i155 = sext i32 %52 to i64
  %arrayidx.i.i156 = getelementptr inbounds ptr, ptr %51, i64 %idxprom.i.i155
  store ptr %call.i157, ptr %arrayidx.i.i156, align 8, !tbaa !33
  %inc.i.i = add nsw i32 %52, 1
  store i32 %inc.i.i, ptr %_size.i.i, align 4, !tbaa !32
  br label %if.end71

lpad56:                                           ; preds = %if.end.i.i.i167, %_ZN11CStringBaseIwEC2ERKS0_.exit.i, %if.then68, %invoke.cont64, %if.then63
  %53 = landingpad { ptr, i32 }
          cleanup
  br label %ehcleanup88

if.end71:                                         ; preds = %_ZN13CObjectVectorI11CStringBaseIwEE3AddERKS1_.exit, %invoke.cont65
  store i32 0, ptr %_length.i151, align 8, !tbaa !28
  %54 = load ptr, ptr %t, align 8, !tbaa !23
  br label %if.end76

if.else73:                                        ; preds = %for.body
  %55 = load i32, ptr %_capacity.i146, align 4, !tbaa !27
  %56 = xor i32 %39, -1
  %sub2.i.i = add i32 %55, %56
  %cmp.not.i.i161 = icmp slt i32 %sub2.i.i, 1
  br i1 %cmp.not.i.i161, label %if.end.i.i165, label %_ZN11CStringBaseIwEpLEw.exit

if.end.i.i165:                                    ; preds = %if.else73
  ...
  %add.i.i162 = add nsw i32 %delta.0.i.i, %sub2.i.i
  %cmp13.i.i = icmp slt i32 %add.i.i162, 1
  ...
  %cmp.i.i.i164 = icmp eq i32 %add.i.i.i163, %55
  br i1 %cmp.i.i.i164, label %_ZN11CStringBaseIwEpLEw.exit, label %if.end.i.i.i167

if.end.i.i.i167:                                  ; preds = %if.end.i.i165
  %conv.i.i.i166 = zext i32 %add.i.i.i163 to i64
  %57 = icmp slt i32 %add18.i.i, -1
  %58 = shl nuw nsw i64 %conv.i.i.i166, 2
  %59 = select i1 %57, i64 -1, i64 %58
  %call.i.i.i168 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %59) #11
          to label %call.i.i.i.noexc unwind label %lpad56

call.i.i.i.noexc:                                 ; preds = %if.end.i.i.i167
  %call.i.i.i168234 = ptrtoint ptr %call.i.i.i168 to i64
...
for.body.lr.ph.i.i.i:                             ; preds = %for.cond.preheader.i.i.i
  ...
  %60 = sub i64 %call.i.i.i168234, %40
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load235 = load <4 x i32>, ptr %62, align 4, !tbaa !25
  %63 = getelementptr inbounds i32, ptr %call.i.i.i168, i64 %index
  store <4 x i32> %wide.load, ptr %63, align 4, !tbaa !25
  %64 = getelementptr inbounds i32, ptr %63, i64 4
  store <4 x i32> %wide.load235, ptr %64, align 4, !tbaa !25
...
for.body.i.i.i.prol:                              ; preds = %for.body.i.i.i.preheader, %for.body.i.i.i.prol
  ...
  %arrayidx7.i.i.i.prol = getelementptr inbounds i32, ptr %call.i.i.i168, i64 %indvars.iv.i.i.i.prol
...
for.body.i.i.i:                                   ; preds = %for.body.i.i.i.prol.loopexit, %for.body.i.i.i
  ...
  %arrayidx7.i.i.i = getelementptr inbounds i32, ptr %call.i.i.i168, i64 %indvars.iv.i.i.i
  ...
  %arrayidx7.i.i.i.1 = getelementptr inbounds i32, ptr %call.i.i.i168, i64 %indvars.iv.next.i.i.i
  ...
  %arrayidx7.i.i.i.2 = getelementptr inbounds i32, ptr %call.i.i.i168, i64 %indvars.iv.next.i.i.i.1
  ...
  %arrayidx7.i.i.i.3 = getelementptr inbounds i32, ptr %call.i.i.i168, i64 %indvars.iv.next.i.i.i.2
...
delete.notnull.i.i.i:                             ; preds = %for.body.i.i.i.prol.loopexit, %for.body.i.i.i, %middle.block, %for.cond.preheader.i.i.i
  ...
  %.pre.i.i = load i32, ptr %_length.i151, align 8, !tbaa !28
  br label %if.end9.i.i.i

if.end9.i.i.i:                                    ; preds = %delete.notnull.i.i.i, %call.i.i.i.noexc
  %74 = phi i32 [ %.pre.i.i, %delete.notnull.i.i.i ], [ %39, %call.i.i.i.noexc ]
  store ptr %call.i.i.i168, ptr %t, align 8, !tbaa !23
  %idxprom13.i.i.i = sext i32 %74 to i64
  %arrayidx14.i.i.i = getelementptr inbounds i32, ptr %call.i.i.i168, i64 %idxprom13.i.i.i
  store i32 0, ptr %arrayidx14.i.i.i, align 4, !tbaa !25
  store i32 %add.i.i.i163, ptr %_capacity.i146, align 4, !tbaa !27
  br label %_ZN11CStringBaseIwEpLEw.exit

_ZN11CStringBaseIwEpLEw.exit:                     ; preds = %if.else73, %if.end.i.i165, %if.end9.i.i.i
  %75 = phi ptr [ %38, %if.else73 ], [ %38, %if.end.i.i165 ], [ %call.i.i.i168, %if.end9.i.i.i ]
  %76 = phi i32 [ %39, %if.else73 ], [ %39, %if.end.i.i165 ], [ %74, %if.end9.i.i.i ]
  ...
  store i32 %inc.i, ptr %_length.i151, align 8, !tbaa !28
...
if.end76:                                         ; preds = %_ZN11CStringBaseIwEpLEw.exit, %if.end71
  ...
  %79 = load i32, ptr %_length.i141, align 8, !tbaa !28
...
invoke.cont81:                                    ; preds = %invoke.cont80
  %_length.i169 = getelementptr inbounds %class.CStringBase.0, ptr %t, i64 0, i32 1
  %81 = load i32, ptr %_length.i169, align 8, !tbaa !28
  %cmp.i170 = icmp eq i32 %81, 0
  br i1 %cmp.i170, label %if.end87, label %if.then84

if.then84:                                        ; preds = %invoke.cont81
  %call.i195 = invoke noalias noundef nonnull dereferenceable(16) ptr @_Znwm(i64 noundef 16) #11
          to label %call.i.noexc194 unwind label %lpad79

call.i.noexc194:                                  ; preds = %if.then84
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %call.i195, i8 0, i64 16, i1 false)
  %add.i.i.i172 = add nsw i32 %81, 1
  %cmp.i.i.i173 = icmp eq i32 %add.i.i.i172, 0
  br i1 %cmp.i.i.i173, label %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i179, label %if.end.i.i.i176

if.end.i.i.i176:                                  ; preds = %call.i.noexc194
  %conv.i.i.i174 = zext i32 %add.i.i.i172 to i64
  %82 = icmp slt i32 %81, -1
  %83 = shl nuw nsw i64 %conv.i.i.i174, 2
  %84 = select i1 %82, i64 -1, i64 %83
  %call.i.i4.i175 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %84) #11
          to label %call.i.i.noexc.i178 unwind label %lpad.i193

call.i.i.noexc.i178:                              ; preds = %if.end.i.i.i176
  %_capacity.i.i177 = getelementptr inbounds %class.CStringBase.0, ptr %call.i195, i64 0, i32 2
  store ptr %call.i.i4.i175, ptr %call.i195, align 8, !tbaa !23
  store i32 0, ptr %call.i.i4.i175, align 4, !tbaa !25
  store i32 %add.i.i.i172, ptr %_capacity.i.i177, align 4, !tbaa !27
  br label %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i179

_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i179:   ; preds = %call.i.i.noexc.i178, %call.i.noexc194
  %85 = phi ptr [ null, %call.i.noexc194 ], [ %call.i.i4.i175, %call.i.i.noexc.i178 ]
  %86 = load ptr, ptr %t, align 8, !tbaa !23
  br label %while.cond.i.i.i185

while.cond.i.i.i185:                              ; preds = %while.cond.i.i.i185, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i179
  %src.addr.0.i.i.i180 = phi ptr [ %86, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i179 ], [ %incdec.ptr.i.i.i182, %while.cond.i.i.i185 ]
  %dest.addr.0.i.i.i181 = phi ptr [ %85, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i179 ], [ %incdec.ptr1.i.i.i183, %while.cond.i.i.i185 ]
  %incdec.ptr.i.i.i182 = getelementptr inbounds i32, ptr %src.addr.0.i.i.i180, i64 1
  %87 = load i32, ptr %src.addr.0.i.i.i180, align 4, !tbaa !25
  %incdec.ptr1.i.i.i183 = getelementptr inbounds i32, ptr %dest.addr.0.i.i.i181, i64 1
  store i32 %87, ptr %dest.addr.0.i.i.i181, align 4, !tbaa !25
  %cmp.not.i.i.i184 = icmp eq i32 %87, 0
  br i1 %cmp.not.i.i.i184, label %_ZN11CStringBaseIwEC2ERKS0_.exit.i192, label %while.cond.i.i.i185, !llvm.loop !29

_ZN11CStringBaseIwEC2ERKS0_.exit.i192:            ; preds = %while.cond.i.i.i185
  %_length.i.i186 = getelementptr inbounds %class.CStringBase.0, ptr %call.i195, i64 0, i32 1
  store i32 %81, ptr %_length.i.i186, align 8, !tbaa !28
  invoke void @_ZN17CBaseRecordVector18ReserveOnePositionEv(ptr noundef nonnull align 8 dereferenceable(32) %resultStrings)
          to label %_ZN13CObjectVectorI11CStringBaseIwEE3AddERKS1_.exit197 unwind label %lpad79

lpad.i193:                                        ; preds = %if.end.i.i.i176
  %88 = landingpad { ptr, i32 }
          cleanup
  call void @_ZdlPv(ptr noundef nonnull %call.i195) #12
  br label %ehcleanup88

_ZN13CObjectVectorI11CStringBaseIwEE3AddERKS1_.exit197: ; preds = %_ZN11CStringBaseIwEC2ERKS0_.exit.i192
  %_items.i.i187 = getelementptr inbounds %class.CBaseRecordVector, ptr %resultStrings, i64 0, i32 3
  %89 = load ptr, ptr %_items.i.i187, align 8, !tbaa !30
  %_size.i.i188 = getelementptr inbounds %class.CBaseRecordVector, ptr %resultStrings, i64 0, i32 2
  %90 = load i32, ptr %_size.i.i188, align 4, !tbaa !32
  %idxprom.i.i189 = sext i32 %90 to i64
  %arrayidx.i.i190 = getelementptr inbounds ptr, ptr %89, i64 %idxprom.i.i189
  store ptr %call.i195, ptr %arrayidx.i.i190, align 8, !tbaa !33
  %inc.i.i191 = add nsw i32 %90, 1
  store i32 %inc.i.i191, ptr %_size.i.i188, align 4, !tbaa !32
  br label %if.end87

lpad79:                                           ; preds = %_ZN11CStringBaseIwEC2ERKS0_.exit.i192, %if.then84, %invoke.cont80, %for.cond.cleanup
  %91 = landingpad { ptr, i32 }
          cleanup
  br label %ehcleanup88

if.end87:                                         ; preds = %_ZN13CObjectVectorI11CStringBaseIwEE3AddERKS1_.exit197, %invoke.cont81
  %92 = load ptr, ptr %t, align 8, !tbaa !23
  %isnull.i198 = icmp eq ptr %92, null
  br i1 %isnull.i198, label %_ZN11CStringBaseIwED2Ev.exit200, label %delete.notnull.i199

delete.notnull.i199:                              ; preds = %if.end87
  call void @_ZdaPv(ptr noundef nonnull %92) #12
  br label %_ZN11CStringBaseIwED2Ev.exit200

_ZN11CStringBaseIwED2Ev.exit200:                  ; preds = %if.end87, %delete.notnull.i199
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %t) #10
  br label %cleanup

ehcleanup88:                                      ; preds = %lpad79, %lpad.i193, %lpad56, %lpad.i
  %eh.lpad-body.pn = phi { ptr, i32 } [ %53, %lpad56 ], [ %50, %lpad.i ], [ %91, %lpad79 ], [ %88, %lpad.i193 ]
  %93 = load ptr, ptr %t, align 8, !tbaa !23
  %isnull.i201 = icmp eq ptr %93, null
  br i1 %isnull.i201, label %ehcleanup89, label %delete.notnull.i202

delete.notnull.i202:                              ; preds = %ehcleanup88
  call void @_ZdaPv(ptr noundef nonnull %93) #12
  br label %ehcleanup89

ehcleanup89:                                      ; preds = %delete.notnull.i202, %ehcleanup88, %lpad50
  %eh.lpad-body.pn.pn = phi { ptr, i32 } [ %37, %lpad50 ], [ %eh.lpad-body.pn, %ehcleanup88 ], [ %eh.lpad-body.pn, %delete.notnull.i202 ]
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %t) #10
  br label %ehcleanup90

cleanup:                                          ; preds = %invoke.cont28, %_ZN11CStringBaseIwED2Ev.exit200
  %retval.0 = phi i1 [ true, %_ZN11CStringBaseIwED2Ev.exit200 ], [ false, %invoke.cont28 ]
  %94 = load ptr, ptr %u, align 8, !tbaa !23
  %isnull.i204 = icmp eq ptr %94, null
  br i1 %isnull.i204, label %_ZN11CStringBaseIwED2Ev.exit206, label %delete.notnull.i205

delete.notnull.i205:                              ; preds = %cleanup
  call void @_ZdaPv(ptr noundef nonnull %94) #12
  br label %_ZN11CStringBaseIwED2Ev.exit206

_ZN11CStringBaseIwED2Ev.exit206:                  ; preds = %cleanup, %delete.notnull.i205
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %u) #10
  br label %cleanup93

ehcleanup90:                                      ; preds = %ehcleanup89, %ehcleanup, %lpad27
  %eh.lpad-body.pn.pn.pn = phi { ptr, i32 } [ %eh.lpad-body.pn.pn, %ehcleanup89 ], [ %16, %lpad27 ], [ %.pn, %ehcleanup ]
  %95 = load ptr, ptr %u, align 8, !tbaa !23
  %isnull.i207 = icmp eq ptr %95, null
  br i1 %isnull.i207, label %ehcleanup92, label %delete.notnull.i208

delete.notnull.i208:                              ; preds = %ehcleanup90
  call void @_ZdaPv(ptr noundef nonnull %95) #12
  br label %ehcleanup92

ehcleanup92:                                      ; preds = %delete.notnull.i208, %ehcleanup90, %lpad23
  %eh.lpad-body.pn.pn.pn.pn = phi { ptr, i32 } [ %15, %lpad23 ], [ %eh.lpad-body.pn.pn.pn, %ehcleanup90 ], [ %eh.lpad-body.pn.pn.pn, %delete.notnull.i208 ]
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %u) #10
  br label %ehcleanup96

cleanup93:                                        ; preds = %invoke.cont15, %_ZN11CStringBaseIwED2Ev.exit206
  %retval.1 = phi i1 [ %retval.0, %_ZN11CStringBaseIwED2Ev.exit206 ], [ false, %invoke.cont15 ]
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %processed) #10
  %96 = load ptr, ptr %s, align 8, !tbaa !13
  %isnull.i210 = icmp eq ptr %96, null
  br i1 %isnull.i210, label %_ZN11CStringBaseIcED2Ev.exit, label %delete.notnull.i211

delete.notnull.i211:                              ; preds = %cleanup93
  call void @_ZdaPv(ptr noundef nonnull %96) #12
  br label %_ZN11CStringBaseIcED2Ev.exit

_ZN11CStringBaseIcED2Ev.exit:                     ; preds = %cleanup93, %delete.notnull.i211
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %s) #10
  br label %cleanup101

ehcleanup96:                                      ; preds = %lpad14, %ehcleanup92
  %eh.lpad-body.pn.pn.pn.pn.pn = phi { ptr, i32 } [ %eh.lpad-body.pn.pn.pn.pn, %ehcleanup92 ], [ %9, %lpad14 ]
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %processed) #10
  %.pre229 = load ptr, ptr %s, align 8, !tbaa !13
  %isnull.i212 = icmp eq ptr %.pre229, null
  br i1 %isnull.i212, label %ehcleanup100, label %delete.notnull.i213

delete.notnull.i213:                              ; preds = %ehcleanup96.thread, %ehcleanup96
  %eh.lpad-body.pn.pn.pn.pn.pn.pn233 = phi { ptr, i32 } [ %8, %ehcleanup96.thread ], [ %eh.lpad-body.pn.pn.pn.pn.pn, %ehcleanup96 ]
  %97 = phi ptr [ %call.i.i115, %ehcleanup96.thread ], [ %.pre229, %ehcleanup96 ]
  call void @_ZdaPv(ptr noundef nonnull %97) #12
  br label %ehcleanup100

ehcleanup100:                                     ; preds = %delete.notnull.i213, %ehcleanup96, %lpad8
  %eh.lpad-body.pn.pn.pn.pn.pn.pn.pn = phi { ptr, i32 } [ %7, %lpad8 ], [ %eh.lpad-body.pn.pn.pn.pn.pn, %ehcleanup96 ], [ %eh.lpad-body.pn.pn.pn.pn.pn.pn233, %delete.notnull.i213 ]
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %s) #10
  br label %ehcleanup102
...
ehcleanup102:                                     ; preds = %ehcleanup100, %lpad1
  %eh.lpad-body.pn.pn.pn.pn.pn.pn.pn.pn = phi { ptr, i32 } [ %eh.lpad-body.pn.pn.pn.pn.pn.pn.pn, %ehcleanup100 ], [ %3, %lpad1 ]
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %length) #10
  br label %ehcleanup104
...
ehcleanup104:                                     ; preds = %ehcleanup102, %lpad
  %eh.lpad-body.pn.pn.pn.pn.pn.pn.pn.pn.pn = phi { ptr, i32 } [ %eh.lpad-body.pn.pn.pn.pn.pn.pn.pn.pn, %ehcleanup102 ], [ %1, %lpad ]
  call void @_ZN8NWindows5NFile3NIO9CFileBaseD2Ev(ptr noundef nonnull align 8 dereferenceable(1084) %file) #10
  call void @llvm.lifetime.end.p0(i64 1088, ptr nonnull %file) #10
  resume { ptr, i32 } %eh.lpad-body.pn.pn.pn.pn.pn.pn.pn.pn.pn
}
...
_ZNK11CStringBaseIwE4FindEw.exit.thread.i.thread.i: ; preds = %if.end.i.i.i.i
  ...
  %7 = load i32, ptr %add.ptr.i.i.i120.i, align 4, !tbaa !25
  %cmp.not.i121.i = icmp eq i32 %7, 0
...
_ZN11CStringBaseIwE9TrimRightEv.exit:             ; preds = %_ZNK11CStringBaseIwE4FindEw.exit.thread.i.thread.i, %entry, %while.end.i.i, %if.then8.i.i, %if.then4.i.i.i
  ...
  %sub.ptr.rhs.cast.i.i.i.i4 = ptrtoint ptr %call.i.i.i.i2 to i64
  br label %while.cond.i.i

while.cond.i.i:                                   ; preds = %while.body.i.i17, %_ZN11CStringBaseIwE9TrimRightEv.exit
  %p.0.i.i = phi ptr [ %12, %_ZN11CStringBaseIwE9TrimRightEv.exit ], [ %add.ptr.i.i.i.i16, %while.body.i.i17 ]
  %13 = load i32, ptr %p.0.i.i, align 4, !tbaa !25
  %cmp10.i.i.i.i5 = icmp eq i32 %13, 32
  br i1 %cmp10.i.i.i.i5, label %_ZNK11CStringBaseIwE4FindEw.exit.i.i, label %if.end.i.i.i.i8

if.end.i.i.i.i8:                                  ; preds = %while.cond.i.i, %if.end5.i.i.i.i11
  %14 = phi i32 [ %15, %if.end5.i.i.i.i11 ], [ 32, %while.cond.i.i ]
  %p.011.i.i.i.i6 = phi ptr [ %add.ptr.i.i.i.i.i.i9, %if.end5.i.i.i.i11 ], [ %call.i.i.i.i2, %while.cond.i.i ]
  %cmp3.i.i.i.i7 = icmp eq i32 %14, 0
  br i1 %cmp3.i.i.i.i7, label %while.end.i.i23, label %if.end5.i.i.i.i11

if.end5.i.i.i.i11:                                ; preds = %if.end.i.i.i.i8
  %add.ptr.i.i.i.i.i.i9 = getelementptr inbounds i32, ptr %p.011.i.i.i.i6, i64 1
  %15 = load i32, ptr %add.ptr.i.i.i.i.i.i9, align 4, !tbaa !25
  %cmp.i.i.i.i10 = icmp eq i32 %15, %13
  br i1 %cmp.i.i.i.i10, label %_ZNK11CStringBaseIwE4FindEw.exit.loopexit.i.i13, label %if.end.i.i.i.i8, !llvm.loop !44

_ZNK11CStringBaseIwE4FindEw.exit.loopexit.i.i13:  ; preds = %if.end5.i.i.i.i11
  %.pre.i.i12 = ptrtoint ptr %add.ptr.i.i.i.i.i.i9 to i64
...
_ZNK11CStringBaseIwE4FindEw.exit.i.i:             ; preds = %_ZNK11CStringBaseIwE4FindEw.exit.loopexit.i.i13, %while.cond.i.i
  %sub.ptr.lhs.cast.i.i.pre-phi.i.i14 = phi i64 [ %.pre.i.i12, %_ZNK11CStringBaseIwE4FindEw.exit.loopexit.i.i13 ], [ %sub.ptr.rhs.cast.i.i.i.i4, %while.cond.i.i ]
  %sub.ptr.sub.i.i.i.i15 = sub i64 %sub.ptr.lhs.cast.i.i.pre-phi.i.i14, %sub.ptr.rhs.cast.i.i.i.i4
  %16 = and i64 %sub.ptr.sub.i.i.i.i15, 8589934592
  %cmp.i.i = icmp ne i64 %16, 0
  %cmp2.not.i.i = icmp eq i32 %13, 0
  %or.cond.i.i = or i1 %cmp2.not.i.i, %cmp.i.i
  br i1 %or.cond.i.i, label %while.end.i.i23, label %while.body.i.i17

while.body.i.i17:                                 ; preds = %_ZNK11CStringBaseIwE4FindEw.exit.i.i
  %add.ptr.i.i.i.i16 = getelementptr inbounds i32, ptr %p.0.i.i, i64 1
  br label %while.cond.i.i, !llvm.loop !49

while.end.i.i23:                                  ; preds = %_ZNK11CStringBaseIwE4FindEw.exit.i.i, %if.end.i.i.i.i8
  %sub.ptr.lhs.cast.i.i18 = ptrtoint ptr %p.0.i.i to i64
  %sub.ptr.rhs.cast.i.i19 = ptrtoint ptr %12 to i64
  %sub.ptr.sub.i.i20 = sub i64 %sub.ptr.lhs.cast.i.i18, %sub.ptr.rhs.cast.i.i19
  %17 = lshr exact i64 %sub.ptr.sub.i.i20, 2
  %conv.i.i21 = trunc i64 %17 to i32
  ...
  %spec.select.i.i.i = tail call i32 @llvm.smin.i32(i32 %18, i32 %conv.i.i21)
  %cmp3.i.i.i22 = icmp sgt i32 %spec.select.i.i.i, 0
  br i1 %cmp3.i.i.i22, label %if.then4.i.i.i27, label %_ZN11CStringBaseIwE8TrimLeftEv.exit

if.then4.i.i.i27:                                 ; preds = %while.end.i.i23
  %idx.ext3.i.i.i.i24 = zext i32 %spec.select.i.i.i to i64
  %add.ptr4.i.i.i.i25 = getelementptr inbounds i32, ptr %12, i64 %idx.ext3.i.i.i.i24
  ...
  tail call void @llvm.memmove.p0.p0.i64(ptr align 4 %12, ptr nonnull align 4 %add.ptr4.i.i.i.i25, i64 %mul.i.i.i.i, i1 false)
  %19 = load i32, ptr %_length.i.i.i, align 8, !tbaa !28
  %sub7.i.i.i26 = sub nsw i32 %19, %spec.select.i.i.i
  store i32 %sub7.i.i.i26, ptr %_length.i.i.i, align 8, !tbaa !28
  br label %_ZN11CStringBaseIwE8TrimLeftEv.exit

_ZN11CStringBaseIwE8TrimLeftEv.exit:              ; preds = %while.end.i.i23, %if.then4.i.i.i27
...
if.end.i.i:                                       ; preds = %if.then7
  ...
  %call.i35.i = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %4) #11
          to label %invoke.cont.i unwind label %_ZN11CStringBaseIwED2Ev.exit.i, !noalias !50

invoke.cont.i:                                    ; preds = %if.end.i.i
  tail call void @_ZdaPv(ptr noundef nonnull %call.i.i32.i) #12, !noalias !50
  store i32 0, ptr %call.i35.i, align 4, !tbaa !25, !noalias !50
  %cmp938.i = icmp ugt i32 %0, 2
  %.pre = load ptr, ptr %s, align 8, !tbaa !23
  br i1 %cmp938.i, label %for.body.lr.ph.i, label %_ZNK11CStringBaseIwE3MidEii.exit

for.body.lr.ph.i:                                 ; preds = %invoke.cont.i, %if.then7
  %5 = phi ptr [ %1, %if.then7 ], [ %.pre, %invoke.cont.i ]
  %ref.tmp.sroa.0.0 = phi ptr [ %call.i.i32.i, %if.then7 ], [ %call.i35.i, %invoke.cont.i ]
...
vector.memcheck:                                  ; preds = %for.body.lr.ph.i
  ...
  %ref.tmp.sroa.0.035 = ptrtoint ptr %ref.tmp.sroa.0.0 to i64
  %8 = add nuw i64 %7, 4
  %9 = sub i64 %ref.tmp.sroa.0.035, %8
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load36 = load <4 x i32>, ptr %12, align 4, !tbaa !25, !noalias !50
  ...
  store <4 x i32> %wide.load36, ptr %14, align 4, !tbaa !25, !noalias !50
  %index.next = add nuw i64 %index, 8
...
common.resume:                                    ; preds = %_ZN11CStringBaseIwED2Ev.exit32, %_ZN11CStringBaseIwED2Ev.exit.i
  %ref.tmp.sroa.0.1.sink = phi ptr [ %ref.tmp.sroa.0.1, %_ZN11CStringBaseIwED2Ev.exit32 ], [ %call.i.i32.i, %_ZN11CStringBaseIwED2Ev.exit.i ]
  %common.resume.op = phi { ptr, i32 } [ %35, %_ZN11CStringBaseIwED2Ev.exit32 ], [ %21, %_ZN11CStringBaseIwED2Ev.exit.i ]
...
_ZNK11CStringBaseIwE3MidEii.exit:                 ; preds = %for.body.i.prol.loopexit, %for.body.i, %middle.block, %invoke.cont.i
  %30 = phi ptr [ %.pre, %invoke.cont.i ], [ %5, %middle.block ], [ %5, %for.body.i ], [ %5, %for.body.i.prol.loopexit ]
  %ref.tmp.sroa.0.1 = phi ptr [ %call.i35.i, %invoke.cont.i ], [ %ref.tmp.sroa.0.0, %middle.block ], [ %ref.tmp.sroa.0.0, %for.body.i ], [ %ref.tmp.sroa.0.0, %for.body.i.prol.loopexit ]
  %idxprom15.pre-phi.i = phi i64 [ 0, %invoke.cont.i ], [ %6, %middle.block ], [ %6, %for.body.i ], [ %6, %for.body.i.prol.loopexit ]
...
if.end.i.i27:                                     ; preds = %_ZNK11CStringBaseIwE3MidEii.exit
  ...
  %call.i.i29 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %32) #11
          to label %call.i.i.noexc unwind label %_ZN11CStringBaseIwED2Ev.exit32
...
if.end9.i.i:                                      ; preds = %delete.notnull.i.i, %call.i.i.noexc
  ...
  store ptr %call.i.i29, ptr %s, align 8, !tbaa !23
  %arrayidx14.i.i = getelementptr inbounds i32, ptr %call.i.i29, i64 %idxprom13.i.i
...
while.cond.i.i.preheader:                         ; preds = %if.end9.i.i, %_ZNK11CStringBaseIwE3MidEii.exit
  %dest.addr.0.i.i.ph = phi ptr [ %30, %_ZNK11CStringBaseIwE3MidEii.exit ], [ %call.i.i29, %if.end9.i.i ]
  br label %while.cond.i.i
...
_ZN11CStringBaseIwED2Ev.exit32:                   ; preds = %if.end.i.i27
