...
for.body.i:                                       ; preds = %for.inc.i, %for.body.preheader.i
  ...
  %retval.sroa.3.183.i = phi i32 [ %retval.sroa.3.2.i, %for.inc.i ], [ %retval.sroa.3.0.i, %for.body.preheader.i ]
  %prev.082.i = phi ptr [ %tmp.084.i, %for.inc.i ], [ %4, %for.body.preheader.i ]
...
if.then15.i:                                      ; preds = %for.body.i
  ...
  %next18.i = getelementptr inbounds %struct.vert_st, ptr %prev.082.i, i64 0, i32 1
  store ptr %11, ptr %next18.i, align 8, !tbaa !11
  br label %for.inc.i
...
if.end31.i:                                       ; preds = %if.else29.i, %if.then26.i, %if.then24.i
  ...
  %cmp33.i = icmp slt i32 %dist2.0.i, %retval.sroa.3.183.i
  %spec.select.i = select i1 %cmp33.i, ptr %tmp.084.i, ptr %retval.sroa.0.081.i
  %spec.select77.i = tail call i32 @llvm.smin.i32(i32 %dist2.0.i, i32 %retval.sroa.3.183.i)
  br label %for.inc.i

for.inc.i:                                        ; preds = %if.end31.i, %if.then15.i
  %retval.sroa.0.1.i = phi ptr [ %retval.sroa.0.081.i, %if.then15.i ], [ %spec.select.i, %if.end31.i ]
  %retval.sroa.3.2.i = phi i32 [ %retval.sroa.3.183.i, %if.then15.i ], [ %spec.select77.i, %if.end31.i ]
