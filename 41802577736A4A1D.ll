...
_ZL6boundsRK20btAlignedObjectArrayIP10btDbvtNodeE.exit: ; preds = %for.body.i
  ...
  %cmp30426 = icmp sgt i32 %3, 0
  br i1 %cmp30426, label %invoke.cont35.lr.ph, label %for.inc85

invoke.cont35.lr.ph:                              ; preds = %_ZL6boundsRK20btAlignedObjectArrayIP10btDbvtNodeE.exit
  ...
  %.pre450 = load float, ptr @_ZZL7topdownP6btDbvtR20btAlignedObjectArrayIP10btDbvtNodeEiE4axis, align 16, !tbaa !33
  ...
  %.pre451 = load float, ptr getelementptr inbounds ([3 x %class.btVector3], ptr @_ZZL7topdownP6btDbvtR20btAlignedObjectArrayIP10btDbvtNodeEiE4axis, i64 0, i64 0, i32 0, i64 1), align 4, !tbaa !33
  ...
  %.pre455 = load float, ptr getelementptr inbounds ([3 x %class.btVector3], ptr @_ZZL7topdownP6btDbvtR20btAlignedObjectArrayIP10btDbvtNodeEiE4axis, i64 0, i64 2, i32 0, i64 2), align 8, !tbaa !33
  %.pre456 = load float, ptr getelementptr inbounds ([3 x %class.btVector3], ptr @_ZZL7topdownP6btDbvtR20btAlignedObjectArrayIP10btDbvtNodeEiE4axis, i64 0, i64 2), align 16, !tbaa !33
  %.pre457 = load float, ptr getelementptr inbounds ([3 x %class.btVector3], ptr @_ZZL7topdownP6btDbvtR20btAlignedObjectArrayIP10btDbvtNodeEiE4axis, i64 0, i64 2, i32 0, i64 1), align 4, !tbaa !33
  %27 = insertelement <2 x float> %22, float %.pre, i64 1
  %28 = insertelement <2 x float> %24, float %.pre450, i64 1
  %29 = insertelement <2 x float> %26, float %.pre451, i64 1
  br label %invoke.cont35

for.cond59.preheader:                             ; preds = %invoke.cont35
...
invoke.cont35:                                    ; preds = %invoke.cont35.lr.ph, %invoke.cont35
  %indvars.iv = phi i64 [ 0, %invoke.cont35.lr.ph ], [ %indvars.iv.next, %invoke.cont35 ]
  ...
  %31 = load float, ptr %arrayidx11.i.i235, align 4, !tbaa !33
  %arrayidx13.i.i236 = getelementptr inbounds %struct.btDbvtAabbMm, ptr %30, i64 0, i32 1, i32 0, i64 2
  %32 = load float, ptr %arrayidx13.i.i236, align 4, !tbaa !33
  %add14.i.i237 = fadd float %31, %32
  ...
  %35 = load float, ptr %30, align 4, !tbaa !33
  %mx.i230 = getelementptr inbounds %struct.btDbvtAabbMm, ptr %30, i64 0, i32 1
  %36 = load float, ptr %mx.i230, align 4, !tbaa !33
  %add.i.i231 = fadd float %35, %36
  ...
  %mul8.i.i.2 = fmul float %sub8.i, %.pre457
  %51 = tail call float @llvm.fmuladd.f32(float %sub.i, float %.pre456, float %mul8.i.i.2)
  %52 = tail call float @llvm.fmuladd.f32(float %sub14.i, float %.pre455, float %51)
  ...
  br i1 %exitcond.not, label %for.cond59.preheader, label %invoke.cont35
...
if.then70:                                        ; preds = %land.lhs.true
  ...
  %spec.select418 = tail call i32 @llvm.smin.i32(i32 %3, i32 %conv80)
  br label %for.inc85
...
for.inc85:                                        ; preds = %_ZL6boundsRK20btAlignedObjectArrayIP10btDbvtNodeE.exit, %for.cond59.preheader, %land.lhs.true, %if.then70
  ...
  %bestmidp.2 = phi i32 [ %spec.select418, %if.then70 ], [ %3, %land.lhs.true ], [ %3, %for.cond59.preheader ], [ %3, %_ZL6boundsRK20btAlignedObjectArrayIP10btDbvtNodeE.exit ]
...
if.then70.1:                                      ; preds = %land.lhs.true.1
  ...
  %spec.select418.1 = tail call i32 @llvm.smin.i32(i32 %bestmidp.2, i32 %conv80.1)
...
for.inc85.1:                                      ; preds = %if.then70.1, %land.lhs.true.1, %for.inc85
  ...
  %bestmidp.2.1 = phi i32 [ %spec.select418.1, %if.then70.1 ], [ %bestmidp.2, %land.lhs.true.1 ], [ %bestmidp.2, %for.inc85 ]
...
for.body.lr.ph.i.i268:                            ; preds = %_ZN20btAlignedObjectArrayIP10btDbvtNodeE8allocateEi.exit.i265
  ...
  %xtraiter494 = and i64 %wide.trip.count.i.i267, 3
...
for.body.lr.ph.i.i268.new:                        ; preds = %for.body.lr.ph.i.i268
  %unroll_iter497 = and i64 %wide.trip.count.i.i267, 4294967292
...
for.body.i.i274:                                  ; preds = %for.body.i.i274, %for.body.lr.ph.i.i268.new
  ...
  %niter498 = phi i64 [ 0, %for.body.lr.ph.i.i268.new ], [ %niter498.next.3, %for.body.i.i274 ]
  ...
  br i1 %niter498.ncmp.3, label %_ZNK20btAlignedObjectArrayIP10btDbvtNodeE4copyEiiPS1_.exit.i280.loopexit.unr-lcssa, label %for.body.i.i274
...
_ZNK20btAlignedObjectArrayIP10btDbvtNodeE4copyEiiPS1_.exit.i280.loopexit.unr-lcssa: ; preds = %for.body.i.i274, %for.body.lr.ph.i.i268
  ...
  br i1 %lcmp.mod496.not, label %_ZNK20btAlignedObjectArrayIP10btDbvtNodeE4copyEiiPS1_.exit.i280, label %for.body.i.i274.epil
...
for.body.i.i274.epil:                             ; preds = %_ZNK20btAlignedObjectArrayIP10btDbvtNodeE4copyEiiPS1_.exit.i280.loopexit.unr-lcssa, %for.body.i.i274.epil
  ...
  %epil.iter495 = phi i64 [ %epil.iter495.next, %for.body.i.i274.epil ], [ 0, %_ZNK20btAlignedObjectArrayIP10btDbvtNodeE4copyEiiPS1_.exit.i280.loopexit.unr-lcssa ]
  ...
  br i1 %epil.iter495.cmp.not, label %_ZNK20btAlignedObjectArrayIP10btDbvtNodeE4copyEiiPS1_.exit.i280, label %for.body.i.i274.epil, !llvm.loop !52
...
for.body10.i53.i.prol:                            ; preds = %for.body10.lr.ph.i48.i, %for.body10.i53.i.prol
  ...
  br i1 %prol.iter503.cmp.not, label %for.body10.i53.i.prol.loopexit, label %for.body10.i53.i.prol, !llvm.loop !54
...
for.body.i.i.i74.i.epil:                          ; preds = %_ZNK20btAlignedObjectArrayIP10btDbvtNodeE4copyEiiPS1_.exit.i.i80.i.loopexit.unr-lcssa, %for.body.i.i.i74.i.epil
  ...
  br i1 %epil.iter510.cmp.not, label %_ZNK20btAlignedObjectArrayIP10btDbvtNodeE4copyEiiPS1_.exit.i.i80.i, label %for.body.i.i.i74.i.epil, !llvm.loop !55
...
for.body.i.i.i115.i.epil:                         ; preds = %_ZNK20btAlignedObjectArrayIP10btDbvtNodeE4copyEiiPS1_.exit.i.i121.i.loopexit.unr-lcssa, %for.body.i.i.i115.i.epil
  ...
  br i1 %epil.iter505.cmp.not, label %_ZNK20btAlignedObjectArrayIP10btDbvtNodeE4copyEiiPS1_.exit.i.i121.i, label %for.body.i.i.i115.i.epil, !llvm.loop !56
...
_ZN20btAlignedObjectArrayIP10btDbvtNodeE8allocateEi.exit.i322: ; preds = %if.then.i.i318
  ...
  %cmp7.i.i321 = icmp sgt i32 %.pre459, 0
...
for.body.lr.ph.i.i325:                            ; preds = %_ZN20btAlignedObjectArrayIP10btDbvtNodeE8allocateEi.exit.i322
  %wide.trip.count.i.i324 = zext i32 %.pre459 to i64
...
_ZNK20btAlignedObjectArrayIP10btDbvtNodeE4copyEiiPS1_.exit.i337: ; preds = %_ZNK20btAlignedObjectArrayIP10btDbvtNodeE4copyEiiPS1_.exit.i337.loopexit.unr-lcssa, %for.body.i.i331.epil, %if.then.i315, %_ZN20btAlignedObjectArrayIP10btDbvtNodeE8allocateEi.exit.i322
  %retval.0.i.i319472 = phi ptr [ %call.i.i.i342, %_ZN20btAlignedObjectArrayIP10btDbvtNodeE8allocateEi.exit.i322 ], [ null, %if.then.i315 ], [ %call.i.i.i342, %for.body.i.i331.epil ], [ %call.i.i.i342, %_ZNK20btAlignedObjectArrayIP10btDbvtNodeE4copyEiiPS1_.exit.i337.loopexit.unr-lcssa ]
...
_ZN20btAlignedObjectArrayIP10btDbvtNodeE10deallocateEv.exit.i340: ; preds = %if.then3.i.i338, %_ZNK20btAlignedObjectArrayIP10btDbvtNodeE4copyEiiPS1_.exit.i337
  store i8 1, ptr %m_ownsMemory.i.i, align 8, !tbaa !24
  store ptr %retval.0.i.i319472, ptr %m_data.i.i, align 16, !tbaa !27
...
invoke.cont108:                                   ; preds = %_ZN20btAlignedObjectArrayIP10btDbvtNodeE10deallocateEv.exit.i340, %if.else
  %div111.pre-phi = phi i32 [ %.pre465, %_ZN20btAlignedObjectArrayIP10btDbvtNodeE10deallocateEv.exit.i340 ], [ %div, %if.else ]
  %176 = phi i32 [ %.pre461, %_ZN20btAlignedObjectArrayIP10btDbvtNodeE10deallocateEv.exit.i340 ], [ 0, %if.else ]
  %177 = phi i32 [ %.pre460, %_ZN20btAlignedObjectArrayIP10btDbvtNodeE10deallocateEv.exit.i340 ], [ %3, %if.else ]
...
for.body.lr.ph.i.i359:                            ; preds = %_ZN20btAlignedObjectArrayIP10btDbvtNodeE8allocateEi.exit.i356
  ...
  %xtraiter479 = and i64 %wide.trip.count.i.i358, 3
...
for.body.lr.ph.i.i359.new:                        ; preds = %for.body.lr.ph.i.i359
  %unroll_iter482 = and i64 %wide.trip.count.i.i358, 4294967292
...
for.body.i.i365:                                  ; preds = %for.body.i.i365, %for.body.lr.ph.i.i359.new
  ...
  %niter483 = phi i64 [ 0, %for.body.lr.ph.i.i359.new ], [ %niter483.next.3, %for.body.i.i365 ]
  ...
  br i1 %niter483.ncmp.3, label %_ZNK20btAlignedObjectArrayIP10btDbvtNodeE4copyEiiPS1_.exit.i371.loopexit.unr-lcssa, label %for.body.i.i365
...
_ZNK20btAlignedObjectArrayIP10btDbvtNodeE4copyEiiPS1_.exit.i371.loopexit.unr-lcssa: ; preds = %for.body.i.i365, %for.body.lr.ph.i.i359
  ...
  br i1 %lcmp.mod481.not, label %_ZNK20btAlignedObjectArrayIP10btDbvtNodeE4copyEiiPS1_.exit.i371, label %for.body.i.i365.epil
...
for.body.i.i365.epil:                             ; preds = %_ZNK20btAlignedObjectArrayIP10btDbvtNodeE4copyEiiPS1_.exit.i371.loopexit.unr-lcssa, %for.body.i.i365.epil
  ...
  %epil.iter480 = phi i64 [ %epil.iter480.next, %for.body.i.i365.epil ], [ 0, %_ZNK20btAlignedObjectArrayIP10btDbvtNodeE4copyEiiPS1_.exit.i371.loopexit.unr-lcssa ]
  ...
  br i1 %epil.iter480.cmp.not, label %_ZNK20btAlignedObjectArrayIP10btDbvtNodeE4copyEiiPS1_.exit.i371, label %for.body.i.i365.epil, !llvm.loop !58
...
invoke.cont112:                                   ; preds = %_ZN20btAlignedObjectArrayIP10btDbvtNodeE10deallocateEv.exit.i374, %invoke.cont108
  %192 = phi i32 [ %.pre462, %_ZN20btAlignedObjectArrayIP10btDbvtNodeE10deallocateEv.exit.i374 ], [ %177, %invoke.cont108 ]
  %cmp116431 = icmp sgt i32 %192, 0
  br i1 %cmp116431, label %for.body118.lr.ph, label %if.end130
...
for.body118:                                      ; preds = %for.body118.lr.ph, %_ZN20btAlignedObjectArrayIP10btDbvtNodeE9push_backERKS1_.exit
  %indvars.iv445 = phi i64 [ 0, %for.body118.lr.ph ], [ %indvars.iv.next446, %_ZN20btAlignedObjectArrayIP10btDbvtNodeE9push_backERKS1_.exit ]
  %and = and i64 %indvars.iv445, 1
  %193 = load ptr, ptr %4, align 8, !tbaa !27
  %arrayidx.i382 = getelementptr inbounds ptr, ptr %193, i64 %indvars.iv445
...
ehcleanup146:                                     ; preds = %lpad94.loopexit, %lpad94.loopexit.split-lp, %lpad131, %lpad121
  %.pn = phi { ptr, i32 } [ %220, %lpad131 ], [ %213, %lpad121 ], [ %lpad.loopexit420, %lpad94.loopexit ], [ %lpad.loopexit.split-lp421, %lpad94.loopexit.split-lp ]
  call void @llvm.lifetime.end.p0(i64 24, ptr nonnull %splitcount) #17
...
_ZN20btAlignedObjectArrayIP10btDbvtNodeED2Ev.exit: ; preds = %if.then3.i.i.i406, %invoke.cont139
  %m_size.i.i.i407 = getelementptr inbounds %class.btAlignedObjectArray.0, ptr %sets, i64 1, i32 2
  store i8 1, ptr %m_ownsMemory.i.i.i403, align 8, !tbaa !24
  store ptr null, ptr %m_data.i.i.i401, align 16, !tbaa !27
  store i32 0, ptr %m_size.i.i.i407, align 4, !tbaa !28
  %m_capacity.i.i.i408 = getelementptr inbounds %class.btAlignedObjectArray.0, ptr %sets, i64 1, i32 3
  store i32 0, ptr %m_capacity.i.i.i408, align 8, !tbaa !29
...
ehcleanup174:                                     ; preds = %arraydestroy.body158.preheader, %invoke.cont171
  %.pn434 = phi { ptr, i32 } [ %.pn, %invoke.cont171 ], [ %223, %arraydestroy.body158.preheader ]
  call void @llvm.lifetime.end.p0(i64 64, ptr nonnull %sets) #17
  resume { ptr, i32 } %.pn434
...
if.else177:                                       ; preds = %if.then
  ...
  %224 = load ptr, ptr %m_data.i410, align 8, !tbaa !27
  %225 = load ptr, ptr %224, align 8, !tbaa !30
  br label %return

if.end179:                                        ; preds = %init.end
  %m_data.i411 = getelementptr inbounds %class.btAlignedObjectArray.0, ptr %leaves, i64 0, i32 5
  %226 = load ptr, ptr %m_data.i411, align 8, !tbaa !27
...
lor.lhs.false8.i:                                 ; preds = %while.body
  ...
  %or.cond64 = select i1 %or.cond, i1 true, i1 %cmp24.i
  %cmp29.i61 = fcmp une float %pb.sroa.8.0.copyload, %.sink76.i
  %or.cond65 = select i1 %or.cond64, i1 true, i1 %cmp29.i61
  br i1 %or.cond65, label %cleanup, label %return
...
if.then:                                          ; preds = %entry, %if.then
  ...
  %arrayidx1 = getelementptr inbounds %struct.btDbvtNode, ptr %root.tr11, i64 0, i32 2, i32 0, i64 1
  %4 = load ptr, ptr %arrayidx1, align 8, !tbaa !23
...
_ZN20btAlignedObjectArrayIN6btDbvt7sStkCLNEE9push_backERKS1_.exit139: ; preds = %if.then3.i.i.i128, %if.then24, %if.then.i103
  ...
  %idxprom.i132 = sext i32 %sub to i64
  %arrayidx.i133 = getelementptr inbounds %"struct.btDbvt::sStkCLN", ptr %stack.sroa.37222.3, i64 %idxprom.i132
...
if.then:                                          ; preds = %entry, %if.then
  ...
  %arrayidx1 = getelementptr inbounds %struct.btDbvtNode, ptr %node.tr9, i64 0, i32 2, i32 0, i64 1
  %3 = load ptr, ptr %arrayidx1, align 8, !tbaa !23
  %arrayidx.i.i = getelementptr inbounds %struct.btDbvtNode, ptr %3, i64 0, i32 2, i32 0, i64 1
  %4 = load ptr, ptr %arrayidx.i.i, align 8, !tbaa !23
  %cmp.i.i.not = icmp eq ptr %4, null
  br i1 %cmp.i.i.not, label %if.else, label %if.then
