...
true_bb8:                                         ; preds = %_halide_buffer_is_bounds_query.exit32
  ...
  %.sroa.2549.0..sroa_idx = getelementptr inbounds i8, ptr %107, i64 4
  store i32 %108, ptr %.sroa.2549.0..sroa_idx, align 4
  %.sroa.3550.0..sroa_idx = getelementptr inbounds i8, ptr %107, i64 8
  store i32 1, ptr %.sroa.3550.0..sroa_idx, align 4
  %.sroa.4551.0..sroa_idx = getelementptr inbounds i8, ptr %107, i64 12
  store i32 0, ptr %.sroa.4551.0..sroa_idx, align 4
  ...
  %.sroa.7553.16..sroa_idx = getelementptr inbounds %struct.halide_dimension_t, ptr %111, i64 1, i32 1
  store i32 %70, ptr %.sroa.7553.16..sroa_idx, align 4
  %.sroa.8554.16..sroa_idx = getelementptr inbounds %struct.halide_dimension_t, ptr %111, i64 1, i32 2
  store i32 %108, ptr %.sroa.8554.16..sroa_idx, align 4
  %.sroa.9555.16..sroa_idx = getelementptr inbounds %struct.halide_dimension_t, ptr %111, i64 1, i32 3
  store i32 0, ptr %.sroa.9555.16..sroa_idx, align 4
  ...
  %.sroa.12557.32..sroa_idx = getelementptr inbounds %struct.halide_dimension_t, ptr %113, i64 2, i32 1
  store i32 %76, ptr %.sroa.12557.32..sroa_idx, align 4
  %.sroa.13558.32..sroa_idx = getelementptr inbounds %struct.halide_dimension_t, ptr %113, i64 2, i32 2
  store i32 %109, ptr %.sroa.13558.32..sroa_idx, align 4
  %.sroa.14559.32..sroa_idx = getelementptr inbounds %struct.halide_dimension_t, ptr %113, i64 2, i32 3
  store i32 0, ptr %.sroa.14559.32..sroa_idx, align 4
...
"for k$2.s0.n1":                                  ; preds = %"assert succeeded77"
  ...
  %reass.sub562 = sub i64 %reass.mul, %256
  %261 = add i64 %reass.sub562, 4
  ...
  %reass.sub562.1 = sub i64 %reass.mul.1, %256
  %271 = add i64 %reass.sub562.1, 4
  ...
  %reass.sub562.2 = sub i64 %reass.mul.2, %256
  %281 = add i64 %reass.sub562.2, 4
  ...
  %reass.sub562.3 = sub i64 %reass.mul.3, %256
  %291 = add i64 %reass.sub562.3, 4
  ...
  %reass.sub562.4 = sub i64 %reass.mul.4, %256
  %301 = add i64 %reass.sub562.4, 4
  ...
  %reass.sub562.5 = sub i64 %reass.mul.5, %256
  %311 = add i64 %reass.sub562.5, 4
  ...
  %reass.sub562.6 = sub i64 %reass.mul.6, %256
  %321 = add i64 %reass.sub562.6, 4
  ...
  %reass.sub562.7 = sub i64 %reass.mul.7, %256
  %331 = add i64 %reass.sub562.7, 4
  ...
  %strided.vec566 = shufflevector <32 x float> %wide.vec, <32 x float> poison, <4 x i32> <i32 1, i32 9, i32 17, i32 25>
  %strided.vec567 = shufflevector <32 x float> %wide.vec, <32 x float> poison, <4 x i32> <i32 2, i32 10, i32 18, i32 26>
  %strided.vec568 = shufflevector <32 x float> %wide.vec, <32 x float> poison, <4 x i32> <i32 3, i32 11, i32 19, i32 27>
  %strided.vec569 = shufflevector <32 x float> %wide.vec, <32 x float> poison, <4 x i32> <i32 4, i32 12, i32 20, i32 28>
  %strided.vec570 = shufflevector <32 x float> %wide.vec, <32 x float> poison, <4 x i32> <i32 5, i32 13, i32 21, i32 29>
  %strided.vec571 = shufflevector <32 x float> %wide.vec, <32 x float> poison, <4 x i32> <i32 6, i32 14, i32 22, i32 30>
  %strided.vec572 = shufflevector <32 x float> %wide.vec, <32 x float> poison, <4 x i32> <i32 7, i32 15, i32 23, i32 31>
  %336 = fadd <4 x float> %strided.vec, %strided.vec569
  %wide.vec573 = load <32 x float>, ptr %"inv_X8$5.18", align 16, !tbaa !32
  %strided.vec574 = shufflevector <32 x float> %wide.vec573, <32 x float> poison, <4 x i32> <i32 0, i32 8, i32 16, i32 24>
  %strided.vec575 = shufflevector <32 x float> %wide.vec573, <32 x float> poison, <4 x i32> <i32 1, i32 9, i32 17, i32 25>
  %strided.vec576 = shufflevector <32 x float> %wide.vec573, <32 x float> poison, <4 x i32> <i32 2, i32 10, i32 18, i32 26>
  %strided.vec577 = shufflevector <32 x float> %wide.vec573, <32 x float> poison, <4 x i32> <i32 3, i32 11, i32 19, i32 27>
  %strided.vec578 = shufflevector <32 x float> %wide.vec573, <32 x float> poison, <4 x i32> <i32 4, i32 12, i32 20, i32 28>
  %strided.vec579 = shufflevector <32 x float> %wide.vec573, <32 x float> poison, <4 x i32> <i32 5, i32 13, i32 21, i32 29>
  %strided.vec580 = shufflevector <32 x float> %wide.vec573, <32 x float> poison, <4 x i32> <i32 6, i32 14, i32 22, i32 30>
  %strided.vec581 = shufflevector <32 x float> %wide.vec573, <32 x float> poison, <4 x i32> <i32 7, i32 15, i32 23, i32 31>
  %337 = fadd <4 x float> %strided.vec574, %strided.vec578
  %338 = fadd <4 x float> %strided.vec567, %strided.vec571
  %339 = fadd <4 x float> %strided.vec576, %strided.vec580
  %340 = fadd <4 x float> %336, %338
  %341 = fadd <4 x float> %337, %339
  %342 = fsub <4 x float> %336, %338
  %343 = fsub <4 x float> %337, %339
  %344 = fsub <4 x float> %strided.vec, %strided.vec569
  %345 = fsub <4 x float> %strided.vec574, %strided.vec578
  %346 = fsub <4 x float> %strided.vec576, %strided.vec580
  %347 = fsub <4 x float> %strided.vec571, %strided.vec567
  %348 = fadd <4 x float> %344, %346
  %349 = fadd <4 x float> %345, %347
  %350 = fsub <4 x float> %344, %346
  %351 = fsub <4 x float> %345, %347
  %352 = fadd <4 x float> %strided.vec566, %strided.vec570
  %353 = fadd <4 x float> %strided.vec575, %strided.vec579
  %354 = fadd <4 x float> %strided.vec568, %strided.vec572
  %355 = fadd <4 x float> %strided.vec577, %strided.vec581
  %356 = fadd <4 x float> %352, %354
  %357 = fadd <4 x float> %353, %355
  %358 = fsub <4 x float> %353, %355
  %359 = fsub <4 x float> %354, %352
  %360 = fsub <4 x float> %strided.vec566, %strided.vec570
  %361 = fsub <4 x float> %strided.vec575, %strided.vec579
  %362 = fsub <4 x float> %strided.vec577, %strided.vec581
  %363 = fsub <4 x float> %strided.vec572, %strided.vec568
  ...
  %interleaved.vec582 = shufflevector <16 x float> %403, <16 x float> %404, <32 x i32> <i32 0, i32 4, i32 8, i32 12, i32 16, i32 20, i32 24, i32 28, i32 1, i32 5, i32 9, i32 13, i32 17, i32 21, i32 25, i32 29, i32 2, i32 6, i32 10, i32 14, i32 18, i32 22, i32 26, i32 30, i32 3, i32 7, i32 11, i32 15, i32 19, i32 23, i32 27, i32 31>
  store <32 x float> %interleaved.vec582, ptr %"inv_fft0_S1_R8_n0$2.110", align 16, !tbaa !36
  ...
  %strided.vec566.1 = shufflevector <32 x float> %wide.vec.1, <32 x float> poison, <4 x i32> <i32 1, i32 9, i32 17, i32 25>
  %strided.vec567.1 = shufflevector <32 x float> %wide.vec.1, <32 x float> poison, <4 x i32> <i32 2, i32 10, i32 18, i32 26>
  %strided.vec568.1 = shufflevector <32 x float> %wide.vec.1, <32 x float> poison, <4 x i32> <i32 3, i32 11, i32 19, i32 27>
  %strided.vec569.1 = shufflevector <32 x float> %wide.vec.1, <32 x float> poison, <4 x i32> <i32 4, i32 12, i32 20, i32 28>
  %strided.vec570.1 = shufflevector <32 x float> %wide.vec.1, <32 x float> poison, <4 x i32> <i32 5, i32 13, i32 21, i32 29>
  %strided.vec571.1 = shufflevector <32 x float> %wide.vec.1, <32 x float> poison, <4 x i32> <i32 6, i32 14, i32 22, i32 30>
  %strided.vec572.1 = shufflevector <32 x float> %wide.vec.1, <32 x float> poison, <4 x i32> <i32 7, i32 15, i32 23, i32 31>
  %406 = fadd <4 x float> %strided.vec.1, %strided.vec569.1
  %407 = getelementptr inbounds float, ptr %"inv_X8$5.18", i64 32
  %wide.vec573.1 = load <32 x float>, ptr %407, align 16, !tbaa !32
  %strided.vec574.1 = shufflevector <32 x float> %wide.vec573.1, <32 x float> poison, <4 x i32> <i32 0, i32 8, i32 16, i32 24>
  %strided.vec575.1 = shufflevector <32 x float> %wide.vec573.1, <32 x float> poison, <4 x i32> <i32 1, i32 9, i32 17, i32 25>
  %strided.vec576.1 = shufflevector <32 x float> %wide.vec573.1, <32 x float> poison, <4 x i32> <i32 2, i32 10, i32 18, i32 26>
  %strided.vec577.1 = shufflevector <32 x float> %wide.vec573.1, <32 x float> poison, <4 x i32> <i32 3, i32 11, i32 19, i32 27>
  %strided.vec578.1 = shufflevector <32 x float> %wide.vec573.1, <32 x float> poison, <4 x i32> <i32 4, i32 12, i32 20, i32 28>
  %strided.vec579.1 = shufflevector <32 x float> %wide.vec573.1, <32 x float> poison, <4 x i32> <i32 5, i32 13, i32 21, i32 29>
  %strided.vec580.1 = shufflevector <32 x float> %wide.vec573.1, <32 x float> poison, <4 x i32> <i32 6, i32 14, i32 22, i32 30>
  %strided.vec581.1 = shufflevector <32 x float> %wide.vec573.1, <32 x float> poison, <4 x i32> <i32 7, i32 15, i32 23, i32 31>
  %408 = fadd <4 x float> %strided.vec574.1, %strided.vec578.1
  %409 = fadd <4 x float> %strided.vec567.1, %strided.vec571.1
  %410 = fadd <4 x float> %strided.vec576.1, %strided.vec580.1
  %411 = fadd <4 x float> %406, %409
  %412 = fadd <4 x float> %408, %410
  %413 = fsub <4 x float> %406, %409
  %414 = fsub <4 x float> %408, %410
  %415 = fsub <4 x float> %strided.vec.1, %strided.vec569.1
  %416 = fsub <4 x float> %strided.vec574.1, %strided.vec578.1
  %417 = fsub <4 x float> %strided.vec576.1, %strided.vec580.1
  %418 = fsub <4 x float> %strided.vec571.1, %strided.vec567.1
  %419 = fadd <4 x float> %415, %417
  %420 = fadd <4 x float> %416, %418
  %421 = fsub <4 x float> %415, %417
  %422 = fsub <4 x float> %416, %418
  %423 = fadd <4 x float> %strided.vec566.1, %strided.vec570.1
  %424 = fadd <4 x float> %strided.vec575.1, %strided.vec579.1
  %425 = fadd <4 x float> %strided.vec568.1, %strided.vec572.1
  %426 = fadd <4 x float> %strided.vec577.1, %strided.vec581.1
  %427 = fadd <4 x float> %423, %425
  %428 = fadd <4 x float> %424, %426
  %429 = fsub <4 x float> %424, %426
  %430 = fsub <4 x float> %425, %423
  %431 = fsub <4 x float> %strided.vec566.1, %strided.vec570.1
  %432 = fsub <4 x float> %strided.vec575.1, %strided.vec579.1
  %433 = fsub <4 x float> %strided.vec577.1, %strided.vec581.1
  %434 = fsub <4 x float> %strided.vec572.1, %strided.vec568.1
  ...
  %interleaved.vec582.1 = shufflevector <16 x float> %476, <16 x float> %477, <32 x i32> <i32 0, i32 4, i32 8, i32 12, i32 16, i32 20, i32 24, i32 28, i32 1, i32 5, i32 9, i32 13, i32 17, i32 21, i32 25, i32 29, i32 2, i32 6, i32 10, i32 14, i32 18, i32 22, i32 26, i32 30, i32 3, i32 7, i32 11, i32 15, i32 19, i32 23, i32 27, i32 31>
  store <32 x float> %interleaved.vec582.1, ptr %471, align 16, !tbaa !36
  ...
  store <4 x float> %663, ptr %"inv_X8$5.09", align 16, !tbaa !140
  store <4 x float> %666, ptr %"inv_X8$5.18", align 16, !tbaa !142
...
"for result$2.s0.i.preheader":                    ; preds = %"for k$2.s0.n1"
  %715 = getelementptr inbounds float, ptr %"inv_fft1_S1_R8_n1$2.05", i64 32
  %716 = getelementptr inbounds float, ptr %"inv_fft1_S1_R8_n1$2.05", i64 40
  %717 = getelementptr inbounds float, ptr %"inv_fft1_S1_R8_n1$2.05", i64 28
  %718 = getelementptr inbounds float, ptr %"inv_fft1_S1_R8_n1$2.05", i64 20
  %719 = getelementptr inbounds float, ptr %"inv_fft1_S1_R8_n1$2.05", i64 36
  %720 = getelementptr inbounds float, ptr %"inv_fft1_S1_R8_n1$2.05", i64 44
  %721 = getelementptr inbounds float, ptr %"inv_fft1_S1_R8_n1$2.05", i64 24
  %722 = getelementptr inbounds float, ptr %"inv_fft1_S1_R8_n1$2.05", i64 16
  %723 = getelementptr inbounds float, ptr %"inv_fft1_S1_R8_n1$2.05", i64 48
  %724 = getelementptr inbounds float, ptr %"inv_fft1_S1_R8_n1$2.05", i64 56
  %725 = getelementptr inbounds float, ptr %"inv_fft1_S1_R8_n1$2.05", i64 12
  %726 = getelementptr inbounds float, ptr %"inv_fft1_S1_R8_n1$2.05", i64 4
  %727 = getelementptr inbounds float, ptr %"inv_fft1_S1_R8_n1$2.05", i64 52
  %728 = getelementptr inbounds float, ptr %"inv_fft1_S1_R8_n1$2.05", i64 60
  %729 = getelementptr inbounds float, ptr %"inv_fft1_S1_R8_n1$2.05", i64 8
  ...
  %invariant.gep = getelementptr float, ptr %"inv_fft0_S1_R8_n0$2.011", i64 -7
  %invariant.gep629 = getelementptr float, ptr %"inv_fft0_S1_R8_n0$2.110", i64 -7
...
"for result$2.s0.i":                              ; preds = %"for result$2.s0.i.preheader", %"end for result$2.s0.n1"
  %indvars.iv537 = phi i64 [ %743, %"for result$2.s0.i.preheader" ], [ %indvars.iv.next538, %"end for result$2.s0.n1" ]
  %749 = trunc i64 %indvars.iv537 to i32
  %reass.add254 = sub i32 %749, %26
  %reass.mul255 = mul i32 %reass.add254, %30
  %750 = sub i32 %reass.mul255, %14
...
"for fwd_fft0_S1_R8_n0$2.s1.n1":                  ; preds = %"for result$2.s0.i", %"for fwd_fft0_S1_R8_n0$2.s1.n1"
  %indvars.iv519 = phi i64 [ 0, %"for result$2.s0.i" ], [ %indvars.iv.next520, %"for fwd_fft0_S1_R8_n0$2.s1.n1" ]
  %751 = trunc i64 %indvars.iv519 to i32
  %reass.add256 = sub i32 %751, %20
  %reass.mul257 = mul i32 %reass.add256, %24
  %t2910 = add i32 %750, %reass.mul257
  ...
  %772 = shl nuw nsw i64 %indvars.iv519, 3
  %773 = getelementptr inbounds float, ptr %"inv_fft0_S1_R8_n0$2.011", i64 %772
  %774 = getelementptr inbounds float, ptr %"inv_fft0_S1_R8_n0$2.110", i64 %772
  store float 0.000000e+00, ptr %774, align 16, !tbaa !36
  %775 = or i64 %772, 1
  %776 = getelementptr inbounds float, ptr %"inv_fft0_S1_R8_n0$2.110", i64 %775
  %777 = or i64 %772, 2
  %778 = getelementptr inbounds float, ptr %"inv_fft0_S1_R8_n0$2.110", i64 %777
  ...
  %806 = or i64 %772, 4
  %807 = getelementptr inbounds float, ptr %"inv_fft0_S1_R8_n0$2.011", i64 %806
  %808 = getelementptr inbounds float, ptr %"inv_fft0_S1_R8_n0$2.110", i64 %806
  store float 0.000000e+00, ptr %808, align 16, !tbaa !36
  %809 = or i64 %772, 5
  %810 = getelementptr inbounds float, ptr %"inv_fft0_S1_R8_n0$2.110", i64 %809
  store float %801, ptr %810, align 4, !tbaa !36
  %811 = or i64 %772, 6
  %812 = getelementptr inbounds float, ptr %"inv_fft0_S1_R8_n0$2.110", i64 %811
  ...
  %843 = getelementptr inbounds float, ptr %"inv_fft0_S1_R8_n0$2.110", i64 %813
  store float %805, ptr %843, align 4, !tbaa !36
  %indvars.iv.next520 = add nuw nsw i64 %indvars.iv519, 1
  %.not21 = icmp eq i64 %indvars.iv.next520, 8
  br i1 %.not21, label %"for fwd_fft1_S1_R8_n1$2.s1.n0.g.preheader", label %"for fwd_fft0_S1_R8_n0$2.s1.n1"

"for fwd_fft1_S1_R8_n1$2.s1.n0.g.preheader":      ; preds = %"for fwd_fft0_S1_R8_n0$2.s1.n1"
  %844 = load <4 x float>, ptr %"inv_fft0_S1_R8_n0$2.011", align 16, !tbaa !34
  %845 = load <4 x float>, ptr %494, align 16, !tbaa !34
  %846 = fadd <4 x float> %844, %845
  %847 = load <4 x float>, ptr %"inv_fft0_S1_R8_n0$2.110", align 16, !tbaa !36
  ...
  store <4 x float> %901, ptr %"inv_X8$5.09", align 16, !tbaa !30
  store <4 x float> %902, ptr %"inv_X8$5.18", align 16, !tbaa !32
  ...
  store <4 x float> %970, ptr %"inv_fft1_S1_R8_n1$2.05", align 16, !tbaa !196
...
"assert succeeded83":                             ; preds = %"assert succeeded81"
  br i1 %735, label %"assert failed84", label %vector.body588, !prof !5

vector.body588:                                   ; preds = %"assert succeeded83", %vector.body588
  %index589 = phi i64 [ %index.next628, %vector.body588 ], [ 0, %"assert succeeded83" ]
  %993 = shl nuw nsw i64 %index589, 3
  %994 = getelementptr inbounds float, ptr %"inv_X8$5.09", i64 %993
  %wide.vec590 = load <32 x float>, ptr %994, align 16, !tbaa !30
  %strided.vec591 = shufflevector <32 x float> %wide.vec590, <32 x float> poison, <4 x i32> <i32 0, i32 8, i32 16, i32 24>
  %strided.vec592 = shufflevector <32 x float> %wide.vec590, <32 x float> poison, <4 x i32> <i32 1, i32 9, i32 17, i32 25>
  %strided.vec593 = shufflevector <32 x float> %wide.vec590, <32 x float> poison, <4 x i32> <i32 2, i32 10, i32 18, i32 26>
  %strided.vec594 = shufflevector <32 x float> %wide.vec590, <32 x float> poison, <4 x i32> <i32 3, i32 11, i32 19, i32 27>
  %strided.vec595 = shufflevector <32 x float> %wide.vec590, <32 x float> poison, <4 x i32> <i32 4, i32 12, i32 20, i32 28>
  %strided.vec596 = shufflevector <32 x float> %wide.vec590, <32 x float> poison, <4 x i32> <i32 5, i32 13, i32 21, i32 29>
  %strided.vec597 = shufflevector <32 x float> %wide.vec590, <32 x float> poison, <4 x i32> <i32 6, i32 14, i32 22, i32 30>
  %strided.vec598 = shufflevector <32 x float> %wide.vec590, <32 x float> poison, <4 x i32> <i32 7, i32 15, i32 23, i32 31>
  %995 = getelementptr inbounds float, ptr %"kernel_fft1_S1_R8_n1$2.013", i64 %993
  %wide.vec599 = load <32 x float>, ptr %995, align 16, !tbaa !38
  %strided.vec600 = shufflevector <32 x float> %wide.vec599, <32 x float> poison, <4 x i32> <i32 0, i32 8, i32 16, i32 24>
  %strided.vec601 = shufflevector <32 x float> %wide.vec599, <32 x float> poison, <4 x i32> <i32 1, i32 9, i32 17, i32 25>
  %strided.vec602 = shufflevector <32 x float> %wide.vec599, <32 x float> poison, <4 x i32> <i32 2, i32 10, i32 18, i32 26>
  %strided.vec603 = shufflevector <32 x float> %wide.vec599, <32 x float> poison, <4 x i32> <i32 3, i32 11, i32 19, i32 27>
  %strided.vec604 = shufflevector <32 x float> %wide.vec599, <32 x float> poison, <4 x i32> <i32 4, i32 12, i32 20, i32 28>
  %strided.vec605 = shufflevector <32 x float> %wide.vec599, <32 x float> poison, <4 x i32> <i32 5, i32 13, i32 21, i32 29>
  %strided.vec606 = shufflevector <32 x float> %wide.vec599, <32 x float> poison, <4 x i32> <i32 6, i32 14, i32 22, i32 30>
  %strided.vec607 = shufflevector <32 x float> %wide.vec599, <32 x float> poison, <4 x i32> <i32 7, i32 15, i32 23, i32 31>
  %996 = fmul <4 x float> %strided.vec591, %strided.vec600
  %997 = getelementptr inbounds float, ptr %"inv_X8$5.18", i64 %993
  %wide.vec608 = load <32 x float>, ptr %997, align 16, !tbaa !32
  %strided.vec609 = shufflevector <32 x float> %wide.vec608, <32 x float> poison, <4 x i32> <i32 0, i32 8, i32 16, i32 24>
  %strided.vec610 = shufflevector <32 x float> %wide.vec608, <32 x float> poison, <4 x i32> <i32 1, i32 9, i32 17, i32 25>
  %strided.vec611 = shufflevector <32 x float> %wide.vec608, <32 x float> poison, <4 x i32> <i32 2, i32 10, i32 18, i32 26>
  %strided.vec612 = shufflevector <32 x float> %wide.vec608, <32 x float> poison, <4 x i32> <i32 3, i32 11, i32 19, i32 27>
  %strided.vec613 = shufflevector <32 x float> %wide.vec608, <32 x float> poison, <4 x i32> <i32 4, i32 12, i32 20, i32 28>
  %strided.vec614 = shufflevector <32 x float> %wide.vec608, <32 x float> poison, <4 x i32> <i32 5, i32 13, i32 21, i32 29>
  %strided.vec615 = shufflevector <32 x float> %wide.vec608, <32 x float> poison, <4 x i32> <i32 6, i32 14, i32 22, i32 30>
  %strided.vec616 = shufflevector <32 x float> %wide.vec608, <32 x float> poison, <4 x i32> <i32 7, i32 15, i32 23, i32 31>
  %998 = getelementptr inbounds float, ptr %"kernel_fft1_S1_R8_n1$2.112", i64 %993
  %wide.vec617 = load <32 x float>, ptr %998, align 16, !tbaa !40
  %strided.vec618 = shufflevector <32 x float> %wide.vec617, <32 x float> poison, <4 x i32> <i32 0, i32 8, i32 16, i32 24>
  %strided.vec619 = shufflevector <32 x float> %wide.vec617, <32 x float> poison, <4 x i32> <i32 1, i32 9, i32 17, i32 25>
  %strided.vec620 = shufflevector <32 x float> %wide.vec617, <32 x float> poison, <4 x i32> <i32 2, i32 10, i32 18, i32 26>
  %strided.vec621 = shufflevector <32 x float> %wide.vec617, <32 x float> poison, <4 x i32> <i32 3, i32 11, i32 19, i32 27>
  %strided.vec622 = shufflevector <32 x float> %wide.vec617, <32 x float> poison, <4 x i32> <i32 4, i32 12, i32 20, i32 28>
  %strided.vec623 = shufflevector <32 x float> %wide.vec617, <32 x float> poison, <4 x i32> <i32 5, i32 13, i32 21, i32 29>
  %strided.vec624 = shufflevector <32 x float> %wide.vec617, <32 x float> poison, <4 x i32> <i32 6, i32 14, i32 22, i32 30>
  %strided.vec625 = shufflevector <32 x float> %wide.vec617, <32 x float> poison, <4 x i32> <i32 7, i32 15, i32 23, i32 31>
  %999 = fmul <4 x float> %strided.vec609, %strided.vec618
  %1000 = fsub <4 x float> %996, %999
  %1001 = fmul <4 x float> %strided.vec595, %strided.vec604
  %1002 = fmul <4 x float> %strided.vec613, %strided.vec622
  %1003 = fsub <4 x float> %1001, %1002
  %1004 = fadd <4 x float> %1000, %1003
  %1005 = fmul <4 x float> %strided.vec591, %strided.vec618
  %1006 = fmul <4 x float> %strided.vec600, %strided.vec609
  %1007 = fadd <4 x float> %1006, %1005
  %1008 = fmul <4 x float> %strided.vec595, %strided.vec622
  %1009 = fmul <4 x float> %strided.vec604, %strided.vec613
  %1010 = fadd <4 x float> %1009, %1008
  %1011 = fadd <4 x float> %1007, %1010
  %1012 = fmul <4 x float> %strided.vec593, %strided.vec602
  %1013 = fmul <4 x float> %strided.vec611, %strided.vec620
  %1014 = fsub <4 x float> %1012, %1013
  %1015 = fmul <4 x float> %strided.vec597, %strided.vec606
  %1016 = fmul <4 x float> %strided.vec615, %strided.vec624
  %1017 = fsub <4 x float> %1015, %1016
  %1018 = fadd <4 x float> %1014, %1017
  %1019 = fmul <4 x float> %strided.vec593, %strided.vec620
  %1020 = fmul <4 x float> %strided.vec602, %strided.vec611
  %1021 = fadd <4 x float> %1020, %1019
  %1022 = fmul <4 x float> %strided.vec597, %strided.vec624
  %1023 = fmul <4 x float> %strided.vec606, %strided.vec615
  ...
  %1040 = fmul <4 x float> %strided.vec592, %strided.vec601
  %1041 = fmul <4 x float> %strided.vec610, %strided.vec619
  %1042 = fsub <4 x float> %1040, %1041
  %1043 = fmul <4 x float> %strided.vec596, %strided.vec605
  %1044 = fmul <4 x float> %strided.vec614, %strided.vec623
  %1045 = fsub <4 x float> %1043, %1044
  %1046 = fadd <4 x float> %1042, %1045
  %1047 = fmul <4 x float> %strided.vec592, %strided.vec619
  %1048 = fmul <4 x float> %strided.vec601, %strided.vec610
  %1049 = fadd <4 x float> %1048, %1047
  %1050 = fmul <4 x float> %strided.vec596, %strided.vec623
  %1051 = fmul <4 x float> %strided.vec605, %strided.vec614
  %1052 = fadd <4 x float> %1051, %1050
  %1053 = fadd <4 x float> %1049, %1052
  %1054 = fmul <4 x float> %strided.vec594, %strided.vec603
  %1055 = fmul <4 x float> %strided.vec612, %strided.vec621
  %1056 = fsub <4 x float> %1054, %1055
  %1057 = or i64 %993, 7
  %1058 = fmul <4 x float> %strided.vec598, %strided.vec607
  %1059 = fmul <4 x float> %strided.vec616, %strided.vec625
  %1060 = fsub <4 x float> %1058, %1059
  %1061 = fadd <4 x float> %1056, %1060
  %1062 = fmul <4 x float> %strided.vec594, %strided.vec621
  %1063 = fmul <4 x float> %strided.vec603, %strided.vec612
  %1064 = fadd <4 x float> %1063, %1062
  %1065 = fmul <4 x float> %strided.vec598, %strided.vec625
  %1066 = fmul <4 x float> %strided.vec607, %strided.vec616
  ...
  %interleaved.vec626 = shufflevector <16 x float> %1112, <16 x float> %1113, <32 x i32> <i32 0, i32 4, i32 8, i32 12, i32 16, i32 20, i32 24, i32 28, i32 1, i32 5, i32 9, i32 13, i32 17, i32 21, i32 25, i32 29, i32 2, i32 6, i32 10, i32 14, i32 18, i32 22, i32 26, i32 30, i32 3, i32 7, i32 11, i32 15, i32 19, i32 23, i32 27, i32 31>
  store <32 x float> %interleaved.vec626, ptr %gep, align 16, !tbaa !34
  %gep630 = getelementptr float, ptr %invariant.gep629, i64 %1057
  ...
  %interleaved.vec627 = shufflevector <16 x float> %1118, <16 x float> %1119, <32 x i32> <i32 0, i32 4, i32 8, i32 12, i32 16, i32 20, i32 24, i32 28, i32 1, i32 5, i32 9, i32 13, i32 17, i32 21, i32 25, i32 29, i32 2, i32 6, i32 10, i32 14, i32 18, i32 22, i32 26, i32 30, i32 3, i32 7, i32 11, i32 15, i32 19, i32 23, i32 27, i32 31>
  store <32 x float> %interleaved.vec627, ptr %gep630, align 16, !tbaa !36
  %index.next628 = add nuw i64 %index589, 4
  %1120 = icmp eq i64 %index.next628, 8
  br i1 %1120, label %"for inv_fft1_S1_R8_n1$2.s1.n0.g.preheader", label %vector.body588, !llvm.loop !198
...
"for inv_fft1_S1_R8_n1$2.s1.n0.g.preheader":      ; preds = %vector.body588
  %1122 = load <4 x float>, ptr %"inv_fft0_S1_R8_n0$2.011", align 16, !tbaa !34
  ...
  %1128 = load <4 x float>, ptr %506, align 16, !tbaa !36
  %1129 = load <4 x float>, ptr %508, align 16, !tbaa !36
  %1130 = fadd <4 x float> %1124, %1127
  %1131 = fsub <4 x float> %1124, %1127
  %1132 = fsub <4 x float> %1122, %1123
  %1133 = fsub <4 x float> %1129, %1128
  %1134 = fadd <4 x float> %1132, %1133
  %1135 = fsub <4 x float> %1132, %1133
  ...
  %1162 = fadd <4 x float> %1130, %1148
  %1163 = fadd <4 x float> %1134, %1157
  %1164 = fadd <4 x float> %1131, %1149
  %1165 = fadd <4 x float> %1135, %1161
  %1166 = fsub <4 x float> %1130, %1148
  %1167 = fsub <4 x float> %1134, %1157
  %1168 = fsub <4 x float> %1131, %1149
  %1169 = fsub <4 x float> %1135, %1161
  store <4 x float> %1162, ptr %"inv_fft1_S1_R8_n1$2.05", align 16, !tbaa !201
  ...
  %1220 = fadd <4 x float> %1173, %1174
  %1221 = fadd <4 x float> %1178, %1179
  %1222 = fadd <4 x float> %1220, %1221
  %1223 = fsub <4 x float> %1220, %1221
  %1224 = fsub <4 x float> %1173, %1174
  %1225 = fsub <4 x float> %1175, %1176
  %1226 = fadd <4 x float> %1224, %1225
  %1227 = fsub <4 x float> %1224, %1225
  %1228 = fadd <4 x float> %1191, %1197
  %1229 = fsub <4 x float> %1188, %1194
  %1230 = fadd <4 x float> %1205, %1204
  ...
  %1232 = fsub <4 x float> %1200, %1202
  %1233 = fadd <4 x float> %1209, %1232
  ...
  %1235 = fadd <4 x float> %1222, %1228
  %1236 = fadd <4 x float> %1226, %1231
  %1237 = fadd <4 x float> %1223, %1229
  %1238 = fadd <4 x float> %1227, %1234
  %1239 = fsub <4 x float> %1222, %1228
  %1240 = fsub <4 x float> %1226, %1231
  %1241 = fsub <4 x float> %1223, %1229
  %1242 = fsub <4 x float> %1227, %1234
  store <4 x float> %1212, ptr %478, align 16, !tbaa !42
  store <4 x float> %1235, ptr %699, align 16, !tbaa !52
  store <4 x float> %1214, ptr %479, align 16, !tbaa !62
  store <4 x float> %1237, ptr %700, align 16, !tbaa !65
  ...
  store <4 x float> %1223, ptr %702, align 16, !tbaa !81
  store <4 x float> %1213, ptr %482, align 16, !tbaa !84
  store <4 x float> %1236, ptr %703, align 16, !tbaa !86
  ...
  store <4 x float> %1226, ptr %705, align 16, !tbaa !94
  store <4 x float> %1185, ptr %485, align 16, !tbaa !96
  store <4 x float> %1227, ptr %706, align 16, !tbaa !98
  ...
  store <4 x float> %1241, ptr %708, align 16, !tbaa !111
  store <4 x float> %1198, ptr %488, align 16, !tbaa !114
  store <4 x float> %1228, ptr %709, align 16, !tbaa !118
  store <4 x float> %1199, ptr %489, align 16, !tbaa !122
  store <4 x float> %1229, ptr %710, align 16, !tbaa !125
  store <4 x float> %1217, ptr %490, align 16, !tbaa !128
  store <4 x float> %1240, ptr %711, align 16, !tbaa !130
  ...
  store <4 x float> %1231, ptr %713, align 16, !tbaa !138
  store <4 x float> %1211, ptr %"inv_X8$5.09", align 16, !tbaa !140
  store <4 x float> %1234, ptr %"inv_X8$5.18", align 16, !tbaa !142
...
"for result$2.s0.n1.preheader":                   ; preds = %"for inv_fft1_S1_R8_n1$2.s1.n0.g.preheader"
  %reass.add263 = sub nsw i64 %indvars.iv537, %743
  %reass.mul264 = mul i64 %reass.add263, %248
  %1243 = sub i64 %reass.mul264, %741
  %1244 = add i64 %746, %reass.mul264
  br label %"for result$2.s0.n1"

"for result$2.s0.n1":                             ; preds = %"for result$2.s0.n1.preheader", %"end for result$2.s0.n0.n091"
  %indvars.iv534 = phi i64 [ %742, %"for result$2.s0.n1.preheader" ], [ %indvars.iv.next535, %"end for result$2.s0.n0.n091" ]
...
"for result$2.s0.n0.n0.preheader":                ; preds = %"for result$2.s0.n1"
  %1245 = shl nsw i64 %indvars.iv534, 3
  %reass.add265 = sub nsw i64 %indvars.iv534, %742
  %reass.mul266 = mul i64 %reass.add265, %241
  %1246 = add i64 %1243, %reass.mul266
...
"end for result$2.s0.n1":                         ; preds = %"end for result$2.s0.n0.n091", %"for inv_fft1_S1_R8_n1$2.s1.n0.g.preheader"
  ...
  %1247 = trunc i64 %indvars.iv.next538 to i32
  %.not25 = icmp eq i32 %173, %1247
...
"for result$2.s0.n0.n0":                          ; preds = %"for result$2.s0.n0.n0.preheader", %"for result$2.s0.n0.n0"
  %indvars.iv531 = phi i64 [ %indvars.iv.next532.1, %"for result$2.s0.n0.n0" ], [ 0, %"for result$2.s0.n0.n0.preheader" ]
  %niter = phi i64 [ %niter.next.1, %"for result$2.s0.n0.n0" ], [ 0, %"for result$2.s0.n0.n0.preheader" ]
  %1248 = shl nuw nsw i64 %indvars.iv531, 2
  %1249 = add nsw i64 %1248, %741
  %1250 = add nsw i64 %1249, %1245
  %1251 = getelementptr inbounds float, ptr %"inv_fft1_S1_R8_n1$2.05", i64 %1250
  ...
  %indvars.iv.next532 = shl i64 %indvars.iv531, 2
  %1256 = or i64 %indvars.iv.next532, 4
  %1257 = add nsw i64 %1256, %741
  %1258 = add nsw i64 %1257, %1245
  %1259 = getelementptr inbounds float, ptr %"inv_fft1_S1_R8_n1$2.05", i64 %1258
  ...
  %indvars.iv.next532.1 = add nuw nsw i64 %indvars.iv531, 2
...
"end for result$2.s0.n0.n0.loopexit.unr-lcssa":   ; preds = %"for result$2.s0.n0.n0", %"for result$2.s0.n0.n0.preheader"
  %indvars.iv531.unr = phi i64 [ 0, %"for result$2.s0.n0.n0.preheader" ], [ %indvars.iv.next532.1, %"for result$2.s0.n0.n0" ]
...
"for result$2.s0.n0.n0.epil":                     ; preds = %"end for result$2.s0.n0.n0.loopexit.unr-lcssa"
  %1264 = shl nuw nsw i64 %indvars.iv531.unr, 2
  %1265 = add nsw i64 %1264, %741
  %1266 = add nsw i64 %1265, %1245
  %1267 = getelementptr inbounds float, ptr %"inv_fft1_S1_R8_n1$2.05", i64 %1266
...
"for result$2.s0.n0.n090.preheader":              ; preds = %"end for result$2.s0.n0.n0"
  %1272 = shl nsw i64 %indvars.iv534, 3
  %1273 = add nsw i64 %745, %1272
  %1274 = getelementptr inbounds float, ptr %"inv_fft1_S1_R8_n1$2.05", i64 %1273
  ...
  %reass.add274 = sub nsw i64 %indvars.iv534, %742
  %reass.mul275 = mul i64 %reass.add274, %241
  %1277 = add i64 %1244, %reass.mul275
...
"end for result$2.s0.n0.n091":                    ; preds = %"for result$2.s0.n0.n090.preheader", %"end for result$2.s0.n0.n0"
  ...
  %1279 = trunc i64 %indvars.iv.next535 to i32
  %.not26 = icmp eq i32 %733, %1279
