...
if.end:                                           ; preds = %if.then
  ...
  br i1 %cmp418.not, label %if.end242.critedge, label %for.body.preheader
...
for.end:                                          ; preds = %for.inc.epil, %for.end.unr-lcssa
  ...
  br i1 %cmp23.not431, label %if.end242.critedge, label %for.body25.lr.ph
...
for.cond29.preheader:                             ; preds = %for.body25
  %call31 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %start.0433) #18
...
for.body34:                                       ; preds = %for.cond29.preheader, %for.inc51
  ...
  switch i8 %9, label %for.inc51 [
    ...
    i8 42, label %if.end54.loopexit.split.loop.exit510
  ]

for.inc51:                                        ; preds = %for.body34
  %inc52 = add nuw nsw i64 %conv30428, 1
...
if.end54.loopexit.split.loop.exit:                ; preds = %for.body34
  %arrayidx36.le514 = getelementptr inbounds i8, ptr %start.0433, i64 %conv30428
  br label %if.end54

if.end54.loopexit.split.loop.exit510:             ; preds = %for.body34
  %arrayidx36.le = getelementptr inbounds i8, ptr %start.0433, i64 %conv30428
  br label %if.end54

if.end54:                                         ; preds = %for.inc51, %if.end54.loopexit.split.loop.exit510, %if.end54.loopexit.split.loop.exit, %for.cond29.preheader
  %pt.1 = phi ptr [ %arrayidx36.le514, %if.end54.loopexit.split.loop.exit ], [ %pt.0432, %for.cond29.preheader ], [ %arrayidx36.le, %if.end54.loopexit.split.loop.exit510 ], [ %pt.0432, %for.inc51 ]
  %asterisk.1 = phi i32 [ 0, %if.end54.loopexit.split.loop.exit ], [ %asterisk.0436, %for.cond29.preheader ], [ 1, %if.end54.loopexit.split.loop.exit510 ], [ %asterisk.0436, %for.inc51 ]
  ...
  %call59 = tail call i32 @cli_ac_addsig(ptr noundef %root, ptr noundef %virname, ptr noundef %start.0433, i32 noundef %10, i16 noundef zeroext %conv56, i16 noundef zeroext %conv57, i16 noundef zeroext %type, i32 noundef %mindist.0438, i32 noundef %maxdist.0439, ptr noundef %offset, i8 noundef zeroext %conv58) #19
...
if.end54.thread:                                  ; preds = %for.body25
  ...
  %call59388 = tail call i32 @cli_ac_addsig(ptr noundef %root, ptr noundef %virname, ptr noundef %start.0433, i32 noundef %11, i16 noundef zeroext %conv56, i16 noundef zeroext %conv56, i16 noundef zeroext %type, i32 noundef %mindist.0438, i32 noundef %maxdist.0439, ptr noundef %offset, i8 noundef zeroext %conv58) #19
  %tobool60.not389 = icmp eq i32 %call59388, 0
  br i1 %tobool60.not389, label %if.end242.critedge, label %if.then61
...
for.body122.preheader:                            ; preds = %if.then114
  %wide.trip.count481 = and i64 %call117, 4294967295
  %min.iters.check = icmp ult i64 %wide.trip.count481, 8
  br i1 %min.iters.check, label %for.body122.preheader546, label %vector.ph

vector.ph:                                        ; preds = %for.body122.preheader
  %n.mod.vf = and i64 %call117, 7
  %n.vec = sub nsw i64 %wide.trip.count481, %n.mod.vf
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ]
  %vec.phi = phi <4 x i32> [ zeroinitializer, %vector.ph ], [ %20, %vector.body ]
  %vec.phi539 = phi <4 x i32> [ zeroinitializer, %vector.ph ], [ %21, %vector.body ]
  %14 = getelementptr inbounds i8, ptr %hexsig, i64 %index
  %wide.load = load <4 x i8>, ptr %14, align 1, !tbaa !12
  %15 = getelementptr inbounds i8, ptr %14, i64 4
  %wide.load540 = load <4 x i8>, ptr %15, align 1, !tbaa !12
  %16 = icmp eq <4 x i8> %wide.load, <i8 42, i8 42, i8 42, i8 42>
  %17 = icmp eq <4 x i8> %wide.load540, <i8 42, i8 42, i8 42, i8 42>
  %18 = zext <4 x i1> %16 to <4 x i32>
  %19 = zext <4 x i1> %17 to <4 x i32>
  %20 = add <4 x i32> %vec.phi, %18
  %21 = add <4 x i32> %vec.phi539, %19
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %for.end133, label %for.body122.preheader546

for.body122.preheader546:                         ; preds = %for.body122.preheader, %middle.block
...
for.body122:                                      ; preds = %for.body122.preheader546, %for.body122
  %indvars.iv477 = phi i64 [ %indvars.iv.next478, %for.body122 ], [ %indvars.iv477.ph, %for.body122.preheader546 ]
  %parts.3442 = phi i32 [ %spec.select381, %for.body122 ], [ %parts.3442.ph, %for.body122.preheader546 ]
  ...
  %spec.select381 = add i32 %parts.3442, %inc129
  %indvars.iv.next478 = add nuw nsw i64 %indvars.iv477, 1
  %exitcond482.not = icmp eq i64 %indvars.iv.next478, %wide.trip.count481
  br i1 %exitcond482.not, label %for.end133, label %for.body122, !llvm.loop !22
...
if.then145:                                       ; preds = %for.body141
  tail call void (ptr, ...) @cli_errmsg(ptr noundef nonnull @.str.3, i32 noundef %i.3445) #19
  br label %cleanup
...
if.end242.critedge:                               ; preds = %for.inc105, %if.end, %for.end, %if.end54.thread
  tail call void @free(ptr noundef %call1) #19
  br label %cleanup
...
if.end.i205:                                      ; preds = %if.then99
  ...
  %tobool5.not.i204 = icmp eq ptr %5, null
...
if.then.i213:                                     ; preds = %if.end110
  ...
  %tobool1.not.i212 = icmp eq ptr %6, null
...
if.end.i217:                                      ; preds = %if.then2.i214, %if.then.i213
  ...
  %tobool5.not.i216 = icmp eq ptr %7, null
...
while.body:                                       ; preds = %while.cond.outer, %while.cond.backedge
  %line.0217 = phi i32 [ %inc, %while.cond.backedge ], [ %line.0.ph, %while.cond.outer ]
  %inc = add nsw i32 %line.0217, 1
...
while.cond.outer:                                 ; preds = %while.cond.preheader, %if.end102
  ...
  %call5215 = call ptr @fgets(ptr noundef nonnull %buffer, i32 noundef 8192, ptr noundef %fd)
  %tobool6.not216 = icmp eq ptr %call5215, null
  br i1 %tobool6.not216, label %while.end.thread, label %while.body
