; ModuleID = '/usr/local/google/home/aeubanks/repos/test-suite/Bitcode/simd_ops/x86_tests/test_op_pminsw_178.bc'
...
@str.11 = private constant [14 x i8] c"op_pminsw_178\00", align 32
...
define i32 @__test_op(ptr noalias nocapture readnone %in_f32.buffer, ptr noalias nocapture readnone %in_f64.buffer, ptr noalias nocapture readnone %in_i8.buffer, ptr noalias nocapture readnone %in_u8.buffer, ptr noalias nocapture readonly %in_i16.buffer, ptr noalias nocapture readnone %in_u16.buffer, ptr noalias nocapture readnone %in_i32.buffer, ptr noalias nocapture readnone %in_u32.buffer, ptr noalias nocapture readnone %in_i64.buffer, ptr noalias nocapture readnone %in_u64.buffer, ptr noalias nocapture readonly %op_pminsw_178.buffer) local_unnamed_addr #0 {
"produce op_pminsw_178":
  %buf_extent168 = getelementptr inbounds %struct.buffer_t, ptr %op_pminsw_178.buffer, i64 0, i32 2, i64 1
  %op_pminsw_178.extent.1 = load i32, ptr %buf_extent168, align 4
  %buf_min176 = getelementptr inbounds %struct.buffer_t, ptr %op_pminsw_178.buffer, i64 0, i32 4, i64 1
  %op_pminsw_178.min.1 = load i32, ptr %buf_min176, align 4
  %0 = add nsw i32 %op_pminsw_178.min.1, %op_pminsw_178.extent.1
  %1 = icmp sgt i32 %op_pminsw_178.extent.1, 0
  br i1 %1, label %"for op_pminsw_178.s0.y.preheader", label %destructor_block, !prof !4

"for op_pminsw_178.s0.y.preheader":               ; preds = %"produce op_pminsw_178"
  ...
  %buf_min175 = getelementptr inbounds %struct.buffer_t, ptr %op_pminsw_178.buffer, i64 0, i32 4, i64 0
  %op_pminsw_178.min.0 = load i32, ptr %buf_min175, align 4
  %2 = sext i32 %op_pminsw_178.min.0 to i64
  %buf_stride172 = getelementptr inbounds %struct.buffer_t, ptr %op_pminsw_178.buffer, i64 0, i32 3, i64 1
  %op_pminsw_178.stride.1 = load i32, ptr %buf_stride172, align 4
  %3 = sext i32 %op_pminsw_178.stride.1 to i64
  %buf_host163 = getelementptr inbounds %struct.buffer_t, ptr %op_pminsw_178.buffer, i64 0, i32 1
  %op_pminsw_178.host = load ptr, ptr %buf_host163, align 8
  %4 = shl nsw i64 %2, 3
  %5 = sub nsw i64 96, %4
  %scevgep = getelementptr i8, ptr %op_pminsw_178.host, i64 %5
  %6 = shl nsw i64 %3, 3
  %sunkaddr = ptrtoint ptr %in_i16.host to i64
  %a97 = load <16 x i16>, ptr %in_i16.host, align 32, !tbaa !5
  %sunkaddr210 = add i64 %sunkaddr, 32
  %sunkaddr211 = inttoptr i64 %sunkaddr210 to ptr
  %b110 = load <16 x i16>, ptr %sunkaddr211, align 32, !tbaa !5
  %7 = tail call <16 x i16> @llvm.smin.v16i16(<16 x i16> %b110, <16 x i16> %a97)
  ...
  %b110.1 = load <16 x i16>, ptr %sunkaddr211.1, align 32, !tbaa !5
  %13 = tail call <16 x i16> @llvm.smin.v16i16(<16 x i16> %b110.1, <16 x i16> %b110)
  ...
  %a97.2 = load <16 x i16>, ptr %sunkaddr207.2, align 32, !tbaa !5
  %sunkaddr210.2 = add i64 %sunkaddr, 96
  %sunkaddr211.2 = inttoptr i64 %sunkaddr210.2 to ptr
  %b110.2 = load <16 x i16>, ptr %sunkaddr211.2, align 32, !tbaa !5
  %19 = tail call <16 x i16> @llvm.smin.v16i16(<16 x i16> %b110.2, <16 x i16> %a97.2)
  ...
  %a97.3 = load <16 x i16>, ptr %sunkaddr207.3, align 32, !tbaa !5
  %sunkaddr210.3 = add i64 %sunkaddr, 128
  %sunkaddr211.3 = inttoptr i64 %sunkaddr210.3 to ptr
  %b110.3 = load <16 x i16>, ptr %sunkaddr211.3, align 32, !tbaa !5
  %25 = tail call <16 x i16> @llvm.smin.v16i16(<16 x i16> %b110.3, <16 x i16> %a97.3)
  ...
  %a97.4 = load <16 x i16>, ptr %sunkaddr207.4, align 32, !tbaa !5
  %sunkaddr210.4 = add i64 %sunkaddr, 160
  %sunkaddr211.4 = inttoptr i64 %sunkaddr210.4 to ptr
  %b110.4 = load <16 x i16>, ptr %sunkaddr211.4, align 32, !tbaa !5
  %31 = tail call <16 x i16> @llvm.smin.v16i16(<16 x i16> %b110.4, <16 x i16> %a97.4)
  ...
  %a97.5 = load <16 x i16>, ptr %sunkaddr207.5, align 32, !tbaa !5
  %sunkaddr210.5 = add i64 %sunkaddr, 192
  %sunkaddr211.5 = inttoptr i64 %sunkaddr210.5 to ptr
  %b110.5 = load <16 x i16>, ptr %sunkaddr211.5, align 32, !tbaa !5
  %37 = tail call <16 x i16> @llvm.smin.v16i16(<16 x i16> %b110.5, <16 x i16> %a97.5)
  ...
  %a97.6 = load <16 x i16>, ptr %sunkaddr207.6, align 32, !tbaa !5
  %sunkaddr210.6 = add i64 %sunkaddr, 224
  %sunkaddr211.6 = inttoptr i64 %sunkaddr210.6 to ptr
  %b110.6 = load <16 x i16>, ptr %sunkaddr211.6, align 32, !tbaa !5
  %43 = tail call <16 x i16> @llvm.smin.v16i16(<16 x i16> %b110.6, <16 x i16> %a97.6)
  ...
  %a97.7 = load <16 x i16>, ptr %sunkaddr207.7, align 32, !tbaa !5
  %sunkaddr210.7 = add i64 %sunkaddr, 256
  %sunkaddr211.7 = inttoptr i64 %sunkaddr210.7 to ptr
  %b110.7 = load <16 x i16>, ptr %sunkaddr211.7, align 32, !tbaa !5
  %49 = tail call <16 x i16> @llvm.smin.v16i16(<16 x i16> %b110.7, <16 x i16> %a97.7)
  ...
  %a97.8 = load <16 x i16>, ptr %sunkaddr207.8, align 32, !tbaa !5
  %sunkaddr210.8 = add i64 %sunkaddr, 288
  %sunkaddr211.8 = inttoptr i64 %sunkaddr210.8 to ptr
  %b110.8 = load <16 x i16>, ptr %sunkaddr211.8, align 32, !tbaa !5
  %55 = tail call <16 x i16> @llvm.smin.v16i16(<16 x i16> %b110.8, <16 x i16> %a97.8)
  ...
  br label %"for op_pminsw_178.s0.x.x.preheader"

"for op_pminsw_178.s0.x.x.preheader":             ; preds = %"for op_pminsw_178.s0.x.x.preheader", %"for op_pminsw_178.s0.y.preheader"
  %lsr.iv180 = phi ptr [ %scevgep, %"for op_pminsw_178.s0.y.preheader" ], [ %scevgep182, %"for op_pminsw_178.s0.x.x.preheader" ]
  %op_pminsw_178.s0.y = phi i32 [ %op_pminsw_178.min.1, %"for op_pminsw_178.s0.y.preheader" ], [ %103, %"for op_pminsw_178.s0.x.x.preheader" ]
  ...
  %a97.9 = load <16 x i16>, ptr %sunkaddr207.9, align 32, !tbaa !5
  %b110.9 = load <16 x i16>, ptr %sunkaddr211.9, align 32, !tbaa !5
  %61 = tail call <16 x i16> @llvm.smin.v16i16(<16 x i16> %b110.9, <16 x i16> %a97.9)
  ...
  %a97.10 = load <16 x i16>, ptr %sunkaddr207.10, align 32, !tbaa !5
  %b110.10 = load <16 x i16>, ptr %sunkaddr211.10, align 32, !tbaa !5
  %67 = tail call <16 x i16> @llvm.smin.v16i16(<16 x i16> %b110.10, <16 x i16> %a97.10)
  ...
  %a97.11 = load <16 x i16>, ptr %sunkaddr207.11, align 32, !tbaa !5
  %b110.11 = load <16 x i16>, ptr %sunkaddr211.11, align 32, !tbaa !5
  %73 = tail call <16 x i16> @llvm.smin.v16i16(<16 x i16> %b110.11, <16 x i16> %a97.11)
  ...
  %a97.12 = load <16 x i16>, ptr %sunkaddr207.12, align 32, !tbaa !5
  %b110.12 = load <16 x i16>, ptr %sunkaddr211.12, align 32, !tbaa !5
  %79 = tail call <16 x i16> @llvm.smin.v16i16(<16 x i16> %b110.12, <16 x i16> %a97.12)
  ...
  %a97.13 = load <16 x i16>, ptr %sunkaddr207.13, align 32, !tbaa !5
  %b110.13 = load <16 x i16>, ptr %sunkaddr211.13, align 32, !tbaa !5
  %85 = tail call <16 x i16> @llvm.smin.v16i16(<16 x i16> %b110.13, <16 x i16> %a97.13)
  ...
  %a97.14 = load <16 x i16>, ptr %sunkaddr207.14, align 32, !tbaa !5
  %b110.14 = load <16 x i16>, ptr %sunkaddr211.14, align 32, !tbaa !5
  %91 = tail call <16 x i16> @llvm.smin.v16i16(<16 x i16> %b110.14, <16 x i16> %a97.14)
  ...
  %a97.15 = load <16 x i16>, ptr %sunkaddr207.15, align 32, !tbaa !5
  %b110.15 = load <16 x i16>, ptr %sunkaddr211.15, align 32, !tbaa !5
  %97 = tail call <16 x i16> @llvm.smin.v16i16(<16 x i16> %b110.15, <16 x i16> %a97.15)
  ...
  %103 = add nsw i32 %op_pminsw_178.s0.y, 1
  %scevgep182 = getelementptr i1, ptr %lsr.iv180, i64 %6
  %.not2 = icmp eq i32 %103, %0
  br i1 %.not2, label %destructor_block, label %"for op_pminsw_178.s0.x.x.preheader"

destructor_block:                                 ; preds = %"for op_pminsw_178.s0.x.x.preheader", %"produce op_pminsw_178"
  ret i32 0
}

; Function Attrs: nofree nosync nounwind memory(readwrite, inaccessiblemem: none)
define i32 @test_op(ptr noalias nocapture readnone %in_f32.buffer, ptr noalias nocapture readnone %in_f64.buffer, ptr noalias nocapture readnone %in_i8.buffer, ptr noalias nocapture readnone %in_u8.buffer, ptr noalias nocapture readonly %in_i16.buffer, ptr noalias nocapture readnone %in_u16.buffer, ptr noalias nocapture readnone %in_i32.buffer, ptr noalias nocapture readnone %in_u32.buffer, ptr noalias nocapture readnone %in_i64.buffer, ptr noalias nocapture readnone %in_u64.buffer, ptr noalias nocapture readonly %op_pminsw_178.buffer) local_unnamed_addr #1 {
destructor_block:
  %"__test_op_result$11" = tail call i32 @__test_op(ptr poison, ptr poison, ptr poison, ptr poison, ptr %in_i16.buffer, ptr poison, ptr poison, ptr poison, ptr poison, ptr poison, ptr %op_pminsw_178.buffer) #4
  ret i32 0
}
