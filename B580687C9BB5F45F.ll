...
if.end12:                                         ; preds = %for.body
  ...
  %11 = load i8, ptr %arrayidx22.4, align 1, !tbaa !5
  %conv23.4 = zext i8 %11 to i64
  %shl.4 = shl nuw nsw i64 %conv23.4, 32
  %12 = or i64 %10, %shl.4
  %add21.5 = or i64 %i.0145, 5
  %arrayidx22.5 = getelementptr inbounds i8, ptr %data, i64 %add21.5
  %13 = load i8, ptr %arrayidx22.5, align 1, !tbaa !5
  %conv23.5 = zext i8 %13 to i64
  %shl.5 = shl nuw nsw i64 %conv23.5, 40
  %14 = or i64 %shl.5, %conv23
  %add24.5 = or i64 %14, %12
  %15 = and i64 %add24.5, 65970697781248
  %or.cond = icmp eq i64 %15, 21990232555520
  br i1 %or.cond, label %if.then35, label %cleanup

if.then35:                                        ; preds = %if.end12
  %shr36 = lshr i64 %12, 18
  %16 = trunc i64 %shr36 to i32
  %conv38 = and i32 %16, 1048575
  %sh.diff = lshr i64 %add24.5, 21
  %tr.sh.diff = trunc i64 %sh.diff to i32
  %shl42 = and i32 %tr.sh.diff, 1048576
  %or = or i32 %conv38, %shl42
  %17 = add nuw nsw i32 %or, %4
...
if.end12.2:                                       ; preds = %cleanup.1
  ...
  %33 = load i8, ptr %arrayidx22.2156, align 1, !tbaa !5
  %conv23.2157 = zext i8 %33 to i64
  %add21.1.2 = or i64 %i.0145, 11
  %arrayidx22.1.2 = getelementptr inbounds i8, ptr %data, i64 %add21.1.2
  %34 = load i8, ptr %arrayidx22.1.2, align 1, !tbaa !5
  %conv23.1.2 = zext i8 %34 to i64
...
if.then35.2:                                      ; preds = %if.end12.2
  ...
  store i8 %34, ptr %arrayidx22.1.2, align 1, !tbaa !5
