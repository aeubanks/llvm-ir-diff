...
cleanup.cont:                                     ; preds = %entry
  ...
  %and.i106 = and i64 %2, 3
  %cmp.not.i107 = icmp ne i64 %and.i106, 0
  %cmp1.i108 = icmp slt i64 %2, 12
  %or.cond285.i109 = or i1 %cmp1.i108, %cmp.not.i107
  br i1 %or.cond285.i109, label %.loopexit, label %if.end.i.lr.ph
...
if.then16.i:                                      ; preds = %cleanup.cont12.i
  ...
  %cmp17316.i = icmp slt i64 %4, 0
  br i1 %cmp17316.i, label %cleanup98.i, label %if.end21.i

if.end21.i:                                       ; preds = %if.then16.i, %cleanup92.i
  %5 = phi i64 [ %10, %cleanup92.i ], [ %add.i, %if.then16.i ]
  %i.0317.i = phi i64 [ %add23.i, %cleanup92.i ], [ 0, %if.then16.i ]
  %spec.select.i = call i64 @llvm.umin.i64(i64 %5, i64 1024)
  %add23.i = add nuw nsw i64 %spec.select.i, %i.0317.i
...
if.then52.i:                                      ; preds = %for.body.i
  %and53326.i = and i64 %indvars.iv.i, 3
  %cmp54.not.i = icmp eq i64 %and53326.i, 0
...
Xz_ReadBackward.exit:                             ; preds = %if.end163.i
  ...
  br i1 %cmp4.not, label %cleanup.cont9, label %cleanup47.thread.loopexit.split.loop.exit131
...
cleanup24:                                        ; preds = %if.then11
  ...
  %.pre123 = load i64, ptr %p, align 8, !tbaa !23
  br label %if.end28

if.end28:                                         ; preds = %cleanup.cont9.if.end28_crit_edge, %cleanup24
  %30 = phi i64 [ %23, %cleanup.cont9.if.end28_crit_edge ], [ %.pre123, %cleanup24 ]
...
cleanup47.thread.loopexit.split.loop.exit131:     ; preds = %Xz_ReadBackward.exit
  %cond192.i.le = select i1 %cmp190.i, i32 0, i32 16
  %retval.14.i.le = select i1 %cmp180.not.i, i32 %cond192.i.le, i32 %call179.i
  br label %cleanup47.thread

cleanup47.thread:                                 ; preds = %if.then11, %land.lhs.true, %if.end33, %cleanup47.thread.loopexit.split.loop.exit131, %.loopexit
  %retval.6.ph = phi i32 [ %retval.15.i.ph, %.loopexit ], [ %retval.14.i.le, %cleanup47.thread.loopexit.split.loop.exit131 ], [ 2, %if.then11 ], [ 10, %land.lhs.true ], [ %call36, %if.end33 ]
