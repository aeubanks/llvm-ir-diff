; ModuleID = '/usr/local/google/home/aeubanks/repos/test-suite/Bitcode/simd_ops/x86_tests/test_op_vpmulhw_363.bc'
...
@str.11 = private constant [15 x i8] c"op_vpmulhw_363\00", align 32
...
define i32 @__test_op(ptr noalias nocapture readnone %in_f32.buffer, ptr noalias nocapture readnone %in_f64.buffer, ptr noalias nocapture readnone %in_i8.buffer, ptr noalias nocapture readnone %in_u8.buffer, ptr noalias nocapture readonly %in_i16.buffer, ptr noalias nocapture readnone %in_u16.buffer, ptr noalias nocapture readnone %in_i32.buffer, ptr noalias nocapture readnone %in_u32.buffer, ptr noalias nocapture readnone %in_i64.buffer, ptr noalias nocapture readnone %in_u64.buffer, ptr noalias nocapture readonly %op_vpmulhw_363.buffer) local_unnamed_addr #0 {
"produce op_vpmulhw_363":
  %buf_extent168 = getelementptr inbounds %struct.buffer_t, ptr %op_vpmulhw_363.buffer, i64 0, i32 2, i64 1
  %op_vpmulhw_363.extent.1 = load i32, ptr %buf_extent168, align 4
  %buf_min176 = getelementptr inbounds %struct.buffer_t, ptr %op_vpmulhw_363.buffer, i64 0, i32 4, i64 1
  %op_vpmulhw_363.min.1 = load i32, ptr %buf_min176, align 4
  %0 = add nsw i32 %op_vpmulhw_363.min.1, %op_vpmulhw_363.extent.1
  %1 = icmp sgt i32 %op_vpmulhw_363.extent.1, 0
  br i1 %1, label %"for op_vpmulhw_363.s0.y.preheader", label %destructor_block, !prof !4

"for op_vpmulhw_363.s0.y.preheader":              ; preds = %"produce op_vpmulhw_363"
  ...
  %buf_min175 = getelementptr inbounds %struct.buffer_t, ptr %op_vpmulhw_363.buffer, i64 0, i32 4, i64 0
  %op_vpmulhw_363.min.0 = load i32, ptr %buf_min175, align 4
  %2 = sext i32 %op_vpmulhw_363.min.0 to i64
  %buf_stride172 = getelementptr inbounds %struct.buffer_t, ptr %op_vpmulhw_363.buffer, i64 0, i32 3, i64 1
  %op_vpmulhw_363.stride.1 = load i32, ptr %buf_stride172, align 4
  %3 = sext i32 %op_vpmulhw_363.stride.1 to i64
  %buf_host163 = getelementptr inbounds %struct.buffer_t, ptr %op_vpmulhw_363.buffer, i64 0, i32 1
  %op_vpmulhw_363.host = load ptr, ptr %buf_host163, align 8
  %4 = shl nsw i64 %2, 3
  %5 = sub nsw i64 96, %4
  %scevgep = getelementptr i8, ptr %op_vpmulhw_363.host, i64 %5
  %6 = shl nsw i64 %3, 3
  ...
  %11 = tail call <8 x i16> @llvm.x86.sse2.pmulh.w(<8 x i16> %9, <8 x i16> %10) #4
  ...
  %14 = tail call <8 x i16> @llvm.x86.sse2.pmulh.w(<8 x i16> %12, <8 x i16> %13) #4
  ...
  %23 = tail call <8 x i16> @llvm.x86.sse2.pmulh.w(<8 x i16> %10, <8 x i16> %22) #4
  %24 = shufflevector <16 x i16> %21, <16 x i16> undef, <8 x i32> <i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %25 = tail call <8 x i16> @llvm.x86.sse2.pmulh.w(<8 x i16> %13, <8 x i16> %24) #4
  ...
  %27 = sitofp <16 x i16> %26 to <16 x double>
  ...
  %36 = tail call <8 x i16> @llvm.x86.sse2.pmulh.w(<8 x i16> %34, <8 x i16> %35) #4
  ...
  %39 = tail call <8 x i16> @llvm.x86.sse2.pmulh.w(<8 x i16> %37, <8 x i16> %38) #4
  ...
  %41 = sitofp <16 x i16> %40 to <16 x double>
  ...
  %50 = tail call <8 x i16> @llvm.x86.sse2.pmulh.w(<8 x i16> %48, <8 x i16> %49) #4
  ...
  %53 = tail call <8 x i16> @llvm.x86.sse2.pmulh.w(<8 x i16> %51, <8 x i16> %52) #4
  ...
  %55 = sitofp <16 x i16> %54 to <16 x double>
  ...
  %64 = tail call <8 x i16> @llvm.x86.sse2.pmulh.w(<8 x i16> %62, <8 x i16> %63) #4
  ...
  %67 = tail call <8 x i16> @llvm.x86.sse2.pmulh.w(<8 x i16> %65, <8 x i16> %66) #4
  ...
  %69 = sitofp <16 x i16> %68 to <16 x double>
  ...
  %78 = tail call <8 x i16> @llvm.x86.sse2.pmulh.w(<8 x i16> %76, <8 x i16> %77) #4
  ...
  %81 = tail call <8 x i16> @llvm.x86.sse2.pmulh.w(<8 x i16> %79, <8 x i16> %80) #4
  ...
  %83 = sitofp <16 x i16> %82 to <16 x double>
  ...
  %92 = tail call <8 x i16> @llvm.x86.sse2.pmulh.w(<8 x i16> %90, <8 x i16> %91) #4
  ...
  %95 = tail call <8 x i16> @llvm.x86.sse2.pmulh.w(<8 x i16> %93, <8 x i16> %94) #4
  ...
  %97 = sitofp <16 x i16> %96 to <16 x double>
  ...
  %106 = tail call <8 x i16> @llvm.x86.sse2.pmulh.w(<8 x i16> %104, <8 x i16> %105) #4
  ...
  %109 = tail call <8 x i16> @llvm.x86.sse2.pmulh.w(<8 x i16> %107, <8 x i16> %108) #4
  ...
  %111 = sitofp <16 x i16> %110 to <16 x double>
  ...
  %120 = tail call <8 x i16> @llvm.x86.sse2.pmulh.w(<8 x i16> %118, <8 x i16> %119) #4
  ...
  %123 = tail call <8 x i16> @llvm.x86.sse2.pmulh.w(<8 x i16> %121, <8 x i16> %122) #4
  ...
  %125 = sitofp <16 x i16> %124 to <16 x double>
  ...
  br label %"for op_vpmulhw_363.s0.x.x.preheader"

"for op_vpmulhw_363.s0.x.x.preheader":            ; preds = %"for op_vpmulhw_363.s0.x.x.preheader", %"for op_vpmulhw_363.s0.y.preheader"
  %lsr.iv180 = phi ptr [ %scevgep, %"for op_vpmulhw_363.s0.y.preheader" ], [ %scevgep182, %"for op_vpmulhw_363.s0.x.x.preheader" ]
  %op_vpmulhw_363.s0.y = phi i32 [ %op_vpmulhw_363.min.1, %"for op_vpmulhw_363.s0.y.preheader" ], [ %228, %"for op_vpmulhw_363.s0.x.x.preheader" ]
  ...
  %134 = tail call <8 x i16> @llvm.x86.sse2.pmulh.w(<8 x i16> %132, <8 x i16> %133) #4
  ...
  %137 = tail call <8 x i16> @llvm.x86.sse2.pmulh.w(<8 x i16> %135, <8 x i16> %136) #4
  ...
  %139 = sitofp <16 x i16> %138 to <16 x double>
  ...
  %148 = tail call <8 x i16> @llvm.x86.sse2.pmulh.w(<8 x i16> %146, <8 x i16> %147) #4
  ...
  %151 = tail call <8 x i16> @llvm.x86.sse2.pmulh.w(<8 x i16> %149, <8 x i16> %150) #4
  ...
  %153 = sitofp <16 x i16> %152 to <16 x double>
  ...
  %162 = tail call <8 x i16> @llvm.x86.sse2.pmulh.w(<8 x i16> %160, <8 x i16> %161) #4
  ...
  %176 = tail call <8 x i16> @llvm.x86.sse2.pmulh.w(<8 x i16> %174, <8 x i16> %175) #4
  ...
  %181 = sitofp <16 x i16> %180 to <16 x double>
  ...
  %190 = tail call <8 x i16> @llvm.x86.sse2.pmulh.w(<8 x i16> %188, <8 x i16> %189) #4
  ...
  %193 = tail call <8 x i16> @llvm.x86.sse2.pmulh.w(<8 x i16> %191, <8 x i16> %192) #4
  ...
  %195 = sitofp <16 x i16> %194 to <16 x double>
  ...
  %204 = tail call <8 x i16> @llvm.x86.sse2.pmulh.w(<8 x i16> %202, <8 x i16> %203) #4
  ...
  %207 = tail call <8 x i16> @llvm.x86.sse2.pmulh.w(<8 x i16> %205, <8 x i16> %206) #4
  ...
  %209 = sitofp <16 x i16> %208 to <16 x double>
  ...
  %218 = tail call <8 x i16> @llvm.x86.sse2.pmulh.w(<8 x i16> %216, <8 x i16> %217) #4
  ...
  %221 = tail call <8 x i16> @llvm.x86.sse2.pmulh.w(<8 x i16> %219, <8 x i16> %220) #4
  ...
  %223 = sitofp <16 x i16> %222 to <16 x double>
  ...
  %228 = add nsw i32 %op_vpmulhw_363.s0.y, 1
  %scevgep182 = getelementptr i1, ptr %lsr.iv180, i64 %6
  %.not2 = icmp eq i32 %228, %0
  br i1 %.not2, label %destructor_block, label %"for op_vpmulhw_363.s0.x.x.preheader"

destructor_block:                                 ; preds = %"for op_vpmulhw_363.s0.x.x.preheader", %"produce op_vpmulhw_363"
  ret i32 0
}
...
; Function Attrs: nofree nosync nounwind memory(readwrite, inaccessiblemem: none)
define i32 @test_op(ptr noalias nocapture readnone %in_f32.buffer, ptr noalias nocapture readnone %in_f64.buffer, ptr noalias nocapture readnone %in_i8.buffer, ptr noalias nocapture readnone %in_u8.buffer, ptr noalias nocapture readonly %in_i16.buffer, ptr noalias nocapture readnone %in_u16.buffer, ptr noalias nocapture readnone %in_i32.buffer, ptr noalias nocapture readnone %in_u32.buffer, ptr noalias nocapture readnone %in_i64.buffer, ptr noalias nocapture readnone %in_u64.buffer, ptr noalias nocapture readonly %op_vpmulhw_363.buffer) local_unnamed_addr #2 {
destructor_block:
  %"__test_op_result$22" = tail call i32 @__test_op(ptr poison, ptr poison, ptr poison, ptr poison, ptr %in_i16.buffer, ptr poison, ptr poison, ptr poison, ptr poison, ptr poison, ptr %op_vpmulhw_363.buffer) #5
  ret i32 0
}
