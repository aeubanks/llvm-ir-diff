; ModuleID = '/usr/local/google/home/aeubanks/repos/test-suite/SingleSource/Regression/C/gcc-c-torture/execute/cmpdi-1.c'
source_filename = "/usr/local/google/home/aeubanks/repos/test-suite/SingleSource/Regression/C/gcc-c-torture/execute/cmpdi-1.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@args = dso_local local_unnamed_addr global [8 x i64] [i64 0, i64 1, i64 -1, i64 9223372036854775807, i64 -9223372036854775808, i64 -9223372036854775807, i64 1891269347843992664, i64 -7816825554603336956], align 16
...
define dso_local i32 @feq(i64 noundef %x, i64 noundef %y) local_unnamed_addr #0 {
entry:
  %cmp = icmp eq i64 %x, %y
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none) uwtable
define dso_local i32 @fne(i64 noundef %x, i64 noundef %y) local_unnamed_addr #0 {
entry:
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none) uwtable
define dso_local i32 @flt(i64 noundef %x, i64 noundef %y) local_unnamed_addr #0 {
entry:
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none) uwtable
define dso_local i32 @fge(i64 noundef %x, i64 noundef %y) local_unnamed_addr #0 {
entry:
  %cmp.not = icmp slt i64 %x, %y
  %. = select i1 %cmp.not, i32 140, i32 13
  ret i32 %.
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none) uwtable
define dso_local i32 @fgt(i64 noundef %x, i64 noundef %y) local_unnamed_addr #0 {
entry:
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none) uwtable
define dso_local i32 @fle(i64 noundef %x, i64 noundef %y) local_unnamed_addr #0 {
entry:
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none) uwtable
define dso_local i32 @fltu(i64 noundef %x, i64 noundef %y) local_unnamed_addr #0 {
entry:
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none) uwtable
define dso_local i32 @fgeu(i64 noundef %x, i64 noundef %y) local_unnamed_addr #0 {
entry:
  %cmp.not = icmp ult i64 %x, %y
  %. = select i1 %cmp.not, i32 140, i32 13
  ret i32 %.
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none) uwtable
define dso_local i32 @fgtu(i64 noundef %x, i64 noundef %y) local_unnamed_addr #0 {
entry:
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none) uwtable
define dso_local i32 @fleu(i64 noundef %x, i64 noundef %y) local_unnamed_addr #0 {
entry:
  %cmp.not = icmp ugt i64 %x, %y
  %. = select i1 %cmp.not, i32 140, i32 13
  ret i32 %.
}
...
for.body:                                         ; preds = %entry, %for.end
  ...
  %arrayidx = getelementptr inbounds [8 x i64], ptr @args, i64 0, i64 %indvars.iv118
...
for.body3:                                        ; preds = %for.body, %if.end51
  ...
  %arrayidx5 = getelementptr inbounds [8 x i64], ptr @args, i64 0, i64 %indvars.iv
  %1 = load i64, ptr %arrayidx5, align 8, !tbaa !5
  %cmp.i = icmp eq i64 %0, %1
  %..i = select i1 %cmp.i, i32 13, i32 140
  %2 = load i32, ptr %res.1113, align 4, !tbaa !9
...
if.end:                                           ; preds = %for.body3
  ...
  %3 = load i32, ptr %incdec.ptr, align 4, !tbaa !9
...
if.end11:                                         ; preds = %if.end
  ...
  %cmp.i87 = icmp slt i64 %0, %1
  %..i88 = select i1 %cmp.i87, i32 13, i32 140
  %4 = load i32, ptr %incdec.ptr8, align 4, !tbaa !9
...
if.end16:                                         ; preds = %if.end11
  ...
  %5 = load i32, ptr %incdec.ptr13, align 4, !tbaa !9
...
if.end21:                                         ; preds = %if.end16
  ...
  %cmp.i91 = icmp sgt i64 %0, %1
  %..i92 = select i1 %cmp.i91, i32 13, i32 140
  %6 = load i32, ptr %incdec.ptr18, align 4, !tbaa !9
...
if.end26:                                         ; preds = %if.end21
  ...
  %7 = load i32, ptr %incdec.ptr23, align 4, !tbaa !9
...
if.end31:                                         ; preds = %if.end26
  ...
  %cmp.i95 = icmp ult i64 %0, %1
  %..i96 = select i1 %cmp.i95, i32 13, i32 140
  %8 = load i32, ptr %incdec.ptr28, align 4, !tbaa !9
...
if.end36:                                         ; preds = %if.end31
  ...
  %9 = load i32, ptr %incdec.ptr33, align 4, !tbaa !9
...
if.end41:                                         ; preds = %if.end36
  ...
  %cmp.i99 = icmp ugt i64 %0, %1
  %..i100 = select i1 %cmp.i99, i32 13, i32 140
  %10 = load i32, ptr %incdec.ptr38, align 4, !tbaa !9
...
if.end46:                                         ; preds = %if.end41
  ...
  %11 = load i32, ptr %incdec.ptr43, align 4, !tbaa !9
...
for.end:                                          ; preds = %if.end51
  ...
  br i1 %exitcond121.not, label %for.end54, label %for.body, !llvm.loop !13
