...
define dso_local i32 @feq(i64 noundef %0, i64 noundef %1) local_unnamed_addr #0 {
  %3 = icmp eq i64 %0, %1
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none) uwtable
define dso_local i32 @fne(i64 noundef %0, i64 noundef %1) local_unnamed_addr #0 {
  %3 = icmp eq i64 %0, %1
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none) uwtable
define dso_local i32 @flt(i64 noundef %0, i64 noundef %1) local_unnamed_addr #0 {
  %3 = icmp slt i64 %0, %1
  %4 = select i1 %3, i32 13, i32 140
  ret i32 %4
}
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none) uwtable
define dso_local i32 @fge(i64 noundef %0, i64 noundef %1) local_unnamed_addr #0 {
  %3 = icmp slt i64 %0, %1
  %4 = select i1 %3, i32 140, i32 13
  ret i32 %4
}
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none) uwtable
define dso_local i32 @fgt(i64 noundef %0, i64 noundef %1) local_unnamed_addr #0 {
  %3 = icmp sgt i64 %0, %1
  %4 = select i1 %3, i32 13, i32 140
  ret i32 %4
}
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none) uwtable
define dso_local i32 @fle(i64 noundef %0, i64 noundef %1) local_unnamed_addr #0 {
  %3 = icmp sgt i64 %0, %1
  %4 = select i1 %3, i32 140, i32 13
  ret i32 %4
}
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none) uwtable
define dso_local i32 @fltu(i64 noundef %0, i64 noundef %1) local_unnamed_addr #0 {
  %3 = icmp ult i64 %0, %1
  %4 = select i1 %3, i32 13, i32 140
  ret i32 %4
}
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none) uwtable
define dso_local i32 @fgeu(i64 noundef %0, i64 noundef %1) local_unnamed_addr #0 {
  %3 = icmp ult i64 %0, %1
  %4 = select i1 %3, i32 140, i32 13
  ret i32 %4
}
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none) uwtable
define dso_local i32 @fgtu(i64 noundef %0, i64 noundef %1) local_unnamed_addr #0 {
  %3 = icmp ugt i64 %0, %1
  %4 = select i1 %3, i32 13, i32 140
  ret i32 %4
}
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none) uwtable
define dso_local i32 @fleu(i64 noundef %0, i64 noundef %1) local_unnamed_addr #0 {
  %3 = icmp ugt i64 %0, %1
  %4 = select i1 %3, i32 140, i32 13
  ret i32 %4
}
...
1:                                                ; preds = %0, %79
  ...
  %4 = getelementptr inbounds [8 x i64], ptr @args, i64 0, i64 %2
...
7:                                                ; preds = %1, %75
  %8 = phi i64 [ 0, %1 ], [ %77, %75 ]
  %9 = phi ptr [ %3, %1 ], [ %76, %75 ]
  %10 = getelementptr inbounds [8 x i64], ptr @args, i64 0, i64 %8
...
49:                                               ; preds = %43
  ...
  %51 = icmp ult i64 %5, %11
  %52 = select i1 %51, i32 13, i32 140
  %53 = load i32, ptr %50, align 4, !tbaa !9
...
62:                                               ; preds = %56
  ...
  %64 = icmp ugt i64 %5, %11
  %65 = select i1 %64, i32 13, i32 140
  %66 = load i32, ptr %63, align 4, !tbaa !9
...
75:                                               ; preds = %69
  ...
  %78 = icmp eq i64 %77, 8
  br i1 %78, label %79, label %7, !llvm.loop !11

79:                                               ; preds = %75
  %80 = add nuw nsw i64 %2, 1
  %81 = icmp eq i64 %80, 8
  br i1 %81, label %82, label %1, !llvm.loop !13
