...
define dso_local i32 @cdiff_apply(i32 noundef %0, i16 noundef zeroext %1) local_unnamed_addr #0 {
  ...
  %8 = tail call i32 @dup(i32 noundef %0) #18
  %9 = icmp eq i32 %8, -1
  br i1 %9, label %10, label %12

10:                                               ; preds = %2
  %11 = tail call i32 (ptr, ...) @logg(ptr noundef nonnull @.str, i32 noundef %0) #18
  br label %204
...
14:                                               ; preds = %12
  %15 = tail call i64 @lseek(i32 noundef %8, i64 noundef -350, i32 noundef 2) #18
  %16 = icmp eq i64 %15, -1
  br i1 %16, label %17, label %20

17:                                               ; preds = %14
  %18 = tail call i32 (ptr, ...) @logg(ptr noundef nonnull @.str.1, i32 noundef -350) #18
  %19 = tail call i32 @close(i32 noundef %8) #18
  br label %204

20:                                               ; preds = %14
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(1024) %4, i8 0, i64 1024, i1 false)
  %21 = call i64 @read(i32 noundef %8, ptr noundef nonnull %4, i64 noundef 350) #18
  %22 = icmp eq i64 %21, 350
  br i1 %22, label %26, label %23

23:                                               ; preds = %20
  %24 = tail call i32 (ptr, ...) @logg(ptr noundef nonnull @.str.2, i32 noundef 350) #18
  %25 = tail call i32 @close(i32 noundef %8) #18
  br label %204
...
59:                                               ; preds = %56
  %60 = tail call i32 (ptr, ...) @logg(ptr noundef nonnull @.str.3) #18
  %61 = tail call i32 @close(i32 noundef %8) #18
  br label %204

62:                                               ; preds = %50, %44, %38, %32, %26
  %63 = phi i32 [ %27, %26 ], [ %33, %32 ], [ %39, %38 ], [ %45, %44 ], [ %51, %50 ]
  %64 = call i32 @fstat(i32 noundef %8, ptr noundef nonnull %7) #18
  %65 = icmp eq i32 %64, -1
  br i1 %65, label %66, label %69

66:                                               ; preds = %62
  %67 = tail call i32 (ptr, ...) @logg(ptr noundef nonnull @.str.4) #18
  %68 = tail call i32 @close(i32 noundef %8) #18
  br label %204

69:                                               ; preds = %62
  %70 = getelementptr inbounds %struct.stat, ptr %7, i64 0, i32 8
  %71 = load i64, ptr %70, align 8, !tbaa !10
  %72 = add nsw i32 %63, -350
...
76:                                               ; preds = %69
  %77 = tail call i32 (ptr, ...) @logg(ptr noundef nonnull @.str.5) #18
  %78 = tail call i32 @close(i32 noundef %8) #18
  br label %204

79:                                               ; preds = %69
  %80 = tail call i64 @lseek(i32 noundef %8, i64 noundef 0, i32 noundef 0) #18
  %81 = icmp eq i64 %80, -1
  br i1 %81, label %82, label %85

82:                                               ; preds = %79
  %83 = tail call i32 (ptr, ...) @logg(ptr noundef nonnull @.str.6) #18
  %84 = tail call i32 @close(i32 noundef %8) #18
  br label %204

85:                                               ; preds = %79
  %86 = tail call i64 @lseek(i32 noundef %8, i64 noundef 0, i32 noundef 0) #18
  %87 = icmp eq i64 %86, -1
  br i1 %87, label %88, label %91

88:                                               ; preds = %85
  %89 = tail call i32 (ptr, ...) @logg(ptr noundef nonnull @.str.6) #18
  %90 = tail call i32 @close(i32 noundef %8) #18
  br label %204
...
91:                                               ; preds = %85, %104
  ...
  %95 = call i64 @read(i32 noundef %8, ptr noundef nonnull %94, i64 noundef 1) #18
...
107:                                              ; preds = %104, %101, %91
  ...
  %112 = call i32 (ptr, ptr, ...) @__isoc99_sscanf(ptr noundef nonnull %5, ptr noundef nonnull @.str.7, ptr noundef nonnull %6) #18
  %113 = icmp eq i32 %112, 1
  br i1 %113, label %117, label %114

114:                                              ; preds = %107
  %115 = call i32 (ptr, ...) @logg(ptr noundef nonnull @.str.8) #18
  %116 = call i32 @close(i32 noundef %8) #18
  br label %204

117:                                              ; preds = %107
  %118 = call ptr @gzdopen(i32 noundef %8, ptr noundef nonnull @.str.9) #18
  %119 = icmp eq ptr %118, null
  br i1 %119, label %120, label %123

120:                                              ; preds = %117
  %121 = call i32 (ptr, ...) @logg(ptr noundef nonnull @.str.10, i32 noundef %8) #18
  %122 = call i32 @close(i32 noundef %8) #18
  br label %204
...
126:                                              ; preds = %123, %154
  ...
  %133 = call ptr @gzgets(ptr noundef nonnull %118, ptr noundef nonnull %4, i32 noundef %132) #18
  %134 = icmp eq ptr %133, null
  br i1 %134, label %135, label %139

135:                                              ; preds = %126
  %136 = add i32 %127, 1
  %137 = call i32 (ptr, ...) @logg(ptr noundef nonnull @.str.11, i32 noundef %136) #18
  call fastcc void @cdiff_ctx_free(ptr noundef nonnull %3)
  %138 = call i32 @gzclose(ptr noundef nonnull %118) #18
  br label %204

139:                                              ; preds = %126
  %140 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %4) #19
  %141 = trunc i64 %140 to i32
  %142 = sub i32 %128, %141
  %143 = add i32 %127, 1
  %144 = call i32 @cli_chomp(ptr noundef nonnull %4) #18
  %145 = load i8, ptr %4, align 16, !tbaa !5
...
149:                                              ; preds = %146
  %150 = call i32 (ptr, ...) @logg(ptr noundef nonnull @.str.12, i32 noundef %143) #18
  call fastcc void @cdiff_ctx_free(ptr noundef nonnull %3)
  %151 = call i32 @gzclose(ptr noundef nonnull %118) #18
  br label %204
...
157:                                              ; preds = %154, %123
  ...
  %160 = call i32 @gzclose(ptr noundef nonnull %118) #18
  br label %195

161:                                              ; preds = %12
  %162 = tail call noalias ptr @fdopen(i32 noundef %8, ptr noundef nonnull @.str.13) #18
...
167:                                              ; preds = %161
  %168 = tail call i32 (ptr, ...) @logg(ptr noundef nonnull @.str.14, i32 noundef %8) #18
  %169 = tail call i32 @close(i32 noundef %8) #18
  br label %204

170:                                              ; preds = %188, %175
  %171 = phi i32 [ %189, %188 ], [ %172, %175 ]
  %172 = add i32 %171, 1
  %173 = call i32 @cli_chomp(ptr noundef nonnull %4) #18
  %174 = load i8, ptr %4, align 16, !tbaa !5
...
181:                                              ; preds = %178
  %182 = call i32 (ptr, ...) @logg(ptr noundef nonnull @.str.12, i32 noundef %172) #18
  call fastcc void @cdiff_ctx_free(ptr noundef nonnull %3)
...
200:                                              ; preds = %195
  %201 = call i32 (ptr, ...) @logg(ptr noundef nonnull @.str.15, ptr noundef nonnull %198) #18
  call fastcc void @cdiff_ctx_free(ptr noundef nonnull %3)
  br label %204

202:                                              ; preds = %195
  %203 = call i32 (ptr, ...) @logg(ptr noundef nonnull @.str.16, i32 noundef %197, i32 noundef %196) #18
  br label %204
...
20:                                               ; preds = %15
  ...
  %22 = tail call ptr @strncpy(ptr noundef nonnull %18, ptr noundef nonnull %0, i64 noundef %21) #18
  %23 = getelementptr inbounds i8, ptr %18, i64 %21
  store i8 0, ptr %23, align 1, !tbaa !5
  %24 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(5) @.str.21, ptr noundef nonnull dereferenceable(1) %18) #19
  %25 = icmp eq i32 %24, 0
  br i1 %25, label %48, label %28

26:                                               ; preds = %2, %13, %15
  %27 = tail call i32 (ptr, ...) @logg(ptr noundef nonnull @.str.17) #18
  br label %80

28:                                               ; preds = %20
  %29 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(4) @.str.22, ptr noundef nonnull dereferenceable(1) %18) #19
  %30 = icmp eq i32 %29, 0
  br i1 %30, label %48, label %31

31:                                               ; preds = %28
  %32 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(4) @.str.23, ptr noundef nonnull dereferenceable(1) %18) #19
  %33 = icmp eq i32 %32, 0
  br i1 %33, label %48, label %34

34:                                               ; preds = %31
  %35 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(5) @.str.24, ptr noundef nonnull dereferenceable(1) %18) #19
  %36 = icmp eq i32 %35, 0
  br i1 %36, label %48, label %37

37:                                               ; preds = %34
  %38 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(6) @.str.25, ptr noundef nonnull dereferenceable(1) %18) #19
  %39 = icmp eq i32 %38, 0
  br i1 %39, label %73, label %40

40:                                               ; preds = %37
  %41 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(5) @.str.26, ptr noundef nonnull dereferenceable(1) %18) #19
  %42 = icmp eq i32 %41, 0
  br i1 %42, label %48, label %43

43:                                               ; preds = %40
  %44 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(7) @.str.27, ptr noundef nonnull dereferenceable(1) %18) #19
  %45 = icmp eq i32 %44, 0
  br i1 %45, label %48, label %46

46:                                               ; preds = %43
  %47 = tail call i32 (ptr, ...) @logg(ptr noundef nonnull @.str.18, ptr noundef nonnull %18) #18
...
55:                                               ; preds = %48, %55
  %56 = phi i8 [ %65, %55 ], [ %3, %48 ]
  %57 = phi i32 [ %62, %55 ], [ 0, %48 ]
  %58 = phi i32 [ %61, %55 ], [ 0, %48 ]
  %59 = icmp eq i8 %56, 32
...
71:                                               ; preds = %69
  %72 = tail call i32 (ptr, ...) @logg(ptr noundef nonnull @.str.19, ptr noundef nonnull %18) #18
  tail call void @free(ptr noundef %18) #18
  br label %80

73:                                               ; preds = %37, %69
  %74 = phi ptr [ %51, %69 ], [ @cdiff_cmd_close, %37 ]
  %75 = tail call i32 %74(ptr noundef nonnull %0, ptr noundef %1) #18
  %76 = icmp eq i32 %75, 0
  br i1 %76, label %79, label %77

77:                                               ; preds = %73
  %78 = tail call i32 (ptr, ...) @logg(ptr noundef nonnull @.str.20, ptr noundef nonnull %18) #18
  tail call void @free(ptr noundef %18) #18
  br label %80
...
80:                                               ; preds = %79, %77, %71, %46, %26
  %81 = phi i32 [ -1, %77 ], [ 0, %79 ], [ -1, %71 ], [ -1, %46 ], [ -1, %26 ]
  ret i32 %81
}
...
30:                                               ; preds = %28
  %31 = tail call noalias ptr @strdup(ptr noundef nonnull %26) #18
  br label %52

32:                                               ; preds = %28, %35
  %33 = phi i8 [ %39, %35 ], [ %24, %28 ]
  %34 = phi i32 [ %36, %35 ], [ %23, %28 ]
...
48:                                               ; preds = %42
  ...
  %50 = tail call ptr @strncpy(ptr noundef nonnull %46, ptr noundef nonnull %26, i64 noundef %49) #18
...
21:                                               ; preds = %19
  ...
  %24 = tail call noalias ptr @strdup(ptr noundef nonnull %23) #18
  %25 = icmp eq ptr %24, null
  br i1 %25, label %26, label %28

26:                                               ; preds = %2, %19, %21
  %27 = tail call i32 (ptr, ...) @logg(ptr noundef nonnull @.str.28) #18
  br label %60
...
31:                                               ; preds = %28
  %32 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %24) #19
  %33 = icmp eq i64 %32, 0
  br i1 %33, label %59, label %40

34:                                               ; preds = %28
  %35 = tail call i32 (ptr, ...) @logg(ptr noundef nonnull @.str.29, ptr noundef nonnull %29, ptr noundef nonnull %24) #18
...
45:                                               ; preds = %40
  %46 = tail call ptr @__ctype_b_loc() #21
...
53:                                               ; preds = %45, %40
  %54 = sext i8 %43 to i32
  %55 = tail call ptr @memchr(ptr noundef nonnull dereferenceable(1) @.str.30, i32 %54, i64 3)
  %56 = icmp eq ptr %55, null
  br i1 %56, label %36, label %57

57:                                               ; preds = %53, %45
  %58 = tail call i32 (ptr, ...) @logg(ptr noundef nonnull @.str.31) #18
  tail call void @free(ptr noundef nonnull %24) #18
  br label %60
...
26:                                               ; preds = %2, %19, %21
  %27 = tail call i32 (ptr, ...) @logg(ptr noundef nonnull @.str.32) #18
  br label %42

28:                                               ; preds = %21
  %29 = tail call noalias dereferenceable_or_null(32) ptr @calloc(i64 noundef 1, i64 noundef 32) #22
  %30 = icmp eq ptr %29, null
  br i1 %30, label %31, label %33

31:                                               ; preds = %28
  %32 = tail call i32 (ptr, ...) @logg(ptr noundef nonnull @.str.33) #18
  tail call void @free(ptr noundef nonnull %24) #18
  br label %42
...
23:                                               ; preds = %19, %26
  %24 = phi i8 [ %30, %26 ], [ %15, %19 ]
  %25 = phi i32 [ %27, %26 ], [ %12, %19 ]
...
39:                                               ; preds = %2, %19, %31, %33
  %40 = tail call i32 (ptr, ...) @logg(ptr noundef nonnull @.str.34) #18
  br label %105

41:                                               ; preds = %33
  %42 = zext i32 %34 to i64
  %43 = tail call ptr @strncpy(ptr noundef nonnull %37, ptr noundef nonnull %21, i64 noundef %42) #18
  %44 = getelementptr inbounds i8, ptr %37, i64 %42
  store i8 0, ptr %44, align 1, !tbaa !5
  %45 = tail call i64 @strtol(ptr nocapture noundef nonnull %37, ptr noundef null, i32 noundef 10) #18
...
65:                                               ; preds = %63
  ...
  %68 = tail call noalias ptr @strdup(ptr noundef nonnull %67) #18
  %69 = icmp eq ptr %68, null
  br i1 %69, label %70, label %72

70:                                               ; preds = %41, %63, %65
  %71 = tail call i32 (ptr, ...) @logg(ptr noundef nonnull @.str.35) #18
  br label %105

72:                                               ; preds = %65
  %73 = tail call noalias dereferenceable_or_null(32) ptr @calloc(i64 noundef 1, i64 noundef 32) #22
  %74 = icmp eq ptr %73, null
  br i1 %74, label %75, label %77

75:                                               ; preds = %72
  %76 = tail call i32 (ptr, ...) @logg(ptr noundef nonnull @.str.36) #18
...
39:                                               ; preds = %2, %19, %31, %33
  %40 = tail call i32 (ptr, ...) @logg(ptr noundef nonnull @.str.37) #18
  br label %146
...
67:                                               ; preds = %63, %70
  %68 = phi i8 [ %74, %70 ], [ %59, %63 ]
  %69 = phi i32 [ %71, %70 ], [ %56, %63 ]
...
83:                                               ; preds = %41, %63, %75, %77
  %84 = tail call i32 (ptr, ...) @logg(ptr noundef nonnull @.str.38) #18
  br label %146

85:                                               ; preds = %77
  %86 = zext i32 %78 to i64
  %87 = tail call ptr @strncpy(ptr noundef nonnull %81, ptr noundef nonnull %65, i64 noundef %86) #18
...
105:                                              ; preds = %103
  ...
  %108 = tail call noalias ptr @strdup(ptr noundef nonnull %107) #18
  %109 = icmp eq ptr %108, null
  br i1 %109, label %110, label %112

110:                                              ; preds = %103, %105
  tail call void @free(ptr noundef %81) #18
  %111 = tail call i32 (ptr, ...) @logg(ptr noundef nonnull @.str.38) #18
  br label %146

112:                                              ; preds = %105
  %113 = tail call noalias dereferenceable_or_null(32) ptr @calloc(i64 noundef 1, i64 noundef 32) #22
  %114 = icmp eq ptr %113, null
  br i1 %114, label %115, label %117

115:                                              ; preds = %112
  %116 = tail call i32 (ptr, ...) @logg(ptr noundef nonnull @.str.39) #18
  tail call void @free(ptr noundef %81) #18
...
6:                                                ; preds = %2
  %7 = tail call i32 (ptr, ...) @logg(ptr noundef nonnull @.str.40) #18
  br label %231
...
23:                                               ; preds = %20
  ...
  %25 = tail call i32 (ptr, ...) @logg(ptr noundef nonnull @.str.41, ptr noundef %24) #18
  br label %231

26:                                               ; preds = %20
  %27 = tail call ptr @cli_gentemp(ptr noundef nonnull @.str.42) #18
  %28 = icmp eq ptr %27, null
  br i1 %28, label %29, label %32

29:                                               ; preds = %26
  %30 = tail call i32 (ptr, ...) @logg(ptr noundef nonnull @.str.43) #18
...
37:                                               ; preds = %32
  %38 = tail call i32 (ptr, ...) @logg(ptr noundef nonnull @.str.45, ptr noundef nonnull %27) #18
...
48:                                               ; preds = %157, %44
  ...
  %54 = call i32 @strncmp(ptr noundef nonnull %3, ptr noundef %52, i64 noundef %53) #19
  %55 = icmp eq i32 %54, 0
  br i1 %55, label %62, label %56
...
56:                                               ; preds = %48
  ...
  %59 = call i32 @unlink(ptr noundef %27) #18
  call void @free(ptr noundef %27) #18
  %60 = load ptr, ptr %1, align 8, !tbaa !19
  %61 = call i32 (ptr, ...) @logg(ptr noundef nonnull @.str.46, i32 noundef %50, ptr noundef %60) #18
  br label %231
...
100:                                              ; preds = %93
  ...
  %103 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %102) #19
  %104 = call i32 @strncmp(ptr noundef nonnull %3, ptr noundef %102, i64 noundef %103) #19
...
116:                                              ; preds = %113
  ...
  %120 = call i32 @strncmp(ptr noundef nonnull %3, ptr noundef %118, i64 noundef %119) #19
...
122:                                              ; preds = %116, %100
  ...
  %126 = call i32 @unlink(ptr noundef %27) #18
  call void @free(ptr noundef %27) #18
  %127 = load ptr, ptr %1, align 8, !tbaa !19
  %128 = call i32 (ptr, ...) @logg(ptr noundef nonnull @.str.47, i32 noundef %123, ptr noundef %127) #18
  br label %231
...
137:                                              ; preds = %129, %134, %76, %81
  ...
  %140 = call i32 @unlink(ptr noundef %27) #18
  %141 = call i32 (ptr, ...) @logg(ptr noundef nonnull @.str.48, ptr noundef %27) #18
  call void @free(ptr noundef %27) #18
  br label %231
...
170:                                              ; preds = %161, %167, %97, %150
  ...
  %173 = call i32 @unlink(ptr noundef %27) #18
  %174 = call i32 (ptr, ...) @logg(ptr noundef nonnull @.str.48, ptr noundef %27) #18
  call void @free(ptr noundef %27) #18
  br label %231
...
183:                                              ; preds = %175
  %184 = call i32 (ptr, ...) @logg(ptr noundef nonnull @.str.49) #18
  %185 = call i32 @unlink(ptr noundef %27) #18
  call void @free(ptr noundef %27) #18
  br label %231

186:                                              ; preds = %175
  %187 = load ptr, ptr %1, align 8, !tbaa !19
  %188 = call i32 @unlink(ptr noundef %187) #18
  %189 = icmp eq i32 %188, -1
  %190 = load ptr, ptr %1, align 8, !tbaa !19
  br i1 %189, label %191, label %194

191:                                              ; preds = %186
  %192 = call i32 (ptr, ...) @logg(ptr noundef nonnull @.str.50, ptr noundef %190) #18
  %193 = call i32 @unlink(ptr noundef %27) #18
  call void @free(ptr noundef %27) #18
  br label %231

194:                                              ; preds = %186
  %195 = call i32 @rename(ptr noundef %27, ptr noundef %190) #18
  %196 = icmp eq i32 %195, -1
  br i1 %196, label %197, label %201

197:                                              ; preds = %194
  %198 = load ptr, ptr %1, align 8, !tbaa !19
  %199 = call i32 (ptr, ...) @logg(ptr noundef nonnull @.str.51, ptr noundef %27, ptr noundef %198) #18
  %200 = call i32 @unlink(ptr noundef %27) #18
  call void @free(ptr noundef %27) #18
  br label %231
...
208:                                              ; preds = %204
  ...
  %210 = call i32 (ptr, ...) @logg(ptr noundef nonnull @.str.53, ptr noundef %209) #18
  br label %231
...
220:                                              ; preds = %217, %211
  ...
  %223 = call i32 (ptr, ...) @logg(ptr noundef nonnull @.str.48, ptr noundef %222) #18
  br label %231
...
6:                                                ; preds = %2
  %7 = tail call i32 (ptr, ...) @logg(ptr noundef nonnull @.str.54, ptr noundef nonnull %4) #18
  br label %333
...
29:                                               ; preds = %25, %32
  %30 = phi i8 [ %36, %32 ], [ %21, %25 ]
  %31 = phi i32 [ %33, %32 ], [ %18, %25 ]
...
45:                                               ; preds = %8, %25, %37, %39
  %46 = tail call i32 (ptr, ...) @logg(ptr noundef nonnull @.str.55) #18
  br label %333

47:                                               ; preds = %39
  %48 = zext i32 %40 to i64
  %49 = tail call ptr @strncpy(ptr noundef nonnull %43, ptr noundef nonnull %27, i64 noundef %48) #18
  %50 = getelementptr inbounds i8, ptr %43, i64 %48
  store i8 0, ptr %50, align 1, !tbaa !5
  %51 = tail call i64 @strtol(ptr nocapture noundef nonnull %43, ptr noundef null, i32 noundef 10) #18
...
73:                                               ; preds = %69, %76
  %74 = phi i8 [ %80, %76 ], [ %65, %69 ]
  %75 = phi i32 [ %77, %76 ], [ %62, %69 ]
...
89:                                               ; preds = %47, %69, %81, %83
  %90 = tail call i32 (ptr, ...) @logg(ptr noundef nonnull @.str.56) #18
  br label %333

91:                                               ; preds = %83
  %92 = zext i32 %84 to i64
  %93 = tail call ptr @strncpy(ptr noundef nonnull %87, ptr noundef nonnull %71, i64 noundef %92) #18
  %94 = getelementptr inbounds i8, ptr %87, i64 %92
  store i8 0, ptr %94, align 1, !tbaa !5
  %95 = tail call i64 @strtol(ptr nocapture noundef nonnull %87, ptr noundef null, i32 noundef 10) #18
...
98:                                               ; preds = %91
  %99 = tail call i32 (ptr, ...) @logg(ptr noundef nonnull @.str.57) #18
  br label %333
...
121:                                              ; preds = %117, %124
  %122 = phi i8 [ %128, %124 ], [ %113, %117 ]
  %123 = phi i32 [ %125, %124 ], [ %110, %117 ]
...
131:                                              ; preds = %129
  ...
  %135 = tail call noalias ptr @malloc(i64 noundef %134) #20
  %136 = icmp eq ptr %135, null
  br i1 %136, label %137, label %139

137:                                              ; preds = %100, %117, %129, %131
  %138 = tail call i32 (ptr, ...) @logg(ptr noundef nonnull @.str.58) #18
  br label %333

139:                                              ; preds = %131
  %140 = zext i32 %132 to i64
  %141 = tail call ptr @strncpy(ptr noundef nonnull %135, ptr noundef nonnull %119, i64 noundef %140) #18
...
161:                                              ; preds = %157, %164
  %162 = phi i8 [ %168, %164 ], [ %153, %157 ]
  %163 = phi i32 [ %165, %164 ], [ %150, %157 ]
...
177:                                              ; preds = %157, %169, %171
  %178 = tail call i32 (ptr, ...) @logg(ptr noundef nonnull @.str.59) #18
  tail call void @free(ptr noundef %135) #18
  br label %333

179:                                              ; preds = %171
  %180 = zext i32 %172 to i64
  %181 = tail call ptr @strncpy(ptr noundef nonnull %175, ptr noundef nonnull %159, i64 noundef %180) #18
...
201:                                              ; preds = %197, %204
  %202 = phi i8 [ %208, %204 ], [ %193, %197 ]
  %203 = phi i32 [ %205, %204 ], [ %190, %197 ]
...
211:                                              ; preds = %209
  ...
  %215 = tail call noalias ptr @malloc(i64 noundef %214) #20
  %216 = icmp eq ptr %215, null
  br i1 %216, label %217, label %219

217:                                              ; preds = %197, %209, %211
  %218 = tail call i32 (ptr, ...) @logg(ptr noundef nonnull @.str.60) #18
  tail call void @free(ptr noundef %135) #18
  tail call void @free(ptr noundef %175) #18
  br label %333

219:                                              ; preds = %211
  %220 = zext i32 %212 to i64
  %221 = tail call ptr @strncpy(ptr noundef nonnull %215, ptr noundef nonnull %199, i64 noundef %220) #18
...
225:                                              ; preds = %219
  %226 = tail call i32 (ptr, ...) @logg(ptr noundef nonnull @.str.61, ptr noundef nonnull %215) #18
  tail call void @free(ptr noundef %135) #18
  tail call void @free(ptr noundef %175) #18
...
230:                                              ; preds = %227
  %231 = tail call i32 (ptr, ...) @logg(ptr noundef nonnull @.str.62) #18
  tail call void @free(ptr noundef %135) #18
  tail call void @free(ptr noundef %175) #18
  tail call void @free(ptr noundef nonnull %215) #18
...
236:                                              ; preds = %233
  %237 = tail call i32 (ptr, ...) @logg(ptr noundef nonnull @.str.63, ptr noundef nonnull %228) #18
  tail call void @free(ptr noundef %135) #18
  tail call void @free(ptr noundef %175) #18
  tail call void @free(ptr noundef nonnull %215) #18
  %238 = tail call i32 @fclose(ptr noundef nonnull %223)
  tail call void @free(ptr noundef nonnull %228) #18
  br label %333

239:                                              ; preds = %233
  %240 = tail call ptr @cli_gentemp(ptr noundef nonnull @.str.42) #18
  %241 = icmp eq ptr %240, null
  br i1 %241, label %242, label %246

242:                                              ; preds = %239
  %243 = tail call i32 (ptr, ...) @logg(ptr noundef nonnull @.str.64) #18
  tail call void @free(ptr noundef %135) #18
  tail call void @free(ptr noundef %175) #18
  tail call void @free(ptr noundef nonnull %215) #18
...
249:                                              ; preds = %246
  %250 = tail call i32 @llvm.umax.i32(i32 %52, i32 %96)
  br label %301

251:                                              ; preds = %246
  %252 = tail call i32 (ptr, ...) @logg(ptr noundef nonnull @.str.65, ptr noundef nonnull %240) #18
  tail call void @free(ptr noundef %135) #18
  tail call void @free(ptr noundef %175) #18
  tail call void @free(ptr noundef nonnull %215) #18
  %253 = tail call i32 @fclose(ptr noundef nonnull %223)
  tail call void @free(ptr noundef nonnull %228) #18
  %254 = tail call i32 @fclose(ptr noundef nonnull %234)
  tail call void @free(ptr noundef nonnull %240) #18
  br label %333

255:                                              ; preds = %301, %304
  %256 = phi i32 [ %260, %304 ], [ %303, %301 ]
  %257 = call ptr @fgets(ptr noundef nonnull %3, i32 noundef 1024, ptr noundef nonnull %223)
  %258 = icmp eq ptr %257, null
  br i1 %258, label %312, label %259

259:                                              ; preds = %255
  %260 = add i32 %256, 1
  %261 = icmp eq i32 %260, %52
  br i1 %261, label %262, label %304

262:                                              ; preds = %259
  %263 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %135) #19
  %264 = call i32 @strncmp(ptr noundef nonnull %3, ptr noundef nonnull %135, i64 noundef %263) #19
...
266:                                              ; preds = %262
  ...
  %267 = call i32 @fclose(ptr noundef nonnull %223)
  call void @free(ptr noundef %302) #18
  %268 = call i32 @fclose(ptr noundef nonnull %234)
  %269 = call i32 @fclose(ptr noundef nonnull %247)
  %270 = call i32 @unlink(ptr noundef %240) #18
  call void @free(ptr noundef %240) #18
  %271 = call i32 (ptr, ...) @logg(ptr noundef nonnull @.str.66, i32 noundef %52) #18
  br label %333

272:                                              ; preds = %262, %287
  %273 = phi i32 [ %288, %287 ], [ %52, %262 ]
  %274 = call i32 @fputs(ptr noundef nonnull %3, ptr noundef nonnull %234)
...
276:                                              ; preds = %272
  ...
  call void @free(ptr noundef %175) #18
  call void @free(ptr noundef %215) #18
  %277 = call i32 @fclose(ptr noundef nonnull %223)
  %278 = call i32 @fclose(ptr noundef nonnull %234)
  %279 = call i32 @fclose(ptr noundef nonnull %247)
  %280 = call i32 @unlink(ptr noundef %240) #18
  call void @free(ptr noundef %240) #18
  %281 = call i32 (ptr, ...) @logg(ptr noundef nonnull @.str.67, ptr noundef %302) #18
  call void @free(ptr noundef %302) #18
  br label %333

282:                                              ; preds = %272
  %283 = icmp eq i32 %273, %250
  br i1 %283, label %290, label %284

284:                                              ; preds = %282
  %285 = call ptr @fgets(ptr noundef nonnull %3, i32 noundef 1024, ptr noundef nonnull %223)
...
287:                                              ; preds = %284
  ...
  br i1 %289, label %290, label %272, !llvm.loop !47

290:                                              ; preds = %284, %282, %287
  %291 = phi i32 [ 1, %287 ], [ %273, %284 ], [ %250, %282 ]
  %292 = call i32 @fclose(ptr noundef nonnull %234)
  call void @free(ptr noundef %302) #18
  call void @free(ptr noundef %135) #18
  %293 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %175) #19
  %294 = call i32 @strncmp(ptr noundef nonnull %3, ptr noundef nonnull %175, i64 noundef %293) #19
  %295 = icmp eq i32 %294, 0
  call void @free(ptr noundef %175) #18
  br i1 %295, label %301, label %296, !llvm.loop !48

296:                                              ; preds = %290
  call void @free(ptr noundef %215) #18
  %297 = call i32 @fclose(ptr noundef nonnull %223)
  %298 = call i32 @fclose(ptr noundef nonnull %247)
  %299 = call i32 @unlink(ptr noundef %240) #18
  call void @free(ptr noundef %240) #18
  %300 = call i32 (ptr, ...) @logg(ptr noundef nonnull @.str.66, i32 noundef %291) #18
  br label %333

301:                                              ; preds = %290, %249
  %302 = phi ptr [ %228, %249 ], [ null, %290 ]
  %303 = phi i32 [ 0, %249 ], [ %291, %290 ]
  br label %255

304:                                              ; preds = %259
  %305 = call i32 @fputs(ptr noundef nonnull %3, ptr noundef nonnull %247)
  %306 = icmp eq i32 %305, -1
  br i1 %306, label %307, label %255, !llvm.loop !48

307:                                              ; preds = %304
  call void @free(ptr noundef %215) #18
  %308 = call i32 @fclose(ptr noundef nonnull %223)
  %309 = call i32 @fclose(ptr noundef nonnull %247)
  %310 = call i32 @unlink(ptr noundef %240) #18
  %311 = call i32 (ptr, ...) @logg(ptr noundef nonnull @.str.67, ptr noundef %240) #18
  call void @free(ptr noundef %240) #18
  br label %333

312:                                              ; preds = %255
  %313 = call i32 @fclose(ptr noundef nonnull %223)
  %314 = call i32 @fclose(ptr noundef nonnull %247)
  %315 = icmp eq ptr %302, null
  br i1 %315, label %320, label %316

316:                                              ; preds = %312
  %317 = call i32 @fclose(ptr noundef nonnull %234)
  call void @free(ptr noundef %135) #18
  call void @free(ptr noundef %175) #18
...
333:                                              ; preds = %332, %329, %323, %316, %307, %296, %276, %266, %251, %242, %236, %230, %225, %217, %177, %137, %98, %89, %45, %6
  %334 = phi i32 [ -1, %6 ], [ -1, %98 ], [ -1, %266 ], [ -1, %276 ], [ -1, %296 ], [ -1, %307 ], [ -1, %316 ], [ -1, %323 ], [ -1, %329 ], [ 0, %332 ], [ -1, %251 ], [ -1, %242 ], [ -1, %236 ], [ -1, %230 ], [ -1, %225 ], [ -1, %217 ], [ -1, %177 ], [ -1, %137 ], [ -1, %89 ], [ -1, %45 ]
  call void @llvm.lifetime.end.p0(i64 1024, ptr nonnull %3) #18
  ret i32 %334
}
...
5:                                                ; preds = %2
  %6 = tail call i32 (ptr, ...) @logg(ptr noundef nonnull @.str.71, ptr noundef nonnull %3) #18
  br label %65
...
26:                                               ; preds = %24
  ...
  %29 = tail call noalias ptr @strdup(ptr noundef nonnull %28) #18
  %30 = icmp eq ptr %29, null
  br i1 %30, label %34, label %31

31:                                               ; preds = %26
  %32 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %29) #19
  %33 = icmp eq i64 %32, 0
  br i1 %33, label %59, label %40

34:                                               ; preds = %7, %24, %26
  %35 = tail call i32 (ptr, ...) @logg(ptr noundef nonnull @.str.72) #18
  br label %65
...
57:                                               ; preds = %53, %45
  %58 = tail call i32 (ptr, ...) @logg(ptr noundef nonnull @.str.73) #18
  tail call void @free(ptr noundef nonnull %29) #18
  br label %65

59:                                               ; preds = %36, %31
  %60 = tail call i32 @unlink(ptr noundef nonnull %29) #18
  %61 = icmp eq i32 %60, -1
  br i1 %61, label %62, label %64

62:                                               ; preds = %59
  %63 = tail call i32 (ptr, ...) @logg(ptr noundef nonnull @.str.74, ptr noundef nonnull %29) #18
  tail call void @free(ptr noundef nonnull %29) #18
  br label %65
