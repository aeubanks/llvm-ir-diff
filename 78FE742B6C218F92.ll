...
for.body:                                         ; preds = %for.body.lr.ph, %for.cond.cleanup401
  %25 = phi i64 [ %6, %for.body.lr.ph ], [ %287, %for.cond.cleanup401 ]
...
for.body101:                                      ; preds = %for.cond97.preheader, %for.cond.cleanup369
  ...
  %33 = phi i32 [ %284, %for.cond.cleanup369 ], [ %31, %for.cond97.preheader ]
...
while.body:                                       ; preds = %if.end165, %if.end286
  ...
  %add178 = add nsw i32 %interval.0757, 1
  %conv179.pn.in = select i1 %tobool.not, i32 %interval.0757, i32 %add178
...
if.then192:                                       ; preds = %while.body
  %dec = add nsw i32 %interval.0757, -1
...
if.else200:                                       ; preds = %while.body
  %57 = tail call float @llvm.fmuladd.f32(float %s.1758, float %conv112, float %54)
  %58 = insertelement <2 x float> poison, float %57, i64 0
  %59 = insertelement <2 x float> %58, float %s.1758, i64 1
  br label %if.end203

if.end203:                                        ; preds = %if.else200, %if.then192
  %interval.2 = phi i32 [ %interval.1, %if.then192 ], [ %interval.0757, %if.else200 ]
  %60 = phi <2 x float> [ %56, %if.then192 ], [ %59, %if.else200 ]
  %61 = extractelement <2 x float> %60, i64 1
  %sub204 = fsub float %s.1758, %61
...
if.then219:                                       ; preds = %if.end203
  ...
  %arrayidx222 = getelementptr inbounds %struct.Track2D, ptr %65, i64 %i.0794
...
if.then228:                                       ; preds = %if.end203
  ...
  %arrayidx232 = getelementptr inbounds %struct.Track2D, ptr %68, i64 %i.0794
...
vector.ph1049:                                    ; preds = %vector.memcheck1036
  ...
  %broadcast.splat1059 = shufflevector <2 x float> %60, <2 x float> poison, <4 x i32> <i32 1, i32 1, i32 1, i32 1>
...
vector.body1054:                                  ; preds = %vector.body1054, %vector.ph1049
  ...
  %85 = getelementptr inbounds float, ptr %79, i64 %index1055
  %wide.load1056 = load <4 x float>, ptr %85, align 4, !tbaa !10
  %86 = getelementptr inbounds float, ptr %85, i64 4
  %wide.load1057 = load <4 x float>, ptr %86, align 4, !tbaa !10
  %87 = getelementptr inbounds float, ptr %add.ptr14, i64 %index1055
  store <4 x float> %wide.load1056, ptr %87, align 4, !tbaa !10
  %88 = getelementptr inbounds float, ptr %87, i64 4
  store <4 x float> %wide.load1057, ptr %88, align 4, !tbaa !10
  %89 = fmul <4 x float> %broadcast.splat1059, %wide.load1056
  %90 = fmul <4 x float> %broadcast.splat1059, %wide.load1057
  %91 = getelementptr inbounds float, ptr %add.ptr17, i64 %index1055
  ...
  %93 = icmp eq i64 %index.next1062, %n.vec1051
  br i1 %93, label %middle.block1046, label %vector.body1054, !llvm.loop !176
...
for.body48.lr.ph.i:                               ; preds = %interpolateTable.exit.i
  ...
  %min.iters.check1020 = icmp ult i32 %78, 8
  br i1 %min.iters.check1020, label %for.body48.i.preheader, label %vector.memcheck982

vector.memcheck982:                               ; preds = %for.body48.lr.ph.i
  %102 = shl nuw nsw i64 %wide.trip.count.i, 2
  %scevgep984 = getelementptr i8, ptr %scevgep983, i64 %102
  %scevgep985 = getelementptr i8, ptr %psi.0.i, i64 %102
  %scevgep986 = getelementptr i8, ptr %101, i64 %102
  %scevgep988 = getelementptr i8, ptr %scevgep987, i64 %102
  %scevgep990 = getelementptr i8, ptr %scevgep989, i64 %102
  ...
  %bound1995 = icmp ult ptr %101, %scevgep984
  ...
  %bound11007 = icmp ult ptr %101, %scevgep985
...
vector.body1026:                                  ; preds = %vector.body1026, %vector.ph1021
  ...
  %103 = getelementptr inbounds float, ptr %101, i64 %index1027
  %wide.load1028 = load <4 x float>, ptr %103, align 4, !tbaa !10, !alias.scope !178
  %104 = getelementptr inbounds float, ptr %add.ptr14, i64 %index1027
  %wide.load1029 = load <4 x float>, ptr %104, align 4, !tbaa !10, !alias.scope !181
  %105 = fdiv <4 x float> %wide.load1028, %wide.load1029
  %106 = getelementptr inbounds float, ptr %psi.0.i, i64 %index1027
  %wide.load1030 = load <4 x float>, ptr %106, align 4, !tbaa !10, !alias.scope !183, !noalias !185
  %107 = fsub <4 x float> %wide.load1030, %105
  %108 = getelementptr inbounds float, ptr %add.ptr23, i64 %index1027
  %wide.load1031 = load <4 x float>, ptr %108, align 4, !tbaa !10, !alias.scope !187
  %109 = fmul <4 x float> %107, %wide.load1031
  %110 = fmul <4 x float> %broadcast.splat1033, %109
  %111 = getelementptr inbounds float, ptr %add.ptr32, i64 %index1027
  store <4 x float> %110, ptr %111, align 4, !tbaa !10, !alias.scope !188, !noalias !190
  %wide.load1034 = load <4 x float>, ptr %106, align 4, !tbaa !10, !alias.scope !183, !noalias !185
  %112 = fsub <4 x float> %wide.load1034, %109
  store <4 x float> %112, ptr %106, align 4, !tbaa !10, !alias.scope !183, !noalias !185
  %index.next1035 = add nuw i64 %index1027, 4
  %113 = icmp eq i64 %index.next1035, %n.vec1023
  br i1 %113, label %middle.block1018, label %vector.body1026, !llvm.loop !191
...
for.body48.i.preheader:                           ; preds = %vector.memcheck982, %for.body48.lr.ph.i, %middle.block1018
  %indvars.iv145.i.ph = phi i64 [ 0, %vector.memcheck982 ], [ 0, %for.body48.lr.ph.i ], [ %n.vec1023, %middle.block1018 ]
  br label %for.body48.i
...
for.body76.i.preheader:                           ; preds = %for.body48.i, %middle.block1018
  %min.iters.check969 = icmp ult i32 %78, 8
...
vector.memcheck960:                               ; preds = %for.body76.i.preheader
  ...
  %scevgep961 = getelementptr i8, ptr %77, i64 %124
  %scevgep963 = getelementptr i8, ptr %scevgep962, i64 %124
  %bound0964 = icmp ult ptr %77, %scevgep963
...
vector.body975:                                   ; preds = %vector.body975, %vector.ph970
  ...
  %125 = getelementptr inbounds float, ptr %add.ptr32, i64 %index976
  %wide.load977 = load <4 x float>, ptr %125, align 4, !tbaa !10, !alias.scope !193
  %126 = getelementptr inbounds float, ptr %125, i64 4
  %wide.load978 = load <4 x float>, ptr %126, align 4, !tbaa !10, !alias.scope !193
  %127 = getelementptr inbounds float, ptr %77, i64 %index976
  %wide.load979 = load <4 x float>, ptr %127, align 4, !tbaa !10, !alias.scope !196, !noalias !193
  %128 = getelementptr inbounds float, ptr %127, i64 4
  %wide.load980 = load <4 x float>, ptr %128, align 4, !tbaa !10, !alias.scope !196, !noalias !193
  %129 = fadd <4 x float> %wide.load977, %wide.load979
  %130 = fadd <4 x float> %wide.load978, %wide.load980
  ...
  %131 = icmp eq i64 %index.next981, %n.vec972
  br i1 %131, label %middle.block967, label %vector.body975, !llvm.loop !198
...
if.end238:                                        ; preds = %for.body76.i.prol.loopexit, %for.body76.i, %middle.block967, %if.then228, %if.then219
  %145 = phi ptr [ %.pre, %if.then219 ], [ %67, %if.then228 ], [ %67, %middle.block967 ], [ %67, %for.body76.i ], [ %67, %for.body76.i.prol.loopexit ]
...
for.cond365.preheader:                            ; preds = %for.cond.cleanup313
  %cmp367784 = icmp sgt i32 %192, 0
  br i1 %cmp367784, label %for.body370.lr.ph, label %for.cond.cleanup369

for.body370.lr.ph:                                ; preds = %for.cond365.preheader
  %152 = load ptr, ptr %tracks, align 8, !tbaa !119
  %arrayidx373 = getelementptr inbounds ptr, ptr %152, i64 %i.0794
  %153 = load ptr, ptr %arrayidx373, align 8, !tbaa !16
  %arrayidx375 = getelementptr inbounds ptr, ptr %153, i64 %indvars.iv832
  %154 = load ptr, ptr %arrayidx375, align 8, !tbaa !16
  %155 = and i8 %spec.select, 1
  %tobool378.not = icmp eq i8 %155, 0
  %156 = load float, ptr %axial_z_sep, align 8, !tbaa !149
  %wide.trip.count830 = zext i32 %192 to i64
  %min.iters.check = icmp ult i32 %192, 4
...
vector.ph852:                                     ; preds = %for.body370.preheader
  ...
  %broadcast.splatinsert861 = insertelement <4 x float> poison, float %156, i64 0
...
vector.body857:                                   ; preds = %vector.body857, %vector.ph852
  ...
  %157 = or i64 %index858, 1
  %158 = or i64 %index858, 2
  %159 = or i64 %index858, 3
  %160 = sitofp <4 x i32> %vec.ind859 to <4 x float>
  %161 = fmul <4 x float> %broadcast.splat862, %160
  %162 = getelementptr inbounds %struct.Track, ptr %154, i64 %index858, i32 1
  %163 = getelementptr inbounds %struct.Track, ptr %154, i64 %157, i32 1
  %164 = getelementptr inbounds %struct.Track, ptr %154, i64 %158, i32 1
  %165 = getelementptr inbounds %struct.Track, ptr %154, i64 %159, i32 1
  %166 = extractelement <4 x float> %161, i64 0
  store float %166, ptr %162, align 4, !tbaa !40
  %167 = extractelement <4 x float> %161, i64 1
  store float %167, ptr %163, align 4, !tbaa !40
  %168 = extractelement <4 x float> %161, i64 2
  store float %168, ptr %164, align 4, !tbaa !40
  %169 = extractelement <4 x float> %161, i64 3
  ...
  %170 = icmp eq i64 %index.next863, %n.vec854
  br i1 %170, label %middle.block849, label %vector.body857, !llvm.loop !203
...
vector.ph:                                        ; preds = %for.body370.us.preheader
  ...
  %broadcast.splatinsert = insertelement <4 x float> poison, float %156, i64 0
  %broadcast.splat = shufflevector <4 x float> %broadcast.splatinsert, <4 x float> poison, <4 x i32> zeroinitializer
  br label %vector.body
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %172 = or i64 %index, 2
  %173 = or i64 %index, 3
  %174 = trunc <4 x i64> %vec.ind to <4 x i32>
  %175 = add <4 x i32> %174, <i32 1, i32 1, i32 1, i32 1>
  %176 = sitofp <4 x i32> %175 to <4 x float>
  %177 = fmul <4 x float> %broadcast.splat, %176
  %178 = getelementptr inbounds %struct.Track, ptr %154, i64 %index, i32 1
  %179 = getelementptr inbounds %struct.Track, ptr %154, i64 %171, i32 1
  %180 = getelementptr inbounds %struct.Track, ptr %154, i64 %172, i32 1
  %181 = getelementptr inbounds %struct.Track, ptr %154, i64 %173, i32 1
  %182 = extractelement <4 x float> %177, i64 0
  store float %182, ptr %178, align 4, !tbaa !40
  %183 = extractelement <4 x float> %177, i64 1
  store float %183, ptr %179, align 4, !tbaa !40
  %184 = extractelement <4 x float> %177, i64 2
  store float %184, ptr %180, align 4, !tbaa !40
  %185 = extractelement <4 x float> %177, i64 3
  store float %185, ptr %181, align 4, !tbaa !40
  %index.next = add nuw i64 %index, 4
  %vec.ind.next = add <4 x i64> %vec.ind, <i64 4, i64 4, i64 4, i64 4>
  %186 = icmp eq i64 %index.next, %n.vec
  br i1 %186, label %middle.block, label %vector.body, !llvm.loop !204
...
for.body370.us:                                   ; preds = %for.body370.us.preheader1065, %for.body370.us
  ...
  %187 = trunc i64 %indvars.iv.next827 to i32
  %conv386.us = sitofp i32 %187 to float
  %mul387.us = fmul float %156, %conv386.us
  %z_height388.us = getelementptr inbounds %struct.Track, ptr %154, i64 %indvars.iv826, i32 1
...
for.body305:                                      ; preds = %for.body305.lr.ph, %for.cond.cleanup313
  %188 = phi i32 [ %43, %for.body305.lr.ph ], [ %192, %for.cond.cleanup313 ]
  ...
  %189 = load i32, ptr %arrayidx308, align 4, !tbaa !6
  %cmp311775 = icmp sgt i32 %189, 0
...
for.body314.lr.ph:                                ; preds = %for.body305
  ...
  %190 = load ptr, ptr %arrayidx317, align 8, !tbaa !16
...
for.cond.cleanup313:                              ; preds = %for.cond.cleanup313.loopexit, %for.body305
  %192 = phi i32 [ %188, %for.body305 ], [ %.pre839, %for.cond.cleanup313.loopexit ]
  ...
  %cmp302 = icmp slt i64 %indvars.iv.next817, %193
  br i1 %cmp302, label %for.body305, label %for.cond365.preheader

for.body314:                                      ; preds = %for.body314.lr.ph, %if.end355
  %indvars.iv813 = phi i64 [ %191, %for.body314.lr.ph ], [ %indvars.iv.next814, %if.end355 ]
  ...
  %arrayidx319 = getelementptr inbounds double, ptr %190, i64 %idxprom318
  %194 = load double, ptr %arrayidx319, align 8, !tbaa !201
  %conv320 = fptrunc double %194 to float
  %195 = load ptr, ptr %tracks, align 8, !tbaa !119
  %arrayidx323 = getelementptr inbounds ptr, ptr %195, i64 %i.0794
  %196 = load ptr, ptr %arrayidx323, align 8, !tbaa !16
  %arrayidx325 = getelementptr inbounds ptr, ptr %196, i64 %indvars.iv832
  %197 = load ptr, ptr %arrayidx325, align 8, !tbaa !16
  %arrayidx327 = getelementptr inbounds %struct.Track, ptr %197, i64 %indvars.iv816
  %198 = load i32, ptr %axial_exp, align 8, !tbaa !121
  switch i32 %198, label %if.end355 [
    i32 2, label %if.then331
    i32 0, label %if.then345
  ]

if.then331:                                       ; preds = %for.body314
  %199 = load ptr, ptr %arrayidx347, align 8, !tbaa !16
  %arrayidx335 = getelementptr inbounds ptr, ptr %199, i64 %idxprom318
  %200 = load ptr, ptr %arrayidx335, align 8, !tbaa !16
  %201 = load ptr, ptr %params, align 8, !tbaa !112
  %arrayidx338 = getelementptr inbounds %struct.Track2D, ptr %201, i64 %i.0794
  %202 = load float, ptr %arrayidx338, align 8, !tbaa !123
  call void @attenuate_fluxes(ptr noundef %arrayidx327, i1 noundef zeroext false, ptr noundef %200, ptr noundef nonnull %I, ptr noundef nonnull %params, float noundef %conv320, float noundef %fneg350, float noundef %202, ptr noundef nonnull %A)
  %inc340 = add nsw i64 %segments_processed.7776, 1
  br label %if.end355

if.then345:                                       ; preds = %for.body314
  %203 = load ptr, ptr %arrayidx347, align 8, !tbaa !16
  %arrayidx349 = getelementptr inbounds ptr, ptr %203, i64 %idxprom318
  %204 = load ptr, ptr %arrayidx349, align 8, !tbaa !16
  %205 = load ptr, ptr %params, align 8, !tbaa !112
  %arrayidx352 = getelementptr inbounds %struct.Track2D, ptr %205, i64 %i.0794
  %206 = load float, ptr %arrayidx352, align 8, !tbaa !123
  ...
  %207 = load float, ptr %height, align 4, !tbaa !100
  %208 = load i32, ptr %fai, align 4, !tbaa !103
  %209 = load i32, ptr %decomp_assemblies_ax, align 4, !tbaa !101
  %mul.i665 = mul nsw i32 %209, %208
  %210 = load i32, ptr %cai, align 8, !tbaa !102
  %mul5.i667 = mul nsw i32 %mul.i665, %210
  %conv.i668 = sitofp i32 %mul5.i667 to float
  %div.i669 = fdiv float %207, %conv.i668
  %z_height.i670 = getelementptr inbounds %struct.Track, ptr %197, i64 %indvars.iv816, i32 1
  %211 = load float, ptr %z_height.i670, align 4, !tbaa !40
  %div7.i671 = fdiv float %211, %div.i669
  %conv8.i672 = fptosi float %div7.i671 to i32
  %rem.i673 = srem i32 %conv8.i672, %208
  %212 = load float, ptr %arrayidx327, align 8, !tbaa !42
  %mul15.i674 = fmul float %206, %212
  %mul16.i675 = fmul float %mul15.i674, %fneg350
  %213 = load ptr, ptr %204, align 8, !tbaa !43
  %idxprom.i676 = sext i32 %rem.i673 to i64
  %arrayidx.i677 = getelementptr inbounds ptr, ptr %213, i64 %idxprom.i676
  %214 = load ptr, ptr %arrayidx.i677, align 8, !tbaa !16
  %215 = load i32, ptr %n_egroups, align 4, !tbaa !104
  %cmp131.i679 = icmp sgt i32 %215, 0
  br i1 %cmp131.i679, label %for.body.lr.ph.i682, label %if.end355

for.body.lr.ph.i682:                              ; preds = %if.then345
  %sigT18.i680 = getelementptr inbounds %struct.Source, ptr %204, i64 0, i32 3
  %216 = load ptr, ptr %sigT18.i680, align 8, !tbaa !54
  %wide.trip.count.i681 = zext i32 %215 to i64
  %min.iters.check945 = icmp ult i32 %215, 20
...
vector.body951:                                   ; preds = %vector.body951, %vector.ph946
  ...
  %222 = getelementptr inbounds float, ptr %216, i64 %index952
  %wide.load953 = load <4 x float>, ptr %222, align 4, !tbaa !10
  %223 = getelementptr inbounds float, ptr %222, i64 4
  %wide.load954 = load <4 x float>, ptr %223, align 4, !tbaa !10
  %224 = getelementptr inbounds float, ptr %add.ptr14, i64 %index952
  store <4 x float> %wide.load953, ptr %224, align 4, !tbaa !10
  %225 = getelementptr inbounds float, ptr %224, i64 4
  store <4 x float> %wide.load954, ptr %225, align 4, !tbaa !10
  %226 = fmul <4 x float> %wide.load953, %broadcast.splat956
  %227 = fmul <4 x float> %wide.load954, %broadcast.splat958
  %228 = getelementptr inbounds float, ptr %add.ptr17, i64 %index952
  store <4 x float> %226, ptr %228, align 4, !tbaa !10
  ...
  %230 = icmp eq i64 %index.next959, %n.vec948
  br i1 %230, label %middle.block943, label %vector.body951, !llvm.loop !206
...
for.body.i693.preheader:                          ; preds = %vector.memcheck933, %for.body.lr.ph.i682, %middle.block943
  ...
  %231 = xor i64 %indvars.iv.i686.ph, -1
...
for.body.i693.prol:                               ; preds = %for.body.i693.preheader
  %arrayidx20.i687.prol = getelementptr inbounds float, ptr %216, i64 %indvars.iv.i686.ph
  %232 = load float, ptr %arrayidx20.i687.prol, align 4, !tbaa !10
  %arrayidx22.i688.prol = getelementptr inbounds float, ptr %add.ptr14, i64 %indvars.iv.i686.ph
  store float %232, ptr %arrayidx22.i688.prol, align 4, !tbaa !10
  %mul25.i689.prol = fmul float %232, %conv320
...
for.body.i693.prol.loopexit:                      ; preds = %for.body.i693.prol, %for.body.i693.preheader
  ...
  %233 = sub nsw i64 0, %wide.trip.count.i681
  %234 = icmp eq i64 %231, %233
  br i1 %234, label %for.body34.i705.preheader, label %for.body.i693
...
for.body.i693:                                    ; preds = %for.body.i693.prol.loopexit, %for.body.i693
  ...
  %arrayidx20.i687 = getelementptr inbounds float, ptr %216, i64 %indvars.iv.i686
  %235 = load float, ptr %arrayidx20.i687, align 4, !tbaa !10
  %arrayidx22.i688 = getelementptr inbounds float, ptr %add.ptr14, i64 %indvars.iv.i686
  store float %235, ptr %arrayidx22.i688, align 4, !tbaa !10
  %mul25.i689 = fmul float %235, %conv320
  ...
  %arrayidx20.i687.1 = getelementptr inbounds float, ptr %216, i64 %indvars.iv.next.i691
  %236 = load float, ptr %arrayidx20.i687.1, align 4, !tbaa !10
  %arrayidx22.i688.1 = getelementptr inbounds float, ptr %add.ptr14, i64 %indvars.iv.next.i691
  store float %236, ptr %arrayidx22.i688.1, align 4, !tbaa !10
  %mul25.i689.1 = fmul float %236, %conv320
...
for.body48.lr.ph.i701:                            ; preds = %interpolateTable.exit.i719
  %b_psi.i695 = getelementptr inbounds %struct.Track, ptr %197, i64 %indvars.iv816, i32 5
  %psi.0.i696 = load ptr, ptr %b_psi.i695, align 8, !tbaa !16
  %fine_source.i698 = getelementptr inbounds %struct.Source, ptr %204, i64 0, i32 1
  %237 = load ptr, ptr %fine_source.i698, align 8, !tbaa !45
  %arrayidx50.i699 = getelementptr inbounds ptr, ptr %237, i64 %idxprom.i676
  %238 = load ptr, ptr %arrayidx50.i699, align 8, !tbaa !16
  %min.iters.check917 = icmp ult i32 %215, 8
  br i1 %min.iters.check917, label %for.body48.i736.preheader, label %vector.memcheck880

vector.memcheck880:                               ; preds = %for.body48.lr.ph.i701
  %239 = shl nuw nsw i64 %wide.trip.count.i681, 2
  %scevgep882 = getelementptr i8, ptr %scevgep881, i64 %239
  %scevgep883 = getelementptr i8, ptr %psi.0.i696, i64 %239
  %scevgep884 = getelementptr i8, ptr %238, i64 %239
  %scevgep886 = getelementptr i8, ptr %scevgep885, i64 %239
  %scevgep888 = getelementptr i8, ptr %scevgep887, i64 %239
  ...
  %bound1893 = icmp ult ptr %238, %scevgep882
  ...
  %bound1904 = icmp ult ptr %238, %scevgep883
...
vector.body923:                                   ; preds = %vector.body923, %vector.ph918
  ...
  %240 = getelementptr inbounds float, ptr %238, i64 %index924
  %wide.load925 = load <4 x float>, ptr %240, align 4, !tbaa !10, !alias.scope !208
  %241 = getelementptr inbounds float, ptr %add.ptr14, i64 %index924
  %wide.load926 = load <4 x float>, ptr %241, align 4, !tbaa !10, !alias.scope !211
  %242 = fdiv <4 x float> %wide.load925, %wide.load926
  %243 = getelementptr inbounds float, ptr %psi.0.i696, i64 %index924
  %wide.load927 = load <4 x float>, ptr %243, align 4, !tbaa !10, !alias.scope !213, !noalias !215
  %244 = fsub <4 x float> %wide.load927, %242
  %245 = getelementptr inbounds float, ptr %add.ptr23, i64 %index924
  %wide.load928 = load <4 x float>, ptr %245, align 4, !tbaa !10, !alias.scope !217
  %246 = fmul <4 x float> %244, %wide.load928
  %247 = fmul <4 x float> %broadcast.splat930, %246
  %248 = getelementptr inbounds float, ptr %add.ptr32, i64 %index924
  store <4 x float> %247, ptr %248, align 4, !tbaa !10, !alias.scope !218, !noalias !220
  %wide.load931 = load <4 x float>, ptr %243, align 4, !tbaa !10, !alias.scope !213, !noalias !215
  %249 = fsub <4 x float> %wide.load931, %246
  store <4 x float> %249, ptr %243, align 4, !tbaa !10, !alias.scope !213, !noalias !215
  %index.next932 = add nuw i64 %index924, 4
  %250 = icmp eq i64 %index.next932, %n.vec920
  br i1 %250, label %middle.block915, label %vector.body923, !llvm.loop !221
...
for.body48.i736.preheader:                        ; preds = %vector.memcheck880, %for.body48.lr.ph.i701, %middle.block915
  %indvars.iv145.i723.ph = phi i64 [ 0, %vector.memcheck880 ], [ 0, %for.body48.lr.ph.i701 ], [ %n.vec920, %middle.block915 ]
...
for.body34.i705:                                  ; preds = %for.body34.i705.preheader, %interpolateTable.exit.i719
  ...
  %251 = load float, ptr %arrayidx36.i703, align 4, !tbaa !10
  %cmp.i.i704 = fcmp olt float %params.sroa.5.0.copyload.i661, %251
  br i1 %cmp.i.i704, label %interpolateTable.exit.i719, label %if.else.i.i714

if.else.i.i714:                                   ; preds = %for.body34.i705
  %div.i.i706 = fdiv float %251, %params.sroa.4.0.copyload.i659
  %252 = tail call float @llvm.fmuladd.f32(float %params.sroa.4.0.copyload.i659, float 5.000000e-01, float %div.i.i706)
  %conv.i.i707 = fptosi float %252 to i32
  ...
  %253 = load float, ptr %arrayidx.i.i710, align 4, !tbaa !10
  ...
  %254 = load float, ptr %arrayidx5.i.i713, align 4, !tbaa !10
  %255 = tail call float @llvm.fmuladd.f32(float %253, float %251, float %254)
  br label %interpolateTable.exit.i719

interpolateTable.exit.i719:                       ; preds = %if.else.i.i714, %for.body34.i705
  %retval.0.i.i715 = phi float [ %255, %if.else.i.i714 ], [ 1.000000e+00, %for.body34.i705 ]
  ...
  br i1 %exitcond144.not.i718, label %for.body48.lr.ph.i701, label %for.body34.i705
...
for.body48.i736:                                  ; preds = %for.body48.i736.preheader, %for.body48.i736
  ...
  %arrayidx52.i724 = getelementptr inbounds float, ptr %238, i64 %indvars.iv145.i723
  %256 = load float, ptr %arrayidx52.i724, align 4, !tbaa !10
  %arrayidx54.i725 = getelementptr inbounds float, ptr %add.ptr14, i64 %indvars.iv145.i723
  %257 = load float, ptr %arrayidx54.i725, align 4, !tbaa !10
  %div55.i726 = fdiv float %256, %257
  %arrayidx57.i727 = getelementptr inbounds float, ptr %psi.0.i696, i64 %indvars.iv145.i723
  %258 = load float, ptr %arrayidx57.i727, align 4, !tbaa !10
  %sub.i728 = fsub float %258, %div55.i726
  %arrayidx59.i729 = getelementptr inbounds float, ptr %add.ptr23, i64 %indvars.iv145.i723
  %259 = load float, ptr %arrayidx59.i729, align 4, !tbaa !10
  %mul60.i730 = fmul float %sub.i728, %259
  ...
  %260 = load float, ptr %arrayidx57.i727, align 4, !tbaa !10
  %sub66.i733 = fsub float %260, %mul60.i730
...
for.body76.i743.preheader:                        ; preds = %for.body48.i736, %middle.block915
  %min.iters.check868 = icmp ult i32 %215, 8
...
vector.memcheck:                                  ; preds = %for.body76.i743.preheader
  %261 = shl nuw nsw i64 %wide.trip.count.i681, 2
  %scevgep = getelementptr i8, ptr %214, i64 %261
  %scevgep865 = getelementptr i8, ptr %scevgep864, i64 %261
  %bound0 = icmp ult ptr %214, %scevgep865
  %bound1 = icmp ult ptr %add.ptr32, %scevgep
  %found.conflict = and i1 %bound0, %bound1
...
vector.body874:                                   ; preds = %vector.body874, %vector.ph869
  ...
  %262 = getelementptr inbounds float, ptr %add.ptr32, i64 %index875
  %wide.load = load <4 x float>, ptr %262, align 4, !tbaa !10, !alias.scope !223
  %263 = getelementptr inbounds float, ptr %262, i64 4
  %wide.load876 = load <4 x float>, ptr %263, align 4, !tbaa !10, !alias.scope !223
  %264 = getelementptr inbounds float, ptr %214, i64 %index875
  %wide.load877 = load <4 x float>, ptr %264, align 4, !tbaa !10, !alias.scope !226, !noalias !223
  %265 = getelementptr inbounds float, ptr %264, i64 4
  %wide.load878 = load <4 x float>, ptr %265, align 4, !tbaa !10, !alias.scope !226, !noalias !223
  %266 = fadd <4 x float> %wide.load, %wide.load877
  %267 = fadd <4 x float> %wide.load876, %wide.load878
  store <4 x float> %266, ptr %264, align 4, !tbaa !10, !alias.scope !226, !noalias !223
  store <4 x float> %267, ptr %265, align 4, !tbaa !10, !alias.scope !226, !noalias !223
  %index.next879 = add nuw i64 %index875, 8
  %268 = icmp eq i64 %index.next879, %n.vec871
  br i1 %268, label %middle.block866, label %vector.body874, !llvm.loop !228
...
for.body76.i743.preheader1064:                    ; preds = %vector.memcheck, %for.body76.i743.preheader, %middle.block866
  ...
  %269 = xor i64 %indvars.iv150.i737.ph, -1
  %270 = add nsw i64 %269, %wide.trip.count.i681
...
for.body76.i743.prol:                             ; preds = %for.body76.i743.preheader1064, %for.body76.i743.prol
  ...
  %271 = load float, ptr %arrayidx78.i738.prol, align 4, !tbaa !10
  %arrayidx80.i739.prol = getelementptr inbounds float, ptr %214, i64 %indvars.iv150.i737.prol
  %272 = load float, ptr %arrayidx80.i739.prol, align 4, !tbaa !10
  %add81.i740.prol = fadd float %271, %272
...
for.body76.i743.prol.loopexit:                    ; preds = %for.body76.i743.prol, %for.body76.i743.preheader1064
  ...
  br i1 %273, label %if.end355, label %for.body76.i743
...
for.body76.i743:                                  ; preds = %for.body76.i743.prol.loopexit, %for.body76.i743
  ...
  %274 = load float, ptr %arrayidx78.i738, align 4, !tbaa !10
  %arrayidx80.i739 = getelementptr inbounds float, ptr %214, i64 %indvars.iv150.i737
  %275 = load float, ptr %arrayidx80.i739, align 4, !tbaa !10
  %add81.i740 = fadd float %274, %275
  ...
  %276 = load float, ptr %arrayidx78.i738.1, align 4, !tbaa !10
  %arrayidx80.i739.1 = getelementptr inbounds float, ptr %214, i64 %indvars.iv.next151.i741
  %277 = load float, ptr %arrayidx80.i739.1, align 4, !tbaa !10
  %add81.i740.1 = fadd float %276, %277
  ...
  %278 = load float, ptr %arrayidx78.i738.2, align 4, !tbaa !10
  %arrayidx80.i739.2 = getelementptr inbounds float, ptr %214, i64 %indvars.iv.next151.i741.1
  %279 = load float, ptr %arrayidx80.i739.2, align 4, !tbaa !10
  %add81.i740.2 = fadd float %278, %279
  ...
  %280 = load float, ptr %arrayidx78.i738.3, align 4, !tbaa !10
  %arrayidx80.i739.3 = getelementptr inbounds float, ptr %214, i64 %indvars.iv.next151.i741.2
  %281 = load float, ptr %arrayidx80.i739.3, align 4, !tbaa !10
  %add81.i740.3 = fadd float %280, %281
...
if.end355:                                        ; preds = %for.body76.i743.prol.loopexit, %for.body76.i743, %middle.block866, %if.then345, %for.body314, %if.then331
  ...
  %z_height357 = getelementptr inbounds %struct.Track, ptr %197, i64 %indvars.iv816, i32 1
  %282 = load float, ptr %z_height357, align 4, !tbaa !40
  %neg = fneg float %conv320
  %283 = tail call float @llvm.fmuladd.f32(float %neg, float %conv112, float %282)
  store float %283, ptr %z_height357, align 4, !tbaa !40
...
for.cond.cleanup369:                              ; preds = %for.body370, %for.body370.us, %middle.block849, %middle.block, %for.cond300.preheader, %for.cond365.preheader
  %.lcssa844 = phi i32 [ %192, %for.cond365.preheader ], [ %43, %for.cond300.preheader ], [ %192, %middle.block ], [ %192, %middle.block849 ], [ %192, %for.body370.us ], [ %192, %for.body370 ]
  ...
  %284 = load i32, ptr %n_polar_angles, align 8, !tbaa !106
  %285 = sext i32 %284 to i64
  %cmp98 = icmp slt i64 %indvars.iv.next833, %285
...
for.body370:                                      ; preds = %for.body370.preheader1066, %for.body370
  ...
  %286 = trunc i64 %indvars.iv820 to i32
  %conv380 = sitofp i32 %286 to float
  %mul381 = fmul float %156, %conv380
  %z_height382 = getelementptr inbounds %struct.Track, ptr %154, i64 %indvars.iv820, i32 1
...
for.cond.cleanup401:                              ; preds = %for.body402, %for.cond397.preheader
  ...
  %287 = load i64, ptr %ntracks_2D, align 8, !tbaa !105
  %cmp45 = icmp slt i64 %inc411, %287
...
for.body402:                                      ; preds = %for.cond397.preheader, %for.body402
  ...
  %288 = load ptr, ptr %arrayidx404, align 8, !tbaa !16
  tail call void @free(ptr noundef %288) #17
  %arrayidx406 = getelementptr inbounds ptr, ptr %call64, i64 %indvars.iv834
  %289 = load ptr, ptr %arrayidx406, align 8, !tbaa !16
  tail call void @free(ptr noundef %289) #17
  %indvars.iv.next835 = add nuw nsw i64 %indvars.iv834, 1
  %290 = load i32, ptr %z_stacked, align 8, !tbaa !115
  %291 = sext i32 %290 to i64
  %cmp399 = icmp slt i64 %indvars.iv.next835, %291
