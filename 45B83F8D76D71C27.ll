...
if.else.i:                                        ; preds = %if.end24.i
  ...
  %add.i.i.i117.i = add nsw i32 %21, 1
  %cmp.i.i.i118.i = icmp eq i32 %add.i.i.i117.i, 0
  br i1 %cmp.i.i.i118.i, label %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i123.i, label %if.end.i.i.i122.i

if.end.i.i.i122.i:                                ; preds = %if.else.i
  %_capacity.i.i119.i = getelementptr inbounds %class.CStringBase, ptr %agg.result, i64 0, i32 2
  %conv.i.i.i120.i = zext i32 %add.i.i.i117.i to i64
  ...
  store i32 %add.i.i.i117.i, ptr %_capacity.i.i119.i, align 4, !tbaa !21, !alias.scope !36
