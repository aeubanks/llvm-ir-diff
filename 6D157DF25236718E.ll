...
entry:
  ...
  br i1 %cmp25.not, label %for.cond7.preheader, label %for.body.lr.ph
...
for.body:                                         ; preds = %for.body.lr.ph, %for.body
  ...
  %xor30.i29 = phi i32 [ 878082192, %for.body.lr.ph ], [ %xor30.i, %for.body ]
  %add13.i28 = phi i32 [ 591751049, %for.body.lr.ph ], [ %add13.i, %for.body ]
  %xor5.i27 = phi i32 [ 305419896, %for.body.lr.ph ], [ %xor5.i, %for.body ]
  %arrayidx6 = getelementptr inbounds i8, ptr %password, i64 %indvars.iv
  %3 = load i8, ptr %arrayidx6, align 1, !tbaa !9
  %.tr.i = trunc i32 %xor5.i27 to i8
  %xor.narrow.i = xor i8 %3, %.tr.i
  ...
  %shr.i = lshr i32 %xor5.i27, 8
  %xor5.i = xor i32 %4, %shr.i
  store i32 %xor5.i, ptr %Keys, align 4, !tbaa !5
  %and12.i = and i32 %xor5.i, 255
  %add.i = add i32 %add13.i28, %and12.i
  ...
  %.masked.i = and i32 %xor30.i29, 255
...
entry:
  ...
  br i1 %cmp25.not.i, label %_ZN7NCrypto4NZip7CCipher17CryptoSetPasswordEPKhj.exit, label %for.body.lr.ph.i
...
for.body.i:                                       ; preds = %for.body.i, %for.body.lr.ph.i
  ...
  %xor30.i29.i = phi i32 [ 878082192, %for.body.lr.ph.i ], [ %xor30.i.i, %for.body.i ]
  %add13.i28.i = phi i32 [ 591751049, %for.body.lr.ph.i ], [ %add13.i.i, %for.body.i ]
  %xor5.i27.i = phi i32 [ 305419896, %for.body.lr.ph.i ], [ %xor5.i.i, %for.body.i ]
  %arrayidx6.i = getelementptr inbounds i8, ptr %password, i64 %indvars.iv.i
  %0 = load i8, ptr %arrayidx6.i, align 1, !tbaa !9
  %.tr.i.i = trunc i32 %xor5.i27.i to i8
  %xor.narrow.i.i = xor i8 %0, %.tr.i.i
  ...
  %shr.i.i = lshr i32 %xor5.i27.i, 8
  %xor5.i.i = xor i32 %1, %shr.i.i
  store i32 %xor5.i.i, ptr %Keys.i, align 4, !tbaa !5
  %and12.i.i = and i32 %xor5.i.i, 255
  %add.i.i = add i32 %and12.i.i, %add13.i28.i
  ...
  %.masked.i.i = and i32 %xor30.i29.i, 255
  ...
  %2 = load i32, ptr %arrayidx26.i.i, align 4, !tbaa !5
  %shr29.i.i = lshr i32 %xor30.i29.i, 8
  %xor30.i.i = xor i32 %2, %shr29.i.i
...
_ZN7NCrypto4NZip7CCipher17CryptoSetPasswordEPKhj.exit: ; preds = %for.body.i, %entry
  %3 = phi i32 [ 878082192, %entry ], [ %xor30.i.i, %for.body.i ]
  %4 = phi i32 [ 591751049, %entry ], [ %add13.i.i, %for.body.i ]
  %5 = phi i32 [ 305419896, %entry ], [ %xor5.i.i, %for.body.i ]
  %arrayidx15.i = getelementptr inbounds i8, ptr %this, i64 24
  store i32 %5, ptr %arrayidx15.i, align 8, !tbaa !5
  %arrayidx15.1.i = getelementptr inbounds i8, ptr %this, i64 28
  store i32 %4, ptr %arrayidx15.1.i, align 4, !tbaa !5
  %arrayidx15.2.i = getelementptr inbounds i8, ptr %this, i64 32
  store i32 %3, ptr %arrayidx15.2.i, align 8, !tbaa !5
  ret i32 0
}
