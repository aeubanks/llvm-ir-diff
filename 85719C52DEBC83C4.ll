; ModuleID = '/usr/local/google/home/aeubanks/repos/test-suite/SingleSource/UnitTests/2008-04-20-LoopBug2.c'
source_filename = "/usr/local/google/home/aeubanks/repos/test-suite/SingleSource/UnitTests/2008-04-20-LoopBug2.c"
...
define dso_local void @foo(i32 noundef %0, ptr nocapture noundef %1) local_unnamed_addr #0 {
  ...
  %6 = icmp ult i32 %0, 2
  br i1 %6, label %7, label %15, !llvm.loop !9
...
15:                                               ; preds = %12, %7, %2
  ...
  %23 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %0, i32 noundef %16, i32 noundef %18, i32 noundef %20, i32 noundef %22)
  ret void
}
