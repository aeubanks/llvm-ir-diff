...
entry:
  %call = tail call i32 @init(ptr noundef nonnull @.str.10)
...
; Function Attrs: nounwind uwtable
define dso_local i32 @s122(i32 noundef %n1, i32 noundef %n3) local_unnamed_addr #7 {
entry:
  %call = tail call i32 @init(ptr noundef nonnull @.str.11)
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
  %cmp22 = icmp sgt i32 %0, 0
  br i1 %cmp22, label %for.body.lr.ph, label %for.cond.cleanup

for.body.lr.ph:                                   ; preds = %entry
  %cmp219 = icmp slt i32 %n1, 32001
  br i1 %cmp219, label %for.body.us.preheader, label %for.body
...
for.body.us:                                      ; preds = %for.body.us.preheader, %for.cond1.for.cond.cleanup3_crit_edge.us
  %nl.023.us = phi i32 [ %inc.us, %for.cond1.for.cond.cleanup3_crit_edge.us ], [ 0, %for.body.us.preheader ]
  br label %for.body4.us

for.body4.us:                                     ; preds = %for.body.us, %for.body4.us
  %indvars.iv25 = phi i64 [ 0, %for.body.us ], [ %indvars.iv.next26, %for.body4.us ]
  %indvars.iv = phi i64 [ %1, %for.body.us ], [ %indvars.iv.next, %for.body4.us ]
  %indvars.iv.next26 = add nuw i64 %indvars.iv25, 1
  %3 = sub nsw i64 31999, %indvars.iv25
  %arrayidx.us = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %3
  %4 = load double, ptr %arrayidx.us, align 8, !tbaa !5
  %arrayidx7.us = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv
  %5 = load double, ptr %arrayidx7.us, align 8, !tbaa !5
  %add8.us = fadd double %4, %5
  store double %add8.us, ptr %arrayidx7.us, align 8, !tbaa !5
...
for.cond1.for.cond.cleanup3_crit_edge.us:         ; preds = %for.body4.us
  %call10.us = tail call i32 @dummy(ptr noundef nonnull @global_data, ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 11, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 20, i64 0, i64 0), double noundef 0.000000e+00) #16
  %inc.us = add nuw nsw i32 %nl.023.us, 1
...
for.body.i:                                       ; preds = %for.body.i, %for.cond.cleanup
  ...
  %suma.0192.i = phi double [ 0.000000e+00, %for.cond.cleanup ], [ %add.i.4, %for.body.i ]
  %arrayidx.i = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv.i
  %7 = load double, ptr %arrayidx.i, align 8, !tbaa !5
  %add.i = fadd double %suma.0192.i, %7
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1
  %arrayidx.i.1 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv.next.i
  %8 = load double, ptr %arrayidx.i.1, align 8, !tbaa !5
  %add.i.1 = fadd double %add.i, %8
  %indvars.iv.next.i.1 = add nuw nsw i64 %indvars.iv.i, 2
  %arrayidx.i.2 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv.next.i.1
  %9 = load double, ptr %arrayidx.i.2, align 8, !tbaa !5
  %add.i.2 = fadd double %add.i.1, %9
  %indvars.iv.next.i.2 = add nuw nsw i64 %indvars.iv.i, 3
  %arrayidx.i.3 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv.next.i.2
  %10 = load double, ptr %arrayidx.i.3, align 8, !tbaa !5
  %add.i.3 = fadd double %add.i.2, %10
  %indvars.iv.next.i.3 = add nuw nsw i64 %indvars.iv.i, 4
  %arrayidx.i.4 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv.next.i.3
  %11 = load double, ptr %arrayidx.i.4, align 8, !tbaa !5
  %add.i.4 = fadd double %add.i.3, %11
  %indvars.iv.next.i.4 = add nuw nsw i64 %indvars.iv.i, 5
  %exitcond.not.i.4 = icmp eq i64 %indvars.iv.next.i.4, 32000
  br i1 %exitcond.not.i.4, label %for.cond18.preheader.i.preheader, label %for.body.i
...
for.cond18.preheader.i.preheader:                 ; preds = %for.body.i
  ...
  %call.i = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %12, double noundef %add.i.4)
  ret i32 0

for.body:                                         ; preds = %for.body.lr.ph, %for.body
  %nl.023 = phi i32 [ %inc, %for.body ], [ 0, %for.body.lr.ph ]
  %call10 = tail call i32 @dummy(ptr noundef nonnull @global_data, ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 11, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 20, i64 0, i64 0), double noundef 0.000000e+00) #16
...
entry:
  %call = tail call i32 @init(ptr noundef nonnull @.str.12)
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
  %cmp43 = icmp sgt i32 %0, 0
  br i1 %cmp43, label %for.cond1.preheader, label %for.cond.cleanup

for.cond1.preheader:                              ; preds = %entry, %for.cond.cleanup3
  %nl.044 = phi i32 [ %inc26, %for.cond.cleanup3 ], [ 0, %entry ]
  br label %for.body4

for.cond.cleanup:                                 ; preds = %for.cond.cleanup3, %entry
  %call28 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.139, double noundef 0.000000e+00)
  br label %for.body.i
...
for.cond.cleanup3:                                ; preds = %for.inc
  ...
  %inc26 = add nuw nsw i32 %nl.044, 1
...
for.body4:                                        ; preds = %for.cond1.preheader, %for.inc
  ...
  %j.041 = phi i32 [ -1, %for.cond1.preheader ], [ %j.1, %for.inc ]
  ...
  %arrayidx8 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 11, i64 %indvars.iv
  ...
  %arrayidx10 = getelementptr inbounds double, ptr @global_data, i64 %idxprom9
...
if.then:                                          ; preds = %for.body4
  %inc14 = add nsw i32 %j.041, 2
  %13 = load double, ptr %arrayidx6, align 8, !tbaa !5
  %14 = load double, ptr %arrayidx8, align 8, !tbaa !5
  %15 = tail call double @llvm.fmuladd.f64(double %13, double %14, double %12)
  %idxprom21 = sext i32 %inc14 to i64
  %arrayidx22 = getelementptr inbounds double, ptr @global_data, i64 %idxprom21
  store double %15, ptr %arrayidx22, align 8, !tbaa !5
  br label %for.inc

for.inc:                                          ; preds = %for.body4, %if.then
  %j.1 = phi i32 [ %inc14, %if.then ], [ %inc, %for.body4 ]
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
...
entry:
  %call = tail call i32 @init(ptr noundef nonnull @.str.13)
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
  %cmp43 = icmp sgt i32 %0, 0
  br i1 %cmp43, label %vector.ph, label %for.cond.cleanup
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load50 = load <2 x double>, ptr %2, align 16, !tbaa !5
  %3 = fcmp ogt <2 x double> %wide.load, zeroinitializer
  %4 = fcmp ogt <2 x double> %wide.load50, zeroinitializer
  %5 = getelementptr %struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 %index
  %wide.load51 = load <2 x double>, ptr %5, align 32, !tbaa !5
  %6 = getelementptr double, ptr %5, i64 2
  %wide.load52 = load <2 x double>, ptr %6, align 16, !tbaa !5
  %predphi = select <2 x i1> %3, <2 x double> %wide.load, <2 x double> %wide.load51
  %predphi53 = select <2 x i1> %4, <2 x double> %wide.load50, <2 x double> %wide.load52
  %7 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 %index
  %wide.load54 = load <2 x double>, ptr %7, align 32, !tbaa !5
  %8 = getelementptr inbounds double, ptr %7, i64 2
  %wide.load55 = load <2 x double>, ptr %8, align 16, !tbaa !5
  %9 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 11, i64 %index
  %wide.load56 = load <2 x double>, ptr %9, align 32, !tbaa !5
  %10 = getelementptr inbounds double, ptr %9, i64 2
  %wide.load57 = load <2 x double>, ptr %10, align 16, !tbaa !5
  %11 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %wide.load54, <2 x double> %wide.load56, <2 x double> %predphi)
  %12 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %wide.load55, <2 x double> %wide.load57, <2 x double> %predphi53)
  %sext = shl i64 %index, 32
  %13 = ashr exact i64 %sext, 32
  %14 = getelementptr inbounds double, ptr @global_data, i64 %13
  store <2 x double> %11, ptr %14, align 32, !tbaa !5
  %15 = getelementptr inbounds double, ptr %14, i64 2
  store <2 x double> %12, ptr %15, align 16, !tbaa !5
  %index.next = add nuw i64 %index, 4
  %16 = icmp eq i64 %index.next, 32000
  br i1 %16, label %for.cond.cleanup3, label %vector.body, !llvm.loop !368
...
for.body.i:                                       ; preds = %for.body.i, %for.cond.cleanup
  ...
  %suma.0192.i = phi double [ 0.000000e+00, %for.cond.cleanup ], [ %add.i.4, %for.body.i ]
  %arrayidx.i = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv.i
  %17 = load double, ptr %arrayidx.i, align 8, !tbaa !5
  %add.i = fadd double %suma.0192.i, %17
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1
  %arrayidx.i.1 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv.next.i
  %18 = load double, ptr %arrayidx.i.1, align 8, !tbaa !5
  %add.i.1 = fadd double %add.i, %18
  %indvars.iv.next.i.1 = add nuw nsw i64 %indvars.iv.i, 2
  %arrayidx.i.2 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv.next.i.1
  %19 = load double, ptr %arrayidx.i.2, align 8, !tbaa !5
  %add.i.2 = fadd double %add.i.1, %19
  %indvars.iv.next.i.2 = add nuw nsw i64 %indvars.iv.i, 3
  %arrayidx.i.3 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv.next.i.2
  %20 = load double, ptr %arrayidx.i.3, align 8, !tbaa !5
  %add.i.3 = fadd double %add.i.2, %20
  %indvars.iv.next.i.3 = add nuw nsw i64 %indvars.iv.i, 4
  %arrayidx.i.4 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv.next.i.3
  %21 = load double, ptr %arrayidx.i.4, align 8, !tbaa !5
  %add.i.4 = fadd double %add.i.3, %21
  %indvars.iv.next.i.4 = add nuw nsw i64 %indvars.iv.i, 5
  %exitcond.not.i.4 = icmp eq i64 %indvars.iv.next.i.4, 32000
  br i1 %exitcond.not.i.4, label %for.cond18.preheader.i.preheader, label %for.body.i
...
for.cond18.preheader.i.preheader:                 ; preds = %for.body.i
  %22 = load i32, ptr @digits, align 4, !tbaa !17
  %call.i = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %22, double noundef %add.i.4)
  ret i32 0
...
entry:
  %call = tail call i32 @init(ptr noundef nonnull @.str.14)
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
  %cmp48 = icmp sgt i32 %0, 255
  br i1 %cmp48, label %for.cond1.preheader, label %for.cond.cleanup

for.cond1.preheader:                              ; preds = %entry, %for.cond.cleanup3
  %nl.049 = phi i32 [ %inc28, %for.cond.cleanup3 ], [ 0, %entry ]
  br label %for.cond5.preheader

for.cond.cleanup:                                 ; preds = %for.cond.cleanup3, %entry
  %call31 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.141, double noundef 0.000000e+00)
...
for.cond5.preheader:                              ; preds = %for.cond1.preheader, %for.cond.cleanup7
  ...
  %k.044 = phi i64 [ -1, %for.cond1.preheader ], [ %ind.end, %for.cond.cleanup7 ]
  %sext = shl i64 %k.044, 32
  %6 = ashr exact i64 %sext, 32
  %ind.end = add nsw i64 %6, 256
  br label %vector.body
...
vector.body:                                      ; preds = %vector.body, %for.cond5.preheader
  ...
  %7 = add nsw i64 %offset.idx, 1
  %8 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), i64 %indvars.iv55, i64 %index
  %wide.load = load <2 x double>, ptr %8, align 32, !tbaa !5
  %9 = getelementptr inbounds double, ptr %8, i64 2
  %wide.load60 = load <2 x double>, ptr %9, align 16, !tbaa !5
  %10 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), i64 %indvars.iv55, i64 %index
  %wide.load61 = load <2 x double>, ptr %10, align 32, !tbaa !5
  %11 = getelementptr inbounds double, ptr %10, i64 2
  %wide.load62 = load <2 x double>, ptr %11, align 16, !tbaa !5
  %12 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 20, i64 0, i64 0), i64 %indvars.iv55, i64 %index
  %wide.load63 = load <2 x double>, ptr %12, align 32, !tbaa !5
  %13 = getelementptr inbounds double, ptr %12, i64 2
  %wide.load64 = load <2 x double>, ptr %13, align 16, !tbaa !5
  %14 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %wide.load61, <2 x double> %wide.load63, <2 x double> %wide.load)
  %15 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %wide.load62, <2 x double> %wide.load64, <2 x double> %wide.load60)
  %16 = getelementptr inbounds [65536 x double], ptr @array, i64 0, i64 %7
  store <2 x double> %14, ptr %16, align 8, !tbaa !5
  %17 = getelementptr inbounds double, ptr %16, i64 2
  store <2 x double> %15, ptr %17, align 8, !tbaa !5
  %index.next = add nuw i64 %index, 4
  %18 = icmp eq i64 %index.next, 256
  br i1 %18, label %for.cond.cleanup7, label %vector.body, !llvm.loop !369
...
for.cond.cleanup3:                                ; preds = %for.cond.cleanup7
  ...
  %inc28 = add nuw nsw i32 %nl.049, 1
  %19 = load i32, ptr @ntimes, align 4, !tbaa !17
  %div = sdiv i32 %19, 256
  %mul = mul nsw i32 %div, 100
  %cmp = icmp slt i32 %inc28, %mul
  br i1 %cmp, label %for.cond1.preheader, label %for.cond.cleanup

for.cond.cleanup7:                                ; preds = %vector.body
  %indvars.iv.next56 = add nuw nsw i64 %indvars.iv55, 1
  %exitcond58.not = icmp eq i64 %indvars.iv.next56, 256
  br i1 %exitcond58.not, label %for.cond.cleanup3, label %for.cond5.preheader
}

; Function Attrs: nounwind uwtable
define dso_local i32 @s126() local_unnamed_addr #7 {
entry:
  %call = tail call i32 @init(ptr noundef nonnull @.str.15)
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
  %cmp52 = icmp sgt i32 %0, 255
  br i1 %cmp52, label %for.cond1.preheader, label %for.cond.cleanup

for.cond1.preheader:                              ; preds = %entry, %for.cond.cleanup3
  %nl.053 = phi i32 [ %inc30, %for.cond.cleanup3 ], [ 0, %entry ]
  br label %for.cond5.preheader

for.cond.cleanup:                                 ; preds = %for.cond.cleanup3, %entry
  %call34 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.142, double noundef 0.000000e+00)
...
for.cond18.preheader.i:                           ; preds = %for.cond.cleanup, %for.cond.cleanup20.i
  ...
  %sumbb.0203.i = phi double [ %add31.i.3, %for.cond.cleanup20.i ], [ 0.000000e+00, %for.cond.cleanup ]
...
for.body47.i.preheader:                           ; preds = %for.cond.cleanup20.i
  ...
  %call77.i = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %1, double noundef %add31.i.3)
  ret i32 0
...
for.body21.i:                                     ; preds = %for.body21.i, %for.cond18.preheader.i
  ...
  %sumbb.1199.i = phi double [ %sumbb.0203.i, %for.cond18.preheader.i ], [ %add31.i.3, %for.body21.i ]
  ...
  %2 = load double, ptr %arrayidx30.i, align 32, !tbaa !5
  %add31.i = fadd double %sumbb.1199.i, %2
  ...
  %3 = load double, ptr %arrayidx30.i.1, align 8, !tbaa !5
  %add31.i.1 = fadd double %add31.i, %3
  %indvars.iv.next210.i.1 = or i64 %indvars.iv209.i, 2
  %arrayidx30.i.2 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), i64 %indvars.iv213.i, i64 %indvars.iv.next210.i.1
  %4 = load double, ptr %arrayidx30.i.2, align 16, !tbaa !5
  %add31.i.2 = fadd double %add31.i.1, %4
  %indvars.iv.next210.i.2 = or i64 %indvars.iv209.i, 3
  %arrayidx30.i.3 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), i64 %indvars.iv213.i, i64 %indvars.iv.next210.i.2
  %5 = load double, ptr %arrayidx30.i.3, align 8, !tbaa !5
  %add31.i.3 = fadd double %add31.i.2, %5
...
for.cond5.preheader:                              ; preds = %for.cond1.preheader, %for.cond.cleanup7
  ...
  %k.048 = phi i32 [ 1, %for.cond1.preheader ], [ %inc24, %for.cond.cleanup7 ]
  %6 = sext i32 %k.048 to i64
  %arrayidx10.phi.trans.insert = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), i64 0, i64 %indvars.iv61
...
for.cond.cleanup3:                                ; preds = %for.cond.cleanup7
  %call28 = tail call i32 @dummy(ptr noundef nonnull @global_data, ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 11, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 20, i64 0, i64 0), double noundef 0.000000e+00) #16
  %inc30 = add nuw nsw i32 %nl.053, 1
...
for.body8:                                        ; preds = %for.body8.1, %for.cond5.preheader
  %10 = phi double [ %.pre, %for.cond5.preheader ], [ %18, %for.body8.1 ]
  %indvars.iv55 = phi i64 [ %6, %for.cond5.preheader ], [ %indvars.iv.next56.1, %for.body8.1 ]
  %indvars.iv = phi i64 [ 1, %for.cond5.preheader ], [ %indvars.iv.next.1, %for.body8.1 ]
  %11 = add nsw i64 %indvars.iv55, -1
  %arrayidx13 = getelementptr inbounds [65536 x double], ptr @array, i64 0, i64 %11
  %12 = load double, ptr %arrayidx13, align 8, !tbaa !5
  %arrayidx17 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 20, i64 0, i64 0), i64 %indvars.iv, i64 %indvars.iv61
  %13 = load double, ptr %arrayidx17, align 8, !tbaa !5
  %14 = tail call double @llvm.fmuladd.f64(double %12, double %13, double %10)
  %arrayidx22 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), i64 %indvars.iv, i64 %indvars.iv61
  store double %14, ptr %arrayidx22, align 8, !tbaa !5
  %15 = trunc i64 %indvars.iv55 to i32
  %exitcond.not = icmp eq i32 %7, %15
  br i1 %exitcond.not, label %for.cond.cleanup7, label %for.body8.1

for.body8.1:                                      ; preds = %for.body8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %arrayidx13.1 = getelementptr inbounds [65536 x double], ptr @array, i64 0, i64 %indvars.iv55
  %16 = load double, ptr %arrayidx13.1, align 8, !tbaa !5
  %arrayidx17.1 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 20, i64 0, i64 0), i64 %indvars.iv.next, i64 %indvars.iv61
  %17 = load double, ptr %arrayidx17.1, align 8, !tbaa !5
  %18 = tail call double @llvm.fmuladd.f64(double %16, double %17, double %14)
  %arrayidx22.1 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), i64 %indvars.iv.next, i64 %indvars.iv61
  store double %18, ptr %arrayidx22.1, align 8, !tbaa !5
...
entry:
  %call = tail call i32 @init(ptr noundef nonnull @.str.16)
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
  %cmp42 = icmp sgt i32 %0, 0
  br i1 %cmp42, label %for.cond1.preheader, label %for.cond.cleanup

for.cond1.preheader:                              ; preds = %entry, %for.cond.cleanup3
  %nl.043 = phi i32 [ %inc25, %for.cond.cleanup3 ], [ 0, %entry ]
  br label %for.body4

for.cond.cleanup:                                 ; preds = %for.cond.cleanup3, %entry
  %call27 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.143, double noundef 0.000000e+00)
  br label %for.body.i
...
for.body4:                                        ; preds = %for.cond1.preheader, %for.body4
  %indvars.iv44 = phi i64 [ -1, %for.cond1.preheader ], [ %indvars.iv.next45, %for.body4 ]
  ...
  %arrayidx8 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 %indvars.iv
  %11 = load double, ptr %arrayidx8, align 8, !tbaa !5
  %12 = tail call double @llvm.fmuladd.f64(double %10, double %11, double %9)
  %arrayidx11 = getelementptr inbounds double, ptr @global_data, i64 %8
  ...
  %14 = load double, ptr %arrayidx8, align 8, !tbaa !5
  %arrayidx18 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 11, i64 %indvars.iv
  %15 = load double, ptr %arrayidx18, align 8, !tbaa !5
  %16 = tail call double @llvm.fmuladd.f64(double %14, double %15, double %13)
  %arrayidx21 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv.next45
  store double %16, ptr %arrayidx21, align 8, !tbaa !5
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, 16000
  br i1 %exitcond.not, label %for.cond.cleanup3, label %for.body4
}
...
entry:
  %call = tail call i32 @init(ptr noundef nonnull @.str.17)
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
  %cmp34 = icmp sgt i32 %0, 0
  br i1 %cmp34, label %for.cond1.preheader, label %for.cond.cleanup

for.cond1.preheader:                              ; preds = %entry, %for.cond.cleanup3
  %nl.035 = phi i32 [ %inc19, %for.cond.cleanup3 ], [ 0, %entry ]
  br label %for.body4

for.cond.cleanup:                                 ; preds = %for.cond.cleanup3, %entry
  %call22 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.144, double noundef 0.000000e+00)
  br label %for.body.i
...
for.cond.cleanup3:                                ; preds = %for.body4
  %call17 = tail call i32 @dummy(ptr noundef nonnull @global_data, ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 11, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 20, i64 0, i64 0), double noundef 1.000000e+00) #16
  %inc19 = add nuw nsw i32 %nl.035, 1
  %6 = load i32, ptr @ntimes, align 4, !tbaa !17
  %mul = shl nsw i32 %6, 1
  %cmp = icmp slt i32 %inc19, %mul
  br i1 %cmp, label %for.cond1.preheader, label %for.cond.cleanup

for.body4:                                        ; preds = %for.cond1.preheader, %for.body4
  %indvars.iv36 = phi i64 [ -1, %for.cond1.preheader ], [ %indvars.iv.next37, %for.body4 ]
  %indvars.iv = phi i64 [ 0, %for.cond1.preheader ], [ %indvars.iv.next, %for.body4 ]
  %7 = add nsw i64 %indvars.iv36, 1
  %arrayidx = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %7
  %8 = load double, ptr %arrayidx, align 8, !tbaa !5
  %arrayidx6 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 %indvars.iv
  %9 = load double, ptr %arrayidx6, align 8, !tbaa !5
  %sub = fsub double %8, %9
  %arrayidx8 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv
  store double %sub, ptr %arrayidx8, align 8, !tbaa !5
  %indvars.iv.next37 = add nsw i64 %indvars.iv36, 2
  %arrayidx13 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 %7
  %10 = load double, ptr %arrayidx13, align 8, !tbaa !5
  %add14 = fadd double %sub, %10
  store double %add14, ptr %arrayidx, align 8, !tbaa !5
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, 16000
  br i1 %exitcond.not, label %for.cond.cleanup3, label %for.body4
}
...
entry:
  %call = tail call i32 @init(ptr noundef nonnull @.str.112)
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
  %cmp21 = icmp sgt i32 %0, 0
  br i1 %cmp21, label %for.cond1.preheader, label %for.cond.cleanup

for.cond1.preheader:                              ; preds = %entry, %for.cond.cleanup3
  %nl.022 = phi i32 [ %inc10, %for.cond.cleanup3 ], [ 0, %entry ]
  br label %for.body4

for.cond.cleanup:                                 ; preds = %for.cond.cleanup3, %entry
  %call12 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.145, double noundef 0.000000e+00)
  br label %for.body.i
...
for.body4:                                        ; preds = %for.body4, %for.cond1.preheader
  ...
  %s.018 = phi double [ 0.000000e+00, %for.cond1.preheader ], [ %add.1, %for.body4 ]
  %add = fadd double %s.018, 2.000000e+00
  %arrayidx = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %indvars.iv
  %8 = load double, ptr %arrayidx, align 16, !tbaa !5
  %mul5 = fmul double %add, %8
  %arrayidx7 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv
  store double %mul5, ptr %arrayidx7, align 16, !tbaa !5
  %indvars.iv.next = or i64 %indvars.iv, 1
  %add.1 = fadd double %add, 2.000000e+00
...
vector.body125:                                   ; preds = %vector.body, %vector.body125
  ...
  br i1 %10, label %vector.body133, label %vector.body125, !llvm.loop !370
...
vector.body133:                                   ; preds = %vector.body125, %vector.body133
  ...
  br i1 %21, label %vector.body141, label %vector.body133, !llvm.loop !371
...
vector.body141:                                   ; preds = %vector.body133, %vector.body141
  ...
  br i1 %32, label %vector.body149, label %vector.body141, !llvm.loop !372
...
vector.body149:                                   ; preds = %vector.body141, %vector.body149
  ...
  br i1 %43, label %for.cond2.preheader.i, label %vector.body149, !llvm.loop !373
...
vector.body157:                                   ; preds = %vector.body157, %for.cond2.preheader.i
  ...
  br i1 %53, label %for.cond.cleanup4.i, label %vector.body157, !llvm.loop !374
...
vector.body167:                                   ; preds = %vector.body167, %for.cond2.preheader.i83
  ...
  br i1 %63, label %for.cond.cleanup4.i85, label %vector.body167, !llvm.loop !375
...
vector.body179:                                   ; preds = %vector.body179, %for.cond2.preheader.i96
  ...
  br i1 %73, label %for.cond.cleanup4.i98, label %vector.body179, !llvm.loop !376
...
vector.body191:                                   ; preds = %for.cond.cleanup4.i98, %vector.body191
  ...
  br i1 %84, label %for.cond.cleanup29, label %vector.body191, !llvm.loop !377
...
vector.body:                                      ; preds = %for.body, %vector.body
  ...
  br i1 %104, label %vector.body125, label %vector.body, !llvm.loop !378
...
if.end:                                           ; preds = %entry
  ...
  %1 = load ptr, ptr %arrayidx, align 8, !tbaa !379
...
if.then4:                                         ; preds = %if.end
  ...
  %2 = load ptr, ptr %arrayidx5, align 8, !tbaa !379
