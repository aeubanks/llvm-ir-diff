...
define dso_local signext i16 @foo(ptr nocapture noundef %0, i32 noundef %1) local_unnamed_addr #0 {
  %3 = getelementptr inbounds %struct.VEC_char_base, ptr %0, i64 0, i32 2
  %4 = sext i32 %1 to i64
  %5 = getelementptr inbounds [1 x i16], ptr %3, i64 0, i64 %4
  store i16 0, ptr %5, align 2, !tbaa !5
  %6 = getelementptr inbounds %struct.VEC_char_base, ptr %0, i64 2
  store i16 1, ptr %6, align 2, !tbaa !8
  %7 = load i16, ptr %5, align 2, !tbaa !5
  ret i16 %7
}
...
define dso_local i32 @main() local_unnamed_addr #1 {
  ...
  %2 = tail call signext i16 @foo(ptr noundef %1, i32 noundef 16)
  %3 = icmp eq i16 %2, 1
