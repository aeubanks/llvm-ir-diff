...
_ZN20btAlignedObjectArrayI11btTransformED2Ev.exit: ; preds = %if.then3.i.i.i18, %_ZN20btAlignedObjectArrayIP16btCollisionShapeED2Ev.exit
  %m_size.i.i.i19 = getelementptr inbounds %class.btGImpactCompoundShape, ptr %this, i64 0, i32 2, i32 2
  store i8 1, ptr %m_ownsMemory.i.i.i15, align 8, !tbaa !70
  store ptr null, ptr %m_data.i.i.i13, align 8, !tbaa !16
  store i32 0, ptr %m_size.i.i.i19, align 4, !tbaa !71
...
if.then3.i.i:                                     ; preds = %while.end
  invoke void @_Z21btAlignedFreeInternalPv(ptr noundef nonnull %8)
          to label %_ZN20btAlignedObjectArrayIP22btGImpactMeshShapePartE5clearEv.exit unwind label %lpad

_ZN20btAlignedObjectArrayIP22btGImpactMeshShapePartE5clearEv.exit: ; preds = %if.then3.i.i, %while.end
...
if.then3.i.i.i.i.i.i:                             ; preds = %_ZN20btAlignedObjectArrayIP22btGImpactMeshShapePartE5clearEv.exit
...
_ZN23btGImpactShapeInterfaceD2Ev.exit:            ; preds = %_ZN20btAlignedObjectArrayIP22btGImpactMeshShapePartE5clearEv.exit, %if.then3.i.i.i.i.i.i
  %m_size.i.i.i.i.i.i = getelementptr inbounds %class.btGImpactShapeInterface, ptr %this, i64 0, i32 4, i32 0, i32 2, i32 0, i32 2
  store i8 1, ptr %m_ownsMemory.i.i.i.i.i.i, align 8, !tbaa !74
  store ptr null, ptr %m_data.i.i.i.i.i.i, align 8, !tbaa !73
  store i32 0, ptr %m_size.i.i.i.i.i.i, align 4, !tbaa !75
...
while.body:                                       ; preds = %while.body.lr.ph, %_ZN23btGImpactShapeInterface11updateBoundEv.exit
  ...
  %7 = phi float [ 0x47EFFFFFE0000000, %while.body.lr.ph ], [ %..i, %_ZN23btGImpactShapeInterface11updateBoundEv.exit ]
...
_ZN23btGImpactShapeInterface11updateBoundEv.exit: ; preds = %while.body, %if.end.i
  ...
  %20 = load float, ptr %m_localAABB.i, align 4, !tbaa !19
  %cmp.i = fcmp ogt float %18, %20
  %..i = select i1 %cmp.i, float %20, float %18
  store float %..i, ptr %m_localAABB, align 4, !tbaa !19
  ...
  %cond30.i = select i1 %cmp20.i, float %21, float %17
  ...
  %cond50.i = select i1 %cmp40.i, float %22, float %16
  ...
  %23 = load float, ptr %m_max56.i, align 4, !tbaa !19
  ...
  %cond89.i = select i1 %cmp79.i, float %24, float %14
  ...
  %cond109.i = select i1 %cmp99.i, float %25, float %13
