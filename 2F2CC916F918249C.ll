...
entry:
  store i32 16777728, ptr %p, align 4, !tbaa !5
  %add.ptr2 = getelementptr inbounds i8, ptr %p, i64 6
  %0 = load i8, ptr %add.ptr2, align 1, !tbaa !9
  %add.ptr3 = getelementptr inbounds i8, ptr %p, i64 2
