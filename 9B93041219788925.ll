...
entry:
  %0 = alloca [20 x i8], align 16
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(5) %0, ptr noundef nonnull align 16 dereferenceable(5) @.str, i64 5, i1 false)
  %1 = tail call ptr @llvm.frameaddress.p0(i32 0)
  store ptr %1, ptr @buf, align 16
  %2 = tail call ptr @llvm.stacksave()
  store ptr %2, ptr getelementptr inbounds ([20 x ptr], ptr @buf, i64 0, i64 2), align 16
  %3 = tail call i32 @llvm.eh.sjlj.setjmp(ptr nonnull @buf)
  %tobool.not = icmp eq i32 %3, 0
  br i1 %tobool.not, label %if.end3, label %if.then

if.then:                                          ; preds = %entry
  %bcmp = call i32 @bcmp(ptr noundef nonnull dereferenceable(5) %0, ptr noundef nonnull dereferenceable(5) @.str, i64 5)
