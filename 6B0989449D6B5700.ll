...
for.body:                                         ; preds = %if.end119, %for.inc
  ...
  %min_mcost.addr.0256 = phi i32 [ %min_mcost, %if.end119 ], [ %min_mcost.addr.1, %for.inc ]
  %best_pos.0254 = phi i32 [ 0, %if.end119 ], [ %best_pos.1, %for.inc ]
  ...
  %or.cond248 = select i1 %13, i1 %cmp142, i1 false
  %cmp145 = icmp eq i32 %shl131, %pic_pix_y
  %or.cond249 = select i1 %or.cond248, i1 %cmp145, i1 false
...
for.body:                                         ; preds = %if.end358, %for.inc
  ...
  %cmp396.not = icmp sgt i32 %min_mcost.addr.0599, %add395
