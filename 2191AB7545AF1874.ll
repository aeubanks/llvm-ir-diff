...
define dso_local noundef ptr @_ZN9direction9as_stringEv(ptr nocapture noundef nonnull readonly align 4 dereferenceable(4) %this) local_unnamed_addr #3 align 2 {
entry:
  %0 = load i32, ptr %this, align 4, !tbaa !5
  %idxprom = sext i32 %0 to i64
  %arrayidx = getelementptr inbounds [9 x ptr], ptr @__const._ZN9direction9as_stringEv.dirs, i64 0, i64 %idxprom
  %1 = load ptr, ptr %arrayidx, align 8, !tbaa !10
  ret ptr %1
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none) uwtable
define dso_local noundef i32 @_Zeq9directionS_(i32 %d1.coerce, i32 %d2.coerce) local_unnamed_addr #4 {
entry:
  %cmp = icmp eq i32 %d1.coerce, %d2.coerce
  %conv = zext i1 %cmp to i32
  ret i32 %conv
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none) uwtable
define dso_local noundef i32 @_Zne9directionS_(i32 %d1.coerce, i32 %d2.coerce) local_unnamed_addr #4 {
entry:
  %cmp = icmp ne i32 %d1.coerce, %d2.coerce
  %conv = zext i1 %cmp to i32
  ret i32 %conv
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none) uwtable
define dso_local noundef i32 @_Zle9directionS_(i32 %d1.coerce, i32 %d2.coerce) local_unnamed_addr #4 {
entry:
  %cmp = icmp sle i32 %d1.coerce, %d2.coerce
  %conv = zext i1 %cmp to i32
  ret i32 %conv
}

; Function Attrs: mustprogress uwtable
define dso_local noundef nonnull align 8 dereferenceable(8) ptr @_ZlsRSo9direction(ptr noundef nonnull returned align 8 dereferenceable(8) %o, i32 %d.coerce) local_unnamed_addr #5 {
entry:
  %idxprom.i = sext i32 %d.coerce to i64
  %arrayidx.i = getelementptr inbounds [9 x ptr], ptr @__const._ZN9direction9as_stringEv.dirs, i64 0, i64 %idxprom.i
  %0 = load ptr, ptr %arrayidx.i, align 8, !tbaa !10
  %call.i.i = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %0) #9
...
entry:
  ...
  %1 = tail call ptr @llvm.invariant.start.p0(i64 4, ptr nonnull @N)
  store i32 1, ptr @NE, align 4, !tbaa !5
  %2 = tail call ptr @llvm.invariant.start.p0(i64 4, ptr nonnull @NE)
  store i32 2, ptr @E, align 4, !tbaa !5
  %3 = tail call ptr @llvm.invariant.start.p0(i64 4, ptr nonnull @E)
  store i32 3, ptr @SE, align 4, !tbaa !5
  %4 = tail call ptr @llvm.invariant.start.p0(i64 4, ptr nonnull @SE)
  store i32 4, ptr @S, align 4, !tbaa !5
  %5 = tail call ptr @llvm.invariant.start.p0(i64 4, ptr nonnull @S)
  store i32 5, ptr @SW, align 4, !tbaa !5
  %6 = tail call ptr @llvm.invariant.start.p0(i64 4, ptr nonnull @SW)
  store i32 6, ptr @W, align 4, !tbaa !5
  %7 = tail call ptr @llvm.invariant.start.p0(i64 4, ptr nonnull @W)
  store i32 7, ptr @NW, align 4, !tbaa !5
  %8 = tail call ptr @llvm.invariant.start.p0(i64 4, ptr nonnull @NW)
  store i32 8, ptr @NO_DIRECTION, align 4, !tbaa !5
  %9 = tail call ptr @llvm.invariant.start.p0(i64 4, ptr nonnull @NO_DIRECTION)
  ret void
}
