...
for.cond.sw.bb782_crit_edge:                      ; preds = %for.cond
  %.pre3405 = load i8, ptr %lbits761, align 8, !tbaa !21
  %.pre3406 = load ptr, ptr %ltree768, align 8, !tbaa !23
  br label %sw.bb782
...
for.cond.sw.bb960_crit_edge:                      ; preds = %for.cond
  %.pre3401 = load i32, ptr %need955, align 8, !tbaa !20
  br label %sw.bb960

for.cond.sw.bb1113_crit_edge:                     ; preds = %for.cond
  %.pre3399 = load i32, ptr %dist1103, align 4, !tbaa !20
  br label %sw.bb1113

while.cond324.preheader:                          ; preds = %for.cond
  %cmp3263157 = icmp ult i32 %_state.sroa.130.0, 14
  br i1 %cmp3263157, label %while.body328.preheader, label %while.end355
...
while.cond99.preheader:                           ; preds = %for.cond
  %cmp1013227 = icmp ult i32 %_state.sroa.130.0, 16
  br i1 %cmp1013227, label %while.body103.preheader, label %while.end130
...
while.cond.preheader:                             ; preds = %for.cond
  %cmp103235 = icmp ult i32 %_state.sroa.130.0, 3
  br i1 %cmp103235, label %while.body, label %while.end
...
again.i.sink.split:                               ; preds = %if.then.peel.i, %if.then21.i
  ...
  %.ph3723 = phi ptr [ %add.ptr13.i, %if.then21.i ], [ %add.ptr13.peel.i, %if.then.peel.i ]
...
again.i.preheader:                                ; preds = %if.then.peel.i, %again.i.sink.split
  %.ph3756 = phi ptr [ %.ph, %again.i.sink.split ], [ %add.ptr.peel.i, %if.then.peel.i ]
  %.ph3757 = phi ptr [ %.ph3723, %again.i.sink.split ], [ %add.ptr13.peel.i, %if.then.peel.i ]
  %.ph3758 = phi ptr [ %window.i2882, %again.i.sink.split ], [ %18, %if.then.peel.i ]
  br label %again.i

again.i:                                          ; preds = %again.i.preheader, %if.then.i
  %19 = phi ptr [ %add.ptr.i, %if.then.i ], [ %.ph3756, %again.i.preheader ]
  %20 = phi ptr [ %add.ptr13.i, %if.then.i ], [ %.ph3757, %again.i.preheader ]
  %21 = phi ptr [ %25, %if.then.i ], [ %.ph3758, %again.i.preheader ]
...
for.body:                                         ; preds = %if.end69.1, %if.then53
  %indvars.iv3392 = phi i64 [ 0, %if.then53 ], [ %indvars.iv.next3393.1, %if.end69.1 ]
  %cmp57 = icmp ugt i64 %indvars.iv3392, 143
  br i1 %cmp57, label %if.then59, label %if.end69

if.then59:                                        ; preds = %for.body
  %cmp60 = icmp ult i64 %indvars.iv3392, 256
  br i1 %cmp60, label %if.end69, label %if.else

if.else:                                          ; preds = %if.then59
  %cmp63 = icmp ult i64 %indvars.iv3392, 280
...
if.end69:                                         ; preds = %if.else, %if.then59, %for.body
  ...
  %arrayidx = getelementptr inbounds [288 x i32], ptr @nsis_inflate.lc, i64 0, i64 %indvars.iv3392
  store i32 %v.0, ptr %arrayidx, align 8, !tbaa !29
  %indvars.iv.next3393 = or i64 %indvars.iv3392, 1
  %cmp57.1 = icmp ugt i64 %indvars.iv3392, 142
  br i1 %cmp57.1, label %if.then59.1, label %if.end69.1

if.then59.1:                                      ; preds = %if.end69
  %cmp60.1 = icmp ult i64 %indvars.iv.next3393, 256
  br i1 %cmp60.1, label %if.end69.1, label %if.else.1

if.else.1:                                        ; preds = %if.then59.1
  %cmp63.1 = icmp ult i64 %indvars.iv.next3393, 280
...
if.end69.1:                                       ; preds = %if.else.1, %if.then59.1, %if.end69
  ...
  %arrayidx.1 = getelementptr inbounds [288 x i32], ptr @nsis_inflate.lc, i64 0, i64 %indvars.iv.next3393
  store i32 %v.0.1, ptr %arrayidx.1, align 4, !tbaa !29
  %indvars.iv.next3393.1 = add nuw nsw i64 %indvars.iv3392, 2
  %exitcond.not.1 = icmp eq i64 %indvars.iv.next3393.1, 288
...
if.then106:                                       ; preds = %while.body103.1, %while.body103.preheader
  %indvars.iv3389.lcssa = phi i64 [ %11, %while.body103.preheader ], [ %indvars.iv.next3390, %while.body103.1 ]
  %_state.sroa.561588.23231.lcssa = phi i64 [ %_state.sroa.561588.0, %while.body103.preheader ], [ %or127, %while.body103.1 ]
  %_state.sroa.2191703.23229.lcssa = phi ptr [ %_state.sroa.2191703.0, %while.body103.preheader ], [ %incdec.ptr121, %while.body103.1 ]
  %33 = trunc i64 %indvars.iv3389.lcssa to i32
  store i64 %_state.sroa.561588.23231.lcssa, ptr %bitb, align 8, !tbaa !14
  store i32 %33, ptr %bitk, align 4, !tbaa !15
  store i32 0, ptr %avail_in, align 8, !tbaa !13
  store ptr %_state.sroa.2191703.23229.lcssa, ptr %z, align 8, !tbaa !5
  store ptr %_state.sroa.3231780.0, ptr %write, align 8, !tbaa !16
...
again.i2268.sink.split:                           ; preds = %if.then.peel.i2253, %if.then21.i2271
  %.ph3724 = phi ptr [ %add.ptr.i2265, %if.then21.i2271 ], [ %add.ptr.peel.i2248, %if.then.peel.i2253 ]
  %.ph3725 = phi ptr [ %add.ptr13.i2266, %if.then21.i2271 ], [ %add.ptr13.peel.i2249, %if.then.peel.i2253 ]
  store ptr %window.i2882, ptr %write, align 8, !tbaa !16
  br label %again.i2268.preheader

again.i2268.preheader:                            ; preds = %if.then.peel.i2253, %again.i2268.sink.split
  %.ph3761 = phi ptr [ %.ph3724, %again.i2268.sink.split ], [ %add.ptr.peel.i2248, %if.then.peel.i2253 ]
  %.ph3762 = phi ptr [ %.ph3725, %again.i2268.sink.split ], [ %add.ptr13.peel.i2249, %if.then.peel.i2253 ]
  %.ph3763 = phi ptr [ %window.i2882, %again.i2268.sink.split ], [ %40, %if.then.peel.i2253 ]
  br label %again.i2268

again.i2268:                                      ; preds = %again.i2268.preheader, %if.then.i2270
  %41 = phi ptr [ %add.ptr.i2265, %if.then.i2270 ], [ %.ph3761, %again.i2268.preheader ]
  %42 = phi ptr [ %add.ptr13.i2266, %if.then.i2270 ], [ %.ph3762, %again.i2268.preheader ]
  %43 = phi ptr [ %47, %if.then.i2270 ], [ %.ph3763, %again.i2268.preheader ]
...
if.end117:                                        ; preds = %while.body103.preheader
  ...
  %indvars.iv.next3390 = add nuw nsw i64 %11, 8
...
if.end117.1:                                      ; preds = %while.body103.1
  ...
  %shl125.1 = shl nuw nsw i64 %conv122.1, %indvars.iv.next3390
...
again.i2311.sink.split:                           ; preds = %if.then.peel.i2296, %if.then21.i2314
  %.ph3726 = phi ptr [ %add.ptr.i2308, %if.then21.i2314 ], [ %add.ptr.peel.i2291, %if.then.peel.i2296 ]
  %.ph3727 = phi ptr [ %add.ptr13.i2309, %if.then21.i2314 ], [ %add.ptr13.peel.i2292, %if.then.peel.i2296 ]
  store ptr %window.i2882, ptr %write, align 8, !tbaa !16
  br label %again.i2311.preheader

again.i2311.preheader:                            ; preds = %if.then.peel.i2296, %again.i2311.sink.split
  %.ph3766 = phi ptr [ %.ph3726, %again.i2311.sink.split ], [ %add.ptr.peel.i2291, %if.then.peel.i2296 ]
  %.ph3767 = phi ptr [ %.ph3727, %again.i2311.sink.split ], [ %add.ptr13.peel.i2292, %if.then.peel.i2296 ]
  %.ph3768 = phi ptr [ %window.i2882, %again.i2311.sink.split ], [ %57, %if.then.peel.i2296 ]
  br label %again.i2311

again.i2311:                                      ; preds = %again.i2311.preheader, %if.then.i2313
  %58 = phi ptr [ %add.ptr.i2308, %if.then.i2313 ], [ %.ph3766, %again.i2311.preheader ]
  %59 = phi ptr [ %add.ptr13.i2309, %if.then.i2313 ], [ %.ph3767, %again.i2311.preheader ]
  %60 = phi ptr [ %64, %if.then.i2313 ], [ %.ph3768, %again.i2311.preheader ]
...
if.then201:                                       ; preds = %if.then164, %land.lhs.true, %if.end197
  %_state.sroa.3231780.12927 = phi ptr [ %window.i2882, %if.end197 ], [ %_state.sroa.3231780.0, %land.lhs.true ], [ %_state.sroa.3231780.0, %if.then164 ]
  store ptr %_state.sroa.3231780.12927, ptr %write, align 8, !tbaa !16
...
cond.true210:                                     ; preds = %if.then201
  ...
  %.pre3408 = load ptr, ptr %end14.i2881, align 8, !tbaa !18
  %.pre3410 = ptrtoint ptr %.pre3408 to i64
...
cond.false217:                                    ; preds = %if.then201
  ...
  %.pre3409 = ptrtoint ptr %68 to i64
  br label %cond.end223

cond.end223:                                      ; preds = %cond.false217, %cond.true210
  %sub.ptr.lhs.cast255.pre-phi = phi i64 [ %sub.ptr.lhs.cast220, %cond.false217 ], [ %.pre3410, %cond.true210 ]
  %sub.ptr.lhs.cast248.pre-phi = phi i64 [ %.pre3409, %cond.false217 ], [ %sub.ptr.lhs.cast213, %cond.true210 ]
  %71 = phi ptr [ %70, %cond.false217 ], [ %.pre3408, %cond.true210 ]
  ...
  %or.cond3246 = select i1 %cmp229, i1 true, i1 %cmp235.not
  ...
  %_state.sroa.3231780.2 = select i1 %or.cond3246, ptr %67, ptr %window.i2882
  %_state.sroa.407.2.in = select i1 %or.cond3246, i64 %cond224, i64 %cond259
...
if.then331:                                       ; preds = %while.body328.1, %while.body328.preheader
  ...
  %_state.sroa.561588.33161.lcssa = phi i64 [ %_state.sroa.561588.0, %while.body328.preheader ], [ %or352, %while.body328.1 ]
  %_state.sroa.2191703.43159.lcssa = phi ptr [ %_state.sroa.2191703.0, %while.body328.preheader ], [ %incdec.ptr346, %while.body328.1 ]
  %75 = trunc i64 %indvars.iv.lcssa to i32
  store i64 %_state.sroa.561588.33161.lcssa, ptr %bitb, align 8, !tbaa !14
  store i32 %75, ptr %bitk, align 4, !tbaa !15
  store i32 0, ptr %avail_in, align 8, !tbaa !13
  store ptr %_state.sroa.2191703.43159.lcssa, ptr %z, align 8, !tbaa !5
  store ptr %_state.sroa.3231780.0, ptr %write, align 8, !tbaa !16
...
again.i2354.sink.split:                           ; preds = %if.then.peel.i2339, %if.then21.i2357
  %.ph3728 = phi ptr [ %add.ptr.i2351, %if.then21.i2357 ], [ %add.ptr.peel.i2334, %if.then.peel.i2339 ]
  %.ph3729 = phi ptr [ %add.ptr13.i2352, %if.then21.i2357 ], [ %add.ptr13.peel.i2335, %if.then.peel.i2339 ]
  store ptr %window.i2882, ptr %write, align 8, !tbaa !16
  br label %again.i2354.preheader

again.i2354.preheader:                            ; preds = %if.then.peel.i2339, %again.i2354.sink.split
  %.ph3771 = phi ptr [ %.ph3728, %again.i2354.sink.split ], [ %add.ptr.peel.i2334, %if.then.peel.i2339 ]
  %.ph3772 = phi ptr [ %.ph3729, %again.i2354.sink.split ], [ %add.ptr13.peel.i2335, %if.then.peel.i2339 ]
  %.ph3773 = phi ptr [ %window.i2882, %again.i2354.sink.split ], [ %82, %if.then.peel.i2339 ]
  br label %again.i2354

again.i2354:                                      ; preds = %again.i2354.preheader, %if.then.i2356
  %83 = phi ptr [ %add.ptr.i2351, %if.then.i2356 ], [ %.ph3771, %again.i2354.preheader ]
  %84 = phi ptr [ %add.ptr13.i2352, %if.then.i2356 ], [ %.ph3772, %again.i2354.preheader ]
  %85 = phi ptr [ %89, %if.then.i2356 ], [ %.ph3773, %again.i2354.preheader ]
...
sw.bb389:                                         ; preds = %for.cond
  %.pre3402 = load i32, ptr %index, align 4, !tbaa !20
  %.pre3403 = load i32, ptr %sub, align 8, !tbaa !20
  %shr3953175 = lshr i32 %.pre3403, 10
  %add3963176 = add nuw nsw i32 %shr3953175, 4
  %cmp3973177 = icmp ult i32 %.pre3402, %add3963176
  br i1 %cmp3973177, label %while.cond400.preheader.preheader, label %while.cond449.preheader

while.cond400.preheader.preheader:                ; preds = %sw.bb389.thread, %sw.bb389
  %.ph3829 = phi i32 [ %.pre3402, %sw.bb389 ], [ 0, %sw.bb389.thread ]
  %_state.sroa.561588.53181.ph = phi i64 [ %_state.sroa.561588.0, %sw.bb389 ], [ %shr384, %sw.bb389.thread ]
  %_state.sroa.130.53180.ph = phi i32 [ %_state.sroa.130.0, %sw.bb389 ], [ %sub386, %sw.bb389.thread ]
  %_state.sroa.2191703.63179.ph = phi ptr [ %_state.sroa.2191703.0, %sw.bb389 ], [ %_state.sroa.2191703.4.lcssa, %sw.bb389.thread ]
  %_state.sroa.265.63178.ph = phi i32 [ %_state.sroa.265.0, %sw.bb389 ], [ %_state.sroa.265.4.lcssa, %sw.bb389.thread ]
...
while.cond449.preheader:                          ; preds = %while.end431, %sw.bb389
  ...
  %.lcssa = phi i32 [ %.pre3402, %sw.bb389 ], [ %111, %while.end431 ]
  %cmp4523188 = icmp ult i32 %.lcssa, 19
  br i1 %cmp4523188, label %while.body454, label %while.end465

while.cond400.preheader:                          ; preds = %while.cond400.preheader.preheader, %while.end431
  %94 = phi i32 [ %111, %while.end431 ], [ %.ph3829, %while.cond400.preheader.preheader ]
  %_state.sroa.561588.53181 = phi i64 [ %shr445, %while.end431 ], [ %_state.sroa.561588.53181.ph, %while.cond400.preheader.preheader ]
  %_state.sroa.130.53180 = phi i32 [ %sub447, %while.end431 ], [ %_state.sroa.130.53180.ph, %while.cond400.preheader.preheader ]
  %_state.sroa.2191703.63179 = phi ptr [ %_state.sroa.2191703.7.lcssa, %while.end431 ], [ %_state.sroa.2191703.63179.ph, %while.cond400.preheader.preheader ]
  %_state.sroa.265.63178 = phi i32 [ %_state.sroa.265.7.lcssa, %while.end431 ], [ %_state.sroa.265.63178.ph, %while.cond400.preheader.preheader ]
  %cmp4023166 = icmp ult i32 %_state.sroa.130.53180, 3
  br i1 %cmp4023166, label %while.body404, label %while.end431

while.body404:                                    ; preds = %while.cond400.preheader
  %tobool406.not = icmp eq i32 %_state.sroa.265.63178, 0
  br i1 %tobool406.not, label %if.then407, label %if.end418

if.then407:                                       ; preds = %while.body404
  store i64 %_state.sroa.561588.53181, ptr %bitb, align 8, !tbaa !14
  store i32 %_state.sroa.130.53180, ptr %bitk, align 4, !tbaa !15
  store i32 0, ptr %avail_in, align 8, !tbaa !13
  store ptr %_state.sroa.2191703.63179, ptr %z, align 8, !tbaa !5
  store ptr %_state.sroa.3231780.0, ptr %write, align 8, !tbaa !16
...
again.i2397.sink.split:                           ; preds = %if.then.peel.i2382, %if.then21.i2400
  %.ph3730 = phi ptr [ %add.ptr.i2394, %if.then21.i2400 ], [ %add.ptr.peel.i2377, %if.then.peel.i2382 ]
  %.ph3731 = phi ptr [ %add.ptr13.i2395, %if.then21.i2400 ], [ %add.ptr13.peel.i2378, %if.then.peel.i2382 ]
  store ptr %window.i2882, ptr %write, align 8, !tbaa !16
  br label %again.i2397.preheader

again.i2397.preheader:                            ; preds = %if.then.peel.i2382, %again.i2397.sink.split
  %.ph3776 = phi ptr [ %.ph3730, %again.i2397.sink.split ], [ %add.ptr.peel.i2377, %if.then.peel.i2382 ]
  %.ph3777 = phi ptr [ %.ph3731, %again.i2397.sink.split ], [ %add.ptr13.peel.i2378, %if.then.peel.i2382 ]
  %.ph3778 = phi ptr [ %window.i2882, %again.i2397.sink.split ], [ %101, %if.then.peel.i2382 ]
  br label %again.i2397

again.i2397:                                      ; preds = %again.i2397.preheader, %if.then.i2399
  %102 = phi ptr [ %add.ptr.i2394, %if.then.i2399 ], [ %.ph3776, %again.i2397.preheader ]
  %103 = phi ptr [ %add.ptr13.i2395, %if.then.i2399 ], [ %.ph3777, %again.i2397.preheader ]
  %104 = phi ptr [ %108, %if.then.i2399 ], [ %.ph3778, %again.i2397.preheader ]
...
if.end418:                                        ; preds = %while.body404
  %dec420 = add i32 %_state.sroa.265.63178, -1
  %incdec.ptr422 = getelementptr inbounds i8, ptr %_state.sroa.2191703.63179, i64 1
  %109 = load i8, ptr %_state.sroa.2191703.63179, align 1, !tbaa !20
  %conv423 = zext i8 %109 to i64
  %sh_prom425 = zext i32 %_state.sroa.130.53180 to i64
  %shl426 = shl nuw nsw i64 %conv423, %sh_prom425
  %or428 = or i64 %shl426, %_state.sroa.561588.53181
  %add430 = add nuw nsw i32 %_state.sroa.130.53180, 8
  br label %while.end431

while.end431:                                     ; preds = %if.end418, %while.cond400.preheader
  %_state.sroa.265.7.lcssa = phi i32 [ %dec420, %if.end418 ], [ %_state.sroa.265.63178, %while.cond400.preheader ]
  %_state.sroa.2191703.7.lcssa = phi ptr [ %incdec.ptr422, %if.end418 ], [ %_state.sroa.2191703.63179, %while.cond400.preheader ]
  %_state.sroa.130.6.lcssa = phi i32 [ %add430, %if.end418 ], [ %_state.sroa.130.53180, %while.cond400.preheader ]
  %_state.sroa.561588.6.lcssa = phi i64 [ %or428, %if.end418 ], [ %_state.sroa.561588.53181, %while.cond400.preheader ]
...
while.body454:                                    ; preds = %while.cond449.preheader, %while.body454
  %113 = phi i32 [ %.pr, %while.body454 ], [ %.lcssa, %while.cond449.preheader ]
...
sw.bb491:                                         ; preds = %for.cond.sw.bb491_crit_edge, %cleanup.cont
  ...
  %cmp5053207 = icmp ult i32 %index497.promoted, %add504
  br i1 %cmp5053207, label %while.body507, label %while.end696

while.body507:                                    ; preds = %sw.bb491, %cleanup690
  %_state.sroa.561588.83211 = phi i64 [ %_state.sroa.561588.12, %cleanup690 ], [ %_state.sroa.561588.7, %sw.bb491 ]
  %_state.sroa.130.83210 = phi i32 [ %_state.sroa.130.12, %cleanup690 ], [ %_state.sroa.130.7, %sw.bb491 ]
  %_state.sroa.2191703.93209 = phi ptr [ %_state.sroa.2191703.13, %cleanup690 ], [ %_state.sroa.2191703.8, %sw.bb491 ]
  %_state.sroa.265.93208 = phi i32 [ %_state.sroa.265.13, %cleanup690 ], [ %_state.sroa.265.8, %sw.bb491 ]
  %117 = phi i32 [ %188, %cleanup690 ], [ %index497.promoted, %sw.bb491 ]
  %118 = load i32, ptr %bb, align 8, !tbaa !20
  %cmp5143189 = icmp ult i32 %_state.sroa.130.83210, %118
  br i1 %cmp5143189, label %while.body516, label %while.end543

while.body516:                                    ; preds = %while.body507, %if.end530
  %_state.sroa.561588.93193 = phi i64 [ %or540, %if.end530 ], [ %_state.sroa.561588.83211, %while.body507 ]
  %_state.sroa.130.93192 = phi i32 [ %add542, %if.end530 ], [ %_state.sroa.130.83210, %while.body507 ]
  %_state.sroa.2191703.103191 = phi ptr [ %incdec.ptr534, %if.end530 ], [ %_state.sroa.2191703.93209, %while.body507 ]
  %_state.sroa.265.103190 = phi i32 [ %dec532, %if.end530 ], [ %_state.sroa.265.93208, %while.body507 ]
  %tobool518.not = icmp eq i32 %_state.sroa.265.103190, 0
  br i1 %tobool518.not, label %if.then519, label %if.end530

if.then519:                                       ; preds = %while.body516
  %119 = shl i32 %_state.sroa.265.93208, 3
  %120 = add i32 %_state.sroa.130.83210, %119
  %121 = zext i32 %_state.sroa.265.93208 to i64
  %scevgep3383.le = getelementptr i8, ptr %_state.sroa.2191703.93209, i64 %121
  store i64 %_state.sroa.561588.93193, ptr %bitb, align 8, !tbaa !14
  store i32 %120, ptr %bitk, align 4, !tbaa !15
  store i32 0, ptr %avail_in, align 8, !tbaa !13
  store ptr %scevgep3383.le, ptr %z, align 8, !tbaa !5
  store ptr %_state.sroa.3231780.0, ptr %write, align 8, !tbaa !16
...
again.i2440.sink.split:                           ; preds = %if.then.peel.i2425, %if.then21.i2443
  %.ph3732 = phi ptr [ %add.ptr.i2437, %if.then21.i2443 ], [ %add.ptr.peel.i2420, %if.then.peel.i2425 ]
  %.ph3733 = phi ptr [ %add.ptr13.i2438, %if.then21.i2443 ], [ %add.ptr13.peel.i2421, %if.then.peel.i2425 ]
  store ptr %window.i2882, ptr %write, align 8, !tbaa !16
  br label %again.i2440.preheader

again.i2440.preheader:                            ; preds = %if.then.peel.i2425, %again.i2440.sink.split
  %.ph3781 = phi ptr [ %.ph3732, %again.i2440.sink.split ], [ %add.ptr.peel.i2420, %if.then.peel.i2425 ]
  %.ph3782 = phi ptr [ %.ph3733, %again.i2440.sink.split ], [ %add.ptr13.peel.i2421, %if.then.peel.i2425 ]
  %.ph3783 = phi ptr [ %window.i2882, %again.i2440.sink.split ], [ %128, %if.then.peel.i2425 ]
  br label %again.i2440

again.i2440:                                      ; preds = %again.i2440.preheader, %if.then.i2442
  %129 = phi ptr [ %add.ptr.i2437, %if.then.i2442 ], [ %.ph3781, %again.i2440.preheader ]
  %130 = phi ptr [ %add.ptr13.i2438, %if.then.i2442 ], [ %.ph3782, %again.i2440.preheader ]
  %131 = phi ptr [ %135, %if.then.i2442 ], [ %.ph3783, %again.i2440.preheader ]
...
if.end530:                                        ; preds = %while.body516
  %dec532 = add i32 %_state.sroa.265.103190, -1
  %incdec.ptr534 = getelementptr inbounds i8, ptr %_state.sroa.2191703.103191, i64 1
  %136 = load i8, ptr %_state.sroa.2191703.103191, align 1, !tbaa !20
  %conv535 = zext i8 %136 to i64
  %sh_prom537 = zext i32 %_state.sroa.130.93192 to i64
  %shl538 = shl i64 %conv535, %sh_prom537
  %or540 = or i64 %shl538, %_state.sroa.561588.93193
  %add542 = add i32 %_state.sroa.130.93192, 8
...
while.end543:                                     ; preds = %if.end530, %while.body507
  %_state.sroa.265.10.lcssa = phi i32 [ %_state.sroa.265.93208, %while.body507 ], [ %dec532, %if.end530 ]
  %_state.sroa.2191703.10.lcssa = phi ptr [ %_state.sroa.2191703.93209, %while.body507 ], [ %incdec.ptr534, %if.end530 ]
  %_state.sroa.130.9.lcssa = phi i32 [ %_state.sroa.130.83210, %while.body507 ], [ %add542, %if.end530 ]
  %_state.sroa.561588.9.lcssa = phi i64 [ %_state.sroa.561588.83211, %while.body507 ], [ %or540, %if.end530 ]
...
if.else575:                                       ; preds = %while.end543
  ...
  %add585 = add nsw i32 %i.0, %conv555
  %cmp5863198 = icmp ult i32 %_state.sroa.130.9.lcssa, %add585
  br i1 %cmp5863198, label %while.body588.preheader, label %while.end615
...
while.body588:                                    ; preds = %while.body588.preheader, %if.end602
  %indvars.iv3384 = phi i64 [ %141, %while.body588.preheader ], [ %indvars.iv.next3385, %if.end602 ]
  %_state.sroa.561588.103202 = phi i64 [ %_state.sroa.561588.9.lcssa, %while.body588.preheader ], [ %or612, %if.end602 ]
  %_state.sroa.2191703.113200 = phi ptr [ %_state.sroa.2191703.10.lcssa, %while.body588.preheader ], [ %incdec.ptr606, %if.end602 ]
  %_state.sroa.265.113199 = phi i32 [ %_state.sroa.265.10.lcssa, %while.body588.preheader ], [ %dec604, %if.end602 ]
  %tobool590.not = icmp eq i32 %_state.sroa.265.113199, 0
...
if.then591:                                       ; preds = %while.body588
  ...
  %scevgep3386.le = getelementptr i8, ptr %_state.sroa.2191703.10.lcssa, i64 %143
  store i64 %_state.sroa.561588.103202, ptr %bitb, align 8, !tbaa !14
...
again.i2483.sink.split:                           ; preds = %if.then.peel.i2468, %if.then21.i2486
  %.ph3734 = phi ptr [ %add.ptr.i2480, %if.then21.i2486 ], [ %add.ptr.peel.i2463, %if.then.peel.i2468 ]
  %.ph3735 = phi ptr [ %add.ptr13.i2481, %if.then21.i2486 ], [ %add.ptr13.peel.i2464, %if.then.peel.i2468 ]
  store ptr %window.i2882, ptr %write, align 8, !tbaa !16
  br label %again.i2483.preheader

again.i2483.preheader:                            ; preds = %if.then.peel.i2468, %again.i2483.sink.split
  %.ph3796 = phi ptr [ %.ph3734, %again.i2483.sink.split ], [ %add.ptr.peel.i2463, %if.then.peel.i2468 ]
  %.ph3797 = phi ptr [ %.ph3735, %again.i2483.sink.split ], [ %add.ptr13.peel.i2464, %if.then.peel.i2468 ]
  %.ph3798 = phi ptr [ %window.i2882, %again.i2483.sink.split ], [ %152, %if.then.peel.i2468 ]
  br label %again.i2483

again.i2483:                                      ; preds = %again.i2483.preheader, %if.then.i2485
  %153 = phi ptr [ %add.ptr.i2480, %if.then.i2485 ], [ %.ph3796, %again.i2483.preheader ]
  %154 = phi ptr [ %add.ptr13.i2481, %if.then.i2485 ], [ %.ph3797, %again.i2483.preheader ]
  %155 = phi ptr [ %159, %if.then.i2485 ], [ %.ph3798, %again.i2483.preheader ]
...
if.end602:                                        ; preds = %while.body588
  %dec604 = add i32 %_state.sroa.265.113199, -1
  %incdec.ptr606 = getelementptr inbounds i8, ptr %_state.sroa.2191703.113200, i64 1
  %160 = load i8, ptr %_state.sroa.2191703.113200, align 1, !tbaa !20
  %conv607 = zext i8 %160 to i64
  %shl610 = shl i64 %conv607, %indvars.iv3384
  %or612 = or i64 %shl610, %_state.sroa.561588.103202
  %indvars.iv.next3385 = add nuw nsw i64 %indvars.iv3384, 8
  %cmp586 = icmp ult i64 %indvars.iv.next3385, %142
  br i1 %cmp586, label %while.body588, label %while.end615.loopexit, !llvm.loop !42

while.end615.loopexit:                            ; preds = %if.end602
  %161 = trunc i64 %indvars.iv.next3385 to i32
...
again.i2526.sink.split:                           ; preds = %if.then.peel.i2511, %if.then21.i2529
  %.ph3736 = phi ptr [ %add.ptr.i2523, %if.then21.i2529 ], [ %add.ptr.peel.i2506, %if.then.peel.i2511 ]
  %.ph3737 = phi ptr [ %add.ptr13.i2524, %if.then21.i2529 ], [ %add.ptr13.peel.i2507, %if.then.peel.i2511 ]
  store ptr %window.i2882, ptr %write, align 8, !tbaa !16
  br label %again.i2526.preheader

again.i2526.preheader:                            ; preds = %if.then.peel.i2511, %again.i2526.sink.split
  %.ph3801 = phi ptr [ %.ph3736, %again.i2526.sink.split ], [ %add.ptr.peel.i2506, %if.then.peel.i2511 ]
  %.ph3802 = phi ptr [ %.ph3737, %again.i2526.sink.split ], [ %add.ptr13.peel.i2507, %if.then.peel.i2511 ]
  %.ph3803 = phi ptr [ %window.i2882, %again.i2526.sink.split ], [ %169, %if.then.peel.i2511 ]
  br label %again.i2526

again.i2526:                                      ; preds = %again.i2526.preheader, %if.then.i2528
  %170 = phi ptr [ %add.ptr.i2523, %if.then.i2528 ], [ %.ph3801, %again.i2526.preheader ]
  %171 = phi ptr [ %add.ptr13.i2524, %if.then.i2528 ], [ %.ph3802, %again.i2526.preheader ]
  %172 = phi ptr [ %176, %if.then.i2528 ], [ %.ph3803, %again.i2526.preheader ]
...
vector.ph:                                        ; preds = %vector.scevcheck
  ...
  %ind.end3718 = and i32 %add629, 7
  %broadcast.splatinsert = insertelement <4 x i32> poison, i32 %cond679, i64 0
  %broadcast.splat = shufflevector <4 x i32> %broadcast.splatinsert, <4 x i32> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert3721 = insertelement <4 x i32> poison, i32 %cond679, i64 0
  %broadcast.splat3722 = shufflevector <4 x i32> %broadcast.splatinsert3721, <4 x i32> poison, <4 x i32> zeroinitializer
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index3720 = phi i32 [ 0, %vector.ph ], [ %index.next, %vector.body ]
  %offset.idx = add i32 %117, %index3720
  ...
  store <4 x i32> %broadcast.splat3722, ptr %184, align 4, !tbaa !20
  %index.next = add nuw i32 %index3720, 8
...
do.body.preheader:                                ; preds = %vector.scevcheck, %cond.end678, %middle.block
  ...
  %j.1.ph = phi i32 [ %add629, %vector.scevcheck ], [ %add629, %cond.end678 ], [ %ind.end3718, %middle.block ]
...
do.body.prol.loopexit:                            ; preds = %do.body.prol, %do.body.preheader
  %inc682.lcssa3861.unr = phi i32 [ undef, %do.body.preheader ], [ %inc682.prol, %do.body.prol ]
...
do.end:                                           ; preds = %do.body.prol.loopexit, %do.body, %middle.block
  %inc682.lcssa = phi i32 [ %ind.end, %middle.block ], [ %inc682.lcssa3861.unr, %do.body.prol.loopexit ], [ %inc682.3, %do.body ]
...
while.end696:                                     ; preds = %cleanup690, %sw.bb491
  ...
  %cmp7233248 = icmp eq i32 %call715, 0
  %cmp723 = select i1 %cmp717, i1 %cmp7233248, i1 false
...
again.i2569.sink.split:                           ; preds = %if.then.peel.i2554, %if.then21.i2572
  %.ph3738 = phi ptr [ %add.ptr.i2566, %if.then21.i2572 ], [ %add.ptr.peel.i2549, %if.then.peel.i2554 ]
  %.ph3739 = phi ptr [ %add.ptr13.i2567, %if.then21.i2572 ], [ %add.ptr13.peel.i2550, %if.then.peel.i2554 ]
  store ptr %window.i2882, ptr %write, align 8, !tbaa !16
  br label %again.i2569.preheader

again.i2569.preheader:                            ; preds = %if.then.peel.i2554, %again.i2569.sink.split
  %.ph3786 = phi ptr [ %.ph3738, %again.i2569.sink.split ], [ %add.ptr.peel.i2549, %if.then.peel.i2554 ]
  %.ph3787 = phi ptr [ %.ph3739, %again.i2569.sink.split ], [ %add.ptr13.peel.i2550, %if.then.peel.i2554 ]
  %.ph3788 = phi ptr [ %window.i2882, %again.i2569.sink.split ], [ %197, %if.then.peel.i2554 ]
  br label %again.i2569

again.i2569:                                      ; preds = %again.i2569.preheader, %if.then.i2571
  %198 = phi ptr [ %add.ptr.i2566, %if.then.i2571 ], [ %.ph3786, %again.i2569.preheader ]
  %199 = phi ptr [ %add.ptr13.i2567, %if.then.i2571 ], [ %.ph3787, %again.i2569.preheader ]
  %200 = phi ptr [ %204, %if.then.i2571 ], [ %.ph3788, %again.i2569.preheader ]
...
sw.bb782:                                         ; preds = %for.cond.sw.bb782_crit_edge, %cleanup.cont780
  %207 = phi ptr [ %.pre3406, %for.cond.sw.bb782_crit_edge ], [ %205, %cleanup.cont780 ]
  %208 = phi i8 [ %.pre3405, %for.cond.sw.bb782_crit_edge ], [ %conv758, %cleanup.cont780 ]
...
sw.bb789:                                         ; preds = %for.cond.sw.bb789_crit_edge, %sw.bb782
  %209 = phi i32 [ %.pre3407, %for.cond.sw.bb789_crit_edge ], [ %conv784, %sw.bb782 ]
  ...
  %cmp7963218 = icmp ult i32 %_state.sroa.130.14, %209
  br i1 %cmp7963218, label %while.body798, label %while.end825

while.body798:                                    ; preds = %sw.bb789, %if.end812
  %_state.sroa.561588.153222 = phi i64 [ %or822, %if.end812 ], [ %_state.sroa.561588.14, %sw.bb789 ]
  %_state.sroa.130.153221 = phi i32 [ %add824, %if.end812 ], [ %_state.sroa.130.14, %sw.bb789 ]
  %_state.sroa.2191703.163220 = phi ptr [ %incdec.ptr816, %if.end812 ], [ %_state.sroa.2191703.15, %sw.bb789 ]
  %_state.sroa.265.163219 = phi i32 [ %dec814, %if.end812 ], [ %_state.sroa.265.15, %sw.bb789 ]
  %tobool800.not = icmp eq i32 %_state.sroa.265.163219, 0
...
if.then801:                                       ; preds = %while.body798
  ...
  %scevgep3388.le = getelementptr i8, ptr %_state.sroa.2191703.15, i64 %212
  store i64 %_state.sroa.561588.153222, ptr %bitb, align 8, !tbaa !14
  store i32 %211, ptr %bitk, align 4, !tbaa !15
  store i32 0, ptr %avail_in, align 8, !tbaa !13
  store ptr %scevgep3388.le, ptr %z, align 8, !tbaa !5
  store ptr %_state.sroa.3231780.0, ptr %write, align 8, !tbaa !16
...
again.i2612.sink.split:                           ; preds = %if.then.peel.i2597, %if.then21.i2615
  %.ph3740 = phi ptr [ %add.ptr.i2609, %if.then21.i2615 ], [ %add.ptr.peel.i2592, %if.then.peel.i2597 ]
  %.ph3741 = phi ptr [ %add.ptr13.i2610, %if.then21.i2615 ], [ %add.ptr13.peel.i2593, %if.then.peel.i2597 ]
  store ptr %window.i2882, ptr %write, align 8, !tbaa !16
  br label %again.i2612.preheader

again.i2612.preheader:                            ; preds = %if.then.peel.i2597, %again.i2612.sink.split
  %.ph3791 = phi ptr [ %.ph3740, %again.i2612.sink.split ], [ %add.ptr.peel.i2592, %if.then.peel.i2597 ]
  %.ph3792 = phi ptr [ %.ph3741, %again.i2612.sink.split ], [ %add.ptr13.peel.i2593, %if.then.peel.i2597 ]
  %.ph3793 = phi ptr [ %window.i2882, %again.i2612.sink.split ], [ %219, %if.then.peel.i2597 ]
  br label %again.i2612

again.i2612:                                      ; preds = %again.i2612.preheader, %if.then.i2614
  %220 = phi ptr [ %add.ptr.i2609, %if.then.i2614 ], [ %.ph3791, %again.i2612.preheader ]
  %221 = phi ptr [ %add.ptr13.i2610, %if.then.i2614 ], [ %.ph3792, %again.i2612.preheader ]
  %222 = phi ptr [ %226, %if.then.i2614 ], [ %.ph3793, %again.i2612.preheader ]
...
if.end812:                                        ; preds = %while.body798
  %dec814 = add i32 %_state.sroa.265.163219, -1
  %incdec.ptr816 = getelementptr inbounds i8, ptr %_state.sroa.2191703.163220, i64 1
  %227 = load i8, ptr %_state.sroa.2191703.163220, align 1, !tbaa !20
  %conv817 = zext i8 %227 to i64
  %sh_prom819 = zext i32 %_state.sroa.130.153221 to i64
  %shl820 = shl i64 %conv817, %sh_prom819
  %or822 = or i64 %shl820, %_state.sroa.561588.153222
  %add824 = add i32 %_state.sroa.130.153221, 8
...
sw.bb899:                                         ; preds = %for.cond
  ...
  %cmp9063139 = icmp ult i32 %_state.sroa.130.0, %235
  br i1 %cmp9063139, label %while.body908, label %while.end935

while.body908:                                    ; preds = %sw.bb899, %if.end922
  %_state.sroa.561588.163143 = phi i64 [ %or932, %if.end922 ], [ %_state.sroa.561588.0, %sw.bb899 ]
  %_state.sroa.130.163142 = phi i32 [ %add934, %if.end922 ], [ %_state.sroa.130.0, %sw.bb899 ]
  %_state.sroa.2191703.173141 = phi ptr [ %incdec.ptr926, %if.end922 ], [ %_state.sroa.2191703.0, %sw.bb899 ]
  %_state.sroa.265.173140 = phi i32 [ %dec924, %if.end922 ], [ %_state.sroa.265.0, %sw.bb899 ]
  %tobool910.not = icmp eq i32 %_state.sroa.265.173140, 0
...
if.then911:                                       ; preds = %while.body908
  ...
  %scevgep3380.le = getelementptr i8, ptr %_state.sroa.2191703.0, i64 %238
  store i64 %_state.sroa.561588.163143, ptr %bitb, align 8, !tbaa !14
  store i32 %237, ptr %bitk, align 4, !tbaa !15
  store i32 0, ptr %avail_in, align 8, !tbaa !13
  store ptr %scevgep3380.le, ptr %z, align 8, !tbaa !5
  store ptr %_state.sroa.3231780.0, ptr %write, align 8, !tbaa !16
...
again.i2655.sink.split:                           ; preds = %if.then.peel.i2640, %if.then21.i2658
  %.ph3742 = phi ptr [ %add.ptr.i2652, %if.then21.i2658 ], [ %add.ptr.peel.i2635, %if.then.peel.i2640 ]
  %.ph3743 = phi ptr [ %add.ptr13.i2653, %if.then21.i2658 ], [ %add.ptr13.peel.i2636, %if.then.peel.i2640 ]
  store ptr %window.i2882, ptr %write, align 8, !tbaa !16
  br label %again.i2655.preheader

again.i2655.preheader:                            ; preds = %if.then.peel.i2640, %again.i2655.sink.split
  %.ph3806 = phi ptr [ %.ph3742, %again.i2655.sink.split ], [ %add.ptr.peel.i2635, %if.then.peel.i2640 ]
  %.ph3807 = phi ptr [ %.ph3743, %again.i2655.sink.split ], [ %add.ptr13.peel.i2636, %if.then.peel.i2640 ]
  %.ph3808 = phi ptr [ %window.i2882, %again.i2655.sink.split ], [ %245, %if.then.peel.i2640 ]
  br label %again.i2655

again.i2655:                                      ; preds = %again.i2655.preheader, %if.then.i2657
  %246 = phi ptr [ %add.ptr.i2652, %if.then.i2657 ], [ %.ph3806, %again.i2655.preheader ]
  %247 = phi ptr [ %add.ptr13.i2653, %if.then.i2657 ], [ %.ph3807, %again.i2655.preheader ]
  %248 = phi ptr [ %252, %if.then.i2657 ], [ %.ph3808, %again.i2655.preheader ]
...
if.end922:                                        ; preds = %while.body908
  %dec924 = add i32 %_state.sroa.265.173140, -1
  %incdec.ptr926 = getelementptr inbounds i8, ptr %_state.sroa.2191703.173141, i64 1
  %253 = load i8, ptr %_state.sroa.2191703.173141, align 1, !tbaa !20
  %conv927 = zext i8 %253 to i64
  %sh_prom929 = zext i32 %_state.sroa.130.163142 to i64
  %shl930 = shl i64 %conv927, %sh_prom929
  %or932 = or i64 %shl930, %_state.sroa.561588.163143
  %add934 = add i32 %_state.sroa.130.163142, 8
...
sw.bb960:                                         ; preds = %for.cond.sw.bb960_crit_edge, %while.end935
  %258 = phi i32 [ %.pre3401, %for.cond.sw.bb960_crit_edge ], [ %conv953, %while.end935 ]
  ...
  %cmp9673148 = icmp ult i32 %_state.sroa.130.17, %258
  br i1 %cmp9673148, label %while.body969, label %while.end996

while.body969:                                    ; preds = %sw.bb960, %if.end983
  %_state.sroa.561588.183152 = phi i64 [ %or993, %if.end983 ], [ %_state.sroa.561588.17, %sw.bb960 ]
  %_state.sroa.130.183151 = phi i32 [ %add995, %if.end983 ], [ %_state.sroa.130.17, %sw.bb960 ]
  %_state.sroa.2191703.193150 = phi ptr [ %incdec.ptr987, %if.end983 ], [ %_state.sroa.2191703.18, %sw.bb960 ]
  %_state.sroa.265.193149 = phi i32 [ %dec985, %if.end983 ], [ %_state.sroa.265.18, %sw.bb960 ]
  %tobool971.not = icmp eq i32 %_state.sroa.265.193149, 0
...
if.then972:                                       ; preds = %while.body969
  ...
  %scevgep3381.le = getelementptr i8, ptr %_state.sroa.2191703.18, i64 %261
  store i64 %_state.sroa.561588.183152, ptr %bitb, align 8, !tbaa !14
  store i32 %260, ptr %bitk, align 4, !tbaa !15
  store i32 0, ptr %avail_in, align 8, !tbaa !13
  store ptr %scevgep3381.le, ptr %z, align 8, !tbaa !5
  store ptr %_state.sroa.3231780.0, ptr %write, align 8, !tbaa !16
...
again.i2698.sink.split:                           ; preds = %if.then.peel.i2683, %if.then21.i2701
  %.ph3744 = phi ptr [ %add.ptr.i2695, %if.then21.i2701 ], [ %add.ptr.peel.i2678, %if.then.peel.i2683 ]
  %.ph3745 = phi ptr [ %add.ptr13.i2696, %if.then21.i2701 ], [ %add.ptr13.peel.i2679, %if.then.peel.i2683 ]
  store ptr %window.i2882, ptr %write, align 8, !tbaa !16
  br label %again.i2698.preheader

again.i2698.preheader:                            ; preds = %if.then.peel.i2683, %again.i2698.sink.split
  %.ph3811 = phi ptr [ %.ph3744, %again.i2698.sink.split ], [ %add.ptr.peel.i2678, %if.then.peel.i2683 ]
  %.ph3812 = phi ptr [ %.ph3745, %again.i2698.sink.split ], [ %add.ptr13.peel.i2679, %if.then.peel.i2683 ]
  %.ph3813 = phi ptr [ %window.i2882, %again.i2698.sink.split ], [ %268, %if.then.peel.i2683 ]
  br label %again.i2698

again.i2698:                                      ; preds = %again.i2698.preheader, %if.then.i2700
  %269 = phi ptr [ %add.ptr.i2695, %if.then.i2700 ], [ %.ph3811, %again.i2698.preheader ]
  %270 = phi ptr [ %add.ptr13.i2696, %if.then.i2700 ], [ %.ph3812, %again.i2698.preheader ]
  %271 = phi ptr [ %275, %if.then.i2700 ], [ %.ph3813, %again.i2698.preheader ]
...
if.end983:                                        ; preds = %while.body969
  %dec985 = add i32 %_state.sroa.265.193149, -1
  %incdec.ptr987 = getelementptr inbounds i8, ptr %_state.sroa.2191703.193150, i64 1
  %276 = load i8, ptr %_state.sroa.2191703.193150, align 1, !tbaa !20
  %conv988 = zext i8 %276 to i64
  %sh_prom990 = zext i32 %_state.sroa.130.183151 to i64
  %shl991 = shl i64 %conv988, %sh_prom990
  %or993 = or i64 %shl991, %_state.sroa.561588.183152
  %add995 = add i32 %_state.sroa.130.183151, 8
...
sw.bb1058:                                        ; preds = %for.cond
  ...
  %cmp10653125 = icmp ult i32 %_state.sroa.130.0, %283
  br i1 %cmp10653125, label %while.body1067, label %while.end1094

while.body1067:                                   ; preds = %sw.bb1058, %if.end1081
  %_state.sroa.561588.193129 = phi i64 [ %or1091, %if.end1081 ], [ %_state.sroa.561588.0, %sw.bb1058 ]
  %_state.sroa.130.193128 = phi i32 [ %add1093, %if.end1081 ], [ %_state.sroa.130.0, %sw.bb1058 ]
  %_state.sroa.2191703.203127 = phi ptr [ %incdec.ptr1085, %if.end1081 ], [ %_state.sroa.2191703.0, %sw.bb1058 ]
  %_state.sroa.265.203126 = phi i32 [ %dec1083, %if.end1081 ], [ %_state.sroa.265.0, %sw.bb1058 ]
  %tobool1069.not = icmp eq i32 %_state.sroa.265.203126, 0
...
if.then1070:                                      ; preds = %while.body1067
  ...
  store i64 %_state.sroa.561588.193129, ptr %bitb, align 8, !tbaa !14
...
again.i2741.sink.split:                           ; preds = %if.then.peel.i2726, %if.then21.i2744
  %.ph3746 = phi ptr [ %add.ptr.i2738, %if.then21.i2744 ], [ %add.ptr.peel.i2721, %if.then.peel.i2726 ]
  %.ph3747 = phi ptr [ %add.ptr13.i2739, %if.then21.i2744 ], [ %add.ptr13.peel.i2722, %if.then.peel.i2726 ]
  store ptr %window.i2882, ptr %write, align 8, !tbaa !16
  br label %again.i2741.preheader

again.i2741.preheader:                            ; preds = %if.then.peel.i2726, %again.i2741.sink.split
  %.ph3816 = phi ptr [ %.ph3746, %again.i2741.sink.split ], [ %add.ptr.peel.i2721, %if.then.peel.i2726 ]
  %.ph3817 = phi ptr [ %.ph3747, %again.i2741.sink.split ], [ %add.ptr13.peel.i2722, %if.then.peel.i2726 ]
  %.ph3818 = phi ptr [ %window.i2882, %again.i2741.sink.split ], [ %293, %if.then.peel.i2726 ]
  br label %again.i2741

again.i2741:                                      ; preds = %again.i2741.preheader, %if.then.i2743
  %294 = phi ptr [ %add.ptr.i2738, %if.then.i2743 ], [ %.ph3816, %again.i2741.preheader ]
  %295 = phi ptr [ %add.ptr13.i2739, %if.then.i2743 ], [ %.ph3817, %again.i2741.preheader ]
  %296 = phi ptr [ %300, %if.then.i2743 ], [ %.ph3818, %again.i2741.preheader ]
...
if.end1081:                                       ; preds = %while.body1067
  %dec1083 = add i32 %_state.sroa.265.203126, -1
  %incdec.ptr1085 = getelementptr inbounds i8, ptr %_state.sroa.2191703.203127, i64 1
  %301 = load i8, ptr %_state.sroa.2191703.203127, align 1, !tbaa !20
  %conv1086 = zext i8 %301 to i64
  %sh_prom1088 = zext i32 %_state.sroa.130.193128 to i64
  %shl1089 = shl i64 %conv1086, %sh_prom1088
  %or1091 = or i64 %shl1089, %_state.sroa.561588.193129
  %add1093 = add i32 %_state.sroa.130.193128, 8
...
sw.bb1113:                                        ; preds = %for.cond.sw.bb1113_crit_edge, %while.end1094
  %304 = phi i32 [ %.pre3399, %for.cond.sw.bb1113_crit_edge ], [ %add1104, %while.end1094 ]
...
cond.end1145:                                     ; preds = %sw.bb1113, %cond.true1125
  ...
  %.pr2947 = load i32, ptr %sub, align 8, !tbaa !20
  %tobool1150.not3133 = icmp eq i32 %.pr2947, 0
  br i1 %tobool1150.not3133, label %while.end1291, label %while.body1151.preheader
...
while.body1151:                                   ; preds = %while.body1151.preheader, %if.end1273
  %_state.sroa.4621885.03136 = phi ptr [ %spec.select2923, %if.end1273 ], [ %add.ptr1144, %while.body1151.preheader ]
  %_state.sroa.407.53135 = phi i32 [ %dec1279, %if.end1273 ], [ %_state.sroa.407.0, %while.body1151.preheader ]
  %_state.sroa.3231780.53134 = phi ptr [ %incdec.ptr1277, %if.end1273 ], [ %_state.sroa.3231780.0, %while.body1151.preheader ]
  %cmp1153 = icmp eq i32 %_state.sroa.407.53135, 0
...
if.then1155:                                      ; preds = %while.body1151
  ...
  %cmp1158 = icmp eq ptr %_state.sroa.3231780.53134, %306
  %307 = load ptr, ptr %read, align 8, !tbaa !17
  br i1 %cmp1158, label %land.lhs.true1160, label %if.then1195
...
if.end1191:                                       ; preds = %land.lhs.true1160
  ...
  %sub.ptr.lhs.cast1184 = ptrtoint ptr %_state.sroa.3231780.53134 to i64
...
if.then1195:                                      ; preds = %if.then1155, %land.lhs.true1160, %if.end1191
  %308 = phi ptr [ %307, %if.end1191 ], [ %window.i2882, %land.lhs.true1160 ], [ %307, %if.then1155 ]
  %_state.sroa.3231780.62951 = phi ptr [ %window.i2882, %if.end1191 ], [ %_state.sroa.3231780.53134, %land.lhs.true1160 ], [ %_state.sroa.3231780.53134, %if.then1155 ]
  store ptr %_state.sroa.3231780.62951, ptr %write, align 8, !tbaa !16
  %cmp.not.peel.i2754 = icmp ugt ptr %308, %_state.sroa.3231780.62951
  %spec.select3577 = select i1 %cmp.not.peel.i2754, ptr %306, ptr %_state.sroa.3231780.62951
  %sub.ptr.lhs.cast.peel.i2757 = ptrtoint ptr %spec.select3577 to i64
  %sub.ptr.rhs.cast.peel.i2758 = ptrtoint ptr %308 to i64
  %sub.ptr.sub.peel.i2759 = sub i64 %sub.ptr.lhs.cast.peel.i2757, %sub.ptr.rhs.cast.peel.i2758
...
again.i2784.sink.split:                           ; preds = %if.then.peel.i2769, %if.then21.i2787
  %.ph3748 = phi ptr [ %add.ptr.i2781, %if.then21.i2787 ], [ %add.ptr.peel.i2764, %if.then.peel.i2769 ]
  %.ph3749 = phi ptr [ %add.ptr13.i2782, %if.then21.i2787 ], [ %add.ptr13.peel.i2765, %if.then.peel.i2769 ]
  store ptr %window.i2882, ptr %write, align 8, !tbaa !16
  br label %again.i2784.preheader

again.i2784.preheader:                            ; preds = %if.then.peel.i2769, %again.i2784.sink.split
  %.ph3826 = phi ptr [ %.ph3748, %again.i2784.sink.split ], [ %add.ptr.peel.i2764, %if.then.peel.i2769 ]
  %.ph3827 = phi ptr [ %.ph3749, %again.i2784.sink.split ], [ %add.ptr13.peel.i2765, %if.then.peel.i2769 ]
  %.ph3828 = phi ptr [ %window.i2882, %again.i2784.sink.split ], [ %313, %if.then.peel.i2769 ]
  br label %again.i2784

again.i2784:                                      ; preds = %again.i2784.preheader, %if.then.i2786
  %314 = phi ptr [ %add.ptr.i2781, %if.then.i2786 ], [ %.ph3826, %again.i2784.preheader ]
  %315 = phi ptr [ %add.ptr13.i2782, %if.then.i2786 ], [ %.ph3827, %again.i2784.preheader ]
  %316 = phi ptr [ %320, %if.then.i2786 ], [ %.ph3828, %again.i2784.preheader ]
...
inflate_flush.exit2790:                           ; preds = %again.i2784, %if.then1195
  ...
  %.pre3411 = ptrtoint ptr %add.ptr13.lcssa.i2789 to i64
  ...
  %.pre3412 = ptrtoint ptr %322 to i64
  %sub.ptr.lhs.cast1249.pre-phi = select i1 %cmp1202, i64 %.pre3412, i64 %sub.ptr.lhs.cast1214
  %sub.ptr.lhs.cast1242.pre-phi = select i1 %cmp1202, i64 %sub.ptr.lhs.cast1207, i64 %.pre3411
  ...
  %or.cond2922 = or i1 %cmp1229.not, %cmp1223
  ...
  %_state.sroa.3231780.7 = select i1 %or.cond2922, ptr %323, ptr %window.i2882
  %_state.sroa.407.7.in = select i1 %or.cond2922, i64 %cond1218, i64 %cond1253
...
if.then1260:                                      ; preds = %inflate_flush.exit2790
  ...
  %.pre3415 = ptrtoint ptr %_state.sroa.3231780.7 to i64
  %spec.select3578 = select i1 %cmp.not.peel.i2797, i64 %sub.ptr.lhs.cast1249.pre-phi, i64 %.pre3415
  %sub.ptr.sub.peel.i2802 = sub i64 %spec.select3578, %sub.ptr.lhs.cast1242.pre-phi
...
again.i2827.sink.split:                           ; preds = %if.then.peel.i2812, %if.then21.i2830
  %.ph3750 = phi ptr [ %add.ptr.i2824, %if.then21.i2830 ], [ %add.ptr.peel.i2807, %if.then.peel.i2812 ]
  %.ph3751 = phi ptr [ %add.ptr13.i2825, %if.then21.i2830 ], [ %add.ptr13.peel.i2808, %if.then.peel.i2812 ]
  store ptr %window.i2882, ptr %write, align 8, !tbaa !16
  br label %again.i2827.preheader

again.i2827.preheader:                            ; preds = %if.then.peel.i2812, %again.i2827.sink.split
  %.ph3821 = phi ptr [ %.ph3750, %again.i2827.sink.split ], [ %add.ptr.peel.i2807, %if.then.peel.i2812 ]
  %.ph3822 = phi ptr [ %.ph3751, %again.i2827.sink.split ], [ %add.ptr13.peel.i2808, %if.then.peel.i2812 ]
  %.ph3823 = phi ptr [ %window.i2882, %again.i2827.sink.split ], [ %328, %if.then.peel.i2812 ]
  br label %again.i2827

again.i2827:                                      ; preds = %again.i2827.preheader, %if.then.i2829
  %329 = phi ptr [ %add.ptr.i2824, %if.then.i2829 ], [ %.ph3821, %again.i2827.preheader ]
  %330 = phi ptr [ %add.ptr13.i2825, %if.then.i2829 ], [ %.ph3822, %again.i2827.preheader ]
  %331 = phi ptr [ %335, %if.then.i2829 ], [ %.ph3823, %again.i2827.preheader ]
...
if.end1273:                                       ; preds = %if.end1191, %inflate_flush.exit2790, %while.body1151
  %_state.sroa.3231780.8 = phi ptr [ %_state.sroa.3231780.7, %inflate_flush.exit2790 ], [ %window.i2882, %if.end1191 ], [ %_state.sroa.3231780.53134, %while.body1151 ]
  %_state.sroa.407.8 = phi i32 [ %_state.sroa.407.7, %inflate_flush.exit2790 ], [ %conv1189, %if.end1191 ], [ %_state.sroa.407.53135, %while.body1151 ]
  %incdec.ptr1275 = getelementptr inbounds i8, ptr %_state.sroa.4621885.03136, i64 1
  %336 = load i8, ptr %_state.sroa.4621885.03136, align 1, !tbaa !20
  ...
  %spec.select2923 = select i1 %cmp1282, ptr %window.i2882, ptr %incdec.ptr1275
...
if.then1297:                                      ; preds = %sw.bb1293
  ...
  br i1 %cmp1300, label %land.lhs.true1302, label %if.then1337
...
if.then1337:                                      ; preds = %if.then1297, %land.lhs.true1302, %if.end1333
  %341 = phi ptr [ %340, %if.end1333 ], [ %window.i2882, %land.lhs.true1302 ], [ %340, %if.then1297 ]
  %_state.sroa.3231780.92955 = phi ptr [ %window.i2882, %if.end1333 ], [ %_state.sroa.3231780.0, %land.lhs.true1302 ], [ %_state.sroa.3231780.0, %if.then1297 ]
  store ptr %_state.sroa.3231780.92955, ptr %write, align 8, !tbaa !16
  %cmp.not.peel.i2840 = icmp ugt ptr %341, %_state.sroa.3231780.92955
  %spec.select3579 = select i1 %cmp.not.peel.i2840, ptr %339, ptr %_state.sroa.3231780.92955
  %sub.ptr.lhs.cast.peel.i2843 = ptrtoint ptr %spec.select3579 to i64
  %sub.ptr.rhs.cast.peel.i2844 = ptrtoint ptr %341 to i64
  %sub.ptr.sub.peel.i2845 = sub i64 %sub.ptr.lhs.cast.peel.i2843, %sub.ptr.rhs.cast.peel.i2844
...
again.i2870.sink.split:                           ; preds = %if.then.peel.i2855, %if.then21.i2873
  %.ph3752 = phi ptr [ %add.ptr.i2867, %if.then21.i2873 ], [ %add.ptr.peel.i2850, %if.then.peel.i2855 ]
  %.ph3753 = phi ptr [ %add.ptr13.i2868, %if.then21.i2873 ], [ %add.ptr13.peel.i2851, %if.then.peel.i2855 ]
  store ptr %window.i2882, ptr %write, align 8, !tbaa !16
  br label %again.i2870.preheader

again.i2870.preheader:                            ; preds = %if.then.peel.i2855, %again.i2870.sink.split
  %.ph3830 = phi ptr [ %.ph3752, %again.i2870.sink.split ], [ %add.ptr.peel.i2850, %if.then.peel.i2855 ]
  %.ph3831 = phi ptr [ %.ph3753, %again.i2870.sink.split ], [ %add.ptr13.peel.i2851, %if.then.peel.i2855 ]
  %.ph3832 = phi ptr [ %window.i2882, %again.i2870.sink.split ], [ %346, %if.then.peel.i2855 ]
  br label %again.i2870

again.i2870:                                      ; preds = %again.i2870.preheader, %if.then.i2872
  %347 = phi ptr [ %add.ptr.i2867, %if.then.i2872 ], [ %.ph3830, %again.i2870.preheader ]
  %348 = phi ptr [ %add.ptr13.i2868, %if.then.i2872 ], [ %.ph3831, %again.i2870.preheader ]
  %349 = phi ptr [ %353, %if.then.i2872 ], [ %.ph3832, %again.i2870.preheader ]
...
inflate_flush.exit2876:                           ; preds = %again.i2870, %if.then1337
  ...
  %.pre3413 = ptrtoint ptr %add.ptr13.lcssa.i2875 to i64
  ...
  %.pre3414 = ptrtoint ptr %354 to i64
  %sub.ptr.lhs.cast1391.pre-phi = select i1 %cmp1344, i64 %.pre3414, i64 %sub.ptr.lhs.cast1356
  %sub.ptr.lhs.cast1384.pre-phi = select i1 %cmp1344, i64 %sub.ptr.lhs.cast1349, i64 %.pre3413
  ...
  %or.cond3247 = select i1 %cmp1365, i1 true, i1 %cmp1371.not
  ...
  %_state.sroa.3231780.10 = select i1 %or.cond3247, ptr %355, ptr %window.i2882
  %_state.sroa.407.10.in = select i1 %or.cond3247, i64 %cond1360, i64 %cond1395
...
again.i2913.sink.split:                           ; preds = %if.then.peel.i2898, %if.then21.i2916
  %.ph3754 = phi ptr [ %add.ptr.i2910, %if.then21.i2916 ], [ %add.ptr.peel.i2893, %if.then.peel.i2898 ]
  %.ph3755 = phi ptr [ %add.ptr13.i2911, %if.then21.i2916 ], [ %add.ptr13.peel.i2894, %if.then.peel.i2898 ]
  store ptr %window.i2882, ptr %write, align 8, !tbaa !16
  br label %again.i2913.preheader

again.i2913.preheader:                            ; preds = %if.then.peel.i2898, %again.i2913.sink.split
  %.ph3833 = phi ptr [ %.ph3754, %again.i2913.sink.split ], [ %add.ptr.peel.i2893, %if.then.peel.i2898 ]
  %.ph3834 = phi ptr [ %.ph3755, %again.i2913.sink.split ], [ %add.ptr13.peel.i2894, %if.then.peel.i2898 ]
  %.ph3835 = phi ptr [ %window.i2882, %again.i2913.sink.split ], [ %364, %if.then.peel.i2898 ]
  br label %again.i2913

again.i2913:                                      ; preds = %again.i2913.preheader, %if.then.i2915
  %365 = phi ptr [ %add.ptr.i2910, %if.then.i2915 ], [ %.ph3833, %again.i2913.preheader ]
  %366 = phi ptr [ %add.ptr13.i2911, %if.then.i2915 ], [ %.ph3834, %again.i2913.preheader ]
  %367 = phi ptr [ %371, %if.then.i2915 ], [ %.ph3835, %again.i2913.preheader ]
