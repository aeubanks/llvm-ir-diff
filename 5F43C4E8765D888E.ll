...
for.end.i337:                                     ; preds = %for.body6.i336
  ...
  %shift535 = shufflevector <2 x double> %185, <2 x double> poison, <2 x i32> <i32 1, i32 poison>
...
for.body224.i:                                    ; preds = %for.body224.i, %for.end.i337
  ...
  %shift536 = shufflevector <2 x double> %217, <2 x double> poison, <2 x i32> <i32 1, i32 poison>
...
for.end336.i:                                     ; preds = %for.body224.i
  ...
  %shift537 = shufflevector <2 x double> %249, <2 x double> poison, <2 x i32> <i32 1, i32 poison>
