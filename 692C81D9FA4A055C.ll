; ModuleID = '/usr/local/google/home/aeubanks/repos/test-suite/SingleSource/Regression/C/gcc-c-torture/execute/pta-field-1.c'
source_filename = "/usr/local/google/home/aeubanks/repos/test-suite/SingleSource/Regression/C/gcc-c-torture/execute/pta-field-1.c"
...
entry:
  %q = getelementptr inbounds %struct.Foo, ptr %x, i64 0, i32 1
...
entry:
  ...
  store ptr %i, ptr %f, align 8, !tbaa !12
  %q = getelementptr inbounds %struct.Foo, ptr %f, i64 0, i32 1
  store ptr %j, ptr %q, align 8, !tbaa !5
  call void @bar(ptr noundef nonnull %f)
  %0 = load i32, ptr %j, align 4, !tbaa !10
...
entry:
  ...
  store i32 2, ptr %j.i, align 4, !tbaa !10
  store ptr %i.i, ptr %f.i, align 8, !tbaa !12
  %q.i = getelementptr inbounds %struct.Foo, ptr %f.i, i64 0, i32 1
  store ptr %j.i, ptr %q.i, align 8, !tbaa !5
  call void @bar(ptr noundef nonnull %f.i)
  %0 = load i32, ptr %j.i, align 4, !tbaa !10
