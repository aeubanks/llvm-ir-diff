...
define dso_local i32 @main() local_unnamed_addr #0 {
  ...
  %10 = load double, ptr @A6, align 8, !tbaa !5
  %11 = load double, ptr @A5, align 8, !tbaa !5
  %12 = fneg double %11
  %13 = load double, ptr @A4, align 8, !tbaa !5
  %14 = load double, ptr @A3, align 8, !tbaa !5
  %15 = fneg double %14
  %16 = load double, ptr @A2, align 8, !tbaa !5
  %17 = load double, ptr @A1, align 8, !tbaa !5
  br label %18
...
34:                                               ; preds = %18
  ...
  %44 = load double, ptr @two, align 8, !tbaa !5
