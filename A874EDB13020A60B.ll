...
entry:
  ...
  %2 = load i8, ptr %r, align 2, !tbaa !5
  %conv.i38 = zext i8 %2 to i32
  %add.i39 = add nuw nsw i32 %conv.i38, 1
  %mul.i41 = mul nuw nsw i32 %add.i39, %conv
  %shr.i42 = lshr i32 %mul.i41, 8
  %r5 = getelementptr inbounds %struct.S, ptr %y, i64 0, i32 2
  %3 = load i8, ptr %r5, align 2, !tbaa !5
  %conv.i44 = zext i8 %3 to i32
