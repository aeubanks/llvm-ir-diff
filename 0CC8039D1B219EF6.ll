...
"for op_pmulhw_108.s0.x.x":                       ; preds = %"for op_pmulhw_108.s0.x.x", %"for op_pmulhw_108.s0.x.x.preheader"
  ...
  %10 = shufflevector <12 x i16> %7, <12 x i16> undef, <8 x i32> <i32 8, i32 9, i32 10, i32 11, i32 undef, i32 undef, i32 undef, i32 undef>
  ...
  %31 = shufflevector <12 x i16> %28, <12 x i16> undef, <8 x i32> <i32 8, i32 9, i32 10, i32 11, i32 undef, i32 undef, i32 undef, i32 undef>
