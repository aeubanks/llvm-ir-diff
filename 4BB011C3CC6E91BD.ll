...
_ZN20btAlignedObjectArrayIP17btActionInterfaceE5clearEv.exit: ; preds = %entry, %if.then3.i.i
  ...
  %m_size.i4.i = getelementptr inbounds %class.btAlignedObjectArray.16, ptr %this, i64 0, i32 2
  store i32 0, ptr %m_size.i4.i, align 4, !tbaa !50
...
_ZN20btAlignedObjectArrayIP11btRigidBodyE5clearEv.exit: ; preds = %entry, %if.then3.i.i
  ...
  store i32 0, ptr %m_size.i4.i, align 4, !tbaa !44
...
_ZN20btAlignedObjectArrayIP17btActionInterfaceED2Ev.exit: ; preds = %if.then3.i.i.i, %if.end11
  ...
  %m_size.i4.i.i = getelementptr inbounds %class.btDiscreteDynamicsWorld, ptr %this, i64 0, i32 12, i32 2
  store i32 0, ptr %m_size.i4.i.i, align 4, !tbaa !50
...
_ZN20btAlignedObjectArrayIP11btRigidBodyED2Ev.exit: ; preds = %if.then3.i.i.i33, %_ZN20btAlignedObjectArrayIP17btActionInterfaceED2Ev.exit
  ...
  %m_size.i4.i.i34 = getelementptr inbounds %class.btDiscreteDynamicsWorld, ptr %this, i64 0, i32 5, i32 2
  store i32 0, ptr %m_size.i4.i.i34, align 4, !tbaa !44
...
_ZN20btAlignedObjectArrayIP17btTypedConstraintED2Ev.exit: ; preds = %if.then3.i.i.i42, %_ZN20btAlignedObjectArrayIP11btRigidBodyED2Ev.exit
  ...
  %m_size.i4.i.i43 = getelementptr inbounds %class.btDiscreteDynamicsWorld, ptr %this, i64 0, i32 4, i32 2
  store i32 0, ptr %m_size.i4.i.i43, align 4, !tbaa !40
...
for.body:                                         ; preds = %if.then109, %if.end148
  %i.01155 = phi i32 [ 0, %if.then109 ], [ %inc, %if.end148 ]
  %conv117 = sitofp i32 %i.01155 to float
...
sw.bb237:                                         ; preds = %entry
  ...
  %fneg.i1262 = fneg float %474
  %fneg4.i1264 = fneg float %475
  %fneg8.i1266 = fneg float %476
  %sub.i = fsub float %fneg.i1262, %489
  %sub8.i = fsub float %fneg4.i1264, %490
  %sub14.i = fsub float %fneg8.i1266, %491
  ...
  %sub.i1433 = fsub float %fneg.i1262, %566
  %sub8.i1436 = fsub float %fneg4.i1264, %567
  %sub14.i1439 = fsub float %fneg8.i1266, %568
...
sw.bb367:                                         ; preds = %entry
  ...
  %fneg.i1624 = fneg float %648
  %fneg4.i1626 = fneg float %650
  %fneg8.i1628 = fneg float %652
  %sub.i1634 = fsub float %fneg.i1624, %649
  %sub8.i1637 = fsub float %fneg4.i1626, %651
  %sub14.i1640 = fsub float %fneg8.i1628, %653
...
if.end538:                                        ; preds = %_ZN17DebugDrawcallbackD2Ev.exit1902, %if.end
  %856 = phi i32 [ %.pr, %_ZN17DebugDrawcallbackD2Ev.exit1902 ], [ %847, %if.end ]
...
invoke.cont15:                                    ; preds = %invoke.cont12
  ...
  %m_solverInfo.i47 = getelementptr inbounds %class.btDynamicsWorld, ptr %this, i64 0, i32 5
  %vtable21 = load ptr, ptr %this, align 8, !tbaa !19
  %vfn22 = getelementptr inbounds ptr, ptr %vtable21, i64 33
  %6 = load ptr, ptr %vfn22, align 8
  invoke void %6(ptr noundef nonnull align 8 dereferenceable(372) %this, ptr noundef nonnull align 4 dereferenceable(68) %m_solverInfo.i47)
...
invoke.cont6:                                     ; preds = %if.then13.i, %if.else.i.invoke.cont6thread-pre-split_crit_edge, %if.then, %if.then
  %17 = phi i32 [ %3, %if.then ], [ %3, %if.then ], [ %.pr.pre, %if.else.i.invoke.cont6thread-pre-split_crit_edge ], [ %3, %if.then13.i ]
  %cmp.i = icmp eq i32 %17, 4
  br i1 %cmp.i, label %if.end46, label %if.end.i66

if.end.i66:                                       ; preds = %invoke.cont6
  %18 = load i8, ptr @gDisableDeactivation, align 1, !tbaa !181, !range !56, !noundef !57
  %tobool.i = icmp ne i8 %18, 0
  %19 = load float, ptr @gDeactivationTime, align 4
  %cmp2.i = fcmp oeq float %19, 0.000000e+00
...
if.end11.i:                                       ; preds = %if.end4.i
  ...
  %21 = load float, ptr %m_deactivationTime.i67, align 8, !tbaa !190
  %cmp12.i68 = fcmp ogt float %21, %19
...
if.then9:                                         ; preds = %if.end4.i, %if.end11.i
  ...
  %22 = load i32, ptr %m_collisionFlags.i, align 8, !tbaa !66
  %and.i = and i32 %22, 3
...
if.end:                                           ; preds = %if.then17.if.end_crit_edge, %if.else
  %24 = phi i32 [ %.pre, %if.then17.if.end_crit_edge ], [ %17, %if.else ]
...
if.then42.invoke:                                 ; preds = %if.then9, %if.end11.i, %if.end.i66
  %25 = phi i32 [ 1, %if.end.i66 ], [ 1, %if.end11.i ], [ 2, %if.then9 ]
  invoke void @_ZN17btCollisionObject18setActivationStateEi(ptr noundef nonnull align 8 dereferenceable(280) %2, i32 noundef %25)
          to label %if.end46 unwind label %lpad3

if.end46:                                         ; preds = %if.then42.invoke, %invoke.cont6, %if.end, %if.then22, %for.body
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %26 = load i32, ptr %m_size.i, align 4, !tbaa !44
...
entry:
  ...
  br i1 %or.cond, label %if.then.i.i.i, label %_ZN20btAlignedObjectArrayIP17btTypedConstraintE6resizeEiRKS1_.exit
...
for.body10.lr.ph.i:                               ; preds = %if.then.i.i.i
  ...
  %1 = icmp ult i32 %0, 4
  br i1 %1, label %_ZN20btAlignedObjectArrayIP17btTypedConstraintE6resizeEiRKS1_.exit.loopexit.unr-lcssa, label %for.body10.lr.ph.i.new
...
_ZN20btAlignedObjectArrayIP17btTypedConstraintE6resizeEiRKS1_.exit.loopexit.unr-lcssa: ; preds = %for.body10.i, %for.body10.lr.ph.i
...
invoke.cont18:                                    ; preds = %invoke.cont14
  ...
  %cond = select i1 %tobool.not, ptr null, ptr %15
  ...
  store ptr %cond, ptr %m_sortedConstraints.i, align 8, !tbaa !201
...
if.then:                                          ; preds = %land.lhs.true26
  ...
  %11 = load i32, ptr %m_activationState1.i.i, align 4
...
lor.lhs.false:                                    ; preds = %if.then, %if.then
  ...
  %12 = load i32, ptr %m_activationState1.i.i70, align 4
...
if.then33:                                        ; preds = %lor.lhs.false, %if.then
  ...
  %m_islandTag1.i74 = getelementptr inbounds %class.btCollisionObject, ptr %8, i64 0, i32 12
  %14 = load i32, ptr %m_islandTag1.i74, align 4, !tbaa !206
...
_ZN11btUnionFind4findEi.exit26.i:                 ; preds = %while.body.i24.i, %_ZN11btUnionFind4findEi.exit.i
  ...
  %cmp.i75 = icmp eq i32 %x.addr.0.lcssa.i.i, %x.addr.0.lcssa.i25.i
  br i1 %cmp.i75, label %if.end43, label %if.end.i
...
invoke.cont21:                                    ; preds = %if.then
  ...
  %7 = load float, ptr %m_origin.i125, align 4, !tbaa !5
...
_ZN13btSphereShapeC2Ef.exit:                      ; preds = %invoke.cont51
  ...
  %m_worldTransform.i132 = getelementptr inbounds %class.btCollisionObject, ptr %3, i64 0, i32 1
  invoke void @_ZNK16btCollisionWorld15convexSweepTestEPK13btConvexShapeRK11btTransformS5_RNS_20ConvexResultCallbackEf(ptr noundef nonnull align 8 dereferenceable(129) %this, ptr noundef nonnull %tmpSphere, ptr noundef nonnull align 4 dereferenceable(64) %m_worldTransform.i132, ptr noundef nonnull align 4 dereferenceable(64) %predictedTrans, ptr noundef nonnull align 8 dereferenceable(16) %sweepResults, float noundef 0.000000e+00)
...
if.end92:                                         ; preds = %if.end87, %invoke.cont21
...
cond.false.i:                                     ; preds = %for.body
  ...
  %cond.in.phi.trans.insert.i = getelementptr inbounds %class.btCollisionObject, ptr %12, i64 0, i32 12
  %cond.pre.i = load i32, ptr %cond.in.phi.trans.insert.i, align 4, !tbaa !206
...
_Z23btGetConstraintIslandIdPK17btTypedConstraint.exit: ; preds = %for.body, %cond.false.i
  %cond.i = phi i32 [ %cond.pre.i, %cond.false.i ], [ %11, %for.body ]
...
for.end:                                          ; preds = %for.cond.preheader, %for.end.split.loop.exit
  %i.0.lcssa = phi i32 [ %13, %for.end.split.loop.exit ], [ 0, %for.cond.preheader ]
...
for.body18.lr.ph:                                 ; preds = %for.end
  ...
  %14 = load ptr, ptr %m_sortedConstraints19, align 8, !tbaa !201
  %15 = zext i32 %i.0.lcssa to i64
  %16 = sub i32 %0, %i.0.lcssa
  %.neg = add i32 %i.0.lcssa, 1
  %xtraiter = and i32 %16, 1
  %17 = icmp eq i32 %0, %.neg
  br i1 %17, label %for.end29.loopexit.unr-lcssa, label %for.body18.lr.ph.new

for.body18.lr.ph.new:                             ; preds = %for.body18.lr.ph
  %unroll_iter = and i32 %16, -2
  br label %for.body18

for.body18:                                       ; preds = %_Z23btGetConstraintIslandIdPK17btTypedConstraint.exit67.1, %for.body18.lr.ph.new
  %indvars.iv84 = phi i64 [ %15, %for.body18.lr.ph.new ], [ %indvars.iv.next85.1, %_Z23btGetConstraintIslandIdPK17btTypedConstraint.exit67.1 ]
  %numCurConstraints.078 = phi i32 [ 0, %for.body18.lr.ph.new ], [ %spec.select.1, %_Z23btGetConstraintIslandIdPK17btTypedConstraint.exit67.1 ]
  %niter = phi i32 [ 0, %for.body18.lr.ph.new ], [ %niter.next.1, %_Z23btGetConstraintIslandIdPK17btTypedConstraint.exit67.1 ]
  %arrayidx21 = getelementptr inbounds ptr, ptr %14, i64 %indvars.iv84
  %18 = load ptr, ptr %arrayidx21, align 8, !tbaa !60
  %m_rbA.i.i59 = getelementptr inbounds %class.btTypedConstraint, ptr %18, i64 0, i32 5
  %19 = load ptr, ptr %m_rbA.i.i59, align 8, !tbaa !82
  %m_islandTag1.i.i60 = getelementptr inbounds %class.btCollisionObject, ptr %19, i64 0, i32 12
  %20 = load i32, ptr %m_islandTag1.i.i60, align 4, !tbaa !206
  %cmp.i61 = icmp sgt i32 %20, -1
  br i1 %cmp.i61, label %_Z23btGetConstraintIslandIdPK17btTypedConstraint.exit67, label %cond.false.i65

cond.false.i65:                                   ; preds = %for.body18
  %m_rbB.i.i62 = getelementptr inbounds %class.btTypedConstraint, ptr %18, i64 0, i32 6
  %21 = load ptr, ptr %m_rbB.i.i62, align 8, !tbaa !83
  %cond.in.phi.trans.insert.i63 = getelementptr inbounds %class.btCollisionObject, ptr %21, i64 0, i32 12
  %cond.pre.i64 = load i32, ptr %cond.in.phi.trans.insert.i63, align 4, !tbaa !206
  br label %_Z23btGetConstraintIslandIdPK17btTypedConstraint.exit67

_Z23btGetConstraintIslandIdPK17btTypedConstraint.exit67: ; preds = %for.body18, %cond.false.i65
  %cond.i66 = phi i32 [ %cond.pre.i64, %cond.false.i65 ], [ %20, %for.body18 ]
  %cmp23 = icmp eq i32 %cond.i66, %islandId
  %inc25 = zext i1 %cmp23 to i32
  %spec.select = add nuw nsw i32 %numCurConstraints.078, %inc25
  %indvars.iv.next85 = add nuw nsw i64 %indvars.iv84, 1
  %arrayidx21.1 = getelementptr inbounds ptr, ptr %14, i64 %indvars.iv.next85
  %22 = load ptr, ptr %arrayidx21.1, align 8, !tbaa !60
  %m_rbA.i.i59.1 = getelementptr inbounds %class.btTypedConstraint, ptr %22, i64 0, i32 5
  %23 = load ptr, ptr %m_rbA.i.i59.1, align 8, !tbaa !82
  %m_islandTag1.i.i60.1 = getelementptr inbounds %class.btCollisionObject, ptr %23, i64 0, i32 12
  %24 = load i32, ptr %m_islandTag1.i.i60.1, align 4, !tbaa !206
  %cmp.i61.1 = icmp sgt i32 %24, -1
  br i1 %cmp.i61.1, label %_Z23btGetConstraintIslandIdPK17btTypedConstraint.exit67.1, label %cond.false.i65.1

cond.false.i65.1:                                 ; preds = %_Z23btGetConstraintIslandIdPK17btTypedConstraint.exit67
  %m_rbB.i.i62.1 = getelementptr inbounds %class.btTypedConstraint, ptr %22, i64 0, i32 6
  %25 = load ptr, ptr %m_rbB.i.i62.1, align 8, !tbaa !83
  %cond.in.phi.trans.insert.i63.1 = getelementptr inbounds %class.btCollisionObject, ptr %25, i64 0, i32 12
  %cond.pre.i64.1 = load i32, ptr %cond.in.phi.trans.insert.i63.1, align 4, !tbaa !206
  br label %_Z23btGetConstraintIslandIdPK17btTypedConstraint.exit67.1

_Z23btGetConstraintIslandIdPK17btTypedConstraint.exit67.1: ; preds = %cond.false.i65.1, %_Z23btGetConstraintIslandIdPK17btTypedConstraint.exit67
  %cond.i66.1 = phi i32 [ %cond.pre.i64.1, %cond.false.i65.1 ], [ %24, %_Z23btGetConstraintIslandIdPK17btTypedConstraint.exit67 ]
  %cmp23.1 = icmp eq i32 %cond.i66.1, %islandId
...
for.end29.loopexit.unr-lcssa:                     ; preds = %_Z23btGetConstraintIslandIdPK17btTypedConstraint.exit67.1, %for.body18.lr.ph
  %spec.select.lcssa.ph = phi i32 [ undef, %for.body18.lr.ph ], [ %spec.select.1, %_Z23btGetConstraintIslandIdPK17btTypedConstraint.exit67.1 ]
  %indvars.iv84.unr = phi i64 [ %15, %for.body18.lr.ph ], [ %indvars.iv.next85.1, %_Z23btGetConstraintIslandIdPK17btTypedConstraint.exit67.1 ]
  %numCurConstraints.078.unr = phi i32 [ 0, %for.body18.lr.ph ], [ %spec.select.1, %_Z23btGetConstraintIslandIdPK17btTypedConstraint.exit67.1 ]
  %lcmp.mod.not = icmp eq i32 %xtraiter, 0
  br i1 %lcmp.mod.not, label %for.end29, label %for.body18.epil

for.body18.epil:                                  ; preds = %for.end29.loopexit.unr-lcssa
  %arrayidx21.epil = getelementptr inbounds ptr, ptr %14, i64 %indvars.iv84.unr
  %26 = load ptr, ptr %arrayidx21.epil, align 8, !tbaa !60
  %m_rbA.i.i59.epil = getelementptr inbounds %class.btTypedConstraint, ptr %26, i64 0, i32 5
  %27 = load ptr, ptr %m_rbA.i.i59.epil, align 8, !tbaa !82
  %m_islandTag1.i.i60.epil = getelementptr inbounds %class.btCollisionObject, ptr %27, i64 0, i32 12
  %28 = load i32, ptr %m_islandTag1.i.i60.epil, align 4, !tbaa !206
  %cmp.i61.epil = icmp sgt i32 %28, -1
  br i1 %cmp.i61.epil, label %_Z23btGetConstraintIslandIdPK17btTypedConstraint.exit67.epil, label %cond.false.i65.epil

cond.false.i65.epil:                              ; preds = %for.body18.epil
  %m_rbB.i.i62.epil = getelementptr inbounds %class.btTypedConstraint, ptr %26, i64 0, i32 6
  %29 = load ptr, ptr %m_rbB.i.i62.epil, align 8, !tbaa !83
  %cond.in.phi.trans.insert.i63.epil = getelementptr inbounds %class.btCollisionObject, ptr %29, i64 0, i32 12
  %cond.pre.i64.epil = load i32, ptr %cond.in.phi.trans.insert.i63.epil, align 4, !tbaa !206
  br label %_Z23btGetConstraintIslandIdPK17btTypedConstraint.exit67.epil

_Z23btGetConstraintIslandIdPK17btTypedConstraint.exit67.epil: ; preds = %cond.false.i65.epil, %for.body18.epil
  %cond.i66.epil = phi i32 [ %cond.pre.i64.epil, %cond.false.i65.epil ], [ %28, %for.body18.epil ]
  %cmp23.epil = icmp eq i32 %cond.i66.epil, %islandId
  %inc25.epil = zext i1 %cmp23.epil to i32
  %spec.select.epil = add nuw nsw i32 %numCurConstraints.078.unr, %inc25.epil
  br label %for.end29

for.end29:                                        ; preds = %for.inc, %_Z23btGetConstraintIslandIdPK17btTypedConstraint.exit67.epil, %for.end29.loopexit.unr-lcssa, %for.end
  %startConstraint.090 = phi ptr [ %startConstraint.0, %for.end ], [ %startConstraint.0, %for.end29.loopexit.unr-lcssa ], [ %startConstraint.0, %_Z23btGetConstraintIslandIdPK17btTypedConstraint.exit67.epil ], [ null, %for.inc ]
  %numCurConstraints.0.lcssa = phi i32 [ 0, %for.end ], [ %spec.select.lcssa.ph, %for.end29.loopexit.unr-lcssa ], [ %spec.select.epil, %_Z23btGetConstraintIslandIdPK17btTypedConstraint.exit67.epil ], [ 0, %for.inc ]
...
if.then32:                                        ; preds = %for.end29
  ...
  %30 = load ptr, ptr %m_solver33, align 8, !tbaa !198
  %m_solverInfo34 = getelementptr inbounds %struct.InplaceSolverIslandCallback, ptr %this, i64 0, i32 1
  %31 = load ptr, ptr %m_solverInfo34, align 8, !tbaa !233
  %m_debugDrawer35 = getelementptr inbounds %struct.InplaceSolverIslandCallback, ptr %this, i64 0, i32 5
  %32 = load ptr, ptr %m_debugDrawer35, align 8, !tbaa !203
  %m_stackAlloc36 = getelementptr inbounds %struct.InplaceSolverIslandCallback, ptr %this, i64 0, i32 6
  %33 = load ptr, ptr %m_stackAlloc36, align 8, !tbaa !204
  %m_dispatcher37 = getelementptr inbounds %struct.InplaceSolverIslandCallback, ptr %this, i64 0, i32 7
  %34 = load ptr, ptr %m_dispatcher37, align 8, !tbaa !205
  %vtable38 = load ptr, ptr %30, align 8, !tbaa !19
  %vfn39 = getelementptr inbounds ptr, ptr %vtable38, i64 3
  %35 = load ptr, ptr %vfn39, align 8
  %call40 = tail call noundef float %35(ptr noundef nonnull align 8 dereferenceable(8) %30, ptr noundef %bodies, i32 noundef %numBodies, ptr noundef %manifolds, i32 noundef %numManifolds, ptr noundef %startConstraint.090, i32 noundef %numCurConstraints.0.lcssa, ptr noundef nonnull align 4 dereferenceable(68) %31, ptr noundef %32, ptr noundef %33, ptr noundef %34)
  br label %if.end42
...
while.cond.us:                                    ; preds = %while.cond.us.preheader, %_ZN33btSortConstraintOnIslandPredicateclEPK17btTypedConstraintS2_.exit.us
  %indvars.iv82 = phi i64 [ %5, %while.cond.us.preheader ], [ %indvars.iv.next83, %_ZN33btSortConstraintOnIslandPredicateclEPK17btTypedConstraintS2_.exit.us ]
  %arrayidx4.us = getelementptr inbounds ptr, ptr %2, i64 %indvars.iv82
  ...
  br i1 %cmp.i5.i.us, label %_ZN33btSortConstraintOnIslandPredicateclEPK17btTypedConstraintS2_.exit.us, label %cond.false.i9.i.us

cond.false.i9.i.us:                               ; preds = %while.cond.us
  ...
  %cond.in.phi.trans.insert.i7.i.us = getelementptr inbounds %class.btCollisionObject, ptr %9, i64 0, i32 12
  %cond.pre.i8.i.us = load i32, ptr %cond.in.phi.trans.insert.i7.i.us, align 4, !tbaa !206
  br label %_ZN33btSortConstraintOnIslandPredicateclEPK17btTypedConstraintS2_.exit.us

_ZN33btSortConstraintOnIslandPredicateclEPK17btTypedConstraintS2_.exit.us: ; preds = %cond.false.i9.i.us, %while.cond.us
  %cond.i10.i.us = phi i32 [ %cond.pre.i8.i.us, %cond.false.i9.i.us ], [ %8, %while.cond.us ]
  %cmp.i.us = icmp slt i32 %cond.i10.i.us, %4
...
do.body.split:                                    ; preds = %do.body
  %10 = load ptr, ptr %m_rbB.i.i.i, align 8, !tbaa !83
  %cond.in.phi.trans.insert.i.i = getelementptr inbounds %class.btCollisionObject, ptr %10, i64 0, i32 12
  %cond.pre.i.i = load i32, ptr %cond.in.phi.trans.insert.i.i, align 4, !tbaa !206
...
while.cond:                                       ; preds = %_ZN33btSortConstraintOnIslandPredicateclEPK17btTypedConstraintS2_.exit, %do.body.split
  %indvars.iv = phi i64 [ %indvars.iv.next, %_ZN33btSortConstraintOnIslandPredicateclEPK17btTypedConstraintS2_.exit ], [ %11, %do.body.split ]
  %arrayidx4 = getelementptr inbounds ptr, ptr %2, i64 %indvars.iv
  %12 = load ptr, ptr %arrayidx4, align 8, !tbaa !60
  %m_rbA.i.i3.i = getelementptr inbounds %class.btTypedConstraint, ptr %12, i64 0, i32 5
  %13 = load ptr, ptr %m_rbA.i.i3.i, align 8, !tbaa !82
  %m_islandTag1.i.i4.i = getelementptr inbounds %class.btCollisionObject, ptr %13, i64 0, i32 12
  %14 = load i32, ptr %m_islandTag1.i.i4.i, align 4, !tbaa !206
  %cmp.i5.i = icmp sgt i32 %14, -1
  br i1 %cmp.i5.i, label %_ZN33btSortConstraintOnIslandPredicateclEPK17btTypedConstraintS2_.exit, label %cond.false.i9.i

cond.false.i9.i:                                  ; preds = %while.cond
  %m_rbB.i.i6.i = getelementptr inbounds %class.btTypedConstraint, ptr %12, i64 0, i32 6
  %15 = load ptr, ptr %m_rbB.i.i6.i, align 8, !tbaa !83
  %cond.in.phi.trans.insert.i7.i = getelementptr inbounds %class.btCollisionObject, ptr %15, i64 0, i32 12
  %cond.pre.i8.i = load i32, ptr %cond.in.phi.trans.insert.i7.i, align 4, !tbaa !206
  br label %_ZN33btSortConstraintOnIslandPredicateclEPK17btTypedConstraintS2_.exit

_ZN33btSortConstraintOnIslandPredicateclEPK17btTypedConstraintS2_.exit: ; preds = %while.cond, %cond.false.i9.i
  %cond.i10.i = phi i32 [ %cond.pre.i8.i, %cond.false.i9.i ], [ %14, %while.cond ]
  %cmp.i = icmp slt i32 %cond.i10.i, %cond.pre.i.i
...
while.cond5.preheader:                            ; preds = %_ZN33btSortConstraintOnIslandPredicateclEPK17btTypedConstraintS2_.exit, %_ZN33btSortConstraintOnIslandPredicateclEPK17btTypedConstraintS2_.exit.us
  %.us-phi = phi i64 [ %indvars.iv82, %_ZN33btSortConstraintOnIslandPredicateclEPK17btTypedConstraintS2_.exit.us ], [ %indvars.iv, %_ZN33btSortConstraintOnIslandPredicateclEPK17btTypedConstraintS2_.exit ]
  %.us-phi69 = phi ptr [ %6, %_ZN33btSortConstraintOnIslandPredicateclEPK17btTypedConstraintS2_.exit.us ], [ %12, %_ZN33btSortConstraintOnIslandPredicateclEPK17btTypedConstraintS2_.exit ]
  %.us-phi67 = trunc i64 %.us-phi to i32
  %arrayidx4.le = getelementptr inbounds ptr, ptr %2, i64 %.us-phi
  br i1 %cmp.i.i, label %while.cond5.us.preheader, label %while.cond5.preheader.split72

while.cond5.us.preheader:                         ; preds = %while.cond5.preheader
  %16 = sext i32 %j.0 to i64
  br label %while.cond5.us

while.cond5.us:                                   ; preds = %while.cond5.us.preheader, %_Z23btGetConstraintIslandIdPK17btTypedConstraint.exit.i54.us
  %indvars.iv88 = phi i64 [ %16, %while.cond5.us.preheader ], [ %indvars.iv.next89, %_Z23btGetConstraintIslandIdPK17btTypedConstraint.exit.i54.us ]
  %arrayidx8.us = getelementptr inbounds ptr, ptr %2, i64 %indvars.iv88
  %17 = load ptr, ptr %arrayidx8.us, align 8, !tbaa !60
  %m_rbA.i.i.i43.us = getelementptr inbounds %class.btTypedConstraint, ptr %17, i64 0, i32 5
  %18 = load ptr, ptr %m_rbA.i.i.i43.us, align 8, !tbaa !82
  %m_islandTag1.i.i.i44.us = getelementptr inbounds %class.btCollisionObject, ptr %18, i64 0, i32 12
  %19 = load i32, ptr %m_islandTag1.i.i.i44.us, align 4, !tbaa !206
  %cmp.i.i45.us = icmp sgt i32 %19, -1
  br i1 %cmp.i.i45.us, label %_Z23btGetConstraintIslandIdPK17btTypedConstraint.exit.i54.us, label %cond.false.i.i49.us

cond.false.i.i49.us:                              ; preds = %while.cond5.us
  %m_rbB.i.i.i46.us = getelementptr inbounds %class.btTypedConstraint, ptr %17, i64 0, i32 6
  %20 = load ptr, ptr %m_rbB.i.i.i46.us, align 8, !tbaa !83
  %cond.in.phi.trans.insert.i.i47.us = getelementptr inbounds %class.btCollisionObject, ptr %20, i64 0, i32 12
  %cond.pre.i.i48.us = load i32, ptr %cond.in.phi.trans.insert.i.i47.us, align 4, !tbaa !206
  br label %_Z23btGetConstraintIslandIdPK17btTypedConstraint.exit.i54.us

_Z23btGetConstraintIslandIdPK17btTypedConstraint.exit.i54.us: ; preds = %cond.false.i.i49.us, %while.cond5.us
  %cond.i.i50.us = phi i32 [ %cond.pre.i.i48.us, %cond.false.i.i49.us ], [ %19, %while.cond5.us ]
  %cmp.i60.us = icmp slt i32 %4, %cond.i.i50.us
  %indvars.iv.next89 = add i64 %indvars.iv88, -1
  br i1 %cmp.i60.us, label %while.cond5.us, label %while.end11

while.cond5.preheader.split72:                    ; preds = %while.cond5.preheader
  %21 = load ptr, ptr %m_rbB.i.i.i, align 8, !tbaa !83
  %cond.in.phi.trans.insert.i7.i56 = getelementptr inbounds %class.btCollisionObject, ptr %21, i64 0, i32 12
  %cond.pre.i8.i57 = load i32, ptr %cond.in.phi.trans.insert.i7.i56, align 4, !tbaa !206
  %22 = sext i32 %j.0 to i64
  br label %while.cond5

while.cond5:                                      ; preds = %_Z23btGetConstraintIslandIdPK17btTypedConstraint.exit.i54, %while.cond5.preheader.split72
  %indvars.iv85 = phi i64 [ %indvars.iv.next86, %_Z23btGetConstraintIslandIdPK17btTypedConstraint.exit.i54 ], [ %22, %while.cond5.preheader.split72 ]
  %arrayidx8 = getelementptr inbounds ptr, ptr %2, i64 %indvars.iv85
  %23 = load ptr, ptr %arrayidx8, align 8, !tbaa !60
  %m_rbA.i.i.i43 = getelementptr inbounds %class.btTypedConstraint, ptr %23, i64 0, i32 5
  %24 = load ptr, ptr %m_rbA.i.i.i43, align 8, !tbaa !82
  %m_islandTag1.i.i.i44 = getelementptr inbounds %class.btCollisionObject, ptr %24, i64 0, i32 12
  %25 = load i32, ptr %m_islandTag1.i.i.i44, align 4, !tbaa !206
  %cmp.i.i45 = icmp sgt i32 %25, -1
  br i1 %cmp.i.i45, label %_Z23btGetConstraintIslandIdPK17btTypedConstraint.exit.i54, label %cond.false.i.i49

cond.false.i.i49:                                 ; preds = %while.cond5
  %m_rbB.i.i.i46 = getelementptr inbounds %class.btTypedConstraint, ptr %23, i64 0, i32 6
  %26 = load ptr, ptr %m_rbB.i.i.i46, align 8, !tbaa !83
  %cond.in.phi.trans.insert.i.i47 = getelementptr inbounds %class.btCollisionObject, ptr %26, i64 0, i32 12
  %cond.pre.i.i48 = load i32, ptr %cond.in.phi.trans.insert.i.i47, align 4, !tbaa !206
  br label %_Z23btGetConstraintIslandIdPK17btTypedConstraint.exit.i54

_Z23btGetConstraintIslandIdPK17btTypedConstraint.exit.i54: ; preds = %cond.false.i.i49, %while.cond5
  %cond.i.i50 = phi i32 [ %cond.pre.i.i48, %cond.false.i.i49 ], [ %25, %while.cond5 ]
  %cmp.i60 = icmp slt i32 %cond.pre.i8.i57, %cond.i.i50
  %indvars.iv.next86 = add i64 %indvars.iv85, -1
  br i1 %cmp.i60, label %while.cond5, label %while.end11

while.end11:                                      ; preds = %_Z23btGetConstraintIslandIdPK17btTypedConstraint.exit.i54, %_Z23btGetConstraintIslandIdPK17btTypedConstraint.exit.i54.us
  %.us-phi74 = phi i64 [ %indvars.iv88, %_Z23btGetConstraintIslandIdPK17btTypedConstraint.exit.i54.us ], [ %indvars.iv85, %_Z23btGetConstraintIslandIdPK17btTypedConstraint.exit.i54 ]
  %.us-phi75 = phi ptr [ %17, %_Z23btGetConstraintIslandIdPK17btTypedConstraint.exit.i54.us ], [ %23, %_Z23btGetConstraintIslandIdPK17btTypedConstraint.exit.i54 ]
  %.us-phi73 = trunc i64 %.us-phi74 to i32
  %cmp.not = icmp sgt i32 %.us-phi67, %.us-phi73
  br i1 %cmp.not, label %do.cond, label %if.then

if.then:                                          ; preds = %while.end11
  store ptr %.us-phi75, ptr %arrayidx4.le, align 8, !tbaa !60
  %27 = load ptr, ptr %m_data, align 8, !tbaa !39
  %arrayidx10.i = getelementptr inbounds ptr, ptr %27, i64 %.us-phi74
  store ptr %.us-phi69, ptr %arrayidx10.i, align 8, !tbaa !60
  %inc12 = add nsw i32 %.us-phi67, 1
  %dec13 = add nsw i32 %.us-phi73, -1
  br label %do.cond

do.cond:                                          ; preds = %while.end11, %if.then
  %j.2 = phi i32 [ %dec13, %if.then ], [ %.us-phi73, %while.end11 ]
