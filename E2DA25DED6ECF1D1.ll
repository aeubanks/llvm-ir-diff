...
for.body3:                                        ; preds = %for.body3, %for.cond1.preheader
  ...
  %.lhs.trunc.1 = trunc i64 %add.i.1 to i16
  %1 = urem i16 %.lhs.trunc.1, 120
...
for.body3.i:                                      ; preds = %for.body3.i, %for.cond1.preheader.i
  ...
  %.lhs.trunc.i.1 = trunc i64 %add.i.i.1 to i16
  %1 = urem i16 %.lhs.trunc.i.1, 120
...
for.body3.i37:                                    ; preds = %for.body3.i37, %for.cond1.preheader.i25
  ...
  %.lhs.trunc.i31.1 = trunc i64 %add.i.i29.1 to i16
  %3 = urem i16 %.lhs.trunc.i31.1, 120
