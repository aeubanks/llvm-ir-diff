...
define dso_local void @foo(ptr noalias nocapture writeonly sret(%struct.s) align 8 %0, ptr nocapture noundef byval(%struct.s) align 8 %1) local_unnamed_addr #0 {
  %3 = getelementptr inbounds %struct.s, ptr %1, i64 0, i32 1
  %4 = load i64, ptr %3, align 8, !tbaa !5
  %5 = add nsw i64 %4, 1
  store i64 %5, ptr %3, align 8, !tbaa !5
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %0, ptr noundef nonnull align 8 dereferenceable(24) %1, i64 24, i1 false), !tbaa.struct !11
  ret void
}
