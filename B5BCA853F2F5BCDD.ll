...
for.body:                                         ; preds = %for.body.lr.ph, %if.end74
  ...
  %errtokens.0214 = phi ptr [ %errs, %for.body.lr.ph ], [ %errtokens.1, %if.end74 ]
...
if.then18:                                        ; preds = %if.then16
  ...
  %.pre217 = load i32, ptr %fp2.0211, align 4, !tbaa !5
  br label %if.end

if.end:                                           ; preds = %if.then18, %if.then16
  %19 = phi i32 [ %.pre217, %if.then18 ], [ %8, %if.then16 ]
...
for.body.i:                                       ; preds = %for.inc.i.1, %for.body.lr.ph.i.new
  ...
  %niter225 = phi i64 [ 0, %for.body.lr.ph.i.new ], [ %niter225.next.1, %for.inc.i.1 ]
...
for.inc.i.1:                                      ; preds = %if.then14.i.1, %land.lhs.true.i.1, %for.inc.i
  ...
  %niter225.next.1 = add i64 %niter225, 2
  %niter225.ncmp.1 = icmp eq i64 %niter225.next.1, %unroll_iter224
  br i1 %niter225.ncmp.1, label %if.end74.loopexit.unr-lcssa, label %for.body.i, !llvm.loop !33
...
if.then69:                                        ; preds = %if.end63
  ...
  %incdec.ptr = getelementptr inbounds i16, ptr %errtokens.0214, i64 1
  store i16 %conv70, ptr %errtokens.0214, align 2, !tbaa !18
  br label %if.end74
...
if.end74.loopexit.unr-lcssa:                      ; preds = %for.inc.i.1, %for.body.lr.ph.i
  ...
  br i1 %lcmp.mod223.not, label %if.end74, label %for.body.i.epil
...
if.end74:                                         ; preds = %if.end74.loopexit.unr-lcssa, %if.then14.i.epil, %land.lhs.true.i.epil, %for.body.i.epil, %if.end54, %if.end63.thread205, %if.then.i, %if.end, %if.end63, %if.then69, %if.end28, %land.lhs.true, %for.body
  %errtokens.1 = phi ptr [ %errtokens.0214, %if.end28 ], [ %incdec.ptr, %if.then69 ], [ %errtokens.0214, %if.end63 ], [ %errtokens.0214, %land.lhs.true ], [ %errtokens.0214, %for.body ], [ %errtokens.0214, %if.end ], [ %errtokens.0214, %if.then.i ], [ %errtokens.0214, %if.end63.thread205 ], [ %errtokens.0214, %if.end54 ], [ %errtokens.0214, %for.body.i.epil ], [ %errtokens.0214, %land.lhs.true.i.epil ], [ %errtokens.0214, %if.then14.i.epil ], [ %errtokens.0214, %if.end74.loopexit.unr-lcssa ]
