...
entry:
  ...
  tail call void @lua_createtable(ptr noundef %L, i32 noundef 0, i32 noundef 4) #6
...
setpath.exit:                                     ; preds = %if.then.i, %if.else.i
  ...
  br i1 %cmp.i28, label %if.then.i29, label %if.else.i32

if.then.i29:                                      ; preds = %setpath.exit
  tail call void @lua_pushstring(ptr noundef %L, ptr noundef nonnull @.str.9) #6
  br label %setpath.exit33

if.else.i32:                                      ; preds = %setpath.exit
...
setpath.exit33:                                   ; preds = %if.then.i29, %if.else.i32
...
if.else.i:                                        ; preds = %entry
  ...
  store ptr null, ptr %call3.i, align 8, !tbaa !5
...
ll_register.exit:                                 ; preds = %if.then.i, %if.else.i
  ...
  %0 = load ptr, ptr %plib.0.i, align 8, !tbaa !5
...
if.end.thread:                                    ; preds = %ll_register.exit
  store ptr null, ptr %plib.0.i, align 8, !tbaa !5
  br label %cleanup8

cleanup8:                                         ; preds = %ll_register.exit, %if.end.thread
...
while.cond.i.backedge:                            ; preds = %while.body.i, %cleanup
...
if.end11:                                         ; preds = %if.end7, %if.else
  tail call void @lua_pushvalue(ptr noundef %L, i32 noundef -1) #6
...
cleanup:                                          ; preds = %if.end29, %if.then32, %if.then, %if.then3
  ret i32 1
}
