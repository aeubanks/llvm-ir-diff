...
154:                                              ; preds = %147, %140, %132, %122
  %155 = phi i32 [ %127, %122 ], [ %130, %132 ], [ %130, %140 ], [ %130, %147 ]
  %156 = phi i32 [ %126, %122 ], [ %134, %132 ], [ %134, %140 ], [ %134, %147 ]
  %157 = phi i32 [ %125, %122 ], [ %133, %132 ], [ %133, %140 ], [ %133, %147 ]
  %158 = phi i32 [ 1, %122 ], [ %124, %132 ], [ %124, %140 ], [ %124, %147 ]
  %159 = and i32 %129, %114
...
407:                                              ; preds = %391, %394, %386, %335, %324
  %408 = phi i32 [ %325, %324 ], [ %325, %335 ], [ 0, %386 ], [ 0, %394 ], [ 0, %391 ]
  %409 = phi i32 [ %286, %324 ], [ %286, %335 ], [ %390, %386 ], [ %286, %394 ], [ %286, %391 ]
  %410 = add i32 %308, %285
