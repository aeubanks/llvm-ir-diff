...
lor.lhs.false:                                    ; preds = %if.end56, %for.body.peel.next
...
if.end56:                                         ; preds = %f4.exit
  ...
  br i1 %exitcond.not, label %for.end59, label %lor.lhs.false, !llvm.loop !9
