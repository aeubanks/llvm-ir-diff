...
define dso_local void @f(ptr nocapture noundef %a, i64 noundef %aa) local_unnamed_addr #0 {
entry:
  %0 = load i64, ptr %a, align 8, !tbaa !5
  %and = and i64 %0, 4294967295
  %and1 = and i64 %aa, 4294967295
  %cmp = icmp ugt i64 %and, %and1
  %add = or i64 %and1, 4294967296
  %spec.select = select i1 %cmp, i64 %add, i64 %and1
  %and2 = and i64 %0, -4294967296
  %add3 = add i64 %spec.select, %and2
...
entry:
  ...
  store i64 4294967297, ptr %value, align 8, !tbaa !5
  call void @f(ptr noundef nonnull %value, i64 noundef 2)
  %0 = load i64, ptr %value, align 8, !tbaa !5
  %cmp.not = icmp eq i64 %0, 4294967298
