; ModuleID = '/usr/local/google/home/aeubanks/repos/test-suite/MultiSource/Benchmarks/TSVC/StatementReordering-dbl/tsc.c'
source_filename = "/usr/local/google/home/aeubanks/repos/test-suite/MultiSource/Benchmarks/TSVC/StatementReordering-dbl/tsc.c"
...
define dso_local i32 @s211() local_unnamed_addr #7 {
  %1 = tail call i32 @init(ptr noundef nonnull @.str.31)
...
37:                                               ; preds = %4, %37
  %38 = phi double [ %6, %4 ], [ %52, %37 ]
  %39 = phi i64 [ 1, %4 ], [ %46, %37 ]
  %40 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 %39
  %41 = load double, ptr %40, align 8, !tbaa !5
  %42 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 %39
  %43 = load double, ptr %42, align 8, !tbaa !5
  %44 = tail call double @llvm.fmuladd.f64(double %41, double %43, double %38)
  %45 = getelementptr inbounds double, ptr @global_data, i64 %39
  ...
  %49 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 11, i64 %39
  %50 = load double, ptr %49, align 8, !tbaa !5
  %51 = fneg double %50
  %52 = tail call double @llvm.fmuladd.f64(double %51, double %43, double %48)
  %53 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %39
  store double %52, ptr %53, align 8, !tbaa !5
  %54 = icmp eq i64 %46, 31999
  br i1 %54, label %32, label %37
}
...
define dso_local i32 @s212() local_unnamed_addr #7 {
  %1 = tail call i32 @init(ptr noundef nonnull @.str.32)
  %2 = load i32, ptr @ntimes, align 4, !tbaa !17
  %3 = icmp sgt i32 %2, 0
  br i1 %3, label %4, label %7
...
37:                                               ; preds = %4, %37
  %38 = phi double [ %6, %4 ], [ %46, %37 ]
  %39 = phi i64 [ 0, %4 ], [ %44, %37 ]
  %40 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 %39
  %41 = load double, ptr %40, align 8, !tbaa !5
  %42 = getelementptr inbounds double, ptr @global_data, i64 %39
  %43 = fmul double %41, %38
  store double %43, ptr %42, align 8, !tbaa !5
  %44 = add nuw nsw i64 %39, 1
  %45 = getelementptr inbounds double, ptr @global_data, i64 %44
  %46 = load double, ptr %45, align 8, !tbaa !5
  %47 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 %39
  %48 = load double, ptr %47, align 8, !tbaa !5
  %49 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %39
  %50 = load double, ptr %49, align 8, !tbaa !5
  %51 = tail call double @llvm.fmuladd.f64(double %46, double %48, double %50)
  store double %51, ptr %49, align 8, !tbaa !5
  %52 = icmp eq i64 %44, 31999
...
37:                                               ; preds = %4, %37
  %38 = phi double [ %6, %4 ], [ %49, %37 ]
  %39 = phi i64 [ 1, %4 ], [ %44, %37 ]
  %40 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 %39
  %41 = load double, ptr %40, align 8, !tbaa !5
  %42 = fadd double %38, %41
  %43 = getelementptr inbounds double, ptr @global_data, i64 %39
  ...
  %50 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %39
  store double %49, ptr %50, align 8, !tbaa !5
  %51 = icmp eq i64 %44, 31999
