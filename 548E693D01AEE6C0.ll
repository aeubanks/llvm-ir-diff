...
entry:
  %call = tail call i32 @init(ptr noundef nonnull @.str.31)
...
for.cond1.preheader:                              ; preds = %entry, %for.cond.cleanup3
  %nl.037 = phi i32 [ %inc21, %for.cond.cleanup3 ], [ 0, %entry ]
...
for.cond.cleanup3:                                ; preds = %for.body4
  ...
  %cmp = icmp slt i32 %inc21, %6
  br i1 %cmp, label %for.cond1.preheader, label %for.cond.cleanup

for.body4:                                        ; preds = %for.cond1.preheader, %for.body4
  %7 = phi double [ %.pre, %for.cond1.preheader ], [ %13, %for.body4 ]
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %arrayidx12 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %indvars.iv.next
  %11 = load double, ptr %arrayidx12, align 8, !tbaa !5
  %arrayidx14 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 11, i64 %indvars.iv
  %12 = load double, ptr %arrayidx14, align 8, !tbaa !5
  %neg = fneg double %12
  %13 = tail call double @llvm.fmuladd.f64(double %neg, double %9, double %11)
...
entry:
  %call = tail call i32 @init(ptr noundef nonnull @.str.32)
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
  %cmp27 = icmp sgt i32 %0, 0
  br i1 %cmp27, label %for.cond1.preheader, label %for.cond.cleanup

for.cond1.preheader:                              ; preds = %entry, %for.cond.cleanup3
  %nl.028 = phi i32 [ %inc16, %for.cond.cleanup3 ], [ 0, %entry ]
  %.pre = load double, ptr @global_data, align 32, !tbaa !5
  br label %for.body4

for.cond.cleanup:                                 ; preds = %for.cond.cleanup3, %entry
  %call18 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.138, double noundef 0.000000e+00)
  br label %for.body.i
...
for.cond.cleanup3:                                ; preds = %for.body4
  ...
  %inc16 = add nuw nsw i32 %nl.028, 1
  %6 = load i32, ptr @ntimes, align 4, !tbaa !17
  %cmp = icmp slt i32 %inc16, %6
  br i1 %cmp, label %for.cond1.preheader, label %for.cond.cleanup

for.body4:                                        ; preds = %for.cond1.preheader, %for.body4
  %7 = phi double [ %.pre, %for.cond1.preheader ], [ %9, %for.body4 ]
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %arrayidx8 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv.next
  %9 = load double, ptr %arrayidx8, align 8, !tbaa !5
  %arrayidx10 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 %indvars.iv
  %10 = load double, ptr %arrayidx10, align 8, !tbaa !5
  %arrayidx13 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %indvars.iv
  %11 = load double, ptr %arrayidx13, align 8, !tbaa !5
  %12 = tail call double @llvm.fmuladd.f64(double %9, double %10, double %11)
  store double %12, ptr %arrayidx13, align 8, !tbaa !5
  %exitcond.not = icmp eq i64 %indvars.iv.next, 31999
  br i1 %exitcond.not, label %for.cond.cleanup3, label %for.body4
}
...
for.cond.cleanup:                                 ; preds = %for.cond.cleanup3, %entry
  %call21 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.139, double noundef 0.000000e+00)
  br label %for.body.i
...
for.body4:                                        ; preds = %for.cond1.preheader, %for.body4
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %arrayidx11 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv.next
  ...
  %arrayidx15 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %indvars.iv
...
if.then4:                                         ; preds = %if.end
  ...
  %call.i14 = call i64 @strtol(ptr nocapture noundef nonnull %2, ptr noundef null, i32 noundef 10) #16
