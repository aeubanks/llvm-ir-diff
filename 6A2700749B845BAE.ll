...
entry:
  ...
  %4 = insertelement <8 x x86_fp80> poison, x86_fp80 %add12, i64 0
  %5 = insertelement <8 x x86_fp80> %4, x86_fp80 %sub15, i64 1
  %6 = insertelement <8 x x86_fp80> %5, x86_fp80 %sub7, i64 2
  %7 = insertelement <8 x x86_fp80> %6, x86_fp80 %sub20, i64 3
  %8 = insertelement <8 x x86_fp80> %7, x86_fp80 %sub19, i64 4
  %9 = insertelement <8 x x86_fp80> %8, x86_fp80 %mul9, i64 5
  %10 = insertelement <8 x x86_fp80> %9, x86_fp80 %sub10, i64 6
  %11 = insertelement <8 x x86_fp80> %10, x86_fp80 %2, i64 7
  %.fr = freeze <8 x x86_fp80> %11
  %12 = fcmp une <8 x x86_fp80> %.fr, <x86_fp80 0xK4004C400000000000000, x86_fp80 0xK40058800000000000000, x86_fp80 0xK4004E800000000000000, x86_fp80 0xK4006BA80000000000000, x86_fp80 0xK4006C100000000000000, x86_fp80 0xK40059A00000000000000, x86_fp80 0xK40058200000000000000, x86_fp80 0xK4002B000000000000000>
