...
if.end22:                                         ; preds = %if.end16
  ...
  %or.cond126.not230 = or i1 %cmp29, %cmp32
  %cmp35.not = icmp ugt i32 %mul, %exesz
  %or.cond212 = or i1 %or.cond126.not230, %cmp35.not
  %cmp38.not = icmp ult ptr %gep, %exe
  %or.cond213 = select i1 %or.cond212, i1 true, i1 %cmp38.not
  br i1 %or.cond213, label %if.then52, label %land.lhs.true40
...
land.lhs.true40:                                  ; preds = %if.end22
  ...
  %or.cond214 = and i1 %cmp45.not, %cmp50
  br i1 %or.cond214, label %if.end53, label %if.then52
...
land.lhs.true8.i:                                 ; preds = %while.cond.i
  ...
  %or.cond1104.i = select i1 %cmp9.not.i, i1 true, i1 %cmp13.not.i
  %cmp26.not.i = icmp uge ptr %dst.0.i, %gep
  %5 = or i1 %cmp396.i, %or.cond1104.i
  %not.1114.i = xor i1 %5, true
  %or.cond1105.i = select i1 %not.1114.i, i1 %cmp26.not.i, i1 false
  %add.ptr29.i = getelementptr inbounds i8, ptr %dst.0.i, i64 1
  %cmp32.not.i = icmp ule ptr %add.ptr29.i, %add.ptr422.i
  %or.cond1106.i = select i1 %or.cond1105.i, i1 %cmp32.not.i, i1 false
  br i1 %or.cond1106.i, label %if.end39.i, label %if.then59.critedge

if.end39.i:                                       ; preds = %land.lhs.true8.i
...
land.lhs.true4.i655.i:                            ; preds = %land.lhs.true2.i650.i
  ...
  %cmp6.not.not.i654.i = icmp ugt ptr %add.ptr.i651.i, %add.ptr5.i.i.i
...
land.lhs.true55.i:                                ; preds = %if.end.i657.i
  ...
  %cmp75.not.i = icmp uge ptr %dst.0.i, %gep
  %7 = or i1 %cmp396.i, %cmp62.not.i
  %not..i = xor i1 %7, true
  %or.cond1108.i = select i1 %not..i, i1 %cmp75.not.i, i1 false
  %add.ptr78.i = getelementptr inbounds i8, ptr %dst.0.i, i64 1
  %cmp81.not.i = icmp ule ptr %add.ptr78.i, %add.ptr422.i
  %or.cond1109.i = select i1 %or.cond1108.i, i1 %cmp81.not.i, i1 false
  br i1 %or.cond1109.i, label %if.end88.i, label %if.then59.critedge

if.end88.i:                                       ; preds = %land.lhs.true55.i
...
return.sink.split.i.thread.i:                     ; preds = %land.lhs.true4.i73.i.i
  ...
  store i8 32, ptr %bits.i, align 1, !tbaa !9
  %cmp971141.i = icmp eq i32 %shr.i.i, 3
  br i1 %cmp971141.i, label %if.then99.thread.i, label %if.end201.thread.i

if.end201.thread.i:                               ; preds = %return.sink.split.i.thread.i
  %shr.i7451147.i = lshr i32 %.val.i74.i.i, 29
  br label %if.then.i749.i

if.then99.thread.i:                               ; preds = %return.sink.split.i.thread.i
  %shr.i6611143.i = lshr i32 %.val.i74.i.i, 30
  store i32 %shr.i6611143.i, ptr %eax.i, align 4, !tbaa !10
  br label %if.then.i665.i
...
if.then.i665.i:                                   ; preds = %if.then99.i.thread, %if.then99.i, %if.then99.thread.i
  %shr.i6611145.i = phi i32 [ %shr.i6611143.i, %if.then99.thread.i ], [ %shr.i661.i, %if.then99.i ], [ %shr.i661.i216, %if.then99.i.thread ]
...
land.lhs.true2.i.i674.i:                          ; preds = %if.else.i667.i
  ...
  %cmp3.not.i.i673.i = icmp ult ptr %16, %call18
...
land.lhs.true4.i.i679.i:                          ; preds = %land.lhs.true2.i.i674.i
  %add.ptr.i.i675.i = getelementptr inbounds i8, ptr %16, i64 4
  %cmp6.not.not.i.i678.i = icmp ugt ptr %add.ptr.i.i675.i, %add.ptr5.i.i.i
  br i1 %cmp6.not.not.i.i678.i, label %if.then59.critedge, label %if.end.i.i687.i

if.end.i.i687.i:                                  ; preds = %land.lhs.true4.i.i679.i
  %.val.i.i680.i = load i32, ptr %16, align 1
  store ptr %add.ptr.i.i675.i, ptr %src.i, align 8, !tbaa !5
  %17 = shl nsw i32 -1, %conv18.i669.i
  %shl22.i681.i = and i32 %17, %shr.i661.i
...
land.lhs.true2.i68.i691.i:                        ; preds = %if.else.i667.i
  ...
  %cmp3.not.i67.i690.i = icmp ult ptr %18, %call18
...
land.lhs.true4.i73.i696.i:                        ; preds = %land.lhs.true2.i68.i691.i
  %add.ptr.i69.i692.i = getelementptr inbounds i8, ptr %18, i64 4
  %cmp6.not.not.i72.i695.i = icmp ugt ptr %add.ptr.i69.i692.i, %add.ptr5.i.i.i
...
if.end.i75.i698.i:                                ; preds = %land.lhs.true4.i73.i696.i
  %.val.i74.i697.i = load i32, ptr %18, align 1
...
return.sink.split.i700.i:                         ; preds = %if.end.i75.i698.i, %if.end.i.i687.i, %if.then.i665.i
  %19 = phi i32 [ %shl.i663.i, %if.then.i665.i ], [ %shl27.i685.i, %if.end.i.i687.i ], [ %.val.i74.i697.i, %if.end.i75.i698.i ]
  %20 = phi i32 [ %shr.i6611145.i, %if.then.i665.i ], [ %or.i684.i, %if.end.i.i687.i ], [ %shr.i661.i, %if.end.i75.i698.i ]
  %21 = phi i8 [ %sub7.i664.i, %if.then.i665.i ], [ 31, %if.end.i.i687.i ], [ 32, %if.end.i75.i698.i ]
...
land.lhs.true4.i.i721.i:                          ; preds = %land.lhs.true2.i.i716.i
  %add.ptr.i.i717.i = getelementptr inbounds i8, ptr %24, i64 4
  %cmp6.not.not.i.i720.i = icmp ugt ptr %add.ptr.i.i717.i, %add.ptr5.i.i.i
  br i1 %cmp6.not.not.i.i720.i, label %if.then59.critedge, label %if.end.i.i729.i

if.end.i.i729.i:                                  ; preds = %land.lhs.true4.i.i721.i
  %.val.i.i722.i = load i32, ptr %24, align 1
  store ptr %add.ptr.i.i717.i, ptr %src.i, align 8, !tbaa !5
  %25 = shl nsw i32 -1, %conv18.i711.i
  %shl22.i723.i = and i32 %25, %shr.i703.i
...
land.lhs.true2.i68.i733.i:                        ; preds = %if.else.i709.i
  ...
  %cmp3.not.i67.i732.i = icmp ult ptr %26, %call18
...
land.lhs.true4.i73.i738.i:                        ; preds = %land.lhs.true2.i68.i733.i
  %add.ptr.i69.i734.i = getelementptr inbounds i8, ptr %26, i64 4
  %cmp6.not.not.i72.i737.i = icmp ugt ptr %add.ptr.i69.i734.i, %add.ptr5.i.i.i
...
if.end.i75.i740.i:                                ; preds = %land.lhs.true4.i73.i738.i
  %.val.i74.i739.i = load i32, ptr %26, align 1
...
return.sink.split.i742.i:                         ; preds = %if.end.i75.i740.i, %if.end.i.i729.i, %if.then.i707.i
  %27 = phi i32 [ %shr.i703.i, %if.then.i707.i ], [ %or.i726.i, %if.end.i.i729.i ], [ %shr.i703.i, %if.end.i75.i740.i ]
...
land.lhs.true152.i:                               ; preds = %land.lhs.true146.i
  ...
  %cmp160.not.i = icmp ule ptr %add.ptr157.i, %add.ptr422.i
  %cmp168.i = icmp ugt ptr %add.ptr157.i, %gep
  %or.cond1063.not1113.not.i = and i1 %cmp160.not.i, %cmp168.i
  %cmp177.not.i = icmp uge ptr %dst.0.i, %gep
  %or.cond1064.i = select i1 %or.cond1063.not1113.not.i, i1 %cmp177.not.i, i1 false
  %add.ptr180.i = getelementptr inbounds i8, ptr %dst.0.i, i64 2
  %cmp183.not.i = icmp ule ptr %add.ptr180.i, %add.ptr422.i
  %or.cond1110.i = select i1 %or.cond1064.i, i1 %cmp183.not.i, i1 false
  br i1 %or.cond1110.i, label %cleanup.i, label %if.then59.critedge

cleanup.i:                                        ; preds = %land.lhs.true152.i
...
if.then.i749.i:                                   ; preds = %if.end201.i.thread, %if.end201.i, %if.end201.thread.i
  %shr.i7451151.i = phi i32 [ %shr.i7451147.i, %if.end201.thread.i ], [ %shr.i745.i, %if.end201.i ], [ %shr.i745.i218, %if.end201.i.thread ]
  ...
  %and11421150.i = phi i32 [ %shr.i.i, %if.end201.thread.i ], [ %10, %if.end201.i ], [ %or.i.i, %if.end201.i.thread ]
  %shl.i747.i = shl i32 %29, 3
  %sub7.i748.i = add i8 %30, -3
...
land.lhs.true2.i.i758.i:                          ; preds = %if.else.i751.i
  ...
  %cmp3.not.i.i757.i = icmp ult ptr %31, %call18
...
land.lhs.true4.i.i763.i:                          ; preds = %land.lhs.true2.i.i758.i
  %add.ptr.i.i759.i = getelementptr inbounds i8, ptr %31, i64 4
  %cmp6.not.not.i.i762.i = icmp ugt ptr %add.ptr.i.i759.i, %add.ptr5.i.i.i
  br i1 %cmp6.not.not.i.i762.i, label %if.then59.critedge, label %if.end.i.i771.i

if.end.i.i771.i:                                  ; preds = %land.lhs.true4.i.i763.i
  %.val.i.i764.i = load i32, ptr %31, align 1
  store ptr %add.ptr.i.i759.i, ptr %src.i, align 8, !tbaa !5
  %32 = shl nsw i32 -1, %conv18.i753.i
  %shl22.i765.i = and i32 %32, %shr.i745.i
...
land.lhs.true2.i68.i775.i:                        ; preds = %if.else.i751.i
  ...
  %cmp3.not.i67.i774.i = icmp ult ptr %33, %call18
...
land.lhs.true4.i73.i780.i:                        ; preds = %land.lhs.true2.i68.i775.i
  %add.ptr.i69.i776.i = getelementptr inbounds i8, ptr %33, i64 4
  %cmp6.not.not.i72.i779.i = icmp ugt ptr %add.ptr.i69.i776.i, %add.ptr5.i.i.i
...
if.end.i75.i782.i:                                ; preds = %land.lhs.true4.i73.i780.i
  %.val.i74.i781.i = load i32, ptr %33, align 1
...
return.sink.split.i784.i:                         ; preds = %if.end.i75.i782.i, %if.end.i.i771.i, %if.then.i749.i
  %and11421149.i = phi i32 [ %and11421150.i, %if.then.i749.i ], [ %10, %if.end.i.i771.i ], [ %10, %if.end.i75.i782.i ]
  %34 = phi i32 [ %shl.i747.i, %if.then.i749.i ], [ %shl27.i769.i, %if.end.i.i771.i ], [ %.val.i74.i781.i, %if.end.i75.i782.i ]
  %35 = phi i32 [ %shr.i7451151.i, %if.then.i749.i ], [ %or.i768.i, %if.end.i.i771.i ], [ %shr.i745.i, %if.end.i75.i782.i ]
  %36 = phi i8 [ %sub7.i748.i, %if.then.i749.i ], [ %sub30.i770.i, %if.end.i.i771.i ], [ 32, %if.end.i75.i782.i ]
...
land.lhs.true2.i789.i:                            ; preds = %if.then215.i
  ...
  %cmp3.not.i788.i = icmp ult ptr %37, %call18
...
land.lhs.true4.i794.i:                            ; preds = %land.lhs.true2.i789.i
  %add.ptr.i790.i = getelementptr inbounds i8, ptr %37, i64 4
  %cmp6.not.not.i793.i = icmp ugt ptr %add.ptr.i790.i, %add.ptr5.i.i.i
  br i1 %cmp6.not.not.i793.i, label %if.then59.critedge, label %if.end.i796.i

if.end.i796.i:                                    ; preds = %land.lhs.true4.i794.i
  %.val.i795.i = load i32, ptr %37, align 1
...
if.end226.i:                                      ; preds = %if.end.i796.i, %if.then215.i, %if.then211.i
  %38 = phi i8 [ %dec218.i, %if.then215.i ], [ 32, %if.end.i796.i ], [ %36, %if.then211.i ]
  %39 = phi i32 [ %shl217.i, %if.then215.i ], [ %.val.i795.i, %if.end.i796.i ], [ %34, %if.then211.i ]
...
land.lhs.true2.i801.i:                            ; preds = %if.then233.i
  ...
  %cmp3.not.i800.i = icmp ult ptr %40, %call18
...
land.lhs.true4.i806.i:                            ; preds = %land.lhs.true2.i801.i
  %add.ptr.i802.i = getelementptr inbounds i8, ptr %40, i64 4
...
if.end.i808.i:                                    ; preds = %land.lhs.true4.i806.i
  %.val.i807.i = load i32, ptr %40, align 1
  store ptr %add.ptr.i802.i, ptr %src.i, align 8, !tbaa !5
  br label %if.end243.i

if.end243.i:                                      ; preds = %if.end.i808.i, %if.then233.i
  %41 = phi i8 [ 32, %if.end.i808.i ], [ %dec236.i, %if.then233.i ]
  %42 = phi i32 [ %.val.i807.i, %if.end.i808.i ], [ %shl235.i, %if.then233.i ]
...
land.lhs.true4.i.i829.i:                          ; preds = %land.lhs.true2.i.i824.i
  %add.ptr.i.i825.i = getelementptr inbounds i8, ptr %43, i64 4
  %cmp6.not.not.i.i828.i = icmp ugt ptr %add.ptr.i.i825.i, %add.ptr5.i.i.i
  br i1 %cmp6.not.not.i.i828.i, label %if.then59.critedge, label %if.end.i.i837.i

if.end.i.i837.i:                                  ; preds = %land.lhs.true4.i.i829.i
  %.val.i.i830.i = load i32, ptr %43, align 1
  store ptr %add.ptr.i.i825.i, ptr %src.i, align 8, !tbaa !5
  %44 = shl nsw i32 -1, %conv18.i819.i
  %shl22.i831.i = and i32 %44, %shr.i811.i
...
land.lhs.true4.i73.i846.i:                        ; preds = %land.lhs.true2.i68.i841.i
  %add.ptr.i69.i842.i = getelementptr inbounds i8, ptr %45, i64 4
  %cmp6.not.not.i72.i845.i = icmp ugt ptr %add.ptr.i69.i842.i, %add.ptr5.i.i.i
...
if.end.i75.i848.i:                                ; preds = %land.lhs.true4.i73.i846.i
  %.val.i74.i847.i = load i32, ptr %45, align 1
...
return.sink.split.i850.i:                         ; preds = %if.end.i75.i848.i, %if.end.i.i837.i, %if.then.i815.i
  %46 = phi i32 [ %shl.i813.i, %if.then.i815.i ], [ %shl27.i835.i, %if.end.i.i837.i ], [ %.val.i74.i847.i, %if.end.i75.i848.i ]
  %47 = phi i32 [ %shr.i811.i, %if.then.i815.i ], [ %or.i834.i, %if.end.i.i837.i ], [ %shr.i811.i, %if.end.i75.i848.i ]
...
land.lhs.true4.i.i871.i:                          ; preds = %land.lhs.true2.i.i866.i
  %add.ptr.i.i867.i = getelementptr inbounds i8, ptr %48, i64 4
  %cmp6.not.not.i.i870.i = icmp ugt ptr %add.ptr.i.i867.i, %add.ptr5.i.i.i
  br i1 %cmp6.not.not.i.i870.i, label %if.then59.critedge, label %if.end.i.i879.i

if.end.i.i879.i:                                  ; preds = %land.lhs.true4.i.i871.i
  %.val.i.i872.i = load i32, ptr %48, align 1
  store ptr %add.ptr.i.i867.i, ptr %src.i, align 8, !tbaa !5
  %49 = shl nsw i32 -1, %conv18.i861.i
  %shl22.i873.i = and i32 %49, %shr.i853.i
...
land.lhs.true4.i73.i888.i:                        ; preds = %land.lhs.true2.i68.i883.i
  %add.ptr.i69.i884.i = getelementptr inbounds i8, ptr %50, i64 4
  %cmp6.not.not.i72.i887.i = icmp ugt ptr %add.ptr.i69.i884.i, %add.ptr5.i.i.i
...
if.end.i75.i890.i:                                ; preds = %land.lhs.true4.i73.i888.i
  %.val.i74.i889.i = load i32, ptr %50, align 1
...
return.sink.split.i892.i:                         ; preds = %if.end.i75.i890.i, %if.end.i.i879.i, %if.then.i857.i
  %51 = phi i32 [ %shl.i855.i, %if.then.i857.i ], [ %shl27.i877.i, %if.end.i.i879.i ], [ %.val.i74.i889.i, %if.end.i75.i890.i ]
  %52 = phi i32 [ %shr.i853.i, %if.then.i857.i ], [ %or.i876.i, %if.end.i.i879.i ], [ %shr.i853.i, %if.end.i75.i890.i ]
...
land.lhs.true4.i.i915.i:                          ; preds = %land.lhs.true2.i.i910.i
  %add.ptr.i.i911.i = getelementptr inbounds i8, ptr %56, i64 4
  %cmp6.not.not.i.i914.i = icmp ugt ptr %add.ptr.i.i911.i, %add.ptr5.i.i.i
  br i1 %cmp6.not.not.i.i914.i, label %if.then59.critedge, label %if.end.i.i923.i

if.end.i.i923.i:                                  ; preds = %land.lhs.true4.i.i915.i
  %.val.i.i916.i = load i32, ptr %56, align 1
  store ptr %add.ptr.i.i911.i, ptr %src.i, align 8, !tbaa !5
  %57 = shl i32 -1, %conv18.i905.i
  %shl22.i917.i = and i32 %57, %shr.i897.i
...
land.lhs.true2.i68.i927.i:                        ; preds = %if.else.i903.i
  ...
  %cmp3.not.i67.i926.i = icmp ult ptr %58, %call18
...
land.lhs.true4.i73.i932.i:                        ; preds = %land.lhs.true2.i68.i927.i
  %add.ptr.i69.i928.i = getelementptr inbounds i8, ptr %58, i64 4
  %cmp6.not.not.i72.i931.i = icmp ugt ptr %add.ptr.i69.i928.i, %add.ptr5.i.i.i
...
if.end.i75.i934.i:                                ; preds = %land.lhs.true4.i73.i932.i
  %.val.i74.i933.i = load i32, ptr %58, align 1
...
return.sink.split.i936.i:                         ; preds = %if.end.i75.i934.i, %if.end.i.i923.i, %if.then.i901.i
  %59 = phi i32 [ %shl.i899.i, %if.then.i901.i ], [ %shl27.i921.i, %if.end.i.i923.i ], [ %.val.i74.i933.i, %if.end.i75.i934.i ]
  %60 = phi i32 [ %shr.i897.i, %if.then.i901.i ], [ %or.i920.i, %if.end.i.i923.i ], [ %shr.i897.i, %if.end.i75.i934.i ]
...
if.end287.i:                                      ; preds = %return.sink.split.i936.i, %return.sink.split.i892.i, %return.sink.split.i850.i
  %61 = phi i8 [ %sub7.sink.i935.i, %return.sink.split.i936.i ], [ %sub7.sink.i891.i, %return.sink.split.i892.i ], [ %sub7.sink.i849.i, %return.sink.split.i850.i ]
  %62 = phi i32 [ %59, %return.sink.split.i936.i ], [ %51, %return.sink.split.i892.i ], [ %46, %return.sink.split.i850.i ]
  %63 = phi i32 [ %add284.i, %return.sink.split.i936.i ], [ %add266.i, %return.sink.split.i892.i ], [ %add260.i, %return.sink.split.i850.i ]
  %and288.i = and i32 %63, 65535
  store i32 %and288.i, ptr %eax.i, align 4, !tbaa !10
  %cmp291.not.i = icmp eq i32 %and11421149.i, 1
  %conv294.i = select i1 %cmp291.not.i, i16 3, i16 4
  %cmp296.i = icmp eq i32 %and11421149.i, 0
...
land.lhs.true2.i941.i:                            ; preds = %if.then298.i
  ...
  %cmp3.not.i940.i = icmp ult ptr %64, %call18
...
land.lhs.true4.i946.i:                            ; preds = %land.lhs.true2.i941.i
  %add.ptr.i942.i = getelementptr inbounds i8, ptr %64, i64 4
  %cmp6.not.not.i945.i = icmp ugt ptr %add.ptr.i942.i, %add.ptr5.i.i.i
...
if.end308.thread.i:                               ; preds = %land.lhs.true4.i946.i
  %.val.i947.i = load i32, ptr %64, align 1
  store ptr %add.ptr.i942.i, ptr %src.i, align 8, !tbaa !5
  %tobool309.not1152.i = icmp sgt i32 %62, -1
  br i1 %tobool309.not1152.i, label %if.then310.thread.i, label %if.else322.thread.i

if.then310.thread.i:                              ; preds = %if.end308.thread.i
  %shl3121162.i = shl i32 %.val.i947.i, 1
  store i32 %shl3121162.i, ptr %bitmap.i, align 4, !tbaa !10
  store i8 31, ptr %bits.i, align 1, !tbaa !9
  br label %if.end320.i

if.else322.thread.i:                              ; preds = %if.end308.thread.i
  %shr.i9631153.i = lshr i32 %.val.i947.i, 29
...
land.lhs.true2.i953.i:                            ; preds = %if.then310.i
  ...
  %cmp3.not.i952.i = icmp ult ptr %65, %call18
...
land.lhs.true4.i958.i:                            ; preds = %land.lhs.true2.i953.i
  %add.ptr.i954.i = getelementptr inbounds i8, ptr %65, i64 4
...
if.end.i960.i:                                    ; preds = %land.lhs.true4.i958.i
  %.val.i959.i = load i32, ptr %65, align 1
...
if.end320.i:                                      ; preds = %if.end.i960.i, %if.then310.i, %if.then310.thread.i
  %shr3111165.in.i = phi i32 [ %.val.i947.i, %if.then310.thread.i ], [ %shl300.i, %if.end.i960.i ], [ %shl300.i, %if.then310.i ]
  %shr3111165.i = lshr i32 %shr3111165.in.i, 31
  %add321.i = add nuw nsw i32 %shr3111165.i, 5
...
if.then.i967.i:                                   ; preds = %if.else322.i, %if.else322.thread.i
  %shr.i9631155.i = phi i32 [ %shr.i9631153.i, %if.else322.thread.i ], [ %shr.i963.i, %if.else322.i ]
  %66 = phi i8 [ 32, %if.else322.thread.i ], [ %dec301.i, %if.else322.i ]
  %67 = phi i32 [ %.val.i947.i, %if.else322.thread.i ], [ %shl300.i, %if.else322.i ]
  %shl.i965.i = shl i32 %67, 3
  store i32 %shl.i965.i, ptr %bitmap.i, align 4, !tbaa !10
  %sub7.i966.i = add i8 %66, -3
...
land.lhs.true4.i.i981.i:                          ; preds = %land.lhs.true2.i.i976.i
  %add.ptr.i.i977.i = getelementptr inbounds i8, ptr %68, i64 4
  %cmp6.not.not.i.i980.i = icmp ugt ptr %add.ptr.i.i977.i, %add.ptr5.i.i.i
  br i1 %cmp6.not.not.i.i980.i, label %if.then59.critedge, label %if.end.i.i989.i

if.end.i.i989.i:                                  ; preds = %land.lhs.true4.i.i981.i
  %.val.i.i982.i = load i32, ptr %68, align 1
  store ptr %add.ptr.i.i977.i, ptr %src.i, align 8, !tbaa !5
  %69 = shl nsw i32 -1, %conv18.i971.i
  %shl22.i983.i = and i32 %69, %shr.i963.i
...
land.lhs.true4.i73.i998.i:                        ; preds = %land.lhs.true2.i68.i993.i
  %add.ptr.i69.i994.i = getelementptr inbounds i8, ptr %70, i64 4
  %cmp6.not.not.i72.i997.i = icmp ugt ptr %add.ptr.i69.i994.i, %add.ptr5.i.i.i
...
return.sink.split.i1002.i:                        ; preds = %if.end.i.i989.i, %if.then.i967.i
  %71 = phi i32 [ %shl.i965.i, %if.then.i967.i ], [ %shl27.i987.i, %if.end.i.i989.i ]
  %72 = phi i32 [ %shr.i9631155.i, %if.then.i967.i ], [ %or.i986.i, %if.end.i.i989.i ]
  %73 = phi i8 [ %sub7.i966.i, %if.then.i967.i ], [ %sub30.i988.i, %if.end.i.i989.i ]
...
land.lhs.true4.i.i1023.i:                         ; preds = %land.lhs.true2.i.i1018.i
  %add.ptr.i.i1019.i = getelementptr inbounds i8, ptr %77, i64 4
  %cmp6.not.not.i.i1022.i = icmp ugt ptr %add.ptr.i.i1019.i, %add.ptr5.i.i.i
...
if.end.i.i1031.i:                                 ; preds = %land.lhs.true4.i.i1023.i
  %.val.i.i1024.i = load i32, ptr %77, align 1
  store ptr %add.ptr.i.i1019.i, ptr %src.i, align 8, !tbaa !5
  %78 = shl nsw i32 -1, %conv18.i1013.i
  %shl22.i1025.i = and i32 %78, %shr.i1005.i
...
land.lhs.true4.i73.i1040.i:                       ; preds = %land.lhs.true2.i68.i1035.i
  %add.ptr.i69.i1036.i = getelementptr inbounds i8, ptr %79, i64 4
  %cmp6.not.not.i72.i1039.i = icmp ugt ptr %add.ptr.i69.i1036.i, %add.ptr5.i.i.i
...
if.end.i75.i1042.i:                               ; preds = %land.lhs.true4.i73.i1040.i
  %.val.i74.i1041.i = load i32, ptr %79, align 1
...
return.sink.split.i1044.i:                        ; preds = %if.end.i75.i1042.i, %if.end.i.i1031.i, %if.then.i1009.i
  ...
  %80 = phi i32 [ %shr.i10051160.i, %if.then.i1009.i ], [ %or.i1028.i, %if.end.i.i1031.i ], [ %shr.i1005.i, %if.end.i75.i1042.i ]
...
while.cond341.us.preheader.i:                     ; preds = %return.sink.split.i1044.i
...
if.then358.us.i:                                  ; preds = %while.cond341.us.preheader.i
  %cmp3.not.i1048.us.i = icmp ult ptr %src.promoted.i, %call18
  br i1 %cmp3.not.i1048.us.i, label %if.then59.critedge, label %land.lhs.true4.i1054.us.i

land.lhs.true4.i1054.us.i:                        ; preds = %if.then358.us.i
  %add.ptr.i1050.us.i = getelementptr inbounds i8, ptr %src.promoted.i, i64 4
  %cmp6.not.not.i1053.us.i = icmp ugt ptr %add.ptr.i1050.us.i, %add.ptr5.i.i.i
  br i1 %cmp6.not.not.i1053.us.i, label %if.then59.critedge, label %if.end.i1056.us.i

if.end.i1056.us.i:                                ; preds = %land.lhs.true4.i1054.us.i
  %.val.i1055.us.i = load i32, ptr %src.promoted.i, align 1
  br label %if.end363.us.i

if.end363.us.i:                                   ; preds = %if.end.i1056.us.i, %while.cond341.us.preheader.i
  %add.ptr.i10501083.us.i = phi ptr [ %add.ptr.i1050.us.i, %if.end.i1056.us.i ], [ %src.promoted.i, %while.cond341.us.preheader.i ]
  %81 = phi i8 [ 32, %if.end.i1056.us.i ], [ %dec356.us.i, %while.cond341.us.preheader.i ]
  %.val.i10551081.us.i = phi i32 [ %.val.i1055.us.i, %if.end.i1056.us.i ], [ %shl355.us.i, %while.cond341.us.preheader.i ]
...
while.cond341.us.1.i:                             ; preds = %if.end363.us.i
  %shl355.us.1.i = shl i32 %.val.i10551081.us.i, 1
...
if.then358.us.1.i:                                ; preds = %while.cond341.us.1.i
  %cmp3.not.i1048.us.1.i = icmp ult ptr %add.ptr.i10501083.us.i, %call18
  br i1 %cmp3.not.i1048.us.1.i, label %if.then59.critedge, label %land.lhs.true4.i1054.us.1.i

land.lhs.true4.i1054.us.1.i:                      ; preds = %if.then358.us.1.i
  %add.ptr.i1050.us.1.i = getelementptr inbounds i8, ptr %add.ptr.i10501083.us.i, i64 4
  %cmp6.not.not.i1053.us.1.i = icmp ugt ptr %add.ptr.i1050.us.1.i, %add.ptr5.i.i.i
  br i1 %cmp6.not.not.i1053.us.1.i, label %if.then59.critedge, label %if.end.i1056.us.1.i

if.end.i1056.us.1.i:                              ; preds = %land.lhs.true4.i1054.us.1.i
  %.val.i1055.us.1.i = load i32, ptr %add.ptr.i10501083.us.i, align 1
  br label %if.end363.us.1.i

if.end363.us.1.i:                                 ; preds = %if.end.i1056.us.1.i, %while.cond341.us.1.i
  %add.ptr.i10501083.us.1.i = phi ptr [ %add.ptr.i1050.us.1.i, %if.end.i1056.us.1.i ], [ %add.ptr.i10501083.us.i, %while.cond341.us.1.i ]
  %82 = phi i8 [ 32, %if.end.i1056.us.1.i ], [ %dec356.us.1.i, %while.cond341.us.1.i ]
  %.val.i10551081.us.1.i = phi i32 [ %.val.i1055.us.1.i, %if.end.i1056.us.1.i ], [ %shl355.us.1.i, %while.cond341.us.1.i ]
  %tobool365.not.us.1.i = icmp sgt i32 %.val.i10551081.us.i, -1
  br i1 %tobool365.not.us.1.i, label %while.cond341.us.2.i, label %if.end367.i

while.cond341.us.2.i:                             ; preds = %if.end363.us.1.i
  %shl355.us.2.i = shl i32 %.val.i10551081.us.1.i, 1
...
if.then358.us.2.i:                                ; preds = %while.cond341.us.2.i
  %cmp3.not.i1048.us.2.i = icmp ult ptr %add.ptr.i10501083.us.1.i, %call18
  br i1 %cmp3.not.i1048.us.2.i, label %if.then59.critedge, label %land.lhs.true4.i1054.us.2.i

land.lhs.true4.i1054.us.2.i:                      ; preds = %if.then358.us.2.i
  %add.ptr.i1050.us.2.i = getelementptr inbounds i8, ptr %add.ptr.i10501083.us.1.i, i64 4
  %cmp6.not.not.i1053.us.2.i = icmp ugt ptr %add.ptr.i1050.us.2.i, %add.ptr5.i.i.i
  br i1 %cmp6.not.not.i1053.us.2.i, label %if.then59.critedge, label %if.end.i1056.us.2.i

if.end.i1056.us.2.i:                              ; preds = %land.lhs.true4.i1054.us.2.i
  %.val.i1055.us.2.i = load i32, ptr %add.ptr.i10501083.us.1.i, align 1
  br label %if.end363.us.2.i

if.end363.us.2.i:                                 ; preds = %if.end.i1056.us.2.i, %while.cond341.us.2.i
  %add.ptr.i10501083.us.2.i = phi ptr [ %add.ptr.i1050.us.2.i, %if.end.i1056.us.2.i ], [ %add.ptr.i10501083.us.1.i, %while.cond341.us.2.i ]
  %83 = phi i8 [ 32, %if.end.i1056.us.2.i ], [ %dec356.us.2.i, %while.cond341.us.2.i ]
  %.val.i10551081.us.2.i = phi i32 [ %.val.i1055.us.2.i, %if.end.i1056.us.2.i ], [ %shl355.us.2.i, %while.cond341.us.2.i ]
  %tobool365.not.us.2.i = icmp sgt i32 %.val.i10551081.us.1.i, -1
...
if.end367.i:                                      ; preds = %if.end363.us.2.i, %if.end363.us.1.i, %if.end363.us.i
  %add.ptr.i10501083.us.lcssa.i = phi ptr [ %add.ptr.i10501083.us.i, %if.end363.us.i ], [ %add.ptr.i10501083.us.1.i, %if.end363.us.1.i ], [ %add.ptr.i10501083.us.2.i, %if.end363.us.2.i ]
  %.lcssa1136.i = phi i8 [ %81, %if.end363.us.i ], [ %82, %if.end363.us.1.i ], [ %83, %if.end363.us.2.i ]
  %.val.i10551081.us.lcssa.i = phi i32 [ %.val.i10551081.us.i, %if.end363.us.i ], [ %.val.i10551081.us.1.i, %if.end363.us.1.i ], [ %.val.i10551081.us.2.i, %if.end363.us.2.i ]
  %inc364.us.lcssa.i = phi i8 [ 5, %if.end363.us.i ], [ 6, %if.end363.us.1.i ], [ 7, %if.end363.us.2.i ]
  %dec353.us.lcssa1135.i = phi i32 [ 29, %if.end363.us.i ], [ 61, %if.end363.us.1.i ], [ 125, %if.end363.us.2.i ]
  store i32 %.val.i10551081.us.lcssa.i, ptr %bitmap.i, align 4, !tbaa !10
  store ptr %add.ptr.i10501083.us.lcssa.i, ptr %src.i, align 8, !tbaa !5
  %conv.i = zext i8 %inc364.us.lcssa.i to i32
  %sub.i197 = sub nuw nsw i32 32, %conv.i
  %shr.i = lshr i32 %.val.i10551081.us.lcssa.i, %sub.i197
  store i32 %shr.i, ptr %eax.i, align 4, !tbaa !10
  %cmp.i = icmp ugt i8 %.lcssa1136.i, %inc364.us.lcssa.i
  br i1 %cmp.i, label %if.then.i, label %if.else.i199

if.then.i:                                        ; preds = %if.end367.i
  %shl.i198 = shl i32 %.val.i10551081.us.lcssa.i, %conv.i
  store i32 %shl.i198, ptr %bitmap.i, align 4, !tbaa !10
  %sub7.i = sub i8 %.lcssa1136.i, %inc364.us.lcssa.i
  br label %return.sink.split.i

if.else.i199:                                     ; preds = %if.end367.i
  %cmp11.i = icmp ult i8 %.lcssa1136.i, %inc364.us.lcssa.i
  br i1 %cmp11.i, label %if.then13.i, label %land.lhs.true2.i68.i

if.then13.i:                                      ; preds = %if.else.i199
  %sub16.i = sub i8 %inc364.us.lcssa.i, %.lcssa1136.i
  %conv18.i = zext i8 %sub16.i to i32
  %shr19.i = lshr i32 %shr.i, %conv18.i
  store i32 %shr19.i, ptr %eax.i, align 4, !tbaa !10
  %cmp3.not.i.i = icmp ult ptr %add.ptr.i10501083.us.lcssa.i, %call18
  br i1 %cmp3.not.i.i, label %if.then59.critedge, label %land.lhs.true4.i.i

land.lhs.true4.i.i:                               ; preds = %if.then13.i
  %add.ptr.i.i201 = getelementptr inbounds i8, ptr %add.ptr.i10501083.us.lcssa.i, i64 4
  %cmp6.not.not.i.i = icmp ugt ptr %add.ptr.i.i201, %add.ptr5.i.i.i
  br i1 %cmp6.not.not.i.i, label %if.then59.critedge, label %if.end.i.i204

if.end.i.i204:                                    ; preds = %land.lhs.true4.i.i
  %.val.i.i202 = load i32, ptr %add.ptr.i10501083.us.lcssa.i, align 1
  store ptr %add.ptr.i.i201, ptr %src.i, align 8, !tbaa !5
  %shl22.i = shl i32 %shr19.i, %conv18.i
  %sub24.i = sub nsw i32 32, %conv18.i
  %shr25.i = lshr i32 %.val.i.i202, %sub24.i
  %or.i203 = or i32 %shr25.i, %shl22.i
  %shl27.i = shl i32 %.val.i.i202, %conv18.i
  store i32 %shl27.i, ptr %bitmap.i, align 4, !tbaa !10
  %sub30.i = sub i8 32, %sub16.i
  br label %return.sink.split.i

land.lhs.true2.i68.i:                             ; preds = %if.else.i199
  %cmp3.not.i67.i = icmp ult ptr %add.ptr.i10501083.us.lcssa.i, %call18
  br i1 %cmp3.not.i67.i, label %if.then59.critedge, label %land.lhs.true4.i73.i

land.lhs.true4.i73.i:                             ; preds = %land.lhs.true2.i68.i
  %add.ptr.i69.i = getelementptr inbounds i8, ptr %add.ptr.i10501083.us.lcssa.i, i64 4
...
if.end.i75.i:                                     ; preds = %land.lhs.true4.i73.i
  %.val.i74.i = load i32, ptr %add.ptr.i10501083.us.lcssa.i, align 1
  store i32 %.val.i74.i, ptr %bitmap.i, align 4, !tbaa !10
  store ptr %add.ptr.i69.i, ptr %src.i, align 8, !tbaa !5
  br label %return.sink.split.i

return.sink.split.i:                              ; preds = %if.end.i75.i, %if.end.i.i204, %if.then.i
  %84 = phi i32 [ %shr.i, %if.then.i ], [ %or.i203, %if.end.i.i204 ], [ %shr.i, %if.end.i75.i ]
  %sub7.sink.i = phi i8 [ %sub7.i, %if.then.i ], [ %sub30.i, %if.end.i.i204 ], [ 32, %if.end.i75.i ]
  store i8 %sub7.sink.i, ptr %bits.i, align 1, !tbaa !9
  %conv375.i = add i32 %84, %dec353.us.lcssa1135.i
...
if.else380.i:                                     ; preds = %if.end363.us.2.i
  store i32 %.val.i10551081.us.2.i, ptr %bitmap.i, align 4, !tbaa !10
  store i8 %83, ptr %bits.i, align 1, !tbaa !9
  store ptr %add.ptr.i10501083.us.2.i, ptr %src.i, align 8, !tbaa !5
...
if.else380.if.end392_crit_edge.i:                 ; preds = %if.else380.i
  %.pre1139.i = load i32, ptr %eax.i, align 4, !tbaa !10
  br label %if.end392.i

if.end392.i:                                      ; preds = %if.else380.if.end392_crit_edge.i, %return.sink.split.i, %if.then338.i, %if.then329.i, %if.end320.i
  %85 = phi i32 [ %.pre1139.i, %if.else380.if.end392_crit_edge.i ], [ %or379.i, %return.sink.split.i ], [ %add330.i, %if.then329.i ], [ %add339.i, %if.then338.i ], [ %add321.i, %if.end320.i ]
...
if.end395.i:                                      ; preds = %if.end392.i, %if.end287.i
  ...
  %or.cond1066.i = select i1 %or.cond496.not1111.i, i1 true, i1 %cmp404.not.i
...
land.lhs.true413.i:                               ; preds = %land.lhs.true406.i
  ...
  %or.cond1067.not1112.i = or i1 %cmp423.not.i, %cmp433.i
  %cmp447.not.i = icmp ult ptr %dst.0.i, %gep
  %or.cond1068.i = select i1 %or.cond1067.not1112.i, i1 true, i1 %cmp447.not.i
...
while.body468.i.preheader:                        ; preds = %land.lhs.true449.i
  ...
  br i1 %or.cond, label %while.body468.i.preheader257, label %vector.ph
...
vector.ph:                                        ; preds = %while.body468.i.preheader
  ...
  %ind.end253 = sub i16 %backsize.0.i, %.cast
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load256 = load <16 x i8>, ptr %87, align 1, !tbaa !9
  store <16 x i8> %wide.load, ptr %next.gep, align 1, !tbaa !9
  %88 = getelementptr i8, ptr %next.gep, i64 16
  store <16 x i8> %wide.load256, ptr %88, align 1, !tbaa !9
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %while.condthread-pre-split.i, label %while.body468.i.preheader257

while.body468.i.preheader257:                     ; preds = %while.body468.i.preheader, %middle.block
  %dst.21103.i.ph = phi ptr [ %dst.0.i, %while.body468.i.preheader ], [ %ind.end, %middle.block ]
  %backsize.11102.i.ph = phi i16 [ %backsize.0.i, %while.body468.i.preheader ], [ %ind.end253, %middle.block ]
  %90 = add i16 %backsize.11102.i.ph, -1
  %xtraiter = and i16 %backsize.11102.i.ph, 7
  %lcmp.mod.not = icmp eq i16 %xtraiter, 0
  br i1 %lcmp.mod.not, label %while.body468.i.prol.loopexit, label %while.body468.i.prol

while.body468.i.prol:                             ; preds = %while.body468.i.preheader257, %while.body468.i.prol
  %dst.21103.i.prol = phi ptr [ %incdec.ptr473.i.prol, %while.body468.i.prol ], [ %dst.21103.i.ph, %while.body468.i.preheader257 ]
  %backsize.11102.i.prol = phi i16 [ %dec466.i.prol, %while.body468.i.prol ], [ %backsize.11102.i.ph, %while.body468.i.preheader257 ]
  %prol.iter = phi i16 [ %prol.iter.next, %while.body468.i.prol ], [ 0, %while.body468.i.preheader257 ]
  %dec466.i.prol = add i16 %backsize.11102.i.prol, -1
  %add.ptr472.i.prol = getelementptr inbounds i8, ptr %dst.21103.i.prol, i64 %idx.neg409.i
  %91 = load i8, ptr %add.ptr472.i.prol, align 1, !tbaa !9
  store i8 %91, ptr %dst.21103.i.prol, align 1, !tbaa !9
  %incdec.ptr473.i.prol = getelementptr inbounds i8, ptr %dst.21103.i.prol, i64 1
...
while.body468.i.prol.loopexit:                    ; preds = %while.body468.i.prol, %while.body468.i.preheader257
  %incdec.ptr473.i.lcssa.unr = phi ptr [ undef, %while.body468.i.preheader257 ], [ %incdec.ptr473.i.prol, %while.body468.i.prol ]
  %dst.21103.i.unr = phi ptr [ %dst.21103.i.ph, %while.body468.i.preheader257 ], [ %incdec.ptr473.i.prol, %while.body468.i.prol ]
  %backsize.11102.i.unr = phi i16 [ %backsize.11102.i.ph, %while.body468.i.preheader257 ], [ %dec466.i.prol, %while.body468.i.prol ]
...
while.body468.i:                                  ; preds = %while.body468.i.prol.loopexit, %while.body468.i
  %dst.21103.i = phi ptr [ %incdec.ptr473.i.7, %while.body468.i ], [ %dst.21103.i.unr, %while.body468.i.prol.loopexit ]
  %backsize.11102.i = phi i16 [ %dec466.i.7, %while.body468.i ], [ %backsize.11102.i.unr, %while.body468.i.prol.loopexit ]
  %add.ptr472.i = getelementptr inbounds i8, ptr %dst.21103.i, i64 %idx.neg409.i
  %93 = load i8, ptr %add.ptr472.i, align 1, !tbaa !9
  store i8 %93, ptr %dst.21103.i, align 1, !tbaa !9
  %incdec.ptr473.i = getelementptr inbounds i8, ptr %dst.21103.i, i64 1
  ...
  %incdec.ptr473.i.1 = getelementptr inbounds i8, ptr %dst.21103.i, i64 2
  ...
  %incdec.ptr473.i.2 = getelementptr inbounds i8, ptr %dst.21103.i, i64 3
  ...
  %incdec.ptr473.i.3 = getelementptr inbounds i8, ptr %dst.21103.i, i64 4
  ...
  %incdec.ptr473.i.4 = getelementptr inbounds i8, ptr %dst.21103.i, i64 5
  ...
  %incdec.ptr473.i.5 = getelementptr inbounds i8, ptr %dst.21103.i, i64 6
  ...
  %incdec.ptr473.i.6 = getelementptr inbounds i8, ptr %dst.21103.i, i64 7
  %dec466.i.7 = add i16 %backsize.11102.i, -8
  ...
  %incdec.ptr473.i.7 = getelementptr inbounds i8, ptr %dst.21103.i, i64 8
...
if.then59.critedge:                               ; preds = %if.then13.i, %land.lhs.true4.i.i, %land.lhs.true2.i68.i, %land.lhs.true4.i73.i, %land.lhs.true449.i, %land.lhs.true413.i, %land.lhs.true406.i, %if.end395.i, %if.else380.i, %land.lhs.true4.i1054.us.2.i, %if.then358.us.2.i, %land.lhs.true4.i1054.us.1.i, %if.then358.us.1.i, %land.lhs.true4.i1054.us.i, %if.then358.us.i, %land.lhs.true4.i73.i1040.i, %land.lhs.true2.i68.i1035.i, %land.lhs.true4.i.i1023.i, %land.lhs.true2.i.i1018.i, %land.lhs.true4.i73.i998.i, %land.lhs.true2.i68.i993.i, %land.lhs.true4.i.i981.i, %land.lhs.true2.i.i976.i, %land.lhs.true4.i958.i, %land.lhs.true2.i953.i, %land.lhs.true4.i946.i, %land.lhs.true2.i941.i, %land.lhs.true4.i73.i932.i, %land.lhs.true2.i68.i927.i, %land.lhs.true4.i.i915.i, %land.lhs.true2.i.i910.i, %land.lhs.true4.i73.i888.i, %land.lhs.true2.i68.i883.i, %land.lhs.true4.i.i871.i, %land.lhs.true2.i.i866.i, %land.lhs.true4.i73.i846.i, %land.lhs.true2.i68.i841.i, %land.lhs.true4.i.i829.i, %land.lhs.true2.i.i824.i, %land.lhs.true4.i806.i, %land.lhs.true2.i801.i, %land.lhs.true4.i794.i, %land.lhs.true2.i789.i, %land.lhs.true4.i73.i780.i, %land.lhs.true2.i68.i775.i, %land.lhs.true4.i.i763.i, %land.lhs.true2.i.i758.i, %land.lhs.true152.i, %land.lhs.true146.i, %if.end136.i, %land.lhs.true4.i73.i738.i, %land.lhs.true2.i68.i733.i, %land.lhs.true4.i.i721.i, %land.lhs.true2.i.i716.i, %land.lhs.true4.i73.i696.i, %land.lhs.true2.i68.i691.i, %land.lhs.true4.i.i679.i, %land.lhs.true2.i.i674.i, %land.lhs.true4.i73.i.i, %land.lhs.true2.i68.i.i, %land.lhs.true4.i.i.i, %land.lhs.true2.i.i.i, %land.lhs.true55.i, %land.lhs.true4.i655.i, %land.lhs.true2.i650.i, %land.lhs.true8.i
  call void @llvm.lifetime.end.p0(i64 1, ptr nonnull %bits.i) #8
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %eax.i) #8
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %bitmap.i) #8
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %src.i) #8
...
while.end:                                        ; preds = %wunpsect.exit
  ...
  %add82206 = select i1 %cmp80.not, i32 0, i32 4096
  %div205207 = add i32 %add82206, %wwpsz
  %mul83 = and i32 %div205207, -4096
  ...
  %tobool93.not227 = icmp eq i16 %sects, 0
  br i1 %tobool93.not227, label %while.end121, label %while.body94.lr.ph
...
while.body94:                                     ; preds = %while.body94.lr.ph, %while.body94
  %sects.addr.0229 = phi i16 [ %sects, %while.body94.lr.ph ], [ %dec, %while.body94 ]
  %stuff.1228 = phi ptr [ %add.ptr91, %while.body94.lr.ph ], [ %add.ptr120, %while.body94 ]
  %dec = add i16 %sects.addr.0229, -1
  %add.ptr95 = getelementptr inbounds i8, ptr %stuff.1228, i64 8
  %add.ptr95.val = load i32, ptr %add.ptr95, align 1
  %add.ptr97 = getelementptr inbounds i8, ptr %stuff.1228, i64 16
  ...
  %add111209 = select i1 %cmp109.not, i32 0, i32 4096
  %div101208210 = add i32 %add111209, %cond
  %mul112 = and i32 %div101208210, -4096
  store i32 %mul112, ptr %add.ptr95, align 1
  store i32 %mul112, ptr %add.ptr97, align 1
  %add.ptr115 = getelementptr inbounds i8, ptr %stuff.1228, i64 20
  %add.ptr116 = getelementptr inbounds i8, ptr %stuff.1228, i64 12
  ...
  %add.ptr120 = getelementptr inbounds i8, ptr %stuff.1228, i64 40
