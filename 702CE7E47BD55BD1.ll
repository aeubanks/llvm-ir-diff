...
if.end179:                                        ; preds = %for.end164
  ...
  %259 = load <2 x float>, ptr %m_origin.i564, align 4, !tbaa !11
  %260 = fadd <2 x float> %258, %259
  %arrayidx11.i569 = getelementptr inbounds %class.btTransform, ptr %transA, i64 0, i32 1, i32 0, i64 2
  %261 = load float, ptr %arrayidx11.i569, align 4, !tbaa !11
  %add14.i = fadd float %mul8.i558, %261
  ...
  store <2 x float> %260, ptr %m_origin3.i584, align 8, !tbaa.struct !13
  ...
  %tobool214 = icmp ne i8 %263, 0
  br i1 %tobool214, label %if.then215, label %if.end226
...
cleanup:                                          ; preds = %for.end164, %if.end226
  %retval.0 = phi i1 [ %tobool214, %if.end226 ], [ false, %for.end164 ]
