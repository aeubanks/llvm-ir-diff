...
for.end:                                          ; preds = %for.body
  ...
  %cmp43672 = icmp sgt i32 %call40, 0
  br i1 %cmp43672, label %for.body44.lr.ph, label %if.end
...
for.body44:                                       ; preds = %for.body44.lr.ph, %for.body44
  %indvars.iv697 = phi i64 [ 42, %for.body44.lr.ph ], [ %indvars.iv.next698, %for.body44 ]
  %i41.0673 = phi i32 [ 0, %for.body44.lr.ph ], [ %inc71, %for.body44 ]
  ...
  call void %42(ptr noundef nonnull align 8 dereferenceable(24) %convexA, i32 noundef %i41.0673, ptr noundef nonnull align 4 dereferenceable(16) %norm45)
  ...
  %arrayidx53 = getelementptr inbounds [62 x %class.btVector3], ptr @_ZL22sPenetrationDirections, i64 0, i64 %indvars.iv697
  ...
  %arrayidx62 = getelementptr inbounds [62 x %class.btVector3], ptr %seperatingAxisInABatch, i64 0, i64 %indvars.iv697
  ...
  %arrayidx68 = getelementptr inbounds [62 x %class.btVector3], ptr %seperatingAxisInBBatch, i64 0, i64 %indvars.iv697
  ...
  %inc71 = add nuw nsw i32 %i41.0673, 1
  %exitcond700.not = icmp eq i32 %inc71, %call40
  br i1 %exitcond700.not, label %if.end.loopexit, label %for.body44

if.end.loopexit:                                  ; preds = %for.body44
  %106 = trunc i64 %indvars.iv.next698 to i32
  br label %if.end
...
if.end:                                           ; preds = %if.end.loopexit, %for.end
  ...
  %cmp80675 = icmp sgt i32 %call75, 0
  br i1 %cmp80675, label %for.body82.lr.ph, label %if.end111
...
for.body82:                                       ; preds = %for.body82.lr.ph, %for.body82
  %indvars.iv701 = phi i64 [ %108, %for.body82.lr.ph ], [ %indvars.iv.next702, %for.body82 ]
  %i78.0676 = phi i32 [ 0, %for.body82.lr.ph ], [ %inc109, %for.body82 ]
  ...
  call void %109(ptr noundef nonnull align 8 dereferenceable(24) %convexB, i32 noundef %i78.0676, ptr noundef nonnull align 4 dereferenceable(16) %norm83)
  %110 = load float, ptr %norm83, align 8, !tbaa !11
  %111 = load float, ptr %arrayidx7.i.i421, align 4, !tbaa !11
  %112 = load float, ptr %arrayidx12.i.i424, align 8, !tbaa !11
  %113 = load <4 x float>, ptr %transB, align 4
  %114 = shufflevector <4 x float> %113, <4 x float> poison, <2 x i32> <i32 0, i32 poison>
  %115 = load <4 x float>, ptr %arrayidx.i.i9.i356, align 4
  %116 = shufflevector <4 x float> %115, <4 x float> poison, <2 x i32> <i32 0, i32 poison>
  %117 = load <4 x float>, ptr %arrayidx.i.i12.i360, align 4
  ...
  %129 = load float, ptr %arrayidx.i14.i13.i361, align 4, !tbaa !11
  ...
  %mul8.i20.i431 = fmul float %111, %135
  %136 = call float @llvm.fmuladd.f32(float %134, float %110, float %mul8.i20.i431)
  ...
  %arrayidx91 = getelementptr inbounds [62 x %class.btVector3], ptr @_ZL22sPenetrationDirections, i64 0, i64 %indvars.iv701
  ...
  %arrayidx100 = getelementptr inbounds [62 x %class.btVector3], ptr %seperatingAxisInABatch, i64 0, i64 %indvars.iv701
  ...
  %arrayidx106 = getelementptr inbounds [62 x %class.btVector3], ptr %seperatingAxisInBBatch, i64 0, i64 %indvars.iv701
  ...
  %inc109 = add nuw nsw i32 %i78.0676, 1
  %exitcond704.not = icmp eq i32 %inc109, %call75
  br i1 %exitcond704.not, label %if.end111.loopexit, label %for.body82

if.end111.loopexit:                               ; preds = %for.body82
  %173 = trunc i64 %indvars.iv.next702 to i32
  br label %if.end111
...
if.end111:                                        ; preds = %if.end111.loopexit, %if.end
  ...
  %cmp120679 = icmp sgt i32 %numSampleDirections.3, 0
  br i1 %cmp120679, label %for.body121.lr.ph, label %for.end164
...
for.body121:                                      ; preds = %for.body121.lr.ph, %if.end161
  %indvars.iv705 = phi i64 [ 0, %for.body121.lr.ph ], [ %indvars.iv.next706, %if.end161 ]
  %minProj.0689 = phi float [ 0x43ABC16D60000000, %for.body121.lr.ph ], [ %minProj.2, %if.end161 ]
  %minNorm.sroa.31.0687 = phi float [ 0.000000e+00, %for.body121.lr.ph ], [ %minNorm.sroa.31.1, %if.end161 ]
  %minNorm.sroa.22.0686 = phi float [ 0.000000e+00, %for.body121.lr.ph ], [ %minNorm.sroa.22.1, %if.end161 ]
  %224 = phi <2 x float> [ zeroinitializer, %for.body121.lr.ph ], [ %254, %if.end161 ]
  %arrayidx124 = getelementptr inbounds [62 x %class.btVector3], ptr @_ZL22sPenetrationDirections, i64 0, i64 %indvars.iv705
...
if.then132:                                       ; preds = %for.body121
  %arrayidx138 = getelementptr inbounds [62 x %class.btVector3], ptr %supportVerticesABatch, i64 0, i64 %indvars.iv705
  ...
  %arrayidx140 = getelementptr inbounds [62 x %class.btVector3], ptr %supportVerticesBBatch, i64 0, i64 %indvars.iv705
  ...
  %cmp158 = fcmp olt float %253, %minProj.0689
...
if.end161:                                        ; preds = %if.then132, %if.then159, %for.body121
  %minNorm.sroa.22.1 = phi float [ %norm122.sroa.8.0, %if.then159 ], [ %minNorm.sroa.22.0686, %if.then132 ], [ %minNorm.sroa.22.0686, %for.body121 ]
  %minNorm.sroa.31.1 = phi float [ %norm122.sroa.11.0.copyload, %if.then159 ], [ %minNorm.sroa.31.0687, %if.then132 ], [ %minNorm.sroa.31.0687, %for.body121 ]
  %minProj.2 = phi float [ %253, %if.then159 ], [ %minProj.0689, %if.then132 ], [ %minProj.0689, %for.body121 ]
  %254 = phi <2 x float> [ %225, %if.then159 ], [ %224, %if.then132 ], [ %224, %for.body121 ]
  %indvars.iv.next706 = add nuw nsw i64 %indvars.iv705, 1
  %exitcond708.not = icmp eq i64 %indvars.iv.next706, %wide.trip.count
  br i1 %exitcond708.not, label %for.end164, label %for.body121
