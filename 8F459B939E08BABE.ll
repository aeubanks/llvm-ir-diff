...
"produce f2":                                     ; preds = %"assert succeeded77"
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 32 dereferenceable(64) %"inv_X4$3.031", ptr noundef nonnull align 4 dereferenceable(64) %scevgep365, i64 64, i1 false)
  %scevgep364.1 = getelementptr inbounds i8, ptr %"inv_X4$3.031", i64 64
  %278 = add i64 %276, %277
  ...
  %scevgep364.2 = getelementptr inbounds i8, ptr %"inv_X4$3.031", i64 128
  ...
  %scevgep364.3 = getelementptr inbounds i8, ptr %"inv_X4$3.031", i64 192
  ...
  %scevgep364.4 = getelementptr inbounds i8, ptr %"inv_X4$3.031", i64 256
  ...
  %scevgep364.5 = getelementptr inbounds i8, ptr %"inv_X4$3.031", i64 320
  ...
  %scevgep364.6 = getelementptr inbounds i8, ptr %"inv_X4$3.031", i64 384
  ...
  %scevgep364.7 = getelementptr inbounds i8, ptr %"inv_X4$3.031", i64 448
  ...
  %scevgep364.8 = getelementptr inbounds i8, ptr %"inv_X4$3.031", i64 512
  ...
  %scevgep364.9 = getelementptr inbounds i8, ptr %"inv_X4$3.031", i64 576
  ...
  %scevgep364.10 = getelementptr inbounds i8, ptr %"inv_X4$3.031", i64 640
  ...
  %scevgep364.11 = getelementptr inbounds i8, ptr %"inv_X4$3.031", i64 704
  ...
  %scevgep364.12 = getelementptr inbounds i8, ptr %"inv_X4$3.031", i64 768
  ...
  %scevgep364.13 = getelementptr inbounds i8, ptr %"inv_X4$3.031", i64 832
  ...
  %scevgep364.14 = getelementptr inbounds i8, ptr %"inv_X4$3.031", i64 896
  ...
  %scevgep364.15 = getelementptr inbounds i8, ptr %"inv_X4$3.031", i64 960
...
"for kernel_fft1_S4_R4_n1.s1.r72$y":              ; preds = %"for kernel_fft1_S4_R4_n1.s1.n0.g", %"for kernel_fft1_S4_R4_n1.s1.r72$y"
  %indvars.iv373 = phi i64 [ 0, %"for kernel_fft1_S4_R4_n1.s1.n0.g" ], [ %indvars.iv.next374, %"for kernel_fft1_S4_R4_n1.s1.r72$y" ]
  ...
  %579 = getelementptr inbounds float, ptr %f1.037, i64 %indvars.iv373
  ...
  %586 = getelementptr inbounds float, ptr %f1.136, i64 %indvars.iv373
...
"for result.s0.i.preheader":                      ; preds = %"produce result"
  ...
  %692 = zext i32 %a11 to i64
  %693 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.019, i64 8
  %694 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.118, i64 8
  %695 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.019, i64 16
  %696 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.118, i64 16
  %697 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.019, i64 24
  %698 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.118, i64 24
  %699 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.019, i64 32
  %700 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.118, i64 32
  %701 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.019, i64 40
  %702 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.118, i64 40
  %703 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.019, i64 48
  %704 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.118, i64 48
  %705 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.019, i64 56
  %706 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.118, i64 56
  %707 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.019, i64 64
  %708 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.118, i64 64
  %709 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.019, i64 72
  %710 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.118, i64 72
  %711 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.019, i64 80
  %712 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.118, i64 80
  %713 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.019, i64 88
  %714 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.118, i64 88
  %715 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.019, i64 96
  %716 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.118, i64 96
  %717 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.019, i64 104
  %718 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.118, i64 104
  %719 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.019, i64 112
  %720 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.118, i64 112
  %721 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.019, i64 120
  %722 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.118, i64 120
  %723 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.019, i64 8
  %724 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.118, i64 8
  %725 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.019, i64 16
  %726 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.118, i64 16
  %727 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.019, i64 24
  %728 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.118, i64 24
  %729 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.019, i64 32
  %730 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.118, i64 32
  %731 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.019, i64 40
  %732 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.118, i64 40
  %733 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.019, i64 48
  %734 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.118, i64 48
  %735 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.019, i64 56
  %736 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.118, i64 56
  %737 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.019, i64 64
  %738 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.118, i64 64
  %739 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.019, i64 72
  %740 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.118, i64 72
  %741 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.019, i64 80
  %742 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.118, i64 80
  %743 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.019, i64 88
  %744 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.118, i64 88
  %745 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.019, i64 96
  %746 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.118, i64 96
  %747 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.019, i64 104
  %748 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.118, i64 104
  %749 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.019, i64 112
  %750 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.118, i64 112
  %751 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.019, i64 120
  %752 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.118, i64 120
  %xtraiter = and i64 %692, 1
  %753 = icmp eq i32 %a11, 1
...
"for result.s0.i":                                ; preds = %"for result.s0.i.preheader", %"end for result.s0.n1"
  %indvars.iv401 = phi i64 [ %688, %"for result.s0.i.preheader" ], [ %indvars.iv.next402, %"end for result.s0.n1" ]
  %reass.add73 = sub nsw i64 %indvars.iv401, %675
  %reass.mul74 = mul i64 %reass.add73, %228
  %754 = sub i64 %reass.mul74, %673
  %755 = load <4 x float>, ptr %f0.039, align 32
  %756 = load <4 x float>, ptr %f0.138, align 32
...
"for fwd_fft0_S4_R4_n0.s1.n1":                    ; preds = %"for result.s0.i", %"for fwd_fft0_S4_R4_n0.s1.n1"
  %indvars.iv376 = phi i64 [ 0, %"for result.s0.i" ], [ %indvars.iv.next377, %"for fwd_fft0_S4_R4_n0.s1.n1" ]
  ...
  %v_inv_fft0_S4_R4_n0.029.sroa.0.0.vec.extract425 = shufflevector <16 x float> %787, <16 x float> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %v_inv_fft0_S4_R4_n0.128.sroa.0.0.vec.extract437 = shufflevector <16 x float> %790, <16 x float> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %v_inv_fft0_S4_R4_n0.029.sroa.0.16.vec.extract428 = shufflevector <16 x float> %787, <16 x float> undef, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
  %792 = fmul <4 x float> %v_inv_fft0_S4_R4_n0.029.sroa.0.16.vec.extract428, %755
  %v_inv_fft0_S4_R4_n0.128.sroa.0.16.vec.extract440 = shufflevector <16 x float> %790, <16 x float> undef, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
  %793 = fmul <4 x float> %v_inv_fft0_S4_R4_n0.128.sroa.0.16.vec.extract440, %756
  %794 = fsub <4 x float> %792, %793
  %795 = fmul <4 x float> %v_inv_fft0_S4_R4_n0.029.sroa.0.16.vec.extract428, %756
  %796 = fmul <4 x float> %755, %v_inv_fft0_S4_R4_n0.128.sroa.0.16.vec.extract440
  %797 = fadd <4 x float> %796, %795
  %v_inv_fft0_S4_R4_n0.029.sroa.8.32.vec.extract431 = shufflevector <8 x float> %788, <8 x float> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %798 = fmul <4 x float> %v_inv_fft0_S4_R4_n0.029.sroa.8.32.vec.extract431, %758
  %v_inv_fft0_S4_R4_n0.128.sroa.8.32.vec.extract443 = shufflevector <8 x float> %791, <8 x float> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %799 = fmul <4 x float> %v_inv_fft0_S4_R4_n0.128.sroa.8.32.vec.extract443, %760
  %800 = fsub <4 x float> %798, %799
  %801 = fmul <4 x float> %v_inv_fft0_S4_R4_n0.029.sroa.8.32.vec.extract431, %760
  %802 = fmul <4 x float> %v_inv_fft0_S4_R4_n0.128.sroa.8.32.vec.extract443, %758
  %803 = fadd <4 x float> %802, %801
  %v_inv_fft0_S4_R4_n0.029.sroa.8.48.vec.extract434 = shufflevector <8 x float> %788, <8 x float> poison, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
  %804 = fmul <4 x float> %v_inv_fft0_S4_R4_n0.029.sroa.8.48.vec.extract434, %766
  %v_inv_fft0_S4_R4_n0.128.sroa.8.48.vec.extract446 = shufflevector <8 x float> %791, <8 x float> poison, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
  %805 = fmul <4 x float> %v_inv_fft0_S4_R4_n0.128.sroa.8.48.vec.extract446, %772
  %806 = fsub <4 x float> %804, %805
  %807 = fmul <4 x float> %v_inv_fft0_S4_R4_n0.029.sroa.8.48.vec.extract434, %772
  %808 = fmul <4 x float> %v_inv_fft0_S4_R4_n0.128.sroa.8.48.vec.extract446, %766
  %809 = fadd <4 x float> %808, %807
  %810 = fadd <4 x float> %v_inv_fft0_S4_R4_n0.029.sroa.0.0.vec.extract425, %800
  %811 = fadd <4 x float> %v_inv_fft0_S4_R4_n0.128.sroa.0.0.vec.extract437, %803
  ...
  %818 = fsub <4 x float> %v_inv_fft0_S4_R4_n0.029.sroa.0.0.vec.extract425, %800
  %819 = fsub <4 x float> %v_inv_fft0_S4_R4_n0.128.sroa.0.0.vec.extract437, %803
  ...
  %827 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.033, i64 %826
  store <4 x float> %814, ptr %827, align 32, !tbaa !134
  %828 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.132, i64 %826
  store <4 x float> %815, ptr %828, align 32, !tbaa !136
  %829 = or i64 %826, 4
  %830 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.033, i64 %829
  store <4 x float> %822, ptr %830, align 16, !tbaa !134
  %831 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.132, i64 %829
  store <4 x float> %823, ptr %831, align 16, !tbaa !136
  %832 = add nuw nsw i64 %826, 8
  %833 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.033, i64 %832
  store <4 x float> %816, ptr %833, align 32, !tbaa !134
  %834 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.132, i64 %832
...
"for fwd_fft1_S4_R4_n1.s1.n0.g":                  ; preds = %"for fwd_fft0_S4_R4_n0.s1.n1", %"end for fwd_fft1_S4_R4_n1.s1.r26$y"
  ...
  %838 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.033, i64 %fwd_fft1_S4_R4_n1.s1.n0.g
  %839 = load <8 x float>, ptr %838, align 32, !tbaa !134
  %840 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.132, i64 %fwd_fft1_S4_R4_n1.s1.n0.g
  %841 = load <8 x float>, ptr %840, align 32, !tbaa !136
  %842 = or i64 %fwd_fft1_S4_R4_n1.s1.n0.g, 96
  %843 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.033, i64 %842
  %844 = load <8 x float>, ptr %843, align 32, !tbaa !134
  %845 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.132, i64 %842
  ...
  store <8 x float> %847, ptr %inv_exchange_S1_R4_n1.019, align 32, !tbaa !148
  store <8 x float> %848, ptr %inv_exchange_S1_R4_n1.118, align 32, !tbaa !150
  ...
  %875 = or i64 %fwd_fft1_S4_R4_n1.s1.n0.g, 48
  %876 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.033, i64 %875
  %877 = load <8 x float>, ptr %876, align 32, !tbaa !134
  %878 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.132, i64 %875
  %879 = load <8 x float>, ptr %878, align 32, !tbaa !136
  %880 = or i64 %fwd_fft1_S4_R4_n1.s1.n0.g, 144
  %881 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.033, i64 %880
  %882 = load <8 x float>, ptr %881, align 32, !tbaa !134
  %883 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.132, i64 %880
  ...
  %894 = add nuw nsw i64 %fwd_fft1_S4_R4_n1.s1.n0.g, 72
  %895 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.033, i64 %894
  %896 = load <8 x float>, ptr %895, align 32, !tbaa !134
  %897 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.132, i64 %894
  %898 = load <8 x float>, ptr %897, align 32, !tbaa !136
  %899 = add nuw nsw i64 %fwd_fft1_S4_R4_n1.s1.n0.g, 168
  %900 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.033, i64 %899
  %901 = load <8 x float>, ptr %900, align 32, !tbaa !134
  %902 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.132, i64 %899
...
"for fwd_fft1_S4_R4_n1.s1.r26$y":                 ; preds = %"for fwd_fft1_S4_R4_n1.s1.n0.g", %"for fwd_fft1_S4_R4_n1.s1.r26$y"
  ...
  %914 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.019, i64 %913
  %915 = load <8 x float>, ptr %914, align 32, !tbaa !148
  %916 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.118, i64 %913
  %917 = load <8 x float>, ptr %916, align 32, !tbaa !150
  %918 = add nuw nsw i64 %913, 32
  %919 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.019, i64 %918
  %920 = load <8 x float>, ptr %919, align 32, !tbaa !148
  %921 = getelementptr inbounds float, ptr %f0.039, i64 %indvars.iv382
  ...
  %926 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.118, i64 %918
  %927 = load <8 x float>, ptr %926, align 32, !tbaa !150
  %928 = getelementptr inbounds float, ptr %f0.138, i64 %indvars.iv382
  ...
  %938 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.019, i64 %937
  %939 = load <8 x float>, ptr %938, align 32, !tbaa !148
  %940 = shl nuw nsw i64 %indvars.iv382, 1
  %941 = getelementptr inbounds float, ptr %f0.039, i64 %940
  ...
  %946 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.118, i64 %937
  %947 = load <8 x float>, ptr %946, align 32, !tbaa !150
  %948 = getelementptr inbounds float, ptr %f0.138, i64 %940
  ...
  %958 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.019, i64 %957
  %959 = load <8 x float>, ptr %958, align 32, !tbaa !148
  %960 = mul nuw nsw i64 %indvars.iv382, 3
  %961 = getelementptr inbounds float, ptr %f0.039, i64 %960
  ...
  %966 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.118, i64 %957
  %967 = load <8 x float>, ptr %966, align 32, !tbaa !150
  %968 = getelementptr inbounds float, ptr %f0.138, i64 %960
  ...
  %994 = or i64 %993, %fwd_fft1_S4_R4_n1.s1.n0.g
  %995 = getelementptr inbounds float, ptr %"inv_X4$3.031", i64 %994
  store <8 x float> %981, ptr %995, align 32, !tbaa !132
  %996 = getelementptr inbounds float, ptr %"inv_X4$3.130", i64 %994
  store <8 x float> %982, ptr %996, align 32, !tbaa !130
  %997 = add nuw nsw i64 %994, 64
  %998 = getelementptr inbounds float, ptr %"inv_X4$3.031", i64 %997
  store <8 x float> %989, ptr %998, align 32, !tbaa !132
  %999 = getelementptr inbounds float, ptr %"inv_X4$3.130", i64 %997
  store <8 x float> %990, ptr %999, align 32, !tbaa !130
  %1000 = add nuw nsw i64 %994, 128
  %1001 = getelementptr inbounds float, ptr %"inv_X4$3.031", i64 %1000
  store <8 x float> %983, ptr %1001, align 32, !tbaa !132
  %1002 = getelementptr inbounds float, ptr %"inv_X4$3.130", i64 %1000
  store <8 x float> %984, ptr %1002, align 32, !tbaa !130
  %1003 = add nuw nsw i64 %994, 192
  %1004 = getelementptr inbounds float, ptr %"inv_X4$3.031", i64 %1003
  store <8 x float> %991, ptr %1004, align 32, !tbaa !132
  %1005 = getelementptr inbounds float, ptr %"inv_X4$3.130", i64 %1003
...
"assert failed80":                                ; preds = %"consume fwd_fft1_S4_R4_n1"
  %1006 = tail call i32 @halide_error_explicit_bounds_too_small(ptr null, ptr nonnull @str.11, ptr nonnull @str.12, i32 0, i32 15, i32 %84, i32 %b2) #2
  br label %destructor_block
...
"assert failed82":                                ; preds = %"assert succeeded81"
  ...
  %1008 = tail call i32 @halide_error_explicit_bounds_too_small(ptr null, ptr nonnull @str.13, ptr nonnull @str.12, i32 0, i32 15, i32 %1007, i32 %a4) #2
  br label %destructor_block
...
"for inv_fft0_S4_R4_n0.s1.n1.preheader":          ; preds = %"assert succeeded83"
  %1009 = load <4 x float>, ptr %f2.041, align 32
  %1010 = load <4 x float>, ptr %f2.140, align 32
...
"for inv_fft0_S4_R4_n0.s1.n1":                    ; preds = %"for inv_fft0_S4_R4_n0.s1.n1.preheader", %"for inv_fft0_S4_R4_n0.s1.n1"
  ...
  %1029 = getelementptr inbounds float, ptr %"inv_X4$3.031", i64 %1028
  %1030 = load <4 x float>, ptr %1029, align 32, !tbaa !132
  %1031 = getelementptr inbounds float, ptr %kernel_fft1_S4_R4_n1.035, i64 %1028
  %1032 = load <4 x float>, ptr %1031, align 32, !tbaa !140
  %1033 = fmul <4 x float> %1030, %1032
  %1034 = getelementptr inbounds float, ptr %"inv_X4$3.130", i64 %1028
  %1035 = load <4 x float>, ptr %1034, align 32, !tbaa !130
  %1036 = getelementptr inbounds float, ptr %kernel_fft1_S4_R4_n1.134, i64 %1028
  %1037 = load <4 x float>, ptr %1036, align 32, !tbaa !142
  %1038 = fmul <4 x float> %1035, %1037
  %1039 = fsub <4 x float> %1033, %1038
  %1040 = or i64 %1028, 8
  %1041 = getelementptr inbounds float, ptr %"inv_X4$3.031", i64 %1040
  %1042 = load <4 x float>, ptr %1041, align 32, !tbaa !132
  %1043 = getelementptr inbounds float, ptr %kernel_fft1_S4_R4_n1.035, i64 %1040
  %1044 = load <4 x float>, ptr %1043, align 32, !tbaa !140
  %1045 = fmul <4 x float> %1042, %1044
  %1046 = getelementptr inbounds float, ptr %"inv_X4$3.130", i64 %1040
  %1047 = load <4 x float>, ptr %1046, align 32, !tbaa !130
  %1048 = getelementptr inbounds float, ptr %kernel_fft1_S4_R4_n1.134, i64 %1040
  ...
  %1060 = or i64 %1028, 4
  %1061 = getelementptr inbounds float, ptr %"inv_X4$3.031", i64 %1060
  %1062 = load <4 x float>, ptr %1061, align 16, !tbaa !132
  %1063 = getelementptr inbounds float, ptr %kernel_fft1_S4_R4_n1.035, i64 %1060
  %1064 = load <4 x float>, ptr %1063, align 16, !tbaa !140
  %1065 = fmul <4 x float> %1062, %1064
  %1066 = getelementptr inbounds float, ptr %"inv_X4$3.130", i64 %1060
  %1067 = load <4 x float>, ptr %1066, align 16, !tbaa !130
  %1068 = getelementptr inbounds float, ptr %kernel_fft1_S4_R4_n1.134, i64 %1060
  %1069 = load <4 x float>, ptr %1068, align 16, !tbaa !142
  %1070 = fmul <4 x float> %1067, %1069
  %1071 = fsub <4 x float> %1065, %1070
  %1072 = or i64 %1028, 12
  %1073 = getelementptr inbounds float, ptr %"inv_X4$3.031", i64 %1072
  %1074 = load <4 x float>, ptr %1073, align 16, !tbaa !132
  %1075 = getelementptr inbounds float, ptr %kernel_fft1_S4_R4_n1.035, i64 %1072
  %1076 = load <4 x float>, ptr %1075, align 16, !tbaa !140
  %1077 = fmul <4 x float> %1074, %1076
  %1078 = getelementptr inbounds float, ptr %"inv_X4$3.130", i64 %1072
  %1079 = load <4 x float>, ptr %1078, align 16, !tbaa !130
  %1080 = getelementptr inbounds float, ptr %kernel_fft1_S4_R4_n1.134, i64 %1072
  ...
  %inv_exchange_S1_R4_n0.026.sroa.0.0.vec.extract = shufflevector <16 x float> %1108, <16 x float> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %inv_exchange_S1_R4_n0.127.sroa.0.0.vec.extract = shufflevector <16 x float> %1112, <16 x float> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %inv_exchange_S1_R4_n0.026.sroa.0.16.vec.extract = shufflevector <16 x float> %1108, <16 x float> undef, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
  %1114 = fmul <4 x float> %inv_exchange_S1_R4_n0.026.sroa.0.16.vec.extract, %1009
  %inv_exchange_S1_R4_n0.127.sroa.0.16.vec.extract = shufflevector <16 x float> %1112, <16 x float> undef, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
  %1115 = fmul <4 x float> %inv_exchange_S1_R4_n0.127.sroa.0.16.vec.extract, %1010
  %1116 = fsub <4 x float> %1114, %1115
  %1117 = fmul <4 x float> %inv_exchange_S1_R4_n0.026.sroa.0.16.vec.extract, %1010
  %1118 = fmul <4 x float> %1009, %inv_exchange_S1_R4_n0.127.sroa.0.16.vec.extract
  %1119 = fadd <4 x float> %1118, %1117
  %inv_exchange_S1_R4_n0.026.sroa.7.32.vec.extract = shufflevector <8 x float> %1109, <8 x float> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %1120 = fmul <4 x float> %inv_exchange_S1_R4_n0.026.sroa.7.32.vec.extract, %1012
  %inv_exchange_S1_R4_n0.127.sroa.7.32.vec.extract = shufflevector <8 x float> %1113, <8 x float> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %1121 = fmul <4 x float> %inv_exchange_S1_R4_n0.127.sroa.7.32.vec.extract, %1014
  %1122 = fsub <4 x float> %1120, %1121
  %1123 = fmul <4 x float> %inv_exchange_S1_R4_n0.026.sroa.7.32.vec.extract, %1014
  %1124 = fmul <4 x float> %inv_exchange_S1_R4_n0.127.sroa.7.32.vec.extract, %1012
  %1125 = fadd <4 x float> %1124, %1123
  %inv_exchange_S1_R4_n0.026.sroa.7.48.vec.extract = shufflevector <8 x float> %1109, <8 x float> poison, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
  %1126 = fmul <4 x float> %inv_exchange_S1_R4_n0.026.sroa.7.48.vec.extract, %1020
  %inv_exchange_S1_R4_n0.127.sroa.7.48.vec.extract = shufflevector <8 x float> %1113, <8 x float> poison, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
  %1127 = fmul <4 x float> %inv_exchange_S1_R4_n0.127.sroa.7.48.vec.extract, %1026
  %1128 = fsub <4 x float> %1126, %1127
  %1129 = fmul <4 x float> %inv_exchange_S1_R4_n0.026.sroa.7.48.vec.extract, %1026
  %1130 = fmul <4 x float> %inv_exchange_S1_R4_n0.127.sroa.7.48.vec.extract, %1020
  %1131 = fadd <4 x float> %1130, %1129
  %1132 = fadd <4 x float> %inv_exchange_S1_R4_n0.026.sroa.0.0.vec.extract, %1122
  %1133 = fadd <4 x float> %inv_exchange_S1_R4_n0.127.sroa.0.0.vec.extract, %1125
  ...
  %1140 = fsub <4 x float> %inv_exchange_S1_R4_n0.026.sroa.0.0.vec.extract, %1122
  %1141 = fsub <4 x float> %inv_exchange_S1_R4_n0.127.sroa.0.0.vec.extract, %1125
  ...
  %1149 = getelementptr inbounds float, ptr %inv_fft0_S4_R4_n0.017, i64 %1148
  store <4 x float> %1136, ptr %1149, align 32, !tbaa !156
  %1150 = getelementptr inbounds float, ptr %inv_fft0_S4_R4_n0.116, i64 %1148
  store <4 x float> %1137, ptr %1150, align 32, !tbaa !158
  %1151 = or i64 %1148, 4
  %1152 = getelementptr inbounds float, ptr %inv_fft0_S4_R4_n0.017, i64 %1151
  store <4 x float> %1144, ptr %1152, align 16, !tbaa !156
  %1153 = getelementptr inbounds float, ptr %inv_fft0_S4_R4_n0.116, i64 %1151
  store <4 x float> %1145, ptr %1153, align 16, !tbaa !158
  %1154 = add nuw nsw i64 %1148, 8
  %1155 = getelementptr inbounds float, ptr %inv_fft0_S4_R4_n0.017, i64 %1154
  store <4 x float> %1138, ptr %1155, align 32, !tbaa !156
  %1156 = getelementptr inbounds float, ptr %inv_fft0_S4_R4_n0.116, i64 %1154
  store <4 x float> %1139, ptr %1156, align 32, !tbaa !158
  %1157 = add nuw nsw i64 %1148, 12
  %1158 = getelementptr inbounds float, ptr %inv_fft0_S4_R4_n0.017, i64 %1157
  store <4 x float> %1146, ptr %1158, align 16, !tbaa !156
  %1159 = getelementptr inbounds float, ptr %inv_fft0_S4_R4_n0.116, i64 %1157
...
"for inv_fft1_S4_R4_n1.s1.n0.g":                  ; preds = %"for inv_fft0_S4_R4_n0.s1.n1", %"end for inv_fft1_S4_R4_n1.s1.r119$y"
  ...
  %1160 = getelementptr inbounds float, ptr %inv_fft0_S4_R4_n0.017, i64 %inv_fft1_S4_R4_n1.s1.n0.g
  %1161 = load <8 x float>, ptr %1160, align 32, !tbaa !156
  %1162 = or i64 %inv_fft1_S4_R4_n1.s1.n0.g, 192
  %1163 = getelementptr inbounds float, ptr %inv_fft0_S4_R4_n0.017, i64 %1162
  %1164 = load <8 x float>, ptr %1163, align 32, !tbaa !156
  %1165 = fadd <8 x float> %1161, %1164
  %1166 = getelementptr inbounds float, ptr %inv_fft0_S4_R4_n0.116, i64 %inv_fft1_S4_R4_n1.s1.n0.g
  %1167 = load <8 x float>, ptr %1166, align 32, !tbaa !158
  %1168 = getelementptr inbounds float, ptr %inv_fft0_S4_R4_n0.116, i64 %1162
  %1169 = load <8 x float>, ptr %1168, align 32, !tbaa !158
  %1170 = fadd <8 x float> %1167, %1169
  %1171 = or i64 %inv_fft1_S4_R4_n1.s1.n0.g, 96
  %1172 = getelementptr inbounds float, ptr %inv_fft0_S4_R4_n0.017, i64 %1171
  %1173 = load <8 x float>, ptr %1172, align 32, !tbaa !156
  %1174 = or i64 %inv_fft1_S4_R4_n1.s1.n0.g, 288
  %1175 = getelementptr inbounds float, ptr %inv_fft0_S4_R4_n0.017, i64 %1174
  %1176 = load <8 x float>, ptr %1175, align 32, !tbaa !156
  %1177 = fadd <8 x float> %1173, %1176
  %1178 = getelementptr inbounds float, ptr %inv_fft0_S4_R4_n0.116, i64 %1171
  %1179 = load <8 x float>, ptr %1178, align 32, !tbaa !158
  %1180 = getelementptr inbounds float, ptr %inv_fft0_S4_R4_n0.116, i64 %1174
  ...
  store <8 x float> %1183, ptr %inv_exchange_S1_R4_n1.019, align 32, !tbaa !148
  store <8 x float> %1184, ptr %inv_exchange_S1_R4_n1.118, align 32, !tbaa !150
  ...
  %1195 = add nuw nsw i64 %inv_fft1_S4_R4_n1.s1.n0.g, 24
  %1196 = getelementptr inbounds float, ptr %inv_fft0_S4_R4_n0.017, i64 %1195
  %1197 = load <8 x float>, ptr %1196, align 32, !tbaa !156
  %1198 = add nuw nsw i64 %inv_fft1_S4_R4_n1.s1.n0.g, 216
  %1199 = getelementptr inbounds float, ptr %inv_fft0_S4_R4_n0.017, i64 %1198
  %1200 = load <8 x float>, ptr %1199, align 32, !tbaa !156
  %1201 = fadd <8 x float> %1197, %1200
  %1202 = getelementptr inbounds float, ptr %inv_fft0_S4_R4_n0.116, i64 %1195
  %1203 = load <8 x float>, ptr %1202, align 32, !tbaa !158
  %1204 = getelementptr inbounds float, ptr %inv_fft0_S4_R4_n0.116, i64 %1198
  %1205 = load <8 x float>, ptr %1204, align 32, !tbaa !158
  %1206 = fadd <8 x float> %1203, %1205
  %1207 = add nuw nsw i64 %inv_fft1_S4_R4_n1.s1.n0.g, 120
  %1208 = getelementptr inbounds float, ptr %inv_fft0_S4_R4_n0.017, i64 %1207
  %1209 = load <8 x float>, ptr %1208, align 32, !tbaa !156
  %1210 = add nuw nsw i64 %inv_fft1_S4_R4_n1.s1.n0.g, 312
  %1211 = getelementptr inbounds float, ptr %inv_fft0_S4_R4_n0.017, i64 %1210
  %1212 = load <8 x float>, ptr %1211, align 32, !tbaa !156
  %1213 = fadd <8 x float> %1209, %1212
  %1214 = getelementptr inbounds float, ptr %inv_fft0_S4_R4_n0.116, i64 %1207
  %1215 = load <8 x float>, ptr %1214, align 32, !tbaa !158
  %1216 = getelementptr inbounds float, ptr %inv_fft0_S4_R4_n0.116, i64 %1210
  ...
  %1250 = getelementptr inbounds float, ptr %inv_fft0_S4_R4_n0.116, i64 %1243
  %1251 = load <8 x float>, ptr %1250, align 32, !tbaa !158
  %1252 = getelementptr inbounds float, ptr %inv_fft0_S4_R4_n0.116, i64 %1246
  ...
  %1267 = add nuw nsw i64 %inv_fft1_S4_R4_n1.s1.n0.g, 72
  %1268 = getelementptr inbounds float, ptr %inv_fft0_S4_R4_n0.017, i64 %1267
  %1269 = load <8 x float>, ptr %1268, align 32, !tbaa !156
  %1270 = add nuw nsw i64 %inv_fft1_S4_R4_n1.s1.n0.g, 264
  %1271 = getelementptr inbounds float, ptr %inv_fft0_S4_R4_n0.017, i64 %1270
  %1272 = load <8 x float>, ptr %1271, align 32, !tbaa !156
  %1273 = fadd <8 x float> %1269, %1272
  %1274 = getelementptr inbounds float, ptr %inv_fft0_S4_R4_n0.116, i64 %1267
  %1275 = load <8 x float>, ptr %1274, align 32, !tbaa !158
  %1276 = getelementptr inbounds float, ptr %inv_fft0_S4_R4_n0.116, i64 %1270
  %1277 = load <8 x float>, ptr %1276, align 32, !tbaa !158
  %1278 = fadd <8 x float> %1275, %1277
  %1279 = add nuw nsw i64 %inv_fft1_S4_R4_n1.s1.n0.g, 168
  %1280 = getelementptr inbounds float, ptr %inv_fft0_S4_R4_n0.017, i64 %1279
  %1281 = load <8 x float>, ptr %1280, align 32, !tbaa !156
  %1282 = add nuw nsw i64 %inv_fft1_S4_R4_n1.s1.n0.g, 360
  %1283 = getelementptr inbounds float, ptr %inv_fft0_S4_R4_n0.017, i64 %1282
  %1284 = load <8 x float>, ptr %1283, align 32, !tbaa !156
  %1285 = fadd <8 x float> %1281, %1284
  %1286 = getelementptr inbounds float, ptr %inv_fft0_S4_R4_n0.116, i64 %1279
  %1287 = load <8 x float>, ptr %1286, align 32, !tbaa !158
  %1288 = getelementptr inbounds float, ptr %inv_fft0_S4_R4_n0.116, i64 %1282
...
"for inv_fft1_S4_R4_n1.s1.r119$y":                ; preds = %"for inv_fft1_S4_R4_n1.s1.n0.g", %"for inv_fft1_S4_R4_n1.s1.r119$y"
  ...
  %1304 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.019, i64 %1303
  %1305 = load <8 x float>, ptr %1304, align 32, !tbaa !148
  %1306 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.118, i64 %1303
  %1307 = load <8 x float>, ptr %1306, align 32, !tbaa !150
  %1308 = add nuw nsw i64 %1303, 32
  %1309 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.019, i64 %1308
  %1310 = load <8 x float>, ptr %1309, align 32, !tbaa !148
  %1311 = getelementptr inbounds float, ptr %f2.041, i64 %indvars.iv392
  ...
  %1316 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.118, i64 %1308
  %1317 = load <8 x float>, ptr %1316, align 32, !tbaa !150
  %1318 = getelementptr inbounds float, ptr %f2.140, i64 %indvars.iv392
  ...
  %1328 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.019, i64 %1327
  %1329 = load <8 x float>, ptr %1328, align 32, !tbaa !148
  %1330 = shl nuw nsw i64 %indvars.iv392, 1
  %1331 = getelementptr inbounds float, ptr %f2.041, i64 %1330
  ...
  %1336 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.118, i64 %1327
  %1337 = load <8 x float>, ptr %1336, align 32, !tbaa !150
  %1338 = getelementptr inbounds float, ptr %f2.140, i64 %1330
  ...
  %1348 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.019, i64 %1347
  %1349 = load <8 x float>, ptr %1348, align 32, !tbaa !148
  %1350 = mul nuw nsw i64 %indvars.iv392, 3
  %1351 = getelementptr inbounds float, ptr %f2.041, i64 %1350
  ...
  %1356 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.118, i64 %1347
  %1357 = load <8 x float>, ptr %1356, align 32, !tbaa !150
  %1358 = getelementptr inbounds float, ptr %f2.140, i64 %1350
  ...
  %1384 = or i64 %1383, %inv_fft1_S4_R4_n1.s1.n0.g
  %1385 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.033, i64 %1384
  store <8 x float> %1371, ptr %1385, align 32, !tbaa !134
  %1386 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.132, i64 %1384
  store <8 x float> %1372, ptr %1386, align 32, !tbaa !136
  %1387 = add nuw nsw i64 %1384, 64
  %1388 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.033, i64 %1387
  store <8 x float> %1379, ptr %1388, align 32, !tbaa !134
  %1389 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.132, i64 %1387
  store <8 x float> %1380, ptr %1389, align 32, !tbaa !136
  %1390 = add nuw nsw i64 %1384, 128
  %1391 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.033, i64 %1390
  store <8 x float> %1373, ptr %1391, align 32, !tbaa !134
  %1392 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.132, i64 %1390
  store <8 x float> %1374, ptr %1392, align 32, !tbaa !136
  %1393 = add nuw nsw i64 %1384, 192
  %1394 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.033, i64 %1393
  store <8 x float> %1381, ptr %1394, align 32, !tbaa !134
  %1395 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.132, i64 %1393
...
"consume inv_fft1_S4_R4_n1":                      ; preds = %"end for inv_fft1_S4_R4_n1.s1.r119$y"
  ...
  store <8 x float> %1375, ptr %"inv_X4$3.031", align 32, !tbaa !180
  store <8 x float> %1376, ptr %"inv_X4$3.130", align 32, !tbaa !182
...
"for result.s0.n1":                               ; preds = %"for result.s0.n1.preheader", %"end for result.s0.n0.n091"
  %indvars.iv398 = phi i64 [ %687, %"for result.s0.n1.preheader" ], [ %indvars.iv.next399, %"end for result.s0.n0.n091" ]
  br i1 %.not325, label %"end for result.s0.n0.n0", label %"for result.s0.n0.n0.preheader", !prof !5
...
"for result.s0.n0.n0.preheader":                  ; preds = %"for result.s0.n1"
  ...
  br i1 %753, label %"end for result.s0.n0.n0.loopexit.unr-lcssa", label %"for result.s0.n0.n0"
...
"for result.s0.n0.n0":                            ; preds = %"for result.s0.n0.n0.preheader", %"for result.s0.n0.n0"
  ...
  %1404 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.033, i64 %1403
  ...
  %1412 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.033, i64 %1411
...
"for result.s0.n0.n0.epil":                       ; preds = %"end for result.s0.n0.n0.loopexit.unr-lcssa"
  ...
  %1420 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.033, i64 %1419
...
"end for result.s0.n0.n0":                        ; preds = %"for result.s0.n0.n0.epil", %"end for result.s0.n0.n0.loopexit.unr-lcssa", %"for result.s0.n1"
  br i1 %685, label %"for result.s0.n0.n090.preheader", label %"end for result.s0.n0.n091", !prof !26

"for result.s0.n0.n090.preheader":                ; preds = %"end for result.s0.n0.n0"
  %1425 = shl nsw i64 %indvars.iv398, 4
  %1426 = add nsw i64 %690, %1425
  %1427 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.033, i64 %1426
