...
if.end15:                                         ; preds = %put_int.exit, %entry
  %next.phi.trans.insert = getelementptr inbounds %struct.status, ptr %out, i64 0, i32 4
  %.pre = load ptr, ptr %next.phi.trans.insert, align 8, !tbaa !5
  %limit = getelementptr inbounds %struct.status, ptr %out, i64 0, i32 1
  %17 = load ptr, ptr %limit, align 8, !tbaa !14
  br i1 %cmp9, label %if.end24, label %if.then18

if.then18:                                        ; preds = %if.end15
  %add.ptr.i87 = getelementptr inbounds i8, ptr %.pre, i64 5
  %cmp.i89 = icmp ugt ptr %add.ptr.i87, %17
  br i1 %cmp.i89, label %cleanup, label %if.end.i91

if.end.i91:                                       ; preds = %if.then18
  %18 = add i32 %sub7, 107
  %or.cond.i90 = icmp ult i32 %18, 215
  br i1 %or.cond.i90, label %if.then3.i94, label %if.else.i96

if.then3.i94:                                     ; preds = %if.end.i91
  %19 = trunc i32 %sub7 to i8
  %conv.i92 = add i8 %19, -117
  %incdec.ptr.i93 = getelementptr inbounds i8, ptr %.pre, i64 1
  store i8 %conv.i92, ptr %.pre, align 1, !tbaa !15
  br label %if.end24.thread

if.else.i96:                                      ; preds = %if.end.i91
  %20 = add i32 %sub7, -108
  %or.cond57.i95 = icmp ult i32 %20, 1024
  br i1 %or.cond57.i95, label %if.then9.i102, label %if.else17.i104

if.then9.i102:                                    ; preds = %if.else.i96
  %shr.i97 = lshr i32 %20, 8
  %21 = trunc i32 %shr.i97 to i8
  %conv13.i98 = add nuw nsw i8 %21, -9
  %incdec.ptr14.i99 = getelementptr inbounds i8, ptr %.pre, i64 1
  store i8 %conv13.i98, ptr %.pre, align 1, !tbaa !15
  %conv15.i100 = trunc i32 %20 to i8
  %incdec.ptr16.i101 = getelementptr inbounds i8, ptr %.pre, i64 2
  store i8 %conv15.i100, ptr %incdec.ptr14.i99, align 1, !tbaa !15
  br label %if.end24.thread

if.else17.i104:                                   ; preds = %if.else.i96
  %22 = add i32 %sub7, 1131
  %or.cond58.i103 = icmp ult i32 %22, 1024
...
if.then23.i111:                                   ; preds = %if.else17.i104
  ...
  %23 = trunc i32 %shr26.i106 to i8
  %conv29.i107 = add nuw nsw i8 %23, -5
  %incdec.ptr30.i108 = getelementptr inbounds i8, ptr %.pre, i64 1
  store i8 %conv29.i107, ptr %.pre, align 1, !tbaa !15
  %conv32.i109 = trunc i32 %sub25.i105 to i8
  %incdec.ptr33.i110 = getelementptr inbounds i8, ptr %.pre, i64 2
  store i8 %conv32.i109, ptr %incdec.ptr30.i108, align 1, !tbaa !15
  br label %if.end24.thread

if.else34.i120:                                   ; preds = %if.else17.i104
  %incdec.ptr35.i112 = getelementptr inbounds i8, ptr %.pre, i64 1
  store i8 -1, ptr %.pre, align 1, !tbaa !15
  %24 = lshr i32 %sub7, 24
  %conv39.i113 = trunc i32 %24 to i8
  %incdec.ptr40.i114 = getelementptr inbounds i8, ptr %.pre, i64 2
  store i8 %conv39.i113, ptr %incdec.ptr35.i112, align 1, !tbaa !15
  %25 = lshr i32 %sub7, 16
  %conv44.i115 = trunc i32 %25 to i8
  %incdec.ptr45.i116 = getelementptr inbounds i8, ptr %.pre, i64 3
  store i8 %conv44.i115, ptr %incdec.ptr40.i114, align 1, !tbaa !15
  %26 = lshr i32 %sub7, 8
  %conv48.i117 = trunc i32 %26 to i8
  %incdec.ptr49.i118 = getelementptr inbounds i8, ptr %.pre, i64 4
...
if.end24.thread:                                  ; preds = %if.else34.i120, %if.then23.i111, %if.then9.i102, %if.then3.i94
  ...
  store ptr %ptr.0.i121, ptr %next.phi.trans.insert, align 8, !tbaa !5
  %limit128 = getelementptr inbounds %struct.status, ptr %out, i64 0, i32 1
  %27 = load ptr, ptr %limit128, align 8, !tbaa !14
  %cmp25129 = icmp eq ptr %ptr.0.i121, %27
...
cond.end40:                                       ; preds = %cond.true33, %cond.false36, %cond.true
  %28 = phi ptr [ %.pre, %cond.true ], [ %ptr.0.i121, %cond.true33 ], [ %ptr.0.i121, %cond.false36 ]
  %cond41 = phi i8 [ %cond, %cond.true ], [ %cond35, %cond.true33 ], [ %cond38, %cond.false36 ]
  %next130132 = getelementptr inbounds %struct.status, ptr %out, i64 0, i32 4
  %incdec.ptr = getelementptr inbounds i8, ptr %28, i64 1
  store ptr %incdec.ptr, ptr %next130132, align 8, !tbaa !5
  store i8 %cond41, ptr %28, align 1, !tbaa !15
...
cleanup:                                          ; preds = %if.end24.thread, %if.then18, %if.then, %if.end24, %cond.end40
  %retval.0 = phi i32 [ 0, %cond.end40 ], [ -13, %if.end24 ], [ -13, %if.then ], [ -13, %if.then18 ], [ -13, %if.end24.thread ]
