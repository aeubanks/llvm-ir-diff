...
if.end65:                                         ; preds = %_ZN9NCompress6NBZip28CDecoder8ReadByteEv.exit.3
  %conv58 = and i32 %and.i.i.i.i.3, 255
  store i8 1, ptr %isBZ, align 1, !tbaa !63
  %37 = mul nuw nsw i32 %conv58, 100000
...
entry:
  ...
  %.pre634 = load i32, ptr %m_InStream, align 8, !tbaa !23
  br i1 %tobool.not, label %if.end, label %if.then

if.then:                                          ; preds = %entry
  %add.i.i.i = add i32 %.pre634, 1
...
if.end:                                           ; preds = %entry, %_ZN9NCompress6NBZip2L7ReadBitEPN5NBitm8CDecoderI9CInBufferEE.exit
  %10 = phi i32 [ %6, %_ZN9NCompress6NBZip2L7ReadBitEPN5NBitm8CDecoderI9CInBufferEE.exit ], [ %.pre634, %entry ]
...
if.end4:                                          ; preds = %_ZN9NCompress6NBZip2L8ReadBitsEPN5NBitm8CDecoderI9CInBufferEEj.exit
  ...
  %.pre635 = load i32, ptr %m_Value.i.i.i311, align 4, !tbaa !18
  %.pre636 = load i32, ptr %m_InStream, align 8, !tbaa !23
  br label %for.body

for.body:                                         ; preds = %if.end4, %_ZN9NCompress6NBZip2L7ReadBitEPN5NBitm8CDecoderI9CInBufferEE.exit358
  %18 = phi i32 [ %.pre636, %if.end4 ], [ %26, %_ZN9NCompress6NBZip2L7ReadBitEPN5NBitm8CDecoderI9CInBufferEE.exit358 ]
  %19 = phi i32 [ %.pre635, %if.end4 ], [ %27, %_ZN9NCompress6NBZip2L7ReadBitEPN5NBitm8CDecoderI9CInBufferEE.exit358 ]
...
pred.store.continue:                              ; preds = %pred.store.if, %if.end38
  ...
  br i1 %62, label %pred.store.if670, label %pred.store.continue671

pred.store.if670:                                 ; preds = %pred.store.continue
  %63 = getelementptr inbounds [6 x i8], ptr %mtfPos, i64 0, i64 1
  store i8 1, ptr %63, align 1, !tbaa !26
  br label %pred.store.continue671

pred.store.continue671:                           ; preds = %pred.store.if670, %pred.store.continue
  %64 = extractelement <8 x i1> %60, i64 2
  br i1 %64, label %pred.store.if672, label %pred.store.continue673
...
pred.store.continue673:                           ; preds = %pred.store.if672, %pred.store.continue671
  ...
  br i1 %66, label %pred.store.if674, label %pred.store.continue675
...
pred.store.continue675:                           ; preds = %pred.store.if674, %pred.store.continue673
  ...
  br i1 %68, label %pred.store.if676, label %pred.store.continue677
...
pred.store.continue677:                           ; preds = %pred.store.if676, %pred.store.continue675
  ...
  br i1 %70, label %pred.store.if678, label %pred.store.continue679
...
pred.store.continue679:                           ; preds = %pred.store.if678, %pred.store.continue677
  ...
  br i1 %72, label %pred.store.if680, label %pred.store.continue681
...
pred.store.continue681:                           ; preds = %pred.store.if680, %pred.store.continue679
  ...
  br i1 %74, label %pred.store.if682, label %pred.store.continue683
...
pred.store.continue683:                           ; preds = %pred.store.if682, %pred.store.continue681
  %wide.trip.count616 = zext i32 %shr3.i.i.i432 to i64
  br label %do.body45

do.body45:                                        ; preds = %pred.store.continue683, %do.cond69
  %indvars.iv613 = phi i64 [ 0, %pred.store.continue683 ], [ %indvars.iv.next614, %do.cond69 ]
  %.pre637 = load i32, ptr %m_Value.i.i.i311, align 4, !tbaa !18
  %.pre638 = load i32, ptr %m_InStream, align 8, !tbaa !23
  br label %while.cond

while.cond:                                       ; preds = %while.body, %do.body45
  %76 = phi i32 [ %84, %while.body ], [ %.pre638, %do.body45 ]
  %77 = phi i32 [ %85, %while.body ], [ %.pre637, %do.body45 ]
...
for.body56:                                       ; preds = %while.end
  %sub = add nuw i64 %indvars.iv607, 4294967295
  %idxprom57 = and i64 %sub, 4294967295
...
for.body56.1:                                     ; preds = %for.body56
  ...
  %sub.1 = add nuw i64 %indvars.iv607, 4294967294
  %idxprom57.1 = and i64 %sub.1, 4294967295
...
for.body56.2:                                     ; preds = %for.body56.1
  ...
  %sub.2 = add nuw i64 %indvars.iv607, 4294967293
  %idxprom57.2 = and i64 %sub.2, 4294967295
...
for.body56.3:                                     ; preds = %for.body56.2
  ...
  %sub.3 = add nuw i64 %indvars.iv607, 4294967292
  %idxprom57.3 = and i64 %sub.3, 4294967295
  ...
  %.not718 = icmp eq i64 %indvars.iv607, 4
  br i1 %.not718, label %do.cond69, label %for.body56.4, !llvm.loop !83

for.body56.4:                                     ; preds = %for.body56.3
  %indvars.iv.next611.3 = add nsw i64 %indvars.iv607, -4
  %sub.4 = add nuw i64 %indvars.iv607, 4294967291
  %idxprom57.4 = and i64 %sub.4, 4294967295
...
for.body56.5:                                     ; preds = %for.body56.4
  ...
  %sub.5 = add nuw i64 %indvars.iv607, 4294967290
  %idxprom57.5 = and i64 %sub.5, 4294967295
...
do.cond69:                                        ; preds = %for.body56, %for.body56.1, %for.body56.2, %for.body56.3, %for.body56.4, %for.body56.5, %while.end
  ...
  br i1 %exitcond617.not, label %cleanup73, label %do.body45, !llvm.loop !84
...
cleanup73:                                        ; preds = %do.cond69
  ...
  %wide.trip.count621 = zext i32 %98 to i64
  %cmp106588 = icmp ult i32 %98, 258
  br label %do.body79

do.body79:                                        ; preds = %cleanup73, %do.cond123
  %indvars.iv626 = phi i64 [ 0, %cleanup73 ], [ %indvars.iv.next627, %do.cond123 ]
...
for.body107.preheader:                            ; preds = %_ZN9NCompress6NBZip2L8ReadBitsEPN5NBitm8CDecoderI9CInBufferEEj.exit483, %for.cond105.preheader
  %i81.0.lcssa641 = phi i32 [ %98, %for.cond105.preheader ], [ 0, %_ZN9NCompress6NBZip2L8ReadBitsEPN5NBitm8CDecoderI9CInBufferEEj.exit483 ]
  %109 = zext i32 %i81.0.lcssa641 to i64
  %scevgep = getelementptr i8, ptr %lens, i64 %109
  %110 = sub nuw nsw i32 257, %i81.0.lcssa641
...
for.cond85.preheader:                             ; preds = %for.cond85.preheader.preheader, %for.end98
  ...
  %indvars.iv618 = phi i64 [ 0, %for.cond85.preheader.preheader ], [ %indvars.iv.next619, %for.end98 ]
...
for.end98:                                        ; preds = %_ZN9NCompress6NBZip2L7ReadBitEPN5NBitm8CDecoderI9CInBufferEE.exit508
  ...
  %arrayidx101 = getelementptr inbounds [258 x i8], ptr %lens, i64 0, i64 %indvars.iv618
  store i8 %conv99, ptr %arrayidx101, align 1, !tbaa !26
  %indvars.iv.next619 = add nuw nsw i64 %indvars.iv618, 1
  %exitcond622 = icmp eq i64 %indvars.iv.next619, %wide.trip.count621
  br i1 %exitcond622, label %for.cond105.preheader, label %for.cond85.preheader, !llvm.loop !86

for.end112:                                       ; preds = %for.body107.preheader, %for.cond105.preheader
  %arrayidx114 = getelementptr inbounds %"class.NCompress::NHuffman::CDecoder", ptr %m_HuffmanDecoders, i64 %indvars.iv626
...
do.cond123:                                       ; preds = %for.end112
  ...
  %exitcond630.not = icmp eq i64 %indvars.iv.next627, %wide.trip.count
  br i1 %exitcond630.not, label %for.body130.preheader, label %do.body79, !llvm.loop !87
...
vector.scevcheck:                                 ; preds = %if.then163
  ...
  br i1 %161, label %do.body169.preheader, label %vector.ph686

vector.ph686:                                     ; preds = %vector.scevcheck
  %n.vec688 = and i32 %runCounter.0, -8
  %ind.end = add i32 %blockSize.0.ph, %n.vec688
  %ind.end690 = and i32 %runCounter.0, 7
  %broadcast.splatinsert694 = insertelement <4 x i32> poison, i32 %conv165, i64 0
  %broadcast.splat695 = shufflevector <4 x i32> %broadcast.splatinsert694, <4 x i32> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert696 = insertelement <4 x i32> poison, i32 %conv165, i64 0
  %broadcast.splat697 = shufflevector <4 x i32> %broadcast.splatinsert696, <4 x i32> poison, <4 x i32> zeroinitializer
  br label %vector.body692

vector.body692:                                   ; preds = %vector.body692, %vector.ph686
  %index = phi i32 [ 0, %vector.ph686 ], [ %index.next698, %vector.body692 ]
  %offset.idx693 = add i32 %blockSize.0.ph, %index
  %162 = add i32 %offset.idx693, 256
  %163 = zext i32 %162 to i64
  %164 = getelementptr inbounds i32, ptr %CharCounters, i64 %163
  store <4 x i32> %broadcast.splat695, ptr %164, align 4, !tbaa !64
  %165 = getelementptr inbounds i32, ptr %164, i64 4
  store <4 x i32> %broadcast.splat697, ptr %165, align 4, !tbaa !64
  %index.next698 = add nuw i32 %index, 8
  %166 = icmp eq i32 %index.next698, %n.vec688
  br i1 %166, label %middle.block684, label %vector.body692, !llvm.loop !89

middle.block684:                                  ; preds = %vector.body692
  %cmp.n = icmp eq i32 %runCounter.0, %n.vec688
  br i1 %cmp.n, label %if.end178, label %do.body169.preheader

do.body169.preheader:                             ; preds = %vector.scevcheck, %if.then163, %middle.block684
  %blockSize.1.ph = phi i32 [ %blockSize.0.ph, %vector.scevcheck ], [ %blockSize.0.ph, %if.then163 ], [ %ind.end, %middle.block684 ]
  %runCounter.1.ph = phi i32 [ %runCounter.0, %vector.scevcheck ], [ %runCounter.0, %if.then163 ], [ %ind.end690, %middle.block684 ]
...
if.end178:                                        ; preds = %do.body169.prol.loopexit, %do.body169, %middle.block684, %if.end161
  %blockSize.2 = phi i32 [ %blockSize.0.ph, %if.end161 ], [ %ind.end, %middle.block684 ], [ %inc170.lcssa.unr, %do.body169.prol.loopexit ], [ %inc170.3, %do.body169 ]
  %runPower.1 = phi i32 [ %runPower.0, %if.end161 ], [ 0, %middle.block684 ], [ 0, %do.body169 ], [ 0, %do.body169.prol.loopexit ]
