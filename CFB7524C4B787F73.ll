; ModuleID = '/usr/local/google/home/aeubanks/repos/test-suite/SingleSource/Regression/C/gcc-c-torture/execute/pr79388.c'
source_filename = "/usr/local/google/home/aeubanks/repos/test-suite/SingleSource/Regression/C/gcc-c-torture/execute/pr79388.c"
...
entry:
  %and = and i32 %p, 65534
  store i32 %and, ptr @c, align 4, !tbaa !5
...
entry:
  %call = tail call i32 @foo(i32 noundef 6)
