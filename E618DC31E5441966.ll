...
for.body17.i176:                                  ; preds = %for.end.i, %for.end62.i
  %scan.0402.i = phi ptr [ %scan.0.val.i187, %for.end62.i ], [ %Clauses, %for.end.i ]
...
clause_LiteralIsEquality.exit.thread.i:           ; preds = %for.body22.i
  ...
  %cmp.i.i383.i = icmp eq i32 %60, %L.val7.val.i.i.i177
  br i1 %cmp.i.i383.i, label %clause_GetLiteralAtom.exit.i181, label %for.inc61.i
...
clause_GetLiteralAtom.exit318.i:                  ; preds = %if.then.i.i316.i, %if.end34.i
  ...
  %call35.val385.pn.in.i = getelementptr i8, ptr %call1.val.val.i.i305.pn.i, i64 16
  %call35.val385.pn.i = load ptr, ptr %call35.val385.pn.in.i, align 8
  %call35.val.val387.in.i = getelementptr i8, ptr %call35.val385.pn.i, i64 8
  %call35.val.val387.i = load ptr, ptr %call35.val.val387.in.i, align 8
  %call37.val.val.i = load ptr, ptr %call35.val385.pn.i, align 8
  %70 = getelementptr i8, ptr %call37.val.val.i, i64 8
  %call37.val.val.val.i = load ptr, ptr %70, align 8
  %call36.val281.i = load i32, ptr %call35.val.val387.i, align 8
...
land.lhs.true.i:                                  ; preds = %clause_GetLiteralAtom.exit318.i
  ...
  %or.cond.i185 = or i1 %cmp.i.i321.i, %cmp.i.i323.i
  br i1 %or.cond.i185, label %for.inc61.i, label %land.lhs.true46.i

land.lhs.true46.i:                                ; preds = %land.lhs.true.i
  %call47.i = call i32 @term_HasSubterm(ptr noundef nonnull %call35.val.val387.i, ptr noundef nonnull %call37.val.val.val.i) #10
  %tobool48.not.i = icmp eq i32 %call47.i, 0
  br i1 %tobool48.not.i, label %land.lhs.true49.i, label %for.inc61.i

land.lhs.true49.i:                                ; preds = %land.lhs.true46.i
  %call50.i186 = call i32 @term_HasSubterm(ptr noundef nonnull %call37.val.val.val.i, ptr noundef nonnull %call35.val.val387.i) #10
  %tobool51.not.i = icmp eq i32 %call50.i186, 0
  br i1 %tobool51.not.i, label %if.then52.i, label %for.inc61.i

if.then52.i:                                      ; preds = %land.lhs.true49.i
  %call36.val.i = load i32, ptr %call35.val.val387.i, align 8
...
for.end62.i:                                      ; preds = %for.inc61.i, %for.body17.i176
  ...
  %scan.0.val.i187 = load ptr, ptr %scan.0402.i, align 8
  %cmp.i290.not.i = icmp eq ptr %scan.0.val.i187, null
...
for.cond67.loopexit.i:                            ; preds = %for.body116.i, %for.cond112.preheader.i, %for.body71.i
  %scan.1.i188 = load ptr, ptr %scan.1413.i, align 8
  %cmp.i334.not.i = icmp eq ptr %scan.1.i188, null
...
for.body71.i:                                     ; preds = %for.end65.i, %for.cond67.loopexit.i
  %scan.1413.i = phi ptr [ %scan.1.i188, %for.cond67.loopexit.i ], [ %scan.1411.i, %for.end65.i ]
...
for.body79.i:                                     ; preds = %if.end108.i, %for.body79.lr.ph.i
  ...
  %info.i.i189 = getelementptr inbounds %struct.signature, ptr %88, i64 0, i32 5
  %89 = load i32, ptr %info.i.i189, align 8
...
lor.lhs.false.i:                                  ; preds = %for.body79.i
  ...
  %or.cond380.i = select i1 %cmp91.i, i1 true, i1 %cmp94.not.i
  br i1 %or.cond380.i, label %if.end98.i, label %if.then96.i
...
lor.lhs.false101.i:                               ; preds = %if.end98.i
  ...
  %or.cond381.i = select i1 %cmp102.i, i1 true, i1 %cmp105.not.i
  br i1 %or.cond381.i, label %if.end108.i, label %if.then107.i
...
for.body.i.preheader.i:                           ; preds = %for.end123.i
  %SymbolPairs.addr.0.val30.i415.i = load ptr, ptr %distrPairs.0.lcssa.i, align 8
  %cond.i416.i = icmp eq ptr %SymbolPairs.addr.0.val30.i415.i, null
  br i1 %cond.i416.i, label %if.then129.critedge.i, label %for.body7.lr.ph.i.i

for.body.i.loopexit.i:                            ; preds = %for.inc.i.i
  %SymbolPairs.addr.0.val30.i.i = load ptr, ptr %SymbolPairs.addr.0.val30.i418.i, align 8
  %cond.i.i = icmp eq ptr %SymbolPairs.addr.0.val30.i.i, null
  br i1 %cond.i.i, label %if.then129.critedge.i, label %for.body7.lr.ph.i.i, !llvm.loop !24

for.body7.lr.ph.i.i:                              ; preds = %for.body.i.preheader.i, %for.body.i.loopexit.i
  %SymbolPairs.addr.0.val30.i418.i = phi ptr [ %SymbolPairs.addr.0.val30.i.i, %for.body.i.loopexit.i ], [ %SymbolPairs.addr.0.val30.i415.i, %for.body.i.preheader.i ]
  %SymbolPairs.addr.0.val30.i418.pn.i = phi ptr [ %SymbolPairs.addr.0.val30.i418.i, %for.body.i.loopexit.i ], [ %distrPairs.0.lcssa.i, %for.body.i.preheader.i ]
  %SymbolPairs.addr.0.val32.i417.in.i = getelementptr i8, ptr %SymbolPairs.addr.0.val30.i418.pn.i, i64 8
...
for.body7.i.i:                                    ; preds = %for.inc.i.i, %for.body7.lr.ph.i.i
  %scan.043.i.i = phi ptr [ %SymbolPairs.addr.0.val30.i418.i, %for.body7.lr.ph.i.i ], [ %scan.0.val.i.i, %for.inc.i.i ]
...
if.then129.critedge.i:                            ; preds = %for.body.i.loopexit.i, %for.body.i.preheader.i
...
for.body135.i:                                    ; preds = %for.body135.i.preheader, %for.body135.i
  ...
  br i1 %cmp.i360.not.i, label %for.end145.i, label %for.body135.i, !llvm.loop !25
...
for.inc166.i:                                     ; preds = %if.then160.i, %for.body155.i
  ...
  br i1 %cmp.i373.not.i, label %while.cond.loopexit.i, label %for.body155.i, !llvm.loop !27
