...
entry:
  %bf.load = load i32, ptr getelementptr inbounds (%struct.anon, ptr @b, i64 0, i32 1), align 8
...
entry:
  %bf.load = load i32, ptr getelementptr inbounds (%struct.anon.0, ptr @c, i64 0, i32 1), align 8
...
entry:
  %bf.load = load i32, ptr getelementptr inbounds (%struct.anon.1, ptr @d, i64 0, i32 1), align 8
...
entry:
  ...
  store i32 %bf.set, ptr getelementptr inbounds (%struct.anon, ptr @b, i64 0, i32 1), align 8
  ret void
}
...
entry:
  ...
  store i32 %bf.lshr3, ptr getelementptr inbounds (%struct.anon, ptr @b, i64 0, i32 1), align 8
  ret void
}
...
entry:
  ...
  %bf.set = or i32 %bf.value, %bf.clear2
  store i32 %bf.set, ptr getelementptr inbounds (%struct.anon.0, ptr @c, i64 0, i32 1), align 8
  ret void
}
...
entry:
  ...
  %add2 = shl i32 %x, 6
  %bf.lshr3 = add i32 %bf.load, %add2
  store i32 %bf.lshr3, ptr getelementptr inbounds (%struct.anon.0, ptr @c, i64 0, i32 1), align 8
  ret void
}
...
entry:
  ...
  %bf.set = or i32 %bf.value, %bf.clear2
  store i32 %bf.set, ptr getelementptr inbounds (%struct.anon.1, ptr @d, i64 0, i32 1), align 8
  ret void
}
...
entry:
  ...
  %add2 = shl i32 %x, 24
  %bf.lshr3 = add i32 %bf.load, %add2
  store i32 %bf.lshr3, ptr getelementptr inbounds (%struct.anon.1, ptr @d, i64 0, i32 1), align 8
  ret void
}
...
entry:
  %bf.load = load i32, ptr getelementptr inbounds (%struct.anon.0, ptr @c, i64 0, i32 1), align 8
  %bf.clear2 = and i32 %bf.load, -33
  store i32 %bf.clear2, ptr getelementptr inbounds (%struct.anon.0, ptr @c, i64 0, i32 1), align 8
  ret void
}
