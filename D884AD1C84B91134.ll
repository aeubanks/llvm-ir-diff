; ModuleID = '/usr/local/google/home/aeubanks/repos/test-suite/SingleSource/Regression/C/gcc-c-torture/execute/20040705-1.c'
source_filename = "/usr/local/google/home/aeubanks/repos/test-suite/SingleSource/Regression/C/gcc-c-torture/execute/20040705-1.c"
...
define dso_local i32 @ret1() local_unnamed_addr #0 {
  %1 = load i32, ptr getelementptr inbounds (%struct.anon, ptr @b, i64 0, i32 1), align 8
  %2 = and i32 %1, 63
  ret i32 %2
}
...
define dso_local i32 @ret4() local_unnamed_addr #0 {
  %1 = load i32, ptr getelementptr inbounds (%struct.anon.0, ptr @c, i64 0, i32 1), align 8
  %2 = and i32 %1, 31
  ret i32 %2
}
...
define dso_local i32 @ret7() local_unnamed_addr #0 {
  %1 = load i32, ptr getelementptr inbounds (%struct.anon.1, ptr @d, i64 0, i32 1), align 8
  %2 = and i32 %1, 65535
  ret i32 %2
}
...
define dso_local void @fn1_1(i32 noundef %0) local_unnamed_addr #1 {
  %2 = load i32, ptr getelementptr inbounds (%struct.anon, ptr @b, i64 0, i32 1), align 8
  %3 = add i32 %2, %0
  %4 = and i32 %3, 63
  %5 = and i32 %2, -64
  %6 = or i32 %4, %5
  store i32 %6, ptr getelementptr inbounds (%struct.anon, ptr @b, i64 0, i32 1), align 8
  ret void
}
...
define dso_local void @fn2_1(i32 noundef %0) local_unnamed_addr #1 {
  ...
  %6 = and i32 %2, -131009
  %7 = or i32 %5, %6
  store i32 %7, ptr getelementptr inbounds (%struct.anon, ptr @b, i64 0, i32 1), align 8
  ret void
}
...
define dso_local void @fn3_1(i32 noundef %0) local_unnamed_addr #1 {
  ...
  %3 = shl i32 %0, 17
  %4 = add i32 %2, %3
  store i32 %4, ptr getelementptr inbounds (%struct.anon, ptr @b, i64 0, i32 1), align 8
  ret void
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(readwrite, argmem: none, inaccessiblemem: none) uwtable
define dso_local void @fn4_1(i32 noundef %0) local_unnamed_addr #1 {
  %2 = load i32, ptr getelementptr inbounds (%struct.anon.0, ptr @c, i64 0, i32 1), align 8
  %3 = add i32 %2, %0
  %4 = and i32 %3, 31
  %5 = and i32 %2, -32
  %6 = or i32 %4, %5
  store i32 %6, ptr getelementptr inbounds (%struct.anon.0, ptr @c, i64 0, i32 1), align 8
  ret void
}
...
define dso_local void @fn5_1(i32 noundef %0) local_unnamed_addr #1 {
  ...
  %6 = and i32 %2, -33
  %7 = or i32 %5, %6
  store i32 %7, ptr getelementptr inbounds (%struct.anon.0, ptr @c, i64 0, i32 1), align 8
  ret void
}
...
define dso_local void @fn6_1(i32 noundef %0) local_unnamed_addr #1 {
  ...
  %3 = shl i32 %0, 6
  %4 = add i32 %2, %3
  store i32 %4, ptr getelementptr inbounds (%struct.anon.0, ptr @c, i64 0, i32 1), align 8
  ret void
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(readwrite, argmem: none, inaccessiblemem: none) uwtable
define dso_local void @fn7_1(i32 noundef %0) local_unnamed_addr #1 {
  %2 = load i32, ptr getelementptr inbounds (%struct.anon.1, ptr @d, i64 0, i32 1), align 8
  %3 = add i32 %2, %0
  %4 = and i32 %3, 65535
  %5 = and i32 %2, -65536
  %6 = or i32 %4, %5
  store i32 %6, ptr getelementptr inbounds (%struct.anon.1, ptr @d, i64 0, i32 1), align 8
  ret void
}
...
define dso_local void @fn8_1(i32 noundef %0) local_unnamed_addr #1 {
  ...
  %7 = or i32 %5, %6
  store i32 %7, ptr getelementptr inbounds (%struct.anon.1, ptr @d, i64 0, i32 1), align 8
  ret void
}
...
define dso_local void @fn9_1(i32 noundef %0) local_unnamed_addr #1 {
  ...
  %3 = shl i32 %0, 24
  %4 = add i32 %2, %3
  store i32 %4, ptr getelementptr inbounds (%struct.anon.1, ptr @d, i64 0, i32 1), align 8
  ret void
}
...
define dso_local void @fn5_2(i32 noundef %0) local_unnamed_addr #1 {
  %2 = load i32, ptr getelementptr inbounds (%struct.anon.0, ptr @c, i64 0, i32 1), align 8
  %3 = xor i32 %2, 32
  store i32 %3, ptr getelementptr inbounds (%struct.anon.0, ptr @c, i64 0, i32 1), align 8
  ret void
}
...
define dso_local void @fn2_7(i32 noundef %0) local_unnamed_addr #1 {
  ...
  %4 = or i32 %3, -131009
  %5 = and i32 %4, %2
  store i32 %5, ptr getelementptr inbounds (%struct.anon, ptr @b, i64 0, i32 1), align 8
  ret void
}
...
define dso_local void @fn5_7(i32 noundef %0) local_unnamed_addr #1 {
  ...
  %4 = or i32 %3, -33
  %5 = and i32 %4, %2
  store i32 %5, ptr getelementptr inbounds (%struct.anon.0, ptr @c, i64 0, i32 1), align 8
  ret void
}
...
define dso_local void @fn8_7(i32 noundef %0) local_unnamed_addr #1 {
  ...
  %4 = or i32 %3, -16711681
  %5 = and i32 %4, %2
  store i32 %5, ptr getelementptr inbounds (%struct.anon.1, ptr @d, i64 0, i32 1), align 8
  ret void
}
...
define dso_local void @fn2_a(i32 noundef %0) local_unnamed_addr #1 {
  ...
  %7 = and i32 %2, -131009
  %8 = or i32 %6, %7
  store i32 %8, ptr getelementptr inbounds (%struct.anon, ptr @b, i64 0, i32 1), align 8
  ret void
}
...
define dso_local void @fn5_a(i32 noundef %0) local_unnamed_addr #1 {
  ...
  %7 = and i32 %2, -33
  %8 = or i32 %6, %7
  store i32 %8, ptr getelementptr inbounds (%struct.anon.0, ptr @c, i64 0, i32 1), align 8
  ret void
}
...
define dso_local void @fn8_a(i32 noundef %0) local_unnamed_addr #1 {
  ...
  %8 = or i32 %6, %7
  store i32 %8, ptr getelementptr inbounds (%struct.anon.1, ptr @d, i64 0, i32 1), align 8
  ret void
}
...
define dso_local void @fn2_b(i32 noundef %0) local_unnamed_addr #1 {
  ...
  %8 = and i32 %2, -131009
  %9 = or i32 %7, %8
  store i32 %9, ptr getelementptr inbounds (%struct.anon, ptr @b, i64 0, i32 1), align 8
  ret void
}
...
define dso_local void @fn5_b(i32 noundef %0) local_unnamed_addr #1 {
  ...
  %8 = and i32 %2, -33
  %9 = or i32 %7, %8
  store i32 %9, ptr getelementptr inbounds (%struct.anon.0, ptr @c, i64 0, i32 1), align 8
  ret void
}
...
define dso_local void @fn8_b(i32 noundef %0) local_unnamed_addr #1 {
  ...
  %9 = or i32 %7, %8
  store i32 %9, ptr getelementptr inbounds (%struct.anon.1, ptr @d, i64 0, i32 1), align 8
  ret void
}
...
define dso_local void @fn1_e(i32 noundef %0) local_unnamed_addr #1 {
  %2 = load i32, ptr getelementptr inbounds (%struct.anon, ptr @b, i64 0, i32 1), align 8
  %3 = and i32 %2, -43
  store i32 %3, ptr getelementptr inbounds (%struct.anon, ptr @b, i64 0, i32 1), align 8
  ret void
}
...
define dso_local void @fn7_e(i32 noundef %0) local_unnamed_addr #1 {
  %2 = load i32, ptr getelementptr inbounds (%struct.anon.1, ptr @d, i64 0, i32 1), align 8
  %3 = and i32 %2, -65515
  store i32 %3, ptr getelementptr inbounds (%struct.anon.1, ptr @d, i64 0, i32 1), align 8
  ret void
}
...
define dso_local void @fn2_h(i32 noundef %0) local_unnamed_addr #1 {
  ...
  %9 = and i32 %2, -131009
  %10 = or i32 %9, %8
  store i32 %10, ptr getelementptr inbounds (%struct.anon, ptr @b, i64 0, i32 1), align 8
  ret void
}
...
define dso_local void @fn2_i(i32 noundef %0) local_unnamed_addr #1 {
  ...
  %10 = and i32 %2, -131009
  %11 = or i32 %10, %9
  store i32 %11, ptr getelementptr inbounds (%struct.anon, ptr @b, i64 0, i32 1), align 8
  ret void
}
...
define dso_local void @fn4_i(i32 noundef %0) local_unnamed_addr #1 {
  ...
  %9 = and i32 %3, -32
  %10 = or i32 %8, %9
  store i32 %10, ptr getelementptr inbounds (%struct.anon.0, ptr @c, i64 0, i32 1), align 8
  ret void
}
...
define dso_local void @fn8_i(i32 noundef %0) local_unnamed_addr #1 {
  ...
  %7 = shl nuw nsw i32 %6, 16
  %8 = and i32 %7, 2031616
  %9 = and i32 %2, -16711681
  %10 = or i32 %8, %9
  store i32 %10, ptr getelementptr inbounds (%struct.anon.1, ptr @d, i64 0, i32 1), align 8
  ret void
}
...
define dso_local i32 @main() local_unnamed_addr #3 {
  store i32 560051, ptr getelementptr inbounds (%struct.anon, ptr @b, i64 0, i32 1), align 8
  store i32 -2147483595, ptr getelementptr inbounds (%struct.anon.0, ptr @c, i64 0, i32 1), align 8
  store i32 -1147377476, ptr getelementptr inbounds (%struct.anon.1, ptr @d, i64 0, i32 1), align 8
  ret i32 0
}
