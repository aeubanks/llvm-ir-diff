...
cleanup.cont66:                                   ; preds = %cleanup62
  ...
  %12 = load i16, ptr @XZ_FOOTER_SIG, align 1
  store i16 %12, ptr %add.ptr85, align 2
  %13 = load ptr, ptr %s, align 8, !tbaa !10
  %call.i139 = call i64 %13(ptr noundef nonnull %s, ptr noundef nonnull %buf, i64 noundef 12) #5
