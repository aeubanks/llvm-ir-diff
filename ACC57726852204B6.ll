...
for.cond1.1:                                      ; preds = %if.end.i
  ...
  %3 = load i32, ptr %arrayidx9.2, align 16, !tbaa !11
  %cmp.i34 = fcmp ole float %0, %1
  %conv1.i.2 = zext i1 %cmp.i34 to i32
  %cmp2.not.i.2 = icmp eq i32 %3, %conv1.i.2
...
for.cond1.2:                                      ; preds = %for.cond1.1
  ...
  %cmp2.not.i.3 = icmp eq i32 %4, %conv1.i.3
...
for.cond1.3:                                      ; preds = %for.cond1.2
  ...
  %cmp2.not.i.4 = icmp eq i32 %5, %conv1.i.4
...
for.cond1.4:                                      ; preds = %for.cond1.3
  ...
  %cmp2.not.i.5 = icmp eq i32 %6, %conv1.i.5
...
if.end.i:                                         ; preds = %for.cond1.preheader
  ...
  %cmp2.not.i.1 = icmp eq i32 %7, %conv1.i.1
