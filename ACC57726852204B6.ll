...
for.cond1.preheader:                              ; preds = %entry, %for.cond1.5
  ...
  %0 = load float, ptr %arrayidx, align 16, !tbaa !5
  ...
  %cmp.i29 = fcmp uno float %0, %1
  %conv1.i = zext i1 %cmp.i29 to i32
  %cmp2.not.i = icmp eq i32 %2, %conv1.i
  br i1 %cmp2.not.i, label %for.cond1, label %if.then.i
...
for.cond1:                                        ; preds = %for.cond1.preheader
  ...
  %cmp.i30 = fcmp olt float %0, %1
  %conv1.i.1 = zext i1 %cmp.i30 to i32
  %cmp2.not.i.1 = icmp eq i32 %3, %conv1.i.1
  br i1 %cmp2.not.i.1, label %for.cond1.1, label %if.then.i
...
for.cond1.1:                                      ; preds = %for.cond1
  ...
  %4 = load i32, ptr %arrayidx9.2, align 16, !tbaa !11
  %cmp.i34 = fcmp ole float %0, %1
  %conv1.i.2 = zext i1 %cmp.i34 to i32
  %cmp2.not.i.2 = icmp eq i32 %4, %conv1.i.2
  br i1 %cmp2.not.i.2, label %for.cond1.2, label %if.then.i
...
for.cond1.2:                                      ; preds = %for.cond1.1
  ...
  %cmp.i38 = fcmp ogt float %0, %1
  %conv1.i.3 = zext i1 %cmp.i38 to i32
  %cmp2.not.i.3 = icmp eq i32 %5, %conv1.i.3
  br i1 %cmp2.not.i.3, label %for.cond1.3, label %if.then.i
...
for.cond1.3:                                      ; preds = %for.cond1.2
  ...
  %6 = load i32, ptr %arrayidx9.4, align 8, !tbaa !11
  %cmp.i42 = fcmp oge float %0, %1
  %conv1.i.4 = zext i1 %cmp.i42 to i32
  %cmp2.not.i.4 = icmp eq i32 %6, %conv1.i.4
  br i1 %cmp2.not.i.4, label %for.cond1.4, label %if.then.i
...
for.cond1.4:                                      ; preds = %for.cond1.3
  ...
  %cmp.i46 = fcmp one float %0, %1
  %conv1.i.5 = zext i1 %cmp.i46 to i32
  %cmp2.not.i.5 = icmp eq i32 %7, %conv1.i.5
  br i1 %cmp2.not.i.5, label %for.cond1.5, label %if.then.i
