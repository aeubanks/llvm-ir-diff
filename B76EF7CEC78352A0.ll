...
entry:
  ...
  %cmp438 = icmp eq i32 %Polarity, 1
  %Def.val287382439 = load i32, ptr %Def, align 8
  %cmp.i383440 = icmp eq i32 %Def.val287382439, %0
  %or.cond384441 = and i1 %cmp438, %cmp.i383440
  br i1 %or.cond384441, label %return, label %lor.lhs.false.lr.ph.preheader

lor.lhs.false.lr.ph.preheader:                    ; preds = %entry
  %.pre518 = load i32, ptr @fol_OR, align 4
...
lor.lhs.false.lr.ph:                              ; preds = %lor.lhs.false.lr.ph.preheader, %tailrecurse.outer.backedge
  ...
  %2 = phi i32 [ %22, %tailrecurse.outer.backedge ], [ %.pre522, %lor.lhs.false.lr.ph.preheader ]
  %3 = phi i32 [ %23, %tailrecurse.outer.backedge ], [ %.pre520, %lor.lhs.false.lr.ph.preheader ]
  %4 = phi i32 [ %24, %tailrecurse.outer.backedge ], [ %.pre518, %lor.lhs.false.lr.ph.preheader ]
  %cmp.i383447 = phi i1 [ %cmp.i383, %tailrecurse.outer.backedge ], [ %cmp.i383440, %lor.lhs.false.lr.ph.preheader ]
  %Def.val287382446 = phi i32 [ %Def.val287382, %tailrecurse.outer.backedge ], [ %Def.val287382439, %lor.lhs.false.lr.ph.preheader ]
  %cmp445 = phi i1 [ %cmp, %tailrecurse.outer.backedge ], [ %cmp438, %lor.lhs.false.lr.ph.preheader ]
  %Polarity.tr.ph443 = phi i32 [ %Polarity.tr.ph.be, %tailrecurse.outer.backedge ], [ %Polarity, %lor.lhs.false.lr.ph.preheader ]
  %Def.tr.ph442 = phi ptr [ %Def.tr.ph.be, %tailrecurse.outer.backedge ], [ %Def, %lor.lhs.false.lr.ph.preheader ]
  %cmp8 = icmp eq i32 %Polarity.tr.ph443, -1
...
lor.lhs.false.lr.ph.split.us:                     ; preds = %lor.lhs.false.lr.ph
  br i1 %cmp445, label %lor.lhs.false.us.peel, label %lor.lhs.false.lr.ph.split.us.split.us

lor.lhs.false.us.peel:                            ; preds = %lor.lhs.false.lr.ph.split.us
  %cmp.i306.us.peel = icmp eq i32 %Def.val287382446, %4
  %brmerge.us.peel = or i1 %cmp.i383447, %cmp.i306.us.peel
  br i1 %brmerge.us.peel, label %if.then18, label %if.end28.us.peel

if.end28.us.peel:                                 ; preds = %lor.lhs.false.us.peel
  %cmp.i.i.us.peel = icmp eq i32 %3, %Def.val287382446
  %cmp.i4.i.us.peel = icmp eq i32 %2, %Def.val287382446
...
if.then32.us.peel:                                ; preds = %if.end28.us.peel
  %5 = getelementptr i8, ptr %Def.tr.ph442, i64 16
...
lor.lhs.false.lr.ph.split.us.split.us:            ; preds = %lor.lhs.false.lr.ph.split.us
  %cmp.i306.us.us431 = icmp eq i32 %Def.val287382446, %4
  %brmerge.us.us432 = or i1 %cmp.i383447, %cmp.i306.us.us431
  br i1 %brmerge.us.us432, label %if.then18, label %if.end28.us.us

if.end28.us.us:                                   ; preds = %lor.lhs.false.lr.ph.split.us.split.us, %if.then32.us.us
  %Def.tr385.us.us434 = phi ptr [ %Def.val300.val.val.us.us, %if.then32.us.us ], [ %Def.tr.ph442, %lor.lhs.false.lr.ph.split.us.split.us ]
  %Def.val287386.us.us433 = phi i32 [ %Def.val287.us.us, %if.then32.us.us ], [ %Def.val287382446, %lor.lhs.false.lr.ph.split.us.split.us ]
  %cmp.i.i.us.us = icmp eq i32 %3, %Def.val287386.us.us433
  %cmp.i4.i.us.us = icmp eq i32 %2, %Def.val287386.us.us433
...
if.then32.us.us:                                  ; preds = %if.end28.us.us
  %7 = getelementptr i8, ptr %Def.tr385.us.us434, i64 16
...
lor.lhs.false.us:                                 ; preds = %if.then32.us.peel, %if.then32.us
  %Def.val287386.us = phi i32 [ %Def.val287.us, %if.then32.us ], [ %Def.val287.us.peel, %if.then32.us.peel ]
  %Def.tr385.us = phi ptr [ %Def.val300.val.val.us, %if.then32.us ], [ %Def.val300.val.val.us.peel, %if.then32.us.peel ]
  %cmp.i306.us = icmp eq i32 %Def.val287386.us, %4
  br i1 %cmp.i306.us, label %if.then18, label %if.end28.us

if.end28.us:                                      ; preds = %lor.lhs.false.us
  %cmp.i.i.us = icmp eq i32 %3, %Def.val287386.us
  %cmp.i4.i.us = icmp eq i32 %2, %Def.val287386.us
...
if.then32.us:                                     ; preds = %if.end28.us
  %9 = getelementptr i8, ptr %Def.tr385.us, i64 16
...
lor.lhs.false.lr.ph.split:                        ; preds = %lor.lhs.false.lr.ph
  br i1 %cmp445, label %lor.lhs.false.peel, label %lor.lhs.false.lr.ph.split.split.us

lor.lhs.false.peel:                               ; preds = %lor.lhs.false.lr.ph.split
  %cmp.i306.peel = icmp eq i32 %Def.val287382446, %4
  br i1 %cmp.i306.peel, label %return, label %if.end.peel

if.end.peel:                                      ; preds = %lor.lhs.false.peel
  br i1 %cmp.i383447, label %if.then18, label %if.end28.peel

if.end28.peel:                                    ; preds = %if.end.peel
  %cmp.i.i.peel = icmp eq i32 %3, %Def.val287382446
  %cmp.i4.i.peel = icmp eq i32 %2, %Def.val287382446
...
if.then32.peel:                                   ; preds = %if.end28.peel
  %11 = getelementptr i8, ptr %Def.tr.ph442, i64 16
...
lor.lhs.false.lr.ph.split.split.us:               ; preds = %lor.lhs.false.lr.ph.split
  %cmp.i306.us396420 = icmp eq i32 %Def.val287382446, %4
  br i1 %cmp.i306.us396420, label %return, label %if.end.us397

if.end.us397:                                     ; preds = %lor.lhs.false.lr.ph.split.split.us, %if.then32.us403
  %Def.tr385.us395423 = phi ptr [ %Def.val300.val.val.us406, %if.then32.us403 ], [ %Def.tr.ph442, %lor.lhs.false.lr.ph.split.split.us ]
  %Def.val287386.us394422 = phi i32 [ %Def.val287.us407, %if.then32.us403 ], [ %Def.val287382446, %lor.lhs.false.lr.ph.split.split.us ]
  %cmp.i387.us393421 = phi i1 [ %cmp.i.us408, %if.then32.us403 ], [ %cmp.i383447, %lor.lhs.false.lr.ph.split.split.us ]
  br i1 %cmp.i387.us393421, label %if.then18, label %if.end28.us399

if.end28.us399:                                   ; preds = %if.end.us397
  %cmp.i.i.us400 = icmp eq i32 %3, %Def.val287386.us394422
  %cmp.i4.i.us401 = icmp eq i32 %2, %Def.val287386.us394422
  %narrow.i.us402 = select i1 %cmp.i.i.us400, i1 true, i1 %cmp.i4.i.us401
  br i1 %narrow.i.us402, label %if.then32.us403, label %if.end35

if.then32.us403:                                  ; preds = %if.end28.us399
  %13 = getelementptr i8, ptr %Def.tr385.us395423, i64 16
  %Def.val300.us404 = load ptr, ptr %13, align 8
  %Def.val300.val.us405 = load ptr, ptr %Def.val300.us404, align 8
  %14 = getelementptr i8, ptr %Def.val300.val.us405, i64 8
  %Def.val300.val.val.us406 = load ptr, ptr %14, align 8
  %Def.val287.us407 = load i32, ptr %Def.val300.val.val.us406, align 8
  %cmp.i.us408 = icmp eq i32 %Def.val287.us407, %1
  %cmp.i306.us396 = icmp eq i32 %Def.val287.us407, %4
  br i1 %cmp.i306.us396, label %return, label %if.end.us397

lor.lhs.false:                                    ; preds = %if.then32.peel, %if.then32
  %Def.val287386 = phi i32 [ %Def.val287, %if.then32 ], [ %Def.val287.peel, %if.then32.peel ]
  %Def.tr385 = phi ptr [ %Def.val300.val.val, %if.then32 ], [ %Def.val300.val.val.peel, %if.then32.peel ]
  %cmp.i306 = icmp eq i32 %Def.val287386, %4
  br i1 %cmp.i306, label %return, label %if.end28

if.then18:                                        ; preds = %lor.lhs.false.lr.ph.split.us.split.us, %if.then32.us.us, %lor.lhs.false.us, %lor.lhs.false.us.peel, %if.end.us397, %if.end.peel
  %Polarity.tr.ph443517 = phi i32 [ -1, %if.end.peel ], [ -1, %if.end.us397 ], [ %Polarity.tr.ph443, %lor.lhs.false.us.peel ], [ %Polarity.tr.ph443, %lor.lhs.false.us ], [ %Polarity.tr.ph443, %if.then32.us.us ], [ %Polarity.tr.ph443, %lor.lhs.false.lr.ph.split.us.split.us ]
  %.us-phi388 = phi ptr [ %Def.tr.ph442, %if.end.peel ], [ %Def.tr385.us395423, %if.end.us397 ], [ %Def.tr385.us, %lor.lhs.false.us ], [ %Def.tr.ph442, %lor.lhs.false.us.peel ], [ %Def.val300.val.val.us.us, %if.then32.us.us ], [ %Def.tr.ph442, %lor.lhs.false.lr.ph.split.us.split.us ]
  %15 = getelementptr i8, ptr %.us-phi388, i64 16
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %call23 = tail call fastcc i32 @cnf_ContainsDefinitionIntern(ptr noundef %l.0.val, i32 noundef %Polarity.tr.ph443517, ptr noundef %FoundPred)
  %tobool24.not = icmp eq i32 %call23, 0
  br i1 %tobool24.not, label %for.cond, label %return, !llvm.loop !7

if.end28:                                         ; preds = %lor.lhs.false
  %cmp.i.i = icmp eq i32 %3, %Def.val287386
  %cmp.i4.i = icmp eq i32 %2, %Def.val287386
  %narrow.i = select i1 %cmp.i.i, i1 true, i1 %cmp.i4.i
  br i1 %narrow.i, label %if.then32, label %if.end35

if.then32:                                        ; preds = %if.end28
  %17 = getelementptr i8, ptr %Def.tr385, i64 16
...
if.end35:                                         ; preds = %if.end28.us.us, %if.end28.us.peel, %if.end28.us, %if.end28.us399, %if.end28.peel, %if.end28
  %.us-phi389 = phi ptr [ %Def.tr.ph442, %if.end28.peel ], [ %Def.tr385, %if.end28 ], [ %Def.tr385.us395423, %if.end28.us399 ], [ %Def.tr.ph442, %if.end28.us.peel ], [ %Def.tr385.us, %if.end28.us ], [ %Def.tr385.us.us434, %if.end28.us.us ]
  %.us-phi390 = phi i32 [ %Def.val287382446, %if.end28.peel ], [ %Def.val287386, %if.end28 ], [ %Def.val287386.us394422, %if.end28.us399 ], [ %Def.val287382446, %if.end28.us.peel ], [ %Def.val287386.us, %if.end28.us ], [ %Def.val287386.us.us433, %if.end28.us.us ]
  %.us-phi391 = phi i1 [ true, %if.end28 ], [ true, %if.end28.peel ], [ false, %if.end28.us399 ], [ true, %if.end28.us ], [ true, %if.end28.us.peel ], [ false, %if.end28.us.us ]
  %19 = load i32, ptr @fol_NOT, align 4
  %cmp.i314 = icmp eq i32 %.us-phi390, %19
  br i1 %cmp.i314, label %if.then40, label %if.end43

if.then40:                                        ; preds = %if.end35
  %20 = getelementptr i8, ptr %.us-phi389, i64 16
  %sub = sub i32 0, %Polarity.tr.ph443
  br label %tailrecurse.outer.backedge

tailrecurse.outer.backedge:                       ; preds = %if.then40, %if.end56
  %21 = phi i32 [ %.pre523, %if.end56 ], [ %1, %if.then40 ]
  %22 = phi i32 [ %.pre521, %if.end56 ], [ %2, %if.then40 ]
  %23 = phi i32 [ %.pre519, %if.end56 ], [ %3, %if.then40 ]
  ...
  %Def.val287382 = load i32, ptr %Def.tr.ph.be, align 8
  %cmp.i383 = icmp eq i32 %Def.val287382, %21
  %or.cond384 = and i1 %cmp, %cmp.i383
  br i1 %or.cond384, label %return, label %lor.lhs.false.lr.ph

if.end43:                                         ; preds = %if.end35
  %25 = load i32, ptr @fol_IMPLIES, align 4
  %cmp.i316 = icmp eq i32 %.us-phi390, %25
  br i1 %cmp.i316, label %if.then48, label %if.end60

if.then48:                                        ; preds = %if.end43
  br i1 %.us-phi391, label %if.then50, label %return

if.then50:                                        ; preds = %if.then48
  %26 = getelementptr i8, ptr %.us-phi389, i64 16
...
if.end56:                                         ; preds = %if.then50
  ...
  %.pre523 = load i32, ptr @fol_AND, align 4
  br label %tailrecurse.outer.backedge

if.end60:                                         ; preds = %if.end43
  %28 = load i32, ptr @fol_EQUIV, align 4
  %cmp.i318 = icmp eq i32 %.us-phi390, %28
  %or.cond204 = and i1 %.us-phi391, %cmp.i318
  br i1 %or.cond204, label %if.then67, label %return

if.then67:                                        ; preds = %if.end60
  %call68 = tail call fastcc ptr @cnf_IsDefinition(ptr noundef nonnull %.us-phi389)
...
while.body:                                       ; preds = %while.body.preheader, %while.body
  %super.0450 = phi ptr [ %super.0.val, %while.body ], [ %.us-phi389, %while.body.preheader ]
  %defpath.0449 = phi ptr [ %call.i320, %while.body ], [ null, %while.body.preheader ]
  ...
  store ptr %super.0450, ptr %car.i, align 8
  store ptr %defpath.0449, ptr %call.i320, align 8
  %29 = getelementptr i8, ptr %super.0450, i64 8
...
for.cond119.preheader:                            ; preds = %for.inc116
  %cmp.i332.not465 = icmp eq ptr %call.i, null
  br i1 %cmp.i332.not465, label %for.end190, label %for.body125

for.body82:                                       ; preds = %while.body, %for.inc116
  %pol.0455 = phi i32 [ %pol.1, %for.inc116 ], [ 1, %while.body ]
  %l71.0453 = phi ptr [ %l71.0.val296, %for.inc116 ], [ %call.i320, %while.body ]
  %30 = getelementptr i8, ptr %l71.0453, i64 8
  %l71.0.val292 = load ptr, ptr %30, align 8
  %conv = sext i32 %pol.0455 to i64
...
land.lhs.true97:                                  ; preds = %if.else
  ...
  %l71.0.val297 = load ptr, ptr %l71.0453, align 8
...
if.then104:                                       ; preds = %land.lhs.true97
  %sub105 = sub nsw i32 0, %pol.0455
  br label %for.inc116

if.else106:                                       ; preds = %land.lhs.true97, %if.else
  %37 = load i32, ptr @fol_EQUIV, align 4
  %cmp.i328 = icmp eq i32 %call85.val, %37
  %spec.select = select i1 %cmp.i328, i32 0, i32 %pol.0455
  br label %for.inc116

for.inc116:                                       ; preds = %if.else106, %if.then90, %if.then104
  %pol.1 = phi i32 [ %sub91, %if.then90 ], [ %sub105, %if.then104 ], [ %spec.select, %if.else106 ]
  %l71.0.val296 = load ptr, ptr %l71.0453, align 8
  %cmp.i321.not = icmp eq ptr %l71.0.val296, null
  br i1 %cmp.i321.not, label %for.cond119.preheader, label %for.body82, !llvm.loop !11

for.body125:                                      ; preds = %for.cond119.preheader, %for.inc188
  %allquantifierfound.0469 = phi i32 [ %allquantifierfound.2.ph, %for.inc188 ], [ 0, %for.cond119.preheader ]
  %l71.1468 = phi ptr [ %l71.1.val293, %for.inc188 ], [ %call.i320, %for.cond119.preheader ]
  %predicate_vars.0467 = phi ptr [ %predicate_vars.3.ph, %for.inc188 ], [ %call.i, %for.cond119.preheader ]
  %38 = getelementptr i8, ptr %l71.1468, i64 8
...
if.then132:                                       ; preds = %for.body125
  ...
  %or.cond363 = select i1 %or.cond205, i1 true, i1 %or.cond206
  br i1 %or.cond363, label %if.then148, label %if.else160
...
if.then148:                                       ; preds = %if.then132
  ...
  %scan.0459 = load ptr, ptr %46, align 8
  %cmp.i342.not460 = icmp eq ptr %scan.0459, null
  br i1 %cmp.i342.not460, label %for.inc188, label %for.body154

for.body154:                                      ; preds = %if.then148, %for.body154
  %scan.0462 = phi ptr [ %scan.0, %for.body154 ], [ %scan.0459, %if.then148 ]
  %predicate_vars.1461 = phi ptr [ %call156, %for.body154 ], [ %predicate_vars.0467, %if.then148 ]
  %47 = getelementptr i8, ptr %scan.0462, i64 8
  %scan.0.val = load ptr, ptr %47, align 8
  %call156 = tail call ptr @list_DeleteElement(ptr noundef %predicate_vars.1461, ptr noundef %scan.0.val, ptr noundef nonnull @term_Equal) #17
  %scan.0 = load ptr, ptr %scan.0462, align 8
...
if.else160:                                       ; preds = %if.then132
  %tobool161.not = icmp eq i32 %allquantifierfound.0469, 0
  br i1 %tobool161.not, label %if.else163, label %while.body.i

while.body.i:                                     ; preds = %if.else160, %while.body.i
  %Current.06.i = phi ptr [ %L.addr.0.val.i, %while.body.i ], [ %predicate_vars.0467, %if.else160 ]
...
if.else163:                                       ; preds = %if.else160
  ...
  %scan164.0456 = load ptr, ptr %55, align 8
  %cmp.i344.not457 = icmp eq ptr %scan164.0456, null
  br i1 %cmp.i344.not457, label %for.inc188, label %for.body170

for.body170:                                      ; preds = %if.else163, %for.inc176
  %scan164.0458 = phi ptr [ %scan164.0, %for.inc176 ], [ %scan164.0456, %if.else163 ]
  %56 = getelementptr i8, ptr %scan164.0458, i64 8
...
if.end.i.i:                                       ; preds = %while.body.i.i
  ...
  br i1 %cmp.i.not.i.i, label %for.inc176, label %while.body.i.i, !llvm.loop !15

while.body.i353:                                  ; preds = %while.body.i.i, %while.body.i353
  %Current.06.i347 = phi ptr [ %L.addr.0.val.i348, %while.body.i353 ], [ %predicate_vars.0467, %while.body.i.i ]
  ...
  br i1 %cmp.i.not.i352, label %list_Delete.exit354, label %while.body.i353, !llvm.loop !13

list_Delete.exit354:                              ; preds = %while.body.i353
  tail call void @list_DeleteWithElement(ptr noundef nonnull %call.i320, ptr noundef nonnull @list_PairFree) #17
  br label %return

for.inc176:                                       ; preds = %if.end.i.i
  %scan164.0 = load ptr, ptr %scan164.0458, align 8
  %cmp.i344.not = icmp eq ptr %scan164.0, null
  br i1 %cmp.i344.not, label %for.inc188, label %for.body170, !llvm.loop !16

for.inc188:                                       ; preds = %for.inc176, %for.body154, %if.else163, %if.then148, %for.body125
  %predicate_vars.3.ph = phi ptr [ %predicate_vars.0467, %for.body125 ], [ %predicate_vars.0467, %if.then148 ], [ %predicate_vars.0467, %if.else163 ], [ %call156, %for.body154 ], [ %predicate_vars.0467, %for.inc176 ]
  %allquantifierfound.2.ph = phi i32 [ %allquantifierfound.0469, %for.body125 ], [ 1, %if.then148 ], [ 0, %if.else163 ], [ 1, %for.body154 ], [ 0, %for.inc176 ]
  %l71.1.val293 = load ptr, ptr %l71.1468, align 8
  %cmp.i330 = icmp eq ptr %l71.1.val293, null
  %cmp.i332.not = icmp eq ptr %predicate_vars.3.ph, null
  %or.cond355 = select i1 %cmp.i330, i1 true, i1 %cmp.i332.not
  br i1 %or.cond355, label %for.end190, label %for.body125, !llvm.loop !17

for.end190:                                       ; preds = %for.inc188, %for.cond119.preheader
  tail call void @list_DeleteWithElement(ptr noundef nonnull %call.i320, ptr noundef nonnull @list_PairFree) #17
  store ptr %call68, ptr %FoundPred, align 8
  br label %return

return:                                           ; preds = %lor.lhs.false.lr.ph.split.split.us, %tailrecurse.outer.backedge, %if.then48, %if.then50, %if.then32.us, %if.then32.us.peel, %if.then32.us403, %lor.lhs.false, %if.then32, %lor.lhs.false.peel, %if.then32.peel, %for.body, %for.cond, %if.end60, %if.then67, %for.end190, %list_Delete.exit354, %list_Delete.exit, %entry
  %retval.7 = phi i32 [ 0, %entry ], [ 1, %for.end190 ], [ 0, %list_Delete.exit354 ], [ 0, %list_Delete.exit ], [ 0, %if.then67 ], [ 0, %if.end60 ], [ 0, %for.cond ], [ 1, %for.body ], [ 0, %if.then32.peel ], [ 0, %lor.lhs.false.peel ], [ 0, %if.then32 ], [ 0, %lor.lhs.false ], [ 0, %if.then32.us403 ], [ 0, %if.then32.us.peel ], [ 0, %if.then32.us ], [ 0, %lor.lhs.false.lr.ph.split.split.us ], [ 0, %tailrecurse.outer.backedge ], [ 1, %if.then50 ], [ 0, %if.then48 ]
  ret i32 %retval.7
}
...
if.else34:                                        ; preds = %if.else
  ...
  br i1 %cmp.i168, label %cnf_GetDualSymbol.exit181, label %lor.lhs.false

lor.lhs.false:                                    ; preds = %if.else34
  %cmp.i170 = icmp eq i32 %call7.val119, %42
  br i1 %cmp.i170, label %cnf_GetDualSymbol.exit181, label %if.end59

cnf_GetDualSymbol.exit181:                        ; preds = %if.else34, %lor.lhs.false
  %dual.0.i180 = phi i32 [ %41, %lor.lhs.false ], [ %42, %if.else34 ]
...
for.end.thread:                                   ; preds = %cnf_GetDualSymbol.exit181
  store i32 %dual.0.i180, ptr %2, align 8
  br label %while.body.i193.preheader

for.body:                                         ; preds = %cnf_GetDualSymbol.exit181, %for.body
  %scan.0206 = phi ptr [ %scan.0, %for.body ], [ %scan.0204, %cnf_GetDualSymbol.exit181 ]
...
if.end59:                                         ; preds = %list_Delete.exit149, %lor.lhs.false, %list_Delete.exit194, %list_Delete.exit166, %while.body
...
for.body69:                                       ; preds = %for.cond65.preheader, %for.body69
  ...
  %scan.1210 = phi ptr [ %call2.val121, %for.cond65.preheader ], [ %scan.1.pr, %for.body69 ]
  ...
  %scan.1.pr = load ptr, ptr %scan.1210, align 8
  %cmp.i199.not = icmp eq ptr %scan.1.pr, null
...
symbol_IsPredicate.exit:                          ; preds = %lor.lhs.false
  ...
  %or.cond = select i1 %cmp.i47, i1 true, i1 %cmp.i48
  br i1 %or.cond, label %while.body.i.preheader, label %if.end24

lor.lhs.false18:                                  ; preds = %lor.lhs.false
  %.old = load i32, ptr @fol_NOT, align 4
  %cmp.i48.old = icmp eq i32 %call2.val35, %.old
  br i1 %cmp.i48.old, label %while.body.i.preheader, label %if.end24
...
entry:
  %0 = getelementptr i8, ptr %Term, i64 16
  %Term.val398549 = load ptr, ptr %0, align 8
  %cmp.i.not550 = icmp eq ptr %Term.val398549, null
  br i1 %cmp.i.not550, label %cleanup, label %if.end

if.end:                                           ; preds = %entry, %tailrecurse.backedge
  %Scan.0556 = phi ptr [ %Term.val398, %tailrecurse.backedge ], [ %Term.val398549, %entry ]
  %Term.val = load i32, ptr %Term, align 8
...
while.body.outer:                                 ; preds = %if.end, %if.end24.thread
  %Scan.0559.ph = phi ptr [ %Scan.0582, %if.end24.thread ], [ %Scan.0556, %if.end ]
  %tobool26.not = phi i1 [ false, %if.end24.thread ], [ true, %if.end ]
  br label %while.body

while.body:                                       ; preds = %while.body.outer, %if.end24
  %Scan.0559 = phi ptr [ %Scan.0, %if.end24 ], [ %Scan.0559.ph, %while.body.outer ]
  %2 = getelementptr i8, ptr %Scan.0559, i64 8
...
if.end24:                                         ; preds = %if.else
  %Scan.0 = load ptr, ptr %Scan.0559, align 8
  %cmp.i401.not = icmp eq ptr %Scan.0, null
  br i1 %cmp.i401.not, label %while.end, label %while.body, !llvm.loop !47

if.end24.thread:                                  ; preds = %while.body
  %Scan.0582 = load ptr, ptr %Scan.0559, align 8
  %cmp.i401.not583 = icmp eq ptr %Scan.0582, null
  br i1 %cmp.i401.not583, label %if.then27, label %while.body.outer, !llvm.loop !47
...
while.body47.outer:                               ; preds = %if.else37, %if.end64.thread
  %Scan.1555.ph = phi ptr [ %Scan.1588, %if.end64.thread ], [ %Scan.0556, %if.else37 ]
...
while.body47:                                     ; preds = %while.body47.outer, %if.end64
  %Scan.1555 = phi ptr [ %Scan.1, %if.end64 ], [ %Scan.1555.ph, %while.body47.outer ]
  %7 = getelementptr i8, ptr %Scan.1555, i64 8
...
if.end64:                                         ; preds = %if.else55
  %Scan.1 = load ptr, ptr %Scan.1555, align 8
  %cmp.i412.not = icmp eq ptr %Scan.1, null
  br i1 %cmp.i412.not, label %while.end66, label %while.body47, !llvm.loop !48

if.end64.thread:                                  ; preds = %while.body47
  %Scan.1588 = load ptr, ptr %Scan.1555, align 8
  %cmp.i412.not589 = icmp eq ptr %Scan.1588, null
  br i1 %cmp.i412.not589, label %if.then68, label %while.body47.outer, !llvm.loop !48
...
if.then87:                                        ; preds = %if.then84
  %Term.val393.val = load ptr, ptr %Scan.0556, align 8
  br label %if.end93

if.end93:                                         ; preds = %if.then84, %if.then87
  %Scan.0556.sink = phi ptr [ %Term.val393.val, %if.then87 ], [ %Scan.0556, %if.then84 ]
  %14 = getelementptr i8, ptr %Scan.0556.sink, i64 8
...
if.then137:                                       ; preds = %if.else133
  %23 = getelementptr i8, ptr %Scan.0556, i64 8
...
while.body.ithread-pre-split.preheader:           ; preds = %if.else148
  ...
  %total_size.i.i.i544 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %27, i64 0, i32 4
  %28 = load i32, ptr %total_size.i.i.i544, align 8
  %conv26.i.i.i545 = sext i32 %28 to i64
  %29 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i546 = add i64 %29, %conv26.i.i.i545
  store i64 %add27.i.i.i546, ptr @memory_FREEDBYTES, align 8
...
while.body.ithread-pre-split:                     ; preds = %while.body.ithread-pre-split.preheader, %while.body.ithread-pre-split
  %L.addr.0.val.i548 = phi ptr [ %L.addr.0.val.i.pr, %while.body.ithread-pre-split ], [ %Term.val392.val, %while.body.ithread-pre-split.preheader ]
  %L.addr.0.val.i.pr = load ptr, ptr %L.addr.0.val.i548, align 8
  ...
  store ptr %35, ptr %L.addr.0.val.i548, align 8
  %36 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %L.addr.0.val.i548, ptr %36, align 8
...
tailrecurse.backedgethread-pre-split:             ; preds = %while.body.i483thread-pre-split, %while.body.ithread-pre-split
  %Term.val390.val.val.sink626 = phi ptr [ %Term.val392.val.val, %while.body.ithread-pre-split ], [ %Term.val390.val.val, %while.body.i483thread-pre-split ]
  %call207.val = load i32, ptr %Term.val390.val.val.sink626, align 8
  store i32 %call207.val, ptr %Term, align 8
  %37 = getelementptr i8, ptr %Term.val390.val.val.sink626, i64 16
  ...
  store ptr %41, ptr %Term.val390.val.val.sink626, align 8
  %42 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 32), align 8
  store ptr %Term.val390.val.val.sink626, ptr %42, align 8
...
if.then184:                                       ; preds = %if.else180
  %48 = getelementptr i8, ptr %Scan.0556, i64 8
...
while.body.i483thread-pre-split.preheader:        ; preds = %if.else202
  ...
  %total_size.i.i.i479539 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %54, i64 0, i32 4
  %55 = load i32, ptr %total_size.i.i.i479539, align 8
  %conv26.i.i.i480540 = sext i32 %55 to i64
  %56 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i481541 = add i64 %56, %conv26.i.i.i480540
  store i64 %add27.i.i.i481541, ptr @memory_FREEDBYTES, align 8
...
while.body.i483thread-pre-split:                  ; preds = %while.body.i483thread-pre-split.preheader, %while.body.i483thread-pre-split
  %L.addr.0.val.i478543 = phi ptr [ %L.addr.0.val.i478.pr, %while.body.i483thread-pre-split ], [ %Term.val390.val, %while.body.i483thread-pre-split.preheader ]
  %L.addr.0.val.i478.pr = load ptr, ptr %L.addr.0.val.i478543, align 8
  ...
  store ptr %62, ptr %L.addr.0.val.i478543, align 8
  %63 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %L.addr.0.val.i478543, ptr %63, align 8
...
for.cond.i.i:                                     ; preds = %lor.rhs.i.i, %if.end16
  ...
  %cond.i.i = icmp eq ptr %scan1.0.i.i, null
  br i1 %cond.i.i, label %cnf_MakeOneAndTerm.exit, label %lor.rhs.i.i
...
lor.rhs.i.i:                                      ; preds = %for.cond.i.i
  ...
  br i1 %cmp.i73.i.i, label %for.body15.lr.ph.i.i, label %for.cond.i.i, !llvm.loop !60

for.body15.lr.ph.i.i:                             ; preds = %lor.rhs.i.i
  %17 = load i32, ptr @symbol_TYPEMASK, align 4
  br label %for.body15.i.i

for.cond29.preheader.i.i:                         ; preds = %for.inc26.i.i
  %cond99.i.i = icmp eq ptr %predlist.1.i.i, null
  br i1 %cond99.i.i, label %cnf_MakeOneAndTerm.exit, label %for.body33.lr.ph.i.i

for.body33.lr.ph.i.i:                             ; preds = %for.cond29.preheader.i.i
  %term.val66.pre.i.i = load ptr, ptr %14, align 8
  br label %for.body33.i.i

for.body15.i.i:                                   ; preds = %for.inc26.i.i, %for.body15.lr.ph.i.i
  %predlist.095.i.i = phi ptr [ null, %for.body15.lr.ph.i.i ], [ %predlist.1.i.i, %for.inc26.i.i ]
  %scan.094.i.i = phi ptr [ %scan1.0.i.i, %for.body15.lr.ph.i.i ], [ %scan.0.val71.i.i, %for.inc26.i.i ]
  %18 = getelementptr i8, ptr %scan.094.i.i, i64 8
...
if.then23.i.i:                                    ; preds = %fol_IsNegativeLiteral.exit.i.i
  ...
  store ptr %predlist.095.i.i, ptr %call.i.i.i, align 8
...
for.inc26.i.i:                                    ; preds = %if.then23.i.i, %fol_IsNegativeLiteral.exit.i.i, %land.rhs.i80.i.i, %symbol_IsPredicate.exit.i.i, %for.body15.i.i
  %predlist.1.i.i = phi ptr [ %call.i.i.i, %if.then23.i.i ], [ %predlist.095.i.i, %fol_IsNegativeLiteral.exit.i.i ], [ %predlist.095.i.i, %symbol_IsPredicate.exit.i.i ], [ %predlist.095.i.i, %for.body15.i.i ], [ %predlist.095.i.i, %land.rhs.i80.i.i ]
  %scan.0.val71.i.i = load ptr, ptr %scan.094.i.i, align 8
...
for.body33.i.i:                                   ; preds = %for.body33.i.i, %for.body33.lr.ph.i.i
  ...
  %scan.197.i.i = phi ptr [ %predlist.1.i.i, %for.body33.lr.ph.i.i ], [ %scan.1.val70.i.i, %for.body33.i.i ]
  %22 = getelementptr i8, ptr %scan.197.i.i, i64 8
  ...
  %scan.1.val70.i.i = load ptr, ptr %scan.197.i.i, align 8
...
for.body97:                                       ; preds = %if.end92, %list_Delete.exit343
  ...
  %cond = icmp eq ptr %call99, null
  br i1 %cond, label %list_Delete.exit343, label %if.then102
...
for.body24:                                       ; preds = %for.body24.preheader, %for.inc104
  %Scan.1226 = phi ptr [ %Scan.1, %for.inc104 ], [ %call.i.i, %for.body24.preheader ]
  %tobool89.not225 = phi i1 [ true, %for.inc104 ], [ false, %for.body24.preheader ]
  %TopTerm.0224 = phi ptr [ %TopTerm.3214, %for.inc104 ], [ %call4, %for.body24.preheader ]
  %VarScan.0223 = phi ptr [ %VarScan.1, %for.inc104 ], [ %call.i.i157, %for.body24.preheader ]
  %12 = getelementptr i8, ptr %Scan.1226, i64 8
...
if.then28:                                        ; preds = %for.body24
  %TopTerm.0.val144 = load i32, ptr %TopTerm.0224, align 8
...
if.then33:                                        ; preds = %if.then28
  ...
  %17 = getelementptr i8, ptr %TopTerm.0224, i64 16
...
if.end38:                                         ; preds = %if.then33, %if.then28
  br i1 %tobool89.not225, label %if.then40, label %for.inc104
...
if.then40:                                        ; preds = %if.end38
  ...
  store ptr %TopTerm.0224, ptr %car.i.i170, align 8
...
for.body54:                                       ; preds = %for.body24, %for.body54
  ...
  %ExVarScan.0219 = phi ptr [ %ExVarScan.0.pr, %for.body54 ], [ %Scan.1.val152, %for.body24 ]
  ...
  %ExVarScan.0.pr = load ptr, ptr %ExVarScan.0219, align 8
  %cmp52.not = icmp eq ptr %ExVarScan.0.pr, null
...
list_Delete.exit186:                              ; preds = %while.body.i185, %for.cond50.for.end72_crit_edge
  ...
  %TopTerm.0.val = load i32, ptr %TopTerm.0224, align 8
...
if.then78:                                        ; preds = %list_Delete.exit186
  %37 = getelementptr i8, ptr %TopTerm.0224, i64 16
...
if.else83:                                        ; preds = %list_Delete.exit186
  ...
  store ptr %TopTerm.0224, ptr %car.i.i190, align 8
...
if.end87:                                         ; preds = %if.else83, %list_Nconc.exit
  %TopTerm.1 = phi ptr [ %TopTerm.0224, %list_Nconc.exit ], [ %call86, %if.else83 ]
  br i1 %tobool89.not225, label %if.then90, label %for.inc104
...
for.inc104:                                       ; preds = %if.end38, %if.end87, %if.then100
  %TopTerm.3214 = phi ptr [ %TopTerm.3.ph, %if.then100 ], [ %TopTerm.0224, %if.end38 ], [ %TopTerm.1, %if.end87 ]
  %VarScan.1 = phi ptr [ %VarScan.0.val154, %if.then100 ], [ %VarScan.0223, %if.end38 ], [ %VarScan.0223, %if.end87 ]
  %Scan.1 = load ptr, ptr %Scan.1226, align 8
...
for.body:                                         ; preds = %for.cond.preheader, %for.body
  ...
  %scan.0153 = phi ptr [ %call2.val102, %for.cond.preheader ], [ %scan.0.pr, %for.body ]
  ...
  %scan.0.pr = load ptr, ptr %scan.0153, align 8
  %cmp.i143.not = icmp eq ptr %scan.0.pr, null
...
for.body.i:                                       ; preds = %while.body.i, %if.end35.i
  %scan.0140.i = phi ptr [ %scan.0.pr.i, %if.end35.i ], [ %call2.val102.i, %while.body.i ]
...
if.end35.i:                                       ; preds = %if.end33.i, %for.body.i
  %scan.0.pr.i = load ptr, ptr %scan.0140.i, align 8
  %cmp.i115.not.i = icmp eq ptr %scan.0.pr.i, null
...
for.body:                                         ; preds = %for.cond.preheader, %for.body
  ...
  %scan.056 = phi ptr [ %call2.val40, %for.cond.preheader ], [ %scan.0.pr, %for.body ]
  ...
  %scan.0.pr = load ptr, ptr %scan.056, align 8
...
if.else46:                                        ; preds = %if.else
  ...
  br i1 %cmp.i235, label %cnf_GetDualSymbol.exit248, label %lor.lhs.false

lor.lhs.false:                                    ; preds = %if.else46
  %cmp.i237 = icmp eq i32 %call3.val178, %40
  br i1 %cmp.i237, label %cnf_GetDualSymbol.exit248, label %if.then89

cnf_GetDualSymbol.exit248:                        ; preds = %if.else46, %lor.lhs.false
  %dual.0.i247 = phi i32 [ %39, %lor.lhs.false ], [ %40, %if.else46 ]
...
for.end71.thread:                                 ; preds = %cnf_GetDualSymbol.exit248
  store i32 %dual.0.i247, ptr %term1.0293, align 8
  br label %while.body.i261.preheader

for.body64:                                       ; preds = %cnf_GetDualSymbol.exit248, %for.body64
  %scan.0280 = phi ptr [ %scan.0, %for.body64 ], [ %scan.0278, %cnf_GetDualSymbol.exit248 ]
...
if.then89:                                        ; preds = %for.end83, %lor.lhs.false, %while.body
...
for.cond95thread-pre-split:                       ; preds = %for.body99
  %scan.1.pr = load ptr, ptr %scan.1285, align 8
  %cmp.i270.not = icmp eq ptr %scan.1.pr, null
  br i1 %cmp.i270.not, label %while.end, label %for.body99

for.body99:                                       ; preds = %if.then89, %for.cond95thread-pre-split
  %scan.1285 = phi ptr [ %scan.1.pr, %for.cond95thread-pre-split ], [ %term1.1.val179, %if.then89 ]
  ...
  br i1 %tobool102.not, label %for.cond95thread-pre-split, label %if.end109, !llvm.loop !144
...
while.end:                                        ; preds = %if.then89, %if.end113, %for.cond95thread-pre-split, %entry
  ret ptr %Term
}
...
for.body30.us:                                    ; preds = %if.else.us, %for.body30.us
  ...
  %scan.174.us = phi ptr [ %scan.1.pr.us, %for.body30.us ], [ %call2.val52.us, %if.else.us ]
  ...
  %scan.1.pr.us = load ptr, ptr %scan.174.us, align 8
  %cmp.i65.not.us = icmp eq ptr %scan.1.pr.us, null
...
for.body30:                                       ; preds = %for.body30.preheader, %for.body30
  ...
  %scan.174 = phi ptr [ %call2.val52, %for.body30.preheader ], [ %scan.1.pr, %for.body30 ]
  ...
  %scan.1.pr = load ptr, ptr %scan.174, align 8
  %cmp.i65.not = icmp eq ptr %scan.1.pr, null
...
for.body.i.i:                                     ; preds = %for.inc.i.i, %for.body.lr.ph.i.i
  ...
  br i1 %cmp.i.i, label %for.cond.i, label %for.inc.i.i
...
for.cond.i:                                       ; preds = %for.body.i.i, %lor.rhs.i
  %scan1.0.in.i = phi ptr [ %scan1.0.i, %lor.rhs.i ], [ %0, %for.body.i.i ]
  %scan1.0.i = load ptr, ptr %scan1.0.in.i, align 8
  %cond.i = icmp eq ptr %scan1.0.i, null
  br i1 %cond.i, label %cnf_MakeOneOrPredicate.exit, label %lor.rhs.i

lor.rhs.i:                                        ; preds = %for.cond.i
  %3 = getelementptr i8, ptr %scan1.0.i, i64 8
  %scan1.0.val.i = load ptr, ptr %3, align 8
  %call5.val.i = load i32, ptr %scan1.0.val.i, align 8
  %cmp.i81.i = icmp eq i32 %call5.val.i, %1
  br i1 %cmp.i81.i, label %for.body19.lr.ph.i, label %for.cond.i, !llvm.loop !164
...
for.cond33.preheader.i:                           ; preds = %for.inc30.i
  %cond109.i = icmp eq ptr %predlist.1.i, null
  br i1 %cond109.i, label %cnf_MakeOneOrPredicate.exit, label %for.body37.lr.ph.i
...
for.body19.i:                                     ; preds = %for.inc30.i, %for.body19.lr.ph.i
  %predlist.0105.i = phi ptr [ null, %for.body19.lr.ph.i ], [ %predlist.1.i, %for.inc30.i ]
  %scan.0104.i = phi ptr [ %scan1.0.i, %for.body19.lr.ph.i ], [ %scan.0.val78.i, %for.inc30.i ]
  %5 = getelementptr i8, ptr %scan.0104.i, i64 8
...
if.then27.i:                                      ; preds = %fol_IsNegativeLiteral.exit.i, %symbol_IsPredicate.exit.i
  ...
  store ptr %predlist.0105.i, ptr %call.i.i, align 8
  br label %for.inc30.i

for.inc30.i:                                      ; preds = %if.then27.i, %fol_IsNegativeLiteral.exit.i, %land.rhs.i88.i, %lor.lhs.false.i
  %predlist.1.i = phi ptr [ %call.i.i, %if.then27.i ], [ %predlist.0105.i, %fol_IsNegativeLiteral.exit.i ], [ %predlist.0105.i, %lor.lhs.false.i ], [ %predlist.0105.i, %land.rhs.i88.i ]
  %scan.0.val78.i = load ptr, ptr %scan.0104.i, align 8
...
for.body37.i:                                     ; preds = %for.body37.i, %for.body37.lr.ph.i
  ...
  %scan.1107.i = phi ptr [ %predlist.1.i, %for.body37.lr.ph.i ], [ %scan.1.val77.i, %for.body37.i ]
  %9 = getelementptr i8, ptr %scan.1107.i, i64 8
  ...
  %scan.1.val77.i = load ptr, ptr %scan.1107.i, align 8
...
cnf_MakeOneOrPredicate.exit:                      ; preds = %for.inc.i.i, %for.cond.i, %entry, %for.cond33.preheader.i, %list_Nconc.exit.i
  ret ptr %term
}
...
entry:
  %0 = getelementptr i8, ptr %Search, i64 112
  %1 = getelementptr i8, ptr %Search, i64 104
  %term.val570630 = load i32, ptr %term, align 8
  %2 = load i32, ptr @fol_ALL, align 4
  %cmp.i.i571631 = icmp eq i32 %2, %term.val570630
  %3 = load i32, ptr @fol_EXIST, align 4
  %cmp.i4.i572632 = icmp eq i32 %3, %term.val570630
  %narrow.i573633 = select i1 %cmp.i.i571631, i1 true, i1 %cmp.i4.i572632
  br i1 %narrow.i573633, label %if.then.lr.ph.lr.ph, label %if.else87
...
if.then.lr.ph:                                    ; preds = %if.then.lr.ph.lr.ph, %list_Delete.exit
  %cmp.i.i571638 = phi i1 [ %cmp.i.i571631, %if.then.lr.ph.lr.ph ], [ %cmp.i.i571, %list_Delete.exit ]
  %Depth.tr.ph635 = phi i32 [ %Depth, %if.then.lr.ph.lr.ph ], [ %Depth.tr574, %list_Delete.exit ]
...
if.then:                                          ; preds = %if.then.lr.ph, %cnf_PopAllQuantifier.exit
  %cmp.i.i577 = phi i1 [ %cmp.i.i571638, %if.then.lr.ph ], [ %cmp.i.i, %cnf_PopAllQuantifier.exit ]
  %Depth.tr574 = phi i32 [ %Depth.tr.ph635, %if.then.lr.ph ], [ %Depth.addr.0, %cnf_PopAllQuantifier.exit ]
  %Search.val575 = load ptr, ptr %0, align 8
  %Search.val221576 = load ptr, ptr %1, align 8
  br i1 %cmp.i.i577, label %if.then8, label %if.end19
...
for.body.i267:                                    ; preds = %if.end.i, %cnf_RplacVarsymbFunction.exit103.i
  ...
  %call1.i.i = tail call i32 @symbol_CreateSkolemFunction(i32 noundef %call.i.i265, ptr noundef %Search.val221576) #17
...
for.body.i.i271:                                  ; preds = %if.else.i.i, %for.body.i.i271
  ...
  %scan.042.i.i = phi ptr [ %scan.0.pr.i.i, %for.body.i.i271 ], [ %call2.val27.i.i, %if.else.i.i ]
  ...
  %scan.0.pr.i.i = load ptr, ptr %scan.042.i.i, align 8
  %cmp.i34.not.i.i = icmp eq ptr %scan.0.pr.i.i, null
...
for.body.i100.i:                                  ; preds = %if.else.i92.i, %for.body.i100.i
  ...
  %scan.042.i94.i = phi ptr [ %scan.0.pr.i98.i, %for.body.i100.i ], [ %call2.val27.i90.i, %if.else.i92.i ]
  ...
  %scan.0.pr.i98.i = load ptr, ptr %scan.042.i94.i, align 8
  %cmp.i34.not.i99.i = icmp eq ptr %scan.0.pr.i98.i, null
...
for.body46.i.i:                                   ; preds = %for.body46.i.i, %for.cond42.preheader.i.i
  ...
  %scan.2105.i.i = phi ptr [ %call2.val75.i.i, %for.cond42.preheader.i.i ], [ %scan.2.pr.i.i, %for.body46.i.i ]
  ...
  %scan.2.pr.i.i = load ptr, ptr %scan.2105.i.i, align 8
  %cmp.i93.not.i.i = icmp eq ptr %scan.2.pr.i.i, null
...
if.then76:                                        ; preds = %if.end73, %if.then29, %if.then26
  %arrayidx.i283 = getelementptr inbounds i32, ptr %Search.val575, i64 54
...
for.body.i529:                                    ; preds = %if.end.i293, %for.body.i529
  ...
  %call.i.i526 = tail call ptr @memory_Malloc(i32 noundef 16) #17
...
while.body.i520thread-pre-split:                  ; preds = %while.body.i520thread-pre-split.preheader, %while.body.i520thread-pre-split
  %L.addr.0.val.i515592 = phi ptr [ %L.addr.0.val.i515.pr, %while.body.i520thread-pre-split ], [ %Term.val225.val.i, %while.body.i520thread-pre-split.preheader ]
  %L.addr.0.val.i515.pr = load ptr, ptr %L.addr.0.val.i515592, align 8
  ...
  store ptr %166, ptr %L.addr.0.val.i515592, align 8
  %167 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %L.addr.0.val.i515592, ptr %167, align 8
  %cmp.i.not.i519 = icmp eq ptr %L.addr.0.val.i515.pr, null
...
for.body.i298:                                    ; preds = %for.body.i298.lr.ph, %for.inc.i303
  ...
  %call.i487 = tail call ptr @fol_FreeVariables(ptr noundef %scan.0.val219.i) #17
  %cmp.i.not14.i488 = icmp eq ptr %call.i487, null
  %or.cond.i490 = or i1 %cmp.i.not8.i.i489, %cmp.i.not14.i488
  br i1 %or.cond.i490, label %cnf_FreeVariablesBut.exit510, label %for.body.i495

for.body.i495:                                    ; preds = %for.body.i298, %for.inc.i507
  %Scan.015.i491 = phi ptr [ %Scan.0.val13.i505, %for.inc.i507 ], [ %call.i487, %for.body.i298 ]
  %175 = getelementptr i8, ptr %Scan.015.i491, i64 8
...
while.body.i.i500:                                ; preds = %if.end.i.i503, %for.body.i495
  ...
  %call2.i.i498 = tail call i32 @symbol_Equal(ptr noundef %176, ptr noundef %List.addr.0.val.i.i497) #17, !callees !14
...
for.inc.i507:                                     ; preds = %if.end.i.i503, %if.then.i504
  %Scan.0.val13.i505 = load ptr, ptr %Scan.015.i491, align 8
...
cnf_FreeVariablesBut.exit510:                     ; preds = %for.inc.i507, %for.body.i298
  %call7.i508 = tail call ptr @list_PointerDeleteElement(ptr noundef %call.i487, ptr noundef null) #17
  %call.i.i485 = tail call ptr @memory_Malloc(i32 noundef 16) #17
  ...
  %cmp.i483 = icmp eq ptr %pairlist.0.i600, null
  br i1 %cmp.i483, label %if.then22.i, label %if.else.i300

if.then22.i:                                      ; preds = %cnf_FreeVariablesBut.exit510
  %call.i.i481 = tail call ptr @memory_Malloc(i32 noundef 16) #17
...
if.else.i300:                                     ; preds = %cnf_FreeVariablesBut.exit510
  %call25.i299 = tail call i32 @list_Length(ptr noundef %call7.i508) #17
  br label %while.body.i
...
for.cond4.preheader.i:                            ; preds = %for.body.i477, %if.then37.i
  %maxdepth1.0.lcssa.i = phi i32 [ 0, %if.then37.i ], [ %spec.select.i, %for.body.i477 ]
...
for.body.i477:                                    ; preds = %for.body.i477, %for.body.lr.ph.i472
  %scan.035.i = phi ptr [ %call38.val.i, %for.body.lr.ph.i472 ], [ %scan.0.val30.i, %for.body.i477 ]
  %maxdepth1.034.i = phi i32 [ 0, %for.body.lr.ph.i472 ], [ %spec.select.i, %for.body.i477 ]
  %181 = getelementptr i8, ptr %scan.035.i, i64 8
  %scan.0.val.i473 = load ptr, ptr %181, align 8
  %call1.val.i474 = load i32, ptr %scan.0.val.i473, align 8
  %idxprom.i = sext i32 %call1.val.i474 to i64
  %arrayidx.i475 = getelementptr inbounds i32, ptr %179, i64 %idxprom.i
  %182 = load i32, ptr %arrayidx.i475, align 4
...
if.then52.i:                                      ; preds = %if.end49.i
  ...
  store ptr %call.i.i485, ptr %car.i.i469, align 8
  store ptr null, ptr %call.i.i468, align 8
  store ptr %call.i.i468, ptr %pairscan.0.i595, align 8
  br label %for.inc.i303

if.else54.i:                                      ; preds = %if.else35.i, %for.body8.i
  %cmp.i466 = icmp eq ptr %pairscan_pred.0.i594, null
  br i1 %cmp.i466, label %if.then59.i, label %if.else61.i

if.then59.i:                                      ; preds = %if.else54.i
  %call.i464 = tail call ptr @memory_Malloc(i32 noundef 16) #17
  %car.i465 = getelementptr inbounds %struct.LIST_HELP, ptr %call.i464, i64 0, i32 1
  store ptr %call.i.i485, ptr %car.i465, align 8
  store ptr %pairlist.0.i600, ptr %call.i464, align 8
  br label %for.inc.i303

if.else61.i:                                      ; preds = %if.else54.i
  tail call void @list_InsertNext(ptr noundef nonnull %pairscan_pred.0.i594, ptr noundef nonnull %call.i.i485) #17
  br label %for.inc.i303

for.inc.i303:                                     ; preds = %if.then52.i, %if.then59.i, %if.else61.i, %if.then22.i
  %pairlist.2.i = phi ptr [ %call.i.i481, %if.then22.i ], [ %pairlist.0.i600, %if.then52.i ], [ %call.i464, %if.then59.i ], [ %pairlist.0.i600, %if.else61.i ]
...
for.end.i304:                                     ; preds = %for.inc.i303, %list_Delete.exit522
  ...
  %cmp.i.not14.i = icmp eq ptr %call.i450, null
  %cmp.i.not8.i.i = icmp eq ptr %result.0.lcssa.i, null
  %or.cond.i451 = or i1 %cmp.i.not8.i.i, %cmp.i.not14.i
  br i1 %or.cond.i451, label %cnf_FreeVariablesBut.exit, label %for.body.i454

for.body.i454:                                    ; preds = %for.end.i304, %for.inc.i461
  %Scan.015.i = phi ptr [ %Scan.0.val13.i, %for.inc.i461 ], [ %call.i450, %for.end.i304 ]
  %185 = getelementptr i8, ptr %Scan.015.i, i64 8
  %Scan.0.val.i = load ptr, ptr %185, align 8
  %call2.val.i452 = load i32, ptr %Scan.0.val.i, align 8
  %conv.i453 = sext i32 %call2.val.i452 to i64
  %186 = inttoptr i64 %conv.i453 to ptr
  br label %while.body.i.i456

while.body.i.i456:                                ; preds = %if.end.i.i458, %for.body.i454
  %List.addr.09.i.i = phi ptr [ %List.addr.0.val7.i.i, %if.end.i.i458 ], [ %result.0.lcssa.i, %for.body.i454 ]
  %187 = getelementptr i8, ptr %List.addr.09.i.i, i64 8
  %List.addr.0.val.i.i = load ptr, ptr %187, align 8
  %call2.i.i455 = tail call i32 @symbol_Equal(ptr noundef %186, ptr noundef %List.addr.0.val.i.i) #17, !callees !14
  %tobool3.not.i.i = icmp eq i32 %call2.i.i455, 0
  br i1 %tobool3.not.i.i, label %if.end.i.i458, label %if.then.i459

if.end.i.i458:                                    ; preds = %while.body.i.i456
  %List.addr.0.val7.i.i = load ptr, ptr %List.addr.09.i.i, align 8
  %cmp.i.not.i.i457 = icmp eq ptr %List.addr.0.val7.i.i, null
  br i1 %cmp.i.not.i.i457, label %for.inc.i461, label %while.body.i.i456, !llvm.loop !15

if.then.i459:                                     ; preds = %while.body.i.i456
  store ptr null, ptr %185, align 8
  br label %for.inc.i461

for.inc.i461:                                     ; preds = %if.end.i.i458, %if.then.i459
  %Scan.0.val13.i = load ptr, ptr %Scan.015.i, align 8
  %cmp.i.not.i460 = icmp eq ptr %Scan.0.val13.i, null
  br i1 %cmp.i.not.i460, label %cnf_FreeVariablesBut.exit, label %for.body.i454, !llvm.loop !185

cnf_FreeVariablesBut.exit:                        ; preds = %for.inc.i461, %for.end.i304
  %call7.i462 = tail call ptr @list_PointerDeleteElement(ptr noundef %call.i450, ptr noundef null) #17
  %call68.i = tail call i32 @list_Length(ptr noundef %call7.i462) #17
  br i1 %cmp.i.not8.i.i, label %for.end83.i, label %for.body74.i

for.body74.i:                                     ; preds = %cnf_FreeVariablesBut.exit, %for.body74.i
  %mapping.0.i605 = phi ptr [ %call.i442, %for.body74.i ], [ null, %cnf_FreeVariablesBut.exit ]
  ...
  store ptr %scan.1.val.i306, ptr %car.i.i445, align 8
  ...
  store ptr %mapping.0.i605, ptr %call.i442, align 8
...
for.end83.i:                                      ; preds = %for.body74.i, %cnf_FreeVariablesBut.exit
  ...
  %cmp.i.not5.i432 = icmp eq ptr %call7.i462, null
  br i1 %cmp.i.not5.i432, label %list_Delete.exit441, label %while.body.i439

while.body.i439:                                  ; preds = %for.end83.i, %while.body.i439
  %Current.06.i433 = phi ptr [ %L.addr.0.val.i434, %while.body.i439 ], [ %call7.i462, %for.end83.i ]
  %L.addr.0.val.i434 = load ptr, ptr %Current.06.i433, align 8
  %191 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i435 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %191, i64 0, i32 4
  %192 = load i32, ptr %total_size.i.i.i435, align 8
  %conv26.i.i.i436 = sext i32 %192 to i64
  %193 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i437 = add i64 %193, %conv26.i.i.i436
  store i64 %add27.i.i.i437, ptr @memory_FREEDBYTES, align 8
  %194 = load ptr, ptr %191, align 8
  store ptr %194, ptr %Current.06.i433, align 8
  %195 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i433, ptr %195, align 8
  %cmp.i.not.i438 = icmp eq ptr %L.addr.0.val.i434, null
  br i1 %cmp.i.not.i438, label %list_Delete.exit441, label %while.body.i439, !llvm.loop !13

list_Delete.exit441:                              ; preds = %while.body.i439, %for.end83.i
...
for.cond94.i.preheader:                           ; preds = %for.body88.i, %list_Delete.exit441
  ...
  %cmp.i429.not617 = icmp eq ptr %pairlist.0.i.lcssa, null
  br i1 %cmp.i429.not617, label %while.cond128.i.preheader, label %for.body98.i.lr.ph
...
for.body88.i:                                     ; preds = %list_Delete.exit441, %for.body88.i
  %newvariables.0.i609 = phi ptr [ %call.i431, %for.body88.i ], [ null, %list_Delete.exit441 ]
  %i.0.i608 = phi i32 [ %inc.i, %for.body88.i ], [ 0, %list_Delete.exit441 ]
  ...
  store ptr %newvariables.0.i609, ptr %call.i431, align 8
...
while.cond128.i.preheader:                        ; preds = %list_Delete.exit390, %for.cond94.i.preheader
  ...
  %strskolemsuccess.0.i.lcssa = phi i32 [ 0, %for.cond94.i.preheader ], [ %spec.select, %list_Delete.exit390 ]
  %newvariables.1.i.lcssa = phi ptr [ %newvariables.0.i.lcssa, %for.cond94.i.preheader ], [ %newvariables.2.i.lcssa, %list_Delete.exit390 ]
  %cmp.i379.not626 = icmp eq ptr %newvariables.1.i.lcssa, null
  br i1 %cmp.i379.not626, label %while.end135.i, label %while.body132.i

for.body98.i:                                     ; preds = %for.body98.i.lr.ph, %list_Delete.exit390
  %newvariables.1.i622 = phi ptr [ %newvariables.0.i.lcssa, %for.body98.i.lr.ph ], [ %newvariables.2.i.lcssa, %list_Delete.exit390 ]
  %acc_length.0.i621 = phi i32 [ 0, %for.body98.i.lr.ph ], [ %call113.i, %list_Delete.exit390 ]
  %strskolemsuccess.0.i620 = phi i32 [ 0, %for.body98.i.lr.ph ], [ %spec.select, %list_Delete.exit390 ]
  %pairscan.2.i619 = phi ptr [ %pairlist.0.i.lcssa, %for.body98.i.lr.ph ], [ %pairscan.2.val220.i, %list_Delete.exit390 ]
  %accumulatedvariables.0.i618 = phi ptr [ null, %for.body98.i.lr.ph ], [ %call.i418, %list_Delete.exit390 ]
  ...
  %cmp.i.i419 = icmp eq ptr %accumulatedvariables.0.i618, null
  br i1 %cmp.i.i419, label %list_Nconc.exit428, label %if.end.i421

if.end.i421:                                      ; preds = %for.body98.i
  %cmp.i18.i420 = icmp eq ptr %call99.val.i, null
  br i1 %cmp.i18.i420, label %list_Nconc.exit428, label %for.cond.i425

for.cond.i425:                                    ; preds = %if.end.i421, %for.cond.i425
  %List1.addr.0.i422 = phi ptr [ %List1.addr.0.val17.i423, %for.cond.i425 ], [ %accumulatedvariables.0.i618, %if.end.i421 ]
  %List1.addr.0.val17.i423 = load ptr, ptr %List1.addr.0.i422, align 8
  %cmp.i20.not.i424 = icmp eq ptr %List1.addr.0.val17.i423, null
  br i1 %cmp.i20.not.i424, label %for.end.i426, label %for.cond.i425, !llvm.loop !20

for.end.i426:                                     ; preds = %for.cond.i425
  store ptr %call99.val.i, ptr %List1.addr.0.i422, align 8
  br label %list_Nconc.exit428

list_Nconc.exit428:                               ; preds = %for.body98.i, %if.end.i421, %for.end.i426
  %retval.0.i427 = phi ptr [ %accumulatedvariables.0.i618, %for.end.i426 ], [ %call99.val.i, %for.body98.i ], [ %accumulatedvariables.0.i618, %if.end.i421 ]
  %call.i418 = tail call ptr @list_DeleteDuplicates(ptr noundef %retval.0.i427, ptr noundef nonnull @term_Equal) #17
  %call104.i611 = tail call i32 @list_Length(ptr noundef %call.i418) #17
...
for.body107.i:                                    ; preds = %list_Nconc.exit428, %for.body107.i
  %newvariables.2.i615 = phi ptr [ %L.val.i414, %for.body107.i ], [ %newvariables.1.i622, %list_Nconc.exit428 ]
  %i.1.i614 = phi i32 [ %inc111.i, %for.body107.i ], [ 0, %list_Nconc.exit428 ]
  ...
  %L.val.i414 = load ptr, ptr %newvariables.2.i615, align 8
...
for.end112.i:                                     ; preds = %for.body107.i, %list_Nconc.exit428
  %newvariables.2.i.lcssa = phi ptr [ %newvariables.1.i622, %list_Nconc.exit428 ], [ %L.val.i414, %for.body107.i ]
  %call113.i = tail call i32 @list_Length(ptr noundef %call.i418) #17
  %cmp.i412 = icmp eq ptr %newvariables.2.i.lcssa, null
  %spec.select = select i1 %cmp.i412, i32 %strskolemsuccess.0.i620, i32 1
  ...
  %cmp.i.i408 = icmp eq ptr %call118.i, null
  br i1 %cmp.i.i408, label %list_Nconc.exit, label %if.end.i409

if.end.i409:                                      ; preds = %for.end112.i
  %cmp.i18.i = icmp eq ptr %call119.i, null
  br i1 %cmp.i18.i, label %list_Nconc.exit, label %for.cond.i410
...
while.body.i393:                                  ; preds = %if.end25.i, %while.body.preheader.i
  ...
  br i1 %cmp.i48.i, label %if.then.i395, label %while.body.if.end_crit_edge.i
...
if.then.i395:                                     ; preds = %while.body.i393
  ...
  br i1 %cmp.i.not5.i.i, label %list_Delete.exit.i404, label %while.body.i.i402

while.body.i.i402:                                ; preds = %if.then.i395, %while.body.i.i402
  %Current.06.i.i396 = phi ptr [ %L.addr.0.val.i.i397, %while.body.i.i402 ], [ %call7.val42.i, %if.then.i395 ]
  %L.addr.0.val.i.i397 = load ptr, ptr %Current.06.i.i396, align 8
  %214 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i.i398 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %214, i64 0, i32 4
  %215 = load i32, ptr %total_size.i.i.i.i398, align 8
  %conv26.i.i.i.i399 = sext i32 %215 to i64
  %216 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i.i400 = add i64 %216, %conv26.i.i.i.i399
  store i64 %add27.i.i.i.i400, ptr @memory_FREEDBYTES, align 8
  %217 = load ptr, ptr %214, align 8
  store ptr %217, ptr %Current.06.i.i396, align 8
  %218 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i.i396, ptr %218, align 8
  %cmp.i.not.i.i401 = icmp eq ptr %L.addr.0.val.i.i397, null
  br i1 %cmp.i.not.i.i401, label %list_Delete.exit.i404, label %while.body.i.i402, !llvm.loop !13

list_Delete.exit.i404:                            ; preds = %while.body.i.i402, %if.then.i395
  %call.i.i403 = tail call ptr @list_CopyWithElement(ptr noundef %retval.0.i, ptr noundef nonnull @term_Copy) #17
  store ptr %call.i.i403, ptr %213, align 8
  %.pre.i.pre = load i32, ptr @vec_MAX, align 4
  br label %if.end.i405

if.end.i405:                                      ; preds = %list_Delete.exit.i404, %while.body.if.end_crit_edge.i
  %.pre.i = phi i32 [ %dec.i.i, %while.body.if.end_crit_edge.i ], [ %.pre.i.pre, %list_Delete.exit.i404 ]
  %call7.val41.i = phi ptr [ %call7.val41.pre.i, %while.body.if.end_crit_edge.i ], [ %call.i.i403, %list_Delete.exit.i404 ]
  %cmp.i50.i = icmp eq ptr %call7.val41.i, null
  br i1 %cmp.i50.i, label %if.end25.i, label %for.cond18.preheader.i

for.cond18.preheader.i:                           ; preds = %if.end.i405
...
for.body22.i:                                     ; preds = %for.body22.i, %for.cond18.preheader.i
  ...
  %scan.060.i = phi ptr [ %call7.val41.i, %for.cond18.preheader.i ], [ %scan.0.pr.i, %for.body22.i ]
  %220 = getelementptr i8, ptr %scan.060.i, i64 8
  %scan.0.val.i406 = load ptr, ptr %220, align 8
  %indvars.iv.next.i = add i64 %indvars.iv.i, 1
  ...
  store ptr %scan.0.val.i406, ptr %arrayidx.i56.i, align 8
  %scan.0.pr.i = load ptr, ptr %scan.060.i, align 8
  %cmp.i52.not.i = icmp eq ptr %scan.0.pr.i, null
  br i1 %cmp.i52.not.i, label %if.end25.i, label %for.body22.i, !llvm.loop !193

if.end25.i:                                       ; preds = %for.body22.i, %if.end.i405
  %222 = phi i32 [ %.pre.i, %if.end.i405 ], [ %221, %for.body22.i ]
...
for.inc26.i:                                      ; preds = %if.end25.i
  ...
  %cmp.i.not.i407 = icmp eq ptr %scan1.0.val44.i, null
  br i1 %cmp.i.not.i407, label %cnf_SkolemFunctionFormulaMapped.exit, label %while.body.preheader.i, !llvm.loop !195
...
cnf_SkolemFunctionFormulaMapped.exit:             ; preds = %for.inc26.i, %list_Nconc.exit
  ...
  br i1 %cmp.i.not5.i381, label %list_Delete.exit390, label %while.body.i388

while.body.i388:                                  ; preds = %cnf_SkolemFunctionFormulaMapped.exit, %while.body.i388
  %Current.06.i382 = phi ptr [ %L.addr.0.val.i383, %while.body.i388 ], [ %retval.0.i, %cnf_SkolemFunctionFormulaMapped.exit ]
  %L.addr.0.val.i383 = load ptr, ptr %Current.06.i382, align 8
  %223 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i384 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %223, i64 0, i32 4
  %224 = load i32, ptr %total_size.i.i.i384, align 8
  %conv26.i.i.i385 = sext i32 %224 to i64
  %225 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i386 = add i64 %225, %conv26.i.i.i385
  store i64 %add27.i.i.i386, ptr @memory_FREEDBYTES, align 8
  %226 = load ptr, ptr %223, align 8
  store ptr %226, ptr %Current.06.i382, align 8
  %227 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i382, ptr %227, align 8
  %cmp.i.not.i387 = icmp eq ptr %L.addr.0.val.i383, null
  br i1 %cmp.i.not.i387, label %list_Delete.exit390, label %while.body.i388, !llvm.loop !13

list_Delete.exit390:                              ; preds = %while.body.i388, %cnf_SkolemFunctionFormulaMapped.exit
  ...
  tail call fastcc void @cnf_OptimizedSkolemFormula(ptr noundef %Search, ptr noundef %topterm, ptr noundef %toplabel, i32 noundef %TopAnd.tr.ph634, ptr noundef %call123.val.i, ptr noundef %UsedTerms, ptr noundef %Symblist, i32 noundef %Result1, ptr noundef %InputClauseToTermLabellist, i32 noundef %Depth.tr574)
...
while.end135.i:                                   ; preds = %while.body132.i, %while.cond128.i.preheader
  ...
  br i1 %cmp.i.not5.i366, label %list_Delete.exit375, label %while.body.i373

while.body.i373:                                  ; preds = %while.end135.i, %while.body.i373
  %Current.06.i367 = phi ptr [ %L.addr.0.val.i368, %while.body.i373 ], [ %accumulatedvariables.0.i.lcssa, %while.end135.i ]
  %L.addr.0.val.i368 = load ptr, ptr %Current.06.i367, align 8
  %235 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i369 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %235, i64 0, i32 4
  %236 = load i32, ptr %total_size.i.i.i369, align 8
  %conv26.i.i.i370 = sext i32 %236 to i64
  %237 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i371 = add i64 %237, %conv26.i.i.i370
  store i64 %add27.i.i.i371, ptr @memory_FREEDBYTES, align 8
  %238 = load ptr, ptr %235, align 8
  store ptr %238, ptr %Current.06.i367, align 8
  %239 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i367, ptr %239, align 8
  %cmp.i.not.i372 = icmp eq ptr %L.addr.0.val.i368, null
  br i1 %cmp.i.not.i372, label %list_Delete.exit375, label %while.body.i373, !llvm.loop !13

list_Delete.exit375:                              ; preds = %while.body.i373, %while.end135.i
  tail call void @list_DeleteWithElement(ptr noundef %pairlist.0.i.lcssa, ptr noundef nonnull @list_PairFree) #17
  br i1 %cmp.i.not8.i.i, label %list_Delete.exit365, label %while.body.i363

while.body.i363:                                  ; preds = %list_Delete.exit375, %while.body.i363
  %Current.06.i357 = phi ptr [ %L.addr.0.val.i358, %while.body.i363 ], [ %result.0.lcssa.i, %list_Delete.exit375 ]
  %L.addr.0.val.i358 = load ptr, ptr %Current.06.i357, align 8
  %240 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i359 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %240, i64 0, i32 4
  %241 = load i32, ptr %total_size.i.i.i359, align 8
  %conv26.i.i.i360 = sext i32 %241 to i64
  %242 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i361 = add i64 %242, %conv26.i.i.i360
  store i64 %add27.i.i.i361, ptr @memory_FREEDBYTES, align 8
  %243 = load ptr, ptr %240, align 8
  store ptr %243, ptr %Current.06.i357, align 8
  %244 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i357, ptr %244, align 8
  %cmp.i.not.i362 = icmp eq ptr %L.addr.0.val.i358, null
  br i1 %cmp.i.not.i362, label %list_Delete.exit365, label %while.body.i363, !llvm.loop !13

list_Delete.exit365:                              ; preds = %while.body.i363, %list_Delete.exit375
  tail call void @list_DeleteWithElement(ptr noundef %mapping.0.i.lcssa, ptr noundef nonnull @list_PairFree) #17
  %arrayidx.i355 = getelementptr inbounds i32, ptr %Search.val.i284, i64 34
...
for.body24.i.i:                                   ; preds = %for.body24.i.i, %for.cond20.preheader.i.i
  ...
  %scan.064.i.i = phi ptr [ %call8.val45.i.i, %for.cond20.preheader.i.i ], [ %scan.0.pr.i.i339, %for.body24.i.i ]
  ...
  %scan.0.pr.i.i339 = load ptr, ptr %scan.064.i.i, align 8
  %cmp.i56.not.i.i = icmp eq ptr %scan.0.pr.i.i339, null
...
if.end27.i.i:                                     ; preds = %for.body24.i.i, %if.end.i.i336
  ...
  %cmp.not.i.i340 = icmp eq i32 %269, %287
  br i1 %cmp.not.i.i340, label %for.inc28.i.i, label %while.body.i28.i, !llvm.loop !199
...
if.end86:                                         ; preds = %while.body.i47.i, %if.end74, %if.then139.i, %list_Delete.exit365, %list_Delete.exit39.thread.i
  %TopAnd.addr.0547 = phi i32 [ %TopAnd.addr.0, %list_Delete.exit39.thread.i ], [ %TopAnd.tr.ph634, %if.end74 ], [ %TopAnd.tr.ph634, %list_Delete.exit365 ], [ %TopAnd.tr.ph634, %if.then139.i ], [ %TopAnd.addr.0, %while.body.i47.i ]
  %cmp.i.not5.i = icmp eq ptr %call20, null
  br i1 %cmp.i.not5.i, label %list_Delete.exit, label %while.body.i345

while.body.i345:                                  ; preds = %if.end86, %while.body.i345
  %Current.06.i = phi ptr [ %L.addr.0.val.i, %while.body.i345 ], [ %call20, %if.end86 ]
  %L.addr.0.val.i = load ptr, ptr %Current.06.i, align 8
  %298 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i341 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %298, i64 0, i32 4
  %299 = load i32, ptr %total_size.i.i.i341, align 8
  %conv26.i.i.i342 = sext i32 %299 to i64
  %300 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i343 = add i64 %300, %conv26.i.i.i342
  store i64 %add27.i.i.i343, ptr @memory_FREEDBYTES, align 8
  ...
  %cmp.i.not.i344 = icmp eq ptr %L.addr.0.val.i, null
  br i1 %cmp.i.not.i344, label %list_Delete.exit, label %while.body.i345, !llvm.loop !13

list_Delete.exit:                                 ; preds = %while.body.i345, %if.end86
  %term.val570 = load i32, ptr %term, align 8
  %303 = load i32, ptr @fol_ALL, align 4
  %cmp.i.i571 = icmp eq i32 %303, %term.val570
  %304 = load i32, ptr @fol_EXIST, align 4
  %cmp.i4.i572 = icmp eq i32 %304, %term.val570
  %narrow.i573 = select i1 %cmp.i.i571, i1 true, i1 %cmp.i4.i572
  br i1 %narrow.i573, label %if.then.lr.ph, label %if.else87
...
if.else87:                                        ; preds = %list_Delete.exit, %cnf_PopAllQuantifier.exit, %entry
  ...
  %term.val.lcssa = phi i32 [ %term.val570630, %entry ], [ %term.val, %cnf_PopAllQuantifier.exit ], [ %term.val570, %list_Delete.exit ]
  %305 = load i32, ptr @fol_AND, align 4
  %cmp.i347 = icmp eq i32 %term.val.lcssa, %305
  %306 = load i32, ptr @fol_OR, align 4
  %cmp.i349 = icmp eq i32 %term.val.lcssa, %306
  %or.cond532 = select i1 %cmp.i347, i1 true, i1 %cmp.i349
  br i1 %or.cond532, label %if.then95, label %cleanup

if.then95:                                        ; preds = %if.else87
  %spec.select533 = select i1 %cmp.i349, i32 0, i32 %TopAnd.tr.ph.lcssa
  %307 = getelementptr i8, ptr %term, i64 16
  %scan.3642 = load ptr, ptr %307, align 8
  %cmp.i353.not643 = icmp eq ptr %scan.3642, null
  br i1 %cmp.i353.not643, label %cleanup, label %for.body106
...
for.body106:                                      ; preds = %if.then95, %for.body106
  ...
  tail call fastcc void @cnf_OptimizedSkolemFormula(ptr noundef %Search, ptr noundef %topterm, ptr noundef %toplabel, i32 noundef %spec.select533, ptr noundef %scan.3.val, ptr noundef %UsedTerms, ptr noundef %Symblist, i32 noundef %Result1, ptr noundef %InputClauseToTermLabellist, i32 noundef %Depth.tr.lcssa)
