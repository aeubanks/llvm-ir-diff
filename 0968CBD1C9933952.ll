...
cond.true.i.i.i.i:                                ; preds = %if.end
  ...
  br i1 %cmp.i.i.i.i.i.i, label %if.then.i.i.i.i.i.i, label %if.then.i.i.i.i.i.i.i.i.i, !prof !13
...
_ZNSt6vectorIdSaIdEEC2ERKS1_.exit:                ; preds = %if.end, %if.then.i.i.i.i.i.i.i.i.i
  %cond.i.i.i.i110 = phi ptr [ %call5.i.i.i.i4.i19.i, %if.then.i.i.i.i.i.i.i.i.i ], [ null, %if.end ]
  %add.ptr.i.i.i.i.i.i.i.i.i = getelementptr inbounds double, ptr %cond.i.i.i.i110, i64 %sub.ptr.div.i
  %div106 = lshr i64 %sub.ptr.div.i, 1
  %add.ptr.i = getelementptr inbounds double, ptr %cond.i.i.i.i110, i64 %div106
  %3 = tail call i64 @llvm.ctlz.i64(i64 %sub.ptr.div.i, i1 true), !range !14
  %sub.i.i = shl nuw nsw i64 %3, 1
  %mul.i70 = xor i64 %sub.i.i, 126
  invoke void @_ZSt13__introselectIN9__gnu_cxx17__normal_iteratorIPdSt6vectorIdSaIdEEEElNS0_5__ops15_Iter_less_iterEEvT_S9_S9_T0_T1_(ptr %cond.i.i.i.i110, ptr %add.ptr.i, ptr nonnull %add.ptr.i.i.i.i.i.i.i.i.i, i64 noundef %mul.i70)
...
invoke.cont:                                      ; preds = %_ZNSt6vectorIdSaIdEEC2ERKS1_.exit
  ...
  %sub.ptr.rhs.cast.i73 = ptrtoint ptr %5 to i64
  %sub.ptr.sub.i74 = sub i64 %sub.ptr.lhs.cast.i72, %sub.ptr.rhs.cast.i73
  %6 = and i64 %sub.ptr.sub.i74, 8
...
if.end19:                                         ; preds = %invoke.cont
  ...
  %div25108 = lshr i64 %sub.ptr.div.i75, 1
  %add.ptr.i81 = getelementptr inbounds double, ptr %cond.i.i.i.i110, i64 %div25108
  ...
  br i1 %cmp.i12.i85, label %invoke.cont41, label %if.end.i93

if.end.i93:                                       ; preds = %if.end19
  invoke void @_ZSt13__introselectIN9__gnu_cxx17__normal_iteratorIPdSt6vectorIdSaIdEEEElNS0_5__ops15_Iter_less_iterEEvT_S9_S9_T0_T1_(ptr %cond.i.i.i.i110, ptr nonnull %add.ptr.i82, ptr nonnull %add.ptr.i.i.i.i.i.i.i.i.i, i64 noundef %mul.i70)
          to label %invoke.cont41 unwind label %lpad40

invoke.cont41:                                    ; preds = %if.end19, %if.end.i93
  %9 = load double, ptr %add.ptr.i, align 8, !tbaa !9
  %10 = load double, ptr %add.ptr.i82, align 8, !tbaa !9
  %add = fadd double %9, %10
  %div44 = fmul double %add, 5.000000e-01
  br label %if.then.i.i.i

lpad40:                                           ; preds = %if.end.i93
  %11 = landingpad { ptr, i32 }
          cleanup
  br label %ehcleanup

if.then.i.i.i:                                    ; preds = %if.then17, %invoke.cont41
  %retval.0 = phi double [ %7, %if.then17 ], [ %div44, %invoke.cont41 ]
  tail call void @_ZdlPv(ptr noundef nonnull %cond.i.i.i.i110) #26
  br label %return

ehcleanup:                                        ; preds = %lpad40, %lpad
  %.pn = phi { ptr, i32 } [ %11, %lpad40 ], [ %8, %lpad ]
  %tobool.not.i.i.i96 = icmp eq ptr %cond.i.i.i.i110, null
  br i1 %tobool.not.i.i.i96, label %_ZNSt6vectorIdSaIdEED2Ev.exit98, label %if.then.i.i.i97

if.then.i.i.i97:                                  ; preds = %ehcleanup
  tail call void @_ZdlPv(ptr noundef nonnull %cond.i.i.i.i110) #26
  br label %_ZNSt6vectorIdSaIdEED2Ev.exit98

_ZNSt6vectorIdSaIdEED2Ev.exit98:                  ; preds = %ehcleanup, %if.then.i.i.i97
  resume { ptr, i32 } %.pn

return:                                           ; preds = %if.then.i.i.i, %"_ZNK9benchmark3$_0clERKSt6vectorIdSaIdEE.exit.i", %if.then
  %retval.1 = phi double [ %mul.i, %"_ZNK9benchmark3$_0clERKSt6vectorIdSaIdEE.exit.i" ], [ 0.000000e+00, %if.then ], [ %retval.0, %if.then.i.i.i ]
  ret double %retval.1
}
...
if.end.i:                                         ; preds = %if.end
  ...
  br i1 %cmp3.i.not, label %if.end.i369.thread, label %if.then4.i

if.end.i369.thread:                               ; preds = %if.end.i
  %_M_end_of_storage.i.i363903 = getelementptr inbounds %"struct.std::_Vector_base<double, std::allocator<double>>::_Vector_impl_data", ptr %cpu_accumulated_time_stat, i64 0, i32 2
...
if.then4.i:                                       ; preds = %if.end.i
  ...
  %call5.i.i.i.i355 = invoke noalias noundef nonnull ptr @_Znwm(i64 noundef %mul.i.i.i.i) #25
          to label %if.then4.i376 unwind label %lpad10

if.then4.i376:                                    ; preds = %if.then4.i
...
_ZNSt12_Vector_baseIdSaIdEE13_M_deallocateEPdm.exit.i383: ; preds = %if.then4.i376
...
invoke.cont13:                                    ; preds = %if.end.i369.thread, %_ZNSt12_Vector_baseIdSaIdEE13_M_deallocateEPdm.exit.i383
  %_M_end_of_storage.i.i363904 = phi ptr [ %_M_end_of_storage.i.i363903, %if.end.i369.thread ], [ %_M_end_of_storage.i.i363, %_ZNSt12_Vector_baseIdSaIdEE13_M_deallocateEPdm.exit.i383 ]
...
for.cond.cleanup:                                 ; preds = %for.cond.cleanup27
  %.pre893 = load ptr, ptr %reports, align 8, !tbaa !5
  %.pre894 = load ptr, ptr %_M_finish.i, align 8, !tbaa !5
  %cmp.i509.not879 = icmp eq ptr %.pre893, %.pre894
  br i1 %cmp.i509.not879, label %for.cond.cleanup85, label %for.body86.lr.ph

for.body86.lr.ph:                                 ; preds = %for.cond.cleanup
  %_M_finish.i523 = getelementptr inbounds %"struct.std::_Vector_base<double, std::allocator<double>>::_Vector_impl_data", ptr %real_accumulated_time_stat, i64 0, i32 1
  %_M_finish.i539 = getelementptr inbounds %"struct.std::_Vector_base<double, std::allocator<double>>::_Vector_impl_data", ptr %cpu_accumulated_time_stat, i64 0, i32 1
  br label %for.body86

lpad10:                                           ; preds = %if.then4.i376, %if.then4.i, %if.then.i
  %6 = landingpad { ptr, i32 }
          cleanup
  br label %ehcleanup287

for.body:                                         ; preds = %for.body.lr.ph, %for.cond.cleanup27
  %__begin1.sroa.0.0875 = phi ptr [ %0, %for.body.lr.ph ], [ %incdec.ptr.i, %for.cond.cleanup27 ]
  %_M_left.i.i = getelementptr inbounds %"struct.benchmark::BenchmarkReporter::Run", ptr %__begin1.sroa.0.0875, i64 0, i32 23, i32 0, i32 0, i32 1, i32 0, i32 2
  %7 = load ptr, ptr %_M_left.i.i, align 8, !tbaa !45
  %add.ptr.i.i = getelementptr inbounds %"struct.benchmark::BenchmarkReporter::Run", ptr %__begin1.sroa.0.0875, i64 0, i32 23, i32 0, i32 0, i32 1
  %cmp.i391.not864 = icmp eq ptr %7, %add.ptr.i.i
  br i1 %cmp.i391.not864, label %for.cond.cleanup27, label %for.body28

for.cond.cleanup27:                               ; preds = %if.end62, %for.body
  %incdec.ptr.i = getelementptr inbounds %"struct.benchmark::BenchmarkReporter::Run", ptr %__begin1.sroa.0.0875, i64 1
...
for.body28:                                       ; preds = %for.body, %if.end62
  %__begin2.sroa.0.0868 = phi ptr [ %call.i, %if.end62 ], [ %7, %for.body ]
  %_M_storage.i.i = getelementptr inbounds %"struct.std::_Rb_tree_node", ptr %__begin2.sroa.0.0868, i64 0, i32 1
  %call29.val344 = load ptr, ptr %_M_storage.i.i, align 8
  %8 = getelementptr %"struct.std::_Rb_tree_node", ptr %__begin2.sroa.0.0868, i64 0, i32 1, i32 0, i64 8
...
_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i.i.i.i: ; preds = %lor.lhs.false.i.i
  %__y.addr.02.i.i.i.sroa.gep818 = getelementptr inbounds %"struct.std::_Rb_tree_node.36", ptr %__y.addr.02.i.i.i, i64 0, i32 1
  %__x.addr.03.i.i.i.sroa.gep819 = getelementptr inbounds %"struct.std::_Rb_tree_node.36", ptr %__x.addr.03.i.i.i, i64 0, i32 1
  %__y.addr.1.i.i.i.sroa.sel820 = select i1 %cmp.i.i.i.i.i392, ptr %__y.addr.02.i.i.i.sroa.gep818, ptr %__x.addr.03.i.i.i.sroa.gep819
  %12 = load ptr, ptr %__y.addr.1.i.i.i.sroa.sel820, align 8, !tbaa !49
  ...
  br i1 %tobool.not.i.i.i.i.i, label %if.then.i.i.i.i.i393, label %invoke.cont31
...
invoke.cont31:                                    ; preds = %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i.i.i.i, %if.then.i.i.i.i.i393
...
if.then37:                                        ; preds = %for.body28, %_ZNSt8_Rb_treeINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt4pairIKS5_ZN9benchmark12ComputeStatsERKSt6vectorINS8_17BenchmarkReporter3RunESaISB_EEE11CounterStatESt10_Select1stISH_ESt4lessIS5_ESaISH_EE14_M_lower_boundEPSt13_Rb_tree_nodeISH_EPSt18_Rb_tree_node_baseRS7_.exit.i.i, %invoke.cont31
  ...
  %second = getelementptr inbounds %"struct.std::_Rb_tree_node", ptr %__begin2.sroa.0.0868, i64 0, i32 1, i32 0, i64 32
  ...
  %cmp.i.i.i397 = icmp ugt i64 %call29.val345, 15
  br i1 %cmp.i.i.i397, label %if.then.i.i.i, label %if.end.i.i.i

if.then.i.i.i:                                    ; preds = %if.then37
  %call2.i12.i.i400 = invoke noundef ptr @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE9_M_createERmm(ptr noundef nonnull align 8 dereferenceable(32) %ref.tmp38, ptr noundef nonnull align 8 dereferenceable(8) %__dnew.i.i.i, i64 noundef 0)
          to label %call2.i12.i.i.noexc unwind label %lpad41

call2.i12.i.i.noexc:                              ; preds = %if.then.i.i.i
  store ptr %call2.i12.i.i400, ptr %ref.tmp38, align 8, !tbaa !49
...
if.end.i.i.i:                                     ; preds = %call2.i12.i.i.noexc, %if.then37
  %14 = phi ptr [ %call2.i12.i.i400, %call2.i12.i.i.noexc ], [ %5, %if.then37 ]
  switch i64 %call29.val345, label %if.end.i.i.i.i.i.i [
    i64 1, label %if.then.i.i.i.i.i398
    i64 0, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC2ERKS4_.exit.i
  ]

if.then.i.i.i.i.i398:                             ; preds = %if.end.i.i.i
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC2ERKS4_.exit.i: ; preds = %if.end.i.i.i.i.i.i, %if.then.i.i.i.i.i398, %if.end.i.i.i
  ...
  br i1 %cmp.not9.i, label %if.then.i767, label %while.body.i

while.body.i:                                     ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC2ERKS4_.exit.i, %_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit.i765
  %__x.010.i = phi ptr [ %__x.0.i, %_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit.i765 ], [ %__x.08.i, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC2ERKS4_.exit.i ]
  %_M_string_length.i10.i.i.i.i750 = getelementptr inbounds %"struct.std::_Rb_tree_node.36", ptr %__x.010.i, i64 0, i32 1, i32 0, i64 8
  %18 = load i64, ptr %_M_string_length.i10.i.i.i.i750, align 8, !tbaa !48
  %.sroa.speculated.i.i.i.i751 = call i64 @llvm.umin.i64(i64 %call.val13.i.i, i64 %18)
  %cmp.i11.i.i.i.i752 = icmp eq i64 %.sroa.speculated.i.i.i.i751, 0
  br i1 %cmp.i11.i.i.i.i752, label %if.then.i.i.i.i761, label %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i.i.i756

_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i.i.i756: ; preds = %while.body.i
  %_M_storage.i.i.i753 = getelementptr inbounds %"struct.std::_Rb_tree_node.36", ptr %__x.010.i, i64 0, i32 1
  %19 = load ptr, ptr %_M_storage.i.i.i753, align 8, !tbaa !49
  %call.i.i.i.i.i754 = call i32 @memcmp(ptr noundef %call.val.i.i, ptr noundef %19, i64 noundef %.sroa.speculated.i.i.i.i751) #27
  %tobool.not.i.i.i.i755 = icmp eq i32 %call.i.i.i.i.i754, 0
  br i1 %tobool.not.i.i.i.i755, label %if.then.i.i.i.i761, label %_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit.i765

if.then.i.i.i.i761:                               ; preds = %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i.i.i756, %while.body.i
  %sub.i.i.i.i.i757 = sub i64 %call.val13.i.i, %18
  %spec.select6.i.i.i.i.i758 = call i64 @llvm.smax.i64(i64 %sub.i.i.i.i.i757, i64 -2147483648)
  %retval.07.i.i.i.i.i759 = call i64 @llvm.smin.i64(i64 %spec.select6.i.i.i.i.i758, i64 2147483647)
  %retval.0.i12.i.i.i.i760 = trunc i64 %retval.07.i.i.i.i.i759 to i32
  br label %_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit.i765

_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit.i765: ; preds = %if.then.i.i.i.i761, %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i.i.i756
  %__r.0.i.i.i.i762 = phi i32 [ %call.i.i.i.i.i754, %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i.i.i756 ], [ %retval.0.i12.i.i.i.i760, %if.then.i.i.i.i761 ]
  %cmp.i.i.i763 = icmp slt i32 %__r.0.i.i.i.i762, 0
  %cond.in.v.i = select i1 %cmp.i.i.i763, i64 16, i64 24
  %cond.in.i = getelementptr i8, ptr %__x.010.i, i64 %cond.in.v.i
  %__x.0.i = load ptr, ptr %cond.in.i, align 8, !tbaa !5
  %cmp.not.i764 = icmp eq ptr %__x.0.i, null
  br i1 %cmp.not.i764, label %while.end.i, label %while.body.i, !llvm.loop !59

while.end.i:                                      ; preds = %_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit.i765
  br i1 %cmp.i.i.i763, label %if.then.i767, label %if.end12.i

if.then.i767:                                     ; preds = %while.end.i, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC2ERKS4_.exit.i
  ...
  %cmp.i.i766 = icmp eq ptr %__y.0.lcssa16.i, %this.val27.i
  br i1 %cmp.i.i766, label %if.then.i.i403, label %if.else.i768

if.else.i768:                                     ; preds = %if.then.i767
  ...
  %.pre902 = call i64 @llvm.umin.i64(i64 %.pre, i64 %call.val13.i.i)
  br label %if.end12.i

if.end12.i:                                       ; preds = %if.else.i768, %while.end.i
  %.sroa.speculated.i.i.i31.i.pre-phi = phi i64 [ %.pre902, %if.else.i768 ], [ %.sroa.speculated.i.i.i.i751, %while.end.i ]
  %20 = phi i64 [ %.pre, %if.else.i768 ], [ %18, %while.end.i ]
  %__y.0.lcssa17.i = phi ptr [ %__y.0.lcssa16.i, %if.else.i768 ], [ %__x.010.i, %while.end.i ]
  %__j.sroa.0.0.i = phi ptr [ %call.i.i, %if.else.i768 ], [ %__x.010.i, %while.end.i ]
...
_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit43.i: ; preds = %if.then.i.i.i40.i, %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i.i35.i
  ...
  br i1 %cmp.i.i42.i, label %if.then.i.i403, label %_ZZN9benchmark12ComputeStatsERKSt6vectorINS_17BenchmarkReporter3RunESaIS2_EEEN11CounterStatD2Ev.exit.i

if.then.i.i403:                                   ; preds = %_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit43.i, %if.then.i767
  %retval.sroa.4.0.i.ph = phi ptr [ %__y.0.lcssa16.i, %if.then.i767 ], [ %__y.0.lcssa17.i, %_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit43.i ]
  %cmp2.i.i.i = icmp eq ptr %4, %retval.sroa.4.0.i.ph
  br i1 %cmp2.i.i.i, label %lor.end.i.i.i, label %lor.rhs.i.i.i

lor.rhs.i.i.i:                                    ; preds = %if.then.i.i403
  ...
  %.sroa.speculated.i.i.i.i.i.i404 = call i64 @llvm.umin.i64(i64 %call.val13.i.i, i64 %22)
  %cmp.i11.i.i.i.i.i.i405 = icmp eq i64 %.sroa.speculated.i.i.i.i.i.i404, 0
  br i1 %cmp.i11.i.i.i.i.i.i405, label %if.then.i.i.i.i.i.i413, label %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i.i.i.i.i408

_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i.i.i.i.i408: ; preds = %lor.rhs.i.i.i
  ...
  %call.i.i.i.i.i.i.i406 = call i32 @memcmp(ptr noundef %call.val.i.i, ptr noundef %23, i64 noundef %.sroa.speculated.i.i.i.i.i.i404) #27
  %tobool.not.i.i.i.i.i.i407 = icmp eq i32 %call.i.i.i.i.i.i.i406, 0
  br i1 %tobool.not.i.i.i.i.i.i407, label %if.then.i.i.i.i.i.i413, label %_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit.i.i.i416

if.then.i.i.i.i.i.i413:                           ; preds = %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i.i.i.i.i408, %lor.rhs.i.i.i
  %sub.i.i.i.i.i.i.i409 = sub i64 %call.val13.i.i, %22
  %spec.select6.i.i.i.i.i.i.i410 = call i64 @llvm.smax.i64(i64 %sub.i.i.i.i.i.i.i409, i64 -2147483648)
  %retval.07.i.i.i.i.i.i.i411 = call i64 @llvm.smin.i64(i64 %spec.select6.i.i.i.i.i.i.i410, i64 2147483647)
  %retval.0.i12.i.i.i.i.i.i412 = trunc i64 %retval.07.i.i.i.i.i.i.i411 to i32
  br label %_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit.i.i.i416

_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit.i.i.i416: ; preds = %if.then.i.i.i.i.i.i413, %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i.i.i.i.i408
  %__r.0.i.i.i.i.i.i414 = phi i32 [ %call.i.i.i.i.i.i.i406, %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i.i.i.i.i408 ], [ %retval.0.i12.i.i.i.i.i.i412, %if.then.i.i.i.i.i.i413 ]
  %cmp.i.i.i.i.i415 = icmp slt i32 %__r.0.i.i.i.i.i.i414, 0
  br label %lor.end.i.i.i

lor.end.i.i.i:                                    ; preds = %_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit.i.i.i416, %if.then.i.i403
  %24 = phi i1 [ %cmp.i.i.i.i.i415, %_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit.i.i.i416 ], [ true, %if.then.i.i403 ]
  %call5.i.i.i.i.i.i.i.i419 = invoke noalias noundef nonnull dereferenceable(104) ptr @_Znwm(i64 noundef 104) #25
          to label %call5.i.i.i.i.i.i.i.i.noexc unwind label %lpad43

call5.i.i.i.i.i.i.i.i.noexc:                      ; preds = %lor.end.i.i.i
  %_M_storage.i.i.i.i.i.i.i = getelementptr inbounds %"struct.std::_Rb_tree_node.36", ptr %call5.i.i.i.i.i.i.i.i419, i64 0, i32 1
  %25 = getelementptr inbounds %"struct.std::_Rb_tree_node.36", ptr %call5.i.i.i.i.i.i.i.i419, i64 0, i32 1, i32 0, i64 16
  ...
  br i1 %cmp.i.i.i.i.i.i.i.i.i.i.i, label %if.then.i.i.i.i.i.i.i.i.i.i.i417, label %if.end.i.i.i.i.i.i.i.i.i.i.i

if.then.i.i.i.i.i.i.i.i.i.i.i417:                 ; preds = %call5.i.i.i.i.i.i.i.i.noexc
...
call2.i12.i.i.i.i.noexc.i.i.i.i.i.i:              ; preds = %if.then.i.i.i.i.i.i.i.i.i.i.i417
...
lpad.i.i.i.i.i.i:                                 ; preds = %if.then.i.i.i.i.i.i.i.i.i.i.i417
  %29 = landingpad { ptr, i32 }
          catch ptr null
  %30 = extractvalue { ptr, i32 } %29, 0
  %31 = call ptr @__cxa_begin_catch(ptr %30) #27
  call void @_ZdlPv(ptr noundef nonnull %call5.i.i.i.i.i.i.i.i419) #26
...
invoke.cont44:                                    ; preds = %if.end.i.i.i.i.i.i.i.i.i.i.i, %if.then.i.i.i.i.i.i.i.i.i.i.i.i.i, %if.end.i.i.i.i.i.i.i.i.i.i.i.i.i.i
  ...
  %_M_string_length.i.i.i.i.i.i.i.i.i.i.i.i.i = getelementptr inbounds %"struct.std::_Rb_tree_node.36", ptr %call5.i.i.i.i.i.i.i.i419, i64 0, i32 1, i32 0, i64 8
  ...
  %second.i.i.i.i.i.i.i.i.i = getelementptr inbounds %"struct.std::_Rb_tree_node.36", ptr %call5.i.i.i.i.i.i.i.i419, i64 0, i32 1, i32 0, i64 32
  ...
  %s.i.i.i.i.i.i.i.i.i.i = getelementptr inbounds %"struct.std::_Rb_tree_node.36", ptr %call5.i.i.i.i.i.i.i.i419, i64 0, i32 1, i32 0, i64 48
  %37 = load <2 x ptr>, ptr %s.i.i, align 8, !tbaa !5
  store <2 x ptr> %37, ptr %s.i.i.i.i.i.i.i.i.i.i, align 8, !tbaa !5
  %_M_end_of_storage.i.i.i.i.i.i.i.i.i.i.i.i.i.i = getelementptr inbounds %"struct.std::_Rb_tree_node.36", ptr %call5.i.i.i.i.i.i.i.i419, i64 0, i32 1, i32 0, i64 64
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %s.i.i, i8 0, i64 24, i1 false)
  call void @_ZSt29_Rb_tree_insert_and_rebalancebPSt18_Rb_tree_node_baseS0_RS_(i1 noundef zeroext %24, ptr noundef nonnull %call5.i.i.i.i.i.i.i.i419, ptr noundef nonnull %retval.sroa.4.0.i.ph, ptr noundef nonnull align 8 dereferenceable(32) %4) #27
  ...
  %tobool.not.i.i.i.i.i421 = icmp eq ptr %second.val.i.pre, null
  br i1 %tobool.not.i.i.i.i.i421, label %_ZZN9benchmark12ComputeStatsERKSt6vectorINS_17BenchmarkReporter3RunESaIS2_EEEN11CounterStatD2Ev.exit.i, label %if.then.i.i.i.i.i422

if.then.i.i.i.i.i422:                             ; preds = %invoke.cont44
...
_ZZN9benchmark12ComputeStatsERKSt6vectorINS_17BenchmarkReporter3RunESaIS2_EEEN11CounterStatD2Ev.exit.i: ; preds = %_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit43.i, %if.then.i.i.i.i.i422, %invoke.cont44
  %40 = load ptr, ptr %ref.tmp38, align 8, !tbaa !49
  %cmp.i.i.i.i423 = icmp eq ptr %40, %5
  br i1 %cmp.i.i.i.i423, label %_ZZN9benchmark12ComputeStatsERKSt6vectorINS_17BenchmarkReporter3RunESaIS2_EEEN11CounterStatD2Ev.exit, label %if.then.i.i.i424

if.then.i.i.i424:                                 ; preds = %_ZZN9benchmark12ComputeStatsERKSt6vectorINS_17BenchmarkReporter3RunESaIS2_EEEN11CounterStatD2Ev.exit.i
...
_ZZN9benchmark12ComputeStatsERKSt6vectorINS_17BenchmarkReporter3RunESaIS2_EEEN11CounterStatD2Ev.exit: ; preds = %if.then.i.i.i424, %_ZZN9benchmark12ComputeStatsERKSt6vectorINS_17BenchmarkReporter3RunESaIS2_EEEN11CounterStatD2Ev.exit.i
  ...
  %this.val.i.i426 = load ptr, ptr %_M_parent.i.i.i.i.i, align 8, !tbaa !44
  %cmp.not1.i.i.i428 = icmp eq ptr %this.val.i.i426, null
  br i1 %cmp.not1.i.i.i428, label %invoke.cont51, label %while.body.i.i.i434

while.body.i.i.i434:                              ; preds = %_ZZN9benchmark12ComputeStatsERKSt6vectorINS_17BenchmarkReporter3RunESaIS2_EEEN11CounterStatD2Ev.exit, %_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit.i.i.i451
  %__x.addr.03.i.i.i429 = phi ptr [ %__x.addr.1.i.i.i449, %_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit.i.i.i451 ], [ %this.val.i.i426, %_ZZN9benchmark12ComputeStatsERKSt6vectorINS_17BenchmarkReporter3RunESaIS2_EEEN11CounterStatD2Ev.exit ]
  %__y.addr.02.i.i.i430 = phi ptr [ %__y.addr.1.i.i.i446, %_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit.i.i.i451 ], [ %4, %_ZZN9benchmark12ComputeStatsERKSt6vectorINS_17BenchmarkReporter3RunESaIS2_EEEN11CounterStatD2Ev.exit ]
  %_M_string_length.i.i.i.i.i.i.i431 = getelementptr inbounds %"struct.std::_Rb_tree_node.36", ptr %__x.addr.03.i.i.i429, i64 0, i32 1, i32 0, i64 8
  %41 = load i64, ptr %_M_string_length.i.i.i.i.i.i.i431, align 8, !tbaa !48
  %.sroa.speculated.i.i.i.i.i.i432 = call i64 @llvm.umin.i64(i64 %41, i64 %call29.val343)
...
_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i.i.i.i.i438: ; preds = %while.body.i.i.i434
  %_M_storage.i.i.i.i.i435 = getelementptr inbounds %"struct.std::_Rb_tree_node.36", ptr %__x.addr.03.i.i.i429, i64 0, i32 1
  %42 = load ptr, ptr %_M_storage.i.i.i.i.i435, align 8, !tbaa !49
  %call.i.i.i.i.i.i.i436 = call i32 @memcmp(ptr noundef %42, ptr noundef %call29.val, i64 noundef %.sroa.speculated.i.i.i.i.i.i432) #27
  %tobool.not.i.i.i.i.i.i437 = icmp eq i32 %call.i.i.i.i.i.i.i436, 0
  br i1 %tobool.not.i.i.i.i.i.i437, label %if.then.i.i.i.i.i.i443, label %_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit.i.i.i451

if.then.i.i.i.i.i.i443:                           ; preds = %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i.i.i.i.i438, %while.body.i.i.i434
  %sub.i.i.i.i.i.i.i439 = sub i64 %41, %call29.val343
  ...
  br label %_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit.i.i.i451

_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit.i.i.i451: ; preds = %if.then.i.i.i.i.i.i443, %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i.i.i.i.i438
  ...
  %__y.addr.1.i.i.i446 = select i1 %cmp.i.i.i.i.i445, ptr %__y.addr.02.i.i.i430, ptr %__x.addr.03.i.i.i429
  %__x.addr.1.in.v.i.i.i447 = select i1 %cmp.i.i.i.i.i445, i64 24, i64 16
  %__x.addr.1.in.i.i.i448 = getelementptr i8, ptr %__x.addr.03.i.i.i429, i64 %__x.addr.1.in.v.i.i.i447
  %__x.addr.1.i.i.i449 = load ptr, ptr %__x.addr.1.in.i.i.i448, align 8, !tbaa !5
  %cmp.not.i.i.i450 = icmp eq ptr %__x.addr.1.i.i.i449, null
  br i1 %cmp.not.i.i.i450, label %_ZNSt8_Rb_treeINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt4pairIKS5_ZN9benchmark12ComputeStatsERKSt6vectorINS8_17BenchmarkReporter3RunESaISB_EEE11CounterStatESt10_Select1stISH_ESt4lessIS5_ESaISH_EE14_M_lower_boundEPSt13_Rb_tree_nodeISH_EPSt18_Rb_tree_node_baseRS7_.exit.i.i453, label %while.body.i.i.i434, !llvm.loop !50

_ZNSt8_Rb_treeINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt4pairIKS5_ZN9benchmark12ComputeStatsERKSt6vectorINS8_17BenchmarkReporter3RunESaISB_EEE11CounterStatESt10_Select1stISH_ESt4lessIS5_ESaISH_EE14_M_lower_boundEPSt13_Rb_tree_nodeISH_EPSt18_Rb_tree_node_baseRS7_.exit.i.i453: ; preds = %_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit.i.i.i451
  %cmp.i.i.i452 = icmp eq ptr %__y.addr.1.i.i.i446, %4
  br i1 %cmp.i.i.i452, label %invoke.cont51, label %lor.lhs.false.i.i457

lor.lhs.false.i.i457:                             ; preds = %_ZNSt8_Rb_treeINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt4pairIKS5_ZN9benchmark12ComputeStatsERKSt6vectorINS8_17BenchmarkReporter3RunESaISB_EEE11CounterStatESt10_Select1stISH_ESt4lessIS5_ESaISH_EE14_M_lower_boundEPSt13_Rb_tree_nodeISH_EPSt18_Rb_tree_node_baseRS7_.exit.i.i453
  %_M_string_length.i.i.i.i.i.i.i431.le = getelementptr inbounds %"struct.std::_Rb_tree_node.36", ptr %__x.addr.03.i.i.i429, i64 0, i32 1, i32 0, i64 8
  %__y.addr.02.i.i.i430.sroa.gep = getelementptr inbounds %"struct.std::_Rb_tree_node.36", ptr %__y.addr.02.i.i.i430, i64 0, i32 1, i32 0, i64 8
  %__y.addr.1.i.i.i446.sroa.sel = select i1 %cmp.i.i.i.i.i445, ptr %__y.addr.02.i.i.i430.sroa.gep, ptr %_M_string_length.i.i.i.i.i.i.i431.le
  %43 = load i64, ptr %__y.addr.1.i.i.i446.sroa.sel, align 8, !tbaa !48
  %.sroa.speculated.i.i.i.i.i455 = call i64 @llvm.umin.i64(i64 %call29.val343, i64 %43)
  %cmp.i11.i.i.i.i.i456 = icmp eq i64 %.sroa.speculated.i.i.i.i.i455, 0
  br i1 %cmp.i11.i.i.i.i.i456, label %if.then.i.i.i.i.i466, label %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i.i.i.i461

_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i.i.i.i461: ; preds = %lor.lhs.false.i.i457
  %__y.addr.02.i.i.i430.sroa.gep821 = getelementptr inbounds %"struct.std::_Rb_tree_node.36", ptr %__y.addr.02.i.i.i430, i64 0, i32 1
  %__x.addr.03.i.i.i429.sroa.gep822 = getelementptr inbounds %"struct.std::_Rb_tree_node.36", ptr %__x.addr.03.i.i.i429, i64 0, i32 1
  %__y.addr.1.i.i.i446.sroa.sel823 = select i1 %cmp.i.i.i.i.i445, ptr %__y.addr.02.i.i.i430.sroa.gep821, ptr %__x.addr.03.i.i.i429.sroa.gep822
  %44 = load ptr, ptr %__y.addr.1.i.i.i446.sroa.sel823, align 8, !tbaa !49
  %call.i.i.i.i.i.i459 = call i32 @memcmp(ptr noundef %call29.val, ptr noundef %44, i64 noundef %.sroa.speculated.i.i.i.i.i455) #27
  %tobool.not.i.i.i.i.i460 = icmp eq i32 %call.i.i.i.i.i.i459, 0
  br i1 %tobool.not.i.i.i.i.i460, label %if.then.i.i.i.i.i466, label %_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit.i.i470

if.then.i.i.i.i.i466:                             ; preds = %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i.i.i.i461, %lor.lhs.false.i.i457
  %sub.i.i.i.i.i.i462 = sub i64 %call29.val343, %43
  %spec.select6.i.i.i.i.i.i463 = call i64 @llvm.smax.i64(i64 %sub.i.i.i.i.i.i462, i64 -2147483648)
  %retval.07.i.i.i.i.i.i464 = call i64 @llvm.smin.i64(i64 %spec.select6.i.i.i.i.i.i463, i64 2147483647)
  %retval.0.i12.i.i.i.i.i465 = trunc i64 %retval.07.i.i.i.i.i.i464 to i32
  br label %_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit.i.i470

_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit.i.i470: ; preds = %if.then.i.i.i.i.i466, %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i.i.i.i461
  %__r.0.i.i.i.i.i467 = phi i32 [ %call.i.i.i.i.i.i459, %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i.i.i.i461 ], [ %retval.0.i12.i.i.i.i.i465, %if.then.i.i.i.i.i466 ]
  %cmp.i.i.i.i468 = icmp slt i32 %__r.0.i.i.i.i.i467, 0
  %spec.select.i.i469 = select i1 %cmp.i.i.i.i468, ptr %4, ptr %__y.addr.1.i.i.i446
  br label %invoke.cont51

invoke.cont51:                                    ; preds = %_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit.i.i470, %_ZNSt8_Rb_treeINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt4pairIKS5_ZN9benchmark12ComputeStatsERKSt6vectorINS8_17BenchmarkReporter3RunESaISB_EEE11CounterStatESt10_Select1stISH_ESt4lessIS5_ESaISH_EE14_M_lower_boundEPSt13_Rb_tree_nodeISH_EPSt18_Rb_tree_node_baseRS7_.exit.i.i453, %_ZZN9benchmark12ComputeStatsERKSt6vectorINS_17BenchmarkReporter3RunESaIS2_EEEN11CounterStatD2Ev.exit
  %retval.sroa.0.0.i.i471 = phi ptr [ %4, %_ZNSt8_Rb_treeINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt4pairIKS5_ZN9benchmark12ComputeStatsERKSt6vectorINS8_17BenchmarkReporter3RunESaISB_EEE11CounterStatESt10_Select1stISH_ESt4lessIS5_ESaISH_EE14_M_lower_boundEPSt13_Rb_tree_nodeISH_EPSt18_Rb_tree_node_baseRS7_.exit.i.i453 ], [ %spec.select.i.i469, %_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit.i.i470 ], [ %4, %_ZZN9benchmark12ComputeStatsERKSt6vectorINS_17BenchmarkReporter3RunESaIS2_EEEN11CounterStatD2Ev.exit ]
  %s57 = getelementptr inbounds %"struct.std::_Rb_tree_node.36", ptr %retval.sroa.0.0.i.i471, i64 0, i32 1, i32 0, i64 48
  %45 = load ptr, ptr %_M_finish.i, align 8, !tbaa !5
  %46 = load ptr, ptr %reports, align 8, !tbaa !5
  %sub.ptr.lhs.cast.i475 = ptrtoint ptr %45 to i64
  %sub.ptr.rhs.cast.i476 = ptrtoint ptr %46 to i64
  %sub.ptr.sub.i477 = sub i64 %sub.ptr.lhs.cast.i475, %sub.ptr.rhs.cast.i476
  %sub.ptr.div.i478 = sdiv exact i64 %sub.ptr.sub.i477, 528
  %cmp.i479 = icmp ugt i64 %sub.ptr.div.i478, 1152921504606846975
  br i1 %cmp.i479, label %if.then.i480, label %if.end.i487

if.then.i480:                                     ; preds = %invoke.cont51
  invoke void @_ZSt20__throw_length_errorPKc(ptr noundef nonnull @.str.2) #24
          to label %.noexc502 unwind label %lpad30.loopexit.split-lp

.noexc502:                                        ; preds = %if.then.i480
  unreachable

if.end.i487:                                      ; preds = %invoke.cont51
  %_M_end_of_storage.i.i481 = getelementptr inbounds %"struct.std::_Rb_tree_node.36", ptr %retval.sroa.0.0.i.i471, i64 0, i32 1, i32 0, i64 64
  %47 = load ptr, ptr %_M_end_of_storage.i.i481, align 8, !tbaa !41
  %48 = load ptr, ptr %s57, align 8, !tbaa !17
  %sub.ptr.lhs.cast.i.i482 = ptrtoint ptr %47 to i64
  %sub.ptr.rhs.cast.i.i483 = ptrtoint ptr %48 to i64
  ...
  %cmp3.i486 = icmp ult i64 %sub.ptr.div.i.i485, %sub.ptr.div.i478
  br i1 %cmp3.i486, label %if.then4.i494, label %if.end62

if.then4.i494:                                    ; preds = %if.end.i487
  %_M_finish.i.i488 = getelementptr inbounds %"struct.std::_Rb_tree_node.36", ptr %retval.sroa.0.0.i.i471, i64 0, i32 1, i32 0, i64 56
  %49 = load ptr, ptr %_M_finish.i.i488, align 8, !tbaa !15
  %sub.ptr.lhs.cast.i30.i489 = ptrtoint ptr %49 to i64
  %sub.ptr.sub.i32.i490 = sub i64 %sub.ptr.lhs.cast.i30.i489, %sub.ptr.rhs.cast.i.i483
  %sub.ptr.div.i33.i491 = ashr exact i64 %sub.ptr.sub.i32.i490, 3
  %mul.i.i.i.i492 = shl nuw nsw i64 %sub.ptr.div.i478, 3
  %call5.i.i.i.i504 = invoke noalias noundef nonnull ptr @_Znwm(i64 noundef %mul.i.i.i.i492) #25
          to label %call5.i.i.i.i.noexc503 unwind label %lpad30.loopexit

call5.i.i.i.i.noexc503:                           ; preds = %if.then4.i494
  %cmp.i.i.i.i.i493 = icmp sgt i64 %sub.ptr.sub.i32.i490, 0
  br i1 %cmp.i.i.i.i.i493, label %if.then.i.i.i.i.i495, label %_ZNSt6vectorIdSaIdEE11_S_relocateEPdS2_S2_RS0_.exit.i497

if.then.i.i.i.i.i495:                             ; preds = %call5.i.i.i.i.noexc503
  call void @llvm.memmove.p0.p0.i64(ptr nonnull align 8 %call5.i.i.i.i504, ptr align 8 %48, i64 %sub.ptr.sub.i32.i490, i1 false)
  br label %_ZNSt6vectorIdSaIdEE11_S_relocateEPdS2_S2_RS0_.exit.i497

_ZNSt6vectorIdSaIdEE11_S_relocateEPdS2_S2_RS0_.exit.i497: ; preds = %if.then.i.i.i.i.i495, %call5.i.i.i.i.noexc503
  %tobool.not.i.i496 = icmp eq ptr %48, null
  br i1 %tobool.not.i.i496, label %_ZNSt12_Vector_baseIdSaIdEE13_M_deallocateEPdm.exit.i501, label %if.then.i.i498

if.then.i.i498:                                   ; preds = %_ZNSt6vectorIdSaIdEE11_S_relocateEPdS2_S2_RS0_.exit.i497
  call void @_ZdlPv(ptr noundef nonnull %48) #26
  br label %_ZNSt12_Vector_baseIdSaIdEE13_M_deallocateEPdm.exit.i501

_ZNSt12_Vector_baseIdSaIdEE13_M_deallocateEPdm.exit.i501: ; preds = %if.then.i.i498, %_ZNSt6vectorIdSaIdEE11_S_relocateEPdS2_S2_RS0_.exit.i497
  store ptr %call5.i.i.i.i504, ptr %s57, align 8, !tbaa !17
  %add.ptr.i499 = getelementptr inbounds double, ptr %call5.i.i.i.i504, i64 %sub.ptr.div.i33.i491
  store ptr %add.ptr.i499, ptr %_M_finish.i.i488, align 8, !tbaa !15
  %add.ptr21.i500 = getelementptr inbounds double, ptr %call5.i.i.i.i504, i64 %sub.ptr.div.i478
  store ptr %add.ptr21.i500, ptr %_M_end_of_storage.i.i481, align 8, !tbaa !41
  br label %if.end62

lpad30.loopexit:                                  ; preds = %if.then4.i494
  %lpad.loopexit844 = landingpad { ptr, i32 }
          cleanup
  br label %ehcleanup281

lpad30.loopexit.split-lp:                         ; preds = %if.then.i480
...
lpad43.body:                                      ; preds = %lpad3.i.i.i.i.i.i, %lpad43
  %eh.lpad-body420 = phi { ptr, i32 } [ %51, %lpad43 ], [ %32, %lpad3.i.i.i.i.i.i ]
...
ehcleanup:                                        ; preds = %lpad43.body, %lpad41
  %eh.lpad-body420.pn = phi { ptr, i32 } [ %eh.lpad-body420, %lpad43.body ], [ %50, %lpad41 ]
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %ref.tmp40.sroa.0)
  call void @llvm.lifetime.end.p0(i64 72, ptr nonnull %ref.tmp38) #27
  br label %ehcleanup281
...
if.end62:                                         ; preds = %init.i, %init.check.i, %if.else, %_ZNSt12_Vector_baseIdSaIdEE13_M_deallocateEPdm.exit.i501, %if.end.i487
  %call.i = call noundef ptr @_ZSt18_Rb_tree_incrementPKSt18_Rb_tree_node_base(ptr noundef %__begin2.sroa.0.0868) #28
...
for.cond.cleanup85:                               ; preds = %invoke.cont13, %for.cond.cleanup85.loopexit, %for.cond.cleanup
  %54 = phi ptr [ %.pre895, %for.cond.cleanup85.loopexit ], [ %.pre894, %for.cond.cleanup ], [ %0, %invoke.cont13 ]
  ...
  br i1 %cmp.i.i, label %if.then.i.i510, label %if.end.i.i

if.then.i.i510:                                   ; preds = %for.cond.cleanup85
  %call2.i12.i512 = invoke noundef ptr @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE9_M_createERmm(ptr noundef nonnull align 8 dereferenceable(32) %report_label, ptr noundef nonnull align 8 dereferenceable(8) %__dnew.i.i, i64 noundef 0)
          to label %call2.i12.i.noexc unwind label %lpad144

call2.i12.i.noexc:                                ; preds = %if.then.i.i510
  store ptr %call2.i12.i512, ptr %report_label, align 8, !tbaa !49
...
if.end.i.i:                                       ; preds = %call2.i12.i.noexc, %for.cond.cleanup85
  %59 = phi ptr [ %call2.i12.i512, %call2.i12.i.noexc ], [ %55, %for.cond.cleanup85 ]
  switch i64 %57, label %if.end.i.i.i.i.i [
    i64 1, label %if.then.i.i.i.i511
    i64 0, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC2ERKS4_.exit
  ]

if.then.i.i.i.i511:                               ; preds = %if.end.i.i
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC2ERKS4_.exit: ; preds = %if.end.i.i, %if.then.i.i.i.i511, %if.end.i.i.i.i.i
  ...
  %sub.ptr.lhs.cast.i670 = ptrtoint ptr %63 to i64
  %sub.ptr.rhs.cast.i671 = ptrtoint ptr %64 to i64
  %sub.ptr.sub.i672 = sub i64 %sub.ptr.lhs.cast.i670, %sub.ptr.rhs.cast.i671
  %sub.ptr.div.i673 = sdiv exact i64 %sub.ptr.sub.i672, 528
  %cmp148881 = icmp ugt i64 %sub.ptr.div.i673, 1
  br i1 %cmp148881, label %for.body150.lr.ph, label %cleanup160
...
for.body150.lr.ph:                                ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC2ERKS4_.exit
  ...
  %cmp.i.i.i677 = icmp eq i64 %65, 0
  br label %for.body150

for.body86:                                       ; preds = %for.body86.lr.ph, %cleanup
  %__begin177.sroa.0.0880 = phi ptr [ %.pre893, %for.body86.lr.ph ], [ %incdec.ptr.i668, %cleanup ]
  %67 = load atomic i8, ptr @_ZGVZN9benchmark8internal18GetNullLogInstanceEvE3log acquire, align 8
  %guard.uninitialized.i513 = icmp eq i8 %67, 0
  br i1 %guard.uninitialized.i513, label %init.check.i515, label %invoke.cont89, !prof !60

init.check.i515:                                  ; preds = %for.body86
  %68 = call i32 @__cxa_guard_acquire(ptr nonnull @_ZGVZN9benchmark8internal18GetNullLogInstanceEvE3log) #27
  %tobool.not.i514 = icmp eq i32 %68, 0
  br i1 %tobool.not.i514, label %invoke.cont89, label %init.i516

init.i516:                                        ; preds = %init.check.i515
  store ptr null, ptr @_ZZN9benchmark8internal18GetNullLogInstanceEvE3log, align 8, !tbaa !61
  call void @__cxa_guard_release(ptr nonnull @_ZGVZN9benchmark8internal18GetNullLogInstanceEvE3log) #27
  br label %invoke.cont89

invoke.cont89:                                    ; preds = %init.i516, %init.check.i515, %for.body86
  %69 = load atomic i8, ptr @_ZGVZN9benchmark8internal18GetNullLogInstanceEvE3log acquire, align 8
  %guard.uninitialized.i518 = icmp eq i8 %69, 0
  br i1 %guard.uninitialized.i518, label %init.check.i520, label %invoke.cont91, !prof !60

init.check.i520:                                  ; preds = %invoke.cont89
  %70 = call i32 @__cxa_guard_acquire(ptr nonnull @_ZGVZN9benchmark8internal18GetNullLogInstanceEvE3log) #27
  %tobool.not.i519 = icmp eq i32 %70, 0
  br i1 %tobool.not.i519, label %invoke.cont91, label %init.i521

init.i521:                                        ; preds = %init.check.i520
  store ptr null, ptr @_ZZN9benchmark8internal18GetNullLogInstanceEvE3log, align 8, !tbaa !61
  call void @__cxa_guard_release(ptr nonnull @_ZGVZN9benchmark8internal18GetNullLogInstanceEvE3log) #27
  br label %invoke.cont91

invoke.cont91:                                    ; preds = %init.i521, %init.check.i520, %invoke.cont89
  %error_occurred = getelementptr inbounds %"struct.benchmark::BenchmarkReporter::Run", ptr %__begin177.sroa.0.0880, i64 0, i32 7
...
lpad88.loopexit:                                  ; preds = %_ZNSt16allocator_traitsISaIdEE8allocateERS0_m.exit.i.i.i, %_ZNSt16allocator_traitsISaIdEE8allocateERS0_m.exit.i.i.i560
  %lpad.loopexit841 = landingpad { ptr, i32 }
          cleanup
  br label %ehcleanup281

lpad88.loopexit.split-lp:                         ; preds = %if.then.i.i.i530.invoke
  %lpad.loopexit.split-lp842 = landingpad { ptr, i32 }
          cleanup
  br label %ehcleanup281

if.end94:                                         ; preds = %invoke.cont91
  %real_accumulated_time = getelementptr inbounds %"struct.benchmark::BenchmarkReporter::Run", ptr %__begin177.sroa.0.0880, i64 0, i32 14
  %72 = load ptr, ptr %_M_finish.i523, align 8, !tbaa !5
  %73 = load ptr, ptr %_M_end_of_storage.i.i, align 8, !tbaa !41
  %cmp.not.i = icmp eq ptr %72, %73
  br i1 %cmp.not.i, label %if.else.i, label %if.then.i525

if.then.i525:                                     ; preds = %if.end94
  %74 = load double, ptr %real_accumulated_time, align 8, !tbaa !9
  store double %74, ptr %72, align 8, !tbaa !9
  %incdec.ptr.i524 = getelementptr inbounds double, ptr %72, i64 1
  store ptr %incdec.ptr.i524, ptr %_M_finish.i523, align 8, !tbaa !15
  br label %invoke.cont95

if.else.i:                                        ; preds = %if.end94
  %75 = load ptr, ptr %real_accumulated_time_stat, align 8, !tbaa !5
  %sub.ptr.lhs.cast.i.i.i.i526 = ptrtoint ptr %72 to i64
  %sub.ptr.rhs.cast.i.i.i.i527 = ptrtoint ptr %75 to i64
  %sub.ptr.sub.i.i.i.i528 = sub i64 %sub.ptr.lhs.cast.i.i.i.i526, %sub.ptr.rhs.cast.i.i.i.i527
  %cmp.i.i.i529 = icmp eq i64 %sub.ptr.sub.i.i.i.i528, 9223372036854775800
  br i1 %cmp.i.i.i529, label %if.then.i.i.i530.invoke, label %_ZNKSt6vectorIdSaIdEE12_M_check_lenEmPKc.exit.i.i

if.then.i.i.i530.invoke:                          ; preds = %if.else.i548, %if.else.i
  invoke void @_ZSt20__throw_length_errorPKc(ptr noundef nonnull @.str.3) #24
          to label %if.then.i.i.i530.cont unwind label %lpad88.loopexit.split-lp

if.then.i.i.i530.cont:                            ; preds = %if.then.i.i.i530.invoke
  unreachable

_ZNKSt6vectorIdSaIdEE12_M_check_lenEmPKc.exit.i.i: ; preds = %if.else.i
  %sub.ptr.div.i.i.i.i531 = ashr exact i64 %sub.ptr.sub.i.i.i.i528, 3
  %.sroa.speculated.i.i.i = call i64 @llvm.umax.i64(i64 %sub.ptr.div.i.i.i.i531, i64 1)
  %add.i.i.i = add i64 %.sroa.speculated.i.i.i, %sub.ptr.div.i.i.i.i531
  %cmp7.i.i.i = icmp ult i64 %add.i.i.i, %sub.ptr.div.i.i.i.i531
  %cmp9.i.i.i = icmp ugt i64 %add.i.i.i, 1152921504606846975
  %or.cond.i.i.i532 = or i1 %cmp7.i.i.i, %cmp9.i.i.i
  %cond.i.i.i = select i1 %or.cond.i.i.i532, i64 1152921504606846975, i64 %add.i.i.i
  %cmp.not.i.i.i533 = icmp eq i64 %cond.i.i.i, 0
  br i1 %cmp.not.i.i.i533, label %_ZNSt12_Vector_baseIdSaIdEE11_M_allocateEm.exit.i.i, label %_ZNSt16allocator_traitsISaIdEE8allocateERS0_m.exit.i.i.i

_ZNSt16allocator_traitsISaIdEE8allocateERS0_m.exit.i.i.i: ; preds = %_ZNKSt6vectorIdSaIdEE12_M_check_lenEmPKc.exit.i.i
  %mul.i.i.i.i.i = shl nuw nsw i64 %cond.i.i.i, 3
  %call5.i.i.i.i.i538 = invoke noalias noundef nonnull ptr @_Znwm(i64 noundef %mul.i.i.i.i.i) #25
...
_ZNSt12_Vector_baseIdSaIdEE11_M_allocateEm.exit.i.i: ; preds = %_ZNSt16allocator_traitsISaIdEE8allocateERS0_m.exit.i.i.i, %_ZNKSt6vectorIdSaIdEE12_M_check_lenEmPKc.exit.i.i
  %cond.i31.i.i = phi ptr [ null, %_ZNKSt6vectorIdSaIdEE12_M_check_lenEmPKc.exit.i.i ], [ %call5.i.i.i.i.i538, %_ZNSt16allocator_traitsISaIdEE8allocateERS0_m.exit.i.i.i ]
  %add.ptr.i.i534 = getelementptr inbounds double, ptr %cond.i31.i.i, i64 %sub.ptr.div.i.i.i.i531
  %76 = load double, ptr %real_accumulated_time, align 8, !tbaa !9
  store double %76, ptr %add.ptr.i.i534, align 8, !tbaa !9
  %cmp.i.i.i.i.i.i = icmp sgt i64 %sub.ptr.sub.i.i.i.i528, 0
  br i1 %cmp.i.i.i.i.i.i, label %if.then.i.i.i.i.i.i535, label %_ZNSt6vectorIdSaIdEE11_S_relocateEPdS2_S2_RS0_.exit.i.i

if.then.i.i.i.i.i.i535:                           ; preds = %_ZNSt12_Vector_baseIdSaIdEE11_M_allocateEm.exit.i.i
  call void @llvm.memmove.p0.p0.i64(ptr nonnull align 8 %cond.i31.i.i, ptr align 8 %75, i64 %sub.ptr.sub.i.i.i.i528, i1 false)
  br label %_ZNSt6vectorIdSaIdEE11_S_relocateEPdS2_S2_RS0_.exit.i.i

_ZNSt6vectorIdSaIdEE11_S_relocateEPdS2_S2_RS0_.exit.i.i: ; preds = %if.then.i.i.i.i.i.i535, %_ZNSt12_Vector_baseIdSaIdEE11_M_allocateEm.exit.i.i
  %incdec.ptr.i.i = getelementptr inbounds double, ptr %add.ptr.i.i534, i64 1
...
_ZNSt6vectorIdSaIdEE17_M_realloc_insertIJRKdEEEvN9__gnu_cxx17__normal_iteratorIPdS1_EEDpOT_.exit.i: ; preds = %if.then.i40.i.i, %_ZNSt6vectorIdSaIdEE11_S_relocateEPdS2_S2_RS0_.exit.i.i
  ...
  store ptr %incdec.ptr.i.i, ptr %_M_finish.i523, align 8, !tbaa !15
...
invoke.cont95:                                    ; preds = %_ZNSt6vectorIdSaIdEE17_M_realloc_insertIJRKdEEEvN9__gnu_cxx17__normal_iteratorIPdS1_EEDpOT_.exit.i, %if.then.i525
  %cpu_accumulated_time = getelementptr inbounds %"struct.benchmark::BenchmarkReporter::Run", ptr %__begin177.sroa.0.0880, i64 0, i32 15
  %77 = load ptr, ptr %_M_finish.i539, align 8, !tbaa !5
  %78 = load ptr, ptr %_M_end_of_storage.i.i363904, align 8, !tbaa !41
  %cmp.not.i541 = icmp eq ptr %77, %78
  br i1 %cmp.not.i541, label %if.else.i548, label %if.then.i543

if.then.i543:                                     ; preds = %invoke.cont95
  %79 = load double, ptr %cpu_accumulated_time, align 8, !tbaa !9
  store double %79, ptr %77, align 8, !tbaa !9
  %incdec.ptr.i542 = getelementptr inbounds double, ptr %77, i64 1
  store ptr %incdec.ptr.i542, ptr %_M_finish.i539, align 8, !tbaa !15
  br label %invoke.cont96

if.else.i548:                                     ; preds = %invoke.cont95
  %80 = load ptr, ptr %cpu_accumulated_time_stat, align 8, !tbaa !5
  %sub.ptr.lhs.cast.i.i.i.i544 = ptrtoint ptr %77 to i64
  %sub.ptr.rhs.cast.i.i.i.i545 = ptrtoint ptr %80 to i64
  %sub.ptr.sub.i.i.i.i546 = sub i64 %sub.ptr.lhs.cast.i.i.i.i544, %sub.ptr.rhs.cast.i.i.i.i545
  %cmp.i.i.i547 = icmp eq i64 %sub.ptr.sub.i.i.i.i546, 9223372036854775800
  br i1 %cmp.i.i.i547, label %if.then.i.i.i530.invoke, label %_ZNKSt6vectorIdSaIdEE12_M_check_lenEmPKc.exit.i.i558

_ZNKSt6vectorIdSaIdEE12_M_check_lenEmPKc.exit.i.i558: ; preds = %if.else.i548
  %sub.ptr.div.i.i.i.i550 = ashr exact i64 %sub.ptr.sub.i.i.i.i546, 3
  ...
  br i1 %cmp.not.i.i.i557, label %_ZNSt12_Vector_baseIdSaIdEE11_M_allocateEm.exit.i.i564, label %_ZNSt16allocator_traitsISaIdEE8allocateERS0_m.exit.i.i.i560

_ZNSt16allocator_traitsISaIdEE8allocateERS0_m.exit.i.i.i560: ; preds = %_ZNKSt6vectorIdSaIdEE12_M_check_lenEmPKc.exit.i.i558
  %mul.i.i.i.i.i559 = shl nuw nsw i64 %cond.i.i.i556, 3
  %call5.i.i.i.i.i575 = invoke noalias noundef nonnull ptr @_Znwm(i64 noundef %mul.i.i.i.i.i559) #25
          to label %_ZNSt12_Vector_baseIdSaIdEE11_M_allocateEm.exit.i.i564 unwind label %lpad88.loopexit

_ZNSt12_Vector_baseIdSaIdEE11_M_allocateEm.exit.i.i564: ; preds = %_ZNSt16allocator_traitsISaIdEE8allocateERS0_m.exit.i.i.i560, %_ZNKSt6vectorIdSaIdEE12_M_check_lenEmPKc.exit.i.i558
  %cond.i31.i.i561 = phi ptr [ null, %_ZNKSt6vectorIdSaIdEE12_M_check_lenEmPKc.exit.i.i558 ], [ %call5.i.i.i.i.i575, %_ZNSt16allocator_traitsISaIdEE8allocateERS0_m.exit.i.i.i560 ]
  %add.ptr.i.i562 = getelementptr inbounds double, ptr %cond.i31.i.i561, i64 %sub.ptr.div.i.i.i.i550
  %81 = load double, ptr %cpu_accumulated_time, align 8, !tbaa !9
  store double %81, ptr %add.ptr.i.i562, align 8, !tbaa !9
  %cmp.i.i.i.i.i.i563 = icmp sgt i64 %sub.ptr.sub.i.i.i.i546, 0
  br i1 %cmp.i.i.i.i.i.i563, label %if.then.i.i.i.i.i.i565, label %_ZNSt6vectorIdSaIdEE11_S_relocateEPdS2_S2_RS0_.exit.i.i568

if.then.i.i.i.i.i.i565:                           ; preds = %_ZNSt12_Vector_baseIdSaIdEE11_M_allocateEm.exit.i.i564
  call void @llvm.memmove.p0.p0.i64(ptr nonnull align 8 %cond.i31.i.i561, ptr align 8 %80, i64 %sub.ptr.sub.i.i.i.i546, i1 false)
  br label %_ZNSt6vectorIdSaIdEE11_S_relocateEPdS2_S2_RS0_.exit.i.i568

_ZNSt6vectorIdSaIdEE11_S_relocateEPdS2_S2_RS0_.exit.i.i568: ; preds = %if.then.i.i.i.i.i.i565, %_ZNSt12_Vector_baseIdSaIdEE11_M_allocateEm.exit.i.i564
  %incdec.ptr.i.i566 = getelementptr inbounds double, ptr %add.ptr.i.i562, i64 1
  %tobool.not.i.i.i567 = icmp eq ptr %80, null
  br i1 %tobool.not.i.i.i567, label %_ZNSt6vectorIdSaIdEE17_M_realloc_insertIJRKdEEEvN9__gnu_cxx17__normal_iteratorIPdS1_EEDpOT_.exit.i571, label %if.then.i40.i.i569

if.then.i40.i.i569:                               ; preds = %_ZNSt6vectorIdSaIdEE11_S_relocateEPdS2_S2_RS0_.exit.i.i568
  call void @_ZdlPv(ptr noundef nonnull %80) #26
  br label %_ZNSt6vectorIdSaIdEE17_M_realloc_insertIJRKdEEEvN9__gnu_cxx17__normal_iteratorIPdS1_EEDpOT_.exit.i571

_ZNSt6vectorIdSaIdEE17_M_realloc_insertIJRKdEEEvN9__gnu_cxx17__normal_iteratorIPdS1_EEDpOT_.exit.i571: ; preds = %if.then.i40.i.i569, %_ZNSt6vectorIdSaIdEE11_S_relocateEPdS2_S2_RS0_.exit.i.i568
  store ptr %cond.i31.i.i561, ptr %cpu_accumulated_time_stat, align 8, !tbaa !17
  store ptr %incdec.ptr.i.i566, ptr %_M_finish.i539, align 8, !tbaa !15
  %add.ptr19.i.i570 = getelementptr inbounds double, ptr %cond.i31.i.i561, i64 %cond.i.i.i556
  store ptr %add.ptr19.i.i570, ptr %_M_end_of_storage.i.i363904, align 8, !tbaa !41
  br label %invoke.cont96

invoke.cont96:                                    ; preds = %_ZNSt6vectorIdSaIdEE17_M_realloc_insertIJRKdEEEvN9__gnu_cxx17__normal_iteratorIPdS1_EEDpOT_.exit.i571, %if.then.i543
  %_M_left.i.i577 = getelementptr inbounds %"struct.benchmark::BenchmarkReporter::Run", ptr %__begin177.sroa.0.0880, i64 0, i32 23, i32 0, i32 0, i32 1, i32 0, i32 2
  %82 = load ptr, ptr %_M_left.i.i577, align 8, !tbaa !45
  %add.ptr.i.i578 = getelementptr inbounds %"struct.benchmark::BenchmarkReporter::Run", ptr %__begin177.sroa.0.0880, i64 0, i32 23, i32 0, i32 0, i32 1
  %cmp.i579.not877 = icmp eq ptr %82, %add.ptr.i.i578
  br i1 %cmp.i579.not877, label %cleanup, label %for.body108

for.body108:                                      ; preds = %invoke.cont96, %invoke.cont123
  %__begin299.sroa.0.0878 = phi ptr [ %call.i667, %invoke.cont123 ], [ %82, %invoke.cont96 ]
  %_M_storage.i.i580 = getelementptr inbounds %"struct.std::_Rb_tree_node", ptr %__begin299.sroa.0.0878, i64 0, i32 1
  %call110.val = load ptr, ptr %_M_storage.i.i580, align 8
  %83 = getelementptr %"struct.std::_Rb_tree_node", ptr %__begin299.sroa.0.0878, i64 0, i32 1, i32 0, i64 8
  %call110.val342 = load i64, ptr %83, align 8
  %this.val.i.i581 = load ptr, ptr %_M_parent.i.i.i.i.i, align 8, !tbaa !44
  %cmp.not1.i.i.i583 = icmp eq ptr %this.val.i.i581, null
  br i1 %cmp.not1.i.i.i583, label %invoke.cont114, label %while.body.i.i.i589

while.body.i.i.i589:                              ; preds = %for.body108, %_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit.i.i.i606
  %__x.addr.03.i.i.i584 = phi ptr [ %__x.addr.1.i.i.i604, %_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit.i.i.i606 ], [ %this.val.i.i581, %for.body108 ]
  %__y.addr.02.i.i.i585 = phi ptr [ %__y.addr.1.i.i.i601, %_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit.i.i.i606 ], [ %4, %for.body108 ]
  %_M_string_length.i.i.i.i.i.i.i586 = getelementptr inbounds %"struct.std::_Rb_tree_node.36", ptr %__x.addr.03.i.i.i584, i64 0, i32 1, i32 0, i64 8
  %84 = load i64, ptr %_M_string_length.i.i.i.i.i.i.i586, align 8, !tbaa !48
  %.sroa.speculated.i.i.i.i.i.i587 = call i64 @llvm.umin.i64(i64 %84, i64 %call110.val342)
  %cmp.i11.i.i.i.i.i.i588 = icmp eq i64 %.sroa.speculated.i.i.i.i.i.i587, 0
  br i1 %cmp.i11.i.i.i.i.i.i588, label %if.then.i.i.i.i.i.i598, label %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i.i.i.i.i593

_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i.i.i.i.i593: ; preds = %while.body.i.i.i589
  %_M_storage.i.i.i.i.i590 = getelementptr inbounds %"struct.std::_Rb_tree_node.36", ptr %__x.addr.03.i.i.i584, i64 0, i32 1
  %85 = load ptr, ptr %_M_storage.i.i.i.i.i590, align 8, !tbaa !49
  %call.i.i.i.i.i.i.i591 = call i32 @memcmp(ptr noundef %85, ptr noundef %call110.val, i64 noundef %.sroa.speculated.i.i.i.i.i.i587) #27
  %tobool.not.i.i.i.i.i.i592 = icmp eq i32 %call.i.i.i.i.i.i.i591, 0
  br i1 %tobool.not.i.i.i.i.i.i592, label %if.then.i.i.i.i.i.i598, label %_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit.i.i.i606

if.then.i.i.i.i.i.i598:                           ; preds = %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i.i.i.i.i593, %while.body.i.i.i589
  %sub.i.i.i.i.i.i.i594 = sub i64 %84, %call110.val342
  %spec.select6.i.i.i.i.i.i.i595 = call i64 @llvm.smax.i64(i64 %sub.i.i.i.i.i.i.i594, i64 -2147483648)
  %retval.07.i.i.i.i.i.i.i596 = call i64 @llvm.smin.i64(i64 %spec.select6.i.i.i.i.i.i.i595, i64 2147483647)
  %retval.0.i12.i.i.i.i.i.i597 = trunc i64 %retval.07.i.i.i.i.i.i.i596 to i32
  br label %_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit.i.i.i606

_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit.i.i.i606: ; preds = %if.then.i.i.i.i.i.i598, %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i.i.i.i.i593
  %__r.0.i.i.i.i.i.i599 = phi i32 [ %call.i.i.i.i.i.i.i591, %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i.i.i.i.i593 ], [ %retval.0.i12.i.i.i.i.i.i597, %if.then.i.i.i.i.i.i598 ]
  %cmp.i.i.i.i.i600 = icmp slt i32 %__r.0.i.i.i.i.i.i599, 0
  %__y.addr.1.i.i.i601 = select i1 %cmp.i.i.i.i.i600, ptr %__y.addr.02.i.i.i585, ptr %__x.addr.03.i.i.i584
  %__x.addr.1.in.v.i.i.i602 = select i1 %cmp.i.i.i.i.i600, i64 24, i64 16
  %__x.addr.1.in.i.i.i603 = getelementptr i8, ptr %__x.addr.03.i.i.i584, i64 %__x.addr.1.in.v.i.i.i602
  %__x.addr.1.i.i.i604 = load ptr, ptr %__x.addr.1.in.i.i.i603, align 8, !tbaa !5
  %cmp.not.i.i.i605 = icmp eq ptr %__x.addr.1.i.i.i604, null
  br i1 %cmp.not.i.i.i605, label %_ZNSt8_Rb_treeINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt4pairIKS5_ZN9benchmark12ComputeStatsERKSt6vectorINS8_17BenchmarkReporter3RunESaISB_EEE11CounterStatESt10_Select1stISH_ESt4lessIS5_ESaISH_EE14_M_lower_boundEPSt13_Rb_tree_nodeISH_EPSt18_Rb_tree_node_baseRS7_.exit.i.i608, label %while.body.i.i.i589, !llvm.loop !50

_ZNSt8_Rb_treeINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt4pairIKS5_ZN9benchmark12ComputeStatsERKSt6vectorINS8_17BenchmarkReporter3RunESaISB_EEE11CounterStatESt10_Select1stISH_ESt4lessIS5_ESaISH_EE14_M_lower_boundEPSt13_Rb_tree_nodeISH_EPSt18_Rb_tree_node_baseRS7_.exit.i.i608: ; preds = %_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit.i.i.i606
  %cmp.i.i.i607 = icmp eq ptr %__y.addr.1.i.i.i601, %4
  br i1 %cmp.i.i.i607, label %invoke.cont114, label %lor.lhs.false.i.i612

lor.lhs.false.i.i612:                             ; preds = %_ZNSt8_Rb_treeINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt4pairIKS5_ZN9benchmark12ComputeStatsERKSt6vectorINS8_17BenchmarkReporter3RunESaISB_EEE11CounterStatESt10_Select1stISH_ESt4lessIS5_ESaISH_EE14_M_lower_boundEPSt13_Rb_tree_nodeISH_EPSt18_Rb_tree_node_baseRS7_.exit.i.i608
  %_M_string_length.i.i.i.i.i.i.i586.le = getelementptr inbounds %"struct.std::_Rb_tree_node.36", ptr %__x.addr.03.i.i.i584, i64 0, i32 1, i32 0, i64 8
  %__y.addr.02.i.i.i585.sroa.gep = getelementptr inbounds %"struct.std::_Rb_tree_node.36", ptr %__y.addr.02.i.i.i585, i64 0, i32 1, i32 0, i64 8
  %__y.addr.1.i.i.i601.sroa.sel = select i1 %cmp.i.i.i.i.i600, ptr %__y.addr.02.i.i.i585.sroa.gep, ptr %_M_string_length.i.i.i.i.i.i.i586.le
  %86 = load i64, ptr %__y.addr.1.i.i.i601.sroa.sel, align 8, !tbaa !48
  %.sroa.speculated.i.i.i.i.i610 = call i64 @llvm.umin.i64(i64 %call110.val342, i64 %86)
  %cmp.i11.i.i.i.i.i611 = icmp eq i64 %.sroa.speculated.i.i.i.i.i610, 0
  br i1 %cmp.i11.i.i.i.i.i611, label %if.then.i.i.i.i.i621, label %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i.i.i.i616

_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i.i.i.i616: ; preds = %lor.lhs.false.i.i612
  %__y.addr.02.i.i.i585.sroa.gep824 = getelementptr inbounds %"struct.std::_Rb_tree_node.36", ptr %__y.addr.02.i.i.i585, i64 0, i32 1
  %__x.addr.03.i.i.i584.sroa.gep825 = getelementptr inbounds %"struct.std::_Rb_tree_node.36", ptr %__x.addr.03.i.i.i584, i64 0, i32 1
  %__y.addr.1.i.i.i601.sroa.sel826 = select i1 %cmp.i.i.i.i.i600, ptr %__y.addr.02.i.i.i585.sroa.gep824, ptr %__x.addr.03.i.i.i584.sroa.gep825
  %87 = load ptr, ptr %__y.addr.1.i.i.i601.sroa.sel826, align 8, !tbaa !49
  %call.i.i.i.i.i.i614 = call i32 @memcmp(ptr noundef %call110.val, ptr noundef %87, i64 noundef %.sroa.speculated.i.i.i.i.i610) #27
  %tobool.not.i.i.i.i.i615 = icmp eq i32 %call.i.i.i.i.i.i614, 0
  br i1 %tobool.not.i.i.i.i.i615, label %if.then.i.i.i.i.i621, label %_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit.i.i625

if.then.i.i.i.i.i621:                             ; preds = %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i.i.i.i616, %lor.lhs.false.i.i612
  %sub.i.i.i.i.i.i617 = sub i64 %call110.val342, %86
  %spec.select6.i.i.i.i.i.i618 = call i64 @llvm.smax.i64(i64 %sub.i.i.i.i.i.i617, i64 -2147483648)
  %retval.07.i.i.i.i.i.i619 = call i64 @llvm.smin.i64(i64 %spec.select6.i.i.i.i.i.i618, i64 2147483647)
  %retval.0.i12.i.i.i.i.i620 = trunc i64 %retval.07.i.i.i.i.i.i619 to i32
  br label %_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit.i.i625

_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit.i.i625: ; preds = %if.then.i.i.i.i.i621, %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i.i.i.i616
  %__r.0.i.i.i.i.i622 = phi i32 [ %call.i.i.i.i.i.i614, %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i.i.i.i616 ], [ %retval.0.i12.i.i.i.i.i620, %if.then.i.i.i.i.i621 ]
  %cmp.i.i.i.i623 = icmp slt i32 %__r.0.i.i.i.i.i622, 0
  %spec.select.i.i624 = select i1 %cmp.i.i.i.i623, ptr %4, ptr %__y.addr.1.i.i.i601
  br label %invoke.cont114

invoke.cont114:                                   ; preds = %_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit.i.i625, %_ZNSt8_Rb_treeINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt4pairIKS5_ZN9benchmark12ComputeStatsERKSt6vectorINS8_17BenchmarkReporter3RunESaISB_EEE11CounterStatESt10_Select1stISH_ESt4lessIS5_ESaISH_EE14_M_lower_boundEPSt13_Rb_tree_nodeISH_EPSt18_Rb_tree_node_baseRS7_.exit.i.i608, %for.body108
  %retval.sroa.0.0.i.i626 = phi ptr [ %4, %_ZNSt8_Rb_treeINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt4pairIKS5_ZN9benchmark12ComputeStatsERKSt6vectorINS8_17BenchmarkReporter3RunESaISB_EEE11CounterStatESt10_Select1stISH_ESt4lessIS5_ESaISH_EE14_M_lower_boundEPSt13_Rb_tree_nodeISH_EPSt18_Rb_tree_node_baseRS7_.exit.i.i608 ], [ %spec.select.i.i624, %_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit.i.i625 ], [ %4, %for.body108 ]
  %88 = load atomic i8, ptr @_ZGVZN9benchmark8internal18GetNullLogInstanceEvE3log acquire, align 8
  %guard.uninitialized.i628 = icmp eq i8 %88, 0
  br i1 %guard.uninitialized.i628, label %init.check.i630, label %invoke.cont117, !prof !60

init.check.i630:                                  ; preds = %invoke.cont114
  %89 = call i32 @__cxa_guard_acquire(ptr nonnull @_ZGVZN9benchmark8internal18GetNullLogInstanceEvE3log) #27
  %tobool.not.i629 = icmp eq i32 %89, 0
  br i1 %tobool.not.i629, label %invoke.cont117, label %init.i631

init.i631:                                        ; preds = %init.check.i630
  store ptr null, ptr @_ZZN9benchmark8internal18GetNullLogInstanceEvE3log, align 8, !tbaa !61
  call void @__cxa_guard_release(ptr nonnull @_ZGVZN9benchmark8internal18GetNullLogInstanceEvE3log) #27
  br label %invoke.cont117

invoke.cont117:                                   ; preds = %init.i631, %init.check.i630, %invoke.cont114
  %s121 = getelementptr inbounds %"struct.std::_Rb_tree_node.36", ptr %retval.sroa.0.0.i.i626, i64 0, i32 1, i32 0, i64 48
  %second122 = getelementptr inbounds %"struct.std::_Rb_tree_node", ptr %__begin299.sroa.0.0878, i64 0, i32 1, i32 0, i64 32
  %_M_finish.i634 = getelementptr inbounds %"struct.std::_Rb_tree_node.36", ptr %retval.sroa.0.0.i.i626, i64 0, i32 1, i32 0, i64 56
  %90 = load ptr, ptr %_M_finish.i634, align 8, !tbaa !5
  %_M_end_of_storage.i635 = getelementptr inbounds %"struct.std::_Rb_tree_node.36", ptr %retval.sroa.0.0.i.i626, i64 0, i32 1, i32 0, i64 64
  %91 = load ptr, ptr %_M_end_of_storage.i635, align 8, !tbaa !41
  %cmp.not.i636 = icmp eq ptr %90, %91
  br i1 %cmp.not.i636, label %if.else.i643, label %if.then.i638

if.then.i638:                                     ; preds = %invoke.cont117
  %92 = load double, ptr %second122, align 8, !tbaa !9
  store double %92, ptr %90, align 8, !tbaa !9
  %incdec.ptr.i637 = getelementptr inbounds double, ptr %90, i64 1
  store ptr %incdec.ptr.i637, ptr %_M_finish.i634, align 8, !tbaa !15
  br label %invoke.cont123

if.else.i643:                                     ; preds = %invoke.cont117
  %93 = load ptr, ptr %s121, align 8, !tbaa !5
  %sub.ptr.lhs.cast.i.i.i.i639 = ptrtoint ptr %90 to i64
  %sub.ptr.rhs.cast.i.i.i.i640 = ptrtoint ptr %93 to i64
  %sub.ptr.sub.i.i.i.i641 = sub i64 %sub.ptr.lhs.cast.i.i.i.i639, %sub.ptr.rhs.cast.i.i.i.i640
  %cmp.i.i.i642 = icmp eq i64 %sub.ptr.sub.i.i.i.i641, 9223372036854775800
  br i1 %cmp.i.i.i642, label %if.then.i.i.i644, label %_ZNKSt6vectorIdSaIdEE12_M_check_lenEmPKc.exit.i.i653

if.then.i.i.i644:                                 ; preds = %if.else.i643
  invoke void @_ZSt20__throw_length_errorPKc(ptr noundef nonnull @.str.3) #24
          to label %.noexc664 unwind label %lpad113.loopexit.split-lp

.noexc664:                                        ; preds = %if.then.i.i.i644
  unreachable

_ZNKSt6vectorIdSaIdEE12_M_check_lenEmPKc.exit.i.i653: ; preds = %if.else.i643
  %sub.ptr.div.i.i.i.i645 = ashr exact i64 %sub.ptr.sub.i.i.i.i641, 3
  %.sroa.speculated.i.i.i646 = call i64 @llvm.umax.i64(i64 %sub.ptr.div.i.i.i.i645, i64 1)
  %add.i.i.i647 = add i64 %.sroa.speculated.i.i.i646, %sub.ptr.div.i.i.i.i645
  %cmp7.i.i.i648 = icmp ult i64 %add.i.i.i647, %sub.ptr.div.i.i.i.i645
  %cmp9.i.i.i649 = icmp ugt i64 %add.i.i.i647, 1152921504606846975
  %or.cond.i.i.i650 = or i1 %cmp7.i.i.i648, %cmp9.i.i.i649
  %cond.i.i.i651 = select i1 %or.cond.i.i.i650, i64 1152921504606846975, i64 %add.i.i.i647
  %cmp.not.i.i.i652 = icmp eq i64 %cond.i.i.i651, 0
  br i1 %cmp.not.i.i.i652, label %_ZNSt12_Vector_baseIdSaIdEE11_M_allocateEm.exit.i.i658, label %_ZNSt16allocator_traitsISaIdEE8allocateERS0_m.exit.i.i.i655

_ZNSt16allocator_traitsISaIdEE8allocateERS0_m.exit.i.i.i655: ; preds = %_ZNKSt6vectorIdSaIdEE12_M_check_lenEmPKc.exit.i.i653
  %mul.i.i.i.i.i654 = shl nuw nsw i64 %cond.i.i.i651, 3
  %call5.i.i.i.i.i666 = invoke noalias noundef nonnull ptr @_Znwm(i64 noundef %mul.i.i.i.i.i654) #25
          to label %_ZNSt12_Vector_baseIdSaIdEE11_M_allocateEm.exit.i.i658 unwind label %lpad113.loopexit

_ZNSt12_Vector_baseIdSaIdEE11_M_allocateEm.exit.i.i658: ; preds = %_ZNSt16allocator_traitsISaIdEE8allocateERS0_m.exit.i.i.i655, %_ZNKSt6vectorIdSaIdEE12_M_check_lenEmPKc.exit.i.i653
  %cond.i47.i.i = phi ptr [ null, %_ZNKSt6vectorIdSaIdEE12_M_check_lenEmPKc.exit.i.i653 ], [ %call5.i.i.i.i.i666, %_ZNSt16allocator_traitsISaIdEE8allocateERS0_m.exit.i.i.i655 ]
  %add.ptr.i.i656 = getelementptr inbounds double, ptr %cond.i47.i.i, i64 %sub.ptr.div.i.i.i.i645
  %94 = load double, ptr %second122, align 8, !tbaa !9
  store double %94, ptr %add.ptr.i.i656, align 8, !tbaa !9
  %cmp.i.i.i.i.i.i657 = icmp sgt i64 %sub.ptr.sub.i.i.i.i641, 0
  br i1 %cmp.i.i.i.i.i.i657, label %if.then.i.i.i.i.i.i659, label %_ZNSt6vectorIdSaIdEE11_S_relocateEPdS2_S2_RS0_.exit.i.i662

if.then.i.i.i.i.i.i659:                           ; preds = %_ZNSt12_Vector_baseIdSaIdEE11_M_allocateEm.exit.i.i658
  call void @llvm.memmove.p0.p0.i64(ptr nonnull align 8 %cond.i47.i.i, ptr align 8 %93, i64 %sub.ptr.sub.i.i.i.i641, i1 false)
  br label %_ZNSt6vectorIdSaIdEE11_S_relocateEPdS2_S2_RS0_.exit.i.i662

_ZNSt6vectorIdSaIdEE11_S_relocateEPdS2_S2_RS0_.exit.i.i662: ; preds = %if.then.i.i.i.i.i.i659, %_ZNSt12_Vector_baseIdSaIdEE11_M_allocateEm.exit.i.i658
  %incdec.ptr.i.i660 = getelementptr inbounds double, ptr %add.ptr.i.i656, i64 1
  %tobool.not.i.i.i661 = icmp eq ptr %93, null
  br i1 %tobool.not.i.i.i661, label %_ZNSt6vectorIdSaIdEE17_M_realloc_insertIJRKN9benchmark7CounterEEEEvN9__gnu_cxx17__normal_iteratorIPdS1_EEDpOT_.exit.i, label %if.then.i56.i.i

if.then.i56.i.i:                                  ; preds = %_ZNSt6vectorIdSaIdEE11_S_relocateEPdS2_S2_RS0_.exit.i.i662
...
_ZNSt6vectorIdSaIdEE17_M_realloc_insertIJRKN9benchmark7CounterEEEEvN9__gnu_cxx17__normal_iteratorIPdS1_EEDpOT_.exit.i: ; preds = %if.then.i56.i.i, %_ZNSt6vectorIdSaIdEE11_S_relocateEPdS2_S2_RS0_.exit.i.i662
  store ptr %cond.i47.i.i, ptr %s121, align 8, !tbaa !17
  store ptr %incdec.ptr.i.i660, ptr %_M_finish.i634, align 8, !tbaa !15
  %add.ptr26.i.i = getelementptr inbounds double, ptr %cond.i47.i.i, i64 %cond.i.i.i651
  store ptr %add.ptr26.i.i, ptr %_M_end_of_storage.i635, align 8, !tbaa !41
  br label %invoke.cont123

invoke.cont123:                                   ; preds = %_ZNSt6vectorIdSaIdEE17_M_realloc_insertIJRKN9benchmark7CounterEEEEvN9__gnu_cxx17__normal_iteratorIPdS1_EEDpOT_.exit.i, %if.then.i638
  %call.i667 = call noundef ptr @_ZSt18_Rb_tree_incrementPKSt18_Rb_tree_node_base(ptr noundef nonnull %__begin299.sroa.0.0878) #28
  %cmp.i579.not = icmp eq ptr %call.i667, %add.ptr.i.i578
  br i1 %cmp.i579.not, label %cleanup, label %for.body108

lpad113.loopexit:                                 ; preds = %_ZNSt16allocator_traitsISaIdEE8allocateERS0_m.exit.i.i.i655
  %lpad.loopexit = landingpad { ptr, i32 }
          cleanup
  br label %ehcleanup281

lpad113.loopexit.split-lp:                        ; preds = %if.then.i.i.i644
  %lpad.loopexit.split-lp = landingpad { ptr, i32 }
          cleanup
  br label %ehcleanup281

cleanup:                                          ; preds = %invoke.cont123, %invoke.cont96, %invoke.cont91
  %incdec.ptr.i668 = getelementptr inbounds %"struct.benchmark::BenchmarkReporter::Run", ptr %__begin177.sroa.0.0880, i64 1
  %cmp.i509.not = icmp eq ptr %incdec.ptr.i668, %.pre894
  br i1 %cmp.i509.not, label %for.cond.cleanup85.loopexit, label %for.body86

lpad144:                                          ; preds = %if.then.i.i510
  %95 = landingpad { ptr, i32 }
          cleanup
  br label %ehcleanup279

for.body150:                                      ; preds = %for.body150.lr.ph, %for.inc159
  %i.0882 = phi i64 [ 1, %for.body150.lr.ph ], [ %inc, %for.inc159 ]
  %report_label152 = getelementptr inbounds %"struct.benchmark::BenchmarkReporter::Run", ptr %64, i64 %i.0882, i32 6
  %_M_string_length.i.i.i675 = getelementptr inbounds %"struct.benchmark::BenchmarkReporter::Run", ptr %64, i64 %i.0882, i32 6, i32 1
  %96 = load i64, ptr %_M_string_length.i.i.i675, align 8, !tbaa !48
  %cmp.i.i676 = icmp eq i64 %96, %65
  br i1 %cmp.i.i676, label %land.rhs.i.i, label %if.then154

land.rhs.i.i:                                     ; preds = %for.body150
  br i1 %cmp.i.i.i677, label %for.inc159, label %if.end.i.i.i678

if.end.i.i.i678:                                  ; preds = %land.rhs.i.i
...
if.then154:                                       ; preds = %for.body150, %if.end.i.i.i678
  %call3.i.i680 = invoke noundef nonnull align 8 dereferenceable(32) ptr @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE10_M_replaceEmmPKcm(ptr noundef nonnull align 8 dereferenceable(32) %report_label, i64 noundef 0, i64 noundef %65, ptr noundef nonnull @.str, i64 noundef 0)
          to label %if.then154.cleanup160_crit_edge unwind label %lpad155

if.then154.cleanup160_crit_edge:                  ; preds = %if.then154
  %.pre896 = load ptr, ptr %_M_finish.i, align 8, !tbaa !65
  %.pre897 = load ptr, ptr %reports, align 8, !tbaa !63
  %.pre898 = ptrtoint ptr %.pre896 to i64
  %.pre899 = ptrtoint ptr %.pre897 to i64
  %.pre900 = sub i64 %.pre898, %.pre899
  %.pre901 = sdiv exact i64 %.pre900, 528
  br label %cleanup160
...
for.inc159:                                       ; preds = %land.rhs.i.i, %if.end.i.i.i678
  %inc = add nuw i64 %i.0882, 1
  %exitcond.not = icmp eq i64 %inc, %sub.ptr.div.i673
...
cleanup160:                                       ; preds = %for.inc159, %if.then154.cleanup160_crit_edge, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC2ERKS4_.exit
  %sub.ptr.div.i685.pre-phi = phi i64 [ %.pre901, %if.then154.cleanup160_crit_edge ], [ %sub.ptr.div.i673, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC2ERKS4_.exit ], [ %sub.ptr.div.i673, %for.inc159 ]
  %99 = phi ptr [ %.pre897, %if.then154.cleanup160_crit_edge ], [ %64, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC2ERKS4_.exit ], [ %64, %for.inc159 ]
  ...
  %_M_finish.i686 = getelementptr inbounds %"struct.std::_Vector_base<benchmark::internal::Statistics, std::allocator<benchmark::internal::Statistics>>::_Vector_impl_data", ptr %100, i64 0, i32 1
  %102 = load ptr, ptr %_M_finish.i686, align 8, !tbaa !5
  %cmp.i687.not887 = icmp eq ptr %101, %102
  br i1 %cmp.i687.not887, label %for.cond.cleanup175, label %for.body176.lr.ph

for.body176.lr.ph:                                ; preds = %cleanup160
  %conv = uitofp i64 %sub.ptr.div.i685.pre-phi to double
  ...
  %_M_parent.i.i.i.i.i723 = getelementptr inbounds %"struct.benchmark::BenchmarkReporter::Run", ptr %data, i64 0, i32 23, i32 0, i32 0, i32 1, i32 0, i32 1
  %add.ptr.i.i.i.i724 = getelementptr inbounds %"struct.benchmark::BenchmarkReporter::Run", ptr %data, i64 0, i32 23, i32 0, i32 0, i32 1
  ...
  %_M_node_count.i.i.i793 = getelementptr inbounds %"struct.benchmark::BenchmarkReporter::Run", ptr %data, i64 0, i32 23, i32 0, i32 0, i32 1, i32 1
  %_M_finish.i713 = getelementptr inbounds %"struct.std::_Vector_base<benchmark::BenchmarkReporter::Run, std::allocator<benchmark::BenchmarkReporter::Run>>::_Vector_impl_data", ptr %agg.result, i64 0, i32 1
  %_M_end_of_storage.i714 = getelementptr inbounds %"struct.std::_Vector_base<benchmark::BenchmarkReporter::Run, std::allocator<benchmark::BenchmarkReporter::Run>>::_Vector_impl_data", ptr %agg.result, i64 0, i32 2
...
for.cond.cleanup175:                              ; preds = %invoke.cont261, %cleanup160
  ...
  %cmp.i.i.i688 = icmp eq ptr %105, %55
  br i1 %cmp.i.i.i688, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit, label %if.then.i.i689

if.then.i.i689:                                   ; preds = %for.cond.cleanup175
  call void @_ZdlPv(ptr noundef %105) #26
  br label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit

_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit: ; preds = %for.cond.cleanup175, %if.then.i.i689
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %report_label) #27
  %this.val.i.i690 = load ptr, ptr %_M_parent.i.i.i.i.i, align 8, !tbaa !44
  call fastcc void @_ZNSt8_Rb_treeINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt4pairIKS5_ZN9benchmark12ComputeStatsERKSt6vectorINS8_17BenchmarkReporter3RunESaISB_EEE11CounterStatESt10_Select1stISH_ESt4lessIS5_ESaISH_EE8_M_eraseEPSt13_Rb_tree_nodeISH_E(ptr noundef %this.val.i.i690)
  ...
  %tobool.not.i.i.i691 = icmp eq ptr %106, null
  br i1 %tobool.not.i.i.i691, label %_ZNSt6vectorIdSaIdEED2Ev.exit, label %if.then.i.i.i692

if.then.i.i.i692:                                 ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit
  call void @_ZdlPv(ptr noundef nonnull %106) #26
  br label %_ZNSt6vectorIdSaIdEED2Ev.exit

_ZNSt6vectorIdSaIdEED2Ev.exit:                    ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit, %if.then.i.i.i692
  ...
  %tobool.not.i.i.i693 = icmp eq ptr %107, null
  br i1 %tobool.not.i.i.i693, label %_ZNSt6vectorIdSaIdEED2Ev.exit695, label %if.then.i.i.i694

if.then.i.i.i694:                                 ; preds = %_ZNSt6vectorIdSaIdEED2Ev.exit
  call void @_ZdlPv(ptr noundef nonnull %107) #26
  br label %_ZNSt6vectorIdSaIdEED2Ev.exit695

_ZNSt6vectorIdSaIdEED2Ev.exit695:                 ; preds = %_ZNSt6vectorIdSaIdEED2Ev.exit, %if.then.i.i.i694
...
for.body176:                                      ; preds = %for.body176.lr.ph, %invoke.cont261
  %__begin1167.sroa.0.0888 = phi ptr [ %101, %for.body176.lr.ph ], [ %incdec.ptr.i738, %invoke.cont261 ]
...
.noexc700:                                        ; preds = %.noexc699
  ...
  invoke void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE9_M_assignERKS4_(ptr noundef nonnull align 8 dereferenceable(32) %time_type.i, ptr noundef nonnull align 8 dereferenceable(32) %time_type11.i)
          to label %.noexc701 unwind label %lpad182
...
invoke.cont183:                                   ; preds = %.noexc701
  ...
  invoke void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE9_M_assignERKS4_(ptr noundef nonnull align 8 dereferenceable(32) %aggregate_name, ptr noundef nonnull align 8 dereferenceable(32) %__begin1167.sroa.0.0888)
          to label %invoke.cont193 unwind label %lpad182

invoke.cont193:                                   ; preds = %invoke.cont183
  %unit_ = getelementptr inbounds %"struct.benchmark::internal::Statistics", ptr %__begin1167.sroa.0.0888, i64 0, i32 2
...
invoke.cont196:                                   ; preds = %invoke.cont193
  ...
  %sub.ptr.lhs.cast.i707 = ptrtoint ptr %114 to i64
  %sub.ptr.rhs.cast.i708 = ptrtoint ptr %115 to i64
  %sub.ptr.sub.i709 = sub i64 %sub.ptr.lhs.cast.i707, %sub.ptr.rhs.cast.i708
  %sub.ptr.div.i710 = sdiv exact i64 %sub.ptr.sub.i709, 528
  store i64 %sub.ptr.div.i710, ptr %iterations199, align 8, !tbaa !42
  %compute_ = getelementptr inbounds %"struct.benchmark::internal::Statistics", ptr %__begin1167.sroa.0.0888, i64 0, i32 1
...
lpad182:                                          ; preds = %if.else.i718, %if.then.i717, %invoke.cont193, %invoke.cont183, %.noexc701, %.noexc700, %.noexc699, %.noexc698, %.noexc697, %.noexc696, %invoke.cont179, %invoke.cont200, %invoke.cont196
...
if.end213:                                        ; preds = %if.then209, %invoke.cont204
  ...
  %cmp.i712.not884 = icmp eq ptr %counter_stats.val, %4
  br i1 %cmp.i712.not884, label %for.cond.cleanup225, label %for.body226

for.cond.cleanup225:                              ; preds = %invoke.cont247, %if.end213
  %126 = load ptr, ptr %_M_finish.i713, align 8, !tbaa !5
  %127 = load ptr, ptr %_M_end_of_storage.i714, align 8, !tbaa !79
  %cmp.not.i715 = icmp eq ptr %126, %127
  br i1 %cmp.not.i715, label %if.else.i718, label %if.then.i717

if.then.i717:                                     ; preds = %for.cond.cleanup225
  invoke void @_ZN9benchmark17BenchmarkReporter3RunC2ERKS1_(ptr noundef nonnull align 8 dereferenceable(528) %126, ptr noundef nonnull align 8 dereferenceable(528) %data)
          to label %.noexc720 unwind label %lpad182

.noexc720:                                        ; preds = %if.then.i717
  %128 = load ptr, ptr %_M_finish.i713, align 8, !tbaa !65
  %incdec.ptr.i716 = getelementptr inbounds %"struct.benchmark::BenchmarkReporter::Run", ptr %128, i64 1
  store ptr %incdec.ptr.i716, ptr %_M_finish.i713, align 8, !tbaa !65
  br label %invoke.cont261

if.else.i718:                                     ; preds = %for.cond.cleanup225
...
for.body226:                                      ; preds = %if.end213, %invoke.cont247
  %__begin2217.sroa.0.0885 = phi ptr [ %call.i737, %invoke.cont247 ], [ %counter_stats.val, %if.end213 ]
  %_M_storage.i.i722 = getelementptr inbounds %"struct.std::_Rb_tree_node.36", ptr %__begin2217.sroa.0.0885, i64 0, i32 1
  %129 = load ptr, ptr %compute_, align 8, !tbaa !75
  %s230 = getelementptr inbounds %"struct.std::_Rb_tree_node.36", ptr %__begin2217.sroa.0.0885, i64 0, i32 1, i32 0, i64 48
...
invoke.cont241:                                   ; preds = %invoke.cont237
  ...
  %132 = load ptr, ptr %_M_parent.i.i.i.i.i723, align 8, !tbaa !44
  %cmp.not9.i.i.i.i = icmp eq ptr %132, null
  br i1 %cmp.not9.i.i.i.i, label %if.then.i733, label %while.body.lr.ph.i.i.i.i

while.body.lr.ph.i.i.i.i:                         ; preds = %invoke.cont241
  %_M_string_length.i10.i.i.i.i.i.i.i = getelementptr inbounds %"struct.std::_Rb_tree_node.36", ptr %__begin2217.sroa.0.0885, i64 0, i32 1, i32 0, i64 8
  %133 = load i64, ptr %_M_string_length.i10.i.i.i.i.i.i.i, align 8, !tbaa !48
  %134 = load ptr, ptr %_M_storage.i.i722, align 8
...
while.body.i.i.i.i:                               ; preds = %_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit.i.i.i.i, %while.body.lr.ph.i.i.i.i
  ...
  %__y.addr.010.i.i.i.i = phi ptr [ %add.ptr.i.i.i.i724, %while.body.lr.ph.i.i.i.i ], [ %__y.addr.1.i.i.i.i, %_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit.i.i.i.i ]
...
_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i.i.i.i.i.i: ; preds = %while.body.i.i.i.i
  %_M_storage.i.i.i.i.i.i725 = getelementptr inbounds %"struct.std::_Rb_tree_node", ptr %__x.addr.011.i.i.i.i, i64 0, i32 1
  %136 = load ptr, ptr %_M_storage.i.i.i.i.i.i725, align 8, !tbaa !49
...
_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit.i.i.i.i: ; preds = %if.then.i.i.i.i.i.i.i, %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i.i.i.i.i.i
  ...
  %cmp.i.i.i.i.i.i726 = icmp slt i32 %__r.0.i.i.i.i.i.i.i, 0
  %_M_right.i.i.i.i.i727 = getelementptr inbounds %"struct.std::_Rb_tree_node_base", ptr %__x.addr.011.i.i.i.i, i64 0, i32 3
  %_M_left.i.i.i.i.i728 = getelementptr inbounds %"struct.std::_Rb_tree_node_base", ptr %__x.addr.011.i.i.i.i, i64 0, i32 2
  %__y.addr.1.i.i.i.i = select i1 %cmp.i.i.i.i.i.i726, ptr %__y.addr.010.i.i.i.i, ptr %__x.addr.011.i.i.i.i
  %__x.addr.1.in.i.i.i.i = select i1 %cmp.i.i.i.i.i.i726, ptr %_M_right.i.i.i.i.i727, ptr %_M_left.i.i.i.i.i728
...
_ZNSt3mapINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEN9benchmark7CounterESt4lessIS5_ESaISt4pairIKS5_S7_EEE11lower_boundERSB_.exit.i: ; preds = %_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit.i.i.i.i
  %cmp.i.i729 = icmp eq ptr %__y.addr.1.i.i.i.i, %add.ptr.i.i.i.i724
  br i1 %cmp.i.i729, label %if.then.i733, label %lor.rhs.i
...
lor.rhs.i:                                        ; preds = %_ZNSt3mapINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEN9benchmark7CounterESt4lessIS5_ESaISt4pairIKS5_S7_EEE11lower_boundERSB_.exit.i
  ...
  %__y.addr.1.i.i.i.i.sroa.sel = select i1 %cmp.i.i.i.i.i.i726, ptr %__y.addr.010.i.i.i.i.sroa.gep, ptr %_M_string_length.i.i.i.i.i.i.i.i.le
  ...
  br i1 %cmp.i11.i.i.i.i, label %if.then.i.i.i.i731, label %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i.i.i

_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i.i.i: ; preds = %lor.rhs.i
  %__y.addr.010.i.i.i.i.sroa.gep800 = getelementptr inbounds %"struct.std::_Rb_tree_node", ptr %__y.addr.010.i.i.i.i, i64 0, i32 1
  %__x.addr.011.i.i.i.i.sroa.gep801 = getelementptr inbounds %"struct.std::_Rb_tree_node", ptr %__x.addr.011.i.i.i.i, i64 0, i32 1
  %__y.addr.1.i.i.i.i.sroa.sel802 = select i1 %cmp.i.i.i.i.i.i726, ptr %__y.addr.010.i.i.i.i.sroa.gep800, ptr %__x.addr.011.i.i.i.i.sroa.gep801
  %138 = load ptr, ptr %__y.addr.1.i.i.i.i.sroa.sel802, align 8, !tbaa !49
  %call.i.i.i.i.i = call i32 @memcmp(ptr noundef %134, ptr noundef %138, i64 noundef %.sroa.speculated.i.i.i.i) #27
  %tobool.not.i.i.i.i730 = icmp eq i32 %call.i.i.i.i.i, 0
  br i1 %tobool.not.i.i.i.i730, label %if.then.i.i.i.i731, label %_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit.i

if.then.i.i.i.i731:                               ; preds = %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i.i.i, %lor.rhs.i
...
_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit.i: ; preds = %if.then.i.i.i.i731, %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i.i.i
  %__r.0.i.i.i.i = phi i32 [ %call.i.i.i.i.i, %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i.i.i ], [ %retval.0.i12.i.i.i.i, %if.then.i.i.i.i731 ]
  %cmp.i.i.i732 = icmp slt i32 %__r.0.i.i.i.i, 0
  br i1 %cmp.i.i.i732, label %if.then.i733, label %invoke.cont247

if.then.i733:                                     ; preds = %_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit.i, %_ZNSt3mapINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEN9benchmark7CounterESt4lessIS5_ESaISt4pairIKS5_S7_EEE11lower_boundERSB_.exit.i, %invoke.cont241
  %__y.addr.0.lcssa.i.i.i23.i = phi ptr [ %add.ptr.i.i.i.i724, %_ZNSt3mapINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEN9benchmark7CounterESt4lessIS5_ESaISt4pairIKS5_S7_EEE11lower_boundERSB_.exit.i ], [ %__y.addr.1.i.i.i.i, %_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit.i ], [ %add.ptr.i.i.i.i724, %invoke.cont241 ]
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %ref.tmp9.i) #27
  store ptr %_M_storage.i.i722, ptr %ref.tmp9.i, align 8, !tbaa !5
  ...
  %call5.i.i.i.i.i.i797 = invoke noalias noundef nonnull dereferenceable(80) ptr @_Znwm(i64 noundef 80) #25
          to label %call5.i.i.i.i.i.i.noexc unwind label %lpad236

call5.i.i.i.i.i.i.noexc:                          ; preds = %if.then.i733
  invoke void @_ZNSt8_Rb_treeINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt4pairIKS5_N9benchmark7CounterEESt10_Select1stISA_ESt4lessIS5_ESaISA_EE17_M_construct_nodeIJRKSt21piecewise_construct_tSt5tupleIJRS7_EESL_IJEEEEEvPSt13_Rb_tree_nodeISA_EDpOT_(ptr noundef nonnull align 8 dereferenceable(48) %counters245, ptr noundef nonnull %call5.i.i.i.i.i.i797, ptr noundef nonnull align 1 dereferenceable(1) @_ZStL19piecewise_construct, ptr noundef nonnull align 8 dereferenceable(8) %ref.tmp9.i, ptr noundef nonnull align 1 dereferenceable(1) %ref.tmp10.i)
          to label %.noexc798 unwind label %lpad236

.noexc798:                                        ; preds = %call5.i.i.i.i.i.i.noexc
  store ptr %call5.i.i.i.i.i.i797, ptr %_M_node.i.i, align 8, !tbaa !88
  %_M_storage.i.i.i.i769 = getelementptr inbounds %"struct.std::_Rb_tree_node", ptr %call5.i.i.i.i.i.i797, i64 0, i32 1
  %call8.i = invoke { ptr, ptr } @_ZNSt8_Rb_treeINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt4pairIKS5_N9benchmark7CounterEESt10_Select1stISA_ESt4lessIS5_ESaISA_EE29_M_get_insert_hint_unique_posESt23_Rb_tree_const_iteratorISA_ERS7_(ptr noundef nonnull align 8 dereferenceable(48) %counters245, ptr %__y.addr.0.lcssa.i.i.i23.i, ptr noundef nonnull align 8 dereferenceable(32) %_M_storage.i.i.i.i769)
          to label %invoke.cont7.i unwind label %lpad.i795

invoke.cont7.i:                                   ; preds = %.noexc798
  %139 = extractvalue { ptr, ptr } %call8.i, 0
  %140 = extractvalue { ptr, ptr } %call8.i, 1
  %tobool.not.i770 = icmp eq ptr %140, null
  br i1 %tobool.not.i770, label %if.then.i.i796, label %if.then.i775

if.then.i775:                                     ; preds = %invoke.cont7.i
  %cmp.not.i.i.i771 = icmp ne ptr %139, null
  %cmp2.i.i.i773 = icmp eq ptr %add.ptr.i.i.i.i724, %140
  %or.cond.i.i.i774 = select i1 %cmp.not.i.i.i771, i1 true, i1 %cmp2.i.i.i773
  br i1 %or.cond.i.i.i774, label %cleanup.thread.i, label %lor.rhs.i.i.i780

lor.rhs.i.i.i780:                                 ; preds = %if.then.i775
  %_M_string_length.i.i.i.i.i.i.i776 = getelementptr inbounds %"struct.std::_Rb_tree_node", ptr %call5.i.i.i.i.i.i797, i64 0, i32 1, i32 0, i64 8
  %141 = load i64, ptr %_M_string_length.i.i.i.i.i.i.i776, align 8, !tbaa !48
  %_M_string_length.i10.i.i.i.i.i.i777 = getelementptr inbounds %"struct.std::_Rb_tree_node", ptr %140, i64 0, i32 1, i32 0, i64 8
  %142 = load i64, ptr %_M_string_length.i10.i.i.i.i.i.i777, align 8, !tbaa !48
  %.sroa.speculated.i.i.i.i.i.i778 = call i64 @llvm.umin.i64(i64 %141, i64 %142)
  %cmp.i11.i.i.i.i.i.i779 = icmp eq i64 %.sroa.speculated.i.i.i.i.i.i778, 0
  br i1 %cmp.i11.i.i.i.i.i.i779, label %if.then.i.i.i.i.i.i789, label %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i.i.i.i.i784

_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i.i.i.i.i784: ; preds = %lor.rhs.i.i.i780
  %_M_storage.i.i.i.i.i.i781 = getelementptr inbounds %"struct.std::_Rb_tree_node", ptr %140, i64 0, i32 1
  %143 = load ptr, ptr %_M_storage.i.i.i.i.i.i781, align 8, !tbaa !49
  %144 = load ptr, ptr %_M_storage.i.i.i.i769, align 8, !tbaa !49
  %call.i.i.i.i.i.i.i782 = call i32 @memcmp(ptr noundef %144, ptr noundef %143, i64 noundef %.sroa.speculated.i.i.i.i.i.i778) #27
  %tobool.not.i.i.i.i.i.i783 = icmp eq i32 %call.i.i.i.i.i.i.i782, 0
  br i1 %tobool.not.i.i.i.i.i.i783, label %if.then.i.i.i.i.i.i789, label %_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit.i.i.i792

if.then.i.i.i.i.i.i789:                           ; preds = %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i.i.i.i.i784, %lor.rhs.i.i.i780
  %sub.i.i.i.i.i.i.i785 = sub i64 %141, %142
  %spec.select6.i.i.i.i.i.i.i786 = call i64 @llvm.smax.i64(i64 %sub.i.i.i.i.i.i.i785, i64 -2147483648)
  %retval.07.i.i.i.i.i.i.i787 = call i64 @llvm.smin.i64(i64 %spec.select6.i.i.i.i.i.i.i786, i64 2147483647)
  %retval.0.i12.i.i.i.i.i.i788 = trunc i64 %retval.07.i.i.i.i.i.i.i787 to i32
  br label %_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit.i.i.i792

_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit.i.i.i792: ; preds = %if.then.i.i.i.i.i.i789, %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i.i.i.i.i784
  %__r.0.i.i.i.i.i.i790 = phi i32 [ %call.i.i.i.i.i.i.i782, %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i.i.i.i.i784 ], [ %retval.0.i12.i.i.i.i.i.i788, %if.then.i.i.i.i.i.i789 ]
  %cmp.i.i.i.i.i791 = icmp slt i32 %__r.0.i.i.i.i.i.i790, 0
  br label %cleanup.thread.i

cleanup.thread.i:                                 ; preds = %_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit.i.i.i792, %if.then.i775
  %145 = phi i1 [ true, %if.then.i775 ], [ %cmp.i.i.i.i.i791, %_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit.i.i.i792 ]
  call void @_ZSt29_Rb_tree_insert_and_rebalancebPSt18_Rb_tree_node_baseS0_RS_(i1 noundef zeroext %145, ptr noundef nonnull %call5.i.i.i.i.i.i797, ptr noundef nonnull %140, ptr noundef nonnull align 8 dereferenceable(32) %add.ptr.i.i.i.i724) #27
  %146 = load i64, ptr %_M_node_count.i.i.i793, align 8, !tbaa !47
  %inc.i.i.i794 = add i64 %146, 1
  store i64 %inc.i.i.i794, ptr %_M_node_count.i.i.i793, align 8, !tbaa !47
...
if.then.i.i796:                                   ; preds = %invoke.cont7.i
  %148 = load ptr, ptr %_M_storage.i.i.i.i769, align 8, !tbaa !49
  %149 = getelementptr inbounds %"struct.std::_Rb_tree_node", ptr %call5.i.i.i.i.i.i797, i64 0, i32 1, i32 0, i64 16
...
if.then.i.i.i.i.i.i.i.i.i:                        ; preds = %if.then.i.i796
...
_ZNSt8_Rb_treeINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt4pairIKS5_N9benchmark7CounterEESt10_Select1stISA_ESt4lessIS5_ESaISA_EE12_M_drop_nodeEPSt13_Rb_tree_nodeISA_E.exit.i.i: ; preds = %if.then.i.i.i.i.i.i.i.i.i, %if.then.i.i796
  call void @_ZdlPv(ptr noundef nonnull %call5.i.i.i.i.i.i797) #26
  br label %_ZNSt8_Rb_treeINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt4pairIKS5_N9benchmark7CounterEESt10_Select1stISA_ESt4lessIS5_ESaISA_EE22_M_emplace_hint_uniqueIJRKSt21piecewise_construct_tSt5tupleIJRS7_EESL_IJEEEEESt17_Rb_tree_iteratorISA_ESt23_Rb_tree_const_iteratorISA_EDpOT_.exit
...
_ZNSt8_Rb_treeINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt4pairIKS5_N9benchmark7CounterEESt10_Select1stISA_ESt4lessIS5_ESaISA_EE22_M_emplace_hint_uniqueIJRKSt21piecewise_construct_tSt5tupleIJRS7_EESL_IJEEEEESt17_Rb_tree_iteratorISA_ESt23_Rb_tree_const_iteratorISA_EDpOT_.exit: ; preds = %cleanup.thread.i, %_ZNSt8_Rb_treeINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt4pairIKS5_N9benchmark7CounterEESt10_Select1stISA_ESt4lessIS5_ESaISA_EE12_M_drop_nodeEPSt13_Rb_tree_nodeISA_E.exit.i.i
  %retval.sroa.0.023.i = phi ptr [ %call5.i.i.i.i.i.i797, %cleanup.thread.i ], [ %139, %_ZNSt8_Rb_treeINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt4pairIKS5_N9benchmark7CounterEESt10_Select1stISA_ESt4lessIS5_ESaISA_EE12_M_drop_nodeEPSt13_Rb_tree_nodeISA_E.exit.i.i ]
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %__z.i) #27
...
invoke.cont247:                                   ; preds = %_ZNSt8_Rb_treeINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt4pairIKS5_N9benchmark7CounterEESt10_Select1stISA_ESt4lessIS5_ESaISA_EE22_M_emplace_hint_uniqueIJRKSt21piecewise_construct_tSt5tupleIJRS7_EESL_IJEEEEESt17_Rb_tree_iteratorISA_ESt23_Rb_tree_const_iteratorISA_EDpOT_.exit, %_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit.i
  ...
  %second.i734 = getelementptr inbounds %"struct.std::_Rb_tree_node", ptr %__i.sroa.0.0.i, i64 0, i32 1, i32 0, i64 32
  store double %call233, ptr %second.i734, align 8, !tbaa.struct !51
  %c234.sroa.5.0.second.i734.sroa_idx = getelementptr inbounds %"struct.std::_Rb_tree_node", ptr %__i.sroa.0.0.i, i64 0, i32 1, i32 0, i64 40
  store i32 %130, ptr %c234.sroa.5.0.second.i734.sroa_idx, align 8, !tbaa.struct !90
  %c234.sroa.6.0.second.i734.sroa_idx = getelementptr inbounds %"struct.std::_Rb_tree_node", ptr %__i.sroa.0.0.i, i64 0, i32 1, i32 0, i64 44
  store i32 %131, ptr %c234.sroa.6.0.second.i734.sroa_idx, align 4, !tbaa.struct !91
  %call.i737 = call noundef ptr @_ZSt18_Rb_tree_incrementPSt18_Rb_tree_node_base(ptr noundef %__begin2217.sroa.0.0885) #28
  %cmp.i712.not = icmp eq ptr %call.i737, %4
  br i1 %cmp.i712.not, label %for.cond.cleanup225, label %for.body226
...
lpad236:                                          ; preds = %call5.i.i.i.i.i.i.noexc, %if.then.i733, %invoke.cont237, %invoke.cont232
  %151 = landingpad { ptr, i32 }
          cleanup
  br label %ehcleanup262

invoke.cont261:                                   ; preds = %.noexc720, %if.else.i718
  ...
  %incdec.ptr.i738 = getelementptr inbounds %"struct.benchmark::internal::Statistics", ptr %__begin1167.sroa.0.0888, i64 1
  %cmp.i687.not = icmp eq ptr %incdec.ptr.i738, %102
  br i1 %cmp.i687.not, label %for.cond.cleanup175, label %for.body176

ehcleanup262:                                     ; preds = %lpad231, %lpad.i795, %lpad236, %lpad182
  %eh.lpad-body799.pn.pn = phi { ptr, i32 } [ %123, %lpad182 ], [ %150, %lpad231 ], [ %151, %lpad236 ], [ %147, %lpad.i795 ]
  call void @_ZN9benchmark17BenchmarkReporter3RunD2Ev(ptr noundef nonnull align 8 dereferenceable(528) %data) #27
  br label %ehcleanup263

ehcleanup263:                                     ; preds = %ehcleanup262, %lpad178
  %eh.lpad-body799.pn.pn.pn = phi { ptr, i32 } [ %eh.lpad-body799.pn.pn, %ehcleanup262 ], [ %122, %lpad178 ]
  call void @llvm.lifetime.end.p0(i64 528, ptr nonnull %data) #27
  br label %ehcleanup277

ehcleanup277:                                     ; preds = %ehcleanup263, %lpad155
  %eh.lpad-body799.pn.pn.pn.pn = phi { ptr, i32 } [ %eh.lpad-body799.pn.pn.pn, %ehcleanup263 ], [ %98, %lpad155 ]
  %152 = load ptr, ptr %report_label, align 8, !tbaa !49
  %cmp.i.i.i739 = icmp eq ptr %152, %55
  br i1 %cmp.i.i.i739, label %ehcleanup279, label %if.then.i.i740

if.then.i.i740:                                   ; preds = %ehcleanup277
  call void @_ZdlPv(ptr noundef %152) #26
  br label %ehcleanup279

ehcleanup279:                                     ; preds = %if.then.i.i740, %ehcleanup277, %lpad144
  %eh.lpad-body799.pn.pn.pn.pn.pn = phi { ptr, i32 } [ %95, %lpad144 ], [ %eh.lpad-body799.pn.pn.pn.pn, %ehcleanup277 ], [ %eh.lpad-body799.pn.pn.pn.pn, %if.then.i.i740 ]
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %report_label) #27
  br label %ehcleanup281
...
ehcleanup281:                                     ; preds = %lpad88.loopexit.split-lp, %lpad88.loopexit, %lpad113.loopexit.split-lp, %lpad113.loopexit, %lpad30.loopexit, %lpad30.loopexit.split-lp, %ehcleanup, %ehcleanup279
  %.pn.pn = phi { ptr, i32 } [ %eh.lpad-body799.pn.pn.pn.pn.pn, %ehcleanup279 ], [ %eh.lpad-body420.pn, %ehcleanup ], [ %lpad.loopexit844, %lpad30.loopexit ], [ %lpad.loopexit.split-lp845, %lpad30.loopexit.split-lp ], [ %lpad.loopexit841, %lpad88.loopexit ], [ %lpad.loopexit.split-lp842, %lpad88.loopexit.split-lp ], [ %lpad.loopexit, %lpad113.loopexit ], [ %lpad.loopexit.split-lp, %lpad113.loopexit.split-lp ]
  %this.val.i.i742 = load ptr, ptr %_M_parent.i.i.i.i.i, align 8, !tbaa !44
  call fastcc void @_ZNSt8_Rb_treeINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt4pairIKS5_ZN9benchmark12ComputeStatsERKSt6vectorINS8_17BenchmarkReporter3RunESaISB_EEE11CounterStatESt10_Select1stISH_ESt4lessIS5_ESaISH_EE8_M_eraseEPSt13_Rb_tree_nodeISH_E(ptr noundef %this.val.i.i742)
  call void @llvm.lifetime.end.p0(i64 48, ptr nonnull %counter_stats) #27
  br label %ehcleanup287
...
ehcleanup287:                                     ; preds = %ehcleanup281, %lpad10
  ...
  %tobool.not.i.i.i743 = icmp eq ptr %153, null
  br i1 %tobool.not.i.i.i743, label %_ZNSt6vectorIdSaIdEED2Ev.exit745, label %if.then.i.i.i744

if.then.i.i.i744:                                 ; preds = %ehcleanup287
  call void @_ZdlPv(ptr noundef nonnull %153) #26
  br label %_ZNSt6vectorIdSaIdEED2Ev.exit745

_ZNSt6vectorIdSaIdEED2Ev.exit745:                 ; preds = %ehcleanup287, %if.then.i.i.i744
  call void @llvm.lifetime.end.p0(i64 24, ptr nonnull %cpu_accumulated_time_stat) #27
  %154 = load ptr, ptr %real_accumulated_time_stat, align 8, !tbaa !17
  %tobool.not.i.i.i746 = icmp eq ptr %154, null
  br i1 %tobool.not.i.i.i746, label %_ZNSt6vectorIdSaIdEED2Ev.exit748, label %if.then.i.i.i747

if.then.i.i.i747:                                 ; preds = %_ZNSt6vectorIdSaIdEED2Ev.exit745
  call void @_ZdlPv(ptr noundef nonnull %154) #26
  br label %_ZNSt6vectorIdSaIdEED2Ev.exit748

_ZNSt6vectorIdSaIdEED2Ev.exit748:                 ; preds = %_ZNSt6vectorIdSaIdEED2Ev.exit745, %if.then.i.i.i747
  call void @llvm.lifetime.end.p0(i64 24, ptr nonnull %real_accumulated_time_stat) #27
...
nrvo.skipdtor:                                    ; preds = %_ZNSt6vectorIdSaIdEED2Ev.exit695, %invoke.cont
  ret void
}
...
if.then.i:                                        ; preds = %invoke.cont7.i, %if.then64.i.i, %if.then50.i.i, %if.then32.i.i, %_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit.i.i
  %retval.sroa.12.2.i5.i = phi ptr [ %retval.sroa.12.2.i.i, %invoke.cont7.i ], [ %__position.coerce.call.i151.i.i, %if.then64.i.i ], [ %__y.addr.0.lcssa.i.i.i42, %if.then50.i.i ], [ %call.i.__position.coerce.i.i, %if.then32.i.i ], [ %19, %_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit.i.i ]
  %retval.sroa.0.2.i4.i = phi ptr [ %retval.sroa.0.2.i.i, %invoke.cont7.i ], [ %.call.i151.i.i, %if.then64.i.i ], [ null, %if.then50.i.i ], [ %.__position.coerce.i.i, %if.then32.i.i ], [ null, %_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit.i.i ]
  %cmp.not.i.i.i25 = icmp ne ptr %retval.sroa.0.2.i4.i, null
  %cmp2.i.i.i = icmp eq ptr %add.ptr.i.i.i, %retval.sroa.12.2.i5.i
  %or.cond.i.i.i = or i1 %cmp2.i.i.i, %cmp.not.i.i.i25
...
entry:
  ...
  %cmp44 = icmp sgt i64 %sub.ptr.sub.i42, 24
...
while.body:                                       ; preds = %entry, %_ZSt27__unguarded_partition_pivotIN9__gnu_cxx17__normal_iteratorIPdSt6vectorIdSaIdEEEENS0_5__ops15_Iter_less_iterEET_S9_S9_T0_.exit
  %sub.ptr.div.i48.in = phi i64 [ %sub.ptr.sub.i, %_ZSt27__unguarded_partition_pivotIN9__gnu_cxx17__normal_iteratorIPdSt6vectorIdSaIdEEEENS0_5__ops15_Iter_less_iterEET_S9_S9_T0_.exit ], [ %sub.ptr.sub.i42, %entry ]
...
if.end:                                           ; preds = %while.body
  ...
  %div.i5560 = lshr i64 %sub.ptr.div.i48.in, 4
  %add.ptr.i.i = getelementptr inbounds double, ptr %__first.sroa.0.046, i64 %div.i5560
...
while.end:                                        ; preds = %_ZSt27__unguarded_partition_pivotIN9__gnu_cxx17__normal_iteratorIPdSt6vectorIdSaIdEEEENS0_5__ops15_Iter_less_iterEET_S9_S9_T0_.exit, %entry
  ...
  %sub.ptr.rhs.cast.i.lcssa = phi i64 [ %sub.ptr.rhs.cast.i41, %entry ], [ %sub.ptr.rhs.cast.i, %_ZSt27__unguarded_partition_pivotIN9__gnu_cxx17__normal_iteratorIPdSt6vectorIdSaIdEEEENS0_5__ops15_Iter_less_iterEET_S9_S9_T0_.exit ]
...
while.cond.us.preheader:                          ; preds = %if.end
  ...
  %add.ptr.i57.i.us = getelementptr inbounds double, ptr %__first.coerce, i64 %div2730
...
while.cond.us:                                    ; preds = %while.cond.us.preheader, %_ZSt13__adjust_heapIN9__gnu_cxx17__normal_iteratorIPdSt6vectorIdSaIdEEEEldNS0_5__ops15_Iter_less_iterEEvT_T0_SA_T1_T2_.exit.us
  %__parent.0.us = phi i64 [ %dec.us, %_ZSt13__adjust_heapIN9__gnu_cxx17__normal_iteratorIPdSt6vectorIdSaIdEEEEldNS0_5__ops15_Iter_less_iterEEvT_T0_SA_T1_T2_.exit.us ], [ %div2730, %while.cond.us.preheader ]
...
while.body.i.us:                                  ; preds = %while.cond.us, %while.body.i.us
  ...
  %cmp.i.us = icmp slt i64 %__secondChild.1.i.us, %div.i2831
...
while.end.i.us:                                   ; preds = %while.body.i.us, %while.cond.us
  %__holeIndex.addr.0.lcssa.i.us = phi i64 [ %__parent.0.us, %while.cond.us ], [ %__secondChild.1.i.us, %while.body.i.us ]
...
while.cond:                                       ; preds = %if.end, %_ZSt13__adjust_heapIN9__gnu_cxx17__normal_iteratorIPdSt6vectorIdSaIdEEEEldNS0_5__ops15_Iter_less_iterEEvT_T0_SA_T1_T2_.exit
  %__parent.0 = phi i64 [ %dec, %_ZSt13__adjust_heapIN9__gnu_cxx17__normal_iteratorIPdSt6vectorIdSaIdEEEEldNS0_5__ops15_Iter_less_iterEEvT_T0_SA_T1_T2_.exit ], [ %div2730, %if.end ]
...
while.body.i:                                     ; preds = %while.cond, %while.body.i
  ...
  %cmp.i = icmp slt i64 %__secondChild.1.i, %div.i2831
  br i1 %cmp.i, label %while.body.i, label %while.end.i, !llvm.loop !106

while.end.i:                                      ; preds = %while.body.i
  %cmp32.i.i = icmp sgt i64 %__secondChild.1.i, %__parent.0
...
land.rhs.i.i:                                     ; preds = %while.end.i, %while.body.i.i
  %__holeIndex.addr.033.i.i = phi i64 [ %__parent.034.i.i, %while.body.i.i ], [ %__secondChild.1.i, %while.end.i ]
...
_ZSt13__adjust_heapIN9__gnu_cxx17__normal_iteratorIPdSt6vectorIdSaIdEEEEldNS0_5__ops15_Iter_less_iterEEvT_T0_SA_T1_T2_.exit: ; preds = %land.rhs.i.i, %while.body.i.i, %while.cond, %while.end.i
  %__holeIndex.addr.0.lcssa.i.i = phi i64 [ %__secondChild.1.i, %while.end.i ], [ %__parent.0, %while.cond ], [ %__parent.034.i.i, %while.body.i.i ], [ %__holeIndex.addr.033.i.i, %land.rhs.i.i ]
