...
if.else459:                                       ; preds = %if.then263
  ...
  %.1733 = select i1 %cmp466, float %sub246, float %72
  %cmp475 = fcmp ogt float %71, %.1733
  %cond494 = select i1 %cmp475, float %.1733, float %71
...
if.then522:                                       ; preds = %if.else506
  ...
  %.1735 = select i1 %cmp674, float %sub246, float %72
  %cmp683 = fcmp olt float %71, %.1735
  %cond702 = select i1 %cmp683, float %.1735, float %71
...
if.else713:                                       ; preds = %if.else506
  ...
  %.1737 = select i1 %cmp720, float %sub246, float %72
  %cmp729 = fcmp ogt float %71, %.1737
  %cond748 = select i1 %cmp729, float %.1737, float %71
...
if.then1031:                                      ; preds = %if.then1027
  ...
  %.1740 = select i1 %cmp1038, float %168, float %167
  %cmp1047 = fcmp olt float %sub950, %.1740
  %cond1066 = select i1 %cmp1047, float %.1740, float %sub950
  %fneg1073 = fneg float %cond1066
  %arrayidx1076 = getelementptr inbounds %class.GIM_TRIANGLE_CALCULATION_CACHE, ptr %this, i64 0, i32 8, i32 0, i64 1
  store float %fneg1073, ptr %arrayidx1076, align 4, !tbaa !16
...
if.else1229:                                      ; preds = %if.then1027
  ...
  %.1742 = select i1 %cmp1236, float %177, float %176
  %cmp1245 = fcmp ogt float %sub950, %.1742
  %cond1264 = select i1 %cmp1245, float %.1742, float %sub950
  %arrayidx1267 = getelementptr inbounds %class.GIM_TRIANGLE_CALCULATION_CACHE, ptr %this, i64 0, i32 8, i32 0, i64 1
  store float %cond1264, ptr %arrayidx1267, align 4, !tbaa !16
...
if.then1293:                                      ; preds = %if.else1276
  ...
  %.1744 = select i1 %cmp1445, float %179, float %178
  %cmp1454 = fcmp olt float %sub950, %.1744
  %cond1473 = select i1 %cmp1454, float %.1744, float %sub950
...
if.else1484:                                      ; preds = %if.else1276
  ...
  %.1746 = select i1 %cmp1491, float %179, float %178
  %cmp1500 = fcmp ogt float %sub950, %.1746
  %cond1519 = select i1 %cmp1500, float %.1746, float %sub950
...
if.then.i76:                                      ; preds = %_Z26PLANE_CLIP_POLYGON_COLLECTI9btVector3EvRKT_S3_ffPS1_Rj.exit
  ...
  %arrayidx20.i70 = getelementptr inbounds %class.btVector3, ptr %clipped, i64 %idxprom.i65, i32 0, i64 1
  ...
  %arrayidx30.i74 = getelementptr inbounds %class.btVector3, ptr %clipped, i64 %idxprom.i65, i32 0, i64 2
...
if.then31.i85:                                    ; preds = %if.end.i77
  ...
  %arrayidx43.i81 = getelementptr inbounds %class.btVector3, ptr %clipped, i64 %idxprom34.i78, i32 0, i64 1
  store float %49, ptr %arrayidx43.i81, align 4, !tbaa !16
  %50 = load float, ptr %arrayidx12.i54, align 4, !tbaa !16
  %arrayidx49.i83 = getelementptr inbounds %class.btVector3, ptr %clipped, i64 %idxprom34.i78, i32 0, i64 2
...
if.then.i106:                                     ; preds = %_Z26PLANE_CLIP_POLYGON_COLLECTI9btVector3EvRKT_S3_ffPS1_Rj.exit86
  ...
  %arrayidx20.i100 = getelementptr inbounds %class.btVector3, ptr %clipped, i64 %idxprom.i95, i32 0, i64 1
  ...
  %arrayidx30.i104 = getelementptr inbounds %class.btVector3, ptr %clipped, i64 %idxprom.i95, i32 0, i64 2
...
if.then31.i115:                                   ; preds = %if.end.i107
  ...
  %arrayidx43.i111 = getelementptr inbounds %class.btVector3, ptr %clipped, i64 %idxprom34.i108, i32 0, i64 1
  store float %61, ptr %arrayidx43.i111, align 4, !tbaa !16
  %62 = load float, ptr %arrayidx12.i, align 4, !tbaa !16
  %arrayidx49.i113 = getelementptr inbounds %class.btVector3, ptr %clipped, i64 %idxprom34.i108, i32 0, i64 2
...
if.then.i83:                                      ; preds = %for.body
  ...
  %arrayidx20.i77 = getelementptr inbounds %class.btVector3, ptr %clipped, i64 %idxprom.i72, i32 0, i64 1
  ...
  %arrayidx30.i81 = getelementptr inbounds %class.btVector3, ptr %clipped, i64 %idxprom.i72, i32 0, i64 2
...
if.then31.i92:                                    ; preds = %if.end.i84
  ...
  %arrayidx43.i88 = getelementptr inbounds %class.btVector3, ptr %clipped, i64 %idxprom34.i85, i32 0, i64 1
  store float %42, ptr %arrayidx43.i88, align 4, !tbaa !16
  %43 = load float, ptr %arrayidx12.i61, align 4, !tbaa !16
  %arrayidx49.i90 = getelementptr inbounds %class.btVector3, ptr %clipped, i64 %idxprom34.i85, i32 0, i64 2
