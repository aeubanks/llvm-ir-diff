...
for.body:                                         ; preds = %if.end, %for.inc
  ...
  %nav.0401 = phi i32 [ 0, %if.end ], [ %nav.1, %for.inc ]
  ...
  %and.i = and i64 %or, 283691315109952
  %cmp.i = icmp eq i64 %and.i, 0
  br i1 %cmp.i, label %if.end5, label %for.inc
...
if.end5:                                          ; preds = %for.body
  ...
  br i1 %cmp.i.i, label %land.rhs.i, label %islegalhaswon.exit
...
islegalhaswon.exit:                               ; preds = %if.end5, %land.rhs.i, %if.end.i.i, %if.end9.i.i, %if.end16.i.i
  ...
  %shr.i = lshr i64 %or, 6
  %and.i295 = and i64 %shr.i, %or
  %shr1.i = lshr i64 %and.i295, 12
  %and2.i = and i64 %shr1.i, %and.i295
  %cmp.not.i = icmp eq i64 %and2.i, 0
...
while.cond:                                       ; preds = %if.then15
  %indvars.iv.next428 = add nuw nsw i64 %indvars.iv, 1
  %exitcond430.not = icmp eq i64 %indvars.iv, 6
  br i1 %exitcond430.not, label %if.end46.thread, label %while.body

while.body:                                       ; preds = %while.cond
  %arrayidx26 = getelementptr inbounds [7 x i8], ptr @height, i64 0, i64 %indvars.iv.next428
  ...
  %or30 = or i64 %shl29, %2
  %and.i.i297 = and i64 %or30, 283691315109952
  %cmp.i.i298 = icmp eq i64 %and.i.i297, 0
  br i1 %cmp.i.i298, label %land.rhs.i304, label %islegalhaswon.exit325

land.rhs.i304:                                    ; preds = %while.body
  %shr.i.i299 = lshr i64 %or30, 6
  %and.i4.i300 = and i64 %shr.i.i299, %or30
  %shr1.i.i301 = lshr i64 %and.i4.i300, 12
  %and2.i.i302 = and i64 %shr1.i.i301, %and.i4.i300
  %cmp.not.i.i303 = icmp eq i64 %and2.i.i302, 0
  br i1 %cmp.not.i.i303, label %if.end.i.i310, label %cleanup

if.end.i.i310:                                    ; preds = %land.rhs.i304
  %shr3.i.i305 = lshr i64 %or30, 7
  %and4.i.i306 = and i64 %shr3.i.i305, %or30
  %shr5.i.i307 = lshr i64 %and4.i.i306, 14
  %and6.i.i308 = and i64 %shr5.i.i307, %and4.i.i306
  %cmp7.not.i.i309 = icmp eq i64 %and6.i.i308, 0
  br i1 %cmp7.not.i.i309, label %if.end9.i.i316, label %cleanup

if.end9.i.i316:                                   ; preds = %if.end.i.i310
  %shr10.i.i311 = lshr i64 %or30, 8
  %and11.i.i312 = and i64 %shr10.i.i311, %or30
  %shr12.i.i313 = lshr i64 %and11.i.i312, 16
  %and13.i.i314 = and i64 %shr12.i.i313, %and11.i.i312
  %cmp14.not.i.i315 = icmp eq i64 %and13.i.i314, 0
  br i1 %cmp14.not.i.i315, label %if.end16.i.i323, label %cleanup

if.end16.i.i323:                                  ; preds = %if.end9.i.i316
  %shr17.i.i317 = lshr i64 %or30, 1
  %and18.i.i318 = and i64 %shr17.i.i317, %or30
  %shr19.i.i319 = lshr i64 %and18.i.i318, 2
  %and20.i.i320 = and i64 %shr19.i.i319, %and18.i.i318
  %cmp21.i.i321 = icmp ne i64 %and20.i.i320, 0
  %conv.i5.i322 = zext i1 %cmp21.i.i321 to i32
  br label %islegalhaswon.exit325

islegalhaswon.exit325:                            ; preds = %while.body, %if.end16.i.i323
  %land.ext.i324 = phi i32 [ 0, %while.body ], [ %conv.i5.i322, %if.end16.i.i323 ]
  %tobool32.not = icmp eq i32 %land.ext.i324, 0
  br i1 %tobool32.not, label %while.cond.1, label %cleanup, !llvm.loop !20

while.cond.1:                                     ; preds = %islegalhaswon.exit325
  %indvars.iv.next428.1 = add nuw nsw i64 %indvars.iv, 2
  %exitcond430.not.1 = icmp eq i64 %indvars.iv.next428, 6
  br i1 %exitcond430.not.1, label %if.end46.thread, label %while.body.1

while.body.1:                                     ; preds = %while.cond.1
  %arrayidx26.1 = getelementptr inbounds [7 x i8], ptr @height, i64 0, i64 %indvars.iv.next428.1
  ...
  %and.i.i297.1 = and i64 %or30.1, 283691315109952
  %cmp.i.i298.1 = icmp eq i64 %and.i.i297.1, 0
  br i1 %cmp.i.i298.1, label %land.rhs.i304.1, label %islegalhaswon.exit325.1

land.rhs.i304.1:                                  ; preds = %while.body.1
  %shr.i.i299.1 = lshr i64 %or30.1, 6
  %and.i4.i300.1 = and i64 %shr.i.i299.1, %or30.1
  %shr1.i.i301.1 = lshr i64 %and.i4.i300.1, 12
  %and2.i.i302.1 = and i64 %shr1.i.i301.1, %and.i4.i300.1
  %cmp.not.i.i303.1 = icmp eq i64 %and2.i.i302.1, 0
  br i1 %cmp.not.i.i303.1, label %if.end.i.i310.1, label %cleanup

if.end.i.i310.1:                                  ; preds = %land.rhs.i304.1
  %shr3.i.i305.1 = lshr i64 %or30.1, 7
  %and4.i.i306.1 = and i64 %shr3.i.i305.1, %or30.1
  %shr5.i.i307.1 = lshr i64 %and4.i.i306.1, 14
  %and6.i.i308.1 = and i64 %shr5.i.i307.1, %and4.i.i306.1
  %cmp7.not.i.i309.1 = icmp eq i64 %and6.i.i308.1, 0
  br i1 %cmp7.not.i.i309.1, label %if.end9.i.i316.1, label %cleanup

if.end9.i.i316.1:                                 ; preds = %if.end.i.i310.1
  %shr10.i.i311.1 = lshr i64 %or30.1, 8
  %and11.i.i312.1 = and i64 %shr10.i.i311.1, %or30.1
  %shr12.i.i313.1 = lshr i64 %and11.i.i312.1, 16
  %and13.i.i314.1 = and i64 %shr12.i.i313.1, %and11.i.i312.1
  %cmp14.not.i.i315.1 = icmp eq i64 %and13.i.i314.1, 0
  br i1 %cmp14.not.i.i315.1, label %if.end16.i.i323.1, label %cleanup

if.end16.i.i323.1:                                ; preds = %if.end9.i.i316.1
  %shr17.i.i317.1 = lshr i64 %or30.1, 1
  %and18.i.i318.1 = and i64 %shr17.i.i317.1, %or30.1
  %shr19.i.i319.1 = lshr i64 %and18.i.i318.1, 2
  %and20.i.i320.1 = and i64 %shr19.i.i319.1, %and18.i.i318.1
  %cmp21.i.i321.1 = icmp ne i64 %and20.i.i320.1, 0
  %conv.i5.i322.1 = zext i1 %cmp21.i.i321.1 to i32
  br label %islegalhaswon.exit325.1

islegalhaswon.exit325.1:                          ; preds = %if.end16.i.i323.1, %while.body.1
  %land.ext.i324.1 = phi i32 [ 0, %while.body.1 ], [ %conv.i5.i322.1, %if.end16.i.i323.1 ]
  %tobool32.not.1 = icmp eq i32 %land.ext.i324.1, 0
  br i1 %tobool32.not.1, label %while.cond.2, label %cleanup, !llvm.loop !20

while.cond.2:                                     ; preds = %islegalhaswon.exit325.1
  %indvars.iv.next428.2 = add nuw nsw i64 %indvars.iv, 3
  %exitcond430.not.2 = icmp eq i64 %indvars.iv.next428.1, 6
  br i1 %exitcond430.not.2, label %if.end46.thread, label %while.body.2

while.body.2:                                     ; preds = %while.cond.2
  %arrayidx26.2 = getelementptr inbounds [7 x i8], ptr @height, i64 0, i64 %indvars.iv.next428.2
  ...
  %and.i.i297.2 = and i64 %or30.2, 283691315109952
  %cmp.i.i298.2 = icmp eq i64 %and.i.i297.2, 0
  br i1 %cmp.i.i298.2, label %land.rhs.i304.2, label %islegalhaswon.exit325.2

land.rhs.i304.2:                                  ; preds = %while.body.2
  %shr.i.i299.2 = lshr i64 %or30.2, 6
  %and.i4.i300.2 = and i64 %shr.i.i299.2, %or30.2
  %shr1.i.i301.2 = lshr i64 %and.i4.i300.2, 12
  %and2.i.i302.2 = and i64 %shr1.i.i301.2, %and.i4.i300.2
  %cmp.not.i.i303.2 = icmp eq i64 %and2.i.i302.2, 0
  br i1 %cmp.not.i.i303.2, label %if.end.i.i310.2, label %cleanup

if.end.i.i310.2:                                  ; preds = %land.rhs.i304.2
  %shr3.i.i305.2 = lshr i64 %or30.2, 7
  %and4.i.i306.2 = and i64 %shr3.i.i305.2, %or30.2
  %shr5.i.i307.2 = lshr i64 %and4.i.i306.2, 14
  %and6.i.i308.2 = and i64 %shr5.i.i307.2, %and4.i.i306.2
  %cmp7.not.i.i309.2 = icmp eq i64 %and6.i.i308.2, 0
  br i1 %cmp7.not.i.i309.2, label %if.end9.i.i316.2, label %cleanup

if.end9.i.i316.2:                                 ; preds = %if.end.i.i310.2
  %shr10.i.i311.2 = lshr i64 %or30.2, 8
  %and11.i.i312.2 = and i64 %shr10.i.i311.2, %or30.2
  %shr12.i.i313.2 = lshr i64 %and11.i.i312.2, 16
  %and13.i.i314.2 = and i64 %shr12.i.i313.2, %and11.i.i312.2
  %cmp14.not.i.i315.2 = icmp eq i64 %and13.i.i314.2, 0
  br i1 %cmp14.not.i.i315.2, label %if.end16.i.i323.2, label %cleanup

if.end16.i.i323.2:                                ; preds = %if.end9.i.i316.2
  %shr17.i.i317.2 = lshr i64 %or30.2, 1
  %and18.i.i318.2 = and i64 %shr17.i.i317.2, %or30.2
  %shr19.i.i319.2 = lshr i64 %and18.i.i318.2, 2
  %and20.i.i320.2 = and i64 %shr19.i.i319.2, %and18.i.i318.2
  %cmp21.i.i321.2 = icmp ne i64 %and20.i.i320.2, 0
  %conv.i5.i322.2 = zext i1 %cmp21.i.i321.2 to i32
  br label %islegalhaswon.exit325.2

islegalhaswon.exit325.2:                          ; preds = %if.end16.i.i323.2, %while.body.2
  %land.ext.i324.2 = phi i32 [ 0, %while.body.2 ], [ %conv.i5.i322.2, %if.end16.i.i323.2 ]
  %tobool32.not.2 = icmp eq i32 %land.ext.i324.2, 0
  br i1 %tobool32.not.2, label %while.cond.3, label %cleanup, !llvm.loop !20

while.cond.3:                                     ; preds = %islegalhaswon.exit325.2
  %indvars.iv.next428.3 = add nuw nsw i64 %indvars.iv, 4
  %exitcond430.not.3 = icmp eq i64 %indvars.iv.next428.2, 6
  br i1 %exitcond430.not.3, label %if.end46.thread, label %while.body.3

while.body.3:                                     ; preds = %while.cond.3
  %arrayidx26.3 = getelementptr inbounds [7 x i8], ptr @height, i64 0, i64 %indvars.iv.next428.3
  ...
  %and.i.i297.3 = and i64 %or30.3, 283691315109952
  %cmp.i.i298.3 = icmp eq i64 %and.i.i297.3, 0
  br i1 %cmp.i.i298.3, label %land.rhs.i304.3, label %while.cond.4

land.rhs.i304.3:                                  ; preds = %while.body.3
  %shr.i.i299.3 = lshr i64 %or30.3, 6
  %and.i4.i300.3 = and i64 %shr.i.i299.3, %or30.3
  %shr1.i.i301.3 = lshr i64 %and.i4.i300.3, 12
  %and2.i.i302.3 = and i64 %shr1.i.i301.3, %and.i4.i300.3
  %cmp.not.i.i303.3 = icmp eq i64 %and2.i.i302.3, 0
  br i1 %cmp.not.i.i303.3, label %if.end.i.i310.3, label %cleanup

if.end.i.i310.3:                                  ; preds = %land.rhs.i304.3
  %shr3.i.i305.3 = lshr i64 %or30.3, 7
  %and4.i.i306.3 = and i64 %shr3.i.i305.3, %or30.3
  %shr5.i.i307.3 = lshr i64 %and4.i.i306.3, 14
  %and6.i.i308.3 = and i64 %shr5.i.i307.3, %and4.i.i306.3
  %cmp7.not.i.i309.3 = icmp eq i64 %and6.i.i308.3, 0
  br i1 %cmp7.not.i.i309.3, label %if.end9.i.i316.3, label %cleanup

if.end9.i.i316.3:                                 ; preds = %if.end.i.i310.3
  %shr10.i.i311.3 = lshr i64 %or30.3, 8
  %and11.i.i312.3 = and i64 %shr10.i.i311.3, %or30.3
  %shr12.i.i313.3 = lshr i64 %and11.i.i312.3, 16
  %and13.i.i314.3 = and i64 %shr12.i.i313.3, %and11.i.i312.3
  %cmp14.not.i.i315.3 = icmp eq i64 %and13.i.i314.3, 0
  br i1 %cmp14.not.i.i315.3, label %if.end16.i.i323.3, label %cleanup

if.end16.i.i323.3:                                ; preds = %if.end9.i.i316.3
  %shr17.i.i317.3 = lshr i64 %or30.3, 1
  %and18.i.i318.3 = and i64 %shr17.i.i317.3, %or30.3
  %shr19.i.i319.3 = lshr i64 %and18.i.i318.3, 2
  %and20.i.i320.3 = and i64 %shr19.i.i319.3, %and18.i.i318.3
  %cmp21.i.i321.3 = icmp eq i64 %and20.i.i320.3, 0
  br i1 %cmp21.i.i321.3, label %while.cond.4, label %cleanup, !llvm.loop !20

while.cond.4:                                     ; preds = %while.body.3, %if.end16.i.i323.3
  %indvars.iv.next428.4 = add nuw nsw i64 %indvars.iv, 5
  %exitcond430.not.4 = icmp eq i64 %indvars.iv.next428.3, 6
  br i1 %exitcond430.not.4, label %if.end46.thread, label %while.body.4

while.body.4:                                     ; preds = %while.cond.4
  %arrayidx26.4 = getelementptr inbounds [7 x i8], ptr @height, i64 0, i64 %indvars.iv.next428.4
  ...
  %and.i.i297.4 = and i64 %or30.4, 283691315109952
  %cmp.i.i298.4 = icmp eq i64 %and.i.i297.4, 0
  br i1 %cmp.i.i298.4, label %land.rhs.i304.4, label %while.cond.5

land.rhs.i304.4:                                  ; preds = %while.body.4
  %shr.i.i299.4 = lshr i64 %or30.4, 6
  %and.i4.i300.4 = and i64 %shr.i.i299.4, %or30.4
  %shr1.i.i301.4 = lshr i64 %and.i4.i300.4, 12
  %and2.i.i302.4 = and i64 %shr1.i.i301.4, %and.i4.i300.4
  %cmp.not.i.i303.4 = icmp eq i64 %and2.i.i302.4, 0
  br i1 %cmp.not.i.i303.4, label %if.end.i.i310.4, label %cleanup

if.end.i.i310.4:                                  ; preds = %land.rhs.i304.4
  %shr3.i.i305.4 = lshr i64 %or30.4, 7
  %and4.i.i306.4 = and i64 %shr3.i.i305.4, %or30.4
  %shr5.i.i307.4 = lshr i64 %and4.i.i306.4, 14
  %and6.i.i308.4 = and i64 %shr5.i.i307.4, %and4.i.i306.4
  %cmp7.not.i.i309.4 = icmp eq i64 %and6.i.i308.4, 0
  br i1 %cmp7.not.i.i309.4, label %if.end9.i.i316.4, label %cleanup

if.end9.i.i316.4:                                 ; preds = %if.end.i.i310.4
  %shr10.i.i311.4 = lshr i64 %or30.4, 8
  %and11.i.i312.4 = and i64 %shr10.i.i311.4, %or30.4
  %shr12.i.i313.4 = lshr i64 %and11.i.i312.4, 16
  %and13.i.i314.4 = and i64 %shr12.i.i313.4, %and11.i.i312.4
  %cmp14.not.i.i315.4 = icmp eq i64 %and13.i.i314.4, 0
  br i1 %cmp14.not.i.i315.4, label %if.end16.i.i323.4, label %cleanup

if.end16.i.i323.4:                                ; preds = %if.end9.i.i316.4
  %shr17.i.i317.4 = lshr i64 %or30.4, 1
  %and18.i.i318.4 = and i64 %shr17.i.i317.4, %or30.4
  %shr19.i.i319.4 = lshr i64 %and18.i.i318.4, 2
  %and20.i.i320.4 = and i64 %shr19.i.i319.4, %and18.i.i318.4
  %cmp21.i.i321.4 = icmp eq i64 %and20.i.i320.4, 0
  br i1 %cmp21.i.i321.4, label %while.cond.5, label %cleanup, !llvm.loop !20

while.cond.5:                                     ; preds = %while.body.4, %if.end16.i.i323.4
  %exitcond430.not.5 = icmp eq i64 %indvars.iv.next428.4, 6
  br i1 %exitcond430.not.5, label %if.end46.thread, label %while.body.5

while.body.5:                                     ; preds = %while.cond.5
  %indvars.iv.next428.5 = add nuw nsw i64 %indvars.iv, 6
  %arrayidx26.5 = getelementptr inbounds [7 x i8], ptr @height, i64 0, i64 %indvars.iv.next428.5
  ...
  %and.i.i297.5 = and i64 %or30.5, 283691315109952
  %cmp.i.i298.5 = icmp eq i64 %and.i.i297.5, 0
  br i1 %cmp.i.i298.5, label %land.rhs.i304.5, label %while.cond.6

land.rhs.i304.5:                                  ; preds = %while.body.5
  %shr.i.i299.5 = lshr i64 %or30.5, 6
  %and.i4.i300.5 = and i64 %shr.i.i299.5, %or30.5
  %shr1.i.i301.5 = lshr i64 %and.i4.i300.5, 12
  %and2.i.i302.5 = and i64 %shr1.i.i301.5, %and.i4.i300.5
  %cmp.not.i.i303.5 = icmp eq i64 %and2.i.i302.5, 0
  br i1 %cmp.not.i.i303.5, label %if.end.i.i310.5, label %cleanup

if.end.i.i310.5:                                  ; preds = %land.rhs.i304.5
  %shr3.i.i305.5 = lshr i64 %or30.5, 7
  %and4.i.i306.5 = and i64 %shr3.i.i305.5, %or30.5
  %shr5.i.i307.5 = lshr i64 %and4.i.i306.5, 14
  %and6.i.i308.5 = and i64 %shr5.i.i307.5, %and4.i.i306.5
  %cmp7.not.i.i309.5 = icmp eq i64 %and6.i.i308.5, 0
  br i1 %cmp7.not.i.i309.5, label %if.end9.i.i316.5, label %cleanup

if.end9.i.i316.5:                                 ; preds = %if.end.i.i310.5
  %shr10.i.i311.5 = lshr i64 %or30.5, 8
  %and11.i.i312.5 = and i64 %shr10.i.i311.5, %or30.5
  %shr12.i.i313.5 = lshr i64 %and11.i.i312.5, 16
  %and13.i.i314.5 = and i64 %shr12.i.i313.5, %and11.i.i312.5
  %cmp14.not.i.i315.5 = icmp eq i64 %and13.i.i314.5, 0
  br i1 %cmp14.not.i.i315.5, label %if.end16.i.i323.5, label %cleanup

if.end16.i.i323.5:                                ; preds = %if.end9.i.i316.5
  %shr17.i.i317.5 = lshr i64 %or30.5, 1
  %and18.i.i318.5 = and i64 %shr17.i.i317.5, %or30.5
  %shr19.i.i319.5 = lshr i64 %and18.i.i318.5, 2
  %and20.i.i320.5 = and i64 %shr19.i.i319.5, %and18.i.i318.5
  %cmp21.i.i321.5 = icmp eq i64 %and20.i.i320.5, 0
  %exitcond430.not.6 = icmp eq i64 %indvars.iv, 0
  %or.cond489 = and i1 %cmp21.i.i321.5, %exitcond430.not.6
  br i1 %or.cond489, label %if.end46.thread, label %cleanup, !llvm.loop !20

while.cond.6:                                     ; preds = %while.body.5
  %exitcond430.not.6.old = icmp eq i64 %indvars.iv, 0
  br i1 %exitcond430.not.6.old, label %if.end46.thread, label %cleanup
...
if.then37:                                        ; preds = %if.end35
  %inc38 = add nsw i32 %nav.0401, 1
  %idxprom39 = sext i32 %nav.0401 to i64
...
for.inc:                                          ; preds = %if.end35, %if.then37, %for.body
  %nav.1 = phi i32 [ %nav.0401, %if.end35 ], [ %inc38, %if.then37 ], [ %nav.0401, %for.body ]
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
...
if.end46.thread:                                  ; preds = %if.end16.i.i323.5, %while.cond.6, %while.cond.5, %while.cond.4, %while.cond.3, %while.cond.2, %while.cond.1, %while.cond
  %cmp47391 = icmp eq i32 %1, 40
  br i1 %cmp47391, label %cleanup, label %if.then53
...
if.then53:                                        ; preds = %if.end50.if.then53_crit_edge, %if.end46.thread
  ...
  %conv.i326 = sext i8 %12 to i64
  %sh_prom.i = and i64 %conv.i326, 4294967295
  ...
  %idxprom.i328 = sext i32 %dec.i to i64
  %arrayidx.i329 = getelementptr inbounds [42 x i32], ptr @moves, i64 0, i64 %idxprom.i328
  %15 = load i32, ptr %arrayidx.i329, align 4, !tbaa !5
  %idxprom1.i330 = sext i32 %15 to i64
  %arrayidx2.i331 = getelementptr inbounds [7 x i8], ptr @height, i64 0, i64 %idxprom1.i330
  %16 = load i8, ptr %arrayidx2.i331, align 1, !tbaa !9
  %dec3.i = add i8 %16, -1
  store i8 %dec3.i, ptr %arrayidx2.i331, align 1, !tbaa !9
  %conv.i332 = sext i8 %dec3.i to i64
  %sh_prom.i333 = and i64 %conv.i332, 4294967295
  %shl.i334 = shl nuw i64 1, %sh_prom.i333
  %and.i335 = and i32 %dec.i, 1
  %idxprom4.i336 = zext i32 %and.i335 to i64
  %arrayidx5.i337 = getelementptr inbounds [2 x i64], ptr @color, i64 0, i64 %idxprom4.i336
  %17 = load i64, ptr %arrayidx5.i337, align 8, !tbaa !10
  %xor.i338 = xor i64 %shl.i334, %17
  store i64 %xor.i338, ptr %arrayidx5.i337, align 8, !tbaa !10
  br label %cleanup
...
if.end58:                                         ; preds = %if.end50
  ...
  %cmp.i.i339 = icmp slt i32 %1, 10
  br i1 %cmp.i.i339, label %for.cond.preheader.i.i, label %hash.exit.i
...
for.body.i.i:                                     ; preds = %for.cond.preheader.i.i, %for.body.i.i
  ...
  %htmp.015.i.i = phi i64 [ %shr.i.i341, %for.body.i.i ], [ %add2.i.i.i, %for.cond.preheader.i.i ]
  %shl.i.i = shl i64 %htemp2.016.i.i, 7
  %and.i.i340 = and i64 %htmp.015.i.i, 127
  %or.i.i = or i64 %and.i.i340, %shl.i.i
  %shr.i.i341 = lshr i64 %htmp.015.i.i, 7
...
hash.exit.i:                                      ; preds = %for.end.i.i, %if.end58
  ...
  %shr5.i.i342 = lshr i64 %htemp.1.i.i, 23
  %conv.i.i = trunc i64 %shr5.i.i342 to i32
  ...
  %arrayidx.i343 = getelementptr inbounds %struct.hashentry, ptr %21, i64 %rem.i.i
  %he.sroa.0.0.copyload.i = load i64, ptr %arrayidx.i343, align 4, !tbaa.struct !16
  %22 = trunc i64 %he.sroa.0.0.copyload.i to i32
  %bf.cast.i = and i32 %22, 67108863
  %cmp.i344 = icmp eq i32 %bf.cast.i, %conv.i.i
  br i1 %cmp.i344, label %if.then.i, label %if.end.i345
...
transpose.exit:                                   ; preds = %if.then.i, %if.then8.i
  %retval.0.i346 = phi i32 [ %bf.cast2.i, %if.then.i ], [ %bf.cast12.i, %if.then8.i ]
  switch i32 %retval.0.i346, label %cleanup [
...
if.end80:                                         ; preds = %if.end.i345, %transpose.exit, %if.then65, %if.then72
  %retval.0.i346396.neg = phi i32 [ 4, %if.then65 ], [ 2, %if.then72 ], [ 6, %transpose.exit ], [ 6, %if.end.i345 ]
  %beta.addr.0 = phi i32 [ 3, %if.then65 ], [ %beta, %if.then72 ], [ %beta, %transpose.exit ], [ %beta, %if.end.i345 ]
  %alpha.addr.0 = phi i32 [ %alpha, %if.then65 ], [ 3, %if.then72 ], [ %alpha, %transpose.exit ], [ %alpha, %if.end.i345 ]
  %25 = load i64, ptr @posed, align 8, !tbaa !10
  %cmp82409 = icmp sgt i32 %nav.1, 0
  br i1 %cmp82409, label %for.body84.lr.ph, label %for.end187

for.body84.lr.ph:                                 ; preds = %if.end80
  %sub129 = sub nsw i32 6, %beta.addr.0
  %26 = zext i32 %nav.1 to i64
  %wide.trip.count445 = zext i32 %nav.1 to i64
  br label %for.body84

for.body84:                                       ; preds = %for.body84.lr.ph, %for.inc185
  %indvar = phi i64 [ 0, %for.body84.lr.ph ], [ %indvar.next, %for.inc185 ]
  %27 = phi i32 [ %1, %for.body84.lr.ph ], [ %dec.i360, %for.inc185 ]
  %indvars.iv450 = phi i32 [ 0, %for.body84.lr.ph ], [ %indvars.iv.next451, %for.inc185 ]
  %indvars.iv442 = phi i64 [ 0, %for.body84.lr.ph ], [ %indvars.iv.next443, %for.inc185 ]
  %indvars.iv431 = phi i64 [ 1, %for.body84.lr.ph ], [ %indvars.iv.next432, %for.inc185 ]
  %alpha.addr.1412 = phi i32 [ %alpha.addr.0, %for.body84.lr.ph ], [ %alpha.addr.2, %for.inc185 ]
  %score.0410 = phi i32 [ 1, %for.body84.lr.ph ], [ %score.2, %for.inc185 ]
  %28 = xor i64 %indvar, -1
  %arrayidx88 = getelementptr inbounds [7 x i32], ptr %av, i64 0, i64 %indvars.iv442
  %indvars.iv.next443 = add nuw nsw i64 %indvars.iv442, 1
  %cmp95403 = icmp ult i64 %indvars.iv.next443, %26
  %29 = trunc i64 %indvars.iv442 to i32
  br i1 %cmp95403, label %for.body97.preheader, label %for.end113
...
for.body97:                                       ; preds = %for.body97.preheader, %for.body97
  %indvars.iv433 = phi i64 [ %indvars.iv431, %for.body97.preheader ], [ %indvars.iv.next434, %for.body97 ]
  %l.0405 = phi i32 [ %29, %for.body97.preheader ], [ %spec.select381, %for.body97 ]
  %val.0404 = phi i32 [ %32, %for.body97.preheader ], [ %spec.select, %for.body97 ]
  %arrayidx101 = getelementptr inbounds [7 x i32], ptr %av, i64 0, i64 %indvars.iv433
  ...
  %cmp107 = icmp sgt i32 %35, %val.0404
  %spec.select = tail call i32 @llvm.smax.i32(i32 %35, i32 %val.0404)
  %36 = trunc i64 %indvars.iv433 to i32
  %spec.select381 = select i1 %cmp107, i32 %36, i32 %l.0405
  %indvars.iv.next434 = add nuw nsw i64 %indvars.iv433, 1
  %exitcond436.not = icmp eq i64 %indvars.iv.next434, %wide.trip.count445
  br i1 %exitcond436.not, label %for.end113, label %for.body97, !llvm.loop !23

for.end113:                                       ; preds = %for.body97, %for.body84
  %l.0.lcssa = phi i32 [ %29, %for.body84 ], [ %spec.select381, %for.body97 ]
  ...
  %cmp117407 = icmp slt i64 %indvars.iv442, %idxprom114
  br i1 %cmp117407, label %for.body119.preheader, label %for.end126
...
for.body119.prol:                                 ; preds = %for.body119.preheader, %for.body119.prol
  %indvars.iv439.prol = phi i64 [ %indvars.iv.next440.prol, %for.body119.prol ], [ %idxprom114, %for.body119.preheader ]
  ...
  %arrayidx122.prol = getelementptr inbounds [7 x i32], ptr %av, i64 0, i64 %indvars.iv.next440.prol
  %40 = load i32, ptr %arrayidx122.prol, align 4, !tbaa !5
  %arrayidx124.prol = getelementptr inbounds [7 x i32], ptr %av, i64 0, i64 %indvars.iv439.prol
...
for.body119.prol.loopexit:                        ; preds = %for.body119.prol, %for.body119.preheader
  %indvars.iv439.unr = phi i64 [ %idxprom114, %for.body119.preheader ], [ %indvars.iv.next440.prol, %for.body119.prol ]
  %41 = icmp ult i64 %39, 3
  br i1 %41, label %for.end126, label %for.body119

for.body119:                                      ; preds = %for.body119.prol.loopexit, %for.body119
  %indvars.iv439 = phi i64 [ %indvars.iv.next440.3, %for.body119 ], [ %indvars.iv439.unr, %for.body119.prol.loopexit ]
  %indvars.iv.next440 = add nsw i64 %indvars.iv439, -1
  %arrayidx122 = getelementptr inbounds [7 x i32], ptr %av, i64 0, i64 %indvars.iv.next440
  %42 = load i32, ptr %arrayidx122, align 4, !tbaa !5
  %arrayidx124 = getelementptr inbounds [7 x i32], ptr %av, i64 0, i64 %indvars.iv439
  store i32 %42, ptr %arrayidx124, align 4, !tbaa !5
  %indvars.iv.next440.1 = add nsw i64 %indvars.iv439, -2
  %arrayidx122.1 = getelementptr inbounds [7 x i32], ptr %av, i64 0, i64 %indvars.iv.next440.1
  %43 = load i32, ptr %arrayidx122.1, align 4, !tbaa !5
  %arrayidx124.1 = getelementptr inbounds [7 x i32], ptr %av, i64 0, i64 %indvars.iv.next440
  store i32 %43, ptr %arrayidx124.1, align 4, !tbaa !5
  %indvars.iv.next440.2 = add nsw i64 %indvars.iv439, -3
  %arrayidx122.2 = getelementptr inbounds [7 x i32], ptr %av, i64 0, i64 %indvars.iv.next440.2
  %44 = load i32, ptr %arrayidx122.2, align 4, !tbaa !5
  %arrayidx124.2 = getelementptr inbounds [7 x i32], ptr %av, i64 0, i64 %indvars.iv.next440.1
  store i32 %44, ptr %arrayidx124.2, align 4, !tbaa !5
  %indvars.iv.next440.3 = add nsw i64 %indvars.iv439, -4
  %arrayidx122.3 = getelementptr inbounds [7 x i32], ptr %av, i64 0, i64 %indvars.iv.next440.3
  %45 = load i32, ptr %arrayidx122.3, align 4, !tbaa !5
  %arrayidx124.3 = getelementptr inbounds [7 x i32], ptr %av, i64 0, i64 %indvars.iv.next440.2
  store i32 %45, ptr %arrayidx124.3, align 4, !tbaa !5
  %cmp117.3 = icmp sgt i64 %indvars.iv.next440.3, %indvars.iv442
...
for.end126:                                       ; preds = %for.body119.prol.loopexit, %for.body119, %for.end113
  ...
  %idxprom.i347 = sext i32 %37 to i64
  %arrayidx.i348 = getelementptr inbounds [7 x i8], ptr @height, i64 0, i64 %idxprom.i347
  %46 = load i8, ptr %arrayidx.i348, align 1, !tbaa !9
  %inc.i349 = add i8 %46, 1
  store i8 %inc.i349, ptr %arrayidx.i348, align 1, !tbaa !9
  %conv.i350 = sext i8 %46 to i64
  %sh_prom.i351 = and i64 %conv.i350, 4294967295
  %shl.i352 = shl nuw i64 1, %sh_prom.i351
  %and.i353 = and i32 %27, 1
  %idxprom1.i354 = zext i32 %and.i353 to i64
  %arrayidx2.i355 = getelementptr inbounds [2 x i64], ptr @color, i64 0, i64 %idxprom1.i354
  %47 = load i64, ptr %arrayidx2.i355, align 8, !tbaa !10
  %xor.i356 = xor i64 %47, %shl.i352
  store i64 %xor.i356, ptr %arrayidx2.i355, align 8, !tbaa !10
  %inc3.i357 = add nsw i32 %27, 1
  store i32 %inc3.i357, ptr @nplies, align 4, !tbaa !5
  %idxprom4.i358 = sext i32 %27 to i64
  %arrayidx5.i359 = getelementptr inbounds [42 x i32], ptr @moves, i64 0, i64 %idxprom4.i358
  store i32 %37, ptr %arrayidx5.i359, align 4, !tbaa !5
  %sub130 = sub nsw i32 6, %alpha.addr.1412
  ...
  %dec.i360 = add nsw i32 %48, -1
  store i32 %dec.i360, ptr @nplies, align 4, !tbaa !5
  %idxprom.i361 = sext i32 %dec.i360 to i64
  %arrayidx.i362 = getelementptr inbounds [42 x i32], ptr @moves, i64 0, i64 %idxprom.i361
  %49 = load i32, ptr %arrayidx.i362, align 4, !tbaa !5
  %idxprom1.i363 = sext i32 %49 to i64
  %arrayidx2.i364 = getelementptr inbounds [7 x i8], ptr @height, i64 0, i64 %idxprom1.i363
  %50 = load i8, ptr %arrayidx2.i364, align 1, !tbaa !9
  %dec3.i365 = add i8 %50, -1
  store i8 %dec3.i365, ptr %arrayidx2.i364, align 1, !tbaa !9
  %conv.i366 = sext i8 %dec3.i365 to i64
  %sh_prom.i367 = and i64 %conv.i366, 4294967295
  %shl.i368 = shl nuw i64 1, %sh_prom.i367
  %and.i369 = and i32 %dec.i360, 1
  %idxprom4.i370 = zext i32 %and.i369 to i64
  %arrayidx5.i371 = getelementptr inbounds [2 x i64], ptr @color, i64 0, i64 %idxprom4.i370
  %51 = load i64, ptr %arrayidx5.i371, align 8, !tbaa !10
  %xor.i372 = xor i64 %shl.i368, %51
  store i64 %xor.i372, ptr %arrayidx5.i371, align 8, !tbaa !10
  %cmp133 = icmp sgt i32 %sub132, %score.0410
  br i1 %cmp133, label %if.then135, label %for.inc185

if.then135:                                       ; preds = %for.end126
  %cmp136 = icmp sgt i32 %sub132, %alpha.addr.1412
...
if.then143:                                       ; preds = %land.lhs.true140
  %arrayidx.i348.le = getelementptr inbounds [7 x i8], ptr @height, i64 0, i64 %idxprom.i347
  %cmp144 = icmp eq i32 %call131, 3
  %sub147 = add nsw i32 %nav.1, -1
  %cmp148 = icmp sgt i32 %sub147, %29
  %spec.select382 = select i1 %cmp148, i32 4, i32 3
  %score.1 = select i1 %cmp144, i32 %spec.select382, i32 %sub132
...
for.body158.preheader:                            ; preds = %if.then143
  %wide.trip.count453 = zext i32 %indvars.iv450 to i64
  %xtraiter479 = and i64 %wide.trip.count453, 1
  %52 = icmp eq i32 %indvars.iv450, 1
  br i1 %52, label %for.end171.unr-lcssa, label %for.body158.preheader.new

for.body158.preheader.new:                        ; preds = %for.body158.preheader
  %unroll_iter = and i64 %wide.trip.count453, 2147483646
  br label %for.body158

for.body158:                                      ; preds = %for.body158, %for.body158.preheader.new
  %indvars.iv447 = phi i64 [ 0, %for.body158.preheader.new ], [ %indvars.iv.next448.1, %for.body158 ]
  %niter = phi i64 [ 0, %for.body158.preheader.new ], [ %niter.next.1, %for.body158 ]
  %arrayidx162 = getelementptr inbounds [7 x i32], ptr %av, i64 0, i64 %indvars.iv447
  ...
  %arrayidx162.1 = getelementptr inbounds [7 x i32], ptr %av, i64 0, i64 %indvars.iv.next448
  ...
  %indvars.iv.next448.1 = add nuw nsw i64 %indvars.iv447, 2
...
for.end171.unr-lcssa:                             ; preds = %for.body158, %for.body158.preheader
  %indvars.iv447.unr = phi i64 [ 0, %for.body158.preheader ], [ %indvars.iv.next448.1, %for.body158 ]
  %lcmp.mod480.not = icmp eq i64 %xtraiter479, 0
  br i1 %lcmp.mod480.not, label %for.end171, label %for.body158.epil

for.body158.epil:                                 ; preds = %for.end171.unr-lcssa
  %arrayidx162.epil = getelementptr inbounds [7 x i32], ptr %av, i64 0, i64 %indvars.iv447.unr
...
for.end171:                                       ; preds = %for.end171.unr-lcssa, %for.body158.epil
  %62 = load i8, ptr %arrayidx.i348.le, align 1, !tbaa !9
...
for.inc185:                                       ; preds = %for.end126, %land.lhs.true140, %if.then135
  %score.2 = phi i32 [ %sub132, %land.lhs.true140 ], [ %sub132, %if.then135 ], [ %score.0410, %for.end126 ]
  %alpha.addr.2 = phi i32 [ %sub132, %land.lhs.true140 ], [ %alpha.addr.1412, %if.then135 ], [ %alpha.addr.1412, %for.end126 ]
  %indvars.iv.next432 = add nuw nsw i64 %indvars.iv431, 1
  %exitcond446.not = icmp eq i64 %indvars.iv.next443, %wide.trip.count445
  %indvars.iv.next451 = add nuw nsw i32 %indvars.iv450, 1
  %indvar.next = add i64 %indvar, 1
  br i1 %exitcond446.not, label %for.end187, label %for.body84, !llvm.loop !28

for.end187:                                       ; preds = %for.inc185, %if.end80, %if.then143, %for.end171
  %64 = phi i32 [ %dec.i360, %for.end171 ], [ %dec.i360, %if.then143 ], [ %1, %if.end80 ], [ %dec.i360, %for.inc185 ]
  %score.3 = phi i32 [ %score.1, %for.end171 ], [ %score.1, %if.then143 ], [ 1, %if.end80 ], [ %score.2, %for.inc185 ]
  %cmp189 = icmp eq i32 %score.3, %retval.0.i346396.neg
  %spec.store.select = select i1 %cmp189, i32 3, i32 %score.3
  %65 = load i64, ptr @posed, align 8, !tbaa !10
  %sub193 = sub i64 %65, %25
  %cmp195.not416 = icmp ult i64 %sub193, 2
  br i1 %cmp195.not416, label %for.end200, label %for.inc198

for.inc198:                                       ; preds = %for.end187, %for.inc198
  %poscnt.0418 = phi i64 [ %shr, %for.inc198 ], [ %sub193, %for.end187 ]
  %work.0417 = phi i32 [ %inc199, %for.inc198 ], [ 0, %for.end187 ]
  %shr = lshr i64 %poscnt.0418, 1
  %inc199 = add nuw nsw i32 %work.0417, 1
  %cmp195.not = icmp ult i64 %poscnt.0418, 4
...
for.end200:                                       ; preds = %for.inc198, %for.end187
  ...
  %inc.i373 = add i64 %65, 1
  store i64 %inc.i373, ptr @posed, align 8, !tbaa !10
  %66 = load ptr, ptr @ht, align 8, !tbaa !14
  %arrayidx.i375 = getelementptr inbounds %struct.hashentry, ptr %66, i64 %rem.i.i
  %he.sroa.0.0.copyload.i376 = load i64, ptr %arrayidx.i375, align 4, !tbaa.struct !16
  %67 = trunc i64 %he.sroa.0.0.copyload.i376 to i32
  %bf.cast.i377 = and i32 %67, 67108863
  %cmp.i378 = icmp ne i32 %bf.cast.i377, %conv.i.i
  %68 = lshr i32 %67, 26
  %cmp4.not.i = icmp ugt i32 %68, %work.0.lcssa
  %or.cond.i = and i1 %cmp.i378, %cmp4.not.i
  br i1 %or.cond.i, label %if.else.i, label %if.then.i379

if.then.i379:                                     ; preds = %for.end200
  %bf.clear6.i = and i64 %he.sroa.0.0.copyload.i376, 2305843004918726656
  ...
  %bf.value.masked.i = and i64 %shr5.i.i342, 67108863
...
if.else.i:                                        ; preds = %for.end200
  %bf.value19.i = shl i64 %shr5.i.i342, 32
  %bf.shl20.i = and i64 %bf.value19.i, 288230371856744448
  %bf.clear21.i = and i64 %he.sroa.0.0.copyload.i376, -2305843004918726657
...
transtore.exit:                                   ; preds = %if.then.i379, %if.else.i
  %he.sroa.0.0.i = phi i64 [ %bf.set16.i, %if.then.i379 ], [ %bf.set28.i, %if.else.i ]
  store i64 %he.sroa.0.0.i, ptr %arrayidx.i375, align 4, !tbaa.struct !16
...
cleanup:                                          ; preds = %while.cond.6, %if.end9.i.i316, %if.end.i.i310, %land.rhs.i304, %islegalhaswon.exit325, %land.rhs.i304.1, %if.end.i.i310.1, %if.end9.i.i316.1, %islegalhaswon.exit325.1, %land.rhs.i304.2, %if.end.i.i310.2, %if.end9.i.i316.2, %islegalhaswon.exit325.2, %land.rhs.i304.3, %if.end.i.i310.3, %if.end9.i.i316.3, %if.end16.i.i323.3, %land.rhs.i304.4, %if.end.i.i310.4, %if.end9.i.i316.4, %if.end16.i.i323.4, %land.rhs.i304.5, %if.end.i.i310.5, %if.end9.i.i316.5, %if.end16.i.i323.5, %if.end46.thread, %transtore.exit, %if.then203, %transpose.exit, %if.then72, %if.then65, %if.end46, %for.end, %if.then15, %entry, %if.then53
  %retval.0 = phi i32 [ %sub57, %if.then53 ], [ 3, %entry ], [ 1, %if.then15 ], [ 1, %for.end ], [ 3, %if.end46 ], [ 2, %if.then65 ], [ 4, %if.then72 ], [ %retval.0.i346, %transpose.exit ], [ %spec.store.select, %if.then203 ], [ %spec.store.select, %transtore.exit ], [ 3, %if.end46.thread ], [ 1, %if.end16.i.i323.5 ], [ 1, %if.end9.i.i316.5 ], [ 1, %if.end.i.i310.5 ], [ 1, %land.rhs.i304.5 ], [ 1, %if.end16.i.i323.4 ], [ 1, %if.end9.i.i316.4 ], [ 1, %if.end.i.i310.4 ], [ 1, %land.rhs.i304.4 ], [ 1, %if.end16.i.i323.3 ], [ 1, %if.end9.i.i316.3 ], [ 1, %if.end.i.i310.3 ], [ 1, %land.rhs.i304.3 ], [ 1, %islegalhaswon.exit325.2 ], [ 1, %if.end9.i.i316.2 ], [ 1, %if.end.i.i310.2 ], [ 1, %land.rhs.i304.2 ], [ 1, %islegalhaswon.exit325.1 ], [ 1, %if.end9.i.i316.1 ], [ 1, %if.end.i.i310.1 ], [ 1, %land.rhs.i304.1 ], [ 1, %islegalhaswon.exit325 ], [ 1, %land.rhs.i304 ], [ 1, %if.end.i.i310 ], [ 1, %if.end9.i.i316 ], [ 1, %while.cond.6 ]
...
if.end9.i:                                        ; preds = %if.end.i
  ...
  %and13.i = and i64 %shr12.i, %and11.i
  %cmp14.not.i = icmp eq i64 %and13.i, 0
  br i1 %cmp14.not.i, label %if.end16.i, label %cleanup
...
if.end16.i:                                       ; preds = %if.end9.i
  ...
  br i1 %cmp21.i, label %for.cond.preheader, label %cleanup

for.cond.preheader:                               ; preds = %if.end16.i
  %idxprom1 = zext i32 %and to i64
  %arrayidx2 = getelementptr inbounds [2 x i64], ptr @color, i64 0, i64 %idxprom1
  %2 = load i64, ptr %arrayidx2, align 8, !tbaa !10
...
for.inc:                                          ; preds = %for.cond.preheader, %islegalhaswon.exit
  ...
  %cmp.i.i.1 = icmp eq i64 %and.i.i.1, 0
  br i1 %cmp.i.i.1, label %land.rhs.i.1, label %for.inc.1
...
for.inc.1:                                        ; preds = %islegalhaswon.exit.1, %for.inc
  ...
  %cmp.i.i.2 = icmp eq i64 %and.i.i.2, 0
  br i1 %cmp.i.i.2, label %land.rhs.i.2, label %for.inc.2
...
for.inc.2:                                        ; preds = %islegalhaswon.exit.2, %for.inc.1
  ...
  %cmp.i.i.3 = icmp eq i64 %and.i.i.3, 0
  br i1 %cmp.i.i.3, label %land.rhs.i.3, label %for.inc.3
...
for.inc.3:                                        ; preds = %islegalhaswon.exit.3, %for.inc.2
  ...
  %cmp.i.i.4 = icmp eq i64 %and.i.i.4, 0
  br i1 %cmp.i.i.4, label %land.rhs.i.4, label %for.inc.4
...
for.inc.4:                                        ; preds = %islegalhaswon.exit.4, %for.inc.3
  ...
  %cmp.i.i.5 = icmp eq i64 %and.i.i.5, 0
  br i1 %cmp.i.i.5, label %land.rhs.i.5, label %for.inc.5
...
for.inc.5:                                        ; preds = %islegalhaswon.exit.5, %for.inc.4
  ...
  %cmp.i.i.6 = icmp eq i64 %and.i.i.6, 0
  br i1 %cmp.i.i.6, label %land.rhs.i.6, label %for.inc.6
...
entry:
  ...
  %call.i253339 = tail call i32 @getc(ptr noundef %0)
  %cond3440 = icmp eq i32 %call.i253339, -1
  br i1 %cond3440, label %for.end18, label %while.body

while.body:                                       ; preds = %entry, %while.body.backedge
  %call.i2535 = phi i32 [ %call.i2535.be, %while.body.backedge ], [ %call.i253339, %entry ]
  %1 = add i32 %call.i2535, -49
...
if.else:                                          ; preds = %while.body
  %cond32 = icmp eq i32 %call.i2535, 10
  br i1 %cond32, label %if.end11, label %if.end8

if.end8:                                          ; preds = %if.else, %if.then
  %5 = load ptr, ptr @stdin, align 8, !tbaa !14
  %call.i25 = tail call i32 @getc(ptr noundef %5)
  %cond = icmp eq i32 %call.i25, -1
  br i1 %cond, label %for.end18, label %while.body.backedge

while.body.backedge:                              ; preds = %if.end8, %for.end
  %call.i2535.be = phi i32 [ %call.i25, %if.end8 ], [ %call.i2533, %for.end ]
...
for.body.i:                                       ; preds = %if.end11, %for.body.i
  ...
  %arrayidx.i26 = getelementptr inbounds [42 x i32], ptr @moves, i64 0, i64 %indvars.iv.i
  %8 = load i32, ptr %arrayidx.i26, align 4, !tbaa !5
  %add.i = add nsw i32 %8, 1
  %call.i27 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %add.i)
...
for.body.i31:                                     ; preds = %for.body.i31.1, %printMoves.exit
  %indvars.iv.i28 = phi i64 [ 0, %printMoves.exit ], [ %indvars.iv.next.i30.3, %for.body.i31.1 ]
  %11 = load ptr, ptr @ht, align 8, !tbaa !14
  %arrayidx.i29 = getelementptr inbounds %struct.hashentry, ptr %11, i64 %indvars.iv.i28
  store i64 0, ptr %arrayidx.i29, align 4, !tbaa.struct !16
  %indvars.iv.next.i30 = or i64 %indvars.iv.i28, 1
  %exitcond.not.i = icmp eq i64 %indvars.iv.next.i30, 8306069
  br i1 %exitcond.not.i, label %emptyTT.exit, label %for.body.i31.1, !llvm.loop !17

for.body.i31.1:                                   ; preds = %for.body.i31
  %12 = load ptr, ptr @ht, align 8, !tbaa !14
  %arrayidx.i29.1 = getelementptr inbounds %struct.hashentry, ptr %12, i64 %indvars.iv.next.i30
  store i64 0, ptr %arrayidx.i29.1, align 4, !tbaa.struct !16
  %indvars.iv.next.i30.1 = or i64 %indvars.iv.i28, 2
  %13 = load ptr, ptr @ht, align 8, !tbaa !14
  %arrayidx.i29.2 = getelementptr inbounds %struct.hashentry, ptr %13, i64 %indvars.iv.next.i30.1
  store i64 0, ptr %arrayidx.i29.2, align 4, !tbaa.struct !16
  %indvars.iv.next.i30.2 = or i64 %indvars.iv.i28, 3
  %14 = load ptr, ptr @ht, align 8, !tbaa !14
  %arrayidx.i29.3 = getelementptr inbounds %struct.hashentry, ptr %14, i64 %indvars.iv.next.i30.2
  store i64 0, ptr %arrayidx.i29.3, align 4, !tbaa.struct !16
  %indvars.iv.next.i30.3 = add nuw nsw i64 %indvars.iv.i28, 4
  br label %for.body.i31

emptyTT.exit:                                     ; preds = %for.body.i31
  store i64 0, ptr @posed, align 8, !tbaa !10
...
for.end:                                          ; preds = %for.inc, %emptyTT.exit
  ...
  %call.i2533 = tail call i32 @getc(ptr noundef %17)
  %cond34 = icmp eq i32 %call.i2533, -1
