...
for.cond.preheader:                               ; preds = %yyreduce
  ...
  %cmp.i1749.not1935 = icmp eq ptr %13, null
  br i1 %cmp.i1749.not1935, label %sw.epilog929, label %for.body
...
if.then617:                                       ; preds = %sw.bb613
  ...
  %.pre2018 = load ptr, ptr %arrayidx614, align 8
  br label %if.end619

if.end619:                                        ; preds = %if.then617, %sw.bb613
  %188 = phi ptr [ %.pre2018, %if.then617 ], [ %183, %sw.bb613 ]
...
cond.end985:                                      ; preds = %if.then976, %cond.true980
  ...
  %cmp9951936 = icmp slt i32 %cond993, 172
  br i1 %cmp9951936, label %for.body997.preheader, label %for.end1017
...
for.body997:                                      ; preds = %for.body997.preheader, %for.inc1015
  ...
  %yycount.01939 = phi i32 [ 0, %for.body997.preheader ], [ %yycount.1, %for.inc1015 ]
  %yysize977.01937 = phi i64 [ 0, %for.body997.preheader ], [ %yysize977.1, %for.inc1015 ]
...
if.then1007:                                      ; preds = %for.body997
  ...
  %add1011 = add i64 %yysize977.01937, 15
  %add1012 = add i64 %add1011, %call1010
  %inc1013 = add nsw i32 %yycount.01939, 1
  br label %for.inc1015

for.inc1015:                                      ; preds = %for.body997, %if.then1007
  %yysize977.1 = phi i64 [ %add1012, %if.then1007 ], [ %yysize977.01937, %for.body997 ]
  %yycount.1 = phi i32 [ %inc1013, %if.then1007 ], [ %yycount.01939, %for.body997 ]
...
yystpcpy.exit1809:                                ; preds = %while.cond.i1808
  ...
  %or.cond1945 = and i1 %cmp1030, %cmp9951936
  br i1 %or.cond1945, label %for.body1043.preheader, label %if.end1066
...
for.body1043:                                     ; preds = %for.body1043.preheader, %for.inc1063
  %indvars.iv2013 = phi i64 [ %321, %for.body1043.preheader ], [ %indvars.iv.next2014, %for.inc1063 ]
  %yyp.01944 = phi ptr [ %yyd.0.i1803, %for.body1043.preheader ], [ %yyp.1, %for.inc1063 ]
  %yycount.21943 = phi i32 [ 0, %for.body1043.preheader ], [ %yycount.3, %for.inc1063 ]
  %323 = add nsw i64 %indvars.iv2013, %322
...
while.cond.i1815:                                 ; preds = %while.cond.i1815, %if.then1053
  %yyd.0.i1810 = phi ptr [ %yyp.01944, %if.then1053 ], [ %incdec.ptr1.i1813, %while.cond.i1815 ]
...
yystpcpy.exit1816:                                ; preds = %while.cond.i1815
  %arrayidx1059 = getelementptr inbounds [172 x ptr], ptr @yytname, i64 0, i64 %indvars.iv2013
...
yystpcpy.exit1823:                                ; preds = %while.cond.i1822
  %inc1061 = add nsw i32 %yycount.21943, 1
  br label %for.inc1063

for.inc1063:                                      ; preds = %for.body1043, %yystpcpy.exit1823
  %yycount.3 = phi i32 [ %inc1061, %yystpcpy.exit1823 ], [ %yycount.21943, %for.body1043 ]
  %yyp.1 = phi ptr [ %yyd.0.i1817, %yystpcpy.exit1823 ], [ %yyp.01944, %for.body1043 ]
  %indvars.iv.next2014 = add nsw i64 %indvars.iv2013, 1
  %cmp1041 = icmp slt i64 %indvars.iv2013, 171
