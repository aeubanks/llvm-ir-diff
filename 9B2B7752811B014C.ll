...
for.body.lr.ph.i:                                 ; preds = %invoke.cont5
  ...
  %10 = lshr exact i64 %sub.ptr.sub.i.i635, 2
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  store <4 x i32> %broadcast.splat1169, ptr %12, align 4, !tbaa !5
  %index.next = add nuw i64 %index, 8
  %13 = icmp eq i64 %index.next, %n.vec
  br i1 %13, label %middle.block, label %vector.body, !llvm.loop !79
...
for.cond.preheader:                               ; preds = %if.end
  %14 = load i64, ptr %ncells, align 8, !tbaa !9
  %cmp964.not = icmp eq i64 %14, 0
  br i1 %cmp964.not, label %sw.epilog.invoke, label %for.body.lr.ph

for.body.lr.ph:                                   ; preds = %for.cond.preheader
  %15 = load ptr, ptr %z_order, align 8, !tbaa !78
  br label %for.body

for.body:                                         ; preds = %for.body.lr.ph, %for.body
  %conv966 = phi i64 [ 0, %for.body.lr.ph ], [ %conv, %for.body ]
  %indvars1062 = trunc i64 %conv966 to i32
  %add.ptr.i637 = getelementptr inbounds i32, ptr %15, i64 %conv966
...
sw.bb12:                                          ; preds = %if.end
  ...
  %17 = load ptr, ptr %_M_finish.i, align 8, !tbaa !86
  %18 = load ptr, ptr %x, align 8, !tbaa !87
  %sub.ptr.lhs.cast.i = ptrtoint ptr %17 to i64
  %sub.ptr.rhs.cast.i = ptrtoint ptr %18 to i64
  %sub.ptr.sub.i = sub i64 %sub.ptr.lhs.cast.i, %sub.ptr.rhs.cast.i
  %sub.ptr.div.i = ashr exact i64 %sub.ptr.sub.i, 3
  %19 = load i64, ptr %ncells, align 8, !tbaa !9
  %cmp15 = icmp ult i64 %sub.ptr.div.i, %19
...
invoke.cont19:                                    ; preds = %if.end18
  %20 = load i64, ptr %ncells, align 8, !tbaa !9
  ...
  %21 = load ptr, ptr %_M_finish.i.i638, align 8, !tbaa !86
  %22 = load ptr, ptr %iunit, align 8, !tbaa !87
  %sub.ptr.lhs.cast.i.i639 = ptrtoint ptr %21 to i64
  %sub.ptr.rhs.cast.i.i640 = ptrtoint ptr %22 to i64
...
if.else.i647:                                     ; preds = %invoke.cont19
  %cmp4.i646 = icmp ult i64 %20, %sub.ptr.div.i.i642
  br i1 %cmp4.i646, label %if.then5.i650, label %invoke.cont21

if.then5.i650:                                    ; preds = %if.else.i647
  %add.ptr.i648 = getelementptr inbounds double, ptr %22, i64 %20
  %tobool.not.i.i649 = icmp eq ptr %21, %add.ptr.i648
...
invoke.cont21:                                    ; preds = %if.then.i645.invoke.cont21_crit_edge, %invoke.cont.i.i651, %if.then5.i650, %if.else.i647
  %23 = phi i64 [ %.pre1066, %if.then.i645.invoke.cont21_crit_edge ], [ %20, %invoke.cont.i.i651 ], [ %20, %if.then5.i650 ], [ %20, %if.else.i647 ]
  ...
  %24 = load ptr, ptr %_M_finish.i.i653, align 8, !tbaa !86
  %25 = load ptr, ptr %junit, align 8, !tbaa !87
  %sub.ptr.lhs.cast.i.i654 = ptrtoint ptr %24 to i64
  %sub.ptr.rhs.cast.i.i655 = ptrtoint ptr %25 to i64
...
if.else.i662:                                     ; preds = %invoke.cont21
  %cmp4.i661 = icmp ult i64 %23, %sub.ptr.div.i.i657
  br i1 %cmp4.i661, label %if.then5.i665, label %invoke.cont23

if.then5.i665:                                    ; preds = %if.else.i662
  %add.ptr.i663 = getelementptr inbounds double, ptr %25, i64 %23
  %tobool.not.i.i664 = icmp eq ptr %24, %add.ptr.i663
...
for.body32:                                       ; preds = %for.body32.lr.ph, %for.body32
  ...
  %add.ptr.i669 = getelementptr inbounds double, ptr %31, i64 %conv28941
  %37 = load double, ptr %add.ptr.i669, align 8, !tbaa !41
  %add.ptr.i670 = getelementptr inbounds double, ptr %32, i64 %conv28941
  %38 = load double, ptr %add.ptr.i670, align 8, !tbaa !41
  %mul = fmul double %38, 5.000000e-01
  %add38 = fadd double %37, %mul
  %39 = load double, ptr %xcentermin, align 8, !tbaa !89
  %sub40 = fsub double %add38, %39
  %mul41 = fmul double %div, %sub40
  %add.ptr.i671 = getelementptr inbounds double, ptr %33, i64 %conv28941
  store double %mul41, ptr %add.ptr.i671, align 8, !tbaa !41
  %add.ptr.i672 = getelementptr inbounds double, ptr %34, i64 %conv28941
  %40 = load double, ptr %add.ptr.i672, align 8, !tbaa !41
  %add.ptr.i673 = getelementptr inbounds double, ptr %35, i64 %conv28941
  %41 = load double, ptr %add.ptr.i673, align 8, !tbaa !41
  %mul48 = fmul double %41, 5.000000e-01
  %add49 = fadd double %40, %mul48
  %42 = load double, ptr %ycentermin, align 8, !tbaa !91
  %sub51 = fsub double %add49, %42
  %mul52 = fmul double %div25, %sub51
  %add.ptr.i674 = getelementptr inbounds double, ptr %36, i64 %conv28941
  store double %mul52, ptr %add.ptr.i674, align 8, !tbaa !41
  %inc56 = add nuw nsw i64 %conv28941, 1
  %conv28 = and i64 %inc56, 4294967295
  %cmp30 = icmp ugt i64 %26, %conv28
  br i1 %cmp30, label %for.body32, label %for.cond.cleanup31, !llvm.loop !92

if.then59:                                        ; preds = %for.cond.cleanup31
  %43 = load ptr, ptr %x, align 8, !tbaa !87
  %44 = load ptr, ptr %_M_finish.i, align 8, !tbaa !86
  %tobool.not.i.i676 = icmp eq ptr %44, %43
...
invoke.cont.i.i677:                               ; preds = %if.then59
  store ptr %43, ptr %_M_finish.i, align 8, !tbaa !86
...
_ZNSt6vectorIdSaIdEE5clearEv.exit:                ; preds = %if.then59, %invoke.cont.i.i677
  ...
  %45 = load ptr, ptr %dx61, align 8, !tbaa !87
  %_M_finish.i.i678 = getelementptr inbounds %class.Mesh, ptr %this, i64 0, i32 76, i32 0, i32 0, i32 0, i32 1
  %46 = load ptr, ptr %_M_finish.i.i678, align 8, !tbaa !86
  %tobool.not.i.i679 = icmp eq ptr %46, %45
...
invoke.cont.i.i680:                               ; preds = %_ZNSt6vectorIdSaIdEE5clearEv.exit
  store ptr %45, ptr %_M_finish.i.i678, align 8, !tbaa !86
...
_ZNSt6vectorIdSaIdEE5clearEv.exit681:             ; preds = %_ZNSt6vectorIdSaIdEE5clearEv.exit, %invoke.cont.i.i680
  ...
  %47 = load ptr, ptr %y62, align 8, !tbaa !87
  %_M_finish.i.i682 = getelementptr inbounds %class.Mesh, ptr %this, i64 0, i32 77, i32 0, i32 0, i32 0, i32 1
  %48 = load ptr, ptr %_M_finish.i.i682, align 8, !tbaa !86
  %tobool.not.i.i683 = icmp eq ptr %48, %47
...
invoke.cont.i.i684:                               ; preds = %_ZNSt6vectorIdSaIdEE5clearEv.exit681
  store ptr %47, ptr %_M_finish.i.i682, align 8, !tbaa !86
...
_ZNSt6vectorIdSaIdEE5clearEv.exit685:             ; preds = %_ZNSt6vectorIdSaIdEE5clearEv.exit681, %invoke.cont.i.i684
  ...
  %49 = load ptr, ptr %dy63, align 8, !tbaa !87
  %_M_finish.i.i686 = getelementptr inbounds %class.Mesh, ptr %this, i64 0, i32 78, i32 0, i32 0, i32 0, i32 1
  %50 = load ptr, ptr %_M_finish.i.i686, align 8, !tbaa !86
  %tobool.not.i.i687 = icmp eq ptr %50, %49
...
invoke.cont.i.i688:                               ; preds = %_ZNSt6vectorIdSaIdEE5clearEv.exit685
  store ptr %49, ptr %_M_finish.i.i686, align 8, !tbaa !86
  br label %if.end64

if.end64:                                         ; preds = %invoke.cont.i.i688, %_ZNSt6vectorIdSaIdEE5clearEv.exit685, %for.cond.cleanup31
  %51 = load i32, ptr %parallel, align 4, !tbaa !76
...
if.else68:                                        ; preds = %if.end64
  ...
  %52 = load ptr, ptr %iunit, align 8, !tbaa !87
  %53 = load ptr, ptr %junit, align 8, !tbaa !87
  invoke void @hsfc2sort(i32 noundef %conv73, ptr noundef %52, ptr noundef %53, i32 noundef 0, ptr noundef %call71, i32 noundef 1)
          to label %for.cond78.preheader unwind label %lpad9

for.cond78.preheader:                             ; preds = %if.else68
  %54 = load i64, ptr %ncells, align 8, !tbaa !9
  %cmp81943.not = icmp eq i64 %54, 0
...
for.body83.lr.ph:                                 ; preds = %for.cond78.preheader
  %55 = load ptr, ptr %z_order, align 8, !tbaa !78
  br label %for.body83

for.cond.cleanup82:                               ; preds = %for.body83
  call void @free(ptr noundef nonnull %call71) #19
  %cmp.i.i = icmp ugt i64 %54, 2305843009213693951
...
if.then.i.i.i.i.i:                                ; preds = %for.cond.cleanup82
  %mul.i.i.i.i.i.i = shl nuw nsw i64 %54, 2
...
call5.i.i.i.i4.i.i.noexc:                         ; preds = %if.then.i.i.i.i.i
  ...
  %cmp.i.i.i.i.i.i.i = icmp eq i64 %54, 1
...
if.end.i.i.i.i.i.i.i:                             ; preds = %call5.i.i.i.i4.i.i.noexc
  ...
  %56 = add nsw i64 %mul.i.i.i.i.i.i, -4
  call void @llvm.memset.p0.i64(ptr align 4 %incdec.ptr.i.i.i.i.i, i8 0, i64 %56, i1 false), !tbaa !5
  br label %invoke.cont93
...
for.body83:                                       ; preds = %for.body83.lr.ph, %for.body83
  ...
  %57 = load i32, ptr %arrayidx84, align 4, !tbaa !5
  %add.ptr.i692 = getelementptr inbounds i32, ptr %55, i64 %conv79945
  store i32 %57, ptr %add.ptr.i692, align 4, !tbaa !5
  %inc88 = add nuw nsw i64 %conv79945, 1
  %conv79 = and i64 %inc88, 4294967295
  %cmp81 = icmp ugt i64 %54, %conv79
...
invoke.cont93:                                    ; preds = %_ZNSt6vectorIiSaIiEE17_S_check_init_lenEmRKS0_.exit.i.thread, %if.end.i.i.i.i.i.i.i, %call5.i.i.i.i4.i.i.noexc
  ...
  %nlft = getelementptr inbounds %class.Mesh, ptr %this, i64 0, i32 69
  %58 = load ptr, ptr %nlft, align 8, !tbaa !50
...
invoke.cont95:                                    ; preds = %invoke.cont93
  %nrht = getelementptr inbounds %class.Mesh, ptr %this, i64 0, i32 70
  %59 = load ptr, ptr %nrht, align 8, !tbaa !56
...
invoke.cont97:                                    ; preds = %invoke.cont95
  %nbot = getelementptr inbounds %class.Mesh, ptr %this, i64 0, i32 71
  %60 = load ptr, ptr %nbot, align 8, !tbaa !57
...
invoke.cont99:                                    ; preds = %invoke.cont97
  %ntop = getelementptr inbounds %class.Mesh, ptr %this, i64 0, i32 72
  %61 = load ptr, ptr %ntop, align 8, !tbaa !55
  invoke void @_ZN10MallocPlus20set_memory_attributeEPvi(ptr noundef nonnull align 8 dereferenceable(96) %mesh_memory, ptr noundef %61, i32 noundef 256)
          to label %invoke.cont101 unwind label %lpad94

invoke.cont101:                                   ; preds = %invoke.cont99
  %62 = load ptr, ptr %z_order, align 8, !tbaa !78
  invoke void @_ZN10MallocPlus18memory_reorder_allEPi(ptr noundef nonnull align 8 dereferenceable(96) %mesh_memory, ptr noundef %62)
...
invoke.cont105:                                   ; preds = %invoke.cont104
  %63 = load ptr, ptr %_M_finish.i, align 8, !tbaa !86
  %64 = load ptr, ptr %x, align 8, !tbaa !87
  %65 = ptrtoint ptr %64 to i64
  %sub.ptr.lhs.cast.i694 = ptrtoint ptr %63 to i64
  %sub.ptr.rhs.cast.i695 = ptrtoint ptr %64 to i64
  %sub.ptr.sub.i696 = sub i64 %sub.ptr.lhs.cast.i694, %sub.ptr.rhs.cast.i695
  %sub.ptr.div.i697 = ashr exact i64 %sub.ptr.sub.i696, 3
  %66 = load i64, ptr %ncells, align 8, !tbaa !9
  %cmp109.not = icmp ult i64 %sub.ptr.div.i697, %66
  br i1 %cmp109.not, label %if.end243, label %if.then110

if.then110:                                       ; preds = %invoke.cont105
  %cmp.i.i698 = icmp ugt i64 %66, 1152921504606846975
...
_ZNSt6vectorIdSaIdEE17_S_check_init_lenEmRKS0_.exit.i: ; preds = %if.then110
  %cmp.not.i.i.i.i700 = icmp eq i64 %66, 0
...
if.then.i.i.i.i.i706:                             ; preds = %_ZNSt6vectorIdSaIdEE17_S_check_init_lenEmRKS0_.exit.i
  %mul.i.i.i.i.i.i701 = shl nuw nsw i64 %66, 3
...
call5.i.i.i.i4.i.i.noexc711:                      ; preds = %if.then.i.i.i.i.i706
  ...
  %cmp.i.i.i.i.i.i.i705 = icmp eq i64 %66, 1
...
invoke.cont114:                                   ; preds = %call5.i.i.i.i4.i.i.noexc711
  ...
  %67 = add nsw i64 %mul.i.i.i.i.i.i701, -8
  call void @llvm.memset.p0.i64(ptr align 8 %incdec.ptr.i.i.i.i.i704, i8 0, i64 %67, i1 false), !tbaa !41
  %conv118 = trunc i64 %66 to i32
...
for.body121.preheader:                            ; preds = %call5.i.i.i.i4.i.i.noexc711, %invoke.cont114
  %wide.trip.count1018 = and i64 %66, 4294967295
  %min.iters.check1233 = icmp ult i64 %wide.trip.count1018, 6
  %68 = sub i64 %call5.i.i.i.i4.i.i7121229, %65
  %diff.check1230 = icmp ult i64 %68, 32
...
vector.body1239:                                  ; preds = %vector.body1239, %vector.ph1234
  ...
  %69 = getelementptr inbounds double, ptr %64, i64 %index1240
  %wide.load1241 = load <2 x double>, ptr %69, align 8, !tbaa !41
  %70 = getelementptr inbounds double, ptr %69, i64 2
  %wide.load1242 = load <2 x double>, ptr %70, align 8, !tbaa !41
  %71 = getelementptr inbounds double, ptr %call5.i.i.i.i4.i.i712, i64 %index1240
  store <2 x double> %wide.load1241, ptr %71, align 8, !tbaa !41
  %72 = getelementptr inbounds double, ptr %71, i64 2
  store <2 x double> %wide.load1242, ptr %72, align 8, !tbaa !41
  %index.next1243 = add nuw i64 %index1240, 4
  %73 = icmp eq i64 %index.next1243, %n.vec1236
  br i1 %73, label %middle.block1231, label %vector.body1239, !llvm.loop !94
...
for.body121.preheader1302:                        ; preds = %for.body121.preheader, %middle.block1231
  ...
  %74 = sub i64 %66, %indvars.iv1014.ph
  %75 = xor i64 %indvars.iv1014.ph, -1
  %76 = add nsw i64 %wide.trip.count1018, %75
  %xtraiter1330 = and i64 %74, 3
...
for.body121.prol:                                 ; preds = %for.body121.preheader1302, %for.body121.prol
  ...
  %add.ptr.i713.prol = getelementptr inbounds double, ptr %64, i64 %indvars.iv1014.prol
  %77 = load double, ptr %add.ptr.i713.prol, align 8, !tbaa !41
  %add.ptr.i714.prol = getelementptr inbounds double, ptr %call5.i.i.i.i4.i.i712, i64 %indvars.iv1014.prol
  store double %77, ptr %add.ptr.i714.prol, align 8, !tbaa !41
...
for.body121.prol.loopexit:                        ; preds = %for.body121.prol, %for.body121.preheader1302
  ...
  br i1 %78, label %for.body136.lr.ph, label %for.body121

for.body136.lr.ph:                                ; preds = %for.body121.prol.loopexit, %for.body121, %middle.block1231
  %79 = load ptr, ptr %z_order, align 8, !tbaa !78
  %80 = add nsw i64 %wide.trip.count1018, -1
  %xtraiter1333 = and i64 %66, 3
  %81 = icmp ult i64 %80, 3
  br i1 %81, label %for.body153.lr.ph.unr-lcssa, label %for.body136.lr.ph.new
...
for.body121:                                      ; preds = %for.body121.prol.loopexit, %for.body121
  ...
  %add.ptr.i713 = getelementptr inbounds double, ptr %64, i64 %indvars.iv1014
  %85 = load double, ptr %add.ptr.i713, align 8, !tbaa !41
  %add.ptr.i714 = getelementptr inbounds double, ptr %call5.i.i.i.i4.i.i712, i64 %indvars.iv1014
  store double %85, ptr %add.ptr.i714, align 8, !tbaa !41
  %indvars.iv.next1015 = add nuw nsw i64 %indvars.iv1014, 1
  %add.ptr.i713.1 = getelementptr inbounds double, ptr %64, i64 %indvars.iv.next1015
  %86 = load double, ptr %add.ptr.i713.1, align 8, !tbaa !41
  %add.ptr.i714.1 = getelementptr inbounds double, ptr %call5.i.i.i.i4.i.i712, i64 %indvars.iv.next1015
  store double %86, ptr %add.ptr.i714.1, align 8, !tbaa !41
  %indvars.iv.next1015.1 = add nuw nsw i64 %indvars.iv1014, 2
  %add.ptr.i713.2 = getelementptr inbounds double, ptr %64, i64 %indvars.iv.next1015.1
  %87 = load double, ptr %add.ptr.i713.2, align 8, !tbaa !41
  %add.ptr.i714.2 = getelementptr inbounds double, ptr %call5.i.i.i.i4.i.i712, i64 %indvars.iv.next1015.1
  store double %87, ptr %add.ptr.i714.2, align 8, !tbaa !41
  %indvars.iv.next1015.2 = add nuw nsw i64 %indvars.iv1014, 3
  %add.ptr.i713.3 = getelementptr inbounds double, ptr %64, i64 %indvars.iv.next1015.2
  %88 = load double, ptr %add.ptr.i713.3, align 8, !tbaa !41
  %add.ptr.i714.3 = getelementptr inbounds double, ptr %call5.i.i.i.i4.i.i712, i64 %indvars.iv.next1015.2
  store double %88, ptr %add.ptr.i714.3, align 8, !tbaa !41
...
for.body136.epil:                                 ; preds = %for.body153.lr.ph.unr-lcssa, %for.body136.epil
  ...
  %add.ptr.i715.epil = getelementptr inbounds i32, ptr %79, i64 %indvars.iv1020.epil
  %89 = load i32, ptr %add.ptr.i715.epil, align 4, !tbaa !5
  %conv139.epil = sext i32 %89 to i64
  %add.ptr.i716.epil = getelementptr inbounds double, ptr %call5.i.i.i.i4.i.i712, i64 %conv139.epil
  %90 = load double, ptr %add.ptr.i716.epil, align 8, !tbaa !41
  %add.ptr.i717.epil = getelementptr inbounds double, ptr %64, i64 %indvars.iv1020.epil
  store double %90, ptr %add.ptr.i717.epil, align 8, !tbaa !41
...
for.body153.lr.ph:                                ; preds = %for.body136.epil, %for.body153.lr.ph.unr-lcssa
  ...
  %91 = load ptr, ptr %dx154, align 8, !tbaa !87
  %wide.trip.count1030 = and i64 %66, 4294967295
  %min.iters.check1248 = icmp ult i64 %wide.trip.count1018, 6
  %92 = ptrtoint ptr %91 to i64
  %93 = sub i64 %call5.i.i.i.i4.i.i7121229, %92
  %diff.check1245 = icmp ult i64 %93, 32
...
vector.body1254:                                  ; preds = %vector.body1254, %vector.ph1249
  ...
  %94 = getelementptr inbounds double, ptr %91, i64 %index1255
  %wide.load1256 = load <2 x double>, ptr %94, align 8, !tbaa !41
  %95 = getelementptr inbounds double, ptr %94, i64 2
  %wide.load1257 = load <2 x double>, ptr %95, align 8, !tbaa !41
  %96 = getelementptr inbounds double, ptr %call5.i.i.i.i4.i.i712, i64 %index1255
  store <2 x double> %wide.load1256, ptr %96, align 8, !tbaa !41
  %97 = getelementptr inbounds double, ptr %96, i64 2
  store <2 x double> %wide.load1257, ptr %97, align 8, !tbaa !41
  %index.next1258 = add nuw i64 %index1255, 4
  %98 = icmp eq i64 %index.next1258, %n.vec1251
  br i1 %98, label %middle.block1246, label %vector.body1254, !llvm.loop !99
...
for.body153.preheader:                            ; preds = %for.body153.lr.ph, %middle.block1246
  ...
  %99 = sub i64 %66, %indvars.iv1026.ph
  %100 = xor i64 %indvars.iv1026.ph, -1
  %101 = add nsw i64 %wide.trip.count1018, %100
  %xtraiter1338 = and i64 %99, 3
...
for.body153.prol:                                 ; preds = %for.body153.preheader, %for.body153.prol
  ...
  %add.ptr.i718.prol = getelementptr inbounds double, ptr %91, i64 %indvars.iv1026.prol
  %102 = load double, ptr %add.ptr.i718.prol, align 8, !tbaa !41
  %add.ptr.i719.prol = getelementptr inbounds double, ptr %call5.i.i.i.i4.i.i712, i64 %indvars.iv1026.prol
  store double %102, ptr %add.ptr.i719.prol, align 8, !tbaa !41
...
for.body153.prol.loopexit:                        ; preds = %for.body153.prol, %for.body153.preheader
  ...
  br i1 %103, label %for.body168.lr.ph, label %for.body153
...
for.body136:                                      ; preds = %for.body136, %for.body136.lr.ph.new
  ...
  %add.ptr.i715 = getelementptr inbounds i32, ptr %79, i64 %indvars.iv1020
  %104 = load i32, ptr %add.ptr.i715, align 4, !tbaa !5
  %conv139 = sext i32 %104 to i64
  %add.ptr.i716 = getelementptr inbounds double, ptr %call5.i.i.i.i4.i.i712, i64 %conv139
  %105 = load double, ptr %add.ptr.i716, align 8, !tbaa !41
  %add.ptr.i717 = getelementptr inbounds double, ptr %64, i64 %indvars.iv1020
  store double %105, ptr %add.ptr.i717, align 8, !tbaa !41
  %indvars.iv.next1021 = or i64 %indvars.iv1020, 1
  %add.ptr.i715.1 = getelementptr inbounds i32, ptr %79, i64 %indvars.iv.next1021
  %106 = load i32, ptr %add.ptr.i715.1, align 4, !tbaa !5
  %conv139.1 = sext i32 %106 to i64
  %add.ptr.i716.1 = getelementptr inbounds double, ptr %call5.i.i.i.i4.i.i712, i64 %conv139.1
  %107 = load double, ptr %add.ptr.i716.1, align 8, !tbaa !41
  %add.ptr.i717.1 = getelementptr inbounds double, ptr %64, i64 %indvars.iv.next1021
  store double %107, ptr %add.ptr.i717.1, align 8, !tbaa !41
  %indvars.iv.next1021.1 = or i64 %indvars.iv1020, 2
  %add.ptr.i715.2 = getelementptr inbounds i32, ptr %79, i64 %indvars.iv.next1021.1
  %108 = load i32, ptr %add.ptr.i715.2, align 4, !tbaa !5
  %conv139.2 = sext i32 %108 to i64
  %add.ptr.i716.2 = getelementptr inbounds double, ptr %call5.i.i.i.i4.i.i712, i64 %conv139.2
  %109 = load double, ptr %add.ptr.i716.2, align 8, !tbaa !41
  %add.ptr.i717.2 = getelementptr inbounds double, ptr %64, i64 %indvars.iv.next1021.1
  store double %109, ptr %add.ptr.i717.2, align 8, !tbaa !41
  %indvars.iv.next1021.2 = or i64 %indvars.iv1020, 3
  %add.ptr.i715.3 = getelementptr inbounds i32, ptr %79, i64 %indvars.iv.next1021.2
  %110 = load i32, ptr %add.ptr.i715.3, align 4, !tbaa !5
  %conv139.3 = sext i32 %110 to i64
  %add.ptr.i716.3 = getelementptr inbounds double, ptr %call5.i.i.i.i4.i.i712, i64 %conv139.3
  %111 = load double, ptr %add.ptr.i716.3, align 8, !tbaa !41
  %add.ptr.i717.3 = getelementptr inbounds double, ptr %64, i64 %indvars.iv.next1021.2
  store double %111, ptr %add.ptr.i717.3, align 8, !tbaa !41
...
for.body168.lr.ph:                                ; preds = %for.body153.prol.loopexit, %for.body153, %middle.block1246
  %112 = load ptr, ptr %z_order, align 8, !tbaa !78
  %dx173 = getelementptr inbounds %class.Mesh, ptr %this, i64 0, i32 76
  %113 = load ptr, ptr %dx173, align 8, !tbaa !87
  %xtraiter1341 = and i64 %66, 3
  %114 = icmp ult i64 %80, 3
  br i1 %114, label %for.body185.lr.ph.unr-lcssa, label %for.body168.lr.ph.new
...
for.body153:                                      ; preds = %for.body153.prol.loopexit, %for.body153
  ...
  %add.ptr.i718 = getelementptr inbounds double, ptr %91, i64 %indvars.iv1026
  %115 = load double, ptr %add.ptr.i718, align 8, !tbaa !41
  %add.ptr.i719 = getelementptr inbounds double, ptr %call5.i.i.i.i4.i.i712, i64 %indvars.iv1026
  store double %115, ptr %add.ptr.i719, align 8, !tbaa !41
  %indvars.iv.next1027 = add nuw nsw i64 %indvars.iv1026, 1
  %add.ptr.i718.1 = getelementptr inbounds double, ptr %91, i64 %indvars.iv.next1027
  %116 = load double, ptr %add.ptr.i718.1, align 8, !tbaa !41
  %add.ptr.i719.1 = getelementptr inbounds double, ptr %call5.i.i.i.i4.i.i712, i64 %indvars.iv.next1027
  store double %116, ptr %add.ptr.i719.1, align 8, !tbaa !41
  %indvars.iv.next1027.1 = add nuw nsw i64 %indvars.iv1026, 2
  %add.ptr.i718.2 = getelementptr inbounds double, ptr %91, i64 %indvars.iv.next1027.1
  %117 = load double, ptr %add.ptr.i718.2, align 8, !tbaa !41
  %add.ptr.i719.2 = getelementptr inbounds double, ptr %call5.i.i.i.i4.i.i712, i64 %indvars.iv.next1027.1
  store double %117, ptr %add.ptr.i719.2, align 8, !tbaa !41
  %indvars.iv.next1027.2 = add nuw nsw i64 %indvars.iv1026, 3
  %add.ptr.i718.3 = getelementptr inbounds double, ptr %91, i64 %indvars.iv.next1027.2
  %118 = load double, ptr %add.ptr.i718.3, align 8, !tbaa !41
  %add.ptr.i719.3 = getelementptr inbounds double, ptr %call5.i.i.i.i4.i.i712, i64 %indvars.iv.next1027.2
  store double %118, ptr %add.ptr.i719.3, align 8, !tbaa !41
...
for.body168.epil:                                 ; preds = %for.body185.lr.ph.unr-lcssa, %for.body168.epil
  ...
  %add.ptr.i720.epil = getelementptr inbounds i32, ptr %112, i64 %indvars.iv1032.epil
  %119 = load i32, ptr %add.ptr.i720.epil, align 4, !tbaa !5
  %conv171.epil = sext i32 %119 to i64
  %add.ptr.i721.epil = getelementptr inbounds double, ptr %call5.i.i.i.i4.i.i712, i64 %conv171.epil
  %120 = load double, ptr %add.ptr.i721.epil, align 8, !tbaa !41
  %add.ptr.i722.epil = getelementptr inbounds double, ptr %113, i64 %indvars.iv1032.epil
  store double %120, ptr %add.ptr.i722.epil, align 8, !tbaa !41
...
for.body185.lr.ph:                                ; preds = %for.body168.epil, %for.body185.lr.ph.unr-lcssa
  ...
  %121 = load ptr, ptr %y186, align 8, !tbaa !87
  %wide.trip.count1042 = and i64 %66, 4294967295
  %min.iters.check1263 = icmp ult i64 %wide.trip.count1018, 6
  %122 = ptrtoint ptr %121 to i64
  %123 = sub i64 %call5.i.i.i.i4.i.i7121229, %122
  %diff.check1260 = icmp ult i64 %123, 32
...
vector.body1269:                                  ; preds = %vector.body1269, %vector.ph1264
  ...
  %124 = getelementptr inbounds double, ptr %121, i64 %index1270
  %wide.load1271 = load <2 x double>, ptr %124, align 8, !tbaa !41
  %125 = getelementptr inbounds double, ptr %124, i64 2
  %wide.load1272 = load <2 x double>, ptr %125, align 8, !tbaa !41
  %126 = getelementptr inbounds double, ptr %call5.i.i.i.i4.i.i712, i64 %index1270
  store <2 x double> %wide.load1271, ptr %126, align 8, !tbaa !41
  %127 = getelementptr inbounds double, ptr %126, i64 2
  store <2 x double> %wide.load1272, ptr %127, align 8, !tbaa !41
  %index.next1273 = add nuw i64 %index1270, 4
  %128 = icmp eq i64 %index.next1273, %n.vec1266
  br i1 %128, label %middle.block1261, label %vector.body1269, !llvm.loop !104
...
for.body185.preheader:                            ; preds = %for.body185.lr.ph, %middle.block1261
  ...
  %129 = sub i64 %66, %indvars.iv1038.ph
  %130 = xor i64 %indvars.iv1038.ph, -1
  %131 = add nsw i64 %wide.trip.count1018, %130
  %xtraiter1346 = and i64 %129, 3
...
for.body185.prol:                                 ; preds = %for.body185.preheader, %for.body185.prol
  ...
  %add.ptr.i723.prol = getelementptr inbounds double, ptr %121, i64 %indvars.iv1038.prol
  %132 = load double, ptr %add.ptr.i723.prol, align 8, !tbaa !41
  %add.ptr.i724.prol = getelementptr inbounds double, ptr %call5.i.i.i.i4.i.i712, i64 %indvars.iv1038.prol
  store double %132, ptr %add.ptr.i724.prol, align 8, !tbaa !41
...
for.body185.prol.loopexit:                        ; preds = %for.body185.prol, %for.body185.preheader
  ...
  br i1 %133, label %for.body200.lr.ph, label %for.body185
...
for.body168:                                      ; preds = %for.body168, %for.body168.lr.ph.new
  ...
  %add.ptr.i720 = getelementptr inbounds i32, ptr %112, i64 %indvars.iv1032
  %134 = load i32, ptr %add.ptr.i720, align 4, !tbaa !5
  %conv171 = sext i32 %134 to i64
  %add.ptr.i721 = getelementptr inbounds double, ptr %call5.i.i.i.i4.i.i712, i64 %conv171
  %135 = load double, ptr %add.ptr.i721, align 8, !tbaa !41
  %add.ptr.i722 = getelementptr inbounds double, ptr %113, i64 %indvars.iv1032
  store double %135, ptr %add.ptr.i722, align 8, !tbaa !41
  %indvars.iv.next1033 = or i64 %indvars.iv1032, 1
  %add.ptr.i720.1 = getelementptr inbounds i32, ptr %112, i64 %indvars.iv.next1033
  %136 = load i32, ptr %add.ptr.i720.1, align 4, !tbaa !5
  %conv171.1 = sext i32 %136 to i64
  %add.ptr.i721.1 = getelementptr inbounds double, ptr %call5.i.i.i.i4.i.i712, i64 %conv171.1
  %137 = load double, ptr %add.ptr.i721.1, align 8, !tbaa !41
  %add.ptr.i722.1 = getelementptr inbounds double, ptr %113, i64 %indvars.iv.next1033
  store double %137, ptr %add.ptr.i722.1, align 8, !tbaa !41
  %indvars.iv.next1033.1 = or i64 %indvars.iv1032, 2
  %add.ptr.i720.2 = getelementptr inbounds i32, ptr %112, i64 %indvars.iv.next1033.1
  %138 = load i32, ptr %add.ptr.i720.2, align 4, !tbaa !5
  %conv171.2 = sext i32 %138 to i64
  %add.ptr.i721.2 = getelementptr inbounds double, ptr %call5.i.i.i.i4.i.i712, i64 %conv171.2
  %139 = load double, ptr %add.ptr.i721.2, align 8, !tbaa !41
  %add.ptr.i722.2 = getelementptr inbounds double, ptr %113, i64 %indvars.iv.next1033.1
  store double %139, ptr %add.ptr.i722.2, align 8, !tbaa !41
  %indvars.iv.next1033.2 = or i64 %indvars.iv1032, 3
  %add.ptr.i720.3 = getelementptr inbounds i32, ptr %112, i64 %indvars.iv.next1033.2
  %140 = load i32, ptr %add.ptr.i720.3, align 4, !tbaa !5
  %conv171.3 = sext i32 %140 to i64
  %add.ptr.i721.3 = getelementptr inbounds double, ptr %call5.i.i.i.i4.i.i712, i64 %conv171.3
  %141 = load double, ptr %add.ptr.i721.3, align 8, !tbaa !41
  %add.ptr.i722.3 = getelementptr inbounds double, ptr %113, i64 %indvars.iv.next1033.2
  store double %141, ptr %add.ptr.i722.3, align 8, !tbaa !41
...
for.body200.lr.ph:                                ; preds = %for.body185.prol.loopexit, %for.body185, %middle.block1261
  %142 = load ptr, ptr %z_order, align 8, !tbaa !78
  %y205 = getelementptr inbounds %class.Mesh, ptr %this, i64 0, i32 77
  %143 = load ptr, ptr %y205, align 8, !tbaa !87
  %xtraiter1349 = and i64 %66, 3
  %144 = icmp ult i64 %80, 3
  br i1 %144, label %for.body217.lr.ph.unr-lcssa, label %for.body200.lr.ph.new
...
for.body185:                                      ; preds = %for.body185.prol.loopexit, %for.body185
  ...
  %add.ptr.i723 = getelementptr inbounds double, ptr %121, i64 %indvars.iv1038
  %145 = load double, ptr %add.ptr.i723, align 8, !tbaa !41
  %add.ptr.i724 = getelementptr inbounds double, ptr %call5.i.i.i.i4.i.i712, i64 %indvars.iv1038
  store double %145, ptr %add.ptr.i724, align 8, !tbaa !41
  %indvars.iv.next1039 = add nuw nsw i64 %indvars.iv1038, 1
  %add.ptr.i723.1 = getelementptr inbounds double, ptr %121, i64 %indvars.iv.next1039
  %146 = load double, ptr %add.ptr.i723.1, align 8, !tbaa !41
  %add.ptr.i724.1 = getelementptr inbounds double, ptr %call5.i.i.i.i4.i.i712, i64 %indvars.iv.next1039
  store double %146, ptr %add.ptr.i724.1, align 8, !tbaa !41
  %indvars.iv.next1039.1 = add nuw nsw i64 %indvars.iv1038, 2
  %add.ptr.i723.2 = getelementptr inbounds double, ptr %121, i64 %indvars.iv.next1039.1
  %147 = load double, ptr %add.ptr.i723.2, align 8, !tbaa !41
  %add.ptr.i724.2 = getelementptr inbounds double, ptr %call5.i.i.i.i4.i.i712, i64 %indvars.iv.next1039.1
  store double %147, ptr %add.ptr.i724.2, align 8, !tbaa !41
  %indvars.iv.next1039.2 = add nuw nsw i64 %indvars.iv1038, 3
  %add.ptr.i723.3 = getelementptr inbounds double, ptr %121, i64 %indvars.iv.next1039.2
  %148 = load double, ptr %add.ptr.i723.3, align 8, !tbaa !41
  %add.ptr.i724.3 = getelementptr inbounds double, ptr %call5.i.i.i.i4.i.i712, i64 %indvars.iv.next1039.2
  store double %148, ptr %add.ptr.i724.3, align 8, !tbaa !41
...
for.body200.epil:                                 ; preds = %for.body217.lr.ph.unr-lcssa, %for.body200.epil
  ...
  %add.ptr.i725.epil = getelementptr inbounds i32, ptr %142, i64 %indvars.iv1044.epil
  %149 = load i32, ptr %add.ptr.i725.epil, align 4, !tbaa !5
  %conv203.epil = sext i32 %149 to i64
  %add.ptr.i726.epil = getelementptr inbounds double, ptr %call5.i.i.i.i4.i.i712, i64 %conv203.epil
  %150 = load double, ptr %add.ptr.i726.epil, align 8, !tbaa !41
  %add.ptr.i727.epil = getelementptr inbounds double, ptr %143, i64 %indvars.iv1044.epil
  store double %150, ptr %add.ptr.i727.epil, align 8, !tbaa !41
...
for.body217.lr.ph:                                ; preds = %for.body200.epil, %for.body217.lr.ph.unr-lcssa
  ...
  %151 = load ptr, ptr %dy218, align 8, !tbaa !87
  %wide.trip.count1054 = and i64 %66, 4294967295
  %min.iters.check1278 = icmp ult i64 %wide.trip.count1018, 6
  %152 = ptrtoint ptr %151 to i64
  %153 = sub i64 %call5.i.i.i.i4.i.i7121229, %152
  %diff.check1275 = icmp ult i64 %153, 32
...
vector.body1284:                                  ; preds = %vector.body1284, %vector.ph1279
  ...
  %154 = getelementptr inbounds double, ptr %151, i64 %index1285
  %wide.load1286 = load <2 x double>, ptr %154, align 8, !tbaa !41
  %155 = getelementptr inbounds double, ptr %154, i64 2
  %wide.load1287 = load <2 x double>, ptr %155, align 8, !tbaa !41
  %156 = getelementptr inbounds double, ptr %call5.i.i.i.i4.i.i712, i64 %index1285
  store <2 x double> %wide.load1286, ptr %156, align 8, !tbaa !41
  %157 = getelementptr inbounds double, ptr %156, i64 2
  store <2 x double> %wide.load1287, ptr %157, align 8, !tbaa !41
  %index.next1288 = add nuw i64 %index1285, 4
  %158 = icmp eq i64 %index.next1288, %n.vec1281
  br i1 %158, label %middle.block1276, label %vector.body1284, !llvm.loop !109
...
for.body217.preheader:                            ; preds = %for.body217.lr.ph, %middle.block1276
  ...
  %159 = sub i64 %66, %indvars.iv1050.ph
  %160 = xor i64 %indvars.iv1050.ph, -1
  %161 = add nsw i64 %wide.trip.count1018, %160
  %xtraiter1354 = and i64 %159, 3
...
for.body217.prol:                                 ; preds = %for.body217.preheader, %for.body217.prol
  ...
  %add.ptr.i728.prol = getelementptr inbounds double, ptr %151, i64 %indvars.iv1050.prol
  %162 = load double, ptr %add.ptr.i728.prol, align 8, !tbaa !41
  %add.ptr.i729.prol = getelementptr inbounds double, ptr %call5.i.i.i.i4.i.i712, i64 %indvars.iv1050.prol
  store double %162, ptr %add.ptr.i729.prol, align 8, !tbaa !41
...
for.body217.prol.loopexit:                        ; preds = %for.body217.prol, %for.body217.preheader
  ...
  br i1 %163, label %for.body232.lr.ph, label %for.body217
...
for.body200:                                      ; preds = %for.body200, %for.body200.lr.ph.new
  ...
  %add.ptr.i725 = getelementptr inbounds i32, ptr %142, i64 %indvars.iv1044
  %164 = load i32, ptr %add.ptr.i725, align 4, !tbaa !5
  %conv203 = sext i32 %164 to i64
  %add.ptr.i726 = getelementptr inbounds double, ptr %call5.i.i.i.i4.i.i712, i64 %conv203
  %165 = load double, ptr %add.ptr.i726, align 8, !tbaa !41
  %add.ptr.i727 = getelementptr inbounds double, ptr %143, i64 %indvars.iv1044
  store double %165, ptr %add.ptr.i727, align 8, !tbaa !41
  %indvars.iv.next1045 = or i64 %indvars.iv1044, 1
  %add.ptr.i725.1 = getelementptr inbounds i32, ptr %142, i64 %indvars.iv.next1045
  %166 = load i32, ptr %add.ptr.i725.1, align 4, !tbaa !5
  %conv203.1 = sext i32 %166 to i64
  %add.ptr.i726.1 = getelementptr inbounds double, ptr %call5.i.i.i.i4.i.i712, i64 %conv203.1
  %167 = load double, ptr %add.ptr.i726.1, align 8, !tbaa !41
  %add.ptr.i727.1 = getelementptr inbounds double, ptr %143, i64 %indvars.iv.next1045
  store double %167, ptr %add.ptr.i727.1, align 8, !tbaa !41
  %indvars.iv.next1045.1 = or i64 %indvars.iv1044, 2
  %add.ptr.i725.2 = getelementptr inbounds i32, ptr %142, i64 %indvars.iv.next1045.1
  %168 = load i32, ptr %add.ptr.i725.2, align 4, !tbaa !5
  %conv203.2 = sext i32 %168 to i64
  %add.ptr.i726.2 = getelementptr inbounds double, ptr %call5.i.i.i.i4.i.i712, i64 %conv203.2
  %169 = load double, ptr %add.ptr.i726.2, align 8, !tbaa !41
  %add.ptr.i727.2 = getelementptr inbounds double, ptr %143, i64 %indvars.iv.next1045.1
  store double %169, ptr %add.ptr.i727.2, align 8, !tbaa !41
  %indvars.iv.next1045.2 = or i64 %indvars.iv1044, 3
  %add.ptr.i725.3 = getelementptr inbounds i32, ptr %142, i64 %indvars.iv.next1045.2
  %170 = load i32, ptr %add.ptr.i725.3, align 4, !tbaa !5
  %conv203.3 = sext i32 %170 to i64
  %add.ptr.i726.3 = getelementptr inbounds double, ptr %call5.i.i.i.i4.i.i712, i64 %conv203.3
  %171 = load double, ptr %add.ptr.i726.3, align 8, !tbaa !41
  %add.ptr.i727.3 = getelementptr inbounds double, ptr %143, i64 %indvars.iv.next1045.2
  store double %171, ptr %add.ptr.i727.3, align 8, !tbaa !41
...
for.body232.lr.ph:                                ; preds = %for.body217.prol.loopexit, %for.body217, %middle.block1276
  %172 = load ptr, ptr %z_order, align 8, !tbaa !78
  %dy237 = getelementptr inbounds %class.Mesh, ptr %this, i64 0, i32 78
  %173 = load ptr, ptr %dy237, align 8, !tbaa !87
  %xtraiter1357 = and i64 %66, 3
  %174 = icmp ult i64 %80, 3
  br i1 %174, label %if.then.i.i.i.loopexit.unr-lcssa, label %for.body232.lr.ph.new
...
for.body217:                                      ; preds = %for.body217.prol.loopexit, %for.body217
  ...
  %add.ptr.i728 = getelementptr inbounds double, ptr %151, i64 %indvars.iv1050
  %175 = load double, ptr %add.ptr.i728, align 8, !tbaa !41
  %add.ptr.i729 = getelementptr inbounds double, ptr %call5.i.i.i.i4.i.i712, i64 %indvars.iv1050
  store double %175, ptr %add.ptr.i729, align 8, !tbaa !41
  %indvars.iv.next1051 = add nuw nsw i64 %indvars.iv1050, 1
  %add.ptr.i728.1 = getelementptr inbounds double, ptr %151, i64 %indvars.iv.next1051
  %176 = load double, ptr %add.ptr.i728.1, align 8, !tbaa !41
  %add.ptr.i729.1 = getelementptr inbounds double, ptr %call5.i.i.i.i4.i.i712, i64 %indvars.iv.next1051
  store double %176, ptr %add.ptr.i729.1, align 8, !tbaa !41
  %indvars.iv.next1051.1 = add nuw nsw i64 %indvars.iv1050, 2
  %add.ptr.i728.2 = getelementptr inbounds double, ptr %151, i64 %indvars.iv.next1051.1
  %177 = load double, ptr %add.ptr.i728.2, align 8, !tbaa !41
  %add.ptr.i729.2 = getelementptr inbounds double, ptr %call5.i.i.i.i4.i.i712, i64 %indvars.iv.next1051.1
  store double %177, ptr %add.ptr.i729.2, align 8, !tbaa !41
  %indvars.iv.next1051.2 = add nuw nsw i64 %indvars.iv1050, 3
  %add.ptr.i728.3 = getelementptr inbounds double, ptr %151, i64 %indvars.iv.next1051.2
  %178 = load double, ptr %add.ptr.i728.3, align 8, !tbaa !41
  %add.ptr.i729.3 = getelementptr inbounds double, ptr %call5.i.i.i.i4.i.i712, i64 %indvars.iv.next1051.2
  store double %178, ptr %add.ptr.i729.3, align 8, !tbaa !41
...
for.body232.epil:                                 ; preds = %if.then.i.i.i.loopexit.unr-lcssa, %for.body232.epil
  ...
  %add.ptr.i730.epil = getelementptr inbounds i32, ptr %172, i64 %indvars.iv1056.epil
  %179 = load i32, ptr %add.ptr.i730.epil, align 4, !tbaa !5
  %conv235.epil = sext i32 %179 to i64
  %add.ptr.i731.epil = getelementptr inbounds double, ptr %call5.i.i.i.i4.i.i712, i64 %conv235.epil
  %180 = load double, ptr %add.ptr.i731.epil, align 8, !tbaa !41
  %add.ptr.i732.epil = getelementptr inbounds double, ptr %173, i64 %indvars.iv1056.epil
  store double %180, ptr %add.ptr.i732.epil, align 8, !tbaa !41
...
for.body232:                                      ; preds = %for.body232, %for.body232.lr.ph.new
  ...
  %add.ptr.i730 = getelementptr inbounds i32, ptr %172, i64 %indvars.iv1056
  %181 = load i32, ptr %add.ptr.i730, align 4, !tbaa !5
  %conv235 = sext i32 %181 to i64
  %add.ptr.i731 = getelementptr inbounds double, ptr %call5.i.i.i.i4.i.i712, i64 %conv235
  %182 = load double, ptr %add.ptr.i731, align 8, !tbaa !41
  %add.ptr.i732 = getelementptr inbounds double, ptr %173, i64 %indvars.iv1056
  store double %182, ptr %add.ptr.i732, align 8, !tbaa !41
  %indvars.iv.next1057 = or i64 %indvars.iv1056, 1
  %add.ptr.i730.1 = getelementptr inbounds i32, ptr %172, i64 %indvars.iv.next1057
  %183 = load i32, ptr %add.ptr.i730.1, align 4, !tbaa !5
  %conv235.1 = sext i32 %183 to i64
  %add.ptr.i731.1 = getelementptr inbounds double, ptr %call5.i.i.i.i4.i.i712, i64 %conv235.1
  %184 = load double, ptr %add.ptr.i731.1, align 8, !tbaa !41
  %add.ptr.i732.1 = getelementptr inbounds double, ptr %173, i64 %indvars.iv.next1057
  store double %184, ptr %add.ptr.i732.1, align 8, !tbaa !41
  %indvars.iv.next1057.1 = or i64 %indvars.iv1056, 2
  %add.ptr.i730.2 = getelementptr inbounds i32, ptr %172, i64 %indvars.iv.next1057.1
  %185 = load i32, ptr %add.ptr.i730.2, align 4, !tbaa !5
  %conv235.2 = sext i32 %185 to i64
  %add.ptr.i731.2 = getelementptr inbounds double, ptr %call5.i.i.i.i4.i.i712, i64 %conv235.2
  %186 = load double, ptr %add.ptr.i731.2, align 8, !tbaa !41
  %add.ptr.i732.2 = getelementptr inbounds double, ptr %173, i64 %indvars.iv.next1057.1
  store double %186, ptr %add.ptr.i732.2, align 8, !tbaa !41
  %indvars.iv.next1057.2 = or i64 %indvars.iv1056, 3
  %add.ptr.i730.3 = getelementptr inbounds i32, ptr %172, i64 %indvars.iv.next1057.2
  %187 = load i32, ptr %add.ptr.i730.3, align 4, !tbaa !5
  %conv235.3 = sext i32 %187 to i64
  %add.ptr.i731.3 = getelementptr inbounds double, ptr %call5.i.i.i.i4.i.i712, i64 %conv235.3
  %188 = load double, ptr %add.ptr.i731.3, align 8, !tbaa !41
  %add.ptr.i732.3 = getelementptr inbounds double, ptr %173, i64 %indvars.iv.next1057.2
  store double %188, ptr %add.ptr.i732.3, align 8, !tbaa !41
...
ehcleanup:                                        ; preds = %lpad113, %lpad94
  %.pn904 = phi { ptr, i32 } [ %84, %lpad113 ], [ %83, %lpad94 ]
...
sw.bb246:                                         ; preds = %if.end
  %189 = load i32, ptr %parallel, align 4, !tbaa !76
  %tobool248.not = icmp eq i32 %189, 0
  br i1 %tobool248.not, label %if.else250, label %sw.epilog.invoke

if.else250:                                       ; preds = %sw.bb246
  %190 = load i64, ptr %ncells, align 8, !tbaa !9
  ...
  %191 = load ptr, ptr %_M_finish.i.i738, align 8, !tbaa !77
  %192 = load ptr, ptr %i_scaled, align 8, !tbaa !78
  %sub.ptr.lhs.cast.i.i739 = ptrtoint ptr %191 to i64
  %sub.ptr.rhs.cast.i.i740 = ptrtoint ptr %192 to i64
  ...
  %cmp.i743 = icmp ugt i64 %190, %sub.ptr.div.i.i742
  br i1 %cmp.i743, label %if.then.i745, label %if.else.i747

if.then.i745:                                     ; preds = %if.else250
  %sub.i744 = sub i64 %190, %sub.ptr.div.i.i742
...
if.else.i747:                                     ; preds = %if.else250
  %cmp4.i746 = icmp ult i64 %190, %sub.ptr.div.i.i742
  br i1 %cmp4.i746, label %if.then5.i750, label %invoke.cont252

if.then5.i750:                                    ; preds = %if.else.i747
  %add.ptr.i748 = getelementptr inbounds i32, ptr %192, i64 %190
  %tobool.not.i.i749 = icmp eq ptr %191, %add.ptr.i748
...
invoke.cont252:                                   ; preds = %if.then.i745.invoke.cont252_crit_edge, %invoke.cont.i.i751, %if.then5.i750, %if.else.i747
  %193 = phi i64 [ %.pre, %if.then.i745.invoke.cont252_crit_edge ], [ %190, %invoke.cont.i.i751 ], [ %190, %if.then5.i750 ], [ %190, %if.else.i747 ]
  ...
  %194 = load ptr, ptr %_M_finish.i.i754, align 8, !tbaa !77
  %195 = load ptr, ptr %j_scaled, align 8, !tbaa !78
  %sub.ptr.lhs.cast.i.i755 = ptrtoint ptr %194 to i64
  %sub.ptr.rhs.cast.i.i756 = ptrtoint ptr %195 to i64
...
if.else.i763:                                     ; preds = %invoke.cont252
  %cmp4.i762 = icmp ult i64 %193, %sub.ptr.div.i.i758
  br i1 %cmp4.i762, label %if.then5.i766, label %invoke.cont254

if.then5.i766:                                    ; preds = %if.else.i763
  %add.ptr.i764 = getelementptr inbounds i32, ptr %195, i64 %193
  %tobool.not.i.i765 = icmp eq ptr %194, %add.ptr.i764
...
invoke.cont254:                                   ; preds = %if.then.i761.invoke.cont254_crit_edge, %invoke.cont.i.i767, %if.then5.i766, %if.else.i763
  %196 = phi i64 [ %.pre1063, %if.then.i761.invoke.cont254_crit_edge ], [ %193, %invoke.cont.i.i767 ], [ %193, %if.then5.i766 ], [ %193, %if.else.i763 ]
  %cmp259912.not = icmp eq i64 %196, 0
...
for.body261.lr.ph:                                ; preds = %invoke.cont254
  ...
  %197 = load ptr, ptr %i, align 8, !tbaa !115
  %j = getelementptr inbounds %class.Mesh, ptr %this, i64 0, i32 65
  %198 = load ptr, ptr %j, align 8, !tbaa !116
...
for.body291.lr.ph:                                ; preds = %for.body261
  ...
  %199 = load ptr, ptr %i292, align 8, !tbaa !115
  %200 = load ptr, ptr %i_scaled, align 8, !tbaa !78
  %j300 = getelementptr inbounds %class.Mesh, ptr %this, i64 0, i32 65
  %201 = load ptr, ptr %j300, align 8, !tbaa !116
  %202 = load ptr, ptr %j_scaled, align 8, !tbaa !78
...
for.body261:                                      ; preds = %for.body261.lr.ph, %for.body261
  ...
  %arrayidx263 = getelementptr inbounds i32, ptr %197, i64 %conv257916
  %203 = load i32, ptr %arrayidx263, align 4, !tbaa !5
  %spec.select = call i32 @llvm.smax.i32(i32 %203, i32 %imax.0914)
  %arrayidx271 = getelementptr inbounds i32, ptr %198, i64 %conv257916
  %204 = load i32, ptr %arrayidx271, align 4, !tbaa !5
  %jmax.1 = call i32 @llvm.smax.i32(i32 %204, i32 %jmax.0913)
  %inc279 = add nuw nsw i64 %conv257916, 1
  %conv257 = and i64 %inc279, 4294967295
  %cmp259 = icmp ugt i64 %196, %conv257
...
for.cond.cleanup290:                              ; preds = %for.body291, %for.cond.cleanup260.for.cond.cleanup290_crit_edge
  %205 = phi ptr [ %.pre1065, %for.cond.cleanup260.for.cond.cleanup290_crit_edge ], [ %202, %for.body291 ]
  %206 = phi ptr [ %.pre1064, %for.cond.cleanup260.for.cond.cleanup290_crit_edge ], [ %200, %for.body291 ]
  %conv312 = trunc i64 %196 to i32
  %level = getelementptr inbounds %class.Mesh, ptr %this, i64 0, i32 67
  %207 = load ptr, ptr %level, align 8, !tbaa !54
  %levmx = getelementptr inbounds %class.Mesh, ptr %this, i64 0, i32 36
  %208 = load i32, ptr %levmx, align 8, !tbaa !118
  %ibase = getelementptr inbounds %class.Mesh, ptr %this, i64 0, i32 38
  %209 = load i32, ptr %ibase, align 8, !tbaa !119
  %210 = load ptr, ptr %z_index, align 8, !tbaa !78
  %211 = load ptr, ptr %z_order, align 8, !tbaa !78
  invoke void @calc_zorder(i32 noundef %conv312, ptr noundef %206, ptr noundef %205, ptr noundef %207, i32 noundef %208, i32 noundef %209, ptr noundef %210, ptr noundef %211)
...
for.body291:                                      ; preds = %for.body291.lr.ph, %for.body291
  ...
  %arrayidx294 = getelementptr inbounds i32, ptr %199, i64 %conv287921
  %212 = load i32, ptr %arrayidx294, align 4, !tbaa !5
  %conv295 = sitofp i32 %212 to double
  %mul296 = fmul double %div282, %conv295
  %conv297 = fptosi double %mul296 to i32
  %add.ptr.i770 = getelementptr inbounds i32, ptr %200, i64 %conv287921
  store i32 %conv297, ptr %add.ptr.i770, align 4, !tbaa !5
  %arrayidx302 = getelementptr inbounds i32, ptr %201, i64 %conv287921
  %213 = load i32, ptr %arrayidx302, align 4, !tbaa !5
  %conv303 = sitofp i32 %213 to double
  %mul304 = fmul double %div284, %conv303
  %conv305 = fptosi double %mul304 to i32
  %add.ptr.i771 = getelementptr inbounds i32, ptr %202, i64 %conv287921
  store i32 %conv305, ptr %add.ptr.i771, align 4, !tbaa !5
  %inc309 = add nuw nsw i64 %conv287921, 1
  %conv287 = and i64 %inc309, 4294967295
  %cmp289 = icmp ugt i64 %196, %conv287
  br i1 %cmp289, label %for.body291, label %for.cond.cleanup290, !llvm.loop !120

invoke.cont318:                                   ; preds = %for.cond.cleanup290
  %214 = load i64, ptr %ncells, align 8, !tbaa !9
  %cmp.i.i772 = icmp ugt i64 %214, 2305843009213693951
...
_ZNSt6vectorIiSaIiEE17_S_check_init_lenEmRKS0_.exit.i775: ; preds = %invoke.cont318
  %cmp.not.i.i.i.i774 = icmp eq i64 %214, 0
...
if.then.i.i.i.i.i782:                             ; preds = %_ZNSt6vectorIiSaIiEE17_S_check_init_lenEmRKS0_.exit.i775
  %mul.i.i.i.i.i.i777 = shl nuw nsw i64 %214, 2
...
call5.i.i.i.i4.i.i.noexc787:                      ; preds = %if.then.i.i.i.i.i782
  ...
  %cmp.i.i.i.i.i.i.i781 = icmp eq i64 %214, 1
...
if.end.i.i.i.i.i.i.i783:                          ; preds = %call5.i.i.i.i4.i.i.noexc787
  ...
  %215 = add nsw i64 %mul.i.i.i.i.i.i777, -4
  call void @llvm.memset.p0.i64(ptr align 4 %incdec.ptr.i.i.i.i.i780, i8 0, i64 %215, i1 false), !tbaa !5
...
invoke.cont323:                                   ; preds = %if.end.i.i.i.i.i.i.i783, %call5.i.i.i.i4.i.i.noexc787, %_ZNSt6vectorIiSaIiEE17_S_check_init_lenEmRKS0_.exit.i775
  ...
  %216 = load ptr, ptr %nlft327, align 8, !tbaa !50
...
invoke.cont329:                                   ; preds = %invoke.cont323
  ...
  %217 = load ptr, ptr %nrht331, align 8, !tbaa !56
...
invoke.cont332:                                   ; preds = %invoke.cont329
  ...
  %218 = load ptr, ptr %nbot334, align 8, !tbaa !57
...
invoke.cont335:                                   ; preds = %invoke.cont332
  ...
  %219 = load ptr, ptr %ntop337, align 8, !tbaa !55
  invoke void @_ZN10MallocPlus20set_memory_attributeEPvi(ptr noundef nonnull align 8 dereferenceable(96) %mesh_memory326, ptr noundef %219, i32 noundef 256)
          to label %invoke.cont338 unwind label %lpad328

invoke.cont338:                                   ; preds = %invoke.cont335
  %220 = load ptr, ptr %z_order, align 8, !tbaa !78
  invoke void @_ZN10MallocPlus18memory_reorder_allEPi(ptr noundef nonnull align 8 dereferenceable(96) %mesh_memory326, ptr noundef %220)
...
invoke.cont342:                                   ; preds = %invoke.cont341
  ...
  %221 = load ptr, ptr %_M_finish.i790, align 8, !tbaa !86
  %222 = load ptr, ptr %x343, align 8, !tbaa !87
  %223 = ptrtoint ptr %222 to i64
  %sub.ptr.lhs.cast.i791 = ptrtoint ptr %221 to i64
  %sub.ptr.rhs.cast.i792 = ptrtoint ptr %222 to i64
  %sub.ptr.sub.i793 = sub i64 %sub.ptr.lhs.cast.i791, %sub.ptr.rhs.cast.i792
  %sub.ptr.div.i794 = ashr exact i64 %sub.ptr.sub.i793, 3
  %224 = load i64, ptr %ncells, align 8, !tbaa !9
  %cmp346.not = icmp ult i64 %sub.ptr.div.i794, %224
  br i1 %cmp346.not, label %if.end484, label %if.then347

if.then347:                                       ; preds = %invoke.cont342
  %cmp.i.i795 = icmp ugt i64 %224, 1152921504606846975
...
_ZNSt6vectorIdSaIdEE17_S_check_init_lenEmRKS0_.exit.i798: ; preds = %if.then347
  %cmp.not.i.i.i.i797 = icmp eq i64 %224, 0
...
if.then.i.i.i.i.i805:                             ; preds = %_ZNSt6vectorIdSaIdEE17_S_check_init_lenEmRKS0_.exit.i798
  %mul.i.i.i.i.i.i800 = shl nuw nsw i64 %224, 3
...
call5.i.i.i.i4.i.i.noexc810:                      ; preds = %if.then.i.i.i.i.i805
  ...
  %cmp.i.i.i.i.i.i.i804 = icmp eq i64 %224, 1
...
invoke.cont352:                                   ; preds = %call5.i.i.i.i4.i.i.noexc810
  ...
  %225 = add nsw i64 %mul.i.i.i.i.i.i800, -8
  call void @llvm.memset.p0.i64(ptr align 8 %incdec.ptr.i.i.i.i.i803, i8 0, i64 %225, i1 false), !tbaa !41
  %conv358 = trunc i64 %224 to i32
...
for.body361.preheader:                            ; preds = %call5.i.i.i.i4.i.i.noexc810, %invoke.cont352
  %wide.trip.count = and i64 %224, 4294967295
  %min.iters.check1173 = icmp ult i64 %wide.trip.count, 6
  %226 = sub i64 %call5.i.i.i.i4.i.i8111170, %223
  %diff.check = icmp ult i64 %226, 32
...
vector.body1179:                                  ; preds = %vector.body1179, %vector.ph1174
  ...
  %227 = getelementptr inbounds double, ptr %222, i64 %index1180
  %wide.load = load <2 x double>, ptr %227, align 8, !tbaa !41
  %228 = getelementptr inbounds double, ptr %227, i64 2
  %wide.load1181 = load <2 x double>, ptr %228, align 8, !tbaa !41
  %229 = getelementptr inbounds double, ptr %call5.i.i.i.i4.i.i811, i64 %index1180
  store <2 x double> %wide.load, ptr %229, align 8, !tbaa !41
  %230 = getelementptr inbounds double, ptr %229, i64 2
  store <2 x double> %wide.load1181, ptr %230, align 8, !tbaa !41
  %index.next1182 = add nuw i64 %index1180, 4
  %231 = icmp eq i64 %index.next1182, %n.vec1176
  br i1 %231, label %middle.block1171, label %vector.body1179, !llvm.loop !121
...
for.body361.preheader1303:                        ; preds = %for.body361.preheader, %middle.block1171
  ...
  %232 = sub i64 %224, %indvars.iv.ph
  %233 = xor i64 %indvars.iv.ph, -1
  %234 = add nsw i64 %wide.trip.count, %233
  %xtraiter = and i64 %232, 3
...
for.body361.prol:                                 ; preds = %for.body361.preheader1303, %for.body361.prol
  ...
  %add.ptr.i813.prol = getelementptr inbounds double, ptr %222, i64 %indvars.iv.prol
  %235 = load double, ptr %add.ptr.i813.prol, align 8, !tbaa !41
  %add.ptr.i814.prol = getelementptr inbounds double, ptr %call5.i.i.i.i4.i.i811, i64 %indvars.iv.prol
  store double %235, ptr %add.ptr.i814.prol, align 8, !tbaa !41
...
for.body361.prol.loopexit:                        ; preds = %for.body361.prol, %for.body361.preheader1303
  ...
  br i1 %236, label %for.body376.lr.ph, label %for.body361

for.body376.lr.ph:                                ; preds = %for.body361.prol.loopexit, %for.body361, %middle.block1171
  %237 = load ptr, ptr %z_order, align 8, !tbaa !78
  %238 = add nsw i64 %wide.trip.count, -1
  %xtraiter1304 = and i64 %224, 3
  %239 = icmp ult i64 %238, 3
  br i1 %239, label %for.body393.lr.ph.unr-lcssa, label %for.body376.lr.ph.new
...
for.body361:                                      ; preds = %for.body361.prol.loopexit, %for.body361
  ...
  %add.ptr.i813 = getelementptr inbounds double, ptr %222, i64 %indvars.iv
  %243 = load double, ptr %add.ptr.i813, align 8, !tbaa !41
  %add.ptr.i814 = getelementptr inbounds double, ptr %call5.i.i.i.i4.i.i811, i64 %indvars.iv
  store double %243, ptr %add.ptr.i814, align 8, !tbaa !41
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %add.ptr.i813.1 = getelementptr inbounds double, ptr %222, i64 %indvars.iv.next
  %244 = load double, ptr %add.ptr.i813.1, align 8, !tbaa !41
  %add.ptr.i814.1 = getelementptr inbounds double, ptr %call5.i.i.i.i4.i.i811, i64 %indvars.iv.next
  store double %244, ptr %add.ptr.i814.1, align 8, !tbaa !41
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %add.ptr.i813.2 = getelementptr inbounds double, ptr %222, i64 %indvars.iv.next.1
  %245 = load double, ptr %add.ptr.i813.2, align 8, !tbaa !41
  %add.ptr.i814.2 = getelementptr inbounds double, ptr %call5.i.i.i.i4.i.i811, i64 %indvars.iv.next.1
  store double %245, ptr %add.ptr.i814.2, align 8, !tbaa !41
  %indvars.iv.next.2 = add nuw nsw i64 %indvars.iv, 3
  %add.ptr.i813.3 = getelementptr inbounds double, ptr %222, i64 %indvars.iv.next.2
  %246 = load double, ptr %add.ptr.i813.3, align 8, !tbaa !41
  %add.ptr.i814.3 = getelementptr inbounds double, ptr %call5.i.i.i.i4.i.i811, i64 %indvars.iv.next.2
  store double %246, ptr %add.ptr.i814.3, align 8, !tbaa !41
...
for.body376.epil:                                 ; preds = %for.body393.lr.ph.unr-lcssa, %for.body376.epil
  ...
  %add.ptr.i815.epil = getelementptr inbounds i32, ptr %237, i64 %indvars.iv970.epil
  %247 = load i32, ptr %add.ptr.i815.epil, align 4, !tbaa !5
  %conv379.epil = sext i32 %247 to i64
  %add.ptr.i816.epil = getelementptr inbounds double, ptr %call5.i.i.i.i4.i.i811, i64 %conv379.epil
  %248 = load double, ptr %add.ptr.i816.epil, align 8, !tbaa !41
  %add.ptr.i817.epil = getelementptr inbounds double, ptr %222, i64 %indvars.iv970.epil
  store double %248, ptr %add.ptr.i817.epil, align 8, !tbaa !41
...
for.body393.lr.ph:                                ; preds = %for.body376.epil, %for.body393.lr.ph.unr-lcssa
  ...
  %249 = load ptr, ptr %dx394, align 8, !tbaa !87
  %wide.trip.count980 = and i64 %224, 4294967295
  %min.iters.check1187 = icmp ult i64 %wide.trip.count, 6
  %250 = ptrtoint ptr %249 to i64
  %251 = sub i64 %call5.i.i.i.i4.i.i8111170, %250
  %diff.check1184 = icmp ult i64 %251, 32
...
vector.body1193:                                  ; preds = %vector.body1193, %vector.ph1188
  ...
  %252 = getelementptr inbounds double, ptr %249, i64 %index1194
  %wide.load1195 = load <2 x double>, ptr %252, align 8, !tbaa !41
  %253 = getelementptr inbounds double, ptr %252, i64 2
  %wide.load1196 = load <2 x double>, ptr %253, align 8, !tbaa !41
  %254 = getelementptr inbounds double, ptr %call5.i.i.i.i4.i.i811, i64 %index1194
  store <2 x double> %wide.load1195, ptr %254, align 8, !tbaa !41
  %255 = getelementptr inbounds double, ptr %254, i64 2
  store <2 x double> %wide.load1196, ptr %255, align 8, !tbaa !41
  %index.next1197 = add nuw i64 %index1194, 4
  %256 = icmp eq i64 %index.next1197, %n.vec1190
  br i1 %256, label %middle.block1185, label %vector.body1193, !llvm.loop !125
...
for.body393.preheader:                            ; preds = %for.body393.lr.ph, %middle.block1185
  ...
  %257 = sub i64 %224, %indvars.iv976.ph
  %258 = xor i64 %indvars.iv976.ph, -1
  %259 = add nsw i64 %wide.trip.count, %258
  %xtraiter1306 = and i64 %257, 3
...
for.body393.prol:                                 ; preds = %for.body393.preheader, %for.body393.prol
  ...
  %add.ptr.i818.prol = getelementptr inbounds double, ptr %249, i64 %indvars.iv976.prol
  %260 = load double, ptr %add.ptr.i818.prol, align 8, !tbaa !41
  %add.ptr.i819.prol = getelementptr inbounds double, ptr %call5.i.i.i.i4.i.i811, i64 %indvars.iv976.prol
  store double %260, ptr %add.ptr.i819.prol, align 8, !tbaa !41
...
for.body393.prol.loopexit:                        ; preds = %for.body393.prol, %for.body393.preheader
  ...
  br i1 %261, label %for.body408.lr.ph, label %for.body393
...
for.body376:                                      ; preds = %for.body376, %for.body376.lr.ph.new
  ...
  %add.ptr.i815 = getelementptr inbounds i32, ptr %237, i64 %indvars.iv970
  %262 = load i32, ptr %add.ptr.i815, align 4, !tbaa !5
  %conv379 = sext i32 %262 to i64
  %add.ptr.i816 = getelementptr inbounds double, ptr %call5.i.i.i.i4.i.i811, i64 %conv379
  %263 = load double, ptr %add.ptr.i816, align 8, !tbaa !41
  %add.ptr.i817 = getelementptr inbounds double, ptr %222, i64 %indvars.iv970
  store double %263, ptr %add.ptr.i817, align 8, !tbaa !41
  %indvars.iv.next971 = or i64 %indvars.iv970, 1
  %add.ptr.i815.1 = getelementptr inbounds i32, ptr %237, i64 %indvars.iv.next971
  %264 = load i32, ptr %add.ptr.i815.1, align 4, !tbaa !5
  %conv379.1 = sext i32 %264 to i64
  %add.ptr.i816.1 = getelementptr inbounds double, ptr %call5.i.i.i.i4.i.i811, i64 %conv379.1
  %265 = load double, ptr %add.ptr.i816.1, align 8, !tbaa !41
  %add.ptr.i817.1 = getelementptr inbounds double, ptr %222, i64 %indvars.iv.next971
  store double %265, ptr %add.ptr.i817.1, align 8, !tbaa !41
  %indvars.iv.next971.1 = or i64 %indvars.iv970, 2
  %add.ptr.i815.2 = getelementptr inbounds i32, ptr %237, i64 %indvars.iv.next971.1
  %266 = load i32, ptr %add.ptr.i815.2, align 4, !tbaa !5
  %conv379.2 = sext i32 %266 to i64
  %add.ptr.i816.2 = getelementptr inbounds double, ptr %call5.i.i.i.i4.i.i811, i64 %conv379.2
  %267 = load double, ptr %add.ptr.i816.2, align 8, !tbaa !41
  %add.ptr.i817.2 = getelementptr inbounds double, ptr %222, i64 %indvars.iv.next971.1
  store double %267, ptr %add.ptr.i817.2, align 8, !tbaa !41
  %indvars.iv.next971.2 = or i64 %indvars.iv970, 3
  %add.ptr.i815.3 = getelementptr inbounds i32, ptr %237, i64 %indvars.iv.next971.2
  %268 = load i32, ptr %add.ptr.i815.3, align 4, !tbaa !5
  %conv379.3 = sext i32 %268 to i64
  %add.ptr.i816.3 = getelementptr inbounds double, ptr %call5.i.i.i.i4.i.i811, i64 %conv379.3
  %269 = load double, ptr %add.ptr.i816.3, align 8, !tbaa !41
  %add.ptr.i817.3 = getelementptr inbounds double, ptr %222, i64 %indvars.iv.next971.2
  store double %269, ptr %add.ptr.i817.3, align 8, !tbaa !41
...
for.body408.lr.ph:                                ; preds = %for.body393.prol.loopexit, %for.body393, %middle.block1185
  %270 = load ptr, ptr %z_order, align 8, !tbaa !78
  %dx413 = getelementptr inbounds %class.Mesh, ptr %this, i64 0, i32 76
  %271 = load ptr, ptr %dx413, align 8, !tbaa !87
  %xtraiter1309 = and i64 %224, 3
  %272 = icmp ult i64 %238, 3
  br i1 %272, label %for.body425.lr.ph.unr-lcssa, label %for.body408.lr.ph.new
...
for.body393:                                      ; preds = %for.body393.prol.loopexit, %for.body393
  ...
  %add.ptr.i818 = getelementptr inbounds double, ptr %249, i64 %indvars.iv976
  %273 = load double, ptr %add.ptr.i818, align 8, !tbaa !41
  %add.ptr.i819 = getelementptr inbounds double, ptr %call5.i.i.i.i4.i.i811, i64 %indvars.iv976
  store double %273, ptr %add.ptr.i819, align 8, !tbaa !41
  %indvars.iv.next977 = add nuw nsw i64 %indvars.iv976, 1
  %add.ptr.i818.1 = getelementptr inbounds double, ptr %249, i64 %indvars.iv.next977
  %274 = load double, ptr %add.ptr.i818.1, align 8, !tbaa !41
  %add.ptr.i819.1 = getelementptr inbounds double, ptr %call5.i.i.i.i4.i.i811, i64 %indvars.iv.next977
  store double %274, ptr %add.ptr.i819.1, align 8, !tbaa !41
  %indvars.iv.next977.1 = add nuw nsw i64 %indvars.iv976, 2
  %add.ptr.i818.2 = getelementptr inbounds double, ptr %249, i64 %indvars.iv.next977.1
  %275 = load double, ptr %add.ptr.i818.2, align 8, !tbaa !41
  %add.ptr.i819.2 = getelementptr inbounds double, ptr %call5.i.i.i.i4.i.i811, i64 %indvars.iv.next977.1
  store double %275, ptr %add.ptr.i819.2, align 8, !tbaa !41
  %indvars.iv.next977.2 = add nuw nsw i64 %indvars.iv976, 3
  %add.ptr.i818.3 = getelementptr inbounds double, ptr %249, i64 %indvars.iv.next977.2
  %276 = load double, ptr %add.ptr.i818.3, align 8, !tbaa !41
  %add.ptr.i819.3 = getelementptr inbounds double, ptr %call5.i.i.i.i4.i.i811, i64 %indvars.iv.next977.2
  store double %276, ptr %add.ptr.i819.3, align 8, !tbaa !41
...
for.body408.epil:                                 ; preds = %for.body425.lr.ph.unr-lcssa, %for.body408.epil
  ...
  %add.ptr.i820.epil = getelementptr inbounds i32, ptr %270, i64 %indvars.iv982.epil
  %277 = load i32, ptr %add.ptr.i820.epil, align 4, !tbaa !5
  %conv411.epil = sext i32 %277 to i64
  %add.ptr.i821.epil = getelementptr inbounds double, ptr %call5.i.i.i.i4.i.i811, i64 %conv411.epil
  %278 = load double, ptr %add.ptr.i821.epil, align 8, !tbaa !41
  %add.ptr.i822.epil = getelementptr inbounds double, ptr %271, i64 %indvars.iv982.epil
  store double %278, ptr %add.ptr.i822.epil, align 8, !tbaa !41
...
for.body425.lr.ph:                                ; preds = %for.body408.epil, %for.body425.lr.ph.unr-lcssa
  ...
  %279 = load ptr, ptr %y426, align 8, !tbaa !87
  %wide.trip.count992 = and i64 %224, 4294967295
  %min.iters.check1202 = icmp ult i64 %wide.trip.count, 6
  %280 = ptrtoint ptr %279 to i64
  %281 = sub i64 %call5.i.i.i.i4.i.i8111170, %280
  %diff.check1199 = icmp ult i64 %281, 32
...
vector.body1208:                                  ; preds = %vector.body1208, %vector.ph1203
  ...
  %282 = getelementptr inbounds double, ptr %279, i64 %index1209
  %wide.load1210 = load <2 x double>, ptr %282, align 8, !tbaa !41
  %283 = getelementptr inbounds double, ptr %282, i64 2
  %wide.load1211 = load <2 x double>, ptr %283, align 8, !tbaa !41
  %284 = getelementptr inbounds double, ptr %call5.i.i.i.i4.i.i811, i64 %index1209
  store <2 x double> %wide.load1210, ptr %284, align 8, !tbaa !41
  %285 = getelementptr inbounds double, ptr %284, i64 2
  store <2 x double> %wide.load1211, ptr %285, align 8, !tbaa !41
  %index.next1212 = add nuw i64 %index1209, 4
  %286 = icmp eq i64 %index.next1212, %n.vec1205
  br i1 %286, label %middle.block1200, label %vector.body1208, !llvm.loop !130
...
for.body425.preheader:                            ; preds = %for.body425.lr.ph, %middle.block1200
  ...
  %287 = sub i64 %224, %indvars.iv988.ph
  %288 = xor i64 %indvars.iv988.ph, -1
  %289 = add nsw i64 %wide.trip.count, %288
  %xtraiter1314 = and i64 %287, 3
...
for.body425.prol:                                 ; preds = %for.body425.preheader, %for.body425.prol
  ...
  %add.ptr.i823.prol = getelementptr inbounds double, ptr %279, i64 %indvars.iv988.prol
  %290 = load double, ptr %add.ptr.i823.prol, align 8, !tbaa !41
  %add.ptr.i824.prol = getelementptr inbounds double, ptr %call5.i.i.i.i4.i.i811, i64 %indvars.iv988.prol
  store double %290, ptr %add.ptr.i824.prol, align 8, !tbaa !41
...
for.body425.prol.loopexit:                        ; preds = %for.body425.prol, %for.body425.preheader
  ...
  br i1 %291, label %for.body440.lr.ph, label %for.body425
...
for.body408:                                      ; preds = %for.body408, %for.body408.lr.ph.new
  ...
  %add.ptr.i820 = getelementptr inbounds i32, ptr %270, i64 %indvars.iv982
  %292 = load i32, ptr %add.ptr.i820, align 4, !tbaa !5
  %conv411 = sext i32 %292 to i64
  %add.ptr.i821 = getelementptr inbounds double, ptr %call5.i.i.i.i4.i.i811, i64 %conv411
  %293 = load double, ptr %add.ptr.i821, align 8, !tbaa !41
  %add.ptr.i822 = getelementptr inbounds double, ptr %271, i64 %indvars.iv982
  store double %293, ptr %add.ptr.i822, align 8, !tbaa !41
  %indvars.iv.next983 = or i64 %indvars.iv982, 1
  %add.ptr.i820.1 = getelementptr inbounds i32, ptr %270, i64 %indvars.iv.next983
  %294 = load i32, ptr %add.ptr.i820.1, align 4, !tbaa !5
  %conv411.1 = sext i32 %294 to i64
  %add.ptr.i821.1 = getelementptr inbounds double, ptr %call5.i.i.i.i4.i.i811, i64 %conv411.1
  %295 = load double, ptr %add.ptr.i821.1, align 8, !tbaa !41
  %add.ptr.i822.1 = getelementptr inbounds double, ptr %271, i64 %indvars.iv.next983
  store double %295, ptr %add.ptr.i822.1, align 8, !tbaa !41
  %indvars.iv.next983.1 = or i64 %indvars.iv982, 2
  %add.ptr.i820.2 = getelementptr inbounds i32, ptr %270, i64 %indvars.iv.next983.1
  %296 = load i32, ptr %add.ptr.i820.2, align 4, !tbaa !5
  %conv411.2 = sext i32 %296 to i64
  %add.ptr.i821.2 = getelementptr inbounds double, ptr %call5.i.i.i.i4.i.i811, i64 %conv411.2
  %297 = load double, ptr %add.ptr.i821.2, align 8, !tbaa !41
  %add.ptr.i822.2 = getelementptr inbounds double, ptr %271, i64 %indvars.iv.next983.1
  store double %297, ptr %add.ptr.i822.2, align 8, !tbaa !41
  %indvars.iv.next983.2 = or i64 %indvars.iv982, 3
  %add.ptr.i820.3 = getelementptr inbounds i32, ptr %270, i64 %indvars.iv.next983.2
  %298 = load i32, ptr %add.ptr.i820.3, align 4, !tbaa !5
  %conv411.3 = sext i32 %298 to i64
  %add.ptr.i821.3 = getelementptr inbounds double, ptr %call5.i.i.i.i4.i.i811, i64 %conv411.3
  %299 = load double, ptr %add.ptr.i821.3, align 8, !tbaa !41
  %add.ptr.i822.3 = getelementptr inbounds double, ptr %271, i64 %indvars.iv.next983.2
  store double %299, ptr %add.ptr.i822.3, align 8, !tbaa !41
...
for.body440.lr.ph:                                ; preds = %for.body425.prol.loopexit, %for.body425, %middle.block1200
  %300 = load ptr, ptr %z_order, align 8, !tbaa !78
  %y445 = getelementptr inbounds %class.Mesh, ptr %this, i64 0, i32 77
  %301 = load ptr, ptr %y445, align 8, !tbaa !87
  %xtraiter1317 = and i64 %224, 3
  %302 = icmp ult i64 %238, 3
  br i1 %302, label %for.body457.lr.ph.unr-lcssa, label %for.body440.lr.ph.new
...
for.body425:                                      ; preds = %for.body425.prol.loopexit, %for.body425
  ...
  %add.ptr.i823 = getelementptr inbounds double, ptr %279, i64 %indvars.iv988
  %303 = load double, ptr %add.ptr.i823, align 8, !tbaa !41
  %add.ptr.i824 = getelementptr inbounds double, ptr %call5.i.i.i.i4.i.i811, i64 %indvars.iv988
  store double %303, ptr %add.ptr.i824, align 8, !tbaa !41
  %indvars.iv.next989 = add nuw nsw i64 %indvars.iv988, 1
  %add.ptr.i823.1 = getelementptr inbounds double, ptr %279, i64 %indvars.iv.next989
  %304 = load double, ptr %add.ptr.i823.1, align 8, !tbaa !41
  %add.ptr.i824.1 = getelementptr inbounds double, ptr %call5.i.i.i.i4.i.i811, i64 %indvars.iv.next989
  store double %304, ptr %add.ptr.i824.1, align 8, !tbaa !41
  %indvars.iv.next989.1 = add nuw nsw i64 %indvars.iv988, 2
  %add.ptr.i823.2 = getelementptr inbounds double, ptr %279, i64 %indvars.iv.next989.1
  %305 = load double, ptr %add.ptr.i823.2, align 8, !tbaa !41
  %add.ptr.i824.2 = getelementptr inbounds double, ptr %call5.i.i.i.i4.i.i811, i64 %indvars.iv.next989.1
  store double %305, ptr %add.ptr.i824.2, align 8, !tbaa !41
  %indvars.iv.next989.2 = add nuw nsw i64 %indvars.iv988, 3
  %add.ptr.i823.3 = getelementptr inbounds double, ptr %279, i64 %indvars.iv.next989.2
  %306 = load double, ptr %add.ptr.i823.3, align 8, !tbaa !41
  %add.ptr.i824.3 = getelementptr inbounds double, ptr %call5.i.i.i.i4.i.i811, i64 %indvars.iv.next989.2
  store double %306, ptr %add.ptr.i824.3, align 8, !tbaa !41
...
for.body440.epil:                                 ; preds = %for.body457.lr.ph.unr-lcssa, %for.body440.epil
  ...
  %add.ptr.i825.epil = getelementptr inbounds i32, ptr %300, i64 %indvars.iv994.epil
  %307 = load i32, ptr %add.ptr.i825.epil, align 4, !tbaa !5
  %conv443.epil = sext i32 %307 to i64
  %add.ptr.i826.epil = getelementptr inbounds double, ptr %call5.i.i.i.i4.i.i811, i64 %conv443.epil
  %308 = load double, ptr %add.ptr.i826.epil, align 8, !tbaa !41
  %add.ptr.i827.epil = getelementptr inbounds double, ptr %301, i64 %indvars.iv994.epil
  store double %308, ptr %add.ptr.i827.epil, align 8, !tbaa !41
...
for.body457.lr.ph:                                ; preds = %for.body440.epil, %for.body457.lr.ph.unr-lcssa
  ...
  %309 = load ptr, ptr %dy458, align 8, !tbaa !87
  %wide.trip.count1004 = and i64 %224, 4294967295
  %min.iters.check1217 = icmp ult i64 %wide.trip.count, 6
  %310 = ptrtoint ptr %309 to i64
  %311 = sub i64 %call5.i.i.i.i4.i.i8111170, %310
  %diff.check1214 = icmp ult i64 %311, 32
...
vector.body1223:                                  ; preds = %vector.body1223, %vector.ph1218
  ...
  %312 = getelementptr inbounds double, ptr %309, i64 %index1224
  %wide.load1225 = load <2 x double>, ptr %312, align 8, !tbaa !41
  %313 = getelementptr inbounds double, ptr %312, i64 2
  %wide.load1226 = load <2 x double>, ptr %313, align 8, !tbaa !41
  %314 = getelementptr inbounds double, ptr %call5.i.i.i.i4.i.i811, i64 %index1224
  store <2 x double> %wide.load1225, ptr %314, align 8, !tbaa !41
  %315 = getelementptr inbounds double, ptr %314, i64 2
  store <2 x double> %wide.load1226, ptr %315, align 8, !tbaa !41
  %index.next1227 = add nuw i64 %index1224, 4
  %316 = icmp eq i64 %index.next1227, %n.vec1220
  br i1 %316, label %middle.block1215, label %vector.body1223, !llvm.loop !135
...
for.body457.preheader:                            ; preds = %for.body457.lr.ph, %middle.block1215
  ...
  %317 = sub i64 %224, %indvars.iv1000.ph
  %318 = xor i64 %indvars.iv1000.ph, -1
  %319 = add nsw i64 %wide.trip.count, %318
  %xtraiter1322 = and i64 %317, 3
...
for.body457.prol:                                 ; preds = %for.body457.preheader, %for.body457.prol
  ...
  %add.ptr.i828.prol = getelementptr inbounds double, ptr %309, i64 %indvars.iv1000.prol
  %320 = load double, ptr %add.ptr.i828.prol, align 8, !tbaa !41
  %add.ptr.i829.prol = getelementptr inbounds double, ptr %call5.i.i.i.i4.i.i811, i64 %indvars.iv1000.prol
  store double %320, ptr %add.ptr.i829.prol, align 8, !tbaa !41
...
for.body457.prol.loopexit:                        ; preds = %for.body457.prol, %for.body457.preheader
  ...
  br i1 %321, label %for.body472.lr.ph, label %for.body457
...
for.body440:                                      ; preds = %for.body440, %for.body440.lr.ph.new
  ...
  %add.ptr.i825 = getelementptr inbounds i32, ptr %300, i64 %indvars.iv994
  %322 = load i32, ptr %add.ptr.i825, align 4, !tbaa !5
  %conv443 = sext i32 %322 to i64
  %add.ptr.i826 = getelementptr inbounds double, ptr %call5.i.i.i.i4.i.i811, i64 %conv443
  %323 = load double, ptr %add.ptr.i826, align 8, !tbaa !41
  %add.ptr.i827 = getelementptr inbounds double, ptr %301, i64 %indvars.iv994
  store double %323, ptr %add.ptr.i827, align 8, !tbaa !41
  %indvars.iv.next995 = or i64 %indvars.iv994, 1
  %add.ptr.i825.1 = getelementptr inbounds i32, ptr %300, i64 %indvars.iv.next995
  %324 = load i32, ptr %add.ptr.i825.1, align 4, !tbaa !5
  %conv443.1 = sext i32 %324 to i64
  %add.ptr.i826.1 = getelementptr inbounds double, ptr %call5.i.i.i.i4.i.i811, i64 %conv443.1
  %325 = load double, ptr %add.ptr.i826.1, align 8, !tbaa !41
  %add.ptr.i827.1 = getelementptr inbounds double, ptr %301, i64 %indvars.iv.next995
  store double %325, ptr %add.ptr.i827.1, align 8, !tbaa !41
  %indvars.iv.next995.1 = or i64 %indvars.iv994, 2
  %add.ptr.i825.2 = getelementptr inbounds i32, ptr %300, i64 %indvars.iv.next995.1
  %326 = load i32, ptr %add.ptr.i825.2, align 4, !tbaa !5
  %conv443.2 = sext i32 %326 to i64
  %add.ptr.i826.2 = getelementptr inbounds double, ptr %call5.i.i.i.i4.i.i811, i64 %conv443.2
  %327 = load double, ptr %add.ptr.i826.2, align 8, !tbaa !41
  %add.ptr.i827.2 = getelementptr inbounds double, ptr %301, i64 %indvars.iv.next995.1
  store double %327, ptr %add.ptr.i827.2, align 8, !tbaa !41
  %indvars.iv.next995.2 = or i64 %indvars.iv994, 3
  %add.ptr.i825.3 = getelementptr inbounds i32, ptr %300, i64 %indvars.iv.next995.2
  %328 = load i32, ptr %add.ptr.i825.3, align 4, !tbaa !5
  %conv443.3 = sext i32 %328 to i64
  %add.ptr.i826.3 = getelementptr inbounds double, ptr %call5.i.i.i.i4.i.i811, i64 %conv443.3
  %329 = load double, ptr %add.ptr.i826.3, align 8, !tbaa !41
  %add.ptr.i827.3 = getelementptr inbounds double, ptr %301, i64 %indvars.iv.next995.2
  store double %329, ptr %add.ptr.i827.3, align 8, !tbaa !41
...
for.body472.lr.ph:                                ; preds = %for.body457.prol.loopexit, %for.body457, %middle.block1215
  %330 = load ptr, ptr %z_order, align 8, !tbaa !78
  %dy477 = getelementptr inbounds %class.Mesh, ptr %this, i64 0, i32 78
  %331 = load ptr, ptr %dy477, align 8, !tbaa !87
  %xtraiter1325 = and i64 %224, 3
  %332 = icmp ult i64 %238, 3
  br i1 %332, label %if.then.i.i.i831.loopexit.unr-lcssa, label %for.body472.lr.ph.new
...
for.body457:                                      ; preds = %for.body457.prol.loopexit, %for.body457
  ...
  %add.ptr.i828 = getelementptr inbounds double, ptr %309, i64 %indvars.iv1000
  %333 = load double, ptr %add.ptr.i828, align 8, !tbaa !41
  %add.ptr.i829 = getelementptr inbounds double, ptr %call5.i.i.i.i4.i.i811, i64 %indvars.iv1000
  store double %333, ptr %add.ptr.i829, align 8, !tbaa !41
  %indvars.iv.next1001 = add nuw nsw i64 %indvars.iv1000, 1
  %add.ptr.i828.1 = getelementptr inbounds double, ptr %309, i64 %indvars.iv.next1001
  %334 = load double, ptr %add.ptr.i828.1, align 8, !tbaa !41
  %add.ptr.i829.1 = getelementptr inbounds double, ptr %call5.i.i.i.i4.i.i811, i64 %indvars.iv.next1001
  store double %334, ptr %add.ptr.i829.1, align 8, !tbaa !41
  %indvars.iv.next1001.1 = add nuw nsw i64 %indvars.iv1000, 2
  %add.ptr.i828.2 = getelementptr inbounds double, ptr %309, i64 %indvars.iv.next1001.1
  %335 = load double, ptr %add.ptr.i828.2, align 8, !tbaa !41
  %add.ptr.i829.2 = getelementptr inbounds double, ptr %call5.i.i.i.i4.i.i811, i64 %indvars.iv.next1001.1
  store double %335, ptr %add.ptr.i829.2, align 8, !tbaa !41
  %indvars.iv.next1001.2 = add nuw nsw i64 %indvars.iv1000, 3
  %add.ptr.i828.3 = getelementptr inbounds double, ptr %309, i64 %indvars.iv.next1001.2
  %336 = load double, ptr %add.ptr.i828.3, align 8, !tbaa !41
  %add.ptr.i829.3 = getelementptr inbounds double, ptr %call5.i.i.i.i4.i.i811, i64 %indvars.iv.next1001.2
  store double %336, ptr %add.ptr.i829.3, align 8, !tbaa !41
...
for.body472.epil:                                 ; preds = %if.then.i.i.i831.loopexit.unr-lcssa, %for.body472.epil
  ...
  %add.ptr.i833.epil = getelementptr inbounds i32, ptr %330, i64 %indvars.iv1006.epil
  %337 = load i32, ptr %add.ptr.i833.epil, align 4, !tbaa !5
  %conv475.epil = sext i32 %337 to i64
  %add.ptr.i834.epil = getelementptr inbounds double, ptr %call5.i.i.i.i4.i.i811, i64 %conv475.epil
  %338 = load double, ptr %add.ptr.i834.epil, align 8, !tbaa !41
  %add.ptr.i835.epil = getelementptr inbounds double, ptr %331, i64 %indvars.iv1006.epil
  store double %338, ptr %add.ptr.i835.epil, align 8, !tbaa !41
...
for.body472:                                      ; preds = %for.body472, %for.body472.lr.ph.new
  ...
  %add.ptr.i833 = getelementptr inbounds i32, ptr %330, i64 %indvars.iv1006
  %339 = load i32, ptr %add.ptr.i833, align 4, !tbaa !5
  %conv475 = sext i32 %339 to i64
  %add.ptr.i834 = getelementptr inbounds double, ptr %call5.i.i.i.i4.i.i811, i64 %conv475
  %340 = load double, ptr %add.ptr.i834, align 8, !tbaa !41
  %add.ptr.i835 = getelementptr inbounds double, ptr %331, i64 %indvars.iv1006
  store double %340, ptr %add.ptr.i835, align 8, !tbaa !41
  %indvars.iv.next1007 = or i64 %indvars.iv1006, 1
  %add.ptr.i833.1 = getelementptr inbounds i32, ptr %330, i64 %indvars.iv.next1007
  %341 = load i32, ptr %add.ptr.i833.1, align 4, !tbaa !5
  %conv475.1 = sext i32 %341 to i64
  %add.ptr.i834.1 = getelementptr inbounds double, ptr %call5.i.i.i.i4.i.i811, i64 %conv475.1
  %342 = load double, ptr %add.ptr.i834.1, align 8, !tbaa !41
  %add.ptr.i835.1 = getelementptr inbounds double, ptr %331, i64 %indvars.iv.next1007
  store double %342, ptr %add.ptr.i835.1, align 8, !tbaa !41
  %indvars.iv.next1007.1 = or i64 %indvars.iv1006, 2
  %add.ptr.i833.2 = getelementptr inbounds i32, ptr %330, i64 %indvars.iv.next1007.1
  %343 = load i32, ptr %add.ptr.i833.2, align 4, !tbaa !5
  %conv475.2 = sext i32 %343 to i64
  %add.ptr.i834.2 = getelementptr inbounds double, ptr %call5.i.i.i.i4.i.i811, i64 %conv475.2
  %344 = load double, ptr %add.ptr.i834.2, align 8, !tbaa !41
  %add.ptr.i835.2 = getelementptr inbounds double, ptr %331, i64 %indvars.iv.next1007.1
  store double %344, ptr %add.ptr.i835.2, align 8, !tbaa !41
  %indvars.iv.next1007.2 = or i64 %indvars.iv1006, 3
  %add.ptr.i833.3 = getelementptr inbounds i32, ptr %330, i64 %indvars.iv.next1007.2
  %345 = load i32, ptr %add.ptr.i833.3, align 4, !tbaa !5
  %conv475.3 = sext i32 %345 to i64
  %add.ptr.i834.3 = getelementptr inbounds double, ptr %call5.i.i.i.i4.i.i811, i64 %conv475.3
  %346 = load double, ptr %add.ptr.i834.3, align 8, !tbaa !41
  %add.ptr.i835.3 = getelementptr inbounds double, ptr %331, i64 %indvars.iv.next1007.2
  store double %346, ptr %add.ptr.i835.3, align 8, !tbaa !41
...
ehcleanup485:                                     ; preds = %lpad351, %lpad328
  %.pn = phi { ptr, i32 } [ %242, %lpad351 ], [ %241, %lpad328 ]
...
sw.epilog.invoke:                                 ; preds = %for.body, %if.end64, %sw.bb246, %if.end, %if.end243, %if.end484, %sw.epilog.sink.split, %for.cond.preheader
  %347 = load i64, ptr %tstart_cpu, align 8
  ...
  %348 = invoke double @cpu_timer_stop(i64 %347, i64 %agg.tmp.sroa.2.0.copyload)
...
cleanup:                                          ; preds = %sw.epilog.invoke
  ...
  %349 = load double, ptr %arrayidx492, align 8, !tbaa !41
  %add493 = fadd double %348, %349
  store double %add493, ptr %arrayidx492, align 8, !tbaa !41
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %tstart_cpu) #19
  %350 = load ptr, ptr %junit, align 8, !tbaa !87
  %tobool.not.i.i.i842 = icmp eq ptr %350, null
...
_ZNSt6vectorIdSaIdEED2Ev.exit844:                 ; preds = %cleanup, %if.then.i.i.i843
  ...
  %351 = load ptr, ptr %iunit, align 8, !tbaa !87
  %tobool.not.i.i.i845 = icmp eq ptr %351, null
...
_ZNSt6vectorIdSaIdEED2Ev.exit847:                 ; preds = %_ZNSt6vectorIdSaIdEED2Ev.exit844, %if.then.i.i.i846
  ...
  %352 = load ptr, ptr %j_scaled, align 8, !tbaa !78
  %tobool.not.i.i.i848 = icmp eq ptr %352, null
...
_ZNSt6vectorIiSaIiEED2Ev.exit850:                 ; preds = %_ZNSt6vectorIdSaIdEED2Ev.exit847, %if.then.i.i.i849
  ...
  %353 = load ptr, ptr %i_scaled, align 8, !tbaa !78
  %tobool.not.i.i.i851 = icmp eq ptr %353, null
...
_ZNSt6vectorIiSaIiEED2Ev.exit853:                 ; preds = %_ZNSt6vectorIiSaIiEED2Ev.exit850, %if.then.i.i.i852
  ...
  %354 = load ptr, ptr %z_index, align 8, !tbaa !78
  %tobool.not.i.i.i854 = icmp eq ptr %354, null
...
ehcleanup496:                                     ; preds = %lpad9, %if.then.i.i.i736, %ehcleanup, %lpad92, %if.then.i.i.i840, %ehcleanup485, %lpad322, %lpad2, %lpad
  %.pn905.pn = phi { ptr, i32 } [ %2, %lpad ], [ %3, %lpad2 ], [ %16, %lpad9 ], [ %82, %lpad92 ], [ %.pn904, %ehcleanup ], [ %.pn904, %if.then.i.i.i736 ], [ %240, %lpad322 ], [ %.pn, %ehcleanup485 ], [ %.pn, %if.then.i.i.i840 ]
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %tstart_cpu) #19
  %355 = load ptr, ptr %junit, align 8, !tbaa !87
  %tobool.not.i.i.i857 = icmp eq ptr %355, null
...
_ZNSt6vectorIdSaIdEED2Ev.exit859:                 ; preds = %ehcleanup496, %if.then.i.i.i858
  call void @llvm.lifetime.end.p0(i64 24, ptr nonnull %junit) #19
  %356 = load ptr, ptr %iunit, align 8, !tbaa !87
  %tobool.not.i.i.i860 = icmp eq ptr %356, null
...
_ZNSt6vectorIdSaIdEED2Ev.exit862:                 ; preds = %_ZNSt6vectorIdSaIdEED2Ev.exit859, %if.then.i.i.i861
  call void @llvm.lifetime.end.p0(i64 24, ptr nonnull %iunit) #19
  %357 = load ptr, ptr %j_scaled, align 8, !tbaa !78
  %tobool.not.i.i.i863 = icmp eq ptr %357, null
...
_ZNSt6vectorIiSaIiEED2Ev.exit865:                 ; preds = %_ZNSt6vectorIdSaIdEED2Ev.exit862, %if.then.i.i.i864
  call void @llvm.lifetime.end.p0(i64 24, ptr nonnull %j_scaled) #19
  %358 = load ptr, ptr %i_scaled, align 8, !tbaa !78
  %tobool.not.i.i.i866 = icmp eq ptr %358, null
...
_ZNSt6vectorIiSaIiEED2Ev.exit868:                 ; preds = %_ZNSt6vectorIiSaIiEED2Ev.exit865, %if.then.i.i.i867
  call void @llvm.lifetime.end.p0(i64 24, ptr nonnull %i_scaled) #19
  %359 = load ptr, ptr %z_index, align 8, !tbaa !78
  %tobool.not.i.i.i869 = icmp eq ptr %359, null
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  store <4 x i32> %broadcast.splat41, ptr %5, align 4, !tbaa !5
  %index.next = add nuw i64 %index, 8
  %6 = icmp eq i64 %index.next, %n.vec
  br i1 %6, label %middle.block, label %vector.body, !llvm.loop !141
...
vector.body242:                                   ; preds = %vector.body242, %vector.ph236
  ...
  %8 = shl i64 %index243, 2
  %next.gep244 = getelementptr i8, ptr %__position.coerce, i64 %8
  store <4 x i32> %broadcast.splat247, ptr %next.gep244, align 4, !tbaa !5
  %9 = getelementptr i32, ptr %next.gep244, i64 4
  store <4 x i32> %broadcast.splat249, ptr %9, align 4, !tbaa !5
  %index.next250 = add nuw i64 %index243, 8
  %10 = icmp eq i64 %index.next250, %n.vec238
  br i1 %10, label %middle.block233, label %vector.body242, !llvm.loop !145
...
vector.ph:                                        ; preds = %if.end.i.i.i.i.i
  ...
  %broadcast.splat = shufflevector <4 x i32> %broadcast.splatinsert, <4 x i32> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert213 = insertelement <4 x i32> poison, i32 %2, i64 0
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  store <4 x i32> %broadcast.splat214, ptr %18, align 4, !tbaa !5
  %index.next = add nuw i64 %index, 8
...
invoke.cont43.thread:                             ; preds = %invoke.cont35
  %add.ptr47207 = getelementptr inbounds i32, ptr %20, i64 %sub.ptr.div.i
  store ptr %add.ptr47207, ptr %_M_finish, align 8, !tbaa !77
  br label %if.end110
...
vector.body224:                                   ; preds = %vector.body224, %vector.ph218
  ...
  %27 = shl i64 %index225, 2
  %next.gep226 = getelementptr i8, ptr %__position.coerce, i64 %27
  store <4 x i32> %broadcast.splat229, ptr %next.gep226, align 4, !tbaa !5
  %28 = getelementptr i32, ptr %next.gep226, i64 4
  store <4 x i32> %broadcast.splat231, ptr %28, align 4, !tbaa !5
  %index.next232 = add nuw i64 %index225, 8
  %29 = icmp eq i64 %index.next232, %n.vec220
  br i1 %29, label %middle.block215, label %vector.body224, !llvm.loop !149
...
_ZNKSt6vectorIiSaIiEE12_M_check_lenEmPKc.exit:    ; preds = %if.else50
  ...
  br i1 %cmp.not.i, label %if.end.i.i.i.i.i171, label %_ZNSt16allocator_traitsISaIiEE8allocateERS0_m.exit.i
...
if.end.i.i.i.i.i171:                              ; preds = %_ZNSt16allocator_traitsISaIiEE8allocateERS0_m.exit.i, %_ZNKSt6vectorIiSaIiEE12_M_check_lenEmPKc.exit
  ...
  %min.iters.check253 = icmp ult i64 %33, 7
...
vector.ph254:                                     ; preds = %if.end.i.i.i.i.i171
  %n.vec256 = and i64 %34, -8
  %35 = shl i64 %n.vec256, 2
  %ind.end257 = getelementptr i8, ptr %add.ptr57, i64 %35
  %broadcast.splatinsert264 = insertelement <4 x i32> poison, i32 %31, i64 0
  %broadcast.splat265 = shufflevector <4 x i32> %broadcast.splatinsert264, <4 x i32> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert266 = insertelement <4 x i32> poison, i32 %31, i64 0
...
vector.body260:                                   ; preds = %vector.body260, %vector.ph254
  ...
  %36 = shl i64 %index261, 2
  %next.gep262 = getelementptr i8, ptr %add.ptr57, i64 %36
  store <4 x i32> %broadcast.splat265, ptr %next.gep262, align 4, !tbaa !5
  %37 = getelementptr i32, ptr %next.gep262, i64 4
  store <4 x i32> %broadcast.splat267, ptr %37, align 4, !tbaa !5
  %index.next268 = add nuw i64 %index261, 8
  %38 = icmp eq i64 %index.next268, %n.vec256
  br i1 %38, label %middle.block251, label %vector.body260, !llvm.loop !151
...
if.end110:                                        ; preds = %for.body.i.i.i162, %for.body.i.i.i, %middle.block215, %middle.block233, %invoke.cont43.thread, %_ZNSt12_Vector_baseIiSaIiEE13_M_deallocateEPim.exit, %entry
  ret void
}
