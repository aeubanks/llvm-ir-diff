...
if.end.i.i:                                       ; preds = %call.i.i32.i.noexc
  ...
  %call.i35.i = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %15) #20
          to label %invoke.cont.i unwind label %_ZN11CStringBaseIwED2Ev.exit.i, !noalias !76
...
ehcleanup:                                        ; preds = %delete.notnull.i158, %lpad14, %lpad12, %_ZN11CStringBaseIwED2Ev.exit.i
  %.pn319 = phi { ptr, i32 } [ %45, %lpad12 ], [ %34, %_ZN11CStringBaseIwED2Ev.exit.i ], [ %46, %lpad14 ], [ %46, %delete.notnull.i158 ]
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %ref.tmp) #17
...
if.end.i.i230:                                    ; preds = %call.i.i32.i.noexc246
  ...
  %call.i35.i229 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %51) #20
          to label %invoke.cont.i232 unwind label %_ZN11CStringBaseIwED2Ev.exit.i238, !noalias !85
...
_ZN11CStringBaseIwED2Ev.exit.i238:                ; preds = %if.end.i.i230
  %70 = landingpad { ptr, i32 }
          cleanup
  call void @_ZdaPv(ptr noundef nonnull %call.i.i32.i247) #21, !noalias !85
...
ehcleanup38:                                      ; preds = %delete.notnull.i167, %lpad34, %lpad32, %_ZN11CStringBaseIwED2Ev.exit.i238
  %.pn317 = phi { ptr, i32 } [ %81, %lpad32 ], [ %70, %_ZN11CStringBaseIwED2Ev.exit.i238 ], [ %82, %lpad34 ], [ %82, %delete.notnull.i167 ]
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %ref.tmp31) #17
...
if.then59:                                        ; preds = %_ZN11CStringBaseIwED2Ev.exit174
  ...
  %87 = load i32, ptr %_length.i, align 8, !noalias !54
...
if.end.i.i260:                                    ; preds = %call.i.i32.i.noexc276
  ...
  %call.i35.i259 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %90) #20
          to label %invoke.cont.i262 unwind label %_ZN11CStringBaseIwED2Ev.exit.i268, !noalias !91
...
_ZN11CStringBaseIwED2Ev.exit.i268:                ; preds = %if.end.i.i260
...
ehcleanup68:                                      ; preds = %delete.notnull.i185, %lpad64, %lpad62, %_ZN11CStringBaseIwED2Ev.exit.i268
  %.pn315 = phi { ptr, i32 } [ %123, %lpad62 ], [ %109, %_ZN11CStringBaseIwED2Ev.exit.i268 ], [ %124, %lpad64 ], [ %124, %delete.notnull.i185 ]
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %ref.tmp61) #17
...
if.then89:                                        ; preds = %_ZN11CStringBaseIwED2Ev.exit194
  ...
  %129 = load i32, ptr %_length.i, align 8, !noalias !54
...
if.end.i.i290:                                    ; preds = %call.i.i32.i.noexc306
  ...
  %call.i35.i289 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %132) #20
          to label %invoke.cont.i292 unwind label %_ZN11CStringBaseIwED2Ev.exit.i298, !noalias !97
...
_ZN11CStringBaseIwED2Ev.exit.i298:                ; preds = %if.end.i.i290
...
ehcleanup99:                                      ; preds = %delete.notnull.i205, %lpad95, %lpad92, %_ZN11CStringBaseIwED2Ev.exit.i298
  %.pn313 = phi { ptr, i32 } [ %165, %lpad92 ], [ %151, %_ZN11CStringBaseIwED2Ev.exit.i298 ], [ %166, %lpad95 ], [ %166, %delete.notnull.i205 ]
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %ref.tmp91) #17
  br label %ehcleanup115
