...
for.body69:                                       ; preds = %for.body69.preheader, %for.body69
  ...
  %shift468 = shufflevector <2 x double> %142, <2 x double> poison, <2 x i32> <i32 1, i32 undef>
  %209 = fadd <2 x double> %shift468, %153
  %add181 = extractelement <2 x double> %209, i64 0
  %shift469 = shufflevector <2 x double> %161, <2 x double> poison, <2 x i32> <i32 1, i32 undef>
  %210 = fadd <2 x double> %shift469, %172
  %add182 = extractelement <2 x double> %210, i64 0
  %shift470 = shufflevector <2 x double> %180, <2 x double> poison, <2 x i32> <i32 1, i32 undef>
  %211 = fadd <2 x double> %180, %shift470
...
invoke.cont242.us.us.us.us.us.us:                 ; preds = %complex_mul_libcall.i.i685.us.us.us.us.us.us, %complex_mul_imag_nan.i.i683.us.us.us.us.us.us, %invoke.cont233.us.us.us.us.us.us
  ...
  %shift867 = shufflevector <2 x double> %177, <2 x double> poison, <2 x i32> <i32 1, i32 undef>
