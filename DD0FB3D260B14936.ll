...
if.end.i947:                                      ; preds = %for.inc.i.i, %if.end250
  ...
  %cmp.i.not720.i = icmp eq ptr %ProblemClauses.0, null
  br i1 %cmp.i.not720.i, label %for.end.i951, label %for.body.i950

for.body.i950:                                    ; preds = %if.end.i947, %for.body.i950
  %Scan.0721.i = phi ptr [ %Scan.0.val446.i, %for.body.i950 ], [ %ProblemClauses.0, %if.end.i947 ]
  %188 = getelementptr i8, ptr %Scan.0721.i, i64 8
  ...
  %Scan.0.val446.i = load ptr, ptr %Scan.0721.i, align 8
...
if.then27.i:                                      ; preds = %if.end25.i
  ...
  br i1 %cmp.i.not720.i, label %if.end39.thread.i, label %for.body34.i

for.body34.i:                                     ; preds = %if.then27.i, %for.body34.i
  %Scan.1723.i = phi ptr [ %Scan.1.val445.i, %for.body34.i ], [ %ProblemClauses.0, %if.then27.i ]
  %199 = getelementptr i8, ptr %Scan.1723.i, i64 8
  ...
  %Scan.1.val445.i = load ptr, ptr %Scan.1723.i, align 8
...
if.end39.thread.i:                                ; preds = %if.then27.i
  %arrayidx.i481748.i = getelementptr inbounds i32, ptr %Search.val435.i, i64 39
  %201 = load i32, ptr %arrayidx.i481748.i, align 4
  %tobool41.not749.i = icmp eq i32 %201, 0
  br i1 %tobool41.not749.i, label %if.end60.i, label %if.then42.i

for.cond51.preheader.i:                           ; preds = %if.end39.i
  br i1 %cmp.i.not720.i, label %if.end60.i, label %for.body55.i
...
for.body55.i:                                     ; preds = %for.cond51.preheader.i, %for.body55.i
  %Scan.2725.i = phi ptr [ %Scan.2.val444.i, %for.body55.i ], [ %ProblemClauses.0, %for.cond51.preheader.i ]
  %203 = getelementptr i8, ptr %Scan.2725.i, i64 8
  %Scan.2.val.i = load ptr, ptr %203, align 8
  call void @prfs_InsertUsableClause(ptr noundef %call2, ptr noundef %Scan.2.val.i) #14
  %Scan.2.val444.i = load ptr, ptr %Scan.2725.i, align 8
...
if.end78.i:                                       ; preds = %if.end76.i, %land.lhs.true66.i, %lor.lhs.false.i
  %Scan.3726.i = load ptr, ptr %120, align 8
  %cmp.i489.not727.i = icmp eq ptr %Scan.3726.i, null
  br i1 %cmp.i489.not727.i, label %for.end103.i, label %for.body84.i

for.cond94.preheader.i:                           ; preds = %for.body84.i
  %Scan.4729.pre.i = load ptr, ptr %120, align 8
  %cmp.i491.not730.i = icmp eq ptr %Scan.4729.pre.i, null
  br i1 %cmp.i491.not730.i, label %for.end103.i, label %for.body98.i

for.body84.i:                                     ; preds = %if.end78.i, %for.body84.i
  %Scan.3728.i = phi ptr [ %Scan.3.i, %for.body84.i ], [ %Scan.3726.i, %if.end78.i ]
  %208 = getelementptr i8, ptr %Scan.3728.i, i64 8
  ...
  %Scan.3.i = load ptr, ptr %Scan.3728.i, align 8
...
for.body98.i:                                     ; preds = %for.cond94.preheader.i, %for.body98.i
  %Scan.4731.i = phi ptr [ %Scan.4.i, %for.body98.i ], [ %Scan.4729.pre.i, %for.cond94.preheader.i ]
  %209 = getelementptr i8, ptr %Scan.4731.i, i64 8
  %Scan.4.val.i = load ptr, ptr %209, align 8
  call void @clause_CountSymbols(ptr noundef %Scan.4.val.i) #14
  %Scan.4.i = load ptr, ptr %Scan.4731.i, align 8
...
if.then108.i:                                     ; preds = %for.end103.i
  ...
  %cond737.i = icmp eq ptr %call110.i, null
  br i1 %cond737.i, label %if.end125.i, label %for.body115.i

for.body115.i:                                    ; preds = %if.then108.i, %for.inc122.i
  %Scan.5733.i = phi ptr [ %Scan.5.val441.i, %for.inc122.i ], [ %call110.i, %if.then108.i ]
  %211 = getelementptr i8, ptr %Scan.5733.i, i64 8
...
for.inc122.i:                                     ; preds = %if.then119.i, %for.body115.i
  %Scan.5.val441.i = load ptr, ptr %Scan.5733.i, align 8
...
while.cond.i.outer:                               ; preds = %while.cond.i.outer.backedge, %if.end134.i
  ...
  %ActBound.0.i.ph = phi i32 [ %193, %if.end134.i ], [ %..pr714.i, %while.cond.i.outer.backedge ]
...
lor.rhs.while.end293_crit_edge.i:                 ; preds = %lor.rhs.i
  %.pre747.i = load ptr, ptr %EmptyClauses.i, align 8
...
while.cond160.i:                                  ; preds = %if.end269.i, %while.body.i955
  ...
  %cmp.i503.i = icmp eq ptr %223, null
  br i1 %cmp.i503.i, label %land.lhs.true166.i, label %lor.lhs.false163.i
...
land.lhs.true170.i:                               ; preds = %land.lhs.true166.i
  ...
  %cmp.i507.i = icmp eq ptr %Search.val447.i, null
  %or.cond713.i = and i1 %cmp.i503.i, %cmp.i507.i
  br i1 %or.cond713.i, label %while.end.i, label %land.rhs177.i
...
for.inc211.i:                                     ; preds = %if.then208.i, %for.body204.i
  %230 = phi ptr [ %228, %for.body204.i ], [ %.pre746.i, %if.then208.i ]
...
land.lhs.true36.i.i:                              ; preds = %if.end34.i.i, %if.end.i527.i
  ...
  %GivenClause.3217.i.i = phi ptr [ %GivenClause.3.ph.i.i, %if.end34.i.i ], [ %239, %if.end.i527.i ]
...
if.then39.i.i:                                    ; preds = %land.lhs.true36.i.i
  %call.i.i.i970 = call fastcc ptr @top_GetLiteralsForSplitting(ptr noundef %GivenClause.3217.i.i)
...
for.body.lr.ph.i.i.i:                             ; preds = %if.then39.i.i
  %272 = getelementptr i8, ptr %GivenClause.3217.i.i, i64 56
...
if.then42.i.i:                                    ; preds = %top_GetOptimalSplitLiteralIndex.exit.i.i
  ...
  %call45.i.i = call ptr @prfs_DoSplitting(ptr noundef %call2, ptr noundef nonnull %GivenClause.3217.i.i, ptr noundef nonnull %call.i.i192.i.i) #14
...
if.else46.i.i:                                    ; preds = %top_GetOptimalSplitLiteralIndex.exit.i.i, %if.then39.i.i
  %call47.i.i = call ptr @prfs_PerformSplitting(ptr noundef %call2, ptr noundef %GivenClause.3217.i.i) #14
...
if.end49.i.i:                                     ; preds = %while.body.i201.i.i, %if.else46.i.i, %land.lhs.true36.i.i, %if.end34.i.i
  ...
  %GivenClause.3218.i.i = phi ptr [ %GivenClause.3217.i.i, %land.lhs.true36.i.i ], [ %GivenClause.3217.i.i, %if.else46.i.i ], [ %GivenClause.3.ph.i.i, %if.end34.i.i ], [ %GivenClause.3217.i.i, %while.body.i201.i.i ]
  call void @prfs_ExtractUsable(ptr noundef %call2, ptr noundef %GivenClause.3218.i.i) #14
...
if.then52.i.i:                                    ; preds = %if.end49.i.i
  ...
  call void @clause_Print(ptr noundef %GivenClause.3218.i.i) #14
...
if.then62.i.i:                                    ; preds = %if.else59.i.i
  ...
  %call66.i.i = call ptr @red_Terminator(ptr noundef %GivenClause.3218.i.i, i32 noundef %295, ptr noundef %Search.val145.i.i, ptr noundef %Search.val142.i.i, ptr noundef nonnull %Search.val.i.i, ptr noundef %Search.val137.i.i) #14
  call void @clock_StopAddPassedTime(i32 noundef 4) #14
...
if.end71.i.i:                                     ; preds = %if.then62.i.i
  ...
  call void @prfs_InsertUsableClause(ptr noundef nonnull %call2, ptr noundef %GivenClause.3218.i.i) #14
  br label %top_FullReductionSelectGivenComputeDerivables.exit.i

if.then74.i.i:                                    ; preds = %if.then62.i.i, %if.else59.i.i
  call void @clause_SelectLiteral(ptr noundef %GivenClause.3218.i.i, ptr noundef nonnull %Search.val.i.i) #14
  call void @prfs_InsertWorkedOffClause(ptr noundef %call2, ptr noundef %GivenClause.3218.i.i) #14
  call void @clock_StartCounter(i32 noundef 5) #14
  %call75.i.i = call ptr @inf_DerivableClauses(ptr noundef %call2, ptr noundef %GivenClause.3218.i.i) #14
...
if.end235.i:                                      ; preds = %top_LazyReductionSelectGivenComputeDerivables.exit.i, %top_FullReductionSelectGivenComputeDerivables.exit.i, %if.end225.i
  ...
  %cmp.i683.not735.i = icmp eq ptr %Derivables.1.i, null
  %or.cond738.i = select i1 %tobool237.not.i, i1 true, i1 %cmp.i683.not735.i
  br i1 %or.cond738.i, label %if.end249.i, label %for.body243.i

for.body243.i:                                    ; preds = %if.end235.i, %for.body243.i
  %Scan.6736.i = phi ptr [ %Scan.6.val440.i, %for.body243.i ], [ %Derivables.1.i, %if.end235.i ]
  %350 = load ptr, ptr @stdout, align 8
  %351 = call i64 @fwrite(ptr nonnull @.str.61, i64 10, i64 1, ptr %350)
  %352 = getelementptr i8, ptr %Scan.6736.i, i64 8
  %Scan.6.val.i = load ptr, ptr %352, align 8
  call void @clause_Print(ptr noundef %Scan.6.val.i) #14
  %Scan.6.val440.i = load ptr, ptr %Scan.6736.i, align 8
...
if.then275.i:                                     ; preds = %while.end.i
  ...
  %.pr714.i = load i32, ptr %BoundApplied, align 4
  %..pr714.i = select i1 %cmp276.i, i32 -1, i32 %.pr714.i
  %cmp281.not.i = icmp eq i32 %.pr714.i, -1
...
if.then286.i:                                     ; preds = %if.then283.i
  %call289.i = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.63, ptr noundef nonnull %cond.i, i32 noundef %..pr714.i)
...
top_ProofSearch.exit:                             ; preds = %lor.lhs.false137.i, %land.lhs.true140.i, %lor.lhs.false147.i, %lor.rhs.while.end293_crit_edge.i
  %361 = phi ptr [ %.pre747.i, %lor.rhs.while.end293_crit_edge.i ], [ %220, %lor.lhs.false147.i ], [ %220, %land.lhs.true140.i ], [ %220, %lor.lhs.false137.i ]
...
for.end438:                                       ; preds = %hsh_DelItem.exit, %if.end429
  br i1 %cmp.i.not720.i, label %list_Delete.exit1071, label %while.body.i1069
