...
while.body.lr.ph:                                 ; preds = %while.cond.preheader
  ...
  br i1 %tobool67.not, label %while.body.lr.ph.split, label %while.body.lr.ph.split.us

while.body.lr.ph.split.us:                        ; preds = %while.body.lr.ph
  br i1 %tobool68.not, label %while.body.us, label %while.body.us.us

while.body.us.us:                                 ; preds = %while.body.lr.ph.split.us, %if.end91.us.us
  ...
  %tobool73.not.us.us = icmp eq i32 %call72.us.us, 0
  br i1 %tobool73.not.us.us, label %if.then74.us.us, label %if.end91.us.us

if.then74.us.us:                                  ; preds = %while.body.us.us
  %12 = load i32, ptr %n, align 8
  %cmp77.us.us = icmp ugt i32 %12, %maxfiles.0.fr
  %13 = load i64, ptr %space, align 8
  %cmp83.us.us = icmp ugt i64 %13, %conv82
  %or.cond172 = select i1 %cmp77.us.us, i1 true, i1 %cmp83.us.us
  br i1 %or.cond172, label %if.then85.us.us, label %if.end91.us.us

if.then85.us.us:                                  ; preds = %if.then74.us.us
  %call88.us.us = call i32 (ptr, ...) @logg(ptr noundef nonnull @.str.143, i32 noundef %12, i64 noundef %13) #18
  %call89.us.us = call i32 @kill(i32 noundef %call23, i32 noundef 9) #18
  br label %if.end91.us.us

if.end91.us.us:                                   ; preds = %if.then74.us.us, %if.then85.us.us, %while.body.us.us
...
while.body.us:                                    ; preds = %while.body.lr.ph.split.us, %if.end91.us
  ...
  %or.cond174 = select i1 %tobool73.not.us, i1 %cmp77.us, i1 false
  br i1 %or.cond174, label %if.then85.us, label %if.end91.us

if.then85.us:                                     ; preds = %while.body.us
  %15 = load i64, ptr %space, align 8, !tbaa !50
  %call88.us = call i32 (ptr, ...) @logg(ptr noundef nonnull @.str.143, i32 noundef %14, i64 noundef %15) #18
  %call89.us = call i32 @kill(i32 noundef %call23, i32 noundef 9) #18
  br label %if.end91.us

if.end91.us:                                      ; preds = %if.then85.us, %while.body.us
...
while.body.lr.ph.split:                           ; preds = %while.body.lr.ph
  br i1 %tobool68.not, label %while.body, label %while.body.us159

while.body.us159:                                 ; preds = %while.body.lr.ph.split, %if.end91.us167
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %n, i8 0, i64 16, i1 false)
  %call72.us160 = call i32 @du(ptr noundef %tmpdir, ptr noundef nonnull %n) #18
  %tobool73.not.us161 = icmp eq i32 %call72.us160, 0
  %16 = load i64, ptr %space, align 8
  %cmp83.us163 = icmp ugt i64 %16, %conv82
  %or.cond173 = select i1 %tobool73.not.us161, i1 %cmp83.us163, i1 false
  br i1 %or.cond173, label %if.then85.us164, label %if.end91.us167

if.then85.us164:                                  ; preds = %while.body.us159
  %17 = load i32, ptr %n, align 8, !tbaa !52
  %call88.us165 = call i32 (ptr, ...) @logg(ptr noundef nonnull @.str.143, i32 noundef %17, i64 noundef %16) #18
  %call89.us166 = call i32 @kill(i32 noundef %call23, i32 noundef 9) #18
  br label %if.end91.us167

if.end91.us167:                                   ; preds = %if.then85.us164, %while.body.us159
  %call70.us168 = call i32 @waitpid(i32 noundef %call23, ptr noundef nonnull %status, i32 noundef 1) #18
  %tobool71.not.us169 = icmp eq i32 %call70.us168, 0
  br i1 %tobool71.not.us169, label %while.body.us159, label %if.end94, !llvm.loop !49
...
if.end94:                                         ; preds = %if.end91.us.us, %if.end91.us, %if.end91.us167, %while.body, %while.cond.preheader, %if.else92
