...
if.then74.us:                                     ; preds = %while.body.us
  ...
  br i1 %cmp77.us, label %if.then85.us, label %if.end91.us
...
if.end91.us:                                      ; preds = %if.then74.us, %if.then85.us, %while.body.us
...
while.body.us159:                                 ; preds = %while.body.lr.ph.split, %if.end91.us167
  ...
  br i1 %tobool73.not.us161, label %if.then74.us162, label %if.end91.us167

if.then74.us162:                                  ; preds = %while.body.us159
  %16 = load i64, ptr %space, align 8
  %cmp83.us163 = icmp ugt i64 %16, %conv82
  br i1 %cmp83.us163, label %if.then85.us164, label %if.end91.us167

if.then85.us164:                                  ; preds = %if.then74.us162
...
if.end91.us167:                                   ; preds = %if.then74.us162, %if.then85.us164, %while.body.us159
