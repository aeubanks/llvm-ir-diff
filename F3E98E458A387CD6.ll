...
for.cond1.i.preheader:                            ; preds = %for.body.i, %ctab_new.exit
  ...
  br i1 %cmp2.i189, label %for.body3.i, label %ctab_rehash.exit
...
for.body3.i:                                      ; preds = %for.cond1.i.preheader, %for.inc13.i
  ...
  %by_name_hash.i = getelementptr inbounds %struct.anon, ptr %0, i64 0, i32 2, i64 %indvars.iv195, i32 1
...
ctab_rehash.exit:                                 ; preds = %for.inc13.i, %for.cond1.i.preheader
  ...
  %.pre198 = load i32, ptr %coltab_count2.phi.trans.insert, align 4, !tbaa !21
  br label %if.end

if.end:                                           ; preds = %ctab_rehash.exit, %entry
  %16 = phi i32 [ %.pre198, %ctab_rehash.exit ], [ %1, %entry ]
...
cond.false96:                                     ; preds = %if.end72
  ...
  %.pre199 = load ptr, ptr @xx_link, align 8, !tbaa !5
