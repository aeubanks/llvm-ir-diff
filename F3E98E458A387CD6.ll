...
if.then29:                                        ; preds = %for.cond.i, %while.end.i
  %call36 = tail call ptr @MakeWord(i32 noundef %conv, ptr noundef nonnull %ostring, ptr noundef nonnull %ou1) #8
...
if.then:                                          ; preds = %entry
  ...
  %call.i181 = tail call noalias ptr @malloc(i64 noundef %add.i) #7
...
if.end.i:                                         ; preds = %if.then.i183, %if.then
  store i32 %mul, ptr %call.i181, align 8, !tbaa !9
  %coltab_count.i184 = getelementptr inbounds %struct.anon, ptr %call.i181, i64 0, i32 1
...
ctab_new.exit:                                    ; preds = %if.end.i, %for.body.preheader.i
  store ptr %call.i181, ptr %NewS.i, align 8, !tbaa !5
...
for.cond1.i.preheader:                            ; preds = %for.body.i, %ctab_new.exit
  ...
  br i1 %cmp2.i188, label %for.body3.i, label %ctab_rehash.exit
...
for.body.i:                                       ; preds = %ctab_new.exit, %for.body.i
  ...
  br i1 %cmp.i.not.not, label %for.body.i, label %for.cond1.i.preheader, !llvm.loop !23
...
for.body3.i:                                      ; preds = %for.cond1.i.preheader, %for.inc13.i
  ...
  %by_name_hash.i = getelementptr inbounds %struct.anon, ptr %0, i64 0, i32 2, i64 %indvars.iv194, i32 1
...
ctab_rehash.exit:                                 ; preds = %for.inc13.i, %for.cond1.i.preheader
  ...
  %.pre197 = load i32, ptr %coltab_count2.phi.trans.insert, align 4, !tbaa !21
  br label %if.end

if.end:                                           ; preds = %ctab_rehash.exit, %entry
  %16 = phi i32 [ %.pre197, %ctab_rehash.exit ], [ %1, %entry ]
...
if.end32:                                         ; preds = %if.then23, %if.else25
  ...
  store ptr %29, ptr %arrayidx35, align 8, !tbaa !12
...
if.end72:                                         ; preds = %if.then61, %if.else63
  ...
  store ptr %35, ptr %arrayidx76, align 8, !tbaa !12
...
cond.false96:                                     ; preds = %if.end72
  ...
  %.pre198 = load ptr, ptr @xx_link, align 8, !tbaa !5
