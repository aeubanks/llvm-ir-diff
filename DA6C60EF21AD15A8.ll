; ModuleID = '/usr/local/google/home/aeubanks/repos/test-suite/MultiSource/Benchmarks/TSVC/Reductions-dbl/tsc.c'
source_filename = "/usr/local/google/home/aeubanks/repos/test-suite/MultiSource/Benchmarks/TSVC/Reductions-dbl/tsc.c"
...
entry:
  %call = tail call i32 @init(ptr noundef nonnull @.str.72)
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
  %cmp17 = icmp sgt i32 %0, 0
  br i1 %cmp17, label %for.cond1.preheader, label %for.cond.cleanup

for.cond1.preheader:                              ; preds = %entry, %for.cond.cleanup3
  %nl.018 = phi i32 [ %inc7, %for.cond.cleanup3 ], [ 0, %entry ]
  br label %for.body4

for.cond.cleanup:                                 ; preds = %for.cond.cleanup3, %entry
  %call9 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.137, double noundef 0.000000e+00)
  br label %for.body.i
...
for.body4:                                        ; preds = %for.body4, %for.cond1.preheader
  ...
  %sum.014 = phi double [ 0.000000e+00, %for.cond1.preheader ], [ %add.4, %for.body4 ]
  %arrayidx = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv
  %8 = load double, ptr %arrayidx, align 8, !tbaa !5
  %add = fadd double %sum.014, %8
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %arrayidx.1 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv.next
  %9 = load double, ptr %arrayidx.1, align 8, !tbaa !5
  %add.1 = fadd double %add, %9
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %arrayidx.2 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv.next.1
  %10 = load double, ptr %arrayidx.2, align 8, !tbaa !5
  %add.2 = fadd double %add.1, %10
  %indvars.iv.next.2 = add nuw nsw i64 %indvars.iv, 3
  %arrayidx.3 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv.next.2
  %11 = load double, ptr %arrayidx.3, align 8, !tbaa !5
  %add.3 = fadd double %add.2, %11
  %indvars.iv.next.3 = add nuw nsw i64 %indvars.iv, 4
  %arrayidx.4 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv.next.3
  %12 = load double, ptr %arrayidx.4, align 8, !tbaa !5
  %add.4 = fadd double %add.3, %12
  %indvars.iv.next.4 = add nuw nsw i64 %indvars.iv, 5
  %exitcond.not.4 = icmp eq i64 %indvars.iv.next.4, 32000
  br i1 %exitcond.not.4, label %for.cond.cleanup3, label %for.body4
}
...
define dso_local double @test(ptr nocapture noundef readonly %A) local_unnamed_addr #9 {
entry:
  %0 = load double, ptr %A, align 8, !tbaa !5
  %add = fadd double %0, 0.000000e+00
  %arrayidx.1 = getelementptr inbounds double, ptr %A, i64 1
  %1 = load double, ptr %arrayidx.1, align 8, !tbaa !5
  %add.1 = fadd double %add, %1
  %arrayidx.2 = getelementptr inbounds double, ptr %A, i64 2
  %2 = load double, ptr %arrayidx.2, align 8, !tbaa !5
  %add.2 = fadd double %add.1, %2
  %arrayidx.3 = getelementptr inbounds double, ptr %A, i64 3
  %3 = load double, ptr %arrayidx.3, align 8, !tbaa !5
  %add.3 = fadd double %add.2, %3
  ret double %add.3
}
...
for.cond.cleanup:                                 ; preds = %for.body, %entry
  %call17 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.138, double noundef 0.000000e+00)
  br label %for.body.i
...
for.body:                                         ; preds = %entry, %for.body
  %nl.058 = phi i32 [ %inc, %for.body ], [ 0, %entry ]
  %7 = load <2 x double>, ptr @global_data, align 32
  %8 = load <2 x double>, ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 0, i64 1), align 8
  %9 = load <2 x double>, ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 0, i64 2), align 16
  %10 = load <2 x double>, ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 0, i64 3), align 8
  %11 = load double, ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 0, i64 4), align 32, !tbaa !5
  %12 = insertelement <2 x double> %7, double %11, i64 1
  %13 = fadd <2 x double> %12, zeroinitializer
  %14 = load double, ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 0, i64 5), align 8, !tbaa !5
  %15 = insertelement <2 x double> %8, double %14, i64 1
  %16 = fadd <2 x double> %13, %15
  %17 = load double, ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 0, i64 6), align 16, !tbaa !5
  %18 = insertelement <2 x double> %9, double %17, i64 1
  %19 = fadd <2 x double> %16, %18
  %20 = load double, ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 0, i64 7), align 8, !tbaa !5
  %21 = insertelement <2 x double> %10, double %20, i64 1
  %22 = fadd <2 x double> %19, %21
  %23 = extractelement <2 x double> %22, i64 0
  %add = fadd double %23, 0.000000e+00
  %24 = extractelement <2 x double> %22, i64 1
  %add3 = fadd double %add, %24
  %25 = load <2 x double>, ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 0, i64 8), align 32
  %26 = load <2 x double>, ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 0, i64 9), align 8
  %27 = load <2 x double>, ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 0, i64 10), align 16
  %28 = load <2 x double>, ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 0, i64 11), align 8
  %29 = load double, ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 0, i64 12), align 32, !tbaa !5
  %30 = insertelement <2 x double> %25, double %29, i64 1
  %31 = fadd <2 x double> %30, zeroinitializer
  %32 = load double, ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 0, i64 13), align 8, !tbaa !5
  %33 = insertelement <2 x double> %26, double %32, i64 1
  %34 = fadd <2 x double> %31, %33
  %35 = load double, ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 0, i64 14), align 16, !tbaa !5
  %36 = insertelement <2 x double> %27, double %35, i64 1
  %37 = fadd <2 x double> %34, %36
  %38 = load double, ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 0, i64 15), align 8, !tbaa !5
  %39 = insertelement <2 x double> %28, double %38, i64 1
  %40 = fadd <2 x double> %37, %39
  %41 = extractelement <2 x double> %40, i64 0
  %add5 = fadd double %add3, %41
  %42 = extractelement <2 x double> %40, i64 1
  %add7 = fadd double %add5, %42
  %43 = load <2 x double>, ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 0, i64 16), align 32
  %44 = load <2 x double>, ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 0, i64 17), align 8
  %45 = load <2 x double>, ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 0, i64 18), align 16
  %46 = load <2 x double>, ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 0, i64 19), align 8
  %47 = load double, ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 0, i64 20), align 32, !tbaa !5
  %48 = insertelement <2 x double> %43, double %47, i64 1
  %49 = fadd <2 x double> %48, zeroinitializer
  %50 = load double, ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 0, i64 21), align 8, !tbaa !5
  %51 = insertelement <2 x double> %44, double %50, i64 1
  %52 = fadd <2 x double> %49, %51
  %53 = load double, ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 0, i64 22), align 16, !tbaa !5
  %54 = insertelement <2 x double> %45, double %53, i64 1
  %55 = fadd <2 x double> %52, %54
  %56 = load double, ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 0, i64 23), align 8, !tbaa !5
  %57 = insertelement <2 x double> %46, double %56, i64 1
  %58 = fadd <2 x double> %55, %57
  %59 = extractelement <2 x double> %58, i64 0
  %add9 = fadd double %add7, %59
  %60 = extractelement <2 x double> %58, i64 1
  %add11 = fadd double %add9, %60
  %61 = load <2 x double>, ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 0, i64 24), align 32
  %62 = load <2 x double>, ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 0, i64 25), align 8
  %63 = load <2 x double>, ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 0, i64 26), align 16
  %64 = load <2 x double>, ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 0, i64 27), align 8
  %65 = load double, ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 0, i64 28), align 32, !tbaa !5
  %66 = insertelement <2 x double> %61, double %65, i64 1
  %67 = fadd <2 x double> %66, zeroinitializer
  %68 = load double, ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 0, i64 29), align 8, !tbaa !5
  %69 = insertelement <2 x double> %62, double %68, i64 1
  %70 = fadd <2 x double> %67, %69
  %71 = load double, ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 0, i64 30), align 16, !tbaa !5
  %72 = insertelement <2 x double> %63, double %71, i64 1
  %73 = fadd <2 x double> %70, %72
  %74 = load double, ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 0, i64 31), align 8, !tbaa !5
  %75 = insertelement <2 x double> %64, double %74, i64 1
  %76 = fadd <2 x double> %73, %75
  %77 = extractelement <2 x double> %76, i64 0
  %add13 = fadd double %add11, %77
  %78 = extractelement <2 x double> %76, i64 1
  %add15 = fadd double %add13, %78
  %call16 = tail call i32 @dummy(ptr noundef nonnull @global_data, ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 11, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 20, i64 0, i64 0), double noundef %add15) #17
  %inc = add nuw nsw i32 %nl.058, 1
  %79 = load i32, ptr @ntimes, align 4, !tbaa !17
  %mul = mul nsw i32 %79, 2000
...
entry:
  %call = tail call i32 @init(ptr noundef nonnull @.str.73)
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
  %cmp19 = icmp sgt i32 %0, 0
  br i1 %cmp19, label %for.cond1.preheader, label %for.cond.cleanup

for.cond1.preheader:                              ; preds = %entry, %for.cond.cleanup3
  %nl.020 = phi i32 [ %inc8, %for.cond.cleanup3 ], [ 0, %entry ]
  br label %for.body4

for.cond.cleanup:                                 ; preds = %for.cond.cleanup3, %entry
  %prod.0.lcssa = phi double [ undef, %entry ], [ %mul5.4, %for.cond.cleanup3 ]
  %call10 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.139, double noundef 0.000000e+00)
  store double %prod.0.lcssa, ptr @temp, align 8, !tbaa !5
  %1 = load i32, ptr @digits, align 4, !tbaa !17
  %call126.i = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %1, double noundef %prod.0.lcssa)
  ret i32 0

for.cond.cleanup3:                                ; preds = %for.body4
  %call6 = tail call i32 @dummy(ptr noundef nonnull @global_data, ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 11, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 20, i64 0, i64 0), double noundef %mul5.4) #17
  %inc8 = add nuw nsw i32 %nl.020, 1
  %2 = load i32, ptr @ntimes, align 4, !tbaa !17
  %mul = mul nsw i32 %2, 10
  %cmp = icmp slt i32 %inc8, %mul
  br i1 %cmp, label %for.cond1.preheader, label %for.cond.cleanup

for.body4:                                        ; preds = %for.body4, %for.cond1.preheader
  %indvars.iv = phi i64 [ 0, %for.cond1.preheader ], [ %indvars.iv.next.4, %for.body4 ]
  %prod.116 = phi double [ 1.000000e+00, %for.cond1.preheader ], [ %mul5.4, %for.body4 ]
  %arrayidx = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv
  %3 = load double, ptr %arrayidx, align 8, !tbaa !5
  %mul5 = fmul double %prod.116, %3
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %arrayidx.1 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv.next
  %4 = load double, ptr %arrayidx.1, align 8, !tbaa !5
  %mul5.1 = fmul double %mul5, %4
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %arrayidx.2 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv.next.1
  %5 = load double, ptr %arrayidx.2, align 8, !tbaa !5
  %mul5.2 = fmul double %mul5.1, %5
  %indvars.iv.next.2 = add nuw nsw i64 %indvars.iv, 3
  %arrayidx.3 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv.next.2
  %6 = load double, ptr %arrayidx.3, align 8, !tbaa !5
  %mul5.3 = fmul double %mul5.2, %6
  %indvars.iv.next.3 = add nuw nsw i64 %indvars.iv, 4
  %arrayidx.4 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv.next.3
  %7 = load double, ptr %arrayidx.4, align 8, !tbaa !5
  %mul5.4 = fmul double %mul5.3, %7
  %indvars.iv.next.4 = add nuw nsw i64 %indvars.iv, 5
  %exitcond.not.4 = icmp eq i64 %indvars.iv.next.4, 32000
  br i1 %exitcond.not.4, label %for.cond.cleanup3, label %for.body4
}
...
entry:
  %call = tail call i32 @init(ptr noundef nonnull @.str.74)
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
  %cmp22 = icmp sgt i32 %0, 0
  br i1 %cmp22, label %for.cond1.preheader, label %for.cond.cleanup

for.cond1.preheader:                              ; preds = %entry, %for.cond.cleanup3
  %nl.023 = phi i32 [ %inc10, %for.cond.cleanup3 ], [ 0, %entry ]
  br label %for.body4

for.cond.cleanup:                                 ; preds = %for.cond.cleanup3, %entry
  %dot.0.lcssa = phi double [ undef, %entry ], [ %8, %for.cond.cleanup3 ]
  %call12 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.140, double noundef 0.000000e+00)
  store double %dot.0.lcssa, ptr @temp, align 8, !tbaa !5
  %1 = load i32, ptr @digits, align 4, !tbaa !17
  %call126.i = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %1, double noundef %dot.0.lcssa)
  ret i32 0

for.cond.cleanup3:                                ; preds = %for.body4
  %call8 = tail call i32 @dummy(ptr noundef nonnull @global_data, ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 11, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 20, i64 0, i64 0), double noundef %8) #17
  %inc10 = add nuw nsw i32 %nl.023, 1
  %2 = load i32, ptr @ntimes, align 4, !tbaa !17
  %mul = mul nsw i32 %2, 5
  %cmp = icmp slt i32 %inc10, %mul
  br i1 %cmp, label %for.cond1.preheader, label %for.cond.cleanup

for.body4:                                        ; preds = %for.body4, %for.cond1.preheader
  %indvars.iv = phi i64 [ 0, %for.cond1.preheader ], [ %indvars.iv.next.1, %for.body4 ]
  %dot.119 = phi double [ 0.000000e+00, %for.cond1.preheader ], [ %8, %for.body4 ]
  %arrayidx = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv
  ...
  %4 = load double, ptr %arrayidx6, align 16, !tbaa !5
  %5 = tail call double @llvm.fmuladd.f64(double %3, double %4, double %dot.119)
  %indvars.iv.next = or i64 %indvars.iv, 1
  %arrayidx.1 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv.next
  ...
  %7 = load double, ptr %arrayidx6.1, align 8, !tbaa !5
...
entry:
  %call = tail call i32 @init(ptr noundef nonnull @.str.75)
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
  %cmp22 = icmp sgt i32 %0, 0
  br i1 %cmp22, label %for.body, label %for.cond.cleanup

for.cond.cleanup:                                 ; preds = %for.cond.cleanup3, %entry
  %x.0.lcssa = phi double [ undef, %entry ], [ %x.2.1, %for.cond.cleanup3 ]
  %call12 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.141, double noundef 0.000000e+00)
  store double %x.0.lcssa, ptr @temp, align 8, !tbaa !5
  %1 = load i32, ptr @digits, align 4, !tbaa !17
  %call126.i = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %1, double noundef %x.0.lcssa)
  ret i32 0

for.body:                                         ; preds = %entry, %for.cond.cleanup3
  %nl.023 = phi i32 [ %inc10, %for.cond.cleanup3 ], [ 0, %entry ]
  %2 = load double, ptr @global_data, align 32, !tbaa !5
  br label %for.body4

for.cond.cleanup3:                                ; preds = %for.body4
  %call8 = tail call i32 @dummy(ptr noundef nonnull @global_data, ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 11, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 20, i64 0, i64 0), double noundef %x.2.1) #17
  %inc10 = add nuw nsw i32 %nl.023, 1
...
for.body4:                                        ; preds = %for.body4, %for.body
  %indvars.iv = phi i64 [ 0, %for.body ], [ %indvars.iv.next.1, %for.body4 ]
  %x.119 = phi double [ %2, %for.body ], [ %x.2.1, %for.body4 ]
  %arrayidx = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv
  %4 = load double, ptr %arrayidx, align 16, !tbaa !5
  %cmp5 = fcmp ogt double %4, %x.119
  %x.2 = select i1 %cmp5, double %4, double %x.119
  %indvars.iv.next = or i64 %indvars.iv, 1
  %arrayidx.1 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv.next
  %5 = load double, ptr %arrayidx.1, align 8, !tbaa !5
  %cmp5.1 = fcmp ogt double %5, %x.2
  %x.2.1 = select i1 %cmp5.1, double %5, double %x.2
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %exitcond.not.1 = icmp eq i64 %indvars.iv.next.1, 32000
  br i1 %exitcond.not.1, label %for.cond.cleanup3, label %for.body4
}
...
entry:
  %call = tail call i32 @init(ptr noundef nonnull @.str.76)
  br label %for.body

for.cond1.preheader:                              ; preds = %for.body
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
  %cmp246 = icmp sgt i32 %0, 0
  br i1 %cmp246, label %for.body5, label %for.cond.cleanup4

for.body:                                         ; preds = %for.body, %entry
  %indvars.iv = phi i64 [ 0, %entry ], [ %indvars.iv.next.1, %for.body ]
  %1 = trunc i64 %indvars.iv to i32
  %2 = mul nuw nsw i32 %1, 7
  %rem = urem i32 %2, 32000
  ...
  %rem.1 = urem i32 %4, 32000
  %conv.1 = sitofp i32 %rem.1 to double
  %arrayidx.1 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv.next
  store double %conv.1, ptr %arrayidx.1, align 8, !tbaa !5
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %exitcond.not.1 = icmp eq i64 %indvars.iv.next.1, 32000
  br i1 %exitcond.not.1, label %for.cond1.preheader, label %for.body

for.cond.cleanup4.loopexit:                       ; preds = %for.cond.cleanup10
  %5 = sitofp i32 %index.2.1 to double
  br label %for.cond.cleanup4

for.cond.cleanup4:                                ; preds = %for.cond1.preheader, %for.cond.cleanup4.loopexit
  %x.0.lcssa = phi double [ %x.2.1, %for.cond.cleanup4.loopexit ], [ undef, %for.cond1.preheader ]
  %index.0.lcssa = phi double [ %5, %for.cond.cleanup4.loopexit ], [ 0.000000e+00, %for.cond1.preheader ]
  %call27 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.142, double noundef 0.000000e+00)
  %add29 = fadd double %x.0.lcssa, %index.0.lcssa
  %add30 = fadd double %add29, 1.000000e+00
  store double %add30, ptr @temp, align 8, !tbaa !5
  %6 = load i32, ptr @digits, align 4, !tbaa !17
  %call126.i = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %6, double noundef %add30)
  ret i32 0

for.body5:                                        ; preds = %for.cond1.preheader, %for.cond.cleanup10
  %nl.047 = phi i32 [ %inc24, %for.cond.cleanup10 ], [ 0, %for.cond1.preheader ]
  %7 = load double, ptr @global_data, align 32, !tbaa !5
  br label %for.body11

for.cond.cleanup10:                               ; preds = %for.body11
  %conv21 = sitofp i32 %index.2.1 to double
  %add = fadd double %x.2.1, %conv21
  %call22 = tail call i32 @dummy(ptr noundef nonnull @global_data, ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 11, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 20, i64 0, i64 0), double noundef %add) #17
  %inc24 = add nuw nsw i32 %nl.047, 1
  %8 = load i32, ptr @ntimes, align 4, !tbaa !17
  %cmp2 = icmp slt i32 %inc24, %8
  br i1 %cmp2, label %for.body5, label %for.cond.cleanup4.loopexit

for.body11:                                       ; preds = %for.body11, %for.body5
  %indvars.iv51 = phi i64 [ 0, %for.body5 ], [ %indvars.iv.next52.1, %for.body11 ]
  %index.144 = phi i32 [ 0, %for.body5 ], [ %index.2.1, %for.body11 ]
  %x.143 = phi double [ %7, %for.body5 ], [ %x.2.1, %for.body11 ]
  %arrayidx13 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv51
  %9 = load double, ptr %arrayidx13, align 16, !tbaa !5
  %cmp14 = fcmp ogt double %9, %x.143
  %x.2 = select i1 %cmp14, double %9, double %x.143
  %10 = trunc i64 %indvars.iv51 to i32
  %index.2 = select i1 %cmp14, i32 %10, i32 %index.144
  %indvars.iv.next52 = or i64 %indvars.iv51, 1
  %arrayidx13.1 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv.next52
  %11 = load double, ptr %arrayidx13.1, align 8, !tbaa !5
  %cmp14.1 = fcmp ogt double %11, %x.2
  %x.2.1 = select i1 %cmp14.1, double %11, double %x.2
  %12 = trunc i64 %indvars.iv.next52 to i32
  %index.2.1 = select i1 %cmp14.1, i32 %12, i32 %index.2
  %indvars.iv.next52.1 = add nuw nsw i64 %indvars.iv51, 2
  %exitcond54.not.1 = icmp eq i64 %indvars.iv.next52.1, 32000
  br i1 %exitcond54.not.1, label %for.cond.cleanup10, label %for.body11
}

; Function Attrs: nounwind uwtable
define dso_local i32 @s316() local_unnamed_addr #7 {
entry:
  %call = tail call i32 @init(ptr noundef nonnull @.str.77)
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
  %cmp22 = icmp sgt i32 %0, 0
  br i1 %cmp22, label %for.body, label %for.cond.cleanup

for.cond.cleanup:                                 ; preds = %for.cond.cleanup3, %entry
  %x.0.lcssa = phi double [ undef, %entry ], [ %x.2, %for.cond.cleanup3 ]
  %call12 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.143, double noundef 0.000000e+00)
  store double %x.0.lcssa, ptr @temp, align 8, !tbaa !5
  %1 = load i32, ptr @digits, align 4, !tbaa !17
  %call126.i = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %1, double noundef %x.0.lcssa)
  ret i32 0
...
for.cond.cleanup3:                                ; preds = %for.body4
  %call8 = tail call i32 @dummy(ptr noundef nonnull @global_data, ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 11, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 20, i64 0, i64 0), double noundef %x.2) #17
  %inc10 = add nuw nsw i32 %nl.023, 1
  %3 = load i32, ptr @ntimes, align 4, !tbaa !17
  %mul = mul nsw i32 %3, 5
  %cmp = icmp slt i32 %inc10, %mul
...
for.body4:                                        ; preds = %for.body4.1, %for.body
  %indvars.iv = phi i64 [ 1, %for.body ], [ %indvars.iv.next.1, %for.body4.1 ]
  %x.119 = phi double [ %2, %for.body ], [ %x.2.1, %for.body4.1 ]
  %arrayidx = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv
  %4 = load double, ptr %arrayidx, align 8, !tbaa !5
  %cmp5 = fcmp olt double %4, %x.119
  %x.2 = select i1 %cmp5, double %4, double %x.119
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, 32000
  br i1 %exitcond.not, label %for.cond.cleanup3, label %for.body4.1

for.body4.1:                                      ; preds = %for.body4
  %arrayidx.1 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv.next
  %5 = load double, ptr %arrayidx.1, align 8, !tbaa !5
  %cmp5.1 = fcmp olt double %5, %x.2
  %x.2.1 = select i1 %cmp5.1, double %5, double %x.2
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  br label %for.body4
}
...
entry:
  %call = tail call i32 @init(ptr noundef nonnull @.str.78)
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
  %cmp18 = icmp sgt i32 %0, 0
  br i1 %cmp18, label %for.cond1.preheader, label %for.cond.cleanup

for.cond1.preheader:                              ; preds = %entry, %for.cond.cleanup3
  %nl.019 = phi i32 [ %inc8, %for.cond.cleanup3 ], [ 0, %entry ]
  br label %for.body4

for.cond.cleanup:                                 ; preds = %for.cond.cleanup3, %entry
  %q.0.lcssa = phi double [ undef, %entry ], [ %mul5.9, %for.cond.cleanup3 ]
  %call10 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.144, double noundef 0.000000e+00)
  store double %q.0.lcssa, ptr @temp, align 8, !tbaa !5
  %1 = load i32, ptr @digits, align 4, !tbaa !17
  %call126.i = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %1, double noundef %q.0.lcssa)
  ret i32 0

for.cond.cleanup3:                                ; preds = %for.body4
  %call6 = tail call i32 @dummy(ptr noundef nonnull @global_data, ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 11, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 20, i64 0, i64 0), double noundef %mul5.9) #17
...
for.body4:                                        ; preds = %for.body4, %for.cond1.preheader
  %i.016 = phi i32 [ 0, %for.cond1.preheader ], [ %inc.9, %for.body4 ]
  %q.115 = phi double [ 1.000000e+00, %for.cond1.preheader ], [ %mul5.9, %for.body4 ]
  %mul5 = fmul double %q.115, 0x3FEFAE147AE147AE
  %mul5.1 = fmul double %mul5, 0x3FEFAE147AE147AE
  %mul5.2 = fmul double %mul5.1, 0x3FEFAE147AE147AE
  %mul5.3 = fmul double %mul5.2, 0x3FEFAE147AE147AE
  %mul5.4 = fmul double %mul5.3, 0x3FEFAE147AE147AE
  %mul5.5 = fmul double %mul5.4, 0x3FEFAE147AE147AE
  %mul5.6 = fmul double %mul5.5, 0x3FEFAE147AE147AE
  %mul5.7 = fmul double %mul5.6, 0x3FEFAE147AE147AE
  %mul5.8 = fmul double %mul5.7, 0x3FEFAE147AE147AE
  %mul5.9 = fmul double %mul5.8, 0x3FEFAE147AE147AE
  %inc.9 = add nuw nsw i32 %i.016, 10
  %exitcond.not.9 = icmp eq i32 %inc.9, 16000
  br i1 %exitcond.not.9, label %for.cond.cleanup3, label %for.body4
}

; Function Attrs: nounwind uwtable
define dso_local i32 @s318(i32 noundef %inc) local_unnamed_addr #7 {
entry:
  %call = tail call i32 @init(ptr noundef nonnull @.str.79)
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
...
for.cond.cleanup.loopexit:                        ; preds = %for.cond.cleanup3
  %2 = sitofp i32 %index.2 to double
  br label %for.cond.cleanup

for.cond.cleanup:                                 ; preds = %entry, %for.cond.cleanup.loopexit
  %index.0.lcssa = phi double [ %2, %for.cond.cleanup.loopexit ], [ 0.000000e+00, %entry ]
  %max.0.lcssa = phi double [ %max.2, %for.cond.cleanup.loopexit ], [ undef, %entry ]
  %call17 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.145, double noundef 0.000000e+00)
  %add19 = fadd double %max.0.lcssa, %index.0.lcssa
  %add20 = fadd double %add19, 1.000000e+00
  store double %add20, ptr @temp, align 8, !tbaa !5
  %3 = load i32, ptr @digits, align 4, !tbaa !17
  %call126.i = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %3, double noundef %add20)
  ret i32 0

for.body:                                         ; preds = %for.body.preheader, %for.cond.cleanup3
  %nl.037 = phi i32 [ %inc13, %for.cond.cleanup3 ], [ 0, %for.body.preheader ]
  %4 = load double, ptr @global_data, align 32, !tbaa !5
  %5 = tail call double @llvm.fabs.f64(double %4)
  br label %for.body4

for.cond.cleanup3:                                ; preds = %for.body4
  %conv = sitofp i32 %index.2 to double
  %add10 = fadd double %max.2, %conv
  %call11 = tail call i32 @dummy(ptr noundef nonnull @global_data, ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 11, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 20, i64 0, i64 0), double noundef %add10) #17
  %inc13 = add nuw nsw i32 %nl.037, 1
  %6 = load i32, ptr @ntimes, align 4, !tbaa !17
  %div = sdiv i32 %6, 2
  %cmp = icmp slt i32 %inc13, %div
  br i1 %cmp, label %for.body, label %for.cond.cleanup.loopexit

for.body4:                                        ; preds = %for.body4.1, %for.body
  %indvars.iv = phi i64 [ %1, %for.body ], [ %indvars.iv.next.1, %for.body4.1 ]
  %i.034 = phi i32 [ 1, %for.body ], [ %inc9.1, %for.body4.1 ]
  %max.132 = phi double [ %5, %for.body ], [ %max.2.1, %for.body4.1 ]
  %index.131 = phi i32 [ 0, %for.body ], [ %index.2.1, %for.body4.1 ]
  %arrayidx = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv
  %7 = load double, ptr %arrayidx, align 8, !tbaa !5
  %8 = tail call double @llvm.fabs.f64(double %7)
  %cmp5 = fcmp ugt double %8, %max.132
  %index.2 = select i1 %cmp5, i32 %i.034, i32 %index.131
  %max.2 = select i1 %cmp5, double %8, double %max.132
  %inc9 = add nuw nsw i32 %i.034, 1
  %exitcond.not = icmp eq i32 %inc9, 32000
  br i1 %exitcond.not, label %for.cond.cleanup3, label %for.body4.1
...
for.body4.1:                                      ; preds = %for.body4
  ...
  %cmp5.1 = fcmp ugt double %10, %max.2
  %index.2.1 = select i1 %cmp5.1, i32 %inc9, i32 %index.2
  %max.2.1 = select i1 %cmp5.1, double %10, double %max.2
  %indvars.iv.next.1 = add i64 %indvars.iv.next, %1
  %inc9.1 = add nuw nsw i32 %i.034, 2
  br label %for.body4
}
...
entry:
  %call = tail call i32 @init(ptr noundef nonnull @.str.80)
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
...
for.cond.cleanup:                                 ; preds = %for.cond.cleanup3, %entry
  %sum.0.lcssa = phi double [ undef, %entry ], [ %add21, %for.cond.cleanup3 ]
  %call26 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.146, double noundef 0.000000e+00)
  store double %sum.0.lcssa, ptr @temp, align 8, !tbaa !5
  %1 = load i32, ptr @digits, align 4, !tbaa !17
  %call126.i = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %1, double noundef %sum.0.lcssa)
  ret i32 0

for.cond.cleanup3:                                ; preds = %for.body4
  %call22 = tail call i32 @dummy(ptr noundef nonnull @global_data, ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 11, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 20, i64 0, i64 0), double noundef %add21) #17
...
for.body4:                                        ; preds = %for.cond1.preheader, %for.body4
  ...
  %sum.140 = phi double [ 0.000000e+00, %for.cond1.preheader ], [ %add21, %for.body4 ]
  %arrayidx = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 %indvars.iv
  %3 = load double, ptr %arrayidx, align 8, !tbaa !5
  %arrayidx6 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 %indvars.iv
  %4 = load double, ptr %arrayidx6, align 8, !tbaa !5
  %add = fadd double %3, %4
  %arrayidx8 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv
  store double %add, ptr %arrayidx8, align 8, !tbaa !5
  %add11 = fadd double %sum.140, %add
  %arrayidx15 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 11, i64 %indvars.iv
  %5 = load double, ptr %arrayidx15, align 8, !tbaa !5
  %add16 = fadd double %3, %5
  %arrayidx18 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %indvars.iv
  store double %add16, ptr %arrayidx18, align 8, !tbaa !5
  %add21 = fadd double %add11, %add16
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, 32000
...
entry:
  %call = tail call i32 @init(ptr noundef nonnull @.str.81)
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
  %cmp57 = icmp sgt i32 %0, 255
  br i1 %cmp57, label %for.body, label %for.cond.cleanup

for.cond.cleanup.loopexit:                        ; preds = %for.cond.cleanup3
  %1 = sitofp i32 %xindex.3.1 to double
  %2 = sitofp i32 %yindex.3.1 to double
  br label %for.cond.cleanup

for.cond.cleanup:                                 ; preds = %entry, %for.cond.cleanup.loopexit
  %yindex.0.lcssa = phi double [ %2, %for.cond.cleanup.loopexit ], [ 0.000000e+00, %entry ]
  %max.0.lcssa = phi double [ %max.3.1, %for.cond.cleanup.loopexit ], [ undef, %entry ]
  %xindex.0.lcssa = phi double [ %1, %for.cond.cleanup.loopexit ], [ 0.000000e+00, %entry ]
  %call27 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.147, double noundef 0.000000e+00)
  %add29 = fadd double %max.0.lcssa, %xindex.0.lcssa
  %add30 = fadd double %add29, 1.000000e+00
  %add32 = fadd double %add30, %yindex.0.lcssa
  %add33 = fadd double %add32, 1.000000e+00
  store double %add33, ptr @temp, align 8, !tbaa !5
  %3 = load i32, ptr @digits, align 4, !tbaa !17
  %call126.i = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %3, double noundef %add33)
  ret i32 0

for.body:                                         ; preds = %entry, %for.cond.cleanup3
  %nl.058 = phi i32 [ %inc23, %for.cond.cleanup3 ], [ 0, %entry ]
  %4 = load double, ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), align 32, !tbaa !5
  br label %for.cond5.preheader

for.cond5.preheader:                              ; preds = %for.body, %for.cond.cleanup7
  %indvars.iv62 = phi i64 [ 0, %for.body ], [ %indvars.iv.next63, %for.cond.cleanup7 ]
  %xindex.153 = phi i32 [ 0, %for.body ], [ %xindex.3.1, %for.cond.cleanup7 ]
  %max.152 = phi double [ %4, %for.body ], [ %max.3.1, %for.cond.cleanup7 ]
  %yindex.151 = phi i32 [ 0, %for.body ], [ %yindex.3.1, %for.cond.cleanup7 ]
  %5 = trunc i64 %indvars.iv62 to i32
  br label %for.body8

for.cond.cleanup3:                                ; preds = %for.cond.cleanup7
  %conv = sitofp i32 %xindex.3.1 to double
  %add = fadd double %max.3.1, %conv
  %conv19 = sitofp i32 %yindex.3.1 to double
  %add20 = fadd double %add, %conv19
  %call21 = tail call i32 @dummy(ptr noundef nonnull @global_data, ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 11, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 20, i64 0, i64 0), double noundef %add20) #17
  %inc23 = add nuw nsw i32 %nl.058, 1
  %6 = load i32, ptr @ntimes, align 4, !tbaa !17
  %div = sdiv i32 %6, 256
...
for.body8:                                        ; preds = %for.body8, %for.cond5.preheader
  ...
  %xindex.249 = phi i32 [ %xindex.153, %for.cond5.preheader ], [ %xindex.3.1, %for.body8 ]
  %max.248 = phi double [ %max.152, %for.cond5.preheader ], [ %max.3.1, %for.body8 ]
  %yindex.247 = phi i32 [ %yindex.151, %for.cond5.preheader ], [ %yindex.3.1, %for.body8 ]
  %arrayidx10 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), i64 %indvars.iv62, i64 %indvars.iv
  %7 = load double, ptr %arrayidx10, align 16, !tbaa !5
  %cmp11 = fcmp ogt double %7, %max.248
  %8 = trunc i64 %indvars.iv to i32
  %yindex.3 = select i1 %cmp11, i32 %8, i32 %yindex.247
  %max.3 = select i1 %cmp11, double %7, double %max.248
  %indvars.iv.next = or i64 %indvars.iv, 1
  %arrayidx10.1 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), i64 %indvars.iv62, i64 %indvars.iv.next
  %9 = load double, ptr %arrayidx10.1, align 8, !tbaa !5
  %cmp11.1 = fcmp ogt double %9, %max.3
  %10 = trunc i64 %indvars.iv.next to i32
  %yindex.3.1 = select i1 %cmp11.1, i32 %10, i32 %yindex.3
  %max.3.1 = select i1 %cmp11.1, double %9, double %max.3
  %11 = or i1 %cmp11.1, %cmp11
  %xindex.3.1 = select i1 %11, i32 %5, i32 %xindex.249
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
...
entry:
  %call = tail call i32 @init(ptr noundef nonnull @.str.81)
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
  %cmp51 = icmp sgt i32 %0, 255
  br i1 %cmp51, label %for.body, label %for.cond.cleanup

for.cond.cleanup.loopexit:                        ; preds = %for.cond.cleanup3
  %1 = fadd double %max.3.1, 0.000000e+00
...
for.cond.cleanup:                                 ; preds = %entry, %for.cond.cleanup.loopexit
  %max.0.lcssa = phi double [ %4, %for.cond.cleanup.loopexit ], [ 0x7FF8000000000000, %entry ]
  %call27 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.148, double noundef 0.000000e+00)
  store double %max.0.lcssa, ptr @temp, align 8, !tbaa !5
  %5 = load i32, ptr @digits, align 4, !tbaa !17
  %call126.i = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %5, double noundef %max.0.lcssa)
  ret i32 0

for.body:                                         ; preds = %entry, %for.cond.cleanup3
  %nl.052 = phi i32 [ %inc23, %for.cond.cleanup3 ], [ 0, %entry ]
  %6 = load double, ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), align 32, !tbaa !5
  br label %for.cond5.preheader

for.cond5.preheader:                              ; preds = %for.body, %for.cond.cleanup7
  %indvars.iv54 = phi i64 [ 0, %for.body ], [ %indvars.iv.next55, %for.cond.cleanup7 ]
  %max.147 = phi double [ %6, %for.body ], [ %max.3.1, %for.cond.cleanup7 ]
  br label %for.body8

for.cond.cleanup3:                                ; preds = %for.cond.cleanup7
  %add = fadd double %max.3.1, 0.000000e+00
  %call21 = tail call i32 @dummy(ptr noundef nonnull @global_data, ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 11, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 20, i64 0, i64 0), double noundef %add) #17
  %inc23 = add nuw nsw i32 %nl.052, 1
  %7 = load i32, ptr @ntimes, align 4, !tbaa !17
  %div = sdiv i32 %7, 256
  %mul = mul nsw i32 %div, 100
  %cmp = icmp slt i32 %inc23, %mul
...
for.body8:                                        ; preds = %for.body8, %for.cond5.preheader
  %indvars.iv = phi i64 [ 0, %for.cond5.preheader ], [ %indvars.iv.next.1, %for.body8 ]
  %max.245 = phi double [ %max.147, %for.cond5.preheader ], [ %max.3.1, %for.body8 ]
  %arrayidx10 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), i64 %indvars.iv54, i64 %indvars.iv
  %8 = load double, ptr %arrayidx10, align 16, !tbaa !5
  %cmp11 = fcmp ogt double %8, %max.245
  %max.3 = select i1 %cmp11, double %8, double %max.245
  %indvars.iv.next = or i64 %indvars.iv, 1
  %arrayidx10.1 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), i64 %indvars.iv54, i64 %indvars.iv.next
  %9 = load double, ptr %arrayidx10.1, align 8, !tbaa !5
  %cmp11.1 = fcmp ogt double %9, %max.3
  %max.3.1 = select i1 %cmp11.1, double %9, double %max.3
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
...
entry:
  %call = tail call i32 @init(ptr noundef nonnull @.str.82)
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
  %cmp23 = icmp sgt i32 %0, 1
  br i1 %cmp23, label %for.cond1.preheader, label %for.cond.cleanup

for.cond1.preheader:                              ; preds = %entry, %for.cond.cleanup3
  %nl.024 = phi i32 [ %inc10, %for.cond.cleanup3 ], [ 0, %entry ]
  br label %for.body4

for.cond.cleanup:                                 ; preds = %for.cond.cleanup3, %entry
  %sum.0.lcssa = phi double [ undef, %entry ], [ %sum.2.1, %for.cond.cleanup3 ]
  %call13 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.149, double noundef 0.000000e+00)
  store double %sum.0.lcssa, ptr @temp, align 8, !tbaa !5
  %1 = load i32, ptr @digits, align 4, !tbaa !17
  %call126.i = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %1, double noundef %sum.0.lcssa)
  ret i32 0
...
for.cond.cleanup3:                                ; preds = %for.body4
  %call8 = tail call i32 @dummy(ptr noundef nonnull @global_data, ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 11, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 20, i64 0, i64 0), double noundef %sum.2.1) #17
  %inc10 = add nuw nsw i32 %nl.024, 1
  %2 = load i32, ptr @ntimes, align 4, !tbaa !17
  %div = sdiv i32 %2, 2
  %cmp = icmp slt i32 %inc10, %div
  br i1 %cmp, label %for.cond1.preheader, label %for.cond.cleanup

for.body4:                                        ; preds = %for.body4, %for.cond1.preheader
  %indvars.iv = phi i64 [ 0, %for.cond1.preheader ], [ %indvars.iv.next.1, %for.body4 ]
  %sum.120 = phi double [ 0.000000e+00, %for.cond1.preheader ], [ %sum.2.1, %for.body4 ]
  %arrayidx = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv
  %3 = load double, ptr %arrayidx, align 16, !tbaa !5
  %cmp5 = fcmp ogt double %3, 0.000000e+00
  %add = select i1 %cmp5, double %3, double -0.000000e+00
  %sum.2 = fadd double %sum.120, %add
  %indvars.iv.next = or i64 %indvars.iv, 1
  %arrayidx.1 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv.next
  %4 = load double, ptr %arrayidx.1, align 8, !tbaa !5
  %cmp5.1 = fcmp ogt double %4, 0.000000e+00
  %add.1 = select i1 %cmp5.1, double %4, double -0.000000e+00
  %sum.2.1 = fadd double %sum.2, %add.1
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %exitcond.not.1 = icmp eq i64 %indvars.iv.next.1, 32000
  br i1 %exitcond.not.1, label %for.cond.cleanup3, label %for.body4
}
...
entry:
  %call = tail call i32 @init(ptr noundef nonnull @.str.83)
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
  %cmp21 = icmp sgt i32 %0, 0
  br i1 %cmp21, label %for.cond1.preheader, label %for.cond.cleanup

for.cond1.preheader:                              ; preds = %entry, %for.cond.cleanup3
  %nl.022 = phi i32 [ %inc9, %for.cond.cleanup3 ], [ 0, %entry ]
  br label %for.body4

for.cond.cleanup:                                 ; preds = %for.cond.cleanup3, %entry
  %sum.0.lcssa = phi double [ undef, %entry ], [ %add.1, %for.cond.cleanup3 ]
  %call11 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.150, double noundef 0.000000e+00)
  store double %sum.0.lcssa, ptr @temp, align 8, !tbaa !5
  br label %for.body.i

for.body.i:                                       ; preds = %for.body.i, %for.cond.cleanup
  %indvars.iv.i = phi i64 [ 0, %for.cond.cleanup ], [ %indvars.iv.next.i.4, %for.body.i ]
  %sumb.0193.i = phi double [ 0.000000e+00, %for.cond.cleanup ], [ %add3.i.4, %for.body.i ]
  ...
  %add3.i = fadd double %sumb.0193.i, %1
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1
  %arrayidx2.i.1 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %indvars.iv.next.i
  %2 = load double, ptr %arrayidx2.i.1, align 8, !tbaa !5
  %add3.i.1 = fadd double %add3.i, %2
  %indvars.iv.next.i.1 = add nuw nsw i64 %indvars.iv.i, 2
  %arrayidx2.i.2 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %indvars.iv.next.i.1
  %3 = load double, ptr %arrayidx2.i.2, align 8, !tbaa !5
  %add3.i.2 = fadd double %add3.i.1, %3
  %indvars.iv.next.i.2 = add nuw nsw i64 %indvars.iv.i, 3
  %arrayidx2.i.3 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %indvars.iv.next.i.2
  %4 = load double, ptr %arrayidx2.i.3, align 8, !tbaa !5
  %add3.i.3 = fadd double %add3.i.2, %4
  %indvars.iv.next.i.3 = add nuw nsw i64 %indvars.iv.i, 4
  %arrayidx2.i.4 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %indvars.iv.next.i.3
  %5 = load double, ptr %arrayidx2.i.4, align 8, !tbaa !5
  %add3.i.4 = fadd double %add3.i.3, %5
  %indvars.iv.next.i.4 = add nuw nsw i64 %indvars.iv.i, 5
  %exitcond.not.i.4 = icmp eq i64 %indvars.iv.next.i.4, 32000
  br i1 %exitcond.not.i.4, label %for.cond18.preheader.i.preheader, label %for.body.i
...
for.body4:                                        ; preds = %for.body4, %for.cond1.preheader
  %indvars.iv = phi i64 [ 0, %for.cond1.preheader ], [ %indvars.iv.next.1, %for.body4 ]
  %sum.119 = phi double [ 0.000000e+00, %for.cond1.preheader ], [ %add.1, %for.body4 ]
  %arrayidx = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv
  %8 = load double, ptr %arrayidx, align 16, !tbaa !5
  %add = fadd double %sum.119, %8
  %arrayidx6 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %indvars.iv
...
entry:
  %call = tail call i32 @init(ptr noundef nonnull @.str.84)
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
  %cmp22 = icmp sgt i32 %0, 0
  br i1 %cmp22, label %for.body, label %for.cond.cleanup

for.cond.cleanup:                                 ; preds = %for.cond.cleanup3, %entry
  %max.0.lcssa = phi double [ undef, %entry ], [ %max.2.1, %for.cond.cleanup3 ]
  %call12 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.151, double noundef 0.000000e+00)
  store double %max.0.lcssa, ptr @temp, align 8, !tbaa !5
  %1 = load i32, ptr @digits, align 4, !tbaa !17
  %call126.i = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %1, double noundef %max.0.lcssa)
  ret i32 0
...
for.cond.cleanup3:                                ; preds = %for.body4
  %call8 = tail call i32 @dummy(ptr noundef nonnull @global_data, ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 11, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 20, i64 0, i64 0), double noundef %max.2.1) #17
  %inc10 = add nuw nsw i32 %nl.023, 1
  %4 = load i32, ptr @ntimes, align 4, !tbaa !17
  %mul = shl nsw i32 %4, 2
  %cmp = icmp slt i32 %inc10, %mul
  br i1 %cmp, label %for.body, label %for.cond.cleanup
...
for.body4:                                        ; preds = %for.body4, %for.body
  %indvars.iv = phi i64 [ 0, %for.body ], [ %indvars.iv.next.1, %for.body4 ]
  %max.119 = phi double [ %3, %for.body ], [ %max.2.1, %for.body4 ]
  %arrayidx = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv
  %5 = load double, ptr %arrayidx, align 16, !tbaa !5
  %6 = tail call double @llvm.fabs.f64(double %5)
  %cmp5 = fcmp ogt double %6, %max.119
  %max.2 = select i1 %cmp5, double %6, double %max.119
  %indvars.iv.next = or i64 %indvars.iv, 1
  %arrayidx.1 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv.next
  %7 = load double, ptr %arrayidx.1, align 8, !tbaa !5
  %8 = tail call double @llvm.fabs.f64(double %7)
  %cmp5.1 = fcmp ogt double %8, %max.2
  %max.2.1 = select i1 %cmp5.1, double %8, double %max.2
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %exitcond.not.1 = icmp eq i64 %indvars.iv.next.1, 32000
  br i1 %exitcond.not.1, label %for.cond.cleanup3, label %for.body4
}
...
vector.body125:                                   ; preds = %vector.body, %vector.body125
  ...
  br i1 %10, label %vector.body133, label %vector.body125, !llvm.loop !367
...
vector.body133:                                   ; preds = %vector.body125, %vector.body133
  ...
  br i1 %21, label %vector.body141, label %vector.body133, !llvm.loop !368
...
vector.body141:                                   ; preds = %vector.body133, %vector.body141
  ...
  br i1 %32, label %vector.body149, label %vector.body141, !llvm.loop !369
...
vector.body149:                                   ; preds = %vector.body141, %vector.body149
  ...
  br i1 %43, label %for.cond2.preheader.i, label %vector.body149, !llvm.loop !370
...
vector.body157:                                   ; preds = %vector.body157, %for.cond2.preheader.i
  ...
  br i1 %53, label %for.cond.cleanup4.i, label %vector.body157, !llvm.loop !371
...
vector.body167:                                   ; preds = %vector.body167, %for.cond2.preheader.i83
  ...
  br i1 %63, label %for.cond.cleanup4.i85, label %vector.body167, !llvm.loop !372
...
vector.body179:                                   ; preds = %vector.body179, %for.cond2.preheader.i96
  ...
  br i1 %73, label %for.cond.cleanup4.i98, label %vector.body179, !llvm.loop !373
...
vector.body191:                                   ; preds = %for.cond.cleanup4.i98, %vector.body191
  ...
  br i1 %84, label %for.cond.cleanup29, label %vector.body191, !llvm.loop !374
...
vector.body:                                      ; preds = %for.body, %vector.body
  ...
  br i1 %104, label %vector.body125, label %vector.body, !llvm.loop !375
...
if.end.thread:                                    ; preds = %entry
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
  %call241 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.153, i32 noundef %0)
  br label %if.end7

if.end:                                           ; preds = %entry
  %arrayidx = getelementptr inbounds ptr, ptr %argv, i64 1
  %1 = load ptr, ptr %arrayidx, align 8, !tbaa !376
  ...
  %call2 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.153, i32 noundef %conv.i)
  %cmp3.not = icmp eq i32 %argc, 2
  br i1 %cmp3.not, label %if.end7, label %if.then4

if.then4:                                         ; preds = %if.end
  %arrayidx5 = getelementptr inbounds ptr, ptr %argv, i64 2
  %2 = load ptr, ptr %arrayidx5, align 8, !tbaa !376
  %call.i26 = call i64 @strtol(ptr nocapture noundef nonnull %2, ptr noundef null, i32 noundef 10) #17
  %conv.i27 = trunc i64 %call.i26 to i32
  store i32 %conv.i27, ptr @digits, align 4, !tbaa !17
  br label %if.end7

if.end7:                                          ; preds = %if.end.thread, %if.then4, %if.end
  %3 = load ptr, ptr %ip, align 8, !tbaa !376
  call void @set(ptr noundef %3, ptr noundef nonnull %s1, ptr noundef nonnull %s2)
  %puts = call i32 @puts(ptr nonnull dereferenceable(1) @str)
  %call9 = call i32 @s311()
  %call10 = call i32 @s31111()
  %call.i28 = call i32 @init(ptr noundef nonnull @.str.73)
  %4 = load i32, ptr @ntimes, align 4, !tbaa !17
  %cmp19.i = icmp sgt i32 %4, 0
  br i1 %cmp19.i, label %for.cond1.preheader.i, label %s312.exit

for.cond1.preheader.i:                            ; preds = %if.end7, %for.cond.cleanup3.i
  %nl.020.i = phi i32 [ %inc8.i, %for.cond.cleanup3.i ], [ 0, %if.end7 ]
  br label %for.body4.i

for.cond.cleanup3.i:                              ; preds = %for.body4.i
  %call6.i = call i32 @dummy(ptr noundef nonnull @global_data, ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 11, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 20, i64 0, i64 0), double noundef %mul5.i.4) #17
  %inc8.i = add nuw nsw i32 %nl.020.i, 1
  %5 = load i32, ptr @ntimes, align 4, !tbaa !17
  %mul.i = mul nsw i32 %5, 10
  %cmp.i = icmp slt i32 %inc8.i, %mul.i
  br i1 %cmp.i, label %for.cond1.preheader.i, label %s312.exit

for.body4.i:                                      ; preds = %for.body4.i, %for.cond1.preheader.i
  %indvars.iv.i = phi i64 [ 0, %for.cond1.preheader.i ], [ %indvars.iv.next.i.4, %for.body4.i ]
  %prod.116.i = phi double [ 1.000000e+00, %for.cond1.preheader.i ], [ %mul5.i.4, %for.body4.i ]
  %arrayidx.i = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv.i
  %6 = load double, ptr %arrayidx.i, align 8, !tbaa !5
  %mul5.i = fmul double %prod.116.i, %6
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1
  %arrayidx.i.1 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv.next.i
  %7 = load double, ptr %arrayidx.i.1, align 8, !tbaa !5
  %mul5.i.1 = fmul double %mul5.i, %7
  %indvars.iv.next.i.1 = add nuw nsw i64 %indvars.iv.i, 2
  %arrayidx.i.2 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv.next.i.1
  %8 = load double, ptr %arrayidx.i.2, align 8, !tbaa !5
  %mul5.i.2 = fmul double %mul5.i.1, %8
  %indvars.iv.next.i.2 = add nuw nsw i64 %indvars.iv.i, 3
  %arrayidx.i.3 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv.next.i.2
  %9 = load double, ptr %arrayidx.i.3, align 8, !tbaa !5
  %mul5.i.3 = fmul double %mul5.i.2, %9
  %indvars.iv.next.i.3 = add nuw nsw i64 %indvars.iv.i, 4
  %arrayidx.i.4 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv.next.i.3
  %10 = load double, ptr %arrayidx.i.4, align 8, !tbaa !5
  %mul5.i.4 = fmul double %mul5.i.3, %10
  %indvars.iv.next.i.4 = add nuw nsw i64 %indvars.iv.i, 5
  %exitcond.not.i.4 = icmp eq i64 %indvars.iv.next.i.4, 32000
  br i1 %exitcond.not.i.4, label %for.cond.cleanup3.i, label %for.body4.i

s312.exit:                                        ; preds = %for.cond.cleanup3.i, %if.end7
  %prod.0.lcssa.i = phi double [ undef, %if.end7 ], [ %mul5.i.4, %for.cond.cleanup3.i ]
  %call10.i = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.139, double noundef 0.000000e+00)
  store double %prod.0.lcssa.i, ptr @temp, align 8, !tbaa !5
  %11 = load i32, ptr @digits, align 4, !tbaa !17
  %call126.i.i = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %11, double noundef %prod.0.lcssa.i)
  %call12 = call i32 @s313()
  %call13 = call i32 @s314()
  %call14 = call i32 @s315()
  %call15 = call i32 @s316()
  %call.i29 = call i32 @init(ptr noundef nonnull @.str.78)
  %12 = load i32, ptr @ntimes, align 4, !tbaa !17
  %cmp18.i = icmp sgt i32 %12, 0
  br i1 %cmp18.i, label %for.cond1.preheader.i30, label %s317.exit

for.cond1.preheader.i30:                          ; preds = %s312.exit, %for.cond.cleanup3.i37
  %nl.019.i = phi i32 [ %inc8.i34, %for.cond.cleanup3.i37 ], [ 0, %s312.exit ]
  br label %for.body4.i40

for.cond.cleanup3.i37:                            ; preds = %for.body4.i40
  %call6.i33 = call i32 @dummy(ptr noundef nonnull @global_data, ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 11, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 20, i64 0, i64 0), double noundef %mul5.i38.9) #17
  %inc8.i34 = add nuw nsw i32 %nl.019.i, 1
  %13 = load i32, ptr @ntimes, align 4, !tbaa !17
  %mul.i35 = mul nsw i32 %13, 5
  %cmp.i36 = icmp slt i32 %inc8.i34, %mul.i35
  br i1 %cmp.i36, label %for.cond1.preheader.i30, label %s317.exit

for.body4.i40:                                    ; preds = %for.body4.i40, %for.cond1.preheader.i30
  %i.016.i = phi i32 [ 0, %for.cond1.preheader.i30 ], [ %inc.i.9, %for.body4.i40 ]
  %q.115.i = phi double [ 1.000000e+00, %for.cond1.preheader.i30 ], [ %mul5.i38.9, %for.body4.i40 ]
  %mul5.i38 = fmul double %q.115.i, 0x3FEFAE147AE147AE
  %mul5.i38.1 = fmul double %mul5.i38, 0x3FEFAE147AE147AE
  %mul5.i38.2 = fmul double %mul5.i38.1, 0x3FEFAE147AE147AE
  %mul5.i38.3 = fmul double %mul5.i38.2, 0x3FEFAE147AE147AE
  %mul5.i38.4 = fmul double %mul5.i38.3, 0x3FEFAE147AE147AE
  %mul5.i38.5 = fmul double %mul5.i38.4, 0x3FEFAE147AE147AE
  %mul5.i38.6 = fmul double %mul5.i38.5, 0x3FEFAE147AE147AE
  %mul5.i38.7 = fmul double %mul5.i38.6, 0x3FEFAE147AE147AE
  %mul5.i38.8 = fmul double %mul5.i38.7, 0x3FEFAE147AE147AE
  %mul5.i38.9 = fmul double %mul5.i38.8, 0x3FEFAE147AE147AE
  %inc.i.9 = add nuw nsw i32 %i.016.i, 10
  %exitcond.not.i39.9 = icmp eq i32 %inc.i.9, 16000
  br i1 %exitcond.not.i39.9, label %for.cond.cleanup3.i37, label %for.body4.i40

s317.exit:                                        ; preds = %for.cond.cleanup3.i37, %s312.exit
  %q.0.lcssa.i = phi double [ undef, %s312.exit ], [ %mul5.i38.9, %for.cond.cleanup3.i37 ]
  %call10.i31 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.144, double noundef 0.000000e+00)
  store double %q.0.lcssa.i, ptr @temp, align 8, !tbaa !5
  %14 = load i32, ptr @digits, align 4, !tbaa !17
  %call126.i.i32 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %14, double noundef %q.0.lcssa.i)
  %call17 = call i32 @s318(i32 noundef 1)
