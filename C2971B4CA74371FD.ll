...
define dso_local i32 @use_a(ptr nocapture noundef readnone %0) local_unnamed_addr #0 {
  ret i32 undef
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: write) uwtable
define dso_local i32 @set_b(ptr nocapture noundef writeonly %0) local_unnamed_addr #1 {
  store ptr @d, ptr %0, align 8, !tbaa !5
  ret i32 undef
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none) uwtable
define dso_local i32 @use_c(ptr nocapture noundef readnone %0) local_unnamed_addr #0 {
  ret i32 undef
}

; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind willreturn memory(none) uwtable
define dso_local ptr @retme(ptr noundef readnone returned %0) local_unnamed_addr #2 {
  ret ptr %0
}
