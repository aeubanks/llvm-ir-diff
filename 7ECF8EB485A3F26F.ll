...
if.then:                                          ; preds = %Assert.exit
  %.b.i = load i1, ptr @g_in_buffering_mode, align 4
  br i1 %.b.i, label %if.then.i, label %PDFPage_End.exit
...
while.body.i.i:                                   ; preds = %if.then.i, %while.body.i.i
  %3 = phi ptr [ %4, %while.body.i.i ], [ %.pr.i.i, %if.then.i ]
...
if.end.i:                                         ; preds = %if.end.i.i.i, %while.end.i.i, %if.then.i
...
while.body:                                       ; preds = %PDFPage_End.exit, %PDFFont_WriteFontResource.exit
  ...
  br i1 %tobool.not.i203, label %if.then.i204, label %PDFFont_WriteFontResource.exit
...
if.then.i204:                                     ; preds = %while.body
  ...
  br i1 %cmp.i.i, label %if.then.i.i, label %PDFFont_WriteObject.exit.i

if.then.i.i:                                      ; preds = %if.then.i204
  %call.i.i205 = tail call fastcc i32 @PDFObject_New()
  store i32 %call.i.i205, ptr %m_pdf_object_number.i.i, align 4, !tbaa !22
  br label %PDFFont_WriteObject.exit.i

PDFFont_WriteObject.exit.i:                       ; preds = %if.then.i.i, %if.then.i204
  %12 = phi i32 [ %call.i.i205, %if.then.i.i ], [ %11, %if.then.i204 ]
