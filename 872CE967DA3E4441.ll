; ModuleID = '/usr/local/google/home/aeubanks/repos/test-suite/SingleSource/Regression/C/gcc-c-torture/execute/20040629-1.c'
source_filename = "/usr/local/google/home/aeubanks/repos/test-suite/SingleSource/Regression/C/gcc-c-torture/execute/20040629-1.c"
...
entry:
  %bf.load = load i32, ptr @c, align 4
...
entry:
  ...
  store i32 %bf.lshr3, ptr @b, align 4
  ret void
}
...
entry:
  ...
  %add2 = shl i32 %x, 6
  %bf.lshr3 = add i32 %bf.load, %add2
  store i32 %bf.lshr3, ptr @c, align 4
  ret void
}
...
entry:
  ...
  %bf.set = or i32 %bf.value, %bf.clear2
  store i32 %bf.set, ptr @d, align 4
  ret void
}
...
entry:
  ...
  %add2 = shl i32 %x, 24
  %bf.lshr3 = add i32 %bf.load, %add2
  store i32 %bf.lshr3, ptr @d, align 4
  ret void
}
...
entry:
  %bf.load = load i32, ptr @c, align 4
  %bf.clear2 = and i32 %bf.load, -33
  store i32 %bf.clear2, ptr @c, align 4
  ret void
}
