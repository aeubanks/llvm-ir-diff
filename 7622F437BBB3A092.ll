...
entry:
  ...
  %cmp.i61 = icmp eq i8 %0, 37
  br i1 %cmp.i61, label %if.then.i, label %if.end.i.lr.ph
...
if.then.i:                                        ; preds = %if.then.i.loopexit, %entry
  %length.0.lcssa60 = phi i32 [ 0, %entry ], [ %1, %if.then.i.loopexit ]
  store i1 true, ptr @white_space.commentP, align 4
  br label %for.end
...
for.end:                                          ; preds = %for.end.loopexit, %if.then.i, %if.then2.i, %if.then6.i
  %.b.i39 = phi i1 [ false, %for.end.loopexit ], [ true, %if.then.i ], [ true, %if.then2.i ], [ false, %if.then6.i ]
  %length.055 = phi i32 [ %4, %for.end.loopexit ], [ %length.0.lcssa60, %if.then.i ], [ 0, %if.then2.i ], [ 0, %if.then6.i ]
  %idx.ext52 = zext i32 %length.055 to i64
...
if.then.i.i231:                                   ; preds = %get_responce.exit, %if.then.i.loopexit.i
  %length.0.lcssa60.i = phi i32 [ %18, %if.then.i.loopexit.i ], [ 0, %get_responce.exit ]
  store i1 true, ptr @white_space.commentP, align 4
  br label %for.end.i
...
for.end.i:                                        ; preds = %for.end.loopexit.i, %if.then.i.i231
  ...
  %length.055.i = phi i32 [ %21, %for.end.loopexit.i ], [ %length.0.lcssa60.i, %if.then.i.i231 ]
  %idx.ext52.i = zext i32 %length.055.i to i64
  %cmp4.i = icmp slt i32 %length.055.i, 1
  br i1 %cmp4.i, label %if.end.thread, label %if.else.i237

if.else.i237:                                     ; preds = %for.end.i
  %cmp8.i = icmp ugt i32 %length.055.i, 4
...
if.end34:                                         ; preds = %for.body, %if.then33, %land.lhs.true26
  ...
  %or.cond249 = select i1 %cmp40, i1 true, i1 %cmp47.not
