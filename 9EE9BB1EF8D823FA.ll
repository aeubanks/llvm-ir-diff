...
entry:
  ...
  %call = tail call noalias dereferenceable_or_null(808) ptr @malloc(i64 noundef 808) #10
  store ptr %call, ptr @C, align 8, !tbaa !5
  store i32 0, ptr @netctr, align 4, !tbaa !9
  tail call void @maketabl() #9
  %call1709 = call i32 (ptr, ptr, ...) @__isoc99_fscanf(ptr noundef %fp, ptr noundef nonnull @.str, ptr noundef nonnull %input) #9
  %cmp710 = icmp eq i32 %call1709, 1
  br i1 %cmp710, label %while.body, label %while.end

while.body:                                       ; preds = %entry, %if.end441
  %ptr.0715 = phi ptr [ %ptr.1, %if.end441 ], [ undef, %entry ]
  %ecount.0714 = phi i32 [ %ecount.1, %if.end441 ], [ 0, %entry ]
  %pinctr.0713 = phi i32 [ %pinctr.2, %if.end441 ], [ 0, %entry ]
  %soft.0712 = phi i32 [ %soft.1, %if.end441 ], [ undef, %entry ]
  %cell.0711 = phi i32 [ %cell.1, %if.end441 ], [ 0, %entry ]
...
if.then:                                          ; preds = %while.body
  %call5 = call i32 (ptr, ptr, ...) @__isoc99_fscanf(ptr noundef %fp, ptr noundef nonnull @.str.2, ptr noundef nonnull %cellnum) #9
  %call7 = call i32 (ptr, ptr, ...) @__isoc99_fscanf(ptr noundef %fp, ptr noundef nonnull @.str.3, ptr noundef nonnull %input) #9
  %call9 = call i32 (ptr, ptr, ...) @__isoc99_fscanf(ptr noundef %fp, ptr noundef nonnull @.str.3, ptr noundef nonnull %input) #9
  %0 = load ptr, ptr @cellarray, align 8, !tbaa !5
  %inc = add nsw i32 %cell.0711, 1
  ...
  %call16 = call i32 (ptr, ptr, ...) @__isoc99_fscanf(ptr noundef %fp, ptr noundef nonnull @.str.4, ptr noundef nonnull %ncorners) #9
  %call18 = call i32 (ptr, ptr, ...) @__isoc99_fscanf(ptr noundef %fp, ptr noundef nonnull @.str, ptr noundef nonnull %input) #9
  %3 = load i32, ptr %ncorners, align 4, !tbaa !9
  %cmp20.not703 = icmp slt i32 %3, 1
  br i1 %cmp20.not703, label %if.then.for.cond37.preheader_crit_edge, label %for.body21

if.then.for.cond37.preheader_crit_edge:           ; preds = %if.then
  %.pre771 = load ptr, ptr @C, align 8, !tbaa !5
  %.pre772 = load i32, ptr %.pre771, align 4, !tbaa !11
  br label %for.cond37.preheader

for.cond37.preheader:                             ; preds = %for.body21, %if.then.for.cond37.preheader_crit_edge
  %4 = phi i32 [ %.pre772, %if.then.for.cond37.preheader_crit_edge ], [ %12, %for.body21 ]
  %5 = phi ptr [ %.pre771, %if.then.for.cond37.preheader_crit_edge ], [ %9, %for.body21 ]
  %cmp40.not705 = icmp slt i32 %4, 1
  br i1 %cmp40.not705, label %for.end78, label %for.body41.lr.ph

for.body41.lr.ph:                                 ; preds = %for.cond37.preheader
  %yc55 = getelementptr inbounds %struct.bustbox, ptr %5, i64 1, i32 1
  %6 = zext i32 %4 to i64
  %7 = add nuw i32 %4, 1
  %wide.trip.count756 = zext i32 %7 to i64
  br label %for.body41

for.body21:                                       ; preds = %if.then, %for.body21
  %corner.0704 = phi i32 [ %inc35, %for.body21 ], [ 1, %if.then ]
  %call22 = call i32 (ptr, ptr, ...) @__isoc99_fscanf(ptr noundef %fp, ptr noundef nonnull @.str.5, ptr noundef nonnull %x, ptr noundef nonnull %y) #9
  ...
  %inc35 = add nuw nsw i32 %corner.0704, 1
  %13 = load i32, ptr %ncorners, align 4, !tbaa !9
  %cmp20.not.not = icmp slt i32 %corner.0704, %13
  br i1 %cmp20.not.not, label %for.body21, label %for.cond37.preheader, !llvm.loop !14

for.cond37:                                       ; preds = %if.end68
  %exitcond757.not = icmp eq i64 %indvars.iv.next754, %wide.trip.count756
  br i1 %exitcond757.not, label %for.end78, label %for.body41, !llvm.loop !16

for.body41:                                       ; preds = %for.body41.lr.ph, %for.cond37
  %indvars.iv753 = phi i64 [ 1, %for.body41.lr.ph ], [ %indvars.iv.next754, %for.cond37 ]
  %arrayidx43 = getelementptr inbounds %struct.bustbox, ptr %5, i64 %indvars.iv753
  %14 = load i32, ptr %arrayidx43, align 4, !tbaa !11
  %yc47 = getelementptr inbounds %struct.bustbox, ptr %5, i64 %indvars.iv753, i32 1
  %15 = load i32, ptr %yc47, align 4, !tbaa !13
  %cmp50 = icmp eq i64 %indvars.iv753, %6
  %indvars.iv.next754 = add nuw nsw i64 %indvars.iv753, 1
  %yc62 = getelementptr inbounds %struct.bustbox, ptr %5, i64 %indvars.iv.next754, i32 1
  %xx2.0.in.v = select i1 %cmp50, i64 1, i64 %indvars.iv.next754
...
if.end68:                                         ; preds = %for.body41
  ...
  br i1 %or.cond651, label %for.cond37, label %if.then72
...
for.end78:                                        ; preds = %for.cond37, %for.cond37.preheader
  %call80 = call i32 (ptr, ptr, ...) @__isoc99_fscanf(ptr noundef %fp, ptr noundef nonnull @.str, ptr noundef nonnull %input) #9
  %call81 = call i32 (ptr, ptr, ...) @__isoc99_fscanf(ptr noundef %fp, ptr noundef nonnull @.str.4, ptr noundef nonnull %class) #9
  %call82 = call i32 (ptr, ptr, ...) @__isoc99_fscanf(ptr noundef %fp, ptr noundef nonnull @.str.4, ptr noundef nonnull %norients) #9
  %call84 = call i32 (ptr, ptr, ...) @__isoc99_fscanf(ptr noundef %fp, ptr noundef nonnull @.str, ptr noundef nonnull %input) #9
  %22 = load i32, ptr %norients, align 4, !tbaa !9
  %cmp86.not707 = icmp slt i32 %22, 1
  br i1 %cmp86.not707, label %if.end441, label %for.body87

for.body87:                                       ; preds = %for.end78, %for.body87
  %orient.0708 = phi i32 [ %inc90, %for.body87 ], [ 1, %for.end78 ]
  %call88 = call i32 (ptr, ptr, ...) @__isoc99_fscanf(ptr noundef %fp, ptr noundef nonnull @.str.4, ptr noundef nonnull %x) #9
  %inc90 = add nuw nsw i32 %orient.0708, 1
  %23 = load i32, ptr %norients, align 4, !tbaa !9
  %cmp86.not.not = icmp slt i32 %orient.0708, %23
...
if.then96:                                        ; preds = %if.else92
  %call98 = call i32 (ptr, ptr, ...) @__isoc99_fscanf(ptr noundef %fp, ptr noundef nonnull @.str, ptr noundef nonnull %input) #9
  %call100 = call i32 (ptr, ptr, ...) @__isoc99_fscanf(ptr noundef %fp, ptr noundef nonnull @.str, ptr noundef nonnull %input) #9
  %call102 = call i32 (ptr, ptr, ...) @__isoc99_fscanf(ptr noundef %fp, ptr noundef nonnull @.str, ptr noundef nonnull %input) #9
  %call104 = call i32 (ptr, ptr, ...) @__isoc99_fscanf(ptr noundef %fp, ptr noundef nonnull @.str, ptr noundef nonnull %input) #9
  %inc105 = add nsw i32 %pinctr.0713, 1
  %call107 = call i32 @addhash(ptr noundef nonnull %input) #9
  %call108 = call i32 (ptr, ptr, ...) @__isoc99_fscanf(ptr noundef %fp, ptr noundef nonnull @.str.5, ptr noundef nonnull %xpos, ptr noundef nonnull %ypos) #9
  %cmp109 = icmp eq i32 %soft.0712, 1
  br i1 %cmp109, label %land.lhs.true110, label %if.end441

land.lhs.true110:                                 ; preds = %if.then96
  %numUnComTerms = getelementptr inbounds %struct.cellbox, ptr %ptr.0715, i64 0, i32 18
...
for.cond113.preheader:                            ; preds = %land.lhs.true110
  ...
  %cmp116.not700 = icmp slt i32 %26, 1
  br i1 %cmp116.not700, label %if.end441, label %for.body117.lr.ph
...
for.body117.lr.ph:                                ; preds = %for.cond113.preheader
  ...
  %30 = add nuw i32 %26, 1
  %wide.trip.count748 = zext i32 %30 to i64
  br label %for.body117

for.body117:                                      ; preds = %for.body117.lr.ph, %for.inc156
  %indvars.iv745 = phi i64 [ 1, %for.body117.lr.ph ], [ %indvars.iv.next746, %for.inc156 ]
  %arrayidx119 = getelementptr inbounds %struct.bustbox, ptr %25, i64 %indvars.iv745
  %31 = load i32, ptr %arrayidx119, align 4, !tbaa !11
  %cmp126 = icmp eq i64 %indvars.iv745, %29
  %indvars.iv.next746 = add nuw nsw i64 %indvars.iv745, 1
  %32 = and i64 %indvars.iv.next746, 4294967295
...
if.else149:                                       ; preds = %for.body117
  %yc123 = getelementptr inbounds %struct.bustbox, ptr %25, i64 %indvars.iv745, i32 1
...
for.inc156:                                       ; preds = %if.then143, %if.else149
  ...
  br i1 %exitcond749.not, label %if.end441, label %for.body117, !llvm.loop !21
...
if.then164:                                       ; preds = %if.else160
  %cmp165 = icmp eq i32 %soft.0712, 1
...
if.then166:                                       ; preds = %if.then164
  ...
  %call168 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %36, ptr noundef nonnull @.str.13, i32 noundef %cell.0711)
  call void @exit(i32 noundef 0) #11
  unreachable

if.end169:                                        ; preds = %if.then164
  %inc170 = add nsw i32 %ecount.0714, 1
  %call172 = call i32 (ptr, ptr, ...) @__isoc99_fscanf(ptr noundef %fp, ptr noundef nonnull @.str, ptr noundef nonnull %input) #9
  %call174 = call i32 (ptr, ptr, ...) @__isoc99_fscanf(ptr noundef %fp, ptr noundef nonnull @.str, ptr noundef nonnull %input) #9
  %call175 = call i32 (ptr, ptr, ...) @__isoc99_fscanf(ptr noundef %fp, ptr noundef nonnull @.str.5, ptr noundef nonnull %xpos, ptr noundef nonnull %ypos) #9
  br label %if.end441
...
if.then180:                                       ; preds = %if.else176
  %call181 = call i32 (ptr, ptr, ...) @__isoc99_fscanf(ptr noundef %fp, ptr noundef nonnull @.str.2, ptr noundef nonnull %cellnum) #9
  %call183 = call i32 (ptr, ptr, ...) @__isoc99_fscanf(ptr noundef %fp, ptr noundef nonnull @.str.3, ptr noundef nonnull %input) #9
  %call185 = call i32 (ptr, ptr, ...) @__isoc99_fscanf(ptr noundef %fp, ptr noundef nonnull @.str.3, ptr noundef nonnull %input) #9
  %37 = load ptr, ptr @cellarray, align 8, !tbaa !5
  %inc186 = add nsw i32 %cell.0711, 1
  ...
  %call201 = call i32 (ptr, ptr, ...) @__isoc99_fscanf(ptr noundef %fp, ptr noundef nonnull @.str.4, ptr noundef nonnull %ncorners) #9
  %call203 = call i32 (ptr, ptr, ...) @__isoc99_fscanf(ptr noundef %fp, ptr noundef nonnull @.str, ptr noundef nonnull %input) #9
  %40 = load i32, ptr %ncorners, align 4, !tbaa !9
  %cmp205.not694 = icmp slt i32 %40, 1
  br i1 %cmp205.not694, label %if.then180.for.cond222.preheader_crit_edge, label %for.body206

if.then180.for.cond222.preheader_crit_edge:       ; preds = %if.then180
  %.pre769 = load ptr, ptr @C, align 8, !tbaa !5
  %.pre770 = load i32, ptr %.pre769, align 4, !tbaa !11
  br label %for.cond222.preheader

for.cond222.preheader:                            ; preds = %for.body206, %if.then180.for.cond222.preheader_crit_edge
  %41 = phi i32 [ %.pre770, %if.then180.for.cond222.preheader_crit_edge ], [ %49, %for.body206 ]
  %42 = phi ptr [ %.pre769, %if.then180.for.cond222.preheader_crit_edge ], [ %46, %for.body206 ]
  %cmp225.not696 = icmp slt i32 %41, 1
  br i1 %cmp225.not696, label %for.end267, label %for.body226.lr.ph

for.body226.lr.ph:                                ; preds = %for.cond222.preheader
  %yc240 = getelementptr inbounds %struct.bustbox, ptr %42, i64 1, i32 1
  %43 = zext i32 %41 to i64
  %44 = add nuw i32 %41, 1
  %wide.trip.count743 = zext i32 %44 to i64
  br label %for.body226

for.body206:                                      ; preds = %if.then180, %for.body206
  %corner.1695 = phi i32 [ %inc220, %for.body206 ], [ 1, %if.then180 ]
  %call207 = call i32 (ptr, ptr, ...) @__isoc99_fscanf(ptr noundef %fp, ptr noundef nonnull @.str.5, ptr noundef nonnull %x, ptr noundef nonnull %y) #9
  ...
  %inc220 = add nuw nsw i32 %corner.1695, 1
  %50 = load i32, ptr %ncorners, align 4, !tbaa !9
  %cmp205.not.not = icmp slt i32 %corner.1695, %50
  br i1 %cmp205.not.not, label %for.body206, label %for.cond222.preheader, !llvm.loop !22

for.cond222:                                      ; preds = %if.end257
  %exitcond744.not = icmp eq i64 %indvars.iv.next741, %wide.trip.count743
  br i1 %exitcond744.not, label %for.end267, label %for.body226, !llvm.loop !23

for.body226:                                      ; preds = %for.body226.lr.ph, %for.cond222
  %indvars.iv740 = phi i64 [ 1, %for.body226.lr.ph ], [ %indvars.iv.next741, %for.cond222 ]
  %arrayidx228 = getelementptr inbounds %struct.bustbox, ptr %42, i64 %indvars.iv740
  %51 = load i32, ptr %arrayidx228, align 4, !tbaa !11
  %yc232 = getelementptr inbounds %struct.bustbox, ptr %42, i64 %indvars.iv740, i32 1
  %52 = load i32, ptr %yc232, align 4, !tbaa !13
  %cmp235 = icmp eq i64 %indvars.iv740, %43
  %indvars.iv.next741 = add nuw nsw i64 %indvars.iv740, 1
  %yc249 = getelementptr inbounds %struct.bustbox, ptr %42, i64 %indvars.iv.next741, i32 1
  %xx2.2.in.v = select i1 %cmp235, i64 1, i64 %indvars.iv.next741
...
if.end257:                                        ; preds = %for.body226
  ...
  br i1 %or.cond653, label %for.cond222, label %if.then261
...
for.end267:                                       ; preds = %for.cond222, %for.cond222.preheader
  %call269 = call i32 (ptr, ptr, ...) @__isoc99_fscanf(ptr noundef %fp, ptr noundef nonnull @.str, ptr noundef nonnull %input) #9
  %call270 = call i32 (ptr, ptr, ...) @__isoc99_fscanf(ptr noundef %fp, ptr noundef nonnull @.str.16, ptr noundef nonnull %asplb) #9
  %call272 = call i32 (ptr, ptr, ...) @__isoc99_fscanf(ptr noundef %fp, ptr noundef nonnull @.str, ptr noundef nonnull %input) #9
  %call273 = call i32 (ptr, ptr, ...) @__isoc99_fscanf(ptr noundef %fp, ptr noundef nonnull @.str.16, ptr noundef nonnull %aspub) #9
  %call275 = call i32 (ptr, ptr, ...) @__isoc99_fscanf(ptr noundef %fp, ptr noundef nonnull @.str, ptr noundef nonnull %input) #9
  %call276 = call i32 (ptr, ptr, ...) @__isoc99_fscanf(ptr noundef %fp, ptr noundef nonnull @.str.4, ptr noundef nonnull %class) #9
  %call277 = call i32 (ptr, ptr, ...) @__isoc99_fscanf(ptr noundef %fp, ptr noundef nonnull @.str.4, ptr noundef nonnull %norients) #9
  %call279 = call i32 (ptr, ptr, ...) @__isoc99_fscanf(ptr noundef %fp, ptr noundef nonnull @.str, ptr noundef nonnull %input) #9
  %59 = load i32, ptr %norients, align 4, !tbaa !9
  %cmp281.not698 = icmp slt i32 %59, 1
  br i1 %cmp281.not698, label %if.end441, label %for.body282

for.body282:                                      ; preds = %for.end267, %for.body282
  %orient.1699 = phi i32 [ %inc285, %for.body282 ], [ 1, %for.end267 ]
  %call283 = call i32 (ptr, ptr, ...) @__isoc99_fscanf(ptr noundef %fp, ptr noundef nonnull @.str.4, ptr noundef nonnull %x) #9
  %inc285 = add nuw nsw i32 %orient.1699, 1
  %60 = load i32, ptr %norients, align 4, !tbaa !9
  %cmp281.not.not = icmp slt i32 %orient.1699, %60
...
if.then294:                                       ; preds = %lor.lhs.false, %if.else287
  %call295 = call i32 (ptr, ptr, ...) @__isoc99_fscanf(ptr noundef %fp, ptr noundef nonnull @.str.4, ptr noundef nonnull %sequence) #9
  %61 = load i32, ptr %sequence, align 4, !tbaa !9
  %numUnComTerms296 = getelementptr inbounds %struct.cellbox, ptr %ptr.0715, i64 0, i32 18
  ...
  %cmp299.not690 = icmp slt i32 %61, 1
  br i1 %cmp299.not690, label %for.end316, label %for.body300

for.body300:                                      ; preds = %if.then294, %for.body300
  %i.0692 = phi i32 [ %inc315, %for.body300 ], [ 1, %if.then294 ]
  %pinctr.1691 = phi i32 [ %inc311, %for.body300 ], [ %pinctr.0713, %if.then294 ]
  %call302 = call i32 (ptr, ptr, ...) @__isoc99_fscanf(ptr noundef %fp, ptr noundef nonnull @.str, ptr noundef nonnull %input) #9
  %call304 = call i32 (ptr, ptr, ...) @__isoc99_fscanf(ptr noundef %fp, ptr noundef nonnull @.str, ptr noundef nonnull %input) #9
  %call306 = call i32 (ptr, ptr, ...) @__isoc99_fscanf(ptr noundef %fp, ptr noundef nonnull @.str, ptr noundef nonnull %input) #9
  %call308 = call i32 (ptr, ptr, ...) @__isoc99_fscanf(ptr noundef %fp, ptr noundef nonnull @.str, ptr noundef nonnull %input) #9
  %call310 = call i32 (ptr, ptr, ...) @__isoc99_fscanf(ptr noundef %fp, ptr noundef nonnull @.str, ptr noundef nonnull %input) #9
  %inc311 = add nsw i32 %pinctr.1691, 1
  %call313 = call i32 @addhash(ptr noundef nonnull %input) #9
  %inc315 = add nuw nsw i32 %i.0692, 1
  %63 = load i32, ptr %sequence, align 4, !tbaa !9
  %cmp299.not.not = icmp slt i32 %i.0692, %63
  br i1 %cmp299.not.not, label %for.body300, label %for.end316, !llvm.loop !25

for.end316:                                       ; preds = %for.body300, %if.then294
  %pinctr.1.lcssa = phi i32 [ %pinctr.0713, %if.then294 ], [ %inc311, %for.body300 ]
  %call318 = call i32 (ptr, ptr, ...) @__isoc99_fscanf(ptr noundef %fp, ptr noundef nonnull @.str, ptr noundef nonnull %input) #9
  %call319 = call i32 (ptr, ptr, ...) @__isoc99_fscanf(ptr noundef %fp, ptr noundef nonnull @.str.5, ptr noundef nonnull %firstside, ptr noundef nonnull %lastside) #9
  br label %if.end441
...
if.then324:                                       ; preds = %if.else320
  %call325 = call i32 (ptr, ptr, ...) @__isoc99_fscanf(ptr noundef %fp, ptr noundef nonnull @.str.2, ptr noundef nonnull %cellnum) #9
  %call327 = call i32 (ptr, ptr, ...) @__isoc99_fscanf(ptr noundef %fp, ptr noundef nonnull @.str.3, ptr noundef nonnull %input) #9
  %call329 = call i32 (ptr, ptr, ...) @__isoc99_fscanf(ptr noundef %fp, ptr noundef nonnull @.str.3, ptr noundef nonnull %input) #9
  %64 = load ptr, ptr @cellarray, align 8, !tbaa !5
  %inc330 = add nsw i32 %cell.0711, 1
  ...
  %call345 = call i32 (ptr, ptr, ...) @__isoc99_fscanf(ptr noundef %fp, ptr noundef nonnull @.str.4, ptr noundef nonnull %ncorners) #9
...
if.then324.for.cond366.preheader_crit_edge:       ; preds = %if.then324
  ...
  %.pre768 = load i32, ptr %.pre, align 4, !tbaa !11
  br label %for.cond366.preheader

for.cond366.preheader:                            ; preds = %for.body350, %if.then324.for.cond366.preheader_crit_edge
  %68 = phi i32 [ %.pre768, %if.then324.for.cond366.preheader_crit_edge ], [ %76, %for.body350 ]
  %69 = phi ptr [ %.pre, %if.then324.for.cond366.preheader_crit_edge ], [ %73, %for.body350 ]
  %cmp369.not686 = icmp slt i32 %68, 1
  br i1 %cmp369.not686, label %for.end411, label %for.body370.lr.ph

for.body370.lr.ph:                                ; preds = %for.cond366.preheader
...
for.body350:                                      ; preds = %if.then324, %for.body350
  ...
  %call351 = call i32 (ptr, ptr, ...) @__isoc99_fscanf(ptr noundef %fp, ptr noundef nonnull @.str.5, ptr noundef nonnull %x, ptr noundef nonnull %y) #9
...
for.cond366:                                      ; preds = %if.end401
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %for.end411, label %for.body370, !llvm.loop !27

for.body370:                                      ; preds = %for.body370.lr.ph, %for.cond366
  %indvars.iv = phi i64 [ 1, %for.body370.lr.ph ], [ %indvars.iv.next, %for.cond366 ]
...
if.end401:                                        ; preds = %for.body370
  ...
  br i1 %or.cond655, label %for.cond366, label %if.then405
...
for.end411:                                       ; preds = %for.cond366, %for.cond366.preheader
  %call413 = call i32 (ptr, ptr, ...) @__isoc99_fscanf(ptr noundef %fp, ptr noundef nonnull @.str, ptr noundef nonnull %input) #9
  %call415 = call i32 (ptr, ptr, ...) @__isoc99_fscanf(ptr noundef %fp, ptr noundef nonnull @.str, ptr noundef nonnull %input) #9
  %call417 = call i32 (ptr, ptr, ...) @__isoc99_fscanf(ptr noundef %fp, ptr noundef nonnull @.str, ptr noundef nonnull %input) #9
  %call418 = call i32 (ptr, ptr, ...) @__isoc99_fscanf(ptr noundef %fp, ptr noundef nonnull @.str.4, ptr noundef nonnull %class) #9
  %call419 = call i32 (ptr, ptr, ...) @__isoc99_fscanf(ptr noundef %fp, ptr noundef nonnull @.str.4, ptr noundef nonnull %norients) #9
  %call421 = call i32 (ptr, ptr, ...) @__isoc99_fscanf(ptr noundef %fp, ptr noundef nonnull @.str, ptr noundef nonnull %input) #9
  %86 = load i32, ptr %norients, align 4, !tbaa !9
  %cmp423.not688 = icmp slt i32 %86, 1
  br i1 %cmp423.not688, label %if.end441, label %for.body424

for.body424:                                      ; preds = %for.end411, %for.body424
  %orient.2689 = phi i32 [ %inc427, %for.body424 ], [ 1, %for.end411 ]
  %call425 = call i32 (ptr, ptr, ...) @__isoc99_fscanf(ptr noundef %fp, ptr noundef nonnull @.str.4, ptr noundef nonnull %x) #9
  %inc427 = add nuw nsw i32 %orient.2689, 1
  %87 = load i32, ptr %norients, align 4, !tbaa !9
  %cmp423.not.not = icmp slt i32 %orient.2689, %87
...
if.then433:                                       ; preds = %if.else429
  %call434 = call i32 (ptr, ptr, ...) @__isoc99_fscanf(ptr noundef %fp, ptr noundef nonnull @.str.21, ptr noundef nonnull %space) #9
  br label %if.end441
...
if.end441:                                        ; preds = %for.body424, %for.body282, %for.inc156, %for.body87, %for.end411, %for.end267, %for.cond113.preheader, %for.end78, %if.then145, %if.then151, %land.lhs.true110, %if.then96, %if.then433, %if.else429, %for.end316, %if.end169
  %cell.1 = phi i32 [ %cell.0711, %if.then145 ], [ %cell.0711, %if.then151 ], [ %cell.0711, %land.lhs.true110 ], [ %cell.0711, %if.then96 ], [ %cell.0711, %if.end169 ], [ %cell.0711, %for.end316 ], [ %cell.0711, %if.then433 ], [ %cell.0711, %if.else429 ], [ %inc, %for.end78 ], [ %cell.0711, %for.cond113.preheader ], [ %inc186, %for.end267 ], [ %inc330, %for.end411 ], [ %inc, %for.body87 ], [ %cell.0711, %for.inc156 ], [ %inc186, %for.body282 ], [ %inc330, %for.body424 ]
  %soft.1 = phi i32 [ 1, %if.then145 ], [ 1, %if.then151 ], [ 1, %land.lhs.true110 ], [ %soft.0712, %if.then96 ], [ %soft.0712, %if.end169 ], [ %soft.0712, %for.end316 ], [ %soft.0712, %if.then433 ], [ %soft.0712, %if.else429 ], [ 0, %for.end78 ], [ 1, %for.cond113.preheader ], [ 1, %for.end267 ], [ 0, %for.end411 ], [ 0, %for.body87 ], [ 1, %for.inc156 ], [ 1, %for.body282 ], [ 0, %for.body424 ]
  %pinctr.2 = phi i32 [ %inc105, %if.then145 ], [ %inc105, %if.then151 ], [ %inc105, %land.lhs.true110 ], [ %inc105, %if.then96 ], [ %pinctr.0713, %if.end169 ], [ %pinctr.1.lcssa, %for.end316 ], [ %pinctr.0713, %if.then433 ], [ %pinctr.0713, %if.else429 ], [ %pinctr.0713, %for.end78 ], [ %inc105, %for.cond113.preheader ], [ %pinctr.0713, %for.end267 ], [ %pinctr.0713, %for.end411 ], [ %pinctr.0713, %for.body87 ], [ %inc105, %for.inc156 ], [ %pinctr.0713, %for.body282 ], [ %pinctr.0713, %for.body424 ]
  %ecount.1 = phi i32 [ %ecount.0714, %if.then145 ], [ %ecount.0714, %if.then151 ], [ %ecount.0714, %land.lhs.true110 ], [ %ecount.0714, %if.then96 ], [ %inc170, %if.end169 ], [ %ecount.0714, %for.end316 ], [ %ecount.0714, %if.then433 ], [ %ecount.0714, %if.else429 ], [ %ecount.0714, %for.end78 ], [ %ecount.0714, %for.cond113.preheader ], [ %ecount.0714, %for.end267 ], [ %ecount.0714, %for.end411 ], [ %ecount.0714, %for.body87 ], [ %ecount.0714, %for.inc156 ], [ %ecount.0714, %for.body282 ], [ %ecount.0714, %for.body424 ]
  %ptr.1 = phi ptr [ %ptr.0715, %if.then145 ], [ %ptr.0715, %if.then151 ], [ %ptr.0715, %land.lhs.true110 ], [ %ptr.0715, %if.then96 ], [ %ptr.0715, %if.end169 ], [ %ptr.0715, %for.end316 ], [ %ptr.0715, %if.then433 ], [ %ptr.0715, %if.else429 ], [ %1, %for.end78 ], [ %ptr.0715, %for.cond113.preheader ], [ %38, %for.end267 ], [ %65, %for.end411 ], [ %1, %for.body87 ], [ %ptr.0715, %for.inc156 ], [ %38, %for.body282 ], [ %65, %for.body424 ]
  %call1 = call i32 (ptr, ptr, ...) @__isoc99_fscanf(ptr noundef %fp, ptr noundef nonnull @.str, ptr noundef nonnull %input) #9
...
while.end:                                        ; preds = %if.end441, %entry
  ...
  %call443 = call noalias ptr @malloc(i64 noundef %mul) #10
  store ptr %call443, ptr @termarray, align 8, !tbaa !5
  %cmp445.not718 = icmp slt i32 %pinctr.0.lcssa, 1
  br i1 %cmp445.not718, label %for.end452, label %for.body447.preheader

for.body447.preheader:                            ; preds = %while.end
  %wide.trip.count761 = zext i32 %add442 to i64
  %88 = add nsw i64 %wide.trip.count761, -1
  %89 = add nsw i64 %wide.trip.count761, -2
...
for.body447:                                      ; preds = %for.body447, %for.body447.preheader.new
  %indvars.iv758 = phi i64 [ 1, %for.body447.preheader.new ], [ %indvars.iv.next759.3, %for.body447 ]
  %niter = phi i64 [ 0, %for.body447.preheader.new ], [ %niter.next.3, %for.body447 ]
  %91 = load ptr, ptr @termarray, align 8, !tbaa !5
  %arrayidx449 = getelementptr inbounds ptr, ptr %91, i64 %indvars.iv758
  store ptr null, ptr %arrayidx449, align 8, !tbaa !5
  %indvars.iv.next759 = add nuw nsw i64 %indvars.iv758, 1
  %92 = load ptr, ptr @termarray, align 8, !tbaa !5
  %arrayidx449.1 = getelementptr inbounds ptr, ptr %92, i64 %indvars.iv.next759
  store ptr null, ptr %arrayidx449.1, align 8, !tbaa !5
  %indvars.iv.next759.1 = add nuw nsw i64 %indvars.iv758, 2
  %93 = load ptr, ptr @termarray, align 8, !tbaa !5
  %arrayidx449.2 = getelementptr inbounds ptr, ptr %93, i64 %indvars.iv.next759.1
  store ptr null, ptr %arrayidx449.2, align 8, !tbaa !5
  %indvars.iv.next759.2 = add nuw nsw i64 %indvars.iv758, 3
  %94 = load ptr, ptr @termarray, align 8, !tbaa !5
  %arrayidx449.3 = getelementptr inbounds ptr, ptr %94, i64 %indvars.iv.next759.2
  store ptr null, ptr %arrayidx449.3, align 8, !tbaa !5
  %indvars.iv.next759.3 = add nuw nsw i64 %indvars.iv758, 4
...
for.end452.loopexit.unr-lcssa:                    ; preds = %for.body447, %for.body447.preheader
  %indvars.iv758.unr = phi i64 [ 1, %for.body447.preheader ], [ %indvars.iv.next759.3, %for.body447 ]
...
for.body447.epil:                                 ; preds = %for.end452.loopexit.unr-lcssa, %for.body447.epil
  %indvars.iv758.epil = phi i64 [ %indvars.iv.next759.epil, %for.body447.epil ], [ %indvars.iv758.unr, %for.end452.loopexit.unr-lcssa ]
  ...
  %arrayidx449.epil = getelementptr inbounds ptr, ptr %95, i64 %indvars.iv758.epil
  store ptr null, ptr %arrayidx449.epil, align 8, !tbaa !5
  %indvars.iv.next759.epil = add nuw nsw i64 %indvars.iv758.epil, 1
...
for.end452:                                       ; preds = %for.end452.loopexit.unr-lcssa, %for.body447.epil, %while.end
  ...
  %call456 = call noalias ptr @malloc(i64 noundef %mul) #10
  ...
  %call460 = call noalias ptr @malloc(i64 noundef %mul459) #10
  store ptr %call460, ptr @netarray, align 8, !tbaa !5
  %cmp462.not720 = icmp slt i32 %96, 1
  br i1 %cmp462.not720, label %for.end470, label %for.body464.preheader

for.body464.preheader:                            ; preds = %for.end452
  %wide.trip.count766 = zext i32 %add457 to i64
  br label %for.body464

for.body464:                                      ; preds = %for.body464.preheader, %for.body464
  %indvars.iv763 = phi i64 [ 1, %for.body464.preheader ], [ %indvars.iv.next764, %for.body464 ]
  %call465 = call noalias dereferenceable_or_null(72) ptr @malloc(i64 noundef 72) #10
  %97 = load ptr, ptr @netarray, align 8, !tbaa !5
  %arrayidx467 = getelementptr inbounds ptr, ptr %97, i64 %indvars.iv763
  ...
  br i1 %exitcond767.not, label %for.end470, label %for.body464, !llvm.loop !35
