...
"produce f2":                                     ; preds = %"assert succeeded77"
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 32 dereferenceable(64) %"inv_X4$3.022", ptr noundef nonnull align 4 dereferenceable(64) %scevgep673, i64 64, i1 false)
  %scevgep672.1 = getelementptr inbounds i8, ptr %"inv_X4$3.022", i64 64
  %278 = add i64 %276, %277
  ...
  %scevgep672.2 = getelementptr inbounds i8, ptr %"inv_X4$3.022", i64 128
  ...
  %scevgep672.3 = getelementptr inbounds i8, ptr %"inv_X4$3.022", i64 192
  ...
  %scevgep672.4 = getelementptr inbounds i8, ptr %"inv_X4$3.022", i64 256
  ...
  %scevgep672.5 = getelementptr inbounds i8, ptr %"inv_X4$3.022", i64 320
  ...
  %scevgep672.6 = getelementptr inbounds i8, ptr %"inv_X4$3.022", i64 384
  ...
  %scevgep672.7 = getelementptr inbounds i8, ptr %"inv_X4$3.022", i64 448
  ...
  %scevgep672.8 = getelementptr inbounds i8, ptr %"inv_X4$3.022", i64 512
  ...
  %scevgep672.9 = getelementptr inbounds i8, ptr %"inv_X4$3.022", i64 576
  ...
  %scevgep672.10 = getelementptr inbounds i8, ptr %"inv_X4$3.022", i64 640
  ...
  %scevgep672.11 = getelementptr inbounds i8, ptr %"inv_X4$3.022", i64 704
  ...
  %scevgep672.12 = getelementptr inbounds i8, ptr %"inv_X4$3.022", i64 768
  ...
  %scevgep672.13 = getelementptr inbounds i8, ptr %"inv_X4$3.022", i64 832
  ...
  %scevgep672.14 = getelementptr inbounds i8, ptr %"inv_X4$3.022", i64 896
  ...
  %scevgep672.15 = getelementptr inbounds i8, ptr %"inv_X4$3.022", i64 960
  ...
  %307 = load <4 x float>, ptr %f1.028, align 32
  %308 = load <4 x float>, ptr %f1.127, align 32
...
"for kernel_fft1_S4_R4_n1.s1.r72$y":              ; preds = %"for kernel_fft1_S4_R4_n1.s1.n0.g", %"for kernel_fft1_S4_R4_n1.s1.r72$y"
  %indvars.iv681 = phi i64 [ 0, %"for kernel_fft1_S4_R4_n1.s1.n0.g" ], [ %indvars.iv.next682, %"for kernel_fft1_S4_R4_n1.s1.r72$y" ]
  ...
  %579 = getelementptr inbounds float, ptr %f1.028, i64 %indvars.iv681
  ...
  %586 = getelementptr inbounds float, ptr %f1.127, i64 %indvars.iv681
...
"for result.s0.i.preheader":                      ; preds = %"produce result"
  ...
  %726 = zext i32 %a11 to i64
  %727 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.010, i64 8
  %728 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.19, i64 8
  %729 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.010, i64 16
  %730 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.19, i64 16
  %731 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.010, i64 24
  %732 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.19, i64 24
  %733 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.010, i64 32
  %734 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.19, i64 32
  %735 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.010, i64 40
  %736 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.19, i64 40
  %737 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.010, i64 48
  %738 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.19, i64 48
  %739 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.010, i64 56
  %740 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.19, i64 56
  %741 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.010, i64 64
  %742 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.19, i64 64
  %743 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.010, i64 72
  %744 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.19, i64 72
  %745 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.010, i64 80
  %746 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.19, i64 80
  %747 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.010, i64 88
  %748 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.19, i64 88
  %749 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.010, i64 96
  %750 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.19, i64 96
  %751 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.010, i64 104
  %752 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.19, i64 104
  %753 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.010, i64 112
  %754 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.19, i64 112
  %755 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.010, i64 120
  %756 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.19, i64 120
  %757 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.010, i64 8
  %758 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.19, i64 8
  %759 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.010, i64 16
  %760 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.19, i64 16
  %761 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.010, i64 24
  %762 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.19, i64 24
  %763 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.010, i64 32
  %764 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.19, i64 32
  %765 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.010, i64 40
  %766 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.19, i64 40
  %767 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.010, i64 48
  %768 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.19, i64 48
  %769 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.010, i64 56
  %770 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.19, i64 56
  %771 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.010, i64 64
  %772 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.19, i64 64
  %773 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.010, i64 72
  %774 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.19, i64 72
  %775 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.010, i64 80
  %776 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.19, i64 80
  %777 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.010, i64 88
  %778 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.19, i64 88
  %779 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.010, i64 96
  %780 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.19, i64 96
  %781 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.010, i64 104
  %782 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.19, i64 104
  %783 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.010, i64 112
  %784 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.19, i64 112
  %785 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.010, i64 120
  %786 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.19, i64 120
  %xtraiter = and i64 %726, 1
  %787 = icmp eq i32 %a11, 1
...
"for result.s0.i":                                ; preds = %"for result.s0.i.preheader", %"end for result.s0.n1"
  %indvars.iv710 = phi i64 [ %722, %"for result.s0.i.preheader" ], [ %indvars.iv.next711, %"end for result.s0.n1" ]
...
"for fwd_fft0_S4_R4_n0.s1.n1":                    ; preds = %"for result.s0.i", %"for fwd_fft0_S4_R4_n0.s1.n1"
  %indvars.iv684 = phi i64 [ 0, %"for result.s0.i" ], [ %indvars.iv.next685, %"for fwd_fft0_S4_R4_n0.s1.n1" ]
  %790 = trunc i64 %indvars.iv684 to i32
  %reass.add627 = sub i32 %790, %20
  %reass.mul628 = mul i32 %reass.add627, %24
  %t950 = add i32 %789, %reass.mul628
  %791 = sext i32 %t950 to i64
  ...
  %v_inv_fft0_S4_R4_n0.020.sroa.0.0.vec.extract64 = shufflevector <16 x float> %814, <16 x float> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %v_inv_fft0_S4_R4_n0.119.sroa.0.0.vec.extract104 = shufflevector <16 x float> %817, <16 x float> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %v_inv_fft0_S4_R4_n0.020.sroa.0.16.vec.extract73 = shufflevector <16 x float> %814, <16 x float> undef, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
  %819 = fmul <4 x float> %673, %v_inv_fft0_S4_R4_n0.020.sroa.0.16.vec.extract73
  %v_inv_fft0_S4_R4_n0.119.sroa.0.16.vec.extract113 = shufflevector <16 x float> %817, <16 x float> undef, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
  %820 = fmul <4 x float> %674, %v_inv_fft0_S4_R4_n0.119.sroa.0.16.vec.extract113
  %821 = fsub <4 x float> %819, %820
  %822 = fmul <4 x float> %674, %v_inv_fft0_S4_R4_n0.020.sroa.0.16.vec.extract73
  %823 = fmul <4 x float> %673, %v_inv_fft0_S4_R4_n0.119.sroa.0.16.vec.extract113
  %824 = fadd <4 x float> %822, %823
  %v_inv_fft0_S4_R4_n0.020.sroa.14.32.vec.extract84 = shufflevector <8 x float> %815, <8 x float> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %825 = fmul <4 x float> %676, %v_inv_fft0_S4_R4_n0.020.sroa.14.32.vec.extract84
  %v_inv_fft0_S4_R4_n0.119.sroa.14.32.vec.extract124 = shufflevector <8 x float> %818, <8 x float> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %826 = fmul <4 x float> %678, %v_inv_fft0_S4_R4_n0.119.sroa.14.32.vec.extract124
  %827 = fsub <4 x float> %825, %826
  %828 = fmul <4 x float> %678, %v_inv_fft0_S4_R4_n0.020.sroa.14.32.vec.extract84
  %829 = fmul <4 x float> %676, %v_inv_fft0_S4_R4_n0.119.sroa.14.32.vec.extract124
  %830 = fadd <4 x float> %828, %829
  %v_inv_fft0_S4_R4_n0.020.sroa.14.48.vec.extract95 = shufflevector <8 x float> %815, <8 x float> poison, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
  %831 = fmul <4 x float> %v_inv_fft0_S4_R4_n0.020.sroa.14.48.vec.extract95, %684
  %v_inv_fft0_S4_R4_n0.119.sroa.14.48.vec.extract135 = shufflevector <8 x float> %818, <8 x float> poison, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
  %832 = fmul <4 x float> %v_inv_fft0_S4_R4_n0.119.sroa.14.48.vec.extract135, %690
  %833 = fsub <4 x float> %831, %832
  %834 = fmul <4 x float> %v_inv_fft0_S4_R4_n0.020.sroa.14.48.vec.extract95, %690
  %835 = fmul <4 x float> %v_inv_fft0_S4_R4_n0.119.sroa.14.48.vec.extract135, %684
  %836 = fadd <4 x float> %835, %834
  %837 = fadd <4 x float> %v_inv_fft0_S4_R4_n0.020.sroa.0.0.vec.extract64, %827
  %838 = fadd <4 x float> %v_inv_fft0_S4_R4_n0.119.sroa.0.0.vec.extract104, %830
  ...
  %845 = fsub <4 x float> %v_inv_fft0_S4_R4_n0.020.sroa.0.0.vec.extract64, %827
  %846 = fsub <4 x float> %v_inv_fft0_S4_R4_n0.119.sroa.0.0.vec.extract104, %830
  ...
  %854 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.024, i64 %853
  store <4 x float> %841, ptr %854, align 32, !tbaa !134
  %855 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.123, i64 %853
  store <4 x float> %842, ptr %855, align 32, !tbaa !136
  %856 = or i64 %853, 4
  %857 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.024, i64 %856
  store <4 x float> %849, ptr %857, align 16, !tbaa !134
  %858 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.123, i64 %856
  store <4 x float> %850, ptr %858, align 16, !tbaa !136
  %859 = add nuw nsw i64 %853, 8
  %860 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.024, i64 %859
  store <4 x float> %843, ptr %860, align 32, !tbaa !134
  %861 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.123, i64 %859
  store <4 x float> %844, ptr %861, align 32, !tbaa !136
  %862 = add nuw nsw i64 %853, 12
  %863 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.024, i64 %862
  store <4 x float> %851, ptr %863, align 16, !tbaa !134
  %864 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.123, i64 %862
...
"for fwd_fft1_S4_R4_n1.s1.n0.g":                  ; preds = %"for fwd_fft0_S4_R4_n0.s1.n1", %"end for fwd_fft1_S4_R4_n1.s1.r26$y"
  ...
  %865 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.024, i64 %fwd_fft1_S4_R4_n1.s1.n0.g
  %866 = load <8 x float>, ptr %865, align 32, !tbaa !134
  %867 = or i64 %fwd_fft1_S4_R4_n1.s1.n0.g, 192
  %868 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.024, i64 %867
  %869 = load <8 x float>, ptr %868, align 32, !tbaa !134
  %870 = fadd <8 x float> %866, %869
  %871 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.123, i64 %fwd_fft1_S4_R4_n1.s1.n0.g
  %872 = load <8 x float>, ptr %871, align 32, !tbaa !136
  %873 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.123, i64 %867
  %874 = load <8 x float>, ptr %873, align 32, !tbaa !136
  %875 = fadd <8 x float> %872, %874
  %876 = or i64 %fwd_fft1_S4_R4_n1.s1.n0.g, 96
  %877 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.024, i64 %876
  %878 = load <8 x float>, ptr %877, align 32, !tbaa !134
  %879 = or i64 %fwd_fft1_S4_R4_n1.s1.n0.g, 288
  %880 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.024, i64 %879
  %881 = load <8 x float>, ptr %880, align 32, !tbaa !134
  %882 = fadd <8 x float> %878, %881
  %883 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.123, i64 %876
  %884 = load <8 x float>, ptr %883, align 32, !tbaa !136
  %885 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.123, i64 %879
  ...
  store <8 x float> %888, ptr %inv_exchange_S1_R4_n1.010, align 32, !tbaa !148
  store <8 x float> %889, ptr %inv_exchange_S1_R4_n1.19, align 32, !tbaa !150
  ...
  %900 = add nuw nsw i64 %fwd_fft1_S4_R4_n1.s1.n0.g, 24
  %901 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.024, i64 %900
  %902 = load <8 x float>, ptr %901, align 32, !tbaa !134
  %903 = add nuw nsw i64 %fwd_fft1_S4_R4_n1.s1.n0.g, 216
  %904 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.024, i64 %903
  %905 = load <8 x float>, ptr %904, align 32, !tbaa !134
  %906 = fadd <8 x float> %902, %905
  %907 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.123, i64 %900
  %908 = load <8 x float>, ptr %907, align 32, !tbaa !136
  %909 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.123, i64 %903
  %910 = load <8 x float>, ptr %909, align 32, !tbaa !136
  %911 = fadd <8 x float> %908, %910
  %912 = add nuw nsw i64 %fwd_fft1_S4_R4_n1.s1.n0.g, 120
  %913 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.024, i64 %912
  %914 = load <8 x float>, ptr %913, align 32, !tbaa !134
  %915 = add nuw nsw i64 %fwd_fft1_S4_R4_n1.s1.n0.g, 312
  %916 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.024, i64 %915
  %917 = load <8 x float>, ptr %916, align 32, !tbaa !134
  %918 = fadd <8 x float> %914, %917
  %919 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.123, i64 %912
  %920 = load <8 x float>, ptr %919, align 32, !tbaa !136
  %921 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.123, i64 %915
  ...
  %936 = or i64 %fwd_fft1_S4_R4_n1.s1.n0.g, 48
  %937 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.024, i64 %936
  %938 = load <8 x float>, ptr %937, align 32, !tbaa !134
  %939 = or i64 %fwd_fft1_S4_R4_n1.s1.n0.g, 240
  %940 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.024, i64 %939
  %941 = load <8 x float>, ptr %940, align 32, !tbaa !134
  %942 = fadd <8 x float> %938, %941
  %943 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.123, i64 %936
  %944 = load <8 x float>, ptr %943, align 32, !tbaa !136
  %945 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.123, i64 %939
  %946 = load <8 x float>, ptr %945, align 32, !tbaa !136
  %947 = fadd <8 x float> %944, %946
  %948 = or i64 %fwd_fft1_S4_R4_n1.s1.n0.g, 144
  %949 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.024, i64 %948
  %950 = load <8 x float>, ptr %949, align 32, !tbaa !134
  %951 = or i64 %fwd_fft1_S4_R4_n1.s1.n0.g, 336
  %952 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.024, i64 %951
  %953 = load <8 x float>, ptr %952, align 32, !tbaa !134
  %954 = fadd <8 x float> %950, %953
  %955 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.123, i64 %948
  %956 = load <8 x float>, ptr %955, align 32, !tbaa !136
  %957 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.123, i64 %951
  ...
  %972 = add nuw nsw i64 %fwd_fft1_S4_R4_n1.s1.n0.g, 72
  %973 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.024, i64 %972
  %974 = load <8 x float>, ptr %973, align 32, !tbaa !134
  %975 = add nuw nsw i64 %fwd_fft1_S4_R4_n1.s1.n0.g, 264
  %976 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.024, i64 %975
  %977 = load <8 x float>, ptr %976, align 32, !tbaa !134
  %978 = fadd <8 x float> %974, %977
  %979 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.123, i64 %972
  %980 = load <8 x float>, ptr %979, align 32, !tbaa !136
  %981 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.123, i64 %975
  %982 = load <8 x float>, ptr %981, align 32, !tbaa !136
  %983 = fadd <8 x float> %980, %982
  %984 = add nuw nsw i64 %fwd_fft1_S4_R4_n1.s1.n0.g, 168
  %985 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.024, i64 %984
  %986 = load <8 x float>, ptr %985, align 32, !tbaa !134
  %987 = add nuw nsw i64 %fwd_fft1_S4_R4_n1.s1.n0.g, 360
  %988 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.024, i64 %987
  %989 = load <8 x float>, ptr %988, align 32, !tbaa !134
  %990 = fadd <8 x float> %986, %989
  %991 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.123, i64 %984
  %992 = load <8 x float>, ptr %991, align 32, !tbaa !136
  %993 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.123, i64 %987
...
"for fwd_fft1_S4_R4_n1.s1.r26$y":                 ; preds = %"for fwd_fft1_S4_R4_n1.s1.n0.g", %"for fwd_fft1_S4_R4_n1.s1.r26$y"
  %indvars.iv691 = phi i64 [ 0, %"for fwd_fft1_S4_R4_n1.s1.n0.g" ], [ %indvars.iv.next692, %"for fwd_fft1_S4_R4_n1.s1.r26$y" ]
  %1008 = shl nuw nsw i64 %indvars.iv691, 3
  %1009 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.010, i64 %1008
  %1010 = load <8 x float>, ptr %1009, align 32, !tbaa !148
  %1011 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.19, i64 %1008
  %1012 = load <8 x float>, ptr %1011, align 32, !tbaa !150
  %1013 = add nuw nsw i64 %1008, 32
  %1014 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.010, i64 %1013
  %1015 = load <8 x float>, ptr %1014, align 32, !tbaa !148
  %1016 = getelementptr inbounds float, ptr %f0.030, i64 %indvars.iv691
  ...
  %1021 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.19, i64 %1013
  %1022 = load <8 x float>, ptr %1021, align 32, !tbaa !150
  %1023 = getelementptr inbounds float, ptr %f0.129, i64 %indvars.iv691
  ...
  %1033 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.010, i64 %1032
  %1034 = load <8 x float>, ptr %1033, align 32, !tbaa !148
  %1035 = shl nuw nsw i64 %indvars.iv691, 1
  %1036 = getelementptr inbounds float, ptr %f0.030, i64 %1035
  ...
  %1041 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.19, i64 %1032
  %1042 = load <8 x float>, ptr %1041, align 32, !tbaa !150
  %1043 = getelementptr inbounds float, ptr %f0.129, i64 %1035
  ...
  %1053 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.010, i64 %1052
  %1054 = load <8 x float>, ptr %1053, align 32, !tbaa !148
  %1055 = mul nuw nsw i64 %indvars.iv691, 3
  %1056 = getelementptr inbounds float, ptr %f0.030, i64 %1055
  ...
  %1061 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.19, i64 %1052
  %1062 = load <8 x float>, ptr %1061, align 32, !tbaa !150
  %1063 = getelementptr inbounds float, ptr %f0.129, i64 %1055
  ...
  %1089 = or i64 %1088, %fwd_fft1_S4_R4_n1.s1.n0.g
  %1090 = getelementptr inbounds float, ptr %"inv_X4$3.022", i64 %1089
  store <8 x float> %1076, ptr %1090, align 32, !tbaa !132
  %1091 = getelementptr inbounds float, ptr %"inv_X4$3.121", i64 %1089
  store <8 x float> %1077, ptr %1091, align 32, !tbaa !130
  %1092 = add nuw nsw i64 %1089, 64
  %1093 = getelementptr inbounds float, ptr %"inv_X4$3.022", i64 %1092
  store <8 x float> %1084, ptr %1093, align 32, !tbaa !132
  %1094 = getelementptr inbounds float, ptr %"inv_X4$3.121", i64 %1092
  store <8 x float> %1085, ptr %1094, align 32, !tbaa !130
  %1095 = add nuw nsw i64 %1089, 128
  %1096 = getelementptr inbounds float, ptr %"inv_X4$3.022", i64 %1095
  store <8 x float> %1078, ptr %1096, align 32, !tbaa !132
  %1097 = getelementptr inbounds float, ptr %"inv_X4$3.121", i64 %1095
  store <8 x float> %1079, ptr %1097, align 32, !tbaa !130
  %1098 = add nuw nsw i64 %1089, 192
  %1099 = getelementptr inbounds float, ptr %"inv_X4$3.022", i64 %1098
  store <8 x float> %1086, ptr %1099, align 32, !tbaa !132
  %1100 = getelementptr inbounds float, ptr %"inv_X4$3.121", i64 %1098
...
"assert failed80":                                ; preds = %"consume fwd_fft1_S4_R4_n1"
  %1101 = tail call i32 @halide_error_explicit_bounds_too_small(ptr null, ptr nonnull @str.11, ptr nonnull @str.12, i32 0, i32 15, i32 %84, i32 %b1) #2
  br label %destructor_block
...
"assert failed82":                                ; preds = %"assert succeeded81"
  ...
  %1103 = tail call i32 @halide_error_explicit_bounds_too_small(ptr null, ptr nonnull @str.13, ptr nonnull @str.12, i32 0, i32 15, i32 %1102, i32 %a4) #2
  br label %destructor_block
...
"for inv_fft0_S4_R4_n0.s1.n1":                    ; preds = %"assert succeeded83", %"for inv_fft0_S4_R4_n0.s1.n1"
  %indvars.iv694 = phi i64 [ %indvars.iv.next695, %"for inv_fft0_S4_R4_n0.s1.n1" ], [ 0, %"assert succeeded83" ]
  %1105 = shl nuw nsw i64 %indvars.iv694, 4
  %1106 = getelementptr inbounds float, ptr %"inv_X4$3.022", i64 %1105
  %1107 = load <4 x float>, ptr %1106, align 32, !tbaa !132
  %1108 = getelementptr inbounds float, ptr %kernel_fft1_S4_R4_n1.026, i64 %1105
  %1109 = load <4 x float>, ptr %1108, align 32, !tbaa !140
  %1110 = fmul <4 x float> %1107, %1109
  %1111 = getelementptr inbounds float, ptr %"inv_X4$3.121", i64 %1105
  %1112 = load <4 x float>, ptr %1111, align 32, !tbaa !130
  %1113 = getelementptr inbounds float, ptr %kernel_fft1_S4_R4_n1.125, i64 %1105
  %1114 = load <4 x float>, ptr %1113, align 32, !tbaa !142
  %1115 = fmul <4 x float> %1112, %1114
  %1116 = fsub <4 x float> %1110, %1115
  %1117 = or i64 %1105, 8
  %1118 = getelementptr inbounds float, ptr %"inv_X4$3.022", i64 %1117
  %1119 = load <4 x float>, ptr %1118, align 32, !tbaa !132
  %1120 = getelementptr inbounds float, ptr %kernel_fft1_S4_R4_n1.026, i64 %1117
  %1121 = load <4 x float>, ptr %1120, align 32, !tbaa !140
  %1122 = fmul <4 x float> %1119, %1121
  %1123 = getelementptr inbounds float, ptr %"inv_X4$3.121", i64 %1117
  %1124 = load <4 x float>, ptr %1123, align 32, !tbaa !130
  %1125 = getelementptr inbounds float, ptr %kernel_fft1_S4_R4_n1.125, i64 %1117
  ...
  %1137 = or i64 %1105, 4
  %1138 = getelementptr inbounds float, ptr %"inv_X4$3.022", i64 %1137
  %1139 = load <4 x float>, ptr %1138, align 16, !tbaa !132
  %1140 = getelementptr inbounds float, ptr %kernel_fft1_S4_R4_n1.026, i64 %1137
  %1141 = load <4 x float>, ptr %1140, align 16, !tbaa !140
  %1142 = fmul <4 x float> %1139, %1141
  %1143 = getelementptr inbounds float, ptr %"inv_X4$3.121", i64 %1137
  %1144 = load <4 x float>, ptr %1143, align 16, !tbaa !130
  %1145 = getelementptr inbounds float, ptr %kernel_fft1_S4_R4_n1.125, i64 %1137
  %1146 = load <4 x float>, ptr %1145, align 16, !tbaa !142
  %1147 = fmul <4 x float> %1144, %1146
  %1148 = fsub <4 x float> %1142, %1147
  %1149 = or i64 %1105, 12
  %1150 = getelementptr inbounds float, ptr %"inv_X4$3.022", i64 %1149
  %1151 = load <4 x float>, ptr %1150, align 16, !tbaa !132
  %1152 = getelementptr inbounds float, ptr %kernel_fft1_S4_R4_n1.026, i64 %1149
  %1153 = load <4 x float>, ptr %1152, align 16, !tbaa !140
  %1154 = fmul <4 x float> %1151, %1153
  %1155 = getelementptr inbounds float, ptr %"inv_X4$3.121", i64 %1149
  %1156 = load <4 x float>, ptr %1155, align 16, !tbaa !130
  %1157 = getelementptr inbounds float, ptr %kernel_fft1_S4_R4_n1.125, i64 %1149
  ...
  %inv_exchange_S1_R4_n0.017.sroa.0.16.vec.extract288 = shufflevector <16 x float> %1185, <16 x float> undef, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
  %1191 = fmul <4 x float> %697, %inv_exchange_S1_R4_n0.017.sroa.0.16.vec.extract288
  %inv_exchange_S1_R4_n0.118.sroa.0.16.vec.extract195 = shufflevector <16 x float> %1189, <16 x float> undef, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
  %1192 = fmul <4 x float> %698, %inv_exchange_S1_R4_n0.118.sroa.0.16.vec.extract195
  %1193 = fsub <4 x float> %1191, %1192
  %1194 = fmul <4 x float> %698, %inv_exchange_S1_R4_n0.017.sroa.0.16.vec.extract288
  %1195 = fmul <4 x float> %697, %inv_exchange_S1_R4_n0.118.sroa.0.16.vec.extract195
  %1196 = fadd <4 x float> %1194, %1195
  %inv_exchange_S1_R4_n0.017.sroa.29.32.vec.extract305 = shufflevector <8 x float> %1186, <8 x float> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %1197 = fmul <4 x float> %700, %inv_exchange_S1_R4_n0.017.sroa.29.32.vec.extract305
  %inv_exchange_S1_R4_n0.118.sroa.29.32.vec.extract212 = shufflevector <8 x float> %1190, <8 x float> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %1198 = fmul <4 x float> %702, %inv_exchange_S1_R4_n0.118.sroa.29.32.vec.extract212
  %1199 = fsub <4 x float> %1197, %1198
  %1200 = fmul <4 x float> %702, %inv_exchange_S1_R4_n0.017.sroa.29.32.vec.extract305
  %1201 = fmul <4 x float> %700, %inv_exchange_S1_R4_n0.118.sroa.29.32.vec.extract212
  %1202 = fadd <4 x float> %1200, %1201
  %inv_exchange_S1_R4_n0.017.sroa.29.48.vec.extract322 = shufflevector <8 x float> %1186, <8 x float> poison, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
  %1203 = fmul <4 x float> %inv_exchange_S1_R4_n0.017.sroa.29.48.vec.extract322, %708
  %inv_exchange_S1_R4_n0.118.sroa.29.48.vec.extract229 = shufflevector <8 x float> %1190, <8 x float> poison, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
  %1204 = fmul <4 x float> %inv_exchange_S1_R4_n0.118.sroa.29.48.vec.extract229, %714
  %1205 = fsub <4 x float> %1203, %1204
  %1206 = fmul <4 x float> %inv_exchange_S1_R4_n0.017.sroa.29.48.vec.extract322, %714
  %1207 = fmul <4 x float> %inv_exchange_S1_R4_n0.118.sroa.29.48.vec.extract229, %708
  %1208 = fadd <4 x float> %1207, %1206
  %v_inv_fft0_S4_R4_n0.020.sroa.0.0.vec.extract67 = shufflevector <16 x float> %1185, <16 x float> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %1209 = fadd <4 x float> %v_inv_fft0_S4_R4_n0.020.sroa.0.0.vec.extract67, %1199
  %v_inv_fft0_S4_R4_n0.119.sroa.0.0.vec.extract107 = shufflevector <16 x float> %1189, <16 x float> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %1210 = fadd <4 x float> %v_inv_fft0_S4_R4_n0.119.sroa.0.0.vec.extract107, %1202
  ...
  %1217 = fsub <4 x float> %v_inv_fft0_S4_R4_n0.020.sroa.0.0.vec.extract67, %1199
  %1218 = fsub <4 x float> %v_inv_fft0_S4_R4_n0.119.sroa.0.0.vec.extract107, %1202
  ...
  %1226 = getelementptr inbounds float, ptr %inv_fft0_S4_R4_n0.08, i64 %1225
  store <4 x float> %1213, ptr %1226, align 32, !tbaa !154
  %1227 = getelementptr inbounds float, ptr %inv_fft0_S4_R4_n0.17, i64 %1225
  store <4 x float> %1214, ptr %1227, align 32, !tbaa !156
  %1228 = or i64 %1225, 4
  %1229 = getelementptr inbounds float, ptr %inv_fft0_S4_R4_n0.08, i64 %1228
  store <4 x float> %1221, ptr %1229, align 16, !tbaa !154
  %1230 = getelementptr inbounds float, ptr %inv_fft0_S4_R4_n0.17, i64 %1228
  store <4 x float> %1222, ptr %1230, align 16, !tbaa !156
  %1231 = add nuw nsw i64 %1225, 8
  %1232 = getelementptr inbounds float, ptr %inv_fft0_S4_R4_n0.08, i64 %1231
  store <4 x float> %1215, ptr %1232, align 32, !tbaa !154
  %1233 = getelementptr inbounds float, ptr %inv_fft0_S4_R4_n0.17, i64 %1231
  store <4 x float> %1216, ptr %1233, align 32, !tbaa !156
  %1234 = add nuw nsw i64 %1225, 12
  %1235 = getelementptr inbounds float, ptr %inv_fft0_S4_R4_n0.08, i64 %1234
  store <4 x float> %1223, ptr %1235, align 16, !tbaa !154
  %1236 = getelementptr inbounds float, ptr %inv_fft0_S4_R4_n0.17, i64 %1234
...
"for inv_fft1_S4_R4_n1.s1.n0.g":                  ; preds = %"for inv_fft0_S4_R4_n0.s1.n1", %"end for inv_fft1_S4_R4_n1.s1.r119$y"
  ...
  %1237 = getelementptr inbounds float, ptr %inv_fft0_S4_R4_n0.08, i64 %inv_fft1_S4_R4_n1.s1.n0.g
  %1238 = load <8 x float>, ptr %1237, align 32, !tbaa !154
  %1239 = or i64 %inv_fft1_S4_R4_n1.s1.n0.g, 192
  %1240 = getelementptr inbounds float, ptr %inv_fft0_S4_R4_n0.08, i64 %1239
  %1241 = load <8 x float>, ptr %1240, align 32, !tbaa !154
  %1242 = fadd <8 x float> %1238, %1241
  %1243 = getelementptr inbounds float, ptr %inv_fft0_S4_R4_n0.17, i64 %inv_fft1_S4_R4_n1.s1.n0.g
  %1244 = load <8 x float>, ptr %1243, align 32, !tbaa !156
  %1245 = getelementptr inbounds float, ptr %inv_fft0_S4_R4_n0.17, i64 %1239
  %1246 = load <8 x float>, ptr %1245, align 32, !tbaa !156
  %1247 = fadd <8 x float> %1244, %1246
  %1248 = or i64 %inv_fft1_S4_R4_n1.s1.n0.g, 96
  %1249 = getelementptr inbounds float, ptr %inv_fft0_S4_R4_n0.08, i64 %1248
  %1250 = load <8 x float>, ptr %1249, align 32, !tbaa !154
  %1251 = or i64 %inv_fft1_S4_R4_n1.s1.n0.g, 288
  %1252 = getelementptr inbounds float, ptr %inv_fft0_S4_R4_n0.08, i64 %1251
  %1253 = load <8 x float>, ptr %1252, align 32, !tbaa !154
  %1254 = fadd <8 x float> %1250, %1253
  %1255 = getelementptr inbounds float, ptr %inv_fft0_S4_R4_n0.17, i64 %1248
  %1256 = load <8 x float>, ptr %1255, align 32, !tbaa !156
  %1257 = getelementptr inbounds float, ptr %inv_fft0_S4_R4_n0.17, i64 %1251
  ...
  store <8 x float> %1260, ptr %inv_exchange_S1_R4_n1.010, align 32, !tbaa !148
  store <8 x float> %1261, ptr %inv_exchange_S1_R4_n1.19, align 32, !tbaa !150
  ...
  %1273 = getelementptr inbounds float, ptr %inv_fft0_S4_R4_n0.08, i64 %1272
  %1274 = load <8 x float>, ptr %1273, align 32, !tbaa !154
  %1275 = add nuw nsw i64 %inv_fft1_S4_R4_n1.s1.n0.g, 216
  %1276 = getelementptr inbounds float, ptr %inv_fft0_S4_R4_n0.08, i64 %1275
  %1277 = load <8 x float>, ptr %1276, align 32, !tbaa !154
  %1278 = fadd <8 x float> %1274, %1277
  %1279 = getelementptr inbounds float, ptr %inv_fft0_S4_R4_n0.17, i64 %1272
  %1280 = load <8 x float>, ptr %1279, align 32, !tbaa !156
  %1281 = getelementptr inbounds float, ptr %inv_fft0_S4_R4_n0.17, i64 %1275
  ...
  %1285 = getelementptr inbounds float, ptr %inv_fft0_S4_R4_n0.08, i64 %1284
  %1286 = load <8 x float>, ptr %1285, align 32, !tbaa !154
  %1287 = add nuw nsw i64 %inv_fft1_S4_R4_n1.s1.n0.g, 312
  %1288 = getelementptr inbounds float, ptr %inv_fft0_S4_R4_n0.08, i64 %1287
  %1289 = load <8 x float>, ptr %1288, align 32, !tbaa !154
  %1290 = fadd <8 x float> %1286, %1289
  %1291 = getelementptr inbounds float, ptr %inv_fft0_S4_R4_n0.17, i64 %1284
  %1292 = load <8 x float>, ptr %1291, align 32, !tbaa !156
  %1293 = getelementptr inbounds float, ptr %inv_fft0_S4_R4_n0.17, i64 %1287
  ...
  %1309 = getelementptr inbounds float, ptr %inv_fft0_S4_R4_n0.08, i64 %1308
  %1310 = load <8 x float>, ptr %1309, align 32, !tbaa !154
  %1311 = or i64 %inv_fft1_S4_R4_n1.s1.n0.g, 240
  %1312 = getelementptr inbounds float, ptr %inv_fft0_S4_R4_n0.08, i64 %1311
  %1313 = load <8 x float>, ptr %1312, align 32, !tbaa !154
  %1314 = fadd <8 x float> %1310, %1313
  %1315 = getelementptr inbounds float, ptr %inv_fft0_S4_R4_n0.17, i64 %1308
  %1316 = load <8 x float>, ptr %1315, align 32, !tbaa !156
  %1317 = getelementptr inbounds float, ptr %inv_fft0_S4_R4_n0.17, i64 %1311
  %1318 = load <8 x float>, ptr %1317, align 32, !tbaa !156
  %1319 = fadd <8 x float> %1316, %1318
  %1320 = or i64 %inv_fft1_S4_R4_n1.s1.n0.g, 144
  %1321 = getelementptr inbounds float, ptr %inv_fft0_S4_R4_n0.08, i64 %1320
  %1322 = load <8 x float>, ptr %1321, align 32, !tbaa !154
  %1323 = or i64 %inv_fft1_S4_R4_n1.s1.n0.g, 336
  %1324 = getelementptr inbounds float, ptr %inv_fft0_S4_R4_n0.08, i64 %1323
  %1325 = load <8 x float>, ptr %1324, align 32, !tbaa !154
  %1326 = fadd <8 x float> %1322, %1325
  %1327 = getelementptr inbounds float, ptr %inv_fft0_S4_R4_n0.17, i64 %1320
  %1328 = load <8 x float>, ptr %1327, align 32, !tbaa !156
  %1329 = getelementptr inbounds float, ptr %inv_fft0_S4_R4_n0.17, i64 %1323
  ...
  %1345 = getelementptr inbounds float, ptr %inv_fft0_S4_R4_n0.08, i64 %1344
  %1346 = load <8 x float>, ptr %1345, align 32, !tbaa !154
  %1347 = add nuw nsw i64 %inv_fft1_S4_R4_n1.s1.n0.g, 264
  %1348 = getelementptr inbounds float, ptr %inv_fft0_S4_R4_n0.08, i64 %1347
  %1349 = load <8 x float>, ptr %1348, align 32, !tbaa !154
  %1350 = fadd <8 x float> %1346, %1349
  %1351 = getelementptr inbounds float, ptr %inv_fft0_S4_R4_n0.17, i64 %1344
  %1352 = load <8 x float>, ptr %1351, align 32, !tbaa !156
  %1353 = getelementptr inbounds float, ptr %inv_fft0_S4_R4_n0.17, i64 %1347
  ...
  %1357 = getelementptr inbounds float, ptr %inv_fft0_S4_R4_n0.08, i64 %1356
  %1358 = load <8 x float>, ptr %1357, align 32, !tbaa !154
  %1359 = add nuw nsw i64 %inv_fft1_S4_R4_n1.s1.n0.g, 360
  %1360 = getelementptr inbounds float, ptr %inv_fft0_S4_R4_n0.08, i64 %1359
  %1361 = load <8 x float>, ptr %1360, align 32, !tbaa !154
  %1362 = fadd <8 x float> %1358, %1361
  %1363 = getelementptr inbounds float, ptr %inv_fft0_S4_R4_n0.17, i64 %1356
  %1364 = load <8 x float>, ptr %1363, align 32, !tbaa !156
  %1365 = getelementptr inbounds float, ptr %inv_fft0_S4_R4_n0.17, i64 %1359
...
"for inv_fft1_S4_R4_n1.s1.r119$y":                ; preds = %"for inv_fft1_S4_R4_n1.s1.n0.g", %"for inv_fft1_S4_R4_n1.s1.r119$y"
  %indvars.iv701 = phi i64 [ 0, %"for inv_fft1_S4_R4_n1.s1.n0.g" ], [ %indvars.iv.next702, %"for inv_fft1_S4_R4_n1.s1.r119$y" ]
  %1380 = shl nuw nsw i64 %indvars.iv701, 3
  %1381 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.010, i64 %1380
  %1382 = load <8 x float>, ptr %1381, align 32, !tbaa !148
  %1383 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.19, i64 %1380
  %1384 = load <8 x float>, ptr %1383, align 32, !tbaa !150
  %1385 = add nuw nsw i64 %1380, 32
  %1386 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.010, i64 %1385
  %1387 = load <8 x float>, ptr %1386, align 32, !tbaa !148
  %1388 = getelementptr inbounds float, ptr %f2.032, i64 %indvars.iv701
  ...
  %1393 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.19, i64 %1385
  %1394 = load <8 x float>, ptr %1393, align 32, !tbaa !150
  %1395 = getelementptr inbounds float, ptr %f2.131, i64 %indvars.iv701
  ...
  %1405 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.010, i64 %1404
  %1406 = load <8 x float>, ptr %1405, align 32, !tbaa !148
  %1407 = shl nuw nsw i64 %indvars.iv701, 1
  %1408 = getelementptr inbounds float, ptr %f2.032, i64 %1407
  ...
  %1413 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.19, i64 %1404
  %1414 = load <8 x float>, ptr %1413, align 32, !tbaa !150
  %1415 = getelementptr inbounds float, ptr %f2.131, i64 %1407
  ...
  %1425 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.010, i64 %1424
  %1426 = load <8 x float>, ptr %1425, align 32, !tbaa !148
  %1427 = mul nuw nsw i64 %indvars.iv701, 3
  %1428 = getelementptr inbounds float, ptr %f2.032, i64 %1427
  ...
  %1433 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.19, i64 %1424
  %1434 = load <8 x float>, ptr %1433, align 32, !tbaa !150
  %1435 = getelementptr inbounds float, ptr %f2.131, i64 %1427
  ...
  %1462 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.024, i64 %1461
  store <8 x float> %1448, ptr %1462, align 32, !tbaa !134
  %1463 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.123, i64 %1461
  store <8 x float> %1449, ptr %1463, align 32, !tbaa !136
  %1464 = add nuw nsw i64 %1461, 64
  %1465 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.024, i64 %1464
  store <8 x float> %1456, ptr %1465, align 32, !tbaa !134
  %1466 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.123, i64 %1464
  store <8 x float> %1457, ptr %1466, align 32, !tbaa !136
  %1467 = add nuw nsw i64 %1461, 128
  %1468 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.024, i64 %1467
  store <8 x float> %1450, ptr %1468, align 32, !tbaa !134
  %1469 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.123, i64 %1467
  store <8 x float> %1451, ptr %1469, align 32, !tbaa !136
  %1470 = add nuw nsw i64 %1461, 192
  %1471 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.024, i64 %1470
  store <8 x float> %1458, ptr %1471, align 32, !tbaa !134
  %1472 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.123, i64 %1470
...
"consume inv_fft1_S4_R4_n1":                      ; preds = %"end for inv_fft1_S4_R4_n1.s1.r119$y"
  ...
  store <8 x float> %1452, ptr %"inv_X4$3.022", align 32, !tbaa !178
  store <8 x float> %1453, ptr %"inv_X4$3.121", align 32, !tbaa !180
...
"for result.s0.n1":                               ; preds = %"for result.s0.n1.preheader", %"end for result.s0.n0.n091"
  %indvars.iv707 = phi i64 [ %721, %"for result.s0.n1.preheader" ], [ %indvars.iv.next708, %"end for result.s0.n0.n091" ]
  br i1 %716, label %"for result.s0.n0.n0.preheader", label %"end for result.s0.n0.n0", !prof !26
...
"for result.s0.n0.n0.preheader":                  ; preds = %"for result.s0.n1"
  ...
  br i1 %787, label %"end for result.s0.n0.n0.loopexit.unr-lcssa", label %"for result.s0.n0.n0"
...
"for result.s0.n0.n0":                            ; preds = %"for result.s0.n0.n0.preheader", %"for result.s0.n0.n0"
  %indvars.iv704 = phi i64 [ %indvars.iv.next705.1, %"for result.s0.n0.n0" ], [ 0, %"for result.s0.n0.n0.preheader" ]
  ...
  %1481 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.024, i64 %1480
  ...
  %1489 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.024, i64 %1488
...
"end for result.s0.n0.n0.loopexit.unr-lcssa":     ; preds = %"for result.s0.n0.n0", %"for result.s0.n0.n0.preheader"
  %indvars.iv704.unr = phi i64 [ 0, %"for result.s0.n0.n0.preheader" ], [ %indvars.iv.next705.1, %"for result.s0.n0.n0" ]
...
"for result.s0.n0.n0.epil":                       ; preds = %"end for result.s0.n0.n0.loopexit.unr-lcssa"
  ...
  %1497 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.024, i64 %1496
...
"end for result.s0.n0.n0":                        ; preds = %"for result.s0.n0.n0.epil", %"end for result.s0.n0.n0.loopexit.unr-lcssa", %"for result.s0.n1"
  br i1 %719, label %"for result.s0.n0.n090.preheader", label %"end for result.s0.n0.n091", !prof !26

"for result.s0.n0.n090.preheader":                ; preds = %"end for result.s0.n0.n0"
  %1502 = shl nsw i64 %indvars.iv707, 4
  %1503 = add nsw i64 %724, %1502
  %1504 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.024, i64 %1503
