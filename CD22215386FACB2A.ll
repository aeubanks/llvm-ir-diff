...
for.cond.cleanup122:                              ; preds = %for.cond.cleanup122.loopexit446.unr-lcssa, %for.body.lr.ph.i.i.i.us.epil, %for.body123.us.epil, %if.end142, %for.cond120.preheader
...
invoke.cont.i.preheader:                          ; preds = %_ZSt4copyIP7double2S1_ET0_T_S3_S2_.exit344
  ...
  br i1 %min.iters.check, label %invoke.cont.i.preheader796, label %vector.memcheck
...
vector.memcheck:                                  ; preds = %invoke.cont.i.preheader
  ...
  br i1 %conflict.rdx554, label %invoke.cont.i.preheader796, label %vector.ph
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %_ZN5Hydro10advPosHalfEPK7double2S2_dPS0_ii.exit, label %invoke.cont.i.preheader796

invoke.cont.i.preheader796:                       ; preds = %vector.memcheck, %invoke.cont.i.preheader, %middle.block
...
invoke.cont.i.prol:                               ; preds = %invoke.cont.i.preheader796
...
invoke.cont.i.prol.loopexit:                      ; preds = %invoke.cont.i.prol, %invoke.cont.i.preheader796
  %indvars.iv.i.unr = phi i64 [ %indvars.iv.i.ph, %invoke.cont.i.preheader796 ], [ %indvars.iv.next.i.prol, %invoke.cont.i.prol ]
...
for.body.i.preheader:                             ; preds = %_ZSt4copyIPdS0_ET0_T_S2_S1_.exit
  ...
  %min.iters.check564 = icmp ult i64 %94, 4
  br i1 %min.iters.check564, label %for.body.i.preheader795, label %vector.memcheck559

vector.memcheck559:                               ; preds = %for.body.i.preheader
  ...
  %99 = add i64 %95, %15
  %100 = sub i64 %96, %99
  %diff.check560 = icmp ult i64 %100, 16
  %conflict.rdx561 = or i1 %diff.check, %diff.check560
  br i1 %conflict.rdx561, label %for.body.i.preheader795, label %vector.ph565

vector.ph565:                                     ; preds = %vector.memcheck559
  %n.vec567 = and i64 %94, -2
  %ind.end568 = add nsw i64 %n.vec567, %idxprom79
...
vector.body571:                                   ; preds = %vector.body571, %vector.ph565
  ...
  %offset.idx573 = add i64 %index572, %idxprom79
  %101 = getelementptr inbounds double, ptr %90, i64 %offset.idx573
  %wide.load = load <2 x double>, ptr %101, align 8, !tbaa !40
  %102 = getelementptr inbounds double, ptr %14, i64 %offset.idx573
  %wide.load574 = load <2 x double>, ptr %102, align 8, !tbaa !40
  %103 = fdiv <2 x double> %wide.load, %wide.load574
  %104 = getelementptr inbounds double, ptr %92, i64 %offset.idx573
  store <2 x double> %103, ptr %104, align 8, !tbaa !40
  %index.next575 = add nuw i64 %index572, 2
  %105 = icmp eq i64 %index.next575, %n.vec567
  br i1 %105, label %middle.block562, label %vector.body571, !llvm.loop !137

middle.block562:                                  ; preds = %vector.body571
  %cmp.n570 = icmp eq i64 %94, %n.vec567
  br i1 %cmp.n570, label %_ZN5Hydro7calcRhoEPKdS1_Pdii.exit, label %for.body.i.preheader795

for.body.i.preheader795:                          ; preds = %vector.memcheck559, %for.body.i.preheader, %middle.block562
  %indvars.iv.i354.ph = phi i64 [ %idxprom79, %vector.memcheck559 ], [ %idxprom79, %for.body.i.preheader ], [ %ind.end568, %middle.block562 ]
  %106 = sub nsw i64 %idxprom81, %indvars.iv.i354.ph
  %107 = xor i64 %indvars.iv.i354.ph, -1
  %108 = add nsw i64 %107, %idxprom81
  %xtraiter797 = and i64 %106, 3
  %lcmp.mod798.not = icmp eq i64 %xtraiter797, 0
  br i1 %lcmp.mod798.not, label %for.body.i.prol.loopexit, label %for.body.i.prol

for.body.i.prol:                                  ; preds = %for.body.i.preheader795, %for.body.i.prol
  %indvars.iv.i354.prol = phi i64 [ %indvars.iv.next.i356.prol, %for.body.i.prol ], [ %indvars.iv.i354.ph, %for.body.i.preheader795 ]
  %prol.iter = phi i64 [ %prol.iter.next, %for.body.i.prol ], [ 0, %for.body.i.preheader795 ]
  ...
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter797
  br i1 %prol.iter.cmp.not, label %for.body.i.prol.loopexit, label %for.body.i.prol, !llvm.loop !138

for.body.i.prol.loopexit:                         ; preds = %for.body.i.prol, %for.body.i.preheader795
  %indvars.iv.i354.unr = phi i64 [ %indvars.iv.i354.ph, %for.body.i.preheader795 ], [ %indvars.iv.next.i356.prol, %for.body.i.prol ]
...
for.body.lr.ph.i:                                 ; preds = %_ZN5Hydro7calcRhoEPKdS1_Pdii.exit
  ...
  %126 = xor i64 %124, -1
  %xtraiter799 = and i64 %125, 1
  %lcmp.mod800.not = icmp eq i64 %xtraiter799, 0
  br i1 %lcmp.mod800.not, label %for.body.i366.prol.loopexit, label %for.body.i366.prol
...
for.body.i380:                                    ; preds = %for.body.i380, %for.body.lr.ph.i369
  %indvars.iv.i370 = phi i64 [ %168, %for.body.lr.ph.i369 ], [ %indvars.iv.next.i378, %for.body.i380 ]
  %arrayidx4.i371 = getelementptr inbounds %struct.double2, ptr %162, i64 %indvars.iv.i370
  %arrayidx6.i372 = getelementptr inbounds %struct.double2, ptr %163, i64 %indvars.iv.i370
  %arrayidx8.i376 = getelementptr inbounds %struct.double2, ptr %164, i64 %indvars.iv.i370
  %arrayidx.i377 = getelementptr inbounds i32, ptr %167, i64 %indvars.iv.i370
  %169 = load i32, ptr %arrayidx.i377, align 4, !tbaa !82
  ...
  %arrayidx30.i = getelementptr inbounds %struct.double2, ptr %165, i64 %indvars.iv.i370
...
for.body112:                                      ; preds = %for.body112.lr.ph, %_ZN5Hydro10advPosFullEPK7double2S2_S2_dPS0_S3_ii.exit
  %181 = phi ptr [ %.pre524, %for.body112.lr.ph ], [ %188, %_ZN5Hydro10advPosFullEPK7double2S2_S2_dPS0_S3_ii.exit ]
  %182 = phi ptr [ %.pre523, %for.body112.lr.ph ], [ %189, %_ZN5Hydro10advPosFullEPK7double2S2_S2_dPS0_S3_ii.exit ]
  ...
  %add.ptr.i381 = getelementptr inbounds i32, ptr %184, i64 %indvars.iv509
  %185 = load i32, ptr %add.ptr.i381, align 4, !tbaa !82
  %pchplast120 = getelementptr inbounds %class.Mesh, ptr %183, i64 0, i32 61
  %186 = load ptr, ptr %pchplast120, align 8, !tbaa !44
  %add.ptr.i382 = getelementptr inbounds i32, ptr %186, i64 %indvars.iv509
  %187 = load i32, ptr %add.ptr.i382, align 4, !tbaa !82
  %cmp126490.not = icmp eq ptr %182, %181
...
for.body.preheader.i384:                          ; preds = %for.cond.cleanup127
  ...
  %wide.trip.count.i383 = sext i32 %187 to i64
  %194 = sub nsw i64 %wide.trip.count.i383, %193
  %min.iters.check707 = icmp ult i64 %194, 4
...
vector.memcheck691:                               ; preds = %for.body.preheader.i384
  ...
  %scevgep692 = getelementptr i8, ptr %192, i64 %195
  %196 = shl nsw i64 %wide.trip.count.i383, 4
  %scevgep693 = getelementptr i8, ptr %192, i64 %196
  %197 = shl nsw i64 %193, 3
  %scevgep694 = getelementptr i8, ptr %191, i64 %197
  %198 = shl nsw i64 %wide.trip.count.i383, 3
  %scevgep695 = getelementptr i8, ptr %191, i64 %198
  %scevgep696 = getelementptr i8, ptr %190, i64 %195
  %scevgep697 = getelementptr i8, ptr %190, i64 %196
...
vector.ph708:                                     ; preds = %vector.memcheck691
  %n.vec710 = and i64 %194, -2
  %ind.end711 = add nsw i64 %n.vec710, %193
...
vector.body714:                                   ; preds = %vector.body714, %vector.ph708
  ...
  %offset.idx716 = add i64 %index715, %193
  %199 = getelementptr inbounds %struct.double2, ptr %190, i64 %offset.idx716
  %200 = getelementptr inbounds double, ptr %191, i64 %offset.idx716
  %wide.load717 = load <2 x double>, ptr %200, align 8, !tbaa !40, !alias.scope !158
  %201 = fcmp olt <2 x double> %wide.load717, <double 1.000000e-99, double 1.000000e-99>
  %202 = fdiv <2 x double> <double 1.000000e+00, double 1.000000e+00>, %wide.load717
  %203 = select <2 x i1> %201, <2 x double> <double 0x547D42AEA2879F2E, double 0x547D42AEA2879F2E>, <2 x double> %202
  %wide.vec718 = load <4 x double>, ptr %199, align 8, !tbaa !40, !noalias !161
  ...
  %204 = fmul <2 x double> %strided.vec719, %203
  %205 = fmul <2 x double> %strided.vec720, %203
  %206 = getelementptr inbounds %struct.double2, ptr %192, i64 %offset.idx716
  %interleaved.vec721 = shufflevector <2 x double> %204, <2 x double> %205, <4 x i32> <i32 0, i32 2, i32 1, i32 3>
  store <4 x double> %interleaved.vec721, ptr %206, align 8, !tbaa !40
  %index.next722 = add nuw i64 %index715, 2
  %207 = icmp eq i64 %index.next722, %n.vec710
  br i1 %207, label %middle.block705, label %vector.body714, !llvm.loop !164

middle.block705:                                  ; preds = %vector.body714
  %cmp.n713 = icmp eq i64 %194, %n.vec710
...
for.body.i395.preheader:                          ; preds = %vector.memcheck691, %for.body.preheader.i384, %middle.block705
  %indvars.iv.i385.ph = phi i64 [ %193, %vector.memcheck691 ], [ %193, %for.body.preheader.i384 ], [ %ind.end711, %middle.block705 ]
...
for.body.i395:                                    ; preds = %for.body.i395.preheader, %for.body.i395
  ...
  %arrayidx.i386 = getelementptr inbounds %struct.double2, ptr %190, i64 %indvars.iv.i385
  %arrayidx3.i387 = getelementptr inbounds double, ptr %191, i64 %indvars.iv.i385
  %208 = load double, ptr %arrayidx3.i387, align 8, !tbaa !40
  ...
  %arrayidx5.i391 = getelementptr inbounds %struct.double2, ptr %192, i64 %indvars.iv.i385
  %210 = load <2 x double>, ptr %arrayidx.i386, align 8, !tbaa !40, !noalias !161
  ...
  store <2 x double> %213, ptr %arrayidx5.i391, align 8, !tbaa !40
...
for.body.preheader.i397:                          ; preds = %for.body.i395, %middle.block705
  ...
  %216 = sub nsw i64 %wide.trip.count.i383, %193
  %min.iters.check664 = icmp ult i64 %216, 16
...
vector.memcheck576:                               ; preds = %for.body.preheader.i397
  ...
  %scevgep577 = getelementptr i8, ptr %215, i64 %217
  %scevgep578 = getelementptr i8, ptr %215, i64 -8
  %218 = shl nsw i64 %wide.trip.count.i383, 4
  %scevgep579 = getelementptr i8, ptr %scevgep578, i64 %218
  %scevgep580 = getelementptr i8, ptr %3, i64 %217
  %scevgep582 = getelementptr i8, ptr %scevgep581, i64 %218
  %scevgep583 = getelementptr i8, ptr %214, i64 %217
  %scevgep584 = getelementptr i8, ptr %214, i64 -8
  %scevgep585 = getelementptr i8, ptr %scevgep584, i64 %218
  %scevgep586 = getelementptr i8, ptr %192, i64 %217
  %scevgep587 = getelementptr i8, ptr %192, i64 -8
  %scevgep588 = getelementptr i8, ptr %scevgep587, i64 %218
  %scevgep589 = getelementptr i8, ptr %20, i64 %217
  %scevgep591 = getelementptr i8, ptr %scevgep590, i64 %218
  %scevgep592 = getelementptr i8, ptr %215, i64 8
  %scevgep593 = getelementptr i8, ptr %scevgep592, i64 %217
  %scevgep594 = getelementptr i8, ptr %215, i64 %218
  %scevgep596 = getelementptr i8, ptr %scevgep595, i64 %217
  %scevgep597 = getelementptr i8, ptr %3, i64 %218
  %scevgep598 = getelementptr i8, ptr %214, i64 8
  %scevgep599 = getelementptr i8, ptr %scevgep598, i64 %217
  %scevgep600 = getelementptr i8, ptr %214, i64 %218
  %scevgep601 = getelementptr i8, ptr %192, i64 8
  %scevgep602 = getelementptr i8, ptr %scevgep601, i64 %217
  %scevgep603 = getelementptr i8, ptr %192, i64 %218
  %scevgep605 = getelementptr i8, ptr %scevgep604, i64 %217
  %scevgep606 = getelementptr i8, ptr %20, i64 %218
...
vector.ph665:                                     ; preds = %vector.memcheck576
  %n.vec667 = and i64 %216, -2
  %ind.end668 = add nsw i64 %n.vec667, %193
...
vector.body671:                                   ; preds = %vector.body671, %vector.ph665
  ...
  %offset.idx673 = add i64 %index672, %193
  %219 = getelementptr inbounds %struct.double2, ptr %214, i64 %offset.idx673
  %wide.vec674 = load <4 x double>, ptr %219, align 8, !tbaa !40, !noalias !166
  ...
  %220 = getelementptr inbounds %struct.double2, ptr %192, i64 %offset.idx673
  %wide.vec677 = load <4 x double>, ptr %220, align 8, !tbaa !40, !noalias !169
  ...
  %221 = fmul <2 x double> %strided.vec679, %broadcast.splat681
  %222 = fadd <2 x double> %strided.vec676, %221
  %223 = fmul <2 x double> %strided.vec678, %broadcast.splat681
  %224 = fadd <2 x double> %strided.vec675, %223
  %225 = getelementptr inbounds %struct.double2, ptr %215, i64 %offset.idx673
  %interleaved.vec682 = shufflevector <2 x double> %224, <2 x double> %222, <4 x i32> <i32 0, i32 2, i32 1, i32 3>
  store <4 x double> %interleaved.vec682, ptr %225, align 8, !tbaa !40
  %226 = getelementptr inbounds %struct.double2, ptr %20, i64 %offset.idx673
  %wide.vec683 = load <4 x double>, ptr %226, align 8, !tbaa !40, !noalias !172
  ...
  %wide.vec686 = load <4 x double>, ptr %219, align 8, !tbaa !40, !noalias !175
  ...
  %227 = fadd <2 x double> %222, %strided.vec688
  %228 = fmul <2 x double> %227, <double 5.000000e-01, double 5.000000e-01>
  %229 = fmul <2 x double> %228, %broadcast.splat681
  %230 = fadd <2 x double> %strided.vec685, %229
  %231 = fadd <2 x double> %224, %strided.vec687
  %232 = fmul <2 x double> %231, <double 5.000000e-01, double 5.000000e-01>
  %233 = fmul <2 x double> %232, %broadcast.splat681
  %234 = fadd <2 x double> %strided.vec684, %233
  %235 = getelementptr inbounds %struct.double2, ptr %3, i64 %offset.idx673
  %interleaved.vec689 = shufflevector <2 x double> %234, <2 x double> %230, <4 x i32> <i32 0, i32 2, i32 1, i32 3>
  store <4 x double> %interleaved.vec689, ptr %235, align 8, !tbaa !40
  %index.next690 = add nuw i64 %index672, 2
  %236 = icmp eq i64 %index.next690, %n.vec667
  br i1 %236, label %middle.block662, label %vector.body671, !llvm.loop !178

middle.block662:                                  ; preds = %vector.body671
  %cmp.n670 = icmp eq i64 %216, %n.vec667
...
for.body.i410.preheader:                          ; preds = %vector.memcheck576, %for.body.preheader.i397, %middle.block662
  %indvars.iv.i398.ph = phi i64 [ %193, %vector.memcheck576 ], [ %193, %for.body.preheader.i397 ], [ %ind.end668, %middle.block662 ]
...
for.body.i410:                                    ; preds = %for.body.i410.preheader, %for.body.i410
  ...
  %arrayidx.i402 = getelementptr inbounds %struct.double2, ptr %214, i64 %indvars.iv.i398
  %arrayidx4.i403 = getelementptr inbounds %struct.double2, ptr %192, i64 %indvars.iv.i398
  %arrayidx6.i406 = getelementptr inbounds %struct.double2, ptr %215, i64 %indvars.iv.i398
  %237 = load <2 x double>, ptr %arrayidx.i402, align 8, !tbaa !40, !noalias !166
  %238 = load <2 x double>, ptr %arrayidx4.i403, align 8, !tbaa !40, !noalias !169
  %239 = fmul <2 x double> %238, %75
  %240 = fadd <2 x double> %237, %239
  store <2 x double> %240, ptr %arrayidx6.i406, align 8, !tbaa !40
  ...
  %241 = load <2 x double>, ptr %arrayidx13.i407, align 8, !tbaa !40, !noalias !172
  %242 = load <2 x double>, ptr %arrayidx.i402, align 8, !tbaa !40, !noalias !175
  %243 = fadd <2 x double> %240, %242
  %244 = fmul <2 x double> %243, <double 5.000000e-01, double 5.000000e-01>
  %245 = fmul <2 x double> %244, %75
...
for.body128:                                      ; preds = %for.body112, %for.body128
  ...
  %add.ptr.i411 = getelementptr inbounds ptr, ptr %247, i64 %indvars.iv506
  %248 = load ptr, ptr %add.ptr.i411, align 8, !tbaa !34
  %pchbfirst = getelementptr inbounds %class.HydroBC, ptr %248, i64 0, i32 4
  %249 = load ptr, ptr %pchbfirst, align 8, !tbaa !44
  %add.ptr.i412 = getelementptr inbounds i32, ptr %249, i64 %indvars.iv509
  %250 = load i32, ptr %add.ptr.i412, align 4, !tbaa !82
  %pchblast = getelementptr inbounds %class.HydroBC, ptr %248, i64 0, i32 5
  %251 = load ptr, ptr %pchblast, align 8, !tbaa !44
  %add.ptr.i414 = getelementptr inbounds i32, ptr %251, i64 %indvars.iv509
  %252 = load i32, ptr %add.ptr.i414, align 4, !tbaa !82
...
for.cond.cleanup158:                              ; preds = %_ZN5Hydro8calcWorkEPK7double2S2_S2_S2_S2_dPdS3_ii.exit, %for.cond.cleanup111
  ...
  %numzch497 = getelementptr inbounds %class.Mesh, ptr %258, i64 0, i32 62
  %259 = load i32, ptr %numzch497, align 8, !tbaa !56
  %cmp198498 = icmp sgt i32 %259, 0
...
for.body159:                                      ; preds = %for.body159.lr.ph, %_ZN5Hydro8calcWorkEPK7double2S2_S2_S2_S2_dPdS3_ii.exit
  ...
  %add.ptr.i416 = getelementptr inbounds i32, ptr %261, i64 %indvars.iv514
  %262 = load i32, ptr %add.ptr.i416, align 4, !tbaa !82
  %schslast167 = getelementptr inbounds %class.Mesh, ptr %260, i64 0, i32 56
  %263 = load ptr, ptr %schslast167, align 8, !tbaa !44
  %add.ptr.i417 = getelementptr inbounds i32, ptr %263, i64 %indvars.iv514
  %264 = load i32, ptr %add.ptr.i417, align 4, !tbaa !82
  %schzfirst172 = getelementptr inbounds %class.Mesh, ptr %260, i64 0, i32 57
  %265 = load ptr, ptr %schzfirst172, align 8, !tbaa !44
  %add.ptr.i418 = getelementptr inbounds i32, ptr %265, i64 %indvars.iv514
  %266 = load i32, ptr %add.ptr.i418, align 4, !tbaa !82
  %schzlast177 = getelementptr inbounds %class.Mesh, ptr %260, i64 0, i32 58
  %267 = load ptr, ptr %schzlast177, align 8, !tbaa !44
  %add.ptr.i419 = getelementptr inbounds i32, ptr %267, i64 %indvars.iv514
  %268 = load i32, ptr %add.ptr.i419, align 4, !tbaa !82
...
for.body.lr.ph.i422:                              ; preds = %_ZSt4fillIPddEvT_S1_RKT0_.exit
  ...
  %mapsz.i420 = getelementptr inbounds %class.Mesh, ptr %281, i64 0, i32 15
  %284 = load ptr, ptr %mapsz.i420, align 8, !tbaa !142
  %285 = sext i32 %262 to i64
  %wide.trip.count.i421 = sext i32 %264 to i64
  br label %for.body.i436

for.body.i436:                                    ; preds = %for.body.i436, %for.body.lr.ph.i422
  %indvars.iv.i423 = phi i64 [ %285, %for.body.lr.ph.i422 ], [ %indvars.iv.next.i434, %for.body.i436 ]
  %arrayidx.i424 = getelementptr inbounds i32, ptr %282, i64 %indvars.iv.i423
  %286 = load i32, ptr %arrayidx.i424, align 4, !tbaa !82
  %arrayidx4.i425 = getelementptr inbounds i32, ptr %283, i64 %indvars.iv.i423
  %287 = load i32, ptr %arrayidx4.i425, align 4, !tbaa !82
  %arrayidx7.i = getelementptr inbounds i32, ptr %284, i64 %indvars.iv.i423
  %288 = load i32, ptr %arrayidx7.i, align 4, !tbaa !82
  %idxprom12.i426 = sext i32 %286 to i64
  %y.i74.i = getelementptr inbounds %struct.double2, ptr %278, i64 %idxprom12.i426, i32 1
  %289 = load double, ptr %y.i74.i, align 8, !tbaa !99, !noalias !184
  %y3.i75.i = getelementptr inbounds %struct.double2, ptr %279, i64 %idxprom12.i426, i32 1
  %290 = load double, ptr %y3.i75.i, align 8, !tbaa !99, !noalias !184
  %add4.i76.i = fadd double %289, %290
  ...
  %291 = load double, ptr %arrayidx13.i427, align 8, !tbaa !97, !noalias !184
  %292 = load double, ptr %arrayidx15.i, align 8, !tbaa !97, !noalias !184
  %add.i73.i = fadd double %291, %292
  %y.i.i428 = getelementptr inbounds %struct.double2, ptr %276, i64 %indvars.iv.i423, i32 1
  %293 = load double, ptr %y.i.i428, align 8, !tbaa !99, !noalias !187
  %y3.i.i429 = getelementptr inbounds %struct.double2, ptr %277, i64 %indvars.iv.i423, i32 1
  %294 = load double, ptr %y3.i.i429, align 8, !tbaa !99, !noalias !187
  %add4.i.i430 = fadd double %293, %294
  %arrayidx11.i431 = getelementptr inbounds %struct.double2, ptr %277, i64 %indvars.iv.i423
  %arrayidx9.i = getelementptr inbounds %struct.double2, ptr %276, i64 %indvars.iv.i423
  %295 = load double, ptr %arrayidx9.i, align 8, !tbaa !97, !noalias !187
  %296 = load double, ptr %arrayidx11.i431, align 8, !tbaa !97, !noalias !187
  %add.i.i432 = fadd double %295, %296
  %mul3.i.i = fmul double %add4.i76.i, %add4.i.i430
  %297 = tail call double @llvm.fmuladd.f64(double %add.i.i432, double %add.i73.i, double %mul3.i.i)
  %fneg.i.i = fneg double %add.i.i432
  %fneg2.i.i = fneg double %add4.i.i430
  %idxprom22.i = sext i32 %287 to i64
  %y.i82.i = getelementptr inbounds %struct.double2, ptr %278, i64 %idxprom22.i, i32 1
  %298 = load double, ptr %y.i82.i, align 8, !tbaa !99, !noalias !190
  %y3.i83.i = getelementptr inbounds %struct.double2, ptr %279, i64 %idxprom22.i, i32 1
  %299 = load double, ptr %y3.i83.i, align 8, !tbaa !99, !noalias !190
  %add4.i84.i = fadd double %298, %299
  ...
  %300 = load double, ptr %arrayidx23.i, align 8, !tbaa !97, !noalias !190
  %301 = load double, ptr %arrayidx25.i, align 8, !tbaa !97, !noalias !190
  %add.i81.i = fadd double %300, %301
  %mul3.i88.i = fmul double %add4.i84.i, %fneg2.i.i
  %302 = tail call double @llvm.fmuladd.f64(double %fneg.i.i, double %add.i81.i, double %mul3.i88.i)
  ...
  %add.i433 = fadd double %306, %mul42.i
...
for.body200:                                      ; preds = %for.body200.lr.ph, %_ZN5Hydro7calcRhoEPKdS1_Pdii.exit475
  ...
  %308 = phi ptr [ %258, %for.body200.lr.ph ], [ %424, %_ZN5Hydro7calcRhoEPKdS1_Pdii.exit475 ]
  %zchzfirst = getelementptr inbounds %class.Mesh, ptr %308, i64 0, i32 63
  %309 = load ptr, ptr %zchzfirst, align 8, !tbaa !44
  %add.ptr.i437 = getelementptr inbounds i32, ptr %309, i64 %indvars.iv519
  %310 = load i32, ptr %add.ptr.i437, align 4, !tbaa !82
  %zchzlast = getelementptr inbounds %class.Mesh, ptr %308, i64 0, i32 64
  %311 = load ptr, ptr %zchzlast, align 8, !tbaa !44
  %add.ptr.i438 = getelementptr inbounds i32, ptr %311, i64 %indvars.iv519
  %312 = load i32, ptr %add.ptr.i438, align 4, !tbaa !82
...
for.body.preheader.i441:                          ; preds = %for.body200
  ...
  %wide.trip.count.i440 = sext i32 %312 to i64
  %320 = sub nsw i64 %wide.trip.count.i440, %319
  %min.iters.check771 = icmp ult i64 %320, 12
...
vector.memcheck761:                               ; preds = %for.body.preheader.i441
  ...
  %323 = add i64 %321, %10
  %324 = sub i64 %322, %323
  %diff.check762 = icmp ult i64 %324, 32
  %325 = add i64 %321, %17
  %326 = sub i64 %322, %325
  %diff.check763 = icmp ult i64 %326, 32
  %conflict.rdx764 = or i1 %diff.check762, %diff.check763
  %327 = add i64 %321, %314
  %328 = sub i64 %322, %327
  %diff.check765 = icmp ult i64 %328, 32
  %conflict.rdx766 = or i1 %conflict.rdx764, %diff.check765
  %329 = add i64 %321, %316
  %330 = sub i64 %322, %329
  %diff.check767 = icmp ult i64 %330, 32
...
vector.ph772:                                     ; preds = %vector.memcheck761
  %n.vec774 = and i64 %320, -4
  %ind.end775 = add nsw i64 %n.vec774, %319
...
vector.body778:                                   ; preds = %vector.body778, %vector.ph772
  ...
  %offset.idx780 = add i64 %index779, %319
  %331 = getelementptr inbounds double, ptr %9, i64 %offset.idx780
  %wide.load781 = load <2 x double>, ptr %331, align 8, !tbaa !40
  %332 = getelementptr inbounds double, ptr %331, i64 2
  %wide.load782 = load <2 x double>, ptr %332, align 8, !tbaa !40
  %333 = getelementptr inbounds double, ptr %16, i64 %offset.idx780
  %wide.load783 = load <2 x double>, ptr %333, align 8, !tbaa !40
  %334 = getelementptr inbounds double, ptr %333, i64 2
  %wide.load784 = load <2 x double>, ptr %334, align 8, !tbaa !40
  %335 = fsub <2 x double> %wide.load781, %wide.load783
  %336 = fsub <2 x double> %wide.load782, %wide.load784
  %337 = getelementptr inbounds double, ptr %313, i64 %offset.idx780
  %wide.load785 = load <2 x double>, ptr %337, align 8, !tbaa !40
  %338 = getelementptr inbounds double, ptr %337, i64 2
  %wide.load786 = load <2 x double>, ptr %338, align 8, !tbaa !40
  %339 = getelementptr inbounds double, ptr %315, i64 %offset.idx780
  %wide.load787 = load <2 x double>, ptr %339, align 8, !tbaa !40
  %340 = getelementptr inbounds double, ptr %339, i64 2
  %wide.load788 = load <2 x double>, ptr %340, align 8, !tbaa !40
  %341 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %wide.load787, <2 x double> %335, <2 x double> %wide.load785)
  %342 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %wide.load788, <2 x double> %336, <2 x double> %wide.load786)
  %343 = fmul <2 x double> %broadcast.splat790, %341
  %344 = fmul <2 x double> %broadcast.splat792, %342
  %345 = getelementptr inbounds double, ptr %317, i64 %offset.idx780
  ...
  %347 = icmp eq i64 %index.next793, %n.vec774
  br i1 %347, label %middle.block769, label %vector.body778, !llvm.loop !195

middle.block769:                                  ; preds = %vector.body778
  %cmp.n777 = icmp eq i64 %320, %n.vec774
...
for.body.i451.preheader:                          ; preds = %vector.memcheck761, %for.body.preheader.i441, %middle.block769
  %indvars.iv.i442.ph = phi i64 [ %319, %vector.memcheck761 ], [ %319, %for.body.preheader.i441 ], [ %ind.end775, %middle.block769 ]
  %348 = sub nsw i64 %wide.trip.count.i440, %indvars.iv.i442.ph
  %349 = xor i64 %indvars.iv.i442.ph, -1
  %xtraiter802 = and i64 %348, 1
  %lcmp.mod803.not = icmp eq i64 %xtraiter802, 0
  br i1 %lcmp.mod803.not, label %for.body.i451.prol.loopexit, label %for.body.i451.prol
...
for.body.i451.prol:                               ; preds = %for.body.i451.preheader
  ...
  %350 = load double, ptr %arrayidx.i443.prol, align 8, !tbaa !40
  %arrayidx3.i444.prol = getelementptr inbounds double, ptr %16, i64 %indvars.iv.i442.ph
  %351 = load double, ptr %arrayidx3.i444.prol, align 8, !tbaa !40
  %sub.i.prol = fsub double %350, %351
  %arrayidx5.i445.prol = getelementptr inbounds double, ptr %313, i64 %indvars.iv.i442.ph
  %352 = load double, ptr %arrayidx5.i445.prol, align 8, !tbaa !40
  %arrayidx7.i446.prol = getelementptr inbounds double, ptr %315, i64 %indvars.iv.i442.ph
  %353 = load double, ptr %arrayidx7.i446.prol, align 8, !tbaa !40
  %354 = tail call double @llvm.fmuladd.f64(double %353, double %sub.i.prol, double %352)
  %mul.i447.prol = fmul double %div.i439, %354
  %arrayidx9.i448.prol = getelementptr inbounds double, ptr %317, i64 %indvars.iv.i442.ph
...
for.body.i451.prol.loopexit:                      ; preds = %for.body.i451.prol, %for.body.i451.preheader
  ...
  %355 = sub nsw i64 0, %wide.trip.count.i440
  %356 = icmp eq i64 %349, %355
  br i1 %356, label %for.body.preheader.i454, label %for.body.i451
...
for.body.i451:                                    ; preds = %for.body.i451.prol.loopexit, %for.body.i451
  ...
  %357 = load double, ptr %arrayidx.i443, align 8, !tbaa !40
  %arrayidx3.i444 = getelementptr inbounds double, ptr %16, i64 %indvars.iv.i442
  %358 = load double, ptr %arrayidx3.i444, align 8, !tbaa !40
  %sub.i = fsub double %357, %358
  %arrayidx5.i445 = getelementptr inbounds double, ptr %313, i64 %indvars.iv.i442
  %359 = load double, ptr %arrayidx5.i445, align 8, !tbaa !40
  %arrayidx7.i446 = getelementptr inbounds double, ptr %315, i64 %indvars.iv.i442
  %360 = load double, ptr %arrayidx7.i446, align 8, !tbaa !40
  %361 = tail call double @llvm.fmuladd.f64(double %360, double %sub.i, double %359)
  %mul.i447 = fmul double %div.i439, %361
  %arrayidx9.i448 = getelementptr inbounds double, ptr %317, i64 %indvars.iv.i442
  ...
  %362 = load double, ptr %arrayidx.i443.1, align 8, !tbaa !40
  %arrayidx3.i444.1 = getelementptr inbounds double, ptr %16, i64 %indvars.iv.next.i449
  %363 = load double, ptr %arrayidx3.i444.1, align 8, !tbaa !40
  %sub.i.1 = fsub double %362, %363
  %arrayidx5.i445.1 = getelementptr inbounds double, ptr %313, i64 %indvars.iv.next.i449
  %364 = load double, ptr %arrayidx5.i445.1, align 8, !tbaa !40
  %arrayidx7.i446.1 = getelementptr inbounds double, ptr %315, i64 %indvars.iv.next.i449
  %365 = load double, ptr %arrayidx7.i446.1, align 8, !tbaa !40
  %366 = tail call double @llvm.fmuladd.f64(double %365, double %sub.i.1, double %364)
  %mul.i447.1 = fmul double %div.i439, %366
  %arrayidx9.i448.1 = getelementptr inbounds double, ptr %317, i64 %indvars.iv.next.i449
...
for.body.preheader.i454:                          ; preds = %for.body.i451.prol.loopexit, %for.body.i451, %middle.block769
  ...
  %371 = sub nsw i64 %wide.trip.count.i440, %319
  %min.iters.check748 = icmp ult i64 %371, 2
...
vector.memcheck742:                               ; preds = %for.body.preheader.i454
  ...
  %376 = add i64 %374, %373
  %377 = sub i64 %375, %376
  %diff.check743 = icmp ult i64 %377, 16
  %378 = add i64 %374, %369
  %379 = sub i64 %375, %378
  %diff.check744 = icmp ult i64 %379, 16
...
vector.ph749:                                     ; preds = %vector.memcheck742
  %n.vec751 = and i64 %371, -2
  %ind.end752 = add nsw i64 %n.vec751, %319
...
vector.body755:                                   ; preds = %vector.body755, %vector.ph749
  ...
  %offset.idx757 = add i64 %index756, %319
  %380 = getelementptr inbounds double, ptr %367, i64 %offset.idx757
  %wide.load758 = load <2 x double>, ptr %380, align 8, !tbaa !40
  %381 = getelementptr inbounds double, ptr %368, i64 %offset.idx757
  %wide.load759 = load <2 x double>, ptr %381, align 8, !tbaa !40
  %382 = fadd <2 x double> %wide.load759, <double 1.000000e-99, double 1.000000e-99>
  %383 = fdiv <2 x double> %wide.load758, %382
  %384 = getelementptr inbounds double, ptr %370, i64 %offset.idx757
  store <2 x double> %383, ptr %384, align 8, !tbaa !40
  %index.next760 = add nuw i64 %index756, 2
  %385 = icmp eq i64 %index.next760, %n.vec751
  br i1 %385, label %middle.block746, label %vector.body755, !llvm.loop !197

middle.block746:                                  ; preds = %vector.body755
  %cmp.n754 = icmp eq i64 %371, %n.vec751
...
for.body.i463.preheader:                          ; preds = %vector.memcheck742, %for.body.preheader.i454, %middle.block746
  %indvars.iv.i455.ph = phi i64 [ %319, %vector.memcheck742 ], [ %319, %for.body.preheader.i454 ], [ %ind.end752, %middle.block746 ]
  %386 = sub nsw i64 %wide.trip.count.i440, %indvars.iv.i455.ph
  %387 = xor i64 %indvars.iv.i455.ph, -1
  %xtraiter805 = and i64 %386, 1
  %lcmp.mod806.not = icmp eq i64 %xtraiter805, 0
  br i1 %lcmp.mod806.not, label %for.body.i463.prol.loopexit, label %for.body.i463.prol

for.body.i463.prol:                               ; preds = %for.body.i463.preheader
  %arrayidx.i456.prol = getelementptr inbounds double, ptr %367, i64 %indvars.iv.i455.ph
  %388 = load double, ptr %arrayidx.i456.prol, align 8, !tbaa !40
  %arrayidx3.i457.prol = getelementptr inbounds double, ptr %368, i64 %indvars.iv.i455.ph
  %389 = load double, ptr %arrayidx3.i457.prol, align 8, !tbaa !40
  %add.i458.prol = fadd double %389, 1.000000e-99
  %div.i459.prol = fdiv double %388, %add.i458.prol
  %arrayidx5.i460.prol = getelementptr inbounds double, ptr %370, i64 %indvars.iv.i455.ph
...
for.body.i463.prol.loopexit:                      ; preds = %for.body.i463.prol, %for.body.i463.preheader
  ...
  %390 = sub nsw i64 0, %wide.trip.count.i440
  %391 = icmp eq i64 %387, %390
  br i1 %391, label %for.body.preheader.i466, label %for.body.i463
...
for.body.i463:                                    ; preds = %for.body.i463.prol.loopexit, %for.body.i463
  ...
  %arrayidx.i456 = getelementptr inbounds double, ptr %367, i64 %indvars.iv.i455
  %392 = load double, ptr %arrayidx.i456, align 8, !tbaa !40
  %arrayidx3.i457 = getelementptr inbounds double, ptr %368, i64 %indvars.iv.i455
  %393 = load double, ptr %arrayidx3.i457, align 8, !tbaa !40
  %add.i458 = fadd double %393, 1.000000e-99
  %div.i459 = fdiv double %392, %add.i458
  %arrayidx5.i460 = getelementptr inbounds double, ptr %370, i64 %indvars.iv.i455
  store double %div.i459, ptr %arrayidx5.i460, align 8, !tbaa !40
  %indvars.iv.next.i461 = add nsw i64 %indvars.iv.i455, 1
  %arrayidx.i456.1 = getelementptr inbounds double, ptr %367, i64 %indvars.iv.next.i461
  %394 = load double, ptr %arrayidx.i456.1, align 8, !tbaa !40
  %arrayidx3.i457.1 = getelementptr inbounds double, ptr %368, i64 %indvars.iv.next.i461
  %395 = load double, ptr %arrayidx3.i457.1, align 8, !tbaa !40
  %add.i458.1 = fadd double %395, 1.000000e-99
  %div.i459.1 = fdiv double %394, %add.i458.1
  %arrayidx5.i460.1 = getelementptr inbounds double, ptr %370, i64 %indvars.iv.next.i461
...
for.body.preheader.i466:                          ; preds = %for.body.i463.prol.loopexit, %for.body.i463, %middle.block746
  ...
  %397 = sub nsw i64 %wide.trip.count.i440, %319
  %min.iters.check729 = icmp ult i64 %397, 4
...
vector.memcheck723:                               ; preds = %for.body.preheader.i466
  ...
  %401 = add i64 %399, %369
  %402 = sub i64 %400, %401
  %diff.check724 = icmp ult i64 %402, 16
  %403 = add i64 %399, %10
  %404 = sub i64 %400, %403
  %diff.check725 = icmp ult i64 %404, 16
...
vector.ph730:                                     ; preds = %vector.memcheck723
  %n.vec732 = and i64 %397, -2
  %ind.end733 = add nsw i64 %n.vec732, %319
...
vector.body736:                                   ; preds = %vector.body736, %vector.ph730
  ...
  %offset.idx738 = add i64 %index737, %319
  %405 = getelementptr inbounds double, ptr %368, i64 %offset.idx738
  %wide.load739 = load <2 x double>, ptr %405, align 8, !tbaa !40
  %406 = getelementptr inbounds double, ptr %9, i64 %offset.idx738
  %wide.load740 = load <2 x double>, ptr %406, align 8, !tbaa !40
  %407 = fdiv <2 x double> %wide.load739, %wide.load740
  %408 = getelementptr inbounds double, ptr %396, i64 %offset.idx738
  store <2 x double> %407, ptr %408, align 8, !tbaa !40
  %index.next741 = add nuw i64 %index737, 2
  %409 = icmp eq i64 %index.next741, %n.vec732
  br i1 %409, label %middle.block727, label %vector.body736, !llvm.loop !199

middle.block727:                                  ; preds = %vector.body736
  %cmp.n735 = icmp eq i64 %397, %n.vec732
...
for.body.i474.preheader:                          ; preds = %vector.memcheck723, %for.body.preheader.i466, %middle.block727
  %indvars.iv.i467.ph = phi i64 [ %319, %vector.memcheck723 ], [ %319, %for.body.preheader.i466 ], [ %ind.end733, %middle.block727 ]
  %410 = sub nsw i64 %wide.trip.count.i440, %indvars.iv.i467.ph
  %411 = xor i64 %indvars.iv.i467.ph, -1
  %412 = add nsw i64 %411, %wide.trip.count.i440
  %xtraiter808 = and i64 %410, 3
  %lcmp.mod809.not = icmp eq i64 %xtraiter808, 0
  br i1 %lcmp.mod809.not, label %for.body.i474.prol.loopexit, label %for.body.i474.prol
...
for.body.i474.prol:                               ; preds = %for.body.i474.preheader, %for.body.i474.prol
  ...
  %prol.iter810 = phi i64 [ %prol.iter810.next, %for.body.i474.prol ], [ 0, %for.body.i474.preheader ]
  %arrayidx.i468.prol = getelementptr inbounds double, ptr %368, i64 %indvars.iv.i467.prol
  %413 = load double, ptr %arrayidx.i468.prol, align 8, !tbaa !40
  %arrayidx3.i469.prol = getelementptr inbounds double, ptr %9, i64 %indvars.iv.i467.prol
  %414 = load double, ptr %arrayidx3.i469.prol, align 8, !tbaa !40
  %div.i470.prol = fdiv double %413, %414
  %arrayidx5.i471.prol = getelementptr inbounds double, ptr %396, i64 %indvars.iv.i467.prol
  ...
  br i1 %prol.iter810.cmp.not, label %for.body.i474.prol.loopexit, label %for.body.i474.prol, !llvm.loop !200
...
for.body.i474.prol.loopexit:                      ; preds = %for.body.i474.prol, %for.body.i474.preheader
  ...
  br i1 %415, label %_ZN5Hydro7calcRhoEPKdS1_Pdii.exit475, label %for.body.i474
...
for.body.i474:                                    ; preds = %for.body.i474.prol.loopexit, %for.body.i474
  ...
  %arrayidx.i468 = getelementptr inbounds double, ptr %368, i64 %indvars.iv.i467
  %416 = load double, ptr %arrayidx.i468, align 8, !tbaa !40
  %arrayidx3.i469 = getelementptr inbounds double, ptr %9, i64 %indvars.iv.i467
  %417 = load double, ptr %arrayidx3.i469, align 8, !tbaa !40
  %div.i470 = fdiv double %416, %417
  %arrayidx5.i471 = getelementptr inbounds double, ptr %396, i64 %indvars.iv.i467
  store double %div.i470, ptr %arrayidx5.i471, align 8, !tbaa !40
  %indvars.iv.next.i472 = add nsw i64 %indvars.iv.i467, 1
  %arrayidx.i468.1 = getelementptr inbounds double, ptr %368, i64 %indvars.iv.next.i472
  %418 = load double, ptr %arrayidx.i468.1, align 8, !tbaa !40
  %arrayidx3.i469.1 = getelementptr inbounds double, ptr %9, i64 %indvars.iv.next.i472
  %419 = load double, ptr %arrayidx3.i469.1, align 8, !tbaa !40
  %div.i470.1 = fdiv double %418, %419
  %arrayidx5.i471.1 = getelementptr inbounds double, ptr %396, i64 %indvars.iv.next.i472
  store double %div.i470.1, ptr %arrayidx5.i471.1, align 8, !tbaa !40
  %indvars.iv.next.i472.1 = add nsw i64 %indvars.iv.i467, 2
  %arrayidx.i468.2 = getelementptr inbounds double, ptr %368, i64 %indvars.iv.next.i472.1
  %420 = load double, ptr %arrayidx.i468.2, align 8, !tbaa !40
  %arrayidx3.i469.2 = getelementptr inbounds double, ptr %9, i64 %indvars.iv.next.i472.1
  %421 = load double, ptr %arrayidx3.i469.2, align 8, !tbaa !40
  %div.i470.2 = fdiv double %420, %421
  %arrayidx5.i471.2 = getelementptr inbounds double, ptr %396, i64 %indvars.iv.next.i472.1
  store double %div.i470.2, ptr %arrayidx5.i471.2, align 8, !tbaa !40
  %indvars.iv.next.i472.2 = add nsw i64 %indvars.iv.i467, 3
  %arrayidx.i468.3 = getelementptr inbounds double, ptr %368, i64 %indvars.iv.next.i472.2
  %422 = load double, ptr %arrayidx.i468.3, align 8, !tbaa !40
  %arrayidx3.i469.3 = getelementptr inbounds double, ptr %9, i64 %indvars.iv.next.i472.2
  %423 = load double, ptr %arrayidx3.i469.3, align 8, !tbaa !40
  %div.i470.3 = fdiv double %422, %423
  %arrayidx5.i471.3 = getelementptr inbounds double, ptr %396, i64 %indvars.iv.next.i472.2
...
_ZN5Hydro7calcRhoEPKdS1_Pdii.exit475:             ; preds = %for.body.i474.prol.loopexit, %for.body.i474, %middle.block727, %for.body200
  ...
  %cmp198 = icmp slt i64 %indvars.iv.next520, %426
...
if.else.i:                                        ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC2IS3_EEPKcRKS3_.exit
  ...
  %cmp.i60.i = icmp eq ptr %15, %14
  %16 = load i64, ptr %14, align 8
  store ptr %8, ptr %msgdtnew, align 8, !tbaa !26
  %_M_string_length.i62.i = getelementptr inbounds %"class.std::__cxx11::basic_string", ptr %msgdtnew, i64 0, i32 1
  %17 = load <2 x i64>, ptr %_M_string_length.i.i.i.i, align 8, !tbaa !24
  store <2 x i64> %17, ptr %_M_string_length.i62.i, align 8, !tbaa !24
  %tobool35.not63.i = icmp eq ptr %15, null
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSEOS4_.exit: ; preds = %if.then15.i, %if.end24.i, %if.then36.i, %if.else37.i
  %18 = phi ptr [ %15, %if.then36.i ], [ %2, %if.else37.i ], [ %.pre.i, %if.end24.i ], [ %2, %if.then15.i ]
  store i64 0, ptr %_M_string_length.i.i.i.i, align 8, !tbaa !21
  store i8 0, ptr %18, align 1, !tbaa !24
  %19 = load ptr, ptr %ref.tmp, align 8, !tbaa !26
