...
entry:
  %call17 = tail call i64 @read(i32 noundef 0, ptr noundef nonnull @sbuf, i64 noundef 2000) #5
...
if.end:                                           ; preds = %entry, %if.end5
  %conv21 = phi i32 [ %conv, %if.end5 ], [ %conv18, %entry ]
  %call20 = phi i64 [ %call, %if.end5 ], [ %call17, %entry ]
  %cmp2 = icmp eq i32 %conv21, 0
  br i1 %cmp2, label %while.end, label %if.end5

if.end5:                                          ; preds = %if.end
  %div15 = lshr i32 %conv21, 1
  tail call void @adpcm_coder(ptr noundef nonnull @sbuf, ptr noundef nonnull @abuf, i32 noundef %div15, ptr noundef nonnull @state) #5
  %div616 = lshr i64 %call20, 2
  %conv7 = and i64 %div616, 1073741823
  %call8 = tail call i64 @write(i32 noundef 1, ptr noundef nonnull @abuf, i64 noundef %conv7) #5
  %call = tail call i64 @read(i32 noundef 0, ptr noundef nonnull @sbuf, i64 noundef 2000) #5
