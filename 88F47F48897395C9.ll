...
1027:                                             ; preds = %1014, %1067
  %1028 = phi ptr [ %1041, %1067 ], [ %914, %1014 ]
  %1029 = phi ptr [ %1040, %1067 ], [ %1025, %1014 ]
  %1030 = phi ptr [ %1039, %1067 ], [ %1022, %1014 ]
  %1031 = phi ptr [ %1038, %1067 ], [ %1021, %1014 ]
  %1032 = phi i32 [ %1073, %1067 ], [ 1, %1014 ]
  %1033 = phi ptr [ %1072, %1067 ], [ %1017, %1014 ]
  %1034 = phi ptr [ %1071, %1067 ], [ %1020, %1014 ]
  %1035 = phi ptr [ %1070, %1067 ], [ %913, %1014 ]
  %1036 = phi float [ %1055, %1067 ], [ %1019, %1014 ]
  %1037 = phi i32 [ %1054, %1067 ], [ 0, %1014 ]
  %1038 = getelementptr inbounds i32, ptr %1031, i64 1
  %1039 = getelementptr inbounds float, ptr %1030, i64 1
  %1040 = getelementptr inbounds i32, ptr %1029, i64 1
  %1041 = getelementptr inbounds float, ptr %1028, i64 1
  %1042 = load float, ptr %1035, align 4, !tbaa !9
  store i32 0, ptr %1040, align 4, !tbaa !11
  %1043 = load float, ptr %1034, align 4, !tbaa !9
  %1044 = fadd float %1036, %1043
  %1045 = fcmp ogt float %1044, %1042
  br i1 %1045, label %1046, label %1048

1046:                                             ; preds = %1027
  %1047 = sub i32 %1037, %1032
  store i32 %1047, ptr %1040, align 4, !tbaa !11
  br label %1048

1048:                                             ; preds = %1046, %1027
  %1049 = phi float [ %1044, %1046 ], [ %1042, %1027 ]
  %1050 = load float, ptr %1033, align 4, !tbaa !9
  %1051 = fadd float %1042, %1050
  %1052 = fcmp ult float %1051, %1036
  %1053 = add nsw i32 %1032, -1
  %1054 = select i1 %1052, i32 %1037, i32 %1053
  %1055 = select i1 %1052, float %1036, float %1051
  %1056 = load float, ptr %1039, align 4, !tbaa !9
  %1057 = fadd float %1010, %1056
  %1058 = fcmp ogt float %1057, %1049
  br i1 %1058, label %1059, label %1062

1059:                                             ; preds = %1048
  %1060 = load i32, ptr %1038, align 4, !tbaa !11
  %1061 = sub nsw i32 %922, %1060
  store i32 %1061, ptr %1040, align 4, !tbaa !11
  br label %1062

1062:                                             ; preds = %1059, %1048
  %1063 = phi float [ %1057, %1059 ], [ %1049, %1048 ]
  %1064 = fadd float %1013, %1042
  %1065 = fcmp ult float %1064, %1056
  br i1 %1065, label %1067, label %1066

1066:                                             ; preds = %1062
  store float %1064, ptr %1039, align 4, !tbaa !9
  store i32 %1026, ptr %1038, align 4, !tbaa !11
  br label %1067

1067:                                             ; preds = %1066, %1062
  %1068 = load float, ptr %1041, align 4, !tbaa !9
  %1069 = fadd float %1063, %1068
  store float %1069, ptr %1041, align 4, !tbaa !9
  %1070 = getelementptr inbounds float, ptr %1035, i64 1
  %1071 = getelementptr inbounds float, ptr %1034, i64 1
  %1072 = getelementptr inbounds float, ptr %1033, i64 1
  %1073 = add nuw i32 %1032, 1
  %1074 = icmp eq i32 %1032, %31
  br i1 %1074, label %1075, label %1027, !llvm.loop !108

1075:                                             ; preds = %1067, %1004
  %1076 = phi float [ %912, %1004 ], [ %1063, %1067 ]
...
946:                                              ; preds = %933, %986
  %947 = phi ptr [ %960, %986 ], [ %848, %933 ]
  %948 = phi ptr [ %959, %986 ], [ %944, %933 ]
  %949 = phi ptr [ %958, %986 ], [ %941, %933 ]
  %950 = phi ptr [ %957, %986 ], [ %940, %933 ]
  %951 = phi i32 [ %992, %986 ], [ 1, %933 ]
  %952 = phi ptr [ %991, %986 ], [ %936, %933 ]
  %953 = phi ptr [ %990, %986 ], [ %939, %933 ]
  %954 = phi ptr [ %989, %986 ], [ %847, %933 ]
  %955 = phi float [ %974, %986 ], [ %938, %933 ]
  %956 = phi i32 [ %973, %986 ], [ 0, %933 ]
  %957 = getelementptr inbounds i32, ptr %950, i64 1
  %958 = getelementptr inbounds float, ptr %949, i64 1
  %959 = getelementptr inbounds i32, ptr %948, i64 1
  %960 = getelementptr inbounds float, ptr %947, i64 1
  %961 = load float, ptr %954, align 4, !tbaa !9
  store i32 0, ptr %959, align 4, !tbaa !11
  %962 = load float, ptr %953, align 4, !tbaa !9
  %963 = fadd float %955, %962
  %964 = fcmp ogt float %963, %961
  br i1 %964, label %965, label %967

965:                                              ; preds = %946
  %966 = sub i32 %956, %951
  store i32 %966, ptr %959, align 4, !tbaa !11
  br label %967

967:                                              ; preds = %965, %946
  %968 = phi float [ %963, %965 ], [ %961, %946 ]
  %969 = load float, ptr %952, align 4, !tbaa !9
  %970 = fadd float %961, %969
  %971 = fcmp ult float %970, %955
  %972 = add nsw i32 %951, -1
  %973 = select i1 %971, i32 %956, i32 %972
  %974 = select i1 %971, float %955, float %970
  %975 = load float, ptr %958, align 4, !tbaa !9
  %976 = fadd float %929, %975
  %977 = fcmp ogt float %976, %968
  br i1 %977, label %978, label %981

978:                                              ; preds = %967
  %979 = load i32, ptr %957, align 4, !tbaa !11
  %980 = sub nsw i32 %856, %979
  store i32 %980, ptr %959, align 4, !tbaa !11
  br label %981

981:                                              ; preds = %978, %967
  %982 = phi float [ %976, %978 ], [ %968, %967 ]
  %983 = fadd float %932, %961
  %984 = fcmp ult float %983, %975
  br i1 %984, label %986, label %985

985:                                              ; preds = %981
  store float %983, ptr %958, align 4, !tbaa !9
  store i32 %945, ptr %957, align 4, !tbaa !11
  br label %986

986:                                              ; preds = %985, %981
  %987 = load float, ptr %960, align 4, !tbaa !9
  %988 = fadd float %982, %987
  store float %988, ptr %960, align 4, !tbaa !9
  %989 = getelementptr inbounds float, ptr %954, i64 1
  %990 = getelementptr inbounds float, ptr %953, i64 1
  %991 = getelementptr inbounds float, ptr %952, i64 1
  %992 = add nuw i32 %951, 1
  %993 = icmp eq i32 %951, %27
  br i1 %993, label %994, label %946, !llvm.loop !205

994:                                              ; preds = %986, %923
  %995 = phi float [ %846, %923 ], [ %982, %986 ]
