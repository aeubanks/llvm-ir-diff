...
define dso_local ptr @R_makefloat() local_unnamed_addr #0 {
  %1 = tail call ptr (i64, ...) @_Z_myalloc(i64 noundef 16) #3
  %2 = tail call ptr (i64, ...) @_Z_myalloc(i64 noundef 200) #3
...
define dso_local i32 @R_getexp(ptr nocapture noundef readonly %0) local_unnamed_addr #2 {
