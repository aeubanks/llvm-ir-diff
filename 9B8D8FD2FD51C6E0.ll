; ModuleID = '/usr/local/google/home/aeubanks/repos/test-suite/MultiSource/Benchmarks/TSVC/Searching-dbl/tsc.c'
source_filename = "/usr/local/google/home/aeubanks/repos/test-suite/MultiSource/Benchmarks/TSVC/Searching-dbl/tsc.c"
...
entry:
  %call = tail call i32 @init(ptr noundef nonnull @.str.88)
...
for.body4:                                        ; preds = %for.body4, %for.cond1.preheader
  ...
  %cmp5.3 = fcmp olt double %11, 0.000000e+00
  %12 = trunc i64 %indvars.iv.next.2 to i32
  %j.2.3 = select i1 %cmp5.3, i32 %12, i32 %j.2.2
  %indvars.iv.next.3 = add nuw nsw i64 %indvars.iv, 4
  %arrayidx.4 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv.next.3
  %13 = load double, ptr %arrayidx.4, align 8, !tbaa !5
  %cmp5.4 = fcmp olt double %13, 0.000000e+00
  %14 = trunc i64 %indvars.iv.next.3 to i32
  %j.2.4 = select i1 %cmp5.4, i32 %14, i32 %j.2.3
...
define dso_local i32 @max(i32 noundef %a1, i32 noundef %b1) local_unnamed_addr #9 {
entry:
  %b1.a1 = tail call i32 @llvm.smax.i32(i32 %b1, i32 %a1)
  ret i32 %b1.a1
}

; Function Attrs: nounwind uwtable
define dso_local i32 @s332(double noundef %t) local_unnamed_addr #7 {
entry:
  %call = tail call i32 @init(ptr noundef nonnull @.str.89)
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
  %cmp29 = icmp sgt i32 %0, 0
  br i1 %cmp29, label %for.cond1.preheader, label %cleanup11

for.cond1.preheader:                              ; preds = %entry, %L20
  %nl.030 = phi i32 [ %inc10, %L20 ], [ 0, %entry ]
  br label %for.body4

for.body4:                                        ; preds = %for.inc.4, %for.cond1.preheader
  %indvars.iv = phi i64 [ 0, %for.cond1.preheader ], [ %indvars.iv.next.4, %for.inc.4 ]
  %arrayidx = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv
  %1 = load double, ptr %arrayidx, align 8, !tbaa !5
  %cmp5 = fcmp ogt double %1, %t
  br i1 %cmp5, label %L20.split.loop.exit32, label %for.inc

for.inc:                                          ; preds = %for.body4
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %arrayidx.1 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv.next
  %2 = load double, ptr %arrayidx.1, align 8, !tbaa !5
  %cmp5.1 = fcmp ogt double %2, %t
  br i1 %cmp5.1, label %L20.split.loop.exit32, label %for.inc.1

for.inc.1:                                        ; preds = %for.inc
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %arrayidx.2 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv.next.1
  %3 = load double, ptr %arrayidx.2, align 8, !tbaa !5
  %cmp5.2 = fcmp ogt double %3, %t
  br i1 %cmp5.2, label %L20.split.loop.exit32, label %for.inc.2

for.inc.2:                                        ; preds = %for.inc.1
  %indvars.iv.next.2 = add nuw nsw i64 %indvars.iv, 3
  %arrayidx.3 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv.next.2
  %4 = load double, ptr %arrayidx.3, align 8, !tbaa !5
  %cmp5.3 = fcmp ogt double %4, %t
  br i1 %cmp5.3, label %L20.split.loop.exit32, label %for.inc.3

for.inc.3:                                        ; preds = %for.inc.2
  %indvars.iv.next.3 = add nuw nsw i64 %indvars.iv, 4
  %arrayidx.4 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv.next.3
  %5 = load double, ptr %arrayidx.4, align 8, !tbaa !5
  %cmp5.4 = fcmp ogt double %5, %t
  br i1 %cmp5.4, label %L20.split.loop.exit32, label %for.inc.4

for.inc.4:                                        ; preds = %for.inc.3
  %indvars.iv.next.4 = add nuw nsw i64 %indvars.iv, 5
  %exitcond.not.4 = icmp eq i64 %indvars.iv.next.4, 32000
  br i1 %exitcond.not.4, label %L20, label %for.body4

L20.split.loop.exit32:                            ; preds = %for.inc.3, %for.inc.2, %for.inc.1, %for.inc, %for.body4
  %indvars.iv.lcssa = phi i64 [ %indvars.iv, %for.body4 ], [ %indvars.iv.next, %for.inc ], [ %indvars.iv.next.1, %for.inc.1 ], [ %indvars.iv.next.2, %for.inc.2 ], [ %indvars.iv.next.3, %for.inc.3 ]
  %.lcssa = phi double [ %1, %for.body4 ], [ %2, %for.inc ], [ %3, %for.inc.1 ], [ %4, %for.inc.2 ], [ %5, %for.inc.3 ]
  %6 = trunc i64 %indvars.iv.lcssa to i32
  br label %L20

L20:                                              ; preds = %for.inc.4, %L20.split.loop.exit32
  %value.1 = phi double [ %.lcssa, %L20.split.loop.exit32 ], [ -1.000000e+00, %for.inc.4 ]
  %index.0 = phi i32 [ %6, %L20.split.loop.exit32 ], [ -2, %for.inc.4 ]
  %conv = sitofp i32 %index.0 to double
  %add = fadd double %value.1, %conv
  %call8 = tail call i32 @dummy(ptr noundef nonnull @global_data, ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 11, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 20, i64 0, i64 0), double noundef %add) #15
  %inc10 = add nuw nsw i32 %nl.030, 1
  %7 = load i32, ptr @ntimes, align 4, !tbaa !17
  %cmp = icmp slt i32 %inc10, %7
  br i1 %cmp, label %for.cond1.preheader, label %cleanup11

cleanup11:                                        ; preds = %L20, %entry
  %value.0.lcssa = phi double [ undef, %entry ], [ %value.1, %L20 ]
  %call14 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.138, double noundef 0.000000e+00)
  store double %value.0.lcssa, ptr @temp, align 8, !tbaa !5
  %8 = load i32, ptr @digits, align 4, !tbaa !17
  %call126.i = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %8, double noundef %value.0.lcssa)
  ret i32 0
}
...
if.end.thread:                                    ; preds = %entry
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
  %call215 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.140, i32 noundef %0)
  br label %if.end7
...
if.end:                                           ; preds = %entry
  ...
  %call2 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.140, i32 noundef %conv.i)
...
if.then4:                                         ; preds = %if.end
  ...
  %call.i13 = call i64 @strtol(ptr nocapture noundef nonnull %2, ptr noundef null, i32 noundef 10) #15
  %conv.i14 = trunc i64 %call.i13 to i32
  store i32 %conv.i14, ptr @digits, align 4, !tbaa !17
  br label %if.end7
...
if.end7:                                          ; preds = %if.end.thread, %if.then4, %if.end
  ...
  %call10 = call i32 @s332(double noundef %4)
