...
define dso_local i32 @s331() local_unnamed_addr #7 {
  %1 = tail call i32 @init(ptr noundef nonnull @.str.88)
...
9:                                                ; preds = %6, %0
  %10 = phi double [ 0.000000e+00, %0 ], [ %8, %6 ]
  %11 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.137, double noundef 0.000000e+00)
...
14:                                               ; preds = %20
  %15 = sitofp i32 %51 to double
  %16 = tail call i32 @dummy(ptr noundef nonnull @global_data, ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 11, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 20, i64 0, i64 0), double noundef %15) #15
...
20:                                               ; preds = %20, %4
  %21 = phi i64 [ 0, %4 ], [ %52, %20 ]
  %22 = phi i32 [ -1, %4 ], [ %51, %20 ]
  %23 = getelementptr inbounds double, ptr @global_data, i64 %21
...
define dso_local i32 @max(i32 noundef %0, i32 noundef %1) local_unnamed_addr #9 {
  %3 = tail call i32 @llvm.smax.i32(i32 %1, i32 %0)
  ret i32 %3
}

; Function Attrs: nounwind uwtable
define dso_local i32 @s332(double noundef %0) local_unnamed_addr #7 {
  %2 = tail call i32 @init(ptr noundef nonnull @.str.89)
...
27:                                               ; preds = %22
  ...
  %29 = getelementptr inbounds double, ptr @global_data, i64 %28
  %30 = load double, ptr %29, align 8, !tbaa !5
  %31 = fcmp ogt double %30, %0
  br i1 %31, label %35, label %32

32:                                               ; preds = %27
  %33 = add nuw nsw i64 %8, 5
  %34 = icmp eq i64 %33, 32000
  br i1 %34, label %39, label %7

35:                                               ; preds = %27, %22, %17, %12, %7
  %36 = phi i64 [ %8, %7 ], [ %13, %12 ], [ %18, %17 ], [ %23, %22 ], [ %28, %27 ]
  %37 = phi double [ %10, %7 ], [ %15, %12 ], [ %20, %17 ], [ %25, %22 ], [ %30, %27 ]
  %38 = trunc i64 %36 to i32
  br label %39

39:                                               ; preds = %32, %35
  %40 = phi double [ %37, %35 ], [ -1.000000e+00, %32 ]
  %41 = phi i32 [ %38, %35 ], [ -2, %32 ]
  %42 = sitofp i32 %41 to double
  %43 = fadd double %40, %42
  %44 = tail call i32 @dummy(ptr noundef nonnull @global_data, ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 11, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 20, i64 0, i64 0), double noundef %43) #15
  %45 = add nuw nsw i32 %6, 1
  %46 = load i32, ptr @ntimes, align 4, !tbaa !17
  %47 = icmp slt i32 %45, %46
  br i1 %47, label %5, label %48

48:                                               ; preds = %39, %1
  %49 = phi double [ undef, %1 ], [ %40, %39 ]
  %50 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.138, double noundef 0.000000e+00)
  store double %49, ptr @temp, align 8, !tbaa !5
  %51 = load i32, ptr @digits, align 4, !tbaa !17
  %52 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %51, double noundef %49)
  ret i32 0
}
...
8:                                                ; preds = %2
  ...
  %10 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.140, i32 noundef %9)
  br label %23
...
11:                                               ; preds = %2
  ...
  %16 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.140, i32 noundef %15)
  %17 = icmp eq i32 %0, 2
...
23:                                               ; preds = %8, %18, %11
  ...
  %28 = call i32 @s332(double noundef %27)
