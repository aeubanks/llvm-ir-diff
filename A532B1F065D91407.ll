...
if.then:                                          ; preds = %entry
  ...
  br i1 %tobool.not.i, label %return, label %if.end.i239

if.end.i239:                                      ; preds = %if.then
...
return:                                           ; preds = %if.then, %if.then3, %while.end, %if.end.i239
  %retval.0 = phi i32 [ 0, %if.end.i239 ], [ 0, %while.end ], [ 0, %if.then3 ], [ -14, %if.then ]
  ret i32 %retval.0
}
