...
land.lhs.true:                                    ; preds = %entry
  ...
  br i1 %cmp, label %land.rhs, label %land.lhs.true.i
...
land.lhs.true.i:                                  ; preds = %land.rhs, %land.lhs.true
  %.ph = phi i1 [ %tobool4, %land.rhs ], [ false, %land.lhs.true ]
  %npass_code.i = getelementptr inbounds %struct.D_Reduction, ptr %0, i64 0, i32 9
  %5 = load i32, ptr %npass_code.i, align 8, !tbaa !76
  %index.i = getelementptr inbounds %struct.D_Pass, ptr %pp, i64 0, i32 3
  %6 = load i32, ptr %index.i, align 8, !tbaa !78
  %cmp.i = icmp ugt i32 %5, %6
  br i1 %cmp.i, label %land.lhs.true2.i, label %pass_call.exit

land.lhs.true2.i:                                 ; preds = %land.lhs.true.i
  %pass_code.i = getelementptr inbounds %struct.D_Reduction, ptr %0, i64 0, i32 10
  %7 = load ptr, ptr %pass_code.i, align 8, !tbaa !79
...
if.then.i:                                        ; preds = %land.lhs.true2.i
  ...
  %9 = load ptr, ptr %v.i, align 8, !tbaa !15
  %10 = load i32, ptr %children.i, align 8, !tbaa !14
  %call.i = tail call i32 %8(ptr noundef nonnull %pn, ptr noundef %9, i32 noundef %10, i32 noundef 152, ptr noundef %p) #23
  br label %pass_call.exit

pass_call.exit:                                   ; preds = %entry, %land.lhs.true.i, %land.lhs.true2.i, %if.then.i
  %11 = phi i1 [ %.ph, %land.lhs.true.i ], [ %.ph, %land.lhs.true2.i ], [ %.ph, %if.then.i ], [ false, %entry ]
  %kind = getelementptr inbounds %struct.D_Pass, ptr %pp, i64 0, i32 2
  %12 = load i32, ptr %kind, align 4, !tbaa !73
  %and = and i32 %12, 8
...
lor.lhs.false:                                    ; preds = %pass_call.exit
  ...
  %or.cond = select i1 %tobool8, i1 true, i1 %11
...
for.body:                                         ; preds = %for.body.lr.ph, %for.body
  %indvars.iv = phi i64 [ 0, %for.body.lr.ph ], [ %indvars.iv.next, %for.body ]
  %14 = load ptr, ptr %v, align 8, !tbaa !15
  %arrayidx14 = getelementptr inbounds ptr, ptr %14, i64 %indvars.iv
  %15 = load ptr, ptr %arrayidx14, align 8, !tbaa !16
  tail call fastcc void @pass_preorder(ptr noundef %p, ptr noundef %pp, ptr noundef %15)
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %16 = load i32, ptr %children, align 8, !tbaa !14
  %17 = zext i32 %16 to i64
  %cmp11 = icmp ult i64 %indvars.iv.next, %17
...
if.end158:                                        ; preds = %land.lhs.true143, %land.lhs.true128, %while.cond121, %if.then154
  %scol.7 = phi ptr [ %add.ptr157, %if.then154 ], [ %scol.6, %while.cond121 ], [ %scol.6, %land.lhs.true128 ], [ %scol.6, %land.lhs.true143 ]
...
while.cond:                                       ; preds = %while.cond.outer, %error_recovery.exit
  ...
  %tobool.not285 = icmp eq ptr %13, null
  br i1 %tobool.not285, label %while.end, label %while.body23

while.body23:                                     ; preds = %land.rhs, %while.cond
  %14 = phi ptr [ %13, %while.cond ], [ %21, %land.rhs ]
  %epos.1286 = phi ptr [ %epos.0, %while.cond ], [ %epos.2316, %land.rhs ]
...
if.end:                                           ; preds = %land.lhs.true, %while.body23
  %cmp32 = icmp ugt ptr %16, %epos.1286
...
if.end34:                                         ; preds = %if.end
  ...
  %tobool36.not284 = icmp eq ptr %.pre, null
  br i1 %tobool36.not284, label %while.end, label %land.rhs.preheader

land.rhs.preheader:                               ; preds = %if.end, %if.end34
  %epos.2316 = phi ptr [ %16, %if.end34 ], [ %epos.1286, %if.end ]
...
while.end:                                        ; preds = %if.end34, %land.lhs.true, %for.body, %while.cond
  %epos.1.lcssa = phi ptr [ %epos.0, %while.cond ], [ %epos.2316, %for.body ], [ %16, %if.end34 ], [ %epos.1286, %land.lhs.true ]
...
if.else:                                          ; preds = %lor.lhs.false, %if.then45
  ...
  %31 = load ptr, ptr %last_all.i, align 8, !tbaa !176
...
if.end7.i:                                        ; preds = %if.end.i
  ...
  %34 = load i32, ptr %last_syntax_error_line.i, align 8, !tbaa !177
  %cmp.i = icmp sgt i32 %33, %34
  br i1 %cmp.i, label %if.end17.i, label %for.body.preheader.i

if.end17.i:                                       ; preds = %if.end7.i
  store i32 %33, ptr %last_syntax_error_line.i, align 8, !tbaa !177
  %35 = load i32, ptr %syntax_errors.i, align 4, !tbaa !178
  %inc.i = add nsw i32 %35, 1
  store i32 %inc.i, ptr %syntax_errors.i, align 4, !tbaa !178
  %36 = load ptr, ptr %syntax_error_fn.i, align 8, !tbaa !85
  call void %36(ptr noundef nonnull %p) #23
  %.pre.i = load ptr, ptr %last_all.i, align 8, !tbaa !176
  %tobool20.not478.i = icmp eq ptr %.pre.i, null
  br i1 %tobool20.not478.i, label %cleanup.sink.split, label %for.body.preheader.i

for.body.preheader.i:                             ; preds = %if.end17.i, %if.end7.i
  %37 = phi ptr [ %.pre.i, %if.end17.i ], [ %31, %if.end7.i ]
  br label %for.body.i

for.body.i:                                       ; preds = %for.inc.i, %for.body.preheader.i
  %sn.0480.i = phi ptr [ %38, %for.inc.i ], [ %37, %for.body.preheader.i ]
  %tail.0479.i = phi i32 [ %tail.1.i, %for.inc.i ], [ 0, %for.body.preheader.i ]
  %cmp21.i = icmp slt i32 %tail.0479.i, 9999
  br i1 %cmp21.i, label %if.then22.i, label %for.inc.i

if.then22.i:                                      ; preds = %for.body.i
  %inc23.i = add nsw i32 %tail.0479.i, 1
  %idxprom.i = sext i32 %tail.0479.i to i64
  %arrayidx.i = getelementptr inbounds ptr, ptr %call.i196, i64 %idxprom.i
  store ptr %sn.0480.i, ptr %arrayidx.i, align 8, !tbaa !16
  br label %for.inc.i

for.inc.i:                                        ; preds = %if.then22.i, %for.body.i
  %tail.1.i = phi i32 [ %inc23.i, %if.then22.i ], [ %tail.0479.i, %for.body.i ]
  %all_next.i = getelementptr inbounds %struct.SNode, ptr %sn.0480.i, i64 0, i32 9
  %38 = load ptr, ptr %all_next.i, align 8, !tbaa !143
  %tobool20.not.i = icmp eq ptr %38, null
  br i1 %tobool20.not.i, label %for.end.i, label %for.body.i, !llvm.loop !179

for.end.i:                                        ; preds = %for.inc.i
  %loc27.i = getelementptr inbounds %struct.SNode, ptr %37, i64 0, i32 3
  %39 = load ptr, ptr %loc27.i, align 8, !tbaa !173
  %cmp29497.i = icmp sgt i32 %tail.1.i, 0
  br i1 %cmp29497.i, label %while.body.i, label %cleanup.sink.split

while.cond.loopexit.i:                            ; preds = %for.inc112.i, %if.end72.i
  %tail.3.lcssa.i = phi i32 [ %tail.2498.i, %if.end72.i ], [ %tail.6.i, %for.inc112.i ]
  %40 = sext i32 %tail.3.lcssa.i to i64
  %cmp29.i = icmp slt i64 %indvars.iv.next529.i, %40
  br i1 %cmp29.i, label %while.body.i, label %while.end.i, !llvm.loop !180

while.body.i:                                     ; preds = %for.end.i, %while.cond.loopexit.i
  %indvars.iv528.i = phi i64 [ %indvars.iv.next529.i, %while.cond.loopexit.i ], [ 0, %for.end.i ]
  %best_sn.0502.i = phi ptr [ %best_sn.3.i, %while.cond.loopexit.i ], [ null, %for.end.i ]
  %best_s.0501.i = phi ptr [ %best_s.3.i, %while.cond.loopexit.i ], [ null, %for.end.i ]
  %best_er.0499.i = phi ptr [ %best_er.3.i, %while.cond.loopexit.i ], [ null, %for.end.i ]
  %tail.2498.i = phi i32 [ %tail.3.lcssa.i, %while.cond.loopexit.i ], [ %tail.1.i, %for.end.i ]
  %indvars.iv.next529.i = add nuw nsw i64 %indvars.iv528.i, 1
  %arrayidx32.i = getelementptr inbounds ptr, ptr %call.i196, i64 %indvars.iv528.i
  %41 = load ptr, ptr %arrayidx32.i, align 8, !tbaa !16
  %42 = load ptr, ptr %41, align 8, !tbaa !43
  %error_recovery_hints.i = getelementptr inbounds %struct.D_State, ptr %42, i64 0, i32 4
  %43 = load i32, ptr %error_recovery_hints.i, align 8, !tbaa !181
...
for.cond35.preheader.i:                           ; preds = %while.body.i
  %v.i198 = getelementptr inbounds %struct.D_State, ptr %42, i64 0, i32 4, i32 1
  %44 = load ptr, ptr %v.i198, align 8, !tbaa !184
  %45 = load i8, ptr %39, align 1, !tbaa !21
  %tobool.not40.i.i = icmp eq i8 %45, 0
  %depth54.i = getelementptr inbounds %struct.SNode, ptr %41, i64 0, i32 4
...
for.body40.i:                                     ; preds = %if.end68.i, %for.cond35.preheader.i
  ...
  %best_sn.1485.i = phi ptr [ %best_sn.0502.i, %for.cond35.preheader.i ], [ %best_sn.2.i, %if.end68.i ]
  %best_s.1484.i = phi ptr [ %best_s.0501.i, %for.cond35.preheader.i ], [ %best_s.2.i, %if.end68.i ]
  %best_er.1482.i = phi ptr [ %best_er.0499.i, %for.cond35.preheader.i ], [ %best_er.2.i, %if.end68.i ]
  %arrayidx44.i = getelementptr inbounds %struct.D_ErrorRecoveryHint, ptr %44, i64 %indvars.iv.i
  %string.i = getelementptr inbounds %struct.D_ErrorRecoveryHint, ptr %44, i64 %indvars.iv.i, i32 2
  %46 = load ptr, ptr %string.i, align 8, !tbaa !185
  %call.i.i = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %46) #25
  %47 = and i64 %call.i.i, 4294967295
...
while.cond.preheader.i.i:                         ; preds = %for.body40.i
  %.pre.i.i = load i8, ptr %46, align 1, !tbaa !21
  br i1 %tobool.not40.i.i, label %while.end.i.i, label %land.rhs.i.i

land.rhs.i.i:                                     ; preds = %while.cond.preheader.i.i, %while.body.i.i
  %48 = phi i8 [ %49, %while.body.i.i ], [ %45, %while.cond.preheader.i.i ]
  %str.addr.041.i.i = phi ptr [ %add.ptr.i474.i, %while.body.i.i ], [ %39, %while.cond.preheader.i.i ]
  %cmp5.not.i.i = icmp eq i8 %48, %.pre.i.i
...
while.body.i.i:                                   ; preds = %land.rhs.i.i
  %49 = load i8, ptr %add.ptr.i474.i, align 1, !tbaa !21
  %tobool.not.i.i = icmp eq i8 %49, 0
  br i1 %tobool.not.i.i, label %while.end.i.i, label %land.rhs.i.i, !llvm.loop !187

while.end.i.i:                                    ; preds = %while.body.i.i, %while.cond.preheader.i.i
  %str.addr.0.lcssa.i.i = phi ptr [ %39, %while.cond.preheader.i.i ], [ %add.ptr.i474.i, %while.body.i.i ]
...
while.body14.i.i:                                 ; preds = %if.end20.i.i, %while.body14.lr.ph.i.i
  %str.addr.139.i.i = phi ptr [ %39, %while.body14.lr.ph.i.i ], [ %incdec.ptr21.i.i, %if.end20.i.i ]
  %call16.i.i = call i32 @strncmp(ptr noundef %46, ptr noundef nonnull %str.addr.139.i.i, i64 noundef %conv15.i.i) #25
...
if.end20.i.i:                                     ; preds = %while.body14.i.i
  ...
  %50 = load i8, ptr %incdec.ptr21.i.i, align 1, !tbaa !21
  %tobool13.not.i.i = icmp eq i8 %50, 0
  br i1 %tobool13.not.i.i, label %if.end68.i, label %while.body14.i.i, !llvm.loop !188
...
if.then47.i:                                      ; preds = %land.rhs.i.i, %find_substr.exit.i, %while.end.i.i
  ...
  %tobool48.not.i = icmp eq ptr %best_sn.1485.i, null
  %cmp49.i = icmp ult ptr %retval.0.i470.i, %best_s.1484.i
...
land.lhs.true.i:                                  ; preds = %if.then47.i
  %cmp52.i = icmp eq ptr %retval.0.i470.i, %best_s.1484.i
  br i1 %cmp52.i, label %land.lhs.true53.i, label %if.end68.i

land.lhs.true53.i:                                ; preds = %land.lhs.true.i
  %depth.i = getelementptr inbounds %struct.SNode, ptr %best_sn.1485.i, i64 0, i32 4
  %51 = load i32, ptr %depth.i, align 8, !tbaa !189
  %52 = load i32, ptr %depth54.i, align 8, !tbaa !189
  %cmp55.i = icmp ult i32 %51, %52
  br i1 %cmp55.i, label %if.then66.i, label %lor.lhs.false56.i

lor.lhs.false56.i:                                ; preds = %land.lhs.true53.i
  %cmp59.i = icmp eq i32 %51, %52
  br i1 %cmp59.i, label %land.lhs.true60.i, label %if.end68.i

land.lhs.true60.i:                                ; preds = %lor.lhs.false56.i
  %53 = load i16, ptr %best_er.1482.i, align 8, !tbaa !190
  %54 = load i16, ptr %arrayidx44.i, align 8, !tbaa !190
  %cmp64.i = icmp ult i16 %53, %54
...
if.end68.i:                                       ; preds = %if.end20.i.i, %if.then66.i, %land.lhs.true60.i, %lor.lhs.false56.i, %land.lhs.true.i, %while.end.i.i, %while.cond12.preheader.i.i
  %best_er.2.i = phi ptr [ %arrayidx44.i, %if.then66.i ], [ %best_er.1482.i, %land.lhs.true60.i ], [ %best_er.1482.i, %lor.lhs.false56.i ], [ %best_er.1482.i, %land.lhs.true.i ], [ %best_er.1482.i, %while.end.i.i ], [ %best_er.1482.i, %while.cond12.preheader.i.i ], [ %best_er.1482.i, %if.end20.i.i ]
  %best_s.2.i = phi ptr [ %retval.0.i470.i, %if.then66.i ], [ %best_s.1484.i, %land.lhs.true60.i ], [ %best_s.1484.i, %lor.lhs.false56.i ], [ %best_s.1484.i, %land.lhs.true.i ], [ %best_s.1484.i, %while.end.i.i ], [ %best_s.1484.i, %while.cond12.preheader.i.i ], [ %best_s.1484.i, %if.end20.i.i ]
  %best_sn.2.i = phi ptr [ %41, %if.then66.i ], [ %best_sn.1485.i, %land.lhs.true60.i ], [ %best_sn.1485.i, %lor.lhs.false56.i ], [ %best_sn.1485.i, %land.lhs.true.i ], [ %best_sn.1485.i, %while.end.i.i ], [ %best_sn.1485.i, %while.cond12.preheader.i.i ], [ %best_sn.1485.i, %if.end20.i.i ]
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1
  %exitcond.not.i = icmp eq i64 %indvars.iv.next.i, %wide.trip.count.i
  br i1 %exitcond.not.i, label %if.end72.i, label %for.body40.i, !llvm.loop !191

if.end72.i:                                       ; preds = %if.end68.i, %while.body.i
  %best_er.3.i = phi ptr [ %best_er.0499.i, %while.body.i ], [ %best_er.2.i, %if.end68.i ]
  %best_s.3.i = phi ptr [ %best_s.0501.i, %while.body.i ], [ %best_s.2.i, %if.end68.i ]
  %best_sn.3.i = phi ptr [ %best_sn.0502.i, %while.body.i ], [ %best_sn.2.i, %if.end68.i ]
  %zns.i = getelementptr inbounds %struct.SNode, ptr %41, i64 0, i32 6
  %55 = load i32, ptr %zns.i, align 8, !tbaa !158
  %cmp75493.not.i = icmp eq i32 %55, 0
  br i1 %cmp75493.not.i, label %while.cond.loopexit.i, label %for.body77.lr.ph.i

for.body77.lr.ph.i:                               ; preds = %if.end72.i
  %v79.i = getelementptr inbounds %struct.SNode, ptr %41, i64 0, i32 6, i32 2
  %56 = load ptr, ptr %v79.i, align 8, !tbaa !159
  %wide.trip.count526.i = zext i32 %55 to i64
  br label %for.body77.i

for.body77.i:                                     ; preds = %for.inc112.i, %for.body77.lr.ph.i
  %indvars.iv523.i = phi i64 [ 0, %for.body77.lr.ph.i ], [ %indvars.iv.next524.i, %for.inc112.i ]
  %tail.3494.i = phi i32 [ %tail.2498.i, %for.body77.lr.ph.i ], [ %tail.6.i, %for.inc112.i ]
  %arrayidx81.i = getelementptr inbounds ptr, ptr %56, i64 %indvars.iv523.i
  %57 = load ptr, ptr %arrayidx81.i, align 8, !tbaa !16
  %tobool82.not.i = icmp eq ptr %57, null
  br i1 %tobool82.not.i, label %for.inc112.i, label %for.cond84.preheader.i

for.cond84.preheader.i:                           ; preds = %for.body77.i
  %sns.i199 = getelementptr inbounds %struct.ZNode, ptr %57, i64 0, i32 1
  %58 = load i32, ptr %sns.i199, align 8, !tbaa !171
  %cmp90489.not.i = icmp eq i32 %58, 0
  br i1 %cmp90489.not.i, label %for.inc112.i, label %for.body92.lr.ph.i

for.body92.lr.ph.i:                               ; preds = %for.cond84.preheader.i
  %v101.i = getelementptr inbounds %struct.ZNode, ptr %57, i64 0, i32 1, i32 2
  %wide.trip.count521.i = zext i32 %58 to i64
  %xtraiter = and i64 %wide.trip.count521.i, 1
  %59 = icmp eq i32 %58, 1
  br i1 %59, label %for.inc112.i.loopexit.unr-lcssa, label %for.body92.lr.ph.i.new

for.body92.lr.ph.i.new:                           ; preds = %for.body92.lr.ph.i
  %unroll_iter = and i64 %wide.trip.count521.i, 4294967294
  br label %for.body92.i

for.body92.i:                                     ; preds = %for.inc108.i.1, %for.body92.lr.ph.i.new
  %indvars.iv518.i = phi i64 [ 0, %for.body92.lr.ph.i.new ], [ %indvars.iv.next519.i.1, %for.inc108.i.1 ]
  %tail.4490.i = phi i32 [ %tail.3494.i, %for.body92.lr.ph.i.new ], [ %tail.5.i.1, %for.inc108.i.1 ]
  %niter = phi i64 [ 0, %for.body92.lr.ph.i.new ], [ %niter.next.1, %for.inc108.i.1 ]
  %cmp93.i = icmp slt i32 %tail.4490.i, 9999
  br i1 %cmp93.i, label %if.then95.i, label %for.inc108.i

if.then95.i:                                      ; preds = %for.body92.i
  %60 = load ptr, ptr %v101.i, align 8, !tbaa !172
  %arrayidx103.i = getelementptr inbounds ptr, ptr %60, i64 %indvars.iv518.i
  %61 = load ptr, ptr %arrayidx103.i, align 8, !tbaa !16
  %inc104.i = add nsw i32 %tail.4490.i, 1
  %idxprom105.i = sext i32 %tail.4490.i to i64
  %arrayidx106.i = getelementptr inbounds ptr, ptr %call.i196, i64 %idxprom105.i
  store ptr %61, ptr %arrayidx106.i, align 8, !tbaa !16
  br label %for.inc108.i

for.inc108.i:                                     ; preds = %if.then95.i, %for.body92.i
  %tail.5.i = phi i32 [ %inc104.i, %if.then95.i ], [ %tail.4490.i, %for.body92.i ]
...
if.then95.i.1:                                    ; preds = %for.inc108.i
  %indvars.iv.next519.i = or i64 %indvars.iv518.i, 1
  %62 = load ptr, ptr %v101.i, align 8, !tbaa !172
  %arrayidx103.i.1 = getelementptr inbounds ptr, ptr %62, i64 %indvars.iv.next519.i
  %63 = load ptr, ptr %arrayidx103.i.1, align 8, !tbaa !16
  ...
  store ptr %63, ptr %arrayidx106.i.1, align 8, !tbaa !16
...
for.inc108.i.1:                                   ; preds = %if.then95.i.1, %for.inc108.i
  ...
  %indvars.iv.next519.i.1 = add nuw nsw i64 %indvars.iv518.i, 2
  %niter.next.1 = add i64 %niter, 2
  %niter.ncmp.1 = icmp eq i64 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %for.inc112.i.loopexit.unr-lcssa, label %for.body92.i, !llvm.loop !192
...
for.inc112.i.loopexit.unr-lcssa:                  ; preds = %for.inc108.i.1, %for.body92.lr.ph.i
  ...
  %indvars.iv518.i.unr = phi i64 [ 0, %for.body92.lr.ph.i ], [ %indvars.iv.next519.i.1, %for.inc108.i.1 ]
  %tail.4490.i.unr = phi i32 [ %tail.3494.i, %for.body92.lr.ph.i ], [ %tail.5.i.1, %for.inc108.i.1 ]
...
for.body92.i.epil:                                ; preds = %for.inc112.i.loopexit.unr-lcssa
  %cmp93.i.epil = icmp slt i32 %tail.4490.i.unr, 9999
  br i1 %cmp93.i.epil, label %if.then95.i.epil, label %for.inc112.i

if.then95.i.epil:                                 ; preds = %for.body92.i.epil
  %64 = load ptr, ptr %v101.i, align 8, !tbaa !172
  %arrayidx103.i.epil = getelementptr inbounds ptr, ptr %64, i64 %indvars.iv518.i.unr
  %65 = load ptr, ptr %arrayidx103.i.epil, align 8, !tbaa !16
  %inc104.i.epil = add nsw i32 %tail.4490.i.unr, 1
  %idxprom105.i.epil = sext i32 %tail.4490.i.unr to i64
  %arrayidx106.i.epil = getelementptr inbounds ptr, ptr %call.i196, i64 %idxprom105.i.epil
  store ptr %65, ptr %arrayidx106.i.epil, align 8, !tbaa !16
...
for.inc112.i:                                     ; preds = %for.inc112.i.loopexit.unr-lcssa, %if.then95.i.epil, %for.body92.i.epil, %for.cond84.preheader.i, %for.body77.i
  %tail.6.i = phi i32 [ %tail.3494.i, %for.body77.i ], [ %tail.3494.i, %for.cond84.preheader.i ], [ %tail.5.i.lcssa.ph, %for.inc112.i.loopexit.unr-lcssa ], [ %inc104.i.epil, %if.then95.i.epil ], [ %tail.4490.i.unr, %for.body92.i.epil ]
  ...
  br i1 %exitcond527.not.i, label %while.cond.loopexit.i, label %for.body77.i, !llvm.loop !193
...
if.then116.i:                                     ; preds = %while.end.i
  ...
  %66 = load ptr, ptr %v121.i, align 8, !tbaa !145
...
if.then157.i:                                     ; preds = %if.else153.i
  %inc162.i = add i32 %68, 1
  store i32 %inc162.i, ptr %error_reductions.i, align 8, !tbaa !142
  %idxprom163.i = zext i32 %68 to i64
  %arrayidx164.i = getelementptr inbounds ptr, ptr %66, i64 %idxprom163.i
...
do.end.i:                                         ; preds = %if.end167.i, %if.then157.i, %if.then144.i, %if.then123.i
  %69 = load i16, ptr %best_er.3.i, align 8, !tbaa !190
  %add.i = add i16 %69, 1
  store i16 %add.i, ptr %calloc.i, align 8, !tbaa !194
  %symbol.i = getelementptr inbounds %struct.D_ErrorRecoveryHint, ptr %best_er.3.i, i64 0, i32 1
  %70 = load i16, ptr %symbol.i, align 2, !tbaa !195
  %symbol172.i = getelementptr inbounds %struct.D_Reduction, ptr %calloc.i, i64 0, i32 1
  store i16 %70, ptr %symbol172.i, align 2, !tbaa !196
  %71 = load ptr, ptr %best_loc.i, align 8, !tbaa !96
  %cmp5.i.i = icmp ult ptr %71, %best_s.3.i
...
for.body.preheader.i.i:                           ; preds = %do.end.i
  ...
  %s8.i.i = ptrtoint ptr %71 to i64
  %72 = sub i64 %e7.i.i, %s8.i.i
  %scevgep.i.i = getelementptr i8, ptr %71, i64 %72
  %line174.promoted.i = load i32, ptr %line174.i, align 8, !tbaa !50
  %73 = xor i64 %s8.i.i, -1
  %74 = add i64 %73, %e7.i.i
  %xtraiter391 = and i64 %72, 3
  %lcmp.mod392.not = icmp eq i64 %xtraiter391, 0
  br i1 %lcmp.mod392.not, label %for.body.i.i.prol.loopexit, label %for.body.i.i.prol

for.body.i.i.prol:                                ; preds = %for.body.preheader.i.i, %for.inc.i.i.prol
  %inc.i507.i.prol = phi i32 [ %inc.i506.i.prol, %for.inc.i.i.prol ], [ %line174.promoted.i, %for.body.preheader.i.i ]
  %s.addr.06.i.i.prol = phi ptr [ %incdec.ptr.i461.i.prol, %for.inc.i.i.prol ], [ %71, %for.body.preheader.i.i ]
  %prol.iter = phi i64 [ %prol.iter.next, %for.inc.i.i.prol ], [ 0, %for.body.preheader.i.i ]
  %75 = load i8, ptr %s.addr.06.i.i.prol, align 1, !tbaa !21
  %cmp1.i.i.prol = icmp eq i8 %75, 10
  br i1 %cmp1.i.i.prol, label %if.then.i.i.prol, label %for.inc.i.i.prol

if.then.i.i.prol:                                 ; preds = %for.body.i.i.prol
  %inc.i.i.prol = add nsw i32 %inc.i507.i.prol, 1
...
for.inc.i.i.prol:                                 ; preds = %if.then.i.i.prol, %for.body.i.i.prol
  %inc.i506.i.prol = phi i32 [ %inc.i.i.prol, %if.then.i.i.prol ], [ %inc.i507.i.prol, %for.body.i.i.prol ]
  %incdec.ptr.i461.i.prol = getelementptr inbounds i8, ptr %s.addr.06.i.i.prol, i64 1
  %prol.iter.next = add i64 %prol.iter, 1
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter391
  br i1 %prol.iter.cmp.not, label %for.body.i.i.prol.loopexit, label %for.body.i.i.prol, !llvm.loop !197

for.body.i.i.prol.loopexit:                       ; preds = %for.inc.i.i.prol, %for.body.preheader.i.i
  %inc.i507.i.unr = phi i32 [ %line174.promoted.i, %for.body.preheader.i.i ], [ %inc.i506.i.prol, %for.inc.i.i.prol ]
  %s.addr.06.i.i.unr = phi ptr [ %71, %for.body.preheader.i.i ], [ %incdec.ptr.i461.i.prol, %for.inc.i.i.prol ]
  %76 = icmp ult i64 %74, 3
  br i1 %76, label %update_line.exit.i, label %for.body.i.i

for.body.i.i:                                     ; preds = %for.body.i.i.prol.loopexit, %for.inc.i.i.3
  %inc.i507.i = phi i32 [ %inc.i506.i.3, %for.inc.i.i.3 ], [ %inc.i507.i.unr, %for.body.i.i.prol.loopexit ]
  %s.addr.06.i.i = phi ptr [ %incdec.ptr.i461.i.3, %for.inc.i.i.3 ], [ %s.addr.06.i.i.unr, %for.body.i.i.prol.loopexit ]
  %77 = load i8, ptr %s.addr.06.i.i, align 1, !tbaa !21
  %cmp1.i.i = icmp eq i8 %77, 10
  br i1 %cmp1.i.i, label %if.then.i.i, label %for.inc.i.i

if.then.i.i:                                      ; preds = %for.body.i.i
  %inc.i.i = add nsw i32 %inc.i507.i, 1
  store i32 %inc.i.i, ptr %line174.i, align 8, !tbaa !50
  br label %for.inc.i.i

for.inc.i.i:                                      ; preds = %if.then.i.i, %for.body.i.i
  %inc.i506.i = phi i32 [ %inc.i.i, %if.then.i.i ], [ %inc.i507.i, %for.body.i.i ]
  %incdec.ptr.i461.i = getelementptr inbounds i8, ptr %s.addr.06.i.i, i64 1
  %78 = load i8, ptr %incdec.ptr.i461.i, align 1, !tbaa !21
  %cmp1.i.i.1 = icmp eq i8 %78, 10
  br i1 %cmp1.i.i.1, label %if.then.i.i.1, label %for.inc.i.i.1

if.then.i.i.1:                                    ; preds = %for.inc.i.i
  %inc.i.i.1 = add nsw i32 %inc.i506.i, 1
  store i32 %inc.i.i.1, ptr %line174.i, align 8, !tbaa !50
  br label %for.inc.i.i.1

for.inc.i.i.1:                                    ; preds = %if.then.i.i.1, %for.inc.i.i
  %inc.i506.i.1 = phi i32 [ %inc.i.i.1, %if.then.i.i.1 ], [ %inc.i506.i, %for.inc.i.i ]
  %incdec.ptr.i461.i.1 = getelementptr inbounds i8, ptr %s.addr.06.i.i, i64 2
  %79 = load i8, ptr %incdec.ptr.i461.i.1, align 1, !tbaa !21
  %cmp1.i.i.2 = icmp eq i8 %79, 10
  br i1 %cmp1.i.i.2, label %if.then.i.i.2, label %for.inc.i.i.2

if.then.i.i.2:                                    ; preds = %for.inc.i.i.1
  %inc.i.i.2 = add nsw i32 %inc.i506.i.1, 1
  store i32 %inc.i.i.2, ptr %line174.i, align 8, !tbaa !50
  br label %for.inc.i.i.2

for.inc.i.i.2:                                    ; preds = %if.then.i.i.2, %for.inc.i.i.1
  %inc.i506.i.2 = phi i32 [ %inc.i.i.2, %if.then.i.i.2 ], [ %inc.i506.i.1, %for.inc.i.i.1 ]
  %incdec.ptr.i461.i.2 = getelementptr inbounds i8, ptr %s.addr.06.i.i, i64 3
  %80 = load i8, ptr %incdec.ptr.i461.i.2, align 1, !tbaa !21
  %cmp1.i.i.3 = icmp eq i8 %80, 10
  br i1 %cmp1.i.i.3, label %if.then.i.i.3, label %for.inc.i.i.3

if.then.i.i.3:                                    ; preds = %for.inc.i.i.2
  %inc.i.i.3 = add nsw i32 %inc.i506.i.2, 1
  store i32 %inc.i.i.3, ptr %line174.i, align 8, !tbaa !50
  br label %for.inc.i.i.3

for.inc.i.i.3:                                    ; preds = %if.then.i.i.3, %for.inc.i.i.2
  %inc.i506.i.3 = phi i32 [ %inc.i.i.3, %if.then.i.i.3 ], [ %inc.i506.i.2, %for.inc.i.i.2 ]
  ...
  br i1 %exitcond.not.i.i.3, label %update_line.exit.i, label %for.body.i.i, !llvm.loop !199
...
update_line.exit.i:                               ; preds = %for.body.i.i.prol.loopexit, %for.inc.i.i.3, %do.end.i
  ...
  %81 = load ptr, ptr %v177.i, align 8, !tbaa !159
  %82 = load ptr, ptr %81, align 8, !tbaa !16
  %83 = load ptr, ptr %82, align 8, !tbaa !160
  %white_space.i = getelementptr inbounds %struct.PNode, ptr %83, i64 0, i32 19, i32 5
  %84 = load ptr, ptr %white_space.i, align 8, !tbaa !200
  %globals.i = getelementptr inbounds %struct.PNode, ptr %83, i64 0, i32 19, i32 6
  call void %84(ptr noundef nonnull %p, ptr noundef nonnull %best_loc.i, ptr noundef nonnull %globals.i) #23
  %refcount.i = getelementptr inbounds %struct.SNode, ptr %best_sn.3.i, i64 0, i32 7
  %85 = load i32, ptr %refcount.i, align 8, !tbaa !101
  %inc181.i = add i32 %85, 1
  store i32 %inc181.i, ptr %refcount.i, align 8, !tbaa !101
  %86 = load ptr, ptr %best_loc.i, align 8, !tbaa !96
  %call187.i = call fastcc ptr @add_PNode(ptr noundef nonnull %p, i32 noundef 0, ptr noundef nonnull %loc1, ptr noundef %86, ptr noundef %83, ptr noundef null, ptr noundef null, ptr noundef null)
  %87 = load ptr, ptr %best_sn.3.i, align 8, !tbaa !43
  %initial_scope.i = getelementptr inbounds %struct.PNode, ptr %call187.i, i64 0, i32 17
  %88 = load ptr, ptr %initial_scope.i, align 8, !tbaa !56
  %initial_globals.i = getelementptr inbounds %struct.PNode, ptr %call187.i, i64 0, i32 18
  %89 = load ptr, ptr %initial_globals.i, align 8, !tbaa !57
  %call189.i = call fastcc ptr @new_SNode(ptr noundef nonnull %p, ptr noundef %87, ptr noundef nonnull %best_loc.i, ptr noundef %88, ptr noundef %89)
  ...
  %90 = load ptr, ptr %free_znodes.i, align 8, !tbaa !138
  %tobool.not.i462.i = icmp eq ptr %90, null
...
if.else.i.i:                                      ; preds = %update_line.exit.i
  ...
  store ptr %91, ptr %free_znodes.i, align 8, !tbaa !138
  br label %new_ZNode.exit.i

new_ZNode.exit.i:                                 ; preds = %if.else.i.i, %if.then.i464.i
  %z.0.i.i = phi ptr [ %90, %if.else.i.i ], [ %call.i463.i, %if.then.i464.i ]
  ...
  %92 = load i32, ptr %refcount193.i, align 8, !tbaa !64
  %inc194.i = add i32 %92, 1
  store i32 %inc194.i, ptr %refcount193.i, align 8, !tbaa !64
  %93 = load ptr, ptr %v.i.i, align 8, !tbaa !172
  %tobool200.not.i = icmp eq ptr %93, null
...
if.then201.i:                                     ; preds = %new_ZNode.exit.i
  ...
  %inc209.i = add i32 %94, 1
  store i32 %inc209.i, ptr %sns.i.i, align 8, !tbaa !171
  %idxprom210.i = zext i32 %94 to i64
...
if.then239.i:                                     ; preds = %if.else234.i
  %inc244.i = add i32 %95, 1
  store i32 %inc244.i, ptr %sns.i.i, align 8, !tbaa !171
  %idxprom245.i = zext i32 %95 to i64
  %arrayidx246.i = getelementptr inbounds ptr, ptr %93, i64 %idxprom245.i
...
do.end252.i:                                      ; preds = %if.end249.i, %if.then239.i, %if.then225.i, %if.then201.i
  store ptr %z.0.i.i, ptr %call118.i, align 8, !tbaa !201
  ...
  %96 = load i32, ptr %refcount.i, align 8, !tbaa !101
  %inc255.i = add i32 %96, 1
  ...
  store ptr %calloc.i, ptr %reduction.i, align 8, !tbaa !202
  %new_snode.i = getelementptr inbounds %struct.Reduction, ptr %call118.i, i64 0, i32 3
  store ptr null, ptr %new_snode.i, align 8, !tbaa !203
  ...
  %97 = load ptr, ptr %t, align 8, !tbaa !23
  %98 = load i32, ptr %97, align 8, !tbaa !204
  %cmp259513.not.i = icmp eq i32 %98, 0
  br i1 %cmp259513.not.i, label %for.end298.i, label %for.body261.lr.ph.i

for.body261.lr.ph.i:                              ; preds = %do.end252.i
  %99 = load ptr, ptr %snode_hash.i, align 8, !tbaa !123
  %wide.trip.count539.i = zext i32 %98 to i64
  br label %for.body261.i

for.body261.i:                                    ; preds = %for.inc296.i, %for.body261.lr.ph.i
  %indvars.iv536.i = phi i64 [ 0, %for.body261.lr.ph.i ], [ %indvars.iv.next537.i, %for.inc296.i ]
  %arrayidx265.i = getelementptr inbounds ptr, ptr %99, i64 %indvars.iv536.i
  %sn.1510.i = load ptr, ptr %arrayidx265.i, align 8, !tbaa !16
  %tobool267.not511.i = icmp eq ptr %sn.1510.i, null
  br i1 %tobool267.not511.i, label %for.inc296.i, label %for.cond269.preheader.i

for.cond269.preheader.i:                          ; preds = %for.body261.i, %for.inc294.i
  %sn.1512.i = phi ptr [ %sn.1.i, %for.inc294.i ], [ %sn.1510.i, %for.body261.i ]
  %zns270.i = getelementptr inbounds %struct.SNode, ptr %sn.1512.i, i64 0, i32 6
  %100 = load i32, ptr %zns270.i, align 8, !tbaa !158
  %cmp272508.not.i = icmp eq i32 %100, 0
  br i1 %cmp272508.not.i, label %for.inc294.i, label %for.body274.lr.ph.i

for.body274.lr.ph.i:                              ; preds = %for.cond269.preheader.i
  %v276.i = getelementptr inbounds %struct.SNode, ptr %sn.1512.i, i64 0, i32 6, i32 2
  %101 = load ptr, ptr %v276.i, align 8, !tbaa !159
  %wide.trip.count534.i = zext i32 %100 to i64
  %xtraiter393 = and i64 %wide.trip.count534.i, 1
  %102 = icmp eq i32 %100, 1
  br i1 %102, label %for.inc294.i.loopexit.unr-lcssa, label %for.body274.lr.ph.i.new

for.body274.lr.ph.i.new:                          ; preds = %for.body274.lr.ph.i
  %unroll_iter395 = and i64 %wide.trip.count534.i, 4294967294
  br label %for.body274.i

for.body274.i:                                    ; preds = %for.inc291.i.1, %for.body274.lr.ph.i.new
  %indvars.iv531.i = phi i64 [ 0, %for.body274.lr.ph.i.new ], [ %indvars.iv.next532.i.1, %for.inc291.i.1 ]
  %niter396 = phi i64 [ 0, %for.body274.lr.ph.i.new ], [ %niter396.next.1, %for.inc291.i.1 ]
  %arrayidx278.i = getelementptr inbounds ptr, ptr %101, i64 %indvars.iv531.i
  %103 = load ptr, ptr %arrayidx278.i, align 8, !tbaa !16
  %tobool279.not.i = icmp eq ptr %103, null
...
if.then280.i:                                     ; preds = %for.body274.i
  ...
  %reduction282.i = getelementptr inbounds %struct.PNode, ptr %104, i64 0, i32 4
  %105 = load ptr, ptr %reduction282.i, align 8, !tbaa !75
  %cmp283.i = icmp eq ptr %105, %calloc.i
  br i1 %cmp283.i, label %if.then285.i, label %for.inc291.i

if.then285.i:                                     ; preds = %if.then280.i
  %evaluated.i = getelementptr inbounds %struct.PNode, ptr %104, i64 0, i32 9
  store i8 1, ptr %evaluated.i, align 4, !tbaa !205
  %error_recovery288.i = getelementptr inbounds %struct.PNode, ptr %104, i64 0, i32 10
...
for.inc291.i:                                     ; preds = %if.then285.i, %if.then280.i, %for.body274.i
  %indvars.iv.next532.i = or i64 %indvars.iv531.i, 1
  %arrayidx278.i.1 = getelementptr inbounds ptr, ptr %101, i64 %indvars.iv.next532.i
  %106 = load ptr, ptr %arrayidx278.i.1, align 8, !tbaa !16
  %tobool279.not.i.1 = icmp eq ptr %106, null
...
if.then280.i.1:                                   ; preds = %for.inc291.i
  ...
  %reduction282.i.1 = getelementptr inbounds %struct.PNode, ptr %107, i64 0, i32 4
  %108 = load ptr, ptr %reduction282.i.1, align 8, !tbaa !75
  %cmp283.i.1 = icmp eq ptr %108, %calloc.i
  br i1 %cmp283.i.1, label %if.then285.i.1, label %for.inc291.i.1

if.then285.i.1:                                   ; preds = %if.then280.i.1
  %evaluated.i.1 = getelementptr inbounds %struct.PNode, ptr %107, i64 0, i32 9
  store i8 1, ptr %evaluated.i.1, align 4, !tbaa !205
  %error_recovery288.i.1 = getelementptr inbounds %struct.PNode, ptr %107, i64 0, i32 10
...
for.inc291.i.1:                                   ; preds = %if.then285.i.1, %if.then280.i.1, %for.inc291.i
  %indvars.iv.next532.i.1 = add nuw nsw i64 %indvars.iv531.i, 2
  %niter396.next.1 = add i64 %niter396, 2
  %niter396.ncmp.1 = icmp eq i64 %niter396.next.1, %unroll_iter395
  br i1 %niter396.ncmp.1, label %for.inc294.i.loopexit.unr-lcssa, label %for.body274.i, !llvm.loop !206

for.inc294.i.loopexit.unr-lcssa:                  ; preds = %for.inc291.i.1, %for.body274.lr.ph.i
  %indvars.iv531.i.unr = phi i64 [ 0, %for.body274.lr.ph.i ], [ %indvars.iv.next532.i.1, %for.inc291.i.1 ]
  %lcmp.mod394.not = icmp eq i64 %xtraiter393, 0
  br i1 %lcmp.mod394.not, label %for.inc294.i, label %for.body274.i.epil

for.body274.i.epil:                               ; preds = %for.inc294.i.loopexit.unr-lcssa
  %arrayidx278.i.epil = getelementptr inbounds ptr, ptr %101, i64 %indvars.iv531.i.unr
  %109 = load ptr, ptr %arrayidx278.i.epil, align 8, !tbaa !16
  %tobool279.not.i.epil = icmp eq ptr %109, null
...
if.then280.i.epil:                                ; preds = %for.body274.i.epil
  ...
  %reduction282.i.epil = getelementptr inbounds %struct.PNode, ptr %110, i64 0, i32 4
  %111 = load ptr, ptr %reduction282.i.epil, align 8, !tbaa !75
  %cmp283.i.epil = icmp eq ptr %111, %calloc.i
  br i1 %cmp283.i.epil, label %if.then285.i.epil, label %for.inc294.i

if.then285.i.epil:                                ; preds = %if.then280.i.epil
  %evaluated.i.epil = getelementptr inbounds %struct.PNode, ptr %110, i64 0, i32 9
  store i8 1, ptr %evaluated.i.epil, align 4, !tbaa !205
  %error_recovery288.i.epil = getelementptr inbounds %struct.PNode, ptr %110, i64 0, i32 10
...
for.inc294.i:                                     ; preds = %for.inc294.i.loopexit.unr-lcssa, %if.then285.i.epil, %if.then280.i.epil, %for.body274.i.epil, %for.cond269.preheader.i
  %bucket_next.i = getelementptr inbounds %struct.SNode, ptr %sn.1512.i, i64 0, i32 8
  %sn.1.i = load ptr, ptr %bucket_next.i, align 8, !tbaa !16
  %tobool267.not.i = icmp eq ptr %sn.1.i, null
  br i1 %tobool267.not.i, label %for.inc296.i, label %for.cond269.preheader.i, !llvm.loop !207
...
for.inc296.i:                                     ; preds = %for.inc294.i, %for.body261.i
  ...
  br i1 %exitcond540.not.i, label %for.end298.i, label %for.body261.i, !llvm.loop !208

for.end298.i:                                     ; preds = %for.inc296.i, %do.end252.i
  %112 = load ptr, ptr %shifts_todo, align 8, !tbaa !126
  %tobool299.not.i = icmp eq ptr %112, null
  br i1 %tobool299.not.i, label %lor.lhs.false300.i, label %error_recovery.exit

lor.lhs.false300.i:                               ; preds = %for.end298.i
  %113 = load ptr, ptr %reductions_todo, align 8, !tbaa !124
  %tobool301.not.i = icmp eq ptr %113, null
...
if.else60:                                        ; preds = %while.end
  %114 = load i32, ptr %dont_compare_stacks, align 4, !tbaa !209
  %tobool62.not = icmp eq i32 %114, 0
...
land.lhs.true63:                                  ; preds = %if.else60
  ...
  %115 = load ptr, ptr %next65, align 8, !tbaa !132
  %tobool66.not = icmp eq ptr %115, null
  br i1 %tobool66.not, label %if.end69, label %if.then67

if.then67:                                        ; preds = %land.lhs.true63
  %116 = load ptr, ptr %26, align 8, !tbaa !134
  %loc.i202 = getelementptr inbounds %struct.SNode, ptr %116, i64 0, i32 3
  %117 = load ptr, ptr %loc.i202, align 8, !tbaa !173
  br label %land.rhs.i

land.rhs.i:                                       ; preds = %for.inc82.i, %if.then67
  %a.0167.i = phi ptr [ %26, %if.then67 ], [ %170, %for.inc82.i ]
  %al.0166.i = phi ptr [ %shifts_todo, %if.then67 ], [ %next83.i, %for.inc82.i ]
  %118 = load ptr, ptr %a.0167.i, align 8, !tbaa !134
  %loc3.i204 = getelementptr inbounds %struct.SNode, ptr %118, i64 0, i32 3
  %119 = load ptr, ptr %loc3.i204, align 8, !tbaa !173
  %cmp.i205 = icmp eq ptr %119, %117
  br i1 %cmp.i205, label %for.body.i206, label %if.end69.loopexit

for.body.i206:                                    ; preds = %land.rhs.i
  %zns.i.i = getelementptr inbounds %struct.SNode, ptr %118, i64 0, i32 6
  %120 = load i32, ptr %zns.i.i, align 8, !tbaa !158
  %cmp.not.i.i = icmp eq i32 %120, 1
  br i1 %cmp.not.i.i, label %if.end.i.i, label %for.inc82.i

if.end.i.i:                                       ; preds = %for.body.i206
  %v.i.i207 = getelementptr inbounds %struct.SNode, ptr %118, i64 0, i32 6, i32 2
  %121 = load ptr, ptr %v.i.i207, align 8, !tbaa !159
  %122 = load ptr, ptr %121, align 8, !tbaa !16
  %123 = load ptr, ptr %122, align 8, !tbaa !160
  %op_assoc.i.i = getelementptr inbounds %struct.PNode, ptr %123, i64 0, i32 2
  %124 = load i32, ptr %op_assoc.i.i, align 8, !tbaa !210
  %cmp2.i.i = icmp eq i32 %124, 10
  br i1 %cmp2.i.i, label %if.then3.i.i, label %if.end19.i.i

if.then3.i.i:                                     ; preds = %if.end.i.i
  %sns.i.i208 = getelementptr inbounds %struct.ZNode, ptr %122, i64 0, i32 1
  %125 = load i32, ptr %sns.i.i208, align 8, !tbaa !171
  %cmp5.not.i.i209 = icmp eq i32 %125, 1
  br i1 %cmp5.not.i.i209, label %if.end7.i.i, label %for.inc82.i

if.end7.i.i:                                      ; preds = %if.then3.i.i
  %v9.i.i = getelementptr inbounds %struct.ZNode, ptr %122, i64 0, i32 1, i32 2
  %126 = load ptr, ptr %v9.i.i, align 8, !tbaa !172
  %127 = load ptr, ptr %126, align 8, !tbaa !16
  %zns11.i.i = getelementptr inbounds %struct.SNode, ptr %127, i64 0, i32 6
  %128 = load i32, ptr %zns11.i.i, align 8, !tbaa !158
  %cmp13.not.i.i = icmp eq i32 %128, 1
  br i1 %cmp13.not.i.i, label %if.end15.i.i, label %for.inc82.i

if.end15.i.i:                                     ; preds = %if.end7.i.i
  %v17.i.i = getelementptr inbounds %struct.SNode, ptr %127, i64 0, i32 6, i32 2
  %129 = load ptr, ptr %v17.i.i, align 8, !tbaa !159
  %130 = load ptr, ptr %129, align 8, !tbaa !16
  %.pre.i.i210 = load ptr, ptr %130, align 8, !tbaa !160
  %op_assoc21.phi.trans.insert.i.i = getelementptr inbounds %struct.PNode, ptr %.pre.i.i210, i64 0, i32 2
  %.pre31.i.i = load i32, ptr %op_assoc21.phi.trans.insert.i.i, align 8, !tbaa !210
  br label %if.end19.i.i

if.end19.i.i:                                     ; preds = %if.end15.i.i, %if.end.i.i
  %131 = phi ptr [ %.pre.i.i210, %if.end15.i.i ], [ %123, %if.end.i.i ]
  %132 = phi i32 [ %.pre31.i.i, %if.end15.i.i ], [ %124, %if.end.i.i ]
  %z.0.i.i211 = phi ptr [ %130, %if.end15.i.i ], [ %122, %if.end.i.i ]
  %and.i.i = and i32 %132, 16
...
if.end.i214:                                      ; preds = %if.end19.i.i
  %next.i213 = getelementptr inbounds %struct.Shift, ptr %a.0167.i, i64 0, i32 1
  %133 = load ptr, ptr %next.i213, align 8, !tbaa !132
  %tobool9.not162.i = icmp eq ptr %133, null
  br i1 %tobool9.not162.i, label %for.inc82.i, label %land.rhs10.lr.ph.i
...
land.rhs10.lr.ph.i:                               ; preds = %if.end.i214
  ...
  %op_priority.i = getelementptr inbounds %struct.PNode, ptr %131, i64 0, i32 3
  br label %land.rhs10.i

land.rhs10.i:                                     ; preds = %for.inc.i220, %land.rhs10.lr.ph.i
  %b.0164.i = phi ptr [ %133, %land.rhs10.lr.ph.i ], [ %169, %for.inc.i220 ]
  %bl.0163.i = phi ptr [ %next.i213, %land.rhs10.lr.ph.i ], [ %next80.i, %for.inc.i220 ]
  %134 = load ptr, ptr %b.0164.i, align 8, !tbaa !134
  %loc12.i = getelementptr inbounds %struct.SNode, ptr %134, i64 0, i32 3
  %135 = load ptr, ptr %loc12.i, align 8, !tbaa !173
  %cmp14.i = icmp eq ptr %135, %117
  br i1 %cmp14.i, label %for.body16.i, label %for.inc82.i

for.body16.i:                                     ; preds = %land.rhs10.i
  %zns.i123.i = getelementptr inbounds %struct.SNode, ptr %134, i64 0, i32 6
  %136 = load i32, ptr %zns.i123.i, align 8, !tbaa !158
  %cmp.not.i124.i = icmp eq i32 %136, 1
  br i1 %cmp.not.i124.i, label %if.end.i128.i, label %for.inc.i220

if.end.i128.i:                                    ; preds = %for.body16.i
  %v.i125.i = getelementptr inbounds %struct.SNode, ptr %134, i64 0, i32 6, i32 2
  %137 = load ptr, ptr %v.i125.i, align 8, !tbaa !159
  %138 = load ptr, ptr %137, align 8, !tbaa !16
  %139 = load ptr, ptr %138, align 8, !tbaa !160
  %op_assoc.i126.i = getelementptr inbounds %struct.PNode, ptr %139, i64 0, i32 2
  %140 = load i32, ptr %op_assoc.i126.i, align 8, !tbaa !210
  %cmp2.i127.i = icmp eq i32 %140, 10
  br i1 %cmp2.i127.i, label %if.then3.i131.i, label %if.end19.i145.i

if.then3.i131.i:                                  ; preds = %if.end.i128.i
  %sns.i129.i = getelementptr inbounds %struct.ZNode, ptr %138, i64 0, i32 1
  %141 = load i32, ptr %sns.i129.i, align 8, !tbaa !171
  %cmp5.not.i130.i = icmp eq i32 %141, 1
  br i1 %cmp5.not.i130.i, label %if.end7.i135.i, label %for.inc.i220

if.end7.i135.i:                                   ; preds = %if.then3.i131.i
  %v9.i132.i = getelementptr inbounds %struct.ZNode, ptr %138, i64 0, i32 1, i32 2
  %142 = load ptr, ptr %v9.i132.i, align 8, !tbaa !172
  %143 = load ptr, ptr %142, align 8, !tbaa !16
  %zns11.i133.i = getelementptr inbounds %struct.SNode, ptr %143, i64 0, i32 6
  %144 = load i32, ptr %zns11.i133.i, align 8, !tbaa !158
  %cmp13.not.i134.i = icmp eq i32 %144, 1
  br i1 %cmp13.not.i134.i, label %if.end15.i140.i, label %for.inc.i220

if.end15.i140.i:                                  ; preds = %if.end7.i135.i
  %v17.i136.i = getelementptr inbounds %struct.SNode, ptr %143, i64 0, i32 6, i32 2
  %145 = load ptr, ptr %v17.i136.i, align 8, !tbaa !159
  %146 = load ptr, ptr %145, align 8, !tbaa !16
  %.pre.i137.i = load ptr, ptr %146, align 8, !tbaa !160
  %op_assoc21.phi.trans.insert.i138.i = getelementptr inbounds %struct.PNode, ptr %.pre.i137.i, i64 0, i32 2
  %.pre31.i139.i = load i32, ptr %op_assoc21.phi.trans.insert.i138.i, align 8, !tbaa !210
  br label %if.end19.i145.i

if.end19.i145.i:                                  ; preds = %if.end15.i140.i, %if.end.i128.i
  %147 = phi ptr [ %.pre.i137.i, %if.end15.i140.i ], [ %139, %if.end.i128.i ]
  %148 = phi i32 [ %.pre31.i139.i, %if.end15.i140.i ], [ %140, %if.end.i128.i ]
  %z.0.i141.i = phi ptr [ %146, %if.end15.i140.i ], [ %138, %if.end.i128.i ]
  %and.i142.i = and i32 %148, 16
...
if.end21.i:                                       ; preds = %if.end19.i145.i
  ...
  %149 = load i32, ptr %sns.i215, align 8, !tbaa !211
  %150 = load i32, ptr %sns22.i, align 8, !tbaa !211
  %cmp.not.i148.i = icmp eq i32 %149, %150
  br i1 %cmp.not.i148.i, label %for.cond.preheader.i.i, label %for.inc.i220

for.cond.preheader.i.i:                           ; preds = %if.end21.i
  %cmp335.not.i.i = icmp eq i32 %149, 0
  br i1 %cmp335.not.i.i, label %if.end26.i, label %for.cond4.preheader.lr.ph.split.us.i.i

for.cond4.preheader.lr.ph.split.us.i.i:           ; preds = %for.cond.preheader.i.i
  %v8.i.i = getelementptr inbounds %struct.ZNode, ptr %z.0.i141.i, i64 0, i32 1, i32 2
  %151 = load ptr, ptr %v.i149.i, align 8, !tbaa !212
  %152 = load ptr, ptr %v8.i.i, align 8, !tbaa !212
  %wide.trip.count44.i.i = zext i32 %149 to i64
  br label %for.cond4.preheader.us.i.i

for.cond4.preheader.us.i.i:                       ; preds = %for.cond.us.i.i, %for.cond4.preheader.lr.ph.split.us.i.i
  %indvars.iv41.i.i = phi i64 [ %indvars.iv.next42.i.i, %for.cond.us.i.i ], [ 0, %for.cond4.preheader.lr.ph.split.us.i.i ]
  %arrayidx.us.i.i = getelementptr inbounds ptr, ptr %151, i64 %indvars.iv41.i.i
  %153 = load ptr, ptr %arrayidx.us.i.i, align 8, !tbaa !16
  br label %for.body7.us.i.i

for.body7.us.i.i:                                 ; preds = %for.inc.us.i.i, %for.cond4.preheader.us.i.i
  %indvars.iv.i.i = phi i64 [ 0, %for.cond4.preheader.us.i.i ], [ %indvars.iv.next.i.i, %for.inc.us.i.i ]
  %arrayidx10.us.i.i = getelementptr inbounds ptr, ptr %152, i64 %indvars.iv.i.i
  %154 = load ptr, ptr %arrayidx10.us.i.i, align 8, !tbaa !16
  %cmp11.us.i.i = icmp eq ptr %153, %154
  br i1 %cmp11.us.i.i, label %for.cond.us.i.i, label %for.inc.us.i.i

for.inc.us.i.i:                                   ; preds = %for.body7.us.i.i
  %indvars.iv.next.i.i = add nuw nsw i64 %indvars.iv.i.i, 1
  %exitcond.not.i.i216 = icmp eq i64 %indvars.iv.next.i.i, %wide.trip.count44.i.i
  br i1 %exitcond.not.i.i216, label %for.inc.i220, label %for.body7.us.i.i, !llvm.loop !213

for.cond.us.i.i:                                  ; preds = %for.body7.us.i.i
  %indvars.iv.next42.i.i = add nuw nsw i64 %indvars.iv41.i.i, 1
  %exitcond45.not.i.i = icmp eq i64 %indvars.iv.next42.i.i, %wide.trip.count44.i.i
  br i1 %exitcond45.not.i.i, label %if.end26.i, label %for.cond4.preheader.us.i.i, !llvm.loop !214

if.end26.i:                                       ; preds = %for.cond.us.i.i, %for.cond.preheader.i.i
  %155 = load ptr, ptr %118, align 8, !tbaa !43
  %reduces_to.i = getelementptr inbounds %struct.D_State, ptr %155, i64 0, i32 13
  %156 = load i32, ptr %reduces_to.i, align 8, !tbaa !215
  %conv.i = sext i32 %156 to i64
  %157 = load ptr, ptr %134, align 8, !tbaa !43
  %158 = load ptr, ptr %t, align 8, !tbaa !23
  %state30.i = getelementptr inbounds %struct.D_ParserTables, ptr %158, i64 0, i32 1
  %159 = load ptr, ptr %state30.i, align 8, !tbaa !42
...
land.lhs.true.i217:                               ; preds = %if.end26.i
  %reduces_to35.i = getelementptr inbounds %struct.D_State, ptr %157, i64 0, i32 13
  %160 = load i32, ptr %reduces_to35.i, align 8, !tbaa !215
  %conv36.i = sext i32 %160 to i64
  %sub.ptr.lhs.cast41.i = ptrtoint ptr %155 to i64
...
if.end48.i:                                       ; preds = %land.lhs.true.i217, %if.end26.i
  %161 = load i32, ptr %op_priority.i, align 4, !tbaa !216
  %op_priority50.i = getelementptr inbounds %struct.PNode, ptr %147, i64 0, i32 3
  %162 = load i32, ptr %op_priority50.i, align 4, !tbaa !216
  %cmp51.i = icmp sgt i32 %161, %162
  br i1 %cmp51.i, label %if.then53.i, label %if.end60.i

if.then53.i:                                      ; preds = %if.end48.i
  %next54.i = getelementptr inbounds %struct.Shift, ptr %b.0164.i, i64 0, i32 1
  %163 = load ptr, ptr %next54.i, align 8, !tbaa !132
  store ptr %163, ptr %bl.0163.i, align 8, !tbaa !16
  %164 = load ptr, ptr %b.0164.i, align 8, !tbaa !134
  %refcount.i218 = getelementptr inbounds %struct.SNode, ptr %164, i64 0, i32 7
  %165 = load i32, ptr %refcount.i218, align 8, !tbaa !101
  %dec.i = add i32 %165, -1
...
do.end.i219:                                      ; preds = %if.then57.i, %if.then53.i
  call void @free(ptr noundef nonnull %b.0164.i) #23
  br label %for.inc82.i

if.end60.i:                                       ; preds = %if.end48.i
  %cmp65.i = icmp slt i32 %161, %162
  br i1 %cmp65.i, label %if.then67.i, label %for.inc.i220

if.then67.i:                                      ; preds = %if.end60.i
  store ptr %133, ptr %al.0166.i, align 8, !tbaa !16
  %166 = load ptr, ptr %a.0167.i, align 8, !tbaa !134
  %refcount71.i = getelementptr inbounds %struct.SNode, ptr %166, i64 0, i32 7
  %167 = load i32, ptr %refcount71.i, align 8, !tbaa !101
  %dec72.i = add i32 %167, -1
...
if.then74.i:                                      ; preds = %if.then67.i
  call fastcc void @free_SNode(ptr noundef nonnull %p, ptr noundef nonnull %166)
  br label %do.end78.i

do.end78.i:                                       ; preds = %if.then74.i, %if.then67.i
  call void @free(ptr noundef nonnull %a.0167.i) #23
  %168 = load ptr, ptr %al.0166.i, align 8, !tbaa !16
  br label %for.inc82.i

for.inc.i220:                                     ; preds = %for.inc.us.i.i, %if.end60.i, %land.lhs.true.i217, %if.end21.i, %if.end19.i145.i, %if.end7.i135.i, %if.then3.i131.i, %for.body16.i
  %next80.i = getelementptr inbounds %struct.Shift, ptr %b.0164.i, i64 0, i32 1
  %169 = load ptr, ptr %next80.i, align 8, !tbaa !132
  %tobool9.not.i = icmp eq ptr %169, null
  br i1 %tobool9.not.i, label %for.inc82.i, label %land.rhs10.i, !llvm.loop !217
...
for.inc82.i:                                      ; preds = %for.inc.i220, %land.rhs10.i, %do.end78.i, %do.end.i219, %if.end.i214, %if.end19.i.i, %if.end7.i.i, %if.then3.i.i, %for.body.i206
  %a.1.i = phi ptr [ %a.0167.i, %do.end.i219 ], [ %168, %do.end78.i ], [ %a.0167.i, %for.body.i206 ], [ %a.0167.i, %if.then3.i.i ], [ %a.0167.i, %if.end7.i.i ], [ %a.0167.i, %if.end19.i.i ], [ %a.0167.i, %if.end.i214 ], [ %a.0167.i, %land.rhs10.i ], [ %a.0167.i, %for.inc.i220 ]
  %next83.i = getelementptr inbounds %struct.Shift, ptr %a.1.i, i64 0, i32 1
  %170 = load ptr, ptr %next83.i, align 8, !tbaa !132
  %tobool.not.i221 = icmp eq ptr %170, null
  br i1 %tobool.not.i221, label %if.end69.loopexit, label %land.rhs.i, !llvm.loop !218

if.end69.loopexit:                                ; preds = %land.rhs.i, %for.inc82.i
  %.pre313 = load ptr, ptr %shifts_todo, align 8, !tbaa !126
  br label %if.end69

if.end69:                                         ; preds = %if.end69.loopexit, %if.else60, %land.lhs.true63
  %171 = phi ptr [ %.pre313, %if.end69.loopexit ], [ %26, %if.else60 ], [ %26, %land.lhs.true63 ]
  %172 = load ptr, ptr %171, align 8, !tbaa !134
  %loc72 = getelementptr inbounds %struct.SNode, ptr %172, i64 0, i32 3
  %173 = load ptr, ptr %loc72, align 8, !tbaa !173
  %cmp74 = icmp ugt ptr %173, %epos.1.lcssa
...
if.end76:                                         ; preds = %if.then75, %if.end69
  %epos.3 = phi ptr [ %173, %if.then75 ], [ %epos.1.lcssa, %if.end69 ]
  %inc77 = add nsw i32 %progress.0.ph, 1
  %174 = load i32, ptr %commit_actions_interval, align 8, !tbaa !84
  %cmp79.not = icmp slt i32 %progress.0.ph, %174
  br i1 %cmp79.not, label %if.end89, label %land.lhs.true81

land.lhs.true81:                                  ; preds = %if.end76
  %175 = load ptr, ptr %shifts_todo, align 8, !tbaa !126
  %next83 = getelementptr inbounds %struct.Shift, ptr %175, i64 0, i32 1
  %176 = load ptr, ptr %next83, align 8, !tbaa !132
  %tobool84.not = icmp eq ptr %176, null
...
if.then85:                                        ; preds = %land.lhs.true81
  ...
  %call88 = call fastcc i32 @commit_stack(ptr noundef nonnull %p, ptr noundef %177), !range !219
  br label %if.end89
...
if.end89:                                         ; preds = %if.then85, %if.end76
  ...
  %tobool92.not297 = icmp eq ptr %.pr, null
  br i1 %tobool92.not297, label %while.cond.outer.backedge, label %land.rhs93.preheader

while.cond.outer.backedge:                        ; preds = %if.end89, %if.then113, %land.lhs.true109, %land.lhs.true106, %for.end104
  %progress.0.ph.be = phi i32 [ %progress.1.ph, %if.end89 ], [ 0, %if.then113 ], [ %progress.1323, %land.lhs.true109 ], [ %progress.1323, %land.lhs.true106 ], [ %progress.1323, %for.end104 ]
  br label %while.cond.outer

land.rhs93.preheader:                             ; preds = %land.lhs.true81, %if.end89
  %ready.0.shrunk325 = phi i1 [ false, %if.end89 ], [ true, %land.lhs.true81 ]
  %progress.1323 = phi i32 [ %progress.1.ph, %if.end89 ], [ %inc77, %land.lhs.true81 ]
  %178 = phi ptr [ %.pr, %if.end89 ], [ %175, %land.lhs.true81 ]
  br label %land.rhs93

land.rhs93:                                       ; preds = %land.rhs93.preheader, %shift_one.exit
  %179 = phi ptr [ %222, %shift_one.exit ], [ %178, %land.rhs93.preheader ]
  %180 = load ptr, ptr %179, align 8, !tbaa !134
  %loc95 = getelementptr inbounds %struct.SNode, ptr %180, i64 0, i32 3
  %181 = load ptr, ptr %loc95, align 8, !tbaa !173
  %cmp97 = icmp eq ptr %181, %173
  br i1 %cmp97, label %for.body100, label %for.end104

for.body100:                                      ; preds = %land.rhs93
  %next102 = getelementptr inbounds %struct.Shift, ptr %179, i64 0, i32 1
  %182 = load ptr, ptr %next102, align 8, !tbaa !132
  store ptr %182, ptr %shifts_todo, align 8, !tbaa !126
  ...
  %183 = load ptr, ptr %180, align 8, !tbaa !43
  ...
  %184 = load i32, ptr %scans.i, align 8, !tbaa !162
  %inc.i224 = add nsw i32 %184, 1
  store i32 %inc.i224, ptr %scans.i, align 8, !tbaa !162
  %scanner_code.i = getelementptr inbounds %struct.D_State, ptr %183, i64 0, i32 6
  %185 = load ptr, ptr %scanner_code.i, align 8, !tbaa !220
  %tobool.not.i225 = icmp eq ptr %185, null
  br i1 %tobool.not.i225, label %if.end34.i, label %if.then.i229

if.then.i229:                                     ; preds = %for.body100
  store i32 0, ptr %term_priority.i, align 8, !tbaa !221
  store i8 0, ptr %op_assoc.i, align 1, !tbaa !222
  %186 = load ptr, ptr %shift_results.i, align 8, !tbaa !147
  %loc6.i = getelementptr inbounds %struct.ShiftResult, ptr %186, i64 0, i32 1
  ...
  %187 = load ptr, ptr %scanner_code.i, align 8, !tbaa !220
  %188 = load ptr, ptr %shift_results.i, align 8, !tbaa !147
  %loc11.i = getelementptr inbounds %struct.ShiftResult, ptr %188, i64 0, i32 1
  %col.i = getelementptr inbounds %struct.ShiftResult, ptr %188, i64 0, i32 1, i32 3
  %line.i226 = getelementptr inbounds %struct.ShiftResult, ptr %188, i64 0, i32 1, i32 4
  %call.i228 = call i32 %187(ptr noundef nonnull %loc11.i, ptr noundef nonnull %col.i, ptr noundef nonnull %line.i226, ptr noundef nonnull %code_shift.i, ptr noundef nonnull %term_priority.i, ptr noundef nonnull %op_assoc.i, ptr noundef nonnull %op_priority.i227) #23
...
if.then28.i:                                      ; preds = %if.then.i229
  ...
  store ptr %code_shift.i, ptr %189, align 8, !tbaa !223
  br label %if.end34.i

if.end34.i:                                       ; preds = %if.then28.i, %if.then.i229, %for.body100
  %nshifts.0.i = phi i32 [ 1, %if.then28.i ], [ 0, %if.then.i229 ], [ 0, %for.body100 ]
  %scanner_table.i = getelementptr inbounds %struct.D_State, ptr %183, i64 0, i32 7
  %190 = load ptr, ptr %scanner_table.i, align 8, !tbaa !225
  %tobool35.not.i = icmp eq ptr %190, null
  br i1 %tobool35.not.i, label %if.end41.i, label %if.then36.i

if.then36.i:                                      ; preds = %if.end34.i
  %191 = load ptr, ptr %shift_results.i, align 8, !tbaa !147
  %idxprom38.i = zext i32 %nshifts.0.i to i64
  %arrayidx39.i = getelementptr inbounds %struct.ShiftResult, ptr %191, i64 %idxprom38.i
  %call40.i = call i32 @scan_buffer(ptr noundef nonnull %loc.i222, ptr noundef nonnull %183, ptr noundef %arrayidx39.i) #23
...
for.body.i236:                                    ; preds = %for.inc.i251, %for.body.lr.ph.i
  ...
  %192 = load ptr, ptr %shift_results.i, align 8, !tbaa !147
  %arrayidx44.i233 = getelementptr inbounds %struct.ShiftResult, ptr %192, i64 %indvars.iv.i232
  %193 = load i32, ptr %shifts.i, align 4, !tbaa !163
  %inc45.i = add nsw i32 %193, 1
  store i32 %inc45.i, ptr %shifts.i, align 4, !tbaa !163
  %194 = load ptr, ptr %arrayidx44.i233, align 8, !tbaa !223
  %195 = load i16, ptr %194, align 8, !tbaa !226
  %conv.i234 = zext i16 %195 to i32
  %196 = load ptr, ptr %179, align 8, !tbaa !134
  %loc49.i = getelementptr inbounds %struct.SNode, ptr %196, i64 0, i32 3
  %loc50.i = getelementptr inbounds %struct.ShiftResult, ptr %192, i64 %indvars.iv.i232, i32 1
  %197 = load ptr, ptr %loc50.i, align 8, !tbaa !227
  %last_pn.i235 = getelementptr inbounds %struct.SNode, ptr %196, i64 0, i32 5
  %198 = load ptr, ptr %last_pn.i235, align 8, !tbaa !170
  %call54.i = call fastcc ptr @add_PNode(ptr noundef nonnull %p, i32 noundef %conv.i234, ptr noundef nonnull %loc49.i, ptr noundef %197, ptr noundef %198, ptr noundef null, ptr noundef null, ptr noundef nonnull %194)
...
if.then56.i:                                      ; preds = %for.body.i236
  %199 = load ptr, ptr %skip_loc.i, align 8, !tbaa !96
  %tobool58.not.i = icmp eq ptr %199, null
  br i1 %tobool58.not.i, label %if.then67.i240, label %lor.lhs.false.i

lor.lhs.false.i:                                  ; preds = %if.then56.i
  %200 = load ptr, ptr %loc50.i, align 8, !tbaa !227
  %cmp62.not.i = icmp eq ptr %199, %200
  br i1 %cmp62.not.i, label %lor.lhs.false64.i, label %if.then67.i240
...
lor.lhs.false64.i:                                ; preds = %lor.lhs.false.i
  ...
  %201 = load ptr, ptr %white_space.i237, align 8, !tbaa !200
  %cmp65.not.i = icmp eq ptr %skip_fn.0160.i, %201
  br i1 %cmp65.not.i, label %lor.lhs.false64.if.end89_crit_edge.i, label %if.then67.i240

lor.lhs.false64.if.end89_crit_edge.i:             ; preds = %lor.lhs.false64.i
  %.pre.i238 = load ptr, ptr %179, align 8, !tbaa !134
  br label %if.end89.i

if.then67.i240:                                   ; preds = %lor.lhs.false64.i, %lor.lhs.false.i, %if.then56.i
  ...
  %202 = load ptr, ptr %white_space70.i, align 8, !tbaa !200
  %globals.i239 = getelementptr inbounds %struct.PNode, ptr %call54.i, i64 0, i32 19, i32 6
  call void %202(ptr noundef nonnull %p, ptr noundef nonnull %skip_loc.i, ptr noundef nonnull %globals.i239) #23
  %203 = load ptr, ptr %179, align 8, !tbaa !134
  %col76.i = getelementptr inbounds %struct.SNode, ptr %203, i64 0, i32 3, i32 3
  %204 = load i32, ptr %col76.i, align 4, !tbaa !228
  %cmp77.i = icmp sgt i32 %204, -1
  br i1 %cmp77.i, label %cond.end.i, label %cond.false.i

cond.false.i:                                     ; preds = %if.then67.i240
  %previous_col.i = getelementptr inbounds %struct.SNode, ptr %203, i64 0, i32 3, i32 2
  %205 = load i32, ptr %previous_col.i, align 8, !tbaa !229
  br label %cond.end.i

cond.end.i:                                       ; preds = %cond.false.i, %if.then67.i240
  %cond.i = phi i32 [ %205, %cond.false.i ], [ %204, %if.then67.i240 ]
  store i32 %cond.i, ptr %previous_col84.i, align 8, !tbaa !103
  %v.i241 = getelementptr inbounds %struct.SNode, ptr %203, i64 0, i32 6, i32 2
  %206 = load ptr, ptr %v.i241, align 8, !tbaa !159
  %207 = load ptr, ptr %206, align 8, !tbaa !16
  %tobool.not29.i.i = icmp eq ptr %207, null
  br i1 %tobool.not29.i.i, label %find_ws_before.exit.i, label %land.rhs.i.i243

land.rhs.i.i243:                                  ; preds = %cond.end.i, %cond.end15.i.i
  %zn.addr.030.i.i = phi ptr [ %216, %cond.end15.i.i ], [ %207, %cond.end.i ]
  %208 = load ptr, ptr %zn.addr.030.i.i, align 8, !tbaa !160
  %start_loc.i.i = getelementptr inbounds %struct.PNode, ptr %208, i64 0, i32 19, i32 1
  %209 = load ptr, ptr %start_loc.i.i, align 8, !tbaa !19
  %end.i.i = getelementptr inbounds %struct.PNode, ptr %208, i64 0, i32 19, i32 2
  %210 = load ptr, ptr %end.i.i, align 8, !tbaa !169
  %cmp.i.i242 = icmp eq ptr %209, %210
  br i1 %cmp.i.i242, label %while.body.i.i245, label %find_ws_before.exit.i.loopexit.split.loop.exit

while.body.i.i245:                                ; preds = %land.rhs.i.i243
  %sns.i.i244 = getelementptr inbounds %struct.ZNode, ptr %zn.addr.030.i.i, i64 0, i32 1
  %211 = load i32, ptr %sns.i.i244, align 8, !tbaa !171
  %tobool3.not.i.i = icmp eq i32 %211, 0
  br i1 %tobool3.not.i.i, label %find_ws_before.exit.i, label %cond.true.i.i

cond.true.i.i:                                    ; preds = %while.body.i.i245
  %v.i.i246 = getelementptr inbounds %struct.ZNode, ptr %zn.addr.030.i.i, i64 0, i32 1, i32 2
  %212 = load ptr, ptr %v.i.i246, align 8, !tbaa !172
  %213 = load ptr, ptr %212, align 8, !tbaa !16
  %zns.i.i247 = getelementptr inbounds %struct.SNode, ptr %213, i64 0, i32 6
  %214 = load i32, ptr %zns.i.i247, align 8, !tbaa !158
  %tobool6.not.i.i = icmp eq i32 %214, 0
  br i1 %tobool6.not.i.i, label %find_ws_before.exit.i, label %cond.end15.i.i

cond.end15.i.i:                                   ; preds = %cond.true.i.i
  %v12.i.i = getelementptr inbounds %struct.SNode, ptr %213, i64 0, i32 6, i32 2
  %215 = load ptr, ptr %v12.i.i, align 8, !tbaa !159
  %216 = load ptr, ptr %215, align 8, !tbaa !16
  %tobool.not.i.i248 = icmp eq ptr %216, null
  br i1 %tobool.not.i.i248, label %find_ws_before.exit.i, label %land.rhs.i.i243, !llvm.loop !230

find_ws_before.exit.i.loopexit.split.loop.exit:   ; preds = %land.rhs.i.i243
  %end.i.i.le = getelementptr inbounds %struct.PNode, ptr %208, i64 0, i32 19, i32 2
  br label %find_ws_before.exit.i

find_ws_before.exit.i:                            ; preds = %cond.end15.i.i, %cond.true.i.i, %while.body.i.i245, %find_ws_before.exit.i.loopexit.split.loop.exit, %cond.end.i
  %retval.0.in.i.i = phi ptr [ %start, %cond.end.i ], [ %end.i.i.le, %find_ws_before.exit.i.loopexit.split.loop.exit ], [ %start, %while.body.i.i245 ], [ %start, %cond.true.i.i ], [ %start, %cond.end15.i.i ]
  %retval.0.i.i = load ptr, ptr %retval.0.in.i.i, align 8, !tbaa !16
  ...
  %217 = load ptr, ptr %skip_loc.i, align 8, !tbaa !96
  %ws_after.i = getelementptr inbounds %struct.PNode, ptr %call54.i, i64 0, i32 16
  store ptr %217, ptr %ws_after.i, align 8, !tbaa !39
  br label %if.end89.i

if.end89.i:                                       ; preds = %find_ws_before.exit.i, %lor.lhs.false64.if.end89_crit_edge.i
  %218 = phi ptr [ %203, %find_ws_before.exit.i ], [ %.pre.i238, %lor.lhs.false64.if.end89_crit_edge.i ]
  %skip_fn.1.i = phi ptr [ %202, %find_ws_before.exit.i ], [ %skip_fn.0160.i, %lor.lhs.false64.if.end89_crit_edge.i ]
  call fastcc void @goto_PNode(ptr noundef nonnull %p, ptr noundef nonnull %skip_loc.i, ptr noundef nonnull %call54.i, ptr noundef %218)
...
for.inc.i251:                                     ; preds = %if.end89.i, %for.body.i236
  ...
  br i1 %exitcond.not.i250, label %do.body.i, label %for.body.i236, !llvm.loop !231

do.body.i:                                        ; preds = %for.inc.i251, %if.end41.i
  %219 = load ptr, ptr %179, align 8, !tbaa !134
  %refcount.i252 = getelementptr inbounds %struct.SNode, ptr %219, i64 0, i32 7
  %220 = load i32, ptr %refcount.i252, align 8, !tbaa !101
  %dec.i253 = add i32 %220, -1
...
if.then96.i:                                      ; preds = %do.body.i
  call fastcc void @free_SNode(ptr noundef nonnull %p, ptr noundef nonnull %219)
  br label %shift_one.exit

shift_one.exit:                                   ; preds = %do.body.i, %if.then96.i
  %221 = load ptr, ptr %free_shifts.i, align 8, !tbaa !127
  store ptr %221, ptr %next102, align 8, !tbaa !132
  store ptr %179, ptr %free_shifts.i, align 8, !tbaa !127
  ...
  %222 = load ptr, ptr %shifts_todo, align 8, !tbaa !126
  %tobool92.not = icmp eq ptr %222, null
  br i1 %tobool92.not, label %for.end104, label %land.rhs93, !llvm.loop !232

for.end104:                                       ; preds = %land.rhs93, %shift_one.exit
  br i1 %ready.0.shrunk325, label %land.lhs.true106, label %while.cond.outer.backedge

land.lhs.true106:                                 ; preds = %for.end104
  %223 = load ptr, ptr %reductions_todo, align 8, !tbaa !124
  %tobool108.not = icmp eq ptr %223, null
  br i1 %tobool108.not, label %while.cond.outer.backedge, label %land.lhs.true109

land.lhs.true109:                                 ; preds = %land.lhs.true106
  %next111 = getelementptr inbounds %struct.Reduction, ptr %223, i64 0, i32 5
  %224 = load ptr, ptr %next111, align 8, !tbaa !128
  %tobool112.not = icmp eq ptr %224, null
  br i1 %tobool112.not, label %if.then113, label %while.cond.outer.backedge

if.then113:                                       ; preds = %land.lhs.true109
  %snode115 = getelementptr inbounds %struct.Reduction, ptr %223, i64 0, i32 1
  %225 = load ptr, ptr %snode115, align 8, !tbaa !130
  %call116 = call fastcc i32 @commit_stack(ptr noundef nonnull %p, ptr noundef %225), !range !219
...
entry:
  ...
  %0 = load i8, ptr %evaluated, align 4, !tbaa !205
  %tobool.not = icmp eq i8 %0, 0
...
if.end:                                           ; preds = %entry
  ...
  %cmp = icmp eq ptr %1, %2
  br i1 %cmp, label %land.lhs.true, label %if.end8.thread160
...
land.lhs.true3:                                   ; preds = %land.lhs.true
  ...
  %4 = load ptr, ptr %final_code, align 8, !tbaa !233
  %tobool5.not = icmp eq ptr %4, null
  br i1 %tobool5.not, label %if.end8, label %if.end8.thread

if.end8:                                          ; preds = %land.lhs.true, %land.lhs.true3
  store i8 1, ptr %evaluated, align 4, !tbaa !205
  %ambiguities = getelementptr inbounds %struct.PNode, ptr %pn, i64 0, i32 13
  %5 = load ptr, ptr %ambiguities, align 8, !tbaa !66
  %tobool9.not = icmp eq ptr %5, null
  br i1 %tobool9.not, label %if.end11, label %if.then10

if.end8.thread160:                                ; preds = %if.end
  store i8 1, ptr %evaluated, align 4, !tbaa !205
  %ambiguities161 = getelementptr inbounds %struct.PNode, ptr %pn, i64 0, i32 13
  %6 = load ptr, ptr %ambiguities161, align 8, !tbaa !66
  %tobool9.not162 = icmp eq ptr %6, null
  br i1 %tobool9.not162, label %if.end11, label %if.then10.thread163

if.then10.thread163:                              ; preds = %if.end8.thread160
  call void @llvm.lifetime.start.p0(i64 40, ptr nonnull %pns.i) #23
  %v.i164 = getelementptr inbounds %struct.anon.3, ptr %pns.i, i64 0, i32 2
  %parse_node.i165 = getelementptr inbounds %struct.PNode, ptr %pn, i64 0, i32 19
...
if.end8.thread:                                   ; preds = %land.lhs.true3
  ...
  %7 = load ptr, ptr %ambiguities152, align 8, !tbaa !66
  %tobool9.not153 = icmp eq ptr %7, null
  br i1 %tobool9.not153, label %if.end11, label %if.then10.thread

if.then10.thread:                                 ; preds = %if.end8.thread
  call void @llvm.lifetime.start.p0(i64 40, ptr nonnull %pns.i) #23
  %v.i154 = getelementptr inbounds %struct.anon.3, ptr %pns.i, i64 0, i32 2
  %parse_node.i155 = getelementptr inbounds %struct.PNode, ptr %pn, i64 0, i32 19
  br label %for.body.lr.ph.i

if.then10:                                        ; preds = %if.end8
  call void @llvm.lifetime.start.p0(i64 40, ptr nonnull %pns.i) #23
  %v.i = getelementptr inbounds %struct.anon.3, ptr %pns.i, i64 0, i32 2
  %parse_node.i = getelementptr inbounds %struct.PNode, ptr %pn, i64 0, i32 19
  br i1 %cmp, label %for.body.lr.ph.i, label %if.then.thread.i

if.then.thread.i:                                 ; preds = %if.then10.thread163, %if.then10
  %parse_node.i167 = phi ptr [ %parse_node.i165, %if.then10.thread163 ], [ %parse_node.i, %if.then10 ]
  %v.i166 = phi ptr [ %v.i164, %if.then10.thread163 ], [ %v.i, %if.then10 ]
  %8 = phi ptr [ %6, %if.then10.thread163 ], [ %5, %if.then10 ]
  %e157.i = getelementptr inbounds %struct.anon.3, ptr %pns.i, i64 0, i32 3
  store ptr %e157.i, ptr %v.i166, align 8, !tbaa !212
  store i32 1, ptr %pns.i, align 8, !tbaa !211
  store ptr %parse_node.i167, ptr %e157.i, align 8, !tbaa !16
  br label %for.body.us.preheader.i

for.body.lr.ph.i:                                 ; preds = %if.then10, %if.then10.thread
  %parse_node.i159 = phi ptr [ %parse_node.i155, %if.then10.thread ], [ %parse_node.i, %if.then10 ]
  %v.i157 = phi ptr [ %v.i154, %if.then10.thread ], [ %v.i, %if.then10 ]
  %9 = phi ptr [ %7, %if.then10.thread ], [ %5, %if.then10 ]
  ...
  store ptr %e.i, ptr %v.i157, align 8, !tbaa !212
  store i32 1, ptr %pns.i, align 8, !tbaa !211
  store ptr %parse_node.i159, ptr %e.i, align 8, !tbaa !16
...
for.body.us.preheader.i:                          ; preds = %if.then.thread.i, %for.body.lr.ph.i
  %v.i156 = phi ptr [ %v.i157, %for.body.lr.ph.i ], [ %v.i166, %if.then.thread.i ]
  %10 = phi ptr [ %9, %for.body.lr.ph.i ], [ %8, %if.then.thread.i ]
  %e162170.i = phi ptr [ %e.i, %for.body.lr.ph.i ], [ %e157.i, %if.then.thread.i ]
  %11 = getelementptr inbounds %struct.anon.3, ptr %pns.i, i64 0, i32 3
  br label %for.body.us.i

for.body.us.i:                                    ; preds = %for.inc.us.i, %for.body.us.preheader.i
  %amb.0154.us.i = phi ptr [ %amb.0.us.i, %for.inc.us.i ], [ %10, %for.body.us.preheader.i ]
  %12 = load ptr, ptr %v.i156, align 8
  %tobool56.not.us.i = icmp eq ptr %12, null
  br i1 %tobool56.not.us.i, label %if.then57.us.i, label %if.else66.us.i

if.else66.us.i:                                   ; preds = %for.body.us.i
  %cmp70.us.i = icmp eq ptr %12, %e162170.i
  %13 = load i32, ptr %pns.i, align 8, !tbaa !211
  br i1 %cmp70.us.i, label %if.then71.us.i, label %if.else82.us.i

if.else82.us.i:                                   ; preds = %if.else66.us.i
  %and84.us.i = and i32 %13, 7
...
if.then86.us.i:                                   ; preds = %if.else82.us.i
  ...
  %inc90.us.i = add i32 %13, 1
  store i32 %inc90.us.i, ptr %pns.i, align 8, !tbaa !211
  %idxprom91.us.i = zext i32 %13 to i64
  %arrayidx92.us.i = getelementptr inbounds ptr, ptr %12, i64 %idxprom91.us.i
  store ptr %parse_node87.us.i, ptr %arrayidx92.us.i, align 8, !tbaa !16
  br label %for.inc.us.i

if.then71.us.i:                                   ; preds = %if.else66.us.i
  %cmp73.us.i = icmp ult i32 %13, 3
...
if.then74.us.i:                                   ; preds = %if.then71.us.i
  ...
  %inc78.us.i = add nuw nsw i32 %13, 1
  store i32 %inc78.us.i, ptr %pns.i, align 8, !tbaa !211
  %idxprom79.us.i = zext i32 %13 to i64
  %arrayidx80.us.i = getelementptr inbounds ptr, ptr %11, i64 %idxprom79.us.i
...
if.then57.us.i:                                   ; preds = %for.body.us.i
  ...
  store ptr %e162170.i, ptr %v.i156, align 8, !tbaa !212
  %14 = load i32, ptr %pns.i, align 8, !tbaa !211
  %inc63.us.i = add i32 %14, 1
  store i32 %inc63.us.i, ptr %pns.i, align 8, !tbaa !211
  %idxprom64.us.i = zext i32 %14 to i64
  %arrayidx65.us.i = getelementptr inbounds ptr, ptr %11, i64 %idxprom64.us.i
...
for.inc.us.i:                                     ; preds = %if.then57.us.i, %if.then74.us.i, %if.end95.us.i, %if.then86.us.i
  ...
  br i1 %tobool38.not.us.i, label %for.end.i, label %for.body.us.i, !llvm.loop !234

for.body.i:                                       ; preds = %for.body.lr.ph.i, %for.inc.i
  %amb.0154.i = phi ptr [ %amb.0.i, %for.inc.i ], [ %9, %for.body.lr.ph.i ]
  %15 = load i32, ptr %dont_merge_epsilon_trees.i, align 4, !tbaa !235
  %tobool39.i = icmp eq i32 %15, 0
...
land.lhs.true.i:                                  ; preds = %for.body.i
  ...
  %16 = load ptr, ptr %start_loc43.i, align 8, !tbaa !19
  %end46.i = getelementptr inbounds %struct.PNode, ptr %amb.0154.i, i64 0, i32 19, i32 2
  %17 = load ptr, ptr %end46.i, align 8, !tbaa !169
  %cmp47.i = icmp eq ptr %16, %17
...
do.body54.i:                                      ; preds = %land.lhs.true48.i, %land.lhs.true.i, %for.body.i
  %18 = load ptr, ptr %v.i157, align 8
  %tobool56.not.i = icmp eq ptr %18, null
...
if.then57.i:                                      ; preds = %do.body54.i
  ...
  store ptr %e.i, ptr %v.i157, align 8, !tbaa !212
  %19 = load i32, ptr %pns.i, align 8, !tbaa !211
  %inc63.i = add i32 %19, 1
  store i32 %inc63.i, ptr %pns.i, align 8, !tbaa !211
  %idxprom64.i = zext i32 %19 to i64
...
if.else66.i:                                      ; preds = %do.body54.i
  %cmp70.i = icmp eq ptr %18, %e.i
  %20 = load i32, ptr %pns.i, align 8, !tbaa !211
  br i1 %cmp70.i, label %if.then71.i, label %if.else82.i

if.then71.i:                                      ; preds = %if.else66.i
  %cmp73.i = icmp ult i32 %20, 3
...
if.then74.i:                                      ; preds = %if.then71.i
  ...
  %inc78.i = add nuw nsw i32 %20, 1
  store i32 %inc78.i, ptr %pns.i, align 8, !tbaa !211
  %idxprom79.i = zext i32 %20 to i64
...
if.then86.i:                                      ; preds = %if.else82.i
  ...
  %inc90.i = add i32 %20, 1
  store i32 %inc90.i, ptr %pns.i, align 8, !tbaa !211
  %idxprom91.i = zext i32 %20 to i64
  %arrayidx92.i = getelementptr inbounds ptr, ptr %18, i64 %idxprom91.i
...
for.inc.i:                                        ; preds = %if.end95.i, %if.then86.i, %if.then74.i, %if.then57.i, %land.lhs.true48.i
  ...
  br i1 %tobool38.not.i, label %for.end.i, label %for.body.i, !llvm.loop !234

for.end.i:                                        ; preds = %for.inc.i, %for.inc.us.i
  %v.i158 = phi ptr [ %v.i156, %for.inc.us.i ], [ %v.i157, %for.inc.i ]
  %e163.ph.i = phi ptr [ %e162170.i, %for.inc.us.i ], [ %e.i, %for.inc.i ]
  %.pr.i = load i32, ptr %pns.i, align 8, !tbaa !211
  %cmp101.i = icmp eq i32 %.pr.i, 1
  br i1 %cmp101.i, label %if.then102.i, label %if.end105.i

if.then102.i:                                     ; preds = %for.end.i
  %.pre = load ptr, ptr %v.i158, align 8
  %.pre151 = load ptr, ptr %.pre, align 8, !tbaa !16
...
if.end105.i:                                      ; preds = %for.end.i
  ...
  %22 = load ptr, ptr %v.i158, align 8, !tbaa !212
  %call109.i = call ptr %21(ptr noundef %p, i32 noundef %.pr.i, ptr noundef %22) #23
  %.pre.i = load ptr, ptr %v.i158, align 8
  br label %do.body110.i

do.body110.i:                                     ; preds = %if.end105.i, %if.then102.i
  %23 = phi ptr [ %.pre, %if.then102.i ], [ %.pre.i, %if.end105.i ]
  %res.0.i = phi ptr [ %.pre151, %if.then102.i ], [ %call109.i, %if.end105.i ]
...
if.end11:                                         ; preds = %if.end8.thread160, %if.end8.thread, %resolve_ambiguities.exit, %if.end8
  %pn.addr.0 = phi ptr [ %add.ptr.i, %resolve_ambiguities.exit ], [ %pn, %if.end8 ], [ %pn, %if.end8.thread ], [ %pn, %if.end8.thread160 ]
  %t = getelementptr inbounds %struct.Parser, ptr %p, i64 0, i32 3
  ...
  %27 = load i32, ptr %arrayidx, align 8, !tbaa !236
  ...
  %cmp17144.not = icmp eq i32 %28, 0
  br i1 %cmp17144.not, label %for.end, label %for.body.lr.ph

for.body.lr.ph:                                   ; preds = %if.end11
  %dont_fixup_internal_productions = getelementptr inbounds %struct.D_Parser, ptr %p, i64 0, i32 11
  %29 = load i32, ptr %dont_fixup_internal_productions, align 8, !tbaa !237
...
for.body.us:                                      ; preds = %for.body.lr.ph, %for.inc.us
  %i.0145.us = phi i32 [ %inc.us, %for.inc.us ], [ 0, %for.body.lr.ph ]
  %31 = load ptr, ptr %v, align 8, !tbaa !15
  %idxprom20.us = sext i32 %i.0145.us to i64
  ...
  %39 = load i32, ptr %arrayidx44.us, align 8, !tbaa !236
...
if.then48.us:                                     ; preds = %for.body.us
  ...
  br i1 %cmp.i122.us, label %if.then.i123.us, label %if.end.i.us

if.then.i123.us:                                  ; preds = %if.then48.us
  call void (ptr, ...) @d_fail(ptr noundef nonnull @.str.12) #23
  br label %if.end.i.us

if.end.i.us:                                      ; preds = %if.then.i123.us, %if.then48.us
...
for.cond.preheader.i.us:                          ; preds = %if.end.i.us
  ...
  %cmp7195.i.us = icmp sgt i32 %sub.i.us, %i.0145.us
  br i1 %cmp7195.i.us, label %for.body.preheader.i.us, label %for.end.i125.us
...
for.body.preheader.i.us:                          ; preds = %for.cond.preheader.i.us
  ...
  %lcmp.mod.not = icmp eq i64 %xtraiter, 0
  br i1 %lcmp.mod.not, label %for.body.i124.us.prol.loopexit, label %for.body.i124.us.prol

for.body.i124.us.prol:                            ; preds = %for.body.preheader.i.us, %for.body.i124.us.prol
  %indvars.iv.i.us.prol = phi i64 [ %indvars.iv.next.i.us.prol, %for.body.i124.us.prol ], [ %idxprom20.us, %for.body.preheader.i.us ]
  %prol.iter = phi i64 [ %prol.iter.next, %for.body.i124.us.prol ], [ 0, %for.body.preheader.i.us ]
  ...
  br i1 %prol.iter.cmp.not, label %for.body.i124.us.prol.loopexit, label %for.body.i124.us.prol, !llvm.loop !238

for.body.i124.us.prol.loopexit:                   ; preds = %for.body.i124.us.prol, %for.body.preheader.i.us
  %indvars.iv.i.us.unr = phi i64 [ %idxprom20.us, %for.body.preheader.i.us ], [ %indvars.iv.next.i.us.prol, %for.body.i124.us.prol ]
  %51 = icmp ult i64 %48, 3
  br i1 %51, label %for.end.i125.us, label %for.body.i124.us

for.body.i124.us:                                 ; preds = %for.body.i124.us.prol.loopexit, %for.body.i124.us
  %indvars.iv.i.us = phi i64 [ %indvars.iv.next.i.us.3, %for.body.i124.us ], [ %indvars.iv.i.us.unr, %for.body.i124.us.prol.loopexit ]
  ...
  br i1 %exitcond.not.i.us.3, label %for.end.i125.us, label %for.body.i124.us, !llvm.loop !239

for.end.i125.us:                                  ; preds = %for.body.i124.us.prol.loopexit, %for.body.i124.us, %for.cond.preheader.i.us
...
do.body36.i.us:                                   ; preds = %for.inc86.i.us, %do.body36.lr.ph.i.us
  ...
  %tobool.not.i126.us = icmp eq ptr %62, null
  br i1 %tobool.not.i126.us, label %if.then39.i.us, label %if.else48.i.us
...
for.inc86.i.us:                                   ; preds = %if.then39.i.us, %if.then59.i.us, %if.end82.i.us, %if.then72.i.us
  ...
  br i1 %exitcond204.not.i.us, label %for.cond90.preheader.i.us, label %do.body36.i.us, !llvm.loop !240

for.cond90.preheader.i.us:                        ; preds = %for.inc86.i.us, %for.cond32.preheader.i.us
  %add91.i.us = add nsw i32 %i.0145.us, 1
...
for.body93.lr.ph.i.us:                            ; preds = %for.cond90.preheader.i.us
  ...
  %68 = xor i64 %66, -1
  %xtraiter180 = and i64 %67, 1
  %lcmp.mod181.not = icmp eq i64 %xtraiter180, 0
  br i1 %lcmp.mod181.not, label %for.body93.i.us.prol.loopexit, label %for.body93.i.us.prol
...
for.body93.i.us:                                  ; preds = %for.body93.i.us.prol.loopexit, %for.body93.i.us
  ...
  br i1 %cmp92.not.not.i.us.1, label %for.body93.i.us, label %for.cond107.preheader.i.us, !llvm.loop !241
...
do.body110.lr.ph.i.us:                            ; preds = %for.cond107.preheader.i.us
  ...
  %xtraiter183 = and i64 %wide.trip.count212.i.us, 1
  %79 = icmp eq i32 %40, 1
...
do.body110.lr.ph.i.us.new:                        ; preds = %do.body110.lr.ph.i.us
  ...
  br label %do.body110.i127.us

do.body110.i127.us:                               ; preds = %do.body110.i127.us, %do.body110.lr.ph.i.us.new
  %indvars.iv208.i.us = phi i64 [ 0, %do.body110.lr.ph.i.us.new ], [ %indvars.iv.next209.i.us.1, %do.body110.i127.us ]
  %niter = phi i64 [ 0, %do.body110.lr.ph.i.us.new ], [ %niter.next.1, %do.body110.i127.us ]
  ...
  %niter.next.1 = add i64 %niter, 2
  %niter.ncmp.1 = icmp eq i64 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %do.body133.i.us.loopexit.unr-lcssa, label %do.body110.i127.us, !llvm.loop !242

do.body133.i.us.loopexit.unr-lcssa:               ; preds = %do.body110.i127.us, %do.body110.lr.ph.i.us
  %indvars.iv208.i.us.unr = phi i64 [ 0, %do.body110.lr.ph.i.us ], [ %indvars.iv.next209.i.us.1, %do.body110.i127.us ]
  %lcmp.mod184.not = icmp eq i64 %xtraiter183, 0
  br i1 %lcmp.mod184.not, label %do.body133.i.us, label %do.body110.i127.us.epil

do.body110.i127.us.epil:                          ; preds = %do.body133.i.us.loopexit.unr-lcssa
...
do.body133.i.us:                                  ; preds = %do.body110.i127.us.epil, %do.body133.i.us.loopexit.unr-lcssa, %for.cond107.preheader.i.us, %for.end.i125.us, %do.body.i.us
...
fixup_internal_symbol.exit.us:                    ; preds = %if.then137.i.us, %do.body133.i.us
  %sub.us = add nsw i32 %i.0145.us, -1
  br label %for.inc.us

for.inc.us:                                       ; preds = %fixup_internal_symbol.exit.us, %for.body.us
  %i.1.us = phi i32 [ %sub.us, %fixup_internal_symbol.exit.us ], [ %i.0145.us, %for.body.us ]
  %inc.us = add nsw i32 %i.1.us, 1
  %96 = load i32, ptr %children, align 8, !tbaa !14
  %cmp17.us = icmp ult i32 %inc.us, %96
  br i1 %cmp17.us, label %for.body.us, label %for.end, !llvm.loop !243
...
for.body:                                         ; preds = %for.body.lr.ph, %for.body
  ...
  br i1 %cmp17, label %for.body, label %for.end, !llvm.loop !243
...
land.lhs.true52:                                  ; preds = %for.end
  ...
  %103 = load ptr, ptr %final_code54, align 8, !tbaa !233
...
if.end64:                                         ; preds = %if.then56, %land.lhs.true52, %for.end
  ...
  %105 = load i8, ptr %evaluated65, align 4, !tbaa !205
...
do.body.lr.ph.i:                                  ; preds = %if.then72
  %v.i129 = getelementptr inbounds %struct.PNode, ptr %pn.addr.0, i64 0, i32 7, i32 2
  br label %do.body.i135

do.body.i135:                                     ; preds = %for.inc.i140, %do.body.lr.ph.i
  %108 = phi i32 [ %107, %do.body.lr.ph.i ], [ %112, %for.inc.i140 ]
  %indvars.iv.i130 = phi i64 [ 0, %do.body.lr.ph.i ], [ %indvars.iv.next.i138, %for.inc.i140 ]
  %109 = load ptr, ptr %v.i129, align 8, !tbaa !15
  %arrayidx.i131 = getelementptr inbounds ptr, ptr %109, i64 %indvars.iv.i130
  %110 = load ptr, ptr %arrayidx.i131, align 8, !tbaa !16
  %refcount.i132 = getelementptr inbounds %struct.PNode, ptr %110, i64 0, i32 6
  %111 = load i32, ptr %refcount.i132, align 8, !tbaa !64
  %dec.i133 = add i32 %111, -1
  store i32 %dec.i133, ptr %refcount.i132, align 8, !tbaa !64
  %tobool.not.i134 = icmp eq i32 %dec.i133, 0
  br i1 %tobool.not.i134, label %if.then.i137, label %for.inc.i140

if.then.i137:                                     ; preds = %do.body.i135
  call fastcc void @free_PNode(ptr noundef %p, ptr noundef nonnull %110)
  %.pre.i136 = load i32, ptr %children, align 8, !tbaa !14
  br label %for.inc.i140

for.inc.i140:                                     ; preds = %if.then.i137, %do.body.i135
  %112 = phi i32 [ %108, %do.body.i135 ], [ %.pre.i136, %if.then.i137 ]
  %indvars.iv.next.i138 = add nuw nsw i64 %indvars.iv.i130, 1
  %113 = zext i32 %112 to i64
  %cmp.i139 = icmp ult i64 %indvars.iv.next.i138, %113
  br i1 %cmp.i139, label %do.body.i135, label %do.body6.i, !llvm.loop !65

do.body6.i:                                       ; preds = %for.inc.i140, %if.then72
  ...
  %e.i141 = getelementptr inbounds %struct.PNode, ptr %pn.addr.0, i64 0, i32 7, i32 3
  %cmp13.not.i = icmp eq ptr %114, %e.i141
  %or.cond.i142 = select i1 %tobool9.not.i, i1 true, i1 %cmp13.not.i
  br i1 %or.cond.i142, label %do.body18.i, label %if.then14.i
...
for.inc.i:                                        ; preds = %if.then13.i, %do.body5.i, %for.body.i
  ...
  br i1 %cmp.i, label %for.body.i, label %do.body22.i, !llvm.loop !244
...
for.inc:                                          ; preds = %for.body, %free_ZNode.exit
  ...
  br i1 %cmp, label %for.body, label %do.body, !llvm.loop !245
...
entry:
  ...
  %0 = load ptr, ptr %all, align 8, !tbaa !246
  %snode_hash = getelementptr inbounds %struct.Parser, ptr %p, i64 0, i32 12
  %all1 = getelementptr inbounds %struct.Parser, ptr %p, i64 0, i32 12, i32 4
  %1 = load ptr, ptr %all1, align 8, !tbaa !247
...
while.cond6:                                      ; preds = %while.cond6, %while.body
  ...
  br i1 %cmp.not, label %while.end, label %while.cond6, !llvm.loop !248
...
while.end:                                        ; preds = %while.cond6
  ...
  %tobool.not = icmp eq ptr %13, null
  br i1 %tobool.not, label %while.end10, label %while.body, !llvm.loop !249

while.end10:                                      ; preds = %while.end, %entry
  %last_all = getelementptr inbounds %struct.Parser, ptr %p, i64 0, i32 12, i32 5
  %16 = load ptr, ptr %last_all, align 8, !tbaa !176
...
while.end17:                                      ; preds = %do.end, %while.end10
  %19 = load ptr, ptr %all1, align 8, !tbaa !247
  store ptr %19, ptr %last_all, align 8, !tbaa !176
  store ptr null, ptr %all1, align 8, !tbaa !247
...
while.end109:                                     ; preds = %do.end108, %while.end17
  ...
  store ptr null, ptr %all, align 8, !tbaa !246
  ret void
}
...
for.body.lr.ph.i41:                               ; preds = %if.end.i
  ...
  %loc8.i47 = getelementptr inbounds %struct.SNode, ptr %17, i64 0, i32 3
  %18 = load ptr, ptr %loc8.i47, align 8, !tbaa !173
  %cmp.not.i48 = icmp ugt ptr %16, %18
  br i1 %cmp.not.i48, label %for.cond.i, label %add_Shift.exit

for.cond.i:                                       ; preds = %for.body.lr.ph.i41, %for.body.i42
  %x.031.i49 = phi ptr [ %x.0.i, %for.body.i42 ], [ %x.028.i, %for.body.lr.ph.i41 ]
  %next12.i = getelementptr inbounds %struct.Shift, ptr %x.031.i49, i64 0, i32 1
...
for.body.i42:                                     ; preds = %for.cond.i
  ...
  br i1 %cmp.not.i, label %for.cond.i, label %add_Shift.exit.loopexit, !llvm.loop !256

add_Shift.exit.loopexit:                          ; preds = %for.cond.i, %for.body.i42
  %.ph = phi ptr [ %x.0.i, %for.body.i42 ], [ null, %for.cond.i ]
  %next12.i.le = getelementptr inbounds %struct.Shift, ptr %x.031.i49, i64 0, i32 1
  br label %add_Shift.exit

add_Shift.exit:                                   ; preds = %add_Shift.exit.loopexit, %for.body.lr.ph.i41, %if.end.i
  %21 = phi ptr [ null, %if.end.i ], [ %x.028.i, %for.body.lr.ph.i41 ], [ %.ph, %add_Shift.exit.loopexit ]
  ...
  store ptr %21, ptr %next14.i, align 8, !tbaa !132
  store ptr %s.0.i, ptr %l.0.lcssa.i, align 8, !tbaa !16
  %.pre = load ptr, ptr %call2, align 8, !tbaa !43
  br label %if.end6

if.end6:                                          ; preds = %add_Shift.exit, %if.end
  %22 = phi ptr [ %.pre, %add_Shift.exit ], [ %11, %if.end ]
  %reductions53 = getelementptr inbounds %struct.D_State, ptr %22, i64 0, i32 2
  %23 = load i32, ptr %reductions53, align 8, !tbaa !257
  %cmp54.not = icmp eq i32 %23, 0
  br i1 %cmp54.not, label %cleanup, label %for.body

for.body:                                         ; preds = %if.end6, %for.inc
  %24 = phi ptr [ %28, %for.inc ], [ %22, %if.end6 ]
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.inc ], [ 0, %if.end6 ]
  %v = getelementptr inbounds %struct.D_State, ptr %24, i64 0, i32 2, i32 1
  %25 = load ptr, ptr %v, align 8, !tbaa !258
  %arrayidx = getelementptr inbounds ptr, ptr %25, i64 %indvars.iv
  %26 = load ptr, ptr %arrayidx, align 8, !tbaa !16
  %27 = load i16, ptr %26, align 8, !tbaa !194
  %tobool11.not = icmp eq i16 %27, 0
  br i1 %tobool11.not, label %if.then12, label %for.inc

if.then12:                                        ; preds = %for.body
  %call18 = tail call fastcc ptr @add_Reduction(ptr noundef %p, ptr noundef null, ptr noundef nonnull %call2, ptr noundef nonnull %26)
  %.pre59 = load ptr, ptr %call2, align 8, !tbaa !43
  br label %for.inc

for.inc:                                          ; preds = %for.body, %if.then12
  %28 = phi ptr [ %24, %for.body ], [ %.pre59, %if.then12 ]
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %reductions = getelementptr inbounds %struct.D_State, ptr %28, i64 0, i32 2
  %29 = load i32, ptr %reductions, align 8, !tbaa !257
  %30 = zext i32 %29 to i64
...
if.end9.i:                                        ; preds = %if.end5.i
  %20 = load i32, ptr %path, align 8, !tbaa !211
...
for.body.lr.ph.i:                                 ; preds = %for.cond.preheader.i
  ...
  %22 = load ptr, ptr %v17.i, align 8, !tbaa !212
...
if.else12.i:                                      ; preds = %if.end.i64
  ...
  %36 = load ptr, ptr %v.i65, align 8, !tbaa !212
  %37 = load i32, ptr %path, align 8, !tbaa !211
  %sub.i = add i32 %37, -1
  ...
  %tobool.not29.i.i = icmp eq ptr %42, null
  br i1 %tobool.not29.i.i, label %if.else.i.i, label %land.rhs.i.i

land.rhs.i.i:                                     ; preds = %if.else12.i, %cond.end15.i.i
  %zn.addr.030.i.i = phi ptr [ %51, %cond.end15.i.i ], [ %42, %if.else12.i ]
  %43 = load ptr, ptr %zn.addr.030.i.i, align 8, !tbaa !160
...
while.body.i.i:                                   ; preds = %land.rhs.i.i
  %sns.i.i = getelementptr inbounds %struct.ZNode, ptr %zn.addr.030.i.i, i64 0, i32 1
...
cond.true.i.i:                                    ; preds = %while.body.i.i
  %v.i.i = getelementptr inbounds %struct.ZNode, ptr %zn.addr.030.i.i, i64 0, i32 1, i32 2
...
cond.end15.i.i:                                   ; preds = %cond.true.i.i
  ...
  br i1 %tobool.not.i.i, label %if.else.i.i, label %land.rhs.i.i, !llvm.loop !230
...
if.else.i.i:                                      ; preds = %cond.end15.i.i, %cond.true.i.i, %while.body.i.i, %if.else12.i
  ...
  %retval.0.i.pre.i = load ptr, ptr %start.i.i, align 8, !tbaa !16
  br label %if.end23.i

if.end23.i:                                       ; preds = %land.rhs.i.i, %if.else.i.i, %if.then10.i
  %retval.0.i.sink.i = phi ptr [ %e, %if.then10.i ], [ %retval.0.i.pre.i, %if.else.i.i ], [ %45, %land.rhs.i.i ]
  ...
  %54 = load ptr, ptr %white_space.i, align 8, !tbaa !200
  %white_space37.i = getelementptr inbounds %struct.PNode, ptr %new_pn.0.i, i64 0, i32 19, i32 5
  store ptr %54, ptr %white_space37.i, align 8, !tbaa !200
...
if.then39.i:                                      ; preds = %if.end23.i
  ...
  store i32 %conv40.i, ptr %op_assoc41.i, align 8, !tbaa !210
  ...
  store i32 %56, ptr %op_priority42.i, align 4, !tbaa !216
...
if.then59.i:                                      ; preds = %if.then57.i
  %60 = load i32, ptr %path, align 8, !tbaa !211
...
for.body.i76:                                     ; preds = %do.body120.i, %for.body.lr.ph.i75
  ...
  %62 = load ptr, ptr %v64.i, align 8, !tbaa !212
...
for.body.i.i:                                     ; preds = %if.end.i.i.1, %for.body.lr.ph.i.i.new
  ...
  %74 = load i32, ptr %op_assoc.i.i, align 8, !tbaa !210
...
if.then.i.i:                                      ; preds = %for.body.i.i
  ...
  %75 = load i32, ptr %op_priority.i.i, align 4, !tbaa !216
...
if.end.i.i:                                       ; preds = %if.then.i.i, %for.body.i.i
  ...
  %78 = load i32, ptr %op_assoc.i.i.1, align 8, !tbaa !210
...
if.then.i.i.1:                                    ; preds = %if.end.i.i
  ...
  %79 = load i32, ptr %op_priority.i.i.1, align 4, !tbaa !216
...
for.body.i.i.epil:                                ; preds = %for.end.i.i.loopexit.unr-lcssa
  ...
  %82 = load i32, ptr %op_assoc.i.i.epil, align 8, !tbaa !210
...
if.then.i.i.epil:                                 ; preds = %for.body.i.i.epil
  ...
  %83 = load i32, ptr %op_priority.i.i.epil, align 4, !tbaa !216
...
for.end.i.i:                                      ; preds = %if.end.i.i.epil, %for.end.i.i.loopexit.unr-lcssa, %if.end124.i
  ...
  store i32 %conv.i.i, ptr %op_assoc9.i.i, align 8, !tbaa !210
  ...
  store i32 %86, ptr %op_priority11.i.i, align 4, !tbaa !216
...
land.lhs.true.i78:                                ; preds = %if.end128.i
  %92 = load i32, ptr %path, align 8, !tbaa !211
...
if.end8:                                          ; preds = %if.then5
  ...
  %107 = load ptr, ptr %all.i, align 8, !tbaa !246
  ...
  store ptr %new_pn.0.i, ptr %all.i, align 8, !tbaa !246
  br label %cleanup
...
sw.bb16:                                          ; preds = %cmp_pnodes.exit.thread, %cmp_pnodes.exit
  ...
  %203 = load ptr, ptr %all.i110, align 8, !tbaa !246
  ...
  store ptr %new_pn.0.i, ptr %all.i110, align 8, !tbaa !246
...
if.then13:                                        ; preds = %if.then10
  ...
  store i32 %inc16, ptr %v, align 8, !tbaa !211
...
if.then22:                                        ; preds = %if.else19
  ...
  store i32 %inc25, ptr %v, align 8, !tbaa !211
...
if.then33:                                        ; preds = %if.end31
  ...
  store i32 0, ptr %v, align 8, !tbaa !211
  store ptr null, ptr %vv.sroa.3.0..sroa_idx, align 8, !tbaa !212
...
do.body:                                          ; preds = %entry
  store i32 0, ptr %paths, align 8, !tbaa !211
  %v = getelementptr inbounds %struct.VecVecZNode, ptr %paths, i64 0, i32 2
  store ptr null, ptr %v, align 8, !tbaa !212
...
build_paths.exit:                                 ; preds = %do.body
  ...
  store ptr %e.i, ptr %v, align 8, !tbaa !212
  store i32 1, ptr %paths, align 8, !tbaa !211
  ...
  %.pre = load i32, ptr %paths, align 8, !tbaa !211
  %cmp200.not = icmp eq i32 %.pre, 0
  br i1 %cmp200.not, label %for.end101, label %for.body.lr.ph
...
for.body:                                         ; preds = %for.body.lr.ph, %for.inc99
  %indvars.iv215 = phi i64 [ 0, %for.body.lr.ph ], [ %indvars.iv.next216, %for.inc99 ]
  %7 = load ptr, ptr %v, align 8, !tbaa !212
  %arrayidx = getelementptr inbounds ptr, ptr %7, i64 %indvars.iv215
  %8 = load ptr, ptr %arrayidx, align 8, !tbaa !16
  %9 = load ptr, ptr %new_snode, align 8, !tbaa !203
...
for.cond17.preheader:                             ; preds = %for.body
  ...
  %10 = load ptr, ptr %v18, align 8, !tbaa !212
  ...
  br i1 %cmp22193.not, label %for.end, label %for.body24.lr.ph
...
for.end:                                          ; preds = %for.end.loopexit, %for.cond17.preheader
  %j.0.lcssa = phi i32 [ 0, %for.cond17.preheader ], [ %16, %for.end.loopexit ]
  %cmp44.not = icmp ult i32 %j.0.lcssa, %13
  br i1 %cmp44.not, label %if.end48, label %for.inc99

if.end48:                                         ; preds = %for.end, %for.body
  %17 = load i32, ptr %8, align 8, !tbaa !211
  %cmp50 = icmp ugt i32 %17, 1
  %v52 = getelementptr inbounds %struct.VecZNode, ptr %8, i64 0, i32 2
  %18 = load ptr, ptr %v52, align 8, !tbaa !212
  %19 = load ptr, ptr %18, align 8, !tbaa !16
  %20 = load ptr, ptr %19, align 8, !tbaa !160
  br i1 %cmp50, label %land.lhs.true, label %if.end65

land.lhs.true:                                    ; preds = %if.end48
  %op_assoc = getelementptr inbounds %struct.PNode, ptr %20, i64 0, i32 2
  %21 = load i32, ptr %op_assoc, align 8, !tbaa !210
  %tobool55.not = icmp eq i32 %21, 0
  br i1 %tobool55.not, label %lor.lhs.false, label %if.end23.i

lor.lhs.false:                                    ; preds = %land.lhs.true
  %arrayidx57 = getelementptr inbounds ptr, ptr %18, i64 1
  %22 = load ptr, ptr %arrayidx57, align 8, !tbaa !16
  %23 = load ptr, ptr %22, align 8, !tbaa !160
  %op_assoc59 = getelementptr inbounds %struct.PNode, ptr %23, i64 0, i32 2
  %24 = load i32, ptr %op_assoc59, align 8, !tbaa !210
  %tobool60.not = icmp eq i32 %24, 0
  br i1 %tobool60.not, label %if.end65, label %if.end6.i

if.end6.i:                                        ; preds = %lor.lhs.false
  %arrayidx9.i = getelementptr inbounds ptr, ptr %18, i64 1
  %25 = load ptr, ptr %arrayidx9.i, align 8, !tbaa !16
  %26 = load ptr, ptr %25, align 8, !tbaa !160
  %op_assoc11.i = getelementptr inbounds %struct.PNode, ptr %26, i64 0, i32 2
  %27 = load i32, ptr %op_assoc11.i, align 8, !tbaa !210
  %tobool12.not.i = icmp eq i32 %27, 0
  br i1 %tobool12.not.i, label %if.end65, label %if.end14.i

if.end14.i:                                       ; preds = %if.end6.i
  %28 = load i32, ptr %20, align 8, !tbaa !268
  %tobool15.not.i = icmp eq i32 %28, 0
  br i1 %tobool15.not.i, label %if.end23.i, label %if.then16.i

if.then16.i:                                      ; preds = %if.end14.i
  %op_priority.i = getelementptr inbounds %struct.PNode, ptr %26, i64 0, i32 3
  %29 = load i32, ptr %op_priority.i, align 4, !tbaa !216
  %priority.i = getelementptr inbounds %struct.PNode, ptr %20, i64 0, i32 1
  %30 = load i32, ptr %priority.i, align 4, !tbaa !269
  %cmp17.i.i = icmp sgt i32 %30, %29
  br i1 %cmp17.i.i, label %check_child.exit.i, label %cond.false19.i.i

cond.false19.i.i:                                 ; preds = %if.then16.i
  %cmp20.i.i = icmp slt i32 %30, %29
  br i1 %cmp20.i.i, label %check_child.exit.i, label %cond.false22.i.i

cond.false22.i.i:                                 ; preds = %cond.false19.i.i
  %and23.i.i = and i32 %28, 2
  %and26.i.i = lshr i32 %27, 1
  %and26.lobit.i.i = and i32 %and26.i.i, 1
  %add.i.i = or i32 %and26.lobit.i.i, 2
  %add29.i.i = add nuw nsw i32 %add.i.i, %and23.i.i
  %31 = zext i32 %add29.i.i to i64
  br label %check_child.exit.i

check_child.exit.i:                               ; preds = %cond.false22.i.i, %cond.false19.i.i, %if.then16.i
  %cond33.i.i = phi i64 [ 0, %if.then16.i ], [ %31, %cond.false22.i.i ], [ 1, %cond.false19.i.i ]
  %32 = and i32 %28, 20
  %or.cond46.i.i = icmp eq i32 %32, 0
  %cmp13.i.i = icmp eq i32 %28, 9
  %cond14.i.i = select i1 %cmp13.i.i, i64 1, i64 2
  %cond16.i.i = select i1 %or.cond46.i.i, i64 %cond14.i.i, i64 0
  %33 = and i32 %27, 20
  %or.cond.i.i = icmp eq i32 %33, 0
  %cmp.i.i = icmp eq i32 %27, 9
  %cond4.i.i = select i1 %cmp.i.i, i64 2, i64 3
  %cond5.i.i = select i1 %or.cond.i.i, i64 %cond4.i.i, i64 1
  %arrayidx37.i.i = getelementptr inbounds [4 x [3 x [6 x i32]]], ptr @child_table, i64 0, i64 %cond5.i.i, i64 %cond16.i.i, i64 %cond33.i.i
  %34 = load i32, ptr %arrayidx37.i.i, align 4, !tbaa !50
  %tobool19.not.i = icmp eq i32 %34, 0
  br i1 %tobool19.not.i, label %for.inc99, label %if.end23.i

if.end23.i:                                       ; preds = %land.lhs.true, %check_child.exit.i, %if.end14.i
  %35 = phi ptr [ %25, %check_child.exit.i ], [ %25, %if.end14.i ], [ %19, %land.lhs.true ]
  %i.0.i = phi i32 [ 1, %check_child.exit.i ], [ 1, %if.end14.i ], [ 0, %land.lhs.true ]
  %pn0.0.i = phi ptr [ %26, %check_child.exit.i ], [ %26, %if.end14.i ], [ %20, %land.lhs.true ]
  %add25.i = add nuw nsw i32 %i.0.i, 1
  %cmp26.i = icmp ugt i32 %17, %add25.i
  br i1 %cmp26.i, label %if.then27.i, label %if.else79.i

if.then27.i:                                      ; preds = %if.end23.i
  %idxprom30.i = zext i32 %add25.i to i64
  %arrayidx31.i = getelementptr inbounds ptr, ptr %18, i64 %idxprom30.i
  %36 = load ptr, ptr %arrayidx31.i, align 8, !tbaa !16
  %37 = load ptr, ptr %36, align 8, !tbaa !160
  %add34.i = or i32 %i.0.i, 2
  %cmp35.i = icmp ugt i32 %17, %add34.i
  br i1 %cmp35.i, label %if.then36.i, label %for.cond.preheader.i

for.cond.preheader.i:                             ; preds = %if.then27.i
  %sns.i = getelementptr inbounds %struct.ZNode, ptr %36, i64 0, i32 1
  %38 = load i32, ptr %sns.i, align 8, !tbaa !171
  %cmp48241.not.i = icmp eq i32 %38, 0
...
for.cond49.preheader.lr.ph.i:                     ; preds = %for.cond.preheader.i
  %v51.i = getelementptr inbounds %struct.ZNode, ptr %36, i64 0, i32 1, i32 2
  %39 = load ptr, ptr %v51.i, align 8, !tbaa !172
  %wide.trip.count270.i = zext i32 %38 to i64
...
if.then36.i:                                      ; preds = %if.then27.i
  ...
  %arrayidx40.i = getelementptr inbounds ptr, ptr %18, i64 %idxprom39.i
  %40 = load ptr, ptr %arrayidx40.i, align 8, !tbaa !16
  %41 = load ptr, ptr %40, align 8, !tbaa !160
  %call42.i = call fastcc i32 @check_assoc_priority(ptr noundef nonnull %pn0.0.i, ptr noundef %37, ptr noundef %41), !range !293
...
for.cond49.preheader.i:                           ; preds = %for.cond49.preheader.i.outer, %for.inc71.i
  ...
  %arrayidx53.i = getelementptr inbounds ptr, ptr %39, i64 %indvars.iv267.i
  %42 = load ptr, ptr %arrayidx53.i, align 8, !tbaa !16
  %zns.i = getelementptr inbounds %struct.SNode, ptr %42, i64 0, i32 6
  %43 = load i32, ptr %zns.i, align 8, !tbaa !158
  %cmp55239.not.i = icmp eq i32 %43, 0
  br i1 %cmp55239.not.i, label %for.inc71.i, label %for.body56.lr.ph.i

for.body56.lr.ph.i:                               ; preds = %for.cond49.preheader.i
  %v62.i = getelementptr inbounds %struct.SNode, ptr %42, i64 0, i32 6, i32 2
  %44 = load ptr, ptr %v62.i, align 8, !tbaa !159
  %wide.trip.count265.i = zext i32 %43 to i64
...
for.body56.i:                                     ; preds = %for.inc.i, %for.body56.lr.ph.i
  ...
  %arrayidx64.i = getelementptr inbounds ptr, ptr %44, i64 %indvars.iv262.i
  %45 = load ptr, ptr %arrayidx64.i, align 8, !tbaa !16
...
land.lhs.true.i:                                  ; preds = %for.body56.i
  ...
  %call67.i = call fastcc i32 @check_assoc_priority(ptr noundef %pn0.0.i, ptr noundef %37, ptr noundef %46), !range !293
...
if.then75.i:                                      ; preds = %for.end73.i, %for.cond.preheader.i
  %call76.i = call fastcc i32 @check_assoc_priority(ptr noundef %pn0.0.i, ptr noundef %37, ptr noundef null), !range !293
  br label %check_path_priorities_internal.exit

if.else79.i:                                      ; preds = %if.end23.i
  %sns84.i = getelementptr inbounds %struct.ZNode, ptr %35, i64 0, i32 1
  %47 = load i32, ptr %sns84.i, align 8, !tbaa !171
  %cmp86237.not.i = icmp eq i32 %47, 0
  br i1 %cmp86237.not.i, label %if.end65, label %for.cond88.preheader.lr.ph.i

for.cond88.preheader.lr.ph.i:                     ; preds = %if.else79.i
  %v90.i = getelementptr inbounds %struct.ZNode, ptr %35, i64 0, i32 1, i32 2
  %48 = load ptr, ptr %v90.i, align 8, !tbaa !172
  %wide.trip.count260.i = zext i32 %47 to i64
...
for.cond88.preheader.i:                           ; preds = %for.inc147.i, %for.cond88.preheader.lr.ph.i
  ...
  %arrayidx92.i = getelementptr inbounds ptr, ptr %48, i64 %indvars.iv257.i
  %49 = load ptr, ptr %arrayidx92.i, align 8, !tbaa !16
  %zns93.i = getelementptr inbounds %struct.SNode, ptr %49, i64 0, i32 6
  %50 = load i32, ptr %zns93.i, align 8, !tbaa !158
  %cmp95235.not.i = icmp eq i32 %50, 0
  br i1 %cmp95235.not.i, label %for.inc147.i, label %for.body96.lr.ph.i

for.body96.lr.ph.i:                               ; preds = %for.cond88.preheader.i
  %v102.i = getelementptr inbounds %struct.SNode, ptr %49, i64 0, i32 6, i32 2
  %51 = load ptr, ptr %v102.i, align 8, !tbaa !159
  %wide.trip.count255.i = zext i32 %50 to i64
...
for.body96.i:                                     ; preds = %for.inc144.i, %for.body96.lr.ph.i
  ...
  %arrayidx104.i = getelementptr inbounds ptr, ptr %51, i64 %indvars.iv252.i
  %52 = load ptr, ptr %arrayidx104.i, align 8, !tbaa !16
  %tobool105.not.i = icmp eq ptr %52, null
  br i1 %tobool105.not.i, label %for.inc144.i, label %for.cond107.preheader.i

for.cond107.preheader.i:                          ; preds = %for.body96.i
  %sns108.i = getelementptr inbounds %struct.ZNode, ptr %52, i64 0, i32 1
  %53 = load i32, ptr %sns108.i, align 8, !tbaa !171
  %cmp110233.not.i = icmp eq i32 %53, 0
...
for.cond112.preheader.lr.ph.i:                    ; preds = %for.cond107.preheader.i
  %v114.i = getelementptr inbounds %struct.ZNode, ptr %52, i64 0, i32 1, i32 2
  %54 = load ptr, ptr %v114.i, align 8, !tbaa !172
  %wide.trip.count250.i = zext i32 %53 to i64
...
for.cond112.preheader.i:                          ; preds = %for.inc140.i, %for.cond112.preheader.lr.ph.i
  ...
  %arrayidx116.i = getelementptr inbounds ptr, ptr %54, i64 %indvars.iv247.i
  %55 = load ptr, ptr %arrayidx116.i, align 8, !tbaa !16
  %zns117.i = getelementptr inbounds %struct.SNode, ptr %55, i64 0, i32 6
  %56 = load i32, ptr %zns117.i, align 8, !tbaa !158
  %cmp119231.not.i = icmp eq i32 %56, 0
  br i1 %cmp119231.not.i, label %for.inc140.i, label %for.body120.lr.ph.i

for.body120.lr.ph.i:                              ; preds = %for.cond112.preheader.i
  %v126.i = getelementptr inbounds %struct.SNode, ptr %55, i64 0, i32 6, i32 2
  %57 = load ptr, ptr %v126.i, align 8, !tbaa !159
...
for.body120.i:                                    ; preds = %for.inc137.i, %for.body120.lr.ph.i
  ...
  %arrayidx128.i = getelementptr inbounds ptr, ptr %57, i64 %indvars.iv.i
  %58 = load ptr, ptr %arrayidx128.i, align 8, !tbaa !16
  %tobool129.not.i = icmp eq ptr %58, null
  br i1 %tobool129.not.i, label %for.inc137.i, label %land.lhs.true130.i

land.lhs.true130.i:                               ; preds = %for.body120.i
  %59 = load ptr, ptr %52, align 8, !tbaa !160
  %60 = load ptr, ptr %58, align 8, !tbaa !160
  %call133.i = call fastcc i32 @check_assoc_priority(ptr noundef %pn0.0.i, ptr noundef %59, ptr noundef %60), !range !293
...
if.end65:                                         ; preds = %for.inc147.i, %land.lhs.true.i, %land.lhs.true130.i, %if.end48, %if.else79.i, %if.end6.i, %check_path_priorities_internal.exit, %lor.lhs.false
  %61 = load i32, ptr %reductions, align 8, !tbaa !164
  %inc66 = add nsw i32 %61, 1
  store i32 %inc66, ptr %reductions, align 8, !tbaa !164
  %arrayidx72 = getelementptr inbounds ptr, ptr %18, i64 %idxprom71
  %62 = load ptr, ptr %arrayidx72, align 8, !tbaa !16
  %63 = load ptr, ptr %reduction, align 8, !tbaa !202
  %symbol74 = getelementptr inbounds %struct.D_Reduction, ptr %63, i64 0, i32 1
  %64 = load i16, ptr %symbol74, align 2, !tbaa !196
  %conv75 = zext i16 %64 to i32
  %65 = load ptr, ptr %62, align 8, !tbaa !160
  %start_loc = getelementptr inbounds %struct.PNode, ptr %65, i64 0, i32 19, i32 1
  %66 = load ptr, ptr %loc77, align 8, !tbaa !173
  %call80 = call fastcc ptr @add_PNode(ptr noundef %p, i32 noundef %conv75, ptr noundef nonnull %start_loc, ptr noundef %66, ptr noundef %20, ptr noundef %63, ptr noundef nonnull %8, ptr noundef null)
...
for.cond83.preheader:                             ; preds = %if.end65
  %sns84 = getelementptr inbounds %struct.ZNode, ptr %62, i64 0, i32 1
  %67 = load i32, ptr %sns84, align 8, !tbaa !171
  %cmp86198.not = icmp eq i32 %67, 0
  br i1 %cmp86198.not, label %for.inc99, label %for.body88.lr.ph

for.body88.lr.ph:                                 ; preds = %for.cond83.preheader
  %v91 = getelementptr inbounds %struct.ZNode, ptr %62, i64 0, i32 1, i32 2
  br label %for.body88

for.body88:                                       ; preds = %for.body88.lr.ph, %for.body88
  %indvars.iv212 = phi i64 [ 0, %for.body88.lr.ph ], [ %indvars.iv.next213, %for.body88 ]
  %68 = load ptr, ptr %v91, align 8, !tbaa !172
  %arrayidx93 = getelementptr inbounds ptr, ptr %68, i64 %indvars.iv212
  %69 = load ptr, ptr %arrayidx93, align 8, !tbaa !16
  call fastcc void @goto_PNode(ptr noundef %p, ptr noundef nonnull %loc77, ptr noundef nonnull %call80, ptr noundef %69)
  %indvars.iv.next213 = add nuw nsw i64 %indvars.iv212, 1
  %70 = load i32, ptr %sns84, align 8, !tbaa !171
  %71 = zext i32 %70 to i64
  %cmp86 = icmp ult i64 %indvars.iv.next213, %71
  br i1 %cmp86, label %for.body88, label %for.inc99, !llvm.loop !300

for.inc99:                                        ; preds = %for.inc, %for.inc71.i.thread, %for.body88, %for.cond83.preheader, %for.end73.i, %check_child.exit.i, %if.end65, %check_path_priorities_internal.exit, %for.end
  %indvars.iv.next216 = add nuw nsw i64 %indvars.iv215, 1
  %72 = load i32, ptr %paths, align 8, !tbaa !211
  %73 = zext i32 %72 to i64
  %cmp = icmp ult i64 %indvars.iv.next216, %73
  br i1 %cmp, label %for.body, label %for.end101, !llvm.loop !301

for.end101:                                       ; preds = %for.inc99, %do.body, %build_paths.exit
  %74 = phi i32 [ 0, %build_paths.exit ], [ 0, %do.body ], [ %72, %for.inc99 ]
  %75 = load ptr, ptr getelementptr inbounds (%struct.VecZNode, ptr @path1, i64 0, i32 2), align 8
  %tobool.i = icmp ne ptr %75, null
  %cmp.i164 = icmp ne ptr %75, getelementptr inbounds (%struct.VecZNode, ptr @path1, i64 0, i32 3)
...
if.then.i:                                        ; preds = %for.end101
  ...
  %.pre221 = load i32, ptr %paths, align 8, !tbaa !211
  br label %do.body1.i

do.body1.i:                                       ; preds = %if.then.i, %for.end101
  %76 = phi i32 [ %.pre221, %if.then.i ], [ %74, %for.end101 ]
  store i32 0, ptr @path1, align 8, !tbaa !211
  store ptr null, ptr getelementptr inbounds (%struct.VecZNode, ptr @path1, i64 0, i32 2), align 8, !tbaa !212
  %cmp482.i = icmp ugt i32 %76, 1
...
do.body5.i:                                       ; preds = %do.body1.i, %do.body23.i
  ...
  %77 = load ptr, ptr %v, align 8, !tbaa !212
  %arrayidx.i167 = getelementptr inbounds ptr, ptr %77, i64 %indvars.iv.i166
  %78 = load ptr, ptr %arrayidx.i167, align 8, !tbaa !16
  %v6.i = getelementptr inbounds %struct.VecZNode, ptr %78, i64 0, i32 2
  %79 = load ptr, ptr %v6.i, align 8, !tbaa !212
  %tobool7.not.i = icmp eq ptr %79, null
  %e.i168 = getelementptr inbounds %struct.VecZNode, ptr %78, i64 0, i32 3
  %cmp16.not.i = icmp eq ptr %79, %e.i168
...
if.then17.i:                                      ; preds = %do.body5.i
  ...
  %.pre.i = load ptr, ptr %v, align 8, !tbaa !212
...
do.body23.i:                                      ; preds = %if.then17.i, %do.body5.i
  %80 = phi ptr [ %78, %do.body5.i ], [ %.pre85.i, %if.then17.i ]
  store i32 0, ptr %80, align 8, !tbaa !211
  %v31.i = getelementptr inbounds %struct.VecZNode, ptr %80, i64 0, i32 2
  store ptr null, ptr %v31.i, align 8, !tbaa !212
  %81 = load ptr, ptr %v, align 8, !tbaa !212
  %arrayidx38.i = getelementptr inbounds ptr, ptr %81, i64 %indvars.iv.i166
  %82 = load ptr, ptr %arrayidx38.i, align 8, !tbaa !16
  call void @free(ptr noundef %82) #23
  %indvars.iv.next.i169 = add nuw nsw i64 %indvars.iv.i166, 1
  %83 = load i32, ptr %paths, align 8, !tbaa !211
  %84 = zext i32 %83 to i64
  %cmp4.i170 = icmp ult i64 %indvars.iv.next.i169, %84
  br i1 %cmp4.i170, label %do.body5.i, label %do.body39.i, !llvm.loop !302

do.body39.i:                                      ; preds = %do.body23.i, %do.body1.i
  %85 = load ptr, ptr %v, align 8, !tbaa !212
  %tobool41.not.i = icmp eq ptr %85, null
  %e44.i = getelementptr inbounds %struct.VecVecZNode, ptr %paths, i64 0, i32 3
  %cmp46.not.i = icmp eq ptr %85, %e44.i
...
do.body103:                                       ; preds = %free_paths.exit, %if.then7, %if.then
  ...
  %86 = load i32, ptr %refcount, align 8, !tbaa !101
  %dec = add i32 %86, -1
  store i32 %dec, ptr %refcount, align 8, !tbaa !101
...
do.end108:                                        ; preds = %if.then105, %do.body103
  %free_reductions = getelementptr inbounds %struct.Parser, ptr %p, i64 0, i32 18
  %87 = load ptr, ptr %free_reductions, align 8, !tbaa !125
  %next = getelementptr inbounds %struct.Reduction, ptr %r, i64 0, i32 5
  store ptr %87, ptr %next, align 8, !tbaa !128
...
land.lhs.true19:                                  ; preds = %land.lhs.true
  ...
  %8 = load ptr, ptr %final_code, align 8, !tbaa !233
...
if.then34:                                        ; preds = %if.end27
  ...
  %call = tail call fastcc i32 @commit_stack(ptr noundef %p, ptr noundef %10), !range !219
...
if.end:                                           ; preds = %if.else, %if.then
  ...
  store i32 0, ptr %depth, align 8, !tbaa !189
  ...
  %4 = load ptr, ptr %all.i, align 8, !tbaa !247
  store ptr %4, ptr %all_next3, align 8, !tbaa !143
  store ptr %sn.0, ptr %all.i, align 8, !tbaa !247
...
for.body.i:                                       ; preds = %for.body.i, %for.body.lr.ph.i.new
  ...
  %4 = load i32, ptr %depth.i, align 8, !tbaa !189
  ...
  %6 = load i32, ptr %depth.i.1, align 8, !tbaa !189
  ...
  %8 = load i32, ptr %depth.i.2, align 8, !tbaa !189
  ...
  %10 = load i32, ptr %depth.i.3, align 8, !tbaa !189
...
for.body.i.epil:                                  ; preds = %znode_depth.exit.loopexit.unr-lcssa, %for.body.i.epil
  ...
  %12 = load i32, ptr %depth.i.epil, align 8, !tbaa !189
...
if.end:                                           ; preds = %for.body
  %16 = load ptr, ptr %x.099, align 8, !tbaa !201
...
for.body.i89:                                     ; preds = %for.body.i89, %for.body.lr.ph.i81.new
  ...
  %21 = load i32, ptr %depth.i85, align 8, !tbaa !189
  ...
  %23 = load i32, ptr %depth.i85.1, align 8, !tbaa !189
  ...
  %25 = load i32, ptr %depth.i85.2, align 8, !tbaa !189
  ...
  %27 = load i32, ptr %depth.i85.3, align 8, !tbaa !189
...
for.body.i89.epil:                                ; preds = %znode_depth.exit91.loopexit.unr-lcssa, %for.body.i89.epil
  ...
  %29 = load i32, ptr %depth.i85.epil, align 8, !tbaa !189
...
land.lhs.true18:                                  ; preds = %while.body
  %31 = load ptr, ptr %x.1, align 8, !tbaa !201
...
land.lhs.true21:                                  ; preds = %land.lhs.true18
  ...
  %32 = load ptr, ptr %reduction22, align 8, !tbaa !202
...
if.end35:                                         ; preds = %if.else, %if.then31
  ...
  store ptr %z, ptr %r.0, align 8, !tbaa !201
  ...
  store ptr null, ptr %new_snode, align 8, !tbaa !203
  ...
  store ptr %reduction, ptr %reduction38, align 8, !tbaa !202
...
if.then:                                          ; preds = %entry
  ...
  %4 = load ptr, ptr %v4, align 8, !tbaa !212
...
if.end23:                                         ; preds = %if.else, %if.then13
  ...
  store i32 %12, ptr %v, align 8, !tbaa !211
  %conv = zext i32 %12 to i64
  %mul = shl nuw nsw i64 %conv, 3
  %calloc = tail call ptr @calloc(i64 1, i64 %mul)
  %v29 = getelementptr inbounds %struct.VecZNode, ptr %v, i64 0, i32 2
  store ptr %calloc, ptr %v29, align 8, !tbaa !212
...
for.body.lr.ph.i:                                 ; preds = %for.cond.preheader.i
  ...
  %14 = load ptr, ptr %v3.i, align 8, !tbaa !212
...
if.end10.i:                                       ; preds = %if.end23
  ...
  %23 = load ptr, ptr %v16.i, align 8, !tbaa !212
...
new_ZNode.exit:                                   ; preds = %if.then.i, %if.else.i271
  ...
  %reductions290 = getelementptr inbounds %struct.D_State, ptr %39, i64 0, i32 2
  %40 = load i32, ptr %reductions290, align 8, !tbaa !257
  %cmp30291.not = icmp eq i32 %40, 0
  br i1 %cmp30291.not, label %for.end, label %for.body
...
for.cond48.preheader:                             ; preds = %for.end
  %right_epsilon_hints295 = getelementptr inbounds %struct.D_State, ptr %48, i64 0, i32 3
  %50 = load i32, ptr %right_epsilon_hints295, align 8, !tbaa !319
  %cmp51296.not = icmp eq i32 %50, 0
  br i1 %cmp51296.not, label %if.end96, label %for.body53.lr.ph
...
for.body53:                                       ; preds = %for.body53.lr.ph, %cleanup
  ...
  %indvars.iv312 = phi i64 [ %indvars.iv.next313, %cleanup ], [ 0, %for.body53.lr.ph ]
  %v56 = getelementptr inbounds %struct.D_State, ptr %53, i64 0, i32 3, i32 1
  %54 = load ptr, ptr %v56, align 8, !tbaa !320
  %arrayidx58 = getelementptr inbounds %struct.D_RightEpsilonHint, ptr %54, i64 %indvars.iv312
  %preceeding_state = getelementptr inbounds %struct.D_RightEpsilonHint, ptr %54, i64 %indvars.iv312, i32 1
...
for.cond66.preheader:                             ; preds = %land.lhs.true9.i
  ...
  %cmp69293.not = icmp eq i32 %69, 0
  br i1 %cmp69293.not, label %cleanup, label %for.body71.lr.ph

for.body71.lr.ph:                                 ; preds = %for.cond66.preheader
  %v73 = getelementptr inbounds %struct.SNode, ptr %sn.029.i, i64 0, i32 6, i32 2
  %reduction = getelementptr inbounds %struct.D_RightEpsilonHint, ptr %54, i64 %indvars.iv312, i32 2
  br label %for.body71
...
for.body71:                                       ; preds = %for.body71.lr.ph, %for.inc89
  %indvars.iv309 = phi i64 [ 0, %for.body71.lr.ph ], [ %indvars.iv.next310, %for.inc89 ]
  %70 = load ptr, ptr %v73, align 8, !tbaa !159
  %arrayidx75 = getelementptr inbounds ptr, ptr %70, i64 %indvars.iv309
...
if.then84:                                        ; preds = %if.then77
  ...
  store ptr %call, ptr %new_snode, align 8, !tbaa !203
...
cleanup:                                          ; preds = %for.inc.i, %cleanup.loopexit, %for.cond66.preheader, %if.then.i275, %for.body53
  ...
  %cmp51 = icmp ult i64 %indvars.iv.next313, %78
...
if.end96:                                         ; preds = %for.body.lr.ph.i, %for.body.i.1, %for.body.i.2, %cleanup, %for.body53.lr.ph, %for.cond48.preheader, %if.else.4.i, %if.else.3.i, %if.else.2.i, %if.else.1.i, %if.else.i, %for.end
  ...
  %cmp99298.not = icmp eq i32 %79, 0
  br i1 %cmp99298.not, label %for.end112, label %for.body101.lr.ph

for.body101.lr.ph:                                ; preds = %if.end96
  %v103 = getelementptr inbounds %struct.ZNode, ptr %z.0, i64 0, i32 1, i32 2
  %80 = load ptr, ptr %v103, align 8, !tbaa !172
  %wide.trip.count = zext i32 %79 to i64
  br label %for.body101

for.body101:                                      ; preds = %for.body101.lr.ph, %for.inc110
  %indvars.iv315 = phi i64 [ 0, %for.body101.lr.ph ], [ %indvars.iv.next316, %for.inc110 ]
  %arrayidx105 = getelementptr inbounds ptr, ptr %80, i64 %indvars.iv315
  %81 = load ptr, ptr %arrayidx105, align 8, !tbaa !16
  %cmp106 = icmp eq ptr %81, %ps
  br i1 %cmp106, label %for.end112.loopexit, label %for.inc110

for.inc110:                                       ; preds = %for.body101
  %indvars.iv.next316 = add nuw nsw i64 %indvars.iv315, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next316, %wide.trip.count
  br i1 %exitcond.not, label %do.body118, label %for.body101, !llvm.loop !328

for.end112.loopexit:                              ; preds = %for.body101
  %82 = trunc i64 %indvars.iv315 to i32
  br label %for.end112

for.end112:                                       ; preds = %for.end112.loopexit, %if.end96
  %i.0.lcssa = phi i32 [ 0, %if.end96 ], [ %82, %for.end112.loopexit ]
  %cmp115.not = icmp ult i32 %i.0.lcssa, %79
  br i1 %cmp115.not, label %cleanup181, label %do.body118

do.body118:                                       ; preds = %for.inc110, %for.end112
  %v120 = getelementptr inbounds %struct.ZNode, ptr %z.0, i64 0, i32 1, i32 2
  %83 = load ptr, ptr %v120, align 8, !tbaa !172
  %tobool121.not = icmp eq ptr %83, null
...
if.then143:                                       ; preds = %if.then138
  ...
  %arrayidx150 = getelementptr inbounds ptr, ptr %83, i64 %idxprom149
...
if.then157:                                       ; preds = %if.else152
  ...
  %arrayidx164 = getelementptr inbounds ptr, ptr %83, i64 %idxprom163
  store ptr %ps, ptr %arrayidx164, align 8, !tbaa !16
  br label %do.end170

if.end167:                                        ; preds = %if.then138, %if.else152
...
do.body174:                                       ; preds = %do.end170
  ...
  %84 = load i32, ptr %refcount175, align 8, !tbaa !101
  %inc176 = add i32 %84, 1
  store i32 %inc176, ptr %refcount175, align 8, !tbaa !101
  br label %cleanup181

cleanup181:                                       ; preds = %for.end112, %do.body174, %do.end170, %entry
  ret void
}
...
entry:
  %0 = load i32, ptr %paths, align 8, !tbaa !211
  %tobool.not = icmp eq i32 %0, 0
...
do.body:                                          ; preds = %entry, %if.else
  ...
  store i32 0, ptr %pv.0, align 8, !tbaa !211
...
if.else17:                                        ; preds = %do.body5
  ...
  %7 = load i32, ptr %pv.0, align 8, !tbaa !211
...
if.then25:                                        ; preds = %if.then22
  %8 = load ptr, ptr %v42, align 8, !tbaa !212
  ...
  %10 = load ptr, ptr %v29, align 8, !tbaa !212
  ...
  store i32 %inc34, ptr %pv.0, align 8, !tbaa !211
...
if.then41:                                        ; preds = %if.else38
  %12 = load ptr, ptr %v42, align 8, !tbaa !212
...
if.end55:                                         ; preds = %if.then22, %if.else38
  %16 = load ptr, ptr %v42, align 8, !tbaa !212
  ...
  %18 = load ptr, ptr %v59, align 8, !tbaa !212
...
if.then:                                          ; preds = %entry
  ...
  %inc = add i32 %5, 1
  store i32 %inc, ptr %4, align 8, !tbaa !211
...
if.else:                                          ; preds = %entry
  %cmp = icmp eq ptr %2, %e
  %6 = load i32, ptr %1, align 8, !tbaa !211
...
if.then30:                                        ; preds = %if.then24
  ...
  store i32 %inc39, ptr %1, align 8, !tbaa !211
...
if.then48:                                        ; preds = %if.else42
  %inc57 = add i32 %6, 1
  store i32 %inc57, ptr %1, align 8, !tbaa !211
...
do.body.i:                                        ; preds = %if.else.i, %if.then94
  ...
  store i32 0, ptr %pv.0.i, align 8, !tbaa !211
  %v.i = getelementptr inbounds %struct.VecZNode, ptr %pv.0.i, i64 0, i32 2
  store ptr null, ptr %v.i, align 8, !tbaa !212
...
if.then8.i:                                       ; preds = %do.body5.i
  ...
  %24 = load ptr, ptr %v10.i, align 8, !tbaa !212
  %arrayidx12.i = getelementptr inbounds ptr, ptr %24, i64 %indvars.iv.i
  %25 = load ptr, ptr %arrayidx12.i, align 8, !tbaa !16
  store ptr %e19.i, ptr %v.i, align 8, !tbaa !212
  %26 = load i32, ptr %pv.0.i, align 8, !tbaa !211
  %inc.i = add i32 %26, 1
  store i32 %inc.i, ptr %pv.0.i, align 8, !tbaa !211
...
if.else17.i:                                      ; preds = %do.body5.i
  ...
  %27 = load i32, ptr %pv.0.i, align 8, !tbaa !211
...
if.then25.i:                                      ; preds = %if.then22.i
  %28 = load ptr, ptr %v, align 8, !tbaa !212
  ...
  %30 = load ptr, ptr %v29.i, align 8, !tbaa !212
  ...
  store i32 %inc34.i, ptr %pv.0.i, align 8, !tbaa !211
...
if.then41.i:                                      ; preds = %if.else38.i
  %32 = load ptr, ptr %v, align 8, !tbaa !212
  ...
  %34 = load ptr, ptr %v45.i, align 8, !tbaa !212
  ...
  store i32 %inc50.i, ptr %pv.0.i, align 8, !tbaa !211
...
if.end55.i:                                       ; preds = %if.else38.i, %if.then22.i
  %36 = load ptr, ptr %v, align 8, !tbaa !212
  ...
  %38 = load ptr, ptr %v59.i, align 8, !tbaa !212
...
new_VecZNode.exit:                                ; preds = %for.inc.i, %do.body.i
  store ptr %e105, ptr %v, align 8, !tbaa !212
  %40 = load i32, ptr %paths, align 8, !tbaa !211
  %inc100 = add i32 %40, 1
  store i32 %inc100, ptr %paths, align 8, !tbaa !211
...
if.else103:                                       ; preds = %do.body91
  ...
  %41 = load i32, ptr %paths, align 8, !tbaa !211
...
if.then111:                                       ; preds = %if.then108
  ...
  %42 = load ptr, ptr %v, align 8, !tbaa !212
  %43 = load i32, ptr %paths, align 8, !tbaa !211
  %inc117 = add i32 %43, 1
  store i32 %inc117, ptr %paths, align 8, !tbaa !211
...
if.then125:                                       ; preds = %if.else121
  ...
  %44 = load ptr, ptr %v, align 8, !tbaa !212
  %45 = load i32, ptr %paths, align 8, !tbaa !211
  %inc131 = add i32 %45, 1
  store i32 %inc131, ptr %paths, align 8, !tbaa !211
...
if.end136:                                        ; preds = %if.then108, %if.else121
  ...
  %.pre250 = load i32, ptr %paths, align 8, !tbaa !211
  br label %do.end141
...
if.then13:                                        ; preds = %if.then11
  ...
  %5 = load i32, ptr %op_priority, align 4, !tbaa !216
...
if.then22:                                        ; preds = %if.else
  ...
  %11 = load i32, ptr %op_priority23, align 4, !tbaa !216
  %op_priority25 = getelementptr inbounds %struct.PNode, ptr %pn0, i64 0, i32 3
  %12 = load i32, ptr %op_priority25, align 4, !tbaa !216
...
if.then33:                                        ; preds = %if.else31
  ...
  %17 = load i32, ptr %op_assoc34, align 8, !tbaa !210
...
land.lhs.true:                                    ; preds = %if.then33
  ...
  %18 = load i32, ptr %op_priority36, align 4, !tbaa !216
  %op_priority38 = getelementptr inbounds %struct.PNode, ptr %pn0, i64 0, i32 3
  %19 = load i32, ptr %op_priority38, align 4, !tbaa !216
...
if.then48:                                        ; preds = %if.end45
  ...
  %25 = load i32, ptr %op_priority49, align 4, !tbaa !216
...
land.lhs.true:                                    ; preds = %entry
  ...
  %1 = load ptr, ptr %final_code, align 8, !tbaa !233
