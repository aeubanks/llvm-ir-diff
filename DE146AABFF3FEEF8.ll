...
foo.exit.thread.i:                                ; preds = %lor.lhs.false.i.i
  ...
  %rem.i227174.i = srem i16 %2, 2
  %rem.i22.sext75.i = sext i16 %rem.i227174.i to i32
  store i32 %rem.i22.sext75.i, ptr @f, align 4, !tbaa !9
...
foo.exit.i:                                       ; preds = %cond.false.i.i, %entry
  ...
  %rem.i2271.i = srem i16 %3, 2
  %rem.i22.sext.i = sext i16 %rem.i2271.i to i32
...
lor.lhs.false.i29.i:                              ; preds = %foo.exit.i, %foo.exit.thread.i
  %cond.i77.i = phi i32 [ %conv.i, %foo.exit.thread.i ], [ %cond.i.i, %foo.exit.i ]
  %cmp1.i27.i = icmp eq i16 %0, 1
  %tobool.i43.i = icmp ne i32 %cond.i77.i, 0
...
cond.false.i48.i:                                 ; preds = %lor.lhs.false.i29.i
  %rem.i47.i = srem i32 %cond.i77.i, %conv.i
  br label %bar.exit

bar.exit:                                         ; preds = %foo.exit.i, %lor.lhs.false.i29.i, %cond.false.i48.i
  %cond.i49.i = phi i32 [ %rem.i47.i, %cond.false.i48.i ], [ %cond.i77.i, %lor.lhs.false.i29.i ], [ %cond.i.i, %foo.exit.i ]
