...
true_bb8:                                         ; preds = %_halide_buffer_is_bounds_query.exit7
  ...
  %.sroa.2470.0..sroa_idx = getelementptr inbounds i8, ptr %107, i64 4
  store i32 %108, ptr %.sroa.2470.0..sroa_idx, align 4
  %.sroa.3471.0..sroa_idx = getelementptr inbounds i8, ptr %107, i64 8
  store i32 1, ptr %.sroa.3471.0..sroa_idx, align 4
  %.sroa.4472.0..sroa_idx = getelementptr inbounds i8, ptr %107, i64 12
  store i32 0, ptr %.sroa.4472.0..sroa_idx, align 4
  ...
  %.sroa.7474.16..sroa_idx = getelementptr inbounds %struct.halide_dimension_t, ptr %111, i64 1, i32 1
  store i32 %70, ptr %.sroa.7474.16..sroa_idx, align 4
  %.sroa.8475.16..sroa_idx = getelementptr inbounds %struct.halide_dimension_t, ptr %111, i64 1, i32 2
  store i32 %108, ptr %.sroa.8475.16..sroa_idx, align 4
  %.sroa.9476.16..sroa_idx = getelementptr inbounds %struct.halide_dimension_t, ptr %111, i64 1, i32 3
  store i32 0, ptr %.sroa.9476.16..sroa_idx, align 4
  ...
  %.sroa.12478.32..sroa_idx = getelementptr inbounds %struct.halide_dimension_t, ptr %113, i64 2, i32 1
  store i32 %76, ptr %.sroa.12478.32..sroa_idx, align 4
  %.sroa.13479.32..sroa_idx = getelementptr inbounds %struct.halide_dimension_t, ptr %113, i64 2, i32 2
  store i32 %109, ptr %.sroa.13479.32..sroa_idx, align 4
  %.sroa.14480.32..sroa_idx = getelementptr inbounds %struct.halide_dimension_t, ptr %113, i64 2, i32 3
  store i32 0, ptr %.sroa.14480.32..sroa_idx, align 4
...
"for k$3.s0.n1":                                  ; preds = %"assert succeeded77"
  ...
  %reass.sub483 = sub i64 %reass.mul, %256
  %261 = add i64 %reass.sub483, 4
  ...
  %reass.sub483.1 = sub i64 %reass.mul.1, %256
  %271 = add i64 %reass.sub483.1, 4
  ...
  %reass.sub483.2 = sub i64 %reass.mul.2, %256
  %281 = add i64 %reass.sub483.2, 4
  ...
  %reass.sub483.3 = sub i64 %reass.mul.3, %256
  %291 = add i64 %reass.sub483.3, 4
  ...
  %reass.sub483.4 = sub i64 %reass.mul.4, %256
  %301 = add i64 %reass.sub483.4, 4
  ...
  %reass.sub483.5 = sub i64 %reass.mul.5, %256
  %311 = add i64 %reass.sub483.5, 4
  ...
  %reass.sub483.6 = sub i64 %reass.mul.6, %256
  %321 = add i64 %reass.sub483.6, 4
  ...
  %reass.sub483.7 = sub i64 %reass.mul.7, %256
  %331 = add i64 %reass.sub483.7, 4
  ...
  %strided.vec487 = shufflevector <32 x float> %wide.vec, <32 x float> poison, <4 x i32> <i32 1, i32 9, i32 17, i32 25>
  %strided.vec488 = shufflevector <32 x float> %wide.vec, <32 x float> poison, <4 x i32> <i32 2, i32 10, i32 18, i32 26>
  %strided.vec489 = shufflevector <32 x float> %wide.vec, <32 x float> poison, <4 x i32> <i32 3, i32 11, i32 19, i32 27>
  %strided.vec490 = shufflevector <32 x float> %wide.vec, <32 x float> poison, <4 x i32> <i32 4, i32 12, i32 20, i32 28>
  %strided.vec491 = shufflevector <32 x float> %wide.vec, <32 x float> poison, <4 x i32> <i32 5, i32 13, i32 21, i32 29>
  %strided.vec492 = shufflevector <32 x float> %wide.vec, <32 x float> poison, <4 x i32> <i32 6, i32 14, i32 22, i32 30>
  %strided.vec493 = shufflevector <32 x float> %wide.vec, <32 x float> poison, <4 x i32> <i32 7, i32 15, i32 23, i32 31>
  %336 = fadd <4 x float> %strided.vec, %strided.vec490
  %wide.vec494 = load <32 x float>, ptr %"inv_X8$7.117", align 16, !tbaa !32
  %strided.vec495 = shufflevector <32 x float> %wide.vec494, <32 x float> poison, <4 x i32> <i32 0, i32 8, i32 16, i32 24>
  %strided.vec496 = shufflevector <32 x float> %wide.vec494, <32 x float> poison, <4 x i32> <i32 1, i32 9, i32 17, i32 25>
  %strided.vec497 = shufflevector <32 x float> %wide.vec494, <32 x float> poison, <4 x i32> <i32 2, i32 10, i32 18, i32 26>
  %strided.vec498 = shufflevector <32 x float> %wide.vec494, <32 x float> poison, <4 x i32> <i32 3, i32 11, i32 19, i32 27>
  %strided.vec499 = shufflevector <32 x float> %wide.vec494, <32 x float> poison, <4 x i32> <i32 4, i32 12, i32 20, i32 28>
  %strided.vec500 = shufflevector <32 x float> %wide.vec494, <32 x float> poison, <4 x i32> <i32 5, i32 13, i32 21, i32 29>
  %strided.vec501 = shufflevector <32 x float> %wide.vec494, <32 x float> poison, <4 x i32> <i32 6, i32 14, i32 22, i32 30>
  %strided.vec502 = shufflevector <32 x float> %wide.vec494, <32 x float> poison, <4 x i32> <i32 7, i32 15, i32 23, i32 31>
  %337 = fadd <4 x float> %strided.vec495, %strided.vec499
  %338 = fadd <4 x float> %strided.vec488, %strided.vec492
  %339 = fadd <4 x float> %strided.vec497, %strided.vec501
  %340 = fadd <4 x float> %336, %338
  %341 = fadd <4 x float> %337, %339
  %342 = fsub <4 x float> %336, %338
  %343 = fsub <4 x float> %337, %339
  %344 = fsub <4 x float> %strided.vec, %strided.vec490
  %345 = fsub <4 x float> %strided.vec495, %strided.vec499
  %346 = fsub <4 x float> %strided.vec497, %strided.vec501
  %347 = fsub <4 x float> %strided.vec492, %strided.vec488
  %348 = fadd <4 x float> %344, %346
  %349 = fadd <4 x float> %345, %347
  %350 = fsub <4 x float> %344, %346
  %351 = fsub <4 x float> %345, %347
  %352 = fadd <4 x float> %strided.vec487, %strided.vec491
  %353 = fadd <4 x float> %strided.vec496, %strided.vec500
  %354 = fadd <4 x float> %strided.vec489, %strided.vec493
  %355 = fadd <4 x float> %strided.vec498, %strided.vec502
  %356 = fadd <4 x float> %352, %354
  %357 = fadd <4 x float> %353, %355
  %358 = fsub <4 x float> %353, %355
  %359 = fsub <4 x float> %354, %352
  %360 = fsub <4 x float> %strided.vec487, %strided.vec491
  %361 = fsub <4 x float> %strided.vec496, %strided.vec500
  %362 = fsub <4 x float> %strided.vec498, %strided.vec502
  %363 = fsub <4 x float> %strided.vec493, %strided.vec489
  ...
  %interleaved.vec503 = shufflevector <16 x float> %403, <16 x float> %404, <32 x i32> <i32 0, i32 4, i32 8, i32 12, i32 16, i32 20, i32 24, i32 28, i32 1, i32 5, i32 9, i32 13, i32 17, i32 21, i32 25, i32 29, i32 2, i32 6, i32 10, i32 14, i32 18, i32 22, i32 26, i32 30, i32 3, i32 7, i32 11, i32 15, i32 19, i32 23, i32 27, i32 31>
  store <32 x float> %interleaved.vec503, ptr %"inv_fft0_S1_R8_n0$3.119", align 16, !tbaa !36
  ...
  %strided.vec487.1 = shufflevector <32 x float> %wide.vec.1, <32 x float> poison, <4 x i32> <i32 1, i32 9, i32 17, i32 25>
  %strided.vec488.1 = shufflevector <32 x float> %wide.vec.1, <32 x float> poison, <4 x i32> <i32 2, i32 10, i32 18, i32 26>
  %strided.vec489.1 = shufflevector <32 x float> %wide.vec.1, <32 x float> poison, <4 x i32> <i32 3, i32 11, i32 19, i32 27>
  %strided.vec490.1 = shufflevector <32 x float> %wide.vec.1, <32 x float> poison, <4 x i32> <i32 4, i32 12, i32 20, i32 28>
  %strided.vec491.1 = shufflevector <32 x float> %wide.vec.1, <32 x float> poison, <4 x i32> <i32 5, i32 13, i32 21, i32 29>
  %strided.vec492.1 = shufflevector <32 x float> %wide.vec.1, <32 x float> poison, <4 x i32> <i32 6, i32 14, i32 22, i32 30>
  %strided.vec493.1 = shufflevector <32 x float> %wide.vec.1, <32 x float> poison, <4 x i32> <i32 7, i32 15, i32 23, i32 31>
  %406 = fadd <4 x float> %strided.vec.1, %strided.vec490.1
  %407 = getelementptr inbounds float, ptr %"inv_X8$7.117", i64 32
  %wide.vec494.1 = load <32 x float>, ptr %407, align 16, !tbaa !32
  %strided.vec495.1 = shufflevector <32 x float> %wide.vec494.1, <32 x float> poison, <4 x i32> <i32 0, i32 8, i32 16, i32 24>
  %strided.vec496.1 = shufflevector <32 x float> %wide.vec494.1, <32 x float> poison, <4 x i32> <i32 1, i32 9, i32 17, i32 25>
  %strided.vec497.1 = shufflevector <32 x float> %wide.vec494.1, <32 x float> poison, <4 x i32> <i32 2, i32 10, i32 18, i32 26>
  %strided.vec498.1 = shufflevector <32 x float> %wide.vec494.1, <32 x float> poison, <4 x i32> <i32 3, i32 11, i32 19, i32 27>
  %strided.vec499.1 = shufflevector <32 x float> %wide.vec494.1, <32 x float> poison, <4 x i32> <i32 4, i32 12, i32 20, i32 28>
  %strided.vec500.1 = shufflevector <32 x float> %wide.vec494.1, <32 x float> poison, <4 x i32> <i32 5, i32 13, i32 21, i32 29>
  %strided.vec501.1 = shufflevector <32 x float> %wide.vec494.1, <32 x float> poison, <4 x i32> <i32 6, i32 14, i32 22, i32 30>
  %strided.vec502.1 = shufflevector <32 x float> %wide.vec494.1, <32 x float> poison, <4 x i32> <i32 7, i32 15, i32 23, i32 31>
  %408 = fadd <4 x float> %strided.vec495.1, %strided.vec499.1
  %409 = fadd <4 x float> %strided.vec488.1, %strided.vec492.1
  %410 = fadd <4 x float> %strided.vec497.1, %strided.vec501.1
  %411 = fadd <4 x float> %406, %409
  %412 = fadd <4 x float> %408, %410
  %413 = fsub <4 x float> %406, %409
  %414 = fsub <4 x float> %408, %410
  %415 = fsub <4 x float> %strided.vec.1, %strided.vec490.1
  %416 = fsub <4 x float> %strided.vec495.1, %strided.vec499.1
  %417 = fsub <4 x float> %strided.vec497.1, %strided.vec501.1
  %418 = fsub <4 x float> %strided.vec492.1, %strided.vec488.1
  %419 = fadd <4 x float> %415, %417
  %420 = fadd <4 x float> %416, %418
  %421 = fsub <4 x float> %415, %417
  %422 = fsub <4 x float> %416, %418
  %423 = fadd <4 x float> %strided.vec487.1, %strided.vec491.1
  %424 = fadd <4 x float> %strided.vec496.1, %strided.vec500.1
  %425 = fadd <4 x float> %strided.vec489.1, %strided.vec493.1
  %426 = fadd <4 x float> %strided.vec498.1, %strided.vec502.1
  %427 = fadd <4 x float> %423, %425
  %428 = fadd <4 x float> %424, %426
  %429 = fsub <4 x float> %424, %426
  %430 = fsub <4 x float> %425, %423
  %431 = fsub <4 x float> %strided.vec487.1, %strided.vec491.1
  %432 = fsub <4 x float> %strided.vec496.1, %strided.vec500.1
  %433 = fsub <4 x float> %strided.vec498.1, %strided.vec502.1
  %434 = fsub <4 x float> %strided.vec493.1, %strided.vec489.1
  ...
  %interleaved.vec503.1 = shufflevector <16 x float> %476, <16 x float> %477, <32 x i32> <i32 0, i32 4, i32 8, i32 12, i32 16, i32 20, i32 24, i32 28, i32 1, i32 5, i32 9, i32 13, i32 17, i32 21, i32 25, i32 29, i32 2, i32 6, i32 10, i32 14, i32 18, i32 22, i32 26, i32 30, i32 3, i32 7, i32 11, i32 15, i32 19, i32 23, i32 27, i32 31>
  store <32 x float> %interleaved.vec503.1, ptr %471, align 16, !tbaa !36
  ...
  store <4 x float> %663, ptr %"inv_X8$7.018", align 16, !tbaa !140
  store <4 x float> %666, ptr %"inv_X8$7.117", align 16, !tbaa !142
...
"for result$3.s0.i.preheader":                    ; preds = %"for k$3.s0.n1"
  %715 = getelementptr inbounds float, ptr %"inv_fft1_S1_R8_n1$3.014", i64 32
  %716 = getelementptr inbounds float, ptr %"inv_fft1_S1_R8_n1$3.014", i64 40
  %717 = getelementptr inbounds float, ptr %"inv_fft1_S1_R8_n1$3.014", i64 28
  %718 = getelementptr inbounds float, ptr %"inv_fft1_S1_R8_n1$3.014", i64 20
  %719 = getelementptr inbounds float, ptr %"inv_fft1_S1_R8_n1$3.014", i64 36
  %720 = getelementptr inbounds float, ptr %"inv_fft1_S1_R8_n1$3.014", i64 44
  %721 = getelementptr inbounds float, ptr %"inv_fft1_S1_R8_n1$3.014", i64 24
  %722 = getelementptr inbounds float, ptr %"inv_fft1_S1_R8_n1$3.014", i64 16
  %723 = getelementptr inbounds float, ptr %"inv_fft1_S1_R8_n1$3.014", i64 48
  %724 = getelementptr inbounds float, ptr %"inv_fft1_S1_R8_n1$3.014", i64 56
  %725 = getelementptr inbounds float, ptr %"inv_fft1_S1_R8_n1$3.014", i64 12
  %726 = getelementptr inbounds float, ptr %"inv_fft1_S1_R8_n1$3.014", i64 4
  %727 = getelementptr inbounds float, ptr %"inv_fft1_S1_R8_n1$3.014", i64 52
  %728 = getelementptr inbounds float, ptr %"inv_fft1_S1_R8_n1$3.014", i64 60
  %729 = getelementptr inbounds float, ptr %"inv_fft1_S1_R8_n1$3.014", i64 8
  ...
  %747 = zext i32 %a53 to i64
  %invariant.gep = getelementptr float, ptr %"inv_fft0_S1_R8_n0$3.020", i64 -7
  %invariant.gep550 = getelementptr float, ptr %"inv_fft0_S1_R8_n0$3.119", i64 -7
  %xtraiter = and i64 %747, 1
  %748 = icmp eq i32 %a53, 1
...
"for result$3.s0.i":                              ; preds = %"for result$3.s0.i.preheader", %"end for result$3.s0.n1"
  %indvars.iv458 = phi i64 [ %743, %"for result$3.s0.i.preheader" ], [ %indvars.iv.next459, %"end for result$3.s0.n1" ]
  %749 = trunc i64 %indvars.iv458 to i32
...
"for fwd_fft0_S1_R8_n0$3.s1.n1":                  ; preds = %"for result$3.s0.i", %"for fwd_fft0_S1_R8_n0$3.s1.n1"
  %indvars.iv440 = phi i64 [ 0, %"for result$3.s0.i" ], [ %indvars.iv.next441, %"for fwd_fft0_S1_R8_n0$3.s1.n1" ]
  %751 = trunc i64 %indvars.iv440 to i32
  %reass.add50 = sub i32 %751, %20
  %reass.mul51 = mul i32 %reass.add50, %24
  %t3887 = add i32 %750, %reass.mul51
  %752 = sext i32 %t3887 to i64
  ...
  %772 = shl nuw nsw i64 %indvars.iv440, 3
  %773 = getelementptr inbounds float, ptr %"inv_fft0_S1_R8_n0$3.020", i64 %772
  %774 = getelementptr inbounds float, ptr %"inv_fft0_S1_R8_n0$3.119", i64 %772
  store float 0.000000e+00, ptr %774, align 16, !tbaa !36
  %775 = or i64 %772, 1
  %776 = getelementptr inbounds float, ptr %"inv_fft0_S1_R8_n0$3.119", i64 %775
  %777 = or i64 %772, 2
  %778 = getelementptr inbounds float, ptr %"inv_fft0_S1_R8_n0$3.119", i64 %777
  ...
  %806 = or i64 %772, 4
  %807 = getelementptr inbounds float, ptr %"inv_fft0_S1_R8_n0$3.020", i64 %806
  %808 = getelementptr inbounds float, ptr %"inv_fft0_S1_R8_n0$3.119", i64 %806
  store float 0.000000e+00, ptr %808, align 16, !tbaa !36
  %809 = or i64 %772, 5
  %810 = getelementptr inbounds float, ptr %"inv_fft0_S1_R8_n0$3.119", i64 %809
  store float %801, ptr %810, align 4, !tbaa !36
  %811 = or i64 %772, 6
  %812 = getelementptr inbounds float, ptr %"inv_fft0_S1_R8_n0$3.119", i64 %811
  ...
  %843 = getelementptr inbounds float, ptr %"inv_fft0_S1_R8_n0$3.119", i64 %813
  store float %805, ptr %843, align 4, !tbaa !36
  %indvars.iv.next441 = add nuw nsw i64 %indvars.iv440, 1
  %.not30 = icmp eq i64 %indvars.iv.next441, 8
  br i1 %.not30, label %"for fwd_fft1_S1_R8_n1$3.s1.n0.g.preheader", label %"for fwd_fft0_S1_R8_n0$3.s1.n1"

"for fwd_fft1_S1_R8_n1$3.s1.n0.g.preheader":      ; preds = %"for fwd_fft0_S1_R8_n0$3.s1.n1"
  %844 = load <4 x float>, ptr %"inv_fft0_S1_R8_n0$3.020", align 16, !tbaa !34
  %845 = load <4 x float>, ptr %494, align 16, !tbaa !34
  %846 = fadd <4 x float> %844, %845
  %847 = load <4 x float>, ptr %"inv_fft0_S1_R8_n0$3.119", align 16, !tbaa !36
  ...
  store <4 x float> %901, ptr %"inv_X8$7.018", align 16, !tbaa !30
  store <4 x float> %902, ptr %"inv_X8$7.117", align 16, !tbaa !32
  ...
  store <4 x float> %970, ptr %"inv_fft1_S1_R8_n1$3.014", align 16, !tbaa !196
...
"assert succeeded83":                             ; preds = %"assert succeeded81"
  br i1 %735, label %"assert failed84", label %vector.body509, !prof !5

vector.body509:                                   ; preds = %"assert succeeded83", %vector.body509
  %index510 = phi i64 [ %index.next549, %vector.body509 ], [ 0, %"assert succeeded83" ]
  %993 = shl nuw nsw i64 %index510, 3
  %994 = getelementptr inbounds float, ptr %"inv_X8$7.018", i64 %993
  %wide.vec511 = load <32 x float>, ptr %994, align 16, !tbaa !30
  %strided.vec512 = shufflevector <32 x float> %wide.vec511, <32 x float> poison, <4 x i32> <i32 0, i32 8, i32 16, i32 24>
  %strided.vec513 = shufflevector <32 x float> %wide.vec511, <32 x float> poison, <4 x i32> <i32 1, i32 9, i32 17, i32 25>
  %strided.vec514 = shufflevector <32 x float> %wide.vec511, <32 x float> poison, <4 x i32> <i32 2, i32 10, i32 18, i32 26>
  %strided.vec515 = shufflevector <32 x float> %wide.vec511, <32 x float> poison, <4 x i32> <i32 3, i32 11, i32 19, i32 27>
  %strided.vec516 = shufflevector <32 x float> %wide.vec511, <32 x float> poison, <4 x i32> <i32 4, i32 12, i32 20, i32 28>
  %strided.vec517 = shufflevector <32 x float> %wide.vec511, <32 x float> poison, <4 x i32> <i32 5, i32 13, i32 21, i32 29>
  %strided.vec518 = shufflevector <32 x float> %wide.vec511, <32 x float> poison, <4 x i32> <i32 6, i32 14, i32 22, i32 30>
  %strided.vec519 = shufflevector <32 x float> %wide.vec511, <32 x float> poison, <4 x i32> <i32 7, i32 15, i32 23, i32 31>
  %995 = getelementptr inbounds float, ptr %"kernel_fft1_S1_R8_n1$3.022", i64 %993
  %wide.vec520 = load <32 x float>, ptr %995, align 16, !tbaa !38
  %strided.vec521 = shufflevector <32 x float> %wide.vec520, <32 x float> poison, <4 x i32> <i32 0, i32 8, i32 16, i32 24>
  %strided.vec522 = shufflevector <32 x float> %wide.vec520, <32 x float> poison, <4 x i32> <i32 1, i32 9, i32 17, i32 25>
  %strided.vec523 = shufflevector <32 x float> %wide.vec520, <32 x float> poison, <4 x i32> <i32 2, i32 10, i32 18, i32 26>
  %strided.vec524 = shufflevector <32 x float> %wide.vec520, <32 x float> poison, <4 x i32> <i32 3, i32 11, i32 19, i32 27>
  %strided.vec525 = shufflevector <32 x float> %wide.vec520, <32 x float> poison, <4 x i32> <i32 4, i32 12, i32 20, i32 28>
  %strided.vec526 = shufflevector <32 x float> %wide.vec520, <32 x float> poison, <4 x i32> <i32 5, i32 13, i32 21, i32 29>
  %strided.vec527 = shufflevector <32 x float> %wide.vec520, <32 x float> poison, <4 x i32> <i32 6, i32 14, i32 22, i32 30>
  %strided.vec528 = shufflevector <32 x float> %wide.vec520, <32 x float> poison, <4 x i32> <i32 7, i32 15, i32 23, i32 31>
  %996 = fmul <4 x float> %strided.vec512, %strided.vec521
  %997 = getelementptr inbounds float, ptr %"inv_X8$7.117", i64 %993
  %wide.vec529 = load <32 x float>, ptr %997, align 16, !tbaa !32
  %strided.vec530 = shufflevector <32 x float> %wide.vec529, <32 x float> poison, <4 x i32> <i32 0, i32 8, i32 16, i32 24>
  %strided.vec531 = shufflevector <32 x float> %wide.vec529, <32 x float> poison, <4 x i32> <i32 1, i32 9, i32 17, i32 25>
  %strided.vec532 = shufflevector <32 x float> %wide.vec529, <32 x float> poison, <4 x i32> <i32 2, i32 10, i32 18, i32 26>
  %strided.vec533 = shufflevector <32 x float> %wide.vec529, <32 x float> poison, <4 x i32> <i32 3, i32 11, i32 19, i32 27>
  %strided.vec534 = shufflevector <32 x float> %wide.vec529, <32 x float> poison, <4 x i32> <i32 4, i32 12, i32 20, i32 28>
  %strided.vec535 = shufflevector <32 x float> %wide.vec529, <32 x float> poison, <4 x i32> <i32 5, i32 13, i32 21, i32 29>
  %strided.vec536 = shufflevector <32 x float> %wide.vec529, <32 x float> poison, <4 x i32> <i32 6, i32 14, i32 22, i32 30>
  %strided.vec537 = shufflevector <32 x float> %wide.vec529, <32 x float> poison, <4 x i32> <i32 7, i32 15, i32 23, i32 31>
  %998 = getelementptr inbounds float, ptr %"kernel_fft1_S1_R8_n1$3.121", i64 %993
  %wide.vec538 = load <32 x float>, ptr %998, align 16, !tbaa !40
  %strided.vec539 = shufflevector <32 x float> %wide.vec538, <32 x float> poison, <4 x i32> <i32 0, i32 8, i32 16, i32 24>
  %strided.vec540 = shufflevector <32 x float> %wide.vec538, <32 x float> poison, <4 x i32> <i32 1, i32 9, i32 17, i32 25>
  %strided.vec541 = shufflevector <32 x float> %wide.vec538, <32 x float> poison, <4 x i32> <i32 2, i32 10, i32 18, i32 26>
  %strided.vec542 = shufflevector <32 x float> %wide.vec538, <32 x float> poison, <4 x i32> <i32 3, i32 11, i32 19, i32 27>
  %strided.vec543 = shufflevector <32 x float> %wide.vec538, <32 x float> poison, <4 x i32> <i32 4, i32 12, i32 20, i32 28>
  %strided.vec544 = shufflevector <32 x float> %wide.vec538, <32 x float> poison, <4 x i32> <i32 5, i32 13, i32 21, i32 29>
  %strided.vec545 = shufflevector <32 x float> %wide.vec538, <32 x float> poison, <4 x i32> <i32 6, i32 14, i32 22, i32 30>
  %strided.vec546 = shufflevector <32 x float> %wide.vec538, <32 x float> poison, <4 x i32> <i32 7, i32 15, i32 23, i32 31>
  %999 = fmul <4 x float> %strided.vec530, %strided.vec539
  %1000 = fsub <4 x float> %996, %999
  %1001 = fmul <4 x float> %strided.vec516, %strided.vec525
  %1002 = fmul <4 x float> %strided.vec534, %strided.vec543
  %1003 = fsub <4 x float> %1001, %1002
  %1004 = fadd <4 x float> %1000, %1003
  %1005 = fmul <4 x float> %strided.vec512, %strided.vec539
  %1006 = fmul <4 x float> %strided.vec521, %strided.vec530
  %1007 = fadd <4 x float> %1006, %1005
  %1008 = fmul <4 x float> %strided.vec516, %strided.vec543
  %1009 = fmul <4 x float> %strided.vec525, %strided.vec534
  %1010 = fadd <4 x float> %1009, %1008
  %1011 = fadd <4 x float> %1007, %1010
  %1012 = fmul <4 x float> %strided.vec514, %strided.vec523
  %1013 = fmul <4 x float> %strided.vec532, %strided.vec541
  %1014 = fsub <4 x float> %1012, %1013
  %1015 = fmul <4 x float> %strided.vec518, %strided.vec527
  %1016 = fmul <4 x float> %strided.vec536, %strided.vec545
  %1017 = fsub <4 x float> %1015, %1016
  %1018 = fadd <4 x float> %1014, %1017
  %1019 = fmul <4 x float> %strided.vec514, %strided.vec541
  %1020 = fmul <4 x float> %strided.vec523, %strided.vec532
  %1021 = fadd <4 x float> %1020, %1019
  %1022 = fmul <4 x float> %strided.vec518, %strided.vec545
  %1023 = fmul <4 x float> %strided.vec527, %strided.vec536
  ...
  %1040 = fmul <4 x float> %strided.vec513, %strided.vec522
  %1041 = fmul <4 x float> %strided.vec531, %strided.vec540
  %1042 = fsub <4 x float> %1040, %1041
  %1043 = fmul <4 x float> %strided.vec517, %strided.vec526
  %1044 = fmul <4 x float> %strided.vec535, %strided.vec544
  %1045 = fsub <4 x float> %1043, %1044
  %1046 = fadd <4 x float> %1042, %1045
  %1047 = fmul <4 x float> %strided.vec513, %strided.vec540
  %1048 = fmul <4 x float> %strided.vec522, %strided.vec531
  %1049 = fadd <4 x float> %1048, %1047
  %1050 = fmul <4 x float> %strided.vec517, %strided.vec544
  %1051 = fmul <4 x float> %strided.vec526, %strided.vec535
  %1052 = fadd <4 x float> %1051, %1050
  %1053 = fadd <4 x float> %1049, %1052
  %1054 = fmul <4 x float> %strided.vec515, %strided.vec524
  %1055 = fmul <4 x float> %strided.vec533, %strided.vec542
  %1056 = fsub <4 x float> %1054, %1055
  %1057 = or i64 %993, 7
  %1058 = fmul <4 x float> %strided.vec519, %strided.vec528
  %1059 = fmul <4 x float> %strided.vec537, %strided.vec546
  %1060 = fsub <4 x float> %1058, %1059
  %1061 = fadd <4 x float> %1056, %1060
  %1062 = fmul <4 x float> %strided.vec515, %strided.vec542
  %1063 = fmul <4 x float> %strided.vec524, %strided.vec533
  %1064 = fadd <4 x float> %1063, %1062
  %1065 = fmul <4 x float> %strided.vec519, %strided.vec546
  %1066 = fmul <4 x float> %strided.vec528, %strided.vec537
  %1067 = fadd <4 x float> %1066, %1065
  %1068 = fadd <4 x float> %1064, %1067
  %1069 = fadd <4 x float> %1046, %1061
  %1070 = fadd <4 x float> %1068, %1053
  ...
  %interleaved.vec547 = shufflevector <16 x float> %1112, <16 x float> %1113, <32 x i32> <i32 0, i32 4, i32 8, i32 12, i32 16, i32 20, i32 24, i32 28, i32 1, i32 5, i32 9, i32 13, i32 17, i32 21, i32 25, i32 29, i32 2, i32 6, i32 10, i32 14, i32 18, i32 22, i32 26, i32 30, i32 3, i32 7, i32 11, i32 15, i32 19, i32 23, i32 27, i32 31>
  store <32 x float> %interleaved.vec547, ptr %gep, align 16, !tbaa !34
  %gep551 = getelementptr float, ptr %invariant.gep550, i64 %1057
  ...
  %interleaved.vec548 = shufflevector <16 x float> %1118, <16 x float> %1119, <32 x i32> <i32 0, i32 4, i32 8, i32 12, i32 16, i32 20, i32 24, i32 28, i32 1, i32 5, i32 9, i32 13, i32 17, i32 21, i32 25, i32 29, i32 2, i32 6, i32 10, i32 14, i32 18, i32 22, i32 26, i32 30, i32 3, i32 7, i32 11, i32 15, i32 19, i32 23, i32 27, i32 31>
  store <32 x float> %interleaved.vec548, ptr %gep551, align 16, !tbaa !36
  %index.next549 = add nuw i64 %index510, 4
  %1120 = icmp eq i64 %index.next549, 8
  br i1 %1120, label %"for inv_fft1_S1_R8_n1$3.s1.n0.g.preheader", label %vector.body509, !llvm.loop !198
...
"for inv_fft1_S1_R8_n1$3.s1.n0.g.preheader":      ; preds = %vector.body509
  %1122 = load <4 x float>, ptr %"inv_fft0_S1_R8_n0$3.020", align 16, !tbaa !34
  ...
  store <4 x float> %1162, ptr %"inv_fft1_S1_R8_n1$3.014", align 16, !tbaa !201
  ...
  %1228 = fadd <4 x float> %1197, %1191
  %1229 = fsub <4 x float> %1188, %1194
  %1230 = fadd <4 x float> %1204, %1205
  ...
  store <4 x float> %1211, ptr %"inv_X8$7.018", align 16, !tbaa !140
  store <4 x float> %1234, ptr %"inv_X8$7.117", align 16, !tbaa !142
...
"for result$3.s0.n1.preheader":                   ; preds = %"for inv_fft1_S1_R8_n1$3.s1.n0.g.preheader"
  %reass.add57 = sub nsw i64 %indvars.iv458, %743
...
"for result$3.s0.n1":                             ; preds = %"for result$3.s0.n1.preheader", %"end for result$3.s0.n0.n091"
  %indvars.iv455 = phi i64 [ %742, %"for result$3.s0.n1.preheader" ], [ %indvars.iv.next456, %"end for result$3.s0.n0.n091" ]
  br i1 %737, label %"for result$3.s0.n0.n0.preheader", label %"end for result$3.s0.n0.n0", !prof !26

"for result$3.s0.n0.n0.preheader":                ; preds = %"for result$3.s0.n1"
  %1245 = shl nsw i64 %indvars.iv455, 3
  %reass.add59 = sub nsw i64 %indvars.iv455, %742
  %reass.mul60 = mul i64 %reass.add59, %241
  %1246 = add i64 %1243, %reass.mul60
  br i1 %748, label %"end for result$3.s0.n0.n0.loopexit.unr-lcssa", label %"for result$3.s0.n0.n0"
...
"end for result$3.s0.n1":                         ; preds = %"end for result$3.s0.n0.n091", %"for inv_fft1_S1_R8_n1$3.s1.n0.g.preheader"
  ...
  %1247 = trunc i64 %indvars.iv.next459 to i32
...
"for result$3.s0.n0.n0":                          ; preds = %"for result$3.s0.n0.n0.preheader", %"for result$3.s0.n0.n0"
  %indvars.iv452 = phi i64 [ %indvars.iv.next453.1, %"for result$3.s0.n0.n0" ], [ 0, %"for result$3.s0.n0.n0.preheader" ]
  %niter = phi i64 [ %niter.next.1, %"for result$3.s0.n0.n0" ], [ 0, %"for result$3.s0.n0.n0.preheader" ]
  %1248 = shl nuw nsw i64 %indvars.iv452, 2
  %1249 = add nsw i64 %1248, %741
  %1250 = add nsw i64 %1249, %1245
  %1251 = getelementptr inbounds float, ptr %"inv_fft1_S1_R8_n1$3.014", i64 %1250
  ...
  %indvars.iv.next453 = shl i64 %indvars.iv452, 2
  %1256 = or i64 %indvars.iv.next453, 4
  %1257 = add nsw i64 %1256, %741
  %1258 = add nsw i64 %1257, %1245
  %1259 = getelementptr inbounds float, ptr %"inv_fft1_S1_R8_n1$3.014", i64 %1258
...
"end for result$3.s0.n0.n0.loopexit.unr-lcssa":   ; preds = %"for result$3.s0.n0.n0", %"for result$3.s0.n0.n0.preheader"
  %indvars.iv452.unr = phi i64 [ 0, %"for result$3.s0.n0.n0.preheader" ], [ %indvars.iv.next453.1, %"for result$3.s0.n0.n0" ]
...
"for result$3.s0.n0.n0.epil":                     ; preds = %"end for result$3.s0.n0.n0.loopexit.unr-lcssa"
  %1264 = shl nuw nsw i64 %indvars.iv452.unr, 2
  %1265 = add nsw i64 %1264, %741
  %1266 = add nsw i64 %1265, %1245
  %1267 = getelementptr inbounds float, ptr %"inv_fft1_S1_R8_n1$3.014", i64 %1266
...
"end for result$3.s0.n0.n0":                      ; preds = %"for result$3.s0.n0.n0.epil", %"end for result$3.s0.n0.n0.loopexit.unr-lcssa", %"for result$3.s0.n1"
  br i1 %740, label %"for result$3.s0.n0.n090.preheader", label %"end for result$3.s0.n0.n091", !prof !26

"for result$3.s0.n0.n090.preheader":              ; preds = %"end for result$3.s0.n0.n0"
  %1272 = shl nsw i64 %indvars.iv455, 3
  %1273 = add nsw i64 %745, %1272
  %1274 = getelementptr inbounds float, ptr %"inv_fft1_S1_R8_n1$3.014", i64 %1273
  ...
  %reass.add68 = sub nsw i64 %indvars.iv455, %742
...
"end for result$3.s0.n0.n091":                    ; preds = %"for result$3.s0.n0.n090.preheader", %"end for result$3.s0.n0.n0"
  ...
  %1279 = trunc i64 %indvars.iv.next456 to i32
