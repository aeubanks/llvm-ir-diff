...
for.body.lr.ph.i:                                 ; preds = %sw.bb27
  ...
  %cmp4.not.i614 = icmp eq i16 %17, 10
  br i1 %cmp4.not.i614, label %cleanup.thread.i, label %for.cond.i

for.cond.i:                                       ; preds = %for.body.lr.ph.i, %for.body.i
  %indvars.iv.i615 = phi i64 [ %indvars.iv.next.i, %for.body.i ], [ 0, %for.body.lr.ph.i ]
...
cleanup.thread.i:                                 ; preds = %cleanup.thread.i.loopexit, %for.body.lr.ph.i
  ...
  %.lcssa578 = phi ptr [ %16, %for.body.lr.ph.i ], [ %18, %cleanup.thread.i.loopexit ]
  %call5.i341 = invoke noundef zeroext i1 @_ZNK8NArchive4NZip14CExtraSubBlock15ExtractNtfsTimeEiR9_FILETIME(ptr noundef nonnull align 8 dereferenceable(32) %.lcssa578, i32 noundef 0, ptr noundef nonnull align 4 dereferenceable(8) %ft)
...
lpad28:                                           ; preds = %if.else39.invoke, %cleanup.thread.i356, %cleanup.thread.i
...
if.else:                                          ; preds = %for.cond.i, %invoke.cont29.if.else_crit_edge
  ...
  br i1 %cmp.not15.i343, label %for.body.lr.ph.i346, label %if.else39
...
for.body.lr.ph.i346:                              ; preds = %if.else
  ...
  %cmp4.not.i354618 = icmp eq i16 %24, 21589
  br i1 %cmp4.not.i354618, label %cleanup.thread.i356, label %for.cond.i350

for.cond.i350:                                    ; preds = %for.body.lr.ph.i346, %for.body.i355
  %indvars.iv.i351619 = phi i64 [ %indvars.iv.next.i347, %for.body.i355 ], [ 0, %for.body.lr.ph.i346 ]
  %indvars.iv.next.i347 = add nuw nsw i64 %indvars.iv.i351619, 1
  %exitcond.not.i349 = icmp eq i64 %indvars.iv.next.i347, %22
  br i1 %exitcond.not.i349, label %if.else39, label %for.body.i355, !llvm.loop !73

for.body.i355:                                    ; preds = %for.cond.i350
  %arrayidx.i.i.i353 = getelementptr inbounds ptr, ptr %21, i64 %indvars.iv.next.i347
  %25 = load ptr, ptr %arrayidx.i.i.i353, align 8, !tbaa !45
  %26 = load i16, ptr %25, align 8, !tbaa !70
  %cmp4.not.i354 = icmp eq i16 %26, 21589
  br i1 %cmp4.not.i354, label %cleanup.thread.i356.loopexit, label %for.cond.i350, !llvm.loop !73

cleanup.thread.i356.loopexit:                     ; preds = %for.body.i355
  %cmp.not.i348 = icmp ult i64 %indvars.iv.next.i347, %22
  br label %cleanup.thread.i356

cleanup.thread.i356:                              ; preds = %cleanup.thread.i356.loopexit, %for.body.lr.ph.i346
  %cmp.not17.i352.lcssa = phi i1 [ true, %for.body.lr.ph.i346 ], [ %cmp.not.i348, %cleanup.thread.i356.loopexit ]
  %.lcssa = phi ptr [ %23, %for.body.lr.ph.i346 ], [ %25, %cleanup.thread.i356.loopexit ]
...
invoke.cont34:                                    ; preds = %cleanup.thread.i356
  %spec.select.i359 = and i1 %cmp.not17.i352.lcssa, %call5.i361
  br i1 %spec.select.i359, label %if.else39.invoke, label %if.else39

if.else39:                                        ; preds = %for.cond.i350, %sw.bb27, %if.else, %invoke.cont34
...
sw.bb45:                                          ; preds = %invoke.cont3
  ...
  br i1 %cmp.not15.i363, label %for.body.lr.ph.i366, label %if.end54

for.body.lr.ph.i366:                              ; preds = %sw.bb45
  %_items.i.i.i364 = getelementptr inbounds %"class.NArchive::NZip::CItem", ptr %1, i64 0, i32 8, i32 0, i32 0, i32 0, i32 3
  %30 = load ptr, ptr %_items.i.i.i364, align 8, !tbaa !68
  %31 = zext i32 %29 to i64
  %32 = load ptr, ptr %30, align 8, !tbaa !45
  %33 = load i16, ptr %32, align 8, !tbaa !70
  %cmp4.not.i374610 = icmp eq i16 %33, 10
  br i1 %cmp4.not.i374610, label %cleanup.thread.i376, label %for.cond.i370

for.cond.i370:                                    ; preds = %for.body.lr.ph.i366, %for.body.i375
  %indvars.iv.i371611 = phi i64 [ %indvars.iv.next.i367, %for.body.i375 ], [ 0, %for.body.lr.ph.i366 ]
  %indvars.iv.next.i367 = add nuw nsw i64 %indvars.iv.i371611, 1
  %exitcond.not.i369 = icmp eq i64 %indvars.iv.next.i367, %31
  br i1 %exitcond.not.i369, label %if.end54, label %for.body.i375, !llvm.loop !72

for.body.i375:                                    ; preds = %for.cond.i370
  %arrayidx.i.i.i373 = getelementptr inbounds ptr, ptr %30, i64 %indvars.iv.next.i367
  %34 = load ptr, ptr %arrayidx.i.i.i373, align 8, !tbaa !45
  %35 = load i16, ptr %34, align 8, !tbaa !70
  %cmp4.not.i374 = icmp eq i16 %35, 10
  br i1 %cmp4.not.i374, label %cleanup.thread.i376.loopexit, label %for.cond.i370, !llvm.loop !72

cleanup.thread.i376.loopexit:                     ; preds = %for.body.i375
  %cmp.not.i368 = icmp ult i64 %indvars.iv.next.i367, %31
  br label %cleanup.thread.i376

cleanup.thread.i376:                              ; preds = %cleanup.thread.i376.loopexit, %for.body.lr.ph.i366
  %cmp.not17.i372.lcssa = phi i1 [ true, %for.body.lr.ph.i366 ], [ %cmp.not.i368, %cleanup.thread.i376.loopexit ]
  %.lcssa581 = phi ptr [ %32, %for.body.lr.ph.i366 ], [ %34, %cleanup.thread.i376.loopexit ]
  %call5.i381 = invoke noundef zeroext i1 @_ZNK8NArchive4NZip14CExtraSubBlock15ExtractNtfsTimeEiR9_FILETIME(ptr noundef nonnull align 8 dereferenceable(32) %.lcssa581, i32 noundef 2, ptr noundef nonnull align 4 dereferenceable(8) %ft46)
          to label %invoke.cont49 unwind label %lpad48

invoke.cont49:                                    ; preds = %cleanup.thread.i376
  %spec.select.i379 = and i1 %cmp.not17.i372.lcssa, %call5.i381
  br i1 %spec.select.i379, label %if.then51, label %if.end54
...
lpad48:                                           ; preds = %cleanup.thread.i376, %if.then51
...
if.end54:                                         ; preds = %for.cond.i370, %sw.bb45, %if.then51, %invoke.cont49
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %ft46) #21
  br label %sw.epilog260
...
sw.bb56:                                          ; preds = %invoke.cont3
  ...
  br i1 %cmp.not15.i384, label %for.body.lr.ph.i387, label %if.end65

for.body.lr.ph.i387:                              ; preds = %sw.bb56
  %_items.i.i.i385 = getelementptr inbounds %"class.NArchive::NZip::CItem", ptr %1, i64 0, i32 8, i32 0, i32 0, i32 0, i32 3
  %38 = load ptr, ptr %_items.i.i.i385, align 8, !tbaa !68
  %39 = zext i32 %37 to i64
  %40 = load ptr, ptr %38, align 8, !tbaa !45
  %41 = load i16, ptr %40, align 8, !tbaa !70
  %cmp4.not.i395606 = icmp eq i16 %41, 10
  br i1 %cmp4.not.i395606, label %cleanup.thread.i397, label %for.cond.i391

for.cond.i391:                                    ; preds = %for.body.lr.ph.i387, %for.body.i396
  %indvars.iv.i392607 = phi i64 [ %indvars.iv.next.i388, %for.body.i396 ], [ 0, %for.body.lr.ph.i387 ]
  %indvars.iv.next.i388 = add nuw nsw i64 %indvars.iv.i392607, 1
  %exitcond.not.i390 = icmp eq i64 %indvars.iv.next.i388, %39
  br i1 %exitcond.not.i390, label %if.end65, label %for.body.i396, !llvm.loop !72

for.body.i396:                                    ; preds = %for.cond.i391
  %arrayidx.i.i.i394 = getelementptr inbounds ptr, ptr %38, i64 %indvars.iv.next.i388
  %42 = load ptr, ptr %arrayidx.i.i.i394, align 8, !tbaa !45
  %43 = load i16, ptr %42, align 8, !tbaa !70
  %cmp4.not.i395 = icmp eq i16 %43, 10
  br i1 %cmp4.not.i395, label %cleanup.thread.i397.loopexit, label %for.cond.i391, !llvm.loop !72

cleanup.thread.i397.loopexit:                     ; preds = %for.body.i396
  %cmp.not.i389 = icmp ult i64 %indvars.iv.next.i388, %39
  br label %cleanup.thread.i397

cleanup.thread.i397:                              ; preds = %cleanup.thread.i397.loopexit, %for.body.lr.ph.i387
  %cmp.not17.i393.lcssa = phi i1 [ true, %for.body.lr.ph.i387 ], [ %cmp.not.i389, %cleanup.thread.i397.loopexit ]
  %.lcssa584 = phi ptr [ %40, %for.body.lr.ph.i387 ], [ %42, %cleanup.thread.i397.loopexit ]
  %call5.i402 = invoke noundef zeroext i1 @_ZNK8NArchive4NZip14CExtraSubBlock15ExtractNtfsTimeEiR9_FILETIME(ptr noundef nonnull align 8 dereferenceable(32) %.lcssa584, i32 noundef 1, ptr noundef nonnull align 4 dereferenceable(8) %ft57)
          to label %invoke.cont60 unwind label %lpad59

invoke.cont60:                                    ; preds = %cleanup.thread.i397
  %spec.select.i400 = and i1 %cmp.not17.i393.lcssa, %call5.i402
  br i1 %spec.select.i400, label %if.then62, label %if.end65
...
lpad59:                                           ; preds = %cleanup.thread.i397, %if.then62
...
if.end65:                                         ; preds = %for.cond.i391, %sw.bb56, %if.then62, %invoke.cont60
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %ft57) #21
  br label %sw.epilog260
...
sw.bb67:                                          ; preds = %invoke.cont3
  ...
  br i1 %cmp.not15.i405, label %for.body.lr.ph.i408, label %if.then72.thread

if.then72.thread:                                 ; preds = %sw.bb67
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %unixTime73) #21
  br label %if.else80

for.body.lr.ph.i408:                              ; preds = %sw.bb67
  %_items.i.i.i406 = getelementptr inbounds %"class.NArchive::NZip::CItem", ptr %1, i64 0, i32 8, i32 0, i32 0, i32 0, i32 3
  %46 = load ptr, ptr %_items.i.i.i406, align 8, !tbaa !68
  %47 = zext i32 %45 to i64
  %48 = load ptr, ptr %46, align 8, !tbaa !45
  %49 = load i16, ptr %48, align 8, !tbaa !70
  %cmp4.not.i416599 = icmp eq i16 %49, 10
  br i1 %cmp4.not.i416599, label %cleanup.thread.i418, label %for.cond.i412

for.cond.i412:                                    ; preds = %for.body.lr.ph.i408, %for.body.i417
  %indvars.iv.i413600 = phi i64 [ %indvars.iv.next.i409, %for.body.i417 ], [ 0, %for.body.lr.ph.i408 ]
  %indvars.iv.next.i409 = add nuw nsw i64 %indvars.iv.i413600, 1
  %exitcond.not.i411 = icmp eq i64 %indvars.iv.next.i409, %47
  br i1 %exitcond.not.i411, label %if.then72, label %for.body.i417, !llvm.loop !72

for.body.i417:                                    ; preds = %for.cond.i412
  %arrayidx.i.i.i415 = getelementptr inbounds ptr, ptr %46, i64 %indvars.iv.next.i409
  %50 = load ptr, ptr %arrayidx.i.i.i415, align 8, !tbaa !45
  %51 = load i16, ptr %50, align 8, !tbaa !70
  %cmp4.not.i416 = icmp eq i16 %51, 10
  br i1 %cmp4.not.i416, label %cleanup.thread.i418.loopexit, label %for.cond.i412, !llvm.loop !72

cleanup.thread.i418.loopexit:                     ; preds = %for.body.i417
  %cmp.not.i410 = icmp ult i64 %indvars.iv.next.i409, %47
  br label %cleanup.thread.i418

cleanup.thread.i418:                              ; preds = %cleanup.thread.i418.loopexit, %for.body.lr.ph.i408
  %cmp.not17.i414.lcssa = phi i1 [ true, %for.body.lr.ph.i408 ], [ %cmp.not.i410, %cleanup.thread.i418.loopexit ]
  %.lcssa590 = phi ptr [ %48, %for.body.lr.ph.i408 ], [ %50, %cleanup.thread.i418.loopexit ]
  %call5.i423 = invoke noundef zeroext i1 @_ZNK8NArchive4NZip14CExtraSubBlock15ExtractNtfsTimeEiR9_FILETIME(ptr noundef nonnull align 8 dereferenceable(32) %.lcssa590, i32 noundef 0, ptr noundef nonnull align 4 dereferenceable(8) %utc)
          to label %invoke.cont70 unwind label %lpad69

invoke.cont70:                                    ; preds = %cleanup.thread.i418
  %spec.select.i421 = and i1 %cmp.not17.i414.lcssa, %call5.i423
  br i1 %spec.select.i421, label %if.end91, label %invoke.cont70.if.then72_crit_edge

invoke.cont70.if.then72_crit_edge:                ; preds = %invoke.cont70
  %.pr574.pre = load i32, ptr %_size.i.i404, align 4, !tbaa !67
  br label %if.then72

if.then72:                                        ; preds = %for.cond.i412, %invoke.cont70.if.then72_crit_edge
  %.pr574 = phi i32 [ %.pr574.pre, %invoke.cont70.if.then72_crit_edge ], [ %45, %for.cond.i412 ]
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %unixTime73) #21
  %cmp.not15.i426 = icmp sgt i32 %.pr574, 0
  br i1 %cmp.not15.i426, label %for.body.lr.ph.i429, label %if.else80

for.body.lr.ph.i429:                              ; preds = %if.then72
  %52 = load ptr, ptr %_items.i.i.i406, align 8, !tbaa !68
  %53 = zext i32 %.pr574 to i64
  %54 = load ptr, ptr %52, align 8, !tbaa !45
  %55 = load i16, ptr %54, align 8, !tbaa !70
  %cmp4.not.i437602 = icmp eq i16 %55, 21589
  br i1 %cmp4.not.i437602, label %cleanup.thread.i439, label %for.cond.i433

for.cond.i433:                                    ; preds = %for.body.lr.ph.i429, %for.body.i438
  %indvars.iv.i434603 = phi i64 [ %indvars.iv.next.i430, %for.body.i438 ], [ 0, %for.body.lr.ph.i429 ]
  %indvars.iv.next.i430 = add nuw nsw i64 %indvars.iv.i434603, 1
  %exitcond.not.i432 = icmp eq i64 %indvars.iv.next.i430, %53
  br i1 %exitcond.not.i432, label %if.else80, label %for.body.i438, !llvm.loop !73

for.body.i438:                                    ; preds = %for.cond.i433
  %arrayidx.i.i.i436 = getelementptr inbounds ptr, ptr %52, i64 %indvars.iv.next.i430
  %56 = load ptr, ptr %arrayidx.i.i.i436, align 8, !tbaa !45
  %57 = load i16, ptr %56, align 8, !tbaa !70
  %cmp4.not.i437 = icmp eq i16 %57, 21589
  br i1 %cmp4.not.i437, label %cleanup.thread.i439.loopexit, label %for.cond.i433, !llvm.loop !73

cleanup.thread.i439.loopexit:                     ; preds = %for.body.i438
  %cmp.not.i431 = icmp ult i64 %indvars.iv.next.i430, %53
  br label %cleanup.thread.i439

cleanup.thread.i439:                              ; preds = %cleanup.thread.i439.loopexit, %for.body.lr.ph.i429
  %cmp.not17.i435.lcssa = phi i1 [ true, %for.body.lr.ph.i429 ], [ %cmp.not.i431, %cleanup.thread.i439.loopexit ]
  %.lcssa587 = phi ptr [ %54, %for.body.lr.ph.i429 ], [ %56, %cleanup.thread.i439.loopexit ]
  %call5.i444 = invoke noundef zeroext i1 @_ZNK8NArchive4NZip14CExtraSubBlock15ExtractUnixTimeEiRj(ptr noundef nonnull align 8 dereferenceable(32) %.lcssa587, i32 noundef 0, ptr noundef nonnull align 4 dereferenceable(4) %unixTime73)
          to label %invoke.cont76 unwind label %lpad75

invoke.cont76:                                    ; preds = %cleanup.thread.i439
  %spec.select.i442 = and i1 %cmp.not17.i435.lcssa, %call5.i444
  br i1 %spec.select.i442, label %if.then78, label %if.else80
...
lpad69:                                           ; preds = %cleanup.thread.i418, %if.end91
  %59 = landingpad { ptr, i32 }
          catch ptr @_ZTIPKc
          catch ptr null
  br label %ehcleanup94

lpad75:                                           ; preds = %cleanup.thread.i439, %if.then78
  %60 = landingpad { ptr, i32 }
          catch ptr @_ZTIPKc
          catch ptr null
  br label %ehcleanup90

if.else80:                                        ; preds = %for.cond.i433, %if.then72.thread, %if.then72, %invoke.cont76
...
ehcleanup94:                                      ; preds = %ehcleanup90, %lpad69
  %.pn324 = phi { ptr, i32 } [ %59, %lpad69 ], [ %.pn323, %ehcleanup90 ]
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %utc) #21
  br label %ehcleanup264
...
sw.bb105:                                         ; preds = %invoke.cont3
  ...
  %call.i.i.i448 = invoke noalias noundef nonnull dereferenceable(4) ptr @_Znam(i64 noundef 4) #23
...
if.end9.i.i.i:                                    ; preds = %if.end.i.i.i
  tail call void @_ZdaPv(ptr noundef nonnull %call.i.i.i448) #22, !noalias !83
...
sw.bb128:                                         ; preds = %invoke.cont3
  ...
  %call.i.i465 = invoke noalias noundef nonnull dereferenceable(4) ptr @_Znam(i64 noundef 4) #23
...
lpad131:                                          ; preds = %sw.bb224.invoke, %if.end.i.i.i505, %if.end236, %sw.bb206, %if.end192, %if.else189, %if.then135
...
for.cond.preheader:                               ; preds = %invoke.cont164
  ...
  switch i16 %107, label %if.then183 [
    ...
    i16 26115, label %if.then172.fold.split738
    i16 26121, label %if.then172.fold.split739
    i16 26126, label %if.then172.fold.split740
    i16 26127, label %if.then172.fold.split741
    i16 26128, label %if.then172.fold.split742
    i16 26370, label %if.then172.fold.split743
    i16 26400, label %if.then172.fold.split744
    i16 26401, label %if.then172.fold.split745
    i16 26625, label %if.then172.fold.split746
  ]
...
if.then172.fold.split738:                         ; preds = %for.cond.preheader
  br label %if.then172

if.then172.fold.split739:                         ; preds = %for.cond.preheader
  br label %if.then172

if.then172.fold.split740:                         ; preds = %for.cond.preheader
  br label %if.then172

if.then172.fold.split741:                         ; preds = %for.cond.preheader
  br label %if.then172

if.then172.fold.split742:                         ; preds = %for.cond.preheader
  br label %if.then172

if.then172.fold.split743:                         ; preds = %for.cond.preheader
  br label %if.then172

if.then172.fold.split744:                         ; preds = %for.cond.preheader
  br label %if.then172

if.then172.fold.split745:                         ; preds = %for.cond.preheader
  br label %if.then172

if.then172.fold.split746:                         ; preds = %for.cond.preheader
  br label %if.then172

if.then172:                                       ; preds = %for.cond.preheader, %if.then172.fold.split746, %if.then172.fold.split745, %if.then172.fold.split744, %if.then172.fold.split743, %if.then172.fold.split742, %if.then172.fold.split741, %if.then172.fold.split740, %if.then172.fold.split739, %if.then172.fold.split738, %if.then172.fold.split
  %indvars.iv.lcssa = phi i64 [ 0, %for.cond.preheader ], [ 1, %if.then172.fold.split ], [ 2, %if.then172.fold.split738 ], [ 3, %if.then172.fold.split739 ], [ 4, %if.then172.fold.split740 ], [ 5, %if.then172.fold.split741 ], [ 6, %if.then172.fold.split742 ], [ 7, %if.then172.fold.split743 ], [ 8, %if.then172.fold.split744 ], [ 9, %if.then172.fold.split745 ], [ 10, %if.then172.fold.split746 ]
...
if.end.i.i:                                       ; preds = %_Z11MyStringLenIcEiPKT_.exit.i
  ...
  br i1 %cmp.i.i.i, label %_ZN11CStringBaseIcE10GrowLengthEi.exit.i, label %if.end.i.i.i475

if.end.i.i.i475:                                  ; preds = %if.end.i.i
  %conv.i.i.i474 = sext i32 %add.i.i.i473 to i64
  %call.i.i.i479 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %conv.i.i.i474) #23
          to label %call.i.i.i.noexc478 unwind label %lpad174

call.i.i.i.noexc478:                              ; preds = %if.end.i.i.i475
  %call.i.i.i479662 = ptrtoint ptr %call.i.i.i479 to i64
  %cmp3.i.i.i = icmp sgt i32 %112, 0
  br i1 %cmp3.i.i.i, label %for.cond.preheader.i.i.i, label %if.end9.i.i.i477

for.cond.preheader.i.i.i:                         ; preds = %call.i.i.i.noexc478
  %cmp522.i.i.i = icmp sgt i32 %113, 0
  %115 = load ptr, ptr %method, align 8, !tbaa !55
...
iter.check:                                       ; preds = %for.cond.preheader.i.i.i
  ...
  %117 = sub i64 %call.i.i.i479662, %116
...
vector.main.loop.iter.check:                      ; preds = %iter.check
  %min.iters.check663 = icmp ult i32 %113, 32
  br i1 %min.iters.check663, label %vec.epilog.ph, label %vector.ph
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  %index664 = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ]
  %118 = getelementptr inbounds i8, ptr %115, i64 %index664
  %wide.load = load <16 x i8>, ptr %118, align 1, !tbaa !18
  %119 = getelementptr inbounds i8, ptr %118, i64 16
  %wide.load665 = load <16 x i8>, ptr %119, align 1, !tbaa !18
  %120 = getelementptr inbounds i8, ptr %call.i.i.i479, i64 %index664
  store <16 x i8> %wide.load, ptr %120, align 1, !tbaa !18
  %121 = getelementptr inbounds i8, ptr %120, i64 16
  store <16 x i8> %wide.load665, ptr %121, align 1, !tbaa !18
  %index.next = add nuw i64 %index664, 32
  %122 = icmp eq i64 %index.next, %n.vec
  br i1 %122, label %middle.block, label %vector.body, !llvm.loop !97
...
vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  ...
  %n.vec667 = and i64 %wide.trip.count.i.i.i, 4294967288
  br label %vec.epilog.vector.body

vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  %index669 = phi i64 [ %vec.epilog.resume.val, %vec.epilog.ph ], [ %index.next671, %vec.epilog.vector.body ]
  %123 = getelementptr inbounds i8, ptr %115, i64 %index669
  %wide.load670 = load <8 x i8>, ptr %123, align 1, !tbaa !18
  %124 = getelementptr inbounds i8, ptr %call.i.i.i479, i64 %index669
  store <8 x i8> %wide.load670, ptr %124, align 1, !tbaa !18
  %index.next671 = add nuw i64 %index669, 8
  %125 = icmp eq i64 %index.next671, %n.vec667
  br i1 %125, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !100

vec.epilog.middle.block:                          ; preds = %vec.epilog.vector.body
  %cmp.n668 = icmp eq i64 %n.vec667, %wide.trip.count.i.i.i
  br i1 %cmp.n668, label %delete.notnull.i.i.i, label %for.body.i.i.i.preheader

for.body.i.i.i.preheader:                         ; preds = %iter.check, %vec.epilog.iter.check, %vec.epilog.middle.block
  %indvars.iv.i.i.i.ph = phi i64 [ 0, %iter.check ], [ %n.vec, %vec.epilog.iter.check ], [ %n.vec667, %vec.epilog.middle.block ]
  %126 = xor i64 %indvars.iv.i.i.i.ph, -1
  %127 = add nsw i64 %126, %wide.trip.count.i.i.i
...
for.body.i.i.i.prol:                              ; preds = %for.body.i.i.i.preheader, %for.body.i.i.i.prol
  ...
  %arrayidx.i.i.i476.prol = getelementptr inbounds i8, ptr %115, i64 %indvars.iv.i.i.i.prol
  %128 = load i8, ptr %arrayidx.i.i.i476.prol, align 1, !tbaa !18
  %arrayidx7.i.i.i.prol = getelementptr inbounds i8, ptr %call.i.i.i479, i64 %indvars.iv.i.i.i.prol
  store i8 %128, ptr %arrayidx7.i.i.i.prol, align 1, !tbaa !18
...
for.body.i.i.i.prol.loopexit:                     ; preds = %for.body.i.i.i.prol, %for.body.i.i.i.preheader
  ...
  br i1 %129, label %delete.notnull.i.i.i, label %for.body.i.i.i

for.cond.cleanup.i.i.i:                           ; preds = %for.cond.preheader.i.i.i
  %isnull.i.i.i = icmp eq ptr %115, null
  br i1 %isnull.i.i.i, label %if.end9.i.i.i477, label %delete.notnull.i.i.i
...
for.body.i.i.i:                                   ; preds = %for.body.i.i.i.prol.loopexit, %for.body.i.i.i
  ...
  %arrayidx.i.i.i476 = getelementptr inbounds i8, ptr %115, i64 %indvars.iv.i.i.i
  %130 = load i8, ptr %arrayidx.i.i.i476, align 1, !tbaa !18
  %arrayidx7.i.i.i = getelementptr inbounds i8, ptr %call.i.i.i479, i64 %indvars.iv.i.i.i
  store i8 %130, ptr %arrayidx7.i.i.i, align 1, !tbaa !18
  %indvars.iv.next.i.i.i = add nuw nsw i64 %indvars.iv.i.i.i, 1
  %arrayidx.i.i.i476.1 = getelementptr inbounds i8, ptr %115, i64 %indvars.iv.next.i.i.i
  %131 = load i8, ptr %arrayidx.i.i.i476.1, align 1, !tbaa !18
  %arrayidx7.i.i.i.1 = getelementptr inbounds i8, ptr %call.i.i.i479, i64 %indvars.iv.next.i.i.i
  store i8 %131, ptr %arrayidx7.i.i.i.1, align 1, !tbaa !18
  %indvars.iv.next.i.i.i.1 = add nuw nsw i64 %indvars.iv.i.i.i, 2
  %arrayidx.i.i.i476.2 = getelementptr inbounds i8, ptr %115, i64 %indvars.iv.next.i.i.i.1
  %132 = load i8, ptr %arrayidx.i.i.i476.2, align 1, !tbaa !18
  %arrayidx7.i.i.i.2 = getelementptr inbounds i8, ptr %call.i.i.i479, i64 %indvars.iv.next.i.i.i.1
  store i8 %132, ptr %arrayidx7.i.i.i.2, align 1, !tbaa !18
  %indvars.iv.next.i.i.i.2 = add nuw nsw i64 %indvars.iv.i.i.i, 3
  %arrayidx.i.i.i476.3 = getelementptr inbounds i8, ptr %115, i64 %indvars.iv.next.i.i.i.2
  %133 = load i8, ptr %arrayidx.i.i.i476.3, align 1, !tbaa !18
  %arrayidx7.i.i.i.3 = getelementptr inbounds i8, ptr %call.i.i.i479, i64 %indvars.iv.next.i.i.i.2
  store i8 %133, ptr %arrayidx7.i.i.i.3, align 1, !tbaa !18
...
delete.notnull.i.i.i:                             ; preds = %for.body.i.i.i.prol.loopexit, %for.body.i.i.i, %middle.block, %vec.epilog.middle.block, %for.cond.cleanup.i.i.i
  ...
  br label %if.end9.i.i.i477

if.end9.i.i.i477:                                 ; preds = %delete.notnull.i.i.i, %for.cond.cleanup.i.i.i, %call.i.i.i.noexc478
  %134 = phi i32 [ %.pre.i.i, %delete.notnull.i.i.i ], [ %113, %for.cond.cleanup.i.i.i ], [ %113, %call.i.i.i.noexc478 ]
  store ptr %call.i.i.i479, ptr %method, align 8, !tbaa !55
  %idxprom13.i.i.i = sext i32 %134 to i64
...
_ZN11CStringBaseIcE10GrowLengthEi.exit.i:         ; preds = %if.end9.i.i.i477, %if.end.i.i, %_Z11MyStringLenIcEiPKT_.exit.i
  %135 = phi i32 [ %113, %_Z11MyStringLenIcEiPKT_.exit.i ], [ %113, %if.end.i.i ], [ %134, %if.end9.i.i.i477 ]
  %136 = load ptr, ptr %method, align 8, !tbaa !55
  %idx.ext.i = sext i32 %135 to i64
  %add.ptr.i = getelementptr inbounds i8, ptr %136, i64 %idx.ext.i
...
while.cond.i.i:                                   ; preds = %while.cond.i.i, %_ZN11CStringBaseIcE10GrowLengthEi.exit.i
  ...
  %137 = load i8, ptr %src.addr.0.i.i, align 1, !tbaa !18
  %incdec.ptr1.i.i = getelementptr inbounds i8, ptr %dest.addr.0.i.i, i64 1
  store i8 %137, ptr %dest.addr.0.i.i, align 1, !tbaa !18
  %cmp.not.i7.i = icmp eq i8 %137, 0
  br i1 %cmp.not.i7.i, label %if.end186.loopexit, label %while.cond.i.i, !llvm.loop !104

lpad174:                                          ; preds = %if.end.i.i.i475
...
if.end186.loopexit:                               ; preds = %while.cond.i.i
  %139 = load i32, ptr %_length.i.i, align 8, !tbaa !61
  %add.i = add nsw i32 %139, %111
...
ehcleanup187:                                     ; preds = %lpad174, %lpad163
  %.pn = phi { ptr, i32 } [ %108, %lpad163 ], [ %138, %lpad174 ]
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %f) #21
  br label %ehcleanup242
...
if.then199:                                       ; preds = %if.end196
  ...
  %140 = load ptr, ptr %arrayidx201, align 8, !tbaa !45
  br label %for.cond.i.i484

for.cond.i.i484:                                  ; preds = %for.cond.i.i484, %if.then199
  %indvars.iv.i.i480 = phi i64 [ %indvars.iv.next.i.i483, %for.cond.i.i484 ], [ 0, %if.then199 ]
  %arrayidx.i.i481 = getelementptr inbounds i8, ptr %140, i64 %indvars.iv.i.i480
  %141 = load i8, ptr %arrayidx.i.i481, align 1, !tbaa !18
  %cmp.not.i.i482 = icmp eq i8 %141, 0
  %indvars.iv.next.i.i483 = add nuw i64 %indvars.iv.i.i480, 1
  br i1 %cmp.not.i.i482, label %_Z11MyStringLenIcEiPKT_.exit.i489, label %for.cond.i.i484, !llvm.loop !59

_Z11MyStringLenIcEiPKT_.exit.i489:                ; preds = %for.cond.i.i484
  %142 = trunc i64 %indvars.iv.i.i480 to i32
  %143 = load i32, ptr %_capacity.i, align 4, !tbaa !57
  %_length.i.i486 = getelementptr inbounds %class.CStringBase.1, ptr %method, i64 0, i32 1
  %144 = load i32, ptr %_length.i.i486, align 8, !tbaa !61
  %145 = xor i32 %144, -1
  %sub2.i.i487 = add i32 %143, %145
  %cmp.not.i6.i488 = icmp slt i32 %sub2.i.i487, %142
  br i1 %cmp.not.i6.i488, label %if.end.i.i502, label %_ZN11CStringBaseIcE10GrowLengthEi.exit.i525

if.end.i.i502:                                    ; preds = %_Z11MyStringLenIcEiPKT_.exit.i489
  %cmp4.i.i490 = icmp sgt i32 %143, 64
  %div24.i.i491 = lshr i32 %143, 1
  %cmp8.i.i492 = icmp sgt i32 %143, 8
  %..i.i493 = select i1 %cmp8.i.i492, i32 16, i32 4
  %delta.0.i.i494 = select i1 %cmp4.i.i490, i32 %div24.i.i491, i32 %..i.i493
  %add.i.i495 = add nsw i32 %delta.0.i.i494, %sub2.i.i487
  %cmp13.i.i496 = icmp slt i32 %add.i.i495, %142
  %sub15.i.i497 = sub nsw i32 %142, %sub2.i.i487
  %delta.1.i.i498 = select i1 %cmp13.i.i496, i32 %sub15.i.i497, i32 %delta.0.i.i494
  %add18.i.i499 = add i32 %143, 1
  %add.i.i.i500 = add i32 %add18.i.i499, %delta.1.i.i498
  %cmp.i.i.i501 = icmp eq i32 %add.i.i.i500, %143
  br i1 %cmp.i.i.i501, label %_ZN11CStringBaseIcE10GrowLengthEi.exit.i525, label %if.end.i.i.i505

if.end.i.i.i505:                                  ; preds = %if.end.i.i502
  %conv.i.i.i503 = sext i32 %add.i.i.i500 to i64
  %call.i.i.i534 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %conv.i.i.i503) #23
          to label %call.i.i.i.noexc533 unwind label %lpad131

call.i.i.i.noexc533:                              ; preds = %if.end.i.i.i505
  %call.i.i.i534673 = ptrtoint ptr %call.i.i.i534 to i64
  %cmp3.i.i.i504 = icmp sgt i32 %143, 0
  br i1 %cmp3.i.i.i504, label %for.cond.preheader.i.i.i507, label %if.end9.i.i.i522

for.cond.preheader.i.i.i507:                      ; preds = %call.i.i.i.noexc533
  %cmp522.i.i.i506 = icmp sgt i32 %144, 0
  %146 = load ptr, ptr %method, align 8, !tbaa !55
  br i1 %cmp522.i.i.i506, label %iter.check678, label %for.cond.cleanup.i.i.i511

iter.check678:                                    ; preds = %for.cond.preheader.i.i.i507
  %147 = ptrtoint ptr %146 to i64
  %wide.trip.count.i.i.i508 = zext i32 %144 to i64
  %min.iters.check676 = icmp ult i32 %144, 8
  %148 = sub i64 %call.i.i.i534673, %147
  %diff.check674 = icmp ult i64 %148, 32
  %or.cond705 = select i1 %min.iters.check676, i1 true, i1 %diff.check674
  br i1 %or.cond705, label %for.body.i.i.i517.preheader, label %vector.main.loop.iter.check680

vector.main.loop.iter.check680:                   ; preds = %iter.check678
  %min.iters.check679 = icmp ult i32 %144, 32
  br i1 %min.iters.check679, label %vec.epilog.ph693, label %vector.ph681

vector.ph681:                                     ; preds = %vector.main.loop.iter.check680
  %n.vec683 = and i64 %wide.trip.count.i.i.i508, 4294967264
  br label %vector.body685

vector.body685:                                   ; preds = %vector.body685, %vector.ph681
  %index686 = phi i64 [ 0, %vector.ph681 ], [ %index.next689, %vector.body685 ]
  %149 = getelementptr inbounds i8, ptr %146, i64 %index686
  %wide.load687 = load <16 x i8>, ptr %149, align 1, !tbaa !18
  %150 = getelementptr inbounds i8, ptr %149, i64 16
  %wide.load688 = load <16 x i8>, ptr %150, align 1, !tbaa !18
  %151 = getelementptr inbounds i8, ptr %call.i.i.i534, i64 %index686
  store <16 x i8> %wide.load687, ptr %151, align 1, !tbaa !18
  %152 = getelementptr inbounds i8, ptr %151, i64 16
  store <16 x i8> %wide.load688, ptr %152, align 1, !tbaa !18
  %index.next689 = add nuw i64 %index686, 32
  %153 = icmp eq i64 %index.next689, %n.vec683
  br i1 %153, label %middle.block675, label %vector.body685, !llvm.loop !105

middle.block675:                                  ; preds = %vector.body685
  %cmp.n684 = icmp eq i64 %n.vec683, %wide.trip.count.i.i.i508
  br i1 %cmp.n684, label %delete.notnull.i.i.i519, label %vec.epilog.iter.check692

vec.epilog.iter.check692:                         ; preds = %middle.block675
  %n.vec.remaining694 = and i64 %wide.trip.count.i.i.i508, 24
  %min.epilog.iters.check695 = icmp eq i64 %n.vec.remaining694, 0
  br i1 %min.epilog.iters.check695, label %for.body.i.i.i517.preheader, label %vec.epilog.ph693

vec.epilog.ph693:                                 ; preds = %vector.main.loop.iter.check680, %vec.epilog.iter.check692
  %vec.epilog.resume.val696 = phi i64 [ %n.vec683, %vec.epilog.iter.check692 ], [ 0, %vector.main.loop.iter.check680 ]
  %n.vec698 = and i64 %wide.trip.count.i.i.i508, 4294967288
  br label %vec.epilog.vector.body701

vec.epilog.vector.body701:                        ; preds = %vec.epilog.vector.body701, %vec.epilog.ph693
  %index702 = phi i64 [ %vec.epilog.resume.val696, %vec.epilog.ph693 ], [ %index.next704, %vec.epilog.vector.body701 ]
  %154 = getelementptr inbounds i8, ptr %146, i64 %index702
  %wide.load703 = load <8 x i8>, ptr %154, align 1, !tbaa !18
  %155 = getelementptr inbounds i8, ptr %call.i.i.i534, i64 %index702
  store <8 x i8> %wide.load703, ptr %155, align 1, !tbaa !18
  %index.next704 = add nuw i64 %index702, 8
  %156 = icmp eq i64 %index.next704, %n.vec698
  br i1 %156, label %vec.epilog.middle.block690, label %vec.epilog.vector.body701, !llvm.loop !106

vec.epilog.middle.block690:                       ; preds = %vec.epilog.vector.body701
  %cmp.n700 = icmp eq i64 %n.vec698, %wide.trip.count.i.i.i508
  br i1 %cmp.n700, label %delete.notnull.i.i.i519, label %for.body.i.i.i517.preheader

for.body.i.i.i517.preheader:                      ; preds = %iter.check678, %vec.epilog.iter.check692, %vec.epilog.middle.block690
  %indvars.iv.i.i.i512.ph = phi i64 [ 0, %iter.check678 ], [ %n.vec683, %vec.epilog.iter.check692 ], [ %n.vec698, %vec.epilog.middle.block690 ]
  %157 = xor i64 %indvars.iv.i.i.i512.ph, -1
  %158 = add nsw i64 %157, %wide.trip.count.i.i.i508
  %xtraiter721 = and i64 %wide.trip.count.i.i.i508, 3
  %lcmp.mod722.not = icmp eq i64 %xtraiter721, 0
  br i1 %lcmp.mod722.not, label %for.body.i.i.i517.prol.loopexit, label %for.body.i.i.i517.prol

for.body.i.i.i517.prol:                           ; preds = %for.body.i.i.i517.preheader, %for.body.i.i.i517.prol
  %indvars.iv.i.i.i512.prol = phi i64 [ %indvars.iv.next.i.i.i515.prol, %for.body.i.i.i517.prol ], [ %indvars.iv.i.i.i512.ph, %for.body.i.i.i517.preheader ]
  %prol.iter723 = phi i64 [ %prol.iter723.next, %for.body.i.i.i517.prol ], [ 0, %for.body.i.i.i517.preheader ]
  %arrayidx.i.i.i513.prol = getelementptr inbounds i8, ptr %146, i64 %indvars.iv.i.i.i512.prol
  %159 = load i8, ptr %arrayidx.i.i.i513.prol, align 1, !tbaa !18
  %arrayidx7.i.i.i514.prol = getelementptr inbounds i8, ptr %call.i.i.i534, i64 %indvars.iv.i.i.i512.prol
  store i8 %159, ptr %arrayidx7.i.i.i514.prol, align 1, !tbaa !18
  %indvars.iv.next.i.i.i515.prol = add nuw nsw i64 %indvars.iv.i.i.i512.prol, 1
  %prol.iter723.next = add i64 %prol.iter723, 1
  %prol.iter723.cmp.not = icmp eq i64 %prol.iter723.next, %xtraiter721
  br i1 %prol.iter723.cmp.not, label %for.body.i.i.i517.prol.loopexit, label %for.body.i.i.i517.prol, !llvm.loop !107

for.body.i.i.i517.prol.loopexit:                  ; preds = %for.body.i.i.i517.prol, %for.body.i.i.i517.preheader
  %indvars.iv.i.i.i512.unr = phi i64 [ %indvars.iv.i.i.i512.ph, %for.body.i.i.i517.preheader ], [ %indvars.iv.next.i.i.i515.prol, %for.body.i.i.i517.prol ]
  %160 = icmp ult i64 %158, 3
  br i1 %160, label %delete.notnull.i.i.i519, label %for.body.i.i.i517

for.cond.cleanup.i.i.i511:                        ; preds = %for.cond.preheader.i.i.i507
  %isnull.i.i.i510 = icmp eq ptr %146, null
  br i1 %isnull.i.i.i510, label %if.end9.i.i.i522, label %delete.notnull.i.i.i519

for.body.i.i.i517:                                ; preds = %for.body.i.i.i517.prol.loopexit, %for.body.i.i.i517
  %indvars.iv.i.i.i512 = phi i64 [ %indvars.iv.next.i.i.i515.3, %for.body.i.i.i517 ], [ %indvars.iv.i.i.i512.unr, %for.body.i.i.i517.prol.loopexit ]
  %arrayidx.i.i.i513 = getelementptr inbounds i8, ptr %146, i64 %indvars.iv.i.i.i512
  %161 = load i8, ptr %arrayidx.i.i.i513, align 1, !tbaa !18
  %arrayidx7.i.i.i514 = getelementptr inbounds i8, ptr %call.i.i.i534, i64 %indvars.iv.i.i.i512
  store i8 %161, ptr %arrayidx7.i.i.i514, align 1, !tbaa !18
  %indvars.iv.next.i.i.i515 = add nuw nsw i64 %indvars.iv.i.i.i512, 1
  %arrayidx.i.i.i513.1 = getelementptr inbounds i8, ptr %146, i64 %indvars.iv.next.i.i.i515
  %162 = load i8, ptr %arrayidx.i.i.i513.1, align 1, !tbaa !18
  %arrayidx7.i.i.i514.1 = getelementptr inbounds i8, ptr %call.i.i.i534, i64 %indvars.iv.next.i.i.i515
  store i8 %162, ptr %arrayidx7.i.i.i514.1, align 1, !tbaa !18
  %indvars.iv.next.i.i.i515.1 = add nuw nsw i64 %indvars.iv.i.i.i512, 2
  %arrayidx.i.i.i513.2 = getelementptr inbounds i8, ptr %146, i64 %indvars.iv.next.i.i.i515.1
  %163 = load i8, ptr %arrayidx.i.i.i513.2, align 1, !tbaa !18
  %arrayidx7.i.i.i514.2 = getelementptr inbounds i8, ptr %call.i.i.i534, i64 %indvars.iv.next.i.i.i515.1
  store i8 %163, ptr %arrayidx7.i.i.i514.2, align 1, !tbaa !18
  %indvars.iv.next.i.i.i515.2 = add nuw nsw i64 %indvars.iv.i.i.i512, 3
  %arrayidx.i.i.i513.3 = getelementptr inbounds i8, ptr %146, i64 %indvars.iv.next.i.i.i515.2
  %164 = load i8, ptr %arrayidx.i.i.i513.3, align 1, !tbaa !18
  %arrayidx7.i.i.i514.3 = getelementptr inbounds i8, ptr %call.i.i.i534, i64 %indvars.iv.next.i.i.i515.2
  store i8 %164, ptr %arrayidx7.i.i.i514.3, align 1, !tbaa !18
  %indvars.iv.next.i.i.i515.3 = add nuw nsw i64 %indvars.iv.i.i.i512, 4
  %exitcond.not.i.i.i516.3 = icmp eq i64 %indvars.iv.next.i.i.i515.3, %wide.trip.count.i.i.i508
  br i1 %exitcond.not.i.i.i516.3, label %delete.notnull.i.i.i519, label %for.body.i.i.i517, !llvm.loop !108

delete.notnull.i.i.i519:                          ; preds = %for.body.i.i.i517.prol.loopexit, %for.body.i.i.i517, %middle.block675, %vec.epilog.middle.block690, %for.cond.cleanup.i.i.i511
  call void @_ZdaPv(ptr noundef nonnull %146) #22
  %.pre.i.i518 = load i32, ptr %_length.i.i486, align 8, !tbaa !61
  br label %if.end9.i.i.i522

if.end9.i.i.i522:                                 ; preds = %delete.notnull.i.i.i519, %for.cond.cleanup.i.i.i511, %call.i.i.i.noexc533
  %165 = phi i32 [ %.pre.i.i518, %delete.notnull.i.i.i519 ], [ %144, %for.cond.cleanup.i.i.i511 ], [ %144, %call.i.i.i.noexc533 ]
  store ptr %call.i.i.i534, ptr %method, align 8, !tbaa !55
  %idxprom13.i.i.i520 = sext i32 %165 to i64
  %arrayidx14.i.i.i521 = getelementptr inbounds i8, ptr %call.i.i.i534, i64 %idxprom13.i.i.i520
  store i8 0, ptr %arrayidx14.i.i.i521, align 1, !tbaa !18
  store i32 %add.i.i.i500, ptr %_capacity.i, align 4, !tbaa !57
  br label %_ZN11CStringBaseIcE10GrowLengthEi.exit.i525

_ZN11CStringBaseIcE10GrowLengthEi.exit.i525:      ; preds = %if.end9.i.i.i522, %if.end.i.i502, %_Z11MyStringLenIcEiPKT_.exit.i489
  %166 = phi i32 [ %144, %_Z11MyStringLenIcEiPKT_.exit.i489 ], [ %144, %if.end.i.i502 ], [ %165, %if.end9.i.i.i522 ]
  %167 = load ptr, ptr %method, align 8, !tbaa !55
  %idx.ext.i523 = sext i32 %166 to i64
  %add.ptr.i524 = getelementptr inbounds i8, ptr %167, i64 %idx.ext.i523
  br label %while.cond.i.i531

while.cond.i.i531:                                ; preds = %while.cond.i.i531, %_ZN11CStringBaseIcE10GrowLengthEi.exit.i525
  %src.addr.0.i.i526 = phi ptr [ %140, %_ZN11CStringBaseIcE10GrowLengthEi.exit.i525 ], [ %incdec.ptr.i.i528, %while.cond.i.i531 ]
  %dest.addr.0.i.i527 = phi ptr [ %add.ptr.i524, %_ZN11CStringBaseIcE10GrowLengthEi.exit.i525 ], [ %incdec.ptr1.i.i529, %while.cond.i.i531 ]
  %incdec.ptr.i.i528 = getelementptr inbounds i8, ptr %src.addr.0.i.i526, i64 1
  %168 = load i8, ptr %src.addr.0.i.i526, align 1, !tbaa !18
  %incdec.ptr1.i.i529 = getelementptr inbounds i8, ptr %dest.addr.0.i.i527, i64 1
  store i8 %168, ptr %dest.addr.0.i.i527, align 1, !tbaa !18
  %cmp.not.i7.i530 = icmp eq i8 %168, 0
  br i1 %cmp.not.i7.i530, label %_ZN11CStringBaseIcEpLEPKc.exit535, label %while.cond.i.i531, !llvm.loop !104

_ZN11CStringBaseIcEpLEPKc.exit535:                ; preds = %while.cond.i.i531
  %169 = load i32, ptr %_length.i.i486, align 8, !tbaa !61
  %add.i532 = add nsw i32 %169, %142
  store i32 %add.i532, ptr %_length.i.i486, align 8, !tbaa !61
  br label %if.end236
...
invoke.cont207:                                   ; preds = %sw.bb206
  %170 = load i16, ptr %Flags.i466, align 2, !tbaa !82
  %171 = and i16 %170, 2
  %cmp.i537.not = icmp eq i16 %171, 0
  br i1 %cmp.i537.not, label %if.end236, label %sw.bb224.invoke
...
sw.bb224.invoke:                                  ; preds = %if.else204, %invoke.cont207, %sw.bb218, %sw.bb221, %sw.bb224
  %172 = phi ptr [ @.str.30, %sw.bb224 ], [ @.str.29, %sw.bb221 ], [ @.str.28, %sw.bb218 ], [ @.str, %invoke.cont207 ], [ @.str.27, %if.else204 ]
  %173 = invoke noundef nonnull align 8 dereferenceable(16) ptr @_ZN11CStringBaseIcEpLEPKc(ptr noundef nonnull align 8 dereferenceable(16) %method, ptr noundef nonnull %172)
...
if.end236:                                        ; preds = %sw.bb224.invoke, %_ZN11CStringBaseIcEpLEPKc.exit535, %invoke.cont233, %invoke.cont207
  %175 = load ptr, ptr %method, align 8, !tbaa !55
  %call240 = invoke noundef nonnull align 8 dereferenceable(16) ptr @_ZN8NWindows4NCOM12CPropVariantaSEPKc(ptr noundef nonnull align 8 dereferenceable(16) %prop, ptr noundef %175)
          to label %invoke.cont239 unwind label %lpad131

invoke.cont239:                                   ; preds = %if.end236
  %176 = load ptr, ptr %method, align 8, !tbaa !55
  %isnull.i538 = icmp eq ptr %176, null
  br i1 %isnull.i538, label %_ZN11CStringBaseIcED2Ev.exit540, label %delete.notnull.i539

delete.notnull.i539:                              ; preds = %invoke.cont239
  call void @_ZdaPv(ptr noundef nonnull %176) #22
  br label %_ZN11CStringBaseIcED2Ev.exit540

_ZN11CStringBaseIcED2Ev.exit540:                  ; preds = %invoke.cont239, %delete.notnull.i539
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %method) #21
  br label %sw.epilog260

ehcleanup242:                                     ; preds = %lpad230, %ehcleanup187, %ehcleanup157, %lpad131
  %.pn316 = phi { ptr, i32 } [ %102, %lpad131 ], [ %174, %lpad230 ], [ %.pn315, %ehcleanup157 ], [ %.pn, %ehcleanup187 ]
  %177 = load ptr, ptr %method, align 8, !tbaa !55
  %isnull.i541 = icmp eq ptr %177, null
  br i1 %isnull.i541, label %ehcleanup244, label %delete.notnull.i542

delete.notnull.i542:                              ; preds = %ehcleanup242
  call void @_ZdaPv(ptr noundef nonnull %177) #22
  br label %ehcleanup244

ehcleanup244:                                     ; preds = %delete.notnull.i542, %ehcleanup242, %lpad129
  %.pn316.pn = phi { ptr, i32 } [ %101, %lpad129 ], [ %.pn316, %ehcleanup242 ], [ %.pn316, %delete.notnull.i542 ]
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %method) #21
  br label %ehcleanup264

sw.bb247:                                         ; preds = %invoke.cont3
  %HostOS = getelementptr inbounds %"class.NArchive::NZip::CItem", ptr %1, i64 0, i32 1, i32 1
  %178 = load i8, ptr %HostOS, align 1, !tbaa !109
  %cmp249 = icmp ult i8 %178, 20
  br i1 %cmp249, label %cond.true, label %cond.end

cond.true:                                        ; preds = %sw.bb247
  %conv248 = zext i8 %178 to i64
...
sw.bb256:                                         ; preds = %invoke.cont3
  %179 = load i8, ptr %1, align 8, !tbaa !111
  %conv257 = zext i8 %179 to i32
  br label %sw.bb256.invoke

sw.bb256.invoke:                                  ; preds = %sw.bb95, %if.then124, %sw.bb256
  %180 = phi i32 [ %conv257, %sw.bb256 ], [ %94, %if.then124 ], [ %call97, %sw.bb95 ]
  %181 = invoke noundef nonnull align 8 dereferenceable(16) ptr @_ZN8NWindows4NCOM12CPropVariantaSEj(ptr noundef nonnull align 8 dereferenceable(16) %prop, i32 noundef %180)
          to label %sw.epilog260 unwind label %lpad2

sw.epilog260:                                     ; preds = %sw.bb24.invoke, %sw.bb100.invoke, %sw.bb256.invoke, %cleanup.i, %cond.end, %invoke.cont122, %invoke.cont3, %_ZN11CStringBaseIcED2Ev.exit540, %_ZN11CStringBaseIcED2Ev.exit, %invoke.cont92, %if.end65, %if.end54, %if.end42, %_ZN11CStringBaseIwED2Ev.exit334
...
ehcleanup264:                                     ; preds = %ehcleanup244, %ehcleanup119, %ehcleanup94, %lpad59, %lpad48, %lpad28, %ehcleanup14, %lpad2
  %.pn328 = phi { ptr, i32 } [ %2, %lpad2 ], [ %.pn316.pn, %ehcleanup244 ], [ %.pn320.pn, %ehcleanup119 ], [ %.pn324, %ehcleanup94 ], [ %44, %lpad59 ], [ %36, %lpad48 ], [ %20, %lpad28 ], [ %.pn327.pn, %ehcleanup14 ]
  %call.i544 = invoke noundef i32 @_ZN8NWindows4NCOM12CPropVariant5ClearEv(ptr noundef nonnull align 8 dereferenceable(16) %prop)
          to label %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit546 unwind label %terminate.lpad.i545

terminate.lpad.i545:                              ; preds = %ehcleanup264
...
_ZN8NWindows4NCOM12CPropVariantD2Ev.exit546:      ; preds = %ehcleanup264
  %exn.slot.10 = extractvalue { ptr, i32 } %.pn328, 0
  %ehselector.slot.10 = extractvalue { ptr, i32 } %.pn328, 1
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %prop) #21
  %186 = call i32 @llvm.eh.typeid.for(ptr nonnull @_ZTIPKc) #21
  %matches = icmp eq i32 %ehselector.slot.10, %186
  %187 = call ptr @__cxa_begin_catch(ptr %exn.slot.10) #21
  br i1 %matches, label %catch270, label %catch

catch270:                                         ; preds = %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit546
  %exception = call ptr @__cxa_allocate_exception(i64 8) #21
  store ptr %187, ptr %exception, align 16, !tbaa !45
  invoke void @__cxa_throw(ptr nonnull %exception, ptr nonnull @_ZTIPKc, ptr null) #24
          to label %unreachable unwind label %lpad273

catch:                                            ; preds = %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit546
  call void @__cxa_end_catch()
  br label %return
...
invoke.cont527:                                   ; preds = %if.then524
  ...
  %229 = load i8, ptr %passwOK, align 1, !range !50
...
if.then.i1199:                                    ; preds = %invoke.cont85, %_ZN9CMyComPtrI18ICryptoSetPasswordED2Ev.exit, %cleanup644
  ...
  %254 = load ptr, ptr %vfn.i1197, align 8
  %call.i1198 = invoke noundef i32 %254(ptr noundef nonnull align 8 dereferenceable(8) %cryptoFilter.sroa.0.41368)
...
if.then.i1205:                                    ; preds = %lpad84, %_ZN9CMyComPtrI18ICryptoSetPasswordED2Ev.exit994, %ehcleanup645
  ...
  %257 = load ptr, ptr %vfn.i1203, align 8
  %call.i1204 = invoke noundef i32 %257(ptr noundef nonnull align 8 dereferenceable(8) %cryptoFilter.sroa.0.51391)
...
if.then.i1212:                                    ; preds = %cleanup648
  ...
  %260 = load ptr, ptr %vfn.i1210, align 8
  %call.i1211 = invoke noundef i32 %260(ptr noundef nonnull align 8 dereferenceable(8) %inStream.sroa.0.5)
...
if.then.i1219:                                    ; preds = %if.then38, %if.then.i1212, %cleanup648
  ...
  %263 = load ptr, ptr %vfn.i1217, align 8
  %call.i1218 = invoke noundef i32 %263(ptr noundef nonnull align 8 dereferenceable(8) %call26)
...
if.then.i1225:                                    ; preds = %ehcleanup649
  ...
  %266 = load ptr, ptr %vfn.i1223, align 8
  %call.i1224 = invoke noundef i32 %266(ptr noundef nonnull align 8 dereferenceable(8) %inStream.sroa.0.6)
...
if.then.i1232:                                    ; preds = %lpad31, %ehcleanup649.thread, %ehcleanup649, %if.then.i1225
  ...
  %269 = load ptr, ptr %vfn.i1230, align 8
  %call.i1231 = invoke noundef i32 %269(ptr noundef nonnull align 8 dereferenceable(8) %call26)
...
if.then.i1239:                                    ; preds = %cleanup660
  ...
  %272 = load ptr, ptr %vfn.i1237, align 8
  %call.i1238 = invoke noundef i32 %272(ptr noundef nonnull align 8 dereferenceable(200) %inStreamReleaser.sroa.0.61404)
...
if.then.i1245:                                    ; preds = %ehcleanup661
  ...
  %275 = load ptr, ptr %vfn.i1243, align 8
  %call.i1244 = invoke noundef i32 %275(ptr noundef nonnull align 8 dereferenceable(200) %inStreamReleaser.sroa.0.8)
