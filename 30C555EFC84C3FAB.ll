...
if.then.i:                                        ; preds = %call.i.i.i.noexc
  ...
  br i1 %cmp.not.i.i, label %_ZN11CStringBaseIcE9GetBufferEi.exit.i, label %if.end.i.i.i
...
if.end.i.i.i:                                     ; preds = %if.then.i
  ...
  %call.i.i1718.i = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %conv.i.i.i) #23
          to label %delete.notnull.i.i.i unwind label %lpad1.i, !noalias !52
...
delete.notnull.i.i.i:                             ; preds = %if.end.i.i.i
  ...
  br label %_ZN11CStringBaseIcE9GetBufferEi.exit.i

_ZN11CStringBaseIcE9GetBufferEi.exit.i:           ; preds = %delete.notnull.i.i.i, %if.then.i
  %4 = phi ptr [ %call.i.i.i51, %if.then.i ], [ %call.i.i1718.i, %delete.notnull.i.i.i ]
...
for.cond.i.i.i:                                   ; preds = %for.cond.i.i.i, %_ZN11CStringBaseIcE9GetBufferEi.exit.i
  %indvars.iv.i.i19.i = phi i64 [ %indvars.iv.next.i.i21.i, %for.cond.i.i.i ], [ 0, %_ZN11CStringBaseIcE9GetBufferEi.exit.i ]
...
ehcleanup19:                                      ; preds = %delete.notnull.i58, %ehcleanup, %lpad10, %lpad1.i
  %.pn.pn = phi { ptr, i32 } [ %12, %lpad10 ], [ %8, %lpad1.i ], [ %.pn, %ehcleanup ], [ %.pn, %delete.notnull.i58 ]
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %ref.tmp8) #21
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %ref.tmp) #21
  br label %ehcleanup40
...
if.end.i.i.i:                                     ; preds = %if.then.i
  ...
  %conv.i.i.i = zext i32 %add.i.i.i to i64
  %call.i.i1718.i = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %conv.i.i.i) #23
          to label %delete.notnull.i.i.i unwind label %lpad1.i, !noalias !83
...
_ZN11CStringBaseIcE9GetBufferEi.exit.i:           ; preds = %delete.notnull.i.i.i, %if.then.i
  %51 = phi ptr [ %call.i.i.i420, %if.then.i ], [ %call.i.i1718.i, %delete.notnull.i.i.i ]
...
ehcleanup119:                                     ; preds = %delete.notnull.i430, %ehcleanup118, %lpad108, %lpad1.i
  %.pn525.pn = phi { ptr, i32 } [ %59, %lpad108 ], [ %55, %lpad1.i ], [ %.pn525, %ehcleanup118 ], [ %.pn525, %delete.notnull.i430 ]
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %ref.tmp107) #21
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %ref.tmp106) #21
  br label %ehcleanup264
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %delete.notnull.i.i.i449, label %vec.epilog.iter.check
...
vec.epilog.middle.block:                          ; preds = %vec.epilog.vector.body
  ...
  br i1 %cmp.n627, label %delete.notnull.i.i.i449, label %for.body.i.i.i.preheader
...
for.body.i.i.i.prol.loopexit:                     ; preds = %for.body.i.i.i.prol, %for.body.i.i.i.preheader
  ...
  br i1 %111, label %delete.notnull.i.i.i449, label %for.body.i.i.i

for.cond.cleanup.i.i.i:                           ; preds = %for.cond.preheader.i.i.i
  %isnull.i.i.i = icmp eq ptr %97, null
  br i1 %isnull.i.i.i, label %if.end9.i.i.i, label %delete.notnull.i.i.i449
...
for.body.i.i.i:                                   ; preds = %for.body.i.i.i.prol.loopexit, %for.body.i.i.i
  ...
  br i1 %exitcond.not.i.i.i.3, label %delete.notnull.i.i.i449, label %for.body.i.i.i, !llvm.loop !103

delete.notnull.i.i.i449:                          ; preds = %for.body.i.i.i.prol.loopexit, %for.body.i.i.i, %middle.block, %vec.epilog.middle.block, %for.cond.cleanup.i.i.i
  call void @_ZdaPv(ptr noundef nonnull %97) #22
  %.pre.i.i = load i32, ptr %_length.i.i, align 8, !tbaa !61
  br label %if.end9.i.i.i

if.end9.i.i.i:                                    ; preds = %delete.notnull.i.i.i449, %for.cond.cleanup.i.i.i, %call.i.i.i.noexc450
  %116 = phi i32 [ %.pre.i.i, %delete.notnull.i.i.i449 ], [ %95, %for.cond.cleanup.i.i.i ], [ %95, %call.i.i.i.noexc450 ]
...
_ZN11CStringBaseIcE10GrowLengthEi.exit.i:         ; preds = %if.end9.i.i.i, %if.end.i.i, %_Z11MyStringLenIcEiPKT_.exit.i
  %117 = phi i32 [ %95, %_Z11MyStringLenIcEiPKT_.exit.i ], [ %95, %if.end.i.i ], [ %116, %if.end9.i.i.i ]
