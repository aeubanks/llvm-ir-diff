...
define internal noalias noundef nonnull ptr @_ZL11CreateCodecv() #1 personality ptr @__gxx_personality_v0 {
  %1 = tail call noalias noundef nonnull dereferenceable(24) ptr @_Znwm(i64 noundef 24) #4
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(24) %1, i8 0, i64 24, i1 false)
  store ptr getelementptr inbounds ({ [11 x ptr] }, ptr @_ZTV16CBCJ_x86_Decoder, i64 0, inrange i32 0, i64 2), ptr %1, align 8, !tbaa !5
  ret ptr %1
}
...
define internal noalias noundef nonnull ptr @_ZL14CreateCodecOutv() #1 personality ptr @__gxx_personality_v0 {
  %1 = tail call noalias noundef nonnull dereferenceable(24) ptr @_Znwm(i64 noundef 24) #4
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(24) %1, i8 0, i64 24, i1 false)
  store ptr getelementptr inbounds ({ [11 x ptr] }, ptr @_ZTV16CBCJ_x86_Encoder, i64 0, inrange i32 0, i64 2), ptr %1, align 8, !tbaa !5
  ret ptr %1
}
