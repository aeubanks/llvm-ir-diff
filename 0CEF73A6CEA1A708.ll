...
if.then:                                          ; preds = %entry
  ...
  store ptr %call.i.i, ptr %agg.result, align 8, !tbaa !9
...
if.end.i.i:                                       ; preds = %if.then
  ...
  %call.i.i4041 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %3) #6
          to label %if.end9.i.i unwind label %delete.notnull.i

if.end9.i.i:                                      ; preds = %if.end.i.i
  tail call void @_ZdaPv(ptr noundef nonnull %call.i.i) #7
  store ptr %call.i.i4041, ptr %agg.result, align 8, !tbaa !9
  store i32 0, ptr %call.i.i4041, align 4, !tbaa !12
...
invoke.cont2:                                     ; preds = %if.end9.i.i, %if.then
  ...
  %5 = phi ptr [ %call.i.i4041, %if.end9.i.i ], [ %call.i.i, %if.then ]
  ...
  br i1 %cmp, label %nrvo.skipdtor, label %delete.notnull.i45

delete.notnull.i:                                 ; preds = %if.end.i.i
  %7 = landingpad { ptr, i32 }
          cleanup
  br label %eh.resume.sink.split

delete.notnull.i45:                               ; preds = %invoke.cont2
  tail call void @_ZdaPv(ptr noundef nonnull %5) #7
  %.pr = load i32, ptr %_length.i, align 8, !tbaa !15
  br label %if.end13
...
nrvo.skipdtor:                                    ; preds = %invoke.cont2
  ...
  store i32 0, ptr %arrayidx.i, align 4, !tbaa !12
  %_length.i43 = getelementptr inbounds %class.CStringBase.0, ptr %agg.result, i64 0, i32 1
  store i32 %conv9, ptr %_length.i43, align 8, !tbaa !18
  br label %return

if.end13:                                         ; preds = %delete.notnull.i45, %entry
  %8 = phi i32 [ %.pr, %delete.notnull.i45 ], [ %2, %entry ]
  %_capacity.i47 = getelementptr inbounds %class.CStringBase.0, ptr %agg.result, i64 0, i32 2
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %agg.result, i8 0, i64 16, i1 false)
  %call.i.i48 = tail call noalias noundef nonnull dereferenceable(16) ptr @_Znam(i64 noundef 16) #6
  store ptr %call.i.i48, ptr %agg.result, align 8, !tbaa !9
  store i32 0, ptr %call.i.i48, align 4, !tbaa !12
  store i32 4, ptr %_capacity.i47, align 4, !tbaa !14
...
lpad15:                                           ; preds = %for.body
  %9 = landingpad { ptr, i32 }
          cleanup
  %10 = load ptr, ptr %agg.result, align 8, !tbaa !9
  %isnull.i50 = icmp eq ptr %10, null
  br i1 %isnull.i50, label %eh.resume, label %eh.resume.sink.split
...
for.body:                                         ; preds = %if.end13, %for.inc
  ...
  %conv2153 = zext i8 %12 to i32
  %call23 = invoke noundef nonnull align 8 dereferenceable(16) ptr @_ZN11CStringBaseIwEpLEw(ptr noundef nonnull align 8 dereferenceable(16) %agg.result, i32 noundef signext %conv2153)
          to label %for.inc unwind label %lpad15

for.inc:                                          ; preds = %for.body
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %13 = load i32, ptr %_length.i, align 8, !tbaa !15
...
eh.resume.sink.split:                             ; preds = %lpad15, %delete.notnull.i
  %.sink = phi ptr [ %call.i.i, %delete.notnull.i ], [ %10, %lpad15 ]
  %.pn.ph = phi { ptr, i32 } [ %7, %delete.notnull.i ], [ %9, %lpad15 ]
...
entry:
  ...
  %0 = load i32, ptr %_capacity.i, align 4, !tbaa !14
...
if.end9.i.i:                                      ; preds = %delete.notnull.i.i, %for.cond.cleanup.i.i, %if.end.i.i
  ...
  store ptr %call.i.i, ptr %this, align 8, !tbaa !9
...
_ZN11CStringBaseIwE10GrowLengthEi.exit:           ; preds = %entry, %if.end.i, %if.end9.i.i
  ...
  %24 = load ptr, ptr %this, align 8, !tbaa !9
...
if.end.i.i:                                       ; preds = %if.then.i
  ...
  %call.i.i5455 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %conv.i.i) #6
          to label %if.end9.i.i unwind label %delete.notnull.i

if.end9.i.i:                                      ; preds = %if.end.i.i
  tail call void @_ZdaPv(ptr noundef nonnull %call.i.i) #7
  store ptr %call.i.i5455, ptr %agg.result, align 8, !tbaa !17
  store i8 0, ptr %call.i.i5455, align 1, !tbaa !19
  store i32 %add.i.i, ptr %_capacity.i, align 4, !tbaa !28
  br label %invoke.cont3

invoke.cont3:                                     ; preds = %if.end9.i.i, %if.then.i, %if.then
  %3 = phi ptr [ %call.i.i5455, %if.end9.i.i ], [ %call.i.i, %if.then.i ], [ %call.i.i, %if.then ]
  %4 = load ptr, ptr %srcString, align 8, !tbaa !9
  %conv = sext i32 %add to i64
  %call7 = tail call i64 @wcstombs(ptr noundef nonnull %3, ptr noundef %4, i64 noundef %conv) #8
  %conv8 = trunc i64 %call7 to i32
  %cmp = icmp sgt i32 %conv8, -1
  br i1 %cmp, label %nrvo.skipdtor, label %delete.notnull.i58
...
delete.notnull.i58:                               ; preds = %invoke.cont3
  tail call void @_ZdaPv(ptr noundef nonnull %3) #7
  %.pr = load i32, ptr %_length.i, align 8, !tbaa !18
  br label %if.end14
...
nrvo.skipdtor:                                    ; preds = %invoke.cont3
  ...
  %_length.i56 = getelementptr inbounds %class.CStringBase, ptr %agg.result, i64 0, i32 1
  store i32 %conv8, ptr %_length.i56, align 8, !tbaa !15
  br label %return

if.end14:                                         ; preds = %delete.notnull.i58, %entry
  %6 = phi i32 [ %.pr, %delete.notnull.i58 ], [ %2, %entry ]
  %_capacity.i60 = getelementptr inbounds %class.CStringBase, ptr %agg.result, i64 0, i32 2
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %agg.result, i8 0, i64 16, i1 false)
  %call.i.i61 = tail call noalias noundef nonnull dereferenceable(4) ptr @_Znam(i64 noundef 4) #6
  store ptr %call.i.i61, ptr %agg.result, align 8, !tbaa !17
  store i8 0, ptr %call.i.i61, align 1, !tbaa !19
  store i32 4, ptr %_capacity.i60, align 4, !tbaa !28
...
lpad16:                                           ; preds = %for.body
  ...
  %isnull.i63 = icmp eq ptr %8, null
  br i1 %isnull.i63, label %eh.resume, label %eh.resume.sink.split

for.body:                                         ; preds = %if.end14, %for.inc
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.inc ], [ 0, %if.end14 ]
  %9 = load ptr, ptr %srcString, align 8, !tbaa !9
...
for.inc:                                          ; preds = %for.body
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %13 = load i32, ptr %_length.i, align 8, !tbaa !18
  %14 = sext i32 %13 to i64
...
eh.resume.sink.split:                             ; preds = %lpad16, %delete.notnull.i
  %.sink = phi ptr [ %call.i.i, %delete.notnull.i ], [ %8, %lpad16 ]
  %.pn.ph = phi { ptr, i32 } [ %5, %delete.notnull.i ], [ %7, %lpad16 ]
  tail call void @_ZdaPv(ptr noundef nonnull %.sink) #7
  br label %eh.resume
...
entry:
  ...
  %1 = load i32, ptr %_length.i, align 8, !tbaa !15
  %2 = xor i32 %1, -1
  %sub2.i = add i32 %0, %2
  %cmp.not.i = icmp slt i32 %sub2.i, 1
...
delete.notnull.i.i:                               ; preds = %for.body.i.i.prol.loopexit, %for.body.i.i, %middle.block, %vec.epilog.middle.block, %for.cond.cleanup.i.i
  tail call void @_ZdaPv(ptr noundef nonnull %3) #7
  %.pre.i = load i32, ptr %_length.i, align 8, !tbaa !15
  br label %if.end9.i.i
...
_ZN11CStringBaseIcE10GrowLengthEi.exit:           ; preds = %entry, %if.end.i, %if.end9.i.i
  ...
  %26 = load i32, ptr %_length.i, align 8, !tbaa !15
  %inc = add nsw i32 %26, 1
  store i32 %inc, ptr %_length.i, align 8, !tbaa !15
  %idxprom4 = sext i32 %inc to i64
