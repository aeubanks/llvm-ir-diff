...
"for op_pmulhuw_14.s0.x.x":                       ; preds = %"for op_pmulhuw_14.s0.x.x", %"for op_pmulhuw_14.s0.x.x.preheader"
  ...
  %8 = xor <4 x i16> %7, %6
  %9 = shufflevector <4 x i16> %8, <4 x i16> undef, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison>
  ...
  %18 = shufflevector <4 x i16> %17, <4 x i16> undef, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison>
  ...
  %27 = shufflevector <4 x i16> %26, <4 x i16> undef, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison>
  ...
  %36 = shufflevector <4 x i16> %35, <4 x i16> undef, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison>
