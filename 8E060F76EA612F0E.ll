; ModuleID = '/usr/local/google/home/aeubanks/repos/test-suite/Bitcode/simd_ops/x86_tests/test_op_pblendvb_255.bc'
...
@str.11 = private constant [16 x i8] c"op_pblendvb_255\00", align 32
...
define i32 @__test_op(ptr noalias nocapture readnone %in_f32.buffer, ptr noalias nocapture readnone %in_f64.buffer, ptr noalias nocapture readnone %in_i8.buffer, ptr noalias nocapture readonly %in_u8.buffer, ptr noalias nocapture readnone %in_i16.buffer, ptr noalias nocapture readnone %in_u16.buffer, ptr noalias nocapture readnone %in_i32.buffer, ptr noalias nocapture readnone %in_u32.buffer, ptr noalias nocapture readnone %in_i64.buffer, ptr noalias nocapture readnone %in_u64.buffer, ptr noalias nocapture readonly %op_pblendvb_255.buffer) local_unnamed_addr #0 {
"produce op_pblendvb_255":
  %buf_extent168 = getelementptr inbounds %struct.buffer_t, ptr %op_pblendvb_255.buffer, i64 0, i32 2, i64 1
  %op_pblendvb_255.extent.1 = load i32, ptr %buf_extent168, align 4
  %buf_min176 = getelementptr inbounds %struct.buffer_t, ptr %op_pblendvb_255.buffer, i64 0, i32 4, i64 1
  %op_pblendvb_255.min.1 = load i32, ptr %buf_min176, align 4
  %0 = add nsw i32 %op_pblendvb_255.min.1, %op_pblendvb_255.extent.1
  %1 = icmp sgt i32 %op_pblendvb_255.extent.1, 0
  br i1 %1, label %"for op_pblendvb_255.s0.y.preheader", label %destructor_block, !prof !4

"for op_pblendvb_255.s0.y.preheader":             ; preds = %"produce op_pblendvb_255"
  %buf_host44 = getelementptr inbounds %struct.buffer_t, ptr %in_u8.buffer, i64 0, i32 1
  %in_u8.host = load ptr, ptr %buf_host44, align 8
  %buf_min175 = getelementptr inbounds %struct.buffer_t, ptr %op_pblendvb_255.buffer, i64 0, i32 4, i64 0
  %op_pblendvb_255.min.0 = load i32, ptr %buf_min175, align 4
  %2 = sext i32 %op_pblendvb_255.min.0 to i64
  %buf_stride172 = getelementptr inbounds %struct.buffer_t, ptr %op_pblendvb_255.buffer, i64 0, i32 3, i64 1
  %op_pblendvb_255.stride.1 = load i32, ptr %buf_stride172, align 4
  %3 = sext i32 %op_pblendvb_255.stride.1 to i64
  %buf_host163 = getelementptr inbounds %struct.buffer_t, ptr %op_pblendvb_255.buffer, i64 0, i32 1
  %op_pblendvb_255.host = load ptr, ptr %buf_host163, align 8
  %4 = shl nsw i64 %2, 3
  %5 = sub nsw i64 96, %4
  %scevgep = getelementptr i8, ptr %op_pblendvb_255.host, i64 %5
  %6 = shl nsw i64 %3, 3
  %sunkaddr = ptrtoint ptr %in_u8.host to i64
  %t186 = load <16 x i8>, ptr %in_u8.host, align 16, !tbaa !5
  %7 = icmp ugt <16 x i8> %t186, <i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7>
  %sunkaddr210 = add i64 %sunkaddr, 16
  %sunkaddr211 = inttoptr i64 %sunkaddr210 to ptr
  %8 = load <16 x i8>, ptr %sunkaddr211, align 16, !tbaa !5
  %9 = select <16 x i1> %7, <16 x i8> %t186, <16 x i8> %8
  ...
  %15 = icmp ugt <16 x i8> %8, <i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7>
  ...
  %17 = select <16 x i1> %15, <16 x i8> %8, <16 x i8> %16
  ...
  %t186.2 = load <16 x i8>, ptr %sunkaddr207.2, align 16, !tbaa !5
  %23 = icmp ugt <16 x i8> %t186.2, <i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7>
  ...
  %25 = select <16 x i1> %23, <16 x i8> %t186.2, <16 x i8> %24
  ...
  %t186.3 = load <16 x i8>, ptr %sunkaddr207.3, align 16, !tbaa !5
  %31 = icmp ugt <16 x i8> %t186.3, <i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7>
  ...
  %33 = select <16 x i1> %31, <16 x i8> %t186.3, <16 x i8> %32
  ...
  %t186.4 = load <16 x i8>, ptr %sunkaddr207.4, align 16, !tbaa !5
  %39 = icmp ugt <16 x i8> %t186.4, <i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7>
  ...
  %41 = select <16 x i1> %39, <16 x i8> %t186.4, <16 x i8> %40
  ...
  %t186.5 = load <16 x i8>, ptr %sunkaddr207.5, align 16, !tbaa !5
  %47 = icmp ugt <16 x i8> %t186.5, <i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7>
  ...
  %49 = select <16 x i1> %47, <16 x i8> %t186.5, <16 x i8> %48
  ...
  %t186.6 = load <16 x i8>, ptr %sunkaddr207.6, align 16, !tbaa !5
  %55 = icmp ugt <16 x i8> %t186.6, <i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7>
  ...
  %57 = select <16 x i1> %55, <16 x i8> %t186.6, <16 x i8> %56
  ...
  %t186.7 = load <16 x i8>, ptr %sunkaddr207.7, align 16, !tbaa !5
  %63 = icmp ugt <16 x i8> %t186.7, <i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7>
  ...
  %65 = select <16 x i1> %63, <16 x i8> %t186.7, <16 x i8> %64
  ...
  %t186.8 = load <16 x i8>, ptr %sunkaddr207.8, align 16, !tbaa !5
  %71 = icmp ugt <16 x i8> %t186.8, <i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7>
  ...
  %73 = select <16 x i1> %71, <16 x i8> %t186.8, <16 x i8> %72
  ...
  br label %"for op_pblendvb_255.s0.x.x.preheader"

"for op_pblendvb_255.s0.x.x.preheader":           ; preds = %"for op_pblendvb_255.s0.x.x.preheader", %"for op_pblendvb_255.s0.y.preheader"
  %lsr.iv180 = phi ptr [ %scevgep, %"for op_pblendvb_255.s0.y.preheader" ], [ %scevgep182, %"for op_pblendvb_255.s0.x.x.preheader" ]
  %op_pblendvb_255.s0.y = phi i32 [ %op_pblendvb_255.min.1, %"for op_pblendvb_255.s0.y.preheader" ], [ %135, %"for op_pblendvb_255.s0.x.x.preheader" ]
  ...
  %t186.9 = load <16 x i8>, ptr %sunkaddr207.9, align 16, !tbaa !5
  %79 = icmp ugt <16 x i8> %t186.9, <i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7>
  %80 = load <16 x i8>, ptr %sunkaddr211.9, align 16, !tbaa !5
  %81 = select <16 x i1> %79, <16 x i8> %t186.9, <16 x i8> %80
  ...
  %t186.10 = load <16 x i8>, ptr %sunkaddr207.10, align 16, !tbaa !5
  %87 = icmp ugt <16 x i8> %t186.10, <i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7>
  %88 = load <16 x i8>, ptr %sunkaddr211.10, align 16, !tbaa !5
  %89 = select <16 x i1> %87, <16 x i8> %t186.10, <16 x i8> %88
  ...
  %t186.11 = load <16 x i8>, ptr %sunkaddr207.11, align 16, !tbaa !5
  %95 = icmp ugt <16 x i8> %t186.11, <i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7>
  %96 = load <16 x i8>, ptr %sunkaddr211.11, align 16, !tbaa !5
  %97 = select <16 x i1> %95, <16 x i8> %t186.11, <16 x i8> %96
  ...
  %t186.12 = load <16 x i8>, ptr %sunkaddr207.12, align 16, !tbaa !5
  %103 = icmp ugt <16 x i8> %t186.12, <i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7>
  %104 = load <16 x i8>, ptr %sunkaddr211.12, align 16, !tbaa !5
  %105 = select <16 x i1> %103, <16 x i8> %t186.12, <16 x i8> %104
  ...
  %t186.13 = load <16 x i8>, ptr %sunkaddr207.13, align 16, !tbaa !5
  %111 = icmp ugt <16 x i8> %t186.13, <i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7>
  %112 = load <16 x i8>, ptr %sunkaddr211.13, align 16, !tbaa !5
  %113 = select <16 x i1> %111, <16 x i8> %t186.13, <16 x i8> %112
  ...
  %t186.14 = load <16 x i8>, ptr %sunkaddr207.14, align 16, !tbaa !5
  %119 = icmp ugt <16 x i8> %t186.14, <i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7>
  %120 = load <16 x i8>, ptr %sunkaddr211.14, align 16, !tbaa !5
  %121 = select <16 x i1> %119, <16 x i8> %t186.14, <16 x i8> %120
  ...
  %t186.15 = load <16 x i8>, ptr %sunkaddr207.15, align 16, !tbaa !5
  %127 = icmp ugt <16 x i8> %t186.15, <i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7>
  %128 = load <16 x i8>, ptr %sunkaddr211.15, align 16, !tbaa !5
  %129 = select <16 x i1> %127, <16 x i8> %t186.15, <16 x i8> %128
  ...
  %135 = add nsw i32 %op_pblendvb_255.s0.y, 1
  %scevgep182 = getelementptr i1, ptr %lsr.iv180, i64 %6
  %.not2 = icmp eq i32 %135, %0
  br i1 %.not2, label %destructor_block, label %"for op_pblendvb_255.s0.x.x.preheader"

destructor_block:                                 ; preds = %"for op_pblendvb_255.s0.x.x.preheader", %"produce op_pblendvb_255"
  ret i32 0
}

; Function Attrs: nofree norecurse nosync nounwind memory(readwrite, inaccessiblemem: none)
define i32 @test_op(ptr noalias nocapture readnone %in_f32.buffer, ptr noalias nocapture readnone %in_f64.buffer, ptr noalias nocapture readnone %in_i8.buffer, ptr noalias nocapture readonly %in_u8.buffer, ptr noalias nocapture readnone %in_i16.buffer, ptr noalias nocapture readnone %in_u16.buffer, ptr noalias nocapture readnone %in_i32.buffer, ptr noalias nocapture readnone %in_u32.buffer, ptr noalias nocapture readnone %in_i64.buffer, ptr noalias nocapture readnone %in_u64.buffer, ptr noalias nocapture readonly %op_pblendvb_255.buffer) local_unnamed_addr #1 {
destructor_block:
  %"__test_op_result$15" = tail call i32 @__test_op(ptr poison, ptr poison, ptr poison, ptr %in_u8.buffer, ptr poison, ptr poison, ptr poison, ptr poison, ptr poison, ptr poison, ptr %op_pblendvb_255.buffer) #3
  ret i32 0
}
