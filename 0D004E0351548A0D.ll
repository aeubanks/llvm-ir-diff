...
"for op_pmulhw_13.s0.x.x":                        ; preds = %"for op_pmulhw_13.s0.x.x", %"for op_pmulhw_13.s0.x.x.preheader"
  ...
  %8 = shufflevector <4 x i16> %t16.s, <4 x i16> undef, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison>
  ...
  %15 = shufflevector <4 x i16> %t16.s.1, <4 x i16> undef, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison>
  ...
  %22 = shufflevector <4 x i16> %t16.s.2, <4 x i16> undef, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison>
  ...
  %29 = shufflevector <4 x i16> %t16.s.3, <4 x i16> undef, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison>
