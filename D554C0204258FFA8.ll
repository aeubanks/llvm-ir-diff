...
if.end:                                           ; preds = %_ZN28btCompoundCollisionAlgorithm21removeChildAlgorithmsEv.exit, %entry
  ...
  %cmp15404 = icmp sgt i32 %16, 0
  br i1 %cmp15404, label %for.body.lr.ph, label %_ZN20btAlignedObjectArrayIP20btPersistentManifoldED2Ev.exit
...
for.body:                                         ; preds = %for.body.lr.ph, %for.inc45
  ...
  %indvars.iv414 = phi i64 [ 0, %for.body.lr.ph ], [ %indvars.iv.next415, %for.inc45 ]
  %18 = load ptr, ptr %m_data.i, align 8, !tbaa !15
  %arrayidx.i = getelementptr inbounds ptr, ptr %18, i64 %indvars.iv414
...
for.cond25.preheader:                             ; preds = %if.then20
  ...
  %cmp29402 = icmp sgt i32 %21, 0
  br i1 %cmp29402, label %for.body30, label %for.cond.cleanup
...
_ZN20btAlignedObjectArrayIP20btPersistentManifoldE5clearEv.exit: ; preds = %if.then3.i.i, %for.cond.cleanup
  ...
  store i32 0, ptr %m_size.i.i240, align 4, !tbaa !62
  store i32 0, ptr %m_capacity.i.i, align 8, !tbaa !63
  %.pre425 = load i32, ptr %m_size.i, align 4, !tbaa !16
  br label %for.inc45
...
for.body30:                                       ; preds = %for.cond25.preheader, %for.inc
  ...
  %arrayidx.i251 = getelementptr inbounds ptr, ptr %27, i64 %indvars.iv
  %28 = load ptr, ptr %arrayidx.i251, align 8, !tbaa !41
...
for.inc45:                                        ; preds = %_ZN20btAlignedObjectArrayIP20btPersistentManifoldE5clearEv.exit, %for.body
  %34 = phi i32 [ %.pre425, %_ZN20btAlignedObjectArrayIP20btPersistentManifoldE5clearEv.exit ], [ %17, %for.body ]
  %indvars.iv.next415 = add nuw nsw i64 %indvars.iv414, 1
  %35 = sext i32 %34 to i64
  %cmp15 = icmp slt i64 %indvars.iv.next415, %35
...
if.then53:                                        ; preds = %_ZN20btAlignedObjectArrayIP20btPersistentManifoldED2Ev.exit
  ...
  %m_origin.i263 = getelementptr inbounds %class.btCollisionObject, ptr %cond7, i64 0, i32 1, i32 1
  %39 = load float, ptr %m_origin.i263, align 4, !tbaa !72, !noalias !78
  ...
  %retval.sroa.3.12.vec.insert.i.i427 = insertelement <2 x float> %60, float 0.000000e+00, i64 1
  ...
  %m_worldTransform.i261 = getelementptr inbounds %class.btCollisionObject, ptr %cond7, i64 0, i32 1
  ...
  %96 = load <2 x float>, ptr %m_worldTransform.i261, align 4, !tbaa !72, !noalias !82
  ...
  %arrayidx7.i.i267 = getelementptr inbounds [3 x %class.btVector3], ptr %otherInCompoundSpace, i64 0, i64 1
  ...
  store <2 x float> %109, ptr %arrayidx7.i.i267, align 8
  %ref.tmp.sroa.11.16.arrayidx7.i.i267.sroa_idx = getelementptr inbounds [3 x %class.btVector3], ptr %otherInCompoundSpace, i64 0, i64 1, i32 0, i64 2
  store float %89, ptr %ref.tmp.sroa.11.16.arrayidx7.i.i267.sroa_idx, align 8, !tbaa.struct !85
  %ref.tmp.sroa.12.16.arrayidx7.i.i267.sroa_idx = getelementptr inbounds [3 x %class.btVector3], ptr %otherInCompoundSpace, i64 0, i64 1, i32 0, i64 3
  store float 0.000000e+00, ptr %ref.tmp.sroa.12.16.arrayidx7.i.i267.sroa_idx, align 4, !tbaa.struct !87
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i.i427, ptr %ref.tmp.sroa.20.48.m_origin3.i.sroa_idx, align 8, !tbaa.struct !85
  %m_collisionShape.i269 = getelementptr inbounds %class.btCollisionObject, ptr %cond7, i64 0, i32 9
  %113 = load ptr, ptr %m_collisionShape.i269, align 8, !tbaa !26
...
ehcleanup:                                        ; preds = %lpad26, %lpad12
  ...
  %tobool.not.i.i.i271 = icmp eq ptr %116, null
  %117 = load i8, ptr %m_ownsMemory.i.i, align 8, !range !38
  %tobool2.not.i.i.i273 = icmp eq i8 %117, 0
  %or.cond.i.i274 = select i1 %tobool.not.i.i.i271, i1 true, i1 %tobool2.not.i.i.i273
  br i1 %or.cond.i.i274, label %ehcleanup50, label %if.then3.i.i.i275

if.then3.i.i.i275:                                ; preds = %ehcleanup
  invoke void @_Z21btAlignedFreeInternalPv(ptr noundef nonnull %116)
          to label %ehcleanup50 unwind label %terminate.lpad

ehcleanup50:                                      ; preds = %ehcleanup, %if.then3.i.i.i275
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %manifoldArray) #14
...
ehcleanup81:                                      ; preds = %lpad77, %lpad58
  %.pn410 = phi { ptr, i32 } [ %119, %lpad77 ], [ %118, %lpad58 ]
  call void @llvm.lifetime.end.p0(i64 64, ptr nonnull %otherInCompoundSpace) #14
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %localAabbMax) #14
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %localAabbMin) #14
  br label %ehcleanup193
...
if.else:                                          ; preds = %_ZN20btAlignedObjectArrayIP20btPersistentManifoldED2Ev.exit
  ...
  %cmp90406 = icmp sgt i32 %120, 0
  br i1 %cmp90406, label %invoke.cont93.lr.ph, label %invoke.cont187

invoke.cont93.lr.ph:                              ; preds = %if.else
  %m_data.i.i281 = getelementptr inbounds %class.btCompoundShape, ptr %1, i64 0, i32 1, i32 5
  %wide.trip.count = zext i32 %120 to i64
  br label %invoke.cont93

invoke.cont93:                                    ; preds = %invoke.cont93.lr.ph, %invoke.cont93
  %indvars.iv417 = phi i64 [ 0, %invoke.cont93.lr.ph ], [ %indvars.iv.next418, %invoke.cont93 ]
  %121 = load ptr, ptr %m_data.i.i281, align 8, !tbaa !46
  %m_childShape.i = getelementptr inbounds %struct.btCompoundShapeChild, ptr %121, i64 %indvars.iv417, i32 1
  %122 = load ptr, ptr %m_childShape.i, align 8, !tbaa !47
  %123 = trunc i64 %indvars.iv417 to i32
...
if.end101:                                        ; preds = %invoke.cont93, %invoke.cont79
  ...
  %cmp112408 = icmp sgt i32 %.pr, 0
  br i1 %cmp112408, label %for.body113.lr.ph, label %invoke.cont187

for.body113.lr.ph:                                ; preds = %if.end101
  %m_data.i.i290 = getelementptr inbounds %class.btCompoundShape, ptr %1, i64 0, i32 1, i32 5
  %m_worldTransform.i293 = getelementptr inbounds %class.btCollisionObject, ptr %cond, i64 0, i32 1
  %orgTrans.sroa.5.0.m_worldTransform.i293.sroa_idx = getelementptr inbounds %class.btCollisionObject, ptr %cond, i64 0, i32 1, i32 0, i32 0, i64 0, i32 0, i64 1
  %orgTrans.sroa.6.0.m_worldTransform.i293.sroa_idx = getelementptr inbounds %class.btCollisionObject, ptr %cond, i64 0, i32 1, i32 0, i32 0, i64 0, i32 0, i64 2
  %arrayidx6.i.i294 = getelementptr inbounds %class.btCollisionObject, ptr %cond, i64 0, i32 1, i32 0, i32 0, i64 1
  %orgTrans.sroa.9.16.arrayidx6.i.i294.sroa_idx = getelementptr inbounds %class.btCollisionObject, ptr %cond, i64 0, i32 1, i32 0, i32 0, i64 1, i32 0, i64 1
  %orgTrans.sroa.10.16.arrayidx6.i.i294.sroa_idx = getelementptr inbounds %class.btCollisionObject, ptr %cond, i64 0, i32 1, i32 0, i32 0, i64 1, i32 0, i64 2
  ...
  %m_origin3.i296 = getelementptr inbounds %class.btCollisionObject, ptr %cond, i64 0, i32 1, i32 1
  %orgTrans.sroa.18.48.m_origin3.i296.sroa_idx = getelementptr inbounds %class.btCollisionObject, ptr %cond, i64 0, i32 1, i32 1, i32 0, i64 2
  %ref.tmp.sroa.5.0.agg.result.sroa_idx.i347 = getelementptr inbounds i8, ptr %newChildWorldTrans, i64 8
  %ref.tmp.sroa.6.0.agg.result.sroa_idx.i348 = getelementptr inbounds i8, ptr %newChildWorldTrans, i64 12
  %arrayidx8.i.i.i349 = getelementptr inbounds [3 x %class.btVector3], ptr %newChildWorldTrans, i64 0, i64 1
  %ref.tmp.sroa.10.16.arrayidx8.i.i.sroa_idx.i351 = getelementptr inbounds [3 x %class.btVector3], ptr %newChildWorldTrans, i64 0, i64 1, i32 0, i64 2
  %ref.tmp.sroa.11.16.arrayidx8.i.i.sroa_idx.i352 = getelementptr inbounds [3 x %class.btVector3], ptr %newChildWorldTrans, i64 0, i64 1, i32 0, i64 3
  %arrayidx12.i.i7.i353 = getelementptr inbounds [3 x %class.btVector3], ptr %newChildWorldTrans, i64 0, i64 2
  %ref.tmp.sroa.15.32.arrayidx12.i.i7.sroa_idx.i355 = getelementptr inbounds [3 x %class.btVector3], ptr %newChildWorldTrans, i64 0, i64 2, i32 0, i64 2
  %ref.tmp.sroa.16.32.arrayidx12.i.i7.sroa_idx.i356 = getelementptr inbounds [3 x %class.btVector3], ptr %newChildWorldTrans, i64 0, i64 2, i32 0, i64 3
  %m_origin.i8.i357 = getelementptr inbounds %class.btTransform, ptr %newChildWorldTrans, i64 0, i32 1
  %ref.tmp3.sroa.4.0.m_origin.i8.sroa_idx.i358 = getelementptr inbounds %class.btTransform, ptr %newChildWorldTrans, i64 0, i32 1, i32 0, i64 2
  %m_collisionShape.i359 = getelementptr inbounds %class.btCollisionObject, ptr %cond7, i64 0, i32 9
  %m_worldTransform.i360 = getelementptr inbounds %class.btCollisionObject, ptr %cond7, i64 0, i32 1
  %arrayidx.i.i361 = getelementptr inbounds [4 x float], ptr %aabbMin0, i64 0, i64 2
  ...
  %wide.trip.count423 = zext i32 %.pr to i64
  br label %for.body113

for.body113:                                      ; preds = %for.body113.lr.ph, %for.inc184
  %indvars.iv420 = phi i64 [ 0, %for.body113.lr.ph ], [ %indvars.iv.next421, %for.inc184 ]
  %124 = load ptr, ptr %m_data.i, align 8, !tbaa !15
  %arrayidx.i289 = getelementptr inbounds ptr, ptr %124, i64 %indvars.iv420
  %125 = load ptr, ptr %arrayidx.i289, align 8, !tbaa !41
  %tobool118.not = icmp eq ptr %125, null
  br i1 %tobool118.not, label %for.inc184, label %if.then119

if.then119:                                       ; preds = %for.body113
  %126 = load ptr, ptr %m_data.i.i290, align 8, !tbaa !46
  %m_childShape.i292 = getelementptr inbounds %struct.btCompoundShapeChild, ptr %126, i64 %indvars.iv420, i32 1
  %127 = load ptr, ptr %m_childShape.i292, align 8, !tbaa !47
  %orgTrans.sroa.11393.32.copyload = load float, ptr %arrayidx10.i.i, align 4, !tbaa.struct !88
  ...
  %orgTrans.sroa.18.48.copyload = load float, ptr %orgTrans.sroa.18.48.m_origin3.i296.sroa_idx, align 4, !tbaa.struct !85
  %arrayidx.i.i305 = getelementptr inbounds %struct.btCompoundShapeChild, ptr %126, i64 %indvars.iv420
  call void @llvm.lifetime.start.p0(i64 64, ptr nonnull %newChildWorldTrans) #14
  call void @llvm.experimental.noalias.scope.decl(metadata !94)
  %arrayidx4.i.i.i306 = getelementptr inbounds [3 x %class.btVector3], ptr %arrayidx.i.i305, i64 0, i64 1
  %arrayidx9.i.i.i309 = getelementptr inbounds [3 x %class.btVector3], ptr %arrayidx.i.i305, i64 0, i64 2
  %arrayidx.i.i45.i.i315 = getelementptr inbounds [4 x float], ptr %arrayidx.i.i305, i64 0, i64 2
  %128 = load float, ptr %arrayidx.i.i45.i.i315, align 4, !tbaa !72, !noalias !97
  %arrayidx.i14.i46.i.i316 = getelementptr inbounds [3 x %class.btVector3], ptr %arrayidx.i.i305, i64 0, i64 1, i32 0, i64 2
  %129 = load float, ptr %arrayidx.i14.i46.i.i316, align 4, !tbaa !72, !noalias !97
  %arrayidx.i16.i49.i.i318 = getelementptr inbounds [3 x %class.btVector3], ptr %arrayidx.i.i305, i64 0, i64 2, i32 0, i64 2
  %130 = load float, ptr %arrayidx.i16.i49.i.i318, align 4, !tbaa !72, !noalias !97
  %mul7.i87.i.i330 = fmul float %orgTrans.sroa.13.32.copyload, %129
  %131 = call float @llvm.fmuladd.f32(float %128, float %orgTrans.sroa.11393.32.copyload, float %mul7.i87.i.i330)
  %132 = call float @llvm.fmuladd.f32(float %130, float %orgTrans.sroa.14.32.copyload, float %131)
  %m_origin.i331 = getelementptr inbounds %class.btTransform, ptr %arrayidx.i.i305, i64 0, i32 1
  %133 = load float, ptr %m_origin.i331, align 4, !tbaa !72, !noalias !94
  %arrayidx7.i.i.i332 = getelementptr inbounds %class.btTransform, ptr %arrayidx.i.i305, i64 0, i32 1, i32 0, i64 1
  %134 = load float, ptr %arrayidx7.i.i.i332, align 4, !tbaa !72, !noalias !94
  %arrayidx12.i.i.i334 = getelementptr inbounds %class.btTransform, ptr %arrayidx.i.i305, i64 0, i32 1, i32 0, i64 2
  %135 = load float, ptr %arrayidx12.i.i.i334, align 4, !tbaa !72, !noalias !94
  %orgTrans.sroa.0.0.copyload = load float, ptr %m_worldTransform.i293, align 4, !tbaa.struct !88
  %orgTrans.sroa.5.0.copyload = load float, ptr %orgTrans.sroa.5.0.m_worldTransform.i293.sroa_idx, align 4, !tbaa.struct !93
  %orgTrans.sroa.6.0.copyload = load float, ptr %orgTrans.sroa.6.0.m_worldTransform.i293.sroa_idx, align 4, !tbaa.struct !85
  %orgTrans.sroa.7392.16.copyload = load float, ptr %arrayidx6.i.i294, align 4, !tbaa.struct !88
  %orgTrans.sroa.9.16.copyload = load float, ptr %orgTrans.sroa.9.16.arrayidx6.i.i294.sroa_idx, align 4, !tbaa.struct !93
  %orgTrans.sroa.10.16.copyload = load float, ptr %orgTrans.sroa.10.16.arrayidx6.i.i294.sroa_idx, align 4, !tbaa.struct !85
  %136 = load <2 x float>, ptr %m_origin3.i296, align 4
  %mul7.i48.i.i317 = fmul float %orgTrans.sroa.5.0.copyload, %129
  %137 = call float @llvm.fmuladd.f32(float %128, float %orgTrans.sroa.0.0.copyload, float %mul7.i48.i.i317)
  %138 = call float @llvm.fmuladd.f32(float %130, float %orgTrans.sroa.6.0.copyload, float %137)
  %mul7.i67.i.i324 = fmul float %orgTrans.sroa.9.16.copyload, %129
  %139 = call float @llvm.fmuladd.f32(float %128, float %orgTrans.sroa.7392.16.copyload, float %mul7.i67.i.i324)
  ...
  %147 = insertelement <2 x float> %146, float %orgTrans.sroa.7392.16.copyload, i64 1
  ...
  %mul8.i29.i.i340 = fmul float %orgTrans.sroa.13.32.copyload, %134
  %157 = call float @llvm.fmuladd.f32(float %orgTrans.sroa.11393.32.copyload, float %133, float %mul8.i29.i.i340)
  %158 = call float @llvm.fmuladd.f32(float %orgTrans.sroa.14.32.copyload, float %135, float %157)
  %add17.i.i342 = fadd float %orgTrans.sroa.18.48.copyload, %158
  %retval.sroa.3.12.vec.insert.i.i345 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %add17.i.i342, i64 0
  %159 = load <2 x float>, ptr %arrayidx.i.i305, align 4, !tbaa !72, !noalias !97
  %160 = load <2 x float>, ptr %arrayidx4.i.i.i306, align 4, !tbaa !72, !noalias !97
  ...
  %165 = load <2 x float>, ptr %arrayidx9.i.i.i309, align 4, !tbaa !72, !noalias !97
  ...
  store float %138, ptr %ref.tmp.sroa.5.0.agg.result.sroa_idx.i347, align 8, !tbaa.struct !85, !alias.scope !94
  store float 0.000000e+00, ptr %ref.tmp.sroa.6.0.agg.result.sroa_idx.i348, align 4, !tbaa.struct !87, !alias.scope !94
  ...
  %171 = insertelement <2 x float> poison, float %orgTrans.sroa.7392.16.copyload, i64 0
  ...
  store <2 x float> %176, ptr %arrayidx8.i.i.i349, align 8, !alias.scope !94
  store float %140, ptr %ref.tmp.sroa.10.16.arrayidx8.i.i.sroa_idx.i351, align 8, !tbaa.struct !85, !alias.scope !94
  store float 0.000000e+00, ptr %ref.tmp.sroa.11.16.arrayidx8.i.i.sroa_idx.i352, align 4, !tbaa.struct !87, !alias.scope !94
  ...
  %180 = insertelement <2 x float> poison, float %orgTrans.sroa.11393.32.copyload, i64 0
  ...
  store <2 x float> %185, ptr %arrayidx12.i.i7.i353, align 8, !alias.scope !94
  store float %132, ptr %ref.tmp.sroa.15.32.arrayidx12.i.i7.sroa_idx.i355, align 8, !tbaa.struct !85, !alias.scope !94
  store float 0.000000e+00, ptr %ref.tmp.sroa.16.32.arrayidx12.i.i7.sroa_idx.i356, align 4, !tbaa.struct !87, !alias.scope !94
  store <2 x float> %156, ptr %m_origin.i8.i357, align 8, !tbaa.struct !88, !alias.scope !94
  store <2 x float> %retval.sroa.3.12.vec.insert.i.i345, ptr %ref.tmp3.sroa.4.0.m_origin.i8.sroa_idx.i358, align 8, !tbaa.struct !85, !alias.scope !94
  ...
  %187 = load ptr, ptr %m_collisionShape.i359, align 8, !tbaa !26
  ...
  call void %188(ptr noundef nonnull align 8 dereferenceable(24) %187, ptr noundef nonnull align 4 dereferenceable(64) %m_worldTransform.i360, ptr noundef nonnull align 4 dereferenceable(16) %aabbMin1, ptr noundef nonnull align 4 dereferenceable(16) %aabbMax1)
...
cond.end.i:                                       ; preds = %cond.false.i, %lor.lhs.false.i, %if.then119
  ...
  %193 = load float, ptr %arrayidx.i.i361, align 4, !tbaa !72
...
cond.end15.i:                                     ; preds = %cond.false13.i, %lor.lhs.false8.i, %cond.end.i
  ...
  %cmp20.i362 = fcmp ogt float %197, %198
  br i1 %cmp20.i362, label %if.then156, label %lor.lhs.false21.i
...
if.then156:                                       ; preds = %lor.lhs.false21.i, %cond.end15.i
  ...
  %arrayidx.i365 = getelementptr inbounds ptr, ptr %201, i64 %indvars.iv420
  %202 = load ptr, ptr %arrayidx.i365, align 8, !tbaa !41
  ...
  %arrayidx.i368 = getelementptr inbounds ptr, ptr %205, i64 %indvars.iv420
  %206 = load ptr, ptr %arrayidx.i368, align 8, !tbaa !41
  ...
  %arrayidx.i371 = getelementptr inbounds ptr, ptr %208, i64 %indvars.iv420
  store ptr null, ptr %arrayidx.i371, align 8, !tbaa !41
  br label %if.end173
...
for.inc184:                                       ; preds = %for.body113, %if.end173
  ...
  br i1 %exitcond424.not, label %invoke.cont187, label %for.body113
...
ehcleanup193:                                     ; preds = %ehcleanup81, %ehcleanup50
  %.pn.pn.pn = phi { ptr, i32 } [ %.pn, %ehcleanup50 ], [ %.pn410, %ehcleanup81 ]
  call void @llvm.lifetime.end.p0(i64 64, ptr nonnull %callback) #14
  resume { ptr, i32 } %.pn.pn.pn

terminate.lpad:                                   ; preds = %if.then3.i.i.i275
