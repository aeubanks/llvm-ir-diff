...
invoke.cont31:                                    ; preds = %invoke.cont
  ...
  %cmp.i.not352 = icmp eq ptr %18, %19
  br i1 %cmp.i.not352, label %for.cond.cleanup, label %for.body.lr.ph
...
for.body:                                         ; preds = %for.body.lr.ph, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit214
  %arg_i.0354 = phi i64 [ 0, %for.body.lr.ph ], [ %inc, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit214 ]
  %__begin2.sroa.0.0353 = phi ptr [ %18, %for.body.lr.ph ], [ %incdec.ptr.i, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit214 ]
...
if.end:                                           ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEpLEc.exit, %for.body
  ...
  %cmp = icmp ult i64 %arg_i.0354, %sub.ptr.div.i
...
if.then47:                                        ; preds = %if.end
  ...
  %_M_string_length.i.i193 = getelementptr inbounds %"class.std::__cxx11::basic_string", ptr %34, i64 %arg_i.0354, i32 1
...
if.then52:                                        ; preds = %if.then47
  %add.ptr.i = getelementptr inbounds %"class.std::__cxx11::basic_string", ptr %34, i64 %arg_i.0354
...
ehcleanup:                                        ; preds = %if.then.i.i201, %lpad58, %lpad54
  %.pn343 = phi { ptr, i32 } [ %41, %lpad54 ], [ %lpad.phi, %lpad58 ], [ %lpad.phi, %if.then.i.i201 ]
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %ref.tmp) #11
  br label %ehcleanup181
...
if.end63:                                         ; preds = %if.then47, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit, %if.end
  ...
  %43 = load i64, ptr %__begin2.sroa.0.0353, align 8, !tbaa !81
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit214: ; preds = %invoke.cont70, %if.then.i.i213
  ...
  %inc = add i64 %arg_i.0354, 1
  %incdec.ptr.i = getelementptr inbounds i64, ptr %__begin2.sroa.0.0353, i64 1
...
lpad69:                                           ; preds = %lpad69.loopexit.split-lp, %lpad69.loopexit
  %lpad.phi351 = phi { ptr, i32 } [ %lpad.loopexit349, %lpad69.loopexit ], [ %lpad.loopexit.split-lp350, %lpad69.loopexit.split-lp ]
...
ehcleanup73:                                      ; preds = %if.then.i.i216, %lpad69, %lpad65
  %.pn = phi { ptr, i32 } [ %48, %lpad65 ], [ %lpad.phi351, %lpad69 ], [ %lpad.phi351, %if.then.i.i216 ]
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %ref.tmp64) #11
  br label %ehcleanup181
...
invoke.cont88:                                    ; preds = %if.then83
  %52 = load ptr, ptr %min_time.i, align 8
  %53 = load ptr, ptr %ref.tmp84, align 8, !tbaa !78
  %54 = getelementptr inbounds %"class.std::__cxx11::basic_string", ptr %ref.tmp84, i64 0, i32 2
  %cmp.i62.i = icmp eq ptr %53, %54
...
if.then17.i:                                      ; preds = %if.then16.i
  ...
  %55 = load i64, ptr %_M_string_length.i.i218, align 8, !tbaa !10
  switch i64 %55, label %if.end.i.i.i [
    i64 0, label %if.end25.i
    i64 1, label %if.then.i.i219
  ]

if.then.i.i219:                                   ; preds = %if.then17.i
  %56 = load i8, ptr %53, align 1, !tbaa !13
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSEOS4_.exit: ; preds = %if.then16.i, %if.end25.i, %if.then39.i, %if.else42.i
  ...
  %62 = load ptr, ptr %ref.tmp84, align 8, !tbaa !78
  %cmp.i.i.i222 = icmp eq ptr %62, %54
...
lpad80:                                           ; preds = %if.then.i.i.i310.invoke, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6appendEPKc.exit.i311.invoke, %if.then.i.i301, %if.then.i.i283, %if.then122, %for.cond.cleanup
...
if.end92:                                         ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit224, %invoke.cont81
  %65 = load ptr, ptr %benchmark_, align 8, !tbaa !53
  %iterations_94 = getelementptr inbounds %"class.benchmark::internal::Benchmark", ptr %65, i64 0, i32 9
  %66 = load i64, ptr %iterations_94, align 8, !tbaa !75
  %cmp95.not = icmp eq i64 %66, 0
  br i1 %cmp95.not, label %if.end105, label %if.then96

if.then96:                                        ; preds = %if.end92
  call void @llvm.lifetime.start.p0(i64 32, ptr nonnull %ref.tmp97) #11
  invoke void (ptr, ptr, ...) @_ZN9benchmark9StrFormatB5cxx11EPKcz(ptr nonnull sret(%"class.std::__cxx11::basic_string") align 8 %ref.tmp97, ptr noundef nonnull @.str.3, i64 noundef %66)
          to label %invoke.cont101 unwind label %lpad100

invoke.cont101:                                   ; preds = %if.then96
  %67 = load ptr, ptr %iterations.i, align 8
  ...
  br i1 %cmp.i62.i225, label %if.then16.i227, label %invoke.cont29.i241

if.then16.i227:                                   ; preds = %invoke.cont101
  %cmp.not.i226 = icmp eq ptr %ref.tmp97, %iterations.i
  br i1 %cmp.not.i226, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSEOS4_.exit245, label %if.then17.i229, !prof !82

if.then17.i229:                                   ; preds = %if.then16.i227
  ...
  switch i64 %70, label %if.end.i.i.i231 [
    i64 0, label %if.end25.i235
    i64 1, label %if.then.i.i230
  ]

if.then.i.i230:                                   ; preds = %if.then17.i229
  %71 = load i8, ptr %68, align 1, !tbaa !13
  store i8 %71, ptr %67, align 1, !tbaa !13
  br label %if.end25.i235

if.end.i.i.i231:                                  ; preds = %if.then17.i229
  call void @llvm.memcpy.p0.p0.i64(ptr align 1 %67, ptr align 1 %68, i64 %70, i1 false)
  br label %if.end25.i235

if.end25.i235:                                    ; preds = %if.end.i.i.i231, %if.then.i.i230, %if.then17.i229
  %72 = load i64, ptr %_M_string_length.i.i228, align 8, !tbaa !10
  store i64 %72, ptr %_M_string_length.i.i.i4.i, align 8, !tbaa !10
  %73 = load ptr, ptr %iterations.i, align 8, !tbaa !78
  %arrayidx.i.i233 = getelementptr inbounds i8, ptr %73, i64 %72
  store i8 0, ptr %arrayidx.i.i233, align 1, !tbaa !13
  %.pre.i234 = load ptr, ptr %ref.tmp97, align 8, !tbaa !78
  br label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSEOS4_.exit245

invoke.cont29.i241:                               ; preds = %invoke.cont101
  %cmp.i66.i236 = icmp eq ptr %67, %3
  %74 = load i64, ptr %3, align 8
  store ptr %68, ptr %iterations.i, align 8, !tbaa !78
  %_M_string_length.i67.i237 = getelementptr inbounds %"class.std::__cxx11::basic_string", ptr %ref.tmp97, i64 0, i32 1
  %75 = load <2 x i64>, ptr %_M_string_length.i67.i237, align 8, !tbaa !13
  store <2 x i64> %75, ptr %_M_string_length.i.i.i4.i, align 8, !tbaa !13
  %tobool38.not69.i239 = icmp eq ptr %67, null
  %tobool38.not.i240 = or i1 %cmp.i66.i236, %tobool38.not69.i239
  br i1 %tobool38.not.i240, label %if.else42.i243, label %if.then39.i242

if.then39.i242:                                   ; preds = %invoke.cont29.i241
  store ptr %67, ptr %ref.tmp97, align 8, !tbaa !78
  store i64 %74, ptr %69, align 8, !tbaa !13
  br label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSEOS4_.exit245

if.else42.i243:                                   ; preds = %invoke.cont29.i241
  store ptr %69, ptr %ref.tmp97, align 8, !tbaa !78
  br label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSEOS4_.exit245

_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSEOS4_.exit245: ; preds = %if.then16.i227, %if.end25.i235, %if.then39.i242, %if.else42.i243
  %76 = phi ptr [ %67, %if.then39.i242 ], [ %69, %if.else42.i243 ], [ %.pre.i234, %if.end25.i235 ], [ %68, %if.then16.i227 ]
  %_M_string_length.i.i.i.i244 = getelementptr inbounds %"class.std::__cxx11::basic_string", ptr %ref.tmp97, i64 0, i32 1
  store i64 0, ptr %_M_string_length.i.i.i.i244, align 8, !tbaa !10
  store i8 0, ptr %76, align 1, !tbaa !13
  %77 = load ptr, ptr %ref.tmp97, align 8, !tbaa !78
  %cmp.i.i.i246 = icmp eq ptr %77, %69
  br i1 %cmp.i.i.i246, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit248, label %if.then.i.i247

if.then.i.i247:                                   ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSEOS4_.exit245
  call void @_ZdlPv(ptr noundef %77) #13
  br label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit248

_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit248: ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSEOS4_.exit245, %if.then.i.i247
...
if.end105:                                        ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit248, %if.end92
  %79 = phi ptr [ %.pre, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit248 ], [ %65, %if.end92 ]
  %repetitions_107 = getelementptr inbounds %"class.benchmark::internal::Benchmark", ptr %79, i64 0, i32 10
  %80 = load i32, ptr %repetitions_107, align 8, !tbaa !71
  %cmp108.not = icmp eq i32 %80, 0
  br i1 %cmp108.not, label %if.end118, label %if.then109

if.then109:                                       ; preds = %if.end105
  call void @llvm.lifetime.start.p0(i64 32, ptr nonnull %ref.tmp110) #11
  invoke void (ptr, ptr, ...) @_ZN9benchmark9StrFormatB5cxx11EPKcz(ptr nonnull sret(%"class.std::__cxx11::basic_string") align 8 %ref.tmp110, ptr noundef nonnull @.str.4, i32 noundef %80)
          to label %invoke.cont114 unwind label %lpad113

invoke.cont114:                                   ; preds = %if.then109
  %81 = load ptr, ptr %repetitions.i, align 8
  %82 = load ptr, ptr %ref.tmp110, align 8, !tbaa !78
  %83 = getelementptr inbounds %"class.std::__cxx11::basic_string", ptr %ref.tmp110, i64 0, i32 2
  %cmp.i62.i249 = icmp eq ptr %82, %83
  br i1 %cmp.i62.i249, label %if.then16.i251, label %invoke.cont29.i265

if.then16.i251:                                   ; preds = %invoke.cont114
  %cmp.not.i250 = icmp eq ptr %ref.tmp110, %repetitions.i
  br i1 %cmp.not.i250, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSEOS4_.exit269, label %if.then17.i253, !prof !82

if.then17.i253:                                   ; preds = %if.then16.i251
  %_M_string_length.i.i252 = getelementptr inbounds %"class.std::__cxx11::basic_string", ptr %ref.tmp110, i64 0, i32 1
  %84 = load i64, ptr %_M_string_length.i.i252, align 8, !tbaa !10
  switch i64 %84, label %if.end.i.i.i255 [
    i64 0, label %if.end25.i259
    i64 1, label %if.then.i.i254
  ]

if.then.i.i254:                                   ; preds = %if.then17.i253
  %85 = load i8, ptr %82, align 1, !tbaa !13
  store i8 %85, ptr %81, align 1, !tbaa !13
  br label %if.end25.i259

if.end.i.i.i255:                                  ; preds = %if.then17.i253
  call void @llvm.memcpy.p0.p0.i64(ptr align 1 %81, ptr align 1 %82, i64 %84, i1 false)
  br label %if.end25.i259

if.end25.i259:                                    ; preds = %if.end.i.i.i255, %if.then.i.i254, %if.then17.i253
  %86 = load i64, ptr %_M_string_length.i.i252, align 8, !tbaa !10
  store i64 %86, ptr %_M_string_length.i.i.i5.i, align 8, !tbaa !10
  %87 = load ptr, ptr %repetitions.i, align 8, !tbaa !78
  %arrayidx.i.i257 = getelementptr inbounds i8, ptr %87, i64 %86
  store i8 0, ptr %arrayidx.i.i257, align 1, !tbaa !13
  %.pre.i258 = load ptr, ptr %ref.tmp110, align 8, !tbaa !78
  br label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSEOS4_.exit269

invoke.cont29.i265:                               ; preds = %invoke.cont114
  %cmp.i66.i260 = icmp eq ptr %81, %4
  %88 = load i64, ptr %4, align 8
  store ptr %82, ptr %repetitions.i, align 8, !tbaa !78
  %_M_string_length.i67.i261 = getelementptr inbounds %"class.std::__cxx11::basic_string", ptr %ref.tmp110, i64 0, i32 1
  %89 = load <2 x i64>, ptr %_M_string_length.i67.i261, align 8, !tbaa !13
  store <2 x i64> %89, ptr %_M_string_length.i.i.i5.i, align 8, !tbaa !13
  %tobool38.not69.i263 = icmp eq ptr %81, null
  %tobool38.not.i264 = or i1 %cmp.i66.i260, %tobool38.not69.i263
  br i1 %tobool38.not.i264, label %if.else42.i267, label %if.then39.i266

if.then39.i266:                                   ; preds = %invoke.cont29.i265
  store ptr %81, ptr %ref.tmp110, align 8, !tbaa !78
  store i64 %88, ptr %83, align 8, !tbaa !13
  br label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSEOS4_.exit269

if.else42.i267:                                   ; preds = %invoke.cont29.i265
  store ptr %83, ptr %ref.tmp110, align 8, !tbaa !78
  br label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSEOS4_.exit269

_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSEOS4_.exit269: ; preds = %if.then16.i251, %if.end25.i259, %if.then39.i266, %if.else42.i267
  %90 = phi ptr [ %81, %if.then39.i266 ], [ %83, %if.else42.i267 ], [ %.pre.i258, %if.end25.i259 ], [ %82, %if.then16.i251 ]
  %_M_string_length.i.i.i.i268 = getelementptr inbounds %"class.std::__cxx11::basic_string", ptr %ref.tmp110, i64 0, i32 1
  store i64 0, ptr %_M_string_length.i.i.i.i268, align 8, !tbaa !10
  store i8 0, ptr %90, align 1, !tbaa !13
  %91 = load ptr, ptr %ref.tmp110, align 8, !tbaa !78
  %cmp.i.i.i270 = icmp eq ptr %91, %83
  br i1 %cmp.i.i.i270, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit272, label %if.then.i.i271

if.then.i.i271:                                   ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSEOS4_.exit269
  call void @_ZdlPv(ptr noundef %91) #13
  br label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit272

_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit272: ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSEOS4_.exit269, %if.then.i.i271
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %ref.tmp110) #11
  %.pre355 = load ptr, ptr %benchmark_, align 8, !tbaa !53
  br label %if.end118
...
if.end118:                                        ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit272, %if.end105
  %93 = phi ptr [ %.pre355, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit272 ], [ %79, %if.end105 ]
  %measure_process_cpu_time_120 = getelementptr inbounds %"class.benchmark::internal::Benchmark", ptr %93, i64 0, i32 11
  %94 = load i8, ptr %measure_process_cpu_time_120, align 4, !tbaa !54, !range !55, !noundef !56
  %tobool121.not = icmp eq i8 %94, 0
  br i1 %tobool121.not, label %if.end126, label %if.then122

if.then122:                                       ; preds = %if.end118
  %95 = load i64, ptr %_M_string_length.i.i.i6.i, align 8, !tbaa !10
  %call3.i.i274 = invoke noundef nonnull align 8 dereferenceable(32) ptr @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE10_M_replaceEmmPKcm(ptr noundef nonnull align 8 dereferenceable(32) %time_type.i, i64 noundef 0, i64 noundef %95, ptr noundef nonnull @.str.5, i64 noundef 12)
          to label %if.then122.if.end126_crit_edge unwind label %lpad80

if.then122.if.end126_crit_edge:                   ; preds = %if.then122
  %.pre356 = load ptr, ptr %benchmark_, align 8, !tbaa !53
  br label %if.end126

if.end126:                                        ; preds = %if.then122.if.end126_crit_edge, %if.end118
  %96 = phi ptr [ %.pre356, %if.then122.if.end126_crit_edge ], [ %93, %if.end118 ]
  %use_manual_time_128 = getelementptr inbounds %"class.benchmark::internal::Benchmark", ptr %96, i64 0, i32 13
  %97 = load i8, ptr %use_manual_time_128, align 2, !tbaa !60, !range !55, !noundef !56
...
if.then130:                                       ; preds = %if.end126
  ...
  %cmp.i276 = icmp eq i64 %98, 0
  br i1 %cmp.i276, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6appendEPKc.exit.i311.invoke, label %if.then134

if.then134:                                       ; preds = %if.then130
  %add.i.i278 = add i64 %98, 1
  %99 = load ptr, ptr %time_type.i, align 8, !tbaa !78
  %cmp.i.i.i.i279 = icmp eq ptr %99, %5
  %100 = load i64, ptr %5, align 8
  %cond.i.i.i280 = select i1 %cmp.i.i.i.i279, i64 15, i64 %100
  %cmp.i.i281 = icmp ugt i64 %add.i.i278, %cond.i.i.i280
  br i1 %cmp.i.i281, label %if.then.i.i283, label %if.end139

if.then.i.i283:                                   ; preds = %if.then134
  invoke void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE9_M_mutateEmmPKcm(ptr noundef nonnull align 8 dereferenceable(32) %time_type.i, i64 noundef %98, i64 noundef 0, ptr noundef null, i64 noundef 1)
          to label %.noexc286 unwind label %lpad80

.noexc286:                                        ; preds = %if.then.i.i283
  %.pre.i.i282 = load ptr, ptr %time_type.i, align 8, !tbaa !78
  br label %if.end139

if.end139:                                        ; preds = %.noexc286, %if.then134
  %101 = phi ptr [ %.pre.i.i282, %.noexc286 ], [ %99, %if.then134 ]
  %arrayidx.i.i284 = getelementptr inbounds i8, ptr %101, i64 %98
  store i8 47, ptr %arrayidx.i.i284, align 1, !tbaa !13
  store i64 %add.i.i278, ptr %_M_string_length.i.i.i6.i, align 8, !tbaa !10
  %102 = load ptr, ptr %time_type.i, align 8, !tbaa !78
  %arrayidx.i.i.i285 = getelementptr inbounds i8, ptr %102, i64 %add.i.i278
  store i8 0, ptr %arrayidx.i.i.i285, align 1, !tbaa !13
  %.pre357 = load i64, ptr %_M_string_length.i.i.i6.i, align 8, !tbaa !10
  %103 = add i64 %.pre357, -4611686018427387893
  %104 = icmp ult i64 %103, 11
  br i1 %104, label %if.then.i.i.i310.invoke, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6appendEPKc.exit.i311.invoke

if.else:                                          ; preds = %if.end126
  %use_real_time_145 = getelementptr inbounds %"class.benchmark::internal::Benchmark", ptr %96, i64 0, i32 12
  %105 = load i8, ptr %use_real_time_145, align 1, !tbaa !58, !range !55, !noundef !56
  %tobool146.not = icmp eq i8 %105, 0
  br i1 %tobool146.not, label %if.end162, label %if.then147

if.then147:                                       ; preds = %if.else
  %106 = load i64, ptr %_M_string_length.i.i.i6.i, align 8, !tbaa !10
  %cmp.i294 = icmp eq i64 %106, 0
  br i1 %cmp.i294, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6appendEPKc.exit.i311.invoke, label %if.then151

if.then151:                                       ; preds = %if.then147
  %add.i.i296 = add i64 %106, 1
  %107 = load ptr, ptr %time_type.i, align 8, !tbaa !78
  %cmp.i.i.i.i297 = icmp eq ptr %107, %5
  %108 = load i64, ptr %5, align 8
  %cond.i.i.i298 = select i1 %cmp.i.i.i.i297, i64 15, i64 %108
  %cmp.i.i299 = icmp ugt i64 %add.i.i296, %cond.i.i.i298
  br i1 %cmp.i.i299, label %if.then.i.i301, label %if.end156

if.then.i.i301:                                   ; preds = %if.then151
  invoke void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE9_M_mutateEmmPKcm(ptr noundef nonnull align 8 dereferenceable(32) %time_type.i, i64 noundef %106, i64 noundef 0, ptr noundef null, i64 noundef 1)
          to label %.noexc304 unwind label %lpad80

.noexc304:                                        ; preds = %if.then.i.i301
  %.pre.i.i300 = load ptr, ptr %time_type.i, align 8, !tbaa !78
  br label %if.end156

if.end156:                                        ; preds = %.noexc304, %if.then151
  %109 = phi ptr [ %.pre.i.i300, %.noexc304 ], [ %107, %if.then151 ]
  %arrayidx.i.i302 = getelementptr inbounds i8, ptr %109, i64 %106
  store i8 47, ptr %arrayidx.i.i302, align 1, !tbaa !13
  store i64 %add.i.i296, ptr %_M_string_length.i.i.i6.i, align 8, !tbaa !10
  %110 = load ptr, ptr %time_type.i, align 8, !tbaa !78
  %arrayidx.i.i.i303 = getelementptr inbounds i8, ptr %110, i64 %add.i.i296
  store i8 0, ptr %arrayidx.i.i.i303, align 1, !tbaa !13
  %.pre358 = load i64, ptr %_M_string_length.i.i.i6.i, align 8, !tbaa !10
  %111 = add i64 %.pre358, -4611686018427387895
  %112 = icmp ult i64 %111, 9
  br i1 %112, label %if.then.i.i.i310.invoke, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6appendEPKc.exit.i311.invoke

if.then.i.i.i310.invoke:                          ; preds = %if.end156, %if.end139
  invoke void @_ZSt20__throw_length_errorPKc(ptr noundef nonnull @.str.9) #12
          to label %if.then.i.i.i310.cont unwind label %lpad80

if.then.i.i.i310.cont:                            ; preds = %if.then.i.i.i310.invoke
  unreachable

_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6appendEPKc.exit.i311.invoke: ; preds = %if.end156, %if.then147, %if.end139, %if.then130
  %113 = phi ptr [ @.str.6, %if.then130 ], [ @.str.6, %if.end139 ], [ @.str.7, %if.then147 ], [ @.str.7, %if.end156 ]
  %114 = phi i64 [ 11, %if.then130 ], [ 11, %if.end139 ], [ 9, %if.then147 ], [ 9, %if.end156 ]
  %115 = invoke noundef nonnull align 8 dereferenceable(32) ptr @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE9_M_appendEPKcm(ptr noundef nonnull align 8 dereferenceable(32) %time_type.i, ptr noundef nonnull %113, i64 noundef %114)
          to label %if.end162 unwind label %lpad80

if.end162:                                        ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6appendEPKc.exit.i311.invoke, %if.else
  %116 = load ptr, ptr %benchmark_, align 8, !tbaa !53
  %thread_counts_ = getelementptr inbounds %"class.benchmark::internal::Benchmark", ptr %116, i64 0, i32 17
  %117 = load ptr, ptr %thread_counts_, align 8, !tbaa !14
  %_M_finish.i.i = getelementptr inbounds %"class.benchmark::internal::Benchmark", ptr %116, i64 0, i32 17, i32 0, i32 0, i32 0, i32 1
  %118 = load ptr, ptr %_M_finish.i.i, align 8, !tbaa !14
  %cmp.i.i315 = icmp eq ptr %117, %118
  br i1 %cmp.i.i315, label %if.end173, label %if.then165

if.then165:                                       ; preds = %if.end162
  call void @llvm.lifetime.start.p0(i64 32, ptr nonnull %ref.tmp166) #11
  %119 = load i32, ptr %threads_, align 8, !tbaa !77
  invoke void (ptr, ptr, ...) @_ZN9benchmark9StrFormatB5cxx11EPKcz(ptr nonnull sret(%"class.std::__cxx11::basic_string") align 8 %ref.tmp166, ptr noundef nonnull @.str.8, i32 noundef %119)
          to label %invoke.cont169 unwind label %lpad168

invoke.cont169:                                   ; preds = %if.then165
  %120 = load ptr, ptr %threads.i, align 8
  %121 = load ptr, ptr %ref.tmp166, align 8, !tbaa !78
  %122 = getelementptr inbounds %"class.std::__cxx11::basic_string", ptr %ref.tmp166, i64 0, i32 2
  %cmp.i62.i316 = icmp eq ptr %121, %122
  br i1 %cmp.i62.i316, label %if.then16.i318, label %invoke.cont29.i332

if.then16.i318:                                   ; preds = %invoke.cont169
  %cmp.not.i317 = icmp eq ptr %ref.tmp166, %threads.i
  br i1 %cmp.not.i317, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSEOS4_.exit336, label %if.then17.i320, !prof !82

if.then17.i320:                                   ; preds = %if.then16.i318
  %_M_string_length.i.i319 = getelementptr inbounds %"class.std::__cxx11::basic_string", ptr %ref.tmp166, i64 0, i32 1
  %123 = load i64, ptr %_M_string_length.i.i319, align 8, !tbaa !10
  switch i64 %123, label %if.end.i.i.i322 [
    i64 0, label %if.end25.i326
    i64 1, label %if.then.i.i321
  ]

if.then.i.i321:                                   ; preds = %if.then17.i320
  %124 = load i8, ptr %121, align 1, !tbaa !13
  store i8 %124, ptr %120, align 1, !tbaa !13
  br label %if.end25.i326

if.end.i.i.i322:                                  ; preds = %if.then17.i320
  call void @llvm.memcpy.p0.p0.i64(ptr align 1 %120, ptr align 1 %121, i64 %123, i1 false)
  br label %if.end25.i326

if.end25.i326:                                    ; preds = %if.end.i.i.i322, %if.then.i.i321, %if.then17.i320
  %125 = load i64, ptr %_M_string_length.i.i319, align 8, !tbaa !10
  store i64 %125, ptr %_M_string_length.i.i.i7.i, align 8, !tbaa !10
  %126 = load ptr, ptr %threads.i, align 8, !tbaa !78
  %arrayidx.i.i324 = getelementptr inbounds i8, ptr %126, i64 %125
  store i8 0, ptr %arrayidx.i.i324, align 1, !tbaa !13
  %.pre.i325 = load ptr, ptr %ref.tmp166, align 8, !tbaa !78
  br label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSEOS4_.exit336

invoke.cont29.i332:                               ; preds = %invoke.cont169
  %cmp.i66.i327 = icmp eq ptr %120, %6
  %127 = load i64, ptr %6, align 8
  store ptr %121, ptr %threads.i, align 8, !tbaa !78
  %_M_string_length.i67.i328 = getelementptr inbounds %"class.std::__cxx11::basic_string", ptr %ref.tmp166, i64 0, i32 1
  %128 = load <2 x i64>, ptr %_M_string_length.i67.i328, align 8, !tbaa !13
  store <2 x i64> %128, ptr %_M_string_length.i.i.i7.i, align 8, !tbaa !13
  %tobool38.not69.i330 = icmp eq ptr %120, null
  %tobool38.not.i331 = or i1 %cmp.i66.i327, %tobool38.not69.i330
  br i1 %tobool38.not.i331, label %if.else42.i334, label %if.then39.i333

if.then39.i333:                                   ; preds = %invoke.cont29.i332
  store ptr %120, ptr %ref.tmp166, align 8, !tbaa !78
  store i64 %127, ptr %122, align 8, !tbaa !13
  br label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSEOS4_.exit336

if.else42.i334:                                   ; preds = %invoke.cont29.i332
  store ptr %122, ptr %ref.tmp166, align 8, !tbaa !78
  br label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSEOS4_.exit336

_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSEOS4_.exit336: ; preds = %if.then16.i318, %if.end25.i326, %if.then39.i333, %if.else42.i334
  %129 = phi ptr [ %120, %if.then39.i333 ], [ %122, %if.else42.i334 ], [ %.pre.i325, %if.end25.i326 ], [ %121, %if.then16.i318 ]
  %_M_string_length.i.i.i.i335 = getelementptr inbounds %"class.std::__cxx11::basic_string", ptr %ref.tmp166, i64 0, i32 1
  store i64 0, ptr %_M_string_length.i.i.i.i335, align 8, !tbaa !10
  store i8 0, ptr %129, align 1, !tbaa !13
  %130 = load ptr, ptr %ref.tmp166, align 8, !tbaa !78
  %cmp.i.i.i337 = icmp eq ptr %130, %122
  br i1 %cmp.i.i.i337, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit339, label %if.then.i.i338

if.then.i.i338:                                   ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSEOS4_.exit336
  call void @_ZdlPv(ptr noundef %130) #13
  br label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit339

_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit339: ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEaSEOS4_.exit336, %if.then.i.i338
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %ref.tmp166) #11
  %.pre359 = load ptr, ptr %benchmark_, align 8, !tbaa !53
  br label %if.end173
...
if.end173:                                        ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit339, %if.end162
  %132 = phi ptr [ %.pre359, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit339 ], [ %116, %if.end162 ]
  %setup_175 = getelementptr inbounds %"class.benchmark::internal::Benchmark", ptr %132, i64 0, i32 18
  %133 = load <2 x ptr>, ptr %setup_175, align 8, !tbaa !14
  store <2 x ptr> %133, ptr %setup_, align 8, !tbaa !14
  ret void

ehcleanup181:                                     ; preds = %lpad80, %lpad87, %lpad100, %lpad113, %lpad168, %ehcleanup73, %ehcleanup, %lpad43, %lpad30
  %.pn.pn.pn.pn = phi { ptr, i32 } [ %24, %lpad30 ], [ %131, %lpad168 ], [ %63, %lpad80 ], [ %92, %lpad113 ], [ %78, %lpad100 ], [ %64, %lpad87 ], [ %.pn, %ehcleanup73 ], [ %.pn343, %ehcleanup ], [ %30, %lpad43 ]
