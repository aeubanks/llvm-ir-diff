...
land.lhs.true.i:                                  ; preds = %entry
  ...
  %shr.i.i.i = ashr i32 %sub.i.i.i.i, %1
  ...
  br i1 %tobool3.not.i, label %lor.lhs.false.i, label %land.lhs.true.if.then12_crit_edge.i

land.lhs.true.if.then12_crit_edge.i:              ; preds = %land.lhs.true.i
  %T2.val59.pre.i = load i32, ptr %T2, align 8
  %.pre.i = sub nsw i32 0, %T2.val59.pre.i
...
land.lhs.true6.i:                                 ; preds = %lor.lhs.false.i
  ...
  %shr.i.i71.i = ashr i32 %sub.i.i.i64.i, %5
  %6 = load ptr, ptr @symbol_SIGNATURE, align 8
  %idxprom.i.i72.i = sext i32 %shr.i.i71.i to i64
...
if.then12.i:                                      ; preds = %if.then.i, %land.lhs.true.if.then12_crit_edge.i
  %sub.i.i.i84.pre-phi.i = phi i32 [ %.pre.i, %land.lhs.true.if.then12_crit_edge.i ], [ %sub.i.i.i64.i, %if.then.i ]
  %9 = phi ptr [ %2, %land.lhs.true.if.then12_crit_edge.i ], [ %6, %if.then.i ]
  %10 = phi i32 [ %1, %land.lhs.true.if.then12_crit_edge.i ], [ %5, %if.then.i ]
  %T2.val59.i = phi i32 [ %T2.val59.pre.i, %land.lhs.true.if.then12_crit_edge.i ], [ %T2.val61.i, %if.then.i ]
  %tobool.not.i.i83.i = icmp sgt i32 %T2.val59.i, -1
  %and.i.i.i85.i = and i32 %sub.i.i.i84.pre-phi.i, %0
...
if.then15.i:                                      ; preds = %if.then12.i
  %shr.i.i91.i = ashr i32 %sub.i.i.i.i, %10
  %idxprom.i.i92.i = sext i32 %shr.i.i91.i to i64
  %arrayidx.i.i93.i = getelementptr inbounds ptr, ptr %9, i64 %idxprom.i.i92.i
...
land.lhs.true19.i:                                ; preds = %if.then15.i
  %shr.i.i97.i = ashr i32 %sub.i.i.i84.pre-phi.i, %10
  %idxprom.i.i98.i = sext i32 %shr.i.i97.i to i64
  %arrayidx.i.i99.i = getelementptr inbounds ptr, ptr %9, i64 %idxprom.i.i98.i
...
lor.lhs.false23.i:                                ; preds = %land.lhs.true19.i
  ...
  br i1 %cmp.i.i, label %cleanup, label %lor.lhs.false32.i
...
if.else:                                          ; preds = %lor.lhs.false32.i, %land.lhs.true6.i, %lor.lhs.false.i
...
cleanup:                                          ; preds = %lor.lhs.false32.i, %lor.lhs.false23.i, %land.lhs.true19.i, %if.then15.i, %if.then12.i, %if.then.i, %sw.bb3, %sw.bb
  %retval.0 = phi i32 [ %call4, %sw.bb3 ], [ %call2, %sw.bb ], [ 1, %lor.lhs.false32.i ], [ 3, %lor.lhs.false23.i ], [ 3, %land.lhs.true19.i ], [ 1, %if.then15.i ], [ 3, %if.then12.i ], [ 1, %if.then.i ]
  ret i32 %retval.0
}
...
cleanup:                                          ; preds = %lor.lhs.false32.i, %lor.lhs.false23.i, %land.lhs.true19.i, %if.then15.i, %if.then12.i, %if.then.i, %sw.bb4, %sw.bb
  %retval.0 = phi i32 [ %conv.i.i, %sw.bb4 ], [ %call3, %sw.bb ], [ 0, %lor.lhs.false32.i ], [ 1, %lor.lhs.false23.i ], [ 1, %land.lhs.true19.i ], [ 0, %if.then15.i ], [ 1, %if.then12.i ], [ 0, %if.then.i ]
  ret i32 %retval.0
}
