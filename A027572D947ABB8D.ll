; ModuleID = '/usr/local/google/home/aeubanks/repos/test-suite/MultiSource/Applications/JM/ldecod/nal_part.c'
source_filename = "/usr/local/google/home/aeubanks/repos/test-suite/MultiSource/Applications/JM/ldecod/nal_part.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct.Bitstream = type { i32, i32, i32, i32, ptr, i32 }

@assignSE2partition = dso_local local_unnamed_addr global [2 x [20 x i32]] [[20 x i32] zeroinitializer, [20 x i32] [i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 1, i32 1, i32 1, i32 1, i32 0, i32 2, i32 2, i32 2, i32 2, i32 0, i32 0, i32 0, i32 0]], align 16
...
@PartitionMode = common dso_local local_unnamed_addr global i32 0, align 4

; Function Attrs: mustprogress nofree nosync nounwind willreturn memory(write, argmem: readwrite, inaccessiblemem: none) uwtable
define dso_local void @free_Partition(ptr nocapture noundef %currStream) local_unnamed_addr #0 {
entry:
  %streamBuffer = getelementptr inbounds %struct.Bitstream, ptr %currStream, i64 0, i32 4
  %0 = load ptr, ptr %streamBuffer, align 8, !tbaa !5
  %bitstream_length = getelementptr inbounds %struct.Bitstream, ptr %currStream, i64 0, i32 3
  store i32 0, ptr %bitstream_length, align 4, !tbaa !11
  %frame_bitoffset = getelementptr inbounds %struct.Bitstream, ptr %currStream, i64 0, i32 2
  store i32 0, ptr %frame_bitoffset, align 8, !tbaa !12
  %ei_flag = getelementptr inbounds %struct.Bitstream, ptr %currStream, i64 0, i32 5
  store i32 0, ptr %ei_flag, align 8, !tbaa !13
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(8000000) %0, i8 0, i64 8000000, i1 false)
  ret void
}
...
attributes #0 = { mustprogress nofree nosync nounwind willreturn memory(write, argmem: readwrite, inaccessiblemem: none) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
