...
entry:
  ...
  %cmp1154 = icmp slt i32 %sub7, 0
  %sub16 = select i1 %cmp1154, i32 %sub9, i32 0
  ...
  %cmp1154.1 = icmp slt i32 %sub7.1, 0
  %sub16.1 = select i1 %cmp1154.1, i32 %sub9.1, i32 0
  ...
  %cmp1154.2 = icmp slt i32 %sub7.2, 0
  %sub16.2 = select i1 %cmp1154.2, i32 %sub9.2, i32 0
...
for.body:                                         ; preds = %for.body.lr.ph, %for.body
  ...
  %cmp1154.i = icmp slt i32 %sub7.i, 0
  %sub16.i = select i1 %cmp1154.i, i32 %sub9.i, i32 0
  ...
  %cmp1154.1.i = icmp slt i32 %sub7.1.i, 0
  %sub16.1.i = select i1 %cmp1154.1.i, i32 %sub9.1.i, i32 0
  ...
  %cmp1154.2.i = icmp slt i32 %sub7.2.i, 0
  %sub16.2.i = select i1 %cmp1154.2.i, i32 %sub9.2.i, i32 0
