...
define dso_local i32 @usite2(i32 noundef %a, i32 noundef %b, i32 noundef %ax, i32 noundef %ay, i32 noundef %bx, i32 noundef %by) local_unnamed_addr #0 {
entry:
  ...
  %xcenter5 = getelementptr inbounds %struct.cellbox, ptr %7, i64 0, i32 2
  %8 = load i32, ptr %xcenter5, align 4, !tbaa !9
  %ycenter6 = getelementptr inbounds %struct.cellbox, ptr %7, i64 0, i32 3
  %9 = load i32, ptr %ycenter6, align 8, !tbaa !13
  %orient7 = getelementptr inbounds %struct.cellbox, ptr %7, i64 0, i32 5
  %10 = load i32, ptr %orient7, align 8, !tbaa !14
  %idxprom9 = sext i32 %10 to i64
  %arrayidx10 = getelementptr inbounds %struct.cellbox, ptr %7, i64 0, i32 21, i64 %idxprom9
  %11 = load ptr, ptr %arrayidx10, align 8, !tbaa !5
  %termptr11 = getelementptr inbounds %struct.tilebox, ptr %11, i64 0, i32 17
  %12 = load ptr, ptr %termptr11, align 8, !tbaa !15
  %13 = load i32, ptr @penalty, align 4, !tbaa !17
  %14 = load ptr, ptr @overlap, align 8, !tbaa !5
  %call = tail call i32 (i32, i32, i32, i32, i32, i32, i32, ...) %14(i32 noundef %a, i32 noundef %2, i32 noundef %3, i32 noundef %4, i32 noundef 0, i32 noundef 1, i32 noundef 0) #3
  %15 = load ptr, ptr @blockarray, align 8, !tbaa !5
  %16 = load i32, ptr @binX, align 4, !tbaa !17
  %idxprom12 = sext i32 %16 to i64
  %arrayidx13 = getelementptr inbounds ptr, ptr %15, i64 %idxprom12
  %17 = load ptr, ptr %arrayidx13, align 8, !tbaa !5
  %18 = load i32, ptr @binY, align 4, !tbaa !17
  %idxprom14 = sext i32 %18 to i64
  %arrayidx15 = getelementptr inbounds ptr, ptr %17, i64 %idxprom14
  %19 = load ptr, ptr %arrayidx15, align 8, !tbaa !5
  store ptr %19, ptr @occa1ptr, align 8, !tbaa !5
  %20 = load ptr, ptr @overlap, align 8, !tbaa !5
  %call16 = tail call i32 (i32, i32, i32, i32, i32, i32, i32, ...) %20(i32 noundef %b, i32 noundef %8, i32 noundef %9, i32 noundef %10, i32 noundef %a, i32 noundef 1, i32 noundef 0) #3
  %21 = load ptr, ptr @blockarray, align 8, !tbaa !5
  %22 = load i32, ptr @binX, align 4, !tbaa !17
  %idxprom18 = sext i32 %22 to i64
  %arrayidx19 = getelementptr inbounds ptr, ptr %21, i64 %idxprom18
  %23 = load ptr, ptr %arrayidx19, align 8, !tbaa !5
  %24 = load i32, ptr @binY, align 4, !tbaa !17
  ...
  %call22 = tail call i32 (i32, i32, i32, i32, i32, i32, i32, ...) %26(i32 noundef %a, i32 noundef %ax, i32 noundef %ay, i32 noundef %4, i32 noundef %b, i32 noundef 0, i32 noundef %10) #3
  %27 = load ptr, ptr @blockarray, align 8, !tbaa !5
  %28 = load i32, ptr @binX, align 4, !tbaa !17
  %idxprom23 = sext i32 %28 to i64
  %arrayidx24 = getelementptr inbounds ptr, ptr %27, i64 %idxprom23
  %29 = load ptr, ptr %arrayidx24, align 8, !tbaa !5
  %30 = load i32, ptr @binY, align 4, !tbaa !17
  ...
  %call27 = tail call i32 (i32, i32, i32, i32, i32, i32, i32, ...) %32(i32 noundef %b, i32 noundef %bx, i32 noundef %by, i32 noundef %10, i32 noundef %a, i32 noundef 1, i32 noundef 0) #3
  ...
  %37 = load i32, ptr @binY, align 4, !tbaa !17
  ...
  tail call void @ufixpin(ptr noundef %6, i32 noundef 0, i32 noundef %ax, i32 noundef %ay) #3
  tail call void @usoftpin(ptr noundef %1, i32 noundef 0, i32 noundef %ax, i32 noundef %ay, i32 noundef %4) #3
  tail call void @ufixpin(ptr noundef %12, i32 noundef 0, i32 noundef %bx, i32 noundef %by) #3
  tail call void @usoftpin(ptr noundef %7, i32 noundef 0, i32 noundef %bx, i32 noundef %by, i32 noundef %10) #3
  %39 = load i32, ptr @funccost, align 4, !tbaa !17
  %call33 = tail call i32 @ufixnet(ptr noundef %6) #3
  %add34 = add nsw i32 %call33, %39
  %call35 = tail call i32 @usoftnet(ptr noundef %1) #3
  %add36 = add nsw i32 %add34, %call35
  %call37 = tail call i32 @ufixnet(ptr noundef %12) #3
  %add38 = add nsw i32 %add36, %call37
  %call39 = tail call i32 @usoftnet(ptr noundef %7) #3
  %add40 = add nsw i32 %add38, %call39
  %add41 = add i32 %add40, %add28
  %40 = load i32, ptr @funccost, align 4, !tbaa !17
  %41 = load i32, ptr @penalty, align 4, !tbaa !17
...
lor.lhs.false:                                    ; preds = %entry
  ...
  %43 = load i32, ptr @randVar, align 4, !tbaa !17
  %mul = mul nsw i32 %43, 1103515245
  %add47 = add nsw i32 %mul, 12345
  store i32 %add47, ptr @randVar, align 4, !tbaa !17
...
if.then:                                          ; preds = %lor.lhs.false, %entry
  ...
  tail call void @ufixpin(ptr noundef %12, i32 noundef 1, i32 noundef 0, i32 noundef 0) #3
...
for.cond:                                         ; preds = %if.then, %for.cond
  ...
  %46 = load i32, ptr %arrayidx56, align 4, !tbaa !17
...
for.end:                                          ; preds = %for.cond
  ...
  store i32 %dec, ptr %44, align 4, !tbaa !17
  %idxprom60 = sext i32 %47 to i64
  %arrayidx61 = getelementptr inbounds i32, ptr %44, i64 %idxprom60
  %48 = load i32, ptr %arrayidx61, align 4, !tbaa !17
  store i32 %48, ptr %arrayidx56.le, align 4, !tbaa !17
  %49 = load i32, ptr %45, align 4, !tbaa !17
  %inc65 = add nsw i32 %49, 1
  store i32 %inc65, ptr %45, align 4, !tbaa !17
  %idxprom66 = sext i32 %inc65 to i64
  %arrayidx67 = getelementptr inbounds i32, ptr %45, i64 %idxprom66
  store i32 %a, ptr %arrayidx67, align 4, !tbaa !17
  br label %if.end
...
for.cond71:                                       ; preds = %if.end, %for.cond71
  %indvars.iv176 = phi i64 [ %indvars.iv.next177, %for.cond71 ], [ 1, %if.end ]
  %arrayidx73 = getelementptr inbounds i32, ptr %50, i64 %indvars.iv176
  %52 = load i32, ptr %arrayidx73, align 4, !tbaa !17
...
for.end79:                                        ; preds = %for.cond71
  %arrayidx73.le = getelementptr inbounds i32, ptr %50, i64 %indvars.iv176
  %53 = load i32, ptr %50, align 4, !tbaa !17
  %dec81 = add nsw i32 %53, -1
  store i32 %dec81, ptr %50, align 4, !tbaa !17
  ...
  store i32 %54, ptr %arrayidx73.le, align 4, !tbaa !17
  %55 = load i32, ptr %51, align 4, !tbaa !17
  %inc87 = add nsw i32 %55, 1
  store i32 %inc87, ptr %51, align 4, !tbaa !17
  %idxprom88 = sext i32 %inc87 to i64
  %arrayidx89 = getelementptr inbounds i32, ptr %51, i64 %idxprom88
  store i32 %b, ptr %arrayidx89, align 4, !tbaa !17
  br label %if.end90
...
if.end90:                                         ; preds = %for.end79, %if.end
  ...
  store i32 %add40, ptr @funccost, align 4, !tbaa !17
  store i32 %add28, ptr @penalty, align 4, !tbaa !17
  br label %cleanup
