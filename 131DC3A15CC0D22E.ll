...
define dso_local i32 @s171(i32 noundef %inc) local_unnamed_addr #7 {
entry:
  %call = tail call i32 @init(ptr noundef nonnull @.str.25)
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
  %cmp18 = icmp sgt i32 %0, 0
  br i1 %cmp18, label %for.cond1.preheader.preheader, label %for.cond.cleanup

for.cond1.preheader.preheader:                    ; preds = %entry
  %1 = sext i32 %inc to i64
  %ident.check.not = icmp eq i32 %inc, 1
  br label %vector.scevcheck

vector.scevcheck:                                 ; preds = %for.cond.cleanup3, %for.cond1.preheader.preheader
  %nl.019 = phi i32 [ %inc10, %for.cond.cleanup3 ], [ 0, %for.cond1.preheader.preheader ]
  br i1 %ident.check.not, label %vector.body, label %for.body4

vector.body:                                      ; preds = %vector.scevcheck, %vector.body
  %index = phi i64 [ %index.next.1, %vector.body ], [ 0, %vector.scevcheck ]
  ...
  %3 = getelementptr inbounds double, ptr %2, i64 2
  %wide.load22 = load <2 x double>, ptr %3, align 16, !tbaa !5
  %4 = mul nsw i64 %index, %1
  %5 = getelementptr inbounds double, ptr @global_data, i64 %4
  %wide.load23 = load <2 x double>, ptr %5, align 32, !tbaa !5
  %6 = getelementptr inbounds double, ptr %5, i64 2
  %wide.load24 = load <2 x double>, ptr %6, align 16, !tbaa !5
  %7 = fadd <2 x double> %wide.load, %wide.load23
  %8 = fadd <2 x double> %wide.load22, %wide.load24
  ...
  %wide.load.1 = load <2 x double>, ptr %9, align 32, !tbaa !5
  %10 = getelementptr inbounds double, ptr %9, i64 2
  %wide.load22.1 = load <2 x double>, ptr %10, align 16, !tbaa !5
  %11 = mul nsw i64 %index.next, %1
  %12 = getelementptr inbounds double, ptr @global_data, i64 %11
  %wide.load23.1 = load <2 x double>, ptr %12, align 32, !tbaa !5
  %13 = getelementptr inbounds double, ptr %12, i64 2
  %wide.load24.1 = load <2 x double>, ptr %13, align 16, !tbaa !5
  %14 = fadd <2 x double> %wide.load.1, %wide.load23.1
  %15 = fadd <2 x double> %wide.load22.1, %wide.load24.1
  store <2 x double> %14, ptr %12, align 32, !tbaa !5
  store <2 x double> %15, ptr %13, align 16, !tbaa !5
  %index.next.1 = add nuw nsw i64 %index, 8
  %16 = icmp eq i64 %index.next.1, 32000
  br i1 %16, label %for.cond.cleanup3, label %vector.body, !llvm.loop !367

for.cond.cleanup:                                 ; preds = %for.cond.cleanup3, %entry
  %call12 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.137, double noundef 0.000000e+00)
  br label %for.body.i
...
for.cond.cleanup3:                                ; preds = %for.body4, %vector.body
  ...
  %inc10 = add nuw nsw i32 %nl.019, 1
  %23 = load i32, ptr @ntimes, align 4, !tbaa !17
  %cmp = icmp slt i32 %inc10, %23
  br i1 %cmp, label %vector.scevcheck, label %for.cond.cleanup

for.body4:                                        ; preds = %vector.scevcheck, %for.body4
  %indvars.iv = phi i64 [ %indvars.iv.next.1, %for.body4 ], [ 0, %vector.scevcheck ]
  %arrayidx = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %indvars.iv
  %24 = load double, ptr %arrayidx, align 16, !tbaa !5
  %25 = mul nsw i64 %indvars.iv, %1
  %arrayidx6 = getelementptr inbounds double, ptr @global_data, i64 %25
  %26 = load double, ptr %arrayidx6, align 16, !tbaa !5
  ...
  %27 = load double, ptr %arrayidx.1, align 8, !tbaa !5
  %28 = mul nsw i64 %indvars.iv.next, %1
  %arrayidx6.1 = getelementptr inbounds double, ptr @global_data, i64 %28
  %29 = load double, ptr %arrayidx6.1, align 8, !tbaa !5
  %add.1 = fadd double %27, %29
  store double %add.1, ptr %arrayidx6.1, align 8, !tbaa !5
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %exitcond.not.1 = icmp eq i64 %indvars.iv.next.1, 32000
  br i1 %exitcond.not.1, label %for.cond.cleanup3, label %for.body4, !llvm.loop !368
}
...
; Function Attrs: nounwind uwtable
define dso_local i32 @s172(i32 noundef %n1, i32 noundef %n3) local_unnamed_addr #7 {
entry:
  %call = tail call i32 @init(ptr noundef nonnull @.str.26)
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
  %cmp19 = icmp sgt i32 %0, 0
  br i1 %cmp19, label %for.body.lr.ph, label %for.cond.cleanup

for.body.lr.ph:                                   ; preds = %entry
  %cmp217 = icmp slt i32 %n1, 32001
  br i1 %cmp217, label %for.body.us.preheader, label %for.body
...
for.body.us:                                      ; preds = %for.body.us.preheader, %for.cond1.for.cond.cleanup3_crit_edge.us
  %nl.020.us = phi i32 [ %inc.us, %for.cond1.for.cond.cleanup3_crit_edge.us ], [ 0, %for.body.us.preheader ]
  br label %for.body4.us

for.body4.us:                                     ; preds = %for.body.us, %for.body4.us
  %indvars.iv = phi i64 [ %1, %for.body.us ], [ %indvars.iv.next, %for.body4.us ]
  %arrayidx.us = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %indvars.iv
  %3 = load double, ptr %arrayidx.us, align 8, !tbaa !5
  %arrayidx6.us = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv
  %4 = load double, ptr %arrayidx6.us, align 8, !tbaa !5
  %add.us = fadd double %3, %4
  store double %add.us, ptr %arrayidx6.us, align 8, !tbaa !5
...
for.cond1.for.cond.cleanup3_crit_edge.us:         ; preds = %for.body4.us
  %call8.us = tail call i32 @dummy(ptr noundef nonnull @global_data, ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 11, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 20, i64 0, i64 0), double noundef 0.000000e+00) #16
  %inc.us = add nuw nsw i32 %nl.020.us, 1
...
for.cond.cleanup:                                 ; preds = %for.body, %for.cond1.for.cond.cleanup3_crit_edge.us, %entry
  %call12 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.138, double noundef 0.000000e+00)
  br label %for.body.i
...
for.cond18.preheader.i.preheader:                 ; preds = %for.body.i
  ...
  %call.i = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %11, double noundef %add.i.4)
  ret i32 0

for.body:                                         ; preds = %for.body.lr.ph, %for.body
  %nl.020 = phi i32 [ %inc, %for.body ], [ 0, %for.body.lr.ph ]
  %call8 = tail call i32 @dummy(ptr noundef nonnull @global_data, ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 11, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 20, i64 0, i64 0), double noundef 0.000000e+00) #16
  %inc = add nuw nsw i32 %nl.020, 1
...
entry:
  %call = tail call i32 @init(ptr noundef nonnull @.str.27)
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load26 = load <2 x double>, ptr %2, align 16, !tbaa !5
  %3 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %index
  %wide.load27 = load <2 x double>, ptr %3, align 32, !tbaa !5
  %4 = getelementptr inbounds double, ptr %3, i64 2
  %wide.load28 = load <2 x double>, ptr %4, align 16, !tbaa !5
  %5 = fadd <2 x double> %wide.load, %wide.load27
  %6 = fadd <2 x double> %wide.load26, %wide.load28
  %7 = add nuw nsw i64 %index, 16000
  %8 = getelementptr inbounds double, ptr @global_data, i64 %7
  store <2 x double> %5, ptr %8, align 32, !tbaa !5
  %9 = getelementptr inbounds double, ptr %8, i64 2
  store <2 x double> %6, ptr %9, align 16, !tbaa !5
  %index.next = add nuw i64 %index, 4
  %10 = icmp eq i64 %index.next, 16000
  br i1 %10, label %for.cond.cleanup3, label %vector.body, !llvm.loop !369
...
for.cond.cleanup3:                                ; preds = %vector.body
  ...
  %17 = load i32, ptr @ntimes, align 4, !tbaa !17
...
; Function Attrs: nounwind uwtable
define dso_local i32 @s174(i32 noundef %M) local_unnamed_addr #7 {
entry:
  %call = tail call i32 @init(ptr noundef nonnull @.str.28)
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
  %cmp24 = icmp sgt i32 %0, 0
  br i1 %cmp24, label %for.cond1.preheader.lr.ph, label %for.cond.cleanup

for.cond1.preheader.lr.ph:                        ; preds = %entry
  %cmp221 = icmp sgt i32 %M, 0
...
for.cond1.preheader.us.preheader:                 ; preds = %for.cond1.preheader.lr.ph
  ...
  %3 = add i64 %2, ptrtoint (ptr @global_data to i64)
  %min.iters.check = icmp ult i32 %M, 6
  %4 = sub i64 %3, add (i64 ptrtoint (ptr @global_data to i64), i64 256032)
  %diff.check31 = icmp ult i64 %4, 32
  %or.cond = select i1 %min.iters.check, i1 true, i1 %diff.check31
...
for.cond1.preheader.us:                           ; preds = %for.cond1.preheader.us.preheader, %for.cond1.for.cond.cleanup3_crit_edge.us
  %nl.025.us = phi i32 [ %inc12.us, %for.cond1.for.cond.cleanup3_crit_edge.us ], [ 0, %for.cond1.preheader.us.preheader ]
  br i1 %or.cond, label %for.body4.us.preheader, label %vector.body
...
vector.body:                                      ; preds = %for.cond1.preheader.us, %vector.body
  ...
  %7 = getelementptr inbounds double, ptr %6, i64 2
  %wide.load32 = load <2 x double>, ptr %7, align 16, !tbaa !5
  %8 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %index
  %wide.load33 = load <2 x double>, ptr %8, align 32, !tbaa !5
  %9 = getelementptr inbounds double, ptr %8, i64 2
  %wide.load34 = load <2 x double>, ptr %9, align 16, !tbaa !5
  %10 = fadd <2 x double> %wide.load, %wide.load33
  %11 = fadd <2 x double> %wide.load32, %wide.load34
  %12 = add nuw nsw i64 %index, %1
  %13 = getelementptr inbounds double, ptr @global_data, i64 %12
  store <2 x double> %10, ptr %13, align 8, !tbaa !5
  %14 = getelementptr inbounds double, ptr %13, i64 2
  store <2 x double> %11, ptr %14, align 8, !tbaa !5
  %index.next = add nuw i64 %index, 4
  %15 = icmp eq i64 %index.next, %n.vec
  br i1 %15, label %middle.block, label %vector.body, !llvm.loop !370
...
for.body4.us.prol:                                ; preds = %for.body4.us.preheader
  %arrayidx.us.prol = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv.ph
  %17 = load double, ptr %arrayidx.us.prol, align 32, !tbaa !5
  %arrayidx6.us.prol = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %indvars.iv.ph
  %18 = load double, ptr %arrayidx6.us.prol, align 32, !tbaa !5
  %add.us.prol = fadd double %17, %18
  %19 = add nuw nsw i64 %indvars.iv.ph, %1
  %arrayidx9.us.prol = getelementptr inbounds double, ptr @global_data, i64 %19
  store double %add.us.prol, ptr %arrayidx9.us.prol, align 8, !tbaa !5
...
for.body4.us.prol.loopexit:                       ; preds = %for.body4.us.prol, %for.body4.us.preheader
  ...
  %20 = icmp eq i64 %16, %5
  br i1 %20, label %for.cond1.for.cond.cleanup3_crit_edge.us, label %for.body4.us
...
for.body4.us:                                     ; preds = %for.body4.us.prol.loopexit, %for.body4.us
  ...
  %arrayidx.us = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv
  %21 = load double, ptr %arrayidx.us, align 8, !tbaa !5
  %arrayidx6.us = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %indvars.iv
  %22 = load double, ptr %arrayidx6.us, align 8, !tbaa !5
  %add.us = fadd double %21, %22
  %23 = add nuw nsw i64 %indvars.iv, %1
  %arrayidx9.us = getelementptr inbounds double, ptr @global_data, i64 %23
  store double %add.us, ptr %arrayidx9.us, align 8, !tbaa !5
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %arrayidx.us.1 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv.next
  %24 = load double, ptr %arrayidx.us.1, align 8, !tbaa !5
  %arrayidx6.us.1 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %indvars.iv.next
  %25 = load double, ptr %arrayidx6.us.1, align 8, !tbaa !5
  %add.us.1 = fadd double %24, %25
  %26 = add nuw nsw i64 %indvars.iv.next, %1
  %arrayidx9.us.1 = getelementptr inbounds double, ptr @global_data, i64 %26
  store double %add.us.1, ptr %arrayidx9.us.1, align 8, !tbaa !5
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %exitcond.not.1 = icmp eq i64 %indvars.iv.next.1, %wide.trip.count
  br i1 %exitcond.not.1, label %for.cond1.for.cond.cleanup3_crit_edge.us, label %for.body4.us, !llvm.loop !371
...
for.cond1.for.cond.cleanup3_crit_edge.us:         ; preds = %for.body4.us.prol.loopexit, %for.body4.us, %middle.block
  ...
  %inc12.us = add nuw nsw i32 %nl.025.us, 1
  %27 = load i32, ptr @ntimes, align 4, !tbaa !17
  %mul.us = mul nsw i32 %27, 10
  %cmp.us = icmp slt i32 %inc12.us, %mul.us
...
for.cond1.preheader:                              ; preds = %for.cond1.preheader.lr.ph, %for.cond1.preheader
  %nl.025 = phi i32 [ %inc12, %for.cond1.preheader ], [ 0, %for.cond1.preheader.lr.ph ]
  %call10 = tail call i32 @dummy(ptr noundef nonnull @global_data, ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 11, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 20, i64 0, i64 0), double noundef 0.000000e+00) #16
...
for.body.i:                                       ; preds = %for.body.i, %for.cond.cleanup
  ...
  %suma.0192.i = phi double [ 0.000000e+00, %for.cond.cleanup ], [ %add.i.4, %for.body.i ]
  %arrayidx.i = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv.i
  %29 = load double, ptr %arrayidx.i, align 8, !tbaa !5
  %add.i = fadd double %suma.0192.i, %29
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1
  %arrayidx.i.1 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv.next.i
  %30 = load double, ptr %arrayidx.i.1, align 8, !tbaa !5
  %add.i.1 = fadd double %add.i, %30
  %indvars.iv.next.i.1 = add nuw nsw i64 %indvars.iv.i, 2
  %arrayidx.i.2 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv.next.i.1
  %31 = load double, ptr %arrayidx.i.2, align 8, !tbaa !5
  %add.i.2 = fadd double %add.i.1, %31
  %indvars.iv.next.i.2 = add nuw nsw i64 %indvars.iv.i, 3
  %arrayidx.i.3 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv.next.i.2
  %32 = load double, ptr %arrayidx.i.3, align 8, !tbaa !5
  %add.i.3 = fadd double %add.i.2, %32
  %indvars.iv.next.i.3 = add nuw nsw i64 %indvars.iv.i, 4
  %arrayidx.i.4 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv.next.i.3
  %33 = load double, ptr %arrayidx.i.4, align 8, !tbaa !5
  %add.i.4 = fadd double %add.i.3, %33
  %indvars.iv.next.i.4 = add nuw nsw i64 %indvars.iv.i, 5
  %exitcond.not.i.4 = icmp eq i64 %indvars.iv.next.i.4, 32000
  br i1 %exitcond.not.i.4, label %for.cond18.preheader.i.preheader, label %for.body.i
...
for.cond18.preheader.i.preheader:                 ; preds = %for.body.i
  ...
  %call.i = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %34, double noundef %add.i.4)
  ret i32 0
}

; Function Attrs: nounwind uwtable
define dso_local i32 @s175(i32 noundef %inc) local_unnamed_addr #7 {
entry:
  %call = tail call i32 @init(ptr noundef nonnull @.str.29)
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
...
for.cond1.preheader:                              ; preds = %for.cond1.preheader.preheader, %for.cond.cleanup3
  %nl.024 = phi i32 [ %inc13, %for.cond.cleanup3 ], [ 0, %for.cond1.preheader.preheader ]
  br label %for.body4
...
for.cond.cleanup3:                                ; preds = %for.body4
  ...
  %cmp = icmp slt i32 %inc13, %8
  br i1 %cmp, label %for.cond1.preheader, label %for.cond.cleanup

for.body4:                                        ; preds = %for.cond1.preheader, %for.body4
  %indvars.iv = phi i64 [ 0, %for.cond1.preheader ], [ %indvars.iv.next, %for.body4 ]
  %indvars.iv.next = add nsw i64 %indvars.iv, %1
  %arrayidx = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv.next
  ...
  %cmp2 = icmp slt i64 %indvars.iv.next, 31999
...
entry:
  %call = tail call i32 @init(ptr noundef nonnull @.str.30)
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
  %cmp37 = icmp sgt i32 %0, 31999
  br i1 %cmp37, label %for.cond1.preheader, label %for.cond.cleanup

for.cond1.preheader:                              ; preds = %entry, %for.cond.cleanup3
  %nl.038 = phi i32 [ %inc20, %for.cond.cleanup3 ], [ 0, %entry ]
  br label %for.cond5.preheader

for.cond.cleanup:                                 ; preds = %for.cond.cleanup3, %entry
  %call24 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.142, double noundef 0.000000e+00)
  br label %for.body.i
...
for.cond5.preheader:                              ; preds = %for.cond1.preheader, %for.cond.cleanup7
  ...
  %arrayidx11 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 %indvars.iv42
  br label %for.body8
...
for.cond.cleanup3:                                ; preds = %for.cond.cleanup7
  ...
  %inc20 = add nuw nsw i32 %nl.038, 1
  %7 = load i32, ptr @ntimes, align 4, !tbaa !17
  %div = sdiv i32 %7, 32000
...
for.cond.cleanup7:                                ; preds = %for.body8
  ...
  br i1 %exitcond45.not, label %for.cond.cleanup3, label %for.cond5.preheader

for.body8:                                        ; preds = %for.body8, %for.cond5.preheader
  %indvars.iv = phi i64 [ 0, %for.cond5.preheader ], [ %indvars.iv.next.1, %for.body8 ]
  %8 = sub nsw i64 %indvars.iv, %indvars.iv42
  %9 = add nsw i64 %8, 15999
  %arrayidx = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %9
  %10 = load double, ptr %arrayidx, align 8, !tbaa !5
  %11 = load double, ptr %arrayidx11, align 8, !tbaa !5
  %arrayidx14 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv
  %12 = load double, ptr %arrayidx14, align 16, !tbaa !5
  %13 = tail call double @llvm.fmuladd.f64(double %10, double %11, double %12)
  store double %13, ptr %arrayidx14, align 16, !tbaa !5
  %indvars.iv.next = or i64 %indvars.iv, 1
  %14 = sub nsw i64 %indvars.iv.next, %indvars.iv42
  %15 = add nsw i64 %14, 15999
  %arrayidx.1 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %15
  %16 = load double, ptr %arrayidx.1, align 8, !tbaa !5
  %17 = load double, ptr %arrayidx11, align 8, !tbaa !5
  %arrayidx14.1 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv.next
  %18 = load double, ptr %arrayidx14.1, align 8, !tbaa !5
  %19 = tail call double @llvm.fmuladd.f64(double %16, double %17, double %18)
  store double %19, ptr %arrayidx14.1, align 8, !tbaa !5
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %exitcond.not.1 = icmp eq i64 %indvars.iv.next.1, 16000
...
if.end.thread:                                    ; preds = %entry
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
  %call221 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.144, i32 noundef %0)
  br label %if.end7
...
if.end:                                           ; preds = %entry
  ...
  %call2 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.144, i32 noundef %conv.i)
...
if.end7:                                          ; preds = %if.end.thread, %if.then4, %if.end
  ...
  %call9 = call i32 @s171(i32 noundef 1)
  %call10 = call i32 @s172(i32 noundef 1, i32 noundef 1)
  %call11 = call i32 @s173()
  %call12 = call i32 @s174(i32 noundef 16000)
  %call13 = call i32 @s175(i32 noundef 1)
