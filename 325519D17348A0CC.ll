...
if.then:                                          ; preds = %entry
  ...
  %m_part0 = getelementptr inbounds %class.btGImpactCollisionAlgorithm, ptr %this, i64 0, i32 6
  %dec344 = add nsw i32 %1, -1
  store i32 %dec344, ptr %m_part0, align 4, !tbaa !18
  %tobool.not345 = icmp eq i32 %1, 0
  br i1 %tobool.not345, label %cleanup.cont, label %while.body.lr.ph
...
while.body:                                       ; preds = %while.body.lr.ph, %while.body
  %dec346 = phi i32 [ %dec344, %while.body.lr.ph ], [ %dec, %while.body ]
  %2 = load ptr, ptr %m_data.i.i, align 8, !tbaa !88
  %idxprom.i.i = sext i32 %dec346 to i64
...
if.then10:                                        ; preds = %if.end
  ...
  %m_part1 = getelementptr inbounds %class.btGImpactCollisionAlgorithm, ptr %this, i64 0, i32 8
  %dec14341 = add nsw i32 %5, -1
  store i32 %dec14341, ptr %m_part1, align 4, !tbaa !20
  %tobool15.not342 = icmp eq i32 %5, 0
  br i1 %tobool15.not342, label %cleanup.cont, label %while.body16.lr.ph
...
while.body16:                                     ; preds = %while.body16.lr.ph, %while.body16
  %dec14343 = phi i32 [ %dec14341, %while.body16.lr.ph ], [ %dec14, %while.body16 ]
  %6 = load ptr, ptr %m_data.i.i186, align 8, !tbaa !88
  %idxprom.i.i187 = sext i32 %dec14343 to i64
  ...
  %.pr336 = load i32, ptr %m_part1, align 4, !tbaa !20
  %dec14 = add nsw i32 %.pr336, -1
  store i32 %dec14, ptr %m_part1, align 4, !tbaa !20
  %tobool15.not = icmp eq i32 %.pr336, 0
...
vector.memcheck:                                  ; preds = %for.body.lr.ph.i.i.i
  ...
  %scevgep351 = getelementptr i8, ptr %9, i64 %11
  %scevgep352 = getelementptr i8, ptr %call.i.i.i8.i, i64 4
  %scevgep353 = getelementptr i8, ptr %call.i.i.i8.i, i64 %10
  %scevgep354 = getelementptr i8, ptr %9, i64 4
  %scevgep355 = getelementptr i8, ptr %9, i64 %10
  %bound0 = icmp ult ptr %call.i.i.i8.i, %scevgep351
  %bound1 = icmp ult ptr %9, %scevgep
  %found.conflict = and i1 %bound0, %bound1
  %bound0356 = icmp ult ptr %scevgep352, %scevgep355
  %bound1357 = icmp ult ptr %scevgep354, %scevgep353
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.vec359 = load <4 x i32>, ptr %14, align 4, !tbaa !45
  ...
  store <4 x i32> %wide.vec359, ptr %16, align 4, !tbaa !45
  %index.next = add nuw i64 %index, 4
...
lpad.i:                                           ; preds = %if.then3.i.i.i, %if.end20
  ...
  %tobool.not.i.i.i318 = icmp eq ptr %28, null
  %29 = load i8, ptr %m_ownsMemory.i.i.i, align 8, !range !52
  %tobool2.not.i.i.i320 = icmp eq i8 %29, 0
  %or.cond.i.i321 = select i1 %tobool.not.i.i.i318, i1 true, i1 %tobool2.not.i.i.i320
  br i1 %or.cond.i.i321, label %common.resume, label %if.then3.i.i.i322

if.then3.i.i.i322:                                ; preds = %lpad.i
  invoke void @_Z21btAlignedFreeInternalPv(ptr noundef nonnull %28)
          to label %common.resume unwind label %terminate.lpad.i

common.resume:                                    ; preds = %lpad.i, %if.then3.i.i.i322, %_ZN20btAlignedObjectArrayI8GIM_PAIRED2Ev.exit316
  %common.resume.op = phi { ptr, i32 } [ %.pn327, %_ZN20btAlignedObjectArrayI8GIM_PAIRED2Ev.exit316 ], [ %27, %if.then3.i.i.i322 ], [ %27, %lpad.i ]
  resume { ptr, i32 } %common.resume.op

terminate.lpad.i:                                 ; preds = %if.then3.i.i.i322
  %30 = landingpad { ptr, i32 }
          catch ptr null
...
invoke.cont64:                                    ; preds = %invoke.cont59
  ...
  %tobool72.not339 = icmp eq i32 %43, 0
  br i1 %tobool72.not339, label %while.end120, label %while.body73.lr.ph
...
ehcleanup138:                                     ; preds = %ehcleanup137, %lpad39, %lpad
  %.pn327 = phi { ptr, i32 } [ %38, %lpad39 ], [ %.pn.pn.pn.pn.pn.pn.pn, %ehcleanup137 ], [ %33, %lpad ]
  %235 = load ptr, ptr %m_data.i.i.i, align 8, !tbaa !44
  %tobool.not.i.i.i308 = icmp eq ptr %235, null
  %236 = load i8, ptr %m_ownsMemory.i.i.i, align 8, !range !52
  %tobool2.not.i.i.i310 = icmp eq i8 %236, 0
  %or.cond.i.i311 = select i1 %tobool.not.i.i.i308, i1 true, i1 %tobool2.not.i.i.i310
  br i1 %or.cond.i.i311, label %_ZN20btAlignedObjectArrayI8GIM_PAIRED2Ev.exit316, label %if.then3.i.i.i312

if.then3.i.i.i312:                                ; preds = %ehcleanup138
  invoke void @_Z21btAlignedFreeInternalPv(ptr noundef nonnull %235)
          to label %_ZN20btAlignedObjectArrayI8GIM_PAIRED2Ev.exit316 unwind label %terminate.lpad

_ZN20btAlignedObjectArrayI8GIM_PAIRED2Ev.exit316: ; preds = %if.then3.i.i.i312, %ehcleanup138
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %pairset) #15
  call void @llvm.lifetime.end.p0(i64 64, ptr nonnull %orgtrans1) #15
  call void @llvm.lifetime.end.p0(i64 64, ptr nonnull %orgtrans0) #15
  br label %common.resume

terminate.lpad:                                   ; preds = %if.then3.i.i.i312, %ehcleanup133, %ehcleanup129
...
entry:
  ...
  %cmp86.i.inv = fcmp ogt float %add17.i, %cond85.i
  %cond105.i = select i1 %cmp86.i.inv, float %cond85.i, float %add17.i
  %cmp191.i = fcmp olt float %34, %35
  %cond199.i = select i1 %cmp191.i, float %35, float %34
  %cmp200.i.inv = fcmp olt float %add17.i, %cond199.i
  %cond219.i = select i1 %cmp200.i.inv, float %cond199.i, float %add17.i
  ...
  %79 = fcmp ule <2 x float> %58, %77
  %80 = shufflevector <2 x i1> %78, <2 x i1> %79, <2 x i32> <i32 0, i32 3>
  %81 = extractelement <2 x i1> %76, i64 1
  %82 = extractelement <2 x float> %65, i64 1
  %83 = extractelement <2 x float> %75, i64 1
  %arrayidx34.mux.val.i = select i1 %81, float %83, float %82
  %84 = shufflevector <2 x float> %77, <2 x float> %58, <2 x i32> <i32 0, i32 3>
  %85 = insertelement <2 x float> %58, float %arrayidx34.mux.val.i, i64 1
  %86 = select <2 x i1> %80, <2 x float> %84, <2 x float> %85
  %87 = extractelement <2 x float> %65, i64 0
  %88 = extractelement <2 x float> %75, i64 0
  %cmp115.i = fcmp olt float %87, %88
  %cond123.i = select i1 %cmp115.i, float %88, float %87
  %89 = extractelement <2 x float> %58, i64 0
  %cmp124.i = fcmp olt float %89, %cond123.i
  %cond143.i = select i1 %cmp124.i, float %cond123.i, float %89
  %cmp153.i = fcmp olt float %82, %83
  %tv2.sroa.0.4.vec.extract103 = extractelement <2 x float> %75, i64 1
  %tv1.sroa.0.4.vec.extract105 = extractelement <2 x float> %65, i64 1
  %cond161.i = select i1 %cmp153.i, float %tv2.sroa.0.4.vec.extract103, float %tv1.sroa.0.4.vec.extract105
  %90 = extractelement <2 x float> %58, i64 1
  %cmp162.i = fcmp uge float %90, %cond161.i
  %arrayidx34.mux317.val.i = select i1 %cmp153.i, float %83, float %82
  %cond181.i = select i1 %cmp162.i, float %90, float %arrayidx34.mux317.val.i
  %91 = insertelement <2 x float> poison, float %33, i64 0
  %92 = shufflevector <2 x float> %91, <2 x float> poison, <2 x i32> zeroinitializer
  %93 = fsub <2 x float> %86, %92
  %add.i60 = fadd float %33, %cond143.i
  %add240.i = fadd float %33, %cond181.i
  store <2 x float> %93, ptr %aabbMin, align 4
  ...
  store float %add.i60, ptr %aabbMax, align 4, !tbaa.struct !77
  %trianglebox.sroa.12.16.aabbMax.sroa_idx = getelementptr inbounds i8, ptr %aabbMax, i64 4
  store float %add240.i, ptr %trianglebox.sroa.12.16.aabbMax.sroa_idx, align 4, !tbaa.struct !78
...
entry:
  ...
  %2 = load ptr, ptr %algorithm6, align 8, !tbaa !152
