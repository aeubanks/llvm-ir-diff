...
while.body3:                                      ; preds = %while.cond1.preheader, %if.end
  %0 = phi i32 [ %.pre, %while.cond1.preheader ], [ %2, %if.end ]
...
if.end:                                           ; preds = %if.then, %while.body3
  %2 = phi i32 [ %0, %if.then ], [ %1, %while.body3 ]
...
lor.lhs.false:                                    ; preds = %while.end18
  %5 = load i32, ptr getelementptr inbounds ([5001 x i32], ptr @sortlist, i64 0, i64 500), align 16, !tbaa !9
  %6 = load i32, ptr @biggest, align 4, !tbaa !9
...
if.end22:                                         ; preds = %if.then21, %lor.lhs.false
  ...
  %call26 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %7)
  ret void
}
