...
if.then.i:                                        ; preds = %if.end3.thread, %if.end3
  %n.addr.0425 = phi i64 [ %n, %if.end3.thread ], [ %3, %if.end3 ]
  %calloc.i = tail call ptr @calloc(i64 1, i64 %n.addr.0425)
  br label %bitvector_init.exit

bitvector_init.exit:                              ; preds = %if.end3, %if.then.i
  %4 = phi i64 [ %n.addr.0425, %if.then.i ], [ 0, %if.end3 ]
  ...
  %cmp15446.not = icmp eq i64 %4, 0
  br i1 %cmp15446.not, label %while.end, label %while.body.lr.ph
...
while.body:                                       ; preds = %while.body.lr.ph, %for.end256
  %i_in.0449 = phi i64 [ 0, %while.body.lr.ph ], [ %i_in.2, %for.end256 ]
  %i_punct.0448 = phi i64 [ 0, %while.body.lr.ph ], [ %spec.store.select, %for.end256 ]
  %bv.0447 = phi i64 [ 0, %while.body.lr.ph ], [ %bv.1, %for.end256 ]
  ...
  %arrayidx20 = getelementptr inbounds %struct.param_viterbi_t, ptr %param, i64 0, i32 3, i64 %i_punct.0448
...
for.cond.preheader:                               ; preds = %while.body
  ...
  %cmp24428.not = icmp eq i64 %10, 0
  br i1 %cmp24428.not, label %for.end, label %for.body.lr.ph
...
for.body:                                         ; preds = %for.body.lr.ph, %for.body
  %i.0429 = phi i64 [ 0, %for.body.lr.ph ], [ %inc, %for.body ]
  %arrayidx26 = getelementptr inbounds %struct.param_viterbi_t, ptr %param, i64 0, i32 6, i64 %i.0429
  %12 = load i8, ptr %arrayidx26, align 1, !tbaa !12
  %sub = sub i8 1, %12
  %arrayidx31 = getelementptr inbounds double, ptr %call7, i64 %i.0429
  ...
  %arrayidx35 = getelementptr inbounds double, ptr %14, i64 %i_in.0449
  %15 = load double, ptr %arrayidx35, align 8, !tbaa !15
  %add = fadd double %13, %15
  store double %add, ptr %arrayidx31, align 8, !tbaa !15
  %arrayidx37 = getelementptr inbounds double, ptr %call10, i64 %i.0429
  ...
  %arrayidx42 = getelementptr inbounds double, ptr %17, i64 %i_in.0449
  %18 = load double, ptr %arrayidx42, align 8, !tbaa !15
  %add43 = fadd double %16, %18
  store double %add43, ptr %arrayidx37, align 8, !tbaa !15
  %inc = add nuw i64 %i.0429, 1
  %exitcond.not = icmp eq i64 %inc, %10
  br i1 %exitcond.not, label %for.end, label %for.body, !llvm.loop !17

for.end:                                          ; preds = %for.body, %for.cond.preheader
  %inc45 = add i64 %i_in.0449, 1
  br label %if.end46

if.end46:                                         ; preds = %for.end, %while.body
  %i_in.1 = phi i64 [ %inc45, %for.end ], [ %i_in.0449, %while.body ]
  %arrayidx47 = getelementptr inbounds %struct.param_viterbi_t, ptr %param, i64 0, i32 4, i64 %i_punct.0448
...
for.cond57.preheader:                             ; preds = %if.end46
  %cmp59430.not = icmp eq i64 %20, 0
  br i1 %cmp59430.not, label %for.end86, label %for.body61.lr.ph
...
for.body61:                                       ; preds = %for.body61.lr.ph, %for.body61
  %i.1431 = phi i64 [ 0, %for.body61.lr.ph ], [ %inc85, %for.body61 ]
  %arrayidx62 = getelementptr inbounds %struct.param_viterbi_t, ptr %param, i64 0, i32 7, i64 %i.1431
  %22 = load i8, ptr %arrayidx62, align 1, !tbaa !12
  %sub66 = sub i8 1, %22
  %arrayidx68 = getelementptr inbounds double, ptr %call7, i64 %i.1431
  ...
  %arrayidx76 = getelementptr inbounds double, ptr %call10, i64 %i.1431
  ...
  %inc85 = add nuw i64 %i.1431, 1
  %exitcond452.not = icmp eq i64 %inc85, %20
  br i1 %exitcond452.not, label %for.end86, label %for.body61, !llvm.loop !19
...
if.end88:                                         ; preds = %if.end46, %for.end86
  ...
  %cmp91436.not = icmp ult i64 %20, 2
  br i1 %cmp91436.not, label %for.cond210.preheader, label %for.body93.preheader
...
for.cond210.preheader:                            ; preds = %for.inc207, %if.end88
  %cmp212439.not = icmp eq i64 %20, 0
  br i1 %cmp212439.not, label %for.end224, label %for.body214.preheader

for.body214.preheader:                            ; preds = %for.cond210.preheader
  %min.iters.check = icmp ult i64 %20, 4
  br i1 %min.iters.check, label %for.body214.preheader467, label %vector.ph
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %vec.phi466 = phi <2 x i64> [ zeroinitializer, %vector.ph ], [ %51, %vector.body ]
  %31 = or i64 %index, 1
  %32 = or i64 %index, 2
  %33 = or i64 %index, 3
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %for.end224, label %for.body214.preheader467

for.body214.preheader467:                         ; preds = %for.body214.preheader, %middle.block
  %i.3441.ph = phi i64 [ 0, %for.body214.preheader ], [ %n.vec, %middle.block ]
  %vote.0440.ph = phi i64 [ 0, %for.body214.preheader ], [ %53, %middle.block ]
  br label %for.body214

for.body93:                                       ; preds = %for.body93.preheader, %for.inc207
  %i.2437 = phi i64 [ %inc208, %for.inc207 ], [ 0, %for.body93.preheader ]
  %54 = mul nuw nsw i64 %i.2437, 144
  %55 = add i64 %30, %54
  %scevgep458 = getelementptr i8, ptr %history_new, i64 %55
  %56 = mul i64 %i.2437, 286
  %57 = add i64 %56, 143
  %scevgep459 = getelementptr i8, ptr %history, i64 %57
  %scevgep457 = getelementptr i8, ptr %history, i64 %56
  %58 = or i64 %54, 1
  %scevgep454 = getelementptr i8, ptr %history_new, i64 %58
  %mul94 = shl nuw i64 %i.2437, 1
  ...
  %arrayidx123 = getelementptr inbounds double, ptr %call, i64 %i.2437
  %arrayidx124 = getelementptr inbounds [128 x [144 x i8]], ptr %history_new, i64 0, i64 %i.2437
...
if.then101:                                       ; preds = %for.body93
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(143) %scevgep454, ptr noundef nonnull align 2 dereferenceable(143) %scevgep457, i64 143, i1 false), !tbaa !12
  br label %if.end140

if.else:                                          ; preds = %for.body93
  store double %60, ptr %arrayidx123, align 8, !tbaa !15
  store i8 1, ptr %arrayidx124, align 16, !tbaa !12
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(143) %scevgep454, ptr noundef nonnull align 1 dereferenceable(143) %scevgep459, i64 143, i1 false), !tbaa !12
  br label %if.end140
...
if.end140:                                        ; preds = %if.then101, %if.else
  ...
  %add182 = add nuw i64 %div422, %i.2437
...
if.then148:                                       ; preds = %if.end140
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(143) %scevgep458, ptr noundef nonnull align 2 dereferenceable(143) %scevgep457, i64 143, i1 false), !tbaa !12
  br label %for.inc207

if.else176:                                       ; preds = %if.end140
  store double %62, ptr %arrayidx183, align 8, !tbaa !15
  store i8 1, ptr %arrayidx187, align 16, !tbaa !12
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(143) %scevgep458, ptr noundef nonnull align 1 dereferenceable(143) %scevgep459, i64 143, i1 false), !tbaa !12
  br label %for.inc207

for.inc207:                                       ; preds = %if.then148, %if.else176
  %inc208 = add nuw nsw i64 %i.2437, 1
  %exitcond460.not = icmp eq i64 %inc208, %umax
  br i1 %exitcond460.not, label %for.cond210.preheader, label %for.body93, !llvm.loop !23

for.body214:                                      ; preds = %for.body214.preheader467, %for.body214
  %i.3441 = phi i64 [ %inc223, %for.body214 ], [ %i.3441.ph, %for.body214.preheader467 ]
  %vote.0440 = phi i64 [ %add221, %for.body214 ], [ %vote.0440.ph, %for.body214.preheader467 ]
  %arrayidx216 = getelementptr inbounds [128 x [144 x i8]], ptr %history_new, i64 0, i64 %i.3441, i64 143
  %63 = load i8, ptr %arrayidx216, align 1, !tbaa !12
  %cmp218 = icmp eq i8 %63, 0
  %conv220 = zext i1 %cmp218 to i64
  %add221 = add i64 %vote.0440, %conv220
  %inc223 = add nuw i64 %i.3441, 1
  %exitcond461.not = icmp eq i64 %inc223, %20
  br i1 %exitcond461.not, label %for.end224, label %for.body214, !llvm.loop !24
...
for.end224:                                       ; preds = %for.body214, %middle.block, %for.cond210.preheader
  ...
  %arrayidx236 = getelementptr inbounds i8, ptr %64, i64 %bv.0447
  %. = zext i1 %cmp227.not to i8
  store i8 %., ptr %arrayidx236, align 1, !tbaa !12
  %bv.1 = add i64 %bv.0447, 1
  %65 = load i64, ptr %Nways, align 8, !tbaa !13
  %cmp240444.not = icmp eq i64 %65, 0
  br i1 %cmp240444.not, label %for.end256, label %for.cond243.preheader.preheader
...
for.cond243.preheader:                            ; preds = %for.cond243.preheader, %for.cond243.preheader.preheader.new
  %i.4445 = phi i64 [ 0, %for.cond243.preheader.preheader.new ], [ %inc255.1, %for.cond243.preheader ]
  %niter = phi i64 [ 0, %for.cond243.preheader.preheader.new ], [ %niter.next.1, %for.cond243.preheader ]
  %67 = mul i64 %i.4445, 143
  %scevgep462 = getelementptr i8, ptr %history, i64 %67
  %68 = mul i64 %i.4445, 144
  %scevgep463 = getelementptr i8, ptr %history_new, i64 %68
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 2 dereferenceable(143) %scevgep462, ptr noundef nonnull align 16 dereferenceable(143) %scevgep463, i64 143, i1 false), !tbaa !12
  %inc255 = or i64 %i.4445, 1
  %69 = mul i64 %inc255, 143
  %scevgep462.1 = getelementptr i8, ptr %history, i64 %69
  %70 = mul i64 %inc255, 144
  %scevgep463.1 = getelementptr i8, ptr %history_new, i64 %70
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(143) %scevgep462.1, ptr noundef nonnull align 16 dereferenceable(143) %scevgep463.1, i64 143, i1 false), !tbaa !12
  %inc255.1 = add nuw i64 %i.4445, 2
...
for.end256.loopexit.unr-lcssa:                    ; preds = %for.cond243.preheader, %for.cond243.preheader.preheader
  %i.4445.unr = phi i64 [ 0, %for.cond243.preheader.preheader ], [ %inc255.1, %for.cond243.preheader ]
...
for.cond243.preheader.epil:                       ; preds = %for.end256.loopexit.unr-lcssa
  %71 = mul i64 %i.4445.unr, 143
  %scevgep462.epil = getelementptr i8, ptr %history, i64 %71
  %72 = mul i64 %i.4445.unr, 144
  %scevgep463.epil = getelementptr i8, ptr %history_new, i64 %72
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(143) %scevgep462.epil, ptr noundef nonnull align 16 dereferenceable(143) %scevgep463.epil, i64 143, i1 false), !tbaa !12
  br label %for.end256

for.end256:                                       ; preds = %for.cond243.preheader.epil, %for.end256.loopexit.unr-lcssa, %for.end224
  %inc257 = add i64 %i_punct.0448, 1
...
while.end.loopexit:                               ; preds = %for.end256
  %.pre465 = load ptr, ptr %5, align 8, !tbaa !11
  br label %while.end

while.end:                                        ; preds = %while.end.loopexit, %bitvector_init.exit
  %75 = phi ptr [ %call.sink.i, %bitvector_init.exit ], [ %.pre465, %while.end.loopexit ]
