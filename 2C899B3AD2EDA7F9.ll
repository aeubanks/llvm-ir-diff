; ModuleID = '/usr/local/google/home/aeubanks/repos/test-suite/MultiSource/Benchmarks/MiBench/telecomm-gsm/rpe.c'
source_filename = "/usr/local/google/home/aeubanks/repos/test-suite/MultiSource/Benchmarks/MiBench/telecomm-gsm/rpe.c"
...
entry:
  ...
  %arrayidx10.i.phi.trans.insert = getelementptr inbounds i16, ptr %e, i64 -2
  %.pre43 = load i16, ptr %arrayidx10.i.phi.trans.insert, align 2, !tbaa !5
  %arrayidx28.i.phi.trans.insert = getelementptr inbounds i16, ptr %e, i64 1
  %.pre44 = load i16, ptr %arrayidx28.i.phi.trans.insert, align 2, !tbaa !5
  %arrayidx40.i.phi.trans.insert = getelementptr inbounds i16, ptr %e, i64 4
  %.pre45 = load i16, ptr %arrayidx40.i.phi.trans.insert, align 2, !tbaa !5
  br label %for.body.i

for.body.i:                                       ; preds = %for.body.i, %entry
  %0 = phi i16 [ %.pre45, %entry ], [ %11, %for.body.i ]
  %1 = phi i16 [ %.pre44, %entry ], [ %9, %for.body.i ]
  %2 = phi i16 [ %.pre43, %entry ], [ %6, %for.body.i ]
  %3 = phi i16 [ %.pre, %entry ], [ %4, %for.body.i ]
  %indvars.iv.i = phi i64 [ 0, %entry ], [ %indvars.iv.next.i, %for.body.i ]
  %conv.i = sext i16 %3 to i64
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1
  %arrayidx4.i = getelementptr inbounds i16, ptr %add.ptr.i, i64 %indvars.iv.next.i
  %4 = load i16, ptr %arrayidx4.i, align 2, !tbaa !5
  %conv5.i = sext i16 %4 to i64
  %conv11.i = sext i16 %2 to i64
  %5 = add nuw nsw i64 %indvars.iv.i, 4
  %arrayidx16.i = getelementptr inbounds i16, ptr %add.ptr.i, i64 %5
  %6 = load i16, ptr %arrayidx16.i, align 2, !tbaa !5
  %conv17.i = sext i16 %6 to i64
  %arrayidx22.i = getelementptr inbounds i16, ptr %e, i64 %indvars.iv.i
  %7 = load i16, ptr %arrayidx22.i, align 2, !tbaa !5
  %conv23.i = sext i16 %7 to i64
  %mul24.i = shl nsw i64 %conv23.i, 13
  %conv29.i = sext i16 %1 to i64
  %8 = add nuw nsw i64 %indvars.iv.i, 7
  %arrayidx34.i = getelementptr inbounds i16, ptr %add.ptr.i, i64 %8
  %9 = load i16, ptr %arrayidx34.i, align 2, !tbaa !5
  %conv35.i = sext i16 %9 to i64
  %conv41.i = sext i16 %0 to i64
  %10 = add nuw nsw i64 %indvars.iv.i, 10
  %arrayidx46.i = getelementptr inbounds i16, ptr %add.ptr.i, i64 %10
  %11 = load i16, ptr %arrayidx46.i, align 2, !tbaa !5
  %conv47.i = sext i16 %11 to i64
  %reass.add.i = add nsw i64 %conv29.i, %conv17.i
  %reass.mul.i = mul nsw i64 %reass.add.i, 5741
  %reass.add93.i = add nsw i64 %conv35.i, %conv11.i
  %reass.mul94.i = mul nsw i64 %reass.add93.i, 2054
  %reass.add95.i = add nsw i64 %conv41.i, %conv5.i
  %reass.mul96.i = mul nsw i64 %reass.add95.i, -374
  %reass.add97.i = add nsw i64 %conv47.i, %conv.i
  %reass.mul98.i = mul nsw i64 %reass.add97.i, -134
  %add25.i = or i64 %mul24.i, 4096
  %add31.i = add nsw i64 %add25.i, %reass.mul.i
  %add37.i = add nsw i64 %add31.i, %reass.mul94.i
  %add43.i = add nsw i64 %add37.i, %reass.mul96.i
  %add49.i = add nsw i64 %add43.i, %reass.mul98.i
...
Weighting_filter.exit:                            ; preds = %for.body.i
  ...
  %15 = ashr i16 %14, 2
  %conv5.i10 = sext i16 %15 to i64
  %mul6.i = mul nsw i64 %conv5.i10, %conv5.i10
  ...
  %17 = ashr i16 %16, 2
  %conv11.i11 = sext i16 %17 to i64
  %mul12.i = mul nsw i64 %conv11.i11, %conv11.i11
  ...
  %19 = ashr i16 %18, 2
  %conv17.i12 = sext i16 %19 to i64
  %mul18.i = mul nsw i64 %conv17.i12, %conv17.i12
  ...
  %21 = ashr i16 %20, 2
  %conv23.i13 = sext i16 %21 to i64
  %mul24.i14 = mul nsw i64 %conv23.i13, %conv23.i13
  %add25.i15 = add nuw nsw i64 %add19.i, %mul24.i14
  %arrayidx26.i = getelementptr inbounds i16, ptr %x, i64 18
  %22 = load i16, ptr %arrayidx26.i, align 4, !tbaa !5
  %23 = ashr i16 %22, 2
  %conv29.i16 = sext i16 %23 to i64
  %mul30.i = mul nsw i64 %conv29.i16, %conv29.i16
  %add31.i17 = add nuw nsw i64 %add25.i15, %mul30.i
  %arrayidx32.i = getelementptr inbounds i16, ptr %x, i64 21
  %24 = load i16, ptr %arrayidx32.i, align 2, !tbaa !5
  %25 = ashr i16 %24, 2
  %conv35.i18 = sext i16 %25 to i64
  %mul36.i = mul nsw i64 %conv35.i18, %conv35.i18
  %add37.i19 = add nuw nsw i64 %add31.i17, %mul36.i
  %arrayidx38.i = getelementptr inbounds i16, ptr %x, i64 24
  %26 = load i16, ptr %arrayidx38.i, align 16, !tbaa !5
  %27 = ashr i16 %26, 2
  %conv41.i20 = sext i16 %27 to i64
  %mul42.i = mul nsw i64 %conv41.i20, %conv41.i20
  %add43.i21 = add nsw i64 %add37.i19, %mul42.i
  %arrayidx44.i = getelementptr inbounds i16, ptr %x, i64 27
  %28 = load i16, ptr %arrayidx44.i, align 2, !tbaa !5
  %29 = ashr i16 %28, 2
  %conv47.i22 = sext i16 %29 to i64
  %mul48.i = mul nsw i64 %conv47.i22, %conv47.i22
  %add49.i23 = add nsw i64 %add43.i21, %mul48.i
  ...
  %add55.i = add nsw i64 %add49.i23, %mul54.i
  ...
  %op.rdx46 = add nuw nsw i16 %op.rdx, %inc32.5.i
  %conv17.i25 = zext i16 %137 to i32
  %add.i = add nuw nsw i16 %op.rdx46, 5
  %conv40103.i = zext i16 %add.i to i32
  %shr41.i = lshr i32 %conv17.i25, %conv40103.i
  %conv42.i = trunc i32 %shr41.i to i16
  %shl.i26 = shl nuw nsw i16 %op.rdx46, 3
  %call.i = tail call signext i16 @gsm_add(i16 noundef signext %conv42.i, i16 noundef signext %shl.i26) #5
...
APCM_quantization.exit:                           ; preds = %Weighting_filter.exit, %while.end.i.i
  ...
  %conv57104.i = zext i16 %sub46.i to i32
  %conv61.i = sext i16 %145 to i64
  %conv56105.i = zext i16 %110 to i32
  %shl58.i = shl i32 %conv56105.i, %conv57104.i
  %conv59.i27 = zext i32 %shl58.i to i64
  %sext.i = shl i64 %conv59.i27, 48
  %conv60.i = ashr exact i64 %sext.i, 48
  %mul.i28 = mul nsw i64 %conv60.i, %conv61.i
  %146 = trunc i64 %mul.i28 to i32
  %147 = shl i32 %146, 1
  %shr65.i = ashr i32 %147, 28
  %148 = trunc i32 %shr65.i to i16
  %conv69.i = add nsw i16 %148, 4
  store i16 %conv69.i, ptr %xMc, align 2, !tbaa !5
  %conv56105.1.i = zext i16 %111 to i32
  %shl58.1.i = shl i32 %conv56105.1.i, %conv57104.i
  ...
  %conv56105.2.i = zext i16 %112 to i32
  %shl58.2.i = shl i32 %conv56105.2.i, %conv57104.i
  ...
  %conv56105.3.i = zext i16 %113 to i32
  %shl58.3.i = shl i32 %conv56105.3.i, %conv57104.i
  ...
  %conv56105.4.i = zext i16 %114 to i32
  %shl58.4.i = shl i32 %conv56105.4.i, %conv57104.i
  ...
  %conv56105.5.i = zext i16 %115 to i32
  %shl58.5.i = shl i32 %conv56105.5.i, %conv57104.i
  ...
  %conv56105.6.i = zext i16 %116 to i32
  %shl58.6.i = shl i32 %conv56105.6.i, %conv57104.i
  ...
  %conv56105.7.i = zext i16 %117 to i32
  %shl58.7.i = shl i32 %conv56105.7.i, %conv57104.i
  ...
  %conv56105.8.i = zext i16 %101 to i32
  %shl58.8.i = shl i32 %conv56105.8.i, %conv57104.i
  ...
  %conv56105.9.i = zext i16 %103 to i32
  %shl58.9.i = shl i32 %conv56105.9.i, %conv57104.i
  ...
  %conv56105.10.i = zext i16 %105 to i32
  %shl58.10.i = shl i32 %conv56105.10.i, %conv57104.i
  ...
  %conv56105.11.i = zext i16 %107 to i32
  %shl58.11.i = shl i32 %conv56105.11.i, %conv57104.i
  ...
  %conv56105.12.i = zext i16 %109 to i32
  %shl58.12.i = shl i32 %conv56105.12.i, %conv57104.i
  ...
  %conv.i29 = sext i16 %185 to i32
  switch i32 %conv.i29, label %sw.epilog.i [
    i32 3, label %sw.bb.i
