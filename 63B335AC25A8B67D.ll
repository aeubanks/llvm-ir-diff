...
if.end.i.i136:                                    ; preds = %if.end.i132
  ...
  %call.i.i134149 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %39) #9
          to label %delete.notnull.i.i138 unwind label %lpad22

delete.notnull.i.i138:                            ; preds = %if.end.i.i136
...
_ZN11CStringBaseIwE11SetCapacityEi.exit.i142:     ; preds = %delete.notnull.i.i138, %if.end.i132
  %41 = phi ptr [ %call.i.i8283, %if.end.i132 ], [ %call.i.i134149, %delete.notnull.i.i138 ]
