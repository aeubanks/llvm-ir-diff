...
define dso_local void @_Z27function_throwing_exceptionv() local_unnamed_addr #0 {
  %1 = tail call ptr @__cxa_allocate_exception(i64 4) #1
  store i32 42, ptr %1, align 16, !tbaa !5
  tail call void @__cxa_throw(ptr nonnull %1, ptr nonnull @_ZTIi, ptr null) #2
  unreachable
}
