...
entry:
  ...
  %0 = load i64, ptr getelementptr inbounds (%struct.hdr, ptr @p, i64 0, i32 1), align 1
  store i64 %0, ptr getelementptr inbounds ([256 x i8], ptr @headline, i64 0, i64 10), align 2
