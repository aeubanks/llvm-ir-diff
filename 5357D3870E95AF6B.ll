...
entry:
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %m_rbAFrame, ptr noundef nonnull align 4 dereferenceable(16) %rbAFrame, i64 16, i1 false), !tbaa.struct !22
...
entry:
  ...
  %m_rbBFrame = getelementptr inbounds %class.btConeTwistConstraint, ptr %this, i64 0, i32 3
  %m_angularOnly = getelementptr inbounds %class.btConeTwistConstraint, ptr %this, i64 0, i32 22
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %m_rbBFrame, ptr noundef nonnull align 4 dereferenceable(16) %m_rbAFrame, i64 16, i1 false), !tbaa.struct !22
...
entry:
  %retval.i563 = alloca %class.btQuaternion, align 8
  %retval.i557 = alloca %class.btQuaternion, align 8
  %retval.i549 = alloca %class.btQuaternion, align 8
  %retval.i543 = alloca %class.btQuaternion, align 8
...
if.then:                                          ; preds = %entry
  ...
  %m_origin.i368 = getelementptr inbounds %class.btConeTwistConstraint, ptr %this, i64 0, i32 2, i32 1
  %36 = load float, ptr %m_origin.i368, align 4, !tbaa !26, !noalias !45
  ...
  %arrayidx4.i.i.i370 = getelementptr inbounds %class.btConeTwistConstraint, ptr %this, i64 0, i32 3, i32 0, i32 0, i64 1
  %45 = load float, ptr %arrayidx4.i.i.i370, align 4, !tbaa !26, !noalias !46
  %arrayidx.i.i.i.i371 = getelementptr inbounds [4 x float], ptr %transB, i64 0, i64 1
  %arrayidx9.i.i.i373 = getelementptr inbounds %class.btConeTwistConstraint, ptr %this, i64 0, i32 3, i32 0, i32 0, i64 2
  %46 = load float, ptr %arrayidx9.i.i.i373, align 4, !tbaa !26, !noalias !46
  %arrayidx.i14.i.i.i374 = getelementptr inbounds [4 x float], ptr %transB, i64 0, i64 2
  %arrayidx.i.i42.i.i375 = getelementptr inbounds %class.btConeTwistConstraint, ptr %this, i64 0, i32 3, i32 0, i32 0, i64 0, i32 0, i64 1
  %47 = load float, ptr %arrayidx.i.i42.i.i375, align 8, !tbaa !26, !noalias !46
  %arrayidx.i14.i43.i.i376 = getelementptr inbounds %class.btConeTwistConstraint, ptr %this, i64 0, i32 3, i32 0, i32 0, i64 1, i32 0, i64 1
  %48 = load float, ptr %arrayidx.i14.i43.i.i376, align 8, !tbaa !26, !noalias !46
  %arrayidx.i16.i.i.i378 = getelementptr inbounds %class.btConeTwistConstraint, ptr %this, i64 0, i32 3, i32 0, i32 0, i64 2, i32 0, i64 1
  %49 = load float, ptr %arrayidx.i16.i.i.i378, align 8, !tbaa !26, !noalias !46
  %arrayidx.i.i45.i.i379 = getelementptr inbounds %class.btConeTwistConstraint, ptr %this, i64 0, i32 3, i32 0, i32 0, i64 0, i32 0, i64 2
  %50 = load float, ptr %arrayidx.i.i45.i.i379, align 4, !tbaa !26, !noalias !46
  %arrayidx.i14.i46.i.i380 = getelementptr inbounds %class.btConeTwistConstraint, ptr %this, i64 0, i32 3, i32 0, i32 0, i64 1, i32 0, i64 2
  %51 = load float, ptr %arrayidx.i14.i46.i.i380, align 4, !tbaa !26, !noalias !46
  %arrayidx.i16.i49.i.i382 = getelementptr inbounds %class.btConeTwistConstraint, ptr %this, i64 0, i32 3, i32 0, i32 0, i64 2, i32 0, i64 2
  %52 = load float, ptr %arrayidx.i16.i49.i.i382, align 4, !tbaa !26, !noalias !46
  %arrayidx.i.i.i383 = getelementptr inbounds [3 x %class.btVector3], ptr %transB, i64 0, i64 1
  %arrayidx.i.i52.i.i384 = getelementptr inbounds [3 x %class.btVector3], ptr %transB, i64 0, i64 1, i32 0, i64 1
  %arrayidx.i14.i55.i.i386 = getelementptr inbounds [3 x %class.btVector3], ptr %transB, i64 0, i64 1, i32 0, i64 2
  %arrayidx.i70.i.i389 = getelementptr inbounds [3 x %class.btVector3], ptr %transB, i64 0, i64 2
  %53 = load float, ptr %arrayidx.i70.i.i389, align 4, !tbaa !26, !noalias !51
  %arrayidx.i.i72.i.i390 = getelementptr inbounds [3 x %class.btVector3], ptr %transB, i64 0, i64 2, i32 0, i64 1
  %54 = load float, ptr %arrayidx.i.i72.i.i390, align 4, !tbaa !26, !noalias !51
  %mul7.i73.i.i391 = fmul float %45, %54
  %55 = tail call float @llvm.fmuladd.f32(float %44, float %53, float %mul7.i73.i.i391)
  %arrayidx.i14.i75.i.i392 = getelementptr inbounds [3 x %class.btVector3], ptr %transB, i64 0, i64 2, i32 0, i64 2
  %56 = load float, ptr %arrayidx.i14.i75.i.i392, align 4, !tbaa !26, !noalias !51
  %57 = tail call float @llvm.fmuladd.f32(float %46, float %56, float %55)
  %mul7.i80.i.i393 = fmul float %48, %54
  %58 = tail call float @llvm.fmuladd.f32(float %47, float %53, float %mul7.i80.i.i393)
  %59 = tail call float @llvm.fmuladd.f32(float %49, float %56, float %58)
  %mul7.i87.i.i394 = fmul float %51, %54
  %60 = tail call float @llvm.fmuladd.f32(float %50, float %53, float %mul7.i87.i.i394)
  %61 = tail call float @llvm.fmuladd.f32(float %52, float %56, float %60)
  %m_origin.i395 = getelementptr inbounds %class.btConeTwistConstraint, ptr %this, i64 0, i32 3, i32 1
  %62 = load float, ptr %m_origin.i395, align 4, !tbaa !26, !noalias !51
  %arrayidx7.i.i.i396 = getelementptr inbounds %class.btConeTwistConstraint, ptr %this, i64 0, i32 3, i32 1, i32 0, i64 1
  %63 = load float, ptr %arrayidx7.i.i.i396, align 8, !tbaa !26, !noalias !51
  %arrayidx12.i.i.i398 = getelementptr inbounds %class.btConeTwistConstraint, ptr %this, i64 0, i32 3, i32 1, i32 0, i64 2
  %64 = load float, ptr %arrayidx12.i.i.i398, align 4, !tbaa !26, !noalias !51
  %m_origin.i.i399 = getelementptr inbounds %class.btTransform, ptr %transB, i64 0, i32 1
  %mul8.i29.i.i404 = fmul float %54, %63
  %65 = tail call float @llvm.fmuladd.f32(float %53, float %62, float %mul8.i29.i.i404)
  %66 = tail call float @llvm.fmuladd.f32(float %56, float %64, float %65)
  %arrayidx.i32.i.i405 = getelementptr inbounds %class.btTransform, ptr %transB, i64 0, i32 1, i32 0, i64 2
  %67 = load float, ptr %arrayidx.i32.i.i405, align 4, !tbaa !26, !noalias !51
  %add17.i.i406 = fadd float %66, %67
  call void @llvm.lifetime.start.p0(i64 64, ptr nonnull %trDeltaAB) #19
  %mul7.i73.i.i444 = fmul float %add30.i.i.i, %59
  %68 = tail call float @llvm.fmuladd.f32(float %sub.i.i.i, float %57, float %mul7.i73.i.i444)
  %69 = tail call float @llvm.fmuladd.f32(float %sub37.i.i.i, float %61, float %68)
  %mul7.i87.i.i447 = fmul float %sub35.i.i.i, %59
  %70 = tail call float @llvm.fmuladd.f32(float %add28.i.i.i, float %57, float %mul7.i87.i.i447)
  %71 = tail call float @llvm.fmuladd.f32(float %sub42.i.i.i, float %61, float %70)
  %mul8.i29.i.i457 = fmul float %59, 0.000000e+00
  %72 = tail call float @llvm.fmuladd.f32(float %57, float 0.000000e+00, float %mul8.i29.i.i457)
  %73 = tail call float @llvm.fmuladd.f32(float %61, float 0.000000e+00, float %72)
  %add17.i.i459 = fadd float %73, %add17.i.i406
  ...
  %mul8.i.i.i369 = fmul float %75, %37
  %113 = tail call float @llvm.fmuladd.f32(float %74, float %36, float %mul8.i.i.i369)
  ...
  %mul8.i.i.i478 = fmul float %117, %fneg4.i.i
  %118 = extractelement <2 x float> %94, i64 0
  %119 = tail call float @llvm.fmuladd.f32(float %118, float %fneg.i.i, float %mul8.i.i.i478)
  ...
  %mul7.i87.i.i505 = fmul float %33, %135
  %136 = tail call float @llvm.fmuladd.f32(float %31, float %69, float %mul7.i87.i.i505)
  ...
  %144 = load <4 x float>, ptr %arrayidx.i.i.i.i371, align 4
  %145 = shufflevector <4 x float> %144, <4 x float> poison, <2 x i32> <i32 0, i32 poison>
  %146 = load <4 x float>, ptr %arrayidx.i14.i.i.i374, align 4
  %147 = shufflevector <4 x float> %146, <4 x float> poison, <2 x i32> <i32 0, i32 poison>
  %148 = load float, ptr %arrayidx.i.i.i383, align 4, !tbaa !26, !noalias !51
  %149 = load float, ptr %arrayidx.i.i52.i.i384, align 4, !tbaa !26, !noalias !51
  ...
  %158 = load float, ptr %arrayidx.i14.i55.i.i386, align 4, !tbaa !26, !noalias !51
  ...
  %190 = load <2 x float>, ptr %m_origin.i.i399, align 4, !tbaa !26, !noalias !51
  ...
  %mul7.i48.i.i492 = fmul float %33, %223
  %224 = extractelement <2 x float> %200, i64 0
  %225 = tail call float @llvm.fmuladd.f32(float %31, float %224, float %mul7.i48.i.i492)
  ...
  %mul7.i67.i.i499 = fmul float %33, %228
  %229 = extractelement <2 x float> %200, i64 1
  %230 = tail call float @llvm.fmuladd.f32(float %31, float %229, float %mul7.i67.i.i499)
  ...
  %mul8.i29.i.i515 = fmul float %248, %135
  %249 = tail call float @llvm.fmuladd.f32(float %69, float %120, float %mul8.i29.i.i515)
  %250 = tail call float @llvm.fmuladd.f32(float %71, float %141, float %249)
  %add17.i.i517 = fadd float %250, %add17.i.i459
  %retval.sroa.3.12.vec.insert.i.i520 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %add17.i.i517, i64 0
  store <2 x float> %238, ptr %trDeltaAB, align 8, !alias.scope !52
  %ref.tmp.sroa.5.0.agg.result.sroa_idx.i522 = getelementptr inbounds i8, ptr %trDeltaAB, i64 8
  store float %227, ptr %ref.tmp.sroa.5.0.agg.result.sroa_idx.i522, align 8, !tbaa.struct !55, !alias.scope !52
  %ref.tmp.sroa.6.0.agg.result.sroa_idx.i523 = getelementptr inbounds i8, ptr %trDeltaAB, i64 12
  store float 0.000000e+00, ptr %ref.tmp.sroa.6.0.agg.result.sroa_idx.i523, align 4, !tbaa.struct !56, !alias.scope !52
  %arrayidx8.i.i.i524 = getelementptr inbounds [3 x %class.btVector3], ptr %trDeltaAB, i64 0, i64 1
  ...
  store <2 x float> %256, ptr %arrayidx8.i.i.i524, align 8, !alias.scope !52
  %ref.tmp.sroa.10.16.arrayidx8.i.i.sroa_idx.i526 = getelementptr inbounds [3 x %class.btVector3], ptr %trDeltaAB, i64 0, i64 1, i32 0, i64 2
  store float %232, ptr %ref.tmp.sroa.10.16.arrayidx8.i.i.sroa_idx.i526, align 8, !tbaa.struct !55, !alias.scope !52
  %ref.tmp.sroa.11.16.arrayidx8.i.i.sroa_idx.i527 = getelementptr inbounds [3 x %class.btVector3], ptr %trDeltaAB, i64 0, i64 1, i32 0, i64 3
  store float 0.000000e+00, ptr %ref.tmp.sroa.11.16.arrayidx8.i.i.sroa_idx.i527, align 4, !tbaa.struct !56, !alias.scope !52
  %arrayidx12.i.i7.i528 = getelementptr inbounds [3 x %class.btVector3], ptr %trDeltaAB, i64 0, i64 2
  ...
  store <2 x float> %264, ptr %arrayidx12.i.i7.i528, align 8, !alias.scope !52
  %ref.tmp.sroa.15.32.arrayidx12.i.i7.sroa_idx.i530 = getelementptr inbounds [3 x %class.btVector3], ptr %trDeltaAB, i64 0, i64 2, i32 0, i64 2
  store float %137, ptr %ref.tmp.sroa.15.32.arrayidx12.i.i7.sroa_idx.i530, align 8, !tbaa.struct !55, !alias.scope !52
  %ref.tmp.sroa.16.32.arrayidx12.i.i7.sroa_idx.i531 = getelementptr inbounds [3 x %class.btVector3], ptr %trDeltaAB, i64 0, i64 2, i32 0, i64 3
  store float 0.000000e+00, ptr %ref.tmp.sroa.16.32.arrayidx12.i.i7.sroa_idx.i531, align 4, !tbaa.struct !56, !alias.scope !52
  %m_origin.i8.i532 = getelementptr inbounds %class.btTransform, ptr %trDeltaAB, i64 0, i32 1
  store <2 x float> %247, ptr %m_origin.i8.i532, align 8, !tbaa.struct !22, !alias.scope !52
  %ref.tmp3.sroa.4.0.m_origin.i8.sroa_idx.i533 = getelementptr inbounds %class.btTransform, ptr %trDeltaAB, i64 0, i32 1, i32 0, i64 2
  store <2 x float> %retval.sroa.3.12.vec.insert.i.i520, ptr %ref.tmp3.sroa.4.0.m_origin.i8.sroa_idx.i533, align 8, !tbaa.struct !55, !alias.scope !52
  ...
  %mul7.i.i.i541 = fmul float %qDeltaAB.sroa.5.8.vec.extract, %div.i.i
  store float %mul7.i.i.i541, ptr %swingAxis.sroa.5.0.m_swingAxis.sroa_idx, align 4, !tbaa !26
...
if.end20:                                         ; preds = %entry
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %retval.i543)
  call void @_ZNK11btMatrix3x311getRotationER12btQuaternion(ptr noundef nonnull align 4 dereferenceable(48) %transA, ptr noundef nonnull align 4 dereferenceable(16) %retval.i543)
  %.fca.0.load.i544 = load <2 x float>, ptr %retval.i543, align 8
  %.fca.1.gep.i546 = getelementptr inbounds { <2 x float>, <2 x float> }, ptr %retval.i543, i64 0, i32 1
  %.fca.1.load.i547 = load <2 x float>, ptr %.fca.1.gep.i546, align 8
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %retval.i543)
  %m_rbAFrame26 = getelementptr inbounds %class.btConeTwistConstraint, ptr %this, i64 0, i32 2
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %retval.i549)
  call void @_ZNK11btMatrix3x311getRotationER12btQuaternion(ptr noundef nonnull align 4 dereferenceable(48) %m_rbAFrame26, ptr noundef nonnull align 4 dereferenceable(16) %retval.i549)
  %.fca.0.load.i550 = load <2 x float>, ptr %retval.i549, align 8
  %.fca.1.gep.i552 = getelementptr inbounds { <2 x float>, <2 x float> }, ptr %retval.i549, i64 0, i32 1
  %.fca.1.load.i553 = load <2 x float>, ptr %.fca.1.gep.i552, align 8
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %retval.i549)
  %ref.tmp21.sroa.5.12.vec.extract = extractelement <2 x float> %.fca.1.load.i547, i64 1
  %ref.tmp25.sroa.5.12.vec.extract = extractelement <2 x float> %.fca.1.load.i553, i64 1
  %273 = extractelement <2 x float> %.fca.0.load.i544, i64 0
  %mul4.i = fmul float %273, %ref.tmp25.sroa.5.12.vec.extract
  %274 = extractelement <2 x float> %.fca.0.load.i550, i64 0
  %275 = call float @llvm.fmuladd.f32(float %ref.tmp21.sroa.5.12.vec.extract, float %274, float %mul4.i)
  %ref.tmp25.sroa.5.8.vec.extract = extractelement <2 x float> %.fca.1.load.i553, i64 0
  %276 = extractelement <2 x float> %.fca.0.load.i544, i64 1
  %277 = call float @llvm.fmuladd.f32(float %276, float %ref.tmp25.sroa.5.8.vec.extract, float %275)
  %ref.tmp21.sroa.5.8.vec.extract = extractelement <2 x float> %.fca.1.load.i547, i64 0
  %neg.i = fneg float %ref.tmp21.sroa.5.8.vec.extract
  %278 = extractelement <2 x float> %.fca.0.load.i550, i64 1
  %279 = call float @llvm.fmuladd.f32(float %neg.i, float %278, float %277)
  %280 = shufflevector <2 x float> %.fca.1.load.i547, <2 x float> %.fca.0.load.i544, <2 x i32> <i32 0, i32 3>
  %281 = shufflevector <2 x float> %.fca.1.load.i553, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %282 = fmul <2 x float> %280, %281
  %283 = shufflevector <2 x float> %.fca.1.load.i547, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %284 = shufflevector <2 x float> %.fca.1.load.i553, <2 x float> %.fca.0.load.i550, <2 x i32> <i32 0, i32 3>
  ...
  %287 = shufflevector <2 x float> %.fca.1.load.i547, <2 x float> %.fca.0.load.i544, <2 x i32> <i32 0, i32 2>
  %288 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %287, <2 x float> %.fca.0.load.i550, <2 x float> %286)
  %289 = fneg <2 x float> %.fca.0.load.i544
  %290 = shufflevector <2 x float> %.fca.1.load.i553, <2 x float> %.fca.0.load.i550, <2 x i32> <i32 0, i32 2>
  %291 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %289, <2 x float> %290, <2 x float> %288)
  %292 = fmul <2 x float> %.fca.0.load.i550, %289
  ...
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %retval.i557)
  call void @_ZNK11btMatrix3x311getRotationER12btQuaternion(ptr noundef nonnull align 4 dereferenceable(48) %transB, ptr noundef nonnull align 4 dereferenceable(16) %retval.i557)
  %.fca.0.load.i558 = load <2 x float>, ptr %retval.i557, align 8
  %.fca.1.gep.i560 = getelementptr inbounds { <2 x float>, <2 x float> }, ptr %retval.i557, i64 0, i32 1
  %.fca.1.load.i561 = load <2 x float>, ptr %.fca.1.gep.i560, align 8
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %retval.i557)
  %m_rbBFrame38 = getelementptr inbounds %class.btConeTwistConstraint, ptr %this, i64 0, i32 3
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %retval.i563)
  call void @_ZNK11btMatrix3x311getRotationER12btQuaternion(ptr noundef nonnull align 4 dereferenceable(48) %m_rbBFrame38, ptr noundef nonnull align 4 dereferenceable(16) %retval.i563)
  %.fca.0.load.i564 = load <2 x float>, ptr %retval.i563, align 8
  %.fca.1.gep.i566 = getelementptr inbounds { <2 x float>, <2 x float> }, ptr %retval.i563, i64 0, i32 1
  %.fca.1.load.i567 = load <2 x float>, ptr %.fca.1.gep.i566, align 8
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %retval.i563)
  %ref.tmp33.sroa.5.12.vec.extract = extractelement <2 x float> %.fca.1.load.i561, i64 1
  %297 = shufflevector <2 x float> %.fca.0.load.i564, <2 x float> poison, <2 x i32> <i32 1, i32 0>
  %ref.tmp37.sroa.5.12.vec.extract = extractelement <2 x float> %.fca.1.load.i567, i64 1
  %298 = extractelement <2 x float> %.fca.0.load.i558, i64 0
  %mul4.i571 = fmul float %298, %ref.tmp37.sroa.5.12.vec.extract
  %299 = extractelement <2 x float> %.fca.0.load.i564, i64 0
  %300 = call float @llvm.fmuladd.f32(float %ref.tmp33.sroa.5.12.vec.extract, float %299, float %mul4.i571)
  %ref.tmp37.sroa.5.8.vec.extract = extractelement <2 x float> %.fca.1.load.i567, i64 0
  %301 = extractelement <2 x float> %.fca.0.load.i558, i64 1
  %302 = call float @llvm.fmuladd.f32(float %301, float %ref.tmp37.sroa.5.8.vec.extract, float %300)
  %ref.tmp33.sroa.5.8.vec.extract = extractelement <2 x float> %.fca.1.load.i561, i64 0
  %neg.i576 = fneg float %ref.tmp33.sroa.5.8.vec.extract
  %303 = extractelement <2 x float> %.fca.0.load.i564, i64 1
  %304 = call float @llvm.fmuladd.f32(float %neg.i576, float %303, float %302)
  %305 = shufflevector <2 x float> %.fca.1.load.i561, <2 x float> %.fca.0.load.i558, <2 x i32> <i32 0, i32 3>
  %306 = shufflevector <2 x float> %.fca.1.load.i567, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %307 = fmul <2 x float> %305, %306
  %308 = shufflevector <2 x float> %.fca.1.load.i561, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %309 = shufflevector <2 x float> %.fca.1.load.i567, <2 x float> %.fca.0.load.i564, <2 x i32> <i32 0, i32 3>
  %310 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %308, <2 x float> %309, <2 x float> %307)
  %311 = shufflevector <2 x float> %.fca.0.load.i558, <2 x float> %.fca.1.load.i561, <2 x i32> <i32 0, i32 2>
  %312 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %311, <2 x float> %297, <2 x float> %310)
  %313 = shufflevector <2 x float> %.fca.0.load.i558, <2 x float> poison, <2 x i32> <i32 1, i32 0>
  %314 = fneg <2 x float> %313
  %315 = shufflevector <2 x float> %.fca.0.load.i564, <2 x float> %.fca.1.load.i567, <2 x i32> <i32 0, i32 2>
  ...
  %317 = fmul <2 x float> %.fca.0.load.i564, %shift
  %neg37.i581 = extractelement <2 x float> %317, i64 0
  %318 = call float @llvm.fmuladd.f32(float %ref.tmp33.sroa.5.12.vec.extract, float %ref.tmp37.sroa.5.12.vec.extract, float %neg37.i581)
  %319 = extractelement <2 x float> %314, i64 0
  %320 = call float @llvm.fmuladd.f32(float %319, float %303, float %318)
  %321 = call float @llvm.fmuladd.f32(float %neg.i576, float %ref.tmp37.sroa.5.8.vec.extract, float %320)
  ...
  %mul14.i602 = fmul float %296, %fneg5.i
  %326 = extractelement <2 x float> %291, i64 0
  %327 = call float @llvm.fmuladd.f32(float %321, float %326, float %mul14.i602)
  ...
  %neg37.i606 = fmul float %279, %304
  %345 = call float @llvm.fmuladd.f32(float %321, float %296, float %neg37.i606)
  ...
  %mul8.i.i.i.i620 = fmul float %368, %368
  %382 = extractelement <2 x float> %381, i64 1
  %383 = call float @llvm.fmuladd.f32(float %382, float %382, float %mul8.i.i.i.i620)
  %384 = extractelement <2 x float> %381, i64 0
  %385 = call float @llvm.fmuladd.f32(float %384, float %384, float %383)
  %sqrt.i.i622 = call float @llvm.sqrt.f32(float %385)
  %div.i.i623 = fdiv float 1.000000e+00, %sqrt.i.i622
  %mul4.i.i.i625 = fmul float %368, %div.i.i623
  %386 = insertelement <2 x float> poison, float %div.i.i623, i64 0
  %387 = shufflevector <2 x float> %386, <2 x float> poison, <2 x i32> zeroinitializer
  %388 = fmul <2 x float> %381, %387
  %mul8.i.i = fmul float %mul4.i.i.i625, 0.000000e+00
  ...
  %cmp.i629 = fcmp olt float %392, 0xBFEFFFFFC0000000
  br i1 %cmp.i629, label %_Z15shortestArcQuatRK9btVector3S1_.exit, label %if.end.i

if.end.i:                                         ; preds = %if.end20
  %neg30.i.i = fmul float %389, -0.000000e+00
  %393 = fadd float %mul4.i.i.i625, %neg30.i.i
  %neg19.i.i = fneg float %391
  %neg.i.i634 = fmul float %mul4.i.i.i625, -0.000000e+00
  %add.i = fadd float %392, 1.000000e+00
  %mul.i635 = fmul float %add.i, 2.000000e+00
  %call.i.i636 = call float @sqrtf(float noundef %mul.i635) #19
  %div.i = fdiv float 1.000000e+00, %call.i.i636
  %394 = insertelement <2 x float> poison, float %neg.i.i634, i64 0
  ...
  %401 = insertelement <2 x float> %400, float %call.i.i636, i64 1
...
_Z15shortestArcQuatRK9btVector3S1_.exit:          ; preds = %if.end20, %if.end.i
  ...
  %sqrt.i.i642 = call float @llvm.sqrt.f32(float %407)
  %div.i.i643 = fdiv float 1.000000e+00, %sqrt.i.i642
  %mul.i.i.i644 = fmul float %qABCone.sroa.0.0.vec.extract, %div.i.i643
  %mul10.i.i.i647 = fmul float %qABCone.sroa.11.12.vec.extract, %div.i.i643
  %fneg.i648 = fneg float %mul.i.i.i644
  ...
  %410 = insertelement <2 x float> poison, float %div.i.i643, i64 0
  ...
  %414 = insertelement <2 x float> poison, float %mul10.i.i.i647, i64 0
  ...
  %418 = insertelement <2 x float> %417, float %fneg.i648, i64 0
  ...
  %423 = insertelement <2 x float> %422, float %fneg.i648, i64 0
  ...
  %427 = insertelement <2 x float> %417, float %mul.i.i.i644, i64 1
  ...
  %430 = insertelement <2 x float> %422, float %mul.i.i.i644, i64 1
  ...
  %mul5.i.i.i.i680 = extractelement <2 x float> %435, i64 1
  %436 = extractelement <2 x float> %429, i64 0
  %437 = call float @llvm.fmuladd.f32(float %436, float %436, float %mul5.i.i.i.i680)
  ...
  %sqrt.i.i683 = call float @llvm.sqrt.f32(float %441)
  %div.i.i684 = fdiv float 1.000000e+00, %sqrt.i.i683
  %442 = insertelement <2 x float> poison, float %div.i.i684, i64 0
  ...
  %or.cond1184 = select i1 %cmp, i1 true, i1 %cmp69
  br i1 %or.cond1184, label %if.else, label %if.then70

if.then70:                                        ; preds = %_Z15shortestArcQuatRK9btVector3S1_.exit
  %call.i.i.i = call float @acosf(float noundef %mul10.i.i.i647) #19
  %mul.i.i690 = fmul float %call.i.i.i, 2.000000e+00
  %cmp.i691 = fcmp ogt float %mul.i.i690, 0x3E80000000000000
  br i1 %cmp.i691, label %if.then.i693, label %_ZN21btConeTwistConstraint20computeConeLimitInfoERK12btQuaternionRfR9btVector3S3_.exit

if.then.i693:                                     ; preds = %if.then70
  %449 = fmul <2 x float> %412, %412
  %mul8.i.i.i.i.i = extractelement <2 x float> %449, i64 0
  %450 = call float @llvm.fmuladd.f32(float %mul.i.i.i644, float %mul.i.i.i644, float %mul8.i.i.i.i.i)
  ...
  %div.i.i.i692 = fdiv float 1.000000e+00, %sqrt.i.i.i
  %453 = insertelement <2 x float> %417, float %mul.i.i.i644, i64 0
  %454 = insertelement <2 x float> poison, float %div.i.i.i692, i64 0
  %455 = shufflevector <2 x float> %454, <2 x float> poison, <2 x i32> zeroinitializer
  %456 = fmul <2 x float> %453, %455
  %mul7.i.i.i.i = fmul float %451, %div.i.i.i692
...
if.then14.i:                                      ; preds = %if.then.i693
  %mul.i694 = fmul float %mul7.i.i.i.i, %mul7.i.i.i.i
  %mul15.i = fmul float %458, %458
  %div.i695 = fdiv float %mul.i694, %mul15.i
  ...
  %464 = insertelement <2 x float> <float poison, float 1.000000e+00>, float %div.i695, i64 0
  ...
  %add.i696 = extractelement <2 x float> %466, i64 0
  %add23.i = fadd float %div.i695, 1.000000e+00
  %div24.i = fdiv float %add23.i, %add.i696
  %call.i.i697 = call float @sqrtf(float noundef %div24.i) #19
  br label %_ZN21btConeTwistConstraint20computeConeLimitInfoERK12btQuaternionRfR9btVector3S3_.exit

_ZN21btConeTwistConstraint20computeConeLimitInfoERK12btQuaternionRfR9btVector3S3_.exit: ; preds = %if.then70, %if.then.i693, %if.then14.i
  %swingAxis71.sroa.10.0 = phi float [ %mul7.i.i.i.i, %if.then14.i ], [ %mul7.i.i.i.i, %if.then.i693 ], [ undef, %if.then70 ]
  %swingLimit.0 = phi float [ %call.i.i697, %if.then14.i ], [ %457, %if.then.i693 ], [ 0.000000e+00, %if.then70 ]
  %467 = phi <2 x float> [ %456, %if.then14.i ], [ %456, %if.then.i693 ], [ undef, %if.then70 ]
  ...
  %cmp72 = fcmp ogt float %mul.i.i690, %mul
...
if.then73:                                        ; preds = %_ZN21btConeTwistConstraint20computeConeLimitInfoERK12btQuaternionRfR9btVector3S3_.exit
  ...
  %cmp75 = fcmp olt float %mul.i.i690, %swingLimit.0
  %cmp78 = fcmp olt float %468, 0x3FEFFFFFC0000000
  %or.cond1185 = and i1 %cmp75, %cmp78
  %neg = fneg float %swingLimit.0
  %469 = call float @llvm.fmuladd.f32(float %neg, float %468, float %mul.i.i690)
  %470 = call float @llvm.fmuladd.f32(float %neg, float %468, float %swingLimit.0)
  %div = fdiv float %469, %470
  %storemerge1189 = select i1 %or.cond1185, float %div, float 1.000000e+00
  ...
  %cmp.i698 = fcmp ogt float %472, 0x3E80000000000000
  br i1 %cmp.i698, label %if.then.i711, label %_ZNK21btConeTwistConstraint33adjustSwingAxisToUseEllipseNormalER9btVector3.exit

if.then.i711:                                     ; preds = %if.then73
  %fneg.i700 = fneg float %swingAxis71.sroa.10.0
  %473 = load float, ptr %m_swingSpan2, align 8, !tbaa !58
  %474 = load float, ptr %m_swingSpan1, align 4, !tbaa !38
  %475 = insertelement <2 x float> poison, float %fneg.i700, i64 0
  ...
  %mul.i704 = extractelement <2 x float> %480, i64 0
  %cmp5.i = fcmp olt float %swingAxis71.sroa.10.0, 0.000000e+00
  %mul7.i = fmul float %471, %mul.i704
  ...
  %mul8.i.i.i.i.i705 = fmul float %471, %471
  %482 = extractelement <2 x float> %467, i64 0
  %483 = call float @llvm.fmuladd.f32(float %482, float %482, float %mul8.i.i.i.i.i705)
  %484 = call float @llvm.fmuladd.f32(float %y.0.i, float %y.0.i, float %483)
  %sqrt.i.i.i706 = call float @llvm.sqrt.f32(float %484)
  %div.i.i.i707 = fdiv float 1.000000e+00, %sqrt.i.i.i706
  %485 = insertelement <2 x float> poison, float %div.i.i.i707, i64 0
  %486 = shufflevector <2 x float> %485, <2 x float> poison, <2 x i32> zeroinitializer
  %487 = fmul <2 x float> %467, %486
  %mul7.i.i.i.i710 = fmul float %div.i.i.i707, %fneg12.i
  br label %_ZNK21btConeTwistConstraint33adjustSwingAxisToUseEllipseNormalER9btVector3.exit

_ZNK21btConeTwistConstraint33adjustSwingAxisToUseEllipseNormalER9btVector3.exit: ; preds = %if.then73, %if.then.i711
  %swingAxis71.sroa.10.1 = phi float [ %mul7.i.i.i.i710, %if.then.i711 ], [ %swingAxis71.sroa.10.0, %if.then73 ]
  %488 = phi <2 x float> [ %487, %if.then.i711 ], [ %467, %if.then73 ]
  ...
  %mul12.i.i725 = extractelement <2 x float> %493, i64 0
  %494 = call float @llvm.fmuladd.f32(float %321, float %fneg4.i, float %mul12.i.i725)
  %495 = call float @llvm.fmuladd.f32(float %304, float %swingAxis71.sroa.10.1, float %494)
  %neg31.i.i729 = fmul float %322, %492
  %496 = extractelement <2 x float> %488, i64 0
  %497 = call float @llvm.fmuladd.f32(float %304, float %496, float %neg31.i.i729)
  ...
  %mul37.i.i732 = fmul float %321, %515
  %516 = call float @llvm.fmuladd.f32(float %498, float %328, float %mul37.i.i732)
  ...
  %retval.sroa.3.12.vec.insert.i735 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %519, i64 0
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i735, ptr %ref.tmp91.sroa.4.0.m_swingAxis97.sroa_idx, align 4, !tbaa.struct !55
  ...
  %arrayidx4.i.i.i741 = getelementptr inbounds [3 x %class.btVector3], ptr %invInertiaWorldA, i64 0, i64 1
  %arrayidx9.i.i.i744 = getelementptr inbounds [3 x %class.btVector3], ptr %invInertiaWorldA, i64 0, i64 2
  ...
  %arrayidx.i16.i.i.i746 = getelementptr inbounds [3 x %class.btVector3], ptr %invInertiaWorldA, i64 0, i64 2, i32 0, i64 1
  ...
  %arrayidx4.i.i.i748 = getelementptr inbounds [3 x %class.btVector3], ptr %invInertiaWorldB, i64 0, i64 1
  %arrayidx9.i.i.i751 = getelementptr inbounds [3 x %class.btVector3], ptr %invInertiaWorldB, i64 0, i64 2
  %arrayidx.i.i9.i.i753 = getelementptr inbounds [4 x float], ptr %invInertiaWorldB, i64 0, i64 1
  %arrayidx.i14.i10.i.i754 = getelementptr inbounds [3 x %class.btVector3], ptr %invInertiaWorldB, i64 0, i64 1, i32 0, i64 1
  %arrayidx.i16.i.i.i756 = getelementptr inbounds [3 x %class.btVector3], ptr %invInertiaWorldB, i64 0, i64 2, i32 0, i64 1
  %arrayidx.i.i12.i.i757 = getelementptr inbounds [4 x float], ptr %invInertiaWorldB, i64 0, i64 2
  %arrayidx.i14.i13.i.i758 = getelementptr inbounds [3 x %class.btVector3], ptr %invInertiaWorldB, i64 0, i64 1, i32 0, i64 2
  %arrayidx.i16.i16.i.i760 = getelementptr inbounds [3 x %class.btVector3], ptr %invInertiaWorldB, i64 0, i64 2, i32 0, i64 2
  %520 = load <4 x float>, ptr %invInertiaWorldA, align 4
  %521 = shufflevector <4 x float> %520, <4 x float> poison, <2 x i32> <i32 0, i32 poison>
  %522 = load <4 x float>, ptr %arrayidx4.i.i.i741, align 4
  %523 = shufflevector <4 x float> %522, <4 x float> poison, <2 x i32> <i32 0, i32 poison>
  %524 = load <4 x float>, ptr %arrayidx9.i.i.i744, align 4
  ...
  %530 = load float, ptr %arrayidx.i16.i.i.i746, align 4, !tbaa !26
  ...
  %537 = load float, ptr %arrayidx4.i.i.i748, align 4, !tbaa !26
  ...
  %544 = load float, ptr %arrayidx9.i.i.i751, align 4, !tbaa !26
  ...
  %549 = load float, ptr %arrayidx.i.i9.i.i753, align 4, !tbaa !26
  %550 = load float, ptr %arrayidx.i14.i10.i.i754, align 4, !tbaa !26
  ...
  %555 = load float, ptr %arrayidx.i16.i.i.i756, align 4, !tbaa !26
  ...
  %559 = load float, ptr %arrayidx.i.i12.i.i757, align 4, !tbaa !26
  %560 = load float, ptr %arrayidx.i14.i13.i.i758, align 4, !tbaa !26
  ...
  %565 = load float, ptr %arrayidx.i16.i16.i.i760, align 4, !tbaa !26
...
if.else:                                          ; preds = %_Z15shortestArcQuatRK9btVector3S1_.exit
  %arrayidx4.i762 = getelementptr inbounds %class.btConeTwistConstraint, ptr %this, i64 0, i32 2, i32 0, i32 0, i64 1
  ...
  %574 = load float, ptr %arrayidx4.i762, align 4, !tbaa !26
  ...
  %arrayidx.i.i770 = getelementptr inbounds [3 x %class.btVector3], ptr %transA, i64 0, i64 1
  %576 = load float, ptr %arrayidx.i.i770, align 4, !tbaa !26
  ...
  %arrayidx7.i777 = getelementptr inbounds %class.btConeTwistConstraint, ptr %this, i64 0, i32 2, i32 0, i32 0, i64 1, i32 0, i64 1
  %arrayidx12.i = getelementptr inbounds %class.btConeTwistConstraint, ptr %this, i64 0, i32 2, i32 0, i32 0, i64 2, i32 0, i64 1
  %arrayidx4.i830 = getelementptr inbounds %class.btConeTwistConstraint, ptr %this, i64 0, i32 3, i32 0, i32 0, i64 1
  %arrayidx9.i831 = getelementptr inbounds %class.btConeTwistConstraint, ptr %this, i64 0, i32 3, i32 0, i32 0, i64 2
  %581 = load float, ptr %m_rbBFrame38, align 4, !tbaa !26
  %582 = load float, ptr %arrayidx4.i830, align 4, !tbaa !26
  %583 = load float, ptr %arrayidx9.i831, align 4, !tbaa !26
  %584 = load float, ptr %transB, align 4, !tbaa !26
  %arrayidx5.i.i837 = getelementptr inbounds [4 x float], ptr %transB, i64 0, i64 1
  %585 = load float, ptr %arrayidx5.i.i837, align 4, !tbaa !26
  %mul8.i.i839 = fmul float %582, %585
  %586 = call float @llvm.fmuladd.f32(float %584, float %581, float %mul8.i.i839)
  %arrayidx10.i.i840 = getelementptr inbounds [4 x float], ptr %transB, i64 0, i64 2
  %587 = load float, ptr %arrayidx10.i.i840, align 4, !tbaa !26
  %588 = call float @llvm.fmuladd.f32(float %587, float %583, float %586)
  %arrayidx.i.i842 = getelementptr inbounds [3 x %class.btVector3], ptr %transB, i64 0, i64 1
  %arrayidx5.i12.i843 = getelementptr inbounds [3 x %class.btVector3], ptr %transB, i64 0, i64 1, i32 0, i64 1
  %arrayidx10.i15.i845 = getelementptr inbounds [3 x %class.btVector3], ptr %transB, i64 0, i64 1, i32 0, i64 2
  %arrayidx.i17.i846 = getelementptr inbounds [3 x %class.btVector3], ptr %transB, i64 0, i64 2
  %arrayidx5.i18.i847 = getelementptr inbounds [3 x %class.btVector3], ptr %transB, i64 0, i64 2, i32 0, i64 1
  %arrayidx10.i21.i849 = getelementptr inbounds [3 x %class.btVector3], ptr %transB, i64 0, i64 2, i32 0, i64 2
  ...
  %610 = load <4 x float>, ptr %arrayidx.i.i842, align 4
  %611 = shufflevector <4 x float> %610, <4 x float> poison, <2 x i32> <i32 0, i32 poison>
  %612 = load <4 x float>, ptr %arrayidx5.i12.i843, align 4
  %613 = shufflevector <4 x float> %612, <4 x float> poison, <2 x i32> <i32 0, i32 poison>
  %614 = load <4 x float>, ptr %arrayidx10.i15.i845, align 4
  %615 = shufflevector <4 x float> %614, <4 x float> poison, <2 x i32> <i32 0, i32 poison>
  %616 = load float, ptr %arrayidx.i17.i846, align 4, !tbaa !26
  %617 = load float, ptr %arrayidx5.i18.i847, align 4, !tbaa !26
  ...
  %626 = load float, ptr %arrayidx10.i21.i849, align 4, !tbaa !26
  ...
  %mul8.i857 = fmul float %580, %631
  %632 = extractelement <2 x float> %609, i64 1
  %633 = call float @llvm.fmuladd.f32(float %588, float %632, float %mul8.i857)
  ...
  %638 = load <2 x float>, ptr %arrayidx7.i777, align 8, !tbaa !26
  ...
  %671 = load float, ptr %m_swingSpan2, align 8
  %cmp148 = fcmp olt float %671, %447
  %or.cond1186 = select i1 %cmp144, i1 %cmp148, i1 false
  br i1 %or.cond1186, label %if.then149, label %if.else162

if.then149:                                       ; preds = %if.else
  %672 = call <2 x float> @llvm.fabs.v2f32(<2 x float> %670)
  %673 = fcmp olt <2 x float> %672, <float 0x3E80000000000000, float 0x3E80000000000000>
  %674 = extractelement <2 x i1> %673, i64 0
  %675 = extractelement <2 x i1> %673, i64 1
  %or.cond1187 = select i1 %674, i1 %675, i1 false
  br i1 %or.cond1187, label %if.end272, label %if.then152

if.then152:                                       ; preds = %if.then149
  store i8 1, ptr %m_solveSwingLimit, align 2, !tbaa !29
  %676 = shufflevector <2 x float> %630, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %677 = insertelement <2 x float> %676, float %588, i64 1
  %678 = fneg <2 x float> %677
  %679 = fneg float %631
  %neg30.i877 = fmul float %632, %679
  %680 = call float @llvm.fmuladd.f32(float %588, float %580, float %neg30.i877)
  %681 = shufflevector <2 x float> %609, <2 x float> poison, <2 x i32> <i32 poison, i32 0>
  %682 = insertelement <2 x float> %681, float %580, i64 0
  %683 = fmul <2 x float> %682, %678
  %684 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %630, <2 x float> %609, <2 x float> %683)
  %685 = fneg <2 x float> %684
  %fneg8.i887 = fneg float %680
  %retval.sroa.3.12.vec.insert.i890 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %fneg8.i887, i64 0
  %m_swingAxis160 = getelementptr inbounds %class.btConeTwistConstraint, ptr %this, i64 0, i32 12
  store <2 x float> %685, ptr %m_swingAxis160, align 4, !tbaa.struct !22
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i890, ptr %ref.tmp154.sroa.4.0.m_swingAxis160.sroa_idx, align 4, !tbaa.struct !55
  br label %if.end272
...
if.then166:                                       ; preds = %if.else162
  %686 = extractelement <2 x float> %670, i64 0
  %687 = call float @llvm.fabs.f32(float %686)
  %cmp.i893 = fcmp olt float %687, 0x3E80000000000000
  %688 = extractelement <2 x float> %670, i64 1
  br i1 %cmp.i893, label %if.end225, label %if.then168

if.then168:                                       ; preds = %if.then166
  store i8 1, ptr %m_solveSwingLimit, align 2, !tbaa !29
  %cmp172 = fcmp ult float %671, %447
  br i1 %cmp172, label %if.end225, label %if.then173

if.then173:                                       ; preds = %if.then168
  %call.i = call float @atan2f(float noundef %688, float noundef %636) #19
  %689 = load float, ptr %m_swingSpan2, align 8, !tbaa !58
  %cmp176 = fcmp ogt float %call.i, %689
  br i1 %cmp176, label %if.then177, label %if.else182

if.then177:                                       ; preds = %if.then173
  %call.i894 = call float @cosf(float noundef %689) #19
  %690 = load float, ptr %m_swingSpan2, align 8, !tbaa !58
  %call.i895 = call float @sinf(float noundef %690) #19
  br label %if.end225
...
if.then185:                                       ; preds = %if.else182
  %call.i896 = call float @cosf(float noundef %689) #19
  %691 = load float, ptr %m_swingSpan2, align 8, !tbaa !58
  %call.i897 = call float @sinf(float noundef %691) #19
  %fneg190 = fneg float %call.i897
  br label %if.end225

if.else195:                                       ; preds = %if.else162
  %692 = extractelement <2 x float> %670, i64 1
  %693 = call float @llvm.fabs.f32(float %692)
  %cmp.i898 = fcmp olt float %693, 0x3E80000000000000
  %694 = extractelement <2 x float> %670, i64 0
  br i1 %cmp.i898, label %if.end225, label %if.then197
...
if.then202:                                       ; preds = %if.then197
  %call.i899 = call float @atan2f(float noundef %694, float noundef %636) #19
  %695 = load float, ptr %m_swingSpan1, align 4, !tbaa !38
  %cmp205 = fcmp ogt float %call.i899, %695
  br i1 %cmp205, label %if.then206, label %if.else211

if.then206:                                       ; preds = %if.then202
  %call.i900 = call float @cosf(float noundef %695) #19
  %696 = load float, ptr %m_swingSpan1, align 4, !tbaa !38
  %call.i901 = call float @sinf(float noundef %696) #19
  br label %if.end225

if.else211:                                       ; preds = %if.then202
  %fneg213 = fneg float %695
  %cmp214 = fcmp olt float %call.i899, %fneg213
  br i1 %cmp214, label %if.then215, label %if.end225

if.then215:                                       ; preds = %if.else211
  %call.i902 = call float @cosf(float noundef %695) #19
  %697 = load float, ptr %m_swingSpan1, align 4, !tbaa !38
  %call.i903 = call float @sinf(float noundef %697) #19
  %fneg220 = fneg float %call.i903
  br label %if.end225
...
if.end225:                                        ; preds = %if.then206, %if.then215, %if.else211, %if.then177, %if.then185, %if.else182, %if.else195, %if.then197, %if.then166, %if.then168
  %z.1 = phi float [ %688, %if.then166 ], [ %688, %if.then168 ], [ %692, %if.else195 ], [ %692, %if.then197 ], [ %call.i895, %if.then177 ], [ %fneg190, %if.then185 ], [ %688, %if.else182 ], [ 0.000000e+00, %if.else211 ], [ 0.000000e+00, %if.then215 ], [ 0.000000e+00, %if.then206 ]
  %y.1 = phi float [ %686, %if.then166 ], [ %686, %if.then168 ], [ %694, %if.else195 ], [ %694, %if.then197 ], [ 0.000000e+00, %if.then177 ], [ 0.000000e+00, %if.then185 ], [ 0.000000e+00, %if.else182 ], [ %694, %if.else211 ], [ %fneg220, %if.then215 ], [ %call.i901, %if.then206 ]
  %x.2 = phi float [ %636, %if.then166 ], [ %636, %if.then168 ], [ %636, %if.else195 ], [ %636, %if.then197 ], [ %call.i894, %if.then177 ], [ %call.i896, %if.then185 ], [ %636, %if.else182 ], [ %636, %if.else211 ], [ %call.i902, %if.then215 ], [ %call.i900, %if.then206 ]
  %698 = extractelement <2 x float> %648, i64 0
  %mul241 = fmul float %698, %y.1
  %699 = call float @llvm.fmuladd.f32(float %x.2, float %580, float %mul241)
  %700 = extractelement <2 x float> %648, i64 1
  %701 = call float @llvm.fmuladd.f32(float %z.1, float %700, float %699)
  %mul8.i.i.i.i905 = fmul float %701, %701
  %702 = fneg float %631
  ...
  %703 = shufflevector <2 x float> %663, <2 x float> %657, <2 x i32> <i32 0, i32 2>
  %704 = insertelement <2 x float> poison, float %y.1, i64 0
  %705 = shufflevector <2 x float> %704, <2 x float> poison, <2 x i32> zeroinitializer
  %706 = fmul <2 x float> %703, %705
  %707 = insertelement <2 x float> poison, float %x.2, i64 0
  %708 = shufflevector <2 x float> %707, <2 x float> poison, <2 x i32> zeroinitializer
  %709 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %708, <2 x float> %609, <2 x float> %706)
  %710 = insertelement <2 x float> poison, float %z.1, i64 0
  %711 = shufflevector <2 x float> %710, <2 x float> poison, <2 x i32> zeroinitializer
  %712 = shufflevector <2 x float> %663, <2 x float> %657, <2 x i32> <i32 1, i32 3>
  %713 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %711, <2 x float> %712, <2 x float> %709)
  %714 = extractelement <2 x float> %713, i64 1
  %715 = call float @llvm.fmuladd.f32(float %714, float %714, float %mul8.i.i.i.i905)
  %716 = extractelement <2 x float> %713, i64 0
  %717 = call float @llvm.fmuladd.f32(float %716, float %716, float %715)
  %sqrt.i.i907 = call float @llvm.sqrt.f32(float %717)
  %div.i.i908 = fdiv float 1.000000e+00, %sqrt.i.i907
  %mul4.i.i.i910 = fmul float %701, %div.i.i908
  %718 = insertelement <2 x float> poison, float %div.i.i908, i64 0
  %719 = shufflevector <2 x float> %718, <2 x float> poison, <2 x i32> zeroinitializer
  %720 = fmul <2 x float> %713, %719
  %721 = insertelement <2 x float> %630, float %588, i64 0
  %722 = fneg <2 x float> %721
  %723 = insertelement <2 x float> %720, float %mul4.i.i.i910, i64 1
  %724 = fmul <2 x float> %723, %722
  %725 = shufflevector <2 x float> %724, <2 x float> poison, <2 x i32> <i32 1, i32 0>
  %726 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %630, <2 x float> %720, <2 x float> %725)
  %727 = extractelement <2 x float> %720, i64 1
  %neg30.i918 = fmul float %727, %702
  %728 = call float @llvm.fmuladd.f32(float %588, float %mul4.i.i.i910, float %neg30.i918)
  %729 = fneg <2 x float> %726
  %fneg8.i928 = fneg float %728
  %retval.sroa.3.12.vec.insert.i931 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %fneg8.i928, i64 0
  store <2 x float> %retval.sroa.3.12.vec.insert.i931, ptr %ref.tmp259.sroa.4.0.m_swingAxis265.sroa_idx, align 4, !tbaa.struct !55
  %730 = fmul <2 x float> %726, %726
  %mul8.i.i.i934 = extractelement <2 x float> %730, i64 1
  %731 = extractelement <2 x float> %726, i64 0
  %732 = call float @llvm.fmuladd.f32(float %731, float %731, float %mul8.i.i.i934)
  %733 = call float @llvm.fmuladd.f32(float %728, float %728, float %732)
  %sqrt.i = call float @llvm.sqrt.f32(float %733)
  store float %sqrt.i, ptr %m_swingCorrection, align 8, !tbaa !57
  %div.i.i939 = fdiv float 1.000000e+00, %sqrt.i
  %734 = insertelement <2 x float> poison, float %div.i.i939, i64 0
  %735 = shufflevector <2 x float> %734, <2 x float> poison, <2 x i32> zeroinitializer
  %736 = fmul <2 x float> %735, %729
  store <2 x float> %736, ptr %m_swingAxis265, align 4, !tbaa !26
  %mul7.i.i.i942 = fmul float %div.i.i939, %fneg8.i928
  store float %mul7.i.i.i942, ptr %ref.tmp259.sroa.4.0.m_swingAxis265.sroa_idx, align 4, !tbaa !26
  br label %if.end272

if.end272:                                        ; preds = %if.end225, %if.then152, %if.then149, %_ZN21btConeTwistConstraint20computeConeLimitInfoERK12btQuaternionRfR9btVector3S3_.exit, %_ZNK21btConeTwistConstraint33adjustSwingAxisToUseEllipseNormalER9btVector3.exit
  %m_twistSpan = getelementptr inbounds %class.btConeTwistConstraint, ptr %this, i64 0, i32 10
  %737 = load float, ptr %m_twistSpan, align 4, !tbaa !62
  %cmp273 = fcmp ult float %737, 0.000000e+00
...
if.then274:                                       ; preds = %if.end272
  %738 = extractelement <2 x float> %445, i64 1
  %call.i.i.i943 = call float @acosf(float noundef %738) #19
  %mul.i.i944 = fmul float %call.i.i.i943, 2.000000e+00
  store float %mul.i.i944, ptr %m_twistAngle332, align 8, !tbaa !26
  %cmp.i945 = fcmp ogt float %mul.i.i944, 0x400921FB60000000
  br i1 %cmp.i945, label %if.then.i952, label %if.end.i953

if.then.i952:                                     ; preds = %if.then274
  %739 = fneg <2 x float> %444
  %740 = fneg <2 x float> %445
  %741 = extractelement <2 x float> %740, i64 1
  %call.i.i24.i = call float @acosf(float noundef %741) #19
  %mul.i25.i = fmul float %call.i.i24.i, 2.000000e+00
  store float %mul.i25.i, ptr %m_twistAngle332, align 8, !tbaa !26
  br label %if.end.i953

if.end.i953:                                      ; preds = %if.then.i952, %if.then274
  %742 = phi float [ %mul.i25.i, %if.then.i952 ], [ %mul.i.i944, %if.then274 ]
  %qMinTwist.sroa.0.0.i = phi <2 x float> [ %739, %if.then.i952 ], [ %444, %if.then274 ]
  %qMinTwist.sroa.6.0.i = phi <2 x float> [ %740, %if.then.i952 ], [ %445, %if.then274 ]
...
if.then13.i:                                      ; preds = %if.end.i953
  %743 = fmul <2 x float> %qMinTwist.sroa.0.0.i, %qMinTwist.sroa.0.0.i
  %mul8.i.i.i.i.i954 = extractelement <2 x float> %743, i64 1
  %744 = extractelement <2 x float> %qMinTwist.sroa.0.0.i, i64 0
  %745 = call float @llvm.fmuladd.f32(float %744, float %744, float %mul8.i.i.i.i.i954)
  %746 = call float @llvm.fmuladd.f32(float %qMinTwist.sroa.6.8.vec.extract.i, float %qMinTwist.sroa.6.8.vec.extract.i, float %745)
  %sqrt.i.i.i955 = call float @llvm.sqrt.f32(float %746)
  %div.i.i.i956 = fdiv float 1.000000e+00, %sqrt.i.i.i955
  %747 = insertelement <2 x float> poison, float %div.i.i.i956, i64 0
  %748 = shufflevector <2 x float> %747, <2 x float> poison, <2 x i32> zeroinitializer
  %749 = fmul <2 x float> %qMinTwist.sroa.0.0.i, %748
  %mul7.i.i.i.i959 = fmul float %qMinTwist.sroa.6.8.vec.extract.i, %div.i.i.i956
  br label %_ZN21btConeTwistConstraint21computeTwistLimitInfoERK12btQuaternionRfR9btVector3.exit

_ZN21btConeTwistConstraint21computeTwistLimitInfoERK12btQuaternionRfR9btVector3.exit: ; preds = %if.end.i953, %if.then13.i
  %twistAxis.sroa.10.0 = phi float [ %mul7.i.i.i.i959, %if.then13.i ], [ %qMinTwist.sroa.6.8.vec.extract.i, %if.end.i953 ]
  %750 = phi <2 x float> [ %749, %if.then13.i ], [ %qMinTwist.sroa.0.0.i, %if.end.i953 ]
  %751 = load float, ptr %m_twistSpan, align 4, !tbaa !62
  %m_limitSoftness277 = getelementptr inbounds %class.btConeTwistConstraint, ptr %this, i64 0, i32 4
  %752 = load float, ptr %m_limitSoftness277, align 4, !tbaa !59
  %mul278 = fmul float %751, %752
  %cmp279 = fcmp ogt float %742, %mul278
...
if.then280:                                       ; preds = %_ZN21btConeTwistConstraint21computeTwistLimitInfoERK12btQuaternionRfR9btVector3.exit
  ...
  %cmp284 = fcmp olt float %742, %751
  %cmp287 = fcmp olt float %752, 0x3FEFFFFFC0000000
  %or.cond1188 = and i1 %cmp284, %cmp287
  %neg293 = fneg float %751
  %753 = call float @llvm.fmuladd.f32(float %neg293, float %752, float %742)
  %754 = call float @llvm.fmuladd.f32(float %neg293, float %752, float %751)
  %div299 = fdiv float %753, %754
  ...
  store float %753, ptr %m_twistCorrection, align 4, !tbaa !64
  %755 = shufflevector <2 x float> %750, <2 x float> poison, <2 x i32> <i32 1, i32 0>
  %756 = extractelement <2 x float> %750, i64 1
  %fneg4.i962 = fneg float %756
  %neg31.i.i981 = fmul float %322, %756
  %757 = extractelement <2 x float> %750, i64 0
  %758 = call float @llvm.fmuladd.f32(float %304, float %757, float %neg31.i.i981)
  %759 = call float @llvm.fmuladd.f32(float %347, float %twistAxis.sroa.10.0, float %758)
  %760 = insertelement <2 x float> %750, float %twistAxis.sroa.10.0, i64 1
  %761 = fneg <2 x float> %760
  %762 = fmul <2 x float> %316, %761
  %mul12.i.i977 = extractelement <2 x float> %762, i64 0
  %763 = call float @llvm.fmuladd.f32(float %321, float %fneg4.i962, float %mul12.i.i977)
  %764 = call float @llvm.fmuladd.f32(float %304, float %twistAxis.sroa.10.0, float %763)
  %765 = shufflevector <2 x float> %316, <2 x float> %324, <2 x i32> <i32 1, i32 2>
  %766 = shufflevector <2 x float> %761, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %767 = insertelement <2 x float> %766, float %fneg4.i962, i64 1
  %768 = fmul <2 x float> %765, %767
  %769 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %336, <2 x float> %761, <2 x float> %768)
  %770 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %316, <2 x float> %755, <2 x float> %769)
  %771 = shufflevector <2 x float> %770, <2 x float> poison, <2 x i32> <i32 poison, i32 0>
  %772 = insertelement <2 x float> %771, float %764, i64 0
  %773 = fmul <2 x float> %336, %772
  %774 = insertelement <2 x float> poison, float %759, i64 0
  %775 = shufflevector <2 x float> %774, <2 x float> poison, <2 x i32> zeroinitializer
  %776 = shufflevector <2 x float> %325, <2 x float> poison, <2 x i32> <i32 poison, i32 0>
  %777 = insertelement <2 x float> %776, float %fneg5.i, i64 0
  %778 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %775, <2 x float> %777, <2 x float> %773)
  %779 = shufflevector <2 x float> %770, <2 x float> %772, <2 x i32> <i32 1, i32 2>
  %780 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %779, <2 x float> %325, <2 x float> %778)
  %781 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %770, <2 x float> %316, <2 x float> %780)
  %782 = extractelement <2 x float> %770, i64 1
  %mul37.i.i984 = fmul float %321, %782
  %783 = call float @llvm.fmuladd.f32(float %759, float %328, float %mul37.i.i984)
  %784 = extractelement <2 x float> %770, i64 0
  %785 = call float @llvm.fmuladd.f32(float %784, float %fneg5.i, float %783)
  %786 = call float @llvm.fmuladd.f32(float %764, float %304, float %785)
  %787 = shufflevector <2 x float> %781, <2 x float> poison, <2 x i32> <i32 1, i32 0>
  %retval.sroa.3.12.vec.insert.i987 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %786, i64 0
  %m_twistAxis = getelementptr inbounds %class.btConeTwistConstraint, ptr %this, i64 0, i32 13
  store <2 x float> %787, ptr %m_twistAxis, align 4, !tbaa.struct !22
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i987, ptr %ref.tmp307.sroa.4.0.m_twistAxis.sroa_idx, align 4, !tbaa.struct !55
  %788 = load float, ptr %invInertiaWorldA, align 4, !tbaa !26
  %arrayidx4.i.i.i990 = getelementptr inbounds [3 x %class.btVector3], ptr %invInertiaWorldA, i64 0, i64 1
  %789 = load float, ptr %arrayidx4.i.i.i990, align 4, !tbaa !26
  %790 = extractelement <2 x float> %781, i64 0
  %mul7.i.i.i992 = fmul float %789, %790
  %791 = extractelement <2 x float> %781, i64 1
  %792 = call float @llvm.fmuladd.f32(float %788, float %791, float %mul7.i.i.i992)
  %arrayidx9.i.i.i993 = getelementptr inbounds [3 x %class.btVector3], ptr %invInertiaWorldA, i64 0, i64 2
  %793 = load float, ptr %arrayidx9.i.i.i993, align 4, !tbaa !26
  %794 = call float @llvm.fmuladd.f32(float %793, float %786, float %792)
  %arrayidx.i.i9.i.i995 = getelementptr inbounds [4 x float], ptr %invInertiaWorldA, i64 0, i64 1
  %795 = load float, ptr %arrayidx.i.i9.i.i995, align 4, !tbaa !26
  %arrayidx.i14.i10.i.i996 = getelementptr inbounds [3 x %class.btVector3], ptr %invInertiaWorldA, i64 0, i64 1, i32 0, i64 1
  %796 = load float, ptr %arrayidx.i14.i10.i.i996, align 4, !tbaa !26
  %mul7.i11.i.i997 = fmul float %790, %796
  %797 = call float @llvm.fmuladd.f32(float %795, float %791, float %mul7.i11.i.i997)
  %arrayidx.i16.i.i.i998 = getelementptr inbounds [3 x %class.btVector3], ptr %invInertiaWorldA, i64 0, i64 2, i32 0, i64 1
  %798 = load float, ptr %arrayidx.i16.i.i.i998, align 4, !tbaa !26
  %799 = call float @llvm.fmuladd.f32(float %798, float %786, float %797)
  %arrayidx.i.i12.i.i999 = getelementptr inbounds [4 x float], ptr %invInertiaWorldA, i64 0, i64 2
  %800 = load float, ptr %arrayidx.i.i12.i.i999, align 4, !tbaa !26
  %arrayidx.i14.i13.i.i1000 = getelementptr inbounds [3 x %class.btVector3], ptr %invInertiaWorldA, i64 0, i64 1, i32 0, i64 2
  %801 = load float, ptr %arrayidx.i14.i13.i.i1000, align 4, !tbaa !26
  %mul7.i15.i.i1001 = fmul float %790, %801
  %802 = call float @llvm.fmuladd.f32(float %800, float %791, float %mul7.i15.i.i1001)
  %arrayidx.i16.i16.i.i1002 = getelementptr inbounds [3 x %class.btVector3], ptr %invInertiaWorldA, i64 0, i64 2, i32 0, i64 2
  %803 = load float, ptr %arrayidx.i16.i16.i.i1002, align 4, !tbaa !26
  %804 = call float @llvm.fmuladd.f32(float %803, float %786, float %802)
  %mul8.i.i1003 = fmul float %790, %799
  %805 = call float @llvm.fmuladd.f32(float %791, float %794, float %mul8.i.i1003)
  %806 = call float @llvm.fmuladd.f32(float %786, float %804, float %805)
  %807 = load float, ptr %invInertiaWorldB, align 4, !tbaa !26
  %arrayidx4.i.i.i1004 = getelementptr inbounds [3 x %class.btVector3], ptr %invInertiaWorldB, i64 0, i64 1
  %808 = load float, ptr %arrayidx4.i.i.i1004, align 4, !tbaa !26
  %mul7.i.i.i1006 = fmul float %790, %808
  %809 = call float @llvm.fmuladd.f32(float %807, float %791, float %mul7.i.i.i1006)
  %arrayidx9.i.i.i1007 = getelementptr inbounds [3 x %class.btVector3], ptr %invInertiaWorldB, i64 0, i64 2
  %810 = load float, ptr %arrayidx9.i.i.i1007, align 4, !tbaa !26
  %811 = call float @llvm.fmuladd.f32(float %810, float %786, float %809)
  %arrayidx.i.i9.i.i1009 = getelementptr inbounds [4 x float], ptr %invInertiaWorldB, i64 0, i64 1
  %812 = load float, ptr %arrayidx.i.i9.i.i1009, align 4, !tbaa !26
  %arrayidx.i14.i10.i.i1010 = getelementptr inbounds [3 x %class.btVector3], ptr %invInertiaWorldB, i64 0, i64 1, i32 0, i64 1
  %813 = load float, ptr %arrayidx.i14.i10.i.i1010, align 4, !tbaa !26
  %mul7.i11.i.i1011 = fmul float %790, %813
  %814 = call float @llvm.fmuladd.f32(float %812, float %791, float %mul7.i11.i.i1011)
  %arrayidx.i16.i.i.i1012 = getelementptr inbounds [3 x %class.btVector3], ptr %invInertiaWorldB, i64 0, i64 2, i32 0, i64 1
  %815 = load float, ptr %arrayidx.i16.i.i.i1012, align 4, !tbaa !26
  %816 = call float @llvm.fmuladd.f32(float %815, float %786, float %814)
  %arrayidx.i.i12.i.i1013 = getelementptr inbounds [4 x float], ptr %invInertiaWorldB, i64 0, i64 2
  %817 = load float, ptr %arrayidx.i.i12.i.i1013, align 4, !tbaa !26
  %arrayidx.i14.i13.i.i1014 = getelementptr inbounds [3 x %class.btVector3], ptr %invInertiaWorldB, i64 0, i64 1, i32 0, i64 2
  %818 = load float, ptr %arrayidx.i14.i13.i.i1014, align 4, !tbaa !26
  %mul7.i15.i.i1015 = fmul float %790, %818
  %819 = call float @llvm.fmuladd.f32(float %817, float %791, float %mul7.i15.i.i1015)
  %arrayidx.i16.i16.i.i1016 = getelementptr inbounds [3 x %class.btVector3], ptr %invInertiaWorldB, i64 0, i64 2, i32 0, i64 2
  %820 = load float, ptr %arrayidx.i16.i16.i.i1016, align 4, !tbaa !26
  %821 = call float @llvm.fmuladd.f32(float %820, float %786, float %819)
  %mul8.i.i1017 = fmul float %790, %816
  %822 = call float @llvm.fmuladd.f32(float %791, float %811, float %mul8.i.i1017)
  %823 = call float @llvm.fmuladd.f32(float %786, float %821, float %822)
  %add317 = fadd float %806, %823
...
if.end319:                                        ; preds = %if.then280, %_ZN21btConeTwistConstraint21computeTwistLimitInfoERK12btQuaternionRfR9btVector3.exit
  %824 = load i8, ptr %m_solveSwingLimit, align 2, !tbaa !29, !range !31, !noundef !32
  %tobool321.not = icmp eq i8 %824, 0
  br i1 %tobool321.not, label %return, label %if.then322

if.then322:                                       ; preds = %if.end319
  %825 = shufflevector <2 x float> %750, <2 x float> poison, <2 x i32> <i32 poison, i32 0>
  %826 = insertelement <2 x float> %825, float %twistAxis.sroa.10.0, i64 0
  %827 = fneg <2 x float> %826
  %828 = extractelement <2 x float> %750, i64 1
  %fneg4.i1020 = fneg float %828
  %829 = shufflevector <2 x float> %291, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %830 = insertelement <2 x float> %829, float %279, i64 1
  %831 = fneg <2 x float> %830
  %832 = fmul <2 x float> %291, %827
  %mul12.i.i1035 = extractelement <2 x float> %832, i64 1
  %833 = call float @llvm.fmuladd.f32(float %296, float %fneg4.i1020, float %mul12.i.i1035)
  %834 = call float @llvm.fmuladd.f32(float %279, float %twistAxis.sroa.10.0, float %833)
  %neg24.i.i1038 = fneg float %326
  %neg31.i.i1039 = fmul float %326, %828
  %835 = extractelement <2 x float> %750, i64 0
  %836 = call float @llvm.fmuladd.f32(float %279, float %835, float %neg31.i.i1039)
  %837 = call float @llvm.fmuladd.f32(float %330, float %twistAxis.sroa.10.0, float %836)
  %838 = shufflevector <2 x float> %830, <2 x float> %291, <2 x i32> <i32 1, i32 2>
  %839 = shufflevector <2 x float> %827, <2 x float> poison, <2 x i32> <i32 poison, i32 0>
  %840 = insertelement <2 x float> %839, float %fneg4.i1020, i64 0
  %841 = fmul <2 x float> %838, %840
  %842 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %333, <2 x float> %827, <2 x float> %841)
  %843 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %291, <2 x float> %750, <2 x float> %842)
  ...
  %850 = insertelement <2 x float> %849, float %neg24.i.i1038, i64 1
  ...
  %854 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %843, <2 x float> %291, <2 x float> %853)
  %855 = extractelement <2 x float> %843, i64 0
  %mul37.i.i1042 = fmul float %296, %855
  %856 = extractelement <2 x float> %831, i64 0
  %857 = call float @llvm.fmuladd.f32(float %837, float %856, float %mul37.i.i1042)
  %858 = extractelement <2 x float> %843, i64 1
  %859 = call float @llvm.fmuladd.f32(float %858, float %neg24.i.i1038, float %857)
  %860 = call float @llvm.fmuladd.f32(float %834, float %279, float %859)
  %retval.sroa.3.12.vec.insert.i1045 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %860, i64 0
  %m_twistAxisA329 = getelementptr inbounds %class.btConeTwistConstraint, ptr %this, i64 0, i32 28
  store <2 x float> %854, ptr %m_twistAxisA329, align 8, !tbaa.struct !22
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i1045, ptr %ref.tmp323.sroa.4.0.m_twistAxisA329.sroa_idx, align 8, !tbaa.struct !55
  br label %return
...
if.end97:                                         ; preds = %if.then91, %if.end88
  ...
  %axisA.sroa.0.0.vec.extract1966 = extractelement <2 x float> %axisA.sroa.0.0, i64 0
  %mul.i.i982 = fmul float %kAxisAInv.0, %axisA.sroa.0.0.vec.extract1966
  %axisA.sroa.0.4.vec.extract1968 = extractelement <2 x float> %axisA.sroa.0.0, i64 1
  %mul4.i.i984 = fmul float %kAxisAInv.0, %axisA.sroa.0.4.vec.extract1968
  %axisA.sroa.7.8.vec.extract1970 = extractelement <2 x float> %axisA.sroa.7.0, i64 0
  %mul8.i.i986 = fmul float %kAxisAInv.0, %axisA.sroa.7.8.vec.extract1970
  %axisB.sroa.0.0.vec.extract1960 = extractelement <2 x float> %axisB.sroa.0.0, i64 0
  %mul.i.i992 = fmul float %kAxisBInv.0, %axisB.sroa.0.0.vec.extract1960
  %axisB.sroa.0.4.vec.extract1962 = extractelement <2 x float> %axisB.sroa.0.0, i64 1
  %mul4.i.i994 = fmul float %kAxisBInv.0, %axisB.sroa.0.4.vec.extract1962
  %axisB.sroa.7.8.vec.extract1964 = extractelement <2 x float> %axisB.sroa.7.0, i64 0
  %mul8.i.i996 = fmul float %kAxisBInv.0, %axisB.sroa.7.8.vec.extract1964
...
if.then109:                                       ; preds = %if.end97
  ...
  %shift2047 = shufflevector <2 x float> %697, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %703 = fsub <2 x float> %697, %shift2047
...
if.end148:                                        ; preds = %if.then141, %if.then131
  ...
  %impulse116.sroa.12.8.vec.extract1929 = extractelement <2 x float> %impulse116.sroa.12.0, i64 0
  %add13.i = fadd float %716, %impulse116.sroa.12.8.vec.extract1929
  ...
  %.pre2036 = load float, ptr %arrayidx.i.i9.i.i1029, align 4, !tbaa !26
  %.pre2037 = load float, ptr %arrayidx.i.i12.i.i1033, align 4, !tbaa !26
  %.pre2038 = load float, ptr %arrayidx4.i.i.i1024, align 4, !tbaa !26
  %.pre2039 = load float, ptr %arrayidx.i14.i10.i.i1030, align 4, !tbaa !26
  %.pre2040 = load float, ptr %arrayidx.i14.i13.i.i1034, align 4, !tbaa !26
  %.pre2041 = load float, ptr %arrayidx9.i.i.i1027, align 4, !tbaa !26
  %.pre2042 = load float, ptr %arrayidx.i16.i.i.i1032, align 4, !tbaa !26
  %.pre2043 = load float, ptr %arrayidx.i16.i16.i.i1036, align 4, !tbaa !26
  %729 = insertelement <2 x float> poison, float %.pre2037, i64 0
  %730 = insertelement <2 x float> %729, float %.pre2040, i64 1
  %731 = insertelement <2 x float> poison, float %.pre, i64 0
  %732 = insertelement <2 x float> %731, float %.pre2038, i64 1
  %733 = insertelement <2 x float> poison, float %.pre2036, i64 0
  %734 = insertelement <2 x float> %733, float %.pre2039, i64 1
  br label %if.end151

if.end151:                                        ; preds = %if.then109, %if.end148
  %impulse116.sroa.12.8.vec.extract1931.pre-phi = phi float [ %impulse116.sroa.12.8.vec.extract1929, %if.end148 ], [ %mul8.i.i1090, %if.then109 ]
  %735 = phi float [ %.pre2043, %if.end148 ], [ %650, %if.then109 ]
  %736 = phi float [ %.pre2042, %if.end148 ], [ %643, %if.then109 ]
  %737 = phi float [ %.pre2041, %if.end148 ], [ %642, %if.then109 ]
  ...
  %745 = call float @llvm.fmuladd.f32(float %impulse116.sroa.12.8.vec.extract1931.pre-phi, float %impulse116.sroa.12.8.vec.extract1931.pre-phi, float %744)
  ...
  %mul8.i.i1149 = fmul float %impulse116.sroa.12.8.vec.extract1931.pre-phi, %div.i1144
...
if.then181:                                       ; preds = %_ZNK12btSolverBody18getAngularVelocityER9btVector3.exit1288
  ...
  %823 = load ptr, ptr %m_rbA, align 8, !tbaa !36
  %m_invInertiaTensorWorld.i.i1318 = getelementptr inbounds %class.btRigidBody, ptr %823, i64 0, i32 1
  %arrayidx4.i.i.i1319 = getelementptr inbounds %class.btRigidBody, ptr %823, i64 0, i32 1, i32 0, i64 1
  %arrayidx9.i.i.i1322 = getelementptr inbounds %class.btRigidBody, ptr %823, i64 0, i32 1, i32 0, i64 2
  %arrayidx.i.i9.i.i1324 = getelementptr inbounds %class.btRigidBody, ptr %823, i64 0, i32 1, i32 0, i64 0, i32 0, i64 1
  %arrayidx.i14.i10.i.i1325 = getelementptr inbounds %class.btRigidBody, ptr %823, i64 0, i32 1, i32 0, i64 1, i32 0, i64 1
  %arrayidx.i16.i.i.i1327 = getelementptr inbounds %class.btRigidBody, ptr %823, i64 0, i32 1, i32 0, i64 2, i32 0, i64 1
  %arrayidx.i.i12.i.i1328 = getelementptr inbounds %class.btRigidBody, ptr %823, i64 0, i32 1, i32 0, i64 0, i32 0, i64 2
  %arrayidx.i14.i13.i.i1329 = getelementptr inbounds %class.btRigidBody, ptr %823, i64 0, i32 1, i32 0, i64 1, i32 0, i64 2
  %arrayidx.i16.i16.i.i1331 = getelementptr inbounds %class.btRigidBody, ptr %823, i64 0, i32 1, i32 0, i64 2, i32 0, i64 2
  %824 = load ptr, ptr %m_rbB, align 8, !tbaa !37
  %m_invInertiaTensorWorld.i.i1334 = getelementptr inbounds %class.btRigidBody, ptr %824, i64 0, i32 1
  %arrayidx4.i.i.i1335 = getelementptr inbounds %class.btRigidBody, ptr %824, i64 0, i32 1, i32 0, i64 1
  %arrayidx9.i.i.i1338 = getelementptr inbounds %class.btRigidBody, ptr %824, i64 0, i32 1, i32 0, i64 2
  %arrayidx.i.i9.i.i1340 = getelementptr inbounds %class.btRigidBody, ptr %824, i64 0, i32 1, i32 0, i64 0, i32 0, i64 1
  %arrayidx.i14.i10.i.i1341 = getelementptr inbounds %class.btRigidBody, ptr %824, i64 0, i32 1, i32 0, i64 1, i32 0, i64 1
  %arrayidx.i16.i.i.i1343 = getelementptr inbounds %class.btRigidBody, ptr %824, i64 0, i32 1, i32 0, i64 2, i32 0, i64 1
  %arrayidx.i.i12.i.i1344 = getelementptr inbounds %class.btRigidBody, ptr %824, i64 0, i32 1, i32 0, i64 0, i32 0, i64 2
  %arrayidx.i14.i13.i.i1345 = getelementptr inbounds %class.btRigidBody, ptr %824, i64 0, i32 1, i32 0, i64 1, i32 0, i64 2
  %arrayidx.i16.i16.i.i1347 = getelementptr inbounds %class.btRigidBody, ptr %824, i64 0, i32 1, i32 0, i64 2, i32 0, i64 2
  %825 = load float, ptr %m_invInertiaTensorWorld.i.i1318, align 8, !tbaa !26
  %826 = load float, ptr %arrayidx4.i.i.i1319, align 8, !tbaa !26
  %827 = load float, ptr %arrayidx9.i.i.i1322, align 8, !tbaa !26
  %828 = load float, ptr %arrayidx.i.i9.i.i1324, align 4, !tbaa !26
  %829 = load float, ptr %arrayidx.i14.i10.i.i1325, align 4, !tbaa !26
  %830 = load float, ptr %arrayidx.i16.i.i.i1327, align 4, !tbaa !26
  %831 = load float, ptr %arrayidx.i.i12.i.i1328, align 8, !tbaa !26
  %832 = load float, ptr %arrayidx.i14.i13.i.i1329, align 8, !tbaa !26
  %833 = load float, ptr %arrayidx.i16.i16.i.i1331, align 8, !tbaa !26
  %834 = load float, ptr %m_invInertiaTensorWorld.i.i1334, align 8, !tbaa !26
  %835 = load float, ptr %arrayidx4.i.i.i1335, align 8, !tbaa !26
  %836 = insertelement <2 x float> poison, float %mul4.i.i.i1310, i64 0
  %837 = shufflevector <2 x float> %836, <2 x float> poison, <2 x i32> zeroinitializer
  %838 = insertelement <2 x float> poison, float %826, i64 0
  %839 = insertelement <2 x float> %838, float %835, i64 1
  %840 = fmul <2 x float> %837, %839
  %841 = insertelement <2 x float> poison, float %825, i64 0
  %842 = insertelement <2 x float> %841, float %834, i64 1
  %843 = insertelement <2 x float> poison, float %mul.i.i.i1309, i64 0
  %844 = shufflevector <2 x float> %843, <2 x float> poison, <2 x i32> zeroinitializer
  %845 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %842, <2 x float> %844, <2 x float> %840)
  %846 = load float, ptr %arrayidx9.i.i.i1338, align 8, !tbaa !26
  %847 = insertelement <2 x float> poison, float %827, i64 0
  %848 = insertelement <2 x float> %847, float %846, i64 1
  %849 = insertelement <2 x float> poison, float %mul8.i.i.i1311, i64 0
  %850 = shufflevector <2 x float> %849, <2 x float> poison, <2 x i32> zeroinitializer
  %851 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %848, <2 x float> %850, <2 x float> %845)
  %852 = load float, ptr %arrayidx.i.i9.i.i1340, align 4, !tbaa !26
  %853 = load float, ptr %arrayidx.i14.i10.i.i1341, align 4, !tbaa !26
  %854 = insertelement <2 x float> poison, float %829, i64 0
  %855 = insertelement <2 x float> %854, float %853, i64 1
  %856 = fmul <2 x float> %837, %855
  %857 = insertelement <2 x float> poison, float %828, i64 0
  %858 = insertelement <2 x float> %857, float %852, i64 1
  %859 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %858, <2 x float> %844, <2 x float> %856)
  %860 = load float, ptr %arrayidx.i16.i.i.i1343, align 4, !tbaa !26
  %861 = insertelement <2 x float> poison, float %830, i64 0
  %862 = insertelement <2 x float> %861, float %860, i64 1
  %863 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %862, <2 x float> %850, <2 x float> %859)
  %864 = load float, ptr %arrayidx.i.i12.i.i1344, align 8, !tbaa !26
  %865 = load float, ptr %arrayidx.i14.i13.i.i1345, align 8, !tbaa !26
  %866 = insertelement <2 x float> poison, float %832, i64 0
  %867 = insertelement <2 x float> %866, float %865, i64 1
  %868 = fmul <2 x float> %837, %867
  %869 = insertelement <2 x float> poison, float %831, i64 0
  %870 = insertelement <2 x float> %869, float %864, i64 1
  %871 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %870, <2 x float> %844, <2 x float> %868)
  %872 = load float, ptr %arrayidx.i16.i16.i.i1347, align 8, !tbaa !26
  %873 = insertelement <2 x float> poison, float %833, i64 0
  %874 = insertelement <2 x float> %873, float %872, i64 1
  %875 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %874, <2 x float> %850, <2 x float> %871)
  %876 = fmul <2 x float> %837, %863
  %877 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %844, <2 x float> %851, <2 x float> %876)
  %878 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %850, <2 x float> %875, <2 x float> %877)
  %shift2048 = shufflevector <2 x float> %878, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %879 = fadd <2 x float> %878, %shift2048
  %add188 = extractelement <2 x float> %879, i64 0
  ...
  %880 = tail call float @llvm.fmuladd.f32(float %mul.i.i1349, float %mul.i.i1349, float %mul8.i.i.i1360)
  %881 = tail call float @llvm.fmuladd.f32(float %mul8.i.i1353, float %mul8.i.i1353, float %880)
  %sqrt.i1362 = tail call float @llvm.sqrt.f32(float %881)
  ...
  %m_invInertiaTensorWorld.i1377 = getelementptr inbounds %class.btRigidBody, ptr %1, i64 0, i32 1
  %arrayidx5.i.i1378 = getelementptr inbounds %class.btRigidBody, ptr %1, i64 0, i32 1, i32 0, i64 0, i32 0, i64 1
  %arrayidx10.i.i1381 = getelementptr inbounds %class.btRigidBody, ptr %1, i64 0, i32 1, i32 0, i64 0, i32 0, i64 2
  %arrayidx.i.i1383 = getelementptr inbounds %class.btRigidBody, ptr %1, i64 0, i32 1, i32 0, i64 1
  %arrayidx5.i12.i1384 = getelementptr inbounds %class.btRigidBody, ptr %1, i64 0, i32 1, i32 0, i64 1, i32 0, i64 1
  %arrayidx10.i15.i1386 = getelementptr inbounds %class.btRigidBody, ptr %1, i64 0, i32 1, i32 0, i64 1, i32 0, i64 2
  %arrayidx.i17.i1387 = getelementptr inbounds %class.btRigidBody, ptr %1, i64 0, i32 1, i32 0, i64 2
  %882 = load float, ptr %arrayidx.i17.i1387, align 4, !tbaa !26
  %arrayidx5.i18.i1388 = getelementptr inbounds %class.btRigidBody, ptr %1, i64 0, i32 1, i32 0, i64 2, i32 0, i64 1
  %883 = load float, ptr %arrayidx5.i18.i1388, align 4, !tbaa !26
  %mul8.i20.i1389 = fmul float %883, %mul4.i.i1366
  %884 = tail call float @llvm.fmuladd.f32(float %882, float %mul.i.i1364, float %mul8.i20.i1389)
  %arrayidx10.i21.i1390 = getelementptr inbounds %class.btRigidBody, ptr %1, i64 0, i32 1, i32 0, i64 2, i32 0, i64 2
  %885 = load float, ptr %arrayidx10.i21.i1390, align 4, !tbaa !26
  %886 = tail call float @llvm.fmuladd.f32(float %885, float %mul8.i.i1368, float %884)
  %mul.i.i1396 = fmul float %sqrt.i1362, 0.000000e+00
  %887 = load <2 x float>, ptr %bodyA, align 8, !tbaa !26
  %888 = insertelement <2 x float> poison, float %mul.i.i1396, i64 0
  %889 = shufflevector <2 x float> %888, <2 x float> poison, <2 x i32> zeroinitializer
  %890 = fadd <2 x float> %887, %889
  %arrayidx12.i.i1404 = getelementptr inbounds [4 x float], ptr %bodyA, i64 0, i64 2
  %891 = load float, ptr %arrayidx12.i.i1404, align 8, !tbaa !26
  %add13.i.i1405 = fadd float %mul.i.i1396, %891
  ...
  %892 = load float, ptr %arrayidx7.i.i.i1410, align 8, !tbaa !26
  %mul8.i.i.i1411 = fmul float %sqrt.i1362, %892
  %mul14.i.i1416 = fmul float %886, %mul8.i.i.i1411
  %m_deltaAngularVelocity.i1417 = getelementptr inbounds %struct.btSolverBody, ptr %bodyA, i64 0, i32 1
  %893 = load float, ptr %m_invInertiaTensorWorld.i1377, align 4, !tbaa !26
  %894 = load float, ptr %arrayidx5.i.i1378, align 4, !tbaa !26
  %895 = load float, ptr %arrayidx10.i.i1381, align 4, !tbaa !26
  %896 = load float, ptr %arrayidx.i.i1383, align 4, !tbaa !26
  %897 = load float, ptr %arrayidx5.i12.i1384, align 4, !tbaa !26
  %898 = insertelement <2 x float> poison, float %894, i64 0
  %899 = insertelement <2 x float> %898, float %897, i64 1
  %900 = insertelement <2 x float> poison, float %mul4.i.i1366, i64 0
  %901 = shufflevector <2 x float> %900, <2 x float> poison, <2 x i32> zeroinitializer
  %902 = fmul <2 x float> %899, %901
  %903 = insertelement <2 x float> poison, float %893, i64 0
  %904 = insertelement <2 x float> %903, float %896, i64 1
  %905 = insertelement <2 x float> poison, float %mul.i.i1364, i64 0
  %906 = shufflevector <2 x float> %905, <2 x float> poison, <2 x i32> zeroinitializer
  %907 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %904, <2 x float> %906, <2 x float> %902)
  %908 = load float, ptr %arrayidx10.i15.i1386, align 4, !tbaa !26
  %909 = insertelement <2 x float> poison, float %895, i64 0
  %910 = insertelement <2 x float> %909, float %908, i64 1
  %911 = insertelement <2 x float> poison, float %mul8.i.i1368, i64 0
  %912 = shufflevector <2 x float> %911, <2 x float> poison, <2 x i32> zeroinitializer
  %913 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %910, <2 x float> %912, <2 x float> %907)
  store <2 x float> %890, ptr %bodyA, align 8, !tbaa !26
  store float %add13.i.i1405, ptr %arrayidx12.i.i1404, align 8, !tbaa !26
  %914 = load <2 x float>, ptr %m_angularFactor.i1406, align 8, !tbaa !26
  %915 = insertelement <2 x float> poison, float %sqrt.i1362, i64 0
  %916 = shufflevector <2 x float> %915, <2 x float> poison, <2 x i32> zeroinitializer
  %917 = fmul <2 x float> %916, %914
  %918 = fmul <2 x float> %913, %917
  %919 = load <2 x float>, ptr %m_deltaAngularVelocity.i1417, align 8, !tbaa !26
  %920 = fadd <2 x float> %918, %919
  store <2 x float> %920, ptr %m_deltaAngularVelocity.i1417, align 8, !tbaa !26
  %arrayidx12.i25.i1421 = getelementptr inbounds %struct.btSolverBody, ptr %bodyA, i64 0, i32 1, i32 0, i64 2
  %921 = load float, ptr %arrayidx12.i25.i1421, align 8, !tbaa !26
  %add13.i26.i1422 = fadd float %mul14.i.i1416, %921
  store float %add13.i26.i1422, ptr %arrayidx12.i25.i1421, align 8, !tbaa !26
  %m_invInertiaTensorWorld.i1426 = getelementptr inbounds %class.btRigidBody, ptr %37, i64 0, i32 1
  %arrayidx5.i.i1427 = getelementptr inbounds %class.btRigidBody, ptr %37, i64 0, i32 1, i32 0, i64 0, i32 0, i64 1
  %arrayidx10.i.i1430 = getelementptr inbounds %class.btRigidBody, ptr %37, i64 0, i32 1, i32 0, i64 0, i32 0, i64 2
  %arrayidx.i.i1432 = getelementptr inbounds %class.btRigidBody, ptr %37, i64 0, i32 1, i32 0, i64 1
  %arrayidx5.i12.i1433 = getelementptr inbounds %class.btRigidBody, ptr %37, i64 0, i32 1, i32 0, i64 1, i32 0, i64 1
  %arrayidx10.i15.i1435 = getelementptr inbounds %class.btRigidBody, ptr %37, i64 0, i32 1, i32 0, i64 1, i32 0, i64 2
  %arrayidx.i17.i1436 = getelementptr inbounds %class.btRigidBody, ptr %37, i64 0, i32 1, i32 0, i64 2
  %922 = load float, ptr %arrayidx.i17.i1436, align 4, !tbaa !26
  %arrayidx5.i18.i1437 = getelementptr inbounds %class.btRigidBody, ptr %37, i64 0, i32 1, i32 0, i64 2, i32 0, i64 1
  %923 = load float, ptr %arrayidx5.i18.i1437, align 4, !tbaa !26
  %mul8.i20.i1438 = fmul float %mul4.i.i1366, %923
  %924 = tail call float @llvm.fmuladd.f32(float %922, float %mul.i.i1364, float %mul8.i20.i1438)
  %arrayidx10.i21.i1439 = getelementptr inbounds %class.btRigidBody, ptr %37, i64 0, i32 1, i32 0, i64 2, i32 0, i64 2
  %925 = load float, ptr %arrayidx10.i21.i1439, align 4, !tbaa !26
  %926 = tail call float @llvm.fmuladd.f32(float %925, float %mul8.i.i1368, float %924)
  %fneg219 = fneg float %sqrt.i1362
  %mul.i.i1445 = fmul float %sqrt.i1362, -0.000000e+00
  %927 = load <2 x float>, ptr %bodyB, align 8, !tbaa !26
  %928 = insertelement <2 x float> poison, float %mul.i.i1445, i64 0
  %929 = shufflevector <2 x float> %928, <2 x float> poison, <2 x i32> zeroinitializer
  %930 = fadd <2 x float> %929, %927
  %arrayidx12.i.i1453 = getelementptr inbounds [4 x float], ptr %bodyB, i64 0, i64 2
  %931 = load float, ptr %arrayidx12.i.i1453, align 8, !tbaa !26
  %add13.i.i1454 = fadd float %mul.i.i1445, %931
  ...
  %932 = load float, ptr %arrayidx7.i.i.i1459, align 8, !tbaa !26
  %mul8.i.i.i1460 = fmul float %932, %fneg219
  %mul14.i.i1465 = fmul float %926, %mul8.i.i.i1460
  %m_deltaAngularVelocity.i1466 = getelementptr inbounds %struct.btSolverBody, ptr %bodyB, i64 0, i32 1
  %933 = load float, ptr %m_invInertiaTensorWorld.i1426, align 4, !tbaa !26
  %934 = load float, ptr %arrayidx5.i.i1427, align 4, !tbaa !26
  %935 = load float, ptr %arrayidx10.i.i1430, align 4, !tbaa !26
  %936 = load float, ptr %arrayidx.i.i1432, align 4, !tbaa !26
  %937 = load float, ptr %arrayidx5.i12.i1433, align 4, !tbaa !26
  %938 = insertelement <2 x float> poison, float %934, i64 0
  %939 = insertelement <2 x float> %938, float %937, i64 1
  %940 = fmul <2 x float> %901, %939
  %941 = insertelement <2 x float> poison, float %933, i64 0
  %942 = insertelement <2 x float> %941, float %936, i64 1
  %943 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %942, <2 x float> %906, <2 x float> %940)
  %944 = load float, ptr %arrayidx10.i15.i1435, align 4, !tbaa !26
  %945 = insertelement <2 x float> poison, float %935, i64 0
  %946 = insertelement <2 x float> %945, float %944, i64 1
  %947 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %946, <2 x float> %912, <2 x float> %943)
  store <2 x float> %930, ptr %bodyB, align 8, !tbaa !26
  store float %add13.i.i1454, ptr %arrayidx12.i.i1453, align 8, !tbaa !26
  %948 = load <2 x float>, ptr %m_angularFactor.i1455, align 8, !tbaa !26
  %949 = insertelement <2 x float> poison, float %fneg219, i64 0
  %950 = shufflevector <2 x float> %949, <2 x float> poison, <2 x i32> zeroinitializer
  %951 = fmul <2 x float> %948, %950
  %952 = fmul <2 x float> %947, %951
  %953 = load <2 x float>, ptr %m_deltaAngularVelocity.i1466, align 8, !tbaa !26
  %954 = fadd <2 x float> %952, %953
  store <2 x float> %954, ptr %m_deltaAngularVelocity.i1466, align 8, !tbaa !26
  %arrayidx12.i25.i1470 = getelementptr inbounds %struct.btSolverBody, ptr %bodyB, i64 0, i32 1, i32 0, i64 2
  %955 = load float, ptr %arrayidx12.i25.i1470, align 8, !tbaa !26
  %add13.i26.i1471 = fadd float %mul14.i.i1465, %955
...
if.end222:                                        ; preds = %_ZNK12btSolverBody18getAngularVelocityER9btVector3.exit1288, %if.then181, %if.else, %if.end174
  ...
  %956 = load ptr, ptr %m_originalBody.i1472, align 8, !tbaa !100
  %tobool.not.i1473 = icmp eq ptr %956, null
...
if.then.i1487:                                    ; preds = %if.end222
  %m_angularVelocity.i.i1474 = getelementptr inbounds %class.btRigidBody, ptr %956, i64 0, i32 3
  %m_deltaAngularVelocity.i1475 = getelementptr inbounds %struct.btSolverBody, ptr %bodyA, i64 0, i32 1
  %957 = load <2 x float>, ptr %m_angularVelocity.i.i1474, align 4, !tbaa !26
  %958 = load <2 x float>, ptr %m_deltaAngularVelocity.i1475, align 8, !tbaa !26
  %959 = fadd <2 x float> %957, %958
  %arrayidx11.i.i1480 = getelementptr inbounds %class.btRigidBody, ptr %956, i64 0, i32 3, i32 0, i64 2
  %960 = load float, ptr %arrayidx11.i.i1480, align 4, !tbaa !26
  %arrayidx13.i.i1481 = getelementptr inbounds %struct.btSolverBody, ptr %bodyA, i64 0, i32 1, i32 0, i64 2
  %961 = load float, ptr %arrayidx13.i.i1481, align 8, !tbaa !26
  %add14.i.i1482 = fadd float %960, %961
...
_ZNK12btSolverBody18getAngularVelocityER9btVector3.exit1489: ; preds = %if.end222, %if.then.i1487
  %angVelA223.sroa.0.0 = phi <2 x float> [ %959, %if.then.i1487 ], [ zeroinitializer, %if.end222 ]
  ...
  %962 = load ptr, ptr %m_originalBody.i1490, align 8, !tbaa !100
  %tobool.not.i1491 = icmp eq ptr %962, null
...
if.then.i1505:                                    ; preds = %_ZNK12btSolverBody18getAngularVelocityER9btVector3.exit1489
  %m_angularVelocity.i.i1492 = getelementptr inbounds %class.btRigidBody, ptr %962, i64 0, i32 3
  %m_deltaAngularVelocity.i1493 = getelementptr inbounds %struct.btSolverBody, ptr %bodyB, i64 0, i32 1
  %963 = load <2 x float>, ptr %m_angularVelocity.i.i1492, align 4, !tbaa !26
  %964 = load <2 x float>, ptr %m_deltaAngularVelocity.i1493, align 8, !tbaa !26
  %965 = fadd <2 x float> %963, %964
  %arrayidx11.i.i1498 = getelementptr inbounds %class.btRigidBody, ptr %962, i64 0, i32 3, i32 0, i64 2
  %966 = load float, ptr %arrayidx11.i.i1498, align 4, !tbaa !26
  %arrayidx13.i.i1499 = getelementptr inbounds %struct.btSolverBody, ptr %bodyB, i64 0, i32 1, i32 0, i64 2
  %967 = load float, ptr %arrayidx13.i.i1499, align 8, !tbaa !26
  %add14.i.i1500 = fadd float %966, %967
...
_ZNK12btSolverBody18getAngularVelocityER9btVector3.exit1507: ; preds = %_ZNK12btSolverBody18getAngularVelocityER9btVector3.exit1489, %if.then.i1505
  %angVelB224.sroa.0.0 = phi <2 x float> [ %965, %if.then.i1505 ], [ zeroinitializer, %_ZNK12btSolverBody18getAngularVelocityER9btVector3.exit1489 ]
  ...
  %m_solveSwingLimit = getelementptr inbounds %class.btConeTwistConstraint, ptr %this, i64 0, i32 24
  %968 = load i8, ptr %m_solveSwingLimit, align 2, !tbaa !29, !range !31, !noundef !32
  %tobool225.not = icmp eq i8 %968, 0
...
if.then226:                                       ; preds = %_ZNK12btSolverBody18getAngularVelocityER9btVector3.exit1507
  %m_swingLimitRatio = getelementptr inbounds %class.btConeTwistConstraint, ptr %this, i64 0, i32 26
  %969 = load float, ptr %m_swingLimitRatio, align 8, !tbaa !60
  %m_swingCorrection = getelementptr inbounds %class.btConeTwistConstraint, ptr %this, i64 0, i32 17
  %970 = load float, ptr %m_swingCorrection, align 8, !tbaa !57
  %mul227 = fmul float %969, %970
  %m_biasFactor = getelementptr inbounds %class.btConeTwistConstraint, ptr %this, i64 0, i32 5
  %971 = load float, ptr %m_biasFactor, align 8, !tbaa !84
  %mul228 = fmul float %mul227, %971
  %div229 = fdiv float %mul228, %timeStep
  %972 = fsub <2 x float> %angVelB224.sroa.0.0, %angVelA223.sroa.0.0
  %sub.i1508 = extractelement <2 x float> %972, i64 0
  %973 = fsub <2 x float> %angVelB224.sroa.0.0, %angVelA223.sroa.0.0
  %sub8.i1511 = extractelement <2 x float> %973, i64 1
  %974 = fsub <2 x float> %angVelB224.sroa.8.0, %angVelA223.sroa.8.0
  %sub14.i1514 = extractelement <2 x float> %974, i64 0
  %m_swingAxis = getelementptr inbounds %class.btConeTwistConstraint, ptr %this, i64 0, i32 12
  %975 = load float, ptr %m_swingAxis, align 4, !tbaa !26
  %arrayidx7.i1521 = getelementptr inbounds %class.btConeTwistConstraint, ptr %this, i64 0, i32 12, i32 0, i64 1
  %976 = load float, ptr %arrayidx7.i1521, align 8, !tbaa !26
  %mul8.i1522 = fmul float %sub8.i1511, %976
  %977 = call float @llvm.fmuladd.f32(float %sub.i1508, float %975, float %mul8.i1522)
  %arrayidx12.i1524 = getelementptr inbounds %class.btConeTwistConstraint, ptr %this, i64 0, i32 12, i32 0, i64 2
  %978 = load float, ptr %arrayidx12.i1524, align 4, !tbaa !26
  %979 = call float @llvm.fmuladd.f32(float %sub14.i1514, float %978, float %977)
  %cmp234 = fcmp ogt float %979, 0.000000e+00
  %mul237 = fmul float %969, %979
  %m_relaxationFactor = getelementptr inbounds %class.btConeTwistConstraint, ptr %this, i64 0, i32 6
  %980 = load float, ptr %m_relaxationFactor, align 4
  %981 = call float @llvm.fmuladd.f32(float %mul237, float %980, float %div229)
  %amplitude.0 = select i1 %cmp234, float %981, float %div229
  %m_kSwing = getelementptr inbounds %class.btConeTwistConstraint, ptr %this, i64 0, i32 14
  %982 = load float, ptr %m_kSwing, align 4, !tbaa !61
  %mul241 = fmul float %982, %amplitude.0
  %m_accSwingLimitImpulse = getelementptr inbounds %class.btConeTwistConstraint, ptr %this, i64 0, i32 20
  %983 = load float, ptr %m_accSwingLimitImpulse, align 4, !tbaa !119
  %add244 = fadd float %983, %mul241
  %cmp.i = fcmp ogt float %add244, 0.000000e+00
  %.sroa.speculated1829 = select i1 %cmp.i, float %add244, float 0.000000e+00
  store float %.sroa.speculated1829, ptr %m_accSwingLimitImpulse, align 4, !tbaa !119
  %sub = fsub float %.sroa.speculated1829, %983
  %mul.i1525 = fmul float %975, %sub
  %mul4.i1527 = fmul float %976, %sub
  %mul8.i1529 = fmul float %978, %sub
  %m_twistAxisA = getelementptr inbounds %class.btConeTwistConstraint, ptr %this, i64 0, i32 28
  %984 = load float, ptr %m_twistAxisA, align 8, !tbaa !26
  %arrayidx7.i1536 = getelementptr inbounds %class.btConeTwistConstraint, ptr %this, i64 0, i32 28, i32 0, i64 1
  %985 = load float, ptr %arrayidx7.i1536, align 4, !tbaa !26
  %mul8.i1537 = fmul float %985, %mul4.i1527
  %986 = call float @llvm.fmuladd.f32(float %mul.i1525, float %984, float %mul8.i1537)
  %arrayidx12.i1539 = getelementptr inbounds %class.btConeTwistConstraint, ptr %this, i64 0, i32 28, i32 0, i64 2
  %987 = load float, ptr %arrayidx12.i1539, align 8, !tbaa !26
  %988 = call float @llvm.fmuladd.f32(float %mul8.i1529, float %987, float %986)
  %mul.i.i1540 = fmul float %984, %988
  %mul4.i.i1542 = fmul float %985, %988
  %mul8.i.i1544 = fmul float %987, %988
  ...
  %989 = call float @llvm.fmuladd.f32(float %sub.i1550, float %sub.i1550, float %mul8.i.i.i1563)
  %990 = call float @llvm.fmuladd.f32(float %sub14.i1556, float %sub14.i1556, float %989)
  %sqrt.i1565 = call float @llvm.sqrt.f32(float %990)
  ...
  %991 = load ptr, ptr %m_rbA, align 8, !tbaa !36
  %m_invInertiaTensorWorld.i1580 = getelementptr inbounds %class.btRigidBody, ptr %991, i64 0, i32 1
  %arrayidx5.i.i1581 = getelementptr inbounds %class.btRigidBody, ptr %991, i64 0, i32 1, i32 0, i64 0, i32 0, i64 1
  %arrayidx10.i.i1584 = getelementptr inbounds %class.btRigidBody, ptr %991, i64 0, i32 1, i32 0, i64 0, i32 0, i64 2
  %arrayidx.i.i1586 = getelementptr inbounds %class.btRigidBody, ptr %991, i64 0, i32 1, i32 0, i64 1
  %arrayidx5.i12.i1587 = getelementptr inbounds %class.btRigidBody, ptr %991, i64 0, i32 1, i32 0, i64 1, i32 0, i64 1
  %arrayidx10.i15.i1589 = getelementptr inbounds %class.btRigidBody, ptr %991, i64 0, i32 1, i32 0, i64 1, i32 0, i64 2
  %arrayidx.i17.i1590 = getelementptr inbounds %class.btRigidBody, ptr %991, i64 0, i32 1, i32 0, i64 2
  %992 = load float, ptr %arrayidx.i17.i1590, align 4, !tbaa !26
  %arrayidx5.i18.i1591 = getelementptr inbounds %class.btRigidBody, ptr %991, i64 0, i32 1, i32 0, i64 2, i32 0, i64 1
  %993 = load float, ptr %arrayidx5.i18.i1591, align 4, !tbaa !26
  %mul8.i20.i1592 = fmul float %993, %mul4.i.i1569
  %994 = call float @llvm.fmuladd.f32(float %992, float %mul.i.i1567, float %mul8.i20.i1592)
  %arrayidx10.i21.i1593 = getelementptr inbounds %class.btRigidBody, ptr %991, i64 0, i32 1, i32 0, i64 2, i32 0, i64 2
  %995 = load float, ptr %arrayidx10.i21.i1593, align 4, !tbaa !26
  %996 = call float @llvm.fmuladd.f32(float %995, float %mul8.i.i1571, float %994)
  %mul.i.i1599 = fmul float %sqrt.i1565, 0.000000e+00
  %997 = load <2 x float>, ptr %bodyA, align 8, !tbaa !26
  %998 = insertelement <2 x float> poison, float %mul.i.i1599, i64 0
  %999 = shufflevector <2 x float> %998, <2 x float> poison, <2 x i32> zeroinitializer
  %1000 = fadd <2 x float> %997, %999
  %arrayidx12.i.i1607 = getelementptr inbounds [4 x float], ptr %bodyA, i64 0, i64 2
  %1001 = load float, ptr %arrayidx12.i.i1607, align 8, !tbaa !26
  %add13.i.i1608 = fadd float %mul.i.i1599, %1001
  ...
  %1002 = load float, ptr %arrayidx7.i.i.i1613, align 8, !tbaa !26
  %mul8.i.i.i1614 = fmul float %sqrt.i1565, %1002
  %mul14.i.i1619 = fmul float %996, %mul8.i.i.i1614
  %m_deltaAngularVelocity.i1620 = getelementptr inbounds %struct.btSolverBody, ptr %bodyA, i64 0, i32 1
  %1003 = load float, ptr %m_invInertiaTensorWorld.i1580, align 4, !tbaa !26
  %1004 = load float, ptr %arrayidx5.i.i1581, align 4, !tbaa !26
  %1005 = load float, ptr %arrayidx10.i.i1584, align 4, !tbaa !26
  %1006 = load float, ptr %arrayidx.i.i1586, align 4, !tbaa !26
  %1007 = load float, ptr %arrayidx5.i12.i1587, align 4, !tbaa !26
  %1008 = insertelement <2 x float> poison, float %1004, i64 0
  %1009 = insertelement <2 x float> %1008, float %1007, i64 1
  %1010 = insertelement <2 x float> poison, float %mul4.i.i1569, i64 0
  %1011 = shufflevector <2 x float> %1010, <2 x float> poison, <2 x i32> zeroinitializer
  %1012 = fmul <2 x float> %1009, %1011
  %1013 = insertelement <2 x float> poison, float %1003, i64 0
  %1014 = insertelement <2 x float> %1013, float %1006, i64 1
  %1015 = insertelement <2 x float> poison, float %mul.i.i1567, i64 0
  %1016 = shufflevector <2 x float> %1015, <2 x float> poison, <2 x i32> zeroinitializer
  %1017 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %1014, <2 x float> %1016, <2 x float> %1012)
  %1018 = load float, ptr %arrayidx10.i15.i1589, align 4, !tbaa !26
  %1019 = insertelement <2 x float> poison, float %1005, i64 0
  %1020 = insertelement <2 x float> %1019, float %1018, i64 1
  %1021 = insertelement <2 x float> poison, float %mul8.i.i1571, i64 0
  %1022 = shufflevector <2 x float> %1021, <2 x float> poison, <2 x i32> zeroinitializer
  %1023 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %1020, <2 x float> %1022, <2 x float> %1017)
  store <2 x float> %1000, ptr %bodyA, align 8, !tbaa !26
  store float %add13.i.i1608, ptr %arrayidx12.i.i1607, align 8, !tbaa !26
  %1024 = load <2 x float>, ptr %m_angularFactor.i1609, align 8, !tbaa !26
  %1025 = insertelement <2 x float> poison, float %sqrt.i1565, i64 0
  %1026 = shufflevector <2 x float> %1025, <2 x float> poison, <2 x i32> zeroinitializer
  %1027 = fmul <2 x float> %1026, %1024
  %1028 = fmul <2 x float> %1027, %1023
  %1029 = load <2 x float>, ptr %m_deltaAngularVelocity.i1620, align 8, !tbaa !26
  %1030 = fadd <2 x float> %1028, %1029
  store <2 x float> %1030, ptr %m_deltaAngularVelocity.i1620, align 8, !tbaa !26
  %arrayidx12.i25.i1624 = getelementptr inbounds %struct.btSolverBody, ptr %bodyA, i64 0, i32 1, i32 0, i64 2
  %1031 = load float, ptr %arrayidx12.i25.i1624, align 8, !tbaa !26
  %add13.i26.i1625 = fadd float %mul14.i.i1619, %1031
  store float %add13.i26.i1625, ptr %arrayidx12.i25.i1624, align 8, !tbaa !26
  %1032 = load ptr, ptr %m_rbB, align 8, !tbaa !37
  %m_invInertiaTensorWorld.i1629 = getelementptr inbounds %class.btRigidBody, ptr %1032, i64 0, i32 1
  %arrayidx5.i.i1630 = getelementptr inbounds %class.btRigidBody, ptr %1032, i64 0, i32 1, i32 0, i64 0, i32 0, i64 1
  %arrayidx10.i.i1633 = getelementptr inbounds %class.btRigidBody, ptr %1032, i64 0, i32 1, i32 0, i64 0, i32 0, i64 2
  %arrayidx.i.i1635 = getelementptr inbounds %class.btRigidBody, ptr %1032, i64 0, i32 1, i32 0, i64 1
  %arrayidx5.i12.i1636 = getelementptr inbounds %class.btRigidBody, ptr %1032, i64 0, i32 1, i32 0, i64 1, i32 0, i64 1
  %arrayidx10.i15.i1638 = getelementptr inbounds %class.btRigidBody, ptr %1032, i64 0, i32 1, i32 0, i64 1, i32 0, i64 2
  %arrayidx.i17.i1639 = getelementptr inbounds %class.btRigidBody, ptr %1032, i64 0, i32 1, i32 0, i64 2
  %1033 = load float, ptr %arrayidx.i17.i1639, align 4, !tbaa !26
  %arrayidx5.i18.i1640 = getelementptr inbounds %class.btRigidBody, ptr %1032, i64 0, i32 1, i32 0, i64 2, i32 0, i64 1
  %1034 = load float, ptr %arrayidx5.i18.i1640, align 4, !tbaa !26
  %mul8.i20.i1641 = fmul float %mul4.i.i1569, %1034
  %1035 = call float @llvm.fmuladd.f32(float %1033, float %mul.i.i1567, float %mul8.i20.i1641)
  %arrayidx10.i21.i1642 = getelementptr inbounds %class.btRigidBody, ptr %1032, i64 0, i32 1, i32 0, i64 2, i32 0, i64 2
  %1036 = load float, ptr %arrayidx10.i21.i1642, align 4, !tbaa !26
  %1037 = call float @llvm.fmuladd.f32(float %1036, float %mul8.i.i1571, float %1035)
  %fneg281 = fneg float %sqrt.i1565
  %mul.i.i1648 = fmul float %sqrt.i1565, -0.000000e+00
  %1038 = load <2 x float>, ptr %bodyB, align 8, !tbaa !26
  %1039 = insertelement <2 x float> poison, float %mul.i.i1648, i64 0
  %1040 = shufflevector <2 x float> %1039, <2 x float> poison, <2 x i32> zeroinitializer
  %1041 = fadd <2 x float> %1040, %1038
  %arrayidx12.i.i1656 = getelementptr inbounds [4 x float], ptr %bodyB, i64 0, i64 2
  %1042 = load float, ptr %arrayidx12.i.i1656, align 8, !tbaa !26
  %add13.i.i1657 = fadd float %mul.i.i1648, %1042
  ...
  %1043 = load float, ptr %arrayidx7.i.i.i1662, align 8, !tbaa !26
  %mul8.i.i.i1663 = fmul float %1043, %fneg281
  %mul14.i.i1668 = fmul float %1037, %mul8.i.i.i1663
  %m_deltaAngularVelocity.i1669 = getelementptr inbounds %struct.btSolverBody, ptr %bodyB, i64 0, i32 1
  %1044 = load float, ptr %m_invInertiaTensorWorld.i1629, align 4, !tbaa !26
  %1045 = load float, ptr %arrayidx5.i.i1630, align 4, !tbaa !26
  %1046 = load float, ptr %arrayidx10.i.i1633, align 4, !tbaa !26
  %1047 = load float, ptr %arrayidx.i.i1635, align 4, !tbaa !26
  %1048 = load float, ptr %arrayidx5.i12.i1636, align 4, !tbaa !26
  %1049 = insertelement <2 x float> poison, float %1045, i64 0
  %1050 = insertelement <2 x float> %1049, float %1048, i64 1
  %1051 = fmul <2 x float> %1011, %1050
  %1052 = insertelement <2 x float> poison, float %1044, i64 0
  %1053 = insertelement <2 x float> %1052, float %1047, i64 1
  %1054 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %1053, <2 x float> %1016, <2 x float> %1051)
  %1055 = load float, ptr %arrayidx10.i15.i1638, align 4, !tbaa !26
  %1056 = insertelement <2 x float> poison, float %1046, i64 0
  %1057 = insertelement <2 x float> %1056, float %1055, i64 1
  %1058 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %1057, <2 x float> %1022, <2 x float> %1054)
  store <2 x float> %1041, ptr %bodyB, align 8, !tbaa !26
  store float %add13.i.i1657, ptr %arrayidx12.i.i1656, align 8, !tbaa !26
  %1059 = load <2 x float>, ptr %m_angularFactor.i1658, align 8, !tbaa !26
  %1060 = insertelement <2 x float> poison, float %fneg281, i64 0
  %1061 = shufflevector <2 x float> %1060, <2 x float> poison, <2 x i32> zeroinitializer
  %1062 = fmul <2 x float> %1059, %1061
  %1063 = fmul <2 x float> %1058, %1062
  %1064 = load <2 x float>, ptr %m_deltaAngularVelocity.i1669, align 8, !tbaa !26
  %1065 = fadd <2 x float> %1063, %1064
  store <2 x float> %1065, ptr %m_deltaAngularVelocity.i1669, align 8, !tbaa !26
  %arrayidx12.i25.i1673 = getelementptr inbounds %struct.btSolverBody, ptr %bodyB, i64 0, i32 1, i32 0, i64 2
  %1066 = load float, ptr %arrayidx12.i25.i1673, align 8, !tbaa !26
  %add13.i26.i1674 = fadd float %mul14.i.i1668, %1066
...
if.end282:                                        ; preds = %if.then226, %_ZNK12btSolverBody18getAngularVelocityER9btVector3.exit1507
  %m_solveTwistLimit = getelementptr inbounds %class.btConeTwistConstraint, ptr %this, i64 0, i32 23
  %1067 = load i8, ptr %m_solveTwistLimit, align 1, !tbaa !28, !range !31, !noundef !32
  %tobool283.not = icmp eq i8 %1067, 0
  br i1 %tobool283.not, label %if.end338, label %if.then284

if.then284:                                       ; preds = %if.end282
  %m_twistLimitRatio = getelementptr inbounds %class.btConeTwistConstraint, ptr %this, i64 0, i32 27
  %1068 = load float, ptr %m_twistLimitRatio, align 4, !tbaa !63
  %m_twistCorrection = getelementptr inbounds %class.btConeTwistConstraint, ptr %this, i64 0, i32 18
  %1069 = load float, ptr %m_twistCorrection, align 4, !tbaa !64
  %mul286 = fmul float %1068, %1069
  %m_biasFactor287 = getelementptr inbounds %class.btConeTwistConstraint, ptr %this, i64 0, i32 5
  %1070 = load float, ptr %m_biasFactor287, align 8, !tbaa !84
  %mul288 = fmul float %mul286, %1070
  %div289 = fdiv float %mul288, %timeStep
  %1071 = fsub <2 x float> %angVelB224.sroa.0.0, %angVelA223.sroa.0.0
  %sub.i1675 = extractelement <2 x float> %1071, i64 0
  %1072 = fsub <2 x float> %angVelB224.sroa.0.0, %angVelA223.sroa.0.0
  %sub8.i1678 = extractelement <2 x float> %1072, i64 1
  %1073 = fsub <2 x float> %angVelB224.sroa.8.0, %angVelA223.sroa.8.0
  %sub14.i1681 = extractelement <2 x float> %1073, i64 0
  %m_twistAxis = getelementptr inbounds %class.btConeTwistConstraint, ptr %this, i64 0, i32 13
  %1074 = load float, ptr %m_twistAxis, align 4, !tbaa !26
  %arrayidx7.i1688 = getelementptr inbounds %class.btConeTwistConstraint, ptr %this, i64 0, i32 13, i32 0, i64 1
  %1075 = load float, ptr %arrayidx7.i1688, align 8, !tbaa !26
  %mul8.i1689 = fmul float %sub8.i1678, %1075
  %1076 = call float @llvm.fmuladd.f32(float %sub.i1675, float %1074, float %mul8.i1689)
  %arrayidx12.i1691 = getelementptr inbounds %class.btConeTwistConstraint, ptr %this, i64 0, i32 13, i32 0, i64 2
  %1077 = load float, ptr %arrayidx12.i1691, align 4, !tbaa !26
  %1078 = call float @llvm.fmuladd.f32(float %sub14.i1681, float %1077, float %1076)
  %cmp294 = fcmp ogt float %1078, 0.000000e+00
  %mul297 = fmul float %1068, %1078
  %m_relaxationFactor298 = getelementptr inbounds %class.btConeTwistConstraint, ptr %this, i64 0, i32 6
  %1079 = load float, ptr %m_relaxationFactor298, align 4
  %1080 = call float @llvm.fmuladd.f32(float %mul297, float %1079, float %div289)
  %amplitude285.0 = select i1 %cmp294, float %1080, float %div289
  %m_kTwist = getelementptr inbounds %class.btConeTwistConstraint, ptr %this, i64 0, i32 15
  %1081 = load float, ptr %m_kTwist, align 8, !tbaa !65
  %mul302 = fmul float %1081, %amplitude285.0
  %m_accTwistLimitImpulse = getelementptr inbounds %class.btConeTwistConstraint, ptr %this, i64 0, i32 21
  %1082 = load float, ptr %m_accTwistLimitImpulse, align 8, !tbaa !120
  %add306 = fadd float %1082, %mul302
  ...
  %sub311 = fsub float %.sroa.speculated, %1082
  %1083 = load ptr, ptr %m_rbA, align 8, !tbaa !36
  %m_invInertiaTensorWorld.i1707 = getelementptr inbounds %class.btRigidBody, ptr %1083, i64 0, i32 1
  %arrayidx5.i.i1708 = getelementptr inbounds %class.btRigidBody, ptr %1083, i64 0, i32 1, i32 0, i64 0, i32 0, i64 1
  %arrayidx10.i.i1711 = getelementptr inbounds %class.btRigidBody, ptr %1083, i64 0, i32 1, i32 0, i64 0, i32 0, i64 2
  %arrayidx.i.i1713 = getelementptr inbounds %class.btRigidBody, ptr %1083, i64 0, i32 1, i32 0, i64 1
  %arrayidx5.i12.i1714 = getelementptr inbounds %class.btRigidBody, ptr %1083, i64 0, i32 1, i32 0, i64 1, i32 0, i64 1
  %arrayidx10.i15.i1716 = getelementptr inbounds %class.btRigidBody, ptr %1083, i64 0, i32 1, i32 0, i64 1, i32 0, i64 2
  %arrayidx.i17.i1717 = getelementptr inbounds %class.btRigidBody, ptr %1083, i64 0, i32 1, i32 0, i64 2
  %1084 = load float, ptr %arrayidx.i17.i1717, align 4, !tbaa !26
  %arrayidx5.i18.i1718 = getelementptr inbounds %class.btRigidBody, ptr %1083, i64 0, i32 1, i32 0, i64 2, i32 0, i64 1
  %1085 = load float, ptr %arrayidx5.i18.i1718, align 4, !tbaa !26
  %mul8.i20.i1719 = fmul float %1075, %1085
  %1086 = call float @llvm.fmuladd.f32(float %1084, float %1074, float %mul8.i20.i1719)
  %arrayidx10.i21.i1720 = getelementptr inbounds %class.btRigidBody, ptr %1083, i64 0, i32 1, i32 0, i64 2, i32 0, i64 2
  %1087 = load float, ptr %arrayidx10.i21.i1720, align 4, !tbaa !26
  %1088 = call float @llvm.fmuladd.f32(float %1087, float %1077, float %1086)
  %mul.i.i1726 = fmul float %sub311, 0.000000e+00
  %1089 = load <2 x float>, ptr %bodyA, align 8, !tbaa !26
  %1090 = insertelement <2 x float> poison, float %mul.i.i1726, i64 0
  %1091 = shufflevector <2 x float> %1090, <2 x float> poison, <2 x i32> zeroinitializer
  %1092 = fadd <2 x float> %1091, %1089
  %arrayidx12.i.i1734 = getelementptr inbounds [4 x float], ptr %bodyA, i64 0, i64 2
  %1093 = load float, ptr %arrayidx12.i.i1734, align 8, !tbaa !26
  %add13.i.i1735 = fadd float %mul.i.i1726, %1093
  ...
  %1094 = load float, ptr %arrayidx7.i.i.i1740, align 8, !tbaa !26
  %mul8.i.i.i1741 = fmul float %sub311, %1094
  %mul14.i.i1746 = fmul float %1088, %mul8.i.i.i1741
  %m_deltaAngularVelocity.i1747 = getelementptr inbounds %struct.btSolverBody, ptr %bodyA, i64 0, i32 1
  %1095 = load float, ptr %m_invInertiaTensorWorld.i1707, align 4, !tbaa !26
  %1096 = load float, ptr %arrayidx5.i.i1708, align 4, !tbaa !26
  %1097 = load float, ptr %arrayidx10.i.i1711, align 4, !tbaa !26
  %1098 = load float, ptr %arrayidx.i.i1713, align 4, !tbaa !26
  %1099 = load float, ptr %arrayidx5.i12.i1714, align 4, !tbaa !26
  %1100 = insertelement <2 x float> poison, float %1075, i64 0
  %1101 = shufflevector <2 x float> %1100, <2 x float> poison, <2 x i32> zeroinitializer
  %1102 = insertelement <2 x float> poison, float %1096, i64 0
  %1103 = insertelement <2 x float> %1102, float %1099, i64 1
  %1104 = fmul <2 x float> %1101, %1103
  %1105 = insertelement <2 x float> poison, float %1095, i64 0
  %1106 = insertelement <2 x float> %1105, float %1098, i64 1
  %1107 = insertelement <2 x float> poison, float %1074, i64 0
  %1108 = shufflevector <2 x float> %1107, <2 x float> poison, <2 x i32> zeroinitializer
  %1109 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %1106, <2 x float> %1108, <2 x float> %1104)
  %1110 = load float, ptr %arrayidx10.i15.i1716, align 4, !tbaa !26
  %1111 = insertelement <2 x float> poison, float %1097, i64 0
  %1112 = insertelement <2 x float> %1111, float %1110, i64 1
  %1113 = insertelement <2 x float> poison, float %1077, i64 0
  %1114 = shufflevector <2 x float> %1113, <2 x float> poison, <2 x i32> zeroinitializer
  %1115 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %1112, <2 x float> %1114, <2 x float> %1109)
  store <2 x float> %1092, ptr %bodyA, align 8, !tbaa !26
  store float %add13.i.i1735, ptr %arrayidx12.i.i1734, align 8, !tbaa !26
  %1116 = load <2 x float>, ptr %m_angularFactor.i1736, align 8, !tbaa !26
  %1117 = insertelement <2 x float> poison, float %sub311, i64 0
  %1118 = shufflevector <2 x float> %1117, <2 x float> poison, <2 x i32> zeroinitializer
  %1119 = fmul <2 x float> %1118, %1116
  %1120 = fmul <2 x float> %1115, %1119
  %1121 = load <2 x float>, ptr %m_deltaAngularVelocity.i1747, align 8, !tbaa !26
  %1122 = fadd <2 x float> %1120, %1121
  store <2 x float> %1122, ptr %m_deltaAngularVelocity.i1747, align 8, !tbaa !26
  %arrayidx12.i25.i1751 = getelementptr inbounds %struct.btSolverBody, ptr %bodyA, i64 0, i32 1, i32 0, i64 2
  %1123 = load float, ptr %arrayidx12.i25.i1751, align 8, !tbaa !26
  %add13.i26.i1752 = fadd float %mul14.i.i1746, %1123
  store float %add13.i26.i1752, ptr %arrayidx12.i25.i1751, align 8, !tbaa !26
  %1124 = load ptr, ptr %m_rbB, align 8, !tbaa !37
  %m_invInertiaTensorWorld.i1756 = getelementptr inbounds %class.btRigidBody, ptr %1124, i64 0, i32 1
  %1125 = load float, ptr %m_twistAxis, align 4, !tbaa !26
  %arrayidx5.i.i1757 = getelementptr inbounds %class.btRigidBody, ptr %1124, i64 0, i32 1, i32 0, i64 0, i32 0, i64 1
  %1126 = load float, ptr %arrayidx7.i1688, align 8, !tbaa !26
  %arrayidx10.i.i1760 = getelementptr inbounds %class.btRigidBody, ptr %1124, i64 0, i32 1, i32 0, i64 0, i32 0, i64 2
  %1127 = load float, ptr %arrayidx12.i1691, align 4, !tbaa !26
  %arrayidx.i.i1762 = getelementptr inbounds %class.btRigidBody, ptr %1124, i64 0, i32 1, i32 0, i64 1
  %arrayidx5.i12.i1763 = getelementptr inbounds %class.btRigidBody, ptr %1124, i64 0, i32 1, i32 0, i64 1, i32 0, i64 1
  %arrayidx10.i15.i1765 = getelementptr inbounds %class.btRigidBody, ptr %1124, i64 0, i32 1, i32 0, i64 1, i32 0, i64 2
  %arrayidx.i17.i1766 = getelementptr inbounds %class.btRigidBody, ptr %1124, i64 0, i32 1, i32 0, i64 2
  %1128 = load float, ptr %arrayidx.i17.i1766, align 4, !tbaa !26
  %arrayidx5.i18.i1767 = getelementptr inbounds %class.btRigidBody, ptr %1124, i64 0, i32 1, i32 0, i64 2, i32 0, i64 1
  %1129 = load float, ptr %arrayidx5.i18.i1767, align 4, !tbaa !26
  %mul8.i20.i1768 = fmul float %1126, %1129
  %1130 = call float @llvm.fmuladd.f32(float %1128, float %1125, float %mul8.i20.i1768)
  %arrayidx10.i21.i1769 = getelementptr inbounds %class.btRigidBody, ptr %1124, i64 0, i32 1, i32 0, i64 2, i32 0, i64 2
  %1131 = load float, ptr %arrayidx10.i21.i1769, align 4, !tbaa !26
  %1132 = call float @llvm.fmuladd.f32(float %1131, float %1127, float %1130)
  %fneg336 = fneg float %sub311
  %mul.i.i1775 = fmul float %sub311, -0.000000e+00
  %1133 = load <2 x float>, ptr %bodyB, align 8, !tbaa !26
  %1134 = insertelement <2 x float> poison, float %mul.i.i1775, i64 0
  ...
  %1137 = load float, ptr %arrayidx12.i.i1783, align 8, !tbaa !26
  %add13.i.i1784 = fadd float %mul.i.i1775, %1137
  ...
  %1138 = load float, ptr %arrayidx7.i.i.i1789, align 8, !tbaa !26
  %mul8.i.i.i1790 = fmul float %1138, %fneg336
  %mul14.i.i1795 = fmul float %1132, %mul8.i.i.i1790
  %m_deltaAngularVelocity.i1796 = getelementptr inbounds %struct.btSolverBody, ptr %bodyB, i64 0, i32 1
  %1139 = load float, ptr %m_invInertiaTensorWorld.i1756, align 4, !tbaa !26
  %1140 = load float, ptr %arrayidx5.i.i1757, align 4, !tbaa !26
  %1141 = load float, ptr %arrayidx10.i.i1760, align 4, !tbaa !26
  %1142 = load float, ptr %arrayidx.i.i1762, align 4, !tbaa !26
  %1143 = load float, ptr %arrayidx5.i12.i1763, align 4, !tbaa !26
  %1144 = insertelement <2 x float> poison, float %1126, i64 0
  ...
  %1147 = insertelement <2 x float> %1146, float %1143, i64 1
  %1148 = fmul <2 x float> %1145, %1147
  %1149 = insertelement <2 x float> poison, float %1139, i64 0
  %1150 = insertelement <2 x float> %1149, float %1142, i64 1
  %1151 = insertelement <2 x float> poison, float %1125, i64 0
  %1152 = shufflevector <2 x float> %1151, <2 x float> poison, <2 x i32> zeroinitializer
  %1153 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %1150, <2 x float> %1152, <2 x float> %1148)
  %1154 = load float, ptr %arrayidx10.i15.i1765, align 4, !tbaa !26
  %1155 = insertelement <2 x float> poison, float %1141, i64 0
  %1156 = insertelement <2 x float> %1155, float %1154, i64 1
  %1157 = insertelement <2 x float> poison, float %1127, i64 0
  %1158 = shufflevector <2 x float> %1157, <2 x float> poison, <2 x i32> zeroinitializer
  %1159 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %1156, <2 x float> %1158, <2 x float> %1153)
  store <2 x float> %1136, ptr %bodyB, align 8, !tbaa !26
  store float %add13.i.i1784, ptr %arrayidx12.i.i1783, align 8, !tbaa !26
  %1160 = load <2 x float>, ptr %m_angularFactor.i1785, align 8, !tbaa !26
  %1161 = insertelement <2 x float> poison, float %fneg336, i64 0
  %1162 = shufflevector <2 x float> %1161, <2 x float> poison, <2 x i32> zeroinitializer
  %1163 = fmul <2 x float> %1160, %1162
  %1164 = fmul <2 x float> %1159, %1163
  %1165 = load <2 x float>, ptr %m_deltaAngularVelocity.i1796, align 8, !tbaa !26
  %1166 = fadd <2 x float> %1164, %1165
  store <2 x float> %1166, ptr %m_deltaAngularVelocity.i1796, align 8, !tbaa !26
  %arrayidx12.i25.i1800 = getelementptr inbounds %struct.btSolverBody, ptr %bodyB, i64 0, i32 1, i32 0, i64 2
  %1167 = load float, ptr %arrayidx12.i25.i1800, align 8, !tbaa !26
  %add13.i26.i1801 = fadd float %mul14.i.i1795, %1167
...
if.end:                                           ; preds = %_Z11btAtan2Fastff.exit, %entry
  %b1Axis2.sroa.0.0 = phi <2 x float> [ %72, %_Z11btAtan2Fastff.exit ], [ undef, %entry ]
  %b1Axis2.sroa.11.0 = phi <2 x float> [ %retval.sroa.3.12.vec.insert.i249, %_Z11btAtan2Fastff.exit ], [ undef, %entry ]
  %swing1.0 = phi float [ %mul35, %_Z11btAtan2Fastff.exit ], [ 0.000000e+00, %entry ]
  %m_swingSpan2 = getelementptr inbounds %class.btConeTwistConstraint, ptr %this, i64 0, i32 9
...
if.end59:                                         ; preds = %_Z11btAtan2Fastff.exit312, %if.end
  %b1Axis3.sroa.0.0 = phi <2 x float> [ %100, %_Z11btAtan2Fastff.exit312 ], [ undef, %if.end ]
  %b1Axis3.sroa.11.0 = phi <2 x float> [ %retval.sroa.3.12.vec.insert.i286, %_Z11btAtan2Fastff.exit312 ], [ undef, %if.end ]
  %swing2.0 = phi float [ %mul58, %_Z11btAtan2Fastff.exit312 ], [ 0.000000e+00, %if.end ]
