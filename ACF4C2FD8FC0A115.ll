; ModuleID = '/usr/local/google/home/aeubanks/repos/test-suite/MultiSource/Benchmarks/Olden/treeadd/args.c'
source_filename = "/usr/local/google/home/aeubanks/repos/test-suite/MultiSource/Benchmarks/Olden/treeadd/args.c"
...
if.end6:                                          ; preds = %if.end, %if.then2
  %level.0 = phi i32 [ %call4, %if.then2 ], [ 16, %if.end ]
  ret i32 %level.0
}
