; ModuleID = '/usr/local/google/home/aeubanks/repos/test-suite/MultiSource/Benchmarks/TSVC/Packing-dbl/tsc.c'
source_filename = "/usr/local/google/home/aeubanks/repos/test-suite/MultiSource/Benchmarks/TSVC/Packing-dbl/tsc.c"
...
entry:
  %call = tail call i32 @init(ptr noundef nonnull @.str.90)
...
for.cond1.preheader:                              ; preds = %entry, %for.cond.cleanup3
  %nl.024 = phi i32 [ %inc13, %for.cond.cleanup3 ], [ 0, %entry ]
  br label %for.body4
...
for.cond.cleanup3:                                ; preds = %for.inc.1
  ...
  %inc13 = add nuw nsw i32 %nl.024, 1
...
for.body4:                                        ; preds = %for.inc.1, %for.cond1.preheader
  ...
  %j.021 = phi i32 [ -1, %for.cond1.preheader ], [ %j.1.1, %for.inc.1 ]
...
if.then:                                          ; preds = %for.body4
  ...
  %arrayidx9 = getelementptr inbounds double, ptr @global_data, i64 %idxprom8
  store double %8, ptr %arrayidx9, align 8, !tbaa !5
  br label %for.inc

for.inc:                                          ; preds = %for.body4, %if.then
  %j.1 = phi i32 [ %inc, %if.then ], [ %j.021, %for.body4 ]
  %indvars.iv.next = or i64 %indvars.iv, 1
  ...
  %cmp5.1 = fcmp ogt double %9, 0.000000e+00
  br i1 %cmp5.1, label %if.then.1, label %for.inc.1

if.then.1:                                        ; preds = %for.inc
  %inc.1 = add nsw i32 %j.1, 1
  %idxprom8.1 = sext i32 %inc.1 to i64
  %arrayidx9.1 = getelementptr inbounds double, ptr @global_data, i64 %idxprom8.1
  store double %9, ptr %arrayidx9.1, align 8, !tbaa !5
  br label %for.inc.1
...
entry:
  %call = tail call i32 @init(ptr noundef nonnull @.str.91)
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
  %cmp23 = icmp sgt i32 %0, 0
  br i1 %cmp23, label %for.cond1.preheader, label %for.cond.cleanup
...
for.cond.cleanup:                                 ; preds = %for.cond.cleanup3, %entry
  %call15 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.138, double noundef 0.000000e+00)
  br label %for.body.i
...
if.then:                                          ; preds = %for.body4
  ...
  %arrayidx7 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %idxprom6
  %9 = load double, ptr %arrayidx7, align 8, !tbaa !5
  store double %9, ptr %arrayidx, align 16, !tbaa !5
  br label %for.inc
...
for.inc:                                          ; preds = %for.body4, %if.then
  ...
  %cmp5.1 = fcmp ogt double %10, 0.000000e+00
  br i1 %cmp5.1, label %if.then.1, label %for.inc.1

if.then.1:                                        ; preds = %for.inc
  %inc.1 = add nsw i32 %j.1, 1
  %idxprom6.1 = sext i32 %inc.1 to i64
  %arrayidx7.1 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %idxprom6.1
  %11 = load double, ptr %arrayidx7.1, align 8, !tbaa !5
  store double %11, ptr %arrayidx.1, align 8, !tbaa !5
  br label %for.inc.1
...
entry:
  %call = tail call i32 @init(ptr noundef nonnull @.str.92)
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
...
for.cond.cleanup:                                 ; preds = %for.cond.cleanup3, %entry
  %call27 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.139, double noundef 0.000000e+00)
...
for.cond5.preheader:                              ; preds = %for.cond1.preheader, %for.cond.cleanup7
  ...
  %k.038 = phi i32 [ -1, %for.cond1.preheader ], [ %k.2.1, %for.cond.cleanup7 ]
  br label %for.body8
...
for.body8:                                        ; preds = %for.inc.1, %for.cond5.preheader
  ...
  %k.136 = phi i32 [ %k.038, %for.cond5.preheader ], [ %k.2.1, %for.inc.1 ]
  ...
  %cmp11 = fcmp ogt double %7, 0.000000e+00
  br i1 %cmp11, label %if.then, label %for.inc

if.then:                                          ; preds = %for.body8
  %inc = add nsw i32 %k.136, 1
  %arrayidx15 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), i64 %indvars.iv, i64 %indvars.iv45
  %8 = load double, ptr %arrayidx15, align 8, !tbaa !5
  %idxprom16 = sext i32 %inc to i64
  %arrayidx17 = getelementptr inbounds [65536 x double], ptr @array, i64 0, i64 %idxprom16
  store double %8, ptr %arrayidx17, align 8, !tbaa !5
  br label %for.inc

for.inc:                                          ; preds = %for.body8, %if.then
  %k.2 = phi i32 [ %inc, %if.then ], [ %k.136, %for.body8 ]
  %indvars.iv.next = or i64 %indvars.iv, 1
  ...
  %cmp11.1 = fcmp ogt double %9, 0.000000e+00
  br i1 %cmp11.1, label %if.then.1, label %for.inc.1

if.then.1:                                        ; preds = %for.inc
  %inc.1 = add nsw i32 %k.2, 1
  %arrayidx15.1 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), i64 %indvars.iv.next, i64 %indvars.iv45
  %10 = load double, ptr %arrayidx15.1, align 8, !tbaa !5
  %idxprom16.1 = sext i32 %inc.1 to i64
  %arrayidx17.1 = getelementptr inbounds [65536 x double], ptr @array, i64 0, i64 %idxprom16.1
  store double %10, ptr %arrayidx17.1, align 8, !tbaa !5
  br label %for.inc.1
...
if.end.thread:                                    ; preds = %entry
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
  %call216 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.141, i32 noundef %0)
  br label %if.end7
...
if.end:                                           ; preds = %entry
  ...
  %call2 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.141, i32 noundef %conv.i)
...
if.then4:                                         ; preds = %if.end
  ...
  %call.i14 = call i64 @strtol(ptr nocapture noundef nonnull %2, ptr noundef null, i32 noundef 10) #15
  %conv.i15 = trunc i64 %call.i14 to i32
  store i32 %conv.i15, ptr @digits, align 4, !tbaa !17
  br label %if.end7
