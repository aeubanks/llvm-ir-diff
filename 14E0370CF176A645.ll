...
if.else:                                          ; preds = %entry
  ...
  store <4 x float> <float 0xC7EFFFFFE0000000, float 0xC7EFFFFFE0000000, float 0xC7EFFFFFE0000000, float 0xC7EFFFFFE0000000>, ptr %key, align 8, !tbaa !8
  %upper = getelementptr inbounds %struct.IndexEntry, ptr %call, i64 0, i32 1, i32 1
  store <4 x float> <float 0x47EFFFFFE0000000, float 0x47EFFFFFE0000000, float 0x47EFFFFFE0000000, float 0x47EFFFFFE0000000>, ptr %upper, align 8, !tbaa !8
  %next = getelementptr inbounds %struct.IndexEntry, ptr %call, i64 0, i32 2
