...
if.then:                                          ; preds = %for.body17
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %temp.sroa.0.16.sroa_idx.i, ptr noundef nonnull align 4 dereferenceable(16) %m_max23, i64 16, i1 false), !tbaa.struct !15
...
if.end:                                           ; preds = %entry
  ...
  %cmp757 = icmp sgt i32 %endIndex, %startIndex
  br i1 %cmp757, label %for.body.lr.ph, label %for.cond.cleanup
...
common.ret73:                                     ; preds = %for.cond.cleanup, %if.then
  ret void

for.cond.cleanup:                                 ; preds = %for.body, %if.end
  %node_bound.sroa.18.0.lcssa = phi float [ 0xC7EFFFFFE0000000, %if.end ], [ %cond109.i, %for.body ]
  %node_bound.sroa.9.0.lcssa = phi float [ 0x47EFFFFFE0000000, %if.end ], [ %cond50.i, %for.body ]
  ...
  %node_bound.sroa.9.0.arrayidx.i.i47.sroa_idx = getelementptr inbounds i8, ptr %arrayidx.i.i47, i64 8
  store float %node_bound.sroa.9.0.lcssa, ptr %node_bound.sroa.9.0.arrayidx.i.i47.sroa_idx, align 4, !tbaa.struct !33
  %node_bound.sroa.1256.0.arrayidx.i.i47.sroa_idx = getelementptr inbounds i8, ptr %arrayidx.i.i47, i64 16
  store <2 x float> %9, ptr %node_bound.sroa.1256.0.arrayidx.i.i47.sroa_idx, align 4
  %node_bound.sroa.18.0.arrayidx.i.i47.sroa_idx = getelementptr inbounds i8, ptr %arrayidx.i.i47, i64 24
  store float %node_bound.sroa.18.0.lcssa, ptr %node_bound.sroa.18.0.arrayidx.i.i47.sroa_idx, align 4, !tbaa.struct !34
...
for.body:                                         ; preds = %for.body.lr.ph, %for.body
  ...
  %node_bound.sroa.9.061 = phi float [ 0x47EFFFFFE0000000, %for.body.lr.ph ], [ %cond50.i, %for.body ]
  %node_bound.sroa.18.060 = phi float [ 0xC7EFFFFFE0000000, %for.body.lr.ph ], [ %cond109.i, %for.body ]
  ...
  %15 = load <2 x float>, ptr %arrayidx.i54, align 4, !tbaa !13
  ...
  %cmp40.i = fcmp ogt float %node_bound.sroa.9.061, %18
  %cond50.i = select i1 %cmp40.i, float %18, float %node_bound.sroa.9.061
  %m_max56.i = getelementptr inbounds %class.btAABB, ptr %arrayidx.i54, i64 0, i32 1
  %19 = load <2 x float>, ptr %m_max56.i, align 4, !tbaa !13
  ...
  %cmp99.i = fcmp olt float %node_bound.sroa.18.060, %22
  %cond109.i = select i1 %cmp99.i, float %22, float %node_bound.sroa.18.060
  %indvars.iv.next = add nsw i64 %indvars.iv, 1
...
entry:
  ...
  %0 = load i32, ptr %this, align 8, !tbaa !24
  %tobool.not84 = icmp eq i32 %0, 0
  br i1 %tobool.not84, label %while.end, label %while.body.lr.ph
...
if.then6:                                         ; preds = %while.body
  ...
  %temp_box.sroa.8.0.arrayidx.i.i.i28.sroa_idx = getelementptr inbounds i8, ptr %arrayidx.i.i.i28, i64 8
  %temp_box.sroa.8.0.copyload = load float, ptr %temp_box.sroa.8.0.arrayidx.i.i.i28.sroa_idx, align 4, !tbaa.struct !33
  %temp_box.sroa.1068.0.arrayidx.i.i.i28.sroa_idx = getelementptr inbounds i8, ptr %arrayidx.i.i.i28, i64 16
  %temp_box.sroa.14.0.arrayidx.i.i.i28.sroa_idx = getelementptr inbounds i8, ptr %arrayidx.i.i.i28, i64 24
  %temp_box.sroa.14.0.copyload = load float, ptr %temp_box.sroa.14.0.arrayidx.i.i.i28.sroa_idx, align 4, !tbaa.struct !34
  ...
  %cond50.i = select i1 %cmp40.i, float %temp_box.sroa.8.0.copyload, float 0x47EFFFFFE0000000
  %10 = load <2 x float>, ptr %temp_box.sroa.1068.0.arrayidx.i.i.i28.sroa_idx, align 4
  ...
  %cmp99.i = fcmp ogt float %temp_box.sroa.14.0.copyload, 0xC7EFFFFFE0000000
  %cond109.i = select i1 %cmp99.i, float %temp_box.sroa.14.0.copyload, float 0xC7EFFFFFE0000000
...
if.then9:                                         ; preds = %if.then6
  ...
  %temp_box.sroa.8.0.arrayidx.i.i.i35.sroa_idx = getelementptr inbounds i8, ptr %arrayidx.i.i.i35, i64 8
  %temp_box.sroa.8.0.copyload65 = load float, ptr %temp_box.sroa.8.0.arrayidx.i.i.i35.sroa_idx, align 4, !tbaa.struct !33
  %temp_box.sroa.1068.0.arrayidx.i.i.i35.sroa_idx = getelementptr inbounds i8, ptr %arrayidx.i.i.i35, i64 16
  %temp_box.sroa.14.0.arrayidx.i.i.i35.sroa_idx = getelementptr inbounds i8, ptr %arrayidx.i.i.i35, i64 24
  %temp_box.sroa.14.0.copyload73 = load float, ptr %temp_box.sroa.14.0.arrayidx.i.i.i35.sroa_idx, align 4, !tbaa.struct !34
  %16 = load <2 x float>, ptr %arrayidx.i.i.i35, align 4
  %17 = fcmp ogt <2 x float> %9, %16
  %18 = select <2 x i1> %17, <2 x float> %16, <2 x float> %9
  %cmp40.i44 = fcmp ogt float %cond50.i, %temp_box.sroa.8.0.copyload65
  %cond50.i45 = select i1 %cmp40.i44, float %temp_box.sroa.8.0.copyload65, float %cond50.i
  %19 = load <2 x float>, ptr %temp_box.sroa.1068.0.arrayidx.i.i.i35.sroa_idx, align 4
  %20 = fcmp olt <2 x float> %12, %19
  %21 = select <2 x i1> %20, <2 x float> %19, <2 x float> %12
  %cmp99.i56 = fcmp olt float %cond109.i, %temp_box.sroa.14.0.copyload73
  %cond109.i57 = select i1 %cmp99.i56, float %temp_box.sroa.14.0.copyload73, float %cond109.i
  br label %if.end10

if.end10:                                         ; preds = %if.then9, %if.then6
  %bound.sroa.28.1 = phi float [ %cond109.i57, %if.then9 ], [ %cond109.i, %if.then6 ]
  %bound.sroa.13.1 = phi float [ %cond50.i45, %if.then9 ], [ %cond50.i, %if.then6 ]
  %22 = phi <2 x float> [ %18, %if.then9 ], [ %9, %if.then6 ]
  %23 = phi <2 x float> [ %21, %if.then9 ], [ %12, %if.then6 ]
  %arrayidx.i.i.i60 = getelementptr inbounds %class.GIM_BVH_TREE_NODE, ptr %2, i64 %indvars.iv.next
  store <2 x float> %22, ptr %arrayidx.i.i.i60, align 4
  %bound.sroa.13.0.arrayidx.i.i.i60.sroa_idx = getelementptr inbounds i8, ptr %arrayidx.i.i.i60, i64 8
  store float %bound.sroa.13.1, ptr %bound.sroa.13.0.arrayidx.i.i.i60.sroa_idx, align 4, !tbaa.struct !33
  %bound.sroa.1879.0.arrayidx.i.i.i60.sroa_idx = getelementptr inbounds i8, ptr %arrayidx.i.i.i60, i64 16
  store <2 x float> %23, ptr %bound.sroa.1879.0.arrayidx.i.i.i60.sroa_idx, align 4
  %bound.sroa.28.0.arrayidx.i.i.i60.sroa_idx = getelementptr inbounds i8, ptr %arrayidx.i.i.i60, i64 24
  store float %bound.sroa.28.1, ptr %bound.sroa.28.0.arrayidx.i.i.i60.sroa_idx, align 4, !tbaa.struct !34
  br label %if.end11
