...
define dso_local void @error(ptr noundef %0, i32 noundef %1) local_unnamed_addr #0 {
  ...
  %4 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %3, ptr noundef nonnull @.str, ptr noundef %0) #5
...
define dso_local i32 @write_PPS(i32 noundef %0, i32 noundef %1) local_unnamed_addr #4 {
  %3 = tail call ptr @GeneratePic_parameter_set_NALU(i32 noundef %1) #6
  %4 = load ptr, ptr @WriteNALU, align 8, !tbaa !5
  %5 = tail call i32 %4(ptr noundef %3) #6
  %6 = add nsw i32 %5, %0
  tail call void @FreeNALU(ptr noundef %3) #6
  ret i32 %6
}
...
define dso_local i32 @start_sequence() local_unnamed_addr #4 {
  ...
  %2 = getelementptr inbounds %struct.InputParameters, ptr %1, i64 0, i32 34
  %3 = load i32, ptr %2, align 8, !tbaa !9
  %4 = icmp ne i32 %3, 0
  %5 = getelementptr inbounds %struct.InputParameters, ptr %1, i64 0, i32 75
...
7:                                                ; preds = %0
  %8 = getelementptr inbounds %struct.InputParameters, ptr %1, i64 0, i32 26
  tail call void @OpenAnnexbFile(ptr noundef nonnull %8) #6
  br label %15

9:                                                ; preds = %0
  %10 = getelementptr inbounds %struct.InputParameters, ptr %1, i64 0, i32 26
  tail call void @OpenRTPFile(ptr noundef nonnull %10) #6
  br label %15

11:                                               ; preds = %0
  %12 = tail call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef nonnull dereferenceable(1) @errortext, i64 noundef 300, ptr noundef nonnull @.str.1, i32 noundef %6) #6
  %13 = load ptr, ptr @stderr, align 8, !tbaa !5
  %14 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %13, ptr noundef nonnull @.str, ptr noundef nonnull @errortext) #5
  tail call void @flush_dpb() #6
  tail call void @exit(i32 noundef 1) #7
  unreachable
...
15:                                               ; preds = %9, %7
  ...
  store ptr %16, ptr @WriteNALU, align 8, !tbaa !5
  %17 = tail call ptr @GenerateSeq_parameter_set_NALU() #6
  %18 = load ptr, ptr @WriteNALU, align 8, !tbaa !5
  %19 = tail call i32 %18(ptr noundef %17) #6
  tail call void @FreeNALU(ptr noundef %17) #6
  br label %20

20:                                               ; preds = %15, %20
  %21 = phi i32 [ %19, %15 ], [ %26, %20 ]
  %22 = phi i32 [ 0, %15 ], [ %27, %20 ]
  %23 = tail call ptr @GeneratePic_parameter_set_NALU(i32 noundef %22) #6
  %24 = load ptr, ptr @WriteNALU, align 8, !tbaa !5
  %25 = tail call i32 %24(ptr noundef %23) #6
  %26 = add nsw i32 %25, %21
  tail call void @FreeNALU(ptr noundef %23) #6
...
30:                                               ; preds = %20
  ...
  %32 = getelementptr inbounds %struct.InputParameters, ptr %31, i64 0, i32 35
  %33 = load i32, ptr %32, align 4, !tbaa !16
  %34 = icmp eq i32 %33, 0
  br i1 %34, label %40, label %35

35:                                               ; preds = %30
  %36 = tail call ptr (...) @GenerateSEImessage_NALU() #6
  %37 = load ptr, ptr @WriteNALU, align 8, !tbaa !5
  %38 = tail call i32 %37(ptr noundef %36) #6
  %39 = add nsw i32 %38, %26
  tail call void @FreeNALU(ptr noundef %36) #6
  br label %40

40:                                               ; preds = %35, %30
  %41 = phi i32 [ %39, %35 ], [ %26, %30 ]
  %42 = load ptr, ptr @stats, align 8, !tbaa !5
  %43 = getelementptr inbounds %struct.StatParameters, ptr %42, i64 0, i32 35
...
define dso_local i32 @rewrite_paramsets() local_unnamed_addr #4 {
  ...
  %3 = load i32, ptr %2, align 8, !tbaa !9
  %4 = icmp ne i32 %3, 0
  %5 = tail call ptr @GenerateSeq_parameter_set_NALU() #6
  %6 = load ptr, ptr @WriteNALU, align 8, !tbaa !5
  %7 = tail call i32 %6(ptr noundef %5) #6
  tail call void @FreeNALU(ptr noundef %5) #6
  br label %8

8:                                                ; preds = %0, %8
  %9 = phi i32 [ 0, %0 ], [ %15, %8 ]
  %10 = phi i32 [ %7, %0 ], [ %14, %8 ]
  %11 = tail call ptr @GeneratePic_parameter_set_NALU(i32 noundef %9) #6
  %12 = load ptr, ptr @WriteNALU, align 8, !tbaa !5
  %13 = tail call i32 %12(ptr noundef %11) #6
  %14 = add nsw i32 %13, %10
  tail call void @FreeNALU(ptr noundef %11) #6
  %15 = add nuw nsw i32 %9, 1
  %16 = icmp ult i32 %9, 2
  %17 = and i1 %4, %16
  br i1 %17, label %8, label %18, !llvm.loop !21

18:                                               ; preds = %8
  %19 = load ptr, ptr @input, align 8, !tbaa !5
  %20 = getelementptr inbounds %struct.InputParameters, ptr %19, i64 0, i32 35
  %21 = load i32, ptr %20, align 4, !tbaa !16
  %22 = icmp eq i32 %21, 0
  br i1 %22, label %28, label %23

23:                                               ; preds = %18
  %24 = tail call ptr (...) @GenerateSEImessage_NALU() #6
  %25 = load ptr, ptr @WriteNALU, align 8, !tbaa !5
  %26 = tail call i32 %25(ptr noundef %24) #6
  %27 = add nsw i32 %26, %14
  tail call void @FreeNALU(ptr noundef %24) #6
  br label %28

28:                                               ; preds = %23, %18
  %29 = phi i32 [ %27, %23 ], [ %14, %18 ]
  %30 = load ptr, ptr @stats, align 8, !tbaa !5
  %31 = getelementptr inbounds %struct.StatParameters, ptr %30, i64 0, i32 35
...
define dso_local i32 @terminate_sequence() local_unnamed_addr #4 {
  %1 = load ptr, ptr @input, align 8, !tbaa !5
  %2 = getelementptr inbounds %struct.InputParameters, ptr %1, i64 0, i32 75
...
6:                                                ; preds = %0
  %7 = tail call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef nonnull dereferenceable(1) @errortext, i64 noundef 300, ptr noundef nonnull @.str.1, i32 noundef %3) #6
  %8 = load ptr, ptr @stderr, align 8, !tbaa !5
  %9 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %8, ptr noundef nonnull @.str, ptr noundef nonnull @errortext) #5
  tail call void @flush_dpb() #6
  tail call void @exit(i32 noundef 1) #7
  unreachable
