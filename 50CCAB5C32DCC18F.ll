...
if.then7:                                         ; preds = %for.end
  %arrayidx.le = getelementptr inbounds i16, ptr %r, i64 %indvars.iv
...
if.then7.i.i:                                     ; preds = %for.end.i.i
  %arrayidx.i.i.le = getelementptr inbounds i16, ptr %call.i.i, i64 %indvars.iv.i.i
  %conv8.i.i = trunc i32 %7 to i16
  store i16 %conv8.i.i, ptr %arrayidx.i.i.le, align 2, !tbaa !5
  br label %if.end.i
