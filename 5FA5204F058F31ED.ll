; ModuleID = '/usr/local/google/home/aeubanks/repos/test-suite/Bitcode/Benchmarks/Halide/common/x86_halide_runtime.bc'
...
while.end:                                        ; preds = %while.body, %while.cond.preheader
  %14 = phi i32 [ %7, %while.cond.preheader ], [ %13, %while.body ]
  ...
  %15 = load ptr, ptr getelementptr inbounds (%"struct.Halide::Runtime::Internal::work_queue_t", ptr @_ZN6Halide7Runtime8Internal10work_queueE, i64 0, i32 1), align 8, !tbaa !26
  %tobool9 = icmp eq ptr %15, null
  %cmp10 = icmp sgt i32 %14, %size
  %or.cond = and i1 %cmp10, %tobool9
  %storemerge = select i1 %or.cond, i32 %size, i32 %14
  ...
  store i64 %16, ptr %job, align 8, !tbaa !39
  ...
  %17 = load i32, ptr getelementptr inbounds (%"struct.Halide::Runtime::Internal::work_queue_t", ptr @_ZN6Halide7Runtime8Internal10work_queueE, i64 0, i32 3), align 4, !tbaa !38
  %18 = load i32, ptr getelementptr inbounds (%"struct.Halide::Runtime::Internal::work_queue_t", ptr @_ZN6Halide7Runtime8Internal10work_queueE, i64 0, i32 2), align 8, !tbaa !29
...
if.end15:                                         ; preds = %if.then14, %while.end
  ...
  %19 = load i32, ptr %exit_status, align 4, !tbaa !36
...
for.body66:                                       ; preds = %cleanup182, %for.body66.lr.ph
  %18 = phi i32 [ %17, %for.body66.lr.ph ], [ %48, %cleanup182 ]
...
while.end116:                                     ; preds = %while.body114, %if.end106
  %.lcssa = phi i64 [ %30, %if.end106 ], [ %31, %while.body114 ]
  %call.i406.sink.lcssa = phi ptr [ %call.i406, %if.end106 ], [ %call.i414, %while.body114 ]
...
if.then118:                                       ; preds = %while.end116
  ...
  %32 = load i64, ptr %active_threads_numerator120, align 8, !tbaa !60
  %conv121 = uitofp i64 %32 to double
  %active_threads_denominator122 = getelementptr inbounds %struct.halide_profiler_func_stats, ptr %19, i64 %indvars.iv594, i32 6
  %33 = load i64, ptr %active_threads_denominator122, align 8, !tbaa !61
  %conv123 = uitofp i64 %33 to double
...
if.end136:                                        ; preds = %while.body133, %if.then118, %while.end116
  %sstr.sroa.16.5 = phi i64 [ %.lcssa, %while.end116 ], [ %sstr.sroa.16.4573, %if.then118 ], [ %sstr.sroa.16.4, %while.body133 ]
  %cursor.0 = phi i64 [ 58, %while.end116 ], [ 73, %if.then118 ], [ 73, %while.body133 ]
  %num_allocs138 = getelementptr inbounds %struct.halide_profiler_func_stats, ptr %19, i64 %indvars.iv594, i32 8
  %34 = load i32, ptr %num_allocs138, align 8, !tbaa !62
  %cmp139 = icmp eq i32 %34, 0
...
if.then140:                                       ; preds = %if.end136
  ...
  %35 = load i64, ptr %memory_total141, align 8, !tbaa !63
  %conv143 = sext i32 %34 to i64
  %div144 = udiv i64 %35, %conv143
  br label %if.end146
...
if.end146:                                        ; preds = %if.then140, %if.end136
  ...
  %36 = load i64, ptr %memory_peak147, align 8, !tbaa !64
  %tobool148 = icmp eq i64 %36, 0
  br i1 %tobool148, label %if.end172, label %if.then149

if.then149:                                       ; preds = %if.end146
  %37 = inttoptr i64 %sstr.sroa.16.5 to ptr
  %call.i442 = call ptr @halide_string_to_string(ptr %37, ptr nonnull %add.ptr.i, ptr nonnull @.str.25) #17
  %38 = load i64, ptr %memory_peak147, align 8, !tbaa !64
  %call.i436 = call ptr @halide_uint64_to_string(ptr %call.i442, ptr nonnull %add.ptr.i, i64 %38, i32 1) #17
  %39 = ptrtoint ptr %call.i436 to i64
  %sub.ptr.sub.i433578 = sub i64 %39, %0
...
while.body157:                                    ; preds = %if.then149, %while.body157
  ...
  %40 = ptrtoint ptr %call.i429 to i64
  %sub.ptr.sub.i433 = sub i64 %40, %0
...
while.end159:                                     ; preds = %while.body157, %if.then149
  ...
  %41 = load i32, ptr %num_allocs138, align 8, !tbaa !62
  %conv.i392 = sext i32 %41 to i64
...
while.end169:                                     ; preds = %while.body167, %while.end159
  ...
  %42 = ptrtoint ptr %call.i356 to i64
  br label %if.end172

if.end172:                                        ; preds = %while.end169, %if.end146
  %sstr.sroa.16.8 = phi i64 [ %sstr.sroa.16.5, %if.end146 ], [ %42, %while.end169 ]
  %stack_peak173 = getelementptr inbounds %struct.halide_profiler_func_stats, ptr %19, i64 %indvars.iv594, i32 4
  %43 = load i64, ptr %stack_peak173, align 8, !tbaa !56
  %cmp174 = icmp eq i64 %43, 0
  br i1 %cmp174, label %if.end179, label %if.then175

if.then175:                                       ; preds = %if.end172
  %44 = inttoptr i64 %sstr.sroa.16.8 to ptr
  %call.i350 = call ptr @halide_string_to_string(ptr %44, ptr nonnull %add.ptr.i, ptr nonnull @.str.28) #17
  %45 = load i64, ptr %stack_peak173, align 8, !tbaa !56
  %call.i282 = call ptr @halide_uint64_to_string(ptr %call.i350, ptr nonnull %add.ptr.i, i64 %45, i32 1) #17
  %46 = ptrtoint ptr %call.i282 to i64
  br label %if.end179

if.end179:                                        ; preds = %if.then175, %if.end172
  %sstr.sroa.16.9 = phi i64 [ %sstr.sroa.16.8, %if.end172 ], [ %46, %if.then175 ]
  %47 = inttoptr i64 %sstr.sroa.16.9 to ptr
  %call.i = call ptr @halide_string_to_string(ptr %47, ptr nonnull %add.ptr.i, ptr nonnull @.str.25.50) #17
  call void @halide_print(ptr %user_context, ptr nonnull %line_buf) #17
  %.pre = load i32, ptr %num_funcs63, align 8, !tbaa !54
  br label %cleanup182

cleanup182:                                       ; preds = %if.end179, %land.lhs.true
  %48 = phi i32 [ %18, %land.lhs.true ], [ %.pre, %if.end179 ]
  %indvars.iv.next595 = add nuw nsw i64 %indvars.iv594, 1
  %49 = sext i32 %48 to i64
  %cmp64 = icmp slt i64 %indvars.iv.next595, %49
...
vector.body.preheader:                            ; preds = %min.iters.checked
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(1) %scevgep7, i8 0, i64 %14, i1 false), !tbaa !8
