; ModuleID = '/usr/local/google/home/aeubanks/repos/test-suite/Bitcode/simd_ops/x86_tests/test_op_pminsb_305.bc'
...
@str.11 = private constant [14 x i8] c"op_pminsb_305\00", align 32
...
define i32 @__test_op(ptr noalias nocapture readnone %in_f32.buffer, ptr noalias nocapture readnone %in_f64.buffer, ptr noalias nocapture readonly %in_i8.buffer, ptr noalias nocapture readnone %in_u8.buffer, ptr noalias nocapture readnone %in_i16.buffer, ptr noalias nocapture readnone %in_u16.buffer, ptr noalias nocapture readnone %in_i32.buffer, ptr noalias nocapture readnone %in_u32.buffer, ptr noalias nocapture readnone %in_i64.buffer, ptr noalias nocapture readnone %in_u64.buffer, ptr noalias nocapture readonly %op_pminsb_305.buffer) local_unnamed_addr #0 {
"produce op_pminsb_305":
  %buf_extent168 = getelementptr inbounds %struct.buffer_t, ptr %op_pminsb_305.buffer, i64 0, i32 2, i64 1
  %op_pminsb_305.extent.1 = load i32, ptr %buf_extent168, align 4
  %buf_min176 = getelementptr inbounds %struct.buffer_t, ptr %op_pminsb_305.buffer, i64 0, i32 4, i64 1
  %op_pminsb_305.min.1 = load i32, ptr %buf_min176, align 4
  %0 = add nsw i32 %op_pminsb_305.min.1, %op_pminsb_305.extent.1
  %1 = icmp sgt i32 %op_pminsb_305.extent.1, 0
  br i1 %1, label %"for op_pminsb_305.s0.y.preheader", label %destructor_block, !prof !4

"for op_pminsb_305.s0.y.preheader":               ; preds = %"produce op_pminsb_305"
  %buf_host27 = getelementptr inbounds %struct.buffer_t, ptr %in_i8.buffer, i64 0, i32 1
  %in_i8.host = load ptr, ptr %buf_host27, align 8
  %buf_min175 = getelementptr inbounds %struct.buffer_t, ptr %op_pminsb_305.buffer, i64 0, i32 4, i64 0
  %op_pminsb_305.min.0 = load i32, ptr %buf_min175, align 4
  %2 = sext i32 %op_pminsb_305.min.0 to i64
  %buf_stride172 = getelementptr inbounds %struct.buffer_t, ptr %op_pminsb_305.buffer, i64 0, i32 3, i64 1
  %op_pminsb_305.stride.1 = load i32, ptr %buf_stride172, align 4
  %3 = sext i32 %op_pminsb_305.stride.1 to i64
  %buf_host163 = getelementptr inbounds %struct.buffer_t, ptr %op_pminsb_305.buffer, i64 0, i32 1
  %op_pminsb_305.host = load ptr, ptr %buf_host163, align 8
  %4 = shl nsw i64 %2, 3
  %5 = sub nsw i64 224, %4
  %scevgep = getelementptr i8, ptr %op_pminsb_305.host, i64 %5
  %6 = shl nsw i64 %3, 3
  %sunkaddr = ptrtoint ptr %in_i8.host to i64
  %a137 = load <32 x i8>, ptr %in_i8.host, align 32, !tbaa !5
  %sunkaddr215 = add i64 %sunkaddr, 16
  %sunkaddr216 = inttoptr i64 %sunkaddr215 to ptr
  %b158 = load <32 x i8>, ptr %sunkaddr216, align 16, !tbaa !5
  %7 = tail call <32 x i8> @llvm.smin.v32i8(<32 x i8> %b158, <32 x i8> %a137)
  ...
  %a137.1 = load <32 x i8>, ptr %sunkaddr212.1, align 32, !tbaa !5
  %sunkaddr215.1 = add i64 %sunkaddr, 48
  %sunkaddr216.1 = inttoptr i64 %sunkaddr215.1 to ptr
  %b158.1 = load <32 x i8>, ptr %sunkaddr216.1, align 16, !tbaa !5
  %17 = tail call <32 x i8> @llvm.smin.v32i8(<32 x i8> %b158.1, <32 x i8> %a137.1)
  ...
  %a137.2 = load <32 x i8>, ptr %sunkaddr212.2, align 32, !tbaa !5
  %sunkaddr215.2 = add i64 %sunkaddr, 80
  %sunkaddr216.2 = inttoptr i64 %sunkaddr215.2 to ptr
  %b158.2 = load <32 x i8>, ptr %sunkaddr216.2, align 16, !tbaa !5
  %27 = tail call <32 x i8> @llvm.smin.v32i8(<32 x i8> %b158.2, <32 x i8> %a137.2)
  ...
  %a137.3 = load <32 x i8>, ptr %sunkaddr212.3, align 32, !tbaa !5
  %sunkaddr215.3 = add i64 %sunkaddr, 112
  %sunkaddr216.3 = inttoptr i64 %sunkaddr215.3 to ptr
  %b158.3 = load <32 x i8>, ptr %sunkaddr216.3, align 16, !tbaa !5
  %37 = tail call <32 x i8> @llvm.smin.v32i8(<32 x i8> %b158.3, <32 x i8> %a137.3)
  ...
  %a137.4 = load <32 x i8>, ptr %sunkaddr212.4, align 32, !tbaa !5
  %sunkaddr215.4 = add i64 %sunkaddr, 144
  %sunkaddr216.4 = inttoptr i64 %sunkaddr215.4 to ptr
  %b158.4 = load <32 x i8>, ptr %sunkaddr216.4, align 16, !tbaa !5
  %47 = tail call <32 x i8> @llvm.smin.v32i8(<32 x i8> %b158.4, <32 x i8> %a137.4)
  ...
  br label %"for op_pminsb_305.s0.x.x.preheader"

"for op_pminsb_305.s0.x.x.preheader":             ; preds = %"for op_pminsb_305.s0.x.x.preheader", %"for op_pminsb_305.s0.y.preheader"
  %lsr.iv180 = phi ptr [ %scevgep, %"for op_pminsb_305.s0.y.preheader" ], [ %scevgep182, %"for op_pminsb_305.s0.x.x.preheader" ]
  %op_pminsb_305.s0.y = phi i32 [ %op_pminsb_305.min.1, %"for op_pminsb_305.s0.y.preheader" ], [ %87, %"for op_pminsb_305.s0.x.x.preheader" ]
  ...
  %a137.5 = load <32 x i8>, ptr %sunkaddr212.5, align 32, !tbaa !5
  %b158.5 = load <32 x i8>, ptr %sunkaddr216.5, align 16, !tbaa !5
  %57 = tail call <32 x i8> @llvm.smin.v32i8(<32 x i8> %b158.5, <32 x i8> %a137.5)
  ...
  %a137.6 = load <32 x i8>, ptr %sunkaddr212.6, align 32, !tbaa !5
  %b158.6 = load <32 x i8>, ptr %sunkaddr216.6, align 16, !tbaa !5
  %67 = tail call <32 x i8> @llvm.smin.v32i8(<32 x i8> %b158.6, <32 x i8> %a137.6)
  ...
  %a137.7 = load <32 x i8>, ptr %sunkaddr212.7, align 32, !tbaa !5
  %b158.7 = load <32 x i8>, ptr %sunkaddr216.7, align 16, !tbaa !5
  %77 = tail call <32 x i8> @llvm.smin.v32i8(<32 x i8> %b158.7, <32 x i8> %a137.7)
  ...
  %87 = add nsw i32 %op_pminsb_305.s0.y, 1
  %scevgep182 = getelementptr i1, ptr %lsr.iv180, i64 %6
  %.not2 = icmp eq i32 %87, %0
  br i1 %.not2, label %destructor_block, label %"for op_pminsb_305.s0.x.x.preheader"

destructor_block:                                 ; preds = %"for op_pminsb_305.s0.x.x.preheader", %"produce op_pminsb_305"
  ret i32 0
}

; Function Attrs: nofree nosync nounwind memory(readwrite, inaccessiblemem: none)
define i32 @test_op(ptr noalias nocapture readnone %in_f32.buffer, ptr noalias nocapture readnone %in_f64.buffer, ptr noalias nocapture readonly %in_i8.buffer, ptr noalias nocapture readnone %in_u8.buffer, ptr noalias nocapture readnone %in_i16.buffer, ptr noalias nocapture readnone %in_u16.buffer, ptr noalias nocapture readnone %in_i32.buffer, ptr noalias nocapture readnone %in_u32.buffer, ptr noalias nocapture readnone %in_i64.buffer, ptr noalias nocapture readnone %in_u64.buffer, ptr noalias nocapture readonly %op_pminsb_305.buffer) local_unnamed_addr #1 {
destructor_block:
  %"__test_op_result$19" = tail call i32 @__test_op(ptr poison, ptr poison, ptr %in_i8.buffer, ptr poison, ptr poison, ptr poison, ptr poison, ptr poison, ptr poison, ptr poison, ptr %op_pminsb_305.buffer) #4
  ret i32 0
}
