...
for.cond.preheader.i:                             ; preds = %if.then2
  ...
  br i1 %cmp18.i, label %for.body.lr.ph.i, label %for.end.i
...
for.body.i:                                       ; preds = %for.body.i, %for.body.lr.ph.i
  ...
  br i1 %cmp.i, label %for.body.i, label %for.end.i, !llvm.loop !89
...
if.end6:                                          ; preds = %for.end.i, %if.then, %entry
  ...
  %cmp16946 = icmp sgt i32 %17, 0
  br i1 %cmp16946, label %for.body.lr.ph, label %for.end267
...
for.body:                                         ; preds = %for.body.lr.ph, %for.inc265
  ...
  %get_buffer.0948 = phi i64 [ %15, %for.body.lr.ph ], [ %get_buffer.21, %for.inc265 ]
  %bits_left.0947 = phi i32 [ %16, %for.body.lr.ph ], [ %bits_left.21, %for.inc265 ]
  ...
  %cmp25 = icmp slt i32 %bits_left.0947, 8
...
while.body.i:                                     ; preds = %if.end59.i, %if.then26
  ...
  %bits_left.addr.0111.i = phi i32 [ %bits_left.0947, %if.then26 ], [ %add.i445, %if.end59.i ]
  %get_buffer.addr.0110.i = phi i64 [ %get_buffer.0948, %if.then26 ], [ %or.i, %if.end59.i ]
  %29 = load i32, ptr %unread_marker11, align 8, !tbaa !48
...
if.then21.i:                                      ; preds = %do.body.i
  %37 = load ptr, ptr %src23.i, align 8, !tbaa !50
  %fill_input_buffer24.i = getelementptr inbounds %struct.jpeg_source_mgr, ptr %37, i64 0, i32 3
  %38 = load ptr, ptr %fill_input_buffer24.i, align 8, !tbaa !51
...
if.end29.i:                                       ; preds = %if.then21.i
  %39 = load ptr, ptr %src23.i, align 8, !tbaa !50
  %40 = load ptr, ptr %39, align 8, !tbaa !53
  %bytes_in_buffer35.i = getelementptr inbounds %struct.jpeg_source_mgr, ptr %39, i64 0, i32 1
  %41 = load i64, ptr %bytes_in_buffer35.i, align 8, !tbaa !54
  br label %if.end36.i
...
if.end36:                                         ; preds = %while.end.i.thread, %while.end.i, %for.body
  %bits_left.1 = phi i32 [ %bits_left.addr.0111.i, %while.end.i ], [ %bits_left.0947, %for.body ], [ %add.i445, %while.end.i.thread ]
  %get_buffer.1 = phi i64 [ %get_buffer.addr.0110.i, %while.end.i ], [ %get_buffer.0948, %for.body ], [ %or.i, %while.end.i.thread ]
...
if.end50:                                         ; preds = %label1
  %48 = load i64, ptr %get_buffer63.i, align 8, !tbaa !61
  %49 = load i32, ptr %bits_left64.i, align 8, !tbaa !62
  br label %cleanup.cont

cleanup.cont:                                     ; preds = %if.end50, %if.then41
  %bits_left.4 = phi i32 [ %49, %if.end50 ], [ %sub42, %if.then41 ]
  %get_buffer.4 = phi i64 [ %48, %if.end50 ], [ %get_buffer.1, %if.then41 ]
...
if.then59:                                        ; preds = %if.then56
  %50 = load ptr, ptr %br_state, align 8, !tbaa !45
  %51 = load i64, ptr %bytes_in_buffer10, align 8, !tbaa !47
  %cmp109.i449 = icmp slt i32 %bits_left.4, 25
  br i1 %cmp109.i449, label %while.body.i459.preheader, label %while.end.i519

while.body.i459.preheader:                        ; preds = %if.then59
  %52 = load ptr, ptr %cinfo7, align 8
  %src.i462 = getelementptr inbounds %struct.jpeg_decompress_struct, ptr %52, i64 0, i32 5
  %53 = load ptr, ptr %printed_eod_ptr, align 8
  br label %while.body.i459

while.body.i459:                                  ; preds = %while.body.i459.preheader, %if.end59.i512
  %bytes_in_buffer.0113.i454 = phi i64 [ %bytes_in_buffer.5.i506, %if.end59.i512 ], [ %51, %while.body.i459.preheader ]
  %next_input_byte.0112.i455 = phi ptr [ %next_input_byte.5.i505, %if.end59.i512 ], [ %50, %while.body.i459.preheader ]
  %bits_left.addr.0111.i456 = phi i32 [ %add.i510, %if.end59.i512 ], [ %bits_left.4, %while.body.i459.preheader ]
  %get_buffer.addr.0110.i457 = phi i64 [ %or.i509, %if.end59.i512 ], [ %get_buffer.4, %while.body.i459.preheader ]
  %54 = load i32, ptr %unread_marker11, align 8, !tbaa !48
  %cmp3.not.i458 = icmp eq i32 %54, 0
...
if.then5.i466:                                    ; preds = %if.end.i461
  %55 = load ptr, ptr %src.i462, align 8, !tbaa !50
  %fill_input_buffer.i463 = getelementptr inbounds %struct.jpeg_source_mgr, ptr %55, i64 0, i32 3
  %56 = load ptr, ptr %fill_input_buffer.i463, align 8, !tbaa !51
  %call.i464 = tail call i32 %56(ptr noundef %52) #4
...
if.end8.i469:                                     ; preds = %if.then5.i466
  %57 = load ptr, ptr %src.i462, align 8, !tbaa !50
  %58 = load ptr, ptr %57, align 8, !tbaa !53
  %bytes_in_buffer14.i468 = getelementptr inbounds %struct.jpeg_source_mgr, ptr %57, i64 0, i32 1
  %59 = load i64, ptr %bytes_in_buffer14.i468, align 8, !tbaa !54
  br label %if.end15.i476

if.end15.i476:                                    ; preds = %if.end8.i469, %if.end.i461
  %next_input_byte.1.i470 = phi ptr [ %58, %if.end8.i469 ], [ %next_input_byte.0112.i455, %if.end.i461 ]
  %bytes_in_buffer.1.i471 = phi i64 [ %59, %if.end8.i469 ], [ %bytes_in_buffer.0113.i454, %if.end.i461 ]
  %dec.i472 = add i64 %bytes_in_buffer.1.i471, -1
  %incdec.ptr.i473 = getelementptr inbounds i8, ptr %next_input_byte.1.i470, i64 1
  %60 = load i8, ptr %next_input_byte.1.i470, align 1, !tbaa !19
  %conv.i474 = zext i8 %60 to i64
  %cmp16.i475 = icmp eq i8 %60, -1
  br i1 %cmp16.i475, label %do.body.i480.preheader, label %if.end59.i512

do.body.i480.preheader:                           ; preds = %if.end15.i476
  %61 = load ptr, ptr %cinfo7, align 8
  %src23.i481 = getelementptr inbounds %struct.jpeg_decompress_struct, ptr %61, i64 0, i32 5
  br label %do.body.i480

do.body.i480:                                     ; preds = %do.body.i480.preheader, %if.end36.i493
  %next_input_byte.2.i477 = phi ptr [ %incdec.ptr38.i492, %if.end36.i493 ], [ %incdec.ptr.i473, %do.body.i480.preheader ]
  %bytes_in_buffer.2.i478 = phi i64 [ %dec37.i491, %if.end36.i493 ], [ %dec.i472, %do.body.i480.preheader ]
...
if.then21.i485:                                   ; preds = %do.body.i480
  %62 = load ptr, ptr %src23.i481, align 8, !tbaa !50
  ...
  %call26.i483 = tail call i32 %63(ptr noundef %61) #4
...
if.end29.i488:                                    ; preds = %if.then21.i485
  %64 = load ptr, ptr %src23.i481, align 8, !tbaa !50
...
if.end49.i501:                                    ; preds = %no_more_data.i499
  ...
  %tobool50.not.i500 = icmp eq i32 %68, 0
  br i1 %tobool50.not.i500, label %if.then51.i504, label %if.end59.i512

if.then51.i504:                                   ; preds = %if.end49.i501
  %69 = load ptr, ptr %52, align 8, !tbaa !56
  %msg_code.i502 = getelementptr inbounds %struct.jpeg_error_mgr, ptr %69, i64 0, i32 5
  store i32 113, ptr %msg_code.i502, align 8, !tbaa !57
  %emit_message.i503 = getelementptr inbounds %struct.jpeg_error_mgr, ptr %69, i64 0, i32 1
  %70 = load ptr, ptr %emit_message.i503, align 8, !tbaa !59
...
while.end.i519:                                   ; preds = %if.end59.i512, %no_more_data.i499, %if.then59
  ...
  %next_input_byte.6.i515 = phi ptr [ %50, %if.then59 ], [ %next_input_byte.5.i505, %if.end59.i512 ], [ %next_input_byte.4.i496, %no_more_data.i499 ]
  %bytes_in_buffer.6.i516 = phi i64 [ %51, %if.then59 ], [ %bytes_in_buffer.5.i506, %if.end59.i512 ], [ %bytes_in_buffer.4.i497, %no_more_data.i499 ]
...
for.body97:                                       ; preds = %if.end82, %for.inc
  %k.0942 = phi i32 [ %inc, %for.inc ], [ 1, %if.end82 ]
  %get_buffer.7941 = phi i64 [ %get_buffer.13, %for.inc ], [ %get_buffer.6, %if.end82 ]
  %bits_left.7940 = phi i32 [ %bits_left.13, %for.inc ], [ %bits_left.6, %if.end82 ]
  %cmp100 = icmp slt i32 %bits_left.7940, 8
  br i1 %cmp100, label %if.then102, label %if.end113

if.then102:                                       ; preds = %for.body97
  %76 = load ptr, ptr %br_state, align 8, !tbaa !45
  %77 = load i64, ptr %bytes_in_buffer10, align 8, !tbaa !47
  %78 = load ptr, ptr %cinfo7, align 8
  %src.i536 = getelementptr inbounds %struct.jpeg_decompress_struct, ptr %78, i64 0, i32 5
  %79 = load ptr, ptr %printed_eod_ptr, align 8
  br label %while.body.i533

while.body.i533:                                  ; preds = %if.end59.i586, %if.then102
  %bytes_in_buffer.0113.i528 = phi i64 [ %77, %if.then102 ], [ %bytes_in_buffer.5.i580, %if.end59.i586 ]
  %next_input_byte.0112.i529 = phi ptr [ %76, %if.then102 ], [ %next_input_byte.5.i579, %if.end59.i586 ]
  %bits_left.addr.0111.i530 = phi i32 [ %bits_left.7940, %if.then102 ], [ %add.i584, %if.end59.i586 ]
  %get_buffer.addr.0110.i531 = phi i64 [ %get_buffer.7941, %if.then102 ], [ %or.i583, %if.end59.i586 ]
  %80 = load i32, ptr %unread_marker11, align 8, !tbaa !48
  %cmp3.not.i532 = icmp eq i32 %80, 0
...
if.then5.i540:                                    ; preds = %if.end.i535
  %81 = load ptr, ptr %src.i536, align 8, !tbaa !50
  %fill_input_buffer.i537 = getelementptr inbounds %struct.jpeg_source_mgr, ptr %81, i64 0, i32 3
  %82 = load ptr, ptr %fill_input_buffer.i537, align 8, !tbaa !51
  %call.i538 = tail call i32 %82(ptr noundef %78) #4
...
if.end8.i543:                                     ; preds = %if.then5.i540
  ...
  %bytes_in_buffer14.i542 = getelementptr inbounds %struct.jpeg_source_mgr, ptr %83, i64 0, i32 1
  %85 = load i64, ptr %bytes_in_buffer14.i542, align 8, !tbaa !54
  br label %if.end15.i550

if.end15.i550:                                    ; preds = %if.end8.i543, %if.end.i535
  %next_input_byte.1.i544 = phi ptr [ %84, %if.end8.i543 ], [ %next_input_byte.0112.i529, %if.end.i535 ]
  %bytes_in_buffer.1.i545 = phi i64 [ %85, %if.end8.i543 ], [ %bytes_in_buffer.0113.i528, %if.end.i535 ]
  %dec.i546 = add i64 %bytes_in_buffer.1.i545, -1
  %incdec.ptr.i547 = getelementptr inbounds i8, ptr %next_input_byte.1.i544, i64 1
  %86 = load i8, ptr %next_input_byte.1.i544, align 1, !tbaa !19
  %conv.i548 = zext i8 %86 to i64
  %cmp16.i549 = icmp eq i8 %86, -1
  br i1 %cmp16.i549, label %do.body.i554.preheader, label %if.end59.i586

do.body.i554.preheader:                           ; preds = %if.end15.i550
  %87 = load ptr, ptr %cinfo7, align 8
  %src23.i555 = getelementptr inbounds %struct.jpeg_decompress_struct, ptr %87, i64 0, i32 5
  br label %do.body.i554

do.body.i554:                                     ; preds = %do.body.i554.preheader, %if.end36.i567
  %next_input_byte.2.i551 = phi ptr [ %incdec.ptr38.i566, %if.end36.i567 ], [ %incdec.ptr.i547, %do.body.i554.preheader ]
  %bytes_in_buffer.2.i552 = phi i64 [ %dec37.i565, %if.end36.i567 ], [ %dec.i546, %do.body.i554.preheader ]
...
if.then21.i559:                                   ; preds = %do.body.i554
  %88 = load ptr, ptr %src23.i555, align 8, !tbaa !50
  %fill_input_buffer24.i556 = getelementptr inbounds %struct.jpeg_source_mgr, ptr %88, i64 0, i32 3
  %89 = load ptr, ptr %fill_input_buffer24.i556, align 8, !tbaa !51
  %call26.i557 = tail call i32 %89(ptr noundef %87) #4
...
if.end29.i562:                                    ; preds = %if.then21.i559
  %90 = load ptr, ptr %src23.i555, align 8, !tbaa !50
  %91 = load ptr, ptr %90, align 8, !tbaa !53
  %bytes_in_buffer35.i561 = getelementptr inbounds %struct.jpeg_source_mgr, ptr %90, i64 0, i32 1
  %92 = load i64, ptr %bytes_in_buffer35.i561, align 8, !tbaa !54
  br label %if.end36.i567

if.end36.i567:                                    ; preds = %if.end29.i562, %do.body.i554
  %next_input_byte.3.i563 = phi ptr [ %91, %if.end29.i562 ], [ %next_input_byte.2.i551, %do.body.i554 ]
  %bytes_in_buffer.3.i564 = phi i64 [ %92, %if.end29.i562 ], [ %bytes_in_buffer.2.i552, %do.body.i554 ]
  %dec37.i565 = add i64 %bytes_in_buffer.3.i564, -1
  %incdec.ptr38.i566 = getelementptr inbounds i8, ptr %next_input_byte.3.i563, i64 1
  %93 = load i8, ptr %next_input_byte.3.i563, align 1, !tbaa !19
  switch i8 %93, label %if.else.i569 [
    i8 -1, label %do.body.i554
    i8 0, label %if.end59.i586
  ]

if.else.i569:                                     ; preds = %if.end36.i567
  %conv39.le.i568 = zext i8 %93 to i32
...
if.end49.i575:                                    ; preds = %no_more_data.i573
  ...
  %tobool50.not.i574 = icmp eq i32 %94, 0
  br i1 %tobool50.not.i574, label %if.then51.i578, label %if.end59.i586

if.then51.i578:                                   ; preds = %if.end49.i575
  %95 = load ptr, ptr %78, align 8, !tbaa !56
  %msg_code.i576 = getelementptr inbounds %struct.jpeg_error_mgr, ptr %95, i64 0, i32 5
  store i32 113, ptr %msg_code.i576, align 8, !tbaa !57
  %emit_message.i577 = getelementptr inbounds %struct.jpeg_error_mgr, ptr %95, i64 0, i32 1
  %96 = load ptr, ptr %emit_message.i577, align 8, !tbaa !59
...
if.end113:                                        ; preds = %while.end.i593.thread, %while.end.i593, %for.body97
  %bits_left.8 = phi i32 [ %bits_left.addr.0111.i530, %while.end.i593 ], [ %bits_left.7940, %for.body97 ], [ %add.i584, %while.end.i593.thread ]
  %get_buffer.8 = phi i64 [ %get_buffer.addr.0110.i531, %while.end.i593 ], [ %get_buffer.7941, %for.body97 ], [ %or.i583, %while.end.i593.thread ]
...
if.end135:                                        ; preds = %label2
  %99 = load i64, ptr %get_buffer63.i, align 8, !tbaa !61
  %100 = load i32, ptr %bits_left64.i, align 8, !tbaa !62
  br label %cleanup.cont142

cleanup.cont142:                                  ; preds = %if.end135, %if.then124
  %bits_left.11 = phi i32 [ %100, %if.end135 ], [ %sub125, %if.then124 ]
  %get_buffer.11 = phi i64 [ %99, %if.end135 ], [ %get_buffer.8, %if.then124 ]
...
if.then146:                                       ; preds = %cleanup.cont142
  %add147 = add nsw i32 %shr143, %k.0942
  %cmp148 = icmp slt i32 %bits_left.11, %and144
  br i1 %cmp148, label %if.then150, label %if.end157

if.then150:                                       ; preds = %if.then146
  %101 = load ptr, ptr %br_state, align 8, !tbaa !45
  %102 = load i64, ptr %bytes_in_buffer10, align 8, !tbaa !47
  %cmp109.i597 = icmp slt i32 %bits_left.11, 25
  br i1 %cmp109.i597, label %while.body.i607.preheader, label %while.end.i667

while.body.i607.preheader:                        ; preds = %if.then150
  %103 = load ptr, ptr %cinfo7, align 8
  %src.i610 = getelementptr inbounds %struct.jpeg_decompress_struct, ptr %103, i64 0, i32 5
  %104 = load ptr, ptr %printed_eod_ptr, align 8
  br label %while.body.i607

while.body.i607:                                  ; preds = %while.body.i607.preheader, %if.end59.i660
  %bytes_in_buffer.0113.i602 = phi i64 [ %bytes_in_buffer.5.i654, %if.end59.i660 ], [ %102, %while.body.i607.preheader ]
  %next_input_byte.0112.i603 = phi ptr [ %next_input_byte.5.i653, %if.end59.i660 ], [ %101, %while.body.i607.preheader ]
  %bits_left.addr.0111.i604 = phi i32 [ %add.i658, %if.end59.i660 ], [ %bits_left.11, %while.body.i607.preheader ]
  %get_buffer.addr.0110.i605 = phi i64 [ %or.i657, %if.end59.i660 ], [ %get_buffer.11, %while.body.i607.preheader ]
  %105 = load i32, ptr %unread_marker11, align 8, !tbaa !48
  %cmp3.not.i606 = icmp eq i32 %105, 0
...
if.then5.i614:                                    ; preds = %if.end.i609
  %106 = load ptr, ptr %src.i610, align 8, !tbaa !50
  %fill_input_buffer.i611 = getelementptr inbounds %struct.jpeg_source_mgr, ptr %106, i64 0, i32 3
  %107 = load ptr, ptr %fill_input_buffer.i611, align 8, !tbaa !51
  %call.i612 = tail call i32 %107(ptr noundef %103) #4
...
if.end8.i617:                                     ; preds = %if.then5.i614
  %108 = load ptr, ptr %src.i610, align 8, !tbaa !50
  %109 = load ptr, ptr %108, align 8, !tbaa !53
  %bytes_in_buffer14.i616 = getelementptr inbounds %struct.jpeg_source_mgr, ptr %108, i64 0, i32 1
  %110 = load i64, ptr %bytes_in_buffer14.i616, align 8, !tbaa !54
  br label %if.end15.i624

if.end15.i624:                                    ; preds = %if.end8.i617, %if.end.i609
  %next_input_byte.1.i618 = phi ptr [ %109, %if.end8.i617 ], [ %next_input_byte.0112.i603, %if.end.i609 ]
  %bytes_in_buffer.1.i619 = phi i64 [ %110, %if.end8.i617 ], [ %bytes_in_buffer.0113.i602, %if.end.i609 ]
  %dec.i620 = add i64 %bytes_in_buffer.1.i619, -1
  %incdec.ptr.i621 = getelementptr inbounds i8, ptr %next_input_byte.1.i618, i64 1
  %111 = load i8, ptr %next_input_byte.1.i618, align 1, !tbaa !19
  %conv.i622 = zext i8 %111 to i64
  %cmp16.i623 = icmp eq i8 %111, -1
  br i1 %cmp16.i623, label %do.body.i628.preheader, label %if.end59.i660

do.body.i628.preheader:                           ; preds = %if.end15.i624
  %112 = load ptr, ptr %cinfo7, align 8
  %src23.i629 = getelementptr inbounds %struct.jpeg_decompress_struct, ptr %112, i64 0, i32 5
  br label %do.body.i628

do.body.i628:                                     ; preds = %do.body.i628.preheader, %if.end36.i641
  %next_input_byte.2.i625 = phi ptr [ %incdec.ptr38.i640, %if.end36.i641 ], [ %incdec.ptr.i621, %do.body.i628.preheader ]
  %bytes_in_buffer.2.i626 = phi i64 [ %dec37.i639, %if.end36.i641 ], [ %dec.i620, %do.body.i628.preheader ]
...
if.then21.i633:                                   ; preds = %do.body.i628
  %113 = load ptr, ptr %src23.i629, align 8, !tbaa !50
  %fill_input_buffer24.i630 = getelementptr inbounds %struct.jpeg_source_mgr, ptr %113, i64 0, i32 3
  %114 = load ptr, ptr %fill_input_buffer24.i630, align 8, !tbaa !51
  %call26.i631 = tail call i32 %114(ptr noundef %112) #4
...
if.end29.i636:                                    ; preds = %if.then21.i633
  %115 = load ptr, ptr %src23.i629, align 8, !tbaa !50
  %116 = load ptr, ptr %115, align 8, !tbaa !53
  %bytes_in_buffer35.i635 = getelementptr inbounds %struct.jpeg_source_mgr, ptr %115, i64 0, i32 1
  %117 = load i64, ptr %bytes_in_buffer35.i635, align 8, !tbaa !54
  br label %if.end36.i641

if.end36.i641:                                    ; preds = %if.end29.i636, %do.body.i628
  %next_input_byte.3.i637 = phi ptr [ %116, %if.end29.i636 ], [ %next_input_byte.2.i625, %do.body.i628 ]
  %bytes_in_buffer.3.i638 = phi i64 [ %117, %if.end29.i636 ], [ %bytes_in_buffer.2.i626, %do.body.i628 ]
  %dec37.i639 = add i64 %bytes_in_buffer.3.i638, -1
  %incdec.ptr38.i640 = getelementptr inbounds i8, ptr %next_input_byte.3.i637, i64 1
  %118 = load i8, ptr %next_input_byte.3.i637, align 1, !tbaa !19
  switch i8 %118, label %if.else.i643 [
    i8 -1, label %do.body.i628
    i8 0, label %if.end59.i660
  ]

if.else.i643:                                     ; preds = %if.end36.i641
  %conv39.le.i642 = zext i8 %118 to i32
...
if.end49.i649:                                    ; preds = %no_more_data.i647
  ...
  %tobool50.not.i648 = icmp eq i32 %119, 0
  br i1 %tobool50.not.i648, label %if.then51.i652, label %if.end59.i660

if.then51.i652:                                   ; preds = %if.end49.i649
  %120 = load ptr, ptr %103, align 8, !tbaa !56
  %msg_code.i650 = getelementptr inbounds %struct.jpeg_error_mgr, ptr %120, i64 0, i32 5
  store i32 113, ptr %msg_code.i650, align 8, !tbaa !57
  %emit_message.i651 = getelementptr inbounds %struct.jpeg_error_mgr, ptr %120, i64 0, i32 1
  %121 = load ptr, ptr %emit_message.i651, align 8, !tbaa !59
...
while.end.i667:                                   ; preds = %if.end59.i660, %no_more_data.i647, %if.then150
  ...
  %next_input_byte.6.i663 = phi ptr [ %101, %if.then150 ], [ %next_input_byte.5.i653, %if.end59.i660 ], [ %next_input_byte.4.i644, %no_more_data.i647 ]
  %bytes_in_buffer.6.i664 = phi i64 [ %102, %if.then150 ], [ %bytes_in_buffer.5.i654, %if.end59.i660 ], [ %bytes_in_buffer.4.i645, %no_more_data.i647 ]
...
for.body192:                                      ; preds = %for.body192.preheader, %for.inc261
  %k.2945 = phi i32 [ %inc262, %for.inc261 ], [ 1, %for.body192.preheader ]
  %get_buffer.14944 = phi i64 [ %get_buffer.20, %for.inc261 ], [ %get_buffer.6, %for.body192.preheader ]
  %bits_left.14943 = phi i32 [ %bits_left.20, %for.inc261 ], [ %bits_left.6, %for.body192.preheader ]
  %cmp195 = icmp slt i32 %bits_left.14943, 8
  br i1 %cmp195, label %if.then197, label %if.end208

if.then197:                                       ; preds = %for.body192
  %125 = load ptr, ptr %br_state, align 8, !tbaa !45
  %126 = load i64, ptr %bytes_in_buffer10, align 8, !tbaa !47
  %127 = load ptr, ptr %cinfo7, align 8
  %src.i684 = getelementptr inbounds %struct.jpeg_decompress_struct, ptr %127, i64 0, i32 5
  %128 = load ptr, ptr %printed_eod_ptr, align 8
  br label %while.body.i681

while.body.i681:                                  ; preds = %if.end59.i734, %if.then197
  %bytes_in_buffer.0113.i676 = phi i64 [ %126, %if.then197 ], [ %bytes_in_buffer.5.i728, %if.end59.i734 ]
  %next_input_byte.0112.i677 = phi ptr [ %125, %if.then197 ], [ %next_input_byte.5.i727, %if.end59.i734 ]
  %bits_left.addr.0111.i678 = phi i32 [ %bits_left.14943, %if.then197 ], [ %add.i732, %if.end59.i734 ]
  %get_buffer.addr.0110.i679 = phi i64 [ %get_buffer.14944, %if.then197 ], [ %or.i731, %if.end59.i734 ]
  %129 = load i32, ptr %unread_marker11, align 8, !tbaa !48
  %cmp3.not.i680 = icmp eq i32 %129, 0
...
if.then5.i688:                                    ; preds = %if.end.i683
  %130 = load ptr, ptr %src.i684, align 8, !tbaa !50
  %fill_input_buffer.i685 = getelementptr inbounds %struct.jpeg_source_mgr, ptr %130, i64 0, i32 3
  %131 = load ptr, ptr %fill_input_buffer.i685, align 8, !tbaa !51
  %call.i686 = tail call i32 %131(ptr noundef %127) #4
...
if.end8.i691:                                     ; preds = %if.then5.i688
  %132 = load ptr, ptr %src.i684, align 8, !tbaa !50
  %133 = load ptr, ptr %132, align 8, !tbaa !53
  %bytes_in_buffer14.i690 = getelementptr inbounds %struct.jpeg_source_mgr, ptr %132, i64 0, i32 1
  %134 = load i64, ptr %bytes_in_buffer14.i690, align 8, !tbaa !54
  br label %if.end15.i698

if.end15.i698:                                    ; preds = %if.end8.i691, %if.end.i683
  %next_input_byte.1.i692 = phi ptr [ %133, %if.end8.i691 ], [ %next_input_byte.0112.i677, %if.end.i683 ]
  %bytes_in_buffer.1.i693 = phi i64 [ %134, %if.end8.i691 ], [ %bytes_in_buffer.0113.i676, %if.end.i683 ]
  %dec.i694 = add i64 %bytes_in_buffer.1.i693, -1
  %incdec.ptr.i695 = getelementptr inbounds i8, ptr %next_input_byte.1.i692, i64 1
  %135 = load i8, ptr %next_input_byte.1.i692, align 1, !tbaa !19
  %conv.i696 = zext i8 %135 to i64
  %cmp16.i697 = icmp eq i8 %135, -1
  br i1 %cmp16.i697, label %do.body.i702.preheader, label %if.end59.i734

do.body.i702.preheader:                           ; preds = %if.end15.i698
  %136 = load ptr, ptr %cinfo7, align 8
  %src23.i703 = getelementptr inbounds %struct.jpeg_decompress_struct, ptr %136, i64 0, i32 5
  br label %do.body.i702

do.body.i702:                                     ; preds = %do.body.i702.preheader, %if.end36.i715
  %next_input_byte.2.i699 = phi ptr [ %incdec.ptr38.i714, %if.end36.i715 ], [ %incdec.ptr.i695, %do.body.i702.preheader ]
  %bytes_in_buffer.2.i700 = phi i64 [ %dec37.i713, %if.end36.i715 ], [ %dec.i694, %do.body.i702.preheader ]
...
if.then21.i707:                                   ; preds = %do.body.i702
  %137 = load ptr, ptr %src23.i703, align 8, !tbaa !50
  %fill_input_buffer24.i704 = getelementptr inbounds %struct.jpeg_source_mgr, ptr %137, i64 0, i32 3
  %138 = load ptr, ptr %fill_input_buffer24.i704, align 8, !tbaa !51
  %call26.i705 = tail call i32 %138(ptr noundef %136) #4
...
if.end29.i710:                                    ; preds = %if.then21.i707
  %139 = load ptr, ptr %src23.i703, align 8, !tbaa !50
  %140 = load ptr, ptr %139, align 8, !tbaa !53
  %bytes_in_buffer35.i709 = getelementptr inbounds %struct.jpeg_source_mgr, ptr %139, i64 0, i32 1
  %141 = load i64, ptr %bytes_in_buffer35.i709, align 8, !tbaa !54
  br label %if.end36.i715

if.end36.i715:                                    ; preds = %if.end29.i710, %do.body.i702
  %next_input_byte.3.i711 = phi ptr [ %140, %if.end29.i710 ], [ %next_input_byte.2.i699, %do.body.i702 ]
  %bytes_in_buffer.3.i712 = phi i64 [ %141, %if.end29.i710 ], [ %bytes_in_buffer.2.i700, %do.body.i702 ]
  %dec37.i713 = add i64 %bytes_in_buffer.3.i712, -1
  %incdec.ptr38.i714 = getelementptr inbounds i8, ptr %next_input_byte.3.i711, i64 1
  %142 = load i8, ptr %next_input_byte.3.i711, align 1, !tbaa !19
  switch i8 %142, label %if.else.i717 [
    i8 -1, label %do.body.i702
    i8 0, label %if.end59.i734
  ]

if.else.i717:                                     ; preds = %if.end36.i715
  %conv39.le.i716 = zext i8 %142 to i32
...
if.end49.i723:                                    ; preds = %no_more_data.i721
  ...
  %tobool50.not.i722 = icmp eq i32 %143, 0
  br i1 %tobool50.not.i722, label %if.then51.i726, label %if.end59.i734

if.then51.i726:                                   ; preds = %if.end49.i723
  %144 = load ptr, ptr %127, align 8, !tbaa !56
  %msg_code.i724 = getelementptr inbounds %struct.jpeg_error_mgr, ptr %144, i64 0, i32 5
  store i32 113, ptr %msg_code.i724, align 8, !tbaa !57
  %emit_message.i725 = getelementptr inbounds %struct.jpeg_error_mgr, ptr %144, i64 0, i32 1
  %145 = load ptr, ptr %emit_message.i725, align 8, !tbaa !59
...
if.end208:                                        ; preds = %while.end.i741.thread, %while.end.i741, %for.body192
  %bits_left.15 = phi i32 [ %bits_left.addr.0111.i678, %while.end.i741 ], [ %bits_left.14943, %for.body192 ], [ %add.i732, %while.end.i741.thread ]
  %get_buffer.15 = phi i64 [ %get_buffer.addr.0110.i679, %while.end.i741 ], [ %get_buffer.14944, %for.body192 ], [ %or.i731, %while.end.i741.thread ]
...
if.end230:                                        ; preds = %label3
  %148 = load i64, ptr %get_buffer63.i, align 8, !tbaa !61
  %149 = load i32, ptr %bits_left64.i, align 8, !tbaa !62
  br label %cleanup.cont237

cleanup.cont237:                                  ; preds = %if.end230, %if.then219
  %bits_left.18 = phi i32 [ %149, %if.end230 ], [ %sub220, %if.then219 ]
  %get_buffer.18 = phi i64 [ %148, %if.end230 ], [ %get_buffer.15, %if.then219 ]
...
if.then245:                                       ; preds = %if.then241
  %150 = load ptr, ptr %br_state, align 8, !tbaa !45
  %151 = load i64, ptr %bytes_in_buffer10, align 8, !tbaa !47
  %cmp109.i745 = icmp slt i32 %bits_left.18, 25
  br i1 %cmp109.i745, label %while.body.i755.preheader, label %while.end.i815

while.body.i755.preheader:                        ; preds = %if.then245
  %152 = load ptr, ptr %cinfo7, align 8
  %src.i758 = getelementptr inbounds %struct.jpeg_decompress_struct, ptr %152, i64 0, i32 5
  %153 = load ptr, ptr %printed_eod_ptr, align 8
  br label %while.body.i755

while.body.i755:                                  ; preds = %while.body.i755.preheader, %if.end59.i808
  %bytes_in_buffer.0113.i750 = phi i64 [ %bytes_in_buffer.5.i802, %if.end59.i808 ], [ %151, %while.body.i755.preheader ]
  %next_input_byte.0112.i751 = phi ptr [ %next_input_byte.5.i801, %if.end59.i808 ], [ %150, %while.body.i755.preheader ]
  %bits_left.addr.0111.i752 = phi i32 [ %add.i806, %if.end59.i808 ], [ %bits_left.18, %while.body.i755.preheader ]
  %get_buffer.addr.0110.i753 = phi i64 [ %or.i805, %if.end59.i808 ], [ %get_buffer.18, %while.body.i755.preheader ]
  %154 = load i32, ptr %unread_marker11, align 8, !tbaa !48
  %cmp3.not.i754 = icmp eq i32 %154, 0
...
if.then5.i762:                                    ; preds = %if.end.i757
  %155 = load ptr, ptr %src.i758, align 8, !tbaa !50
  %fill_input_buffer.i759 = getelementptr inbounds %struct.jpeg_source_mgr, ptr %155, i64 0, i32 3
  %156 = load ptr, ptr %fill_input_buffer.i759, align 8, !tbaa !51
  %call.i760 = tail call i32 %156(ptr noundef %152) #4
...
if.end8.i765:                                     ; preds = %if.then5.i762
  %157 = load ptr, ptr %src.i758, align 8, !tbaa !50
  %158 = load ptr, ptr %157, align 8, !tbaa !53
  %bytes_in_buffer14.i764 = getelementptr inbounds %struct.jpeg_source_mgr, ptr %157, i64 0, i32 1
  %159 = load i64, ptr %bytes_in_buffer14.i764, align 8, !tbaa !54
  br label %if.end15.i772

if.end15.i772:                                    ; preds = %if.end8.i765, %if.end.i757
  %next_input_byte.1.i766 = phi ptr [ %158, %if.end8.i765 ], [ %next_input_byte.0112.i751, %if.end.i757 ]
  %bytes_in_buffer.1.i767 = phi i64 [ %159, %if.end8.i765 ], [ %bytes_in_buffer.0113.i750, %if.end.i757 ]
  %dec.i768 = add i64 %bytes_in_buffer.1.i767, -1
  %incdec.ptr.i769 = getelementptr inbounds i8, ptr %next_input_byte.1.i766, i64 1
  %160 = load i8, ptr %next_input_byte.1.i766, align 1, !tbaa !19
  %conv.i770 = zext i8 %160 to i64
  %cmp16.i771 = icmp eq i8 %160, -1
  br i1 %cmp16.i771, label %do.body.i776.preheader, label %if.end59.i808

do.body.i776.preheader:                           ; preds = %if.end15.i772
  %161 = load ptr, ptr %cinfo7, align 8
  %src23.i777 = getelementptr inbounds %struct.jpeg_decompress_struct, ptr %161, i64 0, i32 5
  br label %do.body.i776

do.body.i776:                                     ; preds = %do.body.i776.preheader, %if.end36.i789
  %next_input_byte.2.i773 = phi ptr [ %incdec.ptr38.i788, %if.end36.i789 ], [ %incdec.ptr.i769, %do.body.i776.preheader ]
  %bytes_in_buffer.2.i774 = phi i64 [ %dec37.i787, %if.end36.i789 ], [ %dec.i768, %do.body.i776.preheader ]
...
if.then21.i781:                                   ; preds = %do.body.i776
  %162 = load ptr, ptr %src23.i777, align 8, !tbaa !50
  %fill_input_buffer24.i778 = getelementptr inbounds %struct.jpeg_source_mgr, ptr %162, i64 0, i32 3
  %163 = load ptr, ptr %fill_input_buffer24.i778, align 8, !tbaa !51
  %call26.i779 = tail call i32 %163(ptr noundef %161) #4
...
if.end29.i784:                                    ; preds = %if.then21.i781
  %164 = load ptr, ptr %src23.i777, align 8, !tbaa !50
  %165 = load ptr, ptr %164, align 8, !tbaa !53
  %bytes_in_buffer35.i783 = getelementptr inbounds %struct.jpeg_source_mgr, ptr %164, i64 0, i32 1
  %166 = load i64, ptr %bytes_in_buffer35.i783, align 8, !tbaa !54
  br label %if.end36.i789

if.end36.i789:                                    ; preds = %if.end29.i784, %do.body.i776
  %next_input_byte.3.i785 = phi ptr [ %165, %if.end29.i784 ], [ %next_input_byte.2.i773, %do.body.i776 ]
  %bytes_in_buffer.3.i786 = phi i64 [ %166, %if.end29.i784 ], [ %bytes_in_buffer.2.i774, %do.body.i776 ]
  %dec37.i787 = add i64 %bytes_in_buffer.3.i786, -1
  %incdec.ptr38.i788 = getelementptr inbounds i8, ptr %next_input_byte.3.i785, i64 1
  %167 = load i8, ptr %next_input_byte.3.i785, align 1, !tbaa !19
  switch i8 %167, label %if.else.i791 [
    i8 -1, label %do.body.i776
    i8 0, label %if.end59.i808
  ]

if.else.i791:                                     ; preds = %if.end36.i789
  %conv39.le.i790 = zext i8 %167 to i32
...
if.end49.i797:                                    ; preds = %no_more_data.i795
  ...
  %tobool50.not.i796 = icmp eq i32 %168, 0
  br i1 %tobool50.not.i796, label %if.then51.i800, label %if.end59.i808

if.then51.i800:                                   ; preds = %if.end49.i797
  %169 = load ptr, ptr %152, align 8, !tbaa !56
  %msg_code.i798 = getelementptr inbounds %struct.jpeg_error_mgr, ptr %169, i64 0, i32 5
  store i32 113, ptr %msg_code.i798, align 8, !tbaa !57
  %emit_message.i799 = getelementptr inbounds %struct.jpeg_error_mgr, ptr %169, i64 0, i32 1
  %170 = load ptr, ptr %emit_message.i799, align 8, !tbaa !59
...
while.end.i815:                                   ; preds = %if.end59.i808, %no_more_data.i795, %if.then245
  ...
  %next_input_byte.6.i811 = phi ptr [ %150, %if.then245 ], [ %next_input_byte.5.i801, %if.end59.i808 ], [ %next_input_byte.4.i792, %no_more_data.i795 ]
  %bytes_in_buffer.6.i812 = phi i64 [ %151, %if.then245 ], [ %bytes_in_buffer.5.i802, %if.end59.i808 ], [ %bytes_in_buffer.4.i793, %no_more_data.i795 ]
...
for.inc265:                                       ; preds = %if.else181, %for.inc, %if.else254, %for.inc261
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %171 = load i32, ptr %blocks_in_MCU, align 8, !tbaa !94
...
for.end267.loopexit:                              ; preds = %for.inc265
  %.pre = load ptr, ptr %br_state, align 8, !tbaa !45
  %.pre1010 = load ptr, ptr %src, align 8, !tbaa !50
  %.pre1011 = load i64, ptr %bytes_in_buffer10, align 8, !tbaa !47
  %.pre1012 = load i32, ptr %unread_marker11, align 8, !tbaa !48
  br label %for.end267

for.end267:                                       ; preds = %for.end267.loopexit, %if.end6
  %173 = phi i32 [ %14, %if.end6 ], [ %.pre1012, %for.end267.loopexit ]
  %174 = phi i64 [ %13, %if.end6 ], [ %.pre1011, %for.end267.loopexit ]
  %175 = phi ptr [ %11, %if.end6 ], [ %.pre1010, %for.end267.loopexit ]
  ...
  store ptr %176, ptr %175, align 8, !tbaa !53
  %bytes_in_buffer273 = getelementptr inbounds %struct.jpeg_source_mgr, ptr %175, i64 0, i32 1
  store i64 %174, ptr %bytes_in_buffer273, align 8, !tbaa !54
  store i32 %173, ptr %unread_marker, align 4, !tbaa !91
  ...
  %177 = load i32, ptr %restarts_to_go281, align 8, !tbaa !83
  %dec = add i32 %177, -1
