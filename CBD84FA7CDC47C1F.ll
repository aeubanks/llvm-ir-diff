...
entry:
  ...
  %cmp.not188 = icmp sgt i32 %start, %end
  br i1 %cmp.not188, label %while.end106, label %while.body

while.body:                                       ; preds = %entry, %while.end105
  %incdec.ptr190 = phi ptr [ %incdec.ptr, %while.end105 ], [ %add.ptr2, %entry ]
  %lastout.0189 = phi ptr [ %lastout.4, %while.end105 ], [ %add.ptr3, %entry ]
  %0 = load i8, ptr %incdec.ptr190, align 1, !tbaa !9
...
while.body9:                                      ; preds = %while.body9.preheader, %if.end101
  ...
  %inc32180 = phi i32 [ %inc32179, %if.end101 ], [ %num_of_matched.promoted, %while.body9.preheader ]
  %p.0 = phi ptr [ %7, %if.end101 ], [ %1, %while.body9.preheader ]
  %text.addr.1 = phi ptr [ %text.addr.7, %if.end101 ], [ %incdec.ptr190, %while.body9.preheader ]
...
while.cond57.preheader:                           ; preds = %while.cond50
  ...
  %cmp60.not184 = icmp eq i8 %22, 10
  br i1 %cmp60.not184, label %while.end65, label %while.body62

while.body62:                                     ; preds = %while.cond57.preheader, %while.body62
  %23 = phi i8 [ %25, %while.body62 ], [ %22, %while.cond57.preheader ]
  %incdec.ptr58185 = phi ptr [ %incdec.ptr58, %while.body62 ], [ %text.addr.3, %while.cond57.preheader ]
  ...
  %incdec.ptr58 = getelementptr inbounds i8, ptr %incdec.ptr58185, i64 1
...
while.end65:                                      ; preds = %while.body62, %while.cond57.preheader
  ...
  %call.i157 = tail call i32 @putc(i32 noundef 10, ptr noundef %26)
...
while.end74:                                      ; preds = %while.cond68
  %cmp75.not = icmp ult ptr %lastout.0189, %incdec.ptr69
  br i1 %cmp75.not, label %while.body82, label %while.cond91.preheader

while.body82:                                     ; preds = %while.end74, %while.body82
  %lastout.2182 = phi ptr [ %incdec.ptr83, %while.body82 ], [ %lastout.0189, %while.end74 ]
  %incdec.ptr83 = getelementptr inbounds i8, ptr %lastout.2182, i64 1
  %28 = load i8, ptr %lastout.2182, align 1, !tbaa !9
  %conv84 = zext i8 %28 to i32
  %29 = load ptr, ptr @stdout, align 8, !tbaa !12
  %call.i158 = tail call i32 @putc(i32 noundef %conv84, ptr noundef %29)
...
if.then88:                                        ; preds = %while.end86
  ...
  %call.i159 = tail call i32 @putc(i32 noundef 10, ptr noundef %30)
...
if.end101:                                        ; preds = %while.cond38, %while.end
  ...
  %inc32179 = phi i32 [ %inc32180, %while.end ], [ %inc32, %while.cond38 ]
...
while.end105:                                     ; preds = %if.end101, %while.end65, %while.end97, %while.body
  %text.addr.8 = phi ptr [ %incdec.ptr190, %while.body ], [ %incdec.ptr58.lcssa, %while.end65 ], [ %incdec.ptr92, %while.end97 ], [ %text.addr.7, %if.end101 ]
  %lastout.4 = phi ptr [ %lastout.0189, %while.body ], [ %lastout.0189, %while.end65 ], [ %add.ptr98, %while.end97 ], [ %lastout.0189, %if.end101 ]
...
while.end106:                                     ; preds = %while.end105, %entry
  ...
  %cmp111.not192 = icmp ugt ptr %lastout.0.lcssa, %add.ptr
  %or.cond194 = select i1 %or.cond126, i1 true, i1 %cmp111.not192
  br i1 %or.cond194, label %cleanup, label %while.body113

while.body113:                                    ; preds = %while.end106, %while.body113
  %lastout.5193 = phi ptr [ %incdec.ptr114, %while.body113 ], [ %lastout.0.lcssa, %while.end106 ]
  %incdec.ptr114 = getelementptr inbounds i8, ptr %lastout.5193, i64 1
  %35 = load i8, ptr %lastout.5193, align 1, !tbaa !9
  %conv115 = zext i8 %35 to i32
  %36 = load ptr, ptr @stdout, align 8, !tbaa !12
  %call.i160 = tail call i32 @putc(i32 noundef %conv115, ptr noundef %36)
...
entry:
  ...
  %cmp.not272 = icmp ugt ptr %add.ptr7, %add.ptr
  br i1 %cmp.not272, label %while.end159, label %while.body.lr.ph
...
while.body:                                       ; preds = %while.body.lr.ph, %if.end155
  %lastout.0274 = phi ptr [ %add.ptr3, %while.body.lr.ph ], [ %lastout.5, %if.end155 ]
  %text.addr.0273 = phi ptr [ %add.ptr7, %while.body.lr.ph ], [ %add.ptr158, %if.end155 ]
  %3 = load i8, ptr %text.addr.0273, align 1, !tbaa !9
  ...
  %add.ptr8 = getelementptr inbounds i8, ptr %text.addr.0273, i64 -1
...
if.then:                                          ; preds = %while.body
  ...
  %add.ptr13 = getelementptr inbounds i8, ptr %text.addr.0273, i64 -2
...
for.body:                                         ; preds = %for.body.preheader, %for.body
  ...
  %add.ptr28 = getelementptr inbounds i8, ptr %text.addr.0273, i64 %idx.neg
  ...
  %12 = shl i32 %hash.1256, 8
  %13 = shl nuw nsw i32 %conv31, 4
  %shl26.1 = add i32 %12, %13
  %idx.neg.1 = xor i64 %indvars.iv, -1
  %add.ptr28.1 = getelementptr inbounds i8, ptr %text.addr.0273, i64 %idx.neg.1
  ...
  %add.ptr28.2 = getelementptr inbounds i8, ptr %text.addr.0273, i64 %idx.neg.2
  ...
  %add.ptr28.3 = getelementptr inbounds i8, ptr %text.addr.0273, i64 %idx.neg.3
...
for.body.epil:                                    ; preds = %for.end.unr-lcssa, %for.body.epil
  ...
  %add.ptr28.epil = getelementptr inbounds i8, ptr %text.addr.0273, i64 %idx.neg.epil
...
while.body38.preheader:                           ; preds = %for.end
  %add.ptr41 = getelementptr inbounds i8, ptr %text.addr.0273, i64 %idx.neg40
  %25 = load i8, ptr %add.ptr41, align 1, !tbaa !9
  %idxprom50260 = zext i8 %25 to i64
  %arrayidx51261 = getelementptr inbounds [256 x i8], ptr @tr, i64 0, i64 %idxprom50260
  %26 = load i8, ptr %arrayidx51261, align 1, !tbaa !9
...
while.body55:                                     ; preds = %while.body38, %while.body55
  ...
  %arrayidx46 = getelementptr inbounds i8, ptr %29, i64 %indvars.iv.next284
...
if.then65:                                        ; preds = %if.then59
  %cmp66 = icmp ugt ptr %text.addr.0273, %add.ptr
...
while.cond77:                                     ; preds = %if.end74, %while.cond77
  %text.addr.2 = phi ptr [ %incdec.ptr82, %while.cond77 ], [ %text.addr.0273, %if.end74 ]
...
while.cond89:                                     ; preds = %while.cond89.preheader, %while.cond89
  %text.addr.3 = phi ptr [ %incdec.ptr90, %while.cond89 ], [ %text.addr.0273, %while.cond89.preheader ]
...
while.cond96.preheader:                           ; preds = %while.cond89
  ...
  %cmp99.not269 = icmp eq i8 %46, 10
  br i1 %cmp99.not269, label %while.end104, label %while.body101

while.body101:                                    ; preds = %while.cond96.preheader, %while.body101
  %47 = phi i8 [ %49, %while.body101 ], [ %46, %while.cond96.preheader ]
  %incdec.ptr97270 = phi ptr [ %incdec.ptr97, %while.body101 ], [ %text.addr.3, %while.cond96.preheader ]
  ...
  %incdec.ptr97 = getelementptr inbounds i8, ptr %incdec.ptr97270, i64 1
...
while.end104:                                     ; preds = %while.body101, %while.cond96.preheader
  ...
  %call.i234 = tail call i32 @putc(i32 noundef 10, ptr noundef %50)
  br label %if.end155
...
while.cond111:                                    ; preds = %while.cond111.preheader, %while.cond111
  %text.addr.5 = phi ptr [ %incdec.ptr112, %while.cond111 ], [ %text.addr.0273, %while.cond111.preheader ]
  %incdec.ptr112 = getelementptr inbounds i8, ptr %text.addr.5, i64 -1
  %51 = load i8, ptr %incdec.ptr112, align 1, !tbaa !9
  %cmp114.not = icmp eq i8 %51, 10
  br i1 %cmp114.not, label %while.end117, label %while.cond111, !llvm.loop !45

while.end117:                                     ; preds = %while.cond111
  %cmp118.not = icmp ult ptr %lastout.0274, %incdec.ptr112
  br i1 %cmp118.not, label %while.body125, label %while.cond134.preheader

while.body125:                                    ; preds = %while.end117, %while.body125
  %lastout.2267 = phi ptr [ %incdec.ptr126, %while.body125 ], [ %lastout.0274, %while.end117 ]
  %incdec.ptr126 = getelementptr inbounds i8, ptr %lastout.2267, i64 1
  %52 = load i8, ptr %lastout.2267, align 1, !tbaa !9
  %conv127 = zext i8 %52 to i32
  %53 = load ptr, ptr @stdout, align 8, !tbaa !12
  %call.i235 = tail call i32 @putc(i32 noundef %conv127, ptr noundef %53)
...
if.then131:                                       ; preds = %while.end129
  ...
  %call.i236 = tail call i32 @putc(i32 noundef 10, ptr noundef %54)
...
while.cond134:                                    ; preds = %while.cond134.preheader, %while.cond134
  ...
  %55 = load i8, ptr %incdec.ptr135, align 1, !tbaa !9
  %cmp137.not = icmp eq i8 %55, 10
...
if.end155:                                        ; preds = %if.end145, %while.cond77, %while.end104, %while.end140, %for.end, %if.end
  ...
  %text.addr.9 = phi ptr [ %text.addr.0273, %if.end ], [ %text.addr.0273, %for.end ], [ %incdec.ptr135, %while.end140 ], [ %incdec.ptr97.lcssa, %while.end104 ], [ %text.addr.2, %while.cond77 ], [ %text.addr.0273, %if.end145 ]
  %lastout.5 = phi ptr [ %lastout.0274, %if.end ], [ %lastout.0274, %for.end ], [ %add.ptr141, %while.end140 ], [ %lastout.0274, %while.end104 ], [ %lastout.0274, %while.cond77 ], [ %lastout.0274, %if.end145 ]
...
while.end159:                                     ; preds = %if.end155, %entry
  ...
  %56 = load i32, ptr @INVERSE, align 4, !tbaa !5
  %tobool160 = icmp eq i32 %56, 0
  %57 = load i32, ptr @COUNT, align 4
  %tobool161 = icmp ne i32 %57, 0
  %or.cond185 = select i1 %tobool160, i1 true, i1 %tobool161
  %cmp164.not276 = icmp ugt ptr %lastout.0.lcssa, %add.ptr
  %or.cond278 = select i1 %or.cond185, i1 true, i1 %cmp164.not276
  br i1 %or.cond278, label %cleanup, label %while.body166

while.body166:                                    ; preds = %while.end159, %while.body166
  %lastout.6277 = phi ptr [ %incdec.ptr167, %while.body166 ], [ %lastout.0.lcssa, %while.end159 ]
  %incdec.ptr167 = getelementptr inbounds i8, ptr %lastout.6277, i64 1
  %58 = load i8, ptr %lastout.6277, align 1, !tbaa !9
  %conv168 = zext i8 %58 to i32
  %59 = load ptr, ptr @stdout, align 8, !tbaa !12
  %call.i237 = tail call i32 @putc(i32 noundef %conv168, ptr noundef %59)
