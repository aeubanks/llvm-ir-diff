...
entry:
  ...
  %call87 = call i64 @read(i32 noundef %fd, ptr noundef nonnull %add.ptr, i64 noundef 8192) #17
  %conv88 = trunc i64 %call87 to i32
  %cmp89 = icmp sgt i32 %conv88, 0
  br i1 %cmp89, label %while.body, label %cleanup

while.body:                                       ; preds = %entry, %if.end29
  %conv92 = phi i32 [ %conv, %if.end29 ], [ %conv88, %entry ]
  %call91 = phi i64 [ %call, %if.end29 ], [ %call87, %entry ]
  %start.090 = phi i32 [ %spec.store.select, %if.end29 ], [ 1023, %entry ]
...
for.body.preheader.i:                             ; preds = %while.body
  ...
  %wide.trip.count.i = and i64 %call91, 4294967295
  %xtraiter = and i64 %call91, 1
...
if.then20:                                        ; preds = %while.end
  call void @m_short(ptr noundef nonnull %text, i32 noundef %start.090, i32 noundef %9)
  br label %if.end23

if.else:                                          ; preds = %while.end
  call void @monkey1(ptr noundef nonnull %text, i32 noundef %start.090, i32 noundef %9)
  br label %if.end23
