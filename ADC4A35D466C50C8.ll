...
"for op_pabsd_240.s0.x.x":                        ; preds = %"for op_pabsd_240.s0.x.x.1", %"for op_pabsd_240.s0.x.x.preheader"
  ...
  %10 = shufflevector <6 x i32> %7, <6 x i32> undef, <4 x i32> <i32 4, i32 5, i32 undef, i32 undef>
...
"for op_pabsd_240.s0.x.x.1":                      ; preds = %"for op_pabsd_240.s0.x.x"
  ...
  %26 = shufflevector <6 x i32> %23, <6 x i32> undef, <4 x i32> <i32 4, i32 5, i32 undef, i32 undef>
