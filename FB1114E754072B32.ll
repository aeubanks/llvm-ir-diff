...
entry:
  %call = tail call i32 @init(ptr noundef nonnull @.str.85)
...
for.body4:                                        ; preds = %for.body4.1, %for.cond1.preheader
  %8 = phi double [ %.pre, %for.cond1.preheader ], [ %14, %for.body4.1 ]
  %indvars.iv = phi i64 [ 1, %for.cond1.preheader ], [ %indvars.iv.next.1, %for.body4.1 ]
...
for.body4.1:                                      ; preds = %for.body4
  ...
  store double %14, ptr %arrayidx8.1, align 8, !tbaa !5
...
entry:
  %call = tail call i32 @init(ptr noundef nonnull @.str.86)
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
  %cmp33 = icmp sgt i32 %0, 1
  br i1 %cmp33, label %for.cond1.preheader, label %for.cond.cleanup

for.cond1.preheader:                              ; preds = %entry, %for.cond.cleanup3
  %nl.034 = phi i32 [ %inc18, %for.cond.cleanup3 ], [ 0, %entry ]
  %.pre = load double, ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 0, i64 1), align 8, !tbaa !5
  br label %for.body4

for.cond.cleanup:                                 ; preds = %for.cond.cleanup3, %entry
  %call22 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.138, double noundef 0.000000e+00)
  br label %for.body.i
...
for.cond.cleanup3:                                ; preds = %for.body4
  ...
  %7 = load i32, ptr @ntimes, align 4, !tbaa !17
  %div = sdiv i32 %7, 2
  %cmp = icmp slt i32 %inc18, %div
  br i1 %cmp, label %for.cond1.preheader, label %for.cond.cleanup

for.body4:                                        ; preds = %for.cond1.preheader, %for.body4
  %8 = phi double [ %.pre, %for.cond1.preheader ], [ %15, %for.body4 ]
  %indvars.iv = phi i64 [ 2, %for.cond1.preheader ], [ %indvars.iv.next, %for.body4 ]
  %arrayidx = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv
  ...
  %arrayidx11 = getelementptr inbounds double, ptr @global_data, i64 %12
  %13 = load double, ptr %arrayidx11, align 8, !tbaa !5
  %arrayidx13 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 %indvars.iv
  %14 = load double, ptr %arrayidx13, align 8, !tbaa !5
  %15 = tail call double @llvm.fmuladd.f64(double %13, double %14, double %11)
  store double %15, ptr %arrayidx, align 8, !tbaa !5
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, 32000
...
entry:
  %call = tail call i32 @init(ptr noundef nonnull @.str.87)
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
...
for.cond.cleanup:                                 ; preds = %for.cond.cleanup3, %entry
  %call25 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.139, double noundef 0.000000e+00)
  br label %for.body.i
...
for.cond.cleanup3:                                ; preds = %for.body4
  ...
  %div = sdiv i32 %6, 2
  %cmp = icmp slt i32 %inc21, %div
  br i1 %cmp, label %for.cond1.preheader, label %for.cond.cleanup

for.body4:                                        ; preds = %for.cond1.preheader, %for.body4
  %7 = phi double [ %.pre, %for.cond1.preheader ], [ %12, %for.body4 ]
  ...
  %arrayidx16 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 11, i64 %indvars.iv
  ...
  store double %12, ptr %arrayidx18, align 8, !tbaa !5
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, 32000
  br i1 %exitcond.not, label %for.cond.cleanup3, label %for.body4
}
