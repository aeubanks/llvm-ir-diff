; ModuleID = '/usr/local/google/home/aeubanks/repos/test-suite/MultiSource/Benchmarks/TSVC/Recurrences-dbl/tsc.c'
source_filename = "/usr/local/google/home/aeubanks/repos/test-suite/MultiSource/Benchmarks/TSVC/Recurrences-dbl/tsc.c"
...
define dso_local i32 @s321() local_unnamed_addr #7 {
  %1 = tail call i32 @init(ptr noundef nonnull @.str.85)
...
36:                                               ; preds = %41
  ...
  br i1 %40, label %4, label %7

41:                                               ; preds = %51, %4
  %42 = phi double [ %6, %4 ], [ %56, %51 ]
  %43 = phi i64 [ 1, %4 ], [ %57, %51 ]
  %44 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %43
  %45 = load double, ptr %44, align 8, !tbaa !5
  %46 = getelementptr inbounds double, ptr @global_data, i64 %43
...
51:                                               ; preds = %41
  %52 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %49
  %53 = load double, ptr %52, align 8, !tbaa !5
  %54 = getelementptr inbounds double, ptr @global_data, i64 %49
  %55 = load double, ptr %54, align 8, !tbaa !5
  %56 = tail call double @llvm.fmuladd.f64(double %48, double %53, double %55)
...
define dso_local i32 @s322() local_unnamed_addr #7 {
  %1 = tail call i32 @init(ptr noundef nonnull @.str.86)
  %2 = load i32, ptr @ntimes, align 4, !tbaa !17
  %3 = icmp sgt i32 %2, 1
  br i1 %3, label %4, label %7
...
4:                                                ; preds = %0, %36
  %5 = phi i32 [ %38, %36 ], [ 0, %0 ]
  %6 = load double, ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 0, i64 1), align 8, !tbaa !5
  br label %42
...
42:                                               ; preds = %4, %42
  %43 = phi double [ %6, %4 ], [ %55, %42 ]
  %44 = phi i64 [ 2, %4 ], [ %56, %42 ]
  %45 = getelementptr inbounds double, ptr @global_data, i64 %44
  %46 = load double, ptr %45, align 8, !tbaa !5
  %47 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %44
  ...
  %53 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 %44
...
define dso_local i32 @s323() local_unnamed_addr #7 {
  %1 = tail call i32 @init(ptr noundef nonnull @.str.87)
  %2 = load i32, ptr @ntimes, align 4, !tbaa !17
  %3 = icmp sgt i32 %2, 1
  br i1 %3, label %4, label %7
...
38:                                               ; preds = %4, %38
  ...
  %45 = tail call double @llvm.fmuladd.f64(double %42, double %44, double %39)
  %46 = getelementptr inbounds double, ptr @global_data, i64 %40
  store double %45, ptr %46, align 8, !tbaa !5
  %47 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 11, i64 %40
  %48 = load double, ptr %47, align 8, !tbaa !5
  %49 = tail call double @llvm.fmuladd.f64(double %42, double %48, double %45)
