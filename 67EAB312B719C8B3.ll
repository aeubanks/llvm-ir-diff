...
define dso_local void @user_print(ptr nocapture noundef readonly %fmt, ...) local_unnamed_addr #0 {
entry:
  %va = alloca [1 x %struct.__va_list_tag], align 16
  call void @llvm.lifetime.start.p0(i64 24, ptr nonnull %va) #10
  call void @llvm.va_start(ptr nonnull %va)
  %0 = load ptr, ptr @stdout, align 8, !tbaa !5
  %call = call i32 @vfprintf(ptr noundef %0, ptr noundef %fmt, ptr noundef nonnull %va)
  call void @llvm.va_end(ptr nonnull %va)
  call void @llvm.lifetime.end.p0(i64 24, ptr nonnull %va) #10
  ret void
}
...
entry:
  ...
  %0 = load ptr, ptr @stdout, align 8, !tbaa !5
  %call1 = tail call ptr @freopen(ptr noundef %call, ptr noundef nonnull @.str, ptr noundef %0) #10
...
if.end7:                                          ; preds = %if.end
  ...
  %call8 = call i32 (ptr, ptr, ...) @__isoc99_fscanf(ptr noundef nonnull %call3, ptr noundef nonnull @.str.5, ptr noundef nonnull %buf) #10
