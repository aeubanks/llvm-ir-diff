...
if.end18:                                         ; preds = %for.cond, %if.then16
  %ou16988 = getelementptr inbounds %struct.word_type, ptr %hd_index.0, i64 0, i32 1
...
if.then129:                                       ; preds = %if.else
  ...
  %cmp133.not6719 = icmp eq ptr %18, %hd_index.0
  br i1 %cmp133.not6719, label %while.cond225.preheader, label %while.body

while.cond225.preheader:                          ; preds = %cond.end196, %if.then129
  %19 = phi ptr [ %hd_index.0, %if.then129 ], [ %35, %cond.end196 ]
  %osucc2286720 = getelementptr inbounds %struct.LIST, ptr %19, i64 0, i32 1
  %20 = load ptr, ptr %osucc2286720, align 8, !tbaa !5
  %cmp229.not6721 = icmp eq ptr %20, %19
  br i1 %cmp229.not6721, label %while.end325, label %while.body231
...
cond.end196:                                      ; preds = %cond.end166, %cond.false174
  %30 = phi ptr [ %21, %cond.end166 ], [ %.pre6836, %cond.false174 ]
...
cond.false271:                                    ; preds = %cond.end263
  ...
  %.pre6837 = load ptr, ptr @xx_link, align 8, !tbaa !8
  br label %cond.end293

cond.end293:                                      ; preds = %cond.end263, %cond.false271
  %46 = phi ptr [ %37, %cond.end263 ], [ %.pre6837, %cond.false271 ]
...
if.then608:                                       ; preds = %if.then599
  ...
  %.pre6838 = load i32, ptr %c, align 4, !tbaa !21
  %.pre6839 = load i32, ptr %obfc, align 4
  %.pre6840 = load i32, ptr %ofc, align 4
  br label %if.end613

if.end613:                                        ; preds = %if.then608, %if.then599
  %96 = phi i32 [ %.pre6840, %if.then608 ], [ %94, %if.then599 ]
  %97 = phi i32 [ %.pre6839, %if.then608 ], [ %93, %if.then599 ]
  %98 = phi i32 [ %.pre6838, %if.then608 ], [ %92, %if.then599 ]
...
if.end808:                                        ; preds = %if.then806, %if.then793
  %130 = phi i32 [ %.pre6843, %if.then806 ], [ %128, %if.then793 ]
  %131 = phi i32 [ %.pre6842, %if.then806 ], [ %127, %if.then793 ]
  %132 = phi i32 [ %.pre6841, %if.then806 ], [ %126, %if.then793 ]
...
cond.end1230:                                     ; preds = %if.end1181
  ...
  store ptr %.pre6844, ptr @zz_res, align 8, !tbaa !8
  store ptr %141, ptr @zz_hold, align 8, !tbaa !8
  %cmp1236 = icmp eq ptr %.pre6844, null
  br i1 %cmp1236, label %cond.end1263, label %cond.false1239

cond.false1239:                                   ; preds = %cond.end1230.thread, %cond.end1230
  %196 = phi ptr [ %186, %cond.end1230.thread ], [ %.pre6844, %cond.end1230 ]
...
cond.end1336.cond.false1345_crit_edge:            ; preds = %cond.end1336
  ...
  %.pre6845 = load ptr, ptr %arrayidx1350.phi.trans.insert, align 8, !tbaa !5
  br label %cond.false1345

cond.false1345:                                   ; preds = %cond.end1336.cond.false1345_crit_edge, %cond.end1336.thread
  %214 = phi ptr [ %204, %cond.end1336.thread ], [ %.pre6845, %cond.end1336.cond.false1345_crit_edge ]
...
cond.end1584:                                     ; preds = %if.end1538
  ...
  store ptr %.pre6873, ptr @zz_res, align 8, !tbaa !8
  store ptr %y.10, ptr @zz_hold, align 8, !tbaa !8
  %cmp1590 = icmp eq ptr %.pre6873, null
  br i1 %cmp1590, label %for.inc3473, label %cond.false1593

cond.false1593:                                   ; preds = %cond.end1584.thread, %cond.end1584
  %248 = phi ptr [ %238, %cond.end1584.thread ], [ %.pre6873, %cond.end1584 ]
...
cond.end1714:                                     ; preds = %cond.end1684, %cond.false1692
  %266 = phi ptr [ %257, %cond.end1684 ], [ %.pre6871, %cond.false1692 ]
...
cond.end1851:                                     ; preds = %cond.end1821, %cond.false1829
  %287 = phi ptr [ %278, %cond.end1821 ], [ %.pre6868, %cond.false1829 ]
...
cond.end1952:                                     ; preds = %cond.end1922, %cond.false1930
  %303 = phi ptr [ %294, %cond.end1922 ], [ %.pre6869, %cond.false1930 ]
...
cond.end2079:                                     ; preds = %cond.end2049, %cond.false2057
  %324 = phi ptr [ %315, %cond.end2049 ], [ %.pre6870, %cond.false2057 ]
...
cond.end2284:                                     ; preds = %cond.end2254, %cond.false2262
  %346 = phi ptr [ %337, %cond.end2254 ], [ %.pre6849, %cond.false2262 ]
...
cond.end2385:                                     ; preds = %cond.end2355, %cond.false2363
  %362 = phi ptr [ %353, %cond.end2355 ], [ %.pre6850, %cond.false2363 ]
...
while.cond2596.preheader:                         ; preds = %cond.end2563
  ...
  %.pre6847 = load ptr, ptr %osucc25996704.phi.trans.insert, align 8, !tbaa !5
  %cmp2600.not6705 = icmp eq ptr %.pre6847, %394
...
cond.end2563:                                     ; preds = %cond.end2533, %cond.false2541
  %389 = phi ptr [ %380, %cond.end2533 ], [ %.pre6846, %cond.false2541 ]
...
while.body2602:                                   ; preds = %while.cond2596.preheader, %cond.end2664
  %396 = phi ptr [ %411, %cond.end2664 ], [ %.pre6847, %while.cond2596.preheader ]
...
cond.end2664:                                     ; preds = %cond.end2634, %cond.false2642
  %405 = phi ptr [ %396, %cond.end2634 ], [ %.pre6848, %cond.false2642 ]
...
while.end2696:                                    ; preds = %cond.end2664, %while.end2494, %while.cond2596.preheader
  %.lcssa6623 = phi ptr [ %.pre6847, %while.cond2596.preheader ], [ %z.0, %while.end2494 ], [ %410, %cond.end2664 ]
...
for.end2746.loopexit:                             ; preds = %for.inc2742
  %.pre6851 = load i8, ptr %ou11469.le, align 8, !tbaa !5
  br label %for.end2746

for.end2746:                                      ; preds = %for.end2746.loopexit, %for.cond2183.preheader
  %418 = phi i8 [ %.pre6851, %for.end2746.loopexit ], [ %227, %for.cond2183.preheader ]
...
if.then2804.if.then2853_crit_edge:                ; preds = %if.then2804
  %.pre6865 = load i32, ptr %arrayidx2759, align 4, !tbaa !5
...
if.then2853:                                      ; preds = %if.then2804.if.then2853_crit_edge, %land.lhs.true2792, %if.then2784
  %429 = phi i32 [ %.pre6865, %if.then2804.if.then2853_crit_edge ], [ %419, %land.lhs.true2792 ], [ %419, %if.then2784 ]
...
if.end2993:                                       ; preds = %if.then2979, %if.else2984
  %.sink6998 = phi i32 [ 1, %if.then2979 ], [ 0, %if.else2984 ]
  %call29916339 = call fastcc ptr @InterposeScale(ptr noundef %y.13, i32 noundef %call2957, i32 noundef %.sink6998)
...
if.then3055:                                      ; preds = %land.lhs.true3048, %if.end3041
  ...
  %.pre6852 = load i32, ptr %arrayidx3045, align 4, !tbaa !5
  br label %if.end3057

if.end3057:                                       ; preds = %if.then3055, %land.lhs.true3048
  %446 = phi i32 [ %.pre6852, %if.then3055 ], [ %443, %land.lhs.true3048 ]
...
cleanup3219.thread:                               ; preds = %if.else3155, %if.then3150
  %.sink7000 = phi i32 [ 0, %if.else3155 ], [ 1, %if.then3150 ]
  %call31616343 = call fastcc ptr @InterposeWideOrHigh(ptr noundef nonnull %z.1, i32 noundef %.sink7000)
  %call31626346 = call fastcc ptr @InterposeScale(ptr noundef %call31616343, i32 noundef %call3121, i32 noundef %.sink7000)
...
if.then3272:                                      ; preds = %land.lhs.true3264, %if.end3256
  ...
  %.pre6853 = load i32, ptr %arrayidx3261, align 4, !tbaa !5
  br label %if.end3274

if.end3274:                                       ; preds = %if.then3272, %land.lhs.true3264
  %470 = phi i32 [ %.pre6853, %if.then3272 ], [ %467, %land.lhs.true3264 ]
...
if.end3390:                                       ; preds = %if.then3374, %if.else3379
  %.sink7002 = phi i32 [ 1, %if.then3374 ], [ 0, %if.else3379 ]
  %call33866348 = call fastcc ptr @InterposeWideOrHigh(ptr noundef nonnull %z.4, i32 noundef %.sink7002)
  %call33886351 = call fastcc ptr @InterposeScale(ptr noundef %call33866348, i32 noundef %call3342, i32 noundef %.sink7002)
...
if.end3397:                                       ; preds = %land.lhs.true3283, %if.end3390
  %osucc5366968 = getelementptr inbounds [2 x %struct.LIST], ptr %86, i64 0, i64 1, i32 1
...
if.end3482:                                       ; preds = %if.then3480, %for.end3477
  ...
  %link.36743 = load ptr, ptr %osucc833, align 8, !tbaa !5
  %cmp3488.not6744 = icmp eq ptr %link.36743, %hd
  br i1 %cmp3488.not6744, label %if.end3704, label %for.cond3494.preheader

for.cond3494.preheader:                           ; preds = %if.end3482, %for.inc3616
  %link.36745 = phi ptr [ %link.3, %for.inc3616 ], [ %link.36743, %if.end3482 ]
  br label %for.cond3494

for.cond3494:                                     ; preds = %for.cond3494.preheader, %for.cond3494
  %link.3.pn = phi ptr [ %y.17, %for.cond3494 ], [ %link.36745, %for.cond3494.preheader ]
...
sw.bb3509:                                        ; preds = %for.cond3494, %for.cond3494, %for.cond3494, %for.cond3494, %for.cond3494, %for.cond3494
  %493 = load ptr, ptr %link.36745, align 8, !tbaa !5
...
cond.end3574:                                     ; preds = %cond.end3544, %cond.false3552
  %503 = phi ptr [ %494, %cond.end3544 ], [ %.pre6874, %cond.false3552 ]
...
for.inc3616:                                      ; preds = %for.cond3494, %if.then3611, %cond.end3574
  %link.4 = phi ptr [ %493, %if.then3611 ], [ %493, %cond.end3574 ], [ %link.36745, %for.cond3494 ]
...
for.end3620:                                      ; preds = %for.inc3616
  %.pre6875 = load ptr, ptr %osucc833, align 8, !tbaa !5
  ...
  %cmp3627.not = icmp eq ptr %.pre6875, %hd
...
if.end3637:                                       ; preds = %if.then3635, %if.then3629
  ...
  %514 = load ptr, ptr %.pre6875, align 8, !tbaa !5
...
cond.end3769:                                     ; preds = %cond.end3736, %cond.false3745
  %544 = load i8, ptr %ou16988, align 8, !tbaa !5
...
if.end3778:                                       ; preds = %if.then3776, %cond.end3769
  ...
  %cmp3783.not6747 = icmp eq ptr %546, %hd_index.0
  br i1 %cmp3783.not6747, label %while.cond3880.preheader, label %while.body3785

while.cond3880.preheader:                         ; preds = %cond.end3847, %if.end3778
  %547 = phi ptr [ %hd_index.0, %if.end3778 ], [ %563, %cond.end3847 ]
  %osucc38836748 = getelementptr inbounds %struct.LIST, ptr %547, i64 0, i32 1
  %548 = load ptr, ptr %osucc38836748, align 8, !tbaa !5
  %cmp3884.not6749 = icmp eq ptr %548, %547
  br i1 %cmp3884.not6749, label %while.end3980, label %while.body3886
...
cond.end3847:                                     ; preds = %cond.end3817, %cond.false3825
  %558 = phi ptr [ %549, %cond.end3817 ], [ %.pre6876, %cond.false3825 ]
...
cond.end3948:                                     ; preds = %cond.end3918, %cond.false3926
  %574 = phi ptr [ %565, %cond.end3918 ], [ %.pre6877, %cond.false3926 ]
...
cond.end4062:                                     ; preds = %if.then4030, %cond.false4040
  %595 = phi ptr [ %589, %if.then4030 ], [ %.pre6867, %cond.false4040 ]
...
cond.end4132:                                     ; preds = %if.else4100, %cond.false4110
  %603 = phi ptr [ %597, %if.else4100 ], [ %.pre6866, %cond.false4110 ]
...
if.end4173.sink.split:                            ; preds = %cond.end4132, %cond.end4062
  %.sink7014 = phi ptr [ %596, %cond.end4062 ], [ %605, %cond.end4132 ]
  %.sink7012 = phi ptr [ %595, %cond.end4062 ], [ %603, %cond.end4132 ]
  %606 = load ptr, ptr %.sink7014, align 8, !tbaa !5
  store ptr %606, ptr @zz_tmp, align 8, !tbaa !8
  %607 = load ptr, ptr %.sink7012, align 8, !tbaa !5
  store ptr %607, ptr %.sink7014, align 8, !tbaa !5
...
cond.end4216:                                     ; preds = %if.end4183, %cond.false4194
  %621 = phi ptr [ %615, %if.end4183 ], [ %.pre6872, %cond.false4194 ]
...
cond.end4294:                                     ; preds = %ACCEPT, %cond.false4272
  %638 = phi ptr [ %632, %ACCEPT ], [ %.pre6854, %cond.false4272 ]
...
cond.end4327:                                     ; preds = %cond.end4294, %cond.false4303
  %648 = load i8, ptr %ou16988, align 8, !tbaa !5
...
if.end4336:                                       ; preds = %if.then4334, %cond.end4327
  ...
  %cmp4341.not6724 = icmp eq ptr %650, %hd_index.0
  br i1 %cmp4341.not6724, label %while.cond4438.preheader, label %while.body4343

while.cond4438.preheader:                         ; preds = %cond.end4405, %if.end4336
  %651 = phi ptr [ %hd_index.0, %if.end4336 ], [ %667, %cond.end4405 ]
  %osucc44416725 = getelementptr inbounds %struct.LIST, ptr %651, i64 0, i32 1
  %652 = load ptr, ptr %osucc44416725, align 8, !tbaa !5
  %cmp4442.not6726 = icmp eq ptr %652, %651
  br i1 %cmp4442.not6726, label %while.end4538, label %while.body4444
...
cond.end4405:                                     ; preds = %cond.end4375, %cond.false4383
  %662 = phi ptr [ %653, %cond.end4375 ], [ %.pre6855, %cond.false4383 ]
...
cond.end4506:                                     ; preds = %cond.end4476, %cond.false4484
  %678 = phi ptr [ %669, %cond.end4476 ], [ %.pre6856, %cond.false4484 ]
...
if.then4615:                                      ; preds = %for.cond4598
  ...
  %.pre6857 = load ptr, ptr %junk, align 8, !tbaa !8
  br label %if.end4617

if.end4617:                                       ; preds = %for.cond4598, %if.then4615
  %694 = phi ptr [ %.pre6857, %if.then4615 ], [ %storemerge, %for.cond4598 ]
...
if.end5000:                                       ; preds = %for.end4999, %cond.end4964
  ...
  %705 = load ptr, ptr %osucc5366968, align 8, !tbaa !5
  %cmp5005.not6729 = icmp eq ptr %705, %86
  br i1 %cmp5005.not6729, label %while.cond5102.preheader, label %while.body5007

while.cond5102.preheader:                         ; preds = %cond.end5069, %if.end5000
  %706 = phi ptr [ %86, %if.end5000 ], [ %722, %cond.end5069 ]
  %osucc51056730 = getelementptr inbounds %struct.LIST, ptr %706, i64 0, i32 1
  %707 = load ptr, ptr %osucc51056730, align 8, !tbaa !5
  %cmp5106.not6731 = icmp eq ptr %707, %706
  br i1 %cmp5106.not6731, label %while.end5202, label %while.body5108
...
cond.end5069:                                     ; preds = %cond.end5039, %cond.false5047
  %717 = phi ptr [ %708, %cond.end5039 ], [ %.pre6858, %cond.false5047 ]
...
cond.end5170:                                     ; preds = %cond.end5140, %cond.false5148
  %733 = phi ptr [ %724, %cond.end5140 ], [ %.pre6859, %cond.false5148 ]
...
if.end5254:                                       ; preds = %if.then5248, %if.end5240
  ...
  %osucc52586733 = getelementptr inbounds [2 x %struct.LIST], ptr %target_index.1, i64 0, i64 1, i32 1
  %748 = load ptr, ptr %osucc52586733, align 8, !tbaa !5
  %cmp5259.not6734 = icmp eq ptr %748, %target_index.1
  br i1 %cmp5259.not6734, label %while.cond5356.preheader, label %while.body5261

while.cond5356.preheader:                         ; preds = %cond.end5323, %if.end5254
  %749 = phi ptr [ %target_index.1, %if.end5254 ], [ %765, %cond.end5323 ]
  %osucc53596735 = getelementptr inbounds %struct.LIST, ptr %749, i64 0, i32 1
  %750 = load ptr, ptr %osucc53596735, align 8, !tbaa !5
  %cmp5360.not6736 = icmp eq ptr %750, %749
  br i1 %cmp5360.not6736, label %while.end5456, label %while.body5362
...
cond.end5323:                                     ; preds = %cond.end5293, %cond.false5301
  %760 = phi ptr [ %751, %cond.end5293 ], [ %.pre6860, %cond.false5301 ]
...
cond.end5424:                                     ; preds = %cond.end5394, %cond.false5402
  %776 = phi ptr [ %767, %cond.end5394 ], [ %.pre6861, %cond.false5402 ]
...
cond.false5552:                                   ; preds = %if.then5503, %if.then5509
  ...
  %.pre6862 = load ptr, ptr %hd_inners, align 8, !tbaa !8
  br label %if.end5578

if.end5578:                                       ; preds = %cond.false5552, %if.else5494
  %808 = phi ptr [ %.pre6862, %cond.false5552 ], [ %788, %if.else5494 ]
  store ptr %808, ptr @xx_hold, align 8, !tbaa !8
  %osucc55826738 = getelementptr inbounds [2 x %struct.LIST], ptr %808, i64 0, i64 1, i32 1
  %809 = load ptr, ptr %osucc55826738, align 8, !tbaa !5
  %cmp5583.not6739 = icmp eq ptr %809, %808
  br i1 %cmp5583.not6739, label %while.cond5680.preheader, label %while.body5585

while.cond5680.preheader:                         ; preds = %cond.end5647, %if.end5578
  %810 = phi ptr [ %808, %if.end5578 ], [ %826, %cond.end5647 ]
  %osucc56836740 = getelementptr inbounds %struct.LIST, ptr %810, i64 0, i32 1
  %811 = load ptr, ptr %osucc56836740, align 8, !tbaa !5
  %cmp5684.not6741 = icmp eq ptr %811, %810
  br i1 %cmp5684.not6741, label %while.end5780, label %while.body5686
...
cond.end5647:                                     ; preds = %cond.end5617, %cond.false5625
  %821 = phi ptr [ %812, %cond.end5617 ], [ %.pre6863, %cond.false5625 ]
...
cond.end5748:                                     ; preds = %cond.end5718, %cond.false5726
  %837 = phi ptr [ %828, %cond.end5718 ], [ %.pre6864, %cond.false5726 ]
