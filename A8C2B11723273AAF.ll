...
entry:
  ...
  %1 = load <2 x float>, ptr %halfExtents, align 4, !tbaa !19
  %2 = load <2 x float>, ptr %m_localScaling, align 8, !tbaa !19
  ...
  %7 = load float, ptr %arrayidx11.i, align 4, !tbaa !19
  %arrayidx13.i = getelementptr inbounds %class.btConvexInternalShape, ptr %this, i64 0, i32 1, i32 0, i64 2
  %8 = load float, ptr %arrayidx13.i, align 8, !tbaa !19
  %mul14.i = fmul float %7, %8
  ...
  store <2 x float> %6, ptr %m_implicitShapeDimensions, align 8, !tbaa.struct !20
...
entry:
  ...
  store <2 x float> %6, ptr %m_implicitShapeDimensions.i, align 8, !tbaa.struct !20
