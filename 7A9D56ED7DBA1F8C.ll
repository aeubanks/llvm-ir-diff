; ModuleID = '/usr/local/google/home/aeubanks/repos/test-suite/SingleSource/Regression/C/gcc-c-torture/execute/20140425-1.c'
source_filename = "/usr/local/google/home/aeubanks/repos/test-suite/SingleSource/Regression/C/gcc-c-torture/execute/20140425-1.c"
...
entry:
  ...
  call fastcc void @set(ptr noundef nonnull %l)
  %0 = load i64, ptr %l, align 8, !tbaa !5
  %conv = trunc i64 %0 to i32
  %cmp.not = icmp ugt i32 %conv, 30
...
define internal fastcc void @set(ptr nocapture noundef writeonly %l) unnamed_addr #2 {
entry:
  store i64 31, ptr %l, align 8, !tbaa !5
  ret void
}
