; ModuleID = '/usr/local/google/home/aeubanks/repos/test-suite/SingleSource/Regression/C/gcc-c-torture/execute/20090623-1.c'
source_filename = "/usr/local/google/home/aeubanks/repos/test-suite/SingleSource/Regression/C/gcc-c-torture/execute/20090623-1.c"
...
define dso_local i32 @foo(i32 noundef returned %y) local_unnamed_addr #0 {
entry:
  %0 = load ptr, ptr @x, align 8, !tbaa !5
  store i32 %y, ptr %0, align 4, !tbaa !9
  ret i32 %y
}
...
entry:
  ...
  store ptr %i, ptr @x, align 8, !tbaa !5
