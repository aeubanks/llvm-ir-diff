...
for.body41:                                       ; preds = %for.end35, %for.inc49
  ...
  %and.i = and i32 %call42.val, 64
  %cmp.i177.not = icmp eq i32 %and.i, 0
  br i1 %cmp.i177.not, label %for.inc49, label %if.then45
...
for.body64:                                       ; preds = %list_Nconc.exit190, %for.inc72
  ...
  %17 = getelementptr i8, ptr %Scan.2255, i64 8
  %Scan.2.val147 = load ptr, ptr %17, align 8
  %18 = getelementptr i8, ptr %Scan.2.val147, i64 48
  %call65.val = load i32, ptr %18, align 8
  %and.i193 = and i32 %call65.val, 128
  %cmp.i194.not = icmp eq i32 %and.i193, 0
  br i1 %cmp.i194.not, label %for.inc72, label %if.then68
...
for.body83:                                       ; preds = %if.then77, %for.body83
  ...
  %19 = getelementptr i8, ptr %Scan.3259, i64 8
  %Scan.3.val = load ptr, ptr %19, align 8
...
for.end89:                                        ; preds = %for.body83
  ...
  %call.i202 = tail call i32 @putc(i32 noundef 10, ptr noundef %20)
  br label %if.end91
...
if.end91:                                         ; preds = %list_Nconc.exit190, %for.end89, %for.end74
  ...
  %21 = load i32, ptr @dp_DEPTH, align 4
  %call93 = tail call i32 @list_Length(ptr noundef %call55) #7
  %call94 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef %21, i32 noundef %call93)
  tail call void @clause_ListPrint(ptr noundef %call55) #7
  %22 = getelementptr i8, ptr %Search.val, i64 124
  %call.val = load i32, ptr %22, align 4
  %tobool96.not = icmp eq i32 %call.val, 0
  br i1 %tobool96.not, label %if.end99, label %if.then97

if.then97:                                        ; preds = %if.end91
  %23 = getelementptr i8, ptr %Search, i64 104
  %Search.val157 = load ptr, ptr %23, align 8
  %call1.i = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %FilePrefix) #8
  %24 = trunc i64 %call1.i to i32
  %conv.i203 = add i32 %24, 5
  ...
  %25 = tail call i64 @fwrite(ptr nonnull @.str.6, i64 25, i64 1, ptr %call4.i)
  %26 = tail call i64 @fwrite(ptr nonnull @.str.7, i64 22, i64 1, ptr %call4.i)
  %27 = tail call i64 @fwrite(ptr nonnull @.str.8, i64 7, i64 1, ptr %call4.i)
  %call8.i = tail call i32 @fputs(ptr noundef %FilePrefix, ptr noundef %call4.i)
  %28 = tail call i64 @fwrite(ptr nonnull @.str.9, i64 5, i64 1, ptr %call4.i)
  %29 = tail call i64 @fwrite(ptr nonnull @.str.10, i64 15, i64 1, ptr %call4.i)
  %30 = tail call i64 @fwrite(ptr nonnull @.str.11, i64 5, i64 1, ptr %call4.i)
  %31 = tail call i64 @fwrite(ptr nonnull @.str.9, i64 5, i64 1, ptr %call4.i)
  %32 = tail call i64 @fwrite(ptr nonnull @.str.12, i64 23, i64 1, ptr %call4.i)
  %33 = tail call i64 @fwrite(ptr nonnull @.str.13, i64 62, i64 1, ptr %call4.i)
  %34 = tail call i64 @fwrite(ptr nonnull @.str.14, i64 14, i64 1, ptr %call4.i)
  %35 = tail call i64 @fwrite(ptr nonnull @.str.15, i64 17, i64 1, ptr %call4.i)
...
for.body.i:                                       ; preds = %if.then97, %for.inc.i
  ...
  %37 = getelementptr i8, ptr %Scan.0131.i, i64 8
  %Scan.0.val.i = load ptr, ptr %37, align 8
  %38 = getelementptr i8, ptr %Scan.0.val.i, i64 76
  %call19.val98.i = load i32, ptr %38, align 4
  %cmp.i99.i = icmp eq i32 %call19.val98.i, 16
  br i1 %cmp.i99.i, label %if.then.i, label %if.else27.i

if.then.i:                                        ; preds = %for.body.i
  %39 = getelementptr i8, ptr %Scan.0.val.i, i64 48
  %call19.val.i = load i32, ptr %39, align 8
  %and.i.i = and i32 %call19.val.i, 8
  %cmp.i101.not.i = icmp eq i32 %and.i.i, 0
  ...
  br i1 %cmp.i101.not.i, label %if.else.i, label %if.then24.i
...
for.end.i204:                                     ; preds = %for.inc.i, %if.then97
  ...
  %40 = tail call i64 @fwrite(ptr nonnull @.str.16, i64 23, i64 1, ptr %call4.i)
...
for.body39.i:                                     ; preds = %for.end.i204, %for.body39.i
  ...
  %41 = getelementptr i8, ptr %Scan.1136.i, i64 8
  %Scan.1.val.i = load ptr, ptr %41, align 8
...
for.end43.i:                                      ; preds = %for.body39.i, %for.end.i204
  %42 = tail call i64 @fwrite(ptr nonnull @.str.14, i64 14, i64 1, ptr %call4.i)
  %43 = tail call i64 @fwrite(ptr nonnull @.str.17, i64 14, i64 1, ptr %call4.i)
...
while.body.i116.i:                                ; preds = %list_Delete.exit.i, %while.body.i116.i
  ...
  %total_size.i.i.i112.i = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %51, i64 0, i32 4
  %52 = load i32, ptr %total_size.i.i.i112.i, align 8
  %conv26.i.i.i113.i = sext i32 %52 to i64
  %53 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i114.i = add i64 %53, %conv26.i.i.i113.i
  store i64 %add27.i.i.i114.i, ptr @memory_FREEDBYTES, align 8
  %54 = load ptr, ptr %51, align 8
  store ptr %54, ptr %Current.06.i110.i, align 8
  %55 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i110.i, ptr %55, align 8
...
while.body.i125.i:                                ; preds = %list_Delete.exit117.i, %while.body.i125.i
  ...
  %total_size.i.i.i121.i = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %56, i64 0, i32 4
  %57 = load i32, ptr %total_size.i.i.i121.i, align 8
  %conv26.i.i.i122.i = sext i32 %57 to i64
  %58 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i123.i = add i64 %58, %conv26.i.i.i122.i
  store i64 %add27.i.i.i123.i, ptr @memory_FREEDBYTES, align 8
  %59 = load ptr, ptr %56, align 8
  store ptr %59, ptr %Current.06.i119.i, align 8
  %60 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i119.i, ptr %60, align 8
...
list_Delete.exit126.i:                            ; preds = %while.body.i125.i, %list_Delete.exit117.i
  ...
  %61 = trunc i64 %call48.i to i32
  %conv51.i = add i32 %61, 5
...
if.then.i.i:                                      ; preds = %list_Delete.exit126.i
  ...
  %rem2.i.i.i.i = urem i32 %conv51.i, %62
  %tobool3.not.i.i.i.i = icmp eq i32 %rem2.i.i.i.i, 0
  %sub6.i.i.i.i = add i32 %62, %conv51.i
  ...
  %63 = load i32, ptr @memory_OFFSET, align 4
  ...
  %cmp2.not.i.i = icmp eq ptr %64, null
  %next6.i.i = getelementptr inbounds i8, ptr %add.ptr.i.i, i64 -8
  %65 = load ptr, ptr %next6.i.i, align 8
  %next5.i.i = getelementptr inbounds %struct.MEMORY_BIGBLOCKHEADERHELP, ptr %64, i64 0, i32 1
  %memory_BIGBLOCKS.sink.i.i = select i1 %cmp2.not.i.i, ptr @memory_BIGBLOCKS, ptr %next5.i.i
  store ptr %65, ptr %memory_BIGBLOCKS.sink.i.i, align 8
  %66 = load ptr, ptr %next6.i.i, align 8
  %cmp8.not.i.i = icmp eq ptr %66, null
...
if.else25.i.i:                                    ; preds = %list_Delete.exit126.i
  ...
  %total_size.i.i = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %71, i64 0, i32 4
  %72 = load i32, ptr %total_size.i.i, align 8
  %conv26.i.i = sext i32 %72 to i64
  %73 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i = add i64 %73, %conv26.i.i
  store i64 %add27.i.i, ptr @memory_FREEDBYTES, align 8
  %74 = load ptr, ptr %71, align 8
  store ptr %74, ptr %call2.i, align 8
  %75 = load ptr, ptr %arrayidx.i.i, align 8
  store ptr %call2.i, ptr %75, align 8
  br label %if.end99

if.end99:                                         ; preds = %if.else25.i.i, %if.end23.i.i, %if.end91
  %76 = load ptr, ptr @stdout, align 8
  %call100 = tail call i32 @fflush(ptr noundef %76)
...
while.body.i:                                     ; preds = %if.end99, %while.body.i
  ...
  %total_size.i.i.i205 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %77, i64 0, i32 4
  %78 = load i32, ptr %total_size.i.i.i205, align 8
  %conv26.i.i.i206 = sext i32 %78 to i64
  %79 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i207 = add i64 %79, %conv26.i.i.i206
...
while.body.i216:                                  ; preds = %list_Delete.exit, %while.body.i216
  ...
  %total_size.i.i.i212 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %82, i64 0, i32 4
  %83 = load i32, ptr %total_size.i.i.i212, align 8
  %conv26.i.i.i213 = sext i32 %83 to i64
  %84 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i214 = add i64 %84, %conv26.i.i.i213
  store i64 %add27.i.i.i214, ptr @memory_FREEDBYTES, align 8
  %85 = load ptr, ptr %82, align 8
  store ptr %85, ptr %Current.06.i210, align 8
  %86 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i210, ptr %86, align 8
...
while.body.i225:                                  ; preds = %list_Delete.exit217, %while.body.i225
  ...
  %total_size.i.i.i221 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %87, i64 0, i32 4
  %88 = load i32, ptr %total_size.i.i.i221, align 8
  %conv26.i.i.i222 = sext i32 %88 to i64
  %89 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i223 = add i64 %89, %conv26.i.i.i222
  store i64 %add27.i.i.i223, ptr @memory_FREEDBYTES, align 8
  %90 = load ptr, ptr %87, align 8
  store ptr %90, ptr %Current.06.i219, align 8
  %91 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i219, ptr %91, align 8
...
while.body.i234:                                  ; preds = %list_Delete.exit226, %while.body.i234
  ...
  %total_size.i.i.i230 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %92, i64 0, i32 4
  %93 = load i32, ptr %total_size.i.i.i230, align 8
  %conv26.i.i.i231 = sext i32 %93 to i64
  %94 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i232 = add i64 %94, %conv26.i.i.i231
  store i64 %add27.i.i.i232, ptr @memory_FREEDBYTES, align 8
  %95 = load ptr, ptr %92, align 8
  store ptr %95, ptr %Current.06.i228, align 8
  %96 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i228, ptr %96, align 8
...
while.body.i243:                                  ; preds = %list_Delete.exit235, %while.body.i243
  ...
  %total_size.i.i.i239 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %97, i64 0, i32 4
  %98 = load i32, ptr %total_size.i.i.i239, align 8
  %conv26.i.i.i240 = sext i32 %98 to i64
  %99 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i241 = add i64 %99, %conv26.i.i.i240
  store i64 %add27.i.i.i241, ptr @memory_FREEDBYTES, align 8
  %100 = load ptr, ptr %97, align 8
  store ptr %100, ptr %Current.06.i237, align 8
  %101 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i237, ptr %101, align 8
