...
"assert failed80":                                ; preds = %"for result$2.s0.i"
  %1113 = tail call i32 @halide_error_explicit_bounds_too_small(ptr null, ptr nonnull @str.11, ptr nonnull @str.12, i32 0, i32 7, i32 %84, i32 %b29) #2
  br label %destructor_block
...
"assert failed82":                                ; preds = %"assert succeeded81"
  ...
  %1115 = tail call i32 @halide_error_explicit_bounds_too_small(ptr null, ptr nonnull @str.13, ptr nonnull @str.12, i32 0, i32 7, i32 %1114, i32 %a32) #2
  br label %destructor_block
