...
define dso_local void @perrmesg(ptr noundef %0, i32 noundef %1, ptr noundef %2) local_unnamed_addr #0 {
  %4 = load ptr, ptr @stderr, align 8, !tbaa !5
  %5 = icmp eq i32 %1, 0
  %6 = load i32, ptr @perrno, align 4
  %7 = select i1 %5, i32 %6, i32 %1
  %8 = sext i32 %7 to i64
  %9 = getelementptr inbounds [256 x ptr], ptr @p_err_text, i64 0, i64 %8
...
12:                                               ; preds = %3
  ...
  %14 = icmp eq i8 %13, 0
  %15 = select i1 %14, ptr @.str.7, ptr @.str.50
  br label %21

16:                                               ; preds = %3
  %17 = load i8, ptr @p_err_string, align 16
  %18 = icmp ne i8 %17, 0
  %19 = select i1 %5, i1 %18, i1 false
  %20 = select i1 %19, ptr @.str.50, ptr @.str.7
  br label %21

21:                                               ; preds = %16, %12
  %22 = phi ptr [ %15, %12 ], [ %20, %16 ]
  %23 = select i1 %5, ptr @p_err_string, ptr @.str.7
  %24 = select i1 %11, ptr %23, ptr %2
  %25 = icmp eq ptr %0, null
  %26 = select i1 %25, ptr @.str.7, ptr %0
  %27 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %4, ptr noundef nonnull @.str.49, ptr noundef %26, ptr noundef %10, ptr noundef nonnull %22, ptr noundef nonnull %24) #2
  ret void
}
...
; Function Attrs: nofree nounwind uwtable
define dso_local void @sperrmesg(ptr nocapture noundef writeonly %0, ptr noundef %1, i32 noundef %2, ptr noundef %3) local_unnamed_addr #0 {
  %5 = icmp eq i32 %2, 0
  %6 = load i32, ptr @perrno, align 4
...
21:                                               ; preds = %16, %12
  %22 = phi ptr [ %15, %12 ], [ %20, %16 ]
  %23 = select i1 %5, ptr @p_err_string, ptr @.str.7
  %24 = select i1 %11, ptr %23, ptr %3
  %25 = icmp eq ptr %1, null
  %26 = select i1 %25, ptr @.str.7, ptr %1
  %27 = tail call i32 (ptr, ptr, ...) @sprintf(ptr noundef nonnull dereferenceable(1) %0, ptr noundef nonnull dereferenceable(1) @.str.49, ptr noundef %26, ptr noundef %10, ptr noundef nonnull %22, ptr noundef nonnull %24) #3
  ret void
}
...
; Function Attrs: nofree nounwind uwtable
define dso_local void @pwarnmesg(ptr noundef %0, i32 noundef %1, ptr noundef %2) local_unnamed_addr #0 {
  %4 = load ptr, ptr @stderr, align 8, !tbaa !5
  %5 = icmp eq i32 %1, 0
  %6 = load i32, ptr @pwarn, align 4
  %7 = select i1 %5, i32 %6, i32 %1
  %8 = sext i32 %7 to i64
  %9 = getelementptr inbounds [256 x ptr], ptr @p_warn_text, i64 0, i64 %8
  %10 = load ptr, ptr %9, align 8, !tbaa !5
  %11 = icmp eq ptr %2, null
  br i1 %11, label %16, label %12
...
16:                                               ; preds = %3
  %17 = load i8, ptr @p_warn_string, align 16
  %18 = icmp ne i8 %17, 0
  %19 = select i1 %5, i1 %18, i1 false
  %20 = select i1 %19, ptr @.str.50, ptr @.str.7
  br label %21
...
21:                                               ; preds = %16, %12
  %22 = phi ptr [ %15, %12 ], [ %20, %16 ]
  %23 = select i1 %5, ptr @p_warn_string, ptr @.str.7
  %24 = select i1 %11, ptr %23, ptr %2
  %25 = icmp eq ptr %0, null
  %26 = select i1 %25, ptr @.str.7, ptr %0
  %27 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %4, ptr noundef nonnull @.str.49, ptr noundef %26, ptr noundef %10, ptr noundef nonnull %22, ptr noundef nonnull %24) #2
...
; Function Attrs: nofree nounwind uwtable
define dso_local void @spwarnmesg(ptr nocapture noundef writeonly %0, ptr noundef %1, i32 noundef %2, ptr noundef %3) local_unnamed_addr #0 {
  %5 = icmp eq i32 %2, 0
  %6 = load i32, ptr @pwarn, align 4
  %7 = select i1 %5, i32 %6, i32 %2
  %8 = sext i32 %7 to i64
