...
entry:
  %retval.sroa.0.0.copyload = load i32, ptr @gs, align 4, !tbaa.struct !5
...
entry:
  ...
  %coerce.sroa.0.0.extract.trunc = trunc i32 %call to i16
  %coerce.sroa.2.0.extract.shift = lshr i32 %call, 16
  %coerce.sroa.2.0.extract.trunc = trunc i32 %coerce.sroa.2.0.extract.shift to i16
  %gs.real = load i16, ptr @gs, align 4
  %gs.imag = load i16, ptr getelementptr inbounds (%struct.s, ptr @gs, i64 0, i32 0, i32 1), align 2
  %cmp.r = icmp ne i16 %gs.real, %coerce.sroa.0.0.extract.trunc
  %cmp.i = icmp ne i16 %gs.imag, %coerce.sroa.2.0.extract.trunc
