...
define dso_local i32 @rotate(i32 noundef %w, i32 noundef %h, i32 noundef %angle) local_unnamed_addr #0 {
entry:
  %conv = sitofp i32 %angle to double
  %mul = fmul double %conv, 0x400921FB54442D18
  %div = fdiv double %mul, 1.800000e+02
  %conv1 = fptrunc double %div to float
  store float %conv1, ptr @text_rotation, align 4, !tbaa !5
  ret i32 0
}
