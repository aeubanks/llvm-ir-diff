...
entry:
  %image432 = ptrtoint ptr %image to i64
...
for.end:                                          ; preds = %for.body
  ...
  %cmp53.not381 = icmp ult ptr %add.ptr1, %image
  %or.cond382 = select i1 %cmp50, i1 true, i1 %cmp53.not381
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(777) %array1, i8 0, i64 777, i1 false)
  br i1 %or.cond382, label %if.then169.critedge, label %land.lhs.true55.lr.ph
...
land.lhs.true55:                                  ; preds = %land.lhs.true55.lr.ph, %if.end162
  %i.1384 = phi i32 [ 0, %land.lhs.true55.lr.ph ], [ %i.4, %if.end162 ]
  %blocks.0383 = phi ptr [ %add.ptr1, %land.lhs.true55.lr.ph ], [ %add.ptr56, %if.end162 ]
  %add.ptr56 = getelementptr inbounds i8, ptr %blocks.0383, i64 8
...
land.lhs.true65:                                  ; preds = %land.lhs.true55
  %blocks.0.val = load i32, ptr %blocks.0383, align 1
...
land.lhs.true68:                                  ; preds = %land.lhs.true65
  %add.ptr69 = getelementptr inbounds i8, ptr %blocks.0383, i64 4
...
if.end.i:                                         ; preds = %if.end107
  ...
  %7 = add i64 %image432, %idx.ext81
  %8 = add i64 %image432, %idx.ext81
...
while.cond.outer.backedge.i.i:                    ; preds = %while.body129.i.i.prol.loopexit, %while.body129.i.i, %middle.block, %if.then2.i.i
  %11 = phi i32 [ %9, %if.then2.i.i ], [ %36, %middle.block ], [ %36, %while.body129.i.i ], [ %36, %while.body129.i.i.prol.loopexit ]
...
while.body.lr.ph.i.i.i:                           ; preds = %if.end26.i.i
  ...
  %hash.i.i.i.promoted = load i32, ptr %hash, align 4, !tbaa !15
  br label %while.body.i.i.i

while.body.i.i.i:                                 ; preds = %if.end.i.i.i, %while.body.lr.ph.i.i.i
  %or.i.i.i374 = phi i32 [ %hash.i.i.i.promoted, %while.body.lr.ph.i.i.i ], [ %or.i.i.i, %if.end.i.i.i ]
  %incdec.ptr15.i.i.i = phi ptr [ %input.promoted.i.i.i, %while.body.lr.ph.i.i.i ], [ %incdec.ptr.i.i.i, %if.end.i.i.i ]
  %15 = phi i32 [ %.pr.i.i.i, %while.body.lr.ph.i.i.i ], [ %sub.i.i.i, %if.end.i.i.i ]
...
if.end.i.i.i:                                     ; preds = %while.body.i.i.i
  %shl.i.i.i = shl i32 %or.i.i.i374, 8
  %16 = load i8, ptr %incdec.ptr15.i.i.i, align 1, !tbaa !17
...
cleanup.i.i:                                      ; preds = %if.end.i.i.i, %if.end26.cleanup_crit_edge.i.i
  %17 = phi i32 [ %.pr.i.i.i, %if.end26.cleanup_crit_edge.i.i ], [ %sub.i.i.i, %if.end.i.i.i ]
  %18 = phi i32 [ %.pre.i.i, %if.end26.cleanup_crit_edge.i.i ], [ %or.i.i.i, %if.end.i.i.i ]
  %idxprom34.i.i = zext i32 %call21.i.i to i64
  %arrayidx35.i.i = getelementptr inbounds i8, ptr %arrayidx116, i64 %idxprom34.i.i
  %19 = load i8, ptr %arrayidx35.i.i, align 1, !tbaa !17
  %conv36.i.i = zext i8 %19 to i32
  %sub37.i.i = sub nuw nsw i32 8, %17
  %shr38.i.i = lshr i32 %18, %sub37.i.i
  ...
  %add47.i.i = add nuw nsw i32 %17, %conv40.i.i
...
if.end48.i.i:                                     ; preds = %cleanup.i.i, %if.end11.i.i
  ...
  %20 = load i32, ptr %arrayidx50.i.i, align 4, !tbaa !16
  ...
  %21 = load i8, ptr %arrayidx53.i.i, align 1, !tbaa !17
  %conv54.i.i = zext i8 %21 to i32
  %22 = load i32, ptr %dict_ok.i.i, align 8, !tbaa !26
  %tobool55.i.i = icmp eq i32 %22, 0
  %cmp57.i.i = icmp ult i8 %21, 3
...
while.body.lr.ph.i210.i.i:                        ; preds = %if.then59.i.i
  %23 = load ptr, ptr %iend, align 8, !tbaa !21
  %input.promoted.i209.i.i = load ptr, ptr %input, align 8, !tbaa !20
  %hash.i.i.i.promoted377 = load i32, ptr %hash, align 4, !tbaa !15
  br label %while.body.i213.i.i

while.body.i213.i.i:                              ; preds = %if.end.i220.i.i, %while.body.lr.ph.i210.i.i
  %or.i216.i.i378 = phi i32 [ %hash.i.i.i.promoted377, %while.body.lr.ph.i210.i.i ], [ %or.i216.i.i, %if.end.i220.i.i ]
  %incdec.ptr15.i211.i.i = phi ptr [ %input.promoted.i209.i.i, %while.body.lr.ph.i210.i.i ], [ %incdec.ptr.i217.i.i, %if.end.i220.i.i ]
  %24 = phi i32 [ %.pr.i204.i.i, %while.body.lr.ph.i210.i.i ], [ %sub.i218.i.i, %if.end.i220.i.i ]
  %cmp1.not.i212.i.i = icmp ult ptr %incdec.ptr15.i211.i.i, %23
  br i1 %cmp1.not.i212.i.i, label %if.end.i220.i.i, label %decomp_block.exit.thread356

if.end.i220.i.i:                                  ; preds = %while.body.i213.i.i
  %shl.i214.i.i = shl i32 %or.i216.i.i378, 8
  %25 = load i8, ptr %incdec.ptr15.i211.i.i, align 1, !tbaa !17
  %conv.i215.i.i = zext i8 %25 to i32
...
if.end63.i.i:                                     ; preds = %if.end.i220.i.i, %if.then59.if.end63_crit_edge.i.i
  %26 = phi i32 [ %.pr.i204.i.i, %if.then59.if.end63_crit_edge.i.i ], [ %sub.i218.i.i, %if.end.i220.i.i ]
  %27 = phi i32 [ %.pre261.i.i, %if.then59.if.end63_crit_edge.i.i ], [ %or.i216.i.i, %if.end.i220.i.i ]
  %sub66.i.i = sub nuw nsw i32 8, %26
  %shr67.i.i = lshr i32 %27, %sub66.i.i
  %and68.i.i = and i32 %shr67.i.i, 16777215
  %sub69.i.i = sub nsw i32 24, %conv54.i.i
  %shr70.i.i = lshr i32 %and68.i.i, %sub69.i.i
  %add71.i.i = add i32 %shr70.i.i, %20
  %add73.i.i = add i32 %26, %conv54.i.i
...
while.body.lr.ph.i229.i.i:                        ; preds = %if.else.i.i
  %28 = load ptr, ptr %iend, align 8, !tbaa !21
  %input.promoted.i228.i.i = load ptr, ptr %input, align 8, !tbaa !20
  %hash.i.i.i.promoted375 = load i32, ptr %hash, align 4, !tbaa !15
  br label %while.body.i232.i.i

while.body.i232.i.i:                              ; preds = %if.end.i239.i.i, %while.body.lr.ph.i229.i.i
  %or.i235.i.i376 = phi i32 [ %hash.i.i.i.promoted375, %while.body.lr.ph.i229.i.i ], [ %or.i235.i.i, %if.end.i239.i.i ]
  %incdec.ptr15.i230.i.i = phi ptr [ %input.promoted.i228.i.i, %while.body.lr.ph.i229.i.i ], [ %incdec.ptr.i236.i.i, %if.end.i239.i.i ]
  %29 = phi i32 [ %.pr.i223.i.i, %while.body.lr.ph.i229.i.i ], [ %sub.i237.i.i, %if.end.i239.i.i ]
  %cmp1.not.i231.i.i = icmp ult ptr %incdec.ptr15.i230.i.i, %28
  br i1 %cmp1.not.i231.i.i, label %if.end.i239.i.i, label %decomp_block.exit.thread356

if.end.i239.i.i:                                  ; preds = %while.body.i232.i.i
  %shl.i233.i.i = shl i32 %or.i235.i.i376, 8
  %30 = load i8, ptr %incdec.ptr15.i230.i.i, align 1, !tbaa !17
  %conv.i234.i.i = zext i8 %30 to i32
...
if.end78.i.i:                                     ; preds = %if.end.i239.i.i, %if.else.if.end78_crit_edge.i.i
  %31 = phi i32 [ %.pr.i223.i.i, %if.else.if.end78_crit_edge.i.i ], [ %sub.i237.i.i, %if.end.i239.i.i ]
  %32 = phi i32 [ %.pre260.i.i, %if.else.if.end78_crit_edge.i.i ], [ %or.i235.i.i, %if.end.i239.i.i ]
  %sub81.i.i = sub nuw nsw i32 8, %31
  %shr82.i.i = lshr i32 %32, %sub81.i.i
  ...
  %add88.i.i = add i32 %sub74.i.i, %31
  ...
  %add86.i.i = add i32 %call89.i.i, %20
  %add90.i.i = add i32 %add86.i.i, %mul.i.i
  %33 = load i32, ptr %oob.i.i, align 4, !tbaa !16
  %tobool91.not.i.i = icmp eq i32 %33, 0
...
if.then97.i.i:                                    ; preds = %if.end94.i.i
  ...
  %34 = load i32, ptr %arrayidx99.i.i, align 4, !tbaa !16
...
if.then102.i.i:                                   ; preds = %if.then97.i.i
  ...
  store i32 %34, ptr %hist.i.i, align 16, !tbaa !16
  br label %if.end115.i.i

if.else108.i.i:                                   ; preds = %if.end94.i.i
  %35 = load i32, ptr %arrayidx109.i.i, align 4, !tbaa !16
  store i32 %35, ptr %arrayidx110.i.i, align 8, !tbaa !16
...
if.end115.i.i:                                    ; preds = %if.else108.i.i, %if.then102.i.i, %if.then97.i.i
  %36 = phi i32 [ %34, %if.then102.i.i ], [ %9, %if.then97.i.i ], [ %sub113.i.i, %if.else108.i.i ]
  %backbytes.0.i.i = phi i32 [ %34, %if.then102.i.i ], [ %34, %if.then97.i.i ], [ %sub113.i.i, %if.else108.i.i ]
...
while.body129.i.i.preheader:                      ; preds = %if.end115.i.i
  ...
  br i1 %min.iters.check, label %while.body129.i.i.preheader436, label %vector.scevcheck

vector.scevcheck:                                 ; preds = %while.body129.i.i.preheader
  %37 = add i32 %backsize.1.i.i, -1
  %38 = xor i32 %counter.0.ph.i15.i, -1
  %39 = icmp ugt i32 %37, %38
  %40 = sub i32 %backbytes.0.i.i, %counter.0.ph.i15.i
  %41 = icmp ult i32 %40, %37
  %42 = or i1 %39, %41
  br i1 %42, label %while.body129.i.i.preheader436, label %vector.memcheck

vector.memcheck:                                  ; preds = %vector.scevcheck
  %43 = zext i32 %counter.0.ph.i15.i to i64
  %44 = add i64 %7, %43
  %45 = xor i32 %backbytes.0.i.i, -1
  %46 = add i32 %counter.0.ph.i15.i, %45
  %47 = zext i32 %46 to i64
  %48 = add i64 %8, %47
  %49 = sub i64 %44, %48
  %diff.check = icmp ult i64 %49, 32
  br i1 %diff.check, label %while.body129.i.i.preheader436, label %vector.ph

vector.ph:                                        ; preds = %vector.memcheck
  %n.vec = and i32 %backsize.1.i.i, -32
  %ind.end = add i32 %counter.0.ph.i15.i, %n.vec
  %ind.end433 = and i32 %backsize.1.i.i, 31
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i32 [ 0, %vector.ph ], [ %index.next, %vector.body ]
  %offset.idx = add i32 %counter.0.ph.i15.i, %index
  %50 = add i32 %offset.idx, %inc116.neg.i.i
  %51 = zext i32 %50 to i64
  %52 = getelementptr inbounds i8, ptr %add.ptr82, i64 %51
  %wide.load = load <16 x i8>, ptr %52, align 1, !tbaa !17
  %53 = getelementptr inbounds i8, ptr %52, i64 16
  %wide.load435 = load <16 x i8>, ptr %53, align 1, !tbaa !17
  %54 = zext i32 %offset.idx to i64
  %55 = getelementptr inbounds i8, ptr %add.ptr82, i64 %54
  store <16 x i8> %wide.load, ptr %55, align 1, !tbaa !17
  %56 = getelementptr inbounds i8, ptr %55, i64 16
  store <16 x i8> %wide.load435, ptr %56, align 1, !tbaa !17
  %index.next = add nuw i32 %index, 32
  %57 = icmp eq i32 %index.next, %n.vec
  br i1 %57, label %middle.block, label %vector.body, !llvm.loop !27

middle.block:                                     ; preds = %vector.body
  %cmp.n = icmp eq i32 %backsize.1.i.i, %n.vec
  br i1 %cmp.n, label %while.cond.outer.backedge.i.i, label %while.body129.i.i.preheader436

while.body129.i.i.preheader436:                   ; preds = %vector.memcheck, %vector.scevcheck, %while.body129.i.i.preheader, %middle.block
  ...
  %backsize.2252.i.i.ph = phi i32 [ %backsize.1.i.i, %vector.memcheck ], [ %backsize.1.i.i, %vector.scevcheck ], [ %backsize.1.i.i, %while.body129.i.i.preheader ], [ %ind.end433, %middle.block ]
  %58 = add i32 %backsize.2252.i.i.ph, -1
...
while.body129.i.i.prol:                           ; preds = %while.body129.i.i.preheader436, %while.body129.i.i.prol
  %counter.1253.i.i.prol = phi i32 [ %inc135.i.i.prol, %while.body129.i.i.prol ], [ %counter.1253.i.i.ph, %while.body129.i.i.preheader436 ]
  %backsize.2252.i.i.prol = phi i32 [ %dec.i.i.prol, %while.body129.i.i.prol ], [ %backsize.2252.i.i.ph, %while.body129.i.i.preheader436 ]
  %prol.iter = phi i32 [ %prol.iter.next, %while.body129.i.i.prol ], [ 0, %while.body129.i.i.preheader436 ]
  ...
  %59 = load i8, ptr %arrayidx132.i.i.prol, align 1, !tbaa !17
  ...
  store i8 %59, ptr %arrayidx134.i.i.prol, align 1, !tbaa !17
...
while.body129.i.i.prol.loopexit:                  ; preds = %while.body129.i.i.prol, %while.body129.i.i.preheader436
  %inc135.i.i.lcssa.unr = phi i32 [ undef, %while.body129.i.i.preheader436 ], [ %inc135.i.i.prol, %while.body129.i.i.prol ]
  %counter.1253.i.i.unr = phi i32 [ %counter.1253.i.i.ph, %while.body129.i.i.preheader436 ], [ %inc135.i.i.prol, %while.body129.i.i.prol ]
  %backsize.2252.i.i.unr = phi i32 [ %backsize.2252.i.i.ph, %while.body129.i.i.preheader436 ], [ %dec.i.i.prol, %while.body129.i.i.prol ]
  %60 = icmp ult i32 %58, 3
  br i1 %60, label %while.cond.outer.backedge.i.i, label %while.body129.i.i
...
while.body129.i.i:                                ; preds = %while.body129.i.i.prol.loopexit, %while.body129.i.i
  ...
  %61 = load i8, ptr %arrayidx132.i.i, align 1, !tbaa !17
  ...
  store i8 %61, ptr %arrayidx134.i.i, align 1, !tbaa !17
  ...
  %62 = load i8, ptr %arrayidx132.i.i.1, align 1, !tbaa !17
  ...
  store i8 %62, ptr %arrayidx134.i.i.1, align 1, !tbaa !17
  ...
  %63 = load i8, ptr %arrayidx132.i.i.2, align 1, !tbaa !17
  ...
  store i8 %63, ptr %arrayidx134.i.i.2, align 1, !tbaa !17
  ...
  %64 = load i8, ptr %arrayidx132.i.i.3, align 1, !tbaa !17
  ...
  store i8 %64, ptr %arrayidx134.i.i.3, align 1, !tbaa !17
...
while.body132:                                    ; preds = %while.body132.preheader, %if.end160
  %i.2380 = phi i32 [ %inc161, %if.end160 ], [ 0, %while.body132.preheader ]
  %add133 = add i32 %i.2380, %blocks.0.val
  %idxprom134 = zext i32 %add133 to i64
  %arrayidx135 = getelementptr inbounds i8, ptr %image, i64 %idxprom134
  %65 = load i8, ptr %arrayidx135, align 1, !tbaa !17
  %66 = and i8 %65, -2
  %or.cond237 = icmp eq i8 %66, -24
...
if.then142:                                       ; preds = %while.body132
  ...
  %67 = load i8, ptr %arrayidx146, align 1, !tbaa !17
  %68 = load i8, ptr %arrayidx150, align 1, !tbaa !17
  %cmp152 = icmp eq i8 %67, %68
...
if.then154:                                       ; preds = %if.then142
  ...
  %sub157 = sub i32 %shr, %i.2380
  store i32 %sub157, ptr %arrayidx146, align 1
  %add158 = add i32 %i.2380, 4
  br label %if.end160

if.end160:                                        ; preds = %if.then142, %if.then154, %while.body132
  %i.3 = phi i32 [ %add158, %if.then154 ], [ %i.2380, %if.then142 ], [ %i.2380, %while.body132 ]
...
if.then169.critedge:                              ; preds = %land.lhs.true68, %land.lhs.true55, %if.end162, %land.lhs.true80, %while.body, %for.end, %if.then121
  %70 = load ptr, ptr %dict_helper, align 8, !tbaa !5
...
land.lhs.true174:                                 ; preds = %while.end164
  ...
  %71 = load i32, ptr %arrayidx178, align 4, !tbaa !35
  %cmp179 = icmp eq i32 %71, %ep
...
land.lhs.true181:                                 ; preds = %land.lhs.true174
  ...
  %72 = load i32, ptr %rsz, align 4, !tbaa !37
...
if.end197:                                        ; preds = %if.end191
  ...
  %cmp202385.not = icmp eq i16 %sectcount.addr.0, 0
  br i1 %cmp202385.not, label %for.end217, label %for.body204.preheader

for.body204.preheader:                            ; preds = %if.end197
  %wide.trip.count = zext i16 %sectcount.addr.0 to i64
  %xtraiter450 = and i64 %wide.trip.count, 3
  %73 = icmp ult i16 %sectcount.addr.0, 4
  br i1 %73, label %for.end217.loopexit.unr-lcssa, label %for.body204.preheader.new
...
for.body204:                                      ; preds = %for.body204, %for.body204.preheader.new
  %indvars.iv402 = phi i64 [ 0, %for.body204.preheader.new ], [ %indvars.iv.next403.3, %for.body204 ]
  %niter = phi i64 [ 0, %for.body204.preheader.new ], [ %niter.next.3, %for.body204 ]
  %arrayidx206 = getelementptr inbounds %struct.cli_exe_section, ptr %call193, i64 %indvars.iv402
  %raw = getelementptr inbounds %struct.cli_exe_section, ptr %call193, i64 %indvars.iv402, i32 2
  %74 = load <2 x i32>, ptr %arrayidx206, align 4, !tbaa !16
  store <2 x i32> %74, ptr %raw, align 4, !tbaa !16
  %indvars.iv.next403 = or i64 %indvars.iv402, 1
  %arrayidx206.1 = getelementptr inbounds %struct.cli_exe_section, ptr %call193, i64 %indvars.iv.next403
  %raw.1 = getelementptr inbounds %struct.cli_exe_section, ptr %call193, i64 %indvars.iv.next403, i32 2
  %75 = load <2 x i32>, ptr %arrayidx206.1, align 4, !tbaa !16
  store <2 x i32> %75, ptr %raw.1, align 4, !tbaa !16
  %indvars.iv.next403.1 = or i64 %indvars.iv402, 2
  %arrayidx206.2 = getelementptr inbounds %struct.cli_exe_section, ptr %call193, i64 %indvars.iv.next403.1
  %raw.2 = getelementptr inbounds %struct.cli_exe_section, ptr %call193, i64 %indvars.iv.next403.1, i32 2
  %76 = load <2 x i32>, ptr %arrayidx206.2, align 4, !tbaa !16
  store <2 x i32> %76, ptr %raw.2, align 4, !tbaa !16
  %indvars.iv.next403.2 = or i64 %indvars.iv402, 3
  %arrayidx206.3 = getelementptr inbounds %struct.cli_exe_section, ptr %call193, i64 %indvars.iv.next403.2
  %raw.3 = getelementptr inbounds %struct.cli_exe_section, ptr %call193, i64 %indvars.iv.next403.2, i32 2
  %77 = load <2 x i32>, ptr %arrayidx206.3, align 4, !tbaa !16
  store <2 x i32> %77, ptr %raw.3, align 4, !tbaa !16
  %indvars.iv.next403.3 = add nuw nsw i64 %indvars.iv402, 4
...
for.end217.loopexit.unr-lcssa:                    ; preds = %for.body204, %for.body204.preheader
  %indvars.iv402.unr = phi i64 [ 0, %for.body204.preheader ], [ %indvars.iv.next403.3, %for.body204 ]
  %lcmp.mod451.not = icmp eq i64 %xtraiter450, 0
  br i1 %lcmp.mod451.not, label %for.end217, label %for.body204.epil

for.body204.epil:                                 ; preds = %for.end217.loopexit.unr-lcssa, %for.body204.epil
  %indvars.iv402.epil = phi i64 [ %indvars.iv.next403.epil, %for.body204.epil ], [ %indvars.iv402.unr, %for.end217.loopexit.unr-lcssa ]
  %epil.iter = phi i64 [ %epil.iter.next, %for.body204.epil ], [ 0, %for.end217.loopexit.unr-lcssa ]
  %arrayidx206.epil = getelementptr inbounds %struct.cli_exe_section, ptr %call193, i64 %indvars.iv402.epil
  %raw.epil = getelementptr inbounds %struct.cli_exe_section, ptr %call193, i64 %indvars.iv402.epil, i32 2
  %78 = load <2 x i32>, ptr %arrayidx206.epil, align 4, !tbaa !16
  store <2 x i32> %78, ptr %raw.epil, align 4, !tbaa !16
  %indvars.iv.next403.epil = add nuw nsw i64 %indvars.iv402.epil, 1
