; ModuleID = '/usr/local/google/home/aeubanks/repos/test-suite/Bitcode/simd_ops/x86_tests/test_op_vpblendvb_391.bc'
...
@str.11 = private constant [17 x i8] c"op_vpblendvb_391\00", align 32
...
define i32 @__test_op(ptr noalias nocapture readnone %in_f32.buffer, ptr noalias nocapture readnone %in_f64.buffer, ptr noalias nocapture readnone %in_i8.buffer, ptr noalias nocapture readonly %in_u8.buffer, ptr noalias nocapture readnone %in_i16.buffer, ptr noalias nocapture readnone %in_u16.buffer, ptr noalias nocapture readnone %in_i32.buffer, ptr noalias nocapture readnone %in_u32.buffer, ptr noalias nocapture readnone %in_i64.buffer, ptr noalias nocapture readnone %in_u64.buffer, ptr noalias nocapture readonly %op_vpblendvb_391.buffer) local_unnamed_addr #0 {
"produce op_vpblendvb_391":
  %buf_extent168 = getelementptr inbounds %struct.buffer_t, ptr %op_vpblendvb_391.buffer, i64 0, i32 2, i64 1
  %op_vpblendvb_391.extent.1 = load i32, ptr %buf_extent168, align 4
  %buf_min176 = getelementptr inbounds %struct.buffer_t, ptr %op_vpblendvb_391.buffer, i64 0, i32 4, i64 1
  %op_vpblendvb_391.min.1 = load i32, ptr %buf_min176, align 4
  %0 = add nsw i32 %op_vpblendvb_391.min.1, %op_vpblendvb_391.extent.1
  %1 = icmp sgt i32 %op_vpblendvb_391.extent.1, 0
  br i1 %1, label %"for op_vpblendvb_391.s0.y.preheader", label %destructor_block, !prof !4

"for op_vpblendvb_391.s0.y.preheader":            ; preds = %"produce op_vpblendvb_391"
  %buf_host44 = getelementptr inbounds %struct.buffer_t, ptr %in_u8.buffer, i64 0, i32 1
  %in_u8.host = load ptr, ptr %buf_host44, align 8
  %buf_min175 = getelementptr inbounds %struct.buffer_t, ptr %op_vpblendvb_391.buffer, i64 0, i32 4, i64 0
  %op_vpblendvb_391.min.0 = load i32, ptr %buf_min175, align 4
  %2 = sext i32 %op_vpblendvb_391.min.0 to i64
  %buf_stride172 = getelementptr inbounds %struct.buffer_t, ptr %op_vpblendvb_391.buffer, i64 0, i32 3, i64 1
  %op_vpblendvb_391.stride.1 = load i32, ptr %buf_stride172, align 4
  %3 = sext i32 %op_vpblendvb_391.stride.1 to i64
  %buf_host163 = getelementptr inbounds %struct.buffer_t, ptr %op_vpblendvb_391.buffer, i64 0, i32 1
  %op_vpblendvb_391.host = load ptr, ptr %buf_host163, align 8
  %4 = shl nsw i64 %2, 3
  %5 = sub nsw i64 224, %4
  %scevgep = getelementptr i8, ptr %op_vpblendvb_391.host, i64 %5
  %6 = shl nsw i64 %3, 3
  %sunkaddr = ptrtoint ptr %in_u8.host to i64
  %t295 = load <32 x i8>, ptr %in_u8.host, align 32, !tbaa !5
  %7 = icmp ugt <32 x i8> %t295, <i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7>
  %sunkaddr215 = add i64 %sunkaddr, 16
  %sunkaddr216 = inttoptr i64 %sunkaddr215 to ptr
  %8 = load <32 x i8>, ptr %sunkaddr216, align 16, !tbaa !5
  %9 = select <32 x i1> %7, <32 x i8> %t295, <32 x i8> %8
  ...
  %t295.1 = load <32 x i8>, ptr %sunkaddr212.1, align 32, !tbaa !5
  %19 = icmp ugt <32 x i8> %t295.1, <i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7>
  ...
  %21 = select <32 x i1> %19, <32 x i8> %t295.1, <32 x i8> %20
  ...
  %t295.2 = load <32 x i8>, ptr %sunkaddr212.2, align 32, !tbaa !5
  %31 = icmp ugt <32 x i8> %t295.2, <i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7>
  ...
  %33 = select <32 x i1> %31, <32 x i8> %t295.2, <32 x i8> %32
  ...
  %t295.3 = load <32 x i8>, ptr %sunkaddr212.3, align 32, !tbaa !5
  %43 = icmp ugt <32 x i8> %t295.3, <i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7>
  ...
  %45 = select <32 x i1> %43, <32 x i8> %t295.3, <32 x i8> %44
  ...
  %t295.4 = load <32 x i8>, ptr %sunkaddr212.4, align 32, !tbaa !5
  %55 = icmp ugt <32 x i8> %t295.4, <i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7>
  ...
  %57 = select <32 x i1> %55, <32 x i8> %t295.4, <32 x i8> %56
  ...
  br label %"for op_vpblendvb_391.s0.x.x.preheader"

"for op_vpblendvb_391.s0.x.x.preheader":          ; preds = %"for op_vpblendvb_391.s0.x.x.preheader", %"for op_vpblendvb_391.s0.y.preheader"
  %lsr.iv180 = phi ptr [ %scevgep, %"for op_vpblendvb_391.s0.y.preheader" ], [ %scevgep182, %"for op_vpblendvb_391.s0.x.x.preheader" ]
  %op_vpblendvb_391.s0.y = phi i32 [ %op_vpblendvb_391.min.1, %"for op_vpblendvb_391.s0.y.preheader" ], [ %103, %"for op_vpblendvb_391.s0.x.x.preheader" ]
  ...
  %t295.5 = load <32 x i8>, ptr %sunkaddr212.5, align 32, !tbaa !5
  %67 = icmp ugt <32 x i8> %t295.5, <i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7>
  %68 = load <32 x i8>, ptr %sunkaddr216.5, align 16, !tbaa !5
  %69 = select <32 x i1> %67, <32 x i8> %t295.5, <32 x i8> %68
  ...
  %t295.6 = load <32 x i8>, ptr %sunkaddr212.6, align 32, !tbaa !5
  %79 = icmp ugt <32 x i8> %t295.6, <i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7>
  %80 = load <32 x i8>, ptr %sunkaddr216.6, align 16, !tbaa !5
  %81 = select <32 x i1> %79, <32 x i8> %t295.6, <32 x i8> %80
  ...
  %t295.7 = load <32 x i8>, ptr %sunkaddr212.7, align 32, !tbaa !5
  %91 = icmp ugt <32 x i8> %t295.7, <i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7, i8 7>
  %92 = load <32 x i8>, ptr %sunkaddr216.7, align 16, !tbaa !5
  %93 = select <32 x i1> %91, <32 x i8> %t295.7, <32 x i8> %92
  ...
  %103 = add nsw i32 %op_vpblendvb_391.s0.y, 1
  %scevgep182 = getelementptr i1, ptr %lsr.iv180, i64 %6
  %.not2 = icmp eq i32 %103, %0
  br i1 %.not2, label %destructor_block, label %"for op_vpblendvb_391.s0.x.x.preheader"

destructor_block:                                 ; preds = %"for op_vpblendvb_391.s0.x.x.preheader", %"produce op_vpblendvb_391"
  ret i32 0
}

; Function Attrs: nofree norecurse nosync nounwind memory(readwrite, inaccessiblemem: none)
define i32 @test_op(ptr noalias nocapture readnone %in_f32.buffer, ptr noalias nocapture readnone %in_f64.buffer, ptr noalias nocapture readnone %in_i8.buffer, ptr noalias nocapture readonly %in_u8.buffer, ptr noalias nocapture readnone %in_i16.buffer, ptr noalias nocapture readnone %in_u16.buffer, ptr noalias nocapture readnone %in_i32.buffer, ptr noalias nocapture readnone %in_u32.buffer, ptr noalias nocapture readnone %in_i64.buffer, ptr noalias nocapture readnone %in_u64.buffer, ptr noalias nocapture readonly %op_vpblendvb_391.buffer) local_unnamed_addr #1 {
destructor_block:
  %"__test_op_result$24" = tail call i32 @__test_op(ptr poison, ptr poison, ptr poison, ptr %in_u8.buffer, ptr poison, ptr poison, ptr poison, ptr poison, ptr poison, ptr poison, ptr %op_vpblendvb_391.buffer) #3
  ret i32 0
}
