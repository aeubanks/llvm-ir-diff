...
define internal noundef nonnull ptr @_ZL11CreateCodecv() #1 personality ptr @__gxx_personality_v0 {
  %1 = tail call noalias noundef nonnull dereferenceable(19376) ptr @_Znwm(i64 noundef 19376) #6
  invoke void @_ZN9NCompress5NPpmd8CDecoderC2Ev(ptr noundef nonnull align 8 dereferenceable(19376) %1)
...
define internal noundef nonnull ptr @_ZL14CreateCodecOutv() #1 personality ptr @__gxx_personality_v0 {
  %1 = tail call noalias noundef nonnull dereferenceable(19328) ptr @_Znwm(i64 noundef 19328) #6
  invoke void @_ZN9NCompress5NPpmd8CEncoderC1Ev(ptr noundef nonnull align 8 dereferenceable(19325) %1)
          to label %2 unwind label %3
...
define linkonce_odr dso_local void @_ZN9NCompress5NPpmd8CDecoderC2Ev(ptr noundef nonnull align 8 dereferenceable(19376) %0) unnamed_addr #3 comdat align 2 personality ptr @__gxx_personality_v0 {
  ...
  store ptr getelementptr inbounds ({ [13 x ptr], [8 x ptr], [9 x ptr], [8 x ptr], [8 x ptr] }, ptr @_ZTVN9NCompress5NPpmd8CDecoderE, i64 0, inrange i32 0, i64 2), ptr %0, align 8, !tbaa !10
  store ptr getelementptr inbounds ({ [13 x ptr], [8 x ptr], [9 x ptr], [8 x ptr], [8 x ptr] }, ptr @_ZTVN9NCompress5NPpmd8CDecoderE, i64 0, inrange i32 1, i64 2), ptr %2, align 8, !tbaa !10
  store ptr getelementptr inbounds ({ [13 x ptr], [8 x ptr], [9 x ptr], [8 x ptr], [8 x ptr] }, ptr @_ZTVN9NCompress5NPpmd8CDecoderE, i64 0, inrange i32 2, i64 2), ptr %3, align 8, !tbaa !10
  store ptr getelementptr inbounds ({ [13 x ptr], [8 x ptr], [9 x ptr], [8 x ptr], [8 x ptr] }, ptr @_ZTVN9NCompress5NPpmd8CDecoderE, i64 0, inrange i32 3, i64 2), ptr %4, align 8, !tbaa !10
  store ptr getelementptr inbounds ({ [13 x ptr], [8 x ptr], [9 x ptr], [8 x ptr], [8 x ptr] }, ptr @_ZTVN9NCompress5NPpmd8CDecoderE, i64 0, inrange i32 4, i64 2), ptr %5, align 8, !tbaa !10
  %7 = getelementptr inbounds %"class.NCompress::NPpmd::CDecoder", ptr %0, i64 0, i32 6
  store ptr null, ptr %7, align 8, !tbaa !12
  %8 = getelementptr inbounds %"class.NCompress::NPpmd::CDecoder", ptr %0, i64 0, i32 8
  tail call void @_ZN14CByteInBufWrapC1Ev(ptr noundef nonnull align 8 dereferenceable(64) %8)
  %9 = getelementptr inbounds %"class.NCompress::NPpmd::CDecoder", ptr %0, i64 0, i32 11
  store i8 0, ptr %9, align 1, !tbaa !31
  %10 = getelementptr inbounds %"class.NCompress::NPpmd::CDecoder", ptr %0, i64 0, i32 15
  store ptr null, ptr %10, align 8, !tbaa !32
  %11 = getelementptr inbounds %"class.NCompress::NPpmd::CDecoder", ptr %0, i64 0, i32 7
  invoke void @Ppmd7z_RangeDec_CreateVTable(ptr noundef nonnull %11)
          to label %12 unwind label %16

12:                                               ; preds = %1
  %13 = getelementptr inbounds %"class.NCompress::NPpmd::CDecoder", ptr %0, i64 0, i32 7, i32 3
  store ptr %8, ptr %13, align 8, !tbaa !33
  %14 = getelementptr inbounds %"class.NCompress::NPpmd::CDecoder", ptr %0, i64 0, i32 9
  invoke void @Ppmd7_Construct(ptr noundef nonnull %14)
