...
if.else.i.i:                                      ; preds = %if.end12, %if.end12, %if.end5
  %m_length.0184 = phi i64 [ 0, %if.end5 ], [ %0, %if.end12 ], [ %0, %if.end12 ]
...
if.end19.i.i:                                     ; preds = %if.end12.i.i, %if.end9.i.i
  %cmp4.not.i.i185 = phi i1 [ true, %if.end12.i.i ], [ false, %if.end9.i.i ]
  %m_length.0183 = phi i64 [ %m_length.0184, %if.end12.i.i ], [ %0, %if.end9.i.i ]
...
lor.lhs.false2.i.i:                               ; preds = %itsf_print_header.exit
  br i1 %cmp4.not.i.i185, label %if.else.i.i105, label %if.then5.i.i101

if.then5.i.i101:                                  ; preds = %lor.lhs.false2.i.i
  %add.i.i = add nuw nsw i64 %14, 84
  %cmp7.i.i100 = icmp ugt i64 %add.i.i, %m_length.0183
...
if.end44:                                         ; preds = %if.then37, %if.end26
  %tobool45.not202 = icmp eq i32 %add34, 0
  br i1 %tobool45.not202, label %while.end, label %while.body

while.body:                                       ; preds = %if.end44, %read_chunk.exit
  %36 = phi i32 [ %65, %read_chunk.exit ], [ %32, %if.end44 ]
  %num_chunks.0206 = phi i32 [ %dec, %read_chunk.exit ], [ %add34, %if.end44 ]
  %offset.1203 = phi i64 [ %add53, %read_chunk.exit ], [ %offset.0, %if.end44 ]
...
if.end4.i:                                        ; preds = %if.end.i
  ...
  br i1 %tobool7.not.i, label %read_chunk.exit.thread189, label %if.end9.i

read_chunk.exit.thread189:                        ; preds = %if.end4.i
  call void @free(ptr noundef nonnull %call.i) #12
  br label %abort

if.end9.i:                                        ; preds = %if.end4.i
  %cmp.i.i125 = icmp slt i64 %offset.1203, 0
  br i1 %cmp.i.i125, label %abort.loopexit.critedge, label %lor.lhs.false2.i.i127

lor.lhs.false2.i.i127:                            ; preds = %if.end9.i
  br i1 %cmp4.not.i.i185, label %if.else.i.i133, label %if.then5.i.i130

if.then5.i.i130:                                  ; preds = %lor.lhs.false2.i.i127
  %add.i.i128 = add nuw nsw i64 %offset.1203, 8
  %cmp7.i.i129 = icmp sgt i64 %add.i.i128, %m_length.0183
  br i1 %cmp7.i.i129, label %abort.loopexit.critedge, label %lor.lhs.false2.i94.i

if.else.i.i133:                                   ; preds = %lor.lhs.false2.i.i127
  %call.i.i131 = call i64 @lseek(i32 noundef %fd, i64 noundef %offset.1203, i32 noundef 0) #12
  %cmp10.not.i.i132 = icmp eq i64 %call.i.i131, %offset.1203
...
if.end12.i.i136:                                  ; preds = %if.else.i.i133
  ...
  br i1 %cmp15.not.i.i135, label %lor.lhs.false2.i94.thread.i, label %abort.loopexit.critedge

lor.lhs.false2.i94.i:                             ; preds = %if.then5.i.i130
  %add.ptr.i.i137 = getelementptr inbounds i8, ptr %m_area.0181, i64 %offset.1203
  %38 = load i64, ptr %add.ptr.i.i137, align 1
  store i64 %38, ptr %call.i, align 1
  %add.i92.i = add nuw nsw i64 %offset.1203, %conv.i124
  %cmp7.i97.i = icmp sgt i64 %add.i92.i, %m_length.0183
  br i1 %cmp7.i97.i, label %abort.loopexit.critedge, label %if.end19.i108.thread.i

lor.lhs.false2.i94.thread.i:                      ; preds = %if.end12.i.i136
  %39 = load ptr, ptr %chunk_data.i, align 8, !tbaa !36
  %call.i101.i = call i64 @lseek(i32 noundef %fd, i64 noundef %offset.1203, i32 noundef 0) #12
  %cmp10.not.i102.i = icmp eq i64 %call.i101.i, %offset.1203
  br i1 %cmp10.not.i102.i, label %if.end12.i107.i, label %abort.loopexit.critedge

if.end12.i107.i:                                  ; preds = %lor.lhs.false2.i94.thread.i
...
if.end19.i108.i:                                  ; preds = %if.end12.i107.i
  ...
  br i1 %cmp24.i, label %lor.lhs.false2.i114.i, label %if.else.i

if.end19.i108.thread.i:                           ; preds = %lor.lhs.false2.i94.i
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 1 %call5.i, ptr nonnull align 1 %add.ptr.i.i137, i64 %conv.i124, i1 false)
  %bcmp156.i = call i32 @bcmp(ptr noundef nonnull dereferenceable(4) %call.i, ptr noundef nonnull dereferenceable(4) @.str.24, i64 4)
  %cmp24157.i = icmp eq i32 %bcmp156.i, 0
  br i1 %cmp24157.i, label %lor.lhs.false2.i114.thread.i, label %if.else.i

lor.lhs.false2.i114.thread.i:                     ; preds = %if.end19.i108.thread.i
  %add.i112.i = add nuw nsw i64 %offset.1203, 20
  %cmp7.i117.i = icmp sgt i64 %add.i112.i, %m_length.0183
  br i1 %cmp7.i117.i, label %abort.loopexit.critedge, label %if.end9.i120.i

lor.lhs.false2.i114.i:                            ; preds = %if.end19.i108.i
  %add.i = add nuw nsw i64 %offset.1203, 8
  %call.i121.i = call i64 @lseek(i32 noundef %fd, i64 noundef %add.i, i32 noundef 0) #12
  %cmp10.not.i122.i = icmp eq i64 %call.i121.i, %add.i
  br i1 %cmp10.not.i122.i, label %if.end12.i127.i, label %abort.loopexit.critedge

if.end9.i120.i:                                   ; preds = %lor.lhs.false2.i114.thread.i
  %unknown158.i = getelementptr inbounds %struct.chunk_header_tag, ptr %call.i, i64 0, i32 2
  %add.ptr.i119.i = getelementptr inbounds i8, ptr %m_area.0181, i64 %add.i.i128
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(12) %unknown158.i, ptr noundef nonnull align 1 dereferenceable(12) %add.ptr.i119.i, i64 12, i1 false)
  br label %if.end19.i128.i

if.end12.i127.i:                                  ; preds = %lor.lhs.false2.i114.i
...
if.end4.i.i146:                                   ; preds = %if.end.i.i
  ...
  br i1 %tobool.not.i.i145, label %if.end23.i, label %if.end.i.i.i

if.end.i.i.i:                                     ; preds = %if.end4.i.i146
  br i1 %cmp4.not.i.i185, label %if.else.i.i.i, label %if.then5.i.i.i

if.then5.i.i.i:                                   ; preds = %if.end.i.i.i
  %add.i.i.i = add nuw nsw i64 %add.i.i143, 24
  %cmp7.i.i.i = icmp sgt i64 %add.i.i.i, %m_length.0183
  br i1 %cmp7.i.i.i, label %abort.i.i, label %if.end9.i.i.i

if.end9.i.i.i:                                    ; preds = %if.then5.i.i.i
  %add.ptr.i.i.i = getelementptr inbounds i8, ptr %m_area.0181, i64 %add.i.i143
...
if.end5.i.i:                                      ; preds = %if.end.i199.i
  ...
  br i1 %tobool.not.i201.i, label %if.end23.i, label %if.end7.i.i

if.end7.i.i:                                      ; preds = %if.end5.i.i
  ...
  br i1 %cmp3.i.i.i, label %abort.i216.i, label %if.end.i.i204.i

if.end.i.i204.i:                                  ; preds = %if.end7.i.i
  br i1 %cmp4.not.i.i185, label %if.else.i.i211.i, label %if.then5.i.i206.i

if.then5.i.i206.i:                                ; preds = %if.end.i.i204.i
  %cmp7.i.i205.i = icmp sgt i64 %add.i.i202.i, %m_length.0183
  br i1 %cmp7.i.i205.i, label %abort.i216.i, label %if.end9.i.i208.i

if.end9.i.i208.i:                                 ; preds = %if.then5.i.i206.i
  %add.ptr.i.i207.i = getelementptr inbounds i8, ptr %m_area.0181, i64 %add2.i.i
...
if.else.i.i211.i:                                 ; preds = %if.end.i.i204.i
...
abort.i216.i:                                     ; preds = %if.then27.i.i, %if.then20.i.i, %if.end12.i.i214.i, %if.else.i.i211.i, %if.then5.i.i206.i, %if.end7.i.i
...
while.end.i:                                      ; preds = %if.end23.i
  ...
  br i1 %or.cond127.i, label %if.end30.i, label %abort.i160
...
if.end41.i:                                       ; preds = %sw.epilog.i
  ...
  %add.i153 = add i32 %99, %conv.i152
  %sub.i154 = sub i32 0, %99
  %and.i = and i32 %add.i153, %sub.i154
...
if.end88.i:                                       ; preds = %if.end78.i
  ...
  br i1 %cmp.not36.i.i, label %chm_copy_file_data.exit.i, label %while.body.i.i157

while.body.i.i157:                                ; preds = %if.end88.i, %if.end15.i.i
  %rem.037.i.i = phi i64 [ %sub16.i.i, %if.end15.i.i ], [ %107, %if.end88.i ]
  %cond.i.i = call i64 @llvm.umin.i64(i64 %rem.037.i.i, i64 8192)
  %conv.i.i155 = trunc i64 %cond.i.i to i32
  %call.i218.i = call i32 @cli_readn(i32 noundef %call56.i, ptr noundef nonnull %data.i.i, i32 noundef %conv.i.i155) #12
  %conv2.i.i = sext i32 %call.i218.i to i64
  %cmp4.not.i.i156 = icmp eq i64 %cond.i.i, %conv2.i.i
  br i1 %cmp4.not.i.i156, label %if.end.i219.i, label %if.then.i.i158

if.then.i.i158:                                   ; preds = %while.body.i.i157
  %sub.i.i = sub i64 %107, %rem.037.i.i
  br label %chm_copy_file_data.exit.i

if.end.i219.i:                                    ; preds = %while.body.i.i157
  %call8.i.i = call i32 @cli_writen(i32 noundef %call83.i, ptr noundef nonnull %data.i.i, i32 noundef %call.i218.i) #12
  %cmp10.not.i.i159 = icmp eq i32 %call8.i.i, %call.i218.i
  br i1 %cmp10.not.i.i159, label %if.end15.i.i, label %if.then12.i.i
...
if.end15.i.i:                                     ; preds = %if.end.i219.i
  ...
  br i1 %cmp.not.i220.i, label %chm_copy_file_data.exit.i, label %while.body.i.i157, !llvm.loop !69

chm_copy_file_data.exit.i:                        ; preds = %if.end15.i.i, %if.then12.i.i, %if.then.i.i158, %if.end88.i
  %retval.0.i221.i = phi i64 [ %sub.i.i, %if.then.i.i158 ], [ %sub14.i.i, %if.then12.i.i ], [ 0, %if.end88.i ], [ %107, %if.end15.i.i ]
...
abort.loopexit.critedge:                          ; preds = %lor.lhs.false2.i114.thread.i, %lor.lhs.false2.i114.i, %if.end12.i127.i, %lor.lhs.false2.i94.i, %lor.lhs.false2.i94.thread.i, %if.end12.i107.i, %if.end9.i, %if.then5.i.i130, %if.else.i.i133, %if.end12.i.i136, %if.else.i
  %111 = load ptr, ptr %chunk_data.i, align 8, !tbaa !36
  call void @free(ptr noundef %111) #12
  call void @free(ptr noundef nonnull %call.i) #12
  br label %abort

abort:                                            ; preds = %if.end.i, %while.body, %abort.loopexit.critedge, %read_chunk.exit.thread189, %itsf_print_header.exit, %if.then5.i.i101, %if.else.i.i105, %if.end12.i.i108, %return.sink.split.i, %if.else.i.i, %if.end12.i.i, %if.then2.i, %if.then9, %chm_decompress_stream.exit
  %m_area.1 = phi ptr [ null, %if.then9 ], [ %m_area.0181, %chm_decompress_stream.exit ], [ %m_area.0181, %if.then2.i ], [ null, %if.end12.i.i ], [ null, %if.else.i.i ], [ %m_area.0181, %return.sink.split.i ], [ %m_area.0181, %if.end12.i.i108 ], [ %m_area.0181, %if.else.i.i105 ], [ %m_area.0181, %if.then5.i.i101 ], [ %m_area.0181, %itsf_print_header.exit ], [ %m_area.0181, %read_chunk.exit.thread189 ], [ %m_area.0181, %abort.loopexit.critedge ], [ %m_area.0181, %while.body ], [ %m_area.0181, %if.end.i ]
  %m_length.1 = phi i64 [ 0, %if.then9 ], [ %m_length.0183, %chm_decompress_stream.exit ], [ %m_length.0183, %if.then2.i ], [ %m_length.0184, %if.end12.i.i ], [ %m_length.0184, %if.else.i.i ], [ %m_length.0183, %return.sink.split.i ], [ %m_length.0183, %if.end12.i.i108 ], [ %m_length.0183, %if.else.i.i105 ], [ %m_length.0183, %if.then5.i.i101 ], [ %m_length.0183, %itsf_print_header.exit ], [ %m_length.0183, %read_chunk.exit.thread189 ], [ %m_length.0183, %abort.loopexit.critedge ], [ %m_length.0183, %while.body ], [ %m_length.0183, %if.end.i ]
  %retval1.0 = phi i32 [ 0, %if.then9 ], [ 1, %chm_decompress_stream.exit ], [ 0, %if.then2.i ], [ 0, %if.end12.i.i ], [ 0, %if.else.i.i ], [ 0, %return.sink.split.i ], [ 0, %if.end12.i.i108 ], [ 0, %if.else.i.i105 ], [ 0, %if.then5.i.i101 ], [ 0, %itsf_print_header.exit ], [ 0, %read_chunk.exit.thread189 ], [ 0, %abort.loopexit.critedge ], [ 0, %while.body ], [ 0, %if.end.i ]
  br label %while.body.i162

while.body.i162:                                  ; preds = %abort, %if.end.i165
...
if.then.i163:                                     ; preds = %while.body.i162
  call void @free(ptr noundef nonnull %113) #12
  br label %if.end.i165

if.end.i165:                                      ; preds = %if.then.i163, %while.body.i162
  call void @free(ptr noundef nonnull %file_l.addr.09.i) #12
  %tobool.not.i164 = icmp eq ptr %112, null
  br i1 %tobool.not.i164, label %while.body.i171, label %while.body.i162, !llvm.loop !70
