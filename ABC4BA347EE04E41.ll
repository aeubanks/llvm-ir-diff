...
entry:
  %call = tail call i32 @init(ptr noundef nonnull @.str.33)
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
  %cmp36 = icmp sgt i32 %0, 1
  br i1 %cmp36, label %for.cond1.preheader, label %for.cond.cleanup

for.cond1.preheader:                              ; preds = %entry, %for.cond.cleanup3
  %nl.037 = phi i32 [ %inc20, %for.cond.cleanup3 ], [ 0, %entry ]
  %.pre = load double, ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 0), align 32, !tbaa !5
  br label %for.body4

for.cond.cleanup:                                 ; preds = %for.cond.cleanup3, %entry
  %call24 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.137, double noundef 0.000000e+00)
  br label %for.body.i
...
for.cond.cleanup3:                                ; preds = %for.body4
  ...
  %inc20 = add nuw nsw i32 %nl.037, 1
  %6 = load i32, ptr @ntimes, align 4, !tbaa !17
  %div = sdiv i32 %6, 2
  %cmp = icmp slt i32 %inc20, %div
  br i1 %cmp, label %for.cond1.preheader, label %for.cond.cleanup

for.body4:                                        ; preds = %for.cond1.preheader, %for.body4
  %7 = phi double [ %.pre, %for.cond1.preheader ], [ %add15, %for.body4 ]
  ...
  store double %11, ptr %arrayidx8, align 8, !tbaa !5
  %add = fadd double %11, %7
  %add15 = fadd double %9, %add
  %arrayidx17 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %indvars.iv
  store double %add15, ptr %arrayidx17, align 8, !tbaa !5
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, 32000
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %offset.idx = add nuw nsw i64 %index, 4
  ...
  %2 = getelementptr inbounds double, ptr @global_data, i64 %offset.idx
  %wide.load25 = load <2 x double>, ptr %2, align 32, !tbaa !5
  %3 = fadd <2 x double> %wide.load, %wide.load25
  %4 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %offset.idx
  store <2 x double> %3, ptr %4, align 32, !tbaa !5
  %index.next = or i64 %index, 2
  %offset.idx.1 = add nuw nsw i64 %index, 6
  %5 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %index.next
  %wide.load.1 = load <2 x double>, ptr %5, align 16, !tbaa !5
  %6 = getelementptr inbounds double, ptr @global_data, i64 %offset.idx.1
  %wide.load25.1 = load <2 x double>, ptr %6, align 16, !tbaa !5
  %7 = fadd <2 x double> %wide.load.1, %wide.load25.1
  %8 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %offset.idx.1
  store <2 x double> %7, ptr %8, align 16, !tbaa !5
  %index.next.1 = add nuw nsw i64 %index, 4
  %9 = icmp eq i64 %index.next.1, 31996
  br i1 %9, label %for.cond.cleanup3, label %vector.body, !llvm.loop !367
...
for.body.i:                                       ; preds = %for.body.i, %for.cond.cleanup
  ...
  %suma.0192.i = phi double [ 0.000000e+00, %for.cond.cleanup ], [ %add.i.1, %for.body.i ]
  %arrayidx.i = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv.i
  %10 = load double, ptr %arrayidx.i, align 16, !tbaa !5
  %add.i = fadd double %suma.0192.i, %10
  %arrayidx2.i = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %indvars.iv.i
  %11 = load double, ptr %arrayidx2.i, align 16, !tbaa !5
  %add3.i = fadd double %sumb.0193.i, %11
  %indvars.iv.next.i = or i64 %indvars.iv.i, 1
  %arrayidx.i.1 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv.next.i
  %12 = load double, ptr %arrayidx.i.1, align 8, !tbaa !5
  %add.i.1 = fadd double %add.i, %12
  %arrayidx2.i.1 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %indvars.iv.next.i
  %13 = load double, ptr %arrayidx2.i.1, align 8, !tbaa !5
  %add3.i.1 = fadd double %add3.i, %13
  %indvars.iv.next.i.1 = add nuw nsw i64 %indvars.iv.i, 2
  %exitcond.not.i.1 = icmp eq i64 %indvars.iv.next.i.1, 32000
  br i1 %exitcond.not.i.1, label %for.cond18.preheader.i.preheader, label %for.body.i
...
for.cond18.preheader.i.preheader:                 ; preds = %for.body.i
  ...
  %add89.i = fadd double %add.i.1, %add3.i.1
  %call90.i = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %14, double noundef %add89.i)
  ret i32 0
...
entry:
  %call = tail call i32 @init(ptr noundef nonnull @.str.34)
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
...
for.cond1.preheader:                              ; preds = %entry, %for.cond.cleanup3
  ...
  %.pre = load double, ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 11, i64 0), align 32, !tbaa !5
  br label %for.body4

for.cond.cleanup:                                 ; preds = %for.cond.cleanup3, %entry
  %call29 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.139, double noundef 0.000000e+00)
  br label %for.body.i
...
for.body4:                                        ; preds = %for.cond1.preheader, %for.body4
  %7 = phi double [ %.pre, %for.cond1.preheader ], [ %mul, %for.body4 ]
  %indvars.iv = phi i64 [ 1, %for.cond1.preheader ], [ %indvars.iv.next, %for.body4 ]
  ...
  store double %mul, ptr %arrayidx15, align 8, !tbaa !5
  %neg = fneg double %8
  %12 = tail call double @llvm.fmuladd.f64(double %neg, double %9, double %11)
  store double %12, ptr %arrayidx8, align 8, !tbaa !5
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, 32000
  br i1 %exitcond.not, label %for.cond.cleanup3, label %for.body4
}
...
entry:
  %call = tail call i32 @init(ptr noundef nonnull @.str.35)
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
...
for.cond.cleanup:                                 ; preds = %for.cond.cleanup3, %entry
  %call28 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.140, double noundef 0.000000e+00)
...
for.cond5.preheader:                              ; preds = %for.cond1.preheader, %for.cond.cleanup7
  ...
  %arrayidx10.phi.trans.insert = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), i64 0, i64 %indvars.iv46
  %.pre = load double, ptr %arrayidx10.phi.trans.insert, align 8, !tbaa !5
  br label %for.body8
...
for.body8:                                        ; preds = %for.body8, %for.cond5.preheader
  %7 = phi double [ %.pre, %for.cond5.preheader ], [ %add.2, %for.body8 ]
  %indvars.iv = phi i64 [ 1, %for.cond5.preheader ], [ %indvars.iv.next.2, %for.body8 ]
  %arrayidx14 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), i64 %indvars.iv, i64 %indvars.iv46
  %8 = load double, ptr %arrayidx14, align 8, !tbaa !5
  %add = fadd double %7, %8
  %arrayidx18 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), i64 %indvars.iv, i64 %indvars.iv46
  store double %add, ptr %arrayidx18, align 8, !tbaa !5
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %arrayidx14.1 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), i64 %indvars.iv.next, i64 %indvars.iv46
  %9 = load double, ptr %arrayidx14.1, align 8, !tbaa !5
  %add.1 = fadd double %add, %9
  %arrayidx18.1 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), i64 %indvars.iv.next, i64 %indvars.iv46
  store double %add.1, ptr %arrayidx18.1, align 8, !tbaa !5
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %arrayidx14.2 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), i64 %indvars.iv.next.1, i64 %indvars.iv46
  %10 = load double, ptr %arrayidx14.2, align 8, !tbaa !5
  %add.2 = fadd double %add.1, %10
  %arrayidx18.2 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), i64 %indvars.iv.next.1, i64 %indvars.iv46
  store double %add.2, ptr %arrayidx18.2, align 8, !tbaa !5
  %indvars.iv.next.2 = add nuw nsw i64 %indvars.iv, 3
  %exitcond.not.2 = icmp eq i64 %indvars.iv.next.2, 256
  br i1 %exitcond.not.2, label %for.cond.cleanup7, label %for.body8
}

; Function Attrs: nounwind uwtable
define dso_local i32 @s232() local_unnamed_addr #7 {
entry:
  %call = tail call i32 @init(ptr noundef nonnull @.str.36)
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
  %cmp51 = icmp sgt i32 %0, 255
  br i1 %cmp51, label %for.cond1.preheader, label %for.cond.cleanup

for.cond1.preheader:                              ; preds = %entry, %for.cond.cleanup3
  %nl.052 = phi i32 [ %inc30, %for.cond.cleanup3 ], [ 0, %entry ]
  br label %for.cond5.preheader

for.cond.cleanup:                                 ; preds = %for.cond.cleanup3, %entry
  %call34 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.141, double noundef 0.000000e+00)
  br label %for.cond18.preheader.i
...
for.cond5.preheader:                              ; preds = %for.cond1.preheader, %for.cond.cleanup7
  ...
  %indvars.iv59 = phi i64 [ 1, %for.cond1.preheader ], [ %indvars.iv.next60, %for.cond.cleanup7 ]
  %6 = add i64 %indvar, 1
  %arrayidx10.phi.trans.insert = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), i64 %indvars.iv59, i64 0
  %.pre = load double, ptr %arrayidx10.phi.trans.insert, align 32, !tbaa !5
...
for.cond.cleanup3:                                ; preds = %for.cond.cleanup7
  ...
  %div = sdiv i32 %8, 256
  %mul = mul nsw i32 %div, 100
  %cmp = icmp slt i32 %inc30, %mul
  br i1 %cmp, label %for.cond1.preheader, label %for.cond.cleanup

for.cond.cleanup7.unr-lcssa:                      ; preds = %for.body8, %for.cond5.preheader
  %.unr = phi double [ %.pre, %for.cond5.preheader ], [ %15, %for.body8 ]
  %indvars.iv.unr = phi i64 [ 1, %for.cond5.preheader ], [ %indvars.iv.next.1, %for.body8 ]
  %lcmp.mod.not = icmp eq i64 %xtraiter, 0
  br i1 %lcmp.mod.not, label %for.cond.cleanup7, label %for.body8.epil

for.body8.epil:                                   ; preds = %for.cond.cleanup7.unr-lcssa
  %arrayidx20.epil = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), i64 %indvars.iv59, i64 %indvars.iv.unr
  %9 = load double, ptr %arrayidx20.epil, align 8, !tbaa !5
  %10 = tail call double @llvm.fmuladd.f64(double %.unr, double %.unr, double %9)
  %arrayidx24.epil = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), i64 %indvars.iv59, i64 %indvars.iv.unr
  store double %10, ptr %arrayidx24.epil, align 8, !tbaa !5
  br label %for.cond.cleanup7

for.cond.cleanup7:                                ; preds = %for.cond.cleanup7.unr-lcssa, %for.body8.epil
  %indvars.iv.next60 = add nuw nsw i64 %indvars.iv59, 1
  %exitcond64.not = icmp eq i64 %indvars.iv.next60, 256
  %indvar.next = add i64 %indvar, 1
  br i1 %exitcond64.not, label %for.cond.cleanup3, label %for.cond5.preheader

for.body8:                                        ; preds = %for.body8, %for.cond5.preheader.new
  %11 = phi double [ %.pre, %for.cond5.preheader.new ], [ %15, %for.body8 ]
  %indvars.iv = phi i64 [ 1, %for.cond5.preheader.new ], [ %indvars.iv.next.1, %for.body8 ]
  %niter = phi i64 [ 0, %for.cond5.preheader.new ], [ %niter.next.1, %for.body8 ]
  %arrayidx20 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), i64 %indvars.iv59, i64 %indvars.iv
  %12 = load double, ptr %arrayidx20, align 8, !tbaa !5
  %13 = tail call double @llvm.fmuladd.f64(double %11, double %11, double %12)
  %arrayidx24 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), i64 %indvars.iv59, i64 %indvars.iv
  store double %13, ptr %arrayidx24, align 8, !tbaa !5
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %arrayidx20.1 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), i64 %indvars.iv59, i64 %indvars.iv.next
  %14 = load double, ptr %arrayidx20.1, align 8, !tbaa !5
  %15 = tail call double @llvm.fmuladd.f64(double %13, double %13, double %14)
  %arrayidx24.1 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), i64 %indvars.iv59, i64 %indvars.iv.next
  store double %15, ptr %arrayidx24.1, align 8, !tbaa !5
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
...
for.cond5.preheader:                              ; preds = %for.cond5.for.cond.cleanup7_crit_edge.1, %for.cond1.preheader
  %indvars.iv = phi i64 [ 0, %for.cond1.preheader ], [ %indvars.iv.next.1, %for.cond5.for.cond.cleanup7_crit_edge.1 ]
  br label %for.body8

for.cond.cleanup3:                                ; preds = %for.cond5.for.cond.cleanup7_crit_edge.1
  %call22 = tail call i32 @dummy(ptr noundef nonnull @global_data, ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 11, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 20, i64 0, i64 0), double noundef 1.000000e+00) #16
...
for.body8.1:                                      ; preds = %for.body8.1, %for.cond5.for.cond.cleanup7_crit_edge
  %indvars.iv45.1 = phi i64 [ %indvars.iv.next, %for.cond5.for.cond.cleanup7_crit_edge ], [ %indvars.iv.next46.1, %for.body8.1 ]
  %arrayidx10.1 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), i64 %indvars.iv45.1, i64 %indvars.iv.next
  %7 = load double, ptr %arrayidx10.1, align 8, !tbaa !5
  %arrayidx14.1 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 20, i64 0, i64 0), i64 %indvars.iv45.1, i64 %indvars.iv.next
  %8 = load double, ptr %arrayidx14.1, align 8, !tbaa !5
  %add.1 = fadd double %7, %8
  %arrayidx18.1 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), i64 %indvars.iv45.1, i64 %indvars.iv.next
  store double %add.1, ptr %arrayidx18.1, align 8, !tbaa !5
  %indvars.iv.next46.1 = add nuw nsw i64 %indvars.iv45.1, 1
  %exitcond.not.1 = icmp eq i64 %indvars.iv.next46.1, 256
  br i1 %exitcond.not.1, label %for.cond5.for.cond.cleanup7_crit_edge.1, label %for.body8.1

for.cond5.for.cond.cleanup7_crit_edge.1:          ; preds = %for.body8.1
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %exitcond49.not.1 = icmp eq i64 %indvars.iv.next.1, 256
  br i1 %exitcond49.not.1, label %for.cond.cleanup3, label %for.cond5.preheader

for.body8:                                        ; preds = %for.cond5.preheader, %for.body8
  %indvars.iv45 = phi i64 [ %indvars.iv, %for.cond5.preheader ], [ %indvars.iv.next46, %for.body8 ]
  %arrayidx10 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), i64 %indvars.iv45, i64 %indvars.iv
  %9 = load double, ptr %arrayidx10, align 16, !tbaa !5
  %arrayidx14 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 20, i64 0, i64 0), i64 %indvars.iv45, i64 %indvars.iv
  %10 = load double, ptr %arrayidx14, align 16, !tbaa !5
  %add = fadd double %9, %10
  %arrayidx18 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), i64 %indvars.iv45, i64 %indvars.iv
...
entry:
  %call = tail call i32 @init(ptr noundef nonnull @.str.37)
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
  %cmp72 = icmp sgt i32 %0, 255
...
for.cond.cleanup:                                 ; preds = %for.cond.cleanup3, %entry
  %call50 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.143, double noundef 0.000000e+00)
  br label %for.cond18.preheader.i

for.cond18.preheader.i:                           ; preds = %for.cond.cleanup, %for.cond.cleanup20.i
  %indvars.iv213.i = phi i64 [ %indvars.iv.next214.i, %for.cond.cleanup20.i ], [ 0, %for.cond.cleanup ]
  %sumbb.0203.i = phi double [ %add31.i.1, %for.cond.cleanup20.i ], [ 0.000000e+00, %for.cond.cleanup ]
  %sumaa.0202.i = phi double [ %add26.i.1, %for.cond.cleanup20.i ], [ 0.000000e+00, %for.cond.cleanup ]
  br label %for.body21.i
...
for.body47.i.preheader:                           ; preds = %for.cond.cleanup20.i
  %1 = load i32, ptr @digits, align 4, !tbaa !17
  %add110.i = fadd double %add26.i.1, %add31.i.1
  %call111.i = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %1, double noundef %add110.i)
  ret i32 0

for.body21.i:                                     ; preds = %for.body21.i, %for.cond18.preheader.i
  %indvars.iv209.i = phi i64 [ 0, %for.cond18.preheader.i ], [ %indvars.iv.next210.i.1, %for.body21.i ]
  %sumbb.1199.i = phi double [ %sumbb.0203.i, %for.cond18.preheader.i ], [ %add31.i.1, %for.body21.i ]
  %sumaa.1198.i = phi double [ %sumaa.0202.i, %for.cond18.preheader.i ], [ %add26.i.1, %for.body21.i ]
  %arrayidx25.i = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), i64 %indvars.iv213.i, i64 %indvars.iv209.i
  %2 = load double, ptr %arrayidx25.i, align 16, !tbaa !5
  %add26.i = fadd double %sumaa.1198.i, %2
  %arrayidx30.i = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), i64 %indvars.iv213.i, i64 %indvars.iv209.i
  %3 = load double, ptr %arrayidx30.i, align 16, !tbaa !5
  %add31.i = fadd double %sumbb.1199.i, %3
  %indvars.iv.next210.i = or i64 %indvars.iv209.i, 1
  %arrayidx25.i.1 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), i64 %indvars.iv213.i, i64 %indvars.iv.next210.i
  %4 = load double, ptr %arrayidx25.i.1, align 8, !tbaa !5
  %add26.i.1 = fadd double %add26.i, %4
  %arrayidx30.i.1 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), i64 %indvars.iv213.i, i64 %indvars.iv.next210.i
  %5 = load double, ptr %arrayidx30.i.1, align 8, !tbaa !5
  %add31.i.1 = fadd double %add31.i, %5
  %indvars.iv.next210.i.1 = add nuw nsw i64 %indvars.iv209.i, 2
  %exitcond212.not.i.1 = icmp eq i64 %indvars.iv.next210.i.1, 256
  br i1 %exitcond212.not.i.1, label %for.cond.cleanup20.i, label %for.body21.i

for.cond5.preheader:                              ; preds = %for.cond1.preheader, %for.cond.cleanup22
  %indvars.iv80 = phi i64 [ 1, %for.cond1.preheader ], [ %indvars.iv.next81, %for.cond.cleanup22 ]
  %arrayidx10.phi.trans.insert = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), i64 0, i64 %indvars.iv80
  %.pre = load double, ptr %arrayidx10.phi.trans.insert, align 8, !tbaa !5
  br label %for.body8

for.cond.cleanup3:                                ; preds = %for.cond.cleanup22
  ...
  %div = sdiv i32 %6, 256
  %mul = mul nsw i32 %div, 100
  %cmp = icmp slt i32 %inc46, %mul
  br i1 %cmp, label %for.cond1.preheader, label %for.cond.cleanup

for.cond20.preheader:                             ; preds = %for.body8
  %7 = add nsw i64 %indvars.iv80, -1
  br label %for.body23

for.body8:                                        ; preds = %for.body8, %for.cond5.preheader
  %8 = phi double [ %.pre, %for.cond5.preheader ], [ %add.2, %for.body8 ]
  %indvars.iv = phi i64 [ 1, %for.cond5.preheader ], [ %indvars.iv.next.2, %for.body8 ]
  %arrayidx14 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 20, i64 0, i64 0), i64 %indvars.iv, i64 %indvars.iv80
  %9 = load double, ptr %arrayidx14, align 8, !tbaa !5
  %add = fadd double %8, %9
  %arrayidx18 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), i64 %indvars.iv, i64 %indvars.iv80
  store double %add, ptr %arrayidx18, align 8, !tbaa !5
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %arrayidx14.1 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 20, i64 0, i64 0), i64 %indvars.iv.next, i64 %indvars.iv80
  %10 = load double, ptr %arrayidx14.1, align 8, !tbaa !5
  %add.1 = fadd double %add, %10
  %arrayidx18.1 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), i64 %indvars.iv.next, i64 %indvars.iv80
  store double %add.1, ptr %arrayidx18.1, align 8, !tbaa !5
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %arrayidx14.2 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 20, i64 0, i64 0), i64 %indvars.iv.next.1, i64 %indvars.iv80
  %11 = load double, ptr %arrayidx14.2, align 8, !tbaa !5
  %add.2 = fadd double %add.1, %11
  %arrayidx18.2 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), i64 %indvars.iv.next.1, i64 %indvars.iv80
  store double %add.2, ptr %arrayidx18.2, align 8, !tbaa !5
  %indvars.iv.next.2 = add nuw nsw i64 %indvars.iv, 3
  %exitcond.not.2 = icmp eq i64 %indvars.iv.next.2, 256
  br i1 %exitcond.not.2, label %for.cond20.preheader, label %for.body8

for.cond.cleanup22:                               ; preds = %for.body23
  %indvars.iv.next81 = add nuw nsw i64 %indvars.iv80, 1
  %exitcond84.not = icmp eq i64 %indvars.iv.next81, 256
  br i1 %exitcond84.not, label %for.cond.cleanup3, label %for.cond5.preheader

for.body23:                                       ; preds = %for.body23.1, %for.cond20.preheader
  %indvars.iv76 = phi i64 [ 1, %for.cond20.preheader ], [ %indvars.iv.next77.1, %for.body23.1 ]
  %arrayidx28 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), i64 %indvars.iv76, i64 %7
  %12 = load double, ptr %arrayidx28, align 8, !tbaa !5
  %arrayidx32 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 20, i64 0, i64 0), i64 %indvars.iv76, i64 %indvars.iv80
  %13 = load double, ptr %arrayidx32, align 8, !tbaa !5
  %add33 = fadd double %12, %13
  %arrayidx37 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), i64 %indvars.iv76, i64 %indvars.iv80
  store double %add33, ptr %arrayidx37, align 8, !tbaa !5
  %indvars.iv.next77 = add nuw nsw i64 %indvars.iv76, 1
  %exitcond79.not = icmp eq i64 %indvars.iv.next77, 256
  br i1 %exitcond79.not, label %for.cond.cleanup22, label %for.body23.1

for.body23.1:                                     ; preds = %for.body23
  %arrayidx28.1 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), i64 %indvars.iv.next77, i64 %7
  %14 = load double, ptr %arrayidx28.1, align 8, !tbaa !5
  %arrayidx32.1 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 20, i64 0, i64 0), i64 %indvars.iv.next77, i64 %indvars.iv80
  %15 = load double, ptr %arrayidx32.1, align 8, !tbaa !5
  %add33.1 = fadd double %14, %15
  %arrayidx37.1 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), i64 %indvars.iv.next77, i64 %indvars.iv80
  store double %add33.1, ptr %arrayidx37.1, align 8, !tbaa !5
...
for.cond.cleanup:                                 ; preds = %for.cond.cleanup3, %entry
  %call50 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.144, double noundef 0.000000e+00)
  br label %for.cond18.preheader.i
...
for.cond5.preheader:                              ; preds = %for.cond1.preheader, %for.body23
  %indvars.iv80 = phi i64 [ 1, %for.cond1.preheader ], [ %indvars.iv.next81, %for.body23 ]
  %arrayidx10.phi.trans.insert = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), i64 0, i64 %indvars.iv80
  %.pre = load double, ptr %arrayidx10.phi.trans.insert, align 8, !tbaa !5
  br label %for.body8

for.cond.cleanup3:                                ; preds = %for.body23
  %call44 = tail call i32 @dummy(ptr noundef nonnull @global_data, ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 11, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 20, i64 0, i64 0), double noundef 0.000000e+00) #16
  %inc46 = add nuw nsw i32 %nl.073, 1
  %6 = load i32, ptr @ntimes, align 4, !tbaa !17
  %div = sdiv i32 %6, 256
...
vector.body:                                      ; preds = %vector.body, %for.cond20.preheader
  %index = phi i64 [ 0, %for.cond20.preheader ], [ %index.next, %vector.body ]
  %offset.idx = or i64 %index, 1
  %8 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), i64 %7, i64 %offset.idx
  %wide.load = load <2 x double>, ptr %8, align 8, !tbaa !5
  %9 = getelementptr inbounds double, ptr %8, i64 2
  %wide.load85 = load <2 x double>, ptr %9, align 8, !tbaa !5
  %10 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 20, i64 0, i64 0), i64 %indvars.iv80, i64 %offset.idx
  %wide.load86 = load <2 x double>, ptr %10, align 8, !tbaa !5
  %11 = getelementptr inbounds double, ptr %10, i64 2
  %wide.load87 = load <2 x double>, ptr %11, align 8, !tbaa !5
  %12 = fadd <2 x double> %wide.load, %wide.load86
  %13 = fadd <2 x double> %wide.load85, %wide.load87
  %14 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), i64 %indvars.iv80, i64 %offset.idx
  store <2 x double> %12, ptr %14, align 8, !tbaa !5
  %15 = getelementptr inbounds double, ptr %14, i64 2
  store <2 x double> %13, ptr %15, align 8, !tbaa !5
  %index.next = add nuw i64 %index, 4
  %16 = icmp eq i64 %index.next, 252
  br i1 %16, label %for.body23, label %vector.body, !llvm.loop !368

for.body8:                                        ; preds = %for.body8, %for.cond5.preheader
  %17 = phi double [ %.pre, %for.cond5.preheader ], [ %add.2, %for.body8 ]
  %indvars.iv = phi i64 [ 1, %for.cond5.preheader ], [ %indvars.iv.next.2, %for.body8 ]
  %arrayidx14 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 20, i64 0, i64 0), i64 %indvars.iv, i64 %indvars.iv80
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %arrayidx14.1 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 20, i64 0, i64 0), i64 %indvars.iv.next, i64 %indvars.iv80
  %19 = load double, ptr %arrayidx14.1, align 8, !tbaa !5
  %add.1 = fadd double %add, %19
  %arrayidx18.1 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), i64 %indvars.iv.next, i64 %indvars.iv80
  store double %add.1, ptr %arrayidx18.1, align 8, !tbaa !5
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %arrayidx14.2 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 20, i64 0, i64 0), i64 %indvars.iv.next.1, i64 %indvars.iv80
  %20 = load double, ptr %arrayidx14.2, align 8, !tbaa !5
  %add.2 = fadd double %add.1, %20
  %arrayidx18.2 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), i64 %indvars.iv.next.1, i64 %indvars.iv80
  store double %add.2, ptr %arrayidx18.2, align 8, !tbaa !5
  %indvars.iv.next.2 = add nuw nsw i64 %indvars.iv, 3
  %exitcond.not.2 = icmp eq i64 %indvars.iv.next.2, 256
...
for.body23:                                       ; preds = %vector.body
  %arrayidx28 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), i64 %7, i64 253
  %21 = load double, ptr %arrayidx28, align 8, !tbaa !5
  %arrayidx32 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 20, i64 0, i64 0), i64 %indvars.iv80, i64 253
  %22 = load double, ptr %arrayidx32, align 8, !tbaa !5
  %add33 = fadd double %21, %22
  %arrayidx37 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), i64 %indvars.iv80, i64 253
  store double %add33, ptr %arrayidx37, align 8, !tbaa !5
  %arrayidx28.1 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), i64 %7, i64 254
  %23 = load double, ptr %arrayidx28.1, align 16, !tbaa !5
  %arrayidx32.1 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 20, i64 0, i64 0), i64 %indvars.iv80, i64 254
  %24 = load double, ptr %arrayidx32.1, align 16, !tbaa !5
  %add33.1 = fadd double %23, %24
  %arrayidx37.1 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), i64 %indvars.iv80, i64 254
  store double %add33.1, ptr %arrayidx37.1, align 16, !tbaa !5
  %arrayidx28.2 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), i64 %7, i64 255
  %25 = load double, ptr %arrayidx28.2, align 8, !tbaa !5
  %arrayidx32.2 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 20, i64 0, i64 0), i64 %indvars.iv80, i64 255
  %26 = load double, ptr %arrayidx32.2, align 8, !tbaa !5
  %add33.2 = fadd double %25, %26
  %arrayidx37.2 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), i64 %indvars.iv80, i64 255
  store double %add33.2, ptr %arrayidx37.2, align 8, !tbaa !5
  %indvars.iv.next81 = add nuw nsw i64 %indvars.iv80, 1
  %exitcond84.not = icmp eq i64 %indvars.iv.next81, 256
  br i1 %exitcond84.not, label %for.cond.cleanup3, label %for.cond5.preheader
}
...
entry:
  %call = tail call i32 @init(ptr noundef nonnull @.str.39)
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
  %cmp56 = icmp sgt i32 %0, 255
  br i1 %cmp56, label %for.cond1.preheader, label %for.cond.cleanup

for.cond1.preheader:                              ; preds = %entry, %for.cond.cleanup3
  %nl.057 = phi i32 [ %inc34, %for.cond.cleanup3 ], [ 0, %entry ]
  br label %for.body4

for.cond.cleanup:                                 ; preds = %for.cond.cleanup3, %entry
  %call38 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.145, double noundef 0.000000e+00)
  br label %for.body.i
...
for.body.i:                                       ; preds = %for.body.i, %for.cond.cleanup
  ...
  br i1 %exitcond.not.i.4, label %for.cond18.preheader.i, label %for.body.i

for.cond18.preheader.i:                           ; preds = %for.body.i, %for.cond.cleanup20.i
  %indvars.iv213.i = phi i64 [ %indvars.iv.next214.i, %for.cond.cleanup20.i ], [ 0, %for.body.i ]
  %sumaa.0202.i = phi double [ %add26.i.3, %for.cond.cleanup20.i ], [ 0.000000e+00, %for.body.i ]
  br label %for.body21.i
...
for.body47.i.preheader:                           ; preds = %for.cond.cleanup20.i
  ...
  %add121.i = fadd double %add.i.4, %add26.i.3
  %call122.i = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %6, double noundef %add121.i)
  ret i32 0
...
for.body21.i:                                     ; preds = %for.body21.i, %for.cond18.preheader.i
  ...
  %sumaa.1198.i = phi double [ %sumaa.0202.i, %for.cond18.preheader.i ], [ %add26.i.3, %for.body21.i ]
  %arrayidx25.i = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), i64 %indvars.iv213.i, i64 %indvars.iv209.i
  %7 = load double, ptr %arrayidx25.i, align 32, !tbaa !5
  %add26.i = fadd double %sumaa.1198.i, %7
  %indvars.iv.next210.i = or i64 %indvars.iv209.i, 1
  %arrayidx25.i.1 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), i64 %indvars.iv213.i, i64 %indvars.iv.next210.i
  %8 = load double, ptr %arrayidx25.i.1, align 8, !tbaa !5
  %add26.i.1 = fadd double %add26.i, %8
  %indvars.iv.next210.i.1 = or i64 %indvars.iv209.i, 2
  %arrayidx25.i.2 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), i64 %indvars.iv213.i, i64 %indvars.iv.next210.i.1
  %9 = load double, ptr %arrayidx25.i.2, align 16, !tbaa !5
  %add26.i.2 = fadd double %add26.i.1, %9
  %indvars.iv.next210.i.2 = or i64 %indvars.iv209.i, 3
  %arrayidx25.i.3 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), i64 %indvars.iv213.i, i64 %indvars.iv.next210.i.2
  %10 = load double, ptr %arrayidx25.i.3, align 8, !tbaa !5
  %add26.i.3 = fadd double %add26.i.2, %10
  %indvars.iv.next210.i.3 = add nuw nsw i64 %indvars.iv209.i, 4
  %exitcond212.not.i.3 = icmp eq i64 %indvars.iv.next210.i.3, 256
  br i1 %exitcond212.not.i.3, label %for.cond.cleanup20.i, label %for.body21.i

for.cond.cleanup3:                                ; preds = %for.cond.cleanup12
  ...
  %inc34 = add nuw nsw i32 %nl.057, 1
  %11 = load i32, ptr @ntimes, align 4, !tbaa !17
  %div = sdiv i32 %11, 256
  %mul = mul nsw i32 %div, 200
  %cmp = icmp slt i32 %inc34, %mul
  br i1 %cmp, label %for.cond1.preheader, label %for.cond.cleanup

for.body4:                                        ; preds = %for.cond1.preheader, %for.cond.cleanup12
  %indvars.iv60 = phi i64 [ 0, %for.cond1.preheader ], [ %indvars.iv.next61, %for.cond.cleanup12 ]
  %arrayidx = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %indvars.iv60
  %12 = load double, ptr %arrayidx, align 8, !tbaa !5
  %arrayidx6 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 %indvars.iv60
  %13 = load double, ptr %arrayidx6, align 8, !tbaa !5
  %arrayidx9 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv60
  %14 = load double, ptr %arrayidx9, align 8, !tbaa !5
  %15 = tail call double @llvm.fmuladd.f64(double %12, double %13, double %14)
  store double %15, ptr %arrayidx9, align 8, !tbaa !5
  %arrayidx17.phi.trans.insert = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), i64 0, i64 %indvars.iv60
  %.pre = load double, ptr %arrayidx17.phi.trans.insert, align 8, !tbaa !5
  br label %for.body13

for.cond.cleanup12:                               ; preds = %for.body13
  %indvars.iv.next61 = add nuw nsw i64 %indvars.iv60, 1
  %exitcond63.not = icmp eq i64 %indvars.iv.next61, 256
  br i1 %exitcond63.not, label %for.cond.cleanup3, label %for.body4

for.body13:                                       ; preds = %for.body13, %for.body4
  %16 = phi double [ %.pre, %for.body4 ], [ %22, %for.body13 ]
  %indvars.iv = phi i64 [ 1, %for.body4 ], [ %indvars.iv.next.2, %for.body13 ]
  %arrayidx21 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), i64 %indvars.iv, i64 %indvars.iv60
  %17 = load double, ptr %arrayidx21, align 8, !tbaa !5
  %18 = tail call double @llvm.fmuladd.f64(double %17, double %15, double %16)
  %arrayidx28 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), i64 %indvars.iv, i64 %indvars.iv60
  store double %18, ptr %arrayidx28, align 8, !tbaa !5
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %arrayidx21.1 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), i64 %indvars.iv.next, i64 %indvars.iv60
  %19 = load double, ptr %arrayidx21.1, align 8, !tbaa !5
  %20 = tail call double @llvm.fmuladd.f64(double %19, double %15, double %18)
  %arrayidx28.1 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), i64 %indvars.iv.next, i64 %indvars.iv60
  store double %20, ptr %arrayidx28.1, align 8, !tbaa !5
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %arrayidx21.2 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), i64 %indvars.iv.next.1, i64 %indvars.iv60
  %21 = load double, ptr %arrayidx21.2, align 8, !tbaa !5
  %22 = tail call double @llvm.fmuladd.f64(double %21, double %15, double %20)
  %arrayidx28.2 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), i64 %indvars.iv.next.1, i64 %indvars.iv60
  store double %22, ptr %arrayidx28.2, align 8, !tbaa !5
  %indvars.iv.next.2 = add nuw nsw i64 %indvars.iv, 3
  %exitcond.not.2 = icmp eq i64 %indvars.iv.next.2, 256
  br i1 %exitcond.not.2, label %for.cond.cleanup12, label %for.body13
}
...
vector.body125:                                   ; preds = %vector.body, %vector.body125
  ...
  br i1 %10, label %vector.body133, label %vector.body125, !llvm.loop !369
...
vector.body133:                                   ; preds = %vector.body125, %vector.body133
  ...
  br i1 %21, label %vector.body141, label %vector.body133, !llvm.loop !370
...
vector.body141:                                   ; preds = %vector.body133, %vector.body141
  ...
  br i1 %32, label %vector.body149, label %vector.body141, !llvm.loop !371
...
vector.body149:                                   ; preds = %vector.body141, %vector.body149
  ...
  br i1 %43, label %for.cond2.preheader.i, label %vector.body149, !llvm.loop !372
...
vector.body157:                                   ; preds = %vector.body157, %for.cond2.preheader.i
  ...
  br i1 %53, label %for.cond.cleanup4.i, label %vector.body157, !llvm.loop !373
...
vector.body167:                                   ; preds = %vector.body167, %for.cond2.preheader.i83
  ...
  br i1 %63, label %for.cond.cleanup4.i85, label %vector.body167, !llvm.loop !374
...
vector.body179:                                   ; preds = %vector.body179, %for.cond2.preheader.i96
  ...
  br i1 %73, label %for.cond.cleanup4.i98, label %vector.body179, !llvm.loop !375
...
vector.body191:                                   ; preds = %for.cond.cleanup4.i98, %vector.body191
  ...
  br i1 %84, label %for.cond.cleanup29, label %vector.body191, !llvm.loop !376
...
vector.body:                                      ; preds = %for.body, %vector.body
  ...
  br i1 %104, label %vector.body125, label %vector.body, !llvm.loop !377
...
if.end.thread:                                    ; preds = %entry
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
  %call222 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.147, i32 noundef %0)
  br label %if.end7

if.end:                                           ; preds = %entry
  %arrayidx = getelementptr inbounds ptr, ptr %argv, i64 1
  %1 = load ptr, ptr %arrayidx, align 8, !tbaa !378
  ...
  %call2 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.147, i32 noundef %conv.i)
  %cmp3.not = icmp eq i32 %argc, 2
  br i1 %cmp3.not, label %if.end7, label %if.then4

if.then4:                                         ; preds = %if.end
  %arrayidx5 = getelementptr inbounds ptr, ptr %argv, i64 2
  %2 = load ptr, ptr %arrayidx5, align 8, !tbaa !378
  %call.i20 = call i64 @strtol(ptr nocapture noundef nonnull %2, ptr noundef null, i32 noundef 10) #16
  %conv.i21 = trunc i64 %call.i20 to i32
  store i32 %conv.i21, ptr @digits, align 4, !tbaa !17
  br label %if.end7

if.end7:                                          ; preds = %if.end.thread, %if.then4, %if.end
  %3 = load ptr, ptr %ip, align 8, !tbaa !378
