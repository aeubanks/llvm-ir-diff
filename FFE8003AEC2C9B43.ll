...
define dso_local zeroext i16 @get_id(i8 noundef signext %c) local_unnamed_addr #0 {
entry:
  %0 = load ptr, ptr getelementptr inbounds (%struct.T_VAL, ptr @curval, i64 0, i32 1), align 2, !tbaa !5
  store i8 %c, ptr %0, align 1, !tbaa !5
  ret i16 undef
}
