...
define dso_local void @good_const(ptr nocapture noundef readonly %p) local_unnamed_addr #0 {
entry:
  tail call void @llvm.prefetch.p0(ptr %p, i32 0, i32 0, i32 1)
  tail call void @llvm.prefetch.p0(ptr %p, i32 0, i32 1, i32 1)
  tail call void @llvm.prefetch.p0(ptr %p, i32 0, i32 2, i32 1)
  tail call void @llvm.prefetch.p0(ptr %p, i32 0, i32 3, i32 1)
  tail call void @llvm.prefetch.p0(ptr %p, i32 1, i32 0, i32 1)
  tail call void @llvm.prefetch.p0(ptr %p, i32 1, i32 1, i32 1)
  tail call void @llvm.prefetch.p0(ptr %p, i32 1, i32 1, i32 1)
  tail call void @llvm.prefetch.p0(ptr %p, i32 1, i32 3, i32 1)
  ret void
}
...
; Function Attrs: mustprogress nofree nosync nounwind willreturn memory(argmem: readwrite, inaccessiblemem: readwrite) uwtable
define dso_local void @good_enum(ptr nocapture noundef readonly %p) local_unnamed_addr #0 {
entry:
  tail call void @llvm.prefetch.p0(ptr %p, i32 0, i32 0, i32 1)
  tail call void @llvm.prefetch.p0(ptr %p, i32 0, i32 1, i32 1)
  tail call void @llvm.prefetch.p0(ptr %p, i32 0, i32 2, i32 1)
  ...
  tail call void @llvm.prefetch.p0(ptr %p, i32 1, i32 0, i32 1)
  tail call void @llvm.prefetch.p0(ptr %p, i32 1, i32 1, i32 1)
  tail call void @llvm.prefetch.p0(ptr %p, i32 1, i32 2, i32 1)
  tail call void @llvm.prefetch.p0(ptr %p, i32 1, i32 3, i32 1)
  ret void
}

; Function Attrs: mustprogress nofree nosync nounwind willreturn memory(argmem: readwrite, inaccessiblemem: readwrite) uwtable
define dso_local void @good_expr(ptr nocapture noundef readonly %p) local_unnamed_addr #0 {
entry:
  tail call void @llvm.prefetch.p0(ptr %p, i32 0, i32 0, i32 1)
  tail call void @llvm.prefetch.p0(ptr %p, i32 1, i32 3, i32 1)
  ret void
...
; Function Attrs: mustprogress nofree nosync nounwind willreturn memory(argmem: readwrite, inaccessiblemem: readwrite) uwtable
define dso_local void @good_vararg(ptr nocapture noundef readonly %p) local_unnamed_addr #0 {
entry:
  tail call void @llvm.prefetch.p0(ptr %p, i32 0, i32 3, i32 1)
  tail call void @llvm.prefetch.p0(ptr %p, i32 0, i32 3, i32 1)
  tail call void @llvm.prefetch.p0(ptr %p, i32 1, i32 3, i32 1)
