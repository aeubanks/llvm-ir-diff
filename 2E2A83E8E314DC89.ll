; ModuleID = '/usr/local/google/home/aeubanks/repos/test-suite/MicroBenchmarks/LoopVectorization/main.cpp'
source_filename = "/usr/local/google/home/aeubanks/repos/test-suite/MicroBenchmarks/LoopVectorization/main.cpp"
...
entry:
  ...
  %call = call noundef i64 @_ZN9benchmark22RunSpecifiedBenchmarksEv()
  ret i32 0
}
...
define internal void @_GLOBAL__sub_I_main.cpp() #2 section ".text.startup" {
entry:
