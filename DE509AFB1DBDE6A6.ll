...
lor.lhs.false:                                    ; preds = %for.body
  ...
  %cmp.i177.not = icmp eq i32 %and.i, 0
  br i1 %cmp.i177.not, label %lor.lhs.false9, label %cleanup
...
lor.lhs.false25:                                  ; preds = %for.body19
  ...
  br i1 %cmp.i184.not, label %cleanup, label %lor.lhs.false28
...
for.cond25.preheader:                             ; preds = %for.cond25.preheader.loopexit, %if.end16
  %24 = phi i32 [ %20, %if.end16 ], [ %.pre, %for.cond25.preheader.loopexit ]
...
if.then.i:                                        ; preds = %if.then
  ...
  br i1 %cmp.i.i, label %if.then3.i, label %if.end6
