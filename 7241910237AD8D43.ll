...
lor.lhs.false:                                    ; preds = %land.lhs.true
  %bcmp361 = tail call i32 @bcmp(ptr noundef nonnull dereferenceable(4) getelementptr inbounds ([10 x [8192 x i8]], ptr @contextbufs, i64 0, i64 0, i64 1), ptr noundef nonnull dereferenceable(4) @.str.1, i64 4)
  %cmp16 = icmp eq i32 %bcmp361, 0
...
if.then18:                                        ; preds = %lor.lhs.false, %land.lhs.true
  ...
  %or.cond362398 = icmp sgt i8 %5, 0
  br i1 %or.cond362398, label %land.rhs28.lr.ph, label %if.end36

land.rhs28.lr.ph:                                 ; preds = %if.then18
  %call29 = tail call ptr @__ctype_b_loc() #15
  %6 = load ptr, ptr %call29, align 8, !tbaa !10
  %idxprom31530 = zext i8 %5 to i64
  %arrayidx32531 = getelementptr inbounds i16, ptr %6, i64 %idxprom31530
  %7 = load i16, ptr %arrayidx32531, align 2, !tbaa !12
  %8 = and i16 %7, 8192
  %tobool34.not532 = icmp eq i16 %8, 0
  br i1 %tobool34.not532, label %if.end36, label %while.body
...
while.body:                                       ; preds = %land.rhs28.lr.ph, %land.rhs28
  ...
  %or.cond362 = icmp sgt i8 %13, 0
  br i1 %or.cond362, label %land.rhs28, label %if.end36, !llvm.loop !14
...
if.then56:                                        ; preds = %lor.lhs.false51, %lor.lhs.false46, %land.lhs.true41
  ...
  %or.cond363401 = icmp sgt i8 %18, 0
  br i1 %or.cond363401, label %land.rhs68.lr.ph, label %while.end79

land.rhs68.lr.ph:                                 ; preds = %if.then56
  %call69 = tail call ptr @__ctype_b_loc() #15
  %19 = load ptr, ptr %call69, align 8, !tbaa !10
  %idxprom71536 = zext i8 %18 to i64
  %arrayidx72537 = getelementptr inbounds i16, ptr %19, i64 %idxprom71536
  %20 = load i16, ptr %arrayidx72537, align 2, !tbaa !12
  %21 = and i16 %20, 8192
  %tobool75.not538 = icmp eq i16 %21, 0
  br i1 %tobool75.not538, label %land.lhs.true87.preheader, label %while.body78
...
while.body78:                                     ; preds = %land.rhs68.lr.ph, %land.rhs68
  ...
  %or.cond363 = icmp sgt i8 %26, 0
  br i1 %or.cond363, label %land.rhs68, label %while.end79, !llvm.loop !16

while.end79:                                      ; preds = %while.body78, %if.then56
  %27 = phi i8 [ %18, %if.then56 ], [ %26, %while.body78 ]
  %28 = phi ptr [ %17, %if.then56 ], [ %25, %while.body78 ]
  %cond364402 = icmp eq i8 %27, 0
  br i1 %cond364402, label %if.then106, label %land.lhs.true87.preheader

land.lhs.true87.preheader:                        ; preds = %land.rhs68, %land.rhs68.lr.ph, %while.end79
  %.ph588 = phi ptr [ %17, %land.rhs68.lr.ph ], [ %28, %while.end79 ], [ %25, %land.rhs68 ]
  %.ph589 = phi i8 [ %18, %land.rhs68.lr.ph ], [ %27, %while.end79 ], [ %26, %land.rhs68 ]
  br label %land.lhs.true87

land.lhs.true87:                                  ; preds = %land.lhs.true87.preheader, %while.body101
  %29 = phi ptr [ %34, %while.body101 ], [ %.ph588, %land.lhs.true87.preheader ]
  %30 = phi i8 [ %35, %while.body101 ], [ %.ph589, %land.lhs.true87.preheader ]
...
while.body101:                                    ; preds = %land.lhs.true87, %land.rhs91
  ...
  %cond364 = icmp eq i8 %35, 0
  br i1 %cond364, label %if.then106, label %land.lhs.true87, !llvm.loop !17
...
if.end117:                                        ; preds = %land.rhs91, %if.end36, %lor.lhs.false51
  ...
  %or.cond487 = select i1 %tobool118.not, i1 %cmp122, i1 false
  br i1 %or.cond487, label %while.cond125.preheader, label %if.end169

while.cond125.preheader:                          ; preds = %if.end117
  %cond365404 = icmp eq i8 %38, 0
  br i1 %cond365404, label %if.then159, label %land.lhs.true132
...
if.then151:                                       ; preds = %while.body147
  %call153 = tail call i32 @putc(i32 noundef %conv126405, ptr noundef %ofile)
  %.pre443 = load ptr, ptr @currentchar, align 8, !tbaa !10
  br label %if.end154

if.end154:                                        ; preds = %if.then151, %while.body147
  %48 = phi ptr [ %.pre443, %if.then151 ], [ %41, %while.body147 ]
  ...
  %cond365 = icmp eq i8 %49, 0
  br i1 %cond365, label %if.then159, label %land.lhs.true132, !llvm.loop !18
...
if.end169:                                        ; preds = %land.rhs136, %if.end, %if.end117
  ...
  %umax551 = tail call i64 @llvm.umax.i64(i64 add (i64 ptrtoint (ptr @ctoken to i64), i64 119), i64 add (i64 ptrtoint (ptr @ctoken to i64), i64 1))
  %54 = add i64 %umax551, xor (i64 ptrtoint (ptr @ctoken to i64), i64 -1)
  br label %for.cond
...
if.else41.i:                                      ; preds = %land.lhs.true37.i, %lor.lhs.false33.i
  ...
  %cond349.i = icmp eq i8 %76, 0
  br i1 %cond349.i, label %while.end245.i, label %land.rhs45.lr.ph.i
...
while.body62.i:                                   ; preds = %land.rhs45.i
  ...
  %cond.i = icmp eq i8 %81, 0
  br i1 %cond.i, label %while.end245.i, label %land.rhs45.i, !llvm.loop !20
...
land.lhs.true118.if.else122_crit_edge.i:          ; preds = %land.lhs.true118.i
  ...
  %.pre440 = load ptr, ptr %bufp.addr.i, align 8, !tbaa !10
  %.pre441 = load i8, ptr %.pre440, align 1, !tbaa !5
...
if.else122.i:                                     ; preds = %land.lhs.true118.if.else122_crit_edge.i, %if.else114.i
  %147 = phi i8 [ %.pre441, %land.lhs.true118.if.else122_crit_edge.i ], [ %67, %if.else114.i ]
  %148 = phi ptr [ %.pre440, %land.lhs.true118.if.else122_crit_edge.i ], [ %58, %if.else114.i ]
...
if.else127.i:                                     ; preds = %if.else122.i
  ...
  %cmp145.i.i = icmp eq i8 %147, %154
  br i1 %cmp145.i.i, label %if.then.i266.i, label %while.cond.preheader.i.preheader.i
...
while.cond.preheader.i.i:                         ; preds = %tailrecurse.loopexit.i.i, %while.cond.preheader.i.preheader.i
  ...
  %cmp11142.i.i = icmp eq i8 %158, %157
  br i1 %cmp11142.i.i, label %while.body.i270.preheader.i, label %while.cond.preheader.i.while.end.i_crit_edge.i
...
if.then.i266.i:                                   ; preds = %tailrecurse.loopexit.i.i, %if.else127.i
  %.lcssa137.i.i = phi ptr [ %148, %if.else127.i ], [ %incdec.ptr66.i.i, %tailrecurse.loopexit.i.i ]
  %.lcssa132.i.i = phi i8 [ %147, %if.else127.i ], [ %230, %tailrecurse.loopexit.i.i ]
  %arrayidx.i264.i = getelementptr inbounds i8, ptr %.lcssa137.i.i, i64 1
  %160 = load i8, ptr %arrayidx.i264.i, align 1, !tbaa !5
  %cmp5.i265.i = icmp eq i8 %160, %.lcssa132.i.i
...
while.end.i.i:                                    ; preds = %while.cond.backedge.i.i, %while.cond.preheader.i.while.end.i_crit_edge.i
  ...
  %.lcssa126.i.i = phi ptr [ %159, %while.cond.preheader.i.while.end.i_crit_edge.i ], [ %storemerge.i.i, %while.cond.backedge.i.i ]
  %.lcssa123.i.i = phi i8 [ %158, %while.cond.preheader.i.while.end.i_crit_edge.i ], [ %172, %while.cond.backedge.i.i ]
  %cmp48.i.i = icmp eq i8 %.lcssa123.i.i, %219
  %222 = load i8, ptr getelementptr inbounds (%struct.hashheader, ptr @hashheader, i64 0, i32 16, i64 6), align 1
  %cmp53.i.i = icmp eq i8 %.lcssa123.i.i, %222
...
if.then61.i.i:                                    ; preds = %land.lhs.true55.i.i
  ...
  %tobool64.not144.i.i = icmp eq i8 %225, 0
...
if.then173:                                       ; preds = %skiptoword.exit
  ...
  %.pre442 = load ptr, ptr @currentchar, align 8, !tbaa !10
  br label %if.end175

if.end175:                                        ; preds = %if.then173, %skiptoword.exit
  %263 = phi ptr [ %.pre442, %if.then173 ], [ %259, %skiptoword.exit ]
...
skipoverword.exit:                                ; preds = %if.else13.i, %if.else21.i, %if.then.i351, %if.then2.i
  ...
  %cond.i360 = select i1 %cmp34.not.i, ptr %bufp.addr.050.i, ptr %lastboundary.052.i
  %cond.i360541 = ptrtoint ptr %cond.i360 to i64
  %currentchar.promoted = load ptr, ptr @currentchar, align 8, !tbaa !10
  %currentchar.promoted542 = ptrtoint ptr %currentchar.promoted to i64
  %cmp183407 = icmp ult ptr %currentchar.promoted, %cond.i360
  br i1 %cmp183407, label %while.body189.preheader, label %while.end192

while.body189.preheader:                          ; preds = %skipoverword.exit
  %272 = xor i64 %currentchar.promoted542, -1
  %273 = add i64 %272, %cond.i360541
  %umin552 = tail call i64 @llvm.umin.i64(i64 %273, i64 %54)
  %274 = add i64 %umin552, 1
  %min.iters.check = icmp ult i64 %274, 22
  br i1 %min.iters.check, label %while.body189.preheader559, label %vector.memcheck

vector.memcheck:                                  ; preds = %while.body189.preheader
  %275 = xor i64 %currentchar.promoted542, -1
  %276 = add i64 %275, %cond.i360541
  ...
  %scevgep543 = getelementptr i8, ptr %currentchar.promoted, i64 1
  %scevgep544 = getelementptr i8, ptr %scevgep543, i64 %umin
  ...
  %bound0545 = icmp ugt ptr %scevgep544, @currentchar
  %bound1 = icmp ult ptr %currentchar.promoted, getelementptr inbounds (ptr, ptr @currentchar, i64 1)
  %found.conflict546 = and i1 %bound0545, %bound1
  %conflict.rdx = or i1 %found.conflict, %found.conflict546
  %bound0547 = icmp ugt ptr %scevgep544, @ctoken
  %bound1548 = icmp ult ptr %currentchar.promoted, %scevgep
  %found.conflict549 = and i1 %bound0547, %bound1548
  %conflict.rdx550 = or i1 %conflict.rdx, %found.conflict549
  br i1 %conflict.rdx550, label %while.body189.preheader559, label %vector.ph

vector.ph:                                        ; preds = %vector.memcheck
  %n.vec = and i64 %274, -2
  %ind.end = getelementptr i8, ptr @ctoken, i64 %n.vec
  %ind.end553 = getelementptr i8, ptr %currentchar.promoted, i64 %n.vec
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %next.gep555 = getelementptr i8, ptr %currentchar.promoted, i64 %index
  %277 = or i64 %index, 1
  %gep = getelementptr i8, ptr %invariant.gep, i64 %277
  %wide.load = load <2 x i8>, ptr %next.gep555, align 1, !tbaa !5, !alias.scope !29
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %while.end192, label %while.body189.preheader559

while.body189.preheader559:                       ; preds = %vector.memcheck, %while.body189.preheader, %middle.block
  %p.0409.ph = phi ptr [ @ctoken, %vector.memcheck ], [ @ctoken, %while.body189.preheader ], [ %ind.end, %middle.block ]
  %incdec.ptr190406408.ph = phi ptr [ %currentchar.promoted, %vector.memcheck ], [ %currentchar.promoted, %while.body189.preheader ], [ %ind.end553, %middle.block ]
  br label %while.body189

while.body189:                                    ; preds = %while.body189.preheader559, %while.body189
  %p.0409 = phi ptr [ %incdec.ptr191, %while.body189 ], [ %p.0409.ph, %while.body189.preheader559 ]
  %incdec.ptr190406408 = phi ptr [ %incdec.ptr190, %while.body189 ], [ %incdec.ptr190406408.ph, %while.body189.preheader559 ]
  %incdec.ptr190 = getelementptr inbounds i8, ptr %incdec.ptr190406408, i64 1
  store ptr %incdec.ptr190, ptr @currentchar, align 8, !tbaa !10
  %279 = load i8, ptr %incdec.ptr190406408, align 1, !tbaa !5
  %incdec.ptr191 = getelementptr inbounds i8, ptr %p.0409, i64 1
  store i8 %279, ptr %p.0409, align 1, !tbaa !5
  %cmp183 = icmp ult ptr %incdec.ptr190, %cond.i360
