...
lor.lhs.false:                                    ; preds = %land.lhs.true
  %bcmp363 = tail call i32 @bcmp(ptr noundef nonnull dereferenceable(4) getelementptr inbounds ([10 x [8192 x i8]], ptr @contextbufs, i64 0, i64 0, i64 1), ptr noundef nonnull dereferenceable(4) @.str.1, i64 4)
  %cmp16 = icmp eq i32 %bcmp363, 0
...
if.then18:                                        ; preds = %lor.lhs.false, %land.lhs.true
  ...
  %or.cond349393 = icmp sgt i8 %5, 0
  br i1 %or.cond349393, label %land.rhs28.lr.ph, label %if.end36

land.rhs28.lr.ph:                                 ; preds = %if.then18
  %call29 = tail call ptr @__ctype_b_loc() #15
  %6 = load ptr, ptr %call29, align 8, !tbaa !10
  %idxprom31521 = zext i8 %5 to i64
  %arrayidx32522 = getelementptr inbounds i16, ptr %6, i64 %idxprom31521
  %7 = load i16, ptr %arrayidx32522, align 2, !tbaa !12
  %8 = and i16 %7, 8192
  %tobool34.not523 = icmp eq i16 %8, 0
  br i1 %tobool34.not523, label %if.end36, label %while.body
...
while.body:                                       ; preds = %land.rhs28.lr.ph, %land.rhs28
  ...
  %or.cond349 = icmp sgt i8 %13, 0
  br i1 %or.cond349, label %land.rhs28, label %if.end36, !llvm.loop !14
...
if.then56:                                        ; preds = %lor.lhs.false51, %lor.lhs.false46, %land.lhs.true41
  ...
  %or.cond350394 = icmp sgt i8 %18, 0
  br i1 %or.cond350394, label %land.rhs68.lr.ph, label %while.end79

land.rhs68.lr.ph:                                 ; preds = %if.then56
  %call69 = tail call ptr @__ctype_b_loc() #15
  %19 = load ptr, ptr %call69, align 8, !tbaa !10
  %idxprom71527 = zext i8 %18 to i64
  %arrayidx72528 = getelementptr inbounds i16, ptr %19, i64 %idxprom71527
  %20 = load i16, ptr %arrayidx72528, align 2, !tbaa !12
  %21 = and i16 %20, 8192
  %tobool75.not529 = icmp eq i16 %21, 0
  br i1 %tobool75.not529, label %land.lhs.true87.preheader, label %while.body78
...
while.body78:                                     ; preds = %land.rhs68.lr.ph, %land.rhs68
  ...
  %or.cond350 = icmp sgt i8 %26, 0
  br i1 %or.cond350, label %land.rhs68, label %while.end79, !llvm.loop !16

while.end79:                                      ; preds = %while.body78, %if.then56
  %27 = phi i8 [ %18, %if.then56 ], [ %26, %while.body78 ]
  %28 = phi ptr [ %17, %if.then56 ], [ %25, %while.body78 ]
  %tobool82.not395 = icmp eq i8 %27, 0
  br i1 %tobool82.not395, label %if.then106, label %land.lhs.true87.preheader

land.lhs.true87.preheader:                        ; preds = %land.rhs68, %land.rhs68.lr.ph, %while.end79
  %.ph579 = phi ptr [ %17, %land.rhs68.lr.ph ], [ %28, %while.end79 ], [ %25, %land.rhs68 ]
  %.ph580 = phi i8 [ %18, %land.rhs68.lr.ph ], [ %27, %while.end79 ], [ %26, %land.rhs68 ]
  br label %land.lhs.true87

land.lhs.true87:                                  ; preds = %land.lhs.true87.preheader, %while.body101
  %29 = phi ptr [ %34, %while.body101 ], [ %.ph579, %land.lhs.true87.preheader ]
  %30 = phi i8 [ %35, %while.body101 ], [ %.ph580, %land.lhs.true87.preheader ]
...
if.end117:                                        ; preds = %land.rhs91, %if.end36, %lor.lhs.false51
  ...
  %or.cond478 = select i1 %tobool118.not, i1 %cmp122, i1 false
  br i1 %or.cond478, label %while.cond125.preheader, label %if.end169

while.cond125.preheader:                          ; preds = %if.end117
  %tobool127.not396 = icmp eq i8 %38, 0
  br i1 %tobool127.not396, label %if.then159, label %land.lhs.true132
...
if.then151:                                       ; preds = %while.body147
  ...
  %.pre434 = load ptr, ptr @currentchar, align 8, !tbaa !10
  br label %if.end154

if.end154:                                        ; preds = %if.then151, %while.body147
  %48 = phi ptr [ %.pre434, %if.then151 ], [ %41, %while.body147 ]
...
if.end169:                                        ; preds = %land.rhs136, %if.end, %if.end117
  ...
  %umax542 = tail call i64 @llvm.umax.i64(i64 add (i64 ptrtoint (ptr @ctoken to i64), i64 119), i64 add (i64 ptrtoint (ptr @ctoken to i64), i64 1))
  %54 = add i64 %umax542, xor (i64 ptrtoint (ptr @ctoken to i64), i64 -1)
  br label %for.cond
...
for.cond:                                         ; preds = %for.cond.backedge, %if.end169
  ...
  %tobool.not355.i = icmp eq i8 %56, 0
  br i1 %tobool.not355.i, label %while.end245.i, label %land.rhs.i
...
land.lhs.true.i:                                  ; preds = %land.rhs.i
  ...
  %.pre381.i = load i8, ptr %58, align 1, !tbaa !5
  %.pre392.i = zext i8 %.pre381.i to i64
  br i1 %cmp.i, label %lor.lhs.false.i, label %land.lhs.true4.i

land.lhs.true4.i:                                 ; preds = %land.lhs.true.i, %land.rhs.i
  %idxprom5.pre-phi.i = phi i64 [ %idxprom.i, %land.rhs.i ], [ %.pre392.i, %land.lhs.true.i ]
  %60 = phi i8 [ %57, %land.rhs.i ], [ %.pre381.i, %land.lhs.true.i ]
...
lor.lhs.false.i:                                  ; preds = %land.lhs.true4.i, %land.lhs.true.i
  %idxprom8.pre-phi.i = phi i64 [ %idxprom5.pre-phi.i, %land.lhs.true4.i ], [ %.pre392.i, %land.lhs.true.i ]
  %62 = phi i8 [ %60, %land.lhs.true4.i ], [ %.pre381.i, %land.lhs.true.i ]
...
if.else41.i:                                      ; preds = %land.lhs.true37.i, %lor.lhs.false33.i
  ...
  %tobool44.not352.i = icmp eq i8 %76, 0
  br i1 %tobool44.not352.i, label %while.end245.i, label %land.rhs45.lr.ph.i
...
land.rhs45.i:                                     ; preds = %while.body62.i, %land.rhs45.lr.ph.i
  ...
  %incdec.ptr350353.i = phi ptr [ %bufp.addr.promoted.i, %land.rhs45.lr.ph.i ], [ %incdec.ptr.i, %while.body62.i ]
...
while.body62.i:                                   ; preds = %land.rhs45.i
  %incdec.ptr.i = getelementptr inbounds i8, ptr %incdec.ptr350353.i, i64 1
...
if.end67.i:                                       ; preds = %land.rhs45.i
  store ptr %incdec.ptr350353.i, ptr %bufp.addr.i, align 8, !tbaa !10
  br i1 %cmp53.i, label %if.then.i.i, label %if.else.i.i

if.then.i.i:                                      ; preds = %if.end67.i
  %arrayidx.i.i = getelementptr inbounds i8, ptr %incdec.ptr350353.i, i64 1
...
if.end16.i.i:                                     ; preds = %if.else.i.i
  %incdec.ptr17.i.i = getelementptr inbounds i8, ptr %incdec.ptr350353.i, i64 1
...
if.then.i.i.i.i:                                  ; preds = %if.end27.i.i
  %arrayidx.i.i.i.i = getelementptr inbounds i8, ptr %incdec.ptr350353.i, i64 5
...
if.then.i41.i.i.i:                                ; preds = %lor.lhs.false.i.i.i
  %arrayidx.i39.i.i.i = getelementptr inbounds i8, ptr %incdec.ptr350353.i, i64 8
...
if.then.i54.i.i.i:                                ; preds = %lor.lhs.false3.i.i.i
  %arrayidx.i52.i.i.i = getelementptr inbounds i8, ptr %incdec.ptr350353.i, i64 5
...
lor.lhs.false6.i.i.i:                             ; preds = %land.lhs.true.i59.i.i.i, %lor.lhs.false3.i.i.i
  ...
  %cmp.i64.i.i.i = icmp eq i32 %call.i63.i.i.i, 0
  br i1 %cmp.i64.i.i.i, label %if.then.i67.i.i.i, label %if.else.i.i.i

if.then.i67.i.i.i:                                ; preds = %lor.lhs.false6.i.i.i
  %arrayidx.i65.i.i.i = getelementptr inbounds i8, ptr %incdec.ptr350353.i, i64 9
...
if.else.i.i.i:                                    ; preds = %land.lhs.true.i72.i.i.i, %lor.lhs.false6.i.i.i
  ...
  %cmp.i77.i.i.i = icmp eq i32 %call.i76.i.i.i, 0
  br i1 %cmp.i77.i.i.i, label %if.then.i80.i.i.i, label %lor.lhs.false11.i.i.i

if.then.i80.i.i.i:                                ; preds = %if.else.i.i.i
  %arrayidx.i78.i.i.i = getelementptr inbounds i8, ptr %incdec.ptr350353.i, i64 7
...
lor.lhs.false11.i.i.i:                            ; preds = %land.lhs.true.i85.i.i.i, %if.else.i.i.i
  ...
  %cmp.i90.i.i.i = icmp eq i32 %call.i89.i.i.i, 0
  br i1 %cmp.i90.i.i.i, label %if.then.i93.i.i.i, label %if.else18.i.i.i

if.then.i93.i.i.i:                                ; preds = %lor.lhs.false11.i.i.i
  %arrayidx.i91.i.i.i = getelementptr inbounds i8, ptr %incdec.ptr350353.i, i64 9
...
TeX_open_paren.exit.i.i.i:                        ; preds = %while.body.i.i.i.i, %if.then14.i.i.i
  ...
  %119 = phi ptr [ %incdec.ptr350353.i, %if.then14.i.i.i ], [ %116, %while.body.i.i.i.i ]
...
if.else18.i.i.i:                                  ; preds = %land.lhs.true.i98.i.i.i, %lor.lhs.false11.i.i.i
  ...
  %cmp.i104.i.i.i = icmp eq i32 %call.i103.i.i.i, 0
  br i1 %cmp.i104.i.i.i, label %if.then.i107.i.i.i, label %if.end30.i.i

if.then.i107.i.i.i:                               ; preds = %if.else18.i.i.i
  %arrayidx.i105.i.i.i = getelementptr inbounds i8, ptr %incdec.ptr350353.i, i64 6
  %120 = load i8, ptr %arrayidx.i105.i.i.i, align 1, !tbaa !5
  %cmp3.i106.i.i.i = icmp sgt i8 %120, -1
  br i1 %cmp3.i106.i.i.i, label %land.lhs.true.i112.i.i.i, label %TeX_LR_begin.exit.i.i
...
TeX_LR_begin.exit.i.i:                            ; preds = %land.lhs.true.i112.i.i.i, %if.then.i107.i.i.i
...
if.end30.i.i:                                     ; preds = %TeX_LR_begin.exit.if.end30_crit_edge.i.i, %land.lhs.true.i112.i.i.i, %if.else18.i.i.i
  %129 = phi ptr [ %.pre.i.i, %TeX_LR_begin.exit.if.end30_crit_edge.i.i ], [ %incdec.ptr17.i.i, %land.lhs.true.i112.i.i.i ], [ %incdec.ptr17.i.i, %if.else18.i.i.i ]
  %call.i.i.i = tail call i32 @strncmp(ptr noundef nonnull dereferenceable(1) %129, ptr noundef nonnull dereferenceable(4) @.str.27, i64 noundef 3) #14
  %cmp.i.i.i = icmp eq i32 %call.i.i.i, 0
  br i1 %cmp.i.i.i, label %if.then.i46.i.i, label %if.end73thread-pre-split.i

if.then.i46.i.i:                                  ; preds = %if.end30.i.i
  %arrayidx.i.i.i = getelementptr inbounds i8, ptr %129, i64 3
  %130 = load i8, ptr %arrayidx.i.i.i, align 1, !tbaa !5
  %cmp3.i.i.i = icmp sgt i8 %130, -1
...
land.lhs.true.i.i.i:                              ; preds = %if.then.i46.i.i
  ...
  %131 = load ptr, ptr %call5.i.i.i, align 8, !tbaa !10
  %idxprom9.i.i.i = zext i8 %130 to i64
  %arrayidx10.i.i.i = getelementptr inbounds i16, ptr %131, i64 %idxprom9.i.i.i
  %132 = load i16, ptr %arrayidx10.i.i.i, align 2, !tbaa !12
  %133 = and i16 %132, 1024
  %tobool.not.i47.i.i = icmp eq i16 %133, 0
...
if.end73thread-pre-split.i:                       ; preds = %TeX_math_end.exit.i, %land.lhs.true.i.i.i, %if.end30.i.i, %if.then13.i.i, %if.then12.i.i
  %.pr320.i = load i32, ptr @math_mode, align 4, !tbaa !8
  br label %if.end73.i

if.end73.i:                                       ; preds = %if.end73thread-pre-split.i, %if.then70.i, %if.then40.i
  %135 = phi i32 [ %.pr320.i, %if.end73thread-pre-split.i ], [ %dec71.i, %if.then70.i ], [ %dec.i, %if.then40.i ]
...
land.lhs.true104.i:                               ; preds = %land.lhs.true99.i
  ...
  %cmp.i262.i = icmp eq i32 %call.i.i, 0
  br i1 %cmp.i262.i, label %if.then.i264.i, label %if.else114.i

if.then.i264.i:                                   ; preds = %land.lhs.true104.i
  %arrayidx.i263.i = getelementptr inbounds i8, ptr %58, i64 4
  %140 = load i8, ptr %arrayidx.i263.i, align 1, !tbaa !5
  %cmp3.i.i = icmp sgt i8 %140, -1
  br i1 %cmp3.i.i, label %land.lhs.true.i.i, label %if.then108.i

land.lhs.true.i.i:                                ; preds = %if.then.i264.i
  %call5.i.i = tail call ptr @__ctype_b_loc() #15
  %141 = load ptr, ptr %call5.i.i, align 8, !tbaa !10
  %idxprom9.i.i = zext i8 %140 to i64
  %arrayidx10.i.i = getelementptr inbounds i16, ptr %141, i64 %idxprom9.i.i
  %142 = load i16, ptr %arrayidx10.i.i, align 2, !tbaa !12
  %143 = and i16 %142, 1024
  %tobool.not.i.i = icmp eq i16 %143, 0
  br i1 %tobool.not.i.i, label %if.then108.i, label %if.else114.i

if.then108.i:                                     ; preds = %land.lhs.true.i.i, %if.then.i264.i, %if.else93.i
...
land.lhs.true118.if.else122_crit_edge.i:          ; preds = %land.lhs.true118.i
  %.pre383.i = load i8, ptr @LaTeX_Mode, align 1, !tbaa !5
  %.pre431 = load ptr, ptr %bufp.addr.i, align 8, !tbaa !10
  %.pre432 = load i8, ptr %.pre431, align 1, !tbaa !5
...
if.else122.i:                                     ; preds = %land.lhs.true118.if.else122_crit_edge.i, %if.else114.i
  %146 = phi i8 [ %.pre432, %land.lhs.true118.if.else122_crit_edge.i ], [ %67, %if.else114.i ]
  %147 = phi ptr [ %.pre431, %land.lhs.true118.if.else122_crit_edge.i ], [ %58, %if.else114.i ]
  %148 = phi i8 [ %.pre383.i, %land.lhs.true118.if.else122_crit_edge.i ], [ %139, %if.else114.i ]
...
while.body.i.i:                                   ; preds = %if.then126.i, %while.body.i.i
  ...
  %tobool.not.i266.i = icmp eq i8 %152, 0
  %cmp.not.i.i = icmp eq i8 %152, %149
  %or.cond.i267.i = select i1 %tobool.not.i266.i, i1 true, i1 %cmp.not.i.i
  %cmp6.not.i.i = icmp eq i8 %152, %150
  %or.cond11.i.i = select i1 %or.cond.i267.i, i1 true, i1 %cmp6.not.i.i
...
if.else127.i:                                     ; preds = %if.else122.i
  ...
  %cmp145.i.i = icmp eq i8 %146, %153
  br i1 %cmp145.i.i, label %if.then.i271.i, label %while.cond.preheader.i.preheader.i

while.cond.preheader.i.preheader.i:               ; preds = %if.else127.i
  %.pre384.i = load i8, ptr getelementptr inbounds (%struct.hashheader, ptr @hashheader, i64 0, i32 16, i64 8), align 1, !tbaa !5
...
tailrecurse.loopexit.i.i:                         ; preds = %land.lhs.true71.i.i
  ...
  %cmp.i268.i = icmp eq i8 %229, %154
  br i1 %cmp.i268.i, label %if.then.i271.i, label %while.cond.preheader.i.i

while.cond.preheader.i.i:                         ; preds = %tailrecurse.loopexit.i.i, %while.cond.preheader.i.preheader.i
  %155 = phi i8 [ %219, %tailrecurse.loopexit.i.i ], [ %.pre384.i, %while.cond.preheader.i.preheader.i ]
  %156 = phi i8 [ %220, %tailrecurse.loopexit.i.i ], [ %.pre384.i, %while.cond.preheader.i.preheader.i ]
  ...
  %cmp11142.i.i = icmp eq i8 %157, %156
  br i1 %cmp11142.i.i, label %while.body.i275.preheader.i, label %while.cond.preheader.i.while.end.i_crit_edge.i

while.cond.preheader.i.while.end.i_crit_edge.i:   ; preds = %while.cond.preheader.i.i
  %.pre390.i = load i8, ptr getelementptr inbounds (%struct.hashheader, ptr @hashheader, i64 0, i32 16, i64 2), align 1
  br label %while.end.i.i

while.body.i275.preheader.i:                      ; preds = %while.cond.preheader.i.i
  %.pre386.i = load i8, ptr getelementptr inbounds (%struct.hashheader, ptr @hashheader, i64 0, i32 16), align 1, !tbaa !5
  %.pre388.i = load i8, ptr getelementptr inbounds (%struct.hashheader, ptr @hashheader, i64 0, i32 16, i64 2), align 1
  br label %while.body.i275.i

if.then.i271.i:                                   ; preds = %tailrecurse.loopexit.i.i, %if.else127.i
  %.lcssa137.i.i = phi ptr [ %147, %if.else127.i ], [ %incdec.ptr66.i.i, %tailrecurse.loopexit.i.i ]
  %.lcssa132.i.i = phi i8 [ %146, %if.else127.i ], [ %229, %tailrecurse.loopexit.i.i ]
  %arrayidx.i269.i = getelementptr inbounds i8, ptr %.lcssa137.i.i, i64 1
  %159 = load i8, ptr %arrayidx.i269.i, align 1, !tbaa !5
  %cmp5.i270.i = icmp eq i8 %159, %.lcssa132.i.i
  br i1 %cmp5.i270.i, label %if.then7.i272.i, label %if.then130.i

if.then7.i272.i:                                  ; preds = %if.then.i271.i
  store ptr %arrayidx.i269.i, ptr %bufp.addr.i, align 8, !tbaa !10
  br label %if.then130.i

while.body.i275.i:                                ; preds = %while.cond.backedge.i.i, %while.body.i275.preheader.i
  %160 = phi i8 [ %168, %while.cond.backedge.i.i ], [ %155, %while.body.i275.preheader.i ]
  %161 = phi i8 [ %169, %while.cond.backedge.i.i ], [ %.pre388.i, %while.body.i275.preheader.i ]
  %162 = phi i8 [ %170, %while.cond.backedge.i.i ], [ %.pre386.i, %while.body.i275.preheader.i ]
  %163 = phi ptr [ %storemerge.i.i, %while.cond.backedge.i.i ], [ %158, %while.body.i275.preheader.i ]
  ...
  %cmp20.i273.i = icmp eq i8 %164, %161
  %or.cond.i274.i = select i1 %cmp16.i.i, i1 true, i1 %cmp20.i273.i
  br i1 %or.cond.i274.i, label %if.then130.i, label %if.else.i278.i

if.else.i278.i:                                   ; preds = %while.body.i275.i
  %call.i276.i = tail call ptr @__ctype_b_loc() #15
  %165 = load ptr, ptr %call.i276.i, align 8, !tbaa !10
  ...
  %tobool.not.i277.i = icmp ne i16 %167, 0
  %cmp27.not.i.i = icmp eq i8 %164, 64
  %or.cond108.i.i = or i1 %cmp27.not.i.i, %tobool.not.i277.i
  br i1 %or.cond108.i.i, label %if.else31.i.i, label %if.then29.i.i

if.then29.i.i:                                    ; preds = %if.else.i278.i
...
while.cond.backedge.i.i:                          ; preds = %if.else39.i.i, %if.then29.i.i
  %168 = phi i8 [ %160, %if.then29.i.i ], [ %.pre389.i, %if.else39.i.i ]
  %169 = phi i8 [ %161, %if.then29.i.i ], [ %.pre387.i, %if.else39.i.i ]
  %170 = phi i8 [ %162, %if.then29.i.i ], [ %.pre385.i, %if.else39.i.i ]
  ...
  br i1 %cmp11.i.i, label %while.body.i275.i, label %while.end.i.i, !llvm.loop !23

if.else31.i.i:                                    ; preds = %if.else.i278.i
  %call.i.i279.i = tail call i32 @strncmp(ptr noundef nonnull dereferenceable(1) %incdec.ptr13.i.i, ptr noundef nonnull dereferenceable(6) @.str.34, i64 noundef 5) #14
  %cmp.i.i280.i = icmp eq i32 %call.i.i279.i, 0
  br i1 %cmp.i.i280.i, label %if.then.i.i283.i, label %if.else42.i.i

if.then.i.i283.i:                                 ; preds = %if.else31.i.i
  %arrayidx.i.i281.i = getelementptr inbounds i8, ptr %163, i64 6
  %172 = load i8, ptr %arrayidx.i.i281.i, align 1, !tbaa !5
  %cmp3.i.i282.i = icmp sgt i8 %172, -1
  br i1 %cmp3.i.i282.i, label %land.lhs.true.i.i287.i, label %if.then35.i.i

land.lhs.true.i.i287.i:                           ; preds = %if.then.i.i283.i
  %idxprom9.i.i284.i = zext i8 %172 to i64
  %arrayidx10.i.i285.i = getelementptr inbounds i16, ptr %165, i64 %idxprom9.i.i284.i
  %173 = load i16, ptr %arrayidx10.i.i285.i, align 2, !tbaa !12
  %174 = and i16 %173, 1024
  %tobool.not.i.i286.i = icmp eq i16 %174, 0
  br i1 %tobool.not.i.i286.i, label %if.then35.i.i, label %if.else42.i.i

if.then35.i.i:                                    ; preds = %land.lhs.true.i.i287.i, %if.then.i.i283.i
...
if.else39.i.i:                                    ; preds = %if.then35.i.i
  ...
  %.pre385.i = load i8, ptr getelementptr inbounds (%struct.hashheader, ptr @hashheader, i64 0, i32 16), align 1, !tbaa !5
  %175 = load ptr, ptr %bufp.addr.i, align 8, !tbaa !10
  %incdec.ptr40.i.i = getelementptr inbounds i8, ptr %175, i64 -1
  %.pre389.i = load i8, ptr getelementptr inbounds (%struct.hashheader, ptr @hashheader, i64 0, i32 16, i64 8), align 1, !tbaa !5
  br label %while.cond.backedge.i.i

if.else42.i.i:                                    ; preds = %land.lhs.true.i.i287.i, %if.else31.i.i
  %call.i.i.i288.i = tail call i32 @strncmp(ptr noundef nonnull dereferenceable(1) %incdec.ptr13.i.i, ptr noundef nonnull dereferenceable(4) @.str.27, i64 noundef 3) #14
  %cmp.i.i.i289.i = icmp eq i32 %call.i.i.i288.i, 0
  br i1 %cmp.i.i.i289.i, label %if.then.i.i.i292.i, label %lor.lhs.false.i.i297.i

if.then.i.i.i292.i:                               ; preds = %if.else42.i.i
  %arrayidx.i.i.i290.i = getelementptr inbounds i8, ptr %163, i64 4
  %176 = load i8, ptr %arrayidx.i.i.i290.i, align 1, !tbaa !5
  %cmp3.i.i.i291.i = icmp sgt i8 %176, -1
  br i1 %cmp3.i.i.i291.i, label %land.lhs.true.i.i.i296.i, label %if.then.i111.i.i

land.lhs.true.i.i.i296.i:                         ; preds = %if.then.i.i.i292.i
  %idxprom9.i.i.i293.i = zext i8 %176 to i64
  %arrayidx10.i.i.i294.i = getelementptr inbounds i16, ptr %165, i64 %idxprom9.i.i.i293.i
  %177 = load i16, ptr %arrayidx10.i.i.i294.i, align 2, !tbaa !12
  %178 = and i16 %177, 1024
  %tobool.not.i.i.i295.i = icmp eq i16 %178, 0
  br i1 %tobool.not.i.i.i295.i, label %if.then.i111.i.i, label %lor.lhs.false.i.i297.i

lor.lhs.false.i.i297.i:                           ; preds = %land.lhs.true.i.i.i296.i, %if.else42.i.i
  %call.i167.i.i.i = tail call i32 @strncmp(ptr noundef nonnull dereferenceable(1) %incdec.ptr13.i.i, ptr noundef nonnull dereferenceable(7) @.str.35, i64 noundef 6) #14
  %cmp.i168.i.i.i = icmp eq i32 %call.i167.i.i.i, 0
  br i1 %cmp.i168.i.i.i, label %if.then.i171.i.i.i, label %lor.lhs.false3.i.i298.i

if.then.i171.i.i.i:                               ; preds = %lor.lhs.false.i.i297.i
  %arrayidx.i169.i.i.i = getelementptr inbounds i8, ptr %163, i64 7
  %179 = load i8, ptr %arrayidx.i169.i.i.i, align 1, !tbaa !5
  %cmp3.i170.i.i.i = icmp sgt i8 %179, -1
  br i1 %cmp3.i170.i.i.i, label %land.lhs.true.i176.i.i.i, label %if.then.i111.i.i

land.lhs.true.i176.i.i.i:                         ; preds = %if.then.i171.i.i.i
  %idxprom9.i173.i.i.i = zext i8 %179 to i64
  %arrayidx10.i174.i.i.i = getelementptr inbounds i16, ptr %165, i64 %idxprom9.i173.i.i.i
  %180 = load i16, ptr %arrayidx10.i174.i.i.i, align 2, !tbaa !12
  %181 = and i16 %180, 1024
  %tobool.not.i175.i.i.i = icmp eq i16 %181, 0
  br i1 %tobool.not.i175.i.i.i, label %if.then.i111.i.i, label %lor.lhs.false3.i.i298.i

lor.lhs.false3.i.i298.i:                          ; preds = %land.lhs.true.i176.i.i.i, %lor.lhs.false.i.i297.i
  %call.i180.i.i.i = tail call i32 @strncmp(ptr noundef nonnull dereferenceable(1) %incdec.ptr13.i.i, ptr noundef nonnull dereferenceable(7) @.str.36, i64 noundef 6) #14
  %cmp.i181.i.i.i = icmp eq i32 %call.i180.i.i.i, 0
  br i1 %cmp.i181.i.i.i, label %if.then.i184.i.i.i, label %lor.lhs.false6.i.i299.i

if.then.i184.i.i.i:                               ; preds = %lor.lhs.false3.i.i298.i
  %arrayidx.i182.i.i.i = getelementptr inbounds i8, ptr %163, i64 7
  %182 = load i8, ptr %arrayidx.i182.i.i.i, align 1, !tbaa !5
  %cmp3.i183.i.i.i = icmp sgt i8 %182, -1
  br i1 %cmp3.i183.i.i.i, label %land.lhs.true.i189.i.i.i, label %if.then.i111.i.i

land.lhs.true.i189.i.i.i:                         ; preds = %if.then.i184.i.i.i
  %idxprom9.i186.i.i.i = zext i8 %182 to i64
  %arrayidx10.i187.i.i.i = getelementptr inbounds i16, ptr %165, i64 %idxprom9.i186.i.i.i
  %183 = load i16, ptr %arrayidx10.i187.i.i.i, align 2, !tbaa !12
  %184 = and i16 %183, 1024
  %tobool.not.i188.i.i.i = icmp eq i16 %184, 0
  br i1 %tobool.not.i188.i.i.i, label %if.then.i111.i.i, label %lor.lhs.false6.i.i299.i

lor.lhs.false6.i.i299.i:                          ; preds = %land.lhs.true.i189.i.i.i, %lor.lhs.false3.i.i298.i
  %call.i193.i.i.i = tail call i32 @strncmp(ptr noundef nonnull dereferenceable(1) %incdec.ptr13.i.i, ptr noundef nonnull dereferenceable(5) @.str.37, i64 noundef 4) #14
  %cmp.i194.i.i.i = icmp eq i32 %call.i193.i.i.i, 0
  br i1 %cmp.i194.i.i.i, label %if.then.i197.i.i.i, label %lor.lhs.false9.i.i.i

if.then.i197.i.i.i:                               ; preds = %lor.lhs.false6.i.i299.i
  %arrayidx.i195.i.i.i = getelementptr inbounds i8, ptr %163, i64 5
  %185 = load i8, ptr %arrayidx.i195.i.i.i, align 1, !tbaa !5
  %cmp3.i196.i.i.i = icmp sgt i8 %185, -1
  br i1 %cmp3.i196.i.i.i, label %land.lhs.true.i202.i.i.i, label %if.then.i111.i.i

land.lhs.true.i202.i.i.i:                         ; preds = %if.then.i197.i.i.i
  %idxprom9.i199.i.i.i = zext i8 %185 to i64
  %arrayidx10.i200.i.i.i = getelementptr inbounds i16, ptr %165, i64 %idxprom9.i199.i.i.i
  %186 = load i16, ptr %arrayidx10.i200.i.i.i, align 2, !tbaa !12
  %187 = and i16 %186, 1024
  %tobool.not.i201.i.i.i = icmp eq i16 %187, 0
  br i1 %tobool.not.i201.i.i.i, label %if.then.i111.i.i, label %lor.lhs.false9.i.i.i

lor.lhs.false9.i.i.i:                             ; preds = %land.lhs.true.i202.i.i.i, %lor.lhs.false6.i.i299.i
  %call.i206.i.i.i = tail call i32 @strncmp(ptr noundef nonnull dereferenceable(1) %incdec.ptr13.i.i, ptr noundef nonnull dereferenceable(4) @.str.38, i64 noundef 3) #14
  %cmp.i207.i.i.i = icmp eq i32 %call.i206.i.i.i, 0
  br i1 %cmp.i207.i.i.i, label %if.then.i210.i.i.i, label %lor.lhs.false12.i.i.i

if.then.i210.i.i.i:                               ; preds = %lor.lhs.false9.i.i.i
  %arrayidx.i208.i.i.i = getelementptr inbounds i8, ptr %163, i64 4
  %188 = load i8, ptr %arrayidx.i208.i.i.i, align 1, !tbaa !5
  %cmp3.i209.i.i.i = icmp sgt i8 %188, -1
  br i1 %cmp3.i209.i.i.i, label %land.lhs.true.i215.i.i.i, label %if.then.i111.i.i

land.lhs.true.i215.i.i.i:                         ; preds = %if.then.i210.i.i.i
  %idxprom9.i212.i.i.i = zext i8 %188 to i64
  %arrayidx10.i213.i.i.i = getelementptr inbounds i16, ptr %165, i64 %idxprom9.i212.i.i.i
  %189 = load i16, ptr %arrayidx10.i213.i.i.i, align 2, !tbaa !12
  %190 = and i16 %189, 1024
  %tobool.not.i214.i.i.i = icmp eq i16 %190, 0
  br i1 %tobool.not.i214.i.i.i, label %if.then.i111.i.i, label %lor.lhs.false12.i.i.i

lor.lhs.false12.i.i.i:                            ; preds = %land.lhs.true.i215.i.i.i, %lor.lhs.false9.i.i.i
  %call.i219.i.i.i = tail call i32 @strncmp(ptr noundef nonnull dereferenceable(1) %incdec.ptr13.i.i, ptr noundef nonnull dereferenceable(7) @.str.32, i64 noundef 6) #14
  %cmp.i220.i.i.i = icmp eq i32 %call.i219.i.i.i, 0
  br i1 %cmp.i220.i.i.i, label %if.then.i223.i.i.i, label %lor.lhs.false15.i.i.i

if.then.i223.i.i.i:                               ; preds = %lor.lhs.false12.i.i.i
  %arrayidx.i221.i.i.i = getelementptr inbounds i8, ptr %163, i64 7
  %191 = load i8, ptr %arrayidx.i221.i.i.i, align 1, !tbaa !5
  %cmp3.i222.i.i.i = icmp sgt i8 %191, -1
  br i1 %cmp3.i222.i.i.i, label %land.lhs.true.i228.i.i.i, label %if.then.i111.i.i

land.lhs.true.i228.i.i.i:                         ; preds = %if.then.i223.i.i.i
  %idxprom9.i225.i.i.i = zext i8 %191 to i64
  %arrayidx10.i226.i.i.i = getelementptr inbounds i16, ptr %165, i64 %idxprom9.i225.i.i.i
  %192 = load i16, ptr %arrayidx10.i226.i.i.i, align 2, !tbaa !12
  %193 = and i16 %192, 1024
  %tobool.not.i227.i.i.i = icmp eq i16 %193, 0
  br i1 %tobool.not.i227.i.i.i, label %if.then.i111.i.i, label %lor.lhs.false15.i.i.i

lor.lhs.false15.i.i.i:                            ; preds = %land.lhs.true.i228.i.i.i, %lor.lhs.false12.i.i.i
  %call.i232.i.i.i = tail call i32 @strncmp(ptr noundef nonnull dereferenceable(1) %incdec.ptr13.i.i, ptr noundef nonnull dereferenceable(6) @.str.39, i64 noundef 5) #14
  %cmp.i233.i.i.i = icmp eq i32 %call.i232.i.i.i, 0
  br i1 %cmp.i233.i.i.i, label %if.then.i236.i.i.i, label %lor.lhs.false18.i.i.i

if.then.i236.i.i.i:                               ; preds = %lor.lhs.false15.i.i.i
  %arrayidx.i234.i.i.i = getelementptr inbounds i8, ptr %163, i64 6
  %194 = load i8, ptr %arrayidx.i234.i.i.i, align 1, !tbaa !5
  %cmp3.i235.i.i.i = icmp sgt i8 %194, -1
  br i1 %cmp3.i235.i.i.i, label %land.lhs.true.i241.i.i.i, label %if.then.i111.i.i

land.lhs.true.i241.i.i.i:                         ; preds = %if.then.i236.i.i.i
  %idxprom9.i238.i.i.i = zext i8 %194 to i64
  %arrayidx10.i239.i.i.i = getelementptr inbounds i16, ptr %165, i64 %idxprom9.i238.i.i.i
  %195 = load i16, ptr %arrayidx10.i239.i.i.i, align 2, !tbaa !12
  %196 = and i16 %195, 1024
  %tobool.not.i240.i.i.i = icmp eq i16 %196, 0
  br i1 %tobool.not.i240.i.i.i, label %if.then.i111.i.i, label %lor.lhs.false18.i.i.i

lor.lhs.false18.i.i.i:                            ; preds = %land.lhs.true.i241.i.i.i, %lor.lhs.false15.i.i.i
  %call.i245.i.i.i = tail call i32 @strncmp(ptr noundef nonnull dereferenceable(1) %incdec.ptr13.i.i, ptr noundef nonnull dereferenceable(6) @.str.40, i64 noundef 5) #14
  %cmp.i246.i.i.i = icmp eq i32 %call.i245.i.i.i, 0
  br i1 %cmp.i246.i.i.i, label %if.then.i249.i.i.i, label %lor.lhs.false21.i.i.i

if.then.i249.i.i.i:                               ; preds = %lor.lhs.false18.i.i.i
  %arrayidx.i247.i.i.i = getelementptr inbounds i8, ptr %163, i64 6
  %197 = load i8, ptr %arrayidx.i247.i.i.i, align 1, !tbaa !5
  %cmp3.i248.i.i.i = icmp sgt i8 %197, -1
  br i1 %cmp3.i248.i.i.i, label %land.lhs.true.i254.i.i.i, label %if.then.i111.i.i

land.lhs.true.i254.i.i.i:                         ; preds = %if.then.i249.i.i.i
  %idxprom9.i251.i.i.i = zext i8 %197 to i64
  %arrayidx10.i252.i.i.i = getelementptr inbounds i16, ptr %165, i64 %idxprom9.i251.i.i.i
  %198 = load i16, ptr %arrayidx10.i252.i.i.i, align 2, !tbaa !12
  %199 = and i16 %198, 1024
  %tobool.not.i253.i.i.i = icmp eq i16 %199, 0
  br i1 %tobool.not.i253.i.i.i, label %if.then.i111.i.i, label %lor.lhs.false21.i.i.i

lor.lhs.false21.i.i.i:                            ; preds = %land.lhs.true.i254.i.i.i, %lor.lhs.false18.i.i.i
  %call.i258.i.i.i = tail call i32 @strncmp(ptr noundef nonnull dereferenceable(1) %incdec.ptr13.i.i, ptr noundef nonnull dereferenceable(7) @.str.41, i64 noundef 6) #14
  %cmp.i259.i.i.i = icmp eq i32 %call.i258.i.i.i, 0
  br i1 %cmp.i259.i.i.i, label %if.then.i262.i.i.i, label %lor.lhs.false24.i.i.i

if.then.i262.i.i.i:                               ; preds = %lor.lhs.false21.i.i.i
  %arrayidx.i260.i.i.i = getelementptr inbounds i8, ptr %163, i64 7
  %200 = load i8, ptr %arrayidx.i260.i.i.i, align 1, !tbaa !5
  %cmp3.i261.i.i.i = icmp sgt i8 %200, -1
  br i1 %cmp3.i261.i.i.i, label %land.lhs.true.i267.i.i.i, label %if.then.i111.i.i

land.lhs.true.i267.i.i.i:                         ; preds = %if.then.i262.i.i.i
  %idxprom9.i264.i.i.i = zext i8 %200 to i64
  %arrayidx10.i265.i.i.i = getelementptr inbounds i16, ptr %165, i64 %idxprom9.i264.i.i.i
  %201 = load i16, ptr %arrayidx10.i265.i.i.i, align 2, !tbaa !12
  %202 = and i16 %201, 1024
  %tobool.not.i266.i.i.i = icmp eq i16 %202, 0
  br i1 %tobool.not.i266.i.i.i, label %if.then.i111.i.i, label %lor.lhs.false24.i.i.i

lor.lhs.false24.i.i.i:                            ; preds = %land.lhs.true.i267.i.i.i, %lor.lhs.false21.i.i.i
  ...
  br i1 %cmp26.i.i.i, label %if.then.i111.i.i, label %lor.lhs.false27.i.i.i
...
lor.lhs.false27.i.i.i:                            ; preds = %lor.lhs.false24.i.i.i
  ...
  br i1 %cmp29.i.i.i, label %if.then.i111.i.i, label %lor.lhs.false30.i.i.i
...
lor.lhs.false30.i.i.i:                            ; preds = %lor.lhs.false27.i.i.i
  ...
  br i1 %cmp32.i.i.i, label %if.then.i111.i.i, label %lor.lhs.false33.i.i.i
...
lor.lhs.false33.i.i.i:                            ; preds = %lor.lhs.false30.i.i.i
  ...
  br i1 %cmp35.i.i.i, label %if.then.i111.i.i, label %lor.lhs.false36.i.i.i
...
lor.lhs.false36.i.i.i:                            ; preds = %lor.lhs.false33.i.i.i
  ...
  br i1 %cmp38.i.i.i, label %if.then.i111.i.i, label %lor.lhs.false39.i.i.i
...
lor.lhs.false39.i.i.i:                            ; preds = %lor.lhs.false36.i.i.i
  ...
  br i1 %cmp41.i.i.i, label %if.then.i111.i.i, label %lor.lhs.false42.i.i.i
...
lor.lhs.false42.i.i.i:                            ; preds = %lor.lhs.false39.i.i.i
  ...
  br i1 %cmp44.i.i.i, label %if.then.i111.i.i, label %lor.lhs.false45.i.i.i
...
lor.lhs.false45.i.i.i:                            ; preds = %lor.lhs.false42.i.i.i
  ...
  br i1 %cmp47.i.i.i, label %if.then.i111.i.i, label %lor.lhs.false48.i.i.i
...
lor.lhs.false48.i.i.i:                            ; preds = %lor.lhs.false45.i.i.i
  ...
  br i1 %cmp50.i.i.i, label %if.then.i111.i.i, label %lor.lhs.false51.i.i.i
...
lor.lhs.false51.i.i.i:                            ; preds = %lor.lhs.false48.i.i.i
  ...
  br i1 %cmp53.i.i.i, label %if.then.i111.i.i, label %lor.lhs.false54.i.i.i
...
lor.lhs.false54.i.i.i:                            ; preds = %lor.lhs.false51.i.i.i
  ...
  br i1 %cmp56.i.i.i, label %if.then.i111.i.i, label %if.else.i.i311.i

if.then.i111.i.i:                                 ; preds = %lor.lhs.false54.i.i.i, %lor.lhs.false51.i.i.i, %lor.lhs.false48.i.i.i, %lor.lhs.false45.i.i.i, %lor.lhs.false42.i.i.i, %lor.lhs.false39.i.i.i, %lor.lhs.false36.i.i.i, %lor.lhs.false33.i.i.i, %lor.lhs.false30.i.i.i, %lor.lhs.false27.i.i.i, %lor.lhs.false24.i.i.i, %land.lhs.true.i267.i.i.i, %if.then.i262.i.i.i, %land.lhs.true.i254.i.i.i, %if.then.i249.i.i.i, %land.lhs.true.i241.i.i.i, %if.then.i236.i.i.i, %land.lhs.true.i228.i.i.i, %if.then.i223.i.i.i, %land.lhs.true.i215.i.i.i, %if.then.i210.i.i.i, %land.lhs.true.i202.i.i.i, %if.then.i197.i.i.i, %land.lhs.true.i189.i.i.i, %if.then.i184.i.i.i, %land.lhs.true.i176.i.i.i, %if.then.i171.i.i.i, %land.lhs.true.i.i.i296.i, %if.then.i.i.i292.i
  %tobool.not12.i.i.i300.i = icmp eq i8 %164, 0
  %203 = load i8, ptr getelementptr inbounds (%struct.hashheader, ptr @hashheader, i64 0, i32 16, i64 5), align 2
  %cmp.not13.i.i.i301.i = icmp eq i8 %164, %203
  %or.cond14.i.i.i302.i = select i1 %tobool.not12.i.i.i300.i, i1 true, i1 %cmp.not13.i.i.i301.i
  %204 = load i8, ptr getelementptr inbounds (%struct.hashheader, ptr @hashheader, i64 0, i32 16, i64 9), align 2
  %cmp6.not15.i.i.i303.i = icmp eq i8 %164, %204
  %or.cond1116.i.i.i304.i = select i1 %or.cond14.i.i.i302.i, i1 true, i1 %cmp6.not15.i.i.i303.i
  br i1 %or.cond1116.i.i.i304.i, label %TeX_skip_parens.exit.i.i.i, label %while.body.i.i.i310.i

while.body.i.i.i310.i:                            ; preds = %if.then.i111.i.i, %while.body.i.i.i310.i
  %205 = phi ptr [ %incdec.ptr.i.i.i305.i, %while.body.i.i.i310.i ], [ %incdec.ptr13.i.i, %if.then.i111.i.i ]
  %incdec.ptr.i.i.i305.i = getelementptr inbounds i8, ptr %205, i64 1
  store ptr %incdec.ptr.i.i.i305.i, ptr %bufp.addr.i, align 8, !tbaa !10
  %206 = load i8, ptr %incdec.ptr.i.i.i305.i, align 1, !tbaa !5
  %tobool.not.i271.i.i.i = icmp eq i8 %206, 0
  %cmp.not.i.i.i306.i = icmp eq i8 %206, %203
  %or.cond.i.i.i307.i = select i1 %tobool.not.i271.i.i.i, i1 true, i1 %cmp.not.i.i.i306.i
  %cmp6.not.i.i.i308.i = icmp eq i8 %206, %204
  %or.cond11.i.i.i309.i = select i1 %or.cond.i.i.i307.i, i1 true, i1 %cmp6.not.i.i.i308.i
  br i1 %or.cond11.i.i.i309.i, label %TeX_skip_parens.exit.i.i.i, label %while.body.i.i.i310.i, !llvm.loop !22

TeX_skip_parens.exit.i.i.i:                       ; preds = %while.body.i.i.i310.i, %if.then.i111.i.i
  %207 = phi i8 [ %164, %if.then.i111.i.i ], [ %206, %while.body.i.i.i310.i ]
...
if.else.i.i311.i:                                 ; preds = %lor.lhs.false54.i.i.i
...
lor.lhs.false63.i.i.i:                            ; preds = %if.else.i.i311.i
...
if.then83.i.i.i:                                  ; preds = %lor.lhs.false79.i.i.i, %lor.lhs.false75.i.i.i, %lor.lhs.false71.i.i.i, %lor.lhs.false67.i.i.i, %lor.lhs.false63.i.i.i, %if.else.i.i311.i
...
if.else88.i.i.i:                                  ; preds = %if.then83.i.i.i
  %incdec.ptr.i.i312.i = getelementptr inbounds i8, ptr %208, i64 1
  store ptr %incdec.ptr.i.i312.i, ptr %bufp.addr.i, align 8, !tbaa !10
  call fastcc void @TeX_skip_parens(ptr noundef nonnull %bufp.addr.i)
...
if.then99.i.i.i:                                  ; preds = %if.else95.i.i.i
  %arrayidx.i112.i.i = getelementptr inbounds i8, ptr %163, i64 5
  %212 = load i8, ptr %arrayidx.i112.i.i, align 1, !tbaa !5
...
while.body117.i.i.i:                              ; preds = %if.else95.i.i.i, %while.body117.i.i.i
  ...
  %tobool.not.i113.i.i = icmp ne i16 %217, 0
  %cmp115.i.i.i = icmp eq i8 %215, 64
  %or.cond166.i.i.i = or i1 %cmp115.i.i.i, %tobool.not.i113.i.i
  br i1 %or.cond166.i.i.i, label %while.body117.i.i.i, label %while.end119.i.i.i, !llvm.loop !25
...
while.end.i.i:                                    ; preds = %while.cond.backedge.i.i, %while.cond.preheader.i.while.end.i_crit_edge.i
  %218 = phi i8 [ %.pre390.i, %while.cond.preheader.i.while.end.i_crit_edge.i ], [ %169, %while.cond.backedge.i.i ]
  ...
  %.lcssa126.i.i = phi ptr [ %158, %while.cond.preheader.i.while.end.i_crit_edge.i ], [ %storemerge.i.i, %while.cond.backedge.i.i ]
  %.lcssa123.i.i = phi i8 [ %157, %while.cond.preheader.i.while.end.i_crit_edge.i ], [ %171, %while.cond.backedge.i.i ]
  %cmp48.i.i = icmp eq i8 %.lcssa123.i.i, %218
  %221 = load i8, ptr getelementptr inbounds (%struct.hashheader, ptr @hashheader, i64 0, i32 16, i64 6), align 1
  %cmp53.i.i = icmp eq i8 %.lcssa123.i.i, %221
...
land.lhs.true55.i.i:                              ; preds = %while.end.i.i
  %arrayidx56.i.i = getelementptr inbounds i8, ptr %.lcssa126.i.i, i64 1
...
if.then61.i.i:                                    ; preds = %land.lhs.true55.i.i
  ...
  %tobool64.not144.i.i = icmp eq i8 %224, 0
  br i1 %tobool64.not144.i.i, label %if.end138.i, label %while.body65.i.preheader.i
...
if.then130.i:                                     ; preds = %if.then35.i.i, %while.body.i275.i, %if.then7.i272.i, %if.then.i271.i
...
skiptoword.exit:                                  ; preds = %while.end245.i, %if.then251.i
  ...
  %cmp171.not = icmp eq ptr %258, %261
...
if.then173:                                       ; preds = %skiptoword.exit
  ...
  %.pre433 = load ptr, ptr @currentchar, align 8, !tbaa !10
  br label %if.end175

if.end175:                                        ; preds = %if.then173, %skiptoword.exit
  %262 = phi ptr [ %.pre433, %if.then173 ], [ %258, %skiptoword.exit ]
  %263 = load i8, ptr %262, align 1, !tbaa !5
  %cmp177 = icmp eq i8 %263, 0
  br i1 %cmp177, label %for.end302, label %if.else.i356

if.then.i353:                                     ; preds = %if.end33.i
  %.b.i352 = load i1, ptr @TeX_comment, align 4
  br i1 %.b.i352, label %if.then2.i, label %skipoverword.exit

if.then2.i:                                       ; preds = %if.then.i353
...
if.else.i356:                                     ; preds = %if.end175, %if.end33.i
  %266 = phi i8 [ %270, %if.end33.i ], [ %263, %if.end175 ]
  %bufp.addr.055.i = phi ptr [ %add.ptr.i, %if.end33.i ], [ %262, %if.end175 ]
  %lastboundary.054.i = phi ptr [ %lastboundary.2.i, %if.end33.i ], [ null, %if.end175 ]
  %idxprom.i354 = zext i8 %266 to i64
  %arrayidx.i355 = getelementptr inbounds %struct.hashheader, ptr @hashheader, i64 0, i32 27, i64 %idxprom.i354
  %267 = load i8, ptr %arrayidx.i355, align 1, !tbaa !5
  %tobool4.not.i = icmp eq i8 %267, 0
  br i1 %tobool4.not.i, label %if.else8.i, label %land.lhs.true.i358

land.lhs.true.i358:                               ; preds = %if.else.i356
  %call.i357 = tail call i32 @stringcharlen(ptr noundef nonnull %bufp.addr.055.i, i32 noundef 0) #13
  %cmp5.i = icmp sgt i32 %call.i357, 0
  br i1 %cmp5.i, label %if.then7.i, label %land.lhs.true.if.else8_crit_edge.i

land.lhs.true.if.else8_crit_edge.i:               ; preds = %land.lhs.true.i358
  %.pre.i = load i8, ptr %bufp.addr.055.i, align 1, !tbaa !5
  %.pre59.i = zext i8 %.pre.i to i64
  br label %if.else8.i

if.then7.i:                                       ; preds = %land.lhs.true.i358
  %idx.ext.i = zext i32 %call.i357 to i64
  br label %if.end33.i

if.else8.i:                                       ; preds = %land.lhs.true.if.else8_crit_edge.i, %if.else.i356
  %idxprom9.pre-phi.i = phi i64 [ %.pre59.i, %land.lhs.true.if.else8_crit_edge.i ], [ %idxprom.i354, %if.else.i356 ]
  ...
  %tobool11.not.i359 = icmp eq i8 %268, 0
  br i1 %tobool11.not.i359, label %if.else13.i, label %if.end33.i
...
if.else13.i:                                      ; preds = %if.else8.i
  ...
  %tobool16.not.i360 = icmp eq i8 %269, 0
  br i1 %tobool16.not.i360, label %skipoverword.exit, label %if.then17.i
...
if.end33.i:                                       ; preds = %if.else21.i, %if.then17.i, %if.else8.i, %if.then7.i
  ...
  %cmp.i361 = icmp eq i8 %270, 0
  br i1 %cmp.i361, label %if.then.i353, label %if.else.i356

skipoverword.exit:                                ; preds = %if.else13.i, %if.else21.i, %if.then.i353, %if.then2.i
  %lastboundary.052.i = phi ptr [ %lastboundary.2.i, %if.then.i353 ], [ %lastboundary.2.i, %if.then2.i ], [ %lastboundary.054.i, %if.else21.i ], [ %lastboundary.054.i, %if.else13.i ]
  %bufp.addr.050.i = phi ptr [ %add.ptr.i, %if.then.i353 ], [ %add.ptr.i, %if.then2.i ], [ %bufp.addr.055.i, %if.else21.i ], [ %bufp.addr.055.i, %if.else13.i ]
  %cmp34.not.i = icmp eq ptr %lastboundary.052.i, null
  %cond.i = select i1 %cmp34.not.i, ptr %bufp.addr.050.i, ptr %lastboundary.052.i
  %cond.i532 = ptrtoint ptr %cond.i to i64
  %currentchar.promoted = load ptr, ptr @currentchar, align 8, !tbaa !10
  %currentchar.promoted533 = ptrtoint ptr %currentchar.promoted to i64
  %cmp183398 = icmp ult ptr %currentchar.promoted, %cond.i
  br i1 %cmp183398, label %while.body189.preheader, label %while.end192

while.body189.preheader:                          ; preds = %skipoverword.exit
  %271 = xor i64 %currentchar.promoted533, -1
  %272 = add i64 %271, %cond.i532
  %umin543 = tail call i64 @llvm.umin.i64(i64 %272, i64 %54)
  %273 = add i64 %umin543, 1
  %min.iters.check = icmp ult i64 %273, 22
  br i1 %min.iters.check, label %while.body189.preheader550, label %vector.memcheck

vector.memcheck:                                  ; preds = %while.body189.preheader
  %274 = xor i64 %currentchar.promoted533, -1
  %275 = add i64 %274, %cond.i532
  ...
  %scevgep534 = getelementptr i8, ptr %currentchar.promoted, i64 1
  %scevgep535 = getelementptr i8, ptr %scevgep534, i64 %umin
  ...
  %bound0536 = icmp ugt ptr %scevgep535, @currentchar
  %bound1 = icmp ult ptr %currentchar.promoted, getelementptr inbounds (ptr, ptr @currentchar, i64 1)
  %found.conflict537 = and i1 %bound0536, %bound1
  %conflict.rdx = or i1 %found.conflict, %found.conflict537
  %bound0538 = icmp ugt ptr %scevgep535, @ctoken
  %bound1539 = icmp ult ptr %currentchar.promoted, %scevgep
  %found.conflict540 = and i1 %bound0538, %bound1539
  %conflict.rdx541 = or i1 %conflict.rdx, %found.conflict540
  br i1 %conflict.rdx541, label %while.body189.preheader550, label %vector.ph

vector.ph:                                        ; preds = %vector.memcheck
  %n.vec = and i64 %273, -2
  %ind.end = getelementptr i8, ptr @ctoken, i64 %n.vec
  %ind.end544 = getelementptr i8, ptr %currentchar.promoted, i64 %n.vec
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %next.gep546 = getelementptr i8, ptr %currentchar.promoted, i64 %index
  %276 = or i64 %index, 1
  %gep = getelementptr i8, ptr %invariant.gep, i64 %276
  %wide.load = load <2 x i8>, ptr %next.gep546, align 1, !tbaa !5, !alias.scope !29
  store <2 x i8> %wide.load, ptr %next.gep, align 2, !tbaa !5, !alias.scope !32, !noalias !29
  %index.next = add nuw i64 %index, 2
  %277 = icmp eq i64 %index.next, %n.vec
  br i1 %277, label %middle.block, label %vector.body, !llvm.loop !34

middle.block:                                     ; preds = %vector.body
  store ptr %gep, ptr @currentchar, align 8, !tbaa !10, !alias.scope !37, !noalias !39
  %cmp.n = icmp eq i64 %273, %n.vec
  br i1 %cmp.n, label %while.end192, label %while.body189.preheader550

while.body189.preheader550:                       ; preds = %vector.memcheck, %while.body189.preheader, %middle.block
  %p.0400.ph = phi ptr [ @ctoken, %vector.memcheck ], [ @ctoken, %while.body189.preheader ], [ %ind.end, %middle.block ]
  %incdec.ptr190397399.ph = phi ptr [ %currentchar.promoted, %vector.memcheck ], [ %currentchar.promoted, %while.body189.preheader ], [ %ind.end544, %middle.block ]
  br label %while.body189

while.body189:                                    ; preds = %while.body189.preheader550, %while.body189
  %p.0400 = phi ptr [ %incdec.ptr191, %while.body189 ], [ %p.0400.ph, %while.body189.preheader550 ]
  %incdec.ptr190397399 = phi ptr [ %incdec.ptr190, %while.body189 ], [ %incdec.ptr190397399.ph, %while.body189.preheader550 ]
  %incdec.ptr190 = getelementptr inbounds i8, ptr %incdec.ptr190397399, i64 1
  store ptr %incdec.ptr190, ptr @currentchar, align 8, !tbaa !10
  %278 = load i8, ptr %incdec.ptr190397399, align 1, !tbaa !5
  %incdec.ptr191 = getelementptr inbounds i8, ptr %p.0400, i64 1
  store i8 %278, ptr %p.0400, align 1, !tbaa !5
  ...
  %279 = select i1 %cmp183, i1 %cmp186, i1 false
  br i1 %279, label %while.body189, label %while.end192, !llvm.loop !40
...
if.then195:                                       ; preds = %while.end192
  %280 = load ptr, ptr @stderr, align 8, !tbaa !10
  %call196 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %280, ptr noundef nonnull @.str.5, ptr noundef nonnull @ctoken, i32 noundef 466, ptr noundef nonnull @.str.6) #16
  br label %if.end197
...
if.end197:                                        ; preds = %if.then195, %while.end192
  ...
  %281 = load i32, ptr @lflag, align 4, !tbaa !8
  %tobool200.not = icmp eq i32 %281, 0
  br i1 %tobool200.not, label %if.else, label %if.then201

if.then201:                                       ; preds = %if.end197
  %282 = load i32, ptr @minword, align 4, !tbaa !8
  %cmp202 = icmp slt i32 %282, %conv199
...
land.lhs.true204:                                 ; preds = %if.then201
  ...
  %283 = load i32, ptr @cflag, align 4
  %tobool208 = icmp ne i32 %283, 0
...
if.else:                                          ; preds = %if.end197
  %284 = load i32, ptr @aflag, align 4, !tbaa !8
  %tobool215.not = icmp eq i32 %284, 0
  br i1 %tobool215.not, label %if.else290, label %if.then216

if.then216:                                       ; preds = %if.else
  %285 = load i32, ptr @minword, align 4, !tbaa !8
  %cmp217.not = icmp slt i32 %285, %conv199
  br i1 %cmp217.not, label %if.end224, label %if.then219

if.then219:                                       ; preds = %if.then216
  %286 = load i32, ptr @terse, align 4, !tbaa !8
  %tobool220.not = icmp eq i32 %286, 0
  br i1 %tobool220.not, label %if.then221, label %for.cond.backedge

if.then221:                                       ; preds = %if.then219
  %287 = tail call i64 @fwrite(ptr nonnull @.str.8, i64 2, i64 1, ptr %ofile)
...
if.then227:                                       ; preds = %if.end224
  %288 = load ptr, ptr getelementptr inbounds ([10 x %struct.success], ptr @hits, i64 0, i64 0, i32 1), align 8, !tbaa !41
  %cmp228 = icmp eq ptr %288, null
  %289 = load ptr, ptr getelementptr inbounds ([10 x %struct.success], ptr @hits, i64 0, i64 0, i32 2), align 16
  %cmp231 = icmp eq ptr %289, null
  %or.cond319 = select i1 %cmp228, i1 %cmp231, i1 false
  %290 = load i32, ptr @terse, align 4, !tbaa !8
  %tobool234.not = icmp eq i32 %290, 0
...
if.then235:                                       ; preds = %if.then233
  %291 = tail call i64 @fwrite(ptr nonnull @.str.8, i64 2, i64 1, ptr %ofile)
  br label %if.end295
...
if.then240:                                       ; preds = %if.else238
  %292 = load ptr, ptr @hits, align 16, !tbaa !43
  %word = getelementptr inbounds %struct.dent, ptr %292, i64 0, i32 1
  %293 = load ptr, ptr %word, align 8, !tbaa !44
  %call241 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %ofile, ptr noundef nonnull @.str.9, ptr noundef %293)
  br label %if.end295
...
if.then247:                                       ; preds = %if.else244
  %294 = load i32, ptr @terse, align 4, !tbaa !8
  %tobool248.not = icmp eq i32 %294, 0
  br i1 %tobool248.not, label %if.then249, label %if.end295

if.then249:                                       ; preds = %if.then247
  %295 = tail call i64 @fwrite(ptr nonnull @.str.10, i64 2, i64 1, ptr %ofile)
  br label %if.end295

if.else252:                                       ; preds = %if.else244
  tail call void @makepossibilities(ptr noundef nonnull @itoken) #13
  %296 = load i32, ptr @pcount, align 4, !tbaa !8
  %tobool253.not = icmp eq i32 %296, 0
  br i1 %tobool253.not, label %if.else279, label %if.then254

if.then254:                                       ; preds = %if.else252
  %297 = load i32, ptr @easypossibilities, align 4, !tbaa !8
  %tobool255.not = icmp eq i32 %297, 0
  %cond = select i1 %tobool255.not, i32 63, i32 38
  %298 = load ptr, ptr @currentchar, align 8, !tbaa !10
  %sub.ptr.lhs.cast256 = ptrtoint ptr %298 to i64
  %call258 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) @ctoken) #14
  %299 = add i64 %call258, ptrtoint (ptr @contextbufs to i64)
  %sub259 = sub i64 %sub.ptr.lhs.cast256, %299
  %conv260 = trunc i64 %sub259 to i32
  %300 = load i32, ptr @contextoffset, align 4, !tbaa !8
  %add = add nsw i32 %300, %conv260
  %call261 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %ofile, ptr noundef nonnull @.str.11, i32 noundef %cond, ptr noundef nonnull @ctoken, i32 noundef %297, i32 noundef %add)
  br label %for.body
...
for.body:                                         ; preds = %if.then254, %if.end272
  ...
  %301 = load i8, ptr %arrayidx266, align 8, !tbaa !5
  %cmp269 = icmp eq i8 %301, 0
...
if.else279:                                       ; preds = %if.else252
  %302 = load ptr, ptr @currentchar, align 8, !tbaa !10
  %sub.ptr.lhs.cast280 = ptrtoint ptr %302 to i64
  %call282 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) @ctoken) #14
  %303 = add i64 %call282, ptrtoint (ptr @contextbufs to i64)
  %sub283 = sub i64 %sub.ptr.lhs.cast280, %303
  %conv284 = trunc i64 %sub283 to i32
  %304 = load i32, ptr @contextoffset, align 4, !tbaa !8
  %add285 = add nsw i32 %304, %conv284
...
if.else290:                                       ; preds = %if.else
  %305 = load i32, ptr @quit, align 4, !tbaa !8
  %tobool291.not = icmp eq i32 %305, 0
...
if.end295:                                        ; preds = %if.then249, %if.then247, %if.else279, %for.end, %if.then235, %if.then233, %if.then240, %if.else238, %if.then292, %if.else290, %if.then201, %land.lhs.true204, %land.lhs.true209, %if.then212
  %306 = load i32, ptr @aflag, align 4, !tbaa !8
  %tobool296 = icmp ne i32 %306, 0
  %307 = load i32, ptr @lflag, align 4
  %tobool298 = icmp ne i32 %307, 0
...
for.end302:                                       ; preds = %if.end175
  %308 = load i32, ptr @lflag, align 4, !tbaa !8
  %tobool303.not = icmp eq i32 %308, 0
  br i1 %tobool303.not, label %land.lhs.true304, label %cleanup

land.lhs.true304:                                 ; preds = %for.end302
  %309 = load i32, ptr @aflag, align 4, !tbaa !8
  %tobool305 = icmp ne i32 %309, 0
...
return:                                           ; preds = %while.body.i64, %while.body.i58.i, %while.body.i50, %if.else26, %if.then20.i, %if.then15.i, %TeX_skip_parens.exit46.i, %if.then8.i, %TeX_skip_parens.exit.i, %if.then20, %if.then
  %retval.0 = phi i32 [ 0, %if.then ], [ 1, %if.then20 ], [ 0, %TeX_skip_parens.exit.i ], [ 0, %if.then8.i ], [ 0, %TeX_skip_parens.exit46.i ], [ 0, %if.then15.i ], [ 0, %if.then20.i ], [ 0, %if.else26 ], [ 1, %while.body.i50 ], [ 0, %while.body.i58.i ], [ 0, %while.body.i64 ]
  ret i32 %retval.0
}
