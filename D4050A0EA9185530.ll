...
sw.epilog61:                                      ; preds = %sw.bb45, %if.then54, %sw.bb37, %sw.bb10, %if.end, %while.body3
  %bsp.2 = phi ptr [ %bsp.184, %while.body3 ], [ %bsp.184, %sw.bb45 ], [ %incdec.ptr59, %if.then54 ], [ %bsp.184, %sw.bb37 ], [ %bsp.184, %sw.bb10 ], [ %bsp.184, %if.end ]
