...
378:                                              ; preds = %372
  ...
  %380 = add nsw i64 %379, 5
  %381 = add i64 %380, %321
  %382 = icmp uge i64 %381, %374
  %383 = icmp ult i64 %381, %375
  %384 = select i1 %382, i1 %383, i1 false
  %385 = icmp eq i8 %264, -24
  %386 = zext i8 %257 to i32
  %387 = icmp eq i8 %264, -23
  %388 = select i1 %387, i32 256, i32 257
  %389 = select i1 %385, i32 %386, i32 %388
  br i1 %384, label %410, label %492

390:                                              ; preds = %286
  %391 = icmp eq i8 %264, -24
  %392 = zext i8 %257 to i32
  %393 = icmp eq i8 %264, -23
  %394 = select i1 %393, i32 256, i32 257
  %395 = select i1 %391, i32 %392, i32 %394
  br i1 %46, label %396, label %399

396:                                              ; preds = %390
  %397 = zext i32 %316 to i64
  %398 = icmp ugt i64 %45, %397
  br i1 %398, label %410, label %492

399:                                              ; preds = %390
  %400 = add i8 %291, 1
  %401 = icmp ult i8 %400, 2
  br i1 %401, label %410, label %492
...
410:                                              ; preds = %378, %366, %369, %399, %396, %402
  %411 = phi i32 [ %395, %396 ], [ %409, %402 ], [ %395, %399 ], [ %365, %369 ], [ %365, %366 ], [ %389, %378 ]
  %412 = phi i1 [ %391, %396 ], [ %405, %402 ], [ %391, %399 ], [ %361, %369 ], [ %361, %366 ], [ %385, %378 ]
  %413 = phi i64 [ %258, %396 ], [ %373, %402 ], [ %258, %399 ], [ %355, %369 ], [ %355, %366 ], [ %373, %378 ]
  %414 = phi i64 [ %259, %396 ], [ %374, %402 ], [ %259, %399 ], [ %356, %369 ], [ %356, %366 ], [ %374, %378 ]
  %415 = phi i64 [ %260, %396 ], [ %375, %402 ], [ %260, %399 ], [ %357, %369 ], [ %357, %366 ], [ %375, %378 ]
...
492:                                              ; preds = %378, %366, %369, %399, %396, %402
  %493 = phi i32 [ %395, %396 ], [ %409, %402 ], [ %395, %399 ], [ %365, %369 ], [ %365, %366 ], [ %389, %378 ]
  %494 = phi i64 [ %258, %396 ], [ %373, %402 ], [ %258, %399 ], [ %355, %369 ], [ %355, %366 ], [ %373, %378 ]
  %495 = phi i64 [ %259, %396 ], [ %374, %402 ], [ %259, %399 ], [ %356, %369 ], [ %356, %366 ], [ %374, %378 ]
  %496 = phi i64 [ %260, %396 ], [ %375, %402 ], [ %260, %399 ], [ %357, %369 ], [ %357, %366 ], [ %375, %378 ]
...
645:                                              ; preds = %33, %26, %23, %20, %17, %8, %629
  %646 = phi i32 [ %574, %629 ], [ -2147024809, %8 ], [ -2147024882, %17 ], [ -2147024882, %20 ], [ -2147024882, %23 ], [ -2147024882, %26 ], [ -2147024882, %33 ]
  ret i32 %646
}
...
391:                                              ; preds = %168, %170, %277, %387, %269, %151, %131
