...
for.cond42.loopexit.loopexit.unr-lcssa:           ; preds = %while.body306, %while.body306.preheader
  %indvars.iv669.unr = phi i64 [ %conv285, %while.body306.preheader ], [ %indvars.iv.next670.3, %while.body306 ]
  %indvars.iv667.unr = phi i64 [ 0, %while.body306.preheader ], [ %indvars.iv.next668.3, %while.body306 ]
...
while.body306.epil:                               ; preds = %for.cond42.loopexit.loopexit.unr-lcssa, %while.body306.epil
  %indvars.iv669.epil = phi i64 [ %indvars.iv.next670.epil, %while.body306.epil ], [ %indvars.iv669.unr, %for.cond42.loopexit.loopexit.unr-lcssa ]
  ...
  %indvars.iv.next670.epil = add nuw nsw i64 %indvars.iv669.epil, 1
  %arrayidx310.epil = getelementptr inbounds i8, ptr %75, i64 %indvars.iv669.epil
  %76 = load i8, ptr %arrayidx310.epil, align 1, !tbaa !34
  %indvars.iv.next668.epil = add nuw nsw i64 %indvars.iv667.epil, 1
  %arrayidx314.epil = getelementptr inbounds i8, ptr %75, i64 %indvars.iv667.epil
...
for.cond42:                                       ; preds = %for.cond42.backedge, %invoke.cont40
  ...
  %cmp44624 = icmp eq i32 %bufferPos.0, 131072
  br i1 %cmp44624, label %for.end65, label %if.end46.lr.ph
...
if.end46:                                         ; preds = %if.end46.lr.ph, %cleanup61
  %add626 = phi i32 [ %bufferPos.0, %if.end46.lr.ph ], [ %add, %cleanup61 ]
  %processedSize.0625 = phi i32 [ 0, %if.end46.lr.ph ], [ %add60, %cleanup61 ]
  %sub = sub i32 131072, %add626
  %79 = load ptr, ptr %_buffer.i, align 8, !tbaa !5
  %add.ptr = getelementptr inbounds i8, ptr %79, i64 %idx.ext
  %idx.ext47 = zext i32 %processedSize.0625 to i64
...
cleanup61:                                        ; preds = %cleanup.cont
  %add60 = add i32 %82, %processedSize.0625
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %processedSizeLoc) #12
...
for.end65:                                        ; preds = %cleanup61, %cleanup.cont, %for.cond42
  %processedSize.0.lcssa = phi i32 [ 0, %for.cond42 ], [ %processedSize.0625, %cleanup.cont ], [ %add60, %cleanup61 ]
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %processedSizeLoc) #12
  %add66 = add i32 %processedSize.0.lcssa, %bufferPos.0
  %cmp67 = icmp ult i32 %add66, 5
  br i1 %cmp67, label %for.cond69.preheader, label %if.end108

for.cond69.preheader:                             ; preds = %for.end65
  %cmp70645.not = icmp eq i32 %add66, 0
  br i1 %cmp70645.not, label %for.end104, label %for.body71.lr.ph
...
for.body71:                                       ; preds = %for.body71.lr.ph, %cleanup98
  %indvars.iv675 = phi i64 [ 0, %for.body71.lr.ph ], [ %indvars.iv.next676, %cleanup98 ]
  %prevByte.1646 = phi i8 [ %prevByte.0, %for.body71.lr.ph ], [ %84, %cleanup98 ]
  %83 = load ptr, ptr %_buffer.i, align 8, !tbaa !5
  %arrayidx74 = getelementptr inbounds i8, ptr %83, i64 %indvars.iv675
...
if.then79:                                        ; preds = %invoke.cont77
  %conv80 = zext i8 %prevByte.1646 to i64
  br label %if.end92
...
if.else84:                                        ; preds = %invoke.cont77
  %cmp.i447 = icmp eq i8 %prevByte.1646, 15
  %90 = and i8 %84, -16
...
cleanup98:                                        ; preds = %if.then15.i, %if.end92, %if.else84
  ...
  %exitcond677.not = icmp eq i64 %indvars.iv.next676, %wide.trip.count
  br i1 %exitcond677.not, label %for.end104, label %for.body71, !llvm.loop !43
...
while.body:                                       ; preds = %if.end108, %cleanup279
  %bufferPos.2639 = phi i32 [ 0, %if.end108 ], [ %bufferPos.5, %cleanup279 ]
  %prevByte.3638 = phi i8 [ %prevByte.0, %if.end108 ], [ %prevByte.6, %cleanup279 ]
  %subStreamIndex.1637 = phi i64 [ %subStreamIndex.0, %if.end108 ], [ %subStreamIndex.8, %cleanup279 ]
  %subStreamStartPos.1636 = phi i64 [ %subStreamStartPos.0, %if.end108 ], [ %subStreamStartPos.8, %cleanup279 ]
  %subStreamEndPos.1635 = phi i64 [ %subStreamEndPos.0, %if.end108 ], [ %subStreamEndPos.8, %cleanup279 ]
  %96 = load ptr, ptr %_buffer.i, align 8, !tbaa !5
  %idxprom113 = zext i32 %bufferPos.2639 to i64
...
lor.rhs.i:                                        ; preds = %invoke.cont117
  %cmp.i.i = icmp eq i8 %prevByte.3638, 15
  %103 = and i8 %97, -16
...
if.then120:                                       ; preds = %lor.rhs.i
  %inc121 = add nuw i32 %bufferPos.2639, 1
...
if.end122:                                        ; preds = %invoke.cont117, %lor.rhs.i
  ...
  %add124 = add nuw i32 %bufferPos.2639, 4
  ...
  %add129 = add nuw i32 %bufferPos.2639, 3
  ...
  %add135 = add nuw i32 %bufferPos.2639, 2
  ...
  %add142 = add nuw i32 %bufferPos.2639, 1
  ...
  %add147 = add i32 %bufferPos.2639, %nowPos.0
...
if.then154:                                       ; preds = %if.end122
  ...
  %cmp158.not628 = icmp ult i64 %subStreamEndPos.1635, %add156
  br i1 %cmp158.not628, label %while.body159, label %if.else200

while.body159:                                    ; preds = %if.then154, %cleanup181
  %subStreamIndex.2630 = phi i64 [ %inc170, %cleanup181 ], [ %subStreamIndex.1637, %if.then154 ]
  %subStreamEndPos.2629 = phi i64 [ %add169, %cleanup181 ], [ %subStreamEndPos.1635, %if.then154 ]
  ...
  %call166 = invoke noundef i32 %114(ptr noundef nonnull align 8 dereferenceable(8) %113, i64 noundef %subStreamIndex.2630, ptr noundef nonnull %subStreamSize)
...
cleanup181:                                       ; preds = %invoke.cont165
  ...
  %add169 = add i64 %117, %subStreamEndPos.2629
  %inc170 = add i64 %subStreamIndex.2630, 1
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %subStreamSize) #12
...
while.end:                                        ; preds = %cleanup181, %cleanup181.thread
  %subStreamIndex.4687 = phi i64 [ %subStreamIndex.2630, %cleanup181.thread ], [ %inc170, %cleanup181 ]
  %subStreamStartPos.4686 = phi i64 [ 0, %cleanup181.thread ], [ %subStreamEndPos.2629, %cleanup181 ]
  %subStreamEndPos.4685 = phi i64 [ -1, %cleanup181.thread ], [ %add169, %cleanup181 ]
...
if.then191:                                       ; preds = %while.end
  %cmp.i467717 = icmp eq i8 %97, -24
  %conv1.i718 = zext i8 %prevByte.3638 to i32
  %cmp3.i719 = icmp eq i8 %97, -23
  %cond.i720 = select i1 %cmp3.i719, i32 256, i32 257
  %cond4.i721 = select i1 %cmp.i467717, i32 %conv1.i718, i32 %cond.i720
...
if.else200:                                       ; preds = %if.then154, %while.end
  %subStreamIndex.2.lcssa697 = phi i64 [ %subStreamIndex.4687, %while.end ], [ %subStreamIndex.1637, %if.then154 ]
  %subStreamStartPos.2.lcssa695 = phi i64 [ %subStreamStartPos.4686, %while.end ], [ %subStreamStartPos.1636, %if.then154 ]
  %subStreamEndPos.2.lcssa693 = phi i64 [ %subStreamEndPos.4685, %while.end ], [ %subStreamEndPos.1635, %if.then154 ]
  %sub201 = sub i64 %subStreamEndPos.2.lcssa693, %subStreamStartPos.2.lcssa695
...
if.then203:                                       ; preds = %if.else200
  ...
  %cmp.i467727 = icmp eq i8 %97, -24
  %conv1.i728 = zext i8 %prevByte.3638 to i32
  %cmp3.i729 = icmp eq i8 %97, -23
  %cond.i730 = select i1 %cmp3.i729, i32 256, i32 257
  %cond4.i731 = select i1 %cmp.i467727, i32 %conv1.i728, i32 %cond.i730
  br i1 %121, label %if.then237, label %if.else262

if.else220:                                       ; preds = %if.end122
  %cmp.i467698 = icmp eq i8 %97, -24
  %conv1.i699 = zext i8 %prevByte.3638 to i32
  %cmp3.i700 = icmp eq i8 %97, -23
  %cond.i701 = select i1 %cmp3.i700, i32 256, i32 257
  %cond4.i702 = select i1 %cmp.i467698, i32 %conv1.i699, i32 %cond.i701
...
if.end231:                                        ; preds = %if.else200
  ...
  %cmp211 = icmp uge i64 %add210, %subStreamStartPos.2.lcssa695
  %cmp212 = icmp ult i64 %add210, %subStreamEndPos.2.lcssa693
  %124 = and i1 %cmp212, %cmp211
  %cmp.i467 = icmp eq i8 %97, -24
  %conv1.i = zext i8 %prevByte.3638 to i32
...
if.then237:                                       ; preds = %if.then203, %if.else195, %if.then192, %if.else226, %if.then222, %if.end231
  %cond4.i710 = phi i32 [ %cond4.i702, %if.then222 ], [ %cond4.i, %if.end231 ], [ %cond4.i702, %if.else226 ], [ %cond4.i721, %if.then192 ], [ %cond4.i721, %if.else195 ], [ %cond4.i731, %if.then203 ]
  %cmp.i467709 = phi i1 [ %cmp.i467698, %if.then222 ], [ %cmp.i467, %if.end231 ], [ %cmp.i467698, %if.else226 ], [ %cmp.i467717, %if.then192 ], [ %cmp.i467717, %if.else195 ], [ %cmp.i467727, %if.then203 ]
  %subStreamIndex.6708 = phi i64 [ %subStreamIndex.1637, %if.then222 ], [ %subStreamIndex.2.lcssa697, %if.end231 ], [ %subStreamIndex.1637, %if.else226 ], [ %subStreamIndex.4687, %if.then192 ], [ %subStreamIndex.4687, %if.else195 ], [ %subStreamIndex.2.lcssa697, %if.then203 ]
  %subStreamStartPos.6706 = phi i64 [ %subStreamStartPos.1636, %if.then222 ], [ %subStreamStartPos.2.lcssa695, %if.end231 ], [ %subStreamStartPos.1636, %if.else226 ], [ %subStreamStartPos.4686, %if.then192 ], [ %subStreamStartPos.4686, %if.else195 ], [ %subStreamStartPos.2.lcssa695, %if.then203 ]
  %subStreamEndPos.6704 = phi i64 [ %subStreamEndPos.1635, %if.then222 ], [ %subStreamEndPos.2.lcssa693, %if.end231 ], [ %subStreamEndPos.1635, %if.else226 ], [ %subStreamEndPos.4685, %if.then192 ], [ %subStreamEndPos.4685, %if.else195 ], [ %subStreamEndPos.2.lcssa693, %if.then203 ]
  %idxprom239 = zext i32 %cond4.i710 to i64
...
invoke.cont242:                                   ; preds = %if.then237, %if.then15.i475
  %add243 = add nuw i32 %bufferPos.2639, 5
  %cond-lvalue = select i1 %cmp.i467709, ptr %_callStream.i, ptr %_jumpStream.i
...
for.inc256:                                       ; preds = %if.then.i484.for.inc256_crit_edge, %invoke.cont242
  %133 = phi i32 [ %.pre678, %if.then.i484.for.inc256_crit_edge ], [ %130, %invoke.cont242 ]
...
if.then.i484.1.for.inc256.1_crit_edge:            ; preds = %if.then.i484.1
  %.pre679 = load i32, ptr %_pos.i478, align 8, !tbaa !41
  br label %for.inc256.1

for.inc256.1:                                     ; preds = %if.then.i484.1.for.inc256.1_crit_edge, %for.inc256
  %137 = phi i32 [ %.pre679, %if.then.i484.1.for.inc256.1_crit_edge ], [ %135, %for.inc256 ]
...
if.then.i484.2.for.inc256.2_crit_edge:            ; preds = %if.then.i484.2
  %.pre680 = load i32, ptr %_pos.i478, align 8, !tbaa !41
  br label %for.inc256.2

for.inc256.2:                                     ; preds = %if.then.i484.2.for.inc256.2_crit_edge, %for.inc256.1
  %141 = phi i32 [ %.pre680, %if.then.i484.2.for.inc256.2_crit_edge ], [ %139, %for.inc256.1 ]
...
if.else262:                                       ; preds = %if.then203, %if.else195, %if.then192, %if.else226, %if.then222, %if.end231
  %cond4.i711 = phi i32 [ %cond4.i702, %if.then222 ], [ %cond4.i, %if.end231 ], [ %cond4.i702, %if.else226 ], [ %cond4.i721, %if.then192 ], [ %cond4.i721, %if.else195 ], [ %cond4.i731, %if.then203 ]
  %subStreamIndex.6707 = phi i64 [ %subStreamIndex.1637, %if.then222 ], [ %subStreamIndex.2.lcssa697, %if.end231 ], [ %subStreamIndex.1637, %if.else226 ], [ %subStreamIndex.4687, %if.then192 ], [ %subStreamIndex.4687, %if.else195 ], [ %subStreamIndex.2.lcssa697, %if.then203 ]
  %subStreamStartPos.6705 = phi i64 [ %subStreamStartPos.1636, %if.then222 ], [ %subStreamStartPos.2.lcssa695, %if.end231 ], [ %subStreamStartPos.1636, %if.else226 ], [ %subStreamStartPos.4686, %if.then192 ], [ %subStreamStartPos.4686, %if.else195 ], [ %subStreamStartPos.2.lcssa695, %if.then203 ]
  %subStreamEndPos.6703 = phi i64 [ %subStreamEndPos.1635, %if.then222 ], [ %subStreamEndPos.2.lcssa693, %if.end231 ], [ %subStreamEndPos.1635, %if.else226 ], [ %subStreamEndPos.4685, %if.then192 ], [ %subStreamEndPos.4685, %if.else195 ], [ %subStreamEndPos.2.lcssa693, %if.then203 ]
  %idxprom264 = zext i32 %cond4.i711 to i64
...
cleanup279:                                       ; preds = %for.inc256.2, %if.then.i484.3, %if.then15.i498, %if.else262, %if.then120
  %subStreamEndPos.8 = phi i64 [ %subStreamEndPos.1635, %if.then120 ], [ %subStreamEndPos.6703, %if.then15.i498 ], [ %subStreamEndPos.6703, %if.else262 ], [ %subStreamEndPos.6704, %if.then.i484.3 ], [ %subStreamEndPos.6704, %for.inc256.2 ]
  %subStreamStartPos.8 = phi i64 [ %subStreamStartPos.1636, %if.then120 ], [ %subStreamStartPos.6705, %if.then15.i498 ], [ %subStreamStartPos.6705, %if.else262 ], [ %subStreamStartPos.6706, %if.then.i484.3 ], [ %subStreamStartPos.6706, %for.inc256.2 ]
  %subStreamIndex.8 = phi i64 [ %subStreamIndex.1637, %if.then120 ], [ %subStreamIndex.6707, %if.then15.i498 ], [ %subStreamIndex.6707, %if.else262 ], [ %subStreamIndex.6708, %if.then.i484.3 ], [ %subStreamIndex.6708, %for.inc256.2 ]
...
if.end302:                                        ; preds = %invoke.cont293, %while.end283
  %cmp305641 = icmp ugt i32 %add66, %bufferPos.5
  br i1 %cmp305641, label %while.body306.preheader, label %for.cond42.backedge
...
while.body306:                                    ; preds = %while.body306, %while.body306.preheader.new
  %indvars.iv669 = phi i64 [ %conv285, %while.body306.preheader.new ], [ %indvars.iv.next670.3, %while.body306 ]
  %indvars.iv667 = phi i64 [ 0, %while.body306.preheader.new ], [ %indvars.iv.next668.3, %while.body306 ]
  ...
  %arrayidx310 = getelementptr inbounds i8, ptr %156, i64 %indvars.iv669
  %157 = load i8, ptr %arrayidx310, align 1, !tbaa !34
  %indvars.iv.next668 = or i64 %indvars.iv667, 1
  %arrayidx314 = getelementptr inbounds i8, ptr %156, i64 %indvars.iv667
  store i8 %157, ptr %arrayidx314, align 1, !tbaa !34
  %158 = load ptr, ptr %_buffer.i, align 8, !tbaa !5
  %indvars.iv.next670.1 = add nuw nsw i64 %indvars.iv669, 2
  %arrayidx310.1 = getelementptr inbounds i8, ptr %158, i64 %indvars.iv.next670
  %159 = load i8, ptr %arrayidx310.1, align 1, !tbaa !34
  %indvars.iv.next668.1 = or i64 %indvars.iv667, 2
  %arrayidx314.1 = getelementptr inbounds i8, ptr %158, i64 %indvars.iv.next668
  store i8 %159, ptr %arrayidx314.1, align 1, !tbaa !34
  %160 = load ptr, ptr %_buffer.i, align 8, !tbaa !5
  %indvars.iv.next670.2 = add nuw nsw i64 %indvars.iv669, 3
  %arrayidx310.2 = getelementptr inbounds i8, ptr %160, i64 %indvars.iv.next670.1
  %161 = load i8, ptr %arrayidx310.2, align 1, !tbaa !34
  %indvars.iv.next668.2 = or i64 %indvars.iv667, 3
  %arrayidx314.2 = getelementptr inbounds i8, ptr %160, i64 %indvars.iv.next668.1
  store i8 %161, ptr %arrayidx314.2, align 1, !tbaa !34
  %162 = load ptr, ptr %_buffer.i, align 8, !tbaa !5
  %indvars.iv.next670.3 = add nuw nsw i64 %indvars.iv669, 4
  %arrayidx310.3 = getelementptr inbounds i8, ptr %162, i64 %indvars.iv.next670.2
  %163 = load i8, ptr %arrayidx310.3, align 1, !tbaa !34
  %indvars.iv.next668.3 = add nuw nsw i64 %indvars.iv667, 4
  %arrayidx314.3 = getelementptr inbounds i8, ptr %162, i64 %indvars.iv.next668.2
