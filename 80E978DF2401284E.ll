...
for.body:                                         ; preds = %for.body.lr.ph, %for.body
  ...
  %m_lifeTime = getelementptr inbounds %class.btPersistentManifold, ptr %this, i64 0, i32 2, i64 %indvars.iv, i32 19
...
for.body16:                                       ; preds = %for.body16.lr.ph, %if.end44
  %indvars.iv174 = phi i64 [ %2, %for.body16.lr.ph ], [ %indvars.iv.next175, %if.end44 ]
  %arrayidx20 = getelementptr inbounds %class.btPersistentManifold, ptr %this, i64 0, i32 2, i64 %indvars.iv174
  %m_distance1.i = getelementptr inbounds %class.btPersistentManifold, ptr %this, i64 0, i32 2, i64 %indvars.iv174, i32 5
...
if.then:                                          ; preds = %for.body16
  %m_userPersistentData.i.i = getelementptr inbounds %class.btPersistentManifold, ptr %this, i64 0, i32 2, i64 %indvars.iv174, i32 13
...
_ZN20btPersistentManifold14clearUserCacheER15btManifoldPoint.exit.i: ; preds = %if.then5.i.i, %if.then.i.i, %if.then
  ...
  %80 = zext i32 %sub.i100 to i64
  %cmp.not.i = icmp eq i64 %indvars.iv174, %80
...
if.else:                                          ; preds = %for.body16
  %m_positionWorldOnA23 = getelementptr inbounds %class.btPersistentManifold, ptr %this, i64 0, i32 2, i64 %indvars.iv174, i32 3
  %m_normalWorldOnB25 = getelementptr inbounds %class.btPersistentManifold, ptr %this, i64 0, i32 2, i64 %indvars.iv174, i32 4
  ...
  %m_positionWorldOnB32 = getelementptr inbounds %class.btPersistentManifold, ptr %this, i64 0, i32 2, i64 %indvars.iv174, i32 2
...
if.then39:                                        ; preds = %if.else
  %m_userPersistentData.i.i140 = getelementptr inbounds %class.btPersistentManifold, ptr %this, i64 0, i32 2, i64 %indvars.iv174, i32 13
...
_ZN20btPersistentManifold14clearUserCacheER15btManifoldPoint.exit.i149: ; preds = %if.then5.i.i145, %if.then.i.i143, %if.then39
  ...
  %95 = zext i32 %sub.i147 to i64
  %cmp.not.i148 = icmp eq i64 %indvars.iv174, %95
...
if.end44:                                         ; preds = %_ZN20btPersistentManifold18removeContactPointEi.exit162, %if.then41, %if.else40, %_ZN20btPersistentManifold18removeContactPointEi.exit
  ...
  %cmp15 = icmp sgt i64 %indvars.iv174, 0
