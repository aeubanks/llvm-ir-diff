; ModuleID = '/usr/local/google/home/aeubanks/repos/test-suite/SingleSource/Regression/C/gcc-c-torture/execute/pr22141-1.c'
source_filename = "/usr/local/google/home/aeubanks/repos/test-suite/SingleSource/Regression/C/gcc-c-torture/execute/pr22141-1.c"
...
entry:
  store <4 x i8> <i8 1, i8 2, i8 3, i8 4>, ptr @u, align 4
  ret void
}
...
entry:
  store <4 x i8> <i8 1, i8 2, i8 3, i8 4>, ptr @u, align 4, !tbaa !12
  ret void
}
...
entry:
  ...
  store <4 x i8> <i8 1, i8 2, i8 3, i8 4>, ptr %v, align 4, !tbaa !12
