...
do.body.i22:                                      ; preds = %if.end75.i, %sw.bb20.do.body_crit_edge.i
  ...
  %49 = inttoptr i64 %srcp1.addr.0.i21 to ptr
...
if.then38.i:                                      ; preds = %do.body.i22
  ...
  %50 = ptrtoint ptr %a.addr.i.i10 to i64
  %51 = ptrtoint ptr %b.addr.i.i11 to i64
  br label %do.body.i.i28

do.body.i.i28:                                    ; preds = %do.body.i.i28, %if.then38.i
  %srcp2.0.i.i23 = phi i64 [ %51, %if.then38.i ], [ %add3.i.i26, %do.body.i.i28 ]
  %srcp1.0.i.i24 = phi i64 [ %50, %if.then38.i ], [ %add.i.i25, %do.body.i.i28 ]
  %52 = inttoptr i64 %srcp1.0.i.i24 to ptr
  %53 = load i8, ptr %52, align 1, !tbaa !9
  %54 = inttoptr i64 %srcp2.0.i.i23 to ptr
  %55 = load i8, ptr %54, align 1, !tbaa !9
  %add.i.i25 = add nsw i64 %srcp1.0.i.i24, 1
  %add3.i.i26 = add nsw i64 %srcp2.0.i.i23, 1
  %cmp.i.i27 = icmp eq i8 %53, %55
  br i1 %cmp.i.i27, label %do.body.i.i28, label %mymemcmp1.exit.i32, !llvm.loop !10

mymemcmp1.exit.i32:                               ; preds = %do.body.i.i28
  %conv2.i.i29 = zext i8 %55 to i32
...
do3.i42:                                          ; preds = %do.body.i22, %if.end.i
  %sh_prom44.pre-phi.i = phi i64 [ %sh_prom34.pre-phi.i, %do.body.i22 ], [ %.pre233.i, %if.end.i ]
  %sh_prom42.pre-phi.i = phi i64 [ %sh_prom.pre-phi.i, %do.body.i22 ], [ %.pre232.i, %if.end.i ]
  %.pre-phi.i33 = phi ptr [ %49, %do.body.i22 ], [ %.pre.i18, %if.end.i ]
  ...
  %a0.0.in.i36 = phi ptr [ %49, %do.body.i22 ], [ %arrayidx17.i, %if.end.i ]
  %a3.1.i = phi i64 [ %a3.0.i, %do.body.i22 ], [ %44, %if.end.i ]
...
do.body.i173.i:                                   ; preds = %do.body.i173.i, %if.then49.i43
  %srcp2.0.i168.i = phi i64 [ %57, %if.then49.i43 ], [ %add3.i171.i, %do.body.i173.i ]
  %srcp1.0.i169.i = phi i64 [ %56, %if.then49.i43 ], [ %add.i170.i, %do.body.i173.i ]
...
do2.i50:                                          ; preds = %do3.i42, %sw.bb8.i
  %sh_prom56.pre-phi.i = phi i64 [ %sh_prom44.pre-phi.i, %do3.i42 ], [ %.pre238.i, %sw.bb8.i ]
  %sh_prom54.pre-phi.i = phi i64 [ %sh_prom42.pre-phi.i, %do3.i42 ], [ %.pre237.i, %sw.bb8.i ]
  %.pre-phi236.i = phi ptr [ %b0.0.in.i38, %do3.i42 ], [ %.pre235.i, %sw.bb8.i ]
  ...
  %a0.1.i46 = phi i64 [ %a0.0.i40, %do3.i42 ], [ %42, %sw.bb8.i ]
  %.pn.i = phi ptr [ %.pre-phi.i33, %do3.i42 ], [ %41, %sw.bb8.i ]
  ...
  %shr55.i = lshr i64 %a0.1.i46, %sh_prom54.pre-phi.i
...
do1.i55:                                          ; preds = %do2.i50, %sw.bb.i16
  ...
  %a1.1.i53 = phi i64 [ %a1.0.i49, %do2.i50 ], [ %40, %sw.bb.i16 ]
  ...
  %shr67.i = lshr i64 %a1.1.i53, %sh_prom66.i
