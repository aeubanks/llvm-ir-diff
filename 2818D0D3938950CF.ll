...
if.end81.sink.split:                              ; preds = %if.then67, %if.then75
  %.sink326 = phi ptr [ %31, %if.then75 ], [ %39, %if.then67 ]
  %.sink325 = phi i32 [ 0, %if.then75 ], [ %call68, %if.then67 ]
  %arrayidx79 = getelementptr inbounds %struct.img_par, ptr %.sink326, i64 0, i32 61, i64 1
  store i32 %.sink325, ptr %arrayidx79, align 4, !tbaa !19
  br label %if.end81

if.end81:                                         ; preds = %if.end81.sink.split, %if.end54, %if.then59, %land.lhs.true64
  %40 = phi ptr [ %31, %if.end54 ], [ %35, %if.then59 ], [ %35, %land.lhs.true64 ], [ %.sink326, %if.end81.sink.split ]
...
if.then87:                                        ; preds = %if.end85
  ...
  %.pre318 = load i32, ptr %type92.phi.trans.insert, align 4, !tbaa !28
  br label %if.end89

if.end89:                                         ; preds = %if.then87, %if.end85
  %47 = phi i32 [ %.pre318, %if.then87 ], [ %45, %if.end85 ]
...
if.then99.if.end114_crit_edge:                    ; preds = %if.then99
  %.pre319 = load ptr, ptr @img, align 8, !tbaa !7
  br label %if.end114
...
if.end114:                                        ; preds = %if.then99.if.end114_crit_edge, %if.end89, %if.then108, %if.then102
  %55 = phi ptr [ %.pre319, %if.then99.if.end114_crit_edge ], [ %48, %if.end89 ], [ %54, %if.then108 ], [ %52, %if.then102 ]
...
lor.end.thread:                                   ; preds = %land.lhs.true121, %land.lhs.true121
  %apply_weights317 = getelementptr inbounds %struct.img_par, ptr %70, i64 0, i32 82
  store i32 1, ptr %apply_weights317, align 8, !tbaa !67
...
land.lhs.true134.lor.lhs.false140_crit_edge:      ; preds = %land.lhs.true134
  ...
  %.pre320 = load i32, ptr %weighted_bipred_idc141.phi.trans.insert, align 4, !tbaa !66
  br label %lor.lhs.false140

lor.lhs.false140:                                 ; preds = %land.lhs.true134.lor.lhs.false140_crit_edge, %lor.end
  %81 = phi i32 [ %.pre320, %land.lhs.true134.lor.lhs.false140_crit_edge ], [ %77, %lor.end ]
...
land.lhs.true152:                                 ; preds = %if.end150
  %type153 = getelementptr inbounds %struct.img_par, ptr %.pre321, i64 0, i32 10
...
if.end162:                                        ; preds = %land.lhs.true152, %land.lhs.true152, %if.end150, %if.then158
  %.sink328 = phi ptr [ %191, %if.then158 ], [ %.pre321, %land.lhs.true152 ], [ %.pre321, %land.lhs.true152 ], [ %.pre321, %if.end150 ]
  %.sink327 = phi i32 [ %call159, %if.then158 ], [ 0, %land.lhs.true152 ], [ 0, %land.lhs.true152 ], [ 0, %if.end150 ]
  %model_number161 = getelementptr inbounds %struct.img_par, ptr %.sink328, i64 0, i32 99
  store i32 %.sink327, ptr %model_number161, align 4, !tbaa !79
...
if.then172:                                       ; preds = %if.end162
  ...
  %.pre322 = load ptr, ptr @img, align 8, !tbaa !7
  br label %if.end173

if.end173:                                        ; preds = %if.end162, %if.then172
  %196 = phi ptr [ %194, %if.end162 ], [ %.pre322, %if.then172 ]
  ...
  switch i32 %197, label %if.end195 [
    i32 3, label %if.then182
    i32 4, label %if.end184
  ]
...
if.end184:                                        ; preds = %if.end173, %if.then182
  ...
  %or.cond314 = icmp ugt i32 %add187, 51
  br i1 %or.cond314, label %if.then193, label %if.end195
...
land.lhs.true215:                                 ; preds = %if.end213
  ...
  %207 = add i32 %206, -3
  %or.cond315 = icmp ult i32 %207, 3
  br i1 %or.cond315, label %if.then220, label %if.end239
...
if.then167:                                       ; preds = %if.end164
  ...
  %add171.add177 = tail call i32 @llvm.smin.i32(i32 %add171, i32 %add177)
  br label %if.end210
...
if.end210:                                        ; preds = %if.then193, %if.else200, %if.then167
  %add197.sink = phi i32 [ %add197, %if.then193 ], [ %add206, %if.else200 ], [ %add171.add177, %if.then167 ]
