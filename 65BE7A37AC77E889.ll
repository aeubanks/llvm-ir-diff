...
define dso_local void @foo(i32 noundef %0) local_unnamed_addr #0 {
  %2 = icmp ne i32 %0, 2
  %3 = zext i1 %2 to i8
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(64) @buf, i8 %3, i64 64, i1 false)
  ret void
}
...
define dso_local i32 @main() local_unnamed_addr #2 {
  ...
  %1 = load <64 x i8>, ptr @buf, align 64
  %2 = freeze <64 x i8> %1
  %3 = icmp ne <64 x i8> %2, zeroinitializer
