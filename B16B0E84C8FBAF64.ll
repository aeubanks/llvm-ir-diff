...
10:                                               ; preds = %24
  %11 = add nuw i32 %15, 1
  %12 = icmp eq i32 %15, %0
  br i1 %12, label %31, label %13, !llvm.loop !5

13:                                               ; preds = %5, %10
  %14 = phi ptr [ %9, %5 ], [ %25, %10 ]
  %15 = phi i32 [ 2, %5 ], [ %11, %10 ]
...
31:                                               ; preds = %10, %1
  %32 = phi i32 [ %4, %1 ], [ %26, %10 ]
  %33 = icmp ult i32 %32, 41
  br i1 %33, label %34, label %40

34:                                               ; preds = %31
  %35 = getelementptr inbounds %struct.__va_list_tag, ptr %2, i64 0, i32 3
...
40:                                               ; preds = %31
  %41 = getelementptr inbounds %struct.__va_list_tag, ptr %2, i64 0, i32 2
...
44:                                               ; preds = %40, %34
  %45 = phi i32 [ %39, %34 ], [ %32, %40 ]
  %46 = phi ptr [ %38, %34 ], [ %42, %40 ]
  %47 = load i64, ptr %46, align 8
  %48 = icmp eq i64 %47, 81985529216486895
...
50:                                               ; preds = %44
  %51 = icmp ult i32 %45, 41
  br i1 %51, label %52, label %58

52:                                               ; preds = %50
  %53 = getelementptr inbounds %struct.__va_list_tag, ptr %2, i64 0, i32 3
  %54 = load ptr, ptr %53, align 16
  %55 = zext i32 %45 to i64
  %56 = getelementptr i8, ptr %54, i64 %55
  %57 = add nuw nsw i32 %45, 8
  store i32 %57, ptr %2, align 16
  br label %62

58:                                               ; preds = %50
  %59 = getelementptr inbounds %struct.__va_list_tag, ptr %2, i64 0, i32 2
