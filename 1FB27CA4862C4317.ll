...
43:                                               ; preds = %74, %41
  %44 = phi i32 [ %75, %74 ], [ 0, %41 ]
  %45 = phi i32 [ %76, %74 ], [ 2, %41 ]
  %46 = lshr i32 %45, 5
...
69:                                               ; preds = %59
  %70 = xor i32 %64, %66
  store i32 %70, ptr %63, align 4, !tbaa !5
  br label %71

71:                                               ; preds = %69, %59
  %72 = add nuw nsw i32 %60, %45
  %73 = icmp ugt i32 %72, 20480000
  br i1 %73, label %74, label %59, !llvm.loop !9
...
80:                                               ; preds = %111, %78
  %81 = phi i32 [ %112, %111 ], [ 0, %78 ]
  %82 = phi i32 [ %113, %111 ], [ 2, %78 ]
  %83 = lshr i32 %82, 5
...
106:                                              ; preds = %96
  %107 = xor i32 %101, %103
  store i32 %107, ptr %100, align 4, !tbaa !5
  br label %108

108:                                              ; preds = %106, %96
  %109 = add nuw nsw i32 %97, %82
  %110 = icmp ugt i32 %109, 10240000
  br i1 %110, label %111, label %96, !llvm.loop !9

111:                                              ; preds = %108, %91, %80
  %112 = phi i32 [ %81, %80 ], [ %92, %91 ], [ %92, %108 ]
  %113 = add nuw nsw i32 %82, 1
  %114 = icmp eq i32 %113, 10240001
  br i1 %114, label %115, label %80, !llvm.loop !11
