...
entry:
  ...
  call fastcc void @b(ptr noundef nonnull %a)
...
; Function Attrs: nounwind uwtable
define internal fastcc void @b(ptr nocapture noundef writeonly %x) unnamed_addr #0 {
entry:
  %call = call i32 @_setjmp(ptr noundef nonnull @g) #6
