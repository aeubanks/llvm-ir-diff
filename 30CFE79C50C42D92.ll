...
define dso_local noalias nonnull ptr @errorp(i32 noundef %0, ptr nocapture noundef readonly %1, ptr nocapture noundef readonly %2) local_unnamed_addr #0 {
  %4 = load ptr, ptr @stderr, align 8, !tbaa !5
  %5 = tail call i32 @fputs(ptr noundef %1, ptr noundef %4) #4
  %6 = load ptr, ptr @stderr, align 8, !tbaa !5
  %7 = tail call i64 @fwrite(ptr nonnull @.str, i64 2, i64 1, ptr %6) #4
  %8 = load ptr, ptr @stderr, align 8, !tbaa !5
  %9 = tail call i32 @fputs(ptr noundef %2, ptr noundef %8) #4
