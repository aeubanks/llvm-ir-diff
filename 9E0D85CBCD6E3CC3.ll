; ModuleID = '/usr/local/google/home/aeubanks/repos/test-suite/MultiSource/Benchmarks/mediabench/gsm/toast/toast_alaw.c'
source_filename = "/usr/local/google/home/aeubanks/repos/test-suite/MultiSource/Benchmarks/mediabench/gsm/toast/toast_alaw.c"
...
define dso_local i32 @alaw_input(ptr nocapture noundef writeonly %buf) local_unnamed_addr #0 {
entry:
  br label %land.rhs
...
land.rhs:                                         ; preds = %entry, %for.body
  ...
  br i1 %cmp1.not, label %land.lhs.true, label %for.body

for.body:                                         ; preds = %land.rhs
  %1 = and i32 %call, 255
  %idxprom = zext i32 %1 to i64
  %arrayidx = getelementptr inbounds [256 x i16], ptr @a2s, i64 0, i64 %idxprom
  %2 = load i16, ptr %arrayidx, align 2, !tbaa !9
  %arrayidx3 = getelementptr inbounds i16, ptr %buf, i64 %indvars.iv
  store i16 %2, ptr %arrayidx3, align 2, !tbaa !9
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, 160
  br i1 %exitcond.not, label %if.end, label %land.rhs, !llvm.loop !11

land.lhs.true:                                    ; preds = %land.rhs
  %3 = trunc i64 %indvars.iv to i32
  %4 = load ptr, ptr @in, align 8, !tbaa !5
  %call6 = tail call i32 @ferror(ptr noundef %4) #3
  %tobool.not = icmp eq i32 %call6, 0
  br i1 %tobool.not, label %if.end, label %cleanup

if.end:                                           ; preds = %for.body, %land.lhs.true
  %i.015 = phi i32 [ %3, %land.lhs.true ], [ 160, %for.body ]
  br label %cleanup

cleanup:                                          ; preds = %land.lhs.true, %if.end
  %retval.0 = phi i32 [ %i.015, %if.end ], [ -1, %land.lhs.true ]
  ret i32 %retval.0
}
...
; Function Attrs: nofree nounwind uwtable
define dso_local i32 @alaw_output(ptr nocapture noundef readonly %buf) local_unnamed_addr #0 {
entry:
  br label %for.body

for.body:                                         ; preds = %entry, %for.inc
  %i.07 = phi i32 [ 0, %entry ], [ %inc, %for.inc ]
  %buf.addr.06 = phi ptr [ %buf, %entry ], [ %incdec.ptr, %for.inc ]
  %0 = load i16, ptr %buf.addr.06, align 2, !tbaa !9
  %1 = lshr i16 %0, 4
  %idxprom = zext i16 %1 to i64
  %arrayidx = getelementptr inbounds [4096 x i8], ptr @s2a, i64 0, i64 %idxprom
  %2 = load i8, ptr %arrayidx, align 1, !tbaa !13
  %conv1 = zext i8 %2 to i32
  %3 = load ptr, ptr @out, align 8, !tbaa !5
  %call = tail call i32 @fputc(i32 noundef %conv1, ptr noundef %3)
  %cmp2 = icmp eq i32 %call, -1
  br i1 %cmp2, label %cleanup, label %for.inc

for.inc:                                          ; preds = %for.body
  %inc = add nuw nsw i32 %i.07, 1
  %incdec.ptr = getelementptr inbounds i16, ptr %buf.addr.06, i64 1
...
cleanup:                                          ; preds = %for.inc, %for.body
  %retval.0 = phi i32 [ -1, %for.body ], [ 0, %for.inc ]
  ret i32 %retval.0
}
