...
"for k$3.s0.n1":                                  ; preds = %"assert succeeded77"
  ...
  %wide.vec495 = load <32 x float>, ptr %"inv_X8$7.117", align 16, !tbaa !32
  ...
  store <32 x float> %interleaved.vec504, ptr %"inv_fft0_S1_R8_n0$3.119", align 16, !tbaa !36
...
"for result$3.s0.i.preheader":                    ; preds = %"for k$3.s0.n1"
  ...
  %invariant.gep551 = getelementptr float, ptr %"inv_fft0_S1_R8_n0$3.119", i64 -7
...
"for result$3.s0.i":                              ; preds = %"for result$3.s0.i.preheader", %"end for result$3.s0.n1"
  %indvars.iv459 = phi i64 [ %746, %"for result$3.s0.i.preheader" ], [ %indvars.iv.next460, %"end for result$3.s0.n1" ]
...
vector.body510:                                   ; preds = %"assert succeeded83", %vector.body510
  ...
  br i1 %1242, label %"for inv_fft1_S1_R8_n1$3.s1.n0.g.preheader", label %vector.body510, !llvm.loop !190
...
"for inv_fft1_S1_R8_n1$3.s1.n0.g.preheader":      ; preds = %vector.body510
  ...
  store <4 x float> %1356, ptr %"inv_X8$7.117", align 16, !tbaa !200
...
"for result$3.s0.n1":                             ; preds = %"for result$3.s0.n1.preheader", %"end for result$3.s0.n0.n091"
  %indvars.iv456 = phi i64 [ %745, %"for result$3.s0.n1.preheader" ], [ %indvars.iv.next457, %"end for result$3.s0.n0.n091" ]
...
"for result$3.s0.n0.n0":                          ; preds = %"for result$3.s0.n0.n0.preheader", %"for result$3.s0.n0.n0"
  %indvars.iv453 = phi i64 [ %indvars.iv.next454.1, %"for result$3.s0.n0.n0" ], [ 0, %"for result$3.s0.n0.n0.preheader" ]
...
"end for result$3.s0.n0.n0.loopexit.unr-lcssa":   ; preds = %"for result$3.s0.n0.n0", %"for result$3.s0.n0.n0.preheader"
  %indvars.iv453.unr = phi i64 [ 0, %"for result$3.s0.n0.n0.preheader" ], [ %indvars.iv.next454.1, %"for result$3.s0.n0.n0" ]
