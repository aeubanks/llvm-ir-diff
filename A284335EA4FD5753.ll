...
entry:
  %0 = load i32, ptr @table, align 16, !tbaa !5
  %1 = load i32, ptr getelementptr inbounds ([4 x i32], ptr @table, i64 0, i64 1), align 4, !tbaa !5
  %2 = load i32, ptr getelementptr inbounds ([4 x i32], ptr @table, i64 0, i64 2), align 8, !tbaa !5
  %3 = load i32, ptr getelementptr inbounds ([4 x i32], ptr @table, i64 0, i64 3), align 4, !tbaa !5
  ...
  %4 = load i32, ptr getelementptr inbounds ([4 x i32], ptr @table, i64 0, i64 1), align 4, !tbaa !5
  ret i32 %4
}
