; ModuleID = '/usr/local/google/home/aeubanks/repos/test-suite/MicroBenchmarks/libs/benchmark/googletest/googlemock/src/gmock_main.cc'
source_filename = "/usr/local/google/home/aeubanks/repos/test-suite/MicroBenchmarks/libs/benchmark/googletest/googlemock/src/gmock_main.cc"
...
entry:
  ...
  call void @_ZN7testing14InitGoogleMockEPiPPc(ptr noundef nonnull %argc.addr, ptr noundef %argv)
  %call.i = call noundef ptr @_ZN7testing8UnitTest11GetInstanceEv()
  %call1.i2 = call noundef i32 @_ZN7testing8UnitTest3RunEv(ptr noundef nonnull align 8 dereferenceable(72) %call.i)
  ret i32 %call1.i2
}
