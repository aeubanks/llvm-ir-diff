...
for.body79:                                       ; preds = %for.body79.lr.ph, %cond.end199
  ...
  %67 = load i32, ptr %arrayidx97, align 4, !tbaa !46
  ...
  %68 = load double, ptr %arrayidx136, align 8, !tbaa !58
  %y.i555 = getelementptr inbounds %struct.double2, ptr %call.i, i64 %idxprom135, i32 1
  %69 = load double, ptr %y.i555, align 8, !tbaa !60
  ...
  %70 = load double, ptr %y3.i546, align 8, !tbaa !60, !noalias !61
  %71 = load double, ptr %arrayidx118, align 8, !tbaa !58, !noalias !61
  %72 = load double, ptr %arrayidx147, align 8, !tbaa !58, !noalias !64
  ...
  %78 = load double, ptr %y.i560, align 8, !tbaa !60, !noalias !64
  ...
  %87 = load double, ptr %y.i542, align 8, !tbaa !60
  %88 = load double, ptr %arrayidx132, align 8, !tbaa !58
  %89 = load double, ptr %arrayidx140, align 8, !tbaa !58
  %90 = load double, ptr %y.i557, align 8, !tbaa !60
  %91 = load double, ptr %arrayidx163, align 8, !tbaa !58
  %92 = load double, ptr %y.i553, align 8, !tbaa !60
  %93 = load double, ptr %y.i570, align 8, !tbaa !60
...
cond.false194:                                    ; preds = %for.body79
  %sub4.i589 = fsub double %92, %87
  %sub.i586 = fsub double %88, %86
  %sub4.i584 = fsub double %93, %87
  %sub.i581 = fsub double %91, %86
...
cond.end199:                                      ; preds = %for.body79, %cond.false194
  ...
  %113 = insertelement <2 x double> poison, double %68, i64 0
  %114 = insertelement <2 x double> %84, double %68, i64 0
  %115 = shufflevector <2 x double> %73, <2 x double> %84, <2 x i32> <i32 0, i32 2>
  %116 = fsub <2 x double> %114, %115
  %117 = insertelement <2 x double> poison, double %69, i64 0
  %118 = insertelement <2 x double> %85, double %69, i64 0
  ...
  %125 = insertelement <2 x double> poison, double %90, i64 0
  %126 = shufflevector <2 x double> %125, <2 x double> poison, <2 x i32> zeroinitializer
  %127 = insertelement <2 x double> %101, double %93, i64 1
  ...
  %169 = fadd <2 x double> %85, %168
  %170 = shufflevector <2 x double> %113, <2 x double> poison, <2 x i32> zeroinitializer
  %171 = fadd <2 x double> %84, %170
  %172 = fsub <2 x double> %169, %80
  %173 = shufflevector <2 x double> %85, <2 x double> poison, <2 x i32> <i32 1, i32 0>
  %174 = fsub <2 x double> %172, %173
  %175 = fsub <2 x double> %171, %74
  %176 = shufflevector <2 x double> %84, <2 x double> poison, <2 x i32> <i32 1, i32 0>
...
for.body37:                                       ; preds = %for.body37.lr.ph, %for.body37
  ...
  %29 = load double, ptr %arrayidx56, align 8, !tbaa !47, !noalias !71
  %arrayidx47 = getelementptr inbounds i32, ptr %13, i64 %idxprom42
  %30 = load i32, ptr %arrayidx47, align 4, !tbaa !46
  %idxprom62 = sext i32 %30 to i64
  %arrayidx63 = getelementptr inbounds double, ptr %5, i64 %idxprom62
  %31 = load double, ptr %arrayidx63, align 8, !tbaa !47, !noalias !72
