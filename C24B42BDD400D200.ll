...
define dso_local void @foo() local_unnamed_addr #0 {
  ...
  %2 = tail call i32 @llvm.smin.i32(i32 %1, i32 2242)
  %3 = add nsw i32 %2, -1
  store i32 %3, ptr getelementptr inbounds (%struct.A, ptr @a, i64 0, i32 1), align 4, !tbaa !9
  %4 = icmp sgt i32 %1, 2242
...
define dso_local i32 @bar(float noundef %0) local_unnamed_addr #1 {
  ret i32 2241
}
...
define dso_local i32 @main() local_unnamed_addr #3 {
  ...
  store i32 3384, ptr @b, align 4, !tbaa !5
  store i32 2241, ptr getelementptr inbounds (%struct.A, ptr @a, i64 0, i32 1), align 4, !tbaa !9
  ret i32 0
}
