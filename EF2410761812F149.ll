...
for.cond:                                         ; preds = %for.cond.outer, %if.end75
  %1 = phi i32 [ %inc.i304372, %if.end75 ], [ %stack_POINTER.promoted, %for.cond.outer ]
  ...
  %TermL.addr.1.val178351 = load i32, ptr %TermL.addr.0, align 8
  %cmp.i.i352 = icmp sgt i32 %TermL.addr.1.val178351, 0
  br i1 %cmp.i.i352, label %land.rhs.preheader, label %while.end

land.rhs.preheader:                               ; preds = %for.cond
  %idxprom.i.i468 = zext i32 %TermL.addr.1.val178351 to i64
  %term.i.i469 = getelementptr inbounds %struct.binding, ptr %CtL.addr.0, i64 %idxprom.i.i468, i32 2
  %2 = load ptr, ptr %term.i.i469, align 8
  %cmp.i.not470 = icmp eq ptr %2, null
  br i1 %cmp.i.not470, label %while.end, label %while.body
...
while.body:                                       ; preds = %land.rhs.preheader, %land.rhs
  ...
  %idxprom.i.i472 = phi i64 [ %idxprom.i.i, %land.rhs ], [ %idxprom.i.i468, %land.rhs.preheader ]
  %CtL.addr.1353471 = phi ptr [ %5, %land.rhs ], [ %CtL.addr.0, %land.rhs.preheader ]
  %context.i = getelementptr inbounds %struct.binding, ptr %CtL.addr.1353471, i64 %idxprom.i.i472, i32 3
...
while.end:                                        ; preds = %while.body, %land.rhs, %land.rhs.preheader, %for.cond
  ...
  %TermL.addr.1.val178.lcssa = phi i32 [ %TermL.addr.1.val178351, %for.cond ], [ %TermL.addr.1.val178351, %land.rhs.preheader ], [ %TermL.addr.1.val178, %land.rhs ], [ %TermL.addr.1.val178, %while.body ]
  %cmp.i.i.lcssa = phi i1 [ false, %for.cond ], [ true, %land.rhs.preheader ], [ %cmp.i.i, %land.rhs ], [ %cmp.i.i, %while.body ]
  %TermR.addr.1.val177364 = load i32, ptr %TermR.addr.0, align 8
  %cmp.i.i193365 = icmp sgt i32 %TermR.addr.1.val177364, 0
  br i1 %cmp.i.i193365, label %land.rhs12.preheader, label %while.end22.thread

land.rhs12.preheader:                             ; preds = %while.end
  %idxprom.i.i195480 = zext i32 %TermR.addr.1.val177364 to i64
  %term.i.i196481 = getelementptr inbounds %struct.binding, ptr %CtR.addr.0, i64 %idxprom.i.i195480, i32 2
  %6 = load ptr, ptr %term.i.i196481, align 8
  %cmp.i197.not482 = icmp eq ptr %6, null
  br i1 %cmp.i197.not482, label %while.end22, label %while.body17
...
while.body17:                                     ; preds = %land.rhs12.preheader, %land.rhs12
  ...
  %idxprom.i.i195484 = phi i64 [ %idxprom.i.i195, %land.rhs12 ], [ %idxprom.i.i195480, %land.rhs12.preheader ]
  %CtR.addr.1366483 = phi ptr [ %9, %land.rhs12 ], [ %CtR.addr.0, %land.rhs12.preheader ]
  %context.i200 = getelementptr inbounds %struct.binding, ptr %CtR.addr.1366483, i64 %idxprom.i.i195484, i32 3
...
while.end22:                                      ; preds = %land.rhs12.preheader, %land.rhs12
  %TermR.addr.1.val177368.lcssa = phi i32 [ %TermR.addr.1.val177, %land.rhs12 ], [ %TermR.addr.1.val177364, %land.rhs12.preheader ]
  %TermR.addr.1367.lcssa = phi ptr [ %8, %land.rhs12 ], [ %TermR.addr.0, %land.rhs12.preheader ]
  %CtR.addr.1366.lcssa = phi ptr [ %9, %land.rhs12 ], [ %CtR.addr.0, %land.rhs12.preheader ]
...
while.end22.thread:                               ; preds = %while.body17, %while.end
  ...
  %TermR.addr.1.val177.lcssa = phi i32 [ %TermR.addr.1.val177364, %while.end ], [ %TermR.addr.1.val177, %while.body17 ]
  br i1 %cmp.i.i.lcssa, label %if.else, label %if.else58

if.then27:                                        ; preds = %while.end22
  %cmp = icmp eq ptr %CtL.addr.1.lcssa, %CtR.addr.1366.lcssa
  %cmp.i.i207 = icmp eq i32 %TermL.addr.1.val178.lcssa, %TermR.addr.1.val177368.lcssa
  %or.cond = and i1 %cmp, %cmp.i.i207
  br i1 %or.cond, label %if.end82, label %if.then30

if.then30:                                        ; preds = %if.then27
  %idxprom.i.i.i = zext i32 %TermR.addr.1.val177368.lcssa to i64
  %arrayidx.i.i.i = getelementptr inbounds %struct.binding, ptr %CtR.addr.1366.lcssa, i64 %idxprom.i.i.i
  store ptr %arrayidx.i.i.i, ptr @cont_CURRENTBINDING, align 8
  %term.i.i.i = getelementptr inbounds %struct.binding, ptr %CtR.addr.1366.lcssa, i64 %idxprom.i.i.i, i32 2
...
if.then.i232:                                     ; preds = %if.end22.i266, %for.cond.outer.i226
  ...
  %cmp.i229 = icmp eq ptr %CTerm.addr.0.ph.i223, %CtR.addr.1366.lcssa
  %cmp.i.i230 = icmp eq i32 %Term.addr.0.val60.lcssa.i228, %TermR.addr.1.val177368.lcssa
...
if.else54.loopexit:                               ; preds = %if.end25.i269
  %TermR.addr.1.val.pre = load i32, ptr %TermR.addr.1367.lcssa, align 8
  br label %if.else54

if.else54:                                        ; preds = %if.else54.loopexit, %if.then47
  %TermR.addr.1.val = phi i32 [ %TermR.addr.1.val.pre, %if.else54.loopexit ], [ %TermR.addr.1.val177368.lcssa, %if.then47 ]
  %idxprom.i.i.i284 = sext i32 %TermR.addr.1.val to i64
  %arrayidx.i.i.i285 = getelementptr inbounds %struct.binding, ptr %CtR.addr.1366.lcssa, i64 %idxprom.i.i.i284
  store ptr %arrayidx.i.i.i285, ptr @cont_CURRENTBINDING, align 8
  %term.i.i.i286 = getelementptr inbounds %struct.binding, ptr %CtR.addr.1366.lcssa, i64 %idxprom.i.i.i284, i32 2
...
if.then61:                                        ; preds = %if.else58
  ...
  %or.cond328 = or i1 %cmp65.not, %cmp.i292.not
  br i1 %or.cond328, label %if.end82, label %if.then66
...
if.end75:                                         ; preds = %if.then72, %if.then66
  %inc.i304372 = phi i32 [ %inc.i304, %if.then72 ], [ %1, %if.then66 ]
...
if.end68.sink.split:                              ; preds = %if.then40, %if.else48, %if.else61
  %idxprom.i.i.i.sink254 = phi i64 [ %idxprom.i.i.i, %if.then40 ], [ %idxprom.i.i.i182, %if.else48 ], [ %idxprom.i.i.i227, %if.else61 ]
  %TermR.addr.1.lcssa.sink = phi ptr [ %TermR.addr.1, %if.then40 ], [ %TermR.addr.1, %if.else48 ], [ %TermL.addr.1, %if.else61 ]
  %arrayidx.i.i.i = getelementptr inbounds %struct.binding, ptr %Context, i64 %idxprom.i.i.i.sink254
  store ptr %arrayidx.i.i.i, ptr @cont_CURRENTBINDING, align 8
  %term.i.i.i = getelementptr inbounds %struct.binding, ptr %Context, i64 %idxprom.i.i.i.sink254, i32 2
...
if.then27:                                        ; preds = %while.end22
  ...
  %or.cond = and i1 %cmp, %cmp.i.i177
  br i1 %or.cond, label %if.end66, label %if.then30
...
if.then45:                                        ; preds = %if.else42
  ...
  %or.cond231 = or i1 %cmp49.not, %cmp.i195.not
  br i1 %or.cond231, label %if.end66, label %if.then50
...
if.then29:                                        ; preds = %if.then26
  ...
  %or.cond = and i1 %cmp.not, %cmp.i.i193
  br i1 %or.cond, label %return, label %if.then32
...
if.else38:                                        ; preds = %if.then32
  ...
  %or.cond296 = select i1 %14, i1 true, i1 %cmp42
  br i1 %or.cond296, label %if.then43, label %if.else46
...
for.body:                                         ; preds = %if.then77, %for.inc
  %ArgR.0329.in = phi ptr [ %44, %if.then77 ], [ %ArgR.0329, %for.inc ]
  %ArgL.0328 = phi ptr [ %TermL.addr.2.val169, %if.then77 ], [ %ArgL.0.val, %for.inc ]
...
for.inc:                                          ; preds = %for.body
  %ArgL.0.val = load ptr, ptr %ArgL.0328, align 8
  %cmp.i293.not.not = icmp eq ptr %ArgL.0.val, null
  br i1 %cmp.i293.not.not, label %return, label %for.body, !llvm.loop !13

return:                                           ; preds = %for.body, %for.inc, %if.then74, %if.else71, %if.then43, %if.else46, %if.then35, %if.then29, %if.else68, %if.then5.i232, %if.else57, %if.then5.i
  %retval.1 = phi i32 [ 0, %if.then5.i ], [ 1, %if.else57 ], [ 0, %if.then5.i232 ], [ 1, %if.else68 ], [ 1, %if.then29 ], [ 1, %if.then35 ], [ 1, %if.else46 ], [ 1, %if.then43 ], [ 0, %if.else71 ], [ 1, %if.then74 ], [ 0, %for.body ], [ 1, %for.inc ]
  ret i32 %retval.1
}
...
for.inc:                                          ; preds = %for.body
  ...
  %cmp.i60.not.not = icmp eq ptr %ArgL.0.val, null
  br i1 %cmp.i60.not.not, label %return, label %for.body, !llvm.loop !14
...
for.inc:                                          ; preds = %for.body
  ...
  %cmp.i68.not.not = icmp eq ptr %ArgL.0.val, null
  br i1 %cmp.i68.not.not, label %return, label %for.body, !llvm.loop !15
...
for.body:                                         ; preds = %if.then35, %for.inc
  ...
  %ArgL.0131 = phi ptr [ %TermL.val91, %if.then35 ], [ %ArgL.0.val, %for.inc ]
...
for.inc:                                          ; preds = %for.body
  ...
  %cmp.i111.not.not = icmp eq ptr %ArgL.0.val, null
  br i1 %cmp.i111.not.not, label %return, label %for.body, !llvm.loop !17
...
for.body:                                         ; preds = %if.then59, %for.inc
  ...
  %ArgL.0183 = phi ptr [ %TermL.val125, %if.then59 ], [ %ArgL.0.val, %for.inc ]
...
for.inc:                                          ; preds = %for.body
  ...
  %cmp.i162.not.not = icmp eq ptr %ArgL.0.val, null
  br i1 %cmp.i162.not.not, label %return, label %for.body, !llvm.loop !18
...
for.inc:                                          ; preds = %for.body
  ...
  %cmp.i76.not.not = icmp eq ptr %ArgL.0.val, null
  br i1 %cmp.i76.not.not, label %return, label %for.body, !llvm.loop !19
