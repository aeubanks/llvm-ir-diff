...
if.end:                                           ; preds = %if.then, %entry
  ...
  %or.cond509 = select i1 %cmp12, i1 true, i1 %cmp14
  br i1 %or.cond509, label %if.then16, label %if.end84
...
while.body.lr.ph.i:                               ; preds = %if.end119
  %seq1.val470 = load ptr, ptr %seq1, align 8, !tbaa !9
  %seq2.val469 = load ptr, ptr %seq2, align 8, !tbaa !9
  %46 = load ptr, ptr @genL__align11.initverticalw, align 8, !tbaa !9
  %47 = load i8, ptr %seq2.val469, align 1, !tbaa !11
...
while.body.i.prol:                                ; preds = %while.body.lr.ph.i, %while.body.i.prol
  %seq2.04.i.prol = phi ptr [ %incdec.ptr.i.prol, %while.body.i.prol ], [ %seq1.val470, %while.body.lr.ph.i ]
...
while.body.i.prol.loopexit:                       ; preds = %while.body.i.prol, %while.body.lr.ph.i
  %seq2.04.i.unr = phi ptr [ %seq1.val470, %while.body.lr.ph.i ], [ %incdec.ptr.i.prol, %while.body.i.prol ]
...
match_calc.exit:                                  ; preds = %while.body.i.prol.loopexit, %while.body.i, %if.end119
  %tobool.not1.i471 = icmp eq i32 %conv11, 0
  br i1 %tobool.not1.i471, label %for.end, label %while.body.lr.ph.i473

while.body.lr.ph.i473:                            ; preds = %match_calc.exit
  %seq2.val468 = load ptr, ptr %seq2, align 8, !tbaa !9
  %seq1.val467 = load ptr, ptr %seq1, align 8, !tbaa !9
  %59 = load i8, ptr %seq1.val467, align 1, !tbaa !11
  %idxprom3.i472 = sext i8 %59 to i64
  %xtraiter627 = and i32 %conv11, 3
  %lcmp.mod628.not = icmp eq i32 %xtraiter627, 0
  br i1 %lcmp.mod628.not, label %while.body.i484.prol.loopexit, label %while.body.i484.prol

while.body.i484.prol:                             ; preds = %while.body.lr.ph.i473, %while.body.i484.prol
  %seq2.04.i474.prol = phi ptr [ %incdec.ptr.i478.prol, %while.body.i484.prol ], [ %seq2.val468, %while.body.lr.ph.i473 ]
  %match.addr.03.i475.prol = phi ptr [ %incdec.ptr9.i482.prol, %while.body.i484.prol ], [ %44, %while.body.lr.ph.i473 ]
  %lgth2.addr.02.i476.prol = phi i32 [ %dec.i477.prol, %while.body.i484.prol ], [ %conv11, %while.body.lr.ph.i473 ]
  %prol.iter629 = phi i32 [ %prol.iter629.next, %while.body.i484.prol ], [ 0, %while.body.lr.ph.i473 ]
  %dec.i477.prol = add nsw i32 %lgth2.addr.02.i476.prol, -1
  %incdec.ptr.i478.prol = getelementptr inbounds i8, ptr %seq2.04.i474.prol, i64 1
  %60 = load i8, ptr %seq2.04.i474.prol, align 1, !tbaa !11
  %idxprom6.i479.prol = sext i8 %60 to i64
  %arrayidx7.i480.prol = getelementptr inbounds [128 x [128 x i32]], ptr @amino_dis, i64 0, i64 %idxprom3.i472, i64 %idxprom6.i479.prol
  %61 = load i32, ptr %arrayidx7.i480.prol, align 4, !tbaa !5
  %conv8.i481.prol = sitofp i32 %61 to float
  %incdec.ptr9.i482.prol = getelementptr inbounds float, ptr %match.addr.03.i475.prol, i64 1
  store float %conv8.i481.prol, ptr %match.addr.03.i475.prol, align 4, !tbaa !12
  %prol.iter629.next = add i32 %prol.iter629, 1
  %prol.iter629.cmp.not = icmp eq i32 %prol.iter629.next, %xtraiter627
  br i1 %prol.iter629.cmp.not, label %while.body.i484.prol.loopexit, label %while.body.i484.prol, !llvm.loop !18

while.body.i484.prol.loopexit:                    ; preds = %while.body.i484.prol, %while.body.lr.ph.i473
  %seq2.04.i474.unr = phi ptr [ %seq2.val468, %while.body.lr.ph.i473 ], [ %incdec.ptr.i478.prol, %while.body.i484.prol ]
  %match.addr.03.i475.unr = phi ptr [ %44, %while.body.lr.ph.i473 ], [ %incdec.ptr9.i482.prol, %while.body.i484.prol ]
  %lgth2.addr.02.i476.unr = phi i32 [ %conv11, %while.body.lr.ph.i473 ], [ %dec.i477.prol, %while.body.i484.prol ]
  %62 = icmp ult i32 %conv11, 4
  br i1 %62, label %match_calc.exit485, label %while.body.i484

while.body.i484:                                  ; preds = %while.body.i484.prol.loopexit, %while.body.i484
  %seq2.04.i474 = phi ptr [ %incdec.ptr.i478.3, %while.body.i484 ], [ %seq2.04.i474.unr, %while.body.i484.prol.loopexit ]
  %match.addr.03.i475 = phi ptr [ %incdec.ptr9.i482.3, %while.body.i484 ], [ %match.addr.03.i475.unr, %while.body.i484.prol.loopexit ]
  %lgth2.addr.02.i476 = phi i32 [ %dec.i477.3, %while.body.i484 ], [ %lgth2.addr.02.i476.unr, %while.body.i484.prol.loopexit ]
  %incdec.ptr.i478 = getelementptr inbounds i8, ptr %seq2.04.i474, i64 1
  %63 = load i8, ptr %seq2.04.i474, align 1, !tbaa !11
  %idxprom6.i479 = sext i8 %63 to i64
  %arrayidx7.i480 = getelementptr inbounds [128 x [128 x i32]], ptr @amino_dis, i64 0, i64 %idxprom3.i472, i64 %idxprom6.i479
  %64 = load i32, ptr %arrayidx7.i480, align 4, !tbaa !5
  %conv8.i481 = sitofp i32 %64 to float
  %incdec.ptr9.i482 = getelementptr inbounds float, ptr %match.addr.03.i475, i64 1
  store float %conv8.i481, ptr %match.addr.03.i475, align 4, !tbaa !12
  %incdec.ptr.i478.1 = getelementptr inbounds i8, ptr %seq2.04.i474, i64 2
  %65 = load i8, ptr %incdec.ptr.i478, align 1, !tbaa !11
  %idxprom6.i479.1 = sext i8 %65 to i64
  %arrayidx7.i480.1 = getelementptr inbounds [128 x [128 x i32]], ptr @amino_dis, i64 0, i64 %idxprom3.i472, i64 %idxprom6.i479.1
  %66 = load i32, ptr %arrayidx7.i480.1, align 4, !tbaa !5
  %conv8.i481.1 = sitofp i32 %66 to float
  %incdec.ptr9.i482.1 = getelementptr inbounds float, ptr %match.addr.03.i475, i64 2
  store float %conv8.i481.1, ptr %incdec.ptr9.i482, align 4, !tbaa !12
  %incdec.ptr.i478.2 = getelementptr inbounds i8, ptr %seq2.04.i474, i64 3
  %67 = load i8, ptr %incdec.ptr.i478.1, align 1, !tbaa !11
  %idxprom6.i479.2 = sext i8 %67 to i64
  %arrayidx7.i480.2 = getelementptr inbounds [128 x [128 x i32]], ptr @amino_dis, i64 0, i64 %idxprom3.i472, i64 %idxprom6.i479.2
  %68 = load i32, ptr %arrayidx7.i480.2, align 4, !tbaa !5
  %conv8.i481.2 = sitofp i32 %68 to float
  %incdec.ptr9.i482.2 = getelementptr inbounds float, ptr %match.addr.03.i475, i64 3
  store float %conv8.i481.2, ptr %incdec.ptr9.i482.1, align 4, !tbaa !12
  %dec.i477.3 = add nsw i32 %lgth2.addr.02.i476, -4
  %incdec.ptr.i478.3 = getelementptr inbounds i8, ptr %seq2.04.i474, i64 4
  %69 = load i8, ptr %incdec.ptr.i478.2, align 1, !tbaa !11
  %idxprom6.i479.3 = sext i8 %69 to i64
  %arrayidx7.i480.3 = getelementptr inbounds [128 x [128 x i32]], ptr @amino_dis, i64 0, i64 %idxprom3.i472, i64 %idxprom6.i479.3
  %70 = load i32, ptr %arrayidx7.i480.3, align 4, !tbaa !5
  %conv8.i481.3 = sitofp i32 %70 to float
  %incdec.ptr9.i482.3 = getelementptr inbounds float, ptr %match.addr.03.i475, i64 4
  store float %conv8.i481.3, ptr %incdec.ptr9.i482.2, align 4, !tbaa !12
  %tobool.not.i483.3 = icmp eq i32 %dec.i477.3, 0
  br i1 %tobool.not.i483.3, label %match_calc.exit485, label %while.body.i484, !llvm.loop !16

match_calc.exit485:                               ; preds = %while.body.i484, %while.body.i484.prol.loopexit
  %cmp121.not510 = icmp slt i32 %conv11, 1
  br i1 %cmp121.not510, label %for.end, label %for.body.lr.ph

for.body.lr.ph:                                   ; preds = %match_calc.exit485
...
for.end:                                          ; preds = %for.body.prol.loopexit, %for.body, %middle.block, %match_calc.exit, %match_calc.exit485
  %cmp121.not510587 = phi i1 [ true, %match_calc.exit485 ], [ true, %match_calc.exit ], [ %cmp121.not510, %middle.block ], [ %cmp121.not510, %for.body ], [ %cmp121.not510, %for.body.prol.loopexit ]
...
for.body146.lr.ph:                                ; preds = %for.end
  %96 = load ptr, ptr @genL__align11.initverticalw, align 8, !tbaa !9
  %97 = load ptr, ptr @genL__align11.m, align 8, !tbaa !9
  %98 = load ptr, ptr @genL__align11.largeM, align 8, !tbaa !9
  %99 = load ptr, ptr @genL__align11.mp, align 8, !tbaa !9
  %100 = load ptr, ptr @genL__align11.Mp, align 8, !tbaa !9
  %wide.trip.count572 = zext i32 %add140 to i64
  %xtraiter633 = and i32 %conv11, 3
  %lcmp.mod634.not = icmp eq i32 %xtraiter633, 0
  %101 = icmp ult i32 %conv11, 4
...
for.body146:                                      ; preds = %for.body146.lr.ph, %for.end239
  ...
  %102 = add nsw i64 %indvars.iv568, -1
  %arrayidx149 = getelementptr inbounds float, ptr %96, i64 %102
  %103 = load float, ptr %arrayidx149, align 4, !tbaa !12
  store float %103, ptr %currentw.0555, align 4, !tbaa !12
  br i1 %tobool.not1.i471, label %match_calc.exit500, label %while.body.lr.ph.i488

while.body.lr.ph.i488:                            ; preds = %for.body146
  %seq2.val = load ptr, ptr %seq2, align 8, !tbaa !9
  %seq1.val = load ptr, ptr %seq1, align 8, !tbaa !9
  %arrayidx1.i = getelementptr inbounds i8, ptr %seq1.val, i64 %indvars.iv568
  %104 = load i8, ptr %arrayidx1.i, align 1, !tbaa !11
  %idxprom3.i487 = sext i8 %104 to i64
  br i1 %lcmp.mod634.not, label %while.body.i499.prol.loopexit, label %while.body.i499.prol

while.body.i499.prol:                             ; preds = %while.body.lr.ph.i488, %while.body.i499.prol
  %seq2.04.i489.prol = phi ptr [ %incdec.ptr.i493.prol, %while.body.i499.prol ], [ %seq2.val, %while.body.lr.ph.i488 ]
  %match.addr.03.i490.prol = phi ptr [ %incdec.ptr9.i497.prol, %while.body.i499.prol ], [ %previousw.0554, %while.body.lr.ph.i488 ]
  %lgth2.addr.02.i491.prol = phi i32 [ %dec.i492.prol, %while.body.i499.prol ], [ %conv11, %while.body.lr.ph.i488 ]
  %prol.iter635 = phi i32 [ %prol.iter635.next, %while.body.i499.prol ], [ 0, %while.body.lr.ph.i488 ]
  %dec.i492.prol = add nsw i32 %lgth2.addr.02.i491.prol, -1
  %incdec.ptr.i493.prol = getelementptr inbounds i8, ptr %seq2.04.i489.prol, i64 1
  %105 = load i8, ptr %seq2.04.i489.prol, align 1, !tbaa !11
  %idxprom6.i494.prol = sext i8 %105 to i64
  %arrayidx7.i495.prol = getelementptr inbounds [128 x [128 x i32]], ptr @amino_dis, i64 0, i64 %idxprom3.i487, i64 %idxprom6.i494.prol
  %106 = load i32, ptr %arrayidx7.i495.prol, align 4, !tbaa !5
  %conv8.i496.prol = sitofp i32 %106 to float
  %incdec.ptr9.i497.prol = getelementptr inbounds float, ptr %match.addr.03.i490.prol, i64 1
  store float %conv8.i496.prol, ptr %match.addr.03.i490.prol, align 4, !tbaa !12
  %prol.iter635.next = add i32 %prol.iter635, 1
  %prol.iter635.cmp.not = icmp eq i32 %prol.iter635.next, %xtraiter633
  br i1 %prol.iter635.cmp.not, label %while.body.i499.prol.loopexit, label %while.body.i499.prol, !llvm.loop !35

while.body.i499.prol.loopexit:                    ; preds = %while.body.i499.prol, %while.body.lr.ph.i488
  %seq2.04.i489.unr = phi ptr [ %seq2.val, %while.body.lr.ph.i488 ], [ %incdec.ptr.i493.prol, %while.body.i499.prol ]
  %match.addr.03.i490.unr = phi ptr [ %previousw.0554, %while.body.lr.ph.i488 ], [ %incdec.ptr9.i497.prol, %while.body.i499.prol ]
  %lgth2.addr.02.i491.unr = phi i32 [ %conv11, %while.body.lr.ph.i488 ], [ %dec.i492.prol, %while.body.i499.prol ]
  br i1 %101, label %match_calc.exit500, label %while.body.i499

while.body.i499:                                  ; preds = %while.body.i499.prol.loopexit, %while.body.i499
  %seq2.04.i489 = phi ptr [ %incdec.ptr.i493.3, %while.body.i499 ], [ %seq2.04.i489.unr, %while.body.i499.prol.loopexit ]
  %match.addr.03.i490 = phi ptr [ %incdec.ptr9.i497.3, %while.body.i499 ], [ %match.addr.03.i490.unr, %while.body.i499.prol.loopexit ]
  %lgth2.addr.02.i491 = phi i32 [ %dec.i492.3, %while.body.i499 ], [ %lgth2.addr.02.i491.unr, %while.body.i499.prol.loopexit ]
  %incdec.ptr.i493 = getelementptr inbounds i8, ptr %seq2.04.i489, i64 1
  %107 = load i8, ptr %seq2.04.i489, align 1, !tbaa !11
  %idxprom6.i494 = sext i8 %107 to i64
  %arrayidx7.i495 = getelementptr inbounds [128 x [128 x i32]], ptr @amino_dis, i64 0, i64 %idxprom3.i487, i64 %idxprom6.i494
  %108 = load i32, ptr %arrayidx7.i495, align 4, !tbaa !5
  %conv8.i496 = sitofp i32 %108 to float
  %incdec.ptr9.i497 = getelementptr inbounds float, ptr %match.addr.03.i490, i64 1
  store float %conv8.i496, ptr %match.addr.03.i490, align 4, !tbaa !12
  %incdec.ptr.i493.1 = getelementptr inbounds i8, ptr %seq2.04.i489, i64 2
  %109 = load i8, ptr %incdec.ptr.i493, align 1, !tbaa !11
  %idxprom6.i494.1 = sext i8 %109 to i64
  %arrayidx7.i495.1 = getelementptr inbounds [128 x [128 x i32]], ptr @amino_dis, i64 0, i64 %idxprom3.i487, i64 %idxprom6.i494.1
  %110 = load i32, ptr %arrayidx7.i495.1, align 4, !tbaa !5
  %conv8.i496.1 = sitofp i32 %110 to float
  %incdec.ptr9.i497.1 = getelementptr inbounds float, ptr %match.addr.03.i490, i64 2
  store float %conv8.i496.1, ptr %incdec.ptr9.i497, align 4, !tbaa !12
  %incdec.ptr.i493.2 = getelementptr inbounds i8, ptr %seq2.04.i489, i64 3
  %111 = load i8, ptr %incdec.ptr.i493.1, align 1, !tbaa !11
  %idxprom6.i494.2 = sext i8 %111 to i64
  %arrayidx7.i495.2 = getelementptr inbounds [128 x [128 x i32]], ptr @amino_dis, i64 0, i64 %idxprom3.i487, i64 %idxprom6.i494.2
  %112 = load i32, ptr %arrayidx7.i495.2, align 4, !tbaa !5
  %conv8.i496.2 = sitofp i32 %112 to float
  %incdec.ptr9.i497.2 = getelementptr inbounds float, ptr %match.addr.03.i490, i64 3
  store float %conv8.i496.2, ptr %incdec.ptr9.i497.1, align 4, !tbaa !12
  %dec.i492.3 = add nsw i32 %lgth2.addr.02.i491, -4
  %incdec.ptr.i493.3 = getelementptr inbounds i8, ptr %seq2.04.i489, i64 4
  %113 = load i8, ptr %incdec.ptr.i493.2, align 1, !tbaa !11
  %idxprom6.i494.3 = sext i8 %113 to i64
  %arrayidx7.i495.3 = getelementptr inbounds [128 x [128 x i32]], ptr @amino_dis, i64 0, i64 %idxprom3.i487, i64 %idxprom6.i494.3
  %114 = load i32, ptr %arrayidx7.i495.3, align 4, !tbaa !5
  %conv8.i496.3 = sitofp i32 %114 to float
  %incdec.ptr9.i497.3 = getelementptr inbounds float, ptr %match.addr.03.i490, i64 4
  store float %conv8.i496.3, ptr %incdec.ptr9.i497.2, align 4, !tbaa !12
  %tobool.not.i498.3 = icmp eq i32 %dec.i492.3, 0
  br i1 %tobool.not.i498.3, label %match_calc.exit500, label %while.body.i499, !llvm.loop !16

match_calc.exit500:                               ; preds = %while.body.i499.prol.loopexit, %while.body.i499, %for.body146
  %arrayidx152 = getelementptr inbounds float, ptr %96, i64 %indvars.iv568
  %115 = load float, ptr %arrayidx152, align 4, !tbaa !12
  store float %115, ptr %previousw.0554, align 4, !tbaa !12
  br i1 %cmp121.not510587, label %for.end239, label %for.body170.preheader

for.body170.preheader:                            ; preds = %match_calc.exit500
  %116 = load float, ptr %currentw.0555, align 4, !tbaa !12
  %arrayidx159 = getelementptr inbounds ptr, ptr %42, i64 %indvars.iv568
  %117 = load ptr, ptr %arrayidx159, align 8, !tbaa !9
  %arrayidx157 = getelementptr inbounds ptr, ptr %43, i64 %indvars.iv568
  %118 = load ptr, ptr %arrayidx157, align 8, !tbaa !9
  %119 = trunc i64 %102 to i32
  %120 = trunc i64 %indvars.iv568 to i32
  br label %for.body170

for.body170:                                      ; preds = %for.body170.preheader, %if.end228
  %ijpipt.0543.pn = phi ptr [ %ijpipt.0543, %if.end228 ], [ %118, %for.body170.preheader ]
  %ijpjpt.0542.pn = phi ptr [ %ijpjpt.0542, %if.end228 ], [ %117, %for.body170.preheader ]
  %mjpt.0541.pn = phi ptr [ %mjpt.0541, %if.end228 ], [ %97, %for.body170.preheader ]
  %Mjpt.0540.pn = phi ptr [ %Mjpt.0540, %if.end228 ], [ %98, %for.body170.preheader ]
  %mpjpt.0539.pn = phi ptr [ %mpjpt.0539, %if.end228 ], [ %99, %for.body170.preheader ]
  %Mpjpt.0538.pn = phi ptr [ %Mpjpt.0538, %if.end228 ], [ %100, %for.body170.preheader ]
  ...
  %add183512528 = phi float [ %add183, %if.end228 ], [ %116, %for.body170.preheader ]
  %sub172515527 = phi i32 [ %sub172514, %if.end228 ], [ 0, %for.body170.preheader ]
  %121 = phi float [ %130, %if.end228 ], [ %116, %for.body170.preheader ]
  ...
  %122 = load float, ptr %prept.0529, align 4, !tbaa !12
  store i32 %119, ptr %ijpipt.0543, align 4, !tbaa !5
  %sub172 = add nsw i32 %j.1536, -1
  %add173 = fadd float %add183512528, %conv
  %cmp174 = fcmp ogt float %add173, %122
  %storemerge = select i1 %cmp174, i32 %sub172515527, i32 %sub172
  %wm.0 = select i1 %cmp174, float %add173, float %122
  store i32 %storemerge, ptr %ijpjpt.0542, align 4, !tbaa !5
  %cmp178 = fcmp ogt float %122, %add183512528
  %sub172514 = select i1 %cmp178, i32 %sub172, i32 %sub172515527
  %add183513 = select i1 %cmp178, float %122, float %add183512528
  %add183 = fadd float %add183513, %conv2
  %123 = load float, ptr %mjpt.0541, align 4, !tbaa !12
  %add184 = fadd float %123, %conv
  %cmp185 = fcmp ogt float %add184, %wm.0
  br i1 %cmp185, label %if.then187, label %if.end189

if.then187:                                       ; preds = %for.body170
  %124 = load i32, ptr %mpjpt.0539, align 4, !tbaa !5
  store i32 %124, ptr %ijpipt.0543, align 4, !tbaa !5
...
if.end189:                                        ; preds = %if.then187, %for.body170
  ...
  %cmp190 = fcmp ogt float %122, %123
  br i1 %cmp190, label %if.then192, label %if.end194

if.then192:                                       ; preds = %if.end189
  store i32 %119, ptr %mpjpt.0539, align 4, !tbaa !5
  br label %if.end194

if.end194:                                        ; preds = %if.then192, %if.end189
  %125 = phi float [ %122, %if.then192 ], [ %123, %if.end189 ]
  %add195 = fadd float %125, %conv2
...
if.end200:                                        ; preds = %if.then199, %if.end194
  ...
  %cmp201 = fcmp ogt float %121, %tbk.0531
  %tbk.1 = select i1 %cmp201, float %121, float %tbk.0531
  %tbki.1 = select i1 %cmp201, i32 %119, i32 %tbki.0532
  %tbkj.1 = select i1 %cmp201, i32 %sub172517526, i32 %tbkj.0533
  %126 = load float, ptr %Mjpt.0540, align 4, !tbaa !12
  %cmp206 = fcmp ogt float %126, %tbk.1
  br i1 %cmp206, label %if.then208, label %if.end210

if.then208:                                       ; preds = %if.end200
  %127 = load i32, ptr %Mpjpt.0538, align 4, !tbaa !5
  br label %if.end210

if.end210:                                        ; preds = %if.then208, %if.end200
  %tbk.2 = phi float [ %126, %if.then208 ], [ %tbk.1, %if.end200 ]
  %tbki.2 = phi i32 [ %127, %if.then208 ], [ %tbki.1, %if.end200 ]
  %tbkj.2 = phi i32 [ %sub172, %if.then208 ], [ %tbkj.1, %if.end200 ]
  %128 = load float, ptr %prept.0529, align 4, !tbaa !12
  %cmp211 = fcmp ogt float %128, %126
  br i1 %cmp211, label %if.then213, label %if.end215

if.then213:                                       ; preds = %if.end210
  store float %128, ptr %Mjpt.0540, align 4, !tbaa !12
  store i32 %119, ptr %Mpjpt.0538, align 4, !tbaa !5
  %.pre582 = load float, ptr %prept.0529, align 4, !tbaa !12
  br label %if.end215

if.end215:                                        ; preds = %if.then213, %if.end210
  %129 = phi float [ %.pre582, %if.then213 ], [ %128, %if.end210 ]
  %cmp216 = fcmp ogt float %129, %121
  %sub172516 = select i1 %cmp216, i32 %sub172, i32 %sub172517526
  %130 = select i1 %cmp216, float %129, float %121
  %cmp221 = fcmp olt float %maxwm.1530, %wm.2
  %maxwm.2 = select i1 %cmp221, float %wm.2, float %maxwm.1530
  %endali.2 = select i1 %cmp221, i32 %120, i32 %endali.1534
...
if.end228:                                        ; preds = %if.then227, %if.end215
  ...
  %131 = load float, ptr %curpt.0537, align 4, !tbaa !12
  %add229 = fadd float %wm.3, %131
...
for.end239:                                       ; preds = %if.end228, %match_calc.exit500
  %maxwm.1.lcssa = phi float [ %maxwm.0551, %match_calc.exit500 ], [ %maxwm.2, %if.end228 ]
  %endali.1.lcssa = phi i32 [ %endali.0552, %match_calc.exit500 ], [ %endali.2, %if.end228 ]
  %endalj.1.lcssa = phi i32 [ %endalj.0553, %match_calc.exit500 ], [ %endalj.2, %if.end228 ]
  %arrayidx242 = getelementptr inbounds float, ptr %previousw.0554, i64 %idxprom137
  %132 = load float, ptr %arrayidx242, align 4, !tbaa !12
  %arrayidx244 = getelementptr inbounds float, ptr %95, i64 %indvars.iv568
  store float %132, ptr %arrayidx244, align 4, !tbaa !12
...
for.end247:                                       ; preds = %for.end239, %for.end
  ...
  %133 = load ptr, ptr %arrayidx249, align 8, !tbaa !9
  %idxprom250 = sext i32 %endalj.0.lcssa to i64
  %arrayidx251 = getelementptr inbounds i32, ptr %133, i64 %idxprom250
  %134 = load i32, ptr %arrayidx251, align 4, !tbaa !5
  %cmp252 = icmp eq i32 %134, %add141
  br i1 %cmp252, label %if.then254, label %if.end259

if.then254:                                       ; preds = %for.end247
  %135 = load ptr, ptr %seq1, align 8, !tbaa !9
  store i8 0, ptr %135, align 1
  %136 = load ptr, ptr %seq2, align 8, !tbaa !9
...
if.end259:                                        ; preds = %for.end247
  %137 = load ptr, ptr @genL__align11.mseq1, align 8, !tbaa !9
  %138 = load ptr, ptr @genL__align11.mseq2, align 8, !tbaa !9
  %139 = load ptr, ptr %seq1, align 8, !tbaa !9
  %call.i = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %139) #7
  %conv.i = trunc i64 %call.i to i32
  %140 = load ptr, ptr %seq2, align 8, !tbaa !9
  %call2.i = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %140) #7
  %conv3.i = trunc i64 %call2.i to i32
  %cmp.not2.i = icmp slt i32 %conv.i, 0
  br i1 %cmp.not2.i, label %for.cond10.preheader.i, label %for.body.lr.ph.i
...
for.body.lr.ph.i:                                 ; preds = %if.end259
  ...
  %xtraiter636 = and i64 %141, 3
  %143 = icmp ult i64 %142, 3
  br i1 %143, label %for.cond10.preheader.i.loopexit.unr-lcssa, label %for.body.lr.ph.i.new
...
for.body.i.epil:                                  ; preds = %for.cond10.preheader.i.loopexit.unr-lcssa, %for.body.i.epil
  ...
  %144 = load ptr, ptr %arrayidx5.i.epil, align 8, !tbaa !9
  store i32 %add141, ptr %144, align 4, !tbaa !5
  %arrayidx8.i.epil = getelementptr inbounds ptr, ptr %42, i64 %indvars.iv.i.epil
  %145 = load ptr, ptr %arrayidx8.i.epil, align 8, !tbaa !9
  store i32 %add141, ptr %145, align 4, !tbaa !5
...
for.cond10.preheader.i:                           ; preds = %for.cond10.preheader.i.loopexit.unr-lcssa, %for.body.i.epil, %if.end259
  %cmp12.not4.i = icmp slt i32 %conv3.i, 0
  br i1 %cmp12.not4.i, label %for.end23.i, label %for.body14.lr.ph.i

for.body14.lr.ph.i:                               ; preds = %for.cond10.preheader.i
  %146 = load ptr, ptr %43, align 8, !tbaa !9
  %147 = load ptr, ptr %42, align 8, !tbaa !9
  %148 = add i64 %call2.i, 1
  %wide.trip.count32.i = and i64 %148, 4294967295
  %min.iters.check613 = icmp ult i64 %wide.trip.count32.i, 8
  %149 = ptrtoint ptr %147 to i64
  %150 = ptrtoint ptr %146 to i64
  %151 = sub i64 %149, %150
  %diff.check = icmp ult i64 %151, 32
...
vector.ph614:                                     ; preds = %for.body14.lr.ph.i
  %n.mod.vf615 = and i64 %148, 7
  %n.vec616 = sub nsw i64 %wide.trip.count32.i, %n.mod.vf615
...
vector.body619:                                   ; preds = %vector.body619, %vector.ph614
  ...
  %152 = getelementptr inbounds i32, ptr %146, i64 %index620
  store <4 x i32> %broadcast.splat, ptr %152, align 4, !tbaa !5
  %153 = getelementptr inbounds i32, ptr %152, i64 4
  store <4 x i32> %broadcast.splat622, ptr %153, align 4, !tbaa !5
  %154 = getelementptr inbounds i32, ptr %147, i64 %index620
  store <4 x i32> %broadcast.splat, ptr %154, align 4, !tbaa !5
  %155 = getelementptr inbounds i32, ptr %154, i64 4
  store <4 x i32> %broadcast.splat622, ptr %155, align 4, !tbaa !5
  %index.next623 = add nuw i64 %index620, 8
  %156 = icmp eq i64 %index.next623, %n.vec616
  br i1 %156, label %middle.block611, label %vector.body619, !llvm.loop !39
...
for.body14.i.preheader:                           ; preds = %for.body14.lr.ph.i, %middle.block611
  %indvars.iv29.i.ph = phi i64 [ 0, %for.body14.lr.ph.i ], [ %n.vec616, %middle.block611 ]
  %157 = sub i64 %148, %indvars.iv29.i.ph
  %158 = xor i64 %indvars.iv29.i.ph, -1
  %159 = add nsw i64 %wide.trip.count32.i, %158
  %xtraiter638 = and i64 %157, 3
...
for.body14.i.prol:                                ; preds = %for.body14.i.preheader, %for.body14.i.prol
  %indvars.iv29.i.prol = phi i64 [ %indvars.iv.next30.i.prol, %for.body14.i.prol ], [ %indvars.iv29.i.ph, %for.body14.i.preheader ]
  %prol.iter640 = phi i64 [ %prol.iter640.next, %for.body14.i.prol ], [ 0, %for.body14.i.preheader ]
  %arrayidx17.i.prol = getelementptr inbounds i32, ptr %146, i64 %indvars.iv29.i.prol
  store i32 %add141, ptr %arrayidx17.i.prol, align 4, !tbaa !5
  %arrayidx20.i.prol = getelementptr inbounds i32, ptr %147, i64 %indvars.iv29.i.prol
  store i32 %add141, ptr %arrayidx20.i.prol, align 4, !tbaa !5
  %indvars.iv.next30.i.prol = add nuw nsw i64 %indvars.iv29.i.prol, 1
...
for.body14.i.prol.loopexit:                       ; preds = %for.body14.i.prol, %for.body14.i.preheader
  %indvars.iv29.i.unr = phi i64 [ %indvars.iv29.i.ph, %for.body14.i.preheader ], [ %indvars.iv.next30.i.prol, %for.body14.i.prol ]
  %160 = icmp ult i64 %159, 3
  br i1 %160, label %for.end23.i, label %for.body14.i
...
for.body14.i:                                     ; preds = %for.body14.i.prol.loopexit, %for.body14.i
  %indvars.iv29.i = phi i64 [ %indvars.iv.next30.i.3, %for.body14.i ], [ %indvars.iv29.i.unr, %for.body14.i.prol.loopexit ]
  %arrayidx17.i = getelementptr inbounds i32, ptr %146, i64 %indvars.iv29.i
  store i32 %add141, ptr %arrayidx17.i, align 4, !tbaa !5
  %arrayidx20.i = getelementptr inbounds i32, ptr %147, i64 %indvars.iv29.i
  store i32 %add141, ptr %arrayidx20.i, align 4, !tbaa !5
  %indvars.iv.next30.i = add nuw nsw i64 %indvars.iv29.i, 1
  %arrayidx17.i.1 = getelementptr inbounds i32, ptr %146, i64 %indvars.iv.next30.i
  store i32 %add141, ptr %arrayidx17.i.1, align 4, !tbaa !5
  %arrayidx20.i.1 = getelementptr inbounds i32, ptr %147, i64 %indvars.iv.next30.i
  store i32 %add141, ptr %arrayidx20.i.1, align 4, !tbaa !5
  %indvars.iv.next30.i.1 = add nuw nsw i64 %indvars.iv29.i, 2
  %arrayidx17.i.2 = getelementptr inbounds i32, ptr %146, i64 %indvars.iv.next30.i.1
  store i32 %add141, ptr %arrayidx17.i.2, align 4, !tbaa !5
  %arrayidx20.i.2 = getelementptr inbounds i32, ptr %147, i64 %indvars.iv.next30.i.1
  store i32 %add141, ptr %arrayidx20.i.2, align 4, !tbaa !5
  %indvars.iv.next30.i.2 = add nuw nsw i64 %indvars.iv29.i, 3
  %arrayidx17.i.3 = getelementptr inbounds i32, ptr %146, i64 %indvars.iv.next30.i.2
  store i32 %add141, ptr %arrayidx17.i.3, align 4, !tbaa !5
  %arrayidx20.i.3 = getelementptr inbounds i32, ptr %147, i64 %indvars.iv.next30.i.2
  store i32 %add141, ptr %arrayidx20.i.3, align 4, !tbaa !5
  %indvars.iv.next30.i.3 = add nuw nsw i64 %indvars.iv29.i, 4
  %exitcond33.not.i.3 = icmp eq i64 %indvars.iv.next30.i.3, %wide.trip.count32.i
  br i1 %exitcond33.not.i.3, label %for.end23.i, label %for.body14.i, !llvm.loop !42
...
for.end23.i:                                      ; preds = %for.body14.i.prol.loopexit, %for.body14.i, %middle.block611, %for.cond10.preheader.i
  ...
  %169 = load ptr, ptr %137, align 8, !tbaa !9
  %idx.ext.i = sext i32 %add24.i to i64
  %add.ptr.i = getelementptr inbounds i8, ptr %169, i64 %idx.ext.i
  store ptr %add.ptr.i, ptr %137, align 8, !tbaa !9
  store i8 0, ptr %add.ptr.i, align 1, !tbaa !11
  %170 = load ptr, ptr %138, align 8, !tbaa !9
  %add.ptr30.i = getelementptr inbounds i8, ptr %170, i64 %idx.ext.i
  store ptr %add.ptr30.i, ptr %138, align 8, !tbaa !9
  store i8 0, ptr %add.ptr30.i, align 1, !tbaa !11
  %cmp34.not15.i = icmp slt i32 %add24.i, 0
  br i1 %cmp34.not15.i, label %.thread.i, label %for.body36.lr.ph.i
...
for.body36.lr.ph.i:                               ; preds = %for.end23.i
  ...
  %.pre42.i = load i32, ptr %arrayidx40.phi.trans.insert.i, align 4, !tbaa !5
  %arrayidx42.phi.trans.insert.i = getelementptr inbounds ptr, ptr %42, i64 %idxprom248
  %.pre43.i = load ptr, ptr %arrayidx42.phi.trans.insert.i, align 8, !tbaa !9
  %arrayidx44.phi.trans.insert.i = getelementptr inbounds i32, ptr %.pre43.i, i64 %idxprom250
  %.pre44.i = load i32, ptr %arrayidx44.phi.trans.insert.i, align 4, !tbaa !5
  br label %for.body36.i

for.body36.i:                                     ; preds = %if.end90.i, %for.body36.lr.ph.i
  %171 = phi i32 [ %.pre44.i, %for.body36.lr.ph.i ], [ %226, %if.end90.i ]
  %172 = phi i32 [ %.pre42.i, %for.body36.lr.ph.i ], [ %224, %if.end90.i ]
  %k.018.i = phi i32 [ 0, %for.body36.lr.ph.i ], [ %inc101.i, %if.end90.i ]
  %iin.017.i = phi i32 [ %endali.0.lcssa, %for.body36.lr.ph.i ], [ %.fr.i, %if.end90.i ]
  %jin.016.i = phi i32 [ %endalj.0.lcssa, %for.body36.lr.ph.i ], [ %.fr57.i, %if.end90.i ]
  %.fr57.i = freeze i32 %171
  %.fr.i = freeze i32 %172
  %173 = xor i32 %.fr.i, -1
  %dec6.i = add i32 %iin.017.i, %173
  %tobool.not7.i = icmp eq i32 %dec6.i, 0
  br i1 %tobool.not7.i, label %while.end.i, label %while.body.preheader.i

while.body.preheader.i:                           ; preds = %for.body36.i
  %174 = sext i32 %dec6.i to i64
  %175 = sext i32 %.fr.i to i64
  %176 = add i32 %iin.017.i, -2
  %xtraiter641 = and i32 %dec6.i, 1
  %lcmp.mod642.not = icmp eq i32 %xtraiter641, 0
  br i1 %lcmp.mod642.not, label %while.body.i503.prol.loopexit, label %while.body.i503.prol

while.body.i503.prol:                             ; preds = %while.body.preheader.i
  %177 = load ptr, ptr %seq1, align 8, !tbaa !9
  %178 = add nsw i64 %174, %175
  %arrayidx48.i.prol = getelementptr inbounds i8, ptr %177, i64 %178
  %179 = load i8, ptr %arrayidx48.i.prol, align 1, !tbaa !11
  %180 = load ptr, ptr %137, align 8, !tbaa !9
  %incdec.ptr.i501.prol = getelementptr inbounds i8, ptr %180, i64 -1
  store ptr %incdec.ptr.i501.prol, ptr %137, align 8, !tbaa !9
  store i8 %179, ptr %incdec.ptr.i501.prol, align 1, !tbaa !11
  %181 = load ptr, ptr %138, align 8, !tbaa !9
  %incdec.ptr51.i.prol = getelementptr inbounds i8, ptr %181, i64 -1
  store ptr %incdec.ptr51.i.prol, ptr %138, align 8, !tbaa !9
  store i8 45, ptr %incdec.ptr51.i.prol, align 1, !tbaa !11
  %indvars.iv.next35.i.prol = add nsw i64 %174, -1
  br label %while.body.i503.prol.loopexit

while.body.i503.prol.loopexit:                    ; preds = %while.body.i503.prol, %while.body.preheader.i
  %indvars.iv34.i.unr = phi i64 [ %174, %while.body.preheader.i ], [ %indvars.iv.next35.i.prol, %while.body.i503.prol ]
  %182 = icmp eq i32 %176, %.fr.i
  br i1 %182, label %while.end.loopexit.i, label %while.body.i503

while.body.i503:                                  ; preds = %while.body.i503.prol.loopexit, %while.body.i503
  %indvars.iv34.i = phi i64 [ %indvars.iv.next35.i.1, %while.body.i503 ], [ %indvars.iv34.i.unr, %while.body.i503.prol.loopexit ]
  %183 = load ptr, ptr %seq1, align 8, !tbaa !9
  %184 = add nsw i64 %indvars.iv34.i, %175
  %arrayidx48.i = getelementptr inbounds i8, ptr %183, i64 %184
  %185 = load i8, ptr %arrayidx48.i, align 1, !tbaa !11
  %186 = load ptr, ptr %137, align 8, !tbaa !9
  %incdec.ptr.i501 = getelementptr inbounds i8, ptr %186, i64 -1
  store ptr %incdec.ptr.i501, ptr %137, align 8, !tbaa !9
  store i8 %185, ptr %incdec.ptr.i501, align 1, !tbaa !11
  %187 = load ptr, ptr %138, align 8, !tbaa !9
  %incdec.ptr51.i = getelementptr inbounds i8, ptr %187, i64 -1
  store ptr %incdec.ptr51.i, ptr %138, align 8, !tbaa !9
  store i8 45, ptr %incdec.ptr51.i, align 1, !tbaa !11
  %indvars.iv.next35.i = add nsw i64 %indvars.iv34.i, -1
  %188 = load ptr, ptr %seq1, align 8, !tbaa !9
  %189 = add nsw i64 %indvars.iv.next35.i, %175
  %arrayidx48.i.1 = getelementptr inbounds i8, ptr %188, i64 %189
  %190 = load i8, ptr %arrayidx48.i.1, align 1, !tbaa !11
  %191 = load ptr, ptr %137, align 8, !tbaa !9
  %incdec.ptr.i501.1 = getelementptr inbounds i8, ptr %191, i64 -1
  store ptr %incdec.ptr.i501.1, ptr %137, align 8, !tbaa !9
  store i8 %190, ptr %incdec.ptr.i501.1, align 1, !tbaa !11
  %192 = load ptr, ptr %138, align 8, !tbaa !9
  %incdec.ptr51.i.1 = getelementptr inbounds i8, ptr %192, i64 -1
  store ptr %incdec.ptr51.i.1, ptr %138, align 8, !tbaa !9
  store i8 45, ptr %incdec.ptr51.i.1, align 1, !tbaa !11
  %indvars.iv.next35.i.1 = add nsw i64 %indvars.iv34.i, -2
  %193 = and i64 %indvars.iv.next35.i.1, 4294967295
  %tobool.not.i502.1 = icmp eq i64 %193, 0
  br i1 %tobool.not.i502.1, label %while.end.loopexit.i, label %while.body.i503, !llvm.loop !43

while.end.loopexit.i:                             ; preds = %while.body.i503, %while.body.i503.prol.loopexit
  %194 = add i32 %k.018.i, %173
  %195 = add i32 %194, %iin.017.i
  br label %while.end.i

while.end.i:                                      ; preds = %while.end.loopexit.i, %for.body36.i
  %k.1.lcssa.i = phi i32 [ %k.018.i, %for.body36.i ], [ %195, %while.end.loopexit.i ]
  %196 = xor i32 %.fr57.i, -1
  %dec5510.i = add i32 %jin.016.i, %196
  %tobool56.not11.i = icmp eq i32 %dec5510.i, 0
  br i1 %tobool56.not11.i, label %while.end68.i, label %while.body57.preheader.i

while.body57.preheader.i:                         ; preds = %while.end.i
  %197 = sext i32 %dec5510.i to i64
  %198 = sext i32 %.fr57.i to i64
  %199 = add i32 %jin.016.i, -2
  %xtraiter644 = and i32 %dec5510.i, 1
...
while.body57.i.prol:                              ; preds = %while.body57.preheader.i
  %200 = load ptr, ptr %137, align 8, !tbaa !9
  %incdec.ptr60.i.prol = getelementptr inbounds i8, ptr %200, i64 -1
  store ptr %incdec.ptr60.i.prol, ptr %137, align 8, !tbaa !9
  store i8 45, ptr %incdec.ptr60.i.prol, align 1, !tbaa !11
  %201 = load ptr, ptr %seq2, align 8, !tbaa !9
  %202 = add nsw i64 %197, %198
  %arrayidx64.i.prol = getelementptr inbounds i8, ptr %201, i64 %202
  %203 = load i8, ptr %arrayidx64.i.prol, align 1, !tbaa !11
  %204 = load ptr, ptr %138, align 8, !tbaa !9
  %incdec.ptr66.i.prol = getelementptr inbounds i8, ptr %204, i64 -1
  store ptr %incdec.ptr66.i.prol, ptr %138, align 8, !tbaa !9
  store i8 %203, ptr %incdec.ptr66.i.prol, align 1, !tbaa !11
  %inc67.i.prol = add nsw i32 %k.1.lcssa.i, 1
  %indvars.iv.next39.i.prol = add nsw i64 %197, -1
...
while.body57.i.prol.loopexit:                     ; preds = %while.body57.i.prol, %while.body57.preheader.i
  ...
  %indvars.iv38.i.unr = phi i64 [ %197, %while.body57.preheader.i ], [ %indvars.iv.next39.i.prol, %while.body57.i.prol ]
  %k.212.i.unr = phi i32 [ %k.1.lcssa.i, %while.body57.preheader.i ], [ %inc67.i.prol, %while.body57.i.prol ]
  %205 = icmp eq i32 %199, %.fr57.i
  br i1 %205, label %while.end68.i, label %while.body57.i

while.body57.i:                                   ; preds = %while.body57.i.prol.loopexit, %while.body57.i
  %indvars.iv38.i = phi i64 [ %indvars.iv.next39.i.1, %while.body57.i ], [ %indvars.iv38.i.unr, %while.body57.i.prol.loopexit ]
  %k.212.i = phi i32 [ %inc67.i.1, %while.body57.i ], [ %k.212.i.unr, %while.body57.i.prol.loopexit ]
  %206 = load ptr, ptr %137, align 8, !tbaa !9
  %incdec.ptr60.i = getelementptr inbounds i8, ptr %206, i64 -1
  store ptr %incdec.ptr60.i, ptr %137, align 8, !tbaa !9
  store i8 45, ptr %incdec.ptr60.i, align 1, !tbaa !11
  %207 = load ptr, ptr %seq2, align 8, !tbaa !9
  %208 = add nsw i64 %indvars.iv38.i, %198
  %arrayidx64.i = getelementptr inbounds i8, ptr %207, i64 %208
  %209 = load i8, ptr %arrayidx64.i, align 1, !tbaa !11
  %210 = load ptr, ptr %138, align 8, !tbaa !9
  %incdec.ptr66.i = getelementptr inbounds i8, ptr %210, i64 -1
  store ptr %incdec.ptr66.i, ptr %138, align 8, !tbaa !9
  store i8 %209, ptr %incdec.ptr66.i, align 1, !tbaa !11
  %indvars.iv.next39.i = add nsw i64 %indvars.iv38.i, -1
  %211 = load ptr, ptr %137, align 8, !tbaa !9
  %incdec.ptr60.i.1 = getelementptr inbounds i8, ptr %211, i64 -1
  store ptr %incdec.ptr60.i.1, ptr %137, align 8, !tbaa !9
  store i8 45, ptr %incdec.ptr60.i.1, align 1, !tbaa !11
  %212 = load ptr, ptr %seq2, align 8, !tbaa !9
  %213 = add nsw i64 %indvars.iv.next39.i, %198
  %arrayidx64.i.1 = getelementptr inbounds i8, ptr %212, i64 %213
  %214 = load i8, ptr %arrayidx64.i.1, align 1, !tbaa !11
  %215 = load ptr, ptr %138, align 8, !tbaa !9
  %incdec.ptr66.i.1 = getelementptr inbounds i8, ptr %215, i64 -1
  store ptr %incdec.ptr66.i.1, ptr %138, align 8, !tbaa !9
  store i8 %214, ptr %incdec.ptr66.i.1, align 1, !tbaa !11
  %inc67.i.1 = add nsw i32 %k.212.i, 2
  %indvars.iv.next39.i.1 = add nsw i64 %indvars.iv38.i, -2
  %216 = and i64 %indvars.iv.next39.i.1, 4294967295
  %tobool56.not.i.1 = icmp eq i64 %216, 0
...
while.end68.i:                                    ; preds = %while.body57.i.prol.loopexit, %while.body57.i, %while.end.i
  ...
  %cmp69.i = icmp slt i32 %iin.017.i, 1
  %cmp71.i = icmp slt i32 %jin.016.i, 1
  %or.cond.i = or i1 %cmp69.i, %cmp71.i
  br i1 %or.cond.i, label %for.end102.i, label %if.end.i

if.end.i:                                         ; preds = %while.end68.i
  %217 = load ptr, ptr %seq1, align 8, !tbaa !9
  %idxprom74.i = sext i32 %.fr.i to i64
  %arrayidx75.i = getelementptr inbounds i8, ptr %217, i64 %idxprom74.i
  %218 = load i8, ptr %arrayidx75.i, align 1, !tbaa !11
  %219 = load ptr, ptr %137, align 8, !tbaa !9
  %incdec.ptr77.i = getelementptr inbounds i8, ptr %219, i64 -1
  store ptr %incdec.ptr77.i, ptr %137, align 8, !tbaa !9
  store i8 %218, ptr %incdec.ptr77.i, align 1, !tbaa !11
  %220 = load ptr, ptr %seq2, align 8, !tbaa !9
  %idxprom79.i = sext i32 %.fr57.i to i64
  %arrayidx80.i = getelementptr inbounds i8, ptr %220, i64 %idxprom79.i
  %221 = load i8, ptr %arrayidx80.i, align 1, !tbaa !11
  %222 = load ptr, ptr %138, align 8, !tbaa !9
  %incdec.ptr82.i = getelementptr inbounds i8, ptr %222, i64 -1
  store ptr %incdec.ptr82.i, ptr %138, align 8, !tbaa !9
  store i8 %221, ptr %incdec.ptr82.i, align 1, !tbaa !11
  %arrayidx84.i = getelementptr inbounds ptr, ptr %43, i64 %idxprom74.i
  %223 = load ptr, ptr %arrayidx84.i, align 8, !tbaa !9
  %arrayidx86.i = getelementptr inbounds i32, ptr %223, i64 %idxprom79.i
  %224 = load i32, ptr %arrayidx86.i, align 4, !tbaa !5
  %cmp87.i = icmp eq i32 %224, %add141
...
if.end90.i:                                       ; preds = %if.end.i
  ...
  %225 = load ptr, ptr %arrayidx92.i, align 8, !tbaa !9
  %arrayidx94.i = getelementptr inbounds i32, ptr %225, i64 %idxprom79.i
  %226 = load i32, ptr %arrayidx94.i, align 4, !tbaa !5
  %cmp95.i = icmp eq i32 %226, %add141
  %inc101.i = add nsw i32 %k.2.lcssa.i, 2
  %cmp34.not.i = icmp sgt i32 %inc101.i, %add24.i
  %or.cond55.i = select i1 %cmp95.i, i1 true, i1 %cmp34.not.i
  br i1 %or.cond55.i, label %for.end102.i, label %for.body36.i, !llvm.loop !45
...
for.end102.i:                                     ; preds = %if.end90.i, %if.end.i, %while.end68.i
  ...
  %cmp107.i = icmp eq i32 %.fr57.i, -1
  %spec.select56.i = select i1 %cmp107.i, i32 0, i32 %.fr57.i
  br label %gentracking.exit

gentracking.exit:                                 ; preds = %.thread.i, %for.end102.i
  %227 = phi i32 [ 0, %.thread.i ], [ %spec.select56.i, %for.end102.i ]
  store i32 %227, ptr %off2pt, align 4, !tbaa !5
  %228 = load ptr, ptr %137, align 8, !tbaa !9
  %call262 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %228) #7
...
if.then269:                                       ; preds = %gentracking.exit
  ...
  %call270 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %229, ptr noundef nonnull @.str.1, i32 noundef %alloclen, i32 noundef %conv263, i32 noundef 5000000) #8
...
if.end271:                                        ; preds = %gentracking.exit, %if.then269
  %230 = phi ptr [ %138, %gentracking.exit ], [ %.pre585, %if.then269 ]
  %231 = phi ptr [ %228, %gentracking.exit ], [ %.pre584, %if.then269 ]
  %232 = load ptr, ptr %seq1, align 8, !tbaa !9
  %call274 = tail call ptr @strcpy(ptr noundef nonnull dereferenceable(1) %232, ptr noundef nonnull dereferenceable(1) %231) #6
  %233 = load ptr, ptr %seq2, align 8, !tbaa !9
  %234 = load ptr, ptr %230, align 8, !tbaa !9
  %call277 = tail call ptr @strcpy(ptr noundef nonnull dereferenceable(1) %233, ptr noundef nonnull dereferenceable(1) %234) #6
  br label %cleanup
