...
"for op_minpd_211.s0.x.x":                        ; preds = %"for op_minpd_211.s0.x.x", %"for op_minpd_211.s0.x.x.preheader"
  ...
  %8 = shufflevector <3 x double> %b133, <3 x double> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 undef>
  %9 = shufflevector <3 x double> %a118, <3 x double> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 undef>
  ...
  %21 = shufflevector <3 x double> %b133.1, <3 x double> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 undef>
  %22 = shufflevector <3 x double> %a118.1, <3 x double> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 undef>
