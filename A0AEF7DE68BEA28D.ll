; ModuleID = '/usr/local/google/home/aeubanks/repos/test-suite/Bitcode/Regression/fft/modules/FftConvolve16x16xCHalide_x86_64_linux_c_plus_plus_name_mangling_no_runtime_sse41.bc'
...
@str.15 = private constant [81 x i8] c"FftConvolve16x16xCHalide_x86_64_linux_c_plus_plus_name_mangling_no_runtime_sse41\00", align 32
@_Z89FftConvolve16x16xCHalide_x86_64_linux_c_plus_plus_name_mangling_no_runtime_sse41_metadatav_storage = private constant %struct.halide_filter_metadata_t { i32 0, i32 3, ptr @0, ptr @str.14, ptr @str.15 }
...
define i32 @_Z80FftConvolve16x16xCHalide_x86_64_linux_c_plus_plus_name_mangling_no_runtime_sse41P15halide_buffer_tS0_S0_(ptr noalias %input.buffer, ptr noalias %kernel.buffer, ptr noalias %"result$2.buffer") local_unnamed_addr #1 {
entry:
  %"inv_fft0_S4_R4_n0$2.17" = alloca [448 x float], align 16
  %"inv_fft0_S4_R4_n0$2.08" = alloca [448 x float], align 16
  %"inv_X4$11.117" = alloca [256 x float], align 16
  %"inv_X4$11.018" = alloca [256 x float], align 16
  %"inv_fft1_S4_R4_n1$2.119" = alloca [448 x float], align 16
  %"inv_fft1_S4_R4_n1$2.020" = alloca [448 x float], align 16
  %"kernel_fft1_S4_R4_n1$2.121" = alloca [256 x float], align 16
  %"kernel_fft1_S4_R4_n1$2.022" = alloca [256 x float], align 16
...
true_bb8:                                         ; preds = %_halide_buffer_is_bounds_query.exit53
  ...
  %.sroa.2490.0..sroa_idx = getelementptr inbounds i8, ptr %107, i64 4
  store i32 %108, ptr %.sroa.2490.0..sroa_idx, align 4
  %.sroa.3491.0..sroa_idx = getelementptr inbounds i8, ptr %107, i64 8
  store i32 1, ptr %.sroa.3491.0..sroa_idx, align 4
  %.sroa.4492.0..sroa_idx = getelementptr inbounds i8, ptr %107, i64 12
  ...
  %.sroa.7494.16..sroa_idx = getelementptr inbounds %struct.halide_dimension_t, ptr %111, i64 1, i32 1
  store i32 %70, ptr %.sroa.7494.16..sroa_idx, align 4
  %.sroa.8495.16..sroa_idx = getelementptr inbounds %struct.halide_dimension_t, ptr %111, i64 1, i32 2
  store i32 %108, ptr %.sroa.8495.16..sroa_idx, align 4
  %.sroa.9496.16..sroa_idx = getelementptr inbounds %struct.halide_dimension_t, ptr %111, i64 1, i32 3
  ...
  %.sroa.12498.32..sroa_idx = getelementptr inbounds %struct.halide_dimension_t, ptr %113, i64 2, i32 1
  store i32 %76, ptr %.sroa.12498.32..sroa_idx, align 4
  %.sroa.13499.32..sroa_idx = getelementptr inbounds %struct.halide_dimension_t, ptr %113, i64 2, i32 2
  store i32 %109, ptr %.sroa.13499.32..sroa_idx, align 4
  %.sroa.14500.32..sroa_idx = getelementptr inbounds %struct.halide_dimension_t, ptr %113, i64 2, i32 3
...
"produce f8":                                     ; preds = %"assert succeeded77"
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(1024) %"inv_X4$11.117", i8 0, i64 1024, i1 false), !tbaa !27
  %scevgep432 = getelementptr i8, ptr %32, i64 %260
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(64) %"inv_X4$11.018", ptr noundef nonnull align 4 dereferenceable(64) %scevgep432, i64 64, i1 false)
  %scevgep431.1 = getelementptr inbounds i8, ptr %"inv_X4$11.018", i64 64
  %262 = add i64 %260, %261
  %scevgep432.1 = getelementptr i8, ptr %32, i64 %262
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(64) %scevgep431.1, ptr noundef nonnull align 4 dereferenceable(64) %scevgep432.1, i64 64, i1 false)
  %scevgep431.2 = getelementptr inbounds i8, ptr %"inv_X4$11.018", i64 128
  %263 = shl nsw i64 %235, 3
  %264 = add i64 %260, %263
  %scevgep432.2 = getelementptr i8, ptr %32, i64 %264
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(64) %scevgep431.2, ptr noundef nonnull align 4 dereferenceable(64) %scevgep432.2, i64 64, i1 false)
  %scevgep431.3 = getelementptr inbounds i8, ptr %"inv_X4$11.018", i64 192
  %265 = mul nsw i64 %235, 12
  %266 = add i64 %260, %265
  %scevgep432.3 = getelementptr i8, ptr %32, i64 %266
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(64) %scevgep431.3, ptr noundef nonnull align 4 dereferenceable(64) %scevgep432.3, i64 64, i1 false)
  %scevgep431.4 = getelementptr inbounds i8, ptr %"inv_X4$11.018", i64 256
  %267 = shl nsw i64 %235, 4
  %268 = add i64 %260, %267
  %scevgep432.4 = getelementptr i8, ptr %32, i64 %268
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(64) %scevgep431.4, ptr noundef nonnull align 4 dereferenceable(64) %scevgep432.4, i64 64, i1 false)
  %scevgep431.5 = getelementptr inbounds i8, ptr %"inv_X4$11.018", i64 320
  %269 = mul nsw i64 %235, 20
  %270 = add i64 %260, %269
  %scevgep432.5 = getelementptr i8, ptr %32, i64 %270
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(64) %scevgep431.5, ptr noundef nonnull align 4 dereferenceable(64) %scevgep432.5, i64 64, i1 false)
  %scevgep431.6 = getelementptr inbounds i8, ptr %"inv_X4$11.018", i64 384
  %271 = mul nsw i64 %235, 24
  %272 = add i64 %260, %271
  %scevgep432.6 = getelementptr i8, ptr %32, i64 %272
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(64) %scevgep431.6, ptr noundef nonnull align 4 dereferenceable(64) %scevgep432.6, i64 64, i1 false)
  %scevgep431.7 = getelementptr inbounds i8, ptr %"inv_X4$11.018", i64 448
  %273 = mul nsw i64 %235, 28
  %274 = add i64 %260, %273
  %scevgep432.7 = getelementptr i8, ptr %32, i64 %274
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(64) %scevgep431.7, ptr noundef nonnull align 4 dereferenceable(64) %scevgep432.7, i64 64, i1 false)
  %scevgep431.8 = getelementptr inbounds i8, ptr %"inv_X4$11.018", i64 512
  %275 = shl nsw i64 %235, 5
  %276 = add i64 %260, %275
  %scevgep432.8 = getelementptr i8, ptr %32, i64 %276
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(64) %scevgep431.8, ptr noundef nonnull align 4 dereferenceable(64) %scevgep432.8, i64 64, i1 false)
  %scevgep431.9 = getelementptr inbounds i8, ptr %"inv_X4$11.018", i64 576
  %277 = mul nsw i64 %235, 36
  %278 = add i64 %260, %277
  %scevgep432.9 = getelementptr i8, ptr %32, i64 %278
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(64) %scevgep431.9, ptr noundef nonnull align 4 dereferenceable(64) %scevgep432.9, i64 64, i1 false)
  %scevgep431.10 = getelementptr inbounds i8, ptr %"inv_X4$11.018", i64 640
  %279 = mul nsw i64 %235, 40
  %280 = add i64 %260, %279
  %scevgep432.10 = getelementptr i8, ptr %32, i64 %280
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(64) %scevgep431.10, ptr noundef nonnull align 4 dereferenceable(64) %scevgep432.10, i64 64, i1 false)
  %scevgep431.11 = getelementptr inbounds i8, ptr %"inv_X4$11.018", i64 704
  %281 = mul nsw i64 %235, 44
  %282 = add i64 %260, %281
  %scevgep432.11 = getelementptr i8, ptr %32, i64 %282
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(64) %scevgep431.11, ptr noundef nonnull align 4 dereferenceable(64) %scevgep432.11, i64 64, i1 false)
  %scevgep431.12 = getelementptr inbounds i8, ptr %"inv_X4$11.018", i64 768
  %283 = mul nsw i64 %235, 48
  %284 = add i64 %260, %283
  %scevgep432.12 = getelementptr i8, ptr %32, i64 %284
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(64) %scevgep431.12, ptr noundef nonnull align 4 dereferenceable(64) %scevgep432.12, i64 64, i1 false)
  %scevgep431.13 = getelementptr inbounds i8, ptr %"inv_X4$11.018", i64 832
  %285 = mul nsw i64 %235, 52
  %286 = add i64 %260, %285
  %scevgep432.13 = getelementptr i8, ptr %32, i64 %286
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(64) %scevgep431.13, ptr noundef nonnull align 4 dereferenceable(64) %scevgep432.13, i64 64, i1 false)
  %scevgep431.14 = getelementptr inbounds i8, ptr %"inv_X4$11.018", i64 896
  %287 = mul nsw i64 %235, 56
  %288 = add i64 %260, %287
  %scevgep432.14 = getelementptr i8, ptr %32, i64 %288
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(64) %scevgep431.14, ptr noundef nonnull align 4 dereferenceable(64) %scevgep432.14, i64 64, i1 false)
  %scevgep431.15 = getelementptr inbounds i8, ptr %"inv_X4$11.018", i64 960
  %289 = mul nsw i64 %235, 60
  %290 = add i64 %260, %289
  %scevgep432.15 = getelementptr i8, ptr %32, i64 %290
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(64) %scevgep431.15, ptr noundef nonnull align 4 dereferenceable(64) %scevgep432.15, i64 64, i1 false)
...
"for kernel_fft0_S4_R4_n0$2.s1.n1":               ; preds = %"produce f8", %"for kernel_fft0_S4_R4_n0$2.s1.n1"
  ...
  %292 = getelementptr inbounds float, ptr %"inv_X4$11.018", i64 %291
  %293 = load <4 x float>, ptr %292, align 16, !tbaa !30
  %294 = or i64 %291, 8
  %295 = getelementptr inbounds float, ptr %"inv_X4$11.018", i64 %294
  %296 = load <4 x float>, ptr %295, align 16, !tbaa !30
  %297 = fadd <4 x float> %293, %296
  %298 = getelementptr inbounds float, ptr %"inv_X4$11.117", i64 %291
  %299 = load <4 x float>, ptr %298, align 16, !tbaa !27
  %300 = getelementptr inbounds float, ptr %"inv_X4$11.117", i64 %294
  %301 = load <4 x float>, ptr %300, align 16, !tbaa !27
  %302 = fadd <4 x float> %299, %301
  %303 = or i64 %291, 4
  %304 = getelementptr inbounds float, ptr %"inv_X4$11.018", i64 %303
  %305 = load <4 x float>, ptr %304, align 16, !tbaa !30
  %306 = or i64 %291, 12
  %307 = getelementptr inbounds float, ptr %"inv_X4$11.018", i64 %306
  %308 = load <4 x float>, ptr %307, align 16, !tbaa !30
  %309 = fadd <4 x float> %305, %308
  %310 = getelementptr inbounds float, ptr %"inv_X4$11.117", i64 %303
  %311 = load <4 x float>, ptr %310, align 16, !tbaa !27
  %312 = getelementptr inbounds float, ptr %"inv_X4$11.117", i64 %306
  ...
  %376 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.020", i64 %375
  store <4 x float> %363, ptr %376, align 16, !tbaa !32
  %377 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.119", i64 %375
  store <4 x float> %364, ptr %377, align 16, !tbaa !34
  %378 = add nuw nsw i64 %375, 4
  %379 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.020", i64 %378
  store <4 x float> %371, ptr %379, align 16, !tbaa !32
  %380 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.119", i64 %378
  store <4 x float> %372, ptr %380, align 16, !tbaa !34
  %381 = add nuw nsw i64 %375, 8
  %382 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.020", i64 %381
  store <4 x float> %365, ptr %382, align 16, !tbaa !32
  %383 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.119", i64 %381
  store <4 x float> %366, ptr %383, align 16, !tbaa !34
  %384 = add nuw nsw i64 %375, 12
  %385 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.020", i64 %384
  store <4 x float> %373, ptr %385, align 16, !tbaa !32
  %386 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.119", i64 %384
  store <4 x float> %374, ptr %386, align 16, !tbaa !34
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %.not34 = icmp eq i64 %indvars.iv.next, 16
  br i1 %.not34, label %"for kernel_fft1_S4_R4_n1$2.s1.n0.g.preheader", label %"for kernel_fft0_S4_R4_n0$2.s1.n1"

"for kernel_fft1_S4_R4_n1$2.s1.n0.g.preheader":   ; preds = %"for kernel_fft0_S4_R4_n0$2.s1.n1"
  %387 = getelementptr inbounds float, ptr %"inv_X4$11.018", i64 4
  %388 = getelementptr inbounds float, ptr %"inv_X4$11.117", i64 4
  %389 = getelementptr inbounds float, ptr %"inv_X4$11.018", i64 8
  %390 = getelementptr inbounds float, ptr %"inv_X4$11.117", i64 8
  %391 = getelementptr inbounds float, ptr %"inv_X4$11.018", i64 12
  %392 = getelementptr inbounds float, ptr %"inv_X4$11.117", i64 12
  %393 = getelementptr inbounds float, ptr %"inv_X4$11.117", i64 16
  %394 = getelementptr inbounds float, ptr %"inv_X4$11.018", i64 20
  %395 = getelementptr inbounds float, ptr %"inv_X4$11.117", i64 20
  %396 = getelementptr inbounds float, ptr %"inv_X4$11.018", i64 24
  %397 = getelementptr inbounds float, ptr %"inv_X4$11.117", i64 24
  %398 = getelementptr inbounds float, ptr %"inv_X4$11.018", i64 28
  %399 = getelementptr inbounds float, ptr %"inv_X4$11.117", i64 28
  %400 = getelementptr inbounds float, ptr %"inv_X4$11.117", i64 32
  %401 = getelementptr inbounds float, ptr %"inv_X4$11.018", i64 36
  %402 = getelementptr inbounds float, ptr %"inv_X4$11.117", i64 36
  %403 = getelementptr inbounds float, ptr %"inv_X4$11.018", i64 40
  %404 = getelementptr inbounds float, ptr %"inv_X4$11.117", i64 40
  %405 = getelementptr inbounds float, ptr %"inv_X4$11.018", i64 44
  %406 = getelementptr inbounds float, ptr %"inv_X4$11.117", i64 44
  %407 = getelementptr inbounds float, ptr %"inv_X4$11.117", i64 48
  %408 = getelementptr inbounds float, ptr %"inv_X4$11.018", i64 52
  %409 = getelementptr inbounds float, ptr %"inv_X4$11.117", i64 52
  %410 = getelementptr inbounds float, ptr %"inv_X4$11.018", i64 56
  %411 = getelementptr inbounds float, ptr %"inv_X4$11.117", i64 56
  %412 = getelementptr inbounds float, ptr %"inv_X4$11.018", i64 60
  %413 = getelementptr inbounds float, ptr %"inv_X4$11.117", i64 60
...
"for kernel_fft1_S4_R4_n1$2.s1.n0.g":             ; preds = %"for kernel_fft1_S4_R4_n1$2.s1.n0.g.preheader", %"for kernel_fft1_S4_R4_n1$2.s1.n0.g"
  %indvars.iv443 = phi i64 [ 0, %"for kernel_fft1_S4_R4_n1$2.s1.n0.g.preheader" ], [ %indvars.iv.next444, %"for kernel_fft1_S4_R4_n1$2.s1.n0.g" ]
  %414 = shl nsw i64 %indvars.iv443, 2
  %415 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.020", i64 %414
  %416 = load <4 x float>, ptr %415, align 16, !tbaa !32
  %417 = add nuw nsw i64 %414, 224
  %418 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.020", i64 %417
  %419 = load <4 x float>, ptr %418, align 16, !tbaa !32
  %420 = fadd <4 x float> %416, %419
  %421 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.119", i64 %414
  %422 = load <4 x float>, ptr %421, align 16, !tbaa !34
  %423 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.119", i64 %417
  %424 = load <4 x float>, ptr %423, align 16, !tbaa !34
  %425 = fadd <4 x float> %422, %424
  %426 = add nuw nsw i64 %414, 112
  %427 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.020", i64 %426
  %428 = load <4 x float>, ptr %427, align 16, !tbaa !32
  %429 = add nuw nsw i64 %414, 336
  %430 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.020", i64 %429
  %431 = load <4 x float>, ptr %430, align 16, !tbaa !32
  %432 = fadd <4 x float> %428, %431
  %433 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.119", i64 %426
  %434 = load <4 x float>, ptr %433, align 16, !tbaa !34
  %435 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.119", i64 %429
  ...
  %451 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.020", i64 %450
  %452 = load <4 x float>, ptr %451, align 16, !tbaa !32
  %453 = add nuw nsw i64 %414, 252
  %454 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.020", i64 %453
  %455 = load <4 x float>, ptr %454, align 16, !tbaa !32
  %456 = fadd <4 x float> %452, %455
  %457 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.119", i64 %450
  %458 = load <4 x float>, ptr %457, align 16, !tbaa !34
  %459 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.119", i64 %453
  %460 = load <4 x float>, ptr %459, align 16, !tbaa !34
  %461 = fadd <4 x float> %458, %460
  %462 = add nuw nsw i64 %414, 140
  %463 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.020", i64 %462
  %464 = load <4 x float>, ptr %463, align 16, !tbaa !32
  %465 = add nuw nsw i64 %414, 364
  %466 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.020", i64 %465
  %467 = load <4 x float>, ptr %466, align 16, !tbaa !32
  %468 = fadd <4 x float> %464, %467
  %469 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.119", i64 %462
  %470 = load <4 x float>, ptr %469, align 16, !tbaa !34
  %471 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.119", i64 %465
  ...
  %487 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.020", i64 %486
  %488 = load <4 x float>, ptr %487, align 16, !tbaa !32
  %489 = add nuw nsw i64 %414, 280
  %490 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.020", i64 %489
  %491 = load <4 x float>, ptr %490, align 16, !tbaa !32
  %492 = fadd <4 x float> %488, %491
  %493 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.119", i64 %486
  %494 = load <4 x float>, ptr %493, align 16, !tbaa !34
  %495 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.119", i64 %489
  %496 = load <4 x float>, ptr %495, align 16, !tbaa !34
  %497 = fadd <4 x float> %494, %496
  %498 = add nuw nsw i64 %414, 168
  %499 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.020", i64 %498
  %500 = load <4 x float>, ptr %499, align 16, !tbaa !32
  %501 = add nuw nsw i64 %414, 392
  %502 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.020", i64 %501
  %503 = load <4 x float>, ptr %502, align 16, !tbaa !32
  %504 = fadd <4 x float> %500, %503
  %505 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.119", i64 %498
  %506 = load <4 x float>, ptr %505, align 16, !tbaa !34
  %507 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.119", i64 %501
  ...
  %523 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.020", i64 %522
  %524 = load <4 x float>, ptr %523, align 16, !tbaa !32
  %525 = add nuw nsw i64 %414, 308
  %526 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.020", i64 %525
  %527 = load <4 x float>, ptr %526, align 16, !tbaa !32
  %528 = fadd <4 x float> %524, %527
  %529 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.119", i64 %522
  %530 = load <4 x float>, ptr %529, align 16, !tbaa !34
  %531 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.119", i64 %525
  %532 = load <4 x float>, ptr %531, align 16, !tbaa !34
  %533 = fadd <4 x float> %530, %532
  %534 = add nuw nsw i64 %414, 196
  %535 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.020", i64 %534
  %536 = load <4 x float>, ptr %535, align 16, !tbaa !32
  %537 = add nuw nsw i64 %414, 420
  %538 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.020", i64 %537
  %539 = load <4 x float>, ptr %538, align 16, !tbaa !32
  %540 = fadd <4 x float> %536, %539
  %541 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.119", i64 %534
  %542 = load <4 x float>, ptr %541, align 16, !tbaa !34
  %543 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.119", i64 %537
  ...
  %586 = getelementptr inbounds float, ptr %"kernel_fft1_S4_R4_n1$2.022", i64 %414
  store <4 x float> %574, ptr %586, align 16, !tbaa !36
  %587 = getelementptr inbounds float, ptr %"kernel_fft1_S4_R4_n1$2.121", i64 %414
  store <4 x float> %575, ptr %587, align 16, !tbaa !38
  %588 = add nuw nsw i64 %414, 64
  %589 = getelementptr inbounds float, ptr %"kernel_fft1_S4_R4_n1$2.022", i64 %588
  store <4 x float> %582, ptr %589, align 16, !tbaa !36
  %590 = getelementptr inbounds float, ptr %"kernel_fft1_S4_R4_n1$2.121", i64 %588
  store <4 x float> %583, ptr %590, align 16, !tbaa !38
  %591 = add nuw nsw i64 %414, 128
  %592 = getelementptr inbounds float, ptr %"kernel_fft1_S4_R4_n1$2.022", i64 %591
  store <4 x float> %576, ptr %592, align 16, !tbaa !36
  %593 = getelementptr inbounds float, ptr %"kernel_fft1_S4_R4_n1$2.121", i64 %591
  store <4 x float> %577, ptr %593, align 16, !tbaa !38
  %594 = add nuw nsw i64 %414, 192
  %595 = getelementptr inbounds float, ptr %"kernel_fft1_S4_R4_n1$2.022", i64 %594
  store <4 x float> %584, ptr %595, align 16, !tbaa !36
  %596 = getelementptr inbounds float, ptr %"kernel_fft1_S4_R4_n1$2.121", i64 %594
  ...
  %632 = getelementptr inbounds float, ptr %"kernel_fft1_S4_R4_n1$2.022", i64 %631
  store <4 x float> %619, ptr %632, align 16, !tbaa !36
  %633 = getelementptr inbounds float, ptr %"kernel_fft1_S4_R4_n1$2.121", i64 %631
  store <4 x float> %620, ptr %633, align 16, !tbaa !38
  %634 = add nuw nsw i64 %414, 80
  %635 = getelementptr inbounds float, ptr %"kernel_fft1_S4_R4_n1$2.022", i64 %634
  store <4 x float> %627, ptr %635, align 16, !tbaa !36
  %636 = getelementptr inbounds float, ptr %"kernel_fft1_S4_R4_n1$2.121", i64 %634
  store <4 x float> %628, ptr %636, align 16, !tbaa !38
  %637 = add nuw nsw i64 %414, 144
  %638 = getelementptr inbounds float, ptr %"kernel_fft1_S4_R4_n1$2.022", i64 %637
  store <4 x float> %621, ptr %638, align 16, !tbaa !36
  %639 = getelementptr inbounds float, ptr %"kernel_fft1_S4_R4_n1$2.121", i64 %637
  store <4 x float> %622, ptr %639, align 16, !tbaa !38
  %640 = add nuw nsw i64 %414, 208
  %641 = getelementptr inbounds float, ptr %"kernel_fft1_S4_R4_n1$2.022", i64 %640
  store <4 x float> %629, ptr %641, align 16, !tbaa !36
  %642 = getelementptr inbounds float, ptr %"kernel_fft1_S4_R4_n1$2.121", i64 %640
  ...
  %674 = getelementptr inbounds float, ptr %"kernel_fft1_S4_R4_n1$2.022", i64 %673
  store <4 x float> %661, ptr %674, align 16, !tbaa !36
  %675 = getelementptr inbounds float, ptr %"kernel_fft1_S4_R4_n1$2.121", i64 %673
  store <4 x float> %662, ptr %675, align 16, !tbaa !38
  %676 = add nuw nsw i64 %414, 96
  %677 = getelementptr inbounds float, ptr %"kernel_fft1_S4_R4_n1$2.022", i64 %676
  store <4 x float> %669, ptr %677, align 16, !tbaa !36
  %678 = getelementptr inbounds float, ptr %"kernel_fft1_S4_R4_n1$2.121", i64 %676
  store <4 x float> %670, ptr %678, align 16, !tbaa !38
  %679 = add nuw nsw i64 %414, 160
  %680 = getelementptr inbounds float, ptr %"kernel_fft1_S4_R4_n1$2.022", i64 %679
  store <4 x float> %663, ptr %680, align 16, !tbaa !36
  %681 = getelementptr inbounds float, ptr %"kernel_fft1_S4_R4_n1$2.121", i64 %679
  store <4 x float> %664, ptr %681, align 16, !tbaa !38
  %682 = add nuw nsw i64 %414, 224
  %683 = getelementptr inbounds float, ptr %"kernel_fft1_S4_R4_n1$2.022", i64 %682
  store <4 x float> %671, ptr %683, align 16, !tbaa !36
  %684 = getelementptr inbounds float, ptr %"kernel_fft1_S4_R4_n1$2.121", i64 %682
  ...
  %718 = getelementptr inbounds float, ptr %"kernel_fft1_S4_R4_n1$2.022", i64 %717
  store <4 x float> %705, ptr %718, align 16, !tbaa !36
  %719 = getelementptr inbounds float, ptr %"kernel_fft1_S4_R4_n1$2.121", i64 %717
  store <4 x float> %706, ptr %719, align 16, !tbaa !38
  %720 = add nuw nsw i64 %414, 112
  %721 = getelementptr inbounds float, ptr %"kernel_fft1_S4_R4_n1$2.022", i64 %720
  store <4 x float> %713, ptr %721, align 16, !tbaa !36
  %722 = getelementptr inbounds float, ptr %"kernel_fft1_S4_R4_n1$2.121", i64 %720
  store <4 x float> %714, ptr %722, align 16, !tbaa !38
  %723 = add nuw nsw i64 %414, 176
  %724 = getelementptr inbounds float, ptr %"kernel_fft1_S4_R4_n1$2.022", i64 %723
  store <4 x float> %707, ptr %724, align 16, !tbaa !36
  %725 = getelementptr inbounds float, ptr %"kernel_fft1_S4_R4_n1$2.121", i64 %723
  store <4 x float> %708, ptr %725, align 16, !tbaa !38
  %726 = add nuw nsw i64 %414, 240
  %727 = getelementptr inbounds float, ptr %"kernel_fft1_S4_R4_n1$2.022", i64 %726
  store <4 x float> %715, ptr %727, align 16, !tbaa !36
  %728 = getelementptr inbounds float, ptr %"kernel_fft1_S4_R4_n1$2.121", i64 %726
  store <4 x float> %716, ptr %728, align 16, !tbaa !38
  %indvars.iv.next444 = add nuw nsw i64 %indvars.iv443, 1
  %.not37 = icmp eq i64 %indvars.iv.next444, 4
  br i1 %.not37, label %"produce result$2", label %"for kernel_fft1_S4_R4_n1$2.s1.n0.g"

"produce result$2":                               ; preds = %"for kernel_fft1_S4_R4_n1$2.s1.n0.g"
  store <4 x float> %438, ptr %"inv_X4$11.018", align 16, !tbaa !30
  store <4 x float> %439, ptr %"inv_X4$11.117", align 16, !tbaa !27
  ...
  store <4 x float> %474, ptr %scevgep431.1, align 16, !tbaa !30
  ...
  store <4 x float> %510, ptr %scevgep431.2, align 16, !tbaa !30
  ...
  store <4 x float> %546, ptr %scevgep431.3, align 16, !tbaa !30
  ...
  %729 = getelementptr inbounds float, ptr %"inv_X4$11.018", i64 4
  %730 = getelementptr inbounds float, ptr %"inv_X4$11.117", i64 4
  %731 = getelementptr inbounds float, ptr %"inv_X4$11.018", i64 8
  %732 = getelementptr inbounds float, ptr %"inv_X4$11.117", i64 8
  %733 = getelementptr inbounds float, ptr %"inv_X4$11.018", i64 12
  %734 = getelementptr inbounds float, ptr %"inv_X4$11.117", i64 12
  %735 = getelementptr inbounds float, ptr %"inv_X4$11.117", i64 16
  %736 = getelementptr inbounds float, ptr %"inv_X4$11.018", i64 20
  %737 = getelementptr inbounds float, ptr %"inv_X4$11.117", i64 20
...
"for result$2.s0.i.preheader":                    ; preds = %"produce result$2"
  ...
  %756 = zext i32 %a39 to i64
  %xtraiter = and i64 %756, 1
  %757 = icmp eq i32 %a39, 1
...
"for result$2.s0.i":                              ; preds = %"for result$2.s0.i.preheader", %"end for result$2.s0.n1"
  %indvars.iv478 = phi i64 [ %752, %"for result$2.s0.i.preheader" ], [ %indvars.iv.next479, %"end for result$2.s0.n1" ]
  %758 = trunc i64 %indvars.iv478 to i32
  %reass.add360 = sub i32 %758, %26
  %reass.mul361 = mul i32 %reass.add360, %30
  %759 = sub i32 %reass.mul361, %14
...
"for fwd_fft0_S4_R4_n0$2.s1.n1":                  ; preds = %"for result$2.s0.i", %"for fwd_fft0_S4_R4_n0$2.s1.n1"
  %indvars.iv446 = phi i64 [ 0, %"for result$2.s0.i" ], [ %indvars.iv.next447, %"for fwd_fft0_S4_R4_n0$2.s1.n1" ]
  %760 = trunc i64 %indvars.iv446 to i32
  %reass.add362 = sub i32 %760, %20
  %reass.mul363 = mul i32 %reass.add362, %24
  %t2916 = add i32 %759, %reass.mul363
  %761 = sext i32 %t2916 to i64
  ...
  %829 = mul nuw nsw i64 %indvars.iv446, 28
  %830 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.020", i64 %829
  store <4 x float> %817, ptr %830, align 16, !tbaa !32
  %831 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.119", i64 %829
  store <4 x float> %818, ptr %831, align 16, !tbaa !34
  %832 = add nuw nsw i64 %829, 4
  %833 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.020", i64 %832
  store <4 x float> %825, ptr %833, align 16, !tbaa !32
  %834 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.119", i64 %832
  store <4 x float> %826, ptr %834, align 16, !tbaa !34
  %835 = add nuw nsw i64 %829, 8
  %836 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.020", i64 %835
  store <4 x float> %819, ptr %836, align 16, !tbaa !32
  %837 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.119", i64 %835
  store <4 x float> %820, ptr %837, align 16, !tbaa !34
  %838 = add nuw nsw i64 %829, 12
  %839 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.020", i64 %838
  store <4 x float> %827, ptr %839, align 16, !tbaa !32
  %840 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.119", i64 %838
  store <4 x float> %828, ptr %840, align 16, !tbaa !34
  %indvars.iv.next447 = add nuw nsw i64 %indvars.iv446, 1
  %.not38 = icmp eq i64 %indvars.iv.next447, 16
  br i1 %.not38, label %"for fwd_fft1_S4_R4_n1$2.s1.n0.g", label %"for fwd_fft0_S4_R4_n0$2.s1.n1"

"for fwd_fft1_S4_R4_n1$2.s1.n0.g":                ; preds = %"for fwd_fft0_S4_R4_n0$2.s1.n1", %"for fwd_fft1_S4_R4_n1$2.s1.n0.g"
  %indvars.iv456 = phi i64 [ %indvars.iv.next457, %"for fwd_fft1_S4_R4_n1$2.s1.n0.g" ], [ 0, %"for fwd_fft0_S4_R4_n0$2.s1.n1" ]
  %841 = shl nsw i64 %indvars.iv456, 2
  %842 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.020", i64 %841
  %843 = load <4 x float>, ptr %842, align 16, !tbaa !32
  %844 = add nuw nsw i64 %841, 224
  %845 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.020", i64 %844
  %846 = load <4 x float>, ptr %845, align 16, !tbaa !32
  %847 = fadd <4 x float> %843, %846
  %848 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.119", i64 %841
  %849 = load <4 x float>, ptr %848, align 16, !tbaa !34
  %850 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.119", i64 %844
  %851 = load <4 x float>, ptr %850, align 16, !tbaa !34
  %852 = fadd <4 x float> %849, %851
  %853 = add nuw nsw i64 %841, 112
  %854 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.020", i64 %853
  %855 = load <4 x float>, ptr %854, align 16, !tbaa !32
  %856 = add nuw nsw i64 %841, 336
  %857 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.020", i64 %856
  %858 = load <4 x float>, ptr %857, align 16, !tbaa !32
  %859 = fadd <4 x float> %855, %858
  %860 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.119", i64 %853
  %861 = load <4 x float>, ptr %860, align 16, !tbaa !34
  %862 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.119", i64 %856
  ...
  %878 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.020", i64 %877
  %879 = load <4 x float>, ptr %878, align 16, !tbaa !32
  %880 = add nuw nsw i64 %841, 252
  %881 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.020", i64 %880
  %882 = load <4 x float>, ptr %881, align 16, !tbaa !32
  %883 = fadd <4 x float> %879, %882
  %884 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.119", i64 %877
  %885 = load <4 x float>, ptr %884, align 16, !tbaa !34
  %886 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.119", i64 %880
  %887 = load <4 x float>, ptr %886, align 16, !tbaa !34
  %888 = fadd <4 x float> %885, %887
  %889 = add nuw nsw i64 %841, 140
  %890 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.020", i64 %889
  %891 = load <4 x float>, ptr %890, align 16, !tbaa !32
  %892 = add nuw nsw i64 %841, 364
  %893 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.020", i64 %892
  %894 = load <4 x float>, ptr %893, align 16, !tbaa !32
  %895 = fadd <4 x float> %891, %894
  %896 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.119", i64 %889
  %897 = load <4 x float>, ptr %896, align 16, !tbaa !34
  %898 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.119", i64 %892
  ...
  %914 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.020", i64 %913
  %915 = load <4 x float>, ptr %914, align 16, !tbaa !32
  %916 = add nuw nsw i64 %841, 280
  %917 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.020", i64 %916
  %918 = load <4 x float>, ptr %917, align 16, !tbaa !32
  %919 = fadd <4 x float> %915, %918
  %920 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.119", i64 %913
  %921 = load <4 x float>, ptr %920, align 16, !tbaa !34
  %922 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.119", i64 %916
  %923 = load <4 x float>, ptr %922, align 16, !tbaa !34
  %924 = fadd <4 x float> %921, %923
  %925 = add nuw nsw i64 %841, 168
  %926 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.020", i64 %925
  %927 = load <4 x float>, ptr %926, align 16, !tbaa !32
  %928 = add nuw nsw i64 %841, 392
  %929 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.020", i64 %928
  %930 = load <4 x float>, ptr %929, align 16, !tbaa !32
  %931 = fadd <4 x float> %927, %930
  %932 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.119", i64 %925
  %933 = load <4 x float>, ptr %932, align 16, !tbaa !34
  %934 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.119", i64 %928
  ...
  %950 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.020", i64 %949
  %951 = load <4 x float>, ptr %950, align 16, !tbaa !32
  %952 = add nuw nsw i64 %841, 308
  %953 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.020", i64 %952
  %954 = load <4 x float>, ptr %953, align 16, !tbaa !32
  %955 = fadd <4 x float> %951, %954
  %956 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.119", i64 %949
  %957 = load <4 x float>, ptr %956, align 16, !tbaa !34
  %958 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.119", i64 %952
  %959 = load <4 x float>, ptr %958, align 16, !tbaa !34
  %960 = fadd <4 x float> %957, %959
  %961 = add nuw nsw i64 %841, 196
  %962 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.020", i64 %961
  %963 = load <4 x float>, ptr %962, align 16, !tbaa !32
  %964 = add nuw nsw i64 %841, 420
  %965 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.020", i64 %964
  %966 = load <4 x float>, ptr %965, align 16, !tbaa !32
  %967 = fadd <4 x float> %963, %966
  %968 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.119", i64 %961
  %969 = load <4 x float>, ptr %968, align 16, !tbaa !34
  %970 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.119", i64 %964
  ...
  %1013 = getelementptr inbounds float, ptr %"inv_X4$11.018", i64 %841
  store <4 x float> %1001, ptr %1013, align 16, !tbaa !30
  %1014 = getelementptr inbounds float, ptr %"inv_X4$11.117", i64 %841
  store <4 x float> %1002, ptr %1014, align 16, !tbaa !27
  %1015 = add nuw nsw i64 %841, 64
  %1016 = getelementptr inbounds float, ptr %"inv_X4$11.018", i64 %1015
  store <4 x float> %1009, ptr %1016, align 16, !tbaa !30
  %1017 = getelementptr inbounds float, ptr %"inv_X4$11.117", i64 %1015
  store <4 x float> %1010, ptr %1017, align 16, !tbaa !27
  %1018 = add nuw nsw i64 %841, 128
  %1019 = getelementptr inbounds float, ptr %"inv_X4$11.018", i64 %1018
  store <4 x float> %1003, ptr %1019, align 16, !tbaa !30
  %1020 = getelementptr inbounds float, ptr %"inv_X4$11.117", i64 %1018
  store <4 x float> %1004, ptr %1020, align 16, !tbaa !27
  %1021 = add nuw nsw i64 %841, 192
  %1022 = getelementptr inbounds float, ptr %"inv_X4$11.018", i64 %1021
  store <4 x float> %1011, ptr %1022, align 16, !tbaa !30
  %1023 = getelementptr inbounds float, ptr %"inv_X4$11.117", i64 %1021
  ...
  %1059 = getelementptr inbounds float, ptr %"inv_X4$11.018", i64 %1058
  store <4 x float> %1046, ptr %1059, align 16, !tbaa !30
  %1060 = getelementptr inbounds float, ptr %"inv_X4$11.117", i64 %1058
  store <4 x float> %1047, ptr %1060, align 16, !tbaa !27
  %1061 = add nuw nsw i64 %841, 80
  %1062 = getelementptr inbounds float, ptr %"inv_X4$11.018", i64 %1061
  store <4 x float> %1054, ptr %1062, align 16, !tbaa !30
  %1063 = getelementptr inbounds float, ptr %"inv_X4$11.117", i64 %1061
  store <4 x float> %1055, ptr %1063, align 16, !tbaa !27
  %1064 = add nuw nsw i64 %841, 144
  %1065 = getelementptr inbounds float, ptr %"inv_X4$11.018", i64 %1064
  store <4 x float> %1048, ptr %1065, align 16, !tbaa !30
  %1066 = getelementptr inbounds float, ptr %"inv_X4$11.117", i64 %1064
  store <4 x float> %1049, ptr %1066, align 16, !tbaa !27
  %1067 = add nuw nsw i64 %841, 208
  %1068 = getelementptr inbounds float, ptr %"inv_X4$11.018", i64 %1067
  store <4 x float> %1056, ptr %1068, align 16, !tbaa !30
  %1069 = getelementptr inbounds float, ptr %"inv_X4$11.117", i64 %1067
  ...
  %1101 = getelementptr inbounds float, ptr %"inv_X4$11.018", i64 %1100
  store <4 x float> %1088, ptr %1101, align 16, !tbaa !30
  %1102 = getelementptr inbounds float, ptr %"inv_X4$11.117", i64 %1100
  store <4 x float> %1089, ptr %1102, align 16, !tbaa !27
  %1103 = add nuw nsw i64 %841, 96
  %1104 = getelementptr inbounds float, ptr %"inv_X4$11.018", i64 %1103
  store <4 x float> %1096, ptr %1104, align 16, !tbaa !30
  %1105 = getelementptr inbounds float, ptr %"inv_X4$11.117", i64 %1103
  store <4 x float> %1097, ptr %1105, align 16, !tbaa !27
  %1106 = add nuw nsw i64 %841, 160
  %1107 = getelementptr inbounds float, ptr %"inv_X4$11.018", i64 %1106
  store <4 x float> %1090, ptr %1107, align 16, !tbaa !30
  %1108 = getelementptr inbounds float, ptr %"inv_X4$11.117", i64 %1106
  store <4 x float> %1091, ptr %1108, align 16, !tbaa !27
  %1109 = add nuw nsw i64 %841, 224
  %1110 = getelementptr inbounds float, ptr %"inv_X4$11.018", i64 %1109
  store <4 x float> %1098, ptr %1110, align 16, !tbaa !30
  %1111 = getelementptr inbounds float, ptr %"inv_X4$11.117", i64 %1109
  ...
  %1145 = getelementptr inbounds float, ptr %"inv_X4$11.018", i64 %1144
  store <4 x float> %1132, ptr %1145, align 16, !tbaa !30
  %1146 = getelementptr inbounds float, ptr %"inv_X4$11.117", i64 %1144
  store <4 x float> %1133, ptr %1146, align 16, !tbaa !27
  %1147 = add nuw nsw i64 %841, 112
  %1148 = getelementptr inbounds float, ptr %"inv_X4$11.018", i64 %1147
  store <4 x float> %1140, ptr %1148, align 16, !tbaa !30
  %1149 = getelementptr inbounds float, ptr %"inv_X4$11.117", i64 %1147
  store <4 x float> %1141, ptr %1149, align 16, !tbaa !27
  %1150 = add nuw nsw i64 %841, 176
  %1151 = getelementptr inbounds float, ptr %"inv_X4$11.018", i64 %1150
  store <4 x float> %1134, ptr %1151, align 16, !tbaa !30
  %1152 = getelementptr inbounds float, ptr %"inv_X4$11.117", i64 %1150
  store <4 x float> %1135, ptr %1152, align 16, !tbaa !27
  %1153 = add nuw nsw i64 %841, 240
  %1154 = getelementptr inbounds float, ptr %"inv_X4$11.018", i64 %1153
  store <4 x float> %1142, ptr %1154, align 16, !tbaa !30
  %1155 = getelementptr inbounds float, ptr %"inv_X4$11.117", i64 %1153
  store <4 x float> %1143, ptr %1155, align 16, !tbaa !27
  %indvars.iv.next457 = add nuw nsw i64 %indvars.iv456, 1
  %.not41 = icmp eq i64 %indvars.iv.next457, 4
  br i1 %.not41, label %"consume fwd_fft1_S4_R4_n1$2", label %"for fwd_fft1_S4_R4_n1$2.s1.n0.g"
...
"assert failed80":                                ; preds = %"consume fwd_fft1_S4_R4_n1$2"
  %1156 = tail call i32 @halide_error_explicit_bounds_too_small(ptr null, ptr nonnull @str.11, ptr nonnull @str.12, i32 0, i32 15, i32 %84, i32 %b29) #2
  br label %destructor_block
...
"assert failed82":                                ; preds = %"assert succeeded81"
  ...
  %a32 = add nsw i32 %742, -1
  %1158 = tail call i32 @halide_error_explicit_bounds_too_small(ptr null, ptr nonnull @str.13, ptr nonnull @str.12, i32 0, i32 15, i32 %1157, i32 %a32) #2
  br label %destructor_block

"assert succeeded83":                             ; preds = %"assert succeeded81"
  br i1 %744, label %"assert failed84", label %"for inv_fft0_S4_R4_n0$2.s1.n1", !prof !5
...
"for inv_fft0_S4_R4_n0$2.s1.n1":                  ; preds = %"assert succeeded83", %"for inv_fft0_S4_R4_n0$2.s1.n1"
  %indvars.iv459 = phi i64 [ %indvars.iv.next460, %"for inv_fft0_S4_R4_n0$2.s1.n1" ], [ 0, %"assert succeeded83" ]
  %1160 = shl nuw nsw i64 %indvars.iv459, 4
  %1161 = getelementptr inbounds float, ptr %"inv_X4$11.018", i64 %1160
  %1162 = load <4 x float>, ptr %1161, align 16, !tbaa !30
  %1163 = getelementptr inbounds float, ptr %"kernel_fft1_S4_R4_n1$2.022", i64 %1160
  %1164 = load <4 x float>, ptr %1163, align 16, !tbaa !36
  %1165 = fmul <4 x float> %1162, %1164
  %1166 = getelementptr inbounds float, ptr %"inv_X4$11.117", i64 %1160
  %1167 = load <4 x float>, ptr %1166, align 16, !tbaa !27
  %1168 = getelementptr inbounds float, ptr %"kernel_fft1_S4_R4_n1$2.121", i64 %1160
  %1169 = load <4 x float>, ptr %1168, align 16, !tbaa !38
  %1170 = fmul <4 x float> %1167, %1169
  %1171 = fsub <4 x float> %1165, %1170
  %1172 = or i64 %1160, 8
  %1173 = getelementptr inbounds float, ptr %"inv_X4$11.018", i64 %1172
  %1174 = load <4 x float>, ptr %1173, align 16, !tbaa !30
  %1175 = getelementptr inbounds float, ptr %"kernel_fft1_S4_R4_n1$2.022", i64 %1172
  %1176 = load <4 x float>, ptr %1175, align 16, !tbaa !36
  %1177 = fmul <4 x float> %1174, %1176
  %1178 = getelementptr inbounds float, ptr %"inv_X4$11.117", i64 %1172
  %1179 = load <4 x float>, ptr %1178, align 16, !tbaa !27
  %1180 = getelementptr inbounds float, ptr %"kernel_fft1_S4_R4_n1$2.121", i64 %1172
  ...
  %1192 = or i64 %1160, 4
  %1193 = getelementptr inbounds float, ptr %"inv_X4$11.018", i64 %1192
  %1194 = load <4 x float>, ptr %1193, align 16, !tbaa !30
  %1195 = getelementptr inbounds float, ptr %"kernel_fft1_S4_R4_n1$2.022", i64 %1192
  %1196 = load <4 x float>, ptr %1195, align 16, !tbaa !36
  %1197 = fmul <4 x float> %1194, %1196
  %1198 = getelementptr inbounds float, ptr %"inv_X4$11.117", i64 %1192
  %1199 = load <4 x float>, ptr %1198, align 16, !tbaa !27
  %1200 = getelementptr inbounds float, ptr %"kernel_fft1_S4_R4_n1$2.121", i64 %1192
  %1201 = load <4 x float>, ptr %1200, align 16, !tbaa !38
  %1202 = fmul <4 x float> %1199, %1201
  %1203 = fsub <4 x float> %1197, %1202
  %1204 = or i64 %1160, 12
  %1205 = getelementptr inbounds float, ptr %"inv_X4$11.018", i64 %1204
  %1206 = load <4 x float>, ptr %1205, align 16, !tbaa !30
  %1207 = getelementptr inbounds float, ptr %"kernel_fft1_S4_R4_n1$2.022", i64 %1204
  %1208 = load <4 x float>, ptr %1207, align 16, !tbaa !36
  %1209 = fmul <4 x float> %1206, %1208
  %1210 = getelementptr inbounds float, ptr %"inv_X4$11.117", i64 %1204
  %1211 = load <4 x float>, ptr %1210, align 16, !tbaa !27
  %1212 = getelementptr inbounds float, ptr %"kernel_fft1_S4_R4_n1$2.121", i64 %1204
  ...
  %1286 = mul nuw nsw i64 %indvars.iv459, 28
  %1287 = getelementptr inbounds float, ptr %"inv_fft0_S4_R4_n0$2.08", i64 %1286
  store <4 x float> %1274, ptr %1287, align 16, !tbaa !42
  %1288 = getelementptr inbounds float, ptr %"inv_fft0_S4_R4_n0$2.17", i64 %1286
  store <4 x float> %1275, ptr %1288, align 16, !tbaa !44
  %1289 = add nuw nsw i64 %1286, 4
  %1290 = getelementptr inbounds float, ptr %"inv_fft0_S4_R4_n0$2.08", i64 %1289
  store <4 x float> %1282, ptr %1290, align 16, !tbaa !42
  %1291 = getelementptr inbounds float, ptr %"inv_fft0_S4_R4_n0$2.17", i64 %1289
  store <4 x float> %1283, ptr %1291, align 16, !tbaa !44
  %1292 = add nuw nsw i64 %1286, 8
  %1293 = getelementptr inbounds float, ptr %"inv_fft0_S4_R4_n0$2.08", i64 %1292
  store <4 x float> %1276, ptr %1293, align 16, !tbaa !42
  %1294 = getelementptr inbounds float, ptr %"inv_fft0_S4_R4_n0$2.17", i64 %1292
  store <4 x float> %1277, ptr %1294, align 16, !tbaa !44
  %1295 = add nuw nsw i64 %1286, 12
  %1296 = getelementptr inbounds float, ptr %"inv_fft0_S4_R4_n0$2.08", i64 %1295
  store <4 x float> %1284, ptr %1296, align 16, !tbaa !42
  %1297 = getelementptr inbounds float, ptr %"inv_fft0_S4_R4_n0$2.17", i64 %1295
  store <4 x float> %1285, ptr %1297, align 16, !tbaa !44
  %indvars.iv.next460 = add nuw nsw i64 %indvars.iv459, 1
  %.not42 = icmp eq i64 %indvars.iv.next460, 16
  br i1 %.not42, label %"for inv_fft1_S4_R4_n1$2.s1.n0.g", label %"for inv_fft0_S4_R4_n0$2.s1.n1"

"for inv_fft1_S4_R4_n1$2.s1.n0.g":                ; preds = %"for inv_fft0_S4_R4_n0$2.s1.n1", %"for inv_fft1_S4_R4_n1$2.s1.n0.g"
  %indvars.iv469 = phi i64 [ %indvars.iv.next470, %"for inv_fft1_S4_R4_n1$2.s1.n0.g" ], [ 0, %"for inv_fft0_S4_R4_n0$2.s1.n1" ]
  %1298 = shl nsw i64 %indvars.iv469, 2
  %1299 = getelementptr inbounds float, ptr %"inv_fft0_S4_R4_n0$2.08", i64 %1298
  %1300 = load <4 x float>, ptr %1299, align 16, !tbaa !42
  %1301 = add nuw nsw i64 %1298, 224
  %1302 = getelementptr inbounds float, ptr %"inv_fft0_S4_R4_n0$2.08", i64 %1301
  %1303 = load <4 x float>, ptr %1302, align 16, !tbaa !42
  %1304 = fadd <4 x float> %1300, %1303
  %1305 = getelementptr inbounds float, ptr %"inv_fft0_S4_R4_n0$2.17", i64 %1298
  %1306 = load <4 x float>, ptr %1305, align 16, !tbaa !44
  %1307 = getelementptr inbounds float, ptr %"inv_fft0_S4_R4_n0$2.17", i64 %1301
  %1308 = load <4 x float>, ptr %1307, align 16, !tbaa !44
  %1309 = fadd <4 x float> %1306, %1308
  %1310 = add nuw nsw i64 %1298, 112
  %1311 = getelementptr inbounds float, ptr %"inv_fft0_S4_R4_n0$2.08", i64 %1310
  %1312 = load <4 x float>, ptr %1311, align 16, !tbaa !42
  %1313 = add nuw nsw i64 %1298, 336
  %1314 = getelementptr inbounds float, ptr %"inv_fft0_S4_R4_n0$2.08", i64 %1313
  %1315 = load <4 x float>, ptr %1314, align 16, !tbaa !42
  %1316 = fadd <4 x float> %1312, %1315
  %1317 = getelementptr inbounds float, ptr %"inv_fft0_S4_R4_n0$2.17", i64 %1310
  %1318 = load <4 x float>, ptr %1317, align 16, !tbaa !44
  %1319 = getelementptr inbounds float, ptr %"inv_fft0_S4_R4_n0$2.17", i64 %1313
  %1320 = load <4 x float>, ptr %1319, align 16, !tbaa !44
  %1321 = fadd <4 x float> %1318, %1320
  %1322 = fadd <4 x float> %1304, %1316
  %1323 = fadd <4 x float> %1309, %1321
  %1324 = fsub <4 x float> %1304, %1316
  %1325 = fsub <4 x float> %1309, %1321
  %1326 = fsub <4 x float> %1300, %1303
  %1327 = fsub <4 x float> %1306, %1308
  %1328 = fsub <4 x float> %1320, %1318
  %1329 = fsub <4 x float> %1312, %1315
  %1330 = fadd <4 x float> %1326, %1328
  %1331 = fadd <4 x float> %1327, %1329
  %1332 = fsub <4 x float> %1326, %1328
  %1333 = fsub <4 x float> %1327, %1329
  %1334 = add nuw nsw i64 %1298, 28
  %1335 = getelementptr inbounds float, ptr %"inv_fft0_S4_R4_n0$2.08", i64 %1334
  %1336 = load <4 x float>, ptr %1335, align 16, !tbaa !42
  %1337 = add nuw nsw i64 %1298, 252
  %1338 = getelementptr inbounds float, ptr %"inv_fft0_S4_R4_n0$2.08", i64 %1337
  %1339 = load <4 x float>, ptr %1338, align 16, !tbaa !42
  %1340 = fadd <4 x float> %1336, %1339
  %1341 = getelementptr inbounds float, ptr %"inv_fft0_S4_R4_n0$2.17", i64 %1334
  %1342 = load <4 x float>, ptr %1341, align 16, !tbaa !44
  %1343 = getelementptr inbounds float, ptr %"inv_fft0_S4_R4_n0$2.17", i64 %1337
  %1344 = load <4 x float>, ptr %1343, align 16, !tbaa !44
  %1345 = fadd <4 x float> %1342, %1344
  %1346 = add nuw nsw i64 %1298, 140
  %1347 = getelementptr inbounds float, ptr %"inv_fft0_S4_R4_n0$2.08", i64 %1346
  %1348 = load <4 x float>, ptr %1347, align 16, !tbaa !42
  %1349 = add nuw nsw i64 %1298, 364
  %1350 = getelementptr inbounds float, ptr %"inv_fft0_S4_R4_n0$2.08", i64 %1349
  %1351 = load <4 x float>, ptr %1350, align 16, !tbaa !42
  %1352 = fadd <4 x float> %1348, %1351
  %1353 = getelementptr inbounds float, ptr %"inv_fft0_S4_R4_n0$2.17", i64 %1346
  %1354 = load <4 x float>, ptr %1353, align 16, !tbaa !44
  %1355 = getelementptr inbounds float, ptr %"inv_fft0_S4_R4_n0$2.17", i64 %1349
  %1356 = load <4 x float>, ptr %1355, align 16, !tbaa !44
  %1357 = fadd <4 x float> %1354, %1356
  %1358 = fadd <4 x float> %1340, %1352
  %1359 = fadd <4 x float> %1345, %1357
  %1360 = fsub <4 x float> %1340, %1352
  %1361 = fsub <4 x float> %1345, %1357
  %1362 = fsub <4 x float> %1336, %1339
  %1363 = fsub <4 x float> %1342, %1344
  %1364 = fsub <4 x float> %1356, %1354
  %1365 = fsub <4 x float> %1348, %1351
  %1366 = fadd <4 x float> %1362, %1364
  %1367 = fadd <4 x float> %1363, %1365
  %1368 = fsub <4 x float> %1362, %1364
  %1369 = fsub <4 x float> %1363, %1365
  %1370 = add nuw nsw i64 %1298, 56
  %1371 = getelementptr inbounds float, ptr %"inv_fft0_S4_R4_n0$2.08", i64 %1370
  %1372 = load <4 x float>, ptr %1371, align 16, !tbaa !42
  %1373 = add nuw nsw i64 %1298, 280
  %1374 = getelementptr inbounds float, ptr %"inv_fft0_S4_R4_n0$2.08", i64 %1373
  %1375 = load <4 x float>, ptr %1374, align 16, !tbaa !42
  %1376 = fadd <4 x float> %1372, %1375
  %1377 = getelementptr inbounds float, ptr %"inv_fft0_S4_R4_n0$2.17", i64 %1370
  %1378 = load <4 x float>, ptr %1377, align 16, !tbaa !44
  %1379 = getelementptr inbounds float, ptr %"inv_fft0_S4_R4_n0$2.17", i64 %1373
  %1380 = load <4 x float>, ptr %1379, align 16, !tbaa !44
  %1381 = fadd <4 x float> %1378, %1380
  %1382 = add nuw nsw i64 %1298, 168
  %1383 = getelementptr inbounds float, ptr %"inv_fft0_S4_R4_n0$2.08", i64 %1382
  %1384 = load <4 x float>, ptr %1383, align 16, !tbaa !42
  %1385 = add nuw nsw i64 %1298, 392
  %1386 = getelementptr inbounds float, ptr %"inv_fft0_S4_R4_n0$2.08", i64 %1385
  %1387 = load <4 x float>, ptr %1386, align 16, !tbaa !42
  %1388 = fadd <4 x float> %1384, %1387
  %1389 = getelementptr inbounds float, ptr %"inv_fft0_S4_R4_n0$2.17", i64 %1382
  %1390 = load <4 x float>, ptr %1389, align 16, !tbaa !44
  %1391 = getelementptr inbounds float, ptr %"inv_fft0_S4_R4_n0$2.17", i64 %1385
  %1392 = load <4 x float>, ptr %1391, align 16, !tbaa !44
  %1393 = fadd <4 x float> %1390, %1392
  %1394 = fadd <4 x float> %1376, %1388
  %1395 = fadd <4 x float> %1381, %1393
  %1396 = fsub <4 x float> %1376, %1388
  %1397 = fsub <4 x float> %1381, %1393
  %1398 = fsub <4 x float> %1372, %1375
  %1399 = fsub <4 x float> %1378, %1380
  %1400 = fsub <4 x float> %1392, %1390
  %1401 = fsub <4 x float> %1384, %1387
  %1402 = fadd <4 x float> %1398, %1400
  %1403 = fadd <4 x float> %1399, %1401
  %1404 = fsub <4 x float> %1398, %1400
  %1405 = fsub <4 x float> %1399, %1401
  %1406 = add nuw nsw i64 %1298, 84
  %1407 = getelementptr inbounds float, ptr %"inv_fft0_S4_R4_n0$2.08", i64 %1406
  %1408 = load <4 x float>, ptr %1407, align 16, !tbaa !42
  %1409 = add nuw nsw i64 %1298, 308
  %1410 = getelementptr inbounds float, ptr %"inv_fft0_S4_R4_n0$2.08", i64 %1409
  %1411 = load <4 x float>, ptr %1410, align 16, !tbaa !42
  %1412 = fadd <4 x float> %1408, %1411
  %1413 = getelementptr inbounds float, ptr %"inv_fft0_S4_R4_n0$2.17", i64 %1406
  %1414 = load <4 x float>, ptr %1413, align 16, !tbaa !44
  %1415 = getelementptr inbounds float, ptr %"inv_fft0_S4_R4_n0$2.17", i64 %1409
  %1416 = load <4 x float>, ptr %1415, align 16, !tbaa !44
  %1417 = fadd <4 x float> %1414, %1416
  %1418 = add nuw nsw i64 %1298, 196
  %1419 = getelementptr inbounds float, ptr %"inv_fft0_S4_R4_n0$2.08", i64 %1418
  %1420 = load <4 x float>, ptr %1419, align 16, !tbaa !42
  %1421 = add nuw nsw i64 %1298, 420
  %1422 = getelementptr inbounds float, ptr %"inv_fft0_S4_R4_n0$2.08", i64 %1421
  %1423 = load <4 x float>, ptr %1422, align 16, !tbaa !42
  %1424 = fadd <4 x float> %1420, %1423
  %1425 = getelementptr inbounds float, ptr %"inv_fft0_S4_R4_n0$2.17", i64 %1418
  %1426 = load <4 x float>, ptr %1425, align 16, !tbaa !44
  %1427 = getelementptr inbounds float, ptr %"inv_fft0_S4_R4_n0$2.17", i64 %1421
  %1428 = load <4 x float>, ptr %1427, align 16, !tbaa !44
  %1429 = fadd <4 x float> %1426, %1428
  %1430 = fadd <4 x float> %1412, %1424
  %1431 = fadd <4 x float> %1417, %1429
  %1432 = fsub <4 x float> %1412, %1424
  %1433 = fsub <4 x float> %1417, %1429
  %1434 = fsub <4 x float> %1408, %1411
  %1435 = fsub <4 x float> %1414, %1416
  %1436 = fsub <4 x float> %1428, %1426
  %1437 = fsub <4 x float> %1420, %1423
  %1438 = fadd <4 x float> %1434, %1436
  %1439 = fadd <4 x float> %1435, %1437
  %1440 = fsub <4 x float> %1434, %1436
  %1441 = fsub <4 x float> %1435, %1437
  %1442 = fmul <4 x float> %1359, zeroinitializer
  %1443 = fsub <4 x float> %1358, %1442
  %1444 = fmul <4 x float> %1358, zeroinitializer
  %1445 = fadd <4 x float> %1359, %1444
  %1446 = fmul <4 x float> %1395, zeroinitializer
  %1447 = fsub <4 x float> %1394, %1446
  %1448 = fmul <4 x float> %1394, zeroinitializer
  %1449 = fadd <4 x float> %1395, %1448
  %1450 = fmul <4 x float> %1431, zeroinitializer
  %1451 = fsub <4 x float> %1430, %1450
  %1452 = fmul <4 x float> %1430, zeroinitializer
  %1453 = fadd <4 x float> %1431, %1452
  %1454 = fadd <4 x float> %1322, %1447
  %1455 = fadd <4 x float> %1323, %1449
  ...
  %1462 = fsub <4 x float> %1322, %1447
  %1463 = fsub <4 x float> %1323, %1449
  ...
  %1470 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.020", i64 %1298
  store <4 x float> %1458, ptr %1470, align 16, !tbaa !32
  %1471 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.119", i64 %1298
  store <4 x float> %1459, ptr %1471, align 16, !tbaa !34
  %1472 = add nuw nsw i64 %1298, 64
  %1473 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.020", i64 %1472
  store <4 x float> %1466, ptr %1473, align 16, !tbaa !32
  %1474 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.119", i64 %1472
  store <4 x float> %1467, ptr %1474, align 16, !tbaa !34
  %1475 = add nuw nsw i64 %1298, 128
  %1476 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.020", i64 %1475
  store <4 x float> %1460, ptr %1476, align 16, !tbaa !32
  %1477 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.119", i64 %1475
  store <4 x float> %1461, ptr %1477, align 16, !tbaa !34
  %1478 = add nuw nsw i64 %1298, 192
  %1479 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.020", i64 %1478
  store <4 x float> %1468, ptr %1479, align 16, !tbaa !32
  %1480 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.119", i64 %1478
  store <4 x float> %1469, ptr %1480, align 16, !tbaa !34
  %1481 = fmul <4 x float> %1366, <float 0x3FED906BC0000000, float 0x3FED906BC0000000, float 0x3FED906BC0000000, float 0x3FED906BC0000000>
  %1482 = fmul <4 x float> %1367, <float 0x3FD87DE2C0000000, float 0x3FD87DE2C0000000, float 0x3FD87DE2C0000000, float 0x3FD87DE2C0000000>
  %1483 = fsub <4 x float> %1481, %1482
  %1484 = fmul <4 x float> %1366, <float 0x3FD87DE2C0000000, float 0x3FD87DE2C0000000, float 0x3FD87DE2C0000000, float 0x3FD87DE2C0000000>
  %1485 = fmul <4 x float> %1367, <float 0x3FED906BC0000000, float 0x3FED906BC0000000, float 0x3FED906BC0000000, float 0x3FED906BC0000000>
  %1486 = fadd <4 x float> %1485, %1484
  ...
  %1488 = fmul <4 x float> %1403, <float 0x3FE6A09E60000000, float 0x3FE6A09E60000000, float 0x3FE6A09E60000000, float 0x3FE6A09E60000000>
  %1489 = fsub <4 x float> %1487, %1488
  %1490 = fadd <4 x float> %1488, %1487
  %1491 = fmul <4 x float> %1438, <float 0x3FD87DE2A0000000, float 0x3FD87DE2A0000000, float 0x3FD87DE2A0000000, float 0x3FD87DE2A0000000>
  %1492 = fmul <4 x float> %1439, <float 0x3FED906BC0000000, float 0x3FED906BC0000000, float 0x3FED906BC0000000, float 0x3FED906BC0000000>
  %1493 = fsub <4 x float> %1491, %1492
  %1494 = fmul <4 x float> %1438, <float 0x3FED906BC0000000, float 0x3FED906BC0000000, float 0x3FED906BC0000000, float 0x3FED906BC0000000>
  %1495 = fmul <4 x float> %1439, <float 0x3FD87DE2A0000000, float 0x3FD87DE2A0000000, float 0x3FD87DE2A0000000, float 0x3FD87DE2A0000000>
  %1496 = fadd <4 x float> %1495, %1494
  %1497 = fadd <4 x float> %1330, %1489
  %1498 = fadd <4 x float> %1331, %1490
  %1499 = fadd <4 x float> %1483, %1493
  %1500 = fadd <4 x float> %1486, %1496
  %1501 = fadd <4 x float> %1497, %1499
  %1502 = fadd <4 x float> %1498, %1500
  %1503 = fsub <4 x float> %1497, %1499
  %1504 = fsub <4 x float> %1498, %1500
  %1505 = fsub <4 x float> %1330, %1489
  %1506 = fsub <4 x float> %1331, %1490
  %1507 = fsub <4 x float> %1496, %1486
  %1508 = fsub <4 x float> %1483, %1493
  %1509 = fadd <4 x float> %1505, %1507
  %1510 = fadd <4 x float> %1506, %1508
  %1511 = fsub <4 x float> %1505, %1507
  %1512 = fsub <4 x float> %1506, %1508
  %1513 = add nuw nsw i64 %1298, 16
  %1514 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.020", i64 %1513
  store <4 x float> %1501, ptr %1514, align 16, !tbaa !32
  %1515 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.119", i64 %1513
  store <4 x float> %1502, ptr %1515, align 16, !tbaa !34
  %1516 = add nuw nsw i64 %1298, 80
  %1517 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.020", i64 %1516
  store <4 x float> %1509, ptr %1517, align 16, !tbaa !32
  %1518 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.119", i64 %1516
  store <4 x float> %1510, ptr %1518, align 16, !tbaa !34
  %1519 = add nuw nsw i64 %1298, 144
  %1520 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.020", i64 %1519
  store <4 x float> %1503, ptr %1520, align 16, !tbaa !32
  %1521 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.119", i64 %1519
  store <4 x float> %1504, ptr %1521, align 16, !tbaa !34
  %1522 = add nuw nsw i64 %1298, 208
  %1523 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.020", i64 %1522
  store <4 x float> %1511, ptr %1523, align 16, !tbaa !32
  %1524 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.119", i64 %1522
  store <4 x float> %1512, ptr %1524, align 16, !tbaa !34
  ...
  %1526 = fmul <4 x float> %1361, <float 0x3FE6A09E60000000, float 0x3FE6A09E60000000, float 0x3FE6A09E60000000, float 0x3FE6A09E60000000>
  %1527 = fsub <4 x float> %1525, %1526
  %1528 = fadd <4 x float> %1526, %1525
  %1529 = fmul <4 x float> %1396, <float 0xBE6777A5C0000000, float 0xBE6777A5C0000000, float 0xBE6777A5C0000000, float 0xBE6777A5C0000000>
  %1530 = fsub <4 x float> %1529, %1397
  %1531 = fmul <4 x float> %1397, <float 0xBE6777A5C0000000, float 0xBE6777A5C0000000, float 0xBE6777A5C0000000, float 0xBE6777A5C0000000>
  %1532 = fadd <4 x float> %1531, %1396
  %1533 = fmul <4 x float> %1432, <float 0xBFE6A09E60000000, float 0xBFE6A09E60000000, float 0xBFE6A09E60000000, float 0xBFE6A09E60000000>
  %1534 = fmul <4 x float> %1433, <float 0x3FE6A09E60000000, float 0x3FE6A09E60000000, float 0x3FE6A09E60000000, float 0x3FE6A09E60000000>
  %1535 = fsub <4 x float> %1533, %1534
  %1536 = fmul <4 x float> %1432, <float 0x3FE6A09E60000000, float 0x3FE6A09E60000000, float 0x3FE6A09E60000000, float 0x3FE6A09E60000000>
  %1537 = fmul <4 x float> %1433, <float 0xBFE6A09E60000000, float 0xBFE6A09E60000000, float 0xBFE6A09E60000000, float 0xBFE6A09E60000000>
  %1538 = fadd <4 x float> %1537, %1536
  %1539 = fadd <4 x float> %1324, %1530
  %1540 = fadd <4 x float> %1325, %1532
  %1541 = fadd <4 x float> %1527, %1535
  %1542 = fadd <4 x float> %1528, %1538
  %1543 = fadd <4 x float> %1539, %1541
  %1544 = fadd <4 x float> %1540, %1542
  %1545 = fsub <4 x float> %1539, %1541
  %1546 = fsub <4 x float> %1540, %1542
  %1547 = fsub <4 x float> %1324, %1530
  %1548 = fsub <4 x float> %1325, %1532
  %1549 = fsub <4 x float> %1538, %1528
  %1550 = fsub <4 x float> %1527, %1535
  %1551 = fadd <4 x float> %1547, %1549
  %1552 = fadd <4 x float> %1548, %1550
  %1553 = fsub <4 x float> %1547, %1549
  %1554 = fsub <4 x float> %1548, %1550
  %1555 = add nuw nsw i64 %1298, 32
  %1556 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.020", i64 %1555
  store <4 x float> %1543, ptr %1556, align 16, !tbaa !32
  %1557 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.119", i64 %1555
  store <4 x float> %1544, ptr %1557, align 16, !tbaa !34
  %1558 = add nuw nsw i64 %1298, 96
  %1559 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.020", i64 %1558
  store <4 x float> %1551, ptr %1559, align 16, !tbaa !32
  %1560 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.119", i64 %1558
  store <4 x float> %1552, ptr %1560, align 16, !tbaa !34
  %1561 = add nuw nsw i64 %1298, 160
  %1562 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.020", i64 %1561
  store <4 x float> %1545, ptr %1562, align 16, !tbaa !32
  %1563 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.119", i64 %1561
  store <4 x float> %1546, ptr %1563, align 16, !tbaa !34
  %1564 = add nuw nsw i64 %1298, 224
  %1565 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.020", i64 %1564
  store <4 x float> %1553, ptr %1565, align 16, !tbaa !32
  %1566 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.119", i64 %1564
  store <4 x float> %1554, ptr %1566, align 16, !tbaa !34
  %1567 = fmul <4 x float> %1368, <float 0x3FD87DE2A0000000, float 0x3FD87DE2A0000000, float 0x3FD87DE2A0000000, float 0x3FD87DE2A0000000>
  %1568 = fmul <4 x float> %1369, <float 0x3FED906BC0000000, float 0x3FED906BC0000000, float 0x3FED906BC0000000, float 0x3FED906BC0000000>
  %1569 = fsub <4 x float> %1567, %1568
  %1570 = fmul <4 x float> %1368, <float 0x3FED906BC0000000, float 0x3FED906BC0000000, float 0x3FED906BC0000000, float 0x3FED906BC0000000>
  %1571 = fmul <4 x float> %1369, <float 0x3FD87DE2A0000000, float 0x3FD87DE2A0000000, float 0x3FD87DE2A0000000, float 0x3FD87DE2A0000000>
  %1572 = fadd <4 x float> %1571, %1570
  %1573 = fmul <4 x float> %1404, <float 0xBFE6A09E60000000, float 0xBFE6A09E60000000, float 0xBFE6A09E60000000, float 0xBFE6A09E60000000>
  %1574 = fmul <4 x float> %1405, <float 0x3FE6A09E60000000, float 0x3FE6A09E60000000, float 0x3FE6A09E60000000, float 0x3FE6A09E60000000>
  %1575 = fsub <4 x float> %1573, %1574
  %1576 = fmul <4 x float> %1404, <float 0x3FE6A09E60000000, float 0x3FE6A09E60000000, float 0x3FE6A09E60000000, float 0x3FE6A09E60000000>
  %1577 = fmul <4 x float> %1405, <float 0xBFE6A09E60000000, float 0xBFE6A09E60000000, float 0xBFE6A09E60000000, float 0xBFE6A09E60000000>
  %1578 = fadd <4 x float> %1577, %1576
  %1579 = fmul <4 x float> %1440, <float 0xBFED906BC0000000, float 0xBFED906BC0000000, float 0xBFED906BC0000000, float 0xBFED906BC0000000>
  %1580 = fmul <4 x float> %1441, <float 0xBFD87DE2A0000000, float 0xBFD87DE2A0000000, float 0xBFD87DE2A0000000, float 0xBFD87DE2A0000000>
  %1581 = fsub <4 x float> %1579, %1580
  %1582 = fmul <4 x float> %1440, <float 0xBFD87DE2A0000000, float 0xBFD87DE2A0000000, float 0xBFD87DE2A0000000, float 0xBFD87DE2A0000000>
  %1583 = fmul <4 x float> %1441, <float 0xBFED906BC0000000, float 0xBFED906BC0000000, float 0xBFED906BC0000000, float 0xBFED906BC0000000>
  %1584 = fadd <4 x float> %1583, %1582
  %1585 = fadd <4 x float> %1332, %1575
  %1586 = fadd <4 x float> %1333, %1578
  %1587 = fadd <4 x float> %1569, %1581
  %1588 = fadd <4 x float> %1572, %1584
  %1589 = fadd <4 x float> %1585, %1587
  %1590 = fadd <4 x float> %1586, %1588
  %1591 = fsub <4 x float> %1585, %1587
  %1592 = fsub <4 x float> %1586, %1588
  %1593 = fsub <4 x float> %1332, %1575
  %1594 = fsub <4 x float> %1333, %1578
  %1595 = fsub <4 x float> %1584, %1572
  %1596 = fsub <4 x float> %1569, %1581
  %1597 = fadd <4 x float> %1593, %1595
  %1598 = fadd <4 x float> %1594, %1596
  %1599 = fsub <4 x float> %1593, %1595
  %1600 = fsub <4 x float> %1594, %1596
  %1601 = add nuw nsw i64 %1298, 48
  %1602 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.020", i64 %1601
  store <4 x float> %1589, ptr %1602, align 16, !tbaa !32
  %1603 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.119", i64 %1601
  store <4 x float> %1590, ptr %1603, align 16, !tbaa !34
  %1604 = add nuw nsw i64 %1298, 112
  %1605 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.020", i64 %1604
  store <4 x float> %1597, ptr %1605, align 16, !tbaa !32
  %1606 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.119", i64 %1604
  store <4 x float> %1598, ptr %1606, align 16, !tbaa !34
  %1607 = add nuw nsw i64 %1298, 176
  %1608 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.020", i64 %1607
  store <4 x float> %1591, ptr %1608, align 16, !tbaa !32
  %1609 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.119", i64 %1607
  store <4 x float> %1592, ptr %1609, align 16, !tbaa !34
  %1610 = add nuw nsw i64 %1298, 240
  %1611 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.020", i64 %1610
  store <4 x float> %1599, ptr %1611, align 16, !tbaa !32
  %1612 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.119", i64 %1610
  store <4 x float> %1600, ptr %1612, align 16, !tbaa !34
  %indvars.iv.next470 = add nuw nsw i64 %indvars.iv469, 1
  %.not45 = icmp eq i64 %indvars.iv.next470, 4
  br i1 %.not45, label %"consume inv_fft1_S4_R4_n1$2", label %"for inv_fft1_S4_R4_n1$2.s1.n0.g"

"consume inv_fft1_S4_R4_n1$2":                    ; preds = %"for inv_fft1_S4_R4_n1$2.s1.n0.g"
  store <4 x float> %1595, ptr %729, align 16, !tbaa !46
  store <4 x float> %1596, ptr %730, align 16, !tbaa !56
  store <4 x float> %1593, ptr %"inv_X4$11.018", align 16, !tbaa !66
  store <4 x float> %1594, ptr %"inv_X4$11.117", align 16, !tbaa !68
  store <4 x float> %1589, ptr %731, align 16, !tbaa !70
  store <4 x float> %1590, ptr %732, align 16, !tbaa !73
  store <4 x float> %1591, ptr %scevgep431.1, align 16, !tbaa !76
  store <4 x float> %1592, ptr %735, align 16, !tbaa !80
  store <4 x float> %1597, ptr %733, align 16, !tbaa !84
  store <4 x float> %1598, ptr %734, align 16, !tbaa !86
  store <4 x float> %1599, ptr %736, align 16, !tbaa !88
  store <4 x float> %1600, ptr %737, align 16, !tbaa !90
  br i1 %745, label %"for result$2.s0.n1.preheader", label %"end for result$2.s0.n1", !prof !26

"for result$2.s0.n1.preheader":                   ; preds = %"consume inv_fft1_S4_R4_n1$2"
  %reass.add369 = sub nsw i64 %indvars.iv478, %752
  %reass.mul370 = mul i64 %reass.add369, %248
  %1613 = sub i64 %reass.mul370, %750
  %1614 = add i64 %755, %reass.mul370
  br label %"for result$2.s0.n1"

"for result$2.s0.n1":                             ; preds = %"for result$2.s0.n1.preheader", %"end for result$2.s0.n0.n091"
  %indvars.iv475 = phi i64 [ %751, %"for result$2.s0.n1.preheader" ], [ %indvars.iv.next476, %"end for result$2.s0.n0.n091" ]
  br i1 %746, label %"for result$2.s0.n0.n0.preheader", label %"end for result$2.s0.n0.n0", !prof !26

"for result$2.s0.n0.n0.preheader":                ; preds = %"for result$2.s0.n1"
  %1615 = shl nsw i64 %indvars.iv475, 4
  %reass.add371 = sub nsw i64 %indvars.iv475, %751
  %reass.mul372 = mul i64 %reass.add371, %241
  %1616 = add i64 %1613, %reass.mul372
  br i1 %757, label %"end for result$2.s0.n0.n0.loopexit.unr-lcssa", label %"for result$2.s0.n0.n0"
...
"end for result$2.s0.n1":                         ; preds = %"end for result$2.s0.n0.n091", %"consume inv_fft1_S4_R4_n1$2"
  ...
  %1617 = trunc i64 %indvars.iv.next479 to i32
  %.not46 = icmp eq i32 %173, %1617
  br i1 %.not46, label %destructor_block, label %"for result$2.s0.i"

"for result$2.s0.n0.n0":                          ; preds = %"for result$2.s0.n0.n0.preheader", %"for result$2.s0.n0.n0"
  %indvars.iv472 = phi i64 [ %indvars.iv.next473.1, %"for result$2.s0.n0.n0" ], [ 0, %"for result$2.s0.n0.n0.preheader" ]
  %niter = phi i64 [ %niter.next.1, %"for result$2.s0.n0.n0" ], [ 0, %"for result$2.s0.n0.n0.preheader" ]
  %1618 = shl nuw nsw i64 %indvars.iv472, 2
  %1619 = add nsw i64 %1618, %750
  %1620 = add nsw i64 %1619, %1615
  %1621 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.020", i64 %1620
  %1622 = load <4 x float>, ptr %1621, align 4, !tbaa !32
  %1623 = fmul <4 x float> %1622, <float 3.906250e-03, float 3.906250e-03, float 3.906250e-03, float 3.906250e-03>
  %1624 = add i64 %1616, %1619
  %1625 = getelementptr inbounds float, ptr %53, i64 %1624
  store <4 x float> %1623, ptr %1625, align 4, !tbaa !92
  %indvars.iv.next473 = shl i64 %indvars.iv472, 2
  %1626 = or i64 %indvars.iv.next473, 4
  %1627 = add nsw i64 %1626, %750
  %1628 = add nsw i64 %1627, %1615
  %1629 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.020", i64 %1628
  %1630 = load <4 x float>, ptr %1629, align 4, !tbaa !32
  %1631 = fmul <4 x float> %1630, <float 3.906250e-03, float 3.906250e-03, float 3.906250e-03, float 3.906250e-03>
  %1632 = add i64 %1616, %1627
  %1633 = getelementptr inbounds float, ptr %53, i64 %1632
  store <4 x float> %1631, ptr %1633, align 4, !tbaa !92
...
"end for result$2.s0.n0.n0.loopexit.unr-lcssa":   ; preds = %"for result$2.s0.n0.n0", %"for result$2.s0.n0.n0.preheader"
  %indvars.iv472.unr = phi i64 [ 0, %"for result$2.s0.n0.n0.preheader" ], [ %indvars.iv.next473.1, %"for result$2.s0.n0.n0" ]
...
"for result$2.s0.n0.n0.epil":                     ; preds = %"end for result$2.s0.n0.n0.loopexit.unr-lcssa"
  %1634 = shl nuw nsw i64 %indvars.iv472.unr, 2
  %1635 = add nsw i64 %1634, %750
  %1636 = add nsw i64 %1635, %1615
  %1637 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.020", i64 %1636
  %1638 = load <4 x float>, ptr %1637, align 4, !tbaa !32
  %1639 = fmul <4 x float> %1638, <float 3.906250e-03, float 3.906250e-03, float 3.906250e-03, float 3.906250e-03>
  %1640 = add i64 %1616, %1635
  %1641 = getelementptr inbounds float, ptr %53, i64 %1640
  store <4 x float> %1639, ptr %1641, align 4, !tbaa !92
...
"end for result$2.s0.n0.n0":                      ; preds = %"for result$2.s0.n0.n0.epil", %"end for result$2.s0.n0.n0.loopexit.unr-lcssa", %"for result$2.s0.n1"
  br i1 %749, label %"for result$2.s0.n0.n090.preheader", label %"end for result$2.s0.n0.n091", !prof !26

"for result$2.s0.n0.n090.preheader":              ; preds = %"end for result$2.s0.n0.n0"
  %1642 = shl nsw i64 %indvars.iv475, 4
  %1643 = add nsw i64 %754, %1642
  %1644 = getelementptr inbounds float, ptr %"inv_fft1_S4_R4_n1$2.020", i64 %1643
  %1645 = load <4 x float>, ptr %1644, align 4, !tbaa !32
  %1646 = fmul <4 x float> %1645, <float 3.906250e-03, float 3.906250e-03, float 3.906250e-03, float 3.906250e-03>
  %reass.add380 = sub nsw i64 %indvars.iv475, %751
  %reass.mul381 = mul i64 %reass.add380, %241
  %1647 = add i64 %1614, %reass.mul381
  %1648 = getelementptr inbounds float, ptr %53, i64 %1647
  store <4 x float> %1646, ptr %1648, align 4, !tbaa !92
...
"end for result$2.s0.n0.n091":                    ; preds = %"for result$2.s0.n0.n090.preheader", %"end for result$2.s0.n0.n0"
  ...
  %1649 = trunc i64 %indvars.iv.next476 to i32
  %.not47 = icmp eq i32 %742, %1649
  br i1 %.not47, label %"end for result$2.s0.n1", label %"for result$2.s0.n1"
}

; Function Attrs: nounwind
define i32 @_Z85FftConvolve16x16xCHalide_x86_64_linux_c_plus_plus_name_mangling_no_runtime_sse41_argvPPv(ptr nocapture readonly %0) local_unnamed_addr #2 {
entry:
  ...
  %6 = tail call i32 @_Z80FftConvolve16x16xCHalide_x86_64_linux_c_plus_plus_name_mangling_no_runtime_sse41P15halide_buffer_tS0_S0_(ptr %1, ptr %3, ptr %5) #7
  ret i32 %6
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none)
define nonnull ptr @_Z89FftConvolve16x16xCHalide_x86_64_linux_c_plus_plus_name_mangling_no_runtime_sse41_metadatav() local_unnamed_addr #3 {
entry:
  ret ptr @_Z89FftConvolve16x16xCHalide_x86_64_linux_c_plus_plus_name_mangling_no_runtime_sse41_metadatav_storage
}

; Function Attrs: nounwind
define i32 @_Z80FftConvolve16x16xCHalide_x86_64_linux_c_plus_plus_name_mangling_no_runtime_sse41P8buffer_tS0_S0_(ptr %input, ptr %kernel, ptr %"result$2") local_unnamed_addr #1 {
entry:
  %0 = alloca %struct.halide_buffer_t, align 8
  %t2944 = alloca [12 x i32], align 4
  %1 = alloca %struct.halide_buffer_t, align 8
  %t2940 = alloca [8 x i32], align 4
  %2 = alloca %struct.halide_buffer_t, align 8
  %t2936 = alloca [12 x i32], align 4
  %3 = getelementptr inbounds %struct.halide_buffer_t, ptr %2, i64 0, i32 2
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(48) %t2936, i8 0, i64 48, i1 false)
  ...
  store ptr %t2936, ptr %8, align 8, !tbaa !18
  %9 = getelementptr inbounds %struct.halide_buffer_t, ptr %2, i64 0, i32 3
  store i64 0, ptr %9, align 8, !tbaa !25
  %10 = getelementptr inbounds %struct.halide_buffer_t, ptr %1, i64 0, i32 2
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(32) %t2940, i8 0, i64 32, i1 false)
  ...
  store ptr %t2940, ptr %15, align 8, !tbaa !18
  %16 = getelementptr inbounds %struct.halide_buffer_t, ptr %1, i64 0, i32 3
  store i64 0, ptr %16, align 8, !tbaa !25
  %17 = getelementptr inbounds %struct.halide_buffer_t, ptr %0, i64 0, i32 2
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(48) %t2944, i8 0, i64 48, i1 false)
  ...
  store ptr %t2944, ptr %22, align 8, !tbaa !18
  %23 = getelementptr inbounds %struct.halide_buffer_t, ptr %0, i64 0, i32 3
  store i64 0, ptr %23, align 8, !tbaa !25
  %t2939 = call i32 @halide_upgrade_buffer_t(ptr null, ptr nonnull @str.3, ptr %input, ptr nonnull %2) #2
  %24 = icmp eq i32 %t2939, 0
  br i1 %24, label %"assert succeeded", label %destructor_block, !prof !26

"assert succeeded":                               ; preds = %entry
  %t2943 = call i32 @halide_upgrade_buffer_t(ptr null, ptr nonnull @str.2, ptr %kernel, ptr nonnull %1) #2
  %25 = icmp eq i32 %t2943, 0
  br i1 %25, label %"assert succeeded2", label %destructor_block, !prof !26

destructor_block:                                 ; preds = %false_bb19, %true_bb18, %false_bb12, %true_bb11, %false_bb, %true_bb, %"assert succeeded4", %"assert succeeded2", %"assert succeeded", %entry
  %26 = phi i32 [ %t2939, %entry ], [ %t2943, %"assert succeeded" ], [ %t2947, %"assert succeeded2" ], [ %t2948, %"assert succeeded4" ], [ %t2937, %true_bb ], [ %t2938, %false_bb ], [ %t2941, %true_bb11 ], [ %t2942, %false_bb12 ], [ %t2945, %true_bb18 ], [ %t2946, %false_bb19 ]
  ret i32 %26

"assert succeeded2":                              ; preds = %"assert succeeded"
  %t2947 = call i32 @halide_upgrade_buffer_t(ptr null, ptr nonnull @str, ptr %"result$2", ptr nonnull %0) #2
  %27 = icmp eq i32 %t2947, 0
  br i1 %27, label %"assert succeeded4", label %destructor_block, !prof !26

"assert succeeded4":                              ; preds = %"assert succeeded2"
  %t2948 = call i32 @_Z80FftConvolve16x16xCHalide_x86_64_linux_c_plus_plus_name_mangling_no_runtime_sse41P15halide_buffer_tS0_S0_(ptr nonnull %2, ptr nonnull %1, ptr nonnull %0) #2
  %28 = icmp eq i32 %t2948, 0
...
true_bb:                                          ; preds = %"assert succeeded6"
  %t2937 = call i32 @halide_downgrade_buffer_t(ptr null, ptr nonnull @str.3, ptr nonnull %2, ptr %input) #2
  %33 = icmp eq i32 %t2937, 0
  br i1 %33, label %after_bb, label %destructor_block, !prof !26

false_bb:                                         ; preds = %"assert succeeded6"
  %t2938 = call i32 @halide_downgrade_buffer_t_device_fields(ptr null, ptr nonnull @str.3, ptr nonnull %2, ptr %input) #2
...
true_bb11:                                        ; preds = %after_bb
  %t2941 = call i32 @halide_downgrade_buffer_t(ptr null, ptr nonnull @str.2, ptr nonnull %1, ptr %kernel) #2
  %39 = icmp eq i32 %t2941, 0
  br i1 %39, label %after_bb13, label %destructor_block, !prof !26

false_bb12:                                       ; preds = %after_bb
  %t2942 = call i32 @halide_downgrade_buffer_t_device_fields(ptr null, ptr nonnull @str.2, ptr nonnull %1, ptr %kernel) #2
  %40 = icmp eq i32 %t2942, 0
...
true_bb18:                                        ; preds = %after_bb13
  %t2945 = call i32 @halide_downgrade_buffer_t(ptr null, ptr nonnull @str, ptr nonnull %0, ptr %"result$2") #2
  br label %destructor_block

false_bb19:                                       ; preds = %after_bb13
  %t2946 = call i32 @halide_downgrade_buffer_t_device_fields(ptr null, ptr nonnull @str, ptr nonnull %0, ptr %"result$2") #2
  br label %destructor_block
}
