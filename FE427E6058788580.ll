...
_ZN11CStringBaseIwE11SetCapacityEi.exit.i208:     ; preds = %delete.notnull.i.i, %_Z11MyStringLenIwEiPKT_.exit.i204
  %49 = phi ptr [ %call.i.i196, %_Z11MyStringLenIwEiPKT_.exit.i204 ], [ %call.i.i206214, %delete.notnull.i.i ]
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load443 = load <4 x i32>, ptr %76, align 4, !tbaa !5
  ...
  store <4 x i32> %wide.load443, ptr %78, align 4, !tbaa !5
...
_ZN11CStringBaseIwE10GrowLengthEi.exit.i:         ; preds = %if.end.i.i382, %_ZN11CStringBaseIwEC2ERKS0_.exit.i305, %if.end9.i.i.i402
  %ref.tmp.sroa.0.1 = phi ptr [ %call.i.i.i411, %if.end9.i.i.i402 ], [ %ref.tmp.sroa.0.0, %_ZN11CStringBaseIwEC2ERKS0_.exit.i305 ], [ %ref.tmp.sroa.0.0, %if.end.i.i382 ]
...
while.cond.i.i407:                                ; preds = %while.cond.i.i407, %_ZN11CStringBaseIwE10GrowLengthEi.exit.i
  ...
  %81 = load i32, ptr %src.addr.0.i.i403, align 4, !tbaa !5
  %incdec.ptr1.i.i406 = getelementptr inbounds i32, ptr %dest.addr.0.i.i404, i64 1
  store i32 %81, ptr %dest.addr.0.i.i404, align 4, !tbaa !5
  %cmp.not.i8.i = icmp eq i32 %81, 0
...
if.end.i.i321:                                    ; preds = %_ZN11CStringBaseIwEpLERKS0_.exit
  ...
  %83 = icmp slt i32 %add.i408, -1
  %84 = shl nuw nsw i64 %conv.i.i318, 2
  %85 = select i1 %83, i64 -1, i64 %84
  %call.i.i319334 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %85) #11
...
while.cond.i.i333:                                ; preds = %while.cond.i.i333.preheader, %while.cond.i.i333
  %src.addr.0.i.i328 = phi ptr [ %incdec.ptr.i.i330, %while.cond.i.i333 ], [ %ref.tmp.sroa.0.1, %while.cond.i.i333.preheader ]
  ...
  %86 = load i32, ptr %src.addr.0.i.i328, align 4, !tbaa !5
  %incdec.ptr1.i.i331 = getelementptr inbounds i32, ptr %dest.addr.0.i.i329, i64 1
  store i32 %86, ptr %dest.addr.0.i.i329, align 4, !tbaa !5
  %cmp.not.i.i332 = icmp eq i32 %86, 0
...
lpad123:                                          ; preds = %if.end.i.i321
  %91 = landingpad { ptr, i32 }
          cleanup
  %isnull.i341 = icmp eq ptr %ref.tmp.sroa.0.1, null
  br i1 %isnull.i341, label %ehcleanup, label %ehcleanup.sink.split

ehcleanup.sink.split:                             ; preds = %lpad123, %lpad.i307
  %ref.tmp.sroa.0.1.sink = phi ptr [ %ref.tmp.sroa.0.0, %lpad.i307 ], [ %ref.tmp.sroa.0.1, %lpad123 ]
  %.pn.ph = phi { ptr, i32 } [ %82, %lpad.i307 ], [ %91, %lpad123 ]
  tail call void @_ZdaPv(ptr noundef nonnull %ref.tmp.sroa.0.1.sink) #12
  br label %ehcleanup

ehcleanup:                                        ; preds = %ehcleanup.sink.split, %lpad123, %lpad.i307
  %.pn = phi { ptr, i32 } [ %82, %lpad.i307 ], [ %91, %lpad123 ], [ %.pn.ph, %ehcleanup.sink.split ]
...
delete.notnull.i345:                              ; preds = %ehcleanup.thread, %ehcleanup
  %.pn430 = phi { ptr, i32 } [ %90, %ehcleanup.thread ], [ %.pn, %ehcleanup ]
  tail call void @_ZdaPv(ptr noundef nonnull %ref.tmp114.sroa.0.1) #12
  br label %ehcleanup126

ehcleanup126:                                     ; preds = %delete.notnull.i345, %ehcleanup, %lpad119, %delete.notnull.i.i288, %lpad.i
  %.pn.pn = phi { ptr, i32 } [ %89, %lpad119 ], [ %67, %delete.notnull.i.i288 ], [ %67, %lpad.i ], [ %.pn, %ehcleanup ], [ %.pn430, %delete.notnull.i345 ]
...
_ZN11CStringBaseIwED2Ev.exit352:                  ; preds = %lpad117, %ehcleanup126, %delete.notnull.i348, %lpad
  %92 = phi ptr [ %call.i.i196, %lpad ], [ %49, %delete.notnull.i348 ], [ %49, %ehcleanup126 ], [ %49, %lpad117 ]
  %.pn.pn.pn.pn = phi { ptr, i32 } [ %87, %lpad ], [ %.pn.pn, %delete.notnull.i348 ], [ %.pn.pn, %ehcleanup126 ], [ %88, %lpad117 ]
  call void @llvm.lifetime.end.p0(i64 64, ptr nonnull %temp44) #10
  tail call void @_ZdaPv(ptr noundef nonnull %92) #12
