...
invoke.cont:                                      ; preds = %if.end.i
  ...
  %tobool.not.i.i17 = select i1 %tobool.not.not.i.i.i, i1 true, i1 %tobool.not12.i.i
...
invoke.cont:                                      ; preds = %if.end.i
  ...
  %tobool.not12.i.i = icmp eq ptr %retval.0.i.i.i, null
  %tobool.not.i.i21 = select i1 %tobool.not.not.i.i.i, i1 true, i1 %tobool.not12.i.i
...
for.cond.preheader:                               ; preds = %entry
  ...
  %cmp.not.i.not167174 = icmp eq i64 %2, 0
  %cmp.not.i.not167 = select i1 %tobool.not.i.i, i1 true, i1 %cmp.not.i.not167174
  br i1 %cmp.not.i.not167, label %if.end.i, label %for.body.lr.ph, !prof !27
...
for.body:                                         ; preds = %for.body.lr.ph, %_ZN9benchmark5State13StateIteratorppEv.exit
  %__begin1.sroa.0.0168 = phi i64 [ %2, %for.body.lr.ph ], [ %dec.i, %_ZN9benchmark5State13StateIteratorppEv.exit ]
...
if.then.i.i.i.i:                                  ; preds = %if.end12.i.i.i, %if.then.i.i.i, %land.lhs.true.i.i
  %retval.sroa.12.2.i.ph.i = phi ptr [ %__y.0.lcssa49.i.i.i, %if.then.i.i.i ], [ %23, %land.lhs.true.i.i ], [ %__y.0.lcssa50.i.i.i, %if.end12.i.i.i ]
...
for.cond13.preheader:                             ; preds = %_ZNSt3setIlSt4lessIlESaIlEED2Ev.exit
  ...
  %sub.ptr.lhs.cast.i.i68162 = ptrtoint ptr %42 to i64
  %sub.ptr.rhs.cast.i.i69163 = ptrtoint ptr %43 to i64
  %sub.ptr.sub.i.i70164 = sub i64 %sub.ptr.lhs.cast.i.i68162, %sub.ptr.rhs.cast.i.i69163
  %cmp.i72165 = icmp ugt i64 %sub.ptr.sub.i.i70164, 8
  br i1 %cmp.i72165, label %_ZNK9benchmark5State5rangeEm.exit75, label %cond.false.i73
...
_ZN9benchmark5State13StateIteratorppEv.exit:      ; preds = %_ZNK9benchmark5State5rangeEm.exit75
  %dec.i = add i64 %__begin1.sroa.0.0168, -1
  %cmp.not.i.not = icmp eq i64 %dec.i, 0
...
_ZNSt8_Rb_treeIllSt9_IdentityIlESt4lessIlESaIlEE10_M_insert_IlNS5_11_Alloc_nodeEEESt17_Rb_tree_iteratorIlEPSt18_Rb_tree_node_baseSB_OT_RT0_.exit.i.i: ; preds = %if.then.i.i, %lor.rhs.i.i.i
  ...
  %call5.i.i.i.i.i.i.i.i149 = invoke noalias noundef nonnull dereferenceable(40) ptr @_Znwm(i64 noundef 40) #26
...
call5.i.i.i.i.i.i.i.i.noexc:                      ; preds = %_ZNSt8_Rb_treeIllSt9_IdentityIlESt4lessIlESaIlEE10_M_insert_IlNS5_11_Alloc_nodeEEESt17_Rb_tree_iteratorIlEPSt18_Rb_tree_node_baseSB_OT_RT0_.exit.i.i
  %_M_storage.i.i.i.i.i.i.i = getelementptr inbounds %"struct.std::_Rb_tree_node", ptr %call5.i.i.i.i.i.i.i.i149, i64 0, i32 1
  store i64 %conv19, ptr %_M_storage.i.i.i.i.i.i.i, align 8, !tbaa !51
  call void @_ZSt29_Rb_tree_insert_and_rebalancebPSt18_Rb_tree_node_baseS0_RS_(i1 noundef zeroext %51, ptr noundef nonnull %call5.i.i.i.i.i.i.i.i149, ptr noundef nonnull %retval.sroa.4.0.i.ph.i.i, ptr noundef nonnull align 8 dereferenceable(32) %0) #22
...
_ZN9benchmark5State17SetBytesProcessedEl.exit:    ; preds = %invoke.cont5.i107, %if.then.i.i11.i108
  ...
  invoke void @_ZNSt8_Rb_treeIllSt9_IdentityIlESt4lessIlESaIlEE8_M_eraseEPSt13_Rb_tree_nodeIlE(ptr noundef nonnull align 8 dereferenceable(48) %data, ptr noundef %69)
          to label %_ZNSt3setIlSt4lessIlESaIlEED2Ev.exit152 unwind label %terminate.lpad.i.i151

terminate.lpad.i.i151:                            ; preds = %_ZN9benchmark5State17SetBytesProcessedEl.exit
...
_ZNSt3setIlSt4lessIlESaIlEED2Ev.exit152:          ; preds = %_ZN9benchmark5State17SetBytesProcessedEl.exit
...
lpad7:                                            ; preds = %if.end.i, %invoke.cont3
