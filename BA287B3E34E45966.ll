...
; Function Attrs: nounwind uwtable
define dso_local noalias ptr @ma_malloc(i64 noundef %0, ptr noundef %1, i32 noundef %2) local_unnamed_addr #0 {
  %4 = tail call noalias ptr @malloc(i64 noundef %0) #6
  %5 = icmp eq ptr %4, null
  br i1 %5, label %6, label %8

6:                                                ; preds = %3
  %7 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, ptr noundef %1, i32 noundef %2)
  tail call void @exit(i32 noundef -1) #7
  unreachable

8:                                                ; preds = %3
  %9 = load i32, ptr @counter_malloc, align 4, !tbaa !5
  %10 = add nsw i32 %9, 1
  store i32 %10, ptr @counter_malloc, align 4, !tbaa !5
  %11 = uitofp i64 %0 to double
  %12 = load double, ptr @size_malloc, align 8, !tbaa !9
  %13 = fadd double %12, %11
  store double %13, ptr @size_malloc, align 8, !tbaa !9
  ret ptr %4
}
