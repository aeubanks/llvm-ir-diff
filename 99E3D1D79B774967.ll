...
define dso_local void @parseCommandLine(ptr noalias sret(%struct.CommandSt) align 8 %0, i32 noundef %1, ptr noundef %2) local_unnamed_addr #0 {
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(5) %0, ptr noundef nonnull align 1 dereferenceable(5) @.str, i64 5, i1 false) #8
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(7) %6, ptr noundef nonnull align 1 dereferenceable(7) @.str.2, i64 7, i1 false) #8
  ...
  store <4 x i32> <i32 0, i32 20, i32 20, i32 20>, ptr %8, align 8, !tbaa !5
  ...
  store <4 x i32> <i32 1, i32 1, i32 1, i32 100>, ptr %12, align 8, !tbaa !5
  %16 = getelementptr inbounds %struct.CommandSt, ptr %0, i64 0, i32 11
  store i32 10, ptr %16, align 8, !tbaa !9
  ...
  store <2 x double> <double 1.000000e+00, double -1.000000e+00>, ptr %17, align 8, !tbaa !12
  ...
  store <2 x double> <double 6.000000e+02, double 0.000000e+00>, ptr %19, align 8, !tbaa !12
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %4) #8
  store i32 0, ptr %4, align 4, !tbaa !5
  %21 = call i32 @addArg(ptr noundef nonnull @.str.3, i8 noundef signext 104, i32 noundef 0, i8 noundef signext 105, ptr noundef nonnull %4, i32 noundef 0, ptr noundef nonnull @.str.4) #8
  %22 = call i32 @addArg(ptr noundef nonnull @.str.5, i8 noundef signext 100, i32 noundef 1, i8 noundef signext 115, ptr noundef %0, i32 noundef 1024, ptr noundef nonnull @.str.6) #8
  %23 = call i32 @addArg(ptr noundef nonnull @.str.7, i8 noundef signext 112, i32 noundef 1, i8 noundef signext 115, ptr noundef nonnull %5, i32 noundef 1024, ptr noundef nonnull @.str.8) #8
  %24 = call i32 @addArg(ptr noundef nonnull @.str.9, i8 noundef signext 116, i32 noundef 1, i8 noundef signext 115, ptr noundef nonnull %6, i32 noundef 1024, ptr noundef nonnull @.str.10) #8
  %25 = call i32 @addArg(ptr noundef nonnull @.str.11, i8 noundef signext 101, i32 noundef 0, i8 noundef signext 105, ptr noundef nonnull %8, i32 noundef 0, ptr noundef nonnull @.str.12) #8
  %26 = call i32 @addArg(ptr noundef nonnull @.str.13, i8 noundef signext 120, i32 noundef 1, i8 noundef signext 105, ptr noundef nonnull %9, i32 noundef 0, ptr noundef nonnull @.str.14) #8
  %27 = call i32 @addArg(ptr noundef nonnull @.str.15, i8 noundef signext 121, i32 noundef 1, i8 noundef signext 105, ptr noundef nonnull %10, i32 noundef 0, ptr noundef nonnull @.str.16) #8
  %28 = call i32 @addArg(ptr noundef nonnull @.str.17, i8 noundef signext 122, i32 noundef 1, i8 noundef signext 105, ptr noundef nonnull %11, i32 noundef 0, ptr noundef nonnull @.str.18) #8
  %29 = call i32 @addArg(ptr noundef nonnull @.str.19, i8 noundef signext 105, i32 noundef 1, i8 noundef signext 105, ptr noundef nonnull %12, i32 noundef 0, ptr noundef nonnull @.str.20) #8
  %30 = call i32 @addArg(ptr noundef nonnull @.str.21, i8 noundef signext 106, i32 noundef 1, i8 noundef signext 105, ptr noundef nonnull %13, i32 noundef 0, ptr noundef nonnull @.str.22) #8
  %31 = call i32 @addArg(ptr noundef nonnull @.str.23, i8 noundef signext 107, i32 noundef 1, i8 noundef signext 105, ptr noundef nonnull %14, i32 noundef 0, ptr noundef nonnull @.str.24) #8
  %32 = call i32 @addArg(ptr noundef nonnull @.str.25, i8 noundef signext 78, i32 noundef 1, i8 noundef signext 105, ptr noundef nonnull %15, i32 noundef 0, ptr noundef nonnull @.str.26) #8
  %33 = call i32 @addArg(ptr noundef nonnull @.str.27, i8 noundef signext 110, i32 noundef 1, i8 noundef signext 105, ptr noundef nonnull %16, i32 noundef 0, ptr noundef nonnull @.str.28) #8
  %34 = call i32 @addArg(ptr noundef nonnull @.str.29, i8 noundef signext 68, i32 noundef 1, i8 noundef signext 100, ptr noundef nonnull %17, i32 noundef 0, ptr noundef nonnull @.str.30) #8
  %35 = call i32 @addArg(ptr noundef nonnull @.str.31, i8 noundef signext 108, i32 noundef 1, i8 noundef signext 100, ptr noundef nonnull %18, i32 noundef 0, ptr noundef nonnull @.str.32) #8
  %36 = call i32 @addArg(ptr noundef nonnull @.str.33, i8 noundef signext 84, i32 noundef 1, i8 noundef signext 100, ptr noundef nonnull %19, i32 noundef 0, ptr noundef nonnull @.str.34) #8
  %37 = call i32 @addArg(ptr noundef nonnull @.str.35, i8 noundef signext 114, i32 noundef 1, i8 noundef signext 100, ptr noundef nonnull %20, i32 noundef 0, ptr noundef nonnull @.str.36) #8
  call void @processArgs(i32 noundef %1, ptr noundef %2) #8
...
43:                                               ; preds = %40
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(15) %5, ptr noundef nonnull align 1 dereferenceable(15) @.str.38, i64 15, i1 false) #8
  br label %44

44:                                               ; preds = %43, %40
  %45 = call i32 @bcmp(ptr noundef nonnull dereferenceable(7) %6, ptr noundef nonnull dereferenceable(7) @.str.2, i64 7)
  %46 = icmp eq i32 %45, 0
  br i1 %46, label %47, label %48

47:                                               ; preds = %44
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(10) %5, ptr noundef nonnull align 1 dereferenceable(10) @.str.39, i64 10, i1 false) #8
  br label %48
...
; Function Attrs: nounwind uwtable
define dso_local void @printCmdYaml(ptr nocapture noundef %0, ptr noundef %1) local_unnamed_addr #0 {
  %3 = tail call i32 @printRank() #8
  %4 = icmp eq i32 %3, 0
...
5:                                                ; preds = %2
  ...
  %35 = tail call i32 @fflush(ptr noundef %0)
  br label %36
