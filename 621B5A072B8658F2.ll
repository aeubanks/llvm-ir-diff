...
if.end36:                                         ; preds = %if.then21, %for.inc, %for.inc.1, %if.then34, %if.end18
  ...
  %add.ptr38.ptr.ptr290 = getelementptr inbounds i8, ptr %buff, i64 -88
  %add.ptr69 = getelementptr inbounds i8, ptr %buff, i64 -84
  %conv79 = zext i16 %sects to i32
  %cmp80284.not = icmp eq i16 %sects, 0
  br i1 %cmp80284.not, label %if.end61.us294, label %if.end61.us.preheader
...
if.end61.us.preheader:                            ; preds = %if.end36
  ...
  %broadcast.splatinsert327 = insertelement <4 x i32> poison, i32 %key.2, i64 0
...
if.end61.us:                                      ; preds = %if.end61.us.preheader, %while.cond.us
  %indvars.iv312 = phi i64 [ 0, %if.end61.us.preheader ], [ %indvars.iv.next313, %while.cond.us ]
  %add.ptr38.ptr.ptr293.us = phi ptr [ %add.ptr38.ptr.ptr290, %if.end61.us.preheader ], [ %add.ptr38.ptr.ptr.us, %while.cond.us ]
  %idx.ext292.us = phi i64 [ 0, %if.end61.us.preheader ], [ %0, %while.cond.us ]
  %add.ptr38.val.us = load i32, ptr %add.ptr38.ptr.ptr293.us, align 1
  %xor67.us = xor i32 %add.ptr38.val.us, %bkey
  %add.ptr72.us = getelementptr inbounds i8, ptr %add.ptr69, i64 %idx.ext292.us
  %add.ptr72.val.us = load i32, ptr %add.ptr72.us, align 1
  %xor74.us = xor i32 %add.ptr72.val.us, %bkey
...
while.cond.us:                                    ; preds = %for.end138.us
  ...
  %0 = shl nsw i64 %indvars.iv.next313, 3
  %add.ptr37.add.us = add nsw i64 %0, -88
  %add.ptr38.ptr.ptr.us = getelementptr inbounds i8, ptr %buff, i64 %add.ptr37.add.us
  %exitcond316 = icmp eq i64 %indvars.iv.next313, 20
  br i1 %exitcond316, label %if.then60, label %if.end61.us

if.end77.us:                                      ; preds = %if.end61.us
  %1 = trunc i64 %indvars.iv312 to i32
  tail call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.5, i32 noundef %1, i32 noundef %xor67.us, i32 noundef %xor74.us) #6
  %cmp86.us = icmp eq i32 %xor74.us, 0
  %add.us = add i32 %xor74.us, %xor67.us
  br label %for.body82.us

for.body82.us:                                    ; preds = %if.end77.us, %for.inc136.us
  %indvars.iv = phi i64 [ 0, %if.end77.us ], [ %indvars.iv.next, %for.inc136.us ]
  %rsz.us = getelementptr inbounds %struct.cli_exe_section, ptr %sections, i64 %indvars.iv, i32 3
  %2 = load i32, ptr %rsz.us, align 4, !tbaa !5
  %cmp83.us = icmp eq i32 %2, 0
  %or.cond177.us.not = select i1 %cmp83.us, i1 true, i1 %cmp86.us
  %cmp92.not.us = icmp ugt i32 %xor74.us, %2
  %or.cond.us = select i1 %or.cond177.us.not, i1 true, i1 %cmp92.not.us
  br i1 %or.cond.us, label %for.inc136.us, label %land.lhs.true94.us

land.lhs.true94.us:                               ; preds = %for.body82.us
  %arrayidx.us = getelementptr inbounds %struct.cli_exe_section, ptr %sections, i64 %indvars.iv
  %3 = load i32, ptr %arrayidx.us, align 4, !tbaa !10
  %cmp97.not.us = icmp ult i32 %xor67.us, %3
  br i1 %cmp97.not.us, label %for.inc136.us, label %land.lhs.true99.us

land.lhs.true99.us:                               ; preds = %land.lhs.true94.us
  %add106.us = add i32 %3, %2
  %cmp107.not.us = icmp ule i32 %add.us, %add106.us
  %cmp114.us = icmp ugt i32 %add.us, %3
...
if.end117.us:                                     ; preds = %land.lhs.true99.us
  ...
  %cmp130287.us = icmp ugt i32 %xor74.us, 3
  br i1 %cmp130287.us, label %while.body132.us.preheader, label %for.end138.us

while.body132.us.preheader:                       ; preds = %if.end117.us
  %idx.ext121.us = zext i32 %3 to i64
  ...
  %5 = load i32, ptr %raw.us, align 4, !tbaa !11
  %idx.ext127.us = zext i32 %5 to i64
  %add.ptr128.us = getelementptr inbounds i8, ptr %add.ptr124.us, i64 %idx.ext127.us
  %6 = add i32 %xor74.us, -4
  %7 = lshr i32 %6, 2
  %narrow = add nuw nsw i32 %7, 1
  %8 = zext i32 %narrow to i64
  %min.iters.check = icmp ult i32 %6, 28
  br i1 %min.iters.check, label %while.body132.us.preheader329, label %vector.ph

vector.ph:                                        ; preds = %while.body132.us.preheader
  %n.vec = and i64 %8, 2147483640
  %.cast = trunc i64 %n.vec to i32
  %9 = shl i32 %.cast, 2
  %ind.end = sub i32 %xor74.us, %9
  %10 = shl nuw nsw i64 %n.vec, 2
  %ind.end323 = getelementptr i8, ptr %add.ptr128.us, i64 %10
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ]
  %11 = shl i64 %index, 2
  %next.gep = getelementptr i8, ptr %add.ptr128.us, i64 %11
  %wide.load = load <4 x i32>, ptr %next.gep, align 1
  %12 = getelementptr i32, ptr %next.gep, i64 4
  %wide.load326 = load <4 x i32>, ptr %12, align 1
  %13 = xor <4 x i32> %wide.load, %broadcast.splat
  %14 = xor <4 x i32> %wide.load326, %broadcast.splat328
  store <4 x i32> %13, ptr %next.gep, align 1
  store <4 x i32> %14, ptr %12, align 1
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %for.end138.us, label %while.body132.us.preheader329

while.body132.us.preheader329:                    ; preds = %while.body132.us.preheader, %middle.block
  %sz.1289.us.ph = phi i32 [ %xor74.us, %while.body132.us.preheader ], [ %ind.end, %middle.block ]
  %hunk.0288.us.ph = phi ptr [ %add.ptr128.us, %while.body132.us.preheader ], [ %ind.end323, %middle.block ]
  br label %while.body132.us

for.end138.us:                                    ; preds = %while.body132.us, %middle.block, %if.end117.us
  %cmp140.us = icmp eq i32 %4, %conv79
  br i1 %cmp140.us, label %if.then142, label %while.cond.us

while.body132.us:                                 ; preds = %while.body132.us.preheader329, %while.body132.us
  %sz.1289.us = phi i32 [ %sub.us, %while.body132.us ], [ %sz.1289.us.ph, %while.body132.us.preheader329 ]
  %hunk.0288.us = phi ptr [ %add.ptr135.us, %while.body132.us ], [ %hunk.0288.us.ph, %while.body132.us.preheader329 ]
  %hunk.0.val.us = load i32, ptr %hunk.0288.us, align 1
  %xor134.us = xor i32 %hunk.0.val.us, %key.2
  store i32 %xor134.us, ptr %hunk.0288.us, align 1
  %add.ptr135.us = getelementptr inbounds i8, ptr %hunk.0288.us, i64 4
  %sub.us = add i32 %sz.1289.us, -4
  %cmp130.us = icmp ugt i32 %sub.us, 3
  br i1 %cmp130.us, label %while.body132.us, label %for.end138.us, !llvm.loop !16

for.inc136.us:                                    ; preds = %land.lhs.true99.us, %land.lhs.true94.us, %for.body82.us
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %if.then142, label %for.body82.us, !llvm.loop !17

if.end61.us294:                                   ; preds = %if.end36
  %add.ptr38.val.us298 = load i32, ptr %add.ptr38.ptr.ptr290, align 1
  %xor67.us299 = xor i32 %add.ptr38.val.us298, %bkey
  %tobool75.not.us303 = icmp eq i32 %xor67.us299, 0
  br i1 %tobool75.not.us303, label %while.end145, label %if.end77.us304

if.end77.us304:                                   ; preds = %if.end61.us294
  %add.ptr72.val.us301 = load i32, ptr %add.ptr69, align 1
  %xor74.us302 = xor i32 %add.ptr72.val.us301, %bkey
  tail call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.5, i32 noundef 0, i32 noundef %xor67.us299, i32 noundef %xor74.us302) #6
  br label %if.then142
...
if.then142:                                       ; preds = %for.end138.us, %for.inc136.us, %if.end77.us304
  tail call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.6) #6
  tail call void @free(ptr noundef %call) #6
  br label %cleanup

while.end145:                                     ; preds = %if.end61.us, %if.end61.us294
