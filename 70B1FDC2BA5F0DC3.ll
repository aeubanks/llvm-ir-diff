...
entry:
  %call = tail call i32 @init(ptr noundef nonnull @.str.44)
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
  %cmp27 = icmp sgt i32 %0, 0
  br i1 %cmp27, label %vector.ph, label %for.cond.cleanup

vector.ph:                                        ; preds = %entry, %for.cond.cleanup3
  %nl.028 = phi i32 [ %inc15, %for.cond.cleanup3 ], [ 0, %entry ]
  br label %vector.body
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load30 = load <2 x double>, ptr %2, align 16, !tbaa !5
  %3 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 %index
  %wide.load31 = load <2 x double>, ptr %3, align 32, !tbaa !5
  %4 = getelementptr inbounds double, ptr %3, i64 2
  %wide.load32 = load <2 x double>, ptr %4, align 16, !tbaa !5
  %5 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 %index
  %wide.load33 = load <2 x double>, ptr %5, align 32, !tbaa !5
  %6 = getelementptr inbounds double, ptr %5, i64 2
  %wide.load34 = load <2 x double>, ptr %6, align 16, !tbaa !5
  %7 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %wide.load31, <2 x double> %wide.load33, <2 x double> %wide.load)
  %8 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %wide.load32, <2 x double> %wide.load34, <2 x double> %wide.load30)
...
entry:
  ...
  br i1 %cmp35, label %vector.ph, label %for.cond.cleanup

vector.ph:                                        ; preds = %entry, %for.cond.cleanup3
  %nl.036 = phi i32 [ %inc21, %for.cond.cleanup3 ], [ 0, %entry ]
  br label %vector.body
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %2 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 %index
  %wide.load38 = load <2 x double>, ptr %2, align 16, !tbaa !5
  %3 = fadd <2 x double> %wide.load, %wide.load38
  %4 = getelementptr inbounds double, ptr @global_data, i64 %index
  %wide.load39 = load <2 x double>, ptr %4, align 16, !tbaa !5
  %5 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 %index
  %wide.load40 = load <2 x double>, ptr %5, align 16, !tbaa !5
  %6 = fadd <2 x double> %wide.load39, %wide.load40
  store <2 x double> %6, ptr %1, align 16, !tbaa !5
  %7 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 11, i64 %index
  %wide.load41 = load <2 x double>, ptr %7, align 16, !tbaa !5
  %8 = fmul <2 x double> %3, %wide.load41
  store <2 x double> %8, ptr %4, align 16, !tbaa !5
  %index.next = add nuw i64 %index, 2
  %9 = icmp eq i64 %index.next, 32000
  br i1 %9, label %for.cond.cleanup3, label %vector.body, !llvm.loop !368

for.cond.cleanup:                                 ; preds = %for.cond.cleanup3, %entry
  %call23 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.138, double noundef 0.000000e+00)
  br label %for.body.i
...
for.cond.cleanup3:                                ; preds = %vector.body
  ...
  %inc21 = add nuw nsw i32 %nl.036, 1
...
for.cond.cleanup:                                 ; preds = %for.cond.cleanup3, %entry
  %call22 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.139, double noundef 0.000000e+00)
  br label %for.body.i
...
for.cond.cleanup3:                                ; preds = %for.body4
  ...
  %cmp = icmp slt i32 %inc20, %7
  br i1 %cmp, label %for.cond1.preheader, label %for.cond.cleanup

for.body4:                                        ; preds = %for.cond1.preheader, %for.body4
  %indvars.iv = phi i64 [ 0, %for.cond1.preheader ], [ %indvars.iv.next, %for.body4 ]
  %s.032 = phi double [ 0.000000e+00, %for.cond1.preheader ], [ %add, %for.body4 ]
  ...
  %mul = fmul double %s.032, %8
  %arrayidx6 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv
  store double %mul, ptr %arrayidx6, align 8, !tbaa !5
  %arrayidx8 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %indvars.iv
  %9 = load double, ptr %arrayidx8, align 8, !tbaa !5
  %arrayidx10 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 %indvars.iv
  ...
  %add15 = fadd double %mul, %11
  store double %add15, ptr %arrayidx8, align 8, !tbaa !5
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, 32000
...
entry:
  ...
  br i1 %cmp40, label %for.cond1.preheader, label %for.cond.cleanup

for.cond1.preheader:                              ; preds = %entry, %for.body4
  %nl.041 = phi i32 [ %inc25, %for.body4 ], [ 0, %entry ]
...
vector.body:                                      ; preds = %vector.body, %for.cond1.preheader
  ...
  %vector.recur = phi <2 x double> [ %vector.recur.init, %for.cond1.preheader ], [ %3, %vector.body ]
  %1 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %index
  %wide.load = load <2 x double>, ptr %1, align 16, !tbaa !5
  %2 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 %index
  %wide.load43 = load <2 x double>, ptr %2, align 16, !tbaa !5
  %3 = fadd <2 x double> %wide.load, %wide.load43
  %4 = shufflevector <2 x double> %vector.recur, <2 x double> %3, <2 x i32> <i32 1, i32 2>
  %5 = or i64 %index, 1
  %6 = getelementptr inbounds double, ptr @global_data, i64 %5
  store <2 x double> %3, ptr %6, align 8, !tbaa !5
  %7 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 11, i64 %index
  %wide.load44 = load <2 x double>, ptr %7, align 16, !tbaa !5
  %8 = fmul <2 x double> %wide.load43, %wide.load44
  store <2 x double> %8, ptr %1, align 16, !tbaa !5
  %9 = fmul <2 x double> %wide.load44, %4
  %10 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 %index
  store <2 x double> %9, ptr %10, align 16, !tbaa !5
  %index.next = add nuw i64 %index, 2
  %11 = icmp eq i64 %index.next, 31998
  br i1 %11, label %for.body4, label %vector.body, !llvm.loop !369

for.cond.cleanup:                                 ; preds = %for.body4, %entry
  %call27 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.140, double noundef 0.000000e+00)
  br label %for.body.i
...
for.body4:                                        ; preds = %vector.body
  %vector.recur.extract = extractelement <2 x double> %3, i64 1
  %18 = load double, ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 31998), align 16, !tbaa !5
  %19 = load double, ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 31998), align 16, !tbaa !5
  %add = fadd double %18, %19
  store double %add, ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 0, i64 31999), align 8, !tbaa !5
  %20 = load double, ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 11, i64 31998), align 16, !tbaa !5
  %mul = fmul double %19, %20
  store double %mul, ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 31998), align 16, !tbaa !5
  %mul20 = fmul double %20, %vector.recur.extract
  store double %mul20, ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 31998), align 16, !tbaa !5
  ...
  %inc25 = add nuw nsw i32 %nl.041, 1
  %21 = load i32, ptr @ntimes, align 4, !tbaa !17
  %cmp = icmp slt i32 %inc25, %21
  br i1 %cmp, label %for.cond1.preheader, label %for.cond.cleanup
}
...
entry:
  %call = tail call i32 @init(ptr noundef nonnull @.str.45)
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
  %cmp22 = icmp sgt i32 %0, 0
  br i1 %cmp22, label %vector.ph, label %for.cond.cleanup

vector.ph:                                        ; preds = %entry, %for.cond.cleanup3
  %nl.023 = phi i32 [ %inc11, %for.cond.cleanup3 ], [ 0, %entry ]
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ]
  %vector.recur = phi <2 x double> [ <double poison, double 0.000000e+00>, %vector.ph ], [ %6, %vector.body ]
  %1 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %index
  %wide.load = load <2 x double>, ptr %1, align 32, !tbaa !5
  %2 = getelementptr inbounds double, ptr %1, i64 2
  ...
  %5 = fmul <2 x double> %wide.load, %wide.load26
  %6 = fmul <2 x double> %wide.load25, %wide.load27
  %7 = shufflevector <2 x double> %vector.recur, <2 x double> %5, <2 x i32> <i32 1, i32 2>
  %8 = shufflevector <2 x double> %5, <2 x double> %6, <2 x i32> <i32 1, i32 2>
  %9 = fadd <2 x double> %7, %5
  %10 = fadd <2 x double> %8, %6
  %11 = getelementptr inbounds double, ptr @global_data, i64 %index
  store <2 x double> %9, ptr %11, align 32, !tbaa !5
  %12 = getelementptr inbounds double, ptr %11, i64 2
  store <2 x double> %10, ptr %12, align 16, !tbaa !5
  %index.next = add nuw i64 %index, 4
  %13 = icmp eq i64 %index.next, 32000
  br i1 %13, label %for.cond.cleanup3, label %vector.body, !llvm.loop !370
...
for.cond.cleanup3:                                ; preds = %vector.body
  ...
  %inc11 = add nuw nsw i32 %nl.023, 1
  %20 = load i32, ptr @ntimes, align 4, !tbaa !17
  %cmp = icmp slt i32 %inc11, %20
  br i1 %cmp, label %vector.ph, label %for.cond.cleanup
}
...
entry:
  %call = tail call i32 @init(ptr noundef nonnull @.str.46)
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
  %cmp35 = icmp sgt i32 %0, 0
  br i1 %cmp35, label %for.cond1.preheader, label %for.cond.cleanup

for.cond1.preheader:                              ; preds = %entry, %for.cond.cleanup3
  %nl.036 = phi i32 [ %inc20, %for.cond.cleanup3 ], [ 0, %entry ]
  br label %for.body4

for.cond.cleanup:                                 ; preds = %for.cond.cleanup3, %entry
  %call22 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.142, double noundef 0.000000e+00)
  br label %for.body.i
...
if.then:                                          ; preds = %for.body4
  ...
  %9 = load double, ptr %arrayidx13, align 8, !tbaa !5
  %neg = fneg double %8
  %10 = tail call double @llvm.fmuladd.f64(double %neg, double %9, double %7)
  ...
  store double %add, ptr %arrayidx15, align 8, !tbaa !5
  store double %10, ptr %arrayidx, align 8, !tbaa !5
  br label %for.inc
...
entry:
  %call = tail call i32 @init(ptr noundef nonnull @.str.47)
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
...
vector.ph:                                        ; preds = %entry, %for.cond.cleanup3
  ...
  %7 = load double, ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 31999), align 8, !tbaa !5
  %vector.recur.init = insertelement <2 x double> poison, double %7, i64 1
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ]
  %vector.recur = phi <2 x double> [ %vector.recur.init, %vector.ph ], [ %wide.load26, %vector.body ]
  ...
  %9 = getelementptr inbounds double, ptr %8, i64 2
  %wide.load26 = load <2 x double>, ptr %9, align 16, !tbaa !5
  %10 = shufflevector <2 x double> %vector.recur, <2 x double> %wide.load, <2 x i32> <i32 1, i32 2>
  %11 = shufflevector <2 x double> %wide.load, <2 x double> %wide.load26, <2 x i32> <i32 1, i32 2>
  %12 = fadd <2 x double> %10, %wide.load
  %13 = fadd <2 x double> %11, %wide.load26
  %14 = fmul <2 x double> %12, <double 5.000000e-01, double 5.000000e-01>
  %15 = fmul <2 x double> %13, <double 5.000000e-01, double 5.000000e-01>
  %16 = getelementptr inbounds double, ptr @global_data, i64 %index
  store <2 x double> %14, ptr %16, align 32, !tbaa !5
  %17 = getelementptr inbounds double, ptr %16, i64 2
  store <2 x double> %15, ptr %17, align 16, !tbaa !5
  %index.next = add nuw i64 %index, 4
  %18 = icmp eq i64 %index.next, 32000
  br i1 %18, label %for.cond.cleanup3, label %vector.body, !llvm.loop !371
...
entry:
  %call = tail call i32 @init(ptr noundef nonnull @.str.48)
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
  %cmp24 = icmp sgt i32 %0, 0
  br i1 %cmp24, label %vector.ph, label %for.cond.cleanup

for.cond.cleanup:                                 ; preds = %for.cond.cleanup3, %entry
  %call14 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.144, double noundef 0.000000e+00)
  br label %for.body.i
...
vector.ph:                                        ; preds = %entry, %for.cond.cleanup3
  ...
  %7 = load double, ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 31998), align 16, !tbaa !5
  %8 = load double, ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 31999), align 8, !tbaa !5
  %vector.recur.init = insertelement <2 x double> poison, double %7, i64 1
  %vector.recur.init27 = insertelement <2 x double> poison, double %8, i64 1
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ]
  %vector.recur = phi <2 x double> [ %vector.recur.init, %vector.ph ], [ %12, %vector.body ]
  %vector.recur28 = phi <2 x double> [ %vector.recur.init27, %vector.ph ], [ %wide.load29, %vector.body ]
  %9 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %index
  %wide.load = load <2 x double>, ptr %9, align 32, !tbaa !5
  %10 = getelementptr inbounds double, ptr %9, i64 2
  %wide.load29 = load <2 x double>, ptr %10, align 16, !tbaa !5
  %11 = shufflevector <2 x double> %vector.recur28, <2 x double> %wide.load, <2 x i32> <i32 1, i32 2>
  %12 = shufflevector <2 x double> %wide.load, <2 x double> %wide.load29, <2 x i32> <i32 1, i32 2>
  %13 = shufflevector <2 x double> %vector.recur, <2 x double> %11, <2 x i32> <i32 1, i32 2>
  %14 = fadd <2 x double> %11, %wide.load
  %15 = fadd <2 x double> %12, %wide.load29
  %16 = fadd <2 x double> %13, %14
  %17 = fadd <2 x double> %wide.load, %15
  %18 = fmul <2 x double> %16, <double 3.330000e-01, double 3.330000e-01>
  %19 = fmul <2 x double> %17, <double 3.330000e-01, double 3.330000e-01>
  %20 = getelementptr inbounds double, ptr @global_data, i64 %index
  store <2 x double> %18, ptr %20, align 32, !tbaa !5
  %21 = getelementptr inbounds double, ptr %20, i64 2
  store <2 x double> %19, ptr %21, align 16, !tbaa !5
  %index.next = add nuw i64 %index, 4
  %22 = icmp eq i64 %index.next, 32000
  br i1 %22, label %for.cond.cleanup3, label %vector.body, !llvm.loop !372
...
entry:
  %call = tail call i32 @init(ptr noundef nonnull @.str.49)
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
  %cmp50 = icmp sgt i32 %0, 255
  br i1 %cmp50, label %for.cond1.preheader, label %for.cond.cleanup

for.cond1.preheader:                              ; preds = %entry, %for.cond.cleanup3
  %nl.051 = phi i32 [ %inc30, %for.cond.cleanup3 ], [ 0, %entry ]
  br label %for.cond5.preheader

for.cond.cleanup:                                 ; preds = %for.cond.cleanup3, %entry
  %call34 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.145, double noundef 0.000000e+00)
  br label %for.body.i
...
for.body8:                                        ; preds = %for.cond5.preheader, %for.body8
  ...
  %arrayidx = getelementptr inbounds double, ptr @global_data, i64 %12
  ...
  store double %sub9, ptr %arrayidx11, align 8, !tbaa !5
  %arrayidx17 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), i64 %indvars.iv, i64 %indvars.iv54
  %14 = load double, ptr %arrayidx17, align 8, !tbaa !5
  %arrayidx19 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 %indvars.iv
  %15 = load double, ptr %arrayidx19, align 8, !tbaa !5
  %16 = tail call double @llvm.fmuladd.f64(double %14, double %15, double %sub9)
  %arrayidx24 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 20, i64 0, i64 0), i64 %indvars.iv, i64 %indvars.iv54
  store double %16, ptr %arrayidx24, align 8, !tbaa !5
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
...
entry:
  %call = tail call i32 @init(ptr noundef nonnull @.str.50)
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
  %cmp52 = icmp sgt i32 %0, 255
  br i1 %cmp52, label %for.cond1.preheader, label %for.cond.cleanup

for.cond1.preheader:                              ; preds = %entry, %for.cond.cleanup3
  %nl.053 = phi i32 [ %inc31, %for.cond.cleanup3 ], [ 0, %entry ]
  br label %for.cond5.preheader

for.cond.cleanup:                                 ; preds = %for.cond.cleanup3, %entry
  %call35 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.146, double noundef 0.000000e+00)
  br label %for.body.i
...
for.cond5.preheader:                              ; preds = %for.cond1.preheader, %for.cond.cleanup7
  %indvars.iv55 = phi i64 [ 1, %for.cond1.preheader ], [ %indvars.iv.next56, %for.cond.cleanup7 ]
  %11 = add nsw i64 %indvars.iv55, -1
  %arrayidx12 = getelementptr inbounds double, ptr @global_data, i64 %11
  %arrayidx15 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv55
  %.pre = load double, ptr %arrayidx12, align 8, !tbaa !5
  br label %for.body8

for.cond.cleanup3:                                ; preds = %for.cond.cleanup7
  %call29 = tail call i32 @dummy(ptr noundef nonnull @global_data, ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 11, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 20, i64 0, i64 0), double noundef 0.000000e+00) #16
  %inc31 = add nuw nsw i32 %nl.053, 1
  %12 = load i32, ptr @ntimes, align 4, !tbaa !17
  %div = sdiv i32 %12, 256
  %mul = mul nsw i32 %div, 10
  %cmp = icmp slt i32 %inc31, %mul
  br i1 %cmp, label %for.cond1.preheader, label %for.cond.cleanup

for.cond.cleanup7:                                ; preds = %for.body8
  store double %sub13.1, ptr %arrayidx15, align 8, !tbaa !5
  %indvars.iv.next56 = add nuw nsw i64 %indvars.iv55, 1
  %exitcond59.not = icmp eq i64 %indvars.iv.next56, 256
  br i1 %exitcond59.not, label %for.cond.cleanup3, label %for.cond5.preheader

for.body8:                                        ; preds = %for.body8, %for.cond5.preheader
  %indvars.iv = phi i64 [ 0, %for.cond5.preheader ], [ %indvars.iv.next.1, %for.body8 ]
  %arrayidx10 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), i64 %indvars.iv, i64 %indvars.iv55
  %13 = load double, ptr %arrayidx10, align 8, !tbaa !5
  %sub13 = fsub double %13, %.pre
  %arrayidx21 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), i64 %indvars.iv, i64 %indvars.iv55
  %14 = load double, ptr %arrayidx21, align 8, !tbaa !5
  %add = fadd double %sub13, %14
  store double %add, ptr %arrayidx10, align 8, !tbaa !5
  %indvars.iv.next = or i64 %indvars.iv, 1
  %arrayidx10.1 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), i64 %indvars.iv.next, i64 %indvars.iv55
  %15 = load double, ptr %arrayidx10.1, align 8, !tbaa !5
  %sub13.1 = fsub double %15, %.pre
  %arrayidx21.1 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), i64 %indvars.iv.next, i64 %indvars.iv55
  %16 = load double, ptr %arrayidx21.1, align 8, !tbaa !5
  %add.1 = fadd double %sub13.1, %16
...
entry:
  %call = tail call i32 @init(ptr noundef nonnull @.str.51)
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
...
for.body.i:                                       ; preds = %for.body.i, %for.cond.cleanup
  %indvars.iv.i = phi i64 [ 0, %for.cond.cleanup ], [ %indvars.iv.next.i.1, %for.body.i ]
  %sume.0196.i = phi double [ 0.000000e+00, %for.cond.cleanup ], [ %add12.i.1, %for.body.i ]
  ...
  %1 = load double, ptr %arrayidx2.i, align 16, !tbaa !5
  %add3.i = fadd double %sumb.0193.i, %1
  %arrayidx11.i = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 11, i64 %indvars.iv.i
  %2 = load double, ptr %arrayidx11.i, align 16, !tbaa !5
  %add12.i = fadd double %sume.0196.i, %2
  %indvars.iv.next.i = or i64 %indvars.iv.i, 1
  %arrayidx2.i.1 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %indvars.iv.next.i
  %3 = load double, ptr %arrayidx2.i.1, align 8, !tbaa !5
  %add3.i.1 = fadd double %add3.i, %3
  %arrayidx11.i.1 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 11, i64 %indvars.iv.next.i
  %4 = load double, ptr %arrayidx11.i.1, align 8, !tbaa !5
  %add12.i.1 = fadd double %add12.i, %4
  %indvars.iv.next.i.1 = add nuw nsw i64 %indvars.iv.i, 2
  %exitcond.not.i.1 = icmp eq i64 %indvars.iv.next.i.1, 32000
  br i1 %exitcond.not.i.1, label %for.cond18.preheader.i.preheader, label %for.body.i
...
for.cond18.preheader.i.preheader:                 ; preds = %for.body.i
  %5 = load i32, ptr @digits, align 4, !tbaa !17
  %add94.i = fadd double %add3.i.1, %add12.i.1
  %call95.i = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %5, double noundef %add94.i)
  ret i32 0
...
for.body4:                                        ; preds = %for.cond1.preheader, %for.body4
  %indvars.iv = phi i64 [ 0, %for.cond1.preheader ], [ %indvars.iv.next, %for.body4 ]
  %s.039 = phi double [ 0.000000e+00, %for.cond1.preheader ], [ %s.1, %for.body4 ]
  %arrayidx = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv
  %7 = load double, ptr %arrayidx, align 8, !tbaa !5
  %cmp5 = fcmp ogt double %7, 0.000000e+00
  %arrayidx7 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 %indvars.iv
  %8 = load double, ptr %arrayidx7, align 8, !tbaa !5
  %mul = fmul double %8, %8
  %s.1 = select i1 %cmp5, double %mul, double %s.039
  %arrayidx11 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 %indvars.iv
  %9 = load double, ptr %arrayidx11, align 8, !tbaa !5
  %10 = tail call double @llvm.fmuladd.f64(double %s.1, double %9, double %8)
  %arrayidx16 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %indvars.iv
  store double %10, ptr %arrayidx16, align 8, !tbaa !5
  %add = fadd double %s.1, 1.000000e+00
  %arrayidx18 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), i64 0, i64 %indvars.iv
  %11 = load double, ptr %arrayidx18, align 8, !tbaa !5
  %mul19 = fmul double %add, %11
  %arrayidx21 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 11, i64 %indvars.iv
  store double %mul19, ptr %arrayidx21, align 8, !tbaa !5
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, 32000
  br i1 %exitcond.not, label %for.cond.cleanup3, label %for.body4
}
...
entry:
  %call = tail call i32 @init(ptr noundef nonnull @.str.52)
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
  %cmp35 = icmp sgt i32 %0, 0
  br i1 %cmp35, label %for.cond1.preheader, label %for.cond.cleanup
...
for.cond1.preheader:                              ; preds = %entry, %for.cond.cleanup3
  %nl.036 = phi i32 [ %inc20, %for.cond.cleanup3 ], [ 0, %entry ]
  %.pre = load double, ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 0), align 32, !tbaa !5
  br label %for.body4

for.cond.cleanup:                                 ; preds = %for.cond.cleanup3, %entry
  %call23 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.148, double noundef 0.000000e+00)
  br label %for.body.i
...
for.body4:                                        ; preds = %for.cond1.preheader, %for.body4
  ...
  store double %add9, ptr %arrayidx, align 8, !tbaa !5
  %arrayidx13 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 %indvars.iv
  %10 = load double, ptr %arrayidx13, align 8, !tbaa !5
  %arrayidx15 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 %indvars.iv
  %11 = load double, ptr %arrayidx15, align 8, !tbaa !5
  %mul = fmul double %10, %11
  store double %mul, ptr %arrayidx13, align 8, !tbaa !5
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, 32000
  br i1 %exitcond.not, label %for.cond.cleanup3, label %for.body4
}
...
vector.body125:                                   ; preds = %vector.body, %vector.body125
  ...
  br i1 %10, label %vector.body133, label %vector.body125, !llvm.loop !373
...
vector.body133:                                   ; preds = %vector.body125, %vector.body133
  ...
  br i1 %21, label %vector.body141, label %vector.body133, !llvm.loop !374
...
vector.body141:                                   ; preds = %vector.body133, %vector.body141
  ...
  br i1 %32, label %vector.body149, label %vector.body141, !llvm.loop !375
...
vector.body149:                                   ; preds = %vector.body141, %vector.body149
  ...
  br i1 %43, label %for.cond2.preheader.i, label %vector.body149, !llvm.loop !376
...
vector.body157:                                   ; preds = %vector.body157, %for.cond2.preheader.i
  ...
  br i1 %53, label %for.cond.cleanup4.i, label %vector.body157, !llvm.loop !377
...
vector.body167:                                   ; preds = %vector.body167, %for.cond2.preheader.i83
  ...
  br i1 %63, label %for.cond.cleanup4.i85, label %vector.body167, !llvm.loop !378
...
vector.body179:                                   ; preds = %vector.body179, %for.cond2.preheader.i96
  ...
  br i1 %73, label %for.cond.cleanup4.i98, label %vector.body179, !llvm.loop !379
...
vector.body191:                                   ; preds = %for.cond.cleanup4.i98, %vector.body191
  ...
  br i1 %84, label %for.cond.cleanup29, label %vector.body191, !llvm.loop !380
...
vector.body:                                      ; preds = %for.body, %vector.body
  ...
  br i1 %104, label %vector.body125, label %vector.body, !llvm.loop !381
...
if.end.thread:                                    ; preds = %entry
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
  %call225 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.150, i32 noundef %0)
  br label %if.end7

if.end:                                           ; preds = %entry
  %arrayidx = getelementptr inbounds ptr, ptr %argv, i64 1
  %1 = load ptr, ptr %arrayidx, align 8, !tbaa !382
  ...
  %call2 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.150, i32 noundef %conv.i)
  %cmp3.not = icmp eq i32 %argc, 2
  br i1 %cmp3.not, label %if.end7, label %if.then4

if.then4:                                         ; preds = %if.end
  %arrayidx5 = getelementptr inbounds ptr, ptr %argv, i64 2
  %2 = load ptr, ptr %arrayidx5, align 8, !tbaa !382
  %call.i23 = call i64 @strtol(ptr nocapture noundef nonnull %2, ptr noundef null, i32 noundef 10) #16
  %conv.i24 = trunc i64 %call.i23 to i32
  store i32 %conv.i24, ptr @digits, align 4, !tbaa !17
  br label %if.end7

if.end7:                                          ; preds = %if.end.thread, %if.then4, %if.end
  %3 = load ptr, ptr %ip, align 8, !tbaa !382
