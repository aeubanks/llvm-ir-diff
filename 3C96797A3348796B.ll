...
if.then.i.i29:                                    ; preds = %string_StringFree.exit
  ...
  %sub6.i.i.i.i17 = sub i32 %17, %rem2.i.i.i.i15
  %add7.i.i.i.i18 = select i1 %tobool3.not.i.i.i.i16, i32 0, i32 %sub6.i.i.i.i17
  %RealSize.1.i.i.i.i19 = add i32 %add7.i.i.i.i18, %conv.i13
  ...
  %next6.i.i25 = getelementptr inbounds i8, ptr %add.ptr.i.i22, i64 -8
...
if.end13.i.i36:                                   ; preds = %if.then9.i.i30, %if.then.i.i29
  ...
  %add.i.i31 = add i32 %RealSize.1.i.i.i.i19, %23
