...
entry:
  ...
  %cmp593 = icmp sgt i32 %2, 0
  br i1 %cmp593, label %for.body.lr.ph, label %for.end338
...
for.body.lr.ph:                                   ; preds = %entry
  ...
  %broadcast.splatinsert628 = insertelement <2 x double> poison, double %alpha, i64 0
  %broadcast.splat629 = shufflevector <2 x double> %broadcast.splatinsert628, <2 x double> poison, <2 x i32> zeroinitializer
  br label %for.body

for.body:                                         ; preds = %for.body.lr.ph, %for.end335
  %indvars.iv605 = phi i64 [ 0, %for.body.lr.ph ], [ %indvars.iv.next606, %for.end335 ]
  %3 = load ptr, ptr %1, align 8, !tbaa !15
  %arrayidx5 = getelementptr inbounds %struct.hypre_Box_struct, ptr %3, i64 %indvars.iv605
  ...
  %arrayidx14 = getelementptr inbounds i32, ptr %9, i64 %indvars.iv605
  ...
  %arrayidx18 = getelementptr inbounds i32, ptr %12, i64 %indvars.iv605
  ...
  %cmp242513 = icmp sgt i32 %hypre__max.1, 0
  br i1 %cmp242513, label %for.cond299.preheader.lr.ph, label %for.end335

for.cond299.preheader.lr.ph:                      ; preds = %for.body
  %arrayidx12 = getelementptr inbounds %struct.hypre_Box_struct, ptr %7, i64 %indvars.iv605
  ...
  %arrayidx77 = getelementptr inbounds %struct.hypre_Box_struct, ptr %7, i64 %indvars.iv605, i32 1, i64 1
  ...
  %imax76 = getelementptr inbounds %struct.hypre_Box_struct, ptr %7, i64 %indvars.iv605, i32 1
  ...
  %arrayidx8 = getelementptr inbounds %struct.hypre_Box_struct, ptr %5, i64 %indvars.iv605
  ...
  %arrayidx33 = getelementptr inbounds %struct.hypre_Box_struct, ptr %5, i64 %indvars.iv605, i32 1, i64 1
  ...
  %imax = getelementptr inbounds %struct.hypre_Box_struct, ptr %5, i64 %indvars.iv605, i32 1
  ...
  %cmp300497 = icmp slt i32 %16, 1
  %cmp306485 = icmp slt i32 %14, 1
  %sub316 = sub i32 %cond61, %14
  %sub319 = sub i32 %cond111, %14
  %mul324608 = sub i32 %spec.select, %15
  %sub325 = mul i32 %cond61, %mul324608
  %mul327609 = sub i32 %cond92, %15
  %sub328 = mul i32 %cond111, %mul327609
  %cmp303490 = icmp slt i32 %15, 1
  %or.cond.not610 = select i1 %cmp300497, i1 true, i1 %cmp303490
  %brmerge = select i1 %or.cond.not610, i1 true, i1 %cmp306485
...
for.cond302.preheader.us.us.us.us.us.preheader:   ; preds = %for.cond299.preheader.lr.ph
  ...
  %scevgep612 = getelementptr i8, ptr %11, i64 8
  %31 = add i32 %14, -1
  %32 = zext i32 %31 to i64
  %33 = shl nuw nsw i64 %32, 3
  %34 = add nsw i64 %30, %33
  %scevgep613 = getelementptr i8, ptr %scevgep612, i64 %34
  %35 = shl nsw i64 %idx.ext, 3
  %scevgep615 = getelementptr i8, ptr %8, i64 %35
  %scevgep617 = getelementptr i8, ptr %8, i64 8
  %36 = add nsw i64 %35, %33
  %scevgep618 = getelementptr i8, ptr %scevgep617, i64 %36
  %37 = zext i32 %14 to i64
  %min.iters.check = icmp ult i32 %14, 6
  %n.vec = and i64 %37, 4294967292
  %ind.end622 = trunc i64 %n.vec to i32
...
for.cond302.preheader.us.us.us.us.us:             ; preds = %for.cond302.preheader.us.us.us.us.us.preheader, %for.cond302.for.end323_crit_edge.split.us.us.us.us.us.us
  %xi.0500.us.us.us.us.us = phi i32 [ %add326.us.us.us.us.us, %for.cond302.for.end323_crit_edge.split.us.us.us.us.us.us ], [ %add63, %for.cond302.preheader.us.us.us.us.us.preheader ]
  %yi.0499.us.us.us.us.us = phi i32 [ %add329.us.us.us.us.us, %for.cond302.for.end323_crit_edge.split.us.us.us.us.us.us ], [ %add113, %for.cond302.preheader.us.us.us.us.us.preheader ]
  %loopk.1498.us.us.us.us.us = phi i32 [ %inc331.us.us.us.us.us, %for.cond302.for.end323_crit_edge.split.us.us.us.us.us.us ], [ 0, %for.cond302.preheader.us.us.us.us.us.preheader ]
...
for.cond305.preheader.us.us.us.us.us.us:          ; preds = %for.cond305.for.end_crit_edge.us.us.us.us.us.us, %for.cond302.preheader.us.us.us.us.us
  %xi.1493.us.us.us.us.us.us = phi i32 [ %xi.0500.us.us.us.us.us, %for.cond302.preheader.us.us.us.us.us ], [ %add317.us.us.us.us.us.us, %for.cond305.for.end_crit_edge.us.us.us.us.us.us ]
  %yi.1492.us.us.us.us.us.us = phi i32 [ %yi.0499.us.us.us.us.us, %for.cond302.preheader.us.us.us.us.us ], [ %add320.us.us.us.us.us.us, %for.cond305.for.end_crit_edge.us.us.us.us.us.us ]
  %loopj.1491.us.us.us.us.us.us = phi i32 [ 0, %for.cond302.preheader.us.us.us.us.us ], [ %inc322.us.us.us.us.us.us, %for.cond305.for.end_crit_edge.us.us.us.us.us.us ]
  %38 = sext i32 %xi.1493.us.us.us.us.us.us to i64
  %39 = sext i32 %yi.1492.us.us.us.us.us.us to i64
...
vector.memcheck:                                  ; preds = %for.cond305.preheader.us.us.us.us.us.us
  %40 = shl nsw i64 %39, 3
  %scevgep611 = getelementptr i8, ptr %scevgep, i64 %40
  %scevgep614 = getelementptr i8, ptr %scevgep613, i64 %40
  %41 = shl nsw i64 %38, 3
  %scevgep616 = getelementptr i8, ptr %scevgep615, i64 %41
  %scevgep619 = getelementptr i8, ptr %scevgep618, i64 %41
  %bound0 = icmp ult ptr %scevgep611, %scevgep619
  %bound1 = icmp ult ptr %scevgep616, %scevgep614
...
vector.ph:                                        ; preds = %vector.memcheck
  ...
  %ind.end620 = add nsw i64 %n.vec, %38
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ]
  %offset.idx = add i64 %index, %38
  %offset.idx624 = add i64 %index, %39
  ...
  %wide.load625 = load <2 x double>, ptr %43, align 8, !tbaa !20, !alias.scope !22
  %44 = getelementptr inbounds double, ptr %add.ptr20, i64 %offset.idx624
  %wide.load626 = load <2 x double>, ptr %44, align 8, !tbaa !20, !alias.scope !25, !noalias !22
  %45 = getelementptr inbounds double, ptr %44, i64 2
  %wide.load627 = load <2 x double>, ptr %45, align 8, !tbaa !20, !alias.scope !25, !noalias !22
  %46 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %broadcast.splat, <2 x double> %wide.load, <2 x double> %wide.load626)
  %47 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %broadcast.splat629, <2 x double> %wide.load625, <2 x double> %wide.load627)
...
for.body307.us.us.us.us.us.us.preheader:          ; preds = %vector.memcheck, %for.cond305.preheader.us.us.us.us.us.us, %middle.block
  %indvars.iv598.ph = phi i64 [ %39, %vector.memcheck ], [ %39, %for.cond305.preheader.us.us.us.us.us.us ], [ %ind.end, %middle.block ]
  %indvars.iv.ph = phi i64 [ %38, %vector.memcheck ], [ %38, %for.cond305.preheader.us.us.us.us.us.us ], [ %ind.end620, %middle.block ]
  %loopi.1486.us.us.us.us.us.us.ph = phi i32 [ 0, %vector.memcheck ], [ 0, %for.cond305.preheader.us.us.us.us.us.us ], [ %ind.end622, %middle.block ]
  %49 = sub i32 %14, %loopi.1486.us.us.us.us.us.us.ph
  %.neg = add i32 %loopi.1486.us.us.us.us.us.us.ph, 1
...
for.body307.us.us.us.us.us.us.prol:               ; preds = %for.body307.us.us.us.us.us.us.preheader
  ...
  %arrayidx312.us.us.us.us.us.us.prol = getelementptr inbounds double, ptr %add.ptr20, i64 %indvars.iv598.ph
  ...
  %indvars.iv.next599.prol = add nsw i64 %indvars.iv598.ph, 1
  %inc.us.us.us.us.us.us.prol = add nuw nsw i32 %loopi.1486.us.us.us.us.us.us.ph, 1
...
for.body307.us.us.us.us.us.us.prol.loopexit:      ; preds = %for.body307.us.us.us.us.us.us.prol, %for.body307.us.us.us.us.us.us.preheader
  %indvars.iv.next.lcssa631.unr = phi i64 [ undef, %for.body307.us.us.us.us.us.us.preheader ], [ %indvars.iv.next.prol, %for.body307.us.us.us.us.us.us.prol ]
  %indvars.iv.next599.lcssa630.unr = phi i64 [ undef, %for.body307.us.us.us.us.us.us.preheader ], [ %indvars.iv.next599.prol, %for.body307.us.us.us.us.us.us.prol ]
  %indvars.iv598.unr = phi i64 [ %indvars.iv598.ph, %for.body307.us.us.us.us.us.us.preheader ], [ %indvars.iv.next599.prol, %for.body307.us.us.us.us.us.us.prol ]
  ...
  %loopi.1486.us.us.us.us.us.us.unr = phi i32 [ %loopi.1486.us.us.us.us.us.us.ph, %for.body307.us.us.us.us.us.us.preheader ], [ %inc.us.us.us.us.us.us.prol, %for.body307.us.us.us.us.us.us.prol ]
...
for.body307.us.us.us.us.us.us:                    ; preds = %for.body307.us.us.us.us.us.us.prol.loopexit, %for.body307.us.us.us.us.us.us
  %indvars.iv598 = phi i64 [ %indvars.iv.next599.1, %for.body307.us.us.us.us.us.us ], [ %indvars.iv598.unr, %for.body307.us.us.us.us.us.us.prol.loopexit ]
  ...
  %loopi.1486.us.us.us.us.us.us = phi i32 [ %inc.us.us.us.us.us.us.1, %for.body307.us.us.us.us.us.us ], [ %loopi.1486.us.us.us.us.us.us.unr, %for.body307.us.us.us.us.us.us.prol.loopexit ]
  ...
  %arrayidx312.us.us.us.us.us.us = getelementptr inbounds double, ptr %add.ptr20, i64 %indvars.iv598
  ...
  %arrayidx312.us.us.us.us.us.us.1 = getelementptr inbounds double, ptr %add.ptr20, i64 %indvars.iv.next599
  ...
  %indvars.iv.next599.1 = add nsw i64 %indvars.iv598, 2
  %inc.us.us.us.us.us.us.1 = add nuw nsw i32 %loopi.1486.us.us.us.us.us.us, 2
...
for.cond305.for.end_crit_edge.us.us.us.us.us.us:  ; preds = %for.body307.us.us.us.us.us.us.prol.loopexit, %for.body307.us.us.us.us.us.us, %middle.block
  %indvars.iv.next.lcssa = phi i64 [ %ind.end620, %middle.block ], [ %indvars.iv.next.lcssa631.unr, %for.body307.us.us.us.us.us.us.prol.loopexit ], [ %indvars.iv.next.1, %for.body307.us.us.us.us.us.us ]
  %indvars.iv.next599.lcssa = phi i64 [ %ind.end, %middle.block ], [ %indvars.iv.next599.lcssa630.unr, %for.body307.us.us.us.us.us.us.prol.loopexit ], [ %indvars.iv.next599.1, %for.body307.us.us.us.us.us.us ]
  %60 = trunc i64 %indvars.iv.next599.lcssa to i32
  ...
  %inc322.us.us.us.us.us.us = add nuw nsw i32 %loopj.1491.us.us.us.us.us.us, 1
  %exitcond603.not = icmp eq i32 %inc322.us.us.us.us.us.us, %15
  br i1 %exitcond603.not, label %for.cond302.for.end323_crit_edge.split.us.us.us.us.us.us, label %for.cond305.preheader.us.us.us.us.us.us, !llvm.loop !32
...
for.cond302.for.end323_crit_edge.split.us.us.us.us.us.us: ; preds = %for.cond305.for.end_crit_edge.us.us.us.us.us.us
  ...
  %inc331.us.us.us.us.us = add nuw nsw i32 %loopk.1498.us.us.us.us.us, 1
  %exitcond604.not = icmp eq i32 %inc331.us.us.us.us.us, %16
  br i1 %exitcond604.not, label %for.end335, label %for.cond302.preheader.us.us.us.us.us, !llvm.loop !33
...
for.end335:                                       ; preds = %for.cond302.for.end323_crit_edge.split.us.us.us.us.us.us, %for.cond299.preheader.lr.ph, %for.body
  ...
  %cmp = icmp slt i64 %indvars.iv.next606, %63
