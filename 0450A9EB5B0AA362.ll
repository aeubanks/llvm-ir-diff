...
return:                                           ; preds = %entry, %entry, %entry, %entry, %entry, %if.end
  %retval.0 = phi i32 [ 0, %if.end ], [ 1, %entry ], [ 1, %entry ], [ 1, %entry ], [ 1, %entry ], [ 1, %entry ]
  ret i32 %retval.0
}
...
entry:
  ...
  %i.0.i.0.i.0.i.0.16 = load volatile i32, ptr %i, align 4, !tbaa !5
  %cmp17 = icmp slt i32 %i.0.i.0.i.0.i.0.16, -200
  br i1 %cmp17, label %for.body, label %for.end

for.body:                                         ; preds = %entry, %for.inc
  %i.0.i.0.i.0.i.0.9 = load volatile i32, ptr %i, align 4, !tbaa !5
  %call = tail call i32 @foo(i32 noundef %i.0.i.0.i.0.i.0.9), !range !9
  %i.0.i.0.i.0.i.0.10 = load volatile i32, ptr %i, align 4, !tbaa !5
  %cmp1 = icmp eq i32 %i.0.i.0.i.0.i.0.10, -216
  br i1 %cmp1, label %lor.end, label %lor.lhs.false

lor.lhs.false:                                    ; preds = %for.body
  %i.0.i.0.i.0.i.0.11 = load volatile i32, ptr %i, align 4, !tbaa !5
  %cmp2 = icmp eq i32 %i.0.i.0.i.0.i.0.11, -211
  br i1 %cmp2, label %lor.end, label %lor.lhs.false3

lor.lhs.false3:                                   ; preds = %lor.lhs.false
  %i.0.i.0.i.0.i.0.12 = load volatile i32, ptr %i, align 4, !tbaa !5
  %cmp4 = icmp eq i32 %i.0.i.0.i.0.i.0.12, -218
  br i1 %cmp4, label %lor.end, label %lor.lhs.false5

lor.lhs.false5:                                   ; preds = %lor.lhs.false3
  %i.0.i.0.i.0.i.0.13 = load volatile i32, ptr %i, align 4, !tbaa !5
  %cmp6 = icmp eq i32 %i.0.i.0.i.0.i.0.13, -205
  br i1 %cmp6, label %lor.end, label %lor.rhs

lor.rhs:                                          ; preds = %lor.lhs.false5
  %i.0.i.0.i.0.i.0.14 = load volatile i32, ptr %i, align 4, !tbaa !5
  %cmp7 = icmp eq i32 %i.0.i.0.i.0.i.0.14, -223
  br label %lor.end

lor.end:                                          ; preds = %lor.rhs, %lor.lhs.false5, %lor.lhs.false3, %lor.lhs.false, %for.body
  %0 = phi i1 [ true, %lor.lhs.false5 ], [ true, %lor.lhs.false3 ], [ true, %lor.lhs.false ], [ true, %for.body ], [ %cmp7, %lor.rhs ]
  %lor.ext = zext i1 %0 to i32
  %cmp8.not = icmp eq i32 %call, %lor.ext
...
for.inc:                                          ; preds = %lor.end
  %i.0.i.0.i.0.i.0.15 = load volatile i32, ptr %i, align 4, !tbaa !5
  %inc = add nsw i32 %i.0.i.0.i.0.i.0.15, 1
  store volatile i32 %inc, ptr %i, align 4, !tbaa !5
  %i.0.i.0.i.0.i.0. = load volatile i32, ptr %i, align 4, !tbaa !5
  %cmp = icmp slt i32 %i.0.i.0.i.0.i.0., -200
