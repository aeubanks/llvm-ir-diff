; ModuleID = '/usr/local/google/home/aeubanks/repos/test-suite/MultiSource/Benchmarks/mediabench/jpeg/jpeg-6a/jdphuff.c'
source_filename = "/usr/local/google/home/aeubanks/repos/test-suite/MultiSource/Benchmarks/mediabench/jpeg/jpeg-6a/jdphuff.c"
...
for.cond.preheader.i:                             ; preds = %if.then3
  ...
  br i1 %cmp20.i, label %for.body.i, label %if.end7.sink.split
...
for.body.i:                                       ; preds = %for.cond.preheader.i, %for.body.i
  ...
  br i1 %cmp.i, label %for.body.i, label %if.end7.sink.split, !llvm.loop !57

if.end7.sink.split:                               ; preds = %for.body.i, %for.cond.preheader.i
...
if.end7:                                          ; preds = %if.end7.sink.split, %if.then, %entry
  ...
  %cmp17186 = icmp sgt i32 %18, 0
  br i1 %cmp17186, label %for.body.lr.ph, label %for.end
...
for.body:                                         ; preds = %for.body.lr.ph, %if.end78
  ...
  %bits_left.0188 = phi i32 [ %17, %for.body.lr.ph ], [ %bits_left.6, %if.end78 ]
  %get_buffer.0187 = phi i64 [ %16, %for.body.lr.ph ], [ %get_buffer.6, %if.end78 ]
  ...
  %cmp24 = icmp slt i32 %bits_left.0188, 8
  br i1 %cmp24, label %if.then25, label %if.end35

if.then25:                                        ; preds = %for.body
  %call26 = call i32 @jpeg_fill_bit_buffer(ptr noundef nonnull %br_state, i64 noundef %get_buffer.0187, i32 noundef %bits_left.0188, i32 noundef 0) #6
...
if.end35:                                         ; preds = %if.end29, %for.body
  %get_buffer.1 = phi i64 [ %24, %if.end29 ], [ %get_buffer.0187, %for.body ]
  %bits_left.1 = phi i32 [ %25, %if.end29 ], [ %bits_left.0188, %for.body ]
...
for.end.loopexit:                                 ; preds = %if.end78
  ...
  %.pre192 = load ptr, ptr %src, align 8, !tbaa !62
  %.pre193 = load i64, ptr %bytes_in_buffer11, align 8, !tbaa !67
  %.pre194 = load i32, ptr %unread_marker12, align 8, !tbaa !69
  br label %for.end

for.end:                                          ; preds = %for.end.loopexit, %if.end7
  %37 = phi i32 [ %15, %if.end7 ], [ %.pre194, %for.end.loopexit ]
  %38 = phi i64 [ %14, %if.end7 ], [ %.pre193, %for.end.loopexit ]
  %39 = phi ptr [ %12, %if.end7 ], [ %.pre192, %for.end.loopexit ]
...
for.cond.preheader.i:                             ; preds = %if.then4
  ...
  br i1 %cmp20.i, label %for.body.i, label %if.end8.sink.split
...
for.body.i:                                       ; preds = %for.cond.preheader.i, %for.body.i
  ...
  br i1 %cmp.i, label %for.body.i, label %if.end8.sink.split, !llvm.loop !57

if.end8.sink.split:                               ; preds = %for.body.i, %for.cond.preheader.i
  %saved5.i = getelementptr inbounds %struct.phuff_entropy_decoder, ptr %0, i64 0, i32 2
  store i32 0, ptr %saved5.i, align 8, !tbaa !58
...
if.end8:                                          ; preds = %if.end8.sink.split, %if.then, %entry
  %saved = getelementptr inbounds %struct.phuff_entropy_decoder, ptr %0, i64 0, i32 2
...
if.else:                                          ; preds = %if.end8
  ...
  %cmp21.not236 = icmp sgt i32 %22, %1
  br i1 %cmp21.not236, label %for.end, label %for.body.lr.ph
...
for.body:                                         ; preds = %for.body.lr.ph, %for.inc
  %bits_left.0239 = phi i32 [ %19, %for.body.lr.ph ], [ %bits_left.8, %for.inc ]
  %get_buffer.0238 = phi i64 [ %18, %for.body.lr.ph ], [ %get_buffer.8, %for.inc ]
  %k.0237 = phi i32 [ %22, %for.body.lr.ph ], [ %inc, %for.inc ]
  %cmp22 = icmp slt i32 %bits_left.0239, 8
  br i1 %cmp22, label %if.then23, label %if.end33

if.then23:                                        ; preds = %for.body
  %call24 = call i32 @jpeg_fill_bit_buffer(ptr noundef nonnull %br_state, i64 noundef %get_buffer.0238, i32 noundef %bits_left.0239, i32 noundef 0) #6
...
if.end33:                                         ; preds = %if.end27, %for.body
  %get_buffer.1 = phi i64 [ %23, %if.end27 ], [ %get_buffer.0238, %for.body ]
  %bits_left.1 = phi i32 [ %24, %if.end27 ], [ %bits_left.0239, %for.body ]
  %sub = add nsw i32 %bits_left.1, -8
  %sh_prom = zext i32 %sub to i64
  %shr = ashr i64 %get_buffer.1, %sh_prom
  %and = and i64 %shr, 255
...
for.cond.preheader.i:                             ; preds = %if.then2
  ...
  %8 = load i32, ptr %comps_in_scan.i, align 8, !tbaa !30
  %cmp20.i = icmp sgt i32 %8, 0
  br i1 %cmp20.i, label %for.body.i, label %if.end6.sink.split
...
for.body.i:                                       ; preds = %for.cond.preheader.i, %for.body.i
  ...
  %10 = sext i32 %9 to i64
  %cmp.i = icmp slt i64 %indvars.iv.next.i, %10
  br i1 %cmp.i, label %for.body.i, label %if.end6.sink.split, !llvm.loop !57
...
if.end6:                                          ; preds = %if.end6.sink.split, %if.then, %entry
  ...
  %blocks_in_MCU = getelementptr inbounds %struct.jpeg_decompress_struct, ptr %cinfo, i64 0, i32 66
  %18 = load i32, ptr %blocks_in_MCU, align 8, !tbaa !73
  %cmp1684 = icmp sgt i32 %18, 0
  br i1 %cmp1684, label %for.body.lr.ph, label %for.end
...
for.body:                                         ; preds = %for.body.lr.ph, %for.inc
  ...
  %bits_left.087 = phi i32 [ %17, %for.body.lr.ph ], [ %sub, %for.inc ]
  %get_buffer.086 = phi i64 [ %16, %for.body.lr.ph ], [ %get_buffer.1, %for.inc ]
  %arrayidx = getelementptr inbounds ptr, ptr %MCU_data, i64 %indvars.iv
  %20 = load ptr, ptr %arrayidx, align 8, !tbaa !22
  %cmp17 = icmp slt i32 %bits_left.087, 1
  br i1 %cmp17, label %if.then18, label %if.end25

if.then18:                                        ; preds = %for.body
  %call19 = call i32 @jpeg_fill_bit_buffer(ptr noundef nonnull %br_state, i64 noundef %get_buffer.086, i32 noundef %bits_left.087, i32 noundef 1) #6
...
if.end25:                                         ; preds = %if.end22, %for.body
  %get_buffer.1 = phi i64 [ %21, %if.end22 ], [ %get_buffer.086, %for.body ]
  %bits_left.1 = phi i32 [ %22, %if.end22 ], [ %bits_left.087, %for.body ]
...
for.end.loopexit:                                 ; preds = %for.inc
  %.pre = load ptr, ptr %br_state, align 8, !tbaa !65
  %.pre90 = load ptr, ptr %src, align 8, !tbaa !62
  %.pre91 = load i64, ptr %bytes_in_buffer10, align 8, !tbaa !67
  %.pre92 = load i32, ptr %unread_marker11, align 8, !tbaa !69
  br label %for.end

for.end:                                          ; preds = %for.end.loopexit, %if.end6
  %28 = phi i32 [ %15, %if.end6 ], [ %.pre92, %for.end.loopexit ]
  %29 = phi i64 [ %14, %if.end6 ], [ %.pre91, %for.end.loopexit ]
  %30 = phi ptr [ %12, %if.end6 ], [ %.pre90, %for.end.loopexit ]
...
for.cond.preheader.i:                             ; preds = %if.then5
  ...
  %9 = load i32, ptr %comps_in_scan.i, align 8, !tbaa !30
  %cmp20.i = icmp sgt i32 %9, 0
  br i1 %cmp20.i, label %for.body.i, label %if.end9.sink.split
...
for.body.i:                                       ; preds = %for.cond.preheader.i, %for.body.i
  ...
  %11 = sext i32 %10 to i64
  %cmp.i = icmp slt i64 %indvars.iv.next.i, %11
  br i1 %cmp.i, label %for.body.i, label %if.end9.sink.split, !llvm.loop !57

if.end9.sink.split:                               ; preds = %for.body.i, %for.cond.preheader.i
  %saved5.i = getelementptr inbounds %struct.phuff_entropy_decoder, ptr %0, i64 0, i32 2
  store i32 0, ptr %saved5.i, align 8, !tbaa !58
  %12 = load i32, ptr %restart_interval, align 8, !tbaa !50
  store i32 %12, ptr %restarts_to_go, align 4, !tbaa !51
...
for.body:                                         ; preds = %for.body.lr.ph, %for.inc
  %num_newnz.0417 = phi i32 [ 0, %for.body.lr.ph ], [ %num_newnz.1, %for.inc ]
...
if.then134:                                       ; preds = %if.then129
  %cmp136492 = icmp slt i16 %46, 0
  %..v = select i1 %cmp136492, i32 %shl4, i32 %shl
  %. = trunc i32 %..v to i16
  %conv141 = add i16 %46, %.
...
if.then158:                                       ; preds = %do.end
  ...
  %inc164 = add nsw i32 %num_newnz.0417, 1
  %idxprom165 = sext i32 %num_newnz.0417 to i64
...
for.inc:                                          ; preds = %do.end, %if.then158
  %num_newnz.1 = phi i32 [ %inc164, %if.then158 ], [ %num_newnz.0417, %do.end ]
...
if.end169:                                        ; preds = %if.end96, %if.end9
  ...
  %num_newnz.2 = phi i32 [ %num_newnz.0417, %if.end96 ], [ 0, %if.end9 ]
...
for.cond173.preheader:                            ; preds = %if.then83, %if.end169
  %num_newnz.2469 = phi i32 [ %num_newnz.2, %if.end169 ], [ %num_newnz.0417, %if.then83 ]
  %k.3468 = phi i32 [ %k.3, %if.end169 ], [ %k.0416, %if.then83 ]
  %bits_left.12467 = phi i32 [ %bits_left.12, %if.end169 ], [ %bits_left.4.ph, %if.then83 ]
  %get_buffer.12466 = phi i64 [ %get_buffer.12, %if.end169 ], [ %get_buffer.4.ph, %if.then83 ]
  %EOBRUN.0465 = phi i32 [ %EOBRUN.0, %if.end169 ], [ %shl84, %if.then83 ]
  %cmp174.not421 = icmp sgt i32 %k.3468, %1
  br i1 %cmp174.not421, label %for.end225, label %for.body176.lr.ph
...
for.body176.lr.ph:                                ; preds = %for.cond173.preheader
  ...
  %49 = sext i32 %k.3468 to i64
  %50 = add i32 %1, 1
  br label %for.body176

for.body176:                                      ; preds = %for.body176.lr.ph, %for.inc223
  %indvars.iv446 = phi i64 [ %49, %for.body176.lr.ph ], [ %indvars.iv.next447, %for.inc223 ]
  %bits_left.13423 = phi i32 [ %bits_left.12467, %for.body176.lr.ph ], [ %bits_left.15, %for.inc223 ]
  %get_buffer.13422 = phi i64 [ %get_buffer.12466, %for.body176.lr.ph ], [ %get_buffer.15, %for.inc223 ]
  %arrayidx179 = getelementptr inbounds [0 x i32], ptr @jpeg_natural_order, i64 0, i64 %indvars.iv446
...
if.then185:                                       ; preds = %for.body176
  %cmp186 = icmp slt i32 %bits_left.13423, 1
  br i1 %cmp186, label %if.then188, label %if.end195

if.then188:                                       ; preds = %if.then185
  %call189 = call i32 @jpeg_fill_bit_buffer(ptr noundef nonnull %br_state, i64 noundef %get_buffer.13422, i32 noundef %bits_left.13423, i32 noundef 1) #6
...
if.end195:                                        ; preds = %if.end192, %if.then185
  %get_buffer.14 = phi i64 [ %53, %if.end192 ], [ %get_buffer.13422, %if.then185 ]
  %bits_left.14 = phi i32 [ %54, %if.end192 ], [ %bits_left.13423, %if.then185 ]
...
if.then207:                                       ; preds = %if.then202
  %cmp209493 = icmp slt i16 %57, 0
  %.491.v = select i1 %cmp209493, i32 %shl4, i32 %shl
  %.491 = trunc i32 %.491.v to i16
  %conv218 = add i16 %57, %.491
  store i16 %conv218, ptr %add.ptr181, align 2, !tbaa !76
  br label %for.inc223

for.inc223:                                       ; preds = %if.then207, %for.body176, %if.then202, %if.end195
  %get_buffer.15 = phi i64 [ %get_buffer.14, %if.then202 ], [ %get_buffer.14, %if.end195 ], [ %get_buffer.13422, %for.body176 ], [ %get_buffer.14, %if.then207 ]
  %bits_left.15 = phi i32 [ %sub196, %if.then202 ], [ %sub196, %if.end195 ], [ %bits_left.13423, %for.body176 ], [ %sub196, %if.then207 ]
  %indvars.iv.next447 = add nsw i64 %indvars.iv446, 1
  %lftr.wideiv = trunc i64 %indvars.iv.next447 to i32
...
for.end225:                                       ; preds = %for.inc223, %for.cond173.preheader
  %get_buffer.13.lcssa = phi i64 [ %get_buffer.12466, %for.cond173.preheader ], [ %get_buffer.15, %for.inc223 ]
  %bits_left.13.lcssa = phi i32 [ %bits_left.12467, %for.cond173.preheader ], [ %bits_left.15, %for.inc223 ]
  %dec226 = add i32 %EOBRUN.0465, -1
  br label %if.end227
...
undoit:                                           ; preds = %if.then24, %label3, %if.then63, %if.then115, %if.then188, %if.then89
  %num_newnz.3 = phi i32 [ %num_newnz.0417, %if.then89 ], [ %num_newnz.2469, %if.then188 ], [ %num_newnz.0417, %if.then115 ], [ %num_newnz.0417, %if.then63 ], [ %num_newnz.0417, %label3 ], [ %num_newnz.0417, %if.then24 ]
  %cmp244427 = icmp sgt i32 %num_newnz.3, 0
  br i1 %cmp244427, label %while.body.preheader, label %cleanup251
...
while.body.prol:                                  ; preds = %while.body.preheader, %while.body.prol
  %indvars.iv449.prol = phi i64 [ %indvars.iv.next450.prol, %while.body.prol ], [ %63, %while.body.preheader ]
  %prol.iter = phi i64 [ %prol.iter.next, %while.body.prol ], [ 0, %while.body.preheader ]
  %indvars.iv.next450.prol = add nsw i64 %indvars.iv449.prol, -1
  %idxprom247.prol = and i64 %indvars.iv.next450.prol, 4294967295
...
while.body.prol.loopexit:                         ; preds = %while.body.prol, %while.body.preheader
  %indvars.iv449.unr = phi i64 [ %63, %while.body.preheader ], [ %indvars.iv.next450.prol, %while.body.prol ]
  %65 = icmp ult i32 %num_newnz.3, 4
  br i1 %65, label %cleanup251, label %while.body

while.body:                                       ; preds = %while.body.prol.loopexit, %while.body
  %indvars.iv449 = phi i64 [ %indvars.iv.next450.3, %while.body ], [ %indvars.iv449.unr, %while.body.prol.loopexit ]
  %indvars.iv.next450 = add i64 %indvars.iv449, 4294967295
  %idxprom247 = and i64 %indvars.iv.next450, 4294967295
  ...
  %indvars.iv.next450.1 = add i64 %indvars.iv449, 4294967294
  %idxprom247.1 = and i64 %indvars.iv.next450.1, 4294967295
  ...
  %indvars.iv.next450.2 = add nsw i64 %indvars.iv449, -3
  %idxprom247.2 = and i64 %indvars.iv.next450.2, 4294967295
  ...
  %indvars.iv.next450.3 = add nsw i64 %indvars.iv449, -4
  %idxprom247.3 = and i64 %indvars.iv.next450.3, 4294967295
  ...
  %cmp244.3 = icmp ugt i64 %indvars.iv.next450.2, 1
