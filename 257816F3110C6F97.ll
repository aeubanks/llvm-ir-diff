...
if.end:                                           ; preds = %land.lhs.true, %entry
  ...
  %cmp5.not314 = icmp sgt i64 %0, 0
  %cmp6.not315 = icmp sgt i64 %1, 0
  %or.cond278316 = and i1 %cmp5.not314, %cmp6.not315
  br i1 %or.cond278316, label %if.end12.lr.ph, label %if.then7
...
if.then7:                                         ; preds = %while.cond.backedge, %if.end
  ...
  %cmp5.not.lcssa = phi i1 [ %cmp5.not314, %if.end ], [ %cmp5.not, %while.cond.backedge ]
  %cmp6.not.lcssa = phi i1 [ %cmp6.not315, %if.end ], [ %cmp6.not, %while.cond.backedge ]
  %tobool.not = icmp eq i32 %ignore_whitespace, 0
  br i1 %tobool.not, label %while.end, label %if.then8

if.then8:                                         ; preds = %if.then7
  br i1 %cmp5.not.lcssa, label %land.rhs.lr.ph.i, label %skip_whitespace.exit
...
skip_whitespace.exit:                             ; preds = %land.rhs.i, %while.body.i, %if.then8, %land.rhs.lr.ph.i, %while.body.peel.i
  ...
  br i1 %cmp6.not.lcssa, label %land.rhs.lr.ph.i159, label %while.end
...
if.end12:                                         ; preds = %if.end12.lr.ph, %while.cond.backedge
  %F2P.0318 = phi ptr [ %call1, %if.end12.lr.ph ], [ %F2P.0.be, %while.cond.backedge ]
  %F1P.0317 = phi ptr [ %call, %if.end12.lr.ph ], [ %F1P.0.be, %while.cond.backedge ]
  %18 = load i8, ptr %F1P.0317, align 1, !tbaa !9
  %19 = load i8, ptr %F2P.0318, align 1, !tbaa !9
...
if.then21:                                        ; preds = %lor.lhs.false.i, %land.lhs.true16
  %incdec.ptr = getelementptr inbounds i8, ptr %F1P.0317, i64 1
  %incdec.ptr22 = getelementptr inbounds i8, ptr %F2P.0318, i64 1
...
land.rhs.lr.ph.i181:                              ; preds = %if.end23
  %FP.promoted8.i174 = ptrtoint ptr %F1P.0317 to i64
  %call.i176 = tail call ptr @__ctype_b_loc() #19
  %20 = sub i64 %FEnd7.i175, %FP.promoted8.i174
  %scevgep.i177 = getelementptr i8, ptr %F1P.0317, i64 %20
...
while.body.peel.i184:                             ; preds = %land.rhs.lr.ph.i181
  %incdec.ptr.peel.i182 = getelementptr inbounds i8, ptr %F1P.0317, i64 1
...
land.rhs.lr.ph.i203:                              ; preds = %while.body.i191, %land.rhs.i188, %while.body.peel.i184, %land.rhs.lr.ph.i181
  %F1P.4 = phi ptr [ %F1P.0317, %land.rhs.lr.ph.i181 ], [ %scevgep.i177, %while.body.peel.i184 ], [ %scevgep.i177, %while.body.i191 ], [ %F1P.3, %land.rhs.i188 ]
  %skipped_some.0.lcssa.i192 = phi i32 [ 0, %land.rhs.lr.ph.i181 ], [ 1, %while.body.peel.i184 ], [ 1, %land.rhs.i188 ], [ 1, %while.body.i191 ]
  %FP.promoted8.i196 = ptrtoint ptr %F2P.0318 to i64
  %27 = sub i64 %FEnd7.i197, %FP.promoted8.i196
  %scevgep.i199 = getelementptr i8, ptr %F2P.0318, i64 %27
  %idxprom.peel.i200 = zext i8 %19 to i64
  %arrayidx.peel.i201 = getelementptr inbounds i16, ptr %21, i64 %idxprom.peel.i200
  %28 = load i16, ptr %arrayidx.peel.i201, align 2, !tbaa !12
  %29 = and i16 %28, 8192
  %tobool.not.peel.i202 = icmp eq i16 %29, 0
...
while.body.peel.i206:                             ; preds = %land.rhs.lr.ph.i203
  %incdec.ptr.peel.i204 = getelementptr inbounds i8, ptr %F2P.0318, i64 1
...
land.rhs.i210:                                    ; preds = %while.body.peel.i206, %while.body.i213
  ...
  %30 = load i8, ptr %F2P.3, align 1, !tbaa !9
  %idxprom.i207 = zext i8 %30 to i64
  %arrayidx.i208 = getelementptr inbounds i16, ptr %21, i64 %idxprom.i207
  %31 = load i16, ptr %arrayidx.i208, align 2, !tbaa !12
  %32 = and i16 %31, 8192
  %tobool.not.i209 = icmp eq i16 %32, 0
...
skip_whitespace.exit215:                          ; preds = %land.rhs.i210, %while.body.i213, %land.rhs.lr.ph.i203, %while.body.peel.i206
  %F2P.4 = phi ptr [ %F2P.0318, %land.rhs.lr.ph.i203 ], [ %scevgep.i199, %while.body.peel.i206 ], [ %scevgep.i199, %while.body.i213 ], [ %F2P.3, %land.rhs.i210 ]
...
land.rhs.lr.ph.i225:                              ; preds = %if.else
  %FP.promoted8.i218 = ptrtoint ptr %F1P.0317 to i64
  %call.i220 = tail call ptr @__ctype_b_loc() #19
  %33 = sub i64 %FEnd7.i175, %FP.promoted8.i218
  %scevgep.i221 = getelementptr i8, ptr %F1P.0317, i64 %33
  %34 = load ptr, ptr %call.i220, align 8, !tbaa !5
  %idxprom.peel.i222 = zext i8 %18 to i64
  %arrayidx.peel.i223 = getelementptr inbounds i16, ptr %34, i64 %idxprom.peel.i222
  %35 = load i16, ptr %arrayidx.peel.i223, align 2, !tbaa !12
  %36 = and i16 %35, 8192
  %tobool.not.peel.i224 = icmp eq i16 %36, 0
...
while.body.peel.i228:                             ; preds = %land.rhs.lr.ph.i225
  %incdec.ptr.peel.i226 = getelementptr inbounds i8, ptr %F1P.0317, i64 1
...
land.rhs.i232:                                    ; preds = %while.body.peel.i228, %while.body.i235
  ...
  %37 = load i8, ptr %F1NumStart.0, align 1, !tbaa !9
  %idxprom.i229 = zext i8 %37 to i64
  %arrayidx.i230 = getelementptr inbounds i16, ptr %34, i64 %idxprom.i229
  %38 = load i16, ptr %arrayidx.i230, align 2, !tbaa !12
  %39 = and i16 %38, 8192
  %tobool.not.i231 = icmp eq i16 %39, 0
...
land.rhs.lr.ph.i247:                              ; preds = %while.body.i235, %land.rhs.i232, %while.body.peel.i228, %land.rhs.lr.ph.i225
  %F1NumStart.1 = phi ptr [ %F1P.0317, %land.rhs.lr.ph.i225 ], [ %scevgep.i221, %while.body.peel.i228 ], [ %scevgep.i221, %while.body.i235 ], [ %F1NumStart.0, %land.rhs.i232 ]
  %FP.promoted8.i240 = ptrtoint ptr %F2P.0318 to i64
  %40 = sub i64 %FEnd7.i197, %FP.promoted8.i240
  %scevgep.i243 = getelementptr i8, ptr %F2P.0318, i64 %40
  %idxprom.peel.i244 = zext i8 %19 to i64
  %arrayidx.peel.i245 = getelementptr inbounds i16, ptr %34, i64 %idxprom.peel.i244
  %41 = load i16, ptr %arrayidx.peel.i245, align 2, !tbaa !12
  %42 = and i16 %41, 8192
  %tobool.not.peel.i246 = icmp eq i16 %42, 0
  br i1 %tobool.not.peel.i246, label %if.end36, label %while.body.peel.i250

while.body.peel.i250:                             ; preds = %land.rhs.lr.ph.i247
  %incdec.ptr.peel.i248 = getelementptr inbounds i8, ptr %F2P.0318, i64 1
...
land.rhs.i254:                                    ; preds = %while.body.peel.i250, %while.body.i257
  ...
  %43 = load i8, ptr %F2NumStart.0, align 1, !tbaa !9
  %idxprom.i251 = zext i8 %43 to i64
  %arrayidx.i252 = getelementptr inbounds i16, ptr %34, i64 %idxprom.i251
  %44 = load i16, ptr %arrayidx.i252, align 2, !tbaa !12
  %45 = and i16 %44, 8192
  %tobool.not.i253 = icmp eq i16 %45, 0
...
if.end36:                                         ; preds = %while.body.i257, %land.rhs.i254, %while.body.peel.i250, %land.rhs.lr.ph.i247, %skip_whitespace.exit215
  %F1P.5 = phi ptr [ %F1P.4, %skip_whitespace.exit215 ], [ %F1P.0317, %land.rhs.lr.ph.i247 ], [ %F1P.0317, %while.body.peel.i250 ], [ %F1P.0317, %land.rhs.i254 ], [ %F1P.0317, %while.body.i257 ]
  %F2P.5 = phi ptr [ %F2P.4, %skip_whitespace.exit215 ], [ %F2P.0318, %land.rhs.lr.ph.i247 ], [ %F2P.0318, %while.body.peel.i250 ], [ %F2P.0318, %land.rhs.i254 ], [ %F2P.0318, %while.body.i257 ]
  %F1NumStart.2 = phi ptr [ %F1P.0317, %skip_whitespace.exit215 ], [ %F1NumStart.1, %land.rhs.lr.ph.i247 ], [ %F1NumStart.1, %while.body.peel.i250 ], [ %F1NumStart.1, %land.rhs.i254 ], [ %F1NumStart.1, %while.body.i257 ]
  %F2NumStart.2 = phi ptr [ %F2P.0318, %skip_whitespace.exit215 ], [ %F2P.0318, %land.rhs.lr.ph.i247 ], [ %scevgep.i243, %while.body.peel.i250 ], [ %scevgep.i243, %while.body.i257 ], [ %F2NumStart.0, %land.rhs.i254 ]
  br i1 %tobool17.not, label %if.then38, label %if.end53

if.then38:                                        ; preds = %if.else, %if.end36
  %F2P.5288 = phi ptr [ %F2P.5, %if.end36 ], [ %F2P.0318, %if.else ]
  %F1P.5287 = phi ptr [ %F1P.5, %if.end36 ], [ %F1P.0317, %if.else ]
...
land.lhs.true44:                                  ; preds = %if.then38
  %46 = load i8, ptr %F1P.5287, align 1, !tbaa !9
  %47 = load i8, ptr %F2P.5288, align 1, !tbaa !9
  %cmp47 = icmp eq i8 %46, %47
...
if.then59:                                        ; preds = %if.end53
  %48 = load i8, ptr %F1P.5, align 1, !tbaa !9
  %49 = load i8, ptr %F2P.5, align 1, !tbaa !9
  %cmp62.not = icmp eq i8 %48, %49
...
if.end.i:                                         ; preds = %land.lhs.true.i, %if.end68
  ...
  %50 = load ptr, ptr %F1NumEnd.i, align 8, !tbaa !5
  %51 = load i8, ptr %50, align 1, !tbaa !9
  switch i8 %51, label %if.end25.i [
...
if.then12.i:                                      ; preds = %if.end.i, %if.end.i
  ...
  %sub.ptr.lhs.cast15.i = ptrtoint ptr %50 to i64
  ...
  %sub.ptr.lhs.cast22.i = ptrtoint ptr %52 to i64
...
if.end25.i:                                       ; preds = %if.then12.i, %if.end.i
  %53 = phi ptr [ %add.ptr.i, %if.then12.i ], [ %50, %if.end.i ]
  %V1.0.i = phi double [ %call20.i, %if.then12.i ], [ %call5.i, %if.end.i ]
  %54 = load ptr, ptr %F2NumEnd.i, align 8
  %55 = load i8, ptr %54, align 1, !tbaa !9
  switch i8 %55, label %if.end51.i [
...
if.then33.i:                                      ; preds = %if.end25.i, %if.end25.i
  ...
  %sub.ptr.lhs.cast38.i = ptrtoint ptr %54 to i64
  ...
  %56 = load ptr, ptr %F2NumEnd.i, align 8, !tbaa !5
  %sub.ptr.lhs.cast47.i = ptrtoint ptr %56 to i64
...
if.end51.i:                                       ; preds = %if.then33.i, %if.end25.i
  %57 = phi ptr [ %add.ptr50.i, %if.then33.i ], [ %54, %if.end25.i ]
  %V2.0.i = phi double [ %call45.i, %if.then33.i ], [ %call6.i, %if.end25.i ]
  %cmp52.i = icmp eq ptr %53, %F1NumStart.2
  %cmp55.i = icmp eq ptr %57, %F2NumStart.2
...
if.then57.i:                                      ; preds = %if.end51.i
  ...
  %60 = load i8, ptr %F1NumStart.2, align 1, !tbaa !9
  %conv59.i = sext i8 %60 to i32
  %61 = load i8, ptr %F2NumStart.2, align 1, !tbaa !9
  %conv61.i = sext i8 %61 to i32
  %call62.i = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %58, ptr noundef nonnull @.str.13, ptr noundef %59, i32 noundef %conv59.i, i32 noundef %conv61.i) #15
...
lor.lhs.false70.i:                                ; preds = %if.end67.i
  ...
  %62 = tail call double @llvm.fabs.f64(double %sub.i)
  %cmp71.i = fcmp ogt double %62, %absolute_tolerance
...
if.then74.i:                                      ; preds = %if.then73.i
  ...
  %63 = tail call double @llvm.fabs.f64(double %sub75.i)
  br label %if.end82.i
...
if.then77.i:                                      ; preds = %if.else.i
  ...
  %64 = tail call double @llvm.fabs.f64(double %sub79.i)
  br label %if.end82.i

if.end82.i:                                       ; preds = %if.then77.i, %if.else.i, %if.then74.i
  %Diff.0.i = phi double [ %63, %if.then74.i ], [ %64, %if.then77.i ], [ 0.000000e+00, %if.else.i ]
...
if.then88.i:                                      ; preds = %if.end82.i
  ...
  %66 = load ptr, ptr @g_program, align 8, !tbaa !5
  %sub89.i = fsub double %V1.0.i, %V2.0.i
  %67 = tail call double @llvm.fabs.f64(double %sub89.i)
  %call90.i = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %65, ptr noundef nonnull @.str.14, ptr noundef %66, double noundef %V1.0.i, double noundef %V2.0.i, double noundef %67, double noundef %Diff.0.i, double noundef %relative_tolerance, double noundef %absolute_tolerance) #15
  br label %cleanup74.thread292
...
if.then83:                                        ; preds = %while.end
  ...
  %69 = load ptr, ptr @g_program, align 8, !tbaa !5
  %70 = load i8, ptr %F1P.8, align 1, !tbaa !9
  %conv84 = sext i8 %70 to i32
  %71 = load i8, ptr %F2P.8, align 1, !tbaa !9
  %conv86 = sext i8 %71 to i32
  %call87 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %68, ptr noundef nonnull @.str.5, ptr noundef %69, i32 noundef %conv84, i32 noundef %conv86) #15
  br label %cleanup103
...
if.then92:                                        ; preds = %if.end88
  ...
  %73 = load ptr, ptr @g_program, align 8, !tbaa !5
  %call93 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %72, ptr noundef nonnull @.str.6, ptr noundef %73) #15
  br label %cleanup103
...
entry:
  %End124 = ptrtoint ptr %End to i64
...
land.rhs.preheader:                               ; preds = %if.end
  %Pos.0125 = ptrtoint ptr %Pos.0 to i64
  %1 = sub i64 %End124, %Pos.0125
  %scevgep = getelementptr i8, ptr %Pos.0, i64 %1
  %2 = load i8, ptr %Pos.0, align 1, !tbaa !9
  %conv.i148 = sext i8 %2 to i32
  %conv.off.i149 = add nsw i32 %conv.i148, -48
  %switch.i150 = icmp ult i32 %conv.off.i149, 10
  br i1 %switch.i150, label %while.body, label %land.lhs.true6
...
while.body:                                       ; preds = %land.rhs.preheader, %land.rhs
  %Pos.1103151 = phi ptr [ %incdec.ptr4, %land.rhs ], [ %Pos.0, %land.rhs.preheader ]
  %incdec.ptr4 = getelementptr inbounds i8, ptr %Pos.1103151, i64 1
...
land.rhs46.preheader:                             ; preds = %if.end42
  %Pos.4128 = ptrtoint ptr %Pos.4 to i64
  %10 = sub i64 %End124, %Pos.4128
  %scevgep129 = getelementptr i8, ptr %Pos.4, i64 %10
  %11 = load i8, ptr %Pos.4, align 1, !tbaa !9
  %conv.i96154 = sext i8 %11 to i32
  %conv.off.i97155 = add nsw i32 %conv.i96154, -48
  %switch.i98156 = icmp ult i32 %conv.off.i97155, 10
  br i1 %switch.i98156, label %while.cond43, label %cleanup54

while.cond43:                                     ; preds = %land.rhs46.preheader, %land.rhs46
  %Pos.5117157 = phi ptr [ %incdec.ptr51, %land.rhs46 ], [ %Pos.4, %land.rhs46.preheader ]
  %incdec.ptr51 = getelementptr inbounds i8, ptr %Pos.5117157, i64 1
  %exitcond130.not = icmp eq ptr %incdec.ptr51, %scevgep129
  br i1 %exitcond130.not, label %cleanup54, label %land.rhs46, !llvm.loop !19
...
cleanup54:                                        ; preds = %while.cond43, %land.rhs46, %land.rhs46.preheader, %land.rhs14.preheader, %if.then9, %if.end, %if.end42, %if.end27, %land.lhs.true30, %if.end24, %cleanup
  %retval.1 = phi ptr [ %Pos.2.lcssa, %cleanup ], [ null, %if.end24 ], [ %EndOfNumber.2, %land.lhs.true30 ], [ %EndOfNumber.2, %if.end27 ], [ %EndOfNumber.2, %if.end42 ], [ null, %if.end ], [ %EndOfNumber.0104.lcssa, %if.then9 ], [ %EndOfNumber.0104.lcssa, %land.rhs14.preheader ], [ %EndOfNumber.2, %land.rhs46.preheader ], [ %incdec.ptr51, %land.rhs46 ], [ %scevgep129, %while.cond43 ]
  ret ptr %retval.1
}
