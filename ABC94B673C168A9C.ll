...
define dso_local void @_ZN2kc22impl_fileline_FileLineC2EPNS_20impl_casestring__StrEi(ptr nocapture noundef nonnull writeonly align 8 dereferenceable(20) %0, ptr noundef %1, i32 noundef %2) unnamed_addr #0 align 2 personality ptr @__gxx_personality_v0 {
  store ptr getelementptr inbounds ({ [13 x ptr] }, ptr @_ZTVN2kc22impl_fileline_FileLineE, i64 0, inrange i32 0, i64 2), ptr %0, align 8, !tbaa !5
  %4 = icmp eq ptr %1, null
  br i1 %4, label %5, label %7

5:                                                ; preds = %3
  %6 = tail call noundef ptr @_ZN2kc12mkcasestringEPKci(ptr noundef nonnull @.str, i32 noundef -1)
  br label %7

7:                                                ; preds = %5, %3
  %8 = phi ptr [ %6, %5 ], [ %1, %3 ]
  %9 = getelementptr inbounds %"class.kc::impl_fileline", ptr %0, i64 0, i32 1
  store ptr %8, ptr %9, align 8, !tbaa !8
  %10 = getelementptr inbounds %"class.kc::impl_fileline", ptr %0, i64 0, i32 2
