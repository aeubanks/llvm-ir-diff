...
for.body218:                                      ; preds = %for.body218.lr.ph, %for.body218
  ...
  %arrayidx243 = getelementptr inbounds [3 x i32], ptr %arrayidx229, i64 0, i64 1
  %71 = load i32, ptr %arrayidx243, align 4, !tbaa !20
  %arrayidx248 = getelementptr inbounds [3 x i32], ptr %arrayidx234, i64 0, i64 1
  store i32 %71, ptr %arrayidx248, align 4, !tbaa !20
  %arrayidx255 = getelementptr inbounds [3 x i32], ptr %arrayidx229, i64 0, i64 2
  %72 = load i32, ptr %arrayidx255, align 4, !tbaa !20
  %arrayidx260 = getelementptr inbounds [3 x i32], ptr %arrayidx234, i64 0, i64 2
...
for.body559:                                      ; preds = %for.body559.lr.ph, %for.body559
  ...
  %arrayidx584 = getelementptr inbounds [3 x i32], ptr %arrayidx570, i64 0, i64 1
  %137 = load i32, ptr %arrayidx584, align 4, !tbaa !20
  %arrayidx589 = getelementptr inbounds [3 x i32], ptr %arrayidx575, i64 0, i64 1
  store i32 %137, ptr %arrayidx589, align 4, !tbaa !20
  %arrayidx596 = getelementptr inbounds [3 x i32], ptr %arrayidx570, i64 0, i64 2
  %138 = load i32, ptr %arrayidx596, align 4, !tbaa !20
  %arrayidx601 = getelementptr inbounds [3 x i32], ptr %arrayidx575, i64 0, i64 2
...
for.body175:                                      ; preds = %for.body175.lr.ph, %for.body175
  ...
  %arrayidx200 = getelementptr inbounds [3 x i32], ptr %arrayidx186, i64 0, i64 1
  %67 = load i32, ptr %arrayidx200, align 4, !tbaa !20
  %arrayidx205 = getelementptr inbounds [3 x i32], ptr %arrayidx191, i64 0, i64 1
  store i32 %67, ptr %arrayidx205, align 4, !tbaa !20
  %arrayidx212 = getelementptr inbounds [3 x i32], ptr %arrayidx186, i64 0, i64 2
  %68 = load i32, ptr %arrayidx212, align 4, !tbaa !20
  %arrayidx217 = getelementptr inbounds [3 x i32], ptr %arrayidx191, i64 0, i64 2
...
for.body413:                                      ; preds = %for.body413.lr.ph, %for.body413
  ...
  %arrayidx438 = getelementptr inbounds [3 x i32], ptr %arrayidx424, i64 0, i64 1
  %120 = load i32, ptr %arrayidx438, align 4, !tbaa !20
  %arrayidx443 = getelementptr inbounds [3 x i32], ptr %arrayidx429, i64 0, i64 1
  store i32 %120, ptr %arrayidx443, align 4, !tbaa !20
  %arrayidx450 = getelementptr inbounds [3 x i32], ptr %arrayidx424, i64 0, i64 2
  %121 = load i32, ptr %arrayidx450, align 4, !tbaa !20
  %arrayidx455 = getelementptr inbounds [3 x i32], ptr %arrayidx429, i64 0, i64 2
