; ModuleID = '/usr/local/google/home/aeubanks/repos/test-suite/Bitcode/simd_ops/x86_tests/test_op_packssdw_202.bc'
...
@str.11 = private constant [16 x i8] c"op_packssdw_202\00", align 32
...
define i32 @__test_op(ptr noalias nocapture readnone %in_f32.buffer, ptr noalias nocapture readnone %in_f64.buffer, ptr noalias nocapture readnone %in_i8.buffer, ptr noalias nocapture readnone %in_u8.buffer, ptr noalias nocapture readnone %in_i16.buffer, ptr noalias nocapture readnone %in_u16.buffer, ptr noalias nocapture readonly %in_i32.buffer, ptr noalias nocapture readnone %in_u32.buffer, ptr noalias nocapture readnone %in_i64.buffer, ptr noalias nocapture readnone %in_u64.buffer, ptr noalias nocapture readonly %op_packssdw_202.buffer) local_unnamed_addr #1 {
"produce op_packssdw_202":
  %buf_extent168 = getelementptr inbounds %struct.buffer_t, ptr %op_packssdw_202.buffer, i64 0, i32 2, i64 1
  %op_packssdw_202.extent.1 = load i32, ptr %buf_extent168, align 4
  %buf_min176 = getelementptr inbounds %struct.buffer_t, ptr %op_packssdw_202.buffer, i64 0, i32 4, i64 1
  %op_packssdw_202.min.1 = load i32, ptr %buf_min176, align 4
  %0 = add nsw i32 %op_packssdw_202.min.1, %op_packssdw_202.extent.1
  %1 = icmp sgt i32 %op_packssdw_202.extent.1, 0
  br i1 %1, label %"for op_packssdw_202.s0.y.preheader", label %destructor_block, !prof !4

"for op_packssdw_202.s0.y.preheader":             ; preds = %"produce op_packssdw_202"
  ...
  %buf_min175 = getelementptr inbounds %struct.buffer_t, ptr %op_packssdw_202.buffer, i64 0, i32 4, i64 0
  %op_packssdw_202.min.0 = load i32, ptr %buf_min175, align 4
  %2 = sext i32 %op_packssdw_202.min.0 to i64
  %buf_stride172 = getelementptr inbounds %struct.buffer_t, ptr %op_packssdw_202.buffer, i64 0, i32 3, i64 1
  %op_packssdw_202.stride.1 = load i32, ptr %buf_stride172, align 4
  %3 = sext i32 %op_packssdw_202.stride.1 to i64
  %buf_host163 = getelementptr inbounds %struct.buffer_t, ptr %op_packssdw_202.buffer, i64 0, i32 1
  %op_packssdw_202.host = load ptr, ptr %buf_host163, align 8
  %4 = shl nsw i64 %2, 3
  %5 = sub nsw i64 32, %4
  %scevgep = getelementptr i8, ptr %op_packssdw_202.host, i64 %5
  %6 = shl nsw i64 %3, 3
  ...
  %10 = tail call <8 x i16> @llvm.x86.sse2.packssdw.128(<4 x i32> %8, <4 x i32> %9) #4
  %11 = sitofp <8 x i16> %10 to <8 x double>
  ...
  %17 = tail call <8 x i16> @llvm.x86.sse2.packssdw.128(<4 x i32> %15, <4 x i32> %16) #4
  %18 = sitofp <8 x i16> %17 to <8 x double>
  ...
  %24 = tail call <8 x i16> @llvm.x86.sse2.packssdw.128(<4 x i32> %22, <4 x i32> %23) #4
  %25 = sitofp <8 x i16> %24 to <8 x double>
  ...
  %31 = tail call <8 x i16> @llvm.x86.sse2.packssdw.128(<4 x i32> %29, <4 x i32> %30) #4
  %32 = sitofp <8 x i16> %31 to <8 x double>
  ...
  %38 = tail call <8 x i16> @llvm.x86.sse2.packssdw.128(<4 x i32> %36, <4 x i32> %37) #4
  ...
  %45 = tail call <8 x i16> @llvm.x86.sse2.packssdw.128(<4 x i32> %43, <4 x i32> %44) #4
  %46 = sitofp <8 x i16> %45 to <8 x double>
  ...
  %52 = tail call <8 x i16> @llvm.x86.sse2.packssdw.128(<4 x i32> %50, <4 x i32> %51) #4
  %53 = sitofp <8 x i16> %52 to <8 x double>
  ...
  %59 = tail call <8 x i16> @llvm.x86.sse2.packssdw.128(<4 x i32> %57, <4 x i32> %58) #4
  %60 = sitofp <8 x i16> %59 to <8 x double>
  ...
  %66 = tail call <8 x i16> @llvm.x86.sse2.packssdw.128(<4 x i32> %64, <4 x i32> %65) #4
  %67 = sitofp <8 x i16> %66 to <8 x double>
  ...
  %73 = tail call <8 x i16> @llvm.x86.sse2.packssdw.128(<4 x i32> %71, <4 x i32> %72) #4
  ...
  %80 = tail call <8 x i16> @llvm.x86.sse2.packssdw.128(<4 x i32> %78, <4 x i32> %79) #4
  ...
  %87 = tail call <8 x i16> @llvm.x86.sse2.packssdw.128(<4 x i32> %85, <4 x i32> %86) #4
  %88 = sitofp <8 x i16> %87 to <8 x double>
  ...
  %94 = tail call <8 x i16> @llvm.x86.sse2.packssdw.128(<4 x i32> %92, <4 x i32> %93) #4
  %95 = sitofp <8 x i16> %94 to <8 x double>
  ...
  %101 = tail call <8 x i16> @llvm.x86.sse2.packssdw.128(<4 x i32> %99, <4 x i32> %100) #4
  %102 = sitofp <8 x i16> %101 to <8 x double>
  ...
  %108 = tail call <8 x i16> @llvm.x86.sse2.packssdw.128(<4 x i32> %106, <4 x i32> %107) #4
  ...
  %115 = tail call <8 x i16> @llvm.x86.sse2.packssdw.128(<4 x i32> %113, <4 x i32> %114) #4
  %116 = sitofp <8 x i16> %115 to <8 x double>
  ...
  %122 = tail call <8 x i16> @llvm.x86.sse2.packssdw.128(<4 x i32> %120, <4 x i32> %121) #4
  %123 = sitofp <8 x i16> %122 to <8 x double>
  ...
  %129 = tail call <8 x i16> @llvm.x86.sse2.packssdw.128(<4 x i32> %127, <4 x i32> %128) #4
  %130 = sitofp <8 x i16> %129 to <8 x double>
  ...
  br label %"for op_packssdw_202.s0.x.x.preheader"

"for op_packssdw_202.s0.x.x.preheader":           ; preds = %"for op_packssdw_202.s0.x.x.preheader", %"for op_packssdw_202.s0.y.preheader"
  %lsr.iv180 = phi ptr [ %scevgep, %"for op_packssdw_202.s0.y.preheader" ], [ %scevgep182, %"for op_packssdw_202.s0.x.x.preheader" ]
  %op_packssdw_202.s0.y = phi i32 [ %op_packssdw_202.min.1, %"for op_packssdw_202.s0.y.preheader" ], [ %231, %"for op_packssdw_202.s0.x.x.preheader" ]
  ...
  %136 = tail call <8 x i16> @llvm.x86.sse2.packssdw.128(<4 x i32> %134, <4 x i32> %135) #4
  %137 = sitofp <8 x i16> %136 to <8 x double>
  ...
  %143 = tail call <8 x i16> @llvm.x86.sse2.packssdw.128(<4 x i32> %141, <4 x i32> %142) #4
  ...
  %150 = tail call <8 x i16> @llvm.x86.sse2.packssdw.128(<4 x i32> %148, <4 x i32> %149) #4
  %151 = sitofp <8 x i16> %150 to <8 x double>
  ...
  %157 = tail call <8 x i16> @llvm.x86.sse2.packssdw.128(<4 x i32> %155, <4 x i32> %156) #4
  %158 = sitofp <8 x i16> %157 to <8 x double>
  ...
  %164 = tail call <8 x i16> @llvm.x86.sse2.packssdw.128(<4 x i32> %162, <4 x i32> %163) #4
  %165 = sitofp <8 x i16> %164 to <8 x double>
  ...
  %171 = tail call <8 x i16> @llvm.x86.sse2.packssdw.128(<4 x i32> %169, <4 x i32> %170) #4
  %172 = sitofp <8 x i16> %171 to <8 x double>
  ...
  %178 = tail call <8 x i16> @llvm.x86.sse2.packssdw.128(<4 x i32> %176, <4 x i32> %177) #4
  %179 = sitofp <8 x i16> %178 to <8 x double>
  ...
  %185 = tail call <8 x i16> @llvm.x86.sse2.packssdw.128(<4 x i32> %183, <4 x i32> %184) #4
  %186 = sitofp <8 x i16> %185 to <8 x double>
  ...
  %192 = tail call <8 x i16> @llvm.x86.sse2.packssdw.128(<4 x i32> %190, <4 x i32> %191) #4
  %193 = sitofp <8 x i16> %192 to <8 x double>
  ...
  %199 = tail call <8 x i16> @llvm.x86.sse2.packssdw.128(<4 x i32> %197, <4 x i32> %198) #4
  %200 = sitofp <8 x i16> %199 to <8 x double>
  ...
  %206 = tail call <8 x i16> @llvm.x86.sse2.packssdw.128(<4 x i32> %204, <4 x i32> %205) #4
  %207 = sitofp <8 x i16> %206 to <8 x double>
  ...
  %213 = tail call <8 x i16> @llvm.x86.sse2.packssdw.128(<4 x i32> %211, <4 x i32> %212) #4
  %214 = sitofp <8 x i16> %213 to <8 x double>
  ...
  %220 = tail call <8 x i16> @llvm.x86.sse2.packssdw.128(<4 x i32> %218, <4 x i32> %219) #4
  %221 = sitofp <8 x i16> %220 to <8 x double>
  ...
  %227 = tail call <8 x i16> @llvm.x86.sse2.packssdw.128(<4 x i32> %225, <4 x i32> %226) #4
  %228 = sitofp <8 x i16> %227 to <8 x double>
  ...
  %231 = add nsw i32 %op_packssdw_202.s0.y, 1
  %scevgep182 = getelementptr i1, ptr %lsr.iv180, i64 %6
  %.not2 = icmp eq i32 %231, %0
  br i1 %.not2, label %destructor_block, label %"for op_packssdw_202.s0.x.x.preheader"

destructor_block:                                 ; preds = %"for op_packssdw_202.s0.x.x.preheader", %"produce op_packssdw_202"
  ret i32 0
}

; Function Attrs: nofree nosync nounwind memory(readwrite, inaccessiblemem: none)
define i32 @test_op(ptr noalias nocapture readnone %in_f32.buffer, ptr noalias nocapture readnone %in_f64.buffer, ptr noalias nocapture readnone %in_i8.buffer, ptr noalias nocapture readnone %in_u8.buffer, ptr noalias nocapture readnone %in_i16.buffer, ptr noalias nocapture readnone %in_u16.buffer, ptr noalias nocapture readonly %in_i32.buffer, ptr noalias nocapture readnone %in_u32.buffer, ptr noalias nocapture readnone %in_i64.buffer, ptr noalias nocapture readnone %in_u64.buffer, ptr noalias nocapture readonly %op_packssdw_202.buffer) local_unnamed_addr #2 {
destructor_block:
  %"__test_op_result$12" = tail call i32 @__test_op(ptr poison, ptr poison, ptr poison, ptr poison, ptr poison, ptr poison, ptr %in_i32.buffer, ptr poison, ptr poison, ptr poison, ptr %op_packssdw_202.buffer) #4
  ret i32 0
}
