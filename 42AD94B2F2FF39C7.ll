; ModuleID = '/usr/local/google/home/aeubanks/repos/test-suite/Bitcode/simd_ops/x86_tests/test_op_paddsb_50.bc'
...
@str.11 = private constant [13 x i8] c"op_paddsb_50\00", align 32
...
define i32 @__test_op(ptr noalias nocapture readnone %in_f32.buffer, ptr noalias nocapture readnone %in_f64.buffer, ptr noalias nocapture readonly %in_i8.buffer, ptr noalias nocapture readnone %in_u8.buffer, ptr noalias nocapture readnone %in_i16.buffer, ptr noalias nocapture readnone %in_u16.buffer, ptr noalias nocapture readnone %in_i32.buffer, ptr noalias nocapture readnone %in_u32.buffer, ptr noalias nocapture readnone %in_i64.buffer, ptr noalias nocapture readnone %in_u64.buffer, ptr noalias nocapture readonly %op_paddsb_50.buffer) local_unnamed_addr #0 {
"produce op_paddsb_50":
  %buf_extent168 = getelementptr inbounds %struct.buffer_t, ptr %op_paddsb_50.buffer, i64 0, i32 2, i64 1
  %op_paddsb_50.extent.1 = load i32, ptr %buf_extent168, align 4
  %buf_min176 = getelementptr inbounds %struct.buffer_t, ptr %op_paddsb_50.buffer, i64 0, i32 4, i64 1
  %op_paddsb_50.min.1 = load i32, ptr %buf_min176, align 4
  %0 = add nsw i32 %op_paddsb_50.min.1, %op_paddsb_50.extent.1
  %1 = icmp sgt i32 %op_paddsb_50.extent.1, 0
  br i1 %1, label %"for op_paddsb_50.s0.y.preheader", label %destructor_block, !prof !4

"for op_paddsb_50.s0.y.preheader":                ; preds = %"produce op_paddsb_50"
  %buf_host27 = getelementptr inbounds %struct.buffer_t, ptr %in_i8.buffer, i64 0, i32 1
  %in_i8.host = load ptr, ptr %buf_host27, align 8
  %buf_min175 = getelementptr inbounds %struct.buffer_t, ptr %op_paddsb_50.buffer, i64 0, i32 4, i64 0
  %op_paddsb_50.min.0 = load i32, ptr %buf_min175, align 4
  %2 = sext i32 %op_paddsb_50.min.0 to i64
  %buf_stride172 = getelementptr inbounds %struct.buffer_t, ptr %op_paddsb_50.buffer, i64 0, i32 3, i64 1
  %op_paddsb_50.stride.1 = load i32, ptr %buf_stride172, align 4
  %3 = sext i32 %op_paddsb_50.stride.1 to i64
  %buf_host163 = getelementptr inbounds %struct.buffer_t, ptr %op_paddsb_50.buffer, i64 0, i32 1
  %op_paddsb_50.host = load ptr, ptr %buf_host163, align 8
  %4 = shl nsw i64 %2, 3
  %5 = sub nsw i64 96, %4
  %scevgep = getelementptr i8, ptr %op_paddsb_50.host, i64 %5
  %6 = shl nsw i64 %3, 3
  %7 = load <16 x i8>, ptr %in_i8.host, align 16, !tbaa !5
  %8 = tail call <16 x i8> @llvm.sadd.sat.v16i8(<16 x i8> %7, <16 x i8> <i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3>)
  %9 = sitofp <16 x i8> %8 to <16 x double>
  ...
  %15 = tail call <16 x i8> @llvm.sadd.sat.v16i8(<16 x i8> %14, <16 x i8> <i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3>)
  %16 = sitofp <16 x i8> %15 to <16 x double>
  ...
  %22 = tail call <16 x i8> @llvm.sadd.sat.v16i8(<16 x i8> %21, <16 x i8> <i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3>)
  %23 = sitofp <16 x i8> %22 to <16 x double>
  ...
  %29 = tail call <16 x i8> @llvm.sadd.sat.v16i8(<16 x i8> %28, <16 x i8> <i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3>)
  %30 = sitofp <16 x i8> %29 to <16 x double>
  ...
  %36 = tail call <16 x i8> @llvm.sadd.sat.v16i8(<16 x i8> %35, <16 x i8> <i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3>)
  %37 = sitofp <16 x i8> %36 to <16 x double>
  ...
  %43 = tail call <16 x i8> @llvm.sadd.sat.v16i8(<16 x i8> %42, <16 x i8> <i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3>)
  ...
  %50 = tail call <16 x i8> @llvm.sadd.sat.v16i8(<16 x i8> %49, <16 x i8> <i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3>)
  ...
  %57 = tail call <16 x i8> @llvm.sadd.sat.v16i8(<16 x i8> %56, <16 x i8> <i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3>)
  %58 = sitofp <16 x i8> %57 to <16 x double>
  ...
  %64 = tail call <16 x i8> @llvm.sadd.sat.v16i8(<16 x i8> %63, <16 x i8> <i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3>)
  %65 = sitofp <16 x i8> %64 to <16 x double>
  ...
  br label %"for op_paddsb_50.s0.x.x.preheader"

"for op_paddsb_50.s0.x.x.preheader":              ; preds = %"for op_paddsb_50.s0.x.x.preheader", %"for op_paddsb_50.s0.y.preheader"
  %lsr.iv180 = phi ptr [ %scevgep, %"for op_paddsb_50.s0.y.preheader" ], [ %scevgep182, %"for op_paddsb_50.s0.x.x.preheader" ]
  %op_paddsb_50.s0.y = phi i32 [ %op_paddsb_50.min.1, %"for op_paddsb_50.s0.y.preheader" ], [ %119, %"for op_paddsb_50.s0.x.x.preheader" ]
  ...
  %72 = sitofp <16 x i8> %71 to <16 x double>
  ...
  %78 = tail call <16 x i8> @llvm.sadd.sat.v16i8(<16 x i8> %77, <16 x i8> <i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3>)
  %79 = sitofp <16 x i8> %78 to <16 x double>
  ...
  %85 = tail call <16 x i8> @llvm.sadd.sat.v16i8(<16 x i8> %84, <16 x i8> <i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3>)
  ...
  %92 = tail call <16 x i8> @llvm.sadd.sat.v16i8(<16 x i8> %91, <16 x i8> <i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3>)
  %93 = sitofp <16 x i8> %92 to <16 x double>
  ...
  %100 = sitofp <16 x i8> %99 to <16 x double>
  ...
  %106 = tail call <16 x i8> @llvm.sadd.sat.v16i8(<16 x i8> %105, <16 x i8> <i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3>)
  %107 = sitofp <16 x i8> %106 to <16 x double>
  ...
  %113 = tail call <16 x i8> @llvm.sadd.sat.v16i8(<16 x i8> %112, <16 x i8> <i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3, i8 3>)
  %114 = sitofp <16 x i8> %113 to <16 x double>
  ...
  %119 = add nsw i32 %op_paddsb_50.s0.y, 1
  %scevgep182 = getelementptr i1, ptr %lsr.iv180, i64 %6
  %.not2 = icmp eq i32 %119, %0
  br i1 %.not2, label %destructor_block, label %"for op_paddsb_50.s0.x.x.preheader"

destructor_block:                                 ; preds = %"for op_paddsb_50.s0.x.x.preheader", %"produce op_paddsb_50"
  ret i32 0
}

; Function Attrs: nofree nosync nounwind memory(readwrite, inaccessiblemem: none)
define i32 @test_op(ptr noalias nocapture readnone %in_f32.buffer, ptr noalias nocapture readnone %in_f64.buffer, ptr noalias nocapture readonly %in_i8.buffer, ptr noalias nocapture readnone %in_u8.buffer, ptr noalias nocapture readnone %in_i16.buffer, ptr noalias nocapture readnone %in_u16.buffer, ptr noalias nocapture readnone %in_i32.buffer, ptr noalias nocapture readnone %in_u32.buffer, ptr noalias nocapture readnone %in_i64.buffer, ptr noalias nocapture readnone %in_u64.buffer, ptr noalias nocapture readonly %op_paddsb_50.buffer) local_unnamed_addr #1 {
destructor_block:
  %"__test_op_result$3" = tail call i32 @__test_op(ptr poison, ptr poison, ptr %in_i8.buffer, ptr poison, ptr poison, ptr poison, ptr poison, ptr poison, ptr poison, ptr poison, ptr %op_paddsb_50.buffer) #4
  ret i32 0
}
