...
if.end.us:                                        ; preds = %for.body.us
  ...
  %add.us = add nsw i32 %lastScale.040.us, 256
  %add7.us = add i32 %add.us, %call.us
  %add7.us.fr = freeze i32 %add7.us
  %rem.us = srem i32 %add7.us.fr, 256
...
if.end.us.i:                                      ; preds = %for.body.us.i
  ...
  %add.us.i = add nsw i32 %lastScale.040.us.i, 256
  %add7.us.i = add i32 %add.us.i, %call.us.i
  %add7.us.fr.i = freeze i32 %add7.us.i
  %rem.us.i = srem i32 %add7.us.fr.i, 256
