...
entry:
  %0 = load ptr, ptr @pwarn, align 8, !tbaa !5
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %warn) #4
  store ptr %warn, ptr @pwarn, align 8, !tbaa !5
  store i32 1, ptr %warn, align 4, !tbaa !9
  call void @bla() #5
  unreachable
}
