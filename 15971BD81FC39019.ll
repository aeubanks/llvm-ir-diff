...
for.end72:                                        ; preds = %for.inc67, %if.else31
  ...
  %.lcssa = phi i32 [ %21, %if.else31 ], [ %26, %for.inc67 ]
...
if.then80:                                        ; preds = %for.end72
  %27 = load i32, ptr %sf_size32, align 4, !tbaa !18
  %call.i = tail call ptr (i32, i32, ...) @sf_new(i32 noundef %.lcssa, i32 noundef %27) #9
  %28 = load ptr, ptr %data44, align 8, !tbaa !14
  %29 = load i32, ptr %count, align 4, !tbaa !12
  %30 = load i32, ptr %A, align 8, !tbaa !19
...
for.body.i:                                       ; preds = %for.inc.i, %for.body.lr.ph.i
  %p.033.i = phi ptr [ %28, %for.body.lr.ph.i ], [ %add.ptr14.i, %for.inc.i ]
  %pdest.032.i = phi ptr [ %31, %for.body.lr.ph.i ], [ %pdest.1.i, %for.inc.i ]
...
if.then.i:                                        ; preds = %for.body.i
  %32 = load i32, ptr %p.033.i, align 4, !tbaa !20
  %33 = and i32 %32, 1023
  %34 = zext i32 %33 to i64
  %35 = add nuw nsw i64 %34, 1
  %min.iters.check = icmp ult i32 %33, 15
...
vector.memcheck:                                  ; preds = %if.then.i
  ...
  %37 = add i64 %36, %p.033.i302
  %38 = add i64 %36, %pdest.032.i303
  %39 = sub i64 %37, %38
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %40 = getelementptr inbounds i32, ptr %p.033.i, i64 %offset.idx
  %41 = getelementptr inbounds i32, ptr %40, i64 -3
  %wide.load = load <4 x i32>, ptr %41, align 4, !tbaa !20
  ...
  store <4 x i32> %wide.load304, ptr %45, align 4, !tbaa !20
  %index.next = add nuw i64 %index, 8
  %46 = icmp eq i64 %index.next, %n.vec
  br i1 %46, label %middle.block, label %vector.body, !llvm.loop !23
...
do.body.i.preheader:                              ; preds = %vector.memcheck, %if.then.i, %middle.block
  %indvars.iv.i.ph = phi i64 [ %34, %vector.memcheck ], [ %34, %if.then.i ], [ %ind.end, %middle.block ]
  %47 = add nsw i64 %indvars.iv.i.ph, 1
...
do.body.i.prol:                                   ; preds = %do.body.i.preheader, %do.body.i.prol
  ...
  %48 = load i32, ptr %arrayidx4.i.prol, align 4, !tbaa !20
  %arrayidx6.i.prol = getelementptr inbounds i32, ptr %pdest.032.i, i64 %indvars.iv.i.prol
  store i32 %48, ptr %arrayidx6.i.prol, align 4, !tbaa !20
...
do.body.i.prol.loopexit:                          ; preds = %do.body.i.prol, %do.body.i.preheader
  ...
  %49 = icmp ult i64 %indvars.iv.i.ph, 3
  br i1 %49, label %do.end.i, label %do.body.i
...
do.end.i:                                         ; preds = %do.body.i.prol.loopexit, %do.body.i, %middle.block
  %54 = load i32, ptr %count8.i, align 4, !tbaa !12
  %inc.i = add nsw i32 %54, 1
  store i32 %inc.i, ptr %count8.i, align 4, !tbaa !12
  %55 = load i32, ptr %call.i, align 8, !tbaa !19
  %idx.ext10.i = sext i32 %55 to i64
...
for.inc.i:                                        ; preds = %do.end.i, %for.body.i
  ...
  %56 = load i32, ptr %A, align 8, !tbaa !19
  %idx.ext13.i = sext i32 %56 to i64
...
abs_covered_many.exit:                            ; preds = %for.inc.i, %if.then80
  ...
  %57 = load i32, ptr %count85, align 4, !tbaa !12
  %cmp86289 = icmp sgt i32 %57, 0
...
for.body88.preheader:                             ; preds = %abs_covered_many.exit
  ...
  %58 = load ptr, ptr %data83, align 8, !tbaa !14
  br label %for.body88

for.body88:                                       ; preds = %for.body88.preheader, %for.body88
  %p.1291 = phi ptr [ %add.ptr93, %for.body88 ], [ %58, %for.body88.preheader ]
...
if.else96:                                        ; preds = %for.end72
  ...
  %61 = load i32, ptr %sf_size32, align 4, !tbaa !18
  %cmp19.i = icmp sgt i32 %61, 0
...
for.body.preheader.i:                             ; preds = %if.else96
  ...
  br i1 %62, label %if.end5.i.unr-lcssa, label %for.body.preheader.i.new
...
for.body.i256:                                    ; preds = %for.body.i256, %for.body.preheader.i.new
  ...
  %63 = load i32, ptr %arrayidx.i, align 4, !tbaa !20
  %cmp1.i = icmp sgt i32 %63, %best_count.022.i
  %64 = trunc i64 %indvars.iv.i254 to i32
  %spec.select.i = select i1 %cmp1.i, i32 %64, i32 %best_var.021.i
  %spec.select18.i = tail call i32 @llvm.smax.i32(i32 %63, i32 %best_count.022.i)
  ...
  %65 = load i32, ptr %arrayidx.i.1, align 4, !tbaa !20
  %cmp1.i.1 = icmp sgt i32 %65, %spec.select18.i
  %66 = trunc i64 %indvars.iv.next.i255 to i32
  %spec.select.i.1 = select i1 %cmp1.i.1, i32 %66, i32 %spec.select.i
  %spec.select18.i.1 = tail call i32 @llvm.smax.i32(i32 %65, i32 %spec.select18.i)
  ...
  %67 = load i32, ptr %arrayidx.i.2, align 4, !tbaa !20
  %cmp1.i.2 = icmp sgt i32 %67, %spec.select18.i.1
  %68 = trunc i64 %indvars.iv.next.i255.1 to i32
  %spec.select.i.2 = select i1 %cmp1.i.2, i32 %68, i32 %spec.select.i.1
  %spec.select18.i.2 = tail call i32 @llvm.smax.i32(i32 %67, i32 %spec.select18.i.1)
  ...
  %69 = load i32, ptr %arrayidx.i.3, align 4, !tbaa !20
  %cmp1.i.3 = icmp sgt i32 %69, %spec.select18.i.2
  %70 = trunc i64 %indvars.iv.next.i255.2 to i32
  %spec.select.i.3 = select i1 %cmp1.i.3, i32 %70, i32 %spec.select.i.2
  %spec.select18.i.3 = tail call i32 @llvm.smax.i32(i32 %69, i32 %spec.select18.i.2)
...
for.body.i256.epil:                               ; preds = %if.end5.i.unr-lcssa, %for.body.i256.epil
  ...
  %71 = load i32, ptr %arrayidx.i.epil, align 4, !tbaa !20
  %cmp1.i.epil = icmp sgt i32 %71, %best_count.022.i.epil
  %72 = trunc i64 %indvars.iv.i254.epil to i32
  %spec.select.i.epil = select i1 %cmp1.i.epil, i32 %72, i32 %best_var.021.i.epil
  %spec.select18.i.epil = tail call i32 @llvm.smax.i32(i32 %71, i32 %best_count.022.i.epil)
...
abs_select_restricted.exit:                       ; preds = %if.end5.i, %if.then7.i
  ...
  %73 = load i32, ptr %count, align 4, !tbaa !12
  %74 = load i32, ptr %sf_size32, align 4, !tbaa !18
  %call.i260 = tail call ptr (i32, i32, ...) @sf_new(i32 noundef %73, i32 noundef %74) #9
  %75 = load ptr, ptr %data44, align 8, !tbaa !14
  %76 = load i32, ptr %count, align 4, !tbaa !12
  %77 = load i32, ptr %A, align 8, !tbaa !19
  %mul.i262 = mul nsw i32 %77, %76
  %idx.ext.i263 = sext i32 %mul.i262 to i64
  %add.ptr.i264 = getelementptr inbounds i32, ptr %75, i64 %idx.ext.i263
...
for.body.lr.ph.i266:                              ; preds = %abs_select_restricted.exit
  ...
  %78 = load ptr, ptr %data.i265, align 8, !tbaa !14
...
for.body.i269:                                    ; preds = %for.inc.i280, %for.body.lr.ph.i266
  %79 = phi i32 [ %77, %for.body.lr.ph.i266 ], [ %105, %for.inc.i280 ]
  %p.037.i = phi ptr [ %75, %for.body.lr.ph.i266 ], [ %add.ptr17.i, %for.inc.i280 ]
  %pdest.036.i = phi ptr [ %78, %for.body.lr.ph.i266 ], [ %pdest.1.i278, %for.inc.i280 ]
  ...
  %80 = load i32, ptr %arrayidx.i267, align 4, !tbaa !20
  %and3.i = and i32 %80, %shl.i
...
if.then.i270:                                     ; preds = %for.body.i269
  %81 = load i32, ptr %p.037.i, align 4, !tbaa !20
  %82 = and i32 %81, 1023
  %83 = zext i32 %82 to i64
  %84 = add nuw nsw i64 %83, 1
  %min.iters.check314 = icmp ult i32 %82, 15
...
vector.memcheck308:                               ; preds = %if.then.i270
  ...
  %86 = add i64 %85, %p.037.i309
  %87 = add i64 %85, %pdest.036.i310
  %88 = sub i64 %86, %87
  %diff.check311 = icmp ult i64 %88, 32
  br i1 %diff.check311, label %do.body.i273.preheader, label %vector.ph315

vector.ph315:                                     ; preds = %vector.memcheck308
  %n.vec317 = and i64 %84, -8
  %ind.end318 = sub nsw i64 %83, %n.vec317
...
vector.body321:                                   ; preds = %vector.body321, %vector.ph315
  ...
  %offset.idx323 = sub i64 %83, %index322
  %89 = getelementptr inbounds i32, ptr %p.037.i, i64 %offset.idx323
  %90 = getelementptr inbounds i32, ptr %89, i64 -3
  %wide.load324 = load <4 x i32>, ptr %90, align 4, !tbaa !20
  %91 = getelementptr inbounds i32, ptr %89, i64 -7
  %wide.load326 = load <4 x i32>, ptr %91, align 4, !tbaa !20
  %92 = getelementptr inbounds i32, ptr %pdest.036.i, i64 %offset.idx323
  %93 = getelementptr inbounds i32, ptr %92, i64 -3
  store <4 x i32> %wide.load324, ptr %93, align 4, !tbaa !20
  %94 = getelementptr inbounds i32, ptr %92, i64 -7
  store <4 x i32> %wide.load326, ptr %94, align 4, !tbaa !20
  %index.next330 = add nuw i64 %index322, 8
  %95 = icmp eq i64 %index.next330, %n.vec317
  br i1 %95, label %middle.block312, label %vector.body321, !llvm.loop !30

middle.block312:                                  ; preds = %vector.body321
  %cmp.n320 = icmp eq i64 %84, %n.vec317
...
do.body.i273.preheader:                           ; preds = %vector.memcheck308, %if.then.i270, %middle.block312
  %indvars.iv.i271.ph = phi i64 [ %83, %vector.memcheck308 ], [ %83, %if.then.i270 ], [ %ind.end318, %middle.block312 ]
  %96 = add nsw i64 %indvars.iv.i271.ph, 1
  %xtraiter335 = and i64 %96, 3
...
do.body.i273.prol:                                ; preds = %do.body.i273.preheader, %do.body.i273.prol
  ...
  %97 = load i32, ptr %arrayidx7.i.prol, align 4, !tbaa !20
  %arrayidx9.i.prol = getelementptr inbounds i32, ptr %pdest.036.i, i64 %indvars.iv.i271.prol
  store i32 %97, ptr %arrayidx9.i.prol, align 4, !tbaa !20
...
do.body.i273.prol.loopexit:                       ; preds = %do.body.i273.prol, %do.body.i273.preheader
  ...
  %98 = icmp ult i64 %indvars.iv.i271.ph, 3
  br i1 %98, label %do.end.i277, label %do.body.i273
...
do.body.i273:                                     ; preds = %do.body.i273.prol.loopexit, %do.body.i273
  ...
  %99 = load i32, ptr %arrayidx7.i, align 4, !tbaa !20
  %arrayidx9.i = getelementptr inbounds i32, ptr %pdest.036.i, i64 %indvars.iv.i271
  store i32 %99, ptr %arrayidx9.i, align 4, !tbaa !20
  ...
  %100 = load i32, ptr %arrayidx7.i.1, align 4, !tbaa !20
  %arrayidx9.i.1 = getelementptr inbounds i32, ptr %pdest.036.i, i64 %indvars.iv.next.i272
  store i32 %100, ptr %arrayidx9.i.1, align 4, !tbaa !20
  ...
  %101 = load i32, ptr %arrayidx7.i.2, align 4, !tbaa !20
  %arrayidx9.i.2 = getelementptr inbounds i32, ptr %pdest.036.i, i64 %indvars.iv.next.i272.1
  store i32 %101, ptr %arrayidx9.i.2, align 4, !tbaa !20
  ...
  %102 = load i32, ptr %arrayidx7.i.3, align 4, !tbaa !20
  %arrayidx9.i.3 = getelementptr inbounds i32, ptr %pdest.036.i, i64 %indvars.iv.next.i272.2
  store i32 %102, ptr %arrayidx9.i.3, align 4, !tbaa !20
...
do.end.i277:                                      ; preds = %do.body.i273.prol.loopexit, %do.body.i273, %middle.block312
  %103 = load i32, ptr %count11.i, align 4, !tbaa !12
  %inc.i274 = add nsw i32 %103, 1
  store i32 %inc.i274, ptr %count11.i, align 4, !tbaa !12
  %104 = load i32, ptr %call.i260, align 8, !tbaa !19
  %idx.ext13.i275 = sext i32 %104 to i64
...
for.inc.i280:                                     ; preds = %do.end.i277, %for.body.i269
  %105 = phi i32 [ %79, %for.body.i269 ], [ %.pre.i, %do.end.i277 ]
  %pdest.1.i278 = phi ptr [ %pdest.036.i, %for.body.i269 ], [ %add.ptr14.i276, %do.end.i277 ]
  %idx.ext16.i = sext i32 %105 to i64
...
abs_covered.exit:                                 ; preds = %for.inc.i280, %abs_select_restricted.exit
  ...
  %106 = load i32, ptr %count102, align 4, !tbaa !12
  %cmp103292 = icmp sgt i32 %106, 0
...
for.body105.lr.ph:                                ; preds = %abs_covered.exit
  ...
  %107 = load ptr, ptr %data100, align 8, !tbaa !14
...
for.body124:                                      ; preds = %for.body124.lr.ph, %for.inc150
  %113 = phi i32 [ %111, %for.body124.lr.ph ], [ %116, %for.inc150 ]
  %p.3297 = phi ptr [ %112, %for.body124.lr.ph ], [ %add.ptr153, %for.inc150 ]
  %i.4296 = phi i32 [ 0, %for.body124.lr.ph ], [ %inc154, %for.inc150 ]
  %arrayidx128 = getelementptr inbounds i32, ptr %p.3297, i64 %idxprom127
  %114 = load i32, ptr %arrayidx128, align 4, !tbaa !20
  %and131 = and i32 %114, %shl130
  %tobool132.not = icmp eq i32 %and131, 0
  br i1 %tobool132.not, label %for.inc150, label %if.then133

if.then133:                                       ; preds = %for.body124
  %and140 = and i32 %114, %not
  store i32 %and140, ptr %arrayidx128, align 4, !tbaa !20
  %115 = load i32, ptr %p.3297, align 4, !tbaa !20
  %shr142 = and i32 %115, -65536
  %and145 = and i32 %115, 65535
...
for.inc150:                                       ; preds = %for.body124, %if.then133
  %116 = phi i32 [ %113, %for.body124 ], [ %.pre299, %if.then133 ]
  %117 = load i32, ptr %A, align 8, !tbaa !19
  %idx.ext152 = sext i32 %117 to i64
  %add.ptr153 = getelementptr inbounds i32, ptr %p.3297, i64 %idx.ext152
  %inc154 = add nuw nsw i32 %i.4296, 1
  %cmp122 = icmp slt i32 %inc154, %116
...
land.rhs:                                         ; preds = %land.rhs.lr.ph, %if.end130
  ...
  br i1 %23, label %while.body, label %for.inc147
...
if.end130:                                        ; preds = %if.then113, %unate_intersect.exit
  ...
  br i1 %cmp72, label %land.rhs, label %for.inc147.loopexit.split.loop.exit324

for.inc147.loopexit.split.loop.exit324:           ; preds = %if.end130
  %indvars.le = trunc i64 %indvars.iv.next to i32
  br label %for.inc147

for.inc147:                                       ; preds = %land.rhs, %for.inc147.loopexit.split.loop.exit324, %for.end64
  %n.2.lcssa = phi i32 [ %inc68, %for.end64 ], [ %indvars.le, %for.inc147.loopexit.split.loop.exit324 ], [ %21, %land.rhs ]
...
for.body180.preheader:                            ; preds = %for.end151
  %scevgep332 = getelementptr i8, ptr %call170, i64 4
...
for.body180:                                      ; preds = %for.body180.preheader, %do.end
  ...
  %62 = icmp ne i32 %59, 0
  %umin334.neg = sext i1 %62 to i64
  %63 = add nsw i64 %61, %umin334.neg
...
vector.memcheck:                                  ; preds = %for.body180
  ...
  %scevgep329 = getelementptr i8, ptr %p.1316, i64 4
  %65 = shl nuw nsw i64 %60, 2
  %scevgep330 = getelementptr i8, ptr %scevgep329, i64 %65
  %scevgep331 = getelementptr i8, ptr %call170, i64 %64
  %scevgep333 = getelementptr i8, ptr %scevgep332, i64 %65
  %bound0 = icmp ult ptr %scevgep, %scevgep333
  %bound1 = icmp ult ptr %scevgep331, %scevgep330
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %68 = getelementptr inbounds i32, ptr %66, i64 -7
  %wide.load335 = load <4 x i32>, ptr %68, align 4, !tbaa !20, !alias.scope !37
  %69 = getelementptr inbounds i32, ptr %p.1316, i64 %offset.idx
  %70 = getelementptr inbounds i32, ptr %69, i64 -3
  %wide.load337 = load <4 x i32>, ptr %70, align 4, !tbaa !20, !alias.scope !40, !noalias !37
  %71 = getelementptr inbounds i32, ptr %69, i64 -7
  %wide.load339 = load <4 x i32>, ptr %71, align 4, !tbaa !20, !alias.scope !40, !noalias !37
  %72 = xor <4 x i32> %wide.load337, <i32 -1, i32 -1, i32 -1, i32 -1>
  %73 = xor <4 x i32> %wide.load339, <i32 -1, i32 -1, i32 -1, i32 -1>
  %74 = and <4 x i32> %wide.load, %72
  %75 = and <4 x i32> %wide.load335, %73
  store <4 x i32> %74, ptr %70, align 4, !tbaa !20, !alias.scope !40, !noalias !37
  store <4 x i32> %75, ptr %71, align 4, !tbaa !20, !alias.scope !40, !noalias !37
  %index.next = add nuw i64 %index, 8
  %76 = icmp eq i64 %index.next, %n.vec
  br i1 %76, label %middle.block, label %vector.body, !llvm.loop !42
...
do.body:                                          ; preds = %do.body.preheader, %do.body
  ...
  %77 = load i32, ptr %arrayidx187, align 4, !tbaa !20
  %arrayidx189 = getelementptr inbounds i32, ptr %p.1316, i64 %indvars.iv318
  %78 = load i32, ptr %arrayidx189, align 4, !tbaa !20
  %not190 = xor i32 %78, -1
  %and191 = and i32 %77, %not190
...
do.end:                                           ; preds = %do.body, %middle.block
  %79 = load i32, ptr %49, align 8, !tbaa !19
  %idx.ext199 = sext i32 %79 to i64
...
if.end204:                                        ; preds = %if.then203, %for.end201
  %80 = load i32, ptr @debug, align 4, !tbaa !20
  %and205 = and i32 %80, 4096
