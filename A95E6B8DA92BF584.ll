; ModuleID = '/usr/local/google/home/aeubanks/repos/test-suite/SingleSource/Benchmarks/Misc/flops-6.c'
source_filename = "/usr/local/google/home/aeubanks/repos/test-suite/SingleSource/Benchmarks/Misc/flops-6.c"
...
define dso_local i32 @main() local_unnamed_addr #0 {
  ...
  %6 = load double, ptr @four, align 8, !tbaa !5
...
22:                                               ; preds = %0, %22
  %23 = phi double [ 0.000000e+00, %0 ], [ %41, %22 ]
  %24 = phi i64 [ 1, %0 ], [ %42, %22 ]
  ...
  %41 = tail call double @llvm.fmuladd.f64(double %34, double %40, double %23)
  %42 = add nuw nsw i64 %24, 1
  %43 = icmp eq i64 %42, 156250000
  br i1 %43, label %44, label %22, !llvm.loop !9

44:                                               ; preds = %22
  %45 = fdiv double %5, %6
  %46 = fmul double %45, %45
  %47 = tail call double @llvm.fmuladd.f64(double %9, double %46, double %10)
  %48 = tail call double @llvm.fmuladd.f64(double %47, double %46, double %11)
  %49 = tail call double @llvm.fmuladd.f64(double %48, double %46, double %12)
  %50 = tail call double @llvm.fmuladd.f64(double %49, double %46, double %13)
  %51 = tail call double @llvm.fmuladd.f64(double %50, double %46, double %14)
  %52 = tail call double @llvm.fmuladd.f64(double %51, double %46, double %15)
  %53 = fmul double %45, %52
  %54 = tail call double @llvm.fmuladd.f64(double %16, double %46, double %17)
  %55 = tail call double @llvm.fmuladd.f64(double %46, double %54, double %18)
  %56 = tail call double @llvm.fmuladd.f64(double %46, double %55, double %19)
  %57 = tail call double @llvm.fmuladd.f64(double %46, double %56, double %20)
  %58 = tail call double @llvm.fmuladd.f64(double %46, double %57, double %21)
  %59 = tail call double @llvm.fmuladd.f64(double %46, double %58, double %15)
  %60 = fmul double %53, %59
  %61 = load double, ptr @two, align 8, !tbaa !5
  %62 = tail call double @llvm.fmuladd.f64(double %61, double %41, double %60)
  %63 = fmul double %8, %62
  %64 = fdiv double %63, %61
  store double %64, ptr @sa, align 8, !tbaa !5
  store double 2.500000e-01, ptr @sb, align 8, !tbaa !5
  %65 = fadd double %64, -2.500000e-01
  store double %65, ptr @sc, align 8, !tbaa !5
  %66 = fmul double %65, 1.000000e-30
  %67 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4, double noundef %66, double noundef 0.000000e+00, double noundef 0.000000e+00)
  ret i32 0
}
