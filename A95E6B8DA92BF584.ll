...
entry:
  ...
  %1 = load double, ptr @four, align 8, !tbaa !5
...
for.body:                                         ; preds = %entry, %for.body
  %s.081 = phi double [ 0.000000e+00, %entry ], [ %27, %for.body ]
  ...
  %27 = tail call double @llvm.fmuladd.f64(double %mul15, double %26, double %s.081)
...
for.end:                                          ; preds = %for.body
  ...
  %28 = tail call double @llvm.fmuladd.f64(double %2, double %mul24, double %3)
  %29 = tail call double @llvm.fmuladd.f64(double %28, double %mul24, double %4)
  %30 = tail call double @llvm.fmuladd.f64(double %29, double %mul24, double %5)
  %31 = tail call double @llvm.fmuladd.f64(double %30, double %mul24, double %6)
  %32 = tail call double @llvm.fmuladd.f64(double %31, double %mul24, double %7)
  %33 = tail call double @llvm.fmuladd.f64(double %32, double %mul24, double %8)
  %mul31 = fmul double %div23, %33
  %34 = tail call double @llvm.fmuladd.f64(double %9, double %mul24, double %10)
  %35 = tail call double @llvm.fmuladd.f64(double %mul24, double %34, double %11)
  %36 = tail call double @llvm.fmuladd.f64(double %mul24, double %35, double %12)
  %37 = tail call double @llvm.fmuladd.f64(double %mul24, double %36, double %13)
  %38 = tail call double @llvm.fmuladd.f64(double %mul24, double %37, double %14)
  %39 = tail call double @llvm.fmuladd.f64(double %mul24, double %38, double %8)
  %mul38 = fmul double %mul31, %39
  %40 = load double, ptr @two, align 8, !tbaa !5
  %41 = tail call double @llvm.fmuladd.f64(double %40, double %27, double %mul38)
  %mul40 = fmul double %div, %41
  %div41 = fdiv double %mul40, %40
  store double %div41, ptr @sa, align 8, !tbaa !5
  store double 2.500000e-01, ptr @sb, align 8, !tbaa !5
  %sub42 = fadd double %div41, -2.500000e-01
