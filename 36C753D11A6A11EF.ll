...
entry:
  %ver.i = alloca [30 x i8], align 16
  tail call void @process_args(ptr noundef nonnull @arg_state, ptr noundef %argv) #6
  %0 = load i32, ptr getelementptr inbounds (%struct.ArgumentState, ptr @arg_state, i64 0, i32 1), align 8, !tbaa !5
  %cmp.not = icmp eq i32 %0, 1
  br i1 %cmp.not, label %if.end, label %if.then

if.then:                                          ; preds = %entry
  call void @llvm.lifetime.start.p0(i64 30, ptr nonnull %ver.i) #6
  call void @d_version(ptr noundef nonnull %ver.i) #6
  %1 = load ptr, ptr @stderr, align 8, !tbaa !11
  %call.i = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %1, ptr noundef nonnull @.str.49, ptr noundef nonnull %ver.i) #7
  %2 = load ptr, ptr @stderr, align 8, !tbaa !11
  %3 = call i64 @fwrite(ptr nonnull @.str.50, i64 37, i64 1, ptr %2) #7
  call void @usage(ptr noundef nonnull @arg_state, ptr noundef null) #6
  call void @llvm.lifetime.end.p0(i64 30, ptr nonnull %ver.i) #6
  br label %if.end

if.end:                                           ; preds = %if.then, %entry
  %4 = load ptr, ptr @arg_state, align 8, !tbaa !12
  %5 = load ptr, ptr %4, align 8, !tbaa !11
  %call = call ptr @new_D_Grammar(ptr noundef %5) #6
  %6 = load i32, ptr @set_op_priority_from_rule, align 4, !tbaa !13
  %set_op_priority_from_rule = getelementptr inbounds %struct.Grammar, ptr %call, i64 0, i32 10
  store i32 %6, ptr %set_op_priority_from_rule, align 8, !tbaa !14
  %7 = load i32, ptr @right_recursive_BNF, align 4, !tbaa !13
  %right_recursive_BNF = getelementptr inbounds %struct.Grammar, ptr %call, i64 0, i32 11
  store i32 %7, ptr %right_recursive_BNF, align 4, !tbaa !18
  %8 = load i32, ptr @states_for_whitespace, align 4, !tbaa !13
  %states_for_whitespace = getelementptr inbounds %struct.Grammar, ptr %call, i64 0, i32 12
  store i32 %8, ptr %states_for_whitespace, align 8, !tbaa !19
  %9 = load i32, ptr @states_for_all_nterms, align 4, !tbaa !13
  %states_for_all_nterms = getelementptr inbounds %struct.Grammar, ptr %call, i64 0, i32 13
  store i32 %9, ptr %states_for_all_nterms, align 4, !tbaa !20
  %10 = load i32, ptr @tokenizer, align 4, !tbaa !13
  %tokenizer = getelementptr inbounds %struct.Grammar, ptr %call, i64 0, i32 14
  store i32 %10, ptr %tokenizer, align 8, !tbaa !21
  %11 = load i32, ptr @longest_match, align 4, !tbaa !13
  %longest_match = getelementptr inbounds %struct.Grammar, ptr %call, i64 0, i32 15
  store i32 %11, ptr %longest_match, align 4, !tbaa !22
  %grammar_ident = getelementptr inbounds %struct.Grammar, ptr %call, i64 0, i32 17
  %call1 = call ptr @strcpy(ptr noundef nonnull dereferenceable(1) %grammar_ident, ptr noundef nonnull dereferenceable(1) @grammar_ident) #6
  %12 = load i32, ptr @scanner_blocks, align 4, !tbaa !13
  %scanner_blocks = getelementptr inbounds %struct.Grammar, ptr %call, i64 0, i32 18
  store i32 %12, ptr %scanner_blocks, align 4, !tbaa !23
  %scanner_block_size = getelementptr inbounds %struct.Grammar, ptr %call, i64 0, i32 19
  store i32 0, ptr %scanner_block_size, align 8, !tbaa !24
  %13 = load i32, ptr @write_line_directives, align 4, !tbaa !13
  %write_line_directives = getelementptr inbounds %struct.Grammar, ptr %call, i64 0, i32 20
  store i32 %13, ptr %write_line_directives, align 4, !tbaa !25
  %14 = load i32, ptr @write_header, align 4, !tbaa !13
  %write_header = getelementptr inbounds %struct.Grammar, ptr %call, i64 0, i32 21
  store i32 %14, ptr %write_header, align 8, !tbaa !26
  %15 = load i32, ptr @token_type, align 4, !tbaa !13
  %token_type = getelementptr inbounds %struct.Grammar, ptr %call, i64 0, i32 22
  store i32 %15, ptr %token_type, align 4, !tbaa !27
  %call2 = call i32 @parse_grammar(ptr noundef %call, ptr noundef nonnull @parser_tables_dparser_gram, i32 noundef 32) #6
  %cmp3 = icmp slt i32 %call2, 0
  br i1 %cmp3, label %if.then4, label %if.end5

if.then4:                                         ; preds = %if.end
  call void (ptr, ...) @d_fail(ptr noundef nonnull @.str, ptr noundef %5) #6
  br label %if.end5

if.end5:                                          ; preds = %if.then4, %if.end
  %call6 = call i32 @build_grammar(ptr noundef nonnull %call) #6
  %cmp7 = icmp slt i32 %call6, 0
  br i1 %cmp7, label %if.then8, label %if.end9

if.then8:                                         ; preds = %if.end5
  call void (ptr, ...) @d_fail(ptr noundef nonnull @.str.1, ptr noundef %5) #6
  br label %if.end9

if.end9:                                          ; preds = %if.then8, %if.end5
  %call10 = call i32 @write_ctables(ptr noundef nonnull %call) #6
  %cmp11 = icmp slt i32 %call10, 0
  br i1 %cmp11, label %if.then12, label %if.end13

if.then12:                                        ; preds = %if.end9
  call void (ptr, ...) @d_fail(ptr noundef nonnull @.str.2, ptr noundef %5) #6
  br label %if.end13

if.end13:                                         ; preds = %if.then12, %if.end9
  call void @free_D_Grammar(ptr noundef nonnull %call) #6
  ret i32 0
}
...
; Function Attrs: nounwind uwtable
define internal void @help(ptr noundef %arg_state, ptr noundef %arg_unused) #0 {
entry:
  %ver = alloca [30 x i8], align 16
  call void @llvm.lifetime.start.p0(i64 30, ptr nonnull %ver) #6
  call void @d_version(ptr noundef nonnull %ver) #6
  %0 = load ptr, ptr @stderr, align 8, !tbaa !11
  %call = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %0, ptr noundef nonnull @.str.49, ptr noundef nonnull %ver) #7
  %1 = load ptr, ptr @stderr, align 8, !tbaa !11
  %2 = call i64 @fwrite(ptr nonnull @.str.50, i64 37, i64 1, ptr %1) #7
  call void @usage(ptr noundef %arg_state, ptr noundef %arg_unused) #6
  call void @llvm.lifetime.end.p0(i64 30, ptr nonnull %ver) #6
  ret void
}
