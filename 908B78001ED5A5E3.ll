...
"for k$1.s0.n1.preheader":                        ; preds = %"assert succeeded77"
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 32 dereferenceable(32) %"fwd_fft1_S1_R8_n1$1.011", ptr noundef nonnull align 4 dereferenceable(32) %scevgep333, i64 32, i1 false)
  %scevgep332.1 = getelementptr inbounds i8, ptr %"fwd_fft1_S1_R8_n1$1.011", i64 32
  %261 = add i64 %259, %260
  ...
  %scevgep332.2 = getelementptr inbounds i8, ptr %"fwd_fft1_S1_R8_n1$1.011", i64 64
  ...
  %scevgep332.3 = getelementptr inbounds i8, ptr %"fwd_fft1_S1_R8_n1$1.011", i64 96
  ...
  %scevgep332.4 = getelementptr inbounds i8, ptr %"fwd_fft1_S1_R8_n1$1.011", i64 128
  ...
  %scevgep332.5 = getelementptr inbounds i8, ptr %"fwd_fft1_S1_R8_n1$1.011", i64 160
  ...
  %scevgep332.6 = getelementptr inbounds i8, ptr %"fwd_fft1_S1_R8_n1$1.011", i64 192
  ...
  %scevgep332.7 = getelementptr inbounds i8, ptr %"fwd_fft1_S1_R8_n1$1.011", i64 224
  ...
  %wide.vec379 = load <32 x float>, ptr %"fwd_fft1_S1_R8_n1$1.110", align 32, !tbaa !27
  ...
  %"inv_fft1_S1_R8_n1$1.112.sroa.0.0.vec.extract" = shufflevector <32 x float> %interleaved.vec388, <32 x float> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %"inv_fft1_S1_R8_n1$1.112.sroa.21.128.vec.extract" = shufflevector <32 x float> %interleaved.vec388.1, <32 x float> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  ...
  %"inv_fft1_S1_R8_n1$1.112.sroa.0.64.vec.extract" = shufflevector <32 x float> %interleaved.vec388, <32 x float> poison, <8 x i32> <i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23>
  %"inv_fft1_S1_R8_n1$1.112.sroa.21.192.vec.extract" = shufflevector <32 x float> %interleaved.vec388.1, <32 x float> poison, <8 x i32> <i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23>
  ...
  %"inv_fft1_S1_R8_n1$1.112.sroa.0.32.vec.extract" = shufflevector <32 x float> %interleaved.vec388, <32 x float> poison, <8 x i32> <i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %"inv_fft1_S1_R8_n1$1.112.sroa.21.160.vec.extract" = shufflevector <32 x float> %interleaved.vec388.1, <32 x float> poison, <8 x i32> <i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  ...
  %"inv_fft1_S1_R8_n1$1.112.sroa.0.96.vec.extract" = shufflevector <32 x float> %interleaved.vec388, <32 x float> poison, <8 x i32> <i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31>
  %"inv_fft1_S1_R8_n1$1.112.sroa.21.224.vec.extract" = shufflevector <32 x float> %interleaved.vec388.1, <32 x float> poison, <8 x i32> <i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31>
...
"for result$1.s0.i.preheader":                    ; preds = %"for k$1.s0.n1.preheader"
  ...
  %561 = getelementptr inbounds float, ptr %"inv_fft1_S1_R8_n1$1.013", i64 1
  %562 = getelementptr inbounds float, ptr %"inv_fft1_S1_R8_n1$1.013", i64 2
  %563 = getelementptr inbounds float, ptr %"inv_fft1_S1_R8_n1$1.013", i64 4
  %564 = getelementptr inbounds float, ptr %"inv_fft1_S1_R8_n1$1.013", i64 5
  %565 = getelementptr inbounds float, ptr %"inv_fft1_S1_R8_n1$1.013", i64 7
  %reass.add309.1 = sub nsw i64 1, %534
  %reass.mul310.1 = mul nsw i64 %reass.add309.1, %221
  %566 = getelementptr inbounds float, ptr %"inv_fft1_S1_R8_n1$1.013", i64 9
  %567 = getelementptr inbounds float, ptr %"inv_fft1_S1_R8_n1$1.013", i64 10
  %568 = getelementptr inbounds float, ptr %"inv_fft1_S1_R8_n1$1.013", i64 12
  %569 = getelementptr inbounds float, ptr %"inv_fft1_S1_R8_n1$1.013", i64 13
  %570 = getelementptr inbounds float, ptr %"inv_fft1_S1_R8_n1$1.013", i64 15
  %reass.add309.2 = sub nsw i64 2, %534
  %reass.mul310.2 = mul nsw i64 %reass.add309.2, %221
  %571 = getelementptr inbounds float, ptr %"inv_fft1_S1_R8_n1$1.013", i64 17
  %572 = getelementptr inbounds float, ptr %"inv_fft1_S1_R8_n1$1.013", i64 18
  %573 = getelementptr inbounds float, ptr %"inv_fft1_S1_R8_n1$1.013", i64 20
  %574 = getelementptr inbounds float, ptr %"inv_fft1_S1_R8_n1$1.013", i64 21
  %575 = getelementptr inbounds float, ptr %"inv_fft1_S1_R8_n1$1.013", i64 23
  %reass.add309.3 = sub nsw i64 3, %534
  %reass.mul310.3 = mul nsw i64 %reass.add309.3, %221
  %576 = getelementptr inbounds float, ptr %"inv_fft1_S1_R8_n1$1.013", i64 25
  %577 = getelementptr inbounds float, ptr %"inv_fft1_S1_R8_n1$1.013", i64 26
  %578 = getelementptr inbounds float, ptr %"inv_fft1_S1_R8_n1$1.013", i64 28
  %579 = getelementptr inbounds float, ptr %"inv_fft1_S1_R8_n1$1.013", i64 29
  %580 = getelementptr inbounds float, ptr %"inv_fft1_S1_R8_n1$1.013", i64 31
  %581 = getelementptr float, ptr %"inv_fft0_S1_R8_n0$1.07", i64 -7
  %582 = getelementptr float, ptr %"inv_fft0_S1_R8_n0$1.16", i64 -7
...
"for result$1.s0.i":                              ; preds = %"for result$1.s0.i.preheader", %"end for result$1.s0.n1"
  %indvars.iv349 = phi i64 [ %555, %"for result$1.s0.i.preheader" ], [ %indvars.iv.next350, %"end for result$1.s0.n1" ]
  ...
  %"inv_fft1_S1_R8_n1$1.112.sroa.0.64.vecblend452" = shufflevector <4 x float> %764, <4 x float> poison, <32 x i32> <i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 0, i32 1, i32 2, i32 3, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef>
  ...
  %"inv_fft1_S1_R8_n1$1.112.sroa.0.96.vecblend458" = shufflevector <4 x float> %824, <4 x float> poison, <32 x i32> <i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 0, i32 1, i32 2, i32 3, i32 undef, i32 undef, i32 undef, i32 undef>
  ...
  %"inv_fft1_S1_R8_n1$1.112.sroa.0.112.vecblend" = shufflevector <32 x float> %"inv_fft1_S1_R8_n1$1.112.sroa.0.96.vecblend458", <32 x float> %"inv_fft1_S1_R8_n1$1.112.sroa.0.112.vec.expand", <32 x i32> <i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 24, i32 25, i32 26, i32 27, i32 60, i32 61, i32 62, i32 63>
  store float %812, ptr %580, align 4, !tbaa !32
  %"inv_fft1_S1_R8_n1$1.112.sroa.0.0.vec.extract436" = shufflevector <32 x float> %"inv_fft1_S1_R8_n1$1.112.sroa.0.0.vec.expand439", <32 x float> %"inv_fft1_S1_R8_n1$1.112.sroa.0.16.vec.expand", <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 36, i32 37, i32 38, i32 39>
  %825 = load <8 x float>, ptr %"inv_fft1_S1_R8_n1$1.013", align 32, !tbaa !34
  %"inv_fft1_S1_R8_n1$1.112.sroa.0.64.vec.extract448" = shufflevector <32 x float> %"inv_fft1_S1_R8_n1$1.112.sroa.0.80.vecblend", <32 x float> poison, <8 x i32> <i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23>
  %826 = load <8 x float>, ptr %422, align 32, !tbaa !47
  %827 = fadd <8 x float> %"inv_fft1_S1_R8_n1$1.112.sroa.0.0.vec.extract436", %"inv_fft1_S1_R8_n1$1.112.sroa.0.64.vec.extract448"
  store <8 x float> %827, ptr %431, align 32, !tbaa !53
  %828 = fadd <8 x float> %825, %826
  store <8 x float> %828, ptr %433, align 32, !tbaa !63
  %829 = fsub <8 x float> %"inv_fft1_S1_R8_n1$1.112.sroa.0.0.vec.extract436", %"inv_fft1_S1_R8_n1$1.112.sroa.0.64.vec.extract448"
  store <8 x float> %829, ptr %435, align 32, !tbaa !73
  %830 = fsub <8 x float> %825, %826
  store <8 x float> %830, ptr %437, align 32, !tbaa !76
  %831 = fsub <8 x float> zeroinitializer, %"inv_fft1_S1_R8_n1$1.112.sroa.0.64.vec.extract448"
  %832 = fadd <8 x float> %"inv_fft1_S1_R8_n1$1.112.sroa.0.0.vec.extract436", %826
  store <8 x float> %832, ptr %447, align 32, !tbaa !79
  %833 = fadd <8 x float> %825, %831
  store <8 x float> %833, ptr %449, align 32, !tbaa !81
  %834 = fsub <8 x float> %"inv_fft1_S1_R8_n1$1.112.sroa.0.0.vec.extract436", %826
  store <8 x float> %834, ptr %451, align 32, !tbaa !83
  %835 = fsub <8 x float> %825, %831
  store <8 x float> %835, ptr %453, align 32, !tbaa !85
  %"inv_fft1_S1_R8_n1$1.112.sroa.0.32.vec.extract442" = shufflevector <32 x float> %"inv_fft1_S1_R8_n1$1.112.sroa.0.48.vecblend", <32 x float> poison, <8 x i32> <i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %836 = load <8 x float>, ptr %454, align 32, !tbaa !87
  %"inv_fft1_S1_R8_n1$1.112.sroa.0.96.vec.extract454" = shufflevector <32 x float> %"inv_fft1_S1_R8_n1$1.112.sroa.0.112.vecblend", <32 x float> poison, <8 x i32> <i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31>
  %837 = load <8 x float>, ptr %462, align 32, !tbaa !91
  %838 = fadd <8 x float> %"inv_fft1_S1_R8_n1$1.112.sroa.0.32.vec.extract442", %"inv_fft1_S1_R8_n1$1.112.sroa.0.96.vec.extract454"
  ...
  %841 = fsub <8 x float> %"inv_fft1_S1_R8_n1$1.112.sroa.0.96.vec.extract454", %"inv_fft1_S1_R8_n1$1.112.sroa.0.32.vec.extract442"
  store <8 x float> %841, ptr %477, align 32, !tbaa !106
  %842 = fsub <8 x float> zeroinitializer, %"inv_fft1_S1_R8_n1$1.112.sroa.0.96.vec.extract454"
  %843 = fadd <8 x float> %"inv_fft1_S1_R8_n1$1.112.sroa.0.32.vec.extract442", %837
  ...
  %849 = fsub <8 x float> %837, %"inv_fft1_S1_R8_n1$1.112.sroa.0.32.vec.extract442"
  ...
  store <8 x float> %852, ptr %"inv_fft0_S1_R8_n0$1.07", align 32, !tbaa !113
  ...
  store <8 x float> %855, ptr %"inv_fft0_S1_R8_n0$1.16", align 32, !tbaa !115
  ...
  store <8 x float> %856, ptr %"fwd_fft1_S1_R8_n1$1.011", align 32, !tbaa !221
  store <8 x float> %857, ptr %"fwd_fft1_S1_R8_n1$1.110", align 32, !tbaa !230
...
vector.body394:                                   ; preds = %"assert succeeded83", %vector.body394
  ...
  %876 = getelementptr inbounds float, ptr %"fwd_fft1_S1_R8_n1$1.011", i64 %875
  ...
  %877 = getelementptr inbounds float, ptr %"kernel_fft1_S1_R8_n1$1.015", i64 %875
  ...
  %879 = getelementptr inbounds float, ptr %"fwd_fft1_S1_R8_n1$1.110", i64 %875
  ...
  %880 = getelementptr inbounds float, ptr %"kernel_fft1_S1_R8_n1$1.114", i64 %875
  ...
  br i1 %1004, label %"produce inv_X8$3", label %vector.body394, !llvm.loop !279
...
"produce inv_X8$3":                               ; preds = %vector.body394
  %1006 = load <8 x float>, ptr %"inv_fft0_S1_R8_n0$1.07", align 32, !tbaa !113
  ...
  store <8 x float> %1046, ptr %"inv_fft1_S1_R8_n1$1.013", align 32, !tbaa !34
...
"for result$1.s0.n1":                             ; preds = %"for result$1.s0.n1.preheader", %"end for result$1.s0.n0.n091"
  %indvars.iv346 = phi i64 [ %554, %"for result$1.s0.n1.preheader" ], [ %indvars.iv.next347, %"end for result$1.s0.n0.n091" ]
  br i1 %.not296, label %"end for result$1.s0.n0.n0", label %"for result$1.s0.n0.n0.preheader", !prof !5
...
"for result$1.s0.n0.n0":                          ; preds = %"for result$1.s0.n0.n0.preheader", %"for result$1.s0.n0.n0"
  %indvars.iv343 = phi i64 [ %indvars.iv.next344.1, %"for result$1.s0.n0.n0" ], [ 0, %"for result$1.s0.n0.n0.preheader" ]
  ...
  %1062 = getelementptr inbounds float, ptr %"inv_fft1_S1_R8_n1$1.013", i64 %1061
  ...
  %1070 = getelementptr inbounds float, ptr %"inv_fft1_S1_R8_n1$1.013", i64 %1069
...
"end for result$1.s0.n0.n0.loopexit.unr-lcssa":   ; preds = %"for result$1.s0.n0.n0", %"for result$1.s0.n0.n0.preheader"
  %indvars.iv343.unr = phi i64 [ 0, %"for result$1.s0.n0.n0.preheader" ], [ %indvars.iv.next344.1, %"for result$1.s0.n0.n0" ]
...
"for result$1.s0.n0.n0.epil":                     ; preds = %"end for result$1.s0.n0.n0.loopexit.unr-lcssa"
  ...
  %1078 = getelementptr inbounds float, ptr %"inv_fft1_S1_R8_n1$1.013", i64 %1077
...
"for result$1.s0.n0.n090.preheader":              ; preds = %"end for result$1.s0.n0.n0"
  ...
  %1085 = getelementptr inbounds float, ptr %"inv_fft1_S1_R8_n1$1.013", i64 %1084
