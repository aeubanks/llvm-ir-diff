...
define dso_local i32 @main(i32 noundef %0, ptr nocapture noundef readnone %1) local_unnamed_addr #0 {
  ...
  %6 = select <2 x i1> %5, <2 x double> <double 0x4050693404EA4A8C, double 0x4063732FEC56D5D0>, <2 x double> <double 0x409B49779A6B50B1, double 0x40ACCB9C779A6B51>
  %7 = extractelement <2 x i1> %5, i64 0
  %8 = select i1 %7, double 0x4050693404EA4A8C, double 0x409B49779A6B50B1
  ...
  %17 = shufflevector <4 x float> %16, <4 x float> poison, <4 x i32> <i32 0, i32 0, i32 undef, i32 undef>
  ...
  %54 = extractelement <2 x double> %6, i64 1
