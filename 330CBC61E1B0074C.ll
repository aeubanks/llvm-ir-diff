...
startover.outer:                                  ; preds = %if.then350, %if.end36
  ...
  %exp.0.ph = phi ptr [ %l.0685, %if.then350 ], [ null, %if.end36 ]
...
startover.loopexit:                               ; preds = %if.end190
  call void (ptr, ...) @ptlfree(ptr noundef nonnull %resp.0845) #7
  br label %startover

startover:                                        ; preds = %startover.loopexit, %startover.outer
  %comp.3 = phi ptr [ %comp.3.ph, %startover.outer ], [ %comp.5661, %startover.loopexit ]
  %cur_link.0 = phi ptr [ %cur_link.0.ph, %startover.outer ], [ %cur_link.2663, %startover.loopexit ]
  %pul.0 = phi ptr [ %exp.0.ph, %startover.outer ], [ %pul.2664, %startover.loopexit ]
  %fwdcnt.0 = phi i32 [ %fwdcnt.0.ph, %startover.outer ], [ %dec, %startover.loopexit ]
  %no_links.0 = phi i32 [ %no_links.0.ph, %startover.outer ], [ %no_links.2670, %startover.loopexit ]
  ...
  %cond861 = icmp eq ptr %call60, null
  br i1 %cond861, label %if.then63, label %while.body.preheader
...
if.then65:                                        ; preds = %if.then63
  ...
  %tobool69.not844 = icmp eq ptr %call60, null
  br i1 %tobool69.not844, label %while.end291, label %while.body.preheader
...
while.body:                                       ; preds = %while.body.preheader, %cleanup289
  %no_links.1851 = phi i32 [ %no_links.2.lcssa, %cleanup289 ], [ %no_links.0, %while.body.preheader ]
  %fwdcnt.1850 = phi i32 [ %fwdcnt.2.lcssa, %cleanup289 ], [ %fwdcnt.0, %while.body.preheader ]
  %unresp.0849 = phi i32 [ %unresp.1.lcssa, %cleanup289 ], [ 0, %while.body.preheader ]
  %pul.1848 = phi ptr [ %pul.2.lcssa, %cleanup289 ], [ %pul.0, %while.body.preheader ]
  %cur_link.1847 = phi ptr [ %cur_link.2.lcssa, %cleanup289 ], [ %cur_link.0, %while.body.preheader ]
  %comp.4846 = phi ptr [ %comp.5.lcssa, %cleanup289 ], [ %comp.3, %while.body.preheader ]
  %resp.0845 = phi ptr [ %23, %cleanup289 ], [ %call60, %while.body.preheader ]
  %start70 = getelementptr inbounds %struct.ptext, ptr %resp.0845, i64 0, i32 1
  %6 = load ptr, ptr %start70, align 8, !tbaa !10
  %cmp71.not660 = icmp eq ptr %6, null
  br i1 %cmp71.not660, label %cleanup289, label %for.body

for.body:                                         ; preds = %while.body, %for.inc
  %line.0673 = phi ptr [ %call287, %for.inc ], [ %6, %while.body ]
  %no_links.2670 = phi i32 [ %no_links.3, %for.inc ], [ %no_links.1851, %while.body ]
  %fwdcnt.2668 = phi i32 [ %fwdcnt.3, %for.inc ], [ %fwdcnt.1850, %while.body ]
  %unresp.1666 = phi i32 [ %unresp.2, %for.inc ], [ %unresp.0849, %while.body ]
  %pul.2664 = phi ptr [ %pul.3, %for.inc ], [ %pul.1848, %while.body ]
  %cur_link.2663 = phi ptr [ %cur_link.3, %for.inc ], [ %cur_link.1847, %while.body ]
  %comp.5661 = phi ptr [ %comp.8, %for.inc ], [ %comp.4846, %while.body ]
  %7 = load i8, ptr %line.0673, align 1, !tbaa !5
...
sw.bb:                                            ; preds = %for.body
  %call74 = call i32 @strncmp(ptr noundef nonnull dereferenceable(1) %line.0673, ptr noundef nonnull dereferenceable(10) @.str.8, i64 noundef 9)
  %cmp75 = icmp eq i32 %call74, 0
  br i1 %cmp75, label %if.then77, label %if.end98

if.then77:                                        ; preds = %sw.bb
  %call78 = call ptr (ptr, ...) @parse_attribute(ptr noundef nonnull %line.0673) #7
  %tobool79.not = icmp eq ptr %call78, null
  br i1 %tobool79.not, label %for.inc, label %if.end81

if.end81:                                         ; preds = %if.then77
  %tobool82.not = icmp eq ptr %cur_link.2663, null
...
if.end84:                                         ; preds = %if.end81
  %lattrib = getelementptr inbounds %struct.vlink, ptr %cur_link.2663, i64 0, i32 17
...
if.end98:                                         ; preds = %sw.bb
  %call99 = call i32 @strncmp(ptr noundef nonnull dereferenceable(1) %line.0673, ptr noundef nonnull dereferenceable(5) @.str.9, i64 noundef 4)
...
if.end107:                                        ; preds = %if.end103
  %inc108 = add nsw i32 %no_links.2670, 1
  %tobool109.not = icmp eq i32 %no_links.2670, 0
...
land.lhs.true159:                                 ; preds = %land.lhs.true154
  ...
  %call161 = call i32 @wcmatch(ptr noundef %20, ptr noundef %comp.5661) #7
...
if.else171:                                       ; preds = %land.lhs.true154, %if.end164
  %call172 = call i32 @ul_insert(ptr noundef nonnull %call122, ptr noundef %dir, ptr noundef %pul.2664) #7
  %tobool173.not = icmp eq ptr %pul.2664, null
...
sw.bb182:                                         ; preds = %for.body
  %call183 = call i32 @strncmp(ptr noundef nonnull dereferenceable(1) %line.0673, ptr noundef nonnull dereferenceable(10) @.str.11, i64 noundef 9)
  %cmp184 = icmp eq i32 %call183, 0
  br i1 %cmp184, label %if.then186, label %if.end204

if.then186:                                       ; preds = %sw.bb182
  %dec = add nsw i32 %fwdcnt.2668, -1
  %cmp187 = icmp slt i32 %fwdcnt.2668, 1
...
if.end190:                                        ; preds = %if.then186
  %call195 = call i32 (ptr, ptr, ...) @__isoc99_sscanf(ptr noundef nonnull %line.0673, ptr noundef nonnull @.str.12, ptr noundef nonnull %l_htype, ptr noundef nonnull %l_host, ptr noundef nonnull %l_ntype, ptr noundef nonnull %l_fname, ptr noundef nonnull %l_version, ptr noundef nonnull %l_magic) #7
...
if.end204:                                        ; preds = %sw.bb182
  %call205 = call i32 @strncmp(ptr noundef nonnull dereferenceable(1) %line.0673, ptr noundef nonnull dereferenceable(7) @.str.13, i64 noundef 6)
  %cmp206.not = icmp eq i32 %call205, 0
  %tobool281.not = icmp eq i8 %7, 0
  %or.cond588 = or i1 %tobool281.not, %cmp206.not
  br i1 %or.cond588, label %for.inc, label %land.lhs.true282

sw.bb211:                                         ; preds = %for.body
  %call212 = call i32 @strncmp(ptr noundef nonnull dereferenceable(1) %line.0673, ptr noundef nonnull dereferenceable(11) @.str.14, i64 noundef 10)
...
if.end219:                                        ; preds = %if.then215
  %inc220 = add nsw i32 %no_links.2670, 1
  %tobool221.not = icmp eq i32 %no_links.2670, 0
...
sw.bb237:                                         ; preds = %for.body
  %call238 = call i32 @strncmp(ptr noundef nonnull dereferenceable(1) %line.0673, ptr noundef nonnull dereferenceable(11) @.str.15, i64 noundef 10)
  %cmp239.not = icmp eq i32 %call238, 0
  br i1 %cmp239.not, label %if.end242, label %sw.default

if.end242:                                        ; preds = %sw.bb237
  %call244 = call i32 (ptr, ptr, ...) @__isoc99_sscanf(ptr noundef nonnull %line.0673, ptr noundef nonnull @.str.16, ptr noundef nonnull %t_unresolved) #7
...
sw.bb274:                                         ; preds = %for.body
  %call275 = call i32 @strncmp(ptr noundef nonnull dereferenceable(1) %line.0673, ptr noundef nonnull dereferenceable(22) @.str.17, i64 noundef 21)
...
land.lhs.true282:                                 ; preds = %if.end204, %sw.default
  %call283 = call i32 @scan_error(ptr noundef nonnull %line.0673) #7
...
for.inc:                                          ; preds = %if.end248, %if.then254, %land.lhs.true174, %if.then83, %if.then77, %if.else93, %while.end, %if.then132, %if.then163, %if.then202, %if.then247, %if.end103, %if.else171, %if.then179, %if.then169, %if.end204, %for.body, %for.body, %if.then215, %if.end232, %if.end219, %land.lhs.true282, %sw.default
  %comp.8 = phi ptr [ %comp.5661, %land.lhs.true282 ], [ %comp.5661, %sw.default ], [ %comp.5661, %if.then247 ], [ %comp.5661, %if.then215 ], [ %comp.5661, %if.end219 ], [ %comp.5661, %if.end232 ], [ %comp.5661, %for.body ], [ %comp.5661, %for.body ], [ %comp.5661, %if.then202 ], [ %comp.5661, %if.end204 ], [ %comp.5661, %if.end103 ], [ %comp.5661, %if.then132 ], [ %comp.5661, %if.then169 ], [ %comp.5661, %if.then179 ], [ %comp.5661, %land.lhs.true174 ], [ %comp.5661, %if.else171 ], [ %comp.5661, %if.then163 ], [ %comp.5661, %while.end ], [ %comp.5661, %if.else93 ], [ %comp.5661, %if.then77 ], [ %comp.5661, %if.then83 ], [ %comp.6, %if.then254 ], [ %comp.5661, %if.end248 ]
  %cur_link.3 = phi ptr [ %cur_link.2663, %land.lhs.true282 ], [ %cur_link.2663, %sw.default ], [ %cur_link.2663, %if.then247 ], [ %cur_link.2663, %if.then215 ], [ %cur_link.2663, %if.end219 ], [ %cur_link.2663, %if.end232 ], [ %cur_link.2663, %for.body ], [ %cur_link.2663, %for.body ], [ %cur_link.2663, %if.then202 ], [ %cur_link.2663, %if.end204 ], [ %cur_link.2663, %if.end103 ], [ %call122, %if.then132 ], [ %call122, %if.then169 ], [ %call122, %if.then179 ], [ %call122, %land.lhs.true174 ], [ %call122, %if.else171 ], [ %call122, %if.then163 ], [ %cur_link.2663, %while.end ], [ %cur_link.2663, %if.else93 ], [ %cur_link.2663, %if.then77 ], [ null, %if.then83 ], [ %cur_link.2663, %if.then254 ], [ %cur_link.2663, %if.end248 ]
  %pul.3 = phi ptr [ %pul.2664, %land.lhs.true282 ], [ %pul.2664, %sw.default ], [ %pul.2664, %if.then247 ], [ %pul.2664, %if.then215 ], [ %pul.2664, %if.end219 ], [ %pul.2664, %if.end232 ], [ %pul.2664, %for.body ], [ %pul.2664, %for.body ], [ %pul.2664, %if.then202 ], [ %pul.2664, %if.end204 ], [ %pul.2664, %if.end103 ], [ %pul.2664, %if.then132 ], [ %pul.2664, %if.then169 ], [ %call122, %if.then179 ], [ %pul.2664, %land.lhs.true174 ], [ null, %if.else171 ], [ %pul.2664, %if.then163 ], [ %pul.2664, %while.end ], [ %pul.2664, %if.else93 ], [ %pul.2664, %if.then77 ], [ %pul.2664, %if.then83 ], [ %pul.2664, %if.then254 ], [ %pul.2664, %if.end248 ]
  %unresp.2 = phi i32 [ %unresp.1666, %land.lhs.true282 ], [ %unresp.1666, %sw.default ], [ %unresp.1666, %if.then247 ], [ %unresp.1666, %if.then215 ], [ %unresp.1666, %if.end219 ], [ %unresp.1666, %if.end232 ], [ %unresp.1666, %for.body ], [ %unresp.1666, %for.body ], [ %unresp.1666, %if.then202 ], [ %unresp.1666, %if.end204 ], [ %unresp.1666, %if.end103 ], [ %unresp.1666, %if.then132 ], [ %unresp.1666, %if.then169 ], [ %unresp.1666, %if.then179 ], [ %unresp.1666, %land.lhs.true174 ], [ %unresp.1666, %if.else171 ], [ %unresp.1666, %if.then163 ], [ %unresp.1666, %while.end ], [ %unresp.1666, %if.else93 ], [ %unresp.1666, %if.then77 ], [ %unresp.1666, %if.then83 ], [ 1, %if.then254 ], [ 1, %if.end248 ]
  %fwdcnt.3 = phi i32 [ %fwdcnt.2668, %land.lhs.true282 ], [ %fwdcnt.2668, %sw.default ], [ %fwdcnt.2668, %if.then247 ], [ %fwdcnt.2668, %if.then215 ], [ %fwdcnt.2668, %if.end219 ], [ %fwdcnt.2668, %if.end232 ], [ %fwdcnt.2668, %for.body ], [ %fwdcnt.2668, %for.body ], [ %dec, %if.then202 ], [ %fwdcnt.2668, %if.end204 ], [ %fwdcnt.2668, %if.end103 ], [ %fwdcnt.2668, %if.then132 ], [ %fwdcnt.2668, %if.then169 ], [ %fwdcnt.2668, %if.then179 ], [ %fwdcnt.2668, %land.lhs.true174 ], [ %fwdcnt.2668, %if.else171 ], [ %fwdcnt.2668, %if.then163 ], [ %fwdcnt.2668, %while.end ], [ %fwdcnt.2668, %if.else93 ], [ %fwdcnt.2668, %if.then77 ], [ %fwdcnt.2668, %if.then83 ], [ %fwdcnt.2668, %if.then254 ], [ %fwdcnt.2668, %if.end248 ]
  %no_links.3 = phi i32 [ %no_links.2670, %land.lhs.true282 ], [ %no_links.2670, %sw.default ], [ %no_links.2670, %if.then247 ], [ %no_links.2670, %if.then215 ], [ %inc220, %if.end219 ], [ 1, %if.end232 ], [ %no_links.2670, %for.body ], [ %no_links.2670, %for.body ], [ %no_links.2670, %if.then202 ], [ %no_links.2670, %if.end204 ], [ %no_links.2670, %if.end103 ], [ %inc108, %if.then132 ], [ %inc108, %if.then169 ], [ %inc108, %if.then179 ], [ %inc108, %land.lhs.true174 ], [ %inc108, %if.else171 ], [ %inc108, %if.then163 ], [ %no_links.2670, %while.end ], [ %no_links.2670, %if.else93 ], [ %no_links.2670, %if.then77 ], [ %no_links.2670, %if.then83 ], [ %no_links.2670, %if.then254 ], [ %no_links.2670, %if.end248 ]
  %call287 = call ptr (ptr, ...) @nxtline(ptr noundef nonnull %line.0673) #7
...
cleanup289:                                       ; preds = %for.inc, %while.body
  %comp.5.lcssa = phi ptr [ %comp.4846, %while.body ], [ %comp.8, %for.inc ]
  %cur_link.2.lcssa = phi ptr [ %cur_link.1847, %while.body ], [ %cur_link.3, %for.inc ]
  %pul.2.lcssa = phi ptr [ %pul.1848, %while.body ], [ %pul.3, %for.inc ]
  %unresp.1.lcssa = phi i32 [ %unresp.0849, %while.body ], [ %unresp.2, %for.inc ]
  %fwdcnt.2.lcssa = phi i32 [ %fwdcnt.1850, %while.body ], [ %fwdcnt.3, %for.inc ]
  %no_links.2.lcssa = phi i32 [ %no_links.1851, %while.body ], [ %no_links.3, %for.inc ]
  %next288 = getelementptr inbounds %struct.ptext, ptr %resp.0845, i64 0, i32 5
  %23 = load ptr, ptr %next288, align 8, !tbaa !34
  call void (ptr, ...) @ptfree(ptr noundef nonnull %resp.0845) #7
...
if.then325:                                       ; preds = %expand_ulinks
  %l.0683 = load ptr, ptr %ulinks228, align 8, !tbaa !35
  %tobool328.not684 = icmp eq ptr %l.0683, null
  br i1 %tobool328.not684, label %if.end358, label %land.lhs.true329

land.lhs.true329:                                 ; preds = %if.then325, %while.body336
  %l.0685 = phi ptr [ %l.0, %while.body336 ], [ %l.0683, %if.then325 ]
  %expanded330 = getelementptr inbounds %struct.vlink, ptr %l.0685, i64 0, i32 3
...
land.rhs:                                         ; preds = %land.lhs.true329
  %linktype332 = getelementptr inbounds %struct.vlink, ptr %l.0685, i64 0, i32 2
...
while.body336:                                    ; preds = %land.rhs
  %next337 = getelementptr inbounds %struct.vlink, ptr %l.0685, i64 0, i32 20
...
if.then340:                                       ; preds = %land.rhs, %land.lhs.true329
  %expanded330.le = getelementptr inbounds %struct.vlink, ptr %l.0685, i64 0, i32 3
  %type341 = getelementptr inbounds %struct.vlink, ptr %l.0685, i64 0, i32 4
...
if.then350:                                       ; preds = %lor.lhs.false345, %if.then340
  ...
  %host352 = getelementptr inbounds %struct.vlink, ptr %l.0685, i64 0, i32 8
  %28 = load ptr, ptr %host352, align 8, !tbaa !30
  %filename353 = getelementptr inbounds %struct.vlink, ptr %l.0685, i64 0, i32 10
...
if.then363:                                       ; preds = %land.lhs.true360
  ...
  %tobool366.not686 = icmp eq ptr %31, null
  br i1 %tobool366.not686, label %cleanup401, label %while.body367

while.body367:                                    ; preds = %if.then363, %if.end398
  %l.1687 = phi ptr [ %l.2, %if.end398 ], [ %31, %if.then363 ]
  %linktype368 = getelementptr inbounds %struct.vlink, ptr %l.1687, i64 0, i32 2
...
land.lhs.true372:                                 ; preds = %while.body367
  %name373 = getelementptr inbounds %struct.vlink, ptr %l.1687, i64 0, i32 1
...
if.then376:                                       ; preds = %land.lhs.true372
  ...
  %cmp378 = icmp eq ptr %l.1687, %34
  %next381 = getelementptr inbounds %struct.vlink, ptr %l.1687, i64 0, i32 20
...
if.else383:                                       ; preds = %if.then376
  %previous385 = getelementptr inbounds %struct.vlink, ptr %l.1687, i64 0, i32 19
...
if.then390:                                       ; preds = %if.end387
  %previous391 = getelementptr inbounds %struct.vlink, ptr %l.1687, i64 0, i32 19
...
if.end394:                                        ; preds = %if.then390, %if.end387
  call void (ptr, ...) @vlfree(ptr noundef nonnull %l.1687) #7
  br label %if.end398

if.else396:                                       ; preds = %land.lhs.true372, %while.body367
  %next397 = getelementptr inbounds %struct.vlink, ptr %l.1687, i64 0, i32 20
