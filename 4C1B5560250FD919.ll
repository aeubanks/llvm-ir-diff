...
define dso_local void @f0(i32 noundef %0, ptr nocapture noundef readonly byval(%struct.s0) align 16 %1) local_unnamed_addr #0 {
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(32) @g0, ptr noundef nonnull align 16 dereferenceable(32) %1, i64 32, i1 false), !tbaa.struct !5
  %3 = sitofp i32 %0 to x86_fp80
  %4 = load x86_fp80, ptr @g0, align 16, !tbaa !10
  %5 = fadd x86_fp80 %4, %3
  store x86_fp80 %5, ptr @g0, align 16, !tbaa !10
  %6 = load x86_fp80, ptr getelementptr inbounds (%struct.s0, ptr @g0, i64 0, i32 1), align 16, !tbaa !12
  %7 = fadd x86_fp80 %6, %3
  store x86_fp80 %7, ptr getelementptr inbounds (%struct.s0, ptr @g0, i64 0, i32 1), align 16, !tbaa !12
  ret void
}
...
define dso_local i32 @main() local_unnamed_addr #2 {
  ...
  %1 = load x86_fp80, ptr @g0, align 16, !tbaa !10
  %2 = fptrunc x86_fp80 %1 to double
  %3 = load x86_fp80, ptr getelementptr inbounds (%struct.s0, ptr @g0, i64 0, i32 1), align 16, !tbaa !12
