; ModuleID = '/usr/local/google/home/aeubanks/repos/test-suite/Bitcode/simd_ops/x86_tests/test_op_vpackuswb_385.bc'
...
@str.11 = private constant [17 x i8] c"op_vpackuswb_385\00", align 32
...
define i32 @__test_op(ptr noalias nocapture readnone %in_f32.buffer, ptr noalias nocapture readnone %in_f64.buffer, ptr noalias nocapture readnone %in_i8.buffer, ptr noalias nocapture readnone %in_u8.buffer, ptr noalias nocapture readonly %in_i16.buffer, ptr noalias nocapture readnone %in_u16.buffer, ptr noalias nocapture readnone %in_i32.buffer, ptr noalias nocapture readnone %in_u32.buffer, ptr noalias nocapture readnone %in_i64.buffer, ptr noalias nocapture readnone %in_u64.buffer, ptr noalias nocapture readonly %op_vpackuswb_385.buffer) local_unnamed_addr #1 {
"produce op_vpackuswb_385":
  %buf_extent168 = getelementptr inbounds %struct.buffer_t, ptr %op_vpackuswb_385.buffer, i64 0, i32 2, i64 1
  %op_vpackuswb_385.extent.1 = load i32, ptr %buf_extent168, align 4
  %buf_min176 = getelementptr inbounds %struct.buffer_t, ptr %op_vpackuswb_385.buffer, i64 0, i32 4, i64 1
  %op_vpackuswb_385.min.1 = load i32, ptr %buf_min176, align 4
  %0 = add nsw i32 %op_vpackuswb_385.min.1, %op_vpackuswb_385.extent.1
  %1 = icmp sgt i32 %op_vpackuswb_385.extent.1, 0
  br i1 %1, label %"for op_vpackuswb_385.s0.y.preheader", label %destructor_block, !prof !4

"for op_vpackuswb_385.s0.y.preheader":            ; preds = %"produce op_vpackuswb_385"
  ...
  %buf_min175 = getelementptr inbounds %struct.buffer_t, ptr %op_vpackuswb_385.buffer, i64 0, i32 4, i64 0
  %op_vpackuswb_385.min.0 = load i32, ptr %buf_min175, align 4
  %2 = sext i32 %op_vpackuswb_385.min.0 to i64
  %buf_stride172 = getelementptr inbounds %struct.buffer_t, ptr %op_vpackuswb_385.buffer, i64 0, i32 3, i64 1
  %op_vpackuswb_385.stride.1 = load i32, ptr %buf_stride172, align 4
  %3 = sext i32 %op_vpackuswb_385.stride.1 to i64
  %buf_host163 = getelementptr inbounds %struct.buffer_t, ptr %op_vpackuswb_385.buffer, i64 0, i32 1
  %op_vpackuswb_385.host = load ptr, ptr %buf_host163, align 8
  %4 = shl nsw i64 %2, 3
  %5 = sub nsw i64 224, %4
  %scevgep = getelementptr i8, ptr %op_vpackuswb_385.host, i64 %5
  %6 = shl nsw i64 %3, 3
  ...
  %11 = tail call <16 x i8> @llvm.x86.sse2.packuswb.128(<8 x i16> %9, <8 x i16> %10) #4
  ...
  %14 = tail call <16 x i8> @llvm.x86.sse2.packuswb.128(<8 x i16> %12, <8 x i16> %13) #4
  ...
  %29 = tail call <16 x i8> @llvm.x86.sse2.packuswb.128(<8 x i16> %27, <8 x i16> %28) #4
  ...
  %32 = tail call <16 x i8> @llvm.x86.sse2.packuswb.128(<8 x i16> %30, <8 x i16> %31) #4
  ...
  %47 = tail call <16 x i8> @llvm.x86.sse2.packuswb.128(<8 x i16> %45, <8 x i16> %46) #4
  ...
  %50 = tail call <16 x i8> @llvm.x86.sse2.packuswb.128(<8 x i16> %48, <8 x i16> %49) #4
  ...
  %65 = tail call <16 x i8> @llvm.x86.sse2.packuswb.128(<8 x i16> %63, <8 x i16> %64) #4
  ...
  %68 = tail call <16 x i8> @llvm.x86.sse2.packuswb.128(<8 x i16> %66, <8 x i16> %67) #4
  ...
  %83 = tail call <16 x i8> @llvm.x86.sse2.packuswb.128(<8 x i16> %81, <8 x i16> %82) #4
  ...
  %86 = tail call <16 x i8> @llvm.x86.sse2.packuswb.128(<8 x i16> %84, <8 x i16> %85) #4
  ...
  br label %"for op_vpackuswb_385.s0.x.x.preheader"

"for op_vpackuswb_385.s0.x.x.preheader":          ; preds = %"for op_vpackuswb_385.s0.x.x.preheader", %"for op_vpackuswb_385.s0.y.preheader"
  %lsr.iv180 = phi ptr [ %scevgep, %"for op_vpackuswb_385.s0.y.preheader" ], [ %scevgep182, %"for op_vpackuswb_385.s0.x.x.preheader" ]
  %op_vpackuswb_385.s0.y = phi i32 [ %op_vpackuswb_385.min.1, %"for op_vpackuswb_385.s0.y.preheader" ], [ %151, %"for op_vpackuswb_385.s0.x.x.preheader" ]
  ...
  %101 = tail call <16 x i8> @llvm.x86.sse2.packuswb.128(<8 x i16> %99, <8 x i16> %100) #4
  ...
  %104 = tail call <16 x i8> @llvm.x86.sse2.packuswb.128(<8 x i16> %102, <8 x i16> %103) #4
  ...
  %119 = tail call <16 x i8> @llvm.x86.sse2.packuswb.128(<8 x i16> %117, <8 x i16> %118) #4
  ...
  %122 = tail call <16 x i8> @llvm.x86.sse2.packuswb.128(<8 x i16> %120, <8 x i16> %121) #4
  ...
  %137 = tail call <16 x i8> @llvm.x86.sse2.packuswb.128(<8 x i16> %135, <8 x i16> %136) #4
  ...
  %140 = tail call <16 x i8> @llvm.x86.sse2.packuswb.128(<8 x i16> %138, <8 x i16> %139) #4
  ...
  %151 = add nsw i32 %op_vpackuswb_385.s0.y, 1
  %scevgep182 = getelementptr i1, ptr %lsr.iv180, i64 %6
  %.not2 = icmp eq i32 %151, %0
  br i1 %.not2, label %destructor_block, label %"for op_vpackuswb_385.s0.x.x.preheader"

destructor_block:                                 ; preds = %"for op_vpackuswb_385.s0.x.x.preheader", %"produce op_vpackuswb_385"
  ret i32 0
}

; Function Attrs: nofree nosync nounwind memory(readwrite, inaccessiblemem: none)
define i32 @test_op(ptr noalias nocapture readnone %in_f32.buffer, ptr noalias nocapture readnone %in_f64.buffer, ptr noalias nocapture readnone %in_i8.buffer, ptr noalias nocapture readnone %in_u8.buffer, ptr noalias nocapture readonly %in_i16.buffer, ptr noalias nocapture readnone %in_u16.buffer, ptr noalias nocapture readnone %in_i32.buffer, ptr noalias nocapture readnone %in_u32.buffer, ptr noalias nocapture readnone %in_i64.buffer, ptr noalias nocapture readnone %in_u64.buffer, ptr noalias nocapture readonly %op_vpackuswb_385.buffer) local_unnamed_addr #2 {
destructor_block:
  %"__test_op_result$24" = tail call i32 @__test_op(ptr poison, ptr poison, ptr poison, ptr poison, ptr %in_i16.buffer, ptr poison, ptr poison, ptr poison, ptr poison, ptr poison, ptr %op_vpackuswb_385.buffer) #4
  ret i32 0
}
