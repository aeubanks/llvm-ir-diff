...
while.body:                                       ; preds = %RecogIdentifier.exit, %if.else41
  %high.0599 = phi i32 [ 18, %RecogIdentifier.exit ], [ %high.1, %if.else41 ]
  %low.0598 = phi i32 [ 0, %RecogIdentifier.exit ], [ %low.1, %if.else41 ]
  %add = add nsw i32 %high.0599, %low.0598
  %div = sdiv i32 %add, 2
...
if.else41:                                        ; preds = %while.body
  ...
  %low.1 = select i1 %cmp42, i32 %low.0598, i32 %add45
  %high.1 = select i1 %cmp42, i32 %sub, i32 %high.0599
...
while.end:                                        ; preds = %if.else41
  tail call void (ptr, ptr, ...) @TreeCCError(ptr noundef nonnull %input, ptr noundef nonnull @.str.1, ptr noundef nonnull %buffer) #9
...
if.end20:                                         ; preds = %if.then11, %if.end4.i, %if.else12
  %currlen.1 = phi i32 [ %currlen.057, %if.then11 ], [ %add.i, %if.end4.i ], [ %currlen.057, %if.else12 ]
  %len.1 = phi i32 [ %len.058, %if.then11 ], [ 0, %if.end4.i ], [ %inc, %if.else12 ]
...
if.end25:                                         ; preds = %if.end4.i, %if.then16
  %len.1 = phi i32 [ 0, %if.end4.i ], [ %inc18, %if.then16 ]
  %currlen.1 = phi i32 [ %add.i, %if.end4.i ], [ %currlen.0.ph, %if.then16 ]
  %2 = load ptr, ptr %stream, align 8, !tbaa !14
...
if.end44:                                         ; preds = %if.end4.i486, %if.then34
  %len.3 = phi i32 [ 0, %if.end4.i486 ], [ %inc37, %if.then34 ]
  %currlen.3 = phi i32 [ %add.i472, %if.end4.i486 ], [ %currlen.2712, %if.then34 ]
  %5 = load ptr, ptr %stream, align 8, !tbaa !14
...
if.end70:                                         ; preds = %if.end4.i505, %if.end60
  %len.5 = phi i32 [ 0, %if.end4.i505 ], [ %inc63, %if.end60 ]
  %currlen.5 = phi i32 [ %add.i491, %if.end4.i505 ], [ %currlen.4, %if.end60 ]
  %8 = load ptr, ptr %stream, align 8, !tbaa !14
...
if.end94:                                         ; preds = %if.end4.i524, %if.then85
  %len.7 = phi i32 [ 0, %if.end4.i524 ], [ %inc87, %if.then85 ]
  %currlen.7 = phi i32 [ %add.i510, %if.end4.i524 ], [ %currlen.0.ph, %if.then85 ]
...
while.cond114.preheader:                          ; preds = %if.end4.i543, %if.then104
  %len.9.ph = phi i32 [ %inc106, %if.then104 ], [ 0, %if.end4.i543 ]
  %currlen.9.ph = phi i32 [ %currlen.7, %if.then104 ], [ %add.i529, %if.end4.i543 ]
...
for.cond162.preheader:                            ; preds = %if.end4.i581, %if.then152
  %len.12.ph = phi i32 [ %inc154, %if.then152 ], [ 0, %if.end4.i581 ]
  %currlen.12.ph = phi i32 [ %currlen.7, %if.then152 ], [ %add.i567, %if.end4.i581 ]
...
if.end181:                                        ; preds = %if.end4.i600, %if.then172
  %len.13 = phi i32 [ 0, %if.end4.i600 ], [ %inc174, %if.then172 ]
  %currlen.13 = phi i32 [ %add.i586, %if.end4.i600 ], [ %currlen.12.ph831, %if.then172 ]
