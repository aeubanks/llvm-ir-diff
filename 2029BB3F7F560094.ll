...
entry:
  ...
  store i8 %0, ptr %dest, align 1, !tbaa !5
  %invariant.gep717 = getelementptr i8, ptr %source, i64 -1
  %idx.ext.i = zext i32 %ssize to i64
  %gep718 = getelementptr i8, ptr %invariant.gep717, i64 %idx.ext.i
...
if.then.i:                                        ; preds = %while.cond
  %cmp.i = icmp uge ptr %csrc.0, %source
  %cmp5.not.i = icmp ult ptr %csrc.0, %gep718
  %or.cond.i = and i1 %cmp.i, %cmp5.not.i
  br i1 %or.cond.i, label %if.end.i, label %cleanup
...
if.then.i439:                                     ; preds = %if.end
  ...
  %cmp5.not.i437 = icmp ult ptr %csrc.1, %gep718
...
if.then.i458:                                     ; preds = %if.end8
  ...
  %cmp5.not.i456 = icmp ult ptr %csrc.3, %gep718
...
while.body17:                                     ; preds = %doubledl.exit468, %doubledl.exit487
  %myeax_backbytes.0716 = phi i32 [ %add, %doubledl.exit487 ], [ 16, %doubledl.exit468 ]
  %csrc.7715 = phi ptr [ %csrc.8, %doubledl.exit487 ], [ %csrc.5, %doubledl.exit468 ]
  %mydl.4714 = phi i8 [ %mydl.0.i482, %doubledl.exit487 ], [ %mydl.0.i463, %doubledl.exit468 ]
  %mul.i469 = shl i8 %mydl.4714, 1
  %7 = and i8 %mydl.4714, 127
...
if.then.i477:                                     ; preds = %while.body17
  %cmp.i471 = icmp uge ptr %csrc.7715, %source
  %cmp5.not.i475 = icmp ult ptr %csrc.7715, %gep718
...
if.end.i481:                                      ; preds = %if.then.i477
  %8 = load i8, ptr %csrc.7715, align 1, !tbaa !5
  %mul9.i478 = shl i8 %8, 1
  %add.i479 = or i8 %mul9.i478, 1
  %add.ptr11.i480 = getelementptr inbounds i8, ptr %csrc.7715, i64 1
  br label %doubledl.exit487

doubledl.exit487:                                 ; preds = %while.body17, %if.end.i481
  %csrc.8 = phi ptr [ %add.ptr11.i480, %if.end.i481 ], [ %csrc.7715, %while.body17 ]
  %mydl.0.i482 = phi i8 [ %add.i479, %if.end.i481 ], [ %mul.i469, %while.body17 ]
  %olddl.0.i483 = phi i8 [ %8, %if.end.i481 ], [ %mydl.4714, %while.body17 ]
  %9 = lshr i8 %olddl.0.i483, 7
  %shr.i484 = zext i8 %9 to i32
  %mul = shl nuw nsw i32 %myeax_backbytes.0716, 1
...
if.then.i496:                                     ; preds = %do.body
  ...
  %cmp5.not.i494 = icmp ult ptr %csrc.10, %gep718
...
if.then.i515:                                     ; preds = %doubledl.exit506
  ...
  %cmp5.not.i513 = icmp ult ptr %csrc.11, %gep718
...
if.then.i534:                                     ; preds = %do.body61
  ...
  %cmp5.not.i532 = icmp ult ptr %csrc.15, %gep718
...
if.then.i553:                                     ; preds = %doubledl.exit544
  ...
  %cmp5.not.i551 = icmp ult ptr %csrc.16, %gep718
...
if.then.i572:                                     ; preds = %do.body88
  ...
  %cmp5.not.i570 = icmp ult ptr %csrc.20, %gep718
...
if.then.i591:                                     ; preds = %doubledl.exit582
  ...
  %cmp5.not.i589 = icmp ult ptr %csrc.21, %gep718
...
if.end120:                                        ; preds = %while.end, %doubledl.exit563, %do.end103, %if.end41
  ...
  %or.cond.not738 = select i1 %cmp121, i1 true, i1 %cmp123
  %cmp126.not = icmp ugt i32 %myecx_backsize.7, %dsize
  %or.cond624 = select i1 %or.cond.not738, i1 true, i1 %cmp126.not
  %cmp129.not = icmp ult ptr %cdst.0, %dest
  %or.cond625 = select i1 %or.cond624, i1 true, i1 %cmp129.not
  br i1 %or.cond625, label %if.then174, label %land.lhs.true131
...
land.lhs.true131:                                 ; preds = %if.end120
  ...
  br i1 %or.cond626, label %land.lhs.true151, label %if.then174
...
land.lhs.true151:                                 ; preds = %land.lhs.true131
  ...
  br i1 %cmp154.not, label %if.then174, label %land.lhs.true156
...
land.lhs.true156:                                 ; preds = %land.lhs.true151
  ...
  br i1 %or.cond627, label %while.body237.preheader, label %if.then174
...
while.body237.preheader:                          ; preds = %land.lhs.true156
  ...
  br i1 %or.cond, label %while.body237.preheader850, label %vector.ph

vector.ph:                                        ; preds = %while.body237.preheader
  %n.vec = and i64 %idx.ext132, 4294967264
  %ind.end = getelementptr i8, ptr %cdst.0, i64 %n.vec
  %.cast = trunc i64 %n.vec to i32
  %ind.end846 = sub i32 %myecx_backsize.7, %.cast
  br label %vector.body
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load849 = load <16 x i8>, ptr %28, align 1, !tbaa !5
  store <16 x i8> %wide.load, ptr %next.gep, align 1, !tbaa !5
  %29 = getelementptr i8, ptr %next.gep, i64 16
  store <16 x i8> %wide.load849, ptr %29, align 1, !tbaa !5
  %index.next = add nuw i64 %index, 32
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %while.cond.outer.outer.backedge, label %while.body237.preheader850
...
while.body237.preheader850:                       ; preds = %while.body237.preheader, %middle.block
  %cdst.1737.ph = phi ptr [ %cdst.0, %while.body237.preheader ], [ %ind.end, %middle.block ]
  %myecx_backsize.8736.ph = phi i32 [ %myecx_backsize.7, %while.body237.preheader ], [ %ind.end846, %middle.block ]
  %31 = add i32 %myecx_backsize.8736.ph, -1
  %xtraiter = and i32 %myecx_backsize.8736.ph, 7
  %lcmp.mod.not = icmp eq i32 %xtraiter, 0
  br i1 %lcmp.mod.not, label %while.body237.prol.loopexit, label %while.body237.prol

while.body237.prol:                               ; preds = %while.body237.preheader850, %while.body237.prol
  %cdst.1737.prol = phi ptr [ %incdec.ptr241.prol, %while.body237.prol ], [ %cdst.1737.ph, %while.body237.preheader850 ]
  %myecx_backsize.8736.prol = phi i32 [ %dec.prol, %while.body237.prol ], [ %myecx_backsize.8736.ph, %while.body237.preheader850 ]
  %prol.iter = phi i32 [ %prol.iter.next, %while.body237.prol ], [ 0, %while.body237.preheader850 ]
  %dec.prol = add i32 %myecx_backsize.8736.prol, -1
  %add.ptr240.prol = getelementptr inbounds i8, ptr %cdst.1737.prol, i64 %idx.neg
  %32 = load i8, ptr %add.ptr240.prol, align 1, !tbaa !5
  store i8 %32, ptr %cdst.1737.prol, align 1, !tbaa !5
  %incdec.ptr241.prol = getelementptr inbounds i8, ptr %cdst.1737.prol, i64 1
  %prol.iter.next = add i32 %prol.iter, 1
  %prol.iter.cmp.not = icmp eq i32 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %while.body237.prol.loopexit, label %while.body237.prol, !llvm.loop !20

while.body237.prol.loopexit:                      ; preds = %while.body237.prol, %while.body237.preheader850
  %incdec.ptr241.lcssa.unr = phi ptr [ undef, %while.body237.preheader850 ], [ %incdec.ptr241.prol, %while.body237.prol ]
  %cdst.1737.unr = phi ptr [ %cdst.1737.ph, %while.body237.preheader850 ], [ %incdec.ptr241.prol, %while.body237.prol ]
  %myecx_backsize.8736.unr = phi i32 [ %myecx_backsize.8736.ph, %while.body237.preheader850 ], [ %dec.prol, %while.body237.prol ]
  %33 = icmp ult i32 %31, 7
  br i1 %33, label %while.cond.outer.outer.backedge, label %while.body237

if.then174:                                       ; preds = %land.lhs.true156, %land.lhs.true151, %land.lhs.true131, %if.end120
  %or.cond.not738.lcssa = phi i1 [ false, %land.lhs.true156 ], [ false, %land.lhs.true151 ], [ false, %land.lhs.true131 ], [ %or.cond.not738, %if.end120 ]
  %or.cond629 = select i1 %or.cond.not738.lcssa, i1 true, i1 %cmp126.not
  %or.cond630 = select i1 %or.cond629, i1 true, i1 %cmp129.not
  br i1 %or.cond630, label %land.end, label %land.lhs.true186

land.lhs.true186:                                 ; preds = %if.then174
  %idx.ext187 = zext i32 %myecx_backsize.7 to i64
  %add.ptr188 = getelementptr inbounds i8, ptr %cdst.0, i64 %idx.ext187
  %cmp191.not = icmp ugt ptr %add.ptr188, %add.ptr135
  br i1 %cmp191.not, label %land.end, label %land.rhs

land.rhs:                                         ; preds = %land.lhs.true186
  %cmp195 = icmp ugt ptr %add.ptr188, %dest
  %34 = zext i1 %cmp195 to i32
  br label %land.end

land.end:                                         ; preds = %land.rhs, %land.lhs.true186, %if.then174
  %land.ext = phi i32 [ 0, %land.lhs.true186 ], [ 0, %if.then174 ], [ %34, %land.rhs ]
  ...
  %or.cond633 = select i1 %or.cond629, i1 true, i1 %cmp212.not
...
land.rhs224:                                      ; preds = %land.lhs.true214
  ...
  %35 = zext i1 %cmp230 to i32
  br label %land.end232

land.end232:                                      ; preds = %land.rhs224, %land.lhs.true214, %land.end
  %land.ext233 = phi i32 [ 0, %land.lhs.true214 ], [ 0, %land.end ], [ %35, %land.rhs224 ]
...
while.body237:                                    ; preds = %while.body237.prol.loopexit, %while.body237
  %cdst.1737 = phi ptr [ %incdec.ptr241.7, %while.body237 ], [ %cdst.1737.unr, %while.body237.prol.loopexit ]
  %myecx_backsize.8736 = phi i32 [ %dec.7, %while.body237 ], [ %myecx_backsize.8736.unr, %while.body237.prol.loopexit ]
  %add.ptr240 = getelementptr inbounds i8, ptr %cdst.1737, i64 %idx.neg
  %36 = load i8, ptr %add.ptr240, align 1, !tbaa !5
  store i8 %36, ptr %cdst.1737, align 1, !tbaa !5
  %incdec.ptr241 = getelementptr inbounds i8, ptr %cdst.1737, i64 1
  %add.ptr240.1 = getelementptr inbounds i8, ptr %incdec.ptr241, i64 %idx.neg
  %37 = load i8, ptr %add.ptr240.1, align 1, !tbaa !5
  store i8 %37, ptr %incdec.ptr241, align 1, !tbaa !5
  %incdec.ptr241.1 = getelementptr inbounds i8, ptr %cdst.1737, i64 2
  %add.ptr240.2 = getelementptr inbounds i8, ptr %incdec.ptr241.1, i64 %idx.neg
  %38 = load i8, ptr %add.ptr240.2, align 1, !tbaa !5
  store i8 %38, ptr %incdec.ptr241.1, align 1, !tbaa !5
  %incdec.ptr241.2 = getelementptr inbounds i8, ptr %cdst.1737, i64 3
  %add.ptr240.3 = getelementptr inbounds i8, ptr %incdec.ptr241.2, i64 %idx.neg
  %39 = load i8, ptr %add.ptr240.3, align 1, !tbaa !5
  store i8 %39, ptr %incdec.ptr241.2, align 1, !tbaa !5
  %incdec.ptr241.3 = getelementptr inbounds i8, ptr %cdst.1737, i64 4
  %add.ptr240.4 = getelementptr inbounds i8, ptr %incdec.ptr241.3, i64 %idx.neg
  %40 = load i8, ptr %add.ptr240.4, align 1, !tbaa !5
  store i8 %40, ptr %incdec.ptr241.3, align 1, !tbaa !5
  %incdec.ptr241.4 = getelementptr inbounds i8, ptr %cdst.1737, i64 5
  %add.ptr240.5 = getelementptr inbounds i8, ptr %incdec.ptr241.4, i64 %idx.neg
  %41 = load i8, ptr %add.ptr240.5, align 1, !tbaa !5
  store i8 %41, ptr %incdec.ptr241.4, align 1, !tbaa !5
  %incdec.ptr241.5 = getelementptr inbounds i8, ptr %cdst.1737, i64 6
  %add.ptr240.6 = getelementptr inbounds i8, ptr %incdec.ptr241.5, i64 %idx.neg
  %42 = load i8, ptr %add.ptr240.6, align 1, !tbaa !5
  store i8 %42, ptr %incdec.ptr241.5, align 1, !tbaa !5
  %incdec.ptr241.6 = getelementptr inbounds i8, ptr %cdst.1737, i64 7
  %dec.7 = add i32 %myecx_backsize.8736, -8
  %add.ptr240.7 = getelementptr inbounds i8, ptr %incdec.ptr241.6, i64 %idx.neg
  %43 = load i8, ptr %add.ptr240.7, align 1, !tbaa !5
  store i8 %43, ptr %incdec.ptr241.6, align 1, !tbaa !5
  %incdec.ptr241.7 = getelementptr inbounds i8, ptr %cdst.1737, i64 8
...
if.else243:                                       ; preds = %doubledl.exit
  ...
  %or.cond634.not739.not = select i1 %cmp244, i1 %cmp249.not, i1 false
  %cmp252 = icmp uge ptr %csrc.1, %source
  %or.cond635 = select i1 %or.cond634.not739.not, i1 %cmp252, i1 false
...
if.end264:                                        ; preds = %if.else243
  ...
  %44 = load i8, ptr %csrc.1, align 1, !tbaa !5
  %incdec.ptr266 = getelementptr inbounds i8, ptr %cdst.0, i64 1
  store i8 %44, ptr %cdst.0, align 1, !tbaa !5
  br label %while.cond.outer
