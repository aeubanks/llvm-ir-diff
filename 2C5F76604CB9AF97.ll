...
_ZNSt16allocator_traitsISaIjEE8allocateERS0_m.exit.i.i.i: ; preds = %while.body.i531
  %call5.i.i.i.i.i534 = invoke noalias noundef nonnull dereferenceable(4) ptr @_Znwm(i64 noundef 4) #28
          to label %_ZNSt12_Vector_baseIjSaIjEE11_M_allocateEm.exit.i.i unwind label %ehcleanup343.thread
...
_ZNSt16allocator_traitsISaIjEE8allocateERS0_m.exit.i.i.i572: ; preds = %while.body.i549
  %call5.i.i.i.i.i586 = invoke noalias noundef nonnull dereferenceable(8) ptr @_Znwm(i64 noundef 8) #28
          to label %_ZNSt6vectorIjSaIjEE9push_backERKj.exit587 unwind label %ehcleanup343.thread1478
...
ehcleanup343.thread1478:                          ; preds = %_ZNSt16allocator_traitsISaIjEE8allocateERS0_m.exit.i.i.i572
...
while.body.i655:                                  ; preds = %for.body50, %while.body.i655
  ...
  br i1 %cmp.not.i654.3, label %if.then.i661, label %while.body.i655, !llvm.loop !82

if.then.i661:                                     ; preds = %while.body.i655
...
_ZNSt16allocator_traitsISaIjEE8allocateERS0_m.exit.i.i.i731: ; preds = %while.body.i708
  %call5.i.i.i.i.i745 = invoke noalias noundef nonnull dereferenceable(32) ptr @_Znwm(i64 noundef 32) #28
          to label %_ZNSt12_Vector_baseIjSaIjEE11_M_allocateEm.exit.i.i735 unwind label %lpad75
...
_ZNSt12_Vector_baseIjSaIjEE11_M_allocateEm.exit.i.i735: ; preds = %_ZNSt16allocator_traitsISaIjEE8allocateERS0_m.exit.i.i.i731
  ...
  call void @llvm.memmove.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %call5.i.i.i.i.i745, ptr noundef nonnull align 4 dereferenceable(16) %call5.i.i.i.i.i639, i64 16, i1 false)
...
for.body69:                                       ; preds = %if.then.i661, %for.body69
  %i65.01488 = phi i32 [ 0, %if.then.i661 ], [ %inc71, %for.body69 ]
  call void @_Z9example4aiPiS_(i32 noundef 1024, ptr noundef nonnull @ia, ptr noundef nonnull @ib)
...
lpad75:                                           ; preds = %_ZNSt16allocator_traitsISaIjEE8allocateERS0_m.exit.i.i.i731
...
ehcleanup343:                                     ; preds = %lpad330, %lpad307, %lpad302, %lpad283, %lpad265, %lpad246, %lpad227, %lpad208, %lpad189, %lpad169, %lpad151, %lpad75
  %results.sroa.0.17 = phi ptr [ %call5.i.i.i.i.i639, %lpad75 ], [ %call5.i.i.i.i.i745, %lpad151 ], [ %cond.i31.i.i944, %lpad169 ], [ %results.sroa.0.9, %lpad189 ], [ %results.sroa.0.10, %lpad208 ], [ %results.sroa.0.11, %lpad227 ], [ %results.sroa.0.12, %lpad246 ], [ %results.sroa.0.13, %lpad265 ], [ %results.sroa.0.14, %lpad283 ], [ %results.sroa.0.15, %lpad302 ], [ %results.sroa.0.16, %lpad330 ], [ %results.sroa.0.16, %lpad307 ]
  %.pn = phi { ptr, i32 } [ %81, %lpad75 ], [ %95, %lpad151 ], [ %104, %lpad169 ], [ %109, %lpad189 ], [ %114, %lpad208 ], [ %119, %lpad227 ], [ %124, %lpad246 ], [ %125, %lpad265 ], [ %130, %lpad283 ], [ %144, %lpad302 ], [ %147, %lpad330 ], [ %145, %lpad307 ]
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %dummy) #27
...
if.then.i.i.i1399:                                ; preds = %lpad37, %ehcleanup343.thread1478, %ehcleanup343
  %.pn1483 = phi { ptr, i32 } [ %66, %ehcleanup343.thread1478 ], [ %.pn, %ehcleanup343 ], [ %72, %lpad37 ]
  %results.sroa.0.171482 = phi ptr [ %call5.i.i.i.i.i534, %ehcleanup343.thread1478 ], [ %results.sroa.0.17, %ehcleanup343 ], [ %call5.i.i.i.i.i586, %lpad37 ]
  call void @_ZdlPv(ptr noundef nonnull %results.sroa.0.171482) #29
  br label %_ZNSt6vectorIjSaIjEED2Ev.exit1400

_ZNSt6vectorIjSaIjEED2Ev.exit1400:                ; preds = %ehcleanup343.thread, %ehcleanup343, %if.then.i.i.i1399
  %.pn1477 = phi { ptr, i32 } [ %61, %ehcleanup343.thread ], [ %.pn, %ehcleanup343 ], [ %.pn1483, %if.then.i.i.i1399 ]
