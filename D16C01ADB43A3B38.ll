...
define dso_local double @normalize(double noundef %0) local_unnamed_addr #0 {
...
define dso_local i32 @main() local_unnamed_addr #1 {
  ...
  call void @llvm.lifetime.start.p0(i64 9, ptr nonnull %1) #6
  %2 = call i32 (ptr, ptr, ...) @sprintf(ptr noundef nonnull dereferenceable(1) %1, ptr noundef nonnull dereferenceable(1) @.str, double noundef 0.000000e+00) #6
  %3 = call i32 @bcmp(ptr noundef nonnull dereferenceable(2) %1, ptr noundef nonnull dereferenceable(2) @.str.1, i64 2)
  %4 = icmp eq i32 %3, 0
