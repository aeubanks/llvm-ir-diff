...
"for kernel_fft1_S4_R4_n1.s1.r86$y":              ; preds = %"for kernel_exchange_S1_R4_n1.s1.r80$y.preheader", %"for kernel_fft1_S4_R4_n1.s1.r86$y"
  %indvars.iv1093 = phi i64 [ 0, %"for kernel_exchange_S1_R4_n1.s1.r80$y.preheader" ], [ %indvars.iv.next1094, %"for kernel_fft1_S4_R4_n1.s1.r86$y" ]
  ...
  %456 = getelementptr inbounds float, ptr %f1.020, i64 %indvars.iv1093
  ...
  %463 = getelementptr inbounds float, ptr %f1.119, i64 %indvars.iv1093
...
"for kernel_unzipped.s0.n1.preheader":            ; preds = %"for kernel_fft1_S4_R4_n1.s1.r86$y"
  ...
  %"inv_X4$2.08.sroa.58.32.vec.extract" = shufflevector <8 x float> %702, <8 x float> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %717 = fmul <4 x float> %"inv_X4$2.08.sroa.58.32.vec.extract", <float 5.000000e-01, float 0x3FD6A09E60000000, float 0xBE5777A5C0000000, float 0xBFD6A09E60000000>
  %v_inv_fft1_S4_R4_n1.19.sroa.76.32.vec.extract = shufflevector <8 x float> %706, <8 x float> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %718 = fmul <4 x float> %v_inv_fft1_S4_R4_n1.19.sroa.76.32.vec.extract, <float 0.000000e+00, float 0xBFD6A09E60000000, float -5.000000e-01, float 0xBFD6A09E60000000>
  %719 = fsub <4 x float> %717, %718
  store <4 x float> %719, ptr %322, align 32, !tbaa !220
  %720 = fmul <4 x float> %"inv_X4$2.08.sroa.58.32.vec.extract", <float 0.000000e+00, float 0xBFD6A09E60000000, float -5.000000e-01, float 0xBFD6A09E60000000>
  %721 = fmul <4 x float> %v_inv_fft1_S4_R4_n1.19.sroa.76.32.vec.extract, <float 5.000000e-01, float 0x3FD6A09E60000000, float 0xBE5777A5C0000000, float 0xBFD6A09E60000000>
  %722 = fadd <4 x float> %720, %721
  store <4 x float> %722, ptr %323, align 32, !tbaa !223
  %"inv_X4$2.08.sroa.58.48.vec.extract" = shufflevector <8 x float> %702, <8 x float> poison, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
  %723 = fmul <4 x float> %"inv_X4$2.08.sroa.58.48.vec.extract", <float 5.000000e-01, float 0x3FC87DE2A0000000, float 0xBFD6A09E60000000, float 0xBFDD906BC0000000>
  %v_inv_fft1_S4_R4_n1.19.sroa.76.48.vec.extract = shufflevector <8 x float> %706, <8 x float> poison, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
  %724 = fmul <4 x float> %v_inv_fft1_S4_R4_n1.19.sroa.76.48.vec.extract, <float 0.000000e+00, float 0xBFDD906BC0000000, float 0xBFD6A09E60000000, float 0x3FC87DE2A0000000>
  ...
  %727 = fmul <4 x float> %"inv_X4$2.08.sroa.58.48.vec.extract", <float 0.000000e+00, float 0xBFDD906BC0000000, float 0xBFD6A09E60000000, float 0x3FC87DE2A0000000>
  %728 = fmul <4 x float> %v_inv_fft1_S4_R4_n1.19.sroa.76.48.vec.extract, <float 5.000000e-01, float 0x3FC87DE2A0000000, float 0xBFD6A09E60000000, float 0xBFDD906BC0000000>
...
"for kernel_fft0_S4_R4_n0.s1.n1":                 ; preds = %"for kernel_unzipped.s0.n1.preheader", %"for kernel_fft0_S4_R4_n0.s1.n1"
  %indvars.iv1100 = phi i64 [ 1, %"for kernel_unzipped.s0.n1.preheader" ], [ %indvars.iv.next1101, %"for kernel_fft0_S4_R4_n0.s1.n1" ]
  ...
  %"inv_X4$2.17.sroa.0.0.vec.extract630" = shufflevector <16 x float> %800, <16 x float> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %805 = fmul <4 x float> %"inv_X4$2.17.sroa.0.0.vec.extract630", <float 5.000000e-01, float 5.000000e-01, float 5.000000e-01, float 5.000000e-01>
  ...
  %"inv_X4$2.17.sroa.0.16.vec.extract656" = shufflevector <16 x float> %800, <16 x float> undef, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
  %810 = fmul <4 x float> %"inv_X4$2.17.sroa.0.16.vec.extract656", <float 0.000000e+00, float 0xBFC87DE2C0000000, float 0xBFD6A09E60000000, float 0xBFDD906BC0000000>
  ...
  %813 = fmul <4 x float> %"inv_X4$2.17.sroa.0.16.vec.extract656", <float 5.000000e-01, float 0x3FDD906BC0000000, float 0x3FD6A09E60000000, float 0x3FC87DE2A0000000>
  ...
  %"inv_X4$2.17.sroa.47.32.vec.extract693" = shufflevector <8 x float> %801, <8 x float> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %818 = fmul <4 x float> %"inv_X4$2.17.sroa.47.32.vec.extract693", <float 0.000000e+00, float 0xBFD6A09E60000000, float -5.000000e-01, float 0xBFD6A09E60000000>
  ...
  %821 = fmul <4 x float> %"inv_X4$2.17.sroa.47.32.vec.extract693", <float 5.000000e-01, float 0x3FD6A09E60000000, float 0xBE5777A5C0000000, float 0xBFD6A09E60000000>
  ...
  %"inv_X4$2.17.sroa.47.48.vec.extract715" = shufflevector <8 x float> %801, <8 x float> poison, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
  %827 = fmul <4 x float> %"inv_X4$2.17.sroa.47.48.vec.extract715", <float 0.000000e+00, float 0xBFDD906BC0000000, float 0xBFD6A09E60000000, float 0x3FC87DE2A0000000>
  ...
  %830 = fmul <4 x float> %"inv_X4$2.17.sroa.47.48.vec.extract715", <float 5.000000e-01, float 0x3FC87DE2A0000000, float 0xBFD6A09E60000000, float 0xBFDD906BC0000000>
...
"for result.s0.i.preheader":                      ; preds = %"end for kernel_fft0_S4_R4_n0.s1.n1"
  ...
  %t1756 = add nsw i32 %883, %884
  %885 = sext i32 %t1756 to i64
  %886 = getelementptr inbounds float, ptr %inv_zipped.115, i64 4
  %887 = getelementptr inbounds float, ptr %inv_zipped.115, i64 12
  %888 = getelementptr inbounds float, ptr %"inv_X4$3.011", i64 20
  %889 = getelementptr inbounds float, ptr %"inv_X4$3.110", i64 20
  %890 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.116, i64 1
  %891 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.012, i64 129
  %892 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.012, i64 1
  %893 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.116, i64 129
  ...
  %900 = and i1 %899, %898
  %901 = getelementptr inbounds float, ptr %kernel_fft0_S4_R4_n0.117, i64 132
  %902 = getelementptr inbounds float, ptr %kernel_fft0_S4_R4_n0.018, i64 132
  %903 = getelementptr inbounds float, ptr %kernel_fft0_S4_R4_n0.117, i64 140
  %904 = getelementptr inbounds float, ptr %kernel_fft0_S4_R4_n0.018, i64 140
  %905 = getelementptr inbounds float, ptr %inv_zipped.06, i64 4
  %906 = getelementptr inbounds float, ptr %inv_zipped.06, i64 8
  %907 = getelementptr inbounds float, ptr %inv_zipped.06, i64 12
  %908 = getelementptr inbounds float, ptr %inv_zipped.06, i64 16
  %909 = getelementptr inbounds float, ptr %inv_zipped.06, i64 64
  %910 = icmp sgt i32 %70, 0
  %a11 = lshr i32 %64, 3
  %.not917 = icmp ult i32 %64, 8
  %911 = add nsw i32 %64, 7
  %912 = ashr i32 %911, 3
  %913 = icmp slt i32 %a11, %912
  ...
  %935 = getelementptr inbounds float, ptr %inv_zipped.06, i64 24
  %936 = getelementptr inbounds float, ptr %inv_zipped.06, i64 32
  %937 = getelementptr inbounds float, ptr %inv_zipped.06, i64 40
  %938 = getelementptr inbounds float, ptr %inv_zipped.06, i64 48
  %939 = getelementptr inbounds float, ptr %inv_zipped.06, i64 56
  %940 = getelementptr inbounds float, ptr %inv_zipped.06, i64 72
  %941 = getelementptr inbounds float, ptr %inv_zipped.06, i64 80
  %942 = getelementptr inbounds float, ptr %inv_zipped.06, i64 88
  %943 = getelementptr inbounds float, ptr %inv_zipped.06, i64 96
  %944 = getelementptr inbounds float, ptr %inv_zipped.06, i64 104
  %945 = getelementptr inbounds float, ptr %inv_zipped.06, i64 112
  %946 = getelementptr inbounds float, ptr %inv_zipped.06, i64 120
  %947 = getelementptr inbounds float, ptr %inv_zipped.06, i64 128
  %948 = getelementptr inbounds float, ptr %inv_zipped.06, i64 136
  %949 = getelementptr inbounds float, ptr %inv_unzipped4, i64 8
  %950 = getelementptr inbounds float, ptr %inv_unzipped4, i64 16
  %951 = getelementptr inbounds float, ptr %inv_unzipped4, i64 24
  %952 = getelementptr inbounds float, ptr %inv_unzipped4, i64 32
  %953 = getelementptr inbounds float, ptr %inv_unzipped4, i64 40
  %954 = getelementptr inbounds float, ptr %inv_unzipped4, i64 48
  %955 = getelementptr inbounds float, ptr %inv_unzipped4, i64 56
  %956 = getelementptr inbounds float, ptr %inv_unzipped4, i64 64
  %957 = getelementptr inbounds float, ptr %inv_unzipped4, i64 72
  %958 = getelementptr inbounds float, ptr %inv_unzipped4, i64 80
  %959 = getelementptr inbounds float, ptr %inv_unzipped4, i64 88
  %960 = getelementptr inbounds float, ptr %inv_unzipped4, i64 96
  %961 = getelementptr inbounds float, ptr %inv_unzipped4, i64 104
  %962 = getelementptr inbounds float, ptr %inv_unzipped4, i64 112
  %963 = getelementptr inbounds float, ptr %inv_unzipped4, i64 120
  %964 = getelementptr inbounds float, ptr %inv_unzipped4, i64 128
  %965 = getelementptr inbounds float, ptr %inv_unzipped4, i64 136
  %966 = getelementptr inbounds float, ptr %inv_unzipped4, i64 144
  %967 = getelementptr inbounds float, ptr %inv_unzipped4, i64 152
  %968 = getelementptr inbounds float, ptr %inv_unzipped4, i64 160
  %969 = getelementptr inbounds float, ptr %inv_unzipped4, i64 168
  %970 = getelementptr inbounds float, ptr %inv_unzipped4, i64 176
  %971 = getelementptr inbounds float, ptr %inv_unzipped4, i64 184
  %972 = getelementptr inbounds float, ptr %inv_unzipped4, i64 192
  %973 = getelementptr inbounds float, ptr %inv_unzipped4, i64 200
  %974 = getelementptr inbounds float, ptr %inv_unzipped4, i64 208
  %975 = getelementptr inbounds float, ptr %inv_unzipped4, i64 216
  %976 = getelementptr inbounds float, ptr %inv_unzipped4, i64 224
  %977 = getelementptr inbounds float, ptr %inv_unzipped4, i64 232
  %978 = getelementptr inbounds float, ptr %inv_unzipped4, i64 240
  %979 = getelementptr inbounds float, ptr %inv_unzipped4, i64 248
  %xtraiter = and i64 %920, 1
  %980 = icmp eq i32 %a11, 1
...
"for result.s0.i":                                ; preds = %"for result.s0.i.preheader", %"end for result.s0.n1"
  %indvars.iv1137 = phi i64 [ %916, %"for result.s0.i.preheader" ], [ %indvars.iv.next1138, %"end for result.s0.n1" ]
  ...
  store <8 x float> %1010, ptr %inv_fft1_S4_R4_n1.014, align 32, !tbaa !140
  store <8 x float> %1011, ptr %inv_fft1_S4_R4_n1.113, align 32, !tbaa !142
...
"for fwd_fft1_S4_R4_n1.s1.r12$y":                 ; preds = %"for result.s0.i", %"for fwd_fft1_S4_R4_n1.s1.r12$y"
  %indvars.iv1106 = phi i64 [ 0, %"for result.s0.i" ], [ %indvars.iv.next1107, %"for fwd_fft1_S4_R4_n1.s1.r12$y" ]
  %1142 = shl nuw nsw i64 %indvars.iv1106, 3
  %1143 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.014, i64 %1142
  %1144 = load <8 x float>, ptr %1143, align 32, !tbaa !140
  %1145 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.113, i64 %1142
  %1146 = load <8 x float>, ptr %1145, align 32, !tbaa !142
  %1147 = add nuw nsw i64 %1142, 32
  %1148 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.014, i64 %1147
  %1149 = load <8 x float>, ptr %1148, align 32, !tbaa !140
  %1150 = getelementptr inbounds float, ptr %f0.024, i64 %indvars.iv1106
  ...
  %1155 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.113, i64 %1147
  %1156 = load <8 x float>, ptr %1155, align 32, !tbaa !142
  %1157 = getelementptr inbounds float, ptr %f0.123, i64 %indvars.iv1106
  ...
  %1167 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.014, i64 %1166
  %1168 = load <8 x float>, ptr %1167, align 32, !tbaa !140
  %1169 = shl nuw nsw i64 %indvars.iv1106, 1
  %1170 = getelementptr inbounds float, ptr %f0.024, i64 %1169
  ...
  %1175 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.113, i64 %1166
  %1176 = load <8 x float>, ptr %1175, align 32, !tbaa !142
  %1177 = getelementptr inbounds float, ptr %f0.123, i64 %1169
  ...
  %1187 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.014, i64 %1186
  %1188 = load <8 x float>, ptr %1187, align 32, !tbaa !140
  %1189 = mul nuw nsw i64 %indvars.iv1106, 3
  %1190 = getelementptr inbounds float, ptr %f0.024, i64 %1189
  ...
  %1195 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.113, i64 %1186
  %1196 = load <8 x float>, ptr %1195, align 32, !tbaa !142
  %1197 = getelementptr inbounds float, ptr %f0.123, i64 %1189
  ...
  %1222 = getelementptr inbounds float, ptr %"inv_X4$3.011", i64 %1142
  store <8 x float> %1210, ptr %1222, align 32, !tbaa !134
  %1223 = getelementptr inbounds float, ptr %"inv_X4$3.110", i64 %1142
  store <8 x float> %1211, ptr %1223, align 32, !tbaa !136
  %1224 = getelementptr inbounds float, ptr %"inv_X4$3.011", i64 %1147
  store <8 x float> %1218, ptr %1224, align 32, !tbaa !134
  %1225 = getelementptr inbounds float, ptr %"inv_X4$3.110", i64 %1147
  store <8 x float> %1219, ptr %1225, align 32, !tbaa !136
  %1226 = getelementptr inbounds float, ptr %"inv_X4$3.011", i64 %1166
  store <8 x float> %1212, ptr %1226, align 32, !tbaa !134
  %1227 = getelementptr inbounds float, ptr %"inv_X4$3.110", i64 %1166
  store <8 x float> %1213, ptr %1227, align 32, !tbaa !136
  %1228 = getelementptr inbounds float, ptr %"inv_X4$3.011", i64 %1186
  store <8 x float> %1220, ptr %1228, align 32, !tbaa !134
  %1229 = getelementptr inbounds float, ptr %"inv_X4$3.110", i64 %1186
...
"for fwd_unzipped.s0.n1.preheader":               ; preds = %"for fwd_fft1_S4_R4_n1.s1.r12$y"
  %1230 = load <8 x float>, ptr %"inv_X4$3.011", align 32, !tbaa !134
  %1231 = fadd <8 x float> %1230, %1230
  store <8 x float> %1231, ptr %inv_zipped.115, align 32, !tbaa !161
  %1232 = load <8 x float>, ptr %"inv_X4$3.110", align 32, !tbaa !136
  %1233 = fsub <8 x float> %1232, %1232
  store <8 x float> %1233, ptr %inv_zipped.06, align 32, !tbaa !351
  ...
  %1298 = load <4 x float>, ptr %inv_zipped.115, align 32, !tbaa !353
  ...
  %"inv_X4$2.08.sroa.0.0.vec.extract475" = shufflevector <16 x float> %1326, <16 x float> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %1332 = fmul <4 x float> %"inv_X4$2.08.sroa.0.0.vec.extract475", <float 5.000000e-01, float 5.000000e-01, float 5.000000e-01, float 5.000000e-01>
  store <4 x float> %1332, ptr %inv_fft1_S4_R4_n1.014, align 32, !tbaa !258
  %"inv_X4$2.17.sroa.0.0.vec.extract632" = shufflevector <16 x float> %1330, <16 x float> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %1333 = fmul <4 x float> %"inv_X4$2.17.sroa.0.0.vec.extract632", <float 5.000000e-01, float 5.000000e-01, float 5.000000e-01, float 5.000000e-01>
  store <4 x float> %1333, ptr %inv_fft1_S4_R4_n1.113, align 32, !tbaa !261
  %"inv_X4$2.08.sroa.0.16.vec.extract505" = shufflevector <16 x float> %1326, <16 x float> undef, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
  %1334 = fmul <4 x float> %"inv_X4$2.08.sroa.0.16.vec.extract505", <float 5.000000e-01, float 0x3FDD906BC0000000, float 0x3FD6A09E60000000, float 0x3FC87DE2A0000000>
  %"inv_X4$2.17.sroa.0.16.vec.extract660" = shufflevector <16 x float> %1330, <16 x float> undef, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
  %1335 = fmul <4 x float> %"inv_X4$2.17.sroa.0.16.vec.extract660", <float 0.000000e+00, float 0xBFC87DE2C0000000, float 0xBFD6A09E60000000, float 0xBFDD906BC0000000>
  %1336 = fsub <4 x float> %1334, %1335
  store <4 x float> %1336, ptr %732, align 16, !tbaa !264
  %1337 = fmul <4 x float> %"inv_X4$2.08.sroa.0.16.vec.extract505", <float 0.000000e+00, float 0xBFC87DE2C0000000, float 0xBFD6A09E60000000, float 0xBFDD906BC0000000>
  %1338 = fmul <4 x float> %"inv_X4$2.17.sroa.0.16.vec.extract660", <float 5.000000e-01, float 0x3FDD906BC0000000, float 0x3FD6A09E60000000, float 0x3FC87DE2A0000000>
  %1339 = fadd <4 x float> %1337, %1338
  store <4 x float> %1339, ptr %734, align 16, !tbaa !266
  %"inv_X4$2.08.sroa.58.32.vec.extract547" = shufflevector <8 x float> %1327, <8 x float> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %1340 = fmul <4 x float> %"inv_X4$2.08.sroa.58.32.vec.extract547", <float 5.000000e-01, float 0x3FD6A09E60000000, float 0xBE5777A5C0000000, float 0xBFD6A09E60000000>
  %"inv_X4$2.17.sroa.47.32.vec.extract697" = shufflevector <8 x float> %1331, <8 x float> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %1341 = fmul <4 x float> %"inv_X4$2.17.sroa.47.32.vec.extract697", <float 0.000000e+00, float 0xBFD6A09E60000000, float -5.000000e-01, float 0xBFD6A09E60000000>
  %1342 = fsub <4 x float> %1340, %1341
  store <4 x float> %1342, ptr %544, align 32, !tbaa !230
  %1343 = fmul <4 x float> %"inv_X4$2.08.sroa.58.32.vec.extract547", <float 0.000000e+00, float 0xBFD6A09E60000000, float -5.000000e-01, float 0xBFD6A09E60000000>
  %1344 = fmul <4 x float> %"inv_X4$2.17.sroa.47.32.vec.extract697", <float 5.000000e-01, float 0x3FD6A09E60000000, float 0xBE5777A5C0000000, float 0xBFD6A09E60000000>
  %1345 = fadd <4 x float> %1343, %1344
  store <4 x float> %1345, ptr %550, align 32, !tbaa !240
  %"inv_X4$2.08.sroa.58.48.vec.extract569" = shufflevector <8 x float> %1327, <8 x float> poison, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
  %1346 = fmul <4 x float> %"inv_X4$2.08.sroa.58.48.vec.extract569", <float 5.000000e-01, float 0x3FC87DE2A0000000, float 0xBFD6A09E60000000, float 0xBFDD906BC0000000>
  %"inv_X4$2.17.sroa.47.48.vec.extract719" = shufflevector <8 x float> %1331, <8 x float> poison, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
  %1347 = fmul <4 x float> %"inv_X4$2.17.sroa.47.48.vec.extract719", <float 0.000000e+00, float 0xBFDD906BC0000000, float 0xBFD6A09E60000000, float 0x3FC87DE2A0000000>
  %1348 = fsub <4 x float> %1346, %1347
  store <4 x float> %1348, ptr %746, align 16, !tbaa !268
  %1349 = fmul <4 x float> %"inv_X4$2.08.sroa.58.48.vec.extract569", <float 0.000000e+00, float 0xBFDD906BC0000000, float 0xBFD6A09E60000000, float 0x3FC87DE2A0000000>
  %1350 = fmul <4 x float> %"inv_X4$2.17.sroa.47.48.vec.extract719", <float 5.000000e-01, float 0x3FC87DE2A0000000, float 0xBFD6A09E60000000, float 0xBFDD906BC0000000>
  ...
  store <4 x float> %1360, ptr %"inv_X4$3.011", align 32, !tbaa !196
  %1361 = fsub <4 x float> %1333, %1345
  store <4 x float> %1361, ptr %"inv_X4$3.110", align 32, !tbaa !206
  ...
  store <4 x float> %1356, ptr %inv_exchange_S1_R4_n1.012, align 32, !tbaa !187
  store <4 x float> %1357, ptr %inv_exchange_S1_R4_n1.116, align 32, !tbaa !163
...
"for fwd_fft0_S4_R4_n0.s1.n1":                    ; preds = %"for fwd_unzipped.s0.n1.preheader", %"for fwd_fft0_S4_R4_n0.s1.n1"
  %indvars.iv1113 = phi i64 [ 1, %"for fwd_unzipped.s0.n1.preheader" ], [ %indvars.iv.next1114, %"for fwd_fft0_S4_R4_n0.s1.n1" ]
  %1368 = shl nuw nsw i64 %indvars.iv1113, 4
  %1369 = getelementptr inbounds float, ptr %inv_zipped.115, i64 %1368
  %1370 = load <4 x float>, ptr %1369, align 32, !tbaa !161
  %1371 = or i64 %1368, 8
  %1372 = getelementptr inbounds float, ptr %inv_zipped.115, i64 %1371
  %1373 = load <4 x float>, ptr %1372, align 32, !tbaa !161
  %1374 = fadd <4 x float> %1370, %1373
  %1375 = getelementptr inbounds float, ptr %inv_zipped.06, i64 %1368
  %1376 = load <4 x float>, ptr %1375, align 32, !tbaa !351
  %1377 = getelementptr inbounds float, ptr %inv_zipped.06, i64 %1371
  %1378 = load <4 x float>, ptr %1377, align 32, !tbaa !351
  %1379 = fadd <4 x float> %1376, %1378
  %1380 = or i64 %1368, 4
  %1381 = getelementptr inbounds float, ptr %inv_zipped.115, i64 %1380
  %1382 = load <4 x float>, ptr %1381, align 16, !tbaa !161
  %1383 = or i64 %1368, 12
  %1384 = getelementptr inbounds float, ptr %inv_zipped.115, i64 %1383
  %1385 = load <4 x float>, ptr %1384, align 16, !tbaa !161
  %1386 = fadd <4 x float> %1382, %1385
  %1387 = getelementptr inbounds float, ptr %inv_zipped.06, i64 %1380
  %1388 = load <4 x float>, ptr %1387, align 16, !tbaa !351
  %1389 = getelementptr inbounds float, ptr %inv_zipped.06, i64 %1383
  ...
  %v_inv_fft1_S4_R4_n1.19.sroa.0.0.vec.extract235 = shufflevector <16 x float> %1406, <16 x float> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %1412 = fmul <4 x float> %v_inv_fft1_S4_R4_n1.19.sroa.0.0.vec.extract235, <float 5.000000e-01, float 5.000000e-01, float 5.000000e-01, float 5.000000e-01>
  %v_inv_fft1_S4_R4_n1.05.sroa.0.0.vec.extract770 = shufflevector <16 x float> %1410, <16 x float> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %1413 = fmul <4 x float> %v_inv_fft1_S4_R4_n1.05.sroa.0.0.vec.extract770, <float 5.000000e-01, float 5.000000e-01, float 5.000000e-01, float 5.000000e-01>
  %v_inv_fft1_S4_R4_n1.19.sroa.0.16.vec.extract292 = shufflevector <16 x float> %1406, <16 x float> undef, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
  %1414 = fmul <4 x float> %v_inv_fft1_S4_R4_n1.19.sroa.0.16.vec.extract292, <float 5.000000e-01, float 0x3FDD906BC0000000, float 0x3FD6A09E60000000, float 0x3FC87DE2A0000000>
  %v_inv_fft1_S4_R4_n1.05.sroa.0.16.vec.extract809 = shufflevector <16 x float> %1410, <16 x float> undef, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
  %1415 = fmul <4 x float> %v_inv_fft1_S4_R4_n1.05.sroa.0.16.vec.extract809, <float 0.000000e+00, float 0xBFC87DE2C0000000, float 0xBFD6A09E60000000, float 0xBFDD906BC0000000>
  %1416 = fsub <4 x float> %1414, %1415
  %1417 = fmul <4 x float> %v_inv_fft1_S4_R4_n1.19.sroa.0.16.vec.extract292, <float 0.000000e+00, float 0xBFC87DE2C0000000, float 0xBFD6A09E60000000, float 0xBFDD906BC0000000>
  %1418 = fmul <4 x float> %v_inv_fft1_S4_R4_n1.05.sroa.0.16.vec.extract809, <float 5.000000e-01, float 0x3FDD906BC0000000, float 0x3FD6A09E60000000, float 0x3FC87DE2A0000000>
  %1419 = fadd <4 x float> %1417, %1418
  %v_inv_fft1_S4_R4_n1.19.sroa.76.32.vec.extract350 = shufflevector <8 x float> %1407, <8 x float> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %1420 = fmul <4 x float> %v_inv_fft1_S4_R4_n1.19.sroa.76.32.vec.extract350, <float 5.000000e-01, float 0x3FD6A09E60000000, float 0xBE5777A5C0000000, float 0xBFD6A09E60000000>
  %v_inv_fft1_S4_R4_n1.05.sroa.46.32.vec.extract848 = shufflevector <8 x float> %1411, <8 x float> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %1421 = fmul <4 x float> %v_inv_fft1_S4_R4_n1.05.sroa.46.32.vec.extract848, <float 0.000000e+00, float 0xBFD6A09E60000000, float -5.000000e-01, float 0xBFD6A09E60000000>
  %1422 = fsub <4 x float> %1420, %1421
  %1423 = fmul <4 x float> %v_inv_fft1_S4_R4_n1.19.sroa.76.32.vec.extract350, <float 0.000000e+00, float 0xBFD6A09E60000000, float -5.000000e-01, float 0xBFD6A09E60000000>
  %1424 = fmul <4 x float> %v_inv_fft1_S4_R4_n1.05.sroa.46.32.vec.extract848, <float 5.000000e-01, float 0x3FD6A09E60000000, float 0xBE5777A5C0000000, float 0xBFD6A09E60000000>
  %1425 = fadd <4 x float> %1423, %1424
  %v_inv_fft1_S4_R4_n1.19.sroa.76.48.vec.extract381 = shufflevector <8 x float> %1407, <8 x float> poison, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
  %1426 = fmul <4 x float> %v_inv_fft1_S4_R4_n1.19.sroa.76.48.vec.extract381, <float 5.000000e-01, float 0x3FC87DE2A0000000, float 0xBFD6A09E60000000, float 0xBFDD906BC0000000>
  %v_inv_fft1_S4_R4_n1.05.sroa.46.48.vec.extract870 = shufflevector <8 x float> %1411, <8 x float> poison, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
  %1427 = fmul <4 x float> %v_inv_fft1_S4_R4_n1.05.sroa.46.48.vec.extract870, <float 0.000000e+00, float 0xBFDD906BC0000000, float 0xBFD6A09E60000000, float 0x3FC87DE2A0000000>
  %1428 = fsub <4 x float> %1426, %1427
  %1429 = fmul <4 x float> %v_inv_fft1_S4_R4_n1.19.sroa.76.48.vec.extract381, <float 0.000000e+00, float 0xBFDD906BC0000000, float 0xBFD6A09E60000000, float 0x3FC87DE2A0000000>
  %1430 = fmul <4 x float> %v_inv_fft1_S4_R4_n1.05.sroa.46.48.vec.extract870, <float 5.000000e-01, float 0x3FC87DE2A0000000, float 0xBFD6A09E60000000, float 0xBFDD906BC0000000>
  ...
  %1448 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.012, i64 %1368
  store <4 x float> %1436, ptr %1448, align 32, !tbaa !132
  %1449 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.116, i64 %1368
  store <4 x float> %1437, ptr %1449, align 32, !tbaa !159
  %1450 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.012, i64 %1380
  store <4 x float> %1444, ptr %1450, align 16, !tbaa !132
  %1451 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.116, i64 %1380
  store <4 x float> %1445, ptr %1451, align 16, !tbaa !159
  %1452 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.012, i64 %1371
  store <4 x float> %1438, ptr %1452, align 32, !tbaa !132
  %1453 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.116, i64 %1371
  store <4 x float> %1439, ptr %1453, align 32, !tbaa !159
  %1454 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.012, i64 %1383
  store <4 x float> %1446, ptr %1454, align 16, !tbaa !132
  %1455 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.116, i64 %1383
...
"end for fwd_fft0_S4_R4_n0.s1.n1":                ; preds = %"for fwd_fft0_S4_R4_n0.s1.n1"
  store <4 x float> %1412, ptr %inv_fft1_S4_R4_n1.113, align 32, !tbaa !261
  store <4 x float> %1413, ptr %inv_fft1_S4_R4_n1.014, align 32, !tbaa !258
  ...
  store <4 x float> %1440, ptr %"inv_X4$3.011", align 32, !tbaa !196
  store <4 x float> %1441, ptr %"inv_X4$3.110", align 32, !tbaa !206
  ...
  %1456 = load float, ptr %inv_exchange_S1_R4_n1.116, align 32, !tbaa !382
  ...
  %fwd_fft0_S4_R4_n0.0.value.x8 = shufflevector <8 x float> %1461, <8 x float> undef, <8 x i32> <i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>
  %1467 = fsub <8 x float> zeroinitializer, %1466
  %fwd_fft0_S4_R4_n0.1.value.x8 = shufflevector <8 x float> %1467, <8 x float> poison, <8 x i32> <i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>
  ...
  %fwd_fft0_S4_R4_n0.0.value.s.x8 = fadd <8 x float> %1464, %1463
  %fwd_fft0_S4_R4_n0.1.value.s.x8 = fsub <8 x float> %1457, %1459
  %1468 = fmul <8 x float> %fwd_fft0_S4_R4_n0.0.value.s.x8, <float 5.000000e-01, float 5.000000e-01, float 5.000000e-01, float 5.000000e-01, float 5.000000e-01, float 5.000000e-01, float 5.000000e-01, float 5.000000e-01>
  store <8 x float> %1468, ptr %892, align 4, !tbaa !406
  %1469 = fmul <8 x float> %fwd_fft0_S4_R4_n0.1.value.s.x8, <float 5.000000e-01, float 5.000000e-01, float 5.000000e-01, float 5.000000e-01, float 5.000000e-01, float 5.000000e-01, float 5.000000e-01, float 5.000000e-01>
  store <8 x float> %1469, ptr %890, align 4, !tbaa !403
  %fwd_fft0_S4_R4_n0.0.value.x8104 = shufflevector <8 x float> %1468, <8 x float> undef, <8 x i32> <i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>
  %1470 = fsub <8 x float> zeroinitializer, %1469
  %fwd_fft0_S4_R4_n0.1.value.x8105 = shufflevector <8 x float> %1470, <8 x float> poison, <8 x i32> <i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>
  ...
  %1471 = shufflevector <8 x float> %fwd_fft0_S4_R4_n0.0.value.x8104, <8 x float> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %1472 = shufflevector <8 x float> %fwd_fft0_S4_R4_n0.1.value.x8105, <8 x float> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %1473 = shufflevector <8 x float> %fwd_fft0_S4_R4_n0.0.value.x8, <8 x float> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %1474 = shufflevector <8 x float> %fwd_fft0_S4_R4_n0.1.value.x8, <8 x float> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  ...
  %bc1179 = bitcast <8 x float> %fwd_fft0_S4_R4_n0.0.value.x8104 to <2 x i128>
  %1491 = extractelement <2 x i128> %bc1179, i64 1
  %1492 = bitcast i128 %1491 to <4 x float>
  %bc1180 = bitcast <8 x float> %fwd_fft0_S4_R4_n0.1.value.x8105 to <2 x i128>
  %1493 = extractelement <2 x i128> %bc1180, i64 1
  %1494 = bitcast i128 %1493 to <4 x float>
  %bc1181 = bitcast <8 x float> %fwd_fft0_S4_R4_n0.0.value.x8 to <2 x i128>
  %1495 = extractelement <2 x i128> %bc1181, i64 1
  %1496 = bitcast i128 %1495 to <4 x float>
  %bc1182 = bitcast <8 x float> %fwd_fft0_S4_R4_n0.1.value.x8 to <2 x i128>
...
"assert succeeded107":                            ; preds = %"end for fwd_fft0_S4_R4_n0.s1.n1"
  br i1 %900, label %"produce inv_X4", label %"assert failed108", !prof !26

"assert failed108":                               ; preds = %"assert succeeded107"
  %1501 = tail call i32 @halide_error_explicit_bounds_too_small(ptr null, ptr nonnull @str.13, ptr nonnull @str.12, i32 0, i32 15, i32 %84, i32 %b2) #2
  br label %destructor_block

"produce inv_X4":                                 ; preds = %"assert succeeded107"
  %1502 = load <4 x float>, ptr %inv_exchange_S1_R4_n1.012, align 32, !tbaa !187
  %1503 = load <4 x float>, ptr %kernel_fft0_S4_R4_n0.018, align 32, !tbaa !276
  %1504 = fmul <4 x float> %1502, %1503
  %1505 = load <4 x float>, ptr %inv_exchange_S1_R4_n1.116, align 32, !tbaa !163
  %1506 = load <4 x float>, ptr %kernel_fft0_S4_R4_n0.117, align 32, !tbaa !287
  ...
  %"inv_X4$2.08.sroa.0.0.vec.extract489" = shufflevector <16 x float> %1600, <16 x float> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  store <4 x float> %"inv_X4$2.08.sroa.0.0.vec.extract489", ptr %inv_zipped.115, align 32, !tbaa !353
  %"inv_X4$2.17.sroa.0.0.vec.extract644" = shufflevector <16 x float> %1604, <16 x float> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  store <4 x float> %"inv_X4$2.17.sroa.0.0.vec.extract644", ptr %inv_zipped.06, align 32, !tbaa !428
  %"inv_X4$2.08.sroa.0.16.vec.extract521" = shufflevector <16 x float> %1600, <16 x float> undef, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
  %1606 = load <4 x float>, ptr %f2.028, align 32
  %1607 = fmul <4 x float> %1606, %"inv_X4$2.08.sroa.0.16.vec.extract521"
  %"inv_X4$2.17.sroa.0.16.vec.extract676" = shufflevector <16 x float> %1604, <16 x float> undef, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
  %1608 = load <4 x float>, ptr %f2.127, align 32
  %1609 = fmul <4 x float> %1608, %"inv_X4$2.17.sroa.0.16.vec.extract676"
  %1610 = fsub <4 x float> %1607, %1609
  store <4 x float> %1610, ptr %886, align 16, !tbaa !366
  %1611 = fmul <4 x float> %1608, %"inv_X4$2.08.sroa.0.16.vec.extract521"
  %1612 = fmul <4 x float> %1606, %"inv_X4$2.17.sroa.0.16.vec.extract676"
  %1613 = fadd <4 x float> %1611, %1612
  store <4 x float> %1613, ptr %905, align 16, !tbaa !438
  %"inv_X4$2.08.sroa.58.32.vec.extract556" = shufflevector <8 x float> %1601, <8 x float> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  ...
  %1616 = fmul <4 x float> %1615, %"inv_X4$2.08.sroa.58.32.vec.extract556"
  %"inv_X4$2.17.sroa.47.32.vec.extract706" = shufflevector <8 x float> %1605, <8 x float> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  ...
  %1619 = fmul <4 x float> %"inv_X4$2.17.sroa.47.32.vec.extract706", %1618
  %1620 = fsub <4 x float> %1616, %1619
  store <4 x float> %1620, ptr %543, align 32, !tbaa !363
  %1621 = fmul <4 x float> %"inv_X4$2.08.sroa.58.32.vec.extract556", %1618
  %1622 = fmul <4 x float> %1615, %"inv_X4$2.17.sroa.47.32.vec.extract706"
  %1623 = fadd <4 x float> %1621, %1622
  store <4 x float> %1623, ptr %906, align 32, !tbaa !440
  %"inv_X4$2.08.sroa.58.48.vec.extract578" = shufflevector <8 x float> %1601, <8 x float> poison, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
  ...
  %1630 = fmul <4 x float> %"inv_X4$2.08.sroa.58.48.vec.extract578", %1629
  %"inv_X4$2.17.sroa.47.48.vec.extract728" = shufflevector <8 x float> %1605, <8 x float> poison, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
  ...
  %1637 = fmul <4 x float> %"inv_X4$2.17.sroa.47.48.vec.extract728", %1636
  %1638 = fsub <4 x float> %1630, %1637
  store <4 x float> %1638, ptr %887, align 16, !tbaa !368
  %1639 = fmul <4 x float> %"inv_X4$2.08.sroa.58.48.vec.extract578", %1636
  %1640 = fmul <4 x float> %"inv_X4$2.17.sroa.47.48.vec.extract728", %1629
  %1641 = fadd <4 x float> %1640, %1639
  store <4 x float> %1641, ptr %907, align 16, !tbaa !445
  %1642 = fadd <4 x float> %"inv_X4$2.08.sroa.0.0.vec.extract489", %1620
  %1643 = fadd <4 x float> %"inv_X4$2.17.sroa.0.0.vec.extract644", %1623
  ...
  %1650 = fsub <4 x float> %"inv_X4$2.08.sroa.0.0.vec.extract489", %1620
  %1651 = fsub <4 x float> %"inv_X4$2.17.sroa.0.0.vec.extract644", %1623
  ...
  store <4 x float> %1646, ptr %"inv_X4$3.011", align 32, !tbaa !196
  store <4 x float> %1647, ptr %"inv_X4$3.110", align 32, !tbaa !206
...
"for inv_fft0_S4_R4_n0.s1.n1":                    ; preds = %"produce inv_X4", %"for inv_fft0_S4_R4_n0.s1.n1"
  %indvars.iv1116 = phi i64 [ 1, %"produce inv_X4" ], [ %indvars.iv.next1117, %"for inv_fft0_S4_R4_n0.s1.n1" ]
  %1658 = shl nuw nsw i64 %indvars.iv1116, 4
  %1659 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.012, i64 %1658
  %1660 = load <4 x float>, ptr %1659, align 32, !tbaa !132
  %1661 = getelementptr inbounds float, ptr %kernel_fft0_S4_R4_n0.018, i64 %1658
  %1662 = load <4 x float>, ptr %1661, align 32, !tbaa !312
  %1663 = fmul <4 x float> %1660, %1662
  %1664 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.116, i64 %1658
  %1665 = load <4 x float>, ptr %1664, align 32, !tbaa !159
  %1666 = getelementptr inbounds float, ptr %kernel_fft0_S4_R4_n0.117, i64 %1658
  %1667 = load <4 x float>, ptr %1666, align 32, !tbaa !313
  %1668 = fmul <4 x float> %1665, %1667
  %1669 = fsub <4 x float> %1663, %1668
  %1670 = or i64 %1658, 8
  %1671 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.012, i64 %1670
  %1672 = load <4 x float>, ptr %1671, align 32, !tbaa !132
  %1673 = getelementptr inbounds float, ptr %kernel_fft0_S4_R4_n0.018, i64 %1670
  %1674 = load <4 x float>, ptr %1673, align 32, !tbaa !312
  %1675 = fmul <4 x float> %1672, %1674
  %1676 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.116, i64 %1670
  %1677 = load <4 x float>, ptr %1676, align 32, !tbaa !159
  %1678 = getelementptr inbounds float, ptr %kernel_fft0_S4_R4_n0.117, i64 %1670
  ...
  %1690 = or i64 %1658, 4
  %1691 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.012, i64 %1690
  %1692 = load <4 x float>, ptr %1691, align 16, !tbaa !132
  %1693 = getelementptr inbounds float, ptr %kernel_fft0_S4_R4_n0.018, i64 %1690
  %1694 = load <4 x float>, ptr %1693, align 16, !tbaa !312
  %1695 = fmul <4 x float> %1692, %1694
  %1696 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.116, i64 %1690
  %1697 = load <4 x float>, ptr %1696, align 16, !tbaa !159
  %1698 = getelementptr inbounds float, ptr %kernel_fft0_S4_R4_n0.117, i64 %1690
  %1699 = load <4 x float>, ptr %1698, align 16, !tbaa !313
  %1700 = fmul <4 x float> %1697, %1699
  %1701 = fsub <4 x float> %1695, %1700
  %1702 = or i64 %1658, 12
  %1703 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.012, i64 %1702
  %1704 = load <4 x float>, ptr %1703, align 16, !tbaa !132
  %1705 = getelementptr inbounds float, ptr %kernel_fft0_S4_R4_n0.018, i64 %1702
  %1706 = load <4 x float>, ptr %1705, align 16, !tbaa !312
  %1707 = fmul <4 x float> %1704, %1706
  %1708 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.116, i64 %1702
  %1709 = load <4 x float>, ptr %1708, align 16, !tbaa !159
  %1710 = getelementptr inbounds float, ptr %kernel_fft0_S4_R4_n0.117, i64 %1702
  ...
  %"inv_X4$2.08.sroa.0.16.vec.extract525" = shufflevector <16 x float> %1738, <16 x float> undef, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
  %1744 = fmul <4 x float> %"inv_X4$2.08.sroa.0.16.vec.extract525", %1606
  %"inv_X4$2.17.sroa.0.16.vec.extract680" = shufflevector <16 x float> %1742, <16 x float> undef, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
  %1745 = fmul <4 x float> %"inv_X4$2.17.sroa.0.16.vec.extract680", %1608
  %1746 = fsub <4 x float> %1744, %1745
  %1747 = fmul <4 x float> %"inv_X4$2.08.sroa.0.16.vec.extract525", %1608
  %1748 = fmul <4 x float> %"inv_X4$2.17.sroa.0.16.vec.extract680", %1606
  %1749 = fadd <4 x float> %1748, %1747
  %"inv_X4$2.08.sroa.58.32.vec.extract560" = shufflevector <8 x float> %1739, <8 x float> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %1750 = fmul <4 x float> %"inv_X4$2.08.sroa.58.32.vec.extract560", %1615
  %"inv_X4$2.17.sroa.47.32.vec.extract710" = shufflevector <8 x float> %1743, <8 x float> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %1751 = fmul <4 x float> %"inv_X4$2.17.sroa.47.32.vec.extract710", %1618
  %1752 = fsub <4 x float> %1750, %1751
  %1753 = fmul <4 x float> %"inv_X4$2.08.sroa.58.32.vec.extract560", %1618
  %1754 = fmul <4 x float> %"inv_X4$2.17.sroa.47.32.vec.extract710", %1615
  %1755 = fadd <4 x float> %1754, %1753
  %"inv_X4$2.08.sroa.58.48.vec.extract582" = shufflevector <8 x float> %1739, <8 x float> poison, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
  %1756 = fmul <4 x float> %"inv_X4$2.08.sroa.58.48.vec.extract582", %1629
  %"inv_X4$2.17.sroa.47.48.vec.extract732" = shufflevector <8 x float> %1743, <8 x float> poison, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
  %1757 = fmul <4 x float> %"inv_X4$2.17.sroa.47.48.vec.extract732", %1636
  %1758 = fsub <4 x float> %1756, %1757
  %1759 = fmul <4 x float> %"inv_X4$2.08.sroa.58.48.vec.extract582", %1636
  %1760 = fmul <4 x float> %"inv_X4$2.17.sroa.47.48.vec.extract732", %1629
  %1761 = fadd <4 x float> %1760, %1759
  %v_inv_fft1_S4_R4_n1.19.sroa.0.0.vec.extract264 = shufflevector <16 x float> %1738, <16 x float> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %1762 = fadd <4 x float> %v_inv_fft1_S4_R4_n1.19.sroa.0.0.vec.extract264, %1752
  %v_inv_fft1_S4_R4_n1.05.sroa.0.0.vec.extract797 = shufflevector <16 x float> %1742, <16 x float> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %1763 = fadd <4 x float> %v_inv_fft1_S4_R4_n1.05.sroa.0.0.vec.extract797, %1755
  ...
  %1770 = fsub <4 x float> %v_inv_fft1_S4_R4_n1.19.sroa.0.0.vec.extract264, %1752
  %1771 = fsub <4 x float> %v_inv_fft1_S4_R4_n1.05.sroa.0.0.vec.extract797, %1755
  ...
  %1778 = getelementptr inbounds float, ptr %"inv_X4$3.011", i64 %1658
  store <4 x float> %1766, ptr %1778, align 32, !tbaa !134
  %1779 = getelementptr inbounds float, ptr %"inv_X4$3.110", i64 %1658
  store <4 x float> %1767, ptr %1779, align 32, !tbaa !136
  %1780 = getelementptr inbounds float, ptr %"inv_X4$3.011", i64 %1690
  store <4 x float> %1774, ptr %1780, align 16, !tbaa !134
  %1781 = getelementptr inbounds float, ptr %"inv_X4$3.110", i64 %1690
  store <4 x float> %1775, ptr %1781, align 16, !tbaa !136
  %1782 = getelementptr inbounds float, ptr %"inv_X4$3.011", i64 %1670
  store <4 x float> %1768, ptr %1782, align 32, !tbaa !134
  %1783 = getelementptr inbounds float, ptr %"inv_X4$3.110", i64 %1670
  store <4 x float> %1769, ptr %1783, align 32, !tbaa !136
  %1784 = getelementptr inbounds float, ptr %"inv_X4$3.011", i64 %1702
  store <4 x float> %1776, ptr %1784, align 16, !tbaa !134
  %1785 = getelementptr inbounds float, ptr %"inv_X4$3.110", i64 %1702
...
"produce inv_zipped":                             ; preds = %"for inv_fft0_S4_R4_n0.s1.n1"
  %1786 = load <8 x float>, ptr %"inv_X4$3.011", align 32, !tbaa !447
  %1787 = load <8 x float>, ptr %322, align 32, !tbaa !448
  store <8 x float> %1786, ptr %inv_zipped.06, align 32, !tbaa !449
  store <8 x float> %1787, ptr %inv_zipped.115, align 32, !tbaa !450
  %1788 = load <8 x float>, ptr %"inv_X4$3.110", align 32, !tbaa !451
  ...
  %1850 = load <8 x float>, ptr %inv_zipped.06, align 32, !tbaa !351
  %1851 = load <8 x float>, ptr %909, align 32, !tbaa !351
  %1852 = fadd <8 x float> %1850, %1851
  %1853 = load <8 x float>, ptr %inv_zipped.115, align 32, !tbaa !161
  ...
  store <8 x float> %1858, ptr %inv_exchange_S1_R4_n1.012, align 32, !tbaa !132
  store <8 x float> %1859, ptr %inv_exchange_S1_R4_n1.116, align 32, !tbaa !159
...
"for inv_fft1_S4_R4_n1.s1.r175$y":                ; preds = %"produce inv_zipped", %"for inv_fft1_S4_R4_n1.s1.r175$y"
  %indvars.iv1125 = phi i64 [ 0, %"produce inv_zipped" ], [ %indvars.iv.next1126, %"for inv_fft1_S4_R4_n1.s1.r175$y" ]
  %1932 = shl nuw nsw i64 %indvars.iv1125, 3
  %1933 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.012, i64 %1932
  %1934 = load <8 x float>, ptr %1933, align 32, !tbaa !132
  %1935 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.116, i64 %1932
  %1936 = load <8 x float>, ptr %1935, align 32, !tbaa !159
  %1937 = add nuw nsw i64 %1932, 32
  %1938 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.012, i64 %1937
  %1939 = load <8 x float>, ptr %1938, align 32, !tbaa !132
  %1940 = getelementptr inbounds float, ptr %f2.028, i64 %indvars.iv1125
  ...
  %1945 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.116, i64 %1937
  %1946 = load <8 x float>, ptr %1945, align 32, !tbaa !159
  %1947 = getelementptr inbounds float, ptr %f2.127, i64 %indvars.iv1125
  ...
  %1957 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.012, i64 %1956
  %1958 = load <8 x float>, ptr %1957, align 32, !tbaa !132
  %1959 = shl nuw nsw i64 %indvars.iv1125, 1
  %1960 = getelementptr inbounds float, ptr %f2.028, i64 %1959
  ...
  %1965 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.116, i64 %1956
  %1966 = load <8 x float>, ptr %1965, align 32, !tbaa !159
  %1967 = getelementptr inbounds float, ptr %f2.127, i64 %1959
  ...
  %1977 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.012, i64 %1976
  %1978 = load <8 x float>, ptr %1977, align 32, !tbaa !132
  %1979 = mul nuw nsw i64 %indvars.iv1125, 3
  %1980 = getelementptr inbounds float, ptr %f2.028, i64 %1979
  ...
  %1985 = getelementptr inbounds float, ptr %inv_exchange_S1_R4_n1.116, i64 %1976
  %1986 = load <8 x float>, ptr %1985, align 32, !tbaa !159
  %1987 = getelementptr inbounds float, ptr %f2.127, i64 %1979
  ...
  %2012 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.014, i64 %1932
  store <8 x float> %2000, ptr %2012, align 32, !tbaa !140
  %2013 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.113, i64 %1932
  store <8 x float> %2001, ptr %2013, align 32, !tbaa !142
  %2014 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.014, i64 %1937
  store <8 x float> %2008, ptr %2014, align 32, !tbaa !140
  %2015 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.113, i64 %1937
  store <8 x float> %2009, ptr %2015, align 32, !tbaa !142
  %2016 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.014, i64 %1956
  store <8 x float> %2002, ptr %2016, align 32, !tbaa !140
  %2017 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.113, i64 %1956
  store <8 x float> %2003, ptr %2017, align 32, !tbaa !142
  %2018 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.014, i64 %1976
  store <8 x float> %2010, ptr %2018, align 32, !tbaa !140
  %2019 = getelementptr inbounds float, ptr %inv_fft1_S4_R4_n1.113, i64 %1976
...
"for inv_unzipped.s0.n1.preheader":               ; preds = %"for inv_fft1_S4_R4_n1.s1.r175$y"
  ...
  store <8 x float> %2004, ptr %"inv_X4$3.011", align 32, !tbaa !447
  store <8 x float> %2005, ptr %"inv_X4$3.110", align 32, !tbaa !451
  ...
  %2020 = load <8 x float>, ptr %inv_fft1_S4_R4_n1.014, align 32, !tbaa !140
  store <8 x float> %2020, ptr %inv_unzipped4, align 32, !tbaa !483
  %2021 = load <8 x float>, ptr %inv_fft1_S4_R4_n1.113, align 32, !tbaa !142
  ...
  br i1 %910, label %"for result.s0.n1.preheader", label %"end for result.s0.n1", !prof !26
...
"for result.s0.n1":                               ; preds = %"for result.s0.n1.preheader", %"end for result.s0.n0.n0127"
  %indvars.iv1134 = phi i64 [ %915, %"for result.s0.n1.preheader" ], [ %indvars.iv.next1135, %"end for result.s0.n0.n0127" ]
  br i1 %.not917, label %"end for result.s0.n0.n0", label %"for result.s0.n0.n0.preheader", !prof !5
...
"for result.s0.n0.n0.preheader":                  ; preds = %"for result.s0.n1"
  ...
  br i1 %980, label %"end for result.s0.n0.n0.loopexit.unr-lcssa", label %"for result.s0.n0.n0"
...
"for result.s0.n0.n0":                            ; preds = %"for result.s0.n0.n0.preheader", %"for result.s0.n0.n0"
  %indvars.iv1131 = phi i64 [ %indvars.iv.next1132.1, %"for result.s0.n0.n0" ], [ 0, %"for result.s0.n0.n0.preheader" ]
  ...
  %2060 = getelementptr inbounds float, ptr %inv_unzipped4, i64 %2059
  ...
  %2068 = getelementptr inbounds float, ptr %inv_unzipped4, i64 %2067
...
"end for result.s0.n0.n0.loopexit.unr-lcssa":     ; preds = %"for result.s0.n0.n0", %"for result.s0.n0.n0.preheader"
  %indvars.iv1131.unr = phi i64 [ 0, %"for result.s0.n0.n0.preheader" ], [ %indvars.iv.next1132.1, %"for result.s0.n0.n0" ]
...
"for result.s0.n0.n0.epil":                       ; preds = %"end for result.s0.n0.n0.loopexit.unr-lcssa"
  ...
  %2076 = getelementptr inbounds float, ptr %inv_unzipped4, i64 %2075
...
"end for result.s0.n0.n0":                        ; preds = %"for result.s0.n0.n0.epil", %"end for result.s0.n0.n0.loopexit.unr-lcssa", %"for result.s0.n1"
  br i1 %913, label %"for result.s0.n0.n0126.preheader", label %"end for result.s0.n0.n0127", !prof !26

"for result.s0.n0.n0126.preheader":               ; preds = %"end for result.s0.n0.n0"
  %2081 = shl nsw i64 %indvars.iv1134, 4
  %2082 = add nsw i64 %918, %2081
  %2083 = getelementptr inbounds float, ptr %inv_unzipped4, i64 %2082
