...
entry:
  ...
  %cmp.not250 = icmp sgt i32 %add.i.i, %sub.i
  br i1 %cmp.not250, label %for.end92, label %for.body.lr.ph
...
for.body:                                         ; preds = %for.body.lr.ph, %if.end89
  %indvars.iv255 = phi i64 [ %8, %for.body.lr.ph ], [ %indvars.iv.next256, %if.end89 ]
  %result.0252 = phi ptr [ null, %for.body.lr.ph ], [ %result.6, %if.end89 ]
  %GivenClause.val139 = load ptr, ptr %3, align 8
  %arrayidx.i = getelementptr inbounds ptr, ptr %GivenClause.val139, i64 %indvars.iv255
...
if.then:                                          ; preds = %clause_LiteralIsSort.exit
  ...
  %cmp.i152.not246 = icmp eq ptr %call10, null
  br i1 %cmp.i152.not246, label %if.end89, label %for.body14

for.body14:                                       ; preds = %if.then, %for.inc86
  %result.1248 = phi ptr [ %result.5, %for.inc86 ], [ %result.0252, %if.then ]
  %termList.0247 = phi ptr [ %L.val.i223, %for.inc86 ], [ %call10, %if.then ]
  %21 = getelementptr i8, ptr %termList.0247, i64 8
...
term_IsAtom.exit:                                 ; preds = %for.body14
  ...
  %cmp.i.i156.not = icmp eq i32 %and.i.i.i155, 2
  br i1 %cmp.i.i156.not, label %land.lhs.true18, label %for.inc86
...
if.then23:                                        ; preds = %land.lhs.true18
  ...
  %cmp.i159.not242 = icmp eq ptr %call25, null
  br i1 %cmp.i159.not242, label %for.inc86, label %for.body30

for.body30:                                       ; preds = %if.then23, %if.end81
  %result.2244 = phi ptr [ %result.4, %if.end81 ], [ %result.1248, %if.then23 ]
  %litScan.0243 = phi ptr [ %litScan.0.val149, %if.end81 ], [ %call25, %if.then23 ]
  %24 = getelementptr i8, ptr %litScan.0243, i64 8
...
land.lhs.true36:                                  ; preds = %clause_LiteralGetIndex.exit
  ...
  %tobool38.not = icmp eq i32 %and.i161, 0
...
clause_LiteralGetIndex.exit179:                   ; preds = %while.cond.i178
  ...
  %cmp47.not.not237 = icmp sgt i32 %call32.val146, 0
  br i1 %cmp47.not.not237, label %for.body49.lr.ph, label %for.end
...
for.body49:                                       ; preds = %for.body49.lr.ph, %if.end
  ...
  %restLits.0240 = phi ptr [ null, %for.body49.lr.ph ], [ %restLits.1, %if.end ]
  %tLits.0239 = phi ptr [ %call.i.i, %for.body49.lr.ph ], [ %tLits.1, %if.end ]
...
if.then59:                                        ; preds = %clause_LiteralAtom.exit188
  ...
  store ptr %tLits.0239, ptr %call.i, align 8
  ...
  store ptr %restLits.0240, ptr %call.i189, align 8
  br label %if.end

if.end:                                           ; preds = %if.then59, %clause_LiteralAtom.exit188, %for.body49
  %tLits.1 = phi ptr [ %call.i, %if.then59 ], [ %tLits.0239, %clause_LiteralAtom.exit188 ], [ %tLits.0239, %for.body49 ]
  %restLits.1 = phi ptr [ %call.i189, %if.then59 ], [ %restLits.0240, %clause_LiteralAtom.exit188 ], [ %restLits.0240, %for.body49 ]
...
if.then67:                                        ; preds = %lor.lhs.false, %for.end
  ...
  %arrayidx.i.i193 = getelementptr inbounds ptr, ptr %call68.val, i64 %indvars.iv255
...
if.end.i:                                         ; preds = %cont_Reset.exit
  %cmp.i18.i = icmp eq ptr %result.2244, null
...
for.end.i:                                        ; preds = %for.cond.i
  store ptr %result.2244, ptr %List1.addr.0.i, align 8
  br label %list_Nconc.exit

list_Nconc.exit:                                  ; preds = %cont_Reset.exit, %if.end.i, %for.end.i
  %retval.0.i196 = phi ptr [ %call77, %for.end.i ], [ %result.2244, %cont_Reset.exit ], [ %call77, %if.end.i ]
...
if.end80:                                         ; preds = %list_Delete.exit, %lor.lhs.false
  %result.3 = phi ptr [ %retval.0.i196, %list_Delete.exit ], [ %result.2244, %lor.lhs.false ]
...
if.end81:                                         ; preds = %while.body.i221, %list_Delete.exit213, %land.lhs.true36, %clause_LiteralGetIndex.exit
  %result.4 = phi ptr [ %result.2244, %land.lhs.true36 ], [ %result.2244, %clause_LiteralGetIndex.exit ], [ %result.3, %list_Delete.exit213 ], [ %result.3, %while.body.i221 ]
  %litScan.0.val149 = load ptr, ptr %litScan.0243, align 8
...
for.inc86:                                        ; preds = %if.end81, %if.then23, %for.body14, %term_IsAtom.exit, %land.lhs.true18
  %result.5 = phi ptr [ %result.1248, %land.lhs.true18 ], [ %result.1248, %term_IsAtom.exit ], [ %result.1248, %for.body14 ], [ %result.1248, %if.then23 ], [ %result.4, %if.end81 ]
  %L.val.i223 = load ptr, ptr %termList.0247, align 8
...
if.end89:                                         ; preds = %for.inc86, %if.then, %clause_LiteralPredicate.exit.i, %clause_LiteralAtom.exit.thread, %clause_LiteralIsSort.exit, %clause_LiteralAtom.exit
  %result.6 = phi ptr [ %result.0252, %clause_LiteralIsSort.exit ], [ %result.0252, %clause_LiteralAtom.exit ], [ %result.0252, %clause_LiteralAtom.exit.thread ], [ %result.0252, %clause_LiteralPredicate.exit.i ], [ %result.0252, %if.then ], [ %result.5, %for.inc86 ]
  %indvars.iv.next256 = add nsw i64 %indvars.iv255, 1
  %lftr.wideiv = trunc i64 %indvars.iv.next256 to i32
  %exitcond258.not = icmp eq i32 %9, %lftr.wideiv
  br i1 %exitcond258.not, label %for.end92, label %for.body, !llvm.loop !13
...
if.then:                                          ; preds = %entry
  ...
  %cmp.i.not551.i = icmp eq ptr %Foundlits, null
  br i1 %cmp.i.not551.i, label %for.end.i, label %for.body.i

for.body.i:                                       ; preds = %if.then, %for.body.i
  %depth.0553.i = phi i32 [ %call11.i, %for.body.i ], [ %Clause.val320.i, %if.then ]
  %Scan.0552.i = phi ptr [ %Scan.0.val308.i, %for.body.i ], [ %Foundlits, %if.then ]
  %1 = getelementptr i8, ptr %Scan.0552.i, i64 8
  ...
  %call11.i = tail call i32 @misc_Max(i32 noundef %depth.0553.i, i32 noundef %call9.val.i) #11
  %Scan.0.val308.i = load ptr, ptr %Scan.0552.i, align 8
...
clause_GetLiteralAtom.exit.i:                     ; preds = %if.then.i.i.i, %for.end.i
  ...
  %cmp.not.not554.i = icmp sgt i32 %call13.val.i, 0
  br i1 %cmp.not.not554.i, label %for.body22.lr.ph.i, label %for.end34.i
...
for.body22.i:                                     ; preds = %for.inc33.i, %for.body22.lr.ph.i
  ...
  %Constraint.0558.i = phi ptr [ null, %for.body22.lr.ph.i ], [ %Constraint.1.i, %for.inc33.i ]
  %ParentCls.0557.i = phi ptr [ null, %for.body22.lr.ph.i ], [ %ParentCls.1.i, %for.inc33.i ]
  %ParentLits.0555.i = phi ptr [ null, %for.body22.lr.ph.i ], [ %ParentLits.1.i, %for.inc33.i ]
...
clause_GetLiteralAtom.exit339.i:                  ; preds = %if.then.i.i337.i, %if.then.critedge.i
  ...
  store ptr %Constraint.0558.i, ptr %call.i340.i, align 8
...
if.else.i:                                        ; preds = %while.body.i.i
  ...
  store ptr %ParentCls.0557.i, ptr %call.i342.i, align 8
  ...
  store ptr %ParentLits.0555.i, ptr %call.i344.i, align 8
  br label %for.inc33.i

for.inc33.i:                                      ; preds = %if.else.i, %clause_GetLiteralAtom.exit339.i
  %ParentLits.1.i = phi ptr [ %call.i344.i, %if.else.i ], [ %ParentLits.0555.i, %clause_GetLiteralAtom.exit339.i ]
  %ParentCls.1.i = phi ptr [ %call.i342.i, %if.else.i ], [ %ParentCls.0557.i, %clause_GetLiteralAtom.exit339.i ]
  %Constraint.1.i = phi ptr [ %Constraint.0558.i, %if.else.i ], [ %call.i340.i, %clause_GetLiteralAtom.exit339.i ]
...
for.end34.i:                                      ; preds = %for.end34.loopexit.i, %clause_GetLiteralAtom.exit.i
  ...
  %cmp37.not563.i = icmp sgt i32 %i.0.lcssa.i, %sub.i346.i
  br i1 %cmp37.not563.i, label %for.end45.i, label %for.body39.lr.ph.i

for.body39.lr.ph.i:                               ; preds = %for.end34.i
  %25 = getelementptr i8, ptr %call13.i, i64 56
  %26 = zext i32 %i.0.lcssa.i to i64
  %wide.trip.count612.i = zext i32 %add.i.i.i to i64
  br label %for.body39.i

for.body39.i:                                     ; preds = %clause_GetLiteralAtom.exit356.i, %for.body39.lr.ph.i
  %indvars.iv609.i = phi i64 [ %26, %for.body39.lr.ph.i ], [ %indvars.iv.next610.i, %clause_GetLiteralAtom.exit356.i ]
  %Antecedent.0565.i = phi ptr [ null, %for.body39.lr.ph.i ], [ %call.i357.i, %clause_GetLiteralAtom.exit356.i ]
  %call13.val317.i = load ptr, ptr %25, align 8
  %arrayidx.i.i348.i = getelementptr inbounds ptr, ptr %call13.val317.i, i64 %indvars.iv609.i
...
clause_GetLiteralAtom.exit356.i:                  ; preds = %if.then.i.i354.i, %for.body39.i
  ...
  store ptr %Antecedent.0565.i, ptr %call.i357.i, align 8
  ...
  br i1 %exitcond613.not.i, label %for.end45.loopexit.i, label %for.body39.i, !llvm.loop !19
...
for.end45.loopexit.i:                             ; preds = %clause_GetLiteralAtom.exit356.i
  ...
  %.pre636.i = add i32 %.pre.i, %Clause.val6.i.i.pre.i
  br label %for.end45.i

for.end45.i:                                      ; preds = %for.end45.loopexit.i, %for.end34.i
  %add3.i.i.pre-phi.i = phi i32 [ %.pre636.i, %for.end45.loopexit.i ], [ %sub.i346.i, %for.end34.i ]
  ...
  %cmp48.not568.i = icmp sgt i32 %i.1.lcssa.i, %sub.i360.i
  br i1 %cmp48.not568.i, label %for.end56.i, label %for.body50.lr.ph.i
...
for.body50.i:                                     ; preds = %clause_GetLiteralAtom.exit370.i, %for.body50.lr.ph.i
  %indvars.iv614.i = phi i64 [ %34, %for.body50.lr.ph.i ], [ %indvars.iv.next615.i, %clause_GetLiteralAtom.exit370.i ]
  %Succedent.0570.i = phi ptr [ null, %for.body50.lr.ph.i ], [ %call.i371.i, %clause_GetLiteralAtom.exit370.i ]
  %call13.val316.i = load ptr, ptr %33, align 8
  %arrayidx.i.i362.i = getelementptr inbounds ptr, ptr %call13.val316.i, i64 %indvars.iv614.i
...
clause_GetLiteralAtom.exit370.i:                  ; preds = %if.then.i.i368.i, %for.body50.i
  ...
  store ptr %Succedent.0570.i, ptr %call.i371.i, align 8
  %indvars.iv.next615.i = add nuw nsw i64 %indvars.iv614.i, 1
  %40 = trunc i64 %indvars.iv614.i to i32
...
for.end56.i:                                      ; preds = %clause_GetLiteralAtom.exit370.i, %for.end45.i
  ...
  %cmp60.not.not588.i = icmp sgt i32 %Clause.val.i, 0
  br i1 %cmp60.not.not588.i, label %for.body62.lr.ph.i, label %for.end180.i
...
for.body62.preheader.i:                           ; preds = %for.body62.lr.ph.i
  %wide.trip.count630.i = zext i32 %Clause.val.i to i64
  br label %for.body62.i

for.body62.i:                                     ; preds = %for.inc178.i, %for.body62.preheader.i
  %indvars.iv627.i = phi i64 [ 0, %for.body62.preheader.i ], [ %indvars.iv.next628.i, %for.inc178.i ]
  %Constraint.2595.i = phi ptr [ %Constraint.0.lcssa.i, %for.body62.preheader.i ], [ %Constraint.7.i, %for.inc178.i ]
  %Antecedent.1594.i = phi ptr [ %Antecedent.0.lcssa.i, %for.body62.preheader.i ], [ %Antecedent.6.i, %for.inc178.i ]
  %Succedent.1593.i = phi ptr [ %Succedent.0.lcssa.i, %for.body62.preheader.i ], [ %Succedent.6.i, %for.inc178.i ]
  %Partners.0592.i = phi ptr [ %call.i.i, %for.body62.preheader.i ], [ %Partners.1.i, %for.inc178.i ]
  %ParentCls.2591.i = phi ptr [ %ParentCls.0.lcssa.i, %for.body62.preheader.i ], [ %ParentCls.3.i, %for.inc178.i ]
  %ParentLits.2589.i = phi ptr [ %ParentLits.0.lcssa.i, %for.body62.preheader.i ], [ %ParentLits.3.i, %for.inc178.i ]
  %43 = inttoptr i64 %indvars.iv627.i to ptr
...
if.then66.i:                                      ; preds = %while.body.i378.i
  ...
  %arrayidx.i.i385.i = getelementptr inbounds ptr, ptr %call13.val315.i, i64 %indvars.iv627.i
...
clause_GetLiteralAtom.exit393.i:                  ; preds = %if.then.i.i391.i, %if.then66.i
  ...
  %call68.i = call ptr @clause_CreateUnnormalized(ptr noundef %Constraint.2595.i, ptr noundef %Antecedent.1594.i, ptr noundef %Succedent.1593.i) #11
  %cmp.i.not5.i.i = icmp eq ptr %Constraint.2595.i, null
...
while.body.i395.i:                                ; preds = %clause_GetLiteralAtom.exit393.i, %while.body.i395.i
  %Current.06.i.i = phi ptr [ %L.addr.0.val.i.i, %while.body.i395.i ], [ %Constraint.2595.i, %clause_GetLiteralAtom.exit393.i ]
...
list_Delete.exit.i:                               ; preds = %while.body.i395.i, %clause_GetLiteralAtom.exit393.i
  %cmp.i.not5.i396.i = icmp eq ptr %Antecedent.1594.i, null
...
while.body.i403.i:                                ; preds = %list_Delete.exit.i, %while.body.i403.i
  %Current.06.i397.i = phi ptr [ %L.addr.0.val.i398.i, %while.body.i403.i ], [ %Antecedent.1594.i, %list_Delete.exit.i ]
...
list_Delete.exit404.i:                            ; preds = %while.body.i403.i, %list_Delete.exit.i
  %cmp.i.not5.i405.i = icmp eq ptr %Succedent.1593.i, null
...
while.body.i412.i:                                ; preds = %list_Delete.exit404.i, %while.body.i412.i
  %Current.06.i406.i = phi ptr [ %L.addr.0.val.i407.i, %while.body.i412.i ], [ %Succedent.1593.i, %list_Delete.exit404.i ]
...
clause_LiteralGetIndex.exit.i:                    ; preds = %while.cond.i.i
  ...
  store ptr %Partners.0592.i, ptr %call.i418.i, align 8
  ...
  store ptr %ParentCls.2591.i, ptr %call.i420.i, align 8
  ...
  store ptr %ParentLits.2589.i, ptr %call.i422.i, align 8
...
cont_Reset.exit.i:                                ; preds = %while.body.i431.i, %if.end107.i
  ...
  %cmp115572.i = icmp sgt i32 %add3.i.i, 0
  br i1 %cmp115572.i, label %for.body117.preheader.i, label %for.end146.i

for.body117.preheader.i:                          ; preds = %cont_Reset.exit.i
  %sub.i434.i = add i32 %add.i.i, -1
  %105 = sext i32 %Clause.val.i.i to i64
  %106 = and i64 %indvars.iv.i.i, 4294967295
  %107 = sext i32 %sub.i434.i to i64
  %wide.trip.count620.i = zext i32 %add3.i.i to i64
  br label %for.body117.i

for.body117.i:                                    ; preds = %for.inc144.i, %for.body117.preheader.i
  %indvars.iv617.i = phi i64 [ 0, %for.body117.preheader.i ], [ %indvars.iv.next618.i, %for.inc144.i ]
  %Constraint.3575.i = phi ptr [ null, %for.body117.preheader.i ], [ %Constraint.4.i, %for.inc144.i ]
  %Antecedent.2574.i = phi ptr [ null, %for.body117.preheader.i ], [ %Antecedent.3.i, %for.inc144.i ]
  %Succedent.2573.i = phi ptr [ null, %for.body117.preheader.i ], [ %Succedent.3.i, %for.inc144.i ]
  %cmp118.not.not.i = icmp slt i64 %indvars.iv617.i, %105
  br i1 %cmp118.not.not.i, label %if.then120.i, label %if.else125.i

if.then120.i:                                     ; preds = %for.body117.i
  %108 = load ptr, ptr %RightSubst.i, align 8
  %call86.val314.i = load ptr, ptr %75, align 8
  %arrayidx.i.i436.i = getelementptr inbounds ptr, ptr %call86.val314.i, i64 %indvars.iv617.i
...
clause_GetLiteralAtom.exit444.i:                  ; preds = %if.then.i.i442.i, %if.then120.i
  ...
  store ptr %Constraint.3575.i, ptr %call.i445.i, align 8
  br label %for.inc144.i

if.else125.i:                                     ; preds = %for.body117.i
  %cmp126.not.i = icmp sgt i64 %indvars.iv617.i, %107
...
if.then128.i:                                     ; preds = %if.else125.i
  ...
  %arrayidx.i.i448.i = getelementptr inbounds ptr, ptr %call86.val313.i, i64 %indvars.iv617.i
...
clause_GetLiteralAtom.exit456.i:                  ; preds = %if.then.i.i454.i, %if.then128.i
  ...
  store ptr %Antecedent.2574.i, ptr %call.i457.i, align 8
  br label %for.inc144.i

if.else133.i:                                     ; preds = %if.else125.i
  %cmp134.not.i = icmp eq i64 %indvars.iv617.i, %106
...
if.then136.i:                                     ; preds = %if.else133.i
  ...
  %arrayidx.i.i460.i = getelementptr inbounds ptr, ptr %call86.val312.i, i64 %indvars.iv617.i
...
clause_GetLiteralAtom.exit468.i:                  ; preds = %if.then.i.i466.i, %if.then136.i
  ...
  store ptr %Succedent.2573.i, ptr %call.i469.i, align 8
  br label %for.inc144.i
...
for.inc144.i:                                     ; preds = %clause_GetLiteralAtom.exit468.i, %if.else133.i, %clause_GetLiteralAtom.exit456.i, %clause_GetLiteralAtom.exit444.i
  %Succedent.3.i = phi ptr [ %Succedent.2573.i, %clause_GetLiteralAtom.exit444.i ], [ %Succedent.2573.i, %clause_GetLiteralAtom.exit456.i ], [ %call.i469.i, %clause_GetLiteralAtom.exit468.i ], [ %Succedent.2573.i, %if.else133.i ]
  %Antecedent.3.i = phi ptr [ %Antecedent.2574.i, %clause_GetLiteralAtom.exit444.i ], [ %call.i457.i, %clause_GetLiteralAtom.exit456.i ], [ %Antecedent.2574.i, %clause_GetLiteralAtom.exit468.i ], [ %Antecedent.2574.i, %if.else133.i ]
  %Constraint.4.i = phi ptr [ %call.i445.i, %clause_GetLiteralAtom.exit444.i ], [ %Constraint.3575.i, %clause_GetLiteralAtom.exit456.i ], [ %Constraint.3575.i, %clause_GetLiteralAtom.exit468.i ], [ %Constraint.3575.i, %if.else133.i ]
  %indvars.iv.next618.i = add nuw nsw i64 %indvars.iv617.i, 1
  %exitcond621.not.i = icmp eq i64 %indvars.iv.next618.i, %wide.trip.count620.i
  br i1 %exitcond621.not.i, label %for.end146.i, label %for.body117.i, !llvm.loop !22
...
for.end146.i:                                     ; preds = %for.inc144.i, %cont_Reset.exit.i
  ...
  %add.i473.i = add i32 %Clause.val6.i472.i, %Clause.val.i471.i
  ...
  %cmp152580.i = icmp sgt i32 %add3.i475.i, 0
  br i1 %cmp152580.i, label %for.body154.lr.ph.i, label %for.end176.i

for.body154.lr.ph.i:                              ; preds = %for.end146.i
  %sub.i478.i = add i32 %add.i473.i, -1
  %130 = getelementptr i8, ptr %call68.i, i64 56
  %131 = sext i32 %Clause.val.i471.i to i64
  %132 = sext i32 %sub.i478.i to i64
  %wide.trip.count625.i = zext i32 %add3.i475.i to i64
  br label %for.body154.i

for.body154.i:                                    ; preds = %for.inc174.i, %for.body154.lr.ph.i
  %indvars.iv622.i = phi i64 [ 0, %for.body154.lr.ph.i ], [ %indvars.iv.next623.i, %for.inc174.i ]
  %Constraint.5583.i = phi ptr [ %Constraint.3.lcssa.i, %for.body154.lr.ph.i ], [ %Constraint.6.i, %for.inc174.i ]
  %Antecedent.4582.i = phi ptr [ %Antecedent.2.lcssa.i, %for.body154.lr.ph.i ], [ %Antecedent.5.i, %for.inc174.i ]
  %Succedent.4581.i = phi ptr [ %Succedent.2.lcssa.i, %for.body154.lr.ph.i ], [ %Succedent.5.i, %for.inc174.i ]
  %cmp155.not.not.i = icmp slt i64 %indvars.iv622.i, %131
  br i1 %cmp155.not.not.i, label %if.then157.i, label %if.else161.i

if.then157.i:                                     ; preds = %for.body154.i
  %call68.val311.i = load ptr, ptr %130, align 8
  %arrayidx.i.i480.i = getelementptr inbounds ptr, ptr %call68.val311.i, i64 %indvars.iv622.i
...
clause_GetLiteralAtom.exit488.i:                  ; preds = %if.then.i.i486.i, %if.then157.i
  ...
  store ptr %Constraint.5583.i, ptr %call.i489.i, align 8
  br label %for.inc174.i

if.else161.i:                                     ; preds = %for.body154.i
  %cmp162.not.i = icmp sgt i64 %indvars.iv622.i, %132
  %call68.val309.i = load ptr, ptr %130, align 8
  %arrayidx.i.i504.i = getelementptr inbounds ptr, ptr %call68.val309.i, i64 %indvars.iv622.i
...
clause_GetLiteralAtom.exit500.i:                  ; preds = %if.then.i.i498.i, %if.then164.i
  ...
  store ptr %Antecedent.4582.i, ptr %call.i501.i, align 8
  br label %for.inc174.i
...
clause_GetLiteralAtom.exit512.i:                  ; preds = %if.then.i.i510.i, %if.else168.i
  ...
  store ptr %Succedent.4581.i, ptr %call.i513.i, align 8
  br label %for.inc174.i

for.inc174.i:                                     ; preds = %clause_GetLiteralAtom.exit512.i, %clause_GetLiteralAtom.exit500.i, %clause_GetLiteralAtom.exit488.i
  %Succedent.5.i = phi ptr [ %Succedent.4581.i, %clause_GetLiteralAtom.exit488.i ], [ %Succedent.4581.i, %clause_GetLiteralAtom.exit500.i ], [ %call.i513.i, %clause_GetLiteralAtom.exit512.i ]
  %Antecedent.5.i = phi ptr [ %Antecedent.4582.i, %clause_GetLiteralAtom.exit488.i ], [ %call.i501.i, %clause_GetLiteralAtom.exit500.i ], [ %Antecedent.4582.i, %clause_GetLiteralAtom.exit512.i ]
  %Constraint.6.i = phi ptr [ %call.i489.i, %clause_GetLiteralAtom.exit488.i ], [ %Constraint.5583.i, %clause_GetLiteralAtom.exit500.i ], [ %Constraint.5583.i, %clause_GetLiteralAtom.exit512.i ]
  ...
  br i1 %exitcond626.not.i, label %for.end176.i, label %for.body154.i, !llvm.loop !23
...
for.inc178.i:                                     ; preds = %if.end.i381.i, %for.end176.i
  %ParentLits.3.i = phi ptr [ %call.i422.i, %for.end176.i ], [ %ParentLits.2589.i, %if.end.i381.i ]
  %ParentCls.3.i = phi ptr [ %call.i420.i, %for.end176.i ], [ %ParentCls.2591.i, %if.end.i381.i ]
  %Partners.1.i = phi ptr [ %call.i418.i, %for.end176.i ], [ %Partners.0592.i, %if.end.i381.i ]
  %Succedent.6.i = phi ptr [ %Succedent.4.lcssa.i, %for.end176.i ], [ %Succedent.1593.i, %if.end.i381.i ]
  %Antecedent.6.i = phi ptr [ %Antecedent.4.lcssa.i, %for.end176.i ], [ %Antecedent.1594.i, %if.end.i381.i ]
  %Constraint.7.i = phi ptr [ %Constraint.5.lcssa.i, %for.end176.i ], [ %Constraint.2595.i, %if.end.i381.i ]
  %indvars.iv.next628.i = add nuw nsw i64 %indvars.iv627.i, 1
  %exitcond631.not.i = icmp eq i64 %indvars.iv.next628.i, %wide.trip.count630.i
  br i1 %exitcond631.not.i, label %for.end180.i, label %for.body62.i, !llvm.loop !24
...
entry:
  ...
  %add3.i.i = add i32 %add.i.i, -1
  %sub.i = add i32 %add3.i.i, %Clause.val7.i.i
  %cmp.not305 = icmp sgt i32 %add.i.i, %sub.i
  br i1 %cmp.not305, label %for.end114, label %for.body.lr.ph
...
for.body:                                         ; preds = %for.body.lr.ph, %if.end111
  %indvars.iv313 = phi i64 [ %8, %for.body.lr.ph ], [ %indvars.iv.next314, %if.end111 ]
  %result.0307 = phi ptr [ null, %for.body.lr.ph ], [ %result.7, %if.end111 ]
  %GivenClause.val172 = load ptr, ptr %3, align 8
  %arrayidx.i = getelementptr inbounds ptr, ptr %GivenClause.val172, i64 %indvars.iv313
  %10 = load ptr, ptr %arrayidx.i, align 8
  %11 = getelementptr i8, ptr %10, i64 24
...
if.then:                                          ; preds = %clause_LiteralIsSort.exit
  ...
  %cmp.i188.not301 = icmp eq ptr %call10, null
  br i1 %cmp.i188.not301, label %if.end111, label %for.body14

for.body14:                                       ; preds = %if.then, %for.inc108
  %result.1303 = phi ptr [ %result.6, %for.inc108 ], [ %result.0307, %if.then ]
  %unifiers.0302 = phi ptr [ %L.val.i275, %for.inc108 ], [ %call10, %if.then ]
  %21 = getelementptr i8, ptr %unifiers.0302, i64 8
...
term_IsAtom.exit:                                 ; preds = %for.body14
  ...
  %cmp.i.i192.not = icmp eq i32 %and.i.i.i191, 2
  br i1 %cmp.i.i192.not, label %land.lhs.true18, label %for.inc108
...
if.then23:                                        ; preds = %land.lhs.true18
  ...
  %cmp.i195.not297 = icmp eq ptr %call25, null
  br i1 %cmp.i195.not297, label %for.inc108, label %for.body30

for.body30:                                       ; preds = %if.then23, %if.end103
  %result.2299 = phi ptr [ %result.5, %if.end103 ], [ %result.1303, %if.then23 ]
  %litScan.0298 = phi ptr [ %litScan.0.val184, %if.end103 ], [ %call25, %if.then23 ]
  %24 = getelementptr i8, ptr %litScan.0298, i64 8
  %litScan.0.val = load ptr, ptr %24, align 8
  %25 = getelementptr i8, ptr %litScan.0.val, i64 16
...
land.lhs.true36:                                  ; preds = %clause_LiteralGetIndex.exit
  ...
  %tobool38.not = icmp eq i32 %and.i197, 0
...
clause_LiteralGetIndex.exit215:                   ; preds = %while.cond.i214
  ...
  %add.i.i219 = add i32 %call32.val183, -1
  %add3.i.i220 = add i32 %add.i.i219, %Clause.val6.i.i217
  %sub.i221 = add i32 %add3.i.i220, %Clause.val7.i.i218
  %cmp51289.not = icmp sgt i32 %call32.val183, %sub.i221
  br i1 %cmp51289.not, label %if.then59, label %for.body53.preheader
...
if.then59:                                        ; preds = %clause_LiteralGetIndex.exit215, %for.end
  ...
  store ptr null, ptr %call.i.i, align 8
  %cmp64.not.not291 = icmp sgt i32 %call32.val183, 0
  br i1 %cmp64.not.not291, label %for.body66.preheader, label %for.end84
...
for.body66:                                       ; preds = %for.body66.preheader, %if.end81
  %indvars.iv310 = phi i64 [ 0, %for.body66.preheader ], [ %indvars.iv.next311, %if.end81 ]
  %restLits.0294 = phi ptr [ null, %for.body66.preheader ], [ %restLits.1, %if.end81 ]
  %tLits.0293 = phi ptr [ %call.i.i, %for.body66.preheader ], [ %tLits.1, %if.end81 ]
  %cmp68.not = icmp eq i64 %indvars.iv310, %50
  br i1 %cmp68.not, label %if.end81, label %land.lhs.true70

land.lhs.true70:                                  ; preds = %for.body66
  %call32.val = load ptr, ptr %26, align 8
  %arrayidx.i225 = getelementptr inbounds ptr, ptr %call32.val, i64 %indvars.iv310
...
if.then76:                                        ; preds = %clause_LiteralAtom.exit232
  %59 = inttoptr i64 %indvars.iv310 to ptr
  %call.i = call ptr @memory_Malloc(i32 noundef 16) #11
  %car.i = getelementptr inbounds %struct.LIST_HELP, ptr %call.i, i64 0, i32 1
  store ptr %59, ptr %car.i, align 8
  store ptr %tLits.0293, ptr %call.i, align 8
  ...
  store ptr %restLits.0294, ptr %call.i233, align 8
  br label %if.end81

if.end81:                                         ; preds = %if.then76, %clause_LiteralAtom.exit232, %for.body66
  %tLits.1 = phi ptr [ %call.i, %if.then76 ], [ %tLits.0293, %clause_LiteralAtom.exit232 ], [ %tLits.0293, %for.body66 ]
  %restLits.1 = phi ptr [ %call.i233, %if.then76 ], [ %restLits.0294, %clause_LiteralAtom.exit232 ], [ %restLits.0294, %for.body66 ]
...
if.then88:                                        ; preds = %lor.lhs.false, %for.end84
  ...
  %arrayidx.i.i238 = getelementptr inbounds ptr, ptr %call89.val, i64 %indvars.iv313
...
if.end.i:                                         ; preds = %cont_Reset.exit
  %cmp.i18.i = icmp eq ptr %result.2299, null
  br i1 %cmp.i18.i, label %list_Nconc.exit, label %for.cond.i
...
for.end.i:                                        ; preds = %for.cond.i
  store ptr %result.2299, ptr %List1.addr.0.i, align 8
  br label %list_Nconc.exit

list_Nconc.exit:                                  ; preds = %cont_Reset.exit, %if.end.i, %for.end.i
  %retval.0.i248 = phi ptr [ %call98, %for.end.i ], [ %result.2299, %cont_Reset.exit ], [ %call98, %if.end.i ]
...
if.end101:                                        ; preds = %list_Delete.exit, %lor.lhs.false
  %result.3 = phi ptr [ %retval.0.i248, %list_Delete.exit ], [ %result.2299, %lor.lhs.false ]
...
if.end103:                                        ; preds = %while.body.i273, %for.end, %list_Delete.exit265, %land.lhs.true39, %land.lhs.true36, %clause_LiteralGetIndex.exit
  %result.5 = phi ptr [ %result.2299, %land.lhs.true39 ], [ %result.2299, %land.lhs.true36 ], [ %result.2299, %clause_LiteralGetIndex.exit ], [ %result.2299, %for.end ], [ %result.3, %list_Delete.exit265 ], [ %result.3, %while.body.i273 ]
  %litScan.0.val184 = load ptr, ptr %litScan.0298, align 8
...
for.inc108:                                       ; preds = %if.end103, %if.then23, %for.body14, %term_IsAtom.exit, %land.lhs.true18
  %result.6 = phi ptr [ %result.1303, %land.lhs.true18 ], [ %result.1303, %term_IsAtom.exit ], [ %result.1303, %for.body14 ], [ %result.1303, %if.then23 ], [ %result.5, %if.end103 ]
  %L.val.i275 = load ptr, ptr %unifiers.0302, align 8
...
if.end111:                                        ; preds = %for.inc108, %if.then, %clause_LiteralPredicate.exit.i, %clause_LiteralAtom.exit.thread, %clause_LiteralIsSort.exit, %clause_LiteralAtom.exit
  %result.7 = phi ptr [ %result.0307, %clause_LiteralIsSort.exit ], [ %result.0307, %clause_LiteralAtom.exit ], [ %result.0307, %clause_LiteralAtom.exit.thread ], [ %result.0307, %clause_LiteralPredicate.exit.i ], [ %result.0307, %if.then ], [ %result.6, %for.inc108 ]
  %indvars.iv.next314 = add nsw i64 %indvars.iv313, 1
  %lftr.wideiv = trunc i64 %indvars.iv.next314 to i32
  %exitcond316.not = icmp eq i32 %9, %lftr.wideiv
  br i1 %exitcond316.not, label %for.end114, label %for.body, !llvm.loop !34
...
land.lhs.true33:                                  ; preds = %land.lhs.true
  ...
  %tobool35.not = icmp eq i32 %and.i85, 0
...
lor.lhs.false:                                    ; preds = %land.lhs.true36
  ...
  %cmp.i90 = icmp eq i32 %call28.val75, 0
  br i1 %cmp.i90, label %land.lhs.true42, label %if.end
...
entry:
  ...
  %cmp.i.not354 = icmp eq ptr %TLits, null
  br i1 %cmp.i.not354, label %for.end, label %for.body.lr.ph
...
for.end:                                          ; preds = %for.body, %entry
  ...
  %cmp.i181.not356 = icmp eq ptr %Unifiers, null
  br i1 %cmp.i181.not356, label %for.end20, label %for.body12

for.body12:                                       ; preds = %for.end, %for.body12
  %scan.1357 = phi ptr [ %scan.1.val174, %for.body12 ], [ %Unifiers, %for.end ]
  %10 = load ptr, ptr @stdout, align 8
  %call.i183 = tail call i32 @putc(i32 noundef 10, ptr noundef %10)
  %11 = getelementptr i8, ptr %scan.1357, i64 8
  ...
  %scan.1.val174 = load ptr, ptr %scan.1357, align 8
...
for.body35:                                       ; preds = %for.body35.lr.ph, %sort_PairDelete.exit
  %SojuList.addr.0374 = phi ptr [ %SojuList, %for.body35.lr.ph ], [ %L.val.i311, %sort_PairDelete.exit ]
  %result.0373 = phi ptr [ null, %for.body35.lr.ph ], [ %result.3, %sort_PairDelete.exit ]
  %45 = getelementptr i8, ptr %SojuList.addr.0374, i64 8
...
do.body:                                          ; preds = %do.cond, %if.then43
  %result.1 = phi ptr [ %result.0373, %if.then43 ], [ %result.2, %do.cond ]
  ...
  %cmp.i200358 = icmp eq ptr %symbolScan.0, null
  %cmp.i202.not359 = icmp eq ptr %unifierScan.0, null
  %or.cond360 = select i1 %cmp.i200358, i1 true, i1 %cmp.i202.not359
  br i1 %or.cond360, label %while.end, label %while.body

while.body:                                       ; preds = %do.body, %if.end80
  %subset.1363 = phi ptr [ %subset.2, %if.end80 ], [ %subset.0, %do.body ]
  %unifierScan.1362 = phi ptr [ %unifierScan.2, %if.end80 ], [ %unifierScan.0, %do.body ]
  %symbolScan.1361 = phi ptr [ %symbolScan.2, %if.end80 ], [ %symbolScan.0, %do.body ]
  %54 = getelementptr i8, ptr %unifierScan.1362, i64 8
...
clause_LiteralPredicate.exit211:                  ; preds = %while.body, %if.then.i.i209
  ...
  %59 = getelementptr i8, ptr %symbolScan.1361, i64 8
...
if.then65:                                        ; preds = %clause_LiteralAtom.exit
  ...
  store ptr %symbolScan.1361, ptr %arrayidx.i218, align 8
  %unifierScan.1.val173 = load ptr, ptr %unifierScan.1362, align 8
  ...
  store ptr %subset.1363, ptr %call.i222, align 8
  %symbolScan.1.val172 = load ptr, ptr %symbolScan.1361, align 8
...
while.end.thread:                                 ; preds = %if.then65
  %unifierScan.1.val171 = load ptr, ptr %unifierScan.1362, align 8
  br label %if.then83
...
if.end80.sink.split:                              ; preds = %clause_LiteralPredicate.exit211, %if.then.i229, %while.end.i
  %unifierScan.1.val170 = load ptr, ptr %unifierScan.1362, align 8
  br label %if.end80

if.end80:                                         ; preds = %if.end80.sink.split, %if.then65
  %symbolScan.2 = phi ptr [ %symbolScan.1.val172, %if.then65 ], [ %symbolScan.1361, %if.end80.sink.split ]
  %unifierScan.2 = phi ptr [ %call26, %if.then65 ], [ %unifierScan.1.val170, %if.end80.sink.split ]
  %subset.2 = phi ptr [ %call.i222, %if.then65 ], [ %subset.1363, %if.end80.sink.split ]
...
while.end:                                        ; preds = %if.end80, %do.body
  ...
  %cmp.i200.lcssa = phi i1 [ %cmp.i200358, %do.body ], [ %cmp.i200, %if.end80 ]
  br i1 %cmp.i200.lcssa, label %if.then83, label %if.end87

if.then83:                                        ; preds = %while.end.thread, %while.end
  %subset.1.lcssa401 = phi ptr [ %call.i222, %while.end.thread ], [ %subset.1.lcssa, %while.end ]
  %unifierScan.1.lcssa400 = phi ptr [ %unifierScan.1.val171, %while.end.thread ], [ %unifierScan.1.lcssa, %while.end ]
  %symbolScan.1.lcssa398 = phi ptr [ null, %while.end.thread ], [ %symbolScan.1.lcssa, %while.end ]
...
for.cond66.preheader.i:                           ; preds = %for.body53.i, %for.end47.i
  ...
  %cmp.i344.not515.i = icmp eq ptr %subset.1.lcssa401, null
...
for.body70.i:                                     ; preds = %for.cond66.preheader.i, %for.end112.i
  %scan.4523.i = phi ptr [ %scan.4.val300.i, %for.end112.i ], [ %subset.1.lcssa401, %for.cond66.preheader.i ]
...
for.end97.loopexit.i:                             ; preds = %clause_GetLiteralAtom.exit370.i
  ...
  %.pre380 = add i32 %Clause.val.i.i.pre.i, %Clause.val6.i.i.pre.i
  br label %for.end97.i

for.end97.i:                                      ; preds = %for.end97.loopexit.i, %for.end84.i
  %add.i.i373.i.pre-phi = phi i32 [ %.pre380, %for.end97.loopexit.i ], [ %add.i.i.i, %for.end84.i ]
...
for.end97.i.for.end112.i_crit_edge:               ; preds = %for.end97.i
  %.pre381 = shl i64 %indvars.iv.i.i239, 32
  %.pre382 = ashr exact i64 %.pre381, 32
...
for.end112.i:                                     ; preds = %for.inc110.i, %for.end97.i.for.end112.i_crit_edge
  %conv117.i.pre-phi = phi i64 [ %.pre382, %for.end97.i.for.end112.i_crit_edge ], [ %sext554.i, %for.inc110.i ]
...
for.body129.i:                                    ; preds = %for.inc144.i, %for.body129.lr.ph.i
  ...
  br i1 %cmp.i.not354, label %if.then133.critedge.i, label %while.body.i.i
...
for.end159.loopexit.i:                            ; preds = %clause_GetLiteralAtom.exit423.i
  ...
  %.pre379 = add i32 %Clause.val.i.i426.pre.i, %Clause.val6.i.i427.pre.i
  br label %for.end159.i

for.end159.i:                                     ; preds = %for.end159.loopexit.i, %for.end146.i
  %add.i.i429.i.pre-phi = phi i32 [ %.pre379, %for.end159.loopexit.i ], [ %add.i.i412.i, %for.end146.i ]
...
while.body.i332:                                  ; preds = %if.end.i338, %list_Delete.exit466.i
  %185 = phi i32 [ %or.i.i, %list_Delete.exit466.i ], [ %189, %if.end.i338 ]
  %Result.val100110.i = phi i32 [ %.promoted.i, %list_Delete.exit466.i ], [ %cond.i336, %if.end.i338 ]
  %l.0109.i = phi i32 [ %183, %list_Delete.exit466.i ], [ %l.1.i, %if.end.i338 ]
  %Scan.0108.i = phi ptr [ %call.i445.i, %list_Delete.exit466.i ], [ %Scan.0.val.i, %if.end.i338 ]
  ...
  %188 = and i32 %call1.val.i331, 8
  %tobool3.not.i = icmp eq i32 %188, 0
  br i1 %tobool3.not.i, label %if.end.i338, label %if.then.i334
...
if.end.i338:                                      ; preds = %if.then.i334, %while.body.i332
  %189 = phi i32 [ %or.i.i333, %if.then.i334 ], [ %185, %while.body.i332 ]
  %190 = getelementptr i8, ptr %Scan.0.val98.i, i64 12
  %call1.val101.i = load i32, ptr %190, align 4
  %cmp.i335 = icmp ugt i32 %call1.val101.i, %Result.val100110.i
  %Scan.0.val98.Result.i = select i1 %cmp.i335, ptr %Scan.0.val98.i, ptr %call174.i
  %cond.in.i = getelementptr i8, ptr %Scan.0.val98.Result.i, i64 12
  %cond.i336 = load i32, ptr %cond.in.i, align 4
  store i32 %cond.i336, ptr %184, align 4
  ...
  %l.1.i = tail call i32 @llvm.umax.i32(i32 %l.0109.i, i32 %191)
  %Scan.0.val.i = load ptr, ptr %Scan.0108.i, align 8
  %cmp.i.not.i337 = icmp eq ptr %Scan.0.val.i, null
  br i1 %cmp.i.not.i337, label %while.end.i339, label %while.body.i332, !llvm.loop !60

while.end.i339:                                   ; preds = %if.end.i338
  %cmp15.i = icmp ugt i32 %l.1.i, %183
  br i1 %cmp15.i, label %if.then16.i, label %if.end29.i

if.then16.i:                                      ; preds = %while.end.i339
...
if.then18.i:                                      ; preds = %if.then16.i
  %mul.i = shl i32 %183, 3
  %cmp.i.i.i340 = icmp ult i32 %mul.i, 1024
  br i1 %cmp.i.i.i340, label %if.else25.i.i, label %if.then.i.i341

if.then.i.i341:                                   ; preds = %if.then18.i
...
if.then9.i.i:                                     ; preds = %if.then.i.i341
  %197 = load ptr, ptr %add.ptr1.i.i, align 8
  store ptr %197, ptr %196, align 8
  br label %if.end13.i.i

if.end13.i.i:                                     ; preds = %if.then9.i.i, %if.then.i.i341
  %198 = load i32, ptr @memory_MARKSIZE, align 4
  %add.i.i342 = add i32 %198, %RealSize.1.i.i.i.i
  %conv.i104.i = zext i32 %add.i.i342 to i64
...
if.else25.i.i:                                    ; preds = %if.then18.i
  %idxprom.i.i343 = zext i32 %mul.i to i64
  %arrayidx.i.i344 = getelementptr inbounds [0 x ptr], ptr @memory_ARRAY, i64 0, i64 %idxprom.i.i343
  %201 = load ptr, ptr %arrayidx.i.i344, align 8
  ...
  %205 = load ptr, ptr %arrayidx.i.i344, align 8
...
if.end29.thread.i:                                ; preds = %if.else25.i.i, %if.end23.i.i, %if.then16.i
  ...
  br label %for.body.lr.ph.i345

if.end29.i:                                       ; preds = %while.end.i339
  %cmp31111.not.i = icmp eq i32 %183, 0
  br i1 %cmp31111.not.i, label %while.body38.lr.ph.i, label %for.body.lr.ph.i345

for.body.lr.ph.i345:                              ; preds = %if.end29.i, %if.end29.thread.i
  %splitfield33.i = getelementptr inbounds %struct.CLAUSE_HELP, ptr %call174.i, i64 0, i32 4
  br label %for.body.i349

while.body38.lr.ph.i:                             ; preds = %for.body.i349, %if.end29.i
  %splitfield46.i = getelementptr inbounds %struct.CLAUSE_HELP, ptr %call174.i, i64 0, i32 4
  br label %while.body38.i

for.body.i349:                                    ; preds = %for.body.i349, %for.body.lr.ph.i345
  %indvars.iv.i346 = phi i64 [ 0, %for.body.lr.ph.i345 ], [ %indvars.iv.next.i348, %for.body.i349 ]
  %206 = load ptr, ptr %splitfield33.i, align 8
  %arrayidx.i347 = getelementptr inbounds i64, ptr %206, i64 %indvars.iv.i346
  store i64 0, ptr %arrayidx.i347, align 8
  %indvars.iv.next.i348 = add nuw nsw i64 %indvars.iv.i346, 1
  %207 = load i32, ptr %splitfield_length.i, align 8
  %208 = zext i32 %207 to i64
  %cmp31.i = icmp ult i64 %indvars.iv.next.i348, %208
  br i1 %cmp31.i, label %for.body.i349, label %while.body38.lr.ph.i, !llvm.loop !61
...
while.body38.i:                                   ; preds = %while.cond34.loopexit.i, %while.body38.lr.ph.i
  ...
  %209 = getelementptr i8, ptr %List.addr.0116.i, i64 8
  ...
  %cmp43113.not.i = icmp eq i32 %210, 0
...
for.body45.i:                                     ; preds = %for.body45.i, %for.body45.lr.ph.i
  ...
  %arrayidx48.i = getelementptr inbounds i64, ptr %211, i64 %indvars.iv118.i
  %212 = load i64, ptr %arrayidx48.i, align 8
  %213 = load ptr, ptr %splitfield49.i, align 8
  %arrayidx51.i = getelementptr inbounds i64, ptr %213, i64 %indvars.iv118.i
  ...
  %cmp43.i = icmp ult i64 %indvars.iv.next119.i, %216
...
if.end87:                                         ; preds = %inf_ApplyWeakening.exit, %while.end
  %subset.1.lcssa402 = phi ptr [ %subset.1.lcssa, %while.end ], [ %subset.1.lcssa401, %inf_ApplyWeakening.exit ]
  %unifierScan.1.lcssa399 = phi ptr [ %unifierScan.1.lcssa, %while.end ], [ %unifierScan.1.lcssa400, %inf_ApplyWeakening.exit ]
  %symbolScan.1.lcssa397 = phi ptr [ %symbolScan.1.lcssa, %while.end ], [ %symbolScan.1.lcssa398, %inf_ApplyWeakening.exit ]
  %result.2 = phi ptr [ %result.1, %while.end ], [ %call.i.i.i, %inf_ApplyWeakening.exit ]
  %222 = load i32, ptr @stack_POINTER, align 4
  %cmp.i248369 = icmp eq i32 %222, %38
  br i1 %cmp.i248369, label %do.cond, label %land.rhs91

land.rhs91:                                       ; preds = %if.end87, %cont_BackTrack.exit270
  %223 = phi i32 [ %243, %cont_BackTrack.exit270 ], [ %222, %if.end87 ]
  %subset.3370 = phi ptr [ %L.val.i, %cont_BackTrack.exit270 ], [ %subset.1.lcssa402, %if.end87 ]
  %sub.i = add i32 %223, -1
  ...
  %224 = load ptr, ptr %arrayidx.i251, align 8
  %cmp.i252 = icmp eq ptr %224, null
  %sub.i254 = add i32 %223, -2
...
while.body.i262.preheader:                        ; preds = %while.body96
  %xtraiter420 = and i32 %.pr.i255, 1
  %lcmp.mod421.not = icmp eq i32 %xtraiter420, 0
  br i1 %lcmp.mod421.not, label %while.body.i262.prol.loopexit, label %while.body.i262.prol
...
while.body.i262.prol:                             ; preds = %while.body.i262.preheader
  ...
  %call.val.i.i.i257.prol = load ptr, ptr %226, align 8
  store ptr %call.val.i.i.i257.prol, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i258.prol = getelementptr inbounds %struct.binding, ptr %225, i64 0, i32 1
  ...
  %link.i.i.i.i259.prol = getelementptr inbounds %struct.binding, ptr %227, i64 0, i32 4
...
while.body.i262.prol.loopexit:                    ; preds = %while.body.i262.prol, %while.body.i262.preheader
  %.unr422 = phi i32 [ %.pr.i255, %while.body.i262.preheader ], [ %dec.i.i.i260.prol, %while.body.i262.prol ]
  %228 = icmp eq i32 %.pr.i255, 1
  br i1 %228, label %while.end.i264, label %while.body.i262

while.body.i262:                                  ; preds = %while.body.i262.prol.loopexit, %while.body.i262
  %229 = phi i32 [ %dec.i.i.i260.1, %while.body.i262 ], [ %.unr422, %while.body.i262.prol.loopexit ]
  ...
  %call.val.i.i.i257 = load ptr, ptr %231, align 8
  store ptr %call.val.i.i.i257, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i258 = getelementptr inbounds %struct.binding, ptr %230, i64 0, i32 1
  ...
  %link.i.i.i.i259 = getelementptr inbounds %struct.binding, ptr %232, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i259, align 8
  %dec.i.i.i260 = add nsw i32 %229, -1
  ...
  %call.val.i.i.i257.1 = load ptr, ptr %234, align 8
  store ptr %call.val.i.i.i257.1, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i258.1 = getelementptr inbounds %struct.binding, ptr %233, i64 0, i32 1
  ...
  %link.i.i.i.i259.1 = getelementptr inbounds %struct.binding, ptr %235, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i259.1, align 8
  %dec.i.i.i260.1 = add nsw i32 %229, -2
...
if.then.i268:                                     ; preds = %while.end.i264
  ...
  %237 = load i32, ptr %arrayidx.i.i267, align 4
...
cont_BackTrack.exit270:                           ; preds = %while.end.i264, %if.then.i268
  %L.val.i = load ptr, ptr %subset.3370, align 8
...
if.then102:                                       ; preds = %land.rhs91
  ...
  %244 = load ptr, ptr %arrayidx.i277, align 8
...
while.body.i285.preheader:                        ; preds = %if.then102
  %xtraiter423 = and i32 %.pr.i278, 1
  %lcmp.mod424.not = icmp eq i32 %xtraiter423, 0
  br i1 %lcmp.mod424.not, label %while.body.i285.prol.loopexit, label %while.body.i285.prol
...
while.body.i285.prol:                             ; preds = %while.body.i285.preheader
  ...
  %call.val.i.i.i280.prol = load ptr, ptr %246, align 8
  store ptr %call.val.i.i.i280.prol, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i281.prol = getelementptr inbounds %struct.binding, ptr %245, i64 0, i32 1
  ...
  %link.i.i.i.i282.prol = getelementptr inbounds %struct.binding, ptr %247, i64 0, i32 4
...
while.body.i285.prol.loopexit:                    ; preds = %while.body.i285.prol, %while.body.i285.preheader
  %.unr425 = phi i32 [ %.pr.i278, %while.body.i285.preheader ], [ %dec.i.i.i283.prol, %while.body.i285.prol ]
  %248 = icmp eq i32 %.pr.i278, 1
  br i1 %248, label %while.end.i287, label %while.body.i285

while.body.i285:                                  ; preds = %while.body.i285.prol.loopexit, %while.body.i285
  %249 = phi i32 [ %dec.i.i.i283.1, %while.body.i285 ], [ %.unr425, %while.body.i285.prol.loopexit ]
  ...
  %call.val.i.i.i280 = load ptr, ptr %251, align 8
  store ptr %call.val.i.i.i280, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i281 = getelementptr inbounds %struct.binding, ptr %250, i64 0, i32 1
  ...
  %link.i.i.i.i282 = getelementptr inbounds %struct.binding, ptr %252, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i282, align 8
  %dec.i.i.i283 = add nsw i32 %249, -1
  ...
  %call.val.i.i.i280.1 = load ptr, ptr %254, align 8
  store ptr %call.val.i.i.i280.1, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i281.1 = getelementptr inbounds %struct.binding, ptr %253, i64 0, i32 1
  ...
  %link.i.i.i.i282.1 = getelementptr inbounds %struct.binding, ptr %255, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i282.1, align 8
  %dec.i.i.i283.1 = add nsw i32 %249, -2
...
if.then.i291:                                     ; preds = %while.end.i287
  ...
  %257 = load i32, ptr %arrayidx.i.i290, align 4
...
cont_BackTrack.exit293:                           ; preds = %while.end.i287, %if.then.i291
  %L.val.i294 = load ptr, ptr %subset.3370, align 8
  %258 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i295 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %258, i64 0, i32 4
  %259 = load i32, ptr %total_size.i.i.i295, align 8
  %conv26.i.i.i296 = sext i32 %259 to i64
  %260 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i297 = add i64 %260, %conv26.i.i.i296
  store i64 %add27.i.i.i297, ptr @memory_FREEDBYTES, align 8
  %261 = load ptr, ptr %258, align 8
  store ptr %261, ptr %subset.3370, align 8
  %262 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %subset.3370, ptr %262, align 8
  %.pre = load i32, ptr @stack_POINTER, align 4
  br label %do.cond

do.cond:                                          ; preds = %cont_BackTrack.exit270, %if.end87, %cont_BackTrack.exit293
  %263 = phi i32 [ %.pre, %cont_BackTrack.exit293 ], [ %38, %if.end87 ], [ %38, %cont_BackTrack.exit270 ]
  %symbolScan.3 = phi ptr [ %244, %cont_BackTrack.exit293 ], [ %symbolScan.1.lcssa397, %if.end87 ], [ %symbolScan.1.lcssa397, %cont_BackTrack.exit270 ]
  %unifierScan.3 = phi ptr [ %224, %cont_BackTrack.exit293 ], [ %unifierScan.1.lcssa399, %if.end87 ], [ %unifierScan.1.lcssa399, %cont_BackTrack.exit270 ]
  %subset.4 = phi ptr [ %L.val.i294, %cont_BackTrack.exit293 ], [ %subset.1.lcssa402, %if.end87 ], [ %L.val.i, %cont_BackTrack.exit270 ]
  %cmp.i298 = icmp eq i32 %263, %38
  %cmp.i300.not = icmp eq ptr %unifierScan.3, null
  %or.cond351 = select i1 %cmp.i298, i1 %cmp.i300.not, i1 false
  br i1 %or.cond351, label %do.end, label %do.body, !llvm.loop !65
...
while.body.i306:                                  ; preds = %do.end, %while.body.i306
  ...
  %total_size.i.i.i302 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %264, i64 0, i32 4
  %265 = load i32, ptr %total_size.i.i.i302, align 8
  %conv26.i.i.i303 = sext i32 %265 to i64
  %266 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i304 = add i64 %266, %conv26.i.i.i303
...
if.end113:                                        ; preds = %while.body.i306, %do.end, %clause_LiteralPredicate.exit
  %result.3 = phi ptr [ %result.0373, %clause_LiteralPredicate.exit ], [ %result.2, %do.end ], [ %result.2, %while.body.i306 ]
...
sort_PairDelete.exit:                             ; preds = %while.body.i.i.i, %if.end113
  ...
  %total_size.i.i.i.i308 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %275, i64 0, i32 4
  %276 = load i32, ptr %total_size.i.i.i.i308, align 8
  %conv26.i.i.i.i309 = sext i32 %276 to i64
  %277 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i.i310 = add i64 %277, %conv26.i.i.i.i309
  ...
  %L.val.i311 = load ptr, ptr %SojuList.addr.0374, align 8
  %280 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i312 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %280, i64 0, i32 4
  %281 = load i32, ptr %total_size.i.i.i312, align 8
  %conv26.i.i.i313 = sext i32 %281 to i64
  %282 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i314 = add i64 %282, %conv26.i.i.i313
  store i64 %add27.i.i.i314, ptr @memory_FREEDBYTES, align 8
  %283 = load ptr, ptr %280, align 8
  store ptr %283, ptr %SojuList.addr.0374, align 8
  %284 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %SojuList.addr.0374, ptr %284, align 8
...
for.body.i318:                                    ; preds = %sort_PairDelete.exit, %for.body.i318
  ...
  %Literals.addr.0.val.i315 = load ptr, ptr %285, align 8
  %286 = getelementptr i8, ptr %Literals.addr.0.val.i315, i64 16
  %call1.val.i316 = load ptr, ptr %286, align 8
...
while.body.i327:                                  ; preds = %for.body.i318, %while.body.i327
  ...
  %total_size.i.i.i323 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %287, i64 0, i32 4
  %288 = load i32, ptr %total_size.i.i.i323, align 8
  %conv26.i.i.i324 = sext i32 %288 to i64
  %289 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i325 = add i64 %289, %conv26.i.i.i324
  store i64 %add27.i.i.i325, ptr @memory_FREEDBYTES, align 8
  %290 = load ptr, ptr %287, align 8
  store ptr %290, ptr %Current.06.i321, align 8
  %291 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i321, ptr %291, align 8
...
clause_LiteralAtom.exit:                          ; preds = %entry, %if.then.i
  ...
  %cmp.i.not165 = icmp eq ptr %call4, null
  br i1 %cmp.i.not165, label %for.end81, label %for.body.lr.ph
...
for.body:                                         ; preds = %for.body.lr.ph, %for.inc79
  %candidates.0166 = phi ptr [ %call4, %for.body.lr.ph ], [ %L.val.i155, %for.inc79 ]
  %10 = getelementptr i8, ptr %candidates.0166, i64 8
...
if.then:                                          ; preds = %for.body, %term_IsAtom.exit
  ...
  %atomScan.0162 = load ptr, ptr %11, align 8
  %cmp.i124.not163 = icmp eq ptr %atomScan.0162, null
  br i1 %cmp.i124.not163, label %for.inc79, label %for.body15

for.body15:                                       ; preds = %if.then, %if.end74
  %atomScan.0164 = phi ptr [ %atomScan.0, %if.end74 ], [ %atomScan.0162, %if.then ]
  %12 = getelementptr i8, ptr %atomScan.0164, i64 8
...
term_IsDeclaration.exit:                          ; preds = %for.body15
  %shr.i.i.i.i = ashr i32 %sub.i.i.i.i, %9
...
if.then19:                                        ; preds = %term_IsDeclaration.exit
  ...
  %cmp.i127.not160 = icmp eq ptr %call20, null
  br i1 %cmp.i127.not160, label %if.end74, label %for.body25

for.body25:                                       ; preds = %if.then19, %for.inc
  %litScan.0161 = phi ptr [ %litScan.0.val122, %for.inc ], [ %call20, %if.then19 ]
  %16 = getelementptr i8, ptr %litScan.0161, i64 8
...
lor.lhs.false:                                    ; preds = %land.lhs.true
  ...
  %cmp.i135 = icmp eq i32 %call27.val120, 0
  br i1 %cmp.i135, label %land.lhs.true41, label %for.inc
...
land.lhs.true44:                                  ; preds = %land.lhs.true41
  ...
  %23 = load i32, ptr @fol_NOT, align 4
  %cmp.i.i.i137 = icmp eq i32 %23, %L.val7.val.i.i
  br i1 %cmp.i.i.i137, label %if.then.i.i, label %clause_LiteralPredicate.exit
...
clause_LiteralPredicate.exit:                     ; preds = %land.lhs.true44, %if.then.i.i
  ...
  %L.val7.val.i.i138 = load i32, ptr %call26.val115, align 8
  %cmp.i.i.i139 = icmp eq i32 %23, %L.val7.val.i.i138
  br i1 %cmp.i.i.i139, label %if.then.i.i143, label %clause_LiteralPredicate.exit145

if.then.i.i143:                                   ; preds = %clause_LiteralPredicate.exit
  ...
  br label %clause_LiteralPredicate.exit145

clause_LiteralPredicate.exit145:                  ; preds = %clause_LiteralPredicate.exit, %if.then.i.i143
  %call.val.i144 = phi i32 [ %call.val.pre.i142, %if.then.i.i143 ], [ %L.val7.val.i.i138, %clause_LiteralPredicate.exit ]
  %cmp.i146 = icmp eq i32 %call.val.i, %call.val.i144
  br i1 %cmp.i146, label %for.inc, label %if.then49

if.then49:                                        ; preds = %clause_LiteralPredicate.exit145
...
if.else:                                          ; preds = %if.then30
  ...
  %call.val.i148 = load ptr, ptr %29, align 8
  br label %while.cond.i

while.cond.i:                                     ; preds = %while.cond.i, %if.else
  %indvars.iv.i = phi i64 [ %indvars.iv.next.i, %while.cond.i ], [ 0, %if.else ]
  %arrayidx.i.i = getelementptr inbounds ptr, ptr %call.val.i148, i64 %indvars.iv.i
...
land.lhs.true53:                                  ; preds = %clause_LiteralGetIndex.exit
  ...
  %cmp.i.i149 = icmp sgt i32 %call54.val, 0
  %or.cond = or i1 %tobool58, %cmp.i.i149
  br i1 %or.cond, label %lor.lhs.false59, label %if.then68

lor.lhs.false59:                                  ; preds = %land.lhs.true53
  %or.cond83 = and i1 %tobool58, %cmp.i.i149
...
if.then68:                                        ; preds = %land.lhs.true53, %land.lhs.true65
  ...
  %call.i153 = tail call ptr @memory_Malloc(i32 noundef 16) #11
  %car.i154 = getelementptr inbounds %struct.LIST_HELP, ptr %call.i153, i64 0, i32 1
  store ptr %litScan.0.val, ptr %car.i154, align 8
  store ptr %33, ptr %call.i153, align 8
  store ptr %call.i153, ptr %ConstraintLits, align 8
  br label %for.inc

for.inc:                                          ; preds = %for.body25, %clause_LiteralGetIndex.exit, %lor.lhs.false59, %land.lhs.true65, %if.then68, %if.then33, %lor.lhs.false, %land.lhs.true41, %clause_LiteralPredicate.exit145, %if.then49
  %litScan.0.val122 = load ptr, ptr %litScan.0161, align 8
...
if.end74:                                         ; preds = %for.inc, %if.then19, %for.body15, %term_IsDeclaration.exit
  %atomScan.0 = load ptr, ptr %atomScan.0164, align 8
...
for.inc79:                                        ; preds = %if.end74, %if.then, %term_IsAtom.exit
  %L.val.i155 = load ptr, ptr %candidates.0166, align 8
  %34 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  ...
  store i64 %add27.i.i.i, ptr @memory_FREEDBYTES, align 8
  %37 = load ptr, ptr %34, align 8
  store ptr %37, ptr %candidates.0166, align 8
  %38 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %candidates.0166, ptr %38, align 8
  %cmp.i.not = icmp eq ptr %L.val.i155, null
...
while.body:                                       ; preds = %while.body.lr.ph, %if.end
  %Result.val100110 = phi i32 [ %.promoted, %while.body.lr.ph ], [ %cond, %if.end ]
...
if.end:                                           ; preds = %if.then, %while.body
  ...
  %cmp = icmp ugt i32 %call1.val101, %Result.val100110
  %Scan.0.val98.Result = select i1 %cmp, ptr %Scan.0.val98, ptr %Result
  %cond.in = getelementptr i8, ptr %Scan.0.val98.Result, i64 12
  ...
  %l.1 = tail call i32 @llvm.umax.i32(i32 %l.0109, i32 %7)
...
if.end13.i:                                       ; preds = %if.then9.i, %if.then.i
  ...
  %add.i = add i32 %15, %RealSize.1.i.i.i
...
while.body38:                                     ; preds = %while.body38.lr.ph, %while.cond34.loopexit
  ...
  %26 = getelementptr i8, ptr %List.addr.0116, i64 8
...
for.body45:                                       ; preds = %for.body45.lr.ph, %for.body45
  ...
  %arrayidx48 = getelementptr inbounds i64, ptr %28, i64 %indvars.iv118
  %29 = load i64, ptr %arrayidx48, align 8
  %30 = load ptr, ptr %splitfield49, align 8
  %arrayidx51 = getelementptr inbounds i64, ptr %30, i64 %indvars.iv118
  ...
  %cmp43 = icmp ult i64 %indvars.iv.next119, %33
