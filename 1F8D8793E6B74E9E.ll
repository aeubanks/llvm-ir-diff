; ModuleID = '/usr/local/google/home/aeubanks/repos/test-suite/SingleSource/Regression/C/gcc-c-torture/execute/ieee/acc1.c'
source_filename = "/usr/local/google/home/aeubanks/repos/test-suite/SingleSource/Regression/C/gcc-c-torture/execute/ieee/acc1.c"
...
common.ret4:                                      ; preds = %entry, %if.else
  %common.ret4.op = phi double [ %add, %if.else ], [ %0, %entry ]
...
entry:
  ...
  %cmp = fcmp une double %call, 1.000000e-101
