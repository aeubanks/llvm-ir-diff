...
vector.body:                                      ; preds = %vector.body, %entry
  ...
  %2 = sdiv <4 x i32> %wide.load, <i32 3, i32 3, i32 3, i32 3>
  %3 = sdiv <4 x i32> %wide.load8, <i32 3, i32 3, i32 3, i32 3>
...
vector.body:                                      ; preds = %vector.body, %entry
  ...
  %1 = getelementptr inbounds i32, ptr %0, i64 4
  %wide.load8 = load <4 x i32>, ptr %1, align 16, !tbaa !5
  %2 = udiv <4 x i32> %wide.load, <i32 3, i32 3, i32 3, i32 3>
  %3 = udiv <4 x i32> %wide.load8, <i32 3, i32 3, i32 3, i32 3>
...
vector.body:                                      ; preds = %vector.body, %entry
  ...
  %1 = getelementptr inbounds i32, ptr %0, i64 4
  %wide.load8 = load <4 x i32>, ptr %1, align 16, !tbaa !5
  %2 = sdiv <4 x i32> %wide.load, <i32 18, i32 18, i32 18, i32 18>
  %3 = sdiv <4 x i32> %wide.load8, <i32 18, i32 18, i32 18, i32 18>
  %4 = getelementptr inbounds [4096 x i32], ptr @c, i64 0, i64 %index
  store <4 x i32> %2, ptr %4, align 16, !tbaa !5
  %5 = getelementptr inbounds i32, ptr %4, i64 4
  store <4 x i32> %3, ptr %5, align 16, !tbaa !5
...
vector.body:                                      ; preds = %vector.body, %entry
  ...
  %1 = getelementptr inbounds i32, ptr %0, i64 4
  %wide.load8 = load <4 x i32>, ptr %1, align 16, !tbaa !5
  %2 = udiv <4 x i32> %wide.load, <i32 18, i32 18, i32 18, i32 18>
  %3 = udiv <4 x i32> %wide.load8, <i32 18, i32 18, i32 18, i32 18>
  %4 = getelementptr inbounds [4096 x i32], ptr @d, i64 0, i64 %index
  store <4 x i32> %2, ptr %4, align 16, !tbaa !5
  %5 = getelementptr inbounds i32, ptr %4, i64 4
  store <4 x i32> %3, ptr %5, align 16, !tbaa !5
...
vector.body:                                      ; preds = %vector.body, %entry
  ...
  %1 = getelementptr inbounds i32, ptr %0, i64 4
  %wide.load8 = load <4 x i32>, ptr %1, align 16, !tbaa !5
  %2 = sdiv <4 x i32> %wide.load, <i32 19, i32 19, i32 19, i32 19>
  %3 = sdiv <4 x i32> %wide.load8, <i32 19, i32 19, i32 19, i32 19>
  %4 = getelementptr inbounds [4096 x i32], ptr @c, i64 0, i64 %index
  store <4 x i32> %2, ptr %4, align 16, !tbaa !5
  %5 = getelementptr inbounds i32, ptr %4, i64 4
  store <4 x i32> %3, ptr %5, align 16, !tbaa !5
...
vector.body:                                      ; preds = %vector.body, %entry
  ...
  %1 = getelementptr inbounds i32, ptr %0, i64 4
  %wide.load8 = load <4 x i32>, ptr %1, align 16, !tbaa !5
  %2 = udiv <4 x i32> %wide.load, <i32 19, i32 19, i32 19, i32 19>
  %3 = udiv <4 x i32> %wide.load8, <i32 19, i32 19, i32 19, i32 19>
  %4 = getelementptr inbounds [4096 x i32], ptr @d, i64 0, i64 %index
  store <4 x i32> %2, ptr %4, align 16, !tbaa !5
  %5 = getelementptr inbounds i32, ptr %4, i64 4
  store <4 x i32> %3, ptr %5, align 16, !tbaa !5
...
vector.body:                                      ; preds = %vector.body, %entry
  ...
  %6 = add <4 x i32> %5, %4
  %7 = getelementptr inbounds [4096 x i32], ptr @c, i64 0, i64 %index
  store <4 x i32> %6, ptr %7, align 16, !tbaa !5
  %index.next = add nuw i64 %index, 4
  %8 = icmp eq i64 %index.next, 4096
  br i1 %8, label %for.end, label %vector.body, !llvm.loop !18
...
vector.body:                                      ; preds = %vector.body, %entry
  ...
  %4 = trunc <4 x i64> %3 to <4 x i32>
  %5 = getelementptr inbounds [4096 x i32], ptr @d, i64 0, i64 %index
  store <4 x i32> %4, ptr %5, align 16, !tbaa !5
  %index.next = add nuw i64 %index, 4
  %6 = icmp eq i64 %index.next, 4096
  br i1 %6, label %for.end, label %vector.body, !llvm.loop !19
...
vector.body:                                      ; preds = %vector.body, %entry
  ...
  %8 = getelementptr inbounds [4096 x i32], ptr @c, i64 0, i64 %index
  store <4 x i32> %7, ptr %8, align 16, !tbaa !5
  %index.next = add nuw i64 %index, 4
  %9 = icmp eq i64 %index.next, 4096
  br i1 %9, label %for.end, label %vector.body, !llvm.loop !20
...
vector.body:                                      ; preds = %vector.body, %entry
  ...
  %index.next = add nuw i64 %index, 4
  %6 = icmp eq i64 %index.next, 4096
  br i1 %6, label %for.end, label %vector.body, !llvm.loop !21
...
vector.body:                                      ; preds = %vector.body, %entry
  ...
  %index.next = add nuw i64 %index, 4
  %9 = icmp eq i64 %index.next, 4096
  br i1 %9, label %for.end, label %vector.body, !llvm.loop !22
...
vector.body:                                      ; preds = %vector.body, %entry
  ...
  %9 = getelementptr inbounds [4096 x i32], ptr @d, i64 0, i64 %index
  store <4 x i32> %8, ptr %9, align 16, !tbaa !5
  %index.next = add nuw i64 %index, 4
  %10 = icmp eq i64 %index.next, 4096
  br i1 %10, label %for.end, label %vector.body, !llvm.loop !23
...
lor.lhs.false29:                                  ; preds = %for.body22
  ...
  %div34 = udiv i32 %10, 18
  %cmp35.not = icmp eq i32 %9, %div34
...
for.body43:                                       ; preds = %for.end40, %for.cond41
  ...
  %div48 = sdiv i32 %12, 19
  %cmp49.not = icmp eq i32 %11, %div48
...
lor.lhs.false50:                                  ; preds = %for.body43
  ...
  %div55 = udiv i32 %14, 19
  %cmp56.not = icmp eq i32 %13, %div55
...
for.body64:                                       ; preds = %for.end61, %for.cond62
  ...
  %div69 = sdiv i32 %16, 3
  %cmp70.not = icmp eq i32 %15, %div69
...
lor.lhs.false71:                                  ; preds = %for.body64
  ...
  %div76 = udiv i32 %18, 3
  %cmp77.not = icmp eq i32 %17, %div76
...
for.body85:                                       ; preds = %for.end82, %for.cond83
  ...
  %div90 = sdiv i32 %20, 18
  %cmp91.not = icmp eq i32 %19, %div90
...
lor.lhs.false92:                                  ; preds = %for.body85
  ...
  %div97 = udiv i32 %22, 18
  %cmp98.not = icmp eq i32 %21, %div97
...
for.body106:                                      ; preds = %for.end103, %for.cond104
  ...
  %div111 = sdiv i32 %24, 19
  %cmp112.not = icmp eq i32 %23, %div111
...
lor.lhs.false113:                                 ; preds = %for.body106
  ...
  %div118 = udiv i32 %26, 19
  %cmp119.not = icmp eq i32 %25, %div118
