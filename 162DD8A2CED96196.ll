...
_ZN8CDirItemC2ERKS_.exit.i:                       ; preds = %while.cond.i.i.i.i
  ...
  %di.sroa.19.48.Attrib.i.i.sroa_idx = getelementptr inbounds %struct.CDirItem, ptr %call.i17, i64 0, i32 6
  store i32 %phyParent, ptr %di.sroa.19.48.Attrib.i.i.sroa_idx, align 4
  %di.sroa.21.48.Attrib.i.i.sroa_idx = getelementptr inbounds %struct.CDirItem, ptr %call.i17, i64 0, i32 7
  store i32 %logParent, ptr %di.sroa.21.48.Attrib.i.i.sroa_idx, align 8
...
_ZN11CStringBaseIwE9GetBufferEi.exit:             ; preds = %for.end, %if.end9.i.i
  %7 = phi i32 [ %0, %for.end ], [ %.pre, %if.end9.i.i ]
  %8 = phi ptr [ %call.i.i, %for.end ], [ %call.i.i6971, %if.end9.i.i ]
...
_ZN11CStringBaseIwE11SetCapacityEi.exit.i:        ; preds = %if.end9.i.i, %invoke.cont30
  %44 = phi ptr [ %call.i.i129, %invoke.cont30 ], [ %call.i.i135, %if.end9.i.i ]
...
.noexc.i932:                                      ; preds = %_ZN13CObjectVectorI11CStringBaseIwEE3AddERKS1_.exit928
  %call.i3.i931 = invoke noundef nonnull align 8 dereferenceable(32) ptr @_ZN13CObjectVectorI11CStringBaseIwEEpLERKS2_(ptr noundef nonnull align 8 dereferenceable(32) %addArchivePrefixNewTemp, ptr noundef nonnull align 8 dereferenceable(32) %addArchivePrefixNew314)
          to label %invoke.cont323 unwind label %lpad.i933
...
invoke.cont323:                                   ; preds = %.noexc.i932
