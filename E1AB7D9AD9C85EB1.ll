...
entry:
  %precision = getelementptr inbounds %struct.Foo, ptr %p, i64 0, i32 1
  %bf.load = load i16, ptr %precision, align 4
...
entry:
  ...
  %bf.load = load i16, ptr getelementptr inbounds (%struct.Foo, ptr @f, i64 0, i32 1), align 4
  %bf.clear2 = and i16 %bf.load, -8192
  %bf.set3 = or i16 %bf.clear2, 7168
  store i16 %bf.set3, ptr getelementptr inbounds (%struct.Foo, ptr @f, i64 0, i32 1), align 4
  %call = tail call i32 @foo(ptr noundef nonnull @f), !range !10
