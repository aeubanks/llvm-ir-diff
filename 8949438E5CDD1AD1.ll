...
entry:
  %call = tail call i64 @foo(i64 poison)
...
if.end:                                           ; preds = %entry
  ...
  %call1 = tail call i64 @foo(i64 poison)
...
if.end4:                                          ; preds = %if.end
  store i64 0, ptr @a, align 8, !tbaa !5
  %call5 = tail call i64 @foo(i64 poison)
...
if.end8:                                          ; preds = %if.end4
  ...
  %call9 = tail call i64 @foo(i64 poison)
...
if.end12:                                         ; preds = %if.end8
  store i64 -64, ptr @a, align 8, !tbaa !5
  %call13 = tail call i64 @foo(i64 poison)
...
if.end16:                                         ; preds = %if.end12
  store i64 -64, ptr @a, align 8, !tbaa !5
  %call17 = tail call i64 @foo(i64 poison)
