...
for.body74.lr.ph:                                 ; preds = %for.body66
  ...
  br i1 %cmp130.fr, label %for.body74, label %for.body74.us

for.body74.us:                                    ; preds = %for.body74.lr.ph, %if.else154.us
  %j.31280.us = phi i32 [ %inc169.us, %if.else154.us ], [ %spec.select, %for.body74.lr.ph ]
  %diff.41279.us = phi double [ %cond164.us, %if.else154.us ], [ %diff.31296, %for.body74.lr.ph ]
  ...
  %cmp136.not.us = icmp eq i32 %cond129.us, %last.31300
  br i1 %cmp136.not.us, label %if.else154.us, label %for.inc171.thread

if.else154.us:                                    ; preds = %for.body74.us
  ...
  %exitcond1331.not = icmp eq i32 %inc169.us, 100
  br i1 %exitcond1331.not, label %for.inc171, label %for.body74.us, !llvm.loop !16

for.body74:                                       ; preds = %for.body74.lr.ph, %for.inc168
  %last.41281 = phi i32 [ %cond129, %for.inc168 ], [ %last.31300, %for.body74.lr.ph ]
  %j.31280 = phi i32 [ %inc169, %for.inc168 ], [ %spec.select, %for.body74.lr.ph ]
  %diff.41279 = phi double [ %diff.5, %for.inc168 ], [ %diff.31296, %for.body74.lr.ph ]
  ...
  %cmp133 = icmp eq i32 %j.31280, %savej.11345
  br i1 %cmp133, label %for.inc168, label %if.then135

if.then135:                                       ; preds = %for.body74
  %cmp136.not = icmp eq i32 %cond129, %last.41281
  br i1 %cmp136.not, label %if.else154, label %for.inc171.thread

for.inc171.thread:                                ; preds = %for.body74.us, %if.then135
  %.us-phi1285 = phi double [ %add78, %if.then135 ], [ %add78.us, %for.body74.us ]
  %.us-phi1286 = phi double [ %mul126, %if.then135 ], [ %mul126.us, %for.body74.us ]
  %.us-phi1288 = phi double [ %diff.41279, %if.then135 ], [ %diff.41279.us, %for.body74.us ]
...
for.inc168:                                       ; preds = %for.body74, %if.else154
  %diff.5 = phi double [ %cond164, %if.else154 ], [ %diff.41279, %for.body74 ]
  %inc169 = add i32 %j.31280, 1
  %exitcond1332.not = icmp eq i32 %inc169, 100
  br i1 %exitcond1332.not, label %for.inc171, label %for.body74, !llvm.loop !16

for.inc171:                                       ; preds = %if.else154.us, %for.inc168, %for.body66
  %diff.41252 = phi double [ %diff.31296, %for.body66 ], [ %diff.5, %for.inc168 ], [ %cond164.us, %if.else154.us ]
  %j.31249 = phi i32 [ %j.11299, %for.body66 ], [ 100, %for.inc168 ], [ 100, %if.else154.us ]
  %last.41247 = phi i32 [ %last.31300, %for.body66 ], [ %cond129, %for.inc168 ], [ %last.31300, %if.else154.us ]
  %k.7 = phi double [ %k.41297, %for.body66 ], [ %add78, %for.inc168 ], [ %add78.us, %if.else154.us ]
...
if.then355:                                       ; preds = %if.end275
  ...
  %fneg.i558 = fmul double %84, -0.000000e+00
  %call.i559 = tail call double @exp(double noundef %fneg.i558) #13
  %86 = load double, ptr @c, align 8, !tbaa !5
  %fneg4.i560 = fmul double %86, -0.000000e+00
  %call5.i561 = tail call double @exp(double noundef %fneg4.i560) #13
  %87 = load double, ptr @a, align 8, !tbaa !5
  %88 = load double, ptr @c, align 8, !tbaa !5
  %89 = fneg double %87
  %fneg.i565 = fmul double %sub.i, %89
  %call.i566 = tail call double @exp(double noundef %fneg.i565) #13
  %90 = load double, ptr @c, align 8, !tbaa !5
  %91 = fneg double %90
  %fneg4.i567 = fmul double %sub.i, %91
  %call5.i568 = tail call double @exp(double noundef %fneg4.i567) #13
  %92 = load double, ptr @rootN, align 8, !tbaa !5
  %93 = fneg double %92
  %sub.i971 = fadd double %k.8, -1.000000e+00
  ...
  %101 = insertelement <2 x double> poison, double %call5.i561, i64 0
  %102 = insertelement <2 x double> poison, double %88, i64 0
  %103 = insertelement <2 x double> poison, double %call.i559, i64 0
  ...
  %106 = insertelement <2 x double> poison, double %call5.i568, i64 0
  %107 = insertelement <2 x double> poison, double %call.i566, i64 0
  ...
  %fneg.i573 = fmul double %111, -0.000000e+00
  %112 = insertelement <2 x double> poison, double %111, i64 0
  %113 = load double, ptr @c, align 8, !tbaa !5
  %call.i574 = tail call double @exp(double noundef %fneg.i573) #13
  %114 = load double, ptr @c, align 8, !tbaa !5
  %fneg4.i575 = fmul double %114, -0.000000e+00
  %call5.i576 = tail call double @exp(double noundef %fneg4.i575) #13
  %115 = load double, ptr @rootN, align 8, !tbaa !5
  %116 = load double, ptr @a, align 8, !tbaa !5
  %117 = load double, ptr @c, align 8, !tbaa !5
  %118 = fneg double %116
  %fneg.i583 = fmul double %sub.i, %118
  %call.i584 = tail call double @exp(double noundef %fneg.i583) #13
  %119 = load double, ptr @c, align 8, !tbaa !5
  %120 = fneg double %119
  %fneg4.i585 = fmul double %sub.i, %120
  %call5.i586 = tail call double @exp(double noundef %fneg4.i585) #13
  ...
  %fneg.i592 = fmul double %124, -0.000000e+00
  %call.i593 = tail call double @exp(double noundef %fneg.i592) #13
  %125 = load double, ptr @c, align 8, !tbaa !5
  %fneg4.i594 = fmul double %125, -0.000000e+00
  %call5.i595 = tail call double @exp(double noundef %fneg4.i594) #13
  ...
  %130 = fneg double %128
  %fneg.i605 = fmul double %sub.i, %130
  %call.i606 = tail call double @exp(double noundef %fneg.i605) #13
  %131 = load double, ptr @c, align 8, !tbaa !5
  %132 = fneg double %131
  %fneg4.i607 = fmul double %sub.i, %132
  %call5.i608 = tail call double @exp(double noundef %fneg4.i607) #13
  ...
  %fneg.i615 = fmul double %133, -0.000000e+00
  %call.i616 = tail call double @exp(double noundef %fneg.i615) #13
  %137 = load double, ptr @c, align 8, !tbaa !5
  %fneg4.i617 = fmul double %137, -0.000000e+00
  %call5.i618 = tail call double @exp(double noundef %fneg4.i617) #13
  ...
  %142 = fneg double %140
  %fneg.i631 = fmul double %sub.i, %142
  %call.i632 = tail call double @exp(double noundef %fneg.i631) #13
  %143 = load double, ptr @c, align 8, !tbaa !5
  %144 = fneg double %143
  %fneg4.i633 = fmul double %sub.i, %144
  %call5.i634 = tail call double @exp(double noundef %fneg4.i633) #13
  ...
  %fneg.i644 = fmul double %147, -0.000000e+00
  %call.i645 = tail call double @exp(double noundef %fneg.i644) #13
  %149 = load double, ptr @c, align 8, !tbaa !5
  %fneg4.i646 = fmul double %149, -0.000000e+00
  %call5.i647 = tail call double @exp(double noundef %fneg4.i646) #13
  ...
  %154 = fneg double %152
  %fneg.i662 = fmul double %sub.i, %154
  %call.i663 = tail call double @exp(double noundef %fneg.i662) #13
  %155 = load double, ptr @c, align 8, !tbaa !5
  %156 = fneg double %155
  %fneg4.i664 = fmul double %sub.i, %156
  %call5.i665 = tail call double @exp(double noundef %fneg4.i664) #13
  %157 = load double, ptr @a, align 8, !tbaa !5
  %158 = load double, ptr @c, align 8, !tbaa !5
  %fneg.i670 = fmul double %157, -0.000000e+00
  %call.i671 = tail call double @exp(double noundef %fneg.i670) #13
  %159 = load double, ptr @c, align 8, !tbaa !5
  %fneg4.i672 = fmul double %159, -0.000000e+00
  %call5.i673 = tail call double @exp(double noundef %fneg4.i672) #13
  %160 = load double, ptr @a, align 8, !tbaa !5
  %161 = load double, ptr @c, align 8, !tbaa !5
  %162 = fneg double %160
  %fneg.i677 = fmul double %sub.i, %162
  %call.i678 = tail call double @exp(double noundef %fneg.i677) #13
  %163 = load double, ptr @c, align 8, !tbaa !5
  %164 = fneg double %163
  %fneg4.i679 = fmul double %sub.i, %164
  %call5.i680 = tail call double @exp(double noundef %fneg4.i679) #13
  %165 = load double, ptr @a, align 8, !tbaa !5
  %166 = load double, ptr @c, align 8, !tbaa !5
  %167 = load double, ptr @rootN, align 8, !tbaa !5
  %fneg.i686 = fmul double %165, -0.000000e+00
  %call.i687 = tail call double @exp(double noundef %fneg.i686) #13
  %168 = load double, ptr @c, align 8, !tbaa !5
  %fneg4.i688 = fmul double %168, -0.000000e+00
  %call5.i689 = tail call double @exp(double noundef %fneg4.i688) #13
  %169 = load double, ptr @rootN, align 8, !tbaa !5
  %170 = load double, ptr @a, align 8, !tbaa !5
  %171 = load double, ptr @c, align 8, !tbaa !5
  %172 = fneg double %170
  %fneg.i696 = fmul double %sub.i, %172
  %call.i697 = tail call double @exp(double noundef %fneg.i696) #13
  %173 = load double, ptr @c, align 8, !tbaa !5
  %174 = fneg double %173
  %fneg4.i698 = fmul double %sub.i, %174
  %call5.i699 = tail call double @exp(double noundef %fneg4.i698) #13
  ...
  %fneg.i706 = fmul double %177, -0.000000e+00
  %call.i707 = tail call double @exp(double noundef %fneg.i706) #13
  %179 = load double, ptr @c, align 8, !tbaa !5
  %fneg4.i708 = fmul double %179, -0.000000e+00
  %call5.i709 = tail call double @exp(double noundef %fneg4.i708) #13
  ...
  %184 = fneg double %182
  %fneg.i719 = fmul double %sub.i, %184
  %call.i720 = tail call double @exp(double noundef %fneg.i719) #13
  %185 = load double, ptr @c, align 8, !tbaa !5
  %186 = fneg double %185
  %fneg4.i721 = fmul double %sub.i, %186
  %call5.i722 = tail call double @exp(double noundef %fneg4.i721) #13
  ...
  %fneg.i732 = fmul double %189, -0.000000e+00
  %call.i733 = tail call double @exp(double noundef %fneg.i732) #13
  %191 = load double, ptr @c, align 8, !tbaa !5
  %fneg4.i734 = fmul double %191, -0.000000e+00
  %call5.i735 = tail call double @exp(double noundef %fneg4.i734) #13
  ...
  %196 = fneg double %194
  %fneg.i972 = fmul double %sub.i971, %196
  %call.i973 = tail call double @exp(double noundef %fneg.i972) #13
  %197 = load double, ptr @c, align 8, !tbaa !5
  %198 = fneg double %197
  %fneg4.i974 = fmul double %sub.i971, %198
  %call5.i975 = tail call double @exp(double noundef %fneg4.i974) #13
  %199 = load double, ptr @a, align 8, !tbaa !5
  %200 = load double, ptr @c, align 8, !tbaa !5
  %201 = fneg double %199
  %fneg.i983 = fmul double %sub.i, %201
  %call.i984 = tail call double @exp(double noundef %fneg.i983) #13
  %202 = load double, ptr @c, align 8, !tbaa !5
  %203 = fneg double %202
  %fneg4.i985 = fmul double %sub.i, %203
  %call5.i986 = tail call double @exp(double noundef %fneg4.i985) #13
  %204 = load double, ptr @a, align 8, !tbaa !5
  %205 = load double, ptr @c, align 8, !tbaa !5
  %206 = fneg double %204
  %fneg.i994 = fmul double %sub.i971, %206
  %call.i995 = tail call double @exp(double noundef %fneg.i994) #13
  %207 = load double, ptr @c, align 8, !tbaa !5
  %208 = fneg double %207
  %fneg4.i996 = fmul double %sub.i971, %208
  %call5.i997 = tail call double @exp(double noundef %fneg4.i996) #13
  ...
  %216 = insertelement <2 x double> %106, double %call5.i997, i64 1
  %217 = fdiv <2 x double> %216, %211
  %218 = insertelement <2 x double> poison, double %call5.i576, i64 0
  %219 = insertelement <2 x double> %218, double %call.i574, i64 1
  ...
  %sub12.i579 = extractelement <2 x double> %224, i64 0
  ...
  %sub16.i580 = extractelement <2 x double> %226, i64 0
  %227 = fneg double %115
  %neg.i581 = fmul double %sub16.i580, %227
  %228 = tail call double @llvm.fmuladd.f64(double %sub12.i579, double 0x3FE5555555555555, double %neg.i581)
  %229 = insertelement <2 x double> %107, double %call.i995, i64 1
  %230 = fdiv <2 x double> %229, %214
  %231 = insertelement <2 x double> poison, double %228, i64 0
  %232 = insertelement <2 x double> poison, double %call5.i586, i64 0
  %233 = insertelement <2 x double> poison, double %call.i584, i64 0
  ...
  %239 = fneg double %213
  %fneg.i1007 = fmul double %sub.i, %239
  %call.i1008 = tail call double @exp(double noundef %fneg.i1007) #13
  %240 = load double, ptr @c, align 8, !tbaa !5
  %241 = fneg double %240
  %fneg4.i1009 = fmul double %sub.i, %241
  %call5.i1010 = tail call double @exp(double noundef %fneg4.i1009) #13
  ...
  %248 = insertelement <2 x double> poison, double %call5.i595, i64 0
  %249 = insertelement <2 x double> %248, double %call.i593, i64 1
  ...
  %sub13.i600 = extractelement <2 x double> %251, i64 0
  ...
  %sub20.i601 = extractelement <2 x double> %253, i64 0
  %neg.i602 = fmul double %243, %sub20.i601
  %254 = tail call double @llvm.fmuladd.f64(double %sub13.i600, double 2.000000e+00, double %neg.i602)
  ...
  %sub24.i603 = extractelement <2 x double> %256, i64 0
  %257 = tail call double @llvm.fmuladd.f64(double %127, double %sub24.i603, double %254)
  ...
  %263 = insertelement <2 x double> poison, double %call5.i608, i64 0
  %264 = insertelement <2 x double> %263, double %call.i606, i64 1
  ...
  %neg.i614 = fmul double %269, %sub23.i
  %270 = fmul double %138, -6.000000e+00
  %mul25.i628 = fmul double %139, 2.000000e+00
  ...
  %276 = insertelement <2 x double> poison, double %call5.i618, i64 0
  %277 = insertelement <2 x double> %276, double %call.i616, i64 1
  ...
  %sub14.i625 = extractelement <2 x double> %279, i64 0
  ...
  %sub23.i626 = extractelement <2 x double> %281, i64 0
  %neg.i627 = fmul double %270, %sub23.i626
  %282 = tail call double @llvm.fmuladd.f64(double %sub14.i625, double 4.000000e+00, double %neg.i627)
  ...
  %sub30.i629 = extractelement <2 x double> %284, i64 0
  %285 = tail call double @llvm.fmuladd.f64(double %mul25.i628, double %sub30.i629, double %282)
  %286 = fmul double %145, -6.000000e+00
  %287 = insertelement <2 x double> poison, double %257, i64 0
  %288 = insertelement <2 x double> poison, double %neg.i614, i64 0
  %289 = insertelement <2 x double> poison, double %136, i64 0
  %290 = insertelement <2 x double> poison, double %call.i606, i64 0
  ...
  %294 = insertelement <2 x double> poison, double %call5.i634, i64 0
  %295 = insertelement <2 x double> poison, double %call.i632, i64 0
  %mul7.i635 = fmul double %147, %147
  %296 = insertelement <2 x double> poison, double %147, i64 0
  %mul11.i639 = fmul double %148, %148
  ...
  %300 = insertelement <2 x double> poison, double %call5.i647, i64 0
  %301 = insertelement <2 x double> poison, double %call.i645, i64 0
  %mul7.i648 = fmul double %152, %152
  %302 = insertelement <2 x double> poison, double %152, i64 0
  %mul11.i652 = fmul double %153, %153
  %303 = insertelement <2 x double> poison, double %153, i64 0
  %304 = insertelement <2 x double> %303, double %152, i64 1
  %305 = insertelement <2 x double> %300, double %call.i645, i64 1
  %306 = fneg double %167
  %307 = insertelement <2 x double> poison, double %call5.i689, i64 0
  %308 = insertelement <2 x double> %307, double %call.i687, i64 1
  ...
  %sub11.i692 = extractelement <2 x double> %313, i64 0
  ...
  %sub15.i693 = extractelement <2 x double> %315, i64 0
  %316 = fneg double %169
  %neg.i694 = fmul double %sub15.i693, %316
  %317 = tail call double @llvm.fmuladd.f64(double %sub11.i692, double 5.000000e-01, double %neg.i694)
  %318 = insertelement <2 x double> %297, double %147, i64 1
  %319 = insertelement <2 x double> %294, double %call.i632, i64 1
  %320 = insertelement <2 x double> poison, double %177, i64 0
  %321 = insertelement <2 x double> poison, double %178, i64 0
  %neg.i716 = fmul double %180, -2.000000e+00
  ...
  %326 = insertelement <2 x double> poison, double %call5.i709, i64 0
  %327 = insertelement <2 x double> %326, double %call.i707, i64 1
  ...
  %sub12.i714 = extractelement <2 x double> %329, i64 0
  ...
  %sub18.i715 = extractelement <2 x double> %331, i64 0
  %332 = tail call double @llvm.fmuladd.f64(double %neg.i716, double %sub18.i715, double %sub12.i714)
  ...
  %sub22.i717 = extractelement <2 x double> %334, i64 0
  %335 = tail call double @llvm.fmuladd.f64(double %181, double %sub22.i717, double %332)
  %mul7.i723 = fmul double %189, %189
  %336 = insertelement <2 x double> poison, double %189, i64 0
  %mul10.i726 = fmul double %190, %190
  %337 = insertelement <2 x double> poison, double %190, i64 0
  %mul7.i736 = fmul double %194, %194
  %338 = insertelement <2 x double> poison, double %194, i64 0
  %mul10.i739 = fmul double %195, %195
  %339 = insertelement <2 x double> poison, double %195, i64 0
  %340 = insertelement <2 x double> %97, double %call5.i975, i64 1
  %341 = insertelement <2 x double> %98, double %200, i64 1
  %342 = fdiv <2 x double> %340, %341
  %343 = insertelement <2 x double> %99, double %call.i973, i64 1
  ...
  %348 = insertelement <2 x double> %101, double %call5.i986, i64 1
  %349 = insertelement <2 x double> %102, double %205, i64 1
  %350 = fdiv <2 x double> %348, %349
  %351 = insertelement <2 x double> %103, double %call.i984, i64 1
  ...
  %368 = insertelement <2 x double> poison, double %call5.i1010, i64 0
  %369 = insertelement <2 x double> %368, double %call.i1008, i64 1
  %370 = load double, ptr @a, align 8, !tbaa !5
  %371 = load double, ptr @c, align 8, !tbaa !5
  %372 = fneg double %370
  %fneg.i1020 = fmul double %sub.i971, %372
  %call.i1021 = tail call double @exp(double noundef %fneg.i1020) #13
  %373 = load double, ptr @c, align 8, !tbaa !5
  %374 = fneg double %373
  %fneg4.i1022 = fmul double %sub.i971, %374
  %call5.i1023 = tail call double @exp(double noundef %fneg4.i1022) #13
  ...
  %383 = fneg double %375
  %fneg.i1033 = fmul double %sub.i, %383
  %call.i1034 = tail call double @exp(double noundef %fneg.i1033) #13
  %384 = load double, ptr @c, align 8, !tbaa !5
  %385 = fneg double %384
  %fneg4.i1035 = fmul double %sub.i, %385
  %call5.i1036 = tail call double @exp(double noundef %fneg4.i1035) #13
  ...
  %sub12.i1015 = extractelement <2 x double> %392, i64 0
  ...
  %sub16.i1016 = extractelement <2 x double> %394, i64 0
  %mul17.i1017 = fmul double %242, %sub16.i1016
  %395 = tail call double @llvm.fmuladd.f64(double %sub12.i1015, double 0xBFE5555555555555, double %mul17.i1017)
  %mul18.i1018 = fmul double %109, %395
  %396 = insertelement <2 x double> %231, double %mul18.i1018, i64 1
  %397 = fsub <2 x double> %367, %396
  %398 = fmul <2 x double> %376, %377
  %399 = fmul <2 x double> %379, %380
  %400 = insertelement <2 x double> %232, double %call5.i1023, i64 1
  %401 = fdiv <2 x double> %400, %399
  %402 = insertelement <2 x double> %233, double %call.i1021, i64 1
  ...
  %neg.i1031 = fmul double %382, -2.000000e+00
  %415 = insertelement <2 x double> %235, double %neg.i1031, i64 1
  ...
  %mul15.i1043 = fmul double %386, 3.000000e+00
  %419 = load double, ptr @a, align 8, !tbaa !5
  %420 = load double, ptr @c, align 8, !tbaa !5
  %421 = fneg double %419
  %fneg.i1050 = fmul double %sub.i971, %421
  %call.i1051 = tail call double @exp(double noundef %fneg.i1050) #13
  %422 = load double, ptr @c, align 8, !tbaa !5
  %423 = fneg double %422
  %fneg4.i1052 = fmul double %sub.i971, %423
  %call5.i1053 = tail call double @exp(double noundef %fneg4.i1052) #13
  ...
  %430 = insertelement <2 x double> poison, double %call5.i1036, i64 0
  %431 = insertelement <2 x double> %430, double %call.i1034, i64 1
  ...
  %sub13.i1042 = extractelement <2 x double> %433, i64 0
  ...
  %sub20.i1044 = extractelement <2 x double> %435, i64 0
  %mul21.i1045 = fmul double %mul15.i1043, %sub20.i1044
  %436 = tail call double @llvm.fmuladd.f64(double %sub13.i1042, double -2.000000e+00, double %mul21.i1045)
  ...
  %sub25.i1046 = extractelement <2 x double> %438, i64 0
  %neg.i1047 = fmul double %387, -2.000000e+00
  %439 = tail call double @llvm.fmuladd.f64(double %neg.i1047, double %sub25.i1046, double %436)
  %mul27.i1048 = fmul double %110, %439
  %440 = insertelement <2 x double> %287, double %mul27.i1048, i64 1
  ...
  %444 = fneg double %442
  %fneg.i1068 = fmul double %sub.i, %444
  %call.i1069 = tail call double @exp(double noundef %fneg.i1068) #13
  %445 = load double, ptr @c, align 8, !tbaa !5
  %446 = fneg double %445
  %fneg4.i1070 = fmul double %sub.i, %446
  %call5.i1071 = tail call double @exp(double noundef %fneg4.i1070) #13
  ...
  %454 = insertelement <2 x double> poison, double %call5.i1053, i64 0
  %455 = insertelement <2 x double> %454, double %call.i1051, i64 1
  ...
  %sub14.i1060 = extractelement <2 x double> %457, i64 0
  ...
  %sub23.i1061 = extractelement <2 x double> %459, i64 0
  %mul24.i1062 = fmul double %mul16.i, %sub23.i1061
  %460 = tail call double @llvm.fmuladd.f64(double %sub14.i1060, double -4.000000e+00, double %mul24.i1062)
  ...
  %neg.i1064 = fmul double %425, -4.000000e+00
  %463 = insertelement <2 x double> %266, double %neg.i1064, i64 1
  ...
  %mul32.i1065 = fmul double %425, 0x3FF5555555555555
  %467 = insertelement <2 x double> %289, double %424, i64 1
  %468 = insertelement <2 x double> <double 2.000000e+00, double poison>, double %mul32.i1065, i64 1
  %469 = fmul <2 x double> %467, %468
  %470 = insertelement <2 x double> %263, double %call5.i1053, i64 1
  %471 = insertelement <2 x double> %260, double %443, i64 1
  %472 = fdiv <2 x double> %470, %471
  %473 = insertelement <2 x double> %290, double %call.i1051, i64 1
  ...
  %mul16.i1079 = fmul double %447, 6.000000e+00
  %neg.i1083 = fmul double %448, -4.000000e+00
  %mul32.i1084 = fmul double %448, 0x3FF5555555555555
  %mul33.i1085 = fmul double %447, %mul32.i1084
  %480 = load double, ptr @a, align 8, !tbaa !5
  %481 = load double, ptr @c, align 8, !tbaa !5
  %482 = fneg double %480
  %fneg.i1089 = fmul double %sub.i971, %482
  %call.i1090 = tail call double @exp(double noundef %fneg.i1089) #13
  %483 = load double, ptr @c, align 8, !tbaa !5
  %484 = fneg double %483
  %fneg4.i1091 = fmul double %sub.i971, %484
  %call5.i1092 = tail call double @exp(double noundef %fneg4.i1091) #13
  ...
  %492 = insertelement <2 x double> poison, double %call5.i1071, i64 0
  %493 = insertelement <2 x double> %492, double %call.i1069, i64 1
  ...
  %sub14.i1078 = extractelement <2 x double> %495, i64 0
  ...
  %sub23.i1080 = extractelement <2 x double> %497, i64 0
  %mul24.i1081 = fmul double %mul16.i1079, %sub23.i1080
  %498 = tail call double @llvm.fmuladd.f64(double %sub14.i1078, double -4.000000e+00, double %mul24.i1081)
  ...
  %sub30.i1082 = extractelement <2 x double> %500, i64 0
  %501 = tail call double @llvm.fmuladd.f64(double %neg.i1083, double %sub30.i1082, double %498)
  ...
  %sub36.i1086 = extractelement <2 x double> %503, i64 0
  %504 = tail call double @llvm.fmuladd.f64(double %mul33.i1085, double %sub36.i1086, double %501)
  %mul38.i1087 = fmul double %sub, %504
  %505 = insertelement <2 x double> %292, double %mul38.i1087, i64 1
  %506 = fsub <2 x double> %479, %505
  %mul18.i1102 = fmul double %485, 6.000000e+00
  %507 = load double, ptr @a, align 8, !tbaa !5
  %508 = insertelement <2 x double> %296, double %507, i64 1
  %509 = insertelement <2 x double> %508, double %mul7.i635, i64 0
  %510 = fmul <2 x double> %508, %509
  %511 = load double, ptr @c, align 8, !tbaa !5
  %512 = insertelement <2 x double> %297, double %511, i64 1
  %513 = insertelement <2 x double> %512, double %mul11.i639, i64 0
  ...
  %neg.i643 = fmul double %286, %sub27.i
  %522 = fneg double %507
  %fneg.i1108 = fmul double %sub.i, %522
  %call.i1109 = tail call double @exp(double noundef %fneg.i1108) #13
  %523 = load double, ptr @c, align 8, !tbaa !5
  %524 = fneg double %523
  %fneg4.i1110 = fmul double %sub.i, %524
  %call5.i1111 = tail call double @exp(double noundef %fneg4.i1110) #13
  ...
  %533 = insertelement <2 x double> poison, double %call5.i1092, i64 0
  %534 = insertelement <2 x double> %533, double %call.i1090, i64 1
  ...
  %sub16.i1101 = extractelement <2 x double> %536, i64 0
  ...
  %sub27.i1103 = extractelement <2 x double> %538, i64 0
  %mul28.i = fmul double %mul18.i1102, %sub27.i1103
  %539 = tail call double @llvm.fmuladd.f64(double %sub16.i1101, double -4.000000e+00, double %mul28.i)
  ...
  %neg.i1105 = fmul double %486, -4.000000e+00
  %542 = insertelement <2 x double> %519, double %neg.i1105, i64 1
  %543 = shufflevector <2 x double> <double 4.000000e+00, double poison>, <2 x double> %541, <2 x i32> <i32 0, i32 2>
  %544 = insertelement <2 x double> poison, double %neg.i643, i64 0
  ...
  %mul38.i1106 = fmul double %486, 0x3FF5555555555555
  %547 = insertelement <2 x double> %293, double %485, i64 1
  %548 = insertelement <2 x double> <double 2.000000e+00, double poison>, double %mul38.i1106, i64 1
  %549 = fmul <2 x double> %547, %548
  %550 = insertelement <2 x double> %294, double %call5.i1092, i64 1
  %551 = fdiv <2 x double> %550, %514
  %552 = insertelement <2 x double> %295, double %call.i1090, i64 1
  ...
  %mul18.i1121 = fmul double %525, 6.000000e+00
  %557 = insertelement <2 x double> %339, double %194, i64 1
  %558 = insertelement <2 x double> poison, double %call5.i735, i64 0
  %559 = insertelement <2 x double> %558, double %call.i733, i64 1
  %560 = load double, ptr @a, align 8, !tbaa !5
  %561 = insertelement <2 x double> %302, double %560, i64 1
  %562 = insertelement <2 x double> %561, double %mul7.i648, i64 0
  %563 = fmul <2 x double> %561, %562
  %564 = load double, ptr @c, align 8, !tbaa !5
  %565 = insertelement <2 x double> %303, double %564, i64 1
  %566 = insertelement <2 x double> %565, double %mul11.i652, i64 0
  ...
  %sub27.i657 = extractelement <2 x double> %574, i64 0
  %neg.i658 = fmul double %298, %sub27.i657
  %575 = fneg double %560
  %fneg.i1130 = fmul double %sub.i971, %575
  %call.i1131 = tail call double @exp(double noundef %fneg.i1130) #13
  %576 = load double, ptr @c, align 8, !tbaa !5
  %577 = fneg double %576
  %fneg4.i1132 = fmul double %sub.i971, %577
  %call5.i1133 = tail call double @exp(double noundef %fneg4.i1132) #13
  %578 = load double, ptr @a, align 8, !tbaa !5
  %579 = load double, ptr @c, align 8, !tbaa !5
  %580 = fneg double %578
  %fneg.i1140 = fmul double %sub.i, %580
  %call.i1141 = tail call double @exp(double noundef %fneg.i1140) #13
  %581 = load double, ptr @c, align 8, !tbaa !5
  %582 = fneg double %581
  %fneg4.i1142 = fmul double %sub.i, %582
  %call5.i1143 = tail call double @exp(double noundef %fneg4.i1142) #13
  %583 = load double, ptr @a, align 8, !tbaa !5
  %584 = load double, ptr @c, align 8, !tbaa !5
  %585 = fneg double %583
  %fneg.i1150 = fmul double %sub.i971, %585
  %call.i1151 = tail call double @exp(double noundef %fneg.i1150) #13
  %586 = load double, ptr @c, align 8, !tbaa !5
  %587 = fneg double %586
  %fneg4.i1152 = fmul double %sub.i971, %587
  %call5.i1153 = tail call double @exp(double noundef %fneg4.i1152) #13
  %588 = load double, ptr @a, align 8, !tbaa !5
  %589 = load double, ptr @c, align 8, !tbaa !5
  %590 = load double, ptr @rootN, align 8, !tbaa !5
  %591 = fneg double %588
  %fneg.i1162 = fmul double %sub.i, %591
  %call.i1163 = tail call double @exp(double noundef %fneg.i1162) #13
  %592 = load double, ptr @c, align 8, !tbaa !5
  %593 = fneg double %592
  %fneg4.i1164 = fmul double %sub.i, %593
  %call5.i1165 = tail call double @exp(double noundef %fneg4.i1164) #13
  %594 = load double, ptr @rootN, align 8, !tbaa !5
  %595 = insertelement <2 x double> %321, double %177, i64 1
  %596 = insertelement <2 x double> poison, double %call5.i699, i64 0
  %597 = insertelement <2 x double> %596, double %call.i697, i64 1
  %598 = insertelement <2 x double> %337, double %189, i64 1
  %599 = insertelement <2 x double> poison, double %call5.i722, i64 0
  %600 = insertelement <2 x double> %599, double %call.i720, i64 1
  ...
  %607 = insertelement <2 x double> poison, double %call5.i1111, i64 0
  %608 = insertelement <2 x double> %607, double %call.i1109, i64 1
  ...
  %sub16.i1120 = extractelement <2 x double> %610, i64 0
  ...
  %sub27.i1122 = extractelement <2 x double> %612, i64 0
  %mul28.i1123 = fmul double %mul18.i1121, %sub27.i1122
  %613 = tail call double @llvm.fmuladd.f64(double %sub16.i1120, double -4.000000e+00, double %mul28.i1123)
  ...
  %neg.i1125 = fmul double %526, -4.000000e+00
  %616 = insertelement <2 x double> %572, double %neg.i1125, i64 1
  %617 = shufflevector <2 x double> <double 4.000000e+00, double poison>, <2 x double> %615, <2 x i32> <i32 0, i32 2>
  %618 = insertelement <2 x double> poison, double %neg.i658, i64 0
  ...
  %mul38.i1126 = fmul double %526, 0x3FF5555555555555
  %621 = insertelement <2 x double> %299, double %525, i64 1
  %622 = insertelement <2 x double> <double 2.000000e+00, double poison>, double %mul38.i1126, i64 1
  %623 = fmul <2 x double> %621, %622
  %624 = insertelement <2 x double> %300, double %call5.i1111, i64 1
  %625 = fdiv <2 x double> %624, %567
  %626 = insertelement <2 x double> %301, double %call.i1109, i64 1
  ...
  %632 = insertelement <2 x double> poison, double %call5.i665, i64 0
  %633 = insertelement <2 x double> %632, double %call5.i1133, i64 1
  ...
  %637 = insertelement <2 x double> poison, double %call.i663, i64 0
  %638 = insertelement <2 x double> %637, double %call.i1131, i64 1
  ...
  %644 = insertelement <2 x double> poison, double %call5.i673, i64 0
  %645 = insertelement <2 x double> %644, double %call5.i1143, i64 1
  ...
  %649 = insertelement <2 x double> poison, double %call.i671, i64 0
  %650 = insertelement <2 x double> %649, double %call.i1141, i64 1
  ...
  %666 = insertelement <2 x double> poison, double %call5.i680, i64 0
  %667 = insertelement <2 x double> %666, double %call5.i1153, i64 1
  %668 = fdiv <2 x double> %667, %665
  %669 = insertelement <2 x double> poison, double %call.i678, i64 0
  %670 = insertelement <2 x double> %669, double %call.i1151, i64 1
  ...
  %682 = insertelement <2 x double> poison, double %call5.i1165, i64 0
  %683 = insertelement <2 x double> %682, double %call.i1163, i64 1
  %684 = load double, ptr @a, align 8, !tbaa !5
  %685 = load double, ptr @c, align 8, !tbaa !5
  %686 = fneg double %684
  %fneg.i1174 = fmul double %sub.i971, %686
  %call.i1175 = tail call double @exp(double noundef %fneg.i1174) #13
  %687 = load double, ptr @c, align 8, !tbaa !5
  %688 = fneg double %687
  %fneg4.i1176 = fmul double %sub.i971, %688
  %call5.i1177 = tail call double @exp(double noundef %fneg4.i1176) #13
  ...
  %sub11.i1169 = extractelement <2 x double> %695, i64 0
  ...
  %sub15.i1170 = extractelement <2 x double> %697, i64 0
  %mul16.i1171 = fmul double %594, %sub15.i1170
  %698 = tail call double @llvm.fmuladd.f64(double %sub11.i1169, double -5.000000e-01, double %mul16.i1171)
  %mul17.i1172 = fmul double %110, %698
  %699 = insertelement <2 x double> poison, double %317, i64 0
  %700 = insertelement <2 x double> %699, double %mul17.i1172, i64 1
  ...
  %712 = fneg double %702
  %fneg.i1188 = fmul double %sub.i, %712
  %call.i1189 = tail call double @exp(double noundef %fneg.i1188) #13
  %713 = load double, ptr @c, align 8, !tbaa !5
  %714 = fneg double %713
  %fneg4.i1190 = fmul double %sub.i, %714
  %call5.i1191 = tail call double @exp(double noundef %fneg4.i1190) #13
  ...
  %721 = insertelement <2 x double> poison, double %call5.i1177, i64 0
  %722 = insertelement <2 x double> %721, double %call.i1175, i64 1
  ...
  %sub12.i1182 = extractelement <2 x double> %724, i64 0
  %fneg13.i = fneg double %sub12.i1182
  ...
  %728 = insertelement <2 x double> %596, double %call5.i1177, i64 1
  %729 = fdiv <2 x double> %728, %707
  %730 = insertelement <2 x double> poison, double %call.i697, i64 0
  %731 = insertelement <2 x double> %730, double %call.i1175, i64 1
  ...
  %neg.i1185 = fmul double %690, -2.000000e+00
  %739 = insertelement <2 x double> poison, double %176, i64 0
  %740 = insertelement <2 x double> %739, double %neg.i1185, i64 1
  ...
  %mul14.i1198 = fmul double %715, 2.000000e+00
  %744 = load double, ptr @a, align 8, !tbaa !5
  %745 = load double, ptr @c, align 8, !tbaa !5
  %746 = fneg double %744
  %fneg.i1204 = fmul double %sub.i971, %746
  %call.i1205 = tail call double @exp(double noundef %fneg.i1204) #13
  %747 = load double, ptr @c, align 8, !tbaa !5
  %748 = fneg double %747
  %fneg4.i1206 = fmul double %sub.i971, %748
  %call5.i1207 = tail call double @exp(double noundef %fneg4.i1206) #13
  ...
  %755 = insertelement <2 x double> poison, double %call5.i1191, i64 0
  %756 = insertelement <2 x double> %755, double %call.i1189, i64 1
  ...
  %sub12.i1196 = extractelement <2 x double> %758, i64 0
  %fneg13.i1197 = fneg double %sub12.i1196
  ...
  %sub19.i1199 = extractelement <2 x double> %760, i64 0
  %761 = tail call double @llvm.fmuladd.f64(double %mul14.i1198, double %sub19.i1199, double %fneg13.i1197)
  ...
  %sub24.i1200 = extractelement <2 x double> %763, i64 0
  %neg.i1201 = fmul double %716, -2.000000e+00
  %764 = tail call double @llvm.fmuladd.f64(double %neg.i1201, double %sub24.i1200, double %761)
  %mul26.i1202 = fmul double %sub, %764
  %765 = insertelement <2 x double> poison, double %335, i64 0
  %766 = insertelement <2 x double> %765, double %mul26.i1202, i64 1
  %767 = fsub <2 x double> %743, %766
  %mul16.i1215 = fmul double %749, 2.000000e+00
  %768 = load double, ptr @a, align 8, !tbaa !5
  %769 = insertelement <2 x double> %336, double %768, i64 1
  %770 = insertelement <2 x double> %769, double %mul7.i723, i64 0
  %771 = fmul <2 x double> %769, %770
  %772 = load double, ptr @c, align 8, !tbaa !5
  %773 = insertelement <2 x double> %337, double %772, i64 1
  %774 = insertelement <2 x double> %773, double %mul10.i726, i64 0
  ...
  %780 = fneg double %768
  %fneg.i1223 = fmul double %sub.i, %780
  %call.i1224 = tail call double @exp(double noundef %fneg.i1223) #13
  %781 = load double, ptr @c, align 8, !tbaa !5
  %782 = fneg double %781
  %fneg4.i1225 = fmul double %sub.i, %782
  %call5.i1226 = tail call double @exp(double noundef %fneg4.i1225) #13
  ...
  %788 = insertelement <2 x double> poison, double %call5.i1207, i64 0
  %789 = insertelement <2 x double> %788, double %call.i1205, i64 1
  ...
  %sub14.i1214 = extractelement <2 x double> %791, i64 0
  %fneg15.i = fneg double %sub14.i1214
  ...
  %sub23.i1216 = extractelement <2 x double> %793, i64 0
  %794 = tail call double @llvm.fmuladd.f64(double %mul16.i1215, double %sub23.i1216, double %fneg15.i)
  %795 = insertelement <2 x double> %599, double %call5.i1207, i64 1
  %796 = fdiv <2 x double> %795, %775
  %797 = insertelement <2 x double> poison, double %call.i720, i64 0
  %798 = insertelement <2 x double> %797, double %call.i1205, i64 1
  ...
  %mul32.i1219 = fmul double %750, 0x3FF5555555555555
  %mul33.i1220 = fmul double %749, %mul32.i1219
  ...
  %810 = insertelement <2 x double> %809, double %mul33.i1220, i64 1
  ...
  %831 = insertelement <2 x double> poison, double %call5.i1226, i64 0
  %832 = insertelement <2 x double> %831, double %call.i1224, i64 1
  ...
  %sub14.i1233 = extractelement <2 x double> %834, i64 0
  %fneg15.i1234 = fneg double %sub14.i1233
  ...
  %sub23.i1236 = extractelement <2 x double> %836, i64 0
  %837 = tail call double @llvm.fmuladd.f64(double %mul16.i1235, double %sub23.i1236, double %fneg15.i1234)
  %838 = load double, ptr @N, align 8, !tbaa !5
  %839 = insertelement <2 x double> %558, double %call5.i1226, i64 1
  %840 = fdiv <2 x double> %839, %821
  %841 = insertelement <2 x double> poison, double %call.i733, i64 0
  %842 = insertelement <2 x double> %841, double %call.i1224, i64 1
  ...
  %mul32.i1239 = fmul double %838, 0x3FF5555555555555
  %mul33.i1240 = fmul double %813, %mul32.i1239
  ...
  %854 = insertelement <2 x double> %853, double %mul33.i1240, i64 1
...
if.else393:                                       ; preds = %if.end275
  %sub.i746 = fadd double %k.8, -1.000000e+00
  %fneg.i747 = fmul double %sub.i746, %78
  %call.i748 = tail call double @exp(double noundef %fneg.i747) #13
  %859 = load double, ptr @c, align 8, !tbaa !5
  %860 = fneg double %859
  %fneg4.i749 = fmul double %sub.i746, %860
  %call5.i750 = tail call double @exp(double noundef %fneg4.i749) #13
  %mul7.i751 = fmul double %k.8, %k.8
  %mul8.i752 = fmul double %k.8, %mul7.i751
  %mul9.i753 = fmul double %k.8, %mul8.i752
  %861 = load double, ptr @a, align 8, !tbaa !5
  %862 = load double, ptr @c, align 8, !tbaa !5
  %863 = insertelement <2 x double> poison, double %call5.i750, i64 0
  %864 = insertelement <2 x double> %863, double %call.i748, i64 1
  ...
  %fneg.i757 = fmul double %861, -0.000000e+00
  %call.i758 = tail call double @exp(double noundef %fneg.i757) #13
  %869 = load double, ptr @c, align 8, !tbaa !5
  %fneg4.i759 = fmul double %869, -0.000000e+00
  %call5.i760 = tail call double @exp(double noundef %fneg4.i759) #13
  %870 = load double, ptr @a, align 8, !tbaa !5
  %871 = load double, ptr @c, align 8, !tbaa !5
  %872 = fdiv double %call.i758, %870
  %873 = insertelement <2 x double> poison, double %mul9.i753, i64 0
  %874 = insertelement <2 x double> %873, double %call5.i760, i64 1
  ...
  %mul13.i762 = fmul double %878, 0x3FC5555555555555
  %879 = extractelement <2 x double> %876, i64 0
  %880 = extractelement <2 x double> %868, i64 0
  %881 = fmul double %879, %880
  %sub320 = fsub double %881, %mul13.i762
  %882 = fneg double %870
  %fneg.i764 = fmul double %sub.i746, %882
  %call.i765 = tail call double @exp(double noundef %fneg.i764) #13
  %883 = load double, ptr @c, align 8, !tbaa !5
  %884 = fneg double %883
  %fneg4.i766 = fmul double %sub.i746, %884
  %call5.i767 = tail call double @exp(double noundef %fneg4.i766) #13
  %885 = insertelement <2 x double> poison, double %call5.i767, i64 0
  %886 = insertelement <2 x double> %885, double %call.i765, i64 1
  ...
  %sub12.i772 = extractelement <2 x double> %894, i64 0
  ...
  %sub16.i773 = extractelement <2 x double> %896, i64 0
  %897 = fneg double %887
  %neg.i774 = fmul double %sub16.i773, %897
  %898 = tail call double @llvm.fmuladd.f64(double %sub12.i772, double 0x3FE5555555555555, double %neg.i774)
  %mul18.i775 = fmul double %mul8.i752, %898
  %add322 = fadd double %sub320, %mul18.i775
  %fneg.i776 = fmul double %888, -0.000000e+00
  %call.i777 = tail call double @exp(double noundef %fneg.i776) #13
  %899 = load double, ptr @c, align 8, !tbaa !5
  %fneg4.i778 = fmul double %899, -0.000000e+00
  %call5.i779 = tail call double @exp(double noundef %fneg4.i778) #13
  %900 = insertelement <2 x double> poison, double %call5.i779, i64 0
  %901 = insertelement <2 x double> %900, double %call.i777, i64 1
  ...
  %sub12.i782 = extractelement <2 x double> %909, i64 0
  ...
  %sub16.i783 = extractelement <2 x double> %911, i64 0
  %912 = fneg double %902
  %neg.i784 = fmul double %sub16.i783, %912
  %913 = tail call double @llvm.fmuladd.f64(double %sub12.i782, double 0x3FE5555555555555, double %neg.i784)
  %sub324 = fsub double %add322, %913
  %914 = fneg double %903
  %fneg.i786 = fmul double %sub.i746, %914
  %call.i787 = tail call double @exp(double noundef %fneg.i786) #13
  %915 = load double, ptr @c, align 8, !tbaa !5
  %916 = fneg double %915
  %fneg4.i788 = fmul double %sub.i746, %916
  %call5.i789 = tail call double @exp(double noundef %fneg4.i788) #13
  ...
  %926 = insertelement <2 x double> poison, double %call5.i789, i64 0
  %927 = insertelement <2 x double> %926, double %call.i787, i64 1
  ...
  %sub13.i795 = extractelement <2 x double> %929, i64 0
  ...
  %sub20.i796 = extractelement <2 x double> %931, i64 0
  %neg.i797 = fmul double %918, %sub20.i796
  %932 = tail call double @llvm.fmuladd.f64(double %sub13.i795, double 2.000000e+00, double %neg.i797)
  ...
  %sub24.i798 = extractelement <2 x double> %934, i64 0
  %935 = tail call double @llvm.fmuladd.f64(double %919, double %sub24.i798, double %932)
  %mul26.i799 = fmul double %mul7.i751, %935
  %add326 = fadd double %sub324, %mul26.i799
  %fneg.i800 = fmul double %920, -0.000000e+00
  %call.i801 = tail call double @exp(double noundef %fneg.i800) #13
  %936 = load double, ptr @c, align 8, !tbaa !5
  %fneg4.i802 = fmul double %936, -0.000000e+00
  %call5.i803 = tail call double @exp(double noundef %fneg4.i802) #13
  ...
  %941 = fneg double %938
  %fneg.i813 = fmul double %sub.i746, %941
  %call.i814 = tail call double @exp(double noundef %fneg.i813) #13
  %942 = load double, ptr @c, align 8, !tbaa !5
  %943 = fneg double %942
  %fneg4.i815 = fmul double %sub.i746, %943
  %call5.i816 = tail call double @exp(double noundef %fneg4.i815) #13
  %944 = load double, ptr @a, align 8, !tbaa !5
  %mul7.i817 = fmul double %944, %944
  %945 = insertelement <2 x double> poison, double %938, i64 0
  %946 = insertelement <2 x double> %945, double %944, i64 1
  %947 = insertelement <2 x double> %946, double %mul7.i817, i64 1
  %948 = fmul <2 x double> %946, %947
  %949 = fmul <2 x double> %946, %948
  %950 = load double, ptr @c, align 8, !tbaa !5
  %mul10.i820 = fmul double %950, %950
  %951 = insertelement <2 x double> poison, double %939, i64 0
  %952 = insertelement <2 x double> %951, double %950, i64 1
  %953 = insertelement <2 x double> %952, double %mul10.i820, i64 1
  %954 = fmul <2 x double> %952, %953
  %955 = fmul <2 x double> %952, %954
  %956 = insertelement <2 x double> poison, double %call5.i803, i64 0
  %957 = insertelement <2 x double> %956, double %call5.i816, i64 1
  %958 = fdiv <2 x double> %957, %955
  %959 = insertelement <2 x double> poison, double %call.i801, i64 0
  %960 = insertelement <2 x double> %959, double %call.i814, i64 1
  ...
  %mul25.i826 = fmul double %972, 2.000000e+00
  ...
  %977 = insertelement <2 x double> %976, double %mul25.i826, i64 1
  ...
  %fneg.i829 = fmul double %944, -0.000000e+00
  %call.i830 = tail call double @exp(double noundef %fneg.i829) #13
  %983 = load double, ptr @c, align 8, !tbaa !5
  %fneg4.i831 = fmul double %983, -0.000000e+00
  %call5.i832 = tail call double @exp(double noundef %fneg4.i831) #13
  %984 = load double, ptr @rootN, align 8, !tbaa !5
  %985 = fmul double %984, -6.000000e+00
  %986 = load double, ptr @N, align 8, !tbaa !5
  %mul25.i842 = fmul double %986, 2.000000e+00
  ...
  %994 = insertelement <2 x double> poison, double %call5.i832, i64 0
  %995 = insertelement <2 x double> %994, double %call.i830, i64 1
  ...
  %sub14.i839 = extractelement <2 x double> %997, i64 0
  ...
  %sub23.i840 = extractelement <2 x double> %999, i64 0
  %neg.i841 = fmul double %985, %sub23.i840
  %1000 = tail call double @llvm.fmuladd.f64(double %sub14.i839, double 4.000000e+00, double %neg.i841)
  ...
  %sub30.i843 = extractelement <2 x double> %1002, i64 0
  %1003 = tail call double @llvm.fmuladd.f64(double %mul25.i842, double %sub30.i843, double %1000)
  %sub332 = fsub double %add330, %1003
  %1004 = fneg double %987
  %fneg.i845 = fmul double %sub.i746, %1004
  %call.i846 = tail call double @exp(double noundef %fneg.i845) #13
  %1005 = load double, ptr @c, align 8, !tbaa !5
  %1006 = fneg double %1005
  %fneg4.i847 = fmul double %sub.i746, %1006
  %call5.i848 = tail call double @exp(double noundef %fneg4.i847) #13
  %1007 = load double, ptr @rootN, align 8, !tbaa !5
  %1008 = fmul double %1007, -6.000000e+00
  %1009 = load double, ptr @N, align 8, !tbaa !5
  %mul29.i860 = fmul double %1009, 2.000000e+00
  ...
  %1018 = insertelement <2 x double> poison, double %call5.i848, i64 0
  %1019 = insertelement <2 x double> %1018, double %call.i846, i64 1
  ...
  %sub16.i857 = extractelement <2 x double> %1021, i64 0
  ...
  %sub27.i858 = extractelement <2 x double> %1023, i64 0
  %neg.i859 = fmul double %1008, %sub27.i858
  %1024 = tail call double @llvm.fmuladd.f64(double %sub16.i857, double 4.000000e+00, double %neg.i859)
  ...
  %sub36.i861 = extractelement <2 x double> %1026, i64 0
  %1027 = tail call double @llvm.fmuladd.f64(double %mul29.i860, double %sub36.i861, double %1024)
  %add334 = fadd double %sub332, %1027
  %fneg.i862 = fmul double %1010, -0.000000e+00
  %call.i863 = tail call double @exp(double noundef %fneg.i862) #13
  %1028 = load double, ptr @c, align 8, !tbaa !5
  %fneg4.i864 = fmul double %1028, -0.000000e+00
  %call5.i865 = tail call double @exp(double noundef %fneg4.i864) #13
  %1029 = load double, ptr @rootN, align 8, !tbaa !5
  %1030 = fmul double %1029, -6.000000e+00
  %1031 = load double, ptr @N, align 8, !tbaa !5
  %mul29.i877 = fmul double %1031, 2.000000e+00
  ...
  %1040 = insertelement <2 x double> poison, double %call5.i865, i64 0
  %1041 = insertelement <2 x double> %1040, double %call.i863, i64 1
  ...
  %sub16.i874 = extractelement <2 x double> %1043, i64 0
  ...
  %sub27.i875 = extractelement <2 x double> %1045, i64 0
  %neg.i876 = fmul double %1030, %sub27.i875
  %1046 = tail call double @llvm.fmuladd.f64(double %sub16.i874, double 4.000000e+00, double %neg.i876)
  ...
  %sub36.i878 = extractelement <2 x double> %1048, i64 0
  %1049 = tail call double @llvm.fmuladd.f64(double %mul29.i877, double %sub36.i878, double %1046)
  %sub336 = fsub double %add334, %1049
  %1050 = fneg double %1032
  %fneg.i880 = fmul double %sub.i746, %1050
  %call.i881 = tail call double @exp(double noundef %fneg.i880) #13
  %1051 = load double, ptr @c, align 8, !tbaa !5
  %1052 = fneg double %1051
  %fneg4.i882 = fmul double %sub.i746, %1052
  %call5.i883 = tail call double @exp(double noundef %fneg4.i882) #13
  %1053 = load double, ptr @a, align 8, !tbaa !5
  %1054 = load double, ptr @c, align 8, !tbaa !5
  %1055 = insertelement <2 x double> poison, double %call5.i883, i64 0
  %1056 = insertelement <2 x double> %1055, double %call.i881, i64 1
  ...
  %fneg.i889 = fmul double %1053, -0.000000e+00
  %call.i890 = tail call double @exp(double noundef %fneg.i889) #13
  %1061 = load double, ptr @c, align 8, !tbaa !5
  %fneg4.i891 = fmul double %1061, -0.000000e+00
  %call5.i892 = tail call double @exp(double noundef %fneg4.i891) #13
  %1062 = load double, ptr @a, align 8, !tbaa !5
  %1063 = load double, ptr @c, align 8, !tbaa !5
  %1064 = fdiv double %call.i890, %1062
  %1065 = insertelement <2 x double> poison, double %mul8.i752, i64 0
  %1066 = insertelement <2 x double> %1065, double %call5.i892, i64 1
  ...
  %mul12.i894 = fmul double %1070, 0x3FC5555555555555
  %1071 = extractelement <2 x double> %1068, i64 0
  %1072 = extractelement <2 x double> %1060, i64 0
  %1073 = fmul double %1071, %1072
  %sub339 = fsub double %1073, %mul12.i894
  %1074 = fneg double %1062
  %fneg.i896 = fmul double %sub.i746, %1074
  %call.i897 = tail call double @exp(double noundef %fneg.i896) #13
  %1075 = load double, ptr @c, align 8, !tbaa !5
  %1076 = fneg double %1075
  %fneg4.i898 = fmul double %sub.i746, %1076
  %call5.i899 = tail call double @exp(double noundef %fneg4.i898) #13
  %1077 = insertelement <2 x double> poison, double %call5.i899, i64 0
  %1078 = insertelement <2 x double> %1077, double %call.i897, i64 1
  ...
  %sub11.i903 = extractelement <2 x double> %1086, i64 0
  ...
  %sub15.i904 = extractelement <2 x double> %1088, i64 0
  %1089 = fneg double %1079
  %neg.i905 = fmul double %sub15.i904, %1089
  %1090 = tail call double @llvm.fmuladd.f64(double %sub11.i903, double 5.000000e-01, double %neg.i905)
  %mul17.i906 = fmul double %mul7.i751, %1090
  %add341 = fadd double %sub339, %mul17.i906
  %fneg.i907 = fmul double %1080, -0.000000e+00
  %call.i908 = tail call double @exp(double noundef %fneg.i907) #13
  %1091 = load double, ptr @c, align 8, !tbaa !5
  %fneg4.i909 = fmul double %1091, -0.000000e+00
  %call5.i910 = tail call double @exp(double noundef %fneg4.i909) #13
  %1092 = insertelement <2 x double> poison, double %call5.i910, i64 0
  %1093 = insertelement <2 x double> %1092, double %call.i908, i64 1
  ...
  %sub11.i913 = extractelement <2 x double> %1101, i64 0
  ...
  %sub15.i914 = extractelement <2 x double> %1103, i64 0
  %1104 = fneg double %1094
  %neg.i915 = fmul double %sub15.i914, %1104
  %1105 = tail call double @llvm.fmuladd.f64(double %sub11.i913, double 5.000000e-01, double %neg.i915)
  %sub343 = fsub double %add341, %1105
  %1106 = fneg double %1095
  %fneg.i917 = fmul double %sub.i746, %1106
  %call.i918 = tail call double @exp(double noundef %fneg.i917) #13
  %1107 = load double, ptr @c, align 8, !tbaa !5
  %1108 = fneg double %1107
  %fneg4.i919 = fmul double %sub.i746, %1108
  %call5.i920 = tail call double @exp(double noundef %fneg4.i919) #13
  %1109 = load double, ptr @rootN, align 8, !tbaa !5
  %neg.i927 = fmul double %1109, -2.000000e+00
  ...
  %1117 = insertelement <2 x double> poison, double %call5.i920, i64 0
  %1118 = insertelement <2 x double> %1117, double %call.i918, i64 1
  ...
  %sub12.i925 = extractelement <2 x double> %1120, i64 0
  ...
  %sub18.i926 = extractelement <2 x double> %1122, i64 0
  %1123 = tail call double @llvm.fmuladd.f64(double %neg.i927, double %sub18.i926, double %sub12.i925)
  ...
  %sub22.i928 = extractelement <2 x double> %1125, i64 0
  %1126 = tail call double @llvm.fmuladd.f64(double %1110, double %sub22.i928, double %1123)
  %mul24.i929 = fmul double %k.8, %1126
  %add345 = fadd double %sub343, %mul24.i929
  %fneg.i930 = fmul double %1111, -0.000000e+00
  %call.i931 = tail call double @exp(double noundef %fneg.i930) #13
  %1127 = load double, ptr @c, align 8, !tbaa !5
  %fneg4.i932 = fmul double %1127, -0.000000e+00
  %call5.i933 = tail call double @exp(double noundef %fneg4.i932) #13
  %1128 = load double, ptr @rootN, align 8, !tbaa !5
  %neg.i940 = fmul double %1128, -2.000000e+00
  ...
  %1136 = insertelement <2 x double> poison, double %call5.i933, i64 0
  %1137 = insertelement <2 x double> %1136, double %call.i931, i64 1
  ...
  %sub12.i938 = extractelement <2 x double> %1139, i64 0
  ...
  %sub18.i939 = extractelement <2 x double> %1141, i64 0
  %1142 = tail call double @llvm.fmuladd.f64(double %neg.i940, double %sub18.i939, double %sub12.i938)
  ...
  %sub22.i941 = extractelement <2 x double> %1144, i64 0
  %1145 = tail call double @llvm.fmuladd.f64(double %1129, double %sub22.i941, double %1142)
  %sub347 = fsub double %add345, %1145
  %1146 = fneg double %1130
  %fneg.i943 = fmul double %sub.i746, %1146
  %call.i944 = tail call double @exp(double noundef %fneg.i943) #13
  %1147 = load double, ptr @c, align 8, !tbaa !5
  %1148 = fneg double %1147
  %fneg4.i945 = fmul double %sub.i746, %1148
  %call5.i946 = tail call double @exp(double noundef %fneg4.i945) #13
  %1149 = load double, ptr @rootN, align 8, !tbaa !5
  %neg.i955 = fmul double %1149, -2.000000e+00
  ...
  %1158 = insertelement <2 x double> poison, double %call5.i946, i64 0
  %1159 = insertelement <2 x double> %1158, double %call.i944, i64 1
  ...
  %sub14.i953 = extractelement <2 x double> %1161, i64 0
  ...
  %sub22.i954 = extractelement <2 x double> %1163, i64 0
  %1164 = tail call double @llvm.fmuladd.f64(double %neg.i955, double %sub22.i954, double %sub14.i953)
  ...
  %sub28.i956 = extractelement <2 x double> %1166, i64 0
  %1167 = tail call double @llvm.fmuladd.f64(double %1150, double %sub28.i956, double %1164)
  %add349 = fadd double %sub347, %1167
  %fneg.i957 = fmul double %1151, -0.000000e+00
  %call.i958 = tail call double @exp(double noundef %fneg.i957) #13
  %1168 = load double, ptr @c, align 8, !tbaa !5
  %fneg4.i959 = fmul double %1168, -0.000000e+00
  %call5.i960 = tail call double @exp(double noundef %fneg4.i959) #13
  %1169 = load double, ptr @rootN, align 8, !tbaa !5
  %neg.i969 = fmul double %1169, -2.000000e+00
  ...
  %1178 = insertelement <2 x double> poison, double %call5.i960, i64 0
  %1179 = insertelement <2 x double> %1178, double %call.i958, i64 1
  ...
  %sub14.i967 = extractelement <2 x double> %1181, i64 0
  ...
  %sub22.i968 = extractelement <2 x double> %1183, i64 0
  %1184 = tail call double @llvm.fmuladd.f64(double %neg.i969, double %sub22.i968, double %sub14.i967)
  ...
  %sub28.i970 = extractelement <2 x double> %1186, i64 0
  %1187 = tail call double @llvm.fmuladd.f64(double %1170, double %sub28.i970, double %1184)
