...
if.end13.peel:                                    ; preds = %if.then7.peel, %if.end4.peel
  %13 = phi i32 [ %spec.store.select.peel, %if.then7.peel ], [ %.pre419, %if.end4.peel ]
...
if.end4.us.peel:                                  ; preds = %if.end4.lr.ph
  %cmp5.us.peel = icmp slt i32 %.pre419, 0
...
if.end13.us.peel:                                 ; preds = %if.then7.us.peel, %if.end4.us.peel
  %20 = phi i32 [ %spec.store.select.us.peel, %if.then7.us.peel ], [ %.pre419, %if.end4.us.peel ]
...
if.then30.split.us.if.end37_crit_edge:            ; preds = %if.then30.split.us
  %.pre421 = load ptr, ptr @yystack.5, align 8, !tbaa !16
  br label %if.end37
...
yygrowstack.exit332:                              ; preds = %if.end14.i326
  ...
  %add.ptr30.i328 = getelementptr inbounds i16, ptr %42, i64 %conv9.i312
  %add.ptr31.i329 = getelementptr inbounds i16, ptr %add.ptr30.i328, i64 -1
  store ptr %add.ptr31.i329, ptr @yystack.3, align 8, !tbaa !15
  %.pre420 = load ptr, ptr @yystack.2, align 8, !tbaa !14
  br label %if.end37

if.end37:                                         ; preds = %if.then30.split.us.if.end37_crit_edge, %yygrowstack.exit332
  %43 = phi ptr [ %add.ptr26.i327, %yygrowstack.exit332 ], [ %.pre421, %if.then30.split.us.if.end37_crit_edge ]
  %44 = phi ptr [ %.pre420, %yygrowstack.exit332 ], [ %37, %if.then30.split.us.if.end37_crit_edge ]
...
if.then66:                                        ; preds = %land.lhs.true60.peel, %land.lhs.true60, %land.lhs.true60.us.peel, %land.lhs.true60.us
  %.us-phi373 = phi i64 [ %idxprom61.us.peel, %land.lhs.true60.us.peel ], [ %idxprom61.us, %land.lhs.true60.us ], [ %idxprom61.peel, %land.lhs.true60.peel ], [ %idxprom61, %land.lhs.true60 ]
  %arrayidx68 = getelementptr inbounds [263 x i16], ptr @yytable, i64 0, i64 %.us-phi373
  br label %yyreduce
...
yygrowstack.exit360:                              ; preds = %if.end14.i354
  ...
  %add.ptr30.i356 = getelementptr inbounds i16, ptr %124, i64 %conv9.i340
  %add.ptr31.i357 = getelementptr inbounds i16, ptr %add.ptr30.i356, i64 -1
  store ptr %add.ptr31.i357, ptr @yystack.3, align 8, !tbaa !15
  %.pre422 = load ptr, ptr @yystack.2, align 8, !tbaa !14
  br label %if.end260

if.end260:                                        ; preds = %yygrowstack.exit360, %if.end253
  %125 = phi ptr [ %add.ptr26.i355, %yygrowstack.exit360 ], [ %add.ptr202, %if.end253 ]
  %126 = phi ptr [ %.pre422, %yygrowstack.exit360 ], [ %add.ptr, %if.end253 ]
