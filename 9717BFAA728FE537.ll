...
call.i.i88.noexc.i:                               ; preds = %if.end.i.i.i
  %call.i.i8889.i590 = ptrtoint ptr %call.i.i8889.i to i64
...
for.cond.preheader.i.i.i:                         ; preds = %call.i.i88.noexc.i
  ...
  br i1 %cmp522.i.i.i, label %iter.check595, label %for.cond.cleanup.i.i.i

iter.check595:                                    ; preds = %for.cond.preheader.i.i.i
  %25 = ptrtoint ptr %24 to i64
  %wide.trip.count.i.i.i = zext i32 %23 to i64
  %min.iters.check593 = icmp ult i32 %23, 8
  %26 = sub i64 %call.i.i8889.i590, %25
  %diff.check591 = icmp ult i64 %26, 32
  %or.cond622 = select i1 %min.iters.check593, i1 true, i1 %diff.check591
  br i1 %or.cond622, label %for.body.i.i.i.preheader, label %vector.main.loop.iter.check597

vector.main.loop.iter.check597:                   ; preds = %iter.check595
  %min.iters.check596 = icmp ult i32 %23, 32
  br i1 %min.iters.check596, label %vec.epilog.ph610, label %vector.ph598

vector.ph598:                                     ; preds = %vector.main.loop.iter.check597
  %n.vec600 = and i64 %wide.trip.count.i.i.i, 4294967264
  br label %vector.body602

vector.body602:                                   ; preds = %vector.body602, %vector.ph598
  %index603 = phi i64 [ 0, %vector.ph598 ], [ %index.next606, %vector.body602 ]
  %27 = getelementptr inbounds i8, ptr %24, i64 %index603
  %wide.load604 = load <16 x i8>, ptr %27, align 1, !tbaa !18
  %28 = getelementptr inbounds i8, ptr %27, i64 16
  %wide.load605 = load <16 x i8>, ptr %28, align 1, !tbaa !18
  %29 = getelementptr inbounds i8, ptr %call.i.i8889.i, i64 %index603
  store <16 x i8> %wide.load604, ptr %29, align 1, !tbaa !18
  %30 = getelementptr inbounds i8, ptr %29, i64 16
  store <16 x i8> %wide.load605, ptr %30, align 1, !tbaa !18
  %index.next606 = add nuw i64 %index603, 32
  %31 = icmp eq i64 %index.next606, %n.vec600
  br i1 %31, label %middle.block592, label %vector.body602, !llvm.loop !77

middle.block592:                                  ; preds = %vector.body602
  %cmp.n601 = icmp eq i64 %n.vec600, %wide.trip.count.i.i.i
  br i1 %cmp.n601, label %delete.notnull.i.i.i, label %vec.epilog.iter.check609

vec.epilog.iter.check609:                         ; preds = %middle.block592
  %n.vec.remaining611 = and i64 %wide.trip.count.i.i.i, 24
  %min.epilog.iters.check612 = icmp eq i64 %n.vec.remaining611, 0
  br i1 %min.epilog.iters.check612, label %for.body.i.i.i.preheader, label %vec.epilog.ph610

vec.epilog.ph610:                                 ; preds = %vector.main.loop.iter.check597, %vec.epilog.iter.check609
  %vec.epilog.resume.val613 = phi i64 [ %n.vec600, %vec.epilog.iter.check609 ], [ 0, %vector.main.loop.iter.check597 ]
  %n.vec615 = and i64 %wide.trip.count.i.i.i, 4294967288
  br label %vec.epilog.vector.body618

vec.epilog.vector.body618:                        ; preds = %vec.epilog.vector.body618, %vec.epilog.ph610
  %index619 = phi i64 [ %vec.epilog.resume.val613, %vec.epilog.ph610 ], [ %index.next621, %vec.epilog.vector.body618 ]
  %32 = getelementptr inbounds i8, ptr %24, i64 %index619
  %wide.load620 = load <8 x i8>, ptr %32, align 1, !tbaa !18
  %33 = getelementptr inbounds i8, ptr %call.i.i8889.i, i64 %index619
  store <8 x i8> %wide.load620, ptr %33, align 1, !tbaa !18
  %index.next621 = add nuw i64 %index619, 8
  %34 = icmp eq i64 %index.next621, %n.vec615
  br i1 %34, label %vec.epilog.middle.block607, label %vec.epilog.vector.body618, !llvm.loop !80

vec.epilog.middle.block607:                       ; preds = %vec.epilog.vector.body618
  %cmp.n617 = icmp eq i64 %n.vec615, %wide.trip.count.i.i.i
  br i1 %cmp.n617, label %delete.notnull.i.i.i, label %for.body.i.i.i.preheader

for.body.i.i.i.preheader:                         ; preds = %iter.check595, %vec.epilog.iter.check609, %vec.epilog.middle.block607
  %indvars.iv.i6.i.i.ph = phi i64 [ 0, %iter.check595 ], [ %n.vec600, %vec.epilog.iter.check609 ], [ %n.vec615, %vec.epilog.middle.block607 ]
...
delete.notnull.i.i.i:                             ; preds = %for.body.i.i.i.prol.loopexit, %for.body.i.i.i, %middle.block592, %vec.epilog.middle.block607, %for.cond.cleanup.i.i.i
...
call.i.i103.noexc.i:                              ; preds = %if.end.i.i105.i
  %call.i.i103129.i557 = ptrtoint ptr %call.i.i103129.i to i64
...
for.cond.preheader.i.i107.i:                      ; preds = %call.i.i103.noexc.i
  ...
  br i1 %cmp522.i.i106.i, label %iter.check562, label %for.cond.cleanup.i.i111.i

iter.check562:                                    ; preds = %for.cond.preheader.i.i107.i
  %54 = ptrtoint ptr %53 to i64
  %wide.trip.count.i.i108.i = zext i32 %52 to i64
  %min.iters.check560 = icmp ult i32 %52, 8
  %55 = sub i64 %call.i.i103129.i557, %54
  %diff.check558 = icmp ult i64 %55, 32
  %or.cond623 = select i1 %min.iters.check560, i1 true, i1 %diff.check558
  br i1 %or.cond623, label %for.body.i.i117.i.preheader, label %vector.main.loop.iter.check564

vector.main.loop.iter.check564:                   ; preds = %iter.check562
  %min.iters.check563 = icmp ult i32 %52, 32
  br i1 %min.iters.check563, label %vec.epilog.ph577, label %vector.ph565

vector.ph565:                                     ; preds = %vector.main.loop.iter.check564
  %n.vec567 = and i64 %wide.trip.count.i.i108.i, 4294967264
  br label %vector.body569

vector.body569:                                   ; preds = %vector.body569, %vector.ph565
  %index570 = phi i64 [ 0, %vector.ph565 ], [ %index.next573, %vector.body569 ]
  %56 = getelementptr inbounds i8, ptr %53, i64 %index570
  %wide.load571 = load <16 x i8>, ptr %56, align 1, !tbaa !18
  %57 = getelementptr inbounds i8, ptr %56, i64 16
  %wide.load572 = load <16 x i8>, ptr %57, align 1, !tbaa !18
  %58 = getelementptr inbounds i8, ptr %call.i.i103129.i, i64 %index570
  store <16 x i8> %wide.load571, ptr %58, align 1, !tbaa !18
  %59 = getelementptr inbounds i8, ptr %58, i64 16
  store <16 x i8> %wide.load572, ptr %59, align 1, !tbaa !18
  %index.next573 = add nuw i64 %index570, 32
  %60 = icmp eq i64 %index.next573, %n.vec567
  br i1 %60, label %middle.block559, label %vector.body569, !llvm.loop !86

middle.block559:                                  ; preds = %vector.body569
  %cmp.n568 = icmp eq i64 %n.vec567, %wide.trip.count.i.i108.i
  br i1 %cmp.n568, label %delete.notnull.i.i118.i, label %vec.epilog.iter.check576

vec.epilog.iter.check576:                         ; preds = %middle.block559
  %n.vec.remaining578 = and i64 %wide.trip.count.i.i108.i, 24
  %min.epilog.iters.check579 = icmp eq i64 %n.vec.remaining578, 0
  br i1 %min.epilog.iters.check579, label %for.body.i.i117.i.preheader, label %vec.epilog.ph577

vec.epilog.ph577:                                 ; preds = %vector.main.loop.iter.check564, %vec.epilog.iter.check576
  %vec.epilog.resume.val580 = phi i64 [ %n.vec567, %vec.epilog.iter.check576 ], [ 0, %vector.main.loop.iter.check564 ]
  %n.vec582 = and i64 %wide.trip.count.i.i108.i, 4294967288
  br label %vec.epilog.vector.body585

vec.epilog.vector.body585:                        ; preds = %vec.epilog.vector.body585, %vec.epilog.ph577
  %index586 = phi i64 [ %vec.epilog.resume.val580, %vec.epilog.ph577 ], [ %index.next588, %vec.epilog.vector.body585 ]
  %61 = getelementptr inbounds i8, ptr %53, i64 %index586
  %wide.load587 = load <8 x i8>, ptr %61, align 1, !tbaa !18
  %62 = getelementptr inbounds i8, ptr %call.i.i103129.i, i64 %index586
  store <8 x i8> %wide.load587, ptr %62, align 1, !tbaa !18
  %index.next588 = add nuw i64 %index586, 8
  %63 = icmp eq i64 %index.next588, %n.vec582
  br i1 %63, label %vec.epilog.middle.block574, label %vec.epilog.vector.body585, !llvm.loop !87

vec.epilog.middle.block574:                       ; preds = %vec.epilog.vector.body585
  %cmp.n584 = icmp eq i64 %n.vec582, %wide.trip.count.i.i108.i
  br i1 %cmp.n584, label %delete.notnull.i.i118.i, label %for.body.i.i117.i.preheader

for.body.i.i117.i.preheader:                      ; preds = %iter.check562, %vec.epilog.iter.check576, %vec.epilog.middle.block574
  %indvars.iv.i6.i112.i.ph = phi i64 [ 0, %iter.check562 ], [ %n.vec567, %vec.epilog.iter.check576 ], [ %n.vec582, %vec.epilog.middle.block574 ]
  %64 = xor i64 %indvars.iv.i6.i112.i.ph, -1
  %65 = add nsw i64 %64, %wide.trip.count.i.i108.i
  %xtraiter637 = and i64 %wide.trip.count.i.i108.i, 3
  %lcmp.mod638.not = icmp eq i64 %xtraiter637, 0
  br i1 %lcmp.mod638.not, label %for.body.i.i117.i.prol.loopexit, label %for.body.i.i117.i.prol
...
for.body.i.i117.i.prol:                           ; preds = %for.body.i.i117.i.preheader, %for.body.i.i117.i.prol
  ...
  %prol.iter639 = phi i64 [ %prol.iter639.next, %for.body.i.i117.i.prol ], [ 0, %for.body.i.i117.i.preheader ]
  ...
  %prol.iter639.next = add i64 %prol.iter639, 1
  %prol.iter639.cmp.not = icmp eq i64 %prol.iter639.next, %xtraiter637
  br i1 %prol.iter639.cmp.not, label %for.body.i.i117.i.prol.loopexit, label %for.body.i.i117.i.prol, !llvm.loop !88
...
delete.notnull.i.i118.i:                          ; preds = %for.body.i.i117.i.prol.loopexit, %for.body.i.i117.i, %middle.block559, %vec.epilog.middle.block574, %for.cond.cleanup.i.i111.i
...
call.i.i.i.noexc371:                              ; preds = %if.end.i.i.i347
  %call.i.i.i372524 = ptrtoint ptr %call.i.i.i372 to i64
...
for.cond.preheader.i.i.i349:                      ; preds = %call.i.i.i.noexc371
  ...
  br i1 %cmp522.i.i.i348, label %iter.check529, label %for.cond.cleanup.i.i.i353

iter.check529:                                    ; preds = %for.cond.preheader.i.i.i349
  %81 = ptrtoint ptr %80 to i64
  %wide.trip.count.i.i.i350 = zext i32 %76 to i64
  %min.iters.check527 = icmp ult i32 %76, 8
  %82 = sub i64 %call.i.i.i372524, %81
  %diff.check525 = icmp ult i64 %82, 32
  %or.cond624 = select i1 %min.iters.check527, i1 true, i1 %diff.check525
  br i1 %or.cond624, label %for.body.i.i.i359.preheader, label %vector.main.loop.iter.check531

vector.main.loop.iter.check531:                   ; preds = %iter.check529
  %min.iters.check530 = icmp ult i32 %76, 32
  br i1 %min.iters.check530, label %vec.epilog.ph544, label %vector.ph532

vector.ph532:                                     ; preds = %vector.main.loop.iter.check531
  %n.vec534 = and i64 %wide.trip.count.i.i.i350, 4294967264
...
vector.body536:                                   ; preds = %vector.body536, %vector.ph532
  ...
  %83 = getelementptr inbounds i8, ptr %80, i64 %index537
  %wide.load538 = load <16 x i8>, ptr %83, align 1, !tbaa !18
  %84 = getelementptr inbounds i8, ptr %83, i64 16
  %wide.load539 = load <16 x i8>, ptr %84, align 1, !tbaa !18
  %85 = getelementptr inbounds i8, ptr %call.i.i.i372, i64 %index537
  store <16 x i8> %wide.load538, ptr %85, align 1, !tbaa !18
  %86 = getelementptr inbounds i8, ptr %85, i64 16
  store <16 x i8> %wide.load539, ptr %86, align 1, !tbaa !18
  %index.next540 = add nuw i64 %index537, 32
  %87 = icmp eq i64 %index.next540, %n.vec534
  br i1 %87, label %middle.block526, label %vector.body536, !llvm.loop !91

middle.block526:                                  ; preds = %vector.body536
  %cmp.n535 = icmp eq i64 %n.vec534, %wide.trip.count.i.i.i350
  br i1 %cmp.n535, label %delete.notnull.i.i.i361, label %vec.epilog.iter.check543

vec.epilog.iter.check543:                         ; preds = %middle.block526
  %n.vec.remaining545 = and i64 %wide.trip.count.i.i.i350, 24
  %min.epilog.iters.check546 = icmp eq i64 %n.vec.remaining545, 0
  br i1 %min.epilog.iters.check546, label %for.body.i.i.i359.preheader, label %vec.epilog.ph544
...
vec.epilog.ph544:                                 ; preds = %vector.main.loop.iter.check531, %vec.epilog.iter.check543
  ...
  %n.vec549 = and i64 %wide.trip.count.i.i.i350, 4294967288
...
vec.epilog.vector.body552:                        ; preds = %vec.epilog.vector.body552, %vec.epilog.ph544
  ...
  %88 = getelementptr inbounds i8, ptr %80, i64 %index553
  %wide.load554 = load <8 x i8>, ptr %88, align 1, !tbaa !18
  %89 = getelementptr inbounds i8, ptr %call.i.i.i372, i64 %index553
  store <8 x i8> %wide.load554, ptr %89, align 1, !tbaa !18
  %index.next555 = add nuw i64 %index553, 8
  %90 = icmp eq i64 %index.next555, %n.vec549
  br i1 %90, label %vec.epilog.middle.block541, label %vec.epilog.vector.body552, !llvm.loop !92

vec.epilog.middle.block541:                       ; preds = %vec.epilog.vector.body552
  %cmp.n551 = icmp eq i64 %n.vec549, %wide.trip.count.i.i.i350
  br i1 %cmp.n551, label %delete.notnull.i.i.i361, label %for.body.i.i.i359.preheader

for.body.i.i.i359.preheader:                      ; preds = %iter.check529, %vec.epilog.iter.check543, %vec.epilog.middle.block541
  %indvars.iv.i.i.i354.ph = phi i64 [ 0, %iter.check529 ], [ %n.vec534, %vec.epilog.iter.check543 ], [ %n.vec549, %vec.epilog.middle.block541 ]
  %91 = xor i64 %indvars.iv.i.i.i354.ph, -1
  %92 = add nsw i64 %91, %wide.trip.count.i.i.i350
  %xtraiter640 = and i64 %wide.trip.count.i.i.i350, 3
  %lcmp.mod641.not = icmp eq i64 %xtraiter640, 0
  br i1 %lcmp.mod641.not, label %for.body.i.i.i359.prol.loopexit, label %for.body.i.i.i359.prol
...
for.body.i.i.i359.prol:                           ; preds = %for.body.i.i.i359.preheader, %for.body.i.i.i359.prol
  ...
  %prol.iter642 = phi i64 [ %prol.iter642.next, %for.body.i.i.i359.prol ], [ 0, %for.body.i.i.i359.preheader ]
  ...
  br i1 %prol.iter642.cmp.not, label %for.body.i.i.i359.prol.loopexit, label %for.body.i.i.i359.prol, !llvm.loop !93
...
delete.notnull.i.i.i361:                          ; preds = %for.body.i.i.i359.prol.loopexit, %for.body.i.i.i359, %middle.block526, %vec.epilog.middle.block541, %for.cond.cleanup.i.i.i353
...
call.i.i.i.noexc326:                              ; preds = %if.end.i.i.i307
  %call.i.i.i327448 = ptrtoint ptr %call.i.i.i327 to i64
...
iter.check:                                       ; preds = %for.cond.preheader.i.i.i309
  ...
  %137 = sub i64 %call.i.i.i327448, %136
  %diff.check = icmp ult i64 %137, 32
  %or.cond625 = select i1 %min.iters.check, i1 true, i1 %diff.check
  br i1 %or.cond625, label %for.body.i.i.i319.preheader, label %vector.main.loop.iter.check

vector.main.loop.iter.check:                      ; preds = %iter.check
  %min.iters.check449 = icmp ult i32 %133, 32
...
vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  ...
  %n.vec452 = and i64 %wide.trip.count.i.i.i310, 4294967288
  br label %vec.epilog.vector.body

vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  %index454 = phi i64 [ %vec.epilog.resume.val, %vec.epilog.ph ], [ %index.next456, %vec.epilog.vector.body ]
  %143 = getelementptr inbounds i8, ptr %135, i64 %index454
  %wide.load455 = load <8 x i8>, ptr %143, align 1, !tbaa !18
  %144 = getelementptr inbounds i8, ptr %call.i.i.i327, i64 %index454
  store <8 x i8> %wide.load455, ptr %144, align 1, !tbaa !18
  %index.next456 = add nuw i64 %index454, 8
  %145 = icmp eq i64 %index.next456, %n.vec452
  br i1 %145, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !114

vec.epilog.middle.block:                          ; preds = %vec.epilog.vector.body
  %cmp.n453 = icmp eq i64 %n.vec452, %wide.trip.count.i.i.i310
  br i1 %cmp.n453, label %delete.notnull.i.i.i321, label %for.body.i.i.i319.preheader

for.body.i.i.i319.preheader:                      ; preds = %iter.check, %vec.epilog.iter.check, %vec.epilog.middle.block
  %indvars.iv.i.i.i314.ph = phi i64 [ 0, %iter.check ], [ %n.vec, %vec.epilog.iter.check ], [ %n.vec452, %vec.epilog.middle.block ]
  %146 = xor i64 %indvars.iv.i.i.i314.ph, -1
  %147 = add nsw i64 %146, %wide.trip.count.i.i.i310
  %xtraiter649 = and i64 %wide.trip.count.i.i.i310, 3
  %lcmp.mod650.not = icmp eq i64 %xtraiter649, 0
  br i1 %lcmp.mod650.not, label %for.body.i.i.i319.prol.loopexit, label %for.body.i.i.i319.prol
...
for.body.i.i.i319.prol:                           ; preds = %for.body.i.i.i319.preheader, %for.body.i.i.i319.prol
  ...
  %prol.iter651 = phi i64 [ %prol.iter651.next, %for.body.i.i.i319.prol ], [ 0, %for.body.i.i.i319.preheader ]
  ...
  br i1 %prol.iter651.cmp.not, label %for.body.i.i.i319.prol.loopexit, label %for.body.i.i.i319.prol, !llvm.loop !115
...
call.i.i.i.noexc285:                              ; preds = %if.end.i.i.i262
  %call.i.i.i286491 = ptrtoint ptr %call.i.i.i286 to i64
...
for.cond.preheader.i.i.i264:                      ; preds = %call.i.i.i.noexc285
  ...
  br i1 %cmp522.i.i.i263, label %iter.check496, label %for.cond.cleanup.i.i.i268

iter.check496:                                    ; preds = %for.cond.preheader.i.i.i264
  %175 = ptrtoint ptr %174 to i64
  %wide.trip.count.i.i.i265 = zext i32 %172 to i64
  %min.iters.check494 = icmp ult i32 %172, 8
  %176 = sub i64 %call.i.i.i286491, %175
  %diff.check492 = icmp ult i64 %176, 32
  %or.cond626 = select i1 %min.iters.check494, i1 true, i1 %diff.check492
  br i1 %or.cond626, label %for.body.i.i.i274.preheader, label %vector.main.loop.iter.check498

vector.main.loop.iter.check498:                   ; preds = %iter.check496
  %min.iters.check497 = icmp ult i32 %172, 32
  br i1 %min.iters.check497, label %vec.epilog.ph511, label %vector.ph499

vector.ph499:                                     ; preds = %vector.main.loop.iter.check498
  %n.vec501 = and i64 %wide.trip.count.i.i.i265, 4294967264
  br label %vector.body503

vector.body503:                                   ; preds = %vector.body503, %vector.ph499
  %index504 = phi i64 [ 0, %vector.ph499 ], [ %index.next507, %vector.body503 ]
  %177 = getelementptr inbounds i8, ptr %174, i64 %index504
  %wide.load505 = load <16 x i8>, ptr %177, align 1, !tbaa !18
  %178 = getelementptr inbounds i8, ptr %177, i64 16
  %wide.load506 = load <16 x i8>, ptr %178, align 1, !tbaa !18
  %179 = getelementptr inbounds i8, ptr %call.i.i.i286, i64 %index504
  store <16 x i8> %wide.load505, ptr %179, align 1, !tbaa !18
  %180 = getelementptr inbounds i8, ptr %179, i64 16
  store <16 x i8> %wide.load506, ptr %180, align 1, !tbaa !18
  %index.next507 = add nuw i64 %index504, 32
  %181 = icmp eq i64 %index.next507, %n.vec501
  br i1 %181, label %middle.block493, label %vector.body503, !llvm.loop !121

middle.block493:                                  ; preds = %vector.body503
  %cmp.n502 = icmp eq i64 %n.vec501, %wide.trip.count.i.i.i265
  br i1 %cmp.n502, label %delete.notnull.i.i.i276, label %vec.epilog.iter.check510

vec.epilog.iter.check510:                         ; preds = %middle.block493
  %n.vec.remaining512 = and i64 %wide.trip.count.i.i.i265, 24
  %min.epilog.iters.check513 = icmp eq i64 %n.vec.remaining512, 0
  br i1 %min.epilog.iters.check513, label %for.body.i.i.i274.preheader, label %vec.epilog.ph511

vec.epilog.ph511:                                 ; preds = %vector.main.loop.iter.check498, %vec.epilog.iter.check510
  %vec.epilog.resume.val514 = phi i64 [ %n.vec501, %vec.epilog.iter.check510 ], [ 0, %vector.main.loop.iter.check498 ]
  %n.vec516 = and i64 %wide.trip.count.i.i.i265, 4294967288
  br label %vec.epilog.vector.body519

vec.epilog.vector.body519:                        ; preds = %vec.epilog.vector.body519, %vec.epilog.ph511
  %index520 = phi i64 [ %vec.epilog.resume.val514, %vec.epilog.ph511 ], [ %index.next522, %vec.epilog.vector.body519 ]
  %182 = getelementptr inbounds i8, ptr %174, i64 %index520
  %wide.load521 = load <8 x i8>, ptr %182, align 1, !tbaa !18
  %183 = getelementptr inbounds i8, ptr %call.i.i.i286, i64 %index520
  store <8 x i8> %wide.load521, ptr %183, align 1, !tbaa !18
  %index.next522 = add nuw i64 %index520, 8
  %184 = icmp eq i64 %index.next522, %n.vec516
  br i1 %184, label %vec.epilog.middle.block508, label %vec.epilog.vector.body519, !llvm.loop !122

vec.epilog.middle.block508:                       ; preds = %vec.epilog.vector.body519
  %cmp.n518 = icmp eq i64 %n.vec516, %wide.trip.count.i.i.i265
  br i1 %cmp.n518, label %delete.notnull.i.i.i276, label %for.body.i.i.i274.preheader

for.body.i.i.i274.preheader:                      ; preds = %iter.check496, %vec.epilog.iter.check510, %vec.epilog.middle.block508
  %indvars.iv.i.i.i269.ph = phi i64 [ 0, %iter.check496 ], [ %n.vec501, %vec.epilog.iter.check510 ], [ %n.vec516, %vec.epilog.middle.block508 ]
  %185 = xor i64 %indvars.iv.i.i.i269.ph, -1
  %186 = add nsw i64 %185, %wide.trip.count.i.i.i265
  %xtraiter643 = and i64 %wide.trip.count.i.i.i265, 3
  %lcmp.mod644.not = icmp eq i64 %xtraiter643, 0
  br i1 %lcmp.mod644.not, label %for.body.i.i.i274.prol.loopexit, label %for.body.i.i.i274.prol
...
for.body.i.i.i274.prol:                           ; preds = %for.body.i.i.i274.preheader, %for.body.i.i.i274.prol
  ...
  %prol.iter645 = phi i64 [ %prol.iter645.next, %for.body.i.i.i274.prol ], [ 0, %for.body.i.i.i274.preheader ]
  ...
  br i1 %prol.iter645.cmp.not, label %for.body.i.i.i274.prol.loopexit, label %for.body.i.i.i274.prol, !llvm.loop !123
...
delete.notnull.i.i.i276:                          ; preds = %for.body.i.i.i274.prol.loopexit, %for.body.i.i.i274, %middle.block493, %vec.epilog.middle.block508, %for.cond.cleanup.i.i.i268
...
call.i.i.i.noexc241:                              ; preds = %if.end.i.i.i222
  %call.i.i.i242458 = ptrtoint ptr %call.i.i.i242 to i64
...
for.cond.preheader.i.i.i224:                      ; preds = %call.i.i.i.noexc241
  ...
  br i1 %cmp522.i.i.i223, label %iter.check463, label %for.cond.cleanup.i.i.i228

iter.check463:                                    ; preds = %for.cond.preheader.i.i.i224
  %203 = ptrtoint ptr %202 to i64
  %wide.trip.count.i.i.i225 = zext i32 %200 to i64
  %min.iters.check461 = icmp ult i32 %200, 8
  %204 = sub i64 %call.i.i.i242458, %203
  %diff.check459 = icmp ult i64 %204, 32
  %or.cond627 = select i1 %min.iters.check461, i1 true, i1 %diff.check459
  br i1 %or.cond627, label %for.body.i.i.i234.preheader, label %vector.main.loop.iter.check465

vector.main.loop.iter.check465:                   ; preds = %iter.check463
  %min.iters.check464 = icmp ult i32 %200, 32
  br i1 %min.iters.check464, label %vec.epilog.ph478, label %vector.ph466

vector.ph466:                                     ; preds = %vector.main.loop.iter.check465
  %n.vec468 = and i64 %wide.trip.count.i.i.i225, 4294967264
  br label %vector.body470

vector.body470:                                   ; preds = %vector.body470, %vector.ph466
  %index471 = phi i64 [ 0, %vector.ph466 ], [ %index.next474, %vector.body470 ]
  %205 = getelementptr inbounds i8, ptr %202, i64 %index471
  %wide.load472 = load <16 x i8>, ptr %205, align 1, !tbaa !18
  %206 = getelementptr inbounds i8, ptr %205, i64 16
  %wide.load473 = load <16 x i8>, ptr %206, align 1, !tbaa !18
  %207 = getelementptr inbounds i8, ptr %call.i.i.i242, i64 %index471
  store <16 x i8> %wide.load472, ptr %207, align 1, !tbaa !18
  %208 = getelementptr inbounds i8, ptr %207, i64 16
  store <16 x i8> %wide.load473, ptr %208, align 1, !tbaa !18
  %index.next474 = add nuw i64 %index471, 32
  %209 = icmp eq i64 %index.next474, %n.vec468
  br i1 %209, label %middle.block460, label %vector.body470, !llvm.loop !125

middle.block460:                                  ; preds = %vector.body470
  %cmp.n469 = icmp eq i64 %n.vec468, %wide.trip.count.i.i.i225
  br i1 %cmp.n469, label %delete.notnull.i.i.i236, label %vec.epilog.iter.check477

vec.epilog.iter.check477:                         ; preds = %middle.block460
  %n.vec.remaining479 = and i64 %wide.trip.count.i.i.i225, 24
  %min.epilog.iters.check480 = icmp eq i64 %n.vec.remaining479, 0
  br i1 %min.epilog.iters.check480, label %for.body.i.i.i234.preheader, label %vec.epilog.ph478

vec.epilog.ph478:                                 ; preds = %vector.main.loop.iter.check465, %vec.epilog.iter.check477
  %vec.epilog.resume.val481 = phi i64 [ %n.vec468, %vec.epilog.iter.check477 ], [ 0, %vector.main.loop.iter.check465 ]
  %n.vec483 = and i64 %wide.trip.count.i.i.i225, 4294967288
  br label %vec.epilog.vector.body486

vec.epilog.vector.body486:                        ; preds = %vec.epilog.vector.body486, %vec.epilog.ph478
  %index487 = phi i64 [ %vec.epilog.resume.val481, %vec.epilog.ph478 ], [ %index.next489, %vec.epilog.vector.body486 ]
  %210 = getelementptr inbounds i8, ptr %202, i64 %index487
  %wide.load488 = load <8 x i8>, ptr %210, align 1, !tbaa !18
  %211 = getelementptr inbounds i8, ptr %call.i.i.i242, i64 %index487
  store <8 x i8> %wide.load488, ptr %211, align 1, !tbaa !18
  %index.next489 = add nuw i64 %index487, 8
  %212 = icmp eq i64 %index.next489, %n.vec483
  br i1 %212, label %vec.epilog.middle.block475, label %vec.epilog.vector.body486, !llvm.loop !126

vec.epilog.middle.block475:                       ; preds = %vec.epilog.vector.body486
  %cmp.n485 = icmp eq i64 %n.vec483, %wide.trip.count.i.i.i225
  br i1 %cmp.n485, label %delete.notnull.i.i.i236, label %for.body.i.i.i234.preheader

for.body.i.i.i234.preheader:                      ; preds = %iter.check463, %vec.epilog.iter.check477, %vec.epilog.middle.block475
  %indvars.iv.i.i.i229.ph = phi i64 [ 0, %iter.check463 ], [ %n.vec468, %vec.epilog.iter.check477 ], [ %n.vec483, %vec.epilog.middle.block475 ]
  %213 = xor i64 %indvars.iv.i.i.i229.ph, -1
  %214 = add nsw i64 %213, %wide.trip.count.i.i.i225
  %xtraiter646 = and i64 %wide.trip.count.i.i.i225, 3
  %lcmp.mod647.not = icmp eq i64 %xtraiter646, 0
  br i1 %lcmp.mod647.not, label %for.body.i.i.i234.prol.loopexit, label %for.body.i.i.i234.prol
...
for.body.i.i.i234.prol:                           ; preds = %for.body.i.i.i234.preheader, %for.body.i.i.i234.prol
  ...
  %prol.iter648 = phi i64 [ %prol.iter648.next, %for.body.i.i.i234.prol ], [ 0, %for.body.i.i.i234.preheader ]
  ...
  br i1 %prol.iter648.cmp.not, label %for.body.i.i.i234.prol.loopexit, label %for.body.i.i.i234.prol, !llvm.loop !127
...
delete.notnull.i.i.i236:                          ; preds = %for.body.i.i.i234.prol.loopexit, %for.body.i.i.i234, %middle.block460, %vec.epilog.middle.block475, %for.cond.cleanup.i.i.i228
...
while.cond.i.i.preheader:                         ; preds = %_Z11MyStringLenIcEiPKT_.exit.i, %if.end9.i.i
  %dest.addr.0.i.i.ph = phi ptr [ %call.i.i4647, %if.end9.i.i ], [ %call.i.i4445, %_Z11MyStringLenIcEiPKT_.exit.i ]
  br label %while.cond.i.i
