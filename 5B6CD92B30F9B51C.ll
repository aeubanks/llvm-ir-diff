...
define dso_local i32 @main() local_unnamed_addr #0 {
  ...
  %2 = load double, ptr @dnan, align 8, !tbaa !5
...
5:                                                ; preds = %0
  ...
  %7 = fcmp une double %2, %6
  br i1 %7, label %8, label %10

8:                                                ; preds = %5
  store double 1.000000e+00, ptr @x, align 8, !tbaa !5
  %9 = fcmp olt double %2, 1.000000e+00
...
15:                                               ; preds = %12
  %16 = fcmp ugt double %2, 1.000000e+00
...
18:                                               ; preds = %15
  %19 = fcmp ult double %2, 1.000000e+00
