; ModuleID = '/usr/local/google/home/aeubanks/repos/test-suite/Bitcode/simd_ops/x86_tests/test_op_vpmulhw_364.bc'
...
@str.11 = private constant [15 x i8] c"op_vpmulhw_364\00", align 32
...
define i32 @__test_op(ptr noalias nocapture readnone %in_f32.buffer, ptr noalias nocapture readnone %in_f64.buffer, ptr noalias nocapture readnone %in_i8.buffer, ptr noalias nocapture readnone %in_u8.buffer, ptr noalias nocapture readonly %in_i16.buffer, ptr noalias nocapture readnone %in_u16.buffer, ptr noalias nocapture readnone %in_i32.buffer, ptr noalias nocapture readnone %in_u32.buffer, ptr noalias nocapture readnone %in_i64.buffer, ptr noalias nocapture readnone %in_u64.buffer, ptr noalias nocapture readonly %op_vpmulhw_364.buffer) local_unnamed_addr #0 {
"produce op_vpmulhw_364":
  %buf_extent168 = getelementptr inbounds %struct.buffer_t, ptr %op_vpmulhw_364.buffer, i64 0, i32 2, i64 1
  %op_vpmulhw_364.extent.1 = load i32, ptr %buf_extent168, align 4
  %buf_min176 = getelementptr inbounds %struct.buffer_t, ptr %op_vpmulhw_364.buffer, i64 0, i32 4, i64 1
  %op_vpmulhw_364.min.1 = load i32, ptr %buf_min176, align 4
  %0 = add nsw i32 %op_vpmulhw_364.min.1, %op_vpmulhw_364.extent.1
  %1 = icmp sgt i32 %op_vpmulhw_364.extent.1, 0
  br i1 %1, label %"for op_vpmulhw_364.s0.y.preheader", label %destructor_block, !prof !4

"for op_vpmulhw_364.s0.y.preheader":              ; preds = %"produce op_vpmulhw_364"
  ...
  %buf_min175 = getelementptr inbounds %struct.buffer_t, ptr %op_vpmulhw_364.buffer, i64 0, i32 4, i64 0
  %op_vpmulhw_364.min.0 = load i32, ptr %buf_min175, align 4
  %2 = sext i32 %op_vpmulhw_364.min.0 to i64
  %buf_stride172 = getelementptr inbounds %struct.buffer_t, ptr %op_vpmulhw_364.buffer, i64 0, i32 3, i64 1
  %op_vpmulhw_364.stride.1 = load i32, ptr %buf_stride172, align 4
  %3 = sext i32 %op_vpmulhw_364.stride.1 to i64
  %buf_host163 = getelementptr inbounds %struct.buffer_t, ptr %op_vpmulhw_364.buffer, i64 0, i32 1
  %op_vpmulhw_364.host = load ptr, ptr %buf_host163, align 8
  %4 = shl nsw i64 %2, 3
  %5 = sub nsw i64 96, %4
  %scevgep = getelementptr i8, ptr %op_vpmulhw_364.host, i64 %5
  %6 = shl nsw i64 %3, 3
  ...
  br label %"for op_vpmulhw_364.s0.x.x.preheader"

"for op_vpmulhw_364.s0.x.x.preheader":            ; preds = %"for op_vpmulhw_364.s0.x.x.preheader", %"for op_vpmulhw_364.s0.y.preheader"
  %lsr.iv180 = phi ptr [ %scevgep, %"for op_vpmulhw_364.s0.y.preheader" ], [ %scevgep182, %"for op_vpmulhw_364.s0.x.x.preheader" ]
  %op_vpmulhw_364.s0.y = phi i32 [ %op_vpmulhw_364.min.1, %"for op_vpmulhw_364.s0.y.preheader" ], [ %228, %"for op_vpmulhw_364.s0.x.x.preheader" ]
  ...
  %228 = add nsw i32 %op_vpmulhw_364.s0.y, 1
  %scevgep182 = getelementptr i1, ptr %lsr.iv180, i64 %6
  %.not2 = icmp eq i32 %228, %0
  br i1 %.not2, label %destructor_block, label %"for op_vpmulhw_364.s0.x.x.preheader"

destructor_block:                                 ; preds = %"for op_vpmulhw_364.s0.x.x.preheader", %"produce op_vpmulhw_364"
  ret i32 0
}
...
; Function Attrs: nofree nosync nounwind memory(readwrite, inaccessiblemem: none)
define i32 @test_op(ptr noalias nocapture readnone %in_f32.buffer, ptr noalias nocapture readnone %in_f64.buffer, ptr noalias nocapture readnone %in_i8.buffer, ptr noalias nocapture readnone %in_u8.buffer, ptr noalias nocapture readonly %in_i16.buffer, ptr noalias nocapture readnone %in_u16.buffer, ptr noalias nocapture readnone %in_i32.buffer, ptr noalias nocapture readnone %in_u32.buffer, ptr noalias nocapture readnone %in_i64.buffer, ptr noalias nocapture readnone %in_u64.buffer, ptr noalias nocapture readonly %op_vpmulhw_364.buffer) local_unnamed_addr #2 {
destructor_block:
  %"__test_op_result$22" = tail call i32 @__test_op(ptr poison, ptr poison, ptr poison, ptr poison, ptr %in_i16.buffer, ptr poison, ptr poison, ptr poison, ptr poison, ptr poison, ptr %op_vpmulhw_364.buffer) #5
  ret i32 0
}
