...
entry:
  ...
  store ptr %0, ptr %call.i.i, align 8, !tbaa !5
  tail call void @lua_pushvalue(ptr noundef %L, i32 noundef -1) #9
  ...
  store ptr null, ptr %call.i.i13, align 8, !tbaa !5
  tail call void @lua_getfield(ptr noundef %L, i32 noundef -10000, ptr noundef nonnull @.str.5) #9
  %call1.i.i14 = tail call i32 @lua_setmetatable(ptr noundef %L, i32 noundef -2) #9
  store ptr %1, ptr %call.i.i13, align 8, !tbaa !5
  tail call void @lua_pushvalue(ptr noundef %L, i32 noundef -1) #9
  ...
  store ptr null, ptr %call.i.i16, align 8, !tbaa !5
  tail call void @lua_getfield(ptr noundef %L, i32 noundef -10000, ptr noundef nonnull @.str.5) #9
  %call1.i.i17 = tail call i32 @lua_setmetatable(ptr noundef %L, i32 noundef -2) #9
  store ptr %2, ptr %call.i.i16, align 8, !tbaa !5
  tail call void @lua_pushvalue(ptr noundef %L, i32 noundef -2) #9
...
if.else.i:                                        ; preds = %entry
  ...
  %1 = load i32, ptr %call.i, align 4, !tbaa !9
...
entry:
  tail call void @lua_pushnil(ptr noundef %L) #9
  tail call void @lua_pushlstring(ptr noundef %L, ptr noundef nonnull @.str.44, i64 noundef 26) #9
  ret i32 2
}
...
entry:
  %call = tail call ptr @luaL_checkudata(ptr noundef %L, i32 noundef 1, ptr noundef nonnull @.str.5) #9
  %0 = load ptr, ptr %call, align 8, !tbaa !5
  %call1 = tail call i32 @pclose(ptr noundef %0)
...
tofile.exit:                                      ; preds = %if.end, %if.then.i
...
if.else.i:                                        ; preds = %tofile.exit
  ...
  %2 = load i32, ptr %call.i4, align 4, !tbaa !9
  tail call void @lua_pushnil(ptr noundef %L) #9
...
pushresult.exit:                                  ; preds = %if.then.i5, %if.else.i
...
if.then:                                          ; preds = %tofile.exit
  ...
  %3 = load i32, ptr %call.i14, align 4, !tbaa !9
  tail call void @lua_pushnil(ptr noundef %L) #9
...
if.else.i:                                        ; preds = %tofile.exit
  ...
  %3 = load i32, ptr %call.i8, align 4, !tbaa !9
  tail call void @lua_pushnil(ptr noundef %L) #9
  %call6.i = tail call ptr @strerror(i32 noundef %3) #9
  %call7.i = tail call ptr (ptr, ptr, ...) @lua_pushfstring(ptr noundef %L, ptr noundef nonnull @.str.19, ptr noundef %call6.i) #9
  %conv.i = sext i32 %3 to i64
...
pushresult.exit:                                  ; preds = %if.then.i9, %if.else.i
...
tofile.exit:                                      ; preds = %entry, %if.then.i
  %1 = phi ptr [ %.pre.i, %if.then.i ], [ %0, %entry ]
  %call1 = tail call fastcc i32 @g_write(ptr noundef %L, ptr noundef %1, i32 noundef 2), !range !11
  ret i32 %call1
}
...
entry.split:                                      ; preds = %entry
  %call226 = tail call fastcc i32 @read_line(ptr noundef %L, ptr noundef nonnull %0)
  br label %if.end

if.then:                                          ; preds = %entry
  %call1 = tail call i32 (ptr, ptr, ...) @luaL_error(ptr noundef %L, ptr noundef nonnull @.str.20) #9
  %call227 = tail call fastcc i32 @read_line(ptr noundef %L, ptr noundef null)
  br label %if.end

if.end:                                           ; preds = %entry.split, %if.then
  %phi.call = phi i32 [ %call226, %entry.split ], [ %call227, %if.then ]
...
cleanup:                                          ; preds = %if.else, %if.then13, %if.end8, %if.then4
...
cleanup:                                          ; preds = %if.end, %lor.lhs.false
...
cleanup17:                                        ; preds = %if.then, %if.else
...
if.else:                                          ; preds = %entry
  ...
  %dec107 = add nsw i32 %call, -2
  br label %for.body

for.body:                                         ; preds = %if.else, %for.inc
  %dec110 = phi i32 [ %dec107, %if.else ], [ %dec, %for.inc ]
...
read_chars.exit:                                  ; preds = %do.end.i, %lor.rhs.i
...
sw.bb:                                            ; preds = %lor.end
  ...
  br i1 %cmp.i79, label %if.then.i, label %read_number.exit
...
read_number.exit:                                 ; preds = %sw.bb, %if.then.i
  %retval.0.i = phi i32 [ 1, %if.then.i ], [ 0, %sw.bb ]
...
do.body.i90:                                      ; preds = %do.body.i90, %sw.bb23
  %rlen.0.i81 = phi i64 [ 8192, %sw.bb23 ], [ %spec.select.i84, %do.body.i90 ]
  %n.addr.0.i82 = phi i64 [ -1, %sw.bb23 ], [ %sub.i87, %do.body.i90 ]
  %call.i83 = call ptr @luaL_prepbuffer(ptr noundef nonnull %b.i80) #9
  %spec.select.i84 = call i64 @llvm.umin.i64(i64 %rlen.0.i81, i64 %n.addr.0.i82)
  %call1.i85 = call i64 @fread(ptr noundef %call.i83, i64 noundef 1, i64 noundef %spec.select.i84, ptr noundef %f)
  %6 = load ptr, ptr %b.i80, align 8, !tbaa !13
  %add.ptr.i86 = getelementptr inbounds i8, ptr %6, i64 %call1.i85
  store ptr %add.ptr.i86, ptr %b.i80, align 8, !tbaa !13
  %sub.i87 = sub i64 %n.addr.0.i82, %call1.i85
  %cmp3.i88 = icmp ne i64 %sub.i87, 0
  %cmp4.i89 = icmp eq i64 %call1.i85, %spec.select.i84
  %7 = and i1 %cmp4.i89, %cmp3.i88
  br i1 %7, label %do.body.i90, label %do.end.i92, !llvm.loop !15

do.end.i92:                                       ; preds = %do.body.i90
  call void @luaL_pushresult(ptr noundef nonnull %b.i80) #9
  %cmp5.i91 = icmp eq i64 %sub.i87, 0
  br i1 %cmp5.i91, label %read_chars.exit97, label %lor.rhs.i95

lor.rhs.i95:                                      ; preds = %do.end.i92
  %call6.i93 = call i64 @lua_objlen(ptr noundef %L, i32 noundef -1) #9
  br label %read_chars.exit97

read_chars.exit97:                                ; preds = %do.end.i92, %lor.rhs.i95
...
for.inc:                                          ; preds = %read_number.exit, %sw.bb21, %read_chars.exit97, %cond.true, %read_chars.exit
...
if.then29:                                        ; preds = %if.end26
  ...
  %9 = load i32, ptr %call.i98, align 4, !tbaa !9
  call void @lua_pushnil(ptr noundef %L) #9
  %call6.i99 = call ptr @strerror(i32 noundef %9) #9
  %call7.i = call ptr (ptr, ptr, ...) @lua_pushfstring(ptr noundef %L, ptr noundef nonnull @.str.19, ptr noundef %call6.i99) #9
  %conv.i100 = sext i32 %9 to i64
  call void @lua_pushinteger(ptr noundef %L, i64 noundef %conv.i100) #9
  br label %cleanup36
...
cleanup36:                                        ; preds = %cleanup, %if.end34, %if.then29
...
for.inc:                                          ; preds = %if.then, %land.rhs, %land.end11
...
if.else.i:                                        ; preds = %for.end
  %call.i = tail call ptr @__errno_location() #10
  %3 = load i32, ptr %call.i, align 4, !tbaa !9
  call void @lua_pushnil(ptr noundef %L) #9
...
if.else.i:                                        ; preds = %getiofile.exit
  %call.i4 = tail call ptr @__errno_location() #10
  %1 = load i32, ptr %call.i4, align 4, !tbaa !9
  tail call void @lua_pushnil(ptr noundef %L) #9
  %call6.i = tail call ptr @strerror(i32 noundef %1) #9
  %call7.i = tail call ptr (ptr, ptr, ...) @lua_pushfstring(ptr noundef %L, ptr noundef nonnull @.str.19, ptr noundef %call6.i) #9
  %conv.i = sext i32 %1 to i64
...
if.else:                                          ; preds = %entry
  ...
  store ptr %call4, ptr %call.i, align 8, !tbaa !5
  %cmp5 = icmp eq ptr %call4, null
  br i1 %cmp5, label %if.then6, label %if.end

if.then6:                                         ; preds = %if.else
  %call.i17 = tail call ptr @__errno_location() #10
  %1 = load i32, ptr %call.i17, align 4, !tbaa !9
...
return:                                           ; preds = %if.then.i.i, %if.then, %if.end
...
entry:
  ...
  store ptr %call3, ptr %call.i, align 8, !tbaa !5
  %cmp = icmp eq ptr %call3, null
  br i1 %cmp, label %cond.true, label %cond.end

cond.true:                                        ; preds = %entry
  %call.i10 = tail call ptr @__errno_location() #10
  %0 = load i32, ptr %call.i10, align 4, !tbaa !9
  tail call void @lua_pushnil(ptr noundef %L) #9
...
pushresult.exit:                                  ; preds = %if.then2.i, %if.else5.i
  %conv.i = sext i32 %0 to i64
  tail call void @lua_pushinteger(ptr noundef %L, i64 noundef %conv.i) #9
  br label %cond.end

cond.end:                                         ; preds = %entry, %pushresult.exit
...
entry:
  ...
  tail call void @lua_getfield(ptr noundef %L, i32 noundef -10000, ptr noundef nonnull @.str.5) #9
  %call1.i = tail call i32 @lua_setmetatable(ptr noundef %L, i32 noundef -2) #9
  %call3 = tail call i32 @fflush(ptr noundef null)
  %call4 = tail call noalias ptr @popen(ptr noundef %call, ptr noundef %call1)
  store ptr %call4, ptr %call.i, align 8, !tbaa !5
  %cmp = icmp eq ptr %call4, null
  br i1 %cmp, label %cond.true, label %cond.end

cond.true:                                        ; preds = %entry
  %call.i12 = tail call ptr @__errno_location() #10
  %0 = load i32, ptr %call.i12, align 4, !tbaa !9
  tail call void @lua_pushnil(ptr noundef %L) #9
  %tobool1.not.i = icmp eq ptr %call, null
  %call6.i = tail call ptr @strerror(i32 noundef %0) #9
  br i1 %tobool1.not.i, label %if.else5.i, label %if.then2.i
...
entry:
  ...
  store ptr %call1, ptr %call.i, align 8, !tbaa !5
  %cmp = icmp eq ptr %call1, null
  br i1 %cmp, label %cond.true, label %cond.end

cond.true:                                        ; preds = %entry
  %call.i5 = tail call ptr @__errno_location() #10
  %0 = load i32, ptr %call.i5, align 4, !tbaa !9
  tail call void @lua_pushnil(ptr noundef %L) #9
  %call6.i = tail call ptr @strerror(i32 noundef %0) #9
  %call7.i = tail call ptr (ptr, ptr, ...) @lua_pushfstring(ptr noundef %L, ptr noundef nonnull @.str.19, ptr noundef %call6.i) #9
  %conv.i = sext i32 %0 to i64
...
if.then6:                                         ; preds = %if.else
  tail call void @lua_pushlstring(ptr noundef %L, ptr noundef nonnull @.str.42, i64 noundef 11) #9
  br label %if.end8

if.else7:                                         ; preds = %if.else
  tail call void @lua_pushlstring(ptr noundef %L, ptr noundef nonnull @.str.43, i64 noundef 4) #9
  br label %if.end8
...
getiofile.exit:                                   ; preds = %entry, %if.then.i
  %call1 = tail call fastcc i32 @g_write(ptr noundef %L, ptr noundef %0, i32 noundef 1), !range !11
  ret i32 %call1
}
...
if.then6:                                         ; preds = %if.then2
  ...
  %0 = load i32, ptr %call.i21, align 4, !tbaa !9
...
if.else:                                          ; preds = %if.then
  ...
  %1 = load ptr, ptr %call.i23, align 8, !tbaa !5
...
tofile.exit:                                      ; preds = %if.else, %if.then.i
  tail call void @lua_pushvalue(ptr noundef %L, i32 noundef 1) #9
  br label %if.end8

if.end8:                                          ; preds = %if.then2, %if.then6, %tofile.exit
