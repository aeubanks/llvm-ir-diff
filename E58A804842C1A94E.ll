...
if.then2.if.end10_crit_edge:                      ; preds = %if.then2
  ...
  %.pre81 = load i32, ptr %_inPos, align 8, !tbaa !36
  br label %if.end10

if.end10:                                         ; preds = %if.then2.if.end10_crit_edge, %do.body
  %5 = phi i32 [ %.pre81, %if.then2.if.end10_crit_edge ], [ %0, %do.body ]
...
cleanup51.thread:                                 ; preds = %if.end38, %cleanup51.thread.loopexit, %cleanup51.thread.loopexit83, %cleanup51.thread.loopexit82
  %retval.4.ph = phi i32 [ 1, %cleanup51.thread.loopexit82 ], [ -2147467259, %cleanup51.thread.loopexit83 ], [ -2147024882, %cleanup51.thread.loopexit ], [ -2147024809, %if.end38 ]
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %status) #14
...
cleanup51:                                        ; preds = %if.end38
  ...
  br i1 %or.cond79, label %return, label %do.body, !llvm.loop !47
