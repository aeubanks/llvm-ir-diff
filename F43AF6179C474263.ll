...
while.end.i:                                      ; preds = %while.body.i, %if.end28
  ...
  %cmp.i330 = icmp eq ptr %15, null
  br i1 %cmp.i330, label %if.then32, label %for.cond.preheader.i
...
land.lhs.true.i:                                  ; preds = %for.end.i
  ...
  %call.i331 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %tag, ptr noundef nonnull dereferenceable(1) %ostring.i) #14
  %cmp18.i = icmp eq i32 %call.i331, 0
...
if.end93:                                         ; preds = %if.else90, %if.then82
  %link.0.in340 = getelementptr inbounds %struct.LIST, ptr %db, i64 0, i32 1
  %link.0341 = load ptr, ptr %link.0.in340, align 8, !tbaa !5
  %cmp95.not342 = icmp eq ptr %link.0341, %db
  br i1 %cmp95.not342, label %if.then148, label %for.cond99.preheader

for.cond99.preheader:                             ; preds = %if.end93, %for.inc141
  %link.0344 = phi ptr [ %link.0, %for.inc141 ], [ %link.0341, %if.end93 ]
  %count.0343 = phi i32 [ %count.1, %for.inc141 ], [ 0, %if.end93 ]
  br label %for.cond99

for.cond99:                                       ; preds = %for.cond99.preheader, %for.cond99
  %link.0.pn = phi ptr [ %yy.0, %for.cond99 ], [ %link.0344, %for.cond99.preheader ]
...
if.end129:                                        ; preds = %if.end122
  ...
  br i1 %cmp130, label %for.end145, label %if.end133

if.end133:                                        ; preds = %if.end129
  %onumber = getelementptr inbounds %struct.link_type, ptr %link.0344, i64 0, i32 2
  %26 = load i8, ptr %onumber, align 1, !tbaa !5
  %conv134 = zext i8 %26 to i32
  %spec.select = call i32 @llvm.smax.i32(i32 %count.0343, i32 %conv134)
  br label %for.inc141

for.inc141:                                       ; preds = %if.end133, %if.end122
  %count.1 = phi i32 [ %count.0343, %if.end122 ], [ %spec.select, %if.end133 ]
  %link.0.in = getelementptr inbounds %struct.LIST, ptr %link.0344, i64 0, i32 1
...
for.end145:                                       ; preds = %if.end129
  %cmp146 = icmp eq ptr %link.0344, %db
  br i1 %cmp146, label %if.then148, label %for.end145.if.end258_crit_edge

for.end145.if.end258_crit_edge:                   ; preds = %for.end145
  %onumber259.phi.trans.insert = getelementptr inbounds %struct.link_type, ptr %link.0344, i64 0, i32 2
  %.pre353 = load i8, ptr %onumber259.phi.trans.insert, align 1, !tbaa !5
  br label %if.end258

if.then148:                                       ; preds = %for.inc141, %if.end93, %for.end145
  %count.0.lcssa357 = phi i32 [ %count.0343, %for.end145 ], [ 0, %if.end93 ], [ %count.1, %for.inc141 ]
  %ocross_sym = getelementptr inbounds %struct.symbol_type, ptr %sym, i64 0, i32 8
  %27 = load ptr, ptr %ocross_sym, align 8, !tbaa !5
  %cmp149 = icmp eq ptr %27, null
...
if.end152:                                        ; preds = %if.then151, %if.then148
  ...
  %conv154 = zext i8 %28 to i64
  %arrayidx160 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %conv154
  %29 = load ptr, ptr %arrayidx160, align 8, !tbaa !8
  %cmp161 = icmp eq ptr %29, null
  br i1 %cmp161, label %if.then163, label %if.else165

if.then163:                                       ; preds = %if.end152
  %30 = load ptr, ptr @no_fpos, align 8, !tbaa !8
  %call164 = call ptr @GetMemory(i32 noundef %conv153, ptr noundef %30) #12
  br label %if.end174

if.else165:                                       ; preds = %if.end152
  store ptr %29, ptr @zz_hold, align 8, !tbaa !8
  %31 = load ptr, ptr %29, align 8, !tbaa !5
  store ptr %31, ptr %arrayidx160, align 8, !tbaa !8
  br label %if.end174

if.end174:                                        ; preds = %if.then163, %if.else165
  %32 = phi ptr [ %call164, %if.then163 ], [ %29, %if.else165 ]
  %ou1175 = getelementptr inbounds %struct.word_type, ptr %32, i64 0, i32 1
  store i8 0, ptr %ou1175, align 8, !tbaa !5
  %arrayidx178 = getelementptr inbounds [2 x %struct.LIST], ptr %32, i64 0, i64 1
  %osucc179 = getelementptr inbounds [2 x %struct.LIST], ptr %32, i64 0, i64 1, i32 1
  store ptr %32, ptr %osucc179, align 8, !tbaa !5
  store ptr %32, ptr %arrayidx178, align 8, !tbaa !5
  %osucc185 = getelementptr inbounds %struct.LIST, ptr %32, i64 0, i32 1
  store ptr %32, ptr %osucc185, align 8, !tbaa !5
...
cond.false194:                                    ; preds = %if.end174
  %33 = load ptr, ptr %db, align 8, !tbaa !5
  store ptr %33, ptr @zz_tmp, align 8, !tbaa !8
  %34 = load ptr, ptr %32, align 8, !tbaa !5
  store ptr %34, ptr %db, align 8, !tbaa !5
  %35 = load ptr, ptr @zz_hold, align 8, !tbaa !8
  %36 = load ptr, ptr @zz_res, align 8, !tbaa !8
  %37 = load ptr, ptr %36, align 8, !tbaa !5
  %osucc209 = getelementptr inbounds %struct.LIST, ptr %37, i64 0, i32 1
  store ptr %35, ptr %osucc209, align 8, !tbaa !5
  ...
  %osucc215 = getelementptr inbounds %struct.LIST, ptr %40, i64 0, i32 1
  store ptr %39, ptr %osucc215, align 8, !tbaa !5
  %.pre352 = load ptr, ptr @xx_link, align 8, !tbaa !8
  br label %cond.end216

cond.end216:                                      ; preds = %if.end174, %cond.false194
  %41 = phi ptr [ %32, %if.end174 ], [ %.pre352, %cond.false194 ]
  store ptr %41, ptr @zz_res, align 8, !tbaa !8
  %42 = load ptr, ptr %ocross_sym, align 8, !tbaa !5
  store ptr %42, ptr @zz_hold, align 8, !tbaa !8
  %cmp219 = icmp eq ptr %42, null
  %cmp223 = icmp eq ptr %41, null
  %or.cond = select i1 %cmp219, i1 true, i1 %cmp223
  br i1 %or.cond, label %cond.end250, label %cond.false226

cond.false226:                                    ; preds = %cond.end216
  %arrayidx228 = getelementptr inbounds [2 x %struct.LIST], ptr %42, i64 0, i64 1
  %43 = load ptr, ptr %arrayidx228, align 8, !tbaa !5
  store ptr %43, ptr @zz_tmp, align 8, !tbaa !8
  %arrayidx231 = getelementptr inbounds [2 x %struct.LIST], ptr %41, i64 0, i64 1
  %44 = load ptr, ptr %arrayidx231, align 8, !tbaa !5
  store ptr %44, ptr %arrayidx228, align 8, !tbaa !5
  %45 = load ptr, ptr %arrayidx231, align 8, !tbaa !5
  %osucc241 = getelementptr inbounds [2 x %struct.LIST], ptr %45, i64 0, i64 1, i32 1
  store ptr %42, ptr %osucc241, align 8, !tbaa !5
  store ptr %43, ptr %arrayidx231, align 8, !tbaa !5
  %osucc247 = getelementptr inbounds [2 x %struct.LIST], ptr %43, i64 0, i64 1, i32 1
  store ptr %41, ptr %osucc247, align 8, !tbaa !5
  br label %cond.end250

cond.end250:                                      ; preds = %cond.end216, %cond.false226
  %46 = load ptr, ptr %db, align 8, !tbaa !5
  %47 = trunc i32 %count.0.lcssa357 to i8
  %conv256 = add i8 %47, 1
  %onumber257 = getelementptr inbounds %struct.link_type, ptr %46, i64 0, i32 2
  store i8 %conv256, ptr %onumber257, align 1, !tbaa !5
  %odb_targ = getelementptr inbounds %struct.link_type, ptr %46, i64 0, i32 3
  store i8 0, ptr %odb_targ, align 2, !tbaa !5
  br label %if.end258

if.end258:                                        ; preds = %for.end145.if.end258_crit_edge, %cond.end250
  %48 = phi i8 [ %conv256, %cond.end250 ], [ %.pre353, %for.end145.if.end258_crit_edge ]
  %link.1 = phi ptr [ %46, %cond.end250 ], [ %link.0344, %for.end145.if.end258_crit_edge ]
...
if.then:                                          ; preds = %entry
  ...
  %conv.i210 = sext i32 %mul to i64
  %mul.i = shl nsw i64 %conv.i210, 3
...
dtab_new.exit:                                    ; preds = %if.end.i214, %for.body.preheader.i
  ...
  %cmp.i221 = icmp sgt i32 %6, 0
  br i1 %cmp.i221, label %for.body.i, label %dtab_rehash.exit
...
for.body.i:                                       ; preds = %dtab_new.exit, %for.inc33.i
  ...
  br i1 %cmp1.i.not, label %for.inc33.i, label %if.then.i
...
if.end.i:                                         ; preds = %if.then7.i, %if.then.i
  %link.0.i.in217 = getelementptr inbounds %struct.LIST, ptr %8, i64 0, i32 1
  %link.0.i218 = load ptr, ptr %link.0.i.in217, align 8, !tbaa !5
  %cmp11.i.not219 = icmp eq ptr %link.0.i218, %8
  br i1 %cmp11.i.not219, label %for.end30.i, label %for.cond16.i.preheader

for.cond16.i.preheader:                           ; preds = %if.end.i, %for.end.i
  %link.0.i220 = phi ptr [ %link.0.i, %for.end.i ], [ %link.0.i218, %if.end.i ]
  br label %for.cond16.i

for.cond16.i:                                     ; preds = %for.cond16.i.preheader, %for.cond16.i
  %link.0.i.pn = phi ptr [ %z.0.i, %for.cond16.i ], [ %link.0.i220, %for.cond16.i.preheader ]
  %z.0.i.in = getelementptr inbounds [2 x %struct.LIST], ptr %link.0.i.pn, i64 0, i64 1
...
for.end.i:                                        ; preds = %for.cond16.i
  ...
  %link.0.i.in = getelementptr inbounds %struct.LIST, ptr %link.0.i220, i64 0, i32 1
  %link.0.i = load ptr, ptr %link.0.i.in, align 8, !tbaa !5
  %cmp11.i.not = icmp eq ptr %link.0.i, %8
  br i1 %cmp11.i.not, label %for.end30.i, label %for.cond16.i.preheader, !llvm.loop !21
...
dtab_rehash.exit.loopexit:                        ; preds = %for.inc33.i
  %.pre231 = load ptr, ptr %NewS.i, align 8, !tbaa !8
  br label %dtab_rehash.exit

dtab_rehash.exit:                                 ; preds = %dtab_rehash.exit.loopexit, %dtab_new.exit
  %14 = phi ptr [ %.pre231, %dtab_rehash.exit.loopexit ], [ %call.i211, %dtab_new.exit ]
  ...
  %.pre232 = load i32, ptr %dbchecktab_count2.phi.trans.insert, align 4, !tbaa !19
  br label %if.end

if.end:                                           ; preds = %dtab_rehash.exit, %entry
  %15 = phi i32 [ %.pre232, %dtab_rehash.exit ], [ %1, %entry ]
  ...
  %tobool.not223 = icmp eq i8 %19, 0
  br i1 %tobool.not223, label %while.end, label %while.body

while.body:                                       ; preds = %if.end, %while.body
  %20 = phi i8 [ %21, %while.body ], [ %19, %if.end ]
  %p.0225 = phi ptr [ %incdec.ptr, %while.body ], [ %ostring, %if.end ]
  %pos.0224 = phi i64 [ %add, %while.body ], [ %18, %if.end ]
  %incdec.ptr = getelementptr inbounds i8, ptr %p.0225, i64 1
  %conv = zext i8 %20 to i64
  %add = add i64 %pos.0224, %conv
...
if.end26:                                         ; preds = %if.then17, %if.else19
  ...
  %arrayidx28 = getelementptr inbounds [2 x %struct.LIST], ptr %28, i64 0, i64 1
  ...
  %.pre233 = load ptr, ptr %S, align 8, !tbaa !8
  %arrayidx42.phi.trans.insert = getelementptr inbounds %struct.anon.14, ptr %.pre233, i64 0, i32 2, i64 %rem
  %.pre234 = load ptr, ptr %arrayidx42.phi.trans.insert, align 8, !tbaa !8
  br label %if.end40

if.end40:                                         ; preds = %if.end26, %while.end
  %30 = phi ptr [ %.pre234, %if.end26 ], [ %23, %while.end ]
  %link.0.in226 = getelementptr inbounds %struct.LIST, ptr %30, i64 0, i32 1
  %link.0227 = load ptr, ptr %link.0.in226, align 8, !tbaa !5
  %cmp46.not228 = icmp eq ptr %link.0227, %30
  br i1 %cmp46.not228, label %for.end79, label %for.cond51.preheader

for.cond51.preheader:                             ; preds = %if.end40, %for.inc75
  %link.0229 = phi ptr [ %link.0, %for.inc75 ], [ %link.0227, %if.end40 ]
  br label %for.cond51

for.cond51:                                       ; preds = %for.cond51.preheader, %for.cond51
  %link.0.pn = phi ptr [ %y.0, %for.cond51 ], [ %link.0229, %for.cond51.preheader ]
...
for.inc75:                                        ; preds = %for.end, %land.lhs.true, %if.then72
  %link.0.in = getelementptr inbounds %struct.LIST, ptr %link.0229, i64 0, i32 1
  %link.0 = load ptr, ptr %link.0.in, align 8, !tbaa !5
...
if.end102:                                        ; preds = %if.then91, %if.else93
  ...
  %arrayidx106 = getelementptr inbounds [2 x %struct.LIST], ptr %39, i64 0, i64 1
  %osucc107 = getelementptr inbounds [2 x %struct.LIST], ptr %39, i64 0, i64 1, i32 1
  store ptr %39, ptr %osucc107, align 8, !tbaa !5
  store ptr %39, ptr %arrayidx106, align 8, !tbaa !5
...
cond.false124:                                    ; preds = %if.end102
  ...
  %.pre235 = load ptr, ptr @xx_link, align 8, !tbaa !8
  br label %cond.end146

cond.end146:                                      ; preds = %if.end102, %cond.false124
  %50 = phi ptr [ %39, %if.end102 ], [ %.pre235, %cond.false124 ]
  ...
  %or.cond = select i1 %cmp148, i1 true, i1 %cmp152
  br i1 %or.cond, label %cond.end179, label %cond.false155
...
cond.false82:                                     ; preds = %while.body
  %arrayidx77 = getelementptr inbounds [2 x %struct.LIST], ptr %21, i64 0, i64 1
  store ptr %22, ptr @zz_res, align 8, !tbaa !8
  %23 = load ptr, ptr %arrayidx77, align 8, !tbaa !5
  %arrayidx90 = getelementptr inbounds [2 x %struct.LIST], ptr %22, i64 0, i64 1
  store ptr %23, ptr %arrayidx90, align 8, !tbaa !5
  %24 = load ptr, ptr %arrayidx77, align 8, !tbaa !5
  ...
  store ptr %21, ptr %arrayidx77, align 8, !tbaa !5
...
cond.false180:                                    ; preds = %while.body170
  %arrayidx175 = getelementptr inbounds [2 x %struct.LIST], ptr %37, i64 0, i64 1
  store ptr %38, ptr @zz_res, align 8, !tbaa !8
  %39 = load ptr, ptr %arrayidx175, align 8, !tbaa !5
  %arrayidx188 = getelementptr inbounds [2 x %struct.LIST], ptr %38, i64 0, i64 1
  store ptr %39, ptr %arrayidx188, align 8, !tbaa !5
  %40 = load ptr, ptr %arrayidx175, align 8, !tbaa !5
  ...
  store ptr %37, ptr %arrayidx175, align 8, !tbaa !5
...
if.then12:                                        ; preds = %if.end9
  ...
  %link.0.in895 = getelementptr inbounds %struct.LIST, ptr %symbs, i64 0, i32 1
  br label %while.cond
...
for.cond.preheader:                               ; preds = %if.end35
  %link.0896 = load ptr, ptr %link.0.in895, align 8, !tbaa !5
  %cmp45.not897 = icmp eq ptr %link.0896, %symbs
  br i1 %cmp45.not897, label %if.then77, label %for.cond49.preheader.lr.ph
...
for.cond49.preheader:                             ; preds = %for.cond49.preheader.lr.ph, %for.inc70
  %link.0898 = phi ptr [ %link.0896, %for.cond49.preheader.lr.ph ], [ %link.0, %for.inc70 ]
  br label %for.cond49

for.cond49:                                       ; preds = %for.cond49.preheader, %for.cond49
  %link.0.pn = phi ptr [ %y.0, %for.cond49 ], [ %link.0898, %for.cond49.preheader ]
  %y.0.in = getelementptr inbounds [2 x %struct.LIST], ptr %link.0.pn, i64 0, i64 1
  %y.0 = load ptr, ptr %y.0.in, align 8, !tbaa !5
...
land.lhs.true64:                                  ; preds = %for.cond49
  ...
  br i1 %cmp66, label %for.end74, label %for.inc70

for.inc70:                                        ; preds = %for.cond49, %land.lhs.true64
  %link.0.in = getelementptr inbounds %struct.LIST, ptr %link.0898, i64 0, i32 1
  %link.0 = load ptr, ptr %link.0.in, align 8, !tbaa !5
...
for.end74:                                        ; preds = %land.lhs.true64
  %cmp75 = icmp eq ptr %link.0898, %symbs
  br i1 %cmp75, label %if.then77, label %if.end83

if.then77:                                        ; preds = %for.inc70, %for.cond.preheader, %for.end74
...
if.end83:                                         ; preds = %if.then38, %for.end74, %if.then77
  %link.1.in900 = getelementptr inbounds %struct.LIST, ptr %call22, i64 0, i32 1
  %link.1901 = load ptr, ptr %link.1.in900, align 8, !tbaa !5
  %cmp88.not902 = icmp eq ptr %link.1901, %call22
  br i1 %cmp88.not902, label %if.then149, label %for.cond94.preheader

for.cond94.preheader:                             ; preds = %if.end83, %for.inc142
  %link.1903 = phi ptr [ %link.1, %for.inc142 ], [ %link.1901, %if.end83 ]
  br label %for.cond94

for.cond94:                                       ; preds = %for.cond94.preheader, %for.cond94
  %link.1.pn = phi ptr [ %par.0, %for.cond94 ], [ %link.1903, %for.cond94.preheader ]
...
for.inc142:                                       ; preds = %for.cond94, %land.lhs.true111, %land.lhs.true116
  %link.1.in = getelementptr inbounds %struct.LIST, ptr %link.1903, i64 0, i32 1
...
if.end154:                                        ; preds = %for.cond129, %if.then149
  %tag.1873 = phi ptr [ null, %if.then149 ], [ %tag.0, %for.cond129 ]
  %call155 = call ptr @ReplaceWithTidy(ptr noundef %tag.1873, i32 noundef 1) #12
...
if.end235:                                        ; preds = %if.then233, %if.then223
  ...
  %ou1.i856 = getelementptr inbounds %struct.word_type, ptr %call241, i64 0, i32 1
  %22 = load i8, ptr %ou1.i856, align 8, !tbaa !5
  %.off.i857 = add i8 %22, -11
  %switch.i858 = icmp ult i8 %.off.i857, 2
  br i1 %switch.i858, label %DbCreate.exit863, label %if.then.i860

if.then.i860:                                     ; preds = %if.end235
  %23 = load ptr, ptr @no_fpos, align 8, !tbaa !8
  %call.i859 = call ptr (i32, i32, ptr, i32, ptr, ...) @Error(i32 noundef 1, i32 noundef 2, ptr noundef nonnull @.str, i32 noundef 0, ptr noundef %23, ptr noundef nonnull @.str.1) #12
  br label %DbCreate.exit863

DbCreate.exit863:                                 ; preds = %if.end235, %if.then.i860
  %oreading.i861 = getelementptr inbounds i8, ptr %call241, i64 42
  store i8 0, ptr %oreading.i861, align 2, !tbaa !5
  %ou3.i862 = getelementptr inbounds %struct.word_type, ptr %call241, i64 0, i32 3
  store ptr null, ptr %ou3.i862, align 8, !tbaa !5
  br label %if.end243

if.end243:                                        ; preds = %DbCreate.exit863, %if.end220
  %db.2 = phi ptr [ %call241, %DbCreate.exit863 ], [ %db.0, %if.end220 ]
...
cond.end357:                                      ; preds = %if.then304, %if.else306
  ...
  %arrayidx319 = getelementptr inbounds [2 x %struct.LIST], ptr %32, i64 0, i64 1
  %osucc320 = getelementptr inbounds [2 x %struct.LIST], ptr %32, i64 0, i64 1, i32 1
  store ptr %32, ptr %osucc320, align 8, !tbaa !5
  store ptr %32, ptr %arrayidx319, align 8, !tbaa !5
...
if.end397:                                        ; preds = %if.end392
  ...
  %cmp401.not906 = icmp eq ptr %call399, null
  br i1 %cmp401.not906, label %while.end670.thread, label %while.body403.lr.ph
...
while.body403.lr.ph:                              ; preds = %if.end397
  ...
  %cmp406967 = icmp ne i8 %45, 48
  %46 = load i8, ptr %arrayidx409, align 1
  %cmp411968 = icmp ne i8 %46, 48
  %or.cond718969 = select i1 %cmp406967, i1 true, i1 %cmp411968
  br i1 %or.cond718969, label %while.end670, label %if.end414
...
while.body403:                                    ; preds = %if.end667
  ...
  br i1 %or.cond718, label %while.end670.loopexit, label %if.end414, !llvm.loop !33

if.end414:                                        ; preds = %while.body403.lr.ph, %while.body403
  %lnum.0907970 = phi i32 [ %inc, %while.body403 ], [ 1, %while.body403.lr.ph ]
  %inc = add nuw nsw i32 %lnum.0907970, 1
...
while.cond441:                                    ; preds = %while.body454, %if.then440
  %indvars.iv927 = phi i32 [ %indvars.iv.next928, %while.body454 ], [ 1, %if.then440 ]
...
while.body454:                                    ; preds = %while.cond441
  ...
  %indvars.iv.next928 = add nuw i32 %indvars.iv927, 1
  br label %while.cond441, !llvm.loop !35

while.end471:                                     ; preds = %while.cond441, %while.cond441
  %cmp473.not904 = icmp eq i32 %count.0, 0
  br i1 %cmp473.not904, label %if.end529, label %for.body475

for.body475:                                      ; preds = %while.end471, %for.body475
  %i.2905 = phi i32 [ %inc477, %for.body475 ], [ 1, %while.end471 ]
  call void @PopScope() #12
  %inc477 = add nuw i32 %i.2905, 1
  %exitcond.not = icmp eq i32 %inc477, %indvars.iv927
...
if.end529:                                        ; preds = %for.body475, %while.end471, %if.then521
  ...
  %or.cond865 = select i1 %cmp530.not, i1 true, i1 %cmp533.not
  br i1 %or.cond865, label %if.else659, label %if.then535
...
if.end562:                                        ; preds = %if.then551, %if.else553
  ...
  %arrayidx566 = getelementptr inbounds [2 x %struct.LIST], ptr %64, i64 0, i64 1
  %osucc567 = getelementptr inbounds [2 x %struct.LIST], ptr %64, i64 0, i64 1, i32 1
  store ptr %64, ptr %osucc567, align 8, !tbaa !5
  store ptr %64, ptr %arrayidx566, align 8, !tbaa !5
  ...
  %or.cond866 = select i1 %cmp611, i1 true, i1 %cmp615
  br i1 %or.cond866, label %cond.end642, label %cond.false618
...
if.end667:                                        ; preds = %cond.end642, %if.then650
  ...
  br i1 %cmp401.not, label %while.end670.thread.loopexit, label %while.body403, !llvm.loop !33

while.end670.loopexit:                            ; preds = %while.body403
  %conv416.le = trunc i64 %call415 to i16
  br label %while.end670

while.end670:                                     ; preds = %while.end670.loopexit, %while.body403.lr.ph
  %leftp.0908.lcssa = phi i16 [ 0, %while.body403.lr.ph ], [ %conv416.le, %while.end670.loopexit ]
  %79 = load i8, ptr %oin_memory, align 1, !tbaa !5
  %tobool673.not = icmp eq i8 %79, 0
  br i1 %tobool673.not, label %if.else691, label %if.else679

while.end670.thread.loopexit:                     ; preds = %if.end667
  %conv416.le1002 = trunc i64 %call415 to i16
  br label %while.end670.thread

while.end670.thread:                              ; preds = %while.end670.thread.loopexit, %if.end397
  %leftp.0.lcssa = phi i16 [ 0, %if.end397 ], [ %conv416.le1002, %while.end670.thread.loopexit ]
  %80 = load i8, ptr %oin_memory, align 1, !tbaa !5
  %tobool673.not879 = icmp eq i8 %80, 0
  br i1 %tobool673.not879, label %if.else691, label %if.then677

if.then677:                                       ; preds = %while.end670.thread
...
if.else691:                                       ; preds = %while.end670.thread, %while.end670
  %leftp.0887 = phi i16 [ %leftp.0.lcssa, %while.end670.thread ], [ %leftp.0908.lcssa, %while.end670 ]
  %ou3692 = getelementptr inbounds %struct.word_type, ptr %call279, i64 0, i32 3
  store ptr %fp.1, ptr %ou3692, align 8, !tbaa !5
  store i16 %leftp.0887, ptr %ou2280, align 8, !tbaa !5
  br label %cleanup
...
entry:
  %buff.i267 = alloca [512 x i8], align 16
...
for.cond.preheader:                               ; preds = %lor.lhs.false
  %link.0.in294 = getelementptr inbounds %struct.LIST, ptr %db, i64 0, i32 1
  %link.0295 = load ptr, ptr %link.0.in294, align 8, !tbaa !5
  %cmp1.not296 = icmp eq ptr %link.0295, %db
  br i1 %cmp1.not296, label %if.then49, label %for.cond4.preheader

for.cond4.preheader:                              ; preds = %for.cond.preheader, %for.inc42
  %link.0298 = phi ptr [ %link.0, %for.inc42 ], [ %link.0295, %for.cond.preheader ]
  %count.0297 = phi i32 [ %count.1, %for.inc42 ], [ 0, %for.cond.preheader ]
  br label %for.cond4

for.cond4:                                        ; preds = %for.cond4.preheader, %for.cond4
  %link.0.pn = phi ptr [ %yy.0, %for.cond4 ], [ %link.0298, %for.cond4.preheader ]
  %yy.0.in = getelementptr inbounds [2 x %struct.LIST], ptr %link.0.pn, i64 0, i64 1
  %yy.0 = load ptr, ptr %yy.0.in, align 8, !tbaa !5
...
if.end30:                                         ; preds = %if.end23
  ...
  br i1 %cmp31, label %for.end46, label %if.end34

if.end34:                                         ; preds = %if.end30
  %onumber = getelementptr inbounds %struct.link_type, ptr %link.0298, i64 0, i32 2
  %6 = load i8, ptr %onumber, align 1, !tbaa !5
  %conv35 = zext i8 %6 to i32
  %spec.select = tail call i32 @llvm.smax.i32(i32 %count.0297, i32 %conv35)
  br label %for.inc42

for.inc42:                                        ; preds = %if.end34, %if.end23
  %count.1 = phi i32 [ %count.0297, %if.end23 ], [ %spec.select, %if.end34 ]
  %link.0.in = getelementptr inbounds %struct.LIST, ptr %link.0298, i64 0, i32 1
  %link.0 = load ptr, ptr %link.0.in, align 8, !tbaa !5
  %cmp1.not = icmp eq ptr %link.0, %db
  br i1 %cmp1.not, label %if.then49, label %for.cond4.preheader, !llvm.loop !38

for.end46:                                        ; preds = %if.end30
  %cmp47 = icmp eq ptr %link.0298, %db
  br i1 %cmp47, label %if.then49, label %for.end46.if.end157_crit_edge

for.end46.if.end157_crit_edge:                    ; preds = %for.end46
  %onumber158.phi.trans.insert = getelementptr inbounds %struct.link_type, ptr %link.0298, i64 0, i32 2
  %.pre306 = load i8, ptr %onumber158.phi.trans.insert, align 1, !tbaa !5
  br label %if.end157

if.then49:                                        ; preds = %for.inc42, %for.cond.preheader, %for.end46
  %count.0.lcssa310 = phi i32 [ %count.0297, %for.end46 ], [ 0, %for.cond.preheader ], [ %count.1, %for.inc42 ]
  %ocross_sym = getelementptr inbounds %struct.symbol_type, ptr %sym, i64 0, i32 8
  %7 = load ptr, ptr %ocross_sym, align 8, !tbaa !5
  %cmp50 = icmp eq ptr %7, null
...
if.end53:                                         ; preds = %if.then52, %if.then49
  ...
  %9 = load ptr, ptr %arrayidx60, align 8, !tbaa !8
  %cmp61 = icmp eq ptr %9, null
  br i1 %cmp61, label %if.then63, label %if.else65

if.then63:                                        ; preds = %if.end53
  %10 = load ptr, ptr @no_fpos, align 8, !tbaa !8
  %call64 = tail call ptr @GetMemory(i32 noundef %conv54, ptr noundef %10) #12
  br label %if.end74

if.else65:                                        ; preds = %if.end53
  store ptr %9, ptr @zz_hold, align 8, !tbaa !8
  %11 = load ptr, ptr %9, align 8, !tbaa !5
  store ptr %11, ptr %arrayidx60, align 8, !tbaa !8
  br label %if.end74

if.end74:                                         ; preds = %if.then63, %if.else65
  %12 = phi ptr [ %call64, %if.then63 ], [ %9, %if.else65 ]
  %ou175 = getelementptr inbounds %struct.word_type, ptr %12, i64 0, i32 1
  store i8 0, ptr %ou175, align 8, !tbaa !5
  %arrayidx78 = getelementptr inbounds [2 x %struct.LIST], ptr %12, i64 0, i64 1
  %osucc79 = getelementptr inbounds [2 x %struct.LIST], ptr %12, i64 0, i64 1, i32 1
  store ptr %12, ptr %osucc79, align 8, !tbaa !5
  store ptr %12, ptr %arrayidx78, align 8, !tbaa !5
  %osucc85 = getelementptr inbounds %struct.LIST, ptr %12, i64 0, i32 1
  store ptr %12, ptr %osucc85, align 8, !tbaa !5
...
cond.false94:                                     ; preds = %if.end74
  %13 = load ptr, ptr %db, align 8, !tbaa !5
  store ptr %13, ptr @zz_tmp, align 8, !tbaa !8
  %14 = load ptr, ptr %12, align 8, !tbaa !5
  store ptr %14, ptr %db, align 8, !tbaa !5
  %15 = load ptr, ptr @zz_hold, align 8, !tbaa !8
  %16 = load ptr, ptr @zz_res, align 8, !tbaa !8
  %17 = load ptr, ptr %16, align 8, !tbaa !5
  %osucc109 = getelementptr inbounds %struct.LIST, ptr %17, i64 0, i32 1
  store ptr %15, ptr %osucc109, align 8, !tbaa !5
  ...
  %osucc115 = getelementptr inbounds %struct.LIST, ptr %20, i64 0, i32 1
  store ptr %19, ptr %osucc115, align 8, !tbaa !5
  %.pre = load ptr, ptr @xx_link, align 8, !tbaa !8
  br label %cond.end116

cond.end116:                                      ; preds = %if.end74, %cond.false94
  %21 = phi ptr [ %12, %if.end74 ], [ %.pre, %cond.false94 ]
  store ptr %21, ptr @zz_res, align 8, !tbaa !8
  %22 = load ptr, ptr %ocross_sym, align 8, !tbaa !5
  store ptr %22, ptr @zz_hold, align 8, !tbaa !8
  %cmp119 = icmp eq ptr %22, null
  %cmp123 = icmp eq ptr %21, null
  %or.cond = select i1 %cmp119, i1 true, i1 %cmp123
  br i1 %or.cond, label %cond.end150, label %cond.false126

cond.false126:                                    ; preds = %cond.end116
  %arrayidx128 = getelementptr inbounds [2 x %struct.LIST], ptr %22, i64 0, i64 1
  %23 = load ptr, ptr %arrayidx128, align 8, !tbaa !5
  store ptr %23, ptr @zz_tmp, align 8, !tbaa !8
  %arrayidx131 = getelementptr inbounds [2 x %struct.LIST], ptr %21, i64 0, i64 1
  %24 = load ptr, ptr %arrayidx131, align 8, !tbaa !5
  store ptr %24, ptr %arrayidx128, align 8, !tbaa !5
  %25 = load ptr, ptr %arrayidx131, align 8, !tbaa !5
  %osucc141 = getelementptr inbounds [2 x %struct.LIST], ptr %25, i64 0, i64 1, i32 1
  store ptr %22, ptr %osucc141, align 8, !tbaa !5
  store ptr %23, ptr %arrayidx131, align 8, !tbaa !5
  %osucc147 = getelementptr inbounds [2 x %struct.LIST], ptr %23, i64 0, i64 1, i32 1
  store ptr %21, ptr %osucc147, align 8, !tbaa !5
  br label %cond.end150

cond.end150:                                      ; preds = %cond.end116, %cond.false126
  %26 = load ptr, ptr %db, align 8, !tbaa !5
  %27 = trunc i32 %count.0.lcssa310 to i8
  %conv155 = add i8 %27, 1
  %onumber156 = getelementptr inbounds %struct.link_type, ptr %26, i64 0, i32 2
  store i8 %conv155, ptr %onumber156, align 1, !tbaa !5
  %odb_targ = getelementptr inbounds %struct.link_type, ptr %26, i64 0, i32 3
  store i8 0, ptr %odb_targ, align 2, !tbaa !5
  br label %if.end157

if.end157:                                        ; preds = %for.end46.if.end157_crit_edge, %cond.end150
  %28 = phi i8 [ %conv155, %cond.end150 ], [ %.pre306, %for.end46.if.end157_crit_edge ]
  ...
  %oin_memory = getelementptr inbounds i8, ptr %db, i64 43
  %29 = load i8, ptr %oin_memory, align 1, !tbaa !5
  %tobool164.not = icmp eq i8 %29, 0
  %30 = load ptr, ptr %ou3, align 8, !tbaa !5
  br i1 %tobool164.not, label %if.else181, label %if.then165

if.then165:                                       ; preds = %if.end157
  %31 = load i16, ptr %ou2, align 8, !tbaa !5
  call void @llvm.lifetime.start.p0(i64 512, ptr nonnull %buff.i) #12
  switch i16 %31, label %while.body.lr.ph.i [
    i16 0, label %SearchLines.exit.thread
    i16 1, label %SearchLines.exit
  ]

SearchLines.exit.thread:                          ; preds = %if.then165
  call void @llvm.lifetime.end.p0(i64 512, ptr nonnull %buff.i) #12
  br label %cleanup

while.body.lr.ph.i:                               ; preds = %if.then165
  %conv168 = zext i16 %31 to i32
  %sub.i = add nsw i32 %conv168, -2
  %32 = load i32, ptr @UseCollate, align 4, !tbaa !18
  %33 = icmp eq i32 %32, 0
  br i1 %33, label %while.body.us.i, label %while.body.i
...
while.body.us.i:                                  ; preds = %while.body.lr.ph.i, %while.body.us.i
  ...
  %arrayidx4.us.i = getelementptr inbounds ptr, ptr %30, i64 %idxprom3.us.i
  %34 = load ptr, ptr %arrayidx4.us.i, align 8, !tbaa !8
  %call5.us.i = call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %buff, ptr noundef nonnull dereferenceable(1) %34) #14
  ...
  br i1 %cmp1.not.us.i, label %SearchLines.exit, label %while.body.us.i, !llvm.loop !39

while.body.i:                                     ; preds = %while.body.lr.ph.i, %if.end10.i
  %35 = phi i32 [ %39, %if.end10.i ], [ 1, %while.body.lr.ph.i ]
  ...
  %arrayidx4.i = getelementptr inbounds ptr, ptr %30, i64 %idxprom3.i
  %36 = load ptr, ptr %arrayidx4.i, align 8, !tbaa !8
  br i1 %tobool.not.i, label %cond.false.i, label %cond.true.i

cond.true.i:                                      ; preds = %while.body.i
  %call.i = call i32 @strcollcmp(ptr noundef nonnull %buff, ptr noundef %36) #12
...
cond.false.i:                                     ; preds = %while.body.i
  %call5.i = call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %buff, ptr noundef nonnull dereferenceable(1) %36) #14
...
if.else.i:                                        ; preds = %cond.false.i, %cond.true.i
  %38 = phi i32 [ 0, %cond.false.i ], [ %.pre.i, %cond.true.i ]
  %add9.i = add nsw i32 %div.i, 1
  br label %if.end10.i

if.end10.i:                                       ; preds = %if.else.i, %if.then7.i
  %39 = phi i32 [ %37, %if.then7.i ], [ %38, %if.else.i ]
  ...
  br i1 %cmp1.not.i, label %SearchLines.exit, label %while.body.i, !llvm.loop !40

SearchLines.exit:                                 ; preds = %if.end10.i, %while.body.us.i, %if.then165
  %l.0.lcssa.i = phi i32 [ 0, %if.then165 ], [ %l.1.us.i, %while.body.us.i ], [ %l.1.i, %if.end10.i ]
  %idxprom11.i = sext i32 %l.0.lcssa.i to i64
  %arrayidx12.i = getelementptr inbounds ptr, ptr %30, i64 %idxprom11.i
  %40 = load ptr, ptr %arrayidx12.i, align 8, !tbaa !8
  %call13.i = call i32 (ptr, ptr, ...) @__isoc99_sscanf(ptr noundef %40, ptr noundef nonnull @.str.58, ptr noundef nonnull %buff.i) #12
  ...
  call void @llvm.lifetime.end.p0(i64 512, ptr nonnull %buff.i) #12
  br i1 %cmp16.i.not, label %if.end173, label %cleanup

if.end173:                                        ; preds = %SearchLines.exit
  %41 = load ptr, ptr %ou3, align 8, !tbaa !5
  %arrayidx176 = getelementptr inbounds ptr, ptr %41, i64 %idxprom11.i
  %42 = load ptr, ptr %arrayidx176, align 8, !tbaa !8
  %call178 = call i32 (ptr, ptr, ...) @__isoc99_sscanf(ptr noundef %42, ptr noundef nonnull @.str.50, ptr noundef %seq, ptr noundef %dfpos, ptr noundef %dlnum, ptr noundef nonnull %buff) #12
  %add179 = add nsw i32 %l.0.lcssa.i, 1
  %conv180 = sext i32 %add179 to i64
  br label %if.end203

if.else181:                                       ; preds = %if.end157
  %call183 = tail call i32 @fseek(ptr noundef %30, i64 noundef 0, i32 noundef 2)
  %43 = load ptr, ptr %ou3, align 8, !tbaa !5
  %44 = load i16, ptr %ou2, align 8, !tbaa !5
  %conv187 = zext i16 %44 to i32
  %call189 = tail call i64 @ftell(ptr noundef %43)
  %conv190 = trunc i64 %call189 to i32
  %sub191 = add nsw i32 %conv190, -1
  call void @llvm.lifetime.start.p0(i64 512, ptr nonnull %buff.i267) #12
  %cmp.not79.i.not = icmp sgt i32 %conv190, %conv187
  br i1 %cmp.not79.i.not, label %while.body.i271, label %while.end.i281

while.body.i271:                                  ; preds = %if.else181, %if.end36.i
  %l.081.i = phi i32 [ %l.1.i279, %if.end36.i ], [ %conv187, %if.else181 ]
  %r.080.i = phi i32 [ %r.1.i278, %if.end36.i ], [ %sub191, %if.else181 ]
  %add.i268 = add nsw i32 %r.080.i, %l.081.i
  %div.i269 = sdiv i32 %add.i268, 2
  %conv.i = sext i32 %div.i269 to i64
  %call.i270 = call i32 @fseek(ptr noundef %43, i64 noundef %conv.i, i32 noundef 0)
  br label %do.body.i

do.body.i:                                        ; preds = %do.body.i, %while.body.i271
  %mid.0.i = phi i32 [ %div.i269, %while.body.i271 ], [ %inc.i, %do.body.i ]
  %inc.i = add nsw i32 %mid.0.i, 1
  %call1.i = call i32 @getc(ptr noundef %43)
...
do.end.i:                                         ; preds = %do.body.i
  ...
  br i1 %cmp5.i, label %if.then.i, label %if.end.i273

if.then.i:                                        ; preds = %do.end.i
  %conv7.i = sext i32 %l.081.i to i64
  %call8.i = call i32 @fseek(ptr noundef %43, i64 noundef %conv7.i, i32 noundef 0)
  br label %if.end.i273

if.end.i273:                                      ; preds = %if.then.i, %do.end.i
  %mid.1.i = phi i32 [ %l.081.i, %if.then.i ], [ %inc.i, %do.end.i ]
  %call9.i = call ptr @fgets(ptr noundef nonnull %line, i32 noundef 512, ptr noundef %43)
  %call10.i = call i64 @ftell(ptr noundef %43)
  %conv11.i = trunc i64 %call10.i to i32
  %sub.i272 = add nsw i32 %conv11.i, -1
  %cmp12.not.i = icmp sgt i32 %l.081.i, %mid.1.i
  br i1 %cmp12.not.i, label %if.then14.i, label %if.end16.i

if.then14.i:                                      ; preds = %if.end.i273
  %45 = load ptr, ptr @no_fpos, align 8, !tbaa !8
  %call15.i274 = call ptr (i32, i32, ptr, i32, ptr, ...) @Error(i32 noundef 1, i32 noundef 2, ptr noundef nonnull @.str, i32 noundef 0, ptr noundef %45, ptr noundef nonnull @.str.59) #12
  br label %if.end16.i

if.end16.i:                                       ; preds = %if.then14.i, %if.end.i273
  %cmp17.i = icmp slt i32 %mid.1.i, %sub.i272
  br i1 %cmp17.i, label %if.end21.i, label %if.then19.i

if.then19.i:                                      ; preds = %if.end16.i
  %46 = load ptr, ptr @no_fpos, align 8, !tbaa !8
  %call20.i = call ptr (i32, i32, ptr, i32, ptr, ...) @Error(i32 noundef 1, i32 noundef 2, ptr noundef nonnull @.str, i32 noundef 0, ptr noundef %46, ptr noundef nonnull @.str.60) #12
  br label %if.end21.i

if.end21.i:                                       ; preds = %if.then19.i, %if.end16.i
  %cmp22.not.i = icmp sgt i32 %sub.i272, %r.080.i
  br i1 %cmp22.not.i, label %if.then24.i, label %if.end26.i

if.then24.i:                                      ; preds = %if.end21.i
  %47 = load ptr, ptr @no_fpos, align 8, !tbaa !8
  %call25.i = call ptr (i32, i32, ptr, i32, ptr, ...) @Error(i32 noundef 1, i32 noundef 2, ptr noundef nonnull @.str, i32 noundef 0, ptr noundef %47, ptr noundef nonnull @.str.61) #12
  br label %if.end26.i

if.end26.i:                                       ; preds = %if.then24.i, %if.end21.i
  %48 = load i32, ptr @UseCollate, align 4, !tbaa !18
  %tobool.not.i275 = icmp eq i32 %48, 0
  br i1 %tobool.not.i275, label %cond.false.i277, label %cond.true.i276

cond.true.i276:                                   ; preds = %if.end26.i
...
cond.false.i277:                                  ; preds = %if.end26.i
...
if.then33.i:                                      ; preds = %cond.false.i277, %cond.true.i276
  %sub34.i = add nsw i32 %mid.1.i, -1
  br label %if.end36.i

if.end36.i:                                       ; preds = %if.then33.i, %cond.false.i277, %cond.true.i276
  %r.1.i278 = phi i32 [ %sub34.i, %if.then33.i ], [ %r.080.i, %cond.false.i277 ], [ %r.080.i, %cond.true.i276 ]
  %l.1.i279 = phi i32 [ %l.081.i, %if.then33.i ], [ %conv11.i, %cond.false.i277 ], [ %conv11.i, %cond.true.i276 ]
  %cmp.not.i = icmp sgt i32 %l.1.i279, %r.1.i278
  br i1 %cmp.not.i, label %while.end.i281, label %while.body.i271, !llvm.loop !43

while.end.i281:                                   ; preds = %if.end36.i, %if.else181
  %l.0.lcssa.i280 = phi i32 [ %conv187, %if.else181 ], [ %l.1.i279, %if.end36.i ]
  %cmp37.i = icmp slt i32 %l.0.lcssa.i280, %sub191
  br i1 %cmp37.i, label %if.then39.i, label %if.then196.critedge

if.then39.i:                                      ; preds = %while.end.i281
  %conv40.i = sext i32 %l.0.lcssa.i280 to i64
  %call41.i = call i32 @fseek(ptr noundef %43, i64 noundef %conv40.i, i32 noundef 0)
  %call42.i = call ptr @fgets(ptr noundef nonnull %line, i32 noundef 512, ptr noundef %43)
  %call43.i = call i32 (ptr, ptr, ...) @__isoc99_sscanf(ptr noundef nonnull %line, ptr noundef nonnull @.str.58, ptr noundef nonnull %buff.i267) #12
  %call45.i = call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %buff, ptr noundef nonnull dereferenceable(1) %buff.i267) #14
  %cmp46.i.not = icmp eq i32 %call45.i, 0
  call void @llvm.lifetime.end.p0(i64 512, ptr nonnull %buff.i267) #12
  br i1 %cmp46.i.not, label %if.end197, label %cleanup

if.then196.critedge:                              ; preds = %while.end.i281
  call void @llvm.lifetime.end.p0(i64 512, ptr nonnull %buff.i267) #12
  br label %cleanup

if.end197:                                        ; preds = %if.then39.i
  ...
  %49 = load ptr, ptr %ou3, align 8, !tbaa !5
  %call202 = call i64 @ftell(ptr noundef %49)
  br label %if.end203
...
cleanup:                                          ; preds = %SearchLines.exit.thread, %if.end212, %if.then218, %if.then39.i, %if.then196.critedge, %SearchLines.exit, %entry, %lor.lhs.false
  %retval.0 = phi i32 [ 0, %lor.lhs.false ], [ 0, %entry ], [ 0, %SearchLines.exit ], [ 0, %if.then196.critedge ], [ 0, %if.then39.i ], [ 1, %if.then218 ], [ 1, %if.end212 ], [ 0, %SearchLines.exit.thread ]
  call void @llvm.lifetime.end.p0(i64 512, ptr nonnull %buff) #12
  call void @llvm.lifetime.end.p0(i64 512, ptr nonnull %line) #12
  ret i32 %retval.0
}
