...
entry:
  ...
  %hptr.0972 = load ptr, ptr @Hlist, align 8, !tbaa !9
  %cmp.not973 = icmp eq ptr %hptr.0972, null
  br i1 %cmp.not973, label %for.end596, label %for.body

for.body:                                         ; preds = %entry, %for.inc594
  %hptr.0977 = phi ptr [ %hptr.0, %for.inc594 ], [ %hptr.0972, %entry ]
  %ht1.0975 = phi i32 [ %ht1.8, %for.inc594 ], [ undef, %entry ]
  %ht2.0974 = phi i32 [ %ht2.9, %for.inc594 ], [ undef, %entry ]
  %0 = load i32, ptr %hptr.0977, align 8, !tbaa !11
...
if.end:                                           ; preds = %for.body
  ...
  %vlptr.0959 = load ptr, ptr %arrayidx10, align 8, !tbaa !9
  %cmp12.not960 = icmp eq ptr %vlptr.0959, null
  br i1 %cmp12.not960, label %for.inc594, label %for.body13

for.body13:                                       ; preds = %if.end, %for.inc591
  %vlptr.0965 = phi ptr [ %vlptr.0, %for.inc591 ], [ %vlptr.0959, %if.end ]
  %ht1.1963 = phi i32 [ %ht1.7, %for.inc591 ], [ %ht1.0975, %if.end ]
  %ht2.1962 = phi i32 [ %ht2.8, %for.inc591 ], [ %ht2.0974, %if.end ]
  %vrloc.0961 = phi i32 [ %vrloc.3, %for.inc591 ], [ -100000, %if.end ]
  %8 = load i32, ptr %vlptr.0965, align 8, !tbaa !11
...
if.end26:                                         ; preds = %if.end20
  %cmp27 = icmp slt i32 %11, %vrloc.0961
...
for.body70:                                       ; preds = %for.body70.lr.ph, %for.inc588
  ...
  %vrloc.1938 = phi i32 [ %vrloc.0961, %for.body70.lr.ph ], [ %vrloc.2, %for.inc588 ]
...
for.body128:                                      ; preds = %for.body128.lr.ph, %for.inc
  ...
  %ht1.2943 = phi i32 [ %ht1.1963, %for.body128.lr.ph ], [ %ht1.5, %for.inc ]
  %ht2.2942 = phi i32 [ %ht2.1962, %for.body128.lr.ph ], [ %ht2.6, %for.inc ]
...
if.end462:                                        ; preds = %land.lhs.true456, %if.else450, %if.then444
  %loc466 = getelementptr inbounds %struct.edgebox, ptr %62, i64 %idxprom425, i32 3
...
if.then474:                                       ; preds = %if.end470
  ...
  %v2ptr.0956 = load ptr, ptr %arrayidx480, align 8, !tbaa !9
  %cmp482.not957 = icmp eq ptr %v2ptr.0956, null
  br i1 %cmp482.not957, label %if.end531, label %for.body483.lr.ph
...
for.body483:                                      ; preds = %for.body483.lr.ph, %for.inc528
  %v2ptr.0958 = phi ptr [ %v2ptr.0956, %for.body483.lr.ph ], [ %v2ptr.0, %for.inc528 ]
  %78 = load i32, ptr %v2ptr.0958, align 8, !tbaa !11
...
if.end523:                                        ; preds = %land.lhs.true517, %if.else511, %if.then505
  %loc527 = getelementptr inbounds %struct.edgebox, ptr %77, i64 %idxprom485, i32 3
  %83 = load i32, ptr %loc527, align 4, !tbaa !17
  br label %if.end531

for.inc528:                                       ; preds = %if.then505, %land.lhs.true517, %if.end490, %for.body483
  %next529 = getelementptr inbounds %struct.dlink1, ptr %v2ptr.0958, i64 0, i32 2
...
if.end535.thread:                                 ; preds = %for.end.i
  ...
  %.pre983 = load ptr, ptr @rectArray, align 8, !tbaa !9
  br label %if.end539
...
if.then537:                                       ; preds = %if.end535
  ...
  %.pre984 = load i32, ptr @numRects, align 4, !tbaa !5
  br label %if.end539

if.end539:                                        ; preds = %if.end535.thread, %if.then537, %if.end535
  %94 = phi i32 [ 1, %if.end535.thread ], [ %.pre984, %if.then537 ], [ %inc, %if.end535 ]
  %95 = phi ptr [ %.pre983, %if.end535.thread ], [ %call538, %if.then537 ], [ %93, %if.end535 ]
...
for.inc591:                                       ; preds = %for.inc588, %for.inc, %if.end122, %if.end64, %if.else, %if.then43, %backCheck.exit, %if.then581, %if.end539, %land.lhs.true, %if.end29, %if.end26, %for.body13
  %vrloc.3 = phi i32 [ %vrloc.0961, %for.body13 ], [ %vrloc.0961, %if.end26 ], [ %vrloc.0961, %if.end29 ], [ %.lcssa, %backCheck.exit ], [ %.lcssa, %if.then581 ], [ %.lcssa, %if.end539 ], [ %vrloc.0961, %land.lhs.true ], [ %vrloc.0961, %if.then43 ], [ %vrloc.0961, %if.else ], [ %vrloc.0961, %if.end64 ], [ %.lcssa, %if.end122 ], [ %.lcssa, %for.inc ], [ %vrloc.2, %for.inc588 ]
  %ht2.8 = phi i32 [ %ht2.1962, %for.body13 ], [ %ht2.1962, %if.end26 ], [ %ht2.1962, %if.end29 ], [ %ht2.7919.ph, %backCheck.exit ], [ %ht2.7919.ph, %if.then581 ], [ %ht2.7919.ph, %if.end539 ], [ %ht2.1962, %land.lhs.true ], [ %ht2.1962, %if.then43 ], [ %ht2.1962, %if.else ], [ %ht2.1962, %if.end64 ], [ %ht2.1962, %if.end122 ], [ %ht2.6, %for.inc ], [ %ht2.1962, %for.inc588 ]
  %ht1.7 = phi i32 [ %ht1.1963, %for.body13 ], [ %ht1.1963, %if.end26 ], [ %ht1.1963, %if.end29 ], [ %ht1.6920.ph, %backCheck.exit ], [ %ht1.6920.ph, %if.then581 ], [ %ht1.6920.ph, %if.end539 ], [ %ht1.1963, %land.lhs.true ], [ %ht1.1963, %if.then43 ], [ %ht1.1963, %if.else ], [ %ht1.1963, %if.end64 ], [ %ht1.1963, %if.end122 ], [ %ht1.5, %for.inc ], [ %ht1.1963, %for.inc588 ]
  %next592 = getelementptr inbounds %struct.dlink1, ptr %vlptr.0965, i64 0, i32 2
...
for.inc594:                                       ; preds = %if.end20, %for.inc591, %if.end, %for.body
  %ht2.9 = phi i32 [ %ht2.0974, %for.body ], [ %ht2.0974, %if.end ], [ %ht2.1962, %if.end20 ], [ %ht2.8, %for.inc591 ]
  %ht1.8 = phi i32 [ %ht1.0975, %for.body ], [ %ht1.0975, %if.end ], [ %ht1.1963, %if.end20 ], [ %ht1.7, %for.inc591 ]
  %next595 = getelementptr inbounds %struct.dlink1, ptr %hptr.0977, i64 0, i32 2
