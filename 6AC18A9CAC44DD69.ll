...
define dso_local i32 @sub3(ptr nocapture noundef readnone %0) local_unnamed_addr #0 {
  ret i32 undef
}

; Function Attrs: nounwind uwtable
define dso_local i32 @eq(i32 noundef %0, i32 noundef %1) local_unnamed_addr #1 {
  %3 = load i32, ptr @eq.i, align 4, !tbaa !5
  %4 = icmp eq i32 %3, %0
...
6:                                                ; preds = %2
  %7 = add nsw i32 %0, 1
  store i32 %7, ptr @eq.i, align 4, !tbaa !5
  ret i32 undef
}
