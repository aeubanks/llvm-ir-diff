...
if.then.us:                                       ; preds = %for.body.us
  ...
  br i1 %cmp.i46.not6.us, label %for.inc30.us, label %for.body15.us.us.preheader

for.body15.us.us.preheader:                       ; preds = %if.then.us
  %.pre17 = load i32, ptr @fol_NOT, align 4
  br label %for.body15.us.us

for.inc30.us:                                     ; preds = %for.inc.us.us, %if.then.us, %for.body.us
  %Result.3.us = phi ptr [ %Result.011.us, %for.body.us ], [ %Result.011.us, %if.then.us ], [ %Result.2.us.us, %for.inc.us.us ]
...
for.body15.us.us:                                 ; preds = %for.body15.us.us.preheader, %for.inc.us.us
  %9 = phi i32 [ %16, %for.inc.us.us ], [ %.pre17, %for.body15.us.us.preheader ]
  %Result.18.us.us = phi ptr [ %Result.2.us.us, %for.inc.us.us ], [ %Result.011.us, %for.body15.us.us.preheader ]
  %LitScan.07.us.us = phi ptr [ %LitScan.0.val45.us.us, %for.inc.us.us ], [ %call10.us, %for.body15.us.us.preheader ]
  %10 = getelementptr i8, ptr %LitScan.07.us.us, i64 8
  ...
  %cmp.i.i48.us.us = icmp eq i32 %9, %Lit.val.val.us.us
  ...
  br i1 %cmp.i.i48.us.us, label %land.lhs.true.i.us.us, label %lor.rhs.i.us.us
...
lor.rhs.i.us.us:                                  ; preds = %land.lhs.true.i.us.us, %for.body15.us.us
  ...
  %cmp.i11.i.us.us = icmp eq i32 %9, %L2.val.val.i.us.us
  br i1 %cmp.i11.i.us.us, label %clause_LiteralsAreComplementary.exit.us.us, label %for.inc.us.us

clause_LiteralsAreComplementary.exit.us.us:       ; preds = %lor.rhs.i.us.us
  %cmp.i.i13.i.us.us = icmp ne i32 %9, %Lit.val.val.us.us
  %cmp.us.us = icmp eq i32 %add3.i.us.us, 1
  %or.cond15 = select i1 %cmp.i.i13.i.us.us, i1 %cmp.us.us, i1 false
  br i1 %or.cond15, label %if.then26.us.us, label %for.inc.us.us
...
if.then26.us.us:                                  ; preds = %clause_LiteralsAreComplementary.exit.us.us, %land.lhs.true.us.us
  ...
  store ptr %Result.18.us.us, ptr %call.i.us.us, align 8
  %.pre = load i32, ptr @fol_NOT, align 4
  br label %for.inc.us.us

for.inc.us.us:                                    ; preds = %land.lhs.true.us.us, %if.then26.us.us, %clause_LiteralsAreComplementary.exit.us.us, %lor.rhs.i.us.us
  %16 = phi i32 [ %.pre, %if.then26.us.us ], [ %9, %clause_LiteralsAreComplementary.exit.us.us ], [ %9, %lor.rhs.i.us.us ], [ %9, %land.lhs.true.us.us ]
  %Result.2.us.us = phi ptr [ %call.i.us.us, %if.then26.us.us ], [ %Result.18.us.us, %clause_LiteralsAreComplementary.exit.us.us ], [ %Result.18.us.us, %lor.rhs.i.us.us ], [ %Result.18.us.us, %land.lhs.true.us.us ]
  %LitScan.0.val45.us.us = load ptr, ptr %LitScan.07.us.us, align 8
...
if.then:                                          ; preds = %for.body
  ...
  br i1 %cmp.i46.not6, label %for.inc30, label %for.body15.preheader

for.body15.preheader:                             ; preds = %if.then
  %.pre19 = load i32, ptr @fol_NOT, align 4
  br label %for.body15

for.body15:                                       ; preds = %for.body15.preheader, %for.inc
  %18 = phi i32 [ %25, %for.inc ], [ %.pre19, %for.body15.preheader ]
  %Result.18 = phi ptr [ %Result.2, %for.inc ], [ %Result.011, %for.body15.preheader ]
  %LitScan.07 = phi ptr [ %LitScan.0.val45, %for.inc ], [ %call10, %for.body15.preheader ]
  %19 = getelementptr i8, ptr %LitScan.07, i64 8
  ...
  %cmp.i.i48 = icmp eq i32 %18, %Lit.val.val
  ...
  br i1 %cmp.i.i48, label %land.lhs.true.i, label %lor.rhs.i
...
lor.rhs.i:                                        ; preds = %land.lhs.true.i, %for.body15
  ...
  %cmp.i11.i = icmp eq i32 %18, %L2.val.val.i
  br i1 %cmp.i11.i, label %clause_LiteralsAreComplementary.exit, label %for.inc

clause_LiteralsAreComplementary.exit:             ; preds = %lor.rhs.i
  %cmp.i.i13.i = icmp ne i32 %18, %Lit.val.val
  %cmp25 = icmp ne i32 %add3.i, 1
  %or.cond = select i1 %cmp.i.i13.i, i1 %cmp25, i1 false
...
if.then26:                                        ; preds = %clause_LiteralsAreComplementary.exit, %land.lhs.true
  %call.i = tail call ptr @memory_Malloc(i32 noundef 16) #11
  %car.i = getelementptr inbounds %struct.LIST_HELP, ptr %call.i, i64 0, i32 1
  store ptr %LitScan.0.val, ptr %car.i, align 8
  store ptr %Result.18, ptr %call.i, align 8
  %.pre18 = load i32, ptr @fol_NOT, align 4
  br label %for.inc

for.inc:                                          ; preds = %lor.rhs.i, %clause_LiteralsAreComplementary.exit, %land.lhs.true, %if.then26
  %25 = phi i32 [ %.pre18, %if.then26 ], [ %18, %land.lhs.true ], [ %18, %clause_LiteralsAreComplementary.exit ], [ %18, %lor.rhs.i ]
  %Result.2 = phi ptr [ %call.i, %if.then26 ], [ %Result.18, %land.lhs.true ], [ %Result.18, %clause_LiteralsAreComplementary.exit ], [ %Result.18, %lor.rhs.i ]
  %LitScan.0.val45 = load ptr, ptr %LitScan.07, align 8
...
for.inc30:                                        ; preds = %for.inc, %if.then, %for.body
  %Result.3 = phi ptr [ %Result.011, %for.body ], [ %Result.011, %if.then ], [ %Result.2, %for.inc ]
...
list_Delete.exit.i:                               ; preds = %while.body.i.i
  ...
  %cmp.i.not122.i = icmp eq ptr %FoundMap, null
  br i1 %cmp.i.not122.i, label %for.end.i, label %for.body.lr.ph.i
...
for.body.i:                                       ; preds = %clause_LiteralGetIndex.exit97.i, %for.body.lr.ph.i
  %depth.0125.i = phi i32 [ %Clause.val72.i, %for.body.lr.ph.i ], [ %call27.i, %clause_LiteralGetIndex.exit97.i ]
  %Parents.0124.i = phi ptr [ %call.i.i76.i, %for.body.lr.ph.i ], [ %call.i.i, %clause_LiteralGetIndex.exit97.i ]
  %FoundMap.addr.0123.i = phi ptr [ %FoundMap, %for.body.lr.ph.i ], [ %FoundMap.addr.0.val71.i, %clause_LiteralGetIndex.exit97.i ]
  %14 = getelementptr i8, ptr %FoundMap.addr.0123.i, i64 8
  ...
  store ptr %Parents.0124.i, ptr %call.i.i, align 8
  %16 = getelementptr i8, ptr %call23.val.i, i64 8
  %call24.val.i = load i32, ptr %16, align 8
  %call27.i = tail call i32 @misc_Max(i32 noundef %depth.0125.i, i32 noundef %call24.val.i) #11
...
clause_LiteralGetIndex.exit97.i:                  ; preds = %while.cond.i96.i
  %sext121.i = shl i64 %indvars.iv.i92.i, 32
  %conv.i98.i = ashr exact i64 %sext121.i, 32
  ...
  %FoundMap.addr.0.val71.i = load ptr, ptr %FoundMap.addr.0123.i, align 8
...
while.body.i102.i:                                ; preds = %if.end.i.i, %for.end.i
  %Result.val100108.i.i = phi i32 [ %.promoted.i.i, %for.end.i ], [ %call1.val101.Result.val100.i.i, %if.end.i.i ]
...
if.end.i.i:                                       ; preds = %if.then.i.i, %while.body.i102.i
  ...
  %call1.val101.Result.val100.i.i = tail call i32 @llvm.umax.i32(i32 %call1.val101.i.i, i32 %Result.val100108.i.i)
  store i32 %call1.val101.Result.val100.i.i, ptr %32, align 4
...
if.then18.i.i:                                    ; preds = %if.then16.i.i
  ...
  %cmp.i.i.i104.i = icmp ult i32 %mul.i.i, 1024
  br i1 %cmp.i.i.i104.i, label %if.else25.i.i.i, label %if.then.i.i105.i

if.then.i.i105.i:                                 ; preds = %if.then18.i.i
...
if.then9.i.i.i:                                   ; preds = %if.then.i.i105.i
  %45 = load ptr, ptr %add.ptr1.i.i.i, align 8
  store ptr %45, ptr %44, align 8
  br label %if.end13.i.i.i

if.end13.i.i.i:                                   ; preds = %if.then9.i.i.i, %if.then.i.i105.i
  %46 = load i32, ptr @memory_MARKSIZE, align 4
  %add.i.i106.i = add i32 %46, %RealSize.1.i.i.i.i.i
  %conv.i102.i.i = zext i32 %add.i.i106.i to i64
...
if.else25.i.i.i:                                  ; preds = %if.then18.i.i
  %idxprom.i.i107.i = zext i32 %mul.i.i to i64
  %arrayidx.i.i108.i = getelementptr inbounds [0 x ptr], ptr @memory_ARRAY, i64 0, i64 %idxprom.i.i107.i
  %49 = load ptr, ptr %arrayidx.i.i108.i, align 8
  ...
  %53 = load ptr, ptr %arrayidx.i.i108.i, align 8
...
for.body.i.i:                                     ; preds = %for.body.i.i, %for.body.lr.ph.i.i
  %indvars.iv.i109.i = phi i64 [ 0, %for.body.lr.ph.i.i ], [ %indvars.iv.next.i110.i, %for.body.i.i ]
  %54 = load ptr, ptr %splitfield33.i.i, align 8
  %arrayidx.i.i = getelementptr inbounds i64, ptr %54, i64 %indvars.iv.i109.i
  ...
  %cmp31.i.i = icmp ult i64 %indvars.iv.next.i110.i, %56
...
while.cond34.loopexit.i.i:                        ; preds = %for.body45.i.i, %while.body38.i.i
  ...
  br i1 %cmp.i103.not.i.i, label %while.body.i118.i, label %while.body38.i.i, !llvm.loop !18
...
while.body.i118.i:                                ; preds = %while.cond34.loopexit.i.i, %while.body.i118.i
  %Current.06.i112.i = phi ptr [ %L.addr.0.val.i113.i, %while.body.i118.i ], [ %Parents.0.lcssa.i, %while.cond34.loopexit.i.i ]
  %L.addr.0.val.i113.i = load ptr, ptr %Current.06.i112.i, align 8
  ...
  %cmp.i.not.i117.i = icmp eq ptr %L.addr.0.val.i113.i, null
  br i1 %cmp.i.not.i117.i, label %inf_CreateURUnitResolvent.exit, label %while.body.i118.i, !llvm.loop !11

inf_CreateURUnitResolvent.exit:                   ; preds = %while.body.i118.i
