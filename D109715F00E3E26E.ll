...
define dso_local i64 @bad(i32 noundef %reg, i64 noundef %inWord) local_unnamed_addr #0 {
entry:
  %data = alloca %union.anon, align 8
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %data) #4
  store i64 %inWord, ptr %data, align 8, !tbaa !5
  %idxprom = sext i32 %reg to i64
  %arrayidx = getelementptr inbounds [4 x i8], ptr %data, i64 0, i64 %idxprom
