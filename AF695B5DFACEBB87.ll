; ModuleID = '/usr/local/google/home/aeubanks/repos/test-suite/SingleSource/Regression/C/gcc-c-torture/execute/pr65215-1.c'
source_filename = "/usr/local/google/home/aeubanks/repos/test-suite/SingleSource/Regression/C/gcc-c-torture/execute/pr65215-1.c"
...
define dso_local i32 @bar(ptr nocapture noundef readonly %x) local_unnamed_addr #0 {
entry:
  %0 = load i64, ptr %x, align 8, !tbaa !5
  %conv = trunc i64 %0 to i32
  %or5.i = tail call i32 @llvm.bswap.i32(i32 %conv)
  ret i32 %or5.i
}
...
entry:
  ...
  store i64 -77195985809396258, ptr %l, align 8, !tbaa !5
  %call1 = call i32 @bar(ptr noundef nonnull %l)
  %cmp.not = icmp eq i32 %call1, -559038737
