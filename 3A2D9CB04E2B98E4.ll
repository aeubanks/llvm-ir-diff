...
complex_mul_cont20.split.split.us:                ; preds = %complex_mul_cont20.split
  br i1 %isnan_cmp72, label %complex_mul_cont20.split.split.us.split, label %for.body.us240.us.preheader, !prof !11

for.body.us240.us.preheader:                      ; preds = %complex_mul_cont20.split.split.us
  %call48.us246.us = tail call { double, double } @cexp(double noundef %mul_r, double noundef %mul_i) #8
  %33 = extractvalue { double, double } %call48.us246.us, 0
  %34 = extractvalue { double, double } %call48.us246.us, 1
  %mul.ir50.us248.us = fneg double %34
  %sub.r51.us249.us = fsub double -1.000000e+00, %33
  %call74.us253.us = tail call { double, double } @__muldc3(double noundef %12, double noundef %13, double noundef %Z.coerce0, double noundef %Z.coerce1) #8
  %35 = extractvalue { double, double } %call74.us253.us, 0
  %36 = extractvalue { double, double } %call74.us253.us, 1
  %sub.r78.us257.us = fsub double 0x4023BD3CBC48F10B, %35
  %sub.i79.us258.us = fneg double %36
  %call86.us260.us = tail call { double, double } @__divdc3(double noundef %sub.r51.us249.us, double noundef %mul.ir50.us248.us, double noundef %sub.r78.us257.us, double noundef %sub.i79.us258.us) #8
  %37 = extractvalue { double, double } %call86.us260.us, 0
  %38 = extractvalue { double, double } %call86.us260.us, 1
  %call48.us246.us.1 = tail call { double, double } @cexp(double noundef %mul_r, double noundef %mul_i) #8
  %39 = extractvalue { double, double } %call48.us246.us.1, 0
  %40 = extractvalue { double, double } %call48.us246.us.1, 1
  %sub.r51.us249.us.1 = fadd double %39, -1.000000e+00
  %call74.us253.us.1 = tail call { double, double } @__muldc3(double noundef %12, double noundef %13, double noundef %Z.coerce0, double noundef %Z.coerce1) #8
  %41 = extractvalue { double, double } %call74.us253.us.1, 0
  %42 = extractvalue { double, double } %call74.us253.us.1, 1
  %sub.r78.us257.us.1 = fsub double 0x4043BD3CDDD6E04C, %41
  %sub.i79.us258.us.1 = fneg double %42
  %call86.us260.us.1 = tail call { double, double } @__divdc3(double noundef %sub.r51.us249.us.1, double noundef %40, double noundef %sub.r78.us257.us.1, double noundef %sub.i79.us258.us.1) #8
  %43 = extractvalue { double, double } %call86.us260.us.1, 0
  %44 = extractvalue { double, double } %call86.us260.us.1, 1
  %call48.us246.us.2 = tail call { double, double } @cexp(double noundef %mul_r, double noundef %mul_i) #8
  %45 = extractvalue { double, double } %call48.us246.us.2, 0
  %46 = extractvalue { double, double } %call48.us246.us.2, 1
  %mul.ir50.us248.us.2 = fneg double %46
  %sub.r51.us249.us.2 = fsub double -1.000000e+00, %45
  %call74.us253.us.2 = tail call { double, double } @__muldc3(double noundef %12, double noundef %13, double noundef %Z.coerce0, double noundef %Z.coerce1) #8
  %47 = extractvalue { double, double } %call74.us253.us.2, 0
  %48 = extractvalue { double, double } %call74.us253.us.2, 1
  %sub.r78.us257.us.2 = fsub double 0x405634E4649906CD, %47
  %sub.i79.us258.us.2 = fneg double %48
  %call86.us260.us.2 = tail call { double, double } @__divdc3(double noundef %sub.r51.us249.us.2, double noundef %mul.ir50.us248.us.2, double noundef %sub.r78.us257.us.2, double noundef %sub.i79.us258.us.2) #8
  %49 = extractvalue { double, double } %call86.us260.us.2, 0
  %50 = extractvalue { double, double } %call86.us260.us.2, 1
  %call48.us246.us.3 = tail call { double, double } @cexp(double noundef %mul_r, double noundef %mul_i) #8
  %51 = extractvalue { double, double } %call48.us246.us.3, 0
  %52 = extractvalue { double, double } %call48.us246.us.3, 1
  %sub.r51.us249.us.3 = fadd double %51, -1.000000e+00
  %call74.us253.us.3 = tail call { double, double } @__muldc3(double noundef %12, double noundef %13, double noundef %Z.coerce0, double noundef %Z.coerce1) #8
  %53 = extractvalue { double, double } %call74.us253.us.3, 0
  %54 = extractvalue { double, double } %call74.us253.us.3, 1
  %sub.r78.us257.us.3 = fsub double 0x4063BD3D07C84B5E, %53
  %sub.i79.us258.us.3 = fneg double %54
  %call86.us260.us.3 = tail call { double, double } @__divdc3(double noundef %sub.r51.us249.us.3, double noundef %52, double noundef %sub.r78.us257.us.3, double noundef %sub.i79.us258.us.3) #8
  %55 = extractvalue { double, double } %call86.us260.us.3, 0
  %56 = extractvalue { double, double } %call86.us260.us.3, 1
  ...
  %call48.us246.us.4 = tail call { double, double } @cexp(double noundef %mul_r, double noundef %mul_i) #8
  %73 = extractvalue { double, double } %call48.us246.us.4, 0
  %74 = extractvalue { double, double } %call48.us246.us.4, 1
  %mul.ir50.us248.us.4 = fneg double %74
  %sub.r51.us249.us.4 = fsub double -1.000000e+00, %73
  %call74.us253.us.4 = tail call { double, double } @__muldc3(double noundef %12, double noundef %13, double noundef %Z.coerce0, double noundef %Z.coerce1) #8
  %75 = extractvalue { double, double } %call74.us253.us.4, 0
  %76 = extractvalue { double, double } %call74.us253.us.4, 1
  %sub.r78.us257.us.4 = fsub double 0x406ED7AEE631F8A1, %75
  %sub.i79.us258.us.4 = fneg double %76
  %call86.us260.us.4 = tail call { double, double } @__divdc3(double noundef %sub.r51.us249.us.4, double noundef %mul.ir50.us248.us.4, double noundef %sub.r78.us257.us.4, double noundef %sub.i79.us258.us.4) #8
  %77 = extractvalue { double, double } %call86.us260.us.4, 0
  %78 = extractvalue { double, double } %call86.us260.us.4, 1
  ...
  %call48.us246.us.5 = tail call { double, double } @cexp(double noundef %mul_r, double noundef %mul_i) #8
  %82 = extractvalue { double, double } %call48.us246.us.5, 0
  %83 = extractvalue { double, double } %call48.us246.us.5, 1
  %sub.r51.us249.us.5 = fadd double %82, -1.000000e+00
  %call74.us253.us.5 = tail call { double, double } @__muldc3(double noundef %12, double noundef %13, double noundef %Z.coerce0, double noundef %Z.coerce1) #8
  %84 = extractvalue { double, double } %call74.us253.us.5, 0
  %85 = extractvalue { double, double } %call74.us253.us.5, 1
  %sub.r78.us257.us.5 = fsub double 0x407634E48E8A71DE, %84
  %sub.i79.us258.us.5 = fneg double %85
  %call86.us260.us.5 = tail call { double, double } @__divdc3(double noundef %sub.r51.us249.us.5, double noundef %83, double noundef %sub.r78.us257.us.5, double noundef %sub.i79.us258.us.5) #8
  %86 = extractvalue { double, double } %call86.us260.us.5, 0
  %87 = extractvalue { double, double } %call86.us260.us.5, 1
  %call48.us246.us.6 = tail call { double, double } @cexp(double noundef %mul_r, double noundef %mul_i) #8
  %88 = extractvalue { double, double } %call48.us246.us.6, 0
  %89 = extractvalue { double, double } %call48.us246.us.6, 1
  %mul.ir50.us248.us.6 = fneg double %89
  %sub.r51.us249.us.6 = fsub double -1.000000e+00, %88
  %call74.us253.us.6 = tail call { double, double } @__muldc3(double noundef %12, double noundef %13, double noundef %Z.coerce0, double noundef %Z.coerce1) #8
  %90 = extractvalue { double, double } %call74.us253.us.6, 0
  %91 = extractvalue { double, double } %call74.us253.us.6, 1
  %sub.r78.us257.us.6 = fsub double 0x407E39C504816F00, %90
  %sub.i79.us258.us.6 = fneg double %91
  %call86.us260.us.6 = tail call { double, double } @__divdc3(double noundef %sub.r51.us249.us.6, double noundef %mul.ir50.us248.us.6, double noundef %sub.r78.us257.us.6, double noundef %sub.i79.us258.us.6) #8
  %92 = extractvalue { double, double } %call86.us260.us.6, 0
  %93 = extractvalue { double, double } %call86.us260.us.6, 1
  %call48.us246.us.7 = tail call { double, double } @cexp(double noundef %mul_r, double noundef %mul_i) #8
  %94 = extractvalue { double, double } %call48.us246.us.7, 0
  %95 = extractvalue { double, double } %call48.us246.us.7, 1
  %sub.r51.us249.us.7 = fadd double %94, -1.000000e+00
  %call74.us253.us.7 = tail call { double, double } @__muldc3(double noundef %12, double noundef %13, double noundef %Z.coerce0, double noundef %Z.coerce1) #8
  %96 = extractvalue { double, double } %call74.us253.us.7, 0
  %97 = extractvalue { double, double } %call74.us253.us.7, 1
  %sub.r78.us257.us.7 = fsub double 0x4083BD3CD35A8588, %96
  %sub.i79.us258.us.7 = fneg double %97
  %call86.us260.us.7 = tail call { double, double } @__divdc3(double noundef %sub.r51.us249.us.7, double noundef %95, double noundef %sub.r78.us257.us.7, double noundef %sub.i79.us258.us.7) #8
  %98 = extractvalue { double, double } %call86.us260.us.7, 0
  %99 = extractvalue { double, double } %call86.us260.us.7, 1
  %call48.us246.us.8 = tail call { double, double } @cexp(double noundef %mul_r, double noundef %mul_i) #8
  %100 = extractvalue { double, double } %call48.us246.us.8, 0
  %101 = extractvalue { double, double } %call48.us246.us.8, 1
  %mul.ir50.us248.us.8 = fneg double %101
  %sub.r51.us249.us.8 = fsub double -1.000000e+00, %100
  %call74.us253.us.8 = tail call { double, double } @__muldc3(double noundef %12, double noundef %13, double noundef %Z.coerce0, double noundef %Z.coerce1) #8
  %102 = extractvalue { double, double } %call74.us253.us.8, 0
  %103 = extractvalue { double, double } %call74.us253.us.8, 1
  %sub.r78.us257.us.8 = fsub double 0x4088FB810624DD2F, %102
  %sub.i79.us258.us.8 = fneg double %103
  %call86.us260.us.8 = tail call { double, double } @__divdc3(double noundef %sub.r51.us249.us.8, double noundef %mul.ir50.us248.us.8, double noundef %sub.r78.us257.us.8, double noundef %sub.i79.us258.us.8) #8
  %104 = extractvalue { double, double } %call86.us260.us.8, 0
  %105 = extractvalue { double, double } %call86.us260.us.8, 1
  %call48.us246.us.9 = tail call { double, double } @cexp(double noundef %mul_r, double noundef %mul_i) #8
  %106 = extractvalue { double, double } %call48.us246.us.9, 0
  %107 = extractvalue { double, double } %call48.us246.us.9, 1
  %sub.r51.us249.us.9 = fadd double %106, -1.000000e+00
  %call74.us253.us.9 = tail call { double, double } @__muldc3(double noundef %12, double noundef %13, double noundef %Z.coerce0, double noundef %Z.coerce1) #8
  %108 = extractvalue { double, double } %call74.us253.us.9, 0
  %109 = extractvalue { double, double } %call74.us253.us.9, 1
  %sub.r78.us257.us.9 = fsub double 0x408ED7AEE631F8A1, %108
  %sub.i79.us258.us.9 = fneg double %109
  %call86.us260.us.9 = tail call { double, double } @__divdc3(double noundef %sub.r51.us249.us.9, double noundef %107, double noundef %sub.r78.us257.us.9, double noundef %sub.i79.us258.us.9) #8
  %110 = extractvalue { double, double } %call86.us260.us.9, 0
  %111 = extractvalue { double, double } %call86.us260.us.9, 1
...
complex_mul_cont20.split.split.us.split:          ; preds = %complex_mul_cont20.split.split.us
  %sub.i79.us258 = fneg double %mul_i69
  %call48.us246 = tail call { double, double } @cexp(double noundef %mul_r, double noundef %mul_i) #8
  %133 = extractvalue { double, double } %call48.us246, 0
  %134 = extractvalue { double, double } %call48.us246, 1
  %mul.ir50.us248 = fneg double %134
  %sub.r51.us249 = fsub double -1.000000e+00, %133
  %sub.r78.us257 = fsub double 0x4023BD3CBC48F10B, %mul_r68
  %call86.us260 = tail call { double, double } @__divdc3(double noundef %sub.r51.us249, double noundef %mul.ir50.us248, double noundef %sub.r78.us257, double noundef %sub.i79.us258) #8
  %135 = extractvalue { double, double } %call86.us260, 0
  %136 = extractvalue { double, double } %call86.us260, 1
  %call48.us246.1 = tail call { double, double } @cexp(double noundef %mul_r, double noundef %mul_i) #8
  %137 = extractvalue { double, double } %call48.us246.1, 0
  %138 = extractvalue { double, double } %call48.us246.1, 1
  %sub.r51.us249.1 = fadd double %137, -1.000000e+00
  %sub.r78.us257.1 = fsub double 0x4043BD3CDDD6E04C, %mul_r68
  %call86.us260.1 = tail call { double, double } @__divdc3(double noundef %sub.r51.us249.1, double noundef %138, double noundef %sub.r78.us257.1, double noundef %sub.i79.us258) #8
  %139 = extractvalue { double, double } %call86.us260.1, 0
  %140 = extractvalue { double, double } %call86.us260.1, 1
  %call48.us246.2 = tail call { double, double } @cexp(double noundef %mul_r, double noundef %mul_i) #8
  %141 = extractvalue { double, double } %call48.us246.2, 0
  %142 = extractvalue { double, double } %call48.us246.2, 1
  %mul.ir50.us248.2 = fneg double %142
  %sub.r51.us249.2 = fsub double -1.000000e+00, %141
  %sub.r78.us257.2 = fsub double 0x405634E4649906CD, %mul_r68
  %call86.us260.2 = tail call { double, double } @__divdc3(double noundef %sub.r51.us249.2, double noundef %mul.ir50.us248.2, double noundef %sub.r78.us257.2, double noundef %sub.i79.us258) #8
  %143 = extractvalue { double, double } %call86.us260.2, 0
  %144 = extractvalue { double, double } %call86.us260.2, 1
  %call48.us246.3 = tail call { double, double } @cexp(double noundef %mul_r, double noundef %mul_i) #8
  %145 = extractvalue { double, double } %call48.us246.3, 0
  %146 = extractvalue { double, double } %call48.us246.3, 1
  %sub.r51.us249.3 = fadd double %145, -1.000000e+00
  %sub.r78.us257.3 = fsub double 0x4063BD3D07C84B5E, %mul_r68
  %call86.us260.3 = tail call { double, double } @__divdc3(double noundef %sub.r51.us249.3, double noundef %146, double noundef %sub.r78.us257.3, double noundef %sub.i79.us258) #8
  %147 = extractvalue { double, double } %call86.us260.3, 0
  %148 = extractvalue { double, double } %call86.us260.3, 1
  ...
  %call48.us246.4 = tail call { double, double } @cexp(double noundef %mul_r, double noundef %mul_i) #8
  %165 = extractvalue { double, double } %call48.us246.4, 0
  %166 = extractvalue { double, double } %call48.us246.4, 1
  %mul.ir50.us248.4 = fneg double %166
  %sub.r51.us249.4 = fsub double -1.000000e+00, %165
  %sub.r78.us257.4 = fsub double 0x406ED7AEE631F8A1, %mul_r68
  %call86.us260.4 = tail call { double, double } @__divdc3(double noundef %sub.r51.us249.4, double noundef %mul.ir50.us248.4, double noundef %sub.r78.us257.4, double noundef %sub.i79.us258) #8
  %167 = extractvalue { double, double } %call86.us260.4, 0
  %168 = extractvalue { double, double } %call86.us260.4, 1
  ...
  %call48.us246.5 = tail call { double, double } @cexp(double noundef %mul_r, double noundef %mul_i) #8
  %172 = extractvalue { double, double } %call48.us246.5, 0
  %173 = extractvalue { double, double } %call48.us246.5, 1
  %sub.r51.us249.5 = fadd double %172, -1.000000e+00
  %sub.r78.us257.5 = fsub double 0x407634E48E8A71DE, %mul_r68
  %call86.us260.5 = tail call { double, double } @__divdc3(double noundef %sub.r51.us249.5, double noundef %173, double noundef %sub.r78.us257.5, double noundef %sub.i79.us258) #8
  %174 = extractvalue { double, double } %call86.us260.5, 0
  %175 = extractvalue { double, double } %call86.us260.5, 1
  %call48.us246.6 = tail call { double, double } @cexp(double noundef %mul_r, double noundef %mul_i) #8
  %176 = extractvalue { double, double } %call48.us246.6, 0
  %177 = extractvalue { double, double } %call48.us246.6, 1
  %mul.ir50.us248.6 = fneg double %177
  %sub.r51.us249.6 = fsub double -1.000000e+00, %176
  %sub.r78.us257.6 = fsub double 0x407E39C504816F00, %mul_r68
  %call86.us260.6 = tail call { double, double } @__divdc3(double noundef %sub.r51.us249.6, double noundef %mul.ir50.us248.6, double noundef %sub.r78.us257.6, double noundef %sub.i79.us258) #8
  %178 = extractvalue { double, double } %call86.us260.6, 0
  %179 = extractvalue { double, double } %call86.us260.6, 1
  %call48.us246.7 = tail call { double, double } @cexp(double noundef %mul_r, double noundef %mul_i) #8
  %180 = extractvalue { double, double } %call48.us246.7, 0
  %181 = extractvalue { double, double } %call48.us246.7, 1
  %sub.r51.us249.7 = fadd double %180, -1.000000e+00
  %sub.r78.us257.7 = fsub double 0x4083BD3CD35A8588, %mul_r68
  %call86.us260.7 = tail call { double, double } @__divdc3(double noundef %sub.r51.us249.7, double noundef %181, double noundef %sub.r78.us257.7, double noundef %sub.i79.us258) #8
  %182 = extractvalue { double, double } %call86.us260.7, 0
  %183 = extractvalue { double, double } %call86.us260.7, 1
  %call48.us246.8 = tail call { double, double } @cexp(double noundef %mul_r, double noundef %mul_i) #8
  %184 = extractvalue { double, double } %call48.us246.8, 0
  %185 = extractvalue { double, double } %call48.us246.8, 1
  %mul.ir50.us248.8 = fneg double %185
  %sub.r51.us249.8 = fsub double -1.000000e+00, %184
  %sub.r78.us257.8 = fsub double 0x4088FB810624DD2F, %mul_r68
  %call86.us260.8 = tail call { double, double } @__divdc3(double noundef %sub.r51.us249.8, double noundef %mul.ir50.us248.8, double noundef %sub.r78.us257.8, double noundef %sub.i79.us258) #8
  %186 = extractvalue { double, double } %call86.us260.8, 0
  %187 = extractvalue { double, double } %call86.us260.8, 1
  %call48.us246.9 = tail call { double, double } @cexp(double noundef %mul_r, double noundef %mul_i) #8
  %188 = extractvalue { double, double } %call48.us246.9, 0
  %189 = extractvalue { double, double } %call48.us246.9, 1
  %sub.r51.us249.9 = fadd double %188, -1.000000e+00
  %sub.r78.us257.9 = fsub double 0x408ED7AEE631F8A1, %mul_r68
  %call86.us260.9 = tail call { double, double } @__divdc3(double noundef %sub.r51.us249.9, double noundef %189, double noundef %sub.r78.us257.9, double noundef %sub.i79.us258) #8
  %190 = extractvalue { double, double } %call86.us260.9, 0
  %191 = extractvalue { double, double } %call86.us260.9, 1
...
for.cond.cleanup:                                 ; preds = %complex_mul_cont75.us, %for.body.us240.us.preheader, %complex_mul_cont20.split.split.us.split, %complex_mul_cont20.split.split
  %293 = phi <2 x double> [ %292, %complex_mul_cont20.split.split ], [ %212, %complex_mul_cont20.split.split.us.split ], [ %132, %for.body.us240.us.preheader ], [ %32, %complex_mul_cont75.us ]
...
entry:
  ...
  %spec.select = add nsw i32 %conv2, %dec
...
if.then.i:                                        ; preds = %for.body.i
  ...
  %sub.i119 = fadd double %mul.i, %call4.i
  br label %if.end24.i
...
if.end24.i:                                       ; preds = %if.then13.i, %if.then6.i, %if.then.i, %for.body.i
  %phi.0.i = phi double [ %sub.i119, %if.then.i ], [ %sub10.i, %if.then6.i ], [ %sub22.i, %if.then13.i ], [ %mul.i, %for.body.i ]
...
calculate_sig_T.exit:                             ; preds = %if.end24.i, %entry
  ...
  %cmp13120 = icmp slt i32 %w.sroa.6.0.copyload, %w.sroa.7.0.copyload
  br i1 %cmp13120, label %for.body.lr.ph, label %for.cond.cleanup
...
for.body:                                         ; preds = %for.body.lr.ph, %complex_mul_cont86
  ...
  %sigT.0124 = phi double [ %mul, %for.body.lr.ph ], [ %add, %complex_mul_cont86 ]
  %sigA.0123 = phi double [ %16, %for.body.lr.ph ], [ %add70, %complex_mul_cont86 ]
  %sigF.0122 = phi double [ %17, %for.body.lr.ph ], [ %add89, %complex_mul_cont86 ]
...
complex_mul_cont49:                               ; preds = %complex_mul_libcall47, %complex_mul_imag_nan45, %complex_mul_cont
  ...
  %add = fadd double %sigT.0124, %real_mul_phi50
...
complex_mul_cont67:                               ; preds = %complex_mul_libcall65, %complex_mul_imag_nan63, %complex_mul_cont49
  ...
  %add70 = fadd double %sigA.0123, %real_mul_phi68
...
complex_mul_cont86:                               ; preds = %complex_mul_libcall84, %complex_mul_imag_nan82, %complex_mul_cont67
  ...
  %add89 = fadd double %sigF.0122, %real_mul_phi87
...
for.body:                                         ; preds = %for.body.lr.ph, %complex_mul_cont76
  ...
  %shift117 = shufflevector <2 x double> %33, <2 x double> poison, <2 x i32> <i32 1, i32 undef>
...
complex_mul_cont39:                               ; preds = %complex_mul_libcall37, %complex_mul_imag_nan35, %complex_mul_cont
  ...
  %shift118 = shufflevector <2 x double> %43, <2 x double> poison, <2 x i32> <i32 1, i32 undef>
...
complex_mul_imag_nan53:                           ; preds = %complex_mul_cont39
  ...
  %shift119 = shufflevector <2 x double> %45, <2 x double> poison, <2 x i32> <i32 1, i32 undef>
...
complex_mul_cont57:                               ; preds = %complex_mul_libcall55, %complex_mul_imag_nan53, %complex_mul_cont39
  ...
  %shift120 = shufflevector <2 x double> %52, <2 x double> poison, <2 x i32> <i32 1, i32 undef>
...
complex_mul_imag_nan72:                           ; preds = %complex_mul_cont57
  ...
  %shift121 = shufflevector <2 x double> %54, <2 x double> poison, <2 x i32> <i32 1, i32 undef>
