...
57:                                               ; preds = %46, %53
  ...
  %67 = getelementptr inbounds %struct.domain_type, ptr %0, i64 0, i32 14
  ...
  %79 = getelementptr inbounds %struct.domain_type, ptr %0, i64 0, i32 14, i32 1
  ...
  %88 = getelementptr inbounds %struct.domain_type, ptr %0, i64 0, i32 14, i32 2
...
434:                                              ; preds = %425, %431
  ...
  %455 = load i32, ptr %55, align 4, !tbaa !37
  %456 = add nsw i32 %454, %455
  %457 = srem i32 %456, %455
  %458 = mul i32 %457, %446
  %459 = add i32 %458, %449
  %460 = mul i32 %459, %439
  %461 = add i32 %460, %442
...
499:                                              ; preds = %496, %488
  ...
  %514 = load i32, ptr %55, align 4, !tbaa !37
  %515 = add nsw i32 %513, %514
  %516 = srem i32 %515, %514
  %517 = mul i32 %516, %505
  %518 = add i32 %517, %508
  %519 = mul i32 %518, %501
  %520 = add i32 %519, %504
...
559:                                              ; preds = %556, %547
  ...
  %574 = load i32, ptr %55, align 4, !tbaa !37
...
621:                                              ; preds = %618, %609
  ...
  %636 = load i32, ptr %55, align 4, !tbaa !37
  %637 = add nsw i32 %635, %636
  %638 = srem i32 %637, %636
  %639 = mul i32 %638, %627
  %640 = add i32 %639, %630
  %641 = mul i32 %640, %623
  %642 = add i32 %641, %626
...
690:                                              ; preds = %687, %678
  ...
  %705 = load i32, ptr %55, align 4, !tbaa !37
  %706 = add nsw i32 %704, %705
  %707 = srem i32 %706, %705
  %708 = mul i32 %707, %696
  %709 = add i32 %708, %699
  %710 = mul i32 %709, %692
  %711 = add i32 %710, %695
...
763:                                              ; preds = %760, %751
  ...
  %778 = load i32, ptr %55, align 4, !tbaa !37
  %779 = add nsw i32 %777, %778
  %780 = srem i32 %779, %778
  %781 = mul i32 %780, %769
  %782 = add i32 %781, %772
  %783 = mul i32 %782, %765
  %784 = add i32 %783, %768
...
827:                                              ; preds = %824, %815
  ...
  %842 = load i32, ptr %55, align 4, !tbaa !37
  %843 = add nsw i32 %841, %842
  %844 = srem i32 %843, %842
  %845 = mul i32 %844, %833
  %846 = add i32 %845, %836
  %847 = mul i32 %846, %829
  %848 = add i32 %847, %832
...
896:                                              ; preds = %893, %884
  ...
  %911 = load i32, ptr %55, align 4, !tbaa !37
  %912 = add nsw i32 %910, %911
  %913 = srem i32 %912, %911
  %914 = mul i32 %913, %902
  %915 = add i32 %914, %905
  %916 = mul i32 %915, %898
  %917 = add i32 %916, %901
...
969:                                              ; preds = %966, %957
  ...
  %984 = load i32, ptr %55, align 4, !tbaa !37
  %985 = add nsw i32 %983, %984
  %986 = srem i32 %985, %984
  %987 = mul i32 %986, %975
  %988 = add i32 %987, %978
  %989 = mul i32 %988, %971
  %990 = add i32 %989, %974
...
1304:                                             ; preds = %1293, %1301
  ...
  %1326 = add nsw i32 %1241, %1325
  %1327 = load i32, ptr %55, align 4, !tbaa !37
  %1328 = add nsw i32 %1326, %1327
  %1329 = srem i32 %1328, %1327
