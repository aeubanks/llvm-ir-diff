; ModuleID = '/usr/local/google/home/aeubanks/repos/test-suite/Bitcode/simd_ops/x86_tests/test_op_vpmaxud_396.bc'
...
@str.11 = private constant [15 x i8] c"op_vpmaxud_396\00", align 32
...
define i32 @__test_op(ptr noalias nocapture readnone %in_f32.buffer, ptr noalias nocapture readnone %in_f64.buffer, ptr noalias nocapture readnone %in_i8.buffer, ptr noalias nocapture readnone %in_u8.buffer, ptr noalias nocapture readnone %in_i16.buffer, ptr noalias nocapture readnone %in_u16.buffer, ptr noalias nocapture readnone %in_i32.buffer, ptr noalias nocapture readonly %in_u32.buffer, ptr noalias nocapture readnone %in_i64.buffer, ptr noalias nocapture readnone %in_u64.buffer, ptr noalias nocapture readonly %op_vpmaxud_396.buffer) local_unnamed_addr #0 {
"produce op_vpmaxud_396":
  %buf_extent168 = getelementptr inbounds %struct.buffer_t, ptr %op_vpmaxud_396.buffer, i64 0, i32 2, i64 1
  %op_vpmaxud_396.extent.1 = load i32, ptr %buf_extent168, align 4
  %buf_min176 = getelementptr inbounds %struct.buffer_t, ptr %op_vpmaxud_396.buffer, i64 0, i32 4, i64 1
  %op_vpmaxud_396.min.1 = load i32, ptr %buf_min176, align 4
  %0 = add nsw i32 %op_vpmaxud_396.min.1, %op_vpmaxud_396.extent.1
  %1 = icmp sgt i32 %op_vpmaxud_396.extent.1, 0
  br i1 %1, label %"for op_vpmaxud_396.s0.y.preheader", label %destructor_block, !prof !4

"for op_vpmaxud_396.s0.y.preheader":              ; preds = %"produce op_vpmaxud_396"
  ...
  %buf_min175 = getelementptr inbounds %struct.buffer_t, ptr %op_vpmaxud_396.buffer, i64 0, i32 4, i64 0
  %op_vpmaxud_396.min.0 = load i32, ptr %buf_min175, align 4
  %2 = sext i32 %op_vpmaxud_396.min.0 to i64
  %buf_stride172 = getelementptr inbounds %struct.buffer_t, ptr %op_vpmaxud_396.buffer, i64 0, i32 3, i64 1
  %op_vpmaxud_396.stride.1 = load i32, ptr %buf_stride172, align 4
  %3 = sext i32 %op_vpmaxud_396.stride.1 to i64
  %buf_host163 = getelementptr inbounds %struct.buffer_t, ptr %op_vpmaxud_396.buffer, i64 0, i32 1
  %op_vpmaxud_396.host = load ptr, ptr %buf_host163, align 8
  %4 = shl nsw i64 %2, 3
  %5 = sub nsw i64 96, %4
  %scevgep = getelementptr i8, ptr %op_vpmaxud_396.host, i64 %5
  %6 = shl nsw i64 %3, 3
  ...
  %11 = tail call <8 x i32> @llvm.umax.v8i32(<8 x i32> %7, <8 x i32> %9)
  %12 = tail call <8 x i32> @llvm.umax.v8i32(<8 x i32> %8, <8 x i32> %10)
  ...
  %22 = tail call <8 x i32> @llvm.umax.v8i32(<8 x i32> %9, <8 x i32> %20)
  %23 = tail call <8 x i32> @llvm.umax.v8i32(<8 x i32> %19, <8 x i32> %21)
  ...
  %34 = tail call <8 x i32> @llvm.umax.v8i32(<8 x i32> %30, <8 x i32> %32)
  %35 = tail call <8 x i32> @llvm.umax.v8i32(<8 x i32> %31, <8 x i32> %33)
  ...
  %46 = tail call <8 x i32> @llvm.umax.v8i32(<8 x i32> %42, <8 x i32> %44)
  %47 = tail call <8 x i32> @llvm.umax.v8i32(<8 x i32> %43, <8 x i32> %45)
  ...
  %58 = tail call <8 x i32> @llvm.umax.v8i32(<8 x i32> %54, <8 x i32> %56)
  %59 = tail call <8 x i32> @llvm.umax.v8i32(<8 x i32> %55, <8 x i32> %57)
  ...
  %70 = tail call <8 x i32> @llvm.umax.v8i32(<8 x i32> %66, <8 x i32> %68)
  %71 = tail call <8 x i32> @llvm.umax.v8i32(<8 x i32> %67, <8 x i32> %69)
  ...
  %82 = tail call <8 x i32> @llvm.umax.v8i32(<8 x i32> %78, <8 x i32> %80)
  %83 = tail call <8 x i32> @llvm.umax.v8i32(<8 x i32> %79, <8 x i32> %81)
  ...
  %94 = tail call <8 x i32> @llvm.umax.v8i32(<8 x i32> %90, <8 x i32> %92)
  %95 = tail call <8 x i32> @llvm.umax.v8i32(<8 x i32> %91, <8 x i32> %93)
  ...
  %106 = tail call <8 x i32> @llvm.umax.v8i32(<8 x i32> %102, <8 x i32> %104)
  %107 = tail call <8 x i32> @llvm.umax.v8i32(<8 x i32> %103, <8 x i32> %105)
  ...
  br label %"for op_vpmaxud_396.s0.x.x.preheader"

"for op_vpmaxud_396.s0.x.x.preheader":            ; preds = %"for op_vpmaxud_396.s0.x.x.preheader", %"for op_vpmaxud_396.s0.y.preheader"
  %lsr.iv180 = phi ptr [ %scevgep, %"for op_vpmaxud_396.s0.y.preheader" ], [ %scevgep182, %"for op_vpmaxud_396.s0.x.x.preheader" ]
  %op_vpmaxud_396.s0.y = phi i32 [ %op_vpmaxud_396.min.1, %"for op_vpmaxud_396.s0.y.preheader" ], [ %198, %"for op_vpmaxud_396.s0.x.x.preheader" ]
  ...
  %118 = tail call <8 x i32> @llvm.umax.v8i32(<8 x i32> %114, <8 x i32> %116)
  %119 = tail call <8 x i32> @llvm.umax.v8i32(<8 x i32> %115, <8 x i32> %117)
  ...
  %130 = tail call <8 x i32> @llvm.umax.v8i32(<8 x i32> %126, <8 x i32> %128)
  %131 = tail call <8 x i32> @llvm.umax.v8i32(<8 x i32> %127, <8 x i32> %129)
  ...
  %142 = tail call <8 x i32> @llvm.umax.v8i32(<8 x i32> %138, <8 x i32> %140)
  %143 = tail call <8 x i32> @llvm.umax.v8i32(<8 x i32> %139, <8 x i32> %141)
  ...
  %154 = tail call <8 x i32> @llvm.umax.v8i32(<8 x i32> %150, <8 x i32> %152)
  %155 = tail call <8 x i32> @llvm.umax.v8i32(<8 x i32> %151, <8 x i32> %153)
  ...
  %166 = tail call <8 x i32> @llvm.umax.v8i32(<8 x i32> %162, <8 x i32> %164)
  %167 = tail call <8 x i32> @llvm.umax.v8i32(<8 x i32> %163, <8 x i32> %165)
  ...
  %178 = tail call <8 x i32> @llvm.umax.v8i32(<8 x i32> %174, <8 x i32> %176)
  %179 = tail call <8 x i32> @llvm.umax.v8i32(<8 x i32> %175, <8 x i32> %177)
  ...
  %190 = tail call <8 x i32> @llvm.umax.v8i32(<8 x i32> %186, <8 x i32> %188)
  %191 = tail call <8 x i32> @llvm.umax.v8i32(<8 x i32> %187, <8 x i32> %189)
  ...
  %198 = add nsw i32 %op_vpmaxud_396.s0.y, 1
  %scevgep182 = getelementptr i1, ptr %lsr.iv180, i64 %6
  %.not2 = icmp eq i32 %198, %0
  br i1 %.not2, label %destructor_block, label %"for op_vpmaxud_396.s0.x.x.preheader"

destructor_block:                                 ; preds = %"for op_vpmaxud_396.s0.x.x.preheader", %"produce op_vpmaxud_396"
  ret i32 0
}

; Function Attrs: nofree nosync nounwind memory(readwrite, inaccessiblemem: none)
define i32 @test_op(ptr noalias nocapture readnone %in_f32.buffer, ptr noalias nocapture readnone %in_f64.buffer, ptr noalias nocapture readnone %in_i8.buffer, ptr noalias nocapture readnone %in_u8.buffer, ptr noalias nocapture readnone %in_i16.buffer, ptr noalias nocapture readnone %in_u16.buffer, ptr noalias nocapture readnone %in_i32.buffer, ptr noalias nocapture readonly %in_u32.buffer, ptr noalias nocapture readnone %in_i64.buffer, ptr noalias nocapture readnone %in_u64.buffer, ptr noalias nocapture readonly %op_vpmaxud_396.buffer) local_unnamed_addr #1 {
destructor_block:
  %"__test_op_result$24" = tail call i32 @__test_op(ptr poison, ptr poison, ptr poison, ptr poison, ptr poison, ptr poison, ptr poison, ptr %in_u32.buffer, ptr poison, ptr poison, ptr %op_vpmaxud_396.buffer) #4
  ret i32 0
}
