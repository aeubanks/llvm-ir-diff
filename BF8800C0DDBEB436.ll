...
if.end.i.i519:                                    ; preds = %if.else
  ...
  %call.i.i533 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %68) #21
          to label %if.end9.i.i524 unwind label %lpad64

if.end9.i.i524:                                   ; preds = %if.end.i.i519
...
_ZN11CStringBaseIwE11SetCapacityEi.exit.i525:     ; preds = %if.end9.i.i524, %if.else
  %70 = phi ptr [ %call.i.i449, %if.else ], [ %call.i.i533, %if.end9.i.i524 ]
...
call.i.i.i.noexc:                                 ; preds = %invoke.cont71
  ...
  %call.i.i45.i = invoke noalias noundef nonnull dereferenceable(16) ptr @_Znam(i64 noundef 16) #21
          to label %_ZN8NArchive6NSplit8CSeqNameC2Ev.exit unwind label %_ZN11CStringBaseIwED2Ev.exit.i
...
invoke.cont133:                                   ; preds = %if.end130, %if.then.i588
  %call.i591594 = invoke noalias noundef nonnull dereferenceable(8) ptr @_Znwm(i64 noundef 8) #21
          to label %call.i591.noexc unwind label %lpad134.body

call.i591.noexc:                                  ; preds = %invoke.cont133
  store ptr %stream, ptr %call.i591594, align 8, !tbaa !48
...
lpad134.body.thread:                              ; preds = %if.then.i.i
  ...
  call void @_ZdlPv(ptr noundef nonnull %call.i591594) #22
...
_ZN13CObjectVectorI9CMyComPtrI9IInStreamEE3AddERKS2_.exit: ; preds = %invoke.cont.i
  ...
  store ptr %call.i591594, ptr %arrayidx.i.i593, align 8, !tbaa !15
  %inc.i.i = add nsw i32 %117, 1
  store i32 %inc.i.i, ptr %_size.i.i, align 4, !tbaa !19
  br i1 %cmp.not.i584, label %_ZN9CMyComPtrI9IInStreamED2Ev.exit, label %if.then.i599

if.then.i599:                                     ; preds = %_ZN13CObjectVectorI9CMyComPtrI9IInStreamEE3AddERKS2_.exit
  %vtable.i596 = load ptr, ptr %stream, align 8, !tbaa !22
  %vfn.i597 = getelementptr inbounds ptr, ptr %vtable.i596, i64 2
  %118 = load ptr, ptr %vfn.i597, align 8
  %call.i598 = invoke noundef i32 %118(ptr noundef nonnull align 8 dereferenceable(8) %stream)
          to label %_ZN9CMyComPtrI9IInStreamED2Ev.exit unwind label %terminate.lpad.i601

terminate.lpad.i601:                              ; preds = %if.then.i599
...
_ZN9CMyComPtrI9IInStreamED2Ev.exit:               ; preds = %_ZN13CObjectVectorI9CMyComPtrI9IInStreamEE3AddERKS2_.exit, %if.then.i599
...
if.end.i.i.i868:                                  ; preds = %if.end.i.i866
  ...
  %call.i.i.i878 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %132) #21
          to label %call.i.i.i.noexc877 unwind label %lpad.i607
...
lpad.i607:                                        ; preds = %if.end.i.i.i868
  %139 = landingpad { ptr, i32 }
          catch ptr @_ZTIPKc
          catch ptr null
  %isnull.i.i = icmp eq ptr %126, null
  br i1 %isnull.i.i, label %ehcleanup152, label %delete.notnull.i.i608

delete.notnull.i.i608:                            ; preds = %lpad.i607
  call void @_ZdaPv(ptr noundef nonnull %126) #22
...
if.then.i707:                                     ; preds = %lpad134.body.thread, %lpad134.body
  %eh.lpad-body595928 = phi { ptr, i32 } [ %115, %lpad134.body.thread ], [ %164, %lpad134.body ]
...
ehcleanup152:                                     ; preds = %delete.notnull.i712, %lpad148, %lpad146, %delete.notnull.i.i608, %lpad.i607
  %.pn899 = phi { ptr, i32 } [ %169, %lpad146 ], [ %139, %delete.notnull.i.i608 ], [ %139, %lpad.i607 ], [ %170, %lpad148 ], [ %170, %delete.notnull.i712 ]
...
ehcleanup345:                                     ; preds = %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit757, %lpad214, %lpad227, %ehcleanup341, %lpad132, %lpad134.body, %if.then.i707, %ehcleanup181, %ehcleanup162, %ehcleanup153, %ehcleanup103, %lpad83, %ehcleanup81
  %.pn906.pn.pn.pn = phi { ptr, i32 } [ %98, %lpad83 ], [ %.pn904, %ehcleanup181 ], [ %.pn902, %ehcleanup162 ], [ %.pn899.pn, %ehcleanup153 ], [ %.pn896, %ehcleanup103 ], [ %.pn894, %ehcleanup81 ], [ %163, %lpad132 ], [ %164, %lpad134.body ], [ %eh.lpad-body595928, %if.then.i707 ], [ %.pn906.pn, %ehcleanup341 ], [ %207, %lpad227 ], [ %206, %lpad214 ], [ %192, %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit757 ]
...
ehcleanup351:                                     ; preds = %lpad72, %_ZN11CStringBaseIwED2Ev.exit.i, %ehcleanup345
  %.pn906.pn.pn.pn.pn = phi { ptr, i32 } [ %.pn906.pn.pn.pn, %ehcleanup345 ], [ %94, %lpad72 ], [ %83, %_ZN11CStringBaseIwED2Ev.exit.i ]
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %seqName) #19
  br label %ehcleanup353
...
_ZN11CStringBaseIwEC2ERKS0_.exit.i:               ; preds = %while.cond.i.i.ithread-pre-split
  ...
  br i1 %cmp.not.i.i579, label %if.end.i.i592, label %_ZN11CStringBaseIwE10GrowLengthEi.exit.i

if.end.i.i592:                                    ; preds = %_ZN11CStringBaseIwEC2ERKS0_.exit.i
  %delta.1.i.i588 = call i32 @llvm.umax.i32(i32 %124, i32 4)
  %add.i.i.i590 = add nuw i32 %delta.1.i.i588, 3
...
for.body.i.i.i607.preheader:                      ; preds = %if.end.i.i592
...
delete.notnull.i.i397:                            ; preds = %if.end.i.i592
