...
entry:
  ...
  %arrayidx = getelementptr inbounds %struct.VEC_char_base, ptr %p, i64 0, i32 2, i64 %idxprom
  store i16 0, ptr %arrayidx, align 2, !tbaa !5
  %arrayidx2 = getelementptr inbounds %struct.VEC_char_base, ptr %p, i64 2
  store i16 1, ptr %arrayidx2, align 2, !tbaa !5
...
entry:
  %call = tail call dereferenceable_or_null(268) ptr @malloc(i64 noundef 268) #4
  %call1 = tail call signext i16 @foo(ptr noundef %call, i32 noundef 8)
