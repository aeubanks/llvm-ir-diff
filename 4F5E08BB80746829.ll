...
while.body.i31.i:                                 ; preds = %while.cond.i28.i
  ...
  %22 = load ptr, ptr %next.i.i29.i, align 8, !tbaa !18
...
while.body.i55.i:                                 ; preds = %while.cond.i52.i
  ...
  %32 = load ptr, ptr %next.i.i53.i, align 8, !tbaa !18
...
while.body.i79.i:                                 ; preds = %while.cond.i76.i
  ...
  %42 = load ptr, ptr %next.i.i77.i, align 8, !tbaa !18
...
if.then55:                                        ; preds = %while.body
  ...
  %68 = load ptr, ptr %next.i109, align 8, !tbaa !18
