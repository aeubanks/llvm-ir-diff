; ModuleID = '/usr/local/google/home/aeubanks/repos/test-suite/SingleSource/Regression/C/gcc-c-torture/execute/pr43008.c'
source_filename = "/usr/local/google/home/aeubanks/repos/test-suite/SingleSource/Regression/C/gcc-c-torture/execute/pr43008.c"
...
define dso_local noalias ptr @my_alloc() local_unnamed_addr #0 {
entry:
  %call = tail call dereferenceable_or_null(8) ptr @malloc(i64 noundef 8) #3
  store ptr @i, ptr %call, align 8, !tbaa !5
  ret ptr %call
}
