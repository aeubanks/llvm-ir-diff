...
if.end:                                           ; preds = %vaarg.end
  ...
  %x.sroa.4.0.copyload = load i8, ptr %x.sroa.4.0.vaarg.addr.sroa_idx, align 1, !tbaa.struct !11
...
entry:
  %call = tail call i32 (i32, ...) @f(i32 noundef 3, i16 5130, i16 5387, i16 5644, i64 noundef 123)
