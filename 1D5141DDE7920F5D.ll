...
define dso_local i32 @g723_40_encoder(i32 noundef %sl, i32 noundef %in_coding, ptr noundef %state_ptr) local_unnamed_addr #0 {
entry:
...
sw.epilog:                                        ; preds = %entry, %sw.bb1, %sw.bb
  ...
  %call22 = tail call i32 (i32, i32, ptr, i32, ...) @quantize(i32 noundef %conv20, i32 noundef %conv21, ptr noundef nonnull @qtab_723_40, i32 noundef 15) #2
  ...
  %arrayidx = getelementptr inbounds [32 x i16], ptr @_dqlntab, i64 0, i64 %idxprom
  ...
  %and33 = and i32 %call27, 32767
  %2 = sub nsw i32 0, %and33
  %cond.p = select i1 %cmp, i32 %2, i32 %conv29
  %cond = add nsw i32 %shr14, %cond.p
  %sext91 = shl i32 %cond, 16
  %conv39 = ashr exact i32 %sext91, 16
  %sub43 = add nsw i32 %shr8, %cond.p
  %arrayidx47 = getelementptr inbounds [32 x i16], ptr @_witab, i64 0, i64 %idxprom
  %3 = load i16, ptr %arrayidx47, align 2, !tbaa !5
  %conv48 = sext i16 %3 to i32
  %arrayidx50 = getelementptr inbounds [32 x i16], ptr @_fitab, i64 0, i64 %idxprom
  %4 = load i16, ptr %arrayidx50, align 2, !tbaa !5
  %conv51 = sext i16 %4 to i32
  %sext92 = shl i32 %sub43, 16
  %conv54 = ashr exact i32 %sext92, 16
  tail call void (i32, i32, i32, i32, i32, i32, i32, ptr, ...) @update(i32 noundef 5, i32 noundef %conv21, i32 noundef %conv48, i32 noundef %conv51, i32 noundef %conv29, i32 noundef %conv39, i32 noundef %conv54, ptr noundef %state_ptr) #2
  br label %cleanup
...
; Function Attrs: nounwind uwtable
define dso_local i32 @g723_40_decoder(i32 noundef %i, i32 noundef %out_coding, ptr noundef %state_ptr) local_unnamed_addr #0 {
entry:
  %and = and i32 %i, 31
  ...
  %arrayidx33 = getelementptr inbounds [32 x i16], ptr @_witab, i64 0, i64 %idxprom
  %2 = load i16, ptr %arrayidx33, align 2, !tbaa !5
  %conv34 = sext i16 %2 to i32
  %arrayidx36 = getelementptr inbounds [32 x i16], ptr @_fitab, i64 0, i64 %idxprom
  %3 = load i16, ptr %arrayidx36, align 2, !tbaa !5
  %conv37 = sext i16 %3 to i32
  %sext88 = shl i32 %add29, 16
  %conv40 = ashr exact i32 %sext88, 16
  tail call void (i32, i32, i32, i32, i32, i32, i32, ptr, ...) @update(i32 noundef 5, i32 noundef %conv13, i32 noundef %conv34, i32 noundef %conv37, i32 noundef %conv16, i32 noundef %conv25, i32 noundef %conv40, ptr noundef %state_ptr) #2
...
sw.bb:                                            ; preds = %entry
  %call44 = tail call i32 (i32, i32, i32, i32, i32, ptr, ...) @tandem_adjust_alaw(i32 noundef %conv25, i32 noundef %shr7, i32 noundef %conv13, i32 noundef %and, i32 noundef 16, ptr noundef nonnull @qtab_723_40) #2
  br label %cleanup

sw.bb45:                                          ; preds = %entry
  %call49 = tail call i32 (i32, i32, i32, i32, i32, ptr, ...) @tandem_adjust_ulaw(i32 noundef %conv25, i32 noundef %shr7, i32 noundef %conv13, i32 noundef %and, i32 noundef 16, ptr noundef nonnull @qtab_723_40) #2
  br label %cleanup

sw.bb50:                                          ; preds = %entry
  %shl = ashr exact i32 %sext87, 14
  br label %cleanup
