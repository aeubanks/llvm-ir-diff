...
entry:
  %call = tail call i32 @init(ptr noundef nonnull @.str.65)
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
  %cmp30 = icmp sgt i32 %0, 0
  br i1 %cmp30, label %for.cond1.preheader, label %for.cond.cleanup
...
for.cond.cleanup:                                 ; preds = %for.cond.cleanup3, %entry
  %call20 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.137, double noundef 0.000000e+00)
  br label %for.body.i
...
for.cond.cleanup3:                                ; preds = %for.body4
  ...
  %cmp = icmp slt i32 %inc17, %6
  br i1 %cmp, label %for.cond1.preheader, label %for.cond.cleanup

for.body4:                                        ; preds = %for.cond1.preheader, %for.body4
  %indvars.iv = phi i64 [ 0, %for.cond1.preheader ], [ %indvars.iv.next, %for.body4 ]
  %7 = sub nuw nsw i64 31999, %indvars.iv
  %arrayidx = getelementptr inbounds double, ptr @global_data, i64 %7
  ...
  %sub10 = fadd double %11, -1.000000e+00
  %arrayidx12 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv
  store double %sub10, ptr %arrayidx12, align 8, !tbaa !5
  store double %11, ptr %arrayidx7, align 8, !tbaa !5
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, 32000
...
entry:
  ...
  br i1 %cmp37, label %vector.ph, label %for.cond.cleanup

vector.ph:                                        ; preds = %entry, %for.cond.cleanup3
  %nl.038 = phi i32 [ %inc21, %for.cond.cleanup3 ], [ 0, %entry ]
  br label %vector.body
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load40 = load <2 x double>, ptr %2, align 16, !tbaa !5
  %3 = getelementptr inbounds double, ptr @global_data, i64 %index
  %wide.load41 = load <2 x double>, ptr %3, align 16, !tbaa !5
  %4 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 %index
  %wide.load42 = load <2 x double>, ptr %4, align 16, !tbaa !5
  %5 = fmul <2 x double> %wide.load41, %wide.load42
  %6 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %wide.load, <2 x double> %wide.load40, <2 x double> %5)
  %7 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 11, i64 %index
  %wide.load43 = load <2 x double>, ptr %7, align 16, !tbaa !5
  %8 = fadd <2 x double> %wide.load43, %6
  %9 = fadd <2 x double> %8, <double -1.000000e+00, double -1.000000e+00>
  store <2 x double> %9, ptr %3, align 16, !tbaa !5
  store <2 x double> %8, ptr %1, align 16, !tbaa !5
  %index.next = add nuw i64 %index, 2
  %10 = icmp eq i64 %index.next, 32000
  br i1 %10, label %for.cond.cleanup3, label %vector.body, !llvm.loop !367

for.cond.cleanup:                                 ; preds = %for.cond.cleanup3, %entry
  %call24 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.138, double noundef 0.000000e+00)
  br label %for.body.i
...
for.body.i:                                       ; preds = %for.body.i, %for.cond.cleanup
  ...
  %suma.0192.i = phi double [ 0.000000e+00, %for.cond.cleanup ], [ %add.i.1, %for.body.i ]
  %arrayidx.i = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv.i
  %11 = load double, ptr %arrayidx.i, align 16, !tbaa !5
  %add.i = fadd double %suma.0192.i, %11
  %arrayidx2.i = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %indvars.iv.i
  %12 = load double, ptr %arrayidx2.i, align 16, !tbaa !5
  %add3.i = fadd double %sumb.0193.i, %12
  %indvars.iv.next.i = or i64 %indvars.iv.i, 1
  %arrayidx.i.1 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv.next.i
  %13 = load double, ptr %arrayidx.i.1, align 8, !tbaa !5
  %add.i.1 = fadd double %add.i, %13
  %arrayidx2.i.1 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %indvars.iv.next.i
  %14 = load double, ptr %arrayidx2.i.1, align 8, !tbaa !5
  %add3.i.1 = fadd double %add3.i, %14
  %indvars.iv.next.i.1 = add nuw nsw i64 %indvars.iv.i, 2
  %exitcond.not.i.1 = icmp eq i64 %indvars.iv.next.i.1, 32000
  br i1 %exitcond.not.i.1, label %for.cond18.preheader.i.preheader, label %for.body.i
...
for.cond18.preheader.i.preheader:                 ; preds = %for.body.i
  %15 = load i32, ptr @digits, align 4, !tbaa !17
  %add89.i = fadd double %add.i.1, %add3.i.1
  %call90.i = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %15, double noundef %add89.i)
  ret i32 0
...
entry:
  %call = tail call i32 @init(ptr noundef nonnull @.str.66)
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
...
for.cond.cleanup:                                 ; preds = %for.cond.cleanup3, %entry
  %call14 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.139, double noundef 0.000000e+00)
  br label %for.body.i
...
for.body4:                                        ; preds = %for.body4, %for.cond1.preheader
  ...
  %im1.020 = phi i64 [ 31999, %for.cond1.preheader ], [ %indvars.iv.next, %for.body4 ]
  ...
  %arrayidx6 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %im1.020
  %9 = load double, ptr %arrayidx6, align 8, !tbaa !5
  %add = fadd double %8, %9
  %mul7 = fmul double %add, 5.000000e-01
  %arrayidx9 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv
  store double %mul7, ptr %arrayidx9, align 16, !tbaa !5
  %indvars.iv.next = or i64 %indvars.iv, 1
  ...
  %arrayidx6.1 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %indvars.iv
  %11 = load double, ptr %arrayidx6.1, align 16, !tbaa !5
  %add.1 = fadd double %10, %11
  %mul7.1 = fmul double %add.1, 5.000000e-01
  %arrayidx9.1 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv.next
  store double %mul7.1, ptr %arrayidx9.1, align 8, !tbaa !5
...
entry:
  %call = tail call i32 @init(ptr noundef nonnull @.str.67)
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
  %cmp26 = icmp sgt i32 %0, 0
  br i1 %cmp26, label %for.cond1.preheader, label %for.cond.cleanup

for.cond1.preheader:                              ; preds = %entry, %for.cond.cleanup3
  %nl.027 = phi i32 [ %inc14, %for.cond.cleanup3 ], [ 0, %entry ]
  br label %for.body4

for.cond.cleanup:                                 ; preds = %for.cond.cleanup3, %entry
  %call16 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.140, double noundef 0.000000e+00)
  br label %for.body.i
...
for.body4:                                        ; preds = %for.body4, %for.cond1.preheader
  %indvars.iv = phi i64 [ 0, %for.cond1.preheader ], [ %indvars.iv.next.1, %for.body4 ]
  %im2.024 = phi i64 [ 31998, %for.cond1.preheader ], [ %indvars.iv, %for.body4 ]
  %im1.023 = phi i32 [ 31999, %for.cond1.preheader ], [ %14, %for.body4 ]
  %arrayidx = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %indvars.iv
  %8 = load double, ptr %arrayidx, align 16, !tbaa !5
  %idxprom5 = zext i32 %im1.023 to i64
  %arrayidx6 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %idxprom5
  %9 = load double, ptr %arrayidx6, align 8, !tbaa !5
  %add = fadd double %8, %9
  %idxprom7 = and i64 %im2.024, 4294967294
  ...
  %add9.1 = fadd double %add.1, %13
  %mul.1 = fmul double %add9.1, 3.330000e-01
  %arrayidx11.1 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv.next
  store double %mul.1, ptr %arrayidx11.1, align 8, !tbaa !5
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
...
entry:
  %call = tail call i32 @init(ptr noundef nonnull @.str.68)
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
  %cmp15 = icmp sgt i32 %0, 0
  br i1 %cmp15, label %for.cond1.preheader, label %for.cond.cleanup

for.cond1.preheader:                              ; preds = %entry, %for.cond.cleanup3
  %nl.016 = phi i32 [ %inc7, %for.cond.cleanup3 ], [ 0, %entry ]
  br label %for.body4

for.cond.cleanup:                                 ; preds = %for.cond.cleanup3, %entry
  %call9 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.141, double noundef 0.000000e+00)
  br label %for.body.i
...
for.body4:                                        ; preds = %for.body4, %for.cond1.preheader
  ...
  %arrayidx = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv
  store double %8, ptr %arrayidx, align 8, !tbaa !5
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %9 = load double, ptr @global_data, align 32, !tbaa !5
  %arrayidx.1 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv.next
  store double %9, ptr %arrayidx.1, align 8, !tbaa !5
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %10 = load double, ptr @global_data, align 32, !tbaa !5
  %arrayidx.2 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv.next.1
  store double %10, ptr %arrayidx.2, align 8, !tbaa !5
  ...
  store double %11, ptr %arrayidx.3, align 8, !tbaa !5
  %indvars.iv.next.3 = add nuw nsw i64 %indvars.iv, 4
  %12 = load double, ptr @global_data, align 32, !tbaa !5
  %arrayidx.4 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv.next.3
  store double %12, ptr %arrayidx.4, align 8, !tbaa !5
...
entry:
  %call = tail call i32 @init(ptr noundef nonnull @.str.69)
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
  %cmp31 = icmp sgt i32 %0, 0
  br i1 %cmp31, label %for.cond1.preheader, label %for.cond.cleanup

for.cond1.preheader:                              ; preds = %entry, %for.cond.cleanup3
  %nl.032 = phi i32 [ %inc18, %for.cond.cleanup3 ], [ 0, %entry ]
  br label %for.body4

for.cond.cleanup:                                 ; preds = %for.cond.cleanup3, %entry
  %call20 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.142, double noundef 0.000000e+00)
...
for.cond.cleanup3:                                ; preds = %for.body4
  ...
  %cmp = icmp slt i32 %inc18, %mul
  br i1 %cmp, label %for.cond1.preheader, label %for.cond.cleanup

for.body4:                                        ; preds = %for.body4, %for.cond1.preheader
  %indvars.iv = phi i64 [ 0, %for.cond1.preheader ], [ %indvars.iv.next.1, %for.body4 ]
  %arrayidx6 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), i64 %indvars.iv, i64 %indvars.iv
  %7 = load double, ptr %arrayidx6, align 16, !tbaa !5
  %arrayidx10 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 20, i64 0, i64 0), i64 %indvars.iv, i64 %indvars.iv
  %8 = load double, ptr %arrayidx10, align 16, !tbaa !5
  %arrayidx15 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), i64 %indvars.iv, i64 %indvars.iv
  %9 = load double, ptr %arrayidx15, align 16, !tbaa !5
  %10 = tail call double @llvm.fmuladd.f64(double %7, double %8, double %9)
  store double %10, ptr %arrayidx15, align 16, !tbaa !5
  %indvars.iv.next = or i64 %indvars.iv, 1
  %arrayidx6.1 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), i64 %indvars.iv.next, i64 %indvars.iv.next
  %11 = load double, ptr %arrayidx6.1, align 8, !tbaa !5
  %arrayidx10.1 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 20, i64 0, i64 0), i64 %indvars.iv.next, i64 %indvars.iv.next
  %12 = load double, ptr %arrayidx10.1, align 8, !tbaa !5
  %arrayidx15.1 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), i64 %indvars.iv.next, i64 %indvars.iv.next
  %13 = load double, ptr %arrayidx15.1, align 8, !tbaa !5
  %14 = tail call double @llvm.fmuladd.f64(double %11, double %12, double %13)
  store double %14, ptr %arrayidx15.1, align 8, !tbaa !5
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
...
entry:
  %call = tail call i32 @init(ptr noundef nonnull @.str.70)
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
  %cmp35 = icmp sgt i32 %0, 255
...
for.cond.cleanup:                                 ; preds = %for.cond.cleanup3, %entry
  %call23 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.143, double noundef 0.000000e+00)
  br label %for.cond18.preheader.i
...
for.cond.cleanup7:                                ; preds = %for.body8
  %arrayidx14 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), i64 %indvars.iv38, i64 %indvars.iv38
  store double 1.000000e+00, ptr %arrayidx14, align 8, !tbaa !5
  %indvars.iv.next39 = add nuw nsw i64 %indvars.iv38, 1
  %exitcond41.not = icmp eq i64 %indvars.iv.next39, 256
  br i1 %exitcond41.not, label %for.cond.cleanup3, label %for.cond5.preheader

for.body8:                                        ; preds = %for.body8, %for.cond5.preheader
  %indvars.iv = phi i64 [ 0, %for.cond5.preheader ], [ %indvars.iv.next.3, %for.body8 ]
  %arrayidx10 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), i64 %indvars.iv, i64 %indvars.iv38
  store double 0.000000e+00, ptr %arrayidx10, align 8, !tbaa !5
  %indvars.iv.next = or i64 %indvars.iv, 1
  %arrayidx10.1 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), i64 %indvars.iv.next, i64 %indvars.iv38
  store double 0.000000e+00, ptr %arrayidx10.1, align 8, !tbaa !5
  %indvars.iv.next.1 = or i64 %indvars.iv, 2
  %arrayidx10.2 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), i64 %indvars.iv.next.1, i64 %indvars.iv38
  store double 0.000000e+00, ptr %arrayidx10.2, align 8, !tbaa !5
  %indvars.iv.next.2 = or i64 %indvars.iv, 3
  %arrayidx10.3 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), i64 %indvars.iv.next.2, i64 %indvars.iv38
  store double 0.000000e+00, ptr %arrayidx10.3, align 8, !tbaa !5
  %indvars.iv.next.3 = add nuw nsw i64 %indvars.iv, 4
  %exitcond.not.3 = icmp eq i64 %indvars.iv.next.3, 256
  br i1 %exitcond.not.3, label %for.cond.cleanup7, label %for.body8
}

; Function Attrs: nounwind uwtable
define dso_local i32 @s2111() local_unnamed_addr #7 {
entry:
  %call = tail call i32 @init(ptr noundef nonnull @.str.71)
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
  %cmp72 = icmp sgt i32 %0, 255
  br i1 %cmp72, label %for.cond1.preheader, label %for.cond.cleanup

for.cond1.preheader:                              ; preds = %entry, %for.cond.cleanup3
  %nl.073 = phi i32 [ %inc25, %for.cond.cleanup3 ], [ 0, %entry ]
  br label %for.cond5.preheader

for.cond.cleanup:                                 ; preds = %for.cond.cleanup3, %entry
  %call29 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.144, double noundef 0.000000e+00)
  br label %for.cond37.preheader

for.cond5.preheader:                              ; preds = %for.cond1.preheader, %for.cond.cleanup7
  %indvars.iv83 = phi i64 [ 1, %for.cond1.preheader ], [ %indvars.iv.next84, %for.cond.cleanup7 ]
  %1 = add nsw i64 %indvars.iv83, -1
  %arrayidx10.phi.trans.insert = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), i64 %indvars.iv83, i64 0
...
for.cond.cleanup3:                                ; preds = %for.cond.cleanup7
  ...
  %inc25 = add nuw nsw i32 %nl.073, 1
...
for.cond.cleanup7:                                ; preds = %for.body8
  ...
  %exitcond87.not = icmp eq i64 %indvars.iv.next84, 256
  br i1 %exitcond87.not, label %for.cond.cleanup3, label %for.cond5.preheader

for.body8:                                        ; preds = %for.body8, %for.cond5.preheader
  %3 = phi double [ %.pre, %for.cond5.preheader ], [ %add.2, %for.body8 ]
  %indvars.iv = phi i64 [ 1, %for.cond5.preheader ], [ %indvars.iv.next.2, %for.body8 ]
  %arrayidx15 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), i64 %1, i64 %indvars.iv
  %4 = load double, ptr %arrayidx15, align 8, !tbaa !5
  %add = fadd double %3, %4
  %arrayidx19 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), i64 %indvars.iv83, i64 %indvars.iv
  store double %add, ptr %arrayidx19, align 8, !tbaa !5
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %arrayidx15.1 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), i64 %1, i64 %indvars.iv.next
  %5 = load double, ptr %arrayidx15.1, align 8, !tbaa !5
  %add.1 = fadd double %add, %5
  %arrayidx19.1 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), i64 %indvars.iv83, i64 %indvars.iv.next
  store double %add.1, ptr %arrayidx19.1, align 8, !tbaa !5
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %arrayidx15.2 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), i64 %1, i64 %indvars.iv.next.1
  %6 = load double, ptr %arrayidx15.2, align 8, !tbaa !5
  %add.2 = fadd double %add.1, %6
  %arrayidx19.2 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), i64 %indvars.iv83, i64 %indvars.iv.next.1
...
for.cond37.preheader:                             ; preds = %for.cond.cleanup, %for.cond.cleanup40
  %indvars.iv92 = phi i64 [ 0, %for.cond.cleanup ], [ %indvars.iv.next93, %for.cond.cleanup40 ]
  %add4674.lcssa7879 = phi double [ 0.000000e+00, %for.cond.cleanup ], [ %add46.3, %for.cond.cleanup40 ]
  br label %for.body41

for.cond.cleanup34:                               ; preds = %for.cond.cleanup40
  %cmp53 = fcmp oeq double %add46.3, 0.000000e+00
  %storemerge = select i1 %cmp53, double 3.000000e+00, double %add46.3
  store double %storemerge, ptr @temp, align 8, !tbaa !5
  %7 = load i32, ptr @digits, align 4, !tbaa !17
  %call126.i = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %7, double noundef %storemerge)
  ret i32 0

for.cond.cleanup40:                               ; preds = %for.body41
  %indvars.iv.next93 = add nuw nsw i64 %indvars.iv92, 1
  %exitcond95.not = icmp eq i64 %indvars.iv.next93, 256
  br i1 %exitcond95.not, label %for.cond.cleanup34, label %for.cond37.preheader

for.body41:                                       ; preds = %for.body41, %for.cond37.preheader
  %indvars.iv88 = phi i64 [ 0, %for.cond37.preheader ], [ %indvars.iv.next89.3, %for.body41 ]
  %add467475 = phi double [ %add4674.lcssa7879, %for.cond37.preheader ], [ %add46.3, %for.body41 ]
  %arrayidx45 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), i64 %indvars.iv92, i64 %indvars.iv88
  %8 = load double, ptr %arrayidx45, align 32, !tbaa !5
  %add46 = fadd double %8, %add467475
  %indvars.iv.next89 = or i64 %indvars.iv88, 1
  %arrayidx45.1 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), i64 %indvars.iv92, i64 %indvars.iv.next89
  %9 = load double, ptr %arrayidx45.1, align 8, !tbaa !5
  %add46.1 = fadd double %9, %add46
  %indvars.iv.next89.1 = or i64 %indvars.iv88, 2
  %arrayidx45.2 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), i64 %indvars.iv92, i64 %indvars.iv.next89.1
  %10 = load double, ptr %arrayidx45.2, align 16, !tbaa !5
  %add46.2 = fadd double %10, %add46.1
  %indvars.iv.next89.2 = or i64 %indvars.iv88, 3
  %arrayidx45.3 = getelementptr inbounds [256 x double], ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), i64 %indvars.iv92, i64 %indvars.iv.next89.2
  %11 = load double, ptr %arrayidx45.3, align 8, !tbaa !5
  %add46.3 = fadd double %11, %add46.2
  %indvars.iv.next89.3 = add nuw nsw i64 %indvars.iv88, 4
  %exitcond91.not.3 = icmp eq i64 %indvars.iv.next89.3, 256
  br i1 %exitcond91.not.3, label %for.cond.cleanup40, label %for.body41
}
...
vector.body125:                                   ; preds = %vector.body, %vector.body125
  ...
  br i1 %10, label %vector.body133, label %vector.body125, !llvm.loop !368
...
vector.body133:                                   ; preds = %vector.body125, %vector.body133
  ...
  br i1 %21, label %vector.body141, label %vector.body133, !llvm.loop !369
...
vector.body141:                                   ; preds = %vector.body133, %vector.body141
  ...
  br i1 %32, label %vector.body149, label %vector.body141, !llvm.loop !370
...
vector.body149:                                   ; preds = %vector.body141, %vector.body149
  ...
  br i1 %43, label %for.cond2.preheader.i, label %vector.body149, !llvm.loop !371
...
vector.body157:                                   ; preds = %vector.body157, %for.cond2.preheader.i
  ...
  br i1 %53, label %for.cond.cleanup4.i, label %vector.body157, !llvm.loop !372
...
vector.body167:                                   ; preds = %vector.body167, %for.cond2.preheader.i83
  ...
  br i1 %63, label %for.cond.cleanup4.i85, label %vector.body167, !llvm.loop !373
...
vector.body179:                                   ; preds = %vector.body179, %for.cond2.preheader.i96
  ...
  br i1 %73, label %for.cond.cleanup4.i98, label %vector.body179, !llvm.loop !374
...
vector.body191:                                   ; preds = %for.cond.cleanup4.i98, %vector.body191
  ...
  br i1 %84, label %for.cond.cleanup29, label %vector.body191, !llvm.loop !375
...
vector.body:                                      ; preds = %for.body, %vector.body
  ...
  br i1 %104, label %vector.body125, label %vector.body, !llvm.loop !376
...
if.end.thread:                                    ; preds = %entry
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
  %call221 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.146, i32 noundef %0)
  br label %if.end7

if.end:                                           ; preds = %entry
  %arrayidx = getelementptr inbounds ptr, ptr %argv, i64 1
  %1 = load ptr, ptr %arrayidx, align 8, !tbaa !377
  ...
  %call2 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.146, i32 noundef %conv.i)
  %cmp3.not = icmp eq i32 %argc, 2
  br i1 %cmp3.not, label %if.end7, label %if.then4

if.then4:                                         ; preds = %if.end
  %arrayidx5 = getelementptr inbounds ptr, ptr %argv, i64 2
  %2 = load ptr, ptr %arrayidx5, align 8, !tbaa !377
  %call.i19 = call i64 @strtol(ptr nocapture noundef nonnull %2, ptr noundef null, i32 noundef 10) #16
...
if.end7:                                          ; preds = %if.end.thread, %if.then4, %if.end
  %3 = load ptr, ptr %ip, align 8, !tbaa !377
