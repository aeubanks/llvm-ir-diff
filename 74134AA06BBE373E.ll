...
40:                                               ; preds = %40, %4
  %41 = phi i64 [ 0, %4 ], [ %69, %40 ]
  %42 = phi i64 [ 31998, %4 ], [ %41, %40 ]
  %43 = phi i32 [ 31999, %4 ], [ %70, %40 ]
  ...
  %56 = or i64 %41, 1
  %57 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %56
  %58 = load double, ptr %57, align 8, !tbaa !5
  %59 = and i64 %41, 4294967294
  %60 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %59
  %61 = load double, ptr %60, align 16, !tbaa !5
  %62 = fadd double %58, %61
  %63 = zext i32 %43 to i64
  %64 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %63
  %65 = load double, ptr %64, align 8, !tbaa !5
  %66 = fadd double %62, %65
  %67 = fmul double %66, 3.330000e-01
  %68 = getelementptr inbounds double, ptr @global_data, i64 %56
  store double %67, ptr %68, align 8, !tbaa !5
  %69 = add nuw nsw i64 %41, 2
  %70 = trunc i64 %56 to i32
  %71 = icmp eq i64 %69, 32000
