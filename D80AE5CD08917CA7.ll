...
entry:
  %0 = load volatile i32, ptr @u, align 4, !tbaa !5
  %conv = uitofp i32 %0 to float
  store volatile float %conv, ptr @f1, align 4, !tbaa !9
  store volatile float 0x41E0000020000000, ptr @f2, align 4, !tbaa !9
  %1 = load volatile float, ptr @f1, align 4, !tbaa !9
  %2 = load volatile float, ptr @f2, align 4, !tbaa !9
