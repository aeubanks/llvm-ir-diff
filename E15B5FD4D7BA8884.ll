...
while.cond.preheader:                             ; preds = %list_equal.exit
  ...
  br i1 %cmp.i.not175, label %do.body.i.preheader, label %while.body.preheader
...
while.body.prol.loopexit:                         ; preds = %while.body.prol, %while.body.preheader
  %dec.i174176.unr = phi i32 [ %call1.i.promoted, %while.body.preheader ], [ %dec.i.prol, %while.body.prol ]
  %17 = icmp eq i32 %12, 0
...
while.cond13.preheader:                           ; preds = %while.body, %while.body.prol.loopexit
  ...
  br i1 %lcmp.mod208.not, label %while.body17.prol.loopexit, label %while.body17.prol
...
while.body17.prol.loopexit:                       ; preds = %while.body17.prol, %while.cond13.preheader
  %dec.i132179181.unr = phi i32 [ %call1.i.promoted, %while.cond13.preheader ], [ %dec.i132.prol, %while.body17.prol ]
  %21 = icmp eq i32 %12, 0
  br i1 %21, label %while.cond13.do.body.i.preheader_crit_edge, label %while.body17

while.body:                                       ; preds = %while.body.prol.loopexit, %while.body
  %dec.i174176 = phi i32 [ %dec.i.1, %while.body ], [ %dec.i174176.unr, %while.body.prol.loopexit ]
...
while.body17:                                     ; preds = %while.body17.prol.loopexit, %while.body17
  %dec.i132179181 = phi i32 [ %dec.i132.1, %while.body17 ], [ %dec.i132179181.unr, %while.body17.prol.loopexit ]
  ...
  br i1 %cmp.i127.not.1, label %while.cond13.do.body.i.preheader_crit_edge, label %while.body17, !llvm.loop !20
