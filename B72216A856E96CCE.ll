...
define dso_local i32 @main() local_unnamed_addr #0 {
  ...
  %16 = load double, ptr @A6, align 8, !tbaa !5
  %17 = load double, ptr @A5, align 8, !tbaa !5
  %18 = load double, ptr @A4, align 8, !tbaa !5
  %19 = load double, ptr @A3, align 8, !tbaa !5
  %20 = load double, ptr @A2, align 8, !tbaa !5
  %21 = load double, ptr @A1, align 8, !tbaa !5
  br label %22
...
22:                                               ; preds = %0, %22
  ...
  %29 = tail call double @llvm.fmuladd.f64(double %27, double %28, double %11)
  %30 = tail call double @llvm.fmuladd.f64(double %27, double %29, double %12)
  %31 = tail call double @llvm.fmuladd.f64(double %27, double %30, double %13)
  %32 = tail call double @llvm.fmuladd.f64(double %27, double %31, double %14)
  %33 = tail call double @llvm.fmuladd.f64(double %27, double %32, double %15)
  %34 = fmul double %33, %33
  %35 = fmul double %26, %34
  %36 = tail call double @llvm.fmuladd.f64(double %16, double %27, double %17)
  %37 = tail call double @llvm.fmuladd.f64(double %36, double %27, double %18)
  %38 = tail call double @llvm.fmuladd.f64(double %37, double %27, double %19)
  %39 = tail call double @llvm.fmuladd.f64(double %38, double %27, double %20)
  %40 = tail call double @llvm.fmuladd.f64(double %39, double %27, double %21)
  %41 = tail call double @llvm.fmuladd.f64(double %40, double %27, double %15)
  %42 = tail call double @llvm.fmuladd.f64(double %35, double %41, double %23)
...
45:                                               ; preds = %22
  ...
  %48 = tail call double @llvm.fmuladd.f64(double %16, double %47, double %17)
  %49 = tail call double @llvm.fmuladd.f64(double %48, double %47, double %18)
  %50 = tail call double @llvm.fmuladd.f64(double %49, double %47, double %19)
  %51 = tail call double @llvm.fmuladd.f64(double %50, double %47, double %20)
  %52 = tail call double @llvm.fmuladd.f64(double %51, double %47, double %21)
  %53 = tail call double @llvm.fmuladd.f64(double %52, double %47, double %15)
  %54 = fmul double %46, %53
  %55 = tail call double @llvm.fmuladd.f64(double %9, double %47, double %10)
  %56 = tail call double @llvm.fmuladd.f64(double %47, double %55, double %11)
  %57 = tail call double @llvm.fmuladd.f64(double %47, double %56, double %12)
  %58 = tail call double @llvm.fmuladd.f64(double %47, double %57, double %13)
  %59 = tail call double @llvm.fmuladd.f64(double %47, double %58, double %14)
  %60 = tail call double @llvm.fmuladd.f64(double %47, double %59, double %15)
  %61 = fmul double %54, %60
  %62 = fmul double %60, %61
  %63 = load double, ptr @two, align 8, !tbaa !5
  %64 = tail call double @llvm.fmuladd.f64(double %63, double %42, double %62)
  %65 = fmul double %8, %64
  %66 = fdiv double %65, %63
  store double %66, ptr @sa, align 8, !tbaa !5
  store double 0x3FD2AAAAAAAAAAAB, ptr @sb, align 8, !tbaa !5
  %67 = fadd double %66, 0xBFD2AAAAAAAAAAAB
  store double %67, ptr @sc, align 8, !tbaa !5
  %68 = fmul double %67, 1.000000e-30
  %69 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4, double noundef %68, double noundef 0.000000e+00, double noundef 0.000000e+00)
  ret i32 0
}
