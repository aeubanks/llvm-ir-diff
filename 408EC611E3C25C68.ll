...
while.cond.preheader.i:                           ; preds = %if.end.i
  ...
  %cmp7196.not.i = icmp eq i32 %6, 0
  br i1 %cmp7196.not.i, label %if.end107.i, label %while.body.lr.ph.i
...
while.body.i:                                     ; preds = %if.end99.i, %while.body.lr.ph.i
  %out_ptr.0198.i = phi i32 [ 0, %while.body.lr.ph.i ], [ %out_ptr.4.i, %if.end99.i ]
  %count.0197.i = phi i32 [ 0, %while.body.lr.ph.i ], [ %count.1.i, %if.end99.i ]
...
while.body.i.i.i:                                 ; preds = %if.then.i.i, %if.end101.i.i.i
  ...
  %conv20.i.i.i = zext i16 %27 to i32
  %shr.i.i.i = lshr i32 %conv20.i.i.i, 8
  %idxprom21.i.i.i = zext i32 %shr.i.i.i to i64
  %arrayidx22.i.i.i = getelementptr inbounds %struct.arj_decode_tag, ptr %decode_data.i, i64 0, i32 14, i64 %idxprom21.i.i.i
  %28 = load i16, ptr %arrayidx22.i.i.i, align 2, !tbaa !5
  %cmp24.i.i.i = icmp sgt i16 %28, 18
  br i1 %cmp24.i.i.i, label %do.body.i.i.i, label %if.end47.i.i.i

do.body.i.i.i:                                    ; preds = %while.body.i.i.i, %if.end.i.i.i
  %c.0.i.i.i = phi i16 [ %c.1.i.i.i, %if.end.i.i.i ], [ %28, %while.body.i.i.i ]
  %mask.0.i.i.i = phi i32 [ %conv33.i.i.i, %if.end.i.i.i ], [ 128, %while.body.i.i.i ]
...
if.end47.i.i.i:                                   ; preds = %if.end.i.i.i, %while.body.i.i.i
  %c.2.i.i.i = phi i16 [ %28, %while.body.i.i.i ], [ %c.1.i.i.i, %if.end.i.i.i ]
  ...
  %29 = load i8, ptr %arrayidx49.i.i.i, align 1, !tbaa !20
  %conv50.i.i.i = zext i8 %29 to i32
...
while.body79.preheader.sink.split.i.i.i:          ; preds = %if.else68.i.i.i, %if.then55.i.i.i
  ...
  %30 = load i16, ptr %bit_buf.i.i.i, align 2, !tbaa !48
  %31 = lshr i16 %30, %.sink209.i.i.i
  %call.i178.i.i.i = call fastcc i32 @fill_buf(ptr noundef nonnull %decode_data.i, i32 noundef %.sink207.i.i.i), !range !51
  %narrow.i.i.i = add nuw nsw i16 %31, %.sink206.i.i.i
...
while.body79.preheader.i.i.i:                     ; preds = %while.body79.preheader.sink.split.i.i.i, %if.then55.i.i.i
  ...
  %32 = sext i16 %i.2189.i.i.i to i64
  %33 = add i16 %c.3.i.i.i.fr, -1
  %34 = zext i16 %33 to i64
  %smax = call i64 @llvm.smax.i64(i64 %32, i64 510)
  %35 = sub i64 %smax, %32
  %umin = call i64 @llvm.umin.i64(i64 %34, i64 %35)
...
vector.ph65:                                      ; preds = %while.body79.preheader.i.i.i
  ...
  %n.mod.vf = and i64 %36, 15
  %37 = icmp eq i64 %n.mod.vf, 0
  %38 = select i1 %37, i64 16, i64 %n.mod.vf
...
vector.body69:                                    ; preds = %vector.body69, %vector.ph65
  ...
  %offset.idx = add i64 %index70, %32
  %39 = getelementptr inbounds %struct.arj_decode_tag, ptr %decode_data.i, i64 0, i32 11, i64 %offset.idx
  store <16 x i8> zeroinitializer, ptr %39, align 1, !tbaa !20
  %index.next71 = add nuw i64 %index70, 16
  %40 = icmp eq i64 %index.next71, %n.vec
  br i1 %40, label %while.body79.i.i.i.preheader, label %vector.body69, !llvm.loop !57

while.body79.i.i.i.preheader:                     ; preds = %vector.body69, %while.body79.preheader.i.i.i
  %indvars.iv.i.i.i.ph = phi i64 [ %32, %while.body79.preheader.i.i.i ], [ %ind.end, %vector.body69 ]
...
if.end94.i.i.i:                                   ; preds = %if.else89.i.i.i
  %41 = trunc i16 %c.2.i.i.i to i8
  %conv96.i.i.i = add nsw i8 %41, -2
...
if.end101.loopexit.i.i.i:                         ; preds = %if.end84.i.i.i
  %42 = trunc i64 %indvars.iv.next.i.i.i to i16
  br label %if.end101.i.i.i

if.end101.i.i.i:                                  ; preds = %if.end101.loopexit.i.i.i, %if.end94.i.i.i
  %i.4.i.i.i = phi i16 [ %inc98.i.i.i, %if.end94.i.i.i ], [ %42, %if.end101.loopexit.i.i.i ]
...
if.end.i.i:                                       ; preds = %read_c_len.exit.i.i, %while.body.i
  %43 = phi i16 [ %.pre.i.i, %read_c_len.exit.i.i ], [ %7, %while.body.i ]
  %dec.i.i = add i16 %43, -1
  store i16 %dec.i.i, ptr %blocksize.i.i, align 8, !tbaa !47
  %44 = load i16, ptr %bit_buf.i.i.i, align 2, !tbaa !48
  %conv5.i.i = zext i16 %44 to i32
  %shr.i.i = lshr i32 %conv5.i.i, 4
  ...
  %45 = load i16, ptr %arrayidx.i.i, align 2, !tbaa !5
  %cmp7.i.i = icmp ugt i16 %45, 509
  br i1 %cmp7.i.i, label %do.body.i.i, label %decode_c.exit.i

do.body.i.i:                                      ; preds = %if.end.i.i, %if.end14.i.i
  %j.0.i.i = phi i16 [ %j.1.i.i, %if.end14.i.i ], [ %45, %if.end.i.i ]
  %mask.0.i.i = phi i32 [ %conv17.i.i, %if.end14.i.i ], [ 8, %if.end.i.i ]
...
if.end14.i.i:                                     ; preds = %do.body.i.i
  %and.i.i = and i32 %mask.0.i.i, %conv5.i.i
...
decode_c.exit.i:                                  ; preds = %if.end14.i.i, %if.end.i.i
  %j.2.i.i = phi i16 [ %45, %if.end.i.i ], [ %j.1.i.i, %if.end14.i.i ]
  ...
  %46 = load i8, ptr %arrayidx32.i.i, align 1, !tbaa !20
  %conv33.i.i = zext i8 %46 to i32
...
if.then11.i:                                      ; preds = %decode_c.exit.i, %decode_c.exit.thread.i
  %retval.0.i177.i = phi i16 [ 0, %decode_c.exit.thread.i ], [ %j.2.i.i, %decode_c.exit.i ]
  %conv12.i = trunc i16 %retval.0.i177.i to i8
  %47 = load ptr, ptr %text.i, align 8, !tbaa !43
  %idxprom.i = zext i32 %out_ptr.0198.i to i64
  %arrayidx.i = getelementptr inbounds i8, ptr %47, i64 %idxprom.i
  store i8 %conv12.i, ptr %arrayidx.i, align 1, !tbaa !20
  %inc.i = add i32 %count.0197.i, 1
  %inc14.i = add i32 %out_ptr.0198.i, 1
  %cmp15.i = icmp ugt i32 %inc14.i, 26623
  br i1 %cmp15.i, label %if.then17.i, label %if.end99.i

if.then17.i:                                      ; preds = %if.then11.i
  %48 = load i32, ptr %ofd, align 4, !tbaa !41
  %49 = load ptr, ptr %text.i, align 8, !tbaa !43
  %call.i.i = call i32 @cli_writen(i32 noundef %48, ptr noundef %49, i32 noundef 26624) #11
  br label %if.end99.i

if.else.i:                                        ; preds = %decode_c.exit.i
  %sub.i = add nsw i16 %j.2.i.i, -253
  %conv23.i = zext i16 %sub.i to i32
  %add.i = add i32 %count.0197.i, %conv23.i
  %50 = load i16, ptr %bit_buf.i.i.i, align 2, !tbaa !48
  %conv.i.i = zext i16 %50 to i32
  %shr.i150.i = lshr i32 %conv.i.i, 8
  %idxprom.i151.i = zext i32 %shr.i150.i to i64
  %arrayidx.i152.i = getelementptr inbounds %struct.arj_decode_tag, ptr %decode_data.i, i64 0, i32 14, i64 %idxprom.i151.i
  %51 = load i16, ptr %arrayidx.i152.i, align 2, !tbaa !5
  %cmp.i153.i = icmp ugt i16 %51, 16
  br i1 %cmp.i153.i, label %do.body.i156.i, label %if.end22.i.i

do.body.i156.i:                                   ; preds = %if.else.i, %if.end.i161.i
  %j.0.i154.i = phi i16 [ %j.1.i160.i, %if.end.i161.i ], [ %51, %if.else.i ]
  %mask.0.i155.i = phi i32 [ %conv9.i.i, %if.end.i161.i ], [ 128, %if.else.i ]
...
if.end.i161.i:                                    ; preds = %do.body.i156.i
  %and.i157.i = and i32 %mask.0.i155.i, %conv.i.i
...
if.end22.i.i:                                     ; preds = %if.end.i161.i, %if.else.i
  %j.2.i162.i = phi i16 [ %51, %if.else.i ], [ %j.1.i160.i, %if.end.i161.i ]
  ...
  %52 = load i8, ptr %arrayidx24.i.i, align 1, !tbaa !20
  %conv25.i.i = zext i8 %52 to i32
...
if.then29.i.i:                                    ; preds = %if.end22.i.i
  ...
  %53 = load i16, ptr %bit_buf.i.i.i, align 2, !tbaa !48
  %conv.i.i.i = zext i16 %53 to i32
  %sub.i.i.i = sub nuw nsw i32 16, %conv30.i.i
  %shr.i.i165.i = lshr i32 %conv.i.i.i, %sub.i.i.i
  %call.i.i166.i = call fastcc i32 @fill_buf(ptr noundef nonnull %decode_data.i, i32 noundef %conv30.i.i), !range !51
  %add.i.i = add nuw nsw i32 %shr.i.i165.i, %shl.i.i
  br label %decode_p.exit.i

decode_p.exit.i:                                  ; preds = %if.then29.i.i, %if.end22.i.i, %if.then6.i.i
  %retval.0.i167.i = phi i32 [ 0, %if.then6.i.i ], [ %add.i.i, %if.then29.i.i ], [ 0, %if.end22.i.i ]
  %54 = xor i32 %retval.0.i167.i, -1
  %sub27.i = add i32 %out_ptr.0198.i, %54
  ...
  %55 = trunc i32 %i.0.in.i to i16
  %or.cond.i = icmp ugt i16 %55, 26623
...
if.end44.i:                                       ; preds = %decode_p.exit.i
  ...
  %cmp46.i = icmp ugt i32 %out_ptr.0198.i, %conv37.i
  %cmp48.i = icmp ult i32 %out_ptr.0198.i, 26367
  %or.cond115.i = and i1 %cmp48.i, %cmp46.i
  %dec186.i = add nsw i16 %j.2.i.i, -254
  br i1 %or.cond115.i, label %while.body61.preheader.i, label %while.body76.i

while.body61.preheader.i:                         ; preds = %if.end44.i
  %56 = zext i32 %conv37.i to i64
  %57 = zext i32 %out_ptr.0198.i to i64
  br label %while.body61.i

while.body61.i:                                   ; preds = %while.body61.i, %while.body61.preheader.i
  %indvars.iv202.i = phi i64 [ %57, %while.body61.preheader.i ], [ %indvars.iv.next203.i, %while.body61.i ]
  %indvars.iv.i = phi i64 [ %56, %while.body61.preheader.i ], [ %indvars.iv.next.i, %while.body61.i ]
  %dec194.i = phi i16 [ %dec186.i, %while.body61.preheader.i ], [ %dec.i, %while.body61.i ]
  %58 = load ptr, ptr %text.i, align 8, !tbaa !43
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1
  %arrayidx65.i = getelementptr inbounds i8, ptr %58, i64 %indvars.iv.i
  %59 = load i8, ptr %arrayidx65.i, align 1, !tbaa !20
  %indvars.iv.next203.i = add nuw nsw i64 %indvars.iv202.i, 1
  %arrayidx69.i = getelementptr inbounds i8, ptr %58, i64 %indvars.iv202.i
  store i8 %59, ptr %arrayidx69.i, align 1, !tbaa !20
  %dec.i = add i16 %dec194.i, -1
  %cmp53.i = icmp sgt i16 %dec.i, -1
  %cmp57.i = icmp ult i64 %indvars.iv.i, 26623
  %or.cond116.i = and i1 %cmp57.i, %cmp53.i
  %cmp59.i = icmp ult i64 %indvars.iv202.i, 26623
...
while.body76.i:                                   ; preds = %if.end44.i, %if.end90.i
  %dec72185.i = phi i16 [ %dec72.i, %if.end90.i ], [ %dec186.i, %if.end44.i ]
  %i.2184.i = phi i16 [ %spec.store.select.i, %if.end90.i ], [ %55, %if.end44.i ]
  %out_ptr.2183.i = phi i32 [ %out_ptr.3.i, %if.end90.i ], [ %out_ptr.0198.i, %if.end44.i ]
  %60 = load ptr, ptr %text.i, align 8, !tbaa !43
  %idxprom78.i = sext i16 %i.2184.i to i64
  %arrayidx79.i = getelementptr inbounds i8, ptr %60, i64 %idxprom78.i
  %61 = load i8, ptr %arrayidx79.i, align 1, !tbaa !20
  %idxprom81.i = zext i32 %out_ptr.2183.i to i64
  %arrayidx82.i = getelementptr inbounds i8, ptr %60, i64 %idxprom81.i
  store i8 %61, ptr %arrayidx82.i, align 1, !tbaa !20
  %inc83.i = add i32 %out_ptr.2183.i, 1
  %cmp84.i = icmp ugt i32 %inc83.i, 26623
  br i1 %cmp84.i, label %if.then86.i, label %if.end90.i

if.then86.i:                                      ; preds = %while.body76.i
  %62 = load i32, ptr %ofd, align 4, !tbaa !41
  %63 = load ptr, ptr %text.i, align 8, !tbaa !43
  %call.i168.i = call i32 @cli_writen(i32 noundef %62, ptr noundef %63, i32 noundef 26624) #11
  br label %if.end90.i

if.end90.i:                                       ; preds = %if.then86.i, %while.body76.i
  %out_ptr.3.i = phi i32 [ 0, %if.then86.i ], [ %inc83.i, %while.body76.i ]
  %inc91.i = add i16 %i.2184.i, 1
  %cmp93.i = icmp sgt i16 %inc91.i, 26623
  %spec.store.select.i = select i1 %cmp93.i, i16 0, i16 %inc91.i
  %dec72.i = add i16 %dec72185.i, -1
...
if.end99.loopexit.i:                              ; preds = %while.body61.i
  %64 = trunc i64 %indvars.iv.next203.i to i32
  br label %if.end99.i
...
if.end99.i:                                       ; preds = %if.end90.i, %if.end99.loopexit.i, %if.then17.i, %if.then11.i
  ...
  %out_ptr.4.i = phi i32 [ 0, %if.then17.i ], [ %inc14.i, %if.then11.i ], [ %64, %if.end99.loopexit.i ], [ %out_ptr.3.i, %if.end90.i ]
  %65 = load i32, ptr %orig_size.i, align 4, !tbaa !52
  %cmp7.i = icmp ult i32 %count.1.i, %65
  br i1 %cmp7.i, label %while.body.i, label %while.end100.i, !llvm.loop !64

while.end100.i:                                   ; preds = %if.end99.i, %if.then43.i
  %out_ptr.0180.i = phi i32 [ %out_ptr.0198.i, %if.then43.i ], [ %out_ptr.4.i, %if.end99.i ]
  %cmp101.not.i = icmp eq i32 %out_ptr.0180.i, 0
  br i1 %cmp101.not.i, label %if.end107.i, label %if.then103.i

if.then103.i:                                     ; preds = %while.end100.i
  %66 = load i32, ptr %ofd, align 4, !tbaa !41
  %67 = load ptr, ptr %text.i, align 8, !tbaa !43
  %call.i171.i = call i32 @cli_writen(i32 noundef %66, ptr noundef %67, i32 noundef %out_ptr.0180.i) #11
  br label %if.end107.i

if.end107.i:                                      ; preds = %if.then103.i, %while.end100.i, %while.cond.preheader.i
  %68 = load ptr, ptr %text.i, align 8, !tbaa !43
...
if.end6:                                          ; preds = %if.end
  ...
  %cmp7246.not = icmp eq i32 %1, 0
  br i1 %cmp7246.not, label %if.end107, label %while.body.lr.ph
...
while.body:                                       ; preds = %while.body.lr.ph, %if.end99
  %out_ptr.0248 = phi i32 [ 0, %while.body.lr.ph ], [ %out_ptr.3, %if.end99 ]
  %count.0247 = phi i32 [ 0, %while.body.lr.ph ], [ %count.1, %if.end99 ]
...
if.then.2.i:                                      ; preds = %if.end26.1.i
  ...
  %.pre131.i = load i16, ptr %getbuf, align 2, !tbaa !66
  br label %if.end.2.i

if.end.2.i:                                       ; preds = %if.then.2.i, %if.end26.1.i
  %12 = phi i16 [ 16, %if.then.2.i ], [ %dec.1.i, %if.end26.1.i ]
  %13 = phi i16 [ %.pre131.i, %if.then.2.i ], [ %shl.1.i, %if.end26.1.i ]
...
if.end.3.i:                                       ; preds = %if.then.3.i, %if.end26.2.i
  ...
  %16 = phi i16 [ %.pre132.i, %if.then.3.i ], [ %shl.2.i, %if.end26.2.i ]
...
if.end.4.i:                                       ; preds = %if.then.4.i, %if.end26.3.i
  ...
  %19 = phi i16 [ %.pre133.i, %if.then.4.i ], [ %shl.3.i, %if.end26.3.i ]
...
if.end.5.i:                                       ; preds = %if.then.5.i, %if.end26.4.i
  ...
  %22 = phi i16 [ %.pre134.i, %if.then.5.i ], [ %shl.4.i, %if.end26.4.i ]
...
if.end.6.i:                                       ; preds = %if.then.6.i, %if.end26.5.i
  ...
  %25 = phi i16 [ %.pre135.i, %if.then.6.i ], [ %shl.5.i, %if.end26.5.i ]
...
for.end.thread.i:                                 ; preds = %if.end.6.i, %if.end.5.i, %if.end.4.i, %if.end.3.i, %if.end.2.i, %if.end.1.i
  ...
  %.ph137.i = phi i16 [ %dec.6.i, %if.end.6.i ], [ %dec.5.i, %if.end.5.i ], [ %dec.4.i, %if.end.4.i ], [ %dec.3.i, %if.end.3.i ], [ %dec.2.i, %if.end.2.i ], [ %dec.1.i, %if.end.1.i ]
  %plus.0126.lcssa.ph.i = phi i32 [ 63, %if.end.6.i ], [ 31, %if.end.5.i ], [ 15, %if.end.4.i ], [ 7, %if.end.3.i ], [ 3, %if.end.2.i ], [ 1, %if.end.1.i ]
  %width.0125.lcssa.ph.i = phi i16 [ 6, %if.end.6.i ], [ 5, %if.end.5.i ], [ 4, %if.end.4.i ], [ 3, %if.end.3.i ], [ 2, %if.end.2.i ], [ 1, %if.end.1.i ]
  br label %if.then36.i

if.then36.i:                                      ; preds = %for.end.thread.i, %if.end.6.i
  %26 = phi i16 [ %shl.6.i, %if.end.6.i ], [ %.ph.i, %for.end.thread.i ]
  %27 = phi i16 [ %dec.6.i, %if.end.6.i ], [ %.ph137.i, %for.end.thread.i ]
  %width.0120.i = phi i16 [ 7, %if.end.6.i ], [ %width.0125.lcssa.ph.i, %for.end.thread.i ]
  %plus.0117.i = phi i32 [ 127, %if.end.6.i ], [ %plus.0126.lcssa.ph.i, %for.end.thread.i ]
  %conv115.i = zext i16 %width.0120.i to i32
  %cmp40.i = icmp ult i16 %27, %width.0120.i
...
decode_len.exit:                                  ; preds = %if.then36.i, %if.then42.i
  ...
  %31 = phi i16 [ %.pre136.i, %if.then42.i ], [ %26, %if.then36.i ]
  %conv59.i = zext i16 %31 to i32
  %sub61.i = sub nuw nsw i32 16, %conv115.i
  %shr62.i = lshr i32 %conv59.i, %sub61.i
  %shl67.i = shl nuw nsw i32 %conv59.i, %conv115.i
  %conv68.i = trunc i32 %shl67.i to i16
  %sub72.i = sub nsw i16 %30, %width.0120.i
  store i16 %sub72.i, ptr %getlen, align 8, !tbaa !67
  %32 = add nuw nsw i32 %shr62.i, %plus.0117.i
  %33 = trunc i32 %32 to i16
  %conv50 = add nuw nsw i32 %32, 2
  %add52 = add i32 %count.0247, %conv50
  %cmp3.i152 = icmp slt i16 %sub72.i, 1
  br i1 %cmp3.i152, label %if.then.i159, label %if.end.i163
...
if.then.i159:                                     ; preds = %decode_len.exit
  %conv2.i153 = sext i16 %sub72.i to i32
  %42 = load i16, ptr %bit_buf.i, align 2, !tbaa !48
  %conv5.i154 = zext i16 %42 to i32
  %shr.i155 = lshr i32 %conv5.i154, %conv2.i153
  %conv9.i156252 = or i32 %shl67.i, %shr.i155
  %conv9.i156 = trunc i32 %conv9.i156252 to i16
  store i16 %conv9.i156, ptr %getbuf, align 2, !tbaa !66
  %sub.i157 = sub nsw i32 16, %conv2.i153
  %call.i158 = call fastcc i32 @fill_buf(ptr noundef nonnull %decode_data, i32 noundef %sub.i157), !range !51
  %.pre = load i16, ptr %getbuf, align 2, !tbaa !66
  br label %if.end.i163

if.end.i163:                                      ; preds = %if.then.i159, %decode_len.exit
  %43 = phi i16 [ %.pre, %if.then.i159 ], [ %conv68.i, %decode_len.exit ]
  %44 = phi i16 [ 16, %if.then.i159 ], [ %sub72.i, %decode_len.exit ]
  %shl.i160 = shl i16 %43, 1
  %dec.i161 = add nsw i16 %44, -1
  store i16 %dec.i161, ptr %getlen, align 8, !tbaa !67
  %cmp23.i162 = icmp sgt i16 %43, -1
  br i1 %cmp23.i162, label %for.end.i, label %if.end26.i165

if.end26.i165:                                    ; preds = %if.end.i163
  %cmp3.1.i164 = icmp eq i16 %dec.i161, 0
  br i1 %cmp3.1.i164, label %if.then.1.i173, label %if.end.1.i177

if.then.1.i173:                                   ; preds = %if.end26.i165
  %45 = load i16, ptr %bit_buf.i, align 2, !tbaa !48
  %conv9.1.i169 = or i16 %shl.i160, %45
  store i16 %conv9.1.i169, ptr %getbuf, align 2, !tbaa !66
  %call.1.i171 = call fastcc i32 @fill_buf(ptr noundef nonnull %decode_data, i32 noundef 16), !range !51
  %.pre.i172 = load i16, ptr %getbuf, align 2, !tbaa !66
  br label %if.end.1.i177

if.end.1.i177:                                    ; preds = %if.then.1.i173, %if.end26.i165
  %46 = phi i16 [ 16, %if.then.1.i173 ], [ %dec.i161, %if.end26.i165 ]
  %47 = phi i16 [ %.pre.i172, %if.then.1.i173 ], [ %shl.i160, %if.end26.i165 ]
  %shl.1.i174 = shl i16 %47, 1
  %dec.1.i175 = add nsw i16 %46, -1
  store i16 %dec.1.i175, ptr %getlen, align 8, !tbaa !67
  %cmp23.1.i176 = icmp sgt i16 %47, -1
  br i1 %cmp23.1.i176, label %for.end.i, label %if.end26.1.i179

if.end26.1.i179:                                  ; preds = %if.end.1.i177
  %cmp3.2.i178 = icmp eq i16 %dec.1.i175, 0
  br i1 %cmp3.2.i178, label %if.then.2.i187, label %if.end.2.i191

if.then.2.i187:                                   ; preds = %if.end26.1.i179
  %48 = load i16, ptr %bit_buf.i, align 2, !tbaa !48
  %conv9.2.i183 = or i16 %shl.1.i174, %48
  store i16 %conv9.2.i183, ptr %getbuf, align 2, !tbaa !66
  %call.2.i185 = call fastcc i32 @fill_buf(ptr noundef nonnull %decode_data, i32 noundef 16), !range !51
  %.pre131.i186 = load i16, ptr %getbuf, align 2, !tbaa !66
  br label %if.end.2.i191

if.end.2.i191:                                    ; preds = %if.then.2.i187, %if.end26.1.i179
  %49 = phi i16 [ 16, %if.then.2.i187 ], [ %dec.1.i175, %if.end26.1.i179 ]
  %50 = phi i16 [ %.pre131.i186, %if.then.2.i187 ], [ %shl.1.i174, %if.end26.1.i179 ]
  %shl.2.i188 = shl i16 %50, 1
  %dec.2.i189 = add nsw i16 %49, -1
  store i16 %dec.2.i189, ptr %getlen, align 8, !tbaa !67
  %cmp23.2.i190 = icmp sgt i16 %50, -1
  br i1 %cmp23.2.i190, label %for.end.i, label %if.end26.2.i193

if.end26.2.i193:                                  ; preds = %if.end.2.i191
  %cmp3.3.i192 = icmp eq i16 %dec.2.i189, 0
  br i1 %cmp3.3.i192, label %if.then.3.i201, label %if.end.3.i205

if.then.3.i201:                                   ; preds = %if.end26.2.i193
  %51 = load i16, ptr %bit_buf.i, align 2, !tbaa !48
  %conv9.3.i197 = or i16 %shl.2.i188, %51
  store i16 %conv9.3.i197, ptr %getbuf, align 2, !tbaa !66
  %call.3.i199 = call fastcc i32 @fill_buf(ptr noundef nonnull %decode_data, i32 noundef 16), !range !51
  %.pre132.i200 = load i16, ptr %getbuf, align 2, !tbaa !66
  br label %if.end.3.i205

if.end.3.i205:                                    ; preds = %if.then.3.i201, %if.end26.2.i193
  %52 = phi i16 [ 16, %if.then.3.i201 ], [ %dec.2.i189, %if.end26.2.i193 ]
  %53 = phi i16 [ %.pre132.i200, %if.then.3.i201 ], [ %shl.2.i188, %if.end26.2.i193 ]
  %shl.3.i202 = shl i16 %53, 1
  %dec.3.i203 = add nsw i16 %52, -1
  store i16 %dec.3.i203, ptr %getlen, align 8, !tbaa !67
  %cmp23.3.i204 = icmp sgt i16 %53, -1
  br i1 %cmp23.3.i204, label %for.end.i, label %if.then36.i209

for.end.i:                                        ; preds = %if.end.3.i205, %if.end.2.i191, %if.end.1.i177, %if.end.i163
  %54 = phi i16 [ %shl.i160, %if.end.i163 ], [ %shl.1.i174, %if.end.1.i177 ], [ %shl.2.i188, %if.end.2.i191 ], [ %shl.3.i202, %if.end.3.i205 ]
  %55 = phi i16 [ %dec.i161, %if.end.i163 ], [ %dec.1.i175, %if.end.1.i177 ], [ %dec.2.i189, %if.end.2.i191 ], [ %dec.3.i203, %if.end.3.i205 ]
  %plus.0126.lcssa.i = phi i32 [ 0, %if.end.i163 ], [ 512, %if.end.1.i177 ], [ 1536, %if.end.2.i191 ], [ 3584, %if.end.3.i205 ]
  %width.0125.lcssa.i = phi i16 [ 9, %if.end.i163 ], [ 10, %if.end.1.i177 ], [ 11, %if.end.2.i191 ], [ 12, %if.end.3.i205 ]
  br label %if.then36.i209

if.then36.i209:                                   ; preds = %for.end.i, %if.end.3.i205
  %56 = phi i16 [ %54, %for.end.i ], [ %shl.3.i202, %if.end.3.i205 ]
  %57 = phi i16 [ %55, %for.end.i ], [ %dec.3.i203, %if.end.3.i205 ]
  %width.0120.i206 = phi i16 [ %width.0125.lcssa.i, %for.end.i ], [ 13, %if.end.3.i205 ]
  %plus.0117.i207 = phi i32 [ %plus.0126.lcssa.i, %for.end.i ], [ 7680, %if.end.3.i205 ]
  %cmp40.i208 = icmp ult i16 %57, %width.0120.i206
  br i1 %cmp40.i208, label %if.then42.i217, label %decode_ptr.exit

if.then42.i217:                                   ; preds = %if.then36.i209
  %conv38.i210 = zext i16 %57 to i32
  %58 = load i16, ptr %bit_buf.i, align 2, !tbaa !48
  %conv44.i211 = zext i16 %58 to i32
  %shr47.i212 = lshr i32 %conv44.i211, %conv38.i210
  %59 = trunc i32 %shr47.i212 to i16
  %conv51.i213 = or i16 %56, %59
  store i16 %conv51.i213, ptr %getbuf, align 2, !tbaa !66
  %sub54.i214 = sub nsw i32 16, %conv38.i210
  %call55.i215 = call fastcc i32 @fill_buf(ptr noundef nonnull %decode_data, i32 noundef %sub54.i214), !range !51
  %.pre133.i216 = load i16, ptr %getbuf, align 2, !tbaa !66
  br label %decode_ptr.exit

decode_ptr.exit:                                  ; preds = %if.then36.i209, %if.then42.i217
  %60 = phi i16 [ 16, %if.then42.i217 ], [ %57, %if.then36.i209 ]
  %61 = phi i16 [ %.pre133.i216, %if.then42.i217 ], [ %56, %if.then36.i209 ]
  %conv115.i218 = zext i16 %width.0120.i206 to i32
  %conv59.i219 = zext i16 %61 to i32
  %shl67.i220 = shl nuw nsw i32 %conv59.i219, %conv115.i218
  %conv68.i221 = trunc i32 %shl67.i220 to i16
  store i16 %conv68.i221, ptr %getbuf, align 2, !tbaa !66
  %sub72.i222 = sub nsw i16 %60, %width.0120.i206
  store i16 %sub72.i222, ptr %getlen, align 8, !tbaa !67
  %sub61.i223 = sub nuw nsw i32 16, %conv115.i218
  %shr62.i224 = lshr i32 %conv59.i219, %sub61.i223
  %conv78.i225 = add nuw nsw i32 %shr62.i224, %plus.0117.i207
  %62 = xor i32 %conv78.i225, -1
  %sub56 = add nsw i32 %out_ptr.0248, %62
  %sext233.mask = and i32 %sub56, 32768
  %cmp59.not = icmp eq i32 %sext233.mask, 0
  %add63 = add nsw i32 %sub56, 26624
  %i.0.in = select i1 %cmp59.not, i32 %sub56, i32 %add63
  %63 = trunc i32 %i.0.in to i16
  %or.cond = icmp ugt i16 %63, 26623
  br i1 %or.cond, label %if.then72, label %while.body78.preheader

while.body78.preheader:                           ; preds = %decode_ptr.exit
  %dec241 = add nuw nsw i16 %33, 1
...
while.body78:                                     ; preds = %while.body78.preheader, %if.end92
  %dec245 = phi i16 [ %dec, %if.end92 ], [ %dec241, %while.body78.preheader ]
  %i.1244 = phi i16 [ %spec.store.select, %if.end92 ], [ %63, %while.body78.preheader ]
  %out_ptr.1243 = phi i32 [ %out_ptr.2, %if.end92 ], [ %out_ptr.0248, %while.body78.preheader ]
  %64 = load ptr, ptr %text, align 8, !tbaa !43
  %idxprom80 = sext i16 %i.1244 to i64
  %arrayidx81 = getelementptr inbounds i8, ptr %64, i64 %idxprom80
  %65 = load i8, ptr %arrayidx81, align 1, !tbaa !20
  %idxprom83 = zext i32 %out_ptr.1243 to i64
  %arrayidx84 = getelementptr inbounds i8, ptr %64, i64 %idxprom83
  store i8 %65, ptr %arrayidx84, align 1, !tbaa !20
  %inc85 = add i32 %out_ptr.1243, 1
  %cmp86 = icmp ugt i32 %inc85, 26623
  br i1 %cmp86, label %if.then88, label %if.end92

if.then88:                                        ; preds = %while.body78
  %66 = load i32, ptr %ofd89, align 4, !tbaa !41
  %67 = load ptr, ptr %text, align 8, !tbaa !43
  %call.i226 = call i32 @cli_writen(i32 noundef %66, ptr noundef %67, i32 noundef 26624) #11
  br label %if.end92

if.end92:                                         ; preds = %if.then88, %while.body78
  %out_ptr.2 = phi i32 [ 0, %if.then88 ], [ %inc85, %while.body78 ]
  %inc93 = add i16 %i.1244, 1
  %cmp95 = icmp sgt i16 %inc93, 26623
  %spec.store.select = select i1 %cmp95, i16 0, i16 %inc93
  %dec = add i16 %dec245, -1
  %cmp76 = icmp sgt i16 %dec245, 0
...
if.end99:                                         ; preds = %if.end92, %if.end27, %if.then44
  ...
  %68 = load i32, ptr %orig_size, align 4, !tbaa !52
  %cmp7 = icmp ult i32 %count.1, %68
  br i1 %cmp7, label %while.body, label %while.end100, !llvm.loop !69

while.end100:                                     ; preds = %if.end99, %if.then72
  %out_ptr.0240 = phi i32 [ %out_ptr.0248, %if.then72 ], [ %out_ptr.3, %if.end99 ]
  %cmp101.not = icmp eq i32 %out_ptr.0240, 0
...
if.then103:                                       ; preds = %while.end100
  ...
  %69 = load i32, ptr %ofd104, align 4, !tbaa !41
  %70 = load ptr, ptr %text, align 8, !tbaa !43
  %call.i229 = call i32 @cli_writen(i32 noundef %69, ptr noundef %70, i32 noundef %out_ptr.0240) #11
  br label %if.end107

if.end107:                                        ; preds = %if.end6, %if.then103, %while.end100
  %71 = load ptr, ptr %text, align 8, !tbaa !43
...
while.cond63.preheader:                           ; preds = %if.end61
  %cmp64141 = icmp slt i32 %i.4, 19
  br i1 %cmp64141, label %while.body70.preheader, label %while.end75
...
if.end.thread:                                    ; preds = %while.body, %if.end
  %c.1166 = phi i16 [ %inc32, %if.end ], [ %shr, %while.body ]
...
if.end.thread167:                                 ; preds = %while.cond24.preheader, %if.end, %if.end.thread
  ...
  %42 = phi i32 [ 3, %if.end.thread ], [ %sub, %if.end ], [ 4, %while.cond24.preheader ]
  %call37 = tail call fastcc i32 @fill_buf(ptr noundef %decode_data, i32 noundef %42), !range !51
...
if.then45:                                        ; preds = %if.end.thread167
  %43 = load i16, ptr %bit_buf.i, align 2, !tbaa !48
  %call.i128 = tail call fastcc i32 @fill_buf(ptr noundef nonnull %decode_data, i32 noundef 2), !range !51
  %cmp49134 = icmp ugt i16 %43, 16383
  %cmp52135 = icmp slt i32 %i.2139, 18
  %44 = and i1 %cmp49134, %cmp52135
  br i1 %44, label %while.body55.preheader, label %if.end61

while.body55.preheader:                           ; preds = %if.then45
  %45 = lshr i16 %43, 14
  %scevgep145 = getelementptr i8, ptr %scevgep, i64 %idxprom41
  %46 = add nsw i16 %45, -2
  %smin = tail call i16 @llvm.smin.i16(i16 %46, i16 -1)
  %47 = sub nsw i16 %46, %smin
  %48 = zext i16 %47 to i64
  %49 = sub i32 17, %i.2139
  %50 = zext i32 %49 to i64
  %umin = tail call i64 @llvm.umin.i64(i64 %48, i64 %50)
  %51 = add nuw nsw i64 %umin, 1
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(1) %scevgep145, i8 0, i64 %51, i1 false), !tbaa !20
  %indvars.iv.next = add i32 %i.2139, 2
  %cmp49 = icmp slt i16 %43, 0
  %cmp52 = icmp slt i32 %i.2139, 17
  %52 = and i1 %cmp49, %cmp52
  br i1 %52, label %while.body55.1, label %if.end61, !llvm.loop !75
...
if.end61:                                         ; preds = %while.body55.1, %while.body55.preheader, %if.then45, %if.end.thread167
  ...
  %55 = icmp slt i32 %i.4, %invariant.smin
  br i1 %55, label %while.body, label %while.cond63.preheader, !llvm.loop !76
