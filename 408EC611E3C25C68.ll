...
if.end88.for.end98.loopexit_crit_edge.i:          ; preds = %if.end88.i
  %22 = trunc i64 %indvars.iv28 to i16
...
if.end92.for.end102.loopexit_crit_edge.i:         ; preds = %if.end92.i
  %25 = trunc i64 %indvars.iv31 to i16
...
vector.body149:                                   ; preds = %vector.body149, %vector.ph145
  ...
  br i1 %42, label %while.body79.i.i.i.preheader, label %vector.body149, !llvm.loop !58
...
if.end.i161.i:                                    ; preds = %do.body.i156.i
  ...
  br i1 %cmp20.i.i, label %do.body.i156.i, label %if.end22.i.i, !llvm.loop !62
...
if.end22.i.i:                                     ; preds = %if.end.i161.i, %if.else.i
  ...
  %call.i163.i = call fastcc i32 @fill_buf(ptr noundef nonnull %decode_data.i, i32 noundef %conv25.i.i), !range !52
...
if.then29.i.i:                                    ; preds = %if.end22.i.i
  ...
  %call.i.i165.i = call fastcc i32 @fill_buf(ptr noundef nonnull %decode_data.i, i32 noundef %conv30.i.i), !range !52
...
if.end99.i:                                       ; preds = %if.end90.i, %if.end99.loopexit.i, %if.then17.i, %if.then11.i
  ...
  br i1 %cmp7.i, label %while.body.i60, label %while.end100.i, !llvm.loop !65
...
if.end.i70:                                       ; preds = %sw.bb31
  ...
  %call.i.i68 = call fastcc i32 @fill_buf(ptr noundef nonnull %decode_data.i63, i32 noundef 16), !range !52
...
if.end6.i:                                        ; preds = %if.end.i70
  ...
  %75 = load i32, ptr %orig_size.i71, align 4, !tbaa !53
...
if.end.i.i78:                                     ; preds = %while.body.i73
  %77 = load i16, ptr %getbuf.i, align 2, !tbaa !66
...
if.end.i.i78.thread:                              ; preds = %while.body.i73
  ...
  %79 = load i16, ptr %getbuf.i, align 2, !tbaa !66
  %80 = trunc i32 %shr.i.i to i16
  %conv9.i.i74 = or i16 %79, %80
  store i16 %conv9.i.i74, ptr %getbuf.i, align 2, !tbaa !66
  ...
  %81 = load i16, ptr %getbuf.i, align 2, !tbaa !66
...
if.then.1.i.i:                                    ; preds = %if.end26.i.i
  ...
  %call.1.i.i = call fastcc i32 @fill_buf(ptr noundef nonnull %decode_data.i63, i32 noundef 16), !range !52
  %.pre.i.i79 = load i16, ptr %getbuf.i, align 2, !tbaa !66
...
if.then.3.i.i:                                    ; preds = %if.end26.2.i.i
  ...
  %call.3.i.i = call fastcc i32 @fill_buf(ptr noundef nonnull %decode_data.i63, i32 noundef 16), !range !52
...
if.then.4.i.i:                                    ; preds = %if.end26.3.i.i
  ...
  %call.4.i.i = call fastcc i32 @fill_buf(ptr noundef nonnull %decode_data.i63, i32 noundef 16), !range !52
...
if.then.5.i.i:                                    ; preds = %if.end26.4.i.i
  ...
  %call.5.i.i = call fastcc i32 @fill_buf(ptr noundef nonnull %decode_data.i63, i32 noundef 16), !range !52
...
if.then.6.i.i:                                    ; preds = %if.end26.5.i.i
  ...
  %call.6.i.i = call fastcc i32 @fill_buf(ptr noundef nonnull %decode_data.i63, i32 noundef 16), !range !52
...
if.then16.i:                                      ; preds = %if.then11.i81
  ...
  %call25.i = call fastcc i32 @fill_buf(ptr noundef nonnull %decode_data.i63, i32 noundef %sub.i82), !range !52
  %.pre250.i = load i16, ptr %getbuf.i, align 2, !tbaa !66
  br label %if.end27.i
...
if.then.i162.i:                                   ; preds = %decode_len.exit.i
  ...
  store i16 %conv9.i158.i, ptr %getbuf.i, align 2, !tbaa !66
  %conv11.i159.i = sext i16 %sub72.i.i to i32
  %sub.i160.i = sub nsw i32 16, %conv11.i159.i
  %call.i161.i = call fastcc i32 @fill_buf(ptr noundef nonnull %decode_data.i63, i32 noundef %sub.i160.i), !range !52
...
if.end.i166.i:                                    ; preds = %if.then.i162.i, %decode_len.exit.i
  ...
  store i16 %dec.i164.i86, ptr %getlen.i, align 8, !tbaa !67
...
if.then.1.i177.i:                                 ; preds = %if.end26.i168.i
  ...
  store i16 %conv9.1.i172.i, ptr %getbuf.i, align 2, !tbaa !66
  %call.1.i175.i = call fastcc i32 @fill_buf(ptr noundef nonnull %decode_data.i63, i32 noundef 16), !range !52
  %.pre.i176.i = load i16, ptr %getbuf.i, align 2, !tbaa !66
...
if.end.1.i181.i:                                  ; preds = %if.then.1.i177.i, %if.end26.i168.i
  ...
  store i16 %dec.1.i179.i, ptr %getlen.i, align 8, !tbaa !67
...
if.then.2.i191.i:                                 ; preds = %if.end26.1.i183.i
  ...
  store i16 %conv9.2.i187.i, ptr %getbuf.i, align 2, !tbaa !66
  %call.2.i190.i = call fastcc i32 @fill_buf(ptr noundef nonnull %decode_data.i63, i32 noundef 16), !range !52
  %.pre129.i.i = load i16, ptr %getbuf.i, align 2, !tbaa !66
...
if.end.2.i195.i:                                  ; preds = %if.then.2.i191.i, %if.end26.1.i183.i
  ...
  store i16 %dec.2.i193.i, ptr %getlen.i, align 8, !tbaa !67
...
if.then.3.i205.i:                                 ; preds = %if.end26.2.i197.i
  ...
  store i16 %conv9.3.i201.i, ptr %getbuf.i, align 2, !tbaa !66
  %call.3.i204.i = call fastcc i32 @fill_buf(ptr noundef nonnull %decode_data.i63, i32 noundef 16), !range !52
  %.pre130.i.i = load i16, ptr %getbuf.i, align 2, !tbaa !66
...
if.end.3.i209.i:                                  ; preds = %if.then.3.i205.i, %if.end26.2.i197.i
  ...
  store i16 %dec.3.i207.i, ptr %getlen.i, align 8, !tbaa !67
...
if.then42.i220.i:                                 ; preds = %if.then36.i212.i
  ...
  store i16 %conv51.i216.i, ptr %getbuf.i, align 2, !tbaa !66
  %sub54.i217.i = sub nsw i32 16, %conv38.i213.i
  %call55.i218.i = call fastcc i32 @fill_buf(ptr noundef nonnull %decode_data.i63, i32 noundef %sub54.i217.i), !range !52
  %.pre131.i219.i = load i16, ptr %getbuf.i, align 2, !tbaa !66
...
decode_ptr.exit.i:                                ; preds = %if.then42.i220.i, %if.then36.i212.i
  ...
  store i16 %conv68.i226.i, ptr %getbuf.i, align 2, !tbaa !66
  %sub72.i227.i = sub nsw i16 %132, %width.0120.i.i
  store i16 %sub72.i227.i, ptr %getlen.i, align 8, !tbaa !67
...
if.end92.i:                                       ; preds = %if.then88.i, %while.body78.i
  ...
  br i1 %cmp76.i, label %while.body78.i, label %if.end99.i93, !llvm.loop !68
...
if.end99.i93:                                     ; preds = %if.end92.i, %if.end27.i
  ...
  %141 = load i32, ptr %orig_size.i71, align 4, !tbaa !53
  %cmp7.i92 = icmp ult i32 %count.1.i90, %141
  br i1 %cmp7.i92, label %while.body.i73thread-pre-split, label %while.end100.i95, !llvm.loop !69
...
if.end99.i93.thread:                              ; preds = %if.end27.i
  ...
  %144 = load i32, ptr %orig_size.i71, align 4, !tbaa !53
  %cmp7.i92112 = icmp ult i32 %inc.i85, %144
  br i1 %cmp7.i92112, label %while.body.i73thread-pre-split, label %if.end107.i98, !llvm.loop !69
