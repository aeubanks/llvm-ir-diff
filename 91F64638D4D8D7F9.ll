...
define dso_local i32 @bar(i32 noundef %0) local_unnamed_addr #0 {
  %2 = load i16, ptr @foo, align 4
  %3 = lshr i16 %2, 12
  %4 = zext i16 %3 to i32
  store i32 %4, ptr @oldfoo, align 4, !tbaa !5
  %5 = trunc i32 %0 to i16
  %6 = shl i16 %5, 12
  %7 = and i16 %2, 4095
  %8 = or i16 %7, %6
  store i16 %8, ptr @foo, align 4
  %9 = icmp eq i32 %0, 0
...
define dso_local i32 @main() local_unnamed_addr #1 {
  %1 = load i16, ptr @foo, align 4
  %2 = lshr i16 %1, 12
  %3 = zext i16 %2 to i32
  store i32 %3, ptr @oldfoo, align 4, !tbaa !5
  %4 = and i16 %1, 4095
  %5 = or i16 %4, 4096
  store i16 %5, ptr @foo, align 4
