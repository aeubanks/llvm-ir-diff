...
define dso_local void @_ZN3barC2Ev(ptr nocapture nonnull readnone align 4 %0) unnamed_addr #0 align 2 {
  ret void
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none) uwtable
define dso_local void @_ZN3fooC2Ev(ptr nocapture nonnull align 4 %0) unnamed_addr #0 align 2 {
  ret void
}
