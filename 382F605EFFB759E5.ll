...
1:                                                ; preds = %1, %0
  ...
  %7 = srem <4 x i32> %4, <i32 3, i32 3, i32 3, i32 3>
  %8 = srem <4 x i32> %6, <i32 3, i32 3, i32 3, i32 3>
...
1:                                                ; preds = %1, %0
  ...
  %5 = getelementptr inbounds i32, ptr %3, i64 4
  %6 = load <4 x i32>, ptr %5, align 16, !tbaa !5
  %7 = urem <4 x i32> %4, <i32 3, i32 3, i32 3, i32 3>
  %8 = urem <4 x i32> %6, <i32 3, i32 3, i32 3, i32 3>
...
1:                                                ; preds = %1, %0
  ...
  %5 = getelementptr inbounds i32, ptr %3, i64 4
  %6 = load <4 x i32>, ptr %5, align 16, !tbaa !5
  %7 = srem <4 x i32> %4, <i32 18, i32 18, i32 18, i32 18>
  %8 = srem <4 x i32> %6, <i32 18, i32 18, i32 18, i32 18>
  %9 = getelementptr inbounds [4096 x i32], ptr @c, i64 0, i64 %2
  store <4 x i32> %7, ptr %9, align 16, !tbaa !5
  %10 = getelementptr inbounds i32, ptr %9, i64 4
  store <4 x i32> %8, ptr %10, align 16, !tbaa !5
...
1:                                                ; preds = %1, %0
  ...
  %5 = getelementptr inbounds i32, ptr %3, i64 4
  %6 = load <4 x i32>, ptr %5, align 16, !tbaa !5
  %7 = urem <4 x i32> %4, <i32 18, i32 18, i32 18, i32 18>
  %8 = urem <4 x i32> %6, <i32 18, i32 18, i32 18, i32 18>
  %9 = getelementptr inbounds [4096 x i32], ptr @d, i64 0, i64 %2
  store <4 x i32> %7, ptr %9, align 16, !tbaa !5
  %10 = getelementptr inbounds i32, ptr %9, i64 4
  store <4 x i32> %8, ptr %10, align 16, !tbaa !5
...
1:                                                ; preds = %1, %0
  ...
  %5 = getelementptr inbounds i32, ptr %3, i64 4
  %6 = load <4 x i32>, ptr %5, align 16, !tbaa !5
  %7 = srem <4 x i32> %4, <i32 19, i32 19, i32 19, i32 19>
  %8 = srem <4 x i32> %6, <i32 19, i32 19, i32 19, i32 19>
  %9 = getelementptr inbounds [4096 x i32], ptr @c, i64 0, i64 %2
  store <4 x i32> %7, ptr %9, align 16, !tbaa !5
  %10 = getelementptr inbounds i32, ptr %9, i64 4
  store <4 x i32> %8, ptr %10, align 16, !tbaa !5
...
1:                                                ; preds = %1, %0
  ...
  %5 = getelementptr inbounds i32, ptr %3, i64 4
  %6 = load <4 x i32>, ptr %5, align 16, !tbaa !5
  %7 = urem <4 x i32> %4, <i32 19, i32 19, i32 19, i32 19>
  %8 = urem <4 x i32> %6, <i32 19, i32 19, i32 19, i32 19>
  %9 = getelementptr inbounds [4096 x i32], ptr @d, i64 0, i64 %2
  store <4 x i32> %7, ptr %9, align 16, !tbaa !5
  %10 = getelementptr inbounds i32, ptr %9, i64 4
  store <4 x i32> %8, ptr %10, align 16, !tbaa !5
...
1:                                                ; preds = %1, %0
  ...
  %10 = add <4 x i32> %9, %8
  %11 = mul <4 x i32> %10, <i32 -3, i32 -3, i32 -3, i32 -3>
  %12 = add <4 x i32> %11, %4
  %13 = getelementptr inbounds [4096 x i32], ptr @c, i64 0, i64 %2
  store <4 x i32> %12, ptr %13, align 16, !tbaa !5
  %14 = add nuw i64 %2, 4
  %15 = icmp eq i64 %14, 4096
  br i1 %15, label %16, label %1, !llvm.loop !18
...
1:                                                ; preds = %1, %0
  ...
  %8 = trunc <4 x i64> %7 to <4 x i32>
  %9 = mul <4 x i32> %8, <i32 -3, i32 -3, i32 -3, i32 -3>
  %10 = add <4 x i32> %9, %4
  %11 = getelementptr inbounds [4096 x i32], ptr @d, i64 0, i64 %2
...
1:                                                ; preds = %1, %0
  ...
  %12 = mul <4 x i32> %11, <i32 -18, i32 -18, i32 -18, i32 -18>
  %13 = add <4 x i32> %12, %4
  %14 = getelementptr inbounds [4096 x i32], ptr @c, i64 0, i64 %2
  store <4 x i32> %13, ptr %14, align 16, !tbaa !5
  %15 = add nuw i64 %2, 4
  %16 = icmp eq i64 %15, 4096
  br i1 %16, label %17, label %1, !llvm.loop !20
...
1:                                                ; preds = %1, %0
  ...
  %8 = trunc <4 x i64> %7 to <4 x i32>
  %9 = mul <4 x i32> %8, <i32 -18, i32 -18, i32 -18, i32 -18>
  %10 = add <4 x i32> %9, %4
  %11 = getelementptr inbounds [4096 x i32], ptr @d, i64 0, i64 %2
  store <4 x i32> %10, ptr %11, align 16, !tbaa !5
  %12 = add nuw i64 %2, 4
  %13 = icmp eq i64 %12, 4096
  br i1 %13, label %14, label %1, !llvm.loop !21
...
1:                                                ; preds = %1, %0
  ...
  %10 = lshr <4 x i32> %4, <i32 31, i32 31, i32 31, i32 31>
  %11 = add nsw <4 x i32> %9, %10
  %12 = mul <4 x i32> %11, <i32 -19, i32 -19, i32 -19, i32 -19>
  %13 = add <4 x i32> %12, %4
  %14 = getelementptr inbounds [4096 x i32], ptr @c, i64 0, i64 %2
  store <4 x i32> %13, ptr %14, align 16, !tbaa !5
  %15 = add nuw i64 %2, 4
  %16 = icmp eq i64 %15, 4096
  br i1 %16, label %17, label %1, !llvm.loop !22
...
1:                                                ; preds = %1, %0
  ...
  %13 = mul <4 x i32> %12, <i32 -19, i32 -19, i32 -19, i32 -19>
  %14 = add <4 x i32> %13, %4
  %15 = getelementptr inbounds [4096 x i32], ptr @d, i64 0, i64 %2
  store <4 x i32> %14, ptr %15, align 16, !tbaa !5
  %16 = add nuw i64 %2, 4
  %17 = icmp eq i64 %16, 4096
  br i1 %17, label %18, label %1, !llvm.loop !23
