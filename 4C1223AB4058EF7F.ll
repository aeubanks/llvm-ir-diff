...
61:                                               ; preds = %57
  %62 = getelementptr inbounds i8, ptr %0, i64 15
...
77:                                               ; preds = %73
  %78 = getelementptr inbounds i8, ptr %0, i64 19
...
85:                                               ; preds = %81
  %86 = getelementptr inbounds i8, ptr %0, i64 21
  %87 = load i8, ptr %86, align 1, !tbaa !5
  %88 = icmp eq i8 %87, 0
  br i1 %88, label %89, label %129

89:                                               ; preds = %85
  %90 = getelementptr inbounds i8, ptr %0, i64 22
...
101:                                              ; preds = %97
  %102 = getelementptr inbounds i8, ptr %0, i64 25
  %103 = load i8, ptr %102, align 1, !tbaa !5
  %104 = icmp eq i8 %103, 0
  br i1 %104, label %105, label %129

105:                                              ; preds = %101
  %106 = getelementptr inbounds i8, ptr %0, i64 26
...
121:                                              ; preds = %117
  %122 = getelementptr inbounds i8, ptr %0, i64 30
  %123 = load i8, ptr %122, align 1, !tbaa !5
  %124 = icmp eq i8 %123, 0
  br i1 %124, label %125, label %129

125:                                              ; preds = %121
  %126 = getelementptr inbounds i8, ptr %0, i64 31
...
define dso_local void @foo(i32 noundef %0) local_unnamed_addr #0 {
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(32) %2, ptr noundef nonnull align 16 dereferenceable(32) @__const.foo.s, i64 32, i1 false)
  %3 = tail call i32 @llvm.bswap.i32(i32 %0)
  %4 = getelementptr inbounds i32, ptr %2, i64 2
  store i32 %3, ptr %4, align 8, !tbaa !8
...
define dso_local i32 @main() local_unnamed_addr #0 {
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(32) %1, ptr noundef nonnull align 16 dereferenceable(32) @__const.foo.s, i64 32, i1 false)
