...
for.cond.cleanup:                                 ; preds = %for.body, %entry
  %global_bound.sroa.25.0.lcssa = phi float [ 0xC7EFFFFFE0000000, %entry ], [ %cond109.i.sroa.speculated, %for.body ]
...
for.body:                                         ; preds = %for.body.lr.ph, %for.body
  ...
  %global_bound.sroa.25.025 = phi float [ 0xC7EFFFFFE0000000, %for.body.lr.ph ], [ %cond109.i.sroa.speculated, %for.body ]
  ...
  %cond109.i.sroa.speculated = select i1 %cmp99.i, float %19, float %global_bound.sroa.25.025
...
for.body.prol:                                    ; preds = %for.body.lr.ph
  ...
  %5 = load float, ptr %arrayidx.i68.prol, align 4, !tbaa !17
...
for.body:                                         ; preds = %for.body.prol.loopexit, %for.body
  ...
  %15 = load float, ptr %arrayidx.i68, align 4, !tbaa !17
  ...
  %22 = load float, ptr %arrayidx.i68.1, align 4, !tbaa !17
...
for.body19:                                       ; preds = %for.body19.lr.ph, %for.body19
  ...
  %35 = load float, ptr %arrayidx.i81, align 4, !tbaa !17
...
for.body.prol:                                    ; preds = %for.body.lr.ph
  ...
  %8 = load <2 x float>, ptr %arrayidx.i77.prol, align 4, !tbaa !17
...
for.body:                                         ; preds = %for.body.prol.loopexit, %for.body
  ...
  %19 = load <2 x float>, ptr %arrayidx.i77, align 4, !tbaa !17
  ...
  %26 = load <2 x float>, ptr %arrayidx.i77.1, align 4, !tbaa !17
...
for.body17:                                       ; preds = %for.body17.lr.ph, %if.end
  ...
  %41 = load <2 x float>, ptr %arrayidx.i90, align 4, !tbaa !17
...
if.then:                                          ; preds = %for.body17
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %temp.sroa.0.i, ptr noundef nonnull align 4 dereferenceable(16) %arrayidx.i90, i64 16, i1 false), !tbaa.struct !14
  %m_max3.i.i.i = getelementptr inbounds %class.btAABB, ptr %arrayidx.i90, i64 0, i32 1
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %temp.sroa.0.16.sroa_idx.i, ptr noundef nonnull align 4 dereferenceable(16) %m_max3.i.i.i, i64 16, i1 false), !tbaa.struct !14
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(36) %arrayidx.i90, ptr noundef nonnull align 4 dereferenceable(36) %arrayidx4.i, i64 36, i1 false), !tbaa.struct !23
...
_ZN18btQuantizedBvhTree17calc_quantizationER18GIM_BVH_DATA_ARRAYf.exit: ; preds = %_ZN18btQuantizedBvhTree17calc_quantizationER18GIM_BVH_DATA_ARRAYf.exit.loopexit, %entry
  ...
  %m_max.i = getelementptr inbounds %class.btQuantizedBvhTree, ptr %this, i64 0, i32 3, i32 1
  %m_bvhQuantization.i = getelementptr inbounds %class.btQuantizedBvhTree, ptr %this, i64 0, i32 4
  %21 = shufflevector <4 x float> %19, <4 x float> poison, <2 x i32> <i32 2, i32 poison>
  ...
  %shift = shufflevector <4 x float> %19, <4 x float> poison, <4 x i32> <i32 poison, i32 2, i32 poison, i32 poison>
  %25 = fsub <4 x float> %19, %shift
  %sub14.i32.i.i = extractelement <4 x float> %25, i64 1
  %26 = fsub <2 x float> %23, %20
  %27 = fdiv <2 x float> <float 6.553500e+04, float 6.553500e+04>, %26
  ...
  store <2 x float> %27, ptr %m_bvhQuantization.i, align 8, !tbaa.struct !14
...
if.then5.i:                                       ; preds = %_ZN18btQuantizedBvhTree17calc_quantizationER18GIM_BVH_DATA_ARRAYf.exit
  ...
  %30 = load i32, ptr %m_capacity.i.i.i, align 8, !tbaa !37
  %cmp.i.i7 = icmp slt i32 %30, %mul
...
for.body.lr.ph.i.i.i:                             ; preds = %_ZN20btAlignedObjectArrayI21BT_QUANTIZED_BVH_NODEE8allocateEi.exit.i.i
  ...
  %32 = icmp eq i32 %31, 1
  br i1 %32, label %_ZNK20btAlignedObjectArrayI21BT_QUANTIZED_BVH_NODEE4copyEiiPS0_.exit.i.i.loopexit.unr-lcssa, label %for.body.lr.ph.i.i.i.new
...
for.body.i.i.i:                                   ; preds = %for.body.i.i.i, %for.body.lr.ph.i.i.i.new
  ...
  %33 = load ptr, ptr %m_data.i.i.i, align 8, !tbaa !31
  %arrayidx3.i.i.i = getelementptr inbounds %struct.BT_QUANTIZED_BVH_NODE, ptr %33, i64 %indvars.iv.i.i.i
  ...
  %arrayidx3.i.i.i.1 = getelementptr inbounds %struct.BT_QUANTIZED_BVH_NODE, ptr %34, i64 %indvars.iv.next.i.i.i
...
for.body.i.i.i.epil:                              ; preds = %_ZNK20btAlignedObjectArrayI21BT_QUANTIZED_BVH_NODEE4copyEiiPS0_.exit.i.i.loopexit.unr-lcssa
  ...
  %arrayidx3.i.i.i.epil = getelementptr inbounds %struct.BT_QUANTIZED_BVH_NODE, ptr %35, i64 %indvars.iv.i.i.i.unr
...
_ZNK20btAlignedObjectArrayI21BT_QUANTIZED_BVH_NODEE4copyEiiPS0_.exit.i.i: ; preds = %for.body.i.i.i.epil, %_ZNK20btAlignedObjectArrayI21BT_QUANTIZED_BVH_NODEE4copyEiiPS0_.exit.i.i.loopexit.unr-lcssa, %_ZN20btAlignedObjectArrayI21BT_QUANTIZED_BVH_NODEE8allocateEi.exit.i.i
  ...
  %36 = load ptr, ptr %m_data.i9.i.i, align 8, !tbaa !31
  %tobool.not.i10.i.i = icmp eq ptr %36, null
  %m_ownsMemory.i.i.i = getelementptr inbounds %class.btQuantizedBvhTree, ptr %this, i64 0, i32 2, i32 0, i32 6
  %37 = load i8, ptr %m_ownsMemory.i.i.i, align 8, !range !39
...
for.body10.lr.ph.i:                               ; preds = %if.end.i, %if.then5.i
  ...
  %39 = sub nsw i64 %wide.trip.count.i8, %38
  %40 = xor i64 %38, -1
  %41 = add nsw i64 %40, %wide.trip.count.i8
  %xtraiter14 = and i64 %39, 3
...
for.body10.i.prol:                                ; preds = %for.body10.lr.ph.i, %for.body10.i.prol
  %indvars.iv.i9.prol = phi i64 [ %indvars.iv.next.i10.prol, %for.body10.i.prol ], [ %38, %for.body10.lr.ph.i ]
  %prol.iter = phi i64 [ %prol.iter.next, %for.body10.i.prol ], [ 0, %for.body10.lr.ph.i ]
  %42 = load ptr, ptr %m_data11.i, align 8, !tbaa !31
  %ref.tmp.sroa.3.0.arrayidx13.i.sroa_idx.prol = getelementptr inbounds %struct.BT_QUANTIZED_BVH_NODE, ptr %42, i64 %indvars.iv.i9.prol, i32 2
...
for.body10.i.prol.loopexit:                       ; preds = %for.body10.i.prol, %for.body10.lr.ph.i
  %indvars.iv.i9.unr = phi i64 [ %38, %for.body10.lr.ph.i ], [ %indvars.iv.next.i10.prol, %for.body10.i.prol ]
  %43 = icmp ult i64 %41, 3
  br i1 %43, label %_ZN20btAlignedObjectArrayI21BT_QUANTIZED_BVH_NODEE6resizeEiRKS0_.exit.loopexit, label %for.body10.i
...
for.body10.i:                                     ; preds = %for.body10.i.prol.loopexit, %for.body10.i
  ...
  %44 = load ptr, ptr %m_data11.i, align 8, !tbaa !31
  %ref.tmp.sroa.3.0.arrayidx13.i.sroa_idx = getelementptr inbounds %struct.BT_QUANTIZED_BVH_NODE, ptr %44, i64 %indvars.iv.i9, i32 2
  ...
  %ref.tmp.sroa.3.0.arrayidx13.i.sroa_idx.1 = getelementptr inbounds %struct.BT_QUANTIZED_BVH_NODE, ptr %45, i64 %indvars.iv.next.i10, i32 2
  ...
  %ref.tmp.sroa.3.0.arrayidx13.i.sroa_idx.2 = getelementptr inbounds %struct.BT_QUANTIZED_BVH_NODE, ptr %46, i64 %indvars.iv.next.i10.1, i32 2
  ...
  %ref.tmp.sroa.3.0.arrayidx13.i.sroa_idx.3 = getelementptr inbounds %struct.BT_QUANTIZED_BVH_NODE, ptr %47, i64 %indvars.iv.next.i10.2, i32 2
...
_ZN20btAlignedObjectArrayI21BT_QUANTIZED_BVH_NODEE6resizeEiRKS0_.exit: ; preds = %_ZN20btAlignedObjectArrayI21BT_QUANTIZED_BVH_NODEE6resizeEiRKS0_.exit.loopexit, %_ZN18btQuantizedBvhTree17calc_quantizationER18GIM_BVH_DATA_ARRAYf.exit
  %48 = phi i32 [ %.pre, %_ZN20btAlignedObjectArrayI21BT_QUANTIZED_BVH_NODEE6resizeEiRKS0_.exit.loopexit ], [ %28, %_ZN18btQuantizedBvhTree17calc_quantizationER18GIM_BVH_DATA_ARRAYf.exit ]
  store i32 %mul, ptr %m_size.i.i6, align 4, !tbaa !36
  tail call void @_ZN18btQuantizedBvhTree15_build_sub_treeER18GIM_BVH_DATA_ARRAYii(ptr noundef nonnull align 8 dereferenceable(88) %this, ptr noundef nonnull align 8 dereferenceable(25) %primitive_boxes, i32 noundef 0, i32 noundef %48)
  ret void
}
...
entry:
  ...
  %0 = load i32, ptr %this, align 8, !tbaa !26
  %tobool.not225 = icmp eq i32 %0, 0
  br i1 %tobool.not225, label %while.end, label %while.body.lr.ph
...
if.end10:                                         ; preds = %if.then9, %if.else
  %76 = phi <4 x float> [ %72, %if.then9 ], [ %52, %if.else ]
  %77 = phi <2 x float> [ %75, %if.then9 ], [ %54, %if.else ]
  ...
  %83 = load <4 x float>, ptr %m_max.i.i112, align 8
  ...
  %90 = load <2 x float>, ptr %arrayidx7.i18.i.i.i129, align 4, !tbaa !17
  ...
  store <4 x i16> %104, ptr %arrayidx.i.i.i110, align 2, !tbaa !32
  %105 = fadd <2 x float> %95, <float 5.000000e-01, float 5.000000e-01>
  %106 = fptoui <2 x float> %105 to <2 x i16>
  store <2 x i16> %106, ptr %arrayidx7.i51.i.i180, align 2, !tbaa !32
  br label %if.end11
...
lpad:                                             ; preds = %for.cond.cleanup, %entry
  %7 = landingpad { ptr, i32 }
          cleanup
  %.pre53 = load ptr, ptr %m_data.i.i.i, align 8, !tbaa !13
  br label %ehcleanup
