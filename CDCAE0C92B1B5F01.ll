; ModuleID = '/usr/local/google/home/aeubanks/repos/test-suite/SingleSource/Regression/C/gcc-c-torture/execute/920922-1.c'
source_filename = "/usr/local/google/home/aeubanks/repos/test-suite/SingleSource/Regression/C/gcc-c-torture/execute/920922-1.c"
...
entry:
  %incdec.ptr = getelementptr inbounds i64, ptr %p, i64 1
  %0 = load i64, ptr %p, align 8, !tbaa !5
  %shr = lshr i64 %0, 24
  %add.ptr = getelementptr inbounds i64, ptr %incdec.ptr, i64 %shr
  ret ptr %add.ptr
}
