...
define dso_local ptr @maybe_next(ptr noundef readonly %0, i32 noundef %1) local_unnamed_addr #0 {
  %3 = icmp eq i32 %1, 0
  br i1 %3, label %6, label %4

4:                                                ; preds = %2
  %5 = load ptr, ptr %0, align 1, !tbaa !5
  br label %6
...
define dso_local i32 @main() local_unnamed_addr #1 {
  ...
  %3 = call ptr @maybe_next(ptr noundef nonnull %1, i32 noundef 1)
  %4 = icmp eq ptr %3, %2
