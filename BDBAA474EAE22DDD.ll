...
entry:
  ...
  %add12 = sub i32 %4, %Wdiv2
  %sub13 = add i32 %add12, %10
  %add34 = add i32 %sub13, %cond
  ...
  %add31 = sub i32 %6, %Hdiv2
  %sub32 = add i32 %add31, %13
  %add36 = add i32 %sub32, %cond30
...
for.body205:                                      ; preds = %for.body205.lr.ph, %for.cond202.loopexit
  ...
  %cond222 = add nsw i32 %conv211, %add218
  ...
  %cond241 = add nsw i32 %conv230, %add237
  ...
  %cond260 = add nsw i32 %conv249, %add256
...
for.body294.us:                                   ; preds = %for.body294.lr.ph, %for.inc.us
  ...
  %60 = load i32, ptr %left295.us, align 8, !tbaa !23
  %add296.us = add nsw i32 %60, %38
  %right297.us = getelementptr inbounds %struct.tilebox, ptr %tileptr2.0585.us, i64 0, i32 10
  %61 = load i32, ptr %right297.us, align 4, !tbaa !24
  %add298.us = add nsw i32 %61, %38
  %bottom299.us = getelementptr inbounds %struct.tilebox, ptr %tileptr2.0585.us, i64 0, i32 11
  %62 = load i32, ptr %bottom299.us, align 8, !tbaa !25
  %add300.us = add nsw i32 %62, %39
  %top301.us = getelementptr inbounds %struct.tilebox, ptr %tileptr2.0585.us, i64 0, i32 12
  %63 = load i32, ptr %top301.us, align 4, !tbaa !26
  %add302.us = add nsw i32 %63, %39
