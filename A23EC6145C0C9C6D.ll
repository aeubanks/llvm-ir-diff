...
if.end111:                                        ; preds = %for.body104, %for.end92
  br i1 %cmp.i246, label %for.end122.thread, label %for.body116.lr.ph
...
for.end122.thread:                                ; preds = %if.end111, %entry
  %defslist.0.lcssa297302.ph = phi ptr [ %defslist.2, %if.end111 ], [ null, %entry ]
  %Search.val185305 = load ptr, ptr %Search, align 8
  %cmp.i.i306 = icmp eq ptr %Search.val185305, null
  %defslist.0.mux308 = select i1 %cmp.i.i306, ptr %defslist.0.lcssa297302.ph, ptr %Search.val185305
  br label %list_Nconc.exit
...
for.end122:                                       ; preds = %for.body116
  ...
  %defslist.0.mux = select i1 %cmp.i.i, ptr %defslist.2, ptr %Search.val185
...
list_Nconc.exit:                                  ; preds = %for.end122.thread, %for.end122, %for.end.i
  %retval.0.i = phi ptr [ %Search.val185, %for.end.i ], [ %defslist.0.mux, %for.end122 ], [ %defslist.0.mux308, %for.end122.thread ]
...
entry:
  ...
  %cmp.i.not69 = icmp eq ptr %Clauselist, null
...
for.body.us:                                      ; preds = %for.body.lr.ph, %list_Nconc.exit.us
  %l.071.us = phi ptr [ %l.0.val50.us, %list_Nconc.exit.us ], [ %Clauselist, %for.body.lr.ph ]
  %allnew.070.us = phi ptr [ %retval.0.i.us, %list_Nconc.exit.us ], [ null, %for.body.lr.ph ]
  %2 = getelementptr i8, ptr %l.071.us, i64 8
  ...
  %cmp.i52.us = icmp eq ptr %call5.us, null
  %cmp.i.i.us = icmp eq ptr %allnew.070.us, null
  %brmerge.us = select i1 %cmp.i.i.us, i1 true, i1 %cmp.i52.us
  %call5.mux.us = select i1 %cmp.i.i.us, ptr %call5.us, ptr %allnew.070.us
  br i1 %brmerge.us, label %list_Nconc.exit.us, label %for.cond.i.us

for.cond.i.us:                                    ; preds = %for.body.us, %for.cond.i.us
  %List1.addr.0.i.us = phi ptr [ %List1.addr.0.val17.i.us, %for.cond.i.us ], [ %allnew.070.us, %for.body.us ]
...
list_Nconc.exit.us:                               ; preds = %for.end.i.us, %for.body.us
  %retval.0.i.us = phi ptr [ %allnew.070.us, %for.end.i.us ], [ %call5.mux.us, %for.body.us ]
  %l.0.val50.us = load ptr, ptr %l.071.us, align 8
...
for.body:                                         ; preds = %for.body.lr.ph, %list_Nconc.exit
  %l.071 = phi ptr [ %l.0.val50, %list_Nconc.exit ], [ %Clauselist, %for.body.lr.ph ]
  %allnew.070 = phi ptr [ %retval.0.i, %list_Nconc.exit ], [ null, %for.body.lr.ph ]
  %3 = getelementptr i8, ptr %l.071, i64 8
  ...
  br i1 %cmp.i52, label %if.end14.thread, label %if.then

if.end14.thread:                                  ; preds = %for.body
  %cmp.i.i73 = icmp eq ptr %allnew.070, null
  %call5.mux75 = select i1 %cmp.i.i73, ptr %call5, ptr %allnew.070
  br label %list_Nconc.exit
...
if.end14:                                         ; preds = %if.then11, %if.else
  ...
  %cmp.i.i = icmp eq ptr %allnew.070, null
  %brmerge = or i1 %cmp.i.i, %cmp.i52
  %call5.mux = select i1 %cmp.i.i, ptr %call5, ptr %allnew.070
  br i1 %brmerge, label %list_Nconc.exit, label %for.cond.i

for.cond.i:                                       ; preds = %if.end14, %for.cond.i
  %List1.addr.0.i = phi ptr [ %List1.addr.0.val17.i, %for.cond.i ], [ %allnew.070, %if.end14 ]
  %List1.addr.0.val17.i = load ptr, ptr %List1.addr.0.i, align 8
  %cmp.i20.not.i = icmp eq ptr %List1.addr.0.val17.i, null
  br i1 %cmp.i20.not.i, label %for.end.i, label %for.cond.i, !llvm.loop !8
...
list_Nconc.exit:                                  ; preds = %if.end14.thread, %if.end14, %for.end.i
  %retval.0.i = phi ptr [ %allnew.070, %for.end.i ], [ %call5.mux, %if.end14 ], [ %call5.mux75, %if.end14.thread ]
  %l.0.val50 = load ptr, ptr %l.071, align 8
...
if.end29:                                         ; preds = %if.then26, %if.end20
  ...
  %brmerge68 = select i1 %cmp.i.i57, i1 true, i1 %cmp.i55
  %allnew.0.mux = select i1 %cmp.i.i57, ptr %allnew.0.lcssa, ptr %Clauselist.addr.0
  br i1 %brmerge68, label %list_Nconc.exit66, label %for.cond.i63
...
list_Nconc.exit66:                                ; preds = %if.end29, %for.end.i64
  %retval.0.i65 = phi ptr [ %Clauselist.addr.0, %for.end.i64 ], [ %allnew.0.mux, %if.end29 ]
...
if.end44:                                         ; preds = %for.body36, %for.end
  ...
  %newterms.0.mux = select i1 %cmp.i.i, ptr %newterms.0.lcssa, ptr %call24
  br i1 %brmerge, label %list_Nconc.exit, label %for.cond.i
...
list_Nconc.exit:                                  ; preds = %if.end44, %for.end.i
  %retval.0.i = phi ptr [ %call24, %for.end.i ], [ %newterms.0.mux, %if.end44 ]
  ret ptr %retval.0.i
}
