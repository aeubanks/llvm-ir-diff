...
cleanup:                                          ; preds = %if.end7.i, %entry, %_ZN8NArchive3N7zL18GetReverseSlashPosERK11CStringBaseIwE.exit, %lor.lhs.false, %_ZNK11CStringBaseIwE11ReverseFindEw.exit
  %retval.0 = phi i32 [ %Name.val12, %_ZNK11CStringBaseIwE11ReverseFindEw.exit ], [ %spec.select, %lor.lhs.false ], [ 0, %_ZN8NArchive3N7zL18GetReverseSlashPosERK11CStringBaseIwE.exit ], [ 0, %entry ], [ %Name.val12, %if.end7.i ]
  ret i32 %retval.0
}
...
if.end:                                           ; preds = %if.then, %entry
  %cmp2.not108114 = icmp eq i32 %size, 0
  br i1 %cmp2.not108114, label %return, label %while.body.lr.ph.lr.ph
...
while.body:                                       ; preds = %while.body.backedge, %while.body.lr.ph.lr.ph
  %data.addr.0110 = phi ptr [ %data, %while.body.lr.ph.lr.ph ], [ %data.addr.0110.be, %while.body.backedge ]
  %size.addr.0109 = phi i32 [ %size, %while.body.lr.ph.lr.ph ], [ %size.addr.0109.be, %while.body.backedge ]
...
if.then3:                                         ; preds = %while.body
  ...
  %conv = zext i32 %size.addr.0109 to i64
  %1 = load i64, ptr %_rem, align 8, !tbaa !48
  %cmp4 = icmp ugt i64 %1, %conv
  %conv6 = trunc i64 %1 to i32
  %cond = select i1 %cmp4, i32 %size.addr.0109, i32 %conv6
  ...
  %call7 = call noundef i32 %3(ptr noundef nonnull align 8 dereferenceable(8) %2, ptr noundef %data.addr.0110, i32 noundef %cond, ptr noundef nonnull %cur)
...
if.end13:                                         ; preds = %cleanup.cont
  ...
  %add.ptr = getelementptr inbounds i8, ptr %data.addr.0110, i64 %idx.ext
  %sub = sub i32 %size.addr.0109, %4
...
cleanup40:                                        ; preds = %cleanup.cont30
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %cur) #16
  %cmp2.not108 = icmp eq i32 %sub, 0
  br i1 %cmp2.not108, label %return, label %while.body.backedge
...
if.end55:                                         ; preds = %cleanup40.thread92, %_ZN8NArchive3N7z17CFolderOutStream28OpenFileEv.exit
  %size.addr.2 = phi i32 [ %size.addr.0109, %_ZN8NArchive3N7z17CFolderOutStream28OpenFileEv.exit ], [ %sub, %cleanup40.thread92 ]
  %data.addr.2 = phi ptr [ %data.addr.0110, %_ZN8NArchive3N7z17CFolderOutStream28OpenFileEv.exit ], [ %add.ptr, %cleanup40.thread92 ]
...
while.body.backedge:                              ; preds = %if.end55, %cleanup40
  %data.addr.0110.be = phi ptr [ %data.addr.2, %if.end55 ], [ %add.ptr, %cleanup40 ]
  %size.addr.0109.be = phi i32 [ %size.addr.2, %if.end55 ], [ %sub, %cleanup40 ]
...
if.end104:                                        ; preds = %for.body.i1525.prol.loopexit, %for.body.i1525, %middle.block, %if.else, %if.then93
  ...
  %.pre3158 = load i32, ptr %_size.i1487, align 4, !tbaa !33
  br label %cleanup108

cleanup108:                                       ; preds = %for.body41, %for.cond.cleanup, %if.end104
  %87 = phi i32 [ %.pre3158, %if.end104 ], [ %20, %for.cond.cleanup ], [ %20, %for.body41 ]
...
_ZN13CRecordVectorIjE3AddEj.exit:                 ; preds = %if.end248
  ...
  %.pre3159 = load i32, ptr %_size.i1526, align 4, !tbaa !33
  br label %cleanup259

cleanup259:                                       ; preds = %lor.lhs.false237, %for.body230, %land.rhs.i, %_ZN13CRecordVectorIjE3AddEj.exit
  %162 = phi i32 [ %140, %lor.lhs.false237 ], [ %140, %for.body230 ], [ %140, %land.rhs.i ], [ %.pre3159, %_ZN13CRecordVectorIjE3AddEj.exit ]
...
_ZN8NArchive3N7z22CCompressionMethodModeC2Ev.exit: ; preds = %for.body346
  ...
  %and.i15883164 = and i64 %indvars.iv3145, 1
  %cmp.i1589.not = icmp eq i64 %and.i15883164, 0
...
for.cond.cleanup504.loopexit:                     ; preds = %_ZN13CRecordVectorIbE3AddEb.exit
  %.pre3160 = load ptr, ptr %_items.i1696, align 8, !tbaa !36
  %arrayidx.i1701.phi.trans.insert = getelementptr inbounds i32, ptr %.pre3160, i64 %idxprom.i1641
  %.pre3161 = load i32, ptr %arrayidx.i1701.phi.trans.insert, align 4, !tbaa !52
  br label %for.cond.cleanup504

for.cond.cleanup504:                              ; preds = %for.cond.cleanup504.loopexit, %invoke.cont488
  %372 = phi i32 [ %.pre3161, %for.cond.cleanup504.loopexit ], [ %371, %invoke.cont488 ]
...
if.end651:                                        ; preds = %_ZN13CObjectVectorIN8NArchive3N7z7CFolderEE3AddERKS2_.exit, %_ZN13CStreamBinderD2Ev.exit
  %retval.19 = phi i32 [ %retval.102791, %_ZN13CObjectVectorIN8NArchive3N7z7CFolderEE3AddERKS2_.exit ], [ %retval.18, %_ZN13CStreamBinderD2Ev.exit ]
...
invoke.cont760.for.end782_crit_edge:              ; preds = %invoke.cont760
  %.pre3162 = load i32, ptr %_size.i1900, align 4, !tbaa !33
  br label %for.end782
...
for.end782:                                       ; preds = %_ZN13CRecordVectorIN8NArchive3N7z8CRefItemEE3AddES2_.exit, %invoke.cont760.for.end782_crit_edge
  %515 = phi i32 [ %.pre3162, %invoke.cont760.for.end782_crit_edge ], [ %inc.i1903, %_ZN13CRecordVectorIN8NArchive3N7z8CRefItemEE3AddES2_.exit ]
...
if.end.i32.i.preheader:                           ; preds = %do.body3.i
  %IsDir.i3374 = getelementptr inbounds %"struct.NArchive::N7z::CUpdateItem", ptr %temp.i.sroa.0.0.copyload, i64 0, i32 11
  %IsAnti.i3380 = getelementptr inbounds %"struct.NArchive::N7z::CUpdateItem", ptr %temp.i.sroa.0.0.copyload, i64 0, i32 10
  %Name.i3381 = getelementptr inbounds %"struct.NArchive::N7z::CUpdateItem", ptr %temp.i.sroa.0.0.copyload, i64 0, i32 6
  ...
  %Size.i3385 = getelementptr inbounds %"struct.NArchive::N7z::CUpdateItem", ptr %temp.i.sroa.0.0.copyload, i64 0, i32 5
...
if.end7.i46.i:                                    ; preds = %call.i36.i.noexc, %if.end.i32.i
  ...
  %524 = load i8, ptr %IsDir.i3374, align 1, !tbaa !122, !range !42, !noundef !43
  %tobool.not.i3375 = icmp eq i8 %524, 0
  ...
  %cmp.not.i3376 = icmp eq i8 %524, %525
  br i1 %cmp.not.i3376, label %if.end.i3379, label %if.then.i3378

if.then.i3378:                                    ; preds = %if.end7.i46.i
  br i1 %tobool.not.i3375, label %cleanup.i53.i, label %if.end7.for.end.loopexit_crit_edge.i48.i

if.end.i3379:                                     ; preds = %if.end7.i46.i
  br i1 %tobool.not.i3375, label %if.end24.i, label %if.then9.i

if.then9.i:                                       ; preds = %if.end.i3379
  %526 = load i8, ptr %IsAnti.i3380, align 2, !tbaa !208, !range !42, !noundef !43
...
if.end20.i:                                       ; preds = %if.then9.i
  %528 = load ptr, ptr %Name.i3381, align 8, !tbaa !82
  ...
  %call23.i3386 = invoke noundef i32 @_Z21MyStringCompareNoCasePKwS0_(ptr noundef %528, ptr noundef %529)
          to label %call23.i.noexc unwind label %lpad768.loopexit

call23.i.noexc:                                   ; preds = %if.end20.i
  %sub.i = sub nsw i32 0, %call23.i3386
  br label %call10.i44.i.noexc

if.end24.i:                                       ; preds = %if.end.i3379
...
if.then27.i:                                      ; preds = %if.end24.i
  ...
  %cmp.i.i3382 = icmp slt i32 %temp.i.sroa.10.0.copyload, %530
  %cmp1.i.i3383 = icmp ne i32 %temp.i.sroa.10.0.copyload, %530
  %cond.i.i = zext i1 %cmp1.i.i3383 to i32
  %cond2.i.i = select i1 %cmp.i.i3382, i32 -1, i32 %cond.i.i
  br i1 %cmp1.i.i3383, label %call10.i44.i.noexc, label %cleanup.cont.i

cleanup.cont.i:                                   ; preds = %if.then27.i
  %531 = load ptr, ptr %Name.i3381, align 8, !tbaa !82
  %add.ptr.i3384 = getelementptr inbounds i32, ptr %531, i64 %idx.ext.i
  ...
  %call41.i3387 = invoke noundef i32 @_Z21MyStringCompareNoCasePKwS0_(ptr noundef %add.ptr.i3384, ptr noundef %add.ptr40.i)
          to label %call41.i.noexc unwind label %lpad768.loopexit

call41.i.noexc:                                   ; preds = %cleanup.cont.i
  %cmp42.not.i = icmp eq i32 %call41.i3387, 0
  br i1 %cmp42.not.i, label %cleanup.cont47.i, label %call10.i44.i.noexc

cleanup.cont47.i:                                 ; preds = %call41.i.noexc
  %534 = load ptr, ptr %Name.i3381, align 8, !tbaa !82
  ...
  %call58.i3388 = invoke noundef i32 @_Z21MyStringCompareNoCasePKwS0_(ptr noundef %add.ptr52.i, ptr noundef %add.ptr57.i)
          to label %call58.i.noexc unwind label %lpad768.loopexit

call58.i.noexc:                                   ; preds = %cleanup.cont47.i
  %cmp59.not.i = icmp eq i32 %call58.i3388, 0
...
if.end92.i:                                       ; preds = %if.then82.i, %land.lhs.true.i
  %541 = load i64, ptr %Size.i3385, align 8, !tbaa !118
...
if.end102.i:                                      ; preds = %if.end92.i, %if.end24.i
  %543 = load ptr, ptr %Name.i3381, align 8, !tbaa !82
  ...
  %call107.i3389 = invoke noundef i32 @_Z21MyStringCompareNoCasePKwS0_(ptr noundef %543, ptr noundef %544)
...
call10.i44.i.noexc:                               ; preds = %if.end92.i, %if.then82.i, %call58.i.noexc, %call41.i.noexc, %if.then27.i, %call23.i.noexc, %if.end102.i
  %retval.7.i = phi i32 [ %sub.i, %call23.i.noexc ], [ %cond2.i164.i, %if.end92.i ], [ %cond2.i160.i, %if.then82.i ], [ %call58.i3388, %call58.i.noexc ], [ %call41.i3387, %call41.i.noexc ], [ %cond2.i.i, %if.then27.i ], [ %call107.i3389, %if.end102.i ]
...
if.end7.for.end.loopexit_crit_edge.i48.i:         ; preds = %land.lhs.true.i, %if.then16.i, %if.then.i3378, %call10.i44.i.noexc
...
cleanup.i53.i:                                    ; preds = %if.then16.i, %if.then.i3378, %land.lhs.true72.i, %call10.i44.i.noexc
...
_ZNK8NArchive3N7z11CUpdateItem15GetExtensionPosEv.exit.i: ; preds = %if.end7.i.i.i, %lor.lhs.false.i.i, %_ZNK11CStringBaseIwE11ReverseFindEw.exit.i.i, %if.then825
  %retval.0.i.i = phi i32 [ %Name.val12.i.i, %_ZNK11CStringBaseIwE11ReverseFindEw.exit.i.i ], [ %spec.select.i.i1948, %lor.lhs.false.i.i ], [ 0, %if.then825 ], [ %Name.val12.i.i, %if.end7.i.i.i ]
...
if.end950:                                        ; preds = %if.end945
  ...
  %spec.select4014 = zext i1 %cmp958.not to i8
  %inc962 = zext i1 %cmp958.not to i32
  %spec.select4015 = add i32 %numUnpackStreams916.02823, %inc962
  store i8 %spec.select4014, ptr %CrcDefined.i2064, align 2
  store i8 %spec.select4014, ptr %HasStream.i2062, align 8
...
cleanup968:                                       ; preds = %if.end950, %if.end945, %if.end940
  %numUnpackStreams916.2 = phi i32 [ %numUnpackStreams916.02823, %if.end940 ], [ %numUnpackStreams916.02823, %if.end945 ], [ %spec.select4015, %if.end950 ]
...
cleanup1026.loopexit:                             ; preds = %_ZN13CStreamBinderD2Ev.exit, %invoke.cont420
  %retval.31.ph = phi i32 [ %call421, %invoke.cont420 ], [ %retval.18, %_ZN13CStreamBinderD2Ev.exit ]
...
_ZN13CRecordVectorIiE3AddEi.exit2149:             ; preds = %if.end1081
  ...
  %.pre3163 = load i32, ptr %_size.i1526, align 4, !tbaa !33
  br label %cleanup1084

cleanup1084:                                      ; preds = %land.lhs.true1072, %land.rhs.i2138, %_ZN13CRecordVectorIiE3AddEi.exit2149
  %678 = phi i32 [ %661, %land.lhs.true1072 ], [ %661, %land.rhs.i2138 ], [ %.pre3163, %_ZN13CRecordVectorIiE3AddEi.exit2149 ]
...
if.end.i:                                         ; preds = %_ZN8NArchive3N7zL18GetReverseSlashPosERK11CStringBaseIwE.exit
  %idx.ext.i = sext i32 %Name.val66 to i64
  %add.ptr.i = getelementptr inbounds i32, ptr %Name.val, i64 %idx.ext.i
  br label %for.cond.i
...
delete.notnull.i:                                 ; preds = %if.end.i.i.i
  %14 = landingpad { ptr, i32 }
          cleanup
  call void @_ZdaPv(ptr noundef nonnull %s.sroa.0.0130195) #18
  br label %ehcleanup46

if.end:                                           ; preds = %for.body.preheader, %for.body
  %15 = phi i32 [ %11, %for.body ], [ %9, %for.body.preheader ]
  %indvars151196 = phi i32 [ %indvars151, %for.body ], [ 0, %for.body.preheader ]
  %s.sroa.0.0130195 = phi ptr [ %s.sroa.0.1, %for.body ], [ %call.i.i72, %for.body.preheader ]
  %s.sroa.16.0132194 = phi i32 [ %s.sroa.16.1, %for.body ], [ 4, %for.body.preheader ]
  %indvars.iv193 = phi i64 [ %indvars.iv.next, %for.body ], [ 0, %for.body.preheader ]
  %s.sroa.0.0130195200 = ptrtoint ptr %s.sroa.0.0130195 to i64
  %conv = trunc i32 %15 to i8
  %16 = xor i32 %indvars151196, -1
  %sub2.i.i = add i32 %s.sroa.16.0132194, %16
  %cmp.not.i.i = icmp slt i32 %sub2.i.i, 1
  br i1 %cmp.not.i.i, label %if.end.i.i75, label %for.inc

if.end.i.i75:                                     ; preds = %if.end
  %cmp4.i.i74 = icmp sgt i32 %s.sroa.16.0132194, 64
  %div24.i.i = lshr i32 %s.sroa.16.0132194, 1
  %cmp8.i.i = icmp sgt i32 %s.sroa.16.0132194, 8
  ...
  %add18.i.i = add i32 %s.sroa.16.0132194, 1
  %add.i.i.i = add i32 %add18.i.i, %delta.1.i.i
  %cmp.i.i.i = icmp eq i32 %add.i.i.i, %s.sroa.16.0132194
...
call.i.i.i.noexc:                                 ; preds = %if.end.i.i.i
  %call.i.i.i76199 = ptrtoint ptr %call.i.i.i76 to i64
  %cmp3.i.i.i = icmp sgt i32 %s.sroa.16.0132194, 0
...
iter.check:                                       ; preds = %for.cond.preheader.i.i.i
  ...
  %17 = sub i64 %call.i.i.i76199, %s.sroa.0.0130195200
  %diff.check = icmp ult i64 %17, 32
  %or.cond210 = or i1 %min.iters.check, %diff.check
  br i1 %or.cond210, label %for.body.i.i.i.preheader, label %vector.main.loop.iter.check

vector.main.loop.iter.check:                      ; preds = %iter.check
  %min.iters.check201 = icmp ult i64 %indvars.iv193, 32
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  %index202 = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ]
  %18 = getelementptr inbounds i8, ptr %s.sroa.0.0130195, i64 %index202
  %wide.load = load <16 x i8>, ptr %18, align 1, !tbaa !15
  %19 = getelementptr inbounds i8, ptr %18, i64 16
  %wide.load203 = load <16 x i8>, ptr %19, align 1, !tbaa !15
  %20 = getelementptr inbounds i8, ptr %call.i.i.i76, i64 %index202
  store <16 x i8> %wide.load, ptr %20, align 1, !tbaa !15
  %21 = getelementptr inbounds i8, ptr %20, i64 16
  store <16 x i8> %wide.load203, ptr %21, align 1, !tbaa !15
  %index.next = add nuw i64 %index202, 32
...
vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  ...
  %n.vec205 = and i64 %indvars.iv193, 9223372036854775800
  br label %vec.epilog.vector.body

vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  %index207 = phi i64 [ %vec.epilog.resume.val, %vec.epilog.ph ], [ %index.next209, %vec.epilog.vector.body ]
  %23 = getelementptr inbounds i8, ptr %s.sroa.0.0130195, i64 %index207
  %wide.load208 = load <8 x i8>, ptr %23, align 1, !tbaa !15
  %24 = getelementptr inbounds i8, ptr %call.i.i.i76, i64 %index207
  store <8 x i8> %wide.load208, ptr %24, align 1, !tbaa !15
...
vec.epilog.middle.block:                          ; preds = %vec.epilog.vector.body
  %cmp.n206 = icmp eq i64 %indvars.iv193, %n.vec205
...
for.body.i.i.i.prol:                              ; preds = %for.body.i.i.i.preheader, %for.body.i.i.i.prol
  ...
  %arrayidx.i.i.i.prol = getelementptr inbounds i8, ptr %s.sroa.0.0130195, i64 %indvars.iv.i.i.i.prol
...
for.body.i.i.i:                                   ; preds = %for.body.i.i.i.prol.loopexit, %for.body.i.i.i
  ...
  %arrayidx.i.i.i = getelementptr inbounds i8, ptr %s.sroa.0.0130195, i64 %indvars.iv.i.i.i
  ...
  %arrayidx.i.i.i.1 = getelementptr inbounds i8, ptr %s.sroa.0.0130195, i64 %indvars.iv.next.i.i.i
  ...
  %arrayidx.i.i.i.2 = getelementptr inbounds i8, ptr %s.sroa.0.0130195, i64 %indvars.iv.next.i.i.i.1
  ...
  %arrayidx.i.i.i.3 = getelementptr inbounds i8, ptr %s.sroa.0.0130195, i64 %indvars.iv.next.i.i.i.2
...
if.end9.i.i.i:                                    ; preds = %delete.notnull.i.i.i, %call.i.i.i.noexc
  %arrayidx14.i.i.i = getelementptr inbounds i8, ptr %call.i.i.i76, i64 %indvars.iv193
  store i8 0, ptr %arrayidx14.i.i.i, align 1, !tbaa !15
  br label %for.inc

for.inc:                                          ; preds = %if.end9.i.i.i, %if.end.i.i75, %if.end
  %s.sroa.0.1 = phi ptr [ %s.sroa.0.0130195, %if.end.i.i75 ], [ %call.i.i.i76, %if.end9.i.i.i ], [ %s.sroa.0.0130195, %if.end ]
  %s.sroa.16.1 = phi i32 [ %s.sroa.16.0132194, %if.end.i.i75 ], [ %add.i.i.i, %if.end9.i.i.i ], [ %s.sroa.16.0132194, %if.end ]
