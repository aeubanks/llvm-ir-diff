...
entry:
  %ref.tmp.i2675 = alloca %class.btVector3, align 8
  %ref.tmp4.i2676 = alloca %class.btVector3, align 8
  %ref.tmp10.i2677 = alloca %class.btVector3, align 8
  %ref.tmp16.i2678 = alloca %class.btVector3, align 8
  %ref.tmp24.i2679 = alloca %class.btVector3, align 8
  %ref.tmp30.i2680 = alloca %class.btVector3, align 8
  %ref.tmp.i2628 = alloca %class.btVector3, align 8
  %ref.tmp4.i2629 = alloca %class.btVector3, align 8
  %ref.tmp10.i2630 = alloca %class.btVector3, align 8
  %ref.tmp16.i2631 = alloca %class.btVector3, align 8
  %ref.tmp24.i2632 = alloca %class.btVector3, align 8
  %ref.tmp30.i2633 = alloca %class.btVector3, align 8
  %ref.tmp.i2502 = alloca %class.btVector3, align 16
  %ref.tmp4.i2503 = alloca %class.btVector3, align 16
  %ref.tmp.i2494 = alloca %class.btVector3, align 16
  %ref.tmp4.i2495 = alloca %class.btVector3, align 16
  %ref.tmp.i2489 = alloca %class.btVector3, align 16
  %ref.tmp4.i2490 = alloca %class.btVector3, align 16
...
for.cond.preheader:                               ; preds = %entry
  ...
  %cmp93281 = icmp sgt i32 %0, 0
  br i1 %cmp93281, label %for.body.lr.ph, label %if.end71
...
for.cond75.preheader:                             ; preds = %if.end71
  ...
  %cmp773283 = icmp sgt i32 %33, 0
  br i1 %cmp773283, label %for.body78.lr.ph, label %if.end99
...
for.body78:                                       ; preds = %for.body78.lr.ph, %cleanup93
  ...
  %indvars.iv3330 = phi i64 [ 0, %for.body78.lr.ph ], [ %indvars.iv.next3331, %cleanup93 ]
  %35 = load ptr, ptr %m_data.i1250, align 8, !tbaa !26
  %m_material81 = getelementptr inbounds %"struct.btSoftBody::Link", ptr %35, i64 %indvars.iv3330, i32 0, i32 1
...
if.end86:                                         ; preds = %for.body78
  %m_n = getelementptr inbounds %"struct.btSoftBody::Link", ptr %35, i64 %indvars.iv3330, i32 1
  %38 = load ptr, ptr %m_n, align 8, !tbaa !27
  %m_x87 = getelementptr inbounds %"struct.btSoftBody::Node", ptr %38, i64 0, i32 1
  %arrayidx89 = getelementptr inbounds %"struct.btSoftBody::Link", ptr %35, i64 %indvars.iv3330, i32 1, i64 1
  ...
  %.pre3374 = load i32, ptr %m_size.i1249, align 4, !tbaa !23
  br label %cleanup93

cleanup93:                                        ; preds = %for.body78, %if.end86
  %41 = phi i32 [ %34, %for.body78 ], [ %.pre3374, %if.end86 ]
  %indvars.iv.next3331 = add nuw nsw i64 %indvars.iv3330, 1
  %42 = sext i32 %41 to i64
  %cmp77 = icmp slt i64 %indvars.iv.next3331, %42
...
for.cond103.preheader:                            ; preds = %if.end99
  ...
  %cmp1063285 = icmp sgt i32 %43, 0
  br i1 %cmp1063285, label %for.body107.lr.ph, label %if.end144
...
for.body107:                                      ; preds = %for.body107.lr.ph, %cleanup138
  ...
  %indvars.iv3333 = phi i64 [ 0, %for.body107.lr.ph ], [ %indvars.iv.next3334, %cleanup138 ]
  %48 = load ptr, ptr %m_data.i1254, align 8, !tbaa !15
  %m_material111 = getelementptr inbounds %"struct.btSoftBody::Node", ptr %48, i64 %indvars.iv3333, i32 0, i32 1
...
if.end116:                                        ; preds = %for.body107
  %m_n117 = getelementptr inbounds %"struct.btSoftBody::Node", ptr %48, i64 %indvars.iv3333, i32 5
  ...
  %m_x120 = getelementptr inbounds %"struct.btSoftBody::Node", ptr %48, i64 %indvars.iv3333, i32 1
  ...
  %.pre3375 = load i32, ptr %m_size.i1253, align 4, !tbaa !9
  br label %cleanup138

cleanup138:                                       ; preds = %for.body107, %if.end116
  %65 = phi i32 [ %47, %for.body107 ], [ %.pre3375, %if.end116 ]
  %indvars.iv.next3334 = add nuw nsw i64 %indvars.iv3333, 1
  %66 = sext i32 %65 to i64
  %cmp106 = icmp slt i64 %indvars.iv.next3334, %66
...
init.end:                                         ; preds = %init, %init.check, %if.then147
  ...
  %cmp1693287 = icmp sgt i32 %70, 0
  br i1 %cmp1693287, label %for.body170.lr.ph, label %if.end253
...
for.body170:                                      ; preds = %for.body170.lr.ph, %for.body170
  %indvars.iv3336 = phi i64 [ 0, %for.body170.lr.ph ], [ %indvars.iv.next3337, %for.body170 ]
  %77 = load ptr, ptr %m_data.i1299, align 8, !tbaa !32
  %arrayidx.i1301 = getelementptr inbounds %"struct.btSoftBody::RContact", ptr %77, i64 %indvars.iv3336
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %o) #18
  %m_node = getelementptr inbounds %"struct.btSoftBody::RContact", ptr %77, i64 %indvars.iv3336, i32 1
  ...
  %cmp169 = icmp slt i64 %indvars.iv.next3337, %155
...
for.cond257.preheader:                            ; preds = %if.end253
  ...
  %cmp2593289 = icmp sgt i32 %156, 0
  br i1 %cmp2593289, label %for.body260.lr.ph, label %for.cond287.preheader
...
for.cond287.preheader:                            ; preds = %for.body260, %for.cond257.preheader
  ...
  %cmp2903291 = icmp sgt i32 %170, 0
  br i1 %cmp2903291, label %for.body291.lr.ph, label %if.end315
...
for.body260:                                      ; preds = %for.body260.lr.ph, %for.body260
  %indvars.iv3339 = phi i64 [ 0, %for.body260.lr.ph ], [ %indvars.iv.next3340, %for.body260 ]
  %177 = load ptr, ptr %m_data.i1477, align 8, !tbaa !42
  %arrayidx.i1479 = getelementptr inbounds %"struct.btSoftBody::Anchor", ptr %177, i64 %indvars.iv3339
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %q) #18
  %m_body = getelementptr inbounds %"struct.btSoftBody::Anchor", ptr %177, i64 %indvars.iv3339, i32 2
  ...
  %m_local = getelementptr inbounds %"struct.btSoftBody::Anchor", ptr %177, i64 %indvars.iv3339, i32 1
  ...
  %cmp259 = icmp slt i64 %indvars.iv.next3340, %245
...
for.body291:                                      ; preds = %for.body291.lr.ph, %cleanup309
  ...
  %indvars.iv3342 = phi i64 [ 0, %for.body291.lr.ph ], [ %indvars.iv.next3343, %cleanup309 ]
  %247 = load ptr, ptr %m_data.i1544, align 8, !tbaa !15
  %m_material295 = getelementptr inbounds %"struct.btSoftBody::Node", ptr %247, i64 %indvars.iv3342, i32 0, i32 1
...
if.end300:                                        ; preds = %for.body291
  %m_im = getelementptr inbounds %"struct.btSoftBody::Node", ptr %247, i64 %indvars.iv3342, i32 6
...
if.then302:                                       ; preds = %if.end300
  %m_x303 = getelementptr inbounds %"struct.btSoftBody::Node", ptr %247, i64 %indvars.iv3342, i32 1
  ...
  %.pre3376 = load i32, ptr %m_size.i1543, align 4, !tbaa !9
  br label %cleanup309

cleanup309:                                       ; preds = %if.end300, %if.then302, %for.body291
  %266 = phi i32 [ %246, %if.end300 ], [ %.pre3376, %if.then302 ], [ %246, %for.body291 ]
  %indvars.iv.next3343 = add nuw nsw i64 %indvars.iv3342, 1
  %267 = sext i32 %266 to i64
  %cmp290 = icmp slt i64 %indvars.iv.next3343, %267
...
if.then318:                                       ; preds = %if.end315
  ...
  %cmp3253293 = icmp sgt i32 %268, 0
  br i1 %cmp3253293, label %for.body326.lr.ph, label %for.end396
...
for.body326:                                      ; preds = %for.body326.lr.ph, %cleanup391
  ...
  %indvars.iv3345 = phi i64 [ 0, %for.body326.lr.ph ], [ %indvars.iv.next3346, %cleanup391 ]
  %273 = load ptr, ptr %m_data.i1598, align 8, !tbaa !51
  %m_material329 = getelementptr inbounds %"struct.btSoftBody::Face", ptr %273, i64 %indvars.iv3345, i32 0, i32 1
...
if.end334:                                        ; preds = %for.body326
  %m_n336 = getelementptr inbounds %"struct.btSoftBody::Face", ptr %273, i64 %indvars.iv3345, i32 1
  ...
  %arrayidx340 = getelementptr inbounds %"struct.btSoftBody::Face", ptr %273, i64 %indvars.iv3345, i32 1, i64 1
  ...
  %arrayidx344 = getelementptr inbounds %"struct.btSoftBody::Face", ptr %273, i64 %indvars.iv3345, i32 1, i64 2
  ...
  %.pre3377 = load i32, ptr %m_size.i1597, align 4, !tbaa !48
  br label %cleanup391

cleanup391:                                       ; preds = %for.body326, %if.end334
  %300 = phi i32 [ %272, %for.body326 ], [ %.pre3377, %if.end334 ]
  %indvars.iv.next3346 = add nuw nsw i64 %indvars.iv3345, 1
  %301 = sext i32 %300 to i64
  %cmp325 = icmp slt i64 %indvars.iv.next3346, %301
...
if.then400:                                       ; preds = %if.end397
  ...
  %cmp4033299 = icmp sgt i32 %302, 0
  br i1 %cmp4033299, label %for.body404.lr.ph, label %if.end594
...
for.body404:                                      ; preds = %for.body404.lr.ph, %if.end544
  %indvars.iv3357 = phi i64 [ 0, %for.body404.lr.ph ], [ %indvars.iv.next3358, %if.end544 ]
  %306 = load ptr, ptr %m_data.i1736, align 8, !tbaa !59
  %arrayidx.i1738 = getelementptr inbounds ptr, ptr %306, i64 %indvars.iv3357
...
if.then408:                                       ; preds = %for.body404
  ...
  %arrayidx.i1767 = getelementptr inbounds ptr, ptr %321, i64 %indvars.iv3357
...
invoke.cont436:                                   ; preds = %if.then.i.i.i
  %cmp4413295 = icmp sgt i32 %323, 0
  br i1 %cmp4413295, label %for.body442.preheader, label %for.end454
...
for.body442:                                      ; preds = %for.body442, %for.body442.preheader.new
  %indvars.iv3348 = phi i64 [ 0, %for.body442.preheader.new ], [ %indvars.iv.next3349.1, %for.body442 ]
  %niter = phi i64 [ 0, %for.body442.preheader.new ], [ %niter.next.1, %for.body442 ]
  %325 = load ptr, ptr %m_data.i1736, align 8, !tbaa !59
  %arrayidx.i1777 = getelementptr inbounds ptr, ptr %325, i64 %indvars.iv3357
  ...
  %arrayidx.i1780 = getelementptr inbounds ptr, ptr %327, i64 %indvars.iv3348
  %328 = load ptr, ptr %arrayidx.i1780, align 8, !tbaa !27
  %m_x449 = getelementptr inbounds %"struct.btSoftBody::Node", ptr %328, i64 0, i32 1
  %arrayidx.i1783 = getelementptr inbounds %class.btVector3, ptr %call.i.i.i.i1773, i64 %indvars.iv3348
  ...
  %indvars.iv.next3349 = or i64 %indvars.iv3348, 1
  %329 = load ptr, ptr %m_data.i1736, align 8, !tbaa !59
  %arrayidx.i1777.1 = getelementptr inbounds ptr, ptr %329, i64 %indvars.iv3357
  ...
  %arrayidx.i1780.1 = getelementptr inbounds ptr, ptr %331, i64 %indvars.iv.next3349
  ...
  %arrayidx.i1783.1 = getelementptr inbounds %class.btVector3, ptr %call.i.i.i.i1773, i64 %indvars.iv.next3349
  ...
  %indvars.iv.next3349.1 = add nuw nsw i64 %indvars.iv3348, 2
...
for.end454.loopexit.unr-lcssa:                    ; preds = %for.body442, %for.body442.preheader
  %indvars.iv3348.unr = phi i64 [ 0, %for.body442.preheader ], [ %indvars.iv.next3349.1, %for.body442 ]
...
for.body442.epil:                                 ; preds = %for.end454.loopexit.unr-lcssa
  ...
  %arrayidx.i1777.epil = getelementptr inbounds ptr, ptr %334, i64 %indvars.iv3357
  ...
  %arrayidx.i1780.epil = getelementptr inbounds ptr, ptr %336, i64 %indvars.iv3348.unr
  ...
  %arrayidx.i1783.epil = getelementptr inbounds %class.btVector3, ptr %call.i.i.i.i1773, i64 %indvars.iv3348.unr
...
for.end454:                                       ; preds = %for.body442.epil, %for.end454.loopexit.unr-lcssa, %if.then408, %invoke.cont436
  %vertices.sroa.173153.13383 = phi ptr [ %call.i.i.i.i1773, %invoke.cont436 ], [ null, %if.then408 ], [ %call.i.i.i.i1773, %for.end454.loopexit.unr-lcssa ], [ %call.i.i.i.i1773, %for.body442.epil ]
  ...
  store ptr %vertices.sroa.173153.13383, ptr %mVertices.i, align 8, !tbaa !76
...
invoke.cont468:                                   ; preds = %for.end454
  ...
  br i1 %tobool.not.i.i, label %_ZL7averageI9btVector3ET_RK20btAlignedObjectArrayIS1_E.exit, label %if.then.i.i1798
...
if.then.i.i1798:                                  ; preds = %invoke.cont468
  ...
  br i1 %cmp6.i.i, label %for.body.preheader.i.i, label %_ZL7averageI9btVector3ET_RK20btAlignedObjectArrayIS1_E.exit
...
for.body.preheader.i.i:                           ; preds = %if.then.i.i1798
  ...
  %xtraiter3412 = and i64 %338, 1
  %339 = icmp eq i32 %m_OutputVertices.val, 2
  br i1 %339, label %_ZL7averageI9btVector3ET_RK20btAlignedObjectArrayIS1_E.exit.loopexit.unr-lcssa, label %for.body.preheader.i.i.new

for.body.preheader.i.i.new:                       ; preds = %for.body.preheader.i.i
  %unroll_iter3416 = and i64 %338, -2
...
for.body.i.i:                                     ; preds = %for.body.i.i, %for.body.preheader.i.i.new
  ...
  %niter3417 = phi i64 [ 0, %for.body.preheader.i.i.new ], [ %niter3417.next.1, %for.body.i.i ]
  ...
  %niter3417.next.1 = add i64 %niter3417, 2
  %niter3417.ncmp.1 = icmp eq i64 %niter3417.next.1, %unroll_iter3416
  br i1 %niter3417.ncmp.1, label %_ZL7averageI9btVector3ET_RK20btAlignedObjectArrayIS1_E.exit.loopexit.unr-lcssa, label %for.body.i.i

_ZL7averageI9btVector3ET_RK20btAlignedObjectArrayIS1_E.exit.loopexit.unr-lcssa: ; preds = %for.body.i.i, %for.body.preheader.i.i
  ...
  %lcmp.mod3413.not = icmp eq i64 %xtraiter3412, 0
  br i1 %lcmp.mod3413.not, label %_ZL7averageI9btVector3ET_RK20btAlignedObjectArrayIS1_E.exit, label %for.body.i.i.epil

for.body.i.i.epil:                                ; preds = %_ZL7averageI9btVector3ET_RK20btAlignedObjectArrayIS1_E.exit.loopexit.unr-lcssa
  ...
  br label %_ZL7averageI9btVector3ET_RK20btAlignedObjectArrayIS1_E.exit

_ZL7averageI9btVector3ET_RK20btAlignedObjectArrayIS1_E.exit: ; preds = %for.body.i.i.epil, %_ZL7averageI9btVector3ET_RK20btAlignedObjectArrayIS1_E.exit.loopexit.unr-lcssa, %invoke.cont468, %if.then.i.i1798
  %retval.sroa.6.1.i.i = phi <2 x float> [ undef, %invoke.cont468 ], [ %retval.sroa.6.0.copyload.i.i, %if.then.i.i1798 ], [ %retval.sroa.6.8.vec.insert.i.i.lcssa.ph, %_ZL7averageI9btVector3ET_RK20btAlignedObjectArrayIS1_E.exit.loopexit.unr-lcssa ], [ %retval.sroa.6.8.vec.insert.i.i.epil, %for.body.i.i.epil ]
  %retval.sroa.0.1.i.i = phi <2 x float> [ undef, %invoke.cont468 ], [ %retval.sroa.0.0.copyload.i.i, %if.then.i.i1798 ], [ %.lcssa.ph, %_ZL7averageI9btVector3ET_RK20btAlignedObjectArrayIS1_E.exit.loopexit.unr-lcssa ], [ %347, %for.body.i.i.epil ]
...
for.body.i:                                       ; preds = %for.body.i, %for.body.lr.ph.i.new
  ...
  %niter3421.next.1 = add i64 %niter3421, 2
  %niter3421.ncmp.1 = icmp eq i64 %niter3421.next.1, %unroll_iter3420
  br i1 %niter3421.ncmp.1, label %for.body.lr.ph.i1846.unr-lcssa, label %for.body.i
...
for.body.lr.ph.i1846.unr-lcssa:                   ; preds = %for.body.i, %for.body.lr.ph.i
  ...
  %lcmp.mod3419.not = icmp eq i64 %xtraiter3418, 0
  br i1 %lcmp.mod3419.not, label %for.body.lr.ph.i1846, label %for.body.i.epil
...
for.body.lr.ph.i1846:                             ; preds = %for.body.lr.ph.i1846.unr-lcssa, %for.body.i.epil
  %m_OutputVertices.val1156 = load ptr, ptr %m_data.i.i.i1787, align 8
  %xtraiter3422 = and i64 %wide.trip.count.i1823, 1
...
for.body.lr.ph.i1846.new:                         ; preds = %for.body.lr.ph.i1846
  %unroll_iter3424 = and i64 %wide.trip.count.i1823, 4294967294
...
for.body.i1856:                                   ; preds = %for.body.i1856, %for.body.lr.ph.i1846.new
  ...
  %niter3425 = phi i64 [ 0, %for.body.lr.ph.i1846.new ], [ %niter3425.next.1, %for.body.i1856 ]
  %arrayidx.i.i1848 = getelementptr inbounds %class.btVector3, ptr %m_OutputVertices.val1156, i64 %indvars.iv.i1847
  ...
  %arrayidx.i.i1848.1 = getelementptr inbounds %class.btVector3, ptr %m_OutputVertices.val1156, i64 %indvars.iv.next.i1854
  ...
  %niter3425.next.1 = add i64 %niter3425, 2
  %niter3425.ncmp.1 = icmp eq i64 %niter3425.next.1, %unroll_iter3424
  br i1 %niter3425.ncmp.1, label %_ZL3addI9btVector3S0_EvR20btAlignedObjectArrayIT_ERKT0_.exit1857.loopexit.unr-lcssa, label %for.body.i1856
...
_ZL3addI9btVector3S0_EvR20btAlignedObjectArrayIT_ERKT0_.exit1857.loopexit.unr-lcssa: ; preds = %for.body.i1856, %for.body.lr.ph.i1846
  ...
  %lcmp.mod3423.not = icmp eq i64 %xtraiter3422, 0
  br i1 %lcmp.mod3423.not, label %_ZL3addI9btVector3S0_EvR20btAlignedObjectArrayIT_ERKT0_.exit1857, label %for.body.i1856.epil

for.body.i1856.epil:                              ; preds = %_ZL3addI9btVector3S0_EvR20btAlignedObjectArrayIT_ERKT0_.exit1857.loopexit.unr-lcssa
  %arrayidx.i.i1848.epil = getelementptr inbounds %class.btVector3, ptr %m_OutputVertices.val1156, i64 %indvars.iv.i1847.unr
...
_ZL3addI9btVector3S0_EvR20btAlignedObjectArrayIT_ERKT0_.exit1857: ; preds = %for.body.i1856.epil, %_ZL3addI9btVector3S0_EvR20btAlignedObjectArrayIT_ERKT0_.exit1857.loopexit.unr-lcssa, %_ZL7averageI9btVector3ET_RK20btAlignedObjectArrayIS1_E.exit
  %375 = load i32, ptr %mNumFaces.i, align 8, !tbaa !92
  %cmp4903297 = icmp sgt i32 %375, 0
  br i1 %cmp4903297, label %for.body491, label %for.end527

for.body491:                                      ; preds = %_ZL3addI9btVector3S0_EvR20btAlignedObjectArrayIT_ERKT0_.exit1857, %invoke.cont523
  %indvars.iv3351 = phi i64 [ %indvars.iv.next3352, %invoke.cont523 ], [ 0, %_ZL3addI9btVector3S0_EvR20btAlignedObjectArrayIT_ERKT0_.exit1857 ]
  %376 = mul nuw nsw i64 %indvars.iv3351, 3
...
invoke.cont523:                                   ; preds = %for.body491
  ...
  %cmp490 = icmp slt i64 %indvars.iv.next3352, %386
...
lpad.i:                                           ; preds = %if.then3.i.i.i.i
  ...
  %tobool.not.i.i.i2923 = icmp eq ptr %397, null
  %398 = load i8, ptr %m_ownsMemory.i.i.i1789, align 8, !range !69
  %tobool2.not.i.i.i2925 = icmp eq i8 %398, 0
  %or.cond.i.i2926 = select i1 %tobool.not.i.i.i2923, i1 true, i1 %tobool2.not.i.i.i2925
  br i1 %or.cond.i.i2926, label %ehcleanup534, label %if.then3.i.i.i2927

if.then3.i.i.i2927:                               ; preds = %lpad.i
  invoke void @_Z21btAlignedFreeInternalPv(ptr noundef nonnull %397)
          to label %ehcleanup534 unwind label %terminate.lpad.i

terminate.lpad.i:                                 ; preds = %if.then3.i.i.i2927
...
lpad.i1893:                                       ; preds = %if.then3.i.i.i.i1882
  ...
  %tobool.not.i.i.i2932 = icmp eq ptr %406, null
  %407 = load i8, ptr %m_ownsMemory.i.i.i1786, align 8, !range !69
  %tobool2.not.i.i.i2934 = icmp eq i8 %407, 0
  %or.cond.i.i2935 = select i1 %tobool.not.i.i.i2932, i1 true, i1 %tobool2.not.i.i.i2934
  br i1 %or.cond.i.i2935, label %ehcleanup540, label %if.then3.i.i.i2936

if.then3.i.i.i2936:                               ; preds = %lpad.i1893
  invoke void @_Z21btAlignedFreeInternalPv(ptr noundef nonnull %406)
          to label %ehcleanup540 unwind label %terminate.lpad.i1895

terminate.lpad.i1895:                             ; preds = %if.then3.i.i.i2936
...
_ZN10HullResultD2Ev.exit:                         ; preds = %if.then3.i.i.i10.i1890, %_ZN20btAlignedObjectArrayIjED2Ev.exit.i
  ...
  %tobool.not.i.i.i1899 = icmp eq ptr %vertices.sroa.173153.13383, null
...
if.then3.i.i.i1903:                               ; preds = %_ZN10HullResultD2Ev.exit
  call void @_Z21btAlignedFreeInternalPv(ptr noundef nonnull %vertices.sroa.173153.13383)
...
_ZN20btAlignedObjectArrayI9btVector3ED2Ev.exit:   ; preds = %_ZN10HullResultD2Ev.exit, %if.then3.i.i.i1903
  ...
  %.pre3378 = load ptr, ptr %m_data.i1736, align 8, !tbaa !59
  %arrayidx.i1918.phi.trans.insert = getelementptr inbounds ptr, ptr %.pre3378, i64 %indvars.iv3357
  %.pre3379 = load ptr, ptr %arrayidx.i1918.phi.trans.insert, align 8, !tbaa !27
  br label %if.end544
...
ehcleanup534:                                     ; preds = %lpad.i, %if.then3.i.i.i2927, %lpad463, %ehcleanup532
  %.pn.pn = phi { ptr, i32 } [ %.pn, %ehcleanup532 ], [ %388, %lpad463 ], [ %396, %if.then3.i.i.i2927 ], [ %396, %lpad.i ]
  call void @llvm.lifetime.end.p0(i64 64, ptr nonnull %hlib) #18
...
ehcleanup540:                                     ; preds = %lpad.i1893, %if.then3.i.i.i2936, %lpad461, %ehcleanup534
  %.pn.pn.pn = phi { ptr, i32 } [ %.pn.pn, %ehcleanup534 ], [ %387, %lpad461 ], [ %405, %if.then3.i.i.i2936 ], [ %405, %lpad.i1893 ]
  call void @llvm.lifetime.end.p0(i64 80, ptr nonnull %hres) #18
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %hdsc) #18
  %tobool.not.i.i.i1907 = icmp eq ptr %vertices.sroa.173153.13383, null
  br i1 %tobool.not.i.i.i1907, label %invoke.cont541, label %if.then3.i.i.i1911

if.then3.i.i.i1911:                               ; preds = %ehcleanup540
  invoke void @_Z21btAlignedFreeInternalPv(ptr noundef nonnull %vertices.sroa.173153.13383)
          to label %invoke.cont541 unwind label %terminate.lpad

common.resume:                                    ; preds = %lpad.i2802, %lpad.i2773, %lpad.i2754, %lpad.i2735, %lpad.i2619, %lpad.i2598, %lpad.i2556, %lpad.i2515, %invoke.cont541
  %common.resume.op = phi { ptr, i32 } [ %.pn3315, %invoke.cont541 ], [ %557, %lpad.i2515 ], [ %595, %lpad.i2556 ], [ %633, %lpad.i2598 ], [ %640, %lpad.i2619 ], [ %677, %lpad.i2735 ], [ %683, %lpad.i2754 ], [ %689, %lpad.i2773 ], [ %724, %lpad.i2802 ]
  resume { ptr, i32 } %common.resume.op

invoke.cont541:                                   ; preds = %ehcleanup540.thread, %ehcleanup540, %if.then3.i.i.i1911
  %.pn3315 = phi { ptr, i32 } [ %333, %ehcleanup540.thread ], [ %.pn.pn.pn, %ehcleanup540 ], [ %.pn.pn.pn, %if.then3.i.i.i1911 ]
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %color) #18
...
if.end544:                                        ; preds = %_ZN20btAlignedObjectArrayI9btVector3ED2Ev.exit, %for.body404
  %410 = phi ptr [ %.pre3379, %_ZN20btAlignedObjectArrayI9btVector3ED2Ev.exit ], [ %307, %for.body404 ]
  ...
  %arrayidx5.i.i.i1922 = getelementptr inbounds %"struct.btSoftBody::Cluster", ptr %410, i64 0, i32 3, i32 0, i32 0, i64 0, i32 0, i64 1
  %arrayidx10.i.i.i1925 = getelementptr inbounds %"struct.btSoftBody::Cluster", ptr %410, i64 0, i32 3, i32 0, i32 0, i64 0, i32 0, i64 2
  %m_origin.i.i1927 = getelementptr inbounds %"struct.btSoftBody::Cluster", ptr %410, i64 0, i32 3, i32 1
  %arrayidx.i.i.i1929 = getelementptr inbounds %"struct.btSoftBody::Cluster", ptr %410, i64 0, i32 3, i32 0, i32 0, i64 1
  %arrayidx5.i20.i.i1930 = getelementptr inbounds %"struct.btSoftBody::Cluster", ptr %410, i64 0, i32 3, i32 0, i32 0, i64 1, i32 0, i64 1
  %arrayidx10.i23.i.i1932 = getelementptr inbounds %"struct.btSoftBody::Cluster", ptr %410, i64 0, i32 3, i32 0, i32 0, i64 1, i32 0, i64 2
  %411 = load float, ptr %m_framexform, align 4, !tbaa !5
  %412 = load float, ptr %arrayidx5.i.i.i1922, align 4, !tbaa !5
  %413 = load float, ptr %arrayidx10.i.i.i1925, align 4, !tbaa !5
  %414 = load float, ptr %arrayidx.i.i.i1929, align 4, !tbaa !5
  %415 = load float, ptr %arrayidx5.i20.i.i1930, align 4, !tbaa !5
  ...
  %422 = load float, ptr %arrayidx10.i23.i.i1932, align 4, !tbaa !5
  ...
  %426 = load <2 x float>, ptr %m_origin.i.i1927, align 4, !tbaa !5
  %427 = fadd <2 x float> %426, %425
  %arrayidx.i26.i.i1935 = getelementptr inbounds %"struct.btSoftBody::Cluster", ptr %410, i64 0, i32 3, i32 0, i32 0, i64 2
  %428 = load float, ptr %arrayidx.i26.i.i1935, align 4, !tbaa !5
  %arrayidx5.i27.i.i1936 = getelementptr inbounds %"struct.btSoftBody::Cluster", ptr %410, i64 0, i32 3, i32 0, i32 0, i64 2, i32 0, i64 1
  %429 = load float, ptr %arrayidx5.i27.i.i1936, align 4, !tbaa !5
  %mul8.i29.i.i1937 = fmul float %429, 0.000000e+00
  %430 = call float @llvm.fmuladd.f32(float %428, float 1.000000e+01, float %mul8.i29.i.i1937)
  %arrayidx10.i30.i.i1938 = getelementptr inbounds %"struct.btSoftBody::Cluster", ptr %410, i64 0, i32 3, i32 0, i32 0, i64 2, i32 0, i64 2
  %431 = load float, ptr %arrayidx10.i30.i.i1938, align 4, !tbaa !5
  %432 = call float @llvm.fmuladd.f32(float %431, float 0.000000e+00, float %430)
  %arrayidx.i32.i.i1939 = getelementptr inbounds %"struct.btSoftBody::Cluster", ptr %410, i64 0, i32 3, i32 1, i32 0, i64 2
  %433 = load float, ptr %arrayidx.i32.i.i1939, align 4, !tbaa !5
  %add17.i.i1940 = fadd float %433, %432
  %retval.sroa.3.12.vec.insert.i.i1943 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %add17.i.i1940, i64 0
  store <2 x float> %427, ptr %ref.tmp548, align 8
  store <2 x float> %retval.sroa.3.12.vec.insert.i.i1943, ptr %303, align 8
  ...
  %436 = load float, ptr %arrayidx5.i.i.i1922, align 4, !tbaa !5
  %437 = load float, ptr %arrayidx10.i.i.i1925, align 4, !tbaa !5
  %438 = load float, ptr %arrayidx.i.i.i1929, align 4, !tbaa !5
  %439 = load float, ptr %arrayidx5.i20.i.i1930, align 4, !tbaa !5
  ...
  %446 = load float, ptr %arrayidx10.i23.i.i1932, align 4, !tbaa !5
  ...
  %450 = load <2 x float>, ptr %m_origin.i.i1927, align 4, !tbaa !5
  %451 = fadd <2 x float> %450, %449
  %452 = load float, ptr %arrayidx.i26.i.i1935, align 4, !tbaa !5
  %453 = load float, ptr %arrayidx5.i27.i.i1936, align 4, !tbaa !5
  %mul8.i29.i.i1967 = fmul float %453, 1.000000e+01
  %454 = call float @llvm.fmuladd.f32(float %452, float 0.000000e+00, float %mul8.i29.i.i1967)
  %455 = load float, ptr %arrayidx10.i30.i.i1938, align 4, !tbaa !5
  %456 = call float @llvm.fmuladd.f32(float %455, float 0.000000e+00, float %454)
  %457 = load float, ptr %arrayidx.i32.i.i1939, align 4, !tbaa !5
  %add17.i.i1970 = fadd float %457, %456
  %retval.sroa.3.12.vec.insert.i.i1973 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %add17.i.i1970, i64 0
  store <2 x float> %451, ptr %ref.tmp562, align 8
  store <2 x float> %retval.sroa.3.12.vec.insert.i.i1973, ptr %304, align 8
  ...
  %460 = load float, ptr %arrayidx5.i.i.i1922, align 4, !tbaa !5
  %461 = load float, ptr %arrayidx10.i.i.i1925, align 4, !tbaa !5
  %462 = load float, ptr %arrayidx.i.i.i1929, align 4, !tbaa !5
  %463 = load float, ptr %arrayidx5.i20.i.i1930, align 4, !tbaa !5
  ...
  %470 = load float, ptr %arrayidx10.i23.i.i1932, align 4, !tbaa !5
  ...
  %474 = load <2 x float>, ptr %m_origin.i.i1927, align 4, !tbaa !5
  %475 = fadd <2 x float> %474, %473
  %476 = load float, ptr %arrayidx.i26.i.i1935, align 4, !tbaa !5
  %477 = load float, ptr %arrayidx5.i27.i.i1936, align 4, !tbaa !5
  %mul8.i29.i.i1997 = fmul float %477, 0.000000e+00
  %478 = call float @llvm.fmuladd.f32(float %476, float 0.000000e+00, float %mul8.i29.i.i1997)
  %479 = load float, ptr %arrayidx10.i30.i.i1938, align 4, !tbaa !5
  %480 = call float @llvm.fmuladd.f32(float %479, float 1.000000e+01, float %478)
  %481 = load float, ptr %arrayidx.i32.i.i1939, align 4, !tbaa !5
  %add17.i.i2000 = fadd float %481, %480
  %retval.sroa.3.12.vec.insert.i.i2003 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %add17.i.i2000, i64 0
  store <2 x float> %475, ptr %ref.tmp577, align 8
  store <2 x float> %retval.sroa.3.12.vec.insert.i.i2003, ptr %305, align 8
  ...
  %cmp403 = icmp slt i64 %indvars.iv.next3358, %484
...
if.then597:                                       ; preds = %if.end594
  ...
  %m_size.i2012 = getelementptr inbounds %class.btSoftBody, ptr %psb, i64 0, i32 12, i32 2
  %485 = load i32, ptr %m_size.i2012, align 4, !tbaa !108
  %cmp6073301 = icmp sgt i32 %485, 0
  br i1 %cmp6073301, label %for.body608.lr.ph, label %for.cond.cleanup

for.body608.lr.ph:                                ; preds = %if.then597
  %m_data.i2013 = getelementptr inbounds %class.btSoftBody, ptr %psb, i64 0, i32 12, i32 5
...
for.body608:                                      ; preds = %for.body608.lr.ph, %cleanup779
  ...
  %indvars.iv3360 = phi i64 [ 0, %for.body608.lr.ph ], [ %indvars.iv.next3361, %cleanup779 ]
  %499 = load ptr, ptr %m_data.i2013, align 8, !tbaa !111
  %m_material611 = getelementptr inbounds %"struct.btSoftBody::Tetra", ptr %499, i64 %indvars.iv3360, i32 0, i32 1
...
if.end616:                                        ; preds = %for.body608
  %m_n619 = getelementptr inbounds %"struct.btSoftBody::Tetra", ptr %499, i64 %indvars.iv3360, i32 1
  ...
  %arrayidx624 = getelementptr inbounds %"struct.btSoftBody::Tetra", ptr %499, i64 %indvars.iv3360, i32 1, i64 1
  %503 = load ptr, ptr %arrayidx624, align 8, !tbaa !27
  %m_x625 = getelementptr inbounds %"struct.btSoftBody::Node", ptr %503, i64 0, i32 1
  %x617.sroa.153100.16.copyload = load float, ptr %m_x625, align 8, !tbaa.struct !52
  ...
  %arrayidx628 = getelementptr inbounds %"struct.btSoftBody::Tetra", ptr %499, i64 %indvars.iv3360, i32 1, i64 2
  %504 = load ptr, ptr %arrayidx628, align 8, !tbaa !27
  %m_x629 = getelementptr inbounds %"struct.btSoftBody::Node", ptr %504, i64 0, i32 1
  %x617.sroa.283110.32.copyload = load float, ptr %m_x629, align 8, !tbaa.struct !52
  ...
  %arrayidx632 = getelementptr inbounds %"struct.btSoftBody::Tetra", ptr %499, i64 %indvars.iv3360, i32 1, i64 3
  %505 = load ptr, ptr %arrayidx632, align 8, !tbaa !27
  %m_x633 = getelementptr inbounds %"struct.btSoftBody::Node", ptr %505, i64 0, i32 1
  %x617.sroa.413120.48.copyload = load float, ptr %m_x633, align 8, !tbaa.struct !52
  ...
  %add.i2016 = fadd float %x617.sroa.0.0.copyload, %x617.sroa.153100.16.copyload
  %add8.i2019 = fadd float %x617.sroa.7.0.copyload, %x617.sroa.20.16.copyload
  %add14.i2022 = fadd float %x617.sroa.11.0.copyload, %x617.sroa.24.16.copyload
  %add.i2028 = fadd float %add.i2016, %x617.sroa.283110.32.copyload
  %add8.i2031 = fadd float %add8.i2019, %x617.sroa.33.32.copyload
  %add14.i2034 = fadd float %add14.i2022, %x617.sroa.37.32.copyload
  %add.i2040 = fadd float %add.i2028, %x617.sroa.413120.48.copyload
  %add8.i2043 = fadd float %add8.i2031, %x617.sroa.46.48.copyload
  %add14.i2046 = fadd float %add14.i2034, %x617.sroa.50.48.copyload
  %mul.i.i2053 = fmul float %add.i2040, 2.500000e-01
  %mul4.i.i2055 = fmul float %add8.i2043, 2.500000e-01
  %mul8.i.i2057 = fmul float %add14.i2046, 2.500000e-01
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %ref.tmp651) #18
  %sub.i2063 = fsub float %x617.sroa.0.0.copyload, %mul.i.i2053
  %sub8.i2066 = fsub float %x617.sroa.7.0.copyload, %mul4.i.i2055
  %sub14.i2069 = fsub float %x617.sroa.11.0.copyload, %mul8.i.i2057
  %mul.i2075 = fmul float %sub.i2063, 0x3FE99999A0000000
  %mul4.i2077 = fmul float %sub8.i2066, 0x3FE99999A0000000
  %mul8.i2079 = fmul float %sub14.i2069, 0x3FE99999A0000000
  %add.i2085 = fadd float %mul.i.i2053, %mul.i2075
  %add8.i2088 = fadd float %mul4.i.i2055, %mul4.i2077
  %add14.i2091 = fadd float %mul8.i.i2057, %mul8.i2079
  %retval.sroa.0.0.vec.insert.i2092 = insertelement <2 x float> undef, float %add.i2085, i64 0
  %retval.sroa.0.4.vec.insert.i2093 = insertelement <2 x float> %retval.sroa.0.0.vec.insert.i2092, float %add8.i2088, i64 1
  %retval.sroa.3.12.vec.insert.i2094 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %add14.i2091, i64 0
  store <2 x float> %retval.sroa.0.4.vec.insert.i2093, ptr %ref.tmp651, align 8
  store <2 x float> %retval.sroa.3.12.vec.insert.i2094, ptr %486, align 8
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %ref.tmp661) #18
  %sub.i2097 = fsub float %x617.sroa.153100.16.copyload, %mul.i.i2053
  %sub8.i2100 = fsub float %x617.sroa.20.16.copyload, %mul4.i.i2055
  %sub14.i2103 = fsub float %x617.sroa.24.16.copyload, %mul8.i.i2057
  %mul.i2109 = fmul float %sub.i2097, 0x3FE99999A0000000
  %mul4.i2111 = fmul float %sub8.i2100, 0x3FE99999A0000000
  %mul8.i2113 = fmul float %sub14.i2103, 0x3FE99999A0000000
  %add.i2119 = fadd float %mul.i.i2053, %mul.i2109
  %add8.i2122 = fadd float %mul4.i.i2055, %mul4.i2111
  %add14.i2125 = fadd float %mul8.i.i2057, %mul8.i2113
  %retval.sroa.0.0.vec.insert.i2126 = insertelement <2 x float> undef, float %add.i2119, i64 0
  %retval.sroa.0.4.vec.insert.i2127 = insertelement <2 x float> %retval.sroa.0.0.vec.insert.i2126, float %add8.i2122, i64 1
  %retval.sroa.3.12.vec.insert.i2128 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %add14.i2125, i64 0
  store <2 x float> %retval.sroa.0.4.vec.insert.i2127, ptr %ref.tmp661, align 8
  store <2 x float> %retval.sroa.3.12.vec.insert.i2128, ptr %487, align 8
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %ref.tmp671) #18
  %sub.i2131 = fsub float %x617.sroa.283110.32.copyload, %mul.i.i2053
  %sub8.i2134 = fsub float %x617.sroa.33.32.copyload, %mul4.i.i2055
  %sub14.i2137 = fsub float %x617.sroa.37.32.copyload, %mul8.i.i2057
  %mul.i2143 = fmul float %sub.i2131, 0x3FE99999A0000000
  %mul4.i2145 = fmul float %sub8.i2134, 0x3FE99999A0000000
  %mul8.i2147 = fmul float %sub14.i2137, 0x3FE99999A0000000
  %add.i2153 = fadd float %mul.i.i2053, %mul.i2143
  %add8.i2156 = fadd float %mul4.i.i2055, %mul4.i2145
  %add14.i2159 = fadd float %mul8.i.i2057, %mul8.i2147
  %retval.sroa.0.0.vec.insert.i2160 = insertelement <2 x float> undef, float %add.i2153, i64 0
  %retval.sroa.0.4.vec.insert.i2161 = insertelement <2 x float> %retval.sroa.0.0.vec.insert.i2160, float %add8.i2156, i64 1
  %retval.sroa.3.12.vec.insert.i2162 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %add14.i2159, i64 0
  store <2 x float> %retval.sroa.0.4.vec.insert.i2161, ptr %ref.tmp671, align 8
  store <2 x float> %retval.sroa.3.12.vec.insert.i2162, ptr %488, align 8
  ...
  store <2 x float> %retval.sroa.0.4.vec.insert.i2093, ptr %ref.tmp683, align 8
  store <2 x float> %retval.sroa.3.12.vec.insert.i2094, ptr %489, align 8
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %ref.tmp693) #18
  store <2 x float> %retval.sroa.0.4.vec.insert.i2127, ptr %ref.tmp693, align 8
  store <2 x float> %retval.sroa.3.12.vec.insert.i2128, ptr %490, align 8
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %ref.tmp703) #18
  %sub.i2233 = fsub float %x617.sroa.413120.48.copyload, %mul.i.i2053
  %sub8.i2236 = fsub float %x617.sroa.46.48.copyload, %mul4.i.i2055
  %sub14.i2239 = fsub float %x617.sroa.50.48.copyload, %mul8.i.i2057
  %mul.i2245 = fmul float %sub.i2233, 0x3FE99999A0000000
  %mul4.i2247 = fmul float %sub8.i2236, 0x3FE99999A0000000
  %mul8.i2249 = fmul float %sub14.i2239, 0x3FE99999A0000000
  %add.i2255 = fadd float %mul.i.i2053, %mul.i2245
  %add8.i2258 = fadd float %mul4.i.i2055, %mul4.i2247
  %add14.i2261 = fadd float %mul8.i.i2057, %mul8.i2249
  %retval.sroa.0.0.vec.insert.i2262 = insertelement <2 x float> undef, float %add.i2255, i64 0
  %retval.sroa.0.4.vec.insert.i2263 = insertelement <2 x float> %retval.sroa.0.0.vec.insert.i2262, float %add8.i2258, i64 1
  %retval.sroa.3.12.vec.insert.i2264 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %add14.i2261, i64 0
  store <2 x float> %retval.sroa.0.4.vec.insert.i2263, ptr %ref.tmp703, align 8
  store <2 x float> %retval.sroa.3.12.vec.insert.i2264, ptr %491, align 8
  ...
  store <2 x float> %retval.sroa.0.4.vec.insert.i2127, ptr %ref.tmp715, align 8
  store <2 x float> %retval.sroa.3.12.vec.insert.i2128, ptr %492, align 8
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %ref.tmp725) #18
  store <2 x float> %retval.sroa.0.4.vec.insert.i2161, ptr %ref.tmp725, align 8
  store <2 x float> %retval.sroa.3.12.vec.insert.i2162, ptr %493, align 8
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %ref.tmp735) #18
  store <2 x float> %retval.sroa.0.4.vec.insert.i2263, ptr %ref.tmp735, align 8
  store <2 x float> %retval.sroa.3.12.vec.insert.i2264, ptr %494, align 8
  ...
  store <2 x float> %retval.sroa.0.4.vec.insert.i2161, ptr %ref.tmp747, align 8
  store <2 x float> %retval.sroa.3.12.vec.insert.i2162, ptr %495, align 8
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %ref.tmp757) #18
  store <2 x float> %retval.sroa.0.4.vec.insert.i2093, ptr %ref.tmp757, align 8
  store <2 x float> %retval.sroa.3.12.vec.insert.i2094, ptr %496, align 8
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %ref.tmp767) #18
  store <2 x float> %retval.sroa.0.4.vec.insert.i2263, ptr %ref.tmp767, align 8
  store <2 x float> %retval.sroa.3.12.vec.insert.i2264, ptr %497, align 8
  ...
  %.pre3380 = load i32, ptr %m_size.i2012, align 4, !tbaa !108
  br label %cleanup779

cleanup779:                                       ; preds = %for.body608, %if.end616
  %510 = phi i32 [ %498, %for.body608 ], [ %.pre3380, %if.end616 ]
  %indvars.iv.next3361 = add nuw nsw i64 %indvars.iv3360, 1
  %511 = sext i32 %510 to i64
  %cmp607 = icmp slt i64 %indvars.iv.next3361, %511
...
for.cond790.preheader:                            ; preds = %if.end786
  %m_size.i2471 = getelementptr inbounds %class.btSoftBody, ptr %psb, i64 0, i32 8, i32 2
  %512 = load i32, ptr %m_size.i2471, align 4, !tbaa !112
  %cmp7923309 = icmp sgt i32 %512, 0
  br i1 %cmp7923309, label %for.body793.lr.ph, label %if.end822

for.body793.lr.ph:                                ; preds = %for.cond790.preheader
  %m_data.i2472 = getelementptr inbounds %class.btSoftBody, ptr %psb, i64 0, i32 8, i32 5
...
for.body793:                                      ; preds = %for.body793.lr.ph, %for.cond.cleanup801
  %indvars.iv3368 = phi i64 [ 0, %for.body793.lr.ph ], [ %indvars.iv.next3369, %for.cond.cleanup801 ]
  %513 = load ptr, ptr %m_data.i2472, align 8, !tbaa !115
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %p) #18
  %m_offset797 = getelementptr inbounds %"struct.btSoftBody::Note", ptr %513, i64 %indvars.iv3368, i32 2
  ...
  %m_rank = getelementptr inbounds %"struct.btSoftBody::Note", ptr %513, i64 %indvars.iv3368, i32 3
  %514 = load i32, ptr %m_rank, align 8, !tbaa !116
  %cmp8003304 = icmp sgt i32 %514, 0
  br i1 %cmp8003304, label %for.body802.lr.ph, label %for.cond.cleanup801
...
for.body802.lr.ph:                                ; preds = %for.body793
  ...
  %wide.trip.count3366 = zext i32 %514 to i64
  br label %for.body802

for.cond.cleanup801:                              ; preds = %for.body802, %for.body793
  %m_text = getelementptr inbounds %"struct.btSoftBody::Note", ptr %513, i64 %indvars.iv3368, i32 1
  ...
  %518 = load i32, ptr %m_size.i2471, align 4, !tbaa !112
  %519 = sext i32 %518 to i64
  %cmp792 = icmp slt i64 %indvars.iv.next3369, %519
  br i1 %cmp792, label %for.body793, label %if.end822

for.body802:                                      ; preds = %for.body802.lr.ph, %for.body802
  %indvars.iv3363 = phi i64 [ 0, %for.body802.lr.ph ], [ %indvars.iv.next3364, %for.body802 ]
  %add13.i3308 = phi float [ %arrayidx12.i.promoted, %for.body802.lr.ph ], [ %add13.i, %for.body802 ]
  %520 = phi <2 x float> [ %515, %for.body802.lr.ph ], [ %528, %for.body802 ]
  %arrayidx806 = getelementptr inbounds %"struct.btSoftBody::Note", ptr %513, i64 %indvars.iv3368, i32 4, i64 %indvars.iv3363
  %521 = load ptr, ptr %arrayidx806, align 8, !tbaa !27
  %m_x807 = getelementptr inbounds %"struct.btSoftBody::Node", ptr %521, i64 0, i32 1
  %arrayidx809 = getelementptr inbounds %"struct.btSoftBody::Note", ptr %513, i64 %indvars.iv3368, i32 5, i64 %indvars.iv3363
  %522 = load float, ptr %arrayidx809, align 4, !tbaa !5
  %arrayidx7.i2478 = getelementptr inbounds %"struct.btSoftBody::Node", ptr %521, i64 0, i32 1, i32 0, i64 2
  %523 = load float, ptr %arrayidx7.i2478, align 4, !tbaa !5
  %mul8.i2479 = fmul float %522, %523
  ...
  %add13.i = fadd float %mul8.i2479, %add13.i3308
  ...
  br i1 %exitcond3367.not, label %for.cond.cleanup801, label %for.body802
...
if.then825:                                       ; preds = %if.end822
  ...
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %ref.tmp.i2489) #18
  store <4 x float> <float 1.000000e+00, float 0.000000e+00, float 1.000000e+00, float 0.000000e+00>, ptr %ref.tmp.i2489, align 16, !tbaa !5
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %ref.tmp4.i2490) #18
  store <4 x float> <float 1.000000e+00, float 1.000000e+00, float 1.000000e+00, float 0.000000e+00>, ptr %ref.tmp4.i2490, align 16, !tbaa !5
  call fastcc void @_ZL8drawTreeP12btIDebugDrawPK10btDbvtNodeiRK9btVector3S6_ii(ptr noundef %idraw, ptr noundef %529, i32 noundef 0, ptr noundef nonnull align 4 dereferenceable(16) %ref.tmp.i2489, ptr noundef nonnull align 4 dereferenceable(16) %ref.tmp4.i2490, i32 noundef 0, i32 noundef -1)
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %ref.tmp4.i2490) #18
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %ref.tmp.i2489) #18
  br label %if.end826
...
if.then829:                                       ; preds = %if.end826
  ...
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %ref.tmp.i2494) #18
  store <4 x float> <float 0.000000e+00, float 1.000000e+00, float 0.000000e+00, float 0.000000e+00>, ptr %ref.tmp.i2494, align 16, !tbaa !5
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %ref.tmp4.i2495) #18
  store <4 x float> <float 1.000000e+00, float 0.000000e+00, float 0.000000e+00, float 0.000000e+00>, ptr %ref.tmp4.i2495, align 16, !tbaa !5
  call fastcc void @_ZL8drawTreeP12btIDebugDrawPK10btDbvtNodeiRK9btVector3S6_ii(ptr noundef %idraw, ptr noundef %530, i32 noundef 0, ptr noundef nonnull align 4 dereferenceable(16) %ref.tmp.i2494, ptr noundef nonnull align 4 dereferenceable(16) %ref.tmp4.i2495, i32 noundef 0, i32 noundef -1)
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %ref.tmp4.i2495) #18
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %ref.tmp.i2494) #18
  br label %if.end830
...
if.then833:                                       ; preds = %if.end830
  ...
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %ref.tmp.i2502) #18
  store <4 x float> <float 0.000000e+00, float 1.000000e+00, float 1.000000e+00, float 0.000000e+00>, ptr %ref.tmp.i2502, align 16, !tbaa !5
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %ref.tmp4.i2503) #18
  store <4 x float> <float 1.000000e+00, float 0.000000e+00, float 0.000000e+00, float 0.000000e+00>, ptr %ref.tmp4.i2503, align 16, !tbaa !5
  call fastcc void @_ZL8drawTreeP12btIDebugDrawPK10btDbvtNodeiRK9btVector3S6_ii(ptr noundef %idraw, ptr noundef %531, i32 noundef 0, ptr noundef nonnull align 4 dereferenceable(16) %ref.tmp.i2502, ptr noundef nonnull align 4 dereferenceable(16) %ref.tmp4.i2503, i32 noundef 0, i32 noundef -1)
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %ref.tmp4.i2503) #18
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %ref.tmp.i2502) #18
  br label %if.end834
...
for.cond838.preheader:                            ; preds = %if.end834
  %m_size.i2510 = getelementptr inbounds %class.btSoftBody, ptr %psb, i64 0, i32 16, i32 2
  %532 = load i32, ptr %m_size.i2510, align 4, !tbaa !145
  %cmp8403311 = icmp sgt i32 %532, 0
  br i1 %cmp8403311, label %for.body841.lr.ph, label %if.end969

for.body841.lr.ph:                                ; preds = %for.cond838.preheader
  %m_data.i2511 = getelementptr inbounds %class.btSoftBody, ptr %psb, i64 0, i32 16, i32 5
  %arrayidx11.i2836 = getelementptr inbounds [4 x float], ptr %o0, i64 0, i64 2
  ...
  %arrayidx11.i2886 = getelementptr inbounds [4 x float], ptr %o1, i64 0, i64 2
  ...
  %539 = getelementptr inbounds { <2 x float>, <2 x float> }, ptr %ref.tmp.i2628, i64 0, i32 1
  %540 = getelementptr inbounds { <2 x float>, <2 x float> }, ptr %ref.tmp4.i2629, i64 0, i32 1
  %541 = getelementptr inbounds { <2 x float>, <2 x float> }, ptr %ref.tmp10.i2630, i64 0, i32 1
  %542 = getelementptr inbounds { <2 x float>, <2 x float> }, ptr %ref.tmp16.i2631, i64 0, i32 1
  %543 = getelementptr inbounds { <2 x float>, <2 x float> }, ptr %ref.tmp24.i2632, i64 0, i32 1
  %544 = getelementptr inbounds { <2 x float>, <2 x float> }, ptr %ref.tmp30.i2633, i64 0, i32 1
  %545 = getelementptr inbounds { <2 x float>, <2 x float> }, ptr %ref.tmp.i2675, i64 0, i32 1
  %546 = getelementptr inbounds { <2 x float>, <2 x float> }, ptr %ref.tmp4.i2676, i64 0, i32 1
  %547 = getelementptr inbounds { <2 x float>, <2 x float> }, ptr %ref.tmp10.i2677, i64 0, i32 1
  %548 = getelementptr inbounds { <2 x float>, <2 x float> }, ptr %ref.tmp16.i2678, i64 0, i32 1
  %549 = getelementptr inbounds { <2 x float>, <2 x float> }, ptr %ref.tmp24.i2679, i64 0, i32 1
  %550 = getelementptr inbounds { <2 x float>, <2 x float> }, ptr %ref.tmp30.i2680, i64 0, i32 1
  br label %for.body841

for.body841:                                      ; preds = %for.body841.lr.ph, %sw.epilog
  %indvars.iv3371 = phi i64 [ 0, %for.body841.lr.ph ], [ %indvars.iv.next3372, %sw.epilog ]
  %551 = load ptr, ptr %m_data.i2511, align 8, !tbaa !146
  %arrayidx.i2513 = getelementptr inbounds ptr, ptr %551, i64 %indvars.iv3371
  %552 = load ptr, ptr %arrayidx.i2513, align 8, !tbaa !27
...
init.i:                                           ; preds = %init.check.i
  %call.i = invoke noundef nonnull align 4 dereferenceable(64) ptr @_ZN11btTransform11getIdentityEv()
          to label %invoke.cont.i unwind label %lpad.i2515
...
invoke.cont.i:                                    ; preds = %init.i
  ...
  %arrayidx10.i.i.i2514 = getelementptr inbounds [3 x %class.btVector3], ptr %call.i, i64 0, i64 2
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) getelementptr inbounds (%class.btTransform, ptr @_ZZNK10btSoftBody4Body5xformEvE8identity, i64 0, i32 0, i32 0, i64 2), ptr noundef nonnull align 4 dereferenceable(16) %arrayidx10.i.i.i2514, i64 16, i1 false), !tbaa.struct !52
...
_ZNK10btSoftBody4Body5xformEv.exit:               ; preds = %sw.bb, %init.check.i, %invoke.cont.i
  ...
  %arrayidx5.i.i.i2516 = getelementptr inbounds [4 x float], ptr %retval.0.i, i64 0, i64 1
  %arrayidx7.i.i.i2517 = getelementptr inbounds %"struct.btSoftBody::Joint", ptr %552, i64 0, i32 2, i64 0, i32 0, i64 1
  %561 = load float, ptr %arrayidx7.i.i.i2517, align 4, !tbaa !5
  %arrayidx10.i.i.i2519 = getelementptr inbounds [4 x float], ptr %retval.0.i, i64 0, i64 2
  %arrayidx12.i.i.i2520 = getelementptr inbounds %"struct.btSoftBody::Joint", ptr %552, i64 0, i32 2, i64 0, i32 0, i64 2
  %562 = load float, ptr %arrayidx12.i.i.i2520, align 4, !tbaa !5
  %m_origin.i.i2521 = getelementptr inbounds %class.btTransform, ptr %retval.0.i, i64 0, i32 1
  %arrayidx.i.i.i2523 = getelementptr inbounds [3 x %class.btVector3], ptr %retval.0.i, i64 0, i64 1
  %arrayidx5.i20.i.i2524 = getelementptr inbounds [3 x %class.btVector3], ptr %retval.0.i, i64 0, i64 1, i32 0, i64 1
  %arrayidx10.i23.i.i2526 = getelementptr inbounds [3 x %class.btVector3], ptr %retval.0.i, i64 0, i64 1, i32 0, i64 2
  %563 = load float, ptr %retval.0.i, align 4, !tbaa !5
  %564 = load float, ptr %arrayidx5.i.i.i2516, align 4, !tbaa !5
  %565 = load float, ptr %arrayidx10.i.i.i2519, align 4, !tbaa !5
  %566 = load float, ptr %arrayidx.i.i.i2523, align 4, !tbaa !5
  %567 = load float, ptr %arrayidx5.i20.i.i2524, align 4, !tbaa !5
  ...
  %578 = load float, ptr %arrayidx10.i23.i.i2526, align 4, !tbaa !5
  ...
  %584 = load <2 x float>, ptr %m_origin.i.i2521, align 4, !tbaa !5
  %585 = fadd <2 x float> %583, %584
  %arrayidx.i26.i.i2529 = getelementptr inbounds [3 x %class.btVector3], ptr %retval.0.i, i64 0, i64 2
  %586 = load float, ptr %arrayidx.i26.i.i2529, align 4, !tbaa !5
  %arrayidx5.i27.i.i2530 = getelementptr inbounds [3 x %class.btVector3], ptr %retval.0.i, i64 0, i64 2, i32 0, i64 1
  %587 = load float, ptr %arrayidx5.i27.i.i2530, align 4, !tbaa !5
  %mul8.i29.i.i2531 = fmul float %561, %587
  %588 = call float @llvm.fmuladd.f32(float %586, float %560, float %mul8.i29.i.i2531)
  %arrayidx10.i30.i.i2532 = getelementptr inbounds [3 x %class.btVector3], ptr %retval.0.i, i64 0, i64 2, i32 0, i64 2
  %589 = load float, ptr %arrayidx10.i30.i.i2532, align 4, !tbaa !5
  %590 = call float @llvm.fmuladd.f32(float %589, float %562, float %588)
  %arrayidx.i32.i.i2533 = getelementptr inbounds %class.btTransform, ptr %retval.0.i, i64 0, i32 1, i32 0, i64 2
  %591 = load float, ptr %arrayidx.i32.i.i2533, align 4, !tbaa !5
  %add17.i.i2534 = fadd float %591, %590
  %retval.sroa.3.12.vec.insert.i.i2537 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %add17.i.i2534, i64 0
  store <2 x float> %585, ptr %a0, align 8
  store <2 x float> %retval.sroa.3.12.vec.insert.i.i2537, ptr %537, align 8
  ...
  %guard.uninitialized.i2540 = icmp eq i8 %592, 0
  br i1 %guard.uninitialized.i2540, label %init.check.i2542, label %_ZNK10btSoftBody4Body5xformEv.exit2557, !prof !28

init.check.i2542:                                 ; preds = %_ZNK10btSoftBody4Body5xformEv.exit
  %593 = call i32 @__cxa_guard_acquire(ptr nonnull @_ZGVZNK10btSoftBody4Body5xformEvE8identity) #18
  %tobool.not.i2541 = icmp eq i32 %593, 0
  br i1 %tobool.not.i2541, label %_ZNK10btSoftBody4Body5xformEv.exit2557, label %init.i2544

init.i2544:                                       ; preds = %init.check.i2542
  %call.i2543 = invoke noundef nonnull align 4 dereferenceable(64) ptr @_ZN11btTransform11getIdentityEv()
          to label %invoke.cont.i2548 unwind label %lpad.i2556

invoke.cont.i2548:                                ; preds = %init.i2544
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) @_ZZNK10btSoftBody4Body5xformEvE8identity, ptr noundef nonnull align 4 dereferenceable(16) %call.i2543, i64 16, i1 false), !tbaa.struct !52
  %arrayidx6.i.i.i2545 = getelementptr inbounds [3 x %class.btVector3], ptr %call.i2543, i64 0, i64 1
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) getelementptr inbounds (%class.btTransform, ptr @_ZZNK10btSoftBody4Body5xformEvE8identity, i64 0, i32 0, i32 0, i64 1), ptr noundef nonnull align 4 dereferenceable(16) %arrayidx6.i.i.i2545, i64 16, i1 false), !tbaa.struct !52
  %arrayidx10.i.i.i2546 = getelementptr inbounds [3 x %class.btVector3], ptr %call.i2543, i64 0, i64 2
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) getelementptr inbounds (%class.btTransform, ptr @_ZZNK10btSoftBody4Body5xformEvE8identity, i64 0, i32 0, i32 0, i64 2), ptr noundef nonnull align 4 dereferenceable(16) %arrayidx10.i.i.i2546, i64 16, i1 false), !tbaa.struct !52
  %m_origin3.i.i2547 = getelementptr inbounds %class.btTransform, ptr %call.i2543, i64 0, i32 1
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) getelementptr inbounds (%class.btTransform, ptr @_ZZNK10btSoftBody4Body5xformEvE8identity, i64 0, i32 1), ptr noundef nonnull align 4 dereferenceable(16) %m_origin3.i.i2547, i64 16, i1 false), !tbaa.struct !52
  %594 = call ptr @llvm.invariant.start.p0(i64 64, ptr nonnull @_ZZNK10btSoftBody4Body5xformEvE8identity)
  call void @__cxa_guard_release(ptr nonnull @_ZGVZNK10btSoftBody4Body5xformEvE8identity) #18
  br label %_ZNK10btSoftBody4Body5xformEv.exit2557

lpad.i2556:                                       ; preds = %init.i2544
  %595 = landingpad { ptr, i32 }
          cleanup
  call void @__cxa_guard_abort(ptr nonnull @_ZGVZNK10btSoftBody4Body5xformEvE8identity) #18
  br label %common.resume

_ZNK10btSoftBody4Body5xformEv.exit2557:           ; preds = %_ZNK10btSoftBody4Body5xformEv.exit, %init.check.i2542, %invoke.cont.i2548
  %m_collisionObject.i2549 = getelementptr inbounds %"struct.btSoftBody::Joint", ptr %552, i64 0, i32 1, i64 1, i32 2
  %596 = load ptr, ptr %m_collisionObject.i2549, align 8, !tbaa !147
  %tobool3.not.i2550 = icmp eq ptr %596, null
  %m_interpolationWorldTransform.i.i2551 = getelementptr inbounds %class.btCollisionObject, ptr %596, i64 0, i32 2
  %597 = load ptr, ptr %arrayidx853, align 8
  %tobool6.not.i2552 = icmp eq ptr %597, null
  %m_framexform.i2553 = getelementptr inbounds %"struct.btSoftBody::Cluster", ptr %597, i64 0, i32 3
  %spec.select.i2554 = select i1 %tobool6.not.i2552, ptr @_ZZNK10btSoftBody4Body5xformEvE8identity, ptr %m_framexform.i2553
  %retval.0.i2555 = select i1 %tobool3.not.i2550, ptr %spec.select.i2554, ptr %m_interpolationWorldTransform.i.i2551
  ...
  %arrayidx5.i.i.i2558 = getelementptr inbounds [4 x float], ptr %retval.0.i2555, i64 0, i64 1
  %arrayidx7.i.i.i2559 = getelementptr inbounds %"struct.btSoftBody::Joint", ptr %552, i64 0, i32 2, i64 1, i32 0, i64 1
  %599 = load float, ptr %arrayidx7.i.i.i2559, align 4, !tbaa !5
  %arrayidx10.i.i.i2561 = getelementptr inbounds [4 x float], ptr %retval.0.i2555, i64 0, i64 2
  %arrayidx12.i.i.i2562 = getelementptr inbounds %"struct.btSoftBody::Joint", ptr %552, i64 0, i32 2, i64 1, i32 0, i64 2
  %600 = load float, ptr %arrayidx12.i.i.i2562, align 4, !tbaa !5
  %m_origin.i.i2563 = getelementptr inbounds %class.btTransform, ptr %retval.0.i2555, i64 0, i32 1
  %arrayidx.i.i.i2565 = getelementptr inbounds [3 x %class.btVector3], ptr %retval.0.i2555, i64 0, i64 1
  %arrayidx5.i20.i.i2566 = getelementptr inbounds [3 x %class.btVector3], ptr %retval.0.i2555, i64 0, i64 1, i32 0, i64 1
  %arrayidx10.i23.i.i2568 = getelementptr inbounds [3 x %class.btVector3], ptr %retval.0.i2555, i64 0, i64 1, i32 0, i64 2
  %601 = load float, ptr %retval.0.i2555, align 4, !tbaa !5
  %602 = load float, ptr %arrayidx5.i.i.i2558, align 4, !tbaa !5
  %603 = load float, ptr %arrayidx10.i.i.i2561, align 4, !tbaa !5
  %604 = load float, ptr %arrayidx.i.i.i2565, align 4, !tbaa !5
  %605 = load float, ptr %arrayidx5.i20.i.i2566, align 4, !tbaa !5
  ...
  %616 = load float, ptr %arrayidx10.i23.i.i2568, align 4, !tbaa !5
  ...
  %622 = load <2 x float>, ptr %m_origin.i.i2563, align 4, !tbaa !5
  %623 = fadd <2 x float> %621, %622
  %arrayidx.i26.i.i2571 = getelementptr inbounds [3 x %class.btVector3], ptr %retval.0.i2555, i64 0, i64 2
  %624 = load float, ptr %arrayidx.i26.i.i2571, align 4, !tbaa !5
  %arrayidx5.i27.i.i2572 = getelementptr inbounds [3 x %class.btVector3], ptr %retval.0.i2555, i64 0, i64 2, i32 0, i64 1
  %625 = load float, ptr %arrayidx5.i27.i.i2572, align 4, !tbaa !5
  %mul8.i29.i.i2573 = fmul float %599, %625
  %626 = call float @llvm.fmuladd.f32(float %624, float %598, float %mul8.i29.i.i2573)
  %arrayidx10.i30.i.i2574 = getelementptr inbounds [3 x %class.btVector3], ptr %retval.0.i2555, i64 0, i64 2, i32 0, i64 2
  %627 = load float, ptr %arrayidx10.i30.i.i2574, align 4, !tbaa !5
  %628 = call float @llvm.fmuladd.f32(float %627, float %600, float %626)
  %arrayidx.i32.i.i2575 = getelementptr inbounds %class.btTransform, ptr %retval.0.i2555, i64 0, i32 1, i32 0, i64 2
  %629 = load float, ptr %arrayidx.i32.i.i2575, align 4, !tbaa !5
  %add17.i.i2576 = fadd float %629, %628
  %retval.sroa.3.12.vec.insert.i.i2579 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %add17.i.i2576, i64 0
  store <2 x float> %623, ptr %a1, align 8
  store <2 x float> %retval.sroa.3.12.vec.insert.i.i2579, ptr %538, align 8
  %630 = load atomic i8, ptr @_ZGVZNK10btSoftBody4Body5xformEvE8identity acquire, align 8
  %guard.uninitialized.i2582 = icmp eq i8 %630, 0
  br i1 %guard.uninitialized.i2582, label %init.check.i2584, label %_ZNK10btSoftBody4Body5xformEv.exit2599, !prof !28

init.check.i2584:                                 ; preds = %_ZNK10btSoftBody4Body5xformEv.exit2557
  %631 = call i32 @__cxa_guard_acquire(ptr nonnull @_ZGVZNK10btSoftBody4Body5xformEvE8identity) #18
  %tobool.not.i2583 = icmp eq i32 %631, 0
  br i1 %tobool.not.i2583, label %_ZNK10btSoftBody4Body5xformEv.exit2599, label %init.i2586

init.i2586:                                       ; preds = %init.check.i2584
  %call.i2585 = invoke noundef nonnull align 4 dereferenceable(64) ptr @_ZN11btTransform11getIdentityEv()
          to label %invoke.cont.i2590 unwind label %lpad.i2598

invoke.cont.i2590:                                ; preds = %init.i2586
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) @_ZZNK10btSoftBody4Body5xformEvE8identity, ptr noundef nonnull align 4 dereferenceable(16) %call.i2585, i64 16, i1 false), !tbaa.struct !52
  %arrayidx6.i.i.i2587 = getelementptr inbounds [3 x %class.btVector3], ptr %call.i2585, i64 0, i64 1
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) getelementptr inbounds (%class.btTransform, ptr @_ZZNK10btSoftBody4Body5xformEvE8identity, i64 0, i32 0, i32 0, i64 1), ptr noundef nonnull align 4 dereferenceable(16) %arrayidx6.i.i.i2587, i64 16, i1 false), !tbaa.struct !52
  %arrayidx10.i.i.i2588 = getelementptr inbounds [3 x %class.btVector3], ptr %call.i2585, i64 0, i64 2
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) getelementptr inbounds (%class.btTransform, ptr @_ZZNK10btSoftBody4Body5xformEvE8identity, i64 0, i32 0, i32 0, i64 2), ptr noundef nonnull align 4 dereferenceable(16) %arrayidx10.i.i.i2588, i64 16, i1 false), !tbaa.struct !52
  %m_origin3.i.i2589 = getelementptr inbounds %class.btTransform, ptr %call.i2585, i64 0, i32 1
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) getelementptr inbounds (%class.btTransform, ptr @_ZZNK10btSoftBody4Body5xformEvE8identity, i64 0, i32 1), ptr noundef nonnull align 4 dereferenceable(16) %m_origin3.i.i2589, i64 16, i1 false), !tbaa.struct !52
  %632 = call ptr @llvm.invariant.start.p0(i64 64, ptr nonnull @_ZZNK10btSoftBody4Body5xformEvE8identity)
  call void @__cxa_guard_release(ptr nonnull @_ZGVZNK10btSoftBody4Body5xformEvE8identity) #18
  br label %_ZNK10btSoftBody4Body5xformEv.exit2599

lpad.i2598:                                       ; preds = %init.i2586
  %633 = landingpad { ptr, i32 }
          cleanup
  call void @__cxa_guard_abort(ptr nonnull @_ZGVZNK10btSoftBody4Body5xformEvE8identity) #18
  br label %common.resume

_ZNK10btSoftBody4Body5xformEv.exit2599:           ; preds = %_ZNK10btSoftBody4Body5xformEv.exit2557, %init.check.i2584, %invoke.cont.i2590
  %634 = load ptr, ptr %m_collisionObject.i, align 8, !tbaa !147
  %tobool3.not.i2592 = icmp eq ptr %634, null
  %m_interpolationWorldTransform.i.i2593 = getelementptr inbounds %class.btCollisionObject, ptr %634, i64 0, i32 2
  %635 = load ptr, ptr %m_bodies, align 8
  %tobool6.not.i2594 = icmp eq ptr %635, null
  %m_framexform.i2595 = getelementptr inbounds %"struct.btSoftBody::Cluster", ptr %635, i64 0, i32 3
  %spec.select.i2596 = select i1 %tobool6.not.i2594, ptr @_ZZNK10btSoftBody4Body5xformEvE8identity, ptr %m_framexform.i2595
  %retval.0.i2597 = select i1 %tobool3.not.i2592, ptr %spec.select.i2596, ptr %m_interpolationWorldTransform.i.i2593
  %m_origin.i = getelementptr inbounds %class.btTransform, ptr %retval.0.i2597, i64 0, i32 1
  ...
  %guard.uninitialized.i2603 = icmp eq i8 %637, 0
  br i1 %guard.uninitialized.i2603, label %init.check.i2605, label %_ZNK10btSoftBody4Body5xformEv.exit2620, !prof !28

init.check.i2605:                                 ; preds = %_ZNK10btSoftBody4Body5xformEv.exit2599
  %638 = call i32 @__cxa_guard_acquire(ptr nonnull @_ZGVZNK10btSoftBody4Body5xformEvE8identity) #18
  %tobool.not.i2604 = icmp eq i32 %638, 0
  br i1 %tobool.not.i2604, label %_ZNK10btSoftBody4Body5xformEv.exit2620, label %init.i2607

init.i2607:                                       ; preds = %init.check.i2605
  %call.i2606 = invoke noundef nonnull align 4 dereferenceable(64) ptr @_ZN11btTransform11getIdentityEv()
          to label %invoke.cont.i2611 unwind label %lpad.i2619

invoke.cont.i2611:                                ; preds = %init.i2607
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) @_ZZNK10btSoftBody4Body5xformEvE8identity, ptr noundef nonnull align 4 dereferenceable(16) %call.i2606, i64 16, i1 false), !tbaa.struct !52
  %arrayidx6.i.i.i2608 = getelementptr inbounds [3 x %class.btVector3], ptr %call.i2606, i64 0, i64 1
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) getelementptr inbounds (%class.btTransform, ptr @_ZZNK10btSoftBody4Body5xformEvE8identity, i64 0, i32 0, i32 0, i64 1), ptr noundef nonnull align 4 dereferenceable(16) %arrayidx6.i.i.i2608, i64 16, i1 false), !tbaa.struct !52
  %arrayidx10.i.i.i2609 = getelementptr inbounds [3 x %class.btVector3], ptr %call.i2606, i64 0, i64 2
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) getelementptr inbounds (%class.btTransform, ptr @_ZZNK10btSoftBody4Body5xformEvE8identity, i64 0, i32 0, i32 0, i64 2), ptr noundef nonnull align 4 dereferenceable(16) %arrayidx10.i.i.i2609, i64 16, i1 false), !tbaa.struct !52
  %m_origin3.i.i2610 = getelementptr inbounds %class.btTransform, ptr %call.i2606, i64 0, i32 1
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) getelementptr inbounds (%class.btTransform, ptr @_ZZNK10btSoftBody4Body5xformEvE8identity, i64 0, i32 1), ptr noundef nonnull align 4 dereferenceable(16) %m_origin3.i.i2610, i64 16, i1 false), !tbaa.struct !52
  %639 = call ptr @llvm.invariant.start.p0(i64 64, ptr nonnull @_ZZNK10btSoftBody4Body5xformEvE8identity)
  call void @__cxa_guard_release(ptr nonnull @_ZGVZNK10btSoftBody4Body5xformEvE8identity) #18
  br label %_ZNK10btSoftBody4Body5xformEv.exit2620

lpad.i2619:                                       ; preds = %init.i2607
  %640 = landingpad { ptr, i32 }
          cleanup
  call void @__cxa_guard_abort(ptr nonnull @_ZGVZNK10btSoftBody4Body5xformEvE8identity) #18
  br label %common.resume

_ZNK10btSoftBody4Body5xformEv.exit2620:           ; preds = %_ZNK10btSoftBody4Body5xformEv.exit2599, %init.check.i2605, %invoke.cont.i2611
  %641 = load ptr, ptr %m_collisionObject.i2549, align 8, !tbaa !147
  %tobool3.not.i2613 = icmp eq ptr %641, null
  %m_interpolationWorldTransform.i.i2614 = getelementptr inbounds %class.btCollisionObject, ptr %641, i64 0, i32 2
  %642 = load ptr, ptr %arrayidx853, align 8
  %tobool6.not.i2615 = icmp eq ptr %642, null
  %m_framexform.i2616 = getelementptr inbounds %"struct.btSoftBody::Cluster", ptr %642, i64 0, i32 3
  %spec.select.i2617 = select i1 %tobool6.not.i2615, ptr @_ZZNK10btSoftBody4Body5xformEvE8identity, ptr %m_framexform.i2616
  %retval.0.i2618 = select i1 %tobool3.not.i2613, ptr %spec.select.i2617, ptr %m_interpolationWorldTransform.i.i2614
  %m_origin.i2621 = getelementptr inbounds %class.btTransform, ptr %retval.0.i2618, i64 0, i32 1
  ...
  call void %643(ptr noundef nonnull align 8 dereferenceable(8) %idraw, ptr noundef nonnull align 4 dereferenceable(16) %m_origin.i2621, ptr noundef nonnull align 4 dereferenceable(16) %a1, ptr noundef nonnull align 4 dereferenceable(16) %ref.tmp873)
  ...
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %ref.tmp.i2628) #18
  %644 = load float, ptr %537, align 8, !tbaa !5
  %retval.sroa.3.12.vec.insert.i.i2639 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %644, i64 0
  store <2 x float> %retval.sroa.3.12.vec.insert.i.i2639, ptr %539, align 8
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %ref.tmp4.i2629) #18
  %645 = load <2 x float>, ptr %a0, align 8, !tbaa !5
  %646 = extractelement <2 x float> %645, i64 0
  %sub.i.i2634 = fadd float %646, -2.500000e-01
  %647 = insertelement <2 x float> %645, float %sub.i.i2634, i64 0
  store <2 x float> %647, ptr %ref.tmp.i2628, align 8
  %648 = fadd <2 x float> %645, <float 2.500000e-01, float 0.000000e+00>
  %add14.i.i2642 = fadd float %644, 0.000000e+00
  %retval.sroa.3.12.vec.insert.i58.i2645 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %add14.i.i2642, i64 0
  store <2 x float> %648, ptr %ref.tmp4.i2629, align 8
  store <2 x float> %retval.sroa.3.12.vec.insert.i58.i2645, ptr %540, align 8
  %vtable.i2646 = load ptr, ptr %idraw, align 8, !tbaa !21
  %vfn.i2647 = getelementptr inbounds ptr, ptr %vtable.i2646, i64 5
  %649 = load ptr, ptr %vfn.i2647, align 8
  call void %649(ptr noundef nonnull align 8 dereferenceable(8) %idraw, ptr noundef nonnull align 4 dereferenceable(16) %ref.tmp.i2628, ptr noundef nonnull align 4 dereferenceable(16) %ref.tmp4.i2629, ptr noundef nonnull align 4 dereferenceable(16) %ref.tmp879)
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %ref.tmp4.i2629) #18
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %ref.tmp.i2628) #18
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %ref.tmp10.i2630) #18
  %650 = load float, ptr %537, align 8, !tbaa !5
  %retval.sroa.3.12.vec.insert.i73.i2651 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %650, i64 0
  store <2 x float> %retval.sroa.3.12.vec.insert.i73.i2651, ptr %541, align 8
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %ref.tmp16.i2631) #18
  %651 = load <2 x float>, ptr %a0, align 8, !tbaa !5
  %652 = extractelement <2 x float> %651, i64 1
  %sub8.i67.i2648 = fadd float %652, -2.500000e-01
  %retval.sroa.0.4.vec.insert.i72.i2650 = insertelement <2 x float> %651, float %sub8.i67.i2648, i64 1
  store <2 x float> %retval.sroa.0.4.vec.insert.i72.i2650, ptr %ref.tmp10.i2630, align 8
  %653 = fadd <2 x float> %651, <float 0.000000e+00, float 2.500000e-01>
  %add14.i85.i2654 = fadd float %650, 0.000000e+00
  %retval.sroa.3.12.vec.insert.i88.i2657 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %add14.i85.i2654, i64 0
  store <2 x float> %653, ptr %ref.tmp16.i2631, align 8
  store <2 x float> %retval.sroa.3.12.vec.insert.i88.i2657, ptr %542, align 8
  %vtable22.i2658 = load ptr, ptr %idraw, align 8, !tbaa !21
  %vfn23.i2659 = getelementptr inbounds ptr, ptr %vtable22.i2658, i64 5
  %654 = load ptr, ptr %vfn23.i2659, align 8
  call void %654(ptr noundef nonnull align 8 dereferenceable(8) %idraw, ptr noundef nonnull align 4 dereferenceable(16) %ref.tmp10.i2630, ptr noundef nonnull align 4 dereferenceable(16) %ref.tmp16.i2631, ptr noundef nonnull align 4 dereferenceable(16) %ref.tmp879)
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %ref.tmp16.i2631) #18
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %ref.tmp10.i2630) #18
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %ref.tmp24.i2632) #18
  %655 = load <2 x float>, ptr %a0, align 8, !tbaa !5
  %656 = load float, ptr %537, align 8, !tbaa !5
  %sub14.i100.i2660 = fadd float %656, -2.500000e-01
  %retval.sroa.3.12.vec.insert.i103.i2663 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %sub14.i100.i2660, i64 0
  store <2 x float> %655, ptr %ref.tmp24.i2632, align 8
  store <2 x float> %retval.sroa.3.12.vec.insert.i103.i2663, ptr %543, align 8
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %ref.tmp30.i2633) #18
  %657 = fadd <2 x float> %655, zeroinitializer
  %add14.i115.i2666 = fadd float %656, 2.500000e-01
  %retval.sroa.3.12.vec.insert.i118.i2669 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %add14.i115.i2666, i64 0
  store <2 x float> %657, ptr %ref.tmp30.i2633, align 8
  store <2 x float> %retval.sroa.3.12.vec.insert.i118.i2669, ptr %544, align 8
  %vtable36.i2670 = load ptr, ptr %idraw, align 8, !tbaa !21
  %vfn37.i2671 = getelementptr inbounds ptr, ptr %vtable36.i2670, i64 5
  %658 = load ptr, ptr %vfn37.i2671, align 8
  call void %658(ptr noundef nonnull align 8 dereferenceable(8) %idraw, ptr noundef nonnull align 4 dereferenceable(16) %ref.tmp24.i2632, ptr noundef nonnull align 4 dereferenceable(16) %ref.tmp30.i2633, ptr noundef nonnull align 4 dereferenceable(16) %ref.tmp879)
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %ref.tmp30.i2633) #18
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %ref.tmp24.i2632) #18
  ...
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %ref.tmp.i2675) #18
  %659 = load float, ptr %538, align 8, !tbaa !5
  %retval.sroa.3.12.vec.insert.i.i2686 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %659, i64 0
  store <2 x float> %retval.sroa.3.12.vec.insert.i.i2686, ptr %545, align 8
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %ref.tmp4.i2676) #18
  %660 = load <2 x float>, ptr %a1, align 8, !tbaa !5
  %661 = extractelement <2 x float> %660, i64 0
  %sub.i.i2681 = fadd float %661, -2.500000e-01
  %662 = insertelement <2 x float> %660, float %sub.i.i2681, i64 0
  store <2 x float> %662, ptr %ref.tmp.i2675, align 8
  %663 = fadd <2 x float> %660, <float 2.500000e-01, float 0.000000e+00>
  %add14.i.i2689 = fadd float %659, 0.000000e+00
  %retval.sroa.3.12.vec.insert.i58.i2692 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %add14.i.i2689, i64 0
  store <2 x float> %663, ptr %ref.tmp4.i2676, align 8
  store <2 x float> %retval.sroa.3.12.vec.insert.i58.i2692, ptr %546, align 8
  %vtable.i2693 = load ptr, ptr %idraw, align 8, !tbaa !21
  %vfn.i2694 = getelementptr inbounds ptr, ptr %vtable.i2693, i64 5
  %664 = load ptr, ptr %vfn.i2694, align 8
  call void %664(ptr noundef nonnull align 8 dereferenceable(8) %idraw, ptr noundef nonnull align 4 dereferenceable(16) %ref.tmp.i2675, ptr noundef nonnull align 4 dereferenceable(16) %ref.tmp4.i2676, ptr noundef nonnull align 4 dereferenceable(16) %ref.tmp883)
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %ref.tmp4.i2676) #18
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %ref.tmp.i2675) #18
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %ref.tmp10.i2677) #18
  %665 = load float, ptr %538, align 8, !tbaa !5
  %retval.sroa.3.12.vec.insert.i73.i2698 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %665, i64 0
  store <2 x float> %retval.sroa.3.12.vec.insert.i73.i2698, ptr %547, align 8
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %ref.tmp16.i2678) #18
  %666 = load <2 x float>, ptr %a1, align 8, !tbaa !5
  %667 = extractelement <2 x float> %666, i64 1
  %sub8.i67.i2695 = fadd float %667, -2.500000e-01
  %retval.sroa.0.4.vec.insert.i72.i2697 = insertelement <2 x float> %666, float %sub8.i67.i2695, i64 1
  store <2 x float> %retval.sroa.0.4.vec.insert.i72.i2697, ptr %ref.tmp10.i2677, align 8
  %668 = fadd <2 x float> %666, <float 0.000000e+00, float 2.500000e-01>
  %add14.i85.i2701 = fadd float %665, 0.000000e+00
  %retval.sroa.3.12.vec.insert.i88.i2704 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %add14.i85.i2701, i64 0
  store <2 x float> %668, ptr %ref.tmp16.i2678, align 8
  store <2 x float> %retval.sroa.3.12.vec.insert.i88.i2704, ptr %548, align 8
  %vtable22.i2705 = load ptr, ptr %idraw, align 8, !tbaa !21
  %vfn23.i2706 = getelementptr inbounds ptr, ptr %vtable22.i2705, i64 5
  %669 = load ptr, ptr %vfn23.i2706, align 8
  call void %669(ptr noundef nonnull align 8 dereferenceable(8) %idraw, ptr noundef nonnull align 4 dereferenceable(16) %ref.tmp10.i2677, ptr noundef nonnull align 4 dereferenceable(16) %ref.tmp16.i2678, ptr noundef nonnull align 4 dereferenceable(16) %ref.tmp883)
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %ref.tmp16.i2678) #18
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %ref.tmp10.i2677) #18
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %ref.tmp24.i2679) #18
  %670 = load <2 x float>, ptr %a1, align 8, !tbaa !5
  %671 = load float, ptr %538, align 8, !tbaa !5
  %sub14.i100.i2707 = fadd float %671, -2.500000e-01
  %retval.sroa.3.12.vec.insert.i103.i2710 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %sub14.i100.i2707, i64 0
  store <2 x float> %670, ptr %ref.tmp24.i2679, align 8
  store <2 x float> %retval.sroa.3.12.vec.insert.i103.i2710, ptr %549, align 8
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %ref.tmp30.i2680) #18
  %672 = fadd <2 x float> %670, zeroinitializer
  %add14.i115.i2713 = fadd float %671, 2.500000e-01
  %retval.sroa.3.12.vec.insert.i118.i2716 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %add14.i115.i2713, i64 0
  store <2 x float> %672, ptr %ref.tmp30.i2680, align 8
  store <2 x float> %retval.sroa.3.12.vec.insert.i118.i2716, ptr %550, align 8
  %vtable36.i2717 = load ptr, ptr %idraw, align 8, !tbaa !21
  %vfn37.i2718 = getelementptr inbounds ptr, ptr %vtable36.i2717, i64 5
  %673 = load ptr, ptr %vfn37.i2718, align 8
  call void %673(ptr noundef nonnull align 8 dereferenceable(8) %idraw, ptr noundef nonnull align 4 dereferenceable(16) %ref.tmp24.i2679, ptr noundef nonnull align 4 dereferenceable(16) %ref.tmp30.i2680, ptr noundef nonnull align 4 dereferenceable(16) %ref.tmp883)
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %ref.tmp30.i2680) #18
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %ref.tmp24.i2679) #18
...
sw.bb887:                                         ; preds = %for.body841
  ...
  %guard.uninitialized.i2719 = icmp eq i8 %674, 0
  br i1 %guard.uninitialized.i2719, label %init.check.i2721, label %_ZNK10btSoftBody4Body5xformEv.exit2736, !prof !28

init.check.i2721:                                 ; preds = %sw.bb887
  %675 = call i32 @__cxa_guard_acquire(ptr nonnull @_ZGVZNK10btSoftBody4Body5xformEvE8identity) #18
  %tobool.not.i2720 = icmp eq i32 %675, 0
  br i1 %tobool.not.i2720, label %_ZNK10btSoftBody4Body5xformEv.exit2736, label %init.i2723

init.i2723:                                       ; preds = %init.check.i2721
  %call.i2722 = invoke noundef nonnull align 4 dereferenceable(64) ptr @_ZN11btTransform11getIdentityEv()
          to label %invoke.cont.i2727 unwind label %lpad.i2735

invoke.cont.i2727:                                ; preds = %init.i2723
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) @_ZZNK10btSoftBody4Body5xformEvE8identity, ptr noundef nonnull align 4 dereferenceable(16) %call.i2722, i64 16, i1 false), !tbaa.struct !52
  %arrayidx6.i.i.i2724 = getelementptr inbounds [3 x %class.btVector3], ptr %call.i2722, i64 0, i64 1
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) getelementptr inbounds (%class.btTransform, ptr @_ZZNK10btSoftBody4Body5xformEvE8identity, i64 0, i32 0, i32 0, i64 1), ptr noundef nonnull align 4 dereferenceable(16) %arrayidx6.i.i.i2724, i64 16, i1 false), !tbaa.struct !52
  %arrayidx10.i.i.i2725 = getelementptr inbounds [3 x %class.btVector3], ptr %call.i2722, i64 0, i64 2
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) getelementptr inbounds (%class.btTransform, ptr @_ZZNK10btSoftBody4Body5xformEvE8identity, i64 0, i32 0, i32 0, i64 2), ptr noundef nonnull align 4 dereferenceable(16) %arrayidx10.i.i.i2725, i64 16, i1 false), !tbaa.struct !52
  %m_origin3.i.i2726 = getelementptr inbounds %class.btTransform, ptr %call.i2722, i64 0, i32 1
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) getelementptr inbounds (%class.btTransform, ptr @_ZZNK10btSoftBody4Body5xformEvE8identity, i64 0, i32 1), ptr noundef nonnull align 4 dereferenceable(16) %m_origin3.i.i2726, i64 16, i1 false), !tbaa.struct !52
  %676 = call ptr @llvm.invariant.start.p0(i64 64, ptr nonnull @_ZZNK10btSoftBody4Body5xformEvE8identity)
  call void @__cxa_guard_release(ptr nonnull @_ZGVZNK10btSoftBody4Body5xformEvE8identity) #18
  br label %_ZNK10btSoftBody4Body5xformEv.exit2736

lpad.i2735:                                       ; preds = %init.i2723
  %677 = landingpad { ptr, i32 }
          cleanup
  call void @__cxa_guard_abort(ptr nonnull @_ZGVZNK10btSoftBody4Body5xformEvE8identity) #18
  br label %common.resume

_ZNK10btSoftBody4Body5xformEv.exit2736:           ; preds = %sw.bb887, %init.check.i2721, %invoke.cont.i2727
  %m_collisionObject.i2728 = getelementptr inbounds %"struct.btSoftBody::Joint", ptr %552, i64 0, i32 1, i64 0, i32 2
  %678 = load ptr, ptr %m_collisionObject.i2728, align 8, !tbaa !147
  %tobool3.not.i2729 = icmp eq ptr %678, null
  %m_interpolationWorldTransform.i.i2730 = getelementptr inbounds %class.btCollisionObject, ptr %678, i64 0, i32 2
  %679 = load ptr, ptr %m_bodies888, align 8
  %tobool6.not.i2731 = icmp eq ptr %679, null
  %m_framexform.i2732 = getelementptr inbounds %"struct.btSoftBody::Cluster", ptr %679, i64 0, i32 3
  %spec.select.i2733 = select i1 %tobool6.not.i2731, ptr @_ZZNK10btSoftBody4Body5xformEvE8identity, ptr %m_framexform.i2732
  %retval.0.i2734 = select i1 %tobool3.not.i2729, ptr %spec.select.i2733, ptr %m_interpolationWorldTransform.i.i2730
  %m_origin.i2737 = getelementptr inbounds %class.btTransform, ptr %retval.0.i2734, i64 0, i32 1
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %o0, ptr noundef nonnull align 4 dereferenceable(16) %m_origin.i2737, i64 16, i1 false), !tbaa.struct !52
  ...
  %guard.uninitialized.i2738 = icmp eq i8 %680, 0
  br i1 %guard.uninitialized.i2738, label %init.check.i2740, label %_ZNK10btSoftBody4Body5xformEv.exit2755, !prof !28

init.check.i2740:                                 ; preds = %_ZNK10btSoftBody4Body5xformEv.exit2736
  %681 = call i32 @__cxa_guard_acquire(ptr nonnull @_ZGVZNK10btSoftBody4Body5xformEvE8identity) #18
  %tobool.not.i2739 = icmp eq i32 %681, 0
  br i1 %tobool.not.i2739, label %_ZNK10btSoftBody4Body5xformEv.exit2755, label %init.i2742

init.i2742:                                       ; preds = %init.check.i2740
  %call.i2741 = invoke noundef nonnull align 4 dereferenceable(64) ptr @_ZN11btTransform11getIdentityEv()
          to label %invoke.cont.i2746 unwind label %lpad.i2754

invoke.cont.i2746:                                ; preds = %init.i2742
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) @_ZZNK10btSoftBody4Body5xformEvE8identity, ptr noundef nonnull align 4 dereferenceable(16) %call.i2741, i64 16, i1 false), !tbaa.struct !52
  %arrayidx6.i.i.i2743 = getelementptr inbounds [3 x %class.btVector3], ptr %call.i2741, i64 0, i64 1
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) getelementptr inbounds (%class.btTransform, ptr @_ZZNK10btSoftBody4Body5xformEvE8identity, i64 0, i32 0, i32 0, i64 1), ptr noundef nonnull align 4 dereferenceable(16) %arrayidx6.i.i.i2743, i64 16, i1 false), !tbaa.struct !52
  %arrayidx10.i.i.i2744 = getelementptr inbounds [3 x %class.btVector3], ptr %call.i2741, i64 0, i64 2
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) getelementptr inbounds (%class.btTransform, ptr @_ZZNK10btSoftBody4Body5xformEvE8identity, i64 0, i32 0, i32 0, i64 2), ptr noundef nonnull align 4 dereferenceable(16) %arrayidx10.i.i.i2744, i64 16, i1 false), !tbaa.struct !52
  %m_origin3.i.i2745 = getelementptr inbounds %class.btTransform, ptr %call.i2741, i64 0, i32 1
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) getelementptr inbounds (%class.btTransform, ptr @_ZZNK10btSoftBody4Body5xformEvE8identity, i64 0, i32 1), ptr noundef nonnull align 4 dereferenceable(16) %m_origin3.i.i2745, i64 16, i1 false), !tbaa.struct !52
  %682 = call ptr @llvm.invariant.start.p0(i64 64, ptr nonnull @_ZZNK10btSoftBody4Body5xformEvE8identity)
  call void @__cxa_guard_release(ptr nonnull @_ZGVZNK10btSoftBody4Body5xformEvE8identity) #18
  br label %_ZNK10btSoftBody4Body5xformEv.exit2755

lpad.i2754:                                       ; preds = %init.i2742
  %683 = landingpad { ptr, i32 }
          cleanup
  call void @__cxa_guard_abort(ptr nonnull @_ZGVZNK10btSoftBody4Body5xformEvE8identity) #18
  br label %common.resume

_ZNK10btSoftBody4Body5xformEv.exit2755:           ; preds = %_ZNK10btSoftBody4Body5xformEv.exit2736, %init.check.i2740, %invoke.cont.i2746
  %m_collisionObject.i2747 = getelementptr inbounds %"struct.btSoftBody::Joint", ptr %552, i64 0, i32 1, i64 1, i32 2
  %684 = load ptr, ptr %m_collisionObject.i2747, align 8, !tbaa !147
  %tobool3.not.i2748 = icmp eq ptr %684, null
  %m_interpolationWorldTransform.i.i2749 = getelementptr inbounds %class.btCollisionObject, ptr %684, i64 0, i32 2
  %685 = load ptr, ptr %arrayidx893, align 8
  %tobool6.not.i2750 = icmp eq ptr %685, null
  %m_framexform.i2751 = getelementptr inbounds %"struct.btSoftBody::Cluster", ptr %685, i64 0, i32 3
  %spec.select.i2752 = select i1 %tobool6.not.i2750, ptr @_ZZNK10btSoftBody4Body5xformEvE8identity, ptr %m_framexform.i2751
  %retval.0.i2753 = select i1 %tobool3.not.i2748, ptr %spec.select.i2752, ptr %m_interpolationWorldTransform.i.i2749
  %m_origin.i2756 = getelementptr inbounds %class.btTransform, ptr %retval.0.i2753, i64 0, i32 1
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %o1, ptr noundef nonnull align 4 dereferenceable(16) %m_origin.i2756, i64 16, i1 false), !tbaa.struct !52
  %686 = load atomic i8, ptr @_ZGVZNK10btSoftBody4Body5xformEvE8identity acquire, align 8
  %guard.uninitialized.i2757 = icmp eq i8 %686, 0
  br i1 %guard.uninitialized.i2757, label %init.check.i2759, label %_ZNK10btSoftBody4Body5xformEv.exit2774, !prof !28

init.check.i2759:                                 ; preds = %_ZNK10btSoftBody4Body5xformEv.exit2755
  %687 = call i32 @__cxa_guard_acquire(ptr nonnull @_ZGVZNK10btSoftBody4Body5xformEvE8identity) #18
  %tobool.not.i2758 = icmp eq i32 %687, 0
  br i1 %tobool.not.i2758, label %_ZNK10btSoftBody4Body5xformEv.exit2774, label %init.i2761

init.i2761:                                       ; preds = %init.check.i2759
  %call.i2760 = invoke noundef nonnull align 4 dereferenceable(64) ptr @_ZN11btTransform11getIdentityEv()
          to label %invoke.cont.i2765 unwind label %lpad.i2773

invoke.cont.i2765:                                ; preds = %init.i2761
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) @_ZZNK10btSoftBody4Body5xformEvE8identity, ptr noundef nonnull align 4 dereferenceable(16) %call.i2760, i64 16, i1 false), !tbaa.struct !52
  %arrayidx6.i.i.i2762 = getelementptr inbounds [3 x %class.btVector3], ptr %call.i2760, i64 0, i64 1
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) getelementptr inbounds (%class.btTransform, ptr @_ZZNK10btSoftBody4Body5xformEvE8identity, i64 0, i32 0, i32 0, i64 1), ptr noundef nonnull align 4 dereferenceable(16) %arrayidx6.i.i.i2762, i64 16, i1 false), !tbaa.struct !52
  %arrayidx10.i.i.i2763 = getelementptr inbounds [3 x %class.btVector3], ptr %call.i2760, i64 0, i64 2
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) getelementptr inbounds (%class.btTransform, ptr @_ZZNK10btSoftBody4Body5xformEvE8identity, i64 0, i32 0, i32 0, i64 2), ptr noundef nonnull align 4 dereferenceable(16) %arrayidx10.i.i.i2763, i64 16, i1 false), !tbaa.struct !52
  %m_origin3.i.i2764 = getelementptr inbounds %class.btTransform, ptr %call.i2760, i64 0, i32 1
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) getelementptr inbounds (%class.btTransform, ptr @_ZZNK10btSoftBody4Body5xformEvE8identity, i64 0, i32 1), ptr noundef nonnull align 4 dereferenceable(16) %m_origin3.i.i2764, i64 16, i1 false), !tbaa.struct !52
  %688 = call ptr @llvm.invariant.start.p0(i64 64, ptr nonnull @_ZZNK10btSoftBody4Body5xformEvE8identity)
  call void @__cxa_guard_release(ptr nonnull @_ZGVZNK10btSoftBody4Body5xformEvE8identity) #18
  br label %_ZNK10btSoftBody4Body5xformEv.exit2774

lpad.i2773:                                       ; preds = %init.i2761
  %689 = landingpad { ptr, i32 }
          cleanup
  call void @__cxa_guard_abort(ptr nonnull @_ZGVZNK10btSoftBody4Body5xformEvE8identity) #18
  br label %common.resume

_ZNK10btSoftBody4Body5xformEv.exit2774:           ; preds = %_ZNK10btSoftBody4Body5xformEv.exit2755, %init.check.i2759, %invoke.cont.i2765
  %690 = load ptr, ptr %m_collisionObject.i2728, align 8, !tbaa !147
  %tobool3.not.i2767 = icmp eq ptr %690, null
  %m_interpolationWorldTransform.i.i2768 = getelementptr inbounds %class.btCollisionObject, ptr %690, i64 0, i32 2
  %691 = load ptr, ptr %m_bodies888, align 8
  %tobool6.not.i2769 = icmp eq ptr %691, null
  %m_framexform.i2770 = getelementptr inbounds %"struct.btSoftBody::Cluster", ptr %691, i64 0, i32 3
  %spec.select.i2771 = select i1 %tobool6.not.i2769, ptr @_ZZNK10btSoftBody4Body5xformEvE8identity, ptr %m_framexform.i2770
  %retval.0.i2772 = select i1 %tobool3.not.i2767, ptr %spec.select.i2771, ptr %m_interpolationWorldTransform.i.i2768
  %m_refs901 = getelementptr inbounds %"struct.btSoftBody::Joint", ptr %552, i64 0, i32 2
  %692 = load float, ptr %m_refs901, align 4, !tbaa !5
  %arrayidx5.i.i2775 = getelementptr inbounds [4 x float], ptr %retval.0.i2772, i64 0, i64 1
  %arrayidx7.i.i2776 = getelementptr inbounds %"struct.btSoftBody::Joint", ptr %552, i64 0, i32 2, i64 0, i32 0, i64 1
  %693 = load float, ptr %arrayidx7.i.i2776, align 4, !tbaa !5
  %arrayidx10.i.i2778 = getelementptr inbounds [4 x float], ptr %retval.0.i2772, i64 0, i64 2
  %arrayidx12.i.i2779 = getelementptr inbounds %"struct.btSoftBody::Joint", ptr %552, i64 0, i32 2, i64 0, i32 0, i64 2
  %694 = load float, ptr %arrayidx12.i.i2779, align 4, !tbaa !5
  %arrayidx.i.i2780 = getelementptr inbounds [3 x %class.btVector3], ptr %retval.0.i2772, i64 0, i64 1
  %arrayidx5.i12.i = getelementptr inbounds [3 x %class.btVector3], ptr %retval.0.i2772, i64 0, i64 1, i32 0, i64 1
  %arrayidx10.i15.i = getelementptr inbounds [3 x %class.btVector3], ptr %retval.0.i2772, i64 0, i64 1, i32 0, i64 2
  %695 = load float, ptr %retval.0.i2772, align 4, !tbaa !5
  %696 = load float, ptr %arrayidx5.i.i2775, align 4, !tbaa !5
  %697 = load float, ptr %arrayidx10.i.i2778, align 4, !tbaa !5
  %698 = load float, ptr %arrayidx.i.i2780, align 4, !tbaa !5
  ...
  %arrayidx.i17.i = getelementptr inbounds [3 x %class.btVector3], ptr %retval.0.i2772, i64 0, i64 2
  %716 = load float, ptr %arrayidx.i17.i, align 4, !tbaa !5
  %arrayidx5.i18.i = getelementptr inbounds [3 x %class.btVector3], ptr %retval.0.i2772, i64 0, i64 2, i32 0, i64 1
  ...
  %arrayidx10.i21.i = getelementptr inbounds [3 x %class.btVector3], ptr %retval.0.i2772, i64 0, i64 2, i32 0, i64 2
  ...
  %guard.uninitialized.i2786 = icmp eq i8 %721, 0
  br i1 %guard.uninitialized.i2786, label %init.check.i2788, label %_ZNK10btSoftBody4Body5xformEv.exit2803, !prof !28

init.check.i2788:                                 ; preds = %_ZNK10btSoftBody4Body5xformEv.exit2774
  %722 = call i32 @__cxa_guard_acquire(ptr nonnull @_ZGVZNK10btSoftBody4Body5xformEvE8identity) #18
  %tobool.not.i2787 = icmp eq i32 %722, 0
  br i1 %tobool.not.i2787, label %_ZNK10btSoftBody4Body5xformEv.exit2803, label %init.i2790

init.i2790:                                       ; preds = %init.check.i2788
  %call.i2789 = invoke noundef nonnull align 4 dereferenceable(64) ptr @_ZN11btTransform11getIdentityEv()
          to label %invoke.cont.i2794 unwind label %lpad.i2802

invoke.cont.i2794:                                ; preds = %init.i2790
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) @_ZZNK10btSoftBody4Body5xformEvE8identity, ptr noundef nonnull align 4 dereferenceable(16) %call.i2789, i64 16, i1 false), !tbaa.struct !52
  %arrayidx6.i.i.i2791 = getelementptr inbounds [3 x %class.btVector3], ptr %call.i2789, i64 0, i64 1
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) getelementptr inbounds (%class.btTransform, ptr @_ZZNK10btSoftBody4Body5xformEvE8identity, i64 0, i32 0, i32 0, i64 1), ptr noundef nonnull align 4 dereferenceable(16) %arrayidx6.i.i.i2791, i64 16, i1 false), !tbaa.struct !52
  %arrayidx10.i.i.i2792 = getelementptr inbounds [3 x %class.btVector3], ptr %call.i2789, i64 0, i64 2
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) getelementptr inbounds (%class.btTransform, ptr @_ZZNK10btSoftBody4Body5xformEvE8identity, i64 0, i32 0, i32 0, i64 2), ptr noundef nonnull align 4 dereferenceable(16) %arrayidx10.i.i.i2792, i64 16, i1 false), !tbaa.struct !52
  %m_origin3.i.i2793 = getelementptr inbounds %class.btTransform, ptr %call.i2789, i64 0, i32 1
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) getelementptr inbounds (%class.btTransform, ptr @_ZZNK10btSoftBody4Body5xformEvE8identity, i64 0, i32 1), ptr noundef nonnull align 4 dereferenceable(16) %m_origin3.i.i2793, i64 16, i1 false), !tbaa.struct !52
  %723 = call ptr @llvm.invariant.start.p0(i64 64, ptr nonnull @_ZZNK10btSoftBody4Body5xformEvE8identity)
  call void @__cxa_guard_release(ptr nonnull @_ZGVZNK10btSoftBody4Body5xformEvE8identity) #18
  br label %_ZNK10btSoftBody4Body5xformEv.exit2803

lpad.i2802:                                       ; preds = %init.i2790
  %724 = landingpad { ptr, i32 }
          cleanup
  call void @__cxa_guard_abort(ptr nonnull @_ZGVZNK10btSoftBody4Body5xformEvE8identity) #18
  br label %common.resume

_ZNK10btSoftBody4Body5xformEv.exit2803:           ; preds = %_ZNK10btSoftBody4Body5xformEv.exit2774, %init.check.i2788, %invoke.cont.i2794
  %725 = load ptr, ptr %m_collisionObject.i2747, align 8, !tbaa !147
  %tobool3.not.i2796 = icmp eq ptr %725, null
  %m_interpolationWorldTransform.i.i2797 = getelementptr inbounds %class.btCollisionObject, ptr %725, i64 0, i32 2
  %726 = load ptr, ptr %arrayidx893, align 8
  %tobool6.not.i2798 = icmp eq ptr %726, null
  %m_framexform.i2799 = getelementptr inbounds %"struct.btSoftBody::Cluster", ptr %726, i64 0, i32 3
  %spec.select.i2800 = select i1 %tobool6.not.i2798, ptr @_ZZNK10btSoftBody4Body5xformEvE8identity, ptr %m_framexform.i2799
  %retval.0.i2801 = select i1 %tobool3.not.i2796, ptr %spec.select.i2800, ptr %m_interpolationWorldTransform.i.i2797
  ...
  %arrayidx5.i.i2804 = getelementptr inbounds [4 x float], ptr %retval.0.i2801, i64 0, i64 1
  %arrayidx7.i.i2805 = getelementptr inbounds %"struct.btSoftBody::Joint", ptr %552, i64 0, i32 2, i64 1, i32 0, i64 1
  %728 = load float, ptr %arrayidx7.i.i2805, align 4, !tbaa !5
  %arrayidx10.i.i2807 = getelementptr inbounds [4 x float], ptr %retval.0.i2801, i64 0, i64 2
  %arrayidx12.i.i2808 = getelementptr inbounds %"struct.btSoftBody::Joint", ptr %552, i64 0, i32 2, i64 1, i32 0, i64 2
  %729 = load float, ptr %arrayidx12.i.i2808, align 4, !tbaa !5
  %arrayidx.i.i2809 = getelementptr inbounds [3 x %class.btVector3], ptr %retval.0.i2801, i64 0, i64 1
  %arrayidx5.i12.i2810 = getelementptr inbounds [3 x %class.btVector3], ptr %retval.0.i2801, i64 0, i64 1, i32 0, i64 1
  %arrayidx10.i15.i2812 = getelementptr inbounds [3 x %class.btVector3], ptr %retval.0.i2801, i64 0, i64 1, i32 0, i64 2
  %arrayidx.i17.i2813 = getelementptr inbounds [3 x %class.btVector3], ptr %retval.0.i2801, i64 0, i64 2
  %730 = load float, ptr %arrayidx.i17.i2813, align 4, !tbaa !5
  %arrayidx5.i18.i2814 = getelementptr inbounds [3 x %class.btVector3], ptr %retval.0.i2801, i64 0, i64 2, i32 0, i64 1
  %731 = load float, ptr %arrayidx5.i18.i2814, align 4, !tbaa !5
  %mul8.i20.i2815 = fmul float %728, %731
  %732 = call float @llvm.fmuladd.f32(float %730, float %727, float %mul8.i20.i2815)
  %arrayidx10.i21.i2816 = getelementptr inbounds [3 x %class.btVector3], ptr %retval.0.i2801, i64 0, i64 2, i32 0, i64 2
  %733 = load float, ptr %arrayidx10.i21.i2816, align 4, !tbaa !5
  ...
  %mul8.i2826 = fmul float %720, 1.000000e+01
  %mul8.i2851 = fmul float %734, 1.000000e+01
  %736 = load float, ptr %retval.0.i2801, align 4, !tbaa !5
  %737 = load float, ptr %arrayidx5.i.i2804, align 4, !tbaa !5
  %738 = load float, ptr %arrayidx10.i.i2807, align 4, !tbaa !5
  %739 = load float, ptr %arrayidx.i.i2809, align 4, !tbaa !5
  %740 = load float, ptr %arrayidx5.i12.i2810, align 4, !tbaa !5
  ...
  %751 = load float, ptr %arrayidx10.i15.i2812, align 4, !tbaa !5
  ...
  %759 = load float, ptr %arrayidx11.i2836, align 8, !tbaa !5
  %add14.i2838 = fadd float %mul8.i2826, %759
  %retval.sroa.3.12.vec.insert.i2841 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %add14.i2838, i64 0
  store <2 x float> %758, ptr %ref.tmp914, align 8
  store <2 x float> %retval.sroa.3.12.vec.insert.i2841, ptr %533, align 8
  ...
  %764 = load float, ptr %arrayidx11.i2836, align 8, !tbaa !5
  %add14.i2863 = fadd float %mul8.i2851, %764
  %retval.sroa.3.12.vec.insert.i2866 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %add14.i2863, i64 0
  store <2 x float> %763, ptr %ref.tmp927, align 8
  store <2 x float> %retval.sroa.3.12.vec.insert.i2866, ptr %534, align 8
  ...
  %768 = load float, ptr %arrayidx11.i2886, align 8, !tbaa !5
  %add14.i2888 = fadd float %mul8.i2826, %768
  %retval.sroa.3.12.vec.insert.i2891 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %add14.i2888, i64 0
  store <2 x float> %767, ptr %ref.tmp940, align 8
  store <2 x float> %retval.sroa.3.12.vec.insert.i2891, ptr %535, align 8
  ...
  %772 = load float, ptr %arrayidx11.i2886, align 8, !tbaa !5
  %add14.i2913 = fadd float %mul8.i2851, %772
  %retval.sroa.3.12.vec.insert.i2916 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %add14.i2913, i64 0
  store <2 x float> %771, ptr %ref.tmp953, align 8
  store <2 x float> %retval.sroa.3.12.vec.insert.i2916, ptr %536, align 8
...
sw.epilog:                                        ; preds = %_ZNK10btSoftBody4Body5xformEv.exit2803, %for.body841, %_ZNK10btSoftBody4Body5xformEv.exit2620
  %indvars.iv.next3372 = add nuw nsw i64 %indvars.iv3371, 1
  %774 = load i32, ptr %m_size.i2510, align 4, !tbaa !145
  %775 = sext i32 %774 to i64
  %cmp840 = icmp slt i64 %indvars.iv.next3372, %775
...
terminate.lpad:                                   ; preds = %if.then3.i.i.i1911, %ehcleanup534, %ehcleanup532
...
_ZN20btAlignedObjectArrayIiED2Ev.exit:            ; preds = %if.then3.i.i.i, %entry
  ...
  store i32 0, ptr %m_size.i.i.i, align 4, !tbaa !104
...
_ZN20btAlignedObjectArrayIP14btHullTriangleED2Ev.exit: ; preds = %_ZN20btAlignedObjectArrayIiED2Ev.exit, %if.then3.i.i.i10
  ...
  store i32 0, ptr %m_size.i.i.i11, align 4, !tbaa !98
...
_ZN20btAlignedObjectArrayIjED2Ev.exit:            ; preds = %if.then3.i.i.i, %entry
  ...
  store i32 0, ptr %m_size.i.i.i, align 4, !tbaa !87
...
_ZN20btAlignedObjectArrayI9btVector3ED2Ev.exit:   ; preds = %_ZN20btAlignedObjectArrayIjED2Ev.exit, %if.then3.i.i.i10
  ...
  store i32 0, ptr %m_size.i.i.i11, align 4, !tbaa !81
...
_ZN20btAlignedObjectArrayI9btVector3E5clearEv.exit: ; preds = %entry, %if.then3.i.i
  ...
  store i32 0, ptr %m_size.i.i, align 4, !tbaa !81
...
for.cond.cleanup:                                 ; preds = %for.body, %entry, %invoke.cont6
  %vtx.sroa.1778.191104 = phi ptr [ %call.i.i.i.i36, %invoke.cont6 ], [ null, %entry ], [ %call.i.i.i.i36, %for.body ]
...
for.body:                                         ; preds = %for.body.lr.ph, %for.body
  ...
  %9 = load float, ptr %arrayidx13.i42, align 4, !tbaa !5
  %mul14.i43 = fmul float %8, %9
  %10 = load float, ptr %arrayidx13.i48, align 4, !tbaa !5
  %add14.i = fadd float %mul14.i43, %10
  %retval.sroa.3.12.vec.insert.i51 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %add14.i, i64 0
  %11 = load <2 x float>, ptr %arrayidx.i, align 4, !tbaa !5
  %12 = load <2 x float>, ptr %radius, align 4, !tbaa !5
  %13 = fmul <2 x float> %11, %12
  %14 = load <2 x float>, ptr %center, align 4, !tbaa !5
  %15 = fadd <2 x float> %13, %14
  store <2 x float> %15, ptr %arrayidx.i, align 4, !tbaa.struct !52
...
lpad.i120:                                        ; preds = %if.then3.i.i.i.i109
  ...
  %tobool.not.i.i.i129 = icmp eq ptr %31, null
  %32 = load i8, ptr %m_ownsMemory.i.i.i, align 8, !range !69
  %tobool2.not.i.i.i131 = icmp eq i8 %32, 0
  %or.cond.i.i132 = select i1 %tobool.not.i.i.i129, i1 true, i1 %tobool2.not.i.i.i131
  br i1 %or.cond.i.i132, label %common.resume, label %if.then3.i.i.i133

if.then3.i.i.i133:                                ; preds = %lpad.i120
  invoke void @_Z21btAlignedFreeInternalPv(ptr noundef nonnull %31)
          to label %common.resume unwind label %terminate.lpad.i122

common.resume:                                    ; preds = %lpad.i120, %if.then3.i.i.i133, %invoke.cont58
  %common.resume.op = phi { ptr, i32 } [ %.pn.pn.pn, %invoke.cont58 ], [ %30, %if.then3.i.i.i133 ], [ %30, %lpad.i120 ]
  resume { ptr, i32 } %common.resume.op

terminate.lpad.i122:                              ; preds = %if.then3.i.i.i133
  %33 = landingpad { ptr, i32 }
          catch ptr null
  %34 = extractvalue { ptr, i32 } %33, 0
...
entry:
  ...
  %cmp297 = icmp sgt i32 %ntriangles, 0
  br i1 %cmp297, label %for.body.preheader, label %if.then.i.i.i162

for.body.preheader:                               ; preds = %entry
  %smax = tail call i32 @llvm.smax.i32(i32 %mul, i32 1)
  %wide.trip.count = zext i32 %smax to i64
  %min.iters.check = icmp ult i32 %smax, 8
  br i1 %min.iters.check, label %for.body.preheader339, label %vector.ph
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %vec.phi337 = phi <4 x i32> [ zeroinitializer, %vector.ph ], [ %3, %vector.body ]
  ...
  %wide.load338 = load <4 x i32>, ptr %1, align 4, !tbaa !107
  %2 = tail call <4 x i32> @llvm.smax.v4i32(<4 x i32> %wide.load, <4 x i32> %vec.phi)
  %3 = tail call <4 x i32> @llvm.smax.v4i32(<4 x i32> %wide.load338, <4 x i32> %vec.phi337)
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %if.then.i.i.i162, label %for.body.preheader339

for.body.preheader339:                            ; preds = %for.body.preheader, %middle.block
  %indvars.iv.ph = phi i64 [ 0, %for.body.preheader ], [ %n.vec, %middle.block ]
  %maxidx.0298.ph = phi i32 [ 0, %for.body.preheader ], [ %5, %middle.block ]
  br label %for.body

for.body:                                         ; preds = %for.body.preheader339, %for.body
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.body ], [ %indvars.iv.ph, %for.body.preheader339 ]
  %maxidx.0298 = phi i32 [ %.sroa.speculated, %for.body ], [ %maxidx.0298.ph, %for.body.preheader339 ]
  %arrayidx = getelementptr inbounds i32, ptr %triangles, i64 %indvars.iv
  %6 = load i32, ptr %arrayidx, align 4, !tbaa !107
  %.sroa.speculated = tail call i32 @llvm.smax.i32(i32 %6, i32 %maxidx.0298)
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
...
if.then.i.i.i162:                                 ; preds = %for.body, %middle.block, %entry
  ...
  %call.i.i.i.i188 = invoke noundef ptr @_Z22btAlignedAllocInternalmi(i64 noundef %mul.i.i.i.i, i32 noundef 16)
          to label %for.body12.preheader unwind label %ehcleanup102.thread291

for.body12.preheader:                             ; preds = %if.then.i.i.i162
  %mul9 = mul i32 %inc1, 3
  %smax317 = tail call i32 @llvm.smax.i32(i32 %mul9, i32 3)
  %7 = add nsw i32 %smax317, -1
  %8 = udiv i32 %7, 3
  %9 = add nuw nsw i32 %8, 1
  %wide.trip.count318 = zext i32 %9 to i64
  %xtraiter = and i64 %wide.trip.count318, 1
  %10 = icmp ult i32 %smax317, 4
  br i1 %10, label %for.end28.unr-lcssa, label %for.body12.preheader.new

for.body12.preheader.new:                         ; preds = %for.body12.preheader
  %unroll_iter = and i64 %wide.trip.count318, 2147483646
  br label %for.body12

for.body12:                                       ; preds = %for.body12, %for.body12.preheader.new
  %indvars.iv312 = phi i64 [ 0, %for.body12.preheader.new ], [ %indvars.iv.next313.1, %for.body12 ]
  %indvars.iv308 = phi i64 [ 0, %for.body12.preheader.new ], [ %indvars.iv.next309.1, %for.body12 ]
  %niter = phi i64 [ 0, %for.body12.preheader.new ], [ %niter.next.1, %for.body12 ]
  %arrayidx15 = getelementptr inbounds float, ptr %vertices, i64 %indvars.iv308
  %11 = add nuw nsw i64 %indvars.iv308, 2
  %arrayidx20 = getelementptr inbounds float, ptr %vertices, i64 %11
  %12 = load float, ptr %arrayidx20, align 4, !tbaa !5
  %arrayidx.i = getelementptr inbounds %class.btVector3, ptr %call.i.i.i.i188, i64 %indvars.iv312
  ...
  %indvars.iv.next313 = or i64 %indvars.iv312, 1
  %indvars.iv.next309 = add nuw nsw i64 %indvars.iv308, 3
  %arrayidx15.1 = getelementptr inbounds float, ptr %vertices, i64 %indvars.iv.next309
  %14 = add nuw nsw i64 %indvars.iv308, 5
  %arrayidx20.1 = getelementptr inbounds float, ptr %vertices, i64 %14
  %15 = load float, ptr %arrayidx20.1, align 4, !tbaa !5
  %arrayidx.i.1 = getelementptr inbounds %class.btVector3, ptr %call.i.i.i.i188, i64 %indvars.iv.next313
  ...
  %indvars.iv.next309.1 = add nuw nsw i64 %indvars.iv308, 6
  %niter.next.1 = add i64 %niter, 2
  %niter.ncmp.1 = icmp eq i64 %niter.next.1, %unroll_iter
...
ehcleanup102.thread291:                           ; preds = %if.then.i.i.i162
  %18 = landingpad { ptr, i32 }
          cleanup
  br label %if.then3.i.i.i233

for.end28.unr-lcssa:                              ; preds = %for.body12, %for.body12.preheader
  %indvars.iv312.unr = phi i64 [ 0, %for.body12.preheader ], [ %indvars.iv.next313.1, %for.body12 ]
  %indvars.iv308.unr = phi i64 [ 0, %for.body12.preheader ], [ %indvars.iv.next309.1, %for.body12 ]
  %lcmp.mod.not = icmp eq i64 %xtraiter, 0
  br i1 %lcmp.mod.not, label %for.end28, label %for.body12.epil

for.body12.epil:                                  ; preds = %for.end28.unr-lcssa
  %arrayidx15.epil = getelementptr inbounds float, ptr %vertices, i64 %indvars.iv308.unr
  %19 = add nuw nsw i64 %indvars.iv308.unr, 2
  %arrayidx20.epil = getelementptr inbounds float, ptr %vertices, i64 %19
  %20 = load float, ptr %arrayidx20.epil, align 4, !tbaa !5
  %arrayidx.i.epil = getelementptr inbounds %class.btVector3, ptr %call.i.i.i.i188, i64 %indvars.iv312.unr
...
for.cond40.preheader:                             ; preds = %invoke.cont30
  br i1 %cmp297, label %for.body42, label %for.end96

for.body42:                                       ; preds = %for.cond40.preheader, %invoke.cont93
  %indvars.iv324 = phi i64 [ %indvars.iv.next325, %invoke.cont93 ], [ 0, %for.cond40.preheader ]
  %arrayidx44 = getelementptr inbounds i32, ptr %triangles, i64 %indvars.iv324
  %22 = load i32, ptr %arrayidx44, align 4, !tbaa !107
  %23 = add nuw nsw i64 %indvars.iv324, 1
  %arrayidx47 = getelementptr inbounds i32, ptr %triangles, i64 %23
  %24 = load i32, ptr %arrayidx47, align 4, !tbaa !107
  %25 = add nuw nsw i64 %indvars.iv324, 2
...
invoke.cont93:                                    ; preds = %for.inc86.2
  %indvars.iv.next325 = add nuw i64 %indvars.iv324, 3
  %33 = trunc i64 %indvars.iv.next325 to i32
...
if.then3.i.i.i223:                                ; preds = %lpad32, %ehcleanup100
  %.pn.pn.pn336 = phi { ptr, i32 } [ %.pn.pn.pn, %ehcleanup100 ], [ %29, %lpad32 ]
  invoke void @_Z21btAlignedFreeInternalPv(ptr noundef nonnull %call.i.i.i.i188)
          to label %ehcleanup102 unwind label %terminate.lpad

ehcleanup102:                                     ; preds = %ehcleanup100, %if.then3.i.i.i223, %lpad
  %.pn.pn.pn.pn = phi { ptr, i32 } [ %17, %lpad ], [ %.pn.pn.pn336, %if.then3.i.i.i223 ], [ %.pn.pn.pn, %ehcleanup100 ]
...
if.then3.i.i.i233:                                ; preds = %ehcleanup102.thread291, %ehcleanup102
  %.pn.pn.pn.pn296 = phi { ptr, i32 } [ %18, %ehcleanup102.thread291 ], [ %.pn.pn.pn.pn, %ehcleanup102 ]
...
invoke.cont104:                                   ; preds = %ehcleanup102, %if.then3.i.i.i233
  %.pn.pn.pn.pn290 = phi { ptr, i32 } [ %.pn.pn.pn.pn, %ehcleanup102 ], [ %.pn.pn.pn.pn296, %if.then3.i.i.i233 ]
  resume { ptr, i32 } %.pn.pn.pn.pn290
...
_ZL8nextLinePKc.exit158:                          ; preds = %for.body, %if.end.loopexit.i155
  ...
  %arrayidx.i162 = getelementptr inbounds [4 x float], ptr %arrayidx.i, i64 0, i64 1
  store float %10, ptr %arrayidx.i162, align 4, !tbaa !5
  %11 = load float, ptr %z, align 4, !tbaa !5
  %arrayidx.i166 = getelementptr inbounds [4 x float], ptr %arrayidx.i, i64 0, i64 2
...
_ZN20btAlignedObjectArrayIP14btHullTriangleE5clearEv.exit: ; preds = %entry, %if.then3.i.i
  ...
  store i32 0, ptr %m_size.i.i, align 4, !tbaa !98
