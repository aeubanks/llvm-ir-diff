...
define dso_local void @_ZN3fooC2Ev(ptr nocapture noundef nonnull writeonly align 8 dereferenceable(12) %this) unnamed_addr #0 align 2 {
entry:
  store ptr getelementptr inbounds ({ [3 x ptr] }, ptr @_ZTV3foo, i64 0, inrange i32 0, i64 2), ptr %this, align 8, !tbaa !5
  %y = getelementptr inbounds %struct.foo, ptr %this, i64 0, i32 1
  store i32 4, ptr %y, align 8, !tbaa !8
  ret void
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: write) uwtable
define dso_local void @_ZN3barC2Ev(ptr nocapture noundef nonnull writeonly align 8 dereferenceable(12) %this) unnamed_addr #0 align 2 {
entry:
  %y.i = getelementptr inbounds %struct.foo, ptr %this, i64 0, i32 1
  store i32 4, ptr %y.i, align 8, !tbaa !8
  store ptr getelementptr inbounds ({ [3 x ptr] }, ptr @_ZTV3bar, i64 0, inrange i32 0, i64 2), ptr %this, align 8, !tbaa !5
  ret void
}
...
define linkonce_odr dso_local noundef i32 @_ZN3bar1TEv(ptr noundef nonnull align 8 dereferenceable(12) %this) unnamed_addr #2 comdat align 2 {
entry:
  unreachable
}
