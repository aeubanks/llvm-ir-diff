...
define dso_local { i64, i48 } @fn1() local_unnamed_addr #0 {
  %1 = load i64, ptr @c, align 8, !tbaa.struct !5
  %2 = load i48, ptr getelementptr inbounds (%struct.S0, ptr @c, i64 0, i32 2), align 8, !tbaa.struct !12
  %3 = insertvalue { i64, i48 } poison, i64 %1, 0
  %4 = insertvalue { i64, i48 } %3, i48 %2, 1
  ret { i64, i48 } %4
}
...
define dso_local void @fn2() local_unnamed_addr #2 {
  %1 = load i64, ptr @c, align 8, !tbaa.struct !5
  %2 = load i48, ptr getelementptr inbounds (%struct.S0, ptr @c, i64 0, i32 2), align 8, !tbaa.struct !12
  store i64 %1, ptr @b, align 8, !tbaa.struct !5
  store i48 %2, ptr getelementptr inbounds (%struct.S0, ptr @b, i64 0, i32 2), align 8, !tbaa.struct !12
