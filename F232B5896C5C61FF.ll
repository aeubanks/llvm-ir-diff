...
if.end:                                           ; preds = %if.then, %entry
  %cmp833 = icmp sgt i32 %argc, 1
  br i1 %cmp833, label %land.rhs, label %if.then242

land.rhs:                                         ; preds = %if.end, %if.end236
  %num_options.0842 = phi i32 [ %num_options.3, %if.end236 ], [ 0, %if.end ]
  %generateOutput.0841 = phi i32 [ %generateOutput.3, %if.end236 ], [ 1, %if.end ]
  %argc.addr.0840 = phi i32 [ %dec237, %if.end236 ], [ %argc, %if.end ]
  %forceCreate.0839 = phi i16 [ %forceCreate.3, %if.end236 ], [ 0, %if.end ]
  %outputDir.0838 = phi ptr [ %outputDir.3, %if.end236 ], [ null, %if.end ]
  %extension.0837 = phi ptr [ %extension.3, %if.end236 ], [ @.str, %if.end ]
  %headerFile.0836 = phi ptr [ %headerFile.3, %if.end236 ], [ null, %if.end ]
  %outputFile.0835 = phi ptr [ %outputFile.3, %if.end236 ], [ null, %if.end ]
  %argv.addr.0834 = phi ptr [ %incdec.ptr238, %if.end236 ], [ %argv, %if.end ]
  %arrayidx5 = getelementptr inbounds ptr, ptr %argv.addr.0834, i64 1
...
if.then32:                                        ; preds = %if.end28
  %cmp35 = icmp ult i32 %argc.addr.0840, 3
...
if.end38:                                         ; preds = %if.then32
  %dec33 = add nsw i32 %argc.addr.0840, -1
  %arrayidx39 = getelementptr inbounds ptr, ptr %argv.addr.0834, i64 2
...
if.then44:                                        ; preds = %if.else40
  %cmp47 = icmp ult i32 %argc.addr.0840, 3
...
if.end50:                                         ; preds = %if.then44
  %dec45 = add nsw i32 %argc.addr.0840, -1
  %arrayidx51 = getelementptr inbounds ptr, ptr %argv.addr.0834, i64 2
...
if.then56:                                        ; preds = %if.else52
  %cmp59 = icmp ult i32 %argc.addr.0840, 3
...
if.end62:                                         ; preds = %if.then56
  %dec57 = add nsw i32 %argc.addr.0840, -1
  %arrayidx63 = getelementptr inbounds ptr, ptr %argv.addr.0834, i64 2
...
if.then68:                                        ; preds = %if.else64
  %dec69 = add nsw i32 %argc.addr.0840, -1
  %cmp71 = icmp ult i32 %argc.addr.0840, 3
...
if.then79:                                        ; preds = %if.else75
  %cmp82 = icmp ult i32 %argc.addr.0840, 3
...
if.end85:                                         ; preds = %if.then79
  %dec80 = add nsw i32 %argc.addr.0840, -1
  %arrayidx86 = getelementptr inbounds ptr, ptr %argv.addr.0834, i64 2
...
if.then91:                                        ; preds = %if.else87
  %cmp94 = icmp ult i32 %argc.addr.0840, 3
...
if.end97:                                         ; preds = %if.then91
  %dec92 = add nsw i32 %argc.addr.0840, -1
  %arrayidx98 = getelementptr inbounds ptr, ptr %argv.addr.0834, i64 2
  %9 = load ptr, ptr %arrayidx98, align 8, !tbaa !5
  %inc = add nsw i32 %num_options.0842, 1
  %idxprom = sext i32 %num_options.0842 to i64
...
while.body135:                                    ; preds = %while.body, %sw.epilog
  ...
  %num_options.1824 = phi i32 [ %num_options.2, %sw.epilog ], [ %num_options.0842, %while.body ]
  %generateOutput.1823 = phi i32 [ %generateOutput.2, %sw.epilog ], [ %generateOutput.0841, %while.body ]
  %argc.addr.1822 = phi i32 [ %argc.addr.2, %sw.epilog ], [ %argc.addr.0840, %while.body ]
  %forceCreate.1821 = phi i16 [ %forceCreate.2, %sw.epilog ], [ %forceCreate.0839, %while.body ]
  %outputDir.1820 = phi ptr [ %outputDir.2, %sw.epilog ], [ %outputDir.0838, %while.body ]
  %extension.1819 = phi ptr [ %extension.2, %sw.epilog ], [ %extension.0837, %while.body ]
  %headerFile.1818 = phi ptr [ %headerFile.2, %sw.epilog ], [ %headerFile.0836, %while.body ]
  %outputFile.1817 = phi ptr [ %outputFile.2, %sw.epilog ], [ %outputFile.0835, %while.body ]
  %opt.0816 = phi ptr [ %opt.1, %sw.epilog ], [ %arrayidx11, %while.body ]
  %argv.addr.1815 = phi ptr [ %argv.addr.2, %sw.epilog ], [ %argv.addr.0834, %while.body ]
  %conv132 = sext i8 %10 to i32
  %incdec.ptr136 = getelementptr inbounds i8, ptr %opt.0816, i64 1
...
if.else142:                                       ; preds = %sw.bb
  %cmp143 = icmp slt i32 %argc.addr.1822, 3
...
if.else146:                                       ; preds = %if.else142
  %dec147 = add nsw i32 %argc.addr.1822, -1
  %incdec.ptr148 = getelementptr inbounds ptr, ptr %argv.addr.1815, i64 1
  %arrayidx149 = getelementptr inbounds ptr, ptr %argv.addr.1815, i64 2
...
if.else157:                                       ; preds = %sw.bb152
  %cmp158 = icmp slt i32 %argc.addr.1822, 3
...
if.else161:                                       ; preds = %if.else157
  %dec162 = add nsw i32 %argc.addr.1822, -1
  %incdec.ptr163 = getelementptr inbounds ptr, ptr %argv.addr.1815, i64 1
  %arrayidx164 = getelementptr inbounds ptr, ptr %argv.addr.1815, i64 2
...
if.else172:                                       ; preds = %sw.bb167
  %cmp173 = icmp slt i32 %argc.addr.1822, 3
...
if.else176:                                       ; preds = %if.else172
  %dec177 = add nsw i32 %argc.addr.1822, -1
  %incdec.ptr178 = getelementptr inbounds ptr, ptr %argv.addr.1815, i64 1
  %arrayidx179 = getelementptr inbounds ptr, ptr %argv.addr.1815, i64 2
...
if.else187:                                       ; preds = %sw.bb182
  %cmp188 = icmp slt i32 %argc.addr.1822, 3
...
if.else191:                                       ; preds = %if.else187
  %dec192 = add nsw i32 %argc.addr.1822, -1
  %incdec.ptr193 = getelementptr inbounds ptr, ptr %argv.addr.1815, i64 1
  br label %sw.epilog
...
if.else201:                                       ; preds = %sw.bb196
  %cmp202 = icmp slt i32 %argc.addr.1822, 3
...
if.else205:                                       ; preds = %if.else201
  %dec206 = add nsw i32 %argc.addr.1822, -1
  %incdec.ptr207 = getelementptr inbounds ptr, ptr %argv.addr.1815, i64 1
  %arrayidx208 = getelementptr inbounds ptr, ptr %argv.addr.1815, i64 2
...
if.then215:                                       ; preds = %sw.bb211
  %inc216 = add nsw i32 %num_options.1824, 1
  %idxprom217 = sext i32 %num_options.1824 to i64
...
if.else219:                                       ; preds = %sw.bb211
  %cmp220 = icmp slt i32 %argc.addr.1822, 3
...
if.else223:                                       ; preds = %if.else219
  %dec224 = add nsw i32 %argc.addr.1822, -1
  %incdec.ptr225 = getelementptr inbounds ptr, ptr %argv.addr.1815, i64 1
  %arrayidx226 = getelementptr inbounds ptr, ptr %argv.addr.1815, i64 2
  %21 = load ptr, ptr %arrayidx226, align 8, !tbaa !5
  %inc227 = add nsw i32 %num_options.1824, 1
  %idxprom228 = sext i32 %num_options.1824 to i64
...
sw.epilog:                                        ; preds = %while.body135, %sw.bb196, %sw.bb182, %sw.bb167, %sw.bb152, %sw.bb, %if.then215, %if.else223, %if.else205, %if.else191, %if.else176, %if.else161, %if.else146, %sw.bb233
  %argv.addr.2 = phi ptr [ %argv.addr.1815, %sw.bb233 ], [ %argv.addr.1815, %if.then215 ], [ %incdec.ptr225, %if.else223 ], [ %incdec.ptr207, %if.else205 ], [ %incdec.ptr193, %if.else191 ], [ %incdec.ptr178, %if.else176 ], [ %incdec.ptr163, %if.else161 ], [ %incdec.ptr148, %if.else146 ], [ %argv.addr.1815, %sw.bb ], [ %argv.addr.1815, %sw.bb152 ], [ %argv.addr.1815, %sw.bb167 ], [ %argv.addr.1815, %sw.bb182 ], [ %argv.addr.1815, %sw.bb196 ], [ %argv.addr.1815, %while.body135 ]
  ...
  %outputFile.2 = phi ptr [ %outputFile.1817, %sw.bb233 ], [ %outputFile.1817, %if.then215 ], [ %outputFile.1817, %if.else223 ], [ %outputFile.1817, %if.else205 ], [ %outputFile.1817, %if.else191 ], [ %outputFile.1817, %if.else176 ], [ %outputFile.1817, %if.else161 ], [ %12, %if.else146 ], [ %incdec.ptr136, %sw.bb ], [ %outputFile.1817, %sw.bb152 ], [ %outputFile.1817, %sw.bb167 ], [ %outputFile.1817, %sw.bb182 ], [ %outputFile.1817, %sw.bb196 ], [ %outputFile.1817, %while.body135 ]
  %headerFile.2 = phi ptr [ %headerFile.1818, %sw.bb233 ], [ %headerFile.1818, %if.then215 ], [ %headerFile.1818, %if.else223 ], [ %headerFile.1818, %if.else205 ], [ %headerFile.1818, %if.else191 ], [ %headerFile.1818, %if.else176 ], [ %14, %if.else161 ], [ %headerFile.1818, %if.else146 ], [ %headerFile.1818, %sw.bb ], [ %incdec.ptr136, %sw.bb152 ], [ %headerFile.1818, %sw.bb167 ], [ %headerFile.1818, %sw.bb182 ], [ %headerFile.1818, %sw.bb196 ], [ %headerFile.1818, %while.body135 ]
  %extension.2 = phi ptr [ %extension.1819, %sw.bb233 ], [ %extension.1819, %if.then215 ], [ %extension.1819, %if.else223 ], [ %19, %if.else205 ], [ %extension.1819, %if.else191 ], [ %extension.1819, %if.else176 ], [ %extension.1819, %if.else161 ], [ %extension.1819, %if.else146 ], [ %extension.1819, %sw.bb ], [ %extension.1819, %sw.bb152 ], [ %extension.1819, %sw.bb167 ], [ %extension.1819, %sw.bb182 ], [ %incdec.ptr136, %sw.bb196 ], [ %extension.1819, %while.body135 ]
  %outputDir.2 = phi ptr [ %outputDir.1820, %sw.bb233 ], [ %outputDir.1820, %if.then215 ], [ %outputDir.1820, %if.else223 ], [ %outputDir.1820, %if.else205 ], [ %outputDir.1820, %if.else191 ], [ %16, %if.else176 ], [ %outputDir.1820, %if.else161 ], [ %outputDir.1820, %if.else146 ], [ %outputDir.1820, %sw.bb ], [ %outputDir.1820, %sw.bb152 ], [ %incdec.ptr136, %sw.bb167 ], [ %outputDir.1820, %sw.bb182 ], [ %outputDir.1820, %sw.bb196 ], [ %outputDir.1820, %while.body135 ]
  %forceCreate.2 = phi i16 [ %forceCreate.1821, %sw.bb233 ], [ %forceCreate.1821, %if.then215 ], [ %forceCreate.1821, %if.else223 ], [ %forceCreate.1821, %if.else205 ], [ %forceCreate.1821, %if.else191 ], [ %forceCreate.1821, %if.else176 ], [ %forceCreate.1821, %if.else161 ], [ %forceCreate.1821, %if.else146 ], [ %forceCreate.1821, %sw.bb ], [ %forceCreate.1821, %sw.bb152 ], [ %forceCreate.1821, %sw.bb167 ], [ %forceCreate.1821, %sw.bb182 ], [ %forceCreate.1821, %sw.bb196 ], [ 1, %while.body135 ]
  %argc.addr.2 = phi i32 [ %argc.addr.1822, %sw.bb233 ], [ %argc.addr.1822, %if.then215 ], [ %dec224, %if.else223 ], [ %dec206, %if.else205 ], [ %dec192, %if.else191 ], [ %dec177, %if.else176 ], [ %dec162, %if.else161 ], [ %dec147, %if.else146 ], [ %argc.addr.1822, %sw.bb ], [ %argc.addr.1822, %sw.bb152 ], [ %argc.addr.1822, %sw.bb167 ], [ %argc.addr.1822, %sw.bb182 ], [ %argc.addr.1822, %sw.bb196 ], [ %argc.addr.1822, %while.body135 ]
  %generateOutput.2 = phi i32 [ 0, %sw.bb233 ], [ %generateOutput.1823, %if.then215 ], [ %generateOutput.1823, %if.else223 ], [ %generateOutput.1823, %if.else205 ], [ %generateOutput.1823, %if.else191 ], [ %generateOutput.1823, %if.else176 ], [ %generateOutput.1823, %if.else161 ], [ %generateOutput.1823, %if.else146 ], [ %generateOutput.1823, %sw.bb ], [ %generateOutput.1823, %sw.bb152 ], [ %generateOutput.1823, %sw.bb167 ], [ %generateOutput.1823, %sw.bb182 ], [ %generateOutput.1823, %sw.bb196 ], [ %generateOutput.1823, %while.body135 ]
  %num_options.2 = phi i32 [ %num_options.1824, %sw.bb233 ], [ %inc216, %if.then215 ], [ %inc227, %if.else223 ], [ %num_options.1824, %if.else205 ], [ %num_options.1824, %if.else191 ], [ %num_options.1824, %if.else176 ], [ %num_options.1824, %if.else161 ], [ %num_options.1824, %if.else146 ], [ %num_options.1824, %sw.bb ], [ %num_options.1824, %sw.bb152 ], [ %num_options.1824, %sw.bb167 ], [ %num_options.1824, %sw.bb182 ], [ %num_options.1824, %sw.bb196 ], [ %num_options.1824, %while.body135 ]
...
if.end236:                                        ; preds = %sw.epilog, %if.else105, %if.else100, %if.end50, %if.then68, %if.end97, %if.end85, %if.end62, %if.end38
  %argv.addr.3 = phi ptr [ %arrayidx5, %if.end97 ], [ %arrayidx5, %if.end85 ], [ %arrayidx5, %if.then68 ], [ %arrayidx5, %if.end62 ], [ %arrayidx5, %if.end50 ], [ %arrayidx5, %if.end38 ], [ %argv.addr.0834, %if.else100 ], [ %argv.addr.0834, %if.else105 ], [ %argv.addr.2, %sw.epilog ]
  %outputFile.3 = phi ptr [ %outputFile.0835, %if.end97 ], [ %outputFile.0835, %if.end85 ], [ %outputFile.0835, %if.then68 ], [ %outputFile.0835, %if.end62 ], [ %outputFile.0835, %if.end50 ], [ %5, %if.end38 ], [ %outputFile.0835, %if.else100 ], [ %outputFile.0835, %if.else105 ], [ %outputFile.2, %sw.epilog ]
  %headerFile.3 = phi ptr [ %headerFile.0836, %if.end97 ], [ %headerFile.0836, %if.end85 ], [ %headerFile.0836, %if.then68 ], [ %headerFile.0836, %if.end62 ], [ %6, %if.end50 ], [ %headerFile.0836, %if.end38 ], [ %headerFile.0836, %if.else100 ], [ %headerFile.0836, %if.else105 ], [ %headerFile.2, %sw.epilog ]
  %extension.3 = phi ptr [ %extension.0837, %if.end97 ], [ %8, %if.end85 ], [ %extension.0837, %if.then68 ], [ %extension.0837, %if.end62 ], [ %extension.0837, %if.end50 ], [ %extension.0837, %if.end38 ], [ %extension.0837, %if.else100 ], [ %extension.0837, %if.else105 ], [ %extension.2, %sw.epilog ]
  %outputDir.3 = phi ptr [ %outputDir.0838, %if.end97 ], [ %outputDir.0838, %if.end85 ], [ %outputDir.0838, %if.then68 ], [ %7, %if.end62 ], [ %outputDir.0838, %if.end50 ], [ %outputDir.0838, %if.end38 ], [ %outputDir.0838, %if.else100 ], [ %outputDir.0838, %if.else105 ], [ %outputDir.2, %sw.epilog ]
  %forceCreate.3 = phi i16 [ %forceCreate.0839, %if.end97 ], [ %forceCreate.0839, %if.end85 ], [ %forceCreate.0839, %if.then68 ], [ %forceCreate.0839, %if.end62 ], [ %forceCreate.0839, %if.end50 ], [ %forceCreate.0839, %if.end38 ], [ 1, %if.else100 ], [ %forceCreate.0839, %if.else105 ], [ %forceCreate.2, %sw.epilog ]
  %argc.addr.3 = phi i32 [ %dec92, %if.end97 ], [ %dec80, %if.end85 ], [ %dec69, %if.then68 ], [ %dec57, %if.end62 ], [ %dec45, %if.end50 ], [ %dec33, %if.end38 ], [ %argc.addr.0840, %if.else100 ], [ %argc.addr.0840, %if.else105 ], [ %argc.addr.2, %sw.epilog ]
  %generateOutput.3 = phi i32 [ %generateOutput.0841, %if.end97 ], [ %generateOutput.0841, %if.end85 ], [ %generateOutput.0841, %if.then68 ], [ %generateOutput.0841, %if.end62 ], [ %generateOutput.0841, %if.end50 ], [ %generateOutput.0841, %if.end38 ], [ %generateOutput.0841, %if.else100 ], [ 0, %if.else105 ], [ %generateOutput.2, %sw.epilog ]
  %num_options.3 = phi i32 [ %inc, %if.end97 ], [ %num_options.0842, %if.end85 ], [ %num_options.0842, %if.then68 ], [ %num_options.0842, %if.end62 ], [ %num_options.0842, %if.end50 ], [ %num_options.0842, %if.end38 ], [ %num_options.0842, %if.else100 ], [ %num_options.0842, %if.else105 ], [ %num_options.2, %sw.epilog ]
...
while.end239:                                     ; preds = %if.then21
  %dec = add nsw i32 %argc.addr.0840, -1
  %cmp240 = icmp ult i32 %argc.addr.0840, 3
...
if.end243:                                        ; preds = %land.rhs, %while.body, %while.end239
  %argc.addr.4541 = phi i32 [ %dec, %while.end239 ], [ %argc.addr.0840, %while.body ], [ %argc.addr.0840, %land.rhs ]
  %argv.addr.4540 = phi ptr [ %arrayidx5, %while.end239 ], [ %argv.addr.0834, %while.body ], [ %argv.addr.0834, %land.rhs ]
  %tobool244.not = icmp eq ptr %outputFile.0835, null
  br i1 %tobool244.not, label %if.then245, label %if.end254

if.then245:                                       ; preds = %if.end243
  %23 = load i8, ptr %extension.0837, align 1, !tbaa !9
  %cmp247 = icmp eq i8 %23, 46
  %spec.select.idx = zext i1 %cmp247 to i64
  %spec.select = getelementptr i8, ptr %extension.0837, i64 %spec.select.idx
...
if.end254:                                        ; preds = %if.then245, %if.end243
  %outputFile.4 = phi ptr [ %outputFile.0835, %if.end243 ], [ %call253, %if.then245 ]
  %tobool255.not = icmp eq ptr %headerFile.0836, null
...
if.end258:                                        ; preds = %if.then256, %if.end254
  %headerFile.4 = phi ptr [ %headerFile.0836, %if.end254 ], [ %call257, %if.then256 ]
  call void @TreeCCOpen(ptr noundef nonnull %input, ptr noundef %0, ptr noundef null, ptr noundef null) #11
  %tobool259.not = icmp eq ptr %outputDir.0838, null
...
land.lhs.true:                                    ; preds = %while.cond264
  ...
  switch i8 %29, label %while.cond264 [
    i8 47, label %while.end284
    i8 92, label %while.end284
  ], !llvm.loop !13

while.end284:                                     ; preds = %land.lhs.true, %land.lhs.true, %while.cond264
  %len.0.lcssa = phi i32 [ %27, %land.lhs.true ], [ %27, %land.lhs.true ], [ %smin, %while.cond264 ]
...
if.end297:                                        ; preds = %if.then296, %if.then292
  %30 = phi ptr [ %.pre, %if.then296 ], [ %25, %if.then292 ]
  %conv299 = zext i32 %spec.select535 to i64
  %call300 = call ptr @strncpy(ptr noundef %call294, ptr noundef %30, i64 noundef %conv299) #11
...
if.end304:                                        ; preds = %while.end284, %if.end297, %if.end258
  %outputDir.4 = phi ptr [ %outputDir.0838, %if.end258 ], [ %call294, %if.end297 ], [ null, %while.end284 ]
...
if.end308:                                        ; preds = %if.then307, %if.end304
  ...
  %bf.value = shl nuw nsw i16 %forceCreate.0839, 4
...
while.cond.i:                                     ; preds = %if.end.i, %if.end308
  ...
  %num.addr.0.i = phi i32 [ %num_options.0842, %if.end308 ], [ %dec.i, %if.end.i ]
...
while.body.i:                                     ; preds = %while.cond.i
  ...
  %31 = load ptr, ptr %options.addr.0.i, align 8, !tbaa !5
  br label %while.cond1.i

while.cond1.i:                                    ; preds = %while.body7.i, %while.body.i
  %value.0.i = phi ptr [ %31, %while.body.i ], [ %incdec.ptr8.i, %while.body7.i ]
  %32 = load i8, ptr %value.0.i, align 1, !tbaa !9
  switch i8 %32, label %while.body7.i [
    i8 0, label %if.end.i
...
if.end.i:                                         ; preds = %while.cond1.i, %if.else.i
  ...
  %call.i = call i32 @TreeCCOptionProcess(ptr noundef %call305, ptr noundef %31, ptr noundef %value.1.i) #11
...
ExtraOptions.exit.thread:                         ; preds = %if.end.i
  ...
  %call16.i = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %33, ptr noundef nonnull @.str.40, ptr noundef %31) #14
  br label %cleanup
...
if.end312:                                        ; preds = %while.cond.i
  ...
  %cmp325843 = icmp sgt i32 %argc.addr.4541, 1
  br i1 %cmp325843, label %while.body327.lr.ph, label %while.end348
...
while.body327:                                    ; preds = %while.body327.lr.ph, %if.end345
  %sawStdin.0846 = phi i32 [ 0, %while.body327.lr.ph ], [ %sawStdin.1, %if.end345 ]
  %argc.addr.5845 = phi i32 [ %argc.addr.4541, %while.body327.lr.ph ], [ %dec346, %if.end345 ]
  %argv.addr.5844 = phi ptr [ %argv.addr.4540, %while.body327.lr.ph ], [ %arrayidx328, %if.end345 ]
  %arrayidx328 = getelementptr inbounds ptr, ptr %argv.addr.5844, i64 1
  %34 = load ptr, ptr %arrayidx328, align 8, !tbaa !5
  %call329 = call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %34, ptr noundef nonnull dereferenceable(2) @.str.13) #13
  %tobool330.not = icmp eq i32 %call329, 0
  br i1 %tobool330.not, label %if.then331, label %if.else335

if.then331:                                       ; preds = %while.body327
  %tobool332.not = icmp eq i32 %sawStdin.0846, 0
  br i1 %tobool332.not, label %if.then333, label %if.end345

if.then333:                                       ; preds = %if.then331
  %35 = load ptr, ptr @stdin, align 8, !tbaa !5
  call void @TreeCCOpen(ptr noundef nonnull %input, ptr noundef %0, ptr noundef %35, ptr noundef nonnull @.str.14) #11
...
if.else335:                                       ; preds = %while.body327
  %call337 = call noalias ptr @fopen(ptr noundef %34, ptr noundef nonnull @.str.15)
  %cmp338 = icmp eq ptr %call337, null
  %36 = load ptr, ptr %arrayidx328, align 8, !tbaa !5
  br i1 %cmp338, label %if.then340, label %if.else342

if.then340:                                       ; preds = %if.else335
  call void @perror(ptr noundef %36) #14
  store i32 1, ptr %errors, align 8, !tbaa !21
  br label %if.end345

if.else342:                                       ; preds = %if.else335
  call void @TreeCCOpen(ptr noundef nonnull %input, ptr noundef %0, ptr noundef nonnull %call337, ptr noundef %36) #11
  call void @TreeCCParse(ptr noundef %call305) #11
...
if.end345:                                        ; preds = %if.then340, %if.else342, %if.then331, %if.then333
  %sawStdin.1 = phi i32 [ %sawStdin.0846, %if.then340 ], [ %sawStdin.0846, %if.else342 ], [ 1, %if.then331 ], [ 1, %if.then333 ]
  %dec346 = add nsw i32 %argc.addr.5845, -1
  %cmp325 = icmp sgt i32 %argc.addr.5845, 2
...
while.end348:                                     ; preds = %if.end345, %if.end312
  ...
  %37 = load i32, ptr %errors349, align 8, !tbaa !21
  %tobool350.not = icmp eq i32 %37, 0
...
if.end352:                                        ; preds = %while.end348
  %tobool353.not = icmp eq i32 %generateOutput.0841, 0
...
if.then354:                                       ; preds = %if.end352
  ...
  %stream.0847 = load ptr, ptr %streamList, align 8, !tbaa !5
  %cmp356.not848 = icmp eq ptr %stream.0847, null
  br i1 %cmp356.not848, label %if.end364, label %while.body358

while.body358:                                    ; preds = %if.then354, %while.body358
  %stream.0850 = phi ptr [ %stream.0, %while.body358 ], [ %stream.0847, %if.then354 ]
  %result.0849 = phi i32 [ %spec.select536, %while.body358 ], [ 0, %if.then354 ]
  %call359 = call i32 @TreeCCStreamFlush(ptr noundef nonnull %stream.0850) #11
  %tobool360.not = icmp eq i32 %call359, 0
  %spec.select536 = select i1 %tobool360.not, i32 1, i32 %result.0849
  %nextStream = getelementptr inbounds %struct._tagTreeCCStream, ptr %stream.0850, i64 0, i32 10
...
cleanup:                                          ; preds = %ExtraOptions.exit.thread, %if.end364, %if.then351, %if.then242, %sw.default, %sw.bb234, %if.then222, %if.then204, %if.then190, %if.then175, %if.then160, %if.then145, %if.else120, %if.then119, %if.then114, %if.then96, %if.then84, %if.then73, %if.then61, %if.then49, %if.then37
  %retval.0 = phi i32 [ 1, %if.then242 ], [ 1, %if.then351 ], [ %result.2, %if.end364 ], [ 1, %if.else120 ], [ 0, %if.then119 ], [ 1, %if.then114 ], [ 1, %if.then96 ], [ 1, %if.then84 ], [ 1, %if.then73 ], [ 1, %if.then61 ], [ 1, %if.then49 ], [ 1, %if.then37 ], [ 1, %sw.default ], [ 0, %sw.bb234 ], [ 1, %if.then222 ], [ 1, %if.then204 ], [ 1, %if.then190 ], [ 1, %if.then175 ], [ 1, %if.then160 ], [ 1, %if.then145 ], [ 1, %ExtraOptions.exit.thread ]
