...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 1096, ptr nonnull %input) #10
  %conv = sext i32 %argc to i64
  %mul = shl nsw i64 %conv, 3
  %call3 = tail call noalias ptr @malloc(i64 noundef %mul) #11
...
if.end:                                           ; preds = %if.then, %entry
  %cmp816 = icmp sgt i32 %argc, 1
  br i1 %cmp816, label %land.rhs, label %if.then242

land.rhs:                                         ; preds = %if.end, %if.end236
  %num_options.0825 = phi i32 [ %num_options.3, %if.end236 ], [ 0, %if.end ]
  %generateOutput.0824 = phi i32 [ %generateOutput.3, %if.end236 ], [ 1, %if.end ]
  %argc.addr.0823 = phi i32 [ %dec237, %if.end236 ], [ %argc, %if.end ]
  %forceCreate.0822 = phi i16 [ %forceCreate.3, %if.end236 ], [ 0, %if.end ]
  %outputDir.0821 = phi ptr [ %outputDir.3, %if.end236 ], [ null, %if.end ]
  %extension.0820 = phi ptr [ %extension.3, %if.end236 ], [ @.str, %if.end ]
  %headerFile.0819 = phi ptr [ %headerFile.3, %if.end236 ], [ null, %if.end ]
  %outputFile.0818 = phi ptr [ %outputFile.3, %if.end236 ], [ null, %if.end ]
  %argv.addr.0817 = phi ptr [ %incdec.ptr238, %if.end236 ], [ %argv, %if.end ]
  %arrayidx5 = getelementptr inbounds ptr, ptr %argv.addr.0817, i64 1
...
if.end28:                                         ; preds = %if.then21
  %call30 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %1, ptr noundef nonnull dereferenceable(9) @.str.1) #12
  %tobool31.not = icmp eq i32 %call30, 0
  br i1 %tobool31.not, label %if.then32, label %if.else40

if.then32:                                        ; preds = %if.end28
  %cmp35 = icmp ult i32 %argc.addr.0823, 3
...
if.end38:                                         ; preds = %if.then32
  %dec33 = add nsw i32 %argc.addr.0823, -1
  %arrayidx39 = getelementptr inbounds ptr, ptr %argv.addr.0817, i64 2
  %5 = load ptr, ptr %arrayidx39, align 8, !tbaa !5
  br label %if.end236

if.else40:                                        ; preds = %if.end28
  %call42 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %1, ptr noundef nonnull dereferenceable(9) @.str.2) #12
  %tobool43.not = icmp eq i32 %call42, 0
  br i1 %tobool43.not, label %if.then44, label %if.else52

if.then44:                                        ; preds = %if.else40
  %cmp47 = icmp ult i32 %argc.addr.0823, 3
...
if.end50:                                         ; preds = %if.then44
  %dec45 = add nsw i32 %argc.addr.0823, -1
  %arrayidx51 = getelementptr inbounds ptr, ptr %argv.addr.0817, i64 2
  %6 = load ptr, ptr %arrayidx51, align 8, !tbaa !5
  br label %if.end236

if.else52:                                        ; preds = %if.else40
  %call54 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %1, ptr noundef nonnull dereferenceable(13) @.str.3) #12
  %tobool55.not = icmp eq i32 %call54, 0
  br i1 %tobool55.not, label %if.then56, label %if.else64

if.then56:                                        ; preds = %if.else52
  %cmp59 = icmp ult i32 %argc.addr.0823, 3
...
if.end62:                                         ; preds = %if.then56
  %dec57 = add nsw i32 %argc.addr.0823, -1
  %arrayidx63 = getelementptr inbounds ptr, ptr %argv.addr.0817, i64 2
  %7 = load ptr, ptr %arrayidx63, align 8, !tbaa !5
  br label %if.end236

if.else64:                                        ; preds = %if.else52
  %call66 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %1, ptr noundef nonnull dereferenceable(15) @.str.4) #12
  %tobool67.not = icmp eq i32 %call66, 0
  br i1 %tobool67.not, label %if.then68, label %if.else75

if.then68:                                        ; preds = %if.else64
  %dec69 = add nsw i32 %argc.addr.0823, -1
  %cmp71 = icmp ult i32 %argc.addr.0823, 3
...
if.else75:                                        ; preds = %if.else64
  %call77 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %1, ptr noundef nonnull dereferenceable(12) @.str.5) #12
  %tobool78.not = icmp eq i32 %call77, 0
  br i1 %tobool78.not, label %if.then79, label %if.else87

if.then79:                                        ; preds = %if.else75
  %cmp82 = icmp ult i32 %argc.addr.0823, 3
...
if.end85:                                         ; preds = %if.then79
  %dec80 = add nsw i32 %argc.addr.0823, -1
  %arrayidx86 = getelementptr inbounds ptr, ptr %argv.addr.0817, i64 2
  %8 = load ptr, ptr %arrayidx86, align 8, !tbaa !5
  br label %if.end236

if.else87:                                        ; preds = %if.else75
  %call89 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %1, ptr noundef nonnull dereferenceable(9) @.str.6) #12
  %tobool90.not = icmp eq i32 %call89, 0
  br i1 %tobool90.not, label %if.then91, label %if.else100

if.then91:                                        ; preds = %if.else87
  %cmp94 = icmp ult i32 %argc.addr.0823, 3
...
if.end97:                                         ; preds = %if.then91
  %dec92 = add nsw i32 %argc.addr.0823, -1
  %arrayidx98 = getelementptr inbounds ptr, ptr %argv.addr.0817, i64 2
  %9 = load ptr, ptr %arrayidx98, align 8, !tbaa !5
  %inc = add nsw i32 %num_options.0825, 1
  %idxprom = sext i32 %num_options.0825 to i64
...
if.else100:                                       ; preds = %if.else87
  %call102 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %1, ptr noundef nonnull dereferenceable(15) @.str.7) #12
  %tobool103.not = icmp eq i32 %call102, 0
  br i1 %tobool103.not, label %if.end236, label %if.else105

if.else105:                                       ; preds = %if.else100
  %call107 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %1, ptr noundef nonnull dereferenceable(12) @.str.8) #12
  %tobool108.not = icmp eq i32 %call107, 0
  br i1 %tobool108.not, label %if.end236, label %if.else110

if.else110:                                       ; preds = %if.else105
  %call112 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %1, ptr noundef nonnull dereferenceable(7) @.str.9) #12
...
if.else115:                                       ; preds = %if.else110
  %call117 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %1, ptr noundef nonnull dereferenceable(10) @.str.10) #12
...
while.body135:                                    ; preds = %while.body, %sw.epilog
  ...
  %num_options.1807 = phi i32 [ %num_options.2, %sw.epilog ], [ %num_options.0825, %while.body ]
  %generateOutput.1806 = phi i32 [ %generateOutput.2, %sw.epilog ], [ %generateOutput.0824, %while.body ]
  %argc.addr.1805 = phi i32 [ %argc.addr.2, %sw.epilog ], [ %argc.addr.0823, %while.body ]
  %forceCreate.1804 = phi i16 [ %forceCreate.2, %sw.epilog ], [ %forceCreate.0822, %while.body ]
  %outputDir.1803 = phi ptr [ %outputDir.2, %sw.epilog ], [ %outputDir.0821, %while.body ]
  %extension.1802 = phi ptr [ %extension.2, %sw.epilog ], [ %extension.0820, %while.body ]
  %headerFile.1801 = phi ptr [ %headerFile.2, %sw.epilog ], [ %headerFile.0819, %while.body ]
  %outputFile.1800 = phi ptr [ %outputFile.2, %sw.epilog ], [ %outputFile.0818, %while.body ]
  %opt.0799 = phi ptr [ %opt.1, %sw.epilog ], [ %arrayidx11, %while.body ]
  %argv.addr.1798 = phi ptr [ %argv.addr.2, %sw.epilog ], [ %argv.addr.0817, %while.body ]
  %conv132 = sext i8 %10 to i32
  %incdec.ptr136 = getelementptr inbounds i8, ptr %opt.0799, i64 1
...
if.else142:                                       ; preds = %sw.bb
  %cmp143 = icmp slt i32 %argc.addr.1805, 3
...
if.else146:                                       ; preds = %if.else142
  %dec147 = add nsw i32 %argc.addr.1805, -1
  %incdec.ptr148 = getelementptr inbounds ptr, ptr %argv.addr.1798, i64 1
  %arrayidx149 = getelementptr inbounds ptr, ptr %argv.addr.1798, i64 2
...
if.else157:                                       ; preds = %sw.bb152
  %cmp158 = icmp slt i32 %argc.addr.1805, 3
...
if.else161:                                       ; preds = %if.else157
  %dec162 = add nsw i32 %argc.addr.1805, -1
  %incdec.ptr163 = getelementptr inbounds ptr, ptr %argv.addr.1798, i64 1
  %arrayidx164 = getelementptr inbounds ptr, ptr %argv.addr.1798, i64 2
...
if.else172:                                       ; preds = %sw.bb167
  %cmp173 = icmp slt i32 %argc.addr.1805, 3
...
if.else176:                                       ; preds = %if.else172
  %dec177 = add nsw i32 %argc.addr.1805, -1
  %incdec.ptr178 = getelementptr inbounds ptr, ptr %argv.addr.1798, i64 1
  %arrayidx179 = getelementptr inbounds ptr, ptr %argv.addr.1798, i64 2
...
if.else187:                                       ; preds = %sw.bb182
  %cmp188 = icmp slt i32 %argc.addr.1805, 3
...
if.else191:                                       ; preds = %if.else187
  %dec192 = add nsw i32 %argc.addr.1805, -1
  %incdec.ptr193 = getelementptr inbounds ptr, ptr %argv.addr.1798, i64 1
  br label %sw.epilog
...
if.else201:                                       ; preds = %sw.bb196
  %cmp202 = icmp slt i32 %argc.addr.1805, 3
...
if.else205:                                       ; preds = %if.else201
  %dec206 = add nsw i32 %argc.addr.1805, -1
  %incdec.ptr207 = getelementptr inbounds ptr, ptr %argv.addr.1798, i64 1
  %arrayidx208 = getelementptr inbounds ptr, ptr %argv.addr.1798, i64 2
...
if.then215:                                       ; preds = %sw.bb211
  %inc216 = add nsw i32 %num_options.1807, 1
  %idxprom217 = sext i32 %num_options.1807 to i64
...
if.else219:                                       ; preds = %sw.bb211
  %cmp220 = icmp slt i32 %argc.addr.1805, 3
...
if.else223:                                       ; preds = %if.else219
  %dec224 = add nsw i32 %argc.addr.1805, -1
  %incdec.ptr225 = getelementptr inbounds ptr, ptr %argv.addr.1798, i64 1
  %arrayidx226 = getelementptr inbounds ptr, ptr %argv.addr.1798, i64 2
  %21 = load ptr, ptr %arrayidx226, align 8, !tbaa !5
  %inc227 = add nsw i32 %num_options.1807, 1
  %idxprom228 = sext i32 %num_options.1807 to i64
...
sw.epilog:                                        ; preds = %while.body135, %sw.bb196, %sw.bb182, %sw.bb167, %sw.bb152, %sw.bb, %if.then215, %if.else223, %if.else205, %if.else191, %if.else176, %if.else161, %if.else146, %sw.bb233
  %argv.addr.2 = phi ptr [ %argv.addr.1798, %sw.bb233 ], [ %argv.addr.1798, %if.then215 ], [ %incdec.ptr225, %if.else223 ], [ %incdec.ptr207, %if.else205 ], [ %incdec.ptr193, %if.else191 ], [ %incdec.ptr178, %if.else176 ], [ %incdec.ptr163, %if.else161 ], [ %incdec.ptr148, %if.else146 ], [ %argv.addr.1798, %sw.bb ], [ %argv.addr.1798, %sw.bb152 ], [ %argv.addr.1798, %sw.bb167 ], [ %argv.addr.1798, %sw.bb182 ], [ %argv.addr.1798, %sw.bb196 ], [ %argv.addr.1798, %while.body135 ]
  ...
  %outputFile.2 = phi ptr [ %outputFile.1800, %sw.bb233 ], [ %outputFile.1800, %if.then215 ], [ %outputFile.1800, %if.else223 ], [ %outputFile.1800, %if.else205 ], [ %outputFile.1800, %if.else191 ], [ %outputFile.1800, %if.else176 ], [ %outputFile.1800, %if.else161 ], [ %12, %if.else146 ], [ %incdec.ptr136, %sw.bb ], [ %outputFile.1800, %sw.bb152 ], [ %outputFile.1800, %sw.bb167 ], [ %outputFile.1800, %sw.bb182 ], [ %outputFile.1800, %sw.bb196 ], [ %outputFile.1800, %while.body135 ]
  %headerFile.2 = phi ptr [ %headerFile.1801, %sw.bb233 ], [ %headerFile.1801, %if.then215 ], [ %headerFile.1801, %if.else223 ], [ %headerFile.1801, %if.else205 ], [ %headerFile.1801, %if.else191 ], [ %headerFile.1801, %if.else176 ], [ %14, %if.else161 ], [ %headerFile.1801, %if.else146 ], [ %headerFile.1801, %sw.bb ], [ %incdec.ptr136, %sw.bb152 ], [ %headerFile.1801, %sw.bb167 ], [ %headerFile.1801, %sw.bb182 ], [ %headerFile.1801, %sw.bb196 ], [ %headerFile.1801, %while.body135 ]
  %extension.2 = phi ptr [ %extension.1802, %sw.bb233 ], [ %extension.1802, %if.then215 ], [ %extension.1802, %if.else223 ], [ %19, %if.else205 ], [ %extension.1802, %if.else191 ], [ %extension.1802, %if.else176 ], [ %extension.1802, %if.else161 ], [ %extension.1802, %if.else146 ], [ %extension.1802, %sw.bb ], [ %extension.1802, %sw.bb152 ], [ %extension.1802, %sw.bb167 ], [ %extension.1802, %sw.bb182 ], [ %incdec.ptr136, %sw.bb196 ], [ %extension.1802, %while.body135 ]
  %outputDir.2 = phi ptr [ %outputDir.1803, %sw.bb233 ], [ %outputDir.1803, %if.then215 ], [ %outputDir.1803, %if.else223 ], [ %outputDir.1803, %if.else205 ], [ %outputDir.1803, %if.else191 ], [ %16, %if.else176 ], [ %outputDir.1803, %if.else161 ], [ %outputDir.1803, %if.else146 ], [ %outputDir.1803, %sw.bb ], [ %outputDir.1803, %sw.bb152 ], [ %incdec.ptr136, %sw.bb167 ], [ %outputDir.1803, %sw.bb182 ], [ %outputDir.1803, %sw.bb196 ], [ %outputDir.1803, %while.body135 ]
  %forceCreate.2 = phi i16 [ %forceCreate.1804, %sw.bb233 ], [ %forceCreate.1804, %if.then215 ], [ %forceCreate.1804, %if.else223 ], [ %forceCreate.1804, %if.else205 ], [ %forceCreate.1804, %if.else191 ], [ %forceCreate.1804, %if.else176 ], [ %forceCreate.1804, %if.else161 ], [ %forceCreate.1804, %if.else146 ], [ %forceCreate.1804, %sw.bb ], [ %forceCreate.1804, %sw.bb152 ], [ %forceCreate.1804, %sw.bb167 ], [ %forceCreate.1804, %sw.bb182 ], [ %forceCreate.1804, %sw.bb196 ], [ 1, %while.body135 ]
  %argc.addr.2 = phi i32 [ %argc.addr.1805, %sw.bb233 ], [ %argc.addr.1805, %if.then215 ], [ %dec224, %if.else223 ], [ %dec206, %if.else205 ], [ %dec192, %if.else191 ], [ %dec177, %if.else176 ], [ %dec162, %if.else161 ], [ %dec147, %if.else146 ], [ %argc.addr.1805, %sw.bb ], [ %argc.addr.1805, %sw.bb152 ], [ %argc.addr.1805, %sw.bb167 ], [ %argc.addr.1805, %sw.bb182 ], [ %argc.addr.1805, %sw.bb196 ], [ %argc.addr.1805, %while.body135 ]
  %generateOutput.2 = phi i32 [ 0, %sw.bb233 ], [ %generateOutput.1806, %if.then215 ], [ %generateOutput.1806, %if.else223 ], [ %generateOutput.1806, %if.else205 ], [ %generateOutput.1806, %if.else191 ], [ %generateOutput.1806, %if.else176 ], [ %generateOutput.1806, %if.else161 ], [ %generateOutput.1806, %if.else146 ], [ %generateOutput.1806, %sw.bb ], [ %generateOutput.1806, %sw.bb152 ], [ %generateOutput.1806, %sw.bb167 ], [ %generateOutput.1806, %sw.bb182 ], [ %generateOutput.1806, %sw.bb196 ], [ %generateOutput.1806, %while.body135 ]
  %num_options.2 = phi i32 [ %num_options.1807, %sw.bb233 ], [ %inc216, %if.then215 ], [ %inc227, %if.else223 ], [ %num_options.1807, %if.else205 ], [ %num_options.1807, %if.else191 ], [ %num_options.1807, %if.else176 ], [ %num_options.1807, %if.else161 ], [ %num_options.1807, %if.else146 ], [ %num_options.1807, %sw.bb ], [ %num_options.1807, %sw.bb152 ], [ %num_options.1807, %sw.bb167 ], [ %num_options.1807, %sw.bb182 ], [ %num_options.1807, %sw.bb196 ], [ %num_options.1807, %while.body135 ]
...
if.end236:                                        ; preds = %sw.epilog, %if.else105, %if.else100, %if.end50, %if.then68, %if.end97, %if.end85, %if.end62, %if.end38
  %argv.addr.3 = phi ptr [ %arrayidx5, %if.end97 ], [ %arrayidx5, %if.end85 ], [ %arrayidx5, %if.then68 ], [ %arrayidx5, %if.end62 ], [ %arrayidx5, %if.end50 ], [ %arrayidx5, %if.end38 ], [ %argv.addr.0817, %if.else100 ], [ %argv.addr.0817, %if.else105 ], [ %argv.addr.2, %sw.epilog ]
  %outputFile.3 = phi ptr [ %outputFile.0818, %if.end97 ], [ %outputFile.0818, %if.end85 ], [ %outputFile.0818, %if.then68 ], [ %outputFile.0818, %if.end62 ], [ %outputFile.0818, %if.end50 ], [ %5, %if.end38 ], [ %outputFile.0818, %if.else100 ], [ %outputFile.0818, %if.else105 ], [ %outputFile.2, %sw.epilog ]
  %headerFile.3 = phi ptr [ %headerFile.0819, %if.end97 ], [ %headerFile.0819, %if.end85 ], [ %headerFile.0819, %if.then68 ], [ %headerFile.0819, %if.end62 ], [ %6, %if.end50 ], [ %headerFile.0819, %if.end38 ], [ %headerFile.0819, %if.else100 ], [ %headerFile.0819, %if.else105 ], [ %headerFile.2, %sw.epilog ]
  %extension.3 = phi ptr [ %extension.0820, %if.end97 ], [ %8, %if.end85 ], [ %extension.0820, %if.then68 ], [ %extension.0820, %if.end62 ], [ %extension.0820, %if.end50 ], [ %extension.0820, %if.end38 ], [ %extension.0820, %if.else100 ], [ %extension.0820, %if.else105 ], [ %extension.2, %sw.epilog ]
  %outputDir.3 = phi ptr [ %outputDir.0821, %if.end97 ], [ %outputDir.0821, %if.end85 ], [ %outputDir.0821, %if.then68 ], [ %7, %if.end62 ], [ %outputDir.0821, %if.end50 ], [ %outputDir.0821, %if.end38 ], [ %outputDir.0821, %if.else100 ], [ %outputDir.0821, %if.else105 ], [ %outputDir.2, %sw.epilog ]
  %forceCreate.3 = phi i16 [ %forceCreate.0822, %if.end97 ], [ %forceCreate.0822, %if.end85 ], [ %forceCreate.0822, %if.then68 ], [ %forceCreate.0822, %if.end62 ], [ %forceCreate.0822, %if.end50 ], [ %forceCreate.0822, %if.end38 ], [ 1, %if.else100 ], [ %forceCreate.0822, %if.else105 ], [ %forceCreate.2, %sw.epilog ]
  %argc.addr.3 = phi i32 [ %dec92, %if.end97 ], [ %dec80, %if.end85 ], [ %dec69, %if.then68 ], [ %dec57, %if.end62 ], [ %dec45, %if.end50 ], [ %dec33, %if.end38 ], [ %argc.addr.0823, %if.else100 ], [ %argc.addr.0823, %if.else105 ], [ %argc.addr.2, %sw.epilog ]
  %generateOutput.3 = phi i32 [ %generateOutput.0824, %if.end97 ], [ %generateOutput.0824, %if.end85 ], [ %generateOutput.0824, %if.then68 ], [ %generateOutput.0824, %if.end62 ], [ %generateOutput.0824, %if.end50 ], [ %generateOutput.0824, %if.end38 ], [ %generateOutput.0824, %if.else100 ], [ 0, %if.else105 ], [ %generateOutput.2, %sw.epilog ]
  %num_options.3 = phi i32 [ %inc, %if.end97 ], [ %num_options.0825, %if.end85 ], [ %num_options.0825, %if.then68 ], [ %num_options.0825, %if.end62 ], [ %num_options.0825, %if.end50 ], [ %num_options.0825, %if.end38 ], [ %num_options.0825, %if.else100 ], [ %num_options.0825, %if.else105 ], [ %num_options.2, %sw.epilog ]
...
while.end239:                                     ; preds = %if.then21
  %dec = add nsw i32 %argc.addr.0823, -1
...
if.end243:                                        ; preds = %land.rhs, %while.body, %while.end239
  %argc.addr.4541 = phi i32 [ %dec, %while.end239 ], [ %argc.addr.0823, %while.body ], [ %argc.addr.0823, %land.rhs ]
  %argv.addr.4540 = phi ptr [ %arrayidx5, %while.end239 ], [ %argv.addr.0817, %while.body ], [ %argv.addr.0817, %land.rhs ]
  %tobool244.not = icmp eq ptr %outputFile.0818, null
  br i1 %tobool244.not, label %if.then245, label %if.end254

if.then245:                                       ; preds = %if.end243
  %23 = load i8, ptr %extension.0820, align 1, !tbaa !9
  %cmp247 = icmp eq i8 %23, 46
  %spec.select.idx = zext i1 %cmp247 to i64
  %spec.select = getelementptr i8, ptr %extension.0820, i64 %spec.select.idx
...
if.end254:                                        ; preds = %if.then245, %if.end243
  %outputFile.4 = phi ptr [ %outputFile.0818, %if.end243 ], [ %call253, %if.then245 ]
  %tobool255.not = icmp eq ptr %headerFile.0819, null
...
if.end258:                                        ; preds = %if.then256, %if.end254
  %headerFile.4 = phi ptr [ %headerFile.0819, %if.end254 ], [ %call257, %if.then256 ]
  call void @TreeCCOpen(ptr noundef nonnull %input, ptr noundef %0, ptr noundef null, ptr noundef null) #10
  %tobool259.not = icmp eq ptr %outputDir.0821, null
...
if.then260:                                       ; preds = %if.end258
  ...
  %call262 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %25) #12
  %conv263 = trunc i64 %call262 to i32
  %cmp265826 = icmp sgt i32 %conv263, 0
  br i1 %cmp265826, label %land.lhs.true.preheader, label %while.end284

land.lhs.true.preheader:                          ; preds = %if.then260
  %26 = and i64 %call262, 4294967295
  br label %land.lhs.true

land.lhs.true:                                    ; preds = %land.lhs.true.preheader, %while.body282
  %indvars.iv = phi i64 [ %26, %land.lhs.true.preheader ], [ %indvars.iv.next, %while.body282 ]
  %len.0827 = phi i32 [ %conv263, %land.lhs.true.preheader ], [ %sub, %while.body282 ]
  %sub = add nsw i32 %len.0827, -1
  %idxprom268 = zext i32 %sub to i64
  %arrayidx269 = getelementptr inbounds i8, ptr %25, i64 %idxprom268
  %27 = load i8, ptr %arrayidx269, align 1, !tbaa !9
  switch i8 %27, label %while.body282 [
    i8 47, label %while.end284.loopexit.split.loop.exit
    i8 92, label %while.end284.loopexit.split.loop.exit
  ]

while.body282:                                    ; preds = %land.lhs.true
  %cmp265 = icmp sgt i64 %indvars.iv, 1
  %indvars.iv.next = add nsw i64 %indvars.iv, -1
  br i1 %cmp265, label %land.lhs.true, label %while.end284, !llvm.loop !13

while.end284.loopexit.split.loop.exit:            ; preds = %land.lhs.true, %land.lhs.true
  %28 = trunc i64 %indvars.iv to i32
  br label %while.end284

while.end284:                                     ; preds = %while.body282, %while.end284.loopexit.split.loop.exit, %if.then260
  %len.0.lcssa = phi i32 [ %conv263, %if.then260 ], [ %28, %while.end284.loopexit.split.loop.exit ], [ 0, %while.body282 ]
  %cmp265.lcssa = phi i32 [ 0, %if.then260 ], [ -1, %while.end284.loopexit.split.loop.exit ], [ 0, %while.body282 ]
  %spec.select535 = add nsw i32 %len.0.lcssa, %cmp265.lcssa
...
if.end304:                                        ; preds = %while.end284, %if.end297, %if.end258
  %outputDir.4 = phi ptr [ %outputDir.0821, %if.end258 ], [ %call294, %if.end297 ], [ null, %while.end284 ]
  %call305 = call ptr @TreeCCContextCreate(ptr noundef nonnull %input) #10
...
if.end308:                                        ; preds = %if.then307, %if.end304
  ...
  %bf.value = shl nuw nsw i16 %forceCreate.0822, 4
...
while.cond.i:                                     ; preds = %if.end.i, %if.end308
  ...
  %num.addr.0.i = phi i32 [ %num_options.0825, %if.end308 ], [ %dec.i, %if.end.i ]
...
while.body.i:                                     ; preds = %while.cond.i
  ...
  %30 = load ptr, ptr %options.addr.0.i, align 8, !tbaa !5
  br label %while.cond1.i

while.cond1.i:                                    ; preds = %while.body7.i, %while.body.i
  %value.0.i = phi ptr [ %30, %while.body.i ], [ %incdec.ptr8.i, %while.body7.i ]
  %31 = load i8, ptr %value.0.i, align 1, !tbaa !9
  switch i8 %31, label %while.body7.i [
    i8 0, label %if.end.i
...
if.end.i:                                         ; preds = %while.cond1.i, %if.else.i
  ...
  %call.i = call i32 @TreeCCOptionProcess(ptr noundef %call305, ptr noundef %30, ptr noundef %value.1.i) #10
...
if.then15.i:                                      ; preds = %if.end.i
  ...
  %call16.i = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %32, ptr noundef nonnull @.str.40, ptr noundef %30) #13
  br label %cleanup

if.end312:                                        ; preds = %while.cond.i
  call void @free(ptr noundef %call3) #10
  %call313 = call ptr @TreeCCStreamCreate(ptr noundef %call305, ptr noundef %outputFile.4, ptr noundef null, i32 noundef 0) #10
  ...
  %call318 = call ptr @TreeCCStreamCreate(ptr noundef %call305, ptr noundef %headerFile.4, ptr noundef null, i32 noundef 1) #10
  ...
  %cmp325836 = icmp sgt i32 %argc.addr.4541, 1
  br i1 %cmp325836, label %while.body327.lr.ph, label %while.end348
...
while.body327:                                    ; preds = %while.body327.lr.ph, %if.end345
  %sawStdin.0839 = phi i32 [ 0, %while.body327.lr.ph ], [ %sawStdin.1, %if.end345 ]
  %argc.addr.5838 = phi i32 [ %argc.addr.4541, %while.body327.lr.ph ], [ %dec346, %if.end345 ]
  %argv.addr.5837 = phi ptr [ %argv.addr.4540, %while.body327.lr.ph ], [ %arrayidx328, %if.end345 ]
  %arrayidx328 = getelementptr inbounds ptr, ptr %argv.addr.5837, i64 1
  %33 = load ptr, ptr %arrayidx328, align 8, !tbaa !5
  %call329 = call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %33, ptr noundef nonnull dereferenceable(2) @.str.13) #12
  %tobool330.not = icmp eq i32 %call329, 0
  br i1 %tobool330.not, label %if.then331, label %if.else335

if.then331:                                       ; preds = %while.body327
  %tobool332.not = icmp eq i32 %sawStdin.0839, 0
  br i1 %tobool332.not, label %if.then333, label %if.end345

if.then333:                                       ; preds = %if.then331
  %34 = load ptr, ptr @stdin, align 8, !tbaa !5
  call void @TreeCCOpen(ptr noundef nonnull %input, ptr noundef %0, ptr noundef %34, ptr noundef nonnull @.str.14) #10
  call void @TreeCCParse(ptr noundef %call305) #10
  call void @TreeCCClose(ptr noundef nonnull %input, i32 noundef 0) #10
  br label %if.end345

if.else335:                                       ; preds = %while.body327
  %call337 = call noalias ptr @fopen(ptr noundef %33, ptr noundef nonnull @.str.15)
...
if.then340:                                       ; preds = %if.else335
  call void @perror(ptr noundef %35) #13
  store i32 1, ptr %errors, align 8, !tbaa !21
  br label %if.end345

if.else342:                                       ; preds = %if.else335
  call void @TreeCCOpen(ptr noundef nonnull %input, ptr noundef %0, ptr noundef nonnull %call337, ptr noundef %35) #10
  call void @TreeCCParse(ptr noundef %call305) #10
  call void @TreeCCClose(ptr noundef nonnull %input, i32 noundef 1) #10
  br label %if.end345

if.end345:                                        ; preds = %if.then340, %if.else342, %if.then331, %if.then333
  %sawStdin.1 = phi i32 [ %sawStdin.0839, %if.then340 ], [ %sawStdin.0839, %if.else342 ], [ 1, %if.then331 ], [ 1, %if.then333 ]
  %dec346 = add nsw i32 %argc.addr.5838, -1
  %cmp325 = icmp sgt i32 %argc.addr.5838, 2
  br i1 %cmp325, label %while.body327, label %while.end348, !llvm.loop !24

while.end348:                                     ; preds = %if.end345, %if.end312
  call void @TreeCCNodeValidate(ptr noundef %call305) #10
  call void @TreeCCOperationValidate(ptr noundef %call305) #10
  %errors349 = getelementptr inbounds %struct.TreeCCInput, ptr %input, i64 0, i32 7
  %36 = load i32, ptr %errors349, align 8, !tbaa !21
  %tobool350.not = icmp eq i32 %36, 0
  br i1 %tobool350.not, label %if.end352, label %if.then351

if.then351:                                       ; preds = %while.end348
  call void @TreeCCContextDestroy(ptr noundef %call305) #10
  br label %cleanup

if.end352:                                        ; preds = %while.end348
  %tobool353.not = icmp eq i32 %generateOutput.0824, 0
  br i1 %tobool353.not, label %if.end364, label %if.then354

if.then354:                                       ; preds = %if.end352
  call void @TreeCCGenerate(ptr noundef %call305) #10
  %streamList = getelementptr inbounds %struct._tagTreeCCContext, ptr %call305, i64 0, i32 3
  %stream.0840 = load ptr, ptr %streamList, align 8, !tbaa !5
  %cmp356.not841 = icmp eq ptr %stream.0840, null
  br i1 %cmp356.not841, label %if.end364, label %while.body358

while.body358:                                    ; preds = %if.then354, %while.body358
  %stream.0843 = phi ptr [ %stream.0, %while.body358 ], [ %stream.0840, %if.then354 ]
  %result.0842 = phi i32 [ %spec.select536, %while.body358 ], [ 0, %if.then354 ]
  %call359 = call i32 @TreeCCStreamFlush(ptr noundef nonnull %stream.0843) #10
  %tobool360.not = icmp eq i32 %call359, 0
  %spec.select536 = select i1 %tobool360.not, i32 1, i32 %result.0842
  %nextStream = getelementptr inbounds %struct._tagTreeCCStream, ptr %stream.0843, i64 0, i32 10
...
cleanup:                                          ; preds = %if.then15.i, %if.end364, %if.then351, %if.then242, %sw.default, %sw.bb234, %if.then222, %if.then204, %if.then190, %if.then175, %if.then160, %if.then145, %if.else120, %if.then119, %if.then114, %if.then96, %if.then84, %if.then73, %if.then61, %if.then49, %if.then37
  ...
  call void @llvm.lifetime.end.p0(i64 1096, ptr nonnull %input) #10
  ret i32 %retval.0
}
...
entry:
  ...
  %1 = tail call i64 @fwrite(ptr nonnull @.str.16, i64 38, i64 1, ptr %0) #13
  %2 = load ptr, ptr @stderr, align 8, !tbaa !5
  %3 = tail call i64 @fwrite(ptr nonnull @.str.17, i64 59, i64 1, ptr %2) #13
  %4 = load ptr, ptr @stderr, align 8, !tbaa !5
  %fputc = tail call i32 @fputc(i32 10, ptr %4)
  %5 = load ptr, ptr @stderr, align 8, !tbaa !5
  %call3 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %5, ptr noundef nonnull @.str.19, ptr noundef %progname) #13
  %6 = load ptr, ptr @stderr, align 8, !tbaa !5
  %fputc21 = tail call i32 @fputc(i32 10, ptr %6)
  %7 = load ptr, ptr @stderr, align 8, !tbaa !5
  %8 = tail call i64 @fwrite(ptr nonnull @.str.20, i64 27, i64 1, ptr %7) #13
  %9 = load ptr, ptr @stderr, align 8, !tbaa !5
  %10 = tail call i64 @fwrite(ptr nonnull @.str.21, i64 41, i64 1, ptr %9) #13
  %11 = load ptr, ptr @stderr, align 8, !tbaa !5
  %12 = tail call i64 @fwrite(ptr nonnull @.str.22, i64 27, i64 1, ptr %11) #13
  %13 = load ptr, ptr @stderr, align 8, !tbaa !5
  %14 = tail call i64 @fwrite(ptr nonnull @.str.23, i64 48, i64 1, ptr %13) #13
  %15 = load ptr, ptr @stderr, align 8, !tbaa !5
  %16 = tail call i64 @fwrite(ptr nonnull @.str.24, i64 31, i64 1, ptr %15) #13
  %17 = load ptr, ptr @stderr, align 8, !tbaa !5
  %18 = tail call i64 @fwrite(ptr nonnull @.str.25, i64 51, i64 1, ptr %17) #13
  %19 = load ptr, ptr @stderr, align 8, !tbaa !5
  %20 = tail call i64 @fwrite(ptr nonnull @.str.26, i64 29, i64 1, ptr %19) #13
  %21 = load ptr, ptr @stderr, align 8, !tbaa !5
  %22 = tail call i64 @fwrite(ptr nonnull @.str.27, i64 57, i64 1, ptr %21) #13
  %23 = load ptr, ptr @stderr, align 8, !tbaa !5
  %24 = tail call i64 @fwrite(ptr nonnull @.str.28, i64 28, i64 1, ptr %23) #13
  %25 = load ptr, ptr @stderr, align 8, !tbaa !5
  %26 = tail call i64 @fwrite(ptr nonnull @.str.29, i64 54, i64 1, ptr %25) #13
  %27 = load ptr, ptr @stderr, align 8, !tbaa !5
  %28 = tail call i64 @fwrite(ptr nonnull @.str.30, i64 26, i64 1, ptr %27) #13
  %29 = load ptr, ptr @stderr, align 8, !tbaa !5
  %30 = tail call i64 @fwrite(ptr nonnull @.str.31, i64 42, i64 1, ptr %29) #13
  %31 = load ptr, ptr @stderr, align 8, !tbaa !5
  %32 = tail call i64 @fwrite(ptr nonnull @.str.32, i64 11, i64 1, ptr %31) #13
  %33 = load ptr, ptr @stderr, align 8, !tbaa !5
  %34 = tail call i64 @fwrite(ptr nonnull @.str.33, i64 33, i64 1, ptr %33) #13
  %35 = load ptr, ptr @stderr, align 8, !tbaa !5
  %36 = tail call i64 @fwrite(ptr nonnull @.str.34, i64 23, i64 1, ptr %35) #13
  %37 = load ptr, ptr @stderr, align 8, !tbaa !5
  %38 = tail call i64 @fwrite(ptr nonnull @.str.35, i64 35, i64 1, ptr %37) #13
  ret void
}
...
entry:
  %call = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %filename, ptr noundef nonnull dereferenceable(2) @.str.13) #12
  %tobool.not = icmp eq i32 %call, 0
  %spec.store.select = select i1 %tobool.not, ptr @.str.41, ptr %filename
  %call1 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %spec.store.select) #12
  %conv = trunc i64 %call1 to i32
  %cmp88 = icmp sgt i32 %conv, 0
  br i1 %cmp88, label %land.lhs.true.preheader, label %if.else
...
land.lhs.true:                                    ; preds = %land.lhs.true.preheader, %while.body
  ...
  %arrayidx = getelementptr inbounds i8, ptr %spec.store.select, i64 %idxprom
...
while.body:                                       ; preds = %land.lhs.true
  ...
  br i1 %cmp, label %land.lhs.true, label %if.else, !llvm.loop !26

if.then28:                                        ; preds = %land.lhs.true
  %conv29 = and i64 %indvars.iv, 4294967295
  %call30 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %extension) #12
  %add = add nuw nsw i64 %conv29, 1
  %add31 = add i64 %add, %call30
  %call32 = tail call noalias ptr @malloc(i64 noundef %add31) #11
...
if.end35:                                         ; preds = %if.then34, %if.then28
  %call37 = tail call ptr @strncpy(ptr noundef %call32, ptr noundef nonnull %spec.store.select, i64 noundef %conv29) #10
  %add.ptr = getelementptr inbounds i8, ptr %call32, i64 %conv29
  br label %if.end56

if.else:                                          ; preds = %while.body, %land.lhs.true, %land.lhs.true, %entry
  %sext = shl i64 %call1, 32
  %conv41 = ashr exact i64 %sext, 32
  %call42 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %extension) #12
  %add43 = add nsw i64 %conv41, 2
  %add44 = add i64 %add43, %call42
  %call45 = tail call noalias ptr @malloc(i64 noundef %add44) #11
...
if.end48:                                         ; preds = %if.then47, %if.else
  %call49 = tail call ptr @strcpy(ptr noundef nonnull dereferenceable(1) %call45, ptr noundef nonnull dereferenceable(1) %spec.store.select) #10
...
if.end56:                                         ; preds = %if.end48, %if.end35
  ...
  %call55 = tail call ptr @strcpy(ptr noundef nonnull dereferenceable(1) %add.ptr54.sink, ptr noundef nonnull dereferenceable(1) %extension) #10
  ret ptr %name.0
}
