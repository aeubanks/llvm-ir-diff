...
"for k.s0.n1.preheader":                          ; preds = %"assert succeeded77"
  ...
  %inv_fft1_S1_R8_n1.121.sroa.0.0.vec.extract = shufflevector <32 x float> %interleaved.vec290, <32 x float> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %inv_fft1_S1_R8_n1.121.sroa.21.128.vec.extract = shufflevector <32 x float> %interleaved.vec290.1, <32 x float> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  ...
  %inv_fft1_S1_R8_n1.121.sroa.0.64.vec.extract = shufflevector <32 x float> %interleaved.vec290, <32 x float> poison, <8 x i32> <i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23>
  %inv_fft1_S1_R8_n1.121.sroa.21.192.vec.extract = shufflevector <32 x float> %interleaved.vec290.1, <32 x float> poison, <8 x i32> <i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23>
  ...
  %inv_fft1_S1_R8_n1.121.sroa.0.32.vec.extract = shufflevector <32 x float> %interleaved.vec290, <32 x float> poison, <8 x i32> <i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %inv_fft1_S1_R8_n1.121.sroa.21.160.vec.extract = shufflevector <32 x float> %interleaved.vec290.1, <32 x float> poison, <8 x i32> <i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  ...
  %inv_fft1_S1_R8_n1.121.sroa.0.96.vec.extract = shufflevector <32 x float> %interleaved.vec290, <32 x float> poison, <8 x i32> <i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31>
  %inv_fft1_S1_R8_n1.121.sroa.21.224.vec.extract = shufflevector <32 x float> %interleaved.vec290.1, <32 x float> poison, <8 x i32> <i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31>
...
"for result.s0.i.preheader":                      ; preds = %"for k.s0.n1.preheader"
  ...
  %562 = getelementptr inbounds float, ptr %inv_fft1_S1_R8_n1.022, i64 1
  %563 = getelementptr inbounds float, ptr %inv_fft1_S1_R8_n1.022, i64 2
  %564 = getelementptr inbounds float, ptr %inv_fft1_S1_R8_n1.022, i64 4
  %565 = getelementptr inbounds float, ptr %inv_fft1_S1_R8_n1.022, i64 5
  %566 = getelementptr inbounds float, ptr %inv_fft1_S1_R8_n1.022, i64 6
  %567 = getelementptr inbounds float, ptr %inv_fft1_S1_R8_n1.022, i64 7
  %reass.add49.1 = sub nsw i64 1, %534
  %reass.mul50.1 = mul nsw i64 %reass.add49.1, %221
  %568 = getelementptr inbounds float, ptr %inv_fft1_S1_R8_n1.022, i64 9
  %569 = getelementptr inbounds float, ptr %inv_fft1_S1_R8_n1.022, i64 10
  %570 = getelementptr inbounds float, ptr %inv_fft1_S1_R8_n1.022, i64 12
  %571 = getelementptr inbounds float, ptr %inv_fft1_S1_R8_n1.022, i64 13
  %572 = getelementptr inbounds float, ptr %inv_fft1_S1_R8_n1.022, i64 14
  %573 = getelementptr inbounds float, ptr %inv_fft1_S1_R8_n1.022, i64 15
  %reass.add49.2 = sub nsw i64 2, %534
  %reass.mul50.2 = mul nsw i64 %reass.add49.2, %221
  %574 = getelementptr inbounds float, ptr %inv_fft1_S1_R8_n1.022, i64 17
  %575 = getelementptr inbounds float, ptr %inv_fft1_S1_R8_n1.022, i64 18
  %576 = getelementptr inbounds float, ptr %inv_fft1_S1_R8_n1.022, i64 20
  %577 = getelementptr inbounds float, ptr %inv_fft1_S1_R8_n1.022, i64 21
  %578 = getelementptr inbounds float, ptr %inv_fft1_S1_R8_n1.022, i64 22
  %579 = getelementptr inbounds float, ptr %inv_fft1_S1_R8_n1.022, i64 23
  %reass.add49.3 = sub nsw i64 3, %534
  %reass.mul50.3 = mul nsw i64 %reass.add49.3, %221
  %580 = getelementptr inbounds float, ptr %inv_fft1_S1_R8_n1.022, i64 25
  %581 = getelementptr inbounds float, ptr %inv_fft1_S1_R8_n1.022, i64 26
  %582 = getelementptr inbounds float, ptr %inv_fft1_S1_R8_n1.022, i64 28
  %583 = getelementptr inbounds float, ptr %inv_fft1_S1_R8_n1.022, i64 29
  %584 = getelementptr inbounds float, ptr %inv_fft1_S1_R8_n1.022, i64 30
  %585 = getelementptr inbounds float, ptr %inv_fft1_S1_R8_n1.022, i64 31
  %invariant.gep = getelementptr float, ptr %inv_fft0_S1_R8_n0.016, i64 -7
  %invariant.gep365 = getelementptr float, ptr %inv_fft0_S1_R8_n0.115, i64 -7
...
"for result.s0.i":                                ; preds = %"for result.s0.i.preheader", %"end for result.s0.n1"
  %indvars.iv209 = phi i64 [ %556, %"for result.s0.i.preheader" ], [ %indvars.iv.next210, %"end for result.s0.n1" ]
  ...
  %inv_fft1_S1_R8_n1.121.sroa.0.64.vecblend354 = shufflevector <4 x float> %764, <4 x float> poison, <32 x i32> <i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  ...
  %inv_fft1_S1_R8_n1.121.sroa.0.112.vecblend = shufflevector <32 x float> %inv_fft1_S1_R8_n1.121.sroa.0.96.vecblend360, <32 x float> %inv_fft1_S1_R8_n1.121.sroa.0.112.vec.expand, <32 x i32> <i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 24, i32 25, i32 26, i32 27, i32 60, i32 61, i32 62, i32 63>
  store float %815, ptr %585, align 4, !tbaa !32
  %inv_fft1_S1_R8_n1.121.sroa.0.0.vec.extract338 = shufflevector <32 x float> %inv_fft1_S1_R8_n1.121.sroa.0.0.vec.expand341, <32 x float> %inv_fft1_S1_R8_n1.121.sroa.0.16.vec.expand, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 36, i32 37, i32 38, i32 39>
  %824 = load <8 x float>, ptr %inv_fft1_S1_R8_n1.022, align 32, !tbaa !34
  %inv_fft1_S1_R8_n1.121.sroa.0.64.vec.extract350 = shufflevector <32 x float> %inv_fft1_S1_R8_n1.121.sroa.0.80.vecblend, <32 x float> poison, <8 x i32> <i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23>
  %825 = load <8 x float>, ptr %422, align 32, !tbaa !47
  %826 = fadd <8 x float> %inv_fft1_S1_R8_n1.121.sroa.0.0.vec.extract338, %inv_fft1_S1_R8_n1.121.sroa.0.64.vec.extract350
  store <8 x float> %826, ptr %431, align 32, !tbaa !53
  %827 = fadd <8 x float> %824, %825
  store <8 x float> %827, ptr %433, align 32, !tbaa !63
  %828 = fsub <8 x float> %inv_fft1_S1_R8_n1.121.sroa.0.0.vec.extract338, %inv_fft1_S1_R8_n1.121.sroa.0.64.vec.extract350
  store <8 x float> %828, ptr %435, align 32, !tbaa !73
  %829 = fsub <8 x float> %824, %825
  store <8 x float> %829, ptr %437, align 32, !tbaa !76
  %830 = fsub <8 x float> zeroinitializer, %inv_fft1_S1_R8_n1.121.sroa.0.64.vec.extract350
  %831 = fadd <8 x float> %inv_fft1_S1_R8_n1.121.sroa.0.0.vec.extract338, %825
  store <8 x float> %831, ptr %447, align 32, !tbaa !79
  %832 = fadd <8 x float> %824, %830
  store <8 x float> %832, ptr %449, align 32, !tbaa !81
  %833 = fsub <8 x float> %inv_fft1_S1_R8_n1.121.sroa.0.0.vec.extract338, %825
  store <8 x float> %833, ptr %451, align 32, !tbaa !83
  %834 = fsub <8 x float> %824, %830
  store <8 x float> %834, ptr %453, align 32, !tbaa !85
  %inv_fft1_S1_R8_n1.121.sroa.0.32.vec.extract344 = shufflevector <32 x float> %inv_fft1_S1_R8_n1.121.sroa.0.48.vecblend, <32 x float> poison, <8 x i32> <i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %835 = load <8 x float>, ptr %454, align 32, !tbaa !87
  %inv_fft1_S1_R8_n1.121.sroa.0.96.vec.extract356 = shufflevector <32 x float> %inv_fft1_S1_R8_n1.121.sroa.0.112.vecblend, <32 x float> poison, <8 x i32> <i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31>
  %836 = load <8 x float>, ptr %462, align 32, !tbaa !91
  %837 = fadd <8 x float> %inv_fft1_S1_R8_n1.121.sroa.0.32.vec.extract344, %inv_fft1_S1_R8_n1.121.sroa.0.96.vec.extract356
  ...
  %840 = fsub <8 x float> %inv_fft1_S1_R8_n1.121.sroa.0.96.vec.extract356, %inv_fft1_S1_R8_n1.121.sroa.0.32.vec.extract344
  store <8 x float> %840, ptr %477, align 32, !tbaa !106
  %841 = fsub <8 x float> zeroinitializer, %inv_fft1_S1_R8_n1.121.sroa.0.96.vec.extract356
  %842 = fadd <8 x float> %inv_fft1_S1_R8_n1.121.sroa.0.32.vec.extract344, %836
  ...
  %848 = fsub <8 x float> %836, %inv_fft1_S1_R8_n1.121.sroa.0.32.vec.extract344
  ...
  store <8 x float> %851, ptr %inv_fft0_S1_R8_n0.016, align 32, !tbaa !113
  ...
  store <8 x float> %854, ptr %inv_fft0_S1_R8_n0.115, align 32, !tbaa !115
  ...
  store <8 x float> %855, ptr %fwd_fft1_S1_R8_n1.020, align 32, !tbaa !221
  store <8 x float> %856, ptr %fwd_fft1_S1_R8_n1.119, align 32, !tbaa !230
...
vector.body296:                                   ; preds = %"assert succeeded83", %vector.body296
  ...
  %875 = getelementptr inbounds float, ptr %fwd_fft1_S1_R8_n1.020, i64 %874
  ...
  %876 = getelementptr inbounds float, ptr %kernel_fft1_S1_R8_n1.024, i64 %874
  ...
  %878 = getelementptr inbounds float, ptr %fwd_fft1_S1_R8_n1.119, i64 %874
  ...
  %879 = getelementptr inbounds float, ptr %kernel_fft1_S1_R8_n1.123, i64 %874
  ...
  br i1 %1001, label %"produce inv_X8$1", label %vector.body296, !llvm.loop !279
...
"produce inv_X8$1":                               ; preds = %vector.body296
  %1003 = load <8 x float>, ptr %inv_fft0_S1_R8_n0.016, align 32, !tbaa !113
  ...
  store <8 x float> %1043, ptr %inv_fft1_S1_R8_n1.022, align 32, !tbaa !34
...
"for result.s0.n1":                               ; preds = %"for result.s0.n1.preheader", %"end for result.s0.n0.n091"
  %indvars.iv206 = phi i64 [ %555, %"for result.s0.n1.preheader" ], [ %indvars.iv.next207, %"end for result.s0.n0.n091" ]
...
"for result.s0.n0.n0":                            ; preds = %"for result.s0.n0.n0.preheader", %"for result.s0.n0.n0"
  ...
  %1059 = getelementptr inbounds float, ptr %inv_fft1_S1_R8_n1.022, i64 %1058
  ...
  %1067 = getelementptr inbounds float, ptr %inv_fft1_S1_R8_n1.022, i64 %1066
...
"for result.s0.n0.n0.epil":                       ; preds = %"end for result.s0.n0.n0.loopexit.unr-lcssa"
  ...
  %1075 = getelementptr inbounds float, ptr %inv_fft1_S1_R8_n1.022, i64 %1074
...
"for result.s0.n0.n090.preheader":                ; preds = %"end for result.s0.n0.n0"
  ...
  %1082 = getelementptr inbounds float, ptr %inv_fft1_S1_R8_n1.022, i64 %1081
