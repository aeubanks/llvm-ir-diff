; ModuleID = '/usr/local/google/home/aeubanks/repos/test-suite/Bitcode/Regression/fft/modules/FftConvolve8x8xCZHalide_x86_64_linux_avx_avx2_c_plus_plus_name_mangling_fma_no_runtime_sse41.bc'
...
@str.15 = private constant [93 x i8] c"FftConvolve8x8xCZHalide_x86_64_linux_avx_avx2_c_plus_plus_name_mangling_fma_no_runtime_sse41\00", align 32
@_Z101FftConvolve8x8xCZHalide_x86_64_linux_avx_avx2_c_plus_plus_name_mangling_fma_no_runtime_sse41_metadatav_storage = private constant %struct.halide_filter_metadata_t { i32 0, i32 3, ptr @0, ptr @str.14, ptr @str.15 }
...
define i32 @_Z92FftConvolve8x8xCZHalide_x86_64_linux_avx_avx2_c_plus_plus_name_mangling_fma_no_runtime_sse41P15halide_buffer_tS0_S0_(ptr noalias %input.buffer, ptr noalias %kernel.buffer, ptr noalias %result.buffer) local_unnamed_addr #1 {
entry:
  %inv_fft0_S1_R8_n0.16 = alloca [128 x float], align 32
  %inv_fft0_S1_R8_n0.07 = alloca [128 x float], align 32
  %fwd_fft1_S1_R8_n1.110 = alloca [64 x float], align 32
  %fwd_fft1_S1_R8_n1.011 = alloca [64 x float], align 32
  %inv_fft1_S1_R8_n1.013 = alloca [64 x float], align 32
  %kernel_fft1_S1_R8_n1.114 = alloca [64 x float], align 32
  %kernel_fft1_S1_R8_n1.015 = alloca [64 x float], align 32
...
"assert succeeded2":                              ; preds = %"assert succeeded"
  %.not17 = icmp eq ptr %input.buffer, null
  br i1 %.not17, label %"assert failed3", label %"assert succeeded4", !prof !5
...
after_bb:                                         ; preds = %"assert succeeded4", %_halide_buffer_is_bounds_query.exit, %true_bb
  ...
  br i1 %95, label %_halide_buffer_is_bounds_query.exit28, label %after_bb7

_halide_buffer_is_bounds_query.exit28:            ; preds = %after_bb
  %96 = load i64, ptr %kernel.buffer, align 8, !tbaa !23
  %97 = icmp eq i64 %96, 0
  br i1 %97, label %true_bb5, label %after_bb7

true_bb5:                                         ; preds = %_halide_buffer_is_bounds_query.exit28
...
after_bb7:                                        ; preds = %after_bb, %_halide_buffer_is_bounds_query.exit28, %true_bb5
  %103 = load ptr, ptr %52, align 8, !tbaa !6
  %104 = icmp eq ptr %103, null
  br i1 %104, label %_halide_buffer_is_bounds_query.exit31, label %after_bb10

_halide_buffer_is_bounds_query.exit31:            ; preds = %after_bb7
  %105 = load i64, ptr %result.buffer, align 8, !tbaa !23
  %106 = icmp eq i64 %105, 0
  br i1 %106, label %true_bb8, label %after_bb10

true_bb8:                                         ; preds = %_halide_buffer_is_bounds_query.exit31
  ...
  %.sroa.2360.0..sroa_idx = getelementptr inbounds i8, ptr %107, i64 4
  store i32 %108, ptr %.sroa.2360.0..sroa_idx, align 4
  %.sroa.3361.0..sroa_idx = getelementptr inbounds i8, ptr %107, i64 8
  store i32 1, ptr %.sroa.3361.0..sroa_idx, align 4
  %.sroa.4362.0..sroa_idx = getelementptr inbounds i8, ptr %107, i64 12
  store i32 0, ptr %.sroa.4362.0..sroa_idx, align 4
  ...
  %.sroa.7364.16..sroa_idx = getelementptr inbounds %struct.halide_dimension_t, ptr %111, i64 1, i32 1
  store i32 %70, ptr %.sroa.7364.16..sroa_idx, align 4
  %.sroa.8365.16..sroa_idx = getelementptr inbounds %struct.halide_dimension_t, ptr %111, i64 1, i32 2
  store i32 %108, ptr %.sroa.8365.16..sroa_idx, align 4
  %.sroa.9366.16..sroa_idx = getelementptr inbounds %struct.halide_dimension_t, ptr %111, i64 1, i32 3
  store i32 0, ptr %.sroa.9366.16..sroa_idx, align 4
  ...
  %.sroa.12368.32..sroa_idx = getelementptr inbounds %struct.halide_dimension_t, ptr %113, i64 2, i32 1
  store i32 %76, ptr %.sroa.12368.32..sroa_idx, align 4
  %.sroa.13369.32..sroa_idx = getelementptr inbounds %struct.halide_dimension_t, ptr %113, i64 2, i32 2
  store i32 %109, ptr %.sroa.13369.32..sroa_idx, align 4
  %.sroa.14370.32..sroa_idx = getelementptr inbounds %struct.halide_dimension_t, ptr %113, i64 2, i32 3
  store i32 0, ptr %.sroa.14370.32..sroa_idx, align 4
  %115 = getelementptr inbounds %struct.halide_buffer_t, ptr %result.buffer, i64 0, i32 3
  store i64 0, ptr %115, align 8, !tbaa !25
  br label %after_bb10

after_bb10:                                       ; preds = %after_bb7, %_halide_buffer_is_bounds_query.exit31, %true_bb8
  %116 = load ptr, ptr %4, align 8, !tbaa !6
  %117 = icmp eq ptr %116, null
  br i1 %117, label %118, label %_halide_buffer_is_bounds_query.exit34

118:                                              ; preds = %after_bb10
  %119 = load i64, ptr %input.buffer, align 8, !tbaa !23
  %120 = icmp eq i64 %119, 0
  br label %_halide_buffer_is_bounds_query.exit34

_halide_buffer_is_bounds_query.exit34:            ; preds = %after_bb10, %118
  %121 = phi i1 [ false, %after_bb10 ], [ %120, %118 ]
  %122 = load ptr, ptr %31, align 8, !tbaa !6
  %123 = icmp eq ptr %122, null
  br i1 %123, label %124, label %_halide_buffer_is_bounds_query.exit35

124:                                              ; preds = %_halide_buffer_is_bounds_query.exit34
  %125 = load i64, ptr %kernel.buffer, align 8, !tbaa !23
  %126 = icmp eq i64 %125, 0
  br label %_halide_buffer_is_bounds_query.exit35

_halide_buffer_is_bounds_query.exit35:            ; preds = %_halide_buffer_is_bounds_query.exit34, %124
  %127 = phi i1 [ false, %_halide_buffer_is_bounds_query.exit34 ], [ %126, %124 ]
  %128 = or i1 %121, %127
  %129 = load ptr, ptr %52, align 8, !tbaa !6
  %130 = icmp eq ptr %129, null
  br i1 %130, label %131, label %_halide_buffer_is_bounds_query.exit36

131:                                              ; preds = %_halide_buffer_is_bounds_query.exit35
  %132 = load i64, ptr %result.buffer, align 8, !tbaa !23
  %133 = icmp eq i64 %132, 0
  br label %_halide_buffer_is_bounds_query.exit36

_halide_buffer_is_bounds_query.exit36:            ; preds = %_halide_buffer_is_bounds_query.exit35, %131
  %134 = phi i1 [ false, %_halide_buffer_is_bounds_query.exit35 ], [ %133, %131 ]
  %135 = or i1 %128, %134
  br i1 %135, label %destructor_block, label %true_bb11

true_bb11:                                        ; preds = %_halide_buffer_is_bounds_query.exit36
  %136 = icmp eq i8 %7, 2
  %137 = icmp eq i8 %9, 32
  %138 = and i1 %136, %137
...
"assert succeeded39":                             ; preds = %"assert succeeded37"
  ...
  %.not18 = icmp slt i32 %202, %62
  %203 = and i1 %201, %.not18
...
"for k.s0.n1.preheader":                          ; preds = %"assert succeeded77"
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 32 dereferenceable(256) %fwd_fft1_S1_R8_n1.110, i8 0, i64 256, i1 false), !tbaa !27
  %scevgep332 = getelementptr i8, ptr %32, i64 %259
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 32 dereferenceable(32) %fwd_fft1_S1_R8_n1.011, ptr noundef nonnull align 4 dereferenceable(32) %scevgep332, i64 32, i1 false)
  %scevgep331.1 = getelementptr inbounds i8, ptr %fwd_fft1_S1_R8_n1.011, i64 32
  %261 = add i64 %259, %260
  %scevgep332.1 = getelementptr i8, ptr %32, i64 %261
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 32 dereferenceable(32) %scevgep331.1, ptr noundef nonnull align 4 dereferenceable(32) %scevgep332.1, i64 32, i1 false)
  %scevgep331.2 = getelementptr inbounds i8, ptr %fwd_fft1_S1_R8_n1.011, i64 64
  %262 = shl nsw i64 %235, 3
  %263 = add i64 %259, %262
  %scevgep332.2 = getelementptr i8, ptr %32, i64 %263
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 32 dereferenceable(32) %scevgep331.2, ptr noundef nonnull align 4 dereferenceable(32) %scevgep332.2, i64 32, i1 false)
  %scevgep331.3 = getelementptr inbounds i8, ptr %fwd_fft1_S1_R8_n1.011, i64 96
  %264 = mul nsw i64 %235, 12
  %265 = add i64 %259, %264
  %scevgep332.3 = getelementptr i8, ptr %32, i64 %265
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 32 dereferenceable(32) %scevgep331.3, ptr noundef nonnull align 4 dereferenceable(32) %scevgep332.3, i64 32, i1 false)
  %scevgep331.4 = getelementptr inbounds i8, ptr %fwd_fft1_S1_R8_n1.011, i64 128
  %266 = shl nsw i64 %235, 4
  %267 = add i64 %259, %266
  %scevgep332.4 = getelementptr i8, ptr %32, i64 %267
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 32 dereferenceable(32) %scevgep331.4, ptr noundef nonnull align 4 dereferenceable(32) %scevgep332.4, i64 32, i1 false)
  %scevgep331.5 = getelementptr inbounds i8, ptr %fwd_fft1_S1_R8_n1.011, i64 160
  %268 = mul nsw i64 %235, 20
  %269 = add i64 %259, %268
  %scevgep332.5 = getelementptr i8, ptr %32, i64 %269
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 32 dereferenceable(32) %scevgep331.5, ptr noundef nonnull align 4 dereferenceable(32) %scevgep332.5, i64 32, i1 false)
  %scevgep331.6 = getelementptr inbounds i8, ptr %fwd_fft1_S1_R8_n1.011, i64 192
  %270 = mul nsw i64 %235, 24
  %271 = add i64 %259, %270
  %scevgep332.6 = getelementptr i8, ptr %32, i64 %271
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 32 dereferenceable(32) %scevgep331.6, ptr noundef nonnull align 4 dereferenceable(32) %scevgep332.6, i64 32, i1 false)
  %scevgep331.7 = getelementptr inbounds i8, ptr %fwd_fft1_S1_R8_n1.011, i64 224
  %272 = mul nsw i64 %235, 28
  %273 = add i64 %259, %272
  %scevgep332.7 = getelementptr i8, ptr %32, i64 %273
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 32 dereferenceable(32) %scevgep331.7, ptr noundef nonnull align 4 dereferenceable(32) %scevgep332.7, i64 32, i1 false)
  %wide.vec = load <32 x float>, ptr %fwd_fft1_S1_R8_n1.011, align 32, !tbaa !30
  %strided.vec = shufflevector <32 x float> %wide.vec, <32 x float> poison, <4 x i32> <i32 0, i32 8, i32 16, i32 24>
  %strided.vec371 = shufflevector <32 x float> %wide.vec, <32 x float> poison, <4 x i32> <i32 1, i32 9, i32 17, i32 25>
  %strided.vec372 = shufflevector <32 x float> %wide.vec, <32 x float> poison, <4 x i32> <i32 2, i32 10, i32 18, i32 26>
  %strided.vec373 = shufflevector <32 x float> %wide.vec, <32 x float> poison, <4 x i32> <i32 3, i32 11, i32 19, i32 27>
  %strided.vec374 = shufflevector <32 x float> %wide.vec, <32 x float> poison, <4 x i32> <i32 4, i32 12, i32 20, i32 28>
  %strided.vec375 = shufflevector <32 x float> %wide.vec, <32 x float> poison, <4 x i32> <i32 5, i32 13, i32 21, i32 29>
  %strided.vec376 = shufflevector <32 x float> %wide.vec, <32 x float> poison, <4 x i32> <i32 6, i32 14, i32 22, i32 30>
  %strided.vec377 = shufflevector <32 x float> %wide.vec, <32 x float> poison, <4 x i32> <i32 7, i32 15, i32 23, i32 31>
  %274 = fadd <4 x float> %strided.vec, %strided.vec374
  %wide.vec378 = load <32 x float>, ptr %fwd_fft1_S1_R8_n1.110, align 32, !tbaa !27
  %strided.vec379 = shufflevector <32 x float> %wide.vec378, <32 x float> poison, <4 x i32> <i32 0, i32 8, i32 16, i32 24>
  %strided.vec380 = shufflevector <32 x float> %wide.vec378, <32 x float> poison, <4 x i32> <i32 1, i32 9, i32 17, i32 25>
  %strided.vec381 = shufflevector <32 x float> %wide.vec378, <32 x float> poison, <4 x i32> <i32 2, i32 10, i32 18, i32 26>
  %strided.vec382 = shufflevector <32 x float> %wide.vec378, <32 x float> poison, <4 x i32> <i32 3, i32 11, i32 19, i32 27>
  %strided.vec383 = shufflevector <32 x float> %wide.vec378, <32 x float> poison, <4 x i32> <i32 4, i32 12, i32 20, i32 28>
  %strided.vec384 = shufflevector <32 x float> %wide.vec378, <32 x float> poison, <4 x i32> <i32 5, i32 13, i32 21, i32 29>
  %strided.vec385 = shufflevector <32 x float> %wide.vec378, <32 x float> poison, <4 x i32> <i32 6, i32 14, i32 22, i32 30>
  %strided.vec386 = shufflevector <32 x float> %wide.vec378, <32 x float> poison, <4 x i32> <i32 7, i32 15, i32 23, i32 31>
  %275 = fadd <4 x float> %strided.vec379, %strided.vec383
  %276 = fadd <4 x float> %strided.vec372, %strided.vec376
  %277 = fadd <4 x float> %strided.vec381, %strided.vec385
  %278 = fadd <4 x float> %274, %276
  %279 = fadd <4 x float> %275, %277
  %280 = fsub <4 x float> %274, %276
  %281 = fsub <4 x float> %275, %277
  %282 = fsub <4 x float> %strided.vec, %strided.vec374
  %283 = fsub <4 x float> %strided.vec379, %strided.vec383
  %284 = fsub <4 x float> %strided.vec381, %strided.vec385
  %285 = fsub <4 x float> %strided.vec376, %strided.vec372
  %286 = fadd <4 x float> %282, %284
  %287 = fadd <4 x float> %283, %285
  %288 = fsub <4 x float> %282, %284
  %289 = fsub <4 x float> %283, %285
  %290 = fadd <4 x float> %strided.vec371, %strided.vec375
  %291 = fadd <4 x float> %strided.vec380, %strided.vec384
  %292 = fadd <4 x float> %strided.vec373, %strided.vec377
  %293 = fadd <4 x float> %strided.vec382, %strided.vec386
  %294 = fadd <4 x float> %290, %292
  %295 = fadd <4 x float> %291, %293
  %296 = fsub <4 x float> %291, %293
  %297 = fsub <4 x float> %292, %290
  %298 = fsub <4 x float> %strided.vec371, %strided.vec375
  %299 = fsub <4 x float> %strided.vec380, %strided.vec384
  %300 = fsub <4 x float> %strided.vec382, %strided.vec386
  %301 = fsub <4 x float> %strided.vec377, %strided.vec373
  ...
  store <32 x float> %interleaved.vec, ptr %inv_fft1_S1_R8_n1.013, align 32, !tbaa !32
  ...
  %interleaved.vec387 = shufflevector <16 x float> %341, <16 x float> %342, <32 x i32> <i32 0, i32 4, i32 8, i32 12, i32 16, i32 20, i32 24, i32 28, i32 1, i32 5, i32 9, i32 13, i32 17, i32 21, i32 25, i32 29, i32 2, i32 6, i32 10, i32 14, i32 18, i32 22, i32 26, i32 30, i32 3, i32 7, i32 11, i32 15, i32 19, i32 23, i32 27, i32 31>
  %343 = getelementptr inbounds float, ptr %fwd_fft1_S1_R8_n1.011, i64 32
  ...
  %strided.vec371.1 = shufflevector <32 x float> %wide.vec.1, <32 x float> poison, <4 x i32> <i32 1, i32 9, i32 17, i32 25>
  %strided.vec372.1 = shufflevector <32 x float> %wide.vec.1, <32 x float> poison, <4 x i32> <i32 2, i32 10, i32 18, i32 26>
  %strided.vec373.1 = shufflevector <32 x float> %wide.vec.1, <32 x float> poison, <4 x i32> <i32 3, i32 11, i32 19, i32 27>
  %strided.vec374.1 = shufflevector <32 x float> %wide.vec.1, <32 x float> poison, <4 x i32> <i32 4, i32 12, i32 20, i32 28>
  %strided.vec375.1 = shufflevector <32 x float> %wide.vec.1, <32 x float> poison, <4 x i32> <i32 5, i32 13, i32 21, i32 29>
  %strided.vec376.1 = shufflevector <32 x float> %wide.vec.1, <32 x float> poison, <4 x i32> <i32 6, i32 14, i32 22, i32 30>
  %strided.vec377.1 = shufflevector <32 x float> %wide.vec.1, <32 x float> poison, <4 x i32> <i32 7, i32 15, i32 23, i32 31>
  %344 = fadd <4 x float> %strided.vec.1, %strided.vec374.1
  %345 = getelementptr inbounds float, ptr %fwd_fft1_S1_R8_n1.110, i64 32
  %wide.vec378.1 = load <32 x float>, ptr %345, align 32, !tbaa !27
  %strided.vec379.1 = shufflevector <32 x float> %wide.vec378.1, <32 x float> poison, <4 x i32> <i32 0, i32 8, i32 16, i32 24>
  %strided.vec380.1 = shufflevector <32 x float> %wide.vec378.1, <32 x float> poison, <4 x i32> <i32 1, i32 9, i32 17, i32 25>
  %strided.vec381.1 = shufflevector <32 x float> %wide.vec378.1, <32 x float> poison, <4 x i32> <i32 2, i32 10, i32 18, i32 26>
  %strided.vec382.1 = shufflevector <32 x float> %wide.vec378.1, <32 x float> poison, <4 x i32> <i32 3, i32 11, i32 19, i32 27>
  %strided.vec383.1 = shufflevector <32 x float> %wide.vec378.1, <32 x float> poison, <4 x i32> <i32 4, i32 12, i32 20, i32 28>
  %strided.vec384.1 = shufflevector <32 x float> %wide.vec378.1, <32 x float> poison, <4 x i32> <i32 5, i32 13, i32 21, i32 29>
  %strided.vec385.1 = shufflevector <32 x float> %wide.vec378.1, <32 x float> poison, <4 x i32> <i32 6, i32 14, i32 22, i32 30>
  %strided.vec386.1 = shufflevector <32 x float> %wide.vec378.1, <32 x float> poison, <4 x i32> <i32 7, i32 15, i32 23, i32 31>
  %346 = fadd <4 x float> %strided.vec379.1, %strided.vec383.1
  %347 = fadd <4 x float> %strided.vec372.1, %strided.vec376.1
  %348 = fadd <4 x float> %strided.vec381.1, %strided.vec385.1
  %349 = fadd <4 x float> %344, %347
  %350 = fadd <4 x float> %346, %348
  %351 = fsub <4 x float> %344, %347
  %352 = fsub <4 x float> %346, %348
  %353 = fsub <4 x float> %strided.vec.1, %strided.vec374.1
  %354 = fsub <4 x float> %strided.vec379.1, %strided.vec383.1
  %355 = fsub <4 x float> %strided.vec381.1, %strided.vec385.1
  %356 = fsub <4 x float> %strided.vec376.1, %strided.vec372.1
  %357 = fadd <4 x float> %353, %355
  %358 = fadd <4 x float> %354, %356
  %359 = fsub <4 x float> %353, %355
  %360 = fsub <4 x float> %354, %356
  %361 = fadd <4 x float> %strided.vec371.1, %strided.vec375.1
  %362 = fadd <4 x float> %strided.vec380.1, %strided.vec384.1
  %363 = fadd <4 x float> %strided.vec373.1, %strided.vec377.1
  %364 = fadd <4 x float> %strided.vec382.1, %strided.vec386.1
  %365 = fadd <4 x float> %361, %363
  %366 = fadd <4 x float> %362, %364
  %367 = fsub <4 x float> %362, %364
  %368 = fsub <4 x float> %363, %361
  %369 = fsub <4 x float> %strided.vec371.1, %strided.vec375.1
  %370 = fsub <4 x float> %strided.vec380.1, %strided.vec384.1
  %371 = fsub <4 x float> %strided.vec382.1, %strided.vec386.1
  %372 = fsub <4 x float> %strided.vec377.1, %strided.vec373.1
  ...
  %402 = getelementptr inbounds float, ptr %inv_fft1_S1_R8_n1.013, i64 32
  ...
  %interleaved.vec387.1 = shufflevector <16 x float> %413, <16 x float> %414, <32 x i32> <i32 0, i32 4, i32 8, i32 12, i32 16, i32 20, i32 24, i32 28, i32 1, i32 5, i32 9, i32 13, i32 17, i32 21, i32 25, i32 29, i32 2, i32 6, i32 10, i32 14, i32 18, i32 22, i32 26, i32 30, i32 3, i32 7, i32 11, i32 15, i32 19, i32 23, i32 27, i32 31>
  %415 = load <8 x float>, ptr %inv_fft1_S1_R8_n1.013, align 32, !tbaa !34
  %416 = getelementptr inbounds float, ptr %inv_fft1_S1_R8_n1.013, i64 32
  %417 = load <8 x float>, ptr %416, align 32, !tbaa !43
  %418 = fadd <8 x float> %415, %417
  %419 = getelementptr inbounds float, ptr %inv_fft0_S1_R8_n0.07, i64 64
  %inv_fft1_S1_R8_n1.112.sroa.0.0.vec.extract = shufflevector <32 x float> %interleaved.vec387, <32 x float> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %inv_fft1_S1_R8_n1.112.sroa.21.128.vec.extract = shufflevector <32 x float> %interleaved.vec387.1, <32 x float> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %420 = fadd <8 x float> %inv_fft1_S1_R8_n1.112.sroa.0.0.vec.extract, %inv_fft1_S1_R8_n1.112.sroa.21.128.vec.extract
  %421 = getelementptr inbounds float, ptr %inv_fft0_S1_R8_n0.16, i64 64
  %422 = getelementptr inbounds float, ptr %inv_fft1_S1_R8_n1.013, i64 16
  %423 = load <8 x float>, ptr %422, align 32, !tbaa !47
  %424 = getelementptr inbounds float, ptr %inv_fft1_S1_R8_n1.013, i64 48
  %425 = load <8 x float>, ptr %424, align 32, !tbaa !50
  %426 = fadd <8 x float> %423, %425
  %427 = getelementptr inbounds float, ptr %inv_fft0_S1_R8_n0.07, i64 80
  %inv_fft1_S1_R8_n1.112.sroa.0.64.vec.extract = shufflevector <32 x float> %interleaved.vec387, <32 x float> poison, <8 x i32> <i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23>
  %inv_fft1_S1_R8_n1.112.sroa.21.192.vec.extract = shufflevector <32 x float> %interleaved.vec387.1, <32 x float> poison, <8 x i32> <i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23>
  %428 = fadd <8 x float> %inv_fft1_S1_R8_n1.112.sroa.0.64.vec.extract, %inv_fft1_S1_R8_n1.112.sroa.21.192.vec.extract
  %429 = getelementptr inbounds float, ptr %inv_fft0_S1_R8_n0.16, i64 80
  %430 = fadd <8 x float> %418, %426
  %431 = getelementptr inbounds float, ptr %inv_fft0_S1_R8_n0.07, i64 56
  store <8 x float> %430, ptr %431, align 32, !tbaa !53
  %432 = fadd <8 x float> %420, %428
  %433 = getelementptr inbounds float, ptr %inv_fft0_S1_R8_n0.16, i64 56
  store <8 x float> %432, ptr %433, align 32, !tbaa !63
  %434 = fsub <8 x float> %418, %426
  %435 = getelementptr inbounds float, ptr %inv_fft0_S1_R8_n0.07, i64 40
  store <8 x float> %434, ptr %435, align 32, !tbaa !73
  %436 = fsub <8 x float> %420, %428
  %437 = getelementptr inbounds float, ptr %inv_fft0_S1_R8_n0.16, i64 40
  store <8 x float> %436, ptr %437, align 32, !tbaa !76
  %438 = fsub <8 x float> %415, %417
  %439 = getelementptr inbounds float, ptr %inv_fft0_S1_R8_n0.07, i64 72
  %440 = fsub <8 x float> %inv_fft1_S1_R8_n1.112.sroa.0.0.vec.extract, %inv_fft1_S1_R8_n1.112.sroa.21.128.vec.extract
  %441 = getelementptr inbounds float, ptr %inv_fft0_S1_R8_n0.16, i64 72
  %442 = fsub <8 x float> %inv_fft1_S1_R8_n1.112.sroa.0.64.vec.extract, %inv_fft1_S1_R8_n1.112.sroa.21.192.vec.extract
  %443 = getelementptr inbounds float, ptr %inv_fft0_S1_R8_n0.07, i64 88
  %444 = fsub <8 x float> %425, %423
  %445 = getelementptr inbounds float, ptr %inv_fft0_S1_R8_n0.16, i64 88
  %446 = fadd <8 x float> %438, %442
  %447 = getelementptr inbounds float, ptr %inv_fft0_S1_R8_n0.07, i64 48
  store <8 x float> %446, ptr %447, align 32, !tbaa !79
  %448 = fadd <8 x float> %440, %444
  %449 = getelementptr inbounds float, ptr %inv_fft0_S1_R8_n0.16, i64 48
  store <8 x float> %448, ptr %449, align 32, !tbaa !81
  %450 = fsub <8 x float> %438, %442
  %451 = getelementptr inbounds float, ptr %inv_fft0_S1_R8_n0.07, i64 32
  store <8 x float> %450, ptr %451, align 32, !tbaa !83
  %452 = fsub <8 x float> %440, %444
  %453 = getelementptr inbounds float, ptr %inv_fft0_S1_R8_n0.16, i64 32
  store <8 x float> %452, ptr %453, align 32, !tbaa !85
  %454 = getelementptr inbounds float, ptr %inv_fft1_S1_R8_n1.013, i64 8
  %455 = load <8 x float>, ptr %454, align 32, !tbaa !87
  %456 = getelementptr inbounds float, ptr %inv_fft1_S1_R8_n1.013, i64 40
  %457 = load <8 x float>, ptr %456, align 32, !tbaa !89
  %458 = fadd <8 x float> %455, %457
  %459 = getelementptr inbounds float, ptr %inv_fft0_S1_R8_n0.07, i64 96
  %inv_fft1_S1_R8_n1.112.sroa.0.32.vec.extract = shufflevector <32 x float> %interleaved.vec387, <32 x float> poison, <8 x i32> <i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %inv_fft1_S1_R8_n1.112.sroa.21.160.vec.extract = shufflevector <32 x float> %interleaved.vec387.1, <32 x float> poison, <8 x i32> <i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %460 = fadd <8 x float> %inv_fft1_S1_R8_n1.112.sroa.0.32.vec.extract, %inv_fft1_S1_R8_n1.112.sroa.21.160.vec.extract
  %461 = getelementptr inbounds float, ptr %inv_fft0_S1_R8_n0.16, i64 96
  %462 = getelementptr inbounds float, ptr %inv_fft1_S1_R8_n1.013, i64 24
  %463 = load <8 x float>, ptr %462, align 32, !tbaa !91
  %464 = getelementptr inbounds float, ptr %inv_fft1_S1_R8_n1.013, i64 56
  %465 = load <8 x float>, ptr %464, align 32, !tbaa !93
  %466 = fadd <8 x float> %463, %465
  %467 = getelementptr inbounds float, ptr %inv_fft0_S1_R8_n0.07, i64 112
  %inv_fft1_S1_R8_n1.112.sroa.0.96.vec.extract = shufflevector <32 x float> %interleaved.vec387, <32 x float> poison, <8 x i32> <i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31>
  %inv_fft1_S1_R8_n1.112.sroa.21.224.vec.extract = shufflevector <32 x float> %interleaved.vec387.1, <32 x float> poison, <8 x i32> <i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31>
  %468 = fadd <8 x float> %inv_fft1_S1_R8_n1.112.sroa.0.96.vec.extract, %inv_fft1_S1_R8_n1.112.sroa.21.224.vec.extract
  %469 = getelementptr inbounds float, ptr %inv_fft0_S1_R8_n0.16, i64 112
  %470 = fadd <8 x float> %458, %466
  %471 = getelementptr inbounds float, ptr %inv_fft0_S1_R8_n0.07, i64 24
  store <8 x float> %470, ptr %471, align 32, !tbaa !95
  %472 = fadd <8 x float> %460, %468
  %473 = getelementptr inbounds float, ptr %inv_fft0_S1_R8_n0.16, i64 24
  store <8 x float> %472, ptr %473, align 32, !tbaa !99
  %474 = fsub <8 x float> %460, %468
  %475 = getelementptr inbounds float, ptr %inv_fft0_S1_R8_n0.07, i64 8
  store <8 x float> %474, ptr %475, align 32, !tbaa !103
  %476 = fsub <8 x float> %466, %458
  %477 = getelementptr inbounds float, ptr %inv_fft0_S1_R8_n0.16, i64 8
  store <8 x float> %476, ptr %477, align 32, !tbaa !106
  %478 = fsub <8 x float> %455, %457
  %479 = getelementptr inbounds float, ptr %inv_fft0_S1_R8_n0.07, i64 104
  %480 = fsub <8 x float> %inv_fft1_S1_R8_n1.112.sroa.0.32.vec.extract, %inv_fft1_S1_R8_n1.112.sroa.21.160.vec.extract
  %481 = getelementptr inbounds float, ptr %inv_fft0_S1_R8_n0.16, i64 104
  %482 = fsub <8 x float> %inv_fft1_S1_R8_n1.112.sroa.0.96.vec.extract, %inv_fft1_S1_R8_n1.112.sroa.21.224.vec.extract
  %483 = getelementptr inbounds float, ptr %inv_fft0_S1_R8_n0.07, i64 120
  %484 = fsub <8 x float> %465, %463
  %485 = getelementptr inbounds float, ptr %inv_fft0_S1_R8_n0.16, i64 120
  ...
  %490 = getelementptr inbounds float, ptr %inv_fft0_S1_R8_n0.07, i64 16
  ...
  %493 = getelementptr inbounds float, ptr %inv_fft0_S1_R8_n0.16, i64 16
  ...
  store <8 x float> %497, ptr %inv_fft0_S1_R8_n0.07, align 32, !tbaa !113
  ...
  store <8 x float> %500, ptr %inv_fft0_S1_R8_n0.16, align 32, !tbaa !115
  ...
  store <8 x float> %501, ptr %kernel_fft1_S1_R8_n1.015, align 32, !tbaa !163
  store <8 x float> %502, ptr %kernel_fft1_S1_R8_n1.114, align 32, !tbaa !173
  %517 = getelementptr inbounds float, ptr %kernel_fft1_S1_R8_n1.015, i64 8
  store <8 x float> %503, ptr %517, align 32, !tbaa !183
  %518 = getelementptr inbounds float, ptr %kernel_fft1_S1_R8_n1.114, i64 8
  store <8 x float> %504, ptr %518, align 32, !tbaa !185
  %519 = getelementptr inbounds float, ptr %kernel_fft1_S1_R8_n1.015, i64 16
  store <8 x float> %505, ptr %519, align 32, !tbaa !187
  %520 = getelementptr inbounds float, ptr %kernel_fft1_S1_R8_n1.114, i64 16
  store <8 x float> %506, ptr %520, align 32, !tbaa !190
  %521 = getelementptr inbounds float, ptr %kernel_fft1_S1_R8_n1.015, i64 24
  store <8 x float> %507, ptr %521, align 32, !tbaa !193
  %522 = getelementptr inbounds float, ptr %kernel_fft1_S1_R8_n1.114, i64 24
  store <8 x float> %508, ptr %522, align 32, !tbaa !195
  %523 = getelementptr inbounds float, ptr %kernel_fft1_S1_R8_n1.015, i64 32
  store <8 x float> %509, ptr %523, align 32, !tbaa !197
  %524 = getelementptr inbounds float, ptr %kernel_fft1_S1_R8_n1.114, i64 32
  store <8 x float> %510, ptr %524, align 32, !tbaa !201
  %525 = getelementptr inbounds float, ptr %kernel_fft1_S1_R8_n1.015, i64 40
  store <8 x float> %511, ptr %525, align 32, !tbaa !205
  %526 = getelementptr inbounds float, ptr %kernel_fft1_S1_R8_n1.114, i64 40
  store <8 x float> %512, ptr %526, align 32, !tbaa !207
  %527 = getelementptr inbounds float, ptr %kernel_fft1_S1_R8_n1.015, i64 48
  store <8 x float> %513, ptr %527, align 32, !tbaa !209
  %528 = getelementptr inbounds float, ptr %kernel_fft1_S1_R8_n1.114, i64 48
  store <8 x float> %514, ptr %528, align 32, !tbaa !212
  %529 = getelementptr inbounds float, ptr %kernel_fft1_S1_R8_n1.015, i64 56
  store <8 x float> %515, ptr %529, align 32, !tbaa !215
  %530 = getelementptr inbounds float, ptr %kernel_fft1_S1_R8_n1.114, i64 56
  store <8 x float> %516, ptr %530, align 32, !tbaa !217
  %531 = icmp sgt i32 %76, 0
  br i1 %531, label %"for result.s0.i.preheader", label %destructor_block, !prof !26
...
"for result.s0.i.preheader":                      ; preds = %"for k.s0.n1.preheader"
  ...
  %536 = getelementptr inbounds float, ptr %fwd_fft1_S1_R8_n1.110, i64 8
  %537 = getelementptr inbounds float, ptr %fwd_fft1_S1_R8_n1.110, i64 16
  %538 = getelementptr inbounds float, ptr %fwd_fft1_S1_R8_n1.110, i64 24
  %539 = getelementptr inbounds float, ptr %fwd_fft1_S1_R8_n1.110, i64 32
  %540 = getelementptr inbounds float, ptr %fwd_fft1_S1_R8_n1.110, i64 40
  %541 = getelementptr inbounds float, ptr %fwd_fft1_S1_R8_n1.110, i64 48
  %542 = getelementptr inbounds float, ptr %fwd_fft1_S1_R8_n1.110, i64 56
  ...
  %560 = zext i32 %a11 to i64
  %561 = mul nsw i64 %534, %221
  %562 = getelementptr inbounds float, ptr %inv_fft1_S1_R8_n1.013, i64 1
  %563 = getelementptr inbounds float, ptr %inv_fft1_S1_R8_n1.013, i64 2
  %564 = getelementptr inbounds float, ptr %inv_fft1_S1_R8_n1.013, i64 4
  %565 = getelementptr inbounds float, ptr %inv_fft1_S1_R8_n1.013, i64 5
  %566 = getelementptr inbounds float, ptr %inv_fft1_S1_R8_n1.013, i64 6
  %567 = getelementptr inbounds float, ptr %inv_fft1_S1_R8_n1.013, i64 7
  %reass.add308.1 = sub nsw i64 1, %534
  %reass.mul309.1 = mul nsw i64 %reass.add308.1, %221
  %568 = getelementptr inbounds float, ptr %inv_fft1_S1_R8_n1.013, i64 9
  %569 = getelementptr inbounds float, ptr %inv_fft1_S1_R8_n1.013, i64 10
  %570 = getelementptr inbounds float, ptr %inv_fft1_S1_R8_n1.013, i64 12
  %571 = getelementptr inbounds float, ptr %inv_fft1_S1_R8_n1.013, i64 13
  %572 = getelementptr inbounds float, ptr %inv_fft1_S1_R8_n1.013, i64 14
  %573 = getelementptr inbounds float, ptr %inv_fft1_S1_R8_n1.013, i64 15
  %reass.add308.2 = sub nsw i64 2, %534
  %reass.mul309.2 = mul nsw i64 %reass.add308.2, %221
  %574 = getelementptr inbounds float, ptr %inv_fft1_S1_R8_n1.013, i64 17
  %575 = getelementptr inbounds float, ptr %inv_fft1_S1_R8_n1.013, i64 18
  %576 = getelementptr inbounds float, ptr %inv_fft1_S1_R8_n1.013, i64 20
  %577 = getelementptr inbounds float, ptr %inv_fft1_S1_R8_n1.013, i64 21
  %578 = getelementptr inbounds float, ptr %inv_fft1_S1_R8_n1.013, i64 22
  %579 = getelementptr inbounds float, ptr %inv_fft1_S1_R8_n1.013, i64 23
  %reass.add308.3 = sub nsw i64 3, %534
  %reass.mul309.3 = mul nsw i64 %reass.add308.3, %221
  %580 = getelementptr inbounds float, ptr %inv_fft1_S1_R8_n1.013, i64 25
  %581 = getelementptr inbounds float, ptr %inv_fft1_S1_R8_n1.013, i64 26
  %582 = getelementptr inbounds float, ptr %inv_fft1_S1_R8_n1.013, i64 28
  %583 = getelementptr inbounds float, ptr %inv_fft1_S1_R8_n1.013, i64 29
  %584 = getelementptr inbounds float, ptr %inv_fft1_S1_R8_n1.013, i64 30
  %585 = getelementptr inbounds float, ptr %inv_fft1_S1_R8_n1.013, i64 31
  %invariant.gep = getelementptr float, ptr %inv_fft0_S1_R8_n0.07, i64 -7
  %invariant.gep462 = getelementptr float, ptr %inv_fft0_S1_R8_n0.16, i64 -7
  %xtraiter = and i64 %560, 1
  %586 = icmp eq i32 %a11, 1
...
"for result.s0.i":                                ; preds = %"for result.s0.i.preheader", %"end for result.s0.n1"
  %indvars.iv348 = phi i64 [ %556, %"for result.s0.i.preheader" ], [ %indvars.iv.next349, %"end for result.s0.n1" ]
  %reass.add306 = sub nsw i64 %indvars.iv348, %535
  %reass.mul307 = mul i64 %reass.add306, %228
  %587 = sub i64 %reass.mul307, %533
  %588 = sub i64 %587, %561
  ...
  store float 0.000000e+00, ptr %inv_fft1_S1_R8_n1.013, align 32, !tbaa !32
  ...
  %inv_fft1_S1_R8_n1.112.sroa.0.96.vecblend457 = shufflevector <4 x float> %823, <4 x float> poison, <32 x i32> <i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison>
  %inv_fft1_S1_R8_n1.112.sroa.0.112.vec.expand = shufflevector <4 x float> %820, <4 x float> poison, <32 x i32> <i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 0, i32 1, i32 2, i32 3>
  %inv_fft1_S1_R8_n1.112.sroa.0.112.vecblend = shufflevector <32 x float> %inv_fft1_S1_R8_n1.112.sroa.0.96.vecblend457, <32 x float> %inv_fft1_S1_R8_n1.112.sroa.0.112.vec.expand, <32 x i32> <i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 24, i32 25, i32 26, i32 27, i32 60, i32 61, i32 62, i32 63>
  store float %815, ptr %585, align 4, !tbaa !32
  %inv_fft1_S1_R8_n1.112.sroa.0.0.vec.extract435 = shufflevector <32 x float> %inv_fft1_S1_R8_n1.112.sroa.0.0.vec.expand438, <32 x float> %inv_fft1_S1_R8_n1.112.sroa.0.16.vec.expand, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 36, i32 37, i32 38, i32 39>
  %824 = load <8 x float>, ptr %inv_fft1_S1_R8_n1.013, align 32, !tbaa !34
  %inv_fft1_S1_R8_n1.112.sroa.0.64.vec.extract447 = shufflevector <32 x float> %inv_fft1_S1_R8_n1.112.sroa.0.80.vecblend, <32 x float> poison, <8 x i32> <i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23>
  %825 = load <8 x float>, ptr %422, align 32, !tbaa !47
  %826 = fadd <8 x float> %inv_fft1_S1_R8_n1.112.sroa.0.0.vec.extract435, %inv_fft1_S1_R8_n1.112.sroa.0.64.vec.extract447
  store <8 x float> %826, ptr %431, align 32, !tbaa !53
  %827 = fadd <8 x float> %824, %825
  store <8 x float> %827, ptr %433, align 32, !tbaa !63
  %828 = fsub <8 x float> %inv_fft1_S1_R8_n1.112.sroa.0.0.vec.extract435, %inv_fft1_S1_R8_n1.112.sroa.0.64.vec.extract447
  store <8 x float> %828, ptr %435, align 32, !tbaa !73
  %829 = fsub <8 x float> %824, %825
  store <8 x float> %829, ptr %437, align 32, !tbaa !76
  %830 = fsub <8 x float> zeroinitializer, %inv_fft1_S1_R8_n1.112.sroa.0.64.vec.extract447
  %831 = fadd <8 x float> %inv_fft1_S1_R8_n1.112.sroa.0.0.vec.extract435, %825
  store <8 x float> %831, ptr %447, align 32, !tbaa !79
  %832 = fadd <8 x float> %824, %830
  store <8 x float> %832, ptr %449, align 32, !tbaa !81
  %833 = fsub <8 x float> %inv_fft1_S1_R8_n1.112.sroa.0.0.vec.extract435, %825
  store <8 x float> %833, ptr %451, align 32, !tbaa !83
  %834 = fsub <8 x float> %824, %830
  store <8 x float> %834, ptr %453, align 32, !tbaa !85
  %inv_fft1_S1_R8_n1.112.sroa.0.32.vec.extract441 = shufflevector <32 x float> %inv_fft1_S1_R8_n1.112.sroa.0.48.vecblend, <32 x float> poison, <8 x i32> <i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %835 = load <8 x float>, ptr %454, align 32, !tbaa !87
  %inv_fft1_S1_R8_n1.112.sroa.0.96.vec.extract453 = shufflevector <32 x float> %inv_fft1_S1_R8_n1.112.sroa.0.112.vecblend, <32 x float> poison, <8 x i32> <i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31>
  %836 = load <8 x float>, ptr %462, align 32, !tbaa !91
  %837 = fadd <8 x float> %inv_fft1_S1_R8_n1.112.sroa.0.32.vec.extract441, %inv_fft1_S1_R8_n1.112.sroa.0.96.vec.extract453
  ...
  %840 = fsub <8 x float> %inv_fft1_S1_R8_n1.112.sroa.0.96.vec.extract453, %inv_fft1_S1_R8_n1.112.sroa.0.32.vec.extract441
  store <8 x float> %840, ptr %477, align 32, !tbaa !106
  %841 = fsub <8 x float> zeroinitializer, %inv_fft1_S1_R8_n1.112.sroa.0.96.vec.extract453
  %842 = fadd <8 x float> %inv_fft1_S1_R8_n1.112.sroa.0.32.vec.extract441, %836
  ...
  %848 = fsub <8 x float> %836, %inv_fft1_S1_R8_n1.112.sroa.0.32.vec.extract441
  ...
  store <8 x float> %851, ptr %inv_fft0_S1_R8_n0.07, align 32, !tbaa !113
  ...
  store <8 x float> %854, ptr %inv_fft0_S1_R8_n0.16, align 32, !tbaa !115
  ...
  store <8 x float> %855, ptr %fwd_fft1_S1_R8_n1.011, align 32, !tbaa !221
  store <8 x float> %856, ptr %fwd_fft1_S1_R8_n1.110, align 32, !tbaa !230
  store <8 x float> %857, ptr %scevgep331.1, align 32, !tbaa !239
  store <8 x float> %858, ptr %536, align 32, !tbaa !241
  store <8 x float> %859, ptr %scevgep331.2, align 32, !tbaa !243
  store <8 x float> %860, ptr %537, align 32, !tbaa !246
  store <8 x float> %861, ptr %scevgep331.3, align 32, !tbaa !249
  store <8 x float> %862, ptr %538, align 32, !tbaa !251
  store <8 x float> %863, ptr %scevgep331.4, align 32, !tbaa !253
  store <8 x float> %864, ptr %539, align 32, !tbaa !257
  store <8 x float> %865, ptr %scevgep331.5, align 32, !tbaa !261
  store <8 x float> %866, ptr %540, align 32, !tbaa !263
  store <8 x float> %867, ptr %scevgep331.6, align 32, !tbaa !265
  store <8 x float> %868, ptr %541, align 32, !tbaa !268
  store <8 x float> %869, ptr %scevgep331.7, align 32, !tbaa !271
  store <8 x float> %870, ptr %542, align 32, !tbaa !273
  br i1 %545, label %"assert succeeded81", label %"assert failed80", !prof !26

"assert failed80":                                ; preds = %"for result.s0.i"
  %871 = tail call i32 @halide_error_explicit_bounds_too_small(ptr null, ptr nonnull @str.11, ptr nonnull @str.12, i32 0, i32 7, i32 %84, i32 %b1) #2
  br label %destructor_block

"assert succeeded81":                             ; preds = %"for result.s0.i"
  br i1 %547, label %"assert succeeded83", label %"assert failed82", !prof !26

"assert failed82":                                ; preds = %"assert succeeded81"
  %872 = tail call i32 @llvm.smin.i32(i32 %68, i32 0)
  %a4 = add nsw i32 %546, -1
  %873 = tail call i32 @halide_error_explicit_bounds_too_small(ptr null, ptr nonnull @str.13, ptr nonnull @str.12, i32 0, i32 7, i32 %872, i32 %a4) #2
  br label %destructor_block

"assert succeeded83":                             ; preds = %"assert succeeded81"
  br i1 %548, label %"assert failed84", label %vector.body393, !prof !5

vector.body393:                                   ; preds = %"assert succeeded83", %vector.body393
  %index394 = phi i64 [ %index.next433, %vector.body393 ], [ 0, %"assert succeeded83" ]
  %874 = shl nuw nsw i64 %index394, 3
  %875 = getelementptr inbounds float, ptr %fwd_fft1_S1_R8_n1.011, i64 %874
  %wide.vec395 = load <32 x float>, ptr %875, align 32, !tbaa !30
  %strided.vec396 = shufflevector <32 x float> %wide.vec395, <32 x float> poison, <4 x i32> <i32 0, i32 8, i32 16, i32 24>
  %strided.vec397 = shufflevector <32 x float> %wide.vec395, <32 x float> poison, <4 x i32> <i32 1, i32 9, i32 17, i32 25>
  %strided.vec398 = shufflevector <32 x float> %wide.vec395, <32 x float> poison, <4 x i32> <i32 2, i32 10, i32 18, i32 26>
  %strided.vec399 = shufflevector <32 x float> %wide.vec395, <32 x float> poison, <4 x i32> <i32 3, i32 11, i32 19, i32 27>
  %strided.vec400 = shufflevector <32 x float> %wide.vec395, <32 x float> poison, <4 x i32> <i32 4, i32 12, i32 20, i32 28>
  %strided.vec401 = shufflevector <32 x float> %wide.vec395, <32 x float> poison, <4 x i32> <i32 5, i32 13, i32 21, i32 29>
  %strided.vec402 = shufflevector <32 x float> %wide.vec395, <32 x float> poison, <4 x i32> <i32 6, i32 14, i32 22, i32 30>
  %strided.vec403 = shufflevector <32 x float> %wide.vec395, <32 x float> poison, <4 x i32> <i32 7, i32 15, i32 23, i32 31>
  %876 = getelementptr inbounds float, ptr %kernel_fft1_S1_R8_n1.015, i64 %874
  %wide.vec404 = load <32 x float>, ptr %876, align 32, !tbaa !275
  %strided.vec405 = shufflevector <32 x float> %wide.vec404, <32 x float> poison, <4 x i32> <i32 0, i32 8, i32 16, i32 24>
  %strided.vec406 = shufflevector <32 x float> %wide.vec404, <32 x float> poison, <4 x i32> <i32 1, i32 9, i32 17, i32 25>
  %strided.vec407 = shufflevector <32 x float> %wide.vec404, <32 x float> poison, <4 x i32> <i32 2, i32 10, i32 18, i32 26>
  %strided.vec408 = shufflevector <32 x float> %wide.vec404, <32 x float> poison, <4 x i32> <i32 3, i32 11, i32 19, i32 27>
  %strided.vec409 = shufflevector <32 x float> %wide.vec404, <32 x float> poison, <4 x i32> <i32 4, i32 12, i32 20, i32 28>
  %strided.vec410 = shufflevector <32 x float> %wide.vec404, <32 x float> poison, <4 x i32> <i32 5, i32 13, i32 21, i32 29>
  %strided.vec411 = shufflevector <32 x float> %wide.vec404, <32 x float> poison, <4 x i32> <i32 6, i32 14, i32 22, i32 30>
  %strided.vec412 = shufflevector <32 x float> %wide.vec404, <32 x float> poison, <4 x i32> <i32 7, i32 15, i32 23, i32 31>
  %877 = fmul <4 x float> %strided.vec396, %strided.vec405
  %878 = getelementptr inbounds float, ptr %fwd_fft1_S1_R8_n1.110, i64 %874
  %wide.vec413 = load <32 x float>, ptr %878, align 32, !tbaa !27
  %strided.vec414 = shufflevector <32 x float> %wide.vec413, <32 x float> poison, <4 x i32> <i32 0, i32 8, i32 16, i32 24>
  %strided.vec415 = shufflevector <32 x float> %wide.vec413, <32 x float> poison, <4 x i32> <i32 1, i32 9, i32 17, i32 25>
  %strided.vec416 = shufflevector <32 x float> %wide.vec413, <32 x float> poison, <4 x i32> <i32 2, i32 10, i32 18, i32 26>
  %strided.vec417 = shufflevector <32 x float> %wide.vec413, <32 x float> poison, <4 x i32> <i32 3, i32 11, i32 19, i32 27>
  %strided.vec418 = shufflevector <32 x float> %wide.vec413, <32 x float> poison, <4 x i32> <i32 4, i32 12, i32 20, i32 28>
  %strided.vec419 = shufflevector <32 x float> %wide.vec413, <32 x float> poison, <4 x i32> <i32 5, i32 13, i32 21, i32 29>
  %strided.vec420 = shufflevector <32 x float> %wide.vec413, <32 x float> poison, <4 x i32> <i32 6, i32 14, i32 22, i32 30>
  %strided.vec421 = shufflevector <32 x float> %wide.vec413, <32 x float> poison, <4 x i32> <i32 7, i32 15, i32 23, i32 31>
  %879 = getelementptr inbounds float, ptr %kernel_fft1_S1_R8_n1.114, i64 %874
  %wide.vec422 = load <32 x float>, ptr %879, align 32, !tbaa !276
  %strided.vec423 = shufflevector <32 x float> %wide.vec422, <32 x float> poison, <4 x i32> <i32 0, i32 8, i32 16, i32 24>
  %strided.vec424 = shufflevector <32 x float> %wide.vec422, <32 x float> poison, <4 x i32> <i32 1, i32 9, i32 17, i32 25>
  %strided.vec425 = shufflevector <32 x float> %wide.vec422, <32 x float> poison, <4 x i32> <i32 2, i32 10, i32 18, i32 26>
  %strided.vec426 = shufflevector <32 x float> %wide.vec422, <32 x float> poison, <4 x i32> <i32 3, i32 11, i32 19, i32 27>
  %strided.vec427 = shufflevector <32 x float> %wide.vec422, <32 x float> poison, <4 x i32> <i32 4, i32 12, i32 20, i32 28>
  %strided.vec428 = shufflevector <32 x float> %wide.vec422, <32 x float> poison, <4 x i32> <i32 5, i32 13, i32 21, i32 29>
  %strided.vec429 = shufflevector <32 x float> %wide.vec422, <32 x float> poison, <4 x i32> <i32 6, i32 14, i32 22, i32 30>
  %strided.vec430 = shufflevector <32 x float> %wide.vec422, <32 x float> poison, <4 x i32> <i32 7, i32 15, i32 23, i32 31>
  %880 = fmul <4 x float> %strided.vec414, %strided.vec423
  %881 = fsub <4 x float> %877, %880
  %882 = fmul <4 x float> %strided.vec400, %strided.vec409
  %883 = fmul <4 x float> %strided.vec418, %strided.vec427
  %884 = fsub <4 x float> %882, %883
  %885 = fadd <4 x float> %881, %884
  %886 = fmul <4 x float> %strided.vec396, %strided.vec423
  %887 = fmul <4 x float> %strided.vec405, %strided.vec414
  %888 = fadd <4 x float> %887, %886
  %889 = fmul <4 x float> %strided.vec400, %strided.vec427
  %890 = fmul <4 x float> %strided.vec409, %strided.vec418
  %891 = fadd <4 x float> %890, %889
  %892 = fadd <4 x float> %888, %891
  %893 = fmul <4 x float> %strided.vec398, %strided.vec407
  %894 = fmul <4 x float> %strided.vec416, %strided.vec425
  %895 = fsub <4 x float> %893, %894
  %896 = fmul <4 x float> %strided.vec402, %strided.vec411
  %897 = fmul <4 x float> %strided.vec420, %strided.vec429
  %898 = fsub <4 x float> %896, %897
  %899 = fadd <4 x float> %895, %898
  %900 = fmul <4 x float> %strided.vec398, %strided.vec425
  %901 = fmul <4 x float> %strided.vec407, %strided.vec416
  %902 = fadd <4 x float> %901, %900
  %903 = fmul <4 x float> %strided.vec402, %strided.vec429
  %904 = fmul <4 x float> %strided.vec411, %strided.vec420
  ...
  %921 = fmul <4 x float> %strided.vec397, %strided.vec406
  %922 = fmul <4 x float> %strided.vec415, %strided.vec424
  %923 = fsub <4 x float> %921, %922
  %924 = fmul <4 x float> %strided.vec401, %strided.vec410
  %925 = fmul <4 x float> %strided.vec419, %strided.vec428
  %926 = fsub <4 x float> %924, %925
  %927 = fadd <4 x float> %923, %926
  %928 = fmul <4 x float> %strided.vec397, %strided.vec424
  %929 = fmul <4 x float> %strided.vec406, %strided.vec415
  %930 = fadd <4 x float> %929, %928
  %931 = fmul <4 x float> %strided.vec401, %strided.vec428
  %932 = fmul <4 x float> %strided.vec410, %strided.vec419
  %933 = fadd <4 x float> %932, %931
  %934 = fadd <4 x float> %930, %933
  %935 = fmul <4 x float> %strided.vec399, %strided.vec408
  %936 = fmul <4 x float> %strided.vec417, %strided.vec426
  %937 = fsub <4 x float> %935, %936
  %938 = or i64 %874, 7
  %939 = fmul <4 x float> %strided.vec403, %strided.vec412
  %940 = fmul <4 x float> %strided.vec421, %strided.vec430
  %941 = fsub <4 x float> %939, %940
  %942 = fadd <4 x float> %937, %941
  %943 = fmul <4 x float> %strided.vec399, %strided.vec426
  %944 = fmul <4 x float> %strided.vec408, %strided.vec417
  %945 = fadd <4 x float> %944, %943
  %946 = fmul <4 x float> %strided.vec403, %strided.vec430
  %947 = fmul <4 x float> %strided.vec412, %strided.vec421
  ...
  %interleaved.vec431 = shufflevector <16 x float> %993, <16 x float> %994, <32 x i32> <i32 0, i32 4, i32 8, i32 12, i32 16, i32 20, i32 24, i32 28, i32 1, i32 5, i32 9, i32 13, i32 17, i32 21, i32 25, i32 29, i32 2, i32 6, i32 10, i32 14, i32 18, i32 22, i32 26, i32 30, i32 3, i32 7, i32 11, i32 15, i32 19, i32 23, i32 27, i32 31>
  store <32 x float> %interleaved.vec431, ptr %gep, align 32, !tbaa !277
  %gep463 = getelementptr float, ptr %invariant.gep462, i64 %938
  ...
  %interleaved.vec432 = shufflevector <16 x float> %999, <16 x float> %1000, <32 x i32> <i32 0, i32 4, i32 8, i32 12, i32 16, i32 20, i32 24, i32 28, i32 1, i32 5, i32 9, i32 13, i32 17, i32 21, i32 25, i32 29, i32 2, i32 6, i32 10, i32 14, i32 18, i32 22, i32 26, i32 30, i32 3, i32 7, i32 11, i32 15, i32 19, i32 23, i32 27, i32 31>
  store <32 x float> %interleaved.vec432, ptr %gep463, align 32, !tbaa !278
  %index.next433 = add nuw i64 %index394, 4
  %1001 = icmp eq i64 %index.next433, 8
  br i1 %1001, label %"produce inv_X8$1", label %vector.body393, !llvm.loop !279
...
"produce inv_X8$1":                               ; preds = %vector.body393
  %1003 = load <8 x float>, ptr %inv_fft0_S1_R8_n0.07, align 32, !tbaa !113
  ...
  store <8 x float> %1043, ptr %inv_fft1_S1_R8_n1.013, align 32, !tbaa !34
  ...
  br i1 %549, label %"for result.s0.n1.preheader", label %"end for result.s0.n1", !prof !26

"for result.s0.n1.preheader":                     ; preds = %"produce inv_X8$1"
  %reass.add315 = sub nsw i64 %indvars.iv348, %556
  %reass.mul316 = mul i64 %reass.add315, %248
  %1051 = sub i64 %reass.mul316, %554
  %1052 = add i64 %559, %reass.mul316
  br label %"for result.s0.n1"

"for result.s0.n1":                               ; preds = %"for result.s0.n1.preheader", %"end for result.s0.n0.n091"
  %indvars.iv345 = phi i64 [ %555, %"for result.s0.n1.preheader" ], [ %indvars.iv.next346, %"end for result.s0.n0.n091" ]
  br i1 %550, label %"for result.s0.n0.n0.preheader", label %"end for result.s0.n0.n0", !prof !26

"for result.s0.n0.n0.preheader":                  ; preds = %"for result.s0.n1"
  %1053 = shl nsw i64 %indvars.iv345, 3
  %reass.add317 = sub nsw i64 %indvars.iv345, %555
  %reass.mul318 = mul i64 %reass.add317, %241
  %1054 = add i64 %1051, %reass.mul318
  br i1 %586, label %"end for result.s0.n0.n0.loopexit.unr-lcssa", label %"for result.s0.n0.n0"

"end for result.s0.n1":                           ; preds = %"end for result.s0.n0.n091", %"produce inv_X8$1"
  %indvars.iv.next349 = add nsw i64 %indvars.iv348, 1
  %1055 = trunc i64 %indvars.iv.next349 to i32
  %.not24 = icmp eq i32 %173, %1055
  br i1 %.not24, label %destructor_block, label %"for result.s0.i"

"for result.s0.n0.n0":                            ; preds = %"for result.s0.n0.n0.preheader", %"for result.s0.n0.n0"
  %indvars.iv342 = phi i64 [ %indvars.iv.next343.1, %"for result.s0.n0.n0" ], [ 0, %"for result.s0.n0.n0.preheader" ]
  %niter = phi i64 [ %niter.next.1, %"for result.s0.n0.n0" ], [ 0, %"for result.s0.n0.n0.preheader" ]
  %1056 = shl nuw nsw i64 %indvars.iv342, 3
  %1057 = add nsw i64 %1056, %554
  %1058 = add nsw i64 %1057, %1053
  %1059 = getelementptr inbounds float, ptr %inv_fft1_S1_R8_n1.013, i64 %1058
  ...
  %indvars.iv.next343 = shl i64 %indvars.iv342, 3
  %1064 = or i64 %indvars.iv.next343, 8
  %1065 = add nsw i64 %1064, %554
  %1066 = add nsw i64 %1065, %1053
  %1067 = getelementptr inbounds float, ptr %inv_fft1_S1_R8_n1.013, i64 %1066
...
"end for result.s0.n0.n0.loopexit.unr-lcssa":     ; preds = %"for result.s0.n0.n0", %"for result.s0.n0.n0.preheader"
  %indvars.iv342.unr = phi i64 [ 0, %"for result.s0.n0.n0.preheader" ], [ %indvars.iv.next343.1, %"for result.s0.n0.n0" ]
...
"for result.s0.n0.n0.epil":                       ; preds = %"end for result.s0.n0.n0.loopexit.unr-lcssa"
  %1072 = shl nuw nsw i64 %indvars.iv342.unr, 3
  %1073 = add nsw i64 %1072, %554
  %1074 = add nsw i64 %1073, %1053
  %1075 = getelementptr inbounds float, ptr %inv_fft1_S1_R8_n1.013, i64 %1074
...
"end for result.s0.n0.n0":                        ; preds = %"for result.s0.n0.n0.epil", %"end for result.s0.n0.n0.loopexit.unr-lcssa", %"for result.s0.n1"
  br i1 %553, label %"for result.s0.n0.n090.preheader", label %"end for result.s0.n0.n091", !prof !26

"for result.s0.n0.n090.preheader":                ; preds = %"end for result.s0.n0.n0"
  %1080 = shl nsw i64 %indvars.iv345, 3
  %1081 = add nsw i64 %558, %1080
  %1082 = getelementptr inbounds float, ptr %inv_fft1_S1_R8_n1.013, i64 %1081
  ...
  %reass.add326 = sub nsw i64 %indvars.iv345, %555
  %reass.mul327 = mul i64 %reass.add326, %241
  %1085 = add i64 %1052, %reass.mul327
...
"end for result.s0.n0.n091":                      ; preds = %"for result.s0.n0.n090.preheader", %"end for result.s0.n0.n0"
  ...
  %1087 = trunc i64 %indvars.iv.next346 to i32
  %.not25 = icmp eq i32 %546, %1087
  br i1 %.not25, label %"end for result.s0.n1", label %"for result.s0.n1"
}

; Function Attrs: nounwind
define i32 @_Z97FftConvolve8x8xCZHalide_x86_64_linux_avx_avx2_c_plus_plus_name_mangling_fma_no_runtime_sse41_argvPPv(ptr nocapture readonly %0) local_unnamed_addr #2 {
entry:
  ...
  %6 = tail call i32 @_Z92FftConvolve8x8xCZHalide_x86_64_linux_avx_avx2_c_plus_plus_name_mangling_fma_no_runtime_sse41P15halide_buffer_tS0_S0_(ptr %1, ptr %3, ptr %5) #7
  ret i32 %6
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none)
define nonnull ptr @_Z101FftConvolve8x8xCZHalide_x86_64_linux_avx_avx2_c_plus_plus_name_mangling_fma_no_runtime_sse41_metadatav() local_unnamed_addr #3 {
entry:
  ret ptr @_Z101FftConvolve8x8xCZHalide_x86_64_linux_avx_avx2_c_plus_plus_name_mangling_fma_no_runtime_sse41_metadatav_storage
}

; Function Attrs: nounwind
define i32 @_Z92FftConvolve8x8xCZHalide_x86_64_linux_avx_avx2_c_plus_plus_name_mangling_fma_no_runtime_sse41P8buffer_tS0_S0_(ptr %input, ptr %kernel, ptr %result) local_unnamed_addr #1 {
entry:
  %0 = alloca %struct.halide_buffer_t, align 8
  %t1576 = alloca [12 x i32], align 4
  %1 = alloca %struct.halide_buffer_t, align 8
  %t1572 = alloca [8 x i32], align 4
  %2 = alloca %struct.halide_buffer_t, align 8
  %t1568 = alloca [12 x i32], align 4
  %3 = getelementptr inbounds %struct.halide_buffer_t, ptr %2, i64 0, i32 2
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(48) %t1568, i8 0, i64 48, i1 false)
  ...
  store ptr %t1568, ptr %8, align 8, !tbaa !18
  %9 = getelementptr inbounds %struct.halide_buffer_t, ptr %2, i64 0, i32 3
  store i64 0, ptr %9, align 8, !tbaa !25
  %10 = getelementptr inbounds %struct.halide_buffer_t, ptr %1, i64 0, i32 2
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(32) %t1572, i8 0, i64 32, i1 false)
  ...
  store ptr %t1572, ptr %15, align 8, !tbaa !18
  %16 = getelementptr inbounds %struct.halide_buffer_t, ptr %1, i64 0, i32 3
  store i64 0, ptr %16, align 8, !tbaa !25
  %17 = getelementptr inbounds %struct.halide_buffer_t, ptr %0, i64 0, i32 2
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(48) %t1576, i8 0, i64 48, i1 false)
  ...
  store ptr %t1576, ptr %22, align 8, !tbaa !18
  %23 = getelementptr inbounds %struct.halide_buffer_t, ptr %0, i64 0, i32 3
  store i64 0, ptr %23, align 8, !tbaa !25
  %t1571 = call i32 @halide_upgrade_buffer_t(ptr null, ptr nonnull @str.3, ptr %input, ptr nonnull %2) #2
  %24 = icmp eq i32 %t1571, 0
  br i1 %24, label %"assert succeeded", label %destructor_block, !prof !26

"assert succeeded":                               ; preds = %entry
  %t1575 = call i32 @halide_upgrade_buffer_t(ptr null, ptr nonnull @str.2, ptr %kernel, ptr nonnull %1) #2
  %25 = icmp eq i32 %t1575, 0
  br i1 %25, label %"assert succeeded2", label %destructor_block, !prof !26

destructor_block:                                 ; preds = %false_bb19, %true_bb18, %false_bb12, %true_bb11, %false_bb, %true_bb, %"assert succeeded4", %"assert succeeded2", %"assert succeeded", %entry
  %26 = phi i32 [ %t1571, %entry ], [ %t1575, %"assert succeeded" ], [ %t1579, %"assert succeeded2" ], [ %t1580, %"assert succeeded4" ], [ %t1569, %true_bb ], [ %t1570, %false_bb ], [ %t1573, %true_bb11 ], [ %t1574, %false_bb12 ], [ %t1577, %true_bb18 ], [ %t1578, %false_bb19 ]
  ret i32 %26

"assert succeeded2":                              ; preds = %"assert succeeded"
  %t1579 = call i32 @halide_upgrade_buffer_t(ptr null, ptr nonnull @str, ptr %result, ptr nonnull %0) #2
  %27 = icmp eq i32 %t1579, 0
  br i1 %27, label %"assert succeeded4", label %destructor_block, !prof !26

"assert succeeded4":                              ; preds = %"assert succeeded2"
  %t1580 = call i32 @_Z92FftConvolve8x8xCZHalide_x86_64_linux_avx_avx2_c_plus_plus_name_mangling_fma_no_runtime_sse41P15halide_buffer_tS0_S0_(ptr nonnull %2, ptr nonnull %1, ptr nonnull %0) #2
  %28 = icmp eq i32 %t1580, 0
...
true_bb:                                          ; preds = %"assert succeeded6"
  %t1569 = call i32 @halide_downgrade_buffer_t(ptr null, ptr nonnull @str.3, ptr nonnull %2, ptr %input) #2
  %33 = icmp eq i32 %t1569, 0
  br i1 %33, label %after_bb, label %destructor_block, !prof !26

false_bb:                                         ; preds = %"assert succeeded6"
  %t1570 = call i32 @halide_downgrade_buffer_t_device_fields(ptr null, ptr nonnull @str.3, ptr nonnull %2, ptr %input) #2
  %34 = icmp eq i32 %t1570, 0
...
true_bb11:                                        ; preds = %after_bb
  %t1573 = call i32 @halide_downgrade_buffer_t(ptr null, ptr nonnull @str.2, ptr nonnull %1, ptr %kernel) #2
  %39 = icmp eq i32 %t1573, 0
  br i1 %39, label %after_bb13, label %destructor_block, !prof !26

false_bb12:                                       ; preds = %after_bb
  %t1574 = call i32 @halide_downgrade_buffer_t_device_fields(ptr null, ptr nonnull @str.2, ptr nonnull %1, ptr %kernel) #2
  %40 = icmp eq i32 %t1574, 0
...
true_bb18:                                        ; preds = %after_bb13
  %t1577 = call i32 @halide_downgrade_buffer_t(ptr null, ptr nonnull @str, ptr nonnull %0, ptr %result) #2
  br label %destructor_block

false_bb19:                                       ; preds = %after_bb13
  %t1578 = call i32 @halide_downgrade_buffer_t_device_fields(ptr null, ptr nonnull @str, ptr nonnull %0, ptr %result) #2
  br label %destructor_block
}
...
!34 = !{!35, !35, i64 0}
!35 = !{!"kernel_fft0_S1_R8_n0.0.width8.base0", !36, i64 0}
!36 = !{!"kernel_fft0_S1_R8_n0.0.width16.base0", !37, i64 0}
!37 = !{!"kernel_fft0_S1_R8_n0.0.width32.base0", !38, i64 0}
!38 = !{!"kernel_fft0_S1_R8_n0.0.width64.base0", !39, i64 0}
!39 = !{!"kernel_fft0_S1_R8_n0.0.width128.base0", !40, i64 0}
!40 = !{!"kernel_fft0_S1_R8_n0.0.width256.base0", !41, i64 0}
!41 = !{!"kernel_fft0_S1_R8_n0.0.width512.base0", !42, i64 0}
!42 = !{!"kernel_fft0_S1_R8_n0.0.width1024.base0", !33, i64 0}
!43 = !{!44, !44, i64 0}
!44 = !{!"kernel_fft0_S1_R8_n0.0.width8.base32", !45, i64 0}
!45 = !{!"kernel_fft0_S1_R8_n0.0.width16.base32", !46, i64 0}
!46 = !{!"kernel_fft0_S1_R8_n0.0.width32.base32", !38, i64 0}
!47 = !{!48, !48, i64 0}
!48 = !{!"kernel_fft0_S1_R8_n0.0.width8.base16", !49, i64 0}
!49 = !{!"kernel_fft0_S1_R8_n0.0.width16.base16", !37, i64 0}
!50 = !{!51, !51, i64 0}
!51 = !{!"kernel_fft0_S1_R8_n0.0.width8.base48", !52, i64 0}
!52 = !{!"kernel_fft0_S1_R8_n0.0.width16.base48", !46, i64 0}
!53 = !{!54, !54, i64 0}
!54 = !{!"kernel_X8$1.0.width8.base56", !55, i64 0}
!55 = !{!"kernel_X8$1.0.width16.base48", !56, i64 0}
!56 = !{!"kernel_X8$1.0.width32.base32", !57, i64 0}
!57 = !{!"kernel_X8$1.0.width64.base0", !58, i64 0}
!58 = !{!"kernel_X8$1.0.width128.base0", !59, i64 0}
!59 = !{!"kernel_X8$1.0.width256.base0", !60, i64 0}
!60 = !{!"kernel_X8$1.0.width512.base0", !61, i64 0}
!61 = !{!"kernel_X8$1.0.width1024.base0", !62, i64 0}
!62 = !{!"kernel_X8$1.0", !29, i64 0}
!63 = !{!64, !64, i64 0}
!64 = !{!"kernel_X8$1.1.width8.base56", !65, i64 0}
!65 = !{!"kernel_X8$1.1.width16.base48", !66, i64 0}
!66 = !{!"kernel_X8$1.1.width32.base32", !67, i64 0}
!67 = !{!"kernel_X8$1.1.width64.base0", !68, i64 0}
!68 = !{!"kernel_X8$1.1.width128.base0", !69, i64 0}
!69 = !{!"kernel_X8$1.1.width256.base0", !70, i64 0}
!70 = !{!"kernel_X8$1.1.width512.base0", !71, i64 0}
!71 = !{!"kernel_X8$1.1.width1024.base0", !72, i64 0}
!72 = !{!"kernel_X8$1.1", !29, i64 0}
!73 = !{!74, !74, i64 0}
!74 = !{!"kernel_X8$1.0.width8.base40", !75, i64 0}
!75 = !{!"kernel_X8$1.0.width16.base32", !56, i64 0}
!76 = !{!77, !77, i64 0}
!77 = !{!"kernel_X8$1.1.width8.base40", !78, i64 0}
!78 = !{!"kernel_X8$1.1.width16.base32", !66, i64 0}
!79 = !{!80, !80, i64 0}
!80 = !{!"kernel_X8$1.0.width8.base48", !55, i64 0}
!81 = !{!82, !82, i64 0}
!82 = !{!"kernel_X8$1.1.width8.base48", !65, i64 0}
!83 = !{!84, !84, i64 0}
!84 = !{!"kernel_X8$1.0.width8.base32", !75, i64 0}
!85 = !{!86, !86, i64 0}
!86 = !{!"kernel_X8$1.1.width8.base32", !78, i64 0}
!87 = !{!88, !88, i64 0}
!88 = !{!"kernel_fft0_S1_R8_n0.0.width8.base8", !36, i64 0}
!89 = !{!90, !90, i64 0}
!90 = !{!"kernel_fft0_S1_R8_n0.0.width8.base40", !45, i64 0}
!91 = !{!92, !92, i64 0}
!92 = !{!"kernel_fft0_S1_R8_n0.0.width8.base24", !49, i64 0}
!93 = !{!94, !94, i64 0}
!94 = !{!"kernel_fft0_S1_R8_n0.0.width8.base56", !52, i64 0}
!95 = !{!96, !96, i64 0}
!96 = !{!"kernel_X8$1.0.width8.base24", !97, i64 0}
!97 = !{!"kernel_X8$1.0.width16.base16", !98, i64 0}
!98 = !{!"kernel_X8$1.0.width32.base0", !57, i64 0}
!99 = !{!100, !100, i64 0}
!100 = !{!"kernel_X8$1.1.width8.base24", !101, i64 0}
!101 = !{!"kernel_X8$1.1.width16.base16", !102, i64 0}
!102 = !{!"kernel_X8$1.1.width32.base0", !67, i64 0}
!103 = !{!104, !104, i64 0}
!104 = !{!"kernel_X8$1.0.width8.base8", !105, i64 0}
!105 = !{!"kernel_X8$1.0.width16.base0", !98, i64 0}
!106 = !{!107, !107, i64 0}
!107 = !{!"kernel_X8$1.1.width8.base8", !108, i64 0}
!108 = !{!"kernel_X8$1.1.width16.base0", !102, i64 0}
!109 = !{!110, !110, i64 0}
!110 = !{!"kernel_X8$1.0.width8.base16", !97, i64 0}
!111 = !{!112, !112, i64 0}
!112 = !{!"kernel_X8$1.1.width8.base16", !101, i64 0}
!113 = !{!114, !114, i64 0}
!114 = !{!"kernel_X8$1.0.width8.base0", !105, i64 0}
!115 = !{!116, !116, i64 0}
!116 = !{!"kernel_X8$1.1.width8.base0", !108, i64 0}
!117 = !{!118, !118, i64 0}
!118 = !{!"kernel_X8$1.0.width8.base64", !119, i64 0}
!119 = !{!"kernel_X8$1.0.width16.base64", !120, i64 0}
!120 = !{!"kernel_X8$1.0.width32.base64", !121, i64 0}
!121 = !{!"kernel_X8$1.0.width64.base64", !58, i64 0}
!122 = !{!123, !123, i64 0}
!123 = !{!"kernel_X8$1.1.width8.base64", !124, i64 0}
!124 = !{!"kernel_X8$1.1.width16.base64", !125, i64 0}
!125 = !{!"kernel_X8$1.1.width32.base64", !126, i64 0}
!126 = !{!"kernel_X8$1.1.width64.base64", !68, i64 0}
!127 = !{!128, !128, i64 0}
!128 = !{!"kernel_X8$1.0.width8.base72", !119, i64 0}
!129 = !{!130, !130, i64 0}
!130 = !{!"kernel_X8$1.1.width8.base72", !124, i64 0}
!131 = !{!132, !132, i64 0}
!132 = !{!"kernel_X8$1.0.width8.base80", !133, i64 0}
!133 = !{!"kernel_X8$1.0.width16.base80", !120, i64 0}
!134 = !{!135, !135, i64 0}
!135 = !{!"kernel_X8$1.1.width8.base80", !136, i64 0}
!136 = !{!"kernel_X8$1.1.width16.base80", !125, i64 0}
!137 = !{!138, !138, i64 0}
!138 = !{!"kernel_X8$1.0.width8.base88", !133, i64 0}
!139 = !{!140, !140, i64 0}
!140 = !{!"kernel_X8$1.1.width8.base88", !136, i64 0}
!141 = !{!142, !142, i64 0}
!142 = !{!"kernel_X8$1.0.width8.base96", !143, i64 0}
!143 = !{!"kernel_X8$1.0.width16.base96", !144, i64 0}
!144 = !{!"kernel_X8$1.0.width32.base96", !121, i64 0}
!145 = !{!146, !146, i64 0}
!146 = !{!"kernel_X8$1.1.width8.base96", !147, i64 0}
!147 = !{!"kernel_X8$1.1.width16.base96", !148, i64 0}
!148 = !{!"kernel_X8$1.1.width32.base96", !126, i64 0}
!149 = !{!150, !150, i64 0}
!150 = !{!"kernel_X8$1.0.width8.base104", !143, i64 0}
!151 = !{!152, !152, i64 0}
!152 = !{!"kernel_X8$1.1.width8.base104", !147, i64 0}
!153 = !{!154, !154, i64 0}
!154 = !{!"kernel_X8$1.0.width8.base112", !155, i64 0}
!155 = !{!"kernel_X8$1.0.width16.base112", !144, i64 0}
!156 = !{!157, !157, i64 0}
!157 = !{!"kernel_X8$1.1.width8.base112", !158, i64 0}
!158 = !{!"kernel_X8$1.1.width16.base112", !148, i64 0}
!159 = !{!160, !160, i64 0}
!160 = !{!"kernel_X8$1.0.width8.base120", !155, i64 0}
!161 = !{!162, !162, i64 0}
!162 = !{!"kernel_X8$1.1.width8.base120", !158, i64 0}
!163 = !{!164, !164, i64 0}
!164 = !{!"kernel_fft1_S1_R8_n1.0.width8.base0", !165, i64 0}
!165 = !{!"kernel_fft1_S1_R8_n1.0.width16.base0", !166, i64 0}
!166 = !{!"kernel_fft1_S1_R8_n1.0.width32.base0", !167, i64 0}
!167 = !{!"kernel_fft1_S1_R8_n1.0.width64.base0", !168, i64 0}
!168 = !{!"kernel_fft1_S1_R8_n1.0.width128.base0", !169, i64 0}
!169 = !{!"kernel_fft1_S1_R8_n1.0.width256.base0", !170, i64 0}
!170 = !{!"kernel_fft1_S1_R8_n1.0.width512.base0", !171, i64 0}
!171 = !{!"kernel_fft1_S1_R8_n1.0.width1024.base0", !172, i64 0}
!172 = !{!"kernel_fft1_S1_R8_n1.0", !29, i64 0}
!173 = !{!174, !174, i64 0}
!174 = !{!"kernel_fft1_S1_R8_n1.1.width8.base0", !175, i64 0}
!175 = !{!"kernel_fft1_S1_R8_n1.1.width16.base0", !176, i64 0}
!176 = !{!"kernel_fft1_S1_R8_n1.1.width32.base0", !177, i64 0}
!177 = !{!"kernel_fft1_S1_R8_n1.1.width64.base0", !178, i64 0}
!178 = !{!"kernel_fft1_S1_R8_n1.1.width128.base0", !179, i64 0}
!179 = !{!"kernel_fft1_S1_R8_n1.1.width256.base0", !180, i64 0}
!180 = !{!"kernel_fft1_S1_R8_n1.1.width512.base0", !181, i64 0}
!181 = !{!"kernel_fft1_S1_R8_n1.1.width1024.base0", !182, i64 0}
!182 = !{!"kernel_fft1_S1_R8_n1.1", !29, i64 0}
!183 = !{!184, !184, i64 0}
!184 = !{!"kernel_fft1_S1_R8_n1.0.width8.base8", !165, i64 0}
!185 = !{!186, !186, i64 0}
!186 = !{!"kernel_fft1_S1_R8_n1.1.width8.base8", !175, i64 0}
!187 = !{!188, !188, i64 0}
!188 = !{!"kernel_fft1_S1_R8_n1.0.width8.base16", !189, i64 0}
!189 = !{!"kernel_fft1_S1_R8_n1.0.width16.base16", !166, i64 0}
!190 = !{!191, !191, i64 0}
!191 = !{!"kernel_fft1_S1_R8_n1.1.width8.base16", !192, i64 0}
!192 = !{!"kernel_fft1_S1_R8_n1.1.width16.base16", !176, i64 0}
!193 = !{!194, !194, i64 0}
!194 = !{!"kernel_fft1_S1_R8_n1.0.width8.base24", !189, i64 0}
!195 = !{!196, !196, i64 0}
!196 = !{!"kernel_fft1_S1_R8_n1.1.width8.base24", !192, i64 0}
!197 = !{!198, !198, i64 0}
!198 = !{!"kernel_fft1_S1_R8_n1.0.width8.base32", !199, i64 0}
!199 = !{!"kernel_fft1_S1_R8_n1.0.width16.base32", !200, i64 0}
!200 = !{!"kernel_fft1_S1_R8_n1.0.width32.base32", !167, i64 0}
!201 = !{!202, !202, i64 0}
!202 = !{!"kernel_fft1_S1_R8_n1.1.width8.base32", !203, i64 0}
!203 = !{!"kernel_fft1_S1_R8_n1.1.width16.base32", !204, i64 0}
!204 = !{!"kernel_fft1_S1_R8_n1.1.width32.base32", !177, i64 0}
!205 = !{!206, !206, i64 0}
!206 = !{!"kernel_fft1_S1_R8_n1.0.width8.base40", !199, i64 0}
!207 = !{!208, !208, i64 0}
!208 = !{!"kernel_fft1_S1_R8_n1.1.width8.base40", !203, i64 0}
!209 = !{!210, !210, i64 0}
!210 = !{!"kernel_fft1_S1_R8_n1.0.width8.base48", !211, i64 0}
!211 = !{!"kernel_fft1_S1_R8_n1.0.width16.base48", !200, i64 0}
!212 = !{!213, !213, i64 0}
!213 = !{!"kernel_fft1_S1_R8_n1.1.width8.base48", !214, i64 0}
!214 = !{!"kernel_fft1_S1_R8_n1.1.width16.base48", !204, i64 0}
!215 = !{!216, !216, i64 0}
!216 = !{!"kernel_fft1_S1_R8_n1.0.width8.base56", !211, i64 0}
!217 = !{!218, !218, i64 0}
!218 = !{!"kernel_fft1_S1_R8_n1.1.width8.base56", !214, i64 0}
!219 = !{!220, !220, i64 0}
!220 = !{!"input", !29, i64 0}
!221 = !{!222, !222, i64 0}
!222 = !{!"k.0.width8.base0", !223, i64 0}
!223 = !{!"k.0.width16.base0", !224, i64 0}
!224 = !{!"k.0.width32.base0", !225, i64 0}
!225 = !{!"k.0.width64.base0", !226, i64 0}
!226 = !{!"k.0.width128.base0", !227, i64 0}
!227 = !{!"k.0.width256.base0", !228, i64 0}
!228 = !{!"k.0.width512.base0", !229, i64 0}
!229 = !{!"k.0.width1024.base0", !31, i64 0}
!230 = !{!231, !231, i64 0}
!231 = !{!"k.1.width8.base0", !232, i64 0}
!232 = !{!"k.1.width16.base0", !233, i64 0}
!233 = !{!"k.1.width32.base0", !234, i64 0}
!234 = !{!"k.1.width64.base0", !235, i64 0}
!235 = !{!"k.1.width128.base0", !236, i64 0}
!236 = !{!"k.1.width256.base0", !237, i64 0}
!237 = !{!"k.1.width512.base0", !238, i64 0}
!238 = !{!"k.1.width1024.base0", !28, i64 0}
!239 = !{!240, !240, i64 0}
!240 = !{!"k.0.width8.base8", !223, i64 0}
!241 = !{!242, !242, i64 0}
!242 = !{!"k.1.width8.base8", !232, i64 0}
!243 = !{!244, !244, i64 0}
!244 = !{!"k.0.width8.base16", !245, i64 0}
!245 = !{!"k.0.width16.base16", !224, i64 0}
!246 = !{!247, !247, i64 0}
!247 = !{!"k.1.width8.base16", !248, i64 0}
!248 = !{!"k.1.width16.base16", !233, i64 0}
!249 = !{!250, !250, i64 0}
!250 = !{!"k.0.width8.base24", !245, i64 0}
!251 = !{!252, !252, i64 0}
!252 = !{!"k.1.width8.base24", !248, i64 0}
!253 = !{!254, !254, i64 0}
!254 = !{!"k.0.width8.base32", !255, i64 0}
!255 = !{!"k.0.width16.base32", !256, i64 0}
!256 = !{!"k.0.width32.base32", !225, i64 0}
!257 = !{!258, !258, i64 0}
!258 = !{!"k.1.width8.base32", !259, i64 0}
!259 = !{!"k.1.width16.base32", !260, i64 0}
!260 = !{!"k.1.width32.base32", !234, i64 0}
!261 = !{!262, !262, i64 0}
!262 = !{!"k.0.width8.base40", !255, i64 0}
!263 = !{!264, !264, i64 0}
!264 = !{!"k.1.width8.base40", !259, i64 0}
!265 = !{!266, !266, i64 0}
!266 = !{!"k.0.width8.base48", !267, i64 0}
!267 = !{!"k.0.width16.base48", !256, i64 0}
!268 = !{!269, !269, i64 0}
!269 = !{!"k.1.width8.base48", !270, i64 0}
!270 = !{!"k.1.width16.base48", !260, i64 0}
!271 = !{!272, !272, i64 0}
!272 = !{!"k.0.width8.base56", !267, i64 0}
!273 = !{!274, !274, i64 0}
!274 = !{!"k.1.width8.base56", !270, i64 0}
!275 = !{!172, !172, i64 0}
!276 = !{!182, !182, i64 0}
!277 = !{!62, !62, i64 0}
!278 = !{!72, !72, i64 0}
