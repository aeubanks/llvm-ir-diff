...
entry:
  %retval.sroa.0.0.copyload = load i64, ptr @x, align 8, !tbaa.struct !5
  %retval.sroa.2.0.copyload = load i64, ptr getelementptr inbounds (%struct.S1, ptr @x, i64 0, i32 2, i64 0, i32 1), align 8, !tbaa.struct !11
...
entry:
  %retval.sroa.2.0.copyload.i = load i64, ptr getelementptr inbounds (%struct.S1, ptr @x, i64 0, i32 2, i64 0, i32 1), align 8, !tbaa.struct !11
