...
if.then114:                                       ; preds = %SET_BITS_TO.exit412
  ...
  %arrayidx.1.i418 = getelementptr inbounds i8, ptr %INSTRUCT_CODE, i64 1
  %99 = load i8, ptr %arrayidx.1.i418, align 1, !tbaa !11
  ...
  %arrayidx.2.i422 = getelementptr inbounds i8, ptr %INSTRUCT_CODE, i64 2
  %102 = load i8, ptr %arrayidx.2.i422, align 2, !tbaa !11
  ...
  %arrayidx.3.i427 = getelementptr inbounds i8, ptr %INSTRUCT_CODE, i64 3
  %103 = load i8, ptr %arrayidx.3.i427, align 1, !tbaa !11
