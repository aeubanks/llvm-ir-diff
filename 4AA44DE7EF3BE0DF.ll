...
if.end88.i:                                       ; preds = %if.end83.i
  ...
  br i1 %tobool97.not.i, label %if.end88.if.end115_crit_edge.i, label %land.lhs.true98.i

if.end88.if.end115_crit_edge.i:                   ; preds = %if.end88.i
  %.pre.i = zext i32 %xor78.i to i64
...
land.lhs.true98.i:                                ; preds = %if.end88.i
  ...
  %tobool100.not.i = icmp ne i64 %25, 0
  %conv103.i = zext i32 %xor78.i to i64
  %cmp106.i = icmp ult i64 %25, %conv103.i
  %or.cond963.i = and i1 %tobool100.not.i, %cmp106.i
  br i1 %or.cond963.i, label %if.then108.i, label %if.end115.i
...
if.end115.i:                                      ; preds = %land.lhs.true98.i, %if.end88.if.end115_crit_edge.i
  %conv117.pre-phi.i = phi i64 [ %.pre.i, %if.end88.if.end115_crit_edge.i ], [ %conv103.i, %land.lhs.true98.i ]
  %call118.i = call ptr @cli_malloc(i64 noundef %conv117.pre-phi.i) #13
...
land.lhs.true156.i:                               ; preds = %if.end139.i
  ...
  %or.cond964.i = and i1 %tobool159.not.i, %cmp165.i
  br i1 %or.cond964.i, label %if.then167.i, label %if.end171.i
...
if.end171.i:                                      ; preds = %land.lhs.true156.i, %if.end139.if.end171_crit_edge.i
  %conv173.pre-phi.i = phi i64 [ %.pre1082.i, %if.end139.if.end171_crit_edge.i ], [ %conv162.i, %land.lhs.true156.i ]
  %call174.i = call ptr @cli_malloc(i64 noundef %conv173.pre-phi.i) #13
  %call174.i684 = ptrtoint ptr %call174.i to i64
...
if.end177.i:                                      ; preds = %if.end171.i
  ...
  %cmp1841051.not.i = icmp eq i32 %27, 0
  br i1 %cmp1841051.not.i, label %if.end342.thread.i, label %while.body186.lr.ph.i
...
while.body186.i:                                  ; preds = %if.end332.i, %while.body186.lr.ph.i
  %UNP.sroa.21.01055.i = phi i32 [ 0, %while.body186.lr.ph.i ], [ %UNP.sroa.21.3.i, %if.end332.i ]
  %UNP.sroa.30.01054.i = phi i32 [ 8, %while.body186.lr.ph.i ], [ %UNP.sroa.30.27.i, %if.end332.i ]
  %UNP.sroa.110.01053.i = phi i32 [ 0, %while.body186.lr.ph.i ], [ %UNP.sroa.110.27.i, %if.end332.i ]
  %UNP.sroa.93.01052.i = phi i32 [ 0, %while.body186.lr.ph.i ], [ %UNP.sroa.93.11.i, %if.end332.i ]
  %UNP.sroa.110.38.insert.mask.i = and i32 %UNP.sroa.110.01053.i, 65535
  %cmp.i.i = icmp eq i32 %UNP.sroa.93.01052.i, 0
  %sub3.i.i = sub i32 %xor78.i, %UNP.sroa.30.01054.i
  %cmp4.i.i = icmp ult i32 %sub3.i.i, 2
  %or.cond968.i = select i1 %cmp.i.i, i1 %cmp4.i.i, i1 false
  br i1 %or.cond968.i, label %land.lhs.true.i762.thread.i, label %while.body.i.preheader.i
...
if.then7.i.i:                                     ; preds = %while.body.i.preheader.i
  %inc.i.i = add i32 %UNP.sroa.30.01054.i, 1
  %idxprom.i.i = zext i32 %UNP.sroa.30.01054.i to i64
  ...
  %inc14.i.i = add i32 %UNP.sroa.30.01054.i, 2
...
if.end24.i.i:                                     ; preds = %if.then7.i.i, %while.body.i.preheader.i
  ...
  %UNP.sroa.30.2.i = phi i32 [ %inc14.i.i, %if.then7.i.i ], [ %UNP.sroa.30.01054.i, %while.body.i.preheader.i ]
  %34 = phi i32 [ 16, %if.then7.i.i ], [ %UNP.sroa.93.01052.i, %while.body.i.preheader.i ]
...
if.end24.i552.thread.i:                           ; preds = %while.body.lr.ph.i534.i
  ...
  %shl26.i5481087.i = shl nuw nsw i32 %UNP.sroa.110.36.insert.insert879.i, 1
...
if.end24.i552.1.thread.i:                         ; preds = %if.then7.i547.1.i, %if.end24.i552.thread.i
  %UNP.sroa.110.5.1.ph.i = phi i32 [ %shl26.i5481087.i, %if.end24.i552.thread.i ], [ %UNP.sroa.110.36.insert.insert879.1.i, %if.then7.i547.1.i ]
  %.ph.i = phi i32 [ 14, %if.end24.i552.thread.i ], [ 15, %if.then7.i547.1.i ]
  %UNP.sroa.30.5.1.ph.i = add i32 %UNP.sroa.30.2.i, 2
  %shl26.i548.11092.i = shl nuw nsw i32 %UNP.sroa.110.5.1.ph.i, 1
  br label %if.end24.i552.3.i
...
if.end24.i552.2.thread.i:                         ; preds = %if.end24.i552.1.i
  ...
  %shl26.i548.21097.i = shl nuw nsw i32 %UNP.sroa.110.36.insert.insert879.2.i, 1
...
if.end24.i552.4.i.thread:                         ; preds = %if.end24.i552.2.thread.i, %if.then7.i547.3.i
  %UNP.sroa.110.5.3.ph.i = phi i32 [ %shl26.i548.21097.i, %if.end24.i552.2.thread.i ], [ %UNP.sroa.110.36.insert.insert879.3.i, %if.then7.i547.3.i ]
  %.ph1100.i = phi i32 [ 14, %if.end24.i552.2.thread.i ], [ 15, %if.then7.i547.3.i ]
  %UNP.sroa.30.5.3.ph.i = add i32 %UNP.sroa.30.2.i, 2
  %shl26.i548.31103.i = shl nuw nsw i32 %UNP.sroa.110.5.3.ph.i, 1
...
if.end24.i552.3.i:                                ; preds = %if.end24.i552.1.i, %if.end24.i552.1.i.thread, %if.end24.i552.1.thread.i
  ...
  %UNP.sroa.110.5.2.i130 = phi i32 [ %shl26.i548.1.i124, %if.end24.i552.1.i.thread ], [ %shl26.i548.11092.i, %if.end24.i552.1.thread.i ], [ %shl26.i548.1.i, %if.end24.i552.1.i ]
...
if.end24.i552.4.thread.i:                         ; preds = %if.end24.i552.3.i
  ...
  %shl26.i548.41108.i = shl nuw nsw i32 %UNP.sroa.110.36.insert.insert879.4.i, 1
...
if.end24.i552.6.i.thread:                         ; preds = %if.end24.i552.4.thread.i, %if.then7.i547.5.i
  %UNP.sroa.110.5.5.ph.i = phi i32 [ %shl26.i548.41108.i, %if.end24.i552.4.thread.i ], [ %UNP.sroa.110.36.insert.insert879.5.i, %if.then7.i547.5.i ]
  %.ph1111.i = phi i32 [ 14, %if.end24.i552.4.thread.i ], [ 15, %if.then7.i547.5.i ]
  %UNP.sroa.30.5.5.ph.i = add i32 %UNP.sroa.30.5.2.i131, 2
  %shl26.i548.51114.i = shl nuw nsw i32 %UNP.sroa.110.5.5.ph.i, 1
  br label %if.end24.i552.7.i

if.end24.i552.5.i:                                ; preds = %if.end24.i552.3.i, %if.end24.i552.4.i.thread
  %61 = phi i32 [ %.ph1100.i, %if.end24.i552.4.i.thread ], [ %dec.i549.3.i, %if.end24.i552.3.i ]
  %UNP.sroa.30.5.4.i136 = phi i32 [ %UNP.sroa.30.5.3.ph.i, %if.end24.i552.4.i.thread ], [ %UNP.sroa.30.5.2.i131, %if.end24.i552.3.i ]
  %UNP.sroa.110.5.4.i135 = phi i32 [ %shl26.i548.31103.i, %if.end24.i552.4.i.thread ], [ %shl26.i548.3.i, %if.end24.i552.3.i ]
...
if.end24.i552.6.thread.i:                         ; preds = %if.end24.i552.5.i
  ...
  %shl26.i548.61119.i = shl nuw nsw i32 %UNP.sroa.110.36.insert.insert879.6.i, 1
...
if.end24.i552.8.i.thread:                         ; preds = %if.end24.i552.6.thread.i, %if.then7.i547.7.i
  %UNP.sroa.110.5.7.ph.i = phi i32 [ %shl26.i548.61119.i, %if.end24.i552.6.thread.i ], [ %UNP.sroa.110.36.insert.insert879.7.i, %if.then7.i547.7.i ]
  %.ph1122.i = phi i32 [ 14, %if.end24.i552.6.thread.i ], [ 15, %if.then7.i547.7.i ]
  %UNP.sroa.30.5.7.ph.i = add i32 %UNP.sroa.30.5.4.i136, 2
  %shl26.i548.71125.i = shl nuw nsw i32 %UNP.sroa.110.5.7.ph.i, 1
  br label %if.end24.i552.9.i

if.end24.i552.7.i:                                ; preds = %if.end24.i552.5.i, %if.end24.i552.6.i.thread
  %70 = phi i32 [ %.ph1111.i, %if.end24.i552.6.i.thread ], [ %dec.i549.5.i, %if.end24.i552.5.i ]
  %UNP.sroa.30.5.6.i141 = phi i32 [ %UNP.sroa.30.5.5.ph.i, %if.end24.i552.6.i.thread ], [ %UNP.sroa.30.5.4.i136, %if.end24.i552.5.i ]
  %UNP.sroa.110.5.6.i140 = phi i32 [ %shl26.i548.51114.i, %if.end24.i552.6.i.thread ], [ %shl26.i548.5.i, %if.end24.i552.5.i ]
...
if.end24.i552.8.thread.i:                         ; preds = %if.end24.i552.7.i
  ...
  %shl26.i548.81130.i = shl nuw nsw i32 %UNP.sroa.110.36.insert.insert879.8.i, 1
...
if.end24.i552.10.i.thread:                        ; preds = %if.end24.i552.8.thread.i, %if.then7.i547.9.i
  %UNP.sroa.110.5.9.ph.i = phi i32 [ %shl26.i548.81130.i, %if.end24.i552.8.thread.i ], [ %UNP.sroa.110.36.insert.insert879.9.i, %if.then7.i547.9.i ]
  %.ph1133.i = phi i32 [ 14, %if.end24.i552.8.thread.i ], [ 15, %if.then7.i547.9.i ]
  %UNP.sroa.30.5.9.ph.i = add i32 %UNP.sroa.30.5.6.i141, 2
  %shl26.i548.91136.i = shl nuw nsw i32 %UNP.sroa.110.5.9.ph.i, 1
  br label %if.end24.i552.11.i

if.end24.i552.9.i:                                ; preds = %if.end24.i552.7.i, %if.end24.i552.8.i.thread
  %79 = phi i32 [ %.ph1122.i, %if.end24.i552.8.i.thread ], [ %dec.i549.7.i, %if.end24.i552.7.i ]
  %UNP.sroa.30.5.8.i146 = phi i32 [ %UNP.sroa.30.5.7.ph.i, %if.end24.i552.8.i.thread ], [ %UNP.sroa.30.5.6.i141, %if.end24.i552.7.i ]
  %UNP.sroa.110.5.8.i145 = phi i32 [ %shl26.i548.71125.i, %if.end24.i552.8.i.thread ], [ %shl26.i548.7.i, %if.end24.i552.7.i ]
...
if.end24.i552.10.thread.i:                        ; preds = %if.end24.i552.9.i
  ...
  %shl26.i548.101141.i = shl nuw nsw i32 %UNP.sroa.110.36.insert.insert879.10.i, 1
...
if.end24.i552.12.i.thread:                        ; preds = %if.end24.i552.10.thread.i, %if.then7.i547.11.i
  %UNP.sroa.110.5.11.ph.i = phi i32 [ %shl26.i548.101141.i, %if.end24.i552.10.thread.i ], [ %UNP.sroa.110.36.insert.insert879.11.i, %if.then7.i547.11.i ]
  %.ph1144.i = phi i32 [ 14, %if.end24.i552.10.thread.i ], [ 15, %if.then7.i547.11.i ]
  %UNP.sroa.30.5.11.ph.i = add i32 %UNP.sroa.30.5.8.i146, 2
  %shl26.i548.111147.i = shl nuw nsw i32 %UNP.sroa.110.5.11.ph.i, 1
  br label %if.end24.i552.13.i

if.end24.i552.11.i:                               ; preds = %if.end24.i552.9.i, %if.end24.i552.10.i.thread
  %88 = phi i32 [ %.ph1133.i, %if.end24.i552.10.i.thread ], [ %dec.i549.9.i, %if.end24.i552.9.i ]
  %UNP.sroa.30.5.10.i151 = phi i32 [ %UNP.sroa.30.5.9.ph.i, %if.end24.i552.10.i.thread ], [ %UNP.sroa.30.5.8.i146, %if.end24.i552.9.i ]
  %UNP.sroa.110.5.10.i150 = phi i32 [ %shl26.i548.91136.i, %if.end24.i552.10.i.thread ], [ %shl26.i548.9.i, %if.end24.i552.9.i ]
...
if.end24.i552.12.thread.i:                        ; preds = %if.end24.i552.11.i
  ...
  %shl26.i548.121152.i = shl nuw nsw i32 %UNP.sroa.110.36.insert.insert879.12.i, 1
...
if.end24.i552.13.thread.i:                        ; preds = %if.then7.i547.13.i, %if.end24.i552.12.thread.i
  %UNP.sroa.110.5.13.ph.i = phi i32 [ %shl26.i548.121152.i, %if.end24.i552.12.thread.i ], [ %UNP.sroa.110.36.insert.insert879.13.i, %if.then7.i547.13.i ]
  %.ph1155.i = phi i32 [ 14, %if.end24.i552.12.thread.i ], [ 15, %if.then7.i547.13.i ]
  %UNP.sroa.30.5.13.ph.i = add i32 %UNP.sroa.30.5.10.i151, 2
  %shl26.i548.131158.i = shl nuw nsw i32 %UNP.sroa.110.5.13.ph.i, 1
  br label %if.end24.i552.14.i

if.end24.i552.13.i:                               ; preds = %if.end24.i552.11.i, %if.end24.i552.12.i.thread
  %97 = phi i32 [ %.ph1144.i, %if.end24.i552.12.i.thread ], [ %dec.i549.11.i, %if.end24.i552.11.i ]
  %UNP.sroa.30.5.12.i156 = phi i32 [ %UNP.sroa.30.5.11.ph.i, %if.end24.i552.12.i.thread ], [ %UNP.sroa.30.5.10.i151, %if.end24.i552.11.i ]
  %UNP.sroa.110.5.12.i155 = phi i32 [ %shl26.i548.111147.i, %if.end24.i552.12.i.thread ], [ %shl26.i548.11.i, %if.end24.i552.11.i ]
...
if.end24.i552.14.i:                               ; preds = %if.then7.i547.14.i, %if.end24.i552.13.i, %if.end24.i552.13.thread.i
  %UNP.sroa.110.5.14.i = phi i32 [ %UNP.sroa.110.36.insert.insert879.14.i, %if.then7.i547.14.i ], [ %shl26.i548.13.i, %if.end24.i552.13.i ], [ %shl26.i548.131158.i, %if.end24.i552.13.thread.i ]
  ...
  %102 = phi i32 [ 16, %if.then7.i547.14.i ], [ %dec.i549.13.i, %if.end24.i552.13.i ], [ %.ph1155.i, %if.end24.i552.13.thread.i ]
...
if.end24.i591.thread.i:                           ; preds = %while.body.lr.ph.i573.i
  ...
  %shl26.i5871164.i = shl nuw nsw i32 %UNP.sroa.110.36.insert.insert889.i, 1
...
if.end24.i591.1.i:                                ; preds = %if.end24.i591.i, %if.then7.i586.1.i, %if.end24.i591.thread.i
  %UNP.sroa.110.8.1.i = phi i32 [ %UNP.sroa.110.36.insert.insert889.1.i, %if.then7.i586.1.i ], [ %shl26.i587.i, %if.end24.i591.i ], [ %shl26.i5871164.i, %if.end24.i591.thread.i ]
...
if.end24.i630.thread.i:                           ; preds = %while.body.lr.ph.i612.i
  ...
  %shl26.i6261170.i = shl nuw nsw i32 %UNP.sroa.110.36.insert.insert899.i, 1
...
if.end24.i630.1.thread.i:                         ; preds = %if.then7.i625.1.i, %if.end24.i630.thread.i
  %UNP.sroa.110.11.1.ph.i = phi i32 [ %shl26.i6261170.i, %if.end24.i630.thread.i ], [ %UNP.sroa.110.36.insert.insert899.1.i, %if.then7.i625.1.i ]
  %.ph1173.i = phi i32 [ 14, %if.end24.i630.thread.i ], [ 15, %if.then7.i625.1.i ]
  %UNP.sroa.30.11.1.ph.i = add i32 %UNP.sroa.30.8.1.i, 2
  %shl26.i626.11176.i = shl nuw nsw i32 %UNP.sroa.110.11.1.ph.i, 1
...
if.end24.i630.2.i:                                ; preds = %if.end24.i630.1.i, %if.then7.i625.2.i, %if.end24.i630.1.thread.i
  %UNP.sroa.110.11.2.i = phi i32 [ %UNP.sroa.110.36.insert.insert899.2.i, %if.then7.i625.2.i ], [ %shl26.i626.1.i, %if.end24.i630.1.i ], [ %shl26.i626.11176.i, %if.end24.i630.1.thread.i ]
  ...
  %127 = phi i32 [ 16, %if.then7.i625.2.i ], [ %dec.i627.1.i, %if.end24.i630.1.i ], [ %.ph1173.i, %if.end24.i630.1.thread.i ]
...
if.end24.i669.thread.i:                           ; preds = %while.body.lr.ph.i651.i
  ...
  %shl26.i6651182.i = shl nuw nsw i32 %UNP.sroa.110.36.insert.insert909.i, 1
...
if.end24.i669.1.thread.i:                         ; preds = %if.then7.i664.1.i, %if.end24.i669.thread.i
  %UNP.sroa.110.14.1.ph.i = phi i32 [ %shl26.i6651182.i, %if.end24.i669.thread.i ], [ %UNP.sroa.110.36.insert.insert909.1.i, %if.then7.i664.1.i ]
  %.ph1185.i = phi i32 [ 14, %if.end24.i669.thread.i ], [ 15, %if.then7.i664.1.i ]
  %UNP.sroa.30.14.1.ph.i = add i32 %UNP.sroa.30.11.2.i, 2
  %shl26.i665.11188.i = shl nuw nsw i32 %UNP.sroa.110.14.1.ph.i, 3
  br label %if.end24.i669.3.i
...
if.end24.i669.2.thread.i:                         ; preds = %if.end24.i669.i
  ...
  %144 = or i32 %142, %143
  %shl26.i665.21193.i = or i32 %141, %144
...
if.end24.i669.3.thread.i:                         ; preds = %if.then7.i664.3.i, %if.end24.i669.2.thread.i
  %UNP.sroa.110.14.3.ph.i = phi i32 [ %shl26.i665.21193.i, %if.end24.i669.2.thread.i ], [ %UNP.sroa.110.36.insert.insert909.3.i, %if.then7.i664.3.i ]
  %.ph1196.i = phi i32 [ 14, %if.end24.i669.2.thread.i ], [ 15, %if.then7.i664.3.i ]
  %UNP.sroa.30.14.3.ph.i = add i32 %UNP.sroa.30.11.2.i, 2
  %shl26.i665.31199.i = shl nuw nsw i32 %UNP.sroa.110.14.3.ph.i, 1
  br label %if.end24.i669.4.i

if.end24.i669.3.i:                                ; preds = %if.end24.i669.1.thread.i, %if.end24.i669.1.i.thread
  %UNP.sroa.110.14.2.i.ph = phi i32 [ %shl26.i665.1.i167, %if.end24.i669.1.i.thread ], [ %shl26.i665.11188.i, %if.end24.i669.1.thread.i ]
  %UNP.sroa.30.14.2.i.ph = phi i32 [ %UNP.sroa.30.11.2.i, %if.end24.i669.1.i.thread ], [ %UNP.sroa.30.14.1.ph.i, %if.end24.i669.1.thread.i ]
  %.ph170 = phi i32 [ %dec.i666.1.i168, %if.end24.i669.1.i.thread ], [ %.ph1185.i, %if.end24.i669.1.thread.i ]
  %dec.i666.3.i = add i32 %.ph170, -2
  br label %if.end24.i669.4.i

if.end24.i669.4.i:                                ; preds = %if.end24.i669.3.i, %if.end24.i669.3.i.thread, %if.end24.i669.3.thread.i
  %UNP.sroa.110.14.4.i = phi i32 [ %UNP.sroa.110.36.insert.insert909.4.i, %if.end24.i669.3.i.thread ], [ %UNP.sroa.110.14.2.i.ph, %if.end24.i669.3.i ], [ %shl26.i665.31199.i, %if.end24.i669.3.thread.i ]
  ...
  %153 = phi i32 [ 16, %if.end24.i669.3.i.thread ], [ %dec.i666.3.i, %if.end24.i669.3.i ], [ %.ph1196.i, %if.end24.i669.3.thread.i ]
...
if.end24.i708.thread.i:                           ; preds = %while.body.lr.ph.i690.i
  ...
  %shl26.i7041205.i = shl nuw nsw i32 %UNP.sroa.110.36.insert.insert919.i, 1
...
if.end24.i708.1.thread.i:                         ; preds = %if.then7.i703.1.i, %if.end24.i708.thread.i
  %UNP.sroa.110.17.1.ph.i = phi i32 [ %shl26.i7041205.i, %if.end24.i708.thread.i ], [ %UNP.sroa.110.36.insert.insert919.1.i, %if.then7.i703.1.i ]
  %.ph1208.i = phi i32 [ 14, %if.end24.i708.thread.i ], [ 15, %if.then7.i703.1.i ]
  %UNP.sroa.30.17.1.ph.i = add i32 %UNP.sroa.30.14.4.i, 2
  %shl26.i704.11211.i = shl nuw nsw i32 %UNP.sroa.110.17.1.ph.i, 1
  br label %if.end24.i708.3.i
...
if.end24.i708.2.thread.i:                         ; preds = %if.end24.i708.1.i
  ...
  %shl26.i704.21216.i = shl nuw nsw i32 %UNP.sroa.110.36.insert.insert919.2.i, 1
...
if.end24.i708.4.i.thread:                         ; preds = %if.end24.i708.2.thread.i, %if.then7.i703.3.i
  %UNP.sroa.110.17.3.ph.i = phi i32 [ %shl26.i704.21216.i, %if.end24.i708.2.thread.i ], [ %UNP.sroa.110.36.insert.insert919.3.i, %if.then7.i703.3.i ]
  %.ph1219.i = phi i32 [ 14, %if.end24.i708.2.thread.i ], [ 15, %if.then7.i703.3.i ]
  %UNP.sroa.30.17.3.ph.i = add i32 %UNP.sroa.30.14.4.i, 2
  %shl26.i704.31222.i = shl nuw nsw i32 %UNP.sroa.110.17.3.ph.i, 1
  br label %if.end24.i708.5.i

if.end24.i708.3.i:                                ; preds = %if.end24.i708.1.i, %if.end24.i708.1.i.thread, %if.end24.i708.1.thread.i
  %172 = phi i32 [ %dec.i705.1.i185, %if.end24.i708.1.i.thread ], [ %.ph1208.i, %if.end24.i708.1.thread.i ], [ %dec.i705.1.i, %if.end24.i708.1.i ]
  ...
  %UNP.sroa.110.17.2.i191 = phi i32 [ %shl26.i704.1.i184, %if.end24.i708.1.i.thread ], [ %shl26.i704.11211.i, %if.end24.i708.1.thread.i ], [ %shl26.i704.1.i, %if.end24.i708.1.i ]
...
if.end24.i708.4.thread.i:                         ; preds = %if.end24.i708.3.i
  ...
  %shl26.i704.41227.i = shl nuw nsw i32 %UNP.sroa.110.36.insert.insert919.4.i, 1
...
if.end24.i708.5.thread.i:                         ; preds = %if.then7.i703.5.i, %if.end24.i708.4.thread.i
  %UNP.sroa.110.17.5.ph.i = phi i32 [ %shl26.i704.41227.i, %if.end24.i708.4.thread.i ], [ %UNP.sroa.110.36.insert.insert919.5.i, %if.then7.i703.5.i ]
  %.ph1230.i = phi i32 [ 14, %if.end24.i708.4.thread.i ], [ 15, %if.then7.i703.5.i ]
  %UNP.sroa.30.17.5.ph.i = add i32 %UNP.sroa.30.17.2.i192, 2
  %shl26.i704.51233.i = shl nuw nsw i32 %UNP.sroa.110.17.5.ph.i, 1
  br label %if.end24.i708.6.i

if.end24.i708.5.i:                                ; preds = %if.end24.i708.3.i, %if.end24.i708.4.i.thread
  %181 = phi i32 [ %.ph1219.i, %if.end24.i708.4.i.thread ], [ %dec.i705.3.i, %if.end24.i708.3.i ]
  %UNP.sroa.30.17.4.i197 = phi i32 [ %UNP.sroa.30.17.3.ph.i, %if.end24.i708.4.i.thread ], [ %UNP.sroa.30.17.2.i192, %if.end24.i708.3.i ]
  %UNP.sroa.110.17.4.i196 = phi i32 [ %shl26.i704.31222.i, %if.end24.i708.4.i.thread ], [ %shl26.i704.3.i, %if.end24.i708.3.i ]
...
if.end24.i708.6.thread.i:                         ; preds = %if.end24.i708.5.i
  ...
  %shl26.i704.61238.i = shl nuw nsw i32 %UNP.sroa.110.36.insert.insert919.6.i, 1
  br label %if.end24.i708.7.i

if.end24.i708.6.i:                                ; preds = %if.end24.i708.5.i, %if.end24.i708.5.thread.i
  %UNP.sroa.110.17.6.i = phi i32 [ %shl26.i704.5.i, %if.end24.i708.5.i ], [ %shl26.i704.51233.i, %if.end24.i708.5.thread.i ]
  %UNP.sroa.30.17.6.i = phi i32 [ %UNP.sroa.30.17.4.i197, %if.end24.i708.5.i ], [ %UNP.sroa.30.17.5.ph.i, %if.end24.i708.5.thread.i ]
  %186 = phi i32 [ %dec.i705.5.i, %if.end24.i708.5.i ], [ %.ph1230.i, %if.end24.i708.5.thread.i ]
...
if.end24.i708.7.i:                                ; preds = %if.then7.i703.7.i, %if.end24.i708.6.i, %if.end24.i708.6.thread.i
  %UNP.sroa.110.17.7.i = phi i32 [ %UNP.sroa.110.36.insert.insert919.7.i, %if.then7.i703.7.i ], [ %shl26.i704.6.i, %if.end24.i708.6.i ], [ %shl26.i704.61238.i, %if.end24.i708.6.thread.i ]
...
if.end24.i747.thread.i:                           ; preds = %while.body.lr.ph.i729.i
  ...
  %shl26.i7431244.i = shl nuw nsw i32 %UNP.sroa.110.36.insert.insert929.i, 1
...
if.end24.i747.1.thread.i:                         ; preds = %if.then7.i742.1.i, %if.end24.i747.thread.i
  %UNP.sroa.110.21.1.ph.i = phi i32 [ %shl26.i7431244.i, %if.end24.i747.thread.i ], [ %UNP.sroa.110.36.insert.insert929.1.i, %if.then7.i742.1.i ]
  %.ph1247.i = phi i32 [ 14, %if.end24.i747.thread.i ], [ 15, %if.then7.i742.1.i ]
  %UNP.sroa.30.21.1.ph.i = add i32 %UNP.sroa.30.19.i, 2
  %shl26.i743.11250.i = shl nuw nsw i32 %UNP.sroa.110.21.1.ph.i, 1
  br label %if.end24.i747.3.i
...
if.end24.i747.2.thread.i:                         ; preds = %if.end24.i747.1.i
  ...
  %shl26.i743.21255.i = shl nuw nsw i32 %UNP.sroa.110.36.insert.insert929.2.i, 1
...
if.end24.i747.4.i.thread:                         ; preds = %if.end24.i747.2.thread.i, %if.then7.i742.3.i
  %UNP.sroa.110.21.3.ph.i = phi i32 [ %shl26.i743.21255.i, %if.end24.i747.2.thread.i ], [ %UNP.sroa.110.36.insert.insert929.3.i, %if.then7.i742.3.i ]
  %.ph1258.i = phi i32 [ 14, %if.end24.i747.2.thread.i ], [ 15, %if.then7.i742.3.i ]
  %UNP.sroa.30.21.3.ph.i = add i32 %UNP.sroa.30.19.i, 2
  %shl26.i743.31261.i = shl nuw nsw i32 %UNP.sroa.110.21.3.ph.i, 1
  br label %if.end24.i747.5.i

if.end24.i747.3.i:                                ; preds = %if.end24.i747.1.i, %if.end24.i747.1.i.thread, %if.end24.i747.1.thread.i
  %210 = phi i32 [ %dec.i744.1.i199, %if.end24.i747.1.i.thread ], [ %.ph1247.i, %if.end24.i747.1.thread.i ], [ %dec.i744.1.i, %if.end24.i747.1.i ]
  ...
  %UNP.sroa.110.21.2.i205 = phi i32 [ %shl26.i743.1.i198, %if.end24.i747.1.i.thread ], [ %shl26.i743.11250.i, %if.end24.i747.1.thread.i ], [ %shl26.i743.1.i, %if.end24.i747.1.i ]
...
if.end24.i747.4.thread.i:                         ; preds = %if.end24.i747.3.i
  ...
  %shl26.i743.41266.i = shl nuw nsw i32 %UNP.sroa.110.36.insert.insert929.4.i, 1
...
if.end24.i747.5.thread.i:                         ; preds = %if.then7.i742.5.i, %if.end24.i747.4.thread.i
  %UNP.sroa.110.21.5.ph.i = phi i32 [ %shl26.i743.41266.i, %if.end24.i747.4.thread.i ], [ %UNP.sroa.110.36.insert.insert929.5.i, %if.then7.i742.5.i ]
  %.ph1269.i = phi i32 [ 14, %if.end24.i747.4.thread.i ], [ 15, %if.then7.i742.5.i ]
  %UNP.sroa.30.21.5.ph.i = add i32 %UNP.sroa.30.21.2.i206, 2
  %shl26.i743.51272.i = shl nuw nsw i32 %UNP.sroa.110.21.5.ph.i, 1
  br label %if.end24.i747.6.i

if.end24.i747.5.i:                                ; preds = %if.end24.i747.3.i, %if.end24.i747.4.i.thread
  %219 = phi i32 [ %.ph1258.i, %if.end24.i747.4.i.thread ], [ %dec.i744.3.i, %if.end24.i747.3.i ]
  %UNP.sroa.30.21.4.i211 = phi i32 [ %UNP.sroa.30.21.3.ph.i, %if.end24.i747.4.i.thread ], [ %UNP.sroa.30.21.2.i206, %if.end24.i747.3.i ]
  %UNP.sroa.110.21.4.i210 = phi i32 [ %shl26.i743.31261.i, %if.end24.i747.4.i.thread ], [ %shl26.i743.3.i, %if.end24.i747.3.i ]
...
if.end24.i747.6.thread.i:                         ; preds = %if.end24.i747.5.i
  ...
  %shl26.i743.61277.i = shl nuw nsw i32 %UNP.sroa.110.36.insert.insert929.6.i, 1
  br label %if.end24.i747.7.i

if.end24.i747.6.i:                                ; preds = %if.end24.i747.5.i, %if.end24.i747.5.thread.i
  %UNP.sroa.110.21.6.i = phi i32 [ %shl26.i743.5.i, %if.end24.i747.5.i ], [ %shl26.i743.51272.i, %if.end24.i747.5.thread.i ]
  %UNP.sroa.30.21.6.i = phi i32 [ %UNP.sroa.30.21.4.i211, %if.end24.i747.5.i ], [ %UNP.sroa.30.21.5.ph.i, %if.end24.i747.5.thread.i ]
  %224 = phi i32 [ %dec.i744.5.i, %if.end24.i747.5.i ], [ %.ph1269.i, %if.end24.i747.5.thread.i ]
...
if.end24.i747.7.i:                                ; preds = %if.then7.i742.7.i, %if.end24.i747.6.i, %if.end24.i747.6.thread.i
  %UNP.sroa.110.21.7.i = phi i32 [ %UNP.sroa.110.36.insert.insert929.7.i, %if.then7.i742.7.i ], [ %shl26.i743.6.i, %if.end24.i747.6.i ], [ %shl26.i743.61277.i, %if.end24.i747.6.thread.i ]
...
if.end216.i:                                      ; preds = %if.end24.i747.7.i, %if.end216.sink.split.i, %if.end24.i708.7.i, %if.end24.i669.4.i, %if.end24.i630.2.i, %if.end24.i591.1.i
  ...
  %or.cond965.not.i = icmp ult i32 %231, %27
  br i1 %or.cond965.not.i, label %land.lhs.true237.i, label %while.end333.thread.i

land.lhs.true237.i:                               ; preds = %if.end216.i
  %idxprom232.i = zext i32 %UNP.sroa.21.01055.i to i64
  ...
  %or.cond966.i = and i1 %cmp247.not.i, %cmp257.i
  br i1 %or.cond966.i, label %land.lhs.true278.i, label %while.end333.thread.i

land.lhs.true278.i:                               ; preds = %land.lhs.true237.i
  %sub.i = sub i32 %UNP.sroa.21.01055.i, %retval.0.i554.i
  ...
  %or.cond967.i = and i1 %cmp290.not.i, %cmp301.i
  br i1 %or.cond967.i, label %while.body308.i.preheader, label %while.end333.thread.i

while.body308.i.preheader:                        ; preds = %land.lhs.true278.i
  %min.iters.check688 = icmp ult i32 %add218.i, 32
  br i1 %min.iters.check688, label %while.body308.i.preheader703, label %vector.scevcheck682

vector.scevcheck682:                              ; preds = %while.body308.i.preheader
  %232 = xor i32 %UNP.sroa.21.01055.i, -1
  %233 = icmp ugt i32 %231, %232
  %234 = xor i32 %sub.i, -1
  %235 = icmp ugt i32 %231, %234
  %236 = or i1 %233, %235
  br i1 %236, label %while.body308.i.preheader703, label %vector.memcheck683

vector.memcheck683:                               ; preds = %vector.scevcheck682
  %237 = add i64 %call174.i684, %idxprom232.i
  %238 = add i64 %call174.i684, %idxprom273.i
  %239 = sub i64 %237, %238
  %diff.check685 = icmp ult i64 %239, 32
  br i1 %diff.check685, label %while.body308.i.preheader703, label %vector.ph689

vector.ph689:                                     ; preds = %vector.memcheck683
  %n.vec691 = and i32 %add218.i, -32
  %ind.end692 = and i32 %add218.i, 31
  %ind.end694 = add i32 %UNP.sroa.21.01055.i, %n.vec691
  br label %vector.body697

vector.body697:                                   ; preds = %vector.body697, %vector.ph689
  %index698 = phi i32 [ 0, %vector.ph689 ], [ %index.next702, %vector.body697 ]
  %offset.idx699 = add i32 %UNP.sroa.21.01055.i, %index698
  %240 = sub i32 %offset.idx699, %retval.0.i554.i
  %241 = zext i32 %240 to i64
  %242 = getelementptr inbounds i8, ptr %call174.i, i64 %241
  %wide.load700 = load <16 x i8>, ptr %242, align 1, !tbaa !5
  %243 = getelementptr inbounds i8, ptr %242, i64 16
  %wide.load701 = load <16 x i8>, ptr %243, align 1, !tbaa !5
  %244 = zext i32 %offset.idx699 to i64
  %245 = getelementptr inbounds i8, ptr %call174.i, i64 %244
  store <16 x i8> %wide.load700, ptr %245, align 1, !tbaa !5
  %246 = getelementptr inbounds i8, ptr %245, i64 16
  store <16 x i8> %wide.load701, ptr %246, align 1, !tbaa !5
  %index.next702 = add nuw i32 %index698, 32
  %247 = icmp eq i32 %index.next702, %n.vec691
  br i1 %247, label %middle.block686, label %vector.body697, !llvm.loop !21

middle.block686:                                  ; preds = %vector.body697
  %cmp.n696 = icmp eq i32 %add218.i, %n.vec691
  br i1 %cmp.n696, label %if.end332.i, label %while.body308.i.preheader703

while.body308.i.preheader703:                     ; preds = %vector.memcheck683, %vector.scevcheck682, %while.body308.i.preheader, %middle.block686
  %bs.11050.i.ph = phi i32 [ %add218.i, %vector.memcheck683 ], [ %add218.i, %vector.scevcheck682 ], [ %add218.i, %while.body308.i.preheader ], [ %ind.end692, %middle.block686 ]
  %UNP.sroa.21.11049.i.ph = phi i32 [ %UNP.sroa.21.01055.i, %vector.memcheck683 ], [ %UNP.sroa.21.01055.i, %vector.scevcheck682 ], [ %UNP.sroa.21.01055.i, %while.body308.i.preheader ], [ %ind.end694, %middle.block686 ]
  %248 = add i32 %bs.11050.i.ph, -1
  %xtraiter794 = and i32 %bs.11050.i.ph, 3
  %lcmp.mod795.not = icmp eq i32 %xtraiter794, 0
  br i1 %lcmp.mod795.not, label %while.body308.i.prol.loopexit, label %while.body308.i.prol

while.body308.i.prol:                             ; preds = %while.body308.i.preheader703, %while.body308.i.prol
  %bs.11050.i.prol = phi i32 [ %dec.i.prol, %while.body308.i.prol ], [ %bs.11050.i.ph, %while.body308.i.preheader703 ]
  %UNP.sroa.21.11049.i.prol = phi i32 [ %inc319.i.prol, %while.body308.i.prol ], [ %UNP.sroa.21.11049.i.ph, %while.body308.i.preheader703 ]
  %prol.iter796 = phi i32 [ %prol.iter796.next, %while.body308.i.prol ], [ 0, %while.body308.i.preheader703 ]
  %dec.i.prol = add i32 %bs.11050.i.prol, -1
  %sub311.i.prol = sub i32 %UNP.sroa.21.11049.i.prol, %retval.0.i554.i
  ...
  %idxprom316.i.prol = zext i32 %UNP.sroa.21.11049.i.prol to i64
  ...
  %inc319.i.prol = add i32 %UNP.sroa.21.11049.i.prol, 1
  %prol.iter796.next = add i32 %prol.iter796, 1
  %prol.iter796.cmp.not = icmp eq i32 %prol.iter796.next, %xtraiter794
  br i1 %prol.iter796.cmp.not, label %while.body308.i.prol.loopexit, label %while.body308.i.prol, !llvm.loop !24

while.body308.i.prol.loopexit:                    ; preds = %while.body308.i.prol, %while.body308.i.preheader703
  %inc319.i.lcssa.unr = phi i32 [ undef, %while.body308.i.preheader703 ], [ %inc319.i.prol, %while.body308.i.prol ]
  %bs.11050.i.unr = phi i32 [ %bs.11050.i.ph, %while.body308.i.preheader703 ], [ %dec.i.prol, %while.body308.i.prol ]
  %UNP.sroa.21.11049.i.unr = phi i32 [ %UNP.sroa.21.11049.i.ph, %while.body308.i.preheader703 ], [ %inc319.i.prol, %while.body308.i.prol ]
...
while.body308.i:                                  ; preds = %while.body308.i.prol.loopexit, %while.body308.i
  %bs.11050.i = phi i32 [ %dec.i.3, %while.body308.i ], [ %bs.11050.i.unr, %while.body308.i.prol.loopexit ]
  %UNP.sroa.21.11049.i = phi i32 [ %inc319.i.3, %while.body308.i ], [ %UNP.sroa.21.11049.i.unr, %while.body308.i.prol.loopexit ]
  %sub311.i = sub i32 %UNP.sroa.21.11049.i, %retval.0.i554.i
  ...
  %inc319.i.1 = add i32 %UNP.sroa.21.11049.i, 2
  ...
  %inc319.i.2 = add i32 %UNP.sroa.21.11049.i, 3
  %dec.i.3 = add i32 %bs.11050.i, -4
  ...
  %inc319.i.3 = add i32 %UNP.sroa.21.11049.i, 4
...
land.lhs.true.i762.i:                             ; preds = %if.else323.i
  %.pre1083.i = sub i32 %xor78.i, %UNP.sroa.30.2.i
  %cmp4.i761.i = icmp ult i32 %.pre1083.i, 2
...
if.then.i764.i:                                   ; preds = %land.lhs.true.i762.i, %land.lhs.true.i762.thread.i
  %UNP.sroa.30.397710211288.i = phi i32 [ %UNP.sroa.30.01054.i, %land.lhs.true.i762.thread.i ], [ %UNP.sroa.30.2.i, %land.lhs.true.i762.i ]
  %UNP.sroa.93.197510241287.i = phi i32 [ 0, %land.lhs.true.i762.thread.i ], [ %dec.i.i, %land.lhs.true.i762.i ]
  %UNP.sroa.110.38.insert.mask95910261286.i = phi i32 [ %UNP.sroa.110.38.insert.mask.i, %land.lhs.true.i762.thread.i ], [ %UNP.sroa.110.38.insert.mask959.i, %land.lhs.true.i762.i ]
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.25) #13
...
if.end24.i786.thread.i:                           ; preds = %while.body.lr.ph.i768.i
  ...
  %shl26.i7821298.i = shl nuw nsw i32 %UNP.sroa.110.36.insert.insert939.i, 1
...
if.end24.i786.1.thread.i:                         ; preds = %if.then7.i781.1.i, %if.end24.i786.thread.i
  %UNP.sroa.110.25.1.ph.i = phi i32 [ %shl26.i7821298.i, %if.end24.i786.thread.i ], [ %UNP.sroa.110.36.insert.insert939.1.i, %if.then7.i781.1.i ]
  %.ph1302.i = phi i32 [ 14, %if.end24.i786.thread.i ], [ 15, %if.then7.i781.1.i ]
  %UNP.sroa.30.25.1.ph.i = add i32 %UNP.sroa.30.2.i, 2
  %shl26.i782.11306.i = shl nuw nsw i32 %UNP.sroa.110.25.1.ph.i, 1
  br label %if.end24.i786.3.i
...
if.end24.i786.2.thread.i:                         ; preds = %if.end24.i786.1.i
  ...
  %shl26.i782.21313.i = shl nuw nsw i32 %UNP.sroa.110.36.insert.insert939.2.i, 1
...
if.end24.i786.4.i.thread:                         ; preds = %if.end24.i786.2.thread.i, %if.then7.i781.3.i
  %UNP.sroa.110.25.3.ph.i = phi i32 [ %shl26.i782.21313.i, %if.end24.i786.2.thread.i ], [ %UNP.sroa.110.36.insert.insert939.3.i, %if.then7.i781.3.i ]
  %.ph1317.i = phi i32 [ 14, %if.end24.i786.2.thread.i ], [ 15, %if.then7.i781.3.i ]
  %UNP.sroa.30.25.3.ph.i = add i32 %UNP.sroa.30.2.i, 2
  %shl26.i782.31321.i = shl nuw nsw i32 %UNP.sroa.110.25.3.ph.i, 1
  br label %if.end24.i786.5.i

if.end24.i786.3.i:                                ; preds = %if.end24.i786.1.i, %if.end24.i786.1.i.thread, %if.end24.i786.1.thread.i
  %271 = phi i32 [ %dec.i783.1.i214, %if.end24.i786.1.i.thread ], [ %.ph1302.i, %if.end24.i786.1.thread.i ], [ %dec.i783.1.i, %if.end24.i786.1.i ]
  ...
  %UNP.sroa.110.25.2.i220 = phi i32 [ %shl26.i782.1.i213, %if.end24.i786.1.i.thread ], [ %shl26.i782.11306.i, %if.end24.i786.1.thread.i ], [ %shl26.i782.1.i, %if.end24.i786.1.i ]
...
if.end24.i786.4.thread.i:                         ; preds = %if.end24.i786.3.i
  ...
  %shl26.i782.41328.i = shl nuw nsw i32 %UNP.sroa.110.36.insert.insert939.4.i, 1
...
if.end24.i786.5.thread.i:                         ; preds = %if.then7.i781.5.i, %if.end24.i786.4.thread.i
  %UNP.sroa.110.25.5.ph.i = phi i32 [ %shl26.i782.41328.i, %if.end24.i786.4.thread.i ], [ %UNP.sroa.110.36.insert.insert939.5.i, %if.then7.i781.5.i ]
  %.ph1332.i = phi i32 [ 14, %if.end24.i786.4.thread.i ], [ 15, %if.then7.i781.5.i ]
  %UNP.sroa.30.25.5.ph.i = add i32 %UNP.sroa.30.25.2.i221, 2
  %shl26.i782.51336.i = shl nuw nsw i32 %UNP.sroa.110.25.5.ph.i, 1
  br label %if.end24.i786.6.i

if.end24.i786.5.i:                                ; preds = %if.end24.i786.3.i, %if.end24.i786.4.i.thread
  %280 = phi i32 [ %.ph1317.i, %if.end24.i786.4.i.thread ], [ %dec.i783.3.i, %if.end24.i786.3.i ]
  %UNP.sroa.30.25.4.i226 = phi i32 [ %UNP.sroa.30.25.3.ph.i, %if.end24.i786.4.i.thread ], [ %UNP.sroa.30.25.2.i221, %if.end24.i786.3.i ]
  %UNP.sroa.110.25.4.i225 = phi i32 [ %shl26.i782.31321.i, %if.end24.i786.4.i.thread ], [ %shl26.i782.3.i, %if.end24.i786.3.i ]
...
if.end24.i786.6.thread.i:                         ; preds = %if.end24.i786.5.i
  ...
  %shl26.i782.61343.i = shl nuw nsw i32 %UNP.sroa.110.36.insert.insert939.6.i, 1
  br label %if.end24.i786.7.i

if.end24.i786.6.i:                                ; preds = %if.end24.i786.5.i, %if.end24.i786.5.thread.i
  %UNP.sroa.110.25.6.i = phi i32 [ %shl26.i782.5.i, %if.end24.i786.5.i ], [ %shl26.i782.51336.i, %if.end24.i786.5.thread.i ]
  %UNP.sroa.30.25.6.i = phi i32 [ %UNP.sroa.30.25.4.i226, %if.end24.i786.5.i ], [ %UNP.sroa.30.25.5.ph.i, %if.end24.i786.5.thread.i ]
  %285 = phi i32 [ %dec.i783.5.i, %if.end24.i786.5.i ], [ %.ph1332.i, %if.end24.i786.5.thread.i ]
...
if.end24.i786.7.i:                                ; preds = %if.then7.i781.7.i, %if.end24.i786.6.i, %if.end24.i786.6.thread.i
  %UNP.sroa.110.25.7.i = phi i32 [ %UNP.sroa.110.36.insert.insert939.7.i, %if.then7.i781.7.i ], [ %shl26.i782.6.i, %if.end24.i786.6.i ], [ %shl26.i782.61343.i, %if.end24.i786.6.thread.i ]
...
getbits.exit789.i:                                ; preds = %if.end24.i786.7.i, %if.then.i764.i
  %UNP.sroa.93.10.i = phi i32 [ %UNP.sroa.93.197510241287.i, %if.then.i764.i ], [ %dec.i783.7.i, %if.end24.i786.7.i ]
  %UNP.sroa.110.26.i = phi i32 [ %UNP.sroa.110.38.insert.mask95910261286.i, %if.then.i764.i ], [ %shl26.i782.7.i, %if.end24.i786.7.i ]
  %UNP.sroa.30.26.i = phi i32 [ %UNP.sroa.30.397710211288.i, %if.then.i764.i ], [ %UNP.sroa.30.25.7.i, %if.end24.i786.7.i ]
  ...
  %idxprom328.i = zext i32 %UNP.sroa.21.01055.i to i64
  ...
  %inc331.i = add nuw i32 %UNP.sroa.21.01055.i, 1
  br label %if.end332.i

if.end332.i:                                      ; preds = %while.body308.i.prol.loopexit, %while.body308.i, %middle.block686, %getbits.exit789.i
  %UNP.sroa.93.11.i = phi i32 [ %UNP.sroa.93.10.i, %getbits.exit789.i ], [ %UNP.sroa.93.9.i, %middle.block686 ], [ %UNP.sroa.93.9.i, %while.body308.i ], [ %UNP.sroa.93.9.i, %while.body308.i.prol.loopexit ]
  %UNP.sroa.110.27.i = phi i32 [ %UNP.sroa.110.26.i, %getbits.exit789.i ], [ %UNP.sroa.110.23.i, %middle.block686 ], [ %UNP.sroa.110.23.i, %while.body308.i ], [ %UNP.sroa.110.23.i, %while.body308.i.prol.loopexit ]
  %UNP.sroa.30.27.i = phi i32 [ %UNP.sroa.30.26.i, %getbits.exit789.i ], [ %UNP.sroa.30.23.i, %middle.block686 ], [ %UNP.sroa.30.23.i, %while.body308.i ], [ %UNP.sroa.30.23.i, %while.body308.i.prol.loopexit ]
  %UNP.sroa.21.3.i = phi i32 [ %inc331.i, %getbits.exit789.i ], [ %ind.end694, %middle.block686 ], [ %inc319.i.lcssa.unr, %while.body308.i.prol.loopexit ], [ %inc319.i.3, %while.body308.i ]
  %UNP.sroa.159.12.i = phi i32 [ %UNP.sroa.159.11.i, %getbits.exit789.i ], [ %UNP.sroa.159.9.i, %middle.block686 ], [ %UNP.sroa.159.9.i, %while.body308.i ], [ %UNP.sroa.159.9.i, %while.body308.i.prol.loopexit ]
...
for.body.i.i:                                     ; preds = %land.end.i.i.1, %for.body.preheader.i.i.new
  ...
  %niter802 = phi i64 [ 0, %for.body.preheader.i.i.new ], [ %niter802.next.1, %land.end.i.i.1 ]
...
land.end.i.i.1:                                   ; preds = %land.rhs.i.i.1, %land.end.i.i
  ...
  %niter802.next.1 = add nuw nsw i64 %niter802, 2
  %niter802.ncmp.1.not = icmp eq i64 %niter802.next.1, %unroll_iter801
  br i1 %niter802.ncmp.1.not, label %for.end.loopexit.i.i.unr-lcssa, label %for.body.i.i, !llvm.loop !28
...
for.end.loopexit.i.i.unr-lcssa:                   ; preds = %land.end.i.i.1, %for.body.preheader.i.i
  ...
  %lcmp.mod799.not = icmp eq i64 %xtraiter797, 0
  br i1 %lcmp.mod799.not, label %for.end.loopexit.i.i, label %for.body.i.i.epil
...
u2a.exit.i:                                       ; preds = %u2a.exit.loopexit.i, %for.end.i.i, %if.end342.i, %if.end342.thread.i
  %UNP.sroa.0.01355.i = phi ptr [ %UNP.sroa.0.0.i, %for.end.i.i ], [ %UNP.sroa.0.0.i, %if.end342.i ], [ %UNP.sroa.0.0.i, %u2a.exit.loopexit.i ], [ %call174.i, %if.end342.thread.i ]
  ...
  %inc3431356.i = add i32 %files.0.ph.i, 1
  %call349.i = call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef nonnull dereferenceable(1) %tempfile.i, i64 noundef 1023, ptr noundef nonnull @.str.19, ptr noundef nonnull %call2, i32 noundef %inc3431356.i) #13
...
if.then355.i:                                     ; preds = %u2a.exit.i
  ...
  call void @free(ptr noundef %UNP.sroa.0.01355.i) #13
  br label %ea05.exit

if.end358.i:                                      ; preds = %u2a.exit.i
  %call361.i = call i32 @cli_writen(i32 noundef %call352.i, ptr noundef nonnull %UNP.sroa.0.01355.i, i32 noundef %retval.1.i.i) #13
...
while.cond.outer.i:                               ; preds = %while.cond.outer.i.backedge, %for.body.preheader.i
  %files.0.ph.i = phi i32 [ 0, %for.body.preheader.i ], [ %inc3431356.i, %while.cond.outer.i.backedge ]
...
if.end.i.i:                                       ; preds = %if.end22.i
  ...
  %or.cond1744.i = select i1 %or.cond1603.i, i1 true, i1 %tobool.not.i.i
  br i1 %or.cond1744.i, label %if.else.i.i55, label %if.end32.thread.i.i53
...
if.end.i992.i:                                    ; preds = %if.end60.i
  ...
  %or.cond1745.i = select i1 %or.cond1605.i, i1 true, i1 %tobool.not.i999.i
  br i1 %or.cond1745.i, label %if.else.i1007.i, label %if.end32.thread.i1002.i
...
for.body36.preheader.i1030.i:                     ; preds = %for.end.loopexit.i1022.i, %if.end32.thread.i1002.i
  ...
  %umax1777.i = call i64 @llvm.umax.i64(i64 %.pre-phi.i, i64 2)
  %356 = add nsw i64 %umax1777.i, -1
  %357 = lshr i64 %356, 1
  %358 = add nuw nsw i64 %357, 1
  %xtraiter782 = and i64 %358, 7
  %359 = icmp ult i64 %umax1777.i, 15
...
for.body36.i1037.i:                               ; preds = %for.body36.i1037.i, %for.body36.preheader.i1030.i.new
  ...
  %niter786 = phi i64 [ 0, %for.body36.preheader.i1030.i.new ], [ %niter786.next.7, %for.body36.i1037.i ]
  ...
  %niter786.next.7 = add i64 %niter786, 8
  %niter786.ncmp.7 = icmp eq i64 %niter786.next.7, %unroll_iter785
  br i1 %niter786.ncmp.7, label %u2a.exit1039.i.loopexit.unr-lcssa, label %for.body36.i1037.i, !llvm.loop !29
...
u2a.exit1039.i.loopexit.unr-lcssa:                ; preds = %for.body36.i1037.i, %for.body36.preheader.i1030.i
  ...
  br i1 %lcmp.mod784.not, label %u2a.exit1039.i, label %for.body36.i1037.i.epil
...
for.body36.i1037.i.epil:                          ; preds = %u2a.exit1039.i.loopexit.unr-lcssa, %for.body36.i1037.i.epil
  ...
  %epil.iter783 = phi i64 [ %epil.iter783.next, %for.body36.i1037.i.epil ], [ 0, %u2a.exit1039.i.loopexit.unr-lcssa ]
  ...
  %epil.iter783.next = add i64 %epil.iter783, 1
  %epil.iter783.cmp.not = icmp eq i64 %epil.iter783.next, %xtraiter782
  br i1 %epil.iter783.cmp.not, label %u2a.exit1039.i, label %for.body36.i1037.i.epil, !llvm.loop !31
...
if.end93.i:                                       ; preds = %if.end88.i88
  ...
  br i1 %tobool102.not.i, label %if.end93.if.end120_crit_edge.i, label %land.lhs.true103.i

if.end93.if.end120_crit_edge.i:                   ; preds = %if.end93.i
  %.pre1781.i = zext i32 %xor83.i to i64
...
land.lhs.true103.i:                               ; preds = %if.end93.i
  ...
  %tobool105.not.i = icmp ne i64 %371, 0
  %conv108.i = zext i32 %xor83.i to i64
  %cmp111.i = icmp ult i64 %371, %conv108.i
  %or.cond1606.i = and i1 %tobool105.not.i, %cmp111.i
  br i1 %or.cond1606.i, label %if.then113.i, label %if.end120.i

if.then113.i:                                     ; preds = %land.lhs.true103.i
...
if.end120.i:                                      ; preds = %land.lhs.true103.i, %if.end93.if.end120_crit_edge.i
  %conv122.pre-phi.i = phi i64 [ %.pre1781.i, %if.end93.if.end120_crit_edge.i ], [ %conv108.i, %land.lhs.true103.i ]
  %inc.i = add i32 %files.0.ph.i38, 1
  %call123.i91 = call ptr @cli_malloc(i64 noundef %conv122.pre-phi.i) #13
...
if.end143.i:                                      ; preds = %if.then138.i92
  ...
  %spec.select1607.i = select i1 %tobool153.not.i, i32 %xor83.i, i32 %or152.i
  %373 = freeze i32 %spec.select1607.i
...
land.lhs.true160.i:                               ; preds = %if.end143.i
  ...
  %or.cond1608.i = and i1 %tobool163.not.i, %cmp169.i
  br i1 %or.cond1608.i, label %if.then171.i, label %if.end172.i
...
if.end172.i:                                      ; preds = %land.lhs.true160.i, %if.end143.if.end172_crit_edge.i
  %conv174.pre-phi.i = phi i64 [ %.pre1782.i, %if.end143.if.end172_crit_edge.i ], [ %conv166.i, %land.lhs.true160.i ]
  %call175.i = call ptr @cli_malloc(i64 noundef %conv174.pre-phi.i) #13
  %call175.i678 = ptrtoint ptr %call175.i to i64
...
if.end178.i:                                      ; preds = %if.end172.i
  ...
  %cmp1851722.not.i = icmp eq i32 %373, 0
  br i1 %cmp1851722.not.i, label %if.end343.thread.i, label %while.body187.lr.ph.i
...
while.body187.i:                                  ; preds = %if.end333.i, %while.body187.lr.ph.i
  %UNP.sroa.31.01726.i = phi i32 [ 0, %while.body187.lr.ph.i ], [ %UNP.sroa.31.3.i, %if.end333.i ]
  %UNP.sroa.75.01725.i = phi i32 [ 8, %while.body187.lr.ph.i ], [ %UNP.sroa.75.27.i, %if.end333.i ]
  %UNP.sroa.178.01724.i = phi i32 [ 0, %while.body187.lr.ph.i ], [ %UNP.sroa.178.11.i, %if.end333.i ]
  %UNP.sroa.200.01723.i = phi i32 [ 0, %while.body187.lr.ph.i ], [ %UNP.sroa.200.27.i, %if.end333.i ]
  %UNP.sroa.200.38.insert.mask.i = and i32 %UNP.sroa.200.01723.i, 65535
  %cmp.i1040.i = icmp eq i32 %UNP.sroa.178.01724.i, 0
  %sub3.i.i94 = sub i32 %xor83.i, %UNP.sroa.75.01725.i
  %cmp4.i.i95 = icmp ult i32 %sub3.i.i94, 2
  %or.cond1624.i = select i1 %cmp.i1040.i, i1 %cmp4.i.i95, i1 false
  br i1 %or.cond1624.i, label %land.lhs.true.i1055.i.thread, label %while.body.i.preheader.i96
...
if.then7.i.i105:                                  ; preds = %while.body.i.preheader.i96
  %inc.i.i97 = add i32 %UNP.sroa.75.01725.i, 1
  %idxprom.i.i98 = zext i32 %UNP.sroa.75.01725.i to i64
  ...
  %inc14.i.i102 = add i32 %UNP.sroa.75.01725.i, 2
...
if.end24.i.i108:                                  ; preds = %if.then7.i.i105, %while.body.i.preheader.i96
  ...
  %UNP.sroa.75.2.i = phi i32 [ %inc14.i.i102, %if.then7.i.i105 ], [ %UNP.sroa.75.01725.i, %while.body.i.preheader.i96 ]
  %380 = phi i32 [ 16, %if.then7.i.i105 ], [ %UNP.sroa.178.01724.i, %while.body.i.preheader.i96 ]
...
land.lhs.true.i1055.i:                            ; preds = %if.then190.i
  %.pre1783.i = sub i32 %xor83.i, %UNP.sroa.75.2.i
  ...
  %cmp4.i1054.i = icmp ugt i32 %mul.i1050.i, %.pre1783.i
...
if.then.i1057.i:                                  ; preds = %land.lhs.true.i1055.i.thread, %land.lhs.true.i1055.i
  %UNP.sroa.75.316331643.i241 = phi i32 [ %UNP.sroa.75.01725.i, %land.lhs.true.i1055.i.thread ], [ %UNP.sroa.75.2.i, %land.lhs.true.i1055.i ]
  %UNP.sroa.178.116321646.i239 = phi i32 [ 0, %land.lhs.true.i1055.i.thread ], [ %dec.i.i107, %land.lhs.true.i1055.i ]
  %UNP.sroa.200.38.insert.mask15781648.i237 = phi i32 [ %UNP.sroa.200.38.insert.mask.i, %land.lhs.true.i1055.i.thread ], [ %UNP.sroa.200.38.insert.mask1578.i, %land.lhs.true.i1055.i ]
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.25) #13
...
if.end24.i1079.thread.i:                          ; preds = %while.body.lr.ph.i1061.i
  ...
  %shl26.i10751793.i = shl nuw nsw i32 %UNP.sroa.200.36.insert.insert1516.i, 1
...
if.end24.i1079.2.i.thread:                        ; preds = %if.end24.i1079.thread.i, %if.then7.i1074.1.i
  %UNP.sroa.200.5.1.ph.i = phi i32 [ %shl26.i10751793.i, %if.end24.i1079.thread.i ], [ %UNP.sroa.200.36.insert.insert1516.1.i, %if.then7.i1074.1.i ]
  %.ph.i109 = phi i32 [ 14, %if.end24.i1079.thread.i ], [ 15, %if.then7.i1074.1.i ]
  %UNP.sroa.75.5.1.ph.i = add i32 %UNP.sroa.75.2.i, 2
  %shl26.i1075.11800.i = shl nuw nsw i32 %UNP.sroa.200.5.1.ph.i, 1
...
if.end24.i1079.2.thread.i:                        ; preds = %if.end24.i1079.1.i
  ...
  %shl26.i1075.21807.i = shl nuw nsw i32 %UNP.sroa.200.36.insert.insert1516.2.i, 1
...
if.end24.i1079.4.i.thread:                        ; preds = %if.end24.i1079.2.thread.i, %if.then7.i1074.3.i
  %UNP.sroa.200.5.3.ph.i = phi i32 [ %shl26.i1075.21807.i, %if.end24.i1079.2.thread.i ], [ %UNP.sroa.200.36.insert.insert1516.3.i, %if.then7.i1074.3.i ]
  %.ph1811.i = phi i32 [ 14, %if.end24.i1079.2.thread.i ], [ 15, %if.then7.i1074.3.i ]
  %UNP.sroa.75.5.3.ph.i = add i32 %UNP.sroa.75.2.i, 2
  %shl26.i1075.31815.i = shl nuw nsw i32 %UNP.sroa.200.5.3.ph.i, 1
...
if.end24.i1079.3.i:                               ; preds = %if.end24.i1079.1.i, %if.end24.i1079.2.i.thread
  ...
  %UNP.sroa.200.5.2.i263 = phi i32 [ %shl26.i1075.11800.i, %if.end24.i1079.2.i.thread ], [ %shl26.i1075.1.i, %if.end24.i1079.1.i ]
...
if.end24.i1079.4.thread.i:                        ; preds = %if.end24.i1079.3.i
  ...
  %shl26.i1075.41822.i = shl nuw nsw i32 %UNP.sroa.200.36.insert.insert1516.4.i, 1
...
if.end24.i1079.6.i.thread:                        ; preds = %if.end24.i1079.4.thread.i, %if.then7.i1074.5.i
  %UNP.sroa.200.5.5.ph.i = phi i32 [ %shl26.i1075.41822.i, %if.end24.i1079.4.thread.i ], [ %UNP.sroa.200.36.insert.insert1516.5.i, %if.then7.i1074.5.i ]
  %.ph1826.i = phi i32 [ 14, %if.end24.i1079.4.thread.i ], [ 15, %if.then7.i1074.5.i ]
  %UNP.sroa.75.5.5.ph.i = add i32 %UNP.sroa.75.5.2.i264, 2
  %shl26.i1075.51830.i = shl nuw nsw i32 %UNP.sroa.200.5.5.ph.i, 1
  br label %if.end24.i1079.7.i

if.end24.i1079.5.i:                               ; preds = %if.end24.i1079.3.i, %if.end24.i1079.4.i.thread
  %407 = phi i32 [ %.ph1811.i, %if.end24.i1079.4.i.thread ], [ %dec.i1076.3.i, %if.end24.i1079.3.i ]
  %UNP.sroa.75.5.4.i271 = phi i32 [ %UNP.sroa.75.5.3.ph.i, %if.end24.i1079.4.i.thread ], [ %UNP.sroa.75.5.2.i264, %if.end24.i1079.3.i ]
  %UNP.sroa.200.5.4.i270 = phi i32 [ %shl26.i1075.31815.i, %if.end24.i1079.4.i.thread ], [ %shl26.i1075.3.i, %if.end24.i1079.3.i ]
...
if.end24.i1079.6.thread.i:                        ; preds = %if.end24.i1079.5.i
  ...
  %shl26.i1075.61837.i = shl nuw nsw i32 %UNP.sroa.200.36.insert.insert1516.6.i, 1
...
if.end24.i1079.8.i.thread:                        ; preds = %if.end24.i1079.6.thread.i, %if.then7.i1074.7.i
  %UNP.sroa.200.5.7.ph.i = phi i32 [ %shl26.i1075.61837.i, %if.end24.i1079.6.thread.i ], [ %UNP.sroa.200.36.insert.insert1516.7.i, %if.then7.i1074.7.i ]
  %.ph1841.i = phi i32 [ 14, %if.end24.i1079.6.thread.i ], [ 15, %if.then7.i1074.7.i ]
  %UNP.sroa.75.5.7.ph.i = add i32 %UNP.sroa.75.5.4.i271, 2
  %shl26.i1075.71845.i = shl nuw nsw i32 %UNP.sroa.200.5.7.ph.i, 1
  br label %if.end24.i1079.9.i

if.end24.i1079.7.i:                               ; preds = %if.end24.i1079.5.i, %if.end24.i1079.6.i.thread
  %416 = phi i32 [ %.ph1826.i, %if.end24.i1079.6.i.thread ], [ %dec.i1076.5.i, %if.end24.i1079.5.i ]
  %UNP.sroa.75.5.6.i278 = phi i32 [ %UNP.sroa.75.5.5.ph.i, %if.end24.i1079.6.i.thread ], [ %UNP.sroa.75.5.4.i271, %if.end24.i1079.5.i ]
  %UNP.sroa.200.5.6.i277 = phi i32 [ %shl26.i1075.51830.i, %if.end24.i1079.6.i.thread ], [ %shl26.i1075.5.i, %if.end24.i1079.5.i ]
...
if.end24.i1079.8.thread.i:                        ; preds = %if.end24.i1079.7.i
  ...
  %shl26.i1075.81852.i = shl nuw nsw i32 %UNP.sroa.200.36.insert.insert1516.8.i, 1
...
if.end24.i1079.10.i.thread:                       ; preds = %if.end24.i1079.8.thread.i, %if.then7.i1074.9.i
  %UNP.sroa.200.5.9.ph.i = phi i32 [ %shl26.i1075.81852.i, %if.end24.i1079.8.thread.i ], [ %UNP.sroa.200.36.insert.insert1516.9.i, %if.then7.i1074.9.i ]
  %.ph1856.i = phi i32 [ 14, %if.end24.i1079.8.thread.i ], [ 15, %if.then7.i1074.9.i ]
  %UNP.sroa.75.5.9.ph.i = add i32 %UNP.sroa.75.5.6.i278, 2
  %shl26.i1075.91860.i = shl nuw nsw i32 %UNP.sroa.200.5.9.ph.i, 1
  br label %if.end24.i1079.11.i

if.end24.i1079.9.i:                               ; preds = %if.end24.i1079.7.i, %if.end24.i1079.8.i.thread
  %425 = phi i32 [ %.ph1841.i, %if.end24.i1079.8.i.thread ], [ %dec.i1076.7.i, %if.end24.i1079.7.i ]
  %UNP.sroa.75.5.8.i285 = phi i32 [ %UNP.sroa.75.5.7.ph.i, %if.end24.i1079.8.i.thread ], [ %UNP.sroa.75.5.6.i278, %if.end24.i1079.7.i ]
  %UNP.sroa.200.5.8.i284 = phi i32 [ %shl26.i1075.71845.i, %if.end24.i1079.8.i.thread ], [ %shl26.i1075.7.i, %if.end24.i1079.7.i ]
...
if.end24.i1079.10.thread.i:                       ; preds = %if.end24.i1079.9.i
  ...
  %shl26.i1075.101867.i = shl nuw nsw i32 %UNP.sroa.200.36.insert.insert1516.10.i, 1
...
if.end24.i1079.12.i.thread:                       ; preds = %if.end24.i1079.10.thread.i, %if.then7.i1074.11.i
  %UNP.sroa.200.5.11.ph.i = phi i32 [ %shl26.i1075.101867.i, %if.end24.i1079.10.thread.i ], [ %UNP.sroa.200.36.insert.insert1516.11.i, %if.then7.i1074.11.i ]
  %.ph1871.i = phi i32 [ 14, %if.end24.i1079.10.thread.i ], [ 15, %if.then7.i1074.11.i ]
  %UNP.sroa.75.5.11.ph.i = add i32 %UNP.sroa.75.5.8.i285, 2
  %shl26.i1075.111875.i = shl nuw nsw i32 %UNP.sroa.200.5.11.ph.i, 1
  br label %if.end24.i1079.13.i

if.end24.i1079.11.i:                              ; preds = %if.end24.i1079.9.i, %if.end24.i1079.10.i.thread
  %434 = phi i32 [ %.ph1856.i, %if.end24.i1079.10.i.thread ], [ %dec.i1076.9.i, %if.end24.i1079.9.i ]
  %UNP.sroa.75.5.10.i292 = phi i32 [ %UNP.sroa.75.5.9.ph.i, %if.end24.i1079.10.i.thread ], [ %UNP.sroa.75.5.8.i285, %if.end24.i1079.9.i ]
  %UNP.sroa.200.5.10.i291 = phi i32 [ %shl26.i1075.91860.i, %if.end24.i1079.10.i.thread ], [ %shl26.i1075.9.i, %if.end24.i1079.9.i ]
...
if.end24.i1079.12.thread.i:                       ; preds = %if.end24.i1079.11.i
  ...
  %shl26.i1075.121882.i = shl nuw nsw i32 %UNP.sroa.200.36.insert.insert1516.12.i, 1
...
if.end24.i1079.13.thread.i:                       ; preds = %if.then7.i1074.13.i, %if.end24.i1079.12.thread.i
  %UNP.sroa.200.5.13.ph.i = phi i32 [ %shl26.i1075.121882.i, %if.end24.i1079.12.thread.i ], [ %UNP.sroa.200.36.insert.insert1516.13.i, %if.then7.i1074.13.i ]
  %.ph1886.i = phi i32 [ 14, %if.end24.i1079.12.thread.i ], [ 15, %if.then7.i1074.13.i ]
  %UNP.sroa.75.5.13.ph.i = add i32 %UNP.sroa.75.5.10.i292, 2
  %shl26.i1075.131890.i = shl nuw nsw i32 %UNP.sroa.200.5.13.ph.i, 1
  br label %if.end24.i1079.14.i

if.end24.i1079.13.i:                              ; preds = %if.end24.i1079.11.i, %if.end24.i1079.12.i.thread
  %443 = phi i32 [ %.ph1871.i, %if.end24.i1079.12.i.thread ], [ %dec.i1076.11.i, %if.end24.i1079.11.i ]
  %UNP.sroa.75.5.12.i299 = phi i32 [ %UNP.sroa.75.5.11.ph.i, %if.end24.i1079.12.i.thread ], [ %UNP.sroa.75.5.10.i292, %if.end24.i1079.11.i ]
  %UNP.sroa.200.5.12.i298 = phi i32 [ %shl26.i1075.111875.i, %if.end24.i1079.12.i.thread ], [ %shl26.i1075.11.i, %if.end24.i1079.11.i ]
...
if.end24.i1079.14.i:                              ; preds = %if.then7.i1074.14.i, %if.end24.i1079.13.i, %if.end24.i1079.13.thread.i
  %UNP.sroa.200.5.14.i = phi i32 [ %UNP.sroa.200.36.insert.insert1516.14.i, %if.then7.i1074.14.i ], [ %shl26.i1075.13.i, %if.end24.i1079.13.i ], [ %shl26.i1075.131890.i, %if.end24.i1079.13.thread.i ]
  ...
  %448 = phi i32 [ 16, %if.then7.i1074.14.i ], [ %dec.i1076.13.i, %if.end24.i1079.13.i ], [ %.ph1886.i, %if.end24.i1079.13.thread.i ]
...
getbits.exit1082.i:                               ; preds = %if.end24.i1079.14.i, %if.then.i1057.i
  %UNP.sroa.200.6.i = phi i32 [ %UNP.sroa.200.38.insert.mask15781648.i237, %if.then.i1057.i ], [ %shl26.i1075.14.i, %if.end24.i1079.14.i ]
  %UNP.sroa.178.2.i = phi i32 [ %UNP.sroa.178.116321646.i239, %if.then.i1057.i ], [ %dec.i1076.14.i, %if.end24.i1079.14.i ]
  %UNP.sroa.75.6.i = phi i32 [ %UNP.sroa.75.316331643.i241, %if.then.i1057.i ], [ %UNP.sroa.75.5.14.i, %if.end24.i1079.14.i ]
...
if.end24.i1118.thread.i:                          ; preds = %while.body.lr.ph.i1100.i
  ...
  %shl26.i11141897.i = shl nuw nsw i32 %UNP.sroa.200.36.insert.insert1526.i, 1
...
if.end24.i1118.1.i:                               ; preds = %if.end24.i1118.i, %if.then7.i1113.1.i, %if.end24.i1118.thread.i
  %UNP.sroa.200.8.1.i = phi i32 [ %UNP.sroa.200.36.insert.insert1526.1.i, %if.then7.i1113.1.i ], [ %shl26.i1114.i, %if.end24.i1118.i ], [ %shl26.i11141897.i, %if.end24.i1118.thread.i ]
...
if.end24.i1157.thread.i:                          ; preds = %while.body.lr.ph.i1139.i
  ...
  %shl26.i11531903.i = shl nuw nsw i32 %UNP.sroa.200.36.insert.insert1536.i, 1
...
if.end24.i1157.1.thread.i:                        ; preds = %if.then7.i1152.1.i, %if.end24.i1157.thread.i
  %UNP.sroa.200.11.1.ph.i = phi i32 [ %shl26.i11531903.i, %if.end24.i1157.thread.i ], [ %UNP.sroa.200.36.insert.insert1536.1.i, %if.then7.i1152.1.i ]
  %.ph1906.i = phi i32 [ 14, %if.end24.i1157.thread.i ], [ 15, %if.then7.i1152.1.i ]
  %UNP.sroa.75.11.1.ph.i = add i32 %UNP.sroa.75.8.1.i, 2
  %shl26.i1153.11909.i = shl nuw nsw i32 %UNP.sroa.200.11.1.ph.i, 1
...
if.end24.i1157.2.i:                               ; preds = %if.end24.i1157.1.i, %if.then7.i1152.2.i, %if.end24.i1157.1.thread.i
  %UNP.sroa.200.11.2.i = phi i32 [ %UNP.sroa.200.36.insert.insert1536.2.i, %if.then7.i1152.2.i ], [ %shl26.i1153.1.i, %if.end24.i1157.1.i ], [ %shl26.i1153.11909.i, %if.end24.i1157.1.thread.i ]
  ...
  %473 = phi i32 [ 16, %if.then7.i1152.2.i ], [ %dec.i1154.1.i, %if.end24.i1157.1.i ], [ %.ph1906.i, %if.end24.i1157.1.thread.i ]
...
if.end24.i1196.thread.i:                          ; preds = %while.body.lr.ph.i1178.i
  ...
  %shl26.i11921915.i = shl nuw nsw i32 %UNP.sroa.200.36.insert.insert1546.i, 1
...
if.end24.i1196.1.thread.i:                        ; preds = %if.then7.i1191.1.i, %if.end24.i1196.thread.i
  %UNP.sroa.200.14.1.ph.i = phi i32 [ %shl26.i11921915.i, %if.end24.i1196.thread.i ], [ %UNP.sroa.200.36.insert.insert1546.1.i, %if.then7.i1191.1.i ]
  %.ph1918.i = phi i32 [ 14, %if.end24.i1196.thread.i ], [ 15, %if.then7.i1191.1.i ]
  %UNP.sroa.75.14.1.ph.i = add i32 %UNP.sroa.75.11.2.i, 2
  %shl26.i1192.11921.i = shl nuw nsw i32 %UNP.sroa.200.14.1.ph.i, 3
  br label %if.end24.i1196.3.i
...
if.end24.i1196.2.thread.i:                        ; preds = %if.end24.i1196.i
  ...
  %490 = or i32 %488, %489
  %shl26.i1192.21926.i = or i32 %487, %490
...
if.end24.i1196.3.thread.i:                        ; preds = %if.then7.i1191.3.i, %if.end24.i1196.2.thread.i
  %UNP.sroa.200.14.3.ph.i = phi i32 [ %shl26.i1192.21926.i, %if.end24.i1196.2.thread.i ], [ %UNP.sroa.200.36.insert.insert1546.3.i, %if.then7.i1191.3.i ]
  %.ph1929.i = phi i32 [ 14, %if.end24.i1196.2.thread.i ], [ 15, %if.then7.i1191.3.i ]
  %UNP.sroa.75.14.3.ph.i = add i32 %UNP.sroa.75.11.2.i, 2
  %shl26.i1192.31932.i = shl nuw nsw i32 %UNP.sroa.200.14.3.ph.i, 1
  br label %if.end24.i1196.4.i

if.end24.i1196.3.i:                               ; preds = %if.end24.i1196.1.thread.i, %if.end24.i1196.1.i.thread
  %UNP.sroa.200.14.2.i.ph = phi i32 [ %shl26.i1192.1.i310, %if.end24.i1196.1.i.thread ], [ %shl26.i1192.11921.i, %if.end24.i1196.1.thread.i ]
  ...
  %.ph313 = phi i32 [ %dec.i1193.1.i311, %if.end24.i1196.1.i.thread ], [ %.ph1918.i, %if.end24.i1196.1.thread.i ]
...
if.end24.i1196.4.i:                               ; preds = %if.end24.i1196.3.i, %if.end24.i1196.3.i.thread, %if.end24.i1196.3.thread.i
  %UNP.sroa.200.14.4.i = phi i32 [ %UNP.sroa.200.36.insert.insert1546.4.i, %if.end24.i1196.3.i.thread ], [ %UNP.sroa.200.14.2.i.ph, %if.end24.i1196.3.i ], [ %shl26.i1192.31932.i, %if.end24.i1196.3.thread.i ]
  ...
  %499 = phi i32 [ 16, %if.end24.i1196.3.i.thread ], [ %dec.i1193.3.i, %if.end24.i1196.3.i ], [ %.ph1929.i, %if.end24.i1196.3.thread.i ]
...
if.end24.i1235.thread.i:                          ; preds = %while.body.lr.ph.i1217.i
  ...
  %shl26.i12311938.i = shl nuw nsw i32 %UNP.sroa.200.36.insert.insert1556.i, 1
...
if.end24.i1235.1.thread.i:                        ; preds = %if.then7.i1230.1.i, %if.end24.i1235.thread.i
  %UNP.sroa.200.17.1.ph.i = phi i32 [ %shl26.i12311938.i, %if.end24.i1235.thread.i ], [ %UNP.sroa.200.36.insert.insert1556.1.i, %if.then7.i1230.1.i ]
  %.ph1941.i = phi i32 [ 14, %if.end24.i1235.thread.i ], [ 15, %if.then7.i1230.1.i ]
  %UNP.sroa.75.17.1.ph.i = add i32 %UNP.sroa.75.14.4.i, 2
  %shl26.i1231.11944.i = shl nuw nsw i32 %UNP.sroa.200.17.1.ph.i, 1
  br label %if.end24.i1235.3.i
...
if.end24.i1235.2.thread.i:                        ; preds = %if.end24.i1235.1.i
  ...
  %shl26.i1231.21949.i = shl nuw nsw i32 %UNP.sroa.200.36.insert.insert1556.2.i, 1
...
if.end24.i1235.4.i.thread:                        ; preds = %if.end24.i1235.2.thread.i, %if.then7.i1230.3.i
  %UNP.sroa.200.17.3.ph.i = phi i32 [ %shl26.i1231.21949.i, %if.end24.i1235.2.thread.i ], [ %UNP.sroa.200.36.insert.insert1556.3.i, %if.then7.i1230.3.i ]
  %.ph1952.i = phi i32 [ 14, %if.end24.i1235.2.thread.i ], [ 15, %if.then7.i1230.3.i ]
  %UNP.sroa.75.17.3.ph.i = add i32 %UNP.sroa.75.14.4.i, 2
  %shl26.i1231.31955.i = shl nuw nsw i32 %UNP.sroa.200.17.3.ph.i, 1
...
if.end24.i1235.3.i:                               ; preds = %if.end24.i1235.1.i, %if.end24.i1235.1.i.thread, %if.end24.i1235.1.thread.i
  %518 = phi i32 [ %dec.i1232.1.i328, %if.end24.i1235.1.i.thread ], [ %.ph1941.i, %if.end24.i1235.1.thread.i ], [ %dec.i1232.1.i, %if.end24.i1235.1.i ]
  ...
  %UNP.sroa.200.17.2.i334 = phi i32 [ %shl26.i1231.1.i327, %if.end24.i1235.1.i.thread ], [ %shl26.i1231.11944.i, %if.end24.i1235.1.thread.i ], [ %shl26.i1231.1.i, %if.end24.i1235.1.i ]
...
if.end24.i1235.4.thread.i:                        ; preds = %if.end24.i1235.3.i
  ...
  %shl26.i1231.41960.i = shl nuw nsw i32 %UNP.sroa.200.36.insert.insert1556.4.i, 1
...
if.end24.i1235.5.thread.i:                        ; preds = %if.then7.i1230.5.i, %if.end24.i1235.4.thread.i
  %UNP.sroa.200.17.5.ph.i = phi i32 [ %shl26.i1231.41960.i, %if.end24.i1235.4.thread.i ], [ %UNP.sroa.200.36.insert.insert1556.5.i, %if.then7.i1230.5.i ]
  %.ph1963.i = phi i32 [ 14, %if.end24.i1235.4.thread.i ], [ 15, %if.then7.i1230.5.i ]
  %UNP.sroa.75.17.5.ph.i = add i32 %UNP.sroa.75.17.2.i335, 2
  %shl26.i1231.51966.i = shl nuw nsw i32 %UNP.sroa.200.17.5.ph.i, 1
  br label %if.end24.i1235.6.i

if.end24.i1235.5.i:                               ; preds = %if.end24.i1235.3.i, %if.end24.i1235.4.i.thread
  %527 = phi i32 [ %.ph1952.i, %if.end24.i1235.4.i.thread ], [ %dec.i1232.3.i, %if.end24.i1235.3.i ]
  %UNP.sroa.75.17.4.i340 = phi i32 [ %UNP.sroa.75.17.3.ph.i, %if.end24.i1235.4.i.thread ], [ %UNP.sroa.75.17.2.i335, %if.end24.i1235.3.i ]
  %UNP.sroa.200.17.4.i339 = phi i32 [ %shl26.i1231.31955.i, %if.end24.i1235.4.i.thread ], [ %shl26.i1231.3.i, %if.end24.i1235.3.i ]
...
if.end24.i1235.6.thread.i:                        ; preds = %if.end24.i1235.5.i
  ...
  %shl26.i1231.61971.i = shl nuw nsw i32 %UNP.sroa.200.36.insert.insert1556.6.i, 1
  br label %if.end24.i1235.7.i

if.end24.i1235.6.i:                               ; preds = %if.end24.i1235.5.i, %if.end24.i1235.5.thread.i
  %UNP.sroa.200.17.6.i = phi i32 [ %shl26.i1231.5.i, %if.end24.i1235.5.i ], [ %shl26.i1231.51966.i, %if.end24.i1235.5.thread.i ]
  %UNP.sroa.75.17.6.i = phi i32 [ %UNP.sroa.75.17.4.i340, %if.end24.i1235.5.i ], [ %UNP.sroa.75.17.5.ph.i, %if.end24.i1235.5.thread.i ]
  %532 = phi i32 [ %dec.i1232.5.i, %if.end24.i1235.5.i ], [ %.ph1963.i, %if.end24.i1235.5.thread.i ]
...
if.end24.i1235.7.i:                               ; preds = %if.then7.i1230.7.i, %if.end24.i1235.6.i, %if.end24.i1235.6.thread.i
  %UNP.sroa.200.17.7.i = phi i32 [ %UNP.sroa.200.36.insert.insert1556.7.i, %if.then7.i1230.7.i ], [ %shl26.i1231.6.i, %if.end24.i1235.6.i ], [ %shl26.i1231.61971.i, %if.end24.i1235.6.thread.i ]
...
if.end24.i1274.thread.i:                          ; preds = %while.body.lr.ph.i1256.i
  ...
  %shl26.i12701977.i = shl nuw nsw i32 %UNP.sroa.200.36.insert.insert1566.i, 1
...
if.end24.i1274.1.thread.i:                        ; preds = %if.then7.i1269.1.i, %if.end24.i1274.thread.i
  %UNP.sroa.200.21.1.ph.i = phi i32 [ %shl26.i12701977.i, %if.end24.i1274.thread.i ], [ %UNP.sroa.200.36.insert.insert1566.1.i, %if.then7.i1269.1.i ]
  %.ph1980.i = phi i32 [ 14, %if.end24.i1274.thread.i ], [ 15, %if.then7.i1269.1.i ]
  %UNP.sroa.75.21.1.ph.i = add i32 %UNP.sroa.75.19.i, 2
  %shl26.i1270.11983.i = shl nuw nsw i32 %UNP.sroa.200.21.1.ph.i, 1
  br label %if.end24.i1274.3.i
...
if.end24.i1274.2.thread.i:                        ; preds = %if.end24.i1274.1.i
  ...
  %shl26.i1270.21988.i = shl nuw nsw i32 %UNP.sroa.200.36.insert.insert1566.2.i, 1
...
if.end24.i1274.4.i.thread:                        ; preds = %if.end24.i1274.2.thread.i, %if.then7.i1269.3.i
  %UNP.sroa.200.21.3.ph.i = phi i32 [ %shl26.i1270.21988.i, %if.end24.i1274.2.thread.i ], [ %UNP.sroa.200.36.insert.insert1566.3.i, %if.then7.i1269.3.i ]
  %.ph1991.i = phi i32 [ 14, %if.end24.i1274.2.thread.i ], [ 15, %if.then7.i1269.3.i ]
  %UNP.sroa.75.21.3.ph.i = add i32 %UNP.sroa.75.19.i, 2
  %shl26.i1270.31994.i = shl nuw nsw i32 %UNP.sroa.200.21.3.ph.i, 1
...
if.end24.i1274.3.i:                               ; preds = %if.end24.i1274.1.i, %if.end24.i1274.1.i.thread, %if.end24.i1274.1.thread.i
  %556 = phi i32 [ %dec.i1271.1.i342, %if.end24.i1274.1.i.thread ], [ %.ph1980.i, %if.end24.i1274.1.thread.i ], [ %dec.i1271.1.i, %if.end24.i1274.1.i ]
  ...
  %UNP.sroa.200.21.2.i348 = phi i32 [ %shl26.i1270.1.i341, %if.end24.i1274.1.i.thread ], [ %shl26.i1270.11983.i, %if.end24.i1274.1.thread.i ], [ %shl26.i1270.1.i, %if.end24.i1274.1.i ]
...
if.end24.i1274.4.thread.i:                        ; preds = %if.end24.i1274.3.i
  ...
  %shl26.i1270.41999.i = shl nuw nsw i32 %UNP.sroa.200.36.insert.insert1566.4.i, 1
...
if.end24.i1274.5.thread.i:                        ; preds = %if.then7.i1269.5.i, %if.end24.i1274.4.thread.i
  %UNP.sroa.200.21.5.ph.i = phi i32 [ %shl26.i1270.41999.i, %if.end24.i1274.4.thread.i ], [ %UNP.sroa.200.36.insert.insert1566.5.i, %if.then7.i1269.5.i ]
  %.ph2002.i = phi i32 [ 14, %if.end24.i1274.4.thread.i ], [ 15, %if.then7.i1269.5.i ]
  %UNP.sroa.75.21.5.ph.i = add i32 %UNP.sroa.75.21.2.i349, 2
  %shl26.i1270.52005.i = shl nuw nsw i32 %UNP.sroa.200.21.5.ph.i, 1
  br label %if.end24.i1274.6.i

if.end24.i1274.5.i:                               ; preds = %if.end24.i1274.3.i, %if.end24.i1274.4.i.thread
  %565 = phi i32 [ %.ph1991.i, %if.end24.i1274.4.i.thread ], [ %dec.i1271.3.i, %if.end24.i1274.3.i ]
  %UNP.sroa.75.21.4.i354 = phi i32 [ %UNP.sroa.75.21.3.ph.i, %if.end24.i1274.4.i.thread ], [ %UNP.sroa.75.21.2.i349, %if.end24.i1274.3.i ]
  %UNP.sroa.200.21.4.i353 = phi i32 [ %shl26.i1270.31994.i, %if.end24.i1274.4.i.thread ], [ %shl26.i1270.3.i, %if.end24.i1274.3.i ]
...
if.end24.i1274.6.thread.i:                        ; preds = %if.end24.i1274.5.i
  ...
  %shl26.i1270.62010.i = shl nuw nsw i32 %UNP.sroa.200.36.insert.insert1566.6.i, 1
  br label %if.end24.i1274.7.i

if.end24.i1274.6.i:                               ; preds = %if.end24.i1274.5.i, %if.end24.i1274.5.thread.i
  %UNP.sroa.200.21.6.i = phi i32 [ %shl26.i1270.5.i, %if.end24.i1274.5.i ], [ %shl26.i1270.52005.i, %if.end24.i1274.5.thread.i ]
  %UNP.sroa.75.21.6.i = phi i32 [ %UNP.sroa.75.21.4.i354, %if.end24.i1274.5.i ], [ %UNP.sroa.75.21.5.ph.i, %if.end24.i1274.5.thread.i ]
  %570 = phi i32 [ %dec.i1271.5.i, %if.end24.i1274.5.i ], [ %.ph2002.i, %if.end24.i1274.5.thread.i ]
...
if.end24.i1274.7.i:                               ; preds = %if.then7.i1269.7.i, %if.end24.i1274.6.i, %if.end24.i1274.6.thread.i
  %UNP.sroa.200.21.7.i = phi i32 [ %UNP.sroa.200.36.insert.insert1566.7.i, %if.then7.i1269.7.i ], [ %shl26.i1270.6.i, %if.end24.i1274.6.i ], [ %shl26.i1270.62010.i, %if.end24.i1274.6.thread.i ]
...
if.end217.i:                                      ; preds = %if.end24.i1274.7.i, %if.end217.sink.split.i, %if.end24.i1235.7.i, %if.end24.i1196.4.i, %if.end24.i1157.2.i, %if.end24.i1118.1.i
  ...
  %or.cond1609.not.i = icmp ult i32 %577, %373
  br i1 %or.cond1609.not.i, label %land.lhs.true238.i, label %while.end334.thread.i

land.lhs.true238.i:                               ; preds = %if.end217.i
  %idxprom233.i = zext i32 %UNP.sroa.31.01726.i to i64
  ...
  %or.cond1610.i = and i1 %cmp248.not.i, %cmp258.i
  br i1 %or.cond1610.i, label %land.lhs.true279.i, label %while.end334.thread.i

land.lhs.true279.i:                               ; preds = %land.lhs.true238.i
  %sub.i116 = sub i32 %UNP.sroa.31.01726.i, %retval.0.i1081.i
  ...
  %or.cond1611.i = and i1 %cmp291.not.i, %cmp302.i
  br i1 %or.cond1611.i, label %while.body309.i.preheader, label %while.end334.thread.i

while.body309.i.preheader:                        ; preds = %land.lhs.true279.i
  %min.iters.check = icmp ult i32 %add219.i, 32
  br i1 %min.iters.check, label %while.body309.i.preheader726, label %vector.scevcheck

vector.scevcheck:                                 ; preds = %while.body309.i.preheader
  %578 = xor i32 %UNP.sroa.31.01726.i, -1
  %579 = icmp ugt i32 %577, %578
  %580 = xor i32 %sub.i116, -1
  %581 = icmp ugt i32 %577, %580
  %582 = or i1 %579, %581
  br i1 %582, label %while.body309.i.preheader726, label %vector.memcheck

vector.memcheck:                                  ; preds = %vector.scevcheck
  %583 = add i64 %call175.i678, %idxprom233.i
  %584 = add i64 %call175.i678, %idxprom274.i
  %585 = sub i64 %583, %584
  %diff.check = icmp ult i64 %585, 32
  br i1 %diff.check, label %while.body309.i.preheader726, label %vector.ph

vector.ph:                                        ; preds = %vector.memcheck
  %n.vec = and i32 %add219.i, -32
  %ind.end = and i32 %add219.i, 31
  %ind.end679 = add i32 %UNP.sroa.31.01726.i, %n.vec
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i32 [ 0, %vector.ph ], [ %index.next, %vector.body ]
  %offset.idx = add i32 %UNP.sroa.31.01726.i, %index
  ...
  %wide.load681 = load <16 x i8>, ptr %589, align 1, !tbaa !5
  ...
  store <16 x i8> %wide.load681, ptr %592, align 1, !tbaa !5
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %if.end333.i, label %while.body309.i.preheader726

while.body309.i.preheader726:                     ; preds = %vector.memcheck, %vector.scevcheck, %while.body309.i.preheader, %middle.block
  %bs.11721.i.ph = phi i32 [ %add219.i, %vector.memcheck ], [ %add219.i, %vector.scevcheck ], [ %add219.i, %while.body309.i.preheader ], [ %ind.end, %middle.block ]
  %UNP.sroa.31.11720.i.ph = phi i32 [ %UNP.sroa.31.01726.i, %vector.memcheck ], [ %UNP.sroa.31.01726.i, %vector.scevcheck ], [ %UNP.sroa.31.01726.i, %while.body309.i.preheader ], [ %ind.end679, %middle.block ]
  %594 = add i32 %bs.11721.i.ph, -1
  %xtraiter787 = and i32 %bs.11721.i.ph, 3
  %lcmp.mod788.not = icmp eq i32 %xtraiter787, 0
  br i1 %lcmp.mod788.not, label %while.body309.i.prol.loopexit, label %while.body309.i.prol

while.body309.i.prol:                             ; preds = %while.body309.i.preheader726, %while.body309.i.prol
  %bs.11721.i.prol = phi i32 [ %dec.i117.prol, %while.body309.i.prol ], [ %bs.11721.i.ph, %while.body309.i.preheader726 ]
  %UNP.sroa.31.11720.i.prol = phi i32 [ %inc320.i.prol, %while.body309.i.prol ], [ %UNP.sroa.31.11720.i.ph, %while.body309.i.preheader726 ]
  %prol.iter = phi i32 [ %prol.iter.next, %while.body309.i.prol ], [ 0, %while.body309.i.preheader726 ]
  %dec.i117.prol = add i32 %bs.11721.i.prol, -1
  %sub312.i.prol = sub i32 %UNP.sroa.31.11720.i.prol, %retval.0.i1081.i
  ...
  %idxprom317.i.prol = zext i32 %UNP.sroa.31.11720.i.prol to i64
  ...
  %inc320.i.prol = add i32 %UNP.sroa.31.11720.i.prol, 1
  %prol.iter.next = add i32 %prol.iter, 1
  %prol.iter.cmp.not = icmp eq i32 %prol.iter.next, %xtraiter787
  br i1 %prol.iter.cmp.not, label %while.body309.i.prol.loopexit, label %while.body309.i.prol, !llvm.loop !35

while.body309.i.prol.loopexit:                    ; preds = %while.body309.i.prol, %while.body309.i.preheader726
  %inc320.i.lcssa.unr = phi i32 [ undef, %while.body309.i.preheader726 ], [ %inc320.i.prol, %while.body309.i.prol ]
  %bs.11721.i.unr = phi i32 [ %bs.11721.i.ph, %while.body309.i.preheader726 ], [ %dec.i117.prol, %while.body309.i.prol ]
  %UNP.sroa.31.11720.i.unr = phi i32 [ %UNP.sroa.31.11720.i.ph, %while.body309.i.preheader726 ], [ %inc320.i.prol, %while.body309.i.prol ]
...
while.body309.i:                                  ; preds = %while.body309.i.prol.loopexit, %while.body309.i
  %bs.11721.i = phi i32 [ %dec.i117.3, %while.body309.i ], [ %bs.11721.i.unr, %while.body309.i.prol.loopexit ]
  %UNP.sroa.31.11720.i = phi i32 [ %inc320.i.3, %while.body309.i ], [ %UNP.sroa.31.11720.i.unr, %while.body309.i.prol.loopexit ]
  %sub312.i = sub i32 %UNP.sroa.31.11720.i, %retval.0.i1081.i
  ...
  %inc320.i.1 = add i32 %UNP.sroa.31.11720.i, 2
  ...
  %inc320.i.2 = add i32 %UNP.sroa.31.11720.i, 3
  %dec.i117.3 = add i32 %bs.11721.i, -4
  ...
  %inc320.i.3 = add i32 %UNP.sroa.31.11720.i, 4
...
if.end24.i1313.thread.i:                          ; preds = %while.body.lr.ph.i1295.i
  ...
  %shl26.i13092016.i = shl nuw nsw i32 %UNP.sroa.200.36.insert.insert1576.i, 1
...
if.end24.i1313.1.thread.i:                        ; preds = %if.then7.i1308.1.i, %if.end24.i1313.thread.i
  %UNP.sroa.200.25.1.ph.i = phi i32 [ %shl26.i13092016.i, %if.end24.i1313.thread.i ], [ %UNP.sroa.200.36.insert.insert1576.1.i, %if.then7.i1308.1.i ]
  %.ph2019.i = phi i32 [ 14, %if.end24.i1313.thread.i ], [ 15, %if.then7.i1308.1.i ]
  %UNP.sroa.75.25.1.ph.i = add i32 %UNP.sroa.75.2.i, 2
  %shl26.i1309.12022.i = shl nuw nsw i32 %UNP.sroa.200.25.1.ph.i, 1
  br label %if.end24.i1313.3.i
...
if.end24.i1313.2.thread.i:                        ; preds = %if.end24.i1313.1.i
  ...
  %shl26.i1309.22027.i = shl nuw nsw i32 %UNP.sroa.200.36.insert.insert1576.2.i, 1
...
if.end24.i1313.4.i.thread:                        ; preds = %if.end24.i1313.2.thread.i, %if.then7.i1308.3.i
  %UNP.sroa.200.25.3.ph.i = phi i32 [ %shl26.i1309.22027.i, %if.end24.i1313.2.thread.i ], [ %UNP.sroa.200.36.insert.insert1576.3.i, %if.then7.i1308.3.i ]
  %.ph2030.i = phi i32 [ 14, %if.end24.i1313.2.thread.i ], [ 15, %if.then7.i1308.3.i ]
  %UNP.sroa.75.25.3.ph.i = add i32 %UNP.sroa.75.2.i, 2
  %shl26.i1309.32033.i = shl nuw nsw i32 %UNP.sroa.200.25.3.ph.i, 1
...
if.end24.i1313.3.i:                               ; preds = %if.end24.i1313.1.i, %if.end24.i1313.1.i.thread, %if.end24.i1313.1.thread.i
  %618 = phi i32 [ %dec.i1310.1.i357, %if.end24.i1313.1.i.thread ], [ %.ph2019.i, %if.end24.i1313.1.thread.i ], [ %dec.i1310.1.i, %if.end24.i1313.1.i ]
  ...
  %UNP.sroa.200.25.2.i363 = phi i32 [ %shl26.i1309.1.i356, %if.end24.i1313.1.i.thread ], [ %shl26.i1309.12022.i, %if.end24.i1313.1.thread.i ], [ %shl26.i1309.1.i, %if.end24.i1313.1.i ]
...
if.end24.i1313.4.thread.i:                        ; preds = %if.end24.i1313.3.i
  ...
  %shl26.i1309.42038.i = shl nuw nsw i32 %UNP.sroa.200.36.insert.insert1576.4.i, 1
...
if.end24.i1313.5.thread.i:                        ; preds = %if.then7.i1308.5.i, %if.end24.i1313.4.thread.i
  %UNP.sroa.200.25.5.ph.i = phi i32 [ %shl26.i1309.42038.i, %if.end24.i1313.4.thread.i ], [ %UNP.sroa.200.36.insert.insert1576.5.i, %if.then7.i1308.5.i ]
  %.ph2041.i = phi i32 [ 14, %if.end24.i1313.4.thread.i ], [ 15, %if.then7.i1308.5.i ]
  %UNP.sroa.75.25.5.ph.i = add i32 %UNP.sroa.75.25.2.i364, 2
  %shl26.i1309.52044.i = shl nuw nsw i32 %UNP.sroa.200.25.5.ph.i, 1
  br label %if.end24.i1313.6.i

if.end24.i1313.5.i:                               ; preds = %if.end24.i1313.3.i, %if.end24.i1313.4.i.thread
  %627 = phi i32 [ %.ph2030.i, %if.end24.i1313.4.i.thread ], [ %dec.i1310.3.i, %if.end24.i1313.3.i ]
  %UNP.sroa.75.25.4.i369 = phi i32 [ %UNP.sroa.75.25.3.ph.i, %if.end24.i1313.4.i.thread ], [ %UNP.sroa.75.25.2.i364, %if.end24.i1313.3.i ]
  %UNP.sroa.200.25.4.i368 = phi i32 [ %shl26.i1309.32033.i, %if.end24.i1313.4.i.thread ], [ %shl26.i1309.3.i, %if.end24.i1313.3.i ]
...
if.end24.i1313.6.thread.i:                        ; preds = %if.end24.i1313.5.i
  ...
  %shl26.i1309.62049.i = shl nuw nsw i32 %UNP.sroa.200.36.insert.insert1576.6.i, 1
  br label %if.end24.i1313.7.i

if.end24.i1313.6.i:                               ; preds = %if.end24.i1313.5.i, %if.end24.i1313.5.thread.i
  %UNP.sroa.200.25.6.i = phi i32 [ %shl26.i1309.5.i, %if.end24.i1313.5.i ], [ %shl26.i1309.52044.i, %if.end24.i1313.5.thread.i ]
  %UNP.sroa.75.25.6.i = phi i32 [ %UNP.sroa.75.25.4.i369, %if.end24.i1313.5.i ], [ %UNP.sroa.75.25.5.ph.i, %if.end24.i1313.5.thread.i ]
  %632 = phi i32 [ %dec.i1310.5.i, %if.end24.i1313.5.i ], [ %.ph2041.i, %if.end24.i1313.5.thread.i ]
...
if.end24.i1313.7.i:                               ; preds = %if.then7.i1308.7.i, %if.end24.i1313.6.i, %if.end24.i1313.6.thread.i
  %UNP.sroa.200.25.7.i = phi i32 [ %UNP.sroa.200.36.insert.insert1576.7.i, %if.then7.i1308.7.i ], [ %shl26.i1309.6.i, %if.end24.i1313.6.i ], [ %shl26.i1309.62049.i, %if.end24.i1313.6.thread.i ]
...
getbits.exit1316.i:                               ; preds = %if.end24.i1313.7.i, %if.then.i1291.i
  ...
  %idxprom329.i = zext i32 %UNP.sroa.31.01726.i to i64
  ...
  %inc332.i = add nuw i32 %UNP.sroa.31.01726.i, 1
...
if.end333.i:                                      ; preds = %while.body309.i.prol.loopexit, %while.body309.i, %middle.block, %getbits.exit1316.i
  ...
  %UNP.sroa.31.3.i = phi i32 [ %inc332.i, %getbits.exit1316.i ], [ %ind.end679, %middle.block ], [ %inc320.i.lcssa.unr, %while.body309.i.prol.loopexit ], [ %inc320.i.3, %while.body309.i ]
...
if.then347.i:                                     ; preds = %if.end343.i, %if.end343.thread.i
  %UNP.sroa.0.02059.i = phi ptr [ %call175.i, %if.end343.thread.i ], [ %UNP.sroa.0.0.i120, %if.end343.i ]
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.52) #13
  call void @free(ptr noundef %UNP.sroa.0.02059.i) #13
  br label %while.cond.outer.i39.backedge
...
if.end360.i:                                      ; preds = %if.then351.i
  ...
  %tobool3731731.i = icmp ne i32 %.val.i, 0
  %cmp3771733.i = icmp ugt i32 %UNP.sroa.131.1.i, 4
  %or.cond16121734.i = and i1 %cmp3771733.i, %tobool3731731.i
  br i1 %or.cond16121734.i, label %while.body380.lr.ph.i, label %if.end746.i
...
while.body380.i:                                  ; preds = %sw.epilog.i, %while.body380.lr.ph.i
  %buf.01740.i = phi ptr [ %call356.i, %while.body380.lr.ph.i ], [ %buf.15.i, %sw.epilog.i ]
  %UNP.sroa.31.41738.i = phi i32 [ 0, %while.body380.lr.ph.i ], [ %UNP.sroa.31.11.i, %sw.epilog.i ]
  %UNP.sroa.75.281737.i = phi i32 [ 4, %while.body380.lr.ph.i ], [ %UNP.sroa.75.32.i, %sw.epilog.i ]
  %UNP.sroa.148.01736.i = phi i32 [ %UNP.sroa.131.1.i, %while.body380.lr.ph.i ], [ %UNP.sroa.148.9.i, %sw.epilog.i ]
  %UNP.sroa.178.121735.i = phi i32 [ %.val.i, %while.body380.lr.ph.i ], [ %UNP.sroa.178.13.i, %sw.epilog.i ]
  %inc383.i = add nuw i32 %UNP.sroa.75.281737.i, 1
  %idxprom384.i = zext i32 %UNP.sroa.75.281737.i to i64
...
if.end394.i121:                                   ; preds = %sw.bb.i
  %add396.i = add i32 %UNP.sroa.31.41738.i, 12
  %cmp398.not.i = icmp ult i32 %add396.i, %UNP.sroa.148.01736.i
  br i1 %cmp398.not.i, label %if.end413.i, label %if.then400.i

if.then400.i:                                     ; preds = %if.end394.i121
  %add402.i = add i32 %UNP.sroa.148.01736.i, 512
  %conv404.i = zext i32 %add402.i to i64
  %call405.i = call ptr @cli_realloc(ptr noundef %buf.01740.i, i64 noundef %conv404.i) #13
...
if.end413.i:                                      ; preds = %if.then400.i, %if.end394.i121
  %UNP.sroa.148.1.i = phi i32 [ %add402.i, %if.then400.i ], [ %UNP.sroa.148.01736.i, %if.end394.i121 ]
  %buf.2.i = phi ptr [ %call405.i, %if.then400.i ], [ %buf.01740.i, %if.end394.i121 ]
  %idxprom415.i = zext i32 %UNP.sroa.31.41738.i to i64
  ...
  %add424.i = add i32 %UNP.sroa.31.41738.i, 11
  %add426.i = add i32 %UNP.sroa.75.281737.i, 5
  br label %sw.epilog.i

sw.bb427.i:                                       ; preds = %while.body380.i
  %cmp435.not.i = icmp ult i32 %inc383.i, %sub491.i
  %or.cond1613.i = select i1 %cmp486.i, i1 %cmp435.not.i, i1 false
  br i1 %or.cond1613.i, label %if.end439.i, label %if.then437.i
...
if.end439.i:                                      ; preds = %sw.bb427.i
  %add441.i = add i32 %UNP.sroa.31.41738.i, 20
  %cmp443.not.i = icmp ult i32 %add441.i, %UNP.sroa.148.01736.i
  br i1 %cmp443.not.i, label %if.end459.i, label %if.then445.i

if.then445.i:                                     ; preds = %if.end439.i
  %add448.i = add i32 %UNP.sroa.148.01736.i, 512
  %conv450.i = zext i32 %add448.i to i64
  %call451.i = call ptr @cli_realloc(ptr noundef %buf.01740.i, i64 noundef %conv450.i) #13
...
if.end459.i:                                      ; preds = %if.then445.i, %if.end439.i
  %UNP.sroa.148.2.i = phi i32 [ %add448.i, %if.then445.i ], [ %UNP.sroa.148.01736.i, %if.end439.i ]
  %buf.4.i = phi ptr [ %call451.i, %if.then445.i ], [ %buf.01740.i, %if.end439.i ]
  %add462.i = add i32 %UNP.sroa.75.281737.i, 5
  ...
  %idxprom476.i = zext i32 %UNP.sroa.31.41738.i to i64
  ...
  %add480.i = add i32 %UNP.sroa.31.41738.i, 19
  %add482.i = add i32 %UNP.sroa.75.281737.i, 9
  br label %sw.epilog.i

sw.bb484.i:                                       ; preds = %while.body380.i
  %cmp492.not.i = icmp ult i32 %inc383.i, %sub491.i
  %or.cond1615.i = select i1 %cmp486.i, i1 %cmp492.not.i, i1 false
  br i1 %or.cond1615.i, label %if.end496.i, label %if.then494.i
...
if.end496.i:                                      ; preds = %sw.bb484.i
  %add498.i = add i32 %UNP.sroa.31.41738.i, 40
  %cmp500.not.i = icmp ult i32 %add498.i, %UNP.sroa.148.01736.i
  br i1 %cmp500.not.i, label %if.end516.i, label %if.then502.i

if.then502.i:                                     ; preds = %if.end496.i
  %add505.i = add i32 %UNP.sroa.148.01736.i, 512
  %conv507.i = zext i32 %add505.i to i64
  %call508.i = call ptr @cli_realloc(ptr noundef %buf.01740.i, i64 noundef %conv507.i) #13
...
if.end516.i:                                      ; preds = %if.then502.i, %if.end496.i
  %UNP.sroa.148.4.i = phi i32 [ %add505.i, %if.then502.i ], [ %UNP.sroa.148.01736.i, %if.end496.i ]
  %buf.7.i = phi ptr [ %call508.i, %if.then502.i ], [ %buf.01740.i, %if.end496.i ]
  %idxprom518.i = zext i32 %UNP.sroa.31.41738.i to i64
  ...
  %add526.i = add i32 %UNP.sroa.31.41738.i, 38
  ...
  %add530.i = add i32 %UNP.sroa.31.41738.i, 39
  ...
  %conv540.i = add i32 %UNP.sroa.31.41738.i, %642
  %add542.i = add i32 %UNP.sroa.75.281737.i, 9
  br label %sw.epilog.i
...
if.end552.i:                                      ; preds = %sw.bb543.i
  ...
  %add560.i = add i32 %UNP.sroa.75.281737.i, 5
  ...
  %or.cond1618.i = and i1 %cmp562.i, %cmp568.not.i
  br i1 %or.cond1618.i, label %if.end576.i, label %if.then570.i
...
if.end576.i:                                      ; preds = %if.end552.i
  %add578.i = add i32 %UNP.sroa.31.41738.i, 3
  %add579.i = add i32 %add578.i, %arrayidx556.val.i
  %cmp581.not.i = icmp ult i32 %add579.i, %UNP.sroa.148.01736.i
  br i1 %cmp581.not.i, label %if.end598.i, label %if.then583.i

if.then583.i:                                     ; preds = %if.end576.i
  %add585.i = add i32 %UNP.sroa.148.01736.i, 512
  %add587.i = add i32 %add585.i, %arrayidx556.val.i
  %conv589.i = zext i32 %add587.i to i64
  %call590.i = call ptr @cli_realloc(ptr noundef %buf.01740.i, i64 noundef %conv589.i) #13
...
if.end598.i:                                      ; preds = %if.then583.i, %if.end576.i
  %UNP.sroa.148.5.i = phi i32 [ %add587.i, %if.then583.i ], [ %UNP.sroa.148.01736.i, %if.end576.i ]
  %buf.9.i = phi ptr [ %call590.i, %if.then583.i ], [ %buf.01740.i, %if.end576.i ]
...
if.then604.i:                                     ; preds = %if.end598.i
  ...
  %inc610.i = add i32 %UNP.sroa.31.41738.i, 1
  %idxprom611.i = zext i32 %UNP.sroa.31.41738.i to i64
...
if.end613.i:                                      ; preds = %if.then604.i, %if.end598.i
  %UNP.sroa.31.6.i = phi i32 [ %inc610.i, %if.then604.i ], [ %UNP.sroa.31.41738.i, %if.end598.i ]
...
for.cond.preheader.i:                             ; preds = %if.end613.i
  %cmp6161729.not.i = icmp eq i32 %mul558.i, 0
  br i1 %cmp6161729.not.i, label %for.end.thread.i, label %for.body.lr.ph.i

for.end.thread.i:                                 ; preds = %for.cond.preheader.i
  %idxprom6432060.i = zext i32 %add560.i to i64
  %arrayidx6442061.i = getelementptr inbounds i8, ptr %UNP.sroa.0.0.i120, i64 %idxprom6432060.i
...
for.body.lr.ph.i:                                 ; preds = %for.cond.preheader.i
  ...
  %xtraiter789 = and i64 %651, 1
  %652 = icmp eq i64 %649, 1
  br i1 %652, label %if.end.i1319.i.unr-lcssa, label %for.body.lr.ph.i.new

for.body.lr.ph.i.new:                             ; preds = %for.body.lr.ph.i
  %unroll_iter792 = and i64 %651, -2
  br label %for.body.i

for.body.i:                                       ; preds = %for.body.i, %for.body.lr.ph.i.new
  %indvars.iv.i = phi i64 [ 0, %for.body.lr.ph.i.new ], [ %indvars.iv.next.i.1, %for.body.i ]
  %niter793 = phi i64 [ 0, %for.body.lr.ph.i.new ], [ %niter793.next.1, %for.body.i ]
  ...
  %niter793.next.1 = add nuw nsw i64 %niter793, 2
  %niter793.ncmp.1.not = icmp eq i64 %niter793.next.1, %unroll_iter792
  br i1 %niter793.ncmp.1.not, label %if.end.i1319.i.unr-lcssa, label %for.body.i, !llvm.loop !40

if.end.i1319.i.unr-lcssa:                         ; preds = %for.body.i, %for.body.lr.ph.i
  %indvars.iv.i.unr = phi i64 [ 0, %for.body.lr.ph.i ], [ %indvars.iv.next.i.1, %for.body.i ]
  %lcmp.mod791.not = icmp eq i64 %xtraiter789, 0
  br i1 %lcmp.mod791.not, label %if.end.i1319.i, label %for.body.i.epil

for.body.i.epil:                                  ; preds = %if.end.i1319.i.unr-lcssa
  ...
  br label %if.end.i1319.i

if.end.i1319.i:                                   ; preds = %if.end.i1319.i.unr-lcssa, %for.body.i.epil
...
land.lhs.true.i1321.i:                            ; preds = %if.end.i1319.i
...
if.else.i1334.i:                                  ; preds = %land.lhs.true9.i1327.i, %land.lhs.true4.i1324.i, %land.lhs.true.i1321.i, %if.end.i1319.i
...
u2a.exit1366.i:                                   ; preds = %for.body36.i1364.i, %for.end.loopexit.i1349.i, %for.end.thread.i
  %arrayidx6442062.i = phi ptr [ %arrayidx6442061.i, %for.end.thread.i ], [ %arrayidx644.i, %for.end.loopexit.i1349.i ], [ %arrayidx644.i, %for.body36.i1364.i ]
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr align 1 %arrayidx648.i, ptr nonnull align 1 %arrayidx6442062.i, i64 %conv653.i, i1 false)
...
if.then671.i:                                     ; preds = %if.end667.thread.i, %if.end658.i
  %UNP.sroa.31.81687.i = phi i32 [ %inc664.i, %if.end667.thread.i ], [ %UNP.sroa.31.7.i, %if.end658.i ]
  %inc673.i = add i32 %UNP.sroa.31.81687.i, 1
  %idxprom674.i = zext i32 %UNP.sroa.31.81687.i to i64
...
sw.bb682.i:                                       ; preds = %while.body380.i, %while.body380.i, %while.body380.i, %while.body380.i, %while.body380.i, %while.body380.i, %while.body380.i, %while.body380.i, %while.body380.i, %while.body380.i, %while.body380.i, %while.body380.i, %while.body380.i, %while.body380.i, %while.body380.i, %while.body380.i, %while.body380.i, %while.body380.i, %while.body380.i, %while.body380.i, %while.body380.i, %while.body380.i, %while.body380.i
  %add684.i = add i32 %UNP.sroa.31.41738.i, 4
  %cmp686.not.i = icmp ult i32 %add684.i, %UNP.sroa.148.01736.i
  br i1 %cmp686.not.i, label %if.end702.i, label %if.then688.i

if.then688.i:                                     ; preds = %sw.bb682.i
  %add691.i = add i32 %UNP.sroa.148.01736.i, 512
  %conv693.i = zext i32 %add691.i to i64
  %call694.i = call ptr @cli_realloc(ptr noundef %buf.01740.i, i64 noundef %conv693.i) #13
...
if.end702.i:                                      ; preds = %if.then688.i, %sw.bb682.i
  %UNP.sroa.148.7.i = phi i32 [ %add691.i, %if.then688.i ], [ %UNP.sroa.148.01736.i, %sw.bb682.i ]
  %buf.12.i = phi ptr [ %call694.i, %if.then688.i ], [ %buf.01740.i, %sw.bb682.i ]
  %idxprom704.i = zext i32 %UNP.sroa.31.41738.i to i64
  ...
  %add712.i = add i32 %call710.i, %UNP.sroa.31.41738.i
  br label %sw.epilog.i

sw.bb713.i:                                       ; preds = %while.body380.i
  %dec715.i = add i32 %UNP.sroa.178.121735.i, -1
  %add717.i = add i32 %UNP.sroa.31.41738.i, 1
  %cmp719.not.i = icmp ult i32 %add717.i, %UNP.sroa.148.01736.i
  br i1 %cmp719.not.i, label %if.end735.i, label %if.then721.i

if.then721.i:                                     ; preds = %sw.bb713.i
  %add724.i = add i32 %UNP.sroa.148.01736.i, 512
  %conv726.i = zext i32 %add724.i to i64
  %call727.i = call ptr @cli_realloc(ptr noundef %buf.01740.i, i64 noundef %conv726.i) #13
...
if.end735.i:                                      ; preds = %if.then721.i, %sw.bb713.i
  %UNP.sroa.148.8.i = phi i32 [ %add724.i, %if.then721.i ], [ %UNP.sroa.148.01736.i, %sw.bb713.i ]
  %buf.14.i = phi ptr [ %call727.i, %if.then721.i ], [ %buf.01740.i, %sw.bb713.i ]
  %idxprom738.i = zext i32 %UNP.sroa.31.41738.i to i64
...
sw.epilog.i:                                      ; preds = %if.end735.i, %if.end702.i, %if.then671.i, %if.end658.i, %if.end516.i, %if.end459.i, %if.end413.i
  %UNP.sroa.178.13.i = phi i32 [ %dec715.i, %if.end735.i ], [ %UNP.sroa.178.121735.i, %if.end702.i ], [ %UNP.sroa.178.121735.i, %if.end516.i ], [ %UNP.sroa.178.121735.i, %if.end413.i ], [ %UNP.sroa.178.121735.i, %if.end459.i ], [ %UNP.sroa.178.121735.i, %if.then671.i ], [ %UNP.sroa.178.121735.i, %if.end658.i ]
  ...
  %or.cond1612.i = select i1 %tobool373.i, i1 %cmp377.i, i1 false
  br i1 %or.cond1612.i, label %while.body380.i, label %if.end746.i, !llvm.loop !41
...
if.end746.i:                                      ; preds = %sw.epilog.i, %if.then745.i, %if.end360.i
  %buf.0.lcssa2080.i = phi ptr [ %buf.01740.i, %if.then745.i ], [ %call356.i, %if.end360.i ], [ %buf.15.i, %sw.epilog.i ]
  %UNP.sroa.31.4.lcssa2079.i = phi i32 [ %UNP.sroa.31.41738.i, %if.then745.i ], [ 0, %if.end360.i ], [ %UNP.sroa.31.11.i, %sw.epilog.i ]
  call void @free(ptr noundef %UNP.sroa.0.0.i120) #13
  br label %if.end752.i

if.end752.i:                                      ; preds = %if.end746.i, %if.end349.i
  %UNP.sroa.31.12.i = phi i32 [ %UNP.sroa.31.4.lcssa2079.i, %if.end746.i ], [ %UNP.sroa.131.1.i, %if.end349.i ]
  %buf.16.i = phi ptr [ %buf.0.lcssa2080.i, %if.end746.i ], [ %UNP.sroa.0.0.i120, %if.end349.i ]
