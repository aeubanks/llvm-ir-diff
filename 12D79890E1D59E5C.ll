...
for.body72:                                       ; preds = %land.rhs
  ...
  %spec.select.idx = zext i1 %cmp78 to i64
  %spec.select = getelementptr i8, ptr %16, i64 %spec.select.idx
...
entry:
  ...
  %0 = load i8, ptr %arrayidx1683, align 1, !tbaa !14
...
while.cond3.preheader:                            ; preds = %while.cond3.preheader.lr.ph, %if.end103
  %indvars.iv1726 = phi i64 [ 0, %while.cond3.preheader.lr.ph ], [ %indvars.iv.next1727, %if.end103 ]
...
while.cond3:                                      ; preds = %while.cond3, %while.cond3.preheader
  %indvars.iv1719.in = phi i32 [ %indvars.iv1719, %while.cond3 ], [ %i.01686, %while.cond3.preheader ]
  %indvars.iv = phi i64 [ %indvars.iv.next, %while.cond3 ], [ %2, %while.cond3.preheader ]
  %indvars.iv1719 = add i32 %indvars.iv1719.in, 1
...
if.then27:                                        ; preds = %while.end, %while.end
  ...
  %sext1772 = add i64 %inc28, 4294967296
  %idxprom32 = ashr exact i64 %sext1772, 32
  %arrayidx33 = getelementptr inbounds i8, ptr %zLine, i64 %idxprom32
  %arrayidx36 = getelementptr inbounds [50 x ptr], ptr %azArg, i64 0, i64 %indvars.iv1726
  store ptr %arrayidx33, ptr %arrayidx36, align 8, !tbaa !5
  %6 = sext i32 %indvars.iv1719 to i64
  br label %while.cond37

while.cond37:                                     ; preds = %while.cond37, %if.then27
  %indvars.iv1721 = phi i64 [ %indvars.iv.next1722, %while.cond37 ], [ %6, %if.then27 ]
  %arrayidx39 = getelementptr inbounds i8, ptr %zLine, i64 %indvars.iv1721
...
while.end51:                                      ; preds = %while.cond37
  %8 = trunc i64 %indvars.iv1721 to i32
  br i1 %cmp46.not, label %if.then57, label %if.end61

if.then57:                                        ; preds = %while.end51
  %arrayidx39.le = getelementptr inbounds i8, ptr %zLine, i64 %indvars.iv1721
...
if.else:                                          ; preds = %while.end
  ...
  %arrayidx72 = getelementptr inbounds [50 x ptr], ptr %azArg, i64 0, i64 %indvars.iv1726
  store ptr %arrayidx5.le, ptr %arrayidx72, align 8, !tbaa !5
  %sext1774 = shl i64 %indvars.iv, 32
  %idxprom741678 = ashr exact i64 %sext1774, 32
  %arrayidx751679 = getelementptr inbounds i8, ptr %zLine, i64 %idxprom741678
  %17 = load i8, ptr %arrayidx751679, align 1, !tbaa !14
  %cond1680 = icmp eq i8 %17, 0
  br i1 %cond1680, label %if.end99, label %land.rhs78

land.rhs78:                                       ; preds = %if.else, %while.body89
  %indvars.iv1724 = phi i64 [ %indvars.iv.next1725, %while.body89 ], [ %indvars.iv, %if.else ]
...
while.body89:                                     ; preds = %land.rhs78
  %indvars.iv.next1725 = add i64 %indvars.iv1724, 1
  %arrayidx75 = getelementptr inbounds i8, ptr %zLine, i64 %indvars.iv.next1725
  %21 = load i8, ptr %arrayidx75, align 1, !tbaa !14
  %cond = icmp eq i8 %21, 0
  br i1 %cond, label %if.end99.loopexit, label %land.rhs78, !llvm.loop !31

if.then95:                                        ; preds = %land.rhs78
  %22 = trunc i64 %indvars.iv1724 to i32
  %arrayidx75.le = getelementptr inbounds i8, ptr %zLine, i64 %indvars.iv1724
  %inc96 = add nsw i32 %22, 1
  store i8 0, ptr %arrayidx75.le, align 1, !tbaa !14
  br label %if.end99

if.end99.loopexit:                                ; preds = %while.body89
  %23 = trunc i64 %indvars.iv.next1725 to i32
  br label %if.end99
...
if.end103:                                        ; preds = %if.end103.sink.split, %if.end61
  ...
  %cmp = icmp ult i64 %indvars.iv1726, 49
...
while.end104:                                     ; preds = %if.end103, %while.end
  %nArg.0.lcssa.ph.in = phi i64 [ %indvars.iv.next1727, %if.end103 ], [ %indvars.iv1726, %while.end ]
...
for.body.preheader:                               ; preds = %if.then163
  %wide.trip.count1763 = and i64 %nArg.0.lcssa.ph.in, 4294967295
  br label %for.body
...
for.body:                                         ; preds = %for.body.preheader, %for.body
  %indvars.iv1759 = phi i64 [ 1, %for.body.preheader ], [ %indvars.iv.next1760, %for.body ]
  %arrayidx178 = getelementptr inbounds [50 x ptr], ptr %azArg, i64 0, i64 %indvars.iv1759
  ...
  %exitcond1764.not = icmp eq i64 %indvars.iv.next1760, %wide.trip.count1763
  br i1 %exitcond1764.not, label %if.end184, label %for.body, !llvm.loop !36
...
for.body390.preheader:                            ; preds = %if.end382
  ...
  br i1 %min.iters.check, label %for.body390.preheader1806, label %vector.ph
...
vector.ph:                                        ; preds = %for.body390.preheader
  ...
  %ind.end1802 = or i32 %.cast, 1
  %invariant.gep = getelementptr i8, ptr %call378, i64 -1
  %invariant.gep1812 = getelementptr i8, ptr %call378, i64 -1
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %gep1813 = getelementptr i8, ptr %invariant.gep1812, i64 %98
  ...
  store <16 x i8> <i8 44, i8 63, i8 44, i8 63, i8 44, i8 63, i8 44, i8 63, i8 44, i8 63, i8 44, i8 63, i8 44, i8 63, i8 44, i8 63>, ptr %gep1813, align 1, !tbaa !14
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %for.end399, label %for.body390.preheader1806

for.body390.preheader1806:                        ; preds = %for.body390.preheader, %middle.block
  %indvars.iv1735.ph = phi i64 [ %92, %for.body390.preheader ], [ %ind.end, %middle.block ]
  %i345.01697.ph = phi i32 [ 1, %for.body390.preheader ], [ %ind.end1802, %middle.block ]
  br label %for.body390

for.body390:                                      ; preds = %for.body390.preheader1806, %for.body390
  %indvars.iv1735 = phi i64 [ %indvars.iv.next1736, %for.body390 ], [ %indvars.iv1735.ph, %for.body390.preheader1806 ]
  %i345.01697 = phi i32 [ %inc398, %for.body390 ], [ %i345.01697.ph, %for.body390.preheader1806 ]
  %100 = add nsw i64 %indvars.iv1735, 1
  %arrayidx393 = getelementptr inbounds i8, ptr %call378, i64 %indvars.iv1735
  store i8 44, ptr %arrayidx393, align 1, !tbaa !14
  %indvars.iv.next1736 = add nsw i64 %indvars.iv1735, 2
  ...
  %exitcond1740.not = icmp eq i32 %inc398, %call369
  br i1 %exitcond1740.not, label %for.end399, label %for.body390, !llvm.loop !43

for.end399:                                       ; preds = %for.body390, %middle.block, %if.end382
  %j.0.lcssa.in = phi i64 [ %call385, %if.end382 ], [ %ind.end, %middle.block ], [ %indvars.iv.next1736, %for.body390 ]
  %sext1775 = shl i64 %j.0.lcssa.in, 32
  %idxprom401 = ashr exact i64 %sext1775, 32
  ...
  %sext1776 = add i64 %inc400, 4294967296
  %idxprom403 = ashr exact i64 %sext1776, 32
...
for.body488:                                      ; preds = %for.cond485.preheader, %for.body488
  %indvars.iv1741 = phi i64 [ %indvars.iv.next1742, %for.body488 ], [ 0, %for.cond485.preheader ]
  %111 = load ptr, ptr %pStmt, align 8, !tbaa !5
  %indvars.iv.next1742 = add nuw nsw i64 %indvars.iv1741, 1
  %arrayidx491 = getelementptr inbounds ptr, ptr %call423, i64 %indvars.iv1741
  %112 = load ptr, ptr %arrayidx491, align 8, !tbaa !5
  %113 = trunc i64 %indvars.iv.next1742 to i32
  ...
  br i1 %exitcond1745.not, label %for.end495, label %for.body488, !llvm.loop !45
...
for.body810:                                      ; preds = %for.body810.lr.ph, %for.body810
  %indvars.iv1733 = phi i64 [ 0, %for.body810.lr.ph ], [ %indvars.iv.next1734, %for.body810 ]
  ...
  store i8 %conv818, ptr %arrayidx8081693, align 1, !tbaa !14
  %indvars.iv.next1734 = add nuw nsw i64 %indvars.iv1733, 1
  %arrayidx808 = getelementptr inbounds i8, ptr %141, i64 %indvars.iv.next1734
...
land.rhs946:                                      ; preds = %if.then892, %for.body953
  %indvars.iv1729 = phi i64 [ 0, %if.then892 ], [ %indvars.iv.next1730, %for.body953 ]
  %arrayidx949 = getelementptr inbounds %struct.callback_data, ptr %p, i64 0, i32 9, i64 %indvars.iv1729
...
for.body953:                                      ; preds = %land.rhs946
  ...
  %exitcond.not = icmp eq i64 %indvars.iv.next1730, 100
...
for.body1001.lr.ph:                               ; preds = %for.cond998.preheader
  ...
  %wide.trip.count1750 = zext i32 %180 to i64
  br label %for.body1001

for.body1001:                                     ; preds = %for.body1001.lr.ph, %for.inc1016
  %indvars.iv1746 = phi i64 [ 1, %for.body1001.lr.ph ], [ %indvars.iv.next1747, %for.inc1016 ]
  %maxlen.01702 = phi i32 [ 0, %for.body1001.lr.ph ], [ %maxlen.1, %for.inc1016 ]
  %arrayidx1003 = getelementptr inbounds ptr, ptr %179, i64 %indvars.iv1746
...
for.inc1016:                                      ; preds = %if.end1007, %for.body1001
  ...
  %exitcond1751.not = icmp eq i64 %indvars.iv.next1747, %wide.trip.count1750
  br i1 %exitcond1751.not, label %for.end1018, label %for.body1001, !llvm.loop !48
...
for.body1030:                                     ; preds = %for.body1030.preheader, %for.end1051
  %indvars.iv1752 = phi i64 [ 1, %for.body1030.preheader ], [ %indvars.iv.next1753, %for.end1051 ]
...
for.body1035:                                     ; preds = %for.body1030, %for.body1035
  %indvars.iv1754 = phi i64 [ %indvars.iv.next1755, %for.body1035 ], [ %indvars.iv1752, %for.body1030 ]
  %cmp1036.not = icmp sgt i64 %indvars.iv1754, %182
  %cond1038 = select i1 %cmp1036.not, ptr @.str.114, ptr @.str.113
  %184 = load ptr, ptr %azResult, align 8, !tbaa !5
  %arrayidx1040 = getelementptr inbounds ptr, ptr %184, i64 %indvars.iv1754
  ...
  %indvars.iv.next1755 = add i64 %indvars.iv1754, %182
  %186 = load i32, ptr %nRow, align 4, !tbaa !13
  %187 = sext i32 %186 to i64
  %cmp1033.not = icmp sgt i64 %indvars.iv.next1755, %187
...
for.end1051:                                      ; preds = %for.body1035, %for.body1030
  ...
  %exitcond1758.not = icmp eq i32 %add1031, %div1026
  br i1 %exitcond1758.not, label %if.end1057, label %for.body1030, !llvm.loop !50
...
land.lhs.true1084:                                ; preds = %land.lhs.true1064
  %conv1086 = and i64 %call110, 4294967295
  %call1087 = tail call i32 @strncmp(ptr noundef nonnull %35, ptr noundef nonnull @.str.117, i64 noundef %conv1086) #23
  %cmp1088 = icmp eq i32 %call1087, 0
  %cmp1091 = icmp ugt i32 %nArg.0.lcssa.ph, 1
  %or.cond1188 = and i1 %cmp1088, %cmp1091
...
for.body1115.preheader:                           ; preds = %for.cond1107.preheader
  %wide.trip.count1770 = and i64 %nArg.0.lcssa.ph.in, 4294967295
  br label %for.body1115

for.body1115:                                     ; preds = %for.body1115.preheader, %for.body1115
  %indvars.iv1765 = phi i64 [ 1, %for.body1115.preheader ], [ %indvars.iv.next1766, %for.body1115 ]
  %arrayidx1117 = getelementptr inbounds [50 x ptr], ptr %azArg, i64 0, i64 %indvars.iv1765
  ...
  %194 = add nsw i64 %indvars.iv1765, -1
  ...
  %exitcond1771.not = icmp eq i64 %indvars.iv.next1766, %wide.trip.count1770
  br i1 %exitcond1771.not, label %cleanup1152, label %for.body1115, !llvm.loop !51
...
land.lhs.true:                                    ; preds = %lor.lhs.false16, %if.end14
  ...
  %tobool.not76.i = icmp eq i8 %11, 0
  br i1 %tobool.not76.i, label %while.cond.backedge, label %for.body.lr.ph.i
...
for.body.i:                                       ; preds = %for.inc.i, %for.body.lr.ph.i
  ...
  %z.addr.077.i = phi ptr [ %retval.0.i, %for.body.lr.ph.i ], [ %incdec.ptr53.i, %for.inc.i ]
...
land.lhs.true.i221:                               ; preds = %if.end.i220
  %arrayidx5.i = getelementptr inbounds i8, ptr %z.addr.077.i, i64 1
...
if.then9.i:                                       ; preds = %land.lhs.true.i221
  %add.ptr.i = getelementptr inbounds i8, ptr %z.addr.077.i, i64 2
...
land.lhs.true29.i:                                ; preds = %if.end.i220
  %arrayidx30.i = getelementptr inbounds i8, ptr %z.addr.077.i, i64 1
...
if.then34.i:                                      ; preds = %land.lhs.true29.i
  %add.ptr35.i = getelementptr inbounds i8, ptr %z.addr.077.i, i64 2
...
for.inc.i:                                        ; preds = %while.cond36.i, %for.inc.i.loopexit, %for.body.i
  %z.addr.3.i = phi ptr [ %z.addr.077.i, %for.body.i ], [ %arrayidx15.i.le, %for.inc.i.loopexit ], [ %z.addr.2.i, %while.cond36.i ]
...
land.lhs.true.i230:                               ; preds = %while.end.i
  ...
  %tobool.not76.i.i = icmp eq i8 %27, 0
  br i1 %tobool.not76.i.i, label %if.end46.thread, label %for.body.i.i

for.body.i.i:                                     ; preds = %land.lhs.true.i230, %for.inc.i.i
  %28 = phi i8 [ %36, %for.inc.i.i ], [ %27, %land.lhs.true.i230 ]
  %z.addr.077.i.i = phi ptr [ %incdec.ptr53.i.i, %for.inc.i.i ], [ %incdec.ptr.i228, %land.lhs.true.i230 ]
...
land.lhs.true.i.i:                                ; preds = %if.end.i.i
  %arrayidx5.i.i = getelementptr inbounds i8, ptr %z.addr.077.i.i, i64 1
...
if.then9.i.i:                                     ; preds = %land.lhs.true.i.i
  %add.ptr.i.i = getelementptr inbounds i8, ptr %z.addr.077.i.i, i64 2
...
land.lhs.true29.i.i:                              ; preds = %if.end.i.i
  %arrayidx30.i.i = getelementptr inbounds i8, ptr %z.addr.077.i.i, i64 1
...
if.then34.i.i:                                    ; preds = %land.lhs.true29.i.i
  %add.ptr35.i.i = getelementptr inbounds i8, ptr %z.addr.077.i.i, i64 2
...
for.inc.i.i:                                      ; preds = %while.cond36.i.i, %for.inc.i.i.loopexit, %for.body.i.i
  %z.addr.3.i.i = phi ptr [ %z.addr.077.i.i, %for.body.i.i ], [ %arrayidx15.i.i.le, %for.inc.i.i.loopexit ], [ %z.addr.2.i.i, %while.cond36.i.i ]
...
land.lhs.true25.i:                                ; preds = %land.lhs.true15.i
  ...
  %tobool.not76.i37.i = icmp eq i8 %41, 0
  br i1 %tobool.not76.i37.i, label %if.end46.thread, label %for.body.i44.i

for.body.i44.i:                                   ; preds = %land.lhs.true25.i, %for.inc.i72.i
  %42 = phi i8 [ %50, %for.inc.i72.i ], [ %41, %land.lhs.true25.i ]
  %z.addr.077.i40.i = phi ptr [ %incdec.ptr53.i70.i, %for.inc.i72.i ], [ %arrayidx26.i, %land.lhs.true25.i ]
...
land.lhs.true.i48.i:                              ; preds = %if.end.i45.i
  %arrayidx5.i46.i = getelementptr inbounds i8, ptr %z.addr.077.i40.i, i64 1
...
if.then9.i50.i:                                   ; preds = %land.lhs.true.i48.i
  %add.ptr.i49.i = getelementptr inbounds i8, ptr %z.addr.077.i40.i, i64 2
...
land.lhs.true29.i60.i:                            ; preds = %if.end.i45.i
  %arrayidx30.i58.i = getelementptr inbounds i8, ptr %z.addr.077.i40.i, i64 1
...
if.then34.i62.i:                                  ; preds = %land.lhs.true29.i60.i
  %add.ptr35.i61.i = getelementptr inbounds i8, ptr %z.addr.077.i40.i, i64 2
...
for.inc.i72.i:                                    ; preds = %while.cond36.i64.i, %for.inc.i72.i.loopexit, %for.body.i44.i
  %z.addr.3.i69.i = phi ptr [ %z.addr.077.i40.i, %for.body.i44.i ], [ %arrayidx15.i53.i.le, %for.inc.i72.i.loopexit ], [ %z.addr.2.i63.i, %while.cond36.i64.i ]
...
if.then143:                                       ; preds = %while.end
  ...
  %tobool.not76.i244 = icmp eq i8 %70, 0
  br i1 %tobool.not76.i244, label %if.end148, label %for.body.lr.ph.i246
...
for.body.i251:                                    ; preds = %for.inc.i279, %for.body.lr.ph.i246
  ...
  %z.addr.077.i247 = phi ptr [ %zSql.0.ph, %for.body.lr.ph.i246 ], [ %incdec.ptr53.i277, %for.inc.i279 ]
...
land.lhs.true.i255:                               ; preds = %if.end.i252
  %arrayidx5.i253 = getelementptr inbounds i8, ptr %z.addr.077.i247, i64 1
...
if.then9.i257:                                    ; preds = %land.lhs.true.i255
  %add.ptr.i256 = getelementptr inbounds i8, ptr %z.addr.077.i247, i64 2
...
land.lhs.true29.i267:                             ; preds = %if.end.i252
  %arrayidx30.i265 = getelementptr inbounds i8, ptr %z.addr.077.i247, i64 1
...
if.then34.i269:                                   ; preds = %land.lhs.true29.i267
  %add.ptr35.i268 = getelementptr inbounds i8, ptr %z.addr.077.i247, i64 2
...
for.inc.i279:                                     ; preds = %while.cond36.i271, %for.inc.i279.loopexit, %for.body.i251
  %z.addr.3.i276 = phi ptr [ %z.addr.077.i247, %for.body.i251 ], [ %arrayidx15.i260.le, %for.inc.i279.loopexit ], [ %z.addr.2.i270, %while.cond36.i271 ]
