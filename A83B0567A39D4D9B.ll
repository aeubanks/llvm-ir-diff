...
if.end:                                           ; preds = %entry
  ...
  %cmp54 = icmp sgt i32 %conv, 0
  br i1 %cmp54, label %land.lhs.true.preheader, label %if.then14
...
land.lhs.true:                                    ; preds = %land.lhs.true.preheader, %while.body
  ...
  %arrayidx = getelementptr inbounds i8, ptr %absolute, i64 %idxprom
...
while.body:                                       ; preds = %land.lhs.true
  ...
  br i1 %cmp, label %land.lhs.true, label %if.then14, !llvm.loop !8

if.then14:                                        ; preds = %while.body, %if.end
...
if.then7.i:                                       ; preds = %if.then.i
  ...
  %conv.i = trunc i64 %call.i to i32
  %cmp29.i = icmp sgt i32 %conv.i, 0
  br i1 %cmp29.i, label %land.lhs.true.preheader.i, label %while.end.i

land.lhs.true.preheader.i:                        ; preds = %if.then7.i
  %3 = and i64 %call.i, 4294967295
  br label %land.lhs.true.i

land.lhs.true.i:                                  ; preds = %while.body.i, %land.lhs.true.preheader.i
  %indvars.iv.i = phi i64 [ %3, %land.lhs.true.preheader.i ], [ %indvars.iv.next.i, %while.body.i ]
  %sub.i = add nuw nsw i64 %indvars.iv.i, 4294967295
  ...
  switch i8 %4, label %while.body.i [
...
while.body.i:                                     ; preds = %land.lhs.true.i
  ...
  br i1 %cmp.i, label %land.lhs.true.i, label %while.end.i, !llvm.loop !47

while.end.i:                                      ; preds = %while.body.i, %land.lhs.true.i, %land.lhs.true.i, %if.then7.i
  %len.0.lcssa.i = phi i64 [ %call.i, %if.then7.i ], [ 0, %while.body.i ], [ %indvars.iv.i, %land.lhs.true.i ], [ %indvars.iv.i, %land.lhs.true.i ]
  %sext.i = shl i64 %len.0.lcssa.i, 32
...
if.then7:                                         ; preds = %if.then
  ...
  br i1 %cmp29, label %land.lhs.true.preheader, label %while.end

land.lhs.true.preheader:                          ; preds = %if.then7
  %1 = and i64 %call, 4294967295
  br label %land.lhs.true

land.lhs.true:                                    ; preds = %land.lhs.true.preheader, %while.body
  %indvars.iv = phi i64 [ %1, %land.lhs.true.preheader ], [ %indvars.iv.next, %while.body ]
  %sub = add nuw i64 %indvars.iv, 4294967295
  %idxprom = and i64 %sub, 4294967295
  %arrayidx = getelementptr inbounds i8, ptr %filename, i64 %idxprom
...
while.body:                                       ; preds = %land.lhs.true
  %indvars.iv.next = add nsw i64 %indvars.iv, -1
  %cmp = icmp sgt i64 %indvars.iv, 1
  br i1 %cmp, label %land.lhs.true, label %while.end, !llvm.loop !47

while.end:                                        ; preds = %while.body, %land.lhs.true, %land.lhs.true, %if.then7
  %len.0.lcssa = phi i64 [ %call, %if.then7 ], [ %indvars.iv, %land.lhs.true ], [ %indvars.iv, %land.lhs.true ], [ 0, %while.body ]
  %sext = shl i64 %len.0.lcssa, 32
...
entry:
  %buf.i = alloca [2 x i8], align 1
  %firstDefn = getelementptr inbounds %struct._tagTreeCCStream, ptr %stream, i64 0, i32 8
  %defn.075 = load ptr, ptr %firstDefn, align 8, !tbaa !17
  %cmp.not76 = icmp eq ptr %defn.075, null
  br i1 %cmp.not76, label %if.end23, label %while.body.lr.ph
...
while.body:                                       ; preds = %while.body.lr.ph, %if.end21
  %defn.078 = phi ptr [ %defn.075, %while.body.lr.ph ], [ %defn.0, %if.end21 ]
  %sawDefn.077 = phi i32 [ 0, %while.body.lr.ph ], [ %sawDefn.1, %if.end21 ]
  %atEnd1 = getelementptr inbounds %struct._tagTreeCCStreamDefn, ptr %defn.078, i64 0, i32 3
  %0 = load i32, ptr %atEnd1, align 8, !tbaa !50
  %cmp2 = icmp eq i32 %0, %atEnd
  br i1 %cmp2, label %if.then, label %if.end21

if.then:                                          ; preds = %while.body
  %linenum = getelementptr inbounds %struct._tagTreeCCStreamDefn, ptr %defn.078, i64 0, i32 2
  %1 = load i64, ptr %linenum, align 8, !tbaa !49
  %filename = getelementptr inbounds %struct._tagTreeCCStreamDefn, ptr %defn.078, i64 0, i32 1
...
land.lhs.true.i:                                  ; preds = %while.body.i, %land.lhs.true.preheader.i
  %indvars.iv.i = phi i64 [ %4, %land.lhs.true.preheader.i ], [ %indvars.iv.next.i, %while.body.i ]
  %sub.i = add nuw nsw i64 %indvars.iv.i, 4294967295
  %idxprom.i = and i64 %sub.i, 4294967295
...
TreeCCStreamLine.exit:                            ; preds = %if.then, %if.end.i
  %6 = load ptr, ptr %defn.078, align 8, !tbaa !36
  %call.i43 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %6) #14
...
while.body.i46:                                   ; preds = %if.end16.i, %while.body.lr.ph.i
  %7 = phi i32 [ %.pre.i, %while.body.lr.ph.i ], [ %add.i, %if.end16.i ]
  %len.054.i = phi i32 [ %conv.i44, %while.body.lr.ph.i ], [ %sub25.i, %if.end16.i ]
  %buf.addr.053.i = phi ptr [ %6, %while.body.lr.ph.i ], [ %add.ptr24.i, %if.end16.i ]
  %cmp2.i = icmp sgt i32 %7, 2047
  br i1 %cmp2.i, label %if.then.i48, label %if.else13.i

if.then.i48:                                      ; preds = %while.body.i46
  %call4.i = tail call noalias dereferenceable_or_null(2056) ptr @malloc(i64 noundef 2056) #15
  %tobool.not.i47 = icmp eq ptr %call4.i, null
  br i1 %tobool.not.i47, label %if.then5.i, label %if.end.i50

if.then5.i:                                       ; preds = %if.then.i48
  tail call void @TreeCCOutOfMemory(ptr noundef null) #16
  br label %if.end.i50

if.end.i50:                                       ; preds = %if.then5.i, %if.then.i48
  %next.i = getelementptr inbounds %struct._tagTreeCCStreamBuf, ptr %call4.i, i64 0, i32 1
  store ptr null, ptr %next.i, align 8, !tbaa !29
  %8 = load ptr, ptr %lastBuf14.i, align 8, !tbaa !38
  %tobool6.not.i49 = icmp eq ptr %8, null
  %next9.i = getelementptr inbounds %struct._tagTreeCCStreamBuf, ptr %8, i64 0, i32 1
  %firstBuf.sink.i = select i1 %tobool6.not.i49, ptr %firstBuf.i, ptr %next9.i
  store ptr %call4.i, ptr %firstBuf.sink.i, align 8, !tbaa !17
  store ptr %call4.i, ptr %lastBuf14.i, align 8, !tbaa !38
  store i32 0, ptr %posn.i, align 8, !tbaa !24
  br label %if.end16.i

if.else13.i:                                      ; preds = %while.body.i46
  %9 = load ptr, ptr %lastBuf14.i, align 8, !tbaa !38
  %sub.i51 = sub nsw i32 2048, %7
  br label %if.end16.i

if.end16.i:                                       ; preds = %if.else13.i, %if.end.i50
  %10 = phi i32 [ 0, %if.end.i50 ], [ %7, %if.else13.i ]
  %templen.0.i = phi i32 [ 2048, %if.end.i50 ], [ %sub.i51, %if.else13.i ]
  %buffer.0.i = phi ptr [ %call4.i, %if.end.i50 ], [ %9, %if.else13.i ]
  %spec.select.i = tail call i32 @llvm.umin.i32(i32 %templen.0.i, i32 %len.054.i)
  %idx.ext.i52 = sext i32 %10 to i64
  %add.ptr.i53 = getelementptr inbounds i8, ptr %buffer.0.i, i64 %idx.ext.i52
  %conv22.i = zext i32 %spec.select.i to i64
  tail call void @llvm.memcpy.p0.p0.i64(ptr align 1 %add.ptr.i53, ptr align 1 %buf.addr.053.i, i64 %conv22.i, i1 false)
  %add.ptr24.i = getelementptr inbounds i8, ptr %buf.addr.053.i, i64 %conv22.i
  %sub25.i = sub nsw i32 %len.054.i, %spec.select.i
  %11 = load i32, ptr %posn.i, align 8, !tbaa !24
  %add.i = add nsw i32 %11, %spec.select.i
  store i32 %add.i, ptr %posn.i, align 8, !tbaa !24
  %cmp.i54 = icmp sgt i32 %sub25.i, 0
  br i1 %cmp.i54, label %while.body.i46, label %WriteBuffer.exit, !llvm.loop !41

WriteBuffer.exit:                                 ; preds = %if.end16.i, %TreeCCStreamLine.exit
  %12 = load ptr, ptr %defn.078, align 8, !tbaa !36
  %call2.i = tail call ptr @strchr(ptr noundef nonnull dereferenceable(1) %12, i32 noundef 10) #14
  %cmp.not3.i = icmp eq ptr %call2.i, null
  br i1 %cmp.not3.i, label %UpdateLineNum.exit, label %while.body.lr.ph.i56

while.body.lr.ph.i56:                             ; preds = %WriteBuffer.exit
  %linenum.promoted.i = load i64, ptr %linenum.i, align 8, !tbaa !23
  br label %while.body.i59

while.body.i59:                                   ; preds = %while.body.i59, %while.body.lr.ph.i56
  %inc5.i = phi i64 [ %linenum.promoted.i, %while.body.lr.ph.i56 ], [ %inc.i, %while.body.i59 ]
  %call4.i57 = phi ptr [ %call2.i, %while.body.lr.ph.i56 ], [ %call.i58, %while.body.i59 ]
  %incdec.ptr.i = getelementptr inbounds i8, ptr %call4.i57, i64 1
  %inc.i = add nsw i64 %inc5.i, 1
  store i64 %inc.i, ptr %linenum.i, align 8, !tbaa !23
  %call.i58 = tail call ptr @strchr(ptr noundef nonnull dereferenceable(1) %incdec.ptr.i, i32 noundef 10) #14
  %cmp.not.i = icmp eq ptr %call.i58, null
  br i1 %cmp.not.i, label %UpdateLineNum.exit, label %while.body.i59, !llvm.loop !42

UpdateLineNum.exit:                               ; preds = %while.body.i59, %WriteBuffer.exit
...
land.lhs.true:                                    ; preds = %UpdateLineNum.exit
  %call = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %12) #14
  %sub = add i64 %call, -1
  %arrayidx = getelementptr inbounds i8, ptr %12, i64 %sub
  %14 = load i8, ptr %arrayidx, align 1, !tbaa !5
  %cmp10.not = icmp eq i8 %14, 10
  br i1 %cmp10.not, label %if.end21, label %do.body

do.body:                                          ; preds = %land.lhs.true
  %15 = load i32, ptr %posn.i, align 8, !tbaa !24
  %cmp13 = icmp slt i32 %15, 2048
  br i1 %cmp13, label %if.then15, label %if.else

if.then15:                                        ; preds = %do.body
  %16 = load ptr, ptr %lastBuf14.i, align 8, !tbaa !38
  %inc = add nsw i32 %15, 1
  store i32 %inc, ptr %posn.i, align 8, !tbaa !24
  %idxprom = sext i32 %15 to i64
  %arrayidx17 = getelementptr inbounds [2048 x i8], ptr %16, i64 0, i64 %idxprom
...
while.body.i.i:                                   ; preds = %if.else, %if.end16.i.i
  %17 = phi i32 [ %add.i.i, %if.end16.i.i ], [ %15, %if.else ]
  %len.054.i.i = phi i32 [ %sub25.i.i, %if.end16.i.i ], [ %conv.i.i, %if.else ]
  %buf.addr.053.i.i = phi ptr [ %add.ptr24.i.i, %if.end16.i.i ], [ %buf.i, %if.else ]
  %cmp2.i.i = icmp sgt i32 %17, 2047
  br i1 %cmp2.i.i, label %if.then.i.i, label %if.else13.i.i
...
if.end.i.i:                                       ; preds = %if.then5.i.i, %if.then.i.i
  ...
  %next9.i.i = getelementptr inbounds %struct._tagTreeCCStreamBuf, ptr %18, i64 0, i32 1
...
if.else13.i.i:                                    ; preds = %while.body.i.i
  ...
  %sub.i.i = sub nsw i32 2048, %17
  br label %if.end16.i.i

if.end16.i.i:                                     ; preds = %if.else13.i.i, %if.end.i.i
  %20 = phi i32 [ 0, %if.end.i.i ], [ %17, %if.else13.i.i ]
  %templen.0.i.i = phi i32 [ 2048, %if.end.i.i ], [ %sub.i.i, %if.else13.i.i ]
  %buffer.0.i.i = phi ptr [ %call4.i.i, %if.end.i.i ], [ %19, %if.else13.i.i ]
  %spec.select.i.i = tail call i32 @llvm.umin.i32(i32 %templen.0.i.i, i32 %len.054.i.i)
  ...
  %add.ptr24.i.i = getelementptr inbounds i8, ptr %buf.addr.053.i.i, i64 %conv22.i.i
  %sub25.i.i = sub nsw i32 %len.054.i.i, %spec.select.i.i
  %21 = load i32, ptr %posn.i, align 8, !tbaa !24
  %add.i.i = add nsw i32 %21, %spec.select.i.i
...
do.end:                                           ; preds = %_StreamPut.exit, %if.then15
  %22 = load i64, ptr %linenum.i, align 8, !tbaa !23
...
if.end21:                                         ; preds = %UpdateLineNum.exit, %land.lhs.true, %do.end, %while.body
  %sawDefn.1 = phi i32 [ %sawDefn.077, %while.body ], [ 1, %do.end ], [ 1, %land.lhs.true ], [ 1, %UpdateLineNum.exit ]
  %next = getelementptr inbounds %struct._tagTreeCCStreamDefn, ptr %defn.078, i64 0, i32 5
...
if.then22:                                        ; preds = %while.end
  %linenum.i61 = getelementptr inbounds %struct._tagTreeCCStream, ptr %stream, i64 0, i32 3
  %23 = load i64, ptr %linenum.i61, align 8, !tbaa !23
  %add.i62 = add nsw i64 %23, 1
  %embedName.i = getelementptr inbounds %struct._tagTreeCCStream, ptr %stream, i64 0, i32 2
  %24 = load ptr, ptr %embedName.i, align 8, !tbaa !22
  %25 = load ptr, ptr %stream, align 8, !tbaa !21
  %print_lines.i.i = getelementptr inbounds %struct._tagTreeCCContext, ptr %25, i64 0, i32 8
  %bf.load.i.i63 = load i16, ptr %print_lines.i.i, align 8
  %bf.shl.mask.i.i = and i16 %bf.load.i.i63, 512
  %tobool.not.i.i64 = icmp eq i16 %bf.shl.mask.i.i, 0
  br i1 %tobool.not.i.i64, label %if.end23, label %if.then.i.i66

if.then.i.i66:                                    ; preds = %if.then22
  %bf.shl3.mask.i.i = and i16 %bf.load.i.i63, 256
  %tobool6.not.i.i65 = icmp eq i16 %bf.shl3.mask.i.i, 0
  br i1 %tobool6.not.i.i65, label %if.end.i.i74, label %if.then7.i.i

if.then7.i.i:                                     ; preds = %if.then.i.i66
  %call.i.i67 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %24) #14
  %conv.i.i68 = trunc i64 %call.i.i67 to i32
  %cmp29.i.i = icmp sgt i32 %conv.i.i68, 0
  br i1 %cmp29.i.i, label %land.lhs.true.preheader.i.i, label %while.end.i.i

land.lhs.true.preheader.i.i:                      ; preds = %if.then7.i.i
  %26 = and i64 %call.i.i67, 4294967295
  br label %land.lhs.true.i.i

land.lhs.true.i.i:                                ; preds = %while.body.i.i71, %land.lhs.true.preheader.i.i
  %indvars.iv.i.i = phi i64 [ %26, %land.lhs.true.preheader.i.i ], [ %indvars.iv.next.i.i, %while.body.i.i71 ]
  %sub.i.i69 = add nuw nsw i64 %indvars.iv.i.i, 4294967295
  %idxprom.i.i = and i64 %sub.i.i69, 4294967295
  %arrayidx.i.i = getelementptr inbounds i8, ptr %24, i64 %idxprom.i.i
  %27 = load i8, ptr %arrayidx.i.i, align 1, !tbaa !5
  switch i8 %27, label %while.body.i.i71 [
    i8 47, label %while.end.i.i
    i8 92, label %while.end.i.i
  ]

while.body.i.i71:                                 ; preds = %land.lhs.true.i.i
  %indvars.iv.next.i.i = add nsw i64 %indvars.iv.i.i, -1
  %cmp.i.i70 = icmp sgt i64 %indvars.iv.i.i, 1
  br i1 %cmp.i.i70, label %land.lhs.true.i.i, label %while.end.i.i, !llvm.loop !47

while.end.i.i:                                    ; preds = %while.body.i.i71, %land.lhs.true.i.i, %land.lhs.true.i.i, %if.then7.i.i
  %len.0.lcssa.i.i = phi i64 [ %call.i.i67, %if.then7.i.i ], [ %indvars.iv.i.i, %land.lhs.true.i.i ], [ %indvars.iv.i.i, %land.lhs.true.i.i ], [ 0, %while.body.i.i71 ]
  %sext.i.i = shl i64 %len.0.lcssa.i.i, 32
  %idx.ext.i.i72 = ashr exact i64 %sext.i.i, 32
  %add.ptr.i.i73 = getelementptr inbounds i8, ptr %24, i64 %idx.ext.i.i72
  br label %if.end.i.i74

if.end.i.i74:                                     ; preds = %while.end.i.i, %if.then.i.i66
  %filename.addr.0.i.i = phi ptr [ %add.ptr.i.i73, %while.end.i.i ], [ %24, %if.then.i.i66 ]
  tail call void (ptr, ptr, ...) @TreeCCStreamPrint(ptr noundef nonnull %stream, ptr noundef nonnull @.str.8, i64 noundef %add.i62, ptr noundef %filename.addr.0.i.i)
  br label %if.end23

if.end23:                                         ; preds = %entry, %if.end.i.i74, %if.then22, %while.end
  ret void
}
