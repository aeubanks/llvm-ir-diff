; ModuleID = '/usr/local/google/home/aeubanks/repos/test-suite/Bitcode/simd_ops/x86_tests/test_op_packsswb_203.bc'
...
@str.11 = private constant [16 x i8] c"op_packsswb_203\00", align 32
...
define i32 @__test_op(ptr noalias nocapture readnone %in_f32.buffer, ptr noalias nocapture readnone %in_f64.buffer, ptr noalias nocapture readnone %in_i8.buffer, ptr noalias nocapture readnone %in_u8.buffer, ptr noalias nocapture readonly %in_i16.buffer, ptr noalias nocapture readnone %in_u16.buffer, ptr noalias nocapture readnone %in_i32.buffer, ptr noalias nocapture readnone %in_u32.buffer, ptr noalias nocapture readnone %in_i64.buffer, ptr noalias nocapture readnone %in_u64.buffer, ptr noalias nocapture readonly %op_packsswb_203.buffer) local_unnamed_addr #1 {
"produce op_packsswb_203":
  %buf_extent168 = getelementptr inbounds %struct.buffer_t, ptr %op_packsswb_203.buffer, i64 0, i32 2, i64 1
  %op_packsswb_203.extent.1 = load i32, ptr %buf_extent168, align 4
  %buf_min176 = getelementptr inbounds %struct.buffer_t, ptr %op_packsswb_203.buffer, i64 0, i32 4, i64 1
  %op_packsswb_203.min.1 = load i32, ptr %buf_min176, align 4
  %0 = add nsw i32 %op_packsswb_203.min.1, %op_packsswb_203.extent.1
  %1 = icmp sgt i32 %op_packsswb_203.extent.1, 0
  br i1 %1, label %"for op_packsswb_203.s0.y.preheader", label %destructor_block, !prof !4

"for op_packsswb_203.s0.y.preheader":             ; preds = %"produce op_packsswb_203"
  ...
  %buf_min175 = getelementptr inbounds %struct.buffer_t, ptr %op_packsswb_203.buffer, i64 0, i32 4, i64 0
  %op_packsswb_203.min.0 = load i32, ptr %buf_min175, align 4
  %2 = sext i32 %op_packsswb_203.min.0 to i64
  %buf_stride172 = getelementptr inbounds %struct.buffer_t, ptr %op_packsswb_203.buffer, i64 0, i32 3, i64 1
  %op_packsswb_203.stride.1 = load i32, ptr %buf_stride172, align 4
  %3 = sext i32 %op_packsswb_203.stride.1 to i64
  %buf_host163 = getelementptr inbounds %struct.buffer_t, ptr %op_packsswb_203.buffer, i64 0, i32 1
  %op_packsswb_203.host = load ptr, ptr %buf_host163, align 8
  %4 = shl nsw i64 %2, 3
  %5 = sub nsw i64 96, %4
  %scevgep = getelementptr i8, ptr %op_packsswb_203.host, i64 %5
  %6 = shl nsw i64 %3, 3
  ...
  %10 = tail call <16 x i8> @llvm.x86.sse2.packsswb.128(<8 x i16> %8, <8 x i16> %9) #4
  %11 = sitofp <16 x i8> %10 to <16 x double>
  ...
  %19 = tail call <16 x i8> @llvm.x86.sse2.packsswb.128(<8 x i16> %17, <8 x i16> %18) #4
  ...
  %28 = tail call <16 x i8> @llvm.x86.sse2.packsswb.128(<8 x i16> %26, <8 x i16> %27) #4
  %29 = sitofp <16 x i8> %28 to <16 x double>
  ...
  %37 = tail call <16 x i8> @llvm.x86.sse2.packsswb.128(<8 x i16> %35, <8 x i16> %36) #4
  ...
  %46 = tail call <16 x i8> @llvm.x86.sse2.packsswb.128(<8 x i16> %44, <8 x i16> %45) #4
  %47 = sitofp <16 x i8> %46 to <16 x double>
  ...
  %55 = tail call <16 x i8> @llvm.x86.sse2.packsswb.128(<8 x i16> %53, <8 x i16> %54) #4
  ...
  %64 = tail call <16 x i8> @llvm.x86.sse2.packsswb.128(<8 x i16> %62, <8 x i16> %63) #4
  ...
  %73 = tail call <16 x i8> @llvm.x86.sse2.packsswb.128(<8 x i16> %71, <8 x i16> %72) #4
  ...
  %82 = tail call <16 x i8> @llvm.x86.sse2.packsswb.128(<8 x i16> %80, <8 x i16> %81) #4
  %83 = sitofp <16 x i8> %82 to <16 x double>
  ...
  br label %"for op_packsswb_203.s0.x.x.preheader"

"for op_packsswb_203.s0.x.x.preheader":           ; preds = %"for op_packsswb_203.s0.x.x.preheader", %"for op_packsswb_203.s0.y.preheader"
  %lsr.iv180 = phi ptr [ %scevgep, %"for op_packsswb_203.s0.y.preheader" ], [ %scevgep182, %"for op_packsswb_203.s0.x.x.preheader" ]
  %op_packsswb_203.s0.y = phi i32 [ %op_packsswb_203.min.1, %"for op_packsswb_203.s0.y.preheader" ], [ %151, %"for op_packsswb_203.s0.x.x.preheader" ]
  ...
  %91 = tail call <16 x i8> @llvm.x86.sse2.packsswb.128(<8 x i16> %89, <8 x i16> %90) #4
  ...
  %100 = tail call <16 x i8> @llvm.x86.sse2.packsswb.128(<8 x i16> %98, <8 x i16> %99) #4
  ...
  %109 = tail call <16 x i8> @llvm.x86.sse2.packsswb.128(<8 x i16> %107, <8 x i16> %108) #4
  %110 = sitofp <16 x i8> %109 to <16 x double>
  ...
  %118 = tail call <16 x i8> @llvm.x86.sse2.packsswb.128(<8 x i16> %116, <8 x i16> %117) #4
  %119 = sitofp <16 x i8> %118 to <16 x double>
  ...
  %127 = tail call <16 x i8> @llvm.x86.sse2.packsswb.128(<8 x i16> %125, <8 x i16> %126) #4
  %128 = sitofp <16 x i8> %127 to <16 x double>
  ...
  %136 = tail call <16 x i8> @llvm.x86.sse2.packsswb.128(<8 x i16> %134, <8 x i16> %135) #4
  %137 = sitofp <16 x i8> %136 to <16 x double>
  ...
  %145 = tail call <16 x i8> @llvm.x86.sse2.packsswb.128(<8 x i16> %143, <8 x i16> %144) #4
  %146 = sitofp <16 x i8> %145 to <16 x double>
  ...
  %151 = add nsw i32 %op_packsswb_203.s0.y, 1
  %scevgep182 = getelementptr i1, ptr %lsr.iv180, i64 %6
  %.not2 = icmp eq i32 %151, %0
  br i1 %.not2, label %destructor_block, label %"for op_packsswb_203.s0.x.x.preheader"

destructor_block:                                 ; preds = %"for op_packsswb_203.s0.x.x.preheader", %"produce op_packsswb_203"
  ret i32 0
}

; Function Attrs: nofree nosync nounwind memory(readwrite, inaccessiblemem: none)
define i32 @test_op(ptr noalias nocapture readnone %in_f32.buffer, ptr noalias nocapture readnone %in_f64.buffer, ptr noalias nocapture readnone %in_i8.buffer, ptr noalias nocapture readnone %in_u8.buffer, ptr noalias nocapture readonly %in_i16.buffer, ptr noalias nocapture readnone %in_u16.buffer, ptr noalias nocapture readnone %in_i32.buffer, ptr noalias nocapture readnone %in_u32.buffer, ptr noalias nocapture readnone %in_i64.buffer, ptr noalias nocapture readnone %in_u64.buffer, ptr noalias nocapture readonly %op_packsswb_203.buffer) local_unnamed_addr #2 {
destructor_block:
  %"__test_op_result$12" = tail call i32 @__test_op(ptr poison, ptr poison, ptr poison, ptr poison, ptr %in_i16.buffer, ptr poison, ptr poison, ptr poison, ptr poison, ptr poison, ptr %op_packsswb_203.buffer) #4
  ret i32 0
}
