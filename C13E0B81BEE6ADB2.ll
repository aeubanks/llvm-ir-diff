; ModuleID = '/usr/local/google/home/aeubanks/repos/test-suite/MultiSource/Benchmarks/TSVC/Equivalencing-dbl/tsc.c'
source_filename = "/usr/local/google/home/aeubanks/repos/test-suite/MultiSource/Benchmarks/TSVC/Equivalencing-dbl/tsc.c"
...
@array = dso_local global [65536 x double] zeroinitializer, align 32
...
entry:
  %call = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.1) #14
...
if.else:                                          ; preds = %entry
  %call17 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.2) #14
...
if.else25:                                        ; preds = %if.else
  %call26 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.3) #14
...
if.else31:                                        ; preds = %if.else25
  %call32 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.4) #14
...
if.else37:                                        ; preds = %if.else31
  %call38 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.5) #14
...
if.else43:                                        ; preds = %if.else37
  %call44 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.6) #14
...
if.else51:                                        ; preds = %if.else43
  %call52 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.7) #14
...
if.else56:                                        ; preds = %if.else51
  %call57 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.8) #14
...
if.else62:                                        ; preds = %if.else56
  %call63 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.9) #14
...
if.else68:                                        ; preds = %if.else62
  %call69 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.10) #14
...
if.else74:                                        ; preds = %if.else68
  %call75 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.11) #14
...
if.else80:                                        ; preds = %if.else74
  %call81 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.12) #14
...
if.else89:                                        ; preds = %if.else80
  %call90 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.13) #14
...
if.else98:                                        ; preds = %if.else89
  %call99 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.14) #14
...
if.else106:                                       ; preds = %if.else98
  %call107 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.15) #14
...
if.else113:                                       ; preds = %if.else106
  %call114 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.16) #14
...
if.else122:                                       ; preds = %if.else113
  %call123 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.17) #14
...
if.else130:                                       ; preds = %if.else122
  %call131 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.18) #14
...
if.else136:                                       ; preds = %if.else130
  %call137 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.19) #14
...
if.else143:                                       ; preds = %if.else136
  %call144 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.20) #14
...
if.else149:                                       ; preds = %if.else143
  %call150 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.21) #14
...
if.else155:                                       ; preds = %if.else149
  %call156 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.22) #14
...
if.else164:                                       ; preds = %if.else155
  %call165 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.23) #14
...
if.else174:                                       ; preds = %if.else164
  %call175 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.24) #14
...
if.else181:                                       ; preds = %if.else174
  %call182 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.25) #14
...
if.else187:                                       ; preds = %if.else181
  %call188 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.26) #14
...
if.else193:                                       ; preds = %if.else187
  %call194 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.27) #14
...
if.else199:                                       ; preds = %if.else193
  %call200 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.28) #14
...
if.else205:                                       ; preds = %if.else199
  %call206 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.29) #14
...
if.else211:                                       ; preds = %if.else205
  %call212 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.30) #14
...
if.else218:                                       ; preds = %if.else211
  %call219 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.31) #14
...
if.else227:                                       ; preds = %if.else218
  %call228 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.32) #14
...
if.else235:                                       ; preds = %if.else227
  %call236 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.33) #14
...
if.else243:                                       ; preds = %if.else235
  %call244 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.34) #14
...
if.else250:                                       ; preds = %if.else243
  %call251 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.35) #14
...
if.else256:                                       ; preds = %if.else250
  %call257 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.36) #14
...
if.else262:                                       ; preds = %if.else256
  %call263 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.37) #14
...
if.else269:                                       ; preds = %if.else262
  %call270 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.38) #14
...
if.else276:                                       ; preds = %if.else269
  %call277 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.39) #14
...
if.else285:                                       ; preds = %if.else276
  %call286 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.40) #14
...
if.else293:                                       ; preds = %if.else285
  %call294 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.41) #14
...
if.else301:                                       ; preds = %if.else293
  %call302 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.42) #14
...
if.else310:                                       ; preds = %if.else301
  %call311 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.43) #14
...
if.else318:                                       ; preds = %if.else310
  %call319 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.44) #14
...
if.else327:                                       ; preds = %if.else318
  %call328 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.45) #14
...
if.else334:                                       ; preds = %if.else327
  %call335 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.46) #14
...
if.else342:                                       ; preds = %if.else334
  %call343 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.47) #14
...
if.else348:                                       ; preds = %if.else342
  %call349 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.48) #14
...
if.else354:                                       ; preds = %if.else348
  %call355 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.49) #14
...
if.else361:                                       ; preds = %if.else354
  %call362 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.50) #14
...
if.else368:                                       ; preds = %if.else361
  %call369 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.51) #14
...
if.else378:                                       ; preds = %if.else368
  %call379 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.52) #14
...
if.else386:                                       ; preds = %if.else378
  %call387 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.53) #14
...
if.else393:                                       ; preds = %if.else386
  %call394 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.54) #14
...
if.else402:                                       ; preds = %if.else393
  %call403 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.55) #14
...
if.else411:                                       ; preds = %if.else402
  %call412 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.56) #14
...
if.else420:                                       ; preds = %if.else411
  %call421 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.57) #14
...
if.else427:                                       ; preds = %if.else420
  %call428 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.58) #14
...
if.else435:                                       ; preds = %if.else427
  %call436 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.59) #14
...
if.else446:                                       ; preds = %if.else435
  %call447 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.60) #14
...
if.else457:                                       ; preds = %if.else446
  %call458 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.61) #14
...
if.else468:                                       ; preds = %if.else457
  %call469 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.62) #14
...
if.else477:                                       ; preds = %if.else468
  %call478 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.63) #14
...
if.else484:                                       ; preds = %if.else477
  %call485 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.64) #14
...
if.else491:                                       ; preds = %if.else484
  %call492 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.65) #14
...
if.else498:                                       ; preds = %if.else491
  %call499 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.66) #14
...
if.else504:                                       ; preds = %if.else498
  %call505 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.67) #14
...
if.else510:                                       ; preds = %if.else504
  %call511 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.68) #14
...
if.else515:                                       ; preds = %if.else510
  %call516 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.69) #14
...
if.else522:                                       ; preds = %if.else515
  %call523 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.70) #14
...
if.else527:                                       ; preds = %if.else522
  %call528 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.71) #14
...
if.else532:                                       ; preds = %if.else527
  %call533 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.72) #14
...
if.else537:                                       ; preds = %if.else532
  %call538 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.73) #14
...
if.else542:                                       ; preds = %if.else537
  %call543 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.74) #14
...
if.else548:                                       ; preds = %if.else542
  %call549 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.75) #14
...
if.else553:                                       ; preds = %if.else548
  %call554 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.76) #14
...
if.else558:                                       ; preds = %if.else553
  %call559 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.77) #14
...
if.else563:                                       ; preds = %if.else558
  %call564 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.78) #14
  %tobool565.not = icmp eq i32 %call564, 0
  br i1 %tobool565.not, label %if.end1093, label %if.else567

if.else567:                                       ; preds = %if.else563
  %call568 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.79) #14
...
if.else573:                                       ; preds = %if.else567
  %call574 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.80) #14
...
if.else582:                                       ; preds = %if.else573
  %call583 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.81) #14
...
if.else587:                                       ; preds = %if.else582
  %call588 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.82) #14
...
if.else592:                                       ; preds = %if.else587
  %call593 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.83) #14
...
if.else598:                                       ; preds = %if.else592
  %call599 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.84) #14
...
if.else604:                                       ; preds = %if.else598
  %call605 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.85) #14
...
if.else610:                                       ; preds = %if.else604
  %call611 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.86) #14
...
if.else617:                                       ; preds = %if.else610
  %call618 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.87) #14
...
if.else626:                                       ; preds = %if.else617
  %call627 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.88) #14
...
if.else632:                                       ; preds = %if.else626
  %call633 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.89) #14
...
if.else637:                                       ; preds = %if.else632
  %call638 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.90) #14
...
if.else643:                                       ; preds = %if.else637
  %call644 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.91) #14
...
if.else649:                                       ; preds = %if.else643
  %call650 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.92) #14
...
if.else655:                                       ; preds = %if.else649
  %call656 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.93) #14
...
if.else661:                                       ; preds = %if.else655
  %call662 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.94) #14
...
if.else667:                                       ; preds = %if.else661
  %call668 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.95) #14
...
if.else673:                                       ; preds = %if.else667
  %call674 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.96) #14
...
if.else680:                                       ; preds = %if.else673
  %call681 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.97) #14
...
if.else687:                                       ; preds = %if.else680
  %call688 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.98) #14
...
if.else696:                                       ; preds = %if.else687
  %call697 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.99) #14
...
if.else703:                                       ; preds = %if.else696
  %call704 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.100) #14
...
if.else711:                                       ; preds = %if.else703
  %call712 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.101) #14
...
if.else717:                                       ; preds = %if.else711
  %call718 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.102) #14
...
if.else723:                                       ; preds = %if.else717
  %call724 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.103) #14
...
if.else729:                                       ; preds = %if.else723
  %call730 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.104) #14
...
if.else735:                                       ; preds = %if.else729
  %call736 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.105) #14
...
if.else741:                                       ; preds = %if.else735
  %call742 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.106) #14
...
if.else747:                                       ; preds = %if.else741
  %call748 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.107) #14
...
if.else758:                                       ; preds = %if.else747
  %call759 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.108) #14
...
if.else767:                                       ; preds = %if.else758
  %call768 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.109) #14
...
if.else774:                                       ; preds = %if.else767
  %call775 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.110) #14
...
if.else780:                                       ; preds = %if.else774
  %call781 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.111) #14
...
if.else787:                                       ; preds = %if.else780
  %call788 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.112) #14
...
if.else793:                                       ; preds = %if.else787
  %call794 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.113) #14
...
if.else802:                                       ; preds = %if.else793
  %call803 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.114) #14
...
if.else810:                                       ; preds = %if.else802
  %call811 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.115) #14
...
if.else817:                                       ; preds = %if.else810
  %call818 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.116) #14
...
if.else825:                                       ; preds = %if.else817
  %call826 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.117) #14
...
if.else831:                                       ; preds = %if.else825
  %call832 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.118) #14
...
if.else838:                                       ; preds = %if.else831
  %call839 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.119) #14
...
if.else846:                                       ; preds = %if.else838
  %call847 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.120) #14
...
if.else852:                                       ; preds = %if.else846
  %call853 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.121) #14
...
if.else858:                                       ; preds = %if.else852
  %call859 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.122) #14
...
if.else866:                                       ; preds = %if.else858
  %call867 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.123) #14
...
if.else873:                                       ; preds = %if.else866
  %call874 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(4) @.str.124) #14
...
if.else879:                                       ; preds = %if.else873
  %call880 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.125) #14
...
if.else885:                                       ; preds = %if.else879
  %call886 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.126) #14
...
if.else891:                                       ; preds = %if.else885
  %call892 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.127) #14
...
if.else897:                                       ; preds = %if.else891
  %call898 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.128) #14
...
if.else903:                                       ; preds = %if.else897
  %call904 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.129) #14
...
if.else909:                                       ; preds = %if.else903
  %call910 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.130) #14
...
if.else916:                                       ; preds = %if.else909
  %call917 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.131) #14
...
if.else922:                                       ; preds = %if.else916
  %call923 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.132) #14
...
if.else930:                                       ; preds = %if.else922
  %call931 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.133) #14
...
if.else937:                                       ; preds = %if.else930
  %call938 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.134) #14
...
if.else942:                                       ; preds = %if.else937
  %call943 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.135) #14
...
if.else948:                                       ; preds = %if.else942
  %call949 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(6) @.str.136) #14
...
entry:
  %0 = load ptr, ptr @xx, align 8, !tbaa !367
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %entry
  %index = phi i64 [ 0, %entry ], [ %index.next.4, %vector.body ]
  %1 = getelementptr inbounds double, ptr %0, i64 %index
  store <2 x double> <double 1.000000e+00, double 1.000000e+00>, ptr %1, align 8, !tbaa !5
  %2 = getelementptr inbounds double, ptr %1, i64 2
  store <2 x double> <double 1.000000e+00, double 1.000000e+00>, ptr %2, align 8, !tbaa !5
  %index.next = add nuw nsw i64 %index, 4
  %3 = getelementptr inbounds double, ptr %0, i64 %index.next
  store <2 x double> <double 1.000000e+00, double 1.000000e+00>, ptr %3, align 8, !tbaa !5
  ...
  %5 = getelementptr inbounds double, ptr %0, i64 %index.next.1
  store <2 x double> <double 1.000000e+00, double 1.000000e+00>, ptr %5, align 8, !tbaa !5
  ...
  %7 = getelementptr inbounds double, ptr %0, i64 %index.next.2
  ...
  %index.next.3 = add nuw nsw i64 %index, 16
  %9 = getelementptr inbounds double, ptr %0, i64 %index.next.3
  ...
  %11 = icmp eq i64 %index.next.4, 32000
  br i1 %11, label %set1d.exit, label %vector.body, !llvm.loop !369

set1d.exit:                                       ; preds = %vector.body
  %call1 = tail call i32 @init(ptr noundef nonnull @.str.101)
  %12 = load i32, ptr @ntimes, align 4, !tbaa !17
  %cmp37 = icmp sgt i32 %12, 0
  br i1 %cmp37, label %for.body, label %for.cond.cleanup

for.cond.cleanup:                                 ; preds = %for.cond.cleanup4, %set1d.exit
  %call15 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.137, double noundef 0.000000e+00)
  store double 0.000000e+00, ptr @temp, align 8, !tbaa !5
  %13 = load ptr, ptr @xx, align 8, !tbaa !367
  br label %for.body21

for.body:                                         ; preds = %set1d.exit, %for.cond.cleanup4
  %nl.038 = phi i32 [ %inc13, %for.cond.cleanup4 ], [ 0, %set1d.exit ]
  %14 = load ptr, ptr @xx, align 8, !tbaa !367
  store ptr %14, ptr @yy, align 8, !tbaa !367
  %scevgep = getelementptr i8, ptr %14, i64 256000
  %bound0 = icmp ult ptr %14, getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 0, i64 31999)
  %bound1 = icmp ugt ptr %scevgep, @global_data
  %found.conflict = and i1 %bound0, %bound1
  br i1 %found.conflict, label %for.body5.prol, label %vector.body53

for.body5.prol:                                   ; preds = %vector.body53, %for.body
  %indvars.iv.ph = phi i64 [ 0, %for.body ], [ 31996, %vector.body53 ]
  %indvars.iv.next.prol = or i64 %indvars.iv.ph, 1
  %arrayidx.prol = getelementptr inbounds double, ptr %14, i64 %indvars.iv.next.prol
  %15 = load double, ptr %arrayidx.prol, align 8, !tbaa !5
  %arrayidx7.prol = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv.ph
  %16 = load double, ptr %arrayidx7.prol, align 32, !tbaa !5
  %add8.prol = fadd double %15, %16
  %arrayidx10.prol = getelementptr inbounds double, ptr %14, i64 %indvars.iv.ph
  store double %add8.prol, ptr %arrayidx10.prol, align 8, !tbaa !5
  br label %for.body5

vector.body53:                                    ; preds = %for.body, %vector.body53.1
  %index54 = phi i64 [ %index.next58.1, %vector.body53.1 ], [ 0, %for.body ]
  %17 = or i64 %index54, 1
  %18 = getelementptr inbounds double, ptr %14, i64 %17
  %wide.load = load <2 x double>, ptr %18, align 8, !tbaa !5, !alias.scope !370, !noalias !373
  %19 = getelementptr inbounds double, ptr %18, i64 2
  %wide.load55 = load <2 x double>, ptr %19, align 8, !tbaa !5, !alias.scope !370, !noalias !373
  %20 = getelementptr inbounds double, ptr @global_data, i64 %index54
  %wide.load56 = load <2 x double>, ptr %20, align 32, !tbaa !5, !alias.scope !373
  %21 = getelementptr inbounds double, ptr %20, i64 2
  %wide.load57 = load <2 x double>, ptr %21, align 16, !tbaa !5, !alias.scope !373
  %22 = fadd <2 x double> %wide.load, %wide.load56
  %23 = fadd <2 x double> %wide.load55, %wide.load57
  %24 = getelementptr inbounds double, ptr %14, i64 %index54
  store <2 x double> %22, ptr %24, align 8, !tbaa !5, !alias.scope !370, !noalias !373
  %25 = getelementptr inbounds double, ptr %24, i64 2
  store <2 x double> %23, ptr %25, align 8, !tbaa !5, !alias.scope !370, !noalias !373
  %index.next58 = or i64 %index54, 4
  %26 = icmp eq i64 %index.next58, 31996
  br i1 %26, label %for.body5.prol, label %vector.body53.1, !llvm.loop !375

vector.body53.1:                                  ; preds = %vector.body53
  %27 = or i64 %index54, 5
  %28 = getelementptr inbounds double, ptr %14, i64 %27
  %wide.load.1 = load <2 x double>, ptr %28, align 8, !tbaa !5, !alias.scope !370, !noalias !373
  %29 = getelementptr inbounds double, ptr %28, i64 2
  %wide.load55.1 = load <2 x double>, ptr %29, align 8, !tbaa !5, !alias.scope !370, !noalias !373
  %30 = getelementptr inbounds double, ptr @global_data, i64 %index.next58
  %wide.load56.1 = load <2 x double>, ptr %30, align 32, !tbaa !5, !alias.scope !373
  %31 = getelementptr inbounds double, ptr %30, i64 2
  %wide.load57.1 = load <2 x double>, ptr %31, align 16, !tbaa !5, !alias.scope !373
  %32 = fadd <2 x double> %wide.load.1, %wide.load56.1
  %33 = fadd <2 x double> %wide.load55.1, %wide.load57.1
  %34 = getelementptr inbounds double, ptr %14, i64 %index.next58
  store <2 x double> %32, ptr %34, align 8, !tbaa !5, !alias.scope !370, !noalias !373
  %35 = getelementptr inbounds double, ptr %34, i64 2
  store <2 x double> %33, ptr %35, align 8, !tbaa !5, !alias.scope !370, !noalias !373
  %index.next58.1 = add nuw nsw i64 %index54, 8
  br label %vector.body53

for.cond.cleanup4:                                ; preds = %for.body5
  %call11 = tail call i32 @dummy(ptr noundef nonnull @global_data, ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 11, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 20, i64 0, i64 0), double noundef 1.000000e+00) #15
  %inc13 = add nuw nsw i32 %nl.038, 1
  %36 = load i32, ptr @ntimes, align 4, !tbaa !17
  %mul = shl nsw i32 %36, 2
  %cmp = icmp slt i32 %inc13, %mul
  br i1 %cmp, label %for.body, label %for.cond.cleanup

for.body5:                                        ; preds = %for.body5, %for.body5.prol
  %indvars.iv = phi i64 [ %indvars.iv.next.prol, %for.body5.prol ], [ %indvars.iv.next.1, %for.body5 ]
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %arrayidx = getelementptr inbounds double, ptr %14, i64 %indvars.iv.next
  %37 = load double, ptr %arrayidx, align 8, !tbaa !5
  %arrayidx7 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv
  %38 = load double, ptr %arrayidx7, align 8, !tbaa !5
  %add8 = fadd double %37, %38
  %arrayidx10 = getelementptr inbounds double, ptr %14, i64 %indvars.iv
  store double %add8, ptr %arrayidx10, align 8, !tbaa !5
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %arrayidx.1 = getelementptr inbounds double, ptr %14, i64 %indvars.iv.next.1
  %39 = load double, ptr %arrayidx.1, align 8, !tbaa !5
  %arrayidx7.1 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv.next
  %40 = load double, ptr %arrayidx7.1, align 8, !tbaa !5
  %add8.1 = fadd double %39, %40
  %arrayidx10.1 = getelementptr inbounds double, ptr %14, i64 %indvars.iv.next
  store double %add8.1, ptr %arrayidx10.1, align 8, !tbaa !5
  %exitcond43.not.1 = icmp eq i64 %indvars.iv.next.1, 31999
  br i1 %exitcond43.not.1, label %for.cond.cleanup4, label %for.body5, !llvm.loop !376

for.body21:                                       ; preds = %for.body21, %for.cond.cleanup
  %indvars.iv44 = phi i64 [ 0, %for.cond.cleanup ], [ %indvars.iv.next45.4, %for.body21 ]
  %add243940 = phi double [ 0.000000e+00, %for.cond.cleanup ], [ %add24.4, %for.body21 ]
  %arrayidx23 = getelementptr inbounds double, ptr %13, i64 %indvars.iv44
  %41 = load double, ptr %arrayidx23, align 8, !tbaa !5
  %add24 = fadd double %41, %add243940
  store double %add24, ptr @temp, align 8, !tbaa !5
  %indvars.iv.next45 = add nuw nsw i64 %indvars.iv44, 1
  %arrayidx23.1 = getelementptr inbounds double, ptr %13, i64 %indvars.iv.next45
  %42 = load double, ptr %arrayidx23.1, align 8, !tbaa !5
  %add24.1 = fadd double %42, %add24
  store double %add24.1, ptr @temp, align 8, !tbaa !5
  %indvars.iv.next45.1 = add nuw nsw i64 %indvars.iv44, 2
  %arrayidx23.2 = getelementptr inbounds double, ptr %13, i64 %indvars.iv.next45.1
  %43 = load double, ptr %arrayidx23.2, align 8, !tbaa !5
  %add24.2 = fadd double %43, %add24.1
  store double %add24.2, ptr @temp, align 8, !tbaa !5
  %indvars.iv.next45.2 = add nuw nsw i64 %indvars.iv44, 3
  %arrayidx23.3 = getelementptr inbounds double, ptr %13, i64 %indvars.iv.next45.2
  %44 = load double, ptr %arrayidx23.3, align 8, !tbaa !5
  %add24.3 = fadd double %44, %add24.2
  store double %add24.3, ptr @temp, align 8, !tbaa !5
  %indvars.iv.next45.3 = add nuw nsw i64 %indvars.iv44, 4
  %arrayidx23.4 = getelementptr inbounds double, ptr %13, i64 %indvars.iv.next45.3
  %45 = load double, ptr %arrayidx23.4, align 8, !tbaa !5
  %add24.4 = fadd double %45, %add24.3
  store double %add24.4, ptr @temp, align 8, !tbaa !5
  %indvars.iv.next45.4 = add nuw nsw i64 %indvars.iv44, 5
  %exitcond47.not.4 = icmp eq i64 %indvars.iv.next45.4, 32000
  br i1 %exitcond47.not.4, label %for.body.i.preheader, label %for.body21

for.body.i.preheader:                             ; preds = %for.body21
  %46 = load i32, ptr @digits, align 4, !tbaa !17
  %call126.i = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %46, double noundef %add24.4)
  ret i32 0
}
...
vector.body:                                      ; preds = %vector.body, %entry
  ...
  %index.next.4 = add nuw nsw i64 %index, 20
  %11 = icmp eq i64 %index.next.4, 32000
  br i1 %11, label %set1d.exit, label %vector.body, !llvm.loop !377

set1d.exit:                                       ; preds = %vector.body
  %call1 = tail call i32 @init(ptr noundef nonnull @.str.101)
  store ptr getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 16000), ptr @xx, align 8, !tbaa !367
  %12 = load i32, ptr @ntimes, align 4, !tbaa !17
  %cmp36 = icmp sgt i32 %12, 0
  br i1 %cmp36, label %for.cond2.preheader, label %for.cond.cleanup

for.cond2.preheader:                              ; preds = %set1d.exit, %for.cond.cleanup4
  %nl.037 = phi i32 [ %inc12, %for.cond.cleanup4 ], [ 0, %set1d.exit ]
  %13 = load ptr, ptr @xx, align 8, !tbaa !367
  %scevgep = getelementptr i8, ptr %13, i64 128000
  %bound0 = icmp ugt ptr %scevgep, @global_data
  %bound1 = icmp ult ptr %13, getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 16000)
  %found.conflict = and i1 %bound0, %bound1
  br i1 %found.conflict, label %for.body5, label %vector.body52

vector.body52:                                    ; preds = %for.cond2.preheader, %vector.body52
  %index53 = phi i64 [ %index.next57.1, %vector.body52 ], [ 0, %for.cond2.preheader ]
  %14 = getelementptr inbounds double, ptr %13, i64 %index53
  %wide.load = load <2 x double>, ptr %14, align 8, !tbaa !5, !alias.scope !378
  %15 = getelementptr inbounds double, ptr %14, i64 2
  %wide.load54 = load <2 x double>, ptr %15, align 8, !tbaa !5, !alias.scope !378
  %16 = getelementptr inbounds double, ptr @global_data, i64 %index53
  %wide.load55 = load <2 x double>, ptr %16, align 32, !tbaa !5, !alias.scope !381, !noalias !378
  %17 = getelementptr inbounds double, ptr %16, i64 2
  %wide.load56 = load <2 x double>, ptr %17, align 16, !tbaa !5, !alias.scope !381, !noalias !378
  %18 = fadd <2 x double> %wide.load, %wide.load55
  %19 = fadd <2 x double> %wide.load54, %wide.load56
  %20 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %index53
  store <2 x double> %18, ptr %20, align 32, !tbaa !5, !alias.scope !381, !noalias !378
  %21 = getelementptr inbounds double, ptr %20, i64 2
  store <2 x double> %19, ptr %21, align 16, !tbaa !5, !alias.scope !381, !noalias !378
  %index.next57 = or i64 %index53, 4
  %22 = getelementptr inbounds double, ptr %13, i64 %index.next57
  %wide.load.1 = load <2 x double>, ptr %22, align 8, !tbaa !5, !alias.scope !378
  %23 = getelementptr inbounds double, ptr %22, i64 2
  %wide.load54.1 = load <2 x double>, ptr %23, align 8, !tbaa !5, !alias.scope !378
  %24 = getelementptr inbounds double, ptr @global_data, i64 %index.next57
  %wide.load55.1 = load <2 x double>, ptr %24, align 32, !tbaa !5, !alias.scope !381, !noalias !378
  %25 = getelementptr inbounds double, ptr %24, i64 2
  %wide.load56.1 = load <2 x double>, ptr %25, align 16, !tbaa !5, !alias.scope !381, !noalias !378
  %26 = fadd <2 x double> %wide.load.1, %wide.load55.1
  %27 = fadd <2 x double> %wide.load54.1, %wide.load56.1
  %28 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %index.next57
  store <2 x double> %26, ptr %28, align 32, !tbaa !5, !alias.scope !381, !noalias !378
  %29 = getelementptr inbounds double, ptr %28, i64 2
  store <2 x double> %27, ptr %29, align 16, !tbaa !5, !alias.scope !381, !noalias !378
  %index.next57.1 = add nuw nsw i64 %index53, 8
  %30 = icmp eq i64 %index.next57.1, 16000
  br i1 %30, label %for.cond.cleanup4, label %vector.body52, !llvm.loop !383

for.cond.cleanup:                                 ; preds = %for.cond.cleanup4, %set1d.exit
  %call14 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.138, double noundef 0.000000e+00)
  store double 0.000000e+00, ptr @temp, align 8, !tbaa !5
  %31 = load ptr, ptr @xx, align 8, !tbaa !367
  br label %for.body20

for.cond.cleanup4:                                ; preds = %vector.body52, %for.body5
  ...
  %inc12 = add nuw nsw i32 %nl.037, 1
  %32 = load i32, ptr @ntimes, align 4, !tbaa !17
  %mul = shl nsw i32 %32, 3
...
for.body5:                                        ; preds = %for.cond2.preheader, %for.body5
  %indvars.iv = phi i64 [ %indvars.iv.next.1, %for.body5 ], [ 0, %for.cond2.preheader ]
  %arrayidx = getelementptr inbounds double, ptr %13, i64 %indvars.iv
  %33 = load double, ptr %arrayidx, align 8, !tbaa !5
  %arrayidx7 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv
  %34 = load double, ptr %arrayidx7, align 16, !tbaa !5
  %add = fadd double %33, %34
  %arrayidx9 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %indvars.iv
  store double %add, ptr %arrayidx9, align 16, !tbaa !5
  %indvars.iv.next = or i64 %indvars.iv, 1
  %arrayidx.1 = getelementptr inbounds double, ptr %13, i64 %indvars.iv.next
  %35 = load double, ptr %arrayidx.1, align 8, !tbaa !5
  %arrayidx7.1 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv.next
  %36 = load double, ptr %arrayidx7.1, align 8, !tbaa !5
  %add.1 = fadd double %35, %36
  %arrayidx9.1 = getelementptr inbounds %struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 %indvars.iv.next
  store double %add.1, ptr %arrayidx9.1, align 8, !tbaa !5
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %exitcond42.not.1 = icmp eq i64 %indvars.iv.next.1, 16000
  br i1 %exitcond42.not.1, label %for.cond.cleanup4, label %for.body5, !llvm.loop !384

for.body20:                                       ; preds = %for.body20, %for.cond.cleanup
  %indvars.iv43 = phi i64 [ 0, %for.cond.cleanup ], [ %indvars.iv.next44.4, %for.body20 ]
  %add233839 = phi double [ 0.000000e+00, %for.cond.cleanup ], [ %add23.4, %for.body20 ]
  %arrayidx22 = getelementptr inbounds double, ptr %31, i64 %indvars.iv43
  %37 = load double, ptr %arrayidx22, align 8, !tbaa !5
  %add23 = fadd double %37, %add233839
  store double %add23, ptr @temp, align 8, !tbaa !5
  %indvars.iv.next44 = add nuw nsw i64 %indvars.iv43, 1
  %arrayidx22.1 = getelementptr inbounds double, ptr %31, i64 %indvars.iv.next44
  %38 = load double, ptr %arrayidx22.1, align 8, !tbaa !5
  %add23.1 = fadd double %38, %add23
  store double %add23.1, ptr @temp, align 8, !tbaa !5
  %indvars.iv.next44.1 = add nuw nsw i64 %indvars.iv43, 2
  %arrayidx22.2 = getelementptr inbounds double, ptr %31, i64 %indvars.iv.next44.1
  %39 = load double, ptr %arrayidx22.2, align 8, !tbaa !5
  %add23.2 = fadd double %39, %add23.1
  store double %add23.2, ptr @temp, align 8, !tbaa !5
  %indvars.iv.next44.2 = add nuw nsw i64 %indvars.iv43, 3
  %arrayidx22.3 = getelementptr inbounds double, ptr %31, i64 %indvars.iv.next44.2
  %40 = load double, ptr %arrayidx22.3, align 8, !tbaa !5
  %add23.3 = fadd double %40, %add23.2
  store double %add23.3, ptr @temp, align 8, !tbaa !5
  %indvars.iv.next44.3 = add nuw nsw i64 %indvars.iv43, 4
  %arrayidx22.4 = getelementptr inbounds double, ptr %31, i64 %indvars.iv.next44.3
  %41 = load double, ptr %arrayidx22.4, align 8, !tbaa !5
  %add23.4 = fadd double %41, %add23.3
  store double %add23.4, ptr @temp, align 8, !tbaa !5
  %indvars.iv.next44.4 = add nuw nsw i64 %indvars.iv43, 5
  %exitcond46.not.4 = icmp eq i64 %indvars.iv.next44.4, 16000
  br i1 %exitcond46.not.4, label %for.body.i.preheader, label %for.body20

for.body.i.preheader:                             ; preds = %for.body20
  %42 = load i32, ptr @digits, align 4, !tbaa !17
  %call126.i = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %42, double noundef %add23.4)
  ret i32 0
}
...
entry:
  store ptr getelementptr inbounds ([65536 x double], ptr @array, i64 0, i64 4), ptr @xx, align 8, !tbaa !367
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 32 dereferenceable(256000) getelementptr inbounds ([65536 x double], ptr @array, i64 0, i64 4), i8 0, i64 256000, i1 false), !tbaa !5
  %call1 = tail call i32 @init(ptr noundef nonnull @.str.102)
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
  %cmp37 = icmp sgt i32 %0, 0
  br i1 %cmp37, label %for.cond2.preheader, label %for.cond.cleanup

for.cond2.preheader:                              ; preds = %entry, %for.cond.cleanup4
  %nl.038 = phi i32 [ %inc13, %for.cond.cleanup4 ], [ 0, %entry ]
  %1 = load ptr, ptr @xx, align 8, !tbaa !367
  %2 = ptrtoint ptr %1 to i64
  %3 = sub i64 %2, add (i64 ptrtoint (ptr @array to i64), i64 64)
  %diff.check = icmp ult i64 %3, 32
  %4 = sub i64 %2, ptrtoint (ptr @global_data to i64)
  %diff.check48 = icmp ult i64 %4, 32
  %conflict.rdx = or i1 %diff.check, %diff.check48
  br i1 %conflict.rdx, label %for.body5, label %vector.body

vector.body:                                      ; preds = %for.cond2.preheader, %vector.body
  %index = phi i64 [ %index.next.1, %vector.body ], [ 0, %for.cond2.preheader ]
  %5 = add nuw nsw i64 %index, 8
  %6 = getelementptr inbounds [65536 x double], ptr @array, i64 0, i64 %5
  %wide.load = load <2 x double>, ptr %6, align 32, !tbaa !5
  %7 = getelementptr inbounds double, ptr %6, i64 2
  %wide.load49 = load <2 x double>, ptr %7, align 16, !tbaa !5
  %8 = getelementptr inbounds double, ptr @global_data, i64 %index
  %wide.load50 = load <2 x double>, ptr %8, align 32, !tbaa !5
  %9 = getelementptr inbounds double, ptr %8, i64 2
  %wide.load51 = load <2 x double>, ptr %9, align 16, !tbaa !5
  %10 = fadd <2 x double> %wide.load, %wide.load50
  %11 = fadd <2 x double> %wide.load49, %wide.load51
  ...
  %index.next = or i64 %index, 4
  %14 = add nuw nsw i64 %index, 12
  %15 = getelementptr inbounds [65536 x double], ptr @array, i64 0, i64 %14
  %wide.load.1 = load <2 x double>, ptr %15, align 32, !tbaa !5
  %16 = getelementptr inbounds double, ptr %15, i64 2
  %wide.load49.1 = load <2 x double>, ptr %16, align 16, !tbaa !5
  %17 = getelementptr inbounds double, ptr @global_data, i64 %index.next
  %wide.load50.1 = load <2 x double>, ptr %17, align 32, !tbaa !5
  %18 = getelementptr inbounds double, ptr %17, i64 2
  %wide.load51.1 = load <2 x double>, ptr %18, align 16, !tbaa !5
  %19 = fadd <2 x double> %wide.load.1, %wide.load50.1
  %20 = fadd <2 x double> %wide.load49.1, %wide.load51.1
  %21 = getelementptr inbounds double, ptr %1, i64 %index.next
  store <2 x double> %19, ptr %21, align 8, !tbaa !5
  %22 = getelementptr inbounds double, ptr %21, i64 2
  store <2 x double> %20, ptr %22, align 8, !tbaa !5
  %index.next.1 = add nuw nsw i64 %index, 8
  %23 = icmp eq i64 %index.next.1, 32000
  br i1 %23, label %for.cond.cleanup4, label %vector.body, !llvm.loop !385

for.cond.cleanup:                                 ; preds = %for.cond.cleanup4, %entry
  %call15 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.139, double noundef 0.000000e+00)
  store double 0.000000e+00, ptr @temp, align 8, !tbaa !5
  %24 = load ptr, ptr @xx, align 8, !tbaa !367
  br label %for.body21

for.cond.cleanup4:                                ; preds = %vector.body, %for.body5
  %call11 = tail call i32 @dummy(ptr noundef nonnull @global_data, ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 11, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 20, i64 0, i64 0), double noundef 0.000000e+00) #15
  %inc13 = add nuw nsw i32 %nl.038, 1
  %25 = load i32, ptr @ntimes, align 4, !tbaa !17
  %mul = shl nsw i32 %25, 3
  %cmp = icmp slt i32 %inc13, %mul
  br i1 %cmp, label %for.cond2.preheader, label %for.cond.cleanup

for.body5:                                        ; preds = %for.cond2.preheader, %for.body5
  %indvars.iv = phi i64 [ %indvars.iv.next.1, %for.body5 ], [ 0, %for.cond2.preheader ]
  %26 = add nuw nsw i64 %indvars.iv, 8
  %arrayidx = getelementptr inbounds [65536 x double], ptr @array, i64 0, i64 %26
  %27 = load double, ptr %arrayidx, align 16, !tbaa !5
  %arrayidx7 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv
  %28 = load double, ptr %arrayidx7, align 16, !tbaa !5
  %add8 = fadd double %27, %28
  %arrayidx10 = getelementptr inbounds double, ptr %1, i64 %indvars.iv
  store double %add8, ptr %arrayidx10, align 8, !tbaa !5
  %indvars.iv.next = or i64 %indvars.iv, 1
  %29 = add nuw nsw i64 %indvars.iv, 9
  %arrayidx.1 = getelementptr inbounds [65536 x double], ptr @array, i64 0, i64 %29
  %30 = load double, ptr %arrayidx.1, align 8, !tbaa !5
  %arrayidx7.1 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv.next
  %31 = load double, ptr %arrayidx7.1, align 8, !tbaa !5
  %add8.1 = fadd double %30, %31
  %arrayidx10.1 = getelementptr inbounds double, ptr %1, i64 %indvars.iv.next
  store double %add8.1, ptr %arrayidx10.1, align 8, !tbaa !5
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %exitcond.not.1 = icmp eq i64 %indvars.iv.next.1, 32000
  br i1 %exitcond.not.1, label %for.cond.cleanup4, label %for.body5, !llvm.loop !386

for.body21:                                       ; preds = %for.body21, %for.cond.cleanup
  %indvars.iv44 = phi i64 [ 0, %for.cond.cleanup ], [ %indvars.iv.next45.4, %for.body21 ]
  %add243940 = phi double [ 0.000000e+00, %for.cond.cleanup ], [ %add24.4, %for.body21 ]
  %arrayidx23 = getelementptr inbounds double, ptr %24, i64 %indvars.iv44
  %32 = load double, ptr %arrayidx23, align 8, !tbaa !5
  %add24 = fadd double %32, %add243940
  store double %add24, ptr @temp, align 8, !tbaa !5
  %indvars.iv.next45 = add nuw nsw i64 %indvars.iv44, 1
  %arrayidx23.1 = getelementptr inbounds double, ptr %24, i64 %indvars.iv.next45
  %33 = load double, ptr %arrayidx23.1, align 8, !tbaa !5
  %add24.1 = fadd double %33, %add24
  store double %add24.1, ptr @temp, align 8, !tbaa !5
  %indvars.iv.next45.1 = add nuw nsw i64 %indvars.iv44, 2
  %arrayidx23.2 = getelementptr inbounds double, ptr %24, i64 %indvars.iv.next45.1
  %34 = load double, ptr %arrayidx23.2, align 8, !tbaa !5
  %add24.2 = fadd double %34, %add24.1
  store double %add24.2, ptr @temp, align 8, !tbaa !5
  %indvars.iv.next45.2 = add nuw nsw i64 %indvars.iv44, 3
  %arrayidx23.3 = getelementptr inbounds double, ptr %24, i64 %indvars.iv.next45.2
  %35 = load double, ptr %arrayidx23.3, align 8, !tbaa !5
  %add24.3 = fadd double %35, %add24.2
  store double %add24.3, ptr @temp, align 8, !tbaa !5
  %indvars.iv.next45.3 = add nuw nsw i64 %indvars.iv44, 4
  %arrayidx23.4 = getelementptr inbounds double, ptr %24, i64 %indvars.iv.next45.3
  %36 = load double, ptr %arrayidx23.4, align 8, !tbaa !5
  %add24.4 = fadd double %36, %add24.3
  store double %add24.4, ptr @temp, align 8, !tbaa !5
  %indvars.iv.next45.4 = add nuw nsw i64 %indvars.iv44, 5
  %exitcond47.not.4 = icmp eq i64 %indvars.iv.next45.4, 32000
  br i1 %exitcond47.not.4, label %for.body.i.preheader, label %for.body21
...
for.body.i.preheader:                             ; preds = %for.body21
  %37 = load i32, ptr @digits, align 4, !tbaa !17
  %call126.i = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %37, double noundef %add24.4)
  ret i32 0
}
...
entry:
  store ptr getelementptr inbounds ([65536 x double], ptr @array, i64 0, i64 64), ptr @xx, align 8, !tbaa !367
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %entry
  %index = phi i64 [ 0, %entry ], [ %index.next.4, %vector.body ]
  %0 = getelementptr inbounds double, ptr getelementptr inbounds ([65536 x double], ptr @array, i64 0, i64 64), i64 %index
  ...
  %index.next = add nuw nsw i64 %index, 4
  %2 = getelementptr inbounds double, ptr getelementptr inbounds ([65536 x double], ptr @array, i64 0, i64 64), i64 %index.next
  ...
  %index.next.1 = add nuw nsw i64 %index, 8
  %4 = getelementptr inbounds double, ptr getelementptr inbounds ([65536 x double], ptr @array, i64 0, i64 64), i64 %index.next.1
  ...
  %index.next.2 = add nuw nsw i64 %index, 12
  %6 = getelementptr inbounds double, ptr getelementptr inbounds ([65536 x double], ptr @array, i64 0, i64 64), i64 %index.next.2
  ...
  %index.next.3 = add nuw nsw i64 %index, 16
  %8 = getelementptr inbounds double, ptr getelementptr inbounds ([65536 x double], ptr @array, i64 0, i64 64), i64 %index.next.3
  ...
  %index.next.4 = add nuw nsw i64 %index, 20
  %10 = icmp eq i64 %index.next.4, 32000
  br i1 %10, label %set1d.exit, label %vector.body, !llvm.loop !387

set1d.exit:                                       ; preds = %vector.body
  %call1 = tail call i32 @init(ptr noundef nonnull @.str.103)
...
for.cond2.preheader:                              ; preds = %set1d.exit, %for.cond.cleanup4
  %nl.038 = phi i32 [ %inc13, %for.cond.cleanup4 ], [ 0, %set1d.exit ]
  %12 = load ptr, ptr @xx, align 8, !tbaa !367
  %13 = ptrtoint ptr %12 to i64
  %14 = sub i64 add (i64 ptrtoint (ptr @array to i64), i64 8), %13
  %diff.check = icmp ult i64 %14, 32
  %conflict.rdx = or i1 %diff.check, icmp ult (i64 sub (i64 add (i64 ptrtoint (ptr @array to i64), i64 8), i64 ptrtoint (ptr @global_data to i64)), i64 32)
  br i1 %conflict.rdx, label %for.body5.prol, label %vector.body53

for.body5.prol:                                   ; preds = %vector.body53, %for.cond2.preheader
  %indvars.iv.ph = phi i64 [ 0, %for.cond2.preheader ], [ 31996, %vector.body53 ]
  %arrayidx.prol = getelementptr inbounds double, ptr %12, i64 %indvars.iv.ph
  %15 = load double, ptr %arrayidx.prol, align 8, !tbaa !5
  %arrayidx7.prol = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv.ph
  %16 = load double, ptr %arrayidx7.prol, align 32, !tbaa !5
  %add.prol = fadd double %15, %16
  %indvars.iv.next.prol = or i64 %indvars.iv.ph, 1
  %arrayidx10.prol = getelementptr inbounds [65536 x double], ptr @array, i64 0, i64 %indvars.iv.next.prol
  store double %add.prol, ptr %arrayidx10.prol, align 8, !tbaa !5
  br label %for.body5

vector.body53:                                    ; preds = %for.cond2.preheader, %vector.body53.1
  %index54 = phi i64 [ %index.next58.1, %vector.body53.1 ], [ 0, %for.cond2.preheader ]
  %17 = getelementptr inbounds double, ptr %12, i64 %index54
  %wide.load = load <2 x double>, ptr %17, align 8, !tbaa !5
  %18 = getelementptr inbounds double, ptr %17, i64 2
  %wide.load55 = load <2 x double>, ptr %18, align 8, !tbaa !5
  %19 = getelementptr inbounds double, ptr @global_data, i64 %index54
  %wide.load56 = load <2 x double>, ptr %19, align 32, !tbaa !5
  %20 = getelementptr inbounds double, ptr %19, i64 2
  %wide.load57 = load <2 x double>, ptr %20, align 16, !tbaa !5
  %21 = fadd <2 x double> %wide.load, %wide.load56
  %22 = fadd <2 x double> %wide.load55, %wide.load57
  %23 = or i64 %index54, 1
  %24 = getelementptr inbounds [65536 x double], ptr @array, i64 0, i64 %23
  store <2 x double> %21, ptr %24, align 8, !tbaa !5
  %25 = getelementptr inbounds double, ptr %24, i64 2
  store <2 x double> %22, ptr %25, align 8, !tbaa !5
  %index.next58 = or i64 %index54, 4
  %26 = icmp eq i64 %index.next58, 31996
  br i1 %26, label %for.body5.prol, label %vector.body53.1, !llvm.loop !388

vector.body53.1:                                  ; preds = %vector.body53
  %27 = getelementptr inbounds double, ptr %12, i64 %index.next58
  %wide.load.1 = load <2 x double>, ptr %27, align 8, !tbaa !5
  %28 = getelementptr inbounds double, ptr %27, i64 2
  %wide.load55.1 = load <2 x double>, ptr %28, align 8, !tbaa !5
  %29 = getelementptr inbounds double, ptr @global_data, i64 %index.next58
  %wide.load56.1 = load <2 x double>, ptr %29, align 32, !tbaa !5
  %30 = getelementptr inbounds double, ptr %29, i64 2
  %wide.load57.1 = load <2 x double>, ptr %30, align 16, !tbaa !5
  %31 = fadd <2 x double> %wide.load.1, %wide.load56.1
  %32 = fadd <2 x double> %wide.load55.1, %wide.load57.1
  %33 = or i64 %index54, 5
  %34 = getelementptr inbounds [65536 x double], ptr @array, i64 0, i64 %33
  store <2 x double> %31, ptr %34, align 8, !tbaa !5
  %35 = getelementptr inbounds double, ptr %34, i64 2
  store <2 x double> %32, ptr %35, align 8, !tbaa !5
  %index.next58.1 = add nuw nsw i64 %index54, 8
  br label %vector.body53

for.cond.cleanup:                                 ; preds = %for.cond.cleanup4, %set1d.exit
  %call15 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.140, double noundef 0.000000e+00)
  br label %for.body21
...
for.body5:                                        ; preds = %for.body5, %for.body5.prol
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %arrayidx10 = getelementptr inbounds [65536 x double], ptr @array, i64 0, i64 %indvars.iv.next
  store double %add, ptr %arrayidx10, align 8, !tbaa !5
  %arrayidx.1 = getelementptr inbounds double, ptr %12, i64 %indvars.iv.next
  %39 = load double, ptr %arrayidx.1, align 8, !tbaa !5
  %arrayidx7.1 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv.next
  %40 = load double, ptr %arrayidx7.1, align 8, !tbaa !5
  %add.1 = fadd double %39, %40
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %arrayidx10.1 = getelementptr inbounds [65536 x double], ptr @array, i64 0, i64 %indvars.iv.next.1
  store double %add.1, ptr %arrayidx10.1, align 8, !tbaa !5
  %exitcond43.not.1 = icmp eq i64 %indvars.iv.next.1, 31999
  br i1 %exitcond43.not.1, label %for.cond.cleanup4, label %for.body5, !llvm.loop !389

for.body.i.preheader:                             ; preds = %for.body21
  store double %add24.4, ptr @temp, align 8, !tbaa !5
  %41 = load i32, ptr @digits, align 4, !tbaa !17
  %call126.i = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %41, double noundef %add24.4)
  ret i32 0

for.body21:                                       ; preds = %for.body21, %for.cond.cleanup
  %indvars.iv44 = phi i64 [ 0, %for.cond.cleanup ], [ %indvars.iv.next45.4, %for.body21 ]
  %add243940 = phi double [ 0.000000e+00, %for.cond.cleanup ], [ %add24.4, %for.body21 ]
  %arrayidx23 = getelementptr inbounds [65536 x double], ptr @array, i64 0, i64 %indvars.iv44
  %42 = load double, ptr %arrayidx23, align 8, !tbaa !5
  %add24 = fadd double %42, %add243940
  %indvars.iv.next45 = add nuw nsw i64 %indvars.iv44, 1
  %arrayidx23.1 = getelementptr inbounds [65536 x double], ptr @array, i64 0, i64 %indvars.iv.next45
  %43 = load double, ptr %arrayidx23.1, align 8, !tbaa !5
  %add24.1 = fadd double %43, %add24
  %indvars.iv.next45.1 = add nuw nsw i64 %indvars.iv44, 2
  %arrayidx23.2 = getelementptr inbounds [65536 x double], ptr @array, i64 0, i64 %indvars.iv.next45.1
  %44 = load double, ptr %arrayidx23.2, align 8, !tbaa !5
  %add24.2 = fadd double %44, %add24.1
  %indvars.iv.next45.2 = add nuw nsw i64 %indvars.iv44, 3
  %arrayidx23.3 = getelementptr inbounds [65536 x double], ptr @array, i64 0, i64 %indvars.iv.next45.2
  %45 = load double, ptr %arrayidx23.3, align 8, !tbaa !5
  %add24.3 = fadd double %45, %add24.2
  %indvars.iv.next45.3 = add nuw nsw i64 %indvars.iv44, 4
  %arrayidx23.4 = getelementptr inbounds [65536 x double], ptr @array, i64 0, i64 %indvars.iv.next45.3
  %46 = load double, ptr %arrayidx23.4, align 8, !tbaa !5
  %add24.4 = fadd double %46, %add24.3
  %indvars.iv.next45.4 = add nuw nsw i64 %indvars.iv44, 5
  %exitcond47.not.4 = icmp eq i64 %indvars.iv.next45.4, 32000
  br i1 %exitcond47.not.4, label %for.body.i.preheader, label %for.body21
}
...
entry:
  store ptr getelementptr inbounds ([65536 x double], ptr @array, i64 0, i64 63), ptr @xx, align 8, !tbaa !367
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(256000) getelementptr inbounds ([65536 x double], ptr @array, i64 0, i64 63), i8 0, i64 256000, i1 false), !tbaa !5
  %call1 = tail call i32 @init(ptr noundef nonnull @.str.104)
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
  %cmp37 = icmp sgt i32 %0, 0
  br i1 %cmp37, label %for.cond2.preheader, label %for.cond.cleanup
...
for.cond2.preheader:                              ; preds = %entry, %for.cond.cleanup4
  ...
  %2 = ptrtoint ptr %1 to i64
  %3 = add nuw i64 %2, 8
  %4 = sub i64 %3, ptrtoint (ptr @array to i64)
  %diff.check = icmp ult i64 %4, 32
  %5 = sub i64 %3, ptrtoint (ptr @global_data to i64)
  %diff.check47 = icmp ult i64 %5, 32
  %conflict.rdx = or i1 %diff.check, %diff.check47
  br i1 %conflict.rdx, label %for.body5.prol, label %vector.body

for.body5.prol:                                   ; preds = %vector.body, %for.cond2.preheader
  %indvars.iv.ph = phi i64 [ 0, %for.cond2.preheader ], [ 31996, %vector.body ]
  %arrayidx.prol = getelementptr inbounds [65536 x double], ptr @array, i64 0, i64 %indvars.iv.ph
  %6 = load double, ptr %arrayidx.prol, align 32, !tbaa !5
  %arrayidx7.prol = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv.ph
  %7 = load double, ptr %arrayidx7.prol, align 32, !tbaa !5
  %add.prol = fadd double %6, %7
  %indvars.iv.next.prol = or i64 %indvars.iv.ph, 1
  %arrayidx10.prol = getelementptr inbounds double, ptr %1, i64 %indvars.iv.next.prol
  store double %add.prol, ptr %arrayidx10.prol, align 8, !tbaa !5
  br label %for.body5

vector.body:                                      ; preds = %for.cond2.preheader, %vector.body.1
  %index = phi i64 [ %index.next.1, %vector.body.1 ], [ 0, %for.cond2.preheader ]
  %8 = getelementptr inbounds [65536 x double], ptr @array, i64 0, i64 %index
  %wide.load = load <2 x double>, ptr %8, align 32, !tbaa !5
  %9 = getelementptr inbounds double, ptr %8, i64 2
  %wide.load48 = load <2 x double>, ptr %9, align 16, !tbaa !5
  %10 = getelementptr inbounds double, ptr @global_data, i64 %index
  %wide.load49 = load <2 x double>, ptr %10, align 32, !tbaa !5
  %11 = getelementptr inbounds double, ptr %10, i64 2
  %wide.load50 = load <2 x double>, ptr %11, align 16, !tbaa !5
  %12 = fadd <2 x double> %wide.load, %wide.load49
  %13 = fadd <2 x double> %wide.load48, %wide.load50
  %14 = or i64 %index, 1
  %15 = getelementptr inbounds double, ptr %1, i64 %14
  store <2 x double> %12, ptr %15, align 8, !tbaa !5
  %16 = getelementptr inbounds double, ptr %15, i64 2
  store <2 x double> %13, ptr %16, align 8, !tbaa !5
  %index.next = or i64 %index, 4
  %17 = icmp eq i64 %index.next, 31996
  br i1 %17, label %for.body5.prol, label %vector.body.1, !llvm.loop !390

vector.body.1:                                    ; preds = %vector.body
  %18 = getelementptr inbounds [65536 x double], ptr @array, i64 0, i64 %index.next
  %wide.load.1 = load <2 x double>, ptr %18, align 32, !tbaa !5
  %19 = getelementptr inbounds double, ptr %18, i64 2
  %wide.load48.1 = load <2 x double>, ptr %19, align 16, !tbaa !5
  %20 = getelementptr inbounds double, ptr @global_data, i64 %index.next
  %wide.load49.1 = load <2 x double>, ptr %20, align 32, !tbaa !5
  %21 = getelementptr inbounds double, ptr %20, i64 2
  %wide.load50.1 = load <2 x double>, ptr %21, align 16, !tbaa !5
  %22 = fadd <2 x double> %wide.load.1, %wide.load49.1
  %23 = fadd <2 x double> %wide.load48.1, %wide.load50.1
  %24 = or i64 %index, 5
  %25 = getelementptr inbounds double, ptr %1, i64 %24
  store <2 x double> %22, ptr %25, align 8, !tbaa !5
  %26 = getelementptr inbounds double, ptr %25, i64 2
  store <2 x double> %23, ptr %26, align 8, !tbaa !5
  %index.next.1 = add nuw nsw i64 %index, 8
  br label %vector.body

for.cond.cleanup:                                 ; preds = %for.cond.cleanup4, %entry
  %call15 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.141, double noundef 0.000000e+00)
  store double 0.000000e+00, ptr @temp, align 8, !tbaa !5
  %27 = load ptr, ptr @xx, align 8, !tbaa !367
  br label %for.body21

for.cond.cleanup4:                                ; preds = %for.body5
  %call11 = tail call i32 @dummy(ptr noundef nonnull @global_data, ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 3, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 6, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 8, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 11, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 14, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 17, i64 0, i64 0), ptr noundef nonnull getelementptr inbounds (%struct.GlobalData, ptr @global_data, i64 0, i32 20, i64 0, i64 0), double noundef 1.000000e+00) #15
  %inc13 = add nuw nsw i32 %nl.038, 1
  %28 = load i32, ptr @ntimes, align 4, !tbaa !17
...
for.body5:                                        ; preds = %for.body5, %for.body5.prol
  %indvars.iv = phi i64 [ %indvars.iv.next.prol, %for.body5.prol ], [ %indvars.iv.next.1, %for.body5 ]
  %arrayidx = getelementptr inbounds [65536 x double], ptr @array, i64 0, i64 %indvars.iv
  %29 = load double, ptr %arrayidx, align 8, !tbaa !5
  %arrayidx7 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv
  %30 = load double, ptr %arrayidx7, align 8, !tbaa !5
  %add = fadd double %29, %30
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %arrayidx10 = getelementptr inbounds double, ptr %1, i64 %indvars.iv.next
  store double %add, ptr %arrayidx10, align 8, !tbaa !5
  %arrayidx.1 = getelementptr inbounds [65536 x double], ptr @array, i64 0, i64 %indvars.iv.next
  %31 = load double, ptr %arrayidx.1, align 8, !tbaa !5
  %arrayidx7.1 = getelementptr inbounds double, ptr @global_data, i64 %indvars.iv.next
  %32 = load double, ptr %arrayidx7.1, align 8, !tbaa !5
  %add.1 = fadd double %31, %32
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %arrayidx10.1 = getelementptr inbounds double, ptr %1, i64 %indvars.iv.next.1
  store double %add.1, ptr %arrayidx10.1, align 8, !tbaa !5
  %exitcond.not.1 = icmp eq i64 %indvars.iv.next.1, 31999
  br i1 %exitcond.not.1, label %for.cond.cleanup4, label %for.body5, !llvm.loop !391

for.body21:                                       ; preds = %for.body21, %for.cond.cleanup
  %indvars.iv43 = phi i64 [ 0, %for.cond.cleanup ], [ %indvars.iv.next44.4, %for.body21 ]
  %add243940 = phi double [ 0.000000e+00, %for.cond.cleanup ], [ %add24.4, %for.body21 ]
  %arrayidx23 = getelementptr inbounds double, ptr %27, i64 %indvars.iv43
  %33 = load double, ptr %arrayidx23, align 8, !tbaa !5
  %add24 = fadd double %33, %add243940
  store double %add24, ptr @temp, align 8, !tbaa !5
  %indvars.iv.next44 = add nuw nsw i64 %indvars.iv43, 1
  %arrayidx23.1 = getelementptr inbounds double, ptr %27, i64 %indvars.iv.next44
  %34 = load double, ptr %arrayidx23.1, align 8, !tbaa !5
  %add24.1 = fadd double %34, %add24
  store double %add24.1, ptr @temp, align 8, !tbaa !5
  %indvars.iv.next44.1 = add nuw nsw i64 %indvars.iv43, 2
  %arrayidx23.2 = getelementptr inbounds double, ptr %27, i64 %indvars.iv.next44.1
  %35 = load double, ptr %arrayidx23.2, align 8, !tbaa !5
  %add24.2 = fadd double %35, %add24.1
  store double %add24.2, ptr @temp, align 8, !tbaa !5
  %indvars.iv.next44.2 = add nuw nsw i64 %indvars.iv43, 3
  %arrayidx23.3 = getelementptr inbounds double, ptr %27, i64 %indvars.iv.next44.2
  %36 = load double, ptr %arrayidx23.3, align 8, !tbaa !5
  %add24.3 = fadd double %36, %add24.2
  store double %add24.3, ptr @temp, align 8, !tbaa !5
  %indvars.iv.next44.3 = add nuw nsw i64 %indvars.iv43, 4
  %arrayidx23.4 = getelementptr inbounds double, ptr %27, i64 %indvars.iv.next44.3
  %37 = load double, ptr %arrayidx23.4, align 8, !tbaa !5
  %add24.4 = fadd double %37, %add24.3
  store double %add24.4, ptr @temp, align 8, !tbaa !5
  %indvars.iv.next44.4 = add nuw nsw i64 %indvars.iv43, 5
  %exitcond46.not.4 = icmp eq i64 %indvars.iv.next44.4, 32000
  br i1 %exitcond46.not.4, label %for.body.i.preheader, label %for.body21

for.body.i.preheader:                             ; preds = %for.body21
  %38 = load i32, ptr @digits, align 4, !tbaa !17
  %call126.i = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %38, double noundef %add24.4)
  ret i32 0
}

; Function Attrs: mustprogress nofree nosync nounwind willreturn memory(none) uwtable
define dso_local i32 @min(i32 noundef %a, i32 noundef %b) local_unnamed_addr #9 {
entry:
...
entry:
  %call = tail call i32 @posix_memalign(ptr noundef nonnull @xx, i64 noundef 32, i64 noundef 256000) #15
...
vector.body125:                                   ; preds = %vector.body, %vector.body125
  ...
  br i1 %10, label %vector.body133, label %vector.body125, !llvm.loop !392
...
vector.body133:                                   ; preds = %vector.body125, %vector.body133
  ...
  br i1 %21, label %vector.body141, label %vector.body133, !llvm.loop !393
...
vector.body141:                                   ; preds = %vector.body133, %vector.body141
  ...
  br i1 %32, label %vector.body149, label %vector.body141, !llvm.loop !394
...
vector.body149:                                   ; preds = %vector.body141, %vector.body149
  ...
  br i1 %43, label %for.cond2.preheader.i, label %vector.body149, !llvm.loop !395
...
vector.body157:                                   ; preds = %vector.body157, %for.cond2.preheader.i
  ...
  br i1 %53, label %for.cond.cleanup4.i, label %vector.body157, !llvm.loop !396
...
vector.body167:                                   ; preds = %vector.body167, %for.cond2.preheader.i83
  ...
  br i1 %63, label %for.cond.cleanup4.i85, label %vector.body167, !llvm.loop !397
...
vector.body179:                                   ; preds = %vector.body179, %for.cond2.preheader.i96
  ...
  br i1 %73, label %for.cond.cleanup4.i98, label %vector.body179, !llvm.loop !398
...
vector.body191:                                   ; preds = %for.cond.cleanup4.i98, %vector.body191
  ...
  br i1 %84, label %for.cond.cleanup29, label %vector.body191, !llvm.loop !399
...
vector.body:                                      ; preds = %for.body, %vector.body
  ...
  br i1 %104, label %vector.body125, label %vector.body, !llvm.loop !400
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %ip) #15
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %s1) #15
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %s2) #15
  %call = call i32 @posix_memalign(ptr noundef nonnull %ip, i64 noundef 32, i64 noundef 256000) #15
  %cmp = icmp sgt i32 %argc, 1
  br i1 %cmp, label %if.end, label %if.end.thread

if.end.thread:                                    ; preds = %entry
  %0 = load i32, ptr @ntimes, align 4, !tbaa !17
  %call218 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.143, i32 noundef %0)
  br label %if.end7

if.end:                                           ; preds = %entry
  %arrayidx = getelementptr inbounds ptr, ptr %argv, i64 1
  %1 = load ptr, ptr %arrayidx, align 8, !tbaa !367
  %call.i = call i64 @strtol(ptr nocapture noundef nonnull %1, ptr noundef null, i32 noundef 10) #15
  %conv.i = trunc i64 %call.i to i32
  store i32 %conv.i, ptr @ntimes, align 4, !tbaa !17
  %call2 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.143, i32 noundef %conv.i)
  %cmp3.not = icmp eq i32 %argc, 2
  br i1 %cmp3.not, label %if.end7, label %if.then4

if.then4:                                         ; preds = %if.end
  %arrayidx5 = getelementptr inbounds ptr, ptr %argv, i64 2
  %2 = load ptr, ptr %arrayidx5, align 8, !tbaa !367
  %call.i16 = call i64 @strtol(ptr nocapture noundef nonnull %2, ptr noundef null, i32 noundef 10) #15
  %conv.i17 = trunc i64 %call.i16 to i32
  store i32 %conv.i17, ptr @digits, align 4, !tbaa !17
  br label %if.end7

if.end7:                                          ; preds = %if.end.thread, %if.then4, %if.end
  %3 = load ptr, ptr %ip, align 8, !tbaa !367
  ...
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %s2) #15
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %s1) #15
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %ip) #15
  ret i32 0
}
...
!386 = distinct !{!386, !10}
!387 = distinct !{!387, !10, !11}
!388 = distinct !{!388, !10, !11}
!389 = distinct !{!389, !10}
!390 = distinct !{!390, !10, !11}
!391 = distinct !{!391, !10}
!392 = distinct !{!392, !10, !11}
!393 = distinct !{!393, !10, !11}
!394 = distinct !{!394, !10, !11}
!395 = distinct !{!395, !10, !11}
!396 = distinct !{!396, !10, !11}
!397 = distinct !{!397, !10, !11}
!398 = distinct !{!398, !10, !11}
!399 = distinct !{!399, !10, !11}
!400 = distinct !{!400, !10, !11}
