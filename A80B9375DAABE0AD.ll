...
if.end:                                           ; preds = %if.then, %entry
  ...
  %cmp.i.not113 = icmp eq ptr %call3, null
  br i1 %tobool4.not, label %for.cond.preheader, label %if.then5

for.cond.preheader:                               ; preds = %if.end
  br i1 %cmp.i.not113, label %if.end16, label %for.body

if.then5:                                         ; preds = %if.end
  br i1 %cmp.i.not113, label %if.end16, label %for.body.i
...
for.body:                                         ; preds = %for.cond.preheader, %for.body
  %Scan.0115 = phi ptr [ %Scan.0.val, %for.body ], [ %call3, %for.cond.preheader ]
  %Renamings.0114 = phi ptr [ %call.i76, %for.body ], [ null, %for.cond.preheader ]
  %17 = getelementptr i8, ptr %Scan.0115, i64 8
  ...
  store ptr %Renamings.0114, ptr %call.i76, align 8
  %Scan.0.val = load ptr, ptr %Scan.0115, align 8
...
if.end37:                                         ; preds = %for.end35, %if.end16
  br i1 %cmp.i77, label %if.then.i, label %if.end46
...
ren_FormulaRename.exit:                           ; preds = %list_Delete.exit.i102
...
if.end46:                                         ; preds = %if.end37, %if.then43, %ren_FormulaRename.exit
  %retval.0.i109 = phi ptr [ %call4.i, %if.then43 ], [ %call4.i, %ren_FormulaRename.exit ], [ %Term, %if.end37 ]
...
while.cond:                                       ; preds = %land.rhs, %if.then
  ...
  %cmp.i46 = icmp eq i32 %3, %Father.0.val40
...
while.body.i.i:                                   ; preds = %lor.lhs.false71.i, %if.end6.i.i
  ...
  %cmp.i.i.i = icmp eq i32 %Term2.addr.0.val.i.i, %12
...
while.body.i187.i:                                ; preds = %if.end6.i193.i, %while.body.lr.ph.i182.i
  ...
  %cmp.i.i186.i = icmp eq i32 %Term2.addr.0.val.i185.i, %14
...
if.end6.i193.i:                                   ; preds = %if.then.i189.i, %while.body.i187.i
  ...
  %15 = getelementptr i8, ptr %Term2.addr.02.i184.i, i64 8
  %Term2.addr.0.val12.i191.i = load ptr, ptr %15, align 8
...
while.body.i.i49:                                 ; preds = %if.then18, %while.body.i.i49
  %Current.06.i.i = phi ptr [ %L.addr.0.val.i.i, %while.body.i.i49 ], [ %25, %if.then18 ]
  %L.addr.0.val.i.i = load ptr, ptr %Current.06.i.i, align 8
...
for.end.thread:                                   ; preds = %if.then18
  %call35290 = tail call fastcc i32 @ren_BFactorOk(ptr noundef %Term1, ptr noundef nonnull %Term2.val)
  %tobool36.not291 = icmp eq i32 %call35290, 0
  %cmp.old = icmp eq ptr %Term2.val, %Term1
  %or.cond305 = or i1 %tobool36.not291, %cmp.old
  br i1 %or.cond305, label %cleanup163, label %if.end.backedge
