...
for.cond225.preheader.lr.ph:                      ; preds = %for.body
  ...
  %reass.add = sub i32 %cond81, %18
  %reass.mul = mul i32 %reass.add, %cond100
  %cmp229396 = icmp slt i32 %18, 1
  %or.cond.not575 = select i1 %cmp226411, i1 true, i1 %cmp229396
  %brmerge = select i1 %or.cond.not575, i1 true, i1 %cmp232393
  %brmerge574 = or i1 %brmerge, %cmp235391
  br i1 %brmerge574, label %for.end266, label %for.cond228.preheader.us.us.us.us.us.us.us.preheader
...
for.cond228.for.end257_crit_edge.split.us.split.us.us.us.us.us.us.us.us: ; preds = %for.cond231.for.end251_crit_edge.split.us.us.us.us.us.us.us.us.us.us
  %add260.us.us.us.us.us.us.us = add i32 %reass.mul, %add254.us.us.us.us.us.us.us.us.us
...
for.cond225.preheader.lr.ph:                      ; preds = %for.body
  ...
  %or.cond.not537 = select i1 %cmp226396, i1 true, i1 %cmp229382
  %brmerge = select i1 %or.cond.not537, i1 true, i1 %cmp232379
  %brmerge536 = or i1 %brmerge, %cmp235377
  br i1 %brmerge536, label %for.end260, label %for.cond228.preheader.us.us.us.us.us.us.us.preheader
...
for.cond228.for.end251_crit_edge.split.us.split.us.us.us.us.us.us.us.us: ; preds = %for.cond231.for.end245_crit_edge.split.us.us.us.us.us.us.us.us.us.us
  %add254.us.us.us.us.us.us.us = add i32 %reass.mul, %add248.us.us.us.us.us.us.us.us.us
