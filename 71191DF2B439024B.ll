...
entry:
  %exception.i = tail call ptr @__cxa_allocate_exception(i64 4) #2
  store i32 5, ptr %exception.i, align 16, !tbaa !5
  invoke void @__cxa_throw(ptr nonnull %exception.i, ptr nonnull @_ZTIi, ptr null) #3
