...
do.end264:                                        ; preds = %if.end255
  ...
  %.pre1001 = load i8, ptr %arrayidx301.phi.trans.insert, align 1, !tbaa !16
  br label %nx
...
nx:                                               ; preds = %cond.end280, %do.end264
  %48 = phi i8 [ %.pre1001, %do.end264 ], [ %47, %cond.end280 ]
...
sw.epilog.if.end358_crit_edge:                    ; preds = %sw.epilog
  %.pre1002 = ptrtoint ptr %ptr.3 to i64
  %.pre1003 = ptrtoint ptr %da.sroa.0.6 to i64
  %.pre1004 = sub i64 %.pre1002, %.pre1003
  %.pre1005 = trunc i64 %.pre1004 to i32
  br label %if.end358
...
if.end358:                                        ; preds = %sw.epilog.if.end358_crit_edge, %cleanup354
  %conv364.pre-phi = phi i32 [ %.pre1005, %sw.epilog.if.end358_crit_edge ], [ %conv341, %cleanup354 ]
...
while.end:                                        ; preds = %if.then15.us, %if.then15
  %.us-phi196 = phi i32 [ %da.sroa.17.1.ph, %if.then15 ], [ %da.sroa.17.1.us, %if.then15.us ]
  %.us-phi197 = phi ptr [ %da.sroa.0.1.ph, %if.then15 ], [ %da.sroa.0.1.us, %if.then15.us ]
  %.us-phi198 = phi ptr [ %ptr.1.ph, %if.then15 ], [ %ptr.1.us, %if.then15.us ]
  %sub.ptr.lhs.cast.i165 = ptrtoint ptr %.us-phi198 to i64
  %sub.ptr.rhs.cast.i166 = ptrtoint ptr %.us-phi197 to i64
  %sub.ptr.sub.i167 = sub i64 %sub.ptr.lhs.cast.i165, %sub.ptr.rhs.cast.i166
  %conv.i168 = trunc i64 %sub.ptr.sub.i167 to i32
  %call.i170 = tail call ptr @alloc_shrink(ptr noundef %.us-phi197, i32 noundef %.us-phi196, i32 noundef %conv.i168, i32 noundef 1, ptr noundef nonnull @.str.6) #7
...
if.then6.i525:                                    ; preds = %cond.end.i523
  ...
  %.pre659 = load ptr, ptr %s, align 8, !tbaa !18
  br i1 %cmp7.not.i524, label %if.end150, label %if.then9.i527

if.then9.i527:                                    ; preds = %if.then6.i525
  %incdec.ptr11.i526 = getelementptr inbounds i8, ptr %.pre659, i64 -1
...
if.end150:                                        ; preds = %if.then6.i525, %if.then9.i527
  %57 = phi ptr [ %incdec.ptr11.i526, %if.then9.i527 ], [ %.pre659, %if.then6.i525 ]
...
sw.epilog170:                                     ; preds = %cond.end119, %cond.false159
  ...
  %idxprom180618 = sext i32 %c.1 to i64
  %arrayidx181619 = getelementptr inbounds i16, ptr %61, i64 %idxprom180618
  %62 = load i16, ptr %arrayidx181619, align 2, !tbaa !27
  %63 = and i16 %62, 2048
  %tobool184.not620 = icmp eq i16 %63, 0
  br i1 %tobool184.not620, label %while.end, label %while.body.lr.ph
...
while.body:                                       ; preds = %while.body.lr.ph, %cond.end204
  %c.2623 = phi i32 [ %c.1, %while.body.lr.ph ], [ %cond205, %cond.end204 ]
  %exp10.0622 = phi i32 [ 0, %while.body.lr.ph ], [ %dec, %cond.end204 ]
  %ival.4621 = phi i64 [ %ival.3, %while.body.lr.ph ], [ %add, %cond.end204 ]
  %cmp185 = icmp ugt i64 %ival.4621, 922337203685477578
  br i1 %cmp185, label %if.then187, label %if.end189

if.then187:                                       ; preds = %while.body
  %conv188 = sitofp i64 %ival.4621 to double
  br label %fd

if.end189:                                        ; preds = %while.body
  %mul = mul nuw nsw i64 %ival.4621, 10
  %sub190 = add nsw i32 %c.2623, -48
...
fd:                                               ; preds = %cond.true88, %cond.false92, %if.then187
  ...
  %exp10.1 = phi i32 [ %exp10.0622, %if.then187 ], [ 0, %cond.false92 ], [ 0, %cond.true88 ]
  %c.3 = phi i32 [ %c.2623, %if.then187 ], [ %call95, %cond.false92 ], [ %conv91, %cond.true88 ]
  %73 = load ptr, ptr %call31, align 8, !tbaa !30
  %idxprom230626 = sext i32 %c.3 to i64
  %arrayidx231627 = getelementptr inbounds i16, ptr %73, i64 %idxprom230626
  %74 = load i16, ptr %arrayidx231627, align 2, !tbaa !27
  %75 = and i16 %74, 2048
  %tobool234.not628 = icmp eq i16 %75, 0
  br i1 %tobool234.not628, label %while.end254, label %while.body235.lr.ph
...
while.body235:                                    ; preds = %while.body235.lr.ph, %cond.end251
  %c.4631 = phi i32 [ %c.3, %while.body235.lr.ph ], [ %cond252, %cond.end251 ]
  %exp10.2630 = phi i32 [ %exp10.1, %while.body235.lr.ph ], [ %dec253, %cond.end251 ]
  %dval.2629 = phi double [ %dval.1, %while.body235.lr.ph ], [ %76, %cond.end251 ]
  %sub237 = add nsw i32 %c.4631, -48
  %conv238 = sitofp i32 %sub237 to double
  %76 = tail call double @llvm.fmuladd.f64(double %dval.2629, double 1.000000e+01, double %conv238)
...
cond.end251:                                      ; preds = %cond.false247, %cond.true243
  ...
  %dec253 = add nsw i32 %exp10.2630, -1
...
while.cond327.preheader:                          ; preds = %if.end323
  %cmp328640 = icmp ugt i32 %exp10.6, 6
  br i1 %cmp328640, label %while.body330, label %if.then337

while.body330:                                    ; preds = %while.cond327.preheader, %while.body330
  %exp10.7642 = phi i32 [ %sub333, %while.body330 ], [ %exp10.6, %while.cond327.preheader ]
  %dval.4641 = phi double [ %mul332, %while.body330 ], [ %dval.3, %while.cond327.preheader ]
  %mul332 = fmul double %dval.4641, 1.000000e+06
  %sub333 = add nsw i32 %exp10.7642, -6
  %cmp328 = icmp ugt i32 %exp10.7642, 12
...
while.cond347.preheader:                          ; preds = %if.else343
  %cmp348635 = icmp ult i32 %exp10.6, -6
  br i1 %cmp348635, label %while.body350, label %if.then357

while.body350:                                    ; preds = %while.cond347.preheader, %while.body350
  %exp10.8637 = phi i32 [ %add353, %while.body350 ], [ %exp10.6, %while.cond347.preheader ]
  %dval.5636 = phi double [ %div352, %while.body350 ], [ %dval.3, %while.cond347.preheader ]
  %div352 = fdiv double %dval.5636, 1.000000e+06
  %add353 = add nuw nsw i32 %exp10.8637, 6
  %cmp348 = icmp ult i32 %exp10.8637, -12
