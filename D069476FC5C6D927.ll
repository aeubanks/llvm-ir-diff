...
entry:
  %dst664 = ptrtoint ptr %dst to i64
...
while.cond.preheader:                             ; preds = %entry
  ...
  %tobool.not598 = icmp eq i32 %0, 0
  %.pre = sub i32 %ep, %upx1
  br i1 %tobool.not598, label %land.lhs.true23, label %while.body.lr.ph
...
while.body:                                       ; preds = %while.body.lr.ph, %if.end21
  ...
  %inc599 = phi i32 [ 1, %while.body.lr.ph ], [ %inc, %if.end21 ]
  %add = add i32 %1, %.pre
...
land.lhs.true11:                                  ; preds = %land.lhs.true
  ...
  br i1 %cmp18, label %if.end62.loopexit585, label %if.end21

if.end21:                                         ; preds = %land.lhs.true11, %land.lhs.true, %while.body
  %inc = add i32 %inc599, 1
  %idxprom = zext i32 %inc599 to i64
...
if.then29:                                        ; preds = %land.lhs.true23
  ...
  %5 = sub i32 %ssize, %.pre
  %conv38603 = add i32 %5, -136
  %call604 = tail call ptr @cli_memstr(ptr noundef %arrayidx33, i32 noundef %conv38603, ptr noundef nonnull @.str.1, i32 noundef 2) #7
  %tobool39.not605 = icmp eq ptr %call604, null
  br i1 %tobool39.not605, label %if.end203, label %while.body40

while.body40:                                     ; preds = %if.then29, %if.end60
  %call606 = phi ptr [ %call, %if.end60 ], [ %call604, %if.then29 ]
  %arrayidx41 = getelementptr inbounds i8, ptr %call606, i64 6
...
land.lhs.true45:                                  ; preds = %while.body40
  %arrayidx46 = getelementptr inbounds i8, ptr %call606, i64 7
...
if.then50:                                        ; preds = %land.lhs.true45
  %sub.ptr.lhs.cast51 = ptrtoint ptr %call606 to i64
...
if.end60:                                         ; preds = %land.lhs.true45, %while.body40
  %incdec.ptr = getelementptr inbounds i8, ptr %call606, i64 1
...
if.end62.loopexit585:                             ; preds = %land.lhs.true11
  store i32 %inc599, ptr %sectcnt, align 4, !tbaa !5
  br label %if.end62

if.end62:                                         ; preds = %if.end62.loopexit585, %if.then50
  %storemerge = phi i32 [ %conv59, %if.then50 ], [ %1, %if.end62.loopexit585 ]
...
land.lhs.true70:                                  ; preds = %if.end62
  ...
  %or.cond652 = select i1 %cmp75.not, i1 %cmp88.not, i1 false
  br i1 %or.cond652, label %if.then101, label %if.end203
...
if.else:                                          ; preds = %if.then101
  ...
  %cmp126.not612 = icmp slt i32 %add.ptr74.val, 0
  %or.cond559613 = or i1 %cmp123, %cmp126.not612
  br i1 %or.cond559613, label %while.end196, label %land.lhs.true128.preheader
...
land.lhs.true128:                                 ; preds = %land.lhs.true128.preheader, %while.end194
  %pehdr.0614 = phi ptr [ %incdec.ptr195, %while.end194 ], [ %add.ptr111, %land.lhs.true128.preheader ]
  %add.ptr129 = getelementptr inbounds i8, ptr %pehdr.0614, i64 8
...
land.rhs:                                         ; preds = %land.lhs.true128
  %pehdr.0.val = load i32, ptr %pehdr.0614, align 1
...
while.cond142.preheader:                          ; preds = %land.rhs
  %cmp149.not607 = icmp ult ptr %add.ptr129, %dst
  br i1 %cmp149.not607, label %while.end194, label %land.lhs.true151

land.lhs.true151:                                 ; preds = %while.cond142.preheader, %while.end192
  %pehdr.1608 = phi ptr [ %incdec.ptr193, %while.end192 ], [ %add.ptr129, %while.cond142.preheader ]
  %add.ptr152 = getelementptr inbounds i8, ptr %pehdr.1608, i64 2
...
land.rhs161:                                      ; preds = %land.lhs.true151
  %13 = load i8, ptr %pehdr.1608, align 1, !tbaa !9
...
while.cond167.preheader:                          ; preds = %land.rhs161
  %scevgep = getelementptr i8, ptr %pehdr.1608, i64 1
  %cmp174.not = icmp uge ptr %scevgep, %dst
  br label %while.cond167

while.cond167:                                    ; preds = %while.cond167.preheader, %land.rhs186
  %pehdr.1.pn = phi ptr [ %pehdr.2, %land.rhs186 ], [ %pehdr.1608, %while.cond167.preheader ]
  %add.ptr177 = getelementptr inbounds i8, ptr %pehdr.1.pn, i64 3
  %cmp180.not = icmp ule ptr %add.ptr177, %add.ptr131
  %or.cond654 = select i1 %cmp174.not, i1 %cmp180.not, i1 false
  br i1 %or.cond654, label %land.rhs186, label %while.end192
...
while.end194:                                     ; preds = %land.rhs161, %while.end192, %land.lhs.true151, %while.cond142.preheader
  %pehdr.1.lcssa = phi ptr [ %add.ptr129, %while.cond142.preheader ], [ %pehdr.1608, %land.lhs.true151 ], [ %incdec.ptr193, %while.end192 ], [ %pehdr.1608, %land.rhs161 ]
...
while.end196:                                     ; preds = %land.rhs, %while.end194, %land.lhs.true128, %if.else
  %pehdr.0.lcssa = phi ptr [ %add.ptr111, %if.else ], [ %pehdr.0614, %land.lhs.true128 ], [ %incdec.ptr195, %while.end194 ], [ %pehdr.0614, %land.rhs ]
...
while.body216.lr.ph:                              ; preds = %if.end203
  ...
  %sectcnt.promoted623 = load i32, ptr %sectcnt, align 4, !tbaa !5
...
while.body216.us.preheader:                       ; preds = %while.body216.lr.ph
  %16 = add i64 %dst664, %idxprom211
  %17 = add i64 %16, -1
  %18 = tail call i64 @llvm.usub.sat.i64(i64 %dst664, i64 %17)
  %19 = sub i64 0, %18
  %scevgep665 = getelementptr i8, ptr %dst, i64 %19
  br label %while.end222

while.body216:                                    ; preds = %while.body216.preheader, %if.end220
  %pehdr.4630 = phi ptr [ %incdec.ptr221, %if.end220 ], [ %arrayidx212, %while.body216.preheader ]
  %add.ptr13.val.i622629 = phi i32 [ %add.ptr13.val.i621, %if.end220 ], [ %valign.promoted, %while.body216.preheader ]
  %add.i626628 = phi i32 [ %add.i625, %if.end220 ], [ %sectcnt.promoted623, %while.body216.preheader ]
  %add.ptr.i = getelementptr inbounds i8, ptr %pehdr.4630, i64 248
...
if.end.i:                                         ; preds = %while.body216
  %pehdr.val.i = load i32, ptr %pehdr.4630, align 1
  %cmp10.not.i = icmp eq i32 %pehdr.val.i, 17744
  br i1 %cmp10.not.i, label %if.end12.i, label %if.end220

if.end12.i:                                       ; preds = %if.end.i
  %add.ptr13.i = getelementptr inbounds i8, ptr %pehdr.4630, i64 56
...
if.end16.i:                                       ; preds = %if.end12.i
  %arrayidx.i = getelementptr inbounds i8, ptr %pehdr.4630, i64 6
  %20 = load i8, ptr %arrayidx.i, align 1, !tbaa !9
  %conv.i = zext i8 %20 to i32
  %arrayidx18.i = getelementptr inbounds i8, ptr %pehdr.4630, i64 7
...
if.end220:                                        ; preds = %while.body216, %if.end.i, %if.end12.i, %if.end16.i, %land.lhs.true25.i, %land.lhs.true36.i
  %add.i625 = phi i32 [ %add.i626628, %while.body216 ], [ %add.i626628, %if.end.i ], [ %add.i626628, %if.end12.i ], [ 0, %if.end16.i ], [ %add.i, %land.lhs.true25.i ], [ %add.i, %land.lhs.true36.i ]
  %add.ptr13.val.i621 = phi i32 [ %add.ptr13.val.i622629, %while.body216 ], [ %add.ptr13.val.i622629, %if.end.i ], [ 0, %if.end12.i ], [ %add.ptr13.val.i, %if.end16.i ], [ %add.ptr13.val.i, %land.lhs.true25.i ], [ %add.ptr13.val.i, %land.lhs.true36.i ]
  %incdec.ptr221 = getelementptr inbounds i8, ptr %pehdr.4630, i64 -1
...
while.end222:                                     ; preds = %if.end220, %land.lhs.true36.i, %while.body216.us.preheader
  %add.i624 = phi i32 [ %sectcnt.promoted623, %while.body216.us.preheader ], [ %add.i, %land.lhs.true36.i ], [ %add.i625, %if.end220 ]
  %add.ptr13.val.i620 = phi i32 [ %valign.promoted, %while.body216.us.preheader ], [ %add.ptr13.val.i, %land.lhs.true36.i ], [ %add.ptr13.val.i621, %if.end220 ]
  %pehdr.4.lcssa = phi ptr [ %scevgep665, %while.body216.us.preheader ], [ %pehdr.4630, %land.lhs.true36.i ], [ %incdec.ptr221, %if.end220 ]
  %sections.2 = phi ptr [ null, %while.body216.us.preheader ], [ %add.ptr.i, %land.lhs.true36.i ], [ null, %if.end220 ]
  store i32 %add.ptr13.val.i620, ptr %valign, align 4, !tbaa !5
  store i32 %add.i624, ptr %sectcnt, align 4, !tbaa !5
  %sub.ptr.lhs.cast223 = ptrtoint ptr %pehdr.4.lcssa to i64
  %sub.ptr.sub225 = sub i64 %sub.ptr.lhs.cast223, %dst664
...
cond.end:                                         ; preds = %if.end255, %cond.true
  ...
  %cmp269643.not = icmp eq i32 %23, 0
  br i1 %cmp269643.not, label %for.end, label %for.body.lr.ph
...
for.body:                                         ; preds = %for.body.lr.ph, %for.inc
  %sections.4646 = phi ptr [ %sections.3, %for.body.lr.ph ], [ %add.ptr326, %for.inc ]
  %foffset.0645 = phi i32 [ %cond, %for.body.lr.ph ], [ %add325, %for.inc ]
  %upd.0644 = phi i32 [ 0, %for.body.lr.ph ], [ %inc329, %for.inc ]
  %add.ptr284 = getelementptr inbounds i8, ptr %sections.4646, i64 8
...
cond.true289:                                     ; preds = %for.body
  ...
  %add.ptr290 = getelementptr inbounds i8, ptr %sections.4646, i64 12
...
cond.false294:                                    ; preds = %for.body
  %add.ptr295 = getelementptr inbounds i8, ptr %sections.4646, i64 12
  %add.ptr295.val = load i32, ptr %add.ptr295, align 1
  br label %cond.end297

cond.end297:                                      ; preds = %cond.false294, %cond.true289
  %cond287578 = phi i32 [ %mul282, %cond.true289 ], [ %add.ptr284.val, %cond.false294 ]
  %cond298 = phi i32 [ %mul293, %cond.true289 ], [ %add.ptr295.val, %cond.false294 ]
  %cmp302 = icmp eq i32 %cond287578, 0
  %or.cond383.not655 = select i1 %cmp299, i1 true, i1 %cmp302
  %cmp305.not = icmp ugt i32 %cond287578, %realstuffsz.1
  %or.cond567 = select i1 %or.cond383.not655, i1 true, i1 %cmp305.not
...
land.lhs.true310:                                 ; preds = %cond.end297
  %add311 = add i32 %cond298, %cond287578
...
cleanup327:                                       ; preds = %cond.end297, %land.lhs.true310
  tail call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.9, i32 noundef %upd.0644) #7
  br label %cleanup370

for.inc:                                          ; preds = %land.lhs.true310
  %add.ptr321 = getelementptr inbounds i8, ptr %sections.4646, i64 8
  store i32 %cond287578, ptr %add.ptr321, align 1
  %add.ptr322 = getelementptr inbounds i8, ptr %sections.4646, i64 12
  store i32 %cond298, ptr %add.ptr322, align 1
  %add.ptr323 = getelementptr inbounds i8, ptr %sections.4646, i64 16
  store i32 %cond287578, ptr %add.ptr323, align 1
  %add.ptr324 = getelementptr inbounds i8, ptr %sections.4646, i64 20
  store i32 %foffset.0645, ptr %add.ptr324, align 1
  %add325 = add i32 %cond287578, %foffset.0645
  %add.ptr326 = getelementptr inbounds i8, ptr %sections.4646, i64 40
  %inc329 = add nuw i32 %upd.0644, 1
...
if.end336:                                        ; preds = %for.end
  ...
  br i1 %cmp269643.not, label %for.end363, label %for.body345.lr.ph
...
for.body345:                                      ; preds = %for.body345, %for.body345.lr.ph.new
  %sections.6651 = phi ptr [ %add.ptr341, %for.body345.lr.ph.new ], [ %add.ptr360.1, %for.body345 ]
  %niter = phi i32 [ 0, %for.body345.lr.ph.new ], [ %niter.next.1, %for.body345 ]
  %add.ptr346 = getelementptr inbounds i8, ptr %sections.6651, i64 20
  ...
  %add.ptr350 = getelementptr inbounds i8, ptr %sections.6651, i64 12
  ...
  %add.ptr357 = getelementptr inbounds i8, ptr %sections.6651, i64 16
  ...
  %add.ptr346.1 = getelementptr inbounds i8, ptr %sections.6651, i64 60
  ...
  %add.ptr350.1 = getelementptr inbounds i8, ptr %sections.6651, i64 52
  ...
  %add.ptr357.1 = getelementptr inbounds i8, ptr %sections.6651, i64 56
  ...
  %add.ptr360.1 = getelementptr inbounds i8, ptr %sections.6651, i64 80
...
for.end363.loopexit.unr-lcssa:                    ; preds = %for.body345, %for.body345.lr.ph
  %sections.6651.unr = phi ptr [ %add.ptr341, %for.body345.lr.ph ], [ %add.ptr360.1, %for.body345 ]
  %lcmp.mod.not = icmp eq i32 %xtraiter, 0
  br i1 %lcmp.mod.not, label %for.end363, label %for.body345.epil

for.body345.epil:                                 ; preds = %for.end363.loopexit.unr-lcssa
  %add.ptr346.epil = getelementptr inbounds i8, ptr %sections.6651.unr, i64 20
  ...
  %add.ptr350.epil = getelementptr inbounds i8, ptr %sections.6651.unr, i64 12
  ...
  %add.ptr357.epil = getelementptr inbounds i8, ptr %sections.6651.unr, i64 16
