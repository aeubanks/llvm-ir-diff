...
ehcleanup:                                        ; preds = %delete.notnull.i62, %lpad4, %lpad2
  %.pn150 = phi { ptr, i32 } [ %7, %lpad2 ], [ %8, %lpad4 ], [ %8, %delete.notnull.i62 ]
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %ref.tmp) #16
...
ehcleanup14:                                      ; preds = %delete.notnull.i90, %lpad11, %lpad9
  %.pn148 = phi { ptr, i32 } [ %16, %lpad9 ], [ %17, %lpad11 ], [ %17, %delete.notnull.i90 ]
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %ref.tmp8) #16
  br label %ehcleanup47
...
if.end15:                                         ; preds = %_ZN11CStringBaseIwED2Ev.exit88, %if.end
  ...
  %cmp18154 = icmp sgt i32 %18, 0
  br i1 %cmp18154, label %for.body.lr.ph, label %for.cond.cleanup
...
call.i.i.i.noexc:                                 ; preds = %for.body
  ...
  %call.i.i45.i = invoke noalias noundef nonnull dereferenceable(16) ptr @_Znam(i64 noundef 16) #17
          to label %_ZN11CArcExtInfoC2Ev.exit unwind label %lpad.i
...
_ZN11CStringBaseIwE11SetCapacityEi.exit.i102:     ; preds = %delete.notnull.i.i, %if.end.i
  %32 = phi ptr [ %call.i.i.i94, %if.end.i ], [ %call.i.i110, %delete.notnull.i.i ]
...
invoke.cont42:                                    ; preds = %if.end41
  ...
  br i1 %isnull.i.i, label %_ZN11CStringBaseIwED2Ev.exit.i, label %delete.notnull.i.i146
...
_ZN11CStringBaseIwED2Ev.exit.i:                   ; preds = %delete.notnull.i.i146, %invoke.cont42
...
ehcleanup45:                                      ; preds = %lpad19, %lpad.i, %lpad21
  %.pn = phi { ptr, i32 } [ %54, %lpad21 ], [ %53, %lpad19 ], [ %24, %lpad.i ]
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %extInfo) #16
  br label %ehcleanup47

ehcleanup47:                                      ; preds = %ehcleanup45, %ehcleanup14, %ehcleanup
  %.pn.pn = phi { ptr, i32 } [ %.pn, %ehcleanup45 ], [ %.pn148, %ehcleanup14 ], [ %.pn150, %ehcleanup ]
...
land.lhs.true:                                    ; preds = %for.inc.i, %6, %invoke.cont
  %switch.i48 = phi i32 [ %15, %invoke.cont ], [ -1, %6 ], [ -1, %for.inc.i ]
...
if.end11:                                         ; preds = %invoke.cont7, %invoke.cont
  %switch.i47 = phi i32 [ %switch.i48, %invoke.cont7 ], [ %15, %invoke.cont ]
...
_ZN13CRecordVectorIiE3AddEi.exit:                 ; preds = %if.end11
  ...
  store i32 %switch.i47, ptr %arrayidx.i, align 4, !tbaa !5
