...
define dso_local void @assemblez_1(i32 %internal_number, ptr nocapture noundef readonly byval(%struct.assembly_operand) align 8 %o1) local_unnamed_addr #0 {
entry:
  %0 = load i32, ptr %o1, align 8, !tbaa !5
  %1 = load i32, ptr @from_input, align 8, !tbaa !5
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @t0(ptr nocapture noundef readonly byval(%struct.assembly_operand) align 8 %to, ptr nocapture noundef readonly byval(%struct.assembly_operand) align 8 %from) local_unnamed_addr #0 {
entry:
  %value = getelementptr inbounds %struct.assembly_operand, ptr %to, i64 0, i32 1
  %0 = load i32, ptr %value, align 4, !tbaa !10
  %cmp = icmp eq i32 %0, 0
  br i1 %cmp, label %if.then, label %if.else

if.then:                                          ; preds = %entry
  tail call void @assemblez_1(i32 poison, ptr noundef nonnull byval(%struct.assembly_operand) align 8 %from)
  ret void
