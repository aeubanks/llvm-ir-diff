; ModuleID = '/usr/local/google/home/aeubanks/repos/test-suite/Bitcode/simd_ops/x86_tests/test_op_sqrtps_169.bc'
...
@str.11 = private constant [14 x i8] c"op_sqrtps_169\00", align 32
...
define i32 @__test_op(ptr noalias nocapture readonly %in_f32.buffer, ptr noalias nocapture readnone %in_f64.buffer, ptr noalias nocapture readnone %in_i8.buffer, ptr noalias nocapture readnone %in_u8.buffer, ptr noalias nocapture readnone %in_i16.buffer, ptr noalias nocapture readnone %in_u16.buffer, ptr noalias nocapture readnone %in_i32.buffer, ptr noalias nocapture readnone %in_u32.buffer, ptr noalias nocapture readnone %in_i64.buffer, ptr noalias nocapture readnone %in_u64.buffer, ptr noalias nocapture readonly %op_sqrtps_169.buffer) local_unnamed_addr #0 {
"produce op_sqrtps_169":
  %buf_extent168 = getelementptr inbounds %struct.buffer_t, ptr %op_sqrtps_169.buffer, i64 0, i32 2, i64 1
  %op_sqrtps_169.extent.1 = load i32, ptr %buf_extent168, align 4
  %buf_min176 = getelementptr inbounds %struct.buffer_t, ptr %op_sqrtps_169.buffer, i64 0, i32 4, i64 1
  %op_sqrtps_169.min.1 = load i32, ptr %buf_min176, align 4
  %0 = add nsw i32 %op_sqrtps_169.min.1, %op_sqrtps_169.extent.1
  %1 = icmp sgt i32 %op_sqrtps_169.extent.1, 0
  br i1 %1, label %"for op_sqrtps_169.s0.y.preheader", label %destructor_block, !prof !4

"for op_sqrtps_169.s0.y.preheader":               ; preds = %"produce op_sqrtps_169"
  %buf_host = getelementptr inbounds %struct.buffer_t, ptr %in_f32.buffer, i64 0, i32 1
  %in_f32.host = load ptr, ptr %buf_host, align 8
  %buf_min175 = getelementptr inbounds %struct.buffer_t, ptr %op_sqrtps_169.buffer, i64 0, i32 4, i64 0
  %op_sqrtps_169.min.0 = load i32, ptr %buf_min175, align 4
  %2 = sext i32 %op_sqrtps_169.min.0 to i64
  %buf_stride172 = getelementptr inbounds %struct.buffer_t, ptr %op_sqrtps_169.buffer, i64 0, i32 3, i64 1
  %op_sqrtps_169.stride.1 = load i32, ptr %buf_stride172, align 4
  %3 = sext i32 %op_sqrtps_169.stride.1 to i64
  %buf_host163 = getelementptr inbounds %struct.buffer_t, ptr %op_sqrtps_169.buffer, i64 0, i32 1
  %op_sqrtps_169.host = load ptr, ptr %buf_host163, align 8
  %4 = shl nsw i64 %2, 3
  %5 = sub nsw i64 32, %4
  %scevgep = getelementptr i8, ptr %op_sqrtps_169.host, i64 %5
  %6 = shl nsw i64 %3, 3
  ...
  %8 = tail call <8 x float> @llvm.sqrt.v8f32(<8 x float> %7)
  ...
  %12 = load <8 x float>, ptr %sunkaddr203.1, align 32, !tbaa !5
  %13 = tail call <8 x float> @llvm.sqrt.v8f32(<8 x float> %12)
  ...
  %17 = load <8 x float>, ptr %sunkaddr203.2, align 32, !tbaa !5
  %18 = tail call <8 x float> @llvm.sqrt.v8f32(<8 x float> %17)
  ...
  %22 = load <8 x float>, ptr %sunkaddr203.3, align 32, !tbaa !5
  %23 = tail call <8 x float> @llvm.sqrt.v8f32(<8 x float> %22)
  ...
  %27 = load <8 x float>, ptr %sunkaddr203.4, align 32, !tbaa !5
  %28 = tail call <8 x float> @llvm.sqrt.v8f32(<8 x float> %27)
  ...
  %32 = load <8 x float>, ptr %sunkaddr203.5, align 32, !tbaa !5
  %33 = tail call <8 x float> @llvm.sqrt.v8f32(<8 x float> %32)
  ...
  %37 = load <8 x float>, ptr %sunkaddr203.6, align 32, !tbaa !5
  %38 = tail call <8 x float> @llvm.sqrt.v8f32(<8 x float> %37)
  ...
  %42 = load <8 x float>, ptr %sunkaddr203.7, align 32, !tbaa !5
  ...
  %47 = load <8 x float>, ptr %sunkaddr203.8, align 32, !tbaa !5
  %48 = tail call <8 x float> @llvm.sqrt.v8f32(<8 x float> %47)
  %49 = fpext <8 x float> %48 to <8 x double>
  ...
  %52 = load <8 x float>, ptr %sunkaddr203.9, align 32, !tbaa !5
  %53 = tail call <8 x float> @llvm.sqrt.v8f32(<8 x float> %52)
  ...
  %57 = load <8 x float>, ptr %sunkaddr203.10, align 32, !tbaa !5
  %58 = tail call <8 x float> @llvm.sqrt.v8f32(<8 x float> %57)
  ...
  %62 = load <8 x float>, ptr %sunkaddr203.11, align 32, !tbaa !5
  %63 = tail call <8 x float> @llvm.sqrt.v8f32(<8 x float> %62)
  ...
  %67 = load <8 x float>, ptr %sunkaddr203.12, align 32, !tbaa !5
  %68 = tail call <8 x float> @llvm.sqrt.v8f32(<8 x float> %67)
  %69 = fpext <8 x float> %68 to <8 x double>
  ...
  %72 = load <8 x float>, ptr %sunkaddr203.13, align 32, !tbaa !5
  %73 = tail call <8 x float> @llvm.sqrt.v8f32(<8 x float> %72)
  ...
  %77 = load <8 x float>, ptr %sunkaddr203.14, align 32, !tbaa !5
  %78 = tail call <8 x float> @llvm.sqrt.v8f32(<8 x float> %77)
  ...
  %82 = load <8 x float>, ptr %sunkaddr203.15, align 32, !tbaa !5
  ...
  %87 = load <8 x float>, ptr %sunkaddr203.16, align 32, !tbaa !5
  %88 = tail call <8 x float> @llvm.sqrt.v8f32(<8 x float> %87)
  %89 = fpext <8 x float> %88 to <8 x double>
  ...
  %92 = load <8 x float>, ptr %sunkaddr203.17, align 32, !tbaa !5
  %93 = tail call <8 x float> @llvm.sqrt.v8f32(<8 x float> %92)
  %94 = fpext <8 x float> %93 to <8 x double>
  ...
  br label %"for op_sqrtps_169.s0.x.x.preheader"

"for op_sqrtps_169.s0.x.x.preheader":             ; preds = %"for op_sqrtps_169.s0.x.x.preheader", %"for op_sqrtps_169.s0.y.preheader"
  %lsr.iv180 = phi ptr [ %scevgep, %"for op_sqrtps_169.s0.y.preheader" ], [ %scevgep182, %"for op_sqrtps_169.s0.x.x.preheader" ]
  %op_sqrtps_169.s0.y = phi i32 [ %op_sqrtps_169.min.1, %"for op_sqrtps_169.s0.y.preheader" ], [ %167, %"for op_sqrtps_169.s0.x.x.preheader" ]
  ...
  %97 = load <8 x float>, ptr %sunkaddr203.18, align 32, !tbaa !5
  %98 = tail call <8 x float> @llvm.sqrt.v8f32(<8 x float> %97)
  %99 = fpext <8 x float> %98 to <8 x double>
  ...
  %102 = load <8 x float>, ptr %sunkaddr203.19, align 32, !tbaa !5
  %103 = tail call <8 x float> @llvm.sqrt.v8f32(<8 x float> %102)
  ...
  %107 = load <8 x float>, ptr %sunkaddr203.20, align 32, !tbaa !5
  %108 = tail call <8 x float> @llvm.sqrt.v8f32(<8 x float> %107)
  ...
  %112 = load <8 x float>, ptr %sunkaddr203.21, align 32, !tbaa !5
  %113 = tail call <8 x float> @llvm.sqrt.v8f32(<8 x float> %112)
  ...
  %117 = load <8 x float>, ptr %sunkaddr203.22, align 32, !tbaa !5
  %118 = tail call <8 x float> @llvm.sqrt.v8f32(<8 x float> %117)
  ...
  %122 = load <8 x float>, ptr %sunkaddr203.23, align 32, !tbaa !5
  %123 = tail call <8 x float> @llvm.sqrt.v8f32(<8 x float> %122)
  ...
  %127 = load <8 x float>, ptr %sunkaddr203.24, align 32, !tbaa !5
  %128 = tail call <8 x float> @llvm.sqrt.v8f32(<8 x float> %127)
  ...
  %132 = load <8 x float>, ptr %sunkaddr203.25, align 32, !tbaa !5
  %133 = tail call <8 x float> @llvm.sqrt.v8f32(<8 x float> %132)
  ...
  %137 = load <8 x float>, ptr %sunkaddr203.26, align 32, !tbaa !5
  %138 = tail call <8 x float> @llvm.sqrt.v8f32(<8 x float> %137)
  ...
  %142 = load <8 x float>, ptr %sunkaddr203.27, align 32, !tbaa !5
  %143 = tail call <8 x float> @llvm.sqrt.v8f32(<8 x float> %142)
  %144 = fpext <8 x float> %143 to <8 x double>
  ...
  %147 = load <8 x float>, ptr %sunkaddr203.28, align 32, !tbaa !5
  %148 = tail call <8 x float> @llvm.sqrt.v8f32(<8 x float> %147)
  ...
  %152 = load <8 x float>, ptr %sunkaddr203.29, align 32, !tbaa !5
  %153 = tail call <8 x float> @llvm.sqrt.v8f32(<8 x float> %152)
  ...
  %157 = load <8 x float>, ptr %sunkaddr203.30, align 32, !tbaa !5
  %158 = tail call <8 x float> @llvm.sqrt.v8f32(<8 x float> %157)
  ...
  %162 = load <8 x float>, ptr %sunkaddr203.31, align 32, !tbaa !5
  %163 = tail call <8 x float> @llvm.sqrt.v8f32(<8 x float> %162)
  ...
  %167 = add nsw i32 %op_sqrtps_169.s0.y, 1
  %scevgep182 = getelementptr i1, ptr %lsr.iv180, i64 %6
  %.not2 = icmp eq i32 %167, %0
  br i1 %.not2, label %destructor_block, label %"for op_sqrtps_169.s0.x.x.preheader"

destructor_block:                                 ; preds = %"for op_sqrtps_169.s0.x.x.preheader", %"produce op_sqrtps_169"
  ret i32 0
}

; Function Attrs: nofree nosync nounwind memory(readwrite, inaccessiblemem: none)
define i32 @test_op(ptr noalias nocapture readonly %in_f32.buffer, ptr noalias nocapture readnone %in_f64.buffer, ptr noalias nocapture readnone %in_i8.buffer, ptr noalias nocapture readnone %in_u8.buffer, ptr noalias nocapture readnone %in_i16.buffer, ptr noalias nocapture readnone %in_u16.buffer, ptr noalias nocapture readnone %in_i32.buffer, ptr noalias nocapture readnone %in_u32.buffer, ptr noalias nocapture readnone %in_i64.buffer, ptr noalias nocapture readnone %in_u64.buffer, ptr noalias nocapture readonly %op_sqrtps_169.buffer) local_unnamed_addr #1 {
destructor_block:
  %"__test_op_result$10" = tail call i32 @__test_op(ptr %in_f32.buffer, ptr poison, ptr poison, ptr poison, ptr poison, ptr poison, ptr poison, ptr poison, ptr poison, ptr poison, ptr %op_sqrtps_169.buffer) #4
  ret i32 0
}
