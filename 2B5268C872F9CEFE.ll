...
define dso_local noundef double @_Z10gen_randomd(double noundef %0) local_unnamed_addr #3 {
  %2 = load i64, ptr @_ZZ10gen_randomdE4last, align 8, !tbaa !5
  %3 = mul nuw nsw i64 %2, 3877
  %4 = add nuw nsw i64 %3, 29573
  %5 = urem i64 %4, 139968
  store i64 %5, ptr @_ZZ10gen_randomdE4last, align 8, !tbaa !5
...
define dso_local void @_Z8heapsortiPd(i32 noundef %0, ptr nocapture noundef %1) local_unnamed_addr #4 {
  %3 = ashr i32 %0, 1
  %4 = add nsw i32 %3, 1
...
16:                                               ; preds = %9
  %17 = load i64, ptr @_ZZ10gen_randomdE4last, align 8, !tbaa !5
...
24:                                               ; preds = %24, %22
  ...
  br i1 %43, label %44, label %24, !llvm.loop !16
...
56:                                               ; preds = %44, %49
  ...
  store i64 %57, ptr @_ZZ10gen_randomdE4last, align 8, !tbaa !5
  br label %58
