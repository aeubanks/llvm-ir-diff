...
entry:
  %0 = load i32, ptr getelementptr inbounds ([14 x %struct.entry], ptr @keywords, i64 0, i64 0, i32 1), align 8, !tbaa !5
  %tobool.not7 = icmp eq i32 %0, 0
  br i1 %tobool.not7, label %for.end, label %for.body

for.body:                                         ; preds = %entry, %for.body
  %1 = phi i32 [ %5, %for.body ], [ %0, %entry ]
  %p.08 = phi ptr [ %incdec.ptr, %for.body ], [ @keywords, %entry ]
  %2 = load ptr, ptr %p.08, align 8, !tbaa !11
  %type = getelementptr inbounds %struct.entry, ptr %p.08, i64 0, i32 2
  %3 = load i32, ptr %type, align 4, !tbaa !12
  %size = getelementptr inbounds %struct.entry, ptr %p.08, i64 0, i32 3
  %4 = load i32, ptr %size, align 8, !tbaa !13
  %call = tail call i32 @GlobalInsert(ptr noundef %2, i32 noundef %1, i32 noundef %3, i32 noundef %4, i32 noundef 0, i32 noundef 0) #2
  %incdec.ptr = getelementptr inbounds %struct.entry, ptr %p.08, i64 1
  %token = getelementptr inbounds %struct.entry, ptr %p.08, i64 1, i32 1
  %5 = load i32, ptr %token, align 8, !tbaa !5
