...
entry:
  ...
  %cmp274 = icmp sgt i32 %add3.i, 0
  br i1 %cmp274, label %while.body.lr.ph, label %cleanup
...
for.body:                                         ; preds = %if.end20, %for.inc
  %Scan.0271 = phi ptr [ %Scan.0.val147, %for.inc ], [ %23, %if.end20 ]
  %24 = getelementptr i8, ptr %Scan.0271, i64 8
  %Scan.0.val145 = load ptr, ptr %24, align 8
  %25 = ptrtoint ptr %Scan.0.val145 to i64
  %26 = trunc i64 %25 to i32
  %cmp.i168 = icmp sgt i32 %26, 0
  br i1 %cmp.i168, label %if.then26, label %if.else

if.then26:                                        ; preds = %for.body
  %sext266 = shl i64 %25, 32
...
for.inc:                                          ; preds = %if.then26, %if.else
  %Scan.0.val147 = load ptr, ptr %Scan.0271, align 8
...
while.body.i:                                     ; preds = %for.inc, %while.body.i
  %Current.06.i = phi ptr [ %L.addr.0.val.i, %while.body.i ], [ %23, %for.inc ]
...
list_Delete.exit:                                 ; preds = %while.body.i, %if.end20
  ...
  %cmp.i174 = icmp eq i32 %Lit.val.i, %32
...
fol_Atom.exit:                                    ; preds = %list_Delete.exit, %if.then.i
  ...
  %cmp.i177 = icmp eq i32 %Lit.val.i176, %32
...
if.then.i180:                                     ; preds = %fol_Atom.exit
  ...
  %Lit.val4.i178 = load ptr, ptr %34, align 8
  %35 = getelementptr i8, ptr %Lit.val4.i178, i64 8
  %Lit.val4.val.i179 = load ptr, ptr %35, align 8
...
fol_Atom.exit191:                                 ; preds = %land.lhs.true
  ...
  %36 = getelementptr i8, ptr %Lit.val4.i187, i64 8
  %Lit.val4.val.i188 = load ptr, ptr %36, align 8
  %call38.val = load i32, ptr %Lit.val4.val.i188, align 8
  %37 = load i32, ptr @fol_EQUALITY, align 4
  %cmp.i192 = icmp eq i32 %37, %call38.val
...
fol_Atom.exit191.thread:                          ; preds = %land.lhs.true
  ...
  %cmp.i192269 = icmp eq i32 %38, %Lit.val.i
...
fol_Atom.exit200:                                 ; preds = %fol_Atom.exit191, %fol_Atom.exit191.thread
  ...
  %39 = getelementptr i8, ptr %retval.0.i199, i64 16
...
if.then.i205:                                     ; preds = %fol_Atom.exit200
  ...
  %Lit.val4.i203 = load ptr, ptr %41, align 8
  %42 = getelementptr i8, ptr %Lit.val4.i203, i64 8
  %Lit.val4.val.i204 = load ptr, ptr %42, align 8
...
fol_Atom.exit207:                                 ; preds = %fol_Atom.exit200, %if.then.i205
  ...
  %43 = getelementptr i8, ptr %retval.0.i206, i64 16
...
land.lhs.true48:                                  ; preds = %fol_Atom.exit207
  ...
  %cmp.i209 = icmp eq i32 %Lit.val.i208, %45
...
if.then.i212:                                     ; preds = %land.lhs.true48
  ...
  %46 = getelementptr i8, ptr %Lit.val4.i210, i64 8
  %Lit.val4.val.i211 = load ptr, ptr %46, align 8
...
fol_Atom.exit214:                                 ; preds = %land.lhs.true48, %if.then.i212
  ...
  %47 = getelementptr i8, ptr %retval.0.i213, i64 16
  ...
  %cmp.i216 = icmp eq i32 %Lit.val.i215, %45
...
if.then.i219:                                     ; preds = %fol_Atom.exit214
  ...
  %Lit.val4.i217 = load ptr, ptr %49, align 8
  %50 = getelementptr i8, ptr %Lit.val4.i217, i64 8
  %Lit.val4.val.i218 = load ptr, ptr %50, align 8
...
fol_Atom.exit221:                                 ; preds = %fol_Atom.exit214, %if.then.i219
  ...
  %51 = getelementptr i8, ptr %retval.0.i220, i64 16
...
for.end.i234:                                     ; preds = %for.cond.i233
  store ptr %54, ptr %List1.addr.0.i230, align 8
  br label %cleanup.sink.split
...
for.end.i244:                                     ; preds = %for.cond.i243
  store ptr %57, ptr %List1.addr.0.i240, align 8
  br label %cleanup.sink.split
...
if.end72:                                         ; preds = %if.end69, %fol_Atom.exit221, %fol_Atom.exit207
  ...
  %cond277 = icmp eq ptr %58, null
  br i1 %cond277, label %list_Delete.exit265, label %for.body77

for.body77:                                       ; preds = %if.end72, %for.inc86
  %Scan.1273 = phi ptr [ %Scan.1.val146, %for.inc86 ], [ %58, %if.end72 ]
  %59 = getelementptr i8, ptr %Scan.1273, i64 8
  %Scan.1.val143 = load ptr, ptr %59, align 8
  %60 = ptrtoint ptr %Scan.1.val143 to i64
  %61 = trunc i64 %60 to i32
  %cmp.i249 = icmp sgt i32 %61, 0
...
for.inc86:                                        ; preds = %if.then81, %if.else83
  %Scan.1.val146 = load ptr, ptr %Scan.1273, align 8
  %cmp.i247.not = icmp eq ptr %Scan.1.val146, null
  br i1 %cmp.i247.not, label %while.body.i264, label %for.body77, !llvm.loop !28

while.body.i264:                                  ; preds = %for.inc86, %while.body.i264
  %Current.06.i258 = phi ptr [ %L.addr.0.val.i259, %while.body.i264 ], [ %58, %for.inc86 ]
  ...
  %total_size.i.i.i260 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %62, i64 0, i32 4
  %63 = load i32, ptr %total_size.i.i.i260, align 8
  %conv26.i.i.i261 = sext i32 %63 to i64
  %64 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i262 = add i64 %64, %conv26.i.i.i261
  store i64 %add27.i.i.i262, ptr @memory_FREEDBYTES, align 8
  %65 = load ptr, ptr %62, align 8
  store ptr %65, ptr %Current.06.i258, align 8
  %66 = load ptr, ptr getelementptr ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i258, ptr %66, align 8
...
list_Delete.exit265:                              ; preds = %while.body.i264, %if.end72
  store ptr null, ptr %NewBindings, align 8
  br label %if.end91
...
cleanup.sink.split:                               ; preds = %for.end.i244, %if.end.i239, %if.then67, %for.end.i234, %if.end.i229, %if.then59, %for.end.i165, %if.end.i160, %if.then15, %for.end.i, %if.end.i, %if.then9
  %retval.0.i245.sink = phi ptr [ %18, %for.end.i ], [ %19, %if.then9 ], [ %18, %if.end.i ], [ %21, %for.end.i165 ], [ %22, %if.then15 ], [ %21, %if.end.i160 ], [ %53, %for.end.i234 ], [ %54, %if.then59 ], [ %53, %if.end.i229 ], [ %56, %for.end.i244 ], [ %57, %if.then67 ], [ %56, %if.end.i239 ]
...
while.body.i99.us.i.i.preheader:                  ; preds = %if.else.us.i.i
  %xtraiter170 = and i32 %.pr.i92.us.i.i, 1
  %lcmp.mod171.not = icmp eq i32 %xtraiter170, 0
  br i1 %lcmp.mod171.not, label %while.body.i99.us.i.i.prol.loopexit, label %while.body.i99.us.i.i.prol
...
while.body.i99.us.i.i.prol.loopexit:              ; preds = %while.body.i99.us.i.i.prol, %while.body.i99.us.i.i.preheader
  %.unr172 = phi i32 [ %.pr.i92.us.i.i, %while.body.i99.us.i.i.preheader ], [ %dec.i.i.i97.us.i.i.prol, %while.body.i99.us.i.i.prol ]
...
while.body.i99.us.i.i:                            ; preds = %while.body.i99.us.i.i.prol.loopexit, %while.body.i99.us.i.i
  %34 = phi i32 [ %dec.i.i.i97.us.i.i.1, %while.body.i99.us.i.i ], [ %.unr172, %while.body.i99.us.i.i.prol.loopexit ]
  %35 = load ptr, ptr @cont_LASTBINDING, align 8
  store ptr %35, ptr @cont_CURRENTBINDING, align 8
  %36 = getelementptr i8, ptr %35, i64 24
...
while.body.i167.us.i.i.preheader:                 ; preds = %if.end.us.i.i
  %xtraiter173 = and i32 %.pr.i160.us.i.i, 1
  %lcmp.mod174.not = icmp eq i32 %xtraiter173, 0
  br i1 %lcmp.mod174.not, label %while.body.i167.us.i.i.prol.loopexit, label %while.body.i167.us.i.i.prol
...
while.body.i167.us.i.i.prol.loopexit:             ; preds = %while.body.i167.us.i.i.prol, %while.body.i167.us.i.i.preheader
  %.unr175 = phi i32 [ %.pr.i160.us.i.i, %while.body.i167.us.i.i.preheader ], [ %dec.i.i.i165.us.i.i.prol, %while.body.i167.us.i.i.prol ]
...
while.body.i167.us.i.i:                           ; preds = %while.body.i167.us.i.i.prol.loopexit, %while.body.i167.us.i.i
  %79 = phi i32 [ %dec.i.i.i165.us.i.i.1, %while.body.i167.us.i.i ], [ %.unr175, %while.body.i167.us.i.i.prol.loopexit ]
...
do.body.i:                                        ; preds = %cont_BackTrack.exit, %if.then4
  ...
  br i1 %cmp.i19145, label %while.body.i, label %while.end.i
...
while.body.i95.preheader:                         ; preds = %if.then25.i
  %xtraiter176 = and i32 %.pr.i89, 1
  %lcmp.mod177.not = icmp eq i32 %xtraiter176, 0
  br i1 %lcmp.mod177.not, label %while.body.i95.prol.loopexit, label %while.body.i95.prol
...
while.body.i95.prol.loopexit:                     ; preds = %while.body.i95.prol, %while.body.i95.preheader
  %.unr178 = phi i32 [ %.pr.i89, %while.body.i95.preheader ], [ %dec.i.i.i93.prol, %while.body.i95.prol ]
...
while.body.i95:                                   ; preds = %while.body.i95.prol.loopexit, %while.body.i95
  %143 = phi i32 [ %dec.i.i.i93.1, %while.body.i95 ], [ %.unr178, %while.body.i95.prol.loopexit ]
...
while.body.i57.preheader:                         ; preds = %if.then45.i
  %xtraiter179 = and i32 %.pr.i50, 1
  %lcmp.mod180.not = icmp eq i32 %xtraiter179, 0
  br i1 %lcmp.mod180.not, label %while.body.i57.prol.loopexit, label %while.body.i57.prol
...
while.body.i57.prol.loopexit:                     ; preds = %while.body.i57.prol, %while.body.i57.preheader
  %.unr181 = phi i32 [ %.pr.i50, %while.body.i57.preheader ], [ %dec.i.i.i55.prol, %while.body.i57.prol ]
...
while.body.i57:                                   ; preds = %while.body.i57.prol.loopexit, %while.body.i57
  %171 = phi i32 [ %dec.i.i.i55.1, %while.body.i57 ], [ %.unr181, %while.body.i57.prol.loopexit ]
...
while.end.i:                                      ; preds = %if.end48.i, %do.body.i
  %a.1.i.lcssa = phi i32 [ %a.0.i, %do.body.i ], [ %a.2.i, %if.end48.i ]
  %add3.i129.lcssa = phi i32 [ %add3.i129144, %do.body.i ], [ %add3.i129, %if.end48.i ]
  %cmp50.i.not = icmp slt i32 %a.1.i.lcssa, %add3.i129.lcssa
  br i1 %cmp50.i.not, label %if.end53.i, label %if.then51.i
...
while.body.i37.preheader:                         ; preds = %if.then51.i
  %xtraiter185 = and i32 %.pr.i30, 1
  %lcmp.mod186.not = icmp eq i32 %xtraiter185, 0
  br i1 %lcmp.mod186.not, label %while.body.i37.prol.loopexit, label %while.body.i37.prol
...
while.body.i37.prol.loopexit:                     ; preds = %while.body.i37.prol, %while.body.i37.preheader
  %.unr187 = phi i32 [ %.pr.i30, %while.body.i37.preheader ], [ %dec.i.i.i35.prol, %while.body.i37.prol ]
...
while.body.i37:                                   ; preds = %while.body.i37.prol.loopexit, %while.body.i37
  %185 = phi i32 [ %dec.i.i.i35.1, %while.body.i37 ], [ %.unr187, %while.body.i37.prol.loopexit ]
...
while.body.i25.preheader:                         ; preds = %if.else61.i
  %xtraiter182 = and i32 %.pr.i, 1
  %lcmp.mod183.not = icmp eq i32 %xtraiter182, 0
  br i1 %lcmp.mod183.not, label %while.body.i25.prol.loopexit, label %while.body.i25.prol
...
while.body.i25.prol.loopexit:                     ; preds = %while.body.i25.prol, %while.body.i25.preheader
  %.unr184 = phi i32 [ %.pr.i, %while.body.i25.preheader ], [ %dec.i.i.i.prol, %while.body.i25.prol ]
...
while.body.i25:                                   ; preds = %while.body.i25.prol.loopexit, %while.body.i25
  %199 = phi i32 [ %dec.i.i.i.1, %while.body.i25 ], [ %.unr184, %while.body.i25.prol.loopexit ]
...
cont_BackTrack.exit:                              ; preds = %while.end.i26, %if.then.i29
  %inc63.i = add nsw i32 %a.1.i.lcssa, 1
  %Clause.val.i = load i32, ptr %0, align 8
  %Clause.val6.i = load i32, ptr %1, align 4
  %add.i = add nsw i32 %Clause.val6.i, %Clause.val.i
  %Clause.val7.i = load i32, ptr %2, align 8
...
if.then4:                                         ; preds = %do.body
  ...
  %.pre.pre = load i32, ptr @cont_BINDINGS, align 4
  %.pre82.pre = load i32, ptr @cont_STACKPOINTER, align 4
...
while.cond.preheader.us.i:                        ; preds = %if.then4, %for.inc.us.i
  %.pre54.i = phi i32 [ %.pre8287, %for.inc.us.i ], [ %.pre82.pre, %if.then4 ]
  %.pre.i = phi i32 [ %.pre84, %for.inc.us.i ], [ %.pre.pre, %if.then4 ]
...
while.body.us.i:                                  ; preds = %cont_BackTrack.exit.us.i, %while.cond.preheader.us.i
  %61 = phi i32 [ %.pre54.i, %while.cond.preheader.us.i ], [ %.pre8287, %cont_BackTrack.exit.us.i ]
  %62 = phi i32 [ %.pre.i, %while.cond.preheader.us.i ], [ %.pre84, %cont_BackTrack.exit.us.i ]
...
while.body.i.us.i.preheader:                      ; preds = %while.body.us.i
  %xtraiter101 = and i32 %.pr.i.us.i, 1
  %lcmp.mod102.not = icmp eq i32 %xtraiter101, 0
  br i1 %lcmp.mod102.not, label %while.body.i.us.i.prol.loopexit, label %while.body.i.us.i.prol
...
while.body.i.us.i.prol.loopexit:                  ; preds = %while.body.i.us.i.prol, %while.body.i.us.i.preheader
  %.unr103 = phi i32 [ %.pr.i.us.i, %while.body.i.us.i.preheader ], [ %dec.i.i.i.us.i.prol, %while.body.i.us.i.prol ]
...
while.body.i.us.i:                                ; preds = %while.body.i.us.i.prol.loopexit, %while.body.i.us.i
  %76 = phi i32 [ %dec.i.i.i.us.i.1, %while.body.i.us.i ], [ %.unr103, %while.body.i.us.i.prol.loopexit ]
...
while.end.i.us.i:                                 ; preds = %while.body.i.us.i.prol.loopexit, %while.body.i.us.i, %while.body.us.i
  %.pre85 = phi i32 [ %.pr.i.us.i, %while.body.us.i ], [ 0, %while.body.i.us.i ], [ 0, %while.body.i.us.i.prol.loopexit ]
...
cont_BackTrack.exit.us.i:                         ; preds = %if.then.i.us.i, %while.end.i.us.i
  %.pre8287 = phi i32 [ %dec.i.i.us.i, %if.then.i.us.i ], [ 0, %while.end.i.us.i ]
  %.pre84 = phi i32 [ %84, %if.then.i.us.i ], [ %.pre85, %while.end.i.us.i ]
...
subs_SearchTopRes.exit:                           ; preds = %for.inc.us.i, %if.then4, %if.then14.loopexit.i
  %.pre82 = phi i32 [ %.pre8287, %if.then14.loopexit.i ], [ %.pre82.pre, %if.then4 ], [ %.pre8287, %for.inc.us.i ]
  %.pre = phi i32 [ %.pre84, %if.then14.loopexit.i ], [ %.pre.pre, %if.then4 ], [ %.pre84, %for.inc.us.i ]
...
do.body.i:                                        ; preds = %cont_BackTrack.exit, %subs_SearchTopRes.exit
  %86 = phi i32 [ %.pre82, %subs_SearchTopRes.exit ], [ %134, %cont_BackTrack.exit ]
  %87 = phi i32 [ %.pre, %subs_SearchTopRes.exit ], [ %135, %cont_BackTrack.exit ]
  ...
  store i32 0, ptr @cont_BINDINGS, align 4
  %cmp.i2076 = icmp slt i32 %a.0.i, %end
  br i1 %cmp.i2076, label %land.rhs.i, label %while.end.i

land.rhs.i:                                       ; preds = %do.body.i, %cont_BackTrackAndStart.exit
  %a.1.i77 = phi i32 [ %inc.i22, %cont_BackTrackAndStart.exit ], [ %a.0.i, %do.body.i ]
  ...
  %idxprom.i = zext i32 %a.1.i77 to i64
  %arrayidx.i = getelementptr inbounds [10000 x ptr], ptr @vec_VECTOR, i64 0, i64 %idxprom.i
  ...
  %tobool.i.not = icmp eq i32 %call5.i, 0
  br i1 %tobool.i.not, label %while.body.i, label %while.end.i

while.body.i:                                     ; preds = %land.rhs.i
  %inc.i22 = add nsw i32 %a.1.i77, 1
  %.pr.i48 = load i32, ptr @cont_BINDINGS, align 4
...
while.body.i54.preheader:                         ; preds = %while.body.i
  %xtraiter104 = and i32 %.pr.i48, 1
  %lcmp.mod105.not = icmp eq i32 %xtraiter104, 0
  br i1 %lcmp.mod105.not, label %while.body.i54.prol.loopexit, label %while.body.i54.prol
...
while.body.i54.prol.loopexit:                     ; preds = %while.body.i54.prol, %while.body.i54.preheader
  %.unr106 = phi i32 [ %.pr.i48, %while.body.i54.preheader ], [ %dec.i.i.i52.prol, %while.body.i54.prol ]
  %98 = icmp eq i32 %.pr.i48, 1
  br i1 %98, label %cont_BackTrackAndStart.exit, label %while.body.i54

while.body.i54:                                   ; preds = %while.body.i54.prol.loopexit, %while.body.i54
  %99 = phi i32 [ %dec.i.i.i52.1, %while.body.i54 ], [ %.unr106, %while.body.i54.prol.loopexit ]
  %100 = load ptr, ptr @cont_LASTBINDING, align 8
  store ptr %100, ptr @cont_CURRENTBINDING, align 8
  %101 = getelementptr i8, ptr %100, i64 24
...
cont_BackTrackAndStart.exit:                      ; preds = %while.body.i54.prol.loopexit, %while.body.i54, %while.body.i
  ...
  br i1 %cmp.i20, label %land.rhs.i, label %while.end.i, !llvm.loop !61

while.end.i:                                      ; preds = %cont_BackTrackAndStart.exit, %land.rhs.i, %do.body.i
  %a.1.i.lcssa = phi i32 [ %a.0.i, %do.body.i ], [ %a.1.i77, %land.rhs.i ], [ %inc.i22, %cont_BackTrackAndStart.exit ]
  %cmp7.i.not = icmp slt i32 %a.1.i.lcssa, %end
  br i1 %cmp7.i.not, label %if.end.i, label %if.then.i23
...
while.body.i39.preheader:                         ; preds = %if.then.i23
  %xtraiter110 = and i32 %.pr.i32, 1
  %lcmp.mod111.not = icmp eq i32 %xtraiter110, 0
  br i1 %lcmp.mod111.not, label %while.body.i39.prol.loopexit, label %while.body.i39.prol
...
while.body.i39.prol:                              ; preds = %while.body.i39.preheader
  ...
  %call.val.i.i.i34.prol = load ptr, ptr %107, align 8
  store ptr %call.val.i.i.i34.prol, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i35.prol = getelementptr inbounds %struct.binding, ptr %106, i64 0, i32 1
  ...
  %link.i.i.i.i36.prol = getelementptr inbounds %struct.binding, ptr %108, i64 0, i32 4
...
while.body.i39.prol.loopexit:                     ; preds = %while.body.i39.prol, %while.body.i39.preheader
  %.unr112 = phi i32 [ %.pr.i32, %while.body.i39.preheader ], [ %dec.i.i.i37.prol, %while.body.i39.prol ]
  %109 = icmp eq i32 %.pr.i32, 1
  br i1 %109, label %while.end.i41, label %while.body.i39

while.body.i39:                                   ; preds = %while.body.i39.prol.loopexit, %while.body.i39
  %110 = phi i32 [ %dec.i.i.i37.1, %while.body.i39 ], [ %.unr112, %while.body.i39.prol.loopexit ]
  %111 = load ptr, ptr @cont_LASTBINDING, align 8
  store ptr %111, ptr @cont_CURRENTBINDING, align 8
  %112 = getelementptr i8, ptr %111, i64 24
  %call.val.i.i.i34 = load ptr, ptr %112, align 8
  store ptr %call.val.i.i.i34, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i35 = getelementptr inbounds %struct.binding, ptr %111, i64 0, i32 1
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) %renaming.i.i.i.i35, i8 0, i64 20, i1 false)
  %113 = load ptr, ptr @cont_CURRENTBINDING, align 8
  %link.i.i.i.i36 = getelementptr inbounds %struct.binding, ptr %113, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i36, align 8
  %dec.i.i.i37 = add nsw i32 %110, -1
  ...
  %call.val.i.i.i34.1 = load ptr, ptr %115, align 8
  store ptr %call.val.i.i.i34.1, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i35.1 = getelementptr inbounds %struct.binding, ptr %114, i64 0, i32 1
  ...
  %link.i.i.i.i36.1 = getelementptr inbounds %struct.binding, ptr %116, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i36.1, align 8
  %dec.i.i.i37.1 = add nsw i32 %110, -2
...
if.then.i45:                                      ; preds = %while.end.i41
  ...
  %118 = load i32, ptr %arrayidx.i.i44, align 4
  store i32 %118, ptr @cont_BINDINGS, align 4
  br label %if.then7.critedge

if.end.i:                                         ; preds = %while.end.i
  %119 = load i32, ptr @vec_MAX, align 4
  %sub.i = sub nsw i32 %56, %119
  %cmp10.i = icmp eq i32 %sub.i, 1
  br i1 %cmp10.i, label %if.else, label %if.end12.i

if.end12.i:                                       ; preds = %if.end.i
  %call13.i = tail call fastcc i32 @subs_InternIdcRes(ptr noundef %c1, i32 noundef %56, i32 noundef %beg, i32 noundef %end), !range !10
...
while.body.i26.preheader:                         ; preds = %if.else.i
  %xtraiter107 = and i32 %.pr.i, 1
  %lcmp.mod108.not = icmp eq i32 %xtraiter107, 0
  br i1 %lcmp.mod108.not, label %while.body.i26.prol.loopexit, label %while.body.i26.prol

while.body.i26.prol:                              ; preds = %while.body.i26.preheader
  %120 = load ptr, ptr @cont_LASTBINDING, align 8
  store ptr %120, ptr @cont_CURRENTBINDING, align 8
  %121 = getelementptr i8, ptr %120, i64 24
  %call.val.i.i.i.prol = load ptr, ptr %121, align 8
  store ptr %call.val.i.i.i.prol, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i.prol = getelementptr inbounds %struct.binding, ptr %120, i64 0, i32 1
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) %renaming.i.i.i.i.prol, i8 0, i64 20, i1 false)
  %122 = load ptr, ptr @cont_CURRENTBINDING, align 8
  %link.i.i.i.i.prol = getelementptr inbounds %struct.binding, ptr %122, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i.prol, align 8
  %dec.i.i.i.prol = add nsw i32 %.pr.i, -1
  store i32 %dec.i.i.i.prol, ptr @cont_BINDINGS, align 4
  br label %while.body.i26.prol.loopexit
...
while.body.i26.prol.loopexit:                     ; preds = %while.body.i26.prol, %while.body.i26.preheader
  %.unr109 = phi i32 [ %.pr.i, %while.body.i26.preheader ], [ %dec.i.i.i.prol, %while.body.i26.prol ]
  %123 = icmp eq i32 %.pr.i, 1
  br i1 %123, label %while.end.i27, label %while.body.i26

while.body.i26:                                   ; preds = %while.body.i26.prol.loopexit, %while.body.i26
  %124 = phi i32 [ %dec.i.i.i.1, %while.body.i26 ], [ %.unr109, %while.body.i26.prol.loopexit ]
  %125 = load ptr, ptr @cont_LASTBINDING, align 8
  store ptr %125, ptr @cont_CURRENTBINDING, align 8
  %126 = getelementptr i8, ptr %125, i64 24
  %call.val.i.i.i = load ptr, ptr %126, align 8
  store ptr %call.val.i.i.i, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i = getelementptr inbounds %struct.binding, ptr %125, i64 0, i32 1
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) %renaming.i.i.i.i, i8 0, i64 20, i1 false)
  %127 = load ptr, ptr @cont_CURRENTBINDING, align 8
  %link.i.i.i.i = getelementptr inbounds %struct.binding, ptr %127, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i, align 8
  %dec.i.i.i = add nsw i32 %124, -1
  store i32 %dec.i.i.i, ptr @cont_BINDINGS, align 4
  %128 = load ptr, ptr @cont_LASTBINDING, align 8
  store ptr %128, ptr @cont_CURRENTBINDING, align 8
  %129 = getelementptr i8, ptr %128, i64 24
  %call.val.i.i.i.1 = load ptr, ptr %129, align 8
  store ptr %call.val.i.i.i.1, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i.1 = getelementptr inbounds %struct.binding, ptr %128, i64 0, i32 1
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) %renaming.i.i.i.i.1, i8 0, i64 20, i1 false)
  %130 = load ptr, ptr @cont_CURRENTBINDING, align 8
  %link.i.i.i.i.1 = getelementptr inbounds %struct.binding, ptr %130, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i.1, align 8
  %dec.i.i.i.1 = add nsw i32 %124, -2
  store i32 %dec.i.i.i.1, ptr @cont_BINDINGS, align 4
  %cmp.i25.1 = icmp ugt i32 %dec.i.i.i, 1
...
while.end.i27:                                    ; preds = %while.body.i26.prol.loopexit, %while.body.i26, %if.else.i
  %131 = phi i32 [ %.pr.i, %if.else.i ], [ 0, %while.body.i26 ], [ 0, %while.body.i26.prol.loopexit ]
...
if.then.i30:                                      ; preds = %while.end.i27
  %dec.i.i = add nsw i32 %132, -1
  store i32 %dec.i.i, ptr @cont_STACKPOINTER, align 4
  %idxprom.i.i28 = sext i32 %dec.i.i to i64
  %arrayidx.i.i29 = getelementptr inbounds [1000 x i32], ptr @cont_STACK, i64 0, i64 %idxprom.i.i28
  %133 = load i32, ptr %arrayidx.i.i29, align 4
  store i32 %133, ptr @cont_BINDINGS, align 4
  br label %cont_BackTrack.exit

cont_BackTrack.exit:                              ; preds = %while.end.i27, %if.then.i30
  %134 = phi i32 [ 0, %while.end.i27 ], [ %dec.i.i, %if.then.i30 ]
  %135 = phi i32 [ %131, %while.end.i27 ], [ %133, %if.then.i30 ]
  %inc17.i = add nsw i32 %a.1.i.lcssa, 1
...
while.body.i148.us.i.i.preheader:                 ; preds = %if.end51.us.i.i
  %xtraiter167 = and i32 %.pr.i142.us.i.i, 1
  %lcmp.mod168.not = icmp eq i32 %xtraiter167, 0
  br i1 %lcmp.mod168.not, label %while.body.i148.us.i.i.prol.loopexit, label %while.body.i148.us.i.i.prol
...
while.body.i148.us.i.i.prol.loopexit:             ; preds = %while.body.i148.us.i.i.prol, %while.body.i148.us.i.i.preheader
  %.unr169 = phi i32 [ %.pr.i142.us.i.i, %while.body.i148.us.i.i.preheader ], [ %dec.i.i.i146.us.i.i.prol, %while.body.i148.us.i.i.prol ]
...
while.body.i148.us.i.i:                           ; preds = %while.body.i148.us.i.i.prol.loopexit, %while.body.i148.us.i.i
  %61 = phi i32 [ %dec.i.i.i146.us.i.i.1, %while.body.i148.us.i.i ], [ %.unr169, %while.body.i148.us.i.i.prol.loopexit ]
  %62 = load ptr, ptr @cont_LASTBINDING, align 8
  store ptr %62, ptr @cont_CURRENTBINDING, align 8
  %63 = getelementptr i8, ptr %62, i64 24
...
do.body.i:                                        ; preds = %cont_BackTrack.exit, %if.then4
  ...
  br i1 %cmp.i20146, label %while.body.i, label %while.end.i
...
while.body.i97.preheader:                         ; preds = %if.then27.i
  %xtraiter170 = and i32 %.pr.i91, 1
  %lcmp.mod171.not = icmp eq i32 %xtraiter170, 0
  br i1 %lcmp.mod171.not, label %while.body.i97.prol.loopexit, label %while.body.i97.prol
...
while.body.i97.prol.loopexit:                     ; preds = %while.body.i97.prol, %while.body.i97.preheader
  %.unr172 = phi i32 [ %.pr.i91, %while.body.i97.preheader ], [ %dec.i.i.i95.prol, %while.body.i97.prol ]
...
while.body.i97:                                   ; preds = %while.body.i97.prol.loopexit, %while.body.i97
  %123 = phi i32 [ %dec.i.i.i95.1, %while.body.i97 ], [ %.unr172, %while.body.i97.prol.loopexit ]
...
while.body.i59.preheader:                         ; preds = %if.then47.i
  %xtraiter173 = and i32 %.pr.i52, 1
  %lcmp.mod174.not = icmp eq i32 %xtraiter173, 0
  br i1 %lcmp.mod174.not, label %while.body.i59.prol.loopexit, label %while.body.i59.prol
...
while.body.i59.prol.loopexit:                     ; preds = %while.body.i59.prol, %while.body.i59.preheader
  %.unr175 = phi i32 [ %.pr.i52, %while.body.i59.preheader ], [ %dec.i.i.i57.prol, %while.body.i59.prol ]
...
while.body.i59:                                   ; preds = %while.body.i59.prol.loopexit, %while.body.i59
  %151 = phi i32 [ %dec.i.i.i57.1, %while.body.i59 ], [ %.unr175, %while.body.i59.prol.loopexit ]
...
while.end.i:                                      ; preds = %if.end53.i, %do.body.i
  %a.1.i.lcssa = phi i32 [ %a.0.i, %do.body.i ], [ %a.2.i, %if.end53.i ]
  %add3.i131.lcssa = phi i32 [ %add3.i131145, %do.body.i ], [ %add3.i131, %if.end53.i ]
  %cmp55.i.not = icmp slt i32 %a.1.i.lcssa, %add3.i131.lcssa
  br i1 %cmp55.i.not, label %if.end58.i, label %if.then56.i
...
while.body.i39.preheader:                         ; preds = %if.then56.i
  %xtraiter179 = and i32 %.pr.i32, 1
  %lcmp.mod180.not = icmp eq i32 %xtraiter179, 0
  br i1 %lcmp.mod180.not, label %while.body.i39.prol.loopexit, label %while.body.i39.prol
...
while.body.i39.prol.loopexit:                     ; preds = %while.body.i39.prol, %while.body.i39.preheader
  %.unr181 = phi i32 [ %.pr.i32, %while.body.i39.preheader ], [ %dec.i.i.i37.prol, %while.body.i39.prol ]
  %164 = icmp eq i32 %.pr.i32, 1
  br i1 %164, label %while.end.i41, label %while.body.i39

while.body.i39:                                   ; preds = %while.body.i39.prol.loopexit, %while.body.i39
  %165 = phi i32 [ %dec.i.i.i37.1, %while.body.i39 ], [ %.unr181, %while.body.i39.prol.loopexit ]
...
while.body.i27.preheader:                         ; preds = %if.else66.i
  %xtraiter176 = and i32 %.pr.i, 1
  %lcmp.mod177.not = icmp eq i32 %xtraiter176, 0
  br i1 %lcmp.mod177.not, label %while.body.i27.prol.loopexit, label %while.body.i27.prol
...
while.body.i27.prol.loopexit:                     ; preds = %while.body.i27.prol, %while.body.i27.preheader
  %.unr178 = phi i32 [ %.pr.i, %while.body.i27.preheader ], [ %dec.i.i.i.prol, %while.body.i27.prol ]
...
while.body.i27:                                   ; preds = %while.body.i27.prol.loopexit, %while.body.i27
  %179 = phi i32 [ %dec.i.i.i.1, %while.body.i27 ], [ %.unr178, %while.body.i27.prol.loopexit ]
...
cont_BackTrack.exit:                              ; preds = %while.end.i28, %if.then.i31
  %inc68.i = add nsw i32 %a.1.i.lcssa, 1
  %Clause.val.i = load i32, ptr %0, align 8
  %Clause.val6.i = load i32, ptr %1, align 4
  %add.i = add nsw i32 %Clause.val6.i, %Clause.val.i
  %Clause.val7.i = load i32, ptr %2, align 8
