...
for.cond.i234:                                    ; preds = %if.end.i230, %for.cond.i234
  ...
  br i1 %cmp.i20.not.i233, label %for.end.i235, label %for.cond.i234, !llvm.loop !25
...
for.cond.i244:                                    ; preds = %if.end.i240, %for.cond.i244
  ...
  br i1 %cmp.i20.not.i243, label %for.end.i245, label %for.cond.i244, !llvm.loop !25
...
for.inc86:                                        ; preds = %if.then81, %if.else83
  ...
  br i1 %cmp.i248.not, label %while.body.i265, label %for.body77, !llvm.loop !28
...
while.body.i265:                                  ; preds = %for.inc86, %while.body.i265
  ...
  br i1 %cmp.i.not.i264, label %list_Delete.exit266, label %while.body.i265, !llvm.loop !27
...
while.body.i.i32:                                 ; preds = %for.end.i30, %while.body.i.i32
  ...
  br i1 %cmp.i.not.i.i31, label %list_Delete.exit.i, label %while.body.i.i32, !llvm.loop !27
...
while.body.i44:                                   ; preds = %list_Delete.exit, %while.body.i44
  ...
  br i1 %cmp.i.not.i43, label %cleanup, label %while.body.i44, !llvm.loop !27
...
while.body.i.i36.i:                               ; preds = %for.end.i34.i, %while.body.i.i36.i
  ...
  br i1 %cmp.i.not.i.i35.i, label %list_Delete.exit.i.i, label %while.body.i.i36.i, !llvm.loop !27
...
while.body.i50.i:                                 ; preds = %list_Delete.exit.i, %while.body.i50.i
  ...
  br i1 %cmp.i.not.i49.i, label %if.end, label %while.body.i50.i, !llvm.loop !27
...
if.end13.i:                                       ; preds = %if.end.i
  %call14.i23 = tail call fastcc i32 @subs_InternIdc(ptr noundef %c1, i32 noundef %59, ptr noundef nonnull %c2), !range !10
