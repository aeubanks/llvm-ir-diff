; ModuleID = '/usr/local/google/home/aeubanks/repos/test-suite/Bitcode/simd_ops/x86_tests/test_op_pmulhw_156.bc'
...
@str.11 = private constant [14 x i8] c"op_pmulhw_156\00", align 32
...
define i32 @__test_op(ptr noalias nocapture readnone %in_f32.buffer, ptr noalias nocapture readnone %in_f64.buffer, ptr noalias nocapture readnone %in_i8.buffer, ptr noalias nocapture readnone %in_u8.buffer, ptr noalias nocapture readonly %in_i16.buffer, ptr noalias nocapture readnone %in_u16.buffer, ptr noalias nocapture readnone %in_i32.buffer, ptr noalias nocapture readnone %in_u32.buffer, ptr noalias nocapture readnone %in_i64.buffer, ptr noalias nocapture readnone %in_u64.buffer, ptr noalias nocapture readonly %op_pmulhw_156.buffer) local_unnamed_addr #0 {
"produce op_pmulhw_156":
  %buf_extent168 = getelementptr inbounds %struct.buffer_t, ptr %op_pmulhw_156.buffer, i64 0, i32 2, i64 1
  %op_pmulhw_156.extent.1 = load i32, ptr %buf_extent168, align 4
  %buf_min176 = getelementptr inbounds %struct.buffer_t, ptr %op_pmulhw_156.buffer, i64 0, i32 4, i64 1
  %op_pmulhw_156.min.1 = load i32, ptr %buf_min176, align 4
  %0 = add nsw i32 %op_pmulhw_156.min.1, %op_pmulhw_156.extent.1
  %1 = icmp sgt i32 %op_pmulhw_156.extent.1, 0
  br i1 %1, label %"for op_pmulhw_156.s0.y.preheader", label %destructor_block, !prof !4

"for op_pmulhw_156.s0.y.preheader":               ; preds = %"produce op_pmulhw_156"
  ...
  %buf_min175 = getelementptr inbounds %struct.buffer_t, ptr %op_pmulhw_156.buffer, i64 0, i32 4, i64 0
  %op_pmulhw_156.min.0 = load i32, ptr %buf_min175, align 4
  %2 = sext i32 %op_pmulhw_156.min.0 to i64
  %buf_stride172 = getelementptr inbounds %struct.buffer_t, ptr %op_pmulhw_156.buffer, i64 0, i32 3, i64 1
  %op_pmulhw_156.stride.1 = load i32, ptr %buf_stride172, align 4
  %3 = sext i32 %op_pmulhw_156.stride.1 to i64
  %buf_host163 = getelementptr inbounds %struct.buffer_t, ptr %op_pmulhw_156.buffer, i64 0, i32 1
  %op_pmulhw_156.host = load ptr, ptr %buf_host163, align 8
  %4 = shl nsw i64 %2, 3
  %5 = sub nsw i64 96, %4
  %scevgep = getelementptr i8, ptr %op_pmulhw_156.host, i64 %5
  %6 = shl nsw i64 %3, 3
  %sunkaddr = ptrtoint ptr %in_i16.host to i64
  %sunkaddr204 = add i64 %sunkaddr, 32
  %sunkaddr205 = inttoptr i64 %sunkaddr204 to ptr
  %7 = load <16 x i16>, ptr %sunkaddr205, align 32, !tbaa !5
  %8 = shufflevector <16 x i16> %7, <16 x i16> undef, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %9 = tail call <8 x i16> @llvm.x86.sse2.pmulh.w(<8 x i16> %8, <8 x i16> <i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3>) #4
  %10 = shufflevector <16 x i16> %7, <16 x i16> undef, <8 x i32> <i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %11 = tail call <8 x i16> @llvm.x86.sse2.pmulh.w(<8 x i16> %10, <8 x i16> <i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3>) #4
  ...
  %13 = sitofp <16 x i16> %12 to <16 x double>
  ...
  %18 = load <16 x i16>, ptr %sunkaddr205.1, align 32, !tbaa !5
  %19 = shufflevector <16 x i16> %18, <16 x i16> undef, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %20 = tail call <8 x i16> @llvm.x86.sse2.pmulh.w(<8 x i16> %19, <8 x i16> <i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3>) #4
  %21 = shufflevector <16 x i16> %18, <16 x i16> undef, <8 x i32> <i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %22 = tail call <8 x i16> @llvm.x86.sse2.pmulh.w(<8 x i16> %21, <8 x i16> <i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3>) #4
  ...
  %24 = sitofp <16 x i16> %23 to <16 x double>
  ...
  %29 = load <16 x i16>, ptr %sunkaddr205.2, align 32, !tbaa !5
  %30 = shufflevector <16 x i16> %29, <16 x i16> undef, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %31 = tail call <8 x i16> @llvm.x86.sse2.pmulh.w(<8 x i16> %30, <8 x i16> <i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3>) #4
  ...
  %35 = sitofp <16 x i16> %34 to <16 x double>
  ...
  %40 = load <16 x i16>, ptr %sunkaddr205.3, align 32, !tbaa !5
  %41 = shufflevector <16 x i16> %40, <16 x i16> undef, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %42 = tail call <8 x i16> @llvm.x86.sse2.pmulh.w(<8 x i16> %41, <8 x i16> <i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3>) #4
  %43 = shufflevector <16 x i16> %40, <16 x i16> undef, <8 x i32> <i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %44 = tail call <8 x i16> @llvm.x86.sse2.pmulh.w(<8 x i16> %43, <8 x i16> <i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3>) #4
  ...
  %51 = load <16 x i16>, ptr %sunkaddr205.4, align 32, !tbaa !5
  ...
  %55 = tail call <8 x i16> @llvm.x86.sse2.pmulh.w(<8 x i16> %54, <8 x i16> <i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3>) #4
  ...
  %57 = sitofp <16 x i16> %56 to <16 x double>
  ...
  %62 = load <16 x i16>, ptr %sunkaddr205.5, align 32, !tbaa !5
  %63 = shufflevector <16 x i16> %62, <16 x i16> undef, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %64 = tail call <8 x i16> @llvm.x86.sse2.pmulh.w(<8 x i16> %63, <8 x i16> <i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3>) #4
  %65 = shufflevector <16 x i16> %62, <16 x i16> undef, <8 x i32> <i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %66 = tail call <8 x i16> @llvm.x86.sse2.pmulh.w(<8 x i16> %65, <8 x i16> <i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3>) #4
  ...
  %73 = load <16 x i16>, ptr %sunkaddr205.6, align 32, !tbaa !5
  %74 = shufflevector <16 x i16> %73, <16 x i16> undef, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %75 = tail call <8 x i16> @llvm.x86.sse2.pmulh.w(<8 x i16> %74, <8 x i16> <i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3>) #4
  %76 = shufflevector <16 x i16> %73, <16 x i16> undef, <8 x i32> <i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %77 = tail call <8 x i16> @llvm.x86.sse2.pmulh.w(<8 x i16> %76, <8 x i16> <i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3>) #4
  ...
  %79 = sitofp <16 x i16> %78 to <16 x double>
  ...
  %84 = load <16 x i16>, ptr %sunkaddr205.7, align 32, !tbaa !5
  %85 = shufflevector <16 x i16> %84, <16 x i16> undef, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %86 = tail call <8 x i16> @llvm.x86.sse2.pmulh.w(<8 x i16> %85, <8 x i16> <i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3>) #4
  ...
  %90 = sitofp <16 x i16> %89 to <16 x double>
  ...
  %95 = load <16 x i16>, ptr %sunkaddr205.8, align 32, !tbaa !5
  %96 = shufflevector <16 x i16> %95, <16 x i16> undef, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %97 = tail call <8 x i16> @llvm.x86.sse2.pmulh.w(<8 x i16> %96, <8 x i16> <i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3>) #4
  %98 = shufflevector <16 x i16> %95, <16 x i16> undef, <8 x i32> <i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %99 = tail call <8 x i16> @llvm.x86.sse2.pmulh.w(<8 x i16> %98, <8 x i16> <i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3>) #4
  ...
  %101 = sitofp <16 x i16> %100 to <16 x double>
  ...
  br label %"for op_pmulhw_156.s0.x.x.preheader"

"for op_pmulhw_156.s0.x.x.preheader":             ; preds = %"for op_pmulhw_156.s0.x.x.preheader", %"for op_pmulhw_156.s0.y.preheader"
  %lsr.iv180 = phi ptr [ %scevgep, %"for op_pmulhw_156.s0.y.preheader" ], [ %scevgep182, %"for op_pmulhw_156.s0.x.x.preheader" ]
  %op_pmulhw_156.s0.y = phi i32 [ %op_pmulhw_156.min.1, %"for op_pmulhw_156.s0.y.preheader" ], [ %183, %"for op_pmulhw_156.s0.x.x.preheader" ]
  ...
  %106 = load <16 x i16>, ptr %sunkaddr205.9, align 32, !tbaa !5
  ...
  %110 = tail call <8 x i16> @llvm.x86.sse2.pmulh.w(<8 x i16> %109, <8 x i16> <i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3>) #4
  ...
  %112 = sitofp <16 x i16> %111 to <16 x double>
  ...
  %117 = load <16 x i16>, ptr %sunkaddr205.10, align 32, !tbaa !5
  %118 = shufflevector <16 x i16> %117, <16 x i16> undef, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %119 = tail call <8 x i16> @llvm.x86.sse2.pmulh.w(<8 x i16> %118, <8 x i16> <i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3>) #4
  %120 = shufflevector <16 x i16> %117, <16 x i16> undef, <8 x i32> <i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %121 = tail call <8 x i16> @llvm.x86.sse2.pmulh.w(<8 x i16> %120, <8 x i16> <i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3>) #4
  ...
  %123 = sitofp <16 x i16> %122 to <16 x double>
  ...
  %128 = load <16 x i16>, ptr %sunkaddr205.11, align 32, !tbaa !5
  %129 = shufflevector <16 x i16> %128, <16 x i16> undef, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %130 = tail call <8 x i16> @llvm.x86.sse2.pmulh.w(<8 x i16> %129, <8 x i16> <i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3>) #4
  %131 = shufflevector <16 x i16> %128, <16 x i16> undef, <8 x i32> <i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %132 = tail call <8 x i16> @llvm.x86.sse2.pmulh.w(<8 x i16> %131, <8 x i16> <i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3>) #4
  ...
  %134 = sitofp <16 x i16> %133 to <16 x double>
  ...
  %139 = load <16 x i16>, ptr %sunkaddr205.12, align 32, !tbaa !5
  %140 = shufflevector <16 x i16> %139, <16 x i16> undef, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %141 = tail call <8 x i16> @llvm.x86.sse2.pmulh.w(<8 x i16> %140, <8 x i16> <i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3>) #4
  ...
  %145 = sitofp <16 x i16> %144 to <16 x double>
  ...
  %150 = load <16 x i16>, ptr %sunkaddr205.13, align 32, !tbaa !5
  %151 = shufflevector <16 x i16> %150, <16 x i16> undef, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %152 = tail call <8 x i16> @llvm.x86.sse2.pmulh.w(<8 x i16> %151, <8 x i16> <i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3>) #4
  %153 = shufflevector <16 x i16> %150, <16 x i16> undef, <8 x i32> <i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %154 = tail call <8 x i16> @llvm.x86.sse2.pmulh.w(<8 x i16> %153, <8 x i16> <i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3>) #4
  ...
  %161 = load <16 x i16>, ptr %sunkaddr205.14, align 32, !tbaa !5
  ...
  %165 = tail call <8 x i16> @llvm.x86.sse2.pmulh.w(<8 x i16> %164, <8 x i16> <i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3>) #4
  ...
  %172 = load <16 x i16>, ptr %sunkaddr205.15, align 32, !tbaa !5
  %173 = shufflevector <16 x i16> %172, <16 x i16> undef, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %174 = tail call <8 x i16> @llvm.x86.sse2.pmulh.w(<8 x i16> %173, <8 x i16> <i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3>) #4
  %175 = shufflevector <16 x i16> %172, <16 x i16> undef, <8 x i32> <i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %176 = tail call <8 x i16> @llvm.x86.sse2.pmulh.w(<8 x i16> %175, <8 x i16> <i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3, i16 3>) #4
  ...
  %178 = sitofp <16 x i16> %177 to <16 x double>
  ...
  %183 = add nsw i32 %op_pmulhw_156.s0.y, 1
  %scevgep182 = getelementptr i1, ptr %lsr.iv180, i64 %6
  %.not2 = icmp eq i32 %183, %0
  br i1 %.not2, label %destructor_block, label %"for op_pmulhw_156.s0.x.x.preheader"

destructor_block:                                 ; preds = %"for op_pmulhw_156.s0.x.x.preheader", %"produce op_pmulhw_156"
  ret i32 0
}
...
; Function Attrs: nofree nosync nounwind memory(readwrite, inaccessiblemem: none)
define i32 @test_op(ptr noalias nocapture readnone %in_f32.buffer, ptr noalias nocapture readnone %in_f64.buffer, ptr noalias nocapture readnone %in_i8.buffer, ptr noalias nocapture readnone %in_u8.buffer, ptr noalias nocapture readonly %in_i16.buffer, ptr noalias nocapture readnone %in_u16.buffer, ptr noalias nocapture readnone %in_i32.buffer, ptr noalias nocapture readnone %in_u32.buffer, ptr noalias nocapture readnone %in_i64.buffer, ptr noalias nocapture readnone %in_u64.buffer, ptr noalias nocapture readonly %op_pmulhw_156.buffer) local_unnamed_addr #2 {
destructor_block:
  %"__test_op_result$9" = tail call i32 @__test_op(ptr poison, ptr poison, ptr poison, ptr poison, ptr %in_i16.buffer, ptr poison, ptr poison, ptr poison, ptr poison, ptr poison, ptr %op_pmulhw_156.buffer) #5
  ret i32 0
}
