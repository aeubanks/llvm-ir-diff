; ModuleID = '/usr/local/google/home/aeubanks/repos/test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/vprobes.c'
source_filename = "/usr/local/google/home/aeubanks/repos/test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/vprobes.c"
...
define dso_local void @vprobes() local_unnamed_addr #0 {
  %1 = load ptr, ptr @hFixedList, align 8, !tbaa !5
...
28:                                               ; preds = %15
  %29 = load ptr, ptr @Hptrs, align 8, !tbaa !5
  %30 = load ptr, ptr @Hroot, align 8, !tbaa !5
...
73:                                               ; preds = %62
  %74 = load ptr, ptr @Hptrs, align 8, !tbaa !5
  %75 = load ptr, ptr @Hroot, align 8, !tbaa !5
...
115:                                              ; preds = %108
  %116 = load ptr, ptr @Hptrs, align 8, !tbaa !5
  %117 = load ptr, ptr @Hroot, align 8, !tbaa !5
...
147:                                              ; preds = %131, %143, %115
  ...
  store i32 %111, ptr %158, align 4, !tbaa !16
  ...
  store i32 %19, ptr %163, align 4, !tbaa !14
  ...
  tail call void @tinsert(ptr noundef nonnull @vEdgeRoot, i32 noundef %19, i32 noundef %187) #3
  ...
  %192 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %191, ptr noundef nonnull @.str.1, i32 noundef %17, i32 noundef %111, i32 noundef %19, i32 noundef 1)
  ...
  store i32 %111, ptr %204, align 4, !tbaa !16
  ...
  store i32 %21, ptr %209, align 4, !tbaa !14
  ...
  tail call void @tinsert(ptr noundef nonnull @vEdgeRoot, i32 noundef %21, i32 noundef %232) #3
  ...
  %237 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %236, ptr noundef nonnull @.str.1, i32 noundef %17, i32 noundef %111, i32 noundef %21, i32 noundef -1)
  br label %603

238:                                              ; preds = %139
  tail call void @doubleDown(ptr noundef nonnull %4)
  br label %603
...
240:                                              ; preds = %239
  ...
  %242 = load i32, ptr %65, align 8, !tbaa !9
...
250:                                              ; preds = %240
  %251 = load ptr, ptr @Hptrs, align 8, !tbaa !5
  %252 = load ptr, ptr @Hroot, align 8, !tbaa !5
...
297:                                              ; preds = %294
  %298 = load ptr, ptr @Hptrs, align 8, !tbaa !5
  %299 = load ptr, ptr @Hroot, align 8, !tbaa !5
...
329:                                              ; preds = %313, %325, %297
  ...
  store i32 %19, ptr %345, align 4, !tbaa !14
  ...
  tail call void @tinsert(ptr noundef nonnull @vEdgeRoot, i32 noundef %19, i32 noundef %369) #3
  ...
  %374 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %373, ptr noundef nonnull @.str.1, i32 noundef %17, i32 noundef %66, i32 noundef %19, i32 noundef 1)
  ...
  store i32 %64, ptr %391, align 4, !tbaa !14
  ...
  tail call void @tinsert(ptr noundef nonnull @vEdgeRoot, i32 noundef %64, i32 noundef %414) #3
  ...
  %419 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %418, ptr noundef nonnull @.str.1, i32 noundef %17, i32 noundef %66, i32 noundef %64, i32 noundef -1)
  br label %420
...
422:                                              ; preds = %420
  ...
  %424 = load i32, ptr %109, align 8, !tbaa !9
...
432:                                              ; preds = %422
  %433 = load ptr, ptr @Hptrs, align 8, !tbaa !5
  %434 = load ptr, ptr @Hroot, align 8, !tbaa !5
...
479:                                              ; preds = %476
  %480 = load ptr, ptr @Hptrs, align 8, !tbaa !5
  %481 = load ptr, ptr @Hroot, align 8, !tbaa !5
...
511:                                              ; preds = %495, %507, %479
  ...
  store i32 %110, ptr %527, align 4, !tbaa !14
  ...
  tail call void @tinsert(ptr noundef nonnull @vEdgeRoot, i32 noundef %110, i32 noundef %551) #3
  ...
  %556 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %555, ptr noundef nonnull @.str.1, i32 noundef %17, i32 noundef %111, i32 noundef %110, i32 noundef 1)
  ...
  store i32 %21, ptr %573, align 4, !tbaa !14
  ...
  tail call void @tinsert(ptr noundef nonnull @vEdgeRoot, i32 noundef %21, i32 noundef %596) #3
  ...
  %601 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %600, ptr noundef nonnull @.str.1, i32 noundef %17, i32 noundef %111, i32 noundef %21, i32 noundef -1)
  br label %602
...
; Function Attrs: nounwind uwtable
define dso_local void @doubleDown(ptr noundef readonly %0) local_unnamed_addr #0 {
  ...
  %11 = load ptr, ptr @Hptrs, align 8, !tbaa !5
  %12 = load ptr, ptr @Hroot, align 8, !tbaa !5
...
52:                                               ; preds = %45
  %53 = load ptr, ptr @Hptrs, align 8, !tbaa !5
  %54 = load ptr, ptr @Hroot, align 8, !tbaa !5
...
86:                                               ; preds = %82, %70, %52
  ...
  store i32 %32, ptr %102, align 4, !tbaa !14
  ...
  tail call void @tinsert(ptr noundef nonnull @vEdgeRoot, i32 noundef %32, i32 noundef %126) #3
  %127 = load ptr, ptr @fpdebug, align 8, !tbaa !5
  %128 = load i32, ptr @numProbes, align 4, !tbaa !23
  %129 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %127, ptr noundef nonnull @.str.2, i32 noundef %128, i32 noundef %6, i32 noundef %30, i32 noundef %32, i32 noundef 1)
  ...
  store i32 %34, ptr %146, align 4, !tbaa !14
  ...
  tail call void @tinsert(ptr noundef nonnull @vEdgeRoot, i32 noundef %34, i32 noundef %169) #3
  %170 = load ptr, ptr @fpdebug, align 8, !tbaa !5
  %171 = load i32, ptr @numProbes, align 4, !tbaa !23
  %172 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %170, ptr noundef nonnull @.str.2, i32 noundef %171, i32 noundef %6, i32 noundef %30, i32 noundef %34, i32 noundef -1)
