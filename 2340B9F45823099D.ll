...
vec.epilog.iter.check:                            ; preds = %vector.body
  ...
  %.splatinsert1395 = insertelement <4 x i8> poison, i8 %ind.end1383, i64 0
  %.splat1396 = shufflevector <4 x i8> %.splatinsert1395, <4 x i8> poison, <4 x i32> zeroinitializer
  %induction1397 = add <4 x i8> %.splat1396, <i8 0, i8 -1, i8 -2, i8 -3>
  %12 = getelementptr i8, ptr %add.ptr13, i64 8175
  %wide.load1400 = load <4 x i8>, ptr %12, align 1, !tbaa !12
  %reverse1401 = shufflevector <4 x i8> %wide.load1400, <4 x i8> poison, <4 x i32> <i32 3, i32 2, i32 1, i32 0>
  %13 = xor <4 x i8> %reverse1401, %induction1397
  %reverse1402 = shufflevector <4 x i8> %13, <4 x i8> poison, <4 x i32> <i32 3, i32 2, i32 1, i32 0>
  store <4 x i8> %reverse1402, ptr %12, align 1, !tbaa !12
  %vec.ind.next1399 = add <4 x i8> %.splat1396, <i8 -4, i8 -5, i8 -6, i8 -7>
  %14 = getelementptr i8, ptr %add.ptr13, i64 8171
  %wide.load1400.1 = load <4 x i8>, ptr %14, align 1, !tbaa !12
  %reverse1401.1 = shufflevector <4 x i8> %wide.load1400.1, <4 x i8> poison, <4 x i32> <i32 3, i32 2, i32 1, i32 0>
  %15 = xor <4 x i8> %reverse1401.1, %vec.ind.next1399
  %reverse1402.1 = shufflevector <4 x i8> %15, <4 x i8> poison, <4 x i32> <i32 3, i32 2, i32 1, i32 0>
  store <4 x i8> %reverse1402.1, ptr %14, align 1, !tbaa !12
  %vec.ind.next1399.1 = add <4 x i8> %.splat1396, <i8 -8, i8 -9, i8 -10, i8 -11>
  %16 = getelementptr i8, ptr %add.ptr13, i64 8167
  %wide.load1400.2 = load <4 x i8>, ptr %16, align 1, !tbaa !12
  %reverse1401.2 = shufflevector <4 x i8> %wide.load1400.2, <4 x i8> poison, <4 x i32> <i32 3, i32 2, i32 1, i32 0>
  %17 = xor <4 x i8> %reverse1401.2, %vec.ind.next1399.1
  %reverse1402.2 = shufflevector <4 x i8> %17, <4 x i8> poison, <4 x i32> <i32 3, i32 2, i32 1, i32 0>
  store <4 x i8> %reverse1402.2, ptr %16, align 1, !tbaa !12
