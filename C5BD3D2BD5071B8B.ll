...
if.then110:                                       ; preds = %if.end102.if.then110_crit_edge, %lor.lhs.false107
  %50 = phi i32 [ %.pre914, %if.end102.if.then110_crit_edge ], [ %49, %lor.lhs.false107 ]
...
if.end117:                                        ; preds = %if.then116, %if.then110
  %54 = phi i32 [ %.pre917, %if.then116 ], [ %50, %if.then110 ]
  %55 = phi i32 [ %.pre916, %if.then116 ], [ %47, %if.then110 ]
  %56 = phi i32 [ %.pre915, %if.then116 ], [ %46, %if.then110 ]
...
if.end139:                                        ; preds = %lor.lhs.false107.if.end139_crit_edge, %if.end117
  %58 = phi ptr [ %.pre918, %lor.lhs.false107.if.end139_crit_edge ], [ %call138, %if.end117 ]
...
match_calc.exit:                                  ; preds = %for.body.i.epil, %match_calc.exit.loopexit.unr-lcssa, %if.end139
  ...
  br i1 %cmp14.i732, label %for.body.lr.ph.i734, label %for.end162

for.body.lr.ph.i734:                              ; preds = %match_calc.exit
  %77 = load ptr, ptr %seq1, align 8, !tbaa !9
  %78 = load ptr, ptr %seq2, align 8, !tbaa !9
  %wide.trip.count.i733 = and i64 %call22, 4294967295
  %xtraiter997 = and i64 %call22, 1
  %79 = icmp eq i64 %wide.trip.count.i733, 1
  br i1 %79, label %match_calc.exit745.unr-lcssa, label %for.body.lr.ph.i734.new

for.body.lr.ph.i734.new:                          ; preds = %for.body.lr.ph.i734
  %unroll_iter999 = sub nsw i64 %wide.trip.count.i733, %xtraiter997
  br label %for.body.i744

for.body.i744:                                    ; preds = %for.body.i744, %for.body.lr.ph.i734.new
  %indvars.iv.i735 = phi i64 [ 0, %for.body.lr.ph.i734.new ], [ %indvars.iv.next.i742.1, %for.body.i744 ]
  %niter1000 = phi i64 [ 0, %for.body.lr.ph.i734.new ], [ %niter1000.next.1, %for.body.i744 ]
  %80 = load i8, ptr %77, align 1, !tbaa !18
  %idxprom1.i736 = sext i8 %80 to i64
  %arrayidx4.i737 = getelementptr inbounds i8, ptr %78, i64 %indvars.iv.i735
  %81 = load i8, ptr %arrayidx4.i737, align 1, !tbaa !18
  %idxprom6.i738 = sext i8 %81 to i64
  %arrayidx7.i739 = getelementptr inbounds [128 x [128 x i32]], ptr @amino_dis, i64 0, i64 %idxprom1.i736, i64 %idxprom6.i738
  %82 = load i32, ptr %arrayidx7.i739, align 4, !tbaa !5
  %conv8.i740 = sitofp i32 %82 to float
  %arrayidx10.i741 = getelementptr inbounds float, ptr %62, i64 %indvars.iv.i735
  store float %conv8.i740, ptr %arrayidx10.i741, align 4, !tbaa !19
  %indvars.iv.next.i742 = or i64 %indvars.iv.i735, 1
  %83 = load i8, ptr %77, align 1, !tbaa !18
  %idxprom1.i736.1 = sext i8 %83 to i64
  %arrayidx4.i737.1 = getelementptr inbounds i8, ptr %78, i64 %indvars.iv.next.i742
  %84 = load i8, ptr %arrayidx4.i737.1, align 1, !tbaa !18
  %idxprom6.i738.1 = sext i8 %84 to i64
  %arrayidx7.i739.1 = getelementptr inbounds [128 x [128 x i32]], ptr @amino_dis, i64 0, i64 %idxprom1.i736.1, i64 %idxprom6.i738.1
  %85 = load i32, ptr %arrayidx7.i739.1, align 4, !tbaa !5
  %conv8.i740.1 = sitofp i32 %85 to float
  %arrayidx10.i741.1 = getelementptr inbounds float, ptr %62, i64 %indvars.iv.next.i742
  store float %conv8.i740.1, ptr %arrayidx10.i741.1, align 4, !tbaa !19
  %indvars.iv.next.i742.1 = add nuw nsw i64 %indvars.iv.i735, 2
  %niter1000.next.1 = add i64 %niter1000, 2
  %niter1000.ncmp.1 = icmp eq i64 %niter1000.next.1, %unroll_iter999
  br i1 %niter1000.ncmp.1, label %match_calc.exit745.unr-lcssa, label %for.body.i744, !llvm.loop !20

match_calc.exit745.unr-lcssa:                     ; preds = %for.body.i744, %for.body.lr.ph.i734
  %indvars.iv.i735.unr = phi i64 [ 0, %for.body.lr.ph.i734 ], [ %indvars.iv.next.i742.1, %for.body.i744 ]
  %lcmp.mod998.not = icmp eq i64 %xtraiter997, 0
  br i1 %lcmp.mod998.not, label %match_calc.exit745, label %for.body.i744.epil

for.body.i744.epil:                               ; preds = %match_calc.exit745.unr-lcssa
  %86 = load i8, ptr %77, align 1, !tbaa !18
  %idxprom1.i736.epil = sext i8 %86 to i64
  %arrayidx4.i737.epil = getelementptr inbounds i8, ptr %78, i64 %indvars.iv.i735.unr
  %87 = load i8, ptr %arrayidx4.i737.epil, align 1, !tbaa !18
  %idxprom6.i738.epil = sext i8 %87 to i64
  %arrayidx7.i739.epil = getelementptr inbounds [128 x [128 x i32]], ptr @amino_dis, i64 0, i64 %idxprom1.i736.epil, i64 %idxprom6.i738.epil
  %88 = load i32, ptr %arrayidx7.i739.epil, align 4, !tbaa !5
  %conv8.i740.epil = sitofp i32 %88 to float
  %arrayidx10.i741.epil = getelementptr inbounds float, ptr %62, i64 %indvars.iv.i735.unr
  store float %conv8.i740.epil, ptr %arrayidx10.i741.epil, align 4, !tbaa !19
  br label %match_calc.exit745

match_calc.exit745:                               ; preds = %match_calc.exit745.unr-lcssa, %for.body.i744.epil
...
vector.memcheck:                                  ; preds = %for.body145.lr.ph
  ...
  %scevgep949 = getelementptr i8, ptr %89, i64 %95
  %scevgep950 = getelementptr i8, ptr %91, i64 4
  %scevgep951 = getelementptr i8, ptr %91, i64 %95
  %96 = add nsw i64 %95, -4
  %scevgep952 = getelementptr i8, ptr %62, i64 %96
  %scevgep953 = getelementptr i8, ptr %90, i64 4
  %scevgep954 = getelementptr i8, ptr %90, i64 %95
  %scevgep955 = getelementptr i8, ptr %92, i64 4
  %scevgep956 = getelementptr i8, ptr %92, i64 %95
  %bound0 = icmp ult ptr %scevgep, %scevgep951
  %bound1 = icmp ult ptr %scevgep950, %scevgep949
  %found.conflict = and i1 %bound0, %bound1
  %bound0957 = icmp ult ptr %scevgep, %scevgep952
  %bound1958 = icmp ult ptr %62, %scevgep949
  %found.conflict959 = and i1 %bound0957, %bound1958
  %conflict.rdx = or i1 %found.conflict, %found.conflict959
  %bound0960 = icmp ult ptr %scevgep950, %scevgep952
  %bound1961 = icmp ult ptr %62, %scevgep951
  %found.conflict962 = and i1 %bound0960, %bound1961
  %conflict.rdx963 = or i1 %conflict.rdx, %found.conflict962
  %bound0964 = icmp ult ptr %scevgep953, %scevgep956
  %bound1965 = icmp ult ptr %scevgep955, %scevgep954
  %found.conflict966 = and i1 %bound0964, %bound1965
  %conflict.rdx967 = or i1 %conflict.rdx963, %found.conflict966
  br i1 %conflict.rdx967, label %for.body145.preheader, label %vector.ph
...
for.body145.preheader:                            ; preds = %vector.memcheck, %for.body145.lr.ph, %middle.block
  ...
  br i1 %lcmp.mod1002.not, label %for.body145.prol.loopexit, label %for.body145.prol

for.body145.prol:                                 ; preds = %for.body145.preheader
  %103 = add nsw i64 %indvars.iv856.ph, -1
  %arrayidx148.prol = getelementptr inbounds float, ptr %62, i64 %103
  %104 = load float, ptr %arrayidx148.prol, align 4, !tbaa !19
  %arrayidx150.prol = getelementptr inbounds float, ptr %89, i64 %indvars.iv856.ph
  store float %104, ptr %arrayidx150.prol, align 4, !tbaa !19
  %arrayidx152.prol = getelementptr inbounds i32, ptr %90, i64 %indvars.iv856.ph
  store i32 0, ptr %arrayidx152.prol, align 4, !tbaa !5
  %105 = load float, ptr %arrayidx148.prol, align 4, !tbaa !19
  %arrayidx157.prol = getelementptr inbounds float, ptr %91, i64 %indvars.iv856.ph
  store float %105, ptr %arrayidx157.prol, align 4, !tbaa !19
  %arrayidx159.prol = getelementptr inbounds i32, ptr %92, i64 %indvars.iv856.ph
...
for.body145:                                      ; preds = %for.body145.prol.loopexit, %for.body145
  ...
  %107 = add nsw i64 %indvars.iv856, -1
  %arrayidx148 = getelementptr inbounds float, ptr %62, i64 %107
  %108 = load float, ptr %arrayidx148, align 4, !tbaa !19
  %arrayidx150 = getelementptr inbounds float, ptr %89, i64 %indvars.iv856
  store float %108, ptr %arrayidx150, align 4, !tbaa !19
  %arrayidx152 = getelementptr inbounds i32, ptr %90, i64 %indvars.iv856
  store i32 0, ptr %arrayidx152, align 4, !tbaa !5
  %109 = load float, ptr %arrayidx148, align 4, !tbaa !19
  %arrayidx157 = getelementptr inbounds float, ptr %91, i64 %indvars.iv856
  store float %109, ptr %arrayidx157, align 4, !tbaa !19
  %arrayidx159 = getelementptr inbounds i32, ptr %92, i64 %indvars.iv856
  store i32 0, ptr %arrayidx159, align 4, !tbaa !5
  %indvars.iv.next857 = add nuw nsw i64 %indvars.iv856, 1
  %arrayidx148.1 = getelementptr inbounds float, ptr %62, i64 %indvars.iv856
  %110 = load float, ptr %arrayidx148.1, align 4, !tbaa !19
  %arrayidx150.1 = getelementptr inbounds float, ptr %89, i64 %indvars.iv.next857
  store float %110, ptr %arrayidx150.1, align 4, !tbaa !19
  %arrayidx152.1 = getelementptr inbounds i32, ptr %90, i64 %indvars.iv.next857
  store i32 0, ptr %arrayidx152.1, align 4, !tbaa !5
  %111 = load float, ptr %arrayidx148.1, align 4, !tbaa !19
  %arrayidx157.1 = getelementptr inbounds float, ptr %91, i64 %indvars.iv.next857
  store float %111, ptr %arrayidx157.1, align 4, !tbaa !19
  %arrayidx159.1 = getelementptr inbounds i32, ptr %92, i64 %indvars.iv.next857
...
for.body173.lr.ph:                                ; preds = %for.end162
  %wide.trip.count.i747 = and i64 %call22, 4294967295
  ...
  %xtraiter1003 = and i64 %call22, 1
  %121 = icmp eq i64 %wide.trip.count.i747, 1
  %unroll_iter1005 = sub nsw i64 %wide.trip.count.i747, %xtraiter1003
  %lcmp.mod1004.not = icmp eq i64 %xtraiter1003, 0
...
for.body173:                                      ; preds = %for.body173.lr.ph, %for.end313
  ...
  %currentw.0822 = phi ptr [ %62, %for.body173.lr.ph ], [ %previousw.0821, %for.end313 ]
  %previousw.0821 = phi ptr [ %63, %for.body173.lr.ph ], [ %currentw.0822, %for.end313 ]
  ...
  %122 = add nsw i64 %indvars.iv866, -1
  %arrayidx176 = getelementptr inbounds float, ptr %64, i64 %122
  %123 = load float, ptr %arrayidx176, align 4, !tbaa !19
  store float %123, ptr %currentw.0822, align 4, !tbaa !19
  br i1 %cmp14.i732, label %for.body.lr.ph.i748, label %match_calc.exit759

for.body.lr.ph.i748:                              ; preds = %for.body173
  %124 = load ptr, ptr %seq1, align 8, !tbaa !9
  %arrayidx.i = getelementptr inbounds i8, ptr %124, i64 %indvars.iv866
  %125 = load ptr, ptr %seq2, align 8, !tbaa !9
  br i1 %121, label %match_calc.exit759.loopexit.unr-lcssa, label %for.body.i758

for.body.i758:                                    ; preds = %for.body.lr.ph.i748, %for.body.i758
  %indvars.iv.i749 = phi i64 [ %indvars.iv.next.i756.1, %for.body.i758 ], [ 0, %for.body.lr.ph.i748 ]
  %niter1006 = phi i64 [ %niter1006.next.1, %for.body.i758 ], [ 0, %for.body.lr.ph.i748 ]
  %126 = load i8, ptr %arrayidx.i, align 1, !tbaa !18
  %idxprom1.i750 = sext i8 %126 to i64
  %arrayidx4.i751 = getelementptr inbounds i8, ptr %125, i64 %indvars.iv.i749
  %127 = load i8, ptr %arrayidx4.i751, align 1, !tbaa !18
  %idxprom6.i752 = sext i8 %127 to i64
  %arrayidx7.i753 = getelementptr inbounds [128 x [128 x i32]], ptr @amino_dis, i64 0, i64 %idxprom1.i750, i64 %idxprom6.i752
  %128 = load i32, ptr %arrayidx7.i753, align 4, !tbaa !5
  %conv8.i754 = sitofp i32 %128 to float
  %arrayidx10.i755 = getelementptr inbounds float, ptr %previousw.0821, i64 %indvars.iv.i749
  store float %conv8.i754, ptr %arrayidx10.i755, align 4, !tbaa !19
  %indvars.iv.next.i756 = or i64 %indvars.iv.i749, 1
  %129 = load i8, ptr %arrayidx.i, align 1, !tbaa !18
  %idxprom1.i750.1 = sext i8 %129 to i64
  %arrayidx4.i751.1 = getelementptr inbounds i8, ptr %125, i64 %indvars.iv.next.i756
  %130 = load i8, ptr %arrayidx4.i751.1, align 1, !tbaa !18
  %idxprom6.i752.1 = sext i8 %130 to i64
  %arrayidx7.i753.1 = getelementptr inbounds [128 x [128 x i32]], ptr @amino_dis, i64 0, i64 %idxprom1.i750.1, i64 %idxprom6.i752.1
  %131 = load i32, ptr %arrayidx7.i753.1, align 4, !tbaa !5
  %conv8.i754.1 = sitofp i32 %131 to float
  %arrayidx10.i755.1 = getelementptr inbounds float, ptr %previousw.0821, i64 %indvars.iv.next.i756
  store float %conv8.i754.1, ptr %arrayidx10.i755.1, align 4, !tbaa !19
  %indvars.iv.next.i756.1 = add nuw nsw i64 %indvars.iv.i749, 2
  %niter1006.next.1 = add i64 %niter1006, 2
  %niter1006.ncmp.1 = icmp eq i64 %niter1006.next.1, %unroll_iter1005
  br i1 %niter1006.ncmp.1, label %match_calc.exit759.loopexit.unr-lcssa, label %for.body.i758, !llvm.loop !20

match_calc.exit759.loopexit.unr-lcssa:            ; preds = %for.body.i758, %for.body.lr.ph.i748
  %indvars.iv.i749.unr = phi i64 [ 0, %for.body.lr.ph.i748 ], [ %indvars.iv.next.i756.1, %for.body.i758 ]
  br i1 %lcmp.mod1004.not, label %match_calc.exit759, label %for.body.i758.epil

for.body.i758.epil:                               ; preds = %match_calc.exit759.loopexit.unr-lcssa
  %132 = load i8, ptr %arrayidx.i, align 1, !tbaa !18
  %idxprom1.i750.epil = sext i8 %132 to i64
  %arrayidx4.i751.epil = getelementptr inbounds i8, ptr %125, i64 %indvars.iv.i749.unr
  %133 = load i8, ptr %arrayidx4.i751.epil, align 1, !tbaa !18
  %idxprom6.i752.epil = sext i8 %133 to i64
  %arrayidx7.i753.epil = getelementptr inbounds [128 x [128 x i32]], ptr @amino_dis, i64 0, i64 %idxprom1.i750.epil, i64 %idxprom6.i752.epil
  %134 = load i32, ptr %arrayidx7.i753.epil, align 4, !tbaa !5
  %conv8.i754.epil = sitofp i32 %134 to float
  %arrayidx10.i755.epil = getelementptr inbounds float, ptr %previousw.0821, i64 %indvars.iv.i749.unr
  store float %conv8.i754.epil, ptr %arrayidx10.i755.epil, align 4, !tbaa !19
  br label %match_calc.exit759

match_calc.exit759:                               ; preds = %for.body.i758.epil, %match_calc.exit759.loopexit.unr-lcssa, %for.body173
  %arrayidx179 = getelementptr inbounds float, ptr %64, i64 %indvars.iv866
  %135 = load float, ptr %arrayidx179, align 4, !tbaa !19
  store float %135, ptr %previousw.0821, align 4, !tbaa !19
  br i1 %cmp143.not769922, label %for.end313, label %for.body197.preheader

for.body197.preheader:                            ; preds = %match_calc.exit759
  %136 = load float, ptr %currentw.0822, align 4, !tbaa !19
  %arrayidx186 = getelementptr inbounds ptr, ptr %115, i64 %indvars.iv866
  %137 = load ptr, ptr %arrayidx186, align 8, !tbaa !9
  %arrayidx184 = getelementptr inbounds ptr, ptr %114, i64 %indvars.iv866
  %138 = load ptr, ptr %arrayidx184, align 8, !tbaa !9
  %139 = trunc i64 %122 to i32
  %140 = trunc i64 %indvars.iv866 to i32
  br label %for.body197

for.body197:                                      ; preds = %for.body197.preheader, %if.end302
  %ijpipt.0806.pn = phi ptr [ %ijpipt.0806, %if.end302 ], [ %138, %for.body197.preheader ]
  %ijpjpt.0805.pn = phi ptr [ %ijpjpt.0805, %if.end302 ], [ %137, %for.body197.preheader ]
  %mjpt.0804.pn = phi ptr [ %mjpt.0804, %if.end302 ], [ %116, %for.body197.preheader ]
  %Mjpt.0803.pn = phi ptr [ %Mjpt.0803, %if.end302 ], [ %117, %for.body197.preheader ]
  %mpjpt.0802.pn = phi ptr [ %mpjpt.0802, %if.end302 ], [ %118, %for.body197.preheader ]
  %Mpjpt.0801.pn = phi ptr [ %Mpjpt.0801, %if.end302 ], [ %119, %for.body197.preheader ]
  ...
  %add210772788 = phi float [ %add210, %if.end302 ], [ %136, %for.body197.preheader ]
  ...
  %142 = load float, ptr %prept.0789, align 4, !tbaa !19
  store i32 %139, ptr %ijpipt.0806, align 4, !tbaa !5
  ...
  %cmp205 = fcmp ogt float %142, %add210772788
  %sub199774 = select i1 %cmp205, i32 %sub199, i32 %sub199775787
  %add210773 = select i1 %cmp205, float %142, float %add210772788
  %add210 = fadd float %add210773, %conv2
  %143 = load float, ptr %mjpt.0804, align 4, !tbaa !19
...
if.then214:                                       ; preds = %for.body197
  %144 = load i32, ptr %mpjpt.0802, align 4, !tbaa !5
  store i32 %144, ptr %ijpipt.0806, align 4, !tbaa !5
  br label %if.end215
...
if.then218:                                       ; preds = %if.end215
  store i32 %139, ptr %mpjpt.0802, align 4, !tbaa !5
  br label %if.end220
...
if.end226:                                        ; preds = %if.then225, %if.end220
  ...
  %cmp227 = fcmp ogt float %141, %tbk.0791
  %tbk.1 = select i1 %cmp227, float %141, float %tbk.0791
  %tbki.1 = select i1 %cmp227, i32 %139, i32 %tbki.0792
  %tbkj.1 = select i1 %cmp227, i32 %sub199777786, i32 %tbkj.0793
  %146 = load float, ptr %Mjpt.0803, align 4, !tbaa !19
  %cmp232 = fcmp ogt float %146, %tbk.1
  br i1 %cmp232, label %if.then234, label %if.end236

if.then234:                                       ; preds = %if.end226
  %147 = load i32, ptr %Mpjpt.0801, align 4, !tbaa !5
  br label %if.end236
...
if.end241:                                        ; preds = %if.then239, %if.end236
  ...
  %endali.2 = select i1 %cmp247, i32 %140, i32 %endali.1794
...
for.body283:                                      ; preds = %for.inc294.4, %if.then270
  ...
  %wm286 = getelementptr inbounds %struct._shuryoten, ptr %120, i64 %indvars.iv861, i32 2
...
for.inc294:                                       ; preds = %for.body283
  ...
  %wm286.1 = getelementptr inbounds %struct._shuryoten, ptr %120, i64 %indvars.iv.next862, i32 2
...
for.inc294.1:                                     ; preds = %for.inc294
  ...
  %wm286.2 = getelementptr inbounds %struct._shuryoten, ptr %120, i64 %indvars.iv.next862.1, i32 2
...
for.inc294.2:                                     ; preds = %for.inc294.1
  ...
  %wm286.3 = getelementptr inbounds %struct._shuryoten, ptr %120, i64 %indvars.iv.next862.2, i32 2
...
for.inc294.3:                                     ; preds = %for.inc294.2
  ...
  %wm286.4 = getelementptr inbounds %struct._shuryoten, ptr %120, i64 %indvars.iv.next862.3, i32 2
...
if.end298.loopexit.split.loop.exit935:            ; preds = %for.inc294.3, %for.inc294.2, %for.inc294.1, %for.inc294, %for.body283
  ...
  %.lcssa994 = phi float [ %151, %for.body283 ], [ %152, %for.inc294 ], [ %153, %for.inc294.1 ], [ %154, %for.inc294.2 ], [ %155, %for.inc294.3 ]
  %156 = trunc i64 %indvars.iv861.lcssa to i32
  br label %if.end298
...
if.end298:                                        ; preds = %for.inc294.4, %if.end298.loopexit.split.loop.exit935, %if.else, %if.then253
  ...
  %minshuryowm.3 = phi float [ %minshuryowm.2, %if.then253 ], [ %minshuryowm.1797, %if.else ], [ %.lcssa994, %if.end298.loopexit.split.loop.exit935 ], [ %wm.4, %for.inc294.4 ]
  %minshuryopos.3 = phi i32 [ %minshuryopos.2, %if.then253 ], [ %minshuryopos.1798, %if.else ], [ %156, %if.end298.loopexit.split.loop.exit935 ], [ %minshuryopos.1798, %for.inc294.4 ]
...
if.end302:                                        ; preds = %if.then301, %if.end298
  ...
  %157 = load float, ptr %curpt.0800, align 4, !tbaa !19
...
for.end313:                                       ; preds = %if.end302, %match_calc.exit759
  ...
  %arrayidx318 = getelementptr inbounds float, ptr %113, i64 %indvars.iv866
  ...
  br i1 %exitcond871.not, label %for.cond322.preheader, label %for.body173, !llvm.loop !39
...
for.body325:                                      ; preds = %for.cond322.preheader, %for.body325
  ...
  %arrayidx327 = getelementptr inbounds %struct._shuryoten, ptr %160, i64 %indvars.iv872
  %161 = load i32, ptr %arrayidx327, align 8, !tbaa !11
  %j331 = getelementptr inbounds %struct._shuryoten, ptr %160, i64 %indvars.iv872, i32 1
  %162 = load i32, ptr %j331, align 4, !tbaa !14
  %wm334 = getelementptr inbounds %struct._shuryoten, ptr %160, i64 %indvars.iv872, i32 2
  %163 = load float, ptr %wm334, align 8, !tbaa !15
  %conv335 = fpext float %163 to double
  %164 = trunc i64 %indvars.iv872 to i32
...
for.body366.lr.ph:                                ; preds = %for.cond363.preheader
  ...
  %172 = add nsw i64 %wide.trip.count883, -1
  %xtraiter1007 = and i64 %wide.trip.count883, 3
...
for.body366.lr.ph.new:                            ; preds = %for.body366.lr.ph
  %unroll_iter1009 = and i64 %wide.trip.count883, 4294967292
...
for.body347:                                      ; preds = %for.end339, %for.body347
  ...
  %arrayidx349 = getelementptr inbounds %struct._shuryoten, ptr %175, i64 %indvars.iv876
  %176 = load i32, ptr %arrayidx349, align 8, !tbaa !11
  %j353 = getelementptr inbounds %struct._shuryoten, ptr %175, i64 %indvars.iv876, i32 1
  %177 = load i32, ptr %j353, align 4, !tbaa !14
  %wm356 = getelementptr inbounds %struct._shuryoten, ptr %175, i64 %indvars.iv876, i32 2
  %178 = load float, ptr %wm356, align 8, !tbaa !15
  %conv357 = fpext float %178 to double
  %179 = trunc i64 %indvars.iv876 to i32
...
for.cond377.preheader.unr-lcssa:                  ; preds = %for.body366, %for.body366.lr.ph
  ...
  br i1 %lcmp.mod1008.not, label %for.cond377.preheader, label %for.body366.epil
...
for.body366.epil:                                 ; preds = %for.cond377.preheader.unr-lcssa, %for.body366.epil
  ...
  %arrayidx368.epil = getelementptr inbounds ptr, ptr %170, i64 %indvars.iv880.epil
  %180 = load ptr, ptr %arrayidx368.epil, align 8, !tbaa !9
  store i32 %169, ptr %180, align 4, !tbaa !5
  %arrayidx371.epil = getelementptr inbounds ptr, ptr %171, i64 %indvars.iv880.epil
  ...
  %epil.iter.cmp.not = icmp eq i64 %epil.iter.next, %xtraiter1007
...
for.body380.lr.ph:                                ; preds = %for.cond377.preheader.thread, %for.cond377.preheader
  ...
  %wide.trip.count888 = and i64 %187, 4294967295
  %min.iters.check972 = icmp ult i64 %wide.trip.count888, 8
  %188 = ptrtoint ptr %186 to i64
  %189 = ptrtoint ptr %184 to i64
  %190 = sub i64 %188, %189
  %diff.check = icmp ult i64 %190, 32
  %or.cond985 = select i1 %min.iters.check972, i1 true, i1 %diff.check
  br i1 %or.cond985, label %for.body380.preheader, label %vector.ph973

vector.ph973:                                     ; preds = %for.body380.lr.ph
  %n.mod.vf974 = and i64 %187, 7
  %n.vec975 = sub nsw i64 %wide.trip.count888, %n.mod.vf974
  %broadcast.splatinsert = insertelement <4 x i32> poison, i32 %182, i64 0
  %broadcast.splat = shufflevector <4 x i32> %broadcast.splatinsert, <4 x i32> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert980 = insertelement <4 x i32> poison, i32 %182, i64 0
...
vector.body978:                                   ; preds = %vector.body978, %vector.ph973
  %index979 = phi i64 [ 0, %vector.ph973 ], [ %index.next982, %vector.body978 ]
  %191 = getelementptr inbounds i32, ptr %184, i64 %index979
  store <4 x i32> %broadcast.splat, ptr %191, align 4, !tbaa !5
  %192 = getelementptr inbounds i32, ptr %191, i64 4
  store <4 x i32> %broadcast.splat981, ptr %192, align 4, !tbaa !5
  %193 = getelementptr inbounds i32, ptr %186, i64 %index979
  store <4 x i32> %broadcast.splat, ptr %193, align 4, !tbaa !5
  %194 = getelementptr inbounds i32, ptr %193, i64 4
  store <4 x i32> %broadcast.splat981, ptr %194, align 4, !tbaa !5
  %index.next982 = add nuw i64 %index979, 8
  %195 = icmp eq i64 %index.next982, %n.vec975
  br i1 %195, label %middle.block970, label %vector.body978, !llvm.loop !44

middle.block970:                                  ; preds = %vector.body978
  %cmp.n977 = icmp eq i64 %n.mod.vf974, 0
  br i1 %cmp.n977, label %for.cond390.preheader, label %for.body380.preheader

for.body380.preheader:                            ; preds = %for.body380.lr.ph, %middle.block970
  %indvars.iv885.ph = phi i64 [ 0, %for.body380.lr.ph ], [ %n.vec975, %middle.block970 ]
  %196 = sub i64 %187, %indvars.iv885.ph
  %197 = xor i64 %indvars.iv885.ph, -1
  %198 = add nsw i64 %wide.trip.count888, %197
  %xtraiter1011 = and i64 %196, 3
  %lcmp.mod1012.not = icmp eq i64 %xtraiter1011, 0
  br i1 %lcmp.mod1012.not, label %for.body380.prol.loopexit, label %for.body380.prol
...
for.body380.prol:                                 ; preds = %for.body380.preheader, %for.body380.prol
  ...
  %arrayidx383.prol = getelementptr inbounds i32, ptr %184, i64 %indvars.iv885.prol
  store i32 %182, ptr %arrayidx383.prol, align 4, !tbaa !5
  %arrayidx386.prol = getelementptr inbounds i32, ptr %186, i64 %indvars.iv885.prol
  store i32 %182, ptr %arrayidx386.prol, align 4, !tbaa !5
  %indvars.iv.next886.prol = add nuw nsw i64 %indvars.iv885.prol, 1
  %prol.iter.next = add i64 %prol.iter, 1
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter1011
...
for.body366:                                      ; preds = %for.body366, %for.body366.lr.ph.new
  ...
  %niter1010 = phi i64 [ 0, %for.body366.lr.ph.new ], [ %niter1010.next.3, %for.body366 ]
  %arrayidx368 = getelementptr inbounds ptr, ptr %170, i64 %indvars.iv880
  %200 = load ptr, ptr %arrayidx368, align 8, !tbaa !9
  store i32 %169, ptr %200, align 4, !tbaa !5
  %arrayidx371 = getelementptr inbounds ptr, ptr %171, i64 %indvars.iv880
  %201 = load ptr, ptr %arrayidx371, align 8, !tbaa !9
  store i32 %169, ptr %201, align 4, !tbaa !5
  %indvars.iv.next881 = or i64 %indvars.iv880, 1
  %arrayidx368.1 = getelementptr inbounds ptr, ptr %170, i64 %indvars.iv.next881
  %202 = load ptr, ptr %arrayidx368.1, align 8, !tbaa !9
  store i32 %169, ptr %202, align 4, !tbaa !5
  %arrayidx371.1 = getelementptr inbounds ptr, ptr %171, i64 %indvars.iv.next881
  ...
  %arrayidx368.2 = getelementptr inbounds ptr, ptr %170, i64 %indvars.iv.next881.1
  %204 = load ptr, ptr %arrayidx368.2, align 8, !tbaa !9
  store i32 %169, ptr %204, align 4, !tbaa !5
  %arrayidx371.2 = getelementptr inbounds ptr, ptr %171, i64 %indvars.iv.next881.1
  ...
  %arrayidx368.3 = getelementptr inbounds ptr, ptr %170, i64 %indvars.iv.next881.2
  %206 = load ptr, ptr %arrayidx368.3, align 8, !tbaa !9
  store i32 %169, ptr %206, align 4, !tbaa !5
  %arrayidx371.3 = getelementptr inbounds ptr, ptr %171, i64 %indvars.iv.next881.2
  ...
  %niter1010.next.3 = add i64 %niter1010, 4
  %niter1010.ncmp.3 = icmp eq i64 %niter1010.next.3, %unroll_iter1009
  br i1 %niter1010.ncmp.3, label %for.cond377.preheader.unr-lcssa, label %for.body366, !llvm.loop !46

for.cond390.preheader:                            ; preds = %for.body380.prol.loopexit, %for.body380, %middle.block970
...
for.cond394.preheader.lr.ph:                      ; preds = %for.cond390.preheader
  ...
  %212 = add nsw i64 %wide.trip.count896, -1
  %xtraiter1013 = and i64 %wide.trip.count896, 7
...
for.cond394.preheader.lr.ph.new:                  ; preds = %for.cond394.preheader.lr.ph
  %unroll_iter1016 = and i64 %wide.trip.count896, 4294967288
...
for.body380:                                      ; preds = %for.body380.prol.loopexit, %for.body380
  ...
  %arrayidx383 = getelementptr inbounds i32, ptr %184, i64 %indvars.iv885
  store i32 %182, ptr %arrayidx383, align 4, !tbaa !5
  %arrayidx386 = getelementptr inbounds i32, ptr %186, i64 %indvars.iv885
  store i32 %182, ptr %arrayidx386, align 4, !tbaa !5
  %indvars.iv.next886 = add nuw nsw i64 %indvars.iv885, 1
  %arrayidx383.1 = getelementptr inbounds i32, ptr %184, i64 %indvars.iv.next886
  store i32 %182, ptr %arrayidx383.1, align 4, !tbaa !5
  %arrayidx386.1 = getelementptr inbounds i32, ptr %186, i64 %indvars.iv.next886
  store i32 %182, ptr %arrayidx386.1, align 4, !tbaa !5
  %indvars.iv.next886.1 = add nuw nsw i64 %indvars.iv885, 2
  %arrayidx383.2 = getelementptr inbounds i32, ptr %184, i64 %indvars.iv.next886.1
  store i32 %182, ptr %arrayidx383.2, align 4, !tbaa !5
  %arrayidx386.2 = getelementptr inbounds i32, ptr %186, i64 %indvars.iv.next886.1
  store i32 %182, ptr %arrayidx386.2, align 4, !tbaa !5
  %indvars.iv.next886.2 = add nuw nsw i64 %indvars.iv885, 3
  %arrayidx383.3 = getelementptr inbounds i32, ptr %184, i64 %indvars.iv.next886.2
  store i32 %182, ptr %arrayidx383.3, align 4, !tbaa !5
  %arrayidx386.3 = getelementptr inbounds i32, ptr %186, i64 %indvars.iv.next886.2
...
for.cond394.preheader:                            ; preds = %for.cond394.preheader, %for.cond394.preheader.lr.ph.new
  ...
  %niter1017 = phi i64 [ 0, %for.cond394.preheader.lr.ph.new ], [ %niter1017.next.7, %for.cond394.preheader ]
  %arrayidx399 = getelementptr inbounds ptr, ptr %208, i64 %indvars.iv893
  ...
  %arrayidx399.1 = getelementptr inbounds ptr, ptr %208, i64 %indvars.iv.next894
  ...
  %arrayidx399.2 = getelementptr inbounds ptr, ptr %208, i64 %indvars.iv.next894.1
  ...
  %arrayidx399.3 = getelementptr inbounds ptr, ptr %208, i64 %indvars.iv.next894.2
  ...
  %arrayidx399.4 = getelementptr inbounds ptr, ptr %208, i64 %indvars.iv.next894.3
  ...
  %arrayidx399.5 = getelementptr inbounds ptr, ptr %208, i64 %indvars.iv.next894.4
  ...
  %arrayidx399.6 = getelementptr inbounds ptr, ptr %208, i64 %indvars.iv.next894.5
  ...
  %arrayidx399.7 = getelementptr inbounds ptr, ptr %208, i64 %indvars.iv.next894.6
  ...
  %niter1017.next.7 = add i64 %niter1017, 8
  %niter1017.ncmp.7 = icmp eq i64 %niter1017.next.7, %unroll_iter1016
  br i1 %niter1017.ncmp.7, label %for.cond408.preheader.loopexit.unr-lcssa, label %for.cond394.preheader, !llvm.loop !48
...
for.cond408.preheader.loopexit.unr-lcssa:         ; preds = %for.cond394.preheader, %for.cond394.preheader.lr.ph
  ...
  br i1 %lcmp.mod1015.not, label %for.cond408.preheader, label %for.cond394.preheader.epil
...
for.cond394.preheader.epil:                       ; preds = %for.cond408.preheader.loopexit.unr-lcssa, %for.cond394.preheader.epil
  ...
  %epil.iter1014 = phi i64 [ %epil.iter1014.next, %for.cond394.preheader.epil ], [ 0, %for.cond408.preheader.loopexit.unr-lcssa ]
  %arrayidx399.epil = getelementptr inbounds ptr, ptr %208, i64 %indvars.iv893.epil
  ...
  %epil.iter1014.next = add i64 %epil.iter1014, 1
  %epil.iter1014.cmp.not = icmp eq i64 %epil.iter1014.next, %xtraiter1013
  br i1 %epil.iter1014.cmp.not, label %for.cond408.preheader, label %for.cond394.preheader.epil, !llvm.loop !49
...
for.body411:                                      ; preds = %for.body411.preheader, %for.inc456
  ...
  %wm414 = getelementptr inbounds %struct._shuryoten, ptr %223, i64 %indvars.iv900, i32 2
...
if.end423:                                        ; preds = %for.body411
  %arrayidx413 = getelementptr inbounds %struct._shuryoten, ptr %223, i64 %indvars.iv900
  %226 = load ptr, ptr @stderr, align 8, !tbaa !9
  %227 = load i32, ptr %arrayidx413, align 8, !tbaa !11
  %j429 = getelementptr inbounds %struct._shuryoten, ptr %223, i64 %indvars.iv900, i32 1
  %228 = load i32, ptr %j429, align 4, !tbaa !14
  %229 = trunc i64 %indvars.iv900 to i32
  ...
  %arrayidx436 = getelementptr inbounds %struct._shuryoten, ptr %235, i64 %indvars.iv900
  %236 = load i32, ptr %arrayidx436, align 8, !tbaa !11
  %j440 = getelementptr inbounds %struct._shuryoten, ptr %235, i64 %indvars.iv900, i32 1
...
if.end.i:                                         ; preds = %if.then.i, %entry.if.end_crit_edge.i
  ...
  %idxprom.i760 = sext i32 %236 to i64
  %arrayidx12.i = getelementptr inbounds ptr, ptr %230, i64 %idxprom.i760
...
for.body.preheader.i:                             ; preds = %for.cond.preheader.i
  %arrayidx20.phi.trans.insert.i = getelementptr inbounds ptr, ptr %233, i64 %idxprom.i760
  ...
  %arrayidx24.phi.trans.insert.i = getelementptr inbounds ptr, ptr %234, i64 %idxprom.i760
...
for.body.i761:                                    ; preds = %if.end75.i, %for.body.preheader.i
  %245 = phi i32 [ %.pre58.i, %for.body.preheader.i ], [ %287, %if.end75.i ]
  %246 = phi i32 [ %.pre56.i, %for.body.preheader.i ], [ %284, %if.end75.i ]
  ...
  %iin.020.i = phi i32 [ %236, %for.body.preheader.i ], [ %.fr.i, %if.end75.i ]
  %jin.019.i = phi i32 [ %237, %for.body.preheader.i ], [ %.fr90.i, %if.end75.i ]
  %.fr90.i = freeze i32 %245
  %.fr.i = freeze i32 %246
...
while.body.preheader.i:                           ; preds = %if.end33.i
  %250 = sext i32 %dec1.i to i64
  %251 = add i32 %iin.020.i, -2
  %xtraiter1018 = and i32 %dec1.i, 1
  %lcmp.mod1019.not = icmp eq i32 %xtraiter1018, 0
  br i1 %lcmp.mod1019.not, label %while.body.i.prol.loopexit, label %while.body.i.prol
...
while.body.i.prol:                                ; preds = %while.body.preheader.i
  ...
  %indvars.iv.next.i763.prol = add nsw i64 %250, -1
...
while.body.i.prol.loopexit:                       ; preds = %while.body.i.prol, %while.body.preheader.i
  ...
  %indvars.iv.i762.unr = phi i64 [ %250, %while.body.preheader.i ], [ %indvars.iv.next.i763.prol, %while.body.i.prol ]
...
while.body.i:                                     ; preds = %while.body.i.prol.loopexit, %while.body.i
  ...
  %257 = add nsw i64 %indvars.iv.i762, %idxprom27.i
  ...
  %260 = add nsw i64 %indvars.iv.next.i763, %idxprom27.i
  ...
  %262 = and i64 %indvars.iv.next.i763.1, 4294967295
...
while.end.loopexit.i:                             ; preds = %while.body.i, %while.body.i.prol.loopexit
  ...
  %263 = add i32 %k.021.i, %249
  %264 = add i32 %263, %iin.020.i
  br label %while.end.i

while.end.i:                                      ; preds = %while.end.loopexit.i, %if.end33.i
  %k.1.lcssa.i = phi i32 [ %k.021.i, %if.end33.i ], [ %264, %while.end.loopexit.i ]
  ...
  %265 = xor i32 %.fr90.i, -1
  %dec429.i = add i32 %jin.019.i, %265
...
while.body44.preheader.i:                         ; preds = %while.end.i
  %266 = sext i32 %dec429.i to i64
  %267 = add i32 %jin.019.i, -2
  %xtraiter1021 = and i32 %dec429.i, 1
  %lcmp.mod1022.not = icmp eq i32 %xtraiter1021, 0
  br i1 %lcmp.mod1022.not, label %while.body44.i.prol.loopexit, label %while.body44.i.prol
...
while.body44.i.prol:                              ; preds = %while.body44.preheader.i
  ...
  %indvars.iv.next52.i.prol = add nsw i64 %266, -1
...
while.body44.i.prol.loopexit:                     ; preds = %while.body44.i.prol, %while.body44.preheader.i
  ...
  %indvars.iv51.i.unr = phi i64 [ %266, %while.body44.preheader.i ], [ %indvars.iv.next52.i.prol, %while.body44.i.prol ]
...
while.body44.i:                                   ; preds = %while.body44.i.prol.loopexit, %while.body44.i
  ...
  %273 = add nsw i64 %indvars.iv51.i, %idxprom29.i
  ...
  %276 = add nsw i64 %indvars.iv.next52.i, %idxprom29.i
  ...
  %278 = and i64 %indvars.iv.next52.i.1, 4294967295
...
for.body99.lr.ph.i:                               ; preds = %if.end59.i, %if.end75.i, %while.end53.i.for.body99.lr.ph.i_crit_edge
  %288 = phi i32 [ %.pre920, %while.end53.i.for.body99.lr.ph.i_crit_edge ], [ %285, %if.end75.i ], [ %285, %if.end59.i ]
  ...
  %289 = select i1 %cmp90.i, i32 0, i32 %.fr90.i
...
for.body99.i:                                     ; preds = %if.end126.i, %for.body99.lr.ph.i
  %290 = phi i32 [ %.pre62.i, %for.body99.lr.ph.i ], [ %296, %if.end126.i ]
  %291 = phi i32 [ %.pre60.i, %for.body99.lr.ph.i ], [ %294, %if.end126.i ]
  %k.343.i = phi i32 [ 0, %for.body99.lr.ph.i ], [ %inc137.i, %if.end126.i ]
  %iin.142.i = phi i32 [ %236, %for.body99.lr.ph.i ], [ %291, %if.end126.i ]
  %jin.141.i = phi i32 [ %237, %for.body99.lr.ph.i ], [ %290, %if.end126.i ]
...
if.end446:                                        ; preds = %if.end126.i, %if.end118.i, %for.body99.i, %.thread80.i
  ...
  %call140.i = tail call ptr @strcpy(ptr noundef nonnull dereferenceable(1) %297, ptr noundef nonnull dereferenceable(1) %mspt1.3707983.i) #14
  %298 = load ptr, ptr %232, align 8, !tbaa !9
  %call142.i = tail call ptr @strcpy(ptr noundef nonnull dereferenceable(1) %298, ptr noundef nonnull dereferenceable(1) %mspt2.3717884.i) #14
  %299 = load ptr, ptr @stderr, align 8, !tbaa !9
  %call143.i = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %299, ptr noundef nonnull @.str.18, ptr noundef %mspt1.3707983.i, ptr noundef %mspt2.3717884.i) #11
  ...
  %wm451 = getelementptr inbounds %struct._shuryoten, ptr %306, i64 %indvars.iv900, i32 2
...
for.cond463.preheader:                            ; preds = %for.cond463.preheader.preheader, %for.cond463.preheader
  ...
  %arrayidx468 = getelementptr inbounds ptr, ptr %309, i64 %indvars.iv909
  ...
  %arrayidx468.1 = getelementptr inbounds ptr, ptr %313, i64 %indvars.iv909
  ...
  %arrayidx468.2 = getelementptr inbounds ptr, ptr %317, i64 %indvars.iv909
  ...
  %arrayidx468.3 = getelementptr inbounds ptr, ptr %321, i64 %indvars.iv909
  ...
  %arrayidx468.4 = getelementptr inbounds ptr, ptr %325, i64 %indvars.iv909
  ...
  %arrayidx468.5 = getelementptr inbounds ptr, ptr %329, i64 %indvars.iv909
  ...
  %arrayidx468.6 = getelementptr inbounds ptr, ptr %333, i64 %indvars.iv909
  ...
  %arrayidx468.7 = getelementptr inbounds ptr, ptr %337, i64 %indvars.iv909
  ...
  %arrayidx468.8 = getelementptr inbounds ptr, ptr %341, i64 %indvars.iv909
  ...
  %arrayidx468.9 = getelementptr inbounds ptr, ptr %345, i64 %indvars.iv909
  ...
  %arrayidx468.10 = getelementptr inbounds ptr, ptr %349, i64 %indvars.iv909
  ...
  %arrayidx468.11 = getelementptr inbounds ptr, ptr %353, i64 %indvars.iv909
  ...
  %arrayidx468.12 = getelementptr inbounds ptr, ptr %357, i64 %indvars.iv909
  ...
  %arrayidx468.13 = getelementptr inbounds ptr, ptr %361, i64 %indvars.iv909
  ...
  %arrayidx468.14 = getelementptr inbounds ptr, ptr %365, i64 %indvars.iv909
  ...
  %arrayidx468.15 = getelementptr inbounds ptr, ptr %369, i64 %indvars.iv909
  ...
  %arrayidx468.16 = getelementptr inbounds ptr, ptr %373, i64 %indvars.iv909
  ...
  %arrayidx468.17 = getelementptr inbounds ptr, ptr %377, i64 %indvars.iv909
  ...
  %arrayidx468.18 = getelementptr inbounds ptr, ptr %381, i64 %indvars.iv909
  ...
  %arrayidx468.19 = getelementptr inbounds ptr, ptr %385, i64 %indvars.iv909
