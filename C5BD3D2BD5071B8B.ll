...
while.end53.i:                                    ; preds = %while.body44.i.prol.loopexit, %while.body44.i, %while.end.i
  ...
  br i1 %or.cond.i, label %while.end53.i.for.end.i_crit_edge, label %if.end59.i

while.end53.i.for.end.i_crit_edge:                ; preds = %while.end53.i
...
if.end59.i:                                       ; preds = %while.end53.i
  ...
  br i1 %cmp72.i, label %for.end.i, label %if.end75.i
...
if.end75.i:                                       ; preds = %if.end59.i
  ...
  br i1 %or.cond90.i, label %for.end.i, label %for.body.i755, !llvm.loop !52

for.end.i:                                        ; preds = %if.end75.i, %if.end59.i, %while.end53.i.for.end.i_crit_edge
  %288 = phi i32 [ %.pre918, %while.end53.i.for.end.i_crit_edge ], [ %285, %if.end59.i ], [ %285, %if.end75.i ]
  %mspt1.3.i = phi ptr [ %mspt1.2.lcssa.i, %while.end53.i.for.end.i_crit_edge ], [ %incdec.ptr63.i, %if.end59.i ], [ %incdec.ptr63.i, %if.end75.i ]
  %mspt2.3.i = phi ptr [ %mspt2.2.lcssa.i, %while.end53.i.for.end.i_crit_edge ], [ %incdec.ptr67.i, %if.end59.i ], [ %incdec.ptr67.i, %if.end75.i ]
...
for.body99.i:                                     ; preds = %if.end126.i, %for.end.i
  %290 = phi i32 [ %.pre64.i, %for.end.i ], [ %296, %if.end126.i ]
  %291 = phi i32 [ %.pre62.i, %for.end.i ], [ %294, %if.end126.i ]
  %k.345.i = phi i32 [ 0, %for.end.i ], [ %inc137.i, %if.end126.i ]
  %iin.144.i = phi i32 [ %236, %for.end.i ], [ %291, %if.end126.i ]
  %jin.143.i = phi i32 [ %237, %for.end.i ], [ %290, %if.end126.i ]
