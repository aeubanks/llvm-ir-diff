...
while.body.i.i:                                   ; preds = %output_bit.exit.i.i, %output_bit.exit13.i.i
  %58 = phi i64 [ %sub.i.i, %output_bit.exit13.i.i ], [ %.pr.i.i, %output_bit.exit.i.i ]
  %spec.select.i51416.i.i = phi i32 [ %or.i4.i.i, %output_bit.exit13.i.i ], [ %shr.i.i.i, %output_bit.exit.i.i ]
  %59 = phi i32 [ %63, %output_bit.exit13.i.i ], [ %bits_to_go.promoted.i.i, %output_bit.exit.i.i ]
  %shr.i2.i.i = lshr i32 %spec.select.i51416.i.i, 1
  %or.i4.i.i = or i32 %shr.i2.i.i, 128
  %sub.i6.i.i = add nsw i32 %59, -1
...
if.then1.i12.i.i:                                 ; preds = %while.body.i.i
  ...
  %inc.i9.i.i = add i32 %61, 1
  store i32 %inc.i9.i.i, ptr @ari_pos, align 4, !tbaa !5
  %idxprom.i10.i.i = zext i32 %61 to i64
  %arrayidx.i11.i.i = getelementptr inbounds i8, ptr %60, i64 %idxprom.i10.i.i
...
output_bit.exit13.i.i:                            ; preds = %if.then1.i12.i.i, %while.body.i.i
  %62 = phi i64 [ %58, %while.body.i.i ], [ %.pre.i.i, %if.then1.i12.i.i ]
  %63 = phi i32 [ %sub.i6.i.i, %while.body.i.i ], [ 8, %if.then1.i12.i.i ]
...
while.body.i19.i:                                 ; preds = %output_bit.exit.i13.i, %output_bit.exit13.i28.i
  %67 = phi i64 [ %sub.i26.i, %output_bit.exit13.i28.i ], [ %.pr.i11.i, %output_bit.exit.i13.i ]
  %spec.select.i51416.i14.i = phi i32 [ %shr.i2.i15.i, %output_bit.exit13.i28.i ], [ %or.i.i2.i, %output_bit.exit.i13.i ]
  %68 = phi i32 [ %72, %output_bit.exit13.i28.i ], [ %bits_to_go.promoted.i10.i, %output_bit.exit.i13.i ]
  %shr.i2.i15.i = lshr i32 %spec.select.i51416.i14.i, 1
  %sub.i6.i17.i = add nsw i32 %68, -1
...
if.then1.i12.i25.i:                               ; preds = %while.body.i19.i
  ...
  %inc.i9.i21.i = add i32 %70, 1
  store i32 %inc.i9.i21.i, ptr @ari_pos, align 4, !tbaa !5
  %idxprom.i10.i22.i = zext i32 %70 to i64
  %arrayidx.i11.i23.i = getelementptr inbounds i8, ptr %69, i64 %idxprom.i10.i22.i
...
output_bit.exit13.i28.i:                          ; preds = %if.then1.i12.i25.i, %while.body.i19.i
  %71 = phi i64 [ %67, %while.body.i19.i ], [ %.pre.i24.i, %if.then1.i12.i25.i ]
  %72 = phi i32 [ %sub.i6.i17.i, %while.body.i19.i ], [ 8, %if.then1.i12.i25.i ]
...
if.end.sink.split.i:                              ; preds = %output_bit.exit13.i28.i, %output_bit.exit13.i.i
  ...
  %.lcssa35.sink.i = phi i32 [ %63, %output_bit.exit13.i.i ], [ %72, %output_bit.exit13.i28.i ]
