...
output_bit.exit.i.i:                              ; preds = %if.then1.i.i.i, %if.then.i
  ...
  br i1 %cmp14.i.i, label %while.body.i.i, label %done_encoding.exit

while.body.i.i:                                   ; preds = %output_bit.exit.i.i, %output_bit.exit12.i.i
  %58 = phi i64 [ %sub.i.i, %output_bit.exit12.i.i ], [ %.pr.i.i, %output_bit.exit.i.i ]
  %spec.select.i41315.i.i = phi i32 [ %or.i3.i.i, %output_bit.exit12.i.i ], [ %shr.i.i.i, %output_bit.exit.i.i ]
  %59 = phi i32 [ %63, %output_bit.exit12.i.i ], [ %bits_to_go.promoted.i.i, %output_bit.exit.i.i ]
  %shr.i2.i.i = lshr i32 %spec.select.i41315.i.i, 1
  %or.i3.i.i = or i32 %shr.i2.i.i, 128
  %sub.i5.i.i = add nsw i32 %59, -1
...
if.then1.i11.i.i:                                 ; preds = %while.body.i.i
  %conv.i7.i.i = trunc i32 %or.i3.i.i to i8
  %60 = load ptr, ptr @ari, align 8, !tbaa !17
  %61 = load i32, ptr @ari_pos, align 4, !tbaa !5
  %inc.i8.i.i = add i32 %61, 1
  store i32 %inc.i8.i.i, ptr @ari_pos, align 4, !tbaa !5
  %idxprom.i9.i.i = zext i32 %61 to i64
  %arrayidx.i10.i.i = getelementptr inbounds i8, ptr %60, i64 %idxprom.i9.i.i
...
output_bit.exit12.i.i:                            ; preds = %if.then1.i11.i.i, %while.body.i.i
  %62 = phi i64 [ %58, %while.body.i.i ], [ %.pre.i.i, %if.then1.i11.i.i ]
  %63 = phi i32 [ %sub.i5.i.i, %while.body.i.i ], [ 8, %if.then1.i11.i.i ]
  %sub.i.i = add nsw i64 %62, -1
  store i64 %sub.i.i, ptr @bits_to_follow, align 8, !tbaa !15
  %cmp.i.i = icmp sgt i64 %62, 1
...
output_bit.exit.i13.i:                            ; preds = %if.then1.i.i9.i, %if.else.i
  ...
  br i1 %cmp14.i12.i, label %while.body.i19.i, label %done_encoding.exit

while.body.i19.i:                                 ; preds = %output_bit.exit.i13.i, %output_bit.exit12.i28.i
  %67 = phi i64 [ %sub.i26.i, %output_bit.exit12.i28.i ], [ %.pr.i11.i, %output_bit.exit.i13.i ]
  %spec.select.i41315.i14.i = phi i32 [ %shr.i2.i15.i, %output_bit.exit12.i28.i ], [ %or.i.i2.i, %output_bit.exit.i13.i ]
  %68 = phi i32 [ %72, %output_bit.exit12.i28.i ], [ %bits_to_go.promoted.i10.i, %output_bit.exit.i13.i ]
  %shr.i2.i15.i = lshr i32 %spec.select.i41315.i14.i, 1
  %sub.i5.i17.i = add nsw i32 %68, -1
  %cmp.i6.i18.i = icmp eq i32 %sub.i5.i17.i, 0
  br i1 %cmp.i6.i18.i, label %if.then1.i11.i25.i, label %output_bit.exit12.i28.i

if.then1.i11.i25.i:                               ; preds = %while.body.i19.i
  %conv.i7.i20.i = trunc i32 %shr.i2.i15.i to i8
  %69 = load ptr, ptr @ari, align 8, !tbaa !17
  %70 = load i32, ptr @ari_pos, align 4, !tbaa !5
  %inc.i8.i21.i = add i32 %70, 1
  store i32 %inc.i8.i21.i, ptr @ari_pos, align 4, !tbaa !5
  %idxprom.i9.i22.i = zext i32 %70 to i64
  %arrayidx.i10.i23.i = getelementptr inbounds i8, ptr %69, i64 %idxprom.i9.i22.i
  store i8 %conv.i7.i20.i, ptr %arrayidx.i10.i23.i, align 1, !tbaa !9
  %.pre.i24.i = load i64, ptr @bits_to_follow, align 8, !tbaa !15
  br label %output_bit.exit12.i28.i

output_bit.exit12.i28.i:                          ; preds = %if.then1.i11.i25.i, %while.body.i19.i
  %71 = phi i64 [ %67, %while.body.i19.i ], [ %.pre.i24.i, %if.then1.i11.i25.i ]
  %72 = phi i32 [ %sub.i5.i17.i, %while.body.i19.i ], [ 8, %if.then1.i11.i25.i ]
  %sub.i26.i = add nsw i64 %71, -1
  store i64 %sub.i26.i, ptr @bits_to_follow, align 8, !tbaa !15
  %cmp.i27.i = icmp sgt i64 %71, 1
  br i1 %cmp.i27.i, label %while.body.i19.i, label %if.end.sink.split.i, !llvm.loop !23

if.end.sink.split.i:                              ; preds = %output_bit.exit12.i28.i, %output_bit.exit12.i.i
  %shr.i2.i15.lcssa.sink.i = phi i32 [ %or.i3.i.i, %output_bit.exit12.i.i ], [ %shr.i2.i15.i, %output_bit.exit12.i28.i ]
  %.lcssa35.sink.i = phi i32 [ %63, %output_bit.exit12.i.i ], [ %72, %output_bit.exit12.i28.i ]
...
done_encoding.exit:                               ; preds = %output_bit.exit.i.i, %output_bit.exit.i13.i, %if.end.sink.split.i
  %73 = phi i32 [ %bits_to_go.promoted.i.i, %output_bit.exit.i.i ], [ %bits_to_go.promoted.i10.i, %output_bit.exit.i13.i ], [ %.lcssa35.sink.i, %if.end.sink.split.i ]
  %74 = phi i32 [ %shr.i.i.i, %output_bit.exit.i.i ], [ %or.i.i2.i, %output_bit.exit.i13.i ], [ %shr.i2.i15.lcssa.sink.i, %if.end.sink.split.i ]
...
output_bit.exit.i:                                ; preds = %if.then1.i.i, %if.then
  ...
  br i1 %cmp14.i, label %while.body.i, label %if.end31

while.body.i:                                     ; preds = %output_bit.exit.i, %output_bit.exit12.i
  %10 = phi i64 [ %sub.i, %output_bit.exit12.i ], [ %.pr.i, %output_bit.exit.i ]
  %spec.select.i41315.i = phi i32 [ %or.i3.i, %output_bit.exit12.i ], [ %shr.i.i, %output_bit.exit.i ]
  %11 = phi i32 [ %15, %output_bit.exit12.i ], [ %bits_to_go.promoted.i, %output_bit.exit.i ]
  %shr.i2.i = lshr i32 %spec.select.i41315.i, 1
  %or.i3.i = or i32 %shr.i2.i, 128
  %sub.i5.i = add nsw i32 %11, -1
...
if.then1.i11.i:                                   ; preds = %while.body.i
  %conv.i7.i = trunc i32 %or.i3.i to i8
  %12 = load ptr, ptr @ari, align 8, !tbaa !17
  %13 = load i32, ptr @ari_pos, align 4, !tbaa !5
  %inc.i8.i = add i32 %13, 1
  store i32 %inc.i8.i, ptr @ari_pos, align 4, !tbaa !5
  %idxprom.i9.i = zext i32 %13 to i64
  %arrayidx.i10.i = getelementptr inbounds i8, ptr %12, i64 %idxprom.i9.i
...
output_bit.exit12.i:                              ; preds = %if.then1.i11.i, %while.body.i
  %14 = phi i64 [ %10, %while.body.i ], [ %.pre.i, %if.then1.i11.i ]
  %15 = phi i32 [ %sub.i5.i, %while.body.i ], [ 8, %if.then1.i11.i ]
...
while.cond.while.end_crit_edge.i:                 ; preds = %output_bit.exit12.i
  store i32 %or.i3.i, ptr @buffer, align 4, !tbaa !5
...
output_bit.exit.i53:                              ; preds = %if.then1.i.i49, %if.then17
  ...
  br i1 %cmp14.i52, label %while.body.i59, label %bit_plus_follow.exit70

while.body.i59:                                   ; preds = %output_bit.exit.i53, %output_bit.exit12.i68
  %18 = phi i64 [ %sub.i66, %output_bit.exit12.i68 ], [ %.pr.i51, %output_bit.exit.i53 ]
  %spec.select.i41315.i54 = phi i32 [ %shr.i2.i55, %output_bit.exit12.i68 ], [ %or.i.i42, %output_bit.exit.i53 ]
  %19 = phi i32 [ %23, %output_bit.exit12.i68 ], [ %bits_to_go.promoted.i50, %output_bit.exit.i53 ]
  %shr.i2.i55 = lshr i32 %spec.select.i41315.i54, 1
  %sub.i5.i57 = add nsw i32 %19, -1
  %cmp.i6.i58 = icmp eq i32 %sub.i5.i57, 0
  br i1 %cmp.i6.i58, label %if.then1.i11.i65, label %output_bit.exit12.i68

if.then1.i11.i65:                                 ; preds = %while.body.i59
  %conv.i7.i60 = trunc i32 %shr.i2.i55 to i8
  %20 = load ptr, ptr @ari, align 8, !tbaa !17
  %21 = load i32, ptr @ari_pos, align 4, !tbaa !5
  %inc.i8.i61 = add i32 %21, 1
  store i32 %inc.i8.i61, ptr @ari_pos, align 4, !tbaa !5
  %idxprom.i9.i62 = zext i32 %21 to i64
  %arrayidx.i10.i63 = getelementptr inbounds i8, ptr %20, i64 %idxprom.i9.i62
  store i8 %conv.i7.i60, ptr %arrayidx.i10.i63, align 1, !tbaa !9
  %.pre.i64 = load i64, ptr @bits_to_follow, align 8, !tbaa !15
  br label %output_bit.exit12.i68

output_bit.exit12.i68:                            ; preds = %if.then1.i11.i65, %while.body.i59
  %22 = phi i64 [ %18, %while.body.i59 ], [ %.pre.i64, %if.then1.i11.i65 ]
  %23 = phi i32 [ %sub.i5.i57, %while.body.i59 ], [ 8, %if.then1.i11.i65 ]
...
while.cond.while.end_crit_edge.i69:               ; preds = %output_bit.exit12.i68
...
if.end31:                                         ; preds = %while.cond.while.end_crit_edge.i, %output_bit.exit.i, %bit_plus_follow.exit70, %if.then25
  ...
  %shr.i2.i55.lcssa2 = phi i32 [ %or.i3.i, %while.cond.while.end_crit_edge.i ], [ %shr.i.i, %output_bit.exit.i ], [ %shr.i2.i55.lcssa4, %bit_plus_follow.exit70 ], [ %shr.i2.i55.lcssa3, %if.then25 ]
