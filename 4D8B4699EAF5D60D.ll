...
entry:
  ...
  %netptr.01287 = load ptr, ptr %6, align 8, !tbaa !5
  %cmp.not1288 = icmp eq ptr %netptr.01287, null
  br i1 %cmp.not1288, label %for.end, label %for.body

for.body:                                         ; preds = %entry, %for.inc
  %netptr.01293 = phi ptr [ %netptr.0, %for.inc ], [ %netptr.01287, %entry ]
  %bigoX.01292 = phi i32 [ %bigoX.2, %for.inc ], [ 0, %entry ]
  %litoY.01291 = phi i32 [ %litoY.2, %for.inc ], [ 1000000000, %entry ]
  %litoX.01290 = phi i32 [ %litoX.2, %for.inc ], [ 1000000000, %entry ]
  %bigoY.01289 = phi i32 [ %bigoY.1, %for.inc ], [ 0, %entry ]
  %terminal6 = getelementptr inbounds %struct.netbox, ptr %netptr.01293, i64 0, i32 5
  %7 = load i32, ptr %terminal6, align 8, !tbaa !14
  %cmp7.not = icmp eq i32 %7, %1
  br i1 %cmp7.not, label %for.inc, label %if.then

if.then:                                          ; preds = %for.body
  %xpos = getelementptr inbounds %struct.netbox, ptr %netptr.01293, i64 0, i32 1
  %8 = load i32, ptr %xpos, align 8, !tbaa !16
  %spec.select = tail call i32 @llvm.smin.i32(i32 %8, i32 %litoX.01290)
  %bigoX.1 = tail call i32 @llvm.smax.i32(i32 %8, i32 %bigoX.01292)
  %ypos = getelementptr inbounds %struct.netbox, ptr %netptr.01293, i64 0, i32 2
  %9 = load i32, ptr %ypos, align 4, !tbaa !17
  %litoY.1 = tail call i32 @llvm.smin.i32(i32 %9, i32 %litoY.01291)
  %spec.select1286 = tail call i32 @llvm.smax.i32(i32 %9, i32 %bigoY.01289)
  br label %for.inc

for.inc:                                          ; preds = %if.then, %for.body
  %bigoY.1 = phi i32 [ %bigoY.01289, %for.body ], [ %spec.select1286, %if.then ]
  %litoX.2 = phi i32 [ %litoX.01290, %for.body ], [ %spec.select, %if.then ]
  %litoY.2 = phi i32 [ %litoY.01291, %for.body ], [ %litoY.1, %if.then ]
  %bigoX.2 = phi i32 [ %bigoX.01292, %for.body ], [ %bigoX.1, %if.then ]
  %netptr.0 = load ptr, ptr %netptr.01293, align 8, !tbaa !5
...
if.then50:                                        ; preds = %if.else42
  ...
  %div = sdiv i32 %add, 2
  %cmp62.not1312 = icmp slt i32 %12, 2
  br i1 %cmp62.not1312, label %if.end982, label %for.body63.preheader

for.body63.preheader:                             ; preds = %if.then50
  %sub = sub nsw i32 %div, %14
  %cond = tail call i32 @llvm.abs.i32(i32 %sub, i1 true)
  %15 = add nuw i32 %12, 1
  %wide.trip.count1371 = zext i32 %15 to i64
  br label %for.body63

for.body63:                                       ; preds = %for.body63.preheader, %if.then83
  %indvars.iv1368 = phi i64 [ 2, %for.body63.preheader ], [ %indvars.iv.next1369, %if.then83 ]
  %distant.01313 = phi i32 [ %cond, %for.body63.preheader ], [ %cond81, %if.then83 ]
  %finaly66 = getelementptr inbounds %struct.flogbox, ptr %11, i64 %indvars.iv1368, i32 3
  %16 = load i32, ptr %finaly66, align 4, !tbaa !21
  %sub67 = sub nsw i32 %div, %16
  %cond81 = tail call i32 @llvm.abs.i32(i32 %sub67, i1 true)
  %cmp82 = icmp ult i32 %cond81, %distant.01313
...
if.then83:                                        ; preds = %for.body63
  ...
  br i1 %exitcond1372.not, label %if.end982, label %for.body63, !llvm.loop !23

for.end105.loopexit.split.loop.exit:              ; preds = %for.body63
  %17 = trunc i64 %indvars.iv1368 to i32
  %18 = add nsw i32 %17, -1
  br label %if.end982
...
if.else107:                                       ; preds = %if.else42
  ...
  %or.cond1275 = select i1 %cmp111.not, i1 true, i1 %cmp115.not
  br i1 %or.cond1275, label %if.else119, label %if.then116
...
if.else119:                                       ; preds = %if.else107
  %cmp145.not1322 = icmp slt i32 %12, 2
  br i1 %cmp115.not, label %if.then128, label %if.else192

if.then128:                                       ; preds = %if.else119
  br i1 %cmp145.not1322, label %for.end189, label %for.body146.preheader

for.body146.preheader:                            ; preds = %if.then128
  %sub131 = sub nsw i32 %litoY.0.lcssa, %14
  %19 = add nuw i32 %12, 1
  %wide.trip.count1381 = zext i32 %19 to i64
  br label %for.body146

for.body146:                                      ; preds = %for.body146.preheader, %if.then166
  %indvars.iv1378 = phi i64 [ 2, %for.body146.preheader ], [ %indvars.iv.next1379, %if.then166 ]
  %distant.11323 = phi i32 [ %sub131, %for.body146.preheader ], [ %cond164, %if.then166 ]
  %finaly149 = getelementptr inbounds %struct.flogbox, ptr %11, i64 %indvars.iv1378, i32 3
  ...
  %cmp165 = icmp slt i32 %cond164, %distant.11323
...
if.then166:                                       ; preds = %for.body146
  ...
  br i1 %exitcond1382.not, label %for.end189, label %for.body146, !llvm.loop !24

for.end189.loopexit.split.loop.exit:              ; preds = %for.body146
  %21 = trunc i64 %indvars.iv1378 to i32
  br label %for.end189
...
if.else192:                                       ; preds = %if.else119
  br i1 %cmp145.not1322, label %for.end253, label %for.body210.preheader
...
for.body210.preheader:                            ; preds = %if.else192
  ...
  %22 = add nuw i32 %12, 1
  %wide.trip.count1376 = zext i32 %22 to i64
  br label %for.body210

for.body210:                                      ; preds = %for.body210.preheader, %if.then230
  %indvars.iv1373 = phi i64 [ 2, %for.body210.preheader ], [ %indvars.iv.next1374, %if.then230 ]
  %distant.21318 = phi i32 [ %cond207, %for.body210.preheader ], [ %cond228, %if.then230 ]
  %finaly213 = getelementptr inbounds %struct.flogbox, ptr %11, i64 %indvars.iv1373, i32 3
  ...
  %cmp229 = icmp ult i32 %cond228, %distant.21318
...
if.then230:                                       ; preds = %for.body210
  ...
  br i1 %exitcond1377.not, label %for.end253, label %for.body210, !llvm.loop !25

for.end253.loopexit.split.loop.exit:              ; preds = %for.body210
  %24 = trunc i64 %indvars.iv1373 to i32
  br label %for.end253
...
if.else271:                                       ; preds = %if.else265
  ...
  %or.cond1277 = select i1 %cmp274.not, i1 true, i1 %cmp279.not
  br i1 %or.cond1277, label %if.else345, label %if.then280

if.then280:                                       ; preds = %if.else271
  %add281 = add nsw i32 %litoY.0.lcssa, %bigoY.0.lcssa
  %div282 = sdiv i32 %add281, 2
  %cmp299.not1297 = icmp slt i32 %12, 2
  br i1 %cmp299.not1297, label %if.end982, label %for.body300.preheader
...
for.body300:                                      ; preds = %for.body300.preheader, %if.then320
  ...
  %distant.31298 = phi i32 [ %cond297, %for.body300.preheader ], [ %cond318, %if.then320 ]
  ...
  %cmp319 = icmp ult i32 %cond318, %distant.31298
...
if.else345:                                       ; preds = %if.else271
  ...
  %or.cond1278 = select i1 %cmp348.not, i1 true, i1 %cmp353.not
  br i1 %or.cond1278, label %if.else357, label %if.then354
...
if.else357:                                       ; preds = %if.else345
  %cmp383.not1307 = icmp slt i32 %12, 2
  br i1 %cmp353.not, label %if.then366, label %if.else429

if.then366:                                       ; preds = %if.else357
  br i1 %cmp383.not1307, label %for.end427, label %for.body384.preheader
...
for.body384.preheader:                            ; preds = %if.then366
  ...
  %29 = add nuw i32 %12, 1
  %wide.trip.count1366 = zext i32 %29 to i64
  br label %for.body384

for.body384:                                      ; preds = %for.body384.preheader, %if.then404
  %indvars.iv1363 = phi i64 [ 2, %for.body384.preheader ], [ %indvars.iv.next1364, %if.then404 ]
  %distant.41308 = phi i32 [ %cond381, %for.body384.preheader ], [ %cond402, %if.then404 ]
  %finaly387 = getelementptr inbounds %struct.flogbox, ptr %11, i64 %indvars.iv1363, i32 3
  ...
  %cmp403 = icmp ult i32 %cond402, %distant.41308
...
if.then404:                                       ; preds = %for.body384
  ...
  br i1 %exitcond1367.not, label %for.end427, label %for.body384, !llvm.loop !27

for.end427.loopexit.split.loop.exit:              ; preds = %for.body384
  %31 = trunc i64 %indvars.iv1363 to i32
  br label %for.end427
...
if.else429:                                       ; preds = %if.else357
  br i1 %cmp383.not1307, label %for.end490, label %for.body447.preheader
...
for.body447.preheader:                            ; preds = %if.else429
  ...
  %32 = add nuw i32 %12, 1
  %wide.trip.count1361 = zext i32 %32 to i64
  br label %for.body447

for.body447:                                      ; preds = %for.body447.preheader, %if.then467
  %indvars.iv1358 = phi i64 [ 2, %for.body447.preheader ], [ %indvars.iv.next1359, %if.then467 ]
  %distant.51303 = phi i32 [ %cond444, %for.body447.preheader ], [ %cond465, %if.then467 ]
  %finaly450 = getelementptr inbounds %struct.flogbox, ptr %11, i64 %indvars.iv1358, i32 3
  ...
  %cmp466 = icmp ult i32 %cond465, %distant.51303
...
if.then467:                                       ; preds = %for.body447
  ...
  br i1 %exitcond1362.not, label %for.end490, label %for.body447, !llvm.loop !28

for.end490.loopexit.split.loop.exit:              ; preds = %for.body447
  %34 = trunc i64 %indvars.iv1358 to i32
  br label %for.end490
...
if.else516:                                       ; preds = %if.else511
  ...
  %or.cond1280 = select i1 %cmp520.not, i1 true, i1 %cmp524.not
  br i1 %or.cond1280, label %if.else590, label %if.then525

if.then525:                                       ; preds = %if.else516
  %add526 = add nsw i32 %bigoX.0.lcssa, %litoX.0.lcssa
  %div527 = sdiv i32 %add526, 2
  %cmp544.not1342 = icmp slt i32 %12, 2
  br i1 %cmp544.not1342, label %if.end982, label %for.body545.preheader

for.body545.preheader:                            ; preds = %if.then525
  %sub530 = sub nsw i32 %div527, %36
  %cond542 = tail call i32 @llvm.abs.i32(i32 %sub530, i1 true)
  %37 = add nuw i32 %12, 1
  %wide.trip.count1401 = zext i32 %37 to i64
  br label %for.body545

for.body545:                                      ; preds = %for.body545.preheader, %if.then565
  %indvars.iv1398 = phi i64 [ 2, %for.body545.preheader ], [ %indvars.iv.next1399, %if.then565 ]
  %distant.61343 = phi i32 [ %cond542, %for.body545.preheader ], [ %cond563, %if.then565 ]
  %finalx548 = getelementptr inbounds %struct.flogbox, ptr %11, i64 %indvars.iv1398, i32 2
  ...
  %cmp564 = icmp ult i32 %cond563, %distant.61343
...
if.then565:                                       ; preds = %for.body545
  ...
  br i1 %exitcond1402.not, label %if.end982, label %for.body545, !llvm.loop !30

for.end588.loopexit.split.loop.exit:              ; preds = %for.body545
  %39 = trunc i64 %indvars.iv1398 to i32
  %40 = add nsw i32 %39, -1
  br label %if.end982
...
if.else590:                                       ; preds = %if.else516
  ...
  br i1 %or.cond1281, label %if.else602, label %if.then599
...
if.else602:                                       ; preds = %if.else590
  %cmp628.not1352 = icmp slt i32 %12, 2
  br i1 %cmp598.not, label %if.then611, label %if.else675

if.then611:                                       ; preds = %if.else602
  br i1 %cmp628.not1352, label %for.end672, label %for.body629.preheader

for.body629.preheader:                            ; preds = %if.then611
  %sub614 = sub nsw i32 %litoX.0.lcssa, %36
  %41 = add nuw i32 %12, 1
  %wide.trip.count1411 = zext i32 %41 to i64
  br label %for.body629

for.body629:                                      ; preds = %for.body629.preheader, %if.then649
  %indvars.iv1408 = phi i64 [ 2, %for.body629.preheader ], [ %indvars.iv.next1409, %if.then649 ]
  %distant.71353 = phi i32 [ %sub614, %for.body629.preheader ], [ %cond647, %if.then649 ]
  %finalx632 = getelementptr inbounds %struct.flogbox, ptr %11, i64 %indvars.iv1408, i32 2
  ...
  %cmp648 = icmp slt i32 %cond647, %distant.71353
...
if.then649:                                       ; preds = %for.body629
  ...
  br i1 %exitcond1412.not, label %for.end672, label %for.body629, !llvm.loop !31

for.end672.loopexit.split.loop.exit:              ; preds = %for.body629
  %43 = trunc i64 %indvars.iv1408 to i32
  br label %for.end672
...
if.else675:                                       ; preds = %if.else602
  br i1 %cmp628.not1352, label %for.end736, label %for.body693.preheader
...
for.body693.preheader:                            ; preds = %if.else675
  ...
  %44 = add nuw i32 %12, 1
  %wide.trip.count1406 = zext i32 %44 to i64
  br label %for.body693

for.body693:                                      ; preds = %for.body693.preheader, %if.then713
  %indvars.iv1403 = phi i64 [ 2, %for.body693.preheader ], [ %indvars.iv.next1404, %if.then713 ]
  %distant.81348 = phi i32 [ %cond690, %for.body693.preheader ], [ %cond711, %if.then713 ]
  %finalx696 = getelementptr inbounds %struct.flogbox, ptr %11, i64 %indvars.iv1403, i32 2
  ...
  %cmp712 = icmp ult i32 %cond711, %distant.81348
...
if.then713:                                       ; preds = %for.body693
  ...
  br i1 %exitcond1407.not, label %for.end736, label %for.body693, !llvm.loop !32

for.end736.loopexit.split.loop.exit:              ; preds = %for.body693
  %46 = trunc i64 %indvars.iv1403 to i32
  br label %for.end736
...
if.else754:                                       ; preds = %if.else748
  ...
  %or.cond1283 = select i1 %cmp757.not, i1 true, i1 %cmp762.not
  br i1 %or.cond1283, label %if.else828, label %if.then763

if.then763:                                       ; preds = %if.else754
  %add764 = add nsw i32 %bigoX.0.lcssa, %litoX.0.lcssa
  %div765 = sdiv i32 %add764, 2
  %cmp782.not1327 = icmp slt i32 %12, 2
  br i1 %cmp782.not1327, label %if.end982, label %for.body783.preheader

for.body783.preheader:                            ; preds = %if.then763
  %sub768 = sub nsw i32 %div765, %36
  %cond780 = tail call i32 @llvm.abs.i32(i32 %sub768, i1 true)
  %47 = add nuw i32 %12, 1
  %wide.trip.count1386 = zext i32 %47 to i64
  br label %for.body783

for.body783:                                      ; preds = %for.body783.preheader, %if.then803
  %indvars.iv1383 = phi i64 [ 2, %for.body783.preheader ], [ %indvars.iv.next1384, %if.then803 ]
  %distant.91328 = phi i32 [ %cond780, %for.body783.preheader ], [ %cond801, %if.then803 ]
  %finalx786 = getelementptr inbounds %struct.flogbox, ptr %11, i64 %indvars.iv1383, i32 2
  ...
  %cmp802 = icmp ult i32 %cond801, %distant.91328
...
if.then803:                                       ; preds = %for.body783
  ...
  br i1 %exitcond1387.not, label %if.end982, label %for.body783, !llvm.loop !33

for.end826.loopexit.split.loop.exit:              ; preds = %for.body783
  %49 = trunc i64 %indvars.iv1383 to i32
  %50 = add nsw i32 %49, -1
  br label %if.end982
...
if.else828:                                       ; preds = %if.else754
  ...
  %or.cond1284 = select i1 %cmp831.not, i1 true, i1 %cmp836.not
  br i1 %or.cond1284, label %if.else840, label %if.then837
...
if.else840:                                       ; preds = %if.else828
  %cmp866.not1337 = icmp slt i32 %12, 2
  br i1 %cmp836.not, label %if.then849, label %if.else912

if.then849:                                       ; preds = %if.else840
  br i1 %cmp866.not1337, label %for.end910, label %for.body867.preheader
...
for.body867.preheader:                            ; preds = %if.then849
  ...
  %51 = add nuw i32 %12, 1
  %wide.trip.count1396 = zext i32 %51 to i64
  br label %for.body867

for.body867:                                      ; preds = %for.body867.preheader, %if.then887
  %indvars.iv1393 = phi i64 [ 2, %for.body867.preheader ], [ %indvars.iv.next1394, %if.then887 ]
  %distant.101338 = phi i32 [ %cond864, %for.body867.preheader ], [ %cond885, %if.then887 ]
  %finalx870 = getelementptr inbounds %struct.flogbox, ptr %11, i64 %indvars.iv1393, i32 2
  ...
  %cmp886 = icmp ult i32 %cond885, %distant.101338
...
if.then887:                                       ; preds = %for.body867
  ...
  br i1 %exitcond1397.not, label %for.end910, label %for.body867, !llvm.loop !34

for.end910.loopexit.split.loop.exit:              ; preds = %for.body867
  %53 = trunc i64 %indvars.iv1393 to i32
  br label %for.end910
...
if.else912:                                       ; preds = %if.else840
  br i1 %cmp866.not1337, label %for.end973, label %for.body930.preheader
...
for.body930.preheader:                            ; preds = %if.else912
  ...
  %54 = add nuw i32 %12, 1
  %wide.trip.count1391 = zext i32 %54 to i64
  br label %for.body930

for.body930:                                      ; preds = %for.body930.preheader, %if.then950
  %indvars.iv1388 = phi i64 [ 2, %for.body930.preheader ], [ %indvars.iv.next1389, %if.then950 ]
  %distant.111333 = phi i32 [ %cond927, %for.body930.preheader ], [ %cond948, %if.then950 ]
  %finalx933 = getelementptr inbounds %struct.flogbox, ptr %11, i64 %indvars.iv1388, i32 2
  ...
  %cmp949 = icmp ult i32 %cond948, %distant.111333
...
if.then950:                                       ; preds = %for.body930
  ...
  br i1 %exitcond1392.not, label %for.end973, label %for.body930, !llvm.loop !35

for.end973.loopexit.split.loop.exit:              ; preds = %for.body930
  %56 = trunc i64 %indvars.iv1388 to i32
  br label %for.end973
