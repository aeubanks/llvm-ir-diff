...
for.body:                                         ; preds = %for.body.lr.ph, %for.inc313
  ...
  %indvars.iv548 = phi i64 [ 1, %for.body.lr.ph ], [ %indvars.iv.next549, %for.inc313 ]
  %side.0503 = phi i32 [ undef, %for.body.lr.ph ], [ %side.4, %for.inc313 ]
  %arrayidx = getelementptr inbounds ptr, ptr %1, i64 %indvars.iv548
...
for.body6.lr.ph:                                  ; preds = %if.end
  %sideArray115 = getelementptr inbounds %struct.cellbox, ptr %3, i64 0, i32 22
  %numsides = getelementptr inbounds %struct.cellbox, ptr %3, i64 0, i32 7
  %9 = sext i32 %8 to i64
  br label %for.body6

for.body6:                                        ; preds = %for.body6.lr.ph, %for.inc310
  %indvars.iv545 = phi i64 [ 1, %for.body6.lr.ph ], [ %indvars.iv.next546, %for.inc310 ]
  %side.1498 = phi i32 [ %side.0503, %for.body6.lr.ph ], [ %side.3, %for.inc310 ]
  %sequence = getelementptr inbounds %struct.uncombox, ptr %6, i64 %indvars.iv545, i32 7
  %10 = load i32, ptr %sequence, align 4, !tbaa !18
  %cmp9.not = icmp eq i32 %10, 0
  br i1 %cmp9.not, label %for.inc310, label %if.then10

if.then10:                                        ; preds = %for.body6
  %numranges = getelementptr inbounds %struct.uncombox, ptr %6, i64 %indvars.iv545, i32 4
  %11 = load i32, ptr %numranges, align 4, !tbaa !20
  %cmp13 = icmp eq i32 %11, 1
  br i1 %cmp13, label %if.then14, label %if.else

if.then14:                                        ; preds = %if.then10
  %12 = load ptr, ptr %sideArray115, align 8, !tbaa !21
  %range1 = getelementptr inbounds %struct.uncombox, ptr %6, i64 %indvars.iv545, i32 5
  ...
  %cmp26.not479 = icmp slt i32 %15, %14
  br i1 %cmp26.not479, label %for.end, label %for.body27.preheader
...
for.body27.preheader:                             ; preds = %if.then14
  ...
  br i1 %min.iters.check, label %for.body27.preheader626, label %vector.ph

vector.ph:                                        ; preds = %for.body27.preheader
  %19 = zext i32 %18 to i64
  %20 = add nuw nsw i64 %19, 1
  %n.mod.vf = and i64 %20, 7
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %vec.phi577 = phi <4 x i32> [ zeroinitializer, %vector.ph ], [ %55, %vector.body ]
  %offset.idx = add i64 %index, %16
  %23 = add i64 %offset.idx, 1
  %24 = add i64 %offset.idx, 2
  %25 = add i64 %offset.idx, 3
  %26 = add i64 %offset.idx, 4
  %27 = add i64 %offset.idx, 5
  %28 = add i64 %offset.idx, 6
  %29 = add i64 %offset.idx, 7
  %30 = getelementptr inbounds %struct.contentbox, ptr %7, i64 %offset.idx, i32 2
  ...
  %54 = add <4 x i32> %45, %vec.phi
  %55 = add <4 x i32> %53, %vec.phi577
  %index.next = add nuw i64 %index, 8
  %56 = icmp eq i64 %index.next, %n.vec
  br i1 %56, label %middle.block, label %vector.body, !llvm.loop !28

middle.block:                                     ; preds = %vector.body
  %bin.rdx = add <4 x i32> %55, %54
  %57 = tail call i32 @llvm.vector.reduce.add.v4i32(<4 x i32> %bin.rdx)
  br label %for.body27.preheader626

for.body27.preheader626:                          ; preds = %for.body27.preheader, %middle.block
  %indvars.iv521.ph = phi i64 [ %16, %for.body27.preheader ], [ %ind.end, %middle.block ]
  %sum.0480.ph = phi i32 [ 0, %for.body27.preheader ], [ %57, %middle.block ]
  br label %for.body27

for.body27:                                       ; preds = %for.body27.preheader626, %for.body27
  %indvars.iv521 = phi i64 [ %indvars.iv.next522, %for.body27 ], [ %indvars.iv521.ph, %for.body27.preheader626 ]
  %sum.0480 = phi i32 [ %add, %for.body27 ], [ %sum.0480.ph, %for.body27.preheader626 ]
  %capacity = getelementptr inbounds %struct.contentbox, ptr %7, i64 %indvars.iv521, i32 2
  %58 = load i32, ptr %capacity, align 4, !tbaa !26
  %add = add nsw i32 %58, %sum.0480
  %indvars.iv.next522 = add nsw i64 %indvars.iv521, 1
  %lftr.wideiv524 = trunc i64 %indvars.iv.next522 to i32
  %exitcond525.not = icmp eq i32 %17, %lftr.wideiv524
  br i1 %exitcond525.not, label %for.end, label %for.body27, !llvm.loop !32
...
if.then34:                                        ; preds = %for.end
  %59 = trunc i64 %indvars.iv548 to i32
...
if.else:                                          ; preds = %if.then10
  %cmp41 = icmp eq i32 %11, 2
  br i1 %cmp41, label %if.then42, label %if.else108

if.then42:                                        ; preds = %if.else
  %65 = load ptr, ptr %sideArray115, align 8, !tbaa !21
  %range146 = getelementptr inbounds %struct.uncombox, ptr %6, i64 %indvars.iv545, i32 5
  ...
  %cmp58.not471 = icmp slt i32 %68, %67
  br i1 %cmp58.not471, label %for.end66, label %for.body59.preheader

for.body59.preheader:                             ; preds = %if.then42
  %69 = sext i32 %67 to i64
  %70 = add i32 %68, 1
  %71 = sub i32 %68, %67
  %min.iters.check596 = icmp ult i32 %71, 8
  br i1 %min.iters.check596, label %for.body59.preheader628, label %vector.ph597

vector.ph597:                                     ; preds = %for.body59.preheader
  %72 = zext i32 %71 to i64
  %73 = add nuw nsw i64 %72, 1
  %n.mod.vf598 = and i64 %73, 7
  %74 = icmp eq i64 %n.mod.vf598, 0
  %75 = select i1 %74, i64 8, i64 %n.mod.vf598
  %n.vec599 = sub nsw i64 %73, %75
  %ind.end600 = add nsw i64 %n.vec599, %69
  br label %vector.body602

vector.body602:                                   ; preds = %vector.body602, %vector.ph597
  %index603 = phi i64 [ 0, %vector.ph597 ], [ %index.next607, %vector.body602 ]
  %vec.phi604 = phi <4 x i32> [ zeroinitializer, %vector.ph597 ], [ %107, %vector.body602 ]
  %vec.phi605 = phi <4 x i32> [ zeroinitializer, %vector.ph597 ], [ %108, %vector.body602 ]
  %offset.idx606 = add i64 %index603, %69
  %76 = add i64 %offset.idx606, 1
  %77 = add i64 %offset.idx606, 2
  %78 = add i64 %offset.idx606, 3
  %79 = add i64 %offset.idx606, 4
  %80 = add i64 %offset.idx606, 5
  %81 = add i64 %offset.idx606, 6
  %82 = add i64 %offset.idx606, 7
  %83 = getelementptr inbounds %struct.contentbox, ptr %7, i64 %offset.idx606, i32 2
  ...
  %107 = add <4 x i32> %98, %vec.phi604
  %108 = add <4 x i32> %106, %vec.phi605
  %index.next607 = add nuw i64 %index603, 8
  %109 = icmp eq i64 %index.next607, %n.vec599
  br i1 %109, label %middle.block594, label %vector.body602, !llvm.loop !33

middle.block594:                                  ; preds = %vector.body602
  %bin.rdx608 = add <4 x i32> %108, %107
  %110 = tail call i32 @llvm.vector.reduce.add.v4i32(<4 x i32> %bin.rdx608)
  br label %for.body59.preheader628

for.body59.preheader628:                          ; preds = %for.body59.preheader, %middle.block594
  %indvars.iv512.ph = phi i64 [ %69, %for.body59.preheader ], [ %ind.end600, %middle.block594 ]
  %sum.1472.ph = phi i32 [ 0, %for.body59.preheader ], [ %110, %middle.block594 ]
  br label %for.body59

for.body59:                                       ; preds = %for.body59.preheader628, %for.body59
  %indvars.iv512 = phi i64 [ %indvars.iv.next513, %for.body59 ], [ %indvars.iv512.ph, %for.body59.preheader628 ]
  %sum.1472 = phi i32 [ %add63, %for.body59 ], [ %sum.1472.ph, %for.body59.preheader628 ]
  %capacity62 = getelementptr inbounds %struct.contentbox, ptr %7, i64 %indvars.iv512, i32 2
  %111 = load i32, ptr %capacity62, align 4, !tbaa !26
  %add63 = add nsw i32 %111, %sum.1472
  %indvars.iv.next513 = add nsw i64 %indvars.iv512, 1
  %lftr.wideiv = trunc i64 %indvars.iv.next513 to i32
  %exitcond515.not = icmp eq i32 %70, %lftr.wideiv
  br i1 %exitcond515.not, label %for.end66, label %for.body59, !llvm.loop !34
...
if.then71:                                        ; preds = %for.end66
  %112 = trunc i64 %indvars.iv548 to i32
...
if.end75:                                         ; preds = %for.end66
  %range2 = getelementptr inbounds %struct.uncombox, ptr %6, i64 %indvars.iv545, i32 6
  ...
  %cmp90.not475 = icmp slt i32 %120, %119
  br i1 %cmp90.not475, label %for.end98, label %for.body91.preheader

for.body91.preheader:                             ; preds = %if.end75
  %121 = sext i32 %119 to i64
  %122 = add i32 %120, 1
  %123 = sub i32 %120, %119
  %min.iters.check580 = icmp ult i32 %123, 8
  br i1 %min.iters.check580, label %for.body91.preheader627, label %vector.ph581

vector.ph581:                                     ; preds = %for.body91.preheader
  %124 = zext i32 %123 to i64
  %125 = add nuw nsw i64 %124, 1
  %n.mod.vf582 = and i64 %125, 7
  %126 = icmp eq i64 %n.mod.vf582, 0
  %127 = select i1 %126, i64 8, i64 %n.mod.vf582
  %n.vec583 = sub nsw i64 %125, %127
  %ind.end584 = add nsw i64 %n.vec583, %121
  br label %vector.body586

vector.body586:                                   ; preds = %vector.body586, %vector.ph581
  %index587 = phi i64 [ 0, %vector.ph581 ], [ %index.next591, %vector.body586 ]
  %vec.phi588 = phi <4 x i32> [ zeroinitializer, %vector.ph581 ], [ %159, %vector.body586 ]
  %vec.phi589 = phi <4 x i32> [ zeroinitializer, %vector.ph581 ], [ %160, %vector.body586 ]
  %offset.idx590 = add i64 %index587, %121
  %128 = add i64 %offset.idx590, 1
  %129 = add i64 %offset.idx590, 2
  %130 = add i64 %offset.idx590, 3
  %131 = add i64 %offset.idx590, 4
  %132 = add i64 %offset.idx590, 5
  %133 = add i64 %offset.idx590, 6
  %134 = add i64 %offset.idx590, 7
  %135 = getelementptr inbounds %struct.contentbox, ptr %7, i64 %offset.idx590, i32 2
  ...
  %159 = add <4 x i32> %150, %vec.phi588
  %160 = add <4 x i32> %158, %vec.phi589
  %index.next591 = add nuw i64 %index587, 8
  %161 = icmp eq i64 %index.next591, %n.vec583
  br i1 %161, label %middle.block578, label %vector.body586, !llvm.loop !36

middle.block578:                                  ; preds = %vector.body586
  %bin.rdx592 = add <4 x i32> %160, %159
  %162 = tail call i32 @llvm.vector.reduce.add.v4i32(<4 x i32> %bin.rdx592)
  br label %for.body91.preheader627

for.body91.preheader627:                          ; preds = %for.body91.preheader, %middle.block578
  %indvars.iv516.ph = phi i64 [ %121, %for.body91.preheader ], [ %ind.end584, %middle.block578 ]
  %sum.2476.ph = phi i32 [ 0, %for.body91.preheader ], [ %162, %middle.block578 ]
  br label %for.body91

for.body91:                                       ; preds = %for.body91.preheader627, %for.body91
  %indvars.iv516 = phi i64 [ %indvars.iv.next517, %for.body91 ], [ %indvars.iv516.ph, %for.body91.preheader627 ]
  %sum.2476 = phi i32 [ %add95, %for.body91 ], [ %sum.2476.ph, %for.body91.preheader627 ]
  %capacity94 = getelementptr inbounds %struct.contentbox, ptr %7, i64 %indvars.iv516, i32 2
  %163 = load i32, ptr %capacity94, align 4, !tbaa !26
  %add95 = add nsw i32 %163, %sum.2476
  %indvars.iv.next517 = add nsw i64 %indvars.iv516, 1
  %lftr.wideiv519 = trunc i64 %indvars.iv.next517 to i32
  %exitcond520.not = icmp eq i32 %122, %lftr.wideiv519
  br i1 %exitcond520.not, label %for.end98, label %for.body91, !llvm.loop !37
...
if.then103:                                       ; preds = %for.end98
  %164 = trunc i64 %indvars.iv548 to i32
...
if.else108:                                       ; preds = %if.else
  ...
  br i1 %cmp112, label %for.cond114.preheader, label %if.end210

for.cond114.preheader:                            ; preds = %if.else108
  %170 = load ptr, ptr %sideArray115, align 8, !tbaa !21
  ...
  %cmp119.not468 = icmp slt i32 %172, 1
  br i1 %cmp119.not468, label %for.end127, label %for.body120.preheader

for.body120.preheader:                            ; preds = %for.cond114.preheader
  %173 = add nuw i32 %172, 1
  %wide.trip.count = zext i32 %173 to i64
  %min.iters.check612 = icmp ult i32 %172, 9
  br i1 %min.iters.check612, label %for.body120.preheader629, label %vector.ph613

vector.ph613:                                     ; preds = %for.body120.preheader
  %174 = add nsw i64 %wide.trip.count, -1
  %n.mod.vf614 = and i64 %174, 7
  %175 = icmp eq i64 %n.mod.vf614, 0
  %176 = select i1 %175, i64 8, i64 %n.mod.vf614
  %n.vec615 = sub nsw i64 %174, %176
  %ind.end616 = add nsw i64 %n.vec615, 1
...
vector.body618:                                   ; preds = %vector.body618, %vector.ph613
  ...
  %vec.phi620 = phi <4 x i32> [ zeroinitializer, %vector.ph613 ], [ %208, %vector.body618 ]
  %vec.phi621 = phi <4 x i32> [ zeroinitializer, %vector.ph613 ], [ %209, %vector.body618 ]
  %offset.idx622 = or i64 %index619, 1
  %177 = or i64 %index619, 2
  %178 = or i64 %index619, 3
  %179 = or i64 %index619, 4
  %180 = or i64 %index619, 5
  %181 = or i64 %index619, 6
  %182 = or i64 %index619, 7
  %183 = add i64 %index619, 8
  %184 = getelementptr inbounds %struct.contentbox, ptr %7, i64 %offset.idx622, i32 2
  ...
  %208 = add <4 x i32> %199, %vec.phi620
  %209 = add <4 x i32> %207, %vec.phi621
  %index.next623 = add nuw i64 %index619, 8
  %210 = icmp eq i64 %index.next623, %n.vec615
  br i1 %210, label %middle.block610, label %vector.body618, !llvm.loop !39

middle.block610:                                  ; preds = %vector.body618
  %bin.rdx624 = add <4 x i32> %209, %208
  %211 = tail call i32 @llvm.vector.reduce.add.v4i32(<4 x i32> %bin.rdx624)
  br label %for.body120.preheader629

for.body120.preheader629:                         ; preds = %for.body120.preheader, %middle.block610
  %indvars.iv.ph = phi i64 [ 1, %for.body120.preheader ], [ %ind.end616, %middle.block610 ]
  %sum.3469.ph = phi i32 [ 0, %for.body120.preheader ], [ %211, %middle.block610 ]
  br label %for.body120

for.body120:                                      ; preds = %for.body120.preheader629, %for.body120
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.body120 ], [ %indvars.iv.ph, %for.body120.preheader629 ]
  %sum.3469 = phi i32 [ %add124, %for.body120 ], [ %sum.3469.ph, %for.body120.preheader629 ]
  %capacity123 = getelementptr inbounds %struct.contentbox, ptr %7, i64 %indvars.iv, i32 2
  %212 = load i32, ptr %capacity123, align 4, !tbaa !26
  %add124 = add nsw i32 %212, %sum.3469
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %for.end127, label %for.body120, !llvm.loop !40
...
if.then132:                                       ; preds = %for.end127
  %213 = trunc i64 %indvars.iv548 to i32
...
do.body.preheader:                                ; preds = %if.end139
  %.pre552 = load i32, ptr @randVar, align 4, !tbaa !5
  br label %do.body

do.body:                                          ; preds = %do.body.preheader, %do.body
  %219 = phi i32 [ %.pre552, %do.body.preheader ], [ %add148, %do.body ]
...
if.else159:                                       ; preds = %if.end139
  %cmp163 = icmp eq i32 %11, 2
  br i1 %cmp163, label %do.body166.preheader, label %if.else198
...
if.then189:                                       ; preds = %do.end186
  %range1192 = getelementptr inbounds %struct.uncombox, ptr %6, i64 %indvars.iv545, i32 5
  %225 = load i32, ptr %range1192, align 4, !tbaa !22
  br label %if.end210

if.else193:                                       ; preds = %do.end186
  %range2196 = getelementptr inbounds %struct.uncombox, ptr %6, i64 %indvars.iv545, i32 6
  %226 = load i32, ptr %range2196, align 4, !tbaa !35
  br label %if.end210

if.else198:                                       ; preds = %if.else159
  br i1 %cmp13, label %if.end210.thread, label %if.end210

if.end210.thread:                                 ; preds = %if.else198
  %range1207 = getelementptr inbounds %struct.uncombox, ptr %6, i64 %indvars.iv545, i32 5
...
if.end210:                                        ; preds = %if.else193, %if.then189, %if.else198, %if.else108, %if.end210.loopexit
  %228 = phi i32 [ %221, %if.end210.loopexit ], [ %11, %if.else198 ], [ %224, %if.else193 ], [ %224, %if.then189 ], [ %11, %if.else108 ]
  %side.2 = phi i32 [ %add152.le, %if.end210.loopexit ], [ %side.1498, %if.else198 ], [ %226, %if.else193 ], [ %225, %if.then189 ], [ %side.1498, %if.else108 ]
  %cmp214 = icmp eq i32 %228, 0
  br i1 %cmp214, label %if.then216, label %if.else220

if.then216:                                       ; preds = %if.end210
  %range1219 = getelementptr inbounds %struct.uncombox, ptr %6, i64 %indvars.iv545, i32 5
  %229 = load i32, ptr %range1219, align 4, !tbaa !22
  br label %if.end230

if.else220:                                       ; preds = %if.end210.thread, %if.end210
  %side.2557 = phi i32 [ %227, %if.end210.thread ], [ %side.2, %if.end210 ]
  %230 = load ptr, ptr %sideArray115, align 8, !tbaa !21
  %idxprom222 = sext i32 %side.2557 to i64
...
if.end230:                                        ; preds = %if.else220, %if.then216
  %side.2558 = phi i32 [ %side.2, %if.then216 ], [ %side.2557, %if.else220 ]
  ...
  %.pre553 = load i32, ptr @randVar, align 4, !tbaa !5
  br label %do.body231

do.body231:                                       ; preds = %do.body231.backedge, %if.end230
  %235 = phi i32 [ %.pre553, %if.end230 ], [ %add234, %do.body231.backedge ]
...
if.else245:                                       ; preds = %if.else245.lr.ph, %for.inc258
  %indvars.iv537 = phi i32 [ %add240, %if.else245.lr.ph ], [ %indvars.iv.next538, %for.inc258 ]
  %indvars.iv526 = phi i64 [ %238, %if.else245.lr.ph ], [ %indvars.iv.next527, %for.inc258 ]
  %sum.4484 = phi i32 [ 0, %if.else245.lr.ph ], [ %add249, %for.inc258 ]
  %capacity248 = getelementptr inbounds %struct.contentbox, ptr %7, i64 %indvars.iv526, i32 2
  %239 = load i32, ptr %capacity248, align 4, !tbaa !26
  %add249 = add nsw i32 %239, %sum.4484
  %cmp253.not = icmp slt i32 %add249, %236
  br i1 %cmp253.not, label %for.inc258, label %for.cond264.loopexit

for.inc258:                                       ; preds = %if.else245
  %indvars.iv.next527 = add nsw i64 %indvars.iv526, 1
  %lftr.wideiv529 = trunc i64 %indvars.iv.next527 to i32
  %exitcond530.not = icmp eq i32 %234, %lftr.wideiv529
  %indvars.iv.next538 = add i32 %indvars.iv537, 1
  br i1 %exitcond530.not, label %do.body231.backedge, label %if.else245

for.cond264.loopexit:                             ; preds = %if.else245
  %240 = trunc i64 %indvars.iv526 to i32
  %cmp265489 = icmp slt i32 %add240, %240
  %241 = trunc i64 %indvars.iv545 to i32
  br i1 %cmp265489, label %for.body267.preheader, label %for.end289

for.body267.preheader:                            ; preds = %for.cond264.loopexit
  %wide.trip.count540 = sext i32 %indvars.iv537 to i64
  br label %for.body267

for.body267:                                      ; preds = %for.body267.preheader, %for.end285
  %indvars.iv534 = phi i64 [ %238, %for.body267.preheader ], [ %indvars.iv.next535, %for.end285 ]
  %l.0491 = phi i32 [ %241, %for.body267.preheader ], [ %add276, %for.end285 ]
  %sum.5490 = phi i32 [ 0, %for.body267.preheader ], [ %add271, %for.end285 ]
  %arrayidx269 = getelementptr inbounds %struct.contentbox, ptr %7, i64 %indvars.iv534
  %capacity270 = getelementptr inbounds %struct.contentbox, ptr %7, i64 %indvars.iv534, i32 2
  %242 = load i32, ptr %capacity270, align 4, !tbaa !26
  %add271 = add nsw i32 %242, %sum.5490
  %243 = load i32, ptr %arrayidx269, align 4, !tbaa !43
  %add274 = add nsw i32 %243, %242
  store i32 %add274, ptr %arrayidx269, align 4, !tbaa !43
...
for.body279.preheader:                            ; preds = %for.body267
  ...
  %246 = trunc i64 %indvars.iv534 to i32
  br label %for.body279

for.body279:                                      ; preds = %for.body279.preheader, %for.body279
  %indvars.iv531 = phi i64 [ %244, %for.body279.preheader ], [ %indvars.iv.next532, %for.body279 ]
  %site282 = getelementptr inbounds %struct.uncombox, ptr %6, i64 %indvars.iv531, i32 1
  store i32 %246, ptr %site282, align 4, !tbaa !44
  %indvars.iv.next532 = add nsw i64 %indvars.iv531, 1
  %cmp277 = icmp slt i64 %indvars.iv.next532, %245
  br i1 %cmp277, label %for.body279, label %for.end285, !llvm.loop !45

for.end285:                                       ; preds = %for.body279, %for.body267
  %indvars.iv.next535 = add nsw i64 %indvars.iv534, 1
  %exitcond541.not = icmp eq i64 %indvars.iv.next535, %wide.trip.count540
  br i1 %exitcond541.not, label %for.end289, label %for.body267, !llvm.loop !46
...
for.end289:                                       ; preds = %for.end285, %for.cond264.loopexit
  ...
  %sext = shl i64 %indvars.iv526, 32
  %idxprom294 = ashr exact i64 %sext, 32
  %arrayidx295 = getelementptr inbounds %struct.contentbox, ptr %7, i64 %idxprom294
  %247 = load i32, ptr %arrayidx295, align 4, !tbaa !43
  %add297 = add nsw i32 %247, %sub293
  store i32 %add297, ptr %arrayidx295, align 4, !tbaa !43
...
for.body302.preheader:                            ; preds = %for.end289
  %add299 = add nsw i32 %sub293, %l.0.lcssa
...
for.body302:                                      ; preds = %for.body302.preheader, %for.body302
  %indvars.iv542 = phi i64 [ %248, %for.body302.preheader ], [ %indvars.iv.next543, %for.body302 ]
  %site305 = getelementptr inbounds %struct.uncombox, ptr %6, i64 %indvars.iv542, i32 1
  store i32 %240, ptr %site305, align 4, !tbaa !44
  %indvars.iv.next543 = add nsw i64 %indvars.iv542, 1
  %cmp300 = icmp slt i64 %indvars.iv.next543, %249
  br i1 %cmp300, label %for.body302, label %for.inc310, !llvm.loop !47

for.inc310:                                       ; preds = %for.body302, %for.end289, %for.body6
  %side.3 = phi i32 [ %side.1498, %for.body6 ], [ %side.2558, %for.end289 ], [ %side.2558, %for.body302 ]
  %indvars.iv.next546 = add nuw nsw i64 %indvars.iv545, 1
  %cmp5.not.not = icmp slt i64 %indvars.iv545, %9
  br i1 %cmp5.not.not, label %for.body6, label %for.inc313.loopexit, !llvm.loop !48

for.inc313.loopexit:                              ; preds = %for.inc310
  %.pre554 = load i32, ptr @numcells, align 4, !tbaa !5
  br label %for.inc313

for.inc313:                                       ; preds = %for.inc313.loopexit, %if.end, %for.body, %lor.lhs.false
  %250 = phi i32 [ %2, %for.body ], [ %2, %lor.lhs.false ], [ %2, %if.end ], [ %.pre554, %for.inc313.loopexit ]
  %side.4 = phi i32 [ %side.0503, %for.body ], [ %side.0503, %lor.lhs.false ], [ %side.0503, %if.end ], [ %side.3, %for.inc313.loopexit ]
  %indvars.iv.next549 = add nuw nsw i64 %indvars.iv548, 1
  %251 = sext i32 %250 to i64
  %cmp.not.not = icmp slt i64 %indvars.iv548, %251
  br i1 %cmp.not.not, label %for.body, label %for.end315, !llvm.loop !49
