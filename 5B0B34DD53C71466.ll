...
cond.false5086:                                   ; preds = %cond.end5078
  ...
  %.pre8090 = load ptr, ptr @xx_link, align 8, !tbaa !8
...
for.cond5963.preheader:                           ; preds = %for.cond5942
  ...
  %ylink.07956 = load ptr, ptr %ylink.0.in7955, align 8, !tbaa !5
...
if.then6113:                                      ; preds = %land.lhs.true6060
  ...
  %or.cond8233 = or i1 %cmp6117, %cmp6122
  %585 = select i1 %or.cond8233, i32 12, i32 11
...
cond.false6290:                                   ; preds = %cond.end6282
  ...
  %.pre8096 = load ptr, ptr @xx_link, align 8, !tbaa !8
...
cond.false6391:                                   ; preds = %cond.end6383
  ...
  %.pre8097 = load ptr, ptr @xx_link, align 8, !tbaa !8
