; ModuleID = '/usr/local/google/home/aeubanks/repos/test-suite/Bitcode/simd_ops/x86_tests/test_op_vcvtdq2ps_344.bc'
...
@str.11 = private constant [17 x i8] c"op_vcvtdq2ps_344\00", align 32
...
define i32 @__test_op(ptr noalias nocapture readnone %in_f32.buffer, ptr noalias nocapture readnone %in_f64.buffer, ptr noalias nocapture readnone %in_i8.buffer, ptr noalias nocapture readnone %in_u8.buffer, ptr noalias nocapture readnone %in_i16.buffer, ptr noalias nocapture readnone %in_u16.buffer, ptr noalias nocapture readonly %in_i32.buffer, ptr noalias nocapture readnone %in_u32.buffer, ptr noalias nocapture readnone %in_i64.buffer, ptr noalias nocapture readnone %in_u64.buffer, ptr noalias nocapture readonly %op_vcvtdq2ps_344.buffer) local_unnamed_addr #0 {
"produce op_vcvtdq2ps_344":
  %buf_extent168 = getelementptr inbounds %struct.buffer_t, ptr %op_vcvtdq2ps_344.buffer, i64 0, i32 2, i64 1
  %op_vcvtdq2ps_344.extent.1 = load i32, ptr %buf_extent168, align 4
  %buf_min176 = getelementptr inbounds %struct.buffer_t, ptr %op_vcvtdq2ps_344.buffer, i64 0, i32 4, i64 1
  %op_vcvtdq2ps_344.min.1 = load i32, ptr %buf_min176, align 4
  %0 = add nsw i32 %op_vcvtdq2ps_344.min.1, %op_vcvtdq2ps_344.extent.1
  %1 = icmp sgt i32 %op_vcvtdq2ps_344.extent.1, 0
  br i1 %1, label %"for op_vcvtdq2ps_344.s0.y.preheader", label %destructor_block, !prof !4

"for op_vcvtdq2ps_344.s0.y.preheader":            ; preds = %"produce op_vcvtdq2ps_344"
  ...
  %buf_min175 = getelementptr inbounds %struct.buffer_t, ptr %op_vcvtdq2ps_344.buffer, i64 0, i32 4, i64 0
  %op_vcvtdq2ps_344.min.0 = load i32, ptr %buf_min175, align 4
  %2 = sext i32 %op_vcvtdq2ps_344.min.0 to i64
  %buf_stride172 = getelementptr inbounds %struct.buffer_t, ptr %op_vcvtdq2ps_344.buffer, i64 0, i32 3, i64 1
  %op_vcvtdq2ps_344.stride.1 = load i32, ptr %buf_stride172, align 4
  %3 = sext i32 %op_vcvtdq2ps_344.stride.1 to i64
  %buf_host163 = getelementptr inbounds %struct.buffer_t, ptr %op_vcvtdq2ps_344.buffer, i64 0, i32 1
  %op_vcvtdq2ps_344.host = load ptr, ptr %buf_host163, align 8
  %4 = shl nsw i64 %2, 3
  %5 = sub nsw i64 32, %4
  %scevgep = getelementptr i8, ptr %op_vcvtdq2ps_344.host, i64 %5
  %6 = shl nsw i64 %3, 3
  ...
  %12 = load <8 x i32>, ptr %uglygep.1, align 32, !tbaa !5
  %13 = sitofp <8 x i32> %12 to <8 x float>
  ...
  %17 = load <8 x i32>, ptr %uglygep.2, align 32, !tbaa !5
  %18 = sitofp <8 x i32> %17 to <8 x float>
  ...
  %22 = load <8 x i32>, ptr %uglygep.3, align 32, !tbaa !5
  ...
  %27 = load <8 x i32>, ptr %uglygep.4, align 32, !tbaa !5
  %28 = sitofp <8 x i32> %27 to <8 x float>
  ...
  %32 = load <8 x i32>, ptr %uglygep.5, align 32, !tbaa !5
  %33 = sitofp <8 x i32> %32 to <8 x float>
  ...
  %37 = load <8 x i32>, ptr %uglygep.6, align 32, !tbaa !5
  ...
  %42 = load <8 x i32>, ptr %uglygep.7, align 32, !tbaa !5
  %43 = sitofp <8 x i32> %42 to <8 x float>
  ...
  %47 = load <8 x i32>, ptr %uglygep.8, align 32, !tbaa !5
  ...
  %52 = load <8 x i32>, ptr %uglygep.9, align 32, !tbaa !5
  ...
  %57 = load <8 x i32>, ptr %uglygep.10, align 32, !tbaa !5
  ...
  %62 = load <8 x i32>, ptr %uglygep.11, align 32, !tbaa !5
  %63 = sitofp <8 x i32> %62 to <8 x float>
  ...
  %67 = load <8 x i32>, ptr %uglygep.12, align 32, !tbaa !5
  ...
  %72 = load <8 x i32>, ptr %uglygep.13, align 32, !tbaa !5
  ...
  %77 = load <8 x i32>, ptr %uglygep.14, align 32, !tbaa !5
  ...
  %82 = load <8 x i32>, ptr %uglygep.15, align 32, !tbaa !5
  ...
  %87 = load <8 x i32>, ptr %uglygep.16, align 32, !tbaa !5
  ...
  %92 = load <8 x i32>, ptr %uglygep.17, align 32, !tbaa !5
  ...
  br label %"for op_vcvtdq2ps_344.s0.x.x.preheader"

"for op_vcvtdq2ps_344.s0.x.x.preheader":          ; preds = %"for op_vcvtdq2ps_344.s0.x.x.preheader", %"for op_vcvtdq2ps_344.s0.y.preheader"
  %lsr.iv180 = phi ptr [ %scevgep, %"for op_vcvtdq2ps_344.s0.y.preheader" ], [ %scevgep182, %"for op_vcvtdq2ps_344.s0.x.x.preheader" ]
  %op_vcvtdq2ps_344.s0.y = phi i32 [ %op_vcvtdq2ps_344.min.1, %"for op_vcvtdq2ps_344.s0.y.preheader" ], [ %167, %"for op_vcvtdq2ps_344.s0.x.x.preheader" ]
  ...
  %97 = load <8 x i32>, ptr %uglygep.18, align 32, !tbaa !5
  ...
  %102 = load <8 x i32>, ptr %uglygep.19, align 32, !tbaa !5
  ...
  %107 = load <8 x i32>, ptr %uglygep.20, align 32, !tbaa !5
  %108 = sitofp <8 x i32> %107 to <8 x float>
  ...
  %112 = load <8 x i32>, ptr %uglygep.21, align 32, !tbaa !5
  ...
  %117 = load <8 x i32>, ptr %uglygep.22, align 32, !tbaa !5
  ...
  %122 = load <8 x i32>, ptr %uglygep.23, align 32, !tbaa !5
  ...
  %127 = load <8 x i32>, ptr %uglygep.24, align 32, !tbaa !5
  ...
  %132 = load <8 x i32>, ptr %uglygep.25, align 32, !tbaa !5
  ...
  %137 = load <8 x i32>, ptr %uglygep.26, align 32, !tbaa !5
  ...
  %142 = load <8 x i32>, ptr %uglygep.27, align 32, !tbaa !5
  ...
  %147 = load <8 x i32>, ptr %uglygep.28, align 32, !tbaa !5
  ...
  %152 = load <8 x i32>, ptr %uglygep.29, align 32, !tbaa !5
  ...
  %157 = load <8 x i32>, ptr %uglygep.30, align 32, !tbaa !5
  %158 = sitofp <8 x i32> %157 to <8 x float>
  ...
  %162 = load <8 x i32>, ptr %uglygep.31, align 32, !tbaa !5
  ...
  %167 = add nsw i32 %op_vcvtdq2ps_344.s0.y, 1
  %scevgep182 = getelementptr i1, ptr %lsr.iv180, i64 %6
  %.not2 = icmp eq i32 %167, %0
  br i1 %.not2, label %destructor_block, label %"for op_vcvtdq2ps_344.s0.x.x.preheader"

destructor_block:                                 ; preds = %"for op_vcvtdq2ps_344.s0.x.x.preheader", %"produce op_vcvtdq2ps_344"
  ret i32 0
}

; Function Attrs: nofree norecurse nosync nounwind memory(readwrite, inaccessiblemem: none)
define i32 @test_op(ptr noalias nocapture readnone %in_f32.buffer, ptr noalias nocapture readnone %in_f64.buffer, ptr noalias nocapture readnone %in_i8.buffer, ptr noalias nocapture readnone %in_u8.buffer, ptr noalias nocapture readnone %in_i16.buffer, ptr noalias nocapture readnone %in_u16.buffer, ptr noalias nocapture readonly %in_i32.buffer, ptr noalias nocapture readnone %in_u32.buffer, ptr noalias nocapture readnone %in_i64.buffer, ptr noalias nocapture readnone %in_u64.buffer, ptr noalias nocapture readonly %op_vcvtdq2ps_344.buffer) local_unnamed_addr #1 {
destructor_block:
  %"__test_op_result$21" = tail call i32 @__test_op(ptr poison, ptr poison, ptr poison, ptr poison, ptr poison, ptr poison, ptr %in_i32.buffer, ptr poison, ptr poison, ptr poison, ptr %op_vcvtdq2ps_344.buffer) #3
  ret i32 0
}
