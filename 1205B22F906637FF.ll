...
for.body.i107:                                    ; preds = %for.inc81.i, %for.body.lr.ph.i104
  ...
  %arrayidx4.i = getelementptr inbounds ptr, ptr %207, i64 %indvars.iv193.i
...
land.lhs.true.i.i115:                             ; preds = %for.body.i.i113
  ...
  %cmp7.i.i = icmp eq i64 %indvars.iv193.i, %219
...
for.cond13.preheader.i:                           ; preds = %for.cond13.preheader.i.preheader, %for.inc54.i129
  ...
  %arrayidx17.i119 = getelementptr inbounds ptr, ptr %207, i64 %indvars.iv188.i
  %220 = load ptr, ptr %arrayidx17.i119, align 8, !tbaa !14
  %rules173.i = getelementptr inbounds %struct.Production, ptr %220, i64 0, i32 2
  %221 = load i32, ptr %rules173.i, align 8, !tbaa !74
  %cmp19174.not.i = icmp eq i32 %221, 0
...
for.body20.i:                                     ; preds = %for.cond13.preheader.i, %for.inc51.i128
  ...
  %arrayidx28.i = getelementptr inbounds ptr, ptr %223, i64 %indvars.iv185.i
  ...
  %cmp31171.not.i = icmp eq i32 %225, 0
...
for.inc51.i128:                                   ; preds = %for.cond29.i, %if.then42.i, %for.body20.i
  ...
  %cmp19.i = icmp ult i64 %indvars.iv.next186.i, %232
...
for.inc54.i129:                                   ; preds = %for.inc51.i128, %for.cond13.preheader.i
  ...
  %exitcond192.not.i = icmp eq i64 %indvars.iv.next189.i, %206
...
for.inc81.i:                                      ; preds = %for.inc.i.i118, %for.cond8.if.then60_crit_edge.i, %lor.lhs.false.i, %for.body.i107
  ...
  %exitcond197.not.i = icmp eq i64 %indvars.iv.next194.i, %206
