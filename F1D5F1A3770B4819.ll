...
invoke.cont9:                                     ; preds = %cond.false.i, %cond.true.i
  ...
  %10 = load float, ptr %arrayidx5.i, align 8, !tbaa !28
  %fneg8.i74 = fneg float %10
  %retval.sroa.3.12.vec.insert.i77 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %fneg8.i74, i64 0
  %11 = load <2 x float>, ptr %aabbMax, align 16, !tbaa !28
  %12 = fneg <2 x float> %11
  store <2 x float> %12, ptr %ref.tmp18, align 8
...
if.then62:                                        ; preds = %if.end40
  ...
  %sqrt260 = tail call float @llvm.sqrt.f32(float %add68)
  %15 = fneg float %sqrt260
  %add66.pn.p = select i1 %cmp63, float %15, float %sqrt260
  ...
  %sqrt261 = tail call float @llvm.sqrt.f32(float %16)
  %div74 = fdiv float 1.000000e+00, %sqrt261
