...
entry:
  ...
  %m_collisionMargin.i.i = getelementptr inbounds %class.btConvexInternalShape, ptr %pointShape, i64 0, i32 3
  store float 0.000000e+00, ptr %m_collisionMargin.i.i, align 8, !tbaa !57
...
if.then12:                                        ; preds = %invoke.cont10
  ...
  %2 = load float, ptr %arrayidx10.i.i, align 8, !tbaa !54
  %3 = load float, ptr %m_normal, align 8, !tbaa !54
  %arrayidx5.i.i = getelementptr inbounds %"struct.btConvexCast::CastResult", ptr %castResult, i64 0, i32 3, i32 0, i64 1
  %4 = load float, ptr %arrayidx5.i.i, align 4, !tbaa !54
  %mul8.i.i = fmul float %4, %4
  %5 = call float @llvm.fmuladd.f32(float %3, float %3, float %mul8.i.i)
  %6 = call float @llvm.fmuladd.f32(float %2, float %2, float %5)
  %cmp = fcmp ogt float %6, 0x3F1A36E2E0000000
  br i1 %cmp, label %if.then15, label %if.end38

if.then15:                                        ; preds = %if.then12
  %7 = load float, ptr %m_fraction.i, align 8, !tbaa !66
  %8 = load float, ptr %m_closestHitFraction, align 8, !tbaa !63
...
invoke.cont24:                                    ; preds = %if.then15
  ...
  %mul8.i20.i = fmul float %4, %11
  %12 = call float @llvm.fmuladd.f32(float %10, float %3, float %mul8.i20.i)
  %13 = call float @llvm.fmuladd.f32(float %9, float %2, float %12)
  %retval.sroa.3.12.vec.insert.i = insertelement <2 x float> <float poison, float 0.000000e+00>, float %13, i64 0
  store <2 x float> %retval.sroa.3.12.vec.insert.i, ptr %arrayidx10.i.i, align 8, !tbaa.struct !67
  ...
  store ptr %collisionObject, ptr %localRayResult, align 8, !tbaa !68
  %m_localShapeInfo.i = getelementptr inbounds %"struct.btCollisionWorld::LocalRayResult", ptr %localRayResult, i64 0, i32 1
  store ptr null, ptr %m_localShapeInfo.i, align 8, !tbaa !70
  ...
  store float %7, ptr %m_hitFraction.i, align 8, !tbaa !71
...
if.then55:                                        ; preds = %if.then51
  ...
  %81 = call float @llvm.fmuladd.f32(float %48, float %69, float %mul8.i29.i.i)
  %82 = call float @llvm.fmuladd.f32(float %50, float %68, float %81)
  ...
  %97 = call float @llvm.fmuladd.f32(float %48, float %85, float %mul8.i29.i.i229)
  %98 = call float @llvm.fmuladd.f32(float %50, float %84, float %97)
  %add17.i.i232 = fadd float %67, %98
  ...
  %100 = load i32, ptr %m_flags.i, align 4, !tbaa !72
...
_ZZN16btCollisionWorld13rayTestSingleERK11btTransformS2_P17btCollisionObjectPK16btCollisionShapeS2_RNS_17RayResultCallbackEEN29BridgeTriangleRaycastCallbackC2ERK9btVector3SD_PS8_S4_P19btTriangleMeshShapeS2_.exit: ; preds = %if.then55
  ...
  %101 = load float, ptr %m_closestHitFraction72, align 8, !tbaa !63
  %m_hitFraction = getelementptr inbounds %class.btTriangleRaycastCallback, ptr %rcb, i64 0, i32 4
  store float %101, ptr %m_hitFraction, align 4, !tbaa !79
...
if.else83:                                        ; preds = %if.then51
  ...
  %117 = call float @llvm.fmuladd.f32(float %48, float %105, float %mul8.i29.i.i291)
  %118 = call float @llvm.fmuladd.f32(float %50, float %104, float %117)
  %add17.i.i294 = fadd float %67, %118
  ...
  %133 = call float @llvm.fmuladd.f32(float %48, float %121, float %mul8.i29.i.i316)
  %134 = call float @llvm.fmuladd.f32(float %50, float %120, float %133)
  %add17.i.i319 = fadd float %67, %134
  ...
  %136 = load i32, ptr %m_flags.i325, align 4, !tbaa !72
...
_ZZN16btCollisionWorld13rayTestSingleERK11btTransformS2_P17btCollisionObjectPK16btCollisionShapeS2_RNS_17RayResultCallbackEEN29BridgeTriangleRaycastCallbackC2E_0RK9btVector3SD_PS8_S4_P14btConcaveShapeS2_.exit: ; preds = %if.else83
  ...
  %137 = load float, ptr %m_closestHitFraction104, align 8, !tbaa !63
  %m_hitFraction105 = getelementptr inbounds %class.btTriangleRaycastCallback, ptr %rcb101, i64 0, i32 4
  store float %137, ptr %m_hitFraction105, align 4, !tbaa !79
...
for.cond.preheader:                               ; preds = %invoke.cont125
  ...
  %153 = load i32, ptr %m_size.i.i, align 4, !tbaa !84
  %cmp131417 = icmp sgt i32 %153, 0
  br i1 %cmp131417, label %invoke.cont135.lr.ph, label %if.end155

invoke.cont135.lr.ph:                             ; preds = %for.cond.preheader
...
invoke.cont135:                                   ; preds = %invoke.cont135.lr.ph, %invoke.cont145
  %indvars.iv = phi i64 [ 0, %invoke.cont135.lr.ph ], [ %indvars.iv.next, %invoke.cont145 ]
  %154 = load ptr, ptr %m_data.i.i, align 8, !tbaa !87
  ...
  %childTrans.sroa.18.48.copyload = load float, ptr %childTrans.sroa.18.48.m_origin3.i.sroa_idx, align 4, !tbaa.struct !67
  ...
  %childTrans.sroa.17.48.copyload = load float, ptr %childTrans.sroa.17.48.m_origin3.i.sroa_idx, align 4, !tbaa.struct !88
  ...
  %childTrans.sroa.14.32.copyload = load float, ptr %childTrans.sroa.14.32.arrayidx10.i.i356.sroa_idx, align 4, !tbaa.struct !67
  ...
  %childTrans.sroa.10.16.copyload = load float, ptr %childTrans.sroa.10.16.arrayidx6.i.i355.sroa_idx, align 4, !tbaa.struct !67
  ...
  %childTrans.sroa.6.0.copyload = load float, ptr %childTrans.sroa.6.0.arrayidx.i.i354.sroa_idx, align 4, !tbaa.struct !67
  %m_childShape.i = getelementptr inbounds %struct.btCompoundShapeChild, ptr %154, i64 %indvars.iv, i32 1
  %155 = load ptr, ptr %m_childShape.i, align 8, !tbaa !89
  ...
  %159 = load float, ptr %arrayidx.i70.i.i, align 4, !tbaa !54, !noalias !91
  %160 = load float, ptr %arrayidx.i.i72.i.i, align 4, !tbaa !54, !noalias !91
  %161 = load float, ptr %arrayidx.i14.i75.i.i, align 4, !tbaa !54, !noalias !91
  ...
  %164 = load float, ptr %colObjWorldTransform, align 4, !tbaa !54, !noalias !91
  %165 = load float, ptr %arrayidx.i.i.i.i, align 4, !tbaa !54, !noalias !91
  %166 = load float, ptr %arrayidx.i14.i.i.i, align 4, !tbaa !54, !noalias !91
  ...
  %178 = load float, ptr %arrayidx.i.i.i362, align 4, !tbaa !54, !noalias !91
  %179 = load float, ptr %arrayidx.i.i52.i.i, align 4, !tbaa !54, !noalias !91
  %180 = load float, ptr %arrayidx.i14.i55.i.i, align 4, !tbaa !54, !noalias !91
  ...
  %195 = load <2 x float>, ptr %m_origin.i.i367, align 4, !tbaa !54, !noalias !91
  ...
  %199 = load float, ptr %arrayidx.i32.i.i373, align 4, !tbaa !54, !noalias !91
  ...
  store <2 x float> %175, ptr %childWorldTrans, align 8, !alias.scope !91
  store float %177, ptr %ref.tmp.sroa.5.0.agg.result.sroa_idx.i, align 8, !tbaa.struct !67, !alias.scope !91
  store float 0.000000e+00, ptr %ref.tmp.sroa.6.0.agg.result.sroa_idx.i, align 4, !tbaa.struct !94, !alias.scope !91
  ...
  store <2 x float> %208, ptr %arrayidx8.i.i.i378, align 8, !alias.scope !91
  store float %182, ptr %ref.tmp.sroa.10.16.arrayidx8.i.i.sroa_idx.i, align 8, !tbaa.struct !67, !alias.scope !91
  store float 0.000000e+00, ptr %ref.tmp.sroa.11.16.arrayidx8.i.i.sroa_idx.i, align 4, !tbaa.struct !94, !alias.scope !91
  ...
  store <2 x float> %217, ptr %arrayidx12.i.i7.i, align 8, !alias.scope !91
  store float %163, ptr %ref.tmp.sroa.15.32.arrayidx12.i.i7.sroa_idx.i, align 8, !tbaa.struct !67, !alias.scope !91
  store float 0.000000e+00, ptr %ref.tmp.sroa.16.32.arrayidx12.i.i7.sroa_idx.i, align 4, !tbaa.struct !94, !alias.scope !91
  store <2 x float> %196, ptr %m_origin.i8.i, align 8, !tbaa.struct !49, !alias.scope !91
  store <2 x float> %retval.sroa.3.12.vec.insert.i.i377, ptr %ref.tmp3.sroa.4.0.m_origin.i8.sroa_idx.i, align 8, !tbaa.struct !67, !alias.scope !91
...
invoke.cont145:                                   ; preds = %invoke.cont135
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %218 = load i32, ptr %m_size.i.i, align 4, !tbaa !84
  %219 = sext i32 %218 to i64
  %cmp131 = icmp slt i64 %indvars.iv.next, %219
  br i1 %cmp131, label %invoke.cont135, label %if.end155
...
if.then:                                          ; preds = %entry
  ...
  store float %allowedPenetration, ptr %m_allowedPenetration, align 8, !tbaa !62
  %m_closestHitFraction = getelementptr inbounds %"struct.btCollisionWorld::ConvexResultCallback", ptr %resultCallback, i64 0, i32 1
  %1 = load float, ptr %m_closestHitFraction, align 8, !tbaa !95
  store float %1, ptr %m_fraction.i, align 8, !tbaa !66
  call void @llvm.lifetime.start.p0(i64 356, ptr nonnull %simplexSolver) #15
  %m_usedVertices.i.i = getelementptr inbounds %class.btVoronoiSimplexSolver, ptr %simplexSolver, i64 0, i32 10, i32 1
  store i8 0, ptr %m_usedVertices.i.i, align 4
...
if.then8:                                         ; preds = %invoke.cont6
  %m_normal = getelementptr inbounds %"struct.btConvexCast::CastResult", ptr %castResult, i64 0, i32 3
  %arrayidx10.i.i = getelementptr inbounds %"struct.btConvexCast::CastResult", ptr %castResult, i64 0, i32 3, i32 0, i64 2
  %3 = load float, ptr %arrayidx10.i.i, align 8, !tbaa !54
  %4 = load <2 x float>, ptr %m_normal, align 8, !tbaa !54
  %5 = fmul <2 x float> %4, %4
  %mul8.i.i = extractelement <2 x float> %5, i64 1
  %6 = extractelement <2 x float> %4, i64 0
  %7 = call float @llvm.fmuladd.f32(float %6, float %6, float %mul8.i.i)
  %8 = call float @llvm.fmuladd.f32(float %3, float %3, float %7)
  %cmp = fcmp ogt float %8, 0x3F1A36E2E0000000
  br i1 %cmp, label %if.then11, label %if.end29

if.then11:                                        ; preds = %if.then8
  %9 = load float, ptr %m_fraction.i, align 8, !tbaa !66
  %10 = load float, ptr %m_closestHitFraction, align 8, !tbaa !95
...
if.then15:                                        ; preds = %if.then11
  ...
  store float %9, ptr %m_hitFraction.i, align 8, !tbaa !100
...
if.then48:                                        ; preds = %if.then45
  ...
  %72 = load float, ptr %arrayidx.i.i45.i, align 4, !tbaa !54, !noalias !101
  %arrayidx.i14.i46.i = getelementptr inbounds [3 x %class.btVector3], ptr %convexToTrans, i64 0, i64 1, i32 0, i64 2
  %73 = load float, ptr %arrayidx.i14.i46.i, align 4, !tbaa !54, !noalias !101
  ...
  %77 = load float, ptr %arrayidx.i16.i49.i, align 4, !tbaa !54, !noalias !101
  ...
  %87 = load <2 x float>, ptr %convexToTrans, align 4, !tbaa !54, !noalias !101
  %88 = load <2 x float>, ptr %arrayidx4.i.i, align 4, !tbaa !54, !noalias !101
  ...
  %93 = load <2 x float>, ptr %arrayidx9.i.i, align 4, !tbaa !54, !noalias !101
  ...
  store float %79, ptr %ref.tmp.sroa.5.0.rotationXform.sroa_idx, align 8, !tbaa.struct !67
  %ref.tmp.sroa.6.0.rotationXform.sroa_idx = getelementptr inbounds i8, ptr %rotationXform, i64 12
  store float 0.000000e+00, ptr %ref.tmp.sroa.6.0.rotationXform.sroa_idx, align 4, !tbaa.struct !94
  ...
  store float %84, ptr %ref.tmp.sroa.10.16.arrayidx8.i.i.sroa_idx, align 8, !tbaa.struct !67
  ...
  store float 0.000000e+00, ptr %ref.tmp.sroa.11.16.arrayidx8.i.i.sroa_idx, align 4, !tbaa.struct !94
  ...
  store float %86, ptr %ref.tmp.sroa.15.32.arrayidx12.i.i.sroa_idx, align 8, !tbaa.struct !67
  ...
  %112 = load float, ptr %m_closestHitFraction60, align 8, !tbaa !95
  %m_hitFraction = getelementptr inbounds %class.btTriangleConvexcastCallback, ptr %tccb, i64 0, i32 5
  store float %112, ptr %m_hitFraction, align 8, !tbaa !109
...
if.else79:                                        ; preds = %if.then45
  ...
  %148 = load float, ptr %arrayidx.i.i45.i351, align 4, !tbaa !54, !noalias !110
  %arrayidx.i14.i46.i352 = getelementptr inbounds [3 x %class.btVector3], ptr %convexToTrans, i64 0, i64 1, i32 0, i64 2
  %149 = load float, ptr %arrayidx.i14.i46.i352, align 4, !tbaa !54, !noalias !110
  ...
  %151 = load float, ptr %arrayidx.i16.i49.i354, align 4, !tbaa !54, !noalias !110
  ...
  %160 = load <2 x float>, ptr %convexToTrans, align 4, !tbaa !54, !noalias !110
  %161 = load <2 x float>, ptr %arrayidx4.i.i342, align 4, !tbaa !54, !noalias !110
  ...
  %166 = load <2 x float>, ptr %arrayidx9.i.i345, align 4, !tbaa !54, !noalias !110
  ...
  store float %152, ptr %ref.tmp90.sroa.5.0.rotationXform89.sroa_idx, align 8, !tbaa.struct !67
  %ref.tmp90.sroa.6.0.rotationXform89.sroa_idx = getelementptr inbounds i8, ptr %rotationXform89, i64 12
  store float 0.000000e+00, ptr %ref.tmp90.sroa.6.0.rotationXform89.sroa_idx, align 4, !tbaa.struct !94
  ...
  store float %157, ptr %ref.tmp90.sroa.10.16.arrayidx8.i.i382.sroa_idx, align 8, !tbaa.struct !67
  ...
  store float 0.000000e+00, ptr %ref.tmp90.sroa.11.16.arrayidx8.i.i382.sroa_idx, align 4, !tbaa.struct !94
  ...
  store float %159, ptr %ref.tmp90.sroa.15.32.arrayidx12.i.i384.sroa_idx, align 8, !tbaa.struct !67
  ...
  %185 = load float, ptr %m_closestHitFraction98, align 8, !tbaa !95
  %m_hitFraction99 = getelementptr inbounds %class.btTriangleConvexcastCallback, ptr %tccb97, i64 0, i32 5
  store float %185, ptr %m_hitFraction99, align 8, !tbaa !109
...
invoke.cont108:                                   ; preds = %if.else79
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i.i314, ptr %convexFromLocal81.sroa.6.0.rayAabbMinLocal.sroa_idx, align 8, !tbaa.struct !67
...
_Z8btSetMinIfEvRT_RKS0_.exit19.i:                 ; preds = %if.then.i18.i, %_Z8btSetMinIfEvRT_RKS0_.exit.i
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i.i314, ptr %convexFromLocal81.sroa.6.0.rayAabbMaxLocal.sroa_idx, align 8, !tbaa.struct !67
...
if.then135:                                       ; preds = %if.else133
  ...
  %m_size.i.i = getelementptr inbounds %class.btCompoundShape, ptr %collisionShape, i64 0, i32 1, i32 2
  %208 = load i32, ptr %m_size.i.i, align 4, !tbaa !84
  %cmp139514 = icmp sgt i32 %208, 0
  br i1 %cmp139514, label %invoke.cont143.lr.ph, label %for.end

invoke.cont143.lr.ph:                             ; preds = %if.then135
  %m_data.i.i = getelementptr inbounds %class.btCompoundShape, ptr %collisionShape, i64 0, i32 1, i32 5
  %arrayidx.i.i.i.i = getelementptr inbounds [4 x float], ptr %colObjWorldTransform, i64 0, i64 1
  %arrayidx.i14.i.i.i = getelementptr inbounds [4 x float], ptr %colObjWorldTransform, i64 0, i64 2
...
invoke.cont143:                                   ; preds = %invoke.cont143.lr.ph, %invoke.cont153
  %indvars.iv = phi i64 [ 0, %invoke.cont143.lr.ph ], [ %indvars.iv.next, %invoke.cont153 ]
  %209 = load ptr, ptr %m_data.i.i, align 8, !tbaa !87
  ...
  %childTrans.sroa.14.32.copyload = load float, ptr %childTrans.sroa.14.32.arrayidx10.i.i424.sroa_idx, align 4, !tbaa.struct !67
  ...
  %childTrans.sroa.10.16.copyload = load float, ptr %childTrans.sroa.10.16.arrayidx6.i.i422.sroa_idx, align 4, !tbaa.struct !67
  ...
  %childTrans.sroa.6.0.copyload = load float, ptr %childTrans.sroa.6.0.arrayidx.i.i421.sroa_idx, align 4, !tbaa.struct !67
  %m_childShape.i = getelementptr inbounds %struct.btCompoundShapeChild, ptr %209, i64 %indvars.iv, i32 1
  %210 = load ptr, ptr %m_childShape.i, align 8, !tbaa !89
  ...
  %214 = load float, ptr %arrayidx.i70.i.i, align 4, !tbaa !54, !noalias !117
  %215 = load float, ptr %arrayidx.i.i72.i.i, align 4, !tbaa !54, !noalias !117
  %216 = load float, ptr %arrayidx.i14.i75.i.i, align 4, !tbaa !54, !noalias !117
  ...
  %219 = load float, ptr %colObjWorldTransform, align 4, !tbaa !54, !noalias !117
  %220 = load float, ptr %arrayidx.i.i.i.i, align 4, !tbaa !54, !noalias !117
  %221 = load float, ptr %arrayidx.i14.i.i.i, align 4, !tbaa !54, !noalias !117
  ...
  %233 = load float, ptr %arrayidx.i.i.i430, align 4, !tbaa !54, !noalias !117
  %234 = load float, ptr %arrayidx.i.i52.i.i, align 4, !tbaa !54, !noalias !117
  %235 = load float, ptr %arrayidx.i14.i55.i.i, align 4, !tbaa !54, !noalias !117
  ...
  %250 = load <2 x float>, ptr %m_origin.i.i435, align 4, !tbaa !54, !noalias !117
  ...
  %254 = load float, ptr %arrayidx.i32.i.i441, align 4, !tbaa !54, !noalias !117
  ...
  store <2 x float> %230, ptr %childWorldTrans, align 8, !alias.scope !117
  store float %232, ptr %ref.tmp.sroa.5.0.agg.result.sroa_idx.i, align 8, !tbaa.struct !67, !alias.scope !117
  store float 0.000000e+00, ptr %ref.tmp.sroa.6.0.agg.result.sroa_idx.i, align 4, !tbaa.struct !94, !alias.scope !117
  ...
  store <2 x float> %263, ptr %arrayidx8.i.i.i446, align 8, !alias.scope !117
  store float %237, ptr %ref.tmp.sroa.10.16.arrayidx8.i.i.sroa_idx.i, align 8, !tbaa.struct !67, !alias.scope !117
  store float 0.000000e+00, ptr %ref.tmp.sroa.11.16.arrayidx8.i.i.sroa_idx.i, align 4, !tbaa.struct !94, !alias.scope !117
  ...
  store <2 x float> %272, ptr %arrayidx12.i.i7.i, align 8, !alias.scope !117
  store float %218, ptr %ref.tmp.sroa.15.32.arrayidx12.i.i7.sroa_idx.i, align 8, !tbaa.struct !67, !alias.scope !117
  store float 0.000000e+00, ptr %ref.tmp.sroa.16.32.arrayidx12.i.i7.sroa_idx.i, align 4, !tbaa.struct !94, !alias.scope !117
  store <2 x float> %251, ptr %m_origin.i8.i, align 8, !tbaa.struct !49, !alias.scope !117
  store <2 x float> %retval.sroa.3.12.vec.insert.i.i445, ptr %ref.tmp3.sroa.4.0.m_origin.i8.sroa_idx.i, align 8, !tbaa.struct !67, !alias.scope !117
...
invoke.cont153:                                   ; preds = %invoke.cont143
  ...
  call void @llvm.lifetime.end.p0(i64 64, ptr nonnull %childWorldTrans) #15
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %273 = load i32, ptr %m_size.i.i, align 4, !tbaa !84
  %274 = sext i32 %273 to i64
  %cmp139 = icmp slt i64 %indvars.iv.next, %274
  br i1 %cmp139, label %invoke.cont143, label %for.end
...
entry:
  ...
  store ptr %this, ptr %m_world.i, align 8, !tbaa !120
  ...
  store <2 x i32> %16, ptr %m_signs.i, align 8, !tbaa !123
  ...
  %21 = load float, ptr %arrayidx11.i105.i, align 8, !tbaa !54
  %arrayidx13.i106.i = getelementptr inbounds %struct.btSingleRayCallback, ptr %rayCB, i64 0, i32 1, i32 0, i64 2
  %22 = load float, ptr %arrayidx13.i106.i, align 8, !tbaa !54
  %sub14.i107.i = fsub float %21, %22
  ...
  store float %26, ptr %m_lambda_max.i, align 4, !tbaa !124
  %m_broadphasePairCache = getelementptr inbounds %class.btCollisionWorld, ptr %this, i64 0, i32 5
...
_ZN15btTransformUtil17calculateVelocityERK11btTransformS2_fR9btVector3S4_.exit: ; preds = %entry
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i.i29.i, ptr %ref.tmp6.sroa.4.0..sroa_idx.i, align 8, !tbaa.struct !67
...
invoke.cont31:                                    ; preds = %_ZNK11btTransform11getRotationEv.exit
  ...
  store ptr %this, ptr %m_world.i, align 8, !tbaa !125
  ...
  store float %allowedCcdPenetration, ptr %m_allowedCcdPenetration.i, align 8, !tbaa !127
  %m_castShape.i = getelementptr inbounds %struct.btSingleSweepCallback, ptr %convexCB, i64 0, i32 7
  store ptr %castShape, ptr %m_castShape.i, align 8, !tbaa !128
  ...
  store <2 x i32> %26, ptr %m_signs.i, align 8, !tbaa !123
  ...
  store i32 %conv66.i, ptr %arrayidx68.i, align 8, !tbaa !123
  ...
  store float %30, ptr %m_lambda_max.i, align 4, !tbaa !124
  %m_broadphasePairCache = getelementptr inbounds %class.btCollisionWorld, ptr %this, i64 0, i32 5
...
entry:
  ...
  store i32 %partId, ptr %shapeInfo, align 4, !tbaa !129
  %m_triangleIndex = getelementptr inbounds %"struct.btCollisionWorld::LocalShapeInfo", ptr %shapeInfo, i64 0, i32 1
  store i32 %triangleIndex, ptr %m_triangleIndex, align 4, !tbaa !131
  ...
  %29 = load ptr, ptr %m_collisionObject, align 8, !tbaa !77
  store ptr %29, ptr %rayResult, align 8, !tbaa !68
  %m_localShapeInfo.i = getelementptr inbounds %"struct.btCollisionWorld::LocalRayResult", ptr %rayResult, i64 0, i32 1
  store ptr %shapeInfo, ptr %m_localShapeInfo.i, align 8, !tbaa !70
  ...
  store <2 x float> %retval.sroa.3.12.vec.insert.i, ptr %hitNormalWorld.sroa.4.0.m_hitNormalLocal.i.sroa_idx, align 8, !tbaa.struct !67
  %m_hitFraction.i = getelementptr inbounds %"struct.btCollisionWorld::LocalRayResult", ptr %rayResult, i64 0, i32 3
  store float %hitFraction, ptr %m_hitFraction.i, align 8, !tbaa !71
  %m_resultCallback = getelementptr inbounds %struct.BridgeTriangleRaycastCallback, ptr %this, i64 0, i32 1
  %30 = load ptr, ptr %m_resultCallback, align 8, !tbaa !73
...
entry:
  ...
  %29 = load ptr, ptr %m_collisionObject, align 8, !tbaa !82
  store ptr %29, ptr %rayResult, align 8, !tbaa !68
  %m_localShapeInfo.i = getelementptr inbounds %"struct.btCollisionWorld::LocalRayResult", ptr %rayResult, i64 0, i32 1
  store ptr %shapeInfo, ptr %m_localShapeInfo.i, align 8, !tbaa !70
  %m_hitNormalLocal.i = getelementptr inbounds %"struct.btCollisionWorld::LocalRayResult", ptr %rayResult, i64 0, i32 2
  ...
  %30 = load ptr, ptr %m_resultCallback, align 8, !tbaa !80
  %vtable = load ptr, ptr %30, align 8, !tbaa !5
  %vfn = getelementptr inbounds ptr, ptr %vtable, i64 3
  %31 = load ptr, ptr %vfn, align 8
  %call3 = call noundef float %31(ptr noundef nonnull align 8 dereferenceable(32) %30, ptr noundef nonnull align 8 dereferenceable(36) %rayResult, i1 noundef zeroext true)
...
entry:
  ...
  %0 = load ptr, ptr %m_resultCallback, align 8, !tbaa !104
...
if.then:                                          ; preds = %entry
  ...
  %2 = load ptr, ptr %m_collisionObject, align 8, !tbaa !107
  store ptr %2, ptr %convexResult, align 8, !tbaa !97
  %m_localShapeInfo.i = getelementptr inbounds %"struct.btCollisionWorld::LocalConvexResult", ptr %convexResult, i64 0, i32 1
  store ptr %shapeInfo, ptr %m_localShapeInfo.i, align 8, !tbaa !99
  ...
  store float %hitFraction, ptr %m_hitFraction.i, align 8, !tbaa !100
  %vtable = load ptr, ptr %0, align 8, !tbaa !5
  %vfn = getelementptr inbounds ptr, ptr %vtable, i64 3
...
entry:
  ...
  %0 = load ptr, ptr %m_resultCallback, align 8, !tbaa !113
  %m_closestHitFraction = getelementptr inbounds %"struct.btCollisionWorld::ConvexResultCallback", ptr %0, i64 0, i32 1
  %1 = load float, ptr %m_closestHitFraction, align 8, !tbaa !95
  %cmp = fcmp ult float %1, %hitFraction
  br i1 %cmp, label %cleanup, label %if.then
...
if.then:                                          ; preds = %entry
  ...
  %2 = load ptr, ptr %m_collisionObject, align 8, !tbaa !115
  store ptr %2, ptr %convexResult, align 8, !tbaa !97
  %m_localShapeInfo.i = getelementptr inbounds %"struct.btCollisionWorld::LocalConvexResult", ptr %convexResult, i64 0, i32 1
  store ptr %shapeInfo, ptr %m_localShapeInfo.i, align 8, !tbaa !99
  %m_hitNormalLocal.i = getelementptr inbounds %"struct.btCollisionWorld::LocalConvexResult", ptr %convexResult, i64 0, i32 2
...
entry:
  ...
  %0 = load ptr, ptr %m_resultCallback, align 8, !tbaa !132
...
if.end:                                           ; preds = %entry
  %2 = load ptr, ptr %proxy, align 8, !tbaa !133
...
if.then4:                                         ; preds = %if.end
  ...
  %6 = load ptr, ptr %m_resultCallback, align 8, !tbaa !132
...
entry:
  ...
  %0 = load float, ptr %arrayidx9.i.i, align 4, !tbaa !54, !noalias !135
  ...
  %1 = load float, ptr %transform1, align 4, !tbaa !54, !noalias !138
  %arrayidx.i.i.i = getelementptr inbounds [4 x float], ptr %transform1, i64 0, i64 1
  %2 = load float, ptr %arrayidx.i.i.i, align 4, !tbaa !54, !noalias !138
  %arrayidx.i14.i.i = getelementptr inbounds [4 x float], ptr %transform1, i64 0, i64 2
  %3 = load float, ptr %arrayidx.i14.i.i, align 4, !tbaa !54, !noalias !138
  %arrayidx.i.i = getelementptr inbounds [3 x %class.btVector3], ptr %transform1, i64 0, i64 1
  %4 = load float, ptr %arrayidx.i.i, align 4, !tbaa !54, !noalias !138
  %arrayidx.i.i52.i = getelementptr inbounds [3 x %class.btVector3], ptr %transform1, i64 0, i64 1, i32 0, i64 1
  %5 = load float, ptr %arrayidx.i.i52.i, align 4, !tbaa !54, !noalias !138
  %arrayidx.i14.i55.i = getelementptr inbounds [3 x %class.btVector3], ptr %transform1, i64 0, i64 1, i32 0, i64 2
  %6 = load float, ptr %arrayidx.i14.i55.i, align 4, !tbaa !54, !noalias !138
  %arrayidx.i70.i = getelementptr inbounds [3 x %class.btVector3], ptr %transform1, i64 0, i64 2
  %7 = load float, ptr %arrayidx.i70.i, align 4, !tbaa !54, !noalias !138
  %arrayidx.i.i72.i = getelementptr inbounds [3 x %class.btVector3], ptr %transform1, i64 0, i64 2, i32 0, i64 1
  %8 = load float, ptr %arrayidx.i.i72.i, align 4, !tbaa !54, !noalias !138
  %arrayidx.i14.i75.i = getelementptr inbounds [3 x %class.btVector3], ptr %transform1, i64 0, i64 2, i32 0, i64 2
  %9 = load float, ptr %arrayidx.i14.i75.i, align 4, !tbaa !54, !noalias !138
  %10 = load float, ptr %arrayidx3.i.i, align 4, !tbaa !54, !noalias !135
  %11 = load float, ptr %arrayidx15.i.i, align 4, !tbaa !54, !noalias !135
  %12 = load <2 x float>, ptr %arrayidx6.i44.i, align 4, !tbaa !54, !noalias !135
  %13 = shufflevector <2 x float> %12, <2 x float> poison, <2 x i32> <i32 1, i32 0>
  %14 = load float, ptr %arrayidx.i42.i, align 4, !tbaa !54, !noalias !135
  %15 = load float, ptr %transform0, align 4, !tbaa !54, !noalias !135
  %16 = load float, ptr %arrayidx5.i53.i, align 4, !tbaa !54, !noalias !135
  %17 = load float, ptr %arrayidx10.i.i, align 4, !tbaa !54, !noalias !135
  ...
  store <2 x float> %64, ptr %dmat, align 8, !tbaa !54, !alias.scope !138
  %arrayidx5.i.i.i.i24 = getelementptr inbounds [4 x float], ptr %dmat, i64 0, i64 2
  store float %66, ptr %arrayidx5.i.i.i.i24, align 8, !tbaa !54, !alias.scope !138
  %arrayidx7.i.i.i.i25 = getelementptr inbounds [4 x float], ptr %dmat, i64 0, i64 3
  store float 0.000000e+00, ptr %arrayidx7.i.i.i.i25, align 4, !tbaa !54, !alias.scope !138
  ...
  store <2 x float> %79, ptr %arrayidx3.i.i.i26, align 8, !tbaa !54, !alias.scope !138
  %arrayidx5.i7.i.i.i28 = getelementptr inbounds [3 x %class.btVector3], ptr %dmat, i64 0, i64 1, i32 0, i64 2
  store float %68, ptr %arrayidx5.i7.i.i.i28, align 8, !tbaa !54, !alias.scope !138
  %arrayidx7.i8.i.i.i29 = getelementptr inbounds [3 x %class.btVector3], ptr %dmat, i64 0, i64 1, i32 0, i64 3
  store float 0.000000e+00, ptr %arrayidx7.i8.i.i.i29, align 4, !tbaa !54, !alias.scope !138
  ...
  store <2 x float> %88, ptr %arrayidx5.i.i.i30, align 8, !tbaa !54, !alias.scope !138
  %arrayidx5.i10.i.i.i32 = getelementptr inbounds [3 x %class.btVector3], ptr %dmat, i64 0, i64 2, i32 0, i64 2
  store float %70, ptr %arrayidx5.i10.i.i.i32, align 8, !tbaa !54, !alias.scope !138
  %arrayidx7.i11.i.i.i33 = getelementptr inbounds [3 x %class.btVector3], ptr %dmat, i64 0, i64 2, i32 0, i64 3
  store float 0.000000e+00, ptr %arrayidx7.i11.i.i.i33, align 4, !tbaa !54, !alias.scope !138
  ...
  %89 = load float, ptr %arrayidx7.i.i.i.i35, align 8, !tbaa !54
  ...
  store float %mul7.i.i.i, ptr %arrayidx7.i.i.i.i35, align 8, !tbaa !54
  ...
  store float %mul.i36, ptr %angle, align 4, !tbaa !54
  %100 = load <2 x float>, ptr %dorn, align 8, !tbaa !54
  %101 = load float, ptr %arrayidx7.i.i.i.i35, align 8, !tbaa !54
...
entry:
  ...
  %0 = load ptr, ptr %m_resultCallback, align 8, !tbaa !141
  %m_closestHitFraction = getelementptr inbounds %"struct.btCollisionWorld::ConvexResultCallback", ptr %0, i64 0, i32 1
  %1 = load float, ptr %m_closestHitFraction, align 8, !tbaa !95
  %cmp = fcmp une float %1, 0.000000e+00
  br i1 %cmp, label %if.end, label %return
...
if.then4:                                         ; preds = %if.end
  ...
  %5 = load ptr, ptr %m_castShape, align 8, !tbaa !128
  ...
  %m_worldTransform.i = getelementptr inbounds %class.btCollisionObject, ptr %2, i64 0, i32 1
  %7 = load ptr, ptr %m_resultCallback, align 8, !tbaa !141
  %m_allowedCcdPenetration = getelementptr inbounds %struct.btSingleSweepCallback, ptr %this, i64 0, i32 6
  %8 = load float, ptr %m_allowedCcdPenetration, align 8, !tbaa !127
...
!56 = !{}
!57 = !{!58, !21, i64 56}
!58 = !{!"_ZTS21btConvexInternalShape", !59, i64 0, !46, i64 24, !46, i64 40, !21, i64 56, !21, i64 60}
!59 = !{!"_ZTS13btConvexShape", !53, i64 0}
!60 = !{!61, !13, i64 176}
!61 = !{!"_ZTSN12btConvexCast10CastResultE", !44, i64 8, !44, i64 72, !46, i64 136, !46, i64 152, !21, i64 168, !13, i64 176, !21, i64 184}
!62 = !{!61, !21, i64 184}
!63 = !{!64, !21, i64 8}
!64 = !{!"_ZTSN16btCollisionWorld17RayResultCallbackE", !21, i64 8, !13, i64 16, !65, i64 24, !65, i64 26, !11, i64 28}
!65 = !{!"short", !12, i64 0}
!66 = !{!61, !21, i64 168}
!67 = !{i64 0, i64 8, !50}
!68 = !{!69, !13, i64 0}
!69 = !{!"_ZTSN16btCollisionWorld14LocalRayResultE", !13, i64 0, !13, i64 8, !46, i64 16, !21, i64 32}
!70 = !{!69, !13, i64 8}
!71 = !{!69, !21, i64 32}
!72 = !{!64, !11, i64 28}
!73 = !{!74, !13, i64 48}
!74 = !{!"_ZTSZN16btCollisionWorld13rayTestSingleERK11btTransformS2_P17btCollisionObjectPK16btCollisionShapeS2_RNS_17RayResultCallbackEE29BridgeTriangleRaycastCallback", !75, i64 0, !13, i64 48, !13, i64 56, !13, i64 64, !44, i64 72}
!75 = !{!"_ZTS25btTriangleRaycastCallback", !76, i64 0, !46, i64 8, !46, i64 24, !11, i64 40, !21, i64 44}
!76 = !{!"_ZTS18btTriangleCallback"}
!77 = !{!74, !13, i64 56}
!78 = !{!74, !13, i64 64}
!79 = !{!75, !21, i64 44}
!80 = !{!81, !13, i64 48}
!81 = !{!"_ZTSZN16btCollisionWorld13rayTestSingleERK11btTransformS2_P17btCollisionObjectPK16btCollisionShapeS2_RNS_17RayResultCallbackEE29BridgeTriangleRaycastCallback_0", !75, i64 0, !13, i64 48, !13, i64 56, !13, i64 64, !44, i64 72}
!82 = !{!81, !13, i64 56}
!83 = !{!81, !13, i64 64}
!84 = !{!85, !11, i64 4}
!85 = !{!"_ZTS20btAlignedObjectArrayI20btCompoundShapeChildE", !86, i64 0, !11, i64 4, !11, i64 8, !13, i64 16, !14, i64 24}
!86 = !{!"_ZTS18btAlignedAllocatorI20btCompoundShapeChildLj16EE"}
!87 = !{!85, !13, i64 16}
!88 = !{i64 0, i64 12, !50}
!89 = !{!90, !13, i64 64}
!90 = !{!"_ZTS20btCompoundShapeChild", !44, i64 0, !13, i64 64, !11, i64 72, !21, i64 76, !13, i64 80}
!91 = !{!92}
!92 = distinct !{!92, !93, !"_ZNK11btTransformmlERKS_: %agg.result"}
!93 = distinct !{!93, !"_ZNK11btTransformmlERKS_"}
!94 = !{i64 0, i64 4, !50}
!95 = !{!96, !21, i64 8}
!96 = !{!"_ZTSN16btCollisionWorld20ConvexResultCallbackE", !21, i64 8, !65, i64 12, !65, i64 14}
!97 = !{!98, !13, i64 0}
!98 = !{!"_ZTSN16btCollisionWorld17LocalConvexResultE", !13, i64 0, !13, i64 8, !46, i64 16, !46, i64 32, !21, i64 48}
!99 = !{!98, !13, i64 8}
!100 = !{!98, !21, i64 48}
!101 = !{!102}
...
!104 = !{!105, !13, i64 216}
!105 = !{!"_ZTSZN16btCollisionWorld17objectQuerySingleEPK13btConvexShapeRK11btTransformS5_P17btCollisionObjectPK16btCollisionShapeS5_RNS_20ConvexResultCallbackEfE32BridgeTriangleConvexcastCallback", !106, i64 0, !13, i64 216, !13, i64 224, !13, i64 232}
!106 = !{!"_ZTS28btTriangleConvexcastCallback", !76, i64 0, !13, i64 8, !44, i64 16, !44, i64 80, !44, i64 144, !21, i64 208, !21, i64 212}
!107 = !{!105, !13, i64 224}
!108 = !{!105, !13, i64 232}
!109 = !{!106, !21, i64 208}
!110 = !{!111}
!111 = distinct !{!111, !112, !"_ZmlRK11btMatrix3x3S1_: %agg.result"}
!112 = distinct !{!112, !"_ZmlRK11btMatrix3x3S1_"}
!113 = !{!114, !13, i64 216}
!114 = !{!"_ZTSZN16btCollisionWorld17objectQuerySingleEPK13btConvexShapeRK11btTransformS5_P17btCollisionObjectPK16btCollisionShapeS5_RNS_20ConvexResultCallbackEfE32BridgeTriangleConvexcastCallback_0", !106, i64 0, !13, i64 216, !13, i64 224, !13, i64 232}
!115 = !{!114, !13, i64 224}
!116 = !{!114, !13, i64 232}
!117 = !{!118}
!118 = distinct !{!118, !119, !"_ZNK11btTransformmlERKS_: %agg.result"}
!119 = distinct !{!119, !"_ZNK11btTransformmlERKS_"}
!120 = !{!121, !13, i64 216}
!121 = !{!"_ZTS19btSingleRayCallback", !122, i64 0, !46, i64 40, !46, i64 56, !44, i64 72, !44, i64 136, !46, i64 200, !13, i64 216, !13, i64 224}
!122 = !{!"_ZTS23btBroadphaseRayCallback", !46, i64 8, !12, i64 24, !21, i64 36}
!123 = !{!11, !11, i64 0}
!124 = !{!122, !21, i64 36}
!125 = !{!126, !13, i64 184}
!126 = !{!"_ZTS21btSingleSweepCallback", !122, i64 0, !44, i64 40, !44, i64 104, !46, i64 168, !13, i64 184, !13, i64 192, !21, i64 200, !13, i64 208}
!127 = !{!126, !21, i64 200}
!128 = !{!126, !13, i64 208}
!129 = !{!130, !11, i64 0}
!130 = !{!"_ZTSN16btCollisionWorld14LocalShapeInfoE", !11, i64 0, !11, i64 4}
!131 = !{!130, !11, i64 4}
!132 = !{!121, !13, i64 224}
!133 = !{!134, !13, i64 0}
!134 = !{!"_ZTS17btBroadphaseProxy", !13, i64 0, !65, i64 8, !65, i64 10, !13, i64 16, !11, i64 24, !46, i64 28, !46, i64 44}
!135 = !{!136}
!136 = distinct !{!136, !137, !"_ZNK11btMatrix3x37inverseEv: %agg.result"}
!137 = distinct !{!137, !"_ZNK11btMatrix3x37inverseEv"}
!138 = !{!139}
!139 = distinct !{!139, !140, !"_ZmlRK11btMatrix3x3S1_: %agg.result"}
