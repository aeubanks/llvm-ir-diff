...
for.cond176.preheader.lr.ph:                      ; preds = %if.then
  ...
  %reass.mul = mul i32 %reass.add, %cond50
  %cmp180311 = icmp slt i32 %9, 1
  %or.cond.not395 = select i1 %cmp177315, i1 true, i1 %cmp180311
  %brmerge = select i1 %or.cond.not395, i1 true, i1 %cmp183308
...
for.cond179.preheader.us.us.us.us.us.preheader:   ; preds = %for.cond176.preheader.lr.ph
  ...
  %ind.end396 = trunc i64 %n.vec to i32
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  %index398 = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ]
  %offset.idx = add i64 %index398, %16
  ...
  %index.next = add nuw i64 %index398, 4
...
for.body184.us.us.us.us.us.us.preheader:          ; preds = %for.cond182.preheader.us.us.us.us.us.us, %middle.block
  ...
  %loopi.1309.us.us.us.us.us.us.ph = phi i32 [ 0, %for.cond182.preheader.us.us.us.us.us.us ], [ %ind.end396, %middle.block ]
...
entry:
  ...
  %cmp1117 = icmp sgt i32 %3, 0
  br i1 %cmp1117, label %for.body.lr.ph, label %for.end
...
if.then:                                          ; preds = %for.end.thread, %for.end
  ...
  %cmp631414 = icmp sgt i32 %17, 0
  br i1 %cmp631414, label %for.body64.lr.ph, label %for.end776

for.body64.lr.ph:                                 ; preds = %if.then
  %cmp831334 = icmp sgt i32 %num_stencil_indices, 0
  %data = getelementptr inbounds %struct.hypre_StructMatrix_struct, ptr %matrix, i64 0, i32 6
  %data_indices = getelementptr inbounds %struct.hypre_StructMatrix_struct, ptr %matrix, i64 0, i32 9
  ...
  %wide.trip.count = zext i32 %num_stencil_indices to i64
  %wide.trip.count1452 = zext i32 %num_stencil_indices to i64
  %19 = shl nsw i64 %18, 3
  %20 = shl nsw i64 %18, 3
  %21 = shl nsw i64 %18, 1
  %22 = mul nsw i64 %18, 3
...
for.body64:                                       ; preds = %for.body64.lr.ph, %for.inc774
  %indvars.iv1454 = phi i64 [ 0, %for.body64.lr.ph ], [ %indvars.iv.next1455, %for.inc774 ]
  %25 = load ptr, ptr %call, align 8, !tbaa !35
  %arrayidx67 = getelementptr inbounds %struct.hypre_Box_struct, ptr %25, i64 %indvars.iv1454
  %26 = load ptr, ptr %14, align 8, !tbaa !35
  %arrayidx70 = getelementptr inbounds %struct.hypre_Box_struct, ptr %26, i64 %indvars.iv1454
...
if.then72:                                        ; preds = %for.body64
  ...
  br i1 %cmp831334, label %for.body84.lr.ph, label %for.inc774
...
for.body84.lr.ph:                                 ; preds = %if.then72
  ...
  %imax107 = getelementptr inbounds %struct.hypre_Box_struct, ptr %26, i64 %indvars.iv1454, i32 1
  %arrayidx108 = getelementptr inbounds %struct.hypre_Box_struct, ptr %26, i64 %indvars.iv1454, i32 1, i64 1
  br i1 %tobool93.not, label %for.body84.us, label %for.body84

for.body84.us:                                    ; preds = %for.body84.lr.ph, %if.end767.loopexit.us
  %indvars.iv1449 = phi i64 [ %indvars.iv.next1450, %if.end767.loopexit.us ], [ 0, %for.body84.lr.ph ]
  %dval_start.sroa.0.01338.us = phi i32 [ %inc769.us, %if.end767.loopexit.us ], [ %mul81, %for.body84.lr.ph ]
  %30 = load ptr, ptr %data, align 8, !tbaa !11
  %31 = load ptr, ptr %data_indices, align 8, !tbaa !12
  %arrayidx86.us = getelementptr inbounds ptr, ptr %31, i64 %indvars.iv1454
  %32 = load ptr, ptr %arrayidx86.us, align 8, !tbaa !13
  %arrayidx88.us = getelementptr inbounds i32, ptr %stencil_indices, i64 %indvars.iv1449
...
if.end767.loopexit.us:                            ; preds = %for.cond731.for.end754_crit_edge.split.us.us.us.us.us.us.us1403, %for.cond728.preheader.lr.ph.us, %for.body84.us
  %inc769.us = add nsw i32 %dval_start.sroa.0.01338.us, 1
  %indvars.iv.next1450 = add nuw nsw i64 %indvars.iv1449, 1
  %exitcond1453.not = icmp eq i64 %indvars.iv.next1450, %wide.trip.count1452
  br i1 %exitcond1453.not, label %for.inc774, label %for.body84.us, !llvm.loop !58
...
for.cond728.preheader.lr.ph.us:                   ; preds = %for.body84.us
  ...
  %cmp7291236.us = icmp slt i32 %37, 1
  %cmp7351224.us = icmp slt i32 %35, 1
  %sub747.us = sub i32 %cond466.us, %35
  %mul749.us = mul i32 %35, %num_stencil_indices
  %sub750.us = sub i32 %cond517.us, %mul749.us
  %reass.add1111.us = sub i32 %spec.select1100.us, %36
  %reass.mul1112.us = mul i32 %reass.add1111.us, %cond466.us
  %reass.add1113.us = sub i32 %cond498.us, %36
  %reass.mul1114.us = mul i32 %reass.add1113.us, %cond517.us
  %cmp7321229.us = icmp slt i32 %36, 1
  %or.cond.not1463 = select i1 %cmp7291236.us, i1 true, i1 %cmp7321229.us
  %brmerge = select i1 %or.cond.not1463, i1 true, i1 %cmp7351224.us
  br i1 %brmerge, label %if.end767.loopexit.us, label %for.cond731.preheader.us.us.us.us.us.us1376.preheader

for.cond731.preheader.us.us.us.us.us.us1376.preheader: ; preds = %for.cond728.preheader.lr.ph.us
  ...
  %sub473.us = sub i32 %dval_start.sroa.0.01338.us, %38
  ...
  br label %for.cond731.preheader.us.us.us.us.us.us1376

for.cond731.preheader.us.us.us.us.us.us1376:      ; preds = %for.cond731.preheader.us.us.us.us.us.us1376.preheader, %for.cond731.for.end754_crit_edge.split.us.us.us.us.us.us.us1403
  %datai.31239.us.us.us.us.us.us1377 = phi i32 [ %add757.us.us.us.us.us.us1406, %for.cond731.for.end754_crit_edge.split.us.us.us.us.us.us.us1403 ], [ %add468.us, %for.cond731.preheader.us.us.us.us.us.us1376.preheader ]
  %dvali.31238.us.us.us.us.us.us1378 = phi i32 [ %add760.us.us.us.us.us.us1407, %for.cond731.for.end754_crit_edge.split.us.us.us.us.us.us.us1403 ], [ %add519.us, %for.cond731.preheader.us.us.us.us.us.us1376.preheader ]
  %loopk.31237.us.us.us.us.us.us1379 = phi i32 [ %inc762.us.us.us.us.us.us1408, %for.cond731.for.end754_crit_edge.split.us.us.us.us.us.us.us1403 ], [ 0, %for.cond731.preheader.us.us.us.us.us.us1376.preheader ]
  br label %for.cond734.preheader.us.us.us.us.us.us.us1380

for.cond734.preheader.us.us.us.us.us.us.us1380:   ; preds = %for.cond734.for.end745_crit_edge.us.us.us.us.us.us.us1
  %indvars.iv1439 = phi i64 [ %indvars.iv.next1440.3, %for.body736.us.us.us.us.us.us.us1384 ], [ %indvars.iv1439.unr, %for.body736.us.us.us.us.us.us.us1384.prol.loopexit ]
  %loopi.31225.us.us.us.us.us.us.us1387 = phi i32 [ %inc744.us.us.us.us.us.us.us1394.3, %for.body736.us.us.us.us.us.us.us1384 ], [ %loopi.31225.us.us.us.us.us.us.us1387.unr, %for.body736.us.us.us.us.us.us.us1384.prol.loopexit ]
  %arrayidx738.us.us.us.us.us.us.us1389 = getelementptr inbounds double, ptr %values, i64 %indvars.iv1441
  %89 = load double, ptr %arrayidx738.us.us.us.us.us.us.us1389, align 8, !tbaa !43
  %arrayidx740.us.us.us.us.us.us.us1391 = getelementptr inbounds double, ptr %add.ptr.us, i64 %indvars.iv1439
  store double %89, ptr %arrayidx740.us.us.us.us.us.us.us1391, align 8, !tbaa !43
  %indvars.iv.next1440 = add nsw i64 %indvars.iv1439, 1
  %indvars.iv.next1442 = add i64 %indvars.iv1441, %18
  %arrayidx738.us.us.us.us.us.us.us1389.1 = getelementptr inbounds double, ptr %values, i64 %indvars.iv.next1442
  %90 = load double, ptr %arrayidx738.us.us.us.us.us.us.us1389.1, align 8, !tbaa !43
  %arrayidx740.us.us.us.us.us.us.us1391.1 = getelementptr inbounds double, ptr %add.ptr.us, i64 %indvars.iv.next1440
  store double %90, ptr %arrayidx740.us.us.us.us.us.us.us1391.1, align 8, !tbaa !43
  %indvars.iv.next1440.1 = add nsw i64 %indvars.iv1439, 2
  %indvars.iv.next1442.1 = add i64 %indvars.iv.next1442, %18
  %arrayidx738.us.us.us.us.us.us.us1389.2 = getelementptr inbounds double, ptr %values, i64 %indvars.iv.next1442.1
  %91 = load double, ptr %arrayidx738.us.us.us.us.us.us.us1389.2, align 8, !tbaa !43
  %arrayidx740.us.us.us.us.us.us.us1391.2 = getelementptr inbounds double, ptr %add.ptr.us, i64 %indvars.iv.next1440.1
  store double %91, ptr %arrayidx740.us.us.us.us.us.us.us1391.2, align 8, !tbaa !43
  %indvars.iv.next1440.2 = add nsw i64 %indvars.iv1439, 3
  %indvars.iv.next1442.2 = add i64 %indvars.iv.next1442.1, %18
  %arrayidx738.us.us.us.us.us.us.us1389.3 = getelementptr inbounds double, ptr %values, i64 %indvars.iv.next1442.2
  %92 = load double, ptr %arrayidx738.us.us.us.us.us.us.us1389.3, align 8, !tbaa !43
  %arrayidx740.us.us.us.us.us.us.us1391.3 = getelementptr inbounds double, ptr %add.ptr.us, i64 %indvars.iv.next1440.2
  store double %92, ptr %arrayidx740.us.us.us.us.us.us.us1391.3, align 8, !tbaa !43
  %indvars.iv.next1440.3 = add nsw i64 %indvars.iv1439, 4
  %indvars.iv.next1442.3 = add i64 %indvars.iv.next1442.2, %18
  %inc744.us.us.us.us.us.us.us1394.3 = add nuw nsw i32 %loopi.31225.us.us.us.us.us.us.us1387, 4
  %exitcond1446.not.3 = icmp eq i32 %inc744.us.us.us.us.us.us.us1394.3, %35
  br i1 %exitcond1446.not.3, label %for.cond734.for.end745_crit_edge.us.us.us.us.us.us.us1396, label %for.body736.us.us.us.us.us.us.us1384, !llvm.loop !66

for.cond734.for.end745_crit_edge.us.us.us.us.us.us.us1396: ; preds = %for.body736.us.us.us.us.us.us.us1384.prol.loopexit, %for.body736.us.us.us.us.us.us.us1384, %middle.block
  %indvars.iv.next1440.lcssa = phi i64 [ %ind.end1473, %middle.block ], [ %indvars.iv.next1440.lcssa1516.unr, %for.body736.us.us.us.us.us.us.us1384.prol.loopexit ], [ %indvars.iv.next1440.3, %for.body736.us.us.us.us.us.us.us1384 ]
  %indvars.iv.next1442.lcssa = phi i64 [ %ind.end, %middle.block ], [ %indvars.iv.next1442.lcssa1515.unr, %for.body736.us.us.us.us.us.us.us1384.prol.loopexit ], [ %indvars.iv.next1442.3, %for.body736.us.us.us.us.us.us.us1384 ]
  %93 = trunc i64 %indvars.iv.next1442.lcssa to i32
  %94 = trunc i64 %indvars.iv.next1440.lcssa to i32
  %add748.us.us.us.us.us.us.us1399 = add nsw i32 %sub747.us, %94
  %add751.us.us.us.us.us.us.us1400 = add nsw i32 %sub750.us, %93
  %inc753.us.us.us.us.us.us.us1401 = add nuw nsw i32 %loopj.31230.us.us.us.us.us.us.us1383, 1
  %exitcond1447.not = icmp eq i32 %inc753.us.us.us.us.us.us.us1401, %36
  br i1 %exitcond1447.not, label %for.cond731.for.end754_crit_edge.split.us.us.us.us.us.us.us1403, label %for.cond734.preheader.us.us.us.us.us.us.us1380, !llvm.loop !67

for.cond731.for.end754_crit_edge.split.us.us.us.us.us.us.us1403: ; preds = %for.cond734.for.end745_crit_edge.us.us.us.us.us.us.us1396
  %add757.us.us.us.us.us.us1406 = add i32 %reass.mul1112.us, %add748.us.us.us.us.us.us.us1399
  %add760.us.us.us.us.us.us1407 = add i32 %reass.mul1114.us, %add751.us.us.us.us.us.us.us1400
  %inc762.us.us.us.us.us.us1408 = add nuw nsw i32 %loopk.31237.us.us.us.us.us.us1379, 1
  %exitcond1448.not = icmp eq i32 %inc762.us.us.us.us.us.us1408, %37
  br i1 %exitcond1448.not, label %if.end767.loopexit.us, label %for.cond731.preheader.us.us.us.us.us.us1376, !llvm.loop !68

for.body84:                                       ; preds = %for.body84.lr.ph, %if.end767.loopexit1116
  %indvars.iv1435 = phi i64 [ %indvars.iv.next1436, %if.end767.loopexit1116 ], [ 0, %for.body84.lr.ph ]
  %dval_start.sroa.0.01338 = phi i32 [ %inc769, %if.end767.loopexit1116 ], [ %mul81, %for.body84.lr.ph ]
  %95 = load ptr, ptr %data, align 8, !tbaa !11
  %96 = load ptr, ptr %data_indices, align 8, !tbaa !12
  %arrayidx86 = getelementptr inbounds ptr, ptr %96, i64 %indvars.iv1454
  %97 = load ptr, ptr %arrayidx86, align 8, !tbaa !13
  %arrayidx88 = getelementptr inbounds i32, ptr %stencil_indices, i64 %indvars.iv1435
  ...
  br i1 %cmp316, label %for.cond377.preheader.lr.ph, label %if.end767.loopexit1116
...
for.cond377.preheader.lr.ph:                      ; preds = %for.body84
  ...
  %cmp3781131 = icmp slt i32 %102, 1
  %cmp3841119 = icmp slt i32 %100, 1
  %sub397 = sub i32 %cond138, %100
  %mul399 = mul i32 %100, %num_stencil_indices
  %sub400 = sub i32 %cond188, %mul399
  %reass.add = sub i32 %spec.select, %101
  %reass.mul = mul i32 %reass.add, %cond138
  %reass.add1104 = sub i32 %cond169, %101
  %reass.mul1105 = mul i32 %reass.add1104, %cond188
  %cmp3811124 = icmp slt i32 %101, 1
  %or.cond1460.not1462 = select i1 %cmp3781131, i1 true, i1 %cmp3811124
  %brmerge1461 = select i1 %or.cond1460.not1462, i1 true, i1 %cmp3841119
  br i1 %brmerge1461, label %if.end767.loopexit1116, label %for.cond380.preheader.us.us.us.us.us.preheader
...
for.cond380.preheader.us.us.us.us.us.preheader:   ; preds = %for.cond377.preheader.lr.ph
  ...
  %sub144 = sub i32 %dval_start.sroa.0.01338, %103
...
for.cond380.preheader.us.us.us.us.us:             ; preds = %for.cond380.preheader.us.us.us.us.us.preheader, %for.cond380.for.end404_crit_edge.split.us.us.us.us.us.us
  %datai.01134.us.us.us.us.us = phi i32 [ %add407.us.us.us.us.us, %for.cond380.for.end404_crit_edge.split.us.us.us.us.us.us ], [ %add140, %for.cond380.preheader.us.us.us.us.us.preheader ]
  %dvali.01133.us.us.us.us.us = phi i32 [ %add410.us.us.us.us.us, %for.cond380.for.end404_crit_edge.split.us.us.us.us.us.us ], [ %add190, %for.cond380.preheader.us.us.us.us.us.preheader ]
  %loopk.11132.us.us.us.us.us = phi i32 [ %inc412.us.us.us.us.us, %for.cond380.for.end404_crit_edge.split.us.us.us.us.us.us ], [ 0, %for.cond380.preheader.us.us.us.us.us.preheader ]
...
for.cond383.preheader.us.us.us.us.us.us:          ; preds = %for.cond383.for.end395_crit_edge.us.us.us.us.us.us, %for.cond380.preheader.us.us.us.us.us
  %datai.11127.us.us.us.us.us.us = phi i32 [ %datai.01134.us.us.us.us.us, %for.cond380.preheader.us.us.us.us.us ], [ %add398.us.us.us.us.us.us, %for.cond383.for.end395_crit_edge.us.us.us.us.us.us ]
  %dvali.11126.us.us.us.us.us.us = phi i32 [ %dvali.01133.us.us.us.us.us, %for.cond380.preheader.us.us.us.us.us ], [ %add401.us.us.us.us.us.us, %for.cond383.for.end395_crit_edge.us.us.us.us.us.us ]
  %loopj.11125.us.us.us.us.us.us = phi i32 [ 0, %for.cond380.preheader.us.us.us.us.us ], [ %inc403.us.us.us.us.us.us, %for.cond383.for.end395_crit_edge.us.us.us.us.us.us ]
  %124 = sext i32 %datai.11127.us.us.us.us.us.us to i64
  %125 = sext i32 %dvali.11126.us.us.us.us.us.us to i64
...
for.body385.us.us.us.us.us.us.preheader:          ; preds = %vector.memcheck1478, %for.cond383.preheader.us.us.us.us.us.us, %middle.block1493
  %indvars.iv1428.ph = phi i64 [ %125, %vector.memcheck1478 ], [ %125, %for.cond383.preheader.us.us.us.us.us.us ], [ %ind.end1499, %middle.block1493 ]
  %indvars.iv1426.ph = phi i64 [ %124, %vector.memcheck1478 ], [ %124, %for.cond383.preheader.us.us.us.us.us.us ], [ %ind.end1501, %middle.block1493 ]
  %loopi.11120.us.us.us.us.us.us.ph = phi i32 [ 0, %vector.memcheck1478 ], [ 0, %for.cond383.preheader.us.us.us.us.us.us ], [ %ind.end1503, %middle.block1493 ]
  %151 = sub i32 %100, %loopi.11120.us.us.us.us.us.us.ph
  %.neg = add i32 %loopi.11120.us.us.us.us.us.us.ph, 1
...
for.body385.us.us.us.us.us.us.prol:               ; preds = %for.body385.us.us.us.us.us.us.preheader
  %arrayidx387.us.us.us.us.us.us.prol = getelementptr inbounds double, ptr %values, i64 %indvars.iv1428.ph
  %152 = load double, ptr %arrayidx387.us.us.us.us.us.us.prol, align 8, !tbaa !43
  %arrayidx389.us.us.us.us.us.us.prol = getelementptr inbounds double, ptr %add.ptr, i64 %indvars.iv1426.ph
  ...
  %indvars.iv.next1427.prol = add nsw i64 %indvars.iv1426.ph, 1
  %indvars.iv.next1429.prol = add i64 %indvars.iv1428.ph, %18
  %inc394.us.us.us.us.us.us.prol = add nuw nsw i32 %loopi.11120.us.us.us.us.us.us.ph, 1
...
for.body385.us.us.us.us.us.us.prol.loopexit:      ; preds = %for.body385.us.us.us.us.us.us.prol, %for.body385.us.us.us.us.us.us.preheader
  %indvars.iv.next1427.lcssa1514.unr = phi i64 [ undef, %for.body385.us.us.us.us.us.us.preheader ], [ %indvars.iv.next1427.prol, %for.body385.us.us.us.us.us.us.prol ]
  %indvars.iv.next1429.lcssa1513.unr = phi i64 [ undef, %for.body385.us.us.us.us.us.us.preheader ], [ %indvars.iv.next1429.prol, %for.body385.us.us.us.us.us.us.prol ]
  %indvars.iv1428.unr = phi i64 [ %indvars.iv1428.ph, %for.body385.us.us.us.us.us.us.preheader ], [ %indvars.iv.next1429.prol, %for.body385.us.us.us.us.us.us.prol ]
  ...
  %loopi.11120.us.us.us.us.us.us.unr = phi i32 [ %loopi.11120.us.us.us.us.us.us.ph, %for.body385.us.us.us.us.us.us.preheader ], [ %inc394.us.us.us.us.us.us.prol, %for.body385.us.us.us.us.us.us.prol ]
...
for.body385.us.us.us.us.us.us:                    ; preds = %for.body385.us.us.us.us.us.us.prol.loopexit, %for.body385.us.us.us.us.us.us
  %indvars.iv1428 = phi i64 [ %indvars.iv.next1429.1, %for.body385.us.us.us.us.us.us ], [ %indvars.iv1428.unr, %for.body385.us.us.us.us.us.us.prol.loopexit ]
  ...
  %loopi.11120.us.us.us.us.us.us = phi i32 [ %inc394.us.us.us.us.us.us.1, %for.body385.us.us.us.us.us.us ], [ %loopi.11120.us.us.us.us.us.us.unr, %for.body385.us.us.us.us.us.us.prol.loopexit ]
  %arrayidx387.us.us.us.us.us.us = getelementptr inbounds double, ptr %values, i64 %indvars.iv1428
  %155 = load double, ptr %arrayidx387.us.us.us.us.us.us, align 8, !tbaa !43
  %arrayidx389.us.us.us.us.us.us = getelementptr inbounds double, ptr %add.ptr, i64 %indvars.iv1426
  ...
  %indvars.iv.next1429 = add i64 %indvars.iv1428, %18
  %arrayidx387.us.us.us.us.us.us.1 = getelementptr inbounds double, ptr %values, i64 %indvars.iv.next1429
  %157 = load double, ptr %arrayidx387.us.us.us.us.us.us.1, align 8, !tbaa !43
  %arrayidx389.us.us.us.us.us.us.1 = getelementptr inbounds double, ptr %add.ptr, i64 %indvars.iv.next1427
  ...
  %indvars.iv.next1427.1 = add nsw i64 %indvars.iv1426, 2
  %indvars.iv.next1429.1 = add i64 %indvars.iv.next1429, %18
  %inc394.us.us.us.us.us.us.1 = add nuw nsw i32 %loopi.11120.us.us.us.us.us.us, 2
...
for.cond383.for.end395_crit_edge.us.us.us.us.us.us: ; preds = %for.body385.us.us.us.us.us.us.prol.loopexit, %for.body385.us.us.us.us.us.us, %middle.block1493
  %indvars.iv.next1427.lcssa = phi i64 [ %ind.end1501, %middle.block1493 ], [ %indvars.iv.next1427.lcssa1514.unr, %for.body385.us.us.us.us.us.us.prol.loopexit ], [ %indvars.iv.next1427.1, %for.body385.us.us.us.us.us.us ]
  %indvars.iv.next1429.lcssa = phi i64 [ %ind.end1499, %middle.block1493 ], [ %indvars.iv.next1429.lcssa1513.unr, %for.body385.us.us.us.us.us.us.prol.loopexit ], [ %indvars.iv.next1429.1, %for.body385.us.us.us.us.us.us ]
  %159 = trunc i64 %indvars.iv.next1429.lcssa to i32
  %160 = trunc i64 %indvars.iv.next1427.lcssa to i32
  %add398.us.us.us.us.us.us = add nsw i32 %sub397, %160
  %add401.us.us.us.us.us.us = add nsw i32 %sub400, %159
  %inc403.us.us.us.us.us.us = add nuw nsw i32 %loopj.11125.us.us.us.us.us.us, 1
  %exitcond1433.not = icmp eq i32 %inc403.us.us.us.us.us.us, %101
  br i1 %exitcond1433.not, label %for.cond380.for.end404_crit_edge.split.us.us.us.us.us.us, label %for.cond383.preheader.us.us.us.us.us.us, !llvm.loop !76

for.cond380.for.end404_crit_edge.split.us.us.us.us.us.us: ; preds = %for.cond383.for.end395_crit_edge.us.us.us.us.us.us
  %add407.us.us.us.us.us = add i32 %reass.mul, %add398.us.us.us.us.us.us
  %add410.us.us.us.us.us = add i32 %reass.mul1105, %add401.us.us.us.us.us.us
  %inc412.us.us.us.us.us = add nuw nsw i32 %loopk.11132.us.us.us.us.us, 1
  %exitcond1434.not = icmp eq i32 %inc412.us.us.us.us.us, %102
  br i1 %exitcond1434.not, label %if.end767.loopexit1116, label %for.cond380.preheader.us.us.us.us.us, !llvm.loop !77

if.end767.loopexit1116:                           ; preds = %for.cond380.for.end404_crit_edge.split.us.us.us.us.us.us, %for.cond377.preheader.lr.ph, %for.body84
  %inc769 = add nsw i32 %dval_start.sroa.0.01338, 1
  %indvars.iv.next1436 = add nuw nsw i64 %indvars.iv1435, 1
  %exitcond1438.not = icmp eq i64 %indvars.iv.next1436, %wide.trip.count
  br i1 %exitcond1438.not, label %for.inc774, label %for.body84, !llvm.loop !58

for.inc774:                                       ; preds = %if.end767.loopexit1116, %if.end767.loopexit.us, %if.then72, %for.body64
  %indvars.iv.next1455 = add nuw nsw i64 %indvars.iv1454, 1
  %161 = load i32, ptr %size62, align 8, !tbaa !22
  %162 = sext i32 %161 to i64
  %cmp63 = icmp slt i64 %indvars.iv.next1455, %162
