...
136:                                              ; preds = %97, %67
  ...
  %140 = fptrunc <2 x double> %137 to <2 x float>
  %141 = fptrunc <2 x double> %138 to <2 x float>
  %142 = fadd <2 x float> %139, %140
  %143 = fcmp olt <2 x float> %140, zeroinitializer
  ...
  %148 = fcmp olt <2 x float> %141, zeroinitializer
  %149 = shufflevector <2 x i1> %148, <2 x i1> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1>
  %150 = shufflevector <2 x float> %141, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1>
