...
for.cond.preheader:                               ; preds = %cond.end
  %cmp1.not96 = icmp slt i32 %cond, 1
  br i1 %cmp1.not96, label %for.cond.cleanup9, label %for.body.lr.ph
...
common.resume:                                    ; preds = %lpad.i.i, %if.then.i.i.i.i.i, %ehcleanup27
  %common.resume.op = phi { ptr, i32 } [ %.pn91, %ehcleanup27 ], [ %1, %if.then.i.i.i.i.i ], [ %1, %lpad.i.i ]
  resume { ptr, i32 } %common.resume.op

for.cond7.preheader:                              ; preds = %invoke.cont
  %cmp898 = icmp sgt i32 %cond, 0
  br i1 %cmp898, label %for.body10.lr.ph, label %for.cond.cleanup9
...
for.body:                                         ; preds = %for.body.lr.ph, %invoke.cont
  %i.097 = phi i32 [ 1, %for.body.lr.ph ], [ %inc, %invoke.cont ]
  %call2 = call i32 (ptr, ptr, ...) @sprintf(ptr noundef nonnull dereferenceable(1) %buf, ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %i.097) #17
...
invoke.cont:                                      ; preds = %for.body.i.i, %call5.i.i.i.i.i.noexc
  %call5.i.i.i.pn.i.i = phi ptr [ %call5.i.i.i.i.i39, %call5.i.i.i.i.i.noexc ], [ %__cur.029.i.i, %for.body.i.i ]
  %second.i = getelementptr inbounds %"struct.__gnu_cxx::_Hashtable_node", ptr %call5.i.i.i.pn.i.i, i64 0, i32 1, i32 1
  store i32 %i.097, ptr %second.i, align 4, !tbaa !30
  %inc = add nuw i32 %i.097, 1
  %exitcond.not = icmp eq i32 %i.097, %cond
...
for.body10:                                       ; preds = %for.body10.lr.ph, %invoke.cont17
  %i6.0100 = phi i32 [ %cond, %for.body10.lr.ph ], [ %dec, %invoke.cont17 ]
  %c.099 = phi i32 [ 0, %for.body10.lr.ph ], [ %spec.select, %invoke.cont17 ]
  %call12 = call i32 (ptr, ptr, ...) @sprintf(ptr noundef nonnull dereferenceable(1) %buf, ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %i6.0100) #17
  %call15 = call noalias ptr @strdup(ptr noundef nonnull %buf) #17
  %14 = load i64, ptr %_M_num_elements.i.i40, align 8, !tbaa !11
  %add.i.i41 = add i64 %14, 1
...
.noexc75:                                         ; preds = %for.body10
  %15 = load ptr, ptr %_M_finish.i.i.i.i.i43, align 8, !tbaa !21
  %16 = load ptr, ptr %_M_buckets.i.i, align 8, !tbaa !9
  %17 = load i8, ptr %call15, align 1, !tbaa !22
  %tobool.not4.i.i.i.i.i.i.i44 = icmp eq i8 %17, 0
...
for.body.i.i.i.i.i.i.i52:                         ; preds = %.noexc75, %for.body.i.i.i.i.i.i.i52
  %18 = phi i8 [ %19, %for.body.i.i.i.i.i.i.i52 ], [ %17, %.noexc75 ]
  %__h.06.i.i.i.i.i.i.i45 = phi i64 [ %add.i.i.i.i.i.i.i49, %for.body.i.i.i.i.i.i.i52 ], [ 0, %.noexc75 ]
  %__s.addr.05.i.i.i.i.i.i.i46 = phi ptr [ %incdec.ptr.i.i.i.i.i.i.i50, %for.body.i.i.i.i.i.i.i52 ], [ %call15, %.noexc75 ]
  %mul.i.i.i.i.i.i.i47 = mul i64 %__h.06.i.i.i.i.i.i.i45, 5
  %conv.i.i.i.i.i.i.i48 = sext i8 %18 to i64
  ...
  %19 = load i8, ptr %incdec.ptr.i.i.i.i.i.i.i50, align 1, !tbaa !22
  %tobool.not.i.i.i.i.i.i.i51 = icmp eq i8 %19, 0
...
_ZNK9__gnu_cxx9hashtableISt4pairIKPKciES3_NS_4hashIS3_EESt10_Select1stIS5_E5eqstrSaIiEE10_M_bkt_numERKS5_.exit.i.i61: ; preds = %for.body.i.i.i.i.i.i.i52, %.noexc75
  %__h.0.lcssa.i.i.i.i.i.i.i53 = phi i64 [ 0, %.noexc75 ], [ %add.i.i.i.i.i.i.i49, %for.body.i.i.i.i.i.i.i52 ]
  %sub.ptr.lhs.cast.i.i.i.i.i54 = ptrtoint ptr %15 to i64
  %sub.ptr.rhs.cast.i.i.i.i.i55 = ptrtoint ptr %16 to i64
  ...
  %add.ptr.i.i.i59 = getelementptr inbounds ptr, ptr %16, i64 %rem.i.i.i.i.i58
  %20 = load ptr, ptr %add.ptr.i.i.i59, align 8, !tbaa !5
  %tobool.not28.i.i60 = icmp eq ptr %20, null
...
for.body.i.i66:                                   ; preds = %_ZNK9__gnu_cxx9hashtableISt4pairIKPKciES3_NS_4hashIS3_EESt10_Select1stIS5_E5eqstrSaIiEE10_M_bkt_numERKS5_.exit.i.i61, %for.inc.i.i68
  %__cur.029.i.i62 = phi ptr [ %22, %for.inc.i.i68 ], [ %20, %_ZNK9__gnu_cxx9hashtableISt4pairIKPKciES3_NS_4hashIS3_EESt10_Select1stIS5_E5eqstrSaIiEE10_M_bkt_numERKS5_.exit.i.i61 ]
  %_M_val.i.i63 = getelementptr inbounds %"struct.__gnu_cxx::_Hashtable_node", ptr %__cur.029.i.i62, i64 0, i32 1
  %21 = load ptr, ptr %_M_val.i.i63, align 8, !tbaa !5
  %call.i.i.i64 = call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %21, ptr noundef nonnull dereferenceable(1) %call15) #19
...
for.inc.i.i68:                                    ; preds = %for.body.i.i66
  %22 = load ptr, ptr %__cur.029.i.i62, align 8, !tbaa !25
...
for.end.i.i72:                                    ; preds = %for.inc.i.i68, %_ZNK9__gnu_cxx9hashtableISt4pairIKPKciES3_NS_4hashIS3_EESt10_Select1stIS5_E5eqstrSaIiEE10_M_bkt_numERKS5_.exit.i.i61
  %call5.i.i.i.i.i77 = invoke noalias noundef nonnull dereferenceable(24) ptr @_Znwm(i64 noundef 24) #20
          to label %call5.i.i.i.i.i.noexc76 unwind label %lpad16

call5.i.i.i.i.i.noexc76:                          ; preds = %for.end.i.i72
  %_M_val.i.i.i69 = getelementptr inbounds %"struct.__gnu_cxx::_Hashtable_node", ptr %call5.i.i.i.i.i77, i64 0, i32 1
  store ptr %call15, ptr %_M_val.i.i.i69, align 8
  %ref.tmp.sroa.5.0._M_val.i.i.sroa_idx.i70 = getelementptr inbounds %"struct.__gnu_cxx::_Hashtable_node", ptr %call5.i.i.i.i.i77, i64 0, i32 1, i32 1
  store i32 0, ptr %ref.tmp.sroa.5.0._M_val.i.i.sroa_idx.i70, align 8
  store ptr %20, ptr %call5.i.i.i.i.i77, align 8, !tbaa !25
  store ptr %call5.i.i.i.i.i77, ptr %add.ptr.i.i.i59, align 8, !tbaa !5
  %23 = load i64, ptr %_M_num_elements.i.i40, align 8, !tbaa !11
  %inc.i.i71 = add i64 %23, 1
  store i64 %inc.i.i71, ptr %_M_num_elements.i.i40, align 8, !tbaa !11
  br label %invoke.cont17

invoke.cont17.loopexit:                           ; preds = %for.body.i.i66
  %second.i74.phi.trans.insert = getelementptr inbounds %"struct.__gnu_cxx::_Hashtable_node", ptr %__cur.029.i.i62, i64 0, i32 1, i32 1
  %.pre = load i32, ptr %second.i74.phi.trans.insert, align 4, !tbaa !30
  br label %invoke.cont17

invoke.cont17:                                    ; preds = %invoke.cont17.loopexit, %call5.i.i.i.i.i.noexc76
  %24 = phi i32 [ 0, %call5.i.i.i.i.i.noexc76 ], [ %.pre, %invoke.cont17.loopexit ]
  %tobool.not = icmp ne i32 %24, 0
  %inc19 = zext i1 %tobool.not to i32
  %spec.select = add nuw nsw i32 %c.099, %inc19
  %dec = add nsw i32 %i6.0100, -1
  %cmp8 = icmp sgt i32 %i6.0100, 1
...
invoke.cont23:                                    ; preds = %for.cond.cleanup9
  ...
  %26 = load ptr, ptr %_M_ctype.i.i, align 8, !tbaa !35
...
_ZSt13__check_facetISt5ctypeIcEERKT_PS3_.exit.i.i: ; preds = %invoke.cont23
  ...
  %27 = load i8, ptr %_M_widen_ok.i.i.i, align 8, !tbaa !43
...
if.then.i4.i.i:                                   ; preds = %_ZSt13__check_facetISt5ctypeIcEERKT_PS3_.exit.i.i
  ...
  %28 = load i8, ptr %arrayidx.i.i.i, align 1, !tbaa !22
  br label %_ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc.exit.i

if.end.i.i.i:                                     ; preds = %_ZSt13__check_facetISt5ctypeIcEERKT_PS3_.exit.i.i
  invoke void @_ZNKSt5ctypeIcE13_M_widen_initEv(ptr noundef nonnull align 8 dereferenceable(570) %26)
          to label %.noexc86 unwind label %lpad22

.noexc86:                                         ; preds = %if.end.i.i.i
  %vtable.i.i.i = load ptr, ptr %26, align 8, !tbaa !33
  %vfn.i.i.i = getelementptr inbounds ptr, ptr %vtable.i.i.i, i64 6
  %29 = load ptr, ptr %vfn.i.i.i, align 8
  %call.i.i.i8487 = invoke noundef signext i8 %29(ptr noundef nonnull align 8 dereferenceable(570) %26, i8 noundef signext 10)
          to label %_ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc.exit.i unwind label %lpad22

_ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc.exit.i: ; preds = %.noexc86, %if.then.i4.i.i
  %retval.0.i.i.i = phi i8 [ %28, %if.then.i4.i.i ], [ %call.i.i.i8487, %.noexc86 ]
  %call1.i88 = invoke noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo3putEc(ptr noundef nonnull align 8 dereferenceable(8) %call24, i8 noundef signext %retval.0.i.i.i)
          to label %call1.i.noexc unwind label %lpad22

call1.i.noexc:                                    ; preds = %_ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc.exit.i
  %call.i.i89 = invoke noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo5flushEv(ptr noundef nonnull align 8 dereferenceable(8) %call1.i88)
...
invoke.cont25:                                    ; preds = %call1.i.noexc
  ...
  %30 = load i64, ptr %_M_num_elements.i.i.i, align 8, !tbaa !11
  %cmp.i.i.i81 = icmp eq i64 %30, 0
  br i1 %cmp.i.i.i81, label %entry.invoke.cont_crit_edge.i.i, label %for.cond.preheader.i.i.i
...
for.cond.preheader.i.i.i:                         ; preds = %invoke.cont25
  ...
  %31 = load ptr, ptr %_M_finish.i.i.i.i, align 8, !tbaa !21
  %32 = load ptr, ptr %_M_buckets.i.i, align 8, !tbaa !9
  %cmp221.not.i.i.i = icmp eq ptr %31, %32
...
for.cond.cleanup.i.i.i:                           ; preds = %while.end.i.i.i, %for.cond.preheader.i.i.i
  %33 = phi ptr [ %31, %for.cond.preheader.i.i.i ], [ %39, %while.end.i.i.i ]
  store i64 0, ptr %_M_num_elements.i.i.i, align 8, !tbaa !11
  br label %invoke.cont.i.i

for.body.i.i.i:                                   ; preds = %for.cond.preheader.i.i.i, %while.end.i.i.i
  %34 = phi ptr [ %39, %while.end.i.i.i ], [ %32, %for.cond.preheader.i.i.i ]
  %__i.022.i.i.i = phi i64 [ %inc.i.i.i, %while.end.i.i.i ], [ 0, %for.cond.preheader.i.i.i ]
  %add.ptr.i.i.i.i = getelementptr inbounds ptr, ptr %34, i64 %__i.022.i.i.i
  %35 = load ptr, ptr %add.ptr.i.i.i.i, align 8, !tbaa !5
  %cmp5.not15.i.i.i = icmp eq ptr %35, null
...
while.body.i.i.i:                                 ; preds = %for.body.i.i.i, %while.body.i.i.i
  %__cur.016.i.i.i = phi ptr [ %36, %while.body.i.i.i ], [ %35, %for.body.i.i.i ]
  %36 = load ptr, ptr %__cur.016.i.i.i, align 8, !tbaa !25
  call void @_ZdlPv(ptr noundef nonnull %__cur.016.i.i.i) #18
  %cmp5.not.i.i.i = icmp eq ptr %36, null
...
while.end.i.i.i:                                  ; preds = %while.end.loopexit.i.i.i, %for.body.i.i.i
  %37 = phi ptr [ %.pre.i.i.i, %while.end.loopexit.i.i.i ], [ %34, %for.body.i.i.i ]
  %add.ptr.i14.i.i.i = getelementptr inbounds ptr, ptr %37, i64 %__i.022.i.i.i
  store ptr null, ptr %add.ptr.i14.i.i.i, align 8, !tbaa !5
  %inc.i.i.i = add nuw i64 %__i.022.i.i.i, 1
  %38 = load ptr, ptr %_M_finish.i.i.i.i, align 8, !tbaa !21
  %39 = load ptr, ptr %_M_buckets.i.i, align 8, !tbaa !9
...
invoke.cont.i.i:                                  ; preds = %for.cond.cleanup.i.i.i, %entry.invoke.cont_crit_edge.i.i
  %40 = phi ptr [ %.pre.i.i, %entry.invoke.cont_crit_edge.i.i ], [ %33, %for.cond.cleanup.i.i.i ]
  %tobool.not.i.i.i.i.i82 = icmp eq ptr %40, null
  br i1 %tobool.not.i.i.i.i.i82, label %_ZN9__gnu_cxx8hash_mapIPKciNS_4hashIS2_EE5eqstrSaIiEED2Ev.exit, label %if.then.i.i.i.i.i83

if.then.i.i.i.i.i83:                              ; preds = %invoke.cont.i.i
  call void @_ZdlPv(ptr noundef nonnull %40) #18
  br label %_ZN9__gnu_cxx8hash_mapIPKciNS_4hashIS2_EE5eqstrSaIiEED2Ev.exit

_ZN9__gnu_cxx8hash_mapIPKciNS_4hashIS2_EE5eqstrSaIiEED2Ev.exit: ; preds = %invoke.cont.i.i, %if.then.i.i.i.i.i83
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %X) #17
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %buf) #17
  ret i32 0

lpad22:                                           ; preds = %call1.i.noexc, %_ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc.exit.i, %.noexc86, %if.end.i.i.i, %if.then.i.i.i, %for.cond.cleanup9
  %41 = landingpad { ptr, i32 }
          cleanup
  br label %ehcleanup27

ehcleanup27:                                      ; preds = %lpad16, %lpad22, %lpad
  %.pn91 = phi { ptr, i32 } [ %13, %lpad ], [ %25, %lpad16 ], [ %41, %lpad22 ]
...
vector.body241:                                   ; preds = %vector.body241, %vector.ph235
  ...
  br i1 %10, label %middle.block232, label %vector.body241, !llvm.loop !51
...
vector.body223:                                   ; preds = %vector.body223, %vector.ph217
  ...
  br i1 %29, label %middle.block214, label %vector.body223, !llvm.loop !57
...
vector.body259:                                   ; preds = %vector.body259, %vector.ph253
  ...
  br i1 %38, label %middle.block250, label %vector.body259, !llvm.loop !59
...
for.cond.cleanup.thread:                          ; preds = %while.end
  ...
  store ptr %call5.i.i.i.i4.i.i70, ptr %_M_buckets, align 8, !tbaa !9
  store ptr %add.ptr.i.i.i, ptr %_M_finish.i, align 8, !tbaa !21
  store ptr %add.ptr.i.i.i, ptr %_M_end_of_storage.i.i.i72118, align 8, !tbaa !50
