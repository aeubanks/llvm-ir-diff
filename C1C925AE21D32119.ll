...
define dso_local i32 @f(i16 noundef zeroext %0) local_unnamed_addr #0 {
  %2 = icmp eq i16 %0, -1
  %3 = zext i16 %0 to i32
...
define dso_local i32 @main() local_unnamed_addr #1 {
  %1 = tail call i32 @f(i16 noundef zeroext 1), !range !5
  %2 = icmp eq i32 %1, 1
...
4:                                                ; preds = %0
  %5 = tail call i32 @f(i16 noundef zeroext -1), !range !5
  %6 = icmp eq i32 %5, -1
