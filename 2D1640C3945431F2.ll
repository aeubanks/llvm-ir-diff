...
for.body.i.i.i:                                   ; preds = %for.body.i.i.i.1, %entry
  ...
  br i1 %exitcond.not.i.i.i, label %if.then4.i, label %for.body.i.i.i.1, !llvm.loop !52
...
if.then4.i:                                       ; preds = %for.body.i.i.i
...
for.body:                                         ; preds = %if.then4.i, %invoke.cont21
  %i.048 = phi i64 [ 0, %if.then4.i ], [ %inc, %invoke.cont21 ]
...
for.body:                                         ; preds = %if.then4.i, %invoke.cont21
  %i.054 = phi i64 [ 0, %if.then4.i ], [ %inc, %invoke.cont21 ]
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %a) #12
