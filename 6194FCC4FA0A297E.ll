...
while.end:                                        ; preds = %if.end31, %if.end13
  %39 = phi ptr [ %StIndex.addr.0.val151, %if.end13 ], [ %StIndex.addr.0.val, %if.end31 ]
...
if.end49:                                         ; preds = %if.then47, %if.then44
  ...
  %call50 = call ptr @subst_ComGen(ptr noundef %Context, ptr noundef %44, ptr noundef nonnull %SubstOld, ptr noundef nonnull %SubstNew) #9
  %45 = load ptr, ptr %SubstOld, align 8
  %46 = load ptr, ptr %SubstNew, align 8
  %call51 = call ptr @subst_CloseOpenVariables(ptr noundef %46) #9
  ...
  call void @subst_Delete(ptr noundef %51) #9
