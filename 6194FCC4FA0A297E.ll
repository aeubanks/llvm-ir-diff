...
for.body.preheader:                               ; preds = %if.else6
  ...
  %.pre140 = load i32, ptr @cont_STACKPOINTER, align 4
  br label %for.body

for.body:                                         ; preds = %for.body.preheader, %cleanup
  %2 = phi i32 [ %39, %cleanup ], [ %.pre140, %for.body.preheader ]
...
if.then16:                                        ; preds = %if.then13
  ...
  %.pre141 = load ptr, ptr %subnodes, align 8
  br i1 %tobool19.not, label %if.end26, label %if.then20

if.then20:                                        ; preds = %if.then16
  %.val107 = load ptr, ptr %.pre141, align 8
  %cmp.i110 = icmp eq ptr %.val107, null
  br i1 %cmp.i110, label %if.then25, label %if.end26

if.then25:                                        ; preds = %if.then20
  %7 = getelementptr i8, ptr %.pre141, i64 8
  %.val.i = load ptr, ptr %7, align 8
  %8 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i.i127 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %8, i64 0, i32 4
  %9 = load i32, ptr %total_size.i.i.i.i127, align 8
  %conv26.i.i.i.i128 = sext i32 %9 to i64
  %10 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i.i129 = add i64 %10, %conv26.i.i.i.i128
  store i64 %add27.i.i.i.i129, ptr @memory_FREEDBYTES, align 8
  %11 = load ptr, ptr %8, align 8
  store ptr %11, ptr %.pre141, align 8
  %12 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %.pre141, ptr %12, align 8
...
if.end26:                                         ; preds = %if.then16, %if.then20
  %19 = getelementptr i8, ptr %.pre141, i64 8
  ...
  %Subnodes.1131 = load ptr, ptr %.pre141, align 8
  %cmp.i112.not132 = icmp eq ptr %Subnodes.1131, null
  br i1 %cmp.i112.not132, label %return, label %for.body36

for.body36:                                       ; preds = %if.end26, %for.inc
  %StIndex.val101138 = phi i16 [ %StIndex.val101137, %for.inc ], [ %call28.val103, %if.end26 ]
  %StIndex.val135 = phi i16 [ %StIndex.val134, %for.inc ], [ %call28.val, %if.end26 ]
  %Subnodes.1133 = phi ptr [ %Subnodes.1, %for.inc ], [ %Subnodes.1131, %if.end26 ]
  %22 = getelementptr i8, ptr %Subnodes.1133, i64 8
  %Subnodes.1.val = load ptr, ptr %22, align 8
  %23 = getelementptr i8, ptr %Subnodes.1.val, i64 24
  %call37.val99 = load i16, ptr %23, align 8
  %cmp = icmp ugt i16 %call37.val99, %StIndex.val135
...
if.end44:                                         ; preds = %if.then42, %for.body36
  %StIndex.val134 = phi i16 [ %call37.val99, %if.then42 ], [ %StIndex.val135, %for.body36 ]
  %24 = getelementptr i8, ptr %Subnodes.1.val, i64 26
  %call37.val102 = load i16, ptr %24, align 2
  %cmp49 = icmp ult i16 %call37.val102, %StIndex.val101138
...
for.inc:                                          ; preds = %if.end44, %if.then51
  %StIndex.val101137 = phi i16 [ %StIndex.val101138, %if.end44 ], [ %call37.val102, %if.then51 ]
  %Subnodes.1 = load ptr, ptr %Subnodes.1133, align 8
