...
cleanup:                                          ; preds = %lor.lhs.false9, %if.then12
...
if.then.i17:                                      ; preds = %if.end
  store i8 99, ptr %buff, align 1, !tbaa !9
  br label %if.end.i
...
if.then3.i:                                       ; preds = %if.end.i
  ...
  %idxprom5.i = zext i32 %i.0.i to i64
  %arrayidx6.i = getelementptr inbounds i8, ptr %buff, i64 %idxprom5.i
  store i8 114, ptr %arrayidx6.i, align 1, !tbaa !9
  br label %if.end7.i
...
if.end20:                                         ; preds = %if.then, %if.then12
...
if.then29:                                        ; preds = %if.end26
  ...
  %0 = load ptr, ptr %source, align 8, !tbaa !10
  ...
  %1 = load i32, ptr %linedefined, align 8, !tbaa !13
  ...
  %2 = load i32, ptr %lastlinedefined, align 4, !tbaa !14
  ...
  %3 = load ptr, ptr %what, align 8, !tbaa !15
...
if.then33:                                        ; preds = %if.end30
  ...
  %4 = load i32, ptr %currentline, align 8, !tbaa !16
...
if.then37:                                        ; preds = %if.end34
  ...
  %5 = load i32, ptr %nups, align 4, !tbaa !17
...
if.then41:                                        ; preds = %if.end38
  ...
  %7 = load ptr, ptr %namewhat, align 8, !tbaa !19
...
if.then45:                                        ; preds = %if.end42
  ...
  br i1 %cmp.i91, label %if.then.i92, label %if.else.i93
...
if.else.i93:                                      ; preds = %if.then45
  call void @lua_xmove(ptr noundef %retval.0.i, ptr noundef %L, i32 noundef 1) #8
  br label %treatstackoption.exit

treatstackoption.exit:                            ; preds = %if.then.i92, %if.else.i93
...
if.then49:                                        ; preds = %if.end46
  ...
  br i1 %cmp.i94, label %if.then.i95, label %if.else.i96

if.then.i95:                                      ; preds = %if.then49
  call void @lua_pushvalue(ptr noundef %L, i32 noundef -2) #8
  call void @lua_remove(ptr noundef %L, i32 noundef -3) #8
  br label %treatstackoption.exit97

if.else.i96:                                      ; preds = %if.then49
  call void @lua_xmove(ptr noundef %retval.0.i, ptr noundef %L, i32 noundef 1) #8
  br label %treatstackoption.exit97

treatstackoption.exit97:                          ; preds = %if.then.i95, %if.else.i96
  call void @lua_setfield(ptr noundef %L, i32 noundef -2, ptr noundef nonnull @.str.38) #8
  br label %cleanup

cleanup:                                          ; preds = %if.end46, %treatstackoption.exit97, %if.then23, %if.else16, %if.then8
...
if.end35:                                         ; preds = %while.body
  ...
  %0 = load i32, ptr %currentline, align 8, !tbaa !16
...
if.end43:                                         ; preds = %if.then40, %if.end35
  %1 = load ptr, ptr %namewhat, align 8, !tbaa !19
...
if.else49:                                        ; preds = %if.end43
  %4 = load ptr, ptr %what, align 8, !tbaa !15
...
if.else65:                                        ; preds = %if.else49
  %6 = load i32, ptr %linedefined, align 8, !tbaa !13
...
if.end71:                                         ; preds = %if.then53, %if.else65, %if.then64, %if.then47
...
cleanup:                                          ; preds = %if.else9, %while.end73
  call void @llvm.lifetime.end.p0(i64 120, ptr nonnull %ar) #8
  ret i32 1
}
...
if.then:                                          ; preds = %entry
  ...
  %currentline = getelementptr inbounds %struct.lua_Debug, ptr %ar, i64 0, i32 5
  %1 = load i32, ptr %currentline, align 8, !tbaa !16
