...
land.rhs47.preheader:                             ; preds = %for.cond44.preheader
  ...
  %cmp49158 = icmp eq i8 %4, 45
  br i1 %cmp49158, label %for.body51.preheader, label %for.end68
...
land.rhs47:                                       ; preds = %for.inc66
  %incdec.ptr67 = getelementptr inbounds ptr, ptr %argv.addr.1130160, i64 1
...
for.body51:                                       ; preds = %for.body51.preheader, %land.rhs47
  ...
  %argv.addr.1130160 = phi ptr [ %incdec.ptr67, %land.rhs47 ], [ %incdec.ptr, %for.body51.preheader ]
  %dec45132159 = phi i32 [ %dec45, %land.rhs47 ], [ %dec133, %for.body51.preheader ]
  store i32 0, ptr %options, align 8, !tbaa !20
...
sw.default62:                                     ; preds = %for.body51
  ...
  %arrayidx63 = getelementptr inbounds ptr, ptr %argv.addr.1130160, i64 1
...
for.inc66:                                        ; preds = %sw.bb56, %sw.bb59, %sw.default62
  %dec45 = add nsw i32 %dec45132159, -1
...
for.end68:                                        ; preds = %land.rhs47, %land.rhs47.preheader
  %argc.addr.1131.lcssa = phi i32 [ %argc, %land.rhs47.preheader ], [ %dec45132159, %land.rhs47 ]
  %argv.addr.1130.lcssa = phi ptr [ %incdec.ptr, %land.rhs47.preheader ], [ %incdec.ptr67, %land.rhs47 ]
  %.lcssa154 = phi ptr [ %3, %land.rhs47.preheader ], [ %18, %land.rhs47 ]
...
sw.bb78:                                          ; preds = %sw.bb69.sw.bb78_crit_edge, %for.end68
  %28 = phi ptr [ %.pre, %sw.bb69.sw.bb78_crit_edge ], [ %.lcssa154, %for.end68 ]
...
for.body46:                                       ; preds = %for.body46.lr.ph, %for.cond43.loopexit
  %indvars.iv1528 = phi i64 [ 0, %for.body46.lr.ph ], [ %indvars.iv.next1529, %for.cond43.loopexit ]
  ...
  %arrayidx51 = getelementptr inbounds ptr, ptr %19, i64 %indvars.iv1528
...
for.end109:                                       ; preds = %for.cond43.loopexit, %for.end
  ...
  %conv125 = add i16 %50, %conv5.i1201
  store i16 %conv125, ptr %imports_count, align 8, !tbaa !30
  %conv127 = zext i16 %conv125 to i64
...
for.cond243:                                      ; preds = %for.body246
  ...
  %cmp244 = icmp sgt i64 %indvars.iv1534, 0
  br i1 %cmp244, label %for.body246, label %cleanup, !llvm.loop !64

for.body246:                                      ; preds = %for.body246.lr.ph, %for.cond243
  %indvars.iv1534 = phi i64 [ %73, %for.body246.lr.ph ], [ %indvars.iv.next1535, %for.cond243 ]
  %arrayidx249 = getelementptr inbounds ptr, ptr %72, i64 %indvars.iv1534
...
land.lhs.true299:                                 ; preds = %if.end296
  ...
  %narrow1524 = select i1 %tobool303.not, i32 %add305, i32 0
  %spec.select.idx = sext i32 %narrow1524 to i64
...
for.cond349:                                      ; preds = %for.body351
  %indvars.iv.next1532 = add nsw i64 %indvars.iv1531, -1
  %cmp350 = icmp sgt i64 %indvars.iv1531, 0
  br i1 %cmp350, label %for.body351, label %if.end363, !llvm.loop !70

for.body351:                                      ; preds = %for.body351.lr.ph, %for.cond349
  %indvars.iv1531 = phi i64 [ %87, %for.body351.lr.ph ], [ %indvars.iv.next1532, %for.cond349 ]
  %arrayidx354 = getelementptr inbounds ptr, ptr %86, i64 %indvars.iv1531
...
for.body381:                                      ; preds = %for.body381.lr.ph, %for.cond378.loopexit
  %indvars.iv1551 = phi i64 [ 0, %for.body381.lr.ph ], [ %indvars.iv.next1552, %for.cond378.loopexit ]
  ...
  %arrayidx388 = getelementptr inbounds ptr, ptr %91, i64 %indvars.iv1551
...
land.lhs.true450:                                 ; preds = %if.end447
  ...
  %narrow1523 = select i1 %tobool454.not, i32 %add456, i32 0
  %spec.select1520.idx = sext i32 %narrow1523 to i64
...
for.cond501:                                      ; preds = %for.body503
  ...
  %cmp502 = icmp sgt i64 %indvars.iv1537, 0
  br i1 %cmp502, label %for.body503, label %if.end519, !llvm.loop !81

for.body503:                                      ; preds = %for.body503.lr.ph, %for.cond501
  %indvars.iv1537 = phi i64 [ %112, %for.body503.lr.ph ], [ %indvars.iv.next1538, %for.cond501 ]
  %arrayidx506 = getelementptr inbounds ptr, ptr %111, i64 %indvars.iv1537
...
if.then544:                                       ; preds = %for.body530
  ...
  %or.i1286 = zext i32 %or11.i1285 to i64
  store i32 %or11.i1285, ptr %code_length, align 4, !tbaa !88
  %call558 = tail call noalias noundef nonnull ptr @_Znam(i64 noundef %or.i1286) #17
  ...
  %call569 = tail call i64 @fread(ptr noundef nonnull %call558, i64 noundef %or.i1286, i64 noundef 1, ptr noundef %134)
...
for.body587:                                      ; preds = %if.then544, %for.body587
  ...
  %indvars.iv1540 = phi i64 [ %indvars.iv.next1541, %for.body587 ], [ 0, %if.then544 ]
  %m581.01494 = phi i16 [ %dec584, %for.body587 ], [ %conv5.i1292, %if.then544 ]
  %dec584 = add i16 %m581.01494, -1
  %arrayidx590 = getelementptr inbounds %struct.Block, ptr %138, i64 %indvars.iv1540
  ...
  %start_pc = getelementptr inbounds %struct.Block, ptr %140, i64 %indvars.iv1540, i32 1
  ...
  %end_pc = getelementptr inbounds %struct.Block, ptr %142, i64 %indvars.iv1540, i32 2
  ...
  %145 = getelementptr inbounds %struct.Block, ptr %144, i64 %indvars.iv1540, i32 3
  ...
  %catch_type = getelementptr inbounds %struct.Block, ptr %147, i64 %indvars.iv1540, i32 4
...
if.then663:                                       ; preds = %if.else660
  ...
  %add676 = add nsw i32 %165, %narrow1412
  ...
  %mul686 = shl nuw nsw i64 %conv685, 4
  %call688 = tail call noalias noundef nonnull ptr @_Znam(i64 noundef %mul686) #17
  store ptr %call688, ptr %local_names, align 8, !tbaa !101
  %tobool696.not1498 = icmp eq i16 %167, 0
  br i1 %tobool696.not1498, label %for.end724, label %for.body697.preheader

for.body697.preheader:                            ; preds = %if.then663
  %168 = zext i16 %167 to i64
  br label %for.body697

for.body697:                                      ; preds = %for.body697.preheader, %for.body697
  %indvars.iv1543 = phi i64 [ %168, %for.body697.preheader ], [ %indvars.iv.next1544, %for.body697 ]
  %indvars.iv.next1544 = add nsw i64 %indvars.iv1543, -1
  %169 = load ptr, ptr %local_variable_table, align 8, !tbaa !100
  %name_index = getelementptr inbounds %struct.LocalVariableTableEntry, ptr %169, i64 %indvars.iv.next1544, i32 2
  ...
  %slot = getelementptr inbounds %struct.LocalVariableTableEntry, ptr %169, i64 %indvars.iv.next1544, i32 4
  ...
  %slot720 = getelementptr inbounds %struct.LocalVariableTableEntry, ptr %177, i64 %indvars.iv.next1544, i32 4
  ...
  %180 = icmp eq i64 %indvars.iv.next1544, 0
  br i1 %180, label %for.end724.loopexit, label %for.body697, !llvm.loop !105

for.end724.loopexit:                              ; preds = %for.body697
  %.pre1554 = load i16, ptr %local_variable_table_length, align 8, !tbaa !84
  br label %for.end724

for.end724:                                       ; preds = %for.end724.loopexit, %if.then663
  %181 = phi i16 [ %.pre1554, %for.end724.loopexit ], [ 0, %if.then663 ]
  %conv726 = zext i16 %181 to i64
  %mul727 = shl nuw nsw i64 %conv726, 4
  %call729 = tail call noalias noundef nonnull ptr @_Znam(i64 noundef %mul727) #17
  store ptr %call729, ptr %local_sigs, align 8, !tbaa !106
  %tobool737.not1501 = icmp eq i16 %181, 0
  br i1 %tobool737.not1501, label %if.end783, label %for.body738.preheader

for.body738.preheader:                            ; preds = %for.end724
  %182 = zext i16 %181 to i64
  br label %for.body738

for.body738:                                      ; preds = %for.body738.preheader, %for.body738
  %indvars.iv1547 = phi i64 [ %182, %for.body738.preheader ], [ %indvars.iv.next1548, %for.body738 ]
  %indvars.iv.next1548 = add nsw i64 %indvars.iv1547, -1
  %183 = load ptr, ptr %local_variable_table, align 8, !tbaa !100
  %signature_index744 = getelementptr inbounds %struct.LocalVariableTableEntry, ptr %183, i64 %indvars.iv.next1548, i32 3
  ...
  %slot753 = getelementptr inbounds %struct.LocalVariableTableEntry, ptr %183, i64 %indvars.iv.next1548, i32 4
  ...
  %slot763 = getelementptr inbounds %struct.LocalVariableTableEntry, ptr %191, i64 %indvars.iv.next1548, i32 4
  ...
  %194 = icmp eq i64 %indvars.iv.next1548, 0
