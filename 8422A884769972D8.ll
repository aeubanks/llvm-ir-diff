...
if.then143:                                       ; preds = %while.body139
  ...
  br i1 %cmp.i653, label %if.end199, label %cond.true.i
...
cond.true.i:                                      ; preds = %if.then143
  ...
  br i1 %cmp149, label %if.then150, label %cond.true.i665
...
_ZN8looplist3popEv.exit:                          ; preds = %for.cond.cleanup157, %if.then.i
  ...
  br i1 %cmp.i662, label %if.end199, label %cond.true.i665
...
cond.true.i665:                                   ; preds = %cond.true.i, %_ZN8looplist3popEv.exit
  %85 = phi ptr [ %call.i657, %_ZN8looplist3popEv.exit ], [ %73, %cond.true.i ]
  %86 = phi ptr [ %spec.select818, %_ZN8looplist3popEv.exit ], [ %72, %cond.true.i ]
  %.pr759812 = phi ptr [ %82, %_ZN8looplist3popEv.exit ], [ %75, %cond.true.i ]
  %87 = phi ptr [ %spec.select, %_ZN8looplist3popEv.exit ], [ %71, %cond.true.i ]
  %88 = phi ptr [ %call.i657, %_ZN8looplist3popEv.exit ], [ %67, %cond.true.i ]
...
land.lhs.true:                                    ; preds = %cond.true.i665
...
if.end199:                                        ; preds = %cond.true.i665, %land.lhs.true, %if.then143, %_ZN8looplist3popEv.exit
  %102 = phi ptr [ %88, %cond.true.i665 ], [ %88, %land.lhs.true ], [ %67, %if.then143 ], [ %call.i657, %_ZN8looplist3popEv.exit ]
  %103 = phi ptr [ %87, %cond.true.i665 ], [ %87, %land.lhs.true ], [ %71, %if.then143 ], [ %spec.select, %_ZN8looplist3popEv.exit ]
  %104 = phi ptr [ %86, %cond.true.i665 ], [ %86, %land.lhs.true ], [ %72, %if.then143 ], [ %spec.select818, %_ZN8looplist3popEv.exit ]
  %105 = phi ptr [ %85, %cond.true.i665 ], [ %85, %land.lhs.true ], [ %73, %if.then143 ], [ %call.i657, %_ZN8looplist3popEv.exit ]
  %cmp.i679 = icmp eq ptr %70, null
  br i1 %cmp.i679, label %if.end221, label %cond.true.i682

cond.true.i682:                                   ; preds = %if.end199
...
if.then206:                                       ; preds = %cond.true.i682
...
if.end221:                                        ; preds = %for.body216, %if.then206, %cond.true.i682, %if.end199
  %114 = phi ptr [ %108, %if.then206 ], [ %66, %cond.true.i682 ], [ %66, %if.end199 ], [ %108, %for.body216 ]
  %115 = phi ptr [ %108, %if.then206 ], [ %69, %cond.true.i682 ], [ %69, %if.end199 ], [ %108, %for.body216 ]
  %116 = phi ptr [ %108, %if.then206 ], [ %70, %cond.true.i682 ], [ null, %if.end199 ], [ %108, %for.body216 ]
...
if.then229:                                       ; preds = %lor.lhs.false225, %if.end221
  ...
  br i1 %cmp.i688, label %if.end299, label %cond.true.i691

cond.true.i691:                                   ; preds = %if.then229
...
if.then238:                                       ; preds = %cond.true.i691
...
if.end277:                                        ; preds = %cond.true.i691
...
if.end299:                                        ; preds = %while.cond.i, %if.then229
  ...
  br i1 %cmp.i703, label %if.end327, label %cond.true.i706

cond.true.i706:                                   ; preds = %if.end299
...
cond.true305:                                     ; preds = %cond.true.i706
...
cond.end308:                                      ; preds = %cond.true.i706, %cond.true305
  %cond309 = phi i32 [ %145, %cond.true305 ], [ 0, %cond.true.i706 ]
...
land.lhs.true341:                                 ; preds = %if.else337
  ...
  br i1 %cmp.i725, label %if.else389, label %cond.true.i728

cond.true.i728:                                   ; preds = %land.lhs.true341
...
cond.true347:                                     ; preds = %cond.true.i728
...
cond.end350:                                      ; preds = %cond.true.i728, %cond.true347
  %cond351 = phi i32 [ %162, %cond.true347 ], [ 0, %cond.true.i728 ]
...
if.else389:                                       ; preds = %cond.end350, %land.lhs.true341, %if.else337
  ...
  br i1 %cmp.i736, label %if.end413, label %cond.true.i739

cond.true.i739:                                   ; preds = %if.else389
...
if.then396:                                       ; preds = %cond.true.i739
...
if.end413:                                        ; preds = %for.body406, %if.then396, %cond.true.i739, %if.else389, %if.end327, %land.lhs.true331, %if.then334
  %184 = phi ptr [ %178, %if.then396 ], [ %65, %cond.true.i739 ], [ %65, %if.else389 ], [ %65, %if.end327 ], [ %65, %land.lhs.true331 ], [ %65, %if.then334 ], [ %178, %for.body406 ]
  %185 = phi ptr [ %114, %if.then396 ], [ %114, %cond.true.i739 ], [ %114, %if.else389 ], [ %114, %if.end327 ], [ %114, %land.lhs.true331 ], [ %call.i719, %if.then334 ], [ %114, %for.body406 ]
  %186 = phi ptr [ %178, %if.then396 ], [ %68, %cond.true.i739 ], [ null, %if.else389 ], [ %68, %if.end327 ], [ %68, %land.lhs.true331 ], [ %68, %if.then334 ], [ %178, %for.body406 ]
  %187 = phi ptr [ %115, %if.then396 ], [ %115, %cond.true.i739 ], [ %115, %if.else389 ], [ %114, %if.end327 ], [ %114, %land.lhs.true331 ], [ %call.i719, %if.then334 ], [ %115, %for.body406 ]
  %188 = phi ptr [ %175, %if.then396 ], [ %175, %cond.true.i739 ], [ %175, %if.else389 ], [ %114, %if.end327 ], [ %114, %land.lhs.true331 ], [ %call.i719, %if.then334 ], [ %175, %for.body406 ]
  %189 = phi ptr [ %105, %if.then396 ], [ %105, %cond.true.i739 ], [ %105, %if.else389 ], [ %102, %if.end327 ], [ %102, %land.lhs.true331 ], [ %102, %if.then334 ], [ %105, %for.body406 ]
