...
define dso_local i32 @main() local_unnamed_addr #0 {
  ...
  %6 = fneg double %5
  store double %6, ptr @A3, align 8, !tbaa !5
  %7 = load double, ptr @A5, align 8, !tbaa !5
  %8 = fneg double %7
  store double %8, ptr @A5, align 8, !tbaa !5
  %9 = load double, ptr @piref, align 8, !tbaa !5
  %10 = load double, ptr @three, align 8, !tbaa !5
  %11 = fmul double %10, 1.562500e+08
  %12 = fdiv double %9, %11
  %13 = load double, ptr @B6, align 8, !tbaa !5
  %14 = load double, ptr @B5, align 8, !tbaa !5
  %15 = load double, ptr @B4, align 8, !tbaa !5
  %16 = load double, ptr @B3, align 8, !tbaa !5
  %17 = load double, ptr @B2, align 8, !tbaa !5
  %18 = load double, ptr @B1, align 8, !tbaa !5
  %19 = load double, ptr @one, align 8, !tbaa !5
  br label %20
