...
entry:
  store i32 1, ptr @w, align 16, !tbaa !5
  store i32 1, ptr getelementptr inbounds ([2 x [2 x i32]], ptr @w, i64 0, i64 1, i64 1), align 4, !tbaa !5
  %0 = load i32, ptr getelementptr inbounds ([2 x [2 x i32]], ptr @w, i64 0, i64 1), align 8
  %cmp3 = icmp ne i32 %0, 0
  %1 = load i32, ptr getelementptr inbounds ([2 x [2 x i32]], ptr @w, i64 0, i64 0, i64 1), align 4
  %cmp5 = icmp ne i32 %1, 0
  %or.cond7 = select i1 %cmp3, i1 true, i1 %cmp5
