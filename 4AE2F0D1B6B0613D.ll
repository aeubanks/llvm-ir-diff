...
while.cond:                                       ; preds = %while.body.critedge, %if.end
  ...
  br i1 %cmp.not.i.i, label %if.end.i.i, label %while.body.critedge, !prof !31
...
while.body.critedge:                              ; preds = %if.then4.i.i, %while.cond
  ...
  %10 = load ptr, ptr @inputImage, align 8, !tbaa !9
  tail call void @orderedDitherKernel(i32 noundef %conv, i32 noundef %conv, ptr noundef %10, ptr noundef nonnull %call11, ptr noundef %call16, i32 noundef %conv7, i32 noundef %conv4)
  br label %while.cond, !llvm.loop !36

if.then21:                                        ; preds = %if.end12.i.i
...
if.end22:                                         ; preds = %if.then21, %if.end12.i.i
...
if.end12.i.i:                                     ; preds = %if.then4.i.i, %if.end.i.i
  tail call void @_ZN9benchmark5State17FinishKeepRunningEv(ptr noundef nonnull align 8 dereferenceable(144) %state)
  %7 = load ptr, ptr %range_.i, align 8, !tbaa !13
...
while.body.critedge:                              ; preds = %if.then4.i.i, %while.cond
  ...
  tail call void @floydDitherKernel(i32 noundef %conv, i32 noundef %conv, ptr noundef %9, ptr noundef nonnull %call6)
