...
heuristic_mincov:                                 ; preds = %for.body21.us.2, %for.end36, %if.then28
  ...
  br i1 %cmp72.i, label %for.body.preheader.i, label %for.end37.i

for.body.preheader.i:                             ; preds = %heuristic_mincov
  %33 = zext i32 %32 to i64
  %34 = shl nuw nsw i64 %33, 2
  tail call void @llvm.memset.p0.i64(ptr align 4 %call.i, i8 0, i64 %34, i1 false), !tbaa !5
  br label %for.body21.i

for.body21.i:                                     ; preds = %for.inc35.i, %for.body.preheader.i
  %indvars.iv.i = phi i64 [ 0, %for.body.preheader.i ], [ %indvars.iv.next.i, %for.inc35.i ]
  %best_count.078.i = phi i32 [ -1, %for.body.preheader.i ], [ %best_count.1.i, %for.inc35.i ]
  %best_part.077.i = phi i32 [ -1, %for.body.preheader.i ], [ %best_part.1.i, %for.inc35.i ]
...
most_frequent.exit:                               ; preds = %if.end40.i, %if.then43.i
  ...
  br i1 %cmp72.i125, label %for.body.preheader.i126, label %for.end37.i155

for.body.preheader.i126:                          ; preds = %most_frequent.exit
  %40 = zext i32 %39 to i64
  %41 = shl nuw nsw i64 %40, 2
  tail call void @llvm.memset.p0.i64(ptr align 4 %call.i124, i8 0, i64 %41, i1 false), !tbaa !5
  br label %for.body21.i142

for.body21.i142:                                  ; preds = %for.inc35.i152, %for.body.preheader.i126
  %indvars.iv.i131 = phi i64 [ 0, %for.body.preheader.i126 ], [ %indvars.iv.next.i150, %for.inc35.i152 ]
  %best_count.078.i132 = phi i32 [ -1, %for.body.preheader.i126 ], [ %best_count.1.i149, %for.inc35.i152 ]
  %best_part.077.i133 = phi i32 [ -1, %for.body.preheader.i126 ], [ %best_part.1.i148, %for.inc35.i152 ]
