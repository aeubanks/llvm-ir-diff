...
for.body:                                         ; preds = %entry, %for.body
  ...
  %puts47 = tail call i32 @puts(ptr nonnull dereferenceable(1) @str.7)
...
if.end.i:                                         ; preds = %for.body8
  %shr.i49 = lshr i64 %l.054, 32
  %conv2.i = trunc i64 %shr.i49 to i32
...
nlzll.exit:                                       ; preds = %if.then.i, %if.end.i
  ...
  %add.i52 = add nuw nsw i32 %15, %14
  %16 = tail call i32 @llvm.cttz.i32(i32 %conv, i1 false), !range !8
  %call15 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.4, i64 noundef %l.054, i32 noundef %retval.0.i, i32 noundef %add.i52, i32 noundef %16)
