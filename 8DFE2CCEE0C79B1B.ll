...
if.then243:                                       ; preds = %sw.bb233.peel
  ...
  %sext473 = shl i64 %sub237.le815, 32
  ...
  %cmp56.i = icmp sgt i64 %sext473, 0
...
sw.bb270:                                         ; preds = %if.else252.peel
  ...
  %cmp56.i374 = icmp sgt i64 %sext, 0
  br i1 %cmp56.i374, label %for.body.i380, label %yy_match.backedge

for.body.i380:                                    ; preds = %sw.bb270, %while.end.i420
  %yy_cp.058.i377 = phi ptr [ %incdec.ptr.i418, %while.end.i420 ], [ %105, %sw.bb270 ]
  %yy_current_state.057.i378 = phi i32 [ %conv31.i417, %while.end.i420 ], [ %106, %sw.bb270 ]
  %107 = load i8, ptr %yy_cp.058.i377, align 1, !tbaa !13
...
cond.end.i388:                                    ; preds = %cond.true.i383, %for.body.i380
  ...
  %idxprom3.i385 = sext i32 %yy_current_state.057.i378 to i64
...
if.then.i389:                                     ; preds = %cond.end.i388
  store i32 %yy_current_state.057.i378, ptr @yy_last_accepting_state, align 4, !tbaa !17
  store ptr %yy_cp.058.i377, ptr @yy_last_accepting_cpos, align 8, !tbaa !5
...
if.end.i397:                                      ; preds = %if.then.i389, %cond.end.i388
  ...
  %cmp13.not52.i396 = icmp eq i32 %yy_current_state.057.i378, %conv1251.i395
  br i1 %cmp13.not52.i396, label %while.end.i420, label %while.body.i403

while.body.i403:                                  ; preds = %if.end.i397, %if.end23.i414
  %conv955.i398 = phi i64 [ %conv9.i410, %if.end23.i414 ], [ %conv948.i392, %if.end.i397 ]
  %idxprom654.i399 = phi i64 [ %idxprom6.i407, %if.end23.i414 ], [ %idxprom3.i385, %if.end.i397 ]
  %yy_c.053.i400 = phi i8 [ %yy_c.1.i406, %if.end23.i414 ], [ %cond.i384, %if.end.i397 ]
  %arrayidx16.i401 = getelementptr inbounds [146 x i16], ptr @yy_def, i64 0, i64 %idxprom654.i399
  %112 = load i16, ptr %arrayidx16.i401, align 2, !tbaa !18
  %cmp18.i402 = icmp sgt i16 %112, 143
  br i1 %cmp18.i402, label %if.then20.i405, label %if.end23.i414

if.then20.i405:                                   ; preds = %while.body.i403
  %arrayidx22.i404 = getelementptr inbounds [53 x i8], ptr @yy_meta, i64 0, i64 %conv955.i398
  %113 = load i8, ptr %arrayidx22.i404, align 1, !tbaa !13
  br label %if.end23.i414

if.end23.i414:                                    ; preds = %if.then20.i405, %while.body.i403
  %yy_c.1.i406 = phi i8 [ %113, %if.then20.i405 ], [ %yy_c.053.i400, %while.body.i403 ]
  ...
  br i1 %cmp13.not.i413, label %while.end.i420, label %while.body.i403, !llvm.loop !32
...
while.end.i420:                                   ; preds = %if.end23.i414, %if.end.i397
  ...
  %incdec.ptr.i418 = getelementptr inbounds i8, ptr %yy_cp.058.i377, i64 1
...
sw.bb275:                                         ; preds = %if.else252.peel
  ...
  %cmp56.i424 = icmp ult ptr %121, %arrayidx278
  br i1 %cmp56.i424, label %for.body.preheader.i426, label %yy_find_action.outer.backedge
...
for.body.i430:                                    ; preds = %while.end.i470, %for.body.preheader.i426
  %yy_cp.058.i427 = phi ptr [ %incdec.ptr.i468, %while.end.i470 ], [ %121, %for.body.preheader.i426 ]
  %yy_current_state.057.i428 = phi i32 [ %conv31.i467, %while.end.i470 ], [ %120, %for.body.preheader.i426 ]
  %125 = load i8, ptr %yy_cp.058.i427, align 1, !tbaa !13
...
cond.end.i438:                                    ; preds = %cond.true.i433, %for.body.i430
  ...
  %idxprom3.i435 = sext i32 %yy_current_state.057.i428 to i64
...
if.then.i439:                                     ; preds = %cond.end.i438
  store i32 %yy_current_state.057.i428, ptr @yy_last_accepting_state, align 4, !tbaa !17
  store ptr %yy_cp.058.i427, ptr @yy_last_accepting_cpos, align 8, !tbaa !5
...
if.end.i447:                                      ; preds = %if.then.i439, %cond.end.i438
  ...
  %cmp13.not52.i446 = icmp eq i32 %yy_current_state.057.i428, %conv1251.i445
  br i1 %cmp13.not52.i446, label %while.end.i470, label %while.body.i453

while.body.i453:                                  ; preds = %if.end.i447, %if.end23.i464
  %conv955.i448 = phi i64 [ %conv9.i460, %if.end23.i464 ], [ %conv948.i442, %if.end.i447 ]
  %idxprom654.i449 = phi i64 [ %idxprom6.i457, %if.end23.i464 ], [ %idxprom3.i435, %if.end.i447 ]
  %yy_c.053.i450 = phi i8 [ %yy_c.1.i456, %if.end23.i464 ], [ %cond.i434, %if.end.i447 ]
  %arrayidx16.i451 = getelementptr inbounds [146 x i16], ptr @yy_def, i64 0, i64 %idxprom654.i449
  %130 = load i16, ptr %arrayidx16.i451, align 2, !tbaa !18
  %cmp18.i452 = icmp sgt i16 %130, 143
  br i1 %cmp18.i452, label %if.then20.i455, label %if.end23.i464

if.then20.i455:                                   ; preds = %while.body.i453
  %arrayidx22.i454 = getelementptr inbounds [53 x i8], ptr @yy_meta, i64 0, i64 %conv955.i448
  %131 = load i8, ptr %arrayidx22.i454, align 1, !tbaa !13
  br label %if.end23.i464

if.end23.i464:                                    ; preds = %if.then20.i455, %while.body.i453
  %yy_c.1.i456 = phi i8 [ %131, %if.then20.i455 ], [ %yy_c.053.i450, %while.body.i453 ]
  ...
  br i1 %cmp13.not.i463, label %while.end.i470, label %while.body.i453, !llvm.loop !32
...
while.end.i470:                                   ; preds = %if.end23.i464, %if.end.i447
  ...
  %incdec.ptr.i468 = getelementptr inbounds i8, ptr %yy_cp.058.i427, i64 1
