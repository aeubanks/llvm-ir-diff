...
for.body:                                         ; preds = %for.body.lr.ph, %for.inc599
  %indvars.iv1283 = phi i64 [ 0, %for.body.lr.ph ], [ %indvars.iv.next1284, %for.inc599 ]
  %retval.01253 = phi i32 [ undef, %for.body.lr.ph ], [ %retval.30, %for.inc599 ]
  %numFiles2.01252 = phi i64 [ 0, %for.body.lr.ph ], [ %numFiles2.4, %for.inc599 ]
  %numDirs2.01251 = phi i64 [ 0, %for.body.lr.ph ], [ %numDirs2.4, %for.inc599 ]
  %totalPackSizePointer2.01250 = phi ptr [ null, %for.body.lr.ph ], [ %totalPackSizePointer2.5, %for.inc599 ]
  %totalUnPackSizePointer2.01249 = phi ptr [ null, %for.body.lr.ph ], [ %totalUnPackSizePointer2.5, %for.inc599 ]
  %numArcs.01248 = phi i32 [ %1, %for.body.lr.ph ], [ %numArcs.5, %for.inc599 ]
  %6 = load ptr, ptr %_items.i.i, align 8, !tbaa !25
  %arrayidx.i.i = getelementptr inbounds ptr, ptr %6, i64 %indvars.iv1283
  %7 = load ptr, ptr %arrayidx.i.i, align 8, !tbaa !29
...
if.end93:                                         ; preds = %invoke.cont46
  ...
  %or.cond1311.not = select i1 %stdInMode, i1 true, i1 %cmp1001211
  br i1 %or.cond1311.not, label %if.end123, label %for.body102

for.body102:                                      ; preds = %if.end93, %if.end118
  %indvars.iv = phi i64 [ %indvars.iv.next, %if.end118 ], [ 0, %if.end93 ]
  %numArcs.11213 = phi i32 [ %numArcs.2, %if.end118 ], [ %numArcs.01248, %if.end93 ]
...
invoke.cont107:                                   ; preds = %call.i.i.i.noexc803
  %or.cond1020 = icmp slt i64 %indvars.iv1283, %idxprom.i.i.i
...
if.end123:                                        ; preds = %if.end118, %if.end93
  %numArcs.3 = phi i32 [ %numArcs.01248, %if.end93 ], [ %numArcs.2, %if.end118 ]
...
for.body145:                                      ; preds = %for.cond139.preheader, %for.inc376
  %indvars.iv1279 = phi i64 [ %indvars.iv.next1280, %for.inc376 ], [ 0, %for.cond139.preheader ]
  %retval.11225 = phi i32 [ %retval.16.ph, %for.inc376 ], [ %retval.01253, %for.cond139.preheader ]
  %57 = load ptr, ptr %_items.i.i808, align 8, !tbaa !25
  %arrayidx.i.i810 = getelementptr inbounds ptr, ptr %57, i64 %indvars.iv1279
...
invoke.cont173:                                   ; preds = %if.end167
  ...
  %or.cond1264 = select i1 %cmp175, i1 %cmp178.not1214, i1 false
  br i1 %or.cond1264, label %for.body180, label %if.end254
...
if.end254:                                        ; preds = %for.cond177, %invoke.cont173
  ...
  %cmp258.not = icmp eq i64 %indvars.iv1279, %99
...
if.then269:                                       ; preds = %invoke.cont266
  %101 = add nuw nsw i64 %indvars.iv1279, 1
...
for.inc376:                                       ; preds = %cleanup363.thread, %if.end254
  ...
  %cmp143 = icmp slt i64 %indvars.iv.next1280, %135
...
for.end381:                                       ; preds = %for.inc376, %for.cond139.preheader
  %retval.1.lcssa = phi i32 [ %retval.01253, %for.cond139.preheader ], [ %retval.16.ph, %for.inc376 ]
...
if.then385:                                       ; preds = %invoke.cont382
  %call387 = invoke noundef nonnull align 8 dereferenceable(16) ptr @_ZN13CStdOutStreamlsEPKc(ptr noundef nonnull align 8 dereferenceable(16) @g_StdOut, ptr noundef nonnull @.str.16)
          to label %if.end400.thread1087 unwind label %lpad45.loopexit.split-lp.loopexit.split-lp

if.end400.thread1087:                             ; preds = %if.then385
  %136 = load i32, ptr %_size.i807, align 4, !tbaa !28
  %sub.i1090 = add nsw i32 %136, -1
  %137 = load ptr, ptr %_items.i.i808, align 8, !tbaa !25
  %idxprom.i.i.i9121092 = sext i32 %sub.i1090 to i64
  %arrayidx.i.i.i9131093 = getelementptr inbounds ptr, ptr %137, i64 %idxprom.i.i.i9121092
  %138 = load ptr, ptr %arrayidx.i.i.i9131093, align 8, !tbaa !29
...
if.end400.thread:                                 ; preds = %if.end389
  ...
  %sub.i1050 = add nsw i32 %140, -1
  %141 = load ptr, ptr %_items.i.i808, align 8, !tbaa !25
  %idxprom.i.i.i9121052 = sext i32 %sub.i1050 to i64
  %arrayidx.i.i.i9131053 = getelementptr inbounds ptr, ptr %141, i64 %idxprom.i.i.i9121052
  %142 = load ptr, ptr %arrayidx.i.i.i9131053, align 8, !tbaa !29
...
if.end400:                                        ; preds = %if.end123, %invoke.cont397
  %retval.181047 = phi i32 [ %retval.1.lcssa, %invoke.cont397 ], [ %retval.01253, %if.end123 ]
...
if.then412:                                       ; preds = %if.end400.thread1087, %if.end400
  %156 = phi ptr [ %139, %if.end400.thread1087 ], [ %155, %if.end400 ]
  %157 = phi ptr [ %138, %if.end400.thread1087 ], [ %154, %if.end400 ]
  %retval.1810471094 = phi i32 [ %retval.1.lcssa, %if.end400.thread1087 ], [ %retval.181047, %if.end400 ]
...
if.end424:                                        ; preds = %if.end400.thread, %invoke.cont415, %if.end400
  ...
  %retval.20 = phi i32 [ %retval.1810471094, %invoke.cont415 ], [ %retval.181047, %if.end400 ], [ %retval.1.lcssa, %if.end400.thread ]
...
for.end523:                                       ; preds = %for.inc518, %_ZN11CStringBaseIwED2Ev.exit918, %for.cond439.preheader
  %retval.261065 = phi i32 [ %retval.20, %for.cond439.preheader ], [ %retval.25, %_ZN11CStringBaseIwED2Ev.exit918 ], [ %retval.25, %for.inc518 ]
  %totalUnPackSizePointer.41064 = phi ptr [ null, %for.cond439.preheader ], [ %totalUnPackSizePointer.3, %_ZN11CStringBaseIwED2Ev.exit918 ], [ %totalUnPackSizePointer.3, %for.inc518 ]
  %totalPackSizePointer.41063 = phi ptr [ null, %for.cond439.preheader ], [ %totalPackSizePointer.3, %_ZN11CStringBaseIwED2Ev.exit918 ], [ %totalPackSizePointer.3, %for.inc518 ]
  %numDirs.41062 = phi i64 [ 0, %for.cond439.preheader ], [ %numDirs.3, %_ZN11CStringBaseIwED2Ev.exit918 ], [ %numDirs.3, %for.inc518 ]
  %numFiles.41061 = phi i64 [ 0, %for.cond439.preheader ], [ %numFiles.3, %_ZN11CStringBaseIwED2Ev.exit918 ], [ %numFiles.3, %for.inc518 ]
  %cmp526 = icmp ne ptr %totalPackSizePointer.41063, null
...
if.then527:                                       ; preds = %for.end523
  ...
  %cmp536 = icmp eq i64 %numFiles.41061, 0
...
if.end537:                                        ; preds = %if.then527, %for.end523
  %totalPackSizePointer.5 = phi ptr [ %totalPackSize, %if.then527 ], [ %totalPackSizePointer.41063, %for.end523 ]
  %cmp538 = icmp eq ptr %totalUnPackSizePointer.41064, null
  %cmp540 = icmp eq i64 %numFiles.41061, 0
...
if.end542:                                        ; preds = %if.then541, %if.end537
  %totalUnPackSizePointer.5 = phi ptr [ %totalUnPackSize, %if.then541 ], [ %totalUnPackSizePointer.41064, %if.end537 ]
  br i1 %brmerge, label %if.end554, label %if.then546
...
invoke.cont548:                                   ; preds = %invoke.cont547
  %call551 = invoke noundef i32 @_ZN13CFieldPrinter16PrintSummaryInfoEyyPKyS1_(ptr noundef nonnull align 8 dereferenceable(32) %fieldPrinter, i64 noundef %numFiles.41061, i64 noundef %numDirs.41062, ptr noundef %totalUnPackSizePointer.5, ptr noundef %totalPackSizePointer.5)
...
if.end558:                                        ; preds = %if.then556, %if.end554
  %totalPackSizePointer2.1 = phi ptr [ %totalPackSize2, %if.then556 ], [ %totalPackSizePointer2.01250, %if.end554 ]
...
if.end562:                                        ; preds = %if.then560, %if.end558
  %totalUnPackSizePointer2.1 = phi ptr [ %totalUnPackSize2, %if.then560 ], [ %totalUnPackSizePointer2.01249, %if.end558 ]
  %add563 = add i64 %numFiles.41061, %numFiles2.01252
  %add564 = add i64 %numDirs.41062, %numDirs2.01251
  br label %cleanup565
...
cleanup565:                                       ; preds = %_ZN11CStringBaseIwED2Ev.exit918, %invoke.cont444, %invoke.cont429, %if.end562
  ...
  %totalUnPackSizePointer2.2 = phi ptr [ %totalUnPackSizePointer2.1, %if.end562 ], [ %totalUnPackSizePointer2.01249, %invoke.cont429 ], [ %totalUnPackSizePointer2.01249, %invoke.cont444 ], [ %totalUnPackSizePointer2.01249, %_ZN11CStringBaseIwED2Ev.exit918 ]
  %totalPackSizePointer2.2 = phi ptr [ %totalPackSizePointer2.1, %if.end562 ], [ %totalPackSizePointer2.01250, %invoke.cont429 ], [ %totalPackSizePointer2.01250, %invoke.cont444 ], [ %totalPackSizePointer2.01250, %_ZN11CStringBaseIwED2Ev.exit918 ]
  %numDirs2.1 = phi i64 [ %add564, %if.end562 ], [ %numDirs2.01251, %invoke.cont429 ], [ %numDirs2.01251, %invoke.cont444 ], [ %numDirs2.01251, %_ZN11CStringBaseIwED2Ev.exit918 ]
  %numFiles2.1 = phi i64 [ %add563, %if.end562 ], [ %numFiles2.01252, %invoke.cont429 ], [ %numFiles2.01252, %invoke.cont444 ], [ %numFiles2.01252, %_ZN11CStringBaseIwED2Ev.exit918 ]
  %retval.27 = phi i32 [ %retval.261065, %if.end562 ], [ %call430, %invoke.cont429 ], [ %retval.25, %_ZN11CStringBaseIwED2Ev.exit918 ], [ -2147467260, %invoke.cont444 ]
...
cleanup583:                                       ; preds = %cleanup378, %cleanup565, %invoke.cont415, %invoke.cont46, %invoke.cont90
  ...
  %numArcs.4 = phi i32 [ %numArcs.01248, %invoke.cont90 ], [ %numArcs.3, %cleanup378 ], [ %numArcs.01248, %invoke.cont46 ], [ %numArcs.3, %cleanup565 ], [ %numArcs.3, %invoke.cont415 ]
  %totalUnPackSizePointer2.4 = phi ptr [ %totalUnPackSizePointer2.01249, %invoke.cont90 ], [ %totalUnPackSizePointer2.01249, %cleanup378 ], [ %totalUnPackSizePointer2.01249, %invoke.cont46 ], [ %totalUnPackSizePointer2.2, %cleanup565 ], [ %totalUnPackSizePointer2.01249, %invoke.cont415 ]
  %totalPackSizePointer2.4 = phi ptr [ %totalPackSizePointer2.01250, %invoke.cont90 ], [ %totalPackSizePointer2.01250, %cleanup378 ], [ %totalPackSizePointer2.01250, %invoke.cont46 ], [ %totalPackSizePointer2.2, %cleanup565 ], [ %totalPackSizePointer2.01250, %invoke.cont415 ]
  %numDirs2.3 = phi i64 [ %numDirs2.01251, %invoke.cont90 ], [ %numDirs2.01251, %cleanup378 ], [ %numDirs2.01251, %invoke.cont46 ], [ %numDirs2.1, %cleanup565 ], [ %numDirs2.01251, %invoke.cont415 ]
  %numFiles2.3 = phi i64 [ %numFiles2.01252, %invoke.cont90 ], [ %numFiles2.01252, %cleanup378 ], [ %numFiles2.01252, %invoke.cont46 ], [ %numFiles2.1, %cleanup565 ], [ %numFiles2.01252, %invoke.cont415 ]
  %retval.29 = phi i32 [ %retval.01253, %invoke.cont90 ], [ %retval.16, %cleanup378 ], [ %call47, %invoke.cont46 ], [ %retval.27, %cleanup565 ], [ %call416, %invoke.cont415 ]
  store ptr getelementptr inbounds ({ [9 x ptr] }, ptr @_ZTV20COpenCallbackConsole, i64 0, inrange i32 0, i64 2), ptr %openCallback, align 8, !tbaa !31
...
cleanup593:                                       ; preds = %_ZN8NWindows5NFile5NFind10CFileInfoWD2Ev.exit783, %_ZN20COpenCallbackConsoleD2Ev.exit
  ...
  %numArcs.5 = phi i32 [ %numArcs.4, %_ZN20COpenCallbackConsoleD2Ev.exit ], [ %numArcs.01248, %_ZN8NWindows5NFile5NFind10CFileInfoWD2Ev.exit783 ]
  %totalUnPackSizePointer2.5 = phi ptr [ %totalUnPackSizePointer2.4, %_ZN20COpenCallbackConsoleD2Ev.exit ], [ %totalUnPackSizePointer2.01249, %_ZN8NWindows5NFile5NFind10CFileInfoWD2Ev.exit783 ]
  %totalPackSizePointer2.5 = phi ptr [ %totalPackSizePointer2.4, %_ZN20COpenCallbackConsoleD2Ev.exit ], [ %totalPackSizePointer2.01250, %_ZN8NWindows5NFile5NFind10CFileInfoWD2Ev.exit783 ]
  %numDirs2.4 = phi i64 [ %numDirs2.3, %_ZN20COpenCallbackConsoleD2Ev.exit ], [ %numDirs2.01251, %_ZN8NWindows5NFile5NFind10CFileInfoWD2Ev.exit783 ]
  %numFiles2.4 = phi i64 [ %numFiles2.3, %_ZN20COpenCallbackConsoleD2Ev.exit ], [ %numFiles2.01252, %_ZN8NWindows5NFile5NFind10CFileInfoWD2Ev.exit783 ]
  %retval.30 = phi i32 [ %retval.29, %_ZN20COpenCallbackConsoleD2Ev.exit ], [ %retval.01253, %_ZN8NWindows5NFile5NFind10CFileInfoWD2Ev.exit783 ]
...
for.inc599:                                       ; preds = %cleanup593, %cleanup593
  ...
  %cmp = icmp slt i64 %indvars.iv.next1284, %194
...
ehcleanup566:                                     ; preds = %lpad529.loopexit, %lpad529.loopexit.split-lp.loopexit.split-lp, %lpad529.loopexit.split-lp.loopexit, %lpad443, %ehcleanup517, %lpad428
  %.pn990 = phi { ptr, i32 } [ %163, %lpad428 ], [ %.pn989.pn.pn, %ehcleanup517 ], [ %164, %lpad443 ], [ %lpad.loopexit1098, %lpad529.loopexit ], [ %lpad.loopexit1100, %lpad529.loopexit.split-lp.loopexit ], [ %lpad.loopexit.split-lp1101, %lpad529.loopexit.split-lp.loopexit.split-lp ]
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %numItems) #16
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %totalUnPackSize) #16
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %totalPackSize) #16
  br label %ehcleanup586
...
ehcleanup586:                                     ; preds = %lpad104.loopexit, %lpad104.loopexit.split-lp, %lpad45.loopexit, %lpad45.loopexit.split-lp.loopexit.split-lp, %lpad45.loopexit.split-lp.loopexit, %ehcleanup87, %ehcleanup369, %lpad147, %ehcleanup566, %lpad414, %lpad41
  %.pn1011.pn = phi { ptr, i32 } [ %28, %lpad41 ], [ %.pn1010, %ehcleanup87 ], [ %.pn997.pn.pn.pn.pn.pn, %ehcleanup369 ], [ %66, %lpad147 ], [ %.pn990, %ehcleanup566 ], [ %158, %lpad414 ], [ %lpad.loopexit1103, %lpad45.loopexit ], [ %lpad.loopexit1105, %lpad45.loopexit.split-lp.loopexit ], [ %lpad.loopexit.split-lp1106, %lpad45.loopexit.split-lp.loopexit.split-lp ], [ %lpad.loopexit1108, %lpad104.loopexit ], [ %lpad.loopexit.split-lp, %lpad104.loopexit.split-lp ]
  store ptr getelementptr inbounds ({ [9 x ptr] }, ptr @_ZTV20COpenCallbackConsole, i64 0, inrange i32 0, i64 2), ptr %openCallback, align 8, !tbaa !31
...
ehcleanup628:                                     ; preds = %lpad3.loopexit, %lpad3.loopexit.split-lp.loopexit.split-lp, %lpad3.loopexit.split-lp.loopexit, %ehcleanup, %ehcleanup588
  %.pn1012 = phi { ptr, i32 } [ %.pn1011.pn.pn, %ehcleanup588 ], [ %.pn, %ehcleanup ], [ %lpad.loopexit, %lpad3.loopexit ], [ %lpad.loopexit1095, %lpad3.loopexit.split-lp.loopexit ], [ %lpad.loopexit.split-lp1096, %lpad3.loopexit.split-lp.loopexit.split-lp ]
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %totalUnPackSize2) #16
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %totalPackSize2) #16
  br label %ehcleanup642
