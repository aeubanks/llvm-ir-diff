...
for.body.i229:                                    ; preds = %for.body.lr.ph.i, %for.inc.i247
  ...
  br i1 %cmp1.not.i.i228, label %clause_DependsOnSplitLevel.exit.i234, label %for.inc.i247
...
clause_DependsOnSplitLevel.exit.i234:             ; preds = %for.body.i229
  ...
  br i1 %cmp4.i.not.i233, label %for.inc.i247, label %if.then.i236
...
prfs_GetSplitOfLevel.exit.i:                      ; preds = %land.rhs.i.i
  ...
  br i1 %cmp.not.i, label %if.end.i245, label %if.then8.i

if.then8.i:                                       ; preds = %prfs_GetSplitOfLevel.exit.i
  %cmp.i18.i.i238 = icmp eq ptr %New.i.2, null
  br i1 %cmp.i18.i.i238, label %list_Nconc.exit.i244, label %for.cond.i.i242

for.cond.i.i242:                                  ; preds = %if.then8.i, %for.cond.i.i242
  %List1.addr.0.i.i239 = phi ptr [ %List1.addr.0.val17.i.i240, %for.cond.i.i242 ], [ %call5.val25.i, %if.then8.i ]
...
list_Nconc.exit.i244:                             ; preds = %for.end.i.i243, %if.then8.i
...
for.inc.i247:                                     ; preds = %if.end.i245, %clause_DependsOnSplitLevel.exit.i234, %for.body.i229
  %New.i.4 = phi ptr [ %New.i.2, %clause_DependsOnSplitLevel.exit.i234 ], [ %New.i.3, %if.end.i245 ], [ %New.i.2, %for.body.i229 ]
  %Scan.0.val26.i = load ptr, ptr %Scan.036.i, align 8
  %cmp.i.not.i246 = icmp eq ptr %Scan.0.val26.i, null
  br i1 %cmp.i.not.i246, label %split_DeleteClausesDependingOnLevelFromList.exit, label %for.body.i229, !llvm.loop !8
...
prfs_GetSplitOfLevel.exit.i.i:                    ; preds = %land.rhs.i.i.i
  ...
  br i1 %cmp.not.i.i, label %if.end.i101.i, label %if.then8.i.i

if.then8.i.i:                                     ; preds = %prfs_GetSplitOfLevel.exit.i.i
  %cmp.i18.i.i.i = icmp eq ptr %call5.val25.i220.i, null
  br i1 %cmp.i18.i.i.i, label %list_Nconc.exit.i.i, label %for.cond.i.i.i

for.cond.i.i.i:                                   ; preds = %if.then8.i.i, %for.cond.i.i.i
  %List1.addr.0.i.i.i = phi ptr [ %List1.addr.0.val17.i.i.i, %for.cond.i.i.i ], [ %call5.val25.i.i, %if.then8.i.i ]
...
list_Nconc.exit.i.i:                              ; preds = %for.end.i.i.i, %if.then8.i.i
...
prfs_GetSplitOfLevel.exit.i156.i:                 ; preds = %land.rhs.i.i153.i
  ...
  br i1 %cmp.not.i155.i, label %if.end.i165.i, label %if.then8.i158.i

if.then8.i158.i:                                  ; preds = %prfs_GetSplitOfLevel.exit.i156.i
  %cmp.i18.i.i157.i = icmp eq ptr %Deleted.2.i, null
  br i1 %cmp.i18.i.i157.i, label %list_Nconc.exit.i164.i, label %for.cond.i.i162.i

for.cond.i.i162.i:                                ; preds = %if.then8.i158.i, %for.cond.i.i162.i
  %List1.addr.0.i.i159.i = phi ptr [ %List1.addr.0.val17.i.i160.i, %for.cond.i.i162.i ], [ %call5.val25.i154.i, %if.then8.i158.i ]
...
list_Nconc.exit.i164.i:                           ; preds = %for.end.i.i163.i, %if.then8.i158.i
...
split_RemoveUnnecessarySplits.exit:               ; preds = %if.end47.i, %entry
  ...
  %cmp.i.i.i148257 = icmp eq ptr %PS.val142256, null
  br i1 %cmp.i.i.i148257, label %if.else, label %land.rhs.lr.ph
...
land.rhs15:                                       ; preds = %land.rhs, %list_Nconc.exit171
  ...
  %RecoverList.2263 = phi ptr [ %retval.0.i170, %list_Nconc.exit171 ], [ %RecoverList.0258, %land.rhs ]
...
if.then25:                                        ; preds = %while.body21
  ...
  store ptr %RecoverList.2263, ptr %call.i160, align 8
  br label %if.end28

if.end28:                                         ; preds = %if.then25, %while.body21
  %RecoverList.3 = phi ptr [ %call.i160, %if.then25 ], [ %RecoverList.2263, %while.body21 ]
...
if.end.i181:                                      ; preds = %if.then34
  %cmp.i18.i180 = icmp eq ptr %RecoverList.2263, null
...
for.end.i186:                                     ; preds = %for.cond.i185
  store ptr %RecoverList.2263, ptr %List1.addr.0.i182, align 8
  br label %list_Nconc.exit188

list_Nconc.exit188:                               ; preds = %if.then34, %for.end.i186
  %retval.0.i187 = phi ptr [ %call36.val132, %for.end.i186 ], [ %RecoverList.2263, %if.then34 ]
  store ptr null, ptr %81, align 8
...
for.body.i.preheader:                             ; preds = %list_Nconc.exit188.thread, %list_Nconc.exit188
  %retval.0.i187283 = phi ptr [ %call36.val132, %list_Nconc.exit188.thread ], [ %retval.0.i187, %list_Nconc.exit188 ]
  br label %for.body.i

for.body.i:                                       ; preds = %for.body.i.preheader, %for.inc.i
  %Scan.015.i = phi ptr [ %Scan.0.val11.i, %for.inc.i ], [ %retval.0.i187283, %for.body.i.preheader ]
...
split_DeleteInvalidClausesFromList.exit:          ; preds = %for.inc.i, %list_Nconc.exit188
  %retval.0.i187284 = phi ptr [ null, %list_Nconc.exit188 ], [ %retval.0.i187283, %for.inc.i ]
  %call5.i = tail call ptr @list_PointerDeleteElement(ptr noundef %retval.0.i187284, ptr noundef null) #3
