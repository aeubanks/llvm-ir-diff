...
while.body:                                       ; preds = %entry, %if.end
  %child.014 = phi ptr [ %2, %if.end ], [ %0, %entry ]
  %1 = load ptr, ptr %child.014, align 8, !tbaa !5
  %cmp = icmp eq ptr %1, %name
  br i1 %cmp, label %cleanup, label %if.end

if.end:                                           ; preds = %while.body
  %Sibling = getelementptr inbounds %class.CProfileNode, ptr %child.014, i64 0, i32 7
  %2 = load ptr, ptr %Sibling, align 8, !tbaa !17
...
while.end:                                        ; preds = %if.end, %entry
  ...
  store ptr %0, ptr %Sibling3, align 8, !tbaa !17
  store ptr %call, ptr %Child, align 8, !tbaa !16
  br label %cleanup

cleanup:                                          ; preds = %while.body, %while.end
  %retval.0 = phi ptr [ %call, %while.end ], [ %child.014, %while.body ]
  ret ptr %retval.0
}
...
entry:
  ...
  %1 = load i32, ptr %RecursionCounter, align 8, !tbaa !18
  %inc2 = add nsw i32 %1, 1
  store i32 %inc2, ptr %RecursionCounter, align 8, !tbaa !18
  %cmp = icmp eq i32 %1, 0
...
if.then:                                          ; preds = %entry
  ...
  %2 = load i64, ptr %currentTime.i.i, align 8, !tbaa !19
  %3 = load i64, ptr @_ZL13gProfileClock, align 8, !tbaa !21
  ...
  %4 = load i64, ptr %tv_usec.i.i, align 8, !tbaa !23
  %5 = load i64, ptr getelementptr inbounds (%class.btClock, ptr @_ZL13gProfileClock, i64 0, i32 0, i32 1), align 8, !tbaa !24
  ...
  store i64 %add.i.i, ptr %StartTime, align 8, !tbaa !25
  br label %if.end
...
entry:
  %currentTime.i.i = alloca %struct.timeval, align 8
  %RecursionCounter = getelementptr inbounds %class.CProfileNode, ptr %this, i64 0, i32 4
  %0 = load i32, ptr %RecursionCounter, align 8, !tbaa !18
  %dec = add nsw i32 %0, -1
  store i32 %dec, ptr %RecursionCounter, align 8, !tbaa !18
...
if.then:                                          ; preds = %entry
  ...
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %currentTime.i.i) #16
  %StartTime = getelementptr inbounds %class.CProfileNode, ptr %this, i64 0, i32 3
  %6 = load i64, ptr %StartTime, align 8, !tbaa !26
  ...
  %.pre = load i32, ptr %RecursionCounter, align 8, !tbaa !18
  br label %if.end
...
entry:
  store ptr %start, ptr %this, align 8, !tbaa !27
  ...
  store ptr %0, ptr %CurrentChild, align 8, !tbaa !29
  ret void
}
...
entry:
  ...
  %CurrentChild = getelementptr inbounds %class.CProfileIterator, ptr %this, i64 0, i32 1
  store ptr %1, ptr %CurrentChild, align 8, !tbaa !29
  ret void
}
...
entry:
  %CurrentChild = getelementptr inbounds %class.CProfileIterator, ptr %this, i64 0, i32 1
  %0 = load ptr, ptr %CurrentChild, align 8, !tbaa !29
...
entry:
  ...
  %Child.i = getelementptr inbounds %class.CProfileNode, ptr %0, i64 0, i32 6
  %CurrentChild = getelementptr inbounds %class.CProfileIterator, ptr %this, i64 0, i32 1
  %storemerge16 = load ptr, ptr %Child.i, align 8, !tbaa !30
  store ptr %storemerge16, ptr %CurrentChild, align 8, !tbaa !29
...
while.body:                                       ; preds = %entry, %while.body
  ...
  %storemerge = load ptr, ptr %Sibling.i, align 8, !tbaa !30
  store ptr %storemerge, ptr %CurrentChild, align 8, !tbaa !29
...
if.then:                                          ; preds = %while.end
  store ptr %storemerge.lcssa, ptr %this, align 8, !tbaa !27
  ...
  store ptr %3, ptr %CurrentChild, align 8, !tbaa !29
  br label %if.end
...
if.then:                                          ; preds = %entry
  store ptr %1, ptr %this, align 8, !tbaa !27
  br label %if.end
...
entry:
  ...
  %0 = load ptr, ptr @_ZN15CProfileManager11CurrentNodeE, align 8, !tbaa !30
...
if.then:                                          ; preds = %entry
  %Child.i = getelementptr inbounds %class.CProfileNode, ptr %0, i64 0, i32 6
  %2 = load ptr, ptr %Child.i, align 8, !tbaa !16
  %tobool.not13.i = icmp eq ptr %2, null
  br i1 %tobool.not13.i, label %while.end.i, label %while.body.i

while.body.i:                                     ; preds = %if.then, %if.end.i
  %child.014.i = phi ptr [ %4, %if.end.i ], [ %2, %if.then ]
  %3 = load ptr, ptr %child.014.i, align 8, !tbaa !5
  %cmp.i = icmp eq ptr %3, %name
  br i1 %cmp.i, label %_ZN12CProfileNode12Get_Sub_NodeEPKc.exit, label %if.end.i

if.end.i:                                         ; preds = %while.body.i
  %Sibling.i = getelementptr inbounds %class.CProfileNode, ptr %child.014.i, i64 0, i32 7
  %4 = load ptr, ptr %Sibling.i, align 8, !tbaa !17
...
while.end.i:                                      ; preds = %if.end.i, %if.then
  ...
  store ptr %2, ptr %Sibling3.i, align 8, !tbaa !17
...
_ZN12CProfileNode12Get_Sub_NodeEPKc.exit:         ; preds = %while.body.i, %while.end.i
  %retval.0.i = phi ptr [ %call.i, %while.end.i ], [ %child.014.i, %while.body.i ]
  store ptr %retval.0.i, ptr @_ZN15CProfileManager11CurrentNodeE, align 8, !tbaa !30
  br label %if.end

if.end:                                           ; preds = %_ZN12CProfileNode12Get_Sub_NodeEPKc.exit, %entry
  %5 = phi ptr [ %retval.0.i, %_ZN12CProfileNode12Get_Sub_NodeEPKc.exit ], [ %0, %entry ]
  %TotalCalls.i = getelementptr inbounds %class.CProfileNode, ptr %5, i64 0, i32 1
  %6 = load i32, ptr %TotalCalls.i, align 8, !tbaa !14
  %inc.i = add nsw i32 %6, 1
  store i32 %inc.i, ptr %TotalCalls.i, align 8, !tbaa !14
  %RecursionCounter.i = getelementptr inbounds %class.CProfileNode, ptr %5, i64 0, i32 4
  %7 = load i32, ptr %RecursionCounter.i, align 8, !tbaa !18
  %inc2.i = add nsw i32 %7, 1
  store i32 %inc2.i, ptr %RecursionCounter.i, align 8, !tbaa !18
  %cmp.i3 = icmp eq i32 %7, 0
  br i1 %cmp.i3, label %if.then.i, label %_ZN12CProfileNode4CallEv.exit

if.then.i:                                        ; preds = %if.end
  %StartTime.i = getelementptr inbounds %class.CProfileNode, ptr %5, i64 0, i32 3
  ...
  %8 = load i64, ptr %currentTime.i.i.i, align 8, !tbaa !19
  %9 = load i64, ptr @_ZL13gProfileClock, align 8, !tbaa !21
  ...
  %10 = load i64, ptr %tv_usec.i.i.i, align 8, !tbaa !23
  %11 = load i64, ptr getelementptr inbounds (%class.btClock, ptr @_ZL13gProfileClock, i64 0, i32 0, i32 1), align 8, !tbaa !24
  %sub5.i.i.i = sub i64 %10, %11
  %add.i.i.i = add nsw i64 %sub5.i.i.i, %mul.i.i.i
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %currentTime.i.i.i) #16
  store i64 %add.i.i.i, ptr %StartTime.i, align 8, !tbaa !25
...
entry:
  ...
  %1 = load i32, ptr %RecursionCounter.i, align 8, !tbaa !18
  %dec.i = add nsw i32 %1, -1
  store i32 %dec.i, ptr %RecursionCounter.i, align 8, !tbaa !18
...
if.then.i:                                        ; preds = %entry
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %currentTime.i.i.i) #16
  %call.i.i.i = call i32 @gettimeofday(ptr noundef nonnull %currentTime.i.i.i, ptr noundef null) #16
  %3 = load i64, ptr %currentTime.i.i.i, align 8, !tbaa !19
  %4 = load i64, ptr @_ZL13gProfileClock, align 8, !tbaa !21
  %sub.i.i.i = sub nsw i64 %3, %4
  %mul.i.i.i = mul nsw i64 %sub.i.i.i, 1000000
  %tv_usec.i.i.i = getelementptr inbounds %struct.timeval, ptr %currentTime.i.i.i, i64 0, i32 1
  %5 = load i64, ptr %tv_usec.i.i.i, align 8, !tbaa !23
  %6 = load i64, ptr getelementptr inbounds (%class.btClock, ptr @_ZL13gProfileClock, i64 0, i32 0, i32 1), align 8, !tbaa !24
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %currentTime.i.i.i) #16
  %StartTime.i = getelementptr inbounds %class.CProfileNode, ptr %0, i64 0, i32 3
  %7 = load i64, ptr %StartTime.i, align 8, !tbaa !26
  ...
  %.pre.i = load i32, ptr %RecursionCounter.i, align 8, !tbaa !18
...
if.then:                                          ; preds = %_ZN12CProfileNode6ReturnEv.exit
  %11 = load ptr, ptr @_ZN15CProfileManager11CurrentNodeE, align 8, !tbaa !30
  %Parent.i = getelementptr inbounds %class.CProfileNode, ptr %11, i64 0, i32 5
  %12 = load ptr, ptr %Parent.i, align 8, !tbaa !13
  store ptr %12, ptr @_ZN15CProfileManager11CurrentNodeE, align 8, !tbaa !30
  br label %if.end
...
entry:
  ...
  %1 = load i32, ptr getelementptr inbounds (%class.CProfileNode, ptr @_ZN15CProfileManager4RootE, i64 0, i32 4), align 8, !tbaa !18
  %inc2.i = add nsw i32 %1, 1
  store i32 %inc2.i, ptr getelementptr inbounds (%class.CProfileNode, ptr @_ZN15CProfileManager4RootE, i64 0, i32 4), align 8, !tbaa !18
...
if.then.i:                                        ; preds = %entry
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %currentTime.i.i.i) #16
  %call.i.i.i = call i32 @gettimeofday(ptr noundef nonnull %currentTime.i.i.i, ptr noundef null) #16
  %2 = load i64, ptr %currentTime.i.i.i, align 8, !tbaa !19
  %3 = load i64, ptr @_ZL13gProfileClock, align 8, !tbaa !21
  %sub.i.i.i = sub nsw i64 %2, %3
  %mul.i.i.i = mul nsw i64 %sub.i.i.i, 1000000
  %tv_usec.i.i.i = getelementptr inbounds %struct.timeval, ptr %currentTime.i.i.i, i64 0, i32 1
  %4 = load i64, ptr %tv_usec.i.i.i, align 8, !tbaa !23
  %5 = load i64, ptr getelementptr inbounds (%class.btClock, ptr @_ZL13gProfileClock, i64 0, i32 0, i32 1), align 8, !tbaa !24
  %sub5.i.i.i = sub i64 %4, %5
  %add.i.i.i = add nsw i64 %sub5.i.i.i, %mul.i.i.i
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %currentTime.i.i.i) #16
  store i64 %add.i.i.i, ptr getelementptr inbounds (%class.CProfileNode, ptr @_ZN15CProfileManager4RootE, i64 0, i32 3), align 8, !tbaa !25
  br label %_ZN12CProfileNode4CallEv.exit
...
_ZN12CProfileNode4CallEv.exit:                    ; preds = %entry, %if.then.i
  ...
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %currentTime.i.i) #16
  %call.i.i = call i32 @gettimeofday(ptr noundef nonnull %currentTime.i.i, ptr noundef null) #16
  %6 = load i64, ptr %currentTime.i.i, align 8, !tbaa !19
  %7 = load i64, ptr @_ZL13gProfileClock, align 8, !tbaa !21
  %sub.i.i = sub nsw i64 %6, %7
  %mul.i.i = mul nsw i64 %sub.i.i, 1000000
  %tv_usec.i.i = getelementptr inbounds %struct.timeval, ptr %currentTime.i.i, i64 0, i32 1
  %8 = load i64, ptr %tv_usec.i.i, align 8, !tbaa !23
  ...
  %add.i.i = add nsw i64 %sub5.i.i, %mul.i.i
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %currentTime.i.i) #16
  store i64 %add.i.i, ptr @_ZN15CProfileManager9ResetTimeE, align 8, !tbaa !25
  ret void
}
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %currentTime.i.i) #16
  %call.i.i = call i32 @gettimeofday(ptr noundef nonnull %currentTime.i.i, ptr noundef null) #16
  %0 = load i64, ptr %currentTime.i.i, align 8, !tbaa !19
  %1 = load i64, ptr @_ZL13gProfileClock, align 8, !tbaa !21
  %sub.i.i = sub nsw i64 %0, %1
  %mul.i.i = mul nsw i64 %sub.i.i, 1000000
  %tv_usec.i.i = getelementptr inbounds %struct.timeval, ptr %currentTime.i.i, i64 0, i32 1
  %2 = load i64, ptr %tv_usec.i.i, align 8, !tbaa !23
  %3 = load i64, ptr getelementptr inbounds (%class.btClock, ptr @_ZL13gProfileClock, i64 0, i32 0, i32 1), align 8, !tbaa !24
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %currentTime.i.i) #16
  %4 = load i64, ptr @_ZN15CProfileManager9ResetTimeE, align 8, !tbaa !25
...
entry:
  %currentTime.i.i.i = alloca %struct.timeval, align 8
  %0 = load ptr, ptr %profileIterator, align 8, !tbaa !27
  ...
  store ptr %1, ptr %CurrentChild.i, align 8, !tbaa !29
...
cond.true:                                        ; preds = %if.end
  ...
  %6 = load i64, ptr getelementptr inbounds (%class.btClock, ptr @_ZL13gProfileClock, i64 0, i32 0, i32 1), align 8, !tbaa !24
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %currentTime.i.i.i) #16
  %7 = load i64, ptr @_ZN15CProfileManager9ResetTimeE, align 8, !tbaa !25
...
for.end13:                                        ; preds = %for.body9, %for.end.thread, %for.end
  %11 = load ptr, ptr %profileIterator, align 8, !tbaa !27
  ...
  %.pr = load ptr, ptr %CurrentChild.i, align 8, !tbaa !29
...
for.end33.us.loopexit:                            ; preds = %for.body29.us
  %.pre160 = load ptr, ptr %CurrentChild.i, align 8, !tbaa !29
...
for.end33.us:                                     ; preds = %for.end33.us.loopexit, %for.body18.us
  ...
  %18 = load ptr, ptr %CurrentChild.i, align 8, !tbaa !29
  ...
  store ptr %19, ptr %CurrentChild.i, align 8, !tbaa !29
...
for.body29:                                       ; preds = %for.body18, %for.body29
  ...
  %putchar133 = tail call i32 @putchar(i32 46)
...
for.end33.loopexit:                               ; preds = %for.body29
  %.pre = load ptr, ptr %CurrentChild.i, align 8, !tbaa !29
  br label %for.end33
...
for.end33:                                        ; preds = %for.end33.loopexit, %for.body18
  ...
  %25 = load ptr, ptr %CurrentChild.i, align 8, !tbaa !29
  %Sibling.i.i = getelementptr inbounds %class.CProfileNode, ptr %25, i64 0, i32 7
  %26 = load ptr, ptr %Sibling.i.i, align 8, !tbaa !17
  store ptr %26, ptr %CurrentChild.i, align 8, !tbaa !29
  %cmp.i118.not = icmp eq ptr %26, null
...
for.body69.lr.ph:                                 ; preds = %for.end55
  ...
  %.pre161 = load ptr, ptr %profileIterator, align 8, !tbaa !27
  br label %for.body69
...
for.body69:                                       ; preds = %for.body69.lr.ph, %_ZN16CProfileIterator12Enter_ParentEv.exit
  ...
  %Child.i.i124 = getelementptr inbounds %class.CProfileNode, ptr %28, i64 0, i32 6
  %storemerge16.i = load ptr, ptr %Child.i.i124, align 8, !tbaa !30
  store ptr %storemerge16.i, ptr %CurrentChild.i, align 8, !tbaa !29
...
while.body.i:                                     ; preds = %for.body69, %while.body.i
  ...
  %storemerge.i = load ptr, ptr %Sibling.i.i126, align 8, !tbaa !30
  store ptr %storemerge.i, ptr %CurrentChild.i, align 8, !tbaa !29
  %cmp.i127 = icmp ne ptr %storemerge.i, null
  %cmp3.i = icmp ne i32 %dec.i, 0
  %30 = select i1 %cmp.i127, i1 %cmp3.i, i1 false
...
if.then.i:                                        ; preds = %while.end.i
  store ptr %storemerge.lcssa.i, ptr %profileIterator, align 8, !tbaa !27
  ...
  store ptr %31, ptr %CurrentChild.i, align 8, !tbaa !29
...
_ZN16CProfileIterator11Enter_ChildEi.exit:        ; preds = %while.end.i, %if.then.i
  ...
  %32 = load ptr, ptr %profileIterator, align 8, !tbaa !27
  %Parent.i.i128 = getelementptr inbounds %class.CProfileNode, ptr %32, i64 0, i32 5
  %33 = load ptr, ptr %Parent.i.i128, align 8, !tbaa !13
...
if.then.i129:                                     ; preds = %_ZN16CProfileIterator11Enter_ChildEi.exit
  store ptr %33, ptr %profileIterator, align 8, !tbaa !27
...
_ZN16CProfileIterator12Enter_ParentEv.exit:       ; preds = %_ZN16CProfileIterator11Enter_ChildEi.exit, %if.then.i129
  %34 = phi ptr [ %33, %if.then.i129 ], [ %32, %_ZN16CProfileIterator11Enter_ChildEi.exit ]
  %Child.i.i130 = getelementptr inbounds %class.CProfileNode, ptr %34, i64 0, i32 6
  %35 = load ptr, ptr %Child.i.i130, align 8, !tbaa !16
  store ptr %35, ptr %CurrentChild.i, align 8, !tbaa !29
...
entry:
  ...
  store ptr @_ZN15CProfileManager4RootE, ptr %call.i, align 8, !tbaa !27
  ...
  store ptr %0, ptr %CurrentChild.i.i, align 8, !tbaa !29
