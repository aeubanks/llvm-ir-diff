; ModuleID = '/usr/local/google/home/aeubanks/repos/test-suite/SingleSource/Regression/C/gcc-c-torture/execute/pr48717.c'
source_filename = "/usr/local/google/home/aeubanks/repos/test-suite/SingleSource/Regression/C/gcc-c-torture/execute/pr48717.c"
...
define dso_local zeroext i16 @foo(i16 noundef zeroext %x, i16 noundef zeroext %y) local_unnamed_addr #0 {
entry:
  %add = add i16 %y, %x
  ret i16 %add
}
