; ModuleID = '/usr/local/google/home/aeubanks/repos/test-suite/Bitcode/simd_ops/x86_tests/test_op_psubd_144.bc'
...
@str.11 = private constant [13 x i8] c"op_psubd_144\00", align 32
...
define i32 @__test_op(ptr noalias nocapture readnone %in_f32.buffer, ptr noalias nocapture readnone %in_f64.buffer, ptr noalias nocapture readnone %in_i8.buffer, ptr noalias nocapture readnone %in_u8.buffer, ptr noalias nocapture readnone %in_i16.buffer, ptr noalias nocapture readnone %in_u16.buffer, ptr noalias nocapture readonly %in_i32.buffer, ptr noalias nocapture readnone %in_u32.buffer, ptr noalias nocapture readnone %in_i64.buffer, ptr noalias nocapture readnone %in_u64.buffer, ptr noalias nocapture readonly %op_psubd_144.buffer) local_unnamed_addr #0 {
"produce op_psubd_144":
  %buf_extent168 = getelementptr inbounds %struct.buffer_t, ptr %op_psubd_144.buffer, i64 0, i32 2, i64 1
  %op_psubd_144.extent.1 = load i32, ptr %buf_extent168, align 4
  %buf_min176 = getelementptr inbounds %struct.buffer_t, ptr %op_psubd_144.buffer, i64 0, i32 4, i64 1
  %op_psubd_144.min.1 = load i32, ptr %buf_min176, align 4
  %0 = add nsw i32 %op_psubd_144.min.1, %op_psubd_144.extent.1
  %1 = icmp sgt i32 %op_psubd_144.extent.1, 0
  br i1 %1, label %"for op_psubd_144.s0.y.preheader", label %destructor_block, !prof !4

"for op_psubd_144.s0.y.preheader":                ; preds = %"produce op_psubd_144"
  ...
  %buf_min175 = getelementptr inbounds %struct.buffer_t, ptr %op_psubd_144.buffer, i64 0, i32 4, i64 0
  %op_psubd_144.min.0 = load i32, ptr %buf_min175, align 4
  %2 = sext i32 %op_psubd_144.min.0 to i64
  %buf_stride172 = getelementptr inbounds %struct.buffer_t, ptr %op_psubd_144.buffer, i64 0, i32 3, i64 1
  %op_psubd_144.stride.1 = load i32, ptr %buf_stride172, align 4
  %3 = sext i32 %op_psubd_144.stride.1 to i64
  %buf_host163 = getelementptr inbounds %struct.buffer_t, ptr %op_psubd_144.buffer, i64 0, i32 1
  %op_psubd_144.host = load ptr, ptr %buf_host163, align 8
  %4 = shl nsw i64 %2, 3
  %5 = sub nsw i64 32, %4
  %scevgep = getelementptr i8, ptr %op_psubd_144.host, i64 %5
  %6 = shl nsw i64 %3, 3
  %sunkaddr = ptrtoint ptr %in_i32.host to i64
  br label %"for op_psubd_144.s0.x.x.preheader"

"for op_psubd_144.s0.x.x.preheader":              ; preds = %"end for op_psubd_144.s0.x.x", %"for op_psubd_144.s0.y.preheader"
  %lsr.iv180 = phi ptr [ %scevgep, %"for op_psubd_144.s0.y.preheader" ], [ %scevgep182, %"end for op_psubd_144.s0.x.x" ]
  %op_psubd_144.s0.y = phi i32 [ %op_psubd_144.min.1, %"for op_psubd_144.s0.y.preheader" ], [ %32, %"end for op_psubd_144.s0.x.x" ]
  br label %"for op_psubd_144.s0.x.x"

"for op_psubd_144.s0.x.x":                        ; preds = %"for op_psubd_144.s0.x.x", %"for op_psubd_144.s0.x.x.preheader"
  %lsr.iv183 = phi ptr [ %lsr.iv180, %"for op_psubd_144.s0.x.x.preheader" ], [ %scevgep184.3, %"for op_psubd_144.s0.x.x" ]
  %lsr.iv = phi i64 [ 0, %"for op_psubd_144.s0.x.x.preheader" ], [ %lsr.iv.next.3, %"for op_psubd_144.s0.x.x" ]
  ...
  br i1 %.not.3, label %"end for op_psubd_144.s0.x.x", label %"for op_psubd_144.s0.x.x"

"end for op_psubd_144.s0.x.x":                    ; preds = %"for op_psubd_144.s0.x.x"
  %32 = add nsw i32 %op_psubd_144.s0.y, 1
  %scevgep182 = getelementptr i1, ptr %lsr.iv180, i64 %6
  %.not2 = icmp eq i32 %32, %0
  br i1 %.not2, label %destructor_block, label %"for op_psubd_144.s0.x.x.preheader"

destructor_block:                                 ; preds = %"end for op_psubd_144.s0.x.x", %"produce op_psubd_144"
  ret i32 0
}

; Function Attrs: nofree norecurse nosync nounwind memory(readwrite, inaccessiblemem: none)
define i32 @test_op(ptr noalias nocapture readnone %in_f32.buffer, ptr noalias nocapture readnone %in_f64.buffer, ptr noalias nocapture readnone %in_i8.buffer, ptr noalias nocapture readnone %in_u8.buffer, ptr noalias nocapture readnone %in_i16.buffer, ptr noalias nocapture readnone %in_u16.buffer, ptr noalias nocapture readonly %in_i32.buffer, ptr noalias nocapture readnone %in_u32.buffer, ptr noalias nocapture readnone %in_i64.buffer, ptr noalias nocapture readnone %in_u64.buffer, ptr noalias nocapture readonly %op_psubd_144.buffer) local_unnamed_addr #1 {
destructor_block:
  %"__test_op_result$8" = tail call i32 @__test_op(ptr poison, ptr poison, ptr poison, ptr poison, ptr poison, ptr poison, ptr %in_i32.buffer, ptr poison, ptr poison, ptr poison, ptr %op_psubd_144.buffer) #3
  ret i32 0
}
