; ModuleID = '/usr/local/google/home/aeubanks/repos/test-suite/Bitcode/simd_ops/x86_tests/test_op_vpmaxsw_374.bc'
...
@str.11 = private constant [15 x i8] c"op_vpmaxsw_374\00", align 32
...
define i32 @__test_op(ptr noalias nocapture readnone %in_f32.buffer, ptr noalias nocapture readnone %in_f64.buffer, ptr noalias nocapture readnone %in_i8.buffer, ptr noalias nocapture readnone %in_u8.buffer, ptr noalias nocapture readonly %in_i16.buffer, ptr noalias nocapture readnone %in_u16.buffer, ptr noalias nocapture readnone %in_i32.buffer, ptr noalias nocapture readnone %in_u32.buffer, ptr noalias nocapture readnone %in_i64.buffer, ptr noalias nocapture readnone %in_u64.buffer, ptr noalias nocapture readonly %op_vpmaxsw_374.buffer) local_unnamed_addr #0 {
"produce op_vpmaxsw_374":
  %buf_extent168 = getelementptr inbounds %struct.buffer_t, ptr %op_vpmaxsw_374.buffer, i64 0, i32 2, i64 1
  %op_vpmaxsw_374.extent.1 = load i32, ptr %buf_extent168, align 4
  %buf_min176 = getelementptr inbounds %struct.buffer_t, ptr %op_vpmaxsw_374.buffer, i64 0, i32 4, i64 1
  %op_vpmaxsw_374.min.1 = load i32, ptr %buf_min176, align 4
  %0 = add nsw i32 %op_vpmaxsw_374.min.1, %op_vpmaxsw_374.extent.1
  %1 = icmp sgt i32 %op_vpmaxsw_374.extent.1, 0
  br i1 %1, label %"for op_vpmaxsw_374.s0.y.preheader", label %destructor_block, !prof !4

"for op_vpmaxsw_374.s0.y.preheader":              ; preds = %"produce op_vpmaxsw_374"
  ...
  %buf_min175 = getelementptr inbounds %struct.buffer_t, ptr %op_vpmaxsw_374.buffer, i64 0, i32 4, i64 0
  %op_vpmaxsw_374.min.0 = load i32, ptr %buf_min175, align 4
  %2 = sext i32 %op_vpmaxsw_374.min.0 to i64
  %buf_stride172 = getelementptr inbounds %struct.buffer_t, ptr %op_vpmaxsw_374.buffer, i64 0, i32 3, i64 1
  %op_vpmaxsw_374.stride.1 = load i32, ptr %buf_stride172, align 4
  %3 = sext i32 %op_vpmaxsw_374.stride.1 to i64
  %buf_host163 = getelementptr inbounds %struct.buffer_t, ptr %op_vpmaxsw_374.buffer, i64 0, i32 1
  %op_vpmaxsw_374.host = load ptr, ptr %buf_host163, align 8
  %4 = shl nsw i64 %2, 3
  %5 = sub nsw i64 96, %4
  %scevgep = getelementptr i8, ptr %op_vpmaxsw_374.host, i64 %5
  %6 = shl nsw i64 %3, 3
  %sunkaddr = ptrtoint ptr %in_i16.host to i64
  %a150 = load <16 x i16>, ptr %in_i16.host, align 32, !tbaa !5
  %sunkaddr210 = add i64 %sunkaddr, 32
  %sunkaddr211 = inttoptr i64 %sunkaddr210 to ptr
  %b176 = load <16 x i16>, ptr %sunkaddr211, align 32, !tbaa !5
  %7 = tail call <16 x i16> @llvm.smax.v16i16(<16 x i16> %a150, <16 x i16> %b176)
  ...
  %b176.1 = load <16 x i16>, ptr %sunkaddr211.1, align 32, !tbaa !5
  %13 = tail call <16 x i16> @llvm.smax.v16i16(<16 x i16> %b176, <16 x i16> %b176.1)
  ...
  %a150.2 = load <16 x i16>, ptr %sunkaddr207.2, align 32, !tbaa !5
  %sunkaddr210.2 = add i64 %sunkaddr, 96
  %sunkaddr211.2 = inttoptr i64 %sunkaddr210.2 to ptr
  %b176.2 = load <16 x i16>, ptr %sunkaddr211.2, align 32, !tbaa !5
  %19 = tail call <16 x i16> @llvm.smax.v16i16(<16 x i16> %a150.2, <16 x i16> %b176.2)
  ...
  %a150.3 = load <16 x i16>, ptr %sunkaddr207.3, align 32, !tbaa !5
  %sunkaddr210.3 = add i64 %sunkaddr, 128
  %sunkaddr211.3 = inttoptr i64 %sunkaddr210.3 to ptr
  %b176.3 = load <16 x i16>, ptr %sunkaddr211.3, align 32, !tbaa !5
  %25 = tail call <16 x i16> @llvm.smax.v16i16(<16 x i16> %a150.3, <16 x i16> %b176.3)
  ...
  %a150.4 = load <16 x i16>, ptr %sunkaddr207.4, align 32, !tbaa !5
  %sunkaddr210.4 = add i64 %sunkaddr, 160
  %sunkaddr211.4 = inttoptr i64 %sunkaddr210.4 to ptr
  %b176.4 = load <16 x i16>, ptr %sunkaddr211.4, align 32, !tbaa !5
  %31 = tail call <16 x i16> @llvm.smax.v16i16(<16 x i16> %a150.4, <16 x i16> %b176.4)
  ...
  %a150.5 = load <16 x i16>, ptr %sunkaddr207.5, align 32, !tbaa !5
  %sunkaddr210.5 = add i64 %sunkaddr, 192
  %sunkaddr211.5 = inttoptr i64 %sunkaddr210.5 to ptr
  %b176.5 = load <16 x i16>, ptr %sunkaddr211.5, align 32, !tbaa !5
  %37 = tail call <16 x i16> @llvm.smax.v16i16(<16 x i16> %a150.5, <16 x i16> %b176.5)
  ...
  %a150.6 = load <16 x i16>, ptr %sunkaddr207.6, align 32, !tbaa !5
  %sunkaddr210.6 = add i64 %sunkaddr, 224
  %sunkaddr211.6 = inttoptr i64 %sunkaddr210.6 to ptr
  %b176.6 = load <16 x i16>, ptr %sunkaddr211.6, align 32, !tbaa !5
  %43 = tail call <16 x i16> @llvm.smax.v16i16(<16 x i16> %a150.6, <16 x i16> %b176.6)
  ...
  %a150.7 = load <16 x i16>, ptr %sunkaddr207.7, align 32, !tbaa !5
  %sunkaddr210.7 = add i64 %sunkaddr, 256
  %sunkaddr211.7 = inttoptr i64 %sunkaddr210.7 to ptr
  %b176.7 = load <16 x i16>, ptr %sunkaddr211.7, align 32, !tbaa !5
  %49 = tail call <16 x i16> @llvm.smax.v16i16(<16 x i16> %a150.7, <16 x i16> %b176.7)
  ...
  %a150.8 = load <16 x i16>, ptr %sunkaddr207.8, align 32, !tbaa !5
  %sunkaddr210.8 = add i64 %sunkaddr, 288
  %sunkaddr211.8 = inttoptr i64 %sunkaddr210.8 to ptr
  %b176.8 = load <16 x i16>, ptr %sunkaddr211.8, align 32, !tbaa !5
  %55 = tail call <16 x i16> @llvm.smax.v16i16(<16 x i16> %a150.8, <16 x i16> %b176.8)
  ...
  br label %"for op_vpmaxsw_374.s0.x.x.preheader"

"for op_vpmaxsw_374.s0.x.x.preheader":            ; preds = %"for op_vpmaxsw_374.s0.x.x.preheader", %"for op_vpmaxsw_374.s0.y.preheader"
  %lsr.iv180 = phi ptr [ %scevgep, %"for op_vpmaxsw_374.s0.y.preheader" ], [ %scevgep182, %"for op_vpmaxsw_374.s0.x.x.preheader" ]
  %op_vpmaxsw_374.s0.y = phi i32 [ %op_vpmaxsw_374.min.1, %"for op_vpmaxsw_374.s0.y.preheader" ], [ %103, %"for op_vpmaxsw_374.s0.x.x.preheader" ]
  ...
  %a150.9 = load <16 x i16>, ptr %sunkaddr207.9, align 32, !tbaa !5
  %b176.9 = load <16 x i16>, ptr %sunkaddr211.9, align 32, !tbaa !5
  %61 = tail call <16 x i16> @llvm.smax.v16i16(<16 x i16> %a150.9, <16 x i16> %b176.9)
  ...
  %a150.10 = load <16 x i16>, ptr %sunkaddr207.10, align 32, !tbaa !5
  %b176.10 = load <16 x i16>, ptr %sunkaddr211.10, align 32, !tbaa !5
  %67 = tail call <16 x i16> @llvm.smax.v16i16(<16 x i16> %a150.10, <16 x i16> %b176.10)
  ...
  %a150.11 = load <16 x i16>, ptr %sunkaddr207.11, align 32, !tbaa !5
  %b176.11 = load <16 x i16>, ptr %sunkaddr211.11, align 32, !tbaa !5
  %73 = tail call <16 x i16> @llvm.smax.v16i16(<16 x i16> %a150.11, <16 x i16> %b176.11)
  ...
  %a150.12 = load <16 x i16>, ptr %sunkaddr207.12, align 32, !tbaa !5
  %b176.12 = load <16 x i16>, ptr %sunkaddr211.12, align 32, !tbaa !5
  %79 = tail call <16 x i16> @llvm.smax.v16i16(<16 x i16> %a150.12, <16 x i16> %b176.12)
  ...
  %a150.13 = load <16 x i16>, ptr %sunkaddr207.13, align 32, !tbaa !5
  %b176.13 = load <16 x i16>, ptr %sunkaddr211.13, align 32, !tbaa !5
  %85 = tail call <16 x i16> @llvm.smax.v16i16(<16 x i16> %a150.13, <16 x i16> %b176.13)
  ...
  %a150.14 = load <16 x i16>, ptr %sunkaddr207.14, align 32, !tbaa !5
  %b176.14 = load <16 x i16>, ptr %sunkaddr211.14, align 32, !tbaa !5
  %91 = tail call <16 x i16> @llvm.smax.v16i16(<16 x i16> %a150.14, <16 x i16> %b176.14)
  ...
  %a150.15 = load <16 x i16>, ptr %sunkaddr207.15, align 32, !tbaa !5
  %b176.15 = load <16 x i16>, ptr %sunkaddr211.15, align 32, !tbaa !5
  %97 = tail call <16 x i16> @llvm.smax.v16i16(<16 x i16> %a150.15, <16 x i16> %b176.15)
  ...
  %103 = add nsw i32 %op_vpmaxsw_374.s0.y, 1
  %scevgep182 = getelementptr i1, ptr %lsr.iv180, i64 %6
  %.not2 = icmp eq i32 %103, %0
  br i1 %.not2, label %destructor_block, label %"for op_vpmaxsw_374.s0.x.x.preheader"

destructor_block:                                 ; preds = %"for op_vpmaxsw_374.s0.x.x.preheader", %"produce op_vpmaxsw_374"
  ret i32 0
}

; Function Attrs: nofree nosync nounwind memory(readwrite, inaccessiblemem: none)
define i32 @test_op(ptr noalias nocapture readnone %in_f32.buffer, ptr noalias nocapture readnone %in_f64.buffer, ptr noalias nocapture readnone %in_i8.buffer, ptr noalias nocapture readnone %in_u8.buffer, ptr noalias nocapture readonly %in_i16.buffer, ptr noalias nocapture readnone %in_u16.buffer, ptr noalias nocapture readnone %in_i32.buffer, ptr noalias nocapture readnone %in_u32.buffer, ptr noalias nocapture readnone %in_i64.buffer, ptr noalias nocapture readnone %in_u64.buffer, ptr noalias nocapture readonly %op_vpmaxsw_374.buffer) local_unnamed_addr #1 {
destructor_block:
  %"__test_op_result$23" = tail call i32 @__test_op(ptr poison, ptr poison, ptr poison, ptr poison, ptr %in_i16.buffer, ptr poison, ptr poison, ptr poison, ptr poison, ptr poison, ptr %op_vpmaxsw_374.buffer) #4
  ret i32 0
}
